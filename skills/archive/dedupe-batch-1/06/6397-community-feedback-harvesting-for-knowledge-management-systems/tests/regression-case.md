# Regression Case — u06397-community-feedback-harvesting-for-knowledge-management-systems

## Objective
Verify deterministic replay and fail-closed gate behavior for `Community Feedback Harvesting for knowledge management systems`.
