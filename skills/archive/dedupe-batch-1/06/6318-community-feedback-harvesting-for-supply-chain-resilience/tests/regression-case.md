# Regression Case — u06318-community-feedback-harvesting-for-supply-chain-resilience

## Objective
Verify deterministic replay and fail-closed gate behavior for `Community Feedback Harvesting for supply chain resilience`.
