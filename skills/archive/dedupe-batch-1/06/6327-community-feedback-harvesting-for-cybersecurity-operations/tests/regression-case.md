# Regression Case — u06327-community-feedback-harvesting-for-cybersecurity-operations

## Objective
Verify deterministic replay and fail-closed gate behavior for `Community Feedback Harvesting for cybersecurity operations`.
