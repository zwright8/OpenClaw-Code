# Regression Case — u06344-community-feedback-harvesting-for-community-mediation-programs

## Objective
Verify deterministic replay and fail-closed gate behavior for `Community Feedback Harvesting for community mediation programs`.
