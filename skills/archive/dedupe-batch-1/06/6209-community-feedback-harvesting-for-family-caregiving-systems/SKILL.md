...
## When To Use
Use this skill only when the request explicitly needs `Community Feedback Harvesting for family caregiving systems` in family caregiving systems and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Community Feedback Harvesting for family caregiving systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in family caregiving systems" capability for family caregiving systems**
   - Input: noisy upstream payload requiring community feedback harvesting for family caregiving systems normalization/assessment.
