...
## When To Use
Use this skill only when the request explicitly needs `Autonomous Workflow Authoring for education support services` in education support services and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Autonomous Workflow Authoring for education support services** outcomes (not generic brainstorming).
...
1. **Incident stabilization in education support services" capability for education support services**
   - Input: noisy upstream payload requiring autonomous workflow authoring for education support services normalization/assessment.
