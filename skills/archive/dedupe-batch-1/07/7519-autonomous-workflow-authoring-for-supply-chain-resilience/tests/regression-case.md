# Regression Case — Autonomous Workflow Authoring for supply chain resilience

## Goal
Verify deterministic tolerance enforcement and fail-closed behavior for supply chain resilience.
