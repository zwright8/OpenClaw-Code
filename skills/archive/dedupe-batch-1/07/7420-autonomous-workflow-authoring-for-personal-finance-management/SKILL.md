...
## When To Use
Use this skill only when the request explicitly needs `Autonomous Workflow Authoring for personal finance management` in personal finance management and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Autonomous Workflow Authoring for personal finance management** outcomes (not generic brainstorming).
...
1. **Incident stabilization in personal finance management" capability for personal finance management**
   - Input: noisy upstream payload requiring autonomous workflow authoring for personal finance management normalization/assessment.
