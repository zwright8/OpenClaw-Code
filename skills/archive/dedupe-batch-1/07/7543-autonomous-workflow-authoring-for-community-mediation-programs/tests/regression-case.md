# Regression Case — Autonomous Workflow Authoring for community mediation programs

## Goal
Verify deterministic tolerance enforcement and fail-closed behavior for community mediation programs.
