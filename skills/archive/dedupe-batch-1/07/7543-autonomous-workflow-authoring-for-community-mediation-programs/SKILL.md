...
## When To Use
Use this skill only when the request explicitly needs `Autonomous Workflow Authoring for community mediation programs` in community mediation programs and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Autonomous Workflow Authoring for community mediation programs** outcomes (not generic brainstorming).
...
1. **Incident stabilization in community mediation programs" capability for community mediation programs**
   - Input: noisy upstream payload requiring autonomous workflow authoring for community mediation programs normalization/assessment.
