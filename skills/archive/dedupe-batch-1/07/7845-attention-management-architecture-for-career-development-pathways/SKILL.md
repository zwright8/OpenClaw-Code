...
## When To Use
Use this skill only when the request explicitly needs `Attention Management Architecture for career development pathways` in career development pathways and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Attention Management Architecture for career development pathways** outcomes (not generic brainstorming).
...
1. **Incident stabilization in career development pathways" capability for career development pathways**
   - Input: noisy upstream payload requiring attention management architecture for career development pathways normalization/assessment.
