...
## When To Use
Use this skill only when the request explicitly needs `Autonomous Workflow Authoring for civic participation platforms` in civic participation platforms and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Autonomous Workflow Authoring for civic participation platforms** outcomes (not generic brainstorming).
...
1. **Incident stabilization in civic participation platforms" capability for civic participation platforms**
   - Input: noisy upstream payload requiring autonomous workflow authoring for civic participation platforms normalization/assessment.
