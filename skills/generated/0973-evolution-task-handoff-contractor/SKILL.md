...
description: Build and operate the "Evolution Task Handoff Contractor" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Evolution Task Handoff Contractor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0973_evolution-task-handoff-contracto, approval gates, and rollback owner before autonomous use.
