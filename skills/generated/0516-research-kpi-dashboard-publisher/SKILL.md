...
description: Build and operate the "Research KPI Dashboard Publisher" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Research KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0516_research-kpi-dashboard-publisher, approval gates, and rollback owner before autonomous use.
