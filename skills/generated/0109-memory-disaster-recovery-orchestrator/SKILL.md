...
description: Build and operate the "Memory Disaster Recovery Orchestrator" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Disaster Recovery Orchestrator" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0109_memory-disaster-recovery-orchest, approval gates, and rollback owner before autonomous use.
