...
## Operational Runbook
### Preflight
- Confirm the Comms Auto-Retry and Backoff Coordinator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0735_comms-auto-retry-and-backoff-coo, approval gates, and rollback owner before autonomous use.
