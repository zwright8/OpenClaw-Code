...
description: Build and operate the "Oversight Privacy Preserving Data Broker" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Privacy Preserving Data Broker" outcomes in the Human Oversight and Operator UX domain.
...
## Operational Runbook
### Preflight
- Confirm the Oversight Privacy Preserving Data Broker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0230_oversight-privacy-preserving-dat, approval gates, and rollback owner before autonomous use.
