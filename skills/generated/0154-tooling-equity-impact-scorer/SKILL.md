...
## Operational Runbook
### Preflight
- Confirm the Tooling Equity Impact Scorer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0154_tooling-equity-impact-scorer, approval gates, and rollback owner before autonomous use.
