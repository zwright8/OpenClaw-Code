...
description: Build and operate the "Federation KPI Dashboard Publisher" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation KPI Dashboard Publisher" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0316_federation-kpi-dashboard-publish, approval gates, and rollback owner before autonomous use.
