...
description: Build and operate the "Infra Incident Playbook Synthesizer" capability for Infrastructure and Sustainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Infra Incident Playbook Synthesizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0948_infra-incident-playbook-synthesi, approval gates, and rollback owner before autonomous use.
