...
## When To Use
Use this skill when the request explicitly needs "Multi-Agent Negotiation for civic participation platforms" outcomes in the civic participation platforms domain.
...
- Runtime profile: negotiation-engine using multi-agent negotiation to produce multi-agent-negotiation-artifact-civic-participation-platforms.
