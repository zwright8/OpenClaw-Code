...
description: Build and operate the "Collab Semantic Retrieval Ranker" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Semantic Retrieval Ranker" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0260_collab-semantic-retrieval-ranker, approval gates, and rollback owner before autonomous use.
