...
description: Build and operate the "Tooling Human Approval Router" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Human Approval Router" outcomes in the Tool Reliability and Execution Quality domain.
...
- Orchestration integration: tool-reliability-and-execution-quality:planning-router routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Tooling Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0132_tooling-human-approval-router, approval gates, and rollback owner before autonomous use.
