...
## When To Use
Use this skill when the request explicitly needs "Learning Curriculum Composition for career development pathways" outcomes in the career development pathways domain.
...
- Runtime profile: curriculum-engine using learning curriculum composition to produce learning-curriculum-composition-artifact-career-development-path.
- Orchestration integration: career-development-pathways:curriculum-engine routing, approval gates, retries, and rollback controls.
