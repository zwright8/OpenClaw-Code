...
## When To Use
Use this skill when the request explicitly needs "Autonomous Workflow Authoring for software engineering delivery" outcomes in the software engineering delivery domain.
...
- Runtime profile: orchestration-engine using autonomous workflow authoring to produce autonomous-workflow-authoring-artifact-software-engineering-deli.
- Orchestration integration: software-engineering-delivery:orchestration-engine routing, approval gates, retries, and rollback controls.
