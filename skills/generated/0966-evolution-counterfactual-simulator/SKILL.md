...
description: Build and operate the "Evolution Counterfactual Simulator" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
- Orchestration integration: autonomous-learning-and-evolution:simulation-lab routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Evolution Counterfactual Simulator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0966_evolution-counterfactual-simulat, approval gates, and rollback owner before autonomous use.
