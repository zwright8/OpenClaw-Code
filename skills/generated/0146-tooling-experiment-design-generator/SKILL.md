...
description: Build and operate the "Tooling Experiment Design Generator" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Experiment Design Generator" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling Experiment Design Generator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0146_tooling-experiment-design-genera, approval gates, and rollback owner before autonomous use.
