...
## Operational Runbook
### Preflight
- Confirm the Crisis Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0660_crisis-semantic-retrieval-ranker, approval gates, and rollback owner before autonomous use.
