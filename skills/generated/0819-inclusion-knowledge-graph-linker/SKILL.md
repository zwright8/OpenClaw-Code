...
description: Build and operate the "Inclusion Knowledge Graph Linker" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0819_inclusion-knowledge-graph-linker, approval gates, and rollback owner before autonomous use.
