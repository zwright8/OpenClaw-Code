...
description: Build and operate the "Logistics Failure Root-Cause Miner" capability for Resource Allocation and Logistics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Logistics Failure Root-Cause Miner" outcomes in the Resource Allocation and Logistics domain.
...
## Operational Runbook
### Preflight
- Confirm the Logistics Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0376_logistics-failure-root-cause-min, approval gates, and rollback owner before autonomous use.
