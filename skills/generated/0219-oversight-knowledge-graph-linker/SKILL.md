...
## Operational Runbook
### Preflight
- Confirm the Oversight Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0219_oversight-knowledge-graph-linker, approval gates, and rollback owner before autonomous use.
