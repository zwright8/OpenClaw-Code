...
## When To Use
Use this skill when the request explicitly needs "Crisis Context Window Prioritizer" outcomes in the Crisis and Incident Response domain.
...
## Operational Runbook
### Preflight
- Confirm the Crisis Context Window Prioritizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0642_crisis-context-window-prioritize, approval gates, and rollback owner before autonomous use.
