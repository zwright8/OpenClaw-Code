...
description: Build and operate the "Research Continuous Improvement Planner" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
- Orchestration integration: scientific-research-systems:planning-router routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Research Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0520_research-continuous-improvement-, approval gates, and rollback owner before autonomous use.
