...
description: Build and operate the "Impact Compliance Evidence Mapper" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Compliance Evidence Mapper request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0712_impact-compliance-evidence-mappe, approval gates, and rollback owner before autonomous use.
