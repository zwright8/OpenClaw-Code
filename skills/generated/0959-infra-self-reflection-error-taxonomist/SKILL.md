...
description: Build and operate the "Infra Self-Reflection Error Taxonomist" capability for Infrastructure and Sustainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Infra Self-Reflection Error Taxonomist request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0959_infra-self-reflection-error-taxo, approval gates, and rollback owner before autonomous use.
