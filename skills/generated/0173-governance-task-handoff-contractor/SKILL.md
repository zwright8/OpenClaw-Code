...
description: Build and operate the "Governance Task Handoff Contractor" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Task Handoff Contractor" outcomes in the Safety and Governance domain.
...
- Orchestration integration: safety-and-governance:contract-compiler routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Governance Task Handoff Contractor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0173_governance-task-handoff-contract, approval gates, and rollback owner before autonomous use.
