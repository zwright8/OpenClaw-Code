...
## Operational Runbook
### Preflight
- Confirm the PublicService Signal Ingestion Normalizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0401_publicservice-signal-ingestion-n, approval gates, and rollback owner before autonomous use.
