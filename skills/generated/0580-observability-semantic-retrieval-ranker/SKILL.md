...
description: Build and operate the "Observability Semantic Retrieval Ranker" capability for Data Quality and Observability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Observability Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0580_observability-semantic-retrieval, approval gates, and rollback owner before autonomous use.
