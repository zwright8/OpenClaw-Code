...
description: Build and operate the "Engineering Continuous Improvement Planner" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Engineering Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0560_engineering-continuous-improveme, approval gates, and rollback owner before autonomous use.
