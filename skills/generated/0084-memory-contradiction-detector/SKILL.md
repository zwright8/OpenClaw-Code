...
description: Build and operate the "Memory Contradiction Detector" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Contradiction Detector" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Contradiction Detector request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0084_memory-contradiction-detector, approval gates, and rollback owner before autonomous use.
