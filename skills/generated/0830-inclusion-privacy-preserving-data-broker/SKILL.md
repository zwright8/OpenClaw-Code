...
## When To Use
Use this skill when the request explicitly needs "Inclusion Privacy Preserving Data Broker" outcomes in the Accessibility and Inclusion domain.
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Privacy Preserving Data Broker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0830_inclusion-privacy-preserving-dat, approval gates, and rollback owner before autonomous use.
