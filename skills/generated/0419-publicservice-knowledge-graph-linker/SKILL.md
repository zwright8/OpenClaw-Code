...
## Operational Runbook
### Preflight
- Confirm the PublicService Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0419_publicservice-knowledge-graph-li, approval gates, and rollback owner before autonomous use.
