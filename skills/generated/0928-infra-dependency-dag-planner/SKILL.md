...
description: Build and operate the "Infra Dependency DAG Planner" capability for Infrastructure and Sustainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Infra Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0928_infra-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
