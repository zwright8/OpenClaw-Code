...
description: Build and operate the "Epistemic Compliance Evidence Mapper" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Compliance Evidence Mapper" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Compliance Evidence Mapper request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0032_epistemic-compliance-evidence-ma, approval gates, and rollback owner before autonomous use.
