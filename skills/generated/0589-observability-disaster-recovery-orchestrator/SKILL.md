...
description: Build and operate the "Observability Disaster Recovery Orchestrator" capability for Data Quality and Observability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Observability Disaster Recovery Orchestrator" outcomes in the Data Quality and Observability domain.
...
## Operational Runbook
### Preflight
- Confirm the Observability Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0589_observability-disaster-recovery-, approval gates, and rollback owner before autonomous use.
