...
description: Build and operate the "Epistemic Security Threat Modeler" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Security Threat Modeler" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Security Threat Modeler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0031_epistemic-security-threat-modele, approval gates, and rollback owner before autonomous use.
