...
description: Build and operate the "Oversight Evidence Provenance Tracker" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Evidence Provenance Tracker" outcomes in the Human Oversight and Operator UX domain.
...
- Orchestration integration: human-oversight-and-operator-ux:provenance-tracker routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Oversight Evidence Provenance Tracker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0203_oversight-evidence-provenance-tr, approval gates, and rollback owner before autonomous use.
