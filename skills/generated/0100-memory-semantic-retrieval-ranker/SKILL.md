...
description: Build and operate the "Memory Semantic Retrieval Ranker" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Semantic Retrieval Ranker" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0100_memory-semantic-retrieval-ranker, approval gates, and rollback owner before autonomous use.
