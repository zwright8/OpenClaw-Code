...
description: Build and operate the "Impact Security Threat Modeler" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Security Threat Modeler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0711_impact-security-threat-modeler, approval gates, and rollback owner before autonomous use.
