...
description: Build and operate the "Memory Privacy Preserving Data Broker" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Privacy Preserving Data Broker" outcomes in the Memory and Knowledge Operations domain.
...
- Orchestration integration: memory-and-knowledge-operations:collaboration-mediator routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Memory Privacy Preserving Data Broker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0110_memory-privacy-preserving-data-b, approval gates, and rollback owner before autonomous use.
