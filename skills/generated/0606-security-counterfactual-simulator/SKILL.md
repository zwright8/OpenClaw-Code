...
description: Build and operate the "Security Counterfactual Simulator" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security Counterfactual Simulator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0606_security-counterfactual-simulato, approval gates, and rollback owner before autonomous use.
