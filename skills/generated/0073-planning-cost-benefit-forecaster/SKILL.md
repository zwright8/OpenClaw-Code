...
description: Build and operate the "Planning Cost-Benefit Forecaster" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Cost-Benefit Forecaster" outcomes in the Strategic Planning and Decomposition domain.
...
## Operational Runbook
### Preflight
- Confirm the Planning Cost-Benefit Forecaster request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0073_planning-cost-benefit-forecaster, approval gates, and rollback owner before autonomous use.
