...
description: Build and operate the "Comms Conflict Resolution Coach" capability for Communication and Explainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Comms Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0743_comms-conflict-resolution-coach, approval gates, and rollback owner before autonomous use.
