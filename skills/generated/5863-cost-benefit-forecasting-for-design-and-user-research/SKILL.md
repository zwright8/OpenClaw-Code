...
## When To Use
Use this skill when the request explicitly needs "Cost-Benefit Forecasting for design and user research" outcomes in the design and user research domain.
...
- Runtime profile: forecasting-engine using cost-benefit forecasting to produce cost-benefit-forecasting-artifact-design-and-user-research.
- Orchestration integration: design-and-user-research:forecasting-engine routing, approval gates, retries, and rollback controls.
