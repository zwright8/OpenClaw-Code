...
description: Build and operate the "Observability Dependency DAG Planner" capability for Data Quality and Observability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Observability Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0568_observability-dependency-dag-pla, approval gates, and rollback owner before autonomous use.
