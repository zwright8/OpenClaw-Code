...
description: Build and operate the "Collab Memory Consolidation Pipeline" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Memory Consolidation Pipeline" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0258_collab-memory-consolidation-pipe, approval gates, and rollback owner before autonomous use.
