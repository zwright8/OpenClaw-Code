...
description: Build and operate the "Oversight Risk-Aware Scheduler" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Risk-Aware Scheduler" outcomes in the Human Oversight and Operator UX domain.
...
## Operational Runbook
### Preflight
- Confirm the Oversight Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0210_oversight-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
