...
## When To Use
Use this skill when the request explicitly needs "Knowledge Graph Linking for fitness and recovery training" outcomes in the fitness and recovery training domain.
...
- Runtime profile: generalist-engine using knowledge graph linking to produce knowledge-graph-linking-artifact-fitness-and-recovery-training.
