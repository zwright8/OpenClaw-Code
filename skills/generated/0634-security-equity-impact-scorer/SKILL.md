...
## Operational Runbook
### Preflight
- Confirm the Security Equity Impact Scorer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0634_security-equity-impact-scorer, approval gates, and rollback owner before autonomous use.
