...
description: Build and operate the "Security Dependency DAG Planner" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0608_security-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
