...
description: Build and operate the "Crisis Community Feedback Harvester" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Crisis Community Feedback Harvester request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0675_crisis-community-feedback-harves, approval gates, and rollback owner before autonomous use.
