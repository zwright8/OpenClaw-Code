...
## When To Use
Use this skill when the request explicitly needs "Community Feedback Harvesting for career development pathways" outcomes in the career development pathways domain.
...
- Runtime profile: feedback-engine using community feedback harvesting to produce community-feedback-harvesting-artifact-career-development-pathwa.
- Orchestration integration: career-development-pathways:feedback-engine routing, approval gates, retries, and rollback controls.
