...
description: Build and operate the "Infra Memory Consolidation Pipeline" capability for Infrastructure and Sustainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Infra Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0938_infra-memory-consolidation-pipel, approval gates, and rollback owner before autonomous use.
