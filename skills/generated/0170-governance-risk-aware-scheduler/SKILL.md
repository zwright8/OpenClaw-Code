...
description: Build and operate the "Governance Risk-Aware Scheduler" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Risk-Aware Scheduler" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0170_governance-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
