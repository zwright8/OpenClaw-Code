...
## Operational Runbook
### Preflight
- Confirm the Education Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0448_education-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
