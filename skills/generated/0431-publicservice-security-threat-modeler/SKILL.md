...
## Operational Runbook
### Preflight
- Confirm the PublicService Security Threat Modeler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0431_publicservice-security-threat-mo, approval gates, and rollback owner before autonomous use.
