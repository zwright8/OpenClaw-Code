...
description: Build and operate the "Impact Task Handoff Contractor" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Task Handoff Contractor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0693_impact-task-handoff-contractor, approval gates, and rollback owner before autonomous use.
