...
description: Build and operate the "Epistemic Privacy Preserving Data Broker" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Privacy Preserving Data Broker" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Privacy Preserving Data Broker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0030_epistemic-privacy-preserving-dat, approval gates, and rollback owner before autonomous use.
