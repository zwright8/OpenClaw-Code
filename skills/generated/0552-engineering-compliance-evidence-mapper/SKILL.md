...
description: Build and operate the "Engineering Compliance Evidence Mapper" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Engineering Compliance Evidence Mapper request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0552_engineering-compliance-evidence-, approval gates, and rollback owner before autonomous use.
