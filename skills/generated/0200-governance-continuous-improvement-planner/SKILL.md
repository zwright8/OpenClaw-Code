...
description: Build and operate the "Governance Continuous Improvement Planner" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Continuous Improvement Planner" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0200_governance-continuous-improvemen, approval gates, and rollback owner before autonomous use.
