...
description: Build and operate the "Engineering Regression Sentinel" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Engineering Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0537_engineering-regression-sentinel, approval gates, and rollback owner before autonomous use.
