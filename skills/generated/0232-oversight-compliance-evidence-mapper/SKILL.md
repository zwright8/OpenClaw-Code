...
description: Build and operate the "Oversight Compliance Evidence Mapper" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Compliance Evidence Mapper" outcomes in the Human Oversight and Operator UX domain.
...
## Operational Runbook
### Preflight
- Confirm the Oversight Compliance Evidence Mapper request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0232_oversight-compliance-evidence-ma, approval gates, and rollback owner before autonomous use.
