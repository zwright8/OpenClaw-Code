...
## When To Use
Use this skill when the request explicitly needs "Conflict Resolution Coaching for family caregiving systems" outcomes in the family caregiving systems domain.
...
- Runtime profile: coaching-engine using conflict resolution coaching to produce conflict-resolution-coaching-artifact-family-caregiving-systems.
