...
## Operational Runbook
### Preflight
- Confirm the Research Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0498_research-memory-consolidation-pi, approval gates, and rollback owner before autonomous use.
