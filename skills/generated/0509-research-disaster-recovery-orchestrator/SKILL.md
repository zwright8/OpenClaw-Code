...
## When To Use
Use this skill when the request explicitly needs "Research Disaster Recovery Orchestrator" outcomes in the Scientific Research Systems domain.
...
## Operational Runbook
### Preflight
- Confirm the Research Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0509_research-disaster-recovery-orche, approval gates, and rollback owner before autonomous use.
