...
## When To Use
Use this skill when the request explicitly needs "Continuous Improvement Planning for supply chain resilience" outcomes in the supply chain resilience domain.
...
- Runtime profile: improvement-engine using continuous improvement planning to produce continuous-improvement-planning-artifact-supply-chain-resilience.
- Orchestration integration: supply-chain-resilience:improvement-engine routing, approval gates, retries, and rollback controls.
