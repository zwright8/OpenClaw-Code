...
description: Build and operate the "Infra Community Feedback Harvester" capability for Infrastructure and Sustainability. Trigger when this exact capability is needed in mission execution.
---
...
- Orchestration integration: infrastructure-and-sustainability:normalization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Infra Community Feedback Harvester request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0955_infra-community-feedback-harvest, approval gates, and rollback owner before autonomous use.
