...
description: Build and operate the "Logistics Continuous Improvement Planner" capability for Resource Allocation and Logistics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Logistics Continuous Improvement Planner" outcomes in the Resource Allocation and Logistics domain.
...
## Operational Runbook
### Preflight
- Confirm the Logistics Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0400_logistics-continuous-improvement, approval gates, and rollback owner before autonomous use.
