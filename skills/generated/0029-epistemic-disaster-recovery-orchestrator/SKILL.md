...
description: Build and operate the "Epistemic Disaster Recovery Orchestrator" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Disaster Recovery Orchestrator" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0029_epistemic-disaster-recovery-orch, approval gates, and rollback owner before autonomous use.
