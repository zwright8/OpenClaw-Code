...
## Operational Runbook
### Preflight
- Confirm the Observability Counterfactual Simulator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0566_observability-counterfactual-sim, approval gates, and rollback owner before autonomous use.
