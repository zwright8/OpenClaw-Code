...
description: Build and operate the "Engineering Semantic Retrieval Ranker" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Engineering Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0540_engineering-semantic-retrieval-r, approval gates, and rollback owner before autonomous use.
