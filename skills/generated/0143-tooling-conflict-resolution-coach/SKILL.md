...
description: Build and operate the "Tooling Conflict Resolution Coach" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Conflict Resolution Coach" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0143_tooling-conflict-resolution-coac, approval gates, and rollback owner before autonomous use.
