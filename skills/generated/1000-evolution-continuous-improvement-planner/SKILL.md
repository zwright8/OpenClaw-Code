...
description: Build and operate the "Evolution Continuous Improvement Planner" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Evolution Continuous Improvement Planner" outcomes in the Autonomous Learning and Evolution domain.
...
## Operational Runbook
### Preflight
- Confirm the Evolution Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_1000_evolution-continuous-improvement, approval gates, and rollback owner before autonomous use.
