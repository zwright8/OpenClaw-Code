...
description: Build and operate the "Epistemic Risk-Aware Scheduler" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Risk-Aware Scheduler" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0010_epistemic-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
