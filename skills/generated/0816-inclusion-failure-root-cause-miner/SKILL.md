...
description: Build and operate the "Inclusion Failure Root-Cause Miner" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0816_inclusion-failure-root-cause-min, approval gates, and rollback owner before autonomous use.
