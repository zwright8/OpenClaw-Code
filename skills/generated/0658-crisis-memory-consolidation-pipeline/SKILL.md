...
description: Build and operate the "Crisis Memory Consolidation Pipeline" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Crisis Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0658_crisis-memory-consolidation-pipe, approval gates, and rollback owner before autonomous use.
