...
## Operational Runbook
### Preflight
- Confirm the Evolution Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0970_evolution-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
