...
description: Build and operate the "Evolution Dependency DAG Planner" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Evolution Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0968_evolution-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
