...
## When To Use
Use this skill when the request explicitly needs "Constraint Compilation for eldercare coordination" outcomes in the eldercare coordination domain.
...
- Runtime profile: generalist-engine using constraint compilation to produce constraint-compilation-artifact-eldercare-coordination.
