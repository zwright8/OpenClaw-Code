...
## When To Use
Use this skill when the request explicitly needs "Public Service Coordination for urban planning and mobility" outcomes in the urban planning and mobility domain.
...
- Runtime profile: public-service-engine using public service coordination to produce public-service-coordination-artifact-urban-planning-and-mobility.
- Orchestration integration: urban-planning-and-mobility:public-service-engine routing, approval gates, retries, and rollback controls.
