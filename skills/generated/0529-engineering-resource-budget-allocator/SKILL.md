...
description: Build and operate the "Engineering Resource Budget Allocator" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Engineering Resource Budget Allocator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0529_engineering-resource-budget-allo, approval gates, and rollback owner before autonomous use.
