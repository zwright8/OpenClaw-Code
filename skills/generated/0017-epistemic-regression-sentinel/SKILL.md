...
description: Build and operate the "Epistemic Regression Sentinel" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Regression Sentinel" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0017_epistemic-regression-sentinel, approval gates, and rollback owner before autonomous use.
