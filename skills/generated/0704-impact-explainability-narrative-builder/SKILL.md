...
description: Build and operate the "Impact Explainability Narrative Builder" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Explainability Narrative Builder request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0704_impact-explainability-narrative-, approval gates, and rollback owner before autonomous use.
