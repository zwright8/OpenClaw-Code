...
## Operational Runbook
### Preflight
- Confirm the PublicService Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0416_publicservice-failure-root-cause, approval gates, and rollback owner before autonomous use.
