...
description: Build and operate the "Planning Tool Health Monitor" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Tool Health Monitor" outcomes in the Strategic Planning and Decomposition domain.
...
## Operational Runbook
### Preflight
- Confirm the Planning Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0054_planning-tool-health-monitor, approval gates, and rollback owner before autonomous use.
