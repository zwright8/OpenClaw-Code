...
description: Build and operate the "Engineering Human Approval Router" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Engineering Human Approval Router" outcomes in the Software Engineering Automation domain.
...
## Operational Runbook
### Preflight
- Confirm the Engineering Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0532_engineering-human-approval-route, approval gates, and rollback owner before autonomous use.
