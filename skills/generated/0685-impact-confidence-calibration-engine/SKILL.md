...
- Orchestration integration: social-impact-measurement:optimization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Impact Confidence Calibration Engine request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0685_impact-confidence-calibration-en, approval gates, and rollback owner before autonomous use.
