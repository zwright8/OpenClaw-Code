...
description: Build and operate the "Economic Goal Decomposer" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Goal Decomposer" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Goal Decomposer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0327_economic-goal-decomposer, approval gates, and rollback owner before autonomous use.
