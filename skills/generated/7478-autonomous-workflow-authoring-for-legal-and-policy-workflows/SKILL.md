...
## When To Use
Use this skill when the request explicitly needs "Autonomous Workflow Authoring for legal and policy workflows" outcomes in the legal and policy workflows domain.
...
- Runtime profile: orchestration-engine using autonomous workflow authoring to produce autonomous-workflow-authoring-artifact-legal-and-policy-workflow.
- Orchestration integration: legal-and-policy-workflows:orchestration-engine routing, approval gates, retries, and rollback controls.
