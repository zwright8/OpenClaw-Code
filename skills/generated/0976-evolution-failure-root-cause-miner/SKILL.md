...
## Operational Runbook
### Preflight
- Confirm the Evolution Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0976_evolution-failure-root-cause-min, approval gates, and rollback owner before autonomous use.
