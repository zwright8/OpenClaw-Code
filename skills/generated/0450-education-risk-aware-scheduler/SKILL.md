...
## Operational Runbook
### Preflight
- Confirm the Education Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0450_education-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
