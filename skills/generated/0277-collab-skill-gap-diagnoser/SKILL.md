...
description: Build and operate the "Collab Skill Gap Diagnoser" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Skill Gap Diagnoser" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Skill Gap Diagnoser request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0277_collab-skill-gap-diagnoser, approval gates, and rollback owner before autonomous use.
