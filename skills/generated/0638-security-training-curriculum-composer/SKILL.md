...
description: Build and operate the "Security Training Curriculum Composer" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security Training Curriculum Composer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0638_security-training-curriculum-com, approval gates, and rollback owner before autonomous use.
