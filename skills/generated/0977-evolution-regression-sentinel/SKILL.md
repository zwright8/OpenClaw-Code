...
description: Build and operate the "Evolution Regression Sentinel" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Evolution Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0977_evolution-regression-sentinel, approval gates, and rollback owner before autonomous use.
