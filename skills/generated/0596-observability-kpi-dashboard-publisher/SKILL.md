...
description: Build and operate the "Observability KPI Dashboard Publisher" capability for Data Quality and Observability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Observability KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0596_observability-kpi-dashboard-publ, approval gates, and rollback owner before autonomous use.
