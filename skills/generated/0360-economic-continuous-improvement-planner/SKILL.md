...
description: Build and operate the "Economic Continuous Improvement Planner" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Continuous Improvement Planner" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0360_economic-continuous-improvement-, approval gates, and rollback owner before autonomous use.
