...
## Operational Runbook
### Preflight
- Confirm the Oversight Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0208_oversight-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
