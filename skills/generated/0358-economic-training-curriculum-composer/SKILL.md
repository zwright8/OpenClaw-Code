...
description: Build and operate the "Economic Training Curriculum Composer" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Training Curriculum Composer" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Training Curriculum Composer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0358_economic-training-curriculum-com, approval gates, and rollback owner before autonomous use.
