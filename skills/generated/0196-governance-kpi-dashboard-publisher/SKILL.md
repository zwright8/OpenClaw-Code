...
description: Build and operate the "Governance KPI Dashboard Publisher" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance KPI Dashboard Publisher" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0196_governance-kpi-dashboard-publish, approval gates, and rollback owner before autonomous use.
