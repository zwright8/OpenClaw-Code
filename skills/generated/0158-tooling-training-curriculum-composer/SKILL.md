...
description: Build and operate the "Tooling Training Curriculum Composer" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Training Curriculum Composer" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling Training Curriculum Composer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0158_tooling-training-curriculum-comp, approval gates, and rollback owner before autonomous use.
