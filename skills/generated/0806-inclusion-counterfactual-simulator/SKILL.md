...
description: Build and operate the "Inclusion Counterfactual Simulator" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
- Orchestration integration: accessibility-and-inclusion:simulation-lab routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Inclusion Counterfactual Simulator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0806_inclusion-counterfactual-simulat, approval gates, and rollback owner before autonomous use.
