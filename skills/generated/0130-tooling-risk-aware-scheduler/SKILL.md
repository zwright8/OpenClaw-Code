...
description: Build and operate the "Tooling Risk-Aware Scheduler" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Risk-Aware Scheduler" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0130_tooling-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
