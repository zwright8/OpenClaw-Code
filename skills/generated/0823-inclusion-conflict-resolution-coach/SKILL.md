...
description: Build and operate the "Inclusion Conflict Resolution Coach" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Inclusion Conflict Resolution Coach" outcomes in the Accessibility and Inclusion domain.
...
- Orchestration integration: accessibility-and-inclusion:collaboration-mediator routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Inclusion Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0823_inclusion-conflict-resolution-co, approval gates, and rollback owner before autonomous use.
