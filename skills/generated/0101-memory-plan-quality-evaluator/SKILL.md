...
## Operational Runbook
### Preflight
- Confirm the Memory Plan Quality Evaluator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0101_memory-plan-quality-evaluator, approval gates, and rollback owner before autonomous use.
