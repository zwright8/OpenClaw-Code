...
## Operational Runbook
### Preflight
- Confirm the Memory Equity Impact Scorer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0114_memory-equity-impact-scorer, approval gates, and rollback owner before autonomous use.
