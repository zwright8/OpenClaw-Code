...
description: Build and operate the "Collab Training Curriculum Composer" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Training Curriculum Composer" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Training Curriculum Composer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0278_collab-training-curriculum-compo, approval gates, and rollback owner before autonomous use.
