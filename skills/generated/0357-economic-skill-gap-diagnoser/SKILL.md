...
description: Build and operate the "Economic Skill Gap Diagnoser" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Skill Gap Diagnoser" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Skill Gap Diagnoser request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0357_economic-skill-gap-diagnoser, approval gates, and rollback owner before autonomous use.
