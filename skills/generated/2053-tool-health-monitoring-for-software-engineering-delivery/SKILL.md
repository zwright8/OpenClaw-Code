...
## When To Use
Use this skill when the request explicitly needs "Tool Health Monitoring for software engineering delivery" outcomes in the software engineering delivery domain.
...
- Runtime profile: monitoring-engine using tool health monitoring to produce tool-health-monitoring-artifact-software-engineering-delivery.
- Orchestration integration: software-engineering-delivery:monitoring-engine routing, approval gates, retries, and rollback controls.
