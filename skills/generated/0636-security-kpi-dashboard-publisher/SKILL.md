...
description: Build and operate the "Security KPI Dashboard Publisher" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0636_security-kpi-dashboard-publisher, approval gates, and rollback owner before autonomous use.
