...
## When To Use
Use this skill when the request explicitly needs "Equity Impact Scoring for knowledge management systems" outcomes in the knowledge management systems domain.
...
- Runtime profile: scoring-engine using equity impact scoring to produce equity-impact-scoring-artifact-knowledge-management-systems.
- Orchestration integration: knowledge-management-systems:scoring-engine routing, approval gates, retries, and rollback controls.
