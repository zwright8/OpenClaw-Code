...
description: Build and operate the "Federation Signal Ingestion Normalizer" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Signal Ingestion Normalizer" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation Signal Ingestion Normalizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0281_federation-signal-ingestion-norm, approval gates, and rollback owner before autonomous use.
