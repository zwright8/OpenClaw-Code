...
## When To Use
Use this skill when the request explicitly needs "Infra Conflict Resolution Coach" outcomes in the Infrastructure and Sustainability domain.
...
## Operational Runbook
### Preflight
- Confirm the Infra Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0943_infra-conflict-resolution-coach, approval gates, and rollback owner before autonomous use.
