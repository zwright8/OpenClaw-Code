...
description: Build and operate the "Governance Contradiction Detector" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Contradiction Detector" outcomes in the Safety and Governance domain.
...
- Orchestration integration: safety-and-governance:detection-guard routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Governance Contradiction Detector request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0164_governance-contradiction-detecto, approval gates, and rollback owner before autonomous use.
