...
## Operational Runbook
### Preflight
- Confirm the Infra Signal Ingestion Normalizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0921_infra-signal-ingestion-normalize, approval gates, and rollback owner before autonomous use.
