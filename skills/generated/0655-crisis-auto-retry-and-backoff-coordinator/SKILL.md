...
## Operational Runbook
### Preflight
- Confirm the Crisis Auto-Retry and Backoff Coordinator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0655_crisis-auto-retry-and-backoff-co, approval gates, and rollback owner before autonomous use.
