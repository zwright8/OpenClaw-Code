...
description: Build and operate the "Economic Experiment Design Generator" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Experiment Design Generator" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Experiment Design Generator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0346_economic-experiment-design-gener, approval gates, and rollback owner before autonomous use.
