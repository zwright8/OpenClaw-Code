...
## Operational Runbook
### Preflight
- Confirm the Engineering Context Window Prioritizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0522_engineering-context-window-prior, approval gates, and rollback owner before autonomous use.
