...
description: Build and operate the "Collab Incident Playbook Synthesizer" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Incident Playbook Synthesizer" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Incident Playbook Synthesizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0268_collab-incident-playbook-synthes, approval gates, and rollback owner before autonomous use.
