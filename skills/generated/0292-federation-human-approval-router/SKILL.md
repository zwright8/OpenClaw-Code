...
description: Build and operate the "Federation Human Approval Router" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Human Approval Router" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0292_federation-human-approval-router, approval gates, and rollback owner before autonomous use.
