...
## When To Use
Use this skill when the request explicitly needs "Tool Health Monitoring for healthcare operations" outcomes in the healthcare operations domain.
...
- Runtime profile: monitoring-engine using tool health monitoring to produce tool-health-monitoring-artifact-healthcare-operations.
- Orchestration integration: healthcare-operations:monitoring-engine routing, approval gates, retries, and rollback controls.
