...
## Operational Runbook
### Preflight
- Confirm the Planning Skill Gap Diagnoser request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0077_planning-skill-gap-diagnoser, approval gates, and rollback owner before autonomous use.
