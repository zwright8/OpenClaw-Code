...
## Operational Runbook
### Preflight
- Confirm the Epistemic Skill Gap Diagnoser request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0037_epistemic-skill-gap-diagnoser, approval gates, and rollback owner before autonomous use.
