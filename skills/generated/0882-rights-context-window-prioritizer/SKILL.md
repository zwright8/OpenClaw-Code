...
description: Build and operate the "Rights Context Window Prioritizer" capability for Legal, Rights, and Compliance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Rights Context Window Prioritizer" outcomes in the Legal, Rights, and Compliance domain.
...
## Operational Runbook
### Preflight
- Confirm the Rights Context Window Prioritizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0882_rights-context-window-prioritize, approval gates, and rollback owner before autonomous use.
