...
description: Build and operate the "Comms Human Approval Router" capability for Communication and Explainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Comms Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0732_comms-human-approval-router, approval gates, and rollback owner before autonomous use.
