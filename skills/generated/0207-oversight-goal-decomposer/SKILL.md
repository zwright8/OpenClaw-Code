...
description: Build and operate the "Oversight Goal Decomposer" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Goal Decomposer" outcomes in the Human Oversight and Operator UX domain.
...
## Operational Runbook
### Preflight
- Confirm the Oversight Goal Decomposer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0207_oversight-goal-decomposer, approval gates, and rollback owner before autonomous use.
