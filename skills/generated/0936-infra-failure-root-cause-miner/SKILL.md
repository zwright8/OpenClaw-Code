...
description: Build and operate the "Infra Failure Root-Cause Miner" capability for Infrastructure and Sustainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Infra Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0936_infra-failure-root-cause-miner, approval gates, and rollback owner before autonomous use.
