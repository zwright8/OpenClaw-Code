...
description: Build and operate the "Federation Task Handoff Contractor" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Task Handoff Contractor" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation Task Handoff Contractor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0293_federation-task-handoff-contract, approval gates, and rollback owner before autonomous use.
