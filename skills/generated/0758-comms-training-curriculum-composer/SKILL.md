...
description: Build and operate the "Comms Training Curriculum Composer" capability for Communication and Explainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Comms Training Curriculum Composer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0758_comms-training-curriculum-compos, approval gates, and rollback owner before autonomous use.
