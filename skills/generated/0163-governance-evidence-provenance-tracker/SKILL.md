...
description: Build and operate the "Governance Evidence Provenance Tracker" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Evidence Provenance Tracker" outcomes in the Safety and Governance domain.
...
- Orchestration integration: safety-and-governance:provenance-tracker routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Governance Evidence Provenance Tracker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0163_governance-evidence-provenance-t, approval gates, and rollback owner before autonomous use.
