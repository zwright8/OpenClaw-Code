...
description: Build and operate the "Memory Signal Ingestion Normalizer" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Signal Ingestion Normalizer" outcomes in the Memory and Knowledge Operations domain.
...
- Orchestration integration: memory-and-knowledge-operations:normalization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Memory Signal Ingestion Normalizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0081_memory-signal-ingestion-normaliz, approval gates, and rollback owner before autonomous use.
