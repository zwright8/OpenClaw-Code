...
description: Build and operate the "Comms Risk-Aware Scheduler" capability for Communication and Explainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Comms Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0730_comms-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
