...
## Operational Runbook
### Preflight
- Confirm the Collab Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0252_collab-human-approval-router, approval gates, and rollback owner before autonomous use.
