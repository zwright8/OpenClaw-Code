...
## When To Use
Use this skill when the request explicitly needs "Skill Gap Diagnosis for legal and policy workflows" outcomes in the legal and policy workflows domain.
...
- Runtime profile: diagnostic-engine using skill gap diagnosis to produce skill-gap-diagnosis-artifact-legal-and-policy-workflows.
