...
description: Build and operate the "Security Auto-Retry and Backoff Coordinator" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Security Auto-Retry and Backoff Coordinator" outcomes in the Security and Privacy domain.
...
## Operational Runbook
### Preflight
- Confirm the Security Auto-Retry and Backoff Coordinator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0615_security-auto-retry-and-backoff-, approval gates, and rollback owner before autonomous use.
