...
description: Build and operate the "Inclusion Dependency DAG Planner" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0808_inclusion-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
