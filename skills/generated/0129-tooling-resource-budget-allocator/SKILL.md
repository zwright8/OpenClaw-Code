...
description: Build and operate the "Tooling Resource Budget Allocator" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Resource Budget Allocator" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling Resource Budget Allocator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0129_tooling-resource-budget-allocato, approval gates, and rollback owner before autonomous use.
