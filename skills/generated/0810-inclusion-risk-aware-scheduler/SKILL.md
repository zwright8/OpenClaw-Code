...
description: Build and operate the "Inclusion Risk-Aware Scheduler" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0810_inclusion-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
