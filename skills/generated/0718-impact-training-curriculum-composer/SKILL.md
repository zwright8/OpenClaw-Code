...
description: Build and operate the "Impact Training Curriculum Composer" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Training Curriculum Composer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0718_impact-training-curriculum-compo, approval gates, and rollback owner before autonomous use.
