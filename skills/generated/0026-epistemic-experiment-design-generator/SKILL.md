...
description: Build and operate the "Epistemic Experiment Design Generator" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Experiment Design Generator" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Experiment Design Generator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0026_epistemic-experiment-design-gene, approval gates, and rollback owner before autonomous use.
