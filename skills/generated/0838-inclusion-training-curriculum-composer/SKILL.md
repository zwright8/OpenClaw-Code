...
description: Build and operate the "Inclusion Training Curriculum Composer" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Training Curriculum Composer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0838_inclusion-training-curriculum-co, approval gates, and rollback owner before autonomous use.
