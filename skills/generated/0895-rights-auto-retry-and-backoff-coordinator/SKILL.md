...
## Operational Runbook
### Preflight
- Confirm the Rights Auto-Retry and Backoff Coordinator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0895_rights-auto-retry-and-backoff-co, approval gates, and rollback owner before autonomous use.
