...
description: Build and operate the "Engineering A/B Rollout Governor" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Engineering A/B Rollout Governor" outcomes in the Software Engineering Automation domain.
...
## Operational Runbook
### Preflight
- Confirm the Engineering A/B Rollout Governor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0547_engineering-a-b-rollout-governor, approval gates, and rollback owner before autonomous use.
