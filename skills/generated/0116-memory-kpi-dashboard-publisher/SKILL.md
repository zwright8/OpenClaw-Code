...
description: Build and operate the "Memory KPI Dashboard Publisher" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Memory KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0116_memory-kpi-dashboard-publisher, approval gates, and rollback owner before autonomous use.
