...
description: Build and operate the "Tooling Goal Decomposer" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Goal Decomposer" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling Goal Decomposer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0127_tooling-goal-decomposer, approval gates, and rollback owner before autonomous use.
