...
description: Build and operate the "Oversight Semantic Retrieval Ranker" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Semantic Retrieval Ranker" outcomes in the Human Oversight and Operator UX domain.
...
## Operational Runbook
### Preflight
- Confirm the Oversight Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0220_oversight-semantic-retrieval-ran, approval gates, and rollback owner before autonomous use.
