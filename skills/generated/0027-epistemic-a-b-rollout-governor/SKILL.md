...
description: Build and operate the "Epistemic A/B Rollout Governor" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic A/B Rollout Governor" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic A/B Rollout Governor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0027_epistemic-a-b-rollout-governor, approval gates, and rollback owner before autonomous use.
