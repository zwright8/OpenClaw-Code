...
## When To Use
Use this skill when the request explicitly needs "Research Knowledge Graph Linker" outcomes in the Scientific Research Systems domain.
...
## Operational Runbook
### Preflight
- Confirm the Research Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0499_research-knowledge-graph-linker, approval gates, and rollback owner before autonomous use.
