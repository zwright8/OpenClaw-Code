...
## Operational Runbook
### Preflight
- Confirm the Security Security Threat Modeler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0631_security-security-threat-modeler, approval gates, and rollback owner before autonomous use.
