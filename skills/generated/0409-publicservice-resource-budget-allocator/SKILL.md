...
## Operational Runbook
### Preflight
- Confirm the PublicService Resource Budget Allocator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0409_publicservice-resource-budget-al, approval gates, and rollback owner before autonomous use.
