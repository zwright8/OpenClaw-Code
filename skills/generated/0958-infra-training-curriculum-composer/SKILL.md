...
description: Build and operate the "Infra Training Curriculum Composer" capability for Infrastructure and Sustainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Infra Training Curriculum Composer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0958_infra-training-curriculum-compos, approval gates, and rollback owner before autonomous use.
