...
description: Build and operate the "Logistics Counterfactual Simulator" capability for Resource Allocation and Logistics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Logistics Counterfactual Simulator" outcomes in the Resource Allocation and Logistics domain.
...
- Orchestration integration: resource-allocation-and-logistics:simulation-lab routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Logistics Counterfactual Simulator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0366_logistics-counterfactual-simulat, approval gates, and rollback owner before autonomous use.
