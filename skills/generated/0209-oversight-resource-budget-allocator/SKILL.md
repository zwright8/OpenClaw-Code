...
description: Build and operate the "Oversight Resource Budget Allocator" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Resource Budget Allocator" outcomes in the Human Oversight and Operator UX domain.
...
## Operational Runbook
### Preflight
- Confirm the Oversight Resource Budget Allocator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0209_oversight-resource-budget-alloca, approval gates, and rollback owner before autonomous use.
