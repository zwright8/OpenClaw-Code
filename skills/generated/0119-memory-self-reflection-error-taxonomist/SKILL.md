...
description: Build and operate the "Memory Self-Reflection Error Taxonomist" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Self-Reflection Error Taxonomist" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Self-Reflection Error Taxonomist request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0119_memory-self-reflection-error-tax, approval gates, and rollback owner before autonomous use.
