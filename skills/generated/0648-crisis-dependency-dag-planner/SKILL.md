...
description: Build and operate the "Crisis Dependency DAG Planner" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Crisis Dependency DAG Planner" outcomes in the Crisis and Incident Response domain.
...
## Operational Runbook
### Preflight
- Confirm the Crisis Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0648_crisis-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
