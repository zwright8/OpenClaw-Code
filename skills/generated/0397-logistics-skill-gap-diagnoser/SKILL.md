...
## Operational Runbook
### Preflight
- Confirm the Logistics Skill Gap Diagnoser request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0397_logistics-skill-gap-diagnoser, approval gates, and rollback owner before autonomous use.
