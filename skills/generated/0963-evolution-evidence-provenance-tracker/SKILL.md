...
- Orchestration integration: autonomous-learning-and-evolution:provenance-tracker routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Evolution Evidence Provenance Tracker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0963_evolution-evidence-provenance-tr, approval gates, and rollback owner before autonomous use.
