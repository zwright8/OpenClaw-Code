...
description: Build and operate the "Comms Plan Quality Evaluator" capability for Communication and Explainability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Comms Plan Quality Evaluator" outcomes in the Communication and Explainability domain.
...
## Operational Runbook
### Preflight
- Confirm the Comms Plan Quality Evaluator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0741_comms-plan-quality-evaluator, approval gates, and rollback owner before autonomous use.
