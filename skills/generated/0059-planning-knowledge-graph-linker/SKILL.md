...
description: Build and operate the "Planning Knowledge Graph Linker" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Knowledge Graph Linker" outcomes in the Strategic Planning and Decomposition domain.
...
## Operational Runbook
### Preflight
- Confirm the Planning Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0059_planning-knowledge-graph-linker, approval gates, and rollback owner before autonomous use.
