...
description: Build and operate the "Cultural Memory Consolidation Pipeline" capability for Multilingual and Cultural Adaptation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Cultural Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0778_cultural-memory-consolidation-pi, approval gates, and rollback owner before autonomous use.
