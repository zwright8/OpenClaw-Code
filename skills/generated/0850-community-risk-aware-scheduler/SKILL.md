...
## Operational Runbook
### Preflight
- Confirm the Community Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0850_community-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
