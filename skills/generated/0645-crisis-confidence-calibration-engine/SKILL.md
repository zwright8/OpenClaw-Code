...
description: Build and operate the "Crisis Confidence Calibration Engine" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
- Orchestration integration: crisis-and-incident-response:optimization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Crisis Confidence Calibration Engine request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0645_crisis-confidence-calibration-en, approval gates, and rollback owner before autonomous use.
