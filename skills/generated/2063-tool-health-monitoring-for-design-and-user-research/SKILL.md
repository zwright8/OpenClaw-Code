...
## When To Use
Use this skill when the request explicitly needs "Tool Health Monitoring for design and user research" outcomes in the design and user research domain.
...
- Runtime profile: monitoring-engine using tool health monitoring to produce tool-health-monitoring-artifact-design-and-user-research.
- Orchestration integration: design-and-user-research:monitoring-engine routing, approval gates, retries, and rollback controls.
