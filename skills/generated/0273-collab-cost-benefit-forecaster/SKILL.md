...
description: Build and operate the "Collab Cost-Benefit Forecaster" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Cost-Benefit Forecaster" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Cost-Benefit Forecaster request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0273_collab-cost-benefit-forecaster, approval gates, and rollback owner before autonomous use.
