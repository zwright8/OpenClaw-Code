...
## When To Use
Use this skill when the request explicitly needs "Cost-Benefit Forecasting for manufacturing quality assurance" outcomes in the manufacturing quality assurance domain.
...
- Runtime profile: forecasting-engine using cost-benefit forecasting to produce cost-benefit-forecasting-artifact-manufacturing-quality-assuranc.
- Orchestration integration: manufacturing-quality-assurance:forecasting-engine routing, approval gates, retries, and rollback controls.
