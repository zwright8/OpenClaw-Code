...
description: Build and operate the "Security Memory Consolidation Pipeline" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0618_security-memory-consolidation-pi, approval gates, and rollback owner before autonomous use.
