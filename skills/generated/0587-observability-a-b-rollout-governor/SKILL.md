...
description: Build and operate the "Observability A/B Rollout Governor" capability for Data Quality and Observability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Observability A/B Rollout Governor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0587_observability-a-b-rollout-govern, approval gates, and rollback owner before autonomous use.
