...
## Operational Runbook
### Preflight
- Confirm the Economic Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0334_economic-tool-health-monitor, approval gates, and rollback owner before autonomous use.
