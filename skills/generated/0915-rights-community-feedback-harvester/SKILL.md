...
description: Build and operate the "Rights Community Feedback Harvester" capability for Legal, Rights, and Compliance. Trigger when this exact capability is needed in mission execution.
---
...
- Orchestration integration: legal-rights-and-compliance:normalization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Rights Community Feedback Harvester request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0915_rights-community-feedback-harves, approval gates, and rollback owner before autonomous use.
