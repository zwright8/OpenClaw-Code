...
description: Build and operate the "Engineering Training Curriculum Composer" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Engineering Training Curriculum Composer" outcomes in the Software Engineering Automation domain.
...
## Operational Runbook
### Preflight
- Confirm the Engineering Training Curriculum Composer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0558_engineering-training-curriculum-, approval gates, and rollback owner before autonomous use.
