...
description: Build and operate the "Economic Privacy Preserving Data Broker" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Privacy Preserving Data Broker" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Privacy Preserving Data Broker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0350_economic-privacy-preserving-data, approval gates, and rollback owner before autonomous use.
