...
description: Build and operate the "Impact Community Feedback Harvester" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Community Feedback Harvester request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0715_impact-community-feedback-harves, approval gates, and rollback owner before autonomous use.
