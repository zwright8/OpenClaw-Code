...
description: Build and operate the "Memory Compliance Evidence Mapper" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Compliance Evidence Mapper" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Compliance Evidence Mapper request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0112_memory-compliance-evidence-mappe, approval gates, and rollback owner before autonomous use.
