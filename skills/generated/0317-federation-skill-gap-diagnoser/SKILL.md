...
## Operational Runbook
### Preflight
- Confirm the Federation Skill Gap Diagnoser request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0317_federation-skill-gap-diagnoser, approval gates, and rollback owner before autonomous use.
