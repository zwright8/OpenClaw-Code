...
description: Build and operate the "Federation Privacy Preserving Data Broker" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Privacy Preserving Data Broker" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation Privacy Preserving Data Broker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0310_federation-privacy-preserving-da, approval gates, and rollback owner before autonomous use.
