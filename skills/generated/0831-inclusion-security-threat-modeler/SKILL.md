...
description: Build and operate the "Inclusion Security Threat Modeler" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Security Threat Modeler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0831_inclusion-security-threat-modele, approval gates, and rollback owner before autonomous use.
