...
## When To Use
Use this skill when the request explicitly needs "Infra Confidence Calibration Engine" outcomes in the Infrastructure and Sustainability domain.
...
- Orchestration integration: infrastructure-and-sustainability:optimization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Infra Confidence Calibration Engine request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0925_infra-confidence-calibration-eng, approval gates, and rollback owner before autonomous use.
