...
description: Build and operate the "Rights Cost-Benefit Forecaster" capability for Legal, Rights, and Compliance. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Rights Cost-Benefit Forecaster request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0913_rights-cost-benefit-forecaster, approval gates, and rollback owner before autonomous use.
