...
description: Build and operate the "Oversight Continuous Improvement Planner" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Continuous Improvement Planner" outcomes in the Human Oversight and Operator UX domain.
...
## Operational Runbook
### Preflight
- Confirm the Oversight Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0240_oversight-continuous-improvement, approval gates, and rollback owner before autonomous use.
