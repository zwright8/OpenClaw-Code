...
description: Build and operate the "Governance Plan Quality Evaluator" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Plan Quality Evaluator" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Plan Quality Evaluator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0181_governance-plan-quality-evaluato, approval gates, and rollback owner before autonomous use.
