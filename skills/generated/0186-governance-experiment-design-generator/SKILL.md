...
description: Build and operate the "Governance Experiment Design Generator" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Experiment Design Generator" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Experiment Design Generator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0186_governance-experiment-design-gen, approval gates, and rollback owner before autonomous use.
