...
## Operational Runbook
### Preflight
- Confirm the Comms Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0740_comms-semantic-retrieval-ranker, approval gates, and rollback owner before autonomous use.
