...
description: Build and operate the "Rights Goal Decomposer" capability for Legal, Rights, and Compliance. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Rights Goal Decomposer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0887_rights-goal-decomposer, approval gates, and rollback owner before autonomous use.
