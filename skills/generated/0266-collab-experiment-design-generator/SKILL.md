...
description: Build and operate the "Collab Experiment Design Generator" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Experiment Design Generator" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Experiment Design Generator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0266_collab-experiment-design-generat, approval gates, and rollback owner before autonomous use.
