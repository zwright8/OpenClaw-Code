...
## When To Use
Use this skill when the request explicitly needs "Experiment Design for agriculture and food systems" outcomes in the agriculture and food systems domain.
...
- Runtime profile: experimentation-engine using experiment design to produce experiment-design-artifact-agriculture-and-food-systems.
- Orchestration integration: agriculture-and-food-systems:experimentation-engine routing, approval gates, retries, and rollback controls.
