...
## When To Use
Use this skill when the request explicitly needs "Equity Impact Scoring for product management execution" outcomes in the product management execution domain.
...
- Runtime profile: scoring-engine using equity impact scoring to produce equity-impact-scoring-artifact-product-management-execution.
- Orchestration integration: product-management-execution:scoring-engine routing, approval gates, retries, and rollback controls.
