...
description: Build and operate the "Federation Cost-Benefit Forecaster" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Cost-Benefit Forecaster" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation Cost-Benefit Forecaster request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0313_federation-cost-benefit-forecast, approval gates, and rollback owner before autonomous use.
