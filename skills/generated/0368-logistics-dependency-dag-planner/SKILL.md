...
description: Build and operate the "Logistics Dependency DAG Planner" capability for Resource Allocation and Logistics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Logistics Dependency DAG Planner" outcomes in the Resource Allocation and Logistics domain.
...
## Operational Runbook
### Preflight
- Confirm the Logistics Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0368_logistics-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
