...
## Operational Runbook
### Preflight
- Confirm the PublicService Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0410_publicservice-risk-aware-schedul, approval gates, and rollback owner before autonomous use.
