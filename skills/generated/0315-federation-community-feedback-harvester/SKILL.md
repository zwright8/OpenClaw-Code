...
description: Build and operate the "Federation Community Feedback Harvester" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Community Feedback Harvester" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation Community Feedback Harvester request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0315_federation-community-feedback-ha, approval gates, and rollback owner before autonomous use.
