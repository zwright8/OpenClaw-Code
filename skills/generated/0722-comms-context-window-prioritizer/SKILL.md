...
description: Build and operate the "Comms Context Window Prioritizer" capability for Communication and Explainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Comms Context Window Prioritizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0722_comms-context-window-prioritizer, approval gates, and rollback owner before autonomous use.
