...
description: Build and operate the "Observability Failure Root-Cause Miner" capability for Data Quality and Observability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Observability Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0576_observability-failure-root-cause, approval gates, and rollback owner before autonomous use.
