...
description: Build and operate the "Collab Failure Root-Cause Miner" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Failure Root-Cause Miner" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0256_collab-failure-root-cause-miner, approval gates, and rollback owner before autonomous use.
