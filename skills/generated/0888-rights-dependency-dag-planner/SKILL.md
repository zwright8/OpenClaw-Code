...
## Operational Runbook
### Preflight
- Confirm the Rights Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0888_rights-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
