...
description: Build and operate the "Governance Memory Consolidation Pipeline" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Memory Consolidation Pipeline" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0178_governance-memory-consolidation-, approval gates, and rollback owner before autonomous use.
