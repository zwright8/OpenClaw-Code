...
## When To Use
Use this skill when the request explicitly needs "Handoff Contracting for customer support operations" outcomes in the customer support operations domain.
...
- Runtime profile: generalist-engine using handoff contracting to produce handoff-contracting-artifact-customer-support-operations.
