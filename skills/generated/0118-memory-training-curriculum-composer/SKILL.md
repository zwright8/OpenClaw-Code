...
description: Build and operate the "Memory Training Curriculum Composer" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Training Curriculum Composer" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Training Curriculum Composer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0118_memory-training-curriculum-compo, approval gates, and rollback owner before autonomous use.
