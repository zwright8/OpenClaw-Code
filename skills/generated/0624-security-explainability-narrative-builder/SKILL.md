...
description: Build and operate the "Security Explainability Narrative Builder" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security Explainability Narrative Builder request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0624_security-explainability-narrativ, approval gates, and rollback owner before autonomous use.
