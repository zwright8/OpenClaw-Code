...
description: Build and operate the "Collab Confidence Calibration Engine" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Confidence Calibration Engine" outcomes in the Collaboration and Negotiation domain.
...
- Orchestration integration: collaboration-and-negotiation:optimization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Collab Confidence Calibration Engine request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0245_collab-confidence-calibration-en, approval gates, and rollback owner before autonomous use.
