...
description: Build and operate the "Impact Skill Gap Diagnoser" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Skill Gap Diagnoser request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0717_impact-skill-gap-diagnoser, approval gates, and rollback owner before autonomous use.
