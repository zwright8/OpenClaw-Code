...
description: Build and operate the "Comms Self-Reflection Error Taxonomist" capability for Communication and Explainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Comms Self-Reflection Error Taxonomist request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0759_comms-self-reflection-error-taxo, approval gates, and rollback owner before autonomous use.
