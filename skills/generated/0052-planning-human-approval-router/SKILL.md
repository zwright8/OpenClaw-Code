...
description: Build and operate the "Planning Human Approval Router" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Human Approval Router" outcomes in the Strategic Planning and Decomposition domain.
...
## Operational Runbook
### Preflight
- Confirm the Planning Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0052_planning-human-approval-router, approval gates, and rollback owner before autonomous use.
