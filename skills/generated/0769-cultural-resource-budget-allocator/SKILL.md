...
## Operational Runbook
### Preflight
- Confirm the Cultural Resource Budget Allocator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0769_cultural-resource-budget-allocat, approval gates, and rollback owner before autonomous use.
