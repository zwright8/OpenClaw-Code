...
description: Build and operate the "Collab Plan Quality Evaluator" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Plan Quality Evaluator" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Plan Quality Evaluator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0261_collab-plan-quality-evaluator, approval gates, and rollback owner before autonomous use.
