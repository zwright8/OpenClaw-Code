...
description: Build and operate the "Evolution Human Approval Router" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Evolution Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0972_evolution-human-approval-router, approval gates, and rollback owner before autonomous use.
