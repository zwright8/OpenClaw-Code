...
## Operational Runbook
### Preflight
- Confirm the Education Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0456_education-failure-root-cause-min, approval gates, and rollback owner before autonomous use.
