...
description: Build and operate the "Economic KPI Dashboard Publisher" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic KPI Dashboard Publisher" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0356_economic-kpi-dashboard-publisher, approval gates, and rollback owner before autonomous use.
