...
description: Build and operate the "Crisis Human Approval Router" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Crisis Human Approval Router" outcomes in the Crisis and Incident Response domain.
...
## Operational Runbook
### Preflight
- Confirm the Crisis Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0652_crisis-human-approval-router, approval gates, and rollback owner before autonomous use.
