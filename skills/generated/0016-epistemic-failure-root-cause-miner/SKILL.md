...
description: Build and operate the "Epistemic Failure Root-Cause Miner" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Failure Root-Cause Miner" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0016_epistemic-failure-root-cause-min, approval gates, and rollback owner before autonomous use.
