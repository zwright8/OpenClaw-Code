...
description: Build and operate the "Engineering Goal Decomposer" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Engineering Goal Decomposer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0527_engineering-goal-decomposer, approval gates, and rollback owner before autonomous use.
