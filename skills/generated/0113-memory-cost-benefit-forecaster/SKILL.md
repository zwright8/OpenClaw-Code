...
## When To Use
Use this skill when the request explicitly needs "Memory Cost-Benefit Forecaster" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Cost-Benefit Forecaster request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0113_memory-cost-benefit-forecaster, approval gates, and rollback owner before autonomous use.
