...
## Operational Runbook
### Preflight
- Confirm the Tooling Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0139_tooling-knowledge-graph-linker, approval gates, and rollback owner before autonomous use.
