...
## When To Use
Use this skill when the request explicitly needs "Research Dependency DAG Planner" outcomes in the Scientific Research Systems domain.
...
## Operational Runbook
### Preflight
- Confirm the Research Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0488_research-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
