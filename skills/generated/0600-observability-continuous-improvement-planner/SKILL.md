...
## Operational Runbook
### Preflight
- Confirm the Observability Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0600_observability-continuous-improve, approval gates, and rollback owner before autonomous use.
