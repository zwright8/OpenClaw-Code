...
description: Build and operate the "Federation Disaster Recovery Orchestrator" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Disaster Recovery Orchestrator" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0309_federation-disaster-recovery-orc, approval gates, and rollback owner before autonomous use.
