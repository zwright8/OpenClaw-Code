...
description: Build and operate the "Impact Context Window Prioritizer" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Context Window Prioritizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0682_impact-context-window-prioritize, approval gates, and rollback owner before autonomous use.
