...
## Operational Runbook
### Preflight
- Confirm the Logistics Security Threat Modeler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0391_logistics-security-threat-modele, approval gates, and rollback owner before autonomous use.
