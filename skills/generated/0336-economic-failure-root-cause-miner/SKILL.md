...
description: Build and operate the "Economic Failure Root-Cause Miner" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Failure Root-Cause Miner" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0336_economic-failure-root-cause-mine, approval gates, and rollback owner before autonomous use.
