...
## Operational Runbook
### Preflight
- Confirm the Inclusion Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0812_inclusion-human-approval-router, approval gates, and rollback owner before autonomous use.
