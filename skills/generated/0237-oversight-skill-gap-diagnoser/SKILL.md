...
description: Build and operate the "Oversight Skill Gap Diagnoser" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Skill Gap Diagnoser" outcomes in the Human Oversight and Operator UX domain.
