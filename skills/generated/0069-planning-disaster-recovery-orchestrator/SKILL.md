...
description: Build and operate the "Planning Disaster Recovery Orchestrator" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Disaster Recovery Orchestrator" outcomes in the Strategic Planning and Decomposition domain.
...
## Operational Runbook
### Preflight
- Confirm the Planning Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0069_planning-disaster-recovery-orche, approval gates, and rollback owner before autonomous use.
