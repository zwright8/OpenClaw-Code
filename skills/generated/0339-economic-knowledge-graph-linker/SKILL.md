...
description: Build and operate the "Economic Knowledge Graph Linker" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Knowledge Graph Linker" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0339_economic-knowledge-graph-linker, approval gates, and rollback owner before autonomous use.
