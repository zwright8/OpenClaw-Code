...
description: Build and operate the "Inclusion Policy Constraint Compiler" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
- Orchestration integration: accessibility-and-inclusion:contract-compiler routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Inclusion Policy Constraint Compiler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0811_inclusion-policy-constraint-comp, approval gates, and rollback owner before autonomous use.
