...
## Operational Runbook
### Preflight
- Confirm the Tooling Skill Gap Diagnoser request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0157_tooling-skill-gap-diagnoser, approval gates, and rollback owner before autonomous use.
