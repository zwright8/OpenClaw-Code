...
description: Build and operate the "Cultural Continuous Improvement Planner" capability for Multilingual and Cultural Adaptation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Cultural Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0800_cultural-continuous-improvement-, approval gates, and rollback owner before autonomous use.
