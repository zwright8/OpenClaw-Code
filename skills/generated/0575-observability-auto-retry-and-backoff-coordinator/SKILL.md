...
## Operational Runbook
### Preflight
- Confirm the Observability Auto-Retry and Backoff Coordinator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0575_observability-auto-retry-and-bac, approval gates, and rollback owner before autonomous use.
