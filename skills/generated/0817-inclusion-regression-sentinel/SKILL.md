...
## Operational Runbook
### Preflight
- Confirm the Inclusion Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0817_inclusion-regression-sentinel, approval gates, and rollback owner before autonomous use.
