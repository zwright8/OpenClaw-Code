...
description: Build and operate the "Research Compliance Evidence Mapper" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Research Compliance Evidence Mapper request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0512_research-compliance-evidence-map, approval gates, and rollback owner before autonomous use.
