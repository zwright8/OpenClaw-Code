...
## Operational Runbook
### Preflight
- Confirm the Federation Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0294_federation-tool-health-monitor, approval gates, and rollback owner before autonomous use.
