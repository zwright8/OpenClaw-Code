...
## Operational Runbook
### Preflight
- Confirm the Education Policy Constraint Compiler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0451_education-policy-constraint-comp, approval gates, and rollback owner before autonomous use.
