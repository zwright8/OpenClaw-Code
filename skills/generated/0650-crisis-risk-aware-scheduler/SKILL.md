...
description: Build and operate the "Crisis Risk-Aware Scheduler" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Crisis Risk-Aware Scheduler" outcomes in the Crisis and Incident Response domain.
...
- Orchestration integration: crisis-and-incident-response:planning-router routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Crisis Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0650_crisis-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
