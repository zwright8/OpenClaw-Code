...
description: Build and operate the "Rights Risk-Aware Scheduler" capability for Legal, Rights, and Compliance. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Rights Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0890_rights-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
