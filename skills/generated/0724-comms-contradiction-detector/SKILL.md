...
description: Build and operate the "Comms Contradiction Detector" capability for Communication and Explainability. Trigger when this exact capability is needed in mission execution.
---
...
- Orchestration integration: communication-and-explainability:detection-guard routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Comms Contradiction Detector request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0724_comms-contradiction-detector, approval gates, and rollback owner before autonomous use.
