...
description: Build and operate the "Logistics Human Approval Router" capability for Resource Allocation and Logistics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Logistics Human Approval Router" outcomes in the Resource Allocation and Logistics domain.
...
## Operational Runbook
### Preflight
- Confirm the Logistics Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0372_logistics-human-approval-router, approval gates, and rollback owner before autonomous use.
