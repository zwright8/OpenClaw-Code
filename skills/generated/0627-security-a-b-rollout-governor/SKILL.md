...
description: Build and operate the "Security A/B Rollout Governor" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security A/B Rollout Governor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0627_security-a-b-rollout-governor, approval gates, and rollback owner before autonomous use.
