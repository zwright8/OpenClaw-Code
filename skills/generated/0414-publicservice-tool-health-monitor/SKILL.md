...
## Operational Runbook
### Preflight
- Confirm the PublicService Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0414_publicservice-tool-health-monito, approval gates, and rollback owner before autonomous use.
