...
## Operational Runbook
### Preflight
- Confirm the PublicService Skill Gap Diagnoser request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0437_publicservice-skill-gap-diagnose, approval gates, and rollback owner before autonomous use.
