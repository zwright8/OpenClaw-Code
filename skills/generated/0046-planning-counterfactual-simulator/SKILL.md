...
description: Build and operate the "Planning Counterfactual Simulator" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Counterfactual Simulator" outcomes in the Strategic Planning and Decomposition domain.
...
- Orchestration integration: strategic-planning-and-decomposition:simulation-lab routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Planning Counterfactual Simulator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0046_planning-counterfactual-simulato, approval gates, and rollback owner before autonomous use.
