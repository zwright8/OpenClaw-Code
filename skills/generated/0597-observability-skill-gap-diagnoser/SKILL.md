...
description: Build and operate the "Observability Skill Gap Diagnoser" capability for Data Quality and Observability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Observability Skill Gap Diagnoser request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0597_observability-skill-gap-diagnose, approval gates, and rollback owner before autonomous use.
