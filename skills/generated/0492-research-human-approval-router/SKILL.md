...
## Operational Runbook
### Preflight
- Confirm the Research Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0492_research-human-approval-router, approval gates, and rollback owner before autonomous use.
