...
description: Build and operate the "Impact Policy Constraint Compiler" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
- Orchestration integration: social-impact-measurement:contract-compiler routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Impact Policy Constraint Compiler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0691_impact-policy-constraint-compile, approval gates, and rollback owner before autonomous use.
