...
description: Build and operate the "Epistemic Explainability Narrative Builder" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Explainability Narrative Builder" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Explainability Narrative Builder request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0024_epistemic-explainability-narrati, approval gates, and rollback owner before autonomous use.
