...
description: Build and operate the "Crisis Training Curriculum Composer" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Crisis Training Curriculum Composer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0678_crisis-training-curriculum-compo, approval gates, and rollback owner before autonomous use.
