...
## When To Use
Use this skill when the request explicitly needs "Constraint Compilation for scientific publishing pipelines" outcomes in the scientific publishing pipelines domain.
...
- Runtime profile: generalist-engine using constraint compilation to produce constraint-compilation-artifact-scientific-publishing-pipelines.
