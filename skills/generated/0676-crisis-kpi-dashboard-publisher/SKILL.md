...
## Operational Runbook
### Preflight
- Confirm the Crisis KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0676_crisis-kpi-dashboard-publisher, approval gates, and rollback owner before autonomous use.
