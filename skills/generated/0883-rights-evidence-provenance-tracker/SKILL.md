...
description: Build and operate the "Rights Evidence Provenance Tracker" capability for Legal, Rights, and Compliance. Trigger when this exact capability is needed in mission execution.
---
...
- Orchestration integration: legal-rights-and-compliance:provenance-tracker routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Rights Evidence Provenance Tracker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0883_rights-evidence-provenance-track, approval gates, and rollback owner before autonomous use.
