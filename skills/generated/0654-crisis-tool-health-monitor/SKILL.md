...
description: Build and operate the "Crisis Tool Health Monitor" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Crisis Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0654_crisis-tool-health-monitor, approval gates, and rollback owner before autonomous use.
