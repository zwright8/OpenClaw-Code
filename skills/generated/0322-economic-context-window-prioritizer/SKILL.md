...
## Operational Runbook
### Preflight
- Confirm the Economic Context Window Prioritizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0322_economic-context-window-prioriti, approval gates, and rollback owner before autonomous use.
