...
- Orchestration integration: autonomous-learning-and-evolution:optimization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Evolution Confidence Calibration Engine request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0965_evolution-confidence-calibration, approval gates, and rollback owner before autonomous use.
