...
description: Build and operate the "Impact Continuous Improvement Planner" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Impact Continuous Improvement Planner" outcomes in the Social Impact Measurement domain.
...
## Operational Runbook
### Preflight
- Confirm the Impact Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0720_impact-continuous-improvement-pl, approval gates, and rollback owner before autonomous use.
