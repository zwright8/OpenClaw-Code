...
description: Build and operate the "Security Regression Sentinel" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0617_security-regression-sentinel, approval gates, and rollback owner before autonomous use.
