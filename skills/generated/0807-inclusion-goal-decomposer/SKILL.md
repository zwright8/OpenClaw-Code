...
description: Build and operate the "Inclusion Goal Decomposer" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Goal Decomposer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0807_inclusion-goal-decomposer, approval gates, and rollback owner before autonomous use.
