...
## When To Use
Use this skill when the request explicitly needs "Tool Health Monitoring for household logistics" outcomes in the household logistics domain.
...
- Runtime profile: monitoring-engine using tool health monitoring to produce tool-health-monitoring-artifact-household-logistics.
- Orchestration integration: household-logistics:monitoring-engine routing, approval gates, retries, and rollback controls.
