...
## Operational Runbook
### Preflight
- Confirm the Federation Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0298_federation-memory-consolidation-, approval gates, and rollback owner before autonomous use.
