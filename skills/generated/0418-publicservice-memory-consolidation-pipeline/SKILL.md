...
## Operational Runbook
### Preflight
- Confirm the PublicService Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0418_publicservice-memory-consolidati, approval gates, and rollback owner before autonomous use.
