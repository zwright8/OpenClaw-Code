...
description: Build and operate the "Inclusion Experiment Design Generator" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Experiment Design Generator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0826_inclusion-experiment-design-gene, approval gates, and rollback owner before autonomous use.
