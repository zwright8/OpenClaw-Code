...
description: Build and operate the "Engineering Skill Gap Diagnoser" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Engineering Skill Gap Diagnoser request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0557_engineering-skill-gap-diagnoser, approval gates, and rollback owner before autonomous use.
