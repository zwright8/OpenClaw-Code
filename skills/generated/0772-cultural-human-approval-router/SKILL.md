...
description: Build and operate the "Cultural Human Approval Router" capability for Multilingual and Cultural Adaptation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Cultural Human Approval Router" outcomes in the Multilingual and Cultural Adaptation domain.
...
## Operational Runbook
### Preflight
- Confirm the Cultural Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0772_cultural-human-approval-router, approval gates, and rollback owner before autonomous use.
