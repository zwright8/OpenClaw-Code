...
description: Build and operate the "Memory Confidence Calibration Engine" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Confidence Calibration Engine" outcomes in the Memory and Knowledge Operations domain.
...
- Orchestration integration: memory-and-knowledge-operations:optimization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Memory Confidence Calibration Engine request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0085_memory-confidence-calibration-en, approval gates, and rollback owner before autonomous use.
