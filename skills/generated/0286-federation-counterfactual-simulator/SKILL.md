...
description: Build and operate the "Federation Counterfactual Simulator" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Counterfactual Simulator" outcomes in the Federation and Interoperability domain.
...
- Orchestration integration: federation-and-interoperability:simulation-lab routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Federation Counterfactual Simulator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0286_federation-counterfactual-simula, approval gates, and rollback owner before autonomous use.
