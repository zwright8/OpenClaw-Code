...
## Operational Runbook
### Preflight
- Confirm the Infra Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0940_infra-semantic-retrieval-ranker, approval gates, and rollback owner before autonomous use.
