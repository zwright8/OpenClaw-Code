...
description: Build and operate the "Logistics Memory Consolidation Pipeline" capability for Resource Allocation and Logistics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Logistics Memory Consolidation Pipeline" outcomes in the Resource Allocation and Logistics domain.
...
## Operational Runbook
### Preflight
- Confirm the Logistics Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0378_logistics-memory-consolidation-p, approval gates, and rollback owner before autonomous use.
