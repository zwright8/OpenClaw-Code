...
## When To Use
Use this skill when the request explicitly needs "Equity Impact Scoring for personal finance management" outcomes in the personal finance management domain.
...
- Runtime profile: scoring-engine using equity impact scoring to produce equity-impact-scoring-artifact-personal-finance-management.
- Orchestration integration: personal-finance-management:scoring-engine routing, approval gates, retries, and rollback controls.
