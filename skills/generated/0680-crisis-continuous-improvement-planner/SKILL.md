...
## When To Use
Use this skill when the request explicitly needs "Crisis Continuous Improvement Planner" outcomes in the Crisis and Incident Response domain.
...
## Operational Runbook
### Preflight
- Confirm the Crisis Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0680_crisis-continuous-improvement-pl, approval gates, and rollback owner before autonomous use.
