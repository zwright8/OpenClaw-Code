...
## Operational Runbook
### Preflight
- Confirm the Education Signal Ingestion Normalizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0441_education-signal-ingestion-norma, approval gates, and rollback owner before autonomous use.
