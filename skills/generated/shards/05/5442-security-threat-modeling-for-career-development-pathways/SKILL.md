...
## Metadata
```yaml
capability_id: u05442-security-threat-modeling-for-career-development-pathways
capability_name: Security threat modeling for career development pathways
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for career development pathways".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for career development pathways** in **career development pathways**.
