...
## Metadata
```yaml
capability_id: u05621-compliance-evidence-mapping-for-nutrition-and-meal-planning
capability_name: Compliance evidence mapping for nutrition and meal planning
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for nutrition and meal planning".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for nutrition and meal planning** in **nutrition and meal planning**.
