...
## Metadata
```yaml
capability_id: u05769-compliance-evidence-mapping-for-arts-and-culture-programming
capability_name: Compliance evidence mapping for arts and culture programming
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for arts and culture programming".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for arts and culture programming** in **arts and culture programming**.
