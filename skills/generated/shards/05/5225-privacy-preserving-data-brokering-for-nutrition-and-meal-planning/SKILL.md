...
## Metadata
```yaml
capability_id: u05225-privacy-preserving-data-brokering-for-nutrition-and-meal-planning
capability_name: Privacy preserving data brokering for nutrition and meal planning
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for nutrition and meal planning".
  domain_scope:
    type: string
    description: Task scope and decision context for nutrition and meal planning.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for nutrition and meal planning** in **nutrition and meal planning**.
