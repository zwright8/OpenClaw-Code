...
## Metadata
```yaml
capability_id: u05742-compliance-evidence-mapping-for-community-mediation-programs
capability_name: Compliance evidence mapping for community mediation programs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for community mediation programs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for community mediation programs** in **community mediation programs**.
