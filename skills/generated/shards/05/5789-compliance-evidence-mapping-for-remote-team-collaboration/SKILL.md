...
## Metadata
```yaml
capability_id: u05789-compliance-evidence-mapping-for-remote-team-collaboration
capability_name: Compliance evidence mapping for remote team collaboration
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for remote team collaboration".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for remote team collaboration** in **remote team collaboration**.
