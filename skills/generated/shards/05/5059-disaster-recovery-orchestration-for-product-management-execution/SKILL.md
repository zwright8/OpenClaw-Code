...
## Metadata
```yaml
capability_id: u05059-disaster-recovery-orchestration-for-product-management-execution
capability_name: Disaster recovery orchestration for product management execution
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for product management execution".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for product management execution** in **product management execution**.
