...
## Metadata
```yaml
capability_id: u05763-compliance-evidence-mapping-for-childcare-support-systems
capability_name: Compliance evidence mapping for childcare support systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for childcare support systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for childcare support systems** in **childcare support systems**.
