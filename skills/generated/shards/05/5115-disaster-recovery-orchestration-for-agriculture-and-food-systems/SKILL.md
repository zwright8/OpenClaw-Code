...
## Metadata
```yaml
capability_id: u05115-disaster-recovery-orchestration-for-agriculture-and-food-systems
capability_name: Disaster recovery orchestration for agriculture and food systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for agriculture and food systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for agriculture and food systems** in **agriculture and food systems**.
