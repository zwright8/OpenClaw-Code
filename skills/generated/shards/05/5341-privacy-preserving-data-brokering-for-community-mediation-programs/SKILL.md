...
## Metadata
```yaml
capability_id: u05341-privacy-preserving-data-brokering-for-community-mediation-programs
capability_name: Privacy preserving data brokering for community mediation programs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for community mediation programs".
  domain_scope:
    type: string
    description: Task scope and decision context for community mediation programs.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for community mediation programs** in **community mediation programs**.
