...
## Metadata
```yaml
capability_id: u05660-compliance-evidence-mapping-for-product-management-execution
capability_name: Compliance evidence mapping for product management execution
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for product management execution".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for product management execution** in **product management execution**.
