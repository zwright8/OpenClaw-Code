...
## Metadata
```yaml
capability_id: u05491-security-threat-modeling-for-nonprofit-program-delivery
capability_name: Security threat modeling for nonprofit program delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for nonprofit program delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for nonprofit program delivery** in **nonprofit program delivery**.
