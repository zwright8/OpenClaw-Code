...
## Metadata
```yaml
capability_id: u05793-compliance-evidence-mapping-for-customer-support-operations
capability_name: Compliance evidence mapping for customer support operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for customer support operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for customer support operations** in **customer support operations**.
