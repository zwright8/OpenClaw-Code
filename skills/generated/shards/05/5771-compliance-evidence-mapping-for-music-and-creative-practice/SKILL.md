...
## Metadata
```yaml
capability_id: u05771-compliance-evidence-mapping-for-music-and-creative-practice
capability_name: Compliance evidence mapping for music and creative practice
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for music and creative practice".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for music and creative practice** in **music and creative practice**.
