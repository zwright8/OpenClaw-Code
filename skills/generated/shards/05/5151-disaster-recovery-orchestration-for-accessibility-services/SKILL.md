...
## Metadata
```yaml
capability_id: u05151-disaster-recovery-orchestration-for-accessibility-services
capability_name: Disaster recovery orchestration for accessibility services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for accessibility services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for accessibility services** in **accessibility services**.
