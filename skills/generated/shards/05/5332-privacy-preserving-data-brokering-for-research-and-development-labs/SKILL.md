...
## Metadata
```yaml
capability_id: u05332-privacy-preserving-data-brokering-for-research-and-development-labs
capability_name: Privacy preserving data brokering for research and development labs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for research and development labs".
  domain_scope:
    type: string
    description: Task scope and decision context for research and development labs.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for research and development labs** in **research and development labs**.
