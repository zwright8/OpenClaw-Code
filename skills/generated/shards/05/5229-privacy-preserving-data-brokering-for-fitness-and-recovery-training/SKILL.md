...
## Metadata
```yaml
capability_id: u05229-privacy-preserving-data-brokering-for-fitness-and-recovery-training
capability_name: Privacy preserving data brokering for fitness and recovery training
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for fitness and recovery training".
  domain_scope:
    type: string
    description: Task scope and decision context for fitness and recovery training.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for fitness and recovery training** in **fitness and recovery training**.
