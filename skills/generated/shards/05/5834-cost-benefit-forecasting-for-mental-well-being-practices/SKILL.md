...
## Metadata
```yaml
capability_id: u05834-cost-benefit-forecasting-for-mental-well-being-practices
capability_name: Cost benefit forecasting for mental well being practices
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for mental well being practices".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for mental well being practices** in **mental well being practices**.
