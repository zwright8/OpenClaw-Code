...
## Metadata
```yaml
capability_id: u05966-cost-benefit-forecasting-for-arts-and-culture-programming
capability_name: Cost benefit forecasting for arts and culture programming
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for arts and culture programming".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for arts and culture programming** in **arts and culture programming**.
