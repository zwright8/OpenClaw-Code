...
## Metadata
```yaml
capability_id: u05528-security-threat-modeling-for-cybersecurity-operations
capability_name: Security threat modeling for cybersecurity operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for cybersecurity operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for cybersecurity operations** in **cybersecurity operations**.
