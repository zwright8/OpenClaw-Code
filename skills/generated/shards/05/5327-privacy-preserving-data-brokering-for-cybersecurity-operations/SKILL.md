...
## Metadata
```yaml
capability_id: u05327-privacy-preserving-data-brokering-for-cybersecurity-operations
capability_name: Privacy preserving data brokering for cybersecurity operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for cybersecurity operations".
  domain_scope:
    type: string
    description: Task scope and decision context for cybersecurity operations.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for cybersecurity operations** in **cybersecurity operations**.
