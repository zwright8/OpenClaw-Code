...
## Metadata
```yaml
capability_id: u05737-compliance-evidence-mapping-for-scientific-publishing-pipelines
capability_name: Compliance evidence mapping for scientific publishing pipelines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for scientific publishing pipelines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for scientific publishing pipelines** in **scientific publishing pipelines**.
