...
## Metadata
```yaml
capability_id: u05193-disaster-recovery-orchestration-for-customer-support-operations
capability_name: Disaster recovery orchestration for customer support operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for customer support operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for customer support operations** in **customer support operations**.
