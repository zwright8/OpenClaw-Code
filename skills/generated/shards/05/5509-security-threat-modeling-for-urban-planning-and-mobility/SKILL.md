...
## Metadata
```yaml
capability_id: u05509-security-threat-modeling-for-urban-planning-and-mobility
capability_name: Security threat modeling for urban planning and mobility
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for urban planning and mobility".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for urban planning and mobility** in **urban planning and mobility**.
