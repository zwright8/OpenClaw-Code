...
## Metadata
```yaml
capability_id: u05235-privacy-preserving-data-brokering-for-mental-well-being-practices
capability_name: Privacy preserving data brokering for mental well being practices
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for mental well being practices".
  domain_scope:
    type: string
    description: Task scope and decision context for mental well being practices.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for mental well being practices** in **mental well being practices**.
