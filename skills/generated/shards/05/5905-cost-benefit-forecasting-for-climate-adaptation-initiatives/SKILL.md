...
description: Operate the "Cost benefit forecasting for climate adaptation initiatives" capability in production for climate adaptation initiatives workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Cost benefit forecasting for climate adaptation initiatives` in climate adaptation initiatives and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Cost benefit forecasting for climate adaptation initiatives** outcomes (not generic brainstorming).
...
1. **Incident stabilization in climate adaptation initiatives" capability in production for climate adaptation initiatives workflows**
   - Input: noisy upstream payload requiring cost benefit forecasting for climate adaptation initiatives normalization/assessment.
