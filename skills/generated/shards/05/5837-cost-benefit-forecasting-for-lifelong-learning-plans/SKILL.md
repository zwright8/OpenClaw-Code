...
## Metadata
```yaml
capability_id: u05837-cost-benefit-forecasting-for-lifelong-learning-plans
capability_name: Cost benefit forecasting for lifelong learning plans
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for lifelong learning plans".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for lifelong learning plans** in **lifelong learning plans**.
