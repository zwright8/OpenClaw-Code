...
## Metadata
```yaml
capability_id: u05418-security-threat-modeling-for-personal-finance-management
capability_name: Security threat modeling for personal finance management
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for personal finance management".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for personal finance management** in **personal finance management**.
