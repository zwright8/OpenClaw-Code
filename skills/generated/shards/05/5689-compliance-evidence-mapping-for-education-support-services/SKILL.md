...
## Metadata
```yaml
capability_id: u05689-compliance-evidence-mapping-for-education-support-services
capability_name: Compliance evidence mapping for education support services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for education support services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for education support services** in **education support services**.
