...
## Metadata
```yaml
capability_id: u05055-disaster-recovery-orchestration-for-software-engineering-delivery
capability_name: Disaster recovery orchestration for software engineering delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for software engineering delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for software engineering delivery** in **software engineering delivery**.
