...
## Metadata
```yaml
capability_id: u05190-disaster-recovery-orchestration-for-remote-team-collaboration
capability_name: Disaster recovery orchestration for remote team collaboration
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for remote team collaboration".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for remote team collaboration** in **remote team collaboration**.
