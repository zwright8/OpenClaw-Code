...
## Metadata
```yaml
capability_id: u05747-compliance-evidence-mapping-for-civic-participation-platforms
capability_name: Compliance evidence mapping for civic participation platforms
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for civic participation platforms".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for civic participation platforms** in **civic participation platforms**.
