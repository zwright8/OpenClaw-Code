...
## Metadata
```yaml
capability_id: u05208-privacy-preserving-data-brokering-for-family-caregiving-systems
capability_name: Privacy preserving data brokering for family caregiving systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for family caregiving systems".
  domain_scope:
    type: string
    description: Task scope and decision context for family caregiving systems.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for family caregiving systems** in **family caregiving systems**.
