...
## Metadata
```yaml
capability_id: u05519-security-threat-modeling-for-supply-chain-resilience
capability_name: Security threat modeling for supply chain resilience
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for supply chain resilience".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for supply chain resilience** in **supply chain resilience**.
