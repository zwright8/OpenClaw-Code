...
## Metadata
```yaml
capability_id: u05616-compliance-evidence-mapping-for-personal-finance-management
capability_name: Compliance evidence mapping for personal finance management
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for personal finance management".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for personal finance management** in **personal finance management**.
