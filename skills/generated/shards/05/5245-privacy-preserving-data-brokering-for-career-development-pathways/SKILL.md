...
## Metadata
```yaml
capability_id: u05245-privacy-preserving-data-brokering-for-career-development-pathways
capability_name: Privacy preserving data brokering for career development pathways
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for career development pathways".
  domain_scope:
    type: string
    description: Task scope and decision context for career development pathways.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for career development pathways** in **career development pathways**.
