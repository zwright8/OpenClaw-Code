...
## Metadata
```yaml
capability_id: u05362-privacy-preserving-data-brokering-for-childcare-support-systems
capability_name: Privacy preserving data brokering for childcare support systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for childcare support systems".
  domain_scope:
    type: string
    description: Task scope and decision context for childcare support systems.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for childcare support systems** in **childcare support systems**.
