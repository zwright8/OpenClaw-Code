...
## Metadata
```yaml
capability_id: u05882-cost-benefit-forecasting-for-healthcare-operations
capability_name: Cost benefit forecasting for healthcare operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for healthcare operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for healthcare operations** in **healthcare operations**.
