...
| Feature flag | `skill_05907_cost-benefit-forecasting` |
| Release cycles | `2` |

## Why This Skill Exists
Use cost-benefit forecasting in urban planning and mobility with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Cost-Benefit Forecasting for urban planning and mobility under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Cost-Benefit Forecasting for urban planning and mobility under pro-humanity impact conditions.
