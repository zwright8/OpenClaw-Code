...
## Metadata
```yaml
capability_id: u05400-privacy-preserving-data-brokering-for-knowledge-management-systems
capability_name: Privacy preserving data brokering for knowledge management systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for knowledge management systems".
  domain_scope:
    type: string
    description: Task scope and decision context for knowledge management systems.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for knowledge management systems** in **knowledge management systems**.
