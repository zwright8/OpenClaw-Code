...
## Metadata
```yaml
capability_id: u05377-privacy-preserving-data-brokering-for-journalism-and-public-communication
capability_name: Privacy preserving data brokering for journalism and public communication
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for journalism and public communication".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Privacy preserving data brokering for journalism and public communication** in **journalism and public communication**.
