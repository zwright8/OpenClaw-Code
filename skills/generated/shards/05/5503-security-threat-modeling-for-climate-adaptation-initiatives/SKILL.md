...
## Metadata
```yaml
capability_id: u05503-security-threat-modeling-for-climate-adaptation-initiatives
capability_name: Security threat modeling for climate adaptation initiatives
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for climate adaptation initiatives".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for climate adaptation initiatives** in **climate adaptation initiatives**.
