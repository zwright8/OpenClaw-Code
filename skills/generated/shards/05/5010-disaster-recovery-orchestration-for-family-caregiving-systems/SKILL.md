...
## Metadata
```yaml
capability_id: u05010-disaster-recovery-orchestration-for-family-caregiving-systems
capability_name: Disaster recovery orchestration for family caregiving systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for family caregiving systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for family caregiving systems** in **family caregiving systems**.
