...
## Metadata
```yaml
capability_id: u05962-cost-benefit-forecasting-for-childcare-support-systems
capability_name: Cost benefit forecasting for childcare support systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for childcare support systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for childcare support systems** in **childcare support systems**.
