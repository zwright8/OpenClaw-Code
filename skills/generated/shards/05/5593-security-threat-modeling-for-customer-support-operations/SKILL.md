...
## Metadata
```yaml
capability_id: u05593-security-threat-modeling-for-customer-support-operations
capability_name: Security threat modeling for customer support operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for customer support operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for customer support operations** in **customer support operations**.
