...
## Metadata
```yaml
capability_id: u05869-cost-benefit-forecasting-for-sales-and-client-success
capability_name: Cost benefit forecasting for sales and client success
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for sales and client success".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for sales and client success** in **sales and client success**.
