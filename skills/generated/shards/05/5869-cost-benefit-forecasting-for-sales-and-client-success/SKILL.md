...
description: Operate the "Cost benefit forecasting for sales and client success" capability in production for sales and client success workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Cost benefit forecasting for sales and client success` in sales and client success and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Cost benefit forecasting for sales and client success** outcomes (not generic brainstorming).
...
1. **Incident stabilization in sales and client success" capability in production for sales and client success workflows**
   - Input: noisy upstream payload requiring cost benefit forecasting for sales and client success normalization/assessment.
