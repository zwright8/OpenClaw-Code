...
## Metadata
```yaml
capability_id: u05088-disaster-recovery-orchestration-for-education-support-services
capability_name: Disaster recovery orchestration for education support services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for education support services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for education support services** in **education support services**.
