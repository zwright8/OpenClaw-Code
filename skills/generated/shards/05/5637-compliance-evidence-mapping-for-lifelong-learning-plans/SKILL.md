...
## Metadata
```yaml
capability_id: u05637-compliance-evidence-mapping-for-lifelong-learning-plans
capability_name: Compliance evidence mapping for lifelong learning plans
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for lifelong learning plans".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for lifelong learning plans** in **lifelong learning plans**.
