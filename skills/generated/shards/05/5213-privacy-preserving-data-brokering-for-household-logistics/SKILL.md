...
## Metadata
```yaml
capability_id: u05213-privacy-preserving-data-brokering-for-household-logistics
capability_name: Privacy preserving data brokering for household logistics
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for household logistics".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Privacy preserving data brokering for household logistics** in **household logistics**.
