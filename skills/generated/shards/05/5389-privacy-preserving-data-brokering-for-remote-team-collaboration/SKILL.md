...
## Metadata
```yaml
capability_id: u05389-privacy-preserving-data-brokering-for-remote-team-collaboration
capability_name: Privacy preserving data brokering for remote team collaboration
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for remote team collaboration".
  domain_scope:
    type: string
    description: Task scope and decision context for remote team collaboration.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for remote team collaboration** in **remote team collaboration**.
