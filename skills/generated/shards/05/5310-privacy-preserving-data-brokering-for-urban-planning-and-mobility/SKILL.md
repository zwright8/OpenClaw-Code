...
## Metadata
```yaml
capability_id: u05310-privacy-preserving-data-brokering-for-urban-planning-and-mobility
capability_name: Privacy preserving data brokering for urban planning and mobility
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for urban planning and mobility".
  domain_scope:
    type: string
    description: Task scope and decision context for urban planning and mobility.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for urban planning and mobility** in **urban planning and mobility**.
