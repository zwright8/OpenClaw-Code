...
## Metadata
```yaml
capability_id: u05476-security-threat-modeling-for-legal-and-policy-workflows
capability_name: Security threat modeling for legal and policy workflows
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for legal and policy workflows".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for legal and policy workflows** in **legal and policy workflows**.
