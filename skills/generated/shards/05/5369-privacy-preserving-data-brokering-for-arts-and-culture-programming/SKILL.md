...
## Metadata
```yaml
capability_id: u05369-privacy-preserving-data-brokering-for-arts-and-culture-programming
capability_name: Privacy preserving data brokering for arts and culture programming
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for arts and culture programming".
  domain_scope:
    type: string
    description: Task scope and decision context for arts and culture programming.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for arts and culture programming** in **arts and culture programming**.
