...
## Metadata
```yaml
capability_id: u05728-compliance-evidence-mapping-for-cybersecurity-operations
capability_name: Compliance evidence mapping for cybersecurity operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for cybersecurity operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for cybersecurity operations** in **cybersecurity operations**.
