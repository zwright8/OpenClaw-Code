...
## Metadata
```yaml
capability_id: u05000-incident-playbook-synthesis-for-knowledge-management-systems
capability_name: Incident playbook synthesis for knowledge management systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for knowledge management systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for knowledge management systems** in **knowledge management systems**.
