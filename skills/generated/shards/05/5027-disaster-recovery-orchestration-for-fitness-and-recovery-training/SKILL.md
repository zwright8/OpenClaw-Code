...
## Metadata
```yaml
capability_id: u05027-disaster-recovery-orchestration-for-fitness-and-recovery-training
capability_name: Disaster recovery orchestration for fitness and recovery training
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for fitness and recovery training".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for fitness and recovery training** in **fitness and recovery training**.
