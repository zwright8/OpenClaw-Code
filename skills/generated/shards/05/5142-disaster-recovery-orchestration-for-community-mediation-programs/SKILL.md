...
## Metadata
```yaml
capability_id: u05142-disaster-recovery-orchestration-for-community-mediation-programs
capability_name: Disaster recovery orchestration for community mediation programs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for community mediation programs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for community mediation programs** in **community mediation programs**.
