...
## Metadata
```yaml
capability_id: u05062-disaster-recovery-orchestration-for-design-and-user-research
capability_name: Disaster recovery orchestration for design and user research
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for design and user research".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for design and user research** in **design and user research**.
