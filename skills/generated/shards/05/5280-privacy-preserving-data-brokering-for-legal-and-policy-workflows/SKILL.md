...
## Metadata
```yaml
capability_id: u05280-privacy-preserving-data-brokering-for-legal-and-policy-workflows
capability_name: Privacy preserving data brokering for legal and policy workflows
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for legal and policy workflows".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Privacy preserving data brokering for legal and policy workflows** in **legal and policy workflows**.
