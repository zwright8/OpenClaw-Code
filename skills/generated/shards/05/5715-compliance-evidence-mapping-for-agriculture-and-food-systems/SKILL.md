...
## Metadata
```yaml
capability_id: u05715-compliance-evidence-mapping-for-agriculture-and-food-systems
capability_name: Compliance evidence mapping for agriculture and food systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for agriculture and food systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for agriculture and food systems** in **agriculture and food systems**.
