...
## Metadata
```yaml
capability_id: u05680-compliance-evidence-mapping-for-legal-and-policy-workflows
capability_name: Compliance evidence mapping for legal and policy workflows
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for legal and policy workflows".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for legal and policy workflows** in **legal and policy workflows**.
