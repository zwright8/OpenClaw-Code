...
## Metadata
```yaml
capability_id: u05911-cost-benefit-forecasting-for-agriculture-and-food-systems
capability_name: Cost benefit forecasting for agriculture and food systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for agriculture and food systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for agriculture and food systems** in **agriculture and food systems**.
