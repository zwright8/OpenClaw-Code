...
description: Operate the "Compliance evidence mapping for software engineering delivery" capability in production for software engineering delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Compliance evidence mapping for software engineering delivery` in software engineering delivery and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Compliance evidence mapping for software engineering delivery** outcomes (not generic brainstorming).
...
1. **Incident stabilization in software engineering delivery" capability in production for software engineering delivery workflows**
   - Input: noisy upstream payload requiring compliance evidence mapping for software engineering delivery normalization/assessment.
