...
## Metadata
```yaml
capability_id: u05707-compliance-evidence-mapping-for-urban-planning-and-mobility
capability_name: Compliance evidence mapping for urban planning and mobility
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for urban planning and mobility".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for urban planning and mobility** in **urban planning and mobility**.
