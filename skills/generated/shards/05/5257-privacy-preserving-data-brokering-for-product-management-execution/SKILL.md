...
description: Operate the "Privacy preserving data brokering for product management execution" capability in production for product management execution workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Privacy preserving data brokering for product management execution` in product management execution and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Privacy preserving data brokering for product management execution** outcomes (not generic brainstorming).
...
1. **Incident stabilization in product management execution" capability in production for product management execution workflows**
   - Input: noisy upstream payload requiring privacy preserving data brokering for product management execution normalization/assessment.
