...
## Metadata
```yaml
capability_id: u05935-cost-benefit-forecasting-for-research-and-development-labs
capability_name: Cost benefit forecasting for research and development labs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for research and development labs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for research and development labs** in **research and development labs**.
