...
## Metadata
```yaml
capability_id: u05272-privacy-preserving-data-brokering-for-marketing-and-storytelling
capability_name: Privacy preserving data brokering for marketing and storytelling
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for marketing and storytelling".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Privacy preserving data brokering for marketing and storytelling** in **marketing and storytelling**.
