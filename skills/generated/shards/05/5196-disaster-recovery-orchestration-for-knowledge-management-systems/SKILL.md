...
## Metadata
```yaml
capability_id: u05196-disaster-recovery-orchestration-for-knowledge-management-systems
capability_name: Disaster recovery orchestration for knowledge management systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for knowledge management systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for knowledge management systems** in **knowledge management systems**.
