...
## Metadata
```yaml
capability_id: u05916-cost-benefit-forecasting-for-supply-chain-resilience
capability_name: Cost benefit forecasting for supply chain resilience
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for supply chain resilience".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for supply chain resilience** in **supply chain resilience**.
