...
## Metadata
```yaml
capability_id: u05957-cost-benefit-forecasting-for-eldercare-coordination
capability_name: Cost benefit forecasting for eldercare coordination
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for eldercare coordination".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for eldercare coordination** in **eldercare coordination**.
