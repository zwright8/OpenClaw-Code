...
## Metadata
```yaml
capability_id: u05138-disaster-recovery-orchestration-for-scientific-publishing-pipelines
capability_name: Disaster recovery orchestration for scientific publishing pipelines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for scientific publishing pipelines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for scientific publishing pipelines** in **scientific publishing pipelines**.
