...
## Metadata
```yaml
capability_id: u05490-security-threat-modeling-for-education-support-services
capability_name: Security threat modeling for education support services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for education support services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for education support services** in **education support services**.
