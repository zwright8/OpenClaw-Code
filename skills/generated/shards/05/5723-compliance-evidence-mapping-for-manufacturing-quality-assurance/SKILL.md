...
## Metadata
```yaml
capability_id: u05723-compliance-evidence-mapping-for-manufacturing-quality-assurance
capability_name: Compliance evidence mapping for manufacturing quality assurance
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for manufacturing quality assurance".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for manufacturing quality assurance** in **manufacturing quality assurance**.
