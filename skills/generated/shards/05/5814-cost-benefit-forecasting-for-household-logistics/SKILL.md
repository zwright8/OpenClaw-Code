...
## Metadata
```yaml
capability_id: u05814-cost-benefit-forecasting-for-household-logistics
capability_name: Cost benefit forecasting for household logistics
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for household logistics".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for household logistics** in **household logistics**.
