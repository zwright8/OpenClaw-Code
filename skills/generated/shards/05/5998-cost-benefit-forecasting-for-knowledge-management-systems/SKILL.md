...
## Metadata
```yaml
capability_id: u05998-cost-benefit-forecasting-for-knowledge-management-systems
capability_name: Cost benefit forecasting for knowledge management systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for knowledge management systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for knowledge management systems** in **knowledge management systems**.
