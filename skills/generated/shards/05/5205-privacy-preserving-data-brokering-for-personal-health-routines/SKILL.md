...
## Metadata
```yaml
capability_id: u05205-privacy-preserving-data-brokering-for-personal-health-routines
capability_name: Privacy preserving data brokering for personal health routines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for personal health routines".
  domain_scope:
    type: string
    description: Task scope and decision context for personal health routines.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for personal health routines** in **personal health routines**.
