...
## Metadata
```yaml
capability_id: u05893-cost-benefit-forecasting-for-nonprofit-program-delivery
capability_name: Cost benefit forecasting for nonprofit program delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for nonprofit program delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for nonprofit program delivery** in **nonprofit program delivery**.
