...
description: Operate the "Privacy preserving data brokering for family caregiving systems" capability in production for family caregiving systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Privacy preserving data brokering for family caregiving systems` in family caregiving systems and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Privacy preserving data brokering for family caregiving systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in family caregiving systems" capability in production for family caregiving systems workflows**
   - Input: noisy upstream payload requiring privacy preserving data brokering for family caregiving systems normalization/assessment.
