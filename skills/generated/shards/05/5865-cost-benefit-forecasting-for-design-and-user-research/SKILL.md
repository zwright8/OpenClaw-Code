...
## Metadata
```yaml
capability_id: u05865-cost-benefit-forecasting-for-design-and-user-research
capability_name: Cost benefit forecasting for design and user research
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for design and user research".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for design and user research** in **design and user research**.
