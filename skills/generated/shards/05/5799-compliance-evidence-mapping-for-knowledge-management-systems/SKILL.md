...
## Metadata
```yaml
capability_id: u05799-compliance-evidence-mapping-for-knowledge-management-systems
capability_name: Compliance evidence mapping for knowledge management systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for knowledge management systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for knowledge management systems** in **knowledge management systems**.
