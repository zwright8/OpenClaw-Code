...
## Metadata
```yaml
capability_id: u05015-disaster-recovery-orchestration-for-household-logistics
capability_name: Disaster recovery orchestration for household logistics
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for household logistics".
  domain_scope:
    type: string
    description: Task scope and decision context for household logistics.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Disaster recovery orchestration for household logistics** in **household logistics**.
