...
## Metadata
```yaml
capability_id: u05255-privacy-preserving-data-brokering-for-software-engineering-delivery
capability_name: Privacy preserving data brokering for software engineering delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for software engineering delivery".
  domain_scope:
    type: string
    description: Task scope and decision context for software engineering delivery.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for software engineering delivery** in **software engineering delivery**.
