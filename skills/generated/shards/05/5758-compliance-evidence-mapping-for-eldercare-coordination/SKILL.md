...
## Metadata
```yaml
capability_id: u05758-compliance-evidence-mapping-for-eldercare-coordination
capability_name: Compliance evidence mapping for eldercare coordination
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for eldercare coordination".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for eldercare coordination** in **eldercare coordination**.
