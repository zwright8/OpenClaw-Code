...
## Metadata
```yaml
capability_id: u05463-security-threat-modeling-for-design-and-user-research
capability_name: Security threat modeling for design and user research
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for design and user research".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for design and user research** in **design and user research**.
