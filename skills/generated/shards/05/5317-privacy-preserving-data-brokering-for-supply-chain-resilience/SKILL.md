...
## Metadata
```yaml
capability_id: u05317-privacy-preserving-data-brokering-for-supply-chain-resilience
capability_name: Privacy preserving data brokering for supply chain resilience
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for supply chain resilience".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Privacy preserving data brokering for supply chain resilience** in **supply chain resilience**.
