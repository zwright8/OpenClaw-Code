...
## Metadata
```yaml
capability_id: u05653-compliance-evidence-mapping-for-software-engineering-delivery
capability_name: Compliance evidence mapping for software engineering delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for software engineering delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for software engineering delivery** in **software engineering delivery**.
