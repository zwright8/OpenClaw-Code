---
name: u05861-cost-benefit-forecasting-for-design-and-user-research
...
| Feature flag | `skill_05861_cost-benefit-forecasting` |
| Release cycles | `2` |

## Why This Skill Exists
Use cost-benefit forecasting in design and user research with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Cost-Benefit Forecasting for design and user research under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Cost-Benefit Forecasting for design and user research under maximally truth-seeking conditions.
