...
## Metadata
```yaml
capability_id: u05817-cost-benefit-forecasting-for-personal-finance-management
capability_name: Cost benefit forecasting for personal finance management
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for personal finance management".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for personal finance management** in **personal finance management**.
