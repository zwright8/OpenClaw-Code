...
## Metadata
```yaml
capability_id: u05614-compliance-evidence-mapping-for-household-logistics
capability_name: Compliance evidence mapping for household logistics
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for household logistics".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for household logistics** in **household logistics**.
