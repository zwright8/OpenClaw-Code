...
## Metadata
```yaml
capability_id: u05650-compliance-evidence-mapping-for-entrepreneurship-operations
capability_name: Compliance evidence mapping for entrepreneurship operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for entrepreneurship operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for entrepreneurship operations** in **entrepreneurship operations**.
