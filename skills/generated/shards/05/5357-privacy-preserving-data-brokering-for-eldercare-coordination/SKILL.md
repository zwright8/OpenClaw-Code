...
## Metadata
```yaml
capability_id: u05357-privacy-preserving-data-brokering-for-eldercare-coordination
capability_name: Privacy preserving data brokering for eldercare coordination
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for eldercare coordination".
  domain_scope:
    type: string
    description: Task scope and decision context for eldercare coordination.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for eldercare coordination** in **eldercare coordination**.
