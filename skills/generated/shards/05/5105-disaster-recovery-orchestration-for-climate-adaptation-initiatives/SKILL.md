...
## Metadata
```yaml
capability_id: u05105-disaster-recovery-orchestration-for-climate-adaptation-initiatives
capability_name: Disaster recovery orchestration for climate adaptation initiatives
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for climate adaptation initiatives".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for climate adaptation initiatives** in **climate adaptation initiatives**.
