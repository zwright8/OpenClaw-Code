...
## Metadata
```yaml
capability_id: u05569-security-threat-modeling-for-arts-and-culture-programming
capability_name: Security threat modeling for arts and culture programming
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for arts and culture programming".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for arts and culture programming** in **arts and culture programming**.
