...
## Metadata
```yaml
capability_id: u05629-compliance-evidence-mapping-for-fitness-and-recovery-training
capability_name: Compliance evidence mapping for fitness and recovery training
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for fitness and recovery training".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for fitness and recovery training** in **fitness and recovery training**.
