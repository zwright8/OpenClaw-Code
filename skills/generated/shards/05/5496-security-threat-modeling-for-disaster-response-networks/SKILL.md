...
## Metadata
```yaml
capability_id: u05496-security-threat-modeling-for-disaster-response-networks
capability_name: Security threat modeling for disaster response networks
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for disaster response networks".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for disaster response networks** in **disaster response networks**.
