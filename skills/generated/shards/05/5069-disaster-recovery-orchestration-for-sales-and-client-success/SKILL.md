...
## Metadata
```yaml
capability_id: u05069-disaster-recovery-orchestration-for-sales-and-client-success
capability_name: Disaster recovery orchestration for sales and client success
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for sales and client success".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for sales and client success** in **sales and client success**.
