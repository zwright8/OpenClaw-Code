...
## Metadata
```yaml
capability_id: u05004-disaster-recovery-orchestration-for-personal-health-routines
capability_name: Disaster recovery orchestration for personal health routines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for personal health routines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for personal health routines** in **personal health routines**.
