...
## Metadata
```yaml
capability_id: u05601-compliance-evidence-mapping-for-personal-health-routines
capability_name: Compliance evidence mapping for personal health routines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for personal health routines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for personal health routines** in **personal health routines**.
