...
## Metadata
```yaml
capability_id: u05781-compliance-evidence-mapping-for-multilingual-translation-services
capability_name: Compliance evidence mapping for multilingual translation services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for multilingual translation services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for multilingual translation services** in **multilingual translation services**.
