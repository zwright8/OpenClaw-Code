...
## Metadata
```yaml
capability_id: u05043-disaster-recovery-orchestration-for-career-development-pathways
capability_name: Disaster recovery orchestration for career development pathways
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for career development pathways".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for career development pathways** in **career development pathways**.
