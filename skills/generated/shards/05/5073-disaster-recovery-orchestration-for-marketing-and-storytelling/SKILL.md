...
## Metadata
```yaml
capability_id: u05073-disaster-recovery-orchestration-for-marketing-and-storytelling
capability_name: Disaster recovery orchestration for marketing and storytelling
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for marketing and storytelling".
  domain_scope:
    type: string
    description: Task scope and decision context for marketing and storytelling.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Disaster recovery orchestration for marketing and storytelling** in **marketing and storytelling**.
