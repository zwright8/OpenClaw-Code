...
## Metadata
```yaml
capability_id: u05694-compliance-evidence-mapping-for-nonprofit-program-delivery
capability_name: Compliance evidence mapping for nonprofit program delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for nonprofit program delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for nonprofit program delivery** in **nonprofit program delivery**.
