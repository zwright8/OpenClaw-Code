...
## Metadata
```yaml
capability_id: u05077-disaster-recovery-orchestration-for-legal-and-policy-workflows
capability_name: Disaster recovery orchestration for legal and policy workflows
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for legal and policy workflows".
  domain_scope:
    type: string
    description: Task scope and decision context for legal and policy workflows.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Disaster recovery orchestration for legal and policy workflows** in **legal and policy workflows**.
