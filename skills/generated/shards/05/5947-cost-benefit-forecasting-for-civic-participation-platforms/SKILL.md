...
## Metadata
```yaml
capability_id: u05947-cost-benefit-forecasting-for-civic-participation-platforms
capability_name: Cost benefit forecasting for civic participation platforms
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for civic participation platforms".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for civic participation platforms** in **civic participation platforms**.
