...
## Metadata
```yaml
capability_id: u05666-compliance-evidence-mapping-for-sales-and-client-success
capability_name: Compliance evidence mapping for sales and client success
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for sales and client success".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for sales and client success** in **sales and client success**.
