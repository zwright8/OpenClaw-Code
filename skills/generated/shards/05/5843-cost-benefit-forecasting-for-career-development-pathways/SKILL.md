...
## Metadata
```yaml
capability_id: u05843-cost-benefit-forecasting-for-career-development-pathways
capability_name: Cost benefit forecasting for career development pathways
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for career development pathways".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for career development pathways** in **career development pathways**.
