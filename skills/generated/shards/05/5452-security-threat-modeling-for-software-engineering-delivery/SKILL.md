...
## Metadata
```yaml
capability_id: u05452-security-threat-modeling-for-software-engineering-delivery
capability_name: Security threat modeling for software engineering delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for software engineering delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for software engineering delivery** in **software engineering delivery**.
