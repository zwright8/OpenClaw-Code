...
## Metadata
```yaml
capability_id: u05110-disaster-recovery-orchestration-for-urban-planning-and-mobility
capability_name: Disaster recovery orchestration for urban planning and mobility
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for urban planning and mobility".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for urban planning and mobility** in **urban planning and mobility**.
