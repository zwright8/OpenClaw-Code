...
## Metadata
```yaml
capability_id: u05535-security-threat-modeling-for-research-and-development-labs
capability_name: Security threat modeling for research and development labs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for research and development labs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for research and development labs** in **research and development labs**.
