...
## Metadata
```yaml
capability_id: u05557-security-threat-modeling-for-eldercare-coordination
capability_name: Security threat modeling for eldercare coordination
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for eldercare coordination".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for eldercare coordination** in **eldercare coordination**.
