...
## Metadata
```yaml
capability_id: u05597-security-threat-modeling-for-knowledge-management-systems
capability_name: Security threat modeling for knowledge management systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for knowledge management systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for knowledge management systems** in **knowledge management systems**.
