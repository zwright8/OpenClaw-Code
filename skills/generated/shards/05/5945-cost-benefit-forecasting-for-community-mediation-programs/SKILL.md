...
## Metadata
```yaml
capability_id: u05945-cost-benefit-forecasting-for-community-mediation-programs
capability_name: Cost benefit forecasting for community mediation programs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for community mediation programs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for community mediation programs** in **community mediation programs**.
