...
## Metadata
```yaml
capability_id: u05830-cost-benefit-forecasting-for-fitness-and-recovery-training
capability_name: Cost benefit forecasting for fitness and recovery training
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for fitness and recovery training".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for fitness and recovery training** in **fitness and recovery training**.
