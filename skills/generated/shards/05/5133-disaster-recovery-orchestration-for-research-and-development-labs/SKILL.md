...
## Metadata
```yaml
capability_id: u05133-disaster-recovery-orchestration-for-research-and-development-labs
capability_name: Disaster recovery orchestration for research and development labs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for research and development labs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for research and development labs** in **research and development labs**.
