...
## Metadata
```yaml
capability_id: u05382-privacy-preserving-data-brokering-for-multilingual-translation-services
capability_name: Privacy preserving data brokering for multilingual translation services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for multilingual translation services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Privacy preserving data brokering for multilingual translation services** in **multilingual translation services**.
