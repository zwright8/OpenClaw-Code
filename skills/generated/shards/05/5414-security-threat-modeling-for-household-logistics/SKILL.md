...
## Metadata
```yaml
capability_id: u05414-security-threat-modeling-for-household-logistics
capability_name: Security threat modeling for household logistics
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for household logistics".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for household logistics** in **household logistics**.
