...
## Metadata
```yaml
capability_id: u05776-compliance-evidence-mapping-for-journalism-and-public-communication
capability_name: Compliance evidence mapping for journalism and public communication
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for journalism and public communication".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for journalism and public communication** in **journalism and public communication**.
