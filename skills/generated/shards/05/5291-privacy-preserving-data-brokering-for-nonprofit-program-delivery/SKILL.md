...
## Metadata
```yaml
capability_id: u05291-privacy-preserving-data-brokering-for-nonprofit-program-delivery
capability_name: Privacy preserving data brokering for nonprofit program delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for nonprofit program delivery".
  domain_scope:
    type: string
    description: Task scope and decision context for nonprofit program delivery.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for nonprofit program delivery** in **nonprofit program delivery**.
