...
## Metadata
```yaml
capability_id: u05588-security-threat-modeling-for-remote-team-collaboration
capability_name: Security threat modeling for remote team collaboration
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for remote team collaboration".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for remote team collaboration** in **remote team collaboration**.
