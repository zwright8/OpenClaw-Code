...
## Metadata
```yaml
capability_id: u05665-compliance-evidence-mapping-for-design-and-user-research
capability_name: Compliance evidence mapping for design and user research
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for design and user research".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for design and user research** in **design and user research**.
