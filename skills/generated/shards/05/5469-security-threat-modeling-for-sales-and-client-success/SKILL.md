...
## Metadata
```yaml
capability_id: u05469-security-threat-modeling-for-sales-and-client-success
capability_name: Security threat modeling for sales and client success
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for sales and client success".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for sales and client success** in **sales and client success**.
