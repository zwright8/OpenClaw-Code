...
## Metadata
```yaml
capability_id: u05973-cost-benefit-forecasting-for-music-and-creative-practice
capability_name: Cost benefit forecasting for music and creative practice
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for music and creative practice".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for music and creative practice** in **music and creative practice**.
