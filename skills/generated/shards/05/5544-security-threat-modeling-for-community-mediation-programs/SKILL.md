...
## Metadata
```yaml
capability_id: u05544-security-threat-modeling-for-community-mediation-programs
capability_name: Security threat modeling for community mediation programs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for community mediation programs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for community mediation programs** in **community mediation programs**.
