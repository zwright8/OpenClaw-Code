...
## Metadata
```yaml
capability_id: u05979-cost-benefit-forecasting-for-journalism-and-public-communication
capability_name: Cost benefit forecasting for journalism and public communication
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for journalism and public communication".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for journalism and public communication** in **journalism and public communication**.
