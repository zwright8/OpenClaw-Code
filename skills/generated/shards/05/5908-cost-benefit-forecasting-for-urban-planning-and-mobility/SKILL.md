...
## Metadata
```yaml
capability_id: u05908-cost-benefit-forecasting-for-urban-planning-and-mobility
capability_name: Cost benefit forecasting for urban planning and mobility
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for urban planning and mobility".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for urban planning and mobility** in **urban planning and mobility**.
