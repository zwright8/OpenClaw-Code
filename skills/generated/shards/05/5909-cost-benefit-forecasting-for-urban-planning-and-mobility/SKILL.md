...
| Feature flag | `skill_05909_cost-benefit-forecasting` |
| Release cycles | `2` |

## Why This Skill Exists
Use cost-benefit forecasting in urban planning and mobility with emphasis on throughput, reliability, leverage, and execution speed.
...
5. Run unit, integration, simulation, and regression suites for Cost-Benefit Forecasting for urban planning and mobility under hyper-productive autonomy conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Cost-Benefit Forecasting for urban planning and mobility under hyper-productive autonomy conditions.
...
1. `OR-Tools/Pyomo` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `cost-benefit-forecasting-artifact-urban-planning-and-mobility`.
2. `Pandas/Polars` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `cost-benefit-forecasting-artifact-urban-planning-and-mobility`.
3. `Great Expectations` -> auth preflight, execute read/query call(s), normalize output, and attach trace to `cost-benefit-forecasting-artifact-urban-planning-and-mobility`.
