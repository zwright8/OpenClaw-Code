...
## Metadata
```yaml
capability_id: u05150-disaster-recovery-orchestration-for-civic-participation-platforms
capability_name: Disaster recovery orchestration for civic participation platforms
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for civic participation platforms".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for civic participation platforms** in **civic participation platforms**.
