...
## Metadata
```yaml
capability_id: u05422-security-threat-modeling-for-nutrition-and-meal-planning
capability_name: Security threat modeling for nutrition and meal planning
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for nutrition and meal planning".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for nutrition and meal planning** in **nutrition and meal planning**.
