...
## Metadata
```yaml
capability_id: u05297-privacy-preserving-data-brokering-for-disaster-response-networks
capability_name: Privacy preserving data brokering for disaster response networks
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for disaster response networks".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Privacy preserving data brokering for disaster response networks** in **disaster response networks**.
