...
## Metadata
```yaml
capability_id: u05119-disaster-recovery-orchestration-for-supply-chain-resilience
capability_name: Disaster recovery orchestration for supply chain resilience
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for supply chain resilience".
  domain_scope:
    type: string
    description: Task scope and decision context for supply chain resilience.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Disaster recovery orchestration for supply chain resilience** in **supply chain resilience**.
