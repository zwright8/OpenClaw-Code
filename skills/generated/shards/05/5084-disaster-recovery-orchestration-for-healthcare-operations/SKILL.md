...
## Metadata
```yaml
capability_id: u05084-disaster-recovery-orchestration-for-healthcare-operations
capability_name: Disaster recovery orchestration for healthcare operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for healthcare operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for healthcare operations** in **healthcare operations**.
