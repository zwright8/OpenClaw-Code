...
## Metadata
```yaml
capability_id: u05548-security-threat-modeling-for-civic-participation-platforms
capability_name: Security threat modeling for civic participation platforms
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for civic participation platforms".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for civic participation platforms** in **civic participation platforms**.
