...
## Metadata
```yaml
capability_id: u05162-disaster-recovery-orchestration-for-childcare-support-systems
capability_name: Disaster recovery orchestration for childcare support systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for childcare support systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for childcare support systems** in **childcare support systems**.
