...
## Metadata
```yaml
capability_id: u05609-compliance-evidence-mapping-for-family-caregiving-systems
capability_name: Compliance evidence mapping for family caregiving systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for family caregiving systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for family caregiving systems** in **family caregiving systems**.
