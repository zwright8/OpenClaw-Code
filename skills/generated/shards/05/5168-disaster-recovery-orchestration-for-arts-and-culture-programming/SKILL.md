...
## Metadata
```yaml
capability_id: u05168-disaster-recovery-orchestration-for-arts-and-culture-programming
capability_name: Disaster recovery orchestration for arts and culture programming
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for arts and culture programming".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for arts and culture programming** in **arts and culture programming**.
