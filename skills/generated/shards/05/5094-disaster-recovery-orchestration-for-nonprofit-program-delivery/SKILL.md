...
## Metadata
```yaml
capability_id: u05094-disaster-recovery-orchestration-for-nonprofit-program-delivery
capability_name: Disaster recovery orchestration for nonprofit program delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for nonprofit program delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for nonprofit program delivery** in **nonprofit program delivery**.
