...
| Feature flag | `skill_05906_cost-benefit-forecasting` |
| Release cycles | `2` |

## Why This Skill Exists
Use cost-benefit forecasting in urban planning and mobility with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Cost-Benefit Forecasting for urban planning and mobility under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Cost-Benefit Forecasting for urban planning and mobility under maximally truth-seeking conditions.
