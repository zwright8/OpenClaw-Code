...
## Metadata
```yaml
capability_id: u05429-security-threat-modeling-for-fitness-and-recovery-training
capability_name: Security threat modeling for fitness and recovery training
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for fitness and recovery training".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for fitness and recovery training** in **fitness and recovery training**.
