...
## Metadata
```yaml
capability_id: u05642-compliance-evidence-mapping-for-career-development-pathways
capability_name: Compliance evidence mapping for career development pathways
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for career development pathways".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for career development pathways** in **career development pathways**.
