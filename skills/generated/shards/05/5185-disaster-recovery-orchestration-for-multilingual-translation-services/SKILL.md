...
## Metadata
```yaml
capability_id: u05185-disaster-recovery-orchestration-for-multilingual-translation-services
capability_name: Disaster recovery orchestration for multilingual translation services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for multilingual translation services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for multilingual translation services** in **multilingual translation services**.
