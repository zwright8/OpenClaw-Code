...
## Metadata
```yaml
capability_id: u05720-compliance-evidence-mapping-for-supply-chain-resilience
capability_name: Compliance evidence mapping for supply chain resilience
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for supply chain resilience".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for supply chain resilience** in **supply chain resilience**.
