...
description: Operate the "Cost benefit forecasting for music and creative practice" capability in production for music and creative practice workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Cost benefit forecasting for music and creative practice` in music and creative practice and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Cost benefit forecasting for music and creative practice** outcomes (not generic brainstorming).
...
1. **Incident stabilization in music and creative practice" capability in production for music and creative practice workflows**
   - Input: noisy upstream payload requiring cost benefit forecasting for music and creative practice normalization/assessment.
