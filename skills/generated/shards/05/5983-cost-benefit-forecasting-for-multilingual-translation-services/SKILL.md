...
## Metadata
```yaml
capability_id: u05983-cost-benefit-forecasting-for-multilingual-translation-services
capability_name: Cost benefit forecasting for multilingual translation services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for multilingual translation services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for multilingual translation services** in **multilingual translation services**.
