...
## Metadata
```yaml
capability_id: u05871-cost-benefit-forecasting-for-marketing-and-storytelling
capability_name: Cost benefit forecasting for marketing and storytelling
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for marketing and storytelling".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for marketing and storytelling** in **marketing and storytelling**.
