...
## Metadata
```yaml
capability_id: u05405-security-threat-modeling-for-personal-health-routines
capability_name: Security threat modeling for personal health routines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for personal health routines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for personal health routines** in **personal health routines**.
