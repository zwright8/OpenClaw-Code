...
## Metadata
```yaml
capability_id: u05025-disaster-recovery-orchestration-for-nutrition-and-meal-planning
capability_name: Disaster recovery orchestration for nutrition and meal planning
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for nutrition and meal planning".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for nutrition and meal planning** in **nutrition and meal planning**.
