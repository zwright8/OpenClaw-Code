...
## Metadata
```yaml
capability_id: u05887-cost-benefit-forecasting-for-education-support-services
capability_name: Cost benefit forecasting for education support services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for education support services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for education support services** in **education support services**.
