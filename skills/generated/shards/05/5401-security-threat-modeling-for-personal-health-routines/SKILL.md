...
description: Operate the "Security threat modeling for personal health routines" capability in production for personal health routines workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Security threat modeling for personal health routines` in personal health routines and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Security threat modeling for personal health routines** outcomes (not generic brainstorming).
...
1. **Incident stabilization in personal health routines" capability in production for personal health routines workflows**
   - Input: noisy upstream payload requiring security threat modeling for personal health routines normalization/assessment.
