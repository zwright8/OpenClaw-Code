...
## Metadata
```yaml
capability_id: u05896-cost-benefit-forecasting-for-disaster-response-networks
capability_name: Cost benefit forecasting for disaster response networks
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for disaster response networks".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for disaster response networks** in **disaster response networks**.
