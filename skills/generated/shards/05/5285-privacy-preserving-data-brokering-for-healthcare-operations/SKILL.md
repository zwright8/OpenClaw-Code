...
## Metadata
```yaml
capability_id: u05285-privacy-preserving-data-brokering-for-healthcare-operations
capability_name: Privacy preserving data brokering for healthcare operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for healthcare operations".
  domain_scope:
    type: string
    description: Task scope and decision context for healthcare operations.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for healthcare operations** in **healthcare operations**.
