...
## Metadata
```yaml
capability_id: u05751-compliance-evidence-mapping-for-accessibility-services
capability_name: Compliance evidence mapping for accessibility services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for accessibility services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for accessibility services** in **accessibility services**.
