...
## Metadata
```yaml
capability_id: u05672-compliance-evidence-mapping-for-marketing-and-storytelling
capability_name: Compliance evidence mapping for marketing and storytelling
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for marketing and storytelling".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for marketing and storytelling** in **marketing and storytelling**.
