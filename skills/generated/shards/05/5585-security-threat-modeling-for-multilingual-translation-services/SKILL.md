...
## Metadata
```yaml
capability_id: u05585-security-threat-modeling-for-multilingual-translation-services
capability_name: Security threat modeling for multilingual translation services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for multilingual translation services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for multilingual translation services** in **multilingual translation services**.
