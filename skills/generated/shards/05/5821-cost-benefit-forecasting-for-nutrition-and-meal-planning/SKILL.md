...
## Metadata
```yaml
capability_id: u05821-cost-benefit-forecasting-for-nutrition-and-meal-planning
capability_name: Cost benefit forecasting for nutrition and meal planning
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for nutrition and meal planning".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for nutrition and meal planning** in **nutrition and meal planning**.
