...
## Metadata
```yaml
capability_id: u05325-privacy-preserving-data-brokering-for-manufacturing-quality-assurance
capability_name: Privacy preserving data brokering for manufacturing quality assurance
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for manufacturing quality assurance".
  domain_scope:
    type: string
    description: Task scope and decision context for manufacturing quality assurance.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for manufacturing quality assurance** in **manufacturing quality assurance**.
