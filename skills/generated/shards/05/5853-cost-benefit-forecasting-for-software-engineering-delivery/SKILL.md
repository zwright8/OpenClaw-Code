...
## Metadata
```yaml
capability_id: u05853-cost-benefit-forecasting-for-software-engineering-delivery
capability_name: Cost benefit forecasting for software engineering delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for software engineering delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for software engineering delivery** in **software engineering delivery**.
