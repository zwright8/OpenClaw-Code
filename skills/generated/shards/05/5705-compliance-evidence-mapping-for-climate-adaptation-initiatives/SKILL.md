...
## Metadata
```yaml
capability_id: u05705-compliance-evidence-mapping-for-climate-adaptation-initiatives
capability_name: Compliance evidence mapping for climate adaptation initiatives
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for climate adaptation initiatives".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for climate adaptation initiatives** in **climate adaptation initiatives**.
