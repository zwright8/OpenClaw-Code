...
## Metadata
```yaml
capability_id: u05314-privacy-preserving-data-brokering-for-agriculture-and-food-systems
capability_name: Privacy preserving data brokering for agriculture and food systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for agriculture and food systems".
  domain_scope:
    type: string
    description: Task scope and decision context for agriculture and food systems.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for agriculture and food systems** in **agriculture and food systems**.
