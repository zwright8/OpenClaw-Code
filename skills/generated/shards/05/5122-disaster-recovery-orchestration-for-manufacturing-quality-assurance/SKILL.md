...
## Metadata
```yaml
capability_id: u05122-disaster-recovery-orchestration-for-manufacturing-quality-assurance
capability_name: Disaster recovery orchestration for manufacturing quality assurance
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for manufacturing quality assurance".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for manufacturing quality assurance** in **manufacturing quality assurance**.
