...
## Metadata
```yaml
capability_id: u05515-security-threat-modeling-for-agriculture-and-food-systems
capability_name: Security threat modeling for agriculture and food systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for agriculture and food systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for agriculture and food systems** in **agriculture and food systems**.
