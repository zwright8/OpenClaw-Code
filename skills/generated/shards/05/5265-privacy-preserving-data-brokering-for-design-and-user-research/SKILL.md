...
## Metadata
```yaml
capability_id: u05265-privacy-preserving-data-brokering-for-design-and-user-research
capability_name: Privacy preserving data brokering for design and user research
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for design and user research".
  domain_scope:
    type: string
    description: Task scope and decision context for design and user research.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for design and user research** in **design and user research**.
