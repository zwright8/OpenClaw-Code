...
## Metadata
```yaml
capability_id: u05580-security-threat-modeling-for-journalism-and-public-communication
capability_name: Security threat modeling for journalism and public communication
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for journalism and public communication".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for journalism and public communication** in **journalism and public communication**.
