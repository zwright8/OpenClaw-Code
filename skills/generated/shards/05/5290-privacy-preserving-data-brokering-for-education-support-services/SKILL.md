...
## Metadata
```yaml
capability_id: u05290-privacy-preserving-data-brokering-for-education-support-services
capability_name: Privacy preserving data brokering for education support services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for education support services".
  domain_scope:
    type: string
    description: Task scope and decision context for education support services.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for education support services** in **education support services**.
