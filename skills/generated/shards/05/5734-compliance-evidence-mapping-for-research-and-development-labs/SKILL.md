...
## Metadata
```yaml
capability_id: u05734-compliance-evidence-mapping-for-research-and-development-labs
capability_name: Compliance evidence mapping for research and development labs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for research and development labs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for research and development labs** in **research and development labs**.
