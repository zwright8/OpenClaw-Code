...
description: Operate the "Disaster recovery orchestration for music and creative practice" capability in production for music and creative practice workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
```yaml
capability_id: u05174-disaster-recovery-orchestration-for-music-and-creative-practice
capability_name: Disaster recovery orchestration for music and creative practice
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for music and creative practice".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for music and creative practice** in **music and creative practice**.
