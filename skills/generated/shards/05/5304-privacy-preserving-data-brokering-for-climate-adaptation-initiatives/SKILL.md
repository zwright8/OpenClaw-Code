...
## Metadata
```yaml
capability_id: u05304-privacy-preserving-data-brokering-for-climate-adaptation-initiatives
capability_name: Privacy preserving data brokering for climate adaptation initiatives
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for climate adaptation initiatives".
  domain_scope:
    type: string
    description: Task scope and decision context for climate adaptation initiatives.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for climate adaptation initiatives** in **climate adaptation initiatives**.
