...
## Metadata
```yaml
capability_id: u05127-disaster-recovery-orchestration-for-cybersecurity-operations
capability_name: Disaster recovery orchestration for cybersecurity operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for cybersecurity operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for cybersecurity operations** in **cybersecurity operations**.
