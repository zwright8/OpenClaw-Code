...
## Metadata
```yaml
capability_id: u05160-disaster-recovery-orchestration-for-eldercare-coordination
capability_name: Disaster recovery orchestration for eldercare coordination
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for eldercare coordination".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for eldercare coordination** in **eldercare coordination**.
