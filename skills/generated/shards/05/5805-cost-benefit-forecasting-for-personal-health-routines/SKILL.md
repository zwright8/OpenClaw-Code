...
## Metadata
```yaml
capability_id: u05805-cost-benefit-forecasting-for-personal-health-routines
capability_name: Cost benefit forecasting for personal health routines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for personal health routines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for personal health routines** in **personal health routines**.
