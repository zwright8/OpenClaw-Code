...
## Metadata
```yaml
capability_id: u05096-disaster-recovery-orchestration-for-disaster-response-networks
capability_name: Disaster recovery orchestration for disaster response networks
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Disaster recovery orchestration for disaster response networks".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Disaster recovery orchestration for disaster response networks** in **disaster response networks**.
