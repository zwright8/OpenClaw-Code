...
## Metadata
```yaml
capability_id: u05481-security-threat-modeling-for-healthcare-operations
capability_name: Security threat modeling for healthcare operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Security threat modeling for healthcare operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Security threat modeling for healthcare operations** in **healthcare operations**.
