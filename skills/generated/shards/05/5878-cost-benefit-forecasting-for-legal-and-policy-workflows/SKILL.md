...
## Metadata
```yaml
capability_id: u05878-cost-benefit-forecasting-for-legal-and-policy-workflows
capability_name: Cost benefit forecasting for legal and policy workflows
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for legal and policy workflows".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for legal and policy workflows** in **legal and policy workflows**.
