...
## Metadata
```yaml
capability_id: u05904-cost-benefit-forecasting-for-climate-adaptation-initiatives
capability_name: Cost benefit forecasting for climate adaptation initiatives
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Cost benefit forecasting for climate adaptation initiatives".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Cost benefit forecasting for climate adaptation initiatives** in **climate adaptation initiatives**.
