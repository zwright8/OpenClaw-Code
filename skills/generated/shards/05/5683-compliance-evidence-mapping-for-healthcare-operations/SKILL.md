...
## Metadata
```yaml
capability_id: u05683-compliance-evidence-mapping-for-healthcare-operations
capability_name: Compliance evidence mapping for healthcare operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for healthcare operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for healthcare operations** in **healthcare operations**.
