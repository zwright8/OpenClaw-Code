...
## Metadata
```yaml
capability_id: u05238-privacy-preserving-data-brokering-for-lifelong-learning-plans
capability_name: Privacy preserving data brokering for lifelong learning plans
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for lifelong learning plans".
  domain_scope:
    type: string
    description: Task scope and decision context for lifelong learning plans.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for lifelong learning plans** in **lifelong learning plans**.
