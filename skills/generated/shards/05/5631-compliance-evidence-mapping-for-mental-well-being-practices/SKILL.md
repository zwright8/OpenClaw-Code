...
## Metadata
```yaml
capability_id: u05631-compliance-evidence-mapping-for-mental-well-being-practices
capability_name: Compliance evidence mapping for mental well being practices
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Compliance evidence mapping for mental well being practices".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Compliance evidence mapping for mental well being practices** in **mental well being practices**.
