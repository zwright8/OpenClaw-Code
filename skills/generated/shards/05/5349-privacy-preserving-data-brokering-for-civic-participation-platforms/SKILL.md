...
## Metadata
```yaml
capability_id: u05349-privacy-preserving-data-brokering-for-civic-participation-platforms
capability_name: Privacy preserving data brokering for civic participation platforms
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Privacy preserving data brokering for civic participation platforms".
  domain_scope:
    type: string
    description: Task scope and decision context for civic participation platforms.
  source_inputs:
    type: array
    items: object
...
3. Execute capability workflow for **Privacy preserving data brokering for civic participation platforms** in **civic participation platforms**.
