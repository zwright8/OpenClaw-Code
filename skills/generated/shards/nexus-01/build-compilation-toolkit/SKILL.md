...
## Overview
Configure reproducible builds and diagnose compilation/linking failures.
...
- Compile and link artifacts
- Generate code from schemas/interfaces
- Tune build performance and caching
