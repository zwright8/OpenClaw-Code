...
## Metadata
- **Skill ID:** `u08133-creative-ideation-facilitation-for-research-and-development-labs`
- **Capability:** Creative Ideation Facilitation for research and development labs
- **Domain:** research and development labs
- **Purpose:** Operate the "Creative Ideation Facilitation for research and development labs" capability in production for research and development labs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
