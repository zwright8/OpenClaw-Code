...
## Metadata
- **Skill ID:** `u08360-beauty-pattern-detection-for-eldercare-coordination`
- **Capability:** Beauty Pattern Detection for eldercare coordination
- **Domain:** eldercare coordination
- **Purpose:** Operate the "Beauty Pattern Detection for eldercare coordination" capability in production for eldercare coordination workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
