...
## Metadata
- **Skill ID:** `u08854-ethical-dilemma-navigation-for-software-engineering-delivery`
- **Capability:** Ethical Dilemma Navigation for software engineering delivery
- **Domain:** software engineering delivery
- **Purpose:** Operate the "Ethical Dilemma Navigation for software engineering delivery" capability in production for software engineering delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
