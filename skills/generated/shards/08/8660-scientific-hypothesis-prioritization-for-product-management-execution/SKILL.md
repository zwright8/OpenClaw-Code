...
## Metadata
- **Skill ID:** `u08660-scientific-hypothesis-prioritization-for-product-management-execution`
- **Capability:** Scientific Hypothesis Prioritization for product management execution
- **Domain:** product management execution
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for product management execution" capability in production for product management execution workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
