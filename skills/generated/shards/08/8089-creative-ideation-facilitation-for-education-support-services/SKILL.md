...
## Metadata
- **Skill ID:** `u08089-creative-ideation-facilitation-for-education-support-services`
- **Capability:** Creative Ideation Facilitation for education support services
- **Domain:** education support services
- **Purpose:** Operate the "Creative Ideation Facilitation for education support services" capability in production for education support services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
