...
## Metadata
- **Skill ID:** `u08718-scientific-hypothesis-prioritization-for-supply-chain-resilience`
- **Capability:** Scientific Hypothesis Prioritization for supply chain resilience
- **Domain:** supply chain resilience
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for supply chain resilience" capability in production for supply chain resilience workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
