...
description: Operate the "Scientific Hypothesis Prioritization for civic participation platforms" capability in production for civic participation platforms workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Scientific Hypothesis Prioritization for civic participation platforms` in civic participation platforms and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Scientific Hypothesis Prioritization for civic participation platforms** outcomes (not generic brainstorming).
...
1. **Incident stabilization in civic participation platforms" capability in production for civic participation platforms workflows**
   - Input: noisy upstream payload requiring scientific hypothesis prioritization for civic participation platforms normalization/assessment.
