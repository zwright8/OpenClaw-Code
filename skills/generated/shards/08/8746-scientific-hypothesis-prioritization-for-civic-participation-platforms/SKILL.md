...
## Metadata
- **Skill ID:** `u08746-scientific-hypothesis-prioritization-for-civic-participation-platforms`
- **Capability:** Scientific Hypothesis Prioritization for civic participation platforms
- **Domain:** civic participation platforms
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for civic participation platforms" capability in production for civic participation platforms workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
