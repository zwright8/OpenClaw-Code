...
## Metadata
- **Skill ID:** `u08386-beauty-pattern-detection-for-remote-team-collaboration`
- **Capability:** Beauty Pattern Detection for remote team collaboration
- **Domain:** remote team collaboration
- **Purpose:** Operate the "Beauty Pattern Detection for remote team collaboration" capability in production for remote team collaboration workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
