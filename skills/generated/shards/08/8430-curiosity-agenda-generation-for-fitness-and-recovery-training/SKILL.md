...
## Metadata
- **Skill ID:** `u08430-curiosity-agenda-generation-for-fitness-and-recovery-training`
- **Capability:** Curiosity Agenda Generation for fitness and recovery training
- **Domain:** fitness and recovery training
- **Purpose:** Operate the "Curiosity Agenda Generation for fitness and recovery training" capability in production for fitness and recovery training workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
