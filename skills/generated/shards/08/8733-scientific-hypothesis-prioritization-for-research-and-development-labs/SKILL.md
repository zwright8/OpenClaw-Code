...
## Metadata
- **Skill ID:** `u08733-scientific-hypothesis-prioritization-for-research-and-development-labs`
- **Capability:** Scientific Hypothesis Prioritization for research and development labs
- **Domain:** research and development labs
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for research and development labs" capability in production for research and development labs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
