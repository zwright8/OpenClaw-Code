...
## Metadata
- **Skill ID:** `u08736-scientific-hypothesis-prioritization-for-scientific-publishing-pipelines`
- **Capability:** Scientific Hypothesis Prioritization for scientific publishing pipelines
- **Domain:** scientific publishing pipelines
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for scientific publishing pipelines" capability in production for scientific publishing pipelines workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
