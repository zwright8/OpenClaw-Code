...
## Metadata
- **Skill ID:** `u08041-creative-ideation-facilitation-for-career-development-pathways`
- **Capability:** Creative Ideation Facilitation for career development pathways
- **Domain:** career development pathways
- **Purpose:** Operate the "Creative Ideation Facilitation for career development pathways" capability in production for career development pathways workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
