...
## Metadata
- **Skill ID:** `u08908-ethical-dilemma-navigation-for-urban-planning-and-mobility`
- **Capability:** Ethical Dilemma Navigation for urban planning and mobility
- **Domain:** urban planning and mobility
- **Purpose:** Operate the "Ethical Dilemma Navigation for urban planning and mobility" capability in production for urban planning and mobility workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
