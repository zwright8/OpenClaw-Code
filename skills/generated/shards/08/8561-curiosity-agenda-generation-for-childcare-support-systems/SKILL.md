...
## Metadata
- **Skill ID:** `u08561-curiosity-agenda-generation-for-childcare-support-systems`
- **Capability:** Curiosity Agenda Generation for childcare support systems
- **Domain:** childcare support systems
- **Purpose:** Operate the "Curiosity Agenda Generation for childcare support systems" capability in production for childcare support systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
