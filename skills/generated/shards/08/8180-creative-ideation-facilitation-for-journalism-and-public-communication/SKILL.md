...
## Metadata
- **Skill ID:** `u08180-creative-ideation-facilitation-for-journalism-and-public-communication`
- **Capability:** Creative Ideation Facilitation for journalism and public communication
- **Domain:** journalism and public communication
- **Purpose:** Operate the "Creative Ideation Facilitation for journalism and public communication" capability in production for journalism and public communication workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
