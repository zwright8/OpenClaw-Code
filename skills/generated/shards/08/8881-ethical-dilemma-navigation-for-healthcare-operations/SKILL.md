...
## Metadata
- **Skill ID:** `u08881-ethical-dilemma-navigation-for-healthcare-operations`
- **Capability:** Ethical Dilemma Navigation for healthcare operations
- **Domain:** healthcare operations
- **Purpose:** Operate the "Ethical Dilemma Navigation for healthcare operations" capability in production for healthcare operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
