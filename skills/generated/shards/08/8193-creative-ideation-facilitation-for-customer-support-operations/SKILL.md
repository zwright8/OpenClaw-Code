...
## Metadata
- **Skill ID:** `u08193-creative-ideation-facilitation-for-customer-support-operations`
- **Capability:** Creative Ideation Facilitation for customer support operations
- **Domain:** customer support operations
- **Purpose:** Operate the "Creative Ideation Facilitation for customer support operations" capability in production for customer support operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
