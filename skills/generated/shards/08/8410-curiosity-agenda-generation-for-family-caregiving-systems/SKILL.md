...
## Metadata
- **Skill ID:** `u08410-curiosity-agenda-generation-for-family-caregiving-systems`
- **Capability:** Curiosity Agenda Generation for family caregiving systems
- **Domain:** family caregiving systems
- **Purpose:** Operate the "Curiosity Agenda Generation for family caregiving systems" capability in production for family caregiving systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
