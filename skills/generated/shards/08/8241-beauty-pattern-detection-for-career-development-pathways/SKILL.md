...
## Metadata
- **Skill ID:** `u08241-beauty-pattern-detection-for-career-development-pathways`
- **Capability:** Beauty Pattern Detection for career development pathways
- **Domain:** career development pathways
- **Purpose:** Operate the "Beauty Pattern Detection for career development pathways" capability in production for career development pathways workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
