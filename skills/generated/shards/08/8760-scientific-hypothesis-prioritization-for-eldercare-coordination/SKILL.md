...
## Metadata
- **Skill ID:** `u08760-scientific-hypothesis-prioritization-for-eldercare-coordination`
- **Capability:** Scientific Hypothesis Prioritization for eldercare coordination
- **Domain:** eldercare coordination
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for eldercare coordination" capability in production for eldercare coordination workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
