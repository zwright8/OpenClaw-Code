...
## Metadata
- **Skill ID:** `u08295-beauty-pattern-detection-for-nonprofit-program-delivery`
- **Capability:** Beauty Pattern Detection for nonprofit program delivery
- **Domain:** nonprofit program delivery
- **Purpose:** Operate the "Beauty Pattern Detection for nonprofit program delivery" capability in production for nonprofit program delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
