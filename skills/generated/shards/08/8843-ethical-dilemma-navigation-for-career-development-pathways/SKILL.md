...
## Metadata
- **Skill ID:** `u08843-ethical-dilemma-navigation-for-career-development-pathways`
- **Capability:** Ethical Dilemma Navigation for career development pathways
- **Domain:** career development pathways
- **Purpose:** Operate the "Ethical Dilemma Navigation for career development pathways" capability in production for career development pathways workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
