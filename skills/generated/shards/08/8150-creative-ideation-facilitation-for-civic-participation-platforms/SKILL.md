...
## Metadata
- **Skill ID:** `u08150-creative-ideation-facilitation-for-civic-participation-platforms`
- **Capability:** Creative Ideation Facilitation for civic participation platforms
- **Domain:** civic participation platforms
- **Purpose:** Operate the "Creative Ideation Facilitation for civic participation platforms" capability in production for civic participation platforms workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
