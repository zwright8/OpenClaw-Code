...
## Metadata
- **Skill ID:** `u08352-beauty-pattern-detection-for-accessibility-services`
- **Capability:** Beauty Pattern Detection for accessibility services
- **Domain:** accessibility services
- **Purpose:** Operate the "Beauty Pattern Detection for accessibility services" capability in production for accessibility services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
