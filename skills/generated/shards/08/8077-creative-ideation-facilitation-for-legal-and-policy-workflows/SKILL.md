...
## Metadata
- **Skill ID:** `u08077-creative-ideation-facilitation-for-legal-and-policy-workflows`
- **Capability:** Creative Ideation Facilitation for legal and policy workflows
- **Domain:** legal and policy workflows
- **Purpose:** Operate the "Creative Ideation Facilitation for legal and policy workflows" capability in production for legal and policy workflows workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
