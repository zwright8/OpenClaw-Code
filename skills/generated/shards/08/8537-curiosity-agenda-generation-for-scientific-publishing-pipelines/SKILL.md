...
## Metadata
- **Skill ID:** `u08537-curiosity-agenda-generation-for-scientific-publishing-pipelines`
- **Capability:** Curiosity Agenda Generation for scientific publishing pipelines
- **Domain:** scientific publishing pipelines
- **Purpose:** Operate the "Curiosity Agenda Generation for scientific publishing pipelines" capability in production for scientific publishing pipelines workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
