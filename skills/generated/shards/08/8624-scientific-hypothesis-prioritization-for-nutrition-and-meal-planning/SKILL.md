...
## Metadata
- **Skill ID:** `u08624-scientific-hypothesis-prioritization-for-nutrition-and-meal-planning`
- **Capability:** Scientific Hypothesis Prioritization for nutrition and meal planning
- **Domain:** nutrition and meal planning
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for nutrition and meal planning" capability in production for nutrition and meal planning workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
