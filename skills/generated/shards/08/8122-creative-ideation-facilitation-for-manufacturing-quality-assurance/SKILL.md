...
description: Operate the "Creative Ideation Facilitation for manufacturing quality assurance" capability in production for manufacturing quality assurance workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Creative Ideation Facilitation for manufacturing quality assurance` in manufacturing quality assurance and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Creative Ideation Facilitation for manufacturing quality assurance** outcomes (not generic brainstorming).
...
1. **Incident stabilization in manufacturing quality assurance" capability in production for manufacturing quality assurance workflows**
   - Input: noisy upstream payload requiring creative ideation facilitation for manufacturing quality assurance normalization/assessment.
