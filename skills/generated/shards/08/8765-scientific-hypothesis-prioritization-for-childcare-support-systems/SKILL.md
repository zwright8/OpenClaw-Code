...
## Metadata
- **Skill ID:** `u08765-scientific-hypothesis-prioritization-for-childcare-support-systems`
- **Capability:** Scientific Hypothesis Prioritization for childcare support systems
- **Domain:** childcare support systems
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for childcare support systems" capability in production for childcare support systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
