...
## Metadata
- **Skill ID:** `u08552-curiosity-agenda-generation-for-accessibility-services`
- **Capability:** Curiosity Agenda Generation for accessibility services
- **Domain:** accessibility services
- **Purpose:** Operate the "Curiosity Agenda Generation for accessibility services" capability in production for accessibility services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
