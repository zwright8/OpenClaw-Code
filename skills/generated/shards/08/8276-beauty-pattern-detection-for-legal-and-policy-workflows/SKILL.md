...
## Metadata
- **Skill ID:** `u08276-beauty-pattern-detection-for-legal-and-policy-workflows`
- **Capability:** Beauty Pattern Detection for legal and policy workflows
- **Domain:** legal and policy workflows
- **Purpose:** Operate the "Beauty Pattern Detection for legal and policy workflows" capability in production for legal and policy workflows workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
