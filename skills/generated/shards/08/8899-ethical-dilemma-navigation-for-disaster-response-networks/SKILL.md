...
## Metadata
- **Skill ID:** `u08899-ethical-dilemma-navigation-for-disaster-response-networks`
- **Capability:** Ethical Dilemma Navigation for disaster response networks
- **Domain:** disaster response networks
- **Purpose:** Operate the "Ethical Dilemma Navigation for disaster response networks" capability in production for disaster response networks workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
