...
## Metadata
- **Skill ID:** `u08670-scientific-hypothesis-prioritization-for-sales-and-client-success`
- **Capability:** Scientific Hypothesis Prioritization for sales and client success
- **Domain:** sales and client success
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for sales and client success" capability in production for sales and client success workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
