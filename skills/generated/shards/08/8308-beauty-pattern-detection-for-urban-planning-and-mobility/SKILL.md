...
## Metadata
- **Skill ID:** `u08308-beauty-pattern-detection-for-urban-planning-and-mobility`
- **Capability:** Beauty Pattern Detection for urban planning and mobility
- **Domain:** urban planning and mobility
- **Purpose:** Operate the "Beauty Pattern Detection for urban planning and mobility" capability in production for urban planning and mobility workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
