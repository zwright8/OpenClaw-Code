...
## Metadata
- **Skill ID:** `u08381-beauty-pattern-detection-for-multilingual-translation-services`
- **Capability:** Beauty Pattern Detection for multilingual translation services
- **Domain:** multilingual translation services
- **Purpose:** Operate the "Beauty Pattern Detection for multilingual translation services" capability in production for multilingual translation services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
