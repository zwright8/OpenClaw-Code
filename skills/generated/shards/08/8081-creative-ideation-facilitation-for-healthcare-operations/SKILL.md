...
## Metadata
- **Skill ID:** `u08081-creative-ideation-facilitation-for-healthcare-operations`
- **Capability:** Creative Ideation Facilitation for healthcare operations
- **Domain:** healthcare operations
- **Purpose:** Operate the "Creative Ideation Facilitation for healthcare operations" capability in production for healthcare operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
