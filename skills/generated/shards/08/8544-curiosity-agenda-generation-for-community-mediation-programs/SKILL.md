...
## Metadata
- **Skill ID:** `u08544-curiosity-agenda-generation-for-community-mediation-programs`
- **Capability:** Curiosity Agenda Generation for community mediation programs
- **Domain:** community mediation programs
- **Purpose:** Operate the "Curiosity Agenda Generation for community mediation programs" capability in production for community mediation programs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
