...
## Metadata
- **Skill ID:** `u08928-ethical-dilemma-navigation-for-cybersecurity-operations`
- **Capability:** Ethical Dilemma Navigation for cybersecurity operations
- **Domain:** cybersecurity operations
- **Purpose:** Operate the "Ethical Dilemma Navigation for cybersecurity operations" capability in production for cybersecurity operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
