...
description: Operate the "Ethical Dilemma Navigation for arts and culture programming" capability in production for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Ethical Dilemma Navigation for arts and culture programming` in arts and culture programming and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Ethical Dilemma Navigation for arts and culture programming** outcomes (not generic brainstorming).
...
1. **Incident stabilization in arts and culture programming" capability in production for arts and culture programming workflows**
   - Input: noisy upstream payload requiring ethical dilemma navigation for arts and culture programming normalization/assessment.
