...
## Metadata
- **Skill ID:** `u08163-creative-ideation-facilitation-for-childcare-support-systems`
- **Capability:** Creative Ideation Facilitation for childcare support systems
- **Domain:** childcare support systems
- **Purpose:** Operate the "Creative Ideation Facilitation for childcare support systems" capability in production for childcare support systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
