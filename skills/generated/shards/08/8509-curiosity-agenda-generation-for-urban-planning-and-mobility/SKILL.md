...
| Feature flag | `skill_08509_curiosity-agenda-generation` |
| Release cycles | `2` |

## Why This Skill Exists
Use curiosity agenda generation in urban planning and mobility with emphasis on throughput, reliability, leverage, and execution speed.
...
5. Run unit, integration, simulation, and regression suites for Curiosity Agenda Generation for urban planning and mobility under hyper-productive autonomy conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Curiosity Agenda Generation for urban planning and mobility under hyper-productive autonomy conditions.
...
1. `Frontier model runtime` -> auth preflight, execute model inference call(s), normalize output, and attach trace to `curiosity-agenda-generation-artifact-urban-planning-and-mobility`.
2. `Vector memory store (optional)` -> auth preflight, execute read/query call(s), normalize output, and attach trace to `curiosity-agenda-generation-artifact-urban-planning-and-mobility`.
