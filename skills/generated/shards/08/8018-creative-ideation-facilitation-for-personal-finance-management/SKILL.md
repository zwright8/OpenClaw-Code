...
description: Operate the "Creative Ideation Facilitation for personal finance management" capability in production for personal finance management workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Creative Ideation Facilitation for personal finance management` in personal finance management and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Creative Ideation Facilitation for personal finance management** outcomes (not generic brainstorming).
...
1. **Incident stabilization in personal finance management" capability in production for personal finance management workflows**
   - Input: noisy upstream payload requiring creative ideation facilitation for personal finance management normalization/assessment.
