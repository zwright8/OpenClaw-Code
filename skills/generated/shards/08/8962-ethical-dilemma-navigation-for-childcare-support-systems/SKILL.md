...
## Metadata
- **Skill ID:** `u08962-ethical-dilemma-navigation-for-childcare-support-systems`
- **Capability:** Ethical Dilemma Navigation for childcare support systems
- **Domain:** childcare support systems
- **Purpose:** Operate the "Ethical Dilemma Navigation for childcare support systems" capability in production for childcare support systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
