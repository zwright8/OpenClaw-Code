...
## Metadata
- **Skill ID:** `u08457-curiosity-agenda-generation-for-product-management-execution`
- **Capability:** Curiosity Agenda Generation for product management execution
- **Domain:** product management execution
- **Purpose:** Operate the "Curiosity Agenda Generation for product management execution" capability in production for product management execution workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
