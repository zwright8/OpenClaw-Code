...
## Metadata
- **Skill ID:** `u08058-creative-ideation-facilitation-for-product-management-execution`
- **Capability:** Creative Ideation Facilitation for product management execution
- **Domain:** product management execution
- **Purpose:** Operate the "Creative Ideation Facilitation for product management execution" capability in production for product management execution workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
