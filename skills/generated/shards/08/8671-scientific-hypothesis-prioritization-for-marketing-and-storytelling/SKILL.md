...
## Metadata
- **Skill ID:** `u08671-scientific-hypothesis-prioritization-for-marketing-and-storytelling`
- **Capability:** Scientific Hypothesis Prioritization for marketing and storytelling
- **Domain:** marketing and storytelling
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for marketing and storytelling" capability in production for marketing and storytelling workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
