...
## Metadata
- **Skill ID:** `u08655-scientific-hypothesis-prioritization-for-software-engineering-delivery`
- **Capability:** Scientific Hypothesis Prioritization for software engineering delivery
- **Domain:** software engineering delivery
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for software engineering delivery" capability in production for software engineering delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
