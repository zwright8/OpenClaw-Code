...
## Metadata
- **Skill ID:** `u08977-ethical-dilemma-navigation-for-journalism-and-public-communication`
- **Capability:** Ethical Dilemma Navigation for journalism and public communication
- **Domain:** journalism and public communication
- **Purpose:** Operate the "Ethical Dilemma Navigation for journalism and public communication" capability in production for journalism and public communication workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
