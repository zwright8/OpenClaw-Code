...
## Metadata
- **Skill ID:** `u08488-curiosity-agenda-generation-for-education-support-services`
- **Capability:** Curiosity Agenda Generation for education support services
- **Domain:** education support services
- **Purpose:** Operate the "Curiosity Agenda Generation for education support services" capability in production for education support services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
