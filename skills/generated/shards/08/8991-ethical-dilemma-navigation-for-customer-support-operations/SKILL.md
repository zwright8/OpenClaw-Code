...
| Feature flag | `skill_08991_ethical-dilemma-navigation` |
| Release cycles | `2` |

## Why This Skill Exists
Use ethical dilemma navigation in customer support operations with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Ethical Dilemma Navigation for customer support operations under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Ethical Dilemma Navigation for customer support operations under maximally truth-seeking conditions.
