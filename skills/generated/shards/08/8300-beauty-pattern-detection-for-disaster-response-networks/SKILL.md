...
## Metadata
- **Skill ID:** `u08300-beauty-pattern-detection-for-disaster-response-networks`
- **Capability:** Beauty Pattern Detection for disaster response networks
- **Domain:** disaster response networks
- **Purpose:** Operate the "Beauty Pattern Detection for disaster response networks" capability in production for disaster response networks workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
