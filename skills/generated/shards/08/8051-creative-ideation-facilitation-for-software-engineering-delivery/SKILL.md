...
## Metadata
- **Skill ID:** `u08051-creative-ideation-facilitation-for-software-engineering-delivery`
- **Capability:** Creative Ideation Facilitation for software engineering delivery
- **Domain:** software engineering delivery
- **Purpose:** Operate the "Creative Ideation Facilitation for software engineering delivery" capability in production for software engineering delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
