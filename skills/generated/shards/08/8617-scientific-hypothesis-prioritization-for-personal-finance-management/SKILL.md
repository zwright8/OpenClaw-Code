...
## Metadata
- **Skill ID:** `u08617-scientific-hypothesis-prioritization-for-personal-finance-management`
- **Capability:** Scientific Hypothesis Prioritization for personal finance management
- **Domain:** personal finance management
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for personal finance management" capability in production for personal finance management workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
