...
## Metadata
- **Skill ID:** `u08816-ethical-dilemma-navigation-for-personal-finance-management`
- **Capability:** Ethical Dilemma Navigation for personal finance management
- **Domain:** personal finance management
- **Purpose:** Operate the "Ethical Dilemma Navigation for personal finance management" capability in production for personal finance management workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
