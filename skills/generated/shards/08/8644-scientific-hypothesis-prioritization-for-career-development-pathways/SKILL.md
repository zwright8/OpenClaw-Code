...
## Metadata
- **Skill ID:** `u08644-scientific-hypothesis-prioritization-for-career-development-pathways`
- **Capability:** Scientific Hypothesis Prioritization for career development pathways
- **Domain:** career development pathways
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for career development pathways" capability in production for career development pathways workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
