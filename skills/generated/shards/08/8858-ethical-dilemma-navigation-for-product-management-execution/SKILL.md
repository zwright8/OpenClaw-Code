...
## Metadata
- **Skill ID:** `u08858-ethical-dilemma-navigation-for-product-management-execution`
- **Capability:** Ethical Dilemma Navigation for product management execution
- **Domain:** product management execution
- **Purpose:** Operate the "Ethical Dilemma Navigation for product management execution" capability in production for product management execution workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
