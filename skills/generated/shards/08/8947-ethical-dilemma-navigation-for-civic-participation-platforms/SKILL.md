...
## Metadata
- **Skill ID:** `u08947-ethical-dilemma-navigation-for-civic-participation-platforms`
- **Capability:** Ethical Dilemma Navigation for civic participation platforms
- **Domain:** civic participation platforms
- **Purpose:** Operate the "Ethical Dilemma Navigation for civic participation platforms" capability in production for civic participation platforms workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
