...
| Feature flag | `skill_08947_ethical-dilemma-navigation` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Ethical Dilemma Navigation for civic participation platforms under pro-humanity impact conditions.
