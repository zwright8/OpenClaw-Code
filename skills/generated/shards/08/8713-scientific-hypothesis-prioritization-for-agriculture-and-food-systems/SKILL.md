...
## Metadata
- **Skill ID:** `u08713-scientific-hypothesis-prioritization-for-agriculture-and-food-systems`
- **Capability:** Scientific Hypothesis Prioritization for agriculture and food systems
- **Domain:** agriculture and food systems
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for agriculture and food systems" capability in production for agriculture and food systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
