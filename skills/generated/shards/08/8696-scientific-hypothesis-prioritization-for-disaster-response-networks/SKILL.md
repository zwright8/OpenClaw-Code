...
## Metadata
- **Skill ID:** `u08696-scientific-hypothesis-prioritization-for-disaster-response-networks`
- **Capability:** Scientific Hypothesis Prioritization for disaster response networks
- **Domain:** disaster response networks
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for disaster response networks" capability in production for disaster response networks workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
