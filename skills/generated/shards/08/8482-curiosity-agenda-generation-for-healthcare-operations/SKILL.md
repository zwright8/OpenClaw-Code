...
## Metadata
- **Skill ID:** `u08482-curiosity-agenda-generation-for-healthcare-operations`
- **Capability:** Curiosity Agenda Generation for healthcare operations
- **Domain:** healthcare operations
- **Purpose:** Operate the "Curiosity Agenda Generation for healthcare operations" capability in production for healthcare operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
