...
## Metadata
- **Skill ID:** `u08140-creative-ideation-facilitation-for-scientific-publishing-pipelines`
- **Capability:** Creative Ideation Facilitation for scientific publishing pipelines
- **Domain:** scientific publishing pipelines
- **Purpose:** Operate the "Creative Ideation Facilitation for scientific publishing pipelines" capability in production for scientific publishing pipelines workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
