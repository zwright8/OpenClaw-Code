...
## Metadata
- **Skill ID:** `u08889-ethical-dilemma-navigation-for-education-support-services`
- **Capability:** Ethical Dilemma Navigation for education support services
- **Domain:** education support services
- **Purpose:** Operate the "Ethical Dilemma Navigation for education support services" capability in production for education support services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
