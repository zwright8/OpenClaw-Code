...
## Metadata
- **Skill ID:** `u08968-ethical-dilemma-navigation-for-arts-and-culture-programming`
- **Capability:** Ethical Dilemma Navigation for arts and culture programming
- **Domain:** arts and culture programming
- **Purpose:** Operate the "Ethical Dilemma Navigation for arts and culture programming" capability in production for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
