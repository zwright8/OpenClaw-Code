...
## Metadata
- **Skill ID:** `u08029-creative-ideation-facilitation-for-fitness-and-recovery-training`
- **Capability:** Creative Ideation Facilitation for fitness and recovery training
- **Domain:** fitness and recovery training
- **Purpose:** Operate the "Creative Ideation Facilitation for fitness and recovery training" capability in production for fitness and recovery training workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
