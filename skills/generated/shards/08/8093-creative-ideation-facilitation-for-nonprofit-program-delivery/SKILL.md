...
## Metadata
- **Skill ID:** `u08093-creative-ideation-facilitation-for-nonprofit-program-delivery`
- **Capability:** Creative Ideation Facilitation for nonprofit program delivery
- **Domain:** nonprofit program delivery
- **Purpose:** Operate the "Creative Ideation Facilitation for nonprofit program delivery" capability in production for nonprofit program delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
