...
## Metadata
- **Skill ID:** `u08380-beauty-pattern-detection-for-journalism-and-public-communication`
- **Capability:** Beauty Pattern Detection for journalism and public communication
- **Domain:** journalism and public communication
- **Purpose:** Operate the "Beauty Pattern Detection for journalism and public communication" capability in production for journalism and public communication workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
