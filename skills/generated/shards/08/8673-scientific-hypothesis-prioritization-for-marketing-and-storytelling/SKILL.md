...
description: Operate the "Scientific Hypothesis Prioritization for marketing and storytelling" capability in production for marketing and storytelling workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---

# Scientific Hypothesis Prioritization for marketing and storytelling

## Why This Skill Exists
This skill hardens a generated capability for production execution so marketing and storytelling workflows remain deterministic, auditable, and fail-closed under risk.

## When To Use
Use this skill only when the request explicitly needs `Scientific Hypothesis Prioritization for marketing and storytelling` in marketing and storytelling and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Scientific Hypothesis Prioritization for marketing and storytelling** outcomes (not generic brainstorming).
...
1. **Incident stabilization in marketing and storytelling" capability in production for marketing and storytelling workflows**
   - Input: noisy upstream payload requiring scientific hypothesis prioritization for marketing and storytelling normalization/assessment.
