...
## Metadata
- **Skill ID:** `u08229-beauty-pattern-detection-for-fitness-and-recovery-training`
- **Capability:** Beauty Pattern Detection for fitness and recovery training
- **Domain:** fitness and recovery training
- **Purpose:** Operate the "Beauty Pattern Detection for fitness and recovery training" capability in production for fitness and recovery training workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
