...
## Metadata
- **Skill ID:** `u08893-ethical-dilemma-navigation-for-nonprofit-program-delivery`
- **Capability:** Ethical Dilemma Navigation for nonprofit program delivery
- **Domain:** nonprofit program delivery
- **Purpose:** Operate the "Ethical Dilemma Navigation for nonprofit program delivery" capability in production for nonprofit program delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
