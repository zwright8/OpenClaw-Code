...
## When To Use
Use this skill only when the request explicitly needs `Attention Management Architecture for knowledge management systems` in knowledge management systems and a downstream consumer requires contract-bound artifacts.
