...
## Metadata
- **Skill ID:** `u08183-creative-ideation-facilitation-for-multilingual-translation-services`
- **Capability:** Creative Ideation Facilitation for multilingual translation services
- **Domain:** multilingual translation services
- **Purpose:** Operate the "Creative Ideation Facilitation for multilingual translation services" capability in production for multilingual translation services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
