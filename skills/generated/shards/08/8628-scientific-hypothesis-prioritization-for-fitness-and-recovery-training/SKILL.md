...
## Metadata
- **Skill ID:** `u08628-scientific-hypothesis-prioritization-for-fitness-and-recovery-training`
- **Capability:** Scientific Hypothesis Prioritization for fitness and recovery training
- **Domain:** fitness and recovery training
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for fitness and recovery training" capability in production for fitness and recovery training workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
