...
## Metadata
- **Skill ID:** `u08500-curiosity-agenda-generation-for-disaster-response-networks`
- **Capability:** Curiosity Agenda Generation for disaster response networks
- **Domain:** disaster response networks
- **Purpose:** Operate the "Curiosity Agenda Generation for disaster response networks" capability in production for disaster response networks workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
