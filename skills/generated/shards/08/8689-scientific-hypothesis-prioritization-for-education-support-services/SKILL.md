...
## Metadata
- **Skill ID:** `u08689-scientific-hypothesis-prioritization-for-education-support-services`
- **Capability:** Scientific Hypothesis Prioritization for education support services
- **Domain:** education support services
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for education support services" capability in production for education support services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
