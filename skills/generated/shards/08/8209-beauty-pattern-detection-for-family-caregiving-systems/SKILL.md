...
## Metadata
- **Skill ID:** `u08209-beauty-pattern-detection-for-family-caregiving-systems`
- **Capability:** Beauty Pattern Detection for family caregiving systems
- **Domain:** family caregiving systems
- **Purpose:** Operate the "Beauty Pattern Detection for family caregiving systems" capability in production for family caregiving systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
