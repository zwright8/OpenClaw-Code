...
## Metadata
- **Skill ID:** `u08434-curiosity-agenda-generation-for-mental-well-being-practices`
- **Capability:** Curiosity Agenda Generation for mental well-being practices
- **Domain:** mental well-being practices
- **Purpose:** Operate the "Curiosity Agenda Generation for mental well-being practices" capability in production for mental well being practices workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
