...
description: Operate the "Scientific Hypothesis Prioritization for arts and culture programming" capability in production for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---

# Scientific Hypothesis Prioritization for arts and culture programming

## Why This Skill Exists
This skill hardens a generated capability for production execution so arts and culture programming workflows remain deterministic, auditable, and fail-closed under risk.

## When To Use
Use this skill only when the request explicitly needs `Scientific Hypothesis Prioritization for arts and culture programming` in arts and culture programming and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Scientific Hypothesis Prioritization for arts and culture programming** outcomes (not generic brainstorming).
...
1. **Incident stabilization in arts and culture programming" capability in production for arts and culture programming workflows**
   - Input: noisy upstream payload requiring scientific hypothesis prioritization for arts and culture programming normalization/assessment.
