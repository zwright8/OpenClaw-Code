...
## Metadata
- **Skill ID:** `u08770-scientific-hypothesis-prioritization-for-arts-and-culture-programming`
- **Capability:** Scientific Hypothesis Prioritization for arts and culture programming
- **Domain:** arts and culture programming
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for arts and culture programming" capability in production for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
