...
## Metadata
- **Skill ID:** `u08519-curiosity-agenda-generation-for-supply-chain-resilience`
- **Capability:** Curiosity Agenda Generation for supply chain resilience
- **Domain:** supply chain resilience
- **Purpose:** Operate the "Curiosity Agenda Generation for supply chain resilience" capability in production for supply chain resilience workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
