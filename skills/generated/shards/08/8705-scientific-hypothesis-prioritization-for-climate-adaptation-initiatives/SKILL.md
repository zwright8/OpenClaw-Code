...
## Metadata
- **Skill ID:** `u08705-scientific-hypothesis-prioritization-for-climate-adaptation-initiatives`
- **Capability:** Scientific Hypothesis Prioritization for climate adaptation initiatives
- **Domain:** climate adaptation initiatives
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for climate adaptation initiatives" capability in production for climate adaptation initiatives workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
