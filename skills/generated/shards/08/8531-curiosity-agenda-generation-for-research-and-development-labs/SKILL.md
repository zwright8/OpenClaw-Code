...
## Metadata
- **Skill ID:** `u08531-curiosity-agenda-generation-for-research-and-development-labs`
- **Capability:** Curiosity Agenda Generation for research and development labs
- **Domain:** research and development labs
- **Purpose:** Operate the "Curiosity Agenda Generation for research and development labs" capability in production for research and development labs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
