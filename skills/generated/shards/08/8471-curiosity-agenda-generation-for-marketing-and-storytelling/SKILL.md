...
## Metadata
- **Skill ID:** `u08471-curiosity-agenda-generation-for-marketing-and-storytelling`
- **Capability:** Curiosity Agenda Generation for marketing and storytelling
- **Domain:** marketing and storytelling
- **Purpose:** Operate the "Curiosity Agenda Generation for marketing and storytelling" capability in production for marketing and storytelling workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
