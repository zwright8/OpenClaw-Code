...
## Metadata
- **Skill ID:** `u08367-beauty-pattern-detection-for-arts-and-culture-programming`
- **Capability:** Beauty Pattern Detection for arts and culture programming
- **Domain:** arts and culture programming
- **Purpose:** Operate the "Beauty Pattern Detection for arts and culture programming" capability in production for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
