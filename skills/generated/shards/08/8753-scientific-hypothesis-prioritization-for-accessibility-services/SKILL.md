...
## Metadata
- **Skill ID:** `u08753-scientific-hypothesis-prioritization-for-accessibility-services`
- **Capability:** Scientific Hypothesis Prioritization for accessibility services
- **Domain:** accessibility services
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for accessibility services" capability in production for accessibility services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
