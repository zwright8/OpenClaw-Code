...
## Metadata
- **Skill ID:** `u08726-scientific-hypothesis-prioritization-for-cybersecurity-operations`
- **Capability:** Scientific Hypothesis Prioritization for cybersecurity operations
- **Domain:** cybersecurity operations
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for cybersecurity operations" capability in production for cybersecurity operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
