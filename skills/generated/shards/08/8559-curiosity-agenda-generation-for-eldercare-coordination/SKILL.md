...
## Metadata
- **Skill ID:** `u08559-curiosity-agenda-generation-for-eldercare-coordination`
- **Capability:** Curiosity Agenda Generation for eldercare coordination
- **Domain:** eldercare coordination
- **Purpose:** Operate the "Curiosity Agenda Generation for eldercare coordination" capability in production for eldercare coordination workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
