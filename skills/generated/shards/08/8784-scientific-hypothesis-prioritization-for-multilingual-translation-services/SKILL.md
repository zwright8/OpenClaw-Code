...
## Metadata
- **Skill ID:** `u08784-scientific-hypothesis-prioritization-for-multilingual-translation-services`
- **Capability:** Scientific Hypothesis Prioritization for multilingual translation services
- **Domain:** multilingual translation services
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for multilingual translation services" capability in production for multilingual translation services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
