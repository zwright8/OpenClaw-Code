...
## Metadata
- **Skill ID:** `u08547-curiosity-agenda-generation-for-civic-participation-platforms`
- **Capability:** Curiosity Agenda Generation for civic participation platforms
- **Domain:** civic participation platforms
- **Purpose:** Operate the "Curiosity Agenda Generation for civic participation platforms" capability in production for civic participation platforms workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
