...
## Metadata
- **Skill ID:** `u08512-curiosity-agenda-generation-for-agriculture-and-food-systems`
- **Capability:** Curiosity Agenda Generation for agriculture and food systems
- **Domain:** agriculture and food systems
- **Purpose:** Operate the "Curiosity Agenda Generation for agriculture and food systems" capability in production for agriculture and food systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
