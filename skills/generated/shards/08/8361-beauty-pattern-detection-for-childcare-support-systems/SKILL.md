...
## Metadata
- **Skill ID:** `u08361-beauty-pattern-detection-for-childcare-support-systems`
- **Capability:** Beauty Pattern Detection for childcare support systems
- **Domain:** childcare support systems
- **Purpose:** Operate the "Beauty Pattern Detection for childcare support systems" capability in production for childcare support systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
