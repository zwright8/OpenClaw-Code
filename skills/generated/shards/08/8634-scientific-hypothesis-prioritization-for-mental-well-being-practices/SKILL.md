...
## Metadata
- **Skill ID:** `u08634-scientific-hypothesis-prioritization-for-mental-well-being-practices`
- **Capability:** Scientific Hypothesis Prioritization for mental well-being practices
- **Domain:** mental well-being practices
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for mental well-being practices" capability in production for mental well being practices workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
