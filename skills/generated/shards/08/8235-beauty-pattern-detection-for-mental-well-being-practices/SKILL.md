...
## Metadata
- **Skill ID:** `u08235-beauty-pattern-detection-for-mental-well-being-practices`
- **Capability:** Beauty Pattern Detection for mental well-being practices
- **Domain:** mental well-being practices
- **Purpose:** Operate the "Beauty Pattern Detection for mental well-being practices" capability in production for mental well being practices workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
