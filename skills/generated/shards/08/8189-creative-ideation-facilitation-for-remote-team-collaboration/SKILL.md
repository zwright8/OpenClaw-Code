...
## Metadata
- **Skill ID:** `u08189-creative-ideation-facilitation-for-remote-team-collaboration`
- **Capability:** Creative Ideation Facilitation for remote team collaboration
- **Domain:** remote team collaboration
- **Purpose:** Operate the "Creative Ideation Facilitation for remote team collaboration" capability in production for remote team collaboration workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
