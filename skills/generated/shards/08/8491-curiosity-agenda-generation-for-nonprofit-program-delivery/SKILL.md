...
## Metadata
- **Skill ID:** `u08491-curiosity-agenda-generation-for-nonprofit-program-delivery`
- **Capability:** Curiosity Agenda Generation for nonprofit program delivery
- **Domain:** nonprofit program delivery
- **Purpose:** Operate the "Curiosity Agenda Generation for nonprofit program delivery" capability in production for nonprofit program delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
