...
## Metadata
- **Skill ID:** `u08706-scientific-hypothesis-prioritization-for-urban-planning-and-mobility`
- **Capability:** Scientific Hypothesis Prioritization for urban planning and mobility
- **Domain:** urban planning and mobility
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for urban planning and mobility" capability in production for urban planning and mobility workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
