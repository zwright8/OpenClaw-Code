...
## Metadata
- **Skill ID:** `u08510-curiosity-agenda-generation-for-urban-planning-and-mobility`
- **Capability:** Curiosity Agenda Generation for urban planning and mobility
- **Domain:** urban planning and mobility
- **Purpose:** Operate the "Curiosity Agenda Generation for urban planning and mobility" capability in production for urban planning and mobility workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
