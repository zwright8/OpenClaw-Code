...
## Metadata
- **Skill ID:** `u08954-ethical-dilemma-navigation-for-accessibility-services`
- **Capability:** Ethical Dilemma Navigation for accessibility services
- **Domain:** accessibility services
- **Purpose:** Operate the "Ethical Dilemma Navigation for accessibility services" capability in production for accessibility services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
