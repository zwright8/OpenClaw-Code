...
## Metadata
- **Skill ID:** `u08260-beauty-pattern-detection-for-product-management-execution`
- **Capability:** Beauty Pattern Detection for product management execution
- **Domain:** product management execution
- **Purpose:** Operate the "Beauty Pattern Detection for product management execution" capability in production for product management execution workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
