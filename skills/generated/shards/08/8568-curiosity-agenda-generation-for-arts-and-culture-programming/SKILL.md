...
## Metadata
- **Skill ID:** `u08568-curiosity-agenda-generation-for-arts-and-culture-programming`
- **Capability:** Curiosity Agenda Generation for arts and culture programming
- **Domain:** arts and culture programming
- **Purpose:** Operate the "Curiosity Agenda Generation for arts and culture programming" capability in production for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
