...
description: Operate the "Creative Ideation Facilitation for marketing and storytelling" capability in production for marketing and storytelling workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Creative Ideation Facilitation for marketing and storytelling` in marketing and storytelling and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Creative Ideation Facilitation for marketing and storytelling** outcomes (not generic brainstorming).
...
1. **Incident stabilization in marketing and storytelling" capability in production for marketing and storytelling workflows**
   - Input: noisy upstream payload requiring creative ideation facilitation for marketing and storytelling normalization/assessment.
