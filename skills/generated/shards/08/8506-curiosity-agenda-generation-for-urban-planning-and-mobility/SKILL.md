...
| Feature flag | `skill_08506_curiosity-agenda-generation` |
| Release cycles | `2` |

## Why This Skill Exists
Use curiosity agenda generation in urban planning and mobility with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Curiosity Agenda Generation for urban planning and mobility under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Curiosity Agenda Generation for urban planning and mobility under maximally truth-seeking conditions.
