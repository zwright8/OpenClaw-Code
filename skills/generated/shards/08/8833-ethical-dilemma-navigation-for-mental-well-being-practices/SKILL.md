...
## Metadata
- **Skill ID:** `u08833-ethical-dilemma-navigation-for-mental-well-being-practices`
- **Capability:** Ethical Dilemma Navigation for mental well-being practices
- **Domain:** mental well-being practices
- **Purpose:** Operate the "Ethical Dilemma Navigation for mental well-being practices" capability in production for mental well being practices workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
