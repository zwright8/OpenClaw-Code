...
## Metadata
- **Skill ID:** `u08694-scientific-hypothesis-prioritization-for-nonprofit-program-delivery`
- **Capability:** Scientific Hypothesis Prioritization for nonprofit program delivery
- **Domain:** nonprofit program delivery
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for nonprofit program delivery" capability in production for nonprofit program delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
