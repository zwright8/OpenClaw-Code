...
## Metadata
- **Skill ID:** `u08286-beauty-pattern-detection-for-education-support-services`
- **Capability:** Beauty Pattern Detection for education support services
- **Domain:** education support services
- **Purpose:** Operate the "Beauty Pattern Detection for education support services" capability in production for education support services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
