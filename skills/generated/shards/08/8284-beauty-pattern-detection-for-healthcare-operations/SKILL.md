...
## Metadata
- **Skill ID:** `u08284-beauty-pattern-detection-for-healthcare-operations`
- **Capability:** Beauty Pattern Detection for healthcare operations
- **Domain:** healthcare operations
- **Purpose:** Operate the "Beauty Pattern Detection for healthcare operations" capability in production for healthcare operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
