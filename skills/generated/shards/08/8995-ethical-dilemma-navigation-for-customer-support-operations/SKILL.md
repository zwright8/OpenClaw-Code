...
## Metadata
- **Skill ID:** `u08995-ethical-dilemma-navigation-for-customer-support-operations`
- **Capability:** Ethical Dilemma Navigation for customer support operations
- **Domain:** customer support operations
- **Purpose:** Operate the "Ethical Dilemma Navigation for customer support operations" capability in production for customer support operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
