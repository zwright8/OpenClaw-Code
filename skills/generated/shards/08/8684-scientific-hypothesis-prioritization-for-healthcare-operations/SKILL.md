...
## Metadata
- **Skill ID:** `u08684-scientific-hypothesis-prioritization-for-healthcare-operations`
- **Capability:** Scientific Hypothesis Prioritization for healthcare operations
- **Domain:** healthcare operations
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for healthcare operations" capability in production for healthcare operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
