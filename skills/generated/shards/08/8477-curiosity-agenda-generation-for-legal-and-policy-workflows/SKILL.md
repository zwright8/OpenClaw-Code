...
## Metadata
- **Skill ID:** `u08477-curiosity-agenda-generation-for-legal-and-policy-workflows`
- **Capability:** Curiosity Agenda Generation for legal and policy workflows
- **Domain:** legal and policy workflows
- **Purpose:** Operate the "Curiosity Agenda Generation for legal and policy workflows" capability in production for legal and policy workflows workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
