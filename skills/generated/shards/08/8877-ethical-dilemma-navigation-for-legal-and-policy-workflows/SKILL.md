...
## Metadata
- **Skill ID:** `u08877-ethical-dilemma-navigation-for-legal-and-policy-workflows`
- **Capability:** Ethical Dilemma Navigation for legal and policy workflows
- **Domain:** legal and policy workflows
- **Purpose:** Operate the "Ethical Dilemma Navigation for legal and policy workflows" capability in production for legal and policy workflows workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
