...
## Metadata
- **Skill ID:** `u08414-curiosity-agenda-generation-for-household-logistics`
- **Capability:** Curiosity Agenda Generation for household logistics
- **Domain:** household logistics
- **Purpose:** Operate the "Curiosity Agenda Generation for household logistics" capability in production for household logistics workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
