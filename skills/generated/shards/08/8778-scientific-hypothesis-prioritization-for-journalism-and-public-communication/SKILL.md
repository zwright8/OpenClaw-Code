...
description: Operate the "Scientific Hypothesis Prioritization for journalism and public communication" capability in production for journalism and public communication workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Scientific Hypothesis Prioritization for journalism and public communication` in journalism and public communication and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Scientific Hypothesis Prioritization for journalism and public communication** outcomes (not generic brainstorming).
...
1. **Incident stabilization in journalism and public communication" capability in production for journalism and public communication workflows**
   - Input: noisy upstream payload requiring scientific hypothesis prioritization for journalism and public communication normalization/assessment.
