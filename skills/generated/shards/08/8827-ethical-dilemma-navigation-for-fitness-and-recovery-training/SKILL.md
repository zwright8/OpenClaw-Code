...
## Metadata
- **Skill ID:** `u08827-ethical-dilemma-navigation-for-fitness-and-recovery-training`
- **Capability:** Ethical Dilemma Navigation for fitness and recovery training
- **Domain:** fitness and recovery training
- **Purpose:** Operate the "Ethical Dilemma Navigation for fitness and recovery training" capability in production for fitness and recovery training workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
