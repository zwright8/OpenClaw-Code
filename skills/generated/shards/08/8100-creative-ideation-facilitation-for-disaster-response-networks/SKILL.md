...
## Metadata
- **Skill ID:** `u08100-creative-ideation-facilitation-for-disaster-response-networks`
- **Capability:** Creative Ideation Facilitation for disaster response networks
- **Domain:** disaster response networks
- **Purpose:** Operate the "Creative Ideation Facilitation for disaster response networks" capability in production for disaster response networks workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
