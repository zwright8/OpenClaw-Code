...
## Metadata
- **Skill ID:** `u08334-beauty-pattern-detection-for-research-and-development-labs`
- **Capability:** Beauty Pattern Detection for research and development labs
- **Domain:** research and development labs
- **Purpose:** Operate the "Beauty Pattern Detection for research and development labs" capability in production for research and development labs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
