...
## Metadata
- **Skill ID:** `u08443-curiosity-agenda-generation-for-career-development-pathways`
- **Capability:** Curiosity Agenda Generation for career development pathways
- **Domain:** career development pathways
- **Purpose:** Operate the "Curiosity Agenda Generation for career development pathways" capability in production for career development pathways workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
