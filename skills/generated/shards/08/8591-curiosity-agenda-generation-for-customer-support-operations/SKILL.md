...
## Metadata
- **Skill ID:** `u08591-curiosity-agenda-generation-for-customer-support-operations`
- **Capability:** Curiosity Agenda Generation for customer support operations
- **Domain:** customer support operations
- **Purpose:** Operate the "Curiosity Agenda Generation for customer support operations" capability in production for customer support operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
