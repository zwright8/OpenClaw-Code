...
## Metadata
- **Skill ID:** `u08350-beauty-pattern-detection-for-civic-participation-platforms`
- **Capability:** Beauty Pattern Detection for civic participation platforms
- **Domain:** civic participation platforms
- **Purpose:** Operate the "Beauty Pattern Detection for civic participation platforms" capability in production for civic participation platforms workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
