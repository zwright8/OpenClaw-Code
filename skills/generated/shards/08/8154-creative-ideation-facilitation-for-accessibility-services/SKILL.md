...
## Metadata
- **Skill ID:** `u08154-creative-ideation-facilitation-for-accessibility-services`
- **Capability:** Creative Ideation Facilitation for accessibility services
- **Domain:** accessibility services
- **Purpose:** Operate the "Creative Ideation Facilitation for accessibility services" capability in production for accessibility services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
