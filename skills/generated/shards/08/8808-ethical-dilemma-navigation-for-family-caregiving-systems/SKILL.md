...
## Metadata
- **Skill ID:** `u08808-ethical-dilemma-navigation-for-family-caregiving-systems`
- **Capability:** Ethical Dilemma Navigation for family caregiving systems
- **Domain:** family caregiving systems
- **Purpose:** Operate the "Ethical Dilemma Navigation for family caregiving systems" capability in production for family caregiving systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
