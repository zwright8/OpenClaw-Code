...
## Metadata
- **Skill ID:** `u08338-beauty-pattern-detection-for-scientific-publishing-pipelines`
- **Capability:** Beauty Pattern Detection for scientific publishing pipelines
- **Domain:** scientific publishing pipelines
- **Purpose:** Operate the "Beauty Pattern Detection for scientific publishing pipelines" capability in production for scientific publishing pipelines workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
