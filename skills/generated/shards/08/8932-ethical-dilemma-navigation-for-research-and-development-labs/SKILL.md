...
## Metadata
- **Skill ID:** `u08932-ethical-dilemma-navigation-for-research-and-development-labs`
- **Capability:** Ethical Dilemma Navigation for research and development labs
- **Domain:** research and development labs
- **Purpose:** Operate the "Ethical Dilemma Navigation for research and development labs" capability in production for research and development labs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
