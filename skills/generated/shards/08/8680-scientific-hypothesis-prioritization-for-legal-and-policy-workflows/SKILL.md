...
## Metadata
- **Skill ID:** `u08680-scientific-hypothesis-prioritization-for-legal-and-policy-workflows`
- **Capability:** Scientific Hypothesis Prioritization for legal and policy workflows
- **Domain:** legal and policy workflows
- **Purpose:** Operate the "Scientific Hypothesis Prioritization for legal and policy workflows" capability in production for legal and policy workflows workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
