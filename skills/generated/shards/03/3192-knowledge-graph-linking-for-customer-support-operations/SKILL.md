...
```yaml
skill_id: u3192
skill_name: u3192-knowledge-graph-linking-for-customer-support-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for customer support operations** before execution.
