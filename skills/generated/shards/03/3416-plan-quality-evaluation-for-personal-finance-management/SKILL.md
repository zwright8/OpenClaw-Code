...
```yaml
skill_id: u3416
skill_name: u3416-plan-quality-evaluation-for-personal-finance-management
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for personal finance management** before execution.
