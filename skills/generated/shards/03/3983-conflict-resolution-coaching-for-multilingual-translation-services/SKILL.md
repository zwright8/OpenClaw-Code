...
```yaml
skill_id: u3983
skill_name: u3983-conflict-resolution-coaching-for-multilingual-translation-services
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for multilingual translation services** before execution.
