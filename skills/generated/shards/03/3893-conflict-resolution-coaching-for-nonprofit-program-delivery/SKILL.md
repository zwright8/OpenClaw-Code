...
```yaml
skill_id: u3893
skill_name: u3893-conflict-resolution-coaching-for-nonprofit-program-delivery
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for nonprofit program delivery** before execution.
