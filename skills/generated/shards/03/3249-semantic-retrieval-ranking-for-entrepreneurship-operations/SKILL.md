...
```yaml
skill_id: u3249
skill_name: u3249-semantic-retrieval-ranking-for-entrepreneurship-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for entrepreneurship operations** before execution.
