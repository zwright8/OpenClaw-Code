...
```yaml
skill_id: u3929
skill_name: u3929-conflict-resolution-coaching-for-cybersecurity-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for cybersecurity operations** before execution.
