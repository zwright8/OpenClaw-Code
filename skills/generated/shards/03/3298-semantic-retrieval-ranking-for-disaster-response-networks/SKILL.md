...
```yaml
skill_id: u3298
skill_name: u3298-semantic-retrieval-ranking-for-disaster-response-networks
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for disaster response networks** before execution.
