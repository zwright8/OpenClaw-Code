...
```yaml
skill_id: u3062
skill_name: u3062-knowledge-graph-linking-for-design-and-user-research
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for design and user research** before execution.
