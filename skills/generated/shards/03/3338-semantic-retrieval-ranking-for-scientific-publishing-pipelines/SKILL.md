...
```yaml
skill_id: u3338
skill_name: u3338-semantic-retrieval-ranking-for-scientific-publishing-pipelines
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for scientific publishing pipelines** before execution.
