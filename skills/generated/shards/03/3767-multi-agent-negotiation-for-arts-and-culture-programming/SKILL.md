...
```yaml
skill_id: u3767
skill_name: u3767-multi-agent-negotiation-for-arts-and-culture-programming
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for arts and culture programming** before execution.
