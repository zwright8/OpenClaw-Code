...
```yaml
skill_id: u3493
skill_name: u3493-plan-quality-evaluation-for-nonprofit-program-delivery
shard_lane: "03"
operation: plan quality evaluation
...
## Musts
- Must verify the request truly requires **plan quality evaluation for nonprofit program delivery** before execution.
