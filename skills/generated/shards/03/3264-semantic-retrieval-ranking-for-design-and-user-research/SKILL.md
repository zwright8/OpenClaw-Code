...
```yaml
skill_id: u3264
skill_name: u3264-semantic-retrieval-ranking-for-design-and-user-research
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for design and user research** before execution.
