...
```yaml
skill_id: u3588
skill_name: u3588-plan-quality-evaluation-for-remote-team-collaboration
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for remote team collaboration** before execution.
