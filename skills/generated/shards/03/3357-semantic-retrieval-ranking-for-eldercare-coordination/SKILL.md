...
```yaml
skill_id: u3357
skill_name: u3357-semantic-retrieval-ranking-for-eldercare-coordination
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for eldercare coordination** before execution.
