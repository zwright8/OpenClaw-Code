...
| Feature flag | `skill_03806_conflict-resolution-coaching` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Conflict Resolution Coaching for family caregiving systems under maximally truth-seeking conditions.
