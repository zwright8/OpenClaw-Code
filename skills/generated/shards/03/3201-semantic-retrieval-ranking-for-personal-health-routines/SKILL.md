...
```yaml
skill_id: u3201
skill_name: u3201-semantic-retrieval-ranking-for-personal-health-routines
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for personal health routines** before execution.
