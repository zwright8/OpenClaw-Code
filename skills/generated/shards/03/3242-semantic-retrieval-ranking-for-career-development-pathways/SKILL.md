...
```yaml
skill_id: u3242
skill_name: u3242-semantic-retrieval-ranking-for-career-development-pathways
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for career development pathways** before execution.
