...
```yaml
skill_id: u3860
skill_name: u3860-conflict-resolution-coaching-for-product-management-execution
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for product management execution** before execution.
