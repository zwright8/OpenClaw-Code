...
```yaml
skill_id: u3226
skill_name: u3226-semantic-retrieval-ranking-for-fitness-and-recovery-training
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for fitness and recovery training** before execution.
