...
```yaml
skill_id: u3016
skill_name: u3016-knowledge-graph-linking-for-personal-finance-management
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for personal finance management** before execution.
