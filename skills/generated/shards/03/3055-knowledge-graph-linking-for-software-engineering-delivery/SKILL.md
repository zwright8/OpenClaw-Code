...
```yaml
skill_id: u3055
skill_name: u3055-knowledge-graph-linking-for-software-engineering-delivery
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for software engineering delivery** before execution.
