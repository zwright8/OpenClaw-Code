...
```yaml
skill_id: u3809
skill_name: u3809-conflict-resolution-coaching-for-family-caregiving-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for family caregiving systems** before execution.
