...
```yaml
skill_id: u3150
skill_name: u3150-knowledge-graph-linking-for-civic-participation-platforms
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for civic participation platforms** before execution.
