...
```yaml
skill_id: u3869
skill_name: u3869-conflict-resolution-coaching-for-sales-and-client-success
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for sales and client success** before execution.
