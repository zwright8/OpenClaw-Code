...
| Feature flag | `skill_03869_conflict-resolution-coaching` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Conflict Resolution Coaching for sales and client success under hyper-productive autonomy conditions.
