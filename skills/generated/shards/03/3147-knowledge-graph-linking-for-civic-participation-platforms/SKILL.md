---
name: u03147-knowledge-graph-linking-for-civic-participation-platforms
...
| Feature flag | `skill_03147_knowledge-graph-linking` |
| Release cycles | `2` |

## Why This Skill Exists
Use knowledge graph linking in civic participation platforms with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Knowledge Graph Linking for civic participation platforms under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Knowledge Graph Linking for civic participation platforms under pro-humanity impact conditions.
