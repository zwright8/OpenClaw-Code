...
```yaml
skill_id: u3316
skill_name: u3316-semantic-retrieval-ranking-for-supply-chain-resilience
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for supply chain resilience** before execution.
