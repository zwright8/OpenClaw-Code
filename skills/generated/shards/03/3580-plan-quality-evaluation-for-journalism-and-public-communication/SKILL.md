...
```yaml
skill_id: u3580
skill_name: u3580-plan-quality-evaluation-for-journalism-and-public-communication
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for journalism and public communication** before execution.
