...
```yaml
skill_id: u3371
skill_name: u3371-semantic-retrieval-ranking-for-music-and-creative-practice
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for music and creative practice** before execution.
