...
```yaml
skill_id: u3583
skill_name: u3583-plan-quality-evaluation-for-multilingual-translation-services
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for multilingual translation services** before execution.
