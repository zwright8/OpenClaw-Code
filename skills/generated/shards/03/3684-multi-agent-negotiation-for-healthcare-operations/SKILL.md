...
```yaml
skill_id: u3684
skill_name: u3684-multi-agent-negotiation-for-healthcare-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for healthcare operations** before execution.
