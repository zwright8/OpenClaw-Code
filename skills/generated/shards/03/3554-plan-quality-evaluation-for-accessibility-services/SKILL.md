...
```yaml
skill_id: u3554
skill_name: u3554-plan-quality-evaluation-for-accessibility-services
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for accessibility services** before execution.
