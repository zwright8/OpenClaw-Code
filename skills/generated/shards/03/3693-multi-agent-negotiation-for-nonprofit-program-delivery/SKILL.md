...
```yaml
skill_id: u3693
skill_name: u3693-multi-agent-negotiation-for-nonprofit-program-delivery
shard_lane: "03"
operation: multi agent negotiation
...
## Musts
- Must verify the request truly requires **multi agent negotiation for nonprofit program delivery** before execution.
