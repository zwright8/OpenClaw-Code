...
```yaml
skill_id: u3922
skill_name: u3922-conflict-resolution-coaching-for-manufacturing-quality-assurance
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for manufacturing quality assurance** before execution.
