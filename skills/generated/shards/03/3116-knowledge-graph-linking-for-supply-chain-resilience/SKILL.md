...
```yaml
skill_id: u3116
skill_name: u3116-knowledge-graph-linking-for-supply-chain-resilience
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for supply chain resilience** before execution.
