...
```yaml
skill_id: u3547
skill_name: u3547-plan-quality-evaluation-for-civic-participation-platforms
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for civic participation platforms** before execution.
