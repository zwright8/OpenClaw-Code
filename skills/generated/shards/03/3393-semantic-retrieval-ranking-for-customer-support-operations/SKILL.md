...
```yaml
skill_id: u3393
skill_name: u3393-semantic-retrieval-ranking-for-customer-support-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for customer support operations** before execution.
