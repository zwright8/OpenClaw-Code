...
```yaml
skill_id: u3607
skill_name: u3607-multi-agent-negotiation-for-family-caregiving-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for family caregiving systems** before execution.
