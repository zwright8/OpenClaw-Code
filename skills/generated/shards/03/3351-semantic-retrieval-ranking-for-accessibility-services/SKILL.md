...
```yaml
skill_id: u3351
skill_name: u3351-semantic-retrieval-ranking-for-accessibility-services
shard_lane: "03"
operation: semantic retrieval ranking
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for accessibility services** before execution.
