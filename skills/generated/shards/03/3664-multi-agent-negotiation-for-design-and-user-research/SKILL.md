...
```yaml
skill_id: u3664
skill_name: u3664-multi-agent-negotiation-for-design-and-user-research
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for design and user research** before execution.
