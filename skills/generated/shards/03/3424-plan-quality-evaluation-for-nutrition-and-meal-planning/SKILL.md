...
```yaml
skill_id: u3424
skill_name: u3424-plan-quality-evaluation-for-nutrition-and-meal-planning
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for nutrition and meal planning** before execution.
