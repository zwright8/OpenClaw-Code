...
```yaml
skill_id: u3785
skill_name: u3785-multi-agent-negotiation-for-multilingual-translation-services
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for multilingual translation services** before execution.
