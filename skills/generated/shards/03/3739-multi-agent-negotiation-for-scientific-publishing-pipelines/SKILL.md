...
```yaml
skill_id: u3739
skill_name: u3739-multi-agent-negotiation-for-scientific-publishing-pipelines
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for scientific publishing pipelines** before execution.
