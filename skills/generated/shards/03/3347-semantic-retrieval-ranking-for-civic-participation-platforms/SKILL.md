---
name: u03347-semantic-retrieval-ranking-for-civic-participation-platforms
...
| Feature flag | `skill_03347_semantic-retrieval-ranking` |
| Release cycles | `2` |

## Why This Skill Exists
Use semantic retrieval ranking in civic participation platforms with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Semantic Retrieval Ranking for civic participation platforms under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Semantic Retrieval Ranking for civic participation platforms under pro-humanity impact conditions.
