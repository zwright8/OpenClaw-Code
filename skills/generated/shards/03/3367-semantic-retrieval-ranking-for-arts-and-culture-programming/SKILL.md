...
```yaml
skill_id: u3367
skill_name: u3367-semantic-retrieval-ranking-for-arts-and-culture-programming
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for arts and culture programming** before execution.
