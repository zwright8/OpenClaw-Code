...
```yaml
skill_id: u3512
skill_name: u3512-plan-quality-evaluation-for-agriculture-and-food-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for agriculture and food systems** before execution.
