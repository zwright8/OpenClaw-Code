...
```yaml
skill_id: u3407
skill_name: u3407-plan-quality-evaluation-for-family-caregiving-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for family caregiving systems** before execution.
