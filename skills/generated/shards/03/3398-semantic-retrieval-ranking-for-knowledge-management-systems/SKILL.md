...
```yaml
skill_id: u3398
skill_name: u3398-semantic-retrieval-ranking-for-knowledge-management-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for knowledge management systems** before execution.
