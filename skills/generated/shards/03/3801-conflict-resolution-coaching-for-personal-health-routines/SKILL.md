...
```yaml
skill_id: u3801
skill_name: u3801-conflict-resolution-coaching-for-personal-health-routines
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for personal health routines** before execution.
