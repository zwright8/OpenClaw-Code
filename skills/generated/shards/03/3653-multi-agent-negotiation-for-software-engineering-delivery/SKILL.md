...
```yaml
skill_id: u3653
skill_name: u3653-multi-agent-negotiation-for-software-engineering-delivery
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for software engineering delivery** before execution.
