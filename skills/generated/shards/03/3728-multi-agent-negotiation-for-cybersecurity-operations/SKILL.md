...
```yaml
skill_id: u3728
skill_name: u3728-multi-agent-negotiation-for-cybersecurity-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for cybersecurity operations** before execution.
