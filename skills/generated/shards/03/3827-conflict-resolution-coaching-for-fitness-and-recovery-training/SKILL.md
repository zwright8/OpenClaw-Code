...
```yaml
skill_id: u3827
skill_name: u3827-conflict-resolution-coaching-for-fitness-and-recovery-training
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for fitness and recovery training** before execution.
