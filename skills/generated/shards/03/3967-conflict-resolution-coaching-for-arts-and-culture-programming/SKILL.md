...
```yaml
skill_id: u3967
skill_name: u3967-conflict-resolution-coaching-for-arts-and-culture-programming
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for arts and culture programming** before execution.
