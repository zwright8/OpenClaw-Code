...
```yaml
skill_id: u3452
skill_name: u3452-plan-quality-evaluation-for-software-engineering-delivery
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for software engineering delivery** before execution.
