...
```yaml
skill_id: u3112
skill_name: u3112-knowledge-graph-linking-for-agriculture-and-food-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for agriculture and food systems** before execution.
