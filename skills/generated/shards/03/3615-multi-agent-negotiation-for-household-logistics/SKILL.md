...
```yaml
skill_id: u3615
skill_name: u3615-multi-agent-negotiation-for-household-logistics
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for household logistics** before execution.
