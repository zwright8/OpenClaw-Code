...
```yaml
skill_id: u3574
skill_name: u3574-plan-quality-evaluation-for-music-and-creative-practice
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for music and creative practice** before execution.
