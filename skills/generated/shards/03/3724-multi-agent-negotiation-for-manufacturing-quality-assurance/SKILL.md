...
```yaml
skill_id: u3724
skill_name: u3724-multi-agent-negotiation-for-manufacturing-quality-assurance
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for manufacturing quality assurance** before execution.
