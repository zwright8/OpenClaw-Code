...
```yaml
skill_id: u3165
skill_name: u3165-knowledge-graph-linking-for-childcare-support-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for childcare support systems** before execution.
