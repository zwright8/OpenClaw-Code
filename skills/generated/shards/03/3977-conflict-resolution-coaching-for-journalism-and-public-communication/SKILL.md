...
```yaml
skill_id: u3977
skill_name: u3977-conflict-resolution-coaching-for-journalism-and-public-communication
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for journalism and public communication** before execution.
