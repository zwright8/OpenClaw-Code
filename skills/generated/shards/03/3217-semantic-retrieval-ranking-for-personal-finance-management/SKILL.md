...
```yaml
skill_id: u3217
skill_name: u3217-semantic-retrieval-ranking-for-personal-finance-management
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for personal finance management** before execution.
