...
```yaml
skill_id: u3456
skill_name: u3456-plan-quality-evaluation-for-product-management-execution
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for product management execution** before execution.
