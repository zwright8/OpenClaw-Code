...
```yaml
skill_id: u3030
skill_name: u3030-knowledge-graph-linking-for-fitness-and-recovery-training
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for fitness and recovery training** before execution.
