...
```yaml
skill_id: u3186
skill_name: u3186-knowledge-graph-linking-for-remote-team-collaboration
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for remote team collaboration** before execution.
