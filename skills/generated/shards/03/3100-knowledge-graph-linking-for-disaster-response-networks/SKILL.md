...
```yaml
skill_id: u3100
skill_name: u3100-knowledge-graph-linking-for-disaster-response-networks
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for disaster response networks** before execution.
