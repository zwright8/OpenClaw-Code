...
```yaml
skill_id: u3733
skill_name: u3733-multi-agent-negotiation-for-research-and-development-labs
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for research and development labs** before execution.
