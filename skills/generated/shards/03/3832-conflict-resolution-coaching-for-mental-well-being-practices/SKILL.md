...
```yaml
skill_id: u3832
skill_name: u3832-conflict-resolution-coaching-for-mental-well-being-practices
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for mental well being practices** before execution.
