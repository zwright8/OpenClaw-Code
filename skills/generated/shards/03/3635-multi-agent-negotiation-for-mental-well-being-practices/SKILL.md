...
```yaml
skill_id: u3635
skill_name: u3635-multi-agent-negotiation-for-mental-well-being-practices
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for mental well being practices** before execution.
