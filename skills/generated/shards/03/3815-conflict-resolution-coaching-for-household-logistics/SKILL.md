...
```yaml
skill_id: u3815
skill_name: u3815-conflict-resolution-coaching-for-household-logistics
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for household logistics** before execution.
