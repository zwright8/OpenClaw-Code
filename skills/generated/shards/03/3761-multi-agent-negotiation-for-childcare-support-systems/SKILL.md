...
```yaml
skill_id: u3761
skill_name: u3761-multi-agent-negotiation-for-childcare-support-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for childcare support systems** before execution.
