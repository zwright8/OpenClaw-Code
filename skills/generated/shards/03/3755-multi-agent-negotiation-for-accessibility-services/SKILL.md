...
```yaml
skill_id: u3755
skill_name: u3755-multi-agent-negotiation-for-accessibility-services
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for accessibility services** before execution.
