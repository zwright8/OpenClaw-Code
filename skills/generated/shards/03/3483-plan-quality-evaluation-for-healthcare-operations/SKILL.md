...
```yaml
skill_id: u3483
skill_name: u3483-plan-quality-evaluation-for-healthcare-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for healthcare operations** before execution.
