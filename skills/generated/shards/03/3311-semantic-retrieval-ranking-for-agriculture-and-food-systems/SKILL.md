...
```yaml
skill_id: u3311
skill_name: u3311-semantic-retrieval-ranking-for-agriculture-and-food-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for agriculture and food systems** before execution.
