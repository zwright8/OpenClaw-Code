...
```yaml
skill_id: u3686
skill_name: u3686-multi-agent-negotiation-for-education-support-services
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for education support services** before execution.
