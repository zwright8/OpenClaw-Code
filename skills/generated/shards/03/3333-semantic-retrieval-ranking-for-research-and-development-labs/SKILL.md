...
```yaml
skill_id: u3333
skill_name: u3333-semantic-retrieval-ranking-for-research-and-development-labs
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for research and development labs** before execution.
