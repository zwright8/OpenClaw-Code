...
```yaml
skill_id: u3183
skill_name: u3183-knowledge-graph-linking-for-multilingual-translation-services
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for multilingual translation services** before execution.
