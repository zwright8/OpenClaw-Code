...
```yaml
skill_id: u3403
skill_name: u3403-plan-quality-evaluation-for-personal-health-routines
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for personal health routines** before execution.
