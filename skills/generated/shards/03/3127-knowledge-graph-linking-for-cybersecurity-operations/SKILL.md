...
```yaml
skill_id: u3127
skill_name: u3127-knowledge-graph-linking-for-cybersecurity-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for cybersecurity operations** before execution.
