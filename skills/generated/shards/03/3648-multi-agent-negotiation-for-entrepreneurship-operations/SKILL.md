...
```yaml
skill_id: u3648
skill_name: u3648-multi-agent-negotiation-for-entrepreneurship-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for entrepreneurship operations** before execution.
