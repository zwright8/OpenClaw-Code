...
```yaml
skill_id: u3854
skill_name: u3854-conflict-resolution-coaching-for-software-engineering-delivery
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for software engineering delivery** before execution.
