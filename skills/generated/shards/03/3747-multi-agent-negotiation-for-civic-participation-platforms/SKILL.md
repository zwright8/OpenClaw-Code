...
```yaml
skill_id: u3747
skill_name: u3747-multi-agent-negotiation-for-civic-participation-platforms
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for civic participation platforms** before execution.
