...
```yaml
skill_id: u3155
skill_name: u3155-knowledge-graph-linking-for-accessibility-services
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for accessibility services** before execution.
