...
```yaml
skill_id: u3885
skill_name: u3885-conflict-resolution-coaching-for-healthcare-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for healthcare operations** before execution.
