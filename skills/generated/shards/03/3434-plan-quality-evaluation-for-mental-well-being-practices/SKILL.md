...
```yaml
skill_id: u3434
skill_name: u3434-plan-quality-evaluation-for-mental-well-being-practices
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for mental well being practices** before execution.
