...
```yaml
skill_id: u3627
skill_name: u3627-multi-agent-negotiation-for-fitness-and-recovery-training
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for fitness and recovery training** before execution.
