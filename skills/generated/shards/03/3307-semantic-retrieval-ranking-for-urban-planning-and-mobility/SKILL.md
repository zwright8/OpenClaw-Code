...
```yaml
skill_id: u3307
skill_name: u3307-semantic-retrieval-ranking-for-urban-planning-and-mobility
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for urban planning and mobility** before execution.
