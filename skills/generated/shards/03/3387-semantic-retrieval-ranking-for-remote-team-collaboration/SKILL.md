...
```yaml
skill_id: u3387
skill_name: u3387-semantic-retrieval-ranking-for-remote-team-collaboration
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for remote team collaboration** before execution.
