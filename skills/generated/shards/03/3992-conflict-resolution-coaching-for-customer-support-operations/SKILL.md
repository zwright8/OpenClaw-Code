...
```yaml
skill_id: u3992
skill_name: u3992-conflict-resolution-coaching-for-customer-support-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for customer support operations** before execution.
