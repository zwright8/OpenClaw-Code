...
```yaml
skill_id: u3301
skill_name: u3301-semantic-retrieval-ranking-for-climate-adaptation-initiatives
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for climate adaptation initiatives** before execution.
