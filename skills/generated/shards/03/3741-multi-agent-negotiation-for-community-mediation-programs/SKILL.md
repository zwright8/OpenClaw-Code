...
```yaml
skill_id: u3741
skill_name: u3741-multi-agent-negotiation-for-community-mediation-programs
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for community mediation programs** before execution.
