...
```yaml
skill_id: u3177
skill_name: u3177-knowledge-graph-linking-for-journalism-and-public-communication
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for journalism and public communication** before execution.
