...
```yaml
skill_id: u3597
skill_name: u3597-plan-quality-evaluation-for-knowledge-management-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for knowledge management systems** before execution.
