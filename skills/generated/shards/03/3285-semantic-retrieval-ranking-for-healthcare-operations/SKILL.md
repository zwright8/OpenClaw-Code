...
```yaml
skill_id: u3285
skill_name: u3285-semantic-retrieval-ranking-for-healthcare-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for healthcare operations** before execution.
