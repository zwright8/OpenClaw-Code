...
```yaml
skill_id: u3601
skill_name: u3601-multi-agent-negotiation-for-personal-health-routines
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for personal health routines** before execution.
