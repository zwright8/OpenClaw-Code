...
```yaml
skill_id: u3799
skill_name: u3799-multi-agent-negotiation-for-knowledge-management-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for knowledge management systems** before execution.
