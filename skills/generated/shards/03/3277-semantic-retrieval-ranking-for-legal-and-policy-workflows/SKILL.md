...
| Feature flag | `skill_03277_semantic-retrieval-ranking` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Semantic Retrieval Ranking for legal and policy workflows under pro-humanity impact conditions.
