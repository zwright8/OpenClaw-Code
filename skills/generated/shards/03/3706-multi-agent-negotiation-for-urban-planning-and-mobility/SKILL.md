---
name: u03706-multi-agent-negotiation-for-urban-planning-and-mobility
...
| Feature flag | `skill_03706_multi-agent-negotiation` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Multi-Agent Negotiation for urban planning and mobility under maximally truth-seeking conditions.
