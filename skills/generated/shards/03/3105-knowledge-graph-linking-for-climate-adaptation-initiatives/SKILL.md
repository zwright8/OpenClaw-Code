...
```yaml
skill_id: u3105
skill_name: u3105-knowledge-graph-linking-for-climate-adaptation-initiatives
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for climate adaptation initiatives** before execution.
