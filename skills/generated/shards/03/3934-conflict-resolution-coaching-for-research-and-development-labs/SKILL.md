...
```yaml
skill_id: u3934
skill_name: u3934-conflict-resolution-coaching-for-research-and-development-labs
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for research and development labs** before execution.
