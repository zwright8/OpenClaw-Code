...
```yaml
skill_id: u3428
skill_name: u3428-plan-quality-evaluation-for-fitness-and-recovery-training
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for fitness and recovery training** before execution.
