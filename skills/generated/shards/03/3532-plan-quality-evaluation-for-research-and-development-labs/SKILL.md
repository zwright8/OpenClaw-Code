...
```yaml
skill_id: u3532
skill_name: u3532-plan-quality-evaluation-for-research-and-development-labs
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for research and development labs** before execution.
