...
```yaml
skill_id: u3038
skill_name: u3038-knowledge-graph-linking-for-lifelong-learning-plans
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for lifelong learning plans** before execution.
