...
```yaml
skill_id: u3936
skill_name: u3936-conflict-resolution-coaching-for-scientific-publishing-pipelines
shard_lane: "03"
operation: conflict resolution coaching
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for scientific publishing pipelines** before execution.
