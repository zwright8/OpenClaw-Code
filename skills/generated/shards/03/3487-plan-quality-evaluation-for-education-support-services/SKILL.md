...
```yaml
skill_id: u3487
skill_name: u3487-plan-quality-evaluation-for-education-support-services
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for education support services** before execution.
