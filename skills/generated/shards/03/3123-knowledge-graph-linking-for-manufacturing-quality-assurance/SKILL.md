...
```yaml
skill_id: u3123
skill_name: u3123-knowledge-graph-linking-for-manufacturing-quality-assurance
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for manufacturing quality assurance** before execution.
