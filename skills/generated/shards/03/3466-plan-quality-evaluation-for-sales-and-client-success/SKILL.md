...
```yaml
skill_id: u3466
skill_name: u3466-plan-quality-evaluation-for-sales-and-client-success
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for sales and client success** before execution.
