...
```yaml
skill_id: u3232
skill_name: u3232-semantic-retrieval-ranking-for-mental-well-being-practices
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for mental well being practices** before execution.
