...
```yaml
skill_id: u3526
skill_name: u3526-plan-quality-evaluation-for-cybersecurity-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for cybersecurity operations** before execution.
