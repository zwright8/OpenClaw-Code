...
```yaml
skill_id: u3342
skill_name: u3342-semantic-retrieval-ranking-for-community-mediation-programs
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for community mediation programs** before execution.
