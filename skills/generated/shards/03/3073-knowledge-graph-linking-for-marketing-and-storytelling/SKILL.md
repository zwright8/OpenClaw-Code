...
```yaml
skill_id: u3073
skill_name: u3073-knowledge-graph-linking-for-marketing-and-storytelling
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for marketing and storytelling** before execution.
