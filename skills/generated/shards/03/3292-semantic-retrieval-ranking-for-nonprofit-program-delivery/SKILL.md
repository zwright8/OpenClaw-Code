...
```yaml
skill_id: u3292
skill_name: u3292-semantic-retrieval-ranking-for-nonprofit-program-delivery
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for nonprofit program delivery** before execution.
