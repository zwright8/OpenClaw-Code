...
```yaml
skill_id: u3160
skill_name: u3160-knowledge-graph-linking-for-eldercare-coordination
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for eldercare coordination** before execution.
