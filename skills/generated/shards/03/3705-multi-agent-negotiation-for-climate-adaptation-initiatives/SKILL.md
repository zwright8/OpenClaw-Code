...
```yaml
skill_id: u3705
skill_name: u3705-multi-agent-negotiation-for-climate-adaptation-initiatives
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for climate adaptation initiatives** before execution.
