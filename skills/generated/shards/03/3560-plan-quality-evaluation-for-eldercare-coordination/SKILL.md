...
```yaml
skill_id: u3560
skill_name: u3560-plan-quality-evaluation-for-eldercare-coordination
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for eldercare coordination** before execution.
