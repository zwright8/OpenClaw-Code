...
```yaml
skill_id: u3675
skill_name: u3675-multi-agent-negotiation-for-marketing-and-storytelling
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for marketing and storytelling** before execution.
