...
```yaml
skill_id: u3565
skill_name: u3565-plan-quality-evaluation-for-childcare-support-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for childcare support systems** before execution.
