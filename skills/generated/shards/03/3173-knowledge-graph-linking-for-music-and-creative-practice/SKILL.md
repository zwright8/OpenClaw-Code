...
```yaml
skill_id: u3173
skill_name: u3173-knowledge-graph-linking-for-music-and-creative-practice
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for music and creative practice** before execution.
