...
```yaml
skill_id: u3137
skill_name: u3137-knowledge-graph-linking-for-scientific-publishing-pipelines
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for scientific publishing pipelines** before execution.
