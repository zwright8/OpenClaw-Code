...
```yaml
skill_id: u3668
skill_name: u3668-multi-agent-negotiation-for-sales-and-client-success
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for sales and client success** before execution.
