...
```yaml
skill_id: u3006
skill_name: u3006-knowledge-graph-linking-for-family-caregiving-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for family caregiving systems** before execution.
