...
```yaml
skill_id: u3865
skill_name: u3865-conflict-resolution-coaching-for-design-and-user-research
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for design and user research** before execution.
