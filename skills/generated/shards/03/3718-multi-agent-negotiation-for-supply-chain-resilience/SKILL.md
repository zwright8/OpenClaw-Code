...
```yaml
skill_id: u3718
skill_name: u3718-multi-agent-negotiation-for-supply-chain-resilience
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for supply chain resilience** before execution.
