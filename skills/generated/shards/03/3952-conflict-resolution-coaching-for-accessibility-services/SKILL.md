...
```yaml
skill_id: u3952
skill_name: u3952-conflict-resolution-coaching-for-accessibility-services
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for accessibility services** before execution.
