...
```yaml
skill_id: u3886
skill_name: u3886-conflict-resolution-coaching-for-education-support-services
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for education support services** before execution.
