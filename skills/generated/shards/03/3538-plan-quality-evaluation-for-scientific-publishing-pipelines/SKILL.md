...
```yaml
skill_id: u3538
skill_name: u3538-plan-quality-evaluation-for-scientific-publishing-pipelines
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for scientific publishing pipelines** before execution.
