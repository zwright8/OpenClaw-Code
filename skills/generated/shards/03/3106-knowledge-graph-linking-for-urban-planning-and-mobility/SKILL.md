...
```yaml
skill_id: u3106
skill_name: u3106-knowledge-graph-linking-for-urban-planning-and-mobility
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for urban planning and mobility** before execution.
