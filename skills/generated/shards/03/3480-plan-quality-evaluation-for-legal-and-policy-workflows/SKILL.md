...
```yaml
skill_id: u3480
skill_name: u3480-plan-quality-evaluation-for-legal-and-policy-workflows
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for legal and policy workflows** before execution.
