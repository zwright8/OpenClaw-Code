...
```yaml
skill_id: u3206
skill_name: u3206-semantic-retrieval-ranking-for-family-caregiving-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for family caregiving systems** before execution.
