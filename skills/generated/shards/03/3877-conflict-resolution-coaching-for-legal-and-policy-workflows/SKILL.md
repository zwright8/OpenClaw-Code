...
```yaml
skill_id: u3877
skill_name: u3877-conflict-resolution-coaching-for-legal-and-policy-workflows
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for legal and policy workflows** before execution.
