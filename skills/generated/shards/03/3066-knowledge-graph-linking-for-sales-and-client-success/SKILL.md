...
```yaml
skill_id: u3066
skill_name: u3066-knowledge-graph-linking-for-sales-and-client-success
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for sales and client success** before execution.
