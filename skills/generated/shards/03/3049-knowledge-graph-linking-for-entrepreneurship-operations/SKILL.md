...
```yaml
skill_id: u3049
skill_name: u3049-knowledge-graph-linking-for-entrepreneurship-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for entrepreneurship operations** before execution.
