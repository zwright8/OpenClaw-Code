---
name: u03866-conflict-resolution-coaching-for-sales-and-client-success
...
| Feature flag | `skill_03866_conflict-resolution-coaching` |
| Release cycles | `2` |

## Why This Skill Exists
Use conflict resolution coaching in sales and client success with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Conflict Resolution Coaching for sales and client success under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Conflict Resolution Coaching for sales and client success under maximally truth-seeking conditions.
...
1. `Frontier model runtime` -> auth preflight, execute model inference call(s), normalize output, and attach trace to `conflict-resolution-coaching-artifact-sales-and-client-success`.
2. `Vector memory store (optional)` -> auth preflight, execute read/query call(s), normalize output, and attach trace to `conflict-resolution-coaching-artifact-sales-and-client-success`.
