...
```yaml
skill_id: u3496
skill_name: u3496-plan-quality-evaluation-for-disaster-response-networks
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for disaster response networks** before execution.
