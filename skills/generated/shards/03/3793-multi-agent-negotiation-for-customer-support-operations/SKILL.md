...
```yaml
skill_id: u3793
skill_name: u3793-multi-agent-negotiation-for-customer-support-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for customer support operations** before execution.
