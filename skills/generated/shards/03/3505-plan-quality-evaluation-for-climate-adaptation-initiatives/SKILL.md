...
```yaml
skill_id: u3505
skill_name: u3505-plan-quality-evaluation-for-climate-adaptation-initiatives
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for climate adaptation initiatives** before execution.
