...
```yaml
skill_id: u3236
skill_name: u3236-semantic-retrieval-ranking-for-lifelong-learning-plans
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for lifelong learning plans** before execution.
