...
```yaml
skill_id: u3507
skill_name: u3507-plan-quality-evaluation-for-urban-planning-and-mobility
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for urban planning and mobility** before execution.
