...
```yaml
skill_id: u3896
skill_name: u3896-conflict-resolution-coaching-for-disaster-response-networks
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for disaster response networks** before execution.
