...
```yaml
skill_id: u3272
skill_name: u3272-semantic-retrieval-ranking-for-marketing-and-storytelling
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for marketing and storytelling** before execution.
