...
```yaml
skill_id: u3082
skill_name: u3082-knowledge-graph-linking-for-healthcare-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for healthcare operations** before execution.
