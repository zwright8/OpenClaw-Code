...
```yaml
skill_id: u3254
skill_name: u3254-semantic-retrieval-ranking-for-software-engineering-delivery
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for software engineering delivery** before execution.
