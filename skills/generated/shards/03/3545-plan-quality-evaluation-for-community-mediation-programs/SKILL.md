...
```yaml
skill_id: u3545
skill_name: u3545-plan-quality-evaluation-for-community-mediation-programs
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for community mediation programs** before execution.
