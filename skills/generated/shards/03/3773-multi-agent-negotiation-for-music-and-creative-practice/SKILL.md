...
```yaml
skill_id: u3773
skill_name: u3773-multi-agent-negotiation-for-music-and-creative-practice
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for music and creative practice** before execution.
