---
name: u03707-multi-agent-negotiation-for-urban-planning-and-mobility
...
| Feature flag | `skill_03707_multi-agent-negotiation` |
| Release cycles | `2` |

## Why This Skill Exists
Use multi-agent negotiation in urban planning and mobility with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Multi-Agent Negotiation for urban planning and mobility under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Multi-Agent Negotiation for urban planning and mobility under pro-humanity impact conditions.
