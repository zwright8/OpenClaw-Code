...
```yaml
skill_id: u3365
skill_name: u3365-semantic-retrieval-ranking-for-childcare-support-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for childcare support systems** before execution.
