...
```yaml
skill_id: u3838
skill_name: u3838-conflict-resolution-coaching-for-lifelong-learning-plans
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for lifelong learning plans** before execution.
