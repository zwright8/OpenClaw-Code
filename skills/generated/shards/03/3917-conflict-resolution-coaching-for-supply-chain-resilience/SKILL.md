...
```yaml
skill_id: u3917
skill_name: u3917-conflict-resolution-coaching-for-supply-chain-resilience
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for supply chain resilience** before execution.
