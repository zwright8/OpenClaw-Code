...
```yaml
skill_id: u3379
skill_name: u3379-semantic-retrieval-ranking-for-journalism-and-public-communication
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for journalism and public communication** before execution.
