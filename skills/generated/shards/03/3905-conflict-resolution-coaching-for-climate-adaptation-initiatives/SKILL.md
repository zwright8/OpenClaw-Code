...
```yaml
skill_id: u3905
skill_name: u3905-conflict-resolution-coaching-for-climate-adaptation-initiatives
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for climate adaptation initiatives** before execution.
