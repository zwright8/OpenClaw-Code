...
```yaml
skill_id: u3845
skill_name: u3845-conflict-resolution-coaching-for-career-development-pathways
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for career development pathways** before execution.
