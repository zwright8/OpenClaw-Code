---
name: u03096-knowledge-graph-linking-for-disaster-response-networks
...
| Feature flag | `skill_03096_knowledge-graph-linking` |
| Release cycles | `2` |

## Why This Skill Exists
Use knowledge graph linking in disaster response networks with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Knowledge Graph Linking for disaster response networks under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Knowledge Graph Linking for disaster response networks under maximally truth-seeking conditions.
