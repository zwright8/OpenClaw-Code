...
```yaml
skill_id: u3523
skill_name: u3523-plan-quality-evaluation-for-manufacturing-quality-assurance
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for manufacturing quality assurance** before execution.
