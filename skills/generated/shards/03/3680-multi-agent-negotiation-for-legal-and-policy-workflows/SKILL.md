...
```yaml
skill_id: u3680
skill_name: u3680-multi-agent-negotiation-for-legal-and-policy-workflows
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for legal and policy workflows** before execution.
