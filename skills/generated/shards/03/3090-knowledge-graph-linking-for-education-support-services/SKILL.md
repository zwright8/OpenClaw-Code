...
```yaml
skill_id: u3090
skill_name: u3090-knowledge-graph-linking-for-education-support-services
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for education support services** before execution.
