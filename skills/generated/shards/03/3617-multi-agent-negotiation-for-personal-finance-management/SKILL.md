...
```yaml
skill_id: u3617
skill_name: u3617-multi-agent-negotiation-for-personal-finance-management
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for personal finance management** before execution.
