...
```yaml
skill_id: u3789
skill_name: u3789-multi-agent-negotiation-for-remote-team-collaboration
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for remote team collaboration** before execution.
