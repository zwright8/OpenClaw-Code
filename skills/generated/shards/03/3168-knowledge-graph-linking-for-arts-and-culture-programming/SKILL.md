...
```yaml
skill_id: u3168
skill_name: u3168-knowledge-graph-linking-for-arts-and-culture-programming
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for arts and culture programming** before execution.
