...
```yaml
skill_id: u3591
skill_name: u3591-plan-quality-evaluation-for-customer-support-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for customer support operations** before execution.
