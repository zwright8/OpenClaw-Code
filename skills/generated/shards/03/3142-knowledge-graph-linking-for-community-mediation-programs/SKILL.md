...
```yaml
skill_id: u3142
skill_name: u3142-knowledge-graph-linking-for-community-mediation-programs
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for community mediation programs** before execution.
