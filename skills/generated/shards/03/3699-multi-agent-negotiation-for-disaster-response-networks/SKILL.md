...
```yaml
skill_id: u3699
skill_name: u3699-multi-agent-negotiation-for-disaster-response-networks
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for disaster response networks** before execution.
