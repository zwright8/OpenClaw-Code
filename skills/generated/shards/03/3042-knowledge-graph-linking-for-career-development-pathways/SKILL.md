...
```yaml
skill_id: u3042
skill_name: u3042-knowledge-graph-linking-for-career-development-pathways
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for career development pathways** before execution.
