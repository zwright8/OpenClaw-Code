...
```yaml
skill_id: u3322
skill_name: u3322-semantic-retrieval-ranking-for-manufacturing-quality-assurance
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for manufacturing quality assurance** before execution.
