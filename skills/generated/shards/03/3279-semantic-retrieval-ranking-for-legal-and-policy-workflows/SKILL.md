...
```yaml
skill_id: u3279
skill_name: u3279-semantic-retrieval-ranking-for-legal-and-policy-workflows
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for legal and policy workflows** before execution.
