...
| Feature flag | `skill_03279_semantic-retrieval-ranking` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Semantic Retrieval Ranking for legal and policy workflows under hyper-productive autonomy conditions.
