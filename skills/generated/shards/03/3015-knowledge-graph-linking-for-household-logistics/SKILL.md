...
```yaml
skill_id: u3015
skill_name: u3015-knowledge-graph-linking-for-household-logistics
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for household logistics** before execution.
