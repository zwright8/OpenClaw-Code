...
```yaml
skill_id: u3077
skill_name: u3077-knowledge-graph-linking-for-legal-and-policy-workflows
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for legal and policy workflows** before execution.
