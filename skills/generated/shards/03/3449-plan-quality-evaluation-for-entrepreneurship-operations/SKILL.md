...
```yaml
skill_id: u3449
skill_name: u3449-plan-quality-evaluation-for-entrepreneurship-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for entrepreneurship operations** before execution.
