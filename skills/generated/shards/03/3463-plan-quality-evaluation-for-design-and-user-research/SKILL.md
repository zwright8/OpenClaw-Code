...
```yaml
skill_id: u3463
skill_name: u3463-plan-quality-evaluation-for-design-and-user-research
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for design and user research** before execution.
