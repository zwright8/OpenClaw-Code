...
```yaml
skill_id: u3660
skill_name: u3660-multi-agent-negotiation-for-product-management-execution
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for product management execution** before execution.
