...
```yaml
skill_id: u3621
skill_name: u3621-multi-agent-negotiation-for-nutrition-and-meal-planning
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for nutrition and meal planning** before execution.
