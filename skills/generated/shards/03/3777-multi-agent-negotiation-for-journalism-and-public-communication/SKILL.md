...
```yaml
skill_id: u3777
skill_name: u3777-multi-agent-negotiation-for-journalism-and-public-communication
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for journalism and public communication** before execution.
