...
```yaml
skill_id: u3095
skill_name: u3095-knowledge-graph-linking-for-nonprofit-program-delivery
shard_lane: "03"
operation: knowledge graph linking
...
## Musts
- Must verify the request truly requires **knowledge graph linking for nonprofit program delivery** before execution.
