...
```yaml
skill_id: u3715
skill_name: u3715-multi-agent-negotiation-for-agriculture-and-food-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for agriculture and food systems** before execution.
