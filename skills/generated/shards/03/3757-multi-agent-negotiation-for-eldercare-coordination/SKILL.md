...
```yaml
skill_id: u3757
skill_name: u3757-multi-agent-negotiation-for-eldercare-coordination
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for eldercare coordination** before execution.
