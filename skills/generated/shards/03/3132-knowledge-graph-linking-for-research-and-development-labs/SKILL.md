...
```yaml
skill_id: u3132
skill_name: u3132-knowledge-graph-linking-for-research-and-development-labs
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for research and development labs** before execution.
