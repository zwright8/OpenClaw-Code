...
```yaml
skill_id: u3708
skill_name: u3708-multi-agent-negotiation-for-urban-planning-and-mobility
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for urban planning and mobility** before execution.
