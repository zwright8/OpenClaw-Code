...
```yaml
skill_id: u3196
skill_name: u3196-knowledge-graph-linking-for-knowledge-management-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for knowledge management systems** before execution.
