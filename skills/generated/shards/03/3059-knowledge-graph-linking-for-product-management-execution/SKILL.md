...
```yaml
skill_id: u3059
skill_name: u3059-knowledge-graph-linking-for-product-management-execution
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for product management execution** before execution.
