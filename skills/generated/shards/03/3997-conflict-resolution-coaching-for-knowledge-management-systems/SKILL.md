...
```yaml
skill_id: u3997
skill_name: u3997-conflict-resolution-coaching-for-knowledge-management-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for knowledge management systems** before execution.
