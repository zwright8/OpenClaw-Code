...
```yaml
skill_id: u3256
skill_name: u3256-semantic-retrieval-ranking-for-product-management-execution
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for product management execution** before execution.
