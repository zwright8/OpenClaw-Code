---
name: u03346-semantic-retrieval-ranking-for-civic-participation-platforms
...
| Feature flag | `skill_03346_semantic-retrieval-ranking` |
| Release cycles | `2` |

## Why This Skill Exists
Use semantic retrieval ranking in civic participation platforms with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Semantic Retrieval Ranking for civic participation platforms under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Semantic Retrieval Ranking for civic participation platforms under maximally truth-seeking conditions.
...
1. `OpenSearch/Elasticsearch` -> auth preflight, execute read/query call(s), normalize output, and attach trace to `semantic-retrieval-ranking-artifact-civic-participation-platform`.
2. `Qdrant/Weaviate/pgvector` -> auth preflight, execute read/query call(s), normalize output, and attach trace to `semantic-retrieval-ranking-artifact-civic-participation-platform`.
3. `Cohere/Jina reranker` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `semantic-retrieval-ranking-artifact-civic-participation-platform`.
