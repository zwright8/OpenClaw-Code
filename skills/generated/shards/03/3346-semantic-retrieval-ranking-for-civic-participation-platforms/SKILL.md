...
```yaml
skill_id: u3346
skill_name: u3346-semantic-retrieval-ranking-for-civic-participation-platforms
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for civic participation platforms** before execution.
