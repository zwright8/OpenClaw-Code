...
```yaml
skill_id: u3033
skill_name: u3033-knowledge-graph-linking-for-mental-well-being-practices
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for mental well being practices** before execution.
