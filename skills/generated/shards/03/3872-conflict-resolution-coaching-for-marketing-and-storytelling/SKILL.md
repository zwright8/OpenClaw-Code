...
```yaml
skill_id: u3872
skill_name: u3872-conflict-resolution-coaching-for-marketing-and-storytelling
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for marketing and storytelling** before execution.
