...
```yaml
skill_id: u3642
skill_name: u3642-multi-agent-negotiation-for-career-development-pathways
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **multi agent negotiation for career development pathways** before execution.
