...
```yaml
skill_id: u3912
skill_name: u3912-conflict-resolution-coaching-for-agriculture-and-food-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for agriculture and food systems** before execution.
