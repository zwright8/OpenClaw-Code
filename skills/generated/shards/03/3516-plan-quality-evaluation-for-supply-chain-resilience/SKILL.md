...
```yaml
skill_id: u3516
skill_name: u3516-plan-quality-evaluation-for-supply-chain-resilience
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for supply chain resilience** before execution.
