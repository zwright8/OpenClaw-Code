...
```yaml
skill_id: u3025
skill_name: u3025-knowledge-graph-linking-for-nutrition-and-meal-planning
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for nutrition and meal planning** before execution.
