...
```yaml
skill_id: u3437
skill_name: u3437-plan-quality-evaluation-for-lifelong-learning-plans
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for lifelong learning plans** before execution.
