...
```yaml
skill_id: u3005
skill_name: u3005-knowledge-graph-linking-for-personal-health-routines
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **knowledge graph linking for personal health routines** before execution.
