...
```yaml
skill_id: u3823
skill_name: u3823-conflict-resolution-coaching-for-nutrition-and-meal-planning
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for nutrition and meal planning** before execution.
