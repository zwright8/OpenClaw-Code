...
```yaml
skill_id: u3817
skill_name: u3817-conflict-resolution-coaching-for-personal-finance-management
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for personal finance management** before execution.
