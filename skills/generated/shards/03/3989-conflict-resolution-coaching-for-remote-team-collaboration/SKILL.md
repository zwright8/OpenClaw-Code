...
```yaml
skill_id: u3989
skill_name: u3989-conflict-resolution-coaching-for-remote-team-collaboration
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for remote team collaboration** before execution.
