...
| Feature flag | `skill_03746_multi-agent-negotiation` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Multi-Agent Negotiation for civic participation platforms under maximally truth-seeking conditions.
