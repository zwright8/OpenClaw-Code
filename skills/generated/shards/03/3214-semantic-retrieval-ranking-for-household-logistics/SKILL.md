...
```yaml
skill_id: u3214
skill_name: u3214-semantic-retrieval-ranking-for-household-logistics
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for household logistics** before execution.
