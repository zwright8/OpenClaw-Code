...
```yaml
skill_id: u3475
skill_name: u3475-plan-quality-evaluation-for-marketing-and-storytelling
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for marketing and storytelling** before execution.
