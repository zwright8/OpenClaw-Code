...
```yaml
skill_id: u3443
skill_name: u3443-plan-quality-evaluation-for-career-development-pathways
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **plan quality evaluation for career development pathways** before execution.
