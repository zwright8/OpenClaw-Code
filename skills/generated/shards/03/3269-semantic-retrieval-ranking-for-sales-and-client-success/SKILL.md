...
| Feature flag | `skill_03269_semantic-retrieval-ranking` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Semantic Retrieval Ranking for sales and client success under hyper-productive autonomy conditions.
