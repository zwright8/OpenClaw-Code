...
```yaml
skill_id: u3948
skill_name: u3948-conflict-resolution-coaching-for-civic-participation-platforms
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for civic participation platforms** before execution.
