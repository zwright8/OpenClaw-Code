---
name: u3800-multi-agent-negotiation-for-knowledge-management-systems
...
This skill hardens a generated capability for production execution so multi agent negotiation for knowledge management systems workflows remain deterministic, auditable, and fail-closed under risk.

## When To Use
Use this skill only when the request explicitly needs `multi agent negotiation for knowledge management systems` and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **multi agent negotiation for knowledge management systems** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **knowledge management systems" capability in production for multi agent negotiation for knowledge management systems workflows** with measurable acceptance criteria.
...
- **Daily:** Run when new knowledge management systems" capability in production for multi agent negotiation for knowledge management systems workflows signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in knowledge management systems" capability in production for multi agent negotiation for knowledge management systems workflows**
   - Input: noisy upstream payload requiring multi agent negotiation for knowledge management systems normalization/assessment.
