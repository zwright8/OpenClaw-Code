...
```yaml
skill_id: u3330
skill_name: u3330-semantic-retrieval-ranking-for-cybersecurity-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for cybersecurity operations** before execution.
