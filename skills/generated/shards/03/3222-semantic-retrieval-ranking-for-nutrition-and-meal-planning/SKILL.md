...
```yaml
skill_id: u3222
skill_name: u3222-semantic-retrieval-ranking-for-nutrition-and-meal-planning
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for nutrition and meal planning** before execution.
