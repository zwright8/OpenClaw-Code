...
```yaml
skill_id: u3266
skill_name: u3266-semantic-retrieval-ranking-for-sales-and-client-success
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for sales and client success** before execution.
