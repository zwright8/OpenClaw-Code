...
```yaml
skill_id: u3288
skill_name: u3288-semantic-retrieval-ranking-for-education-support-services
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **semantic retrieval ranking for education support services** before execution.
