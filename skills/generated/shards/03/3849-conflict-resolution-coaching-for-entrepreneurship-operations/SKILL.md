...
```yaml
skill_id: u3849
skill_name: u3849-conflict-resolution-coaching-for-entrepreneurship-operations
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for entrepreneurship operations** before execution.
