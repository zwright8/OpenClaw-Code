...
```yaml
skill_id: u3943
skill_name: u3943-conflict-resolution-coaching-for-community-mediation-programs
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for community mediation programs** before execution.
