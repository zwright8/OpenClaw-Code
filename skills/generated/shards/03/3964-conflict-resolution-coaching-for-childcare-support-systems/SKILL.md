...
```yaml
skill_id: u3964
skill_name: u3964-conflict-resolution-coaching-for-childcare-support-systems
shard_lane: "03"
...
## Musts
- Must verify the request truly requires **conflict resolution coaching for childcare support systems** before execution.
