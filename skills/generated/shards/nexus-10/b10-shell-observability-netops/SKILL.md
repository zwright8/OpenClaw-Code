...
This skill clusters adjacent tools from ranks **4596-4627** in the top-5000 inventory.

## Tool families in this pack

- Shell and terminal ergonomics (`oils-for-unix`, `zsh-autopair`, `killport`).
- Observability and profiling (`victorialogs`, `flamegraph`, `sampler`, `zabbix-cli`).
- Infra/network operations (`tfmigrate`, `scamper`, `iamy`).
