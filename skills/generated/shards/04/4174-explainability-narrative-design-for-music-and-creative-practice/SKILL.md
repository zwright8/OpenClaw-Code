...
description: Operate the "Explainability narrative design for music and creative practice" capability in production for music and creative practice workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
```yaml
capability_id: u04174-explainability-narrative-design-for-music-and-creative-practice
capability_name: Explainability narrative design for music and creative practice
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for music and creative practice".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for music and creative practice** in **music and creative practice**.
