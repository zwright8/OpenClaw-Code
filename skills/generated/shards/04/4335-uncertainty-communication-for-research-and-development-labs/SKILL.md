...
description: Operate the "Uncertainty communication for research and development labs" capability in production for research and development labs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Uncertainty communication for research and development labs` in research and development labs and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Uncertainty communication for research and development labs** outcomes (not generic brainstorming).
...
1. **Incident stabilization in research and development labs" capability in production for research and development labs workflows**
   - Input: noisy upstream payload requiring uncertainty communication for research and development labs normalization/assessment.
