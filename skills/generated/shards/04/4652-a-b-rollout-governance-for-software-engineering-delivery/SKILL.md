...
## Metadata
```yaml
capability_id: u04652-a-b-rollout-governance-for-software-engineering-delivery
capability_name: A b rollout governance for software engineering delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for software engineering delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for software engineering delivery** in **software engineering delivery**.
