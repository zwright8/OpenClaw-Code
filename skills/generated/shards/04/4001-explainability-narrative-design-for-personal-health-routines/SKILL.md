...
## Metadata
```yaml
capability_id: u04001-explainability-narrative-design-for-personal-health-routines
capability_name: Explainability narrative design for personal health routines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for personal health routines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for personal health routines** in **personal health routines**.
