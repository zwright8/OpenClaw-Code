...
## Metadata
```yaml
capability_id: u04508-experiment-design-for-urban-planning-and-mobility
capability_name: Experiment design for urban planning and mobility
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for urban planning and mobility".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for urban planning and mobility** in **urban planning and mobility**.
