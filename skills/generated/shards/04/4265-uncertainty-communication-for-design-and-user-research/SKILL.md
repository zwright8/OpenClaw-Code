...
## Metadata
```yaml
capability_id: u04265-uncertainty-communication-for-design-and-user-research
capability_name: Uncertainty communication for design and user research
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for design and user research".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for design and user research** in **design and user research**.
