...
## Metadata
```yaml
capability_id: u04843-incident-playbook-synthesis-for-career-development-pathways
capability_name: Incident playbook synthesis for career development pathways
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for career development pathways".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for career development pathways** in **career development pathways**.
