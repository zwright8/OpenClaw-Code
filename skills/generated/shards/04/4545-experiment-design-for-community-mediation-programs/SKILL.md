...
## Metadata
```yaml
capability_id: u04545-experiment-design-for-community-mediation-programs
capability_name: Experiment design for community mediation programs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for community mediation programs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for community mediation programs** in **community mediation programs**.
