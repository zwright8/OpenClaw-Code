...
| Feature flag | `skill_04731_a-b-rollout-governance` |
| Release cycles | `2` |

## Why This Skill Exists
Use a/b rollout governance in research and development labs with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for A/B Rollout Governance for research and development labs under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for A/B Rollout Governance for research and development labs under maximally truth-seeking conditions.
...
1. `LaunchDarkly/Unleash` -> auth preflight, execute read+write/orchestrate call(s), normalize output, and attach trace to `a-b-rollout-governance-artifact-research-and-development-labs`.
2. `Statsig/Optimizely` -> auth preflight, execute read+write/orchestrate call(s), normalize output, and attach trace to `a-b-rollout-governance-artifact-research-and-development-labs`.
3. `SciPy/Statsmodels` -> auth preflight, execute read/query call(s), normalize output, and attach trace to `a-b-rollout-governance-artifact-research-and-development-labs`.
