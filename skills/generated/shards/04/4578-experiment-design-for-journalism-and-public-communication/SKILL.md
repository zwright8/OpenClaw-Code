...
## Metadata
```yaml
capability_id: u04578-experiment-design-for-journalism-and-public-communication
capability_name: Experiment design for journalism and public communication
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for journalism and public communication".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for journalism and public communication** in **journalism and public communication**.
