...
## Metadata
```yaml
capability_id: u04323-uncertainty-communication-for-manufacturing-quality-assurance
capability_name: Uncertainty communication for manufacturing quality assurance
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for manufacturing quality assurance".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for manufacturing quality assurance** in **manufacturing quality assurance**.
