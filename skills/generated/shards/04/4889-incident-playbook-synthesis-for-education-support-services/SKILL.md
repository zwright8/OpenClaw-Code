...
## Metadata
```yaml
capability_id: u04889-incident-playbook-synthesis-for-education-support-services
capability_name: Incident playbook synthesis for education support services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for education support services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for education support services** in **education support services**.
