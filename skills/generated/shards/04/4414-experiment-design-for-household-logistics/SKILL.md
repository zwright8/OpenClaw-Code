...
## Metadata
```yaml
capability_id: u04414-experiment-design-for-household-logistics
capability_name: Experiment design for household logistics
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for household logistics".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for household logistics** in **household logistics**.
