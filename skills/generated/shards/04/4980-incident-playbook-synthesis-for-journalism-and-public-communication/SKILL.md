...
## Metadata
```yaml
capability_id: u04980-incident-playbook-synthesis-for-journalism-and-public-communication
capability_name: Incident playbook synthesis for journalism and public communication
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for journalism and public communication".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for journalism and public communication** in **journalism and public communication**.
