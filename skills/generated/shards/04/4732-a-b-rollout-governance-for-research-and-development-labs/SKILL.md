...
| Feature flag | `skill_04732_a-b-rollout-governance` |
| Release cycles | `2` |

## Why This Skill Exists
Use a/b rollout governance in research and development labs with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for A/B Rollout Governance for research and development labs under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for A/B Rollout Governance for research and development labs under pro-humanity impact conditions.
