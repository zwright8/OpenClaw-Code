...
## Metadata
```yaml
capability_id: u04407-experiment-design-for-family-caregiving-systems
capability_name: Experiment design for family caregiving systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for family caregiving systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for family caregiving systems** in **family caregiving systems**.
