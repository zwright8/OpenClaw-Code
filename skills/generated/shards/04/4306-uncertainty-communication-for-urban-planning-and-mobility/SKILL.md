...
## Metadata
```yaml
capability_id: u04306-uncertainty-communication-for-urban-planning-and-mobility
capability_name: Uncertainty communication for urban planning and mobility
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for urban planning and mobility".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for urban planning and mobility** in **urban planning and mobility**.
