...
## Metadata
```yaml
capability_id: u04767-a-b-rollout-governance-for-arts-and-culture-programming
capability_name: A b rollout governance for arts and culture programming
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for arts and culture programming".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for arts and culture programming** in **arts and culture programming**.
