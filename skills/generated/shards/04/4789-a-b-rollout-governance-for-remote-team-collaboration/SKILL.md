...
## Metadata
```yaml
capability_id: u04789-a-b-rollout-governance-for-remote-team-collaboration
capability_name: A b rollout governance for remote team collaboration
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for remote team collaboration".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for remote team collaboration** in **remote team collaboration**.
