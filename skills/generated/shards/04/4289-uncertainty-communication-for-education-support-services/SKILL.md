...
## Metadata
```yaml
capability_id: u04289-uncertainty-communication-for-education-support-services
capability_name: Uncertainty communication for education support services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for education support services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for education support services** in **education support services**.
