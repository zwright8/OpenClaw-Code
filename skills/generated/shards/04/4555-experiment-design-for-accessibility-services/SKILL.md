...
## Metadata
```yaml
capability_id: u04555-experiment-design-for-accessibility-services
capability_name: Experiment design for accessibility services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for accessibility services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for accessibility services** in **accessibility services**.
