...
## Metadata
```yaml
capability_id: u04643-a-b-rollout-governance-for-career-development-pathways
capability_name: A b rollout governance for career development pathways
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for career development pathways".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for career development pathways** in **career development pathways**.
