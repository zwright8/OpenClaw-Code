...
## Metadata
```yaml
capability_id: u04684-a-b-rollout-governance-for-healthcare-operations
capability_name: A b rollout governance for healthcare operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for healthcare operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for healthcare operations** in **healthcare operations**.
