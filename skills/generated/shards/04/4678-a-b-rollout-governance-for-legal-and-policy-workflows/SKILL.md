...
## Metadata
```yaml
capability_id: u04678-a-b-rollout-governance-for-legal-and-policy-workflows
capability_name: A b rollout governance for legal and policy workflows
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for legal and policy workflows".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for legal and policy workflows** in **legal and policy workflows**.
