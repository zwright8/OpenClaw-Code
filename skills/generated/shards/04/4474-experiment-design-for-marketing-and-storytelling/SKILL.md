...
## Metadata
```yaml
capability_id: u04474-experiment-design-for-marketing-and-storytelling
capability_name: Experiment design for marketing and storytelling
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for marketing and storytelling".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for marketing and storytelling** in **marketing and storytelling**.
