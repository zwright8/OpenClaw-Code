...
## Metadata
```yaml
capability_id: u04601-a-b-rollout-governance-for-personal-health-routines
capability_name: A b rollout governance for personal health routines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for personal health routines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for personal health routines** in **personal health routines**.
