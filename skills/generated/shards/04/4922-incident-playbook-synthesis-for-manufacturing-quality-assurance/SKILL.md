...
## Metadata
```yaml
capability_id: u04922-incident-playbook-synthesis-for-manufacturing-quality-assurance
capability_name: Incident playbook synthesis for manufacturing quality assurance
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for manufacturing quality assurance".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for manufacturing quality assurance** in **manufacturing quality assurance**.
