...
## Metadata
```yaml
capability_id: u04827-incident-playbook-synthesis-for-fitness-and-recovery-training
capability_name: Incident playbook synthesis for fitness and recovery training
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for fitness and recovery training".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for fitness and recovery training** in **fitness and recovery training**.
