...
## Metadata
```yaml
capability_id: u04920-incident-playbook-synthesis-for-supply-chain-resilience
capability_name: Incident playbook synthesis for supply chain resilience
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for supply chain resilience".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for supply chain resilience** in **supply chain resilience**.
