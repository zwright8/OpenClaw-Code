...
## Metadata
```yaml
capability_id: u04752-a-b-rollout-governance-for-accessibility-services
capability_name: A b rollout governance for accessibility services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for accessibility services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for accessibility services** in **accessibility services**.
