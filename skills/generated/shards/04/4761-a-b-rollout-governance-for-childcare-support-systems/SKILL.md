...
## Metadata
```yaml
capability_id: u04761-a-b-rollout-governance-for-childcare-support-systems
capability_name: A b rollout governance for childcare support systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for childcare support systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for childcare support systems** in **childcare support systems**.
