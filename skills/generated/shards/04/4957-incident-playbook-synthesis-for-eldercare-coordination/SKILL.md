...
## Metadata
```yaml
capability_id: u04957-incident-playbook-synthesis-for-eldercare-coordination
capability_name: Incident playbook synthesis for eldercare coordination
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for eldercare coordination".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for eldercare coordination** in **eldercare coordination**.
