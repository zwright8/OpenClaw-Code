...
## Metadata
```yaml
capability_id: u04184-explainability-narrative-design-for-multilingual-translation-services
capability_name: Explainability narrative design for multilingual translation services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for multilingual translation services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for multilingual translation services** in **multilingual translation services**.
