...
## Metadata
```yaml
capability_id: u04856-incident-playbook-synthesis-for-product-management-execution
capability_name: Incident playbook synthesis for product management execution
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for product management execution".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for product management execution** in **product management execution**.
