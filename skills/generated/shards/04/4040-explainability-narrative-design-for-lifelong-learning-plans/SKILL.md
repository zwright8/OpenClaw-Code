...
## Metadata
```yaml
capability_id: u04040-explainability-narrative-design-for-lifelong-learning-plans
capability_name: Explainability narrative design for lifelong learning plans
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for lifelong learning plans".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for lifelong learning plans** in **lifelong learning plans**.
