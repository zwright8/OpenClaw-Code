...
## Metadata
```yaml
capability_id: u04319-uncertainty-communication-for-supply-chain-resilience
capability_name: Uncertainty communication for supply chain resilience
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for supply chain resilience".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for supply chain resilience** in **supply chain resilience**.
