...
## Metadata
```yaml
capability_id: u04479-experiment-design-for-legal-and-policy-workflows
capability_name: Experiment design for legal and policy workflows
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for legal and policy workflows".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for legal and policy workflows** in **legal and policy workflows**.
