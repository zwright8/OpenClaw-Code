...
## Metadata
```yaml
capability_id: u04267-uncertainty-communication-for-sales-and-client-success
capability_name: Uncertainty communication for sales and client success
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for sales and client success".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for sales and client success** in **sales and client success**.
