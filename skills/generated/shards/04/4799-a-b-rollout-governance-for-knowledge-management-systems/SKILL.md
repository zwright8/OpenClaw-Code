...
## Metadata
```yaml
capability_id: u04799-a-b-rollout-governance-for-knowledge-management-systems
capability_name: A b rollout governance for knowledge management systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for knowledge management systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for knowledge management systems** in **knowledge management systems**.
