...
## Metadata
```yaml
capability_id: u04933-incident-playbook-synthesis-for-research-and-development-labs
capability_name: Incident playbook synthesis for research and development labs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for research and development labs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for research and development labs** in **research and development labs**.
