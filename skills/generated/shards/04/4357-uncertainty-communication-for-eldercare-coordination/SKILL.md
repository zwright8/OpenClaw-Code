...
## Metadata
```yaml
capability_id: u04357-uncertainty-communication-for-eldercare-coordination
capability_name: Uncertainty communication for eldercare coordination
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for eldercare coordination".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for eldercare coordination** in **eldercare coordination**.
