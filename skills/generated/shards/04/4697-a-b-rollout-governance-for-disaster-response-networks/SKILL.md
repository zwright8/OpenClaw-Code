...
## Metadata
```yaml
capability_id: u04697-a-b-rollout-governance-for-disaster-response-networks
capability_name: A b rollout governance for disaster response networks
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for disaster response networks".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for disaster response networks** in **disaster response networks**.
