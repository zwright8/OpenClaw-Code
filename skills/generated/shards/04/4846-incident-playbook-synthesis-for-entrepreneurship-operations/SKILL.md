...
## Metadata
```yaml
capability_id: u04846-incident-playbook-synthesis-for-entrepreneurship-operations
capability_name: Incident playbook synthesis for entrepreneurship operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for entrepreneurship operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for entrepreneurship operations** in **entrepreneurship operations**.
