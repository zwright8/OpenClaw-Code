...
## Metadata
```yaml
capability_id: u04536-experiment-design-for-scientific-publishing-pipelines
capability_name: Experiment design for scientific publishing pipelines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for scientific publishing pipelines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for scientific publishing pipelines** in **scientific publishing pipelines**.
