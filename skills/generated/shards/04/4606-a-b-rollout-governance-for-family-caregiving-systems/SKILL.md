...
## Metadata
```yaml
capability_id: u04606-a-b-rollout-governance-for-family-caregiving-systems
capability_name: A b rollout governance for family caregiving systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for family caregiving systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for family caregiving systems** in **family caregiving systems**.
