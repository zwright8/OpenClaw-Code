...
## Metadata
```yaml
capability_id: u04951-incident-playbook-synthesis-for-accessibility-services
capability_name: Incident playbook synthesis for accessibility services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for accessibility services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for accessibility services** in **accessibility services**.
