...
## Metadata
```yaml
capability_id: u04791-a-b-rollout-governance-for-customer-support-operations
capability_name: A b rollout governance for customer support operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for customer support operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for customer support operations** in **customer support operations**.
