...
## Metadata
```yaml
capability_id: u04339-uncertainty-communication-for-scientific-publishing-pipelines
capability_name: Uncertainty communication for scientific publishing pipelines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for scientific publishing pipelines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for scientific publishing pipelines** in **scientific publishing pipelines**.
