...
## Metadata
```yaml
capability_id: u04387-uncertainty-communication-for-remote-team-collaboration
capability_name: Uncertainty communication for remote team collaboration
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for remote team collaboration".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for remote team collaboration** in **remote team collaboration**.
