...
## Metadata
```yaml
capability_id: u04000-conflict-resolution-coaching-for-knowledge-management-systems
capability_name: Conflict resolution coaching for knowledge management systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Conflict resolution coaching for knowledge management systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Conflict resolution coaching for knowledge management systems** in **knowledge management systems**.
