...
## Metadata
```yaml
capability_id: u04628-a-b-rollout-governance-for-fitness-and-recovery-training
capability_name: A b rollout governance for fitness and recovery training
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for fitness and recovery training".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for fitness and recovery training** in **fitness and recovery training**.
