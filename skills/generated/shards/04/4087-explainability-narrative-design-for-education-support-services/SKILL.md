...
## Metadata
```yaml
capability_id: u04087-explainability-narrative-design-for-education-support-services
capability_name: Explainability narrative design for education support services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for education support services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for education support services** in **education support services**.
