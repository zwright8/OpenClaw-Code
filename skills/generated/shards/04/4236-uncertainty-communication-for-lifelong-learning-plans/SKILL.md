...
## Metadata
```yaml
capability_id: u04236-uncertainty-communication-for-lifelong-learning-plans
capability_name: Uncertainty communication for lifelong learning plans
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for lifelong learning plans".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for lifelong learning plans** in **lifelong learning plans**.
