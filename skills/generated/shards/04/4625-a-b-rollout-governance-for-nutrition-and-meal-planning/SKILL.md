...
## Metadata
```yaml
capability_id: u04625-a-b-rollout-governance-for-nutrition-and-meal-planning
capability_name: A b rollout governance for nutrition and meal planning
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for nutrition and meal planning".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for nutrition and meal planning** in **nutrition and meal planning**.
