...
## Metadata
```yaml
capability_id: u04465-experiment-design-for-design-and-user-research
capability_name: Experiment design for design and user research
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for design and user research".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for design and user research** in **design and user research**.
