...
## Metadata
```yaml
capability_id: u04092-explainability-narrative-design-for-nonprofit-program-delivery
capability_name: Explainability narrative design for nonprofit program delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for nonprofit program delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for nonprofit program delivery** in **nonprofit program delivery**.
