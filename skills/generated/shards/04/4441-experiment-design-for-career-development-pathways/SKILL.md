...
## Metadata
```yaml
capability_id: u04441-experiment-design-for-career-development-pathways
capability_name: Experiment design for career development pathways
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for career development pathways".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for career development pathways** in **career development pathways**.
