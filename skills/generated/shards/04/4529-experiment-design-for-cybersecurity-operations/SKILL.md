...
## Metadata
```yaml
capability_id: u04529-experiment-design-for-cybersecurity-operations
capability_name: Experiment design for cybersecurity operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for cybersecurity operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for cybersecurity operations** in **cybersecurity operations**.
