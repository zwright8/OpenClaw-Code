...
## Metadata
```yaml
capability_id: u04446-experiment-design-for-entrepreneurship-operations
capability_name: Experiment design for entrepreneurship operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for entrepreneurship operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for entrepreneurship operations** in **entrepreneurship operations**.
