...
## Metadata
```yaml
capability_id: u04302-uncertainty-communication-for-climate-adaptation-initiatives
capability_name: Uncertainty communication for climate adaptation initiatives
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for climate adaptation initiatives".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for climate adaptation initiatives** in **climate adaptation initiatives**.
