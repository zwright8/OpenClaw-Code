...
description: Operate the "Explainability narrative design for urban planning and mobility" capability in production for urban planning and mobility workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Explainability narrative design for urban planning and mobility` in urban planning and mobility and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Explainability narrative design for urban planning and mobility** outcomes (not generic brainstorming).
...
1. **Incident stabilization in urban planning and mobility" capability in production for urban planning and mobility workflows**
   - Input: noisy upstream payload requiring explainability narrative design for urban planning and mobility normalization/assessment.
