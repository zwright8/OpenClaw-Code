...
## Metadata
```yaml
capability_id: u04739-a-b-rollout-governance-for-scientific-publishing-pipelines
capability_name: A b rollout governance for scientific publishing pipelines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for scientific publishing pipelines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for scientific publishing pipelines** in **scientific publishing pipelines**.
