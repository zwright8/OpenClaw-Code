...
## Metadata
```yaml
capability_id: u04380-uncertainty-communication-for-journalism-and-public-communication
capability_name: Uncertainty communication for journalism and public communication
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for journalism and public communication".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for journalism and public communication** in **journalism and public communication**.
