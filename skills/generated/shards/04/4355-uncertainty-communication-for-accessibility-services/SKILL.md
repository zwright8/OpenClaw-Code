...
## Metadata
```yaml
capability_id: u04355-uncertainty-communication-for-accessibility-services
capability_name: Uncertainty communication for accessibility services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for accessibility services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for accessibility services** in **accessibility services**.
