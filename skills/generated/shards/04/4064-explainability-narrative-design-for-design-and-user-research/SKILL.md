...
## Metadata
```yaml
capability_id: u04064-explainability-narrative-design-for-design-and-user-research
capability_name: Explainability narrative design for design and user research
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for design and user research".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for design and user research** in **design and user research**.
