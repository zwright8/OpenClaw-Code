...
## Metadata
```yaml
capability_id: u04534-experiment-design-for-research-and-development-labs
capability_name: Experiment design for research and development labs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for research and development labs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for research and development labs** in **research and development labs**.
