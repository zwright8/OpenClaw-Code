...
## Metadata
```yaml
capability_id: u04491-experiment-design-for-nonprofit-program-delivery
capability_name: Experiment design for nonprofit program delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for nonprofit program delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for nonprofit program delivery** in **nonprofit program delivery**.
