...
## Metadata
```yaml
capability_id: u04967-incident-playbook-synthesis-for-arts-and-culture-programming
capability_name: Incident playbook synthesis for arts and culture programming
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for arts and culture programming".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for arts and culture programming** in **arts and culture programming**.
