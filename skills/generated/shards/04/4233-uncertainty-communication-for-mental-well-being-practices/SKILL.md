...
## Metadata
```yaml
capability_id: u04233-uncertainty-communication-for-mental-well-being-practices
capability_name: Uncertainty communication for mental well being practices
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for mental well being practices".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for mental well being practices** in **mental well being practices**.
