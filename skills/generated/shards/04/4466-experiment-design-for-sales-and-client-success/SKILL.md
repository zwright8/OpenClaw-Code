...
## Metadata
```yaml
capability_id: u04466-experiment-design-for-sales-and-client-success
capability_name: Experiment design for sales and client success
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for sales and client success".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for sales and client success** in **sales and client success**.
