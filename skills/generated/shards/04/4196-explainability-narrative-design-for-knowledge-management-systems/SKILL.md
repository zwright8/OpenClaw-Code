...
## Metadata
```yaml
capability_id: u04196-explainability-narrative-design-for-knowledge-management-systems
capability_name: Explainability narrative design for knowledge management systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for knowledge management systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for knowledge management systems** in **knowledge management systems**.
