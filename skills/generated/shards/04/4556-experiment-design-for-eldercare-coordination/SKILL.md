...
## Metadata
```yaml
capability_id: u04556-experiment-design-for-eldercare-coordination
capability_name: Experiment design for eldercare coordination
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for eldercare coordination".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for eldercare coordination** in **eldercare coordination**.
