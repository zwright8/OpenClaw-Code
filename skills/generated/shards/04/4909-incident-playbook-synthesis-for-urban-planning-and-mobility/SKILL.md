...
## Metadata
```yaml
capability_id: u04909-incident-playbook-synthesis-for-urban-planning-and-mobility
capability_name: Incident playbook synthesis for urban planning and mobility
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for urban planning and mobility".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for urban planning and mobility** in **urban planning and mobility**.
