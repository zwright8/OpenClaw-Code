...
## Metadata
```yaml
capability_id: u04011-explainability-narrative-design-for-household-logistics
capability_name: Explainability narrative design for household logistics
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for household logistics".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for household logistics** in **household logistics**.
