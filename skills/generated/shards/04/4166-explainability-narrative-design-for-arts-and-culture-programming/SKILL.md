...
## Metadata
```yaml
capability_id: u04166-explainability-narrative-design-for-arts-and-culture-programming
capability_name: Explainability narrative design for arts and culture programming
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for arts and culture programming".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for arts and culture programming** in **arts and culture programming**.
