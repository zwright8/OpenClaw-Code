...
## Metadata
```yaml
capability_id: u04982-incident-playbook-synthesis-for-multilingual-translation-services
capability_name: Incident playbook synthesis for multilingual translation services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for multilingual translation services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for multilingual translation services** in **multilingual translation services**.
