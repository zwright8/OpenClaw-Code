...
## Metadata
```yaml
capability_id: u04108-explainability-narrative-design-for-urban-planning-and-mobility
capability_name: Explainability narrative design for urban planning and mobility
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for urban planning and mobility".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for urban planning and mobility** in **urban planning and mobility**.
