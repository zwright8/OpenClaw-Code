...
## Metadata
```yaml
capability_id: u04637-a-b-rollout-governance-for-lifelong-learning-plans
capability_name: A b rollout governance for lifelong learning plans
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for lifelong learning plans".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for lifelong learning plans** in **lifelong learning plans**.
