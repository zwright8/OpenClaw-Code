...
## Metadata
```yaml
capability_id: u04646-a-b-rollout-governance-for-entrepreneurship-operations
capability_name: A b rollout governance for entrepreneurship operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for entrepreneurship operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for entrepreneurship operations** in **entrepreneurship operations**.
