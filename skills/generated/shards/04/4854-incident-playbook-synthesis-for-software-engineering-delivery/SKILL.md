...
## Metadata
```yaml
capability_id: u04854-incident-playbook-synthesis-for-software-engineering-delivery
capability_name: Incident playbook synthesis for software engineering delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for software engineering delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for software engineering delivery** in **software engineering delivery**.
