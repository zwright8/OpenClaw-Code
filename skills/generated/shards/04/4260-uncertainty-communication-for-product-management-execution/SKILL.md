...
## Metadata
```yaml
capability_id: u04260-uncertainty-communication-for-product-management-execution
capability_name: Uncertainty communication for product management execution
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for product management execution".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for product management execution** in **product management execution**.
