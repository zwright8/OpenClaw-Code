...
## Metadata
```yaml
capability_id: u04948-incident-playbook-synthesis-for-civic-participation-platforms
capability_name: Incident playbook synthesis for civic participation platforms
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for civic participation platforms".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for civic participation platforms** in **civic participation platforms**.
