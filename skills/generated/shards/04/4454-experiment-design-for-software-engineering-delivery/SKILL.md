...
## Metadata
```yaml
capability_id: u04454-experiment-design-for-software-engineering-delivery
capability_name: Experiment design for software engineering delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for software engineering delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for software engineering delivery** in **software engineering delivery**.
