...
## Metadata
```yaml
capability_id: u04328-uncertainty-communication-for-cybersecurity-operations
capability_name: Uncertainty communication for cybersecurity operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for cybersecurity operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for cybersecurity operations** in **cybersecurity operations**.
