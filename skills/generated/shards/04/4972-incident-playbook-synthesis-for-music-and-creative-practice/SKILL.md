...
## Metadata
```yaml
capability_id: u04972-incident-playbook-synthesis-for-music-and-creative-practice
capability_name: Incident playbook synthesis for music and creative practice
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for music and creative practice".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for music and creative practice** in **music and creative practice**.
