...
## Metadata
```yaml
capability_id: u04071-explainability-narrative-design-for-marketing-and-storytelling
capability_name: Explainability narrative design for marketing and storytelling
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for marketing and storytelling".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for marketing and storytelling** in **marketing and storytelling**.
