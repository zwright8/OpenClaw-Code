...
## Metadata
```yaml
capability_id: u04076-explainability-narrative-design-for-legal-and-policy-workflows
capability_name: Explainability narrative design for legal and policy workflows
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for legal and policy workflows".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for legal and policy workflows** in **legal and policy workflows**.
