...
## Metadata
```yaml
capability_id: u04735-a-b-rollout-governance-for-research-and-development-labs
capability_name: A b rollout governance for research and development labs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for research and development labs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for research and development labs** in **research and development labs**.
