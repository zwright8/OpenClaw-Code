...
## Metadata
```yaml
capability_id: u04242-uncertainty-communication-for-career-development-pathways
capability_name: Uncertainty communication for career development pathways
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for career development pathways".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for career development pathways** in **career development pathways**.
