...
## Metadata
```yaml
capability_id: u04701-a-b-rollout-governance-for-climate-adaptation-initiatives
capability_name: A b rollout governance for climate adaptation initiatives
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for climate adaptation initiatives".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for climate adaptation initiatives** in **climate adaptation initiatives**.
