...
## Metadata
```yaml
capability_id: u04251-uncertainty-communication-for-software-engineering-delivery
capability_name: Uncertainty communication for software engineering delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for software engineering delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for software engineering delivery** in **software engineering delivery**.
