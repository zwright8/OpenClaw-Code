...
## Metadata
```yaml
capability_id: u04837-incident-playbook-synthesis-for-lifelong-learning-plans
capability_name: Incident playbook synthesis for lifelong learning plans
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for lifelong learning plans".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for lifelong learning plans** in **lifelong learning plans**.
