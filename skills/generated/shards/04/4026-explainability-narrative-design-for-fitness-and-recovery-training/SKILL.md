...
## Metadata
```yaml
capability_id: u04026-explainability-narrative-design-for-fitness-and-recovery-training
capability_name: Explainability narrative design for fitness and recovery training
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for fitness and recovery training".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for fitness and recovery training** in **fitness and recovery training**.
