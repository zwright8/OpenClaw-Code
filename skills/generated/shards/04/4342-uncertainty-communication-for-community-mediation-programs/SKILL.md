...
## Metadata
```yaml
capability_id: u04342-uncertainty-communication-for-community-mediation-programs
capability_name: Uncertainty communication for community mediation programs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for community mediation programs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for community mediation programs** in **community mediation programs**.
