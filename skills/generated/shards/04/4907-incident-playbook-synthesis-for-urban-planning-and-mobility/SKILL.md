---
name: u04907-incident-playbook-synthesis-for-urban-planning-and-mobility
description: Operate the "Incident playbook synthesis for urban planning and mobility" capability in production for urban planning and mobility workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Incident playbook synthesis for urban planning and mobility` in urban planning and mobility and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Incident playbook synthesis for urban planning and mobility** outcomes (not generic brainstorming).
...
1. **Incident stabilization in urban planning and mobility" capability in production for urban planning and mobility workflows**
   - Input: noisy upstream payload requiring incident playbook synthesis for urban planning and mobility normalization/assessment.
