...
## Metadata
```yaml
capability_id: u04195-explainability-narrative-design-for-customer-support-operations
capability_name: Explainability narrative design for customer support operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for customer support operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for customer support operations** in **customer support operations**.
