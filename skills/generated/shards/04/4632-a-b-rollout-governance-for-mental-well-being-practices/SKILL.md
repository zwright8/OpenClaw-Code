...
## Metadata
```yaml
capability_id: u04632-a-b-rollout-governance-for-mental-well-being-practices
capability_name: A b rollout governance for mental well being practices
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for mental well being practices".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for mental well being practices** in **mental well being practices**.
