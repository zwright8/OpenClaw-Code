...
## Metadata
```yaml
capability_id: u04711-a-b-rollout-governance-for-agriculture-and-food-systems
capability_name: A b rollout governance for agriculture and food systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for agriculture and food systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for agriculture and food systems** in **agriculture and food systems**.
