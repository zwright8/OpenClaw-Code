...
## Metadata
```yaml
capability_id: u04033-explainability-narrative-design-for-mental-well-being-practices
capability_name: Explainability narrative design for mental well being practices
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for mental well being practices".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for mental well being practices** in **mental well being practices**.
