...
description: Operate the "Uncertainty communication for childcare support systems" capability in production for childcare support systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Uncertainty communication for childcare support systems` in childcare support systems and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Uncertainty communication for childcare support systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in childcare support systems" capability in production for childcare support systems workflows**
   - Input: noisy upstream payload requiring uncertainty communication for childcare support systems normalization/assessment.
