...
## Metadata
```yaml
capability_id: u04814-incident-playbook-synthesis-for-household-logistics
capability_name: Incident playbook synthesis for household logistics
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for household logistics".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for household logistics** in **household logistics**.
