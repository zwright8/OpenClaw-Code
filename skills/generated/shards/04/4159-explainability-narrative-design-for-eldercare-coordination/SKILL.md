...
## Metadata
```yaml
capability_id: u04159-explainability-narrative-design-for-eldercare-coordination
capability_name: Explainability narrative design for eldercare coordination
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for eldercare coordination".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for eldercare coordination** in **eldercare coordination**.
