...
## Metadata
```yaml
capability_id: u04897-incident-playbook-synthesis-for-disaster-response-networks
capability_name: Incident playbook synthesis for disaster response networks
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for disaster response networks".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for disaster response networks** in **disaster response networks**.
