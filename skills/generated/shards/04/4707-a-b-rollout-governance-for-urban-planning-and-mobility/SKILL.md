...
## Metadata
```yaml
capability_id: u04707-a-b-rollout-governance-for-urban-planning-and-mobility
capability_name: A b rollout governance for urban planning and mobility
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for urban planning and mobility".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for urban planning and mobility** in **urban planning and mobility**.
