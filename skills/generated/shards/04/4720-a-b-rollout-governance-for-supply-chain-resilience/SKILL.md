...
## Metadata
```yaml
capability_id: u04720-a-b-rollout-governance-for-supply-chain-resilience
capability_name: A b rollout governance for supply chain resilience
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for supply chain resilience".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for supply chain resilience** in **supply chain resilience**.
