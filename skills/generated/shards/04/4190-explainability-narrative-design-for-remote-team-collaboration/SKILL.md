...
## Metadata
```yaml
capability_id: u04190-explainability-narrative-design-for-remote-team-collaboration
capability_name: Explainability narrative design for remote team collaboration
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for remote team collaboration".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for remote team collaboration** in **remote team collaboration**.
