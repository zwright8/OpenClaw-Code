...
description: Operate the "Experiment design for agriculture and food systems" capability in production for agriculture and food systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Experiment design for agriculture and food systems` in agriculture and food systems and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Experiment design for agriculture and food systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in agriculture and food systems" capability in production for agriculture and food systems workflows**
   - Input: noisy upstream payload requiring experiment design for agriculture and food systems normalization/assessment.
