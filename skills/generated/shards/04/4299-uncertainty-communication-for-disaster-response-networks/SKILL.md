...
## Metadata
```yaml
capability_id: u04299-uncertainty-communication-for-disaster-response-networks
capability_name: Uncertainty communication for disaster response networks
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for disaster response networks".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for disaster response networks** in **disaster response networks**.
