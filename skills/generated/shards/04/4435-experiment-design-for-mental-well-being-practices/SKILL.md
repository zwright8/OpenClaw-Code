...
## Metadata
```yaml
capability_id: u04435-experiment-design-for-mental-well-being-practices
capability_name: Experiment design for mental well being practices
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for mental well being practices".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for mental well being practices** in **mental well being practices**.
