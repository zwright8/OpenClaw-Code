...
## Metadata
```yaml
capability_id: u04482-experiment-design-for-healthcare-operations
capability_name: Experiment design for healthcare operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for healthcare operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for healthcare operations** in **healthcare operations**.
