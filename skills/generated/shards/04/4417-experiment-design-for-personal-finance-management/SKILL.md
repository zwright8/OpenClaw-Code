...
## Metadata
```yaml
capability_id: u04417-experiment-design-for-personal-finance-management
capability_name: Experiment design for personal finance management
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for personal finance management".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for personal finance management** in **personal finance management**.
