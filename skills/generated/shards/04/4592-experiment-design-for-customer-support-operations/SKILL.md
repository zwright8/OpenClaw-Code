...
## Metadata
```yaml
capability_id: u04592-experiment-design-for-customer-support-operations
capability_name: Experiment design for customer support operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for customer support operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for customer support operations** in **customer support operations**.
