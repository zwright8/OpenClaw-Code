...
## Metadata
```yaml
capability_id: u04210-uncertainty-communication-for-family-caregiving-systems
capability_name: Uncertainty communication for family caregiving systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for family caregiving systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for family caregiving systems** in **family caregiving systems**.
