...
## Metadata
```yaml
capability_id: u04674-a-b-rollout-governance-for-marketing-and-storytelling
capability_name: A b rollout governance for marketing and storytelling
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for marketing and storytelling".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for marketing and storytelling** in **marketing and storytelling**.
