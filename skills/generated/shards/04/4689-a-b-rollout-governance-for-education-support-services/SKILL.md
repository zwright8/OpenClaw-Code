...
## Metadata
```yaml
capability_id: u04689-a-b-rollout-governance-for-education-support-services
capability_name: A b rollout governance for education support services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for education support services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for education support services** in **education support services**.
