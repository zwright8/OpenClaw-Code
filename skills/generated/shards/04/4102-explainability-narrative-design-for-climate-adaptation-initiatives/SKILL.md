...
## Metadata
```yaml
capability_id: u04102-explainability-narrative-design-for-climate-adaptation-initiatives
capability_name: Explainability narrative design for climate adaptation initiatives
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for climate adaptation initiatives".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for climate adaptation initiatives** in **climate adaptation initiatives**.
