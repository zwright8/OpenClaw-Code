...
## Metadata
```yaml
capability_id: u04750-a-b-rollout-governance-for-civic-participation-platforms
capability_name: A b rollout governance for civic participation platforms
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for civic participation platforms".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for civic participation platforms** in **civic participation platforms**.
