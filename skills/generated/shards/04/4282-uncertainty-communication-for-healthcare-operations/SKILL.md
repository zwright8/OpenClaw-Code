...
## Metadata
```yaml
capability_id: u04282-uncertainty-communication-for-healthcare-operations
capability_name: Uncertainty communication for healthcare operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for healthcare operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for healthcare operations** in **healthcare operations**.
