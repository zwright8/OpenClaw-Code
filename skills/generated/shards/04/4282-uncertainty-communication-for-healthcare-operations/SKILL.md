...
description: Operate the "Uncertainty communication for healthcare operations" capability in production for healthcare operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Uncertainty communication for healthcare operations` in healthcare operations and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Uncertainty communication for healthcare operations** outcomes (not generic brainstorming).
...
1. **Incident stabilization in healthcare operations" capability in production for healthcare operations workflows**
   - Input: noisy upstream payload requiring uncertainty communication for healthcare operations normalization/assessment.
