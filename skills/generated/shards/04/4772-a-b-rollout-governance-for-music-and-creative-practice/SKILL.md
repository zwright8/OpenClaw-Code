...
## Metadata
```yaml
capability_id: u04772-a-b-rollout-governance-for-music-and-creative-practice
capability_name: A b rollout governance for music and creative practice
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for music and creative practice".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for music and creative practice** in **music and creative practice**.
