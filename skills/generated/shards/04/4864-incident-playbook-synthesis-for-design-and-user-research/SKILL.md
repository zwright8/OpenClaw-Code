...
## Metadata
```yaml
capability_id: u04864-incident-playbook-synthesis-for-design-and-user-research
capability_name: Incident playbook synthesis for design and user research
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for design and user research".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for design and user research** in **design and user research**.
