...
## Metadata
```yaml
capability_id: u04872-incident-playbook-synthesis-for-marketing-and-storytelling
capability_name: Incident playbook synthesis for marketing and storytelling
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for marketing and storytelling".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for marketing and storytelling** in **marketing and storytelling**.
