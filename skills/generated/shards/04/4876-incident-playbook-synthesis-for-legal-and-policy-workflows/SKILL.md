...
## Metadata
```yaml
capability_id: u04876-incident-playbook-synthesis-for-legal-and-policy-workflows
capability_name: Incident playbook synthesis for legal and policy workflows
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for legal and policy workflows".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for legal and policy workflows** in **legal and policy workflows**.
