...
## Metadata
```yaml
capability_id: u04082-explainability-narrative-design-for-healthcare-operations
capability_name: Explainability narrative design for healthcare operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for healthcare operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for healthcare operations** in **healthcare operations**.
