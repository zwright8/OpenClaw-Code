...
## Metadata
```yaml
capability_id: u04571-experiment-design-for-music-and-creative-practice
capability_name: Experiment design for music and creative practice
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for music and creative practice".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for music and creative practice** in **music and creative practice**.
