...
## Metadata
```yaml
capability_id: u04121-explainability-narrative-design-for-manufacturing-quality-assurance
capability_name: Explainability narrative design for manufacturing quality assurance
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for manufacturing quality assurance".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for manufacturing quality assurance** in **manufacturing quality assurance**.
