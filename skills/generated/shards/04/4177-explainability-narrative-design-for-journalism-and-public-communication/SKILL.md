...
## Metadata
```yaml
capability_id: u04177-explainability-narrative-design-for-journalism-and-public-communication
capability_name: Explainability narrative design for journalism and public communication
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for journalism and public communication".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for journalism and public communication** in **journalism and public communication**.
