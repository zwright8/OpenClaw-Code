...
## Metadata
```yaml
capability_id: u04615-a-b-rollout-governance-for-household-logistics
capability_name: A b rollout governance for household logistics
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for household logistics".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for household logistics** in **household logistics**.
