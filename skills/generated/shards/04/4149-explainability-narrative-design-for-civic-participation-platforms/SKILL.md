...
## Metadata
```yaml
capability_id: u04149-explainability-narrative-design-for-civic-participation-platforms
capability_name: Explainability narrative design for civic participation platforms
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for civic participation platforms".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for civic participation platforms** in **civic participation platforms**.
