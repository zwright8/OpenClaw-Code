...
## Metadata
```yaml
capability_id: u04499-experiment-design-for-disaster-response-networks
capability_name: Experiment design for disaster response networks
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for disaster response networks".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for disaster response networks** in **disaster response networks**.
