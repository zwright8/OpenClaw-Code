...
## Metadata
```yaml
capability_id: u04383-uncertainty-communication-for-multilingual-translation-services
capability_name: Uncertainty communication for multilingual translation services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for multilingual translation services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for multilingual translation services** in **multilingual translation services**.
