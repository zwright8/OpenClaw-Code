...
## Metadata
```yaml
capability_id: u04994-incident-playbook-synthesis-for-customer-support-operations
capability_name: Incident playbook synthesis for customer support operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for customer support operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for customer support operations** in **customer support operations**.
