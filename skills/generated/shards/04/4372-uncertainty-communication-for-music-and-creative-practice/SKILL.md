...
## Metadata
```yaml
capability_id: u04372-uncertainty-communication-for-music-and-creative-practice
capability_name: Uncertainty communication for music and creative practice
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for music and creative practice".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for music and creative practice** in **music and creative practice**.
