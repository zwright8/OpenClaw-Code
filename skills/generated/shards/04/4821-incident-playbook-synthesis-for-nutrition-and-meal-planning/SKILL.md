...
## Metadata
```yaml
capability_id: u04821-incident-playbook-synthesis-for-nutrition-and-meal-planning
capability_name: Incident playbook synthesis for nutrition and meal planning
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for nutrition and meal planning".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for nutrition and meal planning** in **nutrition and meal planning**.
