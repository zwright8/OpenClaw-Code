...
## Metadata
```yaml
capability_id: u04211-uncertainty-communication-for-household-logistics
capability_name: Uncertainty communication for household logistics
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for household logistics".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for household logistics** in **household logistics**.
