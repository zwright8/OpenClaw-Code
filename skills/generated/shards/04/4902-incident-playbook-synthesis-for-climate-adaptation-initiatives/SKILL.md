...
## Metadata
```yaml
capability_id: u04902-incident-playbook-synthesis-for-climate-adaptation-initiatives
capability_name: Incident playbook synthesis for climate adaptation initiatives
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for climate adaptation initiatives".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for climate adaptation initiatives** in **climate adaptation initiatives**.
