...
## Metadata
```yaml
capability_id: u04776-a-b-rollout-governance-for-journalism-and-public-communication
capability_name: A b rollout governance for journalism and public communication
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for journalism and public communication".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for journalism and public communication** in **journalism and public communication**.
