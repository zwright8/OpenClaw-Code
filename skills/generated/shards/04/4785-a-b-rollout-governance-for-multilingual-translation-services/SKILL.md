...
## Metadata
```yaml
capability_id: u04785-a-b-rollout-governance-for-multilingual-translation-services
capability_name: A b rollout governance for multilingual translation services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for multilingual translation services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for multilingual translation services** in **multilingual translation services**.
