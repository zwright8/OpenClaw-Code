...
## Metadata
```yaml
capability_id: u04401-experiment-design-for-personal-health-routines
capability_name: Experiment design for personal health routines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for personal health routines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for personal health routines** in **personal health routines**.
