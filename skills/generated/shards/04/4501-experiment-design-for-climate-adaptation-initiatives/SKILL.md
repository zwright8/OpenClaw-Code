...
## Metadata
```yaml
capability_id: u04501-experiment-design-for-climate-adaptation-initiatives
capability_name: Experiment design for climate adaptation initiatives
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for climate adaptation initiatives".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for climate adaptation initiatives** in **climate adaptation initiatives**.
