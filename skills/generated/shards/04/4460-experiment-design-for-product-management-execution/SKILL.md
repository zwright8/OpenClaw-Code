...
## Metadata
```yaml
capability_id: u04460-experiment-design-for-product-management-execution
capability_name: Experiment design for product management execution
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for product management execution".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for product management execution** in **product management execution**.
