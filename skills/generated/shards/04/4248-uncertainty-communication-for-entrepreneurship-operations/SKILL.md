...
## Metadata
```yaml
capability_id: u04248-uncertainty-communication-for-entrepreneurship-operations
capability_name: Uncertainty communication for entrepreneurship operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for entrepreneurship operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for entrepreneurship operations** in **entrepreneurship operations**.
