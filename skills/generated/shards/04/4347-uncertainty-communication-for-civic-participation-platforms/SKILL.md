...
## Metadata
```yaml
capability_id: u04347-uncertainty-communication-for-civic-participation-platforms
capability_name: Uncertainty communication for civic participation platforms
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for civic participation platforms".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for civic participation platforms** in **civic participation platforms**.
