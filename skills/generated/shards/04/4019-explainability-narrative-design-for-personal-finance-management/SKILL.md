...
description: Operate the "Explainability narrative design for personal finance management" capability in production for personal finance management workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
```yaml
capability_id: u04019-explainability-narrative-design-for-personal-finance-management
capability_name: Explainability narrative design for personal finance management
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for personal finance management".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for personal finance management** in **personal finance management**.
