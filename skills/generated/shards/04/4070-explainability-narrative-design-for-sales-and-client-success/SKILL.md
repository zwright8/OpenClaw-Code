...
## Metadata
```yaml
capability_id: u04070-explainability-narrative-design-for-sales-and-client-success
capability_name: Explainability narrative design for sales and client success
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for sales and client success".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for sales and client success** in **sales and client success**.
