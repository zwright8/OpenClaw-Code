...
## Metadata
```yaml
capability_id: u04810-incident-playbook-synthesis-for-family-caregiving-systems
capability_name: Incident playbook synthesis for family caregiving systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for family caregiving systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for family caregiving systems** in **family caregiving systems**.
