...
## Metadata
```yaml
capability_id: u04519-experiment-design-for-supply-chain-resilience
capability_name: Experiment design for supply chain resilience
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for supply chain resilience".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for supply chain resilience** in **supply chain resilience**.
