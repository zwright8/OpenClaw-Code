...
## Metadata
```yaml
capability_id: u04525-experiment-design-for-manufacturing-quality-assurance
capability_name: Experiment design for manufacturing quality assurance
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for manufacturing quality assurance".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for manufacturing quality assurance** in **manufacturing quality assurance**.
