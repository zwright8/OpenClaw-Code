...
## Metadata
```yaml
capability_id: u04725-a-b-rollout-governance-for-manufacturing-quality-assurance
capability_name: A b rollout governance for manufacturing quality assurance
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for manufacturing quality assurance".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for manufacturing quality assurance** in **manufacturing quality assurance**.
