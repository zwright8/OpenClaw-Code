...
| Feature flag | `skill_04427_experiment-design` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Experiment Design for fitness and recovery training under pro-humanity impact conditions.
