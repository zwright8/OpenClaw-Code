...
## Metadata
```yaml
capability_id: u04692-a-b-rollout-governance-for-nonprofit-program-delivery
capability_name: A b rollout governance for nonprofit program delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for nonprofit program delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for nonprofit program delivery** in **nonprofit program delivery**.
