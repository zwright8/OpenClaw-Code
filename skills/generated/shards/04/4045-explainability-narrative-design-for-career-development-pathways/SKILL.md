...
## Metadata
```yaml
capability_id: u04045-explainability-narrative-design-for-career-development-pathways
capability_name: Explainability narrative design for career development pathways
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for career development pathways".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for career development pathways** in **career development pathways**.
