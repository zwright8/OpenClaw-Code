...
## Metadata
```yaml
capability_id: u04599-experiment-design-for-knowledge-management-systems
capability_name: Experiment design for knowledge management systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for knowledge management systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for knowledge management systems** in **knowledge management systems**.
