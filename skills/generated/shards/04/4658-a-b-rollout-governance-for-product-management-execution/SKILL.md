...
## Metadata
```yaml
capability_id: u04658-a-b-rollout-governance-for-product-management-execution
capability_name: A b rollout governance for product management execution
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for product management execution".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for product management execution** in **product management execution**.
