...
## Metadata
```yaml
capability_id: u04274-uncertainty-communication-for-marketing-and-storytelling
capability_name: Uncertainty communication for marketing and storytelling
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for marketing and storytelling".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for marketing and storytelling** in **marketing and storytelling**.
