...
## Metadata
```yaml
capability_id: u04926-incident-playbook-synthesis-for-cybersecurity-operations
capability_name: Incident playbook synthesis for cybersecurity operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for cybersecurity operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for cybersecurity operations** in **cybersecurity operations**.
