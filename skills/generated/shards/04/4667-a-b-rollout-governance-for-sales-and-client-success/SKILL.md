...
## Metadata
```yaml
capability_id: u04667-a-b-rollout-governance-for-sales-and-client-success
capability_name: A b rollout governance for sales and client success
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for sales and client success".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for sales and client success** in **sales and client success**.
