...
description: Operate the "Uncertainty communication for supply chain resilience" capability in production for supply chain resilience workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Uncertainty communication for supply chain resilience` in supply chain resilience and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Uncertainty communication for supply chain resilience** outcomes (not generic brainstorming).
...
1. **Incident stabilization in supply chain resilience" capability in production for supply chain resilience workflows**
   - Input: noisy upstream payload requiring uncertainty communication for supply chain resilience normalization/assessment.
