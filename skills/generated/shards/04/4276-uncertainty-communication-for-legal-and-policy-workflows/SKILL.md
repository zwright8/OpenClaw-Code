...
## Metadata
```yaml
capability_id: u04276-uncertainty-communication-for-legal-and-policy-workflows
capability_name: Uncertainty communication for legal and policy workflows
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for legal and policy workflows".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for legal and policy workflows** in **legal and policy workflows**.
