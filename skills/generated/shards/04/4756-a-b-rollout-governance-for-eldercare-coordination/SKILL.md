...
## Metadata
```yaml
capability_id: u04756-a-b-rollout-governance-for-eldercare-coordination
capability_name: A b rollout governance for eldercare coordination
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for eldercare coordination".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for eldercare coordination** in **eldercare coordination**.
