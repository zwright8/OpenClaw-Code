...
## Metadata
```yaml
capability_id: u04054-explainability-narrative-design-for-software-engineering-delivery
capability_name: Explainability narrative design for software engineering delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for software engineering delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for software engineering delivery** in **software engineering delivery**.
