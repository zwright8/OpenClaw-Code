...
## Metadata
```yaml
capability_id: u04620-a-b-rollout-governance-for-personal-finance-management
capability_name: A b rollout governance for personal finance management
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for personal finance management".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for personal finance management** in **personal finance management**.
