...
## Metadata
```yaml
capability_id: u04727-a-b-rollout-governance-for-cybersecurity-operations
capability_name: A b rollout governance for cybersecurity operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for cybersecurity operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for cybersecurity operations** in **cybersecurity operations**.
