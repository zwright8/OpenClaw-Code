...
## Metadata
```yaml
capability_id: u04892-incident-playbook-synthesis-for-nonprofit-program-delivery
capability_name: Incident playbook synthesis for nonprofit program delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for nonprofit program delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for nonprofit program delivery** in **nonprofit program delivery**.
