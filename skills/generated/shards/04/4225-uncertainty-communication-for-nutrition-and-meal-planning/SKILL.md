...
## Metadata
```yaml
capability_id: u04225-uncertainty-communication-for-nutrition-and-meal-planning
capability_name: Uncertainty communication for nutrition and meal planning
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for nutrition and meal planning".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for nutrition and meal planning** in **nutrition and meal planning**.
