...
## Metadata
```yaml
capability_id: u04423-experiment-design-for-nutrition-and-meal-planning
capability_name: Experiment design for nutrition and meal planning
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for nutrition and meal planning".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for nutrition and meal planning** in **nutrition and meal planning**.
