...
## Metadata
```yaml
capability_id: u04661-a-b-rollout-governance-for-design-and-user-research
capability_name: A b rollout governance for design and user research
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for design and user research".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for design and user research** in **design and user research**.
