...
## Metadata
```yaml
capability_id: u04915-incident-playbook-synthesis-for-agriculture-and-food-systems
capability_name: Incident playbook synthesis for agriculture and food systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for agriculture and food systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for agriculture and food systems** in **agriculture and food systems**.
