...
description: Operate the "Uncertainty communication for eldercare coordination" capability in production for eldercare coordination workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Uncertainty communication for eldercare coordination` in eldercare coordination and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Uncertainty communication for eldercare coordination** outcomes (not generic brainstorming).
...
1. **Incident stabilization in eldercare coordination" capability in production for eldercare coordination workflows**
   - Input: noisy upstream payload requiring uncertainty communication for eldercare coordination normalization/assessment.
