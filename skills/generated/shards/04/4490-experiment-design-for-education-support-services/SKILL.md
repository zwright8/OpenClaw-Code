...
## Metadata
```yaml
capability_id: u04490-experiment-design-for-education-support-services
capability_name: Experiment design for education support services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for education support services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for education support services** in **education support services**.
