...
## Metadata
```yaml
capability_id: u04142-explainability-narrative-design-for-community-mediation-programs
capability_name: Explainability narrative design for community mediation programs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for community mediation programs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for community mediation programs** in **community mediation programs**.
