...
## Metadata
```yaml
capability_id: u04203-uncertainty-communication-for-personal-health-routines
capability_name: Uncertainty communication for personal health routines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for personal health routines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for personal health routines** in **personal health routines**.
