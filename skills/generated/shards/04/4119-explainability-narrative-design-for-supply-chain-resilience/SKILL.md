...
## Metadata
```yaml
capability_id: u04119-explainability-narrative-design-for-supply-chain-resilience
capability_name: Explainability narrative design for supply chain resilience
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for supply chain resilience".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for supply chain resilience** in **supply chain resilience**.
