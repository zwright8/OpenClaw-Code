...
## Metadata
```yaml
capability_id: u04295-uncertainty-communication-for-nonprofit-program-delivery
capability_name: Uncertainty communication for nonprofit program delivery
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for nonprofit program delivery".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for nonprofit program delivery** in **nonprofit program delivery**.
