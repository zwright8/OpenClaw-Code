...
## Metadata
```yaml
capability_id: u04230-uncertainty-communication-for-fitness-and-recovery-training
capability_name: Uncertainty communication for fitness and recovery training
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for fitness and recovery training".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for fitness and recovery training** in **fitness and recovery training**.
