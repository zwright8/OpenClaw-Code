...
## Metadata
```yaml
capability_id: u04512-experiment-design-for-agriculture-and-food-systems
capability_name: Experiment design for agriculture and food systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for agriculture and food systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for agriculture and food systems** in **agriculture and food systems**.
