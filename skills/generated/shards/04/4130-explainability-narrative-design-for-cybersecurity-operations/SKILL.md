...
## Metadata
```yaml
capability_id: u04130-explainability-narrative-design-for-cybersecurity-operations
capability_name: Explainability narrative design for cybersecurity operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for cybersecurity operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for cybersecurity operations** in **cybersecurity operations**.
