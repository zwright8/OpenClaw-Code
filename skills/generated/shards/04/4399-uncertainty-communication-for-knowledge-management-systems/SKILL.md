...
## Metadata
```yaml
capability_id: u04399-uncertainty-communication-for-knowledge-management-systems
capability_name: Uncertainty communication for knowledge management systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for knowledge management systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for knowledge management systems** in **knowledge management systems**.
