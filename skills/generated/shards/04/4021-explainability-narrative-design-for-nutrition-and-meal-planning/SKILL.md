...
## Metadata
```yaml
capability_id: u04021-explainability-narrative-design-for-nutrition-and-meal-planning
capability_name: Explainability narrative design for nutrition and meal planning
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for nutrition and meal planning".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for nutrition and meal planning** in **nutrition and meal planning**.
