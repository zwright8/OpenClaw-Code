...
## Metadata
```yaml
capability_id: u04365-uncertainty-communication-for-childcare-support-systems
capability_name: Uncertainty communication for childcare support systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for childcare support systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for childcare support systems** in **childcare support systems**.
