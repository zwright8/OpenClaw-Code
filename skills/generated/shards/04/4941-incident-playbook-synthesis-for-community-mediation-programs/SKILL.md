...
## Metadata
```yaml
capability_id: u04941-incident-playbook-synthesis-for-community-mediation-programs
capability_name: Incident playbook synthesis for community mediation programs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for community mediation programs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for community mediation programs** in **community mediation programs**.
