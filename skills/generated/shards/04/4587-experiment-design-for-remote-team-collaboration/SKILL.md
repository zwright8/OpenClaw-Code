...
## Metadata
```yaml
capability_id: u04587-experiment-design-for-remote-team-collaboration
capability_name: Experiment design for remote team collaboration
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for remote team collaboration".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for remote team collaboration** in **remote team collaboration**.
