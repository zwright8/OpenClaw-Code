...
## Metadata
```yaml
capability_id: u04136-explainability-narrative-design-for-scientific-publishing-pipelines
capability_name: Explainability narrative design for scientific publishing pipelines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for scientific publishing pipelines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for scientific publishing pipelines** in **scientific publishing pipelines**.
