...
## Metadata
```yaml
capability_id: u04866-incident-playbook-synthesis-for-sales-and-client-success
capability_name: Incident playbook synthesis for sales and client success
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for sales and client success".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for sales and client success** in **sales and client success**.
