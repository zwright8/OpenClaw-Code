...
## Metadata
```yaml
capability_id: u04566-experiment-design-for-arts-and-culture-programming
capability_name: Experiment design for arts and culture programming
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for arts and culture programming".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for arts and culture programming** in **arts and culture programming**.
