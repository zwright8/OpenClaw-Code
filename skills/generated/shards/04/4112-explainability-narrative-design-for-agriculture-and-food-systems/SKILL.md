...
## Metadata
```yaml
capability_id: u04112-explainability-narrative-design-for-agriculture-and-food-systems
capability_name: Explainability narrative design for agriculture and food systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for agriculture and food systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for agriculture and food systems** in **agriculture and food systems**.
