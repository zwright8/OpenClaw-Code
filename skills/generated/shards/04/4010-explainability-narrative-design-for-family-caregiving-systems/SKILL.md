...
## Metadata
```yaml
capability_id: u04010-explainability-narrative-design-for-family-caregiving-systems
capability_name: Explainability narrative design for family caregiving systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for family caregiving systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for family caregiving systems** in **family caregiving systems**.
