...
## Metadata
```yaml
capability_id: u04366-uncertainty-communication-for-arts-and-culture-programming
capability_name: Uncertainty communication for arts and culture programming
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for arts and culture programming".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for arts and culture programming** in **arts and culture programming**.
