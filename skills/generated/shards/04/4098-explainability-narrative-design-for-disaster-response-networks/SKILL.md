...
## Metadata
```yaml
capability_id: u04098-explainability-narrative-design-for-disaster-response-networks
capability_name: Explainability narrative design for disaster response networks
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for disaster response networks".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for disaster response networks** in **disaster response networks**.
