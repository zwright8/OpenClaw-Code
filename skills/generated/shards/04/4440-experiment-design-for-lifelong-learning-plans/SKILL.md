...
## Metadata
```yaml
capability_id: u04440-experiment-design-for-lifelong-learning-plans
capability_name: Experiment design for lifelong learning plans
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for lifelong learning plans".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for lifelong learning plans** in **lifelong learning plans**.
