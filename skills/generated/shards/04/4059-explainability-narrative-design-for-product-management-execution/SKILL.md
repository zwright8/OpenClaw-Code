...
## Metadata
```yaml
capability_id: u04059-explainability-narrative-design-for-product-management-execution
capability_name: Explainability narrative design for product management execution
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for product management execution".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for product management execution** in **product management execution**.
