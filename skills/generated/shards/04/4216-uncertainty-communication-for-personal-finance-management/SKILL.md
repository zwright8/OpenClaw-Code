...
## Metadata
```yaml
capability_id: u04216-uncertainty-communication-for-personal-finance-management
capability_name: Uncertainty communication for personal finance management
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for personal finance management".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for personal finance management** in **personal finance management**.
