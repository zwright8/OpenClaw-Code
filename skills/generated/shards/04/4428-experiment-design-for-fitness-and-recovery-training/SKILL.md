...
## Metadata
```yaml
capability_id: u04428-experiment-design-for-fitness-and-recovery-training
capability_name: Experiment design for fitness and recovery training
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for fitness and recovery training".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for fitness and recovery training** in **fitness and recovery training**.
