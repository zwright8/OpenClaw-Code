...
## Metadata
```yaml
capability_id: u04883-incident-playbook-synthesis-for-healthcare-operations
capability_name: Incident playbook synthesis for healthcare operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for healthcare operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for healthcare operations** in **healthcare operations**.
