...
## Metadata
```yaml
capability_id: u04565-experiment-design-for-childcare-support-systems
capability_name: Experiment design for childcare support systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for childcare support systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for childcare support systems** in **childcare support systems**.
