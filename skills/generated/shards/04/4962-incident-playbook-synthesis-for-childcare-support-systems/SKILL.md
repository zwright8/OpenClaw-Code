...
## Metadata
```yaml
capability_id: u04962-incident-playbook-synthesis-for-childcare-support-systems
capability_name: Incident playbook synthesis for childcare support systems
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for childcare support systems".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for childcare support systems** in **childcare support systems**.
