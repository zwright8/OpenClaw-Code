...
## Metadata
```yaml
capability_id: u04153-explainability-narrative-design-for-accessibility-services
capability_name: Explainability narrative design for accessibility services
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for accessibility services".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for accessibility services** in **accessibility services**.
