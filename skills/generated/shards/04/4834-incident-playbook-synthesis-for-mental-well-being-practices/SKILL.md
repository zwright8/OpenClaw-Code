...
## Metadata
```yaml
capability_id: u04834-incident-playbook-synthesis-for-mental-well-being-practices
capability_name: Incident playbook synthesis for mental well being practices
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for mental well being practices".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for mental well being practices** in **mental well being practices**.
