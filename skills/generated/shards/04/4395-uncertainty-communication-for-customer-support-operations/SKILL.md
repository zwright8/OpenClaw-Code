...
## Metadata
```yaml
capability_id: u04395-uncertainty-communication-for-customer-support-operations
capability_name: Uncertainty communication for customer support operations
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Uncertainty communication for customer support operations".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Uncertainty communication for customer support operations** in **customer support operations**.
