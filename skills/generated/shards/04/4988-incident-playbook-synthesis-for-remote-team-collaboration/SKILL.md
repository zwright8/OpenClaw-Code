...
## Metadata
```yaml
capability_id: u04988-incident-playbook-synthesis-for-remote-team-collaboration
capability_name: Incident playbook synthesis for remote team collaboration
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for remote team collaboration".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for remote team collaboration** in **remote team collaboration**.
