...
## Metadata
```yaml
capability_id: u04549-experiment-design-for-civic-participation-platforms
capability_name: Experiment design for civic participation platforms
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Experiment design for civic participation platforms".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Experiment design for civic participation platforms** in **civic participation platforms**.
