...
| Feature flag | `skill_04806_incident-playbook-synthesis` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Incident Playbook Synthesis for family caregiving systems under maximally truth-seeking conditions.
