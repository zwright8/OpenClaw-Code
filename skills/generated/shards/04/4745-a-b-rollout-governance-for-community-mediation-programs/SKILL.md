...
## Metadata
```yaml
capability_id: u04745-a-b-rollout-governance-for-community-mediation-programs
capability_name: A b rollout governance for community mediation programs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "A b rollout governance for community mediation programs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **A b rollout governance for community mediation programs** in **community mediation programs**.
