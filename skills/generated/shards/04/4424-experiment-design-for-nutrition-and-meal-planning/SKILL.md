...
## Trigger Checklist
- [ ] The request explicitly needs **Experiment design for nutrition and meal planning** outcomes (not generic brainstorming).
...
1. **Incident stabilization in nutrition and meal planning" capability in production for nutrition and meal planning workflows**
   - Input: noisy upstream payload requiring experiment design for nutrition and meal planning normalization/assessment.
