...
## Metadata
```yaml
capability_id: u04803-incident-playbook-synthesis-for-personal-health-routines
capability_name: Incident playbook synthesis for personal health routines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for personal health routines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for personal health routines** in **personal health routines**.
