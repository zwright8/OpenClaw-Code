...
## Metadata
```yaml
capability_id: u04131-explainability-narrative-design-for-research-and-development-labs
capability_name: Explainability narrative design for research and development labs
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Explainability narrative design for research and development labs".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Explainability narrative design for research and development labs** in **research and development labs**.
