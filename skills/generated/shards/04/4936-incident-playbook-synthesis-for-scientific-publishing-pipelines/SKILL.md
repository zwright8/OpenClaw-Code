...
## Metadata
```yaml
capability_id: u04936-incident-playbook-synthesis-for-scientific-publishing-pipelines
capability_name: Incident playbook synthesis for scientific publishing pipelines
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for scientific publishing pipelines".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for scientific publishing pipelines** in **scientific publishing pipelines**.
