...
## Metadata
```yaml
capability_id: u04816-incident-playbook-synthesis-for-personal-finance-management
capability_name: Incident playbook synthesis for personal finance management
...
required:
  capability_request:
    type: string
    description: Explicit request to run "Incident playbook synthesis for personal finance management".
  domain_scope:
    type: string
...
3. Execute capability workflow for **Incident playbook synthesis for personal finance management** in **personal finance management**.
