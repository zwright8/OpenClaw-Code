...
## Metadata
- skill_id: `u06840-learning-curriculum-composition-for-lifelong-learning-plans`
- capability: `Learning Curriculum Composition for lifelong learning plans`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for lifelong learning plans` in `lifelong learning plans`.
