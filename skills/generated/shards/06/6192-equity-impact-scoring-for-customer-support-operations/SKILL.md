...
## Metadata
- skill_id: `u06192-equity-impact-scoring-for-customer-support-operations`
- capability: `Equity Impact Scoring for customer support operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for customer support operations` in `customer support operations`.
