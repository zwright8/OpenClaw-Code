...
## Metadata
- skill_id: `u06613-skill-gap-diagnosis-for-household-logistics`
- capability: `Skill Gap Diagnosis for household logistics`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for household logistics` in `household logistics`.
