...
## Metadata
- skill_id: `u06065-equity-impact-scoring-for-design-and-user-research`
- capability: `Equity impact scoring for design and user research`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for design and user research` in `design and user research`.
