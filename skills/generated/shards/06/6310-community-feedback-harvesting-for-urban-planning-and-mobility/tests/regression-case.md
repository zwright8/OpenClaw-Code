# Regression Case — u06310-community-feedback-harvesting-for-urban-planning-and-mobility

## Objective
Verify deterministic replay and fail-closed gate behavior for `Community Feedback Harvesting for urban planning and mobility`.
