# Regression Case — u06885-learning-curriculum-composition-for-healthcare-operations

## Objective
Verify deterministic replay and fail-closed gate behavior for `Learning Curriculum Composition for healthcare operations`.
