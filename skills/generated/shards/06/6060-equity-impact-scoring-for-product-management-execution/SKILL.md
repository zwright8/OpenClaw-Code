...
## Metadata
- skill_id: `u06060-equity-impact-scoring-for-product-management-execution`
- capability: `Equity impact scoring for product management execution`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for product management execution` in `product management execution`.
