...
## Metadata
- skill_id: `u06793-skill-gap-diagnosis-for-customer-support-operations`
- capability: `Skill Gap Diagnosis for customer support operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for customer support operations` in `customer support operations`.
