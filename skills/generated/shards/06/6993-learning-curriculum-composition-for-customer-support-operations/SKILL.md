...
## Metadata
- skill_id: `u06993-learning-curriculum-composition-for-customer-support-operations`
- capability: `Learning Curriculum Composition for customer support operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for customer support operations` in `customer support operations`.
