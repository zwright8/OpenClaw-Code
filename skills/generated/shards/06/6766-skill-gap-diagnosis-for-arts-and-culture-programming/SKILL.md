...
## Metadata
- skill_id: `u06766-skill-gap-diagnosis-for-arts-and-culture-programming`
- capability: `Skill Gap Diagnosis for arts and culture programming`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for arts and culture programming` in `arts and culture programming`.
