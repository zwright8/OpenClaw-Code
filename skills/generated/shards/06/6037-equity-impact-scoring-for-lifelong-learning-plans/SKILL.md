...
## Metadata
- skill_id: `u06037-equity-impact-scoring-for-lifelong-learning-plans`
- capability: `Equity Impact Scoring for lifelong learning plans`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for lifelong learning plans` in `lifelong learning plans`.
