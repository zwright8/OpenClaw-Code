...
## Metadata
- skill_id: `u06048-equity-impact-scoring-for-entrepreneurship-operations`
- capability: `Equity Impact Scoring for entrepreneurship operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for entrepreneurship operations` in `entrepreneurship operations`.
