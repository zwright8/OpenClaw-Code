...
## Metadata
- skill_id: `u06603-skill-gap-diagnosis-for-personal-health-routines`
- capability: `Skill Gap Diagnosis for personal health routines`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for personal health routines` in `personal health routines`.
