...
## Metadata
- skill_id: `u06102-equity-impact-scoring-for-climate-adaptation-initiatives`
- capability: `Equity impact scoring for climate adaptation initiatives`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for climate adaptation initiatives` in `climate adaptation initiatives`.
