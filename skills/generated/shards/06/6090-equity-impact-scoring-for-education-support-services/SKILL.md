...
## Metadata
- skill_id: `u06090-equity-impact-scoring-for-education-support-services`
- capability: `Equity impact scoring for education support services`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for education support services` in `education support services`.
