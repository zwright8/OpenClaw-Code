...
## When To Use
Use this skill only when the request explicitly needs `Community Feedback Harvesting for personal health routines` in personal health routines and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Community Feedback Harvesting for personal health routines** outcomes (not generic brainstorming).
...
1. **Incident stabilization in personal health routines" capability for personal health routines**
   - Input: noisy upstream payload requiring community feedback harvesting for personal health routines normalization/assessment.
