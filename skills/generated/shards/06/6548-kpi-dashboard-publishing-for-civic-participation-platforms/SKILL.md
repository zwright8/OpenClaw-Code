...
## Metadata
- skill_id: `u06548-kpi-dashboard-publishing-for-civic-participation-platforms`
- capability: `KPI Dashboard Publishing for civic participation platforms`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for civic participation platforms` in `civic participation platforms`.
