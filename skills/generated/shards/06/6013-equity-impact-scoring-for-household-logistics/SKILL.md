...
## Metadata
- skill_id: `u06013-equity-impact-scoring-for-household-logistics`
- capability: `Equity Impact Scoring for household logistics`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for household logistics` in `household logistics`.
