...
## Metadata
- skill_id: `u06668-skill-gap-diagnosis-for-sales-and-client-success`
- capability: `Skill Gap Diagnosis for sales and client success`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for sales and client success` in `sales and client success`.
