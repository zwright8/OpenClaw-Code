...
## Metadata
- skill_id: `u06045-equity-impact-scoring-for-career-development-pathways`
- capability: `Equity Impact Scoring for career development pathways`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for career development pathways` in `career development pathways`.
