...
## Metadata
- skill_id: `u06124-equity-impact-scoring-for-manufacturing-quality-assurance`
- capability: `Equity impact scoring for manufacturing quality assurance`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for manufacturing quality assurance` in `manufacturing quality assurance`.
