...
## Metadata
- skill_id: `u06825-learning-curriculum-composition-for-nutrition-and-meal-planning`
- capability: `Learning Curriculum Composition for nutrition and meal planning`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for nutrition and meal planning` in `nutrition and meal planning`.
