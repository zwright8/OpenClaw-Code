...
## Metadata
- skill_id: `u06638-skill-gap-diagnosis-for-lifelong-learning-plans`
- capability: `Skill Gap Diagnosis for lifelong learning plans`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for lifelong learning plans` in `lifelong learning plans`.
