...
## Metadata
- skill_id: `u06000-cost-benefit-forecasting-for-knowledge-management-systems`
- capability: `Cost-Benefit Forecasting for knowledge management systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Cost-Benefit Forecasting for knowledge management systems` in `knowledge management systems`.
