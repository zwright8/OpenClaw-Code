...
## Metadata
- skill_id: `u06528-kpi-dashboard-publishing-for-cybersecurity-operations`
- capability: `KPI Dashboard Publishing for cybersecurity operations`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for cybersecurity operations` in `cybersecurity operations`.
