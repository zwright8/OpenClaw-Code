...
## Metadata
- skill_id: `u06654-skill-gap-diagnosis-for-software-engineering-delivery`
- capability: `Skill Gap Diagnosis for software engineering delivery`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for software engineering delivery` in `software engineering delivery`.
