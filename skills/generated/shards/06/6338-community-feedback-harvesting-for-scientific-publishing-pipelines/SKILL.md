...
## Metadata
- skill_id: `u06338-community-feedback-harvesting-for-scientific-publishing-pipelines`
- capability: `Community Feedback Harvesting for scientific publishing pipelines`
...
## Musts
- [ ] Confirm the request explicitly matches `Community Feedback Harvesting for scientific publishing pipelines` in `scientific publishing pipelines`.
