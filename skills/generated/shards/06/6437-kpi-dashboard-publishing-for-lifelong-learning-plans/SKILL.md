...
## Metadata
- skill_id: `u06437-kpi-dashboard-publishing-for-lifelong-learning-plans`
- capability: `KPI Dashboard Publishing for lifelong learning plans`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for lifelong learning plans` in `lifelong learning plans`.
