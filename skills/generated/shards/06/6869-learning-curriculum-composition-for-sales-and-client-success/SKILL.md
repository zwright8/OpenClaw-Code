...
## Metadata
- skill_id: `u06869-learning-curriculum-composition-for-sales-and-client-success`
- capability: `Learning Curriculum Composition for sales and client success`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for sales and client success` in `sales and client success`.
