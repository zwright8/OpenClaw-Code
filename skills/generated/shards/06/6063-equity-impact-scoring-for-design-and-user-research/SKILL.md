...
description: Operate the "Equity impact scoring for design and user research" capability in production for design and user research workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Equity impact scoring for design and user research` in design and user research and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Equity impact scoring for design and user research** outcomes (not generic brainstorming).
...
1. **Incident stabilization in design and user research" capability in production for design and user research workflows**
   - Input: noisy upstream payload requiring equity impact scoring for design and user research normalization/assessment.
