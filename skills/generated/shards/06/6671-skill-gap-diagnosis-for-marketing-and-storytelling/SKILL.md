...
## Metadata
- skill_id: `u06671-skill-gap-diagnosis-for-marketing-and-storytelling`
- capability: `Skill Gap Diagnosis for marketing and storytelling`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for marketing and storytelling` in `marketing and storytelling`.
