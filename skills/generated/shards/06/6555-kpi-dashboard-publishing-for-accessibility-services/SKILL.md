...
## Metadata
- skill_id: `u06555-kpi-dashboard-publishing-for-accessibility-services`
- capability: `KPI Dashboard Publishing for accessibility services`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for accessibility services` in `accessibility services`.
