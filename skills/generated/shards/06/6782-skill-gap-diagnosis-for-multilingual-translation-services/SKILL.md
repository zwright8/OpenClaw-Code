...
## Metadata
- skill_id: `u06782-skill-gap-diagnosis-for-multilingual-translation-services`
- capability: `Skill Gap Diagnosis for multilingual translation services`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for multilingual translation services` in `multilingual translation services`.
