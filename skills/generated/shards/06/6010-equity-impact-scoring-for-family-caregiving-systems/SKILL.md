...
## Metadata
- skill_id: `u06010-equity-impact-scoring-for-family-caregiving-systems`
- capability: `Equity Impact Scoring for family caregiving systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for family caregiving systems` in `family caregiving systems`.
