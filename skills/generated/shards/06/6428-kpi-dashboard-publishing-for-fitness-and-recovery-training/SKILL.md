...
## Metadata
- skill_id: `u06428-kpi-dashboard-publishing-for-fitness-and-recovery-training`
- capability: `KPI Dashboard Publishing for fitness and recovery training`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for fitness and recovery training` in `fitness and recovery training`.
