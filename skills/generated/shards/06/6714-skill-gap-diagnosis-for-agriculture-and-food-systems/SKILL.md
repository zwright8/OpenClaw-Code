...
## Metadata
- skill_id: `u06714-skill-gap-diagnosis-for-agriculture-and-food-systems`
- capability: `Skill Gap Diagnosis for agriculture and food systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for agriculture and food systems` in `agriculture and food systems`.
