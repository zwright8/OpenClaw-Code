...
## Metadata
- skill_id: `u06558-kpi-dashboard-publishing-for-eldercare-coordination`
- capability: `KPI Dashboard Publishing for eldercare coordination`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for eldercare coordination` in `eldercare coordination`.
