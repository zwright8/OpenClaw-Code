...
## Metadata
- skill_id: `u06709-skill-gap-diagnosis-for-urban-planning-and-mobility`
- capability: `Skill Gap Diagnosis for urban planning and mobility`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for urban planning and mobility` in `urban planning and mobility`.
