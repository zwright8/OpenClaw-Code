...
## Metadata
- skill_id: `u06532-kpi-dashboard-publishing-for-research-and-development-labs`
- capability: `KPI Dashboard Publishing for research and development labs`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for research and development labs` in `research and development labs`.
