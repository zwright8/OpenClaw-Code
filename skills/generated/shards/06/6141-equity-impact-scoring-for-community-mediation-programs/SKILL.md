...
## Metadata
- skill_id: `u06141-equity-impact-scoring-for-community-mediation-programs`
- capability: `Equity impact scoring for community mediation programs`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for community mediation programs` in `community mediation programs`.
