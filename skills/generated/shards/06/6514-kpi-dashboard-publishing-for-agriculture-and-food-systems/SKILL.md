...
## Metadata
- skill_id: `u06514-kpi-dashboard-publishing-for-agriculture-and-food-systems`
- capability: `KPI Dashboard Publishing for agriculture and food systems`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for agriculture and food systems` in `agriculture and food systems`.
