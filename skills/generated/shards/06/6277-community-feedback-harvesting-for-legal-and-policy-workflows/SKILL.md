...
## Metadata
- skill_id: `u06277-community-feedback-harvesting-for-legal-and-policy-workflows`
- capability: `Community Feedback Harvesting for legal and policy workflows`
...
## Musts
- [ ] Confirm the request explicitly matches `Community Feedback Harvesting for legal and policy workflows` in `legal and policy workflows`.
