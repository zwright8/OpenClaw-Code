...
## Metadata
- skill_id: `u06536-kpi-dashboard-publishing-for-scientific-publishing-pipelines`
- capability: `KPI Dashboard Publishing for scientific publishing pipelines`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for scientific publishing pipelines` in `scientific publishing pipelines`.
