...
## Metadata
- skill_id: `u06920-learning-curriculum-composition-for-supply-chain-resilience`
- capability: `Learning Curriculum Composition for supply chain resilience`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for supply chain resilience` in `supply chain resilience`.
