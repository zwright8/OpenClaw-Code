# Regression Case — u06876-learning-curriculum-composition-for-legal-and-policy-workflows

## Objective
Verify deterministic replay and fail-closed gate behavior for `Learning Curriculum Composition for legal and policy workflows`.
