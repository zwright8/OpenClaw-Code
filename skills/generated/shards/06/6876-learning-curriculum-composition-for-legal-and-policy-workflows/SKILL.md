...
## Metadata
- skill_id: `u06876-learning-curriculum-composition-for-legal-and-policy-workflows`
- capability: `Learning Curriculum Composition for legal and policy workflows`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for legal and policy workflows` in `legal and policy`.
