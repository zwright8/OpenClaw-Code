...
## Metadata
- skill_id: `u06502-kpi-dashboard-publishing-for-climate-adaptation-initiatives`
- capability: `KPI Dashboard Publishing for climate adaptation initiatives`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for climate adaptation initiatives` in `climate adaptation initiatives`.
