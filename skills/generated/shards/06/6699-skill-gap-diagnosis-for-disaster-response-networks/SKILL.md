...
## Metadata
- skill_id: `u06699-skill-gap-diagnosis-for-disaster-response-networks`
- capability: `Skill Gap Diagnosis for disaster response networks`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for disaster response networks` in `disaster response networks`.
