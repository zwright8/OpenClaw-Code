...
## Metadata
- skill_id: `u06852-learning-curriculum-composition-for-software-engineering-delivery`
- capability: `Learning Curriculum Composition for software engineering delivery`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for software engineering delivery` in `software engineering delivery`.
