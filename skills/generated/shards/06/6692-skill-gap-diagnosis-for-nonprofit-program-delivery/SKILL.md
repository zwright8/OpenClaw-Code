...
## Metadata
- skill_id: `u06692-skill-gap-diagnosis-for-nonprofit-program-delivery`
- capability: `Skill Gap Diagnosis for nonprofit program delivery`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for nonprofit program delivery` in `nonprofit program delivery`.
