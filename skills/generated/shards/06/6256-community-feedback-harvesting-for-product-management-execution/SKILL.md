...
## Metadata
- skill_id: `u06256-community-feedback-harvesting-for-product-management-execution`
- capability: `Community Feedback Harvesting for product management execution`
...
## Musts
- [ ] Confirm the request explicitly matches `Community Feedback Harvesting for product management execution` in `product management execution`.
