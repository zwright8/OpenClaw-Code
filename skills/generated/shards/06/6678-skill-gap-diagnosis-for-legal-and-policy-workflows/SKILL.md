---
name: u06678-skill-gap-diagnosis-for-legal-and-policy-workflows
...
| Feature flag | `skill_06678_skill-gap-diagnosis` |
| Release cycles | `2` |

## Why This Skill Exists
Use skill gap diagnosis in legal and policy workflows with emphasis on clarity, harmony, craft, and emotionally resonant outcomes.
...
5. Run unit, integration, simulation, and regression suites for Skill Gap Diagnosis for legal and policy workflows under beauty and aesthetic appreciation conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Skill Gap Diagnosis for legal and policy workflows under beauty and aesthetic appreciation conditions.
