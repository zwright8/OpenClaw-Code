...
## Metadata
- skill_id: `u06092-equity-impact-scoring-for-nonprofit-program-delivery`
- capability: `Equity impact scoring for nonprofit program delivery`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for nonprofit program delivery` in `nonprofit program delivery`.
