...
## Metadata
- skill_id: `u06722-skill-gap-diagnosis-for-manufacturing-quality-assurance`
- capability: `Skill Gap Diagnosis for manufacturing quality assurance`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for manufacturing quality assurance` in `manufacturing quality assurance`.
