...
## Metadata
- skill_id: `u06583-kpi-dashboard-publishing-for-multilingual-translation-services`
- capability: `KPI Dashboard Publishing for multilingual translation services`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for multilingual translation services` in `multilingual translation services`.
