...
## Metadata
- skill_id: `u06293-community-feedback-harvesting-for-nonprofit-program-delivery`
- capability: `Community Feedback Harvesting for nonprofit program delivery`
...
## Musts
- [ ] Confirm the request explicitly matches `Community Feedback Harvesting for nonprofit program delivery` in `nonprofit program delivery`.
