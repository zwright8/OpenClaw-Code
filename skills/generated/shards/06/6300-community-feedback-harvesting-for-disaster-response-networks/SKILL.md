...
## Metadata
- skill_id: `u06300-community-feedback-harvesting-for-disaster-response-networks`
- capability: `Community Feedback Harvesting for disaster response networks`
...
## Musts
- [ ] Confirm the request explicitly matches `Community Feedback Harvesting for disaster response networks` in `disaster response networks`.
