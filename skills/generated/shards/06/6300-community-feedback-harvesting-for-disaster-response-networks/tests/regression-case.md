# Regression Case — u06300-community-feedback-harvesting-for-disaster-response-networks

## Objective
Verify deterministic replay and fail-closed gate behavior for `Community Feedback Harvesting for disaster response networks`.
