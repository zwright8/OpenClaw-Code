...
## Metadata
- skill_id: `u06616-skill-gap-diagnosis-for-personal-finance-management`
- capability: `Skill Gap Diagnosis for personal finance management`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for personal finance management` in `personal finance management`.
