...
## Metadata
- skill_id: `u06731-skill-gap-diagnosis-for-research-and-development-labs`
- capability: `Skill Gap Diagnosis for research and development labs`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for research and development labs` in `research and development labs`.
