...
## Metadata
- skill_id: `u06114-equity-impact-scoring-for-agriculture-and-food-systems`
- capability: `Equity impact scoring for agriculture and food systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for agriculture and food systems` in `agriculture and food systems`.
