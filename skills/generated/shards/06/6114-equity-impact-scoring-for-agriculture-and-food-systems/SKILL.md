...
## When To Use
Use this skill only when the request explicitly needs `Equity impact scoring for agriculture and food systems` in agriculture and food systems and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Equity impact scoring for agriculture and food systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in agriculture and food systems" capability in production for agriculture and food systems workflows**
   - Input: noisy upstream payload requiring equity impact scoring for agriculture and food systems normalization/assessment.
