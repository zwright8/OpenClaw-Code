...
## Metadata
- skill_id: `u06737-skill-gap-diagnosis-for-scientific-publishing-pipelines`
- capability: `Skill Gap Diagnosis for scientific publishing pipelines`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for scientific publishing pipelines` in `scientific publishing pipelines`.
