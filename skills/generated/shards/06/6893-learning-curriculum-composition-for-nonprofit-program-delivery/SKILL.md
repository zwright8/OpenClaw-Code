...
description: Operate the "Learning Curriculum Composition for nonprofit program delivery" capability in production for nonprofit program delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Learning Curriculum Composition for nonprofit program delivery` in nonprofit program delivery and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Learning Curriculum Composition for nonprofit program delivery** outcomes (not generic brainstorming).
...
1. **Incident stabilization in nonprofit program delivery" capability in production for nonprofit program delivery workflows**
   - Input: noisy upstream payload requiring learning curriculum composition for nonprofit program delivery normalization/assessment.
