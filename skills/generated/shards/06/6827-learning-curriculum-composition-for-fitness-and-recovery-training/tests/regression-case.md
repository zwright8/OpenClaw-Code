# Regression Case — u06827-learning-curriculum-composition-for-fitness-and-recovery-training

## Objective
Verify deterministic replay and fail-closed gate behavior for `Learning Curriculum Composition for fitness and recovery training`.
