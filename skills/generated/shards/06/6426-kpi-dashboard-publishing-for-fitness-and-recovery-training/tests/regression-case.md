# Regression Case — u06426-kpi-dashboard-publishing-for-fitness-and-recovery-training

## Objective
Verify deterministic replay and fail-closed gate behavior for `KPI Dashboard Publishing for fitness and recovery training`.
