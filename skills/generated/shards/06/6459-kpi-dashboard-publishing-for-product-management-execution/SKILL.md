...
## Metadata
- skill_id: `u06459-kpi-dashboard-publishing-for-product-management-execution`
- capability: `KPI Dashboard Publishing for product management execution`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for product management execution` in `product management execution`.
