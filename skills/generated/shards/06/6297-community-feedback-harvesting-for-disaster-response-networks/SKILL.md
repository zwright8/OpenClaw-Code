...
| Feature flag | `skill_06297_community-feedback-harvesting` |
| Release cycles | `2` |

## Why This Skill Exists
Use community feedback harvesting in disaster response networks with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Community Feedback Harvesting for disaster response networks under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Community Feedback Harvesting for disaster response networks under pro-humanity impact conditions.
