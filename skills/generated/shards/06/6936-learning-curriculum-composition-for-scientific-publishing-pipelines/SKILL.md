...
## Metadata
- skill_id: `u06936-learning-curriculum-composition-for-scientific-publishing-pipelines`
- capability: `Learning Curriculum Composition for scientific publishing pipelines`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for scientific publishing pipelines` in `scientific publishing pipelines`.
