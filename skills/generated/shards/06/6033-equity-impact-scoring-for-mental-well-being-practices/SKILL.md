...
## Metadata
- skill_id: `u06033-equity-impact-scoring-for-mental-well-being-practices`
- capability: `Equity Impact Scoring for mental well-being practices`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for mental well-being practices` in `mental well-being practices`.
