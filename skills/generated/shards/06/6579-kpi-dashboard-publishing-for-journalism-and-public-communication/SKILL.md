...
## Metadata
- skill_id: `u06579-kpi-dashboard-publishing-for-journalism-and-public-communication`
- capability: `KPI Dashboard Publishing for journalism and public communication`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for journalism and public communication` in `journalism and public communication`.
