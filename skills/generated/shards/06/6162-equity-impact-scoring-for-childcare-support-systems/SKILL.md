...
## Metadata
- skill_id: `u06162-equity-impact-scoring-for-childcare-support-systems`
- capability: `Equity Impact Scoring for childcare support systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for childcare support systems` in `childcare support systems`.
