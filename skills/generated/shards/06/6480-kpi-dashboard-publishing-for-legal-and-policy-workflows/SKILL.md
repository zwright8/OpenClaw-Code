...
## Metadata
- skill_id: `u06480-kpi-dashboard-publishing-for-legal-and-policy-workflows`
- capability: `KPI Dashboard Publishing for legal and policy workflows`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for legal and policy workflows` in `legal and policy`.
