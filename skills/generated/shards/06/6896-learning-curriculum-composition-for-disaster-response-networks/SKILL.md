...
## Metadata
- skill_id: `u06896-learning-curriculum-composition-for-disaster-response-networks`
- capability: `Learning Curriculum Composition for disaster response networks`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for disaster response networks` in `disaster response networks`.
