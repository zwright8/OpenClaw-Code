...
## Metadata
- skill_id: `u06589-kpi-dashboard-publishing-for-remote-team-collaboration`
- capability: `KPI Dashboard Publishing for remote team collaboration`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for remote team collaboration` in `remote team collaboration`.
