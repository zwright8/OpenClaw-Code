...
## Metadata
- skill_id: `u06680-skill-gap-diagnosis-for-legal-and-policy-workflows`
- capability: `Skill Gap Diagnosis for legal and policy workflows`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for legal and policy workflows` in `legal and policy`.
