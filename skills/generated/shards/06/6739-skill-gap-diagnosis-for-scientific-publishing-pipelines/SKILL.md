...
description: Operate the "Skill Gap Diagnosis for scientific publishing pipelines" capability in production for scientific publishing pipelines workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Skill Gap Diagnosis for scientific publishing pipelines` in scientific publishing pipelines and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Skill Gap Diagnosis for scientific publishing pipelines** outcomes (not generic brainstorming).
...
1. **Incident stabilization in scientific publishing pipelines" capability in production for scientific publishing pipelines workflows**
   - Input: noisy upstream payload requiring skill gap diagnosis for scientific publishing pipelines normalization/assessment.
