...
| Feature flag | `skill_06298_community-feedback-harvesting` |
| Release cycles | `2` |

## Why This Skill Exists
Use community feedback harvesting in disaster response networks with emphasis on clarity, harmony, craft, and emotionally resonant outcomes.
...
5. Run unit, integration, simulation, and regression suites for Community Feedback Harvesting for disaster response networks under beauty and aesthetic appreciation conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Community Feedback Harvesting for disaster response networks under beauty and aesthetic appreciation conditions.
...
1. `Frontier model runtime` -> auth preflight, execute model inference call(s), normalize output, and attach trace to `community-feedback-harvesting-artifact-disaster-response-network`.
2. `Task/workflow orchestrator` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `community-feedback-harvesting-artifact-disaster-response-network`.
3. `Telemetry store` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `community-feedback-harvesting-artifact-disaster-response-network`.
