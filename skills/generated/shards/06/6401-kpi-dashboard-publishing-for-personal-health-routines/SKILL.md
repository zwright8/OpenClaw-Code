...
## Metadata
- skill_id: `u06401-kpi-dashboard-publishing-for-personal-health-routines`
- capability: `KPI Dashboard Publishing for personal health routines`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for personal health routines` in `personal health routines`.
