...
## When To Use
Use this skill only when the request explicitly needs `KPI Dashboard Publishing for nonprofit program delivery` in nonprofit program delivery and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **KPI Dashboard Publishing for nonprofit program delivery** outcomes (not generic brainstorming).
...
1. **Incident stabilization in nonprofit program delivery" capability in production for nonprofit program delivery workflows**
   - Input: noisy upstream payload requiring kpi dashboard publishing for nonprofit program delivery normalization/assessment.
