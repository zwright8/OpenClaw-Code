...
## Metadata
- skill_id: `u06419-kpi-dashboard-publishing-for-personal-finance-management`
- capability: `KPI Dashboard Publishing for personal finance management`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for personal finance management` in `personal finance management`.
