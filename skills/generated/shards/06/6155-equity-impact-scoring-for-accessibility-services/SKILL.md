...
## Metadata
- skill_id: `u06155-equity-impact-scoring-for-accessibility-services`
- capability: `Equity Impact Scoring for accessibility services`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for accessibility services` in `accessibility services`.
