...
## Metadata
- skill_id: `u06523-kpi-dashboard-publishing-for-manufacturing-quality-assurance`
- capability: `KPI Dashboard Publishing for manufacturing quality assurance`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for manufacturing quality assurance` in `manufacturing quality assurance`.
