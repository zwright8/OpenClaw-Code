---
name: u06082-equity-impact-scoring-for-healthcare-operations
...
| Feature flag | `skill_06082_equity-impact-scoring` |
| Release cycles | `2` |

## Why This Skill Exists
Use equity impact scoring in healthcare operations with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Equity Impact Scoring for healthcare operations under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Equity Impact Scoring for healthcare operations under pro-humanity impact conditions.
