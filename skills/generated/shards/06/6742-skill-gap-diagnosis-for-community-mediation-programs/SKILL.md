...
## Metadata
- skill_id: `u06742-skill-gap-diagnosis-for-community-mediation-programs`
- capability: `Skill Gap Diagnosis for community mediation programs`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for community mediation programs` in `community mediation programs`.
