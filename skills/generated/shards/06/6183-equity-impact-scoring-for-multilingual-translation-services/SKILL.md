...
## Metadata
- skill_id: `u06183-equity-impact-scoring-for-multilingual-translation-services`
- capability: `Equity Impact Scoring for multilingual translation services`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for multilingual translation services` in `multilingual translation services`.
