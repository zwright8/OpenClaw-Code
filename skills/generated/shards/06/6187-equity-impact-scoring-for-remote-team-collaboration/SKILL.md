...
## Metadata
- skill_id: `u06187-equity-impact-scoring-for-remote-team-collaboration`
- capability: `Equity Impact Scoring for remote team collaboration`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for remote team collaboration` in `remote team collaboration`.
