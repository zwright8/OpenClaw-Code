...
## Metadata
- skill_id: `u06891-learning-curriculum-composition-for-nonprofit-program-delivery`
- capability: `Learning Curriculum Composition for nonprofit program delivery`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for nonprofit program delivery` in `nonprofit program delivery`.
