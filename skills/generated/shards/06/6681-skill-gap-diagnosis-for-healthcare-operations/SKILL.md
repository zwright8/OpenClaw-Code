...
## Metadata
- skill_id: `u06681-skill-gap-diagnosis-for-healthcare-operations`
- capability: `Skill Gap Diagnosis for healthcare operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for healthcare operations` in `healthcare operations`.
