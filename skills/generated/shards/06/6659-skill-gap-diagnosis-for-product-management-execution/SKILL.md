...
## Metadata
- skill_id: `u06659-skill-gap-diagnosis-for-product-management-execution`
- capability: `Skill Gap Diagnosis for product management execution`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for product management execution` in `product management execution`.
