# Regression Case — u06899-learning-curriculum-composition-for-disaster-response-networks

## Objective
Verify deterministic replay and fail-closed gate behavior for `Learning Curriculum Composition for disaster response networks`.
