...
## Metadata
- skill_id: `u06025-equity-impact-scoring-for-nutrition-and-meal-planning`
- capability: `Equity Impact Scoring for nutrition and meal planning`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for nutrition and meal planning` in `nutrition and meal planning`.
