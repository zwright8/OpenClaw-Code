# Regression Case — u06679-skill-gap-diagnosis-for-legal-and-policy-workflows

## Objective
Verify deterministic replay and fail-closed gate behavior for `Skill Gap Diagnosis for legal and policy workflows`.
