...
## Metadata
- skill_id: `u06443-kpi-dashboard-publishing-for-career-development-pathways`
- capability: `KPI Dashboard Publishing for career development pathways`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for career development pathways` in `career development pathways`.
