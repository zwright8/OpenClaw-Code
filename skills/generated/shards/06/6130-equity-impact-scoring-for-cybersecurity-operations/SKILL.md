...
## Metadata
- skill_id: `u06130-equity-impact-scoring-for-cybersecurity-operations`
- capability: `Equity impact scoring for cybersecurity operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for cybersecurity operations` in `cybersecurity operations`.
