...
## Metadata
- skill_id: `u06665-skill-gap-diagnosis-for-design-and-user-research`
- capability: `Skill Gap Diagnosis for design and user research`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for design and user research` in `design and user research`.
