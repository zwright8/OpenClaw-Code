...
## Metadata
- skill_id: `u06150-equity-impact-scoring-for-civic-participation-platforms`
- capability: `Equity Impact Scoring for civic participation platforms`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for civic participation platforms` in `civic participation platforms`.
