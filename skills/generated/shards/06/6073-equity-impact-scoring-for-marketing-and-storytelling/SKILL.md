...
## Metadata
- skill_id: `u06073-equity-impact-scoring-for-marketing-and-storytelling`
- capability: `Equity impact scoring for marketing and storytelling`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for marketing and storytelling` in `marketing and storytelling`.
