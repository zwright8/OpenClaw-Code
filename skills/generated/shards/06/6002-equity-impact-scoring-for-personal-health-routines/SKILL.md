...
## Metadata
- skill_id: `u06002-equity-impact-scoring-for-personal-health-routines`
- capability: `Equity Impact Scoring for personal health routines`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for personal health routines` in `personal health routines`.
