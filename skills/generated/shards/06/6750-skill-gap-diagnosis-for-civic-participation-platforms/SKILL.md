...
## Metadata
- skill_id: `u06750-skill-gap-diagnosis-for-civic-participation-platforms`
- capability: `Skill Gap Diagnosis for civic participation platforms`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for civic participation platforms` in `civic participation platforms`.
