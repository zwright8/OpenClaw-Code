...
## Metadata
- skill_id: `u06414-kpi-dashboard-publishing-for-household-logistics`
- capability: `KPI Dashboard Publishing for household logistics`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for household logistics` in `household logistics`.
