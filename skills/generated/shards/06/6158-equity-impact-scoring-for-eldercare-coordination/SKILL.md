...
## Metadata
- skill_id: `u06158-equity-impact-scoring-for-eldercare-coordination`
- capability: `Equity Impact Scoring for eldercare coordination`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for eldercare coordination` in `eldercare coordination`.
