...
## Metadata
- skill_id: `u06482-kpi-dashboard-publishing-for-healthcare-operations`
- capability: `KPI Dashboard Publishing for healthcare operations`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for healthcare operations` in `healthcare operations`.
