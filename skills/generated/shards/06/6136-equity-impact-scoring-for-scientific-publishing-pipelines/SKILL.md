...
## Metadata
- skill_id: `u06136-equity-impact-scoring-for-scientific-publishing-pipelines`
- capability: `Equity impact scoring for scientific publishing pipelines`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for scientific publishing pipelines` in `scientific publishing pipelines`.
