...
## Metadata
- skill_id: `u06110-equity-impact-scoring-for-urban-planning-and-mobility`
- capability: `Equity impact scoring for urban planning and mobility`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for urban planning and mobility` in `urban planning and mobility`.
