...
## Metadata
- skill_id: `u06052-equity-impact-scoring-for-software-engineering-delivery`
- capability: `Equity impact scoring for software engineering delivery`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for software engineering delivery` in `software engineering delivery`.
