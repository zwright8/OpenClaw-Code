...
## Metadata
- skill_id: `u06492-kpi-dashboard-publishing-for-nonprofit-program-delivery`
- capability: `KPI Dashboard Publishing for nonprofit program delivery`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for nonprofit program delivery` in `nonprofit program delivery`.
