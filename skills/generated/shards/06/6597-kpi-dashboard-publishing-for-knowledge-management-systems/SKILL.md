...
## Metadata
- skill_id: `u06597-kpi-dashboard-publishing-for-knowledge-management-systems`
- capability: `KPI Dashboard Publishing for knowledge management systems`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for knowledge management systems` in `knowledge management systems`.
