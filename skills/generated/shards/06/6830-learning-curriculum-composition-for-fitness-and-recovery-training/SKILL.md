...
description: Operate the "Learning Curriculum Composition for fitness and recovery training" capability in production for fitness and recovery training workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Learning Curriculum Composition for fitness and recovery training` in fitness and recovery training and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Learning Curriculum Composition for fitness and recovery training** outcomes (not generic brainstorming).
...
1. **Incident stabilization in fitness and recovery training" capability in production for fitness and recovery training workflows**
   - Input: noisy upstream payload requiring learning curriculum composition for fitness and recovery training normalization/assessment.
