# Regression Case — u06921-learning-curriculum-composition-for-manufacturing-quality-assurance

## Objective
Verify deterministic replay and fail-closed gate behavior for `Learning Curriculum Composition for manufacturing quality assurance`.
