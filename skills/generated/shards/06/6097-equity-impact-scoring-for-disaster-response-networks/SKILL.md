...
## Metadata
- skill_id: `u06097-equity-impact-scoring-for-disaster-response-networks`
- capability: `Equity impact scoring for disaster response networks`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for disaster response networks` in `disaster response networks`.
