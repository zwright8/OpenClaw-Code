...
## Metadata
- skill_id: `u06019-equity-impact-scoring-for-personal-finance-management`
- capability: `Equity Impact Scoring for personal finance management`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for personal finance management` in `personal finance management`.
