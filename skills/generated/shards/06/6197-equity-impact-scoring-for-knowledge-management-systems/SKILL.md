...
## Metadata
- skill_id: `u06197-equity-impact-scoring-for-knowledge-management-systems`
- capability: `Equity Impact Scoring for knowledge management systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for knowledge management systems` in `knowledge management systems`.
