...
## Metadata
- skill_id: `u06786-skill-gap-diagnosis-for-remote-team-collaboration`
- capability: `Skill Gap Diagnosis for remote team collaboration`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for remote team collaboration` in `remote team collaboration`.
