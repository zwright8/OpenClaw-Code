...
## Metadata
- skill_id: `u06120-equity-impact-scoring-for-supply-chain-resilience`
- capability: `Equity impact scoring for supply chain resilience`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for supply chain resilience` in `supply chain resilience`.
