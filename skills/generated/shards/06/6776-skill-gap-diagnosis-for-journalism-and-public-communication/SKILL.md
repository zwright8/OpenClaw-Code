...
## Metadata
- skill_id: `u06776-skill-gap-diagnosis-for-journalism-and-public-communication`
- capability: `Skill Gap Diagnosis for journalism and public communication`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for journalism and public communication` in `journalism and public communication`.
