...
## Metadata
- skill_id: `u06859-learning-curriculum-composition-for-product-management-execution`
- capability: `Learning Curriculum Composition for product management execution`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for product management execution` in `product management execution`.
