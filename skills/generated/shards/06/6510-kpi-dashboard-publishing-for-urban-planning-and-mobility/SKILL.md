...
## Metadata
- skill_id: `u06510-kpi-dashboard-publishing-for-urban-planning-and-mobility`
- capability: `KPI Dashboard Publishing for urban planning and mobility`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for urban planning and mobility` in `urban planning and mobility`.
