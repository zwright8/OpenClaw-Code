...
## Metadata
- skill_id: `u06760-skill-gap-diagnosis-for-eldercare-coordination`
- capability: `Skill Gap Diagnosis for eldercare coordination`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for eldercare coordination` in `eldercare coordination`.
