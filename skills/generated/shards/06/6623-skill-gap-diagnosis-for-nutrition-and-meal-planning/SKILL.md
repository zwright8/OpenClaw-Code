...
## Metadata
- skill_id: `u06623-skill-gap-diagnosis-for-nutrition-and-meal-planning`
- capability: `Skill Gap Diagnosis for nutrition and meal planning`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for nutrition and meal planning` in `nutrition and meal planning`.
