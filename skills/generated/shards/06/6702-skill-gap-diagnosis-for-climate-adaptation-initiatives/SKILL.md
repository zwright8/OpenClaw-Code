...
## Metadata
- skill_id: `u06702-skill-gap-diagnosis-for-climate-adaptation-initiatives`
- capability: `Skill Gap Diagnosis for climate adaptation initiatives`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for climate adaptation initiatives` in `climate adaptation initiatives`.
