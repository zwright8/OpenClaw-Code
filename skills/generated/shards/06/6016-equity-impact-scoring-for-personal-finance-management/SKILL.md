...
| Feature flag | `skill_06016_equity-impact-scoring` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Equity Impact Scoring for personal finance management under maximally truth-seeking conditions.
