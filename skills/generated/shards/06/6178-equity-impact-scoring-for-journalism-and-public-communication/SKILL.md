...
## Metadata
- skill_id: `u06178-equity-impact-scoring-for-journalism-and-public-communication`
- capability: `Equity Impact Scoring for journalism and public communication`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for journalism and public communication` in `journalism and public communication`.
