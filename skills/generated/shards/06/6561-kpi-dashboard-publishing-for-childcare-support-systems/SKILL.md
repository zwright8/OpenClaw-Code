...
## Metadata
- skill_id: `u06561-kpi-dashboard-publishing-for-childcare-support-systems`
- capability: `KPI Dashboard Publishing for childcare support systems`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for childcare support systems` in `childcare support systems`.
