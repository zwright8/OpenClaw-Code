...
## Metadata
- skill_id: `u06070-equity-impact-scoring-for-sales-and-client-success`
- capability: `Equity impact scoring for sales and client success`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for sales and client success` in `sales and client success`.
