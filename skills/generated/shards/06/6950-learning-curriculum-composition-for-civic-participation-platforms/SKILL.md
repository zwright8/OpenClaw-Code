...
## Metadata
- skill_id: `u06950-learning-curriculum-composition-for-civic-participation-platforms`
- capability: `Learning Curriculum Composition for civic participation platforms`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for civic participation platforms` in `civic participation platforms`.
