# Regression Case — u06870-learning-curriculum-composition-for-sales-and-client-success

## Objective
Verify deterministic replay and fail-closed gate behavior for `Learning Curriculum Composition for sales and client success`.
