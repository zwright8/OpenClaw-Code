...
## Metadata
- skill_id: `u06083-equity-impact-scoring-for-healthcare-operations`
- capability: `Equity impact scoring for healthcare operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for healthcare operations` in `healthcare operations`.
