...
## Metadata
- skill_id: `u06425-kpi-dashboard-publishing-for-nutrition-and-meal-planning`
- capability: `KPI Dashboard Publishing for nutrition and meal planning`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for nutrition and meal planning` in `nutrition and meal planning`.
