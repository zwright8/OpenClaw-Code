...
## Metadata
- skill_id: `u06077-equity-impact-scoring-for-legal-and-policy-workflows`
- capability: `Equity impact scoring for legal and policy workflows`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity impact scoring for legal and policy workflows` in `legal and policy`.
