...
## Metadata
- skill_id: `u06942-learning-curriculum-composition-for-community-mediation-programs`
- capability: `Learning Curriculum Composition for community mediation programs`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for community mediation programs` in `community mediation programs`.
