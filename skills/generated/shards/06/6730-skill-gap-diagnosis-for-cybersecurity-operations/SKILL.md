...
## Metadata
- skill_id: `u06730-skill-gap-diagnosis-for-cybersecurity-operations`
- capability: `Skill Gap Diagnosis for cybersecurity operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for cybersecurity operations` in `cybersecurity operations`.
