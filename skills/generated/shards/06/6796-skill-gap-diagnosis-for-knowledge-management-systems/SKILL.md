...
## Metadata
- skill_id: `u06796-skill-gap-diagnosis-for-knowledge-management-systems`
- capability: `Skill Gap Diagnosis for knowledge management systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for knowledge management systems` in `knowledge management systems`.
