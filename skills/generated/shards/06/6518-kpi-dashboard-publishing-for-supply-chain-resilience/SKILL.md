...
## Metadata
- skill_id: `u06518-kpi-dashboard-publishing-for-supply-chain-resilience`
- capability: `KPI Dashboard Publishing for supply chain resilience`
...
## Musts
- [ ] Confirm the request explicitly matches `KPI Dashboard Publishing for supply chain resilience` in `supply chain resilience`.
