...
## Metadata
- skill_id: `u06626-skill-gap-diagnosis-for-fitness-and-recovery-training`
- capability: `Skill Gap Diagnosis for fitness and recovery training`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for fitness and recovery training` in `fitness and recovery training`.
