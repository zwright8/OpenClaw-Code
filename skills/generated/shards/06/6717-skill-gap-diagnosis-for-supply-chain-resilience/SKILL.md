...
## Metadata
- skill_id: `u06717-skill-gap-diagnosis-for-supply-chain-resilience`
- capability: `Skill Gap Diagnosis for supply chain resilience`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for supply chain resilience` in `supply chain resilience`.
