...
description: Operate the "KPI Dashboard Publishing for household logistics" capability in production for household logistics workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `KPI Dashboard Publishing for household logistics` in household logistics and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **KPI Dashboard Publishing for household logistics** outcomes (not generic brainstorming).
...
1. **Incident stabilization in household logistics" capability in production for household logistics workflows**
   - Input: noisy upstream payload requiring kpi dashboard publishing for household logistics normalization/assessment.
