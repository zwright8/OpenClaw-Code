...
## Metadata
- skill_id: `u06863-learning-curriculum-composition-for-design-and-user-research`
- capability: `Learning Curriculum Composition for design and user research`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for design and user research` in `design and user research`.
