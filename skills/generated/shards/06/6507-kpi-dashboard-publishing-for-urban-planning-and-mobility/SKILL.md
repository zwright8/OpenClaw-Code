...
## When To Use
Use this skill only when the request explicitly needs `KPI Dashboard Publishing for urban planning and mobility` in urban planning and mobility and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **KPI Dashboard Publishing for urban planning and mobility** outcomes (not generic brainstorming).
...
1. **Incident stabilization in urban planning and mobility" capability in production for urban planning and mobility workflows**
   - Input: noisy upstream payload requiring kpi dashboard publishing for urban planning and mobility normalization/assessment.
