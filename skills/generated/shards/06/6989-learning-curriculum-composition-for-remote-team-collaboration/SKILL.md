...
| Feature flag | `skill_06989_learning-curriculum-compositio` |
| Release cycles | `2` |

## Why This Skill Exists
Use learning curriculum composition in remote team collaboration with emphasis on throughput, reliability, leverage, and execution speed.
...
5. Run unit, integration, simulation, and regression suites for Learning Curriculum Composition for remote team collaboration under hyper-productive autonomy conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Learning Curriculum Composition for remote team collaboration under hyper-productive autonomy conditions.
...
1. `Frontier model runtime` -> auth preflight, execute model inference call(s), normalize output, and attach trace to `learning-curriculum-composition-artifact-remote-team-collaborati`.
2. `Task/workflow orchestrator` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `learning-curriculum-composition-artifact-remote-team-collaborati`.
3. `Telemetry store` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `learning-curriculum-composition-artifact-remote-team-collaborati`.
