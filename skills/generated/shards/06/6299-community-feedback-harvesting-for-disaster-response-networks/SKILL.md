...
| Feature flag | `skill_06299_community-feedback-harvesting` |
| Release cycles | `2` |

## Why This Skill Exists
Use community feedback harvesting in disaster response networks with emphasis on throughput, reliability, leverage, and execution speed.
...
5. Run unit, integration, simulation, and regression suites for Community Feedback Harvesting for disaster response networks under hyper-productive autonomy conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Community Feedback Harvesting for disaster response networks under hyper-productive autonomy conditions.
