...
## Metadata
- skill_id: `u06026-equity-impact-scoring-for-fitness-and-recovery-training`
- capability: `Equity Impact Scoring for fitness and recovery training`
...
## Musts
- [ ] Confirm the request explicitly matches `Equity Impact Scoring for fitness and recovery training` in `fitness and recovery training`.
