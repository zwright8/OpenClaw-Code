...
## Metadata
- skill_id: `u06805-learning-curriculum-composition-for-personal-health-routines`
- capability: `Learning Curriculum Composition for personal health routines`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for personal health routines` in `personal health routines`.
