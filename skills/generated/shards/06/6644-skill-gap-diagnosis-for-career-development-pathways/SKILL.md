...
## Metadata
- skill_id: `u06644-skill-gap-diagnosis-for-career-development-pathways`
- capability: `Skill Gap Diagnosis for career development pathways`
...
## Musts
- [ ] Confirm the request explicitly matches `Skill Gap Diagnosis for career development pathways` in `career development pathways`.
