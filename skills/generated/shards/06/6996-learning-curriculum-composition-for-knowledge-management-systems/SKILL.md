...
## Metadata
- skill_id: `u06996-learning-curriculum-composition-for-knowledge-management-systems`
- capability: `Learning Curriculum Composition for knowledge management systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Learning Curriculum Composition for knowledge management systems` in `knowledge management systems`.
