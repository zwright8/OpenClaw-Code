---
name: c-cpp-systems-and-build
description: Use C/C++ systems toolchains for compilation, linting, static analysis, and build orchestration. Use when maintaining native codebases, cross-compiling, or debugging build graphs.
---

# c-cpp-systems-and-build

## Quick Reference
| Field | Value |
|---|---|
| Skill pack | `c-cpp-systems-and-build` |
| Tool count | `38` |
| Inventory rank span | `501-957` |
| References | `references/tools.md`, `references/tools.csv`, `references/workflows.md` |
| Local checker | `scripts/check-tools.sh` |

## Why This Skill Exists
This pack provides a curated operational toolkit for c-cpp-systems-and-build tasks so operators can select the smallest safe tool, execute with bounded risk, and hand off reproducible outputs.
...
|---|---|---|---|---|
| inventory & read-only diagnosis | `swift-protobuf` | `periphery` | no | no |
| bounded mutation / transformation | `periphery` | `swift-protobuf` | yes | yes |
| validation & artifact checks | `swift-protobuf` | `periphery` | conditional | no |

## Tool Inventory Highlights
| Tool | Typical Use | Access |
|---|---|---|
| `swift-protobuf` | Plugin and runtime library for using protobuf with Swift | local-installable |
| `periphery` | Identify unused code in Swift projects | local-installable |
| `universal-ctags` | Maintained ctags implementation | local-installable |
| `mingw-w64` | Minimalist GNU for Windows and GCC cross-compilers | local-installable |
| `bazel` | Google's own build tool | local-installable |
| `suite-sparse` | Suite of Sparse Matrix Software | local-installable |
| `googletest` | Google Testing and Mocking Framework | local-installable |
| `pcre` | Perl compatible regular expressions library | local-installable |
| `wxwidgets` | Cross-platform C++ GUI toolkit | local-installable |
| `conan` | Distributed, open source, package manager for C/C++ | local-installable |
| `cppcheck` | Static analysis of C and C++ code | local-installable |
| `emscripten` | LLVM bytecode to JavaScript compiler | local-installable |

## API Protocols & Credential Requirements
| Tool | Primary protocol(s) | Auth mode | Auth required | API key needed | Operator action |
|---|---|---|---|---|---|
| `swift-protobuf` | Local library API/ABI, CLI/stdin-stdout | None (local library/runtime) | no | no | No API key required for local library/runtime use. |
| `periphery` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `universal-ctags` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `mingw-w64` | JSON-RPC/WebSocket, CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `bazel` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `suite-sparse` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `googletest` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `pcre` | Local library API/ABI, CLI/stdin-stdout | None (local library/runtime) | no | no | No API key required for local library/runtime use. |
| `wxwidgets` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `conan` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `cppcheck` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `emscripten` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `bear` | SQL/DB protocol, CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `clang-format@11` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `proj` | Local library API/ABI, CLI/stdin-stdout | None (local library/runtime) | no | no | No API key required for local library/runtime use. |
| `z3` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `tbb` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `fftw` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `llvm@19` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `llvm@20` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `vera++` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `capnp` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `flex` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `libuv` | Local library API/ABI | None or local runtime | no | no | No API key required for local/offline use. |
| `geos` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `nlohmann-json` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `libx11` | Local library API/ABI, CLI/stdin-stdout | None (local library/runtime) | no | no | No API key required for local library/runtime use. |
| `icu4c@78` | CLI/local file I/O | None or local runtime | no | no | No API key required for local/offline use. |
| `abseil` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `fmt` | Local library API/ABI, CLI/stdin-stdout | None (local library/runtime) | no | no | No API key required for local library/runtime use. |
| `arm-none-eabi-gcc` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `mpfr` | Local library API/ABI, CLI/stdin-stdout | None (local library/runtime) | no | no | No API key required for local library/runtime use. |
| `protobuf-c` | Local library API/ABI, CLI/stdin-stdout | None (local library/runtime) | no | no | No API key required for local library/runtime use. |
| `re2c` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `re2` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `buildifier` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `scons` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `vcpkg` | Local library API/ABI, CLI/stdin-stdout | None (local library/runtime) | no | no | No API key required for local library/runtime use. |
...
1. `swift-protobuf` (Local library API/ABI, CLI/stdin-stdout) -> auth preflight (None (local library/runtime)), run read+write command sequence, capture outputs and exit code in handoff packet.
2. `periphery` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
3. `universal-ctags` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
4. `mingw-w64` (JSON-RPC/WebSocket, CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
5. `bazel` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
6. `suite-sparse` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
...
1. Select a minimal tool from this pack to solve a c-cpp-systems-and-build request, run dry-run first, then produce a validated artifact bundle.
