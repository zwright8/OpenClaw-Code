---
name: klaviyo-approval-router
description: Use when tasks require klaviyo approval router with credential-aware preflight, deterministic execution, validation gates, and handoff-ready artifacts.
---

# Klaviyo Approval Router
...
| Primary artifact | `klaviyo-approval-decision-packet` |
| Routing tag | `klaviyo:approval-router` |
| Mutating | `yes` |
| Release cycles | `3` |

## Why This Skill Exists
We need this skill because Klaviyo workflows degrade when auth, schema, and side-effect handling drift when integrations are run ad hoc. This specific skill turns Klaviyo Approval Router into a deterministic, auth-checked workflow for routes klaviyo-driven decisions to the right approvers..

## Trigger Checklist
- [ ] The task explicitly requires `Klaviyo Approval Router` rather than generic brainstorming.
...
| --- | --- | --- | --- |
| klaviyo-approval-decision-packet | structured-artifact | yes | next workflow or operator |
| klaviyo-approval-decision-packet-scorecard | scorecard | yes | reviewer |
| klaviyo-approval-decision-packet-handoff | handoff-packet | yes | downstream owner |

## Step-by-Step Implementation Guide
1. Define the decision classes, approver roster, and escalation hierarchy for Klaviyo Approval Router, then capture the manual fallback path for Klaviyo.
...
3. Implement routes klaviyo-driven decisions to the right approvers. so the routing decision always includes policy clauses, approver evidence, and escalation context.
...
- Preserve request, response, and approval traces in `klaviyo-approval-decision-packet` so downstream owners do not need to rediscover context.
...
- [ ] klaviyo-approval-decision-packet, scorecard, and handoff packet were produced.
...
## Handoff Contract
- **Produces:** `klaviyo-approval-decision-packet`, execution scorecard, approval trace, and next actions.
...
- **Downstream hint:** route to `klaviyo:approval-router` consumers with approval and credential context attached.
