...
| Field | Value |
|---|---|
| Skill pack | `b04-data-db-messaging-workflows` |
| Tool count | `42` |
| Inventory rank span | `1520-1980` |
| References | `references/tools.md`, `references/tools.csv`, `references/workflows.md` |
| Local checker | `scripts/check-tools.sh` |

## Why This Skill Exists
This pack provides a curated operational toolkit for data, databases & messaging workflows tasks so operators can select the smallest safe tool, execute with bounded risk, and hand off reproducible outputs.
...
|---|---|---|---|---|
| inventory & read-only diagnosis | `lapack` | `pocketbase` | no | no |
| bounded mutation / transformation | `pocketbase` | `lapack` | yes | yes |
| validation & artifact checks | `lapack` | `pocketbase` | conditional | no |

## Tool Inventory Highlights
| Tool | Typical Use | Access |
|---|---|---|
| `lapack` | Linear Algebra PACKage | local-installable |
| `pocketbase` | Open source backend for your next project in 1 file | local-installable |
| `blast` | Basic Local Alignment Search Tool | local-installable |
| `imapsync` | Migrate or backup IMAP mail accounts | local-installable |
| `xq` | Command-line XML and HTML beautifier and content extractor | local-installable |
| `bruno-cli` | CLI of the open-source IDE For exploring and testing APIs | local-installable |
| `libdap` | Framework for scientific data networking | local-installable |
| `postgrest` | Serves a fully RESTful API from any existing PostgreSQL database | local-installable |
| `ledger` | Command-line, double-entry accounting tool | local-installable |
| `mdbtools` | Tools to facilitate the use of Microsoft Access databases | local-installable |
| `cjson` | Ultralightweight JSON parser in ANSI C | local-installable |
| `xan` | CSV CLI magician written in Rust | local-installable |

## API Protocols & Credential Requirements
| Tool | Primary protocol(s) | Auth mode | Auth required | API key needed | Operator action |
|---|---|---|---|---|---|
| `lapack` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `pocketbase` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `blast` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `imapsync` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `xq` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `bruno-cli` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `libdap` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `postgrest` | SQL/DB protocol, CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `ledger` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `mdbtools` | SQL/DB protocol, CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `cjson` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `xan` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `calc` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `mcp-toolbox` | SQL/DB protocol, CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `csvlens` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `petsc` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `cfitsio` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `npm-check-updates` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `bcftools` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `json-c` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `redis@6.2` | SQL/DB protocol, CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `posting` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `cypher-shell` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `jc` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `harlequin` | SQL/DB protocol, CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `mmseqs2` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `influxdb-cli` | SQL/DB protocol, CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `avro-tools` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `rover` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `contentful-cli` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `rainfrog` | SQL/DB protocol, CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `curlie` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `scip` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `oauth2l` | CLI/stdin-stdout | Account/session credentials | yes | no | Confirm account credentials/session context are configured before execution. |
| `rqlite` | SQL/DB protocol, CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `newman` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `cbc` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `homebank` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `activemq` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `snakemake` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `molecule` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `psqlodbc` | SQL/DB protocol, CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |

## Credential Prompting Rule
- `oauth2l`: Reuse existing credentials/session first and validate access. Ask user only if required credentials are missing or invalid.
...
1. `lapack` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
2. `pocketbase` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
3. `blast` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
4. `imapsync` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
5. `xq` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
6. `bruno-cli` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
...
1. Select a minimal tool from this pack to solve a data, databases & messaging workflows request, run dry-run first, then produce a validated artifact bundle.
