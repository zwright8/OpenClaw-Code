---
name: b04-terminal-shell-productivity
description: Use when building efficient CLI workflows, shell customization, command automation, and local productivity loops.
---

# Terminal productivity & shell workflows

## Quick Reference
| Field | Value |
|---|---|
| Skill pack | `b04-terminal-shell-productivity` |
| Tool count | `35` |
| Inventory rank span | `1517-1988` |
| References | `references/tools.md`, `references/tools.csv`, `references/workflows.md` |
| Local checker | `scripts/check-tools.sh` |

## Why This Skill Exists
This pack provides a curated operational toolkit for terminal productivity & shell workflows tasks so operators can select the smallest safe tool, execute with bounded risk, and hand off reproducible outputs.
...
|---|---|---|---|---|
| inventory & read-only diagnosis | `zsh-history-substring-search` | `wtfutil` | no | no |
| bounded mutation / transformation | `wtfutil` | `zsh-history-substring-search` | yes | yes |
| validation & artifact checks | `zsh-history-substring-search` | `wtfutil` | conditional | no |

## Tool Inventory Highlights
| Tool | Typical Use | Access |
|---|---|---|
| `zsh-history-substring-search` | Zsh port of Fish shell's history search | local-installable |
| `wtfutil` | Personal information dashboard for your terminal | local-installable |
| `zplug` | Next-generation plugin manager for zsh | local-installable |
| `brew-gem` | Install RubyGems as Homebrew formulae | local-installable |
| `tcsh` | Enhanced, fully compatible version of the Berkeley C shell | local-installable |
| `ttyd` | Command-line tool for sharing terminal over the web | local-installable |
| `rich-cli` | Command-line toolbox for fancy output in the terminal | local-installable |
| `picocom` | Minimal dumb-terminal emulation program | local-installable |
| `irssi` | Modular IRC client | local-installable |
| `terminator` | Multiple GNOME terminals in one window | local-installable |
| `kimi-cli` | CLI agent for MoonshotAI Kimi platform | local-installable |
| `virtualenvwrapper` | Python virtualenv extensions | local-installable |

## API Protocols & Credential Requirements
| Tool | Primary protocol(s) | Auth mode | Auth required | API key needed | Operator action |
|---|---|---|---|---|---|
| `zsh-history-substring-search` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `wtfutil` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `zplug` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `brew-gem` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `tcsh` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `ttyd` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `rich-cli` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `picocom` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `irssi` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `terminator` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `kimi-cli` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `virtualenvwrapper` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `tmuxp` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `sesh` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `foreman` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `zx` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `mprocs` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `copyparty` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `checkbashisms` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `mcfly` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `zsh-fast-syntax-highlighting` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `hunspell` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `notmuch` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `pip-tools` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `mcpm` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `python-argcomplete` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `dockutil` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `brew-php-switcher` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `autogen` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `makensis` | JSON-RPC/WebSocket, CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `reattach-to-user-namespace` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `bkt` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `sc-im` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `bat-extras` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
| `rbenv-bundler` | CLI/stdin-stdout | None or local runtime | no | no | No API key required for local/offline use. |
...
1. `zsh-history-substring-search` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
2. `wtfutil` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
3. `zplug` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
4. `brew-gem` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
5. `tcsh` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
6. `ttyd` (CLI/stdin-stdout) -> auth preflight (None or local runtime), run read+write command sequence, capture outputs and exit code in handoff packet.
...
1. Select a minimal tool from this pack to solve a terminal productivity & shell workflows request, run dry-run first, then produce a validated artifact bundle.
