---
name: woocommerce-approval-router
description: Use when tasks require woocommerce approval router with credential-aware preflight, deterministic execution, validation gates, and handoff-ready artifacts.
---

# WooCommerce Approval Router
...
| Primary artifact | `woocommerce-approval-decision-packet` |
| Routing tag | `woocommerce:approval-router` |
| Mutating | `yes` |
| Release cycles | `3` |

## Why This Skill Exists
We need this skill because WooCommerce workflows degrade when auth, schema, and side-effect handling drift when integrations are run ad hoc. This specific skill turns WooCommerce Approval Router into a deterministic, auth-checked workflow for routes woocommerce-driven decisions to the right approvers..

## Trigger Checklist
- [ ] The task explicitly requires `WooCommerce Approval Router` rather than generic brainstorming.
...
| --- | --- | --- | --- |
| woocommerce-approval-decision-packet | structured-artifact | yes | next workflow or operator |
| woocommerce-approval-decision-packet-scorecard | scorecard | yes | reviewer |
| woocommerce-approval-decision-packet-handoff | handoff-packet | yes | downstream owner |

## Step-by-Step Implementation Guide
1. Define the decision classes, approver roster, and escalation hierarchy for WooCommerce Approval Router, then capture the manual fallback path for WooCommerce.
...
3. Implement routes woocommerce-driven decisions to the right approvers. so the routing decision always includes policy clauses, approver evidence, and escalation context.
...
- Preserve request, response, and approval traces in `woocommerce-approval-decision-packet` so downstream owners do not need to rediscover context.
...
- [ ] woocommerce-approval-decision-packet, scorecard, and handoff packet were produced.
...
## Handoff Contract
- **Produces:** `woocommerce-approval-decision-packet`, execution scorecard, approval trace, and next actions.
...
- **Downstream hint:** route to `woocommerce:approval-router` consumers with approval and credential context attached.
