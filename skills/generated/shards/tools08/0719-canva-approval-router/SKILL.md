---
name: canva-approval-router
description: Use when tasks require canva approval router with credential-aware preflight, deterministic execution, validation gates, and handoff-ready artifacts.
---

# Canva Approval Router
...
| Primary artifact | `canva-approval-decision-packet` |
| Routing tag | `canva:approval-router` |
| Mutating | `yes` |
| Release cycles | `3` |

## Why This Skill Exists
We need this skill because Canva workflows degrade when auth, schema, and side-effect handling drift when integrations are run ad hoc. This specific skill turns Canva Approval Router into a deterministic, auth-checked workflow for routes canva-driven decisions to the right approvers..

## Trigger Checklist
- [ ] The task explicitly requires `Canva Approval Router` rather than generic brainstorming.
...
| --- | --- | --- | --- |
| canva-approval-decision-packet | structured-artifact | yes | next workflow or operator |
| canva-approval-decision-packet-scorecard | scorecard | yes | reviewer |
| canva-approval-decision-packet-handoff | handoff-packet | yes | downstream owner |

## Step-by-Step Implementation Guide
1. Define the decision classes, approver roster, and escalation hierarchy for Canva Approval Router, then capture the manual fallback path for Canva.
...
3. Implement routes canva-driven decisions to the right approvers. so the routing decision always includes policy clauses, approver evidence, and escalation context.
...
- Preserve request, response, and approval traces in `canva-approval-decision-packet` so downstream owners do not need to rediscover context.
...
- [ ] canva-approval-decision-packet, scorecard, and handoff packet were produced.
...
## Handoff Contract
- **Produces:** `canva-approval-decision-packet`, execution scorecard, approval trace, and next actions.
...
- **Downstream hint:** route to `canva:approval-router` consumers with approval and credential context attached.
