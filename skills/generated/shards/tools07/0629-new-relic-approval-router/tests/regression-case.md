...
## Scenario
Approval routing with no matching policy and a stale approver roster.

## Fixture
`../fixtures/minimal-valid.json` (mutated to violate auth, contract, or approval requirements).

## Mutation
Remove all matching policy clauses from the fixture and mark the candidate approver unavailable.
