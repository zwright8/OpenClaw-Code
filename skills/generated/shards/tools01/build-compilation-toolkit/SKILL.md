---
name: build-compilation-toolkit
description: Compile and package software across toolchains. Use when configuring builds, invoking compilers, generating code, linking native dependencies, or troubleshooting compile/link failures in C/C++/JVM/polyglot projects.
---

# Build & Compilation Toolkit

## Quick Reference
| Field | Value |
|---|---|
| Skill pack | `build-compilation-toolkit` |
| Tool count | `0` |
...
This pack provides a curated operational toolkit for build & compilation toolkit tasks so operators can select the smallest safe tool, execute with bounded risk, and hand off reproducible outputs.
...
1. Select a minimal tool from this pack to solve a build & compilation toolkit request, run dry-run first, then produce a validated artifact bundle.
