...
| Field | Value |
|---|---|
| Skill pack | `git-repo-collaboration-toolkit` |
| Tool count | `0` |
...
This pack provides a curated operational toolkit for git & repo collaboration toolkit tasks so operators can select the smallest safe tool, execute with bounded risk, and hand off reproducible outputs.
...
1. Select a minimal tool from this pack to solve a git & repo collaboration toolkit request, run dry-run first, then produce a validated artifact bundle.
