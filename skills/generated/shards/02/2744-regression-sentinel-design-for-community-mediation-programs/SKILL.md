...
```yaml
skill_id: u2744
skill_name: u2744-regression-sentinel-design-for-community-mediation-programs
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for community mediation programs** before execution.
