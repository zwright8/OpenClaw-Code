...
```yaml
skill_id: u2718
skill_name: u2718-regression-sentinel-design-for-supply-chain-resilience
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for supply chain resilience** before execution.
