...
```yaml
skill_id: u2521
skill_name: u2521-failure-root-cause-mining-for-manufacturing-quality-assurance
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for manufacturing quality assurance** before execution.
