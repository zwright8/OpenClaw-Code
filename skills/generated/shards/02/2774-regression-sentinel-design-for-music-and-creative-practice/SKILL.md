...
```yaml
skill_id: u2774
skill_name: u2774-regression-sentinel-design-for-music-and-creative-practice
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for music and creative practice** before execution.
