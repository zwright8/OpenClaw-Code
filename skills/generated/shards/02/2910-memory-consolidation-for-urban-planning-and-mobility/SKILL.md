...
```yaml
skill_id: u2910
skill_name: u2910-memory-consolidation-for-urban-planning-and-mobility
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for urban planning and mobility** before execution.
