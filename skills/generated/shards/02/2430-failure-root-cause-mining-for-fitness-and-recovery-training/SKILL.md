...
```yaml
skill_id: u2430
skill_name: u2430-failure-root-cause-mining-for-fitness-and-recovery-training
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for fitness and recovery training** before execution.
