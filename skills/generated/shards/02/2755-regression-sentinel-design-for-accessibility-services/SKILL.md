...
```yaml
skill_id: u2755
skill_name: u2755-regression-sentinel-design-for-accessibility-services
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for accessibility services** before execution.
