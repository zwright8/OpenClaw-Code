...
```yaml
skill_id: u2030
skill_name: u2030-tool-health-monitoring-for-fitness-and-recovery-training
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for fitness and recovery training** before execution.
