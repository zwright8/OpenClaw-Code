...
```yaml
skill_id: u2431
skill_name: u2431-failure-root-cause-mining-for-mental-well-being-practices
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for mental well being practices** before execution.
