...
```yaml
skill_id: u2213
skill_name: u2213-retry-and-backoff-orchestration-for-household-logistics
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **retry and backoff orchestration for household logistics** before execution.
