...
```yaml
skill_id: u2060
skill_name: u2060-tool-health-monitoring-for-product-management-execution
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for product management execution** before execution.
