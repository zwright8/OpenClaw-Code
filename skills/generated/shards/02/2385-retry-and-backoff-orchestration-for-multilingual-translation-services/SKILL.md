...
```yaml
skill_id: u2385
skill_name: u2385-retry-and-backoff-orchestration-for-multilingual-translation-services
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **retry and backoff orchestration for multilingual translation services** before execution.
