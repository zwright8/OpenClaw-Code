...
```yaml
skill_id: u2513
skill_name: u2513-failure-root-cause-mining-for-agriculture-and-food-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for agriculture and food systems** before execution.
