...
```yaml
skill_id: u2659
skill_name: u2659-regression-sentinel-design-for-product-management-execution
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for product management execution** before execution.
