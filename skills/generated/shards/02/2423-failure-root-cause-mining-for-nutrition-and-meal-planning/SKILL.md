...
```yaml
skill_id: u2423
skill_name: u2423-failure-root-cause-mining-for-nutrition-and-meal-planning
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for nutrition and meal planning** before execution.
