...
```yaml
skill_id: u2485
skill_name: u2485-failure-root-cause-mining-for-healthcare-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for healthcare operations** before execution.
