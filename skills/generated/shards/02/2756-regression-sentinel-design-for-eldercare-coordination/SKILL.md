...
```yaml
skill_id: u2756
skill_name: u2756-regression-sentinel-design-for-eldercare-coordination
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for eldercare coordination** before execution.
