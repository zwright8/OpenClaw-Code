...
```yaml
skill_id: u2561
skill_name: u2561-failure-root-cause-mining-for-childcare-support-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for childcare support systems** before execution.
