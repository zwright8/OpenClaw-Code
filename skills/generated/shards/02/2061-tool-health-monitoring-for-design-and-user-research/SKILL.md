...
```yaml
skill_id: u2061
skill_name: u2061-tool-health-monitoring-for-design-and-user-research
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for design and user research** before execution.
