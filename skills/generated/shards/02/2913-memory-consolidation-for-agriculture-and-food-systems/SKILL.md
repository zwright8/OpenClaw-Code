...
```yaml
skill_id: u2913
skill_name: u2913-memory-consolidation-for-agriculture-and-food-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for agriculture and food systems** before execution.
