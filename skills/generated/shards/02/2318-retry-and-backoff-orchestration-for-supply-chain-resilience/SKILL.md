...
```yaml
skill_id: u2318
skill_name: u2318-retry-and-backoff-orchestration-for-supply-chain-resilience
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **retry and backoff orchestration for supply chain resilience** before execution.
