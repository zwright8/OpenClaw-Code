...
```yaml
skill_id: u2547
skill_name: u2547-failure-root-cause-mining-for-civic-participation-platforms
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for civic participation platforms** before execution.
