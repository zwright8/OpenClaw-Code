...
```yaml
skill_id: u2585
skill_name: u2585-failure-root-cause-mining-for-multilingual-translation-services
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for multilingual translation services** before execution.
