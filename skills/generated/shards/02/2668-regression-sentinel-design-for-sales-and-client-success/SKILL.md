...
```yaml
skill_id: u2668
skill_name: u2668-regression-sentinel-design-for-sales-and-client-success
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for sales and client success** before execution.
