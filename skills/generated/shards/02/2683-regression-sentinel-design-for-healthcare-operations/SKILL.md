...
```yaml
skill_id: u2683
skill_name: u2683-regression-sentinel-design-for-healthcare-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for healthcare operations** before execution.
