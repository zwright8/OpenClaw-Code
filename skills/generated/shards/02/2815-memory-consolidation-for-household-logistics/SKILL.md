...
```yaml
skill_id: u2815
skill_name: u2815-memory-consolidation-for-household-logistics
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for household logistics** before execution.
