...
```yaml
skill_id: u2006
skill_name: u2006-tool-health-monitoring-for-family-caregiving-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for family caregiving systems** before execution.
