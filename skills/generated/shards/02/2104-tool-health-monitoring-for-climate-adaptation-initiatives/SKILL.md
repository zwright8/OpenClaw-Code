...
```yaml
skill_id: u2104
skill_name: u2104-tool-health-monitoring-for-climate-adaptation-initiatives
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for climate adaptation initiatives** before execution.
