...
```yaml
skill_id: u2949
skill_name: u2949-memory-consolidation-for-civic-participation-platforms
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for civic participation platforms** before execution.
