...
```yaml
skill_id: u2068
skill_name: u2068-tool-health-monitoring-for-sales-and-client-success
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for sales and client success** before execution.
