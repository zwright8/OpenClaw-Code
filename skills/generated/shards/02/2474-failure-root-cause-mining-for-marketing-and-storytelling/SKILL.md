...
```yaml
skill_id: u2474
skill_name: u2474-failure-root-cause-mining-for-marketing-and-storytelling
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for marketing and storytelling** before execution.
