...
```yaml
skill_id: u2137
skill_name: u2137-tool-health-monitoring-for-scientific-publishing-pipelines
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for scientific publishing pipelines** before execution.
