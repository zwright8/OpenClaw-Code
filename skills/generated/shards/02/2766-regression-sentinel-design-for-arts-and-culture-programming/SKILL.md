...
```yaml
skill_id: u2766
skill_name: u2766-regression-sentinel-design-for-arts-and-culture-programming
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for arts and culture programming** before execution.
