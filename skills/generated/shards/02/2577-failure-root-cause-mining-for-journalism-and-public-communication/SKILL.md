...
```yaml
skill_id: u2577
skill_name: u2577-failure-root-cause-mining-for-journalism-and-public-communication
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for journalism and public communication** before execution.
