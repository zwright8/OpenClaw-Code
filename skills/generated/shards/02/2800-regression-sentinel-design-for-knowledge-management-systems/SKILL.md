...
```yaml
skill_id: u2800
skill_name: u2800-regression-sentinel-design-for-knowledge-management-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for knowledge management systems** before execution.
