...
```yaml
skill_id: u2902
skill_name: u2902-memory-consolidation-for-climate-adaptation-initiatives
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for climate adaptation initiatives** before execution.
