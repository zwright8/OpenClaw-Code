...
```yaml
skill_id: u2540
skill_name: u2540-failure-root-cause-mining-for-scientific-publishing-pipelines
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for scientific publishing pipelines** before execution.
