...
```yaml
skill_id: u2005
skill_name: u2005-tool-health-monitoring-for-personal-health-routines
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for personal health routines** before execution.
