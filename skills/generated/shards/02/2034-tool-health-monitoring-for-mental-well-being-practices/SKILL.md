...
```yaml
skill_id: u2034
skill_name: u2034-tool-health-monitoring-for-mental-well-being-practices
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for mental well being practices** before execution.
