...
```yaml
skill_id: u2653
skill_name: u2653-regression-sentinel-design-for-software-engineering-delivery
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for software engineering delivery** before execution.
