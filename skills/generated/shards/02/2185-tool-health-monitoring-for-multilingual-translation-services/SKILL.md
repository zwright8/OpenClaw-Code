...
```yaml
skill_id: u2185
skill_name: u2185-tool-health-monitoring-for-multilingual-translation-services
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for multilingual translation services** before execution.
