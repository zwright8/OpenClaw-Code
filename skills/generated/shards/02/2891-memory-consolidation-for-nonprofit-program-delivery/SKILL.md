...
```yaml
skill_id: u2891
skill_name: u2891-memory-consolidation-for-nonprofit-program-delivery
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for nonprofit program delivery** before execution.
