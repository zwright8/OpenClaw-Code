...
```yaml
skill_id: u2709
skill_name: u2709-regression-sentinel-design-for-urban-planning-and-mobility
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for urban planning and mobility** before execution.
