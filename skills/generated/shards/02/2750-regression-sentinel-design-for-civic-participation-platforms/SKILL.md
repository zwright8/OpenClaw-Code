...
| Feature flag | `skill_02750_regression-sentinel-design` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Regression Sentinel Design for civic participation platforms under professional mastery conditions.
