...
```yaml
skill_id: u2520
skill_name: u2520-failure-root-cause-mining-for-supply-chain-resilience
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for supply chain resilience** before execution.
