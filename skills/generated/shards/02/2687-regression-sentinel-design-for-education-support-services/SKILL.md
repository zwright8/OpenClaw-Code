...
```yaml
skill_id: u2687
skill_name: u2687-regression-sentinel-design-for-education-support-services
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for education support services** before execution.
