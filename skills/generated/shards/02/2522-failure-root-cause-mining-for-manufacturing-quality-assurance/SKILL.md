...
| Feature flag | `skill_02522_failure-root-cause-mining` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Failure Root Cause Mining for manufacturing quality assurance under pro-humanity impact conditions.
