...
```yaml
skill_id: u2645
skill_name: u2645-regression-sentinel-design-for-career-development-pathways
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for career development pathways** before execution.
