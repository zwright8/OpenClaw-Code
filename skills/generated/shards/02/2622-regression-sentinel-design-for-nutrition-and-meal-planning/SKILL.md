...
```yaml
skill_id: u2622
skill_name: u2622-regression-sentinel-design-for-nutrition-and-meal-planning
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for nutrition and meal planning** before execution.
