...
```yaml
skill_id: u2117
skill_name: u2117-tool-health-monitoring-for-supply-chain-resilience
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for supply chain resilience** before execution.
