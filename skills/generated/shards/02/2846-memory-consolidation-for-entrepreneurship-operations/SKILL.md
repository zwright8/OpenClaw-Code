...
```yaml
skill_id: u2846
skill_name: u2846-memory-consolidation-for-entrepreneurship-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for entrepreneurship operations** before execution.
