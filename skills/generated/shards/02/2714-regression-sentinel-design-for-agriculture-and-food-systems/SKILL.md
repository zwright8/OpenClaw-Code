...
```yaml
skill_id: u2714
skill_name: u2714-regression-sentinel-design-for-agriculture-and-food-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for agriculture and food systems** before execution.
