...
```yaml
skill_id: u2728
skill_name: u2728-regression-sentinel-design-for-cybersecurity-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for cybersecurity operations** before execution.
