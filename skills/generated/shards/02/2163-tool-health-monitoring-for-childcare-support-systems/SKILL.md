...
```yaml
skill_id: u2163
skill_name: u2163-tool-health-monitoring-for-childcare-support-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for childcare support systems** before execution.
