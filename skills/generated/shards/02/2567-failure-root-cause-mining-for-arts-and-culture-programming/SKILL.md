---
name: u2567-failure-root-cause-mining-for-arts-and-culture-programming
description: Operate the "failure root cause mining for arts and culture programming" capability in production for failure root cause mining for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---

# failure root cause mining for arts and culture programming

## Why This Skill Exists
This skill hardens a generated capability for production execution so failure root cause mining for arts and culture programming workflows remain deterministic, auditable, and fail-closed under risk.

## When To Use
Use this skill only when the request explicitly needs `failure root cause mining for arts and culture programming` and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **failure root cause mining for arts and culture programming** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **arts and culture programming" capability in production for failure root cause mining for arts and culture programming workflows** with measurable acceptance criteria.
...
- **Daily:** Run when new arts and culture programming" capability in production for failure root cause mining for arts and culture programming workflows signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in arts and culture programming" capability in production for failure root cause mining for arts and culture programming workflows**
   - Input: noisy upstream payload requiring failure root cause mining for arts and culture programming normalization/assessment.
