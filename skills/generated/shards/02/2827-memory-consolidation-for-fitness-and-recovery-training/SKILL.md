...
```yaml
skill_id: u2827
skill_name: u2827-memory-consolidation-for-fitness-and-recovery-training
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for fitness and recovery training** before execution.
