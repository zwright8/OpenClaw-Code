...
```yaml
skill_id: u2627
skill_name: u2627-regression-sentinel-design-for-fitness-and-recovery-training
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for fitness and recovery training** before execution.
