---
name: u2559-failure-root-cause-mining-for-eldercare-coordination
description: Operate the "failure root cause mining for eldercare coordination" capability in production for failure root cause mining for eldercare coordination workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---

# failure root cause mining for eldercare coordination

## Why This Skill Exists
This skill hardens a generated capability for production execution so failure root cause mining for eldercare coordination workflows remain deterministic, auditable, and fail-closed under risk.

## When To Use
Use this skill only when the request explicitly needs `failure root cause mining for eldercare coordination` and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **failure root cause mining for eldercare coordination** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **eldercare coordination" capability in production for failure root cause mining for eldercare coordination workflows** with measurable acceptance criteria.
...
- **Daily:** Run when new eldercare coordination" capability in production for failure root cause mining for eldercare coordination workflows signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in eldercare coordination" capability in production for failure root cause mining for eldercare coordination workflows**
   - Input: noisy upstream payload requiring failure root cause mining for eldercare coordination normalization/assessment.
