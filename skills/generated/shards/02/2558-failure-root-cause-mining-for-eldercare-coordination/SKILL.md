...
```yaml
skill_id: u2558
skill_name: u2558-failure-root-cause-mining-for-eldercare-coordination
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for eldercare coordination** before execution.
