...
```yaml
skill_id: u2867
skill_name: u2867-memory-consolidation-for-sales-and-client-success
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for sales and client success** before execution.
