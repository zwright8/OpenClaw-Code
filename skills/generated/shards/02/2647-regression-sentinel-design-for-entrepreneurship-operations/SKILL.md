...
```yaml
skill_id: u2647
skill_name: u2647-regression-sentinel-design-for-entrepreneurship-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for entrepreneurship operations** before execution.
