...
```yaml
skill_id: u2587
skill_name: u2587-failure-root-cause-mining-for-remote-team-collaboration
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for remote team collaboration** before execution.
