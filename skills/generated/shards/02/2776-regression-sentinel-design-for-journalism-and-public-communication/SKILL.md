...
```yaml
skill_id: u2776
skill_name: u2776-regression-sentinel-design-for-journalism-and-public-communication
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for journalism and public communication** before execution.
