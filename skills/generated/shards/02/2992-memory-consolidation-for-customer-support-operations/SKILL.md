...
```yaml
skill_id: u2992
skill_name: u2992-memory-consolidation-for-customer-support-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for customer support operations** before execution.
