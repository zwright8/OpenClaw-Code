...
```yaml
skill_id: u2602
skill_name: u2602-regression-sentinel-design-for-personal-health-routines
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for personal health routines** before execution.
