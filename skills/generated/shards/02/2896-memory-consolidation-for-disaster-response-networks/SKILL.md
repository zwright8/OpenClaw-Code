...
```yaml
skill_id: u2896
skill_name: u2896-memory-consolidation-for-disaster-response-networks
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for disaster response networks** before execution.
