...
```yaml
skill_id: u2955
skill_name: u2955-memory-consolidation-for-accessibility-services
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for accessibility services** before execution.
