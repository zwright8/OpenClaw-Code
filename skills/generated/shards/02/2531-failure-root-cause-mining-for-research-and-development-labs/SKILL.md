...
```yaml
skill_id: u2531
skill_name: u2531-failure-root-cause-mining-for-research-and-development-labs
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for research and development labs** before execution.
