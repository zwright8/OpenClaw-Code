...
```yaml
skill_id: u2781
skill_name: u2781-regression-sentinel-design-for-multilingual-translation-services
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for multilingual translation services** before execution.
