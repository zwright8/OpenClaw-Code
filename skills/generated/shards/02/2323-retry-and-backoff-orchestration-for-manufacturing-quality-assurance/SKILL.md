...
```yaml
skill_id: u2323
skill_name: u2323-retry-and-backoff-orchestration-for-manufacturing-quality-assurance
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **retry and backoff orchestration for manufacturing quality assurance** before execution.
