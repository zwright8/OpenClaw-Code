...
```yaml
skill_id: u2614
skill_name: u2614-regression-sentinel-design-for-household-logistics
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for household logistics** before execution.
