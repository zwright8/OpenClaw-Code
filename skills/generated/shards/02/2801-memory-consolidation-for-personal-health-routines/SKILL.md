...
```yaml
skill_id: u2801
skill_name: u2801-memory-consolidation-for-personal-health-routines
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for personal health routines** before execution.
