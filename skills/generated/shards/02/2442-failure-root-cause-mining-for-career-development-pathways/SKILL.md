...
```yaml
skill_id: u2442
skill_name: u2442-failure-root-cause-mining-for-career-development-pathways
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for career development pathways** before execution.
