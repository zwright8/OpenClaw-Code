...
```yaml
skill_id: u2406
skill_name: u2406-failure-root-cause-mining-for-family-caregiving-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for family caregiving systems** before execution.
