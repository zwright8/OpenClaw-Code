...
```yaml
skill_id: u2617
skill_name: u2617-regression-sentinel-design-for-personal-finance-management
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for personal finance management** before execution.
