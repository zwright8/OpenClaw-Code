...
```yaml
skill_id: u2748
skill_name: u2748-regression-sentinel-design-for-civic-participation-platforms
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for civic participation platforms** before execution.
