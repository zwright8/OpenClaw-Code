...
```yaml
skill_id: u2486
skill_name: u2486-failure-root-cause-mining-for-education-support-services
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for education support services** before execution.
