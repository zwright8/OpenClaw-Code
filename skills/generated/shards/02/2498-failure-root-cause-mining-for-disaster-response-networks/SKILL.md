...
```yaml
skill_id: u2498
skill_name: u2498-failure-root-cause-mining-for-disaster-response-networks
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for disaster response networks** before execution.
