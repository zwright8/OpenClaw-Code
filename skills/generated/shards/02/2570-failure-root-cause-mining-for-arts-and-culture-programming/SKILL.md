...
```yaml
skill_id: u2570
skill_name: u2570-failure-root-cause-mining-for-arts-and-culture-programming
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for arts and culture programming** before execution.
