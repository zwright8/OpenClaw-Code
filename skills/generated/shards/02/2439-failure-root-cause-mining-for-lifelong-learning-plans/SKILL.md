...
```yaml
skill_id: u2439
skill_name: u2439-failure-root-cause-mining-for-lifelong-learning-plans
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for lifelong learning plans** before execution.
