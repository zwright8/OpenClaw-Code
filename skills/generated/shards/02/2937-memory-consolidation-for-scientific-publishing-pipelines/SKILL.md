...
```yaml
skill_id: u2937
skill_name: u2937-memory-consolidation-for-scientific-publishing-pipelines
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for scientific publishing pipelines** before execution.
