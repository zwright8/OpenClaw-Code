...
```yaml
skill_id: u2504
skill_name: u2504-failure-root-cause-mining-for-climate-adaptation-initiatives
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for climate adaptation initiatives** before execution.
