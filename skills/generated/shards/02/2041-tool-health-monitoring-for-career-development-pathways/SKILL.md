...
```yaml
skill_id: u2041
skill_name: u2041-tool-health-monitoring-for-career-development-pathways
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for career development pathways** before execution.
