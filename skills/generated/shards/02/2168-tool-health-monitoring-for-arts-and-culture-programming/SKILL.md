...
```yaml
skill_id: u2168
skill_name: u2168-tool-health-monitoring-for-arts-and-culture-programming
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for arts and culture programming** before execution.
