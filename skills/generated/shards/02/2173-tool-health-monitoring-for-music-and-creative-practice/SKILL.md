...
```yaml
skill_id: u2173
skill_name: u2173-tool-health-monitoring-for-music-and-creative-practice
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for music and creative practice** before execution.
