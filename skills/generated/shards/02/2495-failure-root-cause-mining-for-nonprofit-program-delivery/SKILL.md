...
```yaml
skill_id: u2495
skill_name: u2495-failure-root-cause-mining-for-nonprofit-program-delivery
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for nonprofit program delivery** before execution.
