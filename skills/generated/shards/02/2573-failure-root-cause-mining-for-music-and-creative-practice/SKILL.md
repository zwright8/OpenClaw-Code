...
```yaml
skill_id: u2573
skill_name: u2573-failure-root-cause-mining-for-music-and-creative-practice
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for music and creative practice** before execution.
