...
```yaml
skill_id: u2541
skill_name: u2541-failure-root-cause-mining-for-community-mediation-programs
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for community mediation programs** before execution.
