...
```yaml
skill_id: u2177
skill_name: u2177-tool-health-monitoring-for-journalism-and-public-communication
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for journalism and public communication** before execution.
