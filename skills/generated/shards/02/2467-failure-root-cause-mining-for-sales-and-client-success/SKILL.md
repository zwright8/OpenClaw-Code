...
```yaml
skill_id: u2467
skill_name: u2467-failure-root-cause-mining-for-sales-and-client-success
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for sales and client success** before execution.
