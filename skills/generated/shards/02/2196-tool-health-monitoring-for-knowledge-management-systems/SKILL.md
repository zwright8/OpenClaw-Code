...
```yaml
skill_id: u2196
skill_name: u2196-tool-health-monitoring-for-knowledge-management-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for knowledge management systems** before execution.
