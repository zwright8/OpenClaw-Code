---
name: u02062-tool-health-monitoring-for-design-and-user-research
...
| Feature flag | `skill_02062_tool-health-monitoring` |
| Release cycles | `2` |

## Why This Skill Exists
Use tool health monitoring in design and user research with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Tool Health Monitoring for design and user research under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Tool Health Monitoring for design and user research under pro-humanity impact conditions.
