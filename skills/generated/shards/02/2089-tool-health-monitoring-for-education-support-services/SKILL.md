...
```yaml
skill_id: u2089
skill_name: u2089-tool-health-monitoring-for-education-support-services
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for education support services** before execution.
