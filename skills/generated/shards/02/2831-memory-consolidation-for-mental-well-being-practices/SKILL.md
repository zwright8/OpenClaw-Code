...
```yaml
skill_id: u2831
skill_name: u2831-memory-consolidation-for-mental-well-being-practices
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for mental well being practices** before execution.
