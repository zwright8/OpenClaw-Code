...
```yaml
skill_id: u2508
skill_name: u2508-failure-root-cause-mining-for-urban-planning-and-mobility
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for urban planning and mobility** before execution.
