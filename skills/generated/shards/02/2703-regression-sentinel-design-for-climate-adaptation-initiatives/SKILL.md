...
```yaml
skill_id: u2703
skill_name: u2703-regression-sentinel-design-for-climate-adaptation-initiatives
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for climate adaptation initiatives** before execution.
