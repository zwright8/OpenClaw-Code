...
```yaml
skill_id: u2552
skill_name: u2552-failure-root-cause-mining-for-accessibility-services
shard_lane: "02"
operation: failure root cause mining
...
## Musts
- Must verify the request truly requires **failure root cause mining for accessibility services** before execution.
