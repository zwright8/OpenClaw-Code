...
```yaml
skill_id: u2015
skill_name: u2015-tool-health-monitoring-for-household-logistics
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for household logistics** before execution.
