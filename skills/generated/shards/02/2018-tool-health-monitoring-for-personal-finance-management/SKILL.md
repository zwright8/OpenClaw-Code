...
```yaml
skill_id: u2018
skill_name: u2018-tool-health-monitoring-for-personal-finance-management
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for personal finance management** before execution.
