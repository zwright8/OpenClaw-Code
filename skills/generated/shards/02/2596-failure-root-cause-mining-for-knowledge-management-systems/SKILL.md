...
```yaml
skill_id: u2596
skill_name: u2596-failure-root-cause-mining-for-knowledge-management-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for knowledge management systems** before execution.
