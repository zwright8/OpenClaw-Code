...
```yaml
skill_id: u2976
skill_name: u2976-memory-consolidation-for-journalism-and-public-communication
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for journalism and public communication** before execution.
