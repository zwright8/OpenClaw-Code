...
```yaml
skill_id: u2740
skill_name: u2740-regression-sentinel-design-for-scientific-publishing-pipelines
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for scientific publishing pipelines** before execution.
