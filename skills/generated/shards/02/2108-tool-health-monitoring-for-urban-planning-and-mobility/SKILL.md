---
name: u2108-tool-health-monitoring-for-urban-planning-and-mobility
...
This skill hardens a generated capability for production execution so tool health monitoring for urban planning and mobility workflows remain deterministic, auditable, and fail-closed under risk.

## When To Use
Use this skill only when the request explicitly needs `tool health monitoring for urban planning and mobility` and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **tool health monitoring for urban planning and mobility** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **urban planning and mobility" capability in production for tool health monitoring for urban planning and mobility workflows** with measurable acceptance criteria.
...
- **Daily:** Run when new urban planning and mobility" capability in production for tool health monitoring for urban planning and mobility workflows signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in urban planning and mobility" capability in production for tool health monitoring for urban planning and mobility workflows**
   - Input: noisy upstream payload requiring tool health monitoring for urban planning and mobility normalization/assessment.
