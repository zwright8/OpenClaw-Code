...
```yaml
skill_id: u2606
skill_name: u2606-regression-sentinel-design-for-family-caregiving-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for family caregiving systems** before execution.
