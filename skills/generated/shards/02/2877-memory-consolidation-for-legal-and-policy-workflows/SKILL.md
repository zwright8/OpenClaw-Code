...
```yaml
skill_id: u2877
skill_name: u2877-memory-consolidation-for-legal-and-policy-workflows
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for legal and policy workflows** before execution.
