---
name: u02877-memory-consolidation-for-legal-and-policy-workflows
...
| Feature flag | `skill_02877_memory-consolidation` |
| Release cycles | `2` |

## Why This Skill Exists
Use memory consolidation in legal and policy workflows with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Memory Consolidation for legal and policy workflows under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Memory Consolidation for legal and policy workflows under pro-humanity impact conditions.
