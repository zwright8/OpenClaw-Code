...
```yaml
skill_id: u2337
skill_name: u2337-retry-and-backoff-orchestration-for-scientific-publishing-pipelines
shard_lane: "02"
operation: retry and backoff orchestration
...
## Musts
- Must verify the request truly requires **retry and backoff orchestration for scientific publishing pipelines** before execution.
