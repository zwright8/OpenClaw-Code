...
```yaml
skill_id: u2662
skill_name: u2662-regression-sentinel-design-for-design-and-user-research
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for design and user research** before execution.
