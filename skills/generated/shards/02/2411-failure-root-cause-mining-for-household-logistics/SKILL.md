...
```yaml
skill_id: u2411
skill_name: u2411-failure-root-cause-mining-for-household-logistics
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for household logistics** before execution.
