...
```yaml
skill_id: u2460
skill_name: u2460-failure-root-cause-mining-for-product-management-execution
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for product management execution** before execution.
