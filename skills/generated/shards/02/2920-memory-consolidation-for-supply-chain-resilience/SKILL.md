...
```yaml
skill_id: u2920
skill_name: u2920-memory-consolidation-for-supply-chain-resilience
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for supply chain resilience** before execution.
