...
```yaml
skill_id: u2928
skill_name: u2928-memory-consolidation-for-cybersecurity-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for cybersecurity operations** before execution.
