...
```yaml
skill_id: u2638
skill_name: u2638-regression-sentinel-design-for-lifelong-learning-plans
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for lifelong learning plans** before execution.
