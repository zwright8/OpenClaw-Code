...
```yaml
skill_id: u2969
skill_name: u2969-memory-consolidation-for-arts-and-culture-programming
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for arts and culture programming** before execution.
