...
```yaml
skill_id: u2000
skill_name: u2000-handoff-contracting-for-knowledge-management-systems
shard_lane: "02"
operation: handoff contracting
...
## Musts
- Must verify the request truly requires **handoff contracting for knowledge management systems** before execution.
