...
```yaml
skill_id: u2054
skill_name: u2054-tool-health-monitoring-for-software-engineering-delivery
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for software engineering delivery** before execution.
