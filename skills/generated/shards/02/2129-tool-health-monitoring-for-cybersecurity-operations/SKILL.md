...
```yaml
skill_id: u2129
skill_name: u2129-tool-health-monitoring-for-cybersecurity-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for cybersecurity operations** before execution.
