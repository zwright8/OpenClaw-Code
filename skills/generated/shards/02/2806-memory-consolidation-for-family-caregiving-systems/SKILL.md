...
```yaml
skill_id: u2806
skill_name: u2806-memory-consolidation-for-family-caregiving-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for family caregiving systems** before execution.
