...
```yaml
skill_id: u2680
skill_name: u2680-regression-sentinel-design-for-legal-and-policy-workflows
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for legal and policy workflows** before execution.
