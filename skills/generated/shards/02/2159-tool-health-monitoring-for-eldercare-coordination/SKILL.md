...
```yaml
skill_id: u2159
skill_name: u2159-tool-health-monitoring-for-eldercare-coordination
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for eldercare coordination** before execution.
