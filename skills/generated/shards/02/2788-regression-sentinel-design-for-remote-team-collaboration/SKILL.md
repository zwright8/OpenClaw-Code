...
```yaml
skill_id: u2788
skill_name: u2788-regression-sentinel-design-for-remote-team-collaboration
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for remote team collaboration** before execution.
