...
```yaml
skill_id: u2133
skill_name: u2133-tool-health-monitoring-for-research-and-development-labs
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for research and development labs** before execution.
