...
```yaml
skill_id: u2733
skill_name: u2733-regression-sentinel-design-for-research-and-development-labs
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for research and development labs** before execution.
