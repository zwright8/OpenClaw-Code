...
```yaml
skill_id: u2858
skill_name: u2858-memory-consolidation-for-product-management-execution
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for product management execution** before execution.
