...
```yaml
skill_id: u2840
skill_name: u2840-memory-consolidation-for-lifelong-learning-plans
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for lifelong learning plans** before execution.
