...
```yaml
skill_id: u2691
skill_name: u2691-regression-sentinel-design-for-nonprofit-program-delivery
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for nonprofit program delivery** before execution.
