...
```yaml
skill_id: u2822
skill_name: u2822-memory-consolidation-for-nutrition-and-meal-planning
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for nutrition and meal planning** before execution.
