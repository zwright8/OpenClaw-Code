...
```yaml
skill_id: u2403
skill_name: u2403-failure-root-cause-mining-for-personal-health-routines
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for personal health routines** before execution.
