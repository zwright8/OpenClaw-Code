...
```yaml
skill_id: u2890
skill_name: u2890-memory-consolidation-for-education-support-services
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for education support services** before execution.
