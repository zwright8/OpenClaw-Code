...
```yaml
skill_id: u2924
skill_name: u2924-memory-consolidation-for-manufacturing-quality-assurance
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for manufacturing quality assurance** before execution.
