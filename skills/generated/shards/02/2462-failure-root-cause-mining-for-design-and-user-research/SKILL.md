...
```yaml
skill_id: u2462
skill_name: u2462-failure-root-cause-mining-for-design-and-user-research
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for design and user research** before execution.
