...
```yaml
skill_id: u2194
skill_name: u2194-tool-health-monitoring-for-customer-support-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for customer support operations** before execution.
