...
```yaml
skill_id: u2150
skill_name: u2150-tool-health-monitoring-for-civic-participation-platforms
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for civic participation platforms** before execution.
