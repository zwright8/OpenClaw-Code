...
```yaml
skill_id: u2963
skill_name: u2963-memory-consolidation-for-childcare-support-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for childcare support systems** before execution.
