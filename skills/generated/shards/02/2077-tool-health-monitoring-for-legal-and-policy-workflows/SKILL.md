...
```yaml
skill_id: u2077
skill_name: u2077-tool-health-monitoring-for-legal-and-policy-workflows
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for legal and policy workflows** before execution.
