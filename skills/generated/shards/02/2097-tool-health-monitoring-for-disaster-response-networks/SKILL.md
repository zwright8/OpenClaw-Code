...
| Feature flag | `skill_02097_tool-health-monitoring` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Tool Health Monitoring for disaster response networks under pro-humanity impact conditions.
