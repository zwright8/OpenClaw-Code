...
```yaml
skill_id: u2084
skill_name: u2084-tool-health-monitoring-for-healthcare-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for healthcare operations** before execution.
