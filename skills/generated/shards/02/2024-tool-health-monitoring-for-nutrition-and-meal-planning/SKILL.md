...
```yaml
skill_id: u2024
skill_name: u2024-tool-health-monitoring-for-nutrition-and-meal-planning
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for nutrition and meal planning** before execution.
