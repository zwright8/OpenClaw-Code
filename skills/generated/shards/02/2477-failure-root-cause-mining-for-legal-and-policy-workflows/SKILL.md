...
```yaml
skill_id: u2477
skill_name: u2477-failure-root-cause-mining-for-legal-and-policy-workflows
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for legal and policy workflows** before execution.
