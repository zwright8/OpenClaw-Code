...
```yaml
skill_id: u2975
skill_name: u2975-memory-consolidation-for-music-and-creative-practice
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for music and creative practice** before execution.
