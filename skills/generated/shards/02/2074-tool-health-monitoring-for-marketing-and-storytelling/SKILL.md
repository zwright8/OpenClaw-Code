...
```yaml
skill_id: u2074
skill_name: u2074-tool-health-monitoring-for-marketing-and-storytelling
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for marketing and storytelling** before execution.
