...
```yaml
skill_id: u2842
skill_name: u2842-memory-consolidation-for-career-development-pathways
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for career development pathways** before execution.
