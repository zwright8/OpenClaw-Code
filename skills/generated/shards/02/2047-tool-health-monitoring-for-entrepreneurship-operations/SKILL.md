...
```yaml
skill_id: u2047
skill_name: u2047-tool-health-monitoring-for-entrepreneurship-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for entrepreneurship operations** before execution.
