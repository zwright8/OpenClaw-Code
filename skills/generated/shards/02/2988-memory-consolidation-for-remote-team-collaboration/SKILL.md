...
```yaml
skill_id: u2988
skill_name: u2988-memory-consolidation-for-remote-team-collaboration
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for remote team collaboration** before execution.
