...
```yaml
skill_id: u2725
skill_name: u2725-regression-sentinel-design-for-manufacturing-quality-assurance
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for manufacturing quality assurance** before execution.
