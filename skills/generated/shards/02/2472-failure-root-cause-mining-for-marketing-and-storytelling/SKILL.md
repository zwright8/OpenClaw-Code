---
name: u2472-failure-root-cause-mining-for-marketing-and-storytelling
description: Operate the "failure root cause mining for marketing and storytelling" capability in production for failure root cause mining for marketing and storytelling workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---

# failure root cause mining for marketing and storytelling

## Why This Skill Exists
This skill hardens a generated capability for production execution so failure root cause mining for marketing and storytelling workflows remain deterministic, auditable, and fail-closed under risk.

## When To Use
Use this skill only when the request explicitly needs `failure root cause mining for marketing and storytelling` and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **failure root cause mining for marketing and storytelling** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **marketing and storytelling" capability in production for failure root cause mining for marketing and storytelling workflows** with measurable acceptance criteria.
...
- **Daily:** Run when new marketing and storytelling" capability in production for failure root cause mining for marketing and storytelling workflows signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in marketing and storytelling" capability in production for failure root cause mining for marketing and storytelling workflows**
   - Input: noisy upstream payload requiring failure root cause mining for marketing and storytelling normalization/assessment.
