...
```yaml
skill_id: u2416
skill_name: u2416-failure-root-cause-mining-for-personal-finance-management
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for personal finance management** before execution.
