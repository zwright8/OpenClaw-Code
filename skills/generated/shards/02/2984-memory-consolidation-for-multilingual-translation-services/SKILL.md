...
```yaml
skill_id: u2984
skill_name: u2984-memory-consolidation-for-multilingual-translation-services
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for multilingual translation services** before execution.
