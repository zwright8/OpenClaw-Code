...
```yaml
skill_id: u2142
skill_name: u2142-tool-health-monitoring-for-community-mediation-programs
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for community mediation programs** before execution.
