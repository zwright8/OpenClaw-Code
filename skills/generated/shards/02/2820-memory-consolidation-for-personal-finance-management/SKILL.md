...
```yaml
skill_id: u2820
skill_name: u2820-memory-consolidation-for-personal-finance-management
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for personal finance management** before execution.
