...
| Feature flag | `skill_02514_failure-root-cause-mining` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Failure Root Cause Mining for agriculture and food systems under hyper-productive autonomy conditions.
