...
```yaml
skill_id: u2933
skill_name: u2933-memory-consolidation-for-research-and-development-labs
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for research and development labs** before execution.
