...
```yaml
skill_id: u2096
skill_name: u2096-tool-health-monitoring-for-disaster-response-networks
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for disaster response networks** before execution.
