...
```yaml
skill_id: u2450
skill_name: u2450-failure-root-cause-mining-for-entrepreneurship-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for entrepreneurship operations** before execution.
