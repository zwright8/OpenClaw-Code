...
```yaml
skill_id: u2123
skill_name: u2123-tool-health-monitoring-for-manufacturing-quality-assurance
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for manufacturing quality assurance** before execution.
