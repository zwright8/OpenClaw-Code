...
```yaml
skill_id: u2633
skill_name: u2633-regression-sentinel-design-for-mental-well-being-practices
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for mental well being practices** before execution.
