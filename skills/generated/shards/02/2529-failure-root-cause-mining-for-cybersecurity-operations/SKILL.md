...
```yaml
skill_id: u2529
skill_name: u2529-failure-root-cause-mining-for-cybersecurity-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for cybersecurity operations** before execution.
