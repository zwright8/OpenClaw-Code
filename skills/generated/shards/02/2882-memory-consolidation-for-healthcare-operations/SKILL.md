...
```yaml
skill_id: u2882
skill_name: u2882-memory-consolidation-for-healthcare-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for healthcare operations** before execution.
