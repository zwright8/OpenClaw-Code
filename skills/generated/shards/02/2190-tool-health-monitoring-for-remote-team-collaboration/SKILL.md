...
```yaml
skill_id: u2190
skill_name: u2190-tool-health-monitoring-for-remote-team-collaboration
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for remote team collaboration** before execution.
