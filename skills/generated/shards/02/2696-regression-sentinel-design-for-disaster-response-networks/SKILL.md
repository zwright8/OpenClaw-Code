...
```yaml
skill_id: u2696
skill_name: u2696-regression-sentinel-design-for-disaster-response-networks
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for disaster response networks** before execution.
