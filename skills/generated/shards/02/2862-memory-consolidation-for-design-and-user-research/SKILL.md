...
```yaml
skill_id: u2862
skill_name: u2862-memory-consolidation-for-design-and-user-research
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for design and user research** before execution.
