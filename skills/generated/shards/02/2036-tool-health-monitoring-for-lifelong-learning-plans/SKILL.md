...
```yaml
skill_id: u2036
skill_name: u2036-tool-health-monitoring-for-lifelong-learning-plans
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for lifelong learning plans** before execution.
