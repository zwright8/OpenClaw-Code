...
```yaml
skill_id: u2941
skill_name: u2941-memory-consolidation-for-community-mediation-programs
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for community mediation programs** before execution.
