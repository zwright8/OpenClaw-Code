...
```yaml
skill_id: u2852
skill_name: u2852-memory-consolidation-for-software-engineering-delivery
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for software engineering delivery** before execution.
