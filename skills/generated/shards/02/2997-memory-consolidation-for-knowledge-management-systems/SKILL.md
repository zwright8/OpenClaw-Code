...
```yaml
skill_id: u2997
skill_name: u2997-memory-consolidation-for-knowledge-management-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for knowledge management systems** before execution.
