---
name: u02281-retry-and-backoff-orchestration-for-healthcare-operations
...
| Feature flag | `skill_02281_retry-and-backoff-orchestratio` |
| Release cycles | `2` |

## Why This Skill Exists
Use retry and backoff orchestration in healthcare operations with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Retry And Backoff Orchestration for healthcare operations under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Retry And Backoff Orchestration for healthcare operations under maximally truth-seeking conditions.
