...
```yaml
skill_id: u2673
skill_name: u2673-regression-sentinel-design-for-marketing-and-storytelling
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **regression sentinel design for marketing and storytelling** before execution.
