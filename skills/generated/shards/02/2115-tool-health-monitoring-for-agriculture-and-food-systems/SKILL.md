...
```yaml
skill_id: u2115
skill_name: u2115-tool-health-monitoring-for-agriculture-and-food-systems
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **tool health monitoring for agriculture and food systems** before execution.
