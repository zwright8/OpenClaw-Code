...
| Feature flag | `skill_02746_regression-sentinel-design` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Regression Sentinel Design for civic participation platforms under maximally truth-seeking conditions.
