...
```yaml
skill_id: u2956
skill_name: u2956-memory-consolidation-for-eldercare-coordination
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **memory consolidation for eldercare coordination** before execution.
