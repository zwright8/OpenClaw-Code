...
```yaml
skill_id: u2594
skill_name: u2594-failure-root-cause-mining-for-customer-support-operations
shard_lane: "02"
...
## Musts
- Must verify the request truly requires **failure root cause mining for customer support operations** before execution.
