...
## Metadata
- skill_id: `u07604-personal-habit-optimization-for-personal-health-routines`
- capability: `Personal Habit Optimization for personal health routines`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for personal health routines` in `personal health routines`.
