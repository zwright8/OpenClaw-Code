...
## When To Use
Use this skill only when the request explicitly needs `Continuous Improvement Planning for childcare support systems` in childcare support systems and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for childcare support systems** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **childcare support systems" capability for childcare support systems** with measurable acceptance criteria.
...
- **Daily:** Run when new childcare support systems" capability for childcare support systems signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in childcare support systems" capability for childcare support systems**
   - Input: noisy upstream payload requiring continuous improvement planning for childcare support systems normalization/assessment.
