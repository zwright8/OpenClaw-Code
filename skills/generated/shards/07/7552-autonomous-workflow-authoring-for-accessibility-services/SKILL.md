...
## Metadata
- skill_id: `u07552-autonomous-workflow-authoring-for-accessibility-services`
- capability: `Autonomous Workflow Authoring for accessibility services`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for accessibility services` in `accessibility services`.
