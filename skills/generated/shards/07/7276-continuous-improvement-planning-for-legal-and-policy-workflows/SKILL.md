...
## Metadata
- skill_id: `u07276-continuous-improvement-planning-for-legal-and-policy-workflows`
- capability: `Continuous Improvement Planning for legal and policy workflows`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for legal and policy workflows` in `legal and policy workflows`.
