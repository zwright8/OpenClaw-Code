...
## Metadata
- skill_id: `u07883-attention-management-architecture-for-healthcare-operations`
- capability: `Attention Management Architecture for healthcare operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for healthcare operations` in `healthcare operations`.
