...
## Trigger Checklist
- [ ] The request explicitly needs **Attention Management Architecture for healthcare operations** outcomes (not generic brainstorming).
...
1. **Incident stabilization in healthcare operations" capability in production for healthcare operations workflows**
   - Input: noisy upstream payload requiring attention management architecture for healthcare operations normalization/assessment.
...
## Handoff Contract
- Produces: `Attention Management Architecture for healthcare operations` execution artifacts + scorecard + risk/confidence metadata.
