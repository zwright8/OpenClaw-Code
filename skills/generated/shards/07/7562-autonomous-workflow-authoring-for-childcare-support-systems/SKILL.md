...
## When To Use
Use this skill only when the request explicitly needs `Autonomous Workflow Authoring for childcare support systems` in childcare support systems and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Autonomous Workflow Authoring for childcare support systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in childcare support systems" capability for childcare support systems**
   - Input: noisy upstream payload requiring autonomous workflow authoring for childcare support systems normalization/assessment.
