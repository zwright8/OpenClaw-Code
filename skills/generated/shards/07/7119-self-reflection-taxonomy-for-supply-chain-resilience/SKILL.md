...
## Metadata
- skill_id: `u07119-self-reflection-taxonomy-for-supply-chain-resilience`
- capability: `Self-reflection taxonomy for supply chain resilience`
...
## Musts
- [ ] Confirm the request explicitly matches `Self-reflection taxonomy for supply chain resilience` in `supply chain resilience`.
