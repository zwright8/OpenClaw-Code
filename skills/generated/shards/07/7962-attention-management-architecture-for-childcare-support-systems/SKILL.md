...
## Metadata
- skill_id: `u07962-attention-management-architecture-for-childcare-support-systems`
- capability: `Attention Management Architecture for childcare support systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for childcare support systems` in `childcare support systems`.
