...
## Metadata
- skill_id: `u07305-continuous-improvement-planning-for-climate-adaptation-initiatives`
- capability: `Continuous Improvement Planning for climate adaptation initiatives`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for climate adaptation initiatives` in `climate adaptation initiatives`.
