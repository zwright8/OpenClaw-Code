...
## Metadata
- skill_id: `u07110-self-reflection-taxonomy-for-urban-planning-and-mobility`
- capability: `Self-reflection taxonomy for urban planning and mobility`
...
## Musts
- [ ] Confirm the request explicitly matches `Self-reflection taxonomy for urban planning and mobility` in `urban planning and mobility`.
