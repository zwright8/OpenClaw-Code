...
## When To Use
Use this skill only when the request explicitly needs `Autonomous Workflow Authoring for supply chain resilience` in supply chain resilience and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Autonomous Workflow Authoring for supply chain resilience** outcomes (not generic brainstorming).
...
1. **Incident stabilization in supply chain resilience" capability for supply chain resilience**
   - Input: noisy upstream payload requiring autonomous workflow authoring for supply chain resilience normalization/assessment.
