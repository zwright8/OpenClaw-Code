...
## Metadata
- skill_id: `u07516-autonomous-workflow-authoring-for-supply-chain-resilience`
- capability: `Autonomous Workflow Authoring for supply chain resilience`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for supply chain resilience` in `supply chain resilience`.
