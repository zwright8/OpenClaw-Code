...
## Metadata
- skill_id: `u07542-autonomous-workflow-authoring-for-community-mediation-programs`
- capability: `Autonomous Workflow Authoring for community mediation programs`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for community mediation programs` in `community mediation programs`.
