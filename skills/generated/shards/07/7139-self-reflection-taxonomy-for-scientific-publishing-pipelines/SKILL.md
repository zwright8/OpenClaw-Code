...
## Metadata
- skill_id: `u07139-self-reflection-taxonomy-for-scientific-publishing-pipelines`
- capability: `Self-reflection taxonomy for scientific publishing pipelines`
...
## Musts
- [ ] Confirm the request explicitly matches `Self-reflection taxonomy for scientific publishing pipelines` in `scientific publishing pipelines`.
