...
## Metadata
- skill_id: `u07073-self-reflection-taxonomy-for-marketing-and-storytelling`
- capability: `Self reflection taxonomy for marketing and storytelling`
...
## Musts
- [ ] Confirm the request explicitly matches `Self reflection taxonomy for marketing and storytelling` in `marketing and storytelling`.
