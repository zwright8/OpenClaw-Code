...
## Metadata
- skill_id: `u07679-personal-habit-optimization-for-legal-and-policy-workflows`
- capability: `Personal Habit Optimization for legal and policy workflows`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for legal and policy workflows` in `legal and policy workflows`.
