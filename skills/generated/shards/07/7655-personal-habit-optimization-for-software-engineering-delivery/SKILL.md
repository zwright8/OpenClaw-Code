...
## When To Use
Use this skill only when the request explicitly needs `Personal Habit Optimization for software engineering delivery` in software engineering delivery and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Personal Habit Optimization for software engineering delivery** outcomes (not generic brainstorming).
...
1. **Incident stabilization in software engineering delivery" capability for software engineering delivery**
   - Input: noisy upstream payload requiring personal habit optimization for software engineering delivery normalization/assessment.
