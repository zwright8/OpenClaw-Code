...
## Metadata
- skill_id: `u07485-autonomous-workflow-authoring-for-healthcare-operations`
- capability: `Autonomous Workflow Authoring for healthcare operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for healthcare operations` in `healthcare operations`.
