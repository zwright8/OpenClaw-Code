...
description: Build and operate the "Continuous Improvement Planning for agriculture and food systems" capability for agriculture and food systems. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for agriculture and food systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in agriculture and food systems" capability for agriculture and food systems**
   - Input: noisy upstream payload requiring continuous improvement planning for agriculture and food systems normalization/assessment.
...
## Handoff Contract
- Produces: `Continuous Improvement Planning for agriculture and food systems` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **agriculture and food systems" capability for agriculture and food systems** depends on **Continuous Improvement Planning for agriculture and food systems** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
