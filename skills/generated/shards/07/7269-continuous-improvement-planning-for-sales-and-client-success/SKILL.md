...
This skill hardens a generated capability for production execution so sales and client success workflows remain deterministic, auditable, and fail-closed under risk.

## When To Use
Use this skill only when the request explicitly needs `Continuous Improvement Planning for sales and client success` in sales and client success and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for sales and client success** outcomes (not generic brainstorming).
...
1. **Incident stabilization in sales and client success" capability for sales and client success**
   - Input: noisy upstream payload requiring continuous improvement planning for sales and client success normalization/assessment.
