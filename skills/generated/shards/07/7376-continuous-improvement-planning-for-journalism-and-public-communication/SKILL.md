...
## Metadata
- skill_id: `u07376-continuous-improvement-planning-for-journalism-and-public-communication`
- capability: `Continuous Improvement Planning for journalism and public communication`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for journalism and public communication` in `journalism and public communication`.
