...
## Metadata
- skill_id: `u07556-autonomous-workflow-authoring-for-eldercare-coordination`
- capability: `Autonomous Workflow Authoring for eldercare coordination`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for eldercare coordination` in `eldercare coordination`.
