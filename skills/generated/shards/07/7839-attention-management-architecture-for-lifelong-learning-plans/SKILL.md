...
## Metadata
- skill_id: `u07839-attention-management-architecture-for-lifelong-learning-plans`
- capability: `Attention Management Architecture for lifelong learning plans`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for lifelong learning plans` in `lifelong learning plans`.
