...
## Metadata
- skill_id: `u07524-autonomous-workflow-authoring-for-manufacturing-quality-assurance`
- capability: `Autonomous Workflow Authoring for manufacturing quality assurance`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for manufacturing quality assurance` in `manufacturing quality assurance`.
