---
name: u07480-autonomous-workflow-authoring-for-legal-and-policy-workflows
...
| Feature flag | `skill_07480_autonomous-workflow-authoring` |
| Release cycles | `2` |

## Why This Skill Exists
Use autonomous workflow authoring in legal and policy workflows with emphasis on best-in-class standards, precision, and repeatable excellence.
...
5. Run unit, integration, simulation, and regression suites for Autonomous Workflow Authoring for legal and policy workflows under professional mastery conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Autonomous Workflow Authoring for legal and policy workflows under professional mastery conditions.
