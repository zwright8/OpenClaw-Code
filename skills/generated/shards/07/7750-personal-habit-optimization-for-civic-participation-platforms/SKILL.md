...
## Metadata
- skill_id: `u07750-personal-habit-optimization-for-civic-participation-platforms`
- capability: `Personal Habit Optimization for civic participation platforms`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for civic participation platforms` in `civic participation platforms`.
