...
## Metadata
- skill_id: `u07797-personal-habit-optimization-for-knowledge-management-systems`
- capability: `Personal Habit Optimization for knowledge management systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for knowledge management systems` in `knowledge management systems`.
