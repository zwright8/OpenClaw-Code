---
name: u07452-autonomous-workflow-authoring-for-software-engineering-delivery
...
| Feature flag | `skill_07452_autonomous-workflow-authoring` |
| Release cycles | `2` |

## Why This Skill Exists
Use autonomous workflow authoring in software engineering delivery with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Autonomous Workflow Authoring for software engineering delivery under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Autonomous Workflow Authoring for software engineering delivery under pro-humanity impact conditions.
