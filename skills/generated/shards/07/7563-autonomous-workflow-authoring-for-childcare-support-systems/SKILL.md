...
## Metadata
- skill_id: `u07563-autonomous-workflow-authoring-for-childcare-support-systems`
- capability: `Autonomous Workflow Authoring for childcare support systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for childcare support systems` in `childcare support systems`.
