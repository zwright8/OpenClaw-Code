...
## Metadata
- skill_id: `u07667-personal-habit-optimization-for-sales-and-client-success`
- capability: `Personal Habit Optimization for sales and client success`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for sales and client success` in `sales and client success`.
