...
## Metadata
- skill_id: `u07985-attention-management-architecture-for-multilingual-translation-services`
- capability: `Attention Management Architecture for multilingual translation services`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for multilingual translation services` in `multilingual translation services`.
