...
## Metadata
- skill_id: `u07607-personal-habit-optimization-for-family-caregiving-systems`
- capability: `Personal Habit Optimization for family caregiving systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for family caregiving systems` in `family caregiving systems`.
