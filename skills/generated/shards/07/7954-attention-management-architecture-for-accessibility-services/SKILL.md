...
## Metadata
- skill_id: `u07954-attention-management-architecture-for-accessibility-services`
- capability: `Attention Management Architecture for accessibility services`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for accessibility services` in `accessibility services`.
