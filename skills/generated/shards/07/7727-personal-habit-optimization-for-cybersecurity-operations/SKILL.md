...
## Metadata
- skill_id: `u07727-personal-habit-optimization-for-cybersecurity-operations`
- capability: `Personal Habit Optimization for cybersecurity operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for cybersecurity operations` in `cybersecurity operations`.
