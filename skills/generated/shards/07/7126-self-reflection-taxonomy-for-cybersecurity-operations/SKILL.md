...
| Feature flag | `skill_07126_self-reflection-taxonomy` |
| Release cycles | `2` |

## Why This Skill Exists
Use self-reflection taxonomy in cybersecurity operations with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Self-Reflection Taxonomy for cybersecurity operations under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Self-Reflection Taxonomy for cybersecurity operations under maximally truth-seeking conditions.
