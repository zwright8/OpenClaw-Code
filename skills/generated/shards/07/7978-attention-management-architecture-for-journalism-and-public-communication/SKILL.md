...
## Metadata
- skill_id: `u07978-attention-management-architecture-for-journalism-and-public-communication`
- capability: `Attention Management Architecture for journalism and public communication`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for journalism and public communication` in `journalism and public communication`.
