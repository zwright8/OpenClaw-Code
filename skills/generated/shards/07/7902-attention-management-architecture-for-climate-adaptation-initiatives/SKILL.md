...
## Metadata
- skill_id: `u07902-attention-management-architecture-for-climate-adaptation-initiatives`
- capability: `Attention Management Architecture for climate adaptation initiatives`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for climate adaptation initiatives` in `climate adaptation initiatives`.
