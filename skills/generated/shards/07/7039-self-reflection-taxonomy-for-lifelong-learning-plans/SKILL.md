...
## Metadata
- skill_id: `u07039-self-reflection-taxonomy-for-lifelong-learning-plans`
- capability: `Self-Reflection Taxonomy for lifelong learning plans`
...
## Musts
- [ ] Confirm the request explicitly matches `Self-Reflection Taxonomy for lifelong learning plans` in `lifelong learning plans`.
