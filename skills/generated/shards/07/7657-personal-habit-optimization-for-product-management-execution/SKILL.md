...
## Metadata
- skill_id: `u07657-personal-habit-optimization-for-product-management-execution`
- capability: `Personal Habit Optimization for product management execution`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for product management execution` in `product management execution`.
