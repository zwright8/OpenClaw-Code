...
## When To Use
Use this skill only when the request explicitly needs `Self-Reflection Taxonomy for arts and culture programming` in arts and culture programming and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Self-Reflection Taxonomy for arts and culture programming** outcomes (not generic brainstorming).
...
1. **Incident stabilization in arts and culture programming" capability for arts and culture programming**
   - Input: noisy upstream payload requiring self-reflection taxonomy for arts and culture programming normalization/assessment.
