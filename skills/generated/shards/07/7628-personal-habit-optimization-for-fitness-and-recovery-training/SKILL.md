...
## Metadata
- skill_id: `u07628-personal-habit-optimization-for-fitness-and-recovery-training`
- capability: `Personal Habit Optimization for fitness and recovery training`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for fitness and recovery training` in `fitness and recovery training`.
