...
## Metadata
- skill_id: `u07987-attention-management-architecture-for-remote-team-collaboration`
- capability: `Attention Management Architecture for remote team collaboration`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for remote team collaboration` in `remote team collaboration`.
