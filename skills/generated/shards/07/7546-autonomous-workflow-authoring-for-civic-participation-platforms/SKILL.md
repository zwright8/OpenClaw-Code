...
## Metadata
- skill_id: `u07546-autonomous-workflow-authoring-for-civic-participation-platforms`
- capability: `Autonomous Workflow Authoring for civic participation platforms`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for civic participation platforms` in `civic participation platforms`.
