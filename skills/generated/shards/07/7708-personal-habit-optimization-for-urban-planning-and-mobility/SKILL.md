...
## Metadata
- skill_id: `u07708-personal-habit-optimization-for-urban-planning-and-mobility`
- capability: `Personal Habit Optimization for urban planning and mobility`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for urban planning and mobility` in `urban planning and mobility`.
