...
## Metadata
- skill_id: `u07214-continuous-improvement-planning-for-household-logistics`
- capability: `Continuous Improvement Planning for household logistics`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for household logistics` in `household logistics`.
