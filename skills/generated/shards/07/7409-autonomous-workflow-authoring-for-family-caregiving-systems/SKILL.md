...
## Metadata
- skill_id: `u07409-autonomous-workflow-authoring-for-family-caregiving-systems`
- capability: `Autonomous Workflow Authoring for family caregiving systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for family caregiving systems` in `family caregiving systems`.
