...
## Metadata
- skill_id: `u07991-attention-management-architecture-for-customer-support-operations`
- capability: `Attention Management Architecture for customer support operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for customer support operations` in `customer support operations`.
