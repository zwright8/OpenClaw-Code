...
## When To Use
Use this skill only when the request explicitly needs `Personal Habit Optimization for disaster response networks` in disaster response networks and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Personal Habit Optimization for disaster response networks** outcomes (not generic brainstorming).
...
1. **Incident stabilization in disaster response networks" capability for disaster response networks**
   - Input: noisy upstream payload requiring personal habit optimization for disaster response networks normalization/assessment.
