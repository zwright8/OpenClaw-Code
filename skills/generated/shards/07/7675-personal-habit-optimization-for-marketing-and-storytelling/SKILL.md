...
## Metadata
- skill_id: `u07675-personal-habit-optimization-for-marketing-and-storytelling`
- capability: `Personal Habit Optimization for marketing and storytelling`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for marketing and storytelling` in `marketing and storytelling`.
