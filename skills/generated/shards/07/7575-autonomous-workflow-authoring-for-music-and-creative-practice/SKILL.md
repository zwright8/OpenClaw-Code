...
## Metadata
- skill_id: `u07575-autonomous-workflow-authoring-for-music-and-creative-practice`
- capability: `Autonomous Workflow Authoring for music and creative practice`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for music and creative practice` in `music and creative practice`.
