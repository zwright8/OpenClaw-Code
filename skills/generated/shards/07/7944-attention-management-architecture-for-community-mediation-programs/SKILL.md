...
## Metadata
- skill_id: `u07944-attention-management-architecture-for-community-mediation-programs`
- capability: `Attention Management Architecture for community mediation programs`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for community mediation programs` in `community mediation programs`.
