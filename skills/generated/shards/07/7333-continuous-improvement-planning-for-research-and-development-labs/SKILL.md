...
description: Build and operate the "Continuous Improvement Planning for research and development labs" capability for research and development labs. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for research and development labs** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **research and development labs" capability for research and development labs** with measurable acceptance criteria.
...
- **Daily:** Run when new research and development labs" capability for research and development labs signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in research and development labs" capability for research and development labs**
   - Input: noisy upstream payload requiring continuous improvement planning for research and development labs normalization/assessment.
...
## Handoff Contract
- Produces: `Continuous Improvement Planning for research and development labs` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **research and development labs" capability for research and development labs** depends on **Continuous Improvement Planning for research and development labs** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
