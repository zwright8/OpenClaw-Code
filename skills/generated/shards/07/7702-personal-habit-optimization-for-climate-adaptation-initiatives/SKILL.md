...
## Metadata
- skill_id: `u07702-personal-habit-optimization-for-climate-adaptation-initiatives`
- capability: `Personal Habit Optimization for climate adaptation initiatives`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for climate adaptation initiatives` in `climate adaptation initiatives`.
