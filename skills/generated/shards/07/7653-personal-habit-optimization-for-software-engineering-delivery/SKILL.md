...
## Metadata
- skill_id: `u07653-personal-habit-optimization-for-software-engineering-delivery`
- capability: `Personal Habit Optimization for software engineering delivery`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for software engineering delivery` in `software engineering delivery`.
