...
## Metadata
- skill_id: `u07198-self-reflection-taxonomy-for-knowledge-management-systems`
- capability: `Self-Reflection Taxonomy for knowledge management systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Self-Reflection Taxonomy for knowledge management systems` in `knowledge management systems`.
