...
## Metadata
- skill_id: `u07864-attention-management-architecture-for-design-and-user-research`
- capability: `Attention Management Architecture for design and user research`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for design and user research` in `design and user research`.
