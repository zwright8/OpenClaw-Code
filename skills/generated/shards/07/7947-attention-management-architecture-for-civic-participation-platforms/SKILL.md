...
## Metadata
- skill_id: `u07947-attention-management-architecture-for-civic-participation-platforms`
- capability: `Attention Management Architecture for civic participation platforms`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for civic participation platforms` in `civic participation platforms`.
