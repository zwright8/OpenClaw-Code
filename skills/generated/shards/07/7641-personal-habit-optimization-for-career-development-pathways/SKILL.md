...
## Metadata
- skill_id: `u07641-personal-habit-optimization-for-career-development-pathways`
- capability: `Personal Habit Optimization for career development pathways`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for career development pathways` in `career development pathways`.
