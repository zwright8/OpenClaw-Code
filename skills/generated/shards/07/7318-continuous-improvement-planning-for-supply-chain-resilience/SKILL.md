...
## Metadata
- skill_id: `u07318-continuous-improvement-planning-for-supply-chain-resilience`
- capability: `Continuous Improvement Planning for supply chain resilience`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for supply chain resilience` in `supply chain resilience`.
