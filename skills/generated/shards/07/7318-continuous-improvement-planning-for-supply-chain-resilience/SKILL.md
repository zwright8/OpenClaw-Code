...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for supply chain resilience** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **supply chain resilience" capability for supply chain resilience** with measurable acceptance criteria.
...
- **Daily:** Run when new supply chain resilience" capability for supply chain resilience signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in supply chain resilience" capability for supply chain resilience**
   - Input: noisy upstream payload requiring continuous improvement planning for supply chain resilience normalization/assessment.
...
## Handoff Contract
- Produces: `Continuous Improvement Planning for supply chain resilience` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **supply chain resilience" capability for supply chain resilience** depends on **Continuous Improvement Planning for supply chain resilience** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
