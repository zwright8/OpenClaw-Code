...
## Metadata
- skill_id: `u07857-attention-management-architecture-for-product-management-execution`
- capability: `Attention Management Architecture for product management execution`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for product management execution` in `product management execution`.
