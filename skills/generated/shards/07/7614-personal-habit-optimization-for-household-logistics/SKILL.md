...
## Metadata
- skill_id: `u07614-personal-habit-optimization-for-household-logistics`
- capability: `Personal Habit Optimization for household logistics`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for household logistics` in `household logistics`.
