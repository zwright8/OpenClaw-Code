...
This skill hardens a generated capability for production execution so eldercare coordination workflows remain deterministic, auditable, and fail-closed under risk.

## When To Use
Use this skill only when the request explicitly needs `Continuous Improvement Planning for eldercare coordination` in eldercare coordination and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for eldercare coordination** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **eldercare coordination" capability for eldercare coordination** with measurable acceptance criteria.
...
- **Daily:** Run when new eldercare coordination" capability for eldercare coordination signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in eldercare coordination" capability for eldercare coordination**
   - Input: noisy upstream payload requiring continuous improvement planning for eldercare coordination normalization/assessment.
