...
## Metadata
- skill_id: `u07324-continuous-improvement-planning-for-manufacturing-quality-assurance`
- capability: `Continuous Improvement Planning for manufacturing quality assurance`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for manufacturing quality assurance` in `manufacturing quality assurance`.
