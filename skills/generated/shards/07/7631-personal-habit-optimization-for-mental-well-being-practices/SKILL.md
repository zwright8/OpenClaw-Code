...
## Metadata
- skill_id: `u07631-personal-habit-optimization-for-mental-well-being-practices`
- capability: `Personal Habit Optimization for mental well-being practices`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for mental well-being practices` in `mental well-being practices`.
