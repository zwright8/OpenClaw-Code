...
## Metadata
- skill_id: `u07694-personal-habit-optimization-for-nonprofit-program-delivery`
- capability: `Personal Habit Optimization for nonprofit program delivery`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for nonprofit program delivery` in `nonprofit program delivery`.
