...
## Metadata
- skill_id: `u07745-personal-habit-optimization-for-community-mediation-programs`
- capability: `Personal Habit Optimization for community mediation programs`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for community mediation programs` in `community mediation programs`.
