...
## When To Use
Use this skill only when the request explicitly needs `Personal Habit Optimization for community mediation programs` in community mediation programs and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Personal Habit Optimization for community mediation programs** outcomes (not generic brainstorming).
...
1. **Incident stabilization in community mediation programs" capability for community mediation programs**
   - Input: noisy upstream payload requiring personal habit optimization for community mediation programs normalization/assessment.
