...
## Metadata
- skill_id: `u07283-continuous-improvement-planning-for-healthcare-operations`
- capability: `Continuous Improvement Planning for healthcare operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for healthcare operations` in `healthcare operations`.
