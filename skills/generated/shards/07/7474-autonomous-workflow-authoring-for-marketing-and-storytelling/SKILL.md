...
## Metadata
- skill_id: `u07474-autonomous-workflow-authoring-for-marketing-and-storytelling`
- capability: `Autonomous Workflow Authoring for marketing and storytelling`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for marketing and storytelling` in `marketing and storytelling`.
