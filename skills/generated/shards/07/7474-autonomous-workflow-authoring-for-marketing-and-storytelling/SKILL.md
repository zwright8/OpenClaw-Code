...
## When To Use
Use this skill only when the request explicitly needs `Autonomous Workflow Authoring for marketing and storytelling` in marketing and storytelling and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Autonomous Workflow Authoring for marketing and storytelling** outcomes (not generic brainstorming).
...
1. **Incident stabilization in marketing and storytelling" capability for marketing and storytelling**
   - Input: noisy upstream payload requiring autonomous workflow authoring for marketing and storytelling normalization/assessment.
