...
## Metadata
- skill_id: `u07690-personal-habit-optimization-for-education-support-services`
- capability: `Personal Habit Optimization for education support services`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for education support services` in `education support services`.
