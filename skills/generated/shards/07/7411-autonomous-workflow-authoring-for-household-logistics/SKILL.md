...
## Metadata
- skill_id: `u07411-autonomous-workflow-authoring-for-household-logistics`
- capability: `Autonomous Workflow Authoring for household logistics`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for household logistics` in `household logistics`.
