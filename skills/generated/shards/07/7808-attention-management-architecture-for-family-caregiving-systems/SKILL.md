...
## Metadata
- skill_id: `u07808-attention-management-architecture-for-family-caregiving-systems`
- capability: `Attention Management Architecture for family caregiving systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for family caregiving systems` in `family caregiving systems`.
