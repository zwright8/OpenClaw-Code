...
## Metadata
- skill_id: `u07513-autonomous-workflow-authoring-for-agriculture-and-food-systems`
- capability: `Autonomous Workflow Authoring for agriculture and food systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for agriculture and food systems` in `agriculture and food systems`.
