...
## Metadata
- skill_id: `u07099-self-reflection-taxonomy-for-disaster-response-networks`
- capability: `Self reflection taxonomy for disaster response networks`
...
## Musts
- [ ] Confirm the request explicitly matches `Self reflection taxonomy for disaster response networks` in `disaster response networks`.
