...
## Metadata
- skill_id: `u07879-attention-management-architecture-for-legal-and-policy-workflows`
- capability: `Attention Management Architecture for legal and policy workflows`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for legal and policy workflows` in `legal and policy`.
