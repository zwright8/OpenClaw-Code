...
## Metadata
- skill_id: `u07779-personal-habit-optimization-for-journalism-and-public-communication`
- capability: `Personal Habit Optimization for journalism and public communication`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for journalism and public communication` in `journalism and public communication`.
