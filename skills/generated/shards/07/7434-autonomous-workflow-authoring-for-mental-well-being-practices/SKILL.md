...
## Metadata
- skill_id: `u07434-autonomous-workflow-authoring-for-mental-well-being-practices`
- capability: `Autonomous Workflow Authoring for mental well-being practices`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for mental well-being practices` in `mental well-being practices`.
