...
## Metadata
- skill_id: `u07874-attention-management-architecture-for-marketing-and-storytelling`
- capability: `Attention Management Architecture for marketing and storytelling`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for marketing and storytelling` in `marketing and storytelling`.
