...
## When To Use
Use this skill only when the request explicitly needs `Autonomous Workflow Authoring for nutrition and meal planning` in nutrition and meal planning and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Autonomous Workflow Authoring for nutrition and meal planning** outcomes (not generic brainstorming).
...
1. **Incident stabilization in nutrition and meal planning" capability for nutrition and meal planning**
   - Input: noisy upstream payload requiring autonomous workflow authoring for nutrition and meal planning normalization/assessment.
