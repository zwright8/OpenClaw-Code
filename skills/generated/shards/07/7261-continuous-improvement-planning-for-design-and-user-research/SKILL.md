...
## When To Use
Use this skill only when the request explicitly needs `Continuous Improvement Planning for design and user research` in design and user research and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for design and user research** outcomes (not generic brainstorming).
...
1. **Incident stabilization in design and user research" capability for design and user research**
   - Input: noisy upstream payload requiring continuous improvement planning for design and user research normalization/assessment.
