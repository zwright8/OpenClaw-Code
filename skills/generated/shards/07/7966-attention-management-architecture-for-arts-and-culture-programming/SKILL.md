...
## Metadata
- skill_id: `u07966-attention-management-architecture-for-arts-and-culture-programming`
- capability: `Attention Management Architecture for arts and culture programming`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for arts and culture programming` in `arts and culture programming`.
