...
## Metadata
- skill_id: `u07577-autonomous-workflow-authoring-for-journalism-and-public-communication`
- capability: `Autonomous Workflow Authoring for journalism and public communication`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for journalism and public communication` in `journalism and public communication`.
