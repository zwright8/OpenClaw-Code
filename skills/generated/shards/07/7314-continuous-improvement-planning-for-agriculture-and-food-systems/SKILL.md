...
## Metadata
- skill_id: `u07314-continuous-improvement-planning-for-agriculture-and-food-systems`
- capability: `Continuous Improvement Planning for agriculture and food systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for agriculture and food systems` in `agriculture and food systems`.
