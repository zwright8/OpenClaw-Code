...
description: Operate the "Attention Management Architecture for arts and culture programming" capability in production for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Attention Management Architecture for arts and culture programming** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **arts and culture programming" capability in production for arts and culture programming workflows** with measurable acceptance criteria.
...
- **Daily:** Run when new arts and culture programming" capability in production for arts and culture programming workflows signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in arts and culture programming" capability in production for arts and culture programming workflows**
   - Input: noisy upstream payload requiring attention management architecture for arts and culture programming normalization/assessment.
...
## Handoff Contract
- Produces: `Attention Management Architecture for arts and culture programming` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **arts and culture programming" capability in production for arts and culture programming workflows** depends on **Attention Management Architecture for arts and culture programming** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
