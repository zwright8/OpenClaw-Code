...
## Metadata
- skill_id: `u07697-personal-habit-optimization-for-disaster-response-networks`
- capability: `Personal Habit Optimization for disaster response networks`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for disaster response networks` in `disaster response networks`.
