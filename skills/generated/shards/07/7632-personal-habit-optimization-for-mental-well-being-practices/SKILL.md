...
## When To Use
Use this skill only when the request explicitly needs `Personal Habit Optimization for mental well-being practices` in mental well-being practices and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Personal Habit Optimization for mental well-being practices** outcomes (not generic brainstorming).
...
1. **Incident stabilization in mental well-being practices" capability for mental well-being practices**
   - Input: noisy upstream payload requiring personal habit optimization for mental well-being practices normalization/assessment.
