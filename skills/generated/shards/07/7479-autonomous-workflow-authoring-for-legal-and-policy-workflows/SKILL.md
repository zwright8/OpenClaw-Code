---
name: u07479-autonomous-workflow-authoring-for-legal-and-policy-workflows
description: Run the Autonomous Workflow Authoring for legal and policy workflows capability for legal and policy workflows with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Primary artifact | `autonomous-workflow-authoring-artifact-legal-and-policy-workflow` |
| Routing tag | `legal-and-policy-workflows:orchestration-engine` |
| Feature flag | `skill_07479_autonomous-workflow-authoring` |
| Release cycles | `2` |

## Why This Skill Exists
Use autonomous workflow authoring in legal and policy workflows with emphasis on throughput, reliability, leverage, and execution speed.

## Trigger Checklist
- [ ] The task explicitly needs Autonomous Workflow Authoring for legal and policy workflows (not generic brainstorming).
...
|---|---|---|---|
| autonomous-workflow-authoring-artifact-legal-and-policy-workflow | structured-artifact | yes | downstream orchestrator |
| autonomous-workflow-authoring-artifact-legal-and-policy-workflow-scorecard | scorecard | yes | operator / reviewer |
| autonomous-workflow-authoring-artifact-legal-and-policy-workflow-handoff | handoff-packet | yes | next owner |
...
5. Run unit, integration, simulation, and regression suites for Autonomous Workflow Authoring for legal and policy workflows under hyper-productive autonomy conditions.
...
## Operator Use Cases
- Run Autonomous Workflow Authoring for legal and policy workflows as a repeatable production workflow for humans and agents.
- Use Autonomous Workflow Authoring for legal and policy workflows to accelerate decisions while preserving safety, quality, and auditability.
...
## Posture Playbook
- **Ready posture (score >= 74):** release artifacts after validation pass and route to `legal-and-policy-workflows:orchestration-engine`.
...
## Traceability Map
- **Scope:** Define measurable outcomes for Autonomous Workflow Authoring for legal and policy workflows, including baseline and target metrics for legal and policy workflows.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Autonomous Workflow Authoring for legal and policy workflows under hyper-productive autonomy conditions.
...
1. `Frontier model runtime` -> auth preflight, execute model inference call(s), normalize output, and attach trace to `autonomous-workflow-authoring-artifact-legal-and-policy-workflow`.
2. `Task/workflow orchestrator` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `autonomous-workflow-authoring-artifact-legal-and-policy-workflow`.
3. `Telemetry store` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `autonomous-workflow-authoring-artifact-legal-and-policy-workflow`.
4. `Audit log + immutable storage` -> auth preflight, execute read/query call(s), normalize output, and attach trace to `autonomous-workflow-authoring-artifact-legal-and-policy-workflow`.
...
1. Incident recovery in legal and policy workflows: ingest noisy signals, execute autonomous workflow authoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Autonomous Workflow Authoring for legal and policy workflows against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
3. Pre-deployment gate: validate artifacts for legal-and-policy-workflows:orchestration-engine, enforce approvals, then handoff to downstream orchestrator with next actions.
...
## Handoff Contract
- **Produces:** `autonomous-workflow-authoring-artifact-legal-and-policy-workflow`, scorecard, risk/confidence metadata, remediation backlog.
- **Consumes:** `queue load`, `cycle time`, `throughput metrics`.
- **Readiness rule:** release only when schema, determinism, policy, and reliability gates all pass.
- **Downstream hint:** route only to `legal-and-policy-workflows:orchestration-engine` consumers with approval context attached.
