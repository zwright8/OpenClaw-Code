...
| Feature flag | `skill_07209_continuous-improvement-plannin` |
| Release cycles | `2` |

## Why This Skill Exists
Use continuous improvement planning in family caregiving systems with emphasis on throughput, reliability, leverage, and execution speed.
...
5. Run unit, integration, simulation, and regression suites for Continuous Improvement Planning for family caregiving systems under hyper-productive autonomy conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Continuous Improvement Planning for family caregiving systems under hyper-productive autonomy conditions.
...
1. `Frontier model runtime` -> auth preflight, execute model inference call(s), normalize output, and attach trace to `continuous-improvement-planning-artifact-family-caregiving-syste`.
2. `Task/workflow orchestrator` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `continuous-improvement-planning-artifact-family-caregiving-syste`.
3. `Telemetry store` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `continuous-improvement-planning-artifact-family-caregiving-syste`.
