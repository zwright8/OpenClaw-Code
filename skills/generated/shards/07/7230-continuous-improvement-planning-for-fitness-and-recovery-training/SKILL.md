...
## Metadata
- skill_id: `u07230-continuous-improvement-planning-for-fitness-and-recovery-training`
- capability: `Continuous Improvement Planning for fitness and recovery training`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for fitness and recovery training` in `fitness and recovery training`.
