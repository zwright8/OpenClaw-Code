...
## Metadata
- skill_id: `u07059-self-reflection-taxonomy-for-product-management-execution`
- capability: `Self reflection taxonomy for product management execution`
...
## Musts
- [ ] Confirm the request explicitly matches `Self reflection taxonomy for product management execution` in `product management execution`.
