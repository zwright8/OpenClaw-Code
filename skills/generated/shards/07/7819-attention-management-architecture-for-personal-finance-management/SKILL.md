...
## Metadata
- skill_id: `u07819-attention-management-architecture-for-personal-finance-management`
- capability: `Attention Management Architecture for personal finance management`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for personal finance management` in `personal finance management`.
