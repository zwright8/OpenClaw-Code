...
## Metadata
- skill_id: `u07077-self-reflection-taxonomy-for-legal-and-policy-workflows`
- capability: `Self reflection taxonomy for legal and policy workflows`
...
## Musts
- [ ] Confirm the request explicitly matches `Self reflection taxonomy for legal and policy workflows` in `legal and policy`.
