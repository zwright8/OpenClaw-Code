...
## Metadata
- skill_id: `u07740-personal-habit-optimization-for-scientific-publishing-pipelines`
- capability: `Personal Habit Optimization for scientific publishing pipelines`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for scientific publishing pipelines` in `scientific publishing pipelines`.
