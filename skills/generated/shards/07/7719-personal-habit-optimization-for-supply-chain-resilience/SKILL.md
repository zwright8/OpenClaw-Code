...
## Metadata
- skill_id: `u07719-personal-habit-optimization-for-supply-chain-resilience`
- capability: `Personal Habit Optimization for supply chain resilience`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for supply chain resilience` in `supply chain resilience`.
