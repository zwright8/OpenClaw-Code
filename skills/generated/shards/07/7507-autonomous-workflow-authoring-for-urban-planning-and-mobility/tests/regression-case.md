# Regression Case — Autonomous Workflow Authoring for urban planning and mobility

## Goal
Verify deterministic tolerance enforcement and fail-closed behavior for urban planning and mobility.
