...
## Metadata
- skill_id: `u07843-attention-management-architecture-for-career-development-pathways`
- capability: `Attention Management Architecture for career development pathways`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for career development pathways` in `career development pathways`.
