...
## Metadata
- skill_id: `u07581-autonomous-workflow-authoring-for-multilingual-translation-services`
- capability: `Autonomous Workflow Authoring for multilingual translation services`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for multilingual translation services` in `multilingual translation services`.
