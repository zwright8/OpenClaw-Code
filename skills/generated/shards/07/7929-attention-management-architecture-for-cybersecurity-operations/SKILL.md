...
## Metadata
- skill_id: `u07929-attention-management-architecture-for-cybersecurity-operations`
- capability: `Attention Management Architecture for cybersecurity operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for cybersecurity operations` in `cybersecurity operations`.
