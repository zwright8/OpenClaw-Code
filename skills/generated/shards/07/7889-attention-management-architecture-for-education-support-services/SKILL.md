...
## Metadata
- skill_id: `u07889-attention-management-architecture-for-education-support-services`
- capability: `Attention Management Architecture for education support services`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for education support services` in `education support services`.
