...
## When To Use
Use this skill only when the request explicitly needs `Self-Reflection Taxonomy for eldercare coordination` in eldercare coordination and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Self-Reflection Taxonomy for eldercare coordination** outcomes (not generic brainstorming).
...
1. **Incident stabilization in eldercare coordination" capability for eldercare coordination**
   - Input: noisy upstream payload requiring self-reflection taxonomy for eldercare coordination normalization/assessment.
