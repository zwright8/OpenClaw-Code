...
## Metadata
- skill_id: `u07503-autonomous-workflow-authoring-for-climate-adaptation-initiatives`
- capability: `Autonomous Workflow Authoring for climate adaptation initiatives`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for climate adaptation initiatives` in `climate adaptation initiatives`.
