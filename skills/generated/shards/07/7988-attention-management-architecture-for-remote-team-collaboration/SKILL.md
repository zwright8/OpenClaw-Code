...
description: Operate the "Attention Management Architecture for remote team collaboration" capability in production for remote team collaboration workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Attention Management Architecture for remote team collaboration** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **remote team collaboration" capability in production for remote team collaboration workflows** with measurable acceptance criteria.
...
- **Daily:** Run when new remote team collaboration" capability in production for remote team collaboration workflows signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in remote team collaboration" capability in production for remote team collaboration workflows**
   - Input: noisy upstream payload requiring attention management architecture for remote team collaboration normalization/assessment.
...
## Handoff Contract
- Produces: `Attention Management Architecture for remote team collaboration` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **remote team collaboration" capability in production for remote team collaboration workflows** depends on **Attention Management Architecture for remote team collaboration** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
