...
## Metadata
- skill_id: `u07664-personal-habit-optimization-for-design-and-user-research`
- capability: `Personal Habit Optimization for design and user research`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for design and user research` in `design and user research`.
