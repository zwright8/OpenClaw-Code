...
## Metadata
- skill_id: `u07127-self-reflection-taxonomy-for-cybersecurity-operations`
- capability: `Self-reflection taxonomy for cybersecurity operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Self-reflection taxonomy for cybersecurity operations` in `cybersecurity operations`.
