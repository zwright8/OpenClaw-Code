...
## Metadata
- skill_id: `u07326-continuous-improvement-planning-for-cybersecurity-operations`
- capability: `Continuous Improvement Planning for cybersecurity operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for cybersecurity operations` in `cybersecurity operations`.
