...
description: Build and operate the "Continuous Improvement Planning for cybersecurity operations" capability for cybersecurity operations. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for cybersecurity operations** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **cybersecurity operations" capability for cybersecurity operations** with measurable acceptance criteria.
...
- **Daily:** Run when new cybersecurity operations" capability for cybersecurity operations signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in cybersecurity operations" capability for cybersecurity operations**
   - Input: noisy upstream payload requiring continuous improvement planning for cybersecurity operations normalization/assessment.
...
## Handoff Contract
- Produces: `Continuous Improvement Planning for cybersecurity operations` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **cybersecurity operations" capability for cybersecurity operations** depends on **Continuous Improvement Planning for cybersecurity operations** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
