...
## Metadata
- skill_id: `u07622-personal-habit-optimization-for-nutrition-and-meal-planning`
- capability: `Personal Habit Optimization for nutrition and meal planning`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for nutrition and meal planning` in `nutrition and meal planning`.
