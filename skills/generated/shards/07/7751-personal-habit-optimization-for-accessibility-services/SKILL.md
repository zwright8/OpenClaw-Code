...
## Metadata
- skill_id: `u07751-personal-habit-optimization-for-accessibility-services`
- capability: `Personal Habit Optimization for accessibility services`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for accessibility services` in `accessibility services`.
