...
## Metadata
- skill_id: `u07237-continuous-improvement-planning-for-lifelong-learning-plans`
- capability: `Continuous Improvement Planning for lifelong learning plans`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for lifelong learning plans` in `lifelong learning plans`.
