...
## Metadata
- skill_id: `u07801-attention-management-architecture-for-personal-health-routines`
- capability: `Attention Management Architecture for personal health routines`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for personal health routines` in `personal health routines`.
