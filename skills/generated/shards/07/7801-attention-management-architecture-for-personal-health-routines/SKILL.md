...
| Feature flag | `skill_07801_attention-management-architect` |
| Release cycles | `2` |

## Why This Skill Exists
Use attention management architecture in personal health routines with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Attention Management Architecture for personal health routines under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Attention Management Architecture for personal health routines under maximally truth-seeking conditions.
