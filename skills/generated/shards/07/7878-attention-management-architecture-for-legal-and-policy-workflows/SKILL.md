...
## Trigger Checklist
- [ ] The request explicitly needs **Attention Management Architecture for legal and policy workflows** outcomes (not generic brainstorming).
...
1. **Incident stabilization in legal and policy workflows" capability in production for legal and policy workflows workflows**
   - Input: noisy upstream payload requiring attention management architecture for legal and policy workflows normalization/assessment.
...
## Handoff Contract
- Produces: `Attention Management Architecture for legal and policy workflows` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **legal and policy workflows" capability in production for legal and policy workflows workflows** depends on **Attention Management Architecture for legal and policy workflows** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
