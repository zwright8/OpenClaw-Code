...
## Metadata
- skill_id: `u07001-self-reflection-taxonomy-for-personal-health-routines`
- capability: `Self-Reflection Taxonomy for personal health routines`
...
## Musts
- [ ] Confirm the request explicitly matches `Self-Reflection Taxonomy for personal health routines` in `personal health routines`.
