...
## When To Use
Use this skill only when the request explicitly needs `Continuous Improvement Planning for journalism and public communication` in journalism and public communication and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for journalism and public communication** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **journalism and public communication" capability for journalism and public communication** with measurable acceptance criteria.
...
- **Daily:** Run when new journalism and public communication" capability for journalism and public communication signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in journalism and public communication" capability for journalism and public communication**
   - Input: noisy upstream payload requiring continuous improvement planning for journalism and public communication normalization/assessment.
