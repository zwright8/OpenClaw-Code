...
## Metadata
- skill_id: `u07083-self-reflection-taxonomy-for-healthcare-operations`
- capability: `Self reflection taxonomy for healthcare operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Self reflection taxonomy for healthcare operations` in `healthcare operations`.
