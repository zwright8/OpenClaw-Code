---
name: u07453-autonomous-workflow-authoring-for-software-engineering-delivery
description: Run the Autonomous Workflow Authoring for software engineering delivery capability for software engineering delivery with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Primary artifact | `autonomous-workflow-authoring-artifact-software-engineering-deli` |
| Routing tag | `software-engineering-delivery:orchestration-engine` |
| Feature flag | `skill_07453_autonomous-workflow-authoring` |
| Release cycles | `2` |

## Why This Skill Exists
Use autonomous workflow authoring in software engineering delivery with emphasis on clarity, harmony, craft, and emotionally resonant outcomes.

## Trigger Checklist
- [ ] The task explicitly needs Autonomous Workflow Authoring for software engineering delivery (not generic brainstorming).
...
|---|---|---|---|
| autonomous-workflow-authoring-artifact-software-engineering-deli | structured-artifact | yes | downstream orchestrator |
| autonomous-workflow-authoring-artifact-software-engineering-deli-scorecard | scorecard | yes | operator / reviewer |
| autonomous-workflow-authoring-artifact-software-engineering-deli-handoff | handoff-packet | yes | next owner |
...
5. Run unit, integration, simulation, and regression suites for Autonomous Workflow Authoring for software engineering delivery under beauty and aesthetic appreciation conditions.
...
## Operator Use Cases
- Run Autonomous Workflow Authoring for software engineering delivery as a repeatable production workflow for humans and agents.
- Use Autonomous Workflow Authoring for software engineering delivery to accelerate decisions while preserving safety, quality, and auditability.
...
## Posture Playbook
- **Ready posture (score >= 74):** release artifacts after validation pass and route to `software-engineering-delivery:orchestration-engine`.
...
## Traceability Map
- **Scope:** Define measurable outcomes for Autonomous Workflow Authoring for software engineering delivery, including baseline and target metrics for software engineering delivery.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Autonomous Workflow Authoring for software engineering delivery under beauty and aesthetic appreciation conditions.
...
1. `Frontier model runtime` -> auth preflight, execute model inference call(s), normalize output, and attach trace to `autonomous-workflow-authoring-artifact-software-engineering-deli`.
2. `Task/workflow orchestrator` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `autonomous-workflow-authoring-artifact-software-engineering-deli`.
3. `Telemetry store` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `autonomous-workflow-authoring-artifact-software-engineering-deli`.
...
1. Incident recovery in software engineering delivery: ingest noisy signals, execute autonomous workflow authoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Autonomous Workflow Authoring for software engineering delivery against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
3. Pre-deployment gate: validate artifacts for software-engineering-delivery:orchestration-engine, enforce approvals, then handoff to downstream orchestrator with next actions.
...
## Handoff Contract
- **Produces:** `autonomous-workflow-authoring-artifact-software-engineering-deli`, scorecard, risk/confidence metadata, remediation backlog.
- **Consumes:** `aesthetic constraints`, `craft references`, `experience traces`.
- **Readiness rule:** release only when schema, determinism, policy, and reliability gates all pass.
- **Downstream hint:** route only to `software-engineering-delivery:orchestration-engine` consumers with approval context attached.
