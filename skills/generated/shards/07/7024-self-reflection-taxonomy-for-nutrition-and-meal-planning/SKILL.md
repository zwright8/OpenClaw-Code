...
| Feature flag | `skill_07024_self-reflection-taxonomy` |
| Release cycles | `2` |

## Why This Skill Exists
Use self-reflection taxonomy in nutrition and meal planning with emphasis on throughput, reliability, leverage, and execution speed.
...
5. Run unit, integration, simulation, and regression suites for Self-Reflection Taxonomy for nutrition and meal planning under hyper-productive autonomy conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Self-Reflection Taxonomy for nutrition and meal planning under hyper-productive autonomy conditions.
...
1. `Frontier model runtime` -> auth preflight, execute model inference call(s), normalize output, and attach trace to `self-reflection-taxonomy-artifact-nutrition-and-meal-planning`.
2. `Task/workflow orchestrator` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `self-reflection-taxonomy-artifact-nutrition-and-meal-planning`.
3. `Telemetry store` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `self-reflection-taxonomy-artifact-nutrition-and-meal-planning`.
