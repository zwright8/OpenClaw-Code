...
## Metadata
- skill_id: `u07715-personal-habit-optimization-for-agriculture-and-food-systems`
- capability: `Personal Habit Optimization for agriculture and food systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for agriculture and food systems` in `agriculture and food systems`.
