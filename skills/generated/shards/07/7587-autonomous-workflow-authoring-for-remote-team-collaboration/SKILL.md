...
## Metadata
- skill_id: `u07587-autonomous-workflow-authoring-for-remote-team-collaboration`
- capability: `Autonomous Workflow Authoring for remote team collaboration`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for remote team collaboration` in `remote team collaboration`.
