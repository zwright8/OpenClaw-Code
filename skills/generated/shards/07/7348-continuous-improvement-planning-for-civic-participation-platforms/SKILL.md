...
description: Build and operate the "Continuous Improvement Planning for civic participation platforms" capability for civic participation platforms. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for civic participation platforms** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **civic participation platforms" capability for civic participation platforms** with measurable acceptance criteria.
...
- **Daily:** Run when new civic participation platforms" capability for civic participation platforms signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in civic participation platforms" capability for civic participation platforms**
   - Input: noisy upstream payload requiring continuous improvement planning for civic participation platforms normalization/assessment.
...
## Handoff Contract
- Produces: `Continuous Improvement Planning for civic participation platforms` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **civic participation platforms" capability for civic participation platforms** depends on **Continuous Improvement Planning for civic participation platforms** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
