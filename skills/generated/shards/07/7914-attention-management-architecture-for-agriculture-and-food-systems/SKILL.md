...
## Metadata
- skill_id: `u07914-attention-management-architecture-for-agriculture-and-food-systems`
- capability: `Attention Management Architecture for agriculture and food systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for agriculture and food systems` in `agriculture and food systems`.
