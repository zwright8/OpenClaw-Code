---
name: u07477-autonomous-workflow-authoring-for-legal-and-policy-workflows
...
| Feature flag | `skill_07477_autonomous-workflow-authoring` |
| Release cycles | `2` |

## Why This Skill Exists
Use autonomous workflow authoring in legal and policy workflows with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Autonomous Workflow Authoring for legal and policy workflows under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Autonomous Workflow Authoring for legal and policy workflows under pro-humanity impact conditions.
