...
## Metadata
- skill_id: `u07829-attention-management-architecture-for-fitness-and-recovery-training`
- capability: `Attention Management Architecture for fitness and recovery training`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for fitness and recovery training` in `fitness and recovery training`.
