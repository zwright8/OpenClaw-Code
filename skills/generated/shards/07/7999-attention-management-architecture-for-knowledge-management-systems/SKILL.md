...
## Metadata
- skill_id: `u07999-attention-management-architecture-for-knowledge-management-systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for knowledge management systems` in `knowledge management systems`.
