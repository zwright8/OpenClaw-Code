...
## Metadata
- skill_id: `u07811-attention-management-architecture-for-household-logistics`
- capability: `Attention Management Architecture for household logistics`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for household logistics` in `household logistics`.
