...
## Metadata
- skill_id: `u07894-attention-management-architecture-for-nonprofit-program-delivery`
- capability: `Attention Management Architecture for nonprofit program delivery`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for nonprofit program delivery` in `nonprofit program delivery`.
