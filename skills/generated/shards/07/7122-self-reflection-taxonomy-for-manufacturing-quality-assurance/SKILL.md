...
## Metadata
- skill_id: `u07122-self-reflection-taxonomy-for-manufacturing-quality-assurance`
- capability: `Self-reflection taxonomy for manufacturing quality assurance`
...
## Musts
- [ ] Confirm the request explicitly matches `Self-reflection taxonomy for manufacturing quality assurance` in `manufacturing quality assurance`.
