...
## When To Use
Use this skill only when the request explicitly needs `Self-reflection taxonomy for manufacturing quality assurance` in manufacturing quality assurance and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Self-reflection taxonomy for manufacturing quality assurance** outcomes (not generic brainstorming).
...
1. **Incident stabilization in manufacturing quality assurance" capability in production for manufacturing quality assurance workflows**
   - Input: noisy upstream payload requiring self-reflection taxonomy for manufacturing quality assurance normalization/assessment.
