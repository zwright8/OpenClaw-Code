...
## Metadata
- skill_id: `u07274-continuous-improvement-planning-for-marketing-and-storytelling`
- capability: `Continuous Improvement Planning for marketing and storytelling`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for marketing and storytelling` in `marketing and storytelling`.
