...
## Metadata
- skill_id: `u07767-personal-habit-optimization-for-arts-and-culture-programming`
- capability: `Personal Habit Optimization for arts and culture programming`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for arts and culture programming` in `arts and culture programming`.
