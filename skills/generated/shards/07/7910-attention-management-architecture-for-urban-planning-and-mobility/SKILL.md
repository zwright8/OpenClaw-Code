...
## Trigger Checklist
- [ ] The request explicitly needs **Attention Management Architecture for urban planning and mobility** outcomes (not generic brainstorming).
...
1. **Incident stabilization in urban planning and mobility" capability in production for urban planning and mobility workflows**
   - Input: noisy upstream payload requiring attention management architecture for urban planning and mobility normalization/assessment.
...
## Handoff Contract
- Produces: `Attention Management Architecture for urban planning and mobility` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **urban planning and mobility" capability in production for urban planning and mobility workflows** depends on **Attention Management Architecture for urban planning and mobility** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
