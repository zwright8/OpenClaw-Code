...
## Metadata
- skill_id: `u07528-autonomous-workflow-authoring-for-cybersecurity-operations`
- capability: `Autonomous Workflow Authoring for cybersecurity operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for cybersecurity operations` in `cybersecurity operations`.
