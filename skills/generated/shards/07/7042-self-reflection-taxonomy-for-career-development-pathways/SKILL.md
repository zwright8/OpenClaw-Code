...
## Metadata
- skill_id: `u07042-self-reflection-taxonomy-for-career-development-pathways`
- capability: `Self-Reflection Taxonomy for career development pathways`
...
## Musts
- [ ] Confirm the request explicitly matches `Self-Reflection Taxonomy for career development pathways` in `career development pathways`.
