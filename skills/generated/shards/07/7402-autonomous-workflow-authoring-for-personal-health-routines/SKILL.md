...
## Metadata
- skill_id: `u07402-autonomous-workflow-authoring-for-personal-health-routines`
- capability: `Autonomous Workflow Authoring for personal health routines`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for personal health routines` in `personal health routines`.
