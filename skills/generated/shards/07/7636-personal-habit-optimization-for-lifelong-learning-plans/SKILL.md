...
## Metadata
- skill_id: `u07636-personal-habit-optimization-for-lifelong-learning-plans`
- capability: `Personal Habit Optimization for lifelong learning plans`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for lifelong learning plans` in `lifelong learning plans`.
