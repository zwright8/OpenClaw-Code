...
## Metadata
- skill_id: `u07957-attention-management-architecture-for-eldercare-coordination`
- capability: `Attention Management Architecture for eldercare coordination`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for eldercare coordination` in `eldercare coordination`.
