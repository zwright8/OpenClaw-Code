...
## Metadata
- skill_id: `u07033-self-reflection-taxonomy-for-mental-well-being-practices`
- capability: `Self-Reflection Taxonomy for mental well-being practices`
...
## Musts
- [ ] Confirm the request explicitly matches `Self-Reflection Taxonomy for mental well-being practices` in `mental well-being practices`.
