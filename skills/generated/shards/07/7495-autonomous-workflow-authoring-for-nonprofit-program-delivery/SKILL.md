...
## Metadata
- skill_id: `u07495-autonomous-workflow-authoring-for-nonprofit-program-delivery`
- capability: `Autonomous Workflow Authoring for nonprofit program delivery`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for nonprofit program delivery` in `nonprofit program delivery`.
