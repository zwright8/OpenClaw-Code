...
description: Operate the "Attention Management Architecture for agriculture and food systems" capability in production for agriculture and food systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Attention Management Architecture for agriculture and food systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in agriculture and food systems" capability in production for agriculture and food systems workflows**
   - Input: noisy upstream payload requiring attention management architecture for agriculture and food systems normalization/assessment.
...
## Handoff Contract
- Produces: `Attention Management Architecture for agriculture and food systems` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **agriculture and food systems" capability in production for agriculture and food systems workflows** depends on **Attention Management Architecture for agriculture and food systems** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
