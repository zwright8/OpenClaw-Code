# Regression Case — Continuous Improvement Planning for legal and policy workflows

## Goal
Verify deterministic tolerance enforcement and fail-closed behavior for legal and policy workflows.
