...
## Metadata
- skill_id: `u07975-attention-management-architecture-for-music-and-creative-practice`
- capability: `Attention Management Architecture for music and creative practice`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for music and creative practice` in `music and creative practice`.
