...
## Metadata
- skill_id: `u07436-autonomous-workflow-authoring-for-lifelong-learning-plans`
- capability: `Autonomous Workflow Authoring for lifelong learning plans`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for lifelong learning plans` in `lifelong learning plans`.
