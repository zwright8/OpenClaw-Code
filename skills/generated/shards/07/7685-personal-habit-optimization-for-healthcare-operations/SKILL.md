...
## Metadata
- skill_id: `u07685-personal-habit-optimization-for-healthcare-operations`
- capability: `Personal Habit Optimization for healthcare operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for healthcare operations` in `healthcare operations`.
