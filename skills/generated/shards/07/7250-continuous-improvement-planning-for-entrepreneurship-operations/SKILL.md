...
## Metadata
- skill_id: `u07250-continuous-improvement-planning-for-entrepreneurship-operations`
- capability: `Continuous Improvement Planning for entrepreneurship operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for entrepreneurship operations` in `entrepreneurship operations`.
