...
## Metadata
- skill_id: `u07909-attention-management-architecture-for-urban-planning-and-mobility`
- capability: `Attention Management Architecture for urban planning and mobility`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for urban planning and mobility` in `urban planning and mobility`.
