...
| Feature flag | `skill_07206_continuous-improvement-plannin` |
| Release cycles | `2` |

## Why This Skill Exists
Use continuous improvement planning in family caregiving systems with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Continuous Improvement Planning for family caregiving systems under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Continuous Improvement Planning for family caregiving systems under maximally truth-seeking conditions.
