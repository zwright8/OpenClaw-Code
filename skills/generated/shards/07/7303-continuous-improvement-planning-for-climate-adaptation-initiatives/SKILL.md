...
description: Build and operate the "Continuous Improvement Planning for climate adaptation initiatives" capability for climate adaptation initiatives. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for climate adaptation initiatives** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **climate adaptation initiatives" capability for climate adaptation initiatives** with measurable acceptance criteria.
...
- **Daily:** Run when new climate adaptation initiatives" capability for climate adaptation initiatives signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in climate adaptation initiatives" capability for climate adaptation initiatives**
   - Input: noisy upstream payload requiring continuous improvement planning for climate adaptation initiatives normalization/assessment.
...
## Handoff Contract
- Produces: `Continuous Improvement Planning for climate adaptation initiatives` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **climate adaptation initiatives" capability for climate adaptation initiatives** depends on **Continuous Improvement Planning for climate adaptation initiatives** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
