...
description: Build and operate the "Continuous Improvement Planning for disaster response networks" capability for disaster response networks. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for disaster response networks** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **disaster response networks" capability for disaster response networks** with measurable acceptance criteria.
...
- **Daily:** Run when new disaster response networks" capability for disaster response networks signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in disaster response networks" capability for disaster response networks**
   - Input: noisy upstream payload requiring continuous improvement planning for disaster response networks normalization/assessment.
...
## Handoff Contract
- Produces: `Continuous Improvement Planning for disaster response networks` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **disaster response networks" capability for disaster response networks** depends on **Continuous Improvement Planning for disaster response networks** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
