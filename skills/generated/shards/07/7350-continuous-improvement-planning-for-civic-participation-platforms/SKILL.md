...
This skill hardens a generated capability for production execution so civic participation platforms workflows remain deterministic, auditable, and fail-closed under risk.

## When To Use
Use this skill only when the request explicitly needs `Continuous Improvement Planning for civic participation platforms` in civic participation platforms and a downstream consumer requires contract-bound artifacts.
