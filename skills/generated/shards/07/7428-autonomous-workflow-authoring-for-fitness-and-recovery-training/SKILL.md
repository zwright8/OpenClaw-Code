...
## Metadata
- skill_id: `u07428-autonomous-workflow-authoring-for-fitness-and-recovery-training`
- capability: `Autonomous Workflow Authoring for fitness and recovery training`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for fitness and recovery training` in `fitness and recovery training`.
