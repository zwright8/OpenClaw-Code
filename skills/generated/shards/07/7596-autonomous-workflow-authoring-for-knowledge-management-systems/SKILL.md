...
## Metadata
- skill_id: `u07596-autonomous-workflow-authoring-for-knowledge-management-systems`
- capability: `Autonomous Workflow Authoring for knowledge management systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for knowledge management systems` in `knowledge management systems`.
