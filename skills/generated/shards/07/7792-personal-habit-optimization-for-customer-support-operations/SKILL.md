...
## Metadata
- skill_id: `u07792-personal-habit-optimization-for-customer-support-operations`
- capability: `Personal Habit Optimization for customer support operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for customer support operations` in `customer support operations`.
