...
## Trigger Checklist
- [ ] The request explicitly needs **Attention Management Architecture for marketing and storytelling** outcomes (not generic brainstorming).
...
1. **Incident stabilization in marketing and storytelling" capability in production for marketing and storytelling workflows**
   - Input: noisy upstream payload requiring attention management architecture for marketing and storytelling normalization/assessment.
...
## Handoff Contract
- Produces: `Attention Management Architecture for marketing and storytelling` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **marketing and storytelling" capability in production for marketing and storytelling workflows** depends on **Attention Management Architecture for marketing and storytelling** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
