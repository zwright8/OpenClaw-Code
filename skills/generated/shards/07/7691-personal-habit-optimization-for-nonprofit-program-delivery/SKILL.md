...
## When To Use
Use this skill only when the request explicitly needs `Personal Habit Optimization for nonprofit program delivery` in nonprofit program delivery and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Personal Habit Optimization for nonprofit program delivery** outcomes (not generic brainstorming).
...
1. **Incident stabilization in nonprofit program delivery" capability for nonprofit program delivery**
   - Input: noisy upstream payload requiring personal habit optimization for nonprofit program delivery normalization/assessment.
