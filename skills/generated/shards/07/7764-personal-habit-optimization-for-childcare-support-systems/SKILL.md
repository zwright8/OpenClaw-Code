...
## Metadata
- skill_id: `u07764-personal-habit-optimization-for-childcare-support-systems`
- capability: `Personal Habit Optimization for childcare support systems`
...
## Musts
- [ ] Confirm the request explicitly matches `Personal Habit Optimization for childcare support systems` in `childcare support systems`.
