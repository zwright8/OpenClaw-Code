...
## Metadata
- skill_id: `u07444-autonomous-workflow-authoring-for-career-development-pathways`
- capability: `Autonomous Workflow Authoring for career development pathways`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for career development pathways` in `career development pathways`.
