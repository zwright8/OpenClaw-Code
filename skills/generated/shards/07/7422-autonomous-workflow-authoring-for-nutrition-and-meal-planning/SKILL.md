...
## Metadata
- skill_id: `u07422-autonomous-workflow-authoring-for-nutrition-and-meal-planning`
- capability: `Autonomous Workflow Authoring for nutrition and meal planning`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for nutrition and meal planning` in `nutrition and meal planning`.
