...
## When To Use
Use this skill only when the request explicitly needs `Continuous Improvement Planning for music and creative practice` in music and creative practice and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for music and creative practice** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **music and creative practice" capability for music and creative practice** with measurable acceptance criteria.
...
- **Daily:** Run when new music and creative practice" capability for music and creative practice signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in music and creative practice" capability for music and creative practice**
   - Input: noisy upstream payload requiring continuous improvement planning for music and creative practice normalization/assessment.
