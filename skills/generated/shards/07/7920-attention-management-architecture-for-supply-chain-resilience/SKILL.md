...
## Metadata
- skill_id: `u07920-attention-management-architecture-for-supply-chain-resilience`
- capability: `Attention Management Architecture for supply chain resilience`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for supply chain resilience` in `supply chain resilience`.
