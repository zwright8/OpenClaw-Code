...
## Metadata
- skill_id: `u07924-attention-management-architecture-for-manufacturing-quality-assurance`
- capability: `Attention Management Architecture for manufacturing quality assurance`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for manufacturing quality assurance` in `manufacturing quality assurance`.
