...
## Metadata
- skill_id: `u07418-autonomous-workflow-authoring-for-personal-finance-management`
- capability: `Autonomous Workflow Authoring for personal finance management`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for personal finance management` in `personal finance management`.
