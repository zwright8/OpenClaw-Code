...
## Metadata
- skill_id: `u07500-autonomous-workflow-authoring-for-disaster-response-networks`
- capability: `Autonomous Workflow Authoring for disaster response networks`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for disaster response networks` in `disaster response networks`.
