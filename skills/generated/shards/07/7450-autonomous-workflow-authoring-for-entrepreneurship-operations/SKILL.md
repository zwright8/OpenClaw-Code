...
## Metadata
- skill_id: `u07450-autonomous-workflow-authoring-for-entrepreneurship-operations`
- capability: `Autonomous Workflow Authoring for entrepreneurship operations`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for entrepreneurship operations` in `entrepreneurship operations`.
