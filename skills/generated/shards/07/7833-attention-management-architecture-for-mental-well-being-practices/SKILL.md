...
## Metadata
- skill_id: `u07833-attention-management-architecture-for-mental-well-being-practices`
- capability: `Attention Management Architecture for mental well-being practices`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for mental well-being practices` in `mental well-being practices`.
