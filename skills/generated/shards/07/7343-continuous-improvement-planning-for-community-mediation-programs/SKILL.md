...
description: Build and operate the "Continuous Improvement Planning for community mediation programs" capability for community mediation programs. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for community mediation programs** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **community mediation programs" capability for community mediation programs** with measurable acceptance criteria.
...
- **Daily:** Run when new community mediation programs" capability for community mediation programs signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in community mediation programs" capability for community mediation programs**
   - Input: noisy upstream payload requiring continuous improvement planning for community mediation programs normalization/assessment.
...
## Handoff Contract
- Produces: `Continuous Improvement Planning for community mediation programs` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **community mediation programs" capability for community mediation programs** depends on **Continuous Improvement Planning for community mediation programs** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
