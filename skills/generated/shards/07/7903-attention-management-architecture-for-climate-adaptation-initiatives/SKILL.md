...
## Trigger Checklist
- [ ] The request explicitly needs **Attention Management Architecture for climate adaptation initiatives** outcomes (not generic brainstorming).
...
1. **Incident stabilization in climate adaptation initiatives" capability in production for climate adaptation initiatives workflows**
   - Input: noisy upstream payload requiring attention management architecture for climate adaptation initiatives normalization/assessment.
...
## Handoff Contract
- Produces: `Attention Management Architecture for climate adaptation initiatives` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **climate adaptation initiatives" capability in production for climate adaptation initiatives workflows** depends on **Attention Management Architecture for climate adaptation initiatives** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
