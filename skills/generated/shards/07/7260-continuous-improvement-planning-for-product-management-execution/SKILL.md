...
## When To Use
Use this skill only when the request explicitly needs `Continuous Improvement Planning for product management execution` in product management execution and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for product management execution** outcomes (not generic brainstorming).
...
1. **Incident stabilization in product management execution" capability for product management execution**
   - Input: noisy upstream payload requiring continuous improvement planning for product management execution normalization/assessment.
