...
## Trigger Checklist
- [ ] The request explicitly needs **Attention Management Architecture for software engineering delivery** outcomes (not generic brainstorming).
...
1. **Incident stabilization in software engineering delivery" capability in production for software engineering delivery workflows**
   - Input: noisy upstream payload requiring attention management architecture for software engineering delivery normalization/assessment.
...
## Handoff Contract
- Produces: `Attention Management Architecture for software engineering delivery` execution artifacts + scorecard + risk/confidence metadata.
