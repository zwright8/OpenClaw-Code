...
## Metadata
- skill_id: `u07855-attention-management-architecture-for-software-engineering-delivery`
- capability: `Attention Management Architecture for software engineering delivery`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for software engineering delivery` in `software engineering delivery`.
