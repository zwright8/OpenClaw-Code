...
## Metadata
- skill_id: `u07259-continuous-improvement-planning-for-product-management-execution`
- capability: `Continuous Improvement Planning for product management execution`
...
## Musts
- [ ] Confirm the request explicitly matches `Continuous Improvement Planning for product management execution` in `product management execution`.
