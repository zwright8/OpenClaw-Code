...
## Trigger Checklist
- [ ] The request explicitly needs **Attention Management Architecture for eldercare coordination** outcomes (not generic brainstorming).
...
1. **Incident stabilization in eldercare coordination" capability in production for eldercare coordination workflows**
   - Input: noisy upstream payload requiring attention management architecture for eldercare coordination normalization/assessment.
...
## Handoff Contract
- Produces: `Attention Management Architecture for eldercare coordination` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **eldercare coordination" capability in production for eldercare coordination workflows** depends on **Attention Management Architecture for eldercare coordination** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
