...
description: Build and operate the "Continuous Improvement Planning for urban planning and mobility" capability for urban planning and mobility. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Continuous Improvement Planning for urban planning and mobility** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **urban planning and mobility" capability for urban planning and mobility** with measurable acceptance criteria.
...
- **Daily:** Run when new urban planning and mobility" capability for urban planning and mobility signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in urban planning and mobility" capability for urban planning and mobility**
   - Input: noisy upstream payload requiring continuous improvement planning for urban planning and mobility normalization/assessment.
...
## Handoff Contract
- Produces: `Continuous Improvement Planning for urban planning and mobility` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **urban planning and mobility" capability for urban planning and mobility** depends on **Continuous Improvement Planning for urban planning and mobility** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
