...
## Metadata
- skill_id: `u07821-attention-management-architecture-for-nutrition-and-meal-planning`
- capability: `Attention Management Architecture for nutrition and meal planning`
...
## Musts
- [ ] Confirm the request explicitly matches `Attention Management Architecture for nutrition and meal planning` in `nutrition and meal planning`.
