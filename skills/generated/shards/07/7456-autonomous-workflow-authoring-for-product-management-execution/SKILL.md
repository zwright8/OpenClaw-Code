...
## Metadata
- skill_id: `u07456-autonomous-workflow-authoring-for-product-management-execution`
- capability: `Autonomous Workflow Authoring for product management execution`
...
## Musts
- [ ] Confirm the request explicitly matches `Autonomous Workflow Authoring for product management execution` in `product management execution`.
