---
name: u07456-autonomous-workflow-authoring-for-product-management-execution
description: Build and operate the "Autonomous Workflow Authoring for product management execution" capability for product management execution. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## When To Use
Use this skill only when the request explicitly needs `Autonomous Workflow Authoring for product management execution` in product management execution and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Autonomous Workflow Authoring for product management execution** outcomes (not generic brainstorming).
...
1. **Incident stabilization in product management execution" capability for product management execution**
   - Input: noisy upstream payload requiring autonomous workflow authoring for product management execution normalization/assessment.
