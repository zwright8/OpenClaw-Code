...
## When To Use
Use this skill only when the request explicitly needs `Personal Habit Optimization for journalism and public communication` in journalism and public communication and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Personal Habit Optimization for journalism and public communication** outcomes (not generic brainstorming).
...
1. **Incident stabilization in journalism and public communication" capability for journalism and public communication**
   - Input: noisy upstream payload requiring personal habit optimization for journalism and public communication normalization/assessment.
