...
## Metadata
- **Skill ID:** `u09097-public-service-coordination-for-disaster-response-networks`
- **Capability:** Public Service Coordination for disaster response networks
- **Domain:** disaster response networks
- **Purpose:** Operate the "Public Service Coordination for disaster response networks" capability in production for disaster response networks workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
