...
## Metadata
- **Skill ID:** `u09900-decision-journal-maintenance-for-disaster-response-networks`
- **Capability:** Decision Journal Maintenance for disaster response networks
- **Domain:** disaster response networks
- **Purpose:** Operate the "Decision Journal Maintenance for disaster response networks" capability in production for disaster response networks workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
