...
## Metadata
- **Skill ID:** `u09641-writing-and-rhetoric-optimization-for-career-development-pathways`
- **Capability:** Writing And Rhetoric Optimization for career development pathways
- **Domain:** career development pathways
- **Purpose:** Operate the "Writing And Rhetoric Optimization for career development pathways" capability in production for career development pathways workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
