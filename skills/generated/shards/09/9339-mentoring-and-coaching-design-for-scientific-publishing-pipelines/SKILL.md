...
## Metadata
- **Skill ID:** `u09339-mentoring-and-coaching-design-for-scientific-publishing-pipelines`
- **Capability:** Mentoring And Coaching Design for scientific publishing pipelines
- **Domain:** scientific publishing pipelines
- **Purpose:** Operate the "Mentoring And Coaching Design for scientific publishing pipelines" capability in production for scientific publishing pipelines workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
