...
## Metadata
- **Skill ID:** `u09856-decision-journal-maintenance-for-product-management-execution`
- **Capability:** Decision Journal Maintenance for product management execution
- **Domain:** product management execution
- **Purpose:** Operate the "Decision Journal Maintenance for product management execution" capability in production for product management execution workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
