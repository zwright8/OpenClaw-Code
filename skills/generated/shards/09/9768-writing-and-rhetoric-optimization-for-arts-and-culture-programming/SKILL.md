...
## Metadata
- **Skill ID:** `u09768-writing-and-rhetoric-optimization-for-arts-and-culture-programming`
- **Capability:** Writing And Rhetoric Optimization for arts and culture programming
- **Domain:** arts and culture programming
- **Purpose:** Operate the "Writing And Rhetoric Optimization for arts and culture programming" capability in production for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
