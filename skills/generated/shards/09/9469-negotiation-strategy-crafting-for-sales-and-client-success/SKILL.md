...
## Metadata
- **Skill ID:** `u09469-negotiation-strategy-crafting-for-sales-and-client-success`
- **Capability:** Negotiation Strategy Crafting for sales and client success
- **Domain:** sales and client success
- **Purpose:** Operate the "Negotiation Strategy Crafting for sales and client success" capability in production for sales and client success workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
