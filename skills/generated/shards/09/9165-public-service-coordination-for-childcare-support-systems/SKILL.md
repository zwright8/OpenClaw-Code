...
## Metadata
- **Skill ID:** `u09165-public-service-coordination-for-childcare-support-systems`
- **Capability:** Public Service Coordination for childcare support systems
- **Domain:** childcare support systems
- **Purpose:** Operate the "Public Service Coordination for childcare support systems" capability in production for childcare support systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
