...
## Metadata
- **Skill ID:** `u09258-mentoring-and-coaching-design-for-product-management-execution`
- **Capability:** Mentoring And Coaching Design for product management execution
- **Domain:** product management execution
- **Purpose:** Operate the "Mentoring And Coaching Design for product management execution" capability in production for product management execution workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
