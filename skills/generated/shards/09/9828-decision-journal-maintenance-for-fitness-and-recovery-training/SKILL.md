...
## Metadata
- **Skill ID:** `u09828-decision-journal-maintenance-for-fitness-and-recovery-training`
- **Capability:** Decision Journal Maintenance for fitness and recovery training
- **Domain:** fitness and recovery training
- **Purpose:** Operate the "Decision Journal Maintenance for fitness and recovery training" capability in production for fitness and recovery training workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
