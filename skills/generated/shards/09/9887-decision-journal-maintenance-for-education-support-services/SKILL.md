...
## Metadata
- **Skill ID:** `u09887-decision-journal-maintenance-for-education-support-services`
- **Capability:** Decision Journal Maintenance for education support services
- **Domain:** education support services
- **Purpose:** Operate the "Decision Journal Maintenance for education support services" capability in production for education support services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
