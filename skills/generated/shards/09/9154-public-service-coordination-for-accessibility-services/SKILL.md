...
## Metadata
- **Skill ID:** `u09154-public-service-coordination-for-accessibility-services`
- **Capability:** Public Service Coordination for accessibility services
- **Domain:** accessibility services
- **Purpose:** Operate the "Public Service Coordination for accessibility services" capability in production for accessibility services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
