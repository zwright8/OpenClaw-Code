...
| Feature flag | `skill_09664_writing-and-rhetoric-optimizat` |
| Release cycles | `2` |

## Why This Skill Exists
Use writing and rhetoric optimization in design and user research with emphasis on throughput, reliability, leverage, and execution speed.
...
5. Run unit, integration, simulation, and regression suites for Writing And Rhetoric Optimization for design and user research under hyper-productive autonomy conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Writing And Rhetoric Optimization for design and user research under hyper-productive autonomy conditions.
...
1. `OR-Tools/Pyomo` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `writing-and-rhetoric-optimization-artifact-design-and-user-resea`.
2. `Pandas/Polars` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `writing-and-rhetoric-optimization-artifact-design-and-user-resea`.
3. `Great Expectations` -> auth preflight, execute read/query call(s), normalize output, and attach trace to `writing-and-rhetoric-optimization-artifact-design-and-user-resea`.
