...
## Metadata
- **Skill ID:** `u09652-writing-and-rhetoric-optimization-for-software-engineering-delivery`
- **Capability:** Writing And Rhetoric Optimization for software engineering delivery
- **Domain:** software engineering delivery
- **Purpose:** Operate the "Writing And Rhetoric Optimization for software engineering delivery" capability in production for software engineering delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
