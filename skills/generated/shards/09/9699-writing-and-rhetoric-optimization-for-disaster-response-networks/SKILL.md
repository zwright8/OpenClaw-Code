...
## Metadata
- **Skill ID:** `u09699-writing-and-rhetoric-optimization-for-disaster-response-networks`
- **Capability:** Writing And Rhetoric Optimization for disaster response networks
- **Domain:** disaster response networks
- **Purpose:** Operate the "Writing And Rhetoric Optimization for disaster response networks" capability in production for disaster response networks workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
