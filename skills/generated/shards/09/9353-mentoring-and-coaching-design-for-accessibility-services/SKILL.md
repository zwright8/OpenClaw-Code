...
## Metadata
- **Skill ID:** `u09353-mentoring-and-coaching-design-for-accessibility-services`
- **Capability:** Mentoring And Coaching Design for accessibility services
- **Domain:** accessibility services
- **Purpose:** Operate the "Mentoring And Coaching Design for accessibility services" capability in production for accessibility services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
