...
## Metadata
- **Skill ID:** `u09489-negotiation-strategy-crafting-for-education-support-services`
- **Capability:** Negotiation Strategy Crafting for education support services
- **Domain:** education support services
- **Purpose:** Operate the "Negotiation Strategy Crafting for education support services" capability in production for education support services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
