...
## Metadata
- **Skill ID:** `u09693-writing-and-rhetoric-optimization-for-nonprofit-program-delivery`
- **Capability:** Writing And Rhetoric Optimization for nonprofit program delivery
- **Domain:** nonprofit program delivery
- **Purpose:** Operate the "Writing And Rhetoric Optimization for nonprofit program delivery" capability in production for nonprofit program delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
