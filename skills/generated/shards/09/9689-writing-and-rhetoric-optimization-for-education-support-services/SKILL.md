...
## Metadata
- **Skill ID:** `u09689-writing-and-rhetoric-optimization-for-education-support-services`
- **Capability:** Writing And Rhetoric Optimization for education support services
- **Domain:** education support services
- **Purpose:** Operate the "Writing And Rhetoric Optimization for education support services" capability in production for education support services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
