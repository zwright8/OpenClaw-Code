...
## Metadata
- **Skill ID:** `u09545-negotiation-strategy-crafting-for-community-mediation-programs`
- **Capability:** Negotiation Strategy Crafting for community mediation programs
- **Domain:** community mediation programs
- **Purpose:** Operate the "Negotiation Strategy Crafting for community mediation programs" capability in production for community mediation programs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
