...
## Metadata
- **Skill ID:** `u09730-writing-and-rhetoric-optimization-for-cybersecurity-operations`
- **Capability:** Writing And Rhetoric Optimization for cybersecurity operations
- **Domain:** cybersecurity operations
- **Purpose:** Operate the "Writing And Rhetoric Optimization for cybersecurity operations" capability in production for cybersecurity operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
