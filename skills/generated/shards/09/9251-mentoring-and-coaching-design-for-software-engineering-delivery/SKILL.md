...
## Metadata
- **Skill ID:** `u09251-mentoring-and-coaching-design-for-software-engineering-delivery`
- **Capability:** Mentoring And Coaching Design for software engineering delivery
- **Domain:** software engineering delivery
- **Purpose:** Operate the "Mentoring And Coaching Design for software engineering delivery" capability in production for software engineering delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
