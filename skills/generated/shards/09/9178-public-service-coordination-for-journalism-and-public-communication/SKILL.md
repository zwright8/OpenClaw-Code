...
## Metadata
- **Skill ID:** `u09178-public-service-coordination-for-journalism-and-public-communication`
- **Capability:** Public Service Coordination for journalism and public communication
- **Domain:** journalism and public communication
- **Purpose:** Operate the "Public Service Coordination for journalism and public communication" capability in production for journalism and public communication workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
