...
## Metadata
- **Skill ID:** `u09956-decision-journal-maintenance-for-eldercare-coordination`
- **Capability:** Decision Journal Maintenance for eldercare coordination
- **Domain:** eldercare coordination
- **Purpose:** Operate the "Decision Journal Maintenance for eldercare coordination" capability in production for eldercare coordination workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
