...
## Metadata
- **Skill ID:** `u09747-writing-and-rhetoric-optimization-for-civic-participation-platforms`
- **Capability:** Writing And Rhetoric Optimization for civic participation platforms
- **Domain:** civic participation platforms
- **Purpose:** Operate the "Writing And Rhetoric Optimization for civic participation platforms" capability in production for civic participation platforms workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
