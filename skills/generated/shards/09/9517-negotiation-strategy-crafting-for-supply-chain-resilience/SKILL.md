...
## Metadata
- **Skill ID:** `u09517-negotiation-strategy-crafting-for-supply-chain-resilience`
- **Capability:** Negotiation Strategy Crafting for supply chain resilience
- **Domain:** supply chain resilience
- **Purpose:** Operate the "Negotiation Strategy Crafting for supply chain resilience" capability in production for supply chain resilience workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
