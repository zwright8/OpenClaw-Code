...
## Metadata
- **Skill ID:** `u09950-decision-journal-maintenance-for-civic-participation-platforms`
- **Capability:** Decision Journal Maintenance for civic participation platforms
- **Domain:** civic participation platforms
- **Purpose:** Operate the "Decision Journal Maintenance for civic participation platforms" capability in production for civic participation platforms workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
