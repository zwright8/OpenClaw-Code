...
## Metadata
- **Skill ID:** `u09931-decision-journal-maintenance-for-research-and-development-labs`
- **Capability:** Decision Journal Maintenance for research and development labs
- **Domain:** research and development labs
- **Purpose:** Operate the "Decision Journal Maintenance for research and development labs" capability in production for research and development labs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
