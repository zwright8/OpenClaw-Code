...
## Metadata
- **Skill ID:** `u09927-decision-journal-maintenance-for-cybersecurity-operations`
- **Capability:** Decision Journal Maintenance for cybersecurity operations
- **Domain:** cybersecurity operations
- **Purpose:** Operate the "Decision Journal Maintenance for cybersecurity operations" capability in production for cybersecurity operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
