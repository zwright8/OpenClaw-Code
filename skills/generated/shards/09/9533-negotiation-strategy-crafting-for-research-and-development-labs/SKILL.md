...
## Metadata
- **Skill ID:** `u09533-negotiation-strategy-crafting-for-research-and-development-labs`
- **Capability:** Negotiation Strategy Crafting for research and development labs
- **Domain:** research and development labs
- **Purpose:** Operate the "Negotiation Strategy Crafting for research and development labs" capability in production for research and development labs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
