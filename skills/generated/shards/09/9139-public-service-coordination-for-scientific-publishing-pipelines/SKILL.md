...
## Metadata
- **Skill ID:** `u09139-public-service-coordination-for-scientific-publishing-pipelines`
- **Capability:** Public Service Coordination for scientific publishing pipelines
- **Domain:** scientific publishing pipelines
- **Purpose:** Operate the "Public Service Coordination for scientific publishing pipelines" capability in production for scientific publishing pipelines workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
