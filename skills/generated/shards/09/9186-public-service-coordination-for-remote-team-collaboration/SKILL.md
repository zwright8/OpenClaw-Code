...
## Metadata
- **Skill ID:** `u09186-public-service-coordination-for-remote-team-collaboration`
- **Capability:** Public Service Coordination for remote team collaboration
- **Domain:** remote team collaboration
- **Purpose:** Operate the "Public Service Coordination for remote team collaboration" capability in production for remote team collaboration workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
