...
## Metadata
- **Skill ID:** `u09582-negotiation-strategy-crafting-for-multilingual-translation-services`
- **Capability:** Negotiation Strategy Crafting for multilingual translation services
- **Domain:** multilingual translation services
- **Purpose:** Operate the "Negotiation Strategy Crafting for multilingual translation services" capability in production for multilingual translation services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
