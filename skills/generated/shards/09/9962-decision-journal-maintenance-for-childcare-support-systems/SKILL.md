...
## Metadata
- **Skill ID:** `u09962-decision-journal-maintenance-for-childcare-support-systems`
- **Capability:** Decision Journal Maintenance for childcare support systems
- **Domain:** childcare support systems
- **Purpose:** Operate the "Decision Journal Maintenance for childcare support systems" capability in production for childcare support systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
