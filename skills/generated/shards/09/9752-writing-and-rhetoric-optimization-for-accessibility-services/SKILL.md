...
## Metadata
- **Skill ID:** `u09752-writing-and-rhetoric-optimization-for-accessibility-services`
- **Capability:** Writing And Rhetoric Optimization for accessibility services
- **Domain:** accessibility services
- **Purpose:** Operate the "Writing And Rhetoric Optimization for accessibility services" capability in production for accessibility services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
