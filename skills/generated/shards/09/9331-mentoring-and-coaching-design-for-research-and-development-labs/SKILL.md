...
## Metadata
- **Skill ID:** `u09331-mentoring-and-coaching-design-for-research-and-development-labs`
- **Capability:** Mentoring And Coaching Design for research and development labs
- **Domain:** research and development labs
- **Purpose:** Operate the "Mentoring And Coaching Design for research and development labs" capability in production for research and development labs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
