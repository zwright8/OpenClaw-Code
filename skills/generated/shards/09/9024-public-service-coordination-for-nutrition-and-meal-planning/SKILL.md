...
## Metadata
- **Skill ID:** `u09024-public-service-coordination-for-nutrition-and-meal-planning`
- **Capability:** Public Service Coordination for nutrition and meal planning
- **Domain:** nutrition and meal planning
- **Purpose:** Operate the "Public Service Coordination for nutrition and meal planning" capability in production for nutrition and meal planning workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
