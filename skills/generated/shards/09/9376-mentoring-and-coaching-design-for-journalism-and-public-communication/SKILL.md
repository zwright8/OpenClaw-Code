...
## Metadata
- **Skill ID:** `u09376-mentoring-and-coaching-design-for-journalism-and-public-communication`
- **Capability:** Mentoring And Coaching Design for journalism and public communication
- **Domain:** journalism and public communication
- **Purpose:** Operate the "Mentoring And Coaching Design for journalism and public communication" capability in production for journalism and public communication workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
