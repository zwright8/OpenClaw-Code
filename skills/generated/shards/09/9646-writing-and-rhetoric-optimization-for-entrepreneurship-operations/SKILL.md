...
## Metadata
- **Skill ID:** `u09646-writing-and-rhetoric-optimization-for-entrepreneurship-operations`
- **Capability:** Writing And Rhetoric Optimization for entrepreneurship operations
- **Domain:** entrepreneurship operations
- **Purpose:** Operate the "Writing And Rhetoric Optimization for entrepreneurship operations" capability in production for entrepreneurship operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
