...
## Metadata
- **Skill ID:** `u09089-public-service-coordination-for-education-support-services`
- **Capability:** Public Service Coordination for education support services
- **Domain:** education support services
- **Purpose:** Operate the "Public Service Coordination for education support services" capability in production for education support services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
