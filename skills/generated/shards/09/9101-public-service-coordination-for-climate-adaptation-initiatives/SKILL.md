...
## Metadata
- **Skill ID:** `u09101-public-service-coordination-for-climate-adaptation-initiatives`
- **Capability:** Public Service Coordination for climate adaptation initiatives
- **Domain:** climate adaptation initiatives
- **Purpose:** Operate the "Public Service Coordination for climate adaptation initiatives" capability in production for climate adaptation initiatives workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
