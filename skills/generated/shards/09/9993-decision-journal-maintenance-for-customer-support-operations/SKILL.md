...
## Metadata
- **Skill ID:** `u09993-decision-journal-maintenance-for-customer-support-operations`
- **Capability:** Decision Journal Maintenance for customer support operations
- **Domain:** customer support operations
- **Purpose:** Operate the "Decision Journal Maintenance for customer support operations" capability in production for customer support operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
