...
## Metadata
- **Skill ID:** `u09183-public-service-coordination-for-multilingual-translation-services`
- **Capability:** Public Service Coordination for multilingual translation services
- **Domain:** multilingual translation services
- **Purpose:** Operate the "Public Service Coordination for multilingual translation services" capability in production for multilingual translation services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
