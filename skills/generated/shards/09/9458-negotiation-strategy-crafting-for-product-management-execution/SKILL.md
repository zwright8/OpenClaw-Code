...
## Metadata
- **Skill ID:** `u09458-negotiation-strategy-crafting-for-product-management-execution`
- **Capability:** Negotiation Strategy Crafting for product management execution
- **Domain:** product management execution
- **Purpose:** Operate the "Negotiation Strategy Crafting for product management execution" capability in production for product management execution workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
