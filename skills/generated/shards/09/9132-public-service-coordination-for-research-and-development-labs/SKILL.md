...
## Metadata
- **Skill ID:** `u09132-public-service-coordination-for-research-and-development-labs`
- **Capability:** Public Service Coordination for research and development labs
- **Domain:** research and development labs
- **Purpose:** Operate the "Public Service Coordination for research and development labs" capability in production for research and development labs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
