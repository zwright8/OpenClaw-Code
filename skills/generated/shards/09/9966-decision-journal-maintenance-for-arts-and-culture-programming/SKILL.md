...
## Metadata
- **Skill ID:** `u09966-decision-journal-maintenance-for-arts-and-culture-programming`
- **Capability:** Decision Journal Maintenance for arts and culture programming
- **Domain:** arts and culture programming
- **Purpose:** Operate the "Decision Journal Maintenance for arts and culture programming" capability in production for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
