...
## Metadata
- **Skill ID:** `u09194-public-service-coordination-for-customer-support-operations`
- **Capability:** Public Service Coordination for customer support operations
- **Domain:** customer support operations
- **Purpose:** Operate the "Public Service Coordination for customer support operations" capability in production for customer support operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
