...
## Metadata
- **Skill ID:** `u09880-decision-journal-maintenance-for-legal-and-policy-workflows`
- **Capability:** Decision Journal Maintenance for legal and policy workflows
- **Domain:** legal and policy workflows
- **Purpose:** Operate the "Decision Journal Maintenance for legal and policy workflows" capability in production for legal and policy workflows workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
