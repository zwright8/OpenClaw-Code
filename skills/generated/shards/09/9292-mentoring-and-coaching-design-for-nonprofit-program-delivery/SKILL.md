...
## Metadata
- **Skill ID:** `u09292-mentoring-and-coaching-design-for-nonprofit-program-delivery`
- **Capability:** Mentoring And Coaching Design for nonprofit program delivery
- **Domain:** nonprofit program delivery
- **Purpose:** Operate the "Mentoring And Coaching Design for nonprofit program delivery" capability in production for nonprofit program delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
