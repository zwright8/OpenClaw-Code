...
## Metadata
- **Skill ID:** `u09365-mentoring-and-coaching-design-for-childcare-support-systems`
- **Capability:** Mentoring And Coaching Design for childcare support systems
- **Domain:** childcare support systems
- **Purpose:** Operate the "Mentoring And Coaching Design for childcare support systems" capability in production for childcare support systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
