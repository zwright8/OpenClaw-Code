...
## Metadata
- **Skill ID:** `u09169-public-service-coordination-for-arts-and-culture-programming`
- **Capability:** Public Service Coordination for arts and culture programming
- **Domain:** arts and culture programming
- **Purpose:** Operate the "Public Service Coordination for arts and culture programming" capability in production for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
