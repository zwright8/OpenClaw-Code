...
## Metadata
- **Skill ID:** `u09082-public-service-coordination-for-healthcare-operations`
- **Capability:** Public Service Coordination for healthcare operations
- **Domain:** healthcare operations
- **Purpose:** Operate the "Public Service Coordination for healthcare operations" capability in production for healthcare operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
