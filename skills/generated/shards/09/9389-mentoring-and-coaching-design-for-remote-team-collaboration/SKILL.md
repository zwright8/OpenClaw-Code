...
## Metadata
- **Skill ID:** `u09389-mentoring-and-coaching-design-for-remote-team-collaboration`
- **Capability:** Mentoring And Coaching Design for remote team collaboration
- **Domain:** remote team collaboration
- **Purpose:** Operate the "Mentoring And Coaching Design for remote team collaboration" capability in production for remote team collaboration workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
