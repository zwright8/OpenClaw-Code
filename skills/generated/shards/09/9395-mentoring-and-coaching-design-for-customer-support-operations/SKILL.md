...
## Metadata
- **Skill ID:** `u09395-mentoring-and-coaching-design-for-customer-support-operations`
- **Capability:** Mentoring And Coaching Design for customer support operations
- **Domain:** customer support operations
- **Purpose:** Operate the "Mentoring And Coaching Design for customer support operations" capability in production for customer support operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
