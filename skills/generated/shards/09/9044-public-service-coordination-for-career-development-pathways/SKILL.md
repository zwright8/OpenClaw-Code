...
## Metadata
- **Skill ID:** `u09044-public-service-coordination-for-career-development-pathways`
- **Capability:** Public Service Coordination for career development pathways
- **Domain:** career development pathways
- **Purpose:** Operate the "Public Service Coordination for career development pathways" capability in production for career development pathways workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
