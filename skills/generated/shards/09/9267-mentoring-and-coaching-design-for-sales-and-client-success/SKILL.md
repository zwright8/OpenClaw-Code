...
## Metadata
- **Skill ID:** `u09267-mentoring-and-coaching-design-for-sales-and-client-success`
- **Capability:** Mentoring And Coaching Design for sales and client success
- **Domain:** sales and client success
- **Purpose:** Operate the "Mentoring And Coaching Design for sales and client success" capability in production for sales and client success workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
