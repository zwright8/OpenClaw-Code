...
## Metadata
- **Skill ID:** `u09285-mentoring-and-coaching-design-for-healthcare-operations`
- **Capability:** Mentoring And Coaching Design for healthcare operations
- **Domain:** healthcare operations
- **Purpose:** Operate the "Mentoring And Coaching Design for healthcare operations" capability in production for healthcare operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
