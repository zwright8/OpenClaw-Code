...
## Metadata
- **Skill ID:** `u09594-negotiation-strategy-crafting-for-customer-support-operations`
- **Capability:** Negotiation Strategy Crafting for customer support operations
- **Domain:** customer support operations
- **Purpose:** Operate the "Negotiation Strategy Crafting for customer support operations" capability in production for customer support operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
