...
description: Operate the "Mentoring And Coaching Design for cybersecurity operations" capability in production for cybersecurity operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Mentoring And Coaching Design for cybersecurity operations` in cybersecurity operations and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Mentoring And Coaching Design for cybersecurity operations** outcomes (not generic brainstorming).
...
1. **Incident stabilization in cybersecurity operations" capability in production for cybersecurity operations workflows**
   - Input: noisy upstream payload requiring mentoring and coaching design for cybersecurity operations normalization/assessment.
