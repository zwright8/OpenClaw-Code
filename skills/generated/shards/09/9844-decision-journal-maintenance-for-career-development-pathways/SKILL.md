...
## Metadata
- **Skill ID:** `u09844-decision-journal-maintenance-for-career-development-pathways`
- **Capability:** Decision Journal Maintenance for career development pathways
- **Domain:** career development pathways
- **Purpose:** Operate the "Decision Journal Maintenance for career development pathways" capability in production for career development pathways workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
