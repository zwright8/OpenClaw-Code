...
## Metadata
- **Skill ID:** `u09684-writing-and-rhetoric-optimization-for-healthcare-operations`
- **Capability:** Writing And Rhetoric Optimization for healthcare operations
- **Domain:** healthcare operations
- **Purpose:** Operate the "Writing And Rhetoric Optimization for healthcare operations" capability in production for healthcare operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
