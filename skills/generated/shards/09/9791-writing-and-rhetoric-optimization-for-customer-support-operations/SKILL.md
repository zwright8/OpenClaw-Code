...
## Metadata
- **Skill ID:** `u09791-writing-and-rhetoric-optimization-for-customer-support-operations`
- **Capability:** Writing And Rhetoric Optimization for customer support operations
- **Domain:** customer support operations
- **Purpose:** Operate the "Writing And Rhetoric Optimization for customer support operations" capability in production for customer support operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
