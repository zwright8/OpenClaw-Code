...
## Metadata
- **Skill ID:** `u09884-decision-journal-maintenance-for-healthcare-operations`
- **Capability:** Decision Journal Maintenance for healthcare operations
- **Domain:** healthcare operations
- **Purpose:** Operate the "Decision Journal Maintenance for healthcare operations" capability in production for healthcare operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
