...
## Metadata
- **Skill ID:** `u09442-negotiation-strategy-crafting-for-career-development-pathways`
- **Capability:** Negotiation Strategy Crafting for career development pathways
- **Domain:** career development pathways
- **Purpose:** Operate the "Negotiation Strategy Crafting for career development pathways" capability in production for career development pathways workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
