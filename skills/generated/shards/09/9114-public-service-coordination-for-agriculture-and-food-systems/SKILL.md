...
## Metadata
- **Skill ID:** `u09114-public-service-coordination-for-agriculture-and-food-systems`
- **Capability:** Public Service Coordination for agriculture and food systems
- **Domain:** agriculture and food systems
- **Purpose:** Operate the "Public Service Coordination for agriculture and food systems" capability in production for agriculture and food systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
