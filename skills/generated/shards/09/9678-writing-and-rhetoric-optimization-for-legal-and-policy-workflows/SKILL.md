...
## Metadata
- **Skill ID:** `u09678-writing-and-rhetoric-optimization-for-legal-and-policy-workflows`
- **Capability:** Writing And Rhetoric Optimization for legal and policy workflows
- **Domain:** legal and policy workflows
- **Purpose:** Operate the "Writing And Rhetoric Optimization for legal and policy workflows" capability in production for legal and policy workflows workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
