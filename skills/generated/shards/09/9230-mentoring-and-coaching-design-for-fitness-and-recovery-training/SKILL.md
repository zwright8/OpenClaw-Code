...
## Metadata
- **Skill ID:** `u09230-mentoring-and-coaching-design-for-fitness-and-recovery-training`
- **Capability:** Mentoring And Coaching Design for fitness and recovery training
- **Domain:** fitness and recovery training
- **Purpose:** Operate the "Mentoring And Coaching Design for fitness and recovery training" capability in production for fitness and recovery training workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
