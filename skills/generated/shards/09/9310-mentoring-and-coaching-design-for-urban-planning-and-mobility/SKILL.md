...
## Metadata
- **Skill ID:** `u09310-mentoring-and-coaching-design-for-urban-planning-and-mobility`
- **Capability:** Mentoring And Coaching Design for urban planning and mobility
- **Domain:** urban planning and mobility
- **Purpose:** Operate the "Mentoring And Coaching Design for urban planning and mobility" capability in production for urban planning and mobility workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
