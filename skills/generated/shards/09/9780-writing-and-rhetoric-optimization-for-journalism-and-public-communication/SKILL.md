...
## Metadata
- **Skill ID:** `u09780-writing-and-rhetoric-optimization-for-journalism-and-public-communication`
- **Capability:** Writing And Rhetoric Optimization for journalism and public communication
- **Domain:** journalism and public communication
- **Purpose:** Operate the "Writing And Rhetoric Optimization for journalism and public communication" capability in production for journalism and public communication workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
