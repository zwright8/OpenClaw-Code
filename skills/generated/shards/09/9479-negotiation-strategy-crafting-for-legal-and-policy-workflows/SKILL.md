...
description: Operate the "Negotiation Strategy Crafting for legal and policy workflows" capability in production for legal and policy workflows workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Negotiation Strategy Crafting for legal and policy workflows` in legal and policy workflows and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Negotiation Strategy Crafting for legal and policy workflows** outcomes (not generic brainstorming).
...
1. **Incident stabilization in legal and policy workflows" capability in production for legal and policy workflows workflows**
   - Input: noisy upstream payload requiring negotiation strategy crafting for legal and policy workflows normalization/assessment.
