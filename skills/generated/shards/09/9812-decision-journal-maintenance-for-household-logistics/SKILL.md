...
## Metadata
- **Skill ID:** `u09812-decision-journal-maintenance-for-household-logistics`
- **Capability:** Decision Journal Maintenance for household logistics
- **Domain:** household logistics
- **Purpose:** Operate the "Decision Journal Maintenance for household logistics" capability in production for household logistics workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
