...
## Metadata
- **Skill ID:** `u09784-writing-and-rhetoric-optimization-for-multilingual-translation-services`
- **Capability:** Writing And Rhetoric Optimization for multilingual translation services
- **Domain:** multilingual translation services
- **Purpose:** Operate the "Writing And Rhetoric Optimization for multilingual translation services" capability in production for multilingual translation services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
