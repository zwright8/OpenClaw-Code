...
## Metadata
- **Skill ID:** `u09496-negotiation-strategy-crafting-for-disaster-response-networks`
- **Capability:** Negotiation Strategy Crafting for disaster response networks
- **Domain:** disaster response networks
- **Purpose:** Operate the "Negotiation Strategy Crafting for disaster response networks" capability in production for disaster response networks workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
