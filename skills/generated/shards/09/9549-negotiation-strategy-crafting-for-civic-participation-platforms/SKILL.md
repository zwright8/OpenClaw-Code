...
## Metadata
- **Skill ID:** `u09549-negotiation-strategy-crafting-for-civic-participation-platforms`
- **Capability:** Negotiation Strategy Crafting for civic participation platforms
- **Domain:** civic participation platforms
- **Purpose:** Operate the "Negotiation Strategy Crafting for civic participation platforms" capability in production for civic participation platforms workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
