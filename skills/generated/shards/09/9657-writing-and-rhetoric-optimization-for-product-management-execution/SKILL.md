...
## Metadata
- **Skill ID:** `u09657-writing-and-rhetoric-optimization-for-product-management-execution`
- **Capability:** Writing And Rhetoric Optimization for product management execution
- **Domain:** product management execution
- **Purpose:** Operate the "Writing And Rhetoric Optimization for product management execution" capability in production for product management execution workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
