...
## Metadata
- **Skill ID:** `u09567-negotiation-strategy-crafting-for-arts-and-culture-programming`
- **Capability:** Negotiation Strategy Crafting for arts and culture programming
- **Domain:** arts and culture programming
- **Purpose:** Operate the "Negotiation Strategy Crafting for arts and culture programming" capability in production for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
