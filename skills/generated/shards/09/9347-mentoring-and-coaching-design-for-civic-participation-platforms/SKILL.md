...
## Metadata
- **Skill ID:** `u09347-mentoring-and-coaching-design-for-civic-participation-platforms`
- **Capability:** Mentoring And Coaching Design for civic participation platforms
- **Domain:** civic participation platforms
- **Purpose:** Operate the "Mentoring And Coaching Design for civic participation platforms" capability in production for civic participation platforms workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
