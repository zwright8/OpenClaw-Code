...
## Metadata
- **Skill ID:** `u09035-public-service-coordination-for-mental-well-being-practices`
- **Capability:** Public Service Coordination for mental well-being practices
- **Domain:** mental well-being practices
- **Purpose:** Operate the "Public Service Coordination for mental well-being practices" capability in production for mental well being practices workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
