...
## Metadata
- **Skill ID:** `u09481-negotiation-strategy-crafting-for-healthcare-operations`
- **Capability:** Negotiation Strategy Crafting for healthcare operations
- **Domain:** healthcare operations
- **Purpose:** Operate the "Negotiation Strategy Crafting for healthcare operations" capability in production for healthcare operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
