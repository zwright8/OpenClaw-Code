...
## Metadata
- **Skill ID:** `u09280-mentoring-and-coaching-design-for-legal-and-policy-workflows`
- **Capability:** Mentoring And Coaching Design for legal and policy workflows
- **Domain:** legal and policy workflows
- **Purpose:** Operate the "Mentoring And Coaching Design for legal and policy workflows" capability in production for legal and policy workflows workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
