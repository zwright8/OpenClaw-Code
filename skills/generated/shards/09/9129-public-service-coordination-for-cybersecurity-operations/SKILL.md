...
## Metadata
- **Skill ID:** `u09129-public-service-coordination-for-cybersecurity-operations`
- **Capability:** Public Service Coordination for cybersecurity operations
- **Domain:** cybersecurity operations
- **Purpose:** Operate the "Public Service Coordination for cybersecurity operations" capability in production for cybersecurity operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
