...
## Metadata
- **Skill ID:** `u09245-mentoring-and-coaching-design-for-career-development-pathways`
- **Capability:** Mentoring And Coaching Design for career development pathways
- **Domain:** career development pathways
- **Purpose:** Operate the "Mentoring And Coaching Design for career development pathways" capability in production for career development pathways workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
