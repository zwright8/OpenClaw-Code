...
## Metadata
- **Skill ID:** `u09731-writing-and-rhetoric-optimization-for-research-and-development-labs`
- **Capability:** Writing And Rhetoric Optimization for research and development labs
- **Domain:** research and development labs
- **Purpose:** Operate the "Writing And Rhetoric Optimization for research and development labs" capability in production for research and development labs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
