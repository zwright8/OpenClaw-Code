...
## Metadata
- **Skill ID:** `u09552-negotiation-strategy-crafting-for-accessibility-services`
- **Capability:** Negotiation Strategy Crafting for accessibility services
- **Domain:** accessibility services
- **Purpose:** Operate the "Negotiation Strategy Crafting for accessibility services" capability in production for accessibility services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
