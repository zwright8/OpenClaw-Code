...
## Metadata
- **Skill ID:** `u09078-public-service-coordination-for-legal-and-policy-workflows`
- **Capability:** Public Service Coordination for legal and policy workflows
- **Domain:** legal and policy workflows
- **Purpose:** Operate the "Public Service Coordination for legal and policy workflows" capability in production for legal and policy workflows workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
