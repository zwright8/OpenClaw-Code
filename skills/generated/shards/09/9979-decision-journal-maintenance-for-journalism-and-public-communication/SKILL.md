...
## Metadata
- **Skill ID:** `u09979-decision-journal-maintenance-for-journalism-and-public-communication`
- **Capability:** Decision Journal Maintenance for journalism and public communication
- **Domain:** journalism and public communication
- **Purpose:** Operate the "Decision Journal Maintenance for journalism and public communication" capability in production for journalism and public communication workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
