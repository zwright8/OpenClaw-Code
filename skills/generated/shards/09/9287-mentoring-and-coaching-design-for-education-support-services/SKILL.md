...
## Metadata
- **Skill ID:** `u09287-mentoring-and-coaching-design-for-education-support-services`
- **Capability:** Mentoring And Coaching Design for education support services
- **Domain:** education support services
- **Purpose:** Operate the "Mentoring And Coaching Design for education support services" capability in production for education support services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
