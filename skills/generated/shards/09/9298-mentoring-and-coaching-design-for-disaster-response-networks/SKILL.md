...
## Metadata
- **Skill ID:** `u09298-mentoring-and-coaching-design-for-disaster-response-networks`
- **Capability:** Mentoring And Coaching Design for disaster response networks
- **Domain:** disaster response networks
- **Purpose:** Operate the "Mentoring And Coaching Design for disaster response networks" capability in production for disaster response networks workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
