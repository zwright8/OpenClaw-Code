...
## Metadata
- **Skill ID:** `u09629-writing-and-rhetoric-optimization-for-fitness-and-recovery-training`
- **Capability:** Writing And Rhetoric Optimization for fitness and recovery training
- **Domain:** fitness and recovery training
- **Purpose:** Operate the "Writing And Rhetoric Optimization for fitness and recovery training" capability in production for fitness and recovery training workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
