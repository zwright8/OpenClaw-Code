...
## Metadata
- **Skill ID:** `u09906-decision-journal-maintenance-for-urban-planning-and-mobility`
- **Capability:** Decision Journal Maintenance for urban planning and mobility
- **Domain:** urban planning and mobility
- **Purpose:** Operate the "Decision Journal Maintenance for urban planning and mobility" capability in production for urban planning and mobility workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
