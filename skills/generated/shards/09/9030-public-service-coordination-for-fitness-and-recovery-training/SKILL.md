...
## Metadata
- **Skill ID:** `u09030-public-service-coordination-for-fitness-and-recovery-training`
- **Capability:** Public Service Coordination for fitness and recovery training
- **Domain:** fitness and recovery training
- **Purpose:** Operate the "Public Service Coordination for fitness and recovery training" capability in production for fitness and recovery training workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
