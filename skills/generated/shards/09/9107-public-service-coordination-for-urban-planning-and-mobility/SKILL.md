...
## Metadata
- **Skill ID:** `u09107-public-service-coordination-for-urban-planning-and-mobility`
- **Capability:** Public Service Coordination for urban planning and mobility
- **Domain:** urban planning and mobility
- **Purpose:** Operate the "Public Service Coordination for urban planning and mobility" capability in production for urban planning and mobility workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
