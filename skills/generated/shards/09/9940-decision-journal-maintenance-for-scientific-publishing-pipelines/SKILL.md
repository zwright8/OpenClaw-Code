...
## Metadata
- **Skill ID:** `u09940-decision-journal-maintenance-for-scientific-publishing-pipelines`
- **Capability:** Decision Journal Maintenance for scientific publishing pipelines
- **Domain:** scientific publishing pipelines
- **Purpose:** Operate the "Decision Journal Maintenance for scientific publishing pipelines" capability in production for scientific publishing pipelines workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
