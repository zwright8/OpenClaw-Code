...
## Metadata
- **Skill ID:** `u09059-public-service-coordination-for-product-management-execution`
- **Capability:** Public Service Coordination for product management execution
- **Domain:** product management execution
- **Purpose:** Operate the "Public Service Coordination for product management execution" capability in production for product management execution workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
