...
## Metadata
- **Skill ID:** `u09761-writing-and-rhetoric-optimization-for-childcare-support-systems`
- **Capability:** Writing And Rhetoric Optimization for childcare support systems
- **Domain:** childcare support systems
- **Purpose:** Operate the "Writing And Rhetoric Optimization for childcare support systems" capability in production for childcare support systems workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
