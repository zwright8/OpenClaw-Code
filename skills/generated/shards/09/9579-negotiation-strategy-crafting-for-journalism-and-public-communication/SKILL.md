...
## Metadata
- **Skill ID:** `u09579-negotiation-strategy-crafting-for-journalism-and-public-communication`
- **Capability:** Negotiation Strategy Crafting for journalism and public communication
- **Domain:** journalism and public communication
- **Purpose:** Operate the "Negotiation Strategy Crafting for journalism and public communication" capability in production for journalism and public communication workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
