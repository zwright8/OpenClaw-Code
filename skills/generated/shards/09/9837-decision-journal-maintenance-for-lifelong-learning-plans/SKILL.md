...
## Metadata
- **Skill ID:** `u09837-decision-journal-maintenance-for-lifelong-learning-plans`
- **Capability:** Decision Journal Maintenance for lifelong learning plans
- **Domain:** lifelong learning plans
- **Purpose:** Operate the "Decision Journal Maintenance for lifelong learning plans" capability in production for lifelong learning plans workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
