...
## Metadata
- **Skill ID:** `u09895-decision-journal-maintenance-for-nonprofit-program-delivery`
- **Capability:** Decision Journal Maintenance for nonprofit program delivery
- **Domain:** nonprofit program delivery
- **Purpose:** Operate the "Decision Journal Maintenance for nonprofit program delivery" capability in production for nonprofit program delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
