...
## Metadata
- **Skill ID:** `u09430-negotiation-strategy-crafting-for-fitness-and-recovery-training`
- **Capability:** Negotiation Strategy Crafting for fitness and recovery training
- **Domain:** fitness and recovery training
- **Purpose:** Operate the "Negotiation Strategy Crafting for fitness and recovery training" capability in production for fitness and recovery training workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
