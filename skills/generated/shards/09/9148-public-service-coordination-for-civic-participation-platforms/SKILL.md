...
## Metadata
- **Skill ID:** `u09148-public-service-coordination-for-civic-participation-platforms`
- **Capability:** Public Service Coordination for civic participation platforms
- **Domain:** civic participation platforms
- **Purpose:** Operate the "Public Service Coordination for civic participation platforms" capability in production for civic participation platforms workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
