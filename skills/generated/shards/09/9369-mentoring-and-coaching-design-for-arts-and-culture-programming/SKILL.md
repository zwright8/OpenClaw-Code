...
## Metadata
- **Skill ID:** `u09369-mentoring-and-coaching-design-for-arts-and-culture-programming`
- **Capability:** Mentoring And Coaching Design for arts and culture programming
- **Domain:** arts and culture programming
- **Purpose:** Operate the "Mentoring And Coaching Design for arts and culture programming" capability in production for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
