...
## Metadata
- **Skill ID:** `u09875-decision-journal-maintenance-for-marketing-and-storytelling`
- **Capability:** Decision Journal Maintenance for marketing and storytelling
- **Domain:** marketing and storytelling
- **Purpose:** Operate the "Decision Journal Maintenance for marketing and storytelling" capability in production for marketing and storytelling workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
