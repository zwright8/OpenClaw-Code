...
## Metadata
- **Skill ID:** `u09495-negotiation-strategy-crafting-for-nonprofit-program-delivery`
- **Capability:** Negotiation Strategy Crafting for nonprofit program delivery
- **Domain:** nonprofit program delivery
- **Purpose:** Operate the "Negotiation Strategy Crafting for nonprofit program delivery" capability in production for nonprofit program delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
