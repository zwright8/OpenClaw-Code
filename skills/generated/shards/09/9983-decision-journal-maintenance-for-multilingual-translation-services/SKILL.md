...
## Metadata
- **Skill ID:** `u09983-decision-journal-maintenance-for-multilingual-translation-services`
- **Capability:** Decision Journal Maintenance for multilingual translation services
- **Domain:** multilingual translation services
- **Purpose:** Operate the "Decision Journal Maintenance for multilingual translation services" capability in production for multilingual translation services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
