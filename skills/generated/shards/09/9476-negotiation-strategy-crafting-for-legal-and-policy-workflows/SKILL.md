...
## Metadata
- **Skill ID:** `u09476-negotiation-strategy-crafting-for-legal-and-policy-workflows`
- **Capability:** Negotiation Strategy Crafting for legal and policy workflows
- **Domain:** legal and policy workflows
- **Purpose:** Operate the "Negotiation Strategy Crafting for legal and policy workflows" capability in production for legal and policy workflows workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
