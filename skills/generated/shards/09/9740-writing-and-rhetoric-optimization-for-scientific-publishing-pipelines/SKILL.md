...
## Metadata
- **Skill ID:** `u09740-writing-and-rhetoric-optimization-for-scientific-publishing-pipelines`
- **Capability:** Writing And Rhetoric Optimization for scientific publishing pipelines
- **Domain:** scientific publishing pipelines
- **Purpose:** Operate the "Writing And Rhetoric Optimization for scientific publishing pipelines" capability in production for scientific publishing pipelines workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
