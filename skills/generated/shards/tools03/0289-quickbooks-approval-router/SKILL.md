---
name: quickbooks-approval-router
description: Use when tasks require quickbooks approval router with credential-aware preflight, deterministic execution, validation gates, and handoff-ready artifacts.
---

# QuickBooks Approval Router
...
| Primary artifact | `quickbooks-approval-decision-packet` |
| Routing tag | `quickbooks:approval-router` |
| Mutating | `yes` |
| Release cycles | `3` |

## Why This Skill Exists
We need this skill because QuickBooks workflows degrade when auth, schema, and side-effect handling drift when integrations are run ad hoc. This specific skill turns QuickBooks Approval Router into a deterministic, auth-checked workflow for routes quickbooks-driven decisions to the right approvers..

## Trigger Checklist
- [ ] The task explicitly requires `QuickBooks Approval Router` rather than generic brainstorming.
...
| --- | --- | --- | --- |
| quickbooks-approval-decision-packet | structured-artifact | yes | next workflow or operator |
| quickbooks-approval-decision-packet-scorecard | scorecard | yes | reviewer |
| quickbooks-approval-decision-packet-handoff | handoff-packet | yes | downstream owner |

## Step-by-Step Implementation Guide
1. Define the decision classes, approver roster, and escalation hierarchy for QuickBooks Approval Router, then capture the manual fallback path for QuickBooks.
...
3. Implement routes quickbooks-driven decisions to the right approvers. so the routing decision always includes policy clauses, approver evidence, and escalation context.
...
- Preserve request, response, and approval traces in `quickbooks-approval-decision-packet` so downstream owners do not need to rediscover context.
...
- [ ] quickbooks-approval-decision-packet, scorecard, and handoff packet were produced.
...
## Handoff Contract
- **Produces:** `quickbooks-approval-decision-packet`, execution scorecard, approval trace, and next actions.
...
- **Downstream hint:** route to `quickbooks:approval-router` consumers with approval and credential context attached.
