...
| Field | Value |
|---|---|
| Skill pack | `k8s-platform-ops-toolkit` |
| Tool count | `0` |
...
This pack provides a curated operational toolkit for k8s platform ops toolkit tasks so operators can select the smallest safe tool, execute with bounded risk, and hand off reproducible outputs.
...
1. Select a minimal tool from this pack to solve a k8s platform ops toolkit request, run dry-run first, then produce a validated artifact bundle.
