...
This pack provides a curated operational toolkit for sdl3_image tasks so operators can select the smallest safe tool, execute with bounded risk, and hand off reproducible outputs.
...
1. Select a minimal tool from this pack to solve a sdl3_image request, run dry-run first, then produce a validated artifact bundle.
