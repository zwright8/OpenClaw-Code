...
| Field | Value |
|---|---|
| Skill pack | `x86-64-elf-binutils` |
| Tool count | `0` |
...
This pack provides a curated operational toolkit for x86_64-elf-binutils tasks so operators can select the smallest safe tool, execute with bounded risk, and hand off reproducible outputs.
...
1. Select a minimal tool from this pack to solve a x86_64-elf-binutils request, run dry-run first, then produce a validated artifact bundle.
