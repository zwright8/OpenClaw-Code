...
| Field | Value |
|---|---|
| Skill pack | `protoc-gen-grpc-swift` |
| Tool count | `0` |
...
This pack provides a curated operational toolkit for protoc-gen-grpc-swift tasks so operators can select the smallest safe tool, execute with bounded risk, and hand off reproducible outputs.
...
1. Select a minimal tool from this pack to solve a protoc-gen-grpc-swift request, run dry-run first, then produce a validated artifact bundle.
