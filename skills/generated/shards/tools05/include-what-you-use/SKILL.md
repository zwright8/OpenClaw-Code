...
| Field | Value |
|---|---|
| Skill pack | `include-what-you-use` |
| Tool count | `0` |
...
This pack provides a curated operational toolkit for include-what-you-use tasks so operators can select the smallest safe tool, execute with bounded risk, and hand off reproducible outputs.
...
1. Select a minimal tool from this pack to solve a include-what-you-use request, run dry-run first, then produce a validated artifact bundle.
