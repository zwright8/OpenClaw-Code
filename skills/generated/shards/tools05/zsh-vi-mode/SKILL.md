---
name: zsh-vi-mode
description: Run and troubleshoot the zsh-vi-mode command-line tool on local machines. Use when requests mention \"zsh-vi-mode\" or require workflows supported by this tool.
---
...
This pack provides a curated operational toolkit for zsh-vi-mode tasks so operators can select the smallest safe tool, execute with bounded risk, and hand off reproducible outputs.
...
1. Select a minimal tool from this pack to solve a zsh-vi-mode request, run dry-run first, then produce a validated artifact bundle.
