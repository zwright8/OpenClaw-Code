...
This pack provides a curated operational toolkit for mongo-c-driver tasks so operators can select the smallest safe tool, execute with bounded risk, and hand off reproducible outputs.
...
1. Select a minimal tool from this pack to solve a mongo-c-driver request, run dry-run first, then produce a validated artifact bundle.
