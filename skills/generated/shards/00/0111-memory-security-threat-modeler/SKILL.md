...
- The task explicitly requires `u0111-memory-security-threat-modeler` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
