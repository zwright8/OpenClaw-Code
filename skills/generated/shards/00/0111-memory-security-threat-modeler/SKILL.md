---
name: u0111-memory-security-threat-modeler
description: Run the Memory Security Threat Modeler capability for Memory and Knowledge Operations with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Memory Security Threat Modeler
...
| Feature flag | `skill_0111_memory-security-threat-modeler` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents lose performance when lessons are not retained and reused. This specific skill anticipates attack paths before adversaries exploit them.

## Trigger Checklist
- [ ] The task explicitly needs Memory Security Threat Modeler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Memory Security Threat Modeler.
...
## Operator Use Cases
- Operate Memory Security Threat Modeler as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 73):** release artifacts after validation pass and route to `memory-and-knowledge-operations:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Memory Security Threat Modeler`, including at least three measurable KPIs tied to repeated mistakes and context loss.
...
- Scoring weights: `truth=0.24, execution=0.18, safety=0.22, impact=0.36`
- Posture thresholds:
  - `ready`: score >= 73
  - `review`: score >= 52
  - `review_risk`: risk >= 56
...
1. Incident recovery in Memory and Knowledge Operations: ingest noisy signals, execute attack-surface modeling, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Memory Security Threat Modeler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
