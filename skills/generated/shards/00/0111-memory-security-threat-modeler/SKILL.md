...
description: Build and operate the "Memory Security Threat Modeler" capability for Memory and Knowledge Operations. Use when outcomes in this capability family are required for production execution.
---
...
## Metadata
- **Skill ID:** `111`
- **Skill Name:** `u0111-memory-security-threat-modeler`
...
4. Keep routing aligned with `memory-and-knowledge-operations:detection-guard` and include approval context.
...
### Handoff Contract
- **Produces:** `Memory Security Threat Modeler normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `episodic logs`, `knowledge nodes`, `retrieval metadata`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to memory-and-knowledge-operations:detection-guard consumers with approval-gate context
