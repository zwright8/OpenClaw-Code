...
## Metadata
- **Skill ID:** `765`
- **Skill Name:** `u0765-cultural-confidence-calibration-engine`
...
4. Keep routing aligned with `multilingual-and-cultural-adaptation:optimization-engine` and include approval context.
...
- **Downstream Hint:** Route next to multilingual-and-cultural-adaptation:optimization-engine consumers with approval-gate context
