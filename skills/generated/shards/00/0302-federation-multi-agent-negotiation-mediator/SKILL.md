...
description: Operate the "Federation Multi-Agent Negotiation Mediator" capability in production for the target domain workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `302`
- **Skill Name:** `u0302-federation-multi-agent-negotiation-mediator`
...
4. Keep routing aligned with `federation-and-interoperability:collaboration-mediator` and include approval context.
...
### Handoff Contract
- **Produces:** `Federation Multi-Agent Negotiation Mediator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `envelopes`, `tenant boundaries`, `protocol bridges`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to federation-and-interoperability:collaboration-mediator consumers with approval-gate context
