...
description: Operate the "Community KPI Dashboard Publisher" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `876`
- **Skill Name:** `u0876-community-kpi-dashboard-publisher`
...
4. Keep routing aligned with `community-engagement-and-feedback:communication-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Community KPI Dashboard Publisher normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `feedback channels`, `sentiment`, `urgency`, `follow-ups`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to community-engagement-and-feedback:communication-engine consumers with approval-gate context
