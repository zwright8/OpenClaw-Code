...
## When To Use
Use this skill when the request explicitly needs "Community KPI Dashboard Publisher" outcomes in the Community Engagement and Feedback domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Community KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community kpi dashboard publisher normalization/assessment.
