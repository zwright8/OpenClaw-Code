...
## Metadata
- **Skill ID:** `573`
- **Skill Name:** `u0573-observability-task-handoff-contractor`
...
4. Keep routing aligned with `data-quality-and-observability:contract-compiler` and include approval context.
...
- **Downstream Hint:** Route next to data-quality-and-observability:contract-compiler consumers with approval-gate context
