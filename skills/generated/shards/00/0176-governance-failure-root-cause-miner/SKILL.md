...
description: Run the Governance Failure Root-Cause Miner capability for Safety and Governance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0176_governance-failure-root-cause-mi` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Governance Failure Root-Cause Miner (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Governance Failure Root-Cause Miner.
...
## Operator Use Cases
- Operate Governance Failure Root-Cause Miner as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Governance Failure Root-Cause Miner`, including at least three measurable KPIs tied to unsafe actions and policy drift.
...
1. Incident recovery in Safety and Governance: ingest noisy signals, execute error pattern mining, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Governance Failure Root-Cause Miner against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
