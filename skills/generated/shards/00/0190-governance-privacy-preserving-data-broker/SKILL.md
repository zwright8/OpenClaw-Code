...
description: Build and operate the "Governance Privacy Preserving Data Broker" capability for Safety and Governance. Use only when production execution explicitly requires this exact capability and output contract.
---
...
- Trigger only when the requested outcome explicitly maps to **Governance Privacy Preserving Data Broker** in the **Safety and Governance** capability family.
...
## Trigger Checklist
- [ ] The request explicitly needs **Governance Privacy Preserving Data Broker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Safety and Governance**
   - Input: noisy upstream payload requiring governance privacy preserving data broker normalization/assessment.
...
## When To Use
Use this when a request in **Safety and Governance** depends on **Governance Privacy Preserving Data Broker** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
