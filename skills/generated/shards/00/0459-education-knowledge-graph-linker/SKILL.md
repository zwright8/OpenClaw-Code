...
description: Build and operate the "Education Knowledge Graph Linker" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Knowledge Graph Linker" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Knowledge Graph Linker normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Knowledge Graph Linker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education knowledge graph linker normalization/assessment.
