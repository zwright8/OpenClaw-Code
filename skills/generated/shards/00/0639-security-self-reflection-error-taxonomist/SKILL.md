...
description: Run the Security Self-Reflection Error Taxonomist capability for Security and Privacy with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0639_security-self-reflection-error-t` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Security Self-Reflection Error Taxonomist (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Security Self-Reflection Error Taxonomist.
...
## Operator Use Cases
- Operate Security Self-Reflection Error Taxonomist as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 76):** release artifacts after validation pass and route to `security-and-privacy:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Security Self-Reflection Error Taxonomist`, including at least three measurable KPIs tied to breach, exfiltration, and over-privileged actions.
...
- Scoring weights: `truth=0.13, execution=0.32, safety=0.25, impact=0.30`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 48
  - `review_risk`: risk >= 31
...
1. Incident recovery in Security and Privacy: ingest noisy signals, execute failure-type clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Security Self-Reflection Error Taxonomist against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
