...
## Trigger Checklist
- [ ] The request explicitly needs **Security Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security self-reflection error taxonomist normalization/assessment.
