...
## Trigger Checklist
- [ ] The request explicitly needs **Logistics Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Resource Allocation and Logistics**
   - Input: noisy upstream payload requiring logistics uncertainty communicator normalization/assessment.
