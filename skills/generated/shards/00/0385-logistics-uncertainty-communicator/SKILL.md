...
## Metadata
- **Skill ID:** `385`
- **Skill Name:** `u0385-logistics-uncertainty-communicator`
...
4. Keep routing aligned with `resource-allocation-and-logistics:communication-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Logistics Uncertainty Communicator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `capacity`, `bottlenecks`, `distribution plans`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to resource-allocation-and-logistics:communication-engine consumers with approval-gate context
