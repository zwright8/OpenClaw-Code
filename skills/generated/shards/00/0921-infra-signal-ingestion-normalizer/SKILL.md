...
## When To Use
Use this skill when the request explicitly needs "Infra Signal Ingestion Normalizer" outcomes in the Infrastructure and Sustainability domain.
...
## Handoff Contract
- Produces: Infra Signal Ingestion Normalizer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Signal Ingestion Normalizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra signal ingestion normalizer normalization/assessment.
