---
name: u0759-comms-self-reflection-error-taxonomist
description: Run the Comms Self-Reflection Error Taxonomist capability for Communication and Explainability with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Comms Self-Reflection Error Taxonomist
...
| Feature flag | `skill_0759_comms-self-reflection-error-taxo` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because complex systems require explanations humans can act on quickly. This specific skill classifies recurrent reasoning failures for targeted fixes.

## Trigger Checklist
- [ ] The task explicitly needs Comms Self-Reflection Error Taxonomist (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Comms Self-Reflection Error Taxonomist.
...
## Operator Use Cases
- Operate Comms Self-Reflection Error Taxonomist as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 74):** release artifacts after validation pass and route to `communication-and-explainability:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Comms Self-Reflection Error Taxonomist`, including at least three measurable KPIs tied to misinterpretation and trust erosion.
...
- Scoring weights: `truth=0.26, execution=0.33, safety=0.12, impact=0.29`
- Posture thresholds:
  - `ready`: score >= 74
  - `review`: score >= 46
  - `review_risk`: risk >= 44
...
1. Incident recovery in Communication and Explainability: ingest noisy signals, execute failure-type clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Comms Self-Reflection Error Taxonomist against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
