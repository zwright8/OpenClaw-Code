...
## When To Use
Use this skill when the request explicitly needs "Comms Self-Reflection Error Taxonomist" outcomes in the Communication and Explainability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Comms Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms self-reflection error taxonomist normalization/assessment.
