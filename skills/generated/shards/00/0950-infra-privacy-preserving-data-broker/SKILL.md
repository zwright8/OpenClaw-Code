...
## Metadata
- **Skill ID:** `950`
- **Skill Name:** `u0950-infra-privacy-preserving-data-broker`
...
4. Keep routing aligned with `infrastructure-and-sustainability:collaboration-mediator` and include approval context.
...
### Handoff Contract
- **Produces:** `Infra Privacy Preserving Data Broker normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `capacity forecasts`, `energy usage`, `sustainability metrics`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to infrastructure-and-sustainability:collaboration-mediator consumers with approval-gate context
