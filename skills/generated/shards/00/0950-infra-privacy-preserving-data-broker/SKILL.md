...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Privacy Preserving Data Broker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra privacy preserving data broker normalization/assessment.
