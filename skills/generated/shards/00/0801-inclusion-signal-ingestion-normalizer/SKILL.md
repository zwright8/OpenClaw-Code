...
description: Operate the "Inclusion Signal Ingestion Normalizer" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `801`
- **Skill Name:** `u0801-inclusion-signal-ingestion-normalizer`
...
4. Keep routing aligned with `accessibility-and-inclusion:normalization-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Inclusion Signal Ingestion Normalizer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `accessibility audits`, `accommodations`, `usability feedback`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to accessibility-and-inclusion:normalization-engine consumers with approval-gate context
