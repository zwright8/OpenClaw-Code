...
## When To Use
Use this skill when the request explicitly needs "Inclusion Signal Ingestion Normalizer" outcomes in the Accessibility and Inclusion domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Signal Ingestion Normalizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion signal ingestion normalizer normalization/assessment.
