...
## Metadata
- **Skill ID:** `691`
- **Skill Name:** `u0691-impact-policy-constraint-compiler`
...
4. Keep routing aligned with `social-impact-measurement:contract-compiler` and include approval context.
...
- **Downstream Hint:** Route next to social-impact-measurement:contract-compiler consumers with approval-gate context
