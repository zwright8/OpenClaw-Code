---
name: u0255-collab-auto-retry-and-backoff-coordinator
description: Run the Collab Auto-Retry and Backoff Coordinator capability for Collaboration and Negotiation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Collab Auto-Retry and Backoff Coordinator
...
| Feature flag | `skill_0255_collab-auto-retry-and-backoff-co` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because multi-agent systems underperform without explicit conflict resolution. This specific skill improves success rates while preventing retry storms.

## Trigger Checklist
- [ ] The task explicitly needs Collab Auto-Retry and Backoff Coordinator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Collab Auto-Retry and Backoff Coordinator.
...
## Operator Use Cases
- Operate Collab Auto-Retry and Backoff Coordinator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Collab Auto-Retry and Backoff Coordinator`, including at least three measurable KPIs tied to deadlocks and degraded trust.
...
- Scoring weights: `truth=0.29, execution=0.31, safety=0.26, impact=0.14`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 55
  - `review_risk`: risk >= 61
...
1. Incident recovery in Collaboration and Negotiation: ingest noisy signals, execute adaptive backoff control, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Collab Auto-Retry and Backoff Coordinator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
