...
## Handoff Contract
- Produces: PublicService Community Feedback Harvester normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Community Feedback Harvester** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice community feedback harvester normalization/assessment.
