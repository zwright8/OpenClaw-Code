...
## Metadata
- **Skill ID:** `923`
- **Skill Name:** `u0923-infra-evidence-provenance-tracker`
...
4. Keep routing aligned with `infrastructure-and-sustainability:provenance-tracker` and include approval context.
...
- **Downstream Hint:** Route next to infrastructure-and-sustainability:provenance-tracker consumers with approval-gate context
