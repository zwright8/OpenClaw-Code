...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Compliance Evidence Mapper** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion compliance evidence mapper normalization/assessment.
