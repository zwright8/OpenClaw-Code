...
- The task explicitly requires `u0112-memory-compliance-evidence-mapper` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
