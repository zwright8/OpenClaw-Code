...
description: Operate the "Rights Plan Quality Evaluator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `901`
- **Skill Name:** `u0901-rights-plan-quality-evaluator`
...
4. Keep routing aligned with `legal-rights-and-compliance:general-capability` and include approval context.
...
### Handoff Contract
- **Produces:** `Rights Plan Quality Evaluator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `requirements mappings`, `legal decisions`, `evidence trails`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to legal-rights-and-compliance:general-capability consumers with approval-gate context
