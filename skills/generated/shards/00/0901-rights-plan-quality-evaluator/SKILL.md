---
name: u0901-rights-plan-quality-evaluator
description: Run the Rights Plan Quality Evaluator capability for Legal, Rights, and Compliance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Rights Plan Quality Evaluator
...
| Feature flag | `skill_0901_rights-plan-quality-evaluator` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because operations must preserve rights and satisfy jurisdictional obligations. This specific skill quantifies whether plans are complete, safe, and feasible.

## Trigger Checklist
- [ ] The task explicitly needs Rights Plan Quality Evaluator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Rights Plan Quality Evaluator.
...
## Operator Use Cases
- Operate Rights Plan Quality Evaluator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Rights Plan Quality Evaluator`, including at least three measurable KPIs tied to rights violations and compliance penalties.
...
- Scoring weights: `truth=0.31, execution=0.29, safety=0.20, impact=0.20`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 49
  - `review_risk`: risk >= 45
...
1. Incident recovery in Legal, Rights, and Compliance: ingest noisy signals, execute multi-criteria plan scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Rights Plan Quality Evaluator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
