...
description: Build and operate the "Research Contradiction Detector" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Research Contradiction Detector" outcomes in the Scientific Research Systems domain.
...
## Handoff Contract
- Produces: Research Contradiction Detector normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Research Contradiction Detector** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Scientific Research Systems**
   - Input: noisy upstream payload requiring research contradiction detector normalization/assessment.
