...
## When To Use
Use this skill when the request explicitly needs "Crisis Contradiction Detector" outcomes in the Crisis and Incident Response domain.
...
- Downstream routing hint: Route next to crisis-and-incident-response:detection-guard consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Contradiction Detector** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis contradiction detector normalization/assessment.
