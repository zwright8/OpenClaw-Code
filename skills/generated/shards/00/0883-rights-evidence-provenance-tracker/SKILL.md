...
description: Operate the "Rights Evidence Provenance Tracker" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `883`
- **Skill Name:** `u0883-rights-evidence-provenance-tracker`
...
4. Keep routing aligned with `legal-rights-and-compliance:provenance-tracker` and include approval context.
...
### Handoff Contract
- **Produces:** `Rights Evidence Provenance Tracker normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `requirements mappings`, `legal decisions`, `evidence trails`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to legal-rights-and-compliance:provenance-tracker consumers with approval-gate context
