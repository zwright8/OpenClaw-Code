...
## Metadata
- **Skill ID:** `680`
- **Skill Name:** `u0680-crisis-continuous-improvement-planner`
...
### Handoff Contract
- **Produces:** `Crisis Continuous Improvement Planner normalized artifacts`, `execution scorecard`, `risk posture`
