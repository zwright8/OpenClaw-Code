...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Continuous Improvement Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis continuous improvement planner normalization/assessment.
