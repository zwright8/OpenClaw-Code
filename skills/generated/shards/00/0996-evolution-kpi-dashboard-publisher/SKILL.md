...
description: Operate the "Evolution KPI Dashboard Publisher" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `996`
- **Skill Name:** `u0996-evolution-kpi-dashboard-publisher`
...
|---|---|---|---|
| operator_kpi_dashboards_report | structured-report | true | orchestrator |
| operator_kpi_dashboards_scorecard | scorecard | true | operator |

## Guidelines
1. Validate required inputs before execution and reject non-conforming payloads early.
2. Run `metric synthesis and publication` with deterministic settings and trace capture enabled.
3. Produce `operator KPI dashboards` outputs in machine-readable form for orchestrator/operator use.
...
### Handoff Contract
- **Produces:** `Evolution KPI Dashboard Publisher normalized artifacts`, `execution scorecard`, `risk posture`
