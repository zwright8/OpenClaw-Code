---
name: u0479-education-self-reflection-error-taxonomist
description: Run the Education Self-Reflection Error Taxonomist capability for Education and Upskilling with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Education Self-Reflection Error Taxonomist
...
| Feature flag | `skill_0479_education-self-reflection-error-` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because human capability growth requires targeted planning under constraints. This specific skill classifies recurrent reasoning failures for targeted fixes.

## Trigger Checklist
- [ ] The task explicitly needs Education Self-Reflection Error Taxonomist (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Education Self-Reflection Error Taxonomist.
...
## Operator Use Cases
- Operate Education Self-Reflection Error Taxonomist as a reliable, reusable production workflow.
...
- **Review posture (score >= 58 or risk >= 47):** require human review before publish, with explicit remediation notes.
- **Critical posture (risk >= 77):** fail closed, execute `rollback-to-last-stable-baseline`, and escalate with incident packet.

## Traceability Map
- **Scope:** Define the scope and success metrics for `Education Self-Reflection Error Taxonomist`, including at least three measurable KPIs tied to persistent skill gaps and poor learning outcomes.
...
- Scoring weights: `truth=0.33, execution=0.29, safety=0.15, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 58
  - `review_risk`: risk >= 47
...
1. Incident recovery in Education and Upskilling: ingest noisy signals, execute failure-type clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Education Self-Reflection Error Taxonomist against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
