...
description: Build and operate the "Education Self-Reflection Error Taxonomist" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Self-Reflection Error Taxonomist" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Self-Reflection Error Taxonomist normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education self-reflection error taxonomist normalization/assessment.
