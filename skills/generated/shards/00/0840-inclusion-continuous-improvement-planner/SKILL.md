...
## Metadata
- **Skill ID:** `840`
- **Skill Name:** `u0840-inclusion-continuous-improvement-planner`
...
### Handoff Contract
- **Produces:** `Inclusion Continuous Improvement Planner normalized artifacts`, `execution scorecard`, `risk posture`
