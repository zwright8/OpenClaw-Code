...
- The task explicitly requires `u0143-tooling-conflict-resolution-coach` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
