...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Evidence Provenance Tracker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural evidence provenance tracker normalization/assessment.
