...
description: Operate the "Cultural Evidence Provenance Tracker" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `763`
- **Skill Name:** `u0763-cultural-evidence-provenance-tracker`
...
4. Keep routing aligned with `multilingual-and-cultural-adaptation:provenance-tracker` and include approval context.
...
- **Downstream Hint:** Route next to multilingual-and-cultural-adaptation:provenance-tracker consumers with approval-gate context
