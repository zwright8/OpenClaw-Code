...
description: Build and operate the "Research Goal Decomposer" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Research Goal Decomposer" outcomes in the Scientific Research Systems domain.
...
## Handoff Contract
- Produces: Research Goal Decomposer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Research Goal Decomposer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Scientific Research Systems**
   - Input: noisy upstream payload requiring research goal decomposer normalization/assessment.
