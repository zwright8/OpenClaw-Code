...
## Metadata
- **Skill ID:** `552`
- **Skill Name:** `u0552-engineering-compliance-evidence-mapper`
...
4. Keep routing aligned with `software-engineering-automation:normalization-engine` and include approval context.
...
- **Downstream Hint:** Route next to software-engineering-automation:normalization-engine consumers with approval-gate context
