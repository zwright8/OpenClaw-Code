---
name: u0497-research-regression-sentinel
description: Run the Research Regression Sentinel capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Research Regression Sentinel
...
| Feature flag | `skill_0497_research-regression-sentinel` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because research throughput degrades without reproducibility and prioritization. This specific skill prevents unnoticed quality drift after updates.

## Trigger Checklist
- [ ] The task explicitly needs Research Regression Sentinel (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Regression Sentinel.
...
## Operator Use Cases
- Operate Research Regression Sentinel as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 73):** release artifacts after validation pass and route to `scientific-research-systems:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Regression Sentinel`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.20, execution=0.18, safety=0.36, impact=0.26`
- Posture thresholds:
  - `ready`: score >= 73
  - `review`: score >= 43
  - `review_risk`: risk >= 41
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute baseline-delta detection, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Regression Sentinel against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
