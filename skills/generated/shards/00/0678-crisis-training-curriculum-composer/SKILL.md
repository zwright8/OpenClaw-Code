...
## When To Use
Use this skill when the request explicitly needs "Crisis Training Curriculum Composer" outcomes in the Crisis and Incident Response domain.
...
- Downstream routing hint: Route next to crisis-and-incident-response:general-capability consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Training Curriculum Composer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis training curriculum composer normalization/assessment.
