...
description: Operate the "Crisis Training Curriculum Composer" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `678`
- **Skill Name:** `u0678-crisis-training-curriculum-composer`
...
4. Keep routing aligned with `crisis-and-incident-response:general-capability` and include approval context.
...
### Handoff Contract
- **Produces:** `Crisis Training Curriculum Composer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `incident timelines`, `response roles`, `recovery artifacts`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to crisis-and-incident-response:general-capability consumers with approval-gate context
