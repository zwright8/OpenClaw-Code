---
name: u0678-crisis-training-curriculum-composer
description: Run the Crisis Training Curriculum Composer capability for Crisis and Incident Response with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Crisis Training Curriculum Composer
...
| Feature flag | `skill_0678_crisis-training-curriculum-compo` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because response quality determines whether incidents are contained or amplified. This specific skill converts capability gaps into actionable upskilling programs.

## Trigger Checklist
- [ ] The task explicitly needs Crisis Training Curriculum Composer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Crisis Training Curriculum Composer.
...
## Operator Use Cases
- Operate Crisis Training Curriculum Composer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Crisis Training Curriculum Composer`, including at least three measurable KPIs tied to slow containment and repeated outages.
...
- Scoring weights: `truth=0.27, execution=0.24, safety=0.26, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 71
  - `review`: score >= 61
  - `review_risk`: risk >= 56
...
1. Incident recovery in Crisis and Incident Response: ingest noisy signals, execute sequenced learning path design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Crisis Training Curriculum Composer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
