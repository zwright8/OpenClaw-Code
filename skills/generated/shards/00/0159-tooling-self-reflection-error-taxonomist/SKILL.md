...
- Trigger only when the requested outcome explicitly maps to **Tooling Self-Reflection Error Taxonomist** in the **Tool Reliability and Execution Quality** capability family.
...
## Trigger Checklist
- [ ] The request explicitly needs **Tooling Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Tool Reliability and Execution Quality**
   - Input: noisy upstream payload requiring tooling self-reflection error taxonomist normalization/assessment.
...
## When To Use
Use this when a request in **Tool Reliability and Execution Quality** depends on **Tooling Self-Reflection Error Taxonomist** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
