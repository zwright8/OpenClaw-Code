---
name: u0159-tooling-self-reflection-error-taxonomist
description: Run the Tooling Self-Reflection Error Taxonomist capability for Tool Reliability and Execution Quality with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Tooling Self-Reflection Error Taxonomist
...
| Feature flag | `skill_0159_tooling-self-reflection-error-ta` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because automation collapses when tools are flaky and failure modes are opaque. This specific skill classifies recurrent reasoning failures for targeted fixes.

## Trigger Checklist
- [ ] The task explicitly needs Tooling Self-Reflection Error Taxonomist (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Tooling Self-Reflection Error Taxonomist.
...
## Operator Use Cases
- Operate Tooling Self-Reflection Error Taxonomist as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 76):** release artifacts after validation pass and route to `tool-reliability-and-execution-quality:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Tooling Self-Reflection Error Taxonomist`, including at least three measurable KPIs tied to silent failures and cascading retries.
...
- Scoring weights: `truth=0.28, execution=0.24, safety=0.17, impact=0.31`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 43
  - `review_risk`: risk >= 31
...
1. Incident recovery in Tool Reliability and Execution Quality: ingest noisy signals, execute failure-type clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Tooling Self-Reflection Error Taxonomist against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
