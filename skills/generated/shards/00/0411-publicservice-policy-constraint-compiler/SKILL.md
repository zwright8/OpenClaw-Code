...
## Metadata
- **Skill ID:** `411`
- **Skill Name:** `u0411-publicservice-policy-constraint-compiler`
...
4. Keep routing aligned with `healthcare-and-public-services:contract-compiler` and include approval context.
...
- **Downstream Hint:** Route next to healthcare-and-public-services:contract-compiler consumers with approval-gate context
