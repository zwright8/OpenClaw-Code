...
## When To Use
Use this skill when the request explicitly needs "Evolution Counterfactual Simulator" outcomes in the Autonomous Learning and Evolution domain.
...
- Downstream routing hint: Route next to autonomous-learning-and-evolution:simulation-lab consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Evolution Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring evolution counterfactual simulator normalization/assessment.
