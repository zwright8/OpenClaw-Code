...
description: Operate the "Evolution Counterfactual Simulator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `966`
- **Skill Name:** `u0966-evolution-counterfactual-simulator`
- **Domain:** `Autonomous Learning and Evolution`
- **Domain Slug:** `autonomous-learning-and-evolution`
...
|---|---|---|---|
| outcomes | signal | true | upstream |
| error taxonomies | signal | true | upstream |
| adaptation decisions | signal | true | upstream |
...
4. Keep routing aligned with `autonomous-learning-and-evolution:simulation-lab` and include approval context.
...
- **Week:** Review KPI focus (`capability stagnation`, `repeated blind spots`, `decision drift`), failure trends, and approval/retry performance.
...
### Handoff Contract
- **Produces:** `Evolution Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `outcomes`, `error taxonomies`, `adaptation decisions`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to autonomous-learning-and-evolution:simulation-lab consumers with approval-gate context
