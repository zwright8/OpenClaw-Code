---
name: u0415-publicservice-auto-retry-and-backoff-coordinator
description: Run the PublicService Auto-Retry and Backoff Coordinator capability for Healthcare and Public Services with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# PublicService Auto-Retry and Backoff Coordinator
...
| Feature flag | `skill_0415_publicservice-auto-retry-and-bac` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because public-facing workflows require strict safety and reliability controls. This specific skill improves success rates while preventing retry storms.

## Trigger Checklist
- [ ] The task explicitly needs PublicService Auto-Retry and Backoff Coordinator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for PublicService Auto-Retry and Backoff Coordinator.
...
## Operator Use Cases
- Operate PublicService Auto-Retry and Backoff Coordinator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `PublicService Auto-Retry and Backoff Coordinator`, including at least three measurable KPIs tied to service harm and procedural violations.
...
- Scoring weights: `truth=0.28, execution=0.23, safety=0.22, impact=0.26`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 57
  - `review_risk`: risk >= 54
...
1. Incident recovery in Healthcare and Public Services: ingest noisy signals, execute adaptive backoff control, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run PublicService Auto-Retry and Backoff Coordinator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
