---
name: u0508-research-incident-playbook-synthesizer
description: Run the Research Incident Playbook Synthesizer capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Research Incident Playbook Synthesizer
...
| Feature flag | `skill_0508_research-incident-playbook-synth` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because research throughput degrades without reproducibility and prioritization. This specific skill creates repeatable response procedures from incident history.

## Trigger Checklist
- [ ] The task explicitly needs Research Incident Playbook Synthesizer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Incident Playbook Synthesizer.
...
## Operator Use Cases
- Operate Research Incident Playbook Synthesizer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `scientific-research-systems:communication-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Incident Playbook Synthesizer`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.22, execution=0.26, safety=0.26, impact=0.26`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 57
  - `review_risk`: risk >= 60
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute pattern-to-playbook synthesis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Incident Playbook Synthesizer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
