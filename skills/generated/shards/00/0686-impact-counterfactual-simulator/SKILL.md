...
## When To Use
Use this skill when the request explicitly needs "Impact Counterfactual Simulator" outcomes in the Social Impact Measurement domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Impact Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring impact counterfactual simulator normalization/assessment.
