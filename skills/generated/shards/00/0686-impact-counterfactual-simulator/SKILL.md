...
## Metadata
- **Skill ID:** `686`
- **Skill Name:** `u0686-impact-counterfactual-simulator`
...
4. Keep routing aligned with `social-impact-measurement:simulation-lab` and include approval context.
...
### Handoff Contract
- **Produces:** `Impact Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `community outcomes`, `kpi trends`, `intervention deltas`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to social-impact-measurement:simulation-lab consumers with approval-gate context
