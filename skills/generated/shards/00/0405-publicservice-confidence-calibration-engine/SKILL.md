...
## Metadata
- **Skill ID:** `405`
- **Skill Name:** `u0405-publicservice-confidence-calibration-engine`
...
4. Keep routing aligned with `healthcare-and-public-services:optimization-engine` and include approval context.
...
- **Downstream Hint:** Route next to healthcare-and-public-services:optimization-engine consumers with approval-gate context
