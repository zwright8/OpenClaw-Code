---
name: u0597-observability-skill-gap-diagnoser
description: Run the Observability Skill Gap Diagnoser capability for Data Quality and Observability with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Observability Skill Gap Diagnoser
...
| Feature flag | `skill_0597_observability-skill-gap-diagnose` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because decisions are only as good as the quality and visibility of data. This specific skill identifies where agents and humans need capability upgrades.

## Trigger Checklist
- [ ] The task explicitly needs Observability Skill Gap Diagnoser (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Observability Skill Gap Diagnoser.
...
## Operator Use Cases
- Operate Observability Skill Gap Diagnoser as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Observability Skill Gap Diagnoser`, including at least three measurable KPIs tied to data drift and blind spots.
...
- Scoring weights: `truth=0.25, execution=0.32, safety=0.21, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 61
  - `review_risk`: risk >= 54
...
1. Incident recovery in Data Quality and Observability: ingest noisy signals, execute competency coverage analysis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Observability Skill Gap Diagnoser against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
