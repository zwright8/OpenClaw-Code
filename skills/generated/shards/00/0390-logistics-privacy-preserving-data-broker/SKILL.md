---
name: u0390-logistics-privacy-preserving-data-broker
description: Run the Logistics Privacy Preserving Data Broker capability for Resource Allocation and Logistics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0390_logistics-privacy-preserving-dat` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Logistics Privacy Preserving Data Broker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Logistics Privacy Preserving Data Broker.
...
## Operator Use Cases
- Operate Logistics Privacy Preserving Data Broker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 76):** release artifacts after validation pass and route to `resource-allocation-and-logistics:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Logistics Privacy Preserving Data Broker`, including at least three measurable KPIs tied to supply shortfalls and fairness gaps.
...
- Scoring weights: `truth=0.27, execution=0.29, safety=0.12, impact=0.32`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 62
  - `review_risk`: risk >= 50
...
1. Incident recovery in Resource Allocation and Logistics: ingest noisy signals, execute policy-scoped data mediation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Logistics Privacy Preserving Data Broker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
