...
## Metadata
- **Skill ID:** `390`
- **Skill Name:** `u0390-logistics-privacy-preserving-data-broker`
...
4. Keep routing aligned with `resource-allocation-and-logistics:collaboration-mediator` and include approval context.
...
- **Downstream Hint:** Route next to resource-allocation-and-logistics:collaboration-mediator consumers with approval-gate context
