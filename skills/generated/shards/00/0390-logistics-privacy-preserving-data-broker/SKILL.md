...
description: Build and operate the "Logistics Privacy Preserving Data Broker" capability for Resource Allocation and Logistics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Logistics Privacy Preserving Data Broker" outcomes in the Resource Allocation and Logistics domain.
...
## Handoff Contract
- Produces: Logistics Privacy Preserving Data Broker normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Logistics Privacy Preserving Data Broker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Resource Allocation and Logistics**
   - Input: noisy upstream payload requiring logistics privacy preserving data broker normalization/assessment.
