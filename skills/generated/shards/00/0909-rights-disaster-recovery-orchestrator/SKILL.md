...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Disaster Recovery Orchestrator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights disaster recovery orchestrator normalization/assessment.
