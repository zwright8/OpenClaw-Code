...
description: Run the Rights Disaster Recovery Orchestrator capability for Legal, Rights, and Compliance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0909_rights-disaster-recovery-orchest` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Rights Disaster Recovery Orchestrator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Rights Disaster Recovery Orchestrator.
...
## Operator Use Cases
- Operate Rights Disaster Recovery Orchestrator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Rights Disaster Recovery Orchestrator`, including at least three measurable KPIs tied to rights violations and compliance penalties.
...
- Scoring weights: `truth=0.22, execution=0.28, safety=0.24, impact=0.27`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 54
  - `review_risk`: risk >= 59
...
1. Incident recovery in Legal, Rights, and Compliance: ingest noisy signals, execute failover and restoration sequencing, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Rights Disaster Recovery Orchestrator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
