...
description: Operate the "Observability Failure Root-Cause Miner" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Observability Failure Root-Cause Miner" outcomes in the Data Quality and Observability domain.
...
## Handoff Contract
- Produces: Observability Failure Root-Cause Miner normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Failure Root-Cause Miner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability failure root-cause miner normalization/assessment.
