...
## Metadata
- **Skill ID:** `681`
- **Skill Name:** `u0681-impact-signal-ingestion-normalizer`
...
4. Keep routing aligned with `social-impact-measurement:normalization-engine` and include approval context.
...
- **Downstream Hint:** Route next to social-impact-measurement:normalization-engine consumers with approval-gate context
