...
## Metadata
- **Skill ID:** `298`
- **Skill Name:** `u0298-federation-memory-consolidation-pipeline`
...
### Handoff Contract
- **Produces:** `Federation Memory Consolidation Pipeline normalized artifacts`, `execution scorecard`, `risk posture`
