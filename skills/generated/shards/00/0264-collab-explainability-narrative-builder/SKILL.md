---
name: u0264-collab-explainability-narrative-builder
description: Run the Collab Explainability Narrative Builder capability for Collaboration and Negotiation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Collab Explainability Narrative Builder
...
| Feature flag | `skill_0264_collab-explainability-narrative-` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because multi-agent systems underperform without explicit conflict resolution. This specific skill translates technical decisions into operator-usable narratives.

## Trigger Checklist
- [ ] The task explicitly needs Collab Explainability Narrative Builder (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Collab Explainability Narrative Builder.
...
## Operator Use Cases
- Operate Collab Explainability Narrative Builder as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `collaboration-and-negotiation:communication-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Collab Explainability Narrative Builder`, including at least three measurable KPIs tied to deadlocks and degraded trust.
...
- Scoring weights: `truth=0.29, execution=0.20, safety=0.21, impact=0.29`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 56
  - `review_risk`: risk >= 54
...
1. Incident recovery in Collaboration and Negotiation: ingest noisy signals, execute reason synthesis and abstraction, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Collab Explainability Narrative Builder against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
