---
name: u0358-economic-training-curriculum-composer
description: Run the Economic Training Curriculum Composer capability for Economic Optimization with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Economic Training Curriculum Composer
...
| Feature flag | `skill_0358_economic-training-curriculum-com` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need explicit tradeoff logic for cost, speed, and impact. This specific skill converts capability gaps into actionable upskilling programs.

## Trigger Checklist
- [ ] The task explicitly needs Economic Training Curriculum Composer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Economic Training Curriculum Composer.
...
## Operator Use Cases
- Operate Economic Training Curriculum Composer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 70):** release artifacts after validation pass and route to `economic-optimization:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Economic Training Curriculum Composer`, including at least three measurable KPIs tied to overspending and low-impact allocation.
...
- Scoring weights: `truth=0.29, execution=0.17, safety=0.37, impact=0.17`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 55
  - `review_risk`: risk >= 48
...
1. Incident recovery in Economic Optimization: ingest noisy signals, execute sequenced learning path design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Economic Training Curriculum Composer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
