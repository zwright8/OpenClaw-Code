...
## Metadata
- **Skill ID:** `358`
- **Skill Name:** `u0358-economic-training-curriculum-composer`
...
### Handoff Contract
- **Produces:** `Economic Training Curriculum Composer normalized artifacts`, `execution scorecard`, `risk posture`
