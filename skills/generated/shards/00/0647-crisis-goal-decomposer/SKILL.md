...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Goal Decomposer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis goal decomposer normalization/assessment.
