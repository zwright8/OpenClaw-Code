---
name: u0478-education-training-curriculum-composer
description: Run the Education Training Curriculum Composer capability for Education and Upskilling with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Education Training Curriculum Composer
...
| Feature flag | `skill_0478_education-training-curriculum-co` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because human capability growth requires targeted planning under constraints. This specific skill converts capability gaps into actionable upskilling programs.

## Trigger Checklist
- [ ] The task explicitly needs Education Training Curriculum Composer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Education Training Curriculum Composer.
...
## Operator Use Cases
- Operate Education Training Curriculum Composer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Education Training Curriculum Composer`, including at least three measurable KPIs tied to persistent skill gaps and poor learning outcomes.
...
- Scoring weights: `truth=0.34, execution=0.23, safety=0.20, impact=0.24`
- Posture thresholds:
  - `ready`: score >= 73
  - `review`: score >= 57
  - `review_risk`: risk >= 58
...
1. Incident recovery in Education and Upskilling: ingest noisy signals, execute sequenced learning path design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Education Training Curriculum Composer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
