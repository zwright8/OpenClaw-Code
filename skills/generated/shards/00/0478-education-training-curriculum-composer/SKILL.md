...
## Metadata
- **Skill ID:** `478`
- **Skill Name:** `u0478-education-training-curriculum-composer`
...
4. Keep routing aligned with `education-and-upskilling:general-capability` and include approval context.
...
- **Downstream Hint:** Route next to education-and-upskilling:general-capability consumers with approval-gate context
