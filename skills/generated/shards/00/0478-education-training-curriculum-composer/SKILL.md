...
description: Build and operate the "Education Training Curriculum Composer" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Training Curriculum Composer" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Training Curriculum Composer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Training Curriculum Composer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education training curriculum composer normalization/assessment.
