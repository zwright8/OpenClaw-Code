...
## When To Use
Use this skill when you need "Planning Semantic Retrieval Ranker" outcomes for the Strategic Planning and Decomposition domain with measurable, production-facing outputs.
...
## Trigger Checklist
- [ ] The request explicitly needs **Planning Semantic Retrieval Ranker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Strategic Planning and Decomposition**
   - Input: noisy upstream payload requiring planning semantic retrieval ranker normalization/assessment.
