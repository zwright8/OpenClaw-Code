---
name: u0518-research-training-curriculum-composer
description: Run the Research Training Curriculum Composer capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Research Training Curriculum Composer
...
| Feature flag | `skill_0518_research-training-curriculum-com` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because research throughput degrades without reproducibility and prioritization. This specific skill converts capability gaps into actionable upskilling programs.

## Trigger Checklist
- [ ] The task explicitly needs Research Training Curriculum Composer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Training Curriculum Composer.
...
## Operator Use Cases
- Operate Research Training Curriculum Composer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 71):** release artifacts after validation pass and route to `scientific-research-systems:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Training Curriculum Composer`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.21, execution=0.20, safety=0.37, impact=0.22`
- Posture thresholds:
  - `ready`: score >= 71
  - `review`: score >= 50
  - `review_risk`: risk >= 40
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute sequenced learning path design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Training Curriculum Composer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
