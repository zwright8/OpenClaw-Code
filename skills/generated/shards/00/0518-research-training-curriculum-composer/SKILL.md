...
## Trigger Checklist
- [ ] The request explicitly needs **Research Training Curriculum Composer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring research training curriculum composer normalization/assessment.
