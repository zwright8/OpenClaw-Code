...
## Metadata
- **Skill ID:** `582`
- **Skill Name:** `u0582-observability-multi-agent-negotiation-mediator`
...
4. Keep routing aligned with `data-quality-and-observability:collaboration-mediator` and include approval context.
...
- **Downstream Hint:** Route next to data-quality-and-observability:collaboration-mediator consumers with approval-gate context
