---
name: u0582-observability-multi-agent-negotiation-mediator
description: Run the Observability Multi-Agent Negotiation Mediator capability for Data Quality and Observability with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Observability Multi-Agent Negotiation Mediator
...
| Feature flag | `skill_0582_observability-multi-agent-negoti` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because decisions are only as good as the quality and visibility of data. This specific skill resolves resource and strategy conflicts with explicit tradeoffs.

## Trigger Checklist
- [ ] The task explicitly needs Observability Multi-Agent Negotiation Mediator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Observability Multi-Agent Negotiation Mediator.
...
## Operator Use Cases
- Operate Observability Multi-Agent Negotiation Mediator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 72):** release artifacts after validation pass and route to `data-quality-and-observability:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Observability Multi-Agent Negotiation Mediator`, including at least three measurable KPIs tied to data drift and blind spots.
...
- Scoring weights: `truth=0.36, execution=0.15, safety=0.34, impact=0.15`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 61
  - `review_risk`: risk >= 53
...
1. Incident recovery in Data Quality and Observability: ingest noisy signals, execute structured bargaining protocols, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Observability Multi-Agent Negotiation Mediator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
