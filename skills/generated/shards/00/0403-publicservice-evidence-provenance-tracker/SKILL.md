...
## Metadata
- **Skill ID:** `403`
- **Skill Name:** `u0403-publicservice-evidence-provenance-tracker`
...
4. Keep routing aligned with `healthcare-and-public-services:provenance-tracker` and include approval context.
...
### Handoff Contract
- **Produces:** `PublicService Evidence Provenance Tracker normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `protocol checks`, `service queues`, `compliance flags`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to healthcare-and-public-services:provenance-tracker consumers with approval-gate context
