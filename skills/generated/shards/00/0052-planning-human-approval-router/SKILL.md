---
name: u0052-planning-human-approval-router
description: Run the Planning Human Approval Router capability for Strategic Planning and Decomposition with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Planning Human Approval Router
...
| Feature flag | `skill_0052_planning-human-approval-router` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because large goals fail when decomposition is inconsistent or incomplete. This specific skill directs high-risk decisions to the right humans quickly.

## Trigger Checklist
- [ ] The task explicitly needs Planning Human Approval Router (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Planning Human Approval Router.
...
## Operator Use Cases
- Operate Planning Human Approval Router as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Planning Human Approval Router`, including at least three measurable KPIs tied to execution stalls and hidden dependency failures.
...
- Scoring weights: `truth=0.18, execution=0.46, safety=0.19, impact=0.17`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 52
  - `review_risk`: risk >= 41
...
1. Incident recovery in Strategic Planning and Decomposition: ingest noisy signals, execute reviewer routing policies, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Planning Human Approval Router against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
