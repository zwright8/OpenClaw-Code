---
name: u0661-crisis-plan-quality-evaluator
description: Operate the "Crisis Plan Quality Evaluator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---

# Crisis Plan Quality Evaluator

## Why This Skill Exists
We need this skill because response quality determines whether incidents are contained or amplified. This specific skill quantifies whether plans are complete, safe, and feasible.
...
## Metadata
- **Skill ID:** `661`
- **Skill Name:** `u0661-crisis-plan-quality-evaluator`
...
- **Feature Flag:** `skill_0661_crisis-plan-quality-evaluator`
- **Release Cycles:** `2`
...
### Handoff Contract
- **Produces:** `Crisis Plan Quality Evaluator normalized artifacts`, `execution scorecard`, `risk posture`
