...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Cost-Benefit Forecaster** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering cost-benefit forecaster normalization/assessment.
