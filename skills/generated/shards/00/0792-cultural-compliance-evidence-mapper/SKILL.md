...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Compliance Evidence Mapper** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural compliance evidence mapper normalization/assessment.
