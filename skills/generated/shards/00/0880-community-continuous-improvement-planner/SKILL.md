...
## Metadata
- **Skill ID:** `880`
- **Skill Name:** `u0880-community-continuous-improvement-planner`
...
4. Keep routing aligned with `community-engagement-and-feedback:planning-router` and include approval context.
...
- **Downstream Hint:** Route next to community-engagement-and-feedback:planning-router consumers with approval-gate context
