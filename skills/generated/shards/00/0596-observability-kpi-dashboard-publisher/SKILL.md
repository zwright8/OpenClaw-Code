...
## When To Use
Use this skill when the request explicitly needs "Observability KPI Dashboard Publisher" outcomes in the Data Quality and Observability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Observability KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability kpi dashboard publisher normalization/assessment.
