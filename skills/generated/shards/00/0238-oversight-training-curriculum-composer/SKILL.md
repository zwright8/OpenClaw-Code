...
description: Operate the "Oversight Training Curriculum Composer" capability in production for Human Oversight and Operator UX workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `238`
- **Skill Name:** `u0238-oversight-training-curriculum-composer`
...
4. Keep routing aligned with `human-oversight-and-operator-ux:general-capability` and include approval context.
...
### Handoff Contract
- **Produces:** `Oversight Training Curriculum Composer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `approval queues`, `operator workload`, `intervention history`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to human-oversight-and-operator-ux:general-capability consumers with approval-gate context
