...
## When To Use
Use this skill when you need "Planning Counterfactual Simulator" outcomes for the Strategic Planning and Decomposition domain with measurable, production-facing outputs.
...
- Downstream routing hint: Route next to strategic-planning-and-decomposition:simulation-lab consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Planning Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Strategic Planning and Decomposition**
   - Input: noisy upstream payload requiring planning counterfactual simulator normalization/assessment.
