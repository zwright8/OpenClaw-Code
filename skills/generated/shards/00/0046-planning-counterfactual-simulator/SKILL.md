...
description: Build and operate the "Planning Counterfactual Simulator" capability for Strategic Planning and Decomposition. Use when outcomes in this capability family are required for production execution.
---
...
## Metadata
- **Skill ID:** `46`
- **Skill Name:** `u0046-planning-counterfactual-simulator`
...
4. Keep routing aligned with `strategic-planning-and-decomposition:simulation-lab` and include approval context.
...
### Handoff Contract
- **Produces:** `Planning Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `goals`, `dependencies`, `milestones`, `constraints`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to strategic-planning-and-decomposition:simulation-lab consumers with approval-gate context
