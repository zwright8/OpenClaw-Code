...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Knowledge Graph Linker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights knowledge graph linker normalization/assessment.
