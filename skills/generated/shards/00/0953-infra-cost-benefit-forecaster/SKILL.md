...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Cost-Benefit Forecaster** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra cost-benefit forecaster normalization/assessment.
