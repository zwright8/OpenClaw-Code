...
## Metadata
- **Skill ID:** `835`
- **Skill Name:** `u0835-inclusion-community-feedback-harvester`
...
### Handoff Contract
- **Produces:** `Inclusion Community Feedback Harvester normalized artifacts`, `execution scorecard`, `risk posture`
