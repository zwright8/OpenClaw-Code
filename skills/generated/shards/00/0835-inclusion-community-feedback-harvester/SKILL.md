...
description: Run the Inclusion Community Feedback Harvester capability for Accessibility and Inclusion with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0835_inclusion-community-feedback-har` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Inclusion Community Feedback Harvester (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Inclusion Community Feedback Harvester.
...
## Operator Use Cases
- Operate Inclusion Community Feedback Harvester as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 77):** release artifacts after validation pass and route to `accessibility-and-inclusion:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Inclusion Community Feedback Harvester`, including at least three measurable KPIs tied to barriers for disabled and underserved groups.
...
- Scoring weights: `truth=0.27, execution=0.17, safety=0.33, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 62
  - `review_risk`: risk >= 48
...
1. Incident recovery in Accessibility and Inclusion: ingest noisy signals, execute feedback normalization and clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Inclusion Community Feedback Harvester against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
