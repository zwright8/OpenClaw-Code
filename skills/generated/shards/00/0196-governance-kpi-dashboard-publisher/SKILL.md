...
- Trigger only when the requested outcome explicitly maps to **Governance KPI Dashboard Publisher** in the **Safety and Governance** capability family.
...
## Trigger Checklist
- [ ] The request explicitly needs **Governance KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Safety and Governance**
   - Input: noisy upstream payload requiring governance kpi dashboard publisher normalization/assessment.
...
## When To Use
Use this when a request in **Safety and Governance** depends on **Governance KPI Dashboard Publisher** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
