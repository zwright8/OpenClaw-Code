...
description: Operate the "Inclusion Policy Constraint Compiler" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `811`
- **Skill Name:** `u0811-inclusion-policy-constraint-compiler`
...
4. Keep routing aligned with `accessibility-and-inclusion:contract-compiler` and include approval context.
...
### Handoff Contract
- **Produces:** `Inclusion Policy Constraint Compiler normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `accessibility audits`, `accommodations`, `usability feedback`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to accessibility-and-inclusion:contract-compiler consumers with approval-gate context
