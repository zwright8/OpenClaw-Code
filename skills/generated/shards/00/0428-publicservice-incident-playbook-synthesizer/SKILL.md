...
## Handoff Contract
- Produces: PublicService Incident Playbook Synthesizer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Incident Playbook Synthesizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice incident playbook synthesizer normalization/assessment.
