...
description: Build and operate the "Planning Equity Impact Scorer" capability for Strategic Planning and Decomposition. Use when outcomes in this capability family are required for production execution.
---
...
## When To Use
Use this skill when you need "Planning Equity Impact Scorer" outcomes for the Strategic Planning and Decomposition domain with measurable, production-facing outputs.
...
## Handoff Contract
- Produces: Planning Equity Impact Scorer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Planning Equity Impact Scorer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Strategic Planning and Decomposition**
   - Input: noisy upstream payload requiring planning equity impact scorer normalization/assessment.
