...
## Trigger Checklist
- [ ] The request explicitly needs **Planning Task Handoff Contractor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Strategic Planning and Decomposition**
   - Input: noisy upstream payload requiring planning task handoff contractor normalization/assessment.
