...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Human Approval Router** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights human approval router normalization/assessment.
