...
description: Build and operate the "Education Compliance Evidence Mapper" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Compliance Evidence Mapper" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Compliance Evidence Mapper normalized artifacts; execution scorecard; risk posture
- Consumes: skill profiles; learning paths; support resources; claims; evidence; confidence traces
- Downstream routing hint: Route next to education-and-upskilling:normalization-engine consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Compliance Evidence Mapper** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education compliance evidence mapper normalization/assessment.
