...
## When To Use
Use this skill when the request explicitly needs "Engineering Context Window Prioritizer" outcomes in the Software Engineering Automation domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Context Window Prioritizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering context window prioritizer normalization/assessment.
