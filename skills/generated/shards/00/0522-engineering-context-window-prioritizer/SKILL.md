...
## Metadata
- **Skill ID:** `522`
- **Skill Name:** `u0522-engineering-context-window-prioritizer`
...
### Handoff Contract
- **Produces:** `Engineering Context Window Prioritizer normalized artifacts`, `execution scorecard`, `risk posture`
