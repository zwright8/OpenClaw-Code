---
name: u0035-epistemic-community-feedback-harvester
description: Run the Epistemic Community Feedback Harvester capability for Truth-Seeking and Epistemics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Epistemic Community Feedback Harvester
...
| Feature flag | `skill_0035_epistemic-community-feedback-har` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because decisions drift when claims are accepted without verification. This specific skill integrates lived user feedback into planning cycles.

## Trigger Checklist
- [ ] The task explicitly needs Epistemic Community Feedback Harvester (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Epistemic Community Feedback Harvester.
...
## Operator Use Cases
- Operate Epistemic Community Feedback Harvester as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 76):** release artifacts after validation pass and route to `truth-seeking-and-epistemics:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Epistemic Community Feedback Harvester`, including at least three measurable KPIs tied to false certainty and unverified assumptions.
...
- Scoring weights: `truth=0.21, execution=0.13, safety=0.35, impact=0.32`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 61
  - `review_risk`: risk >= 54
...
1. Incident recovery in Truth-Seeking and Epistemics: ingest noisy signals, execute feedback normalization and clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Epistemic Community Feedback Harvester against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
