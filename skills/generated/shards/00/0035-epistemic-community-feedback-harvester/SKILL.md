...
## Metadata
- **Skill ID:** `35`
- **Skill Name:** `u0035-epistemic-community-feedback-harvester`
...
4. Keep routing aligned with `truth-seeking-and-epistemics:normalization-engine` and include approval context.
...
- **Downstream Hint:** Route next to truth-seeking-and-epistemics:normalization-engine consumers with approval-gate context
