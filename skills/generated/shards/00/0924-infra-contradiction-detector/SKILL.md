...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Contradiction Detector** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra contradiction detector normalization/assessment.
