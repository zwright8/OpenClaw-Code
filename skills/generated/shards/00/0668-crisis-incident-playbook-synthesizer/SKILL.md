...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Incident Playbook Synthesizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis incident playbook synthesizer normalization/assessment.
