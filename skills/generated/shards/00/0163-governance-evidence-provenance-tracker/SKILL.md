...
## Metadata
- **Skill ID:** `163`
- **Skill Name:** `u0163-governance-evidence-provenance-tracker`
...
4. Keep routing aligned with `safety-and-governance:provenance-tracker` and include approval context.
...
- **Downstream Hint:** Route next to safety-and-governance:provenance-tracker consumers with approval-gate context
