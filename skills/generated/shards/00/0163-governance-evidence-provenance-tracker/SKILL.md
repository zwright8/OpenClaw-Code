---
name: u0163-governance-evidence-provenance-tracker
description: Run the Governance Evidence Provenance Tracker capability for Safety and Governance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Routing tag | `safety-and-governance:provenance-tracker` |
| Feature flag | `skill_0163_governance-evidence-provenance-t` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Governance Evidence Provenance Tracker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Governance Evidence Provenance Tracker.
...
## Operator Use Cases
- Operate Governance Evidence Provenance Tracker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 71):** release artifacts after validation pass and route to `safety-and-governance:provenance-tracker`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Governance Evidence Provenance Tracker`, including at least three measurable KPIs tied to unsafe actions and policy drift.
...
- Scoring weights: `truth=0.25, execution=0.25, safety=0.26, impact=0.24`
- Posture thresholds:
  - `ready`: score >= 71
  - `review`: score >= 59
  - `review_risk`: risk >= 58
...
1. Incident recovery in Safety and Governance: ingest noisy signals, execute signed provenance links, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Governance Evidence Provenance Tracker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
3. Pre-deployment gate: validate artifacts for safety-and-governance:provenance-tracker, enforce approvals, then handoff to downstream orchestrator with next actions.
...
- **Downstream hint:** route only to `safety-and-governance:provenance-tracker` consumers with approval context attached.
