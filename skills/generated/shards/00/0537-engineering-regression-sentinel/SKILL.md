...
description: Operate the "Engineering Regression Sentinel" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Engineering Regression Sentinel" outcomes in the Software Engineering Automation domain.
...
## Handoff Contract
- Produces: Engineering Regression Sentinel normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Regression Sentinel** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering regression sentinel normalization/assessment.
