...
## When To Use
Use this skill when the request explicitly needs "Cultural Incident Playbook Synthesizer" outcomes in the Multilingual and Cultural Adaptation domain.
...
## Handoff Contract
- Produces: Cultural Incident Playbook Synthesizer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Incident Playbook Synthesizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural incident playbook synthesizer normalization/assessment.
