...
## When To Use
Use this skill when the request explicitly needs "Infra Policy Constraint Compiler" outcomes in the Infrastructure and Sustainability domain.
...
## Handoff Contract
- Produces: Infra Policy Constraint Compiler normalized artifacts; execution scorecard; risk posture
- Consumes: capacity forecasts; energy usage; sustainability metrics; claims; evidence; confidence traces
- Downstream routing hint: Route next to infrastructure-and-sustainability:contract-compiler consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Policy Constraint Compiler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra policy constraint compiler normalization/assessment.
