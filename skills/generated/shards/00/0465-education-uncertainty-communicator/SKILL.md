...
## Handoff Contract
- Produces: Education Uncertainty Communicator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education uncertainty communicator normalization/assessment.
