---
name: u0465-education-uncertainty-communicator
description: Run the Education Uncertainty Communicator capability for Education and Upskilling with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Education Uncertainty Communicator
...
| Feature flag | `skill_0465_education-uncertainty-communicat` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because human capability growth requires targeted planning under constraints. This specific skill prevents overstatement by explicitly framing uncertainty.

## Trigger Checklist
- [ ] The task explicitly needs Education Uncertainty Communicator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Education Uncertainty Communicator.
...
## Operator Use Cases
- Operate Education Uncertainty Communicator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 70):** release artifacts after validation pass and route to `education-and-upskilling:communication-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Education Uncertainty Communicator`, including at least three measurable KPIs tied to persistent skill gaps and poor learning outcomes.
...
- Scoring weights: `truth=0.34, execution=0.31, safety=0.21, impact=0.14`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 48
  - `review_risk`: risk >= 40
...
1. Incident recovery in Education and Upskilling: ingest noisy signals, execute confidence-bound communication templates, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Education Uncertainty Communicator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
