...
## Metadata
- **Skill ID:** `465`
- **Skill Name:** `u0465-education-uncertainty-communicator`
...
4. Keep routing aligned with `education-and-upskilling:communication-engine` and include approval context.
...
- **Downstream Hint:** Route next to education-and-upskilling:communication-engine consumers with approval-gate context
