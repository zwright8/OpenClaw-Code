...
## When To Use
Use this skill when the request explicitly needs "Rights Multi-Agent Negotiation Mediator" outcomes in the Legal, Rights, and Compliance domain.
...
- Downstream routing hint: Route next to legal-rights-and-compliance:collaboration-mediator consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Multi-Agent Negotiation Mediator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights multi-agent negotiation mediator normalization/assessment.
