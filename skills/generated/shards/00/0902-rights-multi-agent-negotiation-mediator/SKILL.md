---
name: u0902-rights-multi-agent-negotiation-mediator
description: Run the Rights Multi-Agent Negotiation Mediator capability for Legal, Rights, and Compliance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Rights Multi-Agent Negotiation Mediator
...
| Feature flag | `skill_0902_rights-multi-agent-negotiation-m` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because operations must preserve rights and satisfy jurisdictional obligations. This specific skill resolves resource and strategy conflicts with explicit tradeoffs.

## Trigger Checklist
- [ ] The task explicitly needs Rights Multi-Agent Negotiation Mediator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Rights Multi-Agent Negotiation Mediator.
...
## Operator Use Cases
- Operate Rights Multi-Agent Negotiation Mediator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `legal-rights-and-compliance:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Rights Multi-Agent Negotiation Mediator`, including at least three measurable KPIs tied to rights violations and compliance penalties.
...
- Scoring weights: `truth=0.25, execution=0.21, safety=0.18, impact=0.36`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 54
  - `review_risk`: risk >= 61
...
1. Incident recovery in Legal, Rights, and Compliance: ingest noisy signals, execute structured bargaining protocols, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Rights Multi-Agent Negotiation Mediator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
