...
description: Operate the "Rights Multi-Agent Negotiation Mediator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `902`
- **Skill Name:** `u0902-rights-multi-agent-negotiation-mediator`
...
4. Keep routing aligned with `legal-rights-and-compliance:collaboration-mediator` and include approval context.
...
### Handoff Contract
- **Produces:** `Rights Multi-Agent Negotiation Mediator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `requirements mappings`, `legal decisions`, `evidence trails`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to legal-rights-and-compliance:collaboration-mediator consumers with approval-gate context
