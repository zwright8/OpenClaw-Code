...
description: Build and operate the "Tooling Goal Decomposer" capability for Tool Reliability and Execution Quality. Use when outcomes in this capability family are required for production execution.
---
...
## Metadata
- **Skill ID:** `127`
- **Skill Name:** `u0127-tooling-goal-decomposer`
...
4. Keep routing aligned with `tool-reliability-and-execution-quality:planning-router` and include approval context.
...
### Handoff Contract
- **Produces:** `Tooling Goal Decomposer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `tool runs`, `error signatures`, `retry outcomes`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to tool-reliability-and-execution-quality:planning-router consumers with approval-gate context
