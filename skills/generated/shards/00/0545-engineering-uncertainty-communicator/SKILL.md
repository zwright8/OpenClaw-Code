...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering uncertainty communicator normalization/assessment.
