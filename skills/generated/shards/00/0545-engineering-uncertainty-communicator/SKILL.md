...
description: Operate the "Engineering Uncertainty Communicator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `545`
- **Skill Name:** `u0545-engineering-uncertainty-communicator`
...
4. Keep routing aligned with `software-engineering-automation:communication-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Engineering Uncertainty Communicator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `code changes`, `tests`, `incidents`, `rollout data`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to software-engineering-automation:communication-engine consumers with approval-gate context
