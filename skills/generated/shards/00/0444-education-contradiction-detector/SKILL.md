...
## Metadata
- **Skill ID:** `444`
- **Skill Name:** `u0444-education-contradiction-detector`
...
4. Keep routing aligned with `education-and-upskilling:detection-guard` and include approval context.
...
- **Downstream Hint:** Route next to education-and-upskilling:detection-guard consumers with approval-gate context
