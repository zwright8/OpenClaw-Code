...
description: Run the Engineering Multi-Agent Negotiation Mediator capability for Software Engineering Automation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0542_engineering-multi-agent-negotiat` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Engineering Multi-Agent Negotiation Mediator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Engineering Multi-Agent Negotiation Mediator.
...
## Operator Use Cases
- Operate Engineering Multi-Agent Negotiation Mediator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 74):** release artifacts after validation pass and route to `software-engineering-automation:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Engineering Multi-Agent Negotiation Mediator`, including at least three measurable KPIs tied to regressions and brittle release pipelines.
...
- Scoring weights: `truth=0.34, execution=0.14, safety=0.17, impact=0.35`
- Posture thresholds:
  - `ready`: score >= 74
  - `review`: score >= 61
  - `review_risk`: risk >= 47
...
1. Incident recovery in Software Engineering Automation: ingest noisy signals, execute structured bargaining protocols, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Engineering Multi-Agent Negotiation Mediator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
