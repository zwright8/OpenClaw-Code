...
## When To Use
Use this skill when the request explicitly needs "Engineering Multi-Agent Negotiation Mediator" outcomes in the Software Engineering Automation domain.
...
## Handoff Contract
- Produces: Engineering Multi-Agent Negotiation Mediator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Multi-Agent Negotiation Mediator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering multi-agent negotiation mediator normalization/assessment.
