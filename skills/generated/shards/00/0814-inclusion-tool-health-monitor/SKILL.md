...
## When To Use
Use this skill when the request explicitly needs "Inclusion Tool Health Monitor" outcomes in the Accessibility and Inclusion domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Tool Health Monitor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion tool health monitor normalization/assessment.
