...
## Metadata
- **Skill ID:** `433`
- **Skill Name:** `u0433-publicservice-cost-benefit-forecaster`
...
4. Keep routing aligned with `healthcare-and-public-services:simulation-lab` and include approval context.
5. Tune thresholds incrementally based on observed KPI drift and incident learnings.

## Musts
- Enforce approval gates: `policy-constraint-check`, `human-approval-router`, `safety-review`, `scenario-review`.
...
- **Downstream Hint:** Route next to healthcare-and-public-services:simulation-lab consumers with approval-gate context
