...
## Metadata
- **Skill ID:** `123`
- **Skill Name:** `u0123-tooling-evidence-provenance-tracker`
...
4. Keep routing aligned with `tool-reliability-and-execution-quality:provenance-tracker` and include approval context.
...
### Handoff Contract
- **Produces:** `Tooling Evidence Provenance Tracker normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `tool runs`, `error signatures`, `retry outcomes`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to tool-reliability-and-execution-quality:provenance-tracker consumers with approval-gate context
