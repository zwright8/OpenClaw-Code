...
description: Build and operate the "Tooling Evidence Provenance Tracker" capability for Tool Reliability and Execution Quality. Use when outcomes in this capability family are required for production execution.
---
...
## When To Use
Use this skill when you need "Tooling Evidence Provenance Tracker" outputs that will influence production decisions, automated routing, policy posture, or external-facing actions.
...
- Routing tag: tool-reliability-and-execution-quality:tooling-evidence-provenance-tracker
...
## Output Contract
- `tooling_evidence_provenance_tracker_report` (structured-report, consumer=orchestrator, guaranteed=true)
- `tooling_evidence_provenance_tracker_scorecard` (scorecard, consumer=operator, guaranteed=true)
- `tooling_evidence_provenance_tracker_handoff` (handoff-packet, consumer=downstream-skill, guaranteed=true)
...
## Trigger Checklist
- [ ] The request explicitly needs **Tooling Evidence Provenance Tracker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Tool Reliability and Execution Quality**
   - Input: noisy upstream payload requiring tooling evidence provenance tracker normalization/assessment.
