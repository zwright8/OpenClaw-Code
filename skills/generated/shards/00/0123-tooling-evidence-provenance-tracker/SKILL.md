...
- The task explicitly requires `u0123-tooling-evidence-provenance-tracker` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
