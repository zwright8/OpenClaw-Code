...
description: Build and operate the "Economic Auto-Retry and Backoff Coordinator" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Auto-Retry and Backoff Coordinator" outcomes in the Economic Optimization domain.
...
## Handoff Contract
- Produces: Economic Auto-Retry and Backoff Coordinator normalized artifacts; execution scorecard; risk posture
