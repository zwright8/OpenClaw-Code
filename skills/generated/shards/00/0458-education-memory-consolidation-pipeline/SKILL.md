---
name: u0458-education-memory-consolidation-pipeline
description: Run the Education Memory Consolidation Pipeline capability for Education and Upskilling with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Education Memory Consolidation Pipeline
...
| Feature flag | `skill_0458_education-memory-consolidation-p` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because human capability growth requires targeted planning under constraints. This specific skill turns raw logs into durable reusable memory.

## Trigger Checklist
- [ ] The task explicitly needs Education Memory Consolidation Pipeline (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Education Memory Consolidation Pipeline.
...
## Operator Use Cases
- Operate Education Memory Consolidation Pipeline as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 73):** release artifacts after validation pass and route to `education-and-upskilling:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Education Memory Consolidation Pipeline`, including at least three measurable KPIs tied to persistent skill gaps and poor learning outcomes.
...
- Scoring weights: `truth=0.18, execution=0.20, safety=0.27, impact=0.36`
- Posture thresholds:
  - `ready`: score >= 73
  - `review`: score >= 58
  - `review_risk`: risk >= 59
...
1. Incident recovery in Education and Upskilling: ingest noisy signals, execute episodic-to-semantic consolidation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Education Memory Consolidation Pipeline against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
