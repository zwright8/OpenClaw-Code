...
description: Build and operate the "Education Memory Consolidation Pipeline" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Memory Consolidation Pipeline" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Memory Consolidation Pipeline normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Memory Consolidation Pipeline** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education memory consolidation pipeline normalization/assessment.
