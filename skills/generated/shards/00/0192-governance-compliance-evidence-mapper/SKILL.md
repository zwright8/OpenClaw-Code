...
## Metadata
- **Skill ID:** `192`
- **Skill Name:** `u0192-governance-compliance-evidence-mapper`
...
4. Keep routing aligned with `safety-and-governance:normalization-engine` and include approval context.
...
- **Downstream Hint:** Route next to safety-and-governance:normalization-engine consumers with approval-gate context
