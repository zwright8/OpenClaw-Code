...
- The task explicitly requires `u0120-memory-continuous-improvement-planner` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
