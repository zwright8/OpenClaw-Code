...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Regression Sentinel** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra regression sentinel normalization/assessment.
