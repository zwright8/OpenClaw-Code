...
description: Run the Tooling Community Feedback Harvester capability for Tool Reliability and Execution Quality with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0155_tooling-community-feedback-harve` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Tooling Community Feedback Harvester (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Tooling Community Feedback Harvester.
...
## Operator Use Cases
- Operate Tooling Community Feedback Harvester as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 76):** release artifacts after validation pass and route to `tool-reliability-and-execution-quality:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Tooling Community Feedback Harvester`, including at least three measurable KPIs tied to silent failures and cascading retries.
...
- Scoring weights: `truth=0.29, execution=0.22, safety=0.27, impact=0.21`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 52
  - `review_risk`: risk >= 56
...
1. Incident recovery in Tool Reliability and Execution Quality: ingest noisy signals, execute feedback normalization and clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Tooling Community Feedback Harvester against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
