...
description: Run the Observability Training Curriculum Composer capability for Data Quality and Observability with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0598_observability-training-curriculu` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Observability Training Curriculum Composer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Observability Training Curriculum Composer.
...
## Operator Use Cases
- Operate Observability Training Curriculum Composer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Observability Training Curriculum Composer`, including at least three measurable KPIs tied to data drift and blind spots.
...
- Scoring weights: `truth=0.25, execution=0.25, safety=0.19, impact=0.31`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 60
  - `review_risk`: risk >= 52
...
1. Incident recovery in Data Quality and Observability: ingest noisy signals, execute sequenced learning path design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Observability Training Curriculum Composer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
