---
name: u0329-economic-resource-budget-allocator
description: Run the Economic Resource Budget Allocator capability for Economic Optimization with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Economic Resource Budget Allocator
...
| Feature flag | `skill_0329_economic-resource-budget-allocat` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need explicit tradeoff logic for cost, speed, and impact. This specific skill matches mission ambition to finite execution capacity.

## Trigger Checklist
- [ ] The task explicitly needs Economic Resource Budget Allocator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Economic Resource Budget Allocator.
...
## Operator Use Cases
- Operate Economic Resource Budget Allocator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `economic-optimization:planning-router`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Economic Resource Budget Allocator`, including at least three measurable KPIs tied to overspending and low-impact allocation.
...
- Scoring weights: `truth=0.32, execution=0.30, safety=0.19, impact=0.19`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 44
  - `review_risk`: risk >= 43
...
1. Incident recovery in Economic Optimization: ingest noisy signals, execute capacity-aware allocation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Economic Resource Budget Allocator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
