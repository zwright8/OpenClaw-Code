...
- The task explicitly requires `u0121-tooling-signal-ingestion-normalizer` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
