...
## Metadata
- **Skill ID:** `121`
- **Skill Name:** `u0121-tooling-signal-ingestion-normalizer`
...
### Handoff Contract
- **Produces:** `Tooling Signal Ingestion Normalizer normalized artifacts`, `execution scorecard`, `risk posture`
