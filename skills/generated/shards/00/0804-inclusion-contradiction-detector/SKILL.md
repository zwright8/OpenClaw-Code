...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Contradiction Detector** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion contradiction detector normalization/assessment.
