...
## Metadata
- **Skill ID:** `841`
- **Skill Name:** `u0841-community-signal-ingestion-normalizer`
...
4. Keep routing aligned with `community-engagement-and-feedback:normalization-engine` and include approval context.
...
- **Downstream Hint:** Route next to community-engagement-and-feedback:normalization-engine consumers with approval-gate context
