...
## Trigger Checklist
- [ ] The request explicitly needs **Comms Plan Quality Evaluator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms plan quality evaluator normalization/assessment.
