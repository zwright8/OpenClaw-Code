...
## Metadata
- **Skill ID:** `355`
- **Skill Name:** `u0355-economic-community-feedback-harvester`
...
### Handoff Contract
- **Produces:** `Economic Community Feedback Harvester normalized artifacts`, `execution scorecard`, `risk posture`
