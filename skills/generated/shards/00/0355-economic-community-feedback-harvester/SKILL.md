---
name: u0355-economic-community-feedback-harvester
description: Run the Economic Community Feedback Harvester capability for Economic Optimization with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Economic Community Feedback Harvester
...
| Feature flag | `skill_0355_economic-community-feedback-harv` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need explicit tradeoff logic for cost, speed, and impact. This specific skill integrates lived user feedback into planning cycles.

## Trigger Checklist
- [ ] The task explicitly needs Economic Community Feedback Harvester (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Economic Community Feedback Harvester.
...
## Operator Use Cases
- Operate Economic Community Feedback Harvester as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `economic-optimization:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Economic Community Feedback Harvester`, including at least three measurable KPIs tied to overspending and low-impact allocation.
...
- Scoring weights: `truth=0.15, execution=0.42, safety=0.24, impact=0.19`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 47
  - `review_risk`: risk >= 34
...
1. Incident recovery in Economic Optimization: ingest noisy signals, execute feedback normalization and clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Economic Community Feedback Harvester against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
