...
description: Build and operate the "Economic Community Feedback Harvester" capability for Economic Optimization. Use when outcomes in this capability family are required for production execution.
---
...
## When To Use
Use this skill when you need "Economic Community Feedback Harvester" outputs that will influence production decisions, automated routing, policy posture, or external-facing actions.
...
- Routing tag: economic-optimization:economic-community-feedback-harvester
...
## Output Contract
- `economic_community_feedback_harvester_report` (structured-report, consumer=orchestrator, guaranteed=true)
- `economic_community_feedback_harvester_scorecard` (scorecard, consumer=operator, guaranteed=true)
- `economic_community_feedback_harvester_handoff` (handoff-packet, consumer=downstream-skill, guaranteed=true)
...
## Trigger Checklist
- [ ] The request explicitly needs **Economic Community Feedback Harvester** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Economic Optimization**
   - Input: noisy upstream payload requiring economic community feedback harvester normalization/assessment.
