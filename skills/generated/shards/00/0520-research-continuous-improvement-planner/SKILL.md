---
name: u0520-research-continuous-improvement-planner
description: Run the Research Continuous Improvement Planner capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Research Continuous Improvement Planner
...
| Feature flag | `skill_0520_research-continuous-improvement-` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because research throughput degrades without reproducibility and prioritization. This specific skill turns findings into sustained upgrade cycles.

## Trigger Checklist
- [ ] The task explicitly needs Research Continuous Improvement Planner (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Continuous Improvement Planner.
...
## Operator Use Cases
- Operate Research Continuous Improvement Planner as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `scientific-research-systems:planning-router`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Continuous Improvement Planner`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.34, execution=0.13, safety=0.32, impact=0.21`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 57
  - `review_risk`: risk >= 48
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute closed-loop prioritization, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Continuous Improvement Planner against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
