...
description: Operate the "Research Continuous Improvement Planner" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Research Continuous Improvement Planner" outcomes in the Scientific Research Systems domain.
...
## Handoff Contract
- Produces: Research Continuous Improvement Planner normalized artifacts; execution scorecard; risk posture
- Consumes: hypotheses; experiments; replication evidence; claims; evidence; confidence traces
- Downstream routing hint: Route next to scientific-research-systems:planning-router consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Research Continuous Improvement Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring research continuous improvement planner normalization/assessment.
