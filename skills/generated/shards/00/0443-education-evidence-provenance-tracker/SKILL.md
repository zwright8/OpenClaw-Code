...
## Metadata
- **Skill ID:** `443`
- **Skill Name:** `u0443-education-evidence-provenance-tracker`
...
4. Keep routing aligned with `education-and-upskilling:provenance-tracker` and include approval context.
...
- **Downstream Hint:** Route next to education-and-upskilling:provenance-tracker consumers with approval-gate context
