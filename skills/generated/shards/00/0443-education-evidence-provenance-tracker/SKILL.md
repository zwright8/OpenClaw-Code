...
description: Build and operate the "Education Evidence Provenance Tracker" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Evidence Provenance Tracker" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Evidence Provenance Tracker normalized artifacts; execution scorecard; risk posture
- Consumes: skill profiles; learning paths; support resources; claims; evidence; confidence traces
- Downstream routing hint: Route next to education-and-upskilling:provenance-tracker consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Evidence Provenance Tracker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education evidence provenance tracker normalization/assessment.
