...
description: Operate the "Engineering Counterfactual Simulator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `526`
- **Skill Name:** `u0526-engineering-counterfactual-simulator`
...
4. Keep routing aligned with `software-engineering-automation:simulation-lab` and include approval context.
...
### Handoff Contract
- **Produces:** `Engineering Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `code changes`, `tests`, `incidents`, `rollout data`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to software-engineering-automation:simulation-lab consumers with approval-gate context
