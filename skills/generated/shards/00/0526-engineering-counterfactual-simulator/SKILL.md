...
## When To Use
Use this skill when the request explicitly needs "Engineering Counterfactual Simulator" outcomes in the Software Engineering Automation domain.
...
- Downstream routing hint: Route next to software-engineering-automation:simulation-lab consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering counterfactual simulator normalization/assessment.
