...
## When To Use
Use this skill when the request explicitly needs "Logistics A/B Rollout Governor" outcomes in the Resource Allocation and Logistics domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Logistics A/B Rollout Governor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Resource Allocation and Logistics**
   - Input: noisy upstream payload requiring logistics a/b rollout governor normalization/assessment.
