---
name: u0387-logistics-a-b-rollout-governor
description: Run the Logistics A/B Rollout Governor capability for Resource Allocation and Logistics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Logistics A/B Rollout Governor
...
| Feature flag | `skill_0387_logistics-a-b-rollout-governor` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because impact work fails when scarce resources are not routed intelligently. This specific skill controls production risk during behavioral changes.

## Trigger Checklist
- [ ] The task explicitly needs Logistics A/B Rollout Governor (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Logistics A/B Rollout Governor.
...
## Operator Use Cases
- Operate Logistics A/B Rollout Governor as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Logistics A/B Rollout Governor`, including at least three measurable KPIs tied to supply shortfalls and fairness gaps.
...
- Scoring weights: `truth=0.26, execution=0.19, safety=0.26, impact=0.30`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 42
  - `review_risk`: risk >= 32
...
1. Incident recovery in Resource Allocation and Logistics: ingest noisy signals, execute staged rollout policies, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Logistics A/B Rollout Governor against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
