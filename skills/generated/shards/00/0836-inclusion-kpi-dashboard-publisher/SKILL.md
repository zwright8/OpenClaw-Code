...
## When To Use
Use this skill when the request explicitly needs "Inclusion KPI Dashboard Publisher" outcomes in the Accessibility and Inclusion domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion kpi dashboard publisher normalization/assessment.
