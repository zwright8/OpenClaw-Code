...
## When To Use
Use this skill when the request explicitly needs "Comms Training Curriculum Composer" outcomes in the Communication and Explainability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Comms Training Curriculum Composer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms training curriculum composer normalization/assessment.
