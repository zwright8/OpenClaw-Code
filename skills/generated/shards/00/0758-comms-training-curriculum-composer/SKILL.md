---
name: u0758-comms-training-curriculum-composer
description: Run the Comms Training Curriculum Composer capability for Communication and Explainability with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0758_comms-training-curriculum-compos` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Comms Training Curriculum Composer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Comms Training Curriculum Composer.
...
## Operator Use Cases
- Operate Comms Training Curriculum Composer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Comms Training Curriculum Composer`, including at least three measurable KPIs tied to misinterpretation and trust erosion.
...
- Scoring weights: `truth=0.25, execution=0.19, safety=0.28, impact=0.28`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 56
  - `review_risk`: risk >= 57
...
1. Incident recovery in Communication and Explainability: ingest noisy signals, execute sequenced learning path design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Comms Training Curriculum Composer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
