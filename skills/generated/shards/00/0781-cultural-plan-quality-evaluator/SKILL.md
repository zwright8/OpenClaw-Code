...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Plan Quality Evaluator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural plan quality evaluator normalization/assessment.
