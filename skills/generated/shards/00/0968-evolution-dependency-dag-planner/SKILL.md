...
## Trigger Checklist
- [ ] The request explicitly needs **Evolution Dependency DAG Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring evolution dependency dag planner normalization/assessment.
