...
description: Run the Evolution Dependency DAG Planner capability for Autonomous Learning and Evolution with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0968_evolution-dependency-dag-planner` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Evolution Dependency DAG Planner (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Evolution Dependency DAG Planner.
...
## Operator Use Cases
- Operate Evolution Dependency DAG Planner as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Evolution Dependency DAG Planner`, including at least three measurable KPIs tied to capability stagnation and repeated blind spots.
...
- Scoring weights: `truth=0.23, execution=0.18, safety=0.30, impact=0.29`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 54
  - `review_risk`: risk >= 59
...
1. Incident recovery in Autonomous Learning and Evolution: ingest noisy signals, execute dependency graph compilation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Evolution Dependency DAG Planner against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
