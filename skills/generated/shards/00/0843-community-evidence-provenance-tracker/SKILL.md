...
description: Run the Community Evidence Provenance Tracker capability for Community Engagement and Feedback with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Routing tag | `community-engagement-and-feedback:provenance-tracker` |
| Feature flag | `skill_0843_community-evidence-provenance-tr` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Community Evidence Provenance Tracker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Community Evidence Provenance Tracker.
...
## Operator Use Cases
- Operate Community Evidence Provenance Tracker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 76):** release artifacts after validation pass and route to `community-engagement-and-feedback:provenance-tracker`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Community Evidence Provenance Tracker`, including at least three measurable KPIs tied to community trust loss and unaddressed concerns.
...
- Scoring weights: `truth=0.16, execution=0.38, safety=0.25, impact=0.20`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 48
  - `review_risk`: risk >= 42
...
1. Incident recovery in Community Engagement and Feedback: ingest noisy signals, execute signed provenance links, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Community Evidence Provenance Tracker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
3. Pre-deployment gate: validate artifacts for community-engagement-and-feedback:provenance-tracker, enforce approvals, then handoff to downstream orchestrator with next actions.
...
- **Downstream hint:** route only to `community-engagement-and-feedback:provenance-tracker` consumers with approval context attached.
