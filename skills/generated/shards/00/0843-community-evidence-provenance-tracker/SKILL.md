...
description: Operate the "Community Evidence Provenance Tracker" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `843`
- **Skill Name:** `u0843-community-evidence-provenance-tracker`
...
4. Keep routing aligned with `community-engagement-and-feedback:provenance-tracker` and include approval context.
...
### Handoff Contract
- **Produces:** `Community Evidence Provenance Tracker normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `feedback channels`, `sentiment`, `urgency`, `follow-ups`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to community-engagement-and-feedback:provenance-tracker consumers with approval-gate context
