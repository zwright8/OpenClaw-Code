...
- Downstream routing hint: Route next to community-engagement-and-feedback:provenance-tracker consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Community Evidence Provenance Tracker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community evidence provenance tracker normalization/assessment.
