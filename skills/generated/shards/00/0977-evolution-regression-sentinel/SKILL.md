---
name: u0977-evolution-regression-sentinel
description: Run the Evolution Regression Sentinel capability for Autonomous Learning and Evolution with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Evolution Regression Sentinel
...
| Feature flag | `skill_0977_evolution-regression-sentinel` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents stagnate without structured reflection and continuous improvement loops. This specific skill prevents unnoticed quality drift after updates.

## Trigger Checklist
- [ ] The task explicitly needs Evolution Regression Sentinel (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Evolution Regression Sentinel.
...
## Operator Use Cases
- Operate Evolution Regression Sentinel as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `autonomous-learning-and-evolution:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Evolution Regression Sentinel`, including at least three measurable KPIs tied to capability stagnation and repeated blind spots.
...
- Scoring weights: `truth=0.23, execution=0.19, safety=0.36, impact=0.21`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 48
  - `review_risk`: risk >= 34
...
1. Incident recovery in Autonomous Learning and Evolution: ingest noisy signals, execute baseline-delta detection, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Evolution Regression Sentinel against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
