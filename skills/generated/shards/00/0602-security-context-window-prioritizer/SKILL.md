...
## Trigger Checklist
- [ ] The request explicitly needs **Security Context Window Prioritizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security context window prioritizer normalization/assessment.
