...
## Metadata
- **Skill ID:** `531`
- **Skill Name:** `u0531-engineering-policy-constraint-compiler`
...
4. Keep routing aligned with `software-engineering-automation:contract-compiler` and include approval context.
...
- **Downstream Hint:** Route next to software-engineering-automation:contract-compiler consumers with approval-gate context
