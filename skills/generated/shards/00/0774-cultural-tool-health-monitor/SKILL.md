...
description: Operate the "Cultural Tool Health Monitor" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `774`
- **Skill Name:** `u0774-cultural-tool-health-monitor`
...
4. Keep routing aligned with `multilingual-and-cultural-adaptation:detection-guard` and include approval context.
...
### Handoff Contract
- **Produces:** `Cultural Tool Health Monitor normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `language variants`, `cultural norms`, `local preferences`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to multilingual-and-cultural-adaptation:detection-guard consumers with approval-gate context
