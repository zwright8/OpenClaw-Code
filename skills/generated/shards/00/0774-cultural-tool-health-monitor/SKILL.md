...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Tool Health Monitor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural tool health monitor normalization/assessment.
