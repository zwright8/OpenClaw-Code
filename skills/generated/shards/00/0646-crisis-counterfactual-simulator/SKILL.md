...
## When To Use
Use this skill when the request explicitly needs "Crisis Counterfactual Simulator" outcomes in the Crisis and Incident Response domain.
...
- Downstream routing hint: Route next to crisis-and-incident-response:simulation-lab consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis counterfactual simulator normalization/assessment.
