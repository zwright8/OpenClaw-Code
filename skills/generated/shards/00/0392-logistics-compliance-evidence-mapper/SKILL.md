...
description: Build and operate the "Logistics Compliance Evidence Mapper" capability for Resource Allocation and Logistics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Logistics Compliance Evidence Mapper" outcomes in the Resource Allocation and Logistics domain.
...
## Handoff Contract
- Produces: Logistics Compliance Evidence Mapper normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Logistics Compliance Evidence Mapper** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Resource Allocation and Logistics**
   - Input: noisy upstream payload requiring logistics compliance evidence mapper normalization/assessment.
