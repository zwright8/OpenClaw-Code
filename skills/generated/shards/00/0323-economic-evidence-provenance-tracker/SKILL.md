...
## Metadata
- **Skill ID:** `323`
- **Skill Name:** `u0323-economic-evidence-provenance-tracker`
...
4. Keep routing aligned with `economic-optimization:provenance-tracker` and include approval context.
...
### Handoff Contract
- **Produces:** `Economic Evidence Provenance Tracker normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `budgets`, `costs`, `benefits`, `opportunity values`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to economic-optimization:provenance-tracker consumers with approval-gate context
