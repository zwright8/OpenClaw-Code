...
description: Operate the "Inclusion Auto-Retry and Backoff Coordinator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Inclusion Auto-Retry and Backoff Coordinator" outcomes in the Accessibility and Inclusion domain.
...
## Handoff Contract
- Produces: Inclusion Auto-Retry and Backoff Coordinator normalized artifacts; execution scorecard; risk posture
- Consumes: accessibility audits; accommodations; usability feedback; claims; evidence; confidence traces
- Downstream routing hint: Route next to accessibility-and-inclusion:general-capability consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Auto-Retry and Backoff Coordinator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion auto-retry and backoff coordinator normalization/assessment.
