...
## Metadata
- **Skill ID:** `134`
- **Skill Name:** `u0134-tooling-tool-health-monitor`
...
4. Keep routing aligned with `tool-reliability-and-execution-quality:detection-guard` and include approval context.
...
### Handoff Contract
- **Produces:** `Tooling Tool Health Monitor normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `tool runs`, `error signatures`, `retry outcomes`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to tool-reliability-and-execution-quality:detection-guard consumers with approval-gate context
