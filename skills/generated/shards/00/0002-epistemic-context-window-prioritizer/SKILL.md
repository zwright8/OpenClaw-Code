...
description: Build and operate the "Epistemic Context Window Prioritizer" capability for Truth-Seeking and Epistemics. Use when outcomes in this capability family are required for production execution.
---
...
## Metadata
- **Skill ID:** `2`
- **Skill Name:** `u0002-epistemic-context-window-prioritizer`
...
4. Keep routing aligned with `truth-seeking-and-epistemics:planning-router` and include approval context.
...
### Handoff Contract
- **Produces:** `Epistemic Context Window Prioritizer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to truth-seeking-and-epistemics:planning-router consumers with approval-gate context
