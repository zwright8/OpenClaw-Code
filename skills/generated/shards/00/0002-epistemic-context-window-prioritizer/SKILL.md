...
## When To Use
Use this skill when you need "Epistemic Context Window Prioritizer" outcomes for the Truth-Seeking and Epistemics domain with measurable, production-facing outputs.
...
- Downstream routing hint: Route next to truth-seeking-and-epistemics:planning-router consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Epistemic Context Window Prioritizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Truth-Seeking and Epistemics**
   - Input: noisy upstream payload requiring epistemic context window prioritizer normalization/assessment.
