...
## Metadata
- **Skill ID:** `992`
- **Skill Name:** `u0992-evolution-compliance-evidence-mapper`
...
### Handoff Contract
- **Produces:** `Evolution Compliance Evidence Mapper normalized artifacts`, `execution scorecard`, `risk posture`
