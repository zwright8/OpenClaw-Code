---
name: u0071-planning-security-threat-modeler
description: Run the Planning Security Threat Modeler capability for Strategic Planning and Decomposition with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0071_planning-security-threat-modeler` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Planning Security Threat Modeler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Planning Security Threat Modeler.
...
## Operator Use Cases
- Operate Planning Security Threat Modeler as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 74):** release artifacts after validation pass and route to `strategic-planning-and-decomposition:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Planning Security Threat Modeler`, including at least three measurable KPIs tied to execution stalls and hidden dependency failures.
...
- Scoring weights: `truth=0.31, execution=0.17, safety=0.30, impact=0.22`
- Posture thresholds:
  - `ready`: score >= 74
  - `review`: score >= 49
  - `review_risk`: risk >= 36
...
1. Incident recovery in Strategic Planning and Decomposition: ingest noisy signals, execute attack-surface modeling, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Planning Security Threat Modeler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
