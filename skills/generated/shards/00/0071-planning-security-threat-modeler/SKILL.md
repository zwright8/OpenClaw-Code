...
description: Build and operate the "Planning Security Threat Modeler" capability for Strategic Planning and Decomposition. Use when outcomes in this capability family are required for production execution.
---
...
## Metadata
- **Skill ID:** `71`
- **Skill Name:** `u0071-planning-security-threat-modeler`
...
4. Keep routing aligned with `strategic-planning-and-decomposition:detection-guard` and include approval context.
...
### Handoff Contract
- **Produces:** `Planning Security Threat Modeler normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `goals`, `dependencies`, `milestones`, `constraints`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to strategic-planning-and-decomposition:detection-guard consumers with approval-gate context
