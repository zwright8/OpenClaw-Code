...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Explainability Narrative Builder** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis explainability narrative builder normalization/assessment.
