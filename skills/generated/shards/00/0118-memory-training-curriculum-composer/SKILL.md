...
- The task explicitly requires `u0118-memory-training-curriculum-composer` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
