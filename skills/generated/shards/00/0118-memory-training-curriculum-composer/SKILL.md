...
description: Build and operate the "Memory Training Curriculum Composer" capability for Memory and Knowledge Operations. Use when outcomes in this capability family are required for production execution.
---
...
## Metadata
- **Skill ID:** `118`
- **Skill Name:** `u0118-memory-training-curriculum-composer`
...
4. Keep routing aligned with `memory-and-knowledge-operations:general-capability` and include approval context.
...
### Handoff Contract
- **Produces:** `Memory Training Curriculum Composer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `episodic logs`, `knowledge nodes`, `retrieval metadata`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to memory-and-knowledge-operations:general-capability consumers with approval-gate context
