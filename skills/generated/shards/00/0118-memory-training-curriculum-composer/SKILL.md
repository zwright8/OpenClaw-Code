---
name: u0118-memory-training-curriculum-composer
description: Run the Memory Training Curriculum Composer capability for Memory and Knowledge Operations with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Memory Training Curriculum Composer
...
| Feature flag | `skill_0118_memory-training-curriculum-compo` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents lose performance when lessons are not retained and reused. This specific skill converts capability gaps into actionable upskilling programs.

## Trigger Checklist
- [ ] The task explicitly needs Memory Training Curriculum Composer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Memory Training Curriculum Composer.
...
## Operator Use Cases
- Operate Memory Training Curriculum Composer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 77):** release artifacts after validation pass and route to `memory-and-knowledge-operations:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Memory Training Curriculum Composer`, including at least three measurable KPIs tied to repeated mistakes and context loss.
...
- Scoring weights: `truth=0.18, execution=0.20, safety=0.28, impact=0.35`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 56
  - `review_risk`: risk >= 47
...
1. Incident recovery in Memory and Knowledge Operations: ingest noisy signals, execute sequenced learning path design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Memory Training Curriculum Composer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
