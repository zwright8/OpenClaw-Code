...
description: Run the Education Policy Constraint Compiler capability for Education and Upskilling with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
## Trigger Checklist
- [ ] The task explicitly needs Education Policy Constraint Compiler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Education Policy Constraint Compiler.
...
## Operator Use Cases
- Operate Education Policy Constraint Compiler as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `education-and-upskilling:contract-compiler`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Education Policy Constraint Compiler`, including at least three measurable KPIs tied to persistent skill gaps and poor learning outcomes.
...
- Scoring weights: `truth=0.31, execution=0.29, safety=0.28, impact=0.13`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 43
  - `review_risk`: risk >= 40
...
1. Incident recovery in Education and Upskilling: ingest noisy signals, execute rule compilation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Education Policy Constraint Compiler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
