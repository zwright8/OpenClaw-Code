...
- The task explicitly requires `u0147-tooling-a-b-rollout-governor` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
