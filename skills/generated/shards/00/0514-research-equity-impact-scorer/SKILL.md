...
description: Operate the "Research Equity Impact Scorer" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Research Equity Impact Scorer" outcomes in the Scientific Research Systems domain.
...
## Handoff Contract
- Produces: Research Equity Impact Scorer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Research Equity Impact Scorer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring research equity impact scorer normalization/assessment.
