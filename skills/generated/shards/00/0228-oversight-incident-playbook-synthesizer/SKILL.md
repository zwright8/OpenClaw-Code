...
## Metadata
- **Skill ID:** `228`
- **Skill Name:** `u0228-oversight-incident-playbook-synthesizer`
...
### Handoff Contract
- **Produces:** `Oversight Incident Playbook Synthesizer normalized artifacts`, `execution scorecard`, `risk posture`
