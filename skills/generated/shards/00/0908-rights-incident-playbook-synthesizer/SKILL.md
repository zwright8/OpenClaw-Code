---
name: u0908-rights-incident-playbook-synthesizer
description: Run the Rights Incident Playbook Synthesizer capability for Legal, Rights, and Compliance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Rights Incident Playbook Synthesizer
...
| Feature flag | `skill_0908_rights-incident-playbook-synthes` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because operations must preserve rights and satisfy jurisdictional obligations. This specific skill creates repeatable response procedures from incident history.

## Trigger Checklist
- [ ] The task explicitly needs Rights Incident Playbook Synthesizer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Rights Incident Playbook Synthesizer.
...
## Operator Use Cases
- Operate Rights Incident Playbook Synthesizer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `legal-rights-and-compliance:communication-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Rights Incident Playbook Synthesizer`, including at least three measurable KPIs tied to rights violations and compliance penalties.
...
- Scoring weights: `truth=0.26, execution=0.30, safety=0.25, impact=0.19`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 59
  - `review_risk`: risk >= 61
...
1. Incident recovery in Legal, Rights, and Compliance: ingest noisy signals, execute pattern-to-playbook synthesis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Rights Incident Playbook Synthesizer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
