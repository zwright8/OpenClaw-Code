...
## Metadata
- **Skill ID:** `365`
- **Skill Name:** `u0365-logistics-confidence-calibration-engine`
...
4. Keep routing aligned with `resource-allocation-and-logistics:optimization-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Logistics Confidence Calibration Engine normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `capacity`, `bottlenecks`, `distribution plans`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to resource-allocation-and-logistics:optimization-engine consumers with approval-gate context
