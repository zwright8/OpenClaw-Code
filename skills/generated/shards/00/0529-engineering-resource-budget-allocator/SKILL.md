---
name: u0529-engineering-resource-budget-allocator
description: Run the Engineering Resource Budget Allocator capability for Software Engineering Automation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Engineering Resource Budget Allocator
...
| Feature flag | `skill_0529_engineering-resource-budget-allo` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because delivery speed must increase without sacrificing correctness. This specific skill matches mission ambition to finite execution capacity.

## Trigger Checklist
- [ ] The task explicitly needs Engineering Resource Budget Allocator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Engineering Resource Budget Allocator.
...
## Operator Use Cases
- Operate Engineering Resource Budget Allocator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Engineering Resource Budget Allocator`, including at least three measurable KPIs tied to regressions and brittle release pipelines.
...
- Scoring weights: `truth=0.41, execution=0.19, safety=0.16, impact=0.24`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 50
  - `review_risk`: risk >= 33
...
1. Incident recovery in Software Engineering Automation: ingest noisy signals, execute capacity-aware allocation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Engineering Resource Budget Allocator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
