...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Conflict Resolution Coach** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra conflict resolution coach normalization/assessment.
