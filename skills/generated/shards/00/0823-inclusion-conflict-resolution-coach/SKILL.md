...
description: Operate the "Inclusion Conflict Resolution Coach" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `823`
- **Skill Name:** `u0823-inclusion-conflict-resolution-coach`
...
4. Keep routing aligned with `accessibility-and-inclusion:collaboration-mediator` and include approval context.
...
### Handoff Contract
- **Produces:** `Inclusion Conflict Resolution Coach normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `accessibility audits`, `accommodations`, `usability feedback`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to accessibility-and-inclusion:collaboration-mediator consumers with approval-gate context
