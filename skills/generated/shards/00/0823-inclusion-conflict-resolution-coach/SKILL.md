...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Conflict Resolution Coach** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion conflict resolution coach normalization/assessment.
