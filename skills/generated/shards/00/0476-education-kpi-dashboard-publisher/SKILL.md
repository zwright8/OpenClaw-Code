...
description: Build and operate the "Education KPI Dashboard Publisher" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education KPI Dashboard Publisher" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education KPI Dashboard Publisher normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education kpi dashboard publisher normalization/assessment.
