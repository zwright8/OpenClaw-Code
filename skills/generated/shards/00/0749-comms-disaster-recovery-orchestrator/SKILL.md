...
## When To Use
Use this skill when the request explicitly needs "Comms Disaster Recovery Orchestrator" outcomes in the Communication and Explainability domain.
...
## Handoff Contract
- Produces: Comms Disaster Recovery Orchestrator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Comms Disaster Recovery Orchestrator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms disaster recovery orchestrator normalization/assessment.
