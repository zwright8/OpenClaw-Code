...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Continuous Improvement Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural continuous improvement planner normalization/assessment.
