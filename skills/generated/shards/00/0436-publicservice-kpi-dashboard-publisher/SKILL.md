...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice kpi dashboard publisher normalization/assessment.
