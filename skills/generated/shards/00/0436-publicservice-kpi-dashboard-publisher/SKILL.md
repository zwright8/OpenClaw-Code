...
description: Build and operate the "PublicService KPI Dashboard Publisher" capability for Healthcare and Public Services. Trigger when this exact capability is needed in mission execution.
---
...
## Metadata
- **Skill ID:** `436`
- **Skill Name:** `u0436-publicservice-kpi-dashboard-publisher`
...
### Handoff Contract
- **Produces:** `PublicService KPI Dashboard Publisher normalized artifacts`, `execution scorecard`, `risk posture`
