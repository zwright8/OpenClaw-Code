...
- The task explicitly requires `u0115-memory-community-feedback-harvester` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
