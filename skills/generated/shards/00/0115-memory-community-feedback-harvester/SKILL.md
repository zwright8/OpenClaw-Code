---
name: u0115-memory-community-feedback-harvester
description: Run the Memory Community Feedback Harvester capability for Memory and Knowledge Operations with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Memory Community Feedback Harvester
...
| Feature flag | `skill_0115_memory-community-feedback-harves` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents lose performance when lessons are not retained and reused. This specific skill integrates lived user feedback into planning cycles.

## Trigger Checklist
- [ ] The task explicitly needs Memory Community Feedback Harvester (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Memory Community Feedback Harvester.
...
## Operator Use Cases
- Operate Memory Community Feedback Harvester as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `memory-and-knowledge-operations:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Memory Community Feedback Harvester`, including at least three measurable KPIs tied to repeated mistakes and context loss.
...
- Scoring weights: `truth=0.26, execution=0.26, safety=0.17, impact=0.30`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 54
  - `review_risk`: risk >= 51
...
1. Incident recovery in Memory and Knowledge Operations: ingest noisy signals, execute feedback normalization and clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Memory Community Feedback Harvester against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
