...
## Metadata
- **Skill ID:** `115`
- **Skill Name:** `u0115-memory-community-feedback-harvester`
...
### Handoff Contract
- **Produces:** `Memory Community Feedback Harvester normalized artifacts`, `execution scorecard`, `risk posture`
