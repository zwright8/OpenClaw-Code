---
name: u0651-crisis-policy-constraint-compiler
description: Run the Crisis Policy Constraint Compiler capability for Crisis and Incident Response with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Crisis Policy Constraint Compiler
...
| Feature flag | `skill_0651_crisis-policy-constraint-compile` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because response quality determines whether incidents are contained or amplified. This specific skill turns governance language into enforceable runtime checks.

## Trigger Checklist
- [ ] The task explicitly needs Crisis Policy Constraint Compiler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Crisis Policy Constraint Compiler.
...
## Operator Use Cases
- Operate Crisis Policy Constraint Compiler as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 77):** release artifacts after validation pass and route to `crisis-and-incident-response:contract-compiler`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Crisis Policy Constraint Compiler`, including at least three measurable KPIs tied to slow containment and repeated outages.
...
- Scoring weights: `truth=0.28, execution=0.28, safety=0.22, impact=0.21`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 50
  - `review_risk`: risk >= 44
...
1. Incident recovery in Crisis and Incident Response: ingest noisy signals, execute rule compilation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Crisis Policy Constraint Compiler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
