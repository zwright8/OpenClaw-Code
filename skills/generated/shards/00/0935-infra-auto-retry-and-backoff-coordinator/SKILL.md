...
description: Run the Infra Auto-Retry and Backoff Coordinator capability for Infrastructure and Sustainability with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0935_infra-auto-retry-and-backoff-coo` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Infra Auto-Retry and Backoff Coordinator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Infra Auto-Retry and Backoff Coordinator.
...
## Operator Use Cases
- Operate Infra Auto-Retry and Backoff Coordinator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Infra Auto-Retry and Backoff Coordinator`, including at least three measurable KPIs tied to capacity collapse and environmental debt.
...
- Scoring weights: `truth=0.23, execution=0.25, safety=0.31, impact=0.20`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 54
  - `review_risk`: risk >= 46
...
1. Incident recovery in Infrastructure and Sustainability: ingest noisy signals, execute adaptive backoff control, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Infra Auto-Retry and Backoff Coordinator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
