...
## Metadata
- **Skill ID:** `491`
- **Skill Name:** `u0491-research-policy-constraint-compiler`
...
4. Keep routing aligned with `scientific-research-systems:contract-compiler` and include approval context.
...
- **Downstream Hint:** Route next to scientific-research-systems:contract-compiler consumers with approval-gate context
