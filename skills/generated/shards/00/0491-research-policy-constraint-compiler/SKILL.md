...
description: Build and operate the "Research Policy Constraint Compiler" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Research Policy Constraint Compiler" outcomes in the Scientific Research Systems domain.
...
## Handoff Contract
- Produces: Research Policy Constraint Compiler normalized artifacts; execution scorecard; risk posture
- Consumes: hypotheses; experiments; replication evidence; claims; evidence; confidence traces
- Downstream routing hint: Route next to scientific-research-systems:contract-compiler consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Research Policy Constraint Compiler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Scientific Research Systems**
   - Input: noisy upstream payload requiring research policy constraint compiler normalization/assessment.
