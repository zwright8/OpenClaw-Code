---
name: u0491-research-policy-constraint-compiler
description: Run the Research Policy Constraint Compiler capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Research Policy Constraint Compiler
...
| Feature flag | `skill_0491_research-policy-constraint-compi` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because research throughput degrades without reproducibility and prioritization. This specific skill turns governance language into enforceable runtime checks.

## Trigger Checklist
- [ ] The task explicitly needs Research Policy Constraint Compiler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Policy Constraint Compiler.
...
## Operator Use Cases
- Operate Research Policy Constraint Compiler as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 72):** release artifacts after validation pass and route to `scientific-research-systems:contract-compiler`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Policy Constraint Compiler`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.17, execution=0.25, safety=0.27, impact=0.31`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 58
  - `review_risk`: risk >= 57
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute rule compilation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Policy Constraint Compiler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
