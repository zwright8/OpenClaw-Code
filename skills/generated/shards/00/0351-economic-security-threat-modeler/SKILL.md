---
name: u0351-economic-security-threat-modeler
description: Run the Economic Security Threat Modeler capability for Economic Optimization with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Economic Security Threat Modeler
...
| Feature flag | `skill_0351_economic-security-threat-modeler` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need explicit tradeoff logic for cost, speed, and impact. This specific skill anticipates attack paths before adversaries exploit them.

## Trigger Checklist
- [ ] The task explicitly needs Economic Security Threat Modeler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Economic Security Threat Modeler.
...
## Operator Use Cases
- Operate Economic Security Threat Modeler as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `economic-optimization:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Economic Security Threat Modeler`, including at least three measurable KPIs tied to overspending and low-impact allocation.
...
- Scoring weights: `truth=0.22, execution=0.45, safety=0.16, impact=0.17`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 48
  - `review_risk`: risk >= 34
...
1. Incident recovery in Economic Optimization: ingest noisy signals, execute attack-surface modeling, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Economic Security Threat Modeler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
