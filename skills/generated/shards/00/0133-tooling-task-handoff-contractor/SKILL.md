...
- The task explicitly requires `u0133-tooling-task-handoff-contractor` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
