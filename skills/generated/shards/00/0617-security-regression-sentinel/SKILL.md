...
description: Operate the "Security Regression Sentinel" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Security Regression Sentinel" outcomes in the Security and Privacy domain.
...
## Handoff Contract
- Produces: Security Regression Sentinel normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Security Regression Sentinel** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security regression sentinel normalization/assessment.
