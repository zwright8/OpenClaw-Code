...
## When To Use
Use this skill when the request explicitly needs "Community Risk-Aware Scheduler" outcomes in the Community Engagement and Feedback domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Community Risk-Aware Scheduler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community risk-aware scheduler normalization/assessment.
