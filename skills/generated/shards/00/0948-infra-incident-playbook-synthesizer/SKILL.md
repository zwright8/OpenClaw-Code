...
description: Operate the "Infra Incident Playbook Synthesizer" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Infra Incident Playbook Synthesizer" outcomes in the Infrastructure and Sustainability domain.
...
## Handoff Contract
- Produces: Infra Incident Playbook Synthesizer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Incident Playbook Synthesizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra incident playbook synthesizer normalization/assessment.
