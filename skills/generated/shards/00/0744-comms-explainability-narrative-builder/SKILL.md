...
## Trigger Checklist
- [ ] The request explicitly needs **Comms Explainability Narrative Builder** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms explainability narrative builder normalization/assessment.
