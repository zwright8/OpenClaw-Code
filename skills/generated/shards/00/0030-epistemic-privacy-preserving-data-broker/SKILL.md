---
name: u0030-epistemic-privacy-preserving-data-broker
description: Run the Epistemic Privacy Preserving Data Broker capability for Truth-Seeking and Epistemics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0030_epistemic-privacy-preserving-dat` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Epistemic Privacy Preserving Data Broker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Epistemic Privacy Preserving Data Broker.
...
## Operator Use Cases
- Operate Epistemic Privacy Preserving Data Broker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 77):** release artifacts after validation pass and route to `truth-seeking-and-epistemics:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Epistemic Privacy Preserving Data Broker`, including at least three measurable KPIs tied to false certainty and unverified assumptions.
...
- Scoring weights: `truth=0.34, execution=0.27, safety=0.23, impact=0.16`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 45
  - `review_risk`: risk >= 46
...
1. Incident recovery in Truth-Seeking and Epistemics: ingest noisy signals, execute policy-scoped data mediation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Epistemic Privacy Preserving Data Broker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
