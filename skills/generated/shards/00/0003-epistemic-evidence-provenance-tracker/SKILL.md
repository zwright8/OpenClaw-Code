...
## Trigger Checklist
- [ ] The request explicitly needs **Epistemic Evidence Provenance Tracker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Truth-Seeking and Epistemics**
   - Input: noisy upstream payload requiring epistemic evidence provenance tracker normalization/assessment.
