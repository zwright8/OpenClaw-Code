...
description: Run the Epistemic Evidence Provenance Tracker capability for Truth-Seeking and Epistemics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0003_epistemic-evidence-provenance-tr` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Epistemic Evidence Provenance Tracker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Epistemic Evidence Provenance Tracker.
...
## Operator Use Cases
- Operate Epistemic Evidence Provenance Tracker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `truth-seeking-and-epistemics:provenance-tracker`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Epistemic Evidence Provenance Tracker`, including at least three measurable KPIs tied to false certainty and unverified assumptions.
...
- Scoring weights: `truth=0.27, execution=0.25, safety=0.33, impact=0.15`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 53
  - `review_risk`: risk >= 47
...
1. Incident recovery in Truth-Seeking and Epistemics: ingest noisy signals, execute signed provenance links, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Epistemic Evidence Provenance Tracker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
3. Pre-deployment gate: validate artifacts for truth-seeking-and-epistemics:provenance-tracker, enforce approvals, then handoff to downstream orchestrator with next actions.
...
- **Downstream hint:** route only to `truth-seeking-and-epistemics:provenance-tracker` consumers with approval context attached.
