...
## Metadata
- **Skill ID:** `3`
- **Skill Name:** `u0003-epistemic-evidence-provenance-tracker`
...
4. Keep routing aligned with `truth-seeking-and-epistemics:provenance-tracker` and include approval context.
...
- **Downstream Hint:** Route next to truth-seeking-and-epistemics:provenance-tracker consumers with approval-gate context
