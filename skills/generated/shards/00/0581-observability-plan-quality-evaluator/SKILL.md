...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Plan Quality Evaluator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability plan quality evaluator normalization/assessment.
