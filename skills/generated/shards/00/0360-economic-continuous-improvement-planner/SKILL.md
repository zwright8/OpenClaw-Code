...
## Metadata
- **Skill ID:** `360`
- **Skill Name:** `u0360-economic-continuous-improvement-planner`
...
### Handoff Contract
- **Produces:** `Economic Continuous Improvement Planner normalized artifacts`, `execution scorecard`, `risk posture`
