...
## Metadata
- **Skill ID:** `281`
- **Skill Name:** `u0281-federation-signal-ingestion-normalizer`
...
### Handoff Contract
- **Produces:** `Federation Signal Ingestion Normalizer normalized artifacts`, `execution scorecard`, `risk posture`
