...
description: Operate the "Crisis Conflict Resolution Coach" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `663`
- **Skill Name:** `u0663-crisis-conflict-resolution-coach`
...
4. Keep routing aligned with `crisis-and-incident-response:collaboration-mediator` and include approval context.
...
### Handoff Contract
- **Produces:** `Crisis Conflict Resolution Coach normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `incident timelines`, `response roles`, `recovery artifacts`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to crisis-and-incident-response:collaboration-mediator consumers with approval-gate context
