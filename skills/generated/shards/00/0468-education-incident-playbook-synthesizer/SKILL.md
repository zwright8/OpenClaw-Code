---
name: u0468-education-incident-playbook-synthesizer
description: Run the Education Incident Playbook Synthesizer capability for Education and Upskilling with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Education Incident Playbook Synthesizer
...
| Feature flag | `skill_0468_education-incident-playbook-synt` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because human capability growth requires targeted planning under constraints. This specific skill creates repeatable response procedures from incident history.

## Trigger Checklist
- [ ] The task explicitly needs Education Incident Playbook Synthesizer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Education Incident Playbook Synthesizer.
...
## Operator Use Cases
- Operate Education Incident Playbook Synthesizer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Education Incident Playbook Synthesizer`, including at least three measurable KPIs tied to persistent skill gaps and poor learning outcomes.
...
- Scoring weights: `truth=0.16, execution=0.33, safety=0.17, impact=0.34`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 57
  - `review_risk`: risk >= 49
...
1. Incident recovery in Education and Upskilling: ingest noisy signals, execute pattern-to-playbook synthesis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Education Incident Playbook Synthesizer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
