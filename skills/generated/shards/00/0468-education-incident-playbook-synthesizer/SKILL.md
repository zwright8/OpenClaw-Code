...
description: Build and operate the "Education Incident Playbook Synthesizer" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Incident Playbook Synthesizer" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Incident Playbook Synthesizer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Incident Playbook Synthesizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education incident playbook synthesizer normalization/assessment.
