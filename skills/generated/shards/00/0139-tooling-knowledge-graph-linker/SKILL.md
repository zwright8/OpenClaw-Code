...
- The task explicitly requires `u0139-tooling-knowledge-graph-linker` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
