...
## When To Use
Use this skill when the request explicitly needs "Crisis Self-Reflection Error Taxonomist" outcomes in the Crisis and Incident Response domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis self-reflection error taxonomist normalization/assessment.
