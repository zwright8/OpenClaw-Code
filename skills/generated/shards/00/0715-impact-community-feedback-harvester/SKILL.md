---
name: u0715-impact-community-feedback-harvester
description: Run the Impact Community Feedback Harvester capability for Social Impact Measurement with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Impact Community Feedback Harvester
...
| Feature flag | `skill_0715_impact-community-feedback-harves` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need measurable outcomes, not just activity volume. This specific skill integrates lived user feedback into planning cycles.

## Trigger Checklist
- [ ] The task explicitly needs Impact Community Feedback Harvester (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Impact Community Feedback Harvester.
...
## Operator Use Cases
- Operate Impact Community Feedback Harvester as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 75):** release artifacts after validation pass and route to `social-impact-measurement:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Impact Community Feedback Harvester`, including at least three measurable KPIs tied to impact theater and unmeasured harm.
...
- Scoring weights: `truth=0.26, execution=0.37, safety=0.19, impact=0.18`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 54
  - `review_risk`: risk >= 48
...
1. Incident recovery in Social Impact Measurement: ingest noisy signals, execute feedback normalization and clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Impact Community Feedback Harvester against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
