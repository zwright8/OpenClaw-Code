...
description: Run the Governance Memory Consolidation Pipeline capability for Safety and Governance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0178_governance-memory-consolidation-` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Governance Memory Consolidation Pipeline (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Governance Memory Consolidation Pipeline.
...
## Operator Use Cases
- Operate Governance Memory Consolidation Pipeline as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 71):** release artifacts after validation pass and route to `safety-and-governance:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Governance Memory Consolidation Pipeline`, including at least three measurable KPIs tied to unsafe actions and policy drift.
...
- Scoring weights: `truth=0.12, execution=0.30, safety=0.35, impact=0.24`
- Posture thresholds:
  - `ready`: score >= 71
  - `review`: score >= 42
  - `review_risk`: risk >= 36
...
1. Incident recovery in Safety and Governance: ingest noisy signals, execute episodic-to-semantic consolidation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Governance Memory Consolidation Pipeline against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
