...
description: Run the Crisis Skill Gap Diagnoser capability for Crisis and Incident Response with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0677_crisis-skill-gap-diagnoser` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Crisis Skill Gap Diagnoser (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Crisis Skill Gap Diagnoser.
...
## Operator Use Cases
- Operate Crisis Skill Gap Diagnoser as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Crisis Skill Gap Diagnoser`, including at least three measurable KPIs tied to slow containment and repeated outages.
...
- Scoring weights: `truth=0.22, execution=0.30, safety=0.28, impact=0.20`
- Posture thresholds:
  - `ready`: score >= 73
  - `review`: score >= 47
  - `review_risk`: risk >= 46
...
1. Incident recovery in Crisis and Incident Response: ingest noisy signals, execute competency coverage analysis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Crisis Skill Gap Diagnoser against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
