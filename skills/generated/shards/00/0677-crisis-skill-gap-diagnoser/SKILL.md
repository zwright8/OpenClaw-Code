...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Skill Gap Diagnoser** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis skill gap diagnoser normalization/assessment.
