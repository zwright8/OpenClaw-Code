...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Semantic Retrieval Ranker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural semantic retrieval ranker normalization/assessment.
