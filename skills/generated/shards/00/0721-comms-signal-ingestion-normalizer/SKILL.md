...
## Metadata
- **Skill ID:** `721`
- **Skill Name:** `u0721-comms-signal-ingestion-normalizer`
...
4. Keep routing aligned with `communication-and-explainability:normalization-engine` and include approval context.
...
- **Downstream Hint:** Route next to communication-and-explainability:normalization-engine consumers with approval-gate context
