...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability counterfactual simulator normalization/assessment.
