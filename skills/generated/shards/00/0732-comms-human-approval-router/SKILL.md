...
## When To Use
Use this skill when the request explicitly needs "Comms Human Approval Router" outcomes in the Communication and Explainability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Comms Human Approval Router** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms human approval router normalization/assessment.
