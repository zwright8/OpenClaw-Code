...
description: Build and operate the "Education Counterfactual Simulator" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## Metadata
- **Skill ID:** `446`
- **Skill Name:** `u0446-education-counterfactual-simulator`
...
4. Keep routing aligned with `education-and-upskilling:simulation-lab` and include approval context.
...
### Handoff Contract
- **Produces:** `Education Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `skill profiles`, `learning paths`, `support resources`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to education-and-upskilling:simulation-lab consumers with approval-gate context
