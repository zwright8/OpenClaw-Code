...
## When To Use
Use this skill when the request explicitly needs "Education Counterfactual Simulator" outcomes in the Education and Upskilling domain.
...
- Downstream routing hint: Route next to education-and-upskilling:simulation-lab consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education counterfactual simulator normalization/assessment.
