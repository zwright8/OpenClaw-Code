...
description: Operate the "Evolution Policy Constraint Compiler" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `971`
- **Skill Name:** `u0971-evolution-policy-constraint-compiler`
...
4. Keep routing aligned with `autonomous-learning-and-evolution:contract-compiler` and include approval context.
...
### Handoff Contract
- **Produces:** `Evolution Policy Constraint Compiler normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `outcomes`, `error taxonomies`, `adaptation decisions`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to autonomous-learning-and-evolution:contract-compiler consumers with approval-gate context
