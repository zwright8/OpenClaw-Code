...
description: Run the Impact Privacy Preserving Data Broker capability for Social Impact Measurement with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0710_impact-privacy-preserving-data-b` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Impact Privacy Preserving Data Broker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Impact Privacy Preserving Data Broker.
...
## Operator Use Cases
- Operate Impact Privacy Preserving Data Broker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `social-impact-measurement:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Impact Privacy Preserving Data Broker`, including at least three measurable KPIs tied to impact theater and unmeasured harm.
...
- Scoring weights: `truth=0.18, execution=0.35, safety=0.21, impact=0.27`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 52
  - `review_risk`: risk >= 52
...
1. Incident recovery in Social Impact Measurement: ingest noisy signals, execute policy-scoped data mediation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Impact Privacy Preserving Data Broker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
