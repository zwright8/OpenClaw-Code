...
## When To Use
Use this skill when you need "Security Uncertainty Communicator" outcomes for the Security and Privacy domain with measurable, production-facing outputs.
...
## Trigger Checklist
- [ ] The request explicitly needs **Security Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security uncertainty communicator normalization/assessment.
