...
## Metadata
- **Skill ID:** `550`
- **Skill Name:** `u0550-engineering-privacy-preserving-data-broker`
...
4. Keep routing aligned with `software-engineering-automation:collaboration-mediator` and include approval context.
...
- **Downstream Hint:** Route next to software-engineering-automation:collaboration-mediator consumers with approval-gate context
