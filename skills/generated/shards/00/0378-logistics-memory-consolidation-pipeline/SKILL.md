---
name: u0378-logistics-memory-consolidation-pipeline
description: Run the Logistics Memory Consolidation Pipeline capability for Resource Allocation and Logistics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Logistics Memory Consolidation Pipeline
...
| Feature flag | `skill_0378_logistics-memory-consolidation-p` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because impact work fails when scarce resources are not routed intelligently. This specific skill turns raw logs into durable reusable memory.

## Trigger Checklist
- [ ] The task explicitly needs Logistics Memory Consolidation Pipeline (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Logistics Memory Consolidation Pipeline.
...
## Operator Use Cases
- Operate Logistics Memory Consolidation Pipeline as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `resource-allocation-and-logistics:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Logistics Memory Consolidation Pipeline`, including at least three measurable KPIs tied to supply shortfalls and fairness gaps.
...
- Scoring weights: `truth=0.34, execution=0.23, safety=0.14, impact=0.29`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 60
  - `review_risk`: risk >= 51
...
1. Incident recovery in Resource Allocation and Logistics: ingest noisy signals, execute episodic-to-semantic consolidation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Logistics Memory Consolidation Pipeline against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
