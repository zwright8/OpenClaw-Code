...
## Metadata
- **Skill ID:** `378`
- **Skill Name:** `u0378-logistics-memory-consolidation-pipeline`
...
### Handoff Contract
- **Produces:** `Logistics Memory Consolidation Pipeline normalized artifacts`, `execution scorecard`, `risk posture`
