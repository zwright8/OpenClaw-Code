...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis uncertainty communicator normalization/assessment.
