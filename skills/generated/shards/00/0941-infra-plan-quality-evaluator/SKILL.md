...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Plan Quality Evaluator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra plan quality evaluator normalization/assessment.
