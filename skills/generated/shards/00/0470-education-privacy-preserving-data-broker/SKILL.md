...
description: Build and operate the "Education Privacy Preserving Data Broker" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Privacy Preserving Data Broker" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Privacy Preserving Data Broker normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Privacy Preserving Data Broker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education privacy preserving data broker normalization/assessment.
