---
name: u0470-education-privacy-preserving-data-broker
description: Run the Education Privacy Preserving Data Broker capability for Education and Upskilling with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Education Privacy Preserving Data Broker
...
| Feature flag | `skill_0470_education-privacy-preserving-dat` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because human capability growth requires targeted planning under constraints. This specific skill enables collaboration while minimizing raw data exposure.

## Trigger Checklist
- [ ] The task explicitly needs Education Privacy Preserving Data Broker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Education Privacy Preserving Data Broker.
...
## Operator Use Cases
- Operate Education Privacy Preserving Data Broker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `education-and-upskilling:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Education Privacy Preserving Data Broker`, including at least three measurable KPIs tied to persistent skill gaps and poor learning outcomes.
...
- Scoring weights: `truth=0.29, execution=0.26, safety=0.28, impact=0.18`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 44
  - `review_risk`: risk >= 46
...
1. Incident recovery in Education and Upskilling: ingest noisy signals, execute policy-scoped data mediation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Education Privacy Preserving Data Broker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
