...
## Trigger Checklist
- [ ] The request explicitly needs **Research Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Scientific Research Systems**
   - Input: noisy upstream payload requiring research counterfactual simulator normalization/assessment.
