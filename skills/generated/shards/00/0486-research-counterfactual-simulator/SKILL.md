...
## Metadata
- **Skill ID:** `486`
- **Skill Name:** `u0486-research-counterfactual-simulator`
...
4. Keep routing aligned with `scientific-research-systems:simulation-lab` and include approval context.
...
### Handoff Contract
- **Produces:** `Research Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `hypotheses`, `experiments`, `replication evidence`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to scientific-research-systems:simulation-lab consumers with approval-gate context
