...
description: Run the Rights Auto-Retry and Backoff Coordinator capability for Legal, Rights, and Compliance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0895_rights-auto-retry-and-backoff-co` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Rights Auto-Retry and Backoff Coordinator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Rights Auto-Retry and Backoff Coordinator.
...
## Operator Use Cases
- Operate Rights Auto-Retry and Backoff Coordinator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 74):** release artifacts after validation pass and route to `legal-rights-and-compliance:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Rights Auto-Retry and Backoff Coordinator`, including at least three measurable KPIs tied to rights violations and compliance penalties.
...
- Scoring weights: `truth=0.17, execution=0.39, safety=0.19, impact=0.25`
- Posture thresholds:
  - `ready`: score >= 74
  - `review`: score >= 53
  - `review_risk`: risk >= 54
...
1. Incident recovery in Legal, Rights, and Compliance: ingest noisy signals, execute adaptive backoff control, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Rights Auto-Retry and Backoff Coordinator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
