...
## Metadata
- **Skill ID:** `632`
- **Skill Name:** `u0632-security-compliance-evidence-mapper`
...
4. Keep routing aligned with `security-and-privacy:normalization-engine` and include approval context.
...
- **Downstream Hint:** Route next to security-and-privacy:normalization-engine consumers with approval-gate context
