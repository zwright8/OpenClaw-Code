---
name: u0632-security-compliance-evidence-mapper
description: Run the Security Compliance Evidence Mapper capability for Security and Privacy with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Security Compliance Evidence Mapper
...
| Feature flag | `skill_0632_security-compliance-evidence-map` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because production autonomy must default to least privilege and strong privacy. This specific skill keeps proof of control coverage continuously current.

## Trigger Checklist
- [ ] The task explicitly needs Security Compliance Evidence Mapper (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Security Compliance Evidence Mapper.
...
## Operator Use Cases
- Operate Security Compliance Evidence Mapper as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 76):** release artifacts after validation pass and route to `security-and-privacy:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Security Compliance Evidence Mapper`, including at least three measurable KPIs tied to breach, exfiltration, and over-privileged actions.
...
- Scoring weights: `truth=0.17, execution=0.29, safety=0.35, impact=0.19`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 51
  - `review_risk`: risk >= 42
...
1. Incident recovery in Security and Privacy: ingest noisy signals, execute requirement-to-evidence mapping, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Security Compliance Evidence Mapper against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
