...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Security Threat Modeler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability security threat modeler normalization/assessment.
