...
## Metadata
- **Skill ID:** `4`
- **Skill Name:** `u0004-epistemic-contradiction-detector`
...
4. Keep routing aligned with `truth-seeking-and-epistemics:detection-guard` and include approval context.
...
- **Downstream Hint:** Route next to truth-seeking-and-epistemics:detection-guard consumers with approval-gate context
