---
name: u0004-epistemic-contradiction-detector
description: Run the Epistemic Contradiction Detector capability for Truth-Seeking and Epistemics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Epistemic Contradiction Detector
...
| Feature flag | `skill_0004_epistemic-contradiction-detector` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because decisions drift when claims are accepted without verification. This specific skill catches internal and external claim conflicts early.

## Trigger Checklist
- [ ] The task explicitly needs Epistemic Contradiction Detector (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Epistemic Contradiction Detector.
...
## Operator Use Cases
- Operate Epistemic Contradiction Detector as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 72):** release artifacts after validation pass and route to `truth-seeking-and-epistemics:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Epistemic Contradiction Detector`, including at least three measurable KPIs tied to false certainty and unverified assumptions.
...
- Scoring weights: `truth=0.14, execution=0.31, safety=0.23, impact=0.31`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 57
  - `review_risk`: risk >= 60
...
1. Incident recovery in Truth-Seeking and Epistemics: ingest noisy signals, execute cross-claim consistency checks, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Epistemic Contradiction Detector against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
