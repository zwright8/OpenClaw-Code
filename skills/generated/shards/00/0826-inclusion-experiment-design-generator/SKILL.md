...
## When To Use
Use this skill when the request explicitly needs "Inclusion Experiment Design Generator" outcomes in the Accessibility and Inclusion domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Experiment Design Generator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion experiment design generator normalization/assessment.
