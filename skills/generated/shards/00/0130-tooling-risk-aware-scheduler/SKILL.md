...
- The task explicitly requires `u0130-tooling-risk-aware-scheduler` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
