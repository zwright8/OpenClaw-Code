...
## When To Use
Use this skill when the request explicitly needs "Rights KPI Dashboard Publisher" outcomes in the Legal, Rights, and Compliance domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Rights KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights kpi dashboard publisher normalization/assessment.
