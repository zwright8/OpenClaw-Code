...
- The task explicitly requires `u0144-tooling-explainability-narrative-builder` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
