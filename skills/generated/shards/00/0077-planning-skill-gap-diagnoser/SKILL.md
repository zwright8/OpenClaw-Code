...
description: Run the Planning Skill Gap Diagnoser capability for Strategic Planning and Decomposition with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0077_planning-skill-gap-diagnoser` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Planning Skill Gap Diagnoser (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Planning Skill Gap Diagnoser.
...
## Operator Use Cases
- Operate Planning Skill Gap Diagnoser as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 76):** release artifacts after validation pass and route to `strategic-planning-and-decomposition:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Planning Skill Gap Diagnoser`, including at least three measurable KPIs tied to execution stalls and hidden dependency failures.
...
- Scoring weights: `truth=0.21, execution=0.16, safety=0.45, impact=0.18`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 53
  - `review_risk`: risk >= 60
...
1. Incident recovery in Strategic Planning and Decomposition: ingest noisy signals, execute competency coverage analysis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Planning Skill Gap Diagnoser against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
