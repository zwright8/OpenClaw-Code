...
## When To Use
Use this skill when the request explicitly needs "Cultural KPI Dashboard Publisher" outcomes in the Multilingual and Cultural Adaptation domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural kpi dashboard publisher normalization/assessment.
