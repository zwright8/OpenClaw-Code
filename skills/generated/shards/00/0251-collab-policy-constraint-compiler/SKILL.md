...
## Metadata
- **Skill ID:** `251`
- **Skill Name:** `u0251-collab-policy-constraint-compiler`
...
4. Keep routing aligned with `collaboration-and-negotiation:contract-compiler` and include approval context.
...
### Handoff Contract
- **Produces:** `Collab Policy Constraint Compiler normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `proposals`, `contention signals`, `negotiated outcomes`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to collaboration-and-negotiation:contract-compiler consumers with approval-gate context
