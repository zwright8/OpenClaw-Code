...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Explainability Narrative Builder** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering explainability narrative builder normalization/assessment.
