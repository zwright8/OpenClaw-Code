---
name: u0395-logistics-community-feedback-harvester
description: Run the Logistics Community Feedback Harvester capability for Resource Allocation and Logistics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Logistics Community Feedback Harvester
...
| Feature flag | `skill_0395_logistics-community-feedback-har` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because impact work fails when scarce resources are not routed intelligently. This specific skill integrates lived user feedback into planning cycles.

## Trigger Checklist
- [ ] The task explicitly needs Logistics Community Feedback Harvester (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Logistics Community Feedback Harvester.
...
## Operator Use Cases
- Operate Logistics Community Feedback Harvester as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 72):** release artifacts after validation pass and route to `resource-allocation-and-logistics:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Logistics Community Feedback Harvester`, including at least three measurable KPIs tied to supply shortfalls and fairness gaps.
...
- Scoring weights: `truth=0.19, execution=0.30, safety=0.18, impact=0.33`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 54
  - `review_risk`: risk >= 59
...
1. Incident recovery in Resource Allocation and Logistics: ingest noisy signals, execute feedback normalization and clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Logistics Community Feedback Harvester against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
