...
description: Build and operate the "Epistemic Disaster Recovery Orchestrator" capability for Truth-Seeking and Epistemics. Use when outcomes in this capability family are required for production execution.
---
...
## When To Use
Use this skill when you need "Epistemic Disaster Recovery Orchestrator" outcomes for the Truth-Seeking and Epistemics domain with measurable, production-facing outputs.
...
## Handoff Contract
- Produces: Epistemic Disaster Recovery Orchestrator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Epistemic Disaster Recovery Orchestrator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Truth-Seeking and Epistemics**
   - Input: noisy upstream payload requiring epistemic disaster recovery orchestrator normalization/assessment.
