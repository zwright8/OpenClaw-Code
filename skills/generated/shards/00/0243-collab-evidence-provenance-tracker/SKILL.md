...
## Metadata
- **Skill ID:** `243`
- **Skill Name:** `u0243-collab-evidence-provenance-tracker`
...
4. Keep routing aligned with `collaboration-and-negotiation:provenance-tracker` and include approval context.
...
### Handoff Contract
- **Produces:** `Collab Evidence Provenance Tracker normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `proposals`, `contention signals`, `negotiated outcomes`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to collaboration-and-negotiation:provenance-tracker consumers with approval-gate context
