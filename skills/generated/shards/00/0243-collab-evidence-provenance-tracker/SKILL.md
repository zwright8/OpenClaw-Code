---
name: u0243-collab-evidence-provenance-tracker
description: Run the Collab Evidence Provenance Tracker capability for Collaboration and Negotiation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Collab Evidence Provenance Tracker
...
| Routing tag | `collaboration-and-negotiation:provenance-tracker` |
| Feature flag | `skill_0243_collab-evidence-provenance-track` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because multi-agent systems underperform without explicit conflict resolution. This specific skill preserves source lineage so claims remain auditable.

## Trigger Checklist
- [ ] The task explicitly needs Collab Evidence Provenance Tracker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Collab Evidence Provenance Tracker.
...
## Operator Use Cases
- Operate Collab Evidence Provenance Tracker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 73):** release artifacts after validation pass and route to `collaboration-and-negotiation:provenance-tracker`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Collab Evidence Provenance Tracker`, including at least three measurable KPIs tied to deadlocks and degraded trust.
...
- Scoring weights: `truth=0.12, execution=0.33, safety=0.24, impact=0.31`
- Posture thresholds:
  - `ready`: score >= 73
  - `review`: score >= 49
  - `review_risk`: risk >= 46
...
1. Incident recovery in Collaboration and Negotiation: ingest noisy signals, execute signed provenance links, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Collab Evidence Provenance Tracker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
3. Pre-deployment gate: validate artifacts for collaboration-and-negotiation:provenance-tracker, enforce approvals, then handoff to downstream orchestrator with next actions.
...
- **Downstream hint:** route only to `collaboration-and-negotiation:provenance-tracker` consumers with approval context attached.
