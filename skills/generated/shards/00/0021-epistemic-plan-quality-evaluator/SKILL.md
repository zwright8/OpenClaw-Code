...
## When To Use
Use this skill when you need "Epistemic Plan Quality Evaluator" outcomes for the Truth-Seeking and Epistemics domain with measurable, production-facing outputs.
...
## Trigger Checklist
- [ ] The request explicitly needs **Epistemic Plan Quality Evaluator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Truth-Seeking and Epistemics**
   - Input: noisy upstream payload requiring epistemic plan quality evaluator normalization/assessment.
