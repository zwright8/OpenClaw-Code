...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Continuous Improvement Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering continuous improvement planner normalization/assessment.
