---
name: u0972-evolution-human-approval-router
description: Run the Evolution Human Approval Router capability for Autonomous Learning and Evolution with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Evolution Human Approval Router
...
| Feature flag | `skill_0972_evolution-human-approval-router` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents stagnate without structured reflection and continuous improvement loops. This specific skill directs high-risk decisions to the right humans quickly.

## Trigger Checklist
- [ ] The task explicitly needs Evolution Human Approval Router (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Evolution Human Approval Router.
...
## Operator Use Cases
- Operate Evolution Human Approval Router as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Evolution Human Approval Router`, including at least three measurable KPIs tied to capability stagnation and repeated blind spots.
...
- Scoring weights: `truth=0.27, execution=0.31, safety=0.13, impact=0.29`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 62
  - `review_risk`: risk >= 52
...
1. Incident recovery in Autonomous Learning and Evolution: ingest noisy signals, execute reviewer routing policies, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Evolution Human Approval Router against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
