...
description: Operate the "Research KPI Dashboard Publisher" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `516`
- **Skill Name:** `u0516-research-kpi-dashboard-publisher`
...
4. Keep routing aligned with `scientific-research-systems:communication-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Research KPI Dashboard Publisher normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `hypotheses`, `experiments`, `replication evidence`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to scientific-research-systems:communication-engine consumers with approval-gate context
