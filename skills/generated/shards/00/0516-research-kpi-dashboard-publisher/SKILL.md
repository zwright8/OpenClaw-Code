...
## When To Use
Use this skill when the request explicitly needs "Research KPI Dashboard Publisher" outcomes in the Scientific Research Systems domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Research KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring research kpi dashboard publisher normalization/assessment.
