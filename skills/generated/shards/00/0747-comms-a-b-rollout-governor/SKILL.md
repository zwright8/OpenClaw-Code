...
## When To Use
Use this skill when the request explicitly needs "Comms A/B Rollout Governor" outcomes in the Communication and Explainability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Comms A/B Rollout Governor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms a/b rollout governor normalization/assessment.
