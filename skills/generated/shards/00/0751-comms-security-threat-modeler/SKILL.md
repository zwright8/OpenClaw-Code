...
## When To Use
Use this skill when the request explicitly needs "Comms Security Threat Modeler" outcomes in the Communication and Explainability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Comms Security Threat Modeler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms security threat modeler normalization/assessment.
