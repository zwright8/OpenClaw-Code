...
- The task explicitly requires `u0105-memory-uncertainty-communicator` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
