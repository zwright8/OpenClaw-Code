...
## Metadata
- **Skill ID:** `683`
- **Skill Name:** `u0683-impact-evidence-provenance-tracker`
...
4. Keep routing aligned with `social-impact-measurement:provenance-tracker` and include approval context.
...
- **Downstream Hint:** Route next to social-impact-measurement:provenance-tracker consumers with approval-gate context
