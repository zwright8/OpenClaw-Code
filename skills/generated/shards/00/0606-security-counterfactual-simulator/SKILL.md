...
## When To Use
Use this skill when the request explicitly needs "Security Counterfactual Simulator" outcomes in the Security and Privacy domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Security Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security counterfactual simulator normalization/assessment.
