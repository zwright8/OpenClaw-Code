...
## When To Use
Use this skill when the request explicitly needs "Inclusion Resource Budget Allocator" outcomes in the Accessibility and Inclusion domain.
...
- Downstream routing hint: Route next to accessibility-and-inclusion:planning-router consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Resource Budget Allocator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion resource budget allocator normalization/assessment.
