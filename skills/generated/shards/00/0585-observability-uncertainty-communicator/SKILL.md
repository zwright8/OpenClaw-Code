...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability uncertainty communicator normalization/assessment.
