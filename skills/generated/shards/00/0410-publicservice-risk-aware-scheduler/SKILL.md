...
description: Build and operate the "PublicService Risk-Aware Scheduler" capability for Healthcare and Public Services. Trigger when this exact capability is needed in mission execution.
---
...
## Metadata
- **Skill ID:** `410`
- **Skill Name:** `u0410-publicservice-risk-aware-scheduler`
...
### Handoff Contract
- **Produces:** `PublicService Risk-Aware Scheduler normalized artifacts`, `execution scorecard`, `risk posture`
