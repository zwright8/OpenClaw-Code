...
- The task explicitly requires `u0124-tooling-contradiction-detector` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
