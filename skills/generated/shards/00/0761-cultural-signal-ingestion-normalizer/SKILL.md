...
description: Operate the "Cultural Signal Ingestion Normalizer" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Cultural Signal Ingestion Normalizer" outcomes in the Multilingual and Cultural Adaptation domain.
...
## Handoff Contract
- Produces: Cultural Signal Ingestion Normalizer normalized artifacts; execution scorecard; risk posture
- Consumes: language variants; cultural norms; local preferences; claims; evidence; confidence traces
- Downstream routing hint: Route next to multilingual-and-cultural-adaptation:normalization-engine consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Signal Ingestion Normalizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural signal ingestion normalizer normalization/assessment.
