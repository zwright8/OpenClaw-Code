...
description: Build and operate the "Economic Multi-Agent Negotiation Mediator" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Multi-Agent Negotiation Mediator" outcomes in the Economic Optimization domain.
...
- Downstream routing hint: Route next to economic-optimization:collaboration-mediator consumers with approval-gate context
