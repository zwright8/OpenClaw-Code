...
## Metadata
- **Skill ID:** `342`
- **Skill Name:** `u0342-economic-multi-agent-negotiation-mediator`
...
4. Keep routing aligned with `economic-optimization:collaboration-mediator` and include approval context.
...
### Handoff Contract
- **Produces:** `Economic Multi-Agent Negotiation Mediator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `budgets`, `costs`, `benefits`, `opportunity values`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to economic-optimization:collaboration-mediator consumers with approval-gate context
