...
description: Build and operate the "Memory Counterfactual Simulator" capability for Memory and Knowledge Operations. Use when outcomes in this capability family are required for production execution.
---
...
## Metadata
- **Skill ID:** `86`
- **Skill Name:** `u0086-memory-counterfactual-simulator`
...
4. Keep routing aligned with `memory-and-knowledge-operations:simulation-lab` and include approval context.
...
### Handoff Contract
- **Produces:** `Memory Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `episodic logs`, `knowledge nodes`, `retrieval metadata`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to memory-and-knowledge-operations:simulation-lab consumers with approval-gate context
