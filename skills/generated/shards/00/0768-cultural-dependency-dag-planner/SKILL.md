...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Dependency DAG Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural dependency dag planner normalization/assessment.
