...
## Metadata
- **Skill ID:** `760`
- **Skill Name:** `u0760-comms-continuous-improvement-planner`
...
### Handoff Contract
- **Produces:** `Comms Continuous Improvement Planner normalized artifacts`, `execution scorecard`, `risk posture`
