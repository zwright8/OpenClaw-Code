...
description: Operate the "Collab Training Curriculum Composer" capability in production for Collaboration and Negotiation workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `278`
- **Skill Name:** `u0278-collab-training-curriculum-composer`
...
4. Keep routing aligned with `collaboration-and-negotiation:general-capability` and include approval context.
...
### Handoff Contract
- **Produces:** `Collab Training Curriculum Composer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `proposals`, `contention signals`, `negotiated outcomes`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to collaboration-and-negotiation:general-capability consumers with approval-gate context
