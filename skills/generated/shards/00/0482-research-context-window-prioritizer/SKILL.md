...
description: Build and operate the "Research Context Window Prioritizer" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Research Context Window Prioritizer" outcomes in the Scientific Research Systems domain.
...
## Handoff Contract
- Produces: Research Context Window Prioritizer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Research Context Window Prioritizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Scientific Research Systems**
   - Input: noisy upstream payload requiring research context window prioritizer normalization/assessment.
