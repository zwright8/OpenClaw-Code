...
description: Run the Community Failure Root-Cause Miner capability for Community Engagement and Feedback with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0856_community-failure-root-cause-min` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Community Failure Root-Cause Miner (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Community Failure Root-Cause Miner.
...
## Operator Use Cases
- Operate Community Failure Root-Cause Miner as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `community-engagement-and-feedback:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Community Failure Root-Cause Miner`, including at least three measurable KPIs tied to community trust loss and unaddressed concerns.
...
- Scoring weights: `truth=0.25, execution=0.30, safety=0.24, impact=0.22`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 55
  - `review_risk`: risk >= 52
...
1. Incident recovery in Community Engagement and Feedback: ingest noisy signals, execute error pattern mining, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Community Failure Root-Cause Miner against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
