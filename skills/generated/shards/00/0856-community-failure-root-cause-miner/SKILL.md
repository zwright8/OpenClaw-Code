...
## Trigger Checklist
- [ ] The request explicitly needs **Community Failure Root-Cause Miner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community failure root-cause miner normalization/assessment.
