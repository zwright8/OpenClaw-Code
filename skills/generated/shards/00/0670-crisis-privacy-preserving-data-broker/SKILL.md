...
description: Run the Crisis Privacy Preserving Data Broker capability for Crisis and Incident Response with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0670_crisis-privacy-preserving-data-b` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Crisis Privacy Preserving Data Broker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Crisis Privacy Preserving Data Broker.
...
## Operator Use Cases
- Operate Crisis Privacy Preserving Data Broker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 72):** release artifacts after validation pass and route to `crisis-and-incident-response:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Crisis Privacy Preserving Data Broker`, including at least three measurable KPIs tied to slow containment and repeated outages.
...
- Scoring weights: `truth=0.21, execution=0.28, safety=0.28, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 62
  - `review_risk`: risk >= 56
...
1. Incident recovery in Crisis and Incident Response: ingest noisy signals, execute policy-scoped data mediation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Crisis Privacy Preserving Data Broker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
