...
## When To Use
Use this skill when the request explicitly needs "Crisis Equity Impact Scorer" outcomes in the Crisis and Incident Response domain.
...
## Handoff Contract
- Produces: Crisis Equity Impact Scorer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Equity Impact Scorer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis equity impact scorer normalization/assessment.
