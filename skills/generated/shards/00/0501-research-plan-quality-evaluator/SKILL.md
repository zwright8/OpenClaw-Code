...
## Trigger Checklist
- [ ] The request explicitly needs **Research Plan Quality Evaluator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring research plan quality evaluator normalization/assessment.
