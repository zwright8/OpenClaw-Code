...
description: Operate the "Comms Dependency DAG Planner" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Comms Dependency DAG Planner" outcomes in the Communication and Explainability domain.
...
## Handoff Contract
- Produces: Comms Dependency DAG Planner normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Comms Dependency DAG Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms dependency dag planner normalization/assessment.
