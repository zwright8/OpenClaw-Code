...
description: Run the Epistemic Training Curriculum Composer capability for Truth-Seeking and Epistemics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0038_epistemic-training-curriculum-co` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Epistemic Training Curriculum Composer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Epistemic Training Curriculum Composer.
...
## Operator Use Cases
- Operate Epistemic Training Curriculum Composer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 70):** release artifacts after validation pass and route to `truth-seeking-and-epistemics:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Epistemic Training Curriculum Composer`, including at least three measurable KPIs tied to false certainty and unverified assumptions.
...
- Scoring weights: `truth=0.28, execution=0.27, safety=0.26, impact=0.18`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 48
  - `review_risk`: risk >= 34
...
1. Incident recovery in Truth-Seeking and Epistemics: ingest noisy signals, execute sequenced learning path design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Epistemic Training Curriculum Composer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
