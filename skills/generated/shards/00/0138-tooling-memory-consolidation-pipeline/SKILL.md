...
- The task explicitly requires `u0138-tooling-memory-consolidation-pipeline` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
