---
name: u0419-publicservice-knowledge-graph-linker
description: Run the PublicService Knowledge Graph Linker capability for Healthcare and Public Services with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# PublicService Knowledge Graph Linker
...
| Feature flag | `skill_0419_publicservice-knowledge-graph-li` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because public-facing workflows require strict safety and reliability controls. This specific skill connects fragmented facts into reusable structures.

## Trigger Checklist
- [ ] The task explicitly needs PublicService Knowledge Graph Linker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for PublicService Knowledge Graph Linker.
...
## Operator Use Cases
- Operate PublicService Knowledge Graph Linker as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `PublicService Knowledge Graph Linker`, including at least three measurable KPIs tied to service harm and procedural violations.
...
- Scoring weights: `truth=0.16, execution=0.35, safety=0.18, impact=0.31`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 47
  - `review_risk`: risk >= 34
...
1. Incident recovery in Healthcare and Public Services: ingest noisy signals, execute entity and relation linking, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run PublicService Knowledge Graph Linker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
