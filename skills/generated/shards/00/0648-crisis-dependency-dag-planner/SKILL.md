...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Dependency DAG Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis dependency dag planner normalization/assessment.
