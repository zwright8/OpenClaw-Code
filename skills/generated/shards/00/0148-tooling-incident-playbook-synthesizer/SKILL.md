...
## Metadata
- **Skill ID:** `148`
- **Skill Name:** `u0148-tooling-incident-playbook-synthesizer`
...
### Handoff Contract
- **Produces:** `Tooling Incident Playbook Synthesizer normalized artifacts`, `execution scorecard`, `risk posture`
