...
- The task explicitly requires `u0148-tooling-incident-playbook-synthesizer` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
