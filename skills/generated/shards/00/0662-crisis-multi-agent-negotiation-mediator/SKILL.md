...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Multi-Agent Negotiation Mediator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis multi-agent negotiation mediator normalization/assessment.
