...
description: Run the Crisis Multi-Agent Negotiation Mediator capability for Crisis and Incident Response with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0662_crisis-multi-agent-negotiation-m` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Crisis Multi-Agent Negotiation Mediator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Crisis Multi-Agent Negotiation Mediator.
...
## Operator Use Cases
- Operate Crisis Multi-Agent Negotiation Mediator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `crisis-and-incident-response:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Crisis Multi-Agent Negotiation Mediator`, including at least three measurable KPIs tied to slow containment and repeated outages.
...
- Scoring weights: `truth=0.21, execution=0.29, safety=0.17, impact=0.34`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 61
  - `review_risk`: risk >= 57
...
1. Incident recovery in Crisis and Incident Response: ingest noisy signals, execute structured bargaining protocols, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Crisis Multi-Agent Negotiation Mediator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
