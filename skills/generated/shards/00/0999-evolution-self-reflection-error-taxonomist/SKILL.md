...
## When To Use
Use this skill when the request explicitly needs "Evolution Self-Reflection Error Taxonomist" outcomes in the Autonomous Learning and Evolution domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Evolution Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring evolution self-reflection error taxonomist normalization/assessment.
