---
name: u0999-evolution-self-reflection-error-taxonomist
description: Run the Evolution Self-Reflection Error Taxonomist capability for Autonomous Learning and Evolution with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Evolution Self-Reflection Error Taxonomist
...
| Feature flag | `skill_0999_evolution-self-reflection-error-` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents stagnate without structured reflection and continuous improvement loops. This specific skill classifies recurrent reasoning failures for targeted fixes.

## Trigger Checklist
- [ ] The task explicitly needs Evolution Self-Reflection Error Taxonomist (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Evolution Self-Reflection Error Taxonomist.
...
## Operator Use Cases
- Operate Evolution Self-Reflection Error Taxonomist as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 70):** release artifacts after validation pass and route to `autonomous-learning-and-evolution:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Evolution Self-Reflection Error Taxonomist`, including at least three measurable KPIs tied to capability stagnation and repeated blind spots.
...
- Scoring weights: `truth=0.15, execution=0.31, safety=0.28, impact=0.26`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 49
  - `review_risk`: risk >= 33
...
1. Incident recovery in Autonomous Learning and Evolution: ingest noisy signals, execute failure-type clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Evolution Self-Reflection Error Taxonomist against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
