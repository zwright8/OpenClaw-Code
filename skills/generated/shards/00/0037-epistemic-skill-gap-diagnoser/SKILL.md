...
description: Run the Epistemic Skill Gap Diagnoser capability for Truth-Seeking and Epistemics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0037_epistemic-skill-gap-diagnoser` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Epistemic Skill Gap Diagnoser (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Epistemic Skill Gap Diagnoser.
...
## Operator Use Cases
- Operate Epistemic Skill Gap Diagnoser as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 71):** release artifacts after validation pass and route to `truth-seeking-and-epistemics:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Epistemic Skill Gap Diagnoser`, including at least three measurable KPIs tied to false certainty and unverified assumptions.
...
- Scoring weights: `truth=0.18, execution=0.43, safety=0.21, impact=0.18`
- Posture thresholds:
  - `ready`: score >= 71
  - `review`: score >= 58
  - `review_risk`: risk >= 52
...
1. Incident recovery in Truth-Seeking and Epistemics: ingest noisy signals, execute competency coverage analysis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Epistemic Skill Gap Diagnoser against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
