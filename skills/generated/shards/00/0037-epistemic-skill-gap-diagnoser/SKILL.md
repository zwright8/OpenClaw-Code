...
## Trigger Checklist
- [ ] The request explicitly needs **Epistemic Skill Gap Diagnoser** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Truth-Seeking and Epistemics**
   - Input: noisy upstream payload requiring epistemic skill gap diagnoser normalization/assessment.
