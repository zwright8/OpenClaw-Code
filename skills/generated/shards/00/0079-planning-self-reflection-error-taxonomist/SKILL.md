...
## When To Use
Use this skill when you need "Planning Self-Reflection Error Taxonomist" outcomes for the Strategic Planning and Decomposition domain with measurable, production-facing outputs.
...
## Trigger Checklist
- [ ] The request explicitly needs **Planning Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Strategic Planning and Decomposition**
   - Input: noisy upstream payload requiring planning self-reflection error taxonomist normalization/assessment.
