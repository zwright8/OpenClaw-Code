...
description: Build and operate the "PublicService Goal Decomposer" capability for Healthcare and Public Services. Trigger when this exact capability is needed in mission execution.
---
...
## Metadata
- **Skill ID:** `407`
- **Skill Name:** `u0407-publicservice-goal-decomposer`
...
4. Keep routing aligned with `healthcare-and-public-services:planning-router` and include approval context.
...
### Handoff Contract
- **Produces:** `PublicService Goal Decomposer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `protocol checks`, `service queues`, `compliance flags`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to healthcare-and-public-services:planning-router consumers with approval-gate context
