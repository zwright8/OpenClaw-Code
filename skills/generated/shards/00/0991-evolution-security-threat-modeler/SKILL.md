---
name: u0991-evolution-security-threat-modeler
description: Run the Evolution Security Threat Modeler capability for Autonomous Learning and Evolution with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Evolution Security Threat Modeler
...
| Feature flag | `skill_0991_evolution-security-threat-modele` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents stagnate without structured reflection and continuous improvement loops. This specific skill anticipates attack paths before adversaries exploit them.

## Trigger Checklist
- [ ] The task explicitly needs Evolution Security Threat Modeler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Evolution Security Threat Modeler.
...
## Operator Use Cases
- Operate Evolution Security Threat Modeler as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `autonomous-learning-and-evolution:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Evolution Security Threat Modeler`, including at least three measurable KPIs tied to capability stagnation and repeated blind spots.
...
- Scoring weights: `truth=0.18, execution=0.24, safety=0.27, impact=0.31`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 49
  - `review_risk`: risk >= 37
...
1. Incident recovery in Autonomous Learning and Evolution: ingest noisy signals, execute attack-surface modeling, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Evolution Security Threat Modeler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
