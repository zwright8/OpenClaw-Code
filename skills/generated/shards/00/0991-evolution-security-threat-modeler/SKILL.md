...
## When To Use
Use this skill when the request explicitly needs "Evolution Security Threat Modeler" outcomes in the Autonomous Learning and Evolution domain.
...
- Downstream routing hint: Route next to autonomous-learning-and-evolution:detection-guard consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Evolution Security Threat Modeler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring evolution security threat modeler normalization/assessment.
