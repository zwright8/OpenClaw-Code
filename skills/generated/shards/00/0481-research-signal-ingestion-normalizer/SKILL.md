...
description: Build and operate the "Research Signal Ingestion Normalizer" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Research Signal Ingestion Normalizer" outcomes in the Scientific Research Systems domain.
...
## Handoff Contract
- Produces: Research Signal Ingestion Normalizer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Research Signal Ingestion Normalizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Scientific Research Systems**
   - Input: noisy upstream payload requiring research signal ingestion normalizer normalization/assessment.
