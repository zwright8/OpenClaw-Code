---
name: u0386-logistics-experiment-design-generator
description: Run the Logistics Experiment Design Generator capability for Resource Allocation and Logistics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Logistics Experiment Design Generator
...
| Feature flag | `skill_0386_logistics-experiment-design-gene` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because impact work fails when scarce resources are not routed intelligently. This specific skill converts unknowns into testable learning loops.

## Trigger Checklist
- [ ] The task explicitly needs Logistics Experiment Design Generator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Logistics Experiment Design Generator.
...
## Operator Use Cases
- Operate Logistics Experiment Design Generator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Logistics Experiment Design Generator`, including at least three measurable KPIs tied to supply shortfalls and fairness gaps.
...
- Scoring weights: `truth=0.23, execution=0.26, safety=0.33, impact=0.18`
- Posture thresholds:
  - `ready`: score >= 73
  - `review`: score >= 43
  - `review_risk`: risk >= 35
...
1. Incident recovery in Resource Allocation and Logistics: ingest noisy signals, execute hypothesis-driven design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Logistics Experiment Design Generator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
