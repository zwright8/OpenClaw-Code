...
description: Operate the "Rights Counterfactual Simulator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `886`
- **Skill Name:** `u0886-rights-counterfactual-simulator`
...
4. Keep routing aligned with `legal-rights-and-compliance:simulation-lab` and include approval context.
...
### Handoff Contract
- **Produces:** `Rights Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `requirements mappings`, `legal decisions`, `evidence trails`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to legal-rights-and-compliance:simulation-lab consumers with approval-gate context
