...
## When To Use
Use this skill when the request explicitly needs "Observability Continuous Improvement Planner" outcomes in the Data Quality and Observability domain.
...
## Handoff Contract
- Produces: Observability Continuous Improvement Planner normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Continuous Improvement Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability continuous improvement planner normalization/assessment.
