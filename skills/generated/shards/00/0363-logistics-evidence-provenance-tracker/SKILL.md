...
description: Build and operate the "Logistics Evidence Provenance Tracker" capability for Resource Allocation and Logistics. Use when outcomes in this capability family are required for production execution.
---
...
## When To Use
Use this skill when you need "Logistics Evidence Provenance Tracker" outputs that will influence production decisions, automated routing, policy posture, or external-facing actions.
...
- Routing tag: resource-allocation-and-logistics:logistics-evidence-provenance-tracker
...
## Output Contract
- `logistics_evidence_provenance_tracker_report` (structured-report, consumer=orchestrator, guaranteed=true)
- `logistics_evidence_provenance_tracker_scorecard` (scorecard, consumer=operator, guaranteed=true)
- `logistics_evidence_provenance_tracker_handoff` (handoff-packet, consumer=downstream-skill, guaranteed=true)
...
## Trigger Checklist
- [ ] The request explicitly needs **Logistics Evidence Provenance Tracker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Resource Allocation and Logistics**
   - Input: noisy upstream payload requiring logistics evidence provenance tracker normalization/assessment.
