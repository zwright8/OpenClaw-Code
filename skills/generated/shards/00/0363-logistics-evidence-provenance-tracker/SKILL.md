...
## Metadata
- **Skill ID:** `363`
- **Skill Name:** `u0363-logistics-evidence-provenance-tracker`
...
4. Keep routing aligned with `resource-allocation-and-logistics:provenance-tracker` and include approval context.
...
### Handoff Contract
- **Produces:** `Logistics Evidence Provenance Tracker normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `capacity`, `bottlenecks`, `distribution plans`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to resource-allocation-and-logistics:provenance-tracker consumers with approval-gate context
