...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Semantic Retrieval Ranker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis semantic retrieval ranker normalization/assessment.
