...
## Handoff Contract
- Produces: PublicService Continuous Improvement Planner normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Continuous Improvement Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice continuous improvement planner normalization/assessment.
