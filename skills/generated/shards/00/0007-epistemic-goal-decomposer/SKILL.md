...
## When To Use
Use this skill when you need "Epistemic Goal Decomposer" outcomes for the Truth-Seeking and Epistemics domain with measurable, production-facing outputs.
...
## Trigger Checklist
- [ ] The request explicitly needs **Epistemic Goal Decomposer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Truth-Seeking and Epistemics**
   - Input: noisy upstream payload requiring epistemic goal decomposer normalization/assessment.
