...
## When To Use
Use this skill when the request explicitly needs "Observability A/B Rollout Governor" outcomes in the Data Quality and Observability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Observability A/B Rollout Governor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability a/b rollout governor normalization/assessment.
