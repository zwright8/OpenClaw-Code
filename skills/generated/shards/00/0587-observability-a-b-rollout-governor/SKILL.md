---
name: u0587-observability-a-b-rollout-governor
description: Run the Observability A/B Rollout Governor capability for Data Quality and Observability with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Observability A/B Rollout Governor
...
| Feature flag | `skill_0587_observability-a-b-rollout-govern` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because decisions are only as good as the quality and visibility of data. This specific skill controls production risk during behavioral changes.

## Trigger Checklist
- [ ] The task explicitly needs Observability A/B Rollout Governor (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Observability A/B Rollout Governor.
...
## Operator Use Cases
- Operate Observability A/B Rollout Governor as a reliable, reusable production workflow.
...
- **Review posture (score >= 54 or risk >= 56):** require human review before publish, with explicit remediation notes.
- **Critical posture (risk >= 82):** fail closed, execute `rollback-to-last-stable-baseline`, and escalate with incident packet.

## Traceability Map
- **Scope:** Define the scope and success metrics for `Observability A/B Rollout Governor`, including at least three measurable KPIs tied to data drift and blind spots.
...
1. Incident recovery in Data Quality and Observability: ingest noisy signals, execute staged rollout policies, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Observability A/B Rollout Governor against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
