...
## When To Use
Use this skill when the request explicitly needs "Inclusion Failure Root-Cause Miner" outcomes in the Accessibility and Inclusion domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Failure Root-Cause Miner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion failure root-cause miner normalization/assessment.
