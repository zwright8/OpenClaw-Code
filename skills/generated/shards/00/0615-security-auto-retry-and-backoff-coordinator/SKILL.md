...
## Trigger Checklist
- [ ] The request explicitly needs **Security Auto-Retry and Backoff Coordinator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security auto-retry and backoff coordinator normalization/assessment.
