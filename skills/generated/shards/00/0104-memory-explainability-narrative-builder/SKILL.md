...
- The task explicitly requires `u0104-memory-explainability-narrative-builder` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
