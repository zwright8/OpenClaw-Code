---
name: u0849-community-resource-budget-allocator
description: Run the Community Resource Budget Allocator capability for Community Engagement and Feedback with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Community Resource Budget Allocator
...
| Feature flag | `skill_0849_community-resource-budget-alloca` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because real-world feedback loops are necessary for continuous alignment. This specific skill matches mission ambition to finite execution capacity.

## Trigger Checklist
- [ ] The task explicitly needs Community Resource Budget Allocator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Community Resource Budget Allocator.
...
## Operator Use Cases
- Operate Community Resource Budget Allocator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Community Resource Budget Allocator`, including at least three measurable KPIs tied to community trust loss and unaddressed concerns.
...
- Scoring weights: `truth=0.27, execution=0.16, safety=0.34, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 54
  - `review_risk`: risk >= 60
...
1. Incident recovery in Community Engagement and Feedback: ingest noisy signals, execute capacity-aware allocation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Community Resource Budget Allocator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
