...
## When To Use
Use this skill when the request explicitly needs "Security A/B Rollout Governor" outcomes in the Security and Privacy domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Security A/B Rollout Governor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security a/b rollout governor normalization/assessment.
