...
## When To Use
Use this skill when the request explicitly needs "Crisis Memory Consolidation Pipeline" outcomes in the Crisis and Incident Response domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Memory Consolidation Pipeline** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis memory consolidation pipeline normalization/assessment.
