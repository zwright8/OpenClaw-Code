...
## Metadata
- **Skill ID:** `731`
- **Skill Name:** `u0731-comms-policy-constraint-compiler`
...
4. Keep routing aligned with `communication-and-explainability:contract-compiler` and include approval context.
...
- **Downstream Hint:** Route next to communication-and-explainability:contract-compiler consumers with approval-gate context
