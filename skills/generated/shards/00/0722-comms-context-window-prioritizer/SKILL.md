...
## When To Use
Use this skill when the request explicitly needs "Comms Context Window Prioritizer" outcomes in the Communication and Explainability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Comms Context Window Prioritizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms context window prioritizer normalization/assessment.
