...
description: Operate the "Comms Context Window Prioritizer" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `722`
- **Skill Name:** `u0722-comms-context-window-prioritizer`
...
4. Keep routing aligned with `communication-and-explainability:planning-router` and include approval context.
...
### Handoff Contract
- **Produces:** `Comms Context Window Prioritizer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `decision factors`, `uncertainty markers`, `audience summaries`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to communication-and-explainability:planning-router consumers with approval-gate context
