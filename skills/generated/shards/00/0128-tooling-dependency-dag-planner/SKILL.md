...
- The task explicitly requires `u0128-tooling-dependency-dag-planner` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
