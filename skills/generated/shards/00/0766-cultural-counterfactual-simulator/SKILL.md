...
description: Operate the "Cultural Counterfactual Simulator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `766`
- **Skill Name:** `u0766-cultural-counterfactual-simulator`
...
4. Keep routing aligned with `multilingual-and-cultural-adaptation:simulation-lab` and include approval context.
...
### Handoff Contract
- **Produces:** `Cultural Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `language variants`, `cultural norms`, `local preferences`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to multilingual-and-cultural-adaptation:simulation-lab consumers with approval-gate context
