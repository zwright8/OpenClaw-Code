...
## When To Use
Use this skill when the request explicitly needs "Cultural Counterfactual Simulator" outcomes in the Multilingual and Cultural Adaptation domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural counterfactual simulator normalization/assessment.
