...
## Metadata
- **Skill ID:** `406`
- **Skill Name:** `u0406-publicservice-counterfactual-simulator`
...
### Handoff Contract
- **Produces:** `PublicService Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
