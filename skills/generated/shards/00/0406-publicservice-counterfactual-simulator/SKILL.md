...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice counterfactual simulator normalization/assessment.
