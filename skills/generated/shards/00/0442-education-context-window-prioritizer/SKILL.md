...
description: Build and operate the "Education Context Window Prioritizer" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Context Window Prioritizer" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Context Window Prioritizer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Context Window Prioritizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education context window prioritizer normalization/assessment.
