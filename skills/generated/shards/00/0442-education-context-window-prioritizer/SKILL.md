...
## Metadata
- **Skill ID:** `442`
- **Skill Name:** `u0442-education-context-window-prioritizer`
...
4. Keep routing aligned with `education-and-upskilling:planning-router` and include approval context.
...
- **Downstream Hint:** Route next to education-and-upskilling:planning-router consumers with approval-gate context
