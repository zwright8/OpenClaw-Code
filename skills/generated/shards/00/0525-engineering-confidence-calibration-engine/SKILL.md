...
## Metadata
- **Skill ID:** `525`
- **Skill Name:** `u0525-engineering-confidence-calibration-engine`
...
4. Keep routing aligned with `software-engineering-automation:optimization-engine` and include approval context.
...
- **Downstream Hint:** Route next to software-engineering-automation:optimization-engine consumers with approval-gate context
