...
description: Operate the "Engineering Confidence Calibration Engine" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Engineering Confidence Calibration Engine" outcomes in the Software Engineering Automation domain.
...
## Handoff Contract
- Produces: Engineering Confidence Calibration Engine normalized artifacts; execution scorecard; risk posture
- Consumes: code changes; tests; incidents; rollout data; claims; evidence; confidence traces
- Downstream routing hint: Route next to software-engineering-automation:optimization-engine consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Confidence Calibration Engine** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering confidence calibration engine normalization/assessment.
