...
## When To Use
Use this skill when the request explicitly needs "Infra Self-Reflection Error Taxonomist" outcomes in the Infrastructure and Sustainability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra self-reflection error taxonomist normalization/assessment.
