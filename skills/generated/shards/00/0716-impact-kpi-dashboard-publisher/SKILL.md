...
## When To Use
Use this skill when the request explicitly needs "Impact KPI Dashboard Publisher" outcomes in the Social Impact Measurement domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Impact KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring impact kpi dashboard publisher normalization/assessment.
