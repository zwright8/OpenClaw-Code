...
description: Operate the "Impact KPI Dashboard Publisher" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `716`
- **Skill Name:** `u0716-impact-kpi-dashboard-publisher`
...
4. Keep routing aligned with `social-impact-measurement:communication-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Impact KPI Dashboard Publisher normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `community outcomes`, `kpi trends`, `intervention deltas`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to social-impact-measurement:communication-engine consumers with approval-gate context
