...
## Trigger Checklist
- [ ] The request explicitly needs **Tooling Semantic Retrieval Ranker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Tool Reliability and Execution Quality**
   - Input: noisy upstream payload requiring tooling semantic retrieval ranker normalization/assessment.
