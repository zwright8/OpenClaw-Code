...
## Metadata
- **Skill ID:** `420`
- **Skill Name:** `u0420-publicservice-semantic-retrieval-ranker`
...
### Handoff Contract
- **Produces:** `PublicService Semantic Retrieval Ranker normalized artifacts`, `execution scorecard`, `risk posture`
