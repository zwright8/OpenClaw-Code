...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Semantic Retrieval Ranker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice semantic retrieval ranker normalization/assessment.
