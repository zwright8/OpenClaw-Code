...
## When To Use
Use this skill when you need "Observability Signal Ingestion Normalizer" outcomes for the Data Quality and Observability domain with measurable, production-facing outputs.
...
## Handoff Contract
- Produces: Observability Signal Ingestion Normalizer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Signal Ingestion Normalizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability signal ingestion normalizer normalization/assessment.
