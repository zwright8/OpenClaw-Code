...
## When To Use
Use this skill when the request explicitly needs "Cultural Task Handoff Contractor" outcomes in the Multilingual and Cultural Adaptation domain.
...
## Handoff Contract
- Produces: Cultural Task Handoff Contractor normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Task Handoff Contractor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural task handoff contractor normalization/assessment.
