---
name: u0981-evolution-plan-quality-evaluator
description: Run the Evolution Plan Quality Evaluator capability for Autonomous Learning and Evolution with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Evolution Plan Quality Evaluator
...
| Feature flag | `skill_0981_evolution-plan-quality-evaluator` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents stagnate without structured reflection and continuous improvement loops. This specific skill quantifies whether plans are complete, safe, and feasible.

## Trigger Checklist
- [ ] The task explicitly needs Evolution Plan Quality Evaluator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Evolution Plan Quality Evaluator.
...
## Operator Use Cases
- Operate Evolution Plan Quality Evaluator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Evolution Plan Quality Evaluator`, including at least three measurable KPIs tied to capability stagnation and repeated blind spots.
...
- Scoring weights: `truth=0.24, execution=0.37, safety=0.23, impact=0.16`
- Posture thresholds:
  - `ready`: score >= 73
  - `review`: score >= 56
  - `review_risk`: risk >= 53
...
1. Incident recovery in Autonomous Learning and Evolution: ingest noisy signals, execute multi-criteria plan scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Evolution Plan Quality Evaluator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
