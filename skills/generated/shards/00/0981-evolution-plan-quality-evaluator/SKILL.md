...
## Trigger Checklist
- [ ] The request explicitly needs **Evolution Plan Quality Evaluator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring evolution plan quality evaluator normalization/assessment.
