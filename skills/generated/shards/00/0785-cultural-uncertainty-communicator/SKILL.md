...
- Downstream routing hint: Route next to multilingual-and-cultural-adaptation:communication-engine consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural uncertainty communicator normalization/assessment.
