...
description: Operate the "Cultural Uncertainty Communicator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `785`
- **Skill Name:** `u0785-cultural-uncertainty-communicator`
...
4. Keep routing aligned with `multilingual-and-cultural-adaptation:communication-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Cultural Uncertainty Communicator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `language variants`, `cultural norms`, `local preferences`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to multilingual-and-cultural-adaptation:communication-engine consumers with approval-gate context
