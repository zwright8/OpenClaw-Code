...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice uncertainty communicator normalization/assessment.
