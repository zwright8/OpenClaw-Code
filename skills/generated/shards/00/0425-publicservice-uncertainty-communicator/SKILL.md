---
name: u0425-publicservice-uncertainty-communicator
description: Run the PublicService Uncertainty Communicator capability for Healthcare and Public Services with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# PublicService Uncertainty Communicator
...
| Feature flag | `skill_0425_publicservice-uncertainty-commun` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because public-facing workflows require strict safety and reliability controls. This specific skill prevents overstatement by explicitly framing uncertainty.

## Trigger Checklist
- [ ] The task explicitly needs PublicService Uncertainty Communicator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for PublicService Uncertainty Communicator.
...
## Operator Use Cases
- Operate PublicService Uncertainty Communicator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `PublicService Uncertainty Communicator`, including at least three measurable KPIs tied to service harm and procedural violations.
...
- Scoring weights: `truth=0.28, execution=0.31, safety=0.20, impact=0.21`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 48
  - `review_risk`: risk >= 44
...
1. Incident recovery in Healthcare and Public Services: ingest noisy signals, execute confidence-bound communication templates, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run PublicService Uncertainty Communicator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
