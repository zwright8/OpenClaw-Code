...
## Metadata
- **Skill ID:** `425`
- **Skill Name:** `u0425-publicservice-uncertainty-communicator`
...
4. Keep routing aligned with `healthcare-and-public-services:communication-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `PublicService Uncertainty Communicator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `protocol checks`, `service queues`, `compliance flags`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to healthcare-and-public-services:communication-engine consumers with approval-gate context
