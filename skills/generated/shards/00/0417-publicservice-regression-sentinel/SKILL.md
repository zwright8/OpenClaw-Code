...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Regression Sentinel** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice regression sentinel normalization/assessment.
