...
description: Build and operate the "Education Failure Root-Cause Miner" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Failure Root-Cause Miner" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Failure Root-Cause Miner normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Failure Root-Cause Miner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education failure root-cause miner normalization/assessment.
