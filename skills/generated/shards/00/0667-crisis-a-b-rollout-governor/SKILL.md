...
## When To Use
Use this skill when the request explicitly needs "Crisis A/B Rollout Governor" outcomes in the Crisis and Incident Response domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis A/B Rollout Governor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis a/b rollout governor normalization/assessment.
