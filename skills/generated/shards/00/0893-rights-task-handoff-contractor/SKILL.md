...
description: Operate the "Rights Task Handoff Contractor" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `893`
- **Skill Name:** `u0893-rights-task-handoff-contractor`
...
4. Keep routing aligned with `legal-rights-and-compliance:contract-compiler` and include approval context.
...
### Handoff Contract
- **Produces:** `Rights Task Handoff Contractor normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `requirements mappings`, `legal decisions`, `evidence trails`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to legal-rights-and-compliance:contract-compiler consumers with approval-gate context
