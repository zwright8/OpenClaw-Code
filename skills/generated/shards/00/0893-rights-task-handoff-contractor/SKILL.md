...
## When To Use
Use this skill when the request explicitly needs "Rights Task Handoff Contractor" outcomes in the Legal, Rights, and Compliance domain.
...
- Downstream routing hint: Route next to legal-rights-and-compliance:contract-compiler consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Task Handoff Contractor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights task handoff contractor normalization/assessment.
