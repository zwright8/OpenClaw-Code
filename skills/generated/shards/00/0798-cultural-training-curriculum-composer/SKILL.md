...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Training Curriculum Composer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural training curriculum composer normalization/assessment.
