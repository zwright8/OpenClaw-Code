...
description: Run the Cultural Training Curriculum Composer capability for Multilingual and Cultural Adaptation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0798_cultural-training-curriculum-com` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Cultural Training Curriculum Composer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Cultural Training Curriculum Composer.
...
## Operator Use Cases
- Operate Cultural Training Curriculum Composer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Cultural Training Curriculum Composer`, including at least three measurable KPIs tied to context mismatch and exclusion.
...
- Scoring weights: `truth=0.30, execution=0.19, safety=0.25, impact=0.26`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 51
  - `review_risk`: risk >= 45
...
1. Incident recovery in Multilingual and Cultural Adaptation: ingest noisy signals, execute sequenced learning path design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Cultural Training Curriculum Composer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
