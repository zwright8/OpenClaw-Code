...
## Metadata
- **Skill ID:** `963`
- **Skill Name:** `u0963-evolution-evidence-provenance-tracker`
...
4. Keep routing aligned with `autonomous-learning-and-evolution:provenance-tracker` and include approval context.
...
### Handoff Contract
- **Produces:** `Evolution Evidence Provenance Tracker normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `outcomes`, `error taxonomies`, `adaptation decisions`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to autonomous-learning-and-evolution:provenance-tracker consumers with approval-gate context
