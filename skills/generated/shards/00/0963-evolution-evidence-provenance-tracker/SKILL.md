...
## When To Use
Use this skill when the request explicitly needs "Evolution Evidence Provenance Tracker" outcomes in the Autonomous Learning and Evolution domain.
...
- Downstream routing hint: Route next to autonomous-learning-and-evolution:provenance-tracker consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Evolution Evidence Provenance Tracker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring evolution evidence provenance tracker normalization/assessment.
