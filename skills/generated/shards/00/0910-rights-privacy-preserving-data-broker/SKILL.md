---
name: u0910-rights-privacy-preserving-data-broker
description: Run the Rights Privacy Preserving Data Broker capability for Legal, Rights, and Compliance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0910_rights-privacy-preserving-data-b` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Rights Privacy Preserving Data Broker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Rights Privacy Preserving Data Broker.
...
## Operator Use Cases
- Operate Rights Privacy Preserving Data Broker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 77):** release artifacts after validation pass and route to `legal-rights-and-compliance:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Rights Privacy Preserving Data Broker`, including at least three measurable KPIs tied to rights violations and compliance penalties.
...
- Scoring weights: `truth=0.28, execution=0.30, safety=0.16, impact=0.25`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 62
  - `review_risk`: risk >= 49
...
1. Incident recovery in Legal, Rights, and Compliance: ingest noisy signals, execute policy-scoped data mediation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Rights Privacy Preserving Data Broker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
