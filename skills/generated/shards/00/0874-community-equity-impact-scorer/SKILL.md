---
name: u0874-community-equity-impact-scorer
description: Run the Community Equity Impact Scorer capability for Community Engagement and Feedback with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Community Equity Impact Scorer
...
| Feature flag | `skill_0874_community-equity-impact-scorer` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because real-world feedback loops are necessary for continuous alignment. This specific skill exposes uneven benefit/harm distribution before rollout.

## Trigger Checklist
- [ ] The task explicitly needs Community Equity Impact Scorer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Community Equity Impact Scorer.
...
## Operator Use Cases
- Operate Community Equity Impact Scorer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Community Equity Impact Scorer`, including at least three measurable KPIs tied to community trust loss and unaddressed concerns.
...
- Scoring weights: `truth=0.26, execution=0.18, safety=0.22, impact=0.34`
- Posture thresholds:
  - `ready`: score >= 71
  - `review`: score >= 42
  - `review_risk`: risk >= 40
...
1. Incident recovery in Community Engagement and Feedback: ingest noisy signals, execute group-level impact scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Community Equity Impact Scorer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
