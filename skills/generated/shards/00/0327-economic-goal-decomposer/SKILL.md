...
description: Operate the "Economic Goal Decomposer" capability in production for the target domain workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `327`
- **Skill Name:** `u0327-economic-goal-decomposer`
...
4. Keep routing aligned with `economic-optimization:planning-router` and include approval context.
...
### Handoff Contract
- **Produces:** `Economic Goal Decomposer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `budgets`, `costs`, `benefits`, `opportunity values`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to economic-optimization:planning-router consumers with approval-gate context
