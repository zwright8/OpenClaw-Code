---
name: u0327-economic-goal-decomposer
description: Run the Economic Goal Decomposer capability for Economic Optimization with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Economic Goal Decomposer
...
| Feature flag | `skill_0327_economic-goal-decomposer` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need explicit tradeoff logic for cost, speed, and impact. This specific skill breaks ambiguous missions into executable units.

## Trigger Checklist
- [ ] The task explicitly needs Economic Goal Decomposer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Economic Goal Decomposer.
...
## Operator Use Cases
- Operate Economic Goal Decomposer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Economic Goal Decomposer`, including at least three measurable KPIs tied to overspending and low-impact allocation.
...
- Scoring weights: `truth=0.30, execution=0.18, safety=0.34, impact=0.18`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 47
  - `review_risk`: risk >= 41
...
1. Incident recovery in Economic Optimization: ingest noisy signals, execute hierarchical decomposition, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Economic Goal Decomposer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
