...
## When To Use
Use this skill when the request explicitly needs "Infra Training Curriculum Composer" outcomes in the Infrastructure and Sustainability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Training Curriculum Composer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra training curriculum composer normalization/assessment.
