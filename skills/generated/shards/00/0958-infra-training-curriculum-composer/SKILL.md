...
description: Operate the "Infra Training Curriculum Composer" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `958`
- **Skill Name:** `u0958-infra-training-curriculum-composer`
...
4. Keep routing aligned with `infrastructure-and-sustainability:general-capability` and include approval context.
...
### Handoff Contract
- **Produces:** `Infra Training Curriculum Composer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `capacity forecasts`, `energy usage`, `sustainability metrics`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to infrastructure-and-sustainability:general-capability consumers with approval-gate context
