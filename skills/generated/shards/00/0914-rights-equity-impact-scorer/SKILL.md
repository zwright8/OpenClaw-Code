...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Equity Impact Scorer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights equity impact scorer normalization/assessment.
