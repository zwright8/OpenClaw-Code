...
description: Run the Infra Task Handoff Contractor capability for Infrastructure and Sustainability with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0933_infra-task-handoff-contractor` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Infra Task Handoff Contractor (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Infra Task Handoff Contractor.
...
## Operator Use Cases
- Operate Infra Task Handoff Contractor as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 72):** release artifacts after validation pass and route to `infrastructure-and-sustainability:contract-compiler`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Infra Task Handoff Contractor`, including at least three measurable KPIs tied to capacity collapse and environmental debt.
...
- Scoring weights: `truth=0.25, execution=0.22, safety=0.17, impact=0.36`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 59
  - `review_risk`: risk >= 46
...
1. Incident recovery in Infrastructure and Sustainability: ingest noisy signals, execute contracted payload schemas, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Infra Task Handoff Contractor against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
