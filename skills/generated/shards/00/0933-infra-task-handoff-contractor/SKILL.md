...
description: Operate the "Infra Task Handoff Contractor" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `933`
- **Skill Name:** `u0933-infra-task-handoff-contractor`
...
4. Keep routing aligned with `infrastructure-and-sustainability:contract-compiler` and include approval context.
...
### Handoff Contract
- **Produces:** `Infra Task Handoff Contractor normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `capacity forecasts`, `energy usage`, `sustainability metrics`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to infrastructure-and-sustainability:contract-compiler consumers with approval-gate context
