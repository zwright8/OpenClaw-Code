...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Task Handoff Contractor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra task handoff contractor normalization/assessment.
