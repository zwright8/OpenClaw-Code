...
description: Operate the "Community Multi-Agent Negotiation Mediator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Community Multi-Agent Negotiation Mediator" outcomes in the Community Engagement and Feedback domain.
...
## Handoff Contract
- Produces: Community Multi-Agent Negotiation Mediator normalized artifacts; execution scorecard; risk posture
- Consumes: feedback channels; sentiment; urgency; follow-ups; claims; evidence; confidence traces
- Downstream routing hint: Route next to community-engagement-and-feedback:collaboration-mediator consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Community Multi-Agent Negotiation Mediator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community multi-agent negotiation mediator normalization/assessment.
