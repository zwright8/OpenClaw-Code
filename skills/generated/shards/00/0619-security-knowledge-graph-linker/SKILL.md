...
## When To Use
Use this skill when the request explicitly needs "Security Knowledge Graph Linker" outcomes in the Security and Privacy domain.
...
## Handoff Contract
- Produces: Security Knowledge Graph Linker normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Security Knowledge Graph Linker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security knowledge graph linker normalization/assessment.
