...
## Trigger Checklist
- [ ] The request explicitly needs **Community Goal Decomposer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community goal decomposer normalization/assessment.
