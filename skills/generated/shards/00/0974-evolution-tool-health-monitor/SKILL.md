---
name: u0974-evolution-tool-health-monitor
description: Run the Evolution Tool Health Monitor capability for Autonomous Learning and Evolution with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Evolution Tool Health Monitor
...
| Feature flag | `skill_0974_evolution-tool-health-monitor` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents stagnate without structured reflection and continuous improvement loops. This specific skill detects tool flakiness before it impacts mission outcomes.

## Trigger Checklist
- [ ] The task explicitly needs Evolution Tool Health Monitor (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Evolution Tool Health Monitor.
...
## Operator Use Cases
- Operate Evolution Tool Health Monitor as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `autonomous-learning-and-evolution:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Evolution Tool Health Monitor`, including at least three measurable KPIs tied to capability stagnation and repeated blind spots.
...
- Scoring weights: `truth=0.21, execution=0.35, safety=0.16, impact=0.27`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 44
  - `review_risk`: risk >= 46
...
1. Incident recovery in Autonomous Learning and Evolution: ingest noisy signals, execute telemetry aggregation and SLO checks, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Evolution Tool Health Monitor against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
