...
## Metadata
- **Skill ID:** `166`
- **Skill Name:** `u0166-governance-counterfactual-simulator`
...
### Handoff Contract
- **Produces:** `Governance Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
