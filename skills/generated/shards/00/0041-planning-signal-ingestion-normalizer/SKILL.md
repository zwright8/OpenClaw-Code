...
## Metadata
- **Skill ID:** `41`
- **Skill Name:** `u0041-planning-signal-ingestion-normalizer`
...
4. Keep routing aligned with `strategic-planning-and-decomposition:normalization-engine` and include approval context.
...
- **Downstream Hint:** Route next to strategic-planning-and-decomposition:normalization-engine consumers with approval-gate context
