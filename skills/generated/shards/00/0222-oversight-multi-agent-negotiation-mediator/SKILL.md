...
## Metadata
- **Skill ID:** `222`
- **Skill Name:** `u0222-oversight-multi-agent-negotiation-mediator`
...
4. Keep routing aligned with `human-oversight-and-operator-ux:collaboration-mediator` and include approval context.
...
### Handoff Contract
- **Produces:** `Oversight Multi-Agent Negotiation Mediator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `approval queues`, `operator workload`, `intervention history`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to human-oversight-and-operator-ux:collaboration-mediator consumers with approval-gate context
