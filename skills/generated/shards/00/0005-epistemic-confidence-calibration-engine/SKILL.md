...
## Metadata
- **Skill ID:** `5`
- **Skill Name:** `u0005-epistemic-confidence-calibration-engine`
...
4. Keep routing aligned with `truth-seeking-and-epistemics:optimization-engine` and include approval context.
...
- **Downstream Hint:** Route next to truth-seeking-and-epistemics:optimization-engine consumers with approval-gate context
