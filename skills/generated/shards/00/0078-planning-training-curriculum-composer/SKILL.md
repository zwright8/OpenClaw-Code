...
## When To Use
Use this skill when you need "Planning Training Curriculum Composer" outcomes for the Strategic Planning and Decomposition domain with measurable, production-facing outputs.
...
## Trigger Checklist
- [ ] The request explicitly needs **Planning Training Curriculum Composer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Strategic Planning and Decomposition**
   - Input: noisy upstream payload requiring planning training curriculum composer normalization/assessment.
