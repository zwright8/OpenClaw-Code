---
name: u0356-economic-kpi-dashboard-publisher
description: Run the Economic KPI Dashboard Publisher capability for Economic Optimization with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Economic KPI Dashboard Publisher
...
| Feature flag | `skill_0356_economic-kpi-dashboard-publisher` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need explicit tradeoff logic for cost, speed, and impact. This specific skill keeps mission status observable in real time.

## Trigger Checklist
- [ ] The task explicitly needs Economic KPI Dashboard Publisher (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Economic KPI Dashboard Publisher.
...
## Operator Use Cases
- Operate Economic KPI Dashboard Publisher as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Economic KPI Dashboard Publisher`, including at least three measurable KPIs tied to overspending and low-impact allocation.
...
- Scoring weights: `truth=0.36, execution=0.18, safety=0.22, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 62
  - `review_risk`: risk >= 58
...
1. Incident recovery in Economic Optimization: ingest noisy signals, execute metric synthesis and publication, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Economic KPI Dashboard Publisher against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
