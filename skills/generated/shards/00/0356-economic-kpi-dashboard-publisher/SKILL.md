...
## Metadata
- **Skill ID:** `356`
- **Skill Name:** `u0356-economic-kpi-dashboard-publisher`
...
4. Keep routing aligned with `economic-optimization:communication-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Economic KPI Dashboard Publisher normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `budgets`, `costs`, `benefits`, `opportunity values`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to economic-optimization:communication-engine consumers with approval-gate context
