...
## Metadata
- **Skill ID:** `725`
- **Skill Name:** `u0725-comms-confidence-calibration-engine`
...
4. Keep routing aligned with `communication-and-explainability:optimization-engine` and include approval context.
...
- **Downstream Hint:** Route next to communication-and-explainability:optimization-engine consumers with approval-gate context
