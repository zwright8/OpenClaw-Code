...
## When To Use
Use this skill when you need "Planning Context Window Prioritizer" outcomes for the Strategic Planning and Decomposition domain with measurable, production-facing outputs.
...
## Trigger Checklist
- [ ] The request explicitly needs **Planning Context Window Prioritizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Strategic Planning and Decomposition**
   - Input: noisy upstream payload requiring planning context window prioritizer normalization/assessment.
