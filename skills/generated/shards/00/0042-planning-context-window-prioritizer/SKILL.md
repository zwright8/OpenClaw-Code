---
name: u0042-planning-context-window-prioritizer
description: Run the Planning Context Window Prioritizer capability for Strategic Planning and Decomposition with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Planning Context Window Prioritizer
...
| Feature flag | `skill_0042_planning-context-window-prioriti` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because large goals fail when decomposition is inconsistent or incomplete. This specific skill surfaces the most decision-relevant context under tight token budgets.

## Trigger Checklist
- [ ] The task explicitly needs Planning Context Window Prioritizer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Planning Context Window Prioritizer.
...
## Operator Use Cases
- Operate Planning Context Window Prioritizer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Planning Context Window Prioritizer`, including at least three measurable KPIs tied to execution stalls and hidden dependency failures.
...
- Scoring weights: `truth=0.21, execution=0.31, safety=0.33, impact=0.15`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 43
  - `review_risk`: risk >= 43
...
1. Incident recovery in Strategic Planning and Decomposition: ingest noisy signals, execute importance scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Planning Context Window Prioritizer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
