...
description: Build and operate the "Planning Context Window Prioritizer" capability for Strategic Planning and Decomposition. Use when outcomes in this capability family are required for production execution.
---
...
## Metadata
- **Skill ID:** `42`
- **Skill Name:** `u0042-planning-context-window-prioritizer`
...
4. Keep routing aligned with `strategic-planning-and-decomposition:planning-router` and include approval context.
...
### Handoff Contract
- **Produces:** `Planning Context Window Prioritizer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `goals`, `dependencies`, `milestones`, `constraints`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to strategic-planning-and-decomposition:planning-router consumers with approval-gate context
