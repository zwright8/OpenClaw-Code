...
## Metadata
- **Skill ID:** `510`
- **Skill Name:** `u0510-research-privacy-preserving-data-broker`
...
4. Keep routing aligned with `scientific-research-systems:collaboration-mediator` and include approval context.
...
- **Downstream Hint:** Route next to scientific-research-systems:collaboration-mediator consumers with approval-gate context
