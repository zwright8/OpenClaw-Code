---
name: u0510-research-privacy-preserving-data-broker
description: Run the Research Privacy Preserving Data Broker capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Research Privacy Preserving Data Broker
...
| Feature flag | `skill_0510_research-privacy-preserving-data` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because research throughput degrades without reproducibility and prioritization. This specific skill enables collaboration while minimizing raw data exposure.

## Trigger Checklist
- [ ] The task explicitly needs Research Privacy Preserving Data Broker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Privacy Preserving Data Broker.
...
## Operator Use Cases
- Operate Research Privacy Preserving Data Broker as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Privacy Preserving Data Broker`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.26, execution=0.18, safety=0.30, impact=0.26`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 52
  - `review_risk`: risk >= 46
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute policy-scoped data mediation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Privacy Preserving Data Broker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
