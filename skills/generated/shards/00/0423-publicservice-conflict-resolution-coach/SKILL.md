...
## Handoff Contract
- Produces: PublicService Conflict Resolution Coach normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Conflict Resolution Coach** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice conflict resolution coach normalization/assessment.
