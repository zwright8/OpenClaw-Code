...
## Metadata
- **Skill ID:** `13`
- **Skill Name:** `u0013-epistemic-task-handoff-contractor`
...
4. Keep routing aligned with `truth-seeking-and-epistemics:contract-compiler` and include approval context.
...
- **Downstream Hint:** Route next to truth-seeking-and-epistemics:contract-compiler consumers with approval-gate context
