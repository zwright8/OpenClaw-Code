...
description: Build and operate the "Tooling Equity Impact Scorer" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Equity Impact Scorer" outcomes in the Tool Reliability and Execution Quality domain.
