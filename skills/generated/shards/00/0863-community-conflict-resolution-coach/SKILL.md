---
name: u0863-community-conflict-resolution-coach
description: Run the Community Conflict Resolution Coach capability for Community Engagement and Feedback with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Community Conflict Resolution Coach
...
| Routing tag | `community-engagement-and-feedback:collaboration-mediator` |
| Feature flag | `skill_0863_community-conflict-resolution-co` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because real-world feedback loops are necessary for continuous alignment. This specific skill reduces deadlocks in human-agent collaboration loops.

## Trigger Checklist
- [ ] The task explicitly needs Community Conflict Resolution Coach (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Community Conflict Resolution Coach.
...
## Operator Use Cases
- Operate Community Conflict Resolution Coach as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 72):** release artifacts after validation pass and route to `community-engagement-and-feedback:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Community Conflict Resolution Coach`, including at least three measurable KPIs tied to community trust loss and unaddressed concerns.
...
- Scoring weights: `truth=0.20, execution=0.32, safety=0.33, impact=0.15`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 54
  - `review_risk`: risk >= 48
...
1. Incident recovery in Community Engagement and Feedback: ingest noisy signals, execute guided mediation prompts, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Community Conflict Resolution Coach against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
3. Pre-deployment gate: validate artifacts for community-engagement-and-feedback:collaboration-mediator, enforce approvals, then handoff to downstream orchestrator with next actions.
...
- **Downstream hint:** route only to `community-engagement-and-feedback:collaboration-mediator` consumers with approval context attached.
