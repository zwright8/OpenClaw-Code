...
## Metadata
- **Skill ID:** `820`
- **Skill Name:** `u0820-inclusion-semantic-retrieval-ranker`
...
### Handoff Contract
- **Produces:** `Inclusion Semantic Retrieval Ranker normalized artifacts`, `execution scorecard`, `risk posture`
