...
## When To Use
Use this skill when the request explicitly needs "Inclusion Semantic Retrieval Ranker" outcomes in the Accessibility and Inclusion domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Semantic Retrieval Ranker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion semantic retrieval ranker normalization/assessment.
