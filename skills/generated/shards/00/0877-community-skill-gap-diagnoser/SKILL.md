...
## When To Use
Use this skill when the request explicitly needs "Community Skill Gap Diagnoser" outcomes in the Community Engagement and Feedback domain.
...
## Handoff Contract
- Produces: Community Skill Gap Diagnoser normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Community Skill Gap Diagnoser** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community skill gap diagnoser normalization/assessment.
