...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Evidence Provenance Tracker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion evidence provenance tracker normalization/assessment.
