...
description: Operate the "Inclusion Evidence Provenance Tracker" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `803`
- **Skill Name:** `u0803-inclusion-evidence-provenance-tracker`
...
4. Keep routing aligned with `accessibility-and-inclusion:provenance-tracker` and include approval context.
...
- **Downstream Hint:** Route next to accessibility-and-inclusion:provenance-tracker consumers with approval-gate context
