...
description: Build and operate the "PublicService Security Threat Modeler" capability for Healthcare and Public Services. Trigger when this exact capability is needed in mission execution.
---
...
## Metadata
- **Skill ID:** `431`
- **Skill Name:** `u0431-publicservice-security-threat-modeler`
...
4. Keep routing aligned with `healthcare-and-public-services:detection-guard` and include approval context.
...
### Handoff Contract
- **Produces:** `PublicService Security Threat Modeler normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `protocol checks`, `service queues`, `compliance flags`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to healthcare-and-public-services:detection-guard consumers with approval-gate context
