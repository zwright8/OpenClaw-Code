...
## When To Use
Use this skill when the request explicitly needs "PublicService Security Threat Modeler" outcomes in the Healthcare and Public Services domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Security Threat Modeler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice security threat modeler normalization/assessment.
