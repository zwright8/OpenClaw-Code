---
name: u0431-publicservice-security-threat-modeler
description: Run the PublicService Security Threat Modeler capability for Healthcare and Public Services with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0431_publicservice-security-threat-mo` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs PublicService Security Threat Modeler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for PublicService Security Threat Modeler.
...
## Operator Use Cases
- Operate PublicService Security Threat Modeler as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `PublicService Security Threat Modeler`, including at least three measurable KPIs tied to service harm and procedural violations.
...
1. Incident recovery in Healthcare and Public Services: ingest noisy signals, execute attack-surface modeling, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run PublicService Security Threat Modeler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
