...
## When To Use
Use this skill when the request explicitly needs "Rights Semantic Retrieval Ranker" outcomes in the Legal, Rights, and Compliance domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Semantic Retrieval Ranker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights semantic retrieval ranker normalization/assessment.
