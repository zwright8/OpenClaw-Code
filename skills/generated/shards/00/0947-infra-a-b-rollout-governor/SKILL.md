...
## When To Use
Use this skill when the request explicitly needs "Infra A/B Rollout Governor" outcomes in the Infrastructure and Sustainability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra A/B Rollout Governor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra a/b rollout governor normalization/assessment.
