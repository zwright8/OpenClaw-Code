...
description: Operate the "Federation Evidence Provenance Tracker" capability in production for Federation and Interoperability workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `283`
- **Skill Name:** `u0283-federation-evidence-provenance-tracker`
...
4. Keep routing aligned with `federation-and-interoperability:provenance-tracker` and include approval context.
...
### Handoff Contract
- **Produces:** `Federation Evidence Provenance Tracker normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `envelopes`, `tenant boundaries`, `protocol bridges`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to federation-and-interoperability:provenance-tracker consumers with approval-gate context
