...
## Metadata
- **Skill ID:** `325`
- **Skill Name:** `u0325-economic-confidence-calibration-engine`
...
4. Keep routing aligned with `economic-optimization:optimization-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Economic Confidence Calibration Engine normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `budgets`, `costs`, `benefits`, `opportunity values`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to economic-optimization:optimization-engine consumers with approval-gate context
