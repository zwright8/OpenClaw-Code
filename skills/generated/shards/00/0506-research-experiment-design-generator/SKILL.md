---
name: u0506-research-experiment-design-generator
description: Run the Research Experiment Design Generator capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Research Experiment Design Generator
...
| Feature flag | `skill_0506_research-experiment-design-gener` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because research throughput degrades without reproducibility and prioritization. This specific skill converts unknowns into testable learning loops.

## Trigger Checklist
- [ ] The task explicitly needs Research Experiment Design Generator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Experiment Design Generator.
...
## Operator Use Cases
- Operate Research Experiment Design Generator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 77):** release artifacts after validation pass and route to `scientific-research-systems:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Experiment Design Generator`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.30, execution=0.31, safety=0.23, impact=0.16`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 53
  - `review_risk`: risk >= 51
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute hypothesis-driven design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Experiment Design Generator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
