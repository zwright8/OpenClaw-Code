...
description: Build and operate the "Education Auto-Retry and Backoff Coordinator" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Auto-Retry and Backoff Coordinator" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Auto-Retry and Backoff Coordinator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Auto-Retry and Backoff Coordinator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education auto-retry and backoff coordinator normalization/assessment.
