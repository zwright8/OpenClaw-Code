---
name: u0675-crisis-community-feedback-harvester
description: Run the Crisis Community Feedback Harvester capability for Crisis and Incident Response with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Crisis Community Feedback Harvester
...
| Feature flag | `skill_0675_crisis-community-feedback-harves` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because response quality determines whether incidents are contained or amplified. This specific skill integrates lived user feedback into planning cycles.

## Trigger Checklist
- [ ] The task explicitly needs Crisis Community Feedback Harvester (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Crisis Community Feedback Harvester.
...
## Operator Use Cases
- Operate Crisis Community Feedback Harvester as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 70):** release artifacts after validation pass and route to `crisis-and-incident-response:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Crisis Community Feedback Harvester`, including at least three measurable KPIs tied to slow containment and repeated outages.
...
- Scoring weights: `truth=0.27, execution=0.23, safety=0.25, impact=0.25`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 51
  - `review_risk`: risk >= 42
...
1. Incident recovery in Crisis and Incident Response: ingest noisy signals, execute feedback normalization and clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Crisis Community Feedback Harvester against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
