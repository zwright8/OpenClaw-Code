...
description: Operate the "Crisis Community Feedback Harvester" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `675`
- **Skill Name:** `u0675-crisis-community-feedback-harvester`
...
4. Keep routing aligned with `crisis-and-incident-response:normalization-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Crisis Community Feedback Harvester normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `incident timelines`, `response roles`, `recovery artifacts`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to crisis-and-incident-response:normalization-engine consumers with approval-gate context
