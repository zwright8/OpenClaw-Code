---
name: u0069-planning-disaster-recovery-orchestrator
description: Run the Planning Disaster Recovery Orchestrator capability for Strategic Planning and Decomposition with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Planning Disaster Recovery Orchestrator
...
| Feature flag | `skill_0069_planning-disaster-recovery-orche` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because large goals fail when decomposition is inconsistent or incomplete. This specific skill improves recovery speed after severe outages.

## Trigger Checklist
- [ ] The task explicitly needs Planning Disaster Recovery Orchestrator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Planning Disaster Recovery Orchestrator.
...
## Operator Use Cases
- Operate Planning Disaster Recovery Orchestrator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Planning Disaster Recovery Orchestrator`, including at least three measurable KPIs tied to execution stalls and hidden dependency failures.
...
- Scoring weights: `truth=0.25, execution=0.27, safety=0.23, impact=0.25`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 53
  - `review_risk`: risk >= 52
...
1. Incident recovery in Strategic Planning and Decomposition: ingest noisy signals, execute failover and restoration sequencing, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Planning Disaster Recovery Orchestrator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
