---
name: u0182-governance-multi-agent-negotiation-mediator
description: Run the Governance Multi-Agent Negotiation Mediator capability for Safety and Governance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Governance Multi-Agent Negotiation Mediator
...
| Feature flag | `skill_0182_governance-multi-agent-negotiati` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because high-speed autonomy needs enforceable guardrails to stay aligned. This specific skill resolves resource and strategy conflicts with explicit tradeoffs.

## Trigger Checklist
- [ ] The task explicitly needs Governance Multi-Agent Negotiation Mediator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Governance Multi-Agent Negotiation Mediator.
...
## Operator Use Cases
- Operate Governance Multi-Agent Negotiation Mediator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 71):** release artifacts after validation pass and route to `safety-and-governance:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Governance Multi-Agent Negotiation Mediator`, including at least three measurable KPIs tied to unsafe actions and policy drift.
...
- Scoring weights: `truth=0.20, execution=0.37, safety=0.29, impact=0.14`
- Posture thresholds:
  - `ready`: score >= 71
  - `review`: score >= 55
  - `review_risk`: risk >= 54
...
1. Incident recovery in Safety and Governance: ingest noisy signals, execute structured bargaining protocols, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Governance Multi-Agent Negotiation Mediator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
