...
## Metadata
- **Skill ID:** `182`
- **Skill Name:** `u0182-governance-multi-agent-negotiation-mediator`
...
4. Keep routing aligned with `safety-and-governance:collaboration-mediator` and include approval context.
...
- **Downstream Hint:** Route next to safety-and-governance:collaboration-mediator consumers with approval-gate context
