...
description: Operate the "Observability Equity Impact Scorer" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Observability Equity Impact Scorer" outcomes in the Data Quality and Observability domain.
...
## Handoff Contract
- Produces: Observability Equity Impact Scorer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Equity Impact Scorer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability equity impact scorer normalization/assessment.
