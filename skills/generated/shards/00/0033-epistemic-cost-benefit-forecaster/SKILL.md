...
description: Run the Epistemic Cost-Benefit Forecaster capability for Truth-Seeking and Epistemics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0033_epistemic-cost-benefit-forecaste` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Epistemic Cost-Benefit Forecaster (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Epistemic Cost-Benefit Forecaster.
...
## Operator Use Cases
- Operate Epistemic Cost-Benefit Forecaster as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 77):** release artifacts after validation pass and route to `truth-seeking-and-epistemics:simulation-lab`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Epistemic Cost-Benefit Forecaster`, including at least three measurable KPIs tied to false certainty and unverified assumptions.
...
- Scoring weights: `truth=0.25, execution=0.29, safety=0.27, impact=0.19`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 62
  - `review_risk`: risk >= 60
...
1. Incident recovery in Truth-Seeking and Epistemics: ingest noisy signals, execute cost-impact simulation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Epistemic Cost-Benefit Forecaster against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
