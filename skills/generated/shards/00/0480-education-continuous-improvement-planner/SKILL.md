...
description: Build and operate the "Education Continuous Improvement Planner" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Continuous Improvement Planner" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Continuous Improvement Planner normalized artifacts; execution scorecard; risk posture
- Consumes: skill profiles; learning paths; support resources; claims; evidence; confidence traces
- Downstream routing hint: Route next to education-and-upskilling:planning-router consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Continuous Improvement Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education continuous improvement planner normalization/assessment.
