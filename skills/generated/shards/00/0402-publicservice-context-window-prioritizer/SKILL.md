...
## Metadata
- **Skill ID:** `402`
- **Skill Name:** `u0402-publicservice-context-window-prioritizer`
...
### Handoff Contract
- **Produces:** `PublicService Context Window Prioritizer normalized artifacts`, `execution scorecard`, `risk posture`
