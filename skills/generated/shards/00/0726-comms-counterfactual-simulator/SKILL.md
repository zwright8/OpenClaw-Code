...
## Trigger Checklist
- [ ] The request explicitly needs **Comms Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms counterfactual simulator normalization/assessment.
