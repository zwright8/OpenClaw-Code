...
description: Operate the "Collab Conflict Resolution Coach" capability in production for Collaboration and Negotiation workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Collab Conflict Resolution Coach` in Collaboration and Negotiation and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Collab Conflict Resolution Coach** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Collaboration and Negotiation workflows**
   - Input: noisy upstream payload requiring collab conflict resolution coach normalization/assessment.
