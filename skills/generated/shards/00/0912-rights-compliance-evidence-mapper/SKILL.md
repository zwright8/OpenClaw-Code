...
description: Run the Rights Compliance Evidence Mapper capability for Legal, Rights, and Compliance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Routing tag | `legal-rights-and-compliance:normalization-engine` |
| Feature flag | `skill_0912_rights-compliance-evidence-mappe` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Rights Compliance Evidence Mapper (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Rights Compliance Evidence Mapper.
...
## Operator Use Cases
- Operate Rights Compliance Evidence Mapper as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `legal-rights-and-compliance:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Rights Compliance Evidence Mapper`, including at least three measurable KPIs tied to rights violations and compliance penalties.
...
1. Incident recovery in Legal, Rights, and Compliance: ingest noisy signals, execute requirement-to-evidence mapping, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Rights Compliance Evidence Mapper against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
3. Pre-deployment gate: validate artifacts for legal-rights-and-compliance:normalization-engine, enforce approvals, then handoff to downstream orchestrator with next actions.
...
- **Downstream hint:** route only to `legal-rights-and-compliance:normalization-engine` consumers with approval context attached.
