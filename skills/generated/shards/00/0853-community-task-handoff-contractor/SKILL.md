...
description: Run the Community Task Handoff Contractor capability for Community Engagement and Feedback with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0853_community-task-handoff-contracto` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Community Task Handoff Contractor (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Community Task Handoff Contractor.
...
## Operator Use Cases
- Operate Community Task Handoff Contractor as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `community-engagement-and-feedback:contract-compiler`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Community Task Handoff Contractor`, including at least three measurable KPIs tied to community trust loss and unaddressed concerns.
...
- Scoring weights: `truth=0.31, execution=0.14, safety=0.28, impact=0.28`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 50
  - `review_risk`: risk >= 46
...
1. Incident recovery in Community Engagement and Feedback: ingest noisy signals, execute contracted payload schemas, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Community Task Handoff Contractor against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
