...
## Trigger Checklist
- [ ] The request explicitly needs **Community Task Handoff Contractor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community task handoff contractor normalization/assessment.
