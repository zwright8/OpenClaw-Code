...
## When To Use
Use this skill when the request explicitly needs "Observability Context Window Prioritizer" outcomes in the Data Quality and Observability domain.
...
- Downstream routing hint: Route next to data-quality-and-observability:planning-router consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Context Window Prioritizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability context window prioritizer normalization/assessment.
