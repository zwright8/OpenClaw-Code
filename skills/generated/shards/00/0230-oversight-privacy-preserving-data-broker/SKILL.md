---
name: u0230-oversight-privacy-preserving-data-broker
description: Run the Oversight Privacy Preserving Data Broker capability for Human Oversight and Operator UX with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0230_oversight-privacy-preserving-dat` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Oversight Privacy Preserving Data Broker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Oversight Privacy Preserving Data Broker.
...
## Operator Use Cases
- Operate Oversight Privacy Preserving Data Broker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 70):** release artifacts after validation pass and route to `human-oversight-and-operator-ux:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Oversight Privacy Preserving Data Broker`, including at least three measurable KPIs tied to slow interventions and approval bottlenecks.
...
- Scoring weights: `truth=0.28, execution=0.33, safety=0.27, impact=0.12`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 59
  - `review_risk`: risk >= 51
...
1. Incident recovery in Human Oversight and Operator UX: ingest noisy signals, execute policy-scoped data mediation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Oversight Privacy Preserving Data Broker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
