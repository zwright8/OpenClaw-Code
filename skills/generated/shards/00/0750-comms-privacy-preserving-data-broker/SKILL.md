...
description: Run the Comms Privacy Preserving Data Broker capability for Communication and Explainability with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0750_comms-privacy-preserving-data-br` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Comms Privacy Preserving Data Broker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Comms Privacy Preserving Data Broker.
...
## Operator Use Cases
- Operate Comms Privacy Preserving Data Broker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 75):** release artifacts after validation pass and route to `communication-and-explainability:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Comms Privacy Preserving Data Broker`, including at least three measurable KPIs tied to misinterpretation and trust erosion.
...
- Scoring weights: `truth=0.23, execution=0.25, safety=0.31, impact=0.21`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 46
  - `review_risk`: risk >= 44
...
1. Incident recovery in Communication and Explainability: ingest noisy signals, execute policy-scoped data mediation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Comms Privacy Preserving Data Broker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
