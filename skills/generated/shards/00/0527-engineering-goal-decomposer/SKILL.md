...
## When To Use
Use this skill when the request explicitly needs "Engineering Goal Decomposer" outcomes in the Software Engineering Automation domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Goal Decomposer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering goal decomposer normalization/assessment.
