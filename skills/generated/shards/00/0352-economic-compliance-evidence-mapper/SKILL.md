...
description: Build and operate the "Economic Compliance Evidence Mapper" capability for Economic Optimization. Use when outcomes in this capability family are required for production execution.
---
...
## When To Use
Use this skill when you need "Economic Compliance Evidence Mapper" outputs that will influence production decisions, automated routing, policy posture, or external-facing actions.
...
- Routing tag: economic-optimization:economic-compliance-evidence-mapper
...
## Output Contract
- `economic_compliance_evidence_mapper_report` (structured-report, consumer=orchestrator, guaranteed=true)
- `economic_compliance_evidence_mapper_scorecard` (scorecard, consumer=operator, guaranteed=true)
- `economic_compliance_evidence_mapper_handoff` (handoff-packet, consumer=downstream-skill, guaranteed=true)
...
## Trigger Checklist
- [ ] The request explicitly needs **Economic Compliance Evidence Mapper** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Economic Optimization**
   - Input: noisy upstream payload requiring economic compliance evidence mapper normalization/assessment.
