...
## Metadata
- **Skill ID:** `352`
- **Skill Name:** `u0352-economic-compliance-evidence-mapper`
...
### Handoff Contract
- **Produces:** `Economic Compliance Evidence Mapper normalized artifacts`, `execution scorecard`, `risk posture`
