...
- The task explicitly requires `u0146-tooling-experiment-design-generator` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
