...
description: Build and operate the "Tooling Experiment Design Generator" capability for Tool Reliability and Execution Quality. Use when outcomes in this capability family are required for production execution.
---
...
## When To Use
Use this skill when you need "Tooling Experiment Design Generator" outputs that will influence production decisions, automated routing, policy posture, or external-facing actions.
...
- Routing tag: tool-reliability-and-execution-quality:tooling-experiment-design-generator
...
## Output Contract
- `tooling_experiment_design_generator_report` (structured-report, consumer=orchestrator, guaranteed=true)
- `tooling_experiment_design_generator_scorecard` (scorecard, consumer=operator, guaranteed=true)
- `tooling_experiment_design_generator_handoff` (handoff-packet, consumer=downstream-skill, guaranteed=true)
...
## Trigger Checklist
- [ ] The request explicitly needs **Tooling Experiment Design Generator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Tool Reliability and Execution Quality**
   - Input: noisy upstream payload requiring tooling experiment design generator normalization/assessment.
