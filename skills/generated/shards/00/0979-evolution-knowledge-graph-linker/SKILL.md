...
## When To Use
Use this skill when the request explicitly needs "Evolution Knowledge Graph Linker" outcomes in the Autonomous Learning and Evolution domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Evolution Knowledge Graph Linker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring evolution knowledge graph linker normalization/assessment.
