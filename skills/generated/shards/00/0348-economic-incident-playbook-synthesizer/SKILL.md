...
description: Run the Economic Incident Playbook Synthesizer capability for Economic Optimization with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0348_economic-incident-playbook-synth` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Economic Incident Playbook Synthesizer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Economic Incident Playbook Synthesizer.
...
## Operator Use Cases
- Operate Economic Incident Playbook Synthesizer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 70):** release artifacts after validation pass and route to `economic-optimization:communication-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Economic Incident Playbook Synthesizer`, including at least three measurable KPIs tied to overspending and low-impact allocation.
...
- Scoring weights: `truth=0.20, execution=0.33, safety=0.24, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 62
  - `review_risk`: risk >= 52
...
1. Incident recovery in Economic Optimization: ingest noisy signals, execute pattern-to-playbook synthesis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Economic Incident Playbook Synthesizer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
