...
## Metadata
- **Skill ID:** `51`
- **Skill Name:** `u0051-planning-policy-constraint-compiler`
...
4. Keep routing aligned with `strategic-planning-and-decomposition:contract-compiler` and include approval context.
...
- **Downstream Hint:** Route next to strategic-planning-and-decomposition:contract-compiler consumers with approval-gate context
