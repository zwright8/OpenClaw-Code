---
name: u0172-governance-human-approval-router
description: Run the Governance Human Approval Router capability for Safety and Governance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Governance Human Approval Router
...
| Feature flag | `skill_0172_governance-human-approval-router` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because high-speed autonomy needs enforceable guardrails to stay aligned. This specific skill directs high-risk decisions to the right humans quickly.

## Trigger Checklist
- [ ] The task explicitly needs Governance Human Approval Router (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Governance Human Approval Router.
...
## Operator Use Cases
- Operate Governance Human Approval Router as a reliable, reusable production workflow.
...
- **Review posture (score >= 57 or risk >= 59):** require human review before publish, with explicit remediation notes.
- **Critical posture (risk >= 83):** fail closed, execute `rollback-to-last-stable-baseline`, and escalate with incident packet.

## Traceability Map
- **Scope:** Define the scope and success metrics for `Governance Human Approval Router`, including at least three measurable KPIs tied to unsafe actions and policy drift.
...
1. Incident recovery in Safety and Governance: ingest noisy signals, execute reviewer routing policies, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Governance Human Approval Router against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
