...
description: Operate the "Federation Community Feedback Harvester" capability in production for the target domain workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `315`
- **Skill Name:** `u0315-federation-community-feedback-harvester`
...
4. Keep routing aligned with `federation-and-interoperability:normalization-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Federation Community Feedback Harvester normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `envelopes`, `tenant boundaries`, `protocol bridges`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to federation-and-interoperability:normalization-engine consumers with approval-gate context
