---
name: u0310-federation-privacy-preserving-data-broker
description: Run the Federation Privacy Preserving Data Broker capability for Federation and Interoperability with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0310_federation-privacy-preserving-da` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Federation Privacy Preserving Data Broker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Federation Privacy Preserving Data Broker.
...
## Operator Use Cases
- Operate Federation Privacy Preserving Data Broker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 72):** release artifacts after validation pass and route to `federation-and-interoperability:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Federation Privacy Preserving Data Broker`, including at least three measurable KPIs tied to integration breakage and trust boundary violations.
...
- Scoring weights: `truth=0.21, execution=0.28, safety=0.34, impact=0.17`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 48
  - `review_risk`: risk >= 41
...
1. Incident recovery in Federation and Interoperability: ingest noisy signals, execute policy-scoped data mediation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Federation Privacy Preserving Data Broker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
