...
## Metadata
- **Skill ID:** `45`
- **Skill Name:** `u0045-planning-confidence-calibration-engine`
...
4. Keep routing aligned with `strategic-planning-and-decomposition:optimization-engine` and include approval context.
...
- **Downstream Hint:** Route next to strategic-planning-and-decomposition:optimization-engine consumers with approval-gate context
