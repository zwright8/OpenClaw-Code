...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Training Curriculum Composer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering training curriculum composer normalization/assessment.
