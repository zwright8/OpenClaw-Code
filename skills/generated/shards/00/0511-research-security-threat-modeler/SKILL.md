---
name: u0511-research-security-threat-modeler
description: Run the Research Security Threat Modeler capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Research Security Threat Modeler
...
| Feature flag | `skill_0511_research-security-threat-modeler` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because research throughput degrades without reproducibility and prioritization. This specific skill anticipates attack paths before adversaries exploit them.

## Trigger Checklist
- [ ] The task explicitly needs Research Security Threat Modeler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Security Threat Modeler.
...
## Operator Use Cases
- Operate Research Security Threat Modeler as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Security Threat Modeler`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.33, execution=0.15, safety=0.13, impact=0.39`
- Posture thresholds:
  - `ready`: score >= 73
  - `review`: score >= 59
  - `review_risk`: risk >= 53
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute attack-surface modeling, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Security Threat Modeler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
