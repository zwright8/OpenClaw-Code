...
description: Operate the "Research Security Threat Modeler" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `511`
- **Skill Name:** `u0511-research-security-threat-modeler`
...
4. Keep routing aligned with `scientific-research-systems:detection-guard` and include approval context.
...
### Handoff Contract
- **Produces:** `Research Security Threat Modeler normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `hypotheses`, `experiments`, `replication evidence`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to scientific-research-systems:detection-guard consumers with approval-gate context
