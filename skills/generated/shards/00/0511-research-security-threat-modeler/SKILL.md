...
## When To Use
Use this skill when the request explicitly needs "Research Security Threat Modeler" outcomes in the Scientific Research Systems domain.
...
- Downstream routing hint: Route next to scientific-research-systems:detection-guard consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Research Security Threat Modeler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring research security threat modeler normalization/assessment.
