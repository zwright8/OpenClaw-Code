...
description: Build and operate the "Tooling Training Curriculum Composer" capability for Tool Reliability and Execution Quality. Use only when production execution explicitly requires this exact capability and output contract.
---
...
## Metadata
- **Skill ID:** `158`
- **Skill Name:** `u0158-tooling-training-curriculum-composer`
...
4. Keep routing aligned with `tool-reliability-and-execution-quality:general-capability` and include approval context.
...
### Handoff Contract
- **Produces:** `Tooling Training Curriculum Composer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `tool runs`, `error signatures`, `retry outcomes`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to tool-reliability-and-execution-quality:general-capability consumers with approval-gate context
