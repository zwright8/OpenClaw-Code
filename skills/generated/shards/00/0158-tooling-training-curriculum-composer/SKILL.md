...
- Trigger only when the requested outcome explicitly maps to **Tooling Training Curriculum Composer** in the **Tool Reliability and Execution Quality** capability family.
...
## Trigger Checklist
- [ ] The request explicitly needs **Tooling Training Curriculum Composer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Tool Reliability and Execution Quality**
   - Input: noisy upstream payload requiring tooling training curriculum composer normalization/assessment.
...
## When To Use
Use this when a request in **Tool Reliability and Execution Quality** depends on **Tooling Training Curriculum Composer** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
