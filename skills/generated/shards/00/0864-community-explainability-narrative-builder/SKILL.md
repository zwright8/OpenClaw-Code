...
## When To Use
Use this skill when the request explicitly needs "Community Explainability Narrative Builder" outcomes in the Community Engagement and Feedback domain.
...
## Handoff Contract
- Produces: Community Explainability Narrative Builder normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Community Explainability Narrative Builder** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community explainability narrative builder normalization/assessment.
