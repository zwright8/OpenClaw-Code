...
## Trigger Checklist
- [ ] The request explicitly needs **Infra KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra kpi dashboard publisher normalization/assessment.
