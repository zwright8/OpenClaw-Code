...
description: Operate the "Inclusion Counterfactual Simulator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `806`
- **Skill Name:** `u0806-inclusion-counterfactual-simulator`
- **Domain:** `Accessibility and Inclusion`
- **Domain Slug:** `accessibility-and-inclusion`
...
|---|---|---|---|
| accessibility audits | signal | true | upstream |
| accommodations | signal | true | upstream |
| usability feedback | signal | true | upstream |
...
4. Keep routing aligned with `accessibility-and-inclusion:simulation-lab` and include approval context.
...
- **Week:** Review KPI focus (`barriers for disabled`, `underserved groups`, `decision drift`), failure trends, and approval/retry performance.
...
### Handoff Contract
- **Produces:** `Inclusion Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `accessibility audits`, `accommodations`, `usability feedback`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to accessibility-and-inclusion:simulation-lab consumers with approval-gate context
