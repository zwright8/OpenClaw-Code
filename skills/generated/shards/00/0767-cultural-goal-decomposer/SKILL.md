...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Goal Decomposer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural goal decomposer normalization/assessment.
