...
## Metadata
- **Skill ID:** `401`
- **Skill Name:** `u0401-publicservice-signal-ingestion-normalizer`
...
4. Keep routing aligned with `healthcare-and-public-services:normalization-engine` and include approval context.
...
- **Downstream Hint:** Route next to healthcare-and-public-services:normalization-engine consumers with approval-gate context
