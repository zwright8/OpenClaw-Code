---
name: u0384-logistics-explainability-narrative-builder
description: Run the Logistics Explainability Narrative Builder capability for Resource Allocation and Logistics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Logistics Explainability Narrative Builder
...
| Feature flag | `skill_0384_logistics-explainability-narrati` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because impact work fails when scarce resources are not routed intelligently. This specific skill translates technical decisions into operator-usable narratives.

## Trigger Checklist
- [ ] The task explicitly needs Logistics Explainability Narrative Builder (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Logistics Explainability Narrative Builder.
...
## Operator Use Cases
- Operate Logistics Explainability Narrative Builder as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 75):** release artifacts after validation pass and route to `resource-allocation-and-logistics:communication-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Logistics Explainability Narrative Builder`, including at least three measurable KPIs tied to supply shortfalls and fairness gaps.
...
- Scoring weights: `truth=0.25, execution=0.27, safety=0.24, impact=0.24`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 43
  - `review_risk`: risk >= 34
...
1. Incident recovery in Resource Allocation and Logistics: ingest noisy signals, execute reason synthesis and abstraction, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Logistics Explainability Narrative Builder against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
