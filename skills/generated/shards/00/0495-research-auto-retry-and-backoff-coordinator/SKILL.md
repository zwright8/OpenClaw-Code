---
name: u0495-research-auto-retry-and-backoff-coordinator
description: Run the Research Auto-Retry and Backoff Coordinator capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Research Auto-Retry and Backoff Coordinator
...
| Feature flag | `skill_0495_research-auto-retry-and-backoff-` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because research throughput degrades without reproducibility and prioritization. This specific skill improves success rates while preventing retry storms.

## Trigger Checklist
- [ ] The task explicitly needs Research Auto-Retry and Backoff Coordinator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Auto-Retry and Backoff Coordinator.
...
## Operator Use Cases
- Operate Research Auto-Retry and Backoff Coordinator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Auto-Retry and Backoff Coordinator`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.17, execution=0.22, safety=0.33, impact=0.28`
- Posture thresholds:
  - `ready`: score >= 74
  - `review`: score >= 57
  - `review_risk`: risk >= 49
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute adaptive backoff control, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Auto-Retry and Backoff Coordinator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
