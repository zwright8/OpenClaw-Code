...
description: Build and operate the "Research Auto-Retry and Backoff Coordinator" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Research Auto-Retry and Backoff Coordinator" outcomes in the Scientific Research Systems domain.
...
## Handoff Contract
- Produces: Research Auto-Retry and Backoff Coordinator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Research Auto-Retry and Backoff Coordinator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Scientific Research Systems**
   - Input: noisy upstream payload requiring research auto-retry and backoff coordinator normalization/assessment.
