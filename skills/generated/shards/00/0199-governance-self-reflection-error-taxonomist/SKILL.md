...
description: Run the Governance Self-Reflection Error Taxonomist capability for Safety and Governance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0199_governance-self-reflection-error` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Governance Self-Reflection Error Taxonomist (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Governance Self-Reflection Error Taxonomist.
...
## Operator Use Cases
- Operate Governance Self-Reflection Error Taxonomist as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Governance Self-Reflection Error Taxonomist`, including at least three measurable KPIs tied to unsafe actions and policy drift.
...
- Scoring weights: `truth=0.26, execution=0.32, safety=0.13, impact=0.30`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 52
  - `review_risk`: risk >= 36
...
1. Incident recovery in Safety and Governance: ingest noisy signals, execute failure-type clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Governance Self-Reflection Error Taxonomist against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
