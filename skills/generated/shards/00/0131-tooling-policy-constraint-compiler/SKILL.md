...
## Metadata
- **Skill ID:** `131`
- **Skill Name:** `u0131-tooling-policy-constraint-compiler`
...
4. Keep routing aligned with `tool-reliability-and-execution-quality:contract-compiler` and include approval context.
...
### Handoff Contract
- **Produces:** `Tooling Policy Constraint Compiler normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `tool runs`, `error signatures`, `retry outcomes`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to tool-reliability-and-execution-quality:contract-compiler consumers with approval-gate context
