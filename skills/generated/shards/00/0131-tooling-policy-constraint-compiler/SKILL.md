...
- The task explicitly requires `u0131-tooling-policy-constraint-compiler` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
