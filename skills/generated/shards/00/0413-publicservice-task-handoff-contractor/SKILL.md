...
description: Build and operate the "PublicService Task Handoff Contractor" capability for Healthcare and Public Services. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "PublicService Task Handoff Contractor" outcomes in the Healthcare and Public Services domain.
...
## Handoff Contract
- Produces: PublicService Task Handoff Contractor normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Task Handoff Contractor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice task handoff contractor normalization/assessment.
