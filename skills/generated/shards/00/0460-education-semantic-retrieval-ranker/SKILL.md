...
description: Build and operate the "Education Semantic Retrieval Ranker" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Semantic Retrieval Ranker" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Semantic Retrieval Ranker normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Semantic Retrieval Ranker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education semantic retrieval ranker normalization/assessment.
