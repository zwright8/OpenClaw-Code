---
name: u0460-education-semantic-retrieval-ranker
description: Run the Education Semantic Retrieval Ranker capability for Education and Upskilling with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Education Semantic Retrieval Ranker
...
| Feature flag | `skill_0460_education-semantic-retrieval-ran` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because human capability growth requires targeted planning under constraints. This specific skill improves recall precision for downstream decision quality.

## Trigger Checklist
- [ ] The task explicitly needs Education Semantic Retrieval Ranker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Education Semantic Retrieval Ranker.
...
## Operator Use Cases
- Operate Education Semantic Retrieval Ranker as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Education Semantic Retrieval Ranker`, including at least three measurable KPIs tied to persistent skill gaps and poor learning outcomes.
...
- Scoring weights: `truth=0.43, execution=0.18, safety=0.17, impact=0.21`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 57
  - `review_risk`: risk >= 49
...
1. Incident recovery in Education and Upskilling: ingest noisy signals, execute semantic relevance scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Education Semantic Retrieval Ranker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
