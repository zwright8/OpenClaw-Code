...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Compliance Evidence Mapper** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice compliance evidence mapper normalization/assessment.
