...
## Metadata
- **Skill ID:** `432`
- **Skill Name:** `u0432-publicservice-compliance-evidence-mapper`
...
### Handoff Contract
- **Produces:** `PublicService Compliance Evidence Mapper normalized artifacts`, `execution scorecard`, `risk posture`
