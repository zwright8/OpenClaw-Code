...
description: Operate the "Community Knowledge Graph Linker" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Community Knowledge Graph Linker" outcomes in the Community Engagement and Feedback domain.
...
## Handoff Contract
- Produces: Community Knowledge Graph Linker normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Community Knowledge Graph Linker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community knowledge graph linker normalization/assessment.
