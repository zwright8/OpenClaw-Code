...
description: Build and operate the "Logistics Cost-Benefit Forecaster" capability for Resource Allocation and Logistics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Logistics Cost-Benefit Forecaster" outcomes in the Resource Allocation and Logistics domain.
...
## Handoff Contract
- Produces: Logistics Cost-Benefit Forecaster normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Logistics Cost-Benefit Forecaster** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Resource Allocation and Logistics**
   - Input: noisy upstream payload requiring logistics cost-benefit forecaster normalization/assessment.
