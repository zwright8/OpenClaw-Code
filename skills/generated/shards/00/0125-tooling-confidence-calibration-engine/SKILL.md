...
- The task explicitly requires `u0125-tooling-confidence-calibration-engine` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
