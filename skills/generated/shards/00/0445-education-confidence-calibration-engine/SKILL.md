...
## Metadata
- **Skill ID:** `445`
- **Skill Name:** `u0445-education-confidence-calibration-engine`
...
4. Keep routing aligned with `education-and-upskilling:optimization-engine` and include approval context.
...
- **Downstream Hint:** Route next to education-and-upskilling:optimization-engine consumers with approval-gate context
