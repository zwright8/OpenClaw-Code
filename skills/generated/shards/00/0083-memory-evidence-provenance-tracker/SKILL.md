...
## Metadata
- **Skill ID:** `83`
- **Skill Name:** `u0083-memory-evidence-provenance-tracker`
...
4. Keep routing aligned with `memory-and-knowledge-operations:provenance-tracker` and include approval context.
...
### Handoff Contract
- **Produces:** `Memory Evidence Provenance Tracker normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `episodic logs`, `knowledge nodes`, `retrieval metadata`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to memory-and-knowledge-operations:provenance-tracker consumers with approval-gate context
