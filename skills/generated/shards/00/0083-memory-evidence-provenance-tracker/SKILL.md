...
description: Build and operate the "Memory Evidence Provenance Tracker" capability for Memory and Knowledge Operations. Use when outcomes in this capability family are required for production execution.
---
...
## When To Use
Use this skill when you need "Memory Evidence Provenance Tracker" outputs that will influence production decisions, automated routing, policy posture, or external-facing actions.
...
- Routing tag: memory-and-knowledge-operations:memory-evidence-provenance-tracker
...
## Output Contract
- `memory_evidence_provenance_tracker_report` (structured-report, consumer=orchestrator, guaranteed=true)
- `memory_evidence_provenance_tracker_scorecard` (scorecard, consumer=operator, guaranteed=true)
- `memory_evidence_provenance_tracker_handoff` (handoff-packet, consumer=downstream-skill, guaranteed=true)
...
## Trigger Checklist
- [ ] The request explicitly needs **Memory Evidence Provenance Tracker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Memory and Knowledge Operations**
   - Input: noisy upstream payload requiring memory evidence provenance tracker normalization/assessment.
