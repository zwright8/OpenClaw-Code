---
name: u0193-governance-cost-benefit-forecaster
description: Run the Governance Cost-Benefit Forecaster capability for Safety and Governance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Governance Cost-Benefit Forecaster
...
| Feature flag | `skill_0193_governance-cost-benefit-forecast` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because high-speed autonomy needs enforceable guardrails to stay aligned. This specific skill prioritizes actions with the strongest net value.

## Trigger Checklist
- [ ] The task explicitly needs Governance Cost-Benefit Forecaster (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Governance Cost-Benefit Forecaster.
...
## Operator Use Cases
- Operate Governance Cost-Benefit Forecaster as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `safety-and-governance:simulation-lab`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Governance Cost-Benefit Forecaster`, including at least three measurable KPIs tied to unsafe actions and policy drift.
...
- Scoring weights: `truth=0.23, execution=0.18, safety=0.37, impact=0.21`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 49
  - `review_risk`: risk >= 41
...
1. Incident recovery in Safety and Governance: ingest noisy signals, execute cost-impact simulation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Governance Cost-Benefit Forecaster against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
