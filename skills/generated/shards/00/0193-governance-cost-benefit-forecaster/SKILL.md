...
## Metadata
- **Skill ID:** `193`
- **Skill Name:** `u0193-governance-cost-benefit-forecaster`
...
4. Keep routing aligned with `safety-and-governance:simulation-lab` and include approval context.
...
- **Downstream Hint:** Route next to safety-and-governance:simulation-lab consumers with approval-gate context
