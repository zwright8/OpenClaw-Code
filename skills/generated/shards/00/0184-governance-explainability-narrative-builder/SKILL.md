...
description: Build and operate the "Governance Explainability Narrative Builder" capability for Safety and Governance. Use only when production execution explicitly requires this exact capability and output contract.
---
...
- Trigger only when the requested outcome explicitly maps to **Governance Explainability Narrative Builder** in the **Safety and Governance** capability family.
...
## Trigger Checklist
- [ ] The request explicitly needs **Governance Explainability Narrative Builder** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Safety and Governance**
   - Input: noisy upstream payload requiring governance explainability narrative builder normalization/assessment.
...
## When To Use
Use this when a request in **Safety and Governance** depends on **Governance Explainability Narrative Builder** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
