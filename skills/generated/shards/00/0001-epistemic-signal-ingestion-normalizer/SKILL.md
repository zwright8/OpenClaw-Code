...
description: Run the Epistemic Signal Ingestion Normalizer capability for Truth-Seeking and Epistemics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0001_epistemic-signal-ingestion-norma` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Epistemic Signal Ingestion Normalizer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Epistemic Signal Ingestion Normalizer.
...
## Operator Use Cases
- Operate Epistemic Signal Ingestion Normalizer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 74):** release artifacts after validation pass and route to `truth-seeking-and-epistemics:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Epistemic Signal Ingestion Normalizer`, including at least three measurable KPIs tied to false certainty and unverified assumptions.
...
- Scoring weights: `truth=0.36, execution=0.12, safety=0.25, impact=0.27`
- Posture thresholds:
  - `ready`: score >= 74
  - `review`: score >= 53
  - `review_risk`: risk >= 61
...
1. Incident recovery in Truth-Seeking and Epistemics: ingest noisy signals, execute schema mapping and validation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Epistemic Signal Ingestion Normalizer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
