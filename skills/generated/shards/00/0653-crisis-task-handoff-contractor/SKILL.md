...
## When To Use
Use this skill when the request explicitly needs "Crisis Task Handoff Contractor" outcomes in the Crisis and Incident Response domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Task Handoff Contractor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis task handoff contractor normalization/assessment.
