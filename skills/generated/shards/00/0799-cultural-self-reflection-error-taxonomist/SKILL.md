...
## Metadata
- **Skill ID:** `799`
- **Skill Name:** `u0799-cultural-self-reflection-error-taxonomist`
...
### Handoff Contract
- **Produces:** `Cultural Self-Reflection Error Taxonomist normalized artifacts`, `execution scorecard`, `risk posture`
