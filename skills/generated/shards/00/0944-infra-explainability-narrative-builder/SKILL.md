...
## When To Use
Use this skill when the request explicitly needs "Infra Explainability Narrative Builder" outcomes in the Infrastructure and Sustainability domain.
...
## Handoff Contract
- Produces: Infra Explainability Narrative Builder normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Explainability Narrative Builder** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra explainability narrative builder normalization/assessment.
