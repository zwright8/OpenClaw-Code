...
## Metadata
- **Skill ID:** `685`
- **Skill Name:** `u0685-impact-confidence-calibration-engine`
...
4. Keep routing aligned with `social-impact-measurement:optimization-engine` and include approval context.
...
- **Downstream Hint:** Route next to social-impact-measurement:optimization-engine consumers with approval-gate context
