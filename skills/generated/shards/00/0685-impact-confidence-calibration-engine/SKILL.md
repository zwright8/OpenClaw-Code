...
## When To Use
Use this skill when the request explicitly needs "Impact Confidence Calibration Engine" outcomes in the Social Impact Measurement domain.
...
## Handoff Contract
- Produces: Impact Confidence Calibration Engine normalized artifacts; execution scorecard; risk posture
- Consumes: community outcomes; kpi trends; intervention deltas; claims; evidence; confidence traces
- Downstream routing hint: Route next to social-impact-measurement:optimization-engine consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Impact Confidence Calibration Engine** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring impact confidence calibration engine normalization/assessment.
