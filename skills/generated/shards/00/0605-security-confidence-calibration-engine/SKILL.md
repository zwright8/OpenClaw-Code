...
## Metadata
- **Skill ID:** `605`
- **Skill Name:** `u0605-security-confidence-calibration-engine`
...
4. Keep routing aligned with `security-and-privacy:optimization-engine` and include approval context.
...
- **Downstream Hint:** Route next to security-and-privacy:optimization-engine consumers with approval-gate context
