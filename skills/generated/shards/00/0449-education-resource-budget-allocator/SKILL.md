...
description: Build and operate the "Education Resource Budget Allocator" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Resource Budget Allocator" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Resource Budget Allocator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Resource Budget Allocator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education resource budget allocator normalization/assessment.
