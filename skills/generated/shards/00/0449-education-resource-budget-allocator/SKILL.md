---
name: u0449-education-resource-budget-allocator
description: Run the Education Resource Budget Allocator capability for Education and Upskilling with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Education Resource Budget Allocator
...
| Feature flag | `skill_0449_education-resource-budget-alloca` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because human capability growth requires targeted planning under constraints. This specific skill matches mission ambition to finite execution capacity.

## Trigger Checklist
- [ ] The task explicitly needs Education Resource Budget Allocator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Education Resource Budget Allocator.
...
## Operator Use Cases
- Operate Education Resource Budget Allocator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Education Resource Budget Allocator`, including at least three measurable KPIs tied to persistent skill gaps and poor learning outcomes.
...
- Scoring weights: `truth=0.31, execution=0.14, safety=0.23, impact=0.32`
- Posture thresholds:
  - `ready`: score >= 71
  - `review`: score >= 46
  - `review_risk`: risk >= 45
...
1. Incident recovery in Education and Upskilling: ingest noisy signals, execute capacity-aware allocation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Education Resource Budget Allocator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
