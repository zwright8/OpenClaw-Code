...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis kpi dashboard publisher normalization/assessment.
