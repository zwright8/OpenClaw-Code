...
## When To Use
Use this skill when the request explicitly needs "Security Experiment Design Generator" outcomes in the Security and Privacy domain.
...
## Handoff Contract
- Produces: Security Experiment Design Generator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Security Experiment Design Generator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security experiment design generator normalization/assessment.
