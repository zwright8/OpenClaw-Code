...
## Metadata
- **Skill ID:** `515`
- **Skill Name:** `u0515-research-community-feedback-harvester`
...
4. Keep routing aligned with `scientific-research-systems:normalization-engine` and include approval context.
...
- **Downstream Hint:** Route next to scientific-research-systems:normalization-engine consumers with approval-gate context
