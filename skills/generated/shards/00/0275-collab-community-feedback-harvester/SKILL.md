...
description: Operate the "Collab Community Feedback Harvester" capability in production for the target domain workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Collab Community Feedback Harvester` in the target domain and a downstream consumer requires contract-bound artifacts.
