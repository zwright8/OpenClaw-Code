---
name: u0275-collab-community-feedback-harvester
description: Run the Collab Community Feedback Harvester capability for Collaboration and Negotiation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Collab Community Feedback Harvester
...
| Feature flag | `skill_0275_collab-community-feedback-harves` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because multi-agent systems underperform without explicit conflict resolution. This specific skill integrates lived user feedback into planning cycles.

## Trigger Checklist
- [ ] The task explicitly needs Collab Community Feedback Harvester (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Collab Community Feedback Harvester.
...
## Operator Use Cases
- Operate Collab Community Feedback Harvester as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `collaboration-and-negotiation:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Collab Community Feedback Harvester`, including at least three measurable KPIs tied to deadlocks and degraded trust.
...
- Scoring weights: `truth=0.26, execution=0.26, safety=0.23, impact=0.25`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 52
  - `review_risk`: risk >= 48
...
1. Incident recovery in Collaboration and Negotiation: ingest noisy signals, execute feedback normalization and clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Collab Community Feedback Harvester against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
