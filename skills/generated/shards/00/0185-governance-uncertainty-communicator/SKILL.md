...
description: Build and operate the "Governance Uncertainty Communicator" capability for Safety and Governance. Use only when production execution explicitly requires this exact capability and output contract.
---
...
## Metadata
- **Skill ID:** `185`
- **Skill Name:** `u0185-governance-uncertainty-communicator`
...
4. Keep routing aligned with `safety-and-governance:communication-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Governance Uncertainty Communicator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `policies`, `violations`, `mitigation actions`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to safety-and-governance:communication-engine consumers with approval-gate context
