...
description: Run the Governance Auto-Retry and Backoff Coordinator capability for Safety and Governance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0175_governance-auto-retry-and-backof` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Governance Auto-Retry and Backoff Coordinator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Governance Auto-Retry and Backoff Coordinator.
...
## Operator Use Cases
- Operate Governance Auto-Retry and Backoff Coordinator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Governance Auto-Retry and Backoff Coordinator`, including at least three measurable KPIs tied to unsafe actions and policy drift.
...
- Scoring weights: `truth=0.20, execution=0.16, safety=0.22, impact=0.42`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 58
  - `review_risk`: risk >= 60
...
1. Incident recovery in Safety and Governance: ingest noisy signals, execute adaptive backoff control, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Governance Auto-Retry and Backoff Coordinator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
