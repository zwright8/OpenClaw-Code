...
## Metadata
- **Skill ID:** `851`
- **Skill Name:** `u0851-community-policy-constraint-compiler`
...
4. Keep routing aligned with `community-engagement-and-feedback:contract-compiler` and include approval context.
...
- **Downstream Hint:** Route next to community-engagement-and-feedback:contract-compiler consumers with approval-gate context
