...
- The task explicitly requires `u0119-memory-self-reflection-error-taxonomist` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
