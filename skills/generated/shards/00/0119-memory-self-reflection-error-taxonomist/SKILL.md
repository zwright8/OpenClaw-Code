---
name: u0119-memory-self-reflection-error-taxonomist
description: Run the Memory Self-Reflection Error Taxonomist capability for Memory and Knowledge Operations with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Memory Self-Reflection Error Taxonomist
...
| Feature flag | `skill_0119_memory-self-reflection-error-tax` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents lose performance when lessons are not retained and reused. This specific skill classifies recurrent reasoning failures for targeted fixes.

## Trigger Checklist
- [ ] The task explicitly needs Memory Self-Reflection Error Taxonomist (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Memory Self-Reflection Error Taxonomist.
...
## Operator Use Cases
- Operate Memory Self-Reflection Error Taxonomist as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 75):** release artifacts after validation pass and route to `memory-and-knowledge-operations:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Memory Self-Reflection Error Taxonomist`, including at least three measurable KPIs tied to repeated mistakes and context loss.
...
- Scoring weights: `truth=0.33, execution=0.26, safety=0.25, impact=0.16`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 48
  - `review_risk`: risk >= 42
...
1. Incident recovery in Memory and Knowledge Operations: ingest noisy signals, execute failure-type clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Memory Self-Reflection Error Taxonomist against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
