...
- The task explicitly requires `u0129-tooling-resource-budget-allocator` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
