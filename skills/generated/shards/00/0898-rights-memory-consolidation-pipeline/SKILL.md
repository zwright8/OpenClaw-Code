...
## When To Use
Use this skill when the request explicitly needs "Rights Memory Consolidation Pipeline" outcomes in the Legal, Rights, and Compliance domain.
...
- Downstream routing hint: Route next to legal-rights-and-compliance:general-capability consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Memory Consolidation Pipeline** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights memory consolidation pipeline normalization/assessment.
