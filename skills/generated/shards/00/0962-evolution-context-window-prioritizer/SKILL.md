...
## Trigger Checklist
- [ ] The request explicitly needs **Evolution Context Window Prioritizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring evolution context window prioritizer normalization/assessment.
