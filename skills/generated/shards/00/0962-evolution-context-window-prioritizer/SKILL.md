...
description: Run the Evolution Context Window Prioritizer capability for Autonomous Learning and Evolution with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0962_evolution-context-window-priorit` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Evolution Context Window Prioritizer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Evolution Context Window Prioritizer.
...
## Operator Use Cases
- Operate Evolution Context Window Prioritizer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Evolution Context Window Prioritizer`, including at least three measurable KPIs tied to capability stagnation and repeated blind spots.
...
- Scoring weights: `truth=0.20, execution=0.38, safety=0.22, impact=0.20`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 56
  - `review_risk`: risk >= 50
...
1. Incident recovery in Autonomous Learning and Evolution: ingest noisy signals, execute importance scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Evolution Context Window Prioritizer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
