...
## Metadata
- **Skill ID:** `782`
- **Skill Name:** `u0782-cultural-multi-agent-negotiation-mediator`
...
4. Keep routing aligned with `multilingual-and-cultural-adaptation:collaboration-mediator` and include approval context.
...
- **Downstream Hint:** Route next to multilingual-and-cultural-adaptation:collaboration-mediator consumers with approval-gate context
