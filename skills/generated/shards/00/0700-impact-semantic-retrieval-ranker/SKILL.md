---
name: u0700-impact-semantic-retrieval-ranker
description: Run the Impact Semantic Retrieval Ranker capability for Social Impact Measurement with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Impact Semantic Retrieval Ranker
...
| Feature flag | `skill_0700_impact-semantic-retrieval-ranker` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need measurable outcomes, not just activity volume. This specific skill improves recall precision for downstream decision quality.

## Trigger Checklist
- [ ] The task explicitly needs Impact Semantic Retrieval Ranker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Impact Semantic Retrieval Ranker.
...
## Operator Use Cases
- Operate Impact Semantic Retrieval Ranker as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Impact Semantic Retrieval Ranker`, including at least three measurable KPIs tied to impact theater and unmeasured harm.
...
- Scoring weights: `truth=0.29, execution=0.27, safety=0.31, impact=0.13`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 44
  - `review_risk`: risk >= 40
...
1. Incident recovery in Social Impact Measurement: ingest noisy signals, execute semantic relevance scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Impact Semantic Retrieval Ranker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
