...
description: Operate the "Impact Semantic Retrieval Ranker" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Impact Semantic Retrieval Ranker" outcomes in the Social Impact Measurement domain.
...
## Handoff Contract
- Produces: Impact Semantic Retrieval Ranker normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Impact Semantic Retrieval Ranker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring impact semantic retrieval ranker normalization/assessment.
