...
## When To Use
Use this skill when the request explicitly needs "Community A/B Rollout Governor" outcomes in the Community Engagement and Feedback domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Community A/B Rollout Governor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community a/b rollout governor normalization/assessment.
