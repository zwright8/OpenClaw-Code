---
name: u0833-inclusion-cost-benefit-forecaster
description: Run the Inclusion Cost-Benefit Forecaster capability for Accessibility and Inclusion with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Inclusion Cost-Benefit Forecaster
...
| Feature flag | `skill_0833_inclusion-cost-benefit-forecaste` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because systems must be operable and understandable for diverse users. This specific skill prioritizes actions with the strongest net value.

## Trigger Checklist
- [ ] The task explicitly needs Inclusion Cost-Benefit Forecaster (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Inclusion Cost-Benefit Forecaster.
...
## Operator Use Cases
- Operate Inclusion Cost-Benefit Forecaster as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `accessibility-and-inclusion:simulation-lab`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Inclusion Cost-Benefit Forecaster`, including at least three measurable KPIs tied to barriers for disabled and underserved groups.
...
- Scoring weights: `truth=0.14, execution=0.21, safety=0.27, impact=0.37`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 44
  - `review_risk`: risk >= 32
...
1. Incident recovery in Accessibility and Inclusion: ingest noisy signals, execute cost-impact simulation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Inclusion Cost-Benefit Forecaster against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
