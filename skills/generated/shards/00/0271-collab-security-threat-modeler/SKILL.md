---
name: u0271-collab-security-threat-modeler
description: Run the Collab Security Threat Modeler capability for Collaboration and Negotiation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Collab Security Threat Modeler
...
| Feature flag | `skill_0271_collab-security-threat-modeler` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because multi-agent systems underperform without explicit conflict resolution. This specific skill anticipates attack paths before adversaries exploit them.

## Trigger Checklist
- [ ] The task explicitly needs Collab Security Threat Modeler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Collab Security Threat Modeler.
...
## Operator Use Cases
- Operate Collab Security Threat Modeler as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `collaboration-and-negotiation:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Collab Security Threat Modeler`, including at least three measurable KPIs tied to deadlocks and degraded trust.
...
- Scoring weights: `truth=0.15, execution=0.30, safety=0.27, impact=0.27`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 62
  - `review_risk`: risk >= 54
...
1. Incident recovery in Collaboration and Negotiation: ingest noisy signals, execute attack-surface modeling, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Collab Security Threat Modeler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
