...
## Trigger Checklist
- [ ] The request explicitly needs **Evolution Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring evolution uncertainty communicator normalization/assessment.
