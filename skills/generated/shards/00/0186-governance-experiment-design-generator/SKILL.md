...
- Trigger only when the requested outcome explicitly maps to **Governance Experiment Design Generator** in the **Safety and Governance** capability family.
...
## Trigger Checklist
- [ ] The request explicitly needs **Governance Experiment Design Generator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Safety and Governance**
   - Input: noisy upstream payload requiring governance experiment design generator normalization/assessment.
...
## When To Use
Use this when a request in **Safety and Governance** depends on **Governance Experiment Design Generator** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
