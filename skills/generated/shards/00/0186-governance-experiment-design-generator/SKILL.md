...
description: Run the Governance Experiment Design Generator capability for Safety and Governance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
## Trigger Checklist
- [ ] The task explicitly needs Governance Experiment Design Generator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Governance Experiment Design Generator.
...
## Operator Use Cases
- Operate Governance Experiment Design Generator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Governance Experiment Design Generator`, including at least three measurable KPIs tied to unsafe actions and policy drift.
...
- Scoring weights: `truth=0.28, execution=0.36, safety=0.15, impact=0.21`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 61
  - `review_risk`: risk >= 52
...
1. Incident recovery in Safety and Governance: ingest noisy signals, execute hypothesis-driven design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Governance Experiment Design Generator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
