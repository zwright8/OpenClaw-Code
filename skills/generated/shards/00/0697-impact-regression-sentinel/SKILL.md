...
## Metadata
- **Skill ID:** `697`
- **Skill Name:** `u0697-impact-regression-sentinel`
...
4. Keep routing aligned with `social-impact-measurement:detection-guard` and include approval context.
...
- **Downstream Hint:** Route next to social-impact-measurement:detection-guard consumers with approval-gate context
