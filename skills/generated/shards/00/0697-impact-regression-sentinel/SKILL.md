---
name: u0697-impact-regression-sentinel
description: Run the Impact Regression Sentinel capability for Social Impact Measurement with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Impact Regression Sentinel
...
| Feature flag | `skill_0697_impact-regression-sentinel` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need measurable outcomes, not just activity volume. This specific skill prevents unnoticed quality drift after updates.

## Trigger Checklist
- [ ] The task explicitly needs Impact Regression Sentinel (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Impact Regression Sentinel.
...
## Operator Use Cases
- Operate Impact Regression Sentinel as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 75):** release artifacts after validation pass and route to `social-impact-measurement:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Impact Regression Sentinel`, including at least three measurable KPIs tied to impact theater and unmeasured harm.
...
- Scoring weights: `truth=0.27, execution=0.21, safety=0.21, impact=0.31`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 53
  - `review_risk`: risk >= 48
...
1. Incident recovery in Social Impact Measurement: ingest noisy signals, execute baseline-delta detection, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Impact Regression Sentinel against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
