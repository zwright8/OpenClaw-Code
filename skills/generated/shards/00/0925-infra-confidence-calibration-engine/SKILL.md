...
- Downstream routing hint: Route next to infrastructure-and-sustainability:optimization-engine consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Confidence Calibration Engine** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra confidence calibration engine normalization/assessment.
