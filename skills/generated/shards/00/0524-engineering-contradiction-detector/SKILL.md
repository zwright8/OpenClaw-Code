...
description: Operate the "Engineering Contradiction Detector" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Engineering Contradiction Detector" outcomes in the Software Engineering Automation domain.
...
## Handoff Contract
- Produces: Engineering Contradiction Detector normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Contradiction Detector** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering contradiction detector normalization/assessment.
