...
## Metadata
- **Skill ID:** `91`
- **Skill Name:** `u0091-memory-policy-constraint-compiler`
...
4. Keep routing aligned with `memory-and-knowledge-operations:contract-compiler` and include approval context.
...
### Handoff Contract
- **Produces:** `Memory Policy Constraint Compiler normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `episodic logs`, `knowledge nodes`, `retrieval metadata`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to memory-and-knowledge-operations:contract-compiler consumers with approval-gate context
