---
name: u0091-memory-policy-constraint-compiler
description: Run the Memory Policy Constraint Compiler capability for Memory and Knowledge Operations with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Memory Policy Constraint Compiler
...
| Feature flag | `skill_0091_memory-policy-constraint-compile` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents lose performance when lessons are not retained and reused. This specific skill turns governance language into enforceable runtime checks.

## Trigger Checklist
- [ ] The task explicitly needs Memory Policy Constraint Compiler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Memory Policy Constraint Compiler.
...
## Operator Use Cases
- Operate Memory Policy Constraint Compiler as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Memory Policy Constraint Compiler`, including at least three measurable KPIs tied to repeated mistakes and context loss.
...
- Scoring weights: `truth=0.40, execution=0.17, safety=0.26, impact=0.17`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 62
  - `review_risk`: risk >= 46
...
1. Incident recovery in Memory and Knowledge Operations: ingest noisy signals, execute rule compilation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Memory Policy Constraint Compiler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
