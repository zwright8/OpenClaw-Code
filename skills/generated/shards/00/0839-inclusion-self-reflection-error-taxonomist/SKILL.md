...
## When To Use
Use this skill when the request explicitly needs "Inclusion Self-Reflection Error Taxonomist" outcomes in the Accessibility and Inclusion domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion self-reflection error taxonomist normalization/assessment.
