---
name: u0108-memory-incident-playbook-synthesizer
description: Run the Memory Incident Playbook Synthesizer capability for Memory and Knowledge Operations with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Memory Incident Playbook Synthesizer
...
| Feature flag | `skill_0108_memory-incident-playbook-synthes` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents lose performance when lessons are not retained and reused. This specific skill creates repeatable response procedures from incident history.

## Trigger Checklist
- [ ] The task explicitly needs Memory Incident Playbook Synthesizer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Memory Incident Playbook Synthesizer.
...
## Operator Use Cases
- Operate Memory Incident Playbook Synthesizer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Memory Incident Playbook Synthesizer`, including at least three measurable KPIs tied to repeated mistakes and context loss.
...
- Scoring weights: `truth=0.27, execution=0.26, safety=0.24, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 54
  - `review_risk`: risk >= 58
...
1. Incident recovery in Memory and Knowledge Operations: ingest noisy signals, execute pattern-to-playbook synthesis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Memory Incident Playbook Synthesizer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
