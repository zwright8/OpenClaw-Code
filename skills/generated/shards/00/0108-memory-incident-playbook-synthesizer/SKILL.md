...
- The task explicitly requires `u0108-memory-incident-playbook-synthesizer` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
