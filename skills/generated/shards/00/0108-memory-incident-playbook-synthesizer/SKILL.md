...
## Metadata
- **Skill ID:** `108`
- **Skill Name:** `u0108-memory-incident-playbook-synthesizer`
...
### Handoff Contract
- **Produces:** `Memory Incident Playbook Synthesizer normalized artifacts`, `execution scorecard`, `risk posture`
