...
## Metadata
- **Skill ID:** `771`
- **Skill Name:** `u0771-cultural-policy-constraint-compiler`
...
4. Keep routing aligned with `multilingual-and-cultural-adaptation:contract-compiler` and include approval context.
...
- **Downstream Hint:** Route next to multilingual-and-cultural-adaptation:contract-compiler consumers with approval-gate context
