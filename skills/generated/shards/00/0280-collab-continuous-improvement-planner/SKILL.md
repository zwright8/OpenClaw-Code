---
name: u0280-collab-continuous-improvement-planner
description: Run the Collab Continuous Improvement Planner capability for Collaboration and Negotiation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Collab Continuous Improvement Planner
...
| Feature flag | `skill_0280_collab-continuous-improvement-pl` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because multi-agent systems underperform without explicit conflict resolution. This specific skill turns findings into sustained upgrade cycles.

## Trigger Checklist
- [ ] The task explicitly needs Collab Continuous Improvement Planner (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Collab Continuous Improvement Planner.
...
## Operator Use Cases
- Operate Collab Continuous Improvement Planner as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Collab Continuous Improvement Planner`, including at least three measurable KPIs tied to deadlocks and degraded trust.
...
- Scoring weights: `truth=0.22, execution=0.29, safety=0.16, impact=0.34`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 53
  - `review_risk`: risk >= 47
...
1. Incident recovery in Collaboration and Negotiation: ingest noisy signals, execute closed-loop prioritization, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Collab Continuous Improvement Planner against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
