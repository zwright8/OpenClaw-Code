...
## Metadata
- **Skill ID:** `85`
- **Skill Name:** `u0085-memory-confidence-calibration-engine`
...
4. Keep routing aligned with `memory-and-knowledge-operations:optimization-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Memory Confidence Calibration Engine normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `episodic logs`, `knowledge nodes`, `retrieval metadata`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to memory-and-knowledge-operations:optimization-engine consumers with approval-gate context
