...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Risk-Aware Scheduler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis risk-aware scheduler normalization/assessment.
