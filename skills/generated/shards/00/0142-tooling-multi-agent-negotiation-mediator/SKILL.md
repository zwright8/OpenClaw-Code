...
- The task explicitly requires `u0142-tooling-multi-agent-negotiation-mediator` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
