...
## Trigger Checklist
- [ ] The request explicitly needs **Community Incident Playbook Synthesizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community incident playbook synthesizer normalization/assessment.
