...
description: Run the Community Incident Playbook Synthesizer capability for Community Engagement and Feedback with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0868_community-incident-playbook-synt` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Community Incident Playbook Synthesizer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Community Incident Playbook Synthesizer.
...
## Operator Use Cases
- Operate Community Incident Playbook Synthesizer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 70):** release artifacts after validation pass and route to `community-engagement-and-feedback:communication-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Community Incident Playbook Synthesizer`, including at least three measurable KPIs tied to community trust loss and unaddressed concerns.
...
- Scoring weights: `truth=0.26, execution=0.27, safety=0.26, impact=0.22`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 62
  - `review_risk`: risk >= 59
...
1. Incident recovery in Community Engagement and Feedback: ingest noisy signals, execute pattern-to-playbook synthesis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Community Incident Playbook Synthesizer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
