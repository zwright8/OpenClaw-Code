...
## When To Use
Use this skill only when the request explicitly needs `Oversight Uncertainty Communicator` in Human Oversight and Operator UX and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Oversight Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Human Oversight and Operator UX workflows**
   - Input: noisy upstream payload requiring oversight uncertainty communicator normalization/assessment.
