...
description: Build and operate the "Research Tool Health Monitor" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Research Tool Health Monitor" outcomes in the Scientific Research Systems domain.
...
## Handoff Contract
- Produces: Research Tool Health Monitor normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Research Tool Health Monitor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Scientific Research Systems**
   - Input: noisy upstream payload requiring research tool health monitor normalization/assessment.
