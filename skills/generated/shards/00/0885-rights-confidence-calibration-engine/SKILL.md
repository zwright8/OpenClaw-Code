...
## Metadata
- **Skill ID:** `885`
- **Skill Name:** `u0885-rights-confidence-calibration-engine`
...
4. Keep routing aligned with `legal-rights-and-compliance:optimization-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Rights Confidence Calibration Engine normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `requirements mappings`, `legal decisions`, `evidence trails`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to legal-rights-and-compliance:optimization-engine consumers with approval-gate context
