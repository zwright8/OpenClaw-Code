...
## Handoff Contract
- Produces: PublicService Skill Gap Diagnoser normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Skill Gap Diagnoser** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice skill gap diagnoser normalization/assessment.
