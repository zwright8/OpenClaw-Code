...
## Handoff Contract
- Produces: PublicService Plan Quality Evaluator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Plan Quality Evaluator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice plan quality evaluator normalization/assessment.
