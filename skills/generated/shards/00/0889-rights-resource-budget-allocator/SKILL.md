...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Resource Budget Allocator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights resource budget allocator normalization/assessment.
