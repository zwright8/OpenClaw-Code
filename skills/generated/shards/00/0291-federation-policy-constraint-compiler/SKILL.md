...
description: Operate the "Federation Policy Constraint Compiler" capability in production for the target domain workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill only when the request explicitly needs `Federation Policy Constraint Compiler` in the target domain and a downstream consumer requires contract-bound artifacts.
