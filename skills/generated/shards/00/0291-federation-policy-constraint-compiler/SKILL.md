...
description: Operate the "Federation Policy Constraint Compiler" capability in production for Federation and Interoperability workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `291`
- **Skill Name:** `u0291-federation-policy-constraint-compiler`
...
4. Keep routing aligned with `federation-and-interoperability:contract-compiler` and include approval context.
...
### Handoff Contract
- **Produces:** `Federation Policy Constraint Compiler normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `envelopes`, `tenant boundaries`, `protocol bridges`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to federation-and-interoperability:contract-compiler consumers with approval-gate context
