...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Explainability Narrative Builder** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice explainability narrative builder normalization/assessment.
