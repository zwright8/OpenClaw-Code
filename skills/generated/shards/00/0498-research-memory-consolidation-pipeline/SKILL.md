...
description: Run the Research Memory Consolidation Pipeline capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0498_research-memory-consolidation-pi` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Research Memory Consolidation Pipeline (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Memory Consolidation Pipeline.
...
## Operator Use Cases
- Operate Research Memory Consolidation Pipeline as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 75):** release artifacts after validation pass and route to `scientific-research-systems:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Memory Consolidation Pipeline`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.27, execution=0.20, safety=0.24, impact=0.29`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 61
  - `review_risk`: risk >= 46
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute episodic-to-semantic consolidation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Memory Consolidation Pipeline against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
