...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Compliance Evidence Mapper** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability compliance evidence mapper normalization/assessment.
