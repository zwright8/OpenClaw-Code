---
name: u0174-governance-tool-health-monitor
description: Run the Governance Tool Health Monitor capability for Safety and Governance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Governance Tool Health Monitor
...
| Feature flag | `skill_0174_governance-tool-health-monitor` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because high-speed autonomy needs enforceable guardrails to stay aligned. This specific skill detects tool flakiness before it impacts mission outcomes.

## Trigger Checklist
- [ ] The task explicitly needs Governance Tool Health Monitor (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Governance Tool Health Monitor.
...
## Operator Use Cases
- Operate Governance Tool Health Monitor as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `safety-and-governance:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Governance Tool Health Monitor`, including at least three measurable KPIs tied to unsafe actions and policy drift.
...
- Scoring weights: `truth=0.26, execution=0.31, safety=0.16, impact=0.27`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 51
  - `review_risk`: risk >= 45
...
1. Incident recovery in Safety and Governance: ingest noisy signals, execute telemetry aggregation and SLO checks, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Governance Tool Health Monitor against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
