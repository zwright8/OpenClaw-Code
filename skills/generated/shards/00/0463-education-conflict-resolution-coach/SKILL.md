...
description: Build and operate the "Education Conflict Resolution Coach" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Conflict Resolution Coach" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Conflict Resolution Coach normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Conflict Resolution Coach** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education conflict resolution coach normalization/assessment.
