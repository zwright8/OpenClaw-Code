...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering kpi dashboard publisher normalization/assessment.
