...
description: Run the Memory Cost-Benefit Forecaster capability for Memory and Knowledge Operations with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0113_memory-cost-benefit-forecaster` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Memory Cost-Benefit Forecaster (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Memory Cost-Benefit Forecaster.
...
## Operator Use Cases
- Operate Memory Cost-Benefit Forecaster as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `memory-and-knowledge-operations:simulation-lab`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Memory Cost-Benefit Forecaster`, including at least three measurable KPIs tied to repeated mistakes and context loss.
...
- Scoring weights: `truth=0.19, execution=0.13, safety=0.37, impact=0.31`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 59
  - `review_risk`: risk >= 61
...
1. Incident recovery in Memory and Knowledge Operations: ingest noisy signals, execute cost-impact simulation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Memory Cost-Benefit Forecaster against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
