...
description: Operate the "Observability Evidence Provenance Tracker" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `563`
- **Skill Name:** `u0563-observability-evidence-provenance-tracker`
...
4. Keep routing aligned with `data-quality-and-observability:provenance-tracker` and include approval context.
...
- **Downstream Hint:** Route next to data-quality-and-observability:provenance-tracker consumers with approval-gate context
