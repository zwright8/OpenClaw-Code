...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Evidence Provenance Tracker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability evidence provenance tracker normalization/assessment.
