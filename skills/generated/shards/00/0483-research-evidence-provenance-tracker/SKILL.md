...
## Metadata
- **Skill ID:** `483`
- **Skill Name:** `u0483-research-evidence-provenance-tracker`
...
4. Keep routing aligned with `scientific-research-systems:provenance-tracker` and include approval context.
...
- **Downstream Hint:** Route next to scientific-research-systems:provenance-tracker consumers with approval-gate context
