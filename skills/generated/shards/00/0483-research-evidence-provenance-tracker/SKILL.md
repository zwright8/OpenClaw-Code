...
description: Run the Research Evidence Provenance Tracker capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0483_research-evidence-provenance-tra` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Research Evidence Provenance Tracker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Evidence Provenance Tracker.
...
## Operator Use Cases
- Operate Research Evidence Provenance Tracker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `scientific-research-systems:provenance-tracker`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Evidence Provenance Tracker`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.26, execution=0.21, safety=0.24, impact=0.29`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 44
  - `review_risk`: risk >= 38
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute signed provenance links, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Evidence Provenance Tracker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
3. Pre-deployment gate: validate artifacts for scientific-research-systems:provenance-tracker, enforce approvals, then handoff to downstream orchestrator with next actions.
...
- **Downstream hint:** route only to `scientific-research-systems:provenance-tracker` consumers with approval context attached.
