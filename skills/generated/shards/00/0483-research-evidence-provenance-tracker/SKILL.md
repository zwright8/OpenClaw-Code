...
## Trigger Checklist
- [ ] The request explicitly needs **Research Evidence Provenance Tracker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Scientific Research Systems**
   - Input: noisy upstream payload requiring research evidence provenance tracker normalization/assessment.
