...
description: Run the Community Uncertainty Communicator capability for Community Engagement and Feedback with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0865_community-uncertainty-communicat` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Community Uncertainty Communicator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Community Uncertainty Communicator.
...
## Operator Use Cases
- Operate Community Uncertainty Communicator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Community Uncertainty Communicator`, including at least three measurable KPIs tied to community trust loss and unaddressed concerns.
...
- Scoring weights: `truth=0.15, execution=0.25, safety=0.17, impact=0.44`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 61
  - `review_risk`: risk >= 57
...
1. Incident recovery in Community Engagement and Feedback: ingest noisy signals, execute confidence-bound communication templates, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Community Uncertainty Communicator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
