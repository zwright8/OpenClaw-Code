...
## Trigger Checklist
- [ ] The request explicitly needs **Community Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community uncertainty communicator normalization/assessment.
