---
name: u0242-collab-context-window-prioritizer
description: Run the Collab Context Window Prioritizer capability for Collaboration and Negotiation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Collab Context Window Prioritizer
...
| Feature flag | `skill_0242_collab-context-window-prioritize` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because multi-agent systems underperform without explicit conflict resolution. This specific skill surfaces the most decision-relevant context under tight token budgets.

## Trigger Checklist
- [ ] The task explicitly needs Collab Context Window Prioritizer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Collab Context Window Prioritizer.
...
## Operator Use Cases
- Operate Collab Context Window Prioritizer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `collaboration-and-negotiation:planning-router`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Collab Context Window Prioritizer`, including at least three measurable KPIs tied to deadlocks and degraded trust.
...
- Scoring weights: `truth=0.27, execution=0.15, safety=0.26, impact=0.32`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 59
  - `review_risk`: risk >= 55
...
1. Incident recovery in Collaboration and Negotiation: ingest noisy signals, execute importance scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Collab Context Window Prioritizer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
