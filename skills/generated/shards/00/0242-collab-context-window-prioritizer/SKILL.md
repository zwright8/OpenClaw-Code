...
description: Operate the "Collab Context Window Prioritizer" capability in production for Human Oversight and Operator UX workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `242`
- **Skill Name:** `u0242-collab-context-window-prioritizer`
...
4. Keep routing aligned with `collaboration-and-negotiation:planning-router` and include approval context.
...
### Handoff Contract
- **Produces:** `Collab Context Window Prioritizer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `proposals`, `contention signals`, `negotiated outcomes`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to collaboration-and-negotiation:planning-router consumers with approval-gate context
