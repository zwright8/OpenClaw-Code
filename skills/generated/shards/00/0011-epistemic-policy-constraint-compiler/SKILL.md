...
description: Build and operate the "Epistemic Policy Constraint Compiler" capability for Truth-Seeking and Epistemics. Use when outcomes in this capability family are required for production execution.
---
...
## When To Use
Use this skill when you need "Epistemic Policy Constraint Compiler" outcomes for the Truth-Seeking and Epistemics domain with measurable, production-facing outputs.
...
## Trigger Checklist
- [ ] The request explicitly needs **Epistemic Policy Constraint Compiler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Truth-Seeking and Epistemics**
   - Input: noisy upstream payload requiring epistemic policy constraint compiler normalization/assessment.
