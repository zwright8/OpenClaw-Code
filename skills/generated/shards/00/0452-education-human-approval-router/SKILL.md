...
description: Build and operate the "Education Human Approval Router" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Human Approval Router" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Human Approval Router normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Human Approval Router** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education human approval router normalization/assessment.
