...
## Metadata
- **Skill ID:** `232`
- **Skill Name:** `u0232-oversight-compliance-evidence-mapper`
...
### Handoff Contract
- **Produces:** `Oversight Compliance Evidence Mapper normalized artifacts`, `execution scorecard`, `risk posture`
