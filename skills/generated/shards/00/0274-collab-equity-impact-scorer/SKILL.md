---
name: u0274-collab-equity-impact-scorer
description: Run the Collab Equity Impact Scorer capability for Collaboration and Negotiation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Collab Equity Impact Scorer
...
| Feature flag | `skill_0274_collab-equity-impact-scorer` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because multi-agent systems underperform without explicit conflict resolution. This specific skill exposes uneven benefit/harm distribution before rollout.

## Trigger Checklist
- [ ] The task explicitly needs Collab Equity Impact Scorer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Collab Equity Impact Scorer.
...
## Operator Use Cases
- Operate Collab Equity Impact Scorer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Collab Equity Impact Scorer`, including at least three measurable KPIs tied to deadlocks and degraded trust.
...
- Scoring weights: `truth=0.28, execution=0.27, safety=0.27, impact=0.18`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 57
  - `review_risk`: risk >= 58
...
1. Incident recovery in Collaboration and Negotiation: ingest noisy signals, execute group-level impact scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Collab Equity Impact Scorer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
