...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Experiment Design Generator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights experiment design generator normalization/assessment.
