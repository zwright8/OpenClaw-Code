...
description: Run the Rights Experiment Design Generator capability for Legal, Rights, and Compliance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0906_rights-experiment-design-generat` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Rights Experiment Design Generator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Rights Experiment Design Generator.
...
## Operator Use Cases
- Operate Rights Experiment Design Generator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Rights Experiment Design Generator`, including at least three measurable KPIs tied to rights violations and compliance penalties.
...
- Scoring weights: `truth=0.23, execution=0.21, safety=0.21, impact=0.36`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 50
  - `review_risk`: risk >= 43
...
1. Incident recovery in Legal, Rights, and Compliance: ingest noisy signals, execute hypothesis-driven design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Rights Experiment Design Generator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
