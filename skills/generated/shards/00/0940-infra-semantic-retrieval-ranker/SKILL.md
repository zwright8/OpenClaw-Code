...
## When To Use
Use this skill when the request explicitly needs "Infra Semantic Retrieval Ranker" outcomes in the Infrastructure and Sustainability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Semantic Retrieval Ranker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra semantic retrieval ranker normalization/assessment.
