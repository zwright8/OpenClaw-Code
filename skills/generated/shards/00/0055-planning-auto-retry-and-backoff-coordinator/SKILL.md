...
description: Build and operate the "Planning Auto-Retry and Backoff Coordinator" capability for Strategic Planning and Decomposition. Use when outcomes in this capability family are required for production execution.
---
...
## When To Use
Use this skill when you need "Planning Auto-Retry and Backoff Coordinator" outcomes for the Strategic Planning and Decomposition domain with measurable, production-facing outputs.
...
## Handoff Contract
- Produces: Planning Auto-Retry and Backoff Coordinator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Planning Auto-Retry and Backoff Coordinator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Strategic Planning and Decomposition**
   - Input: noisy upstream payload requiring planning auto-retry and backoff coordinator normalization/assessment.
