---
name: u0055-planning-auto-retry-and-backoff-coordinator
description: Run the Planning Auto-Retry and Backoff Coordinator capability for Strategic Planning and Decomposition with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Planning Auto-Retry and Backoff Coordinator
...
| Feature flag | `skill_0055_planning-auto-retry-and-backoff-` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because large goals fail when decomposition is inconsistent or incomplete. This specific skill improves success rates while preventing retry storms.

## Trigger Checklist
- [ ] The task explicitly needs Planning Auto-Retry and Backoff Coordinator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Planning Auto-Retry and Backoff Coordinator.
...
## Operator Use Cases
- Operate Planning Auto-Retry and Backoff Coordinator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 74):** release artifacts after validation pass and route to `strategic-planning-and-decomposition:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Planning Auto-Retry and Backoff Coordinator`, including at least three measurable KPIs tied to execution stalls and hidden dependency failures.
...
- Scoring weights: `truth=0.30, execution=0.33, safety=0.20, impact=0.17`
- Posture thresholds:
  - `ready`: score >= 74
  - `review`: score >= 61
  - `review_risk`: risk >= 61
...
1. Incident recovery in Strategic Planning and Decomposition: ingest noisy signals, execute adaptive backoff control, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Planning Auto-Retry and Backoff Coordinator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
