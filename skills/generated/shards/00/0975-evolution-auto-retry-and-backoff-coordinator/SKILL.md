---
name: u0975-evolution-auto-retry-and-backoff-coordinator
description: Run the Evolution Auto-Retry and Backoff Coordinator capability for Autonomous Learning and Evolution with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Evolution Auto-Retry and Backoff Coordinator
...
| Feature flag | `skill_0975_evolution-auto-retry-and-backoff` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents stagnate without structured reflection and continuous improvement loops. This specific skill improves success rates while preventing retry storms.

## Trigger Checklist
- [ ] The task explicitly needs Evolution Auto-Retry and Backoff Coordinator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Evolution Auto-Retry and Backoff Coordinator.
...
## Operator Use Cases
- Operate Evolution Auto-Retry and Backoff Coordinator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 72):** release artifacts after validation pass and route to `autonomous-learning-and-evolution:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Evolution Auto-Retry and Backoff Coordinator`, including at least three measurable KPIs tied to capability stagnation and repeated blind spots.
...
- Scoring weights: `truth=0.28, execution=0.18, safety=0.31, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 50
  - `review_risk`: risk >= 32
...
1. Incident recovery in Autonomous Learning and Evolution: ingest noisy signals, execute adaptive backoff control, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Evolution Auto-Retry and Backoff Coordinator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
