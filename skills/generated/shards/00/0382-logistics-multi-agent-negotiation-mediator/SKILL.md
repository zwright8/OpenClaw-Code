...
description: Run the Logistics Multi-Agent Negotiation Mediator capability for Resource Allocation and Logistics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0382_logistics-multi-agent-negotiatio` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Logistics Multi-Agent Negotiation Mediator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Logistics Multi-Agent Negotiation Mediator.
...
## Operator Use Cases
- Operate Logistics Multi-Agent Negotiation Mediator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 75):** release artifacts after validation pass and route to `resource-allocation-and-logistics:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Logistics Multi-Agent Negotiation Mediator`, including at least three measurable KPIs tied to supply shortfalls and fairness gaps.
...
- Scoring weights: `truth=0.30, execution=0.39, safety=0.12, impact=0.18`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 45
  - `review_risk`: risk >= 33
...
1. Incident recovery in Resource Allocation and Logistics: ingest noisy signals, execute structured bargaining protocols, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Logistics Multi-Agent Negotiation Mediator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
