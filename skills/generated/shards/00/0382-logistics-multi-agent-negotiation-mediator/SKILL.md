...
## Metadata
- **Skill ID:** `382`
- **Skill Name:** `u0382-logistics-multi-agent-negotiation-mediator`
...
### Handoff Contract
- **Produces:** `Logistics Multi-Agent Negotiation Mediator normalized artifacts`, `execution scorecard`, `risk posture`
