...
description: Build and operate the "Education Disaster Recovery Orchestrator" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Disaster Recovery Orchestrator" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Disaster Recovery Orchestrator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Disaster Recovery Orchestrator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education disaster recovery orchestrator normalization/assessment.
