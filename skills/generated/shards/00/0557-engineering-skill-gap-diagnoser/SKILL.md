...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Skill Gap Diagnoser** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering skill gap diagnoser normalization/assessment.
