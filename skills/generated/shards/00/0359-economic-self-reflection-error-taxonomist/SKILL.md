---
name: u0359-economic-self-reflection-error-taxonomist
description: Run the Economic Self-Reflection Error Taxonomist capability for Economic Optimization with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Economic Self-Reflection Error Taxonomist
...
| Feature flag | `skill_0359_economic-self-reflection-error-t` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need explicit tradeoff logic for cost, speed, and impact. This specific skill classifies recurrent reasoning failures for targeted fixes.

## Trigger Checklist
- [ ] The task explicitly needs Economic Self-Reflection Error Taxonomist (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Economic Self-Reflection Error Taxonomist.
...
## Operator Use Cases
- Operate Economic Self-Reflection Error Taxonomist as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Economic Self-Reflection Error Taxonomist`, including at least three measurable KPIs tied to overspending and low-impact allocation.
...
- Scoring weights: `truth=0.28, execution=0.16, safety=0.27, impact=0.29`
- Posture thresholds:
  - `ready`: score >= 71
  - `review`: score >= 44
  - `review_risk`: risk >= 44
...
1. Incident recovery in Economic Optimization: ingest noisy signals, execute failure-type clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Economic Self-Reflection Error Taxonomist against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
