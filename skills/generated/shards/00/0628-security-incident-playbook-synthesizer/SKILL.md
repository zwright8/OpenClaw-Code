...
## When To Use
Use this skill when the request explicitly needs "Security Incident Playbook Synthesizer" outcomes in the Security and Privacy domain.
...
## Handoff Contract
- Produces: Security Incident Playbook Synthesizer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Security Incident Playbook Synthesizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security incident playbook synthesizer normalization/assessment.
