...
description: Build and operate the "Planning Tool Health Monitor" capability for Strategic Planning and Decomposition. Use when outcomes in this capability family are required for production execution.
---
...
## When To Use
Use this skill when you need "Planning Tool Health Monitor" outcomes for the Strategic Planning and Decomposition domain with measurable, production-facing outputs.
...
## Handoff Contract
- Produces: Planning Tool Health Monitor normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Planning Tool Health Monitor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Strategic Planning and Decomposition**
   - Input: noisy upstream payload requiring planning tool health monitor normalization/assessment.
