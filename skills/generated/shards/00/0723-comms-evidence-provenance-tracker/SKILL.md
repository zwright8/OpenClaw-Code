...
## When To Use
Use this skill when the request explicitly needs "Comms Evidence Provenance Tracker" outcomes in the Communication and Explainability domain.
...
## Handoff Contract
- Produces: Comms Evidence Provenance Tracker normalized artifacts; execution scorecard; risk posture
- Consumes: decision factors; uncertainty markers; audience summaries; claims; evidence; confidence traces
- Downstream routing hint: Route next to communication-and-explainability:provenance-tracker consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Comms Evidence Provenance Tracker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms evidence provenance tracker normalization/assessment.
