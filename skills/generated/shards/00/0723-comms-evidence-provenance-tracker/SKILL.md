...
## Metadata
- **Skill ID:** `723`
- **Skill Name:** `u0723-comms-evidence-provenance-tracker`
...
4. Keep routing aligned with `communication-and-explainability:provenance-tracker` and include approval context.
...
- **Downstream Hint:** Route next to communication-and-explainability:provenance-tracker consumers with approval-gate context
