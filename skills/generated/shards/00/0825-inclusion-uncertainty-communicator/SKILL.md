...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion uncertainty communicator normalization/assessment.
