...
description: Build and operate the "Epistemic Counterfactual Simulator" capability for Truth-Seeking and Epistemics. Use when outcomes in this capability family are required for production execution.
---
...
## Metadata
- **Skill ID:** `6`
- **Skill Name:** `u0006-epistemic-counterfactual-simulator`
...
4. Keep routing aligned with `truth-seeking-and-epistemics:simulation-lab` and include approval context.
...
### Handoff Contract
- **Produces:** `Epistemic Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to truth-seeking-and-epistemics:simulation-lab consumers with approval-gate context
