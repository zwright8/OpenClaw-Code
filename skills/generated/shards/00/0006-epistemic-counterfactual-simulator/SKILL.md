...
## When To Use
Use this skill when you need "Epistemic Counterfactual Simulator" outcomes for the Truth-Seeking and Epistemics domain with measurable, production-facing outputs.
...
- Downstream routing hint: Route next to truth-seeking-and-epistemics:simulation-lab consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Epistemic Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Truth-Seeking and Epistemics**
   - Input: noisy upstream payload requiring epistemic counterfactual simulator normalization/assessment.
