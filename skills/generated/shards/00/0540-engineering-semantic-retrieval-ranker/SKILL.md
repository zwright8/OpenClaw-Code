...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Semantic Retrieval Ranker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering semantic retrieval ranker normalization/assessment.
