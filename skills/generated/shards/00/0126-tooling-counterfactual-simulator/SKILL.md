...
description: Build and operate the "Tooling Counterfactual Simulator" capability for Tool Reliability and Execution Quality. Use when outcomes in this capability family are required for production execution.
---
...
## Metadata
- **Skill ID:** `126`
- **Skill Name:** `u0126-tooling-counterfactual-simulator`
...
4. Keep routing aligned with `tool-reliability-and-execution-quality:simulation-lab` and include approval context.
...
### Handoff Contract
- **Produces:** `Tooling Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `tool runs`, `error signatures`, `retry outcomes`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to tool-reliability-and-execution-quality:simulation-lab consumers with approval-gate context
