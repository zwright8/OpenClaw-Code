...
- The task explicitly requires `u0126-tooling-counterfactual-simulator` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
