...
- The task explicitly requires `u0135-tooling-auto-retry-and-backoff-coordinator` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
