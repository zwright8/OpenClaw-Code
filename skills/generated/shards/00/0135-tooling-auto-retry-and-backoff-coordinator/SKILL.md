...
## Metadata
- **Skill ID:** `135`
- **Skill Name:** `u0135-tooling-auto-retry-and-backoff-coordinator`
...
### Handoff Contract
- **Produces:** `Tooling Auto-Retry and Backoff Coordinator normalized artifacts`, `execution scorecard`, `risk posture`
