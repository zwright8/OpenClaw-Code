...
description: Run the Tooling Auto-Retry and Backoff Coordinator capability for Tool Reliability and Execution Quality with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0135_tooling-auto-retry-and-backoff-c` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Tooling Auto-Retry and Backoff Coordinator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Tooling Auto-Retry and Backoff Coordinator.
...
## Operator Use Cases
- Operate Tooling Auto-Retry and Backoff Coordinator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 71):** release artifacts after validation pass and route to `tool-reliability-and-execution-quality:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Tooling Auto-Retry and Backoff Coordinator`, including at least three measurable KPIs tied to silent failures and cascading retries.
...
- Scoring weights: `truth=0.15, execution=0.27, safety=0.28, impact=0.31`
- Posture thresholds:
  - `ready`: score >= 71
  - `review`: score >= 47
  - `review_risk`: risk >= 40
...
1. Incident recovery in Tool Reliability and Execution Quality: ingest noisy signals, execute adaptive backoff control, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Tooling Auto-Retry and Backoff Coordinator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
