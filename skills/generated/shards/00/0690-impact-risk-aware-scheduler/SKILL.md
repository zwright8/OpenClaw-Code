...
## When To Use
Use this skill when the request explicitly needs "Impact Risk-Aware Scheduler" outcomes in the Social Impact Measurement domain.
...
## Handoff Contract
- Produces: Impact Risk-Aware Scheduler normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Impact Risk-Aware Scheduler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring impact risk-aware scheduler normalization/assessment.
