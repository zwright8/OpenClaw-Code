...
description: Operate the "Impact Training Curriculum Composer" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `718`
- **Skill Name:** `u0718-impact-training-curriculum-composer`
...
4. Keep routing aligned with `social-impact-measurement:general-capability` and include approval context.
...
### Handoff Contract
- **Produces:** `Impact Training Curriculum Composer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `community outcomes`, `kpi trends`, `intervention deltas`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to social-impact-measurement:general-capability consumers with approval-gate context
