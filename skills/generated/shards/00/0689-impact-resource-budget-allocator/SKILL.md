...
## When To Use
Use this skill when the request explicitly needs "Impact Resource Budget Allocator" outcomes in the Social Impact Measurement domain.
...
## Handoff Contract
- Produces: Impact Resource Budget Allocator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Impact Resource Budget Allocator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring impact resource budget allocator normalization/assessment.
