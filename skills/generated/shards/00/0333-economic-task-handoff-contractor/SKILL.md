...
description: Build and operate the "Economic Task Handoff Contractor" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Task Handoff Contractor" outcomes in the Economic Optimization domain.
...
- Downstream routing hint: Route next to economic-optimization:contract-compiler consumers with approval-gate context
