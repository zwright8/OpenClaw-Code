...
## Metadata
- **Skill ID:** `333`
- **Skill Name:** `u0333-economic-task-handoff-contractor`
...
4. Keep routing aligned with `economic-optimization:contract-compiler` and include approval context.
...
### Handoff Contract
- **Produces:** `Economic Task Handoff Contractor normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `budgets`, `costs`, `benefits`, `opportunity values`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to economic-optimization:contract-compiler consumers with approval-gate context
