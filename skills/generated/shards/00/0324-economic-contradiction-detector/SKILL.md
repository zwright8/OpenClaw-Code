...
description: Operate the "Economic Contradiction Detector" capability in production for Economic Optimization workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---

# Economic Contradiction Detector

## Why This Skill Exists
This skill hardens a generated capability for production execution so economic optimization workflows remain deterministic, auditable, and fail-closed under risk.

## When To Use
Use this skill only when the request explicitly needs `Economic Contradiction Detector` in Economic Optimization and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Economic Contradiction Detector** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **Economic Optimization workflows** with measurable acceptance criteria.
...
- **Daily:** Run when new economic optimization workflows signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in Economic Optimization workflows**
   - Input: noisy upstream payload requiring economic contradiction detector normalization/assessment.
