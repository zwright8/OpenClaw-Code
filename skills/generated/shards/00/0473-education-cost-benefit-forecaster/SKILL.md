...
description: Build and operate the "Education Cost-Benefit Forecaster" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Cost-Benefit Forecaster" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Cost-Benefit Forecaster normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Cost-Benefit Forecaster** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education cost-benefit forecaster normalization/assessment.
