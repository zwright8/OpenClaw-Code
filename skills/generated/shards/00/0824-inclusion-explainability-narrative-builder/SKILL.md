...
## When To Use
Use this skill when the request explicitly needs "Inclusion Explainability Narrative Builder" outcomes in the Accessibility and Inclusion domain.
...
- Downstream routing hint: Route next to accessibility-and-inclusion:communication-engine consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Explainability Narrative Builder** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion explainability narrative builder normalization/assessment.
