---
name: u0824-inclusion-explainability-narrative-builder
description: Run the Inclusion Explainability Narrative Builder capability for Accessibility and Inclusion with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Inclusion Explainability Narrative Builder
...
| Feature flag | `skill_0824_inclusion-explainability-narrati` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because systems must be operable and understandable for diverse users. This specific skill translates technical decisions into operator-usable narratives.

## Trigger Checklist
- [ ] The task explicitly needs Inclusion Explainability Narrative Builder (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Inclusion Explainability Narrative Builder.
...
## Operator Use Cases
- Operate Inclusion Explainability Narrative Builder as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `accessibility-and-inclusion:communication-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Inclusion Explainability Narrative Builder`, including at least three measurable KPIs tied to barriers for disabled and underserved groups.
...
- Scoring weights: `truth=0.22, execution=0.30, safety=0.32, impact=0.17`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 54
  - `review_risk`: risk >= 59
...
1. Incident recovery in Accessibility and Inclusion: ingest noisy signals, execute reason synthesis and abstraction, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Inclusion Explainability Narrative Builder against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
