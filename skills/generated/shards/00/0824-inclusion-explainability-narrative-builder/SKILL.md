...
description: Operate the "Inclusion Explainability Narrative Builder" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `824`
- **Skill Name:** `u0824-inclusion-explainability-narrative-builder`
...
4. Keep routing aligned with `accessibility-and-inclusion:communication-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Inclusion Explainability Narrative Builder normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `accessibility audits`, `accommodations`, `usability feedback`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to accessibility-and-inclusion:communication-engine consumers with approval-gate context
