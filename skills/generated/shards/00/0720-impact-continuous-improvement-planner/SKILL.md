...
## Trigger Checklist
- [ ] The request explicitly needs **Impact Continuous Improvement Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring impact continuous improvement planner normalization/assessment.
