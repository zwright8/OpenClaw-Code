...
- The task explicitly requires `u0136-tooling-failure-root-cause-miner` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
