...
## Metadata
- **Skill ID:** `643`
- **Skill Name:** `u0643-crisis-evidence-provenance-tracker`
...
4. Keep routing aligned with `crisis-and-incident-response:provenance-tracker` and include approval context.
...
### Handoff Contract
- **Produces:** `Crisis Evidence Provenance Tracker normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `incident timelines`, `response roles`, `recovery artifacts`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to crisis-and-incident-response:provenance-tracker consumers with approval-gate context
