...
description: Operate the "Infra Context Window Prioritizer" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `922`
- **Skill Name:** `u0922-infra-context-window-prioritizer`
...
4. Keep routing aligned with `infrastructure-and-sustainability:planning-router` and include approval context.
...
### Handoff Contract
- **Produces:** `Infra Context Window Prioritizer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `capacity forecasts`, `energy usage`, `sustainability metrics`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to infrastructure-and-sustainability:planning-router consumers with approval-gate context
