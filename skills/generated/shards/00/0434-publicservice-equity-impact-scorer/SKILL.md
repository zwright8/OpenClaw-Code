...
description: Build and operate the "PublicService Equity Impact Scorer" capability for Healthcare and Public Services. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "PublicService Equity Impact Scorer" outcomes in the Healthcare and Public Services domain.
...
## Handoff Contract
- Produces: PublicService Equity Impact Scorer normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Equity Impact Scorer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice equity impact scorer normalization/assessment.
