...
## When To Use
Use this skill when the request explicitly needs "Crisis Failure Root-Cause Miner" outcomes in the Crisis and Incident Response domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Failure Root-Cause Miner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis failure root-cause miner normalization/assessment.
