...
## Metadata
- **Skill ID:** `462`
- **Skill Name:** `u0462-education-multi-agent-negotiation-mediator`
...
4. Keep routing aligned with `education-and-upskilling:collaboration-mediator` and include approval context.
...
- **Downstream Hint:** Route next to education-and-upskilling:collaboration-mediator consumers with approval-gate context
