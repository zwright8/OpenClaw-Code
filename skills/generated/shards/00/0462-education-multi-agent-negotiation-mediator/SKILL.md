---
name: u0462-education-multi-agent-negotiation-mediator
description: Run the Education Multi-Agent Negotiation Mediator capability for Education and Upskilling with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Education Multi-Agent Negotiation Mediator
...
| Feature flag | `skill_0462_education-multi-agent-negotiatio` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because human capability growth requires targeted planning under constraints. This specific skill resolves resource and strategy conflicts with explicit tradeoffs.

## Trigger Checklist
- [ ] The task explicitly needs Education Multi-Agent Negotiation Mediator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Education Multi-Agent Negotiation Mediator.
...
## Operator Use Cases
- Operate Education Multi-Agent Negotiation Mediator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 75):** release artifacts after validation pass and route to `education-and-upskilling:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Education Multi-Agent Negotiation Mediator`, including at least three measurable KPIs tied to persistent skill gaps and poor learning outcomes.
...
- Scoring weights: `truth=0.21, execution=0.23, safety=0.33, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 61
  - `review_risk`: risk >= 50
...
1. Incident recovery in Education and Upskilling: ingest noisy signals, execute structured bargaining protocols, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Education Multi-Agent Negotiation Mediator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
