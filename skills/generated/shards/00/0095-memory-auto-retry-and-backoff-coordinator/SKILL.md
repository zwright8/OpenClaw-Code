---
name: u0095-memory-auto-retry-and-backoff-coordinator
description: Run the Memory Auto-Retry and Backoff Coordinator capability for Memory and Knowledge Operations with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Memory Auto-Retry and Backoff Coordinator
...
| Feature flag | `skill_0095_memory-auto-retry-and-backoff-co` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents lose performance when lessons are not retained and reused. This specific skill improves success rates while preventing retry storms.

## Trigger Checklist
- [ ] The task explicitly needs Memory Auto-Retry and Backoff Coordinator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Memory Auto-Retry and Backoff Coordinator.
...
## Operator Use Cases
- Operate Memory Auto-Retry and Backoff Coordinator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Memory Auto-Retry and Backoff Coordinator`, including at least three measurable KPIs tied to repeated mistakes and context loss.
...
- Scoring weights: `truth=0.16, execution=0.32, safety=0.15, impact=0.37`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 47
  - `review_risk`: risk >= 44
...
1. Incident recovery in Memory and Knowledge Operations: ingest noisy signals, execute adaptive backoff control, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Memory Auto-Retry and Backoff Coordinator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
