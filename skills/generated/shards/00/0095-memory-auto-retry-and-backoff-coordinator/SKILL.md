...
## Metadata
- **Skill ID:** `95`
- **Skill Name:** `u0095-memory-auto-retry-and-backoff-coordinator`
...
### Handoff Contract
- **Produces:** `Memory Auto-Retry and Backoff Coordinator normalized artifacts`, `execution scorecard`, `risk posture`
