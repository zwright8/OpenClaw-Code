...
## When To Use
Use this skill when the request explicitly needs "Inclusion A/B Rollout Governor" outcomes in the Accessibility and Inclusion domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion A/B Rollout Governor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion a/b rollout governor normalization/assessment.
