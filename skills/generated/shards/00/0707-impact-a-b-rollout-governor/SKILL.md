---
name: u0707-impact-a-b-rollout-governor
description: Run the Impact A/B Rollout Governor capability for Social Impact Measurement with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Impact A/B Rollout Governor
...
| Feature flag | `skill_0707_impact-a-b-rollout-governor` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need measurable outcomes, not just activity volume. This specific skill controls production risk during behavioral changes.

## Trigger Checklist
- [ ] The task explicitly needs Impact A/B Rollout Governor (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Impact A/B Rollout Governor.
...
## Operator Use Cases
- Operate Impact A/B Rollout Governor as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Impact A/B Rollout Governor`, including at least three measurable KPIs tied to impact theater and unmeasured harm.
...
- Scoring weights: `truth=0.32, execution=0.16, safety=0.15, impact=0.37`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 59
  - `review_risk`: risk >= 55
...
1. Incident recovery in Social Impact Measurement: ingest noisy signals, execute staged rollout policies, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Impact A/B Rollout Governor against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
