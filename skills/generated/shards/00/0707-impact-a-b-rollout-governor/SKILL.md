...
## When To Use
Use this skill when the request explicitly needs "Impact A/B Rollout Governor" outcomes in the Social Impact Measurement domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Impact A/B Rollout Governor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring impact a/b rollout governor normalization/assessment.
