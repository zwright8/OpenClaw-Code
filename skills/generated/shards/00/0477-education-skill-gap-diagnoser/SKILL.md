---
name: u0477-education-skill-gap-diagnoser
description: Run the Education Skill Gap Diagnoser capability for Education and Upskilling with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Education Skill Gap Diagnoser
...
| Feature flag | `skill_0477_education-skill-gap-diagnoser` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because human capability growth requires targeted planning under constraints. This specific skill identifies where agents and humans need capability upgrades.

## Trigger Checklist
- [ ] The task explicitly needs Education Skill Gap Diagnoser (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Education Skill Gap Diagnoser.
...
## Operator Use Cases
- Operate Education Skill Gap Diagnoser as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Education Skill Gap Diagnoser`, including at least three measurable KPIs tied to persistent skill gaps and poor learning outcomes.
...
- Scoring weights: `truth=0.20, execution=0.24, safety=0.34, impact=0.22`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 60
  - `review_risk`: risk >= 53
...
1. Incident recovery in Education and Upskilling: ingest noisy signals, execute competency coverage analysis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Education Skill Gap Diagnoser against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
