---
name: u0666-crisis-experiment-design-generator
description: Run the Crisis Experiment Design Generator capability for Crisis and Incident Response with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Crisis Experiment Design Generator
...
| Feature flag | `skill_0666_crisis-experiment-design-generat` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because response quality determines whether incidents are contained or amplified. This specific skill converts unknowns into testable learning loops.

## Trigger Checklist
- [ ] The task explicitly needs Crisis Experiment Design Generator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Crisis Experiment Design Generator.
...
## Operator Use Cases
- Operate Crisis Experiment Design Generator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Crisis Experiment Design Generator`, including at least three measurable KPIs tied to slow containment and repeated outages.
...
- Scoring weights: `truth=0.19, execution=0.25, safety=0.29, impact=0.27`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 62
  - `review_risk`: risk >= 48
...
1. Incident recovery in Crisis and Incident Response: ingest noisy signals, execute hypothesis-driven design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Crisis Experiment Design Generator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
