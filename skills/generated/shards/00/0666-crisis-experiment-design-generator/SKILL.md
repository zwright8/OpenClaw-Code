...
## When To Use
Use this skill when the request explicitly needs "Crisis Experiment Design Generator" outcomes in the Crisis and Incident Response domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Experiment Design Generator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis experiment design generator normalization/assessment.
