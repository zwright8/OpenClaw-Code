...
## Metadata
- **Skill ID:** `724`
- **Skill Name:** `u0724-comms-contradiction-detector`
...
4. Keep routing aligned with `communication-and-explainability:detection-guard` and include approval context.
...
- **Downstream Hint:** Route next to communication-and-explainability:detection-guard consumers with approval-gate context
