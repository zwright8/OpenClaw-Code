...
## Trigger Checklist
- [ ] The request explicitly needs **Education Tool Health Monitor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education tool health monitor normalization/assessment.
