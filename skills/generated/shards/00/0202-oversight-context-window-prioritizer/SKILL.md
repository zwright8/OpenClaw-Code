...
## Metadata
- **Skill ID:** `202`
- **Skill Name:** `u0202-oversight-context-window-prioritizer`
...
### Handoff Contract
- **Produces:** `Oversight Context Window Prioritizer normalized artifacts`, `execution scorecard`, `risk posture`
