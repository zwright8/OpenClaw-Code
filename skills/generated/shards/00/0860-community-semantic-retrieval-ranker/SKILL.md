...
## Metadata
- **Skill ID:** `860`
- **Skill Name:** `u0860-community-semantic-retrieval-ranker`
...
### Handoff Contract
- **Produces:** `Community Semantic Retrieval Ranker normalized artifacts`, `execution scorecard`, `risk posture`
