...
description: Build and operate the "Planning Evidence Provenance Tracker" capability for Strategic Planning and Decomposition. Use when outcomes in this capability family are required for production execution.
---
...
## When To Use
Use this skill when you need "Planning Evidence Provenance Tracker" outcomes for the Strategic Planning and Decomposition domain with measurable, production-facing outputs.
...
## Handoff Contract
- Produces: Planning Evidence Provenance Tracker normalized artifacts; execution scorecard; risk posture
- Consumes: goals; dependencies; milestones; constraints; claims; evidence; confidence traces
- Downstream routing hint: Route next to strategic-planning-and-decomposition:provenance-tracker consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Planning Evidence Provenance Tracker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Strategic Planning and Decomposition**
   - Input: noisy upstream payload requiring planning evidence provenance tracker normalization/assessment.
