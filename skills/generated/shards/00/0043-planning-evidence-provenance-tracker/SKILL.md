...
## Metadata
- **Skill ID:** `43`
- **Skill Name:** `u0043-planning-evidence-provenance-tracker`
...
4. Keep routing aligned with `strategic-planning-and-decomposition:provenance-tracker` and include approval context.
...
- **Downstream Hint:** Route next to strategic-planning-and-decomposition:provenance-tracker consumers with approval-gate context
