...
## When To Use
Use this skill when the request explicitly needs "Crisis Cost-Benefit Forecaster" outcomes in the Crisis and Incident Response domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Cost-Benefit Forecaster** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis cost-benefit forecaster normalization/assessment.
