...
## Metadata
- **Skill ID:** `965`
- **Skill Name:** `u0965-evolution-confidence-calibration-engine`
...
4. Keep routing aligned with `autonomous-learning-and-evolution:optimization-engine` and include approval context.
...
- **Downstream Hint:** Route next to autonomous-learning-and-evolution:optimization-engine consumers with approval-gate context
