...
## Metadata
- **Skill ID:** `241`
- **Skill Name:** `u0241-collab-signal-ingestion-normalizer`
...
4. Keep routing aligned with `collaboration-and-negotiation:normalization-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Collab Signal Ingestion Normalizer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `proposals`, `contention signals`, `negotiated outcomes`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to collaboration-and-negotiation:normalization-engine consumers with approval-gate context
