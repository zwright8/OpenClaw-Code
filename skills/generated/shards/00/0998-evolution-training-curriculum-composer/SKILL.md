...
description: Operate the "Evolution Training Curriculum Composer" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `998`
- **Skill Name:** `u0998-evolution-training-curriculum-composer`
...
|---|---|---|---|
| role_specific_curricula_report | structured-report | true | orchestrator |
| role_specific_curricula_scorecard | scorecard | true | operator |

## Guidelines
1. Validate required inputs before execution and reject non-conforming payloads early.
2. Run `sequenced learning path design` with deterministic settings and trace capture enabled.
3. Produce `role-specific curricula` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `autonomous-learning-and-evolution:general-capability` and include approval context.
...
### Handoff Contract
- **Produces:** `Evolution Training Curriculum Composer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `outcomes`, `error taxonomies`, `adaptation decisions`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to autonomous-learning-and-evolution:general-capability consumers with approval-gate context
