---
name: u0998-evolution-training-curriculum-composer
description: Run the Evolution Training Curriculum Composer capability for Autonomous Learning and Evolution with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Evolution Training Curriculum Composer
...
| Feature flag | `skill_0998_evolution-training-curriculum-co` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents stagnate without structured reflection and continuous improvement loops. This specific skill converts capability gaps into actionable upskilling programs.

## Trigger Checklist
- [ ] The task explicitly needs Evolution Training Curriculum Composer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Evolution Training Curriculum Composer.
...
## Operator Use Cases
- Operate Evolution Training Curriculum Composer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 73):** release artifacts after validation pass and route to `autonomous-learning-and-evolution:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Evolution Training Curriculum Composer`, including at least three measurable KPIs tied to capability stagnation and repeated blind spots.
...
- Scoring weights: `truth=0.24, execution=0.25, safety=0.23, impact=0.27`
- Posture thresholds:
  - `ready`: score >= 73
  - `review`: score >= 50
  - `review_risk`: risk >= 31
...
1. Incident recovery in Autonomous Learning and Evolution: ingest noisy signals, execute sequenced learning path design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Evolution Training Curriculum Composer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
