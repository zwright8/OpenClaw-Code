...
description: Operate the "Cultural Resource Budget Allocator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Handoff Contract
- Produces: Cultural Resource Budget Allocator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Resource Budget Allocator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural resource budget allocator normalization/assessment.
