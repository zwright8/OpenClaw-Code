...
## When To Use
Use this skill when the request explicitly needs "Infra Security Threat Modeler" outcomes in the Infrastructure and Sustainability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Security Threat Modeler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra security threat modeler normalization/assessment.
