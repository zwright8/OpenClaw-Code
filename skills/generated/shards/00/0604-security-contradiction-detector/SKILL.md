...
## Trigger Checklist
- [ ] The request explicitly needs **Security Contradiction Detector** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security contradiction detector normalization/assessment.
