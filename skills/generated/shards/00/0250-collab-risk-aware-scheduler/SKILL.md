...
## When To Use
Use this skill only when the request explicitly needs `Collab Risk Aware Scheduler` in Human Oversight and Operator UX and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Collab Risk Aware Scheduler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Human Oversight and Operator UX workflows**
   - Input: noisy upstream payload requiring collab risk aware scheduler normalization/assessment.
