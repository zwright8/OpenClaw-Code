...
## Trigger Checklist
- [ ] The request explicitly needs **Inclusion Plan Quality Evaluator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring inclusion plan quality evaluator normalization/assessment.
