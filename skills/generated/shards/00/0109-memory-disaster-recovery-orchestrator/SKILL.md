---
name: u0109-memory-disaster-recovery-orchestrator
description: Run the Memory Disaster Recovery Orchestrator capability for Memory and Knowledge Operations with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Memory Disaster Recovery Orchestrator
...
| Feature flag | `skill_0109_memory-disaster-recovery-orchest` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents lose performance when lessons are not retained and reused. This specific skill improves recovery speed after severe outages.

## Trigger Checklist
- [ ] The task explicitly needs Memory Disaster Recovery Orchestrator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Memory Disaster Recovery Orchestrator.
...
## Operator Use Cases
- Operate Memory Disaster Recovery Orchestrator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Memory Disaster Recovery Orchestrator`, including at least three measurable KPIs tied to repeated mistakes and context loss.
...
- Scoring weights: `truth=0.19, execution=0.34, safety=0.24, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 48
  - `review_risk`: risk >= 36
...
1. Incident recovery in Memory and Knowledge Operations: ingest noisy signals, execute failover and restoration sequencing, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Memory Disaster Recovery Orchestrator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
