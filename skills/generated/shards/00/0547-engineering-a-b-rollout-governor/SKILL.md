...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering A/B Rollout Governor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering a/b rollout governor normalization/assessment.
