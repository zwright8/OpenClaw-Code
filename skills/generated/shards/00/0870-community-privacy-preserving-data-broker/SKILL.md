---
name: u0870-community-privacy-preserving-data-broker
description: Run the Community Privacy Preserving Data Broker capability for Community Engagement and Feedback with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Community Privacy Preserving Data Broker
...
| Feature flag | `skill_0870_community-privacy-preserving-dat` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because real-world feedback loops are necessary for continuous alignment. This specific skill enables collaboration while minimizing raw data exposure.

## Trigger Checklist
- [ ] The task explicitly needs Community Privacy Preserving Data Broker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Community Privacy Preserving Data Broker.
...
## Operator Use Cases
- Operate Community Privacy Preserving Data Broker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `community-engagement-and-feedback:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Community Privacy Preserving Data Broker`, including at least three measurable KPIs tied to community trust loss and unaddressed concerns.
...
- Scoring weights: `truth=0.16, execution=0.29, safety=0.25, impact=0.30`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 56
  - `review_risk`: risk >= 49
...
1. Incident recovery in Community Engagement and Feedback: ingest noisy signals, execute policy-scoped data mediation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Community Privacy Preserving Data Broker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
