...
## Metadata
- **Skill ID:** `934`
- **Skill Name:** `u0934-infra-tool-health-monitor`
...
4. Keep routing aligned with `infrastructure-and-sustainability:detection-guard` and include approval context.
...
- **Downstream Hint:** Route next to infrastructure-and-sustainability:detection-guard consumers with approval-gate context
