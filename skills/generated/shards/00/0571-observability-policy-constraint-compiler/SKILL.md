...
## When To Use
Use this skill when the request explicitly needs "Observability Policy Constraint Compiler" outcomes in the Data Quality and Observability domain.
...
## Handoff Contract
- Produces: Observability Policy Constraint Compiler normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Policy Constraint Compiler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability policy constraint compiler normalization/assessment.
