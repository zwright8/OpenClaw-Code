...
## Metadata
- **Skill ID:** `918`
- **Skill Name:** `u0918-rights-training-curriculum-composer`
...
### Handoff Contract
- **Produces:** `Rights Training Curriculum Composer normalized artifacts`, `execution scorecard`, `risk posture`
