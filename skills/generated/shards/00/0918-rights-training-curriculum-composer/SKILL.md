...
## When To Use
Use this skill when the request explicitly needs "Rights Training Curriculum Composer" outcomes in the Legal, Rights, and Compliance domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Training Curriculum Composer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights training curriculum composer normalization/assessment.
