...
- The task explicitly requires `u0103-memory-conflict-resolution-coach` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
...
## Trigger Checklist
- [ ] The request explicitly needs **Memory Conflict Resolution Coach** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Memory and Knowledge Operations**
   - Input: noisy upstream payload requiring memory conflict resolution coach normalization/assessment.
