...
description: Build and operate the "Tooling Compliance Evidence Mapper" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Compliance Evidence Mapper" outcomes in the Tool Reliability and Execution Quality domain.
