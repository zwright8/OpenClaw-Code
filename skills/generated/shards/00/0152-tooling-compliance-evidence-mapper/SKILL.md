...
## Metadata
- **Skill ID:** `152`
- **Skill Name:** `u0152-tooling-compliance-evidence-mapper`
...
4. Keep routing aligned with `tool-reliability-and-execution-quality:normalization-engine` and include approval context.
...
- **Downstream Hint:** Route next to tool-reliability-and-execution-quality:normalization-engine consumers with approval-gate context
