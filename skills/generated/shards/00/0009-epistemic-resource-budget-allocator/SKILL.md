---
name: u0009-epistemic-resource-budget-allocator
description: Run the Epistemic Resource Budget Allocator capability for Truth-Seeking and Epistemics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Epistemic Resource Budget Allocator
...
| Feature flag | `skill_0009_epistemic-resource-budget-alloca` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because decisions drift when claims are accepted without verification. This specific skill matches mission ambition to finite execution capacity.

## Trigger Checklist
- [ ] The task explicitly needs Epistemic Resource Budget Allocator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Epistemic Resource Budget Allocator.
...
## Operator Use Cases
- Operate Epistemic Resource Budget Allocator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 70):** release artifacts after validation pass and route to `truth-seeking-and-epistemics:planning-router`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Epistemic Resource Budget Allocator`, including at least three measurable KPIs tied to false certainty and unverified assumptions.
...
- Scoring weights: `truth=0.20, execution=0.19, safety=0.33, impact=0.27`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 44
  - `review_risk`: risk >= 44
...
1. Incident recovery in Truth-Seeking and Epistemics: ingest noisy signals, execute capacity-aware allocation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Epistemic Resource Budget Allocator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
