...
description: Operate the "Inclusion Training Curriculum Composer" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `838`
- **Skill Name:** `u0838-inclusion-training-curriculum-composer`
...
4. Keep routing aligned with `accessibility-and-inclusion:general-capability` and include approval context.
...
### Handoff Contract
- **Produces:** `Inclusion Training Curriculum Composer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `accessibility audits`, `accommodations`, `usability feedback`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to accessibility-and-inclusion:general-capability consumers with approval-gate context
