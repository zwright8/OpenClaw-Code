---
name: u0838-inclusion-training-curriculum-composer
description: Run the Inclusion Training Curriculum Composer capability for Accessibility and Inclusion with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Inclusion Training Curriculum Composer
...
| Feature flag | `skill_0838_inclusion-training-curriculum-co` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because systems must be operable and understandable for diverse users. This specific skill converts capability gaps into actionable upskilling programs.

## Trigger Checklist
- [ ] The task explicitly needs Inclusion Training Curriculum Composer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Inclusion Training Curriculum Composer.
...
## Operator Use Cases
- Operate Inclusion Training Curriculum Composer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 76):** release artifacts after validation pass and route to `accessibility-and-inclusion:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Inclusion Training Curriculum Composer`, including at least three measurable KPIs tied to barriers for disabled and underserved groups.
...
- Scoring weights: `truth=0.19, execution=0.31, safety=0.21, impact=0.28`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 50
  - `review_risk`: risk >= 40
...
1. Incident recovery in Accessibility and Inclusion: ingest noisy signals, execute sequenced learning path design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Inclusion Training Curriculum Composer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
