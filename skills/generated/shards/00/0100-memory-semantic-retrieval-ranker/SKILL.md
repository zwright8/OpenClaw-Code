---
name: u0100-memory-semantic-retrieval-ranker
description: Run the Memory Semantic Retrieval Ranker capability for Memory and Knowledge Operations with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Memory Semantic Retrieval Ranker
...
| Feature flag | `skill_0100_memory-semantic-retrieval-ranker` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents lose performance when lessons are not retained and reused. This specific skill improves recall precision for downstream decision quality.

## Trigger Checklist
- [ ] The task explicitly needs Memory Semantic Retrieval Ranker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Memory Semantic Retrieval Ranker.
...
## Operator Use Cases
- Operate Memory Semantic Retrieval Ranker as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Memory Semantic Retrieval Ranker`, including at least three measurable KPIs tied to repeated mistakes and context loss.
...
- Scoring weights: `truth=0.37, execution=0.32, safety=0.15, impact=0.17`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 53
  - `review_risk`: risk >= 46
...
1. Incident recovery in Memory and Knowledge Operations: ingest noisy signals, execute semantic relevance scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Memory Semantic Retrieval Ranker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
