...
## When To Use
Use this skill when the request explicitly needs "Infra Goal Decomposer" outcomes in the Infrastructure and Sustainability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Goal Decomposer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra goal decomposer normalization/assessment.
