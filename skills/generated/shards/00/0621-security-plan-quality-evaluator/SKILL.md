...
## Trigger Checklist
- [ ] The request explicitly needs **Security Plan Quality Evaluator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security plan quality evaluator normalization/assessment.
