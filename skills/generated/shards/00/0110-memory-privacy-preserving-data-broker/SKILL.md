...
## Metadata
- **Skill ID:** `110`
- **Skill Name:** `u0110-memory-privacy-preserving-data-broker`
...
4. Keep routing aligned with `memory-and-knowledge-operations:collaboration-mediator` and include approval context.
...
### Handoff Contract
- **Produces:** `Memory Privacy Preserving Data Broker normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `episodic logs`, `knowledge nodes`, `retrieval metadata`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to memory-and-knowledge-operations:collaboration-mediator consumers with approval-gate context
