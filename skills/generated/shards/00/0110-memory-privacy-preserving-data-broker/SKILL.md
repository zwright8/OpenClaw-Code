---
name: u0110-memory-privacy-preserving-data-broker
description: Run the Memory Privacy Preserving Data Broker capability for Memory and Knowledge Operations with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Memory Privacy Preserving Data Broker
...
| Feature flag | `skill_0110_memory-privacy-preserving-data-b` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents lose performance when lessons are not retained and reused. This specific skill enables collaboration while minimizing raw data exposure.

## Trigger Checklist
- [ ] The task explicitly needs Memory Privacy Preserving Data Broker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Memory Privacy Preserving Data Broker.
...
## Operator Use Cases
- Operate Memory Privacy Preserving Data Broker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 75):** release artifacts after validation pass and route to `memory-and-knowledge-operations:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Memory Privacy Preserving Data Broker`, including at least three measurable KPIs tied to repeated mistakes and context loss.
...
- Scoring weights: `truth=0.31, execution=0.22, safety=0.13, impact=0.33`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 49
  - `review_risk`: risk >= 31
...
1. Incident recovery in Memory and Knowledge Operations: ingest noisy signals, execute policy-scoped data mediation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Memory Privacy Preserving Data Broker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
