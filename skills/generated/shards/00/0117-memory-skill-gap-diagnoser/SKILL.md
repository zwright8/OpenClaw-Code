---
name: u0117-memory-skill-gap-diagnoser
description: Run the Memory Skill Gap Diagnoser capability for Memory and Knowledge Operations with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Memory Skill Gap Diagnoser
...
| Feature flag | `skill_0117_memory-skill-gap-diagnoser` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents lose performance when lessons are not retained and reused. This specific skill identifies where agents and humans need capability upgrades.

## Trigger Checklist
- [ ] The task explicitly needs Memory Skill Gap Diagnoser (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Memory Skill Gap Diagnoser.
...
## Operator Use Cases
- Operate Memory Skill Gap Diagnoser as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Memory Skill Gap Diagnoser`, including at least three measurable KPIs tied to repeated mistakes and context loss.
...
- Scoring weights: `truth=0.22, execution=0.20, safety=0.22, impact=0.37`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 43
  - `review_risk`: risk >= 34
...
1. Incident recovery in Memory and Knowledge Operations: ingest noisy signals, execute competency coverage analysis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Memory Skill Gap Diagnoser against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
