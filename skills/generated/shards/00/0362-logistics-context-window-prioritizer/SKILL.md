...
description: Build and operate the "Logistics Context Window Prioritizer" capability for Resource Allocation and Logistics. Use when outcomes in this capability family are required for production execution.
---
...
## Metadata
- **Skill ID:** `362`
- **Skill Name:** `u0362-logistics-context-window-prioritizer`
...
4. Keep routing aligned with `resource-allocation-and-logistics:planning-router` and include approval context.
...
### Handoff Contract
- **Produces:** `Logistics Context Window Prioritizer normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `capacity`, `bottlenecks`, `distribution plans`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to resource-allocation-and-logistics:planning-router consumers with approval-gate context
