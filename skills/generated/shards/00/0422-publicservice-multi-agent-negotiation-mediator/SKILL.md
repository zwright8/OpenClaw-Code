---
name: u0422-publicservice-multi-agent-negotiation-mediator
description: Run the PublicService Multi-Agent Negotiation Mediator capability for Healthcare and Public Services with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# PublicService Multi-Agent Negotiation Mediator
...
## Trigger Checklist
- [ ] The task explicitly needs PublicService Multi-Agent Negotiation Mediator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for PublicService Multi-Agent Negotiation Mediator.
...
## Operator Use Cases
- Operate PublicService Multi-Agent Negotiation Mediator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `healthcare-and-public-services:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `PublicService Multi-Agent Negotiation Mediator`, including at least three measurable KPIs tied to service harm and procedural violations.
...
- Scoring weights: `truth=0.20, execution=0.39, safety=0.18, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 43
  - `review_risk`: risk >= 44
...
1. Incident recovery in Healthcare and Public Services: ingest noisy signals, execute structured bargaining protocols, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run PublicService Multi-Agent Negotiation Mediator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
