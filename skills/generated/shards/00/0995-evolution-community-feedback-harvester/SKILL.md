...
## Metadata
- **Skill ID:** `995`
- **Skill Name:** `u0995-evolution-community-feedback-harvester`
...
### Handoff Contract
- **Produces:** `Evolution Community Feedback Harvester normalized artifacts`, `execution scorecard`, `risk posture`
