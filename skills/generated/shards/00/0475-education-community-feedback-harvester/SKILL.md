...
## When To Use
Use this skill when the request explicitly needs "Education Community Feedback Harvester" outcomes in the Education and Upskilling domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Community Feedback Harvester** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education community feedback harvester normalization/assessment.
