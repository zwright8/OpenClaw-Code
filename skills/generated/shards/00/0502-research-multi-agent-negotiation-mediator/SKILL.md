...
## Trigger Checklist
- [ ] The request explicitly needs **Research Multi-Agent Negotiation Mediator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring research multi-agent negotiation mediator normalization/assessment.
