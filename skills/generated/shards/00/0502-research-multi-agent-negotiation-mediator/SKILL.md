...
description: Run the Research Multi-Agent Negotiation Mediator capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0502_research-multi-agent-negotiation` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Research Multi-Agent Negotiation Mediator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Multi-Agent Negotiation Mediator.
...
## Operator Use Cases
- Operate Research Multi-Agent Negotiation Mediator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Multi-Agent Negotiation Mediator`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.31, execution=0.25, safety=0.23, impact=0.22`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 48
  - `review_risk`: risk >= 35
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute structured bargaining protocols, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Multi-Agent Negotiation Mediator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
