...
- The task explicitly requires `u0101-memory-plan-quality-evaluator` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
