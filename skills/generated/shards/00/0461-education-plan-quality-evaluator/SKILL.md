...
## Handoff Contract
- Produces: Education Plan Quality Evaluator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Plan Quality Evaluator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education plan quality evaluator normalization/assessment.
