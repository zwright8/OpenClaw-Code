---
name: u0461-education-plan-quality-evaluator
description: Run the Education Plan Quality Evaluator capability for Education and Upskilling with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Education Plan Quality Evaluator
...
| Feature flag | `skill_0461_education-plan-quality-evaluator` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because human capability growth requires targeted planning under constraints. This specific skill quantifies whether plans are complete, safe, and feasible.

## Trigger Checklist
- [ ] The task explicitly needs Education Plan Quality Evaluator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Education Plan Quality Evaluator.
...
## Operator Use Cases
- Operate Education Plan Quality Evaluator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 76):** release artifacts after validation pass and route to `education-and-upskilling:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Education Plan Quality Evaluator`, including at least three measurable KPIs tied to persistent skill gaps and poor learning outcomes.
...
- Scoring weights: `truth=0.36, execution=0.30, safety=0.21, impact=0.13`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 56
  - `review_risk`: risk >= 58
...
1. Incident recovery in Education and Upskilling: ingest noisy signals, execute multi-criteria plan scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Education Plan Quality Evaluator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
