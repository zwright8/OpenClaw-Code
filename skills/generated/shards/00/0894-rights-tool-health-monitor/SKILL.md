...
description: Operate the "Rights Tool Health Monitor" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `894`
- **Skill Name:** `u0894-rights-tool-health-monitor`
...
4. Keep routing aligned with `legal-rights-and-compliance:detection-guard` and include approval context.
...
### Handoff Contract
- **Produces:** `Rights Tool Health Monitor normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `requirements mappings`, `legal decisions`, `evidence trails`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to legal-rights-and-compliance:detection-guard consumers with approval-gate context
