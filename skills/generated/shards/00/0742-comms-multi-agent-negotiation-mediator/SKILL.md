...
## Metadata
- **Skill ID:** `742`
- **Skill Name:** `u0742-comms-multi-agent-negotiation-mediator`
...
4. Keep routing aligned with `communication-and-explainability:collaboration-mediator` and include approval context.
...
- **Downstream Hint:** Route next to communication-and-explainability:collaboration-mediator consumers with approval-gate context
