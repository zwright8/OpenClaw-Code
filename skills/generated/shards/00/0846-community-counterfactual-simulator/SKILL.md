...
description: Operate the "Community Counterfactual Simulator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `846`
- **Skill Name:** `u0846-community-counterfactual-simulator`
...
4. Keep routing aligned with `community-engagement-and-feedback:simulation-lab` and include approval context.
...
### Handoff Contract
- **Produces:** `Community Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `feedback channels`, `sentiment`, `urgency`, `follow-ups`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to community-engagement-and-feedback:simulation-lab consumers with approval-gate context
