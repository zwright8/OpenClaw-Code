...
description: Run the Rights Self-Reflection Error Taxonomist capability for Legal, Rights, and Compliance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0919_rights-self-reflection-error-tax` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Rights Self-Reflection Error Taxonomist (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Rights Self-Reflection Error Taxonomist.
...
## Operator Use Cases
- Operate Rights Self-Reflection Error Taxonomist as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 72):** release artifacts after validation pass and route to `legal-rights-and-compliance:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Rights Self-Reflection Error Taxonomist`, including at least three measurable KPIs tied to rights violations and compliance penalties.
...
- Scoring weights: `truth=0.39, execution=0.27, safety=0.20, impact=0.15`
- Posture thresholds:
  - `ready`: score >= 72
  - `review`: score >= 43
  - `review_risk`: risk >= 35
...
4. `Audit log + immutable storage` -> auth preflight, execute read/query call(s), normalize output, and attach trace to `error taxonomies`.
...
1. Incident recovery in Legal, Rights, and Compliance: ingest noisy signals, execute failure-type clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Rights Self-Reflection Error Taxonomist against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
