...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights self-reflection error taxonomist normalization/assessment.
