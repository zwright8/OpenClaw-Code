...
## When To Use
Use this skill when you need "Epistemic Self-Reflection Error Taxonomist" outcomes for the Truth-Seeking and Epistemics domain with measurable, production-facing outputs.
...
## Trigger Checklist
- [ ] The request explicitly needs **Epistemic Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Truth-Seeking and Epistemics**
   - Input: noisy upstream payload requiring epistemic self-reflection error taxonomist normalization/assessment.
