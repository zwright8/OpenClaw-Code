...
## Trigger Checklist
- [ ] The request explicitly needs **Impact Security Threat Modeler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring impact security threat modeler normalization/assessment.
