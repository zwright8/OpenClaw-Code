...
- Downstream routing hint: Route next to community-engagement-and-feedback:optimization-engine consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Community Confidence Calibration Engine** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community confidence calibration engine normalization/assessment.
