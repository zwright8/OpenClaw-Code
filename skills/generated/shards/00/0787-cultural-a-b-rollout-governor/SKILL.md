...
## When To Use
Use this skill when the request explicitly needs "Cultural A/B Rollout Governor" outcomes in the Multilingual and Cultural Adaptation domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural A/B Rollout Governor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural a/b rollout governor normalization/assessment.
