...
description: Run the Epistemic Uncertainty Communicator capability for Truth-Seeking and Epistemics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0025_epistemic-uncertainty-communicat` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Epistemic Uncertainty Communicator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Epistemic Uncertainty Communicator.
...
## Operator Use Cases
- Operate Epistemic Uncertainty Communicator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `truth-seeking-and-epistemics:communication-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Epistemic Uncertainty Communicator`, including at least three measurable KPIs tied to false certainty and unverified assumptions.
...
- Scoring weights: `truth=0.21, execution=0.24, safety=0.36, impact=0.19`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 60
  - `review_risk`: risk >= 61
...
1. Incident recovery in Truth-Seeking and Epistemics: ingest noisy signals, execute confidence-bound communication templates, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Epistemic Uncertainty Communicator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
