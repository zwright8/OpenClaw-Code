...
## Metadata
- **Skill ID:** `603`
- **Skill Name:** `u0603-security-evidence-provenance-tracker`
...
4. Keep routing aligned with `security-and-privacy:provenance-tracker` and include approval context.
...
- **Downstream Hint:** Route next to security-and-privacy:provenance-tracker consumers with approval-gate context
