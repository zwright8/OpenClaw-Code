---
name: u0341-economic-plan-quality-evaluator
description: Run the Economic Plan Quality Evaluator capability for Economic Optimization with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Economic Plan Quality Evaluator
...
| Feature flag | `skill_0341_economic-plan-quality-evaluator` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need explicit tradeoff logic for cost, speed, and impact. This specific skill quantifies whether plans are complete, safe, and feasible.

## Trigger Checklist
- [ ] The task explicitly needs Economic Plan Quality Evaluator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Economic Plan Quality Evaluator.
...
## Operator Use Cases
- Operate Economic Plan Quality Evaluator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Economic Plan Quality Evaluator`, including at least three measurable KPIs tied to overspending and low-impact allocation.
...
- Scoring weights: `truth=0.17, execution=0.32, safety=0.34, impact=0.18`
- Posture thresholds:
  - `ready`: score >= 74
  - `review`: score >= 58
  - `review_risk`: risk >= 49
...
1. Incident recovery in Economic Optimization: ingest noisy signals, execute multi-criteria plan scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Economic Plan Quality Evaluator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
