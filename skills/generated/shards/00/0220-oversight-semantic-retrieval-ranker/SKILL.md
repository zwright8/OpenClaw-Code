...
## Metadata
- **Skill ID:** `220`
- **Skill Name:** `u0220-oversight-semantic-retrieval-ranker`
...
### Handoff Contract
- **Produces:** `Oversight Semantic Retrieval Ranker normalized artifacts`, `execution scorecard`, `risk posture`
