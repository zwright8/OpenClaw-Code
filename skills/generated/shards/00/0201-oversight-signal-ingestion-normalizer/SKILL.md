...
## Trigger Checklist
- [ ] The request explicitly needs **Oversight Signal Ingestion Normalizer** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **Human Oversight and Operator UX** with measurable acceptance criteria.
...
- **Daily:** Run when new human oversight and operator ux signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in Human Oversight and Operator UX**
   - Input: noisy upstream payload requiring oversight signal ingestion normalizer normalization/assessment.
...
## When To Use
Use this when a request in **Human Oversight and Operator UX** depends on **Oversight Signal Ingestion Normalizer** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
