---
name: u0019-epistemic-knowledge-graph-linker
description: Run the Epistemic Knowledge Graph Linker capability for Truth-Seeking and Epistemics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Epistemic Knowledge Graph Linker
...
| Feature flag | `skill_0019_epistemic-knowledge-graph-linker` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because decisions drift when claims are accepted without verification. This specific skill connects fragmented facts into reusable structures.

## Trigger Checklist
- [ ] The task explicitly needs Epistemic Knowledge Graph Linker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Epistemic Knowledge Graph Linker.
...
## Operator Use Cases
- Operate Epistemic Knowledge Graph Linker as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Epistemic Knowledge Graph Linker`, including at least three measurable KPIs tied to false certainty and unverified assumptions.
...
- Scoring weights: `truth=0.18, execution=0.28, safety=0.27, impact=0.26`
- Posture thresholds:
  - `ready`: score >= 74
  - `review`: score >= 45
  - `review_risk`: risk >= 45
...
1. Incident recovery in Truth-Seeking and Epistemics: ingest noisy signals, execute entity and relation linking, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Epistemic Knowledge Graph Linker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
