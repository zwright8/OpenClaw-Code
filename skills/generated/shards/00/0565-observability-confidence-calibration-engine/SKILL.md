...
## Metadata
- **Skill ID:** `565`
- **Skill Name:** `u0565-observability-confidence-calibration-engine`
...
4. Keep routing aligned with `data-quality-and-observability:optimization-engine` and include approval context.
...
- **Downstream Hint:** Route next to data-quality-and-observability:optimization-engine consumers with approval-gate context
