...
## When To Use
Use this skill when the request explicitly needs "Logistics Security Threat Modeler" outcomes in the Resource Allocation and Logistics domain.
...
- Downstream routing hint: Route next to resource-allocation-and-logistics:detection-guard consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Logistics Security Threat Modeler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Resource Allocation and Logistics**
   - Input: noisy upstream payload requiring logistics security threat modeler normalization/assessment.
