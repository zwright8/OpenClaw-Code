...
## Trigger Checklist
- [ ] The request explicitly needs **Comms Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms uncertainty communicator normalization/assessment.
