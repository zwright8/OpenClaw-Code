...
description: Operate the "Comms Uncertainty Communicator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `745`
- **Skill Name:** `u0745-comms-uncertainty-communicator`
...
4. Keep routing aligned with `communication-and-explainability:communication-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Comms Uncertainty Communicator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `decision factors`, `uncertainty markers`, `audience summaries`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to communication-and-explainability:communication-engine consumers with approval-gate context
