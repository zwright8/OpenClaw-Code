...
## When To Use
Use this skill when the request explicitly needs "PublicService Experiment Design Generator" outcomes in the Healthcare and Public Services domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Experiment Design Generator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice experiment design generator normalization/assessment.
