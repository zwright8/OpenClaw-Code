...
## Trigger Checklist
- [ ] The request explicitly needs **Impact Plan Quality Evaluator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring impact plan quality evaluator normalization/assessment.
