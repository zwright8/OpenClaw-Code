...
- Downstream routing hint: Route next to infrastructure-and-sustainability:communication-engine consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra uncertainty communicator normalization/assessment.
