...
description: Operate the "Infra Uncertainty Communicator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `945`
- **Skill Name:** `u0945-infra-uncertainty-communicator`
...
4. Keep routing aligned with `infrastructure-and-sustainability:communication-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Infra Uncertainty Communicator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `capacity forecasts`, `energy usage`, `sustainability metrics`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to infrastructure-and-sustainability:communication-engine consumers with approval-gate context
