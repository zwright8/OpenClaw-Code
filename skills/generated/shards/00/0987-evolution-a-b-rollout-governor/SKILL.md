---
name: u0987-evolution-a-b-rollout-governor
description: Run the Evolution A/B Rollout Governor capability for Autonomous Learning and Evolution with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Evolution A/B Rollout Governor
...
| Feature flag | `skill_0987_evolution-a-b-rollout-governor` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents stagnate without structured reflection and continuous improvement loops. This specific skill controls production risk during behavioral changes.

## Trigger Checklist
- [ ] The task explicitly needs Evolution A/B Rollout Governor (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Evolution A/B Rollout Governor.
...
## Operator Use Cases
- Operate Evolution A/B Rollout Governor as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Evolution A/B Rollout Governor`, including at least three measurable KPIs tied to capability stagnation and repeated blind spots.
...
- Scoring weights: `truth=0.27, execution=0.19, safety=0.23, impact=0.31`
- Posture thresholds:
  - `ready`: score >= 73
  - `review`: score >= 43
  - `review_risk`: risk >= 44
...
1. Incident recovery in Autonomous Learning and Evolution: ingest noisy signals, execute staged rollout policies, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Evolution A/B Rollout Governor against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
