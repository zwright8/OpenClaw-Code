---
name: u0188-governance-incident-playbook-synthesizer
description: Run the Governance Incident Playbook Synthesizer capability for Safety and Governance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Governance Incident Playbook Synthesizer
...
| Feature flag | `skill_0188_governance-incident-playbook-syn` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because high-speed autonomy needs enforceable guardrails to stay aligned. This specific skill creates repeatable response procedures from incident history.

## Trigger Checklist
- [ ] The task explicitly needs Governance Incident Playbook Synthesizer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Governance Incident Playbook Synthesizer.
...
## Operator Use Cases
- Operate Governance Incident Playbook Synthesizer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `safety-and-governance:communication-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Governance Incident Playbook Synthesizer`, including at least three measurable KPIs tied to unsafe actions and policy drift.
...
- Scoring weights: `truth=0.17, execution=0.37, safety=0.18, impact=0.28`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 43
  - `review_risk`: risk >= 36
...
1. Incident recovery in Safety and Governance: ingest noisy signals, execute pattern-to-playbook synthesis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Governance Incident Playbook Synthesizer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
