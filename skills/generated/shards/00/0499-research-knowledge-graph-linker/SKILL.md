...
## Trigger Checklist
- [ ] The request explicitly needs **Research Knowledge Graph Linker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Scientific Research Systems**
   - Input: noisy upstream payload requiring research knowledge graph linker normalization/assessment.
