...
description: Run the Research Knowledge Graph Linker capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
## Trigger Checklist
- [ ] The task explicitly needs Research Knowledge Graph Linker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Knowledge Graph Linker.
...
## Operator Use Cases
- Operate Research Knowledge Graph Linker as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Knowledge Graph Linker`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.33, execution=0.13, safety=0.25, impact=0.29`
- Posture thresholds:
  - `ready`: score >= 71
  - `review`: score >= 44
  - `review_risk`: risk >= 31
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute entity and relation linking, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Knowledge Graph Linker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
