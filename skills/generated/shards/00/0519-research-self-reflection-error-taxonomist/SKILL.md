...
## Trigger Checklist
- [ ] The request explicitly needs **Research Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring research self-reflection error taxonomist normalization/assessment.
