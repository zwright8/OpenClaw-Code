...
## When To Use
Use this skill when the request explicitly needs "Rights Explainability Narrative Builder" outcomes in the Legal, Rights, and Compliance domain.
...
- Downstream routing hint: Route next to legal-rights-and-compliance:communication-engine consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Explainability Narrative Builder** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights explainability narrative builder normalization/assessment.
