...
## Metadata
- **Skill ID:** `622`
- **Skill Name:** `u0622-security-multi-agent-negotiation-mediator`
...
4. Keep routing aligned with `security-and-privacy:collaboration-mediator` and include approval context.
...
- **Downstream Hint:** Route next to security-and-privacy:collaboration-mediator consumers with approval-gate context
