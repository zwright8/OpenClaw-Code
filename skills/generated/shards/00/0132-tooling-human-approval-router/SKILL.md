...
- The task explicitly requires `u0132-tooling-human-approval-router` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
