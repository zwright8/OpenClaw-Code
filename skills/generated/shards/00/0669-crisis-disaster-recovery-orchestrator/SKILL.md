...
## When To Use
Use this skill when the request explicitly needs "Crisis Disaster Recovery Orchestrator" outcomes in the Crisis and Incident Response domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Disaster Recovery Orchestrator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis disaster recovery orchestrator normalization/assessment.
