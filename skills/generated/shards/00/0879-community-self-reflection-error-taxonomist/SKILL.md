...
## When To Use
Use this skill when the request explicitly needs "Community Self-Reflection Error Taxonomist" outcomes in the Community Engagement and Feedback domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Community Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community self-reflection error taxonomist normalization/assessment.
