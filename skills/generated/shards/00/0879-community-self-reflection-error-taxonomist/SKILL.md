---
name: u0879-community-self-reflection-error-taxonomist
description: Run the Community Self-Reflection Error Taxonomist capability for Community Engagement and Feedback with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Community Self-Reflection Error Taxonomist
...
| Feature flag | `skill_0879_community-self-reflection-error-` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because real-world feedback loops are necessary for continuous alignment. This specific skill classifies recurrent reasoning failures for targeted fixes.

## Trigger Checklist
- [ ] The task explicitly needs Community Self-Reflection Error Taxonomist (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Community Self-Reflection Error Taxonomist.
...
## Operator Use Cases
- Operate Community Self-Reflection Error Taxonomist as a reliable, reusable production workflow.
...
- **Review posture (score >= 44 or risk >= 43):** require human review before publish, with explicit remediation notes.
- **Critical posture (risk >= 68):** fail closed, execute `rollback-to-last-stable-baseline`, and escalate with incident packet.

## Traceability Map
- **Scope:** Define the scope and success metrics for `Community Self-Reflection Error Taxonomist`, including at least three measurable KPIs tied to community trust loss and unaddressed concerns.
...
- Scoring weights: `truth=0.23, execution=0.16, safety=0.36, impact=0.25`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 44
  - `review_risk`: risk >= 43
...
1. Incident recovery in Community Engagement and Feedback: ingest noisy signals, execute failure-type clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Community Self-Reflection Error Taxonomist against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
