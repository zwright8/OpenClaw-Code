...
description: Operate the "Community Self-Reflection Error Taxonomist" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `879`
- **Skill Name:** `u0879-community-self-reflection-error-taxonomist`
...
4. Keep routing aligned with `community-engagement-and-feedback:general-capability` and include approval context.
...
### Handoff Contract
- **Produces:** `Community Self-Reflection Error Taxonomist normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `feedback channels`, `sentiment`, `urgency`, `follow-ups`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to community-engagement-and-feedback:general-capability consumers with approval-gate context
