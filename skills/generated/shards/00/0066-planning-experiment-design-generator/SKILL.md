---
name: u0066-planning-experiment-design-generator
description: Run the Planning Experiment Design Generator capability for Strategic Planning and Decomposition with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Planning Experiment Design Generator
...
| Feature flag | `skill_0066_planning-experiment-design-gener` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because large goals fail when decomposition is inconsistent or incomplete. This specific skill converts unknowns into testable learning loops.

## Trigger Checklist
- [ ] The task explicitly needs Planning Experiment Design Generator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Planning Experiment Design Generator.
...
## Operator Use Cases
- Operate Planning Experiment Design Generator as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Planning Experiment Design Generator`, including at least three measurable KPIs tied to execution stalls and hidden dependency failures.
...
- Scoring weights: `truth=0.23, execution=0.32, safety=0.16, impact=0.28`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 46
  - `review_risk`: risk >= 39
...
1. Incident recovery in Strategic Planning and Decomposition: ingest noisy signals, execute hypothesis-driven design, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Planning Experiment Design Generator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
