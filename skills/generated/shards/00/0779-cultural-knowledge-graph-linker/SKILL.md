...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Knowledge Graph Linker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural knowledge graph linker normalization/assessment.
