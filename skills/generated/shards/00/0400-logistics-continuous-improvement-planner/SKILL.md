...
## Handoff Contract
- Produces: Logistics Continuous Improvement Planner normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Logistics Continuous Improvement Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Resource Allocation and Logistics**
   - Input: noisy upstream payload requiring logistics continuous improvement planner normalization/assessment.
