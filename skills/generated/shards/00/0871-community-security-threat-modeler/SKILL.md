...
## When To Use
Use this skill when the request explicitly needs "Community Security Threat Modeler" outcomes in the Community Engagement and Feedback domain.
...
## Handoff Contract
- Produces: Community Security Threat Modeler normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Community Security Threat Modeler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community security threat modeler normalization/assessment.
