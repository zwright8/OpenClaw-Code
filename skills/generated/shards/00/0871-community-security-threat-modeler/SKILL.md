...
description: Run the Community Security Threat Modeler capability for Community Engagement and Feedback with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0871_community-security-threat-modele` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because real-world feedback loops are necessary for continuous alignment. This specific skill anticipates attack paths before adversaries exploit them.

## Trigger Checklist
- [ ] The task explicitly needs Community Security Threat Modeler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Community Security Threat Modeler.
...
## Operator Use Cases
- Operate Community Security Threat Modeler as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Community Security Threat Modeler`, including at least three measurable KPIs tied to community trust loss and unaddressed concerns.
...
- Scoring weights: `truth=0.33, execution=0.20, safety=0.33, impact=0.13`
- Posture thresholds:
  - `ready`: score >= 74
  - `review`: score >= 52
  - `review_risk`: risk >= 58
...
1. Incident recovery in Community Engagement and Feedback: ingest noisy signals, execute attack-surface modeling, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Community Security Threat Modeler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
