...
## When To Use
Use this skill when the request explicitly needs "Observability Risk-Aware Scheduler" outcomes in the Data Quality and Observability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Risk-Aware Scheduler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability risk-aware scheduler normalization/assessment.
