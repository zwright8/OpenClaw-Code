...
description: Build and operate the "Tooling Uncertainty Communicator" capability for Tool Reliability and Execution Quality. Use when outcomes in this capability family are required for production execution.
---
...
## Metadata
- **Skill ID:** `145`
- **Skill Name:** `u0145-tooling-uncertainty-communicator`
...
4. Keep routing aligned with `tool-reliability-and-execution-quality:communication-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Tooling Uncertainty Communicator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `tool runs`, `error signatures`, `retry outcomes`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to tool-reliability-and-execution-quality:communication-engine consumers with approval-gate context
