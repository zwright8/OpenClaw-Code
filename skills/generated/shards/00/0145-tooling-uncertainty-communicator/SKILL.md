...
- The task explicitly requires `u0145-tooling-uncertainty-communicator` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
