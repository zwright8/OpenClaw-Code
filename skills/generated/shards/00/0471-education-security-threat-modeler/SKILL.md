...
## Trigger Checklist
- [ ] The request explicitly needs **Education Security Threat Modeler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education security threat modeler normalization/assessment.
