...
description: Operate the "Impact Conflict Resolution Coach" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `703`
- **Skill Name:** `u0703-impact-conflict-resolution-coach`
...
4. Keep routing aligned with `social-impact-measurement:collaboration-mediator` and include approval context.
...
### Handoff Contract
- **Produces:** `Impact Conflict Resolution Coach normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `community outcomes`, `kpi trends`, `intervention deltas`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to social-impact-measurement:collaboration-mediator consumers with approval-gate context
