...
## Trigger Checklist
- [ ] The request explicitly needs **Impact Conflict Resolution Coach** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring impact conflict resolution coach normalization/assessment.
