...
description: Run the Economic Policy Constraint Compiler capability for Economic Optimization with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0331_economic-policy-constraint-compi` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Economic Policy Constraint Compiler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Economic Policy Constraint Compiler.
...
## Operator Use Cases
- Operate Economic Policy Constraint Compiler as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 74):** release artifacts after validation pass and route to `economic-optimization:contract-compiler`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Economic Policy Constraint Compiler`, including at least three measurable KPIs tied to overspending and low-impact allocation.
...
- Scoring weights: `truth=0.20, execution=0.32, safety=0.25, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 74
  - `review`: score >= 62
  - `review_risk`: risk >= 51
...
1. Incident recovery in Economic Optimization: ingest noisy signals, execute rule compilation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Economic Policy Constraint Compiler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
