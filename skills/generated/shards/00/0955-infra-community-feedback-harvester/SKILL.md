...
description: Operate the "Infra Community Feedback Harvester" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Infra Community Feedback Harvester" outcomes in the Infrastructure and Sustainability domain.
...
## Handoff Contract
- Produces: Infra Community Feedback Harvester normalized artifacts; execution scorecard; risk posture
- Consumes: capacity forecasts; energy usage; sustainability metrics; claims; evidence; confidence traces
- Downstream routing hint: Route next to infrastructure-and-sustainability:normalization-engine consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Community Feedback Harvester** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra community feedback harvester normalization/assessment.
