...
## Metadata
- **Skill ID:** `955`
- **Skill Name:** `u0955-infra-community-feedback-harvester`
...
4. Keep routing aligned with `infrastructure-and-sustainability:normalization-engine` and include approval context.
...
- **Downstream Hint:** Route next to infrastructure-and-sustainability:normalization-engine consumers with approval-gate context
