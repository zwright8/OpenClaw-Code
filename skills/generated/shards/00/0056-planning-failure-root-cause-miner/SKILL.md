...
## Trigger Checklist
- [ ] The request explicitly needs **Planning Failure Root-Cause Miner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Strategic Planning and Decomposition**
   - Input: noisy upstream payload requiring planning failure root-cause miner normalization/assessment.
