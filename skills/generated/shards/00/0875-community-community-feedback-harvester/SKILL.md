...
description: Run the Community Community Feedback Harvester capability for Community Engagement and Feedback with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0875_community-community-feedback-har` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Community Community Feedback Harvester (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Community Community Feedback Harvester.
...
## Operator Use Cases
- Operate Community Community Feedback Harvester as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 77):** release artifacts after validation pass and route to `community-engagement-and-feedback:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Community Community Feedback Harvester`, including at least three measurable KPIs tied to community trust loss and unaddressed concerns.
...
- Scoring weights: `truth=0.24, execution=0.27, safety=0.14, impact=0.35`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 49
  - `review_risk`: risk >= 44
...
1. Incident recovery in Community Engagement and Feedback: ingest noisy signals, execute feedback normalization and clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Community Community Feedback Harvester against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
