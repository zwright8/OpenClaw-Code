---
name: u0994-evolution-equity-impact-scorer
description: Run the Evolution Equity Impact Scorer capability for Autonomous Learning and Evolution with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Evolution Equity Impact Scorer
...
| Feature flag | `skill_0994_evolution-equity-impact-scorer` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents stagnate without structured reflection and continuous improvement loops. This specific skill exposes uneven benefit/harm distribution before rollout.

## Trigger Checklist
- [ ] The task explicitly needs Evolution Equity Impact Scorer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Evolution Equity Impact Scorer.
...
## Operator Use Cases
- Operate Evolution Equity Impact Scorer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Evolution Equity Impact Scorer`, including at least three measurable KPIs tied to capability stagnation and repeated blind spots.
...
- Scoring weights: `truth=0.37, execution=0.27, safety=0.18, impact=0.19`
- Posture thresholds:
  - `ready`: score >= 71
  - `review`: score >= 51
  - `review_risk`: risk >= 39
...
1. Incident recovery in Autonomous Learning and Evolution: ingest noisy signals, execute group-level impact scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Evolution Equity Impact Scorer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
