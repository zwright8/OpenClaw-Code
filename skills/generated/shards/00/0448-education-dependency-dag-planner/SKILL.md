...
description: Build and operate the "Education Dependency DAG Planner" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Dependency DAG Planner" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Dependency DAG Planner normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Dependency DAG Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education dependency dag planner normalization/assessment.
