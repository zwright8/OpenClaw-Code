---
name: u0770-cultural-risk-aware-scheduler
description: Run the Cultural Risk-Aware Scheduler capability for Multilingual and Cultural Adaptation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Cultural Risk-Aware Scheduler
...
| Feature flag | `skill_0770_cultural-risk-aware-scheduler` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because global utility requires language and cultural context fidelity. This specific skill times execution based on risk posture instead of urgency alone.

## Trigger Checklist
- [ ] The task explicitly needs Cultural Risk-Aware Scheduler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Cultural Risk-Aware Scheduler.
...
## Operator Use Cases
- Operate Cultural Risk-Aware Scheduler as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `multilingual-and-cultural-adaptation:planning-router`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Cultural Risk-Aware Scheduler`, including at least three measurable KPIs tied to context mismatch and exclusion.
...
- Scoring weights: `truth=0.35, execution=0.25, safety=0.12, impact=0.29`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 46
  - `review_risk`: risk >= 37
...
1. Incident recovery in Multilingual and Cultural Adaptation: ingest noisy signals, execute risk-weighted sequencing, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Cultural Risk-Aware Scheduler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
