...
## Trigger Checklist
- [ ] The request explicitly needs **Collab A/B Rollout Governor** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Collaboration and Negotiation workflows**
   - Input: noisy upstream payload requiring collab a/b rollout governor normalization/assessment.
