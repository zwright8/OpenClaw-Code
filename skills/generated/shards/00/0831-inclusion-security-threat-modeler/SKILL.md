...
description: Operate the "Inclusion Security Threat Modeler" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `831`
- **Skill Name:** `u0831-inclusion-security-threat-modeler`
...
4. Keep routing aligned with `accessibility-and-inclusion:detection-guard` and include approval context.
...
### Handoff Contract
- **Produces:** `Inclusion Security Threat Modeler normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `accessibility audits`, `accommodations`, `usability feedback`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to accessibility-and-inclusion:detection-guard consumers with approval-gate context
