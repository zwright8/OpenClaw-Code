...
## Metadata
- **Skill ID:** `205`
- **Skill Name:** `u0205-oversight-confidence-calibration-engine`
...
4. Keep routing aligned with `human-oversight-and-operator-ux:optimization-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Oversight Confidence Calibration Engine normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `approval queues`, `operator workload`, `intervention history`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to human-oversight-and-operator-ux:optimization-engine consumers with approval-gate context
