...
## Metadata
- **Skill ID:** `235`
- **Skill Name:** `u0235-oversight-community-feedback-harvester`
...
4. Keep routing aligned with `human-oversight-and-operator-ux:normalization-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Oversight Community Feedback Harvester normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `approval queues`, `operator workload`, `intervention history`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to human-oversight-and-operator-ux:normalization-engine consumers with approval-gate context
