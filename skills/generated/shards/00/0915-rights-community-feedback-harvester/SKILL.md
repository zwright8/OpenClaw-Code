...
description: Operate the "Rights Community Feedback Harvester" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `915`
- **Skill Name:** `u0915-rights-community-feedback-harvester`
...
4. Keep routing aligned with `legal-rights-and-compliance:normalization-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Rights Community Feedback Harvester normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `requirements mappings`, `legal decisions`, `evidence trails`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to legal-rights-and-compliance:normalization-engine consumers with approval-gate context
