---
name: u0915-rights-community-feedback-harvester
description: Run the Rights Community Feedback Harvester capability for Legal, Rights, and Compliance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Rights Community Feedback Harvester
...
| Feature flag | `skill_0915_rights-community-feedback-harves` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because operations must preserve rights and satisfy jurisdictional obligations. This specific skill integrates lived user feedback into planning cycles.

## Trigger Checklist
- [ ] The task explicitly needs Rights Community Feedback Harvester (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Rights Community Feedback Harvester.
...
## Operator Use Cases
- Operate Rights Community Feedback Harvester as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 76):** release artifacts after validation pass and route to `legal-rights-and-compliance:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Rights Community Feedback Harvester`, including at least three measurable KPIs tied to rights violations and compliance penalties.
...
- Scoring weights: `truth=0.16, execution=0.23, safety=0.30, impact=0.32`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 48
  - `review_risk`: risk >= 34
...
1. Incident recovery in Legal, Rights, and Compliance: ingest noisy signals, execute feedback normalization and clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Rights Community Feedback Harvester against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
