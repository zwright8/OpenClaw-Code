---
name: u0982-evolution-multi-agent-negotiation-mediator
description: Run the Evolution Multi-Agent Negotiation Mediator capability for Autonomous Learning and Evolution with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Evolution Multi-Agent Negotiation Mediator
...
| Feature flag | `skill_0982_evolution-multi-agent-negotiatio` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because agents stagnate without structured reflection and continuous improvement loops. This specific skill resolves resource and strategy conflicts with explicit tradeoffs.

## Trigger Checklist
- [ ] The task explicitly needs Evolution Multi-Agent Negotiation Mediator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Evolution Multi-Agent Negotiation Mediator.
...
## Operator Use Cases
- Operate Evolution Multi-Agent Negotiation Mediator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `autonomous-learning-and-evolution:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Evolution Multi-Agent Negotiation Mediator`, including at least three measurable KPIs tied to capability stagnation and repeated blind spots.
...
- Scoring weights: `truth=0.20, execution=0.30, safety=0.13, impact=0.37`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 52
  - `review_risk`: risk >= 36
...
1. Incident recovery in Autonomous Learning and Evolution: ingest noisy signals, execute structured bargaining protocols, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Evolution Multi-Agent Negotiation Mediator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
