...
## Trigger Checklist
- [ ] The request explicitly needs **PublicService Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Healthcare and Public Services**
   - Input: noisy upstream payload requiring publicservice self-reflection error taxonomist normalization/assessment.
