...
## Metadata
- **Skill ID:** `439`
- **Skill Name:** `u0439-publicservice-self-reflection-error-taxonomist`
...
### Handoff Contract
- **Produces:** `PublicService Self-Reflection Error Taxonomist normalized artifacts`, `execution scorecard`, `risk posture`
