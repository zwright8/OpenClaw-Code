---
name: u0189-governance-disaster-recovery-orchestrator
description: Run the Governance Disaster Recovery Orchestrator capability for Safety and Governance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Governance Disaster Recovery Orchestrator
...
| Feature flag | `skill_0189_governance-disaster-recovery-orc` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because high-speed autonomy needs enforceable guardrails to stay aligned. This specific skill improves recovery speed after severe outages.

## Trigger Checklist
- [ ] The task explicitly needs Governance Disaster Recovery Orchestrator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Governance Disaster Recovery Orchestrator.
...
## Operator Use Cases
- Operate Governance Disaster Recovery Orchestrator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `safety-and-governance:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Governance Disaster Recovery Orchestrator`, including at least three measurable KPIs tied to unsafe actions and policy drift.
...
- Scoring weights: `truth=0.12, execution=0.33, safety=0.21, impact=0.34`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 55
  - `review_risk`: risk >= 48
...
1. Incident recovery in Safety and Governance: ingest noisy signals, execute failover and restoration sequencing, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Governance Disaster Recovery Orchestrator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
