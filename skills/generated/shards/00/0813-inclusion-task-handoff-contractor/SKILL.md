...
description: Run the Inclusion Task Handoff Contractor capability for Accessibility and Inclusion with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0813_inclusion-task-handoff-contracto` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because systems must be operable and understandable for diverse users. This specific skill standardizes handoffs between agents and humans.

## Trigger Checklist
- [ ] The task explicitly needs Inclusion Task Handoff Contractor (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Inclusion Task Handoff Contractor.
...
## Operator Use Cases
- Operate Inclusion Task Handoff Contractor as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 73):** release artifacts after validation pass and route to `accessibility-and-inclusion:contract-compiler`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Inclusion Task Handoff Contractor`, including at least three measurable KPIs tied to barriers for disabled and underserved groups.
...
- Scoring weights: `truth=0.19, execution=0.33, safety=0.28, impact=0.20`
- Posture thresholds:
  - `ready`: score >= 73
  - `review`: score >= 54
  - `review_risk`: risk >= 50
...
1. Incident recovery in Accessibility and Inclusion: ingest noisy signals, execute contracted payload schemas, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Inclusion Task Handoff Contractor against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
