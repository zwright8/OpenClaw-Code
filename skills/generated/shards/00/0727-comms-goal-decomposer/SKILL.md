...
## Trigger Checklist
- [ ] The request explicitly needs **Comms Goal Decomposer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms goal decomposer normalization/assessment.
