...
description: Build and operate the "Epistemic Continuous Improvement Planner" capability for Truth-Seeking and Epistemics. Use when outcomes in this capability family are required for production execution.
---
...
## When To Use
Use this skill when you need "Epistemic Continuous Improvement Planner" outcomes for the Truth-Seeking and Epistemics domain with measurable, production-facing outputs.
...
## Handoff Contract
- Produces: Epistemic Continuous Improvement Planner normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Epistemic Continuous Improvement Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Truth-Seeking and Epistemics**
   - Input: noisy upstream payload requiring epistemic continuous improvement planner normalization/assessment.
