...
## Trigger Checklist
- [ ] The request explicitly needs **Crisis Signal Ingestion Normalizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring crisis signal ingestion normalizer normalization/assessment.
