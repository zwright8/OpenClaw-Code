...
description: Build and operate the "Research Confidence Calibration Engine" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Research Confidence Calibration Engine" outcomes in the Scientific Research Systems domain.
...
## Handoff Contract
- Produces: Research Confidence Calibration Engine normalized artifacts; execution scorecard; risk posture
- Consumes: hypotheses; experiments; replication evidence; claims; evidence; confidence traces
- Downstream routing hint: Route next to scientific-research-systems:optimization-engine consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Research Confidence Calibration Engine** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Scientific Research Systems**
   - Input: noisy upstream payload requiring research confidence calibration engine normalization/assessment.
