...
## Metadata
- **Skill ID:** `485`
- **Skill Name:** `u0485-research-confidence-calibration-engine`
...
4. Keep routing aligned with `scientific-research-systems:optimization-engine` and include approval context.
...
- **Downstream Hint:** Route next to scientific-research-systems:optimization-engine consumers with approval-gate context
