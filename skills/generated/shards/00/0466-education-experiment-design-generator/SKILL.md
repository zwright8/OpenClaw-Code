...
description: Build and operate the "Education Experiment Design Generator" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Experiment Design Generator" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Experiment Design Generator normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Experiment Design Generator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education experiment design generator normalization/assessment.
