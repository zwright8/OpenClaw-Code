...
## Trigger Checklist
- [ ] The request explicitly needs **Research Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring research uncertainty communicator normalization/assessment.
