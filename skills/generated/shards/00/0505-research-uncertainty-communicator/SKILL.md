...
description: Run the Research Uncertainty Communicator capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0505_research-uncertainty-communicato` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Research Uncertainty Communicator (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Uncertainty Communicator.
...
## Operator Use Cases
- Operate Research Uncertainty Communicator as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 74):** release artifacts after validation pass and route to `scientific-research-systems:communication-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Uncertainty Communicator`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.37, execution=0.30, safety=0.20, impact=0.13`
- Posture thresholds:
  - `ready`: score >= 74
  - `review`: score >= 47
  - `review_risk`: risk >= 32
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute confidence-bound communication templates, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Uncertainty Communicator against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
