...
## Trigger Checklist
- [ ] The request explicitly needs **Tooling Security Threat Modeler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Tool Reliability and Execution Quality**
   - Input: noisy upstream payload requiring tooling security threat modeler normalization/assessment.
