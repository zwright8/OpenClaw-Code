---
name: u0507-research-a-b-rollout-governor
description: Run the Research A/B Rollout Governor capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Research A/B Rollout Governor
...
| Feature flag | `skill_0507_research-a-b-rollout-governor` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because research throughput degrades without reproducibility and prioritization. This specific skill controls production risk during behavioral changes.

## Trigger Checklist
- [ ] The task explicitly needs Research A/B Rollout Governor (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research A/B Rollout Governor.
...
## Operator Use Cases
- Operate Research A/B Rollout Governor as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research A/B Rollout Governor`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.23, execution=0.24, safety=0.23, impact=0.30`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 53
  - `review_risk`: risk >= 54
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute staged rollout policies, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research A/B Rollout Governor against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
