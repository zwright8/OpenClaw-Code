---
name: u0017-epistemic-regression-sentinel
description: Run the Epistemic Regression Sentinel capability for Truth-Seeking and Epistemics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0017_epistemic-regression-sentinel` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Epistemic Regression Sentinel (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Epistemic Regression Sentinel.
...
## Operator Use Cases
- Operate Epistemic Regression Sentinel as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 75):** release artifacts after validation pass and route to `truth-seeking-and-epistemics:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Epistemic Regression Sentinel`, including at least three measurable KPIs tied to false certainty and unverified assumptions.
...
- Scoring weights: `truth=0.30, execution=0.28, safety=0.28, impact=0.15`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 53
  - `review_risk`: risk >= 58
...
1. Incident recovery in Truth-Seeking and Epistemics: ingest noisy signals, execute baseline-delta detection, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Epistemic Regression Sentinel against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
