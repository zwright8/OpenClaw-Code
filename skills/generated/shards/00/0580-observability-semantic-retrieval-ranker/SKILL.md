...
## When To Use
Use this skill when the request explicitly needs "Observability Semantic Retrieval Ranker" outcomes in the Data Quality and Observability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Semantic Retrieval Ranker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability semantic retrieval ranker normalization/assessment.
