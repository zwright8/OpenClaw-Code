...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Security Threat Modeler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural security threat modeler normalization/assessment.
