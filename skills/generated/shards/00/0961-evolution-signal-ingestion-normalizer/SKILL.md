...
## When To Use
Use this skill when the request explicitly needs "Evolution Signal Ingestion Normalizer" outcomes in the Autonomous Learning and Evolution domain.
...
- Downstream routing hint: Route next to autonomous-learning-and-evolution:normalization-engine consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Evolution Signal Ingestion Normalizer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring evolution signal ingestion normalizer normalization/assessment.
