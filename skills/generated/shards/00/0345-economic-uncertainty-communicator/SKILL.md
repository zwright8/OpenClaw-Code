...
## When To Use
Use this skill only when the request explicitly needs `Economic Uncertainty Communicator` in the target domain and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Economic Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in the target domain workflows**
   - Input: noisy upstream payload requiring economic uncertainty communicator normalization/assessment.
