---
name: u0693-impact-task-handoff-contractor
description: Run the Impact Task Handoff Contractor capability for Social Impact Measurement with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Impact Task Handoff Contractor
...
| Feature flag | `skill_0693_impact-task-handoff-contractor` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need measurable outcomes, not just activity volume. This specific skill standardizes handoffs between agents and humans.

## Trigger Checklist
- [ ] The task explicitly needs Impact Task Handoff Contractor (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Impact Task Handoff Contractor.
...
## Operator Use Cases
- Operate Impact Task Handoff Contractor as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 77):** release artifacts after validation pass and route to `social-impact-measurement:contract-compiler`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Impact Task Handoff Contractor`, including at least three measurable KPIs tied to impact theater and unmeasured harm.
...
- Scoring weights: `truth=0.26, execution=0.17, safety=0.40, impact=0.17`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 55
  - `review_risk`: risk >= 50
...
1. Incident recovery in Social Impact Measurement: ingest noisy signals, execute contracted payload schemas, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Impact Task Handoff Contractor against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
