---
name: u0240-oversight-continuous-improvement-planner
description: Run the Oversight Continuous Improvement Planner capability for Human Oversight and Operator UX with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Oversight Continuous Improvement Planner
...
| Feature flag | `skill_0240_oversight-continuous-improvement` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because human teams need fast, legible control when stakes are high. This specific skill turns findings into sustained upgrade cycles.

## Trigger Checklist
- [ ] The task explicitly needs Oversight Continuous Improvement Planner (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Oversight Continuous Improvement Planner.
...
## Operator Use Cases
- Operate Oversight Continuous Improvement Planner as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 76):** release artifacts after validation pass and route to `human-oversight-and-operator-ux:planning-router`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Oversight Continuous Improvement Planner`, including at least three measurable KPIs tied to slow interventions and approval bottlenecks.
...
- Scoring weights: `truth=0.34, execution=0.16, safety=0.24, impact=0.26`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 48
  - `review_risk`: risk >= 34
...
1. Incident recovery in Human Oversight and Operator UX: ingest noisy signals, execute closed-loop prioritization, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Oversight Continuous Improvement Planner against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
