...
description: Run the Cultural Explainability Narrative Builder capability for Multilingual and Cultural Adaptation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Routing tag | `multilingual-and-cultural-adaptation:communication-engine` |
| Feature flag | `skill_0784_cultural-explainability-narrativ` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Cultural Explainability Narrative Builder (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Cultural Explainability Narrative Builder.
...
## Operator Use Cases
- Operate Cultural Explainability Narrative Builder as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 76):** release artifacts after validation pass and route to `multilingual-and-cultural-adaptation:communication-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Cultural Explainability Narrative Builder`, including at least three measurable KPIs tied to context mismatch and exclusion.
...
- Scoring weights: `truth=0.33, execution=0.35, safety=0.14, impact=0.17`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 43
  - `review_risk`: risk >= 33
...
1. Incident recovery in Multilingual and Cultural Adaptation: ingest noisy signals, execute reason synthesis and abstraction, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Cultural Explainability Narrative Builder against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
3. Pre-deployment gate: validate artifacts for multilingual-and-cultural-adaptation:communication-engine, enforce approvals, then handoff to downstream orchestrator with next actions.
...
- **Downstream hint:** route only to `multilingual-and-cultural-adaptation:communication-engine` consumers with approval context attached.
