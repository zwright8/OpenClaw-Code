...
## Trigger Checklist
- [ ] The request explicitly needs **Cultural Explainability Narrative Builder** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring cultural explainability narrative builder normalization/assessment.
