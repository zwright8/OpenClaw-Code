...
## Trigger Checklist
- [ ] The request explicitly needs **Community Contradiction Detector** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community contradiction detector normalization/assessment.
