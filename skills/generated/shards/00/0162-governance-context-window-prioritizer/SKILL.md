...
## Metadata
- **Skill ID:** `162`
- **Skill Name:** `u0162-governance-context-window-prioritizer`
...
4. Keep routing aligned with `safety-and-governance:planning-router` and include approval context.
...
- **Downstream Hint:** Route next to safety-and-governance:planning-router consumers with approval-gate context
