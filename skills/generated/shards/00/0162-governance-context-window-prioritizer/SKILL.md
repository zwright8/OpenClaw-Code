---
name: u0162-governance-context-window-prioritizer
description: Run the Governance Context Window Prioritizer capability for Safety and Governance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Governance Context Window Prioritizer
...
| Feature flag | `skill_0162_governance-context-window-priori` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because high-speed autonomy needs enforceable guardrails to stay aligned. This specific skill surfaces the most decision-relevant context under tight token budgets.

## Trigger Checklist
- [ ] The task explicitly needs Governance Context Window Prioritizer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Governance Context Window Prioritizer.
...
## Operator Use Cases
- Operate Governance Context Window Prioritizer as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `safety-and-governance:planning-router`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Governance Context Window Prioritizer`, including at least three measurable KPIs tied to unsafe actions and policy drift.
...
- Scoring weights: `truth=0.23, execution=0.26, safety=0.26, impact=0.25`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 52
  - `review_risk`: risk >= 49
...
1. Incident recovery in Safety and Governance: ingest noisy signals, execute importance scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Governance Context Window Prioritizer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
