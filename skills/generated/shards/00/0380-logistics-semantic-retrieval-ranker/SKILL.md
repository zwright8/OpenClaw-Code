---
name: u0380-logistics-semantic-retrieval-ranker
description: Run the Logistics Semantic Retrieval Ranker capability for Resource Allocation and Logistics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Logistics Semantic Retrieval Ranker
...
| Feature flag | `skill_0380_logistics-semantic-retrieval-ran` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because impact work fails when scarce resources are not routed intelligently. This specific skill improves recall precision for downstream decision quality.

## Trigger Checklist
- [ ] The task explicitly needs Logistics Semantic Retrieval Ranker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Logistics Semantic Retrieval Ranker.
...
## Operator Use Cases
- Operate Logistics Semantic Retrieval Ranker as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Logistics Semantic Retrieval Ranker`, including at least three measurable KPIs tied to supply shortfalls and fairness gaps.
...
- Scoring weights: `truth=0.26, execution=0.26, safety=0.25, impact=0.23`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 44
  - `review_risk`: risk >= 31
...
1. Incident recovery in Resource Allocation and Logistics: ingest noisy signals, execute semantic relevance scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Logistics Semantic Retrieval Ranker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
