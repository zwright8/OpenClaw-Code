...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering self-reflection error taxonomist normalization/assessment.
