...
description: Run the Engineering Self-Reflection Error Taxonomist capability for Software Engineering Automation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0559_engineering-self-reflection-erro` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Engineering Self-Reflection Error Taxonomist (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Engineering Self-Reflection Error Taxonomist.
...
## Operator Use Cases
- Operate Engineering Self-Reflection Error Taxonomist as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 73):** release artifacts after validation pass and route to `software-engineering-automation:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Engineering Self-Reflection Error Taxonomist`, including at least three measurable KPIs tied to regressions and brittle release pipelines.
...
- Scoring weights: `truth=0.32, execution=0.22, safety=0.30, impact=0.16`
- Posture thresholds:
  - `ready`: score >= 73
  - `review`: score >= 47
  - `review_risk`: risk >= 32
...
1. Incident recovery in Software Engineering Automation: ingest noisy signals, execute failure-type clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Engineering Self-Reflection Error Taxonomist against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
