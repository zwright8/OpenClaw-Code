...
## When To Use
Use this skill when you need "Economic Cost-Benefit Forecaster" outputs that will influence production decisions, automated routing, policy posture, or external-facing actions.
...
- Routing tag: economic-optimization:economic-cost-benefit-forecaster
...
## Output Contract
- `economic_cost_benefit_forecaster_report` (structured-report, consumer=orchestrator, guaranteed=true)
- `economic_cost_benefit_forecaster_scorecard` (scorecard, consumer=operator, guaranteed=true)
- `economic_cost_benefit_forecaster_handoff` (handoff-packet, consumer=downstream-skill, guaranteed=true)
...
## Trigger Checklist
- [ ] The request explicitly needs **Economic Cost-Benefit Forecaster** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Economic Optimization**
   - Input: noisy upstream payload requiring economic cost-benefit forecaster normalization/assessment.
