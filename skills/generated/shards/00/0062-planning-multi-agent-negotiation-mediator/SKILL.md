...
## Metadata
- **Skill ID:** `62`
- **Skill Name:** `u0062-planning-multi-agent-negotiation-mediator`
...
4. Keep routing aligned with `strategic-planning-and-decomposition:collaboration-mediator` and include approval context.
...
- **Downstream Hint:** Route next to strategic-planning-and-decomposition:collaboration-mediator consumers with approval-gate context
