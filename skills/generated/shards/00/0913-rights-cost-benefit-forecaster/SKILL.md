...
description: Run the Rights Cost-Benefit Forecaster capability for Legal, Rights, and Compliance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0913_rights-cost-benefit-forecaster` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Rights Cost-Benefit Forecaster (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Rights Cost-Benefit Forecaster.
...
## Operator Use Cases
- Operate Rights Cost-Benefit Forecaster as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 77):** release artifacts after validation pass and route to `legal-rights-and-compliance:simulation-lab`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Rights Cost-Benefit Forecaster`, including at least three measurable KPIs tied to rights violations and compliance penalties.
...
- Scoring weights: `truth=0.26, execution=0.30, safety=0.18, impact=0.26`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 43
  - `review_risk`: risk >= 34
...
1. Incident recovery in Legal, Rights, and Compliance: ingest noisy signals, execute cost-impact simulation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Rights Cost-Benefit Forecaster against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
