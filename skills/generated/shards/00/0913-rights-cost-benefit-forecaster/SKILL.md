...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Cost-Benefit Forecaster** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights cost-benefit forecaster normalization/assessment.
