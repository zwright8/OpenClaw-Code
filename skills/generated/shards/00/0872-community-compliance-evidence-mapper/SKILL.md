...
description: Operate the "Community Compliance Evidence Mapper" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Community Compliance Evidence Mapper" outcomes in the Community Engagement and Feedback domain.
...
## Handoff Contract
- Produces: Community Compliance Evidence Mapper normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Community Compliance Evidence Mapper** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring community compliance evidence mapper normalization/assessment.
