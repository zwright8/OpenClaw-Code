---
name: u0872-community-compliance-evidence-mapper
description: Run the Community Compliance Evidence Mapper capability for Community Engagement and Feedback with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Community Compliance Evidence Mapper
...
| Routing tag | `community-engagement-and-feedback:normalization-engine` |
| Feature flag | `skill_0872_community-compliance-evidence-ma` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because real-world feedback loops are necessary for continuous alignment. This specific skill keeps proof of control coverage continuously current.

## Trigger Checklist
- [ ] The task explicitly needs Community Compliance Evidence Mapper (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Community Compliance Evidence Mapper.
...
## Operator Use Cases
- Operate Community Compliance Evidence Mapper as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `community-engagement-and-feedback:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Community Compliance Evidence Mapper`, including at least three measurable KPIs tied to community trust loss and unaddressed concerns.
...
- Scoring weights: `truth=0.19, execution=0.34, safety=0.17, impact=0.31`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 51
  - `review_risk`: risk >= 41
...
1. Incident recovery in Community Engagement and Feedback: ingest noisy signals, execute requirement-to-evidence mapping, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Community Compliance Evidence Mapper against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
3. Pre-deployment gate: validate artifacts for community-engagement-and-feedback:normalization-engine, enforce approvals, then handoff to downstream orchestrator with next actions.
...
- **Downstream hint:** route only to `community-engagement-and-feedback:normalization-engine` consumers with approval context attached.
