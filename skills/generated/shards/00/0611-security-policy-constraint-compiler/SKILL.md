...
## Metadata
- **Skill ID:** `611`
- **Skill Name:** `u0611-security-policy-constraint-compiler`
...
4. Keep routing aligned with `security-and-privacy:contract-compiler` and include approval context.
...
- **Downstream Hint:** Route next to security-and-privacy:contract-compiler consumers with approval-gate context
