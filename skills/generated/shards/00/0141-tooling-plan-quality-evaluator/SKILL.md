...
- The task explicitly requires `u0141-tooling-plan-quality-evaluator` outcomes in the declared domain and cannot be handled by a simpler upstream capability.
