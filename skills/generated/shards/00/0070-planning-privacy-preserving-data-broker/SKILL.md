---
name: u0070-planning-privacy-preserving-data-broker
description: Run the Planning Privacy Preserving Data Broker capability for Strategic Planning and Decomposition with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Planning Privacy Preserving Data Broker
...
| Feature flag | `skill_0070_planning-privacy-preserving-data` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because large goals fail when decomposition is inconsistent or incomplete. This specific skill enables collaboration while minimizing raw data exposure.

## Trigger Checklist
- [ ] The task explicitly needs Planning Privacy Preserving Data Broker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Planning Privacy Preserving Data Broker.
...
## Operator Use Cases
- Operate Planning Privacy Preserving Data Broker as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 71):** release artifacts after validation pass and route to `strategic-planning-and-decomposition:collaboration-mediator`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Planning Privacy Preserving Data Broker`, including at least three measurable KPIs tied to execution stalls and hidden dependency failures.
...
- Scoring weights: `truth=0.17, execution=0.27, safety=0.32, impact=0.24`
- Posture thresholds:
  - `ready`: score >= 71
  - `review`: score >= 51
  - `review_risk`: risk >= 42
...
1. Incident recovery in Strategic Planning and Decomposition: ingest noisy signals, execute policy-scoped data mediation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Planning Privacy Preserving Data Broker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
