...
description: Build and operate the "Logistics Regression Sentinel" capability for Resource Allocation and Logistics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Logistics Regression Sentinel" outcomes in the Resource Allocation and Logistics domain.
