---
name: u0377-logistics-regression-sentinel
description: Run the Logistics Regression Sentinel capability for Resource Allocation and Logistics with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Logistics Regression Sentinel
...
| Feature flag | `skill_0377_logistics-regression-sentinel` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because impact work fails when scarce resources are not routed intelligently. This specific skill prevents unnoticed quality drift after updates.

## Trigger Checklist
- [ ] The task explicitly needs Logistics Regression Sentinel (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Logistics Regression Sentinel.
...
## Operator Use Cases
- Operate Logistics Regression Sentinel as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 70):** release artifacts after validation pass and route to `resource-allocation-and-logistics:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Logistics Regression Sentinel`, including at least three measurable KPIs tied to supply shortfalls and fairness gaps.
...
- Scoring weights: `truth=0.24, execution=0.24, safety=0.19, impact=0.33`
- Posture thresholds:
  - `ready`: score >= 70
  - `review`: score >= 54
  - `review_risk`: risk >= 60
...
1. Incident recovery in Resource Allocation and Logistics: ingest noisy signals, execute baseline-delta detection, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Logistics Regression Sentinel against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
