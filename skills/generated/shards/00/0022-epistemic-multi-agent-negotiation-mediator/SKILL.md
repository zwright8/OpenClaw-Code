...
## Metadata
- **Skill ID:** `22`
- **Skill Name:** `u0022-epistemic-multi-agent-negotiation-mediator`
...
4. Keep routing aligned with `truth-seeking-and-epistemics:collaboration-mediator` and include approval context.
...
- **Downstream Hint:** Route next to truth-seeking-and-epistemics:collaboration-mediator consumers with approval-gate context
