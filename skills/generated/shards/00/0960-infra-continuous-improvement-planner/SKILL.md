...
description: Operate the "Infra Continuous Improvement Planner" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## When To Use
Use this skill when the request explicitly needs "Infra Continuous Improvement Planner" outcomes in the Infrastructure and Sustainability domain.
...
## Handoff Contract
- Produces: Infra Continuous Improvement Planner normalized artifacts; execution scorecard; risk posture
- Consumes: capacity forecasts; energy usage; sustainability metrics; claims; evidence; confidence traces
- Downstream routing hint: Route next to infrastructure-and-sustainability:planning-router consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Continuous Improvement Planner** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra continuous improvement planner normalization/assessment.
