...
## Trigger Checklist
- [ ] The request explicitly needs **Security Community Feedback Harvester** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security community feedback harvester normalization/assessment.
