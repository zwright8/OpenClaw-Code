...
## Metadata
- **Skill ID:** `165`
- **Skill Name:** `u0165-governance-confidence-calibration-engine`
...
4. Keep routing aligned with `safety-and-governance:optimization-engine` and include approval context.
...
- **Downstream Hint:** Route next to safety-and-governance:optimization-engine consumers with approval-gate context
