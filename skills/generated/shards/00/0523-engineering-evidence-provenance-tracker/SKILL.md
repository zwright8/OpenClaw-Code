...
## Metadata
- **Skill ID:** `523`
- **Skill Name:** `u0523-engineering-evidence-provenance-tracker`
...
4. Keep routing aligned with `software-engineering-automation:provenance-tracker` and include approval context.
...
- **Downstream Hint:** Route next to software-engineering-automation:provenance-tracker consumers with approval-gate context
