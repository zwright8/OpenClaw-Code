---
name: u0099-memory-knowledge-graph-linker
description: Run the Memory Knowledge Graph Linker capability for Memory and Knowledge Operations with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Memory Knowledge Graph Linker
...
| Feature flag | `skill_0099_memory-knowledge-graph-linker` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Memory Knowledge Graph Linker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Memory Knowledge Graph Linker.
...
## Operator Use Cases
- Operate Memory Knowledge Graph Linker as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Memory Knowledge Graph Linker`, including at least three measurable KPIs tied to repeated mistakes and context loss.
...
- Scoring weights: `truth=0.28, execution=0.15, safety=0.29, impact=0.27`
- Posture thresholds:
  - `ready`: score >= 76
  - `review`: score >= 47
  - `review_risk`: risk >= 37
...
1. Incident recovery in Memory and Knowledge Operations: ingest noisy signals, execute entity and relation linking, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Memory Knowledge Graph Linker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
