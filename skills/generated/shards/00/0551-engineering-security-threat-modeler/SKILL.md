...
description: Operate the "Engineering Security Threat Modeler" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `551`
- **Skill Name:** `u0551-engineering-security-threat-modeler`
...
4. Keep routing aligned with `software-engineering-automation:detection-guard` and include approval context.
...
### Handoff Contract
- **Produces:** `Engineering Security Threat Modeler normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `code changes`, `tests`, `incidents`, `rollout data`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to software-engineering-automation:detection-guard consumers with approval-gate context
