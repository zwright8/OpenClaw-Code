---
name: u0551-engineering-security-threat-modeler
description: Run the Engineering Security Threat Modeler capability for Software Engineering Automation with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Engineering Security Threat Modeler
...
| Feature flag | `skill_0551_engineering-security-threat-mode` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because delivery speed must increase without sacrificing correctness. This specific skill anticipates attack paths before adversaries exploit them.

## Trigger Checklist
- [ ] The task explicitly needs Engineering Security Threat Modeler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Engineering Security Threat Modeler.
...
## Operator Use Cases
- Operate Engineering Security Threat Modeler as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `software-engineering-automation:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Engineering Security Threat Modeler`, including at least three measurable KPIs tied to regressions and brittle release pipelines.
...
- Scoring weights: `truth=0.31, execution=0.13, safety=0.35, impact=0.21`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 55
  - `review_risk`: risk >= 58
...
1. Incident recovery in Software Engineering Automation: ingest noisy signals, execute attack-surface modeling, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Engineering Security Threat Modeler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
