...
## When To Use
Use this skill when the request explicitly needs "Engineering Security Threat Modeler" outcomes in the Software Engineering Automation domain.
...
- Downstream routing hint: Route next to software-engineering-automation:detection-guard consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Engineering Security Threat Modeler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring engineering security threat modeler normalization/assessment.
