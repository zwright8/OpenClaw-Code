...
## When To Use
Use this skill when the request explicitly needs "Comms KPI Dashboard Publisher" outcomes in the Communication and Explainability domain.
...
## Trigger Checklist
- [ ] The request explicitly needs **Comms KPI Dashboard Publisher** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring comms kpi dashboard publisher normalization/assessment.
