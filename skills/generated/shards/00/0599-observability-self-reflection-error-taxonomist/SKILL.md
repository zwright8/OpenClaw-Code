...
description: Run the Observability Self-Reflection Error Taxonomist capability for Data Quality and Observability with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_0599_observability-self-reflection-er` |
| Release cycles | `2` |
...
## Trigger Checklist
- [ ] The task explicitly needs Observability Self-Reflection Error Taxonomist (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Observability Self-Reflection Error Taxonomist.
...
## Operator Use Cases
- Operate Observability Self-Reflection Error Taxonomist as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 75):** release artifacts after validation pass and route to `data-quality-and-observability:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Observability Self-Reflection Error Taxonomist`, including at least three measurable KPIs tied to data drift and blind spots.
...
- Scoring weights: `truth=0.15, execution=0.17, safety=0.33, impact=0.36`
- Posture thresholds:
  - `ready`: score >= 75
  - `review`: score >= 61
  - `review_risk`: risk >= 51
...
1. Incident recovery in Data Quality and Observability: ingest noisy signals, execute failure-type clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Observability Self-Reflection Error Taxonomist against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
