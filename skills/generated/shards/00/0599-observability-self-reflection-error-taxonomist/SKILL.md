...
## Trigger Checklist
- [ ] The request explicitly needs **Observability Self-Reflection Error Taxonomist** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring observability self-reflection error taxonomist normalization/assessment.
