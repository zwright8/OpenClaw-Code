---
name: u0075-planning-community-feedback-harvester
description: Run the Planning Community Feedback Harvester capability for Strategic Planning and Decomposition with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Planning Community Feedback Harvester
...
| Feature flag | `skill_0075_planning-community-feedback-harv` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because large goals fail when decomposition is inconsistent or incomplete. This specific skill integrates lived user feedback into planning cycles.

## Trigger Checklist
- [ ] The task explicitly needs Planning Community Feedback Harvester (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Planning Community Feedback Harvester.
...
## Operator Use Cases
- Operate Planning Community Feedback Harvester as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `strategic-planning-and-decomposition:normalization-engine`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Planning Community Feedback Harvester`, including at least three measurable KPIs tied to execution stalls and hidden dependency failures.
...
- Scoring weights: `truth=0.28, execution=0.18, safety=0.20, impact=0.34`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 62
  - `review_risk`: risk >= 52
...
1. Incident recovery in Strategic Planning and Decomposition: ingest noisy signals, execute feedback normalization and clustering, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Planning Community Feedback Harvester against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
