...
## Trigger Checklist
- [ ] The request explicitly needs **Security Goal Decomposer** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring security goal decomposer normalization/assessment.
