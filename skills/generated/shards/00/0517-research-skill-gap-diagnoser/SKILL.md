---
name: u0517-research-skill-gap-diagnoser
description: Run the Research Skill Gap Diagnoser capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Research Skill Gap Diagnoser
...
| Feature flag | `skill_0517_research-skill-gap-diagnoser` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because research throughput degrades without reproducibility and prioritization. This specific skill identifies where agents and humans need capability upgrades.

## Trigger Checklist
- [ ] The task explicitly needs Research Skill Gap Diagnoser (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Skill Gap Diagnoser.
...
## Operator Use Cases
- Operate Research Skill Gap Diagnoser as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 79):** release artifacts after validation pass and route to `scientific-research-systems:general-capability`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Skill Gap Diagnoser`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.29, execution=0.27, safety=0.28, impact=0.16`
- Posture thresholds:
  - `ready`: score >= 79
  - `review`: score >= 42
  - `review_risk`: risk >= 38
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute competency coverage analysis, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Skill Gap Diagnoser against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
