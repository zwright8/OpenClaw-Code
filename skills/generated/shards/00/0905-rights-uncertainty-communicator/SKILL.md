...
## Trigger Checklist
- [ ] The request explicitly needs **Rights Uncertainty Communicator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring rights uncertainty communicator normalization/assessment.
