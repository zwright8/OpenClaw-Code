...
description: Operate the "Rights Uncertainty Communicator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `905`
- **Skill Name:** `u0905-rights-uncertainty-communicator`
- **Domain:** `Legal, Rights, and Compliance`
- **Domain Slug:** `legal-rights-and-compliance`
...
|---|---|---|---|
| requirements mappings | signal | true | upstream |
| legal decisions | signal | true | upstream |
| evidence trails | signal | true | upstream |
...
4. Keep routing aligned with `legal-rights-and-compliance:communication-engine` and include approval context.
...
- **Week:** Review KPI focus (`rights violations`, `compliance penalties`, `decision drift`), failure trends, and approval/retry performance.
...
### Handoff Contract
- **Produces:** `Rights Uncertainty Communicator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `requirements mappings`, `legal decisions`, `evidence trails`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to legal-rights-and-compliance:communication-engine consumers with approval-gate context
