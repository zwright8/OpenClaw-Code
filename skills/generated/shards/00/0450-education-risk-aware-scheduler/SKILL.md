---
name: u0450-education-risk-aware-scheduler
description: Run the Education Risk-Aware Scheduler capability for Education and Upskilling with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Education Risk-Aware Scheduler
...
| Feature flag | `skill_0450_education-risk-aware-scheduler` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because human capability growth requires targeted planning under constraints. This specific skill times execution based on risk posture instead of urgency alone.

## Trigger Checklist
- [ ] The task explicitly needs Education Risk-Aware Scheduler (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Education Risk-Aware Scheduler.
...
## Operator Use Cases
- Operate Education Risk-Aware Scheduler as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 78):** release artifacts after validation pass and route to `education-and-upskilling:planning-router`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Education Risk-Aware Scheduler`, including at least three measurable KPIs tied to persistent skill gaps and poor learning outcomes.
...
- Scoring weights: `truth=0.18, execution=0.37, safety=0.15, impact=0.30`
- Posture thresholds:
  - `ready`: score >= 78
  - `review`: score >= 60
  - `review_risk`: risk >= 53
...
1. Incident recovery in Education and Upskilling: ingest noisy signals, execute risk-weighted sequencing, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Education Risk-Aware Scheduler against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
