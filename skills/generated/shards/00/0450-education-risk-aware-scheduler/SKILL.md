...
description: Build and operate the "Education Risk-Aware Scheduler" capability for Education and Upskilling. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Education Risk-Aware Scheduler" outcomes in the Education and Upskilling domain.
...
## Handoff Contract
- Produces: Education Risk-Aware Scheduler normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Education Risk-Aware Scheduler** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Education and Upskilling**
   - Input: noisy upstream payload requiring education risk-aware scheduler normalization/assessment.
