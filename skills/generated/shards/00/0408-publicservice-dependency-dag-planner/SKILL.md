...
## Metadata
- **Skill ID:** `408`
- **Skill Name:** `u0408-publicservice-dependency-dag-planner`
...
### Handoff Contract
- **Produces:** `PublicService Dependency DAG Planner normalized artifacts`, `execution scorecard`, `risk posture`
