---
name: u0897-rights-regression-sentinel
description: Run the Rights Regression Sentinel capability for Legal, Rights, and Compliance with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Rights Regression Sentinel
...
| Feature flag | `skill_0897_rights-regression-sentinel` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because operations must preserve rights and satisfy jurisdictional obligations. This specific skill prevents unnoticed quality drift after updates.

## Trigger Checklist
- [ ] The task explicitly needs Rights Regression Sentinel (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Rights Regression Sentinel.
...
## Operator Use Cases
- Operate Rights Regression Sentinel as a reliable, reusable production workflow.
...
## Posture Playbook
- **Ready posture (score >= 80):** release artifacts after validation pass and route to `legal-rights-and-compliance:detection-guard`.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Rights Regression Sentinel`, including at least three measurable KPIs tied to rights violations and compliance penalties.
...
- Scoring weights: `truth=0.27, execution=0.25, safety=0.26, impact=0.22`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 58
  - `review_risk`: risk >= 46
...
1. Incident recovery in Legal, Rights, and Compliance: ingest noisy signals, execute baseline-delta detection, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Rights Regression Sentinel against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
