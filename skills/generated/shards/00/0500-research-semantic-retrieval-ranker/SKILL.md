---
name: u0500-research-semantic-retrieval-ranker
description: Run the Research Semantic Retrieval Ranker capability for Scientific Research Systems with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Research Semantic Retrieval Ranker
...
| Feature flag | `skill_0500_research-semantic-retrieval-rank` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because research throughput degrades without reproducibility and prioritization. This specific skill improves recall precision for downstream decision quality.

## Trigger Checklist
- [ ] The task explicitly needs Research Semantic Retrieval Ranker (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Research Semantic Retrieval Ranker.
...
## Operator Use Cases
- Operate Research Semantic Retrieval Ranker as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Research Semantic Retrieval Ranker`, including at least three measurable KPIs tied to non-reproducible results and wasted cycles.
...
- Scoring weights: `truth=0.19, execution=0.24, safety=0.31, impact=0.25`
- Posture thresholds:
  - `ready`: score >= 80
  - `review`: score >= 61
  - `review_risk`: risk >= 54
...
1. Incident recovery in Scientific Research Systems: ingest noisy signals, execute semantic relevance scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Research Semantic Retrieval Ranker against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
