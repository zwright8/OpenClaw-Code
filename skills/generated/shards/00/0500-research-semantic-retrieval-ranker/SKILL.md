...
description: Build and operate the "Research Semantic Retrieval Ranker" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Research Semantic Retrieval Ranker" outcomes in the Scientific Research Systems domain.
...
## Handoff Contract
- Produces: Research Semantic Retrieval Ranker normalized artifacts; execution scorecard; risk posture
...
## Trigger Checklist
- [ ] The request explicitly needs **Research Semantic Retrieval Ranker** outcomes (not generic brainstorming).
...
1. **Incident stabilization in Scientific Research Systems**
   - Input: noisy upstream payload requiring research semantic retrieval ranker normalization/assessment.
