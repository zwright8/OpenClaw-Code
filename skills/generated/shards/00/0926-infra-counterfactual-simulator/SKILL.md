...
description: Operate the "Infra Counterfactual Simulator" capability in production for  workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `926`
- **Skill Name:** `u0926-infra-counterfactual-simulator`
...
4. Keep routing aligned with `infrastructure-and-sustainability:simulation-lab` and include approval context.
...
### Handoff Contract
- **Produces:** `Infra Counterfactual Simulator normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `capacity forecasts`, `energy usage`, `sustainability metrics`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to infrastructure-and-sustainability:simulation-lab consumers with approval-gate context
