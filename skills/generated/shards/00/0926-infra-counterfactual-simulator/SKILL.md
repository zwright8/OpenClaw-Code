...
## When To Use
Use this skill when the request explicitly needs "Infra Counterfactual Simulator" outcomes in the Infrastructure and Sustainability domain.
...
- Downstream routing hint: Route next to infrastructure-and-sustainability:simulation-lab consumers with approval-gate context
...
## Trigger Checklist
- [ ] The request explicitly needs **Infra Counterfactual Simulator** outcomes (not generic brainstorming).
...
1. **Incident stabilization in workflows**
   - Input: noisy upstream payload requiring infra counterfactual simulator normalization/assessment.
