...
## Metadata
- **Skill ID:** `245`
- **Skill Name:** `u0245-collab-confidence-calibration-engine`
...
4. Keep routing aligned with `collaboration-and-negotiation:optimization-engine` and include approval context.
...
### Handoff Contract
- **Produces:** `Collab Confidence Calibration Engine normalized artifacts`, `execution scorecard`, `risk posture`
- **Consumes:** `proposals`, `contention signals`, `negotiated outcomes`, `claims`, `evidence`, `confidence traces`
- **Downstream Hint:** Route next to collaboration-and-negotiation:optimization-engine consumers with approval-gate context
