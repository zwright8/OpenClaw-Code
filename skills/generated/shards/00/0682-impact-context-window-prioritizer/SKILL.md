---
name: u0682-impact-context-window-prioritizer
description: Run the Impact Context Window Prioritizer capability for Social Impact Measurement with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---

# Impact Context Window Prioritizer
...
| Feature flag | `skill_0682_impact-context-window-prioritize` |
| Release cycles | `2` |

## Why This Skill Exists
We need this skill because missions need measurable outcomes, not just activity volume. This specific skill surfaces the most decision-relevant context under tight token budgets.

## Trigger Checklist
- [ ] The task explicitly needs Impact Context Window Prioritizer (not generic brainstorming).
...
## Operational Runbook
### Preflight
- Confirm scope, owner, and success criteria for Impact Context Window Prioritizer.
...
## Operator Use Cases
- Operate Impact Context Window Prioritizer as a reliable, reusable production workflow.
...
## Traceability Map
- **Scope:** Define the scope and success metrics for `Impact Context Window Prioritizer`, including at least three measurable KPIs tied to impact theater and unmeasured harm.
...
- Scoring weights: `truth=0.31, execution=0.24, safety=0.27, impact=0.19`
- Posture thresholds:
  - `ready`: score >= 77
  - `review`: score >= 46
  - `review_risk`: risk >= 43
...
1. Incident recovery in Social Impact Measurement: ingest noisy signals, execute importance scoring, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Impact Context Window Prioritizer against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
