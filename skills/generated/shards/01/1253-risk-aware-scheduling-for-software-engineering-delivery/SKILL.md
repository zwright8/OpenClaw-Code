...
## Metadata
- **Skill ID:** `1253`
- **Skill Name:** `u01253-risk-aware-scheduling-for-software-engineering-delivery`
...
3. Produce `risk-aware-scheduling-artifact-software-engineering-delivery` outputs in machine-readable form for orchestrator/operator use.
