...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for software engineering delivery** outcomes (not generic brainstorming).
...
1. **Incident stabilization in software engineering delivery" capability in production for software engineering delivery workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for software engineering delivery normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for software engineering delivery` execution artifacts + scorecard + risk/confidence metadata.
