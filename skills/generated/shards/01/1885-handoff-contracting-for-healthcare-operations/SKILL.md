---
name: u01885-handoff-contracting-for-healthcare-operations
...
| Feature flag | `skill_01885_handoff-contracting` |
| Release cycles | `2` |

## Why This Skill Exists
Use handoff contracting in healthcare operations with emphasis on best-in-class standards, precision, and repeatable excellence.
...
5. Run unit, integration, simulation, and regression suites for Handoff Contracting for healthcare operations under professional mastery conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Handoff Contracting for healthcare operations under professional mastery conditions.
