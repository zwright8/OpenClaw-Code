...
description: Build and operate the "Resource Budget Allocation for product management execution" capability for product management execution. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for product management execution** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **product management execution" capability for product management execution** with measurable acceptance criteria.
...
- **Daily:** Run when new product management execution" capability for product management execution signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in product management execution" capability for product management execution**
   - Input: noisy upstream payload requiring resource budget allocation for product management execution normalization/assessment.
...
## Handoff Contract
- Produces: `Resource Budget Allocation for product management execution` execution artifacts + scorecard + risk/confidence metadata.
