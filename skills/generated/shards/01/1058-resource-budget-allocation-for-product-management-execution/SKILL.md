...
## Metadata
- **Skill ID:** `1058`
- **Skill Name:** `u01058-resource-budget-allocation-for-product-management-execution`
...
3. Produce `resource-budget-allocation-artifact-product-management-execution` outputs in machine-readable form for orchestrator/operator use.
