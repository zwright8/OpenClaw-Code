...
## Metadata
- **Skill ID:** `1518`
- **Skill Name:** `u01518-constraint-compilation-for-supply-chain-resilience`
...
3. Produce `constraint-compilation-artifact-supply-chain-resilience` outputs in machine-readable form for orchestrator/operator use.
