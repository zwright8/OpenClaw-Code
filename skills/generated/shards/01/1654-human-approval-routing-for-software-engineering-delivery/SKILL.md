...
## Metadata
- **Skill ID:** `1654`
- **Skill Name:** `u01654-human-approval-routing-for-software-engineering-delivery`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in software engineering delivery`), failure trends, and approval/retry performance.
