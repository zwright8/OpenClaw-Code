...
## Metadata
- **Skill ID:** `1888`
- **Skill Name:** `u01888-handoff-contracting-for-education-support-services`
...
3. Produce `handoff-contracting-artifact-education-support-services` outputs in machine-readable form for orchestrator/operator use.
