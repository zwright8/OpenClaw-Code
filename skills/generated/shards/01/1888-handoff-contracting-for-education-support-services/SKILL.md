...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for education support services** outcomes (not generic brainstorming).
...
1. **Incident stabilization in education support services" capability in production for education support services workflows**
   - Input: noisy upstream payload requiring handoff contracting for education support services normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for education support services` execution artifacts + scorecard + risk/confidence metadata.
