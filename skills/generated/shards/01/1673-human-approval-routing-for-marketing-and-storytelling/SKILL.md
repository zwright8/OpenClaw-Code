...
description: Operate the "Human Approval Routing for marketing and storytelling" capability in production for marketing and storytelling workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for marketing and storytelling** outcomes (not generic brainstorming).
...
1. **Incident stabilization in marketing and storytelling" capability in production for marketing and storytelling workflows**
   - Input: noisy upstream payload requiring human approval routing for marketing and storytelling normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for marketing and storytelling` execution artifacts + scorecard + risk/confidence metadata.
