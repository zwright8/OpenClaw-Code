...
## Metadata
- **Skill ID:** `1673`
- **Skill Name:** `u01673-human-approval-routing-for-marketing-and-storytelling`
...
3. Produce `human-approval-routing-artifact-marketing-and-storytelling` outputs in machine-readable form for orchestrator/operator use.
