...
## Metadata
- **Skill ID:** `1918`
- **Skill Name:** `u01918-handoff-contracting-for-supply-chain-resilience`
...
3. Produce `handoff-contracting-artifact-supply-chain-resilience` outputs in machine-readable form for orchestrator/operator use.
