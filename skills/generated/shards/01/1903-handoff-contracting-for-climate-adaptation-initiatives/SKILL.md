...
## Metadata
- **Skill ID:** `1903`
- **Skill Name:** `u01903-handoff-contracting-for-climate-adaptation-initiatives`
...
3. Produce `handoff-contracting-artifact-climate-adaptation-initiatives` outputs in machine-readable form for orchestrator/operator use.
