...
## Metadata
- **Skill ID:** `1587`
- **Skill Name:** `u01587-constraint-compilation-for-remote-team-collaboration`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in remote team collaboration`), failure trends, and approval/retry performance.
