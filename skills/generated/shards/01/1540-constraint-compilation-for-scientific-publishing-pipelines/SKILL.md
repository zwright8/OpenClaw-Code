...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for scientific publishing pipelines** outcomes (not generic brainstorming).
...
1. **Incident stabilization in scientific publishing pipelines" capability in production for scientific publishing pipelines workflows**
   - Input: noisy upstream payload requiring constraint compilation for scientific publishing pipelines normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for scientific publishing pipelines` execution artifacts + scorecard + risk/confidence metadata.
