...
## Metadata
- **Skill ID:** `1695`
- **Skill Name:** `u01695-human-approval-routing-for-nonprofit-program-delivery`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in nonprofit program delivery`), failure trends, and approval/retry performance.
