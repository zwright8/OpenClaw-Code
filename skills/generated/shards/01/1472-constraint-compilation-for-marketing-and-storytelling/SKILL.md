...
## Metadata
- **Skill ID:** `1472`
- **Skill Name:** `u01472-constraint-compilation-for-marketing-and-storytelling`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in marketing and storytelling`), failure trends, and approval/retry performance.
