...
## Metadata
- **Skill ID:** `1012`
- **Skill Name:** `u01012-resource-budget-allocation-for-household-logistics`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in household logistics`), failure trends, and approval/retry performance.
