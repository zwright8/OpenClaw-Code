...
## Metadata
- **Skill ID:** `1228`
- **Skill Name:** `u01228-risk-aware-scheduling-for-fitness-and-recovery-training`
...
3. Produce `risk-aware-scheduling-artifact-fitness-and-recovery-training` outputs in machine-readable form for orchestrator/operator use.
