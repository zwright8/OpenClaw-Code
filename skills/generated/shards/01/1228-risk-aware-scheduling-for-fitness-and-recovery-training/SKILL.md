...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for fitness and recovery training** outcomes (not generic brainstorming).
...
1. **Incident stabilization in fitness and recovery training" capability in production for fitness and recovery training workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for fitness and recovery training normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for fitness and recovery training` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **fitness and recovery training" capability in production for fitness and recovery training workflows** depends on **Risk-Aware Scheduling for fitness and recovery training** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
