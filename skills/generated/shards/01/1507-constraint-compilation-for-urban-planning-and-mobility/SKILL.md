...
| Feature flag | `skill_01507_constraint-compilation` |
| Release cycles | `2` |

## Why This Skill Exists
Use constraint compilation in urban planning and mobility with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Constraint Compilation for urban planning and mobility under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Constraint Compilation for urban planning and mobility under pro-humanity impact conditions.
