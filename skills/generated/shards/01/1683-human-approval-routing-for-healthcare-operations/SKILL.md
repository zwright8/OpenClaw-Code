...
## Metadata
- **Skill ID:** `1683`
- **Skill Name:** `u01683-human-approval-routing-for-healthcare-operations`
- **Domain:** `healthcare operations`
- **Domain Slug:** `healthcare-operations`
...
3. Produce `human-approval-routing-artifact-healthcare-operations` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `healthcare-operations:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in healthcare operations`), failure trends, and approval/retry performance.
