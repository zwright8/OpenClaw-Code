...
description: Operate the "Risk-Aware Scheduling for legal and policy workflows" capability in production for legal and policy workflows workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for legal and policy workflows** outcomes (not generic brainstorming).
...
1. **Incident stabilization in legal and policy workflows" capability in production for legal and policy workflows workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for legal and policy workflows normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for legal and policy workflows` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **legal and policy workflows" capability in production for legal and policy workflows workflows** depends on **Risk-Aware Scheduling for legal and policy workflows** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
