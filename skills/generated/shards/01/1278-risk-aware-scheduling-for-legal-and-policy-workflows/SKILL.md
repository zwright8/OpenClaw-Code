...
## Metadata
- **Skill ID:** `1278`
- **Skill Name:** `u01278-risk-aware-scheduling-for-legal-and-policy-workflows`
...
3. Produce `risk-aware-scheduling-artifact-legal-and-policy-workflows` outputs in machine-readable form for orchestrator/operator use.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in legal and policy workflows`), failure trends, and approval/retry performance.
