...
## Metadata
- **Skill ID:** `1368`
- **Skill Name:** `u01368-risk-aware-scheduling-for-arts-and-culture-programming`
...
3. Produce `risk-aware-scheduling-artifact-arts-and-culture-programming` outputs in machine-readable form for orchestrator/operator use.
