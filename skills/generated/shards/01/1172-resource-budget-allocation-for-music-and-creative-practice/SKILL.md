...
## Metadata
- **Skill ID:** `1172`
- **Skill Name:** `u01172-resource-budget-allocation-for-music-and-creative-practice`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in music and creative practice`), failure trends, and approval/retry performance.
