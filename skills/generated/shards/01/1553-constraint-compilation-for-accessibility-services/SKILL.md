...
description: Operate the "Constraint Compilation for accessibility services" capability in production for accessibility services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for accessibility services** outcomes (not generic brainstorming).
...
1. **Incident stabilization in accessibility services" capability in production for accessibility services workflows**
   - Input: noisy upstream payload requiring constraint compilation for accessibility services normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for accessibility services` execution artifacts + scorecard + risk/confidence metadata.
