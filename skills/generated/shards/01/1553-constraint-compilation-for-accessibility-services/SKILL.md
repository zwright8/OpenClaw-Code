...
## Metadata
- **Skill ID:** `1553`
- **Skill Name:** `u01553-constraint-compilation-for-accessibility-services`
...
3. Produce `constraint-compilation-artifact-accessibility-services` outputs in machine-readable form for orchestrator/operator use.
