...
## Metadata
- **Skill ID:** `1893`
- **Skill Name:** `u01893-handoff-contracting-for-nonprofit-program-delivery`
...
3. Produce `handoff-contracting-artifact-nonprofit-program-delivery` outputs in machine-readable form for orchestrator/operator use.
