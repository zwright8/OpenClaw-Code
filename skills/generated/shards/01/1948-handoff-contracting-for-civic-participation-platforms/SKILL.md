...
description: Operate the "Handoff Contracting for civic participation platforms" capability in production for civic participation platforms workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for civic participation platforms** outcomes (not generic brainstorming).
...
1. **Incident stabilization in civic participation platforms" capability in production for civic participation platforms workflows**
   - Input: noisy upstream payload requiring handoff contracting for civic participation platforms normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for civic participation platforms` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **civic participation platforms" capability in production for civic participation platforms workflows** depends on **Handoff Contracting for civic participation platforms** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
