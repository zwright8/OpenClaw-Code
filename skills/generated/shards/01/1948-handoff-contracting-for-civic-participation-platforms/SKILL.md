...
## Metadata
- **Skill ID:** `1948`
- **Skill Name:** `u01948-handoff-contracting-for-civic-participation-platforms`
...
3. Produce `handoff-contracting-artifact-civic-participation-platforms` outputs in machine-readable form for orchestrator/operator use.
