...
## Metadata
- **Skill ID:** `1156`
- **Skill Name:** `u01156-resource-budget-allocation-for-eldercare-coordination`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in eldercare coordination`), failure trends, and approval/retry performance.
