...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for family caregiving systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in family caregiving systems" capability in production for family caregiving systems workflows**
   - Input: noisy upstream payload requiring human approval routing for family caregiving systems normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for family caregiving systems` execution artifacts + scorecard + risk/confidence metadata.
