...
## Metadata
- **Skill ID:** `1657`
- **Skill Name:** `u01657-human-approval-routing-for-product-management-execution`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in product management execution`), failure trends, and approval/retry performance.
