...
## Metadata
- **Skill ID:** `1483`
- **Skill Name:** `u01483-constraint-compilation-for-healthcare-operations`
...
3. Produce `constraint-compilation-artifact-healthcare-operations` outputs in machine-readable form for orchestrator/operator use.
