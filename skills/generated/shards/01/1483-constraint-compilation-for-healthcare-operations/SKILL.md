...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for healthcare operations** outcomes (not generic brainstorming).
...
1. **Incident stabilization in healthcare operations" capability in production for healthcare operations workflows**
   - Input: noisy upstream payload requiring constraint compilation for healthcare operations normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for healthcare operations` execution artifacts + scorecard + risk/confidence metadata.
