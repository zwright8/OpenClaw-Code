...
## Metadata
- **Skill ID:** `1773`
- **Skill Name:** `u01773-human-approval-routing-for-music-and-creative-practice`
...
3. Produce `human-approval-routing-artifact-music-and-creative-practice` outputs in machine-readable form for orchestrator/operator use.
