...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for music and creative practice** outcomes (not generic brainstorming).
...
1. **Incident stabilization in music and creative practice" capability in production for music and creative practice workflows**
   - Input: noisy upstream payload requiring human approval routing for music and creative practice normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for music and creative practice` execution artifacts + scorecard + risk/confidence metadata.
