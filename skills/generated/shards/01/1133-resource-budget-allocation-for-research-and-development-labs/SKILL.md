...
description: Build and operate the "Resource Budget Allocation for research and development labs" capability for research and development labs. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Metadata
- **Skill ID:** `1133`
- **Skill Name:** `u01133-resource-budget-allocation-for-research-and-development-labs`
...
3. Produce `resource-budget-allocation-artifact-research-and-development-lab` outputs in machine-readable form for orchestrator/operator use.
