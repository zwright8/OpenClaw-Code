...
## Metadata
- **Skill ID:** `1159`
- **Skill Name:** `u01159-resource-budget-allocation-for-eldercare-coordination`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in eldercare coordination`), failure trends, and approval/retry performance.
