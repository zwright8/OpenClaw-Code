...
## Metadata
- **Skill ID:** `1491`
- **Skill Name:** `u01491-constraint-compilation-for-nonprofit-program-delivery`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in nonprofit program delivery`), failure trends, and approval/retry performance.
