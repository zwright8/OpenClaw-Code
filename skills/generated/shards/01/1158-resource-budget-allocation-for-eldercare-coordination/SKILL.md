...
description: Operate the "Resource Budget Allocation for eldercare coordination" capability in production for eldercare coordination workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `1158`
- **Skill Name:** `u01158-resource-budget-allocation-for-eldercare-coordination`
- **Domain:** `eldercare coordination`
- **Domain Slug:** `eldercare-coordination`
...
3. Produce `resource-budget-allocation-artifact-eldercare-coordination` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `eldercare-coordination:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in eldercare coordination`), failure trends, and approval/retry performance.
