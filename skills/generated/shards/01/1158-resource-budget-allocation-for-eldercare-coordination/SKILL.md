...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for eldercare coordination** outcomes (not generic brainstorming).
...
1. **Incident stabilization in eldercare coordination" capability in production for eldercare coordination workflows**
   - Input: noisy upstream payload requiring resource budget allocation for eldercare coordination normalization/assessment.
...
## Handoff Contract
- Produces: `Resource Budget Allocation for eldercare coordination` execution artifacts + scorecard + risk/confidence metadata.
