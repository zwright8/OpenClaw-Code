...
## Metadata
- **Skill ID:** `1420`
- **Skill Name:** `u01420-constraint-compilation-for-personal-finance-management`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in personal finance management`), failure trends, and approval/retry performance.
