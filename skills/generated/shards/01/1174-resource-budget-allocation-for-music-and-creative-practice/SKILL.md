...
## Metadata
- **Skill ID:** `1174`
- **Skill Name:** `u01174-resource-budget-allocation-for-music-and-creative-practice`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in music and creative practice`), failure trends, and approval/retry performance.
