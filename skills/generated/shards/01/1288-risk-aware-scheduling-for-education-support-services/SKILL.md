...
description: Operate the "Risk-Aware Scheduling for education support services" capability in production for education support services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for education support services** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **education support services" capability in production for education support services workflows** with measurable acceptance criteria.
...
- **Daily:** Run when new education support services" capability in production for education support services workflows signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in education support services" capability in production for education support services workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for education support services normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for education support services` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **education support services" capability in production for education support services workflows** depends on **Risk-Aware Scheduling for education support services** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
