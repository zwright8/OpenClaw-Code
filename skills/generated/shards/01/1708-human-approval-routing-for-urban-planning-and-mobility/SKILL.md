...
## Metadata
- **Skill ID:** `1708`
- **Skill Name:** `u01708-human-approval-routing-for-urban-planning-and-mobility`
...
3. Produce `human-approval-routing-artifact-urban-planning-and-mobility` outputs in machine-readable form for orchestrator/operator use.
