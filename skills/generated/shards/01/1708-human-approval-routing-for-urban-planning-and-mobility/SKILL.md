...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for urban planning and mobility** outcomes (not generic brainstorming).
...
1. **Incident stabilization in urban planning and mobility" capability in production for urban planning and mobility workflows**
   - Input: noisy upstream payload requiring human approval routing for urban planning and mobility normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for urban planning and mobility` execution artifacts + scorecard + risk/confidence metadata.
