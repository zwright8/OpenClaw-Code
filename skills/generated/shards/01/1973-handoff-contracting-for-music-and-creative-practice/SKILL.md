...
## Metadata
- **Skill ID:** `1973`
- **Skill Name:** `u01973-handoff-contracting-for-music-and-creative-practice`
...
3. Produce `handoff-contracting-artifact-music-and-creative-practice` outputs in machine-readable form for orchestrator/operator use.
