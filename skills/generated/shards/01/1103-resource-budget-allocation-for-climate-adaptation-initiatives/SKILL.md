...
description: Build and operate the "Resource Budget Allocation for climate adaptation initiatives" capability for climate adaptation initiatives. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Metadata
- **Skill ID:** `1103`
- **Skill Name:** `u01103-resource-budget-allocation-for-climate-adaptation-initiatives`
...
3. Produce `resource-budget-allocation-artifact-climate-adaptation-initiativ` outputs in machine-readable form for orchestrator/operator use.
