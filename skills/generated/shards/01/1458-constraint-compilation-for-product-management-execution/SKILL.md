...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for product management execution** outcomes (not generic brainstorming).
...
1. **Incident stabilization in product management execution" capability in production for product management execution workflows**
   - Input: noisy upstream payload requiring constraint compilation for product management execution normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for product management execution` execution artifacts + scorecard + risk/confidence metadata.
