...
## Metadata
- **Skill ID:** `1458`
- **Skill Name:** `u01458-constraint-compilation-for-product-management-execution`
...
3. Produce `constraint-compilation-artifact-product-management-execution` outputs in machine-readable form for orchestrator/operator use.
