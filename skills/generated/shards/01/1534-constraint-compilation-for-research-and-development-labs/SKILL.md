...
## Metadata
- **Skill ID:** `1534`
- **Skill Name:** `u01534-constraint-compilation-for-research-and-development-labs`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in research and development labs`), failure trends, and approval/retry performance.
