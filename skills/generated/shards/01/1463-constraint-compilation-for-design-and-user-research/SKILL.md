...
## Metadata
- **Skill ID:** `1463`
- **Skill Name:** `u01463-constraint-compilation-for-design-and-user-research`
...
3. Produce `constraint-compilation-artifact-design-and-user-research` outputs in machine-readable form for orchestrator/operator use.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in design and user research`), failure trends, and approval/retry performance.
