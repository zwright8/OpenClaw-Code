...
## Metadata
- **Skill ID:** `1543`
- **Skill Name:** `u01543-constraint-compilation-for-community-mediation-programs`
- **Domain:** `community mediation programs`
- **Domain Slug:** `community-mediation-programs`
...
3. Produce `constraint-compilation-artifact-community-mediation-programs` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `community-mediation-programs:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in community mediation programs`), failure trends, and approval/retry performance.
