...
description: Operate the "Constraint Compilation for community mediation programs" capability in production for community mediation programs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for community mediation programs** outcomes (not generic brainstorming).
...
1. **Incident stabilization in community mediation programs" capability in production for community mediation programs workflows**
   - Input: noisy upstream payload requiring constraint compilation for community mediation programs normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for community mediation programs` execution artifacts + scorecard + risk/confidence metadata.
