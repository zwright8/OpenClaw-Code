...
## Metadata
- **Skill ID:** `1853`
- **Skill Name:** `u01853-handoff-contracting-for-software-engineering-delivery`
...
3. Produce `handoff-contracting-artifact-software-engineering-delivery` outputs in machine-readable form for orchestrator/operator use.
