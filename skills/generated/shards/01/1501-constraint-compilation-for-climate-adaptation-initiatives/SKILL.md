...
## Metadata
- **Skill ID:** `1501`
- **Skill Name:** `u01501-constraint-compilation-for-climate-adaptation-initiatives`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in climate adaptation initiatives`), failure trends, and approval/retry performance.
