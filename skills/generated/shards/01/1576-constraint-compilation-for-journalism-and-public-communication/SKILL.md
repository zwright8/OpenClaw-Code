...
## Metadata
- **Skill ID:** `1576`
- **Skill Name:** `u01576-constraint-compilation-for-journalism-and-public-communication`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in journalism and public communication`), failure trends, and approval/retry performance.
