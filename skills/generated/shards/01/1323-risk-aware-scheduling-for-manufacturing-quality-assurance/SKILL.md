...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for manufacturing quality assurance** outcomes (not generic brainstorming).
...
1. **Incident stabilization in manufacturing quality assurance" capability in production for manufacturing quality assurance workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for manufacturing quality assurance normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for manufacturing quality assurance` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **manufacturing quality assurance" capability in production for manufacturing quality assurance workflows** depends on **Risk-Aware Scheduling for manufacturing quality assurance** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
