...
## Metadata
- **Skill ID:** `1323`
- **Skill Name:** `u01323-risk-aware-scheduling-for-manufacturing-quality-assurance`
...
3. Produce `risk-aware-scheduling-artifact-manufacturing-quality-assurance` outputs in machine-readable form for orchestrator/operator use.
