...
## Metadata
- **Skill ID:** `1034`
- **Skill Name:** `u01034-resource-budget-allocation-for-mental-well-being-practices`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in mental well-being practices`), failure trends, and approval/retry performance.
