...
| Feature flag | `skill_01204_risk-aware-scheduling` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Risk-Aware Scheduling for personal health routines under hyper-productive autonomy conditions.
