...
## Metadata
- **Skill ID:** `1296`
- **Skill Name:** `u01296-risk-aware-scheduling-for-disaster-response-networks`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in disaster response networks`), failure trends, and approval/retry performance.
