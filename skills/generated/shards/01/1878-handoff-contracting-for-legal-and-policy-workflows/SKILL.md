...
## Metadata
- **Skill ID:** `1878`
- **Skill Name:** `u01878-handoff-contracting-for-legal-and-policy-workflows`
...
3. Produce `handoff-contracting-artifact-legal-and-policy-workflows` outputs in machine-readable form for orchestrator/operator use.
