...
## Metadata
- **Skill ID:** `1036`
- **Skill Name:** `u01036-resource-budget-allocation-for-lifelong-learning-plans`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in lifelong learning plans`), failure trends, and approval/retry performance.
