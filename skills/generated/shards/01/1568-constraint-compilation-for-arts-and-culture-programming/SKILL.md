...
## Metadata
- **Skill ID:** `1568`
- **Skill Name:** `u01568-constraint-compilation-for-arts-and-culture-programming`
- **Domain:** `arts and culture programming`
- **Domain Slug:** `arts-and-culture-programming`
...
3. Produce `constraint-compilation-artifact-arts-and-culture-programming` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `arts-and-culture-programming:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in arts and culture programming`), failure trends, and approval/retry performance.
