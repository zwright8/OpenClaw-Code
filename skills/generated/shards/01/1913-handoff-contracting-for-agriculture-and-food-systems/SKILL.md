...
## Metadata
- **Skill ID:** `1913`
- **Skill Name:** `u01913-handoff-contracting-for-agriculture-and-food-systems`
...
3. Produce `handoff-contracting-artifact-agriculture-and-food-systems` outputs in machine-readable form for orchestrator/operator use.
