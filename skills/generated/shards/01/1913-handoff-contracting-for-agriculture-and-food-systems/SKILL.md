...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for agriculture and food systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in agriculture and food systems" capability in production for agriculture and food systems workflows**
   - Input: noisy upstream payload requiring handoff contracting for agriculture and food systems normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for agriculture and food systems` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **agriculture and food systems" capability in production for agriculture and food systems workflows** depends on **Handoff Contracting for agriculture and food systems** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
