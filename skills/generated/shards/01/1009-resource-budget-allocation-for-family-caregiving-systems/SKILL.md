...
## Metadata
- **Skill ID:** `1009`
- **Skill Name:** `u01009-resource-budget-allocation-for-family-caregiving-systems`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in family caregiving systems`), failure trends, and approval/retry performance.
