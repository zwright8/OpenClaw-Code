...
## Metadata
- **Skill ID:** `1579`
- **Skill Name:** `u01579-constraint-compilation-for-journalism-and-public-communication`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in journalism and public communication`), failure trends, and approval/retry performance.
