...
## Metadata
- **Skill ID:** `1740`
- **Skill Name:** `u01740-human-approval-routing-for-scientific-publishing-pipelines`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in scientific publishing pipelines`), failure trends, and approval/retry performance.
