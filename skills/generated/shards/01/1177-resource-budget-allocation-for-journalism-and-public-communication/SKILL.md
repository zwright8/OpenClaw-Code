...
## Metadata
- **Skill ID:** `1177`
- **Skill Name:** `u01177-resource-budget-allocation-for-journalism-and-public-communication`
...
3. Produce `resource-budget-allocation-artifact-journalism-and-public-commun` outputs in machine-readable form for orchestrator/operator use.
