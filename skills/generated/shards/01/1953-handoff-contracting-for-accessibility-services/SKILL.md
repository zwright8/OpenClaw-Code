...
## Metadata
- **Skill ID:** `1953`
- **Skill Name:** `u01953-handoff-contracting-for-accessibility-services`
...
3. Produce `handoff-contracting-artifact-accessibility-services` outputs in machine-readable form for orchestrator/operator use.
