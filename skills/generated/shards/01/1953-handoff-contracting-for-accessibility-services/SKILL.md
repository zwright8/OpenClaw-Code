...
description: Operate the "Handoff Contracting for accessibility services" capability in production for accessibility services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for accessibility services** outcomes (not generic brainstorming).
...
1. **Incident stabilization in accessibility services" capability in production for accessibility services workflows**
   - Input: noisy upstream payload requiring handoff contracting for accessibility services normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for accessibility services` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **accessibility services" capability in production for accessibility services workflows** depends on **Handoff Contracting for accessibility services** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
