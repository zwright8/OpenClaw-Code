---
name: u01096-resource-budget-allocation-for-disaster-response-networks
...
| Feature flag | `skill_01096_resource-budget-allocation` |
| Release cycles | `2` |

## Why This Skill Exists
Use resource budget allocation in disaster response networks with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Resource Budget Allocation for disaster response networks under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Resource Budget Allocation for disaster response networks under maximally truth-seeking conditions.
