...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for software engineering delivery** outcomes (not generic brainstorming).
...
1. **Incident stabilization in software engineering delivery" capability in production for software engineering delivery workflows**
   - Input: noisy upstream payload requiring constraint compilation for software engineering delivery normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for software engineering delivery` execution artifacts + scorecard + risk/confidence metadata.
