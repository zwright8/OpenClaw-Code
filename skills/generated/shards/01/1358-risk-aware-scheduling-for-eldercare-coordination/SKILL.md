...
## Metadata
- **Skill ID:** `1358`
- **Skill Name:** `u01358-risk-aware-scheduling-for-eldercare-coordination`
...
3. Produce `risk-aware-scheduling-artifact-eldercare-coordination` outputs in machine-readable form for orchestrator/operator use.
