...
## Metadata
- **Skill ID:** `1277`
- **Skill Name:** `u01277-risk-aware-scheduling-for-legal-and-policy-workflows`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in legal and policy workflows`), failure trends, and approval/retry performance.
