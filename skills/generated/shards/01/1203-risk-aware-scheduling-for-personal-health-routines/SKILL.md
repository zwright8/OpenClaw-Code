...
## Metadata
- **Skill ID:** `1203`
- **Skill Name:** `u01203-risk-aware-scheduling-for-personal-health-routines`
...
3. Produce `risk-aware-scheduling-artifact-personal-health-routines` outputs in machine-readable form for orchestrator/operator use.
