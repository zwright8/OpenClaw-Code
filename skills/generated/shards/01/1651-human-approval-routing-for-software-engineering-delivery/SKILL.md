...
## Metadata
- **Skill ID:** `1651`
- **Skill Name:** `u01651-human-approval-routing-for-software-engineering-delivery`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in software engineering delivery`), failure trends, and approval/retry performance.
