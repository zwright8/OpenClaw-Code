...
description: Operate the "Human Approval Routing for civic participation platforms" capability in production for civic participation platforms workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for civic participation platforms** outcomes (not generic brainstorming).
...
1. **Incident stabilization in civic participation platforms" capability in production for civic participation platforms workflows**
   - Input: noisy upstream payload requiring human approval routing for civic participation platforms normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for civic participation platforms` execution artifacts + scorecard + risk/confidence metadata.
