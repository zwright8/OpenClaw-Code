...
## Metadata
- **Skill ID:** `1748`
- **Skill Name:** `u01748-human-approval-routing-for-civic-participation-platforms`
...
3. Produce `human-approval-routing-artifact-civic-participation-platforms` outputs in machine-readable form for orchestrator/operator use.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in civic participation platforms`), failure trends, and approval/retry performance.
