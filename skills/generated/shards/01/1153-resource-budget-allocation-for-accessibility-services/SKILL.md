...
## Metadata
- **Skill ID:** `1153`
- **Skill Name:** `u01153-resource-budget-allocation-for-accessibility-services`
- **Domain:** `accessibility services`
- **Domain Slug:** `accessibility-services`
...
3. Produce `resource-budget-allocation-artifact-accessibility-services` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `accessibility-services:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in accessibility services`), failure trends, and approval/retry performance.
