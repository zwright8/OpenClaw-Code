...
## Metadata
- **Skill ID:** `1195`
- **Skill Name:** `u01195-resource-budget-allocation-for-customer-support-operations`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in customer support operations`), failure trends, and approval/retry performance.
