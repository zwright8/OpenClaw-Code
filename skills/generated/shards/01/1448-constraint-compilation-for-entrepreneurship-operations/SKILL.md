...
## Metadata
- **Skill ID:** `1448`
- **Skill Name:** `u01448-constraint-compilation-for-entrepreneurship-operations`
...
3. Produce `constraint-compilation-artifact-entrepreneurship-operations` outputs in machine-readable form for orchestrator/operator use.
