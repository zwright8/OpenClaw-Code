...
description: Operate the "Handoff Contracting for multilingual translation services" capability in production for multilingual translation services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for multilingual translation services** outcomes (not generic brainstorming).
...
1. **Incident stabilization in multilingual translation services" capability in production for multilingual translation services workflows**
   - Input: noisy upstream payload requiring handoff contracting for multilingual translation services normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for multilingual translation services` execution artifacts + scorecard + risk/confidence metadata.
