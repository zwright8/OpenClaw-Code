...
description: Build and operate the "Resource Budget Allocation for cybersecurity operations" capability for cybersecurity operations. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Metadata
- **Skill ID:** `1128`
- **Skill Name:** `u01128-resource-budget-allocation-for-cybersecurity-operations`
...
3. Produce `resource-budget-allocation-artifact-cybersecurity-operations` outputs in machine-readable form for orchestrator/operator use.
