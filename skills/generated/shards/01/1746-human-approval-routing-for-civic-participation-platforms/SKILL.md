...
## Metadata
- **Skill ID:** `1746`
- **Skill Name:** `u01746-human-approval-routing-for-civic-participation-platforms`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in civic participation platforms`), failure trends, and approval/retry performance.
