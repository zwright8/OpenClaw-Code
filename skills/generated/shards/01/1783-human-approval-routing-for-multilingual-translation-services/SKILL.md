...
## Metadata
- **Skill ID:** `1783`
- **Skill Name:** `u01783-human-approval-routing-for-multilingual-translation-services`
...
3. Produce `human-approval-routing-artifact-multilingual-translation-service` outputs in machine-readable form for orchestrator/operator use.
