...
## Metadata
- **Skill ID:** `1593`
- **Skill Name:** `u01593-constraint-compilation-for-customer-support-operations`
...
3. Produce `constraint-compilation-artifact-customer-support-operations` outputs in machine-readable form for orchestrator/operator use.
