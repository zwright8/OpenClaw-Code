...
## Metadata
- **Skill ID:** `1383`
- **Skill Name:** `u01383-risk-aware-scheduling-for-multilingual-translation-services`
...
3. Produce `risk-aware-scheduling-artifact-multilingual-translation-services` outputs in machine-readable form for orchestrator/operator use.
