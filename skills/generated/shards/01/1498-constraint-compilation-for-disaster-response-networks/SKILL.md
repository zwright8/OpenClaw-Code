...
## Metadata
- **Skill ID:** `1498`
- **Skill Name:** `u01498-constraint-compilation-for-disaster-response-networks`
...
- **Feature Flag:** `skill_01498_constraint-compilation`
- **Release Cycles:** `2`
...
3. Produce `constraint-compilation-artifact-disaster-response-networks` outputs in machine-readable form for orchestrator/operator use.
