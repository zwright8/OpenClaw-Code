...
## Metadata
- **Skill ID:** `1469`
- **Skill Name:** `u01469-constraint-compilation-for-sales-and-client-success`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in sales and client success`), failure trends, and approval/retry performance.
