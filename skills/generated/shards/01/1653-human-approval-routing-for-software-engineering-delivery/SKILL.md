...
description: Operate the "Human Approval Routing for software engineering delivery" capability in production for software engineering delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for software engineering delivery** outcomes (not generic brainstorming).
...
1. **Incident stabilization in software engineering delivery" capability in production for software engineering delivery workflows**
   - Input: noisy upstream payload requiring human approval routing for software engineering delivery normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for software engineering delivery` execution artifacts + scorecard + risk/confidence metadata.
