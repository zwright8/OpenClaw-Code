...
## Metadata
- **Skill ID:** `1653`
- **Skill Name:** `u01653-human-approval-routing-for-software-engineering-delivery`
- **Domain:** `software engineering delivery`
- **Domain Slug:** `software-engineering-delivery`
...
3. Produce `human-approval-routing-artifact-software-engineering-delivery` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `software-engineering-delivery:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in software engineering delivery`), failure trends, and approval/retry performance.
