...
## Metadata
- **Skill ID:** `1958`
- **Skill Name:** `u01958-handoff-contracting-for-eldercare-coordination`
...
3. Produce `handoff-contracting-artifact-eldercare-coordination` outputs in machine-readable form for orchestrator/operator use.
