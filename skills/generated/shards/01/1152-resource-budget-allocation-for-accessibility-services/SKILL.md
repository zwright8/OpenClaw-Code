...
## Metadata
- **Skill ID:** `1152`
- **Skill Name:** `u01152-resource-budget-allocation-for-accessibility-services`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in accessibility services`), failure trends, and approval/retry performance.
