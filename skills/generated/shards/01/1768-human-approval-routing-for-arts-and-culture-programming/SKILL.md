...
description: Operate the "Human Approval Routing for arts and culture programming" capability in production for arts and culture programming workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for arts and culture programming** outcomes (not generic brainstorming).
...
1. **Incident stabilization in arts and culture programming" capability in production for arts and culture programming workflows**
   - Input: noisy upstream payload requiring human approval routing for arts and culture programming normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for arts and culture programming` execution artifacts + scorecard + risk/confidence metadata.
