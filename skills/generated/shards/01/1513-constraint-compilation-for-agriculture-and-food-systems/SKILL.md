...
## Metadata
- **Skill ID:** `1513`
- **Skill Name:** `u01513-constraint-compilation-for-agriculture-and-food-systems`
...
3. Produce `constraint-compilation-artifact-agriculture-and-food-systems` outputs in machine-readable form for orchestrator/operator use.
