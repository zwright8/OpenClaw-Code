...
description: Operate the "Risk-Aware Scheduling for supply chain resilience" capability in production for supply chain resilience workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for supply chain resilience** outcomes (not generic brainstorming).
...
1. **Incident stabilization in supply chain resilience" capability in production for supply chain resilience workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for supply chain resilience normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for supply chain resilience` execution artifacts + scorecard + risk/confidence metadata.
