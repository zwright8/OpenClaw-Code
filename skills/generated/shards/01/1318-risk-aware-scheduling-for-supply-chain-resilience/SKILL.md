...
## Metadata
- **Skill ID:** `1318`
- **Skill Name:** `u01318-risk-aware-scheduling-for-supply-chain-resilience`
...
3. Produce `risk-aware-scheduling-artifact-supply-chain-resilience` outputs in machine-readable form for orchestrator/operator use.
