...
description: Operate the "Resource Budget Allocation for multilingual translation services" capability in production for multilingual translation services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for multilingual translation services** outcomes (not generic brainstorming).
...
1. **Incident stabilization in multilingual translation services" capability in production for multilingual translation services workflows**
   - Input: noisy upstream payload requiring resource budget allocation for multilingual translation services normalization/assessment.
...
## Handoff Contract
- Produces: `Resource Budget Allocation for multilingual translation services` execution artifacts + scorecard + risk/confidence metadata.
