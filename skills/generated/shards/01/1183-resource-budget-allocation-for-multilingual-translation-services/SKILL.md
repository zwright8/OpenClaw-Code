...
## Metadata
- **Skill ID:** `1183`
- **Skill Name:** `u01183-resource-budget-allocation-for-multilingual-translation-services`
- **Domain:** `multilingual translation services`
- **Domain Slug:** `multilingual-translation-services`
...
3. Produce `resource-budget-allocation-artifact-multilingual-translation-ser` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `multilingual-translation-services:generalist-engine` and include approval context.
5. Tune thresholds incrementally based on observed KPI drift and incident learnings.

## Musts
- Enforce approval gates: `policy-constraint-check`, `quality-review`.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in multilingual translation services`), failure trends, and approval/retry performance.
