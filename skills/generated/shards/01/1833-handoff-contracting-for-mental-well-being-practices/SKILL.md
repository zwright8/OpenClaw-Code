...
description: Build and operate the "Handoff Contracting for mental well-being practices" capability for mental well-being practices. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for mental well-being practices** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **mental well-being practices" capability for mental well-being practices** with measurable acceptance criteria.
...
- **Daily:** Run when new mental well-being practices" capability for mental well-being practices signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in mental well-being practices" capability for mental well-being practices**
   - Input: noisy upstream payload requiring handoff contracting for mental well-being practices normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for mental well-being practices` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **mental well-being practices" capability for mental well-being practices** depends on **Handoff Contracting for mental well-being practices** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
