...
## Metadata
- **Skill ID:** `1833`
- **Skill Name:** `u01833-handoff-contracting-for-mental-well-being-practices`
...
3. Produce `handoff-contracting-artifact-mental-well-being-practices` outputs in machine-readable form for orchestrator/operator use.
