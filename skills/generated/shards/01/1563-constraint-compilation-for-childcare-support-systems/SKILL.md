...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for childcare support systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in childcare support systems" capability in production for childcare support systems workflows**
   - Input: noisy upstream payload requiring constraint compilation for childcare support systems normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for childcare support systems` execution artifacts + scorecard + risk/confidence metadata.
