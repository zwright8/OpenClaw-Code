...
## Metadata
- **Skill ID:** `1563`
- **Skill Name:** `u01563-constraint-compilation-for-childcare-support-systems`
...
3. Produce `constraint-compilation-artifact-childcare-support-systems` outputs in machine-readable form for orchestrator/operator use.
