...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for journalism and public communication** outcomes (not generic brainstorming).
...
1. **Incident stabilization in journalism and public communication" capability in production for journalism and public communication workflows**
   - Input: noisy upstream payload requiring resource budget allocation for journalism and public communication normalization/assessment.
...
## Handoff Contract
- Produces: `Resource Budget Allocation for journalism and public communication` execution artifacts + scorecard + risk/confidence metadata.
