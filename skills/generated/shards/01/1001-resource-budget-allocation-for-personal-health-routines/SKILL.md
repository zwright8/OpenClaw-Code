...
## Metadata
- **Skill ID:** `1001`
- **Skill Name:** `u01001-resource-budget-allocation-for-personal-health-routines`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in personal health routines`), failure trends, and approval/retry performance.
