...
description: Build and operate the "Resource Budget Allocation for marketing and storytelling" capability for marketing and storytelling. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for marketing and storytelling** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **marketing and storytelling" capability for marketing and storytelling** with measurable acceptance criteria.
...
- **Daily:** Run when new marketing and storytelling" capability for marketing and storytelling signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in marketing and storytelling" capability for marketing and storytelling**
   - Input: noisy upstream payload requiring resource budget allocation for marketing and storytelling normalization/assessment.
...
## Handoff Contract
- Produces: `Resource Budget Allocation for marketing and storytelling` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **marketing and storytelling" capability for marketing and storytelling** depends on **Resource Budget Allocation for marketing and storytelling** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
