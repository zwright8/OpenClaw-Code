...
## Metadata
- **Skill ID:** `1073`
- **Skill Name:** `u01073-resource-budget-allocation-for-marketing-and-storytelling`
...
3. Produce `resource-budget-allocation-artifact-marketing-and-storytelling` outputs in machine-readable form for orchestrator/operator use.
