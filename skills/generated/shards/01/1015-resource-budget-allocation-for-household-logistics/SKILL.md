...
## Metadata
- **Skill ID:** `1015`
- **Skill Name:** `u01015-resource-budget-allocation-for-household-logistics`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in household logistics`), failure trends, and approval/retry performance.
