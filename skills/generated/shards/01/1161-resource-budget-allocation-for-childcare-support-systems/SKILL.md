...
## Metadata
- **Skill ID:** `1161`
- **Skill Name:** `u01161-resource-budget-allocation-for-childcare-support-systems`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in childcare support systems`), failure trends, and approval/retry performance.
