...
## Metadata
- **Skill ID:** `1035`
- **Skill Name:** `u01035-resource-budget-allocation-for-mental-well-being-practices`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in mental well-being practices`), failure trends, and approval/retry performance.
