...
## Metadata
- **Skill ID:** `1718`
- **Skill Name:** `u01718-human-approval-routing-for-supply-chain-resilience`
- **Domain:** `supply chain resilience`
- **Domain Slug:** `supply-chain-resilience`
...
3. Produce `human-approval-routing-artifact-supply-chain-resilience` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `supply-chain-resilience:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in supply chain resilience`), failure trends, and approval/retry performance.
