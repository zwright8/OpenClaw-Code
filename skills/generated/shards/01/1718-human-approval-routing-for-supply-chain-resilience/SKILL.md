...
description: Operate the "Human Approval Routing for supply chain resilience" capability in production for supply chain resilience workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for supply chain resilience** outcomes (not generic brainstorming).
...
1. **Incident stabilization in supply chain resilience" capability in production for supply chain resilience workflows**
   - Input: noisy upstream payload requiring human approval routing for supply chain resilience normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for supply chain resilience` execution artifacts + scorecard + risk/confidence metadata.
