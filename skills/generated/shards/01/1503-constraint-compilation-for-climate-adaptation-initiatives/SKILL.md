...
## Metadata
- **Skill ID:** `1503`
- **Skill Name:** `u01503-constraint-compilation-for-climate-adaptation-initiatives`
- **Domain:** `climate adaptation initiatives`
- **Domain Slug:** `climate-adaptation-initiatives`
...
3. Produce `constraint-compilation-artifact-climate-adaptation-initiatives` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `climate-adaptation-initiatives:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in climate adaptation initiatives`), failure trends, and approval/retry performance.
