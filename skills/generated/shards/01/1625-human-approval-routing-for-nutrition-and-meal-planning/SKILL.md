...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for nutrition and meal planning** outcomes (not generic brainstorming).
...
1. **Incident stabilization in nutrition and meal planning" capability in production for nutrition and meal planning workflows**
   - Input: noisy upstream payload requiring human approval routing for nutrition and meal planning normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for nutrition and meal planning` execution artifacts + scorecard + risk/confidence metadata.
