...
## Metadata
- **Skill ID:** `1720`
- **Skill Name:** `u01720-human-approval-routing-for-supply-chain-resilience`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in supply chain resilience`), failure trends, and approval/retry performance.
