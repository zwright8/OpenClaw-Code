...
## Metadata
- **Skill ID:** `1517`
- **Skill Name:** `u01517-constraint-compilation-for-supply-chain-resilience`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in supply chain resilience`), failure trends, and approval/retry performance.
