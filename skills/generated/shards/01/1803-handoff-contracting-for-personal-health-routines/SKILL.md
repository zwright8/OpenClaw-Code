...
## Metadata
- **Skill ID:** `1803`
- **Skill Name:** `u01803-handoff-contracting-for-personal-health-routines`
...
3. Produce `handoff-contracting-artifact-personal-health-routines` outputs in machine-readable form for orchestrator/operator use.
