...
description: Build and operate the "Handoff Contracting for personal health routines" capability for personal health routines. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for personal health routines** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **personal health routines" capability for personal health routines** with measurable acceptance criteria.
...
- **Daily:** Run when new personal health routines" capability for personal health routines signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in personal health routines" capability for personal health routines**
   - Input: noisy upstream payload requiring handoff contracting for personal health routines normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for personal health routines` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **personal health routines" capability for personal health routines** depends on **Handoff Contracting for personal health routines** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
