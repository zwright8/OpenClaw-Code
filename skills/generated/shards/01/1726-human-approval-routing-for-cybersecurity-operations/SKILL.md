...
## Metadata
- **Skill ID:** `1726`
- **Skill Name:** `u01726-human-approval-routing-for-cybersecurity-operations`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in cybersecurity operations`), failure trends, and approval/retry performance.
