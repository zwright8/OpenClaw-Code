...
## Metadata
- **Skill ID:** `1766`
- **Skill Name:** `u01766-human-approval-routing-for-arts-and-culture-programming`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in arts and culture programming`), failure trends, and approval/retry performance.
