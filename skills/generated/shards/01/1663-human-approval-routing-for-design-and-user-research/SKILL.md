...
description: Operate the "Human Approval Routing for design and user research" capability in production for design and user research workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for design and user research** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **design and user research" capability in production for design and user research workflows** with measurable acceptance criteria.
...
- **Daily:** Run when new design and user research" capability in production for design and user research workflows signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in design and user research" capability in production for design and user research workflows**
   - Input: noisy upstream payload requiring human approval routing for design and user research normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for design and user research` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **design and user research" capability in production for design and user research workflows** depends on **Human Approval Routing for design and user research** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
