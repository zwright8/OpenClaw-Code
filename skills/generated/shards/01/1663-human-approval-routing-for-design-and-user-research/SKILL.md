...
## Metadata
- **Skill ID:** `1663`
- **Skill Name:** `u01663-human-approval-routing-for-design-and-user-research`
...
3. Produce `human-approval-routing-artifact-design-and-user-research` outputs in machine-readable form for orchestrator/operator use.
