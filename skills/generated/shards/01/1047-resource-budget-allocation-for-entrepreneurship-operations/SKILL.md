...
## Metadata
- **Skill ID:** `1047`
- **Skill Name:** `u01047-resource-budget-allocation-for-entrepreneurship-operations`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in entrepreneurship operations`), failure trends, and approval/retry performance.
