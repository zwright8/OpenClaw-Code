...
## Metadata
- **Skill ID:** `1093`
- **Skill Name:** `u01093-resource-budget-allocation-for-nonprofit-program-delivery`
...
3. Produce `resource-budget-allocation-artifact-nonprofit-program-delivery` outputs in machine-readable form for orchestrator/operator use.
