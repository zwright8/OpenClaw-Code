...
description: Build and operate the "Resource Budget Allocation for nonprofit program delivery" capability for nonprofit program delivery. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for nonprofit program delivery** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **nonprofit program delivery" capability for nonprofit program delivery** with measurable acceptance criteria.
...
- **Daily:** Run when new nonprofit program delivery" capability for nonprofit program delivery signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in nonprofit program delivery" capability for nonprofit program delivery**
   - Input: noisy upstream payload requiring resource budget allocation for nonprofit program delivery normalization/assessment.
...
## Handoff Contract
- Produces: `Resource Budget Allocation for nonprofit program delivery` execution artifacts + scorecard + risk/confidence metadata.
