...
## Metadata
- **Skill ID:** `1312`
- **Skill Name:** `u01312-risk-aware-scheduling-for-agriculture-and-food-systems`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in agriculture and food systems`), failure trends, and approval/retry performance.
