...
## Metadata
- **Skill ID:** `1863`
- **Skill Name:** `u01863-handoff-contracting-for-design-and-user-research`
...
3. Produce `handoff-contracting-artifact-design-and-user-research` outputs in machine-readable form for orchestrator/operator use.
