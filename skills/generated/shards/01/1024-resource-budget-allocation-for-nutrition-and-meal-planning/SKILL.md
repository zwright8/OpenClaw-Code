...
## Metadata
- **Skill ID:** `1024`
- **Skill Name:** `u01024-resource-budget-allocation-for-nutrition-and-meal-planning`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in nutrition and meal planning`), failure trends, and approval/retry performance.
