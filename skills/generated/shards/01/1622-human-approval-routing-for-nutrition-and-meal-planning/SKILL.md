...
## Metadata
- **Skill ID:** `1622`
- **Skill Name:** `u01622-human-approval-routing-for-nutrition-and-meal-planning`
...
3. Produce `human-approval-routing-artifact-nutrition-and-meal-planning` outputs in machine-readable form for orchestrator/operator use.
