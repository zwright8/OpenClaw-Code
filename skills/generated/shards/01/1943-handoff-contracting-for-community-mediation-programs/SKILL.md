...
## Metadata
- **Skill ID:** `1943`
- **Skill Name:** `u01943-handoff-contracting-for-community-mediation-programs`
...
3. Produce `handoff-contracting-artifact-community-mediation-programs` outputs in machine-readable form for orchestrator/operator use.
