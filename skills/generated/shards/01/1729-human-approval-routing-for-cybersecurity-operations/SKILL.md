...
## Metadata
- **Skill ID:** `1729`
- **Skill Name:** `u01729-human-approval-routing-for-cybersecurity-operations`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in cybersecurity operations`), failure trends, and approval/retry performance.
