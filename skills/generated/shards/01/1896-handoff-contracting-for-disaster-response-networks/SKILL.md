---
name: u01896-handoff-contracting-for-disaster-response-networks
...
| Feature flag | `skill_01896_handoff-contracting` |
| Release cycles | `2` |

## Why This Skill Exists
Use handoff contracting in disaster response networks with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Handoff Contracting for disaster response networks under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Handoff Contracting for disaster response networks under maximally truth-seeking conditions.
