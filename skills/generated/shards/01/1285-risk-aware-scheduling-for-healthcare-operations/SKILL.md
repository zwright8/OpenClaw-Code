...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for healthcare operations** outcomes (not generic brainstorming).
...
1. **Incident stabilization in healthcare operations" capability in production for healthcare operations workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for healthcare operations normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for healthcare operations` execution artifacts + scorecard + risk/confidence metadata.
