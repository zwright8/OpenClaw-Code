...
## Metadata
- **Skill ID:** `1045`
- **Skill Name:** `u01045-resource-budget-allocation-for-career-development-pathways`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in career development pathways`), failure trends, and approval/retry performance.
