...
## Metadata
- **Skill ID:** `1032`
- **Skill Name:** `u01032-resource-budget-allocation-for-mental-well-being-practices`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in mental well-being practices`), failure trends, and approval/retry performance.
