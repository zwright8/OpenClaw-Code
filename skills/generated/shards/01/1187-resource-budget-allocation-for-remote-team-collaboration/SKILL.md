...
## Metadata
- **Skill ID:** `1187`
- **Skill Name:** `u01187-resource-budget-allocation-for-remote-team-collaboration`
...
3. Produce `resource-budget-allocation-artifact-remote-team-collaboration` outputs in machine-readable form for orchestrator/operator use.
