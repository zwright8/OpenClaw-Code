...
## Metadata
- **Skill ID:** `1377`
- **Skill Name:** `u01377-risk-aware-scheduling-for-journalism-and-public-communication`
...
3. Produce `risk-aware-scheduling-artifact-journalism-and-public-communicati` outputs in machine-readable form for orchestrator/operator use.
