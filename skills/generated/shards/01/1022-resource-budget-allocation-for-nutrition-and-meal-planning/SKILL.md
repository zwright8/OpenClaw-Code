...
## Metadata
- **Skill ID:** `1022`
- **Skill Name:** `u01022-resource-budget-allocation-for-nutrition-and-meal-planning`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in nutrition and meal planning`), failure trends, and approval/retry performance.
