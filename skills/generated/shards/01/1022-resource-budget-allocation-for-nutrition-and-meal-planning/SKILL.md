...
## When To Use
Use this skill only when the request explicitly needs `Resource Budget Allocation for nutrition and meal planning` in nutrition and meal planning and a downstream consumer requires contract-bound artifacts.
...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for nutrition and meal planning** outcomes (not generic brainstorming).
...
1. **Incident stabilization in nutrition and meal planning" capability in production for nutrition and meal planning workflows**
   - Input: noisy upstream payload requiring resource budget allocation for nutrition and meal planning normalization/assessment.
