...
## Metadata
- **Skill ID:** `1808`
- **Skill Name:** `u01808-handoff-contracting-for-family-caregiving-systems`
...
3. Produce `handoff-contracting-artifact-family-caregiving-systems` outputs in machine-readable form for orchestrator/operator use.
