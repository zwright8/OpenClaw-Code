...
description: Build and operate the "Handoff Contracting for family caregiving systems" capability for family caregiving systems. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for family caregiving systems** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **family caregiving systems" capability for family caregiving systems** with measurable acceptance criteria.
...
- **Daily:** Run when new family caregiving systems" capability for family caregiving systems signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in family caregiving systems" capability for family caregiving systems**
   - Input: noisy upstream payload requiring handoff contracting for family caregiving systems normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for family caregiving systems` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **family caregiving systems" capability for family caregiving systems** depends on **Handoff Contracting for family caregiving systems** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
