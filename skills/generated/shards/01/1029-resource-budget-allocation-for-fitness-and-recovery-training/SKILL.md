...
## Metadata
- **Skill ID:** `1029`
- **Skill Name:** `u01029-resource-budget-allocation-for-fitness-and-recovery-training`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in fitness and recovery training`), failure trends, and approval/retry performance.
