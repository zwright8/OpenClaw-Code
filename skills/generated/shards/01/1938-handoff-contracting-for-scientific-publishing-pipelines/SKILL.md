...
## Metadata
- **Skill ID:** `1938`
- **Skill Name:** `u01938-handoff-contracting-for-scientific-publishing-pipelines`
...
3. Produce `handoff-contracting-artifact-scientific-publishing-pipelines` outputs in machine-readable form for orchestrator/operator use.
