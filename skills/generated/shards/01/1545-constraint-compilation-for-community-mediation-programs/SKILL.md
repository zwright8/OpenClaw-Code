...
## Metadata
- **Skill ID:** `1545`
- **Skill Name:** `u01545-constraint-compilation-for-community-mediation-programs`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in community mediation programs`), failure trends, and approval/retry performance.
