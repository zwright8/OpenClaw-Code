...
description: Operate the "Resource Budget Allocation for personal health routines" capability in production for personal health routines workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `1003`
- **Skill Name:** `u01003-resource-budget-allocation-for-personal-health-routines`
- **Domain:** `personal health routines`
- **Domain Slug:** `personal-health-routines`
...
3. Produce `resource-budget-allocation-artifact-personal-health-routines` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `personal-health-routines:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in personal health routines`), failure trends, and approval/retry performance.
