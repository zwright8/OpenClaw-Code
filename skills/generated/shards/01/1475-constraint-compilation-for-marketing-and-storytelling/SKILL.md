...
## Metadata
- **Skill ID:** `1475`
- **Skill Name:** `u01475-constraint-compilation-for-marketing-and-storytelling`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in marketing and storytelling`), failure trends, and approval/retry performance.
