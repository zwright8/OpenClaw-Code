---
name: u01881-handoff-contracting-for-healthcare-operations
...
| Feature flag | `skill_01881_handoff-contracting` |
| Release cycles | `2` |

## Why This Skill Exists
Use handoff contracting in healthcare operations with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Handoff Contracting for healthcare operations under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Handoff Contracting for healthcare operations under maximally truth-seeking conditions.
