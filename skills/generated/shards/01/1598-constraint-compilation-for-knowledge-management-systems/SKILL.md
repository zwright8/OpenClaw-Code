...
## Metadata
- **Skill ID:** `1598`
- **Skill Name:** `u01598-constraint-compilation-for-knowledge-management-systems`
...
3. Produce `constraint-compilation-artifact-knowledge-management-systems` outputs in machine-readable form for orchestrator/operator use.
