...
## Metadata
- **Skill ID:** `1868`
- **Skill Name:** `u01868-handoff-contracting-for-sales-and-client-success`
...
3. Produce `handoff-contracting-artifact-sales-and-client-success` outputs in machine-readable form for orchestrator/operator use.
