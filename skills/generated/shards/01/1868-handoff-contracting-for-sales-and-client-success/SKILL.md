...
description: Operate the "Handoff Contracting for sales and client success" capability in production for sales and client success workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for sales and client success** outcomes (not generic brainstorming).
...
1. **Incident stabilization in sales and client success" capability in production for sales and client success workflows**
   - Input: noisy upstream payload requiring handoff contracting for sales and client success normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for sales and client success` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **sales and client success" capability in production for sales and client success workflows** depends on **Handoff Contracting for sales and client success** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
