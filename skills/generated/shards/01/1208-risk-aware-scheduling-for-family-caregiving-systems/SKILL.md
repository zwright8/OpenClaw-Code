...
## Metadata
- **Skill ID:** `1208`
- **Skill Name:** `u01208-risk-aware-scheduling-for-family-caregiving-systems`
...
3. Produce `risk-aware-scheduling-artifact-family-caregiving-systems` outputs in machine-readable form for orchestrator/operator use.
