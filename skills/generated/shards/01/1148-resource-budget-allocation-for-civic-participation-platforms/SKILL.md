...
## Metadata
- **Skill ID:** `1148`
- **Skill Name:** `u01148-resource-budget-allocation-for-civic-participation-platforms`
...
3. Produce `resource-budget-allocation-artifact-civic-participation-platform` outputs in machine-readable form for orchestrator/operator use.
