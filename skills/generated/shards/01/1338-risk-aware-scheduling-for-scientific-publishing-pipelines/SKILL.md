...
## Metadata
- **Skill ID:** `1338`
- **Skill Name:** `u01338-risk-aware-scheduling-for-scientific-publishing-pipelines`
...
3. Produce `risk-aware-scheduling-artifact-scientific-publishing-pipelines` outputs in machine-readable form for orchestrator/operator use.
