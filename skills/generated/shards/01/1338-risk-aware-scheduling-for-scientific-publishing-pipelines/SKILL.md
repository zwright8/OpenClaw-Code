...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for scientific publishing pipelines** outcomes (not generic brainstorming).
...
1. **Incident stabilization in scientific publishing pipelines" capability in production for scientific publishing pipelines workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for scientific publishing pipelines normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for scientific publishing pipelines` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **scientific publishing pipelines" capability in production for scientific publishing pipelines workflows** depends on **Risk-Aware Scheduling for scientific publishing pipelines** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
