...
## Metadata
- **Skill ID:** `1443`
- **Skill Name:** `u01443-constraint-compilation-for-career-development-pathways`
...
- **Feature Flag:** `skill_01443_constraint-compilation`
- **Release Cycles:** `2`
...
3. Produce `constraint-compilation-artifact-career-development-pathways` outputs in machine-readable form for orchestrator/operator use.
