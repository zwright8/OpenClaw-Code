...
## Metadata
- **Skill ID:** `1524`
- **Skill Name:** `u01524-constraint-compilation-for-manufacturing-quality-assurance`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in manufacturing quality assurance`), failure trends, and approval/retry performance.
