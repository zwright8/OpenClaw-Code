...
## Metadata
- **Skill ID:** `1523`
- **Skill Name:** `u01523-constraint-compilation-for-manufacturing-quality-assurance`
- **Domain:** `manufacturing quality assurance`
- **Domain Slug:** `manufacturing-quality-assurance`
...
3. Produce `constraint-compilation-artifact-manufacturing-quality-assurance` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `manufacturing-quality-assurance:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in manufacturing quality assurance`), failure trends, and approval/retry performance.
