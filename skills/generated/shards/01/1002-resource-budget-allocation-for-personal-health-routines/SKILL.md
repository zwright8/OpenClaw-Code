...
## Metadata
- **Skill ID:** `1002`
- **Skill Name:** `u01002-resource-budget-allocation-for-personal-health-routines`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in personal health routines`), failure trends, and approval/retry performance.
