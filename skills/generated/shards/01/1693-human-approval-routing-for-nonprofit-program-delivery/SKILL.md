...
## Metadata
- **Skill ID:** `1693`
- **Skill Name:** `u01693-human-approval-routing-for-nonprofit-program-delivery`
...
3. Produce `human-approval-routing-artifact-nonprofit-program-delivery` outputs in machine-readable form for orchestrator/operator use.
