...
description: Operate the "Constraint Compilation for music and creative practice" capability in production for music and creative practice workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for music and creative practice** outcomes (not generic brainstorming).
...
1. **Incident stabilization in music and creative practice" capability in production for music and creative practice workflows**
   - Input: noisy upstream payload requiring constraint compilation for music and creative practice normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for music and creative practice` execution artifacts + scorecard + risk/confidence metadata.
