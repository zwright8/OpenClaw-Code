...
## Metadata
- **Skill ID:** `1573`
- **Skill Name:** `u01573-constraint-compilation-for-music-and-creative-practice`
...
3. Produce `constraint-compilation-artifact-music-and-creative-practice` outputs in machine-readable form for orchestrator/operator use.
