...
## Metadata
- **Skill ID:** `1287`
- **Skill Name:** `u01287-risk-aware-scheduling-for-education-support-services`
...
3. Produce `risk-aware-scheduling-artifact-education-support-services` outputs in machine-readable form for orchestrator/operator use.
