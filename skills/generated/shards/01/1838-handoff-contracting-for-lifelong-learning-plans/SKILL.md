...
## Metadata
- **Skill ID:** `1838`
- **Skill Name:** `u01838-handoff-contracting-for-lifelong-learning-plans`
...
3. Produce `handoff-contracting-artifact-lifelong-learning-plans` outputs in machine-readable form for orchestrator/operator use.
