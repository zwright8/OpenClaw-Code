...
description: Build and operate the "Handoff Contracting for lifelong learning plans" capability for lifelong learning plans. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for lifelong learning plans** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **lifelong learning plans" capability for lifelong learning plans** with measurable acceptance criteria.
...
- **Daily:** Run when new lifelong learning plans" capability for lifelong learning plans signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in lifelong learning plans" capability for lifelong learning plans**
   - Input: noisy upstream payload requiring handoff contracting for lifelong learning plans normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for lifelong learning plans` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **lifelong learning plans" capability for lifelong learning plans** depends on **Handoff Contracting for lifelong learning plans** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
