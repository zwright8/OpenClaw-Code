...
description: Build and operate the "Human Approval Routing for knowledge management systems" capability for knowledge management systems. Use when this exact capability is required by autonomous or human-guided missions.
---
...
- [ ] Inputs are sufficient to execute in **knowledge management systems" capability for knowledge management systems** with measurable acceptance criteria.
...
- **Daily:** Run when new knowledge management systems" capability for knowledge management systems signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in knowledge management systems" capability for knowledge management systems**
