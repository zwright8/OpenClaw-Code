...
## Metadata
- **Skill ID:** `1280`
- **Skill Name:** `u01280-risk-aware-scheduling-for-legal-and-policy-workflows`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in legal and policy workflows`), failure trends, and approval/retry performance.
