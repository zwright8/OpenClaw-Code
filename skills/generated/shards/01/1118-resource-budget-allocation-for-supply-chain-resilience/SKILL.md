...
description: Build and operate the "Resource Budget Allocation for supply chain resilience" capability for supply chain resilience. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Metadata
- **Skill ID:** `1118`
- **Skill Name:** `u01118-resource-budget-allocation-for-supply-chain-resilience`
...
3. Produce `resource-budget-allocation-artifact-supply-chain-resilience` outputs in machine-readable form for orchestrator/operator use.
