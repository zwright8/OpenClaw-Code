---
name: u01747-human-approval-routing-for-civic-participation-platforms
...
| Feature flag | `skill_01747_human-approval-routing` |
| Release cycles | `2` |

## Why This Skill Exists
Use human approval routing in civic participation platforms with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Human Approval Routing for civic participation platforms under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Human Approval Routing for civic participation platforms under pro-humanity impact conditions.
