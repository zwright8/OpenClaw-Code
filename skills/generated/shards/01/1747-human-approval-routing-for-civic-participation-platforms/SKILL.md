...
## Metadata
- **Skill ID:** `1747`
- **Skill Name:** `u01747-human-approval-routing-for-civic-participation-platforms`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in civic participation platforms`), failure trends, and approval/retry performance.
