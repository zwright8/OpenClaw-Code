...
## Metadata
- **Skill ID:** `1723`
- **Skill Name:** `u01723-human-approval-routing-for-manufacturing-quality-assurance`
...
3. Produce `human-approval-routing-artifact-manufacturing-quality-assurance` outputs in machine-readable form for orchestrator/operator use.
