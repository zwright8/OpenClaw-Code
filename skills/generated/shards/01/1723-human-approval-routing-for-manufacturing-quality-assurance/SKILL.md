...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for manufacturing quality assurance** outcomes (not generic brainstorming).
...
1. **Incident stabilization in manufacturing quality assurance" capability in production for manufacturing quality assurance workflows**
   - Input: noisy upstream payload requiring human approval routing for manufacturing quality assurance normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for manufacturing quality assurance` execution artifacts + scorecard + risk/confidence metadata.
