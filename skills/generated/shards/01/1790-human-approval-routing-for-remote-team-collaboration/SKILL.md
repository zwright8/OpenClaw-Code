...
## Metadata
- **Skill ID:** `1790`
- **Skill Name:** `u01790-human-approval-routing-for-remote-team-collaboration`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in remote team collaboration`), failure trends, and approval/retry performance.
