...
## Metadata
- **Skill ID:** `1007`
- **Skill Name:** `u01007-resource-budget-allocation-for-family-caregiving-systems`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in family caregiving systems`), failure trends, and approval/retry performance.
