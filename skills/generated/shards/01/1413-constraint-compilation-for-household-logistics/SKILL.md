...
description: Operate the "Constraint Compilation for household logistics" capability in production for household logistics workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for household logistics** outcomes (not generic brainstorming).
...
1. **Incident stabilization in household logistics" capability in production for household logistics workflows**
   - Input: noisy upstream payload requiring constraint compilation for household logistics normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for household logistics` execution artifacts + scorecard + risk/confidence metadata.
