...
## Metadata
- **Skill ID:** `1413`
- **Skill Name:** `u01413-constraint-compilation-for-household-logistics`
...
3. Produce `constraint-compilation-artifact-household-logistics` outputs in machine-readable form for orchestrator/operator use.
