...
## Metadata
- **Skill ID:** `1181`
- **Skill Name:** `u01181-resource-budget-allocation-for-multilingual-translation-services`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in multilingual translation services`), failure trends, and approval/retry performance.
