...
## Metadata
- **Skill ID:** `1155`
- **Skill Name:** `u01155-resource-budget-allocation-for-accessibility-services`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in accessibility services`), failure trends, and approval/retry performance.
