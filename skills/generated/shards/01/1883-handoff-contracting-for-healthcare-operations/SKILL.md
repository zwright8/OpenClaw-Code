...
## Metadata
- **Skill ID:** `1883`
- **Skill Name:** `u01883-handoff-contracting-for-healthcare-operations`
...
3. Produce `handoff-contracting-artifact-healthcare-operations` outputs in machine-readable form for orchestrator/operator use.
