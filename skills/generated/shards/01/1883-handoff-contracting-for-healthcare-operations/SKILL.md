...
description: Operate the "Handoff Contracting for healthcare operations" capability in production for healthcare operations workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for healthcare operations** outcomes (not generic brainstorming).
...
1. **Incident stabilization in healthcare operations" capability in production for healthcare operations workflows**
   - Input: noisy upstream payload requiring handoff contracting for healthcare operations normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for healthcare operations` execution artifacts + scorecard + risk/confidence metadata.
