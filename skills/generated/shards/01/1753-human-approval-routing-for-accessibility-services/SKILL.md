...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for accessibility services** outcomes (not generic brainstorming).
...
1. **Incident stabilization in accessibility services" capability in production for accessibility services workflows**
   - Input: noisy upstream payload requiring human approval routing for accessibility services normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for accessibility services` execution artifacts + scorecard + risk/confidence metadata.
