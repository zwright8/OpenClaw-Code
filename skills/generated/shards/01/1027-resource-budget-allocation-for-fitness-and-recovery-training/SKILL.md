...
## Metadata
- **Skill ID:** `1027`
- **Skill Name:** `u01027-resource-budget-allocation-for-fitness-and-recovery-training`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in fitness and recovery training`), failure trends, and approval/retry performance.
