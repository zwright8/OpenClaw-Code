...
## Metadata
- **Skill ID:** `1728`
- **Skill Name:** `u01728-human-approval-routing-for-cybersecurity-operations`
...
3. Produce `human-approval-routing-artifact-cybersecurity-operations` outputs in machine-readable form for orchestrator/operator use.
