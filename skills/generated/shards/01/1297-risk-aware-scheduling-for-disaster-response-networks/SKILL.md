...
## Metadata
- **Skill ID:** `1297`
- **Skill Name:** `u01297-risk-aware-scheduling-for-disaster-response-networks`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in disaster response networks`), failure trends, and approval/retry performance.
