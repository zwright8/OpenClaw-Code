...
## Metadata
- **Skill ID:** `1182`
- **Skill Name:** `u01182-resource-budget-allocation-for-multilingual-translation-services`
...
## Musts
- Enforce approval gates: `policy-constraint-check`, `human-impact-review`.
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in multilingual translation services`), failure trends, and approval/retry performance.
