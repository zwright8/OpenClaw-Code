...
## Metadata
- **Skill ID:** `1466`
- **Skill Name:** `u01466-constraint-compilation-for-sales-and-client-success`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in sales and client success`), failure trends, and approval/retry performance.
