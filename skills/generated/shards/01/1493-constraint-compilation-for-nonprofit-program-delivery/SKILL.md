...
## Metadata
- **Skill ID:** `1493`
- **Skill Name:** `u01493-constraint-compilation-for-nonprofit-program-delivery`
- **Domain:** `nonprofit program delivery`
- **Domain Slug:** `nonprofit-program-delivery`
...
3. Produce `constraint-compilation-artifact-nonprofit-program-delivery` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `nonprofit-program-delivery:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in nonprofit program delivery`), failure trends, and approval/retry performance.
