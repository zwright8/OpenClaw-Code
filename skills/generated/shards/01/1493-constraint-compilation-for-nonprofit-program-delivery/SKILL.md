...
description: Operate the "Constraint Compilation for nonprofit program delivery" capability in production for nonprofit program delivery workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for nonprofit program delivery** outcomes (not generic brainstorming).
...
1. **Incident stabilization in nonprofit program delivery" capability in production for nonprofit program delivery workflows**
   - Input: noisy upstream payload requiring constraint compilation for nonprofit program delivery normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for nonprofit program delivery` execution artifacts + scorecard + risk/confidence metadata.
