...
| Feature flag | `skill_01899_handoff-contracting` |
| Release cycles | `2` |

## Why This Skill Exists
Use handoff contracting in disaster response networks with emphasis on throughput, reliability, leverage, and execution speed.
...
5. Run unit, integration, simulation, and regression suites for Handoff Contracting for disaster response networks under hyper-productive autonomy conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Handoff Contracting for disaster response networks under hyper-productive autonomy conditions.
