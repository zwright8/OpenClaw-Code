...
## Metadata
- **Skill ID:** `1194`
- **Skill Name:** `u01194-resource-budget-allocation-for-customer-support-operations`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in customer support operations`), failure trends, and approval/retry performance.
