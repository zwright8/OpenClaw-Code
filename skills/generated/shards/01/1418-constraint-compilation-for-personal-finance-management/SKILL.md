...
## Metadata
- **Skill ID:** `1418`
- **Skill Name:** `u01418-constraint-compilation-for-personal-finance-management`
...
3. Produce `constraint-compilation-artifact-personal-finance-management` outputs in machine-readable form for orchestrator/operator use.
