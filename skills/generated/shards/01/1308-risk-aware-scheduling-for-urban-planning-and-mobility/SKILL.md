...
## Metadata
- **Skill ID:** `1308`
- **Skill Name:** `u01308-risk-aware-scheduling-for-urban-planning-and-mobility`
...
3. Produce `risk-aware-scheduling-artifact-urban-planning-and-mobility` outputs in machine-readable form for orchestrator/operator use.
