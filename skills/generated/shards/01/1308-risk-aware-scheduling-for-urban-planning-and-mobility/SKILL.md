...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for urban planning and mobility** outcomes (not generic brainstorming).
...
1. **Incident stabilization in urban planning and mobility" capability in production for urban planning and mobility workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for urban planning and mobility normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for urban planning and mobility` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **urban planning and mobility" capability in production for urban planning and mobility workflows** depends on **Risk-Aware Scheduling for urban planning and mobility** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
