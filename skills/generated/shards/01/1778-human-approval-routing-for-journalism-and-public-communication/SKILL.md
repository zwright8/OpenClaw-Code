...
## Metadata
- **Skill ID:** `1778`
- **Skill Name:** `u01778-human-approval-routing-for-journalism-and-public-communication`
- **Domain:** `journalism and public communication`
- **Domain Slug:** `journalism-and-public-communication`
...
3. Produce `human-approval-routing-artifact-journalism-and-public-communicat` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `journalism-and-public-communication:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in journalism and public communication`), failure trends, and approval/retry performance.
