...
## Metadata
- **Skill ID:** `1279`
- **Skill Name:** `u01279-risk-aware-scheduling-for-legal-and-policy-workflows`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in legal and policy workflows`), failure trends, and approval/retry performance.
