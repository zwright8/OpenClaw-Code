---
name: u01477-constraint-compilation-for-legal-and-policy-workflows
...
| Feature flag | `skill_01477_constraint-compilation` |
| Release cycles | `2` |

## Why This Skill Exists
Use constraint compilation in legal and policy workflows with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Constraint Compilation for legal and policy workflows under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Constraint Compilation for legal and policy workflows under pro-humanity impact conditions.
