...
## Metadata
- **Skill ID:** `1525`
- **Skill Name:** `u01525-constraint-compilation-for-manufacturing-quality-assurance`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in manufacturing quality assurance`), failure trends, and approval/retry performance.
