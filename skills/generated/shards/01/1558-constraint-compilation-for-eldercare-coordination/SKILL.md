...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for eldercare coordination** outcomes (not generic brainstorming).
...
1. **Incident stabilization in eldercare coordination" capability in production for eldercare coordination workflows**
   - Input: noisy upstream payload requiring constraint compilation for eldercare coordination normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for eldercare coordination` execution artifacts + scorecard + risk/confidence metadata.
