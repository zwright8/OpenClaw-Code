---
name: u01712-human-approval-routing-for-agriculture-and-food-systems
...
| Feature flag | `skill_01712_human-approval-routing` |
| Release cycles | `2` |

## Why This Skill Exists
Use human approval routing in agriculture and food systems with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Human Approval Routing for agriculture and food systems under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Human Approval Routing for agriculture and food systems under pro-humanity impact conditions.
