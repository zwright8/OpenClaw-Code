...
## Metadata
- **Skill ID:** `1160`
- **Skill Name:** `u01160-resource-budget-allocation-for-eldercare-coordination`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in eldercare coordination`), failure trends, and approval/retry performance.
