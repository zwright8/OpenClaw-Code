...
## Metadata
- **Skill ID:** `1532`
- **Skill Name:** `u01532-constraint-compilation-for-research-and-development-labs`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in research and development labs`), failure trends, and approval/retry performance.
