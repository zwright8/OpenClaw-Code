...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for sales and client success** outcomes (not generic brainstorming).
...
1. **Incident stabilization in sales and client success" capability in production for sales and client success workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for sales and client success normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for sales and client success` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **sales and client success" capability in production for sales and client success workflows** depends on **Risk-Aware Scheduling for sales and client success** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
