...
## Metadata
- **Skill ID:** `1268`
- **Skill Name:** `u01268-risk-aware-scheduling-for-sales-and-client-success`
...
3. Produce `risk-aware-scheduling-artifact-sales-and-client-success` outputs in machine-readable form for orchestrator/operator use.
