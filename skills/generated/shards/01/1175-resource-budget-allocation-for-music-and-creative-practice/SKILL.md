...
## Metadata
- **Skill ID:** `1175`
- **Skill Name:** `u01175-resource-budget-allocation-for-music-and-creative-practice`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in music and creative practice`), failure trends, and approval/retry performance.
