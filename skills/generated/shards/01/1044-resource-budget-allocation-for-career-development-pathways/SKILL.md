...
## Metadata
- **Skill ID:** `1044`
- **Skill Name:** `u01044-resource-budget-allocation-for-career-development-pathways`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in career development pathways`), failure trends, and approval/retry performance.
