...
## Metadata
- **Skill ID:** `1025`
- **Skill Name:** `u01025-resource-budget-allocation-for-nutrition-and-meal-planning`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in nutrition and meal planning`), failure trends, and approval/retry performance.
