...
description: Build and operate the "Handoff Contracting for entrepreneurship operations" capability for entrepreneurship operations. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for entrepreneurship operations** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **entrepreneurship operations" capability for entrepreneurship operations** with measurable acceptance criteria.
...
- **Daily:** Run when new entrepreneurship operations" capability for entrepreneurship operations signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in entrepreneurship operations" capability for entrepreneurship operations**
   - Input: noisy upstream payload requiring handoff contracting for entrepreneurship operations normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for entrepreneurship operations` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **entrepreneurship operations" capability for entrepreneurship operations** depends on **Handoff Contracting for entrepreneurship operations** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
