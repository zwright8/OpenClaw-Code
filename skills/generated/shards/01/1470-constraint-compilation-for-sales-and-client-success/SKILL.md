...
## Metadata
- **Skill ID:** `1470`
- **Skill Name:** `u01470-constraint-compilation-for-sales-and-client-success`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in sales and client success`), failure trends, and approval/retry performance.
