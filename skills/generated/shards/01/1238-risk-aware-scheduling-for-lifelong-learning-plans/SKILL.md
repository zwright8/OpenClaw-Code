...
## Metadata
- **Skill ID:** `1238`
- **Skill Name:** `u01238-risk-aware-scheduling-for-lifelong-learning-plans`
...
3. Produce `risk-aware-scheduling-artifact-lifelong-learning-plans` outputs in machine-readable form for orchestrator/operator use.
