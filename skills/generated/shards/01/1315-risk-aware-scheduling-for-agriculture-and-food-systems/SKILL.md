...
## Metadata
- **Skill ID:** `1315`
- **Skill Name:** `u01315-risk-aware-scheduling-for-agriculture-and-food-systems`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in agriculture and food systems`), failure trends, and approval/retry performance.
