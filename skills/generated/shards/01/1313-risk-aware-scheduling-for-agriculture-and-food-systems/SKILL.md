...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for agriculture and food systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in agriculture and food systems" capability in production for agriculture and food systems workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for agriculture and food systems normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for agriculture and food systems` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **agriculture and food systems" capability in production for agriculture and food systems workflows** depends on **Risk-Aware Scheduling for agriculture and food systems** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
