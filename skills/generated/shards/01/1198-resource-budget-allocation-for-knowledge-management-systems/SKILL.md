...
## Metadata
- **Skill ID:** `1198`
- **Skill Name:** `u01198-resource-budget-allocation-for-knowledge-management-systems`
...
3. Produce `resource-budget-allocation-artifact-knowledge-management-systems` outputs in machine-readable form for orchestrator/operator use.
