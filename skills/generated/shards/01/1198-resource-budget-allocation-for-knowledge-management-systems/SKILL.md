...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for knowledge management systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in knowledge management systems" capability in production for knowledge management systems workflows**
   - Input: noisy upstream payload requiring resource budget allocation for knowledge management systems normalization/assessment.
...
## Handoff Contract
- Produces: `Resource Budget Allocation for knowledge management systems` execution artifacts + scorecard + risk/confidence metadata.
