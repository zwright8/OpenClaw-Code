...
## Metadata
- **Skill ID:** `1428`
- **Skill Name:** `u01428-constraint-compilation-for-fitness-and-recovery-training`
...
3. Produce `constraint-compilation-artifact-fitness-and-recovery-training` outputs in machine-readable form for orchestrator/operator use.
