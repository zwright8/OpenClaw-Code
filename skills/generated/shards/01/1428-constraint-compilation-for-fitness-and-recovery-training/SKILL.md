...
description: Operate the "Constraint Compilation for fitness and recovery training" capability in production for fitness and recovery training workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for fitness and recovery training** outcomes (not generic brainstorming).
...
1. **Incident stabilization in fitness and recovery training" capability in production for fitness and recovery training workflows**
   - Input: noisy upstream payload requiring constraint compilation for fitness and recovery training normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for fitness and recovery training` execution artifacts + scorecard + risk/confidence metadata.
