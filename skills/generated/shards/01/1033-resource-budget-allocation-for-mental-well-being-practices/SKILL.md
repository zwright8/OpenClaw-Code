...
description: Operate the "Resource Budget Allocation for mental well-being practices" capability in production for mental well-being practices workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `1033`
- **Skill Name:** `u01033-resource-budget-allocation-for-mental-well-being-practices`
- **Domain:** `mental well-being practices`
- **Domain Slug:** `mental-well-being-practices`
...
3. Produce `resource-budget-allocation-artifact-mental-well-being-practices` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `mental-well-being-practices:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in mental well-being practices`), failure trends, and approval/retry performance.
