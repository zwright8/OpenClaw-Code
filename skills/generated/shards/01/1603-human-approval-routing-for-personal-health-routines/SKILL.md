...
## Metadata
- **Skill ID:** `1603`
- **Skill Name:** `u01603-human-approval-routing-for-personal-health-routines`
...
3. Produce `human-approval-routing-artifact-personal-health-routines` outputs in machine-readable form for orchestrator/operator use.
