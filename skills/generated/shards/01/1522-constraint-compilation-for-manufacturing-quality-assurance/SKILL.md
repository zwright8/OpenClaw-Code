...
## Metadata
- **Skill ID:** `1522`
- **Skill Name:** `u01522-constraint-compilation-for-manufacturing-quality-assurance`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in manufacturing quality assurance`), failure trends, and approval/retry performance.
