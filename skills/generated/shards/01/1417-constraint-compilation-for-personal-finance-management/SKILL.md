...
## Metadata
- **Skill ID:** `1417`
- **Skill Name:** `u01417-constraint-compilation-for-personal-finance-management`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in personal finance management`), failure trends, and approval/retry performance.
