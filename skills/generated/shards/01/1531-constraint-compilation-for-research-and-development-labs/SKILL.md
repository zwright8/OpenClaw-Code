...
## Metadata
- **Skill ID:** `1531`
- **Skill Name:** `u01531-constraint-compilation-for-research-and-development-labs`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in research and development labs`), failure trends, and approval/retry performance.
