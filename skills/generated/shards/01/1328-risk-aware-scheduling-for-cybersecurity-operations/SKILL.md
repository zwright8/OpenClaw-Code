...
## Metadata
- **Skill ID:** `1328`
- **Skill Name:** `u01328-risk-aware-scheduling-for-cybersecurity-operations`
...
3. Produce `risk-aware-scheduling-artifact-cybersecurity-operations` outputs in machine-readable form for orchestrator/operator use.
