...
## Metadata
- **Skill ID:** `1088`
- **Skill Name:** `u01088-resource-budget-allocation-for-education-support-services`
...
3. Produce `resource-budget-allocation-artifact-education-support-services` outputs in machine-readable form for orchestrator/operator use.
