...
description: Build and operate the "Resource Budget Allocation for education support services" capability for education support services. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for education support services** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **education support services" capability for education support services** with measurable acceptance criteria.
...
- **Daily:** Run when new education support services" capability for education support services signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in education support services" capability for education support services**
   - Input: noisy upstream payload requiring resource budget allocation for education support services normalization/assessment.
...
## Handoff Contract
- Produces: `Resource Budget Allocation for education support services` execution artifacts + scorecard + risk/confidence metadata.
