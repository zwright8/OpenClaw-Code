---
name: u01479-constraint-compilation-for-legal-and-policy-workflows
description: Run the Constraint Compilation for legal and policy workflows capability for legal and policy workflows with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Feature flag | `skill_01479_constraint-compilation` |
| Release cycles | `2` |

## Why This Skill Exists
Use constraint compilation in legal and policy workflows with emphasis on throughput, reliability, leverage, and execution speed.

## Trigger Checklist
- [ ] The task explicitly needs Constraint Compilation for legal and policy workflows (not generic brainstorming).
...
|---|---|---|---|
| constraint-compilation-artifact-legal-and-policy-workflows | structured-artifact | yes | downstream orchestrator |
| constraint-compilation-artifact-legal-and-policy-workflows-scorecard | scorecard | yes | operator / reviewer |
| constraint-compilation-artifact-legal-and-policy-workflows-handoff | handoff-packet | yes | next owner |
...
5. Run unit, integration, simulation, and regression suites for Constraint Compilation for legal and policy workflows under hyper-productive autonomy conditions.
...
## Operator Use Cases
- Run Constraint Compilation for legal and policy workflows as a repeatable production workflow for humans and agents.
- Use Constraint Compilation for legal and policy workflows to accelerate decisions while preserving safety, quality, and auditability.

## Guardrail Policy Matrix
| Guardrail Type | Policy Rule | Automation Hook |
|---|---|---|
| quality | Require unit and integration validations before promoting Constraint Compilation for legal and policy workflows. | run-validation:unit+integration+simulation+regression-baseline |
...
## Traceability Map
- **Scope:** Define measurable outcomes for Constraint Compilation for legal and policy workflows, including baseline and target metrics for legal and policy workflows.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Constraint Compilation for legal and policy workflows under hyper-productive autonomy conditions.
...
1. `Frontier model runtime` -> auth preflight, execute model inference call(s), normalize output, and attach trace to `constraint-compilation-artifact-legal-and-policy-workflows`.
2. `Task/workflow orchestrator` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `constraint-compilation-artifact-legal-and-policy-workflows`.
3. `Telemetry store` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `constraint-compilation-artifact-legal-and-policy-workflows`.
4. `Audit log + immutable storage` -> auth preflight, execute read/query call(s), normalize output, and attach trace to `constraint-compilation-artifact-legal-and-policy-workflows`.
...
1. Incident recovery in legal and policy workflows: ingest noisy signals, execute constraint compilation, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Constraint Compilation for legal and policy workflows against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
...
## Handoff Contract
- **Produces:** `constraint-compilation-artifact-legal-and-policy-workflows`, scorecard, risk/confidence metadata, remediation backlog.
