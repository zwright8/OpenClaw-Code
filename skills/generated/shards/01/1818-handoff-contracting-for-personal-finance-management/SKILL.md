...
description: Build and operate the "Handoff Contracting for personal finance management" capability for personal finance management. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for personal finance management** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **personal finance management" capability for personal finance management** with measurable acceptance criteria.
...
- **Daily:** Run when new personal finance management" capability for personal finance management signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in personal finance management" capability for personal finance management**
   - Input: noisy upstream payload requiring handoff contracting for personal finance management normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for personal finance management` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **personal finance management" capability for personal finance management** depends on **Handoff Contracting for personal finance management** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
