...
## Metadata
- **Skill ID:** `1818`
- **Skill Name:** `u01818-handoff-contracting-for-personal-finance-management`
...
3. Produce `handoff-contracting-artifact-personal-finance-management` outputs in machine-readable form for orchestrator/operator use.
