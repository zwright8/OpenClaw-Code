...
## Metadata
- **Skill ID:** `1031`
- **Skill Name:** `u01031-resource-budget-allocation-for-mental-well-being-practices`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in mental well-being practices`), failure trends, and approval/retry performance.
