...
## Metadata
- **Skill ID:** `1963`
- **Skill Name:** `u01963-handoff-contracting-for-childcare-support-systems`
...
3. Produce `handoff-contracting-artifact-childcare-support-systems` outputs in machine-readable form for orchestrator/operator use.
