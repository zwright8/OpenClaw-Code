...
## Metadata
- **Skill ID:** `1692`
- **Skill Name:** `u01692-human-approval-routing-for-nonprofit-program-delivery`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in nonprofit program delivery`), failure trends, and approval/retry performance.
