...
## Metadata
- **Skill ID:** `1454`
- **Skill Name:** `u01454-constraint-compilation-for-software-engineering-delivery`
...
3. Produce `constraint-compilation-artifact-software-engineering-delivery` outputs in machine-readable form for orchestrator/operator use.
