...
## Metadata
- **Skill ID:** `1736`
- **Skill Name:** `u01736-human-approval-routing-for-scientific-publishing-pipelines`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in scientific publishing pipelines`), failure trends, and approval/retry performance.
