...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for education support services** outcomes (not generic brainstorming).
...
1. **Incident stabilization in education support services" capability in production for education support services workflows**
   - Input: noisy upstream payload requiring human approval routing for education support services normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for education support services` execution artifacts + scorecard + risk/confidence metadata.
