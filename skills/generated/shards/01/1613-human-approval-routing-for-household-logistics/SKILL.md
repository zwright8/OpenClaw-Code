...
description: Operate the "Human Approval Routing for household logistics" capability in production for household logistics workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for household logistics** outcomes (not generic brainstorming).
...
1. **Incident stabilization in household logistics" capability in production for household logistics workflows**
   - Input: noisy upstream payload requiring human approval routing for household logistics normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for household logistics` execution artifacts + scorecard + risk/confidence metadata.
