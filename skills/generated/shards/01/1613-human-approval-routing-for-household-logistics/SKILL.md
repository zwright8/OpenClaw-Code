...
## Metadata
- **Skill ID:** `1613`
- **Skill Name:** `u01613-human-approval-routing-for-household-logistics`
...
3. Produce `human-approval-routing-artifact-household-logistics` outputs in machine-readable form for orchestrator/operator use.
