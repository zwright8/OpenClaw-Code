...
## Metadata
- **Skill ID:** `1243`
- **Skill Name:** `u01243-risk-aware-scheduling-for-career-development-pathways`
...
3. Produce `risk-aware-scheduling-artifact-career-development-pathways` outputs in machine-readable form for orchestrator/operator use.
