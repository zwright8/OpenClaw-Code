...
description: Operate the "Risk-Aware Scheduling for career development pathways" capability in production for career development pathways workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for career development pathways** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **career development pathways" capability in production for career development pathways workflows** with measurable acceptance criteria.
...
- **Daily:** Run when new career development pathways" capability in production for career development pathways workflows signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in career development pathways" capability in production for career development pathways workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for career development pathways normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for career development pathways` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **career development pathways" capability in production for career development pathways workflows** depends on **Risk-Aware Scheduling for career development pathways** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
