...
## Metadata
- **Skill ID:** `1471`
- **Skill Name:** `u01471-constraint-compilation-for-marketing-and-storytelling`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in marketing and storytelling`), failure trends, and approval/retry performance.
