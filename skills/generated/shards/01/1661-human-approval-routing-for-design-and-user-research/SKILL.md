...
## Metadata
- **Skill ID:** `1661`
- **Skill Name:** `u01661-human-approval-routing-for-design-and-user-research`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in design and user research`), failure trends, and approval/retry performance.
