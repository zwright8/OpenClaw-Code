...
## Metadata
- **Skill ID:** `1193`
- **Skill Name:** `u01193-resource-budget-allocation-for-customer-support-operations`
- **Domain:** `customer support operations`
- **Domain Slug:** `customer-support-operations`
...
3. Produce `resource-budget-allocation-artifact-customer-support-operations` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `customer-support-operations:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in customer support operations`), failure trends, and approval/retry performance.
