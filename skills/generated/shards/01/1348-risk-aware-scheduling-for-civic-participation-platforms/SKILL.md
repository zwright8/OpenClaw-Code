...
## Metadata
- **Skill ID:** `1348`
- **Skill Name:** `u01348-risk-aware-scheduling-for-civic-participation-platforms`
...
3. Produce `risk-aware-scheduling-artifact-civic-participation-platforms` outputs in machine-readable form for orchestrator/operator use.
