...
## Metadata
- **Skill ID:** `1505`
- **Skill Name:** `u01505-constraint-compilation-for-climate-adaptation-initiatives`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in climate adaptation initiatives`), failure trends, and approval/retry performance.
