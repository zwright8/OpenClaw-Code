...
## Metadata
- **Skill ID:** `1168`
- **Skill Name:** `u01168-resource-budget-allocation-for-arts-and-culture-programming`
...
3. Produce `resource-budget-allocation-artifact-arts-and-culture-programming` outputs in machine-readable form for orchestrator/operator use.
