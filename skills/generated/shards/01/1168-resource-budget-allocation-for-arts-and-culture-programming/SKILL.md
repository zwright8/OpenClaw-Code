...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for arts and culture programming** outcomes (not generic brainstorming).
...
1. **Incident stabilization in arts and culture programming" capability in production for arts and culture programming workflows**
   - Input: noisy upstream payload requiring resource budget allocation for arts and culture programming normalization/assessment.
...
## Handoff Contract
- Produces: `Resource Budget Allocation for arts and culture programming` execution artifacts + scorecard + risk/confidence metadata.
