...
## Metadata
- **Skill ID:** `1191`
- **Skill Name:** `u01191-resource-budget-allocation-for-customer-support-operations`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in customer support operations`), failure trends, and approval/retry performance.
