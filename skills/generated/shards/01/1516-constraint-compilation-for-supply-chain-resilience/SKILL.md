...
## Metadata
- **Skill ID:** `1516`
- **Skill Name:** `u01516-constraint-compilation-for-supply-chain-resilience`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in supply chain resilience`), failure trends, and approval/retry performance.
