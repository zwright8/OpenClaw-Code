...
description: Operate the "Human Approval Routing for community mediation programs" capability in production for community mediation programs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for community mediation programs** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **community mediation programs" capability in production for community mediation programs workflows** with measurable acceptance criteria.
...
- **Daily:** Run when new community mediation programs" capability in production for community mediation programs workflows signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in community mediation programs" capability in production for community mediation programs workflows**
   - Input: noisy upstream payload requiring human approval routing for community mediation programs normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for community mediation programs` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **community mediation programs" capability in production for community mediation programs workflows** depends on **Human Approval Routing for community mediation programs** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
