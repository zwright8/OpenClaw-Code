...
## Metadata
- **Skill ID:** `1743`
- **Skill Name:** `u01743-human-approval-routing-for-community-mediation-programs`
...
3. Produce `human-approval-routing-artifact-community-mediation-programs` outputs in machine-readable form for orchestrator/operator use.
