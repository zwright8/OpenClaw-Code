...
## Metadata
- **Skill ID:** `1068`
- **Skill Name:** `u01068-resource-budget-allocation-for-sales-and-client-success`
...
3. Produce `resource-budget-allocation-artifact-sales-and-client-success` outputs in machine-readable form for orchestrator/operator use.
