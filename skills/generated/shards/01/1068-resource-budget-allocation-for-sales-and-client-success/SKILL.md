...
description: Build and operate the "Resource Budget Allocation for sales and client success" capability for sales and client success. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for sales and client success** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **sales and client success" capability for sales and client success** with measurable acceptance criteria.
...
- **Daily:** Run when new sales and client success" capability for sales and client success signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in sales and client success" capability for sales and client success**
   - Input: noisy upstream payload requiring resource budget allocation for sales and client success normalization/assessment.
...
## Handoff Contract
- Produces: `Resource Budget Allocation for sales and client success` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **sales and client success" capability for sales and client success** depends on **Resource Budget Allocation for sales and client success** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
