...
## Metadata
- **Skill ID:** `1005`
- **Skill Name:** `u01005-resource-budget-allocation-for-personal-health-routines`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in personal health routines`), failure trends, and approval/retry performance.
