---
name: u01822-handoff-contracting-for-nutrition-and-meal-planning
...
| Feature flag | `skill_01822_handoff-contracting` |
| Release cycles | `2` |

## Why This Skill Exists
Use handoff contracting in nutrition and meal planning with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Handoff Contracting for nutrition and meal planning under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Handoff Contracting for nutrition and meal planning under pro-humanity impact conditions.
