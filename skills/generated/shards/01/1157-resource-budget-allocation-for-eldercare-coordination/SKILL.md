...
## Metadata
- **Skill ID:** `1157`
- **Skill Name:** `u01157-resource-budget-allocation-for-eldercare-coordination`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in eldercare coordination`), failure trends, and approval/retry performance.
