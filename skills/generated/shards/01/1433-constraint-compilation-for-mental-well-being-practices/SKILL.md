...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for mental well-being practices** outcomes (not generic brainstorming).
...
1. **Incident stabilization in mental well-being practices" capability in production for mental well-being practices workflows**
   - Input: noisy upstream payload requiring constraint compilation for mental well-being practices normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for mental well-being practices` execution artifacts + scorecard + risk/confidence metadata.
