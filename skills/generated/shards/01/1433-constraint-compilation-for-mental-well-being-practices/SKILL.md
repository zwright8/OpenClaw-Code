...
## Metadata
- **Skill ID:** `1433`
- **Skill Name:** `u01433-constraint-compilation-for-mental-well-being-practices`
...
3. Produce `constraint-compilation-artifact-mental-well-being-practices` outputs in machine-readable form for orchestrator/operator use.
