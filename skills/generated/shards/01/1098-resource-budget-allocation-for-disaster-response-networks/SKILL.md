...
description: Build and operate the "Resource Budget Allocation for disaster response networks" capability for disaster response networks. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for disaster response networks** outcomes (not generic brainstorming).
...
1. **Incident stabilization in disaster response networks" capability for disaster response networks**
   - Input: noisy upstream payload requiring resource budget allocation for disaster response networks normalization/assessment.
...
## Handoff Contract
- Produces: `Resource Budget Allocation for disaster response networks` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **disaster response networks" capability for disaster response networks** depends on **Resource Budget Allocation for disaster response networks** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
