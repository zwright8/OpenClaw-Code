...
## Metadata
- **Skill ID:** `1098`
- **Skill Name:** `u01098-resource-budget-allocation-for-disaster-response-networks`
...
3. Produce `resource-budget-allocation-artifact-disaster-response-networks` outputs in machine-readable form for orchestrator/operator use.
