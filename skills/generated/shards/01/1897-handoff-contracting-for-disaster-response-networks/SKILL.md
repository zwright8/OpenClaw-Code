---
name: u01897-handoff-contracting-for-disaster-response-networks
...
| Feature flag | `skill_01897_handoff-contracting` |
| Release cycles | `2` |

## Why This Skill Exists
Use handoff contracting in disaster response networks with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Handoff Contracting for disaster response networks under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Handoff Contracting for disaster response networks under pro-humanity impact conditions.
