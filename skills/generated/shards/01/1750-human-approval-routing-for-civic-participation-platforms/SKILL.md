...
## Metadata
- **Skill ID:** `1750`
- **Skill Name:** `u01750-human-approval-routing-for-civic-participation-platforms`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in civic participation platforms`), failure trends, and approval/retry performance.
