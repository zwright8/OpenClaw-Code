...
## Metadata
- **Skill ID:** `1300`
- **Skill Name:** `u01300-risk-aware-scheduling-for-disaster-response-networks`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in disaster response networks`), failure trends, and approval/retry performance.
