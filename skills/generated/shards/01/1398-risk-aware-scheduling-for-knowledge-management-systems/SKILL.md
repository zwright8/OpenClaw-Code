...
## Metadata
- **Skill ID:** `1398`
- **Skill Name:** `u01398-risk-aware-scheduling-for-knowledge-management-systems`
...
3. Produce `risk-aware-scheduling-artifact-knowledge-management-systems` outputs in machine-readable form for orchestrator/operator use.
