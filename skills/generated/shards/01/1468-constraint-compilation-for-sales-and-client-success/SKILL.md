...
description: Operate the "Constraint Compilation for sales and client success" capability in production for sales and client success workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for sales and client success** outcomes (not generic brainstorming).
...
1. **Incident stabilization in sales and client success" capability in production for sales and client success workflows**
   - Input: noisy upstream payload requiring constraint compilation for sales and client success normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for sales and client success` execution artifacts + scorecard + risk/confidence metadata.
