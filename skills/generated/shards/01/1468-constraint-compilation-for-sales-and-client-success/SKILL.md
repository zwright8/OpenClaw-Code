...
## Metadata
- **Skill ID:** `1468`
- **Skill Name:** `u01468-constraint-compilation-for-sales-and-client-success`
- **Domain:** `sales and client success`
- **Domain Slug:** `sales-and-client-success`
...
3. Produce `constraint-compilation-artifact-sales-and-client-success` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `sales-and-client-success:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in sales and client success`), failure trends, and approval/retry performance.
