...
## Metadata
- **Skill ID:** `1541`
- **Skill Name:** `u01541-constraint-compilation-for-community-mediation-programs`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in community mediation programs`), failure trends, and approval/retry performance.
