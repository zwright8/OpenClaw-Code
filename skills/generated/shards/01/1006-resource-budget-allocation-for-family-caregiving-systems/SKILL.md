...
## Metadata
- **Skill ID:** `1006`
- **Skill Name:** `u01006-resource-budget-allocation-for-family-caregiving-systems`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in family caregiving systems`), failure trends, and approval/retry performance.
