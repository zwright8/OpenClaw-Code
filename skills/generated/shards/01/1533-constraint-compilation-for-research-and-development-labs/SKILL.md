...
## Metadata
- **Skill ID:** `1533`
- **Skill Name:** `u01533-constraint-compilation-for-research-and-development-labs`
- **Domain:** `research and development labs`
- **Domain Slug:** `research-and-development-labs`
...
3. Produce `constraint-compilation-artifact-research-and-development-labs` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `research-and-development-labs:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in research and development labs`), failure trends, and approval/retry performance.
