...
description: Operate the "Constraint Compilation for research and development labs" capability in production for research and development labs workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for research and development labs** outcomes (not generic brainstorming).
...
1. **Incident stabilization in research and development labs" capability in production for research and development labs workflows**
   - Input: noisy upstream payload requiring constraint compilation for research and development labs normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for research and development labs` execution artifacts + scorecard + risk/confidence metadata.
