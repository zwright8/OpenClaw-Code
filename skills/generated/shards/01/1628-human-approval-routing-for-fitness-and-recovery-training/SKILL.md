...
## Metadata
- **Skill ID:** `1628`
- **Skill Name:** `u01628-human-approval-routing-for-fitness-and-recovery-training`
...
3. Produce `human-approval-routing-artifact-fitness-and-recovery-training` outputs in machine-readable form for orchestrator/operator use.
