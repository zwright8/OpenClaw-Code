...
## Metadata
- **Skill ID:** `1703`
- **Skill Name:** `u01703-human-approval-routing-for-climate-adaptation-initiatives`
...
3. Produce `human-approval-routing-artifact-climate-adaptation-initiatives` outputs in machine-readable form for orchestrator/operator use.
