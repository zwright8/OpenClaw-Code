...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for climate adaptation initiatives** outcomes (not generic brainstorming).
...
1. **Incident stabilization in climate adaptation initiatives" capability in production for climate adaptation initiatives workflows**
   - Input: noisy upstream payload requiring human approval routing for climate adaptation initiatives normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for climate adaptation initiatives` execution artifacts + scorecard + risk/confidence metadata.
