...
## Metadata
- **Skill ID:** `1333`
- **Skill Name:** `u01333-risk-aware-scheduling-for-research-and-development-labs`
...
3. Produce `risk-aware-scheduling-artifact-research-and-development-labs` outputs in machine-readable form for orchestrator/operator use.
