...
## Metadata
- **Skill ID:** `1494`
- **Skill Name:** `u01494-constraint-compilation-for-nonprofit-program-delivery`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in nonprofit program delivery`), failure trends, and approval/retry performance.
