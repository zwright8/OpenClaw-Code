...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for disaster response networks** outcomes (not generic brainstorming).
...
1. **Incident stabilization in disaster response networks" capability in production for disaster response networks workflows**
   - Input: noisy upstream payload requiring handoff contracting for disaster response networks normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for disaster response networks` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **disaster response networks" capability in production for disaster response networks workflows** depends on **Handoff Contracting for disaster response networks** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
