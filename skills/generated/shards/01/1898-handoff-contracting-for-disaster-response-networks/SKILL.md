...
## Metadata
- **Skill ID:** `1898`
- **Skill Name:** `u01898-handoff-contracting-for-disaster-response-networks`
...
3. Produce `handoff-contracting-artifact-disaster-response-networks` outputs in machine-readable form for orchestrator/operator use.
