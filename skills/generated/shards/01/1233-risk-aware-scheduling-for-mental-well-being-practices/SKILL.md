...
## Metadata
- **Skill ID:** `1233`
- **Skill Name:** `u01233-risk-aware-scheduling-for-mental-well-being-practices`
...
3. Produce `risk-aware-scheduling-artifact-mental-well-being-practices` outputs in machine-readable form for orchestrator/operator use.
