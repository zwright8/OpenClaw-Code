...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for design and user research** outcomes (not generic brainstorming).
...
1. **Incident stabilization in design and user research" capability in production for design and user research workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for design and user research normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for design and user research` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **design and user research" capability in production for design and user research workflows** depends on **Risk-Aware Scheduling for design and user research** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
