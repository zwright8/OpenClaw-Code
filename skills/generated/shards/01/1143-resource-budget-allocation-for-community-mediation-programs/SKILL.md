...
description: Build and operate the "Resource Budget Allocation for community mediation programs" capability for community mediation programs. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Metadata
- **Skill ID:** `1143`
- **Skill Name:** `u01143-resource-budget-allocation-for-community-mediation-programs`
...
3. Produce `resource-budget-allocation-artifact-community-mediation-programs` outputs in machine-readable form for orchestrator/operator use.
