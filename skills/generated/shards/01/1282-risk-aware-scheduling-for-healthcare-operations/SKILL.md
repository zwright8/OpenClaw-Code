...
## Metadata
- **Skill ID:** `1282`
- **Skill Name:** `u01282-risk-aware-scheduling-for-healthcare-operations`
...
3. Produce `risk-aware-scheduling-artifact-healthcare-operations` outputs in machine-readable form for orchestrator/operator use.
