...
## Metadata
- **Skill ID:** `1655`
- **Skill Name:** `u01655-human-approval-routing-for-software-engineering-delivery`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in software engineering delivery`), failure trends, and approval/retry performance.
