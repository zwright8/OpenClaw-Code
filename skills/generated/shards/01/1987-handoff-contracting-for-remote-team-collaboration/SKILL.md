...
## Metadata
- **Skill ID:** `1987`
- **Skill Name:** `u01987-handoff-contracting-for-remote-team-collaboration`
...
3. Produce `handoff-contracting-artifact-remote-team-collaboration` outputs in machine-readable form for orchestrator/operator use.
