...
## Metadata
- **Skill ID:** `1473`
- **Skill Name:** `u01473-constraint-compilation-for-marketing-and-storytelling`
...
3. Produce `constraint-compilation-artifact-marketing-and-storytelling` outputs in machine-readable form for orchestrator/operator use.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in marketing and storytelling`), failure trends, and approval/retry performance.
