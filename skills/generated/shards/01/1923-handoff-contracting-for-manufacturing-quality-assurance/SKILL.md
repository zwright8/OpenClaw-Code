...
## Metadata
- **Skill ID:** `1923`
- **Skill Name:** `u01923-handoff-contracting-for-manufacturing-quality-assurance`
...
3. Produce `handoff-contracting-artifact-manufacturing-quality-assurance` outputs in machine-readable form for orchestrator/operator use.
