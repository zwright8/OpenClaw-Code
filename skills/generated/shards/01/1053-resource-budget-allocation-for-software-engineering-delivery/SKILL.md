...
## Metadata
- **Skill ID:** `1053`
- **Skill Name:** `u01053-resource-budget-allocation-for-software-engineering-delivery`
...
3. Produce `resource-budget-allocation-artifact-software-engineering-deliver` outputs in machine-readable form for orchestrator/operator use.
