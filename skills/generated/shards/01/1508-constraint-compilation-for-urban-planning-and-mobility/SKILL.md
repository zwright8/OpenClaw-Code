...
## Metadata
- **Skill ID:** `1508`
- **Skill Name:** `u01508-constraint-compilation-for-urban-planning-and-mobility`
...
3. Produce `constraint-compilation-artifact-urban-planning-and-mobility` outputs in machine-readable form for orchestrator/operator use.
