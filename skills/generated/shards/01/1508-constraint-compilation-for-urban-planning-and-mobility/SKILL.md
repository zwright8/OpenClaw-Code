---
name: u01508-constraint-compilation-for-urban-planning-and-mobility
...
| Feature flag | `skill_01508_constraint-compilation` |
| Release cycles | `2` |

## Why This Skill Exists
Use constraint compilation in urban planning and mobility with emphasis on clarity, harmony, craft, and emotionally resonant outcomes.
...
5. Run unit, integration, simulation, and regression suites for Constraint Compilation for urban planning and mobility under beauty and aesthetic appreciation conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Constraint Compilation for urban planning and mobility under beauty and aesthetic appreciation conditions.
