...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for urban planning and mobility** outcomes (not generic brainstorming).
...
1. **Incident stabilization in urban planning and mobility" capability in production for urban planning and mobility workflows**
   - Input: noisy upstream payload requiring constraint compilation for urban planning and mobility normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for urban planning and mobility` execution artifacts + scorecard + risk/confidence metadata.
