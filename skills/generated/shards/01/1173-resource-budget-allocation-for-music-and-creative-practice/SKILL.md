...
description: Operate the "Resource Budget Allocation for music and creative practice" capability in production for music and creative practice workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for music and creative practice** outcomes (not generic brainstorming).
...
1. **Incident stabilization in music and creative practice" capability in production for music and creative practice workflows**
   - Input: noisy upstream payload requiring resource budget allocation for music and creative practice normalization/assessment.
...
## Handoff Contract
- Produces: `Resource Budget Allocation for music and creative practice` execution artifacts + scorecard + risk/confidence metadata.
