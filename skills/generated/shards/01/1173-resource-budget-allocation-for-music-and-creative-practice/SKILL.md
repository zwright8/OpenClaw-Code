...
## Metadata
- **Skill ID:** `1173`
- **Skill Name:** `u01173-resource-budget-allocation-for-music-and-creative-practice`
...
3. Produce `resource-budget-allocation-artifact-music-and-creative-practice` outputs in machine-readable form for orchestrator/operator use.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in music and creative practice`), failure trends, and approval/retry performance.
