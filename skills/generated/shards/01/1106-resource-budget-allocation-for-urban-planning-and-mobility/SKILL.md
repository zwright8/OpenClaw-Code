...
## Metadata
- **Skill ID:** `1106`
- **Skill Name:** `u01106-resource-budget-allocation-for-urban-planning-and-mobility`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in urban planning and mobility`), failure trends, and approval/retry performance.
