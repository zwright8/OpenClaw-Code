...
## Metadata
- **Skill ID:** `1151`
- **Skill Name:** `u01151-resource-budget-allocation-for-accessibility-services`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in accessibility services`), failure trends, and approval/retry performance.
