...
## Metadata
- **Skill ID:** `1273`
- **Skill Name:** `u01273-risk-aware-scheduling-for-marketing-and-storytelling`
...
3. Produce `risk-aware-scheduling-artifact-marketing-and-storytelling` outputs in machine-readable form for orchestrator/operator use.
