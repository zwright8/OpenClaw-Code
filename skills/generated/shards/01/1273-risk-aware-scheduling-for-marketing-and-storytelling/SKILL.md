...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for marketing and storytelling** outcomes (not generic brainstorming).
...
1. **Incident stabilization in marketing and storytelling" capability in production for marketing and storytelling workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for marketing and storytelling normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for marketing and storytelling` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **marketing and storytelling" capability in production for marketing and storytelling workflows** depends on **Risk-Aware Scheduling for marketing and storytelling** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
