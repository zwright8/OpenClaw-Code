...
## Metadata
- **Skill ID:** `1026`
- **Skill Name:** `u01026-resource-budget-allocation-for-fitness-and-recovery-training`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in fitness and recovery training`), failure trends, and approval/retry performance.
