...
## Metadata
- **Skill ID:** `1010`
- **Skill Name:** `u01010-resource-budget-allocation-for-family-caregiving-systems`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in family caregiving systems`), failure trends, and approval/retry performance.
