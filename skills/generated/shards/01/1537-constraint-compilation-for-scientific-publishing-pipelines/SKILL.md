...
## Metadata
- **Skill ID:** `1537`
- **Skill Name:** `u01537-constraint-compilation-for-scientific-publishing-pipelines`
...
3. Produce `constraint-compilation-artifact-scientific-publishing-pipelines` outputs in machine-readable form for orchestrator/operator use.
