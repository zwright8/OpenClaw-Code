...
## Metadata
- **Skill ID:** `1580`
- **Skill Name:** `u01580-constraint-compilation-for-journalism-and-public-communication`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in journalism and public communication`), failure trends, and approval/retry performance.
