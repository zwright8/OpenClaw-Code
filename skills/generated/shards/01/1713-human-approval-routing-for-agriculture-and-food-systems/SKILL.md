...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for agriculture and food systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in agriculture and food systems" capability in production for agriculture and food systems workflows**
   - Input: noisy upstream payload requiring human approval routing for agriculture and food systems normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for agriculture and food systems` execution artifacts + scorecard + risk/confidence metadata.
