...
## Metadata
- **Skill ID:** `1488`
- **Skill Name:** `u01488-constraint-compilation-for-education-support-services`
...
3. Produce `constraint-compilation-artifact-education-support-services` outputs in machine-readable form for orchestrator/operator use.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in education support services`), failure trends, and approval/retry performance.
