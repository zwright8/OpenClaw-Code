...
description: Operate the "Constraint Compilation for education support services" capability in production for education support services workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for education support services** outcomes (not generic brainstorming).
...
1. **Incident stabilization in education support services" capability in production for education support services workflows**
   - Input: noisy upstream payload requiring constraint compilation for education support services normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for education support services` execution artifacts + scorecard + risk/confidence metadata.
