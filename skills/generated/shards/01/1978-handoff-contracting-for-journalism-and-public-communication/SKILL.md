...
## Metadata
- **Skill ID:** `1978`
- **Skill Name:** `u01978-handoff-contracting-for-journalism-and-public-communication`
...
3. Produce `handoff-contracting-artifact-journalism-and-public-communication` outputs in machine-readable form for orchestrator/operator use.
