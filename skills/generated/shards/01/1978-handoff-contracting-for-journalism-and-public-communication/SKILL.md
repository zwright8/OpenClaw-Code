...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for journalism and public communication** outcomes (not generic brainstorming).
...
1. **Incident stabilization in journalism and public communication" capability in production for journalism and public communication workflows**
   - Input: noisy upstream payload requiring handoff contracting for journalism and public communication normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for journalism and public communication` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **journalism and public communication" capability in production for journalism and public communication workflows** depends on **Handoff Contracting for journalism and public communication** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
