...
description: Operate the "Constraint Compilation for nutrition and meal planning" capability in production for nutrition and meal planning workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for nutrition and meal planning** outcomes (not generic brainstorming).
...
1. **Incident stabilization in nutrition and meal planning" capability in production for nutrition and meal planning workflows**
   - Input: noisy upstream payload requiring constraint compilation for nutrition and meal planning normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for nutrition and meal planning` execution artifacts + scorecard + risk/confidence metadata.
