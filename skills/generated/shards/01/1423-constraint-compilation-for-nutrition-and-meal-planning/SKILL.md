...
## Metadata
- **Skill ID:** `1423`
- **Skill Name:** `u01423-constraint-compilation-for-nutrition-and-meal-planning`
...
3. Produce `constraint-compilation-artifact-nutrition-and-meal-planning` outputs in machine-readable form for orchestrator/operator use.
