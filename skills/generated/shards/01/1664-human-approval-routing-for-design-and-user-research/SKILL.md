...
## Metadata
- **Skill ID:** `1664`
- **Skill Name:** `u01664-human-approval-routing-for-design-and-user-research`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in design and user research`), failure trends, and approval/retry performance.
