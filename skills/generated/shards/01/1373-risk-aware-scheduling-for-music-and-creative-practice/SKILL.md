...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for music and creative practice** outcomes (not generic brainstorming).
...
1. **Incident stabilization in music and creative practice" capability in production for music and creative practice workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for music and creative practice normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for music and creative practice` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **music and creative practice" capability in production for music and creative practice workflows** depends on **Risk-Aware Scheduling for music and creative practice** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
