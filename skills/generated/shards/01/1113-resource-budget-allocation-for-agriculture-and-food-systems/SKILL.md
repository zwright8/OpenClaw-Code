...
description: Build and operate the "Resource Budget Allocation for agriculture and food systems" capability for agriculture and food systems. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Metadata
- **Skill ID:** `1113`
- **Skill Name:** `u01113-resource-budget-allocation-for-agriculture-and-food-systems`
...
3. Produce `resource-budget-allocation-artifact-agriculture-and-food-systems` outputs in machine-readable form for orchestrator/operator use.
