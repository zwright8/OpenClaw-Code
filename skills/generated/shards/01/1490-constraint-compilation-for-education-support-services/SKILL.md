...
## Metadata
- **Skill ID:** `1490`
- **Skill Name:** `u01490-constraint-compilation-for-education-support-services`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in education support services`), failure trends, and approval/retry performance.
