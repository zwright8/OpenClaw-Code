...
## Metadata
- **Skill ID:** `1083`
- **Skill Name:** `u01083-resource-budget-allocation-for-healthcare-operations`
...
3. Produce `resource-budget-allocation-artifact-healthcare-operations` outputs in machine-readable form for orchestrator/operator use.
