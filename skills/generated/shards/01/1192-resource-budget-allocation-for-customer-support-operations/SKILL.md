...
## Metadata
- **Skill ID:** `1192`
- **Skill Name:** `u01192-resource-budget-allocation-for-customer-support-operations`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in customer support operations`), failure trends, and approval/retry performance.
