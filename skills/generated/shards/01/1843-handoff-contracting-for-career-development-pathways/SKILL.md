...
description: Build and operate the "Handoff Contracting for career development pathways" capability for career development pathways. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for career development pathways** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **career development pathways" capability for career development pathways** with measurable acceptance criteria.
...
- **Daily:** Run when new career development pathways" capability for career development pathways signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in career development pathways" capability for career development pathways**
   - Input: noisy upstream payload requiring handoff contracting for career development pathways normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for career development pathways` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **career development pathways" capability for career development pathways** depends on **Handoff Contracting for career development pathways** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
