...
## Metadata
- **Skill ID:** `1843`
- **Skill Name:** `u01843-handoff-contracting-for-career-development-pathways`
...
3. Produce `handoff-contracting-artifact-career-development-pathways` outputs in machine-readable form for orchestrator/operator use.
