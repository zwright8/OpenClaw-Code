...
description: Build and operate the "Resource Budget Allocation for urban planning and mobility" capability for urban planning and mobility. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Metadata
- **Skill ID:** `1108`
- **Skill Name:** `u01108-resource-budget-allocation-for-urban-planning-and-mobility`
- **Domain:** `urban planning and mobility`
- **Domain Slug:** `urban-planning-and-mobility`
...
3. Produce `resource-budget-allocation-artifact-urban-planning-and-mobility` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `urban-planning-and-mobility:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in urban planning and mobility`), failure trends, and approval/retry performance.
