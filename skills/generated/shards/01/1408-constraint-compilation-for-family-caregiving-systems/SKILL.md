...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for family caregiving systems** outcomes (not generic brainstorming).
...
1. **Incident stabilization in family caregiving systems" capability in production for family caregiving systems workflows**
   - Input: noisy upstream payload requiring constraint compilation for family caregiving systems normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for family caregiving systems` execution artifacts + scorecard + risk/confidence metadata.
