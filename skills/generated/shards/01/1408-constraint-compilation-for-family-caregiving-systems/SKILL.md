...
## Metadata
- **Skill ID:** `1408`
- **Skill Name:** `u01408-constraint-compilation-for-family-caregiving-systems`
...
3. Produce `constraint-compilation-artifact-family-caregiving-systems` outputs in machine-readable form for orchestrator/operator use.
