...
description: Operate the "Resource Budget Allocation for fitness and recovery training" capability in production for fitness and recovery training workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `1028`
- **Skill Name:** `u01028-resource-budget-allocation-for-fitness-and-recovery-training`
- **Domain:** `fitness and recovery training`
- **Domain Slug:** `fitness-and-recovery-training`
...
3. Produce `resource-budget-allocation-artifact-fitness-and-recovery-trainin` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `fitness-and-recovery-training:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in fitness and recovery training`), failure trends, and approval/retry performance.
