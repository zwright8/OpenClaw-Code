...
## Metadata
- **Skill ID:** `1770`
- **Skill Name:** `u01770-human-approval-routing-for-arts-and-culture-programming`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in arts and culture programming`), failure trends, and approval/retry performance.
