...
## Metadata
- **Skill ID:** `1004`
- **Skill Name:** `u01004-resource-budget-allocation-for-personal-health-routines`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in personal health routines`), failure trends, and approval/retry performance.
