...
## Metadata
- **Skill ID:** `1293`
- **Skill Name:** `u01293-risk-aware-scheduling-for-nonprofit-program-delivery`
...
3. Produce `risk-aware-scheduling-artifact-nonprofit-program-delivery` outputs in machine-readable form for orchestrator/operator use.
