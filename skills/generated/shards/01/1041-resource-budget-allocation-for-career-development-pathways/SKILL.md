...
## Metadata
- **Skill ID:** `1041`
- **Skill Name:** `u01041-resource-budget-allocation-for-career-development-pathways`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in career development pathways`), failure trends, and approval/retry performance.
