...
## Metadata
- **Skill ID:** `1502`
- **Skill Name:** `u01502-constraint-compilation-for-climate-adaptation-initiatives`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in climate adaptation initiatives`), failure trends, and approval/retry performance.
