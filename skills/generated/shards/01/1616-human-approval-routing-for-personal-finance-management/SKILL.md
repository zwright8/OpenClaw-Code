...
## Metadata
- **Skill ID:** `1616`
- **Skill Name:** `u01616-human-approval-routing-for-personal-finance-management`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in personal finance management`), failure trends, and approval/retry performance.
