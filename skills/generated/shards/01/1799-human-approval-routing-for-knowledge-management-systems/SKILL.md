...
## Metadata
- **Skill ID:** `1799`
- **Skill Name:** `u01799-human-approval-routing-for-knowledge-management-systems`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in knowledge management systems`), failure trends, and approval/retry performance.
