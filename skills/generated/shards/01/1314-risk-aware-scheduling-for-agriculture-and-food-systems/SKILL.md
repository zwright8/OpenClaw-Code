...
## Metadata
- **Skill ID:** `1314`
- **Skill Name:** `u01314-risk-aware-scheduling-for-agriculture-and-food-systems`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in agriculture and food systems`), failure trends, and approval/retry performance.
