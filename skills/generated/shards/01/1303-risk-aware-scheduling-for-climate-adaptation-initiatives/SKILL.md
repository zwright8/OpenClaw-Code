...
## Metadata
- **Skill ID:** `1303`
- **Skill Name:** `u01303-risk-aware-scheduling-for-climate-adaptation-initiatives`
...
3. Produce `risk-aware-scheduling-artifact-climate-adaptation-initiatives` outputs in machine-readable form for orchestrator/operator use.
