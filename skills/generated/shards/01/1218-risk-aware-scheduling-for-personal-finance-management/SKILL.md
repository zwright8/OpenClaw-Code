...
## Metadata
- **Skill ID:** `1218`
- **Skill Name:** `u01218-risk-aware-scheduling-for-personal-finance-management`
...
3. Produce `risk-aware-scheduling-artifact-personal-finance-management` outputs in machine-readable form for orchestrator/operator use.
