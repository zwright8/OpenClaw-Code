...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for arts and culture programming** outcomes (not generic brainstorming).
...
1. **Incident stabilization in arts and culture programming" capability in production for arts and culture programming workflows**
   - Input: noisy upstream payload requiring handoff contracting for arts and culture programming normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for arts and culture programming` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **arts and culture programming" capability in production for arts and culture programming workflows** depends on **Handoff Contracting for arts and culture programming** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
