...
| Feature flag | `skill_01209_risk-aware-scheduling` |
| Release cycles | `2` |
...
- **Validation:** Run unit, integration, simulation, and regression suites for Risk-Aware Scheduling for family caregiving systems under hyper-productive autonomy conditions.
