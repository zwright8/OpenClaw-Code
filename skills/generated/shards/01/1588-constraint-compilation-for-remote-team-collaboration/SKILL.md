...
description: Operate the "Constraint Compilation for remote team collaboration" capability in production for remote team collaboration workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for remote team collaboration** outcomes (not generic brainstorming).
...
1. **Incident stabilization in remote team collaboration" capability in production for remote team collaboration workflows**
   - Input: noisy upstream payload requiring constraint compilation for remote team collaboration normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for remote team collaboration` execution artifacts + scorecard + risk/confidence metadata.
