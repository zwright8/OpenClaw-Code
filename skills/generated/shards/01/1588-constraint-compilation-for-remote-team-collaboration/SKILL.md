...
## Metadata
- **Skill ID:** `1588`
- **Skill Name:** `u01588-constraint-compilation-for-remote-team-collaboration`
- **Domain:** `remote team collaboration`
- **Domain Slug:** `remote-team-collaboration`
...
3. Produce `constraint-compilation-artifact-remote-team-collaboration` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `remote-team-collaboration:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in remote team collaboration`), failure trends, and approval/retry performance.
