...
## Metadata
- **Skill ID:** `1258`
- **Skill Name:** `u01258-risk-aware-scheduling-for-product-management-execution`
...
3. Produce `risk-aware-scheduling-artifact-product-management-execution` outputs in machine-readable form for orchestrator/operator use.
