...
## Trigger Checklist
- [ ] The request explicitly needs **Risk-Aware Scheduling for product management execution** outcomes (not generic brainstorming).
...
1. **Incident stabilization in product management execution" capability in production for product management execution workflows**
   - Input: noisy upstream payload requiring risk-aware scheduling for product management execution normalization/assessment.
...
## Handoff Contract
- Produces: `Risk-Aware Scheduling for product management execution` execution artifacts + scorecard + risk/confidence metadata.
