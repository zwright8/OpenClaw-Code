...
description: Operate the "Human Approval Routing for personal finance management" capability in production for personal finance management workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for personal finance management** outcomes (not generic brainstorming).
...
1. **Incident stabilization in personal finance management" capability in production for personal finance management workflows**
   - Input: noisy upstream payload requiring human approval routing for personal finance management normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for personal finance management` execution artifacts + scorecard + risk/confidence metadata.
