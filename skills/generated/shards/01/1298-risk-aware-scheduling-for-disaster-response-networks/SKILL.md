...
## Metadata
- **Skill ID:** `1298`
- **Skill Name:** `u01298-risk-aware-scheduling-for-disaster-response-networks`
- **Domain:** `disaster response networks`
- **Domain Slug:** `disaster-response-networks`
...
3. Produce `risk-aware-scheduling-artifact-disaster-response-networks` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `disaster-response-networks:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in disaster response networks`), failure trends, and approval/retry performance.
