...
## Metadata
- **Skill ID:** `1738`
- **Skill Name:** `u01738-human-approval-routing-for-scientific-publishing-pipelines`
- **Domain:** `scientific publishing pipelines`
- **Domain Slug:** `scientific-publishing-pipelines`
...
3. Produce `human-approval-routing-artifact-scientific-publishing-pipelines` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `scientific-publishing-pipelines:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in scientific publishing pipelines`), failure trends, and approval/retry performance.
