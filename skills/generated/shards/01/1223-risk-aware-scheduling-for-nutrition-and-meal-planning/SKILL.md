...
## Metadata
- **Skill ID:** `1223`
- **Skill Name:** `u01223-risk-aware-scheduling-for-nutrition-and-meal-planning`
...
3. Produce `risk-aware-scheduling-artifact-nutrition-and-meal-planning` outputs in machine-readable form for orchestrator/operator use.
