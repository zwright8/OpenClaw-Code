---
name: u01666-human-approval-routing-for-sales-and-client-success
description: Run the Human Approval Routing for sales and client success capability for sales and client success with deterministic outputs, policy-gated release, and handoff-ready operational artifacts. Use when mission execution explicitly requires this capability.
---
...
| Primary artifact | `human-approval-routing-artifact-sales-and-client-success` |
| Routing tag | `sales-and-client-success:generalist-engine` |
| Feature flag | `skill_01666_human-approval-routing` |
| Release cycles | `2` |

## Why This Skill Exists
Use human approval routing in sales and client success with emphasis on evidence quality, falsifiability, and calibration.

## Trigger Checklist
- [ ] The task explicitly needs Human Approval Routing for sales and client success (not generic brainstorming).
...
|---|---|---|---|
| human-approval-routing-artifact-sales-and-client-success | structured-artifact | yes | downstream orchestrator |
| human-approval-routing-artifact-sales-and-client-success-scorecard | scorecard | yes | operator / reviewer |
| human-approval-routing-artifact-sales-and-client-success-handoff | handoff-packet | yes | next owner |
...
5. Run unit, integration, simulation, and regression suites for Human Approval Routing for sales and client success under maximally truth-seeking conditions.
...
## Operator Use Cases
- Run Human Approval Routing for sales and client success as a repeatable production workflow for humans and agents.
- Use Human Approval Routing for sales and client success to accelerate decisions while preserving safety, quality, and auditability.
...
## Traceability Map
- **Scope:** Define measurable outcomes for Human Approval Routing for sales and client success, including baseline and target metrics for sales and client success.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Human Approval Routing for sales and client success under maximally truth-seeking conditions.
...
1. `OPA/Rego` -> auth preflight, execute read+write/orchestrate call(s), normalize output, and attach trace to `human-approval-routing-artifact-sales-and-client-success`.
2. `Vault/KMS` -> auth preflight, execute read+write/orchestrate call(s), normalize output, and attach trace to `human-approval-routing-artifact-sales-and-client-success`.
3. `SIEM (Elastic/Splunk)` -> auth preflight, execute read+write call(s), normalize output, and attach trace to `human-approval-routing-artifact-sales-and-client-success`.
...
1. Incident recovery in sales and client success: ingest noisy signals, execute human approval routing, produce an operator-ready scorecard and remediation queue.
2. Scheduled quality pass: run Human Approval Routing for sales and client success against baseline data, compare drift, and publish release/no-release recommendation with evidence links.
...
## Handoff Contract
- **Produces:** `human-approval-routing-artifact-sales-and-client-success`, scorecard, risk/confidence metadata, remediation backlog.
