...
description: Build and operate the "Resource Budget Allocation for legal and policy workflows" capability for legal and policy workflows. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Resource Budget Allocation for legal and policy workflows** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **legal and policy workflows" capability for legal and policy workflows** with measurable acceptance criteria.
...
- **Daily:** Run when new legal and policy workflows" capability for legal and policy workflows signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in legal and policy workflows" capability for legal and policy workflows**
   - Input: noisy upstream payload requiring resource budget allocation for legal and policy workflows normalization/assessment.
...
## Handoff Contract
- Produces: `Resource Budget Allocation for legal and policy workflows` execution artifacts + scorecard + risk/confidence metadata.
