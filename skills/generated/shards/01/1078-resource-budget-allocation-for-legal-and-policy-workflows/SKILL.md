...
## Metadata
- **Skill ID:** `1078`
- **Skill Name:** `u01078-resource-budget-allocation-for-legal-and-policy-workflows`
...
3. Produce `resource-budget-allocation-artifact-legal-and-policy-workflows` outputs in machine-readable form for orchestrator/operator use.
