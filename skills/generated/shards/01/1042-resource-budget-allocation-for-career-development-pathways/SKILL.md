...
## Metadata
- **Skill ID:** `1042`
- **Skill Name:** `u01042-resource-budget-allocation-for-career-development-pathways`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in career development pathways`), failure trends, and approval/retry performance.
