...
## Metadata
- **Skill ID:** `1528`
- **Skill Name:** `u01528-constraint-compilation-for-cybersecurity-operations`
- **Domain:** `cybersecurity operations`
- **Domain Slug:** `cybersecurity-operations`
...
3. Produce `constraint-compilation-artifact-cybersecurity-operations` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `cybersecurity-operations:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in cybersecurity operations`), failure trends, and approval/retry performance.
