...
## Metadata
- **Skill ID:** `1583`
- **Skill Name:** `u01583-constraint-compilation-for-multilingual-translation-services`
...
3. Produce `constraint-compilation-artifact-multilingual-translation-service` outputs in machine-readable form for orchestrator/operator use.
