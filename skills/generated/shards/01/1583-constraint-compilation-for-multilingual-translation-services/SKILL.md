...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for multilingual translation services** outcomes (not generic brainstorming).
...
1. **Incident stabilization in multilingual translation services" capability in production for multilingual translation services workflows**
   - Input: noisy upstream payload requiring constraint compilation for multilingual translation services normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for multilingual translation services` execution artifacts + scorecard + risk/confidence metadata.
