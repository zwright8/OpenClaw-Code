...
## Metadata
- **Skill ID:** `1858`
- **Skill Name:** `u01858-handoff-contracting-for-product-management-execution`
...
3. Produce `handoff-contracting-artifact-product-management-execution` outputs in machine-readable form for orchestrator/operator use.
