...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for product management execution** outcomes (not generic brainstorming).
...
1. **Incident stabilization in product management execution" capability in production for product management execution workflows**
   - Input: noisy upstream payload requiring handoff contracting for product management execution normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for product management execution` execution artifacts + scorecard + risk/confidence metadata.
