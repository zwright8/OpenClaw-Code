...
## Metadata
- **Skill ID:** `1652`
- **Skill Name:** `u01652-human-approval-routing-for-software-engineering-delivery`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in software engineering delivery`), failure trends, and approval/retry performance.
