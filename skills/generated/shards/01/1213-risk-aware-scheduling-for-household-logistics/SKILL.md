...
## Metadata
- **Skill ID:** `1213`
- **Skill Name:** `u01213-risk-aware-scheduling-for-household-logistics`
...
3. Produce `risk-aware-scheduling-artifact-household-logistics` outputs in machine-readable form for orchestrator/operator use.
