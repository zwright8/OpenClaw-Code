...
## Metadata
- **Skill ID:** `1908`
- **Skill Name:** `u01908-handoff-contracting-for-urban-planning-and-mobility`
...
3. Produce `handoff-contracting-artifact-urban-planning-and-mobility` outputs in machine-readable form for orchestrator/operator use.
