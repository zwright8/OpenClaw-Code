...
## Metadata
- **Skill ID:** `1597`
- **Skill Name:** `u01597-constraint-compilation-for-knowledge-management-systems`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in knowledge management systems`), failure trends, and approval/retry performance.
