...
## Metadata
- **Skill ID:** `1467`
- **Skill Name:** `u01467-constraint-compilation-for-sales-and-client-success`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in sales and client success`), failure trends, and approval/retry performance.
