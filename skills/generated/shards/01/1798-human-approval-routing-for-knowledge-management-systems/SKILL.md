...
## Metadata
- **Skill ID:** `1798`
- **Skill Name:** `u01798-human-approval-routing-for-knowledge-management-systems`
...
3. Produce `human-approval-routing-artifact-knowledge-management-systems` outputs in machine-readable form for orchestrator/operator use.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in knowledge management systems`), failure trends, and approval/retry performance.
