...
description: Operate the "Resource Budget Allocation for career development pathways" capability in production for career development pathways workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Metadata
- **Skill ID:** `1043`
- **Skill Name:** `u01043-resource-budget-allocation-for-career-development-pathways`
- **Domain:** `career development pathways`
- **Domain Slug:** `career-development-pathways`
...
3. Produce `resource-budget-allocation-artifact-career-development-pathways` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `career-development-pathways:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in career development pathways`), failure trends, and approval/retry performance.
