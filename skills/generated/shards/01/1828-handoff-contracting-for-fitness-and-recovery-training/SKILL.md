...
description: Build and operate the "Handoff Contracting for fitness and recovery training" capability for fitness and recovery training. Use when this exact capability is required by autonomous or human-guided missions.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for fitness and recovery training** outcomes (not generic brainstorming).
- [ ] Inputs are sufficient to execute in **fitness and recovery training" capability for fitness and recovery training** with measurable acceptance criteria.
...
- **Daily:** Run when new fitness and recovery training" capability for fitness and recovery training signals arrive or when active decisions depend on this capability.
...
1. **Incident stabilization in fitness and recovery training" capability for fitness and recovery training**
   - Input: noisy upstream payload requiring handoff contracting for fitness and recovery training normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for fitness and recovery training` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **fitness and recovery training" capability for fitness and recovery training** depends on **Handoff Contracting for fitness and recovery training** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
