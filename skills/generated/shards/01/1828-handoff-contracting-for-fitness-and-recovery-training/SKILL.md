...
## Metadata
- **Skill ID:** `1828`
- **Skill Name:** `u01828-handoff-contracting-for-fitness-and-recovery-training`
...
3. Produce `handoff-contracting-artifact-fitness-and-recovery-training` outputs in machine-readable form for orchestrator/operator use.
