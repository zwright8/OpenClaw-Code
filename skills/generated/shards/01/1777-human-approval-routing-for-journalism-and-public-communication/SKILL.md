...
## Metadata
- **Skill ID:** `1777`
- **Skill Name:** `u01777-human-approval-routing-for-journalism-and-public-communication`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in journalism and public communication`), failure trends, and approval/retry performance.
