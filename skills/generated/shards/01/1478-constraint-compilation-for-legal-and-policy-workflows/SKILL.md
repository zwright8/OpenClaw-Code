---
name: u01478-constraint-compilation-for-legal-and-policy-workflows
...
| Feature flag | `skill_01478_constraint-compilation` |
| Release cycles | `2` |

## Why This Skill Exists
Use constraint compilation in legal and policy workflows with emphasis on clarity, harmony, craft, and emotionally resonant outcomes.
...
5. Run unit, integration, simulation, and regression suites for Constraint Compilation for legal and policy workflows under beauty and aesthetic appreciation conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Constraint Compilation for legal and policy workflows under beauty and aesthetic appreciation conditions.
