...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for legal and policy workflows** outcomes (not generic brainstorming).
...
1. **Incident stabilization in legal and policy workflows" capability in production for legal and policy workflows workflows**
   - Input: noisy upstream payload requiring constraint compilation for legal and policy workflows normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for legal and policy workflows` execution artifacts + scorecard + risk/confidence metadata.
