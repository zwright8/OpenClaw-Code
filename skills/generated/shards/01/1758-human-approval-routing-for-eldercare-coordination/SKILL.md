...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for eldercare coordination** outcomes (not generic brainstorming).
...
1. **Incident stabilization in eldercare coordination" capability in production for eldercare coordination workflows**
   - Input: noisy upstream payload requiring human approval routing for eldercare coordination normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for eldercare coordination` execution artifacts + scorecard + risk/confidence metadata.
