...
## Metadata
- **Skill ID:** `1677`
- **Skill Name:** `u01677-human-approval-routing-for-legal-and-policy-workflows`
...
3. Produce `human-approval-routing-artifact-legal-and-policy-workflows` outputs in machine-readable form for orchestrator/operator use.
