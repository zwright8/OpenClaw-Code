...
## Metadata
- **Skill ID:** `1363`
- **Skill Name:** `u01363-risk-aware-scheduling-for-childcare-support-systems`
...
3. Produce `risk-aware-scheduling-artifact-childcare-support-systems` outputs in machine-readable form for orchestrator/operator use.
