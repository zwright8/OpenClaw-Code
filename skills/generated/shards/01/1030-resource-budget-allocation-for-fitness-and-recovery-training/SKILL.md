...
## Metadata
- **Skill ID:** `1030`
- **Skill Name:** `u01030-resource-budget-allocation-for-fitness-and-recovery-training`
...
- **Week:** Review KPI focus (`quality score`, `consistency index`, `mastery progress in fitness and recovery training`), failure trends, and approval/retry performance.
