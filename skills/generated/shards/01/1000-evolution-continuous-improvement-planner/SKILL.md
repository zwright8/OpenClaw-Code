...
## Metadata
- **Skill ID:** `1000`
- **Skill Name:** `u1000-evolution-continuous-improvement-planner`
...
### Handoff Contract
- **Produces:** `Evolution Continuous Improvement Planner normalized artifacts`, `execution scorecard`, `risk posture`
