...
## Metadata
- **Skill ID:** `1719`
- **Skill Name:** `u01719-human-approval-routing-for-supply-chain-resilience`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in supply chain resilience`), failure trends, and approval/retry performance.
