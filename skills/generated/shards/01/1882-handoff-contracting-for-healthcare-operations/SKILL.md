---
name: u01882-handoff-contracting-for-healthcare-operations
...
| Feature flag | `skill_01882_handoff-contracting` |
| Release cycles | `2` |

## Why This Skill Exists
Use handoff contracting in healthcare operations with emphasis on safety, dignity, equity, and long-term societal benefit.
...
5. Run unit, integration, simulation, and regression suites for Handoff Contracting for healthcare operations under pro-humanity impact conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Handoff Contracting for healthcare operations under pro-humanity impact conditions.
