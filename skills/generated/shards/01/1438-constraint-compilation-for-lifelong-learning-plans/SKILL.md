...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for lifelong learning plans** outcomes (not generic brainstorming).
...
1. **Incident stabilization in lifelong learning plans" capability in production for lifelong learning plans workflows**
   - Input: noisy upstream payload requiring constraint compilation for lifelong learning plans normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for lifelong learning plans` execution artifacts + scorecard + risk/confidence metadata.
