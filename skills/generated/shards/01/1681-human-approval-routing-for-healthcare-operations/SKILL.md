---
name: u01681-human-approval-routing-for-healthcare-operations
...
| Feature flag | `skill_01681_human-approval-routing` |
| Release cycles | `2` |

## Why This Skill Exists
Use human approval routing in healthcare operations with emphasis on evidence quality, falsifiability, and calibration.
...
5. Run unit, integration, simulation, and regression suites for Human Approval Routing for healthcare operations under maximally truth-seeking conditions.
...
- **Validation:** Run unit, integration, simulation, and regression suites for Human Approval Routing for healthcare operations under maximally truth-seeking conditions.
