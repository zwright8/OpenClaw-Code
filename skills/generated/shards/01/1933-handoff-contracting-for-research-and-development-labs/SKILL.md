...
## Metadata
- **Skill ID:** `1933`
- **Skill Name:** `u01933-handoff-contracting-for-research-and-development-labs`
...
3. Produce `handoff-contracting-artifact-research-and-development-labs` outputs in machine-readable form for orchestrator/operator use.
