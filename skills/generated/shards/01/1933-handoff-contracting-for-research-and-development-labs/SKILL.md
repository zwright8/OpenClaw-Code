...
## Trigger Checklist
- [ ] The request explicitly needs **Handoff Contracting for research and development labs** outcomes (not generic brainstorming).
...
1. **Incident stabilization in research and development labs" capability in production for research and development labs workflows**
   - Input: noisy upstream payload requiring handoff contracting for research and development labs normalization/assessment.
...
## Handoff Contract
- Produces: `Handoff Contracting for research and development labs` execution artifacts + scorecard + risk/confidence metadata.
...
## When To Use
Use this when a request in **research and development labs" capability in production for research and development labs workflows** depends on **Handoff Contracting for research and development labs** outcomes with explicit acceptance criteria. Do not use for unconstrained ideation; route discovery work before invoking this execution skill.
