...
## Metadata
- **Skill ID:** `1403`
- **Skill Name:** `u01403-constraint-compilation-for-personal-health-routines`
...
3. Produce `constraint-compilation-artifact-personal-health-routines` outputs in machine-readable form for orchestrator/operator use.
