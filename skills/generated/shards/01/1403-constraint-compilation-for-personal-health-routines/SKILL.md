...
## Trigger Checklist
- [ ] The request explicitly needs **Constraint Compilation for personal health routines** outcomes (not generic brainstorming).
...
1. **Incident stabilization in personal health routines" capability in production for personal health routines workflows**
   - Input: noisy upstream payload requiring constraint compilation for personal health routines normalization/assessment.
...
## Handoff Contract
- Produces: `Constraint Compilation for personal health routines` execution artifacts + scorecard + risk/confidence metadata.
