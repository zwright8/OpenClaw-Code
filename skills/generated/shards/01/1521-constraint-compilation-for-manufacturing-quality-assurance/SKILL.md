...
## Metadata
- **Skill ID:** `1521`
- **Skill Name:** `u01521-constraint-compilation-for-manufacturing-quality-assurance`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in manufacturing quality assurance`), failure trends, and approval/retry performance.
