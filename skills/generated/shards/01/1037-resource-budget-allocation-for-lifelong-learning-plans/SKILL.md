...
## Metadata
- **Skill ID:** `1037`
- **Skill Name:** `u01037-resource-budget-allocation-for-lifelong-learning-plans`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in lifelong learning plans`), failure trends, and approval/retry performance.
