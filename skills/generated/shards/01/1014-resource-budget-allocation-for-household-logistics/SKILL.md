...
## Metadata
- **Skill ID:** `1014`
- **Skill Name:** `u01014-resource-budget-allocation-for-household-logistics`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in household logistics`), failure trends, and approval/retry performance.
