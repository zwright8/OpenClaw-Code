...
## Metadata
- **Skill ID:** `1578`
- **Skill Name:** `u01578-constraint-compilation-for-journalism-and-public-communication`
...
3. Produce `constraint-compilation-artifact-journalism-and-public-communicat` outputs in machine-readable form for orchestrator/operator use.
