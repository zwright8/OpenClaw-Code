...
## Metadata
- **Skill ID:** `1342`
- **Skill Name:** `u01342-risk-aware-scheduling-for-community-mediation-programs`
...
3. Produce `risk-aware-scheduling-artifact-community-mediation-programs` outputs in machine-readable form for orchestrator/operator use.
