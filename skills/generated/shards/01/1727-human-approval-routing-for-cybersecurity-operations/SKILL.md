...
## Metadata
- **Skill ID:** `1727`
- **Skill Name:** `u01727-human-approval-routing-for-cybersecurity-operations`
...
- **Week:** Review KPI focus (`harm reduction`, `equity improvement`, `human benefit in cybersecurity operations`), failure trends, and approval/retry performance.
