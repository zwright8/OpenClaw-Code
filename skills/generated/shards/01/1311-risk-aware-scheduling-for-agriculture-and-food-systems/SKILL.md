...
## Metadata
- **Skill ID:** `1311`
- **Skill Name:** `u01311-risk-aware-scheduling-for-agriculture-and-food-systems`
...
- **Week:** Review KPI focus (`accuracy lift`, `contradiction reduction`, `evidence coverage in agriculture and food systems`), failure trends, and approval/retry performance.
