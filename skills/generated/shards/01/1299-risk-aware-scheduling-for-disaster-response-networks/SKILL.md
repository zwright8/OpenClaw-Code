...
## Metadata
- **Skill ID:** `1299`
- **Skill Name:** `u01299-risk-aware-scheduling-for-disaster-response-networks`
...
- **Week:** Review KPI focus (`cycle time reduction`, `throughput gain`, `automation leverage in disaster response networks`), failure trends, and approval/retry performance.
