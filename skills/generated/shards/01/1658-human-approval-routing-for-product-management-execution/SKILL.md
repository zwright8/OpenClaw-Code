...
description: Operate the "Human Approval Routing for product management execution" capability in production for product management execution workflows. Use when mission execution explicitly requires this capability and outcomes must be reproducible, policy-gated, and handoff-ready.
---
...
## Trigger Checklist
- [ ] The request explicitly needs **Human Approval Routing for product management execution** outcomes (not generic brainstorming).
...
1. **Incident stabilization in product management execution" capability in production for product management execution workflows**
   - Input: noisy upstream payload requiring human approval routing for product management execution normalization/assessment.
...
## Handoff Contract
- Produces: `Human Approval Routing for product management execution` execution artifacts + scorecard + risk/confidence metadata.
