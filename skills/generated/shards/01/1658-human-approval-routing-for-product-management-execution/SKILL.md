...
## Metadata
- **Skill ID:** `1658`
- **Skill Name:** `u01658-human-approval-routing-for-product-management-execution`
- **Domain:** `product management execution`
- **Domain Slug:** `product-management-execution`
...
3. Produce `human-approval-routing-artifact-product-management-execution` outputs in machine-readable form for orchestrator/operator use.
4. Keep routing aligned with `product-management-execution:generalist-engine` and include approval context.
...
- **Week:** Review KPI focus (`aesthetic coherence`, `craft quality`, `delight in product management execution`), failure trends, and approval/retry performance.
