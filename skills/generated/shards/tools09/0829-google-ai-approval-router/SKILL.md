---
name: google-ai-approval-router
description: Use when tasks require google ai approval router with credential-aware preflight, deterministic execution, validation gates, and handoff-ready artifacts.
---

# Google AI Approval Router
...
| Primary artifact | `google-ai-approval-decision-packet` |
| Routing tag | `google-ai:approval-router` |
| Mutating | `yes` |
| Release cycles | `3` |

## Why This Skill Exists
We need this skill because Google AI workflows degrade when auth, schema, and side-effect handling drift when integrations are run ad hoc. This specific skill turns Google AI Approval Router into a deterministic, auth-checked workflow for routes google ai-driven decisions to the right approvers..

## Trigger Checklist
- [ ] The task explicitly requires `Google AI Approval Router` rather than generic brainstorming.
...
| --- | --- | --- | --- |
| google-ai-approval-decision-packet | structured-artifact | yes | next workflow or operator |
| google-ai-approval-decision-packet-scorecard | scorecard | yes | reviewer |
| google-ai-approval-decision-packet-handoff | handoff-packet | yes | downstream owner |

## Step-by-Step Implementation Guide
1. Define the decision classes, approver roster, and escalation hierarchy for Google AI Approval Router, then capture the manual fallback path for Google AI.
...
3. Implement routes google ai-driven decisions to the right approvers. so the routing decision always includes policy clauses, approver evidence, and escalation context.
...
- Preserve request, response, and approval traces in `google-ai-approval-decision-packet` so downstream owners do not need to rediscover context.
...
- [ ] google-ai-approval-decision-packet, scorecard, and handoff packet were produced.
...
## Handoff Contract
- **Produces:** `google-ai-approval-decision-packet`, execution scorecard, approval trace, and next actions.
...
- **Downstream hint:** route to `google-ai:approval-router` consumers with approval and credential context attached.
