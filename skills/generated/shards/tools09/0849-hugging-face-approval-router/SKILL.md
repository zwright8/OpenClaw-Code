---
name: hugging-face-approval-router
description: Use when tasks require hugging face approval router with credential-aware preflight, deterministic execution, validation gates, and handoff-ready artifacts.
---

# Hugging Face Approval Router
...
| Primary artifact | `hugging-face-approval-decision-packet` |
| Routing tag | `hugging-face:approval-router` |
| Mutating | `yes` |
| Release cycles | `3` |

## Why This Skill Exists
We need this skill because Hugging Face workflows degrade when auth, schema, and side-effect handling drift when integrations are run ad hoc. This specific skill turns Hugging Face Approval Router into a deterministic, auth-checked workflow for routes hugging face-driven decisions to the right approvers..

## Trigger Checklist
- [ ] The task explicitly requires `Hugging Face Approval Router` rather than generic brainstorming.
...
| --- | --- | --- | --- |
| hugging-face-approval-decision-packet | structured-artifact | yes | next workflow or operator |
| hugging-face-approval-decision-packet-scorecard | scorecard | yes | reviewer |
| hugging-face-approval-decision-packet-handoff | handoff-packet | yes | downstream owner |

## Step-by-Step Implementation Guide
1. Define the decision classes, approver roster, and escalation hierarchy for Hugging Face Approval Router, then capture the manual fallback path for Hugging Face.
...
3. Implement routes hugging face-driven decisions to the right approvers. so the routing decision always includes policy clauses, approver evidence, and escalation context.
...
- Preserve request, response, and approval traces in `hugging-face-approval-decision-packet` so downstream owners do not need to rediscover context.
...
- [ ] hugging-face-approval-decision-packet, scorecard, and handoff packet were produced.
...
## Handoff Contract
- **Produces:** `hugging-face-approval-decision-packet`, execution scorecard, approval trace, and next actions.
...
- **Downstream hint:** route to `hugging-face:approval-router` consumers with approval and credential context attached.
