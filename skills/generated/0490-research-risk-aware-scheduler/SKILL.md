...
## Operational Runbook
### Preflight
- Confirm the Research Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0490_research-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
