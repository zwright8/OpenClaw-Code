...
description: Build and operate the "Memory Knowledge Graph Linker" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Memory Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0099_memory-knowledge-graph-linker, approval gates, and rollback owner before autonomous use.
