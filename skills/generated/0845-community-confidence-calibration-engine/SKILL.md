...
description: Build and operate the "Community Confidence Calibration Engine" capability for Community Engagement and Feedback. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Community Confidence Calibration Engine" outcomes in the Community Engagement and Feedback domain.
...
- Orchestration integration: community-engagement-and-feedback:optimization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Community Confidence Calibration Engine request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0845_community-confidence-calibration, approval gates, and rollback owner before autonomous use.
