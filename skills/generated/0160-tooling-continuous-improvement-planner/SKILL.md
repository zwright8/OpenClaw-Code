...
description: Build and operate the "Tooling Continuous Improvement Planner" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Continuous Improvement Planner" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0160_tooling-continuous-improvement-p, approval gates, and rollback owner before autonomous use.
