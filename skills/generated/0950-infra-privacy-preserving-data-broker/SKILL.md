...
## When To Use
Use this skill when the request explicitly needs "Infra Privacy Preserving Data Broker" outcomes in the Infrastructure and Sustainability domain.
...
- Orchestration integration: infrastructure-and-sustainability:collaboration-mediator routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Infra Privacy Preserving Data Broker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0950_infra-privacy-preserving-data-br, approval gates, and rollback owner before autonomous use.
