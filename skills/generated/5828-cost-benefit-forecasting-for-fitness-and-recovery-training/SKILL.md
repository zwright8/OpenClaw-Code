...
## When To Use
Use this skill when the request explicitly needs "Cost-Benefit Forecasting for fitness and recovery training" outcomes in the fitness and recovery training domain.
...
- Runtime profile: forecasting-engine using cost-benefit forecasting to produce cost-benefit-forecasting-artifact-fitness-and-recovery-training.
- Orchestration integration: fitness-and-recovery-training:forecasting-engine routing, approval gates, retries, and rollback controls.
