...
description: Build and operate the "Oversight Tool Health Monitor" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Tool Health Monitor" outcomes in the Human Oversight and Operator UX domain.
...
## Operational Runbook
### Preflight
- Confirm the Oversight Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0214_oversight-tool-health-monitor, approval gates, and rollback owner before autonomous use.
