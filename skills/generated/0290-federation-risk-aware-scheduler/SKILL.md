...
description: Build and operate the "Federation Risk-Aware Scheduler" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Risk-Aware Scheduler" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0290_federation-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
