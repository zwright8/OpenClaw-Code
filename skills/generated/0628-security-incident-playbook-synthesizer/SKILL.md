...
## Operational Runbook
### Preflight
- Confirm the Security Incident Playbook Synthesizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0628_security-incident-playbook-synth, approval gates, and rollback owner before autonomous use.
