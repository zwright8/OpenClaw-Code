...
description: Build and operate the "Inclusion Memory Consolidation Pipeline" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0818_inclusion-memory-consolidation-p, approval gates, and rollback owner before autonomous use.
