...
## When To Use
Use this skill when the request explicitly needs "Handoff Contracting for knowledge management systems" outcomes in the knowledge management systems domain.
...
- Runtime profile: generalist-engine using handoff contracting to produce handoff-contracting-artifact-knowledge-management-systems.
