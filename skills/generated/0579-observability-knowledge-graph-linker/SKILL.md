...
description: Build and operate the "Observability Knowledge Graph Linker" capability for Data Quality and Observability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Observability Knowledge Graph Linker" outcomes in the Data Quality and Observability domain.
...
## Operational Runbook
### Preflight
- Confirm the Observability Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0579_observability-knowledge-graph-li, approval gates, and rollback owner before autonomous use.
