...
description: Build and operate the "Evolution Cost-Benefit Forecaster" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Evolution Cost-Benefit Forecaster request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0993_evolution-cost-benefit-forecaste, approval gates, and rollback owner before autonomous use.
