...
description: Build and operate the "Crisis Failure Root-Cause Miner" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Crisis Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0656_crisis-failure-root-cause-miner, approval gates, and rollback owner before autonomous use.
