...
description: Build and operate the "Tooling Dependency DAG Planner" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Dependency DAG Planner" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0128_tooling-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
