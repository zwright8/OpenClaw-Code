...
description: Build and operate the "Observability Regression Sentinel" capability for Data Quality and Observability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Observability Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0577_observability-regression-sentine, approval gates, and rollback owner before autonomous use.
