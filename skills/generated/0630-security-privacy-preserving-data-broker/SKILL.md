...
description: Build and operate the "Security Privacy Preserving Data Broker" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security Privacy Preserving Data Broker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0630_security-privacy-preserving-data, approval gates, and rollback owner before autonomous use.
