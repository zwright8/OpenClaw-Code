...
description: Build and operate the "Economic Resource Budget Allocator" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Resource Budget Allocator" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Resource Budget Allocator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0329_economic-resource-budget-allocat, approval gates, and rollback owner before autonomous use.
