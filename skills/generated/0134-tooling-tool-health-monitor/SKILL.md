...
description: Build and operate the "Tooling Tool Health Monitor" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Tool Health Monitor" outcomes in the Tool Reliability and Execution Quality domain.
...
- Orchestration integration: tool-reliability-and-execution-quality:detection-guard routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Tooling Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0134_tooling-tool-health-monitor, approval gates, and rollback owner before autonomous use.
