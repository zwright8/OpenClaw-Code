...
description: Build and operate the "Observability Tool Health Monitor" capability for Data Quality and Observability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Observability Tool Health Monitor" outcomes in the Data Quality and Observability domain.
...
## Operational Runbook
### Preflight
- Confirm the Observability Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0574_observability-tool-health-monito, approval gates, and rollback owner before autonomous use.
