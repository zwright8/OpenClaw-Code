...
## Operational Runbook
### Preflight
- Confirm the Oversight Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0216_oversight-failure-root-cause-min, approval gates, and rollback owner before autonomous use.
