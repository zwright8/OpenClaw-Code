...
description: Build and operate the "Oversight Failure Root-Cause Miner" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Failure Root-Cause Miner" outcomes in the Human Oversight and Operator UX domain.
