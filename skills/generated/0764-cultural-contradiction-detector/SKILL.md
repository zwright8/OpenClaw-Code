...
## When To Use
Use this skill when the request explicitly needs "Cultural Contradiction Detector" outcomes in the Multilingual and Cultural Adaptation domain.
...
## Operational Runbook
### Preflight
- Confirm the Cultural Contradiction Detector request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0764_cultural-contradiction-detector, approval gates, and rollback owner before autonomous use.
