...
description: Build and operate the "Planning Experiment Design Generator" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Experiment Design Generator" outcomes in the Strategic Planning and Decomposition domain.
...
## Operational Runbook
### Preflight
- Confirm the Planning Experiment Design Generator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0066_planning-experiment-design-gener, approval gates, and rollback owner before autonomous use.
