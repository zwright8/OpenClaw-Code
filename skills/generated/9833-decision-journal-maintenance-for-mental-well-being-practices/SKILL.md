...
## When To Use
Use this skill when the request explicitly needs "Decision Journal Maintenance for mental well-being practices" outcomes in the mental well-being practices domain.
...
- Runtime profile: journal-engine using decision journal maintenance to produce decision-journal-maintenance-artifact-mental-well-being-practice.
- Orchestration integration: mental-well-being-practices:journal-engine routing, approval gates, retries, and rollback controls.
