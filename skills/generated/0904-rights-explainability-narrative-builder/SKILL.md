...
description: Build and operate the "Rights Explainability Narrative Builder" capability for Legal, Rights, and Compliance. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Rights Explainability Narrative Builder request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0904_rights-explainability-narrative-, approval gates, and rollback owner before autonomous use.
