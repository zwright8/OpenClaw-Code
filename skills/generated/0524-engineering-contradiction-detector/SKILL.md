...
description: Build and operate the "Engineering Contradiction Detector" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Engineering Contradiction Detector request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0524_engineering-contradiction-detect, approval gates, and rollback owner before autonomous use.
