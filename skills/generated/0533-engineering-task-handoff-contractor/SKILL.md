...
description: Build and operate the "Engineering Task Handoff Contractor" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Engineering Task Handoff Contractor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0533_engineering-task-handoff-contrac, approval gates, and rollback owner before autonomous use.
