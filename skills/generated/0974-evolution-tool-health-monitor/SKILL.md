...
description: Build and operate the "Evolution Tool Health Monitor" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Evolution Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0974_evolution-tool-health-monitor, approval gates, and rollback owner before autonomous use.
