...
description: Build and operate the "Security Signal Ingestion Normalizer" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security Signal Ingestion Normalizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0601_security-signal-ingestion-normal, approval gates, and rollback owner before autonomous use.
