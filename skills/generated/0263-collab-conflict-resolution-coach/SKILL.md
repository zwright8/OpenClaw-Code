...
description: Build and operate the "Collab Conflict Resolution Coach" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Conflict Resolution Coach" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0263_collab-conflict-resolution-coach, approval gates, and rollback owner before autonomous use.
