...
description: Build and operate the "Epistemic KPI Dashboard Publisher" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic KPI Dashboard Publisher" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0036_epistemic-kpi-dashboard-publishe, approval gates, and rollback owner before autonomous use.
