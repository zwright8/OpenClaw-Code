...
description: Build and operate the "Inclusion Self-Reflection Error Taxonomist" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Self-Reflection Error Taxonomist request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0839_inclusion-self-reflection-error-, approval gates, and rollback owner before autonomous use.
