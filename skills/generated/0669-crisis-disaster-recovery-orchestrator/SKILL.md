...
description: Build and operate the "Crisis Disaster Recovery Orchestrator" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Crisis Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0669_crisis-disaster-recovery-orchest, approval gates, and rollback owner before autonomous use.
