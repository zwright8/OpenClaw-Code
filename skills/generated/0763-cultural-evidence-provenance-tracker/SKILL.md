...
- Orchestration integration: multilingual-and-cultural-adaptation:provenance-tracker routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Cultural Evidence Provenance Tracker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0763_cultural-evidence-provenance-tra, approval gates, and rollback owner before autonomous use.
