...
## Operational Runbook
### Preflight
- Confirm the Infra Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0937_infra-regression-sentinel, approval gates, and rollback owner before autonomous use.
