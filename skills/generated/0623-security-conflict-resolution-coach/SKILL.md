...
description: Build and operate the "Security Conflict Resolution Coach" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0623_security-conflict-resolution-coa, approval gates, and rollback owner before autonomous use.
