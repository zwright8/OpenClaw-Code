...
description: Build and operate the "Evolution Contradiction Detector" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Evolution Contradiction Detector request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0964_evolution-contradiction-detector, approval gates, and rollback owner before autonomous use.
