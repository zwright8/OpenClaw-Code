...
description: Build and operate the "Impact Self-Reflection Error Taxonomist" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Self-Reflection Error Taxonomist request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0719_impact-self-reflection-error-tax, approval gates, and rollback owner before autonomous use.
