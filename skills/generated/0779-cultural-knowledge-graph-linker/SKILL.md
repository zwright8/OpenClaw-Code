...
## Operational Runbook
### Preflight
- Confirm the Cultural Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0779_cultural-knowledge-graph-linker, approval gates, and rollback owner before autonomous use.
