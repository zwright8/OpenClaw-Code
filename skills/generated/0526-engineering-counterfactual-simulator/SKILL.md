...
description: Build and operate the "Engineering Counterfactual Simulator" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
- Orchestration integration: software-engineering-automation:simulation-lab routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Engineering Counterfactual Simulator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0526_engineering-counterfactual-simul, approval gates, and rollback owner before autonomous use.
