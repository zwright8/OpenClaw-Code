...
description: Build and operate the "Inclusion Tool Health Monitor" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0814_inclusion-tool-health-monitor, approval gates, and rollback owner before autonomous use.
