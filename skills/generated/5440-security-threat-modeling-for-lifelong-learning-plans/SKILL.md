...
## When To Use
Use this skill when the request explicitly needs "Security Threat Modeling for lifelong learning plans" outcomes in the lifelong learning plans domain.
...
- Runtime profile: modeling-engine using security threat modeling to produce security-threat-modeling-artifact-lifelong-learning-plans.
- Orchestration integration: lifelong-learning-plans:modeling-engine routing, approval gates, retries, and rollback controls.
