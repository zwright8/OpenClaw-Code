...
description: Build and operate the "Research Equity Impact Scorer" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Research Equity Impact Scorer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0514_research-equity-impact-scorer, approval gates, and rollback owner before autonomous use.
