...
## Operational Runbook
### Preflight
- Confirm the Security Plan Quality Evaluator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0621_security-plan-quality-evaluator, approval gates, and rollback owner before autonomous use.
