...
description: Build and operate the "Impact Memory Consolidation Pipeline" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0698_impact-memory-consolidation-pipe, approval gates, and rollback owner before autonomous use.
