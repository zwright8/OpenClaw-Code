...
description: Build and operate the "Engineering Conflict Resolution Coach" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Engineering Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0543_engineering-conflict-resolution-, approval gates, and rollback owner before autonomous use.
