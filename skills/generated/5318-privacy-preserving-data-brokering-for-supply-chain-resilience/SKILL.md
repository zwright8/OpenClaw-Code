...
## When To Use
Use this skill when the request explicitly needs "Privacy-Preserving Data Brokering for supply chain resilience" outcomes in the supply chain resilience domain.
...
- Runtime profile: privacy-engine using privacy-preserving data brokering to produce privacy-preserving-data-brokering-artifact-supply-chain-resilien.
- Orchestration integration: supply-chain-resilience:privacy-engine routing, approval gates, retries, and rollback controls.
