...
description: Build and operate the "Infra Resource Budget Allocator" capability for Infrastructure and Sustainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Infra Resource Budget Allocator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0929_infra-resource-budget-allocator, approval gates, and rollback owner before autonomous use.
