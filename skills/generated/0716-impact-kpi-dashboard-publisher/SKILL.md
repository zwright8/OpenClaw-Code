...
description: Build and operate the "Impact KPI Dashboard Publisher" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0716_impact-kpi-dashboard-publisher, approval gates, and rollback owner before autonomous use.
