...
description: Build and operate the "Collab Regression Sentinel" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Regression Sentinel" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0257_collab-regression-sentinel, approval gates, and rollback owner before autonomous use.
