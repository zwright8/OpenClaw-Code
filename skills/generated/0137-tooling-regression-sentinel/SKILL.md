...
description: Build and operate the "Tooling Regression Sentinel" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Regression Sentinel" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0137_tooling-regression-sentinel, approval gates, and rollback owner before autonomous use.
