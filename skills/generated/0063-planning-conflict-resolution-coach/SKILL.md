...
description: Build and operate the "Planning Conflict Resolution Coach" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Conflict Resolution Coach" outcomes in the Strategic Planning and Decomposition domain.
...
## Operational Runbook
### Preflight
- Confirm the Planning Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0063_planning-conflict-resolution-coa, approval gates, and rollback owner before autonomous use.
