...
## Operational Runbook
### Preflight
- Confirm the Infra Task Handoff Contractor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0933_infra-task-handoff-contractor, approval gates, and rollback owner before autonomous use.
