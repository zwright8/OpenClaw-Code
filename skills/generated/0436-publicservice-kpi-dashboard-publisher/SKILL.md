...
## When To Use
Use this skill when the request explicitly needs "PublicService KPI Dashboard Publisher" outcomes in the Healthcare and Public Services domain.
...
## Operational Runbook
### Preflight
- Confirm the PublicService KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0436_publicservice-kpi-dashboard-publ, approval gates, and rollback owner before autonomous use.
