...
description: Build and operate the "Collab Privacy Preserving Data Broker" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Privacy Preserving Data Broker" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Privacy Preserving Data Broker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0270_collab-privacy-preserving-data-b, approval gates, and rollback owner before autonomous use.
