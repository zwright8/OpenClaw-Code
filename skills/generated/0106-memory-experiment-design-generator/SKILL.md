...
description: Build and operate the "Memory Experiment Design Generator" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Experiment Design Generator" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Experiment Design Generator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0106_memory-experiment-design-generat, approval gates, and rollback owner before autonomous use.
