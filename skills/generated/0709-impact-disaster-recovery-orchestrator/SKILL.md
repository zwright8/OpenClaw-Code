...
description: Build and operate the "Impact Disaster Recovery Orchestrator" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0709_impact-disaster-recovery-orchest, approval gates, and rollback owner before autonomous use.
