...
description: Build and operate the "Governance Training Curriculum Composer" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Training Curriculum Composer" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Training Curriculum Composer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0198_governance-training-curriculum-c, approval gates, and rollback owner before autonomous use.
