...
description: Build and operate the "Planning Regression Sentinel" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Regression Sentinel" outcomes in the Strategic Planning and Decomposition domain.
...
## Operational Runbook
### Preflight
- Confirm the Planning Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0057_planning-regression-sentinel, approval gates, and rollback owner before autonomous use.
