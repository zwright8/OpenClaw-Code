...
## Operational Runbook
### Preflight
- Confirm the Infra Skill Gap Diagnoser request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0957_infra-skill-gap-diagnoser, approval gates, and rollback owner before autonomous use.
