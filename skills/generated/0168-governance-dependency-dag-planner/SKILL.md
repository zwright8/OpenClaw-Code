...
description: Build and operate the "Governance Dependency DAG Planner" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Dependency DAG Planner" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0168_governance-dependency-dag-planne, approval gates, and rollback owner before autonomous use.
