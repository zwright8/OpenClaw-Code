...
description: Build and operate the "Planning Self-Reflection Error Taxonomist" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Self-Reflection Error Taxonomist" outcomes in the Strategic Planning and Decomposition domain.
...
## Operational Runbook
### Preflight
- Confirm the Planning Self-Reflection Error Taxonomist request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0079_planning-self-reflection-error-t, approval gates, and rollback owner before autonomous use.
