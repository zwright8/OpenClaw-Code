...
description: Build and operate the "Crisis Privacy Preserving Data Broker" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Crisis Privacy Preserving Data Broker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0670_crisis-privacy-preserving-data-b, approval gates, and rollback owner before autonomous use.
