...
## Operational Runbook
### Preflight
- Confirm the Inclusion Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0820_inclusion-semantic-retrieval-ran, approval gates, and rollback owner before autonomous use.
