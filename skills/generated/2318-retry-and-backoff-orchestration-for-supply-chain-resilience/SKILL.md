...
## When To Use
Use this skill when the request explicitly needs "Retry And Backoff Orchestration for supply chain resilience" outcomes in the supply chain resilience domain.
...
- Runtime profile: generalist-engine using retry and backoff orchestration to produce retry-and-backoff-orchestration-artifact-supply-chain-resilience.
