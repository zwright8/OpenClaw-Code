...
## Operational Runbook
### Preflight
- Confirm the Federation Resource Budget Allocator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0289_federation-resource-budget-alloc, approval gates, and rollback owner before autonomous use.
