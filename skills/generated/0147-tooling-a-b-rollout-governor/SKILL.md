...
description: Build and operate the "Tooling A/B Rollout Governor" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling A/B Rollout Governor" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling A/B Rollout Governor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0147_tooling-a-b-rollout-governor, approval gates, and rollback owner before autonomous use.
