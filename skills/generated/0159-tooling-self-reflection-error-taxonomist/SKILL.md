...
description: Build and operate the "Tooling Self-Reflection Error Taxonomist" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Self-Reflection Error Taxonomist" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling Self-Reflection Error Taxonomist request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0159_tooling-self-reflection-error-ta, approval gates, and rollback owner before autonomous use.
