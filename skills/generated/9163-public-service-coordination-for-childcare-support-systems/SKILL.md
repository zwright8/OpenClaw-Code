...
## When To Use
Use this skill when the request explicitly needs "Public Service Coordination for childcare support systems" outcomes in the childcare support systems domain.
...
- Runtime profile: public-service-engine using public service coordination to produce public-service-coordination-artifact-childcare-support-systems.
- Orchestration integration: childcare-support-systems:public-service-engine routing, approval gates, retries, and rollback controls.
