---
name: research-repositories-reliability-scorer
description: Use when tasks require research repositories reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Reliability Scorer

## Purpose
Design and execute research repositories workflows using reliability scorer controls with validated outcomes.
