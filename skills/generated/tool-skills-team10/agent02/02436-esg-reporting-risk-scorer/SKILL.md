---
name: esg-reporting-risk-scorer
description: Use when tasks require esg reporting risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Risk Scorer

## Purpose
Design and execute esg reporting workflows using risk scorer controls with validated outcomes.
