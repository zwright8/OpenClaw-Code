---
name: admissions-systems-root-cause-miner
description: Use when tasks require admissions systems root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Root Cause Miner

## Purpose
Design and execute admissions systems workflows using root cause miner controls with validated outcomes.
