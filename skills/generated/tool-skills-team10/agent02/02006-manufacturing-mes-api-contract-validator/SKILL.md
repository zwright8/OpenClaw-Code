---
name: manufacturing-mes-api-contract-validator
description: Use when tasks require manufacturing mes api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES API Contract Validator

## Purpose
Design and execute manufacturing mes workflows using api contract validator controls with validated outcomes.
...
- Domain: [Manufacturing MES](../../resources/domains/manufacturing-mes.md)
