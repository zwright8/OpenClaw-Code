---
name: admissions-systems-compliance-mapper
description: Use when tasks require admissions systems compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Compliance Mapper

## Purpose
Design and execute admissions systems workflows using compliance mapper controls with validated outcomes.
