---
name: fleet-telematics-secret-scanner
description: Use when tasks require fleet telematics secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Secret Scanner

## Purpose
Design and execute fleet telematics workflows using secret scanner controls with validated outcomes.
