---
name: energy-grid-ops-feedback-harvester
description: Use when tasks require energy grid ops feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Feedback Harvester

## Purpose
Design and execute energy grid ops workflows using feedback harvester controls with validated outcomes.
