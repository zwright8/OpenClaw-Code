---
name: clinical-trial-systems-rollback-coordinator
description: Use when tasks require clinical trial systems rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Rollback Coordinator

## Purpose
Design and execute clinical trial systems workflows using rollback coordinator controls with validated outcomes.
