---
name: clinical-trial-systems-evidence-collector
description: Use when tasks require clinical trial systems evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Evidence Collector

## Purpose
Design and execute clinical trial systems workflows using evidence collector controls with validated outcomes.
