---
name: clinical-trial-systems-schema-introspector
description: Use when tasks require clinical trial systems schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Schema Introspector

## Purpose
Design and execute clinical trial systems workflows using schema introspector controls with validated outcomes.
