---
name: quality-management-risk-scorer
description: Use when tasks require quality management risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Risk Scorer

## Purpose
Design and execute quality management workflows using risk scorer controls with validated outcomes.
