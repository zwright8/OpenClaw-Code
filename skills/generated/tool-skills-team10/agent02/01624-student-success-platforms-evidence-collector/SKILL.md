---
name: student-success-platforms-evidence-collector
description: Use when tasks require student success platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Evidence Collector

## Purpose
Design and execute student success platforms workflows using evidence collector controls with validated outcomes.
