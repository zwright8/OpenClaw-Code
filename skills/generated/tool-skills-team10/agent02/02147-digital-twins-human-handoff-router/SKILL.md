---
name: digital-twins-human-handoff-router
description: Use when tasks require digital twins human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Digital Twins Human Handoff Router

## Purpose
Design and execute digital twins workflows using human handoff router controls with validated outcomes.
