---
name: utility-billing-anomaly-detector
description: Use when tasks require utility billing anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Anomaly Detector

## Purpose
Design and execute utility billing workflows using anomaly detector controls with validated outcomes.
