---
name: real-estate-mls-runbook-composer
description: Use when tasks require real estate mls runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Runbook Composer

## Purpose
Design and execute real estate mls workflows using runbook composer controls with validated outcomes.
