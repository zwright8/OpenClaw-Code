---
name: research-repositories-secret-scanner
description: Use when tasks require research repositories secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Secret Scanner

## Purpose
Design and execute research repositories workflows using secret scanner controls with validated outcomes.
