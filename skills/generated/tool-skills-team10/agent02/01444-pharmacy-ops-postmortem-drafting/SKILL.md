---
name: pharmacy-ops-postmortem-drafting
description: Use when tasks require pharmacy ops postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Postmortem Drafting

## Purpose
Design and execute pharmacy ops workflows using postmortem drafting controls with validated outcomes.
