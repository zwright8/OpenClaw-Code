---
name: energy-grid-ops-rollback-coordinator
description: Use when tasks require energy grid ops rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Rollback Coordinator

## Purpose
Design and execute energy grid ops workflows using rollback coordinator controls with validated outcomes.
