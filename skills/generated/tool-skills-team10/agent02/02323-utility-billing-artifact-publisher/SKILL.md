---
name: utility-billing-artifact-publisher
description: Use when tasks require utility billing artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Artifact Publisher

## Purpose
Design and execute utility billing workflows using artifact publisher controls with validated outcomes.
