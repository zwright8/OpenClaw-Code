---
name: clinical-trial-systems-artifact-publisher
description: Use when tasks require clinical trial systems artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Artifact Publisher

## Purpose
Design and execute clinical trial systems workflows using artifact publisher controls with validated outcomes.
