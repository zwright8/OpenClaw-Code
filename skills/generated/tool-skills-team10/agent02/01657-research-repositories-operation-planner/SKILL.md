---
name: research-repositories-operation-planner
description: Use when tasks require research repositories operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Operation Planner

## Purpose
Design and execute research repositories workflows using operation planner controls with validated outcomes.
