---
name: esg-reporting-capacity-planner
description: Use when tasks require esg reporting capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Capacity Planner

## Purpose
Design and execute esg reporting workflows using capacity planner controls with validated outcomes.
