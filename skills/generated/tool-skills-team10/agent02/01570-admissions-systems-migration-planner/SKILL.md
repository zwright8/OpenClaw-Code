---
name: admissions-systems-migration-planner
description: Use when tasks require admissions systems migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Migration Planner

## Purpose
Design and execute admissions systems workflows using migration planner controls with validated outcomes.
