---
name: energy-grid-ops-reliability-scorer
description: Use when tasks require energy grid ops reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Reliability Scorer

## Purpose
Design and execute energy grid ops workflows using reliability scorer controls with validated outcomes.
