---
name: library-networks-evidence-collector
description: Use when tasks require library networks evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Library Networks Evidence Collector

## Purpose
Design and execute library networks workflows using evidence collector controls with validated outcomes.
