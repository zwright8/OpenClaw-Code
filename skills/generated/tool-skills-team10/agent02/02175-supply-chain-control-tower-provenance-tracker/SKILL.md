---
name: supply-chain-control-tower-provenance-tracker
description: Use when tasks require supply chain control tower provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Provenance Tracker

## Purpose
Design and execute supply chain control tower workflows using provenance tracker controls with validated outcomes.
...
4. Execute provenance tracker actions with minimal blast radius.
...
- Capability: [Provenance Tracker](../../resources/capabilities/provenance-tracker.md)
