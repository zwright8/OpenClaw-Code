---
name: research-repositories-snapshot-manager
description: Use when tasks require research repositories snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Snapshot Manager

## Purpose
Design and execute research repositories workflows using snapshot manager controls with validated outcomes.
