---
name: carbon-accounting-reliability-scorer
description: Use when tasks require carbon accounting reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Reliability Scorer

## Purpose
Design and execute carbon accounting workflows using reliability scorer controls with validated outcomes.
