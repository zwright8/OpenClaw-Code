---
name: real-estate-mls-feedback-harvester
description: Use when tasks require real estate mls feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Feedback Harvester

## Purpose
Design and execute real estate mls workflows using feedback harvester controls with validated outcomes.
