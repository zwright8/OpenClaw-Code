---
name: freight-brokerage-snapshot-manager
description: Use when tasks require freight brokerage snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Snapshot Manager

## Purpose
Design and execute freight brokerage workflows using snapshot manager controls with validated outcomes.
