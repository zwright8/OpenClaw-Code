---
name: carbon-accounting-pii-redactor
description: Use when tasks require carbon accounting pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting PII Redactor

## Purpose
Design and execute carbon accounting workflows using pii redactor controls with validated outcomes.
