---
name: supply-chain-control-tower-rollback-coordinator
description: Use when tasks require supply chain control tower rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Rollback Coordinator

## Purpose
Design and execute supply chain control tower workflows using rollback coordinator controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Rollback Coordinator
- Score: 80
- Rank: 1764
- Priority band: P2
...
4. Execute rollback coordinator actions with minimal blast radius.
...
- Capability: [Rollback Coordinator](../../resources/capabilities/rollback-coordinator.md)
