---
name: education-lms-human-handoff-router
description: Use when tasks require education lms human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Human Handoff Router

## Purpose
Design and execute education lms workflows using human handoff router controls with validated outcomes.
