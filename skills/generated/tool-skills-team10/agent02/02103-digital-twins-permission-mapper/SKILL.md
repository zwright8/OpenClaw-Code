---
name: digital-twins-permission-mapper
description: Use when tasks require digital twins permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Digital Twins Permission Mapper

## Purpose
Design and execute digital twins workflows using permission mapper controls with validated outcomes.
