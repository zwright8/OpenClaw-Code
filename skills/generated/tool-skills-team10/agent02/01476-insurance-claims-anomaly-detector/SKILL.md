---
name: insurance-claims-anomaly-detector
description: Use when tasks require insurance claims anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Anomaly Detector

## Purpose
Design and execute insurance claims workflows using anomaly detector controls with validated outcomes.
