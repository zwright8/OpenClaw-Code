---
name: property-management-anomaly-detector
description: Use when tasks require property management anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Anomaly Detector

## Purpose
Design and execute property management workflows using anomaly detector controls with validated outcomes.
