---
name: environmental-sensors-task-decomposer
description: Use when tasks require environmental sensors task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Task Decomposer

## Purpose
Design and execute environmental sensors workflows using task decomposer controls with validated outcomes.
