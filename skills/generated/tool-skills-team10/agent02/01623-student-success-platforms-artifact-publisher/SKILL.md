---
name: student-success-platforms-artifact-publisher
description: Use when tasks require student success platforms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Artifact Publisher

## Purpose
Design and execute student success platforms workflows using artifact publisher controls with validated outcomes.
