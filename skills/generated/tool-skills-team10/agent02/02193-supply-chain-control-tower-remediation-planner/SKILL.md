---
name: supply-chain-control-tower-remediation-planner
description: Use when tasks require supply chain control tower remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Remediation Planner

## Purpose
Design and execute supply chain control tower workflows using remediation planner controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Remediation Planner
- Score: 85
- Rank: 821
- Priority band: P1
...
4. Execute remediation planner actions with minimal blast radius.
...
- Capability: [Remediation Planner](../../resources/capabilities/remediation-planner.md)
