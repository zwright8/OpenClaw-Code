---
name: esg-reporting-evidence-collector
description: Use when tasks require esg reporting evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Evidence Collector

## Purpose
Design and execute esg reporting workflows using evidence collector controls with validated outcomes.
