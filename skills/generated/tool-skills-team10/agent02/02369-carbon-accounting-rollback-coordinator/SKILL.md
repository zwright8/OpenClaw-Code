---
name: carbon-accounting-rollback-coordinator
description: Use when tasks require carbon accounting rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Rollback Coordinator

## Purpose
Design and execute carbon accounting workflows using rollback coordinator controls with validated outcomes.
