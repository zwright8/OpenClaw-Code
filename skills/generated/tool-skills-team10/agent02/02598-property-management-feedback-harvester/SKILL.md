---
name: property-management-feedback-harvester
description: Use when tasks require property management feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Feedback Harvester

## Purpose
Design and execute property management workflows using feedback harvester controls with validated outcomes.
