---
name: logistics-dispatch-postmortem-drafting
description: Use when tasks require logistics dispatch postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Postmortem Drafting

## Purpose
Design and execute logistics dispatch workflows using postmortem drafting controls with validated outcomes.
