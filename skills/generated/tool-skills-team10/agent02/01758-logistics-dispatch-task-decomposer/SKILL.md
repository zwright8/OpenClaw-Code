---
name: logistics-dispatch-task-decomposer
description: Use when tasks require logistics dispatch task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Task Decomposer

## Purpose
Design and execute logistics dispatch workflows using task decomposer controls with validated outcomes.
