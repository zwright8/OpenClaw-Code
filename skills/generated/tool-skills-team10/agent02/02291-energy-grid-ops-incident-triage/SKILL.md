---
name: energy-grid-ops-incident-triage
description: Use when tasks require energy grid ops incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Incident Triage

## Purpose
Design and execute energy grid ops workflows using incident triage controls with validated outcomes.
