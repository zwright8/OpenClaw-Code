---
name: quality-management-policy-evaluator
description: Use when tasks require quality management policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Policy Evaluator

## Purpose
Design and execute quality management workflows using policy evaluator controls with validated outcomes.
