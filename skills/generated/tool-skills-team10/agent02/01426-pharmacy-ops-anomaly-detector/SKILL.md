---
name: pharmacy-ops-anomaly-detector
description: Use when tasks require pharmacy ops anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Anomaly Detector

## Purpose
Design and execute pharmacy ops workflows using anomaly detector controls with validated outcomes.
