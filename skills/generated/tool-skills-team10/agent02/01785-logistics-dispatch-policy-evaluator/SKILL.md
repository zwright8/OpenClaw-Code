---
name: logistics-dispatch-policy-evaluator
description: Use when tasks require logistics dispatch policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Policy Evaluator

## Purpose
Design and execute logistics dispatch workflows using policy evaluator controls with validated outcomes.
