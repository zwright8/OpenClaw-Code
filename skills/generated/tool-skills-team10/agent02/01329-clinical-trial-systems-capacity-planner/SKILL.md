---
name: clinical-trial-systems-capacity-planner
description: Use when tasks require clinical trial systems capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Capacity Planner

## Purpose
Design and execute clinical trial systems workflows using capacity planner controls with validated outcomes.
