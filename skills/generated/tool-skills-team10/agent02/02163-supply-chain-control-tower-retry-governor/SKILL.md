---
name: supply-chain-control-tower-retry-governor
description: Use when tasks require supply chain control tower retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Retry Governor

## Purpose
Design and execute supply chain control tower workflows using retry governor controls with validated outcomes.
