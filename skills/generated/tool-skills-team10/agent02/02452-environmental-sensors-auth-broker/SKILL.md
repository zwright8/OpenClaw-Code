---
name: environmental-sensors-auth-broker
description: Use when tasks require environmental sensors auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Auth Broker

## Purpose
Design and execute environmental sensors workflows using auth broker controls with validated outcomes.
