---
name: insurance-claims-permission-mapper
description: Use when tasks require insurance claims permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Permission Mapper

## Purpose
Design and execute insurance claims workflows using permission mapper controls with validated outcomes.
