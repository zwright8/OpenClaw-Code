---
name: logistics-dispatch-conflict-resolver
description: Use when tasks require logistics dispatch conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Conflict Resolver

## Purpose
Design and execute logistics dispatch workflows using conflict resolver controls with validated outcomes.
