---
name: freight-brokerage-risk-scorer
description: Use when tasks require freight brokerage risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Risk Scorer

## Purpose
Design and execute freight brokerage workflows using risk scorer controls with validated outcomes.
