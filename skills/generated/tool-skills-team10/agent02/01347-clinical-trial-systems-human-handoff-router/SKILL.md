---
name: clinical-trial-systems-human-handoff-router
description: Use when tasks require clinical trial systems human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Human Handoff Router

## Purpose
Design and execute clinical trial systems workflows using human handoff router controls with validated outcomes.
