---
name: fleet-telematics-spec-drift-detector
description: Use when tasks require fleet telematics spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Spec Drift Detector

## Purpose
Design and execute fleet telematics workflows using spec drift detector controls with validated outcomes.
