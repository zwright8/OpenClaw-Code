---
name: library-networks-anomaly-detector
description: Use when tasks require library networks anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Library Networks Anomaly Detector

## Purpose
Design and execute library networks workflows using anomaly detector controls with validated outcomes.
