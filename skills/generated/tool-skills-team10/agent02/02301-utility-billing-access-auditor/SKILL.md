---
name: utility-billing-access-auditor
description: Use when tasks require utility billing access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Access Auditor

## Purpose
Design and execute utility billing workflows using access auditor controls with validated outcomes.
