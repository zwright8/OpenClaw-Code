---
name: pharmacy-ops-rollback-coordinator
description: Use when tasks require pharmacy ops rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Rollback Coordinator

## Purpose
Design and execute pharmacy ops workflows using rollback coordinator controls with validated outcomes.
