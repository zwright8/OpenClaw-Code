---
name: warehouse-robotics-quality-gatekeeper
description: Use when tasks require warehouse robotics quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Quality Gatekeeper

## Purpose
Design and execute warehouse robotics workflows using quality gatekeeper controls with validated outcomes.
