---
name: freight-brokerage-forecast-engine
description: Use when tasks require freight brokerage forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Forecast Engine

## Purpose
Design and execute freight brokerage workflows using forecast engine controls with validated outcomes.
