---
name: utility-billing-conflict-resolver
description: Use when tasks require utility billing conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Conflict Resolver

## Purpose
Design and execute utility billing workflows using conflict resolver controls with validated outcomes.
