---
name: fleet-telematics-runbook-composer
description: Use when tasks require fleet telematics runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Runbook Composer

## Purpose
Design and execute fleet telematics workflows using runbook composer controls with validated outcomes.
