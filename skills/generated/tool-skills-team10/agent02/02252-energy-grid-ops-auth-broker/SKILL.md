---
name: energy-grid-ops-auth-broker
description: Use when tasks require energy grid ops auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Auth Broker

## Purpose
Design and execute energy grid ops workflows using auth broker controls with validated outcomes.
