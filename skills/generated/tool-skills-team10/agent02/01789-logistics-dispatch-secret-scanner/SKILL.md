---
name: logistics-dispatch-secret-scanner
description: Use when tasks require logistics dispatch secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Secret Scanner

## Purpose
Design and execute logistics dispatch workflows using secret scanner controls with validated outcomes.
