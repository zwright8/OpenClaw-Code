---
name: logistics-dispatch-operation-planner
description: Use when tasks require logistics dispatch operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Operation Planner

## Purpose
Design and execute logistics dispatch workflows using operation planner controls with validated outcomes.
