...
description: Use when tasks require carbon accounting secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Secret Scanner

## Purpose
Design and execute carbon accounting workflows using secret scanner controls with validated outcomes.
