---
name: insurance-claims-provenance-tracker
description: Use when tasks require insurance claims provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Provenance Tracker

## Purpose
Design and execute insurance claims workflows using provenance tracker controls with validated outcomes.
