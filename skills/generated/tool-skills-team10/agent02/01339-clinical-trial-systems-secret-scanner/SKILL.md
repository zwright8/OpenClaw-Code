---
name: clinical-trial-systems-secret-scanner
description: Use when tasks require clinical trial systems secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Secret Scanner

## Purpose
Design and execute clinical trial systems workflows using secret scanner controls with validated outcomes.
