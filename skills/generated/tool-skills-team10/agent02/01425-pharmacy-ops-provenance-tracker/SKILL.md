---
name: pharmacy-ops-provenance-tracker
description: Use when tasks require pharmacy ops provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Provenance Tracker

## Purpose
Design and execute pharmacy ops workflows using provenance tracker controls with validated outcomes.
