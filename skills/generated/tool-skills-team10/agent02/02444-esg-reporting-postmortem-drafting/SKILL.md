---
name: esg-reporting-postmortem-drafting
description: Use when tasks require esg reporting postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Postmortem Drafting

## Purpose
Design and execute esg reporting workflows using postmortem drafting controls with validated outcomes.
