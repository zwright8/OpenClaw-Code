---
name: admissions-systems-version-tracker
description: Use when tasks require admissions systems version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Version Tracker

## Purpose
Design and execute admissions systems workflows using version tracker controls with validated outcomes.
