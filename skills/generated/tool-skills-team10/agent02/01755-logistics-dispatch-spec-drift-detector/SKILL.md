---
name: logistics-dispatch-spec-drift-detector
description: Use when tasks require logistics dispatch spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Spec Drift Detector

## Purpose
Design and execute logistics dispatch workflows using spec drift detector controls with validated outcomes.
