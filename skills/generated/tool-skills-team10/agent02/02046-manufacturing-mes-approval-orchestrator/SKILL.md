---
name: manufacturing-mes-approval-orchestrator
description: Use when tasks require manufacturing mes approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Approval Orchestrator

## Purpose
Design and execute manufacturing mes workflows using approval orchestrator controls with validated outcomes.
