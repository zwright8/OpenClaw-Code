---
name: esg-reporting-feedback-harvester
description: Use when tasks require esg reporting feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Feedback Harvester

## Purpose
Design and execute esg reporting workflows using feedback harvester controls with validated outcomes.
