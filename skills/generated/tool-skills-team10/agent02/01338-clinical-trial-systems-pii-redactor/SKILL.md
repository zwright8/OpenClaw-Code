---
name: clinical-trial-systems-pii-redactor
description: Use when tasks require clinical trial systems pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems PII Redactor

## Purpose
Design and execute clinical trial systems workflows using pii redactor controls with validated outcomes.
