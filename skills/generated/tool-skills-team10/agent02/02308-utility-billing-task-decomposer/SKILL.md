---
name: utility-billing-task-decomposer
description: Use when tasks require utility billing task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Task Decomposer

## Purpose
Design and execute utility billing workflows using task decomposer controls with validated outcomes.
