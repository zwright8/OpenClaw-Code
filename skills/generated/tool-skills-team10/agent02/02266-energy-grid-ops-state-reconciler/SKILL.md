---
name: energy-grid-ops-state-reconciler
description: Use when tasks require energy grid ops state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops State Reconciler

## Purpose
Design and execute energy grid ops workflows using state reconciler controls with validated outcomes.
