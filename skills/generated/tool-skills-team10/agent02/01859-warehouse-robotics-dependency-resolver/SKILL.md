---
name: warehouse-robotics-dependency-resolver
description: Use when tasks require warehouse robotics dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Dependency Resolver

## Purpose
Design and execute warehouse robotics workflows using dependency resolver controls with validated outcomes.
