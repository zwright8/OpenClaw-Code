---
name: logistics-dispatch-anomaly-detector
description: Use when tasks require logistics dispatch anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Anomaly Detector

## Purpose
Design and execute logistics dispatch workflows using anomaly detector controls with validated outcomes.
