---
name: clinical-trial-systems-access-auditor
description: Use when tasks require clinical trial systems access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Access Auditor

## Purpose
Design and execute clinical trial systems workflows using access auditor controls with validated outcomes.
