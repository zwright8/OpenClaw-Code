---
name: freight-brokerage-auth-broker
description: Use when tasks require freight brokerage auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Auth Broker

## Purpose
Design and execute freight brokerage workflows using auth broker controls with validated outcomes.
