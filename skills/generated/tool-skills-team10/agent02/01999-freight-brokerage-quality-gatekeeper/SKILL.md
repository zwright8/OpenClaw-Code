---
name: freight-brokerage-quality-gatekeeper
description: Use when tasks require freight brokerage quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Quality Gatekeeper

## Purpose
Design and execute freight brokerage workflows using quality gatekeeper controls with validated outcomes.
