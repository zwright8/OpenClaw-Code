---
name: energy-grid-ops-secret-scanner
description: Use when tasks require energy grid ops secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Secret Scanner

## Purpose
Design and execute energy grid ops workflows using secret scanner controls with validated outcomes.
