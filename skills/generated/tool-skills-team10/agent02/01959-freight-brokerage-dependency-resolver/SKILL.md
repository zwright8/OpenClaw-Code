---
name: freight-brokerage-dependency-resolver
description: Use when tasks require freight brokerage dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Dependency Resolver

## Purpose
Design and execute freight brokerage workflows using dependency resolver controls with validated outcomes.
