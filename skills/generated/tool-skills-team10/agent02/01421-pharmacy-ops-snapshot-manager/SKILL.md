---
name: pharmacy-ops-snapshot-manager
description: Use when tasks require pharmacy ops snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Snapshot Manager

## Purpose
Design and execute pharmacy ops workflows using snapshot manager controls with validated outcomes.
