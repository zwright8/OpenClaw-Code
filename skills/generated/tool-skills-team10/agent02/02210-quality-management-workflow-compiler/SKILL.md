---
name: quality-management-workflow-compiler
description: Use when tasks require quality management workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Workflow Compiler

## Purpose
Design and execute quality management workflows using workflow compiler controls with validated outcomes.
