---
name: research-repositories-spec-drift-detector
description: Use when tasks require research repositories spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Spec Drift Detector

## Purpose
Design and execute research repositories workflows using spec drift detector controls with validated outcomes.
