---
name: quality-management-task-decomposer
description: Use when tasks require quality management task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Task Decomposer

## Purpose
Design and execute quality management workflows using task decomposer controls with validated outcomes.
