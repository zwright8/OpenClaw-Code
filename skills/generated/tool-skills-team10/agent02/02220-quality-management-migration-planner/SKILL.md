---
name: quality-management-migration-planner
description: Use when tasks require quality management migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Migration Planner

## Purpose
Design and execute quality management workflows using migration planner controls with validated outcomes.
