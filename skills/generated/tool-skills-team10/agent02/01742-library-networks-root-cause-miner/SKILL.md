---
name: library-networks-root-cause-miner
description: Use when tasks require library networks root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Library Networks Root Cause Miner

## Purpose
Design and execute library networks workflows using root cause miner controls with validated outcomes.
