---
name: energy-grid-ops-policy-evaluator
description: Use when tasks require energy grid ops policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Policy Evaluator

## Purpose
Design and execute energy grid ops workflows using policy evaluator controls with validated outcomes.
