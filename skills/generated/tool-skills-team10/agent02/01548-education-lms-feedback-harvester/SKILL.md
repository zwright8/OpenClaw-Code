---
name: education-lms-feedback-harvester
description: Use when tasks require education lms feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Feedback Harvester

## Purpose
Design and execute education lms workflows using feedback harvester controls with validated outcomes.
