---
name: insurance-claims-reliability-scorer
description: Use when tasks require insurance claims reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Reliability Scorer

## Purpose
Design and execute insurance claims workflows using reliability scorer controls with validated outcomes.
