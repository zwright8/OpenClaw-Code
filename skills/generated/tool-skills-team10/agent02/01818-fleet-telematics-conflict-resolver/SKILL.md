---
name: fleet-telematics-conflict-resolver
description: Use when tasks require fleet telematics conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Conflict Resolver

## Purpose
Design and execute fleet telematics workflows using conflict resolver controls with validated outcomes.
