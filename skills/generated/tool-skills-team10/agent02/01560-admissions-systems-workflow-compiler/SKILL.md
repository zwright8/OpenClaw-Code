---
name: admissions-systems-workflow-compiler
description: Use when tasks require admissions systems workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Workflow Compiler

## Purpose
Design and execute admissions systems workflows using workflow compiler controls with validated outcomes.
