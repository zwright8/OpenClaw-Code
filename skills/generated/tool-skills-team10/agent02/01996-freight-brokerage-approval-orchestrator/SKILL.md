---
name: freight-brokerage-approval-orchestrator
description: Use when tasks require freight brokerage approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Approval Orchestrator

## Purpose
Design and execute freight brokerage workflows using approval orchestrator controls with validated outcomes.
