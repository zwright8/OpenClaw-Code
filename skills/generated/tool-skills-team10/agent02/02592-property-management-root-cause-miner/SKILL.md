---
name: property-management-root-cause-miner
description: Use when tasks require property management root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Root Cause Miner

## Purpose
Design and execute property management workflows using root cause miner controls with validated outcomes.
