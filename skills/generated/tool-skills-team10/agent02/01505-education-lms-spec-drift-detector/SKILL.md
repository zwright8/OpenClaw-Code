---
name: education-lms-spec-drift-detector
description: Use when tasks require education lms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Spec Drift Detector

## Purpose
Design and execute education lms workflows using spec drift detector controls with validated outcomes.
