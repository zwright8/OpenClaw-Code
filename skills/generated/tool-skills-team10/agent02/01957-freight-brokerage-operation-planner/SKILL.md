---
name: freight-brokerage-operation-planner
description: Use when tasks require freight brokerage operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Operation Planner

## Purpose
Design and execute freight brokerage workflows using operation planner controls with validated outcomes.
