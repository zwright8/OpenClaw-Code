---
name: education-lms-reliability-scorer
description: Use when tasks require education lms reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Reliability Scorer

## Purpose
Design and execute education lms workflows using reliability scorer controls with validated outcomes.
