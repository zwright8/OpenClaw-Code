---
name: pharmacy-ops-remediation-planner
description: Use when tasks require pharmacy ops remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Remediation Planner

## Purpose
Design and execute pharmacy ops workflows using remediation planner controls with validated outcomes.
