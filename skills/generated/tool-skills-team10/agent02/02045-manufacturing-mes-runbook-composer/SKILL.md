---
name: manufacturing-mes-runbook-composer
description: Use when tasks require manufacturing mes runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Runbook Composer

## Purpose
Design and execute manufacturing mes workflows using runbook composer controls with validated outcomes.
