---
name: supply-chain-control-tower-task-decomposer
description: Use when tasks require supply chain control tower task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Task Decomposer

## Purpose
Design and execute supply chain control tower workflows using task decomposer controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Task Decomposer
- Score: 68
- Rank: 5321
- Priority band: P3
...
4. Execute task decomposer actions with minimal blast radius.
...
- Capability: [Task Decomposer](../../resources/capabilities/task-decomposer.md)
