---
name: real-estate-mls-anomaly-detector
description: Use when tasks require real estate mls anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Anomaly Detector

## Purpose
Design and execute real estate mls workflows using anomaly detector controls with validated outcomes.
