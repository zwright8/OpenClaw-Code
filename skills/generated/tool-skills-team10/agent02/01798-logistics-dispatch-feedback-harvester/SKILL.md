---
name: logistics-dispatch-feedback-harvester
description: Use when tasks require logistics dispatch feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Feedback Harvester

## Purpose
Design and execute logistics dispatch workflows using feedback harvester controls with validated outcomes.
