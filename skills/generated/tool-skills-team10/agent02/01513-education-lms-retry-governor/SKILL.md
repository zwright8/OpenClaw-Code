---
name: education-lms-retry-governor
description: Use when tasks require education lms retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Retry Governor

## Purpose
Design and execute education lms workflows using retry governor controls with validated outcomes.
