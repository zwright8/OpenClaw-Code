---
name: insurance-claims-execution-runner
description: Use when tasks require insurance claims execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Execution Runner

## Purpose
Design and execute insurance claims workflows using execution runner controls with validated outcomes.
