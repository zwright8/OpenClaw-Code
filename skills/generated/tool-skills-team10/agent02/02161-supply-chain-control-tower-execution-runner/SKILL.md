---
name: supply-chain-control-tower-execution-runner
description: Use when tasks require supply chain control tower execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Execution Runner

## Purpose
Design and execute supply chain control tower workflows using execution runner controls with validated outcomes.
