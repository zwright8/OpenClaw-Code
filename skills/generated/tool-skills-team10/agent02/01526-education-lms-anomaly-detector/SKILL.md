---
name: education-lms-anomaly-detector
description: Use when tasks require education lms anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Anomaly Detector

## Purpose
Design and execute education lms workflows using anomaly detector controls with validated outcomes.
