---
name: supply-chain-control-tower-api-contract-validator
description: Use when tasks require supply chain control tower api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower API Contract Validator

## Purpose
Design and execute supply chain control tower workflows using api contract validator controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: API Contract Validator
- Score: 106
- Rank: 1
- Priority band: P0
...
4. Execute api contract validator actions with minimal blast radius.
...
- Domain: [Supply Chain Control Tower](../../resources/domains/supply-chain-control-tower.md)
- Capability: [API Contract Validator](../../resources/capabilities/api-contract-validator.md)
