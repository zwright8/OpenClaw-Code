---
name: esg-reporting-snapshot-manager
description: Use when tasks require esg reporting snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Snapshot Manager

## Purpose
Design and execute esg reporting workflows using snapshot manager controls with validated outcomes.
