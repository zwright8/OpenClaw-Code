---
name: property-management-auth-broker
description: Use when tasks require property management auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Auth Broker

## Purpose
Design and execute property management workflows using auth broker controls with validated outcomes.
