---
name: insurance-claims-operation-planner
description: Use when tasks require insurance claims operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Operation Planner

## Purpose
Design and execute insurance claims workflows using operation planner controls with validated outcomes.
