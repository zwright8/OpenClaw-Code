---
name: utility-billing-provenance-tracker
description: Use when tasks require utility billing provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Provenance Tracker

## Purpose
Design and execute utility billing workflows using provenance tracker controls with validated outcomes.
