---
name: research-repositories-remediation-planner
description: Use when tasks require research repositories remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Remediation Planner

## Purpose
Design and execute research repositories workflows using remediation planner controls with validated outcomes.
