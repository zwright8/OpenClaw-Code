---
name: clinical-trial-systems-task-decomposer
description: Use when tasks require clinical trial systems task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Task Decomposer

## Purpose
Design and execute clinical trial systems workflows using task decomposer controls with validated outcomes.
