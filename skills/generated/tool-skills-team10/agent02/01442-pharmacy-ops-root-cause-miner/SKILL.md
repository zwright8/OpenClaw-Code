---
name: pharmacy-ops-root-cause-miner
description: Use when tasks require pharmacy ops root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Root Cause Miner

## Purpose
Design and execute pharmacy ops workflows using root cause miner controls with validated outcomes.
