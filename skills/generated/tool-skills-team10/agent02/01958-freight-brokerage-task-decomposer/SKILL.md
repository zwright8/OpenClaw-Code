---
name: freight-brokerage-task-decomposer
description: Use when tasks require freight brokerage task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Task Decomposer

## Purpose
Design and execute freight brokerage workflows using task decomposer controls with validated outcomes.
