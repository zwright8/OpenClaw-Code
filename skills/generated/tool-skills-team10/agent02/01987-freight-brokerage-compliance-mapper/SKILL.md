---
name: freight-brokerage-compliance-mapper
description: Use when tasks require freight brokerage compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Compliance Mapper

## Purpose
Design and execute freight brokerage workflows using compliance mapper controls with validated outcomes.
