---
name: manufacturing-mes-delta-calculator
description: Use when tasks require manufacturing mes delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Delta Calculator

## Purpose
Design and execute manufacturing mes workflows using delta calculator controls with validated outcomes.
