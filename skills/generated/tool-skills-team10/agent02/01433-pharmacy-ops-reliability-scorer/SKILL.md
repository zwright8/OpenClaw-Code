---
name: pharmacy-ops-reliability-scorer
description: Use when tasks require pharmacy ops reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Reliability Scorer

## Purpose
Design and execute pharmacy ops workflows using reliability scorer controls with validated outcomes.
