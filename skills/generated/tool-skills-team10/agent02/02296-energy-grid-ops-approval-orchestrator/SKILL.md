---
name: energy-grid-ops-approval-orchestrator
description: Use when tasks require energy grid ops approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Approval Orchestrator

## Purpose
Design and execute energy grid ops workflows using approval orchestrator controls with validated outcomes.
