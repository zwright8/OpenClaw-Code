---
name: insurance-claims-dependency-resolver
description: Use when tasks require insurance claims dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Dependency Resolver

## Purpose
Design and execute insurance claims workflows using dependency resolver controls with validated outcomes.
