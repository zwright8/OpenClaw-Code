---
name: digital-twins-approval-orchestrator
description: Use when tasks require digital twins approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Digital Twins Approval Orchestrator

## Purpose
Design and execute digital twins workflows using approval orchestrator controls with validated outcomes.
