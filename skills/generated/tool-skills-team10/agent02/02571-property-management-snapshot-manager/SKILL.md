---
name: property-management-snapshot-manager
description: Use when tasks require property management snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Snapshot Manager

## Purpose
Design and execute property management workflows using snapshot manager controls with validated outcomes.
