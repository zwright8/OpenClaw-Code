---
name: utility-billing-secret-scanner
description: Use when tasks require utility billing secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Secret Scanner

## Purpose
Design and execute utility billing workflows using secret scanner controls with validated outcomes.
