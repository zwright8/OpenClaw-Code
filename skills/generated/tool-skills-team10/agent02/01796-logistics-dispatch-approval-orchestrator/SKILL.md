---
name: logistics-dispatch-approval-orchestrator
description: Use when tasks require logistics dispatch approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Approval Orchestrator

## Purpose
Design and execute logistics dispatch workflows using approval orchestrator controls with validated outcomes.
