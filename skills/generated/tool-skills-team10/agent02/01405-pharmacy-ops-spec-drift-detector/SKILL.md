---
name: pharmacy-ops-spec-drift-detector
description: Use when tasks require pharmacy ops spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Spec Drift Detector

## Purpose
Design and execute pharmacy ops workflows using spec drift detector controls with validated outcomes.
