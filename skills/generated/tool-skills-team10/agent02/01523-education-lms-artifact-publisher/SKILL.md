---
name: education-lms-artifact-publisher
description: Use when tasks require education lms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Artifact Publisher

## Purpose
Design and execute education lms workflows using artifact publisher controls with validated outcomes.
