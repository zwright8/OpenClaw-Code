---
name: education-lms-workflow-compiler
description: Use when tasks require education lms workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Workflow Compiler

## Purpose
Design and execute education lms workflows using workflow compiler controls with validated outcomes.
