---
name: insurance-claims-root-cause-miner
description: Use when tasks require insurance claims root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Root Cause Miner

## Purpose
Design and execute insurance claims workflows using root cause miner controls with validated outcomes.
