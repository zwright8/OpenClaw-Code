---
name: carbon-accounting-state-reconciler
description: Use when tasks require carbon accounting state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting State Reconciler

## Purpose
Design and execute carbon accounting workflows using state reconciler controls with validated outcomes.
