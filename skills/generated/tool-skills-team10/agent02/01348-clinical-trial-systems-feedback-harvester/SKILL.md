---
name: clinical-trial-systems-feedback-harvester
description: Use when tasks require clinical trial systems feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Feedback Harvester

## Purpose
Design and execute clinical trial systems workflows using feedback harvester controls with validated outcomes.
