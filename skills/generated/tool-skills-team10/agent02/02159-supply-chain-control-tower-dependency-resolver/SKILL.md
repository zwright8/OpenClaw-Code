---
name: supply-chain-control-tower-dependency-resolver
description: Use when tasks require supply chain control tower dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Dependency Resolver

## Purpose
Design and execute supply chain control tower workflows using dependency resolver controls with validated outcomes.
