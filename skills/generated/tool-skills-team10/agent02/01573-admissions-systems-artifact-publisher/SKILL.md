---
name: admissions-systems-artifact-publisher
description: Use when tasks require admissions systems artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Artifact Publisher

## Purpose
Design and execute admissions systems workflows using artifact publisher controls with validated outcomes.
