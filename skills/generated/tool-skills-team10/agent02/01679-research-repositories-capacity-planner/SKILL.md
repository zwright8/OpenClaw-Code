---
name: research-repositories-capacity-planner
description: Use when tasks require research repositories capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Capacity Planner

## Purpose
Design and execute research repositories workflows using capacity planner controls with validated outcomes.
