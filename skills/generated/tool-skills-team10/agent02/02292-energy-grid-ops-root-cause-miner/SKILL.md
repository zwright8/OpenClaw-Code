---
name: energy-grid-ops-root-cause-miner
description: Use when tasks require energy grid ops root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Root Cause Miner

## Purpose
Design and execute energy grid ops workflows using root cause miner controls with validated outcomes.
