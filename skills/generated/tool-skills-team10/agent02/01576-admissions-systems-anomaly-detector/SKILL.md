---
name: admissions-systems-anomaly-detector
description: Use when tasks require admissions systems anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Anomaly Detector

## Purpose
Design and execute admissions systems workflows using anomaly detector controls with validated outcomes.
