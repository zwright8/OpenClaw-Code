---
name: library-networks-spec-drift-detector
description: Use when tasks require library networks spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Library Networks Spec Drift Detector

## Purpose
Design and execute library networks workflows using spec drift detector controls with validated outcomes.
