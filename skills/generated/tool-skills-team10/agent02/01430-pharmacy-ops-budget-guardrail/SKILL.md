---
name: pharmacy-ops-budget-guardrail
description: Use when tasks require pharmacy ops budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Budget Guardrail

## Purpose
Design and execute pharmacy ops workflows using budget guardrail controls with validated outcomes.
