---
name: freight-brokerage-remediation-planner
description: Use when tasks require freight brokerage remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Remediation Planner

## Purpose
Design and execute freight brokerage workflows using remediation planner controls with validated outcomes.
