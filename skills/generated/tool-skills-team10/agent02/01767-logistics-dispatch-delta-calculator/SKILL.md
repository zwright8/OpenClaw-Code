---
name: logistics-dispatch-delta-calculator
description: Use when tasks require logistics dispatch delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Delta Calculator

## Purpose
Design and execute logistics dispatch workflows using delta calculator controls with validated outcomes.
