---
name: real-estate-mls-secret-scanner
description: Use when tasks require real estate mls secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Secret Scanner

## Purpose
Design and execute real estate mls workflows using secret scanner controls with validated outcomes.
