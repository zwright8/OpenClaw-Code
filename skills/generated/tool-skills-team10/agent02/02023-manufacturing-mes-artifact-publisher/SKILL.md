---
name: manufacturing-mes-artifact-publisher
description: Use when tasks require manufacturing mes artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Artifact Publisher

## Purpose
Design and execute manufacturing mes workflows using artifact publisher controls with validated outcomes.
