---
name: education-lms-runbook-composer
description: Use when tasks require education lms runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Runbook Composer

## Purpose
Design and execute education lms workflows using runbook composer controls with validated outcomes.
