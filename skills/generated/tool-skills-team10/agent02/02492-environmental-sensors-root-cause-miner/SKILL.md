---
name: environmental-sensors-root-cause-miner
description: Use when tasks require environmental sensors root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Root Cause Miner

## Purpose
Design and execute environmental sensors workflows using root cause miner controls with validated outcomes.
