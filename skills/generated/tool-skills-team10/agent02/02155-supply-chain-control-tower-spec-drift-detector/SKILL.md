---
name: supply-chain-control-tower-spec-drift-detector
description: Use when tasks require supply chain control tower spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Spec Drift Detector

## Purpose
Design and execute supply chain control tower workflows using spec drift detector controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Spec Drift Detector
- Score: 82
- Rank: 1283
- Priority band: P2
...
4. Execute spec drift detector actions with minimal blast radius.
...
- Capability: [Spec Drift Detector](../../resources/capabilities/spec-drift-detector.md)
