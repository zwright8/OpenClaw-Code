---
name: energy-grid-ops-execution-runner
description: Use when tasks require energy grid ops execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Execution Runner

## Purpose
Design and execute energy grid ops workflows using execution runner controls with validated outcomes.
