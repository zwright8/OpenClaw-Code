---
name: pharmacy-ops-compliance-mapper
description: Use when tasks require pharmacy ops compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Compliance Mapper

## Purpose
Design and execute pharmacy ops workflows using compliance mapper controls with validated outcomes.
