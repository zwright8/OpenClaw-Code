---
name: utility-billing-permission-mapper
description: Use when tasks require utility billing permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Permission Mapper

## Purpose
Design and execute utility billing workflows using permission mapper controls with validated outcomes.
