---
name: energy-grid-ops-job-scheduler
description: Use when tasks require energy grid ops job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Job Scheduler

## Purpose
Design and execute energy grid ops workflows using job scheduler controls with validated outcomes.
