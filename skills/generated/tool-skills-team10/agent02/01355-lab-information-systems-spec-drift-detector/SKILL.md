---
name: lab-information-systems-spec-drift-detector
description: Use when tasks require lab information systems spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Information Systems Spec Drift Detector

## Purpose
Design and execute lab information systems workflows using spec drift detector controls with validated outcomes.
