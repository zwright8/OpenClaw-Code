---
name: research-repositories-artifact-publisher
description: Use when tasks require research repositories artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Artifact Publisher

## Purpose
Design and execute research repositories workflows using artifact publisher controls with validated outcomes.
