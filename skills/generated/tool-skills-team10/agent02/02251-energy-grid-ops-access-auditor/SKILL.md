---
name: energy-grid-ops-access-auditor
description: Use when tasks require energy grid ops access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Access Auditor

## Purpose
Design and execute energy grid ops workflows using access auditor controls with validated outcomes.
