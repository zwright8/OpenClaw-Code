---
name: customs-processing-runbook-composer
description: Use when tasks require customs processing runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Runbook Composer

## Purpose
Design and execute customs processing workflows using runbook composer controls with validated outcomes.
