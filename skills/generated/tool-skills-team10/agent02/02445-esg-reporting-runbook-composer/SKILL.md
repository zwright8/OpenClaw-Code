---
name: esg-reporting-runbook-composer
description: Use when tasks require esg reporting runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Runbook Composer

## Purpose
Design and execute esg reporting workflows using runbook composer controls with validated outcomes.
