---
name: real-estate-mls-auth-broker
description: Use when tasks require real estate mls auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Auth Broker

## Purpose
Design and execute real estate mls workflows using auth broker controls with validated outcomes.
