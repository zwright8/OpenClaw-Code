---
name: digital-twins-capacity-planner
description: Use when tasks require digital twins capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Digital Twins Capacity Planner

## Purpose
Design and execute digital twins workflows using capacity planner controls with validated outcomes.
