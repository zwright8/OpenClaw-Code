---
name: environmental-sensors-migration-planner
description: Use when tasks require environmental sensors migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Migration Planner

## Purpose
Design and execute environmental sensors workflows using migration planner controls with validated outcomes.
