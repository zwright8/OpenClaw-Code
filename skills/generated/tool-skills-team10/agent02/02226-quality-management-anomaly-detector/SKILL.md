---
name: quality-management-anomaly-detector
description: Use when tasks require quality management anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Anomaly Detector

## Purpose
Design and execute quality management workflows using anomaly detector controls with validated outcomes.
