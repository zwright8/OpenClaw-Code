---
name: supply-chain-control-tower-forecast-engine
description: Use when tasks require supply chain control tower forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Forecast Engine

## Purpose
Design and execute supply chain control tower workflows using forecast engine controls with validated outcomes.
