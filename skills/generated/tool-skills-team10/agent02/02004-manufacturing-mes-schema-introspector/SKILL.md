---
name: manufacturing-mes-schema-introspector
description: Use when tasks require manufacturing mes schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Schema Introspector

## Purpose
Design and execute manufacturing mes workflows using schema introspector controls with validated outcomes.
