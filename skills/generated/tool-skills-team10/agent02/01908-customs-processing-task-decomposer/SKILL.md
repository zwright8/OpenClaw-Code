---
name: customs-processing-task-decomposer
description: Use when tasks require customs processing task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Task Decomposer

## Purpose
Design and execute customs processing workflows using task decomposer controls with validated outcomes.
