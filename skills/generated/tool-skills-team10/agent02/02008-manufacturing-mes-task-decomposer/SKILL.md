---
name: manufacturing-mes-task-decomposer
description: Use when tasks require manufacturing mes task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Task Decomposer

## Purpose
Design and execute manufacturing mes workflows using task decomposer controls with validated outcomes.
