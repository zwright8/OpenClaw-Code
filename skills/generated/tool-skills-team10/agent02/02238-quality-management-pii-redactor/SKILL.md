---
name: quality-management-pii-redactor
description: Use when tasks require quality management pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management PII Redactor

## Purpose
Design and execute quality management workflows using pii redactor controls with validated outcomes.
