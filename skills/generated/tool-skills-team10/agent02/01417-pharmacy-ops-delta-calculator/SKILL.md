---
name: pharmacy-ops-delta-calculator
description: Use when tasks require pharmacy ops delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Delta Calculator

## Purpose
Design and execute pharmacy ops workflows using delta calculator controls with validated outcomes.
