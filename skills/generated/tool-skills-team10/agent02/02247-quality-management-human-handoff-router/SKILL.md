---
name: quality-management-human-handoff-router
description: Use when tasks require quality management human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Human Handoff Router

## Purpose
Design and execute quality management workflows using human handoff router controls with validated outcomes.
