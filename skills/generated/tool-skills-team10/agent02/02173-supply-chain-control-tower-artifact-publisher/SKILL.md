---
name: supply-chain-control-tower-artifact-publisher
description: Use when tasks require supply chain control tower artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Artifact Publisher

## Purpose
Design and execute supply chain control tower workflows using artifact publisher controls with validated outcomes.
