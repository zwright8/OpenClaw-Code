---
name: freight-brokerage-execution-runner
description: Use when tasks require freight brokerage execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Execution Runner

## Purpose
Design and execute freight brokerage workflows using execution runner controls with validated outcomes.
