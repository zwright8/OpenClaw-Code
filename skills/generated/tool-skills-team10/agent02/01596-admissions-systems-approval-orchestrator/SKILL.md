---
name: admissions-systems-approval-orchestrator
description: Use when tasks require admissions systems approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Approval Orchestrator

## Purpose
Design and execute admissions systems workflows using approval orchestrator controls with validated outcomes.
