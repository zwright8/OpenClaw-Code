---
name: clinical-trial-systems-provenance-tracker
description: Use when tasks require clinical trial systems provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Provenance Tracker

## Purpose
Design and execute clinical trial systems workflows using provenance tracker controls with validated outcomes.
