---
name: pharmacy-ops-state-reconciler
description: Use when tasks require pharmacy ops state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops State Reconciler

## Purpose
Design and execute pharmacy ops workflows using state reconciler controls with validated outcomes.
