---
name: property-management-capacity-planner
description: Use when tasks require property management capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Capacity Planner

## Purpose
Design and execute property management workflows using capacity planner controls with validated outcomes.
