---
name: quality-management-approval-orchestrator
description: Use when tasks require quality management approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Approval Orchestrator

## Purpose
Design and execute quality management workflows using approval orchestrator controls with validated outcomes.
