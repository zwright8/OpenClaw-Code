---
name: research-repositories-approval-orchestrator
description: Use when tasks require research repositories approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Approval Orchestrator

## Purpose
Design and execute research repositories workflows using approval orchestrator controls with validated outcomes.
