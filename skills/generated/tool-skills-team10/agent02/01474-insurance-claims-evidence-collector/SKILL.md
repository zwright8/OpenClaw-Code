---
name: insurance-claims-evidence-collector
description: Use when tasks require insurance claims evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Evidence Collector

## Purpose
Design and execute insurance claims workflows using evidence collector controls with validated outcomes.
