---
name: insurance-claims-human-handoff-router
description: Use when tasks require insurance claims human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Human Handoff Router

## Purpose
Design and execute insurance claims workflows using human handoff router controls with validated outcomes.
