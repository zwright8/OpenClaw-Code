---
name: supply-chain-control-tower-compliance-mapper
description: Use when tasks require supply chain control tower compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Compliance Mapper

## Purpose
Design and execute supply chain control tower workflows using compliance mapper controls with validated outcomes.
