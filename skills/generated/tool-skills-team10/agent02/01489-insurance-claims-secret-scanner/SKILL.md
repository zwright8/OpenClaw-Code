---
name: insurance-claims-secret-scanner
description: Use when tasks require insurance claims secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Secret Scanner

## Purpose
Design and execute insurance claims workflows using secret scanner controls with validated outcomes.
