---
name: carbon-accounting-workflow-compiler
description: Use when tasks require carbon accounting workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Workflow Compiler

## Purpose
Design and execute carbon accounting workflows using workflow compiler controls with validated outcomes.
