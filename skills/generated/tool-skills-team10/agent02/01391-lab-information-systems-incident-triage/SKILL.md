---
name: lab-information-systems-incident-triage
description: Use when tasks require lab information systems incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Information Systems Incident Triage

## Purpose
Design and execute lab information systems workflows using incident triage controls with validated outcomes.
