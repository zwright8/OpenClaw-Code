---
name: clinical-trial-systems-forecast-engine
description: Use when tasks require clinical trial systems forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Forecast Engine

## Purpose
Design and execute clinical trial systems workflows using forecast engine controls with validated outcomes.
