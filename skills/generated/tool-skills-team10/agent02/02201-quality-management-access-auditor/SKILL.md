---
name: quality-management-access-auditor
description: Use when tasks require quality management access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Access Auditor

## Purpose
Design and execute quality management workflows using access auditor controls with validated outcomes.
