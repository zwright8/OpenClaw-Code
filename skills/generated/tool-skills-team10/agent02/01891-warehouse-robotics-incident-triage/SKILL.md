---
name: warehouse-robotics-incident-triage
description: Use when tasks require warehouse robotics incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Incident Triage

## Purpose
Design and execute warehouse robotics workflows using incident triage controls with validated outcomes.
