---
name: logistics-dispatch-quality-gatekeeper
description: Use when tasks require logistics dispatch quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Quality Gatekeeper

## Purpose
Design and execute logistics dispatch workflows using quality gatekeeper controls with validated outcomes.
