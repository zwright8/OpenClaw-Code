---
name: customs-processing-artifact-publisher
description: Use when tasks require customs processing artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Artifact Publisher

## Purpose
Design and execute customs processing workflows using artifact publisher controls with validated outcomes.
