---
name: esg-reporting-delta-calculator
description: Use when tasks require esg reporting delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Delta Calculator

## Purpose
Design and execute esg reporting workflows using delta calculator controls with validated outcomes.
