---
name: environmental-sensors-artifact-publisher
description: Use when tasks require environmental sensors artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Artifact Publisher

## Purpose
Design and execute environmental sensors workflows using artifact publisher controls with validated outcomes.
