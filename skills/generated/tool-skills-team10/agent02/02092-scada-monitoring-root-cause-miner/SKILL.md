---
name: scada-monitoring-root-cause-miner
description: Use when tasks require scada monitoring root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Root Cause Miner

## Purpose
Design and execute scada monitoring workflows using root cause miner controls with validated outcomes.
