---
name: supply-chain-control-tower-risk-scorer
description: Use when tasks require supply chain control tower risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Risk Scorer

## Purpose
Design and execute supply chain control tower workflows using risk scorer controls with validated outcomes.
