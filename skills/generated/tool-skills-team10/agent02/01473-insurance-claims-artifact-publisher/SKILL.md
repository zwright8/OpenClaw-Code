---
name: insurance-claims-artifact-publisher
description: Use when tasks require insurance claims artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Artifact Publisher

## Purpose
Design and execute insurance claims workflows using artifact publisher controls with validated outcomes.
