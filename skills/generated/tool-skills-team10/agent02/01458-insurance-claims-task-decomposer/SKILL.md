---
name: insurance-claims-task-decomposer
description: Use when tasks require insurance claims task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Task Decomposer

## Purpose
Design and execute insurance claims workflows using task decomposer controls with validated outcomes.
