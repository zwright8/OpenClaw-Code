---
name: manufacturing-mes-compliance-mapper
description: Use when tasks require manufacturing mes compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Compliance Mapper

## Purpose
Design and execute manufacturing mes workflows using compliance mapper controls with validated outcomes.
