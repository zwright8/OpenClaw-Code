---
name: energy-grid-ops-migration-planner
description: Use when tasks require energy grid ops migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Migration Planner

## Purpose
Design and execute energy grid ops workflows using migration planner controls with validated outcomes.
