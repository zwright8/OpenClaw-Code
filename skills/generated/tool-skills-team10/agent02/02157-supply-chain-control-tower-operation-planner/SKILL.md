---
name: supply-chain-control-tower-operation-planner
description: Use when tasks require supply chain control tower operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Operation Planner

## Purpose
Design and execute supply chain control tower workflows using operation planner controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Operation Planner
- Score: 68
- Rank: 5320
- Priority band: P3
...
4. Execute operation planner actions with minimal blast radius.
...
- Capability: [Operation Planner](../../resources/capabilities/operation-planner.md)
