---
name: freight-brokerage-evidence-collector
description: Use when tasks require freight brokerage evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Evidence Collector

## Purpose
Design and execute freight brokerage workflows using evidence collector controls with validated outcomes.
