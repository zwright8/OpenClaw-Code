---
name: esg-reporting-secret-scanner
description: Use when tasks require esg reporting secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Secret Scanner

## Purpose
Design and execute esg reporting workflows using secret scanner controls with validated outcomes.
