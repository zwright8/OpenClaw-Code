---
name: admissions-systems-evidence-collector
description: Use when tasks require admissions systems evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Evidence Collector

## Purpose
Design and execute admissions systems workflows using evidence collector controls with validated outcomes.
