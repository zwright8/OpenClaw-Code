---
name: carbon-accounting-task-decomposer
description: Use when tasks require carbon accounting task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Task Decomposer

## Purpose
Design and execute carbon accounting workflows using task decomposer controls with validated outcomes.
