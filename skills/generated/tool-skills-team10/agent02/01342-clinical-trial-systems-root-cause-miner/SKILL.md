---
name: clinical-trial-systems-root-cause-miner
description: Use when tasks require clinical trial systems root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Root Cause Miner

## Purpose
Design and execute clinical trial systems workflows using root cause miner controls with validated outcomes.
