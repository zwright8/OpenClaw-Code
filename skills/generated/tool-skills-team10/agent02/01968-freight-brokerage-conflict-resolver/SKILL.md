---
name: freight-brokerage-conflict-resolver
description: Use when tasks require freight brokerage conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Conflict Resolver

## Purpose
Design and execute freight brokerage workflows using conflict resolver controls with validated outcomes.
