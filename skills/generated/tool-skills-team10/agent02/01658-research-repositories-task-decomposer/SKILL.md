---
name: research-repositories-task-decomposer
description: Use when tasks require research repositories task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Task Decomposer

## Purpose
Design and execute research repositories workflows using task decomposer controls with validated outcomes.
