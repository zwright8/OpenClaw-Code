---
name: clinical-trial-systems-migration-planner
description: Use when tasks require clinical trial systems migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Migration Planner

## Purpose
Design and execute clinical trial systems workflows using migration planner controls with validated outcomes.
