---
name: education-lms-dependency-resolver
description: Use when tasks require education lms dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Dependency Resolver

## Purpose
Design and execute education lms workflows using dependency resolver controls with validated outcomes.
