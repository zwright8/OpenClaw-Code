---
name: quality-management-root-cause-miner
description: Use when tasks require quality management root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Root Cause Miner

## Purpose
Design and execute quality management workflows using root cause miner controls with validated outcomes.
