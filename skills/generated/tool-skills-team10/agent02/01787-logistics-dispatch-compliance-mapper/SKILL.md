---
name: logistics-dispatch-compliance-mapper
description: Use when tasks require logistics dispatch compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Compliance Mapper

## Purpose
Design and execute logistics dispatch workflows using compliance mapper controls with validated outcomes.
