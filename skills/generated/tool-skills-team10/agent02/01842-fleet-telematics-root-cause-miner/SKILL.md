---
name: fleet-telematics-root-cause-miner
description: Use when tasks require fleet telematics root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Root Cause Miner

## Purpose
Design and execute fleet telematics workflows using root cause miner controls with validated outcomes.
