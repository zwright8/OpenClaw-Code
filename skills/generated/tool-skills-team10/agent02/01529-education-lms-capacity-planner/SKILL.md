---
name: education-lms-capacity-planner
description: Use when tasks require education lms capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Capacity Planner

## Purpose
Design and execute education lms workflows using capacity planner controls with validated outcomes.
