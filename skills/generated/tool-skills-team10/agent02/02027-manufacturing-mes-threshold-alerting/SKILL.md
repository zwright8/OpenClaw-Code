---
name: manufacturing-mes-threshold-alerting
description: Use when tasks require manufacturing mes threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Threshold Alerting

## Purpose
Design and execute manufacturing mes workflows using threshold alerting controls with validated outcomes.
