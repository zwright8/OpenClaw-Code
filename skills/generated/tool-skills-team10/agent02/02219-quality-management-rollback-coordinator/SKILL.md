---
name: quality-management-rollback-coordinator
description: Use when tasks require quality management rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Rollback Coordinator

## Purpose
Design and execute quality management workflows using rollback coordinator controls with validated outcomes.
