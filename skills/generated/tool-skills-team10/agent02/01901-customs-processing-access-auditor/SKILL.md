---
name: customs-processing-access-auditor
description: Use when tasks require customs processing access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Access Auditor

## Purpose
Design and execute customs processing workflows using access auditor controls with validated outcomes.
