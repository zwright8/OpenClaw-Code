---
name: research-repositories-runbook-composer
description: Use when tasks require research repositories runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Runbook Composer

## Purpose
Design and execute research repositories workflows using runbook composer controls with validated outcomes.
