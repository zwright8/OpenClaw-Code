---
name: logistics-dispatch-runbook-composer
description: Use when tasks require logistics dispatch runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Runbook Composer

## Purpose
Design and execute logistics dispatch workflows using runbook composer controls with validated outcomes.
