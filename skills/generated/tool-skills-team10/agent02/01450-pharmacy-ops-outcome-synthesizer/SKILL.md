---
name: pharmacy-ops-outcome-synthesizer
description: Use when tasks require pharmacy ops outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Outcome Synthesizer

## Purpose
Design and execute pharmacy ops workflows using outcome synthesizer controls with validated outcomes.
