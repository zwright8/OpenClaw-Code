---
name: energy-grid-ops-artifact-publisher
description: Use when tasks require energy grid ops artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Artifact Publisher

## Purpose
Design and execute energy grid ops workflows using artifact publisher controls with validated outcomes.
