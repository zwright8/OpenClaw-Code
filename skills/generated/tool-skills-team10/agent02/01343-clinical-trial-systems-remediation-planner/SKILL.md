---
name: clinical-trial-systems-remediation-planner
description: Use when tasks require clinical trial systems remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Remediation Planner

## Purpose
Design and execute clinical trial systems workflows using remediation planner controls with validated outcomes.
