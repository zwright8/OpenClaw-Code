---
name: supply-chain-control-tower-access-auditor
description: Use when tasks require supply chain control tower access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Access Auditor

## Purpose
Design and execute supply chain control tower workflows using access auditor controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Access Auditor
- Score: 68
- Rank: 5319
- Priority band: P3
...
4. Execute access auditor actions with minimal blast radius.
...
- Capability: [Access Auditor](../../resources/capabilities/access-auditor.md)
