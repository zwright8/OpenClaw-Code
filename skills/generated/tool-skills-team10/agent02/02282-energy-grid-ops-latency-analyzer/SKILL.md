---
name: energy-grid-ops-latency-analyzer
description: Use when tasks require energy grid ops latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Latency Analyzer

## Purpose
Design and execute energy grid ops workflows using latency analyzer controls with validated outcomes.
