---
name: supply-chain-control-tower-anomaly-detector
description: Use when tasks require supply chain control tower anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Anomaly Detector

## Purpose
Design and execute supply chain control tower workflows using anomaly detector controls with validated outcomes.
