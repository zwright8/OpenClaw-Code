---
name: research-repositories-feedback-harvester
description: Use when tasks require research repositories feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Feedback Harvester

## Purpose
Design and execute research repositories workflows using feedback harvester controls with validated outcomes.
