---
name: research-repositories-execution-runner
description: Use when tasks require research repositories execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Execution Runner

## Purpose
Design and execute research repositories workflows using execution runner controls with validated outcomes.
