---
name: logistics-dispatch-execution-runner
description: Use when tasks require logistics dispatch execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Execution Runner

## Purpose
Design and execute logistics dispatch workflows using execution runner controls with validated outcomes.
