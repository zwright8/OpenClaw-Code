---
name: energy-grid-ops-remediation-planner
description: Use when tasks require energy grid ops remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Remediation Planner

## Purpose
Design and execute energy grid ops workflows using remediation planner controls with validated outcomes.
