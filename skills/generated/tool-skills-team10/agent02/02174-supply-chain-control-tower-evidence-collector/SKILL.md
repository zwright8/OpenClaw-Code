---
name: supply-chain-control-tower-evidence-collector
description: Use when tasks require supply chain control tower evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Evidence Collector

## Purpose
Design and execute supply chain control tower workflows using evidence collector controls with validated outcomes.
