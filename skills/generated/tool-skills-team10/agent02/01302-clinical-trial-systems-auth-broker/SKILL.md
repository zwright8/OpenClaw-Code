---
name: clinical-trial-systems-auth-broker
description: Use when tasks require clinical trial systems auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Auth Broker

## Purpose
Design and execute clinical trial systems workflows using auth broker controls with validated outcomes.
