---
name: education-lms-compliance-mapper
description: Use when tasks require education lms compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Compliance Mapper

## Purpose
Design and execute education lms workflows using compliance mapper controls with validated outcomes.
