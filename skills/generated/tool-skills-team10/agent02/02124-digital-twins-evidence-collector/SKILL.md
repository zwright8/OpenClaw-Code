---
name: digital-twins-evidence-collector
description: Use when tasks require digital twins evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Digital Twins Evidence Collector

## Purpose
Design and execute digital twins workflows using evidence collector controls with validated outcomes.
