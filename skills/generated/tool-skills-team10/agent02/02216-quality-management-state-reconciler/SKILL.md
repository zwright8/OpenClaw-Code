---
name: quality-management-state-reconciler
description: Use when tasks require quality management state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management State Reconciler

## Purpose
Design and execute quality management workflows using state reconciler controls with validated outcomes.
