---
name: scada-monitoring-capacity-planner
description: Use when tasks require scada monitoring capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Capacity Planner

## Purpose
Design and execute scada monitoring workflows using capacity planner controls with validated outcomes.
