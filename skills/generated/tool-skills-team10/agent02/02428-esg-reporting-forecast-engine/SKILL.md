---
name: esg-reporting-forecast-engine
description: Use when tasks require esg reporting forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Forecast Engine

## Purpose
Design and execute esg reporting workflows using forecast engine controls with validated outcomes.
