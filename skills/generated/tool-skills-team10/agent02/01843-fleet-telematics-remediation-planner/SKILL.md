---
name: fleet-telematics-remediation-planner
description: Use when tasks require fleet telematics remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Remediation Planner

## Purpose
Design and execute fleet telematics workflows using remediation planner controls with validated outcomes.
