---
name: quality-management-operation-planner
description: Use when tasks require quality management operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Operation Planner

## Purpose
Design and execute quality management workflows using operation planner controls with validated outcomes.
