---
name: lab-information-systems-secret-scanner
description: Use when tasks require lab information systems secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Information Systems Secret Scanner

## Purpose
Design and execute lab information systems workflows using secret scanner controls with validated outcomes.
