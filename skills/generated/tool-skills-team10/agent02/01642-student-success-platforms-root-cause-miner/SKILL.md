---
name: student-success-platforms-root-cause-miner
description: Use when tasks require student success platforms root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Root Cause Miner

## Purpose
Design and execute student success platforms workflows using root cause miner controls with validated outcomes.
