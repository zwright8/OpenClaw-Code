---
name: quality-management-forecast-engine
description: Use when tasks require quality management forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Forecast Engine

## Purpose
Design and execute quality management workflows using forecast engine controls with validated outcomes.
