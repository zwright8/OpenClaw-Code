---
name: freight-brokerage-human-handoff-router
description: Use when tasks require freight brokerage human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Human Handoff Router

## Purpose
Design and execute freight brokerage workflows using human handoff router controls with validated outcomes.
