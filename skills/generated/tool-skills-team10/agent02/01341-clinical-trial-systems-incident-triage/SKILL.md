---
name: clinical-trial-systems-incident-triage
description: Use when tasks require clinical trial systems incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Incident Triage

## Purpose
Design and execute clinical trial systems workflows using incident triage controls with validated outcomes.
