---
name: freight-brokerage-root-cause-miner
description: Use when tasks require freight brokerage root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Root Cause Miner

## Purpose
Design and execute freight brokerage workflows using root cause miner controls with validated outcomes.
