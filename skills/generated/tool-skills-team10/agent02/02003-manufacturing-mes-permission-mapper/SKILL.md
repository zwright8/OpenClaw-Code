---
name: manufacturing-mes-permission-mapper
description: Use when tasks require manufacturing mes permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Permission Mapper

## Purpose
Design and execute manufacturing mes workflows using permission mapper controls with validated outcomes.
