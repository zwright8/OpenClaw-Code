---
name: quality-management-retry-governor
description: Use when tasks require quality management retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Retry Governor

## Purpose
Design and execute quality management workflows using retry governor controls with validated outcomes.
