---
name: pharmacy-ops-runbook-composer
description: Use when tasks require pharmacy ops runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Runbook Composer

## Purpose
Design and execute pharmacy ops workflows using runbook composer controls with validated outcomes.
