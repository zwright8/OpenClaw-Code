---
name: insurance-claims-risk-scorer
description: Use when tasks require insurance claims risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Risk Scorer

## Purpose
Design and execute insurance claims workflows using risk scorer controls with validated outcomes.
