---
name: quality-management-runbook-composer
description: Use when tasks require quality management runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Runbook Composer

## Purpose
Design and execute quality management workflows using runbook composer controls with validated outcomes.
