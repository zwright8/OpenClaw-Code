---
name: customs-processing-spec-drift-detector
description: Use when tasks require customs processing spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Spec Drift Detector

## Purpose
Design and execute customs processing workflows using spec drift detector controls with validated outcomes.
