---
name: freight-brokerage-secret-scanner
description: Use when tasks require freight brokerage secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Secret Scanner

## Purpose
Design and execute freight brokerage workflows using secret scanner controls with validated outcomes.
