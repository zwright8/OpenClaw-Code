---
name: carbon-accounting-migration-planner
description: Use when tasks require carbon accounting migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Migration Planner

## Purpose
Design and execute carbon accounting workflows using migration planner controls with validated outcomes.
