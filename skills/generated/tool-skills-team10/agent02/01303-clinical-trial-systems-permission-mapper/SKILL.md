---
name: clinical-trial-systems-permission-mapper
description: Use when tasks require clinical trial systems permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Permission Mapper

## Purpose
Design and execute clinical trial systems workflows using permission mapper controls with validated outcomes.
