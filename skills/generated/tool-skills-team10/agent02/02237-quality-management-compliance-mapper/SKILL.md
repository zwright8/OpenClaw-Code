---
name: quality-management-compliance-mapper
description: Use when tasks require quality management compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Compliance Mapper

## Purpose
Design and execute quality management workflows using compliance mapper controls with validated outcomes.
