---
name: fleet-telematics-evidence-collector
description: Use when tasks require fleet telematics evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Evidence Collector

## Purpose
Design and execute fleet telematics workflows using evidence collector controls with validated outcomes.
