---
name: supply-chain-control-tower-reliability-scorer
description: Use when tasks require supply chain control tower reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Reliability Scorer

## Purpose
Design and execute supply chain control tower workflows using reliability scorer controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Reliability Scorer
- Score: 68
- Rank: 5336
- Priority band: P3
...
4. Execute reliability scorer actions with minimal blast radius.
...
- Capability: [Reliability Scorer](../../resources/capabilities/reliability-scorer.md)
