---
name: clinical-trial-systems-operation-planner
description: Use when tasks require clinical trial systems operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Operation Planner

## Purpose
Design and execute clinical trial systems workflows using operation planner controls with validated outcomes.
