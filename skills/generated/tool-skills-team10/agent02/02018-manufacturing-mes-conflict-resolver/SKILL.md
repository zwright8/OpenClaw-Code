---
name: manufacturing-mes-conflict-resolver
description: Use when tasks require manufacturing mes conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Conflict Resolver

## Purpose
Design and execute manufacturing mes workflows using conflict resolver controls with validated outcomes.
