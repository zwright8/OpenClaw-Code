---
name: energy-grid-ops-spec-drift-detector
description: Use when tasks require energy grid ops spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Spec Drift Detector

## Purpose
Design and execute energy grid ops workflows using spec drift detector controls with validated outcomes.
