---
name: energy-grid-ops-delta-calculator
description: Use when tasks require energy grid ops delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Delta Calculator

## Purpose
Design and execute energy grid ops workflows using delta calculator controls with validated outcomes.
