---
name: carbon-accounting-execution-runner
description: Use when tasks require carbon accounting execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Execution Runner

## Purpose
Design and execute carbon accounting workflows using execution runner controls with validated outcomes.
