---
name: manufacturing-mes-provenance-tracker
description: Use when tasks require manufacturing mes provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Provenance Tracker

## Purpose
Design and execute manufacturing mes workflows using provenance tracker controls with validated outcomes.
