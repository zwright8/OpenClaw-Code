---
name: pharmacy-ops-secret-scanner
description: Use when tasks require pharmacy ops secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Secret Scanner

## Purpose
Design and execute pharmacy ops workflows using secret scanner controls with validated outcomes.
