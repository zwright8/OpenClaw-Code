---
name: pharmacy-ops-risk-scorer
description: Use when tasks require pharmacy ops risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Risk Scorer

## Purpose
Design and execute pharmacy ops workflows using risk scorer controls with validated outcomes.
