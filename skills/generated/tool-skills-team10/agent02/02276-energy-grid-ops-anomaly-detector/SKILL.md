---
name: energy-grid-ops-anomaly-detector
description: Use when tasks require energy grid ops anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Anomaly Detector

## Purpose
Design and execute energy grid ops workflows using anomaly detector controls with validated outcomes.
