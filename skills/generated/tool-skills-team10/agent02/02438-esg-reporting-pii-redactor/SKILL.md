---
name: esg-reporting-pii-redactor
description: Use when tasks require esg reporting pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting PII Redactor

## Purpose
Design and execute esg reporting workflows using pii redactor controls with validated outcomes.
