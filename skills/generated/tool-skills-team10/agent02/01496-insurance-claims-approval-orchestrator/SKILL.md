---
name: insurance-claims-approval-orchestrator
description: Use when tasks require insurance claims approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Approval Orchestrator

## Purpose
Design and execute insurance claims workflows using approval orchestrator controls with validated outcomes.
