---
name: scada-monitoring-compliance-mapper
description: Use when tasks require scada monitoring compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Compliance Mapper

## Purpose
Design and execute scada monitoring workflows using compliance mapper controls with validated outcomes.
