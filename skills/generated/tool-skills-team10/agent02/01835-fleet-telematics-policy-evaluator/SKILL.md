---
name: fleet-telematics-policy-evaluator
description: Use when tasks require fleet telematics policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Policy Evaluator

## Purpose
Design and execute fleet telematics workflows using policy evaluator controls with validated outcomes.
