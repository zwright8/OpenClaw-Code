---
name: insurance-claims-capacity-planner
description: Use when tasks require insurance claims capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Capacity Planner

## Purpose
Design and execute insurance claims workflows using capacity planner controls with validated outcomes.
