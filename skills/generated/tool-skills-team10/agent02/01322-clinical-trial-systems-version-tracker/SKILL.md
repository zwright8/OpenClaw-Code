---
name: clinical-trial-systems-version-tracker
description: Use when tasks require clinical trial systems version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Version Tracker

## Purpose
Design and execute clinical trial systems workflows using version tracker controls with validated outcomes.
