---
name: supply-chain-control-tower-incident-triage
description: Use when tasks require supply chain control tower incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Incident Triage

## Purpose
Design and execute supply chain control tower workflows using incident triage controls with validated outcomes.
