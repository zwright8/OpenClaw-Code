---
name: freight-brokerage-delta-calculator
description: Use when tasks require freight brokerage delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Delta Calculator

## Purpose
Design and execute freight brokerage workflows using delta calculator controls with validated outcomes.
