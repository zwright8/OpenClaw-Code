---
name: logistics-dispatch-workflow-compiler
description: Use when tasks require logistics dispatch workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Workflow Compiler

## Purpose
Design and execute logistics dispatch workflows using workflow compiler controls with validated outcomes.
