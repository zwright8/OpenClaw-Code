---
name: property-management-permission-mapper
description: Use when tasks require property management permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Permission Mapper

## Purpose
Design and execute property management workflows using permission mapper controls with validated outcomes.
