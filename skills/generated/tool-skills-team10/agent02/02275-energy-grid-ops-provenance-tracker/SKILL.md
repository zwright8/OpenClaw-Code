---
name: energy-grid-ops-provenance-tracker
description: Use when tasks require energy grid ops provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Provenance Tracker

## Purpose
Design and execute energy grid ops workflows using provenance tracker controls with validated outcomes.
