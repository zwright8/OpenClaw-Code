---
name: esg-reporting-auth-broker
description: Use when tasks require esg reporting auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Auth Broker

## Purpose
Design and execute esg reporting workflows using auth broker controls with validated outcomes.
