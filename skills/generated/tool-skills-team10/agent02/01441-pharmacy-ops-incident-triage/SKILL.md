---
name: pharmacy-ops-incident-triage
description: Use when tasks require pharmacy ops incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Incident Triage

## Purpose
Design and execute pharmacy ops workflows using incident triage controls with validated outcomes.
