---
name: fleet-telematics-state-reconciler
description: Use when tasks require fleet telematics state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics State Reconciler

## Purpose
Design and execute fleet telematics workflows using state reconciler controls with validated outcomes.
