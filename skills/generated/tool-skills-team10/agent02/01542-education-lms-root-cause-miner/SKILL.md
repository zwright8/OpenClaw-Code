---
name: education-lms-root-cause-miner
description: Use when tasks require education lms root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Root Cause Miner

## Purpose
Design and execute education lms workflows using root cause miner controls with validated outcomes.
