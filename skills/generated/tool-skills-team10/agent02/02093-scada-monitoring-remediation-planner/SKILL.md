---
name: scada-monitoring-remediation-planner
description: Use when tasks require scada monitoring remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Remediation Planner

## Purpose
Design and execute scada monitoring workflows using remediation planner controls with validated outcomes.
