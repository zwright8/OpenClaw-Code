---
name: logistics-dispatch-capacity-planner
description: Use when tasks require logistics dispatch capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Capacity Planner

## Purpose
Design and execute logistics dispatch workflows using capacity planner controls with validated outcomes.
