---
name: manufacturing-mes-spec-drift-detector
description: Use when tasks require manufacturing mes spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Spec Drift Detector

## Purpose
Design and execute manufacturing mes workflows using spec drift detector controls with validated outcomes.
