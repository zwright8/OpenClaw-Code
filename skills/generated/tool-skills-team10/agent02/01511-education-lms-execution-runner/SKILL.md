---
name: education-lms-execution-runner
description: Use when tasks require education lms execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Execution Runner

## Purpose
Design and execute education lms workflows using execution runner controls with validated outcomes.
