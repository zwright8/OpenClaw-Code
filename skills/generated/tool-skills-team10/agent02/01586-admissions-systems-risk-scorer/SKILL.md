---
name: admissions-systems-risk-scorer
description: Use when tasks require admissions systems risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Risk Scorer

## Purpose
Design and execute admissions systems workflows using risk scorer controls with validated outcomes.
