---
name: carbon-accounting-anomaly-detector
description: Use when tasks require carbon accounting anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Anomaly Detector

## Purpose
Design and execute carbon accounting workflows using anomaly detector controls with validated outcomes.
