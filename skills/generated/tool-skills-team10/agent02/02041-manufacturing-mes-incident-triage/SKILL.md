---
name: manufacturing-mes-incident-triage
description: Use when tasks require manufacturing mes incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Incident Triage

## Purpose
Design and execute manufacturing mes workflows using incident triage controls with validated outcomes.
