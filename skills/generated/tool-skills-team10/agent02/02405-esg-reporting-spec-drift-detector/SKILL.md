---
name: esg-reporting-spec-drift-detector
description: Use when tasks require esg reporting spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Spec Drift Detector

## Purpose
Design and execute esg reporting workflows using spec drift detector controls with validated outcomes.
