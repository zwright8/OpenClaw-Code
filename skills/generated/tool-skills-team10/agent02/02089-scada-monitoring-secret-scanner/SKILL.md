---
name: scada-monitoring-secret-scanner
description: Use when tasks require scada monitoring secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Secret Scanner

## Purpose
Design and execute scada monitoring workflows using secret scanner controls with validated outcomes.
