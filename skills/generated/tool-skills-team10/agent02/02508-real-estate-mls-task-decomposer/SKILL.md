---
name: real-estate-mls-task-decomposer
description: Use when tasks require real estate mls task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Task Decomposer

## Purpose
Design and execute real estate mls workflows using task decomposer controls with validated outcomes.
