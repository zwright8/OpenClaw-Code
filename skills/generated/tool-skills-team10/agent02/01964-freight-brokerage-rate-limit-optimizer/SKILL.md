---
name: freight-brokerage-rate-limit-optimizer
description: Use when tasks require freight brokerage rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Rate Limit Optimizer

## Purpose
Design and execute freight brokerage workflows using rate limit optimizer controls with validated outcomes.
