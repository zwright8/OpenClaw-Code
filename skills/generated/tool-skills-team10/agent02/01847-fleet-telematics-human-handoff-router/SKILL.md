---
name: fleet-telematics-human-handoff-router
description: Use when tasks require fleet telematics human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Human Handoff Router

## Purpose
Design and execute fleet telematics workflows using human handoff router controls with validated outcomes.
