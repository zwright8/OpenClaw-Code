---
name: research-repositories-risk-scorer
description: Use when tasks require research repositories risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Risk Scorer

## Purpose
Design and execute research repositories workflows using risk scorer controls with validated outcomes.
