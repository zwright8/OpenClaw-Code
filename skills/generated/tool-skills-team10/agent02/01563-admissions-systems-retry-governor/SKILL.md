---
name: admissions-systems-retry-governor
description: Use when tasks require admissions systems retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Retry Governor

## Purpose
Design and execute admissions systems workflows using retry governor controls with validated outcomes.
