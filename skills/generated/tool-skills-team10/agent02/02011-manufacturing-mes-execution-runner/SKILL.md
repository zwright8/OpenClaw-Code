---
name: manufacturing-mes-execution-runner
description: Use when tasks require manufacturing mes execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Execution Runner

## Purpose
Design and execute manufacturing mes workflows using execution runner controls with validated outcomes.
