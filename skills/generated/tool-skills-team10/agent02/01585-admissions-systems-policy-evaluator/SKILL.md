---
name: admissions-systems-policy-evaluator
description: Use when tasks require admissions systems policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Policy Evaluator

## Purpose
Design and execute admissions systems workflows using policy evaluator controls with validated outcomes.
