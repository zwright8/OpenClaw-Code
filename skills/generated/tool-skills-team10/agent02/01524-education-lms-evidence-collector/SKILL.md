---
name: education-lms-evidence-collector
description: Use when tasks require education lms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Evidence Collector

## Purpose
Design and execute education lms workflows using evidence collector controls with validated outcomes.
