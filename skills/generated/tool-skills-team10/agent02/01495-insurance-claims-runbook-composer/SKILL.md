---
name: insurance-claims-runbook-composer
description: Use when tasks require insurance claims runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Runbook Composer

## Purpose
Design and execute insurance claims workflows using runbook composer controls with validated outcomes.
