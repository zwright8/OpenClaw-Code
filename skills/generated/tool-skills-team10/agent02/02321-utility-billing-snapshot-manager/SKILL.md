---
name: utility-billing-snapshot-manager
description: Use when tasks require utility billing snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Snapshot Manager

## Purpose
Design and execute utility billing workflows using snapshot manager controls with validated outcomes.
