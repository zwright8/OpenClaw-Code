---
name: supply-chain-control-tower-snapshot-manager
description: Use when tasks require supply chain control tower snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Snapshot Manager

## Purpose
Design and execute supply chain control tower workflows using snapshot manager controls with validated outcomes.
...
4. Execute snapshot manager actions with minimal blast radius.
...
- Capability: [Snapshot Manager](../../resources/capabilities/snapshot-manager.md)
