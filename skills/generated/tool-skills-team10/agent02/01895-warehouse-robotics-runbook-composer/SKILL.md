---
name: warehouse-robotics-runbook-composer
description: Use when tasks require warehouse robotics runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Runbook Composer

## Purpose
Design and execute warehouse robotics workflows using runbook composer controls with validated outcomes.
