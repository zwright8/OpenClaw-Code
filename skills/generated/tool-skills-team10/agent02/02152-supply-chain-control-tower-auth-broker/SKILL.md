---
name: supply-chain-control-tower-auth-broker
description: Use when tasks require supply chain control tower auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Auth Broker

## Purpose
Design and execute supply chain control tower workflows using auth broker controls with validated outcomes.
