---
name: freight-brokerage-outcome-synthesizer
description: Use when tasks require freight brokerage outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Outcome Synthesizer

## Purpose
Design and execute freight brokerage workflows using outcome synthesizer controls with validated outcomes.
