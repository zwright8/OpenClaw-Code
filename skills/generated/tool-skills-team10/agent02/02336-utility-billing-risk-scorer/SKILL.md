---
name: utility-billing-risk-scorer
description: Use when tasks require utility billing risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Risk Scorer

## Purpose
Design and execute utility billing workflows using risk scorer controls with validated outcomes.
