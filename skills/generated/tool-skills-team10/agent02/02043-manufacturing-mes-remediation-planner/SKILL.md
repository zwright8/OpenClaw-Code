---
name: manufacturing-mes-remediation-planner
description: Use when tasks require manufacturing mes remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Remediation Planner

## Purpose
Design and execute manufacturing mes workflows using remediation planner controls with validated outcomes.
