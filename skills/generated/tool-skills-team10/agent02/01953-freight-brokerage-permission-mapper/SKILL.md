---
name: freight-brokerage-permission-mapper
description: Use when tasks require freight brokerage permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Permission Mapper

## Purpose
Design and execute freight brokerage workflows using permission mapper controls with validated outcomes.
