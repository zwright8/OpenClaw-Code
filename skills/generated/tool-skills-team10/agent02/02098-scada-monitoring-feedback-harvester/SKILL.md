---
name: scada-monitoring-feedback-harvester
description: Use when tasks require scada monitoring feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Feedback Harvester

## Purpose
Design and execute scada monitoring workflows using feedback harvester controls with validated outcomes.
