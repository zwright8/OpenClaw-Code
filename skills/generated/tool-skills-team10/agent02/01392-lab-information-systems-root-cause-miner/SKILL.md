---
name: lab-information-systems-root-cause-miner
description: Use when tasks require lab information systems root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Information Systems Root Cause Miner

## Purpose
Design and execute lab information systems workflows using root cause miner controls with validated outcomes.
