---
name: admissions-systems-feedback-harvester
description: Use when tasks require admissions systems feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Feedback Harvester

## Purpose
Design and execute admissions systems workflows using feedback harvester controls with validated outcomes.
