---
name: supply-chain-control-tower-budget-guardrail
description: Use when tasks require supply chain control tower budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Budget Guardrail

## Purpose
Design and execute supply chain control tower workflows using budget guardrail controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Budget Guardrail
- Score: 68
- Rank: 5333
- Priority band: P3
...
4. Execute budget guardrail actions with minimal blast radius.
...
- Capability: [Budget Guardrail](../../resources/capabilities/budget-guardrail.md)
