---
name: manufacturing-mes-feedback-harvester
description: Use when tasks require manufacturing mes feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Feedback Harvester

## Purpose
Design and execute manufacturing mes workflows using feedback harvester controls with validated outcomes.
