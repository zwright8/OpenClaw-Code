---
name: real-estate-mls-conflict-resolver
description: Use when tasks require real estate mls conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Conflict Resolver

## Purpose
Design and execute real estate mls workflows using conflict resolver controls with validated outcomes.
