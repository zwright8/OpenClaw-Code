---
name: esg-reporting-migration-planner
description: Use when tasks require esg reporting migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Migration Planner

## Purpose
Design and execute esg reporting workflows using migration planner controls with validated outcomes.
