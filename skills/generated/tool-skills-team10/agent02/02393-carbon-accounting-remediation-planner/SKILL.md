---
name: carbon-accounting-remediation-planner
description: Use when tasks require carbon accounting remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Remediation Planner

## Purpose
Design and execute carbon accounting workflows using remediation planner controls with validated outcomes.
