---
name: research-repositories-rollback-coordinator
description: Use when tasks require research repositories rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Rollback Coordinator

## Purpose
Design and execute research repositories workflows using rollback coordinator controls with validated outcomes.
