---
name: manufacturing-mes-root-cause-miner
description: Use when tasks require manufacturing mes root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Root Cause Miner

## Purpose
Design and execute manufacturing mes workflows using root cause miner controls with validated outcomes.
