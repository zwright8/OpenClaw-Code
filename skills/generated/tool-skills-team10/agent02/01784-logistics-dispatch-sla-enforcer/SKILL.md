---
name: logistics-dispatch-sla-enforcer
description: Use when tasks require logistics dispatch sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch SLA Enforcer

## Purpose
Design and execute logistics dispatch workflows using sla enforcer controls with validated outcomes.
