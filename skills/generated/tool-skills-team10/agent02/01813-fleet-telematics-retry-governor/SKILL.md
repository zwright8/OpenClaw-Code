---
name: fleet-telematics-retry-governor
description: Use when tasks require fleet telematics retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Retry Governor

## Purpose
Design and execute fleet telematics workflows using retry governor controls with validated outcomes.
