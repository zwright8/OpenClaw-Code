---
name: education-lms-forecast-engine
description: Use when tasks require education lms forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Forecast Engine

## Purpose
Design and execute education lms workflows using forecast engine controls with validated outcomes.
