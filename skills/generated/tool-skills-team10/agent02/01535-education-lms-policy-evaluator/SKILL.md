---
name: education-lms-policy-evaluator
description: Use when tasks require education lms policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Policy Evaluator

## Purpose
Design and execute education lms workflows using policy evaluator controls with validated outcomes.
