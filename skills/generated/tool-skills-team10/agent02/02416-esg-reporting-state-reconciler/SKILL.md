---
name: esg-reporting-state-reconciler
description: Use when tasks require esg reporting state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting State Reconciler

## Purpose
Design and execute esg reporting workflows using state reconciler controls with validated outcomes.
