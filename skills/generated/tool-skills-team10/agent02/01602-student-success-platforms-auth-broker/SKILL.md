---
name: student-success-platforms-auth-broker
description: Use when tasks require student success platforms auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Auth Broker

## Purpose
Design and execute student success platforms workflows using auth broker controls with validated outcomes.
