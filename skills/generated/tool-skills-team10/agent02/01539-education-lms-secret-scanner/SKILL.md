---
name: education-lms-secret-scanner
description: Use when tasks require education lms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Secret Scanner

## Purpose
Design and execute education lms workflows using secret scanner controls with validated outcomes.
