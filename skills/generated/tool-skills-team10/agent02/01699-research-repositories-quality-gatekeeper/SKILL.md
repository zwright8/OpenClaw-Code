---
name: research-repositories-quality-gatekeeper
description: Use when tasks require research repositories quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Quality Gatekeeper

## Purpose
Design and execute research repositories workflows using quality gatekeeper controls with validated outcomes.
