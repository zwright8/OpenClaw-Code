---
name: carbon-accounting-postmortem-drafting
description: Use when tasks require carbon accounting postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Postmortem Drafting

## Purpose
Design and execute carbon accounting workflows using postmortem drafting controls with validated outcomes.
