---
name: manufacturing-mes-migration-planner
description: Use when tasks require manufacturing mes migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Migration Planner

## Purpose
Design and execute manufacturing mes workflows using migration planner controls with validated outcomes.
