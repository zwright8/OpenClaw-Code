---
name: pharmacy-ops-dependency-resolver
description: Use when tasks require pharmacy ops dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Dependency Resolver

## Purpose
Design and execute pharmacy ops workflows using dependency resolver controls with validated outcomes.
