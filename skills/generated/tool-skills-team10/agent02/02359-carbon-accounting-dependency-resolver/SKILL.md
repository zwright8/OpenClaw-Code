---
name: carbon-accounting-dependency-resolver
description: Use when tasks require carbon accounting dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Dependency Resolver

## Purpose
Design and execute carbon accounting workflows using dependency resolver controls with validated outcomes.
