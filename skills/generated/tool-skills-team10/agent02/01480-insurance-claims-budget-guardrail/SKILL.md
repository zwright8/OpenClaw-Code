---
name: insurance-claims-budget-guardrail
description: Use when tasks require insurance claims budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Budget Guardrail

## Purpose
Design and execute insurance claims workflows using budget guardrail controls with validated outcomes.
