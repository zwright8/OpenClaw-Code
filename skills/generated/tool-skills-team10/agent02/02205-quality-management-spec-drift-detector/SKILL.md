---
name: quality-management-spec-drift-detector
description: Use when tasks require quality management spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Spec Drift Detector

## Purpose
Design and execute quality management workflows using spec drift detector controls with validated outcomes.
