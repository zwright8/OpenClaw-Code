---
name: quality-management-secret-scanner
description: Use when tasks require quality management secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Secret Scanner

## Purpose
Design and execute quality management workflows using secret scanner controls with validated outcomes.
