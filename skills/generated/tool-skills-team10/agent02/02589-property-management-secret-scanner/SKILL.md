---
name: property-management-secret-scanner
description: Use when tasks require property management secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Secret Scanner

## Purpose
Design and execute property management workflows using secret scanner controls with validated outcomes.
