---
name: insurance-claims-compliance-mapper
description: Use when tasks require insurance claims compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Compliance Mapper

## Purpose
Design and execute insurance claims workflows using compliance mapper controls with validated outcomes.
