---
name: property-management-dependency-resolver
description: Use when tasks require property management dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Dependency Resolver

## Purpose
Design and execute property management workflows using dependency resolver controls with validated outcomes.
