---
name: education-lms-budget-guardrail
description: Use when tasks require education lms budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Budget Guardrail

## Purpose
Design and execute education lms workflows using budget guardrail controls with validated outcomes.
