---
name: energy-grid-ops-postmortem-drafting
description: Use when tasks require energy grid ops postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Postmortem Drafting

## Purpose
Design and execute energy grid ops workflows using postmortem drafting controls with validated outcomes.
