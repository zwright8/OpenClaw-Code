---
name: esg-reporting-task-decomposer
description: Use when tasks require esg reporting task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Task Decomposer

## Purpose
Design and execute esg reporting workflows using task decomposer controls with validated outcomes.
