---
name: quality-management-evidence-collector
description: Use when tasks require quality management evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Evidence Collector

## Purpose
Design and execute quality management workflows using evidence collector controls with validated outcomes.
