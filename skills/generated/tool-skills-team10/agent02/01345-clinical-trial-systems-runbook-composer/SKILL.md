---
name: clinical-trial-systems-runbook-composer
description: Use when tasks require clinical trial systems runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Runbook Composer

## Purpose
Design and execute clinical trial systems workflows using runbook composer controls with validated outcomes.
