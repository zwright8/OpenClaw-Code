---
name: lab-information-systems-migration-planner
description: Use when tasks require lab information systems migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Information Systems Migration Planner

## Purpose
Design and execute lab information systems workflows using migration planner controls with validated outcomes.
