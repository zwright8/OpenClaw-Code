---
name: admissions-systems-access-auditor
description: Use when tasks require admissions systems access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Access Auditor

## Purpose
Design and execute admissions systems workflows using access auditor controls with validated outcomes.
