---
name: manufacturing-mes-capacity-planner
description: Use when tasks require manufacturing mes capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Capacity Planner

## Purpose
Design and execute manufacturing mes workflows using capacity planner controls with validated outcomes.
