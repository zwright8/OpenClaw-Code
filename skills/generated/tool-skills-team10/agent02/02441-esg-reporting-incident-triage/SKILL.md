---
name: esg-reporting-incident-triage
description: Use when tasks require esg reporting incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Incident Triage

## Purpose
Design and execute esg reporting workflows using incident triage controls with validated outcomes.
