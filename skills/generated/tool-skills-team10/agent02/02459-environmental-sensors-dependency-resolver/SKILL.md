---
name: environmental-sensors-dependency-resolver
description: Use when tasks require environmental sensors dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Dependency Resolver

## Purpose
Design and execute environmental sensors workflows using dependency resolver controls with validated outcomes.
