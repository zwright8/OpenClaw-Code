---
name: education-lms-risk-scorer
description: Use when tasks require education lms risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Risk Scorer

## Purpose
Design and execute education lms workflows using risk scorer controls with validated outcomes.
