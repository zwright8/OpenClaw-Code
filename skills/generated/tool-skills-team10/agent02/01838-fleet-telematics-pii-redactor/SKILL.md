---
name: fleet-telematics-pii-redactor
description: Use when tasks require fleet telematics pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics PII Redactor

## Purpose
Design and execute fleet telematics workflows using pii redactor controls with validated outcomes.
