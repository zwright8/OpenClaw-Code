---
name: carbon-accounting-rate-limit-optimizer
description: Use when tasks require carbon accounting rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Rate Limit Optimizer

## Purpose
Design and execute carbon accounting workflows using rate limit optimizer controls with validated outcomes.
