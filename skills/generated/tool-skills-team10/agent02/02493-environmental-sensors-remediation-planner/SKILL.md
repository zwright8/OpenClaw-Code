---
name: environmental-sensors-remediation-planner
description: Use when tasks require environmental sensors remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Remediation Planner

## Purpose
Design and execute environmental sensors workflows using remediation planner controls with validated outcomes.
