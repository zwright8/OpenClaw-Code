---
name: warehouse-robotics-root-cause-miner
description: Use when tasks require warehouse robotics root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Root Cause Miner

## Purpose
Design and execute warehouse robotics workflows using root cause miner controls with validated outcomes.
