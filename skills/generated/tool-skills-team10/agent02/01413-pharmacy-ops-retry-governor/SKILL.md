---
name: pharmacy-ops-retry-governor
description: Use when tasks require pharmacy ops retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Retry Governor

## Purpose
Design and execute pharmacy ops workflows using retry governor controls with validated outcomes.
