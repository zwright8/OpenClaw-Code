---
name: quality-management-execution-runner
description: Use when tasks require quality management execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Execution Runner

## Purpose
Design and execute quality management workflows using execution runner controls with validated outcomes.
