---
name: admissions-systems-rate-limit-optimizer
description: Use when tasks require admissions systems rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Rate Limit Optimizer

## Purpose
Design and execute admissions systems workflows using rate limit optimizer controls with validated outcomes.
