---
name: manufacturing-mes-evidence-collector
description: Use when tasks require manufacturing mes evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Evidence Collector

## Purpose
Design and execute manufacturing mes workflows using evidence collector controls with validated outcomes.
