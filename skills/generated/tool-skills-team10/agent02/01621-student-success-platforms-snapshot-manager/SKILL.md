---
name: student-success-platforms-snapshot-manager
description: Use when tasks require student success platforms snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Snapshot Manager

## Purpose
Design and execute student success platforms workflows using snapshot manager controls with validated outcomes.
