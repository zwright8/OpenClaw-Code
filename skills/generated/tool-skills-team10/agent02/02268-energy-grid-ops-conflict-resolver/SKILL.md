---
name: energy-grid-ops-conflict-resolver
description: Use when tasks require energy grid ops conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Conflict Resolver

## Purpose
Design and execute energy grid ops workflows using conflict resolver controls with validated outcomes.
