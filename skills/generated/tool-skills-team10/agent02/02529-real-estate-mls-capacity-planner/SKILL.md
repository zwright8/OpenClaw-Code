---
name: real-estate-mls-capacity-planner
description: Use when tasks require real estate mls capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Capacity Planner

## Purpose
Design and execute real estate mls workflows using capacity planner controls with validated outcomes.
