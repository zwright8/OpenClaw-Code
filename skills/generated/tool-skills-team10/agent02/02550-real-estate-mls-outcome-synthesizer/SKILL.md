---
name: real-estate-mls-outcome-synthesizer
description: Use when tasks require real estate mls outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Outcome Synthesizer

## Purpose
Design and execute real estate mls workflows using outcome synthesizer controls with validated outcomes.
