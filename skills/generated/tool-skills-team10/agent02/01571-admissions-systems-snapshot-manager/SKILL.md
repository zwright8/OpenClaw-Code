---
name: admissions-systems-snapshot-manager
description: Use when tasks require admissions systems snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Snapshot Manager

## Purpose
Design and execute admissions systems workflows using snapshot manager controls with validated outcomes.
