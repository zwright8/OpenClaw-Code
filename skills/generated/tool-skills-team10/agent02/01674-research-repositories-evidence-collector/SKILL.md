---
name: research-repositories-evidence-collector
description: Use when tasks require research repositories evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Evidence Collector

## Purpose
Design and execute research repositories workflows using evidence collector controls with validated outcomes.
