---
name: carbon-accounting-feedback-harvester
description: Use when tasks require carbon accounting feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Feedback Harvester

## Purpose
Design and execute carbon accounting workflows using feedback harvester controls with validated outcomes.
