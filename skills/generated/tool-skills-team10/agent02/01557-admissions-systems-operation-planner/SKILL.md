---
name: admissions-systems-operation-planner
description: Use when tasks require admissions systems operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Operation Planner

## Purpose
Design and execute admissions systems workflows using operation planner controls with validated outcomes.
