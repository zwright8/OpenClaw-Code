---
name: scada-monitoring-spec-drift-detector
description: Use when tasks require scada monitoring spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Spec Drift Detector

## Purpose
Design and execute scada monitoring workflows using spec drift detector controls with validated outcomes.
