---
name: supply-chain-control-tower-quality-gatekeeper
description: Use when tasks require supply chain control tower quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Quality Gatekeeper

## Purpose
Design and execute supply chain control tower workflows using quality gatekeeper controls with validated outcomes.
