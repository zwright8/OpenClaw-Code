---
name: education-lms-snapshot-manager
description: Use when tasks require education lms snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Snapshot Manager

## Purpose
Design and execute education lms workflows using snapshot manager controls with validated outcomes.
