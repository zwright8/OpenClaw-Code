---
name: warehouse-robotics-remediation-planner
description: Use when tasks require warehouse robotics remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Remediation Planner

## Purpose
Design and execute warehouse robotics workflows using remediation planner controls with validated outcomes.
