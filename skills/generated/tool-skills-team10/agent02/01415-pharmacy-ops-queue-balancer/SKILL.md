---
name: pharmacy-ops-queue-balancer
description: Use when tasks require pharmacy ops queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Queue Balancer

## Purpose
Design and execute pharmacy ops workflows using queue balancer controls with validated outcomes.
