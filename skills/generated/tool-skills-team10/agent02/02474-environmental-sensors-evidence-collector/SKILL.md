---
name: environmental-sensors-evidence-collector
description: Use when tasks require environmental sensors evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Evidence Collector

## Purpose
Design and execute environmental sensors workflows using evidence collector controls with validated outcomes.
