---
name: fleet-telematics-capacity-planner
description: Use when tasks require fleet telematics capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Capacity Planner

## Purpose
Design and execute fleet telematics workflows using capacity planner controls with validated outcomes.
