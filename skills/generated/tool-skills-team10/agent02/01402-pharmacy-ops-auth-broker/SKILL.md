---
name: pharmacy-ops-auth-broker
description: Use when tasks require pharmacy ops auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Auth Broker

## Purpose
Design and execute pharmacy ops workflows using auth broker controls with validated outcomes.
