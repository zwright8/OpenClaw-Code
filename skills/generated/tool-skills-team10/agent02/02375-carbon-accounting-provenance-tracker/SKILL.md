---
name: carbon-accounting-provenance-tracker
description: Use when tasks require carbon accounting provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Provenance Tracker

## Purpose
Design and execute carbon accounting workflows using provenance tracker controls with validated outcomes.
