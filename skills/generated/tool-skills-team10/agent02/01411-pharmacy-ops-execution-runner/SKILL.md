---
name: pharmacy-ops-execution-runner
description: Use when tasks require pharmacy ops execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Execution Runner

## Purpose
Design and execute pharmacy ops workflows using execution runner controls with validated outcomes.
