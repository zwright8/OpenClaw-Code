---
name: research-repositories-anomaly-detector
description: Use when tasks require research repositories anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Anomaly Detector

## Purpose
Design and execute research repositories workflows using anomaly detector controls with validated outcomes.
