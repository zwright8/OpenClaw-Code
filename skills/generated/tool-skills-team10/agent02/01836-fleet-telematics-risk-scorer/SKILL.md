---
name: fleet-telematics-risk-scorer
description: Use when tasks require fleet telematics risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Risk Scorer

## Purpose
Design and execute fleet telematics workflows using risk scorer controls with validated outcomes.
