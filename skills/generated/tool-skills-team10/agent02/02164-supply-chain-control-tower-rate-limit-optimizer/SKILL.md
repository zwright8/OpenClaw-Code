---
name: supply-chain-control-tower-rate-limit-optimizer
description: Use when tasks require supply chain control tower rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Rate Limit Optimizer

## Purpose
Design and execute supply chain control tower workflows using rate limit optimizer controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Rate Limit Optimizer
- Score: 78
- Rank: 2300
- Priority band: P2
...
4. Execute rate limit optimizer actions with minimal blast radius.
...
- Capability: [Rate Limit Optimizer](../../resources/capabilities/rate-limit-optimizer.md)
