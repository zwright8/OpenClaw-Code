---
name: clinical-trial-systems-reliability-scorer
description: Use when tasks require clinical trial systems reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Reliability Scorer

## Purpose
Design and execute clinical trial systems workflows using reliability scorer controls with validated outcomes.
