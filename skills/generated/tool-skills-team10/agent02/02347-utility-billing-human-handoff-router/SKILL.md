---
name: utility-billing-human-handoff-router
description: Use when tasks require utility billing human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Human Handoff Router

## Purpose
Design and execute utility billing workflows using human handoff router controls with validated outcomes.
