---
name: admissions-systems-secret-scanner
description: Use when tasks require admissions systems secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Secret Scanner

## Purpose
Design and execute admissions systems workflows using secret scanner controls with validated outcomes.
