---
name: insurance-claims-pii-redactor
description: Use when tasks require insurance claims pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims PII Redactor

## Purpose
Design and execute insurance claims workflows using pii redactor controls with validated outcomes.
