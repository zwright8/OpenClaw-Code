---
name: quality-management-conflict-resolver
description: Use when tasks require quality management conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Conflict Resolver

## Purpose
Design and execute quality management workflows using conflict resolver controls with validated outcomes.
