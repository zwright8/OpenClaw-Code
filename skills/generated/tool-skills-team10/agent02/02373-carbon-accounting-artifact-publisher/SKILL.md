---
name: carbon-accounting-artifact-publisher
description: Use when tasks require carbon accounting artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Artifact Publisher

## Purpose
Design and execute carbon accounting workflows using artifact publisher controls with validated outcomes.
