---
name: admissions-systems-remediation-planner
description: Use when tasks require admissions systems remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Remediation Planner

## Purpose
Design and execute admissions systems workflows using remediation planner controls with validated outcomes.
