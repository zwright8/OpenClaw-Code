---
name: logistics-dispatch-remediation-planner
description: Use when tasks require logistics dispatch remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Remediation Planner

## Purpose
Design and execute logistics dispatch workflows using remediation planner controls with validated outcomes.
