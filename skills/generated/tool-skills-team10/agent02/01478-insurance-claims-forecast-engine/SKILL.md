---
name: insurance-claims-forecast-engine
description: Use when tasks require insurance claims forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Forecast Engine

## Purpose
Design and execute insurance claims workflows using forecast engine controls with validated outcomes.
