---
name: pharmacy-ops-job-scheduler
description: Use when tasks require pharmacy ops job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Job Scheduler

## Purpose
Design and execute pharmacy ops workflows using job scheduler controls with validated outcomes.
