---
name: environmental-sensors-retry-governor
description: Use when tasks require environmental sensors retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Retry Governor

## Purpose
Design and execute environmental sensors workflows using retry governor controls with validated outcomes.
