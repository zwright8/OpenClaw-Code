---
name: pharmacy-ops-artifact-publisher
description: Use when tasks require pharmacy ops artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Artifact Publisher

## Purpose
Design and execute pharmacy ops workflows using artifact publisher controls with validated outcomes.
