---
name: research-repositories-state-reconciler
description: Use when tasks require research repositories state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories State Reconciler

## Purpose
Design and execute research repositories workflows using state reconciler controls with validated outcomes.
