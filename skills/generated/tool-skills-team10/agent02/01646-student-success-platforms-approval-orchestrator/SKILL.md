---
name: student-success-platforms-approval-orchestrator
description: Use when tasks require student success platforms approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Approval Orchestrator

## Purpose
Design and execute student success platforms workflows using approval orchestrator controls with validated outcomes.
