---
name: carbon-accounting-conflict-resolver
description: Use when tasks require carbon accounting conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Conflict Resolver

## Purpose
Design and execute carbon accounting workflows using conflict resolver controls with validated outcomes.
