---
name: clinical-trial-systems-conflict-resolver
description: Use when tasks require clinical trial systems conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Conflict Resolver

## Purpose
Design and execute clinical trial systems workflows using conflict resolver controls with validated outcomes.
