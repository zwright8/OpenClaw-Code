---
name: environmental-sensors-spec-drift-detector
description: Use when tasks require environmental sensors spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Spec Drift Detector

## Purpose
Design and execute environmental sensors workflows using spec drift detector controls with validated outcomes.
