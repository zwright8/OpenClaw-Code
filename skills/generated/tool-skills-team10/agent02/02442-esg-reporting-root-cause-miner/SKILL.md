---
name: esg-reporting-root-cause-miner
description: Use when tasks require esg reporting root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Root Cause Miner

## Purpose
Design and execute esg reporting workflows using root cause miner controls with validated outcomes.
