---
name: property-management-policy-evaluator
description: Use when tasks require property management policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Policy Evaluator

## Purpose
Design and execute property management workflows using policy evaluator controls with validated outcomes.
