---
name: manufacturing-mes-retry-governor
description: Use when tasks require manufacturing mes retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Retry Governor

## Purpose
Design and execute manufacturing mes workflows using retry governor controls with validated outcomes.
