---
name: admissions-systems-human-handoff-router
description: Use when tasks require admissions systems human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Human Handoff Router

## Purpose
Design and execute admissions systems workflows using human handoff router controls with validated outcomes.
