---
name: admissions-systems-incident-triage
description: Use when tasks require admissions systems incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Incident Triage

## Purpose
Design and execute admissions systems workflows using incident triage controls with validated outcomes.
