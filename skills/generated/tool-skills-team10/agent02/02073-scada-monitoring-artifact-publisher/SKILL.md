---
name: scada-monitoring-artifact-publisher
description: Use when tasks require scada monitoring artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Artifact Publisher

## Purpose
Design and execute scada monitoring workflows using artifact publisher controls with validated outcomes.
