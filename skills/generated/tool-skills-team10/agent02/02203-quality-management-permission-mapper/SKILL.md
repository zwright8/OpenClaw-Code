---
name: quality-management-permission-mapper
description: Use when tasks require quality management permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Permission Mapper

## Purpose
Design and execute quality management workflows using permission mapper controls with validated outcomes.
