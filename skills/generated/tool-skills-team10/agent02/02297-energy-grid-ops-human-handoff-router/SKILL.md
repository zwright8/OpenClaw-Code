---
name: energy-grid-ops-human-handoff-router
description: Use when tasks require energy grid ops human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Human Handoff Router

## Purpose
Design and execute energy grid ops workflows using human handoff router controls with validated outcomes.
