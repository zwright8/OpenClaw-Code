---
name: warehouse-robotics-spec-drift-detector
description: Use when tasks require warehouse robotics spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Spec Drift Detector

## Purpose
Design and execute warehouse robotics workflows using spec drift detector controls with validated outcomes.
