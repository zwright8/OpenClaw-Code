---
name: freight-brokerage-policy-evaluator
description: Use when tasks require freight brokerage policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Policy Evaluator

## Purpose
Design and execute freight brokerage workflows using policy evaluator controls with validated outcomes.
