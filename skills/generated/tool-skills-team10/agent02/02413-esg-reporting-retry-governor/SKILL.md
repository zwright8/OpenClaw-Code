---
name: esg-reporting-retry-governor
description: Use when tasks require esg reporting retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Retry Governor

## Purpose
Design and execute esg reporting workflows using retry governor controls with validated outcomes.
