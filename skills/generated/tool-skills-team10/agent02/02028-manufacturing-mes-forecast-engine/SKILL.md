---
name: manufacturing-mes-forecast-engine
description: Use when tasks require manufacturing mes forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Forecast Engine

## Purpose
Design and execute manufacturing mes workflows using forecast engine controls with validated outcomes.
