---
name: manufacturing-mes-cost-attribution
description: Use when tasks require manufacturing mes cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Cost Attribution

## Purpose
Design and execute manufacturing mes workflows using cost attribution controls with validated outcomes.
