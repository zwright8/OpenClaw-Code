---
name: manufacturing-mes-snapshot-manager
description: Use when tasks require manufacturing mes snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Snapshot Manager

## Purpose
Design and execute manufacturing mes workflows using snapshot manager controls with validated outcomes.
