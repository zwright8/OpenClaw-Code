---
name: quality-management-capacity-planner
description: Use when tasks require quality management capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Capacity Planner

## Purpose
Design and execute quality management workflows using capacity planner controls with validated outcomes.
