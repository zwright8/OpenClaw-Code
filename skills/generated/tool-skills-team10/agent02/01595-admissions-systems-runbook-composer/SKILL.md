---
name: admissions-systems-runbook-composer
description: Use when tasks require admissions systems runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Runbook Composer

## Purpose
Design and execute admissions systems workflows using runbook composer controls with validated outcomes.
