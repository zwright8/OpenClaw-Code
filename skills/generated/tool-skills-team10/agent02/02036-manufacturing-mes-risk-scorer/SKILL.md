---
name: manufacturing-mes-risk-scorer
description: Use when tasks require manufacturing mes risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Risk Scorer

## Purpose
Design and execute manufacturing mes workflows using risk scorer controls with validated outcomes.
