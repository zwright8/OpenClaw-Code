---
name: environmental-sensors-secret-scanner
description: Use when tasks require environmental sensors secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Secret Scanner

## Purpose
Design and execute environmental sensors workflows using secret scanner controls with validated outcomes.
