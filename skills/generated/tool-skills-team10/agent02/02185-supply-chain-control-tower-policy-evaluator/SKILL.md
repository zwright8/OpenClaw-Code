---
name: supply-chain-control-tower-policy-evaluator
description: Use when tasks require supply chain control tower policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Policy Evaluator

## Purpose
Design and execute supply chain control tower workflows using policy evaluator controls with validated outcomes.
...
4. Execute policy evaluator actions with minimal blast radius.
...
- Capability: [Policy Evaluator](../../resources/capabilities/policy-evaluator.md)
