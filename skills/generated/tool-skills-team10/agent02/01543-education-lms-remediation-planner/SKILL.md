---
name: education-lms-remediation-planner
description: Use when tasks require education lms remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Remediation Planner

## Purpose
Design and execute education lms workflows using remediation planner controls with validated outcomes.
