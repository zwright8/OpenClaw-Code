---
name: customs-processing-feedback-harvester
description: Use when tasks require customs processing feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Feedback Harvester

## Purpose
Design and execute customs processing workflows using feedback harvester controls with validated outcomes.
