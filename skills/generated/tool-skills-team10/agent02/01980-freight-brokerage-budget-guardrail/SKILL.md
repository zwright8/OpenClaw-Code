---
name: freight-brokerage-budget-guardrail
description: Use when tasks require freight brokerage budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Budget Guardrail

## Purpose
Design and execute freight brokerage workflows using budget guardrail controls with validated outcomes.
