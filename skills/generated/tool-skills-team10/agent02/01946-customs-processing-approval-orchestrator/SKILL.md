---
name: customs-processing-approval-orchestrator
description: Use when tasks require customs processing approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Approval Orchestrator

## Purpose
Design and execute customs processing workflows using approval orchestrator controls with validated outcomes.
