---
name: carbon-accounting-compliance-mapper
description: Use when tasks require carbon accounting compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Compliance Mapper

## Purpose
Design and execute carbon accounting workflows using compliance mapper controls with validated outcomes.
