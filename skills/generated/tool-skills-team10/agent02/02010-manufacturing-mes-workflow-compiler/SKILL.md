---
name: manufacturing-mes-workflow-compiler
description: Use when tasks require manufacturing mes workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Workflow Compiler

## Purpose
Design and execute manufacturing mes workflows using workflow compiler controls with validated outcomes.
