---
name: clinical-trial-systems-retry-governor
description: Use when tasks require clinical trial systems retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Retry Governor

## Purpose
Design and execute clinical trial systems workflows using retry governor controls with validated outcomes.
