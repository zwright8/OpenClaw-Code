---
name: scada-monitoring-anomaly-detector
description: Use when tasks require scada monitoring anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Anomaly Detector

## Purpose
Design and execute scada monitoring workflows using anomaly detector controls with validated outcomes.
