---
name: pharmacy-ops-migration-planner
description: Use when tasks require pharmacy ops migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Migration Planner

## Purpose
Design and execute pharmacy ops workflows using migration planner controls with validated outcomes.
