---
name: warehouse-robotics-retry-governor
description: Use when tasks require warehouse robotics retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Retry Governor

## Purpose
Design and execute warehouse robotics workflows using retry governor controls with validated outcomes.
