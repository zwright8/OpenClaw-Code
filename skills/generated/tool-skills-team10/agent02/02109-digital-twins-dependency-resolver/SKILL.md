---
name: digital-twins-dependency-resolver
description: Use when tasks require digital twins dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Digital Twins Dependency Resolver

## Purpose
Design and execute digital twins workflows using dependency resolver controls with validated outcomes.
