---
name: admissions-systems-dependency-resolver
description: Use when tasks require admissions systems dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Dependency Resolver

## Purpose
Design and execute admissions systems workflows using dependency resolver controls with validated outcomes.
