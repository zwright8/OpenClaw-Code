---
name: logistics-dispatch-budget-guardrail
description: Use when tasks require logistics dispatch budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Budget Guardrail

## Purpose
Design and execute logistics dispatch workflows using budget guardrail controls with validated outcomes.
