---
name: carbon-accounting-schema-introspector
description: Use when tasks require carbon accounting schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Schema Introspector

## Purpose
Design and execute carbon accounting workflows using schema introspector controls with validated outcomes.
