---
name: environmental-sensors-human-handoff-router
description: Use when tasks require environmental sensors human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Human Handoff Router

## Purpose
Design and execute environmental sensors workflows using human handoff router controls with validated outcomes.
