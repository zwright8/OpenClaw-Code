---
name: manufacturing-mes-version-tracker
description: Use when tasks require manufacturing mes version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Version Tracker

## Purpose
Design and execute manufacturing mes workflows using version tracker controls with validated outcomes.
