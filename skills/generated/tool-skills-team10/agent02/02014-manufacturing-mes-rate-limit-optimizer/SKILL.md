---
name: manufacturing-mes-rate-limit-optimizer
description: Use when tasks require manufacturing mes rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Rate Limit Optimizer

## Purpose
Design and execute manufacturing mes workflows using rate limit optimizer controls with validated outcomes.
