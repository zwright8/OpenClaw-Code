---
name: carbon-accounting-operation-planner
description: Use when tasks require carbon accounting operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Operation Planner

## Purpose
Design and execute carbon accounting workflows using operation planner controls with validated outcomes.
