---
name: logistics-dispatch-dependency-resolver
description: Use when tasks require logistics dispatch dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Dependency Resolver

## Purpose
Design and execute logistics dispatch workflows using dependency resolver controls with validated outcomes.
