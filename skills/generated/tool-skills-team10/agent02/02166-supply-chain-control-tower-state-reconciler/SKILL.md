---
name: supply-chain-control-tower-state-reconciler
description: Use when tasks require supply chain control tower state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower State Reconciler

## Purpose
Design and execute supply chain control tower workflows using state reconciler controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: State Reconciler
- Score: 82
- Rank: 1284
- Priority band: P2
...
4. Execute state reconciler actions with minimal blast radius.
...
- Capability: [State Reconciler](../../resources/capabilities/state-reconciler.md)
