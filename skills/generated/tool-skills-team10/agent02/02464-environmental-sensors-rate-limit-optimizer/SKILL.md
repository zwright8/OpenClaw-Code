---
name: environmental-sensors-rate-limit-optimizer
description: Use when tasks require environmental sensors rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Rate Limit Optimizer

## Purpose
Design and execute environmental sensors workflows using rate limit optimizer controls with validated outcomes.
