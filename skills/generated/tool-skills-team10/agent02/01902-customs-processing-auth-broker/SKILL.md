---
name: customs-processing-auth-broker
description: Use when tasks require customs processing auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Auth Broker

## Purpose
Design and execute customs processing workflows using auth broker controls with validated outcomes.
