---
name: supply-chain-control-tower-feedback-harvester
description: Use when tasks require supply chain control tower feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Feedback Harvester

## Purpose
Design and execute supply chain control tower workflows using feedback harvester controls with validated outcomes.
