---
name: pharmacy-ops-forecast-engine
description: Use when tasks require pharmacy ops forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Forecast Engine

## Purpose
Design and execute pharmacy ops workflows using forecast engine controls with validated outcomes.
