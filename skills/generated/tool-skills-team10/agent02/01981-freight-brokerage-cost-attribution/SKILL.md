---
name: freight-brokerage-cost-attribution
description: Use when tasks require freight brokerage cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Cost Attribution

## Purpose
Design and execute freight brokerage workflows using cost attribution controls with validated outcomes.
