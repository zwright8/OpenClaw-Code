---
name: energy-grid-ops-dependency-resolver
description: Use when tasks require energy grid ops dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Dependency Resolver

## Purpose
Design and execute energy grid ops workflows using dependency resolver controls with validated outcomes.
