---
name: warehouse-robotics-human-handoff-router
description: Use when tasks require warehouse robotics human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Human Handoff Router

## Purpose
Design and execute warehouse robotics workflows using human handoff router controls with validated outcomes.
