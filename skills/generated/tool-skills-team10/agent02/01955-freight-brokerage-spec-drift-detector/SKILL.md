---
name: freight-brokerage-spec-drift-detector
description: Use when tasks require freight brokerage spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Spec Drift Detector

## Purpose
Design and execute freight brokerage workflows using spec drift detector controls with validated outcomes.
