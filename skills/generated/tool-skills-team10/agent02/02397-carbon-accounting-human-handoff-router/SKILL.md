---
name: carbon-accounting-human-handoff-router
description: Use when tasks require carbon accounting human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Human Handoff Router

## Purpose
Design and execute carbon accounting workflows using human handoff router controls with validated outcomes.
