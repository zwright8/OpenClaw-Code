---
name: supply-chain-control-tower-outcome-synthesizer
description: Use when tasks require supply chain control tower outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Outcome Synthesizer

## Purpose
Design and execute supply chain control tower workflows using outcome synthesizer controls with validated outcomes.
