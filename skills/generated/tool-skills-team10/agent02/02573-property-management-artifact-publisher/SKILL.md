---
name: property-management-artifact-publisher
description: Use when tasks require property management artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Artifact Publisher

## Purpose
Design and execute property management workflows using artifact publisher controls with validated outcomes.
