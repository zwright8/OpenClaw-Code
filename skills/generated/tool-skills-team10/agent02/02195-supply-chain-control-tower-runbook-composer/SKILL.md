---
name: supply-chain-control-tower-runbook-composer
description: Use when tasks require supply chain control tower runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Runbook Composer

## Purpose
Design and execute supply chain control tower workflows using runbook composer controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Runbook Composer
- Score: 78
- Rank: 2302
- Priority band: P2
...
4. Execute runbook composer actions with minimal blast radius.
...
- Capability: [Runbook Composer](../../resources/capabilities/runbook-composer.md)
