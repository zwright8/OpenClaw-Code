---
name: fleet-telematics-operation-planner
description: Use when tasks require fleet telematics operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Operation Planner

## Purpose
Design and execute fleet telematics workflows using operation planner controls with validated outcomes.
