---
name: scada-monitoring-incident-triage
description: Use when tasks require scada monitoring incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Incident Triage

## Purpose
Design and execute scada monitoring workflows using incident triage controls with validated outcomes.
