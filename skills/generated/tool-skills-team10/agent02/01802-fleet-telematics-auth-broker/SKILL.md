---
name: fleet-telematics-auth-broker
description: Use when tasks require fleet telematics auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Auth Broker

## Purpose
Design and execute fleet telematics workflows using auth broker controls with validated outcomes.
