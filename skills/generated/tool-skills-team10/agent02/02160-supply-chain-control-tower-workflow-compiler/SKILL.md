---
name: supply-chain-control-tower-workflow-compiler
description: Use when tasks require supply chain control tower workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Workflow Compiler

## Purpose
Design and execute supply chain control tower workflows using workflow compiler controls with validated outcomes.
...
4. Execute workflow compiler actions with minimal blast radius.
...
- Capability: [Workflow Compiler](../../resources/capabilities/workflow-compiler.md)
