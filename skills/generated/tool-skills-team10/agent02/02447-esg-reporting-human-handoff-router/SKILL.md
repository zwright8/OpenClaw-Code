---
name: esg-reporting-human-handoff-router
description: Use when tasks require esg reporting human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Human Handoff Router

## Purpose
Design and execute esg reporting workflows using human handoff router controls with validated outcomes.
