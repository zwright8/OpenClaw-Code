---
name: supply-chain-control-tower-approval-orchestrator
description: Use when tasks require supply chain control tower approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Approval Orchestrator

## Purpose
Design and execute supply chain control tower workflows using approval orchestrator controls with validated outcomes.
