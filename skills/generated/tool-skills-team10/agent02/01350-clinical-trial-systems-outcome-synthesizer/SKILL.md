---
name: clinical-trial-systems-outcome-synthesizer
description: Use when tasks require clinical trial systems outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Outcome Synthesizer

## Purpose
Design and execute clinical trial systems workflows using outcome synthesizer controls with validated outcomes.
