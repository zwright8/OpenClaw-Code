---
name: utility-billing-auth-broker
description: Use when tasks require utility billing auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Auth Broker

## Purpose
Design and execute utility billing workflows using auth broker controls with validated outcomes.
