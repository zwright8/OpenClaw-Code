---
name: fleet-telematics-task-decomposer
description: Use when tasks require fleet telematics task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Task Decomposer

## Purpose
Design and execute fleet telematics workflows using task decomposer controls with validated outcomes.
