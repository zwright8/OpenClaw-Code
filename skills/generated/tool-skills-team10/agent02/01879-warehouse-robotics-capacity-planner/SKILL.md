---
name: warehouse-robotics-capacity-planner
description: Use when tasks require warehouse robotics capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Capacity Planner

## Purpose
Design and execute warehouse robotics workflows using capacity planner controls with validated outcomes.
