---
name: fleet-telematics-execution-runner
description: Use when tasks require fleet telematics execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Execution Runner

## Purpose
Design and execute fleet telematics workflows using execution runner controls with validated outcomes.
