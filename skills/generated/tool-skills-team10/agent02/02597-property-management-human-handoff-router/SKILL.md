---
name: property-management-human-handoff-router
description: Use when tasks require property management human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Human Handoff Router

## Purpose
Design and execute property management workflows using human handoff router controls with validated outcomes.
