---
name: supply-chain-control-tower-migration-planner
description: Use when tasks require supply chain control tower migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Migration Planner

## Purpose
Design and execute supply chain control tower workflows using migration planner controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Migration Planner
- Score: 81
- Rank: 1509
- Priority band: P2
...
4. Execute migration planner actions with minimal blast radius.
...
- Capability: [Migration Planner](../../resources/capabilities/migration-planner.md)
