---
name: manufacturing-mes-policy-evaluator
description: Use when tasks require manufacturing mes policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Policy Evaluator

## Purpose
Design and execute manufacturing mes workflows using policy evaluator controls with validated outcomes.
