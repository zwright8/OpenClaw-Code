---
name: energy-grid-ops-capacity-planner
description: Use when tasks require energy grid ops capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Capacity Planner

## Purpose
Design and execute energy grid ops workflows using capacity planner controls with validated outcomes.
