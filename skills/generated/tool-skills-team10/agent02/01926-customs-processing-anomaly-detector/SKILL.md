---
name: customs-processing-anomaly-detector
description: Use when tasks require customs processing anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Anomaly Detector

## Purpose
Design and execute customs processing workflows using anomaly detector controls with validated outcomes.
