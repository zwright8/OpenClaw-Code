---
name: student-success-platforms-workflow-compiler
description: Use when tasks require student success platforms workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Workflow Compiler

## Purpose
Design and execute student success platforms workflows using workflow compiler controls with validated outcomes.
