---
name: student-success-platforms-human-handoff-router
description: Use when tasks require student success platforms human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Human Handoff Router

## Purpose
Design and execute student success platforms workflows using human handoff router controls with validated outcomes.
