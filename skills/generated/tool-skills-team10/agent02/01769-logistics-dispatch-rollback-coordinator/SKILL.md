---
name: logistics-dispatch-rollback-coordinator
description: Use when tasks require logistics dispatch rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Rollback Coordinator

## Purpose
Design and execute logistics dispatch workflows using rollback coordinator controls with validated outcomes.
