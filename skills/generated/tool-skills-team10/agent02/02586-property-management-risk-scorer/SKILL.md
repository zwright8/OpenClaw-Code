---
name: property-management-risk-scorer
description: Use when tasks require property management risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Risk Scorer

## Purpose
Design and execute property management workflows using risk scorer controls with validated outcomes.
