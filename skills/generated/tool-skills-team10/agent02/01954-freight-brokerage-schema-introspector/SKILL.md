---
name: freight-brokerage-schema-introspector
description: Use when tasks require freight brokerage schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Schema Introspector

## Purpose
Design and execute freight brokerage workflows using schema introspector controls with validated outcomes.
