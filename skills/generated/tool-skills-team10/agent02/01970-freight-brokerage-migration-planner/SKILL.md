---
name: freight-brokerage-migration-planner
description: Use when tasks require freight brokerage migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Migration Planner

## Purpose
Design and execute freight brokerage workflows using migration planner controls with validated outcomes.
