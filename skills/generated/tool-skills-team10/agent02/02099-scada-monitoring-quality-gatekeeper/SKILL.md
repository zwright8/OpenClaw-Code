---
name: scada-monitoring-quality-gatekeeper
description: Use when tasks require scada monitoring quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Quality Gatekeeper

## Purpose
Design and execute scada monitoring workflows using quality gatekeeper controls with validated outcomes.
