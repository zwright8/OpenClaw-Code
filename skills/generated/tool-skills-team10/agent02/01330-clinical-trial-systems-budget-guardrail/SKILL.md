---
name: clinical-trial-systems-budget-guardrail
description: Use when tasks require clinical trial systems budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Budget Guardrail

## Purpose
Design and execute clinical trial systems workflows using budget guardrail controls with validated outcomes.
