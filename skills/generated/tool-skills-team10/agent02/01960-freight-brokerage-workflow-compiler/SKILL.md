---
name: freight-brokerage-workflow-compiler
description: Use when tasks require freight brokerage workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Workflow Compiler

## Purpose
Design and execute freight brokerage workflows using workflow compiler controls with validated outcomes.
