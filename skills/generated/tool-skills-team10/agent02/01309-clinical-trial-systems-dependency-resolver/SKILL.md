---
name: clinical-trial-systems-dependency-resolver
description: Use when tasks require clinical trial systems dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Dependency Resolver

## Purpose
Design and execute clinical trial systems workflows using dependency resolver controls with validated outcomes.
