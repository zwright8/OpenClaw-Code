---
name: pharmacy-ops-capacity-planner
description: Use when tasks require pharmacy ops capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Capacity Planner

## Purpose
Design and execute pharmacy ops workflows using capacity planner controls with validated outcomes.
