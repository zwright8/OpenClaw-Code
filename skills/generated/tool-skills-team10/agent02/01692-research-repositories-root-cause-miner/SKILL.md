---
name: research-repositories-root-cause-miner
description: Use when tasks require research repositories root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Root Cause Miner

## Purpose
Design and execute research repositories workflows using root cause miner controls with validated outcomes.
