---
name: admissions-systems-task-decomposer
description: Use when tasks require admissions systems task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Task Decomposer

## Purpose
Design and execute admissions systems workflows using task decomposer controls with validated outcomes.
