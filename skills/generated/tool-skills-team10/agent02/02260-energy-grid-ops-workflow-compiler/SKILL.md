---
name: energy-grid-ops-workflow-compiler
description: Use when tasks require energy grid ops workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Workflow Compiler

## Purpose
Design and execute energy grid ops workflows using workflow compiler controls with validated outcomes.
