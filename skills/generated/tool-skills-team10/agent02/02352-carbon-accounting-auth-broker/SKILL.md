---
name: carbon-accounting-auth-broker
description: Use when tasks require carbon accounting auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Auth Broker

## Purpose
Design and execute carbon accounting workflows using auth broker controls with validated outcomes.
