---
name: admissions-systems-schema-introspector
description: Use when tasks require admissions systems schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Schema Introspector

## Purpose
Design and execute admissions systems workflows using schema introspector controls with validated outcomes.
