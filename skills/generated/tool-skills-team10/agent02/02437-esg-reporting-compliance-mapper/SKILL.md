---
name: esg-reporting-compliance-mapper
description: Use when tasks require esg reporting compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Compliance Mapper

## Purpose
Design and execute esg reporting workflows using compliance mapper controls with validated outcomes.
