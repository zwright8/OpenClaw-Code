---
name: logistics-dispatch-forecast-engine
description: Use when tasks require logistics dispatch forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Forecast Engine

## Purpose
Design and execute logistics dispatch workflows using forecast engine controls with validated outcomes.
