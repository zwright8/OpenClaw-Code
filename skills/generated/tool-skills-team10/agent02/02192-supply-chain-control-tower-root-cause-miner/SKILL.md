---
name: supply-chain-control-tower-root-cause-miner
description: Use when tasks require supply chain control tower root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Root Cause Miner

## Purpose
Design and execute supply chain control tower workflows using root cause miner controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Root Cause Miner
- Score: 81
- Rank: 1510
- Priority band: P2
...
4. Execute root cause miner actions with minimal blast radius.
...
- Capability: [Root Cause Miner](../../resources/capabilities/root-cause-miner.md)
