---
name: pharmacy-ops-schema-introspector
description: Use when tasks require pharmacy ops schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Schema Introspector

## Purpose
Design and execute pharmacy ops workflows using schema introspector controls with validated outcomes.
