---
name: quality-management-auth-broker
description: Use when tasks require quality management auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Auth Broker

## Purpose
Design and execute quality management workflows using auth broker controls with validated outcomes.
