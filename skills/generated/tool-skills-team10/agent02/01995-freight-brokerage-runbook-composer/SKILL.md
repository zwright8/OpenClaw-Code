---
name: freight-brokerage-runbook-composer
description: Use when tasks require freight brokerage runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Runbook Composer

## Purpose
Design and execute freight brokerage workflows using runbook composer controls with validated outcomes.
