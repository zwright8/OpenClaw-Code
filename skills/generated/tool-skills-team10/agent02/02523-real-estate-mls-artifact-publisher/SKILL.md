---
name: real-estate-mls-artifact-publisher
description: Use when tasks require real estate mls artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Artifact Publisher

## Purpose
Design and execute real estate mls workflows using artifact publisher controls with validated outcomes.
