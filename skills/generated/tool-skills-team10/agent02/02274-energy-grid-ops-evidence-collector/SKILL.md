---
name: energy-grid-ops-evidence-collector
description: Use when tasks require energy grid ops evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Evidence Collector

## Purpose
Design and execute energy grid ops workflows using evidence collector controls with validated outcomes.
