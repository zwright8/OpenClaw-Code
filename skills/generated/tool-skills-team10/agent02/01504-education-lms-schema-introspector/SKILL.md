---
name: education-lms-schema-introspector
description: Use when tasks require education lms schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Schema Introspector

## Purpose
Design and execute education lms workflows using schema introspector controls with validated outcomes.
