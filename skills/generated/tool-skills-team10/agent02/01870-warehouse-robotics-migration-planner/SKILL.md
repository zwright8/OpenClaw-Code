---
name: warehouse-robotics-migration-planner
description: Use when tasks require warehouse robotics migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Migration Planner

## Purpose
Design and execute warehouse robotics workflows using migration planner controls with validated outcomes.
