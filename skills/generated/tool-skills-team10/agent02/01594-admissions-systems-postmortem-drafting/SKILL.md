---
name: admissions-systems-postmortem-drafting
description: Use when tasks require admissions systems postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Postmortem Drafting

## Purpose
Design and execute admissions systems workflows using postmortem drafting controls with validated outcomes.
