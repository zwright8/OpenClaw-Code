---
name: research-repositories-budget-guardrail
description: Use when tasks require research repositories budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Budget Guardrail

## Purpose
Design and execute research repositories workflows using budget guardrail controls with validated outcomes.
