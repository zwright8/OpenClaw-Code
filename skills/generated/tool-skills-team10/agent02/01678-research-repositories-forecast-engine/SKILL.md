---
name: research-repositories-forecast-engine
description: Use when tasks require research repositories forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Forecast Engine

## Purpose
Design and execute research repositories workflows using forecast engine controls with validated outcomes.
