---
name: real-estate-mls-spec-drift-detector
description: Use when tasks require real estate mls spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Spec Drift Detector

## Purpose
Design and execute real estate mls workflows using spec drift detector controls with validated outcomes.
