---
name: environmental-sensors-permission-mapper
description: Use when tasks require environmental sensors permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Permission Mapper

## Purpose
Design and execute environmental sensors workflows using permission mapper controls with validated outcomes.
