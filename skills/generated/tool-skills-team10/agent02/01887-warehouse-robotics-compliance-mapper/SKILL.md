---
name: warehouse-robotics-compliance-mapper
description: Use when tasks require warehouse robotics compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Compliance Mapper

## Purpose
Design and execute warehouse robotics workflows using compliance mapper controls with validated outcomes.
