---
name: fleet-telematics-quality-gatekeeper
description: Use when tasks require fleet telematics quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Quality Gatekeeper

## Purpose
Design and execute fleet telematics workflows using quality gatekeeper controls with validated outcomes.
