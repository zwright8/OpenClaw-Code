---
name: education-lms-approval-orchestrator
description: Use when tasks require education lms approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Approval Orchestrator

## Purpose
Design and execute education lms workflows using approval orchestrator controls with validated outcomes.
