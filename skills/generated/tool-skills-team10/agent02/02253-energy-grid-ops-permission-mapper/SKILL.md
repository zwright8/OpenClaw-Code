---
name: energy-grid-ops-permission-mapper
description: Use when tasks require energy grid ops permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Permission Mapper

## Purpose
Design and execute energy grid ops workflows using permission mapper controls with validated outcomes.
