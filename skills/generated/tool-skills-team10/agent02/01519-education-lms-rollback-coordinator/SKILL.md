---
name: education-lms-rollback-coordinator
description: Use when tasks require education lms rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Rollback Coordinator

## Purpose
Design and execute education lms workflows using rollback coordinator controls with validated outcomes.
