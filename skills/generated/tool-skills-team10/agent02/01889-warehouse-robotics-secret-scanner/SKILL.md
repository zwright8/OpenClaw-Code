---
name: warehouse-robotics-secret-scanner
description: Use when tasks require warehouse robotics secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Secret Scanner

## Purpose
Design and execute warehouse robotics workflows using secret scanner controls with validated outcomes.
