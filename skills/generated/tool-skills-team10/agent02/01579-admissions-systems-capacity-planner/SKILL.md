---
name: admissions-systems-capacity-planner
description: Use when tasks require admissions systems capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Capacity Planner

## Purpose
Design and execute admissions systems workflows using capacity planner controls with validated outcomes.
