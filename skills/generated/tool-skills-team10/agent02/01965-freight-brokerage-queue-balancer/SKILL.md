---
name: freight-brokerage-queue-balancer
description: Use when tasks require freight brokerage queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Queue Balancer

## Purpose
Design and execute freight brokerage workflows using queue balancer controls with validated outcomes.
