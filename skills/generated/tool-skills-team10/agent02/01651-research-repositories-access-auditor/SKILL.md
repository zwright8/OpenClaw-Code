---
name: research-repositories-access-auditor
description: Use when tasks require research repositories access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Access Auditor

## Purpose
Design and execute research repositories workflows using access auditor controls with validated outcomes.
