---
name: insurance-claims-spec-drift-detector
description: Use when tasks require insurance claims spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Spec Drift Detector

## Purpose
Design and execute insurance claims workflows using spec drift detector controls with validated outcomes.
