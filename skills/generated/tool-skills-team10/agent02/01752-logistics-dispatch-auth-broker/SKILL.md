---
name: logistics-dispatch-auth-broker
description: Use when tasks require logistics dispatch auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Auth Broker

## Purpose
Design and execute logistics dispatch workflows using auth broker controls with validated outcomes.
