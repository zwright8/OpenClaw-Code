---
name: pharmacy-ops-quality-gatekeeper
description: Use when tasks require pharmacy ops quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Quality Gatekeeper

## Purpose
Design and execute pharmacy ops workflows using quality gatekeeper controls with validated outcomes.
