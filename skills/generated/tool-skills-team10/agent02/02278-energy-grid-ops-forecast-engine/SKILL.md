---
name: energy-grid-ops-forecast-engine
description: Use when tasks require energy grid ops forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Forecast Engine

## Purpose
Design and execute energy grid ops workflows using forecast engine controls with validated outcomes.
