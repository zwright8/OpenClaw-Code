---
name: quality-management-remediation-planner
description: Use when tasks require quality management remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Remediation Planner

## Purpose
Design and execute quality management workflows using remediation planner controls with validated outcomes.
