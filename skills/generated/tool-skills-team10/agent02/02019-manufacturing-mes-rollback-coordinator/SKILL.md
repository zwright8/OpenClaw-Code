---
name: manufacturing-mes-rollback-coordinator
description: Use when tasks require manufacturing mes rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Rollback Coordinator

## Purpose
Design and execute manufacturing mes workflows using rollback coordinator controls with validated outcomes.
