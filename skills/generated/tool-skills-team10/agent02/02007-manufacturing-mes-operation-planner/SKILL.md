---
name: manufacturing-mes-operation-planner
description: Use when tasks require manufacturing mes operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Operation Planner

## Purpose
Design and execute manufacturing mes workflows using operation planner controls with validated outcomes.
