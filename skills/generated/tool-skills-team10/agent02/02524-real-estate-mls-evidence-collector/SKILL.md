---
name: real-estate-mls-evidence-collector
description: Use when tasks require real estate mls evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Evidence Collector

## Purpose
Design and execute real estate mls workflows using evidence collector controls with validated outcomes.
