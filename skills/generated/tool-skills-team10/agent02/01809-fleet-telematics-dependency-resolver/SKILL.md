---
name: fleet-telematics-dependency-resolver
description: Use when tasks require fleet telematics dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Dependency Resolver

## Purpose
Design and execute fleet telematics workflows using dependency resolver controls with validated outcomes.
