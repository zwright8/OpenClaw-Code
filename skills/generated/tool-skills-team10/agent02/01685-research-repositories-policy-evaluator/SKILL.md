---
name: research-repositories-policy-evaluator
description: Use when tasks require research repositories policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Policy Evaluator

## Purpose
Design and execute research repositories workflows using policy evaluator controls with validated outcomes.
