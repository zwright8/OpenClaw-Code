---
name: manufacturing-mes-job-scheduler
description: Use when tasks require manufacturing mes job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Job Scheduler

## Purpose
Design and execute manufacturing mes workflows using job scheduler controls with validated outcomes.
