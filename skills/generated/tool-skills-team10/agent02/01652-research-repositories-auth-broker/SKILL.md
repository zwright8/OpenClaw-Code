---
name: research-repositories-auth-broker
description: Use when tasks require research repositories auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Auth Broker

## Purpose
Design and execute research repositories workflows using auth broker controls with validated outcomes.
