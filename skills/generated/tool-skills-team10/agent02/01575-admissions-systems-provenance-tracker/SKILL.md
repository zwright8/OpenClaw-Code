---
name: admissions-systems-provenance-tracker
description: Use when tasks require admissions systems provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Provenance Tracker

## Purpose
Design and execute admissions systems workflows using provenance tracker controls with validated outcomes.
