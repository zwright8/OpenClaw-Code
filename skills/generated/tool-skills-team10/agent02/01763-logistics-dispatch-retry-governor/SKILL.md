---
name: logistics-dispatch-retry-governor
description: Use when tasks require logistics dispatch retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Retry Governor

## Purpose
Design and execute logistics dispatch workflows using retry governor controls with validated outcomes.
