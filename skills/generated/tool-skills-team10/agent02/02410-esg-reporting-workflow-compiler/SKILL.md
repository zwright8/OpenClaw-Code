---
name: esg-reporting-workflow-compiler
description: Use when tasks require esg reporting workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Workflow Compiler

## Purpose
Design and execute esg reporting workflows using workflow compiler controls with validated outcomes.
