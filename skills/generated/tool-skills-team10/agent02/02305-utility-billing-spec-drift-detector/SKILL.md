---
name: utility-billing-spec-drift-detector
description: Use when tasks require utility billing spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Spec Drift Detector

## Purpose
Design and execute utility billing workflows using spec drift detector controls with validated outcomes.
