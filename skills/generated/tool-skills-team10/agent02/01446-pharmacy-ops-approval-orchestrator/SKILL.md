---
name: pharmacy-ops-approval-orchestrator
description: Use when tasks require pharmacy ops approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Approval Orchestrator

## Purpose
Design and execute pharmacy ops workflows using approval orchestrator controls with validated outcomes.
