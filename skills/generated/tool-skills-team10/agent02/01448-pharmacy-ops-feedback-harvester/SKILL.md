---
name: pharmacy-ops-feedback-harvester
description: Use when tasks require pharmacy ops feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Feedback Harvester

## Purpose
Design and execute pharmacy ops workflows using feedback harvester controls with validated outcomes.
