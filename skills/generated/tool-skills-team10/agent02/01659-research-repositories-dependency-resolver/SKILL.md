---
name: research-repositories-dependency-resolver
description: Use when tasks require research repositories dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Dependency Resolver

## Purpose
Design and execute research repositories workflows using dependency resolver controls with validated outcomes.
