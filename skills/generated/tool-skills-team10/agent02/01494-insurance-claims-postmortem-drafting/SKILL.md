---
name: insurance-claims-postmortem-drafting
description: Use when tasks require insurance claims postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Postmortem Drafting

## Purpose
Design and execute insurance claims workflows using postmortem drafting controls with validated outcomes.
