---
name: warehouse-robotics-artifact-publisher
description: Use when tasks require warehouse robotics artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Artifact Publisher

## Purpose
Design and execute warehouse robotics workflows using artifact publisher controls with validated outcomes.
