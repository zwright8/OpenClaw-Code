---
name: insurance-claims-quality-gatekeeper
description: Use when tasks require insurance claims quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Quality Gatekeeper

## Purpose
Design and execute insurance claims workflows using quality gatekeeper controls with validated outcomes.
