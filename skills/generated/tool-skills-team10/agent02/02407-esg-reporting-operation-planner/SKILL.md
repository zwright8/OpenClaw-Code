---
name: esg-reporting-operation-planner
description: Use when tasks require esg reporting operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Operation Planner

## Purpose
Design and execute esg reporting workflows using operation planner controls with validated outcomes.
