---
name: energy-grid-ops-schema-introspector
description: Use when tasks require energy grid ops schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Schema Introspector

## Purpose
Design and execute energy grid ops workflows using schema introspector controls with validated outcomes.
