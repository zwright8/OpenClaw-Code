---
name: admissions-systems-permission-mapper
description: Use when tasks require admissions systems permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Permission Mapper

## Purpose
Design and execute admissions systems workflows using permission mapper controls with validated outcomes.
