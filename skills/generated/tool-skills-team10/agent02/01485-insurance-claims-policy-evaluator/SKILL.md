---
name: insurance-claims-policy-evaluator
description: Use when tasks require insurance claims policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Policy Evaluator

## Purpose
Design and execute insurance claims workflows using policy evaluator controls with validated outcomes.
