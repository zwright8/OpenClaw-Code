---
name: education-lms-migration-planner
description: Use when tasks require education lms migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Migration Planner

## Purpose
Design and execute education lms workflows using migration planner controls with validated outcomes.
