---
name: admissions-systems-spec-drift-detector
description: Use when tasks require admissions systems spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Spec Drift Detector

## Purpose
Design and execute admissions systems workflows using spec drift detector controls with validated outcomes.
