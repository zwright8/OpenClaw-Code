---
name: energy-grid-ops-budget-guardrail
description: Use when tasks require energy grid ops budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Budget Guardrail

## Purpose
Design and execute energy grid ops workflows using budget guardrail controls with validated outcomes.
