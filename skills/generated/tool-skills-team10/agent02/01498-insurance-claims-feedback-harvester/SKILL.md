---
name: insurance-claims-feedback-harvester
description: Use when tasks require insurance claims feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Feedback Harvester

## Purpose
Design and execute insurance claims workflows using feedback harvester controls with validated outcomes.
