---
name: logistics-dispatch-evidence-collector
description: Use when tasks require logistics dispatch evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Evidence Collector

## Purpose
Design and execute logistics dispatch workflows using evidence collector controls with validated outcomes.
