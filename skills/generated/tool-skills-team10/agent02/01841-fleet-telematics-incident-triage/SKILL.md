---
name: fleet-telematics-incident-triage
description: Use when tasks require fleet telematics incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Incident Triage

## Purpose
Design and execute fleet telematics workflows using incident triage controls with validated outcomes.
