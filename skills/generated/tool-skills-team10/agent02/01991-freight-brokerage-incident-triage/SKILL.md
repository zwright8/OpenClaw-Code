---
name: freight-brokerage-incident-triage
description: Use when tasks require freight brokerage incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Incident Triage

## Purpose
Design and execute freight brokerage workflows using incident triage controls with validated outcomes.
