---
name: energy-grid-ops-risk-scorer
description: Use when tasks require energy grid ops risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Risk Scorer

## Purpose
Design and execute energy grid ops workflows using risk scorer controls with validated outcomes.
