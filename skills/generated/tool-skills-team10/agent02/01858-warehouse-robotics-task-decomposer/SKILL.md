---
name: warehouse-robotics-task-decomposer
description: Use when tasks require warehouse robotics task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Task Decomposer

## Purpose
Design and execute warehouse robotics workflows using task decomposer controls with validated outcomes.
