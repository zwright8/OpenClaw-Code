---
name: student-success-platforms-secret-scanner
description: Use when tasks require student success platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Secret Scanner

## Purpose
Design and execute student success platforms workflows using secret scanner controls with validated outcomes.
