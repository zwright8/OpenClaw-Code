---
name: real-estate-mls-human-handoff-router
description: Use when tasks require real estate mls human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Human Handoff Router

## Purpose
Design and execute real estate mls workflows using human handoff router controls with validated outcomes.
