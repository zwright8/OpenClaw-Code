---
name: clinical-trial-systems-quality-gatekeeper
description: Use when tasks require clinical trial systems quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Quality Gatekeeper

## Purpose
Design and execute clinical trial systems workflows using quality gatekeeper controls with validated outcomes.
