---
name: supply-chain-control-tower-permission-mapper
description: Use when tasks require supply chain control tower permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Permission Mapper

## Purpose
Design and execute supply chain control tower workflows using permission mapper controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Permission Mapper
- Score: 84
- Rank: 1043
- Priority band: P2
...
4. Execute permission mapper actions with minimal blast radius.
...
- Capability: [Permission Mapper](../../resources/capabilities/permission-mapper.md)
