---
name: freight-brokerage-state-reconciler
description: Use when tasks require freight brokerage state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage State Reconciler

## Purpose
Design and execute freight brokerage workflows using state reconciler controls with validated outcomes.
