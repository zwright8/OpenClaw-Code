---
name: manufacturing-mes-anomaly-detector
description: Use when tasks require manufacturing mes anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Anomaly Detector

## Purpose
Design and execute manufacturing mes workflows using anomaly detector controls with validated outcomes.
