---
name: environmental-sensors-runbook-composer
description: Use when tasks require environmental sensors runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Runbook Composer

## Purpose
Design and execute environmental sensors workflows using runbook composer controls with validated outcomes.
