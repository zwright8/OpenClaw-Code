---
name: education-lms-conflict-resolver
description: Use when tasks require education lms conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Conflict Resolver

## Purpose
Design and execute education lms workflows using conflict resolver controls with validated outcomes.
