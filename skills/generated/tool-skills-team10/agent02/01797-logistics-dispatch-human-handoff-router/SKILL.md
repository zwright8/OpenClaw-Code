---
name: logistics-dispatch-human-handoff-router
description: Use when tasks require logistics dispatch human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Human Handoff Router

## Purpose
Design and execute logistics dispatch workflows using human handoff router controls with validated outcomes.
