---
name: pharmacy-ops-evidence-collector
description: Use when tasks require pharmacy ops evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Evidence Collector

## Purpose
Design and execute pharmacy ops workflows using evidence collector controls with validated outcomes.
