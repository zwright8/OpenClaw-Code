---
name: logistics-dispatch-incident-triage
description: Use when tasks require logistics dispatch incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Incident Triage

## Purpose
Design and execute logistics dispatch workflows using incident triage controls with validated outcomes.
