---
name: customs-processing-budget-guardrail
description: Use when tasks require customs processing budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Budget Guardrail

## Purpose
Design and execute customs processing workflows using budget guardrail controls with validated outcomes.
