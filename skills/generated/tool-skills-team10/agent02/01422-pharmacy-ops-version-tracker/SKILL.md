---
name: pharmacy-ops-version-tracker
description: Use when tasks require pharmacy ops version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Version Tracker

## Purpose
Design and execute pharmacy ops workflows using version tracker controls with validated outcomes.
