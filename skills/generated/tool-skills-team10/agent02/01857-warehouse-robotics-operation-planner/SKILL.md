---
name: warehouse-robotics-operation-planner
description: Use when tasks require warehouse robotics operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Operation Planner

## Purpose
Design and execute warehouse robotics workflows using operation planner controls with validated outcomes.
