---
name: freight-brokerage-postmortem-drafting
description: Use when tasks require freight brokerage postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Postmortem Drafting

## Purpose
Design and execute freight brokerage workflows using postmortem drafting controls with validated outcomes.
