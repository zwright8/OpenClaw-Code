---
name: real-estate-mls-snapshot-manager
description: Use when tasks require real estate mls snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Snapshot Manager

## Purpose
Design and execute real estate mls workflows using snapshot manager controls with validated outcomes.
