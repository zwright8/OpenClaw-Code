---
name: carbon-accounting-permission-mapper
description: Use when tasks require carbon accounting permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Permission Mapper

## Purpose
Design and execute carbon accounting workflows using permission mapper controls with validated outcomes.
