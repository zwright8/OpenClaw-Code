---
name: research-repositories-permission-mapper
description: Use when tasks require research repositories permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Permission Mapper

## Purpose
Design and execute research repositories workflows using permission mapper controls with validated outcomes.
