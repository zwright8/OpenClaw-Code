---
name: manufacturing-mes-secret-scanner
description: Use when tasks require manufacturing mes secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Secret Scanner

## Purpose
Design and execute manufacturing mes workflows using secret scanner controls with validated outcomes.
