---
name: customs-processing-evidence-collector
description: Use when tasks require customs processing evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Evidence Collector

## Purpose
Design and execute customs processing workflows using evidence collector controls with validated outcomes.
