---
name: scada-monitoring-risk-scorer
description: Use when tasks require scada monitoring risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Risk Scorer

## Purpose
Design and execute scada monitoring workflows using risk scorer controls with validated outcomes.
