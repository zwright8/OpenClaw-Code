---
name: clinical-trial-systems-anomaly-detector
description: Use when tasks require clinical trial systems anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Anomaly Detector

## Purpose
Design and execute clinical trial systems workflows using anomaly detector controls with validated outcomes.
