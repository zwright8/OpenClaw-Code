---
name: education-lms-task-decomposer
description: Use when tasks require education lms task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Task Decomposer

## Purpose
Design and execute education lms workflows using task decomposer controls with validated outcomes.
