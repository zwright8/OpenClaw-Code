---
name: real-estate-mls-approval-orchestrator
description: Use when tasks require real estate mls approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Approval Orchestrator

## Purpose
Design and execute real estate mls workflows using approval orchestrator controls with validated outcomes.
