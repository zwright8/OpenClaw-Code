---
name: pharmacy-ops-cost-attribution
description: Use when tasks require pharmacy ops cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Cost Attribution

## Purpose
Design and execute pharmacy ops workflows using cost attribution controls with validated outcomes.
