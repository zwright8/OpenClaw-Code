---
name: utility-billing-feedback-harvester
description: Use when tasks require utility billing feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Feedback Harvester

## Purpose
Design and execute utility billing workflows using feedback harvester controls with validated outcomes.
