---
name: carbon-accounting-root-cause-miner
description: Use when tasks require carbon accounting root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Root Cause Miner

## Purpose
Design and execute carbon accounting workflows using root cause miner controls with validated outcomes.
