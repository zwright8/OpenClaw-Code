---
name: fleet-telematics-migration-planner
description: Use when tasks require fleet telematics migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Migration Planner

## Purpose
Design and execute fleet telematics workflows using migration planner controls with validated outcomes.
