---
name: esg-reporting-dependency-resolver
description: Use when tasks require esg reporting dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Dependency Resolver

## Purpose
Design and execute esg reporting workflows using dependency resolver controls with validated outcomes.
