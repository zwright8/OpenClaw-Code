---
name: fleet-telematics-compliance-mapper
description: Use when tasks require fleet telematics compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Compliance Mapper

## Purpose
Design and execute fleet telematics workflows using compliance mapper controls with validated outcomes.
