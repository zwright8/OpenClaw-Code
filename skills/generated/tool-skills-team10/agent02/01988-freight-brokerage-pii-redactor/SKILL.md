---
name: freight-brokerage-pii-redactor
description: Use when tasks require freight brokerage pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage PII Redactor

## Purpose
Design and execute freight brokerage workflows using pii redactor controls with validated outcomes.
