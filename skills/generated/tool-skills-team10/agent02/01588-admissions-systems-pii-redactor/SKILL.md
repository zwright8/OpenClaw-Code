---
name: admissions-systems-pii-redactor
description: Use when tasks require admissions systems pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems PII Redactor

## Purpose
Design and execute admissions systems workflows using pii redactor controls with validated outcomes.
