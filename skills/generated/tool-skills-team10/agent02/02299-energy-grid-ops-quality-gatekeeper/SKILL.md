---
name: energy-grid-ops-quality-gatekeeper
description: Use when tasks require energy grid ops quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Quality Gatekeeper

## Purpose
Design and execute energy grid ops workflows using quality gatekeeper controls with validated outcomes.
