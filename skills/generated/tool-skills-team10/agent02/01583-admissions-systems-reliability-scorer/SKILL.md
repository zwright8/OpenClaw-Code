---
name: admissions-systems-reliability-scorer
description: Use when tasks require admissions systems reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Reliability Scorer

## Purpose
Design and execute admissions systems workflows using reliability scorer controls with validated outcomes.
