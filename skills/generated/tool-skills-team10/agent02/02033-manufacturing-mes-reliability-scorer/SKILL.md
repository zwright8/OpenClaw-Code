---
name: manufacturing-mes-reliability-scorer
description: Use when tasks require manufacturing mes reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Reliability Scorer

## Purpose
Design and execute manufacturing mes workflows using reliability scorer controls with validated outcomes.
