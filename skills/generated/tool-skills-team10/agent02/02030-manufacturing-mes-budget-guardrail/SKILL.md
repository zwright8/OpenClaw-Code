---
name: manufacturing-mes-budget-guardrail
description: Use when tasks require manufacturing mes budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Budget Guardrail

## Purpose
Design and execute manufacturing mes workflows using budget guardrail controls with validated outcomes.
