---
name: supply-chain-control-tower-secret-scanner
description: Use when tasks require supply chain control tower secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Secret Scanner

## Purpose
Design and execute supply chain control tower workflows using secret scanner controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Secret Scanner
- Score: 85
- Rank: 820
- Priority band: P1
...
4. Execute secret scanner actions with minimal blast radius.
...
- Capability: [Secret Scanner](../../resources/capabilities/secret-scanner.md)
