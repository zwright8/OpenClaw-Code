---
name: quality-management-artifact-publisher
description: Use when tasks require quality management artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Artifact Publisher

## Purpose
Design and execute quality management workflows using artifact publisher controls with validated outcomes.
