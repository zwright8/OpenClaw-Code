---
name: clinical-trial-systems-snapshot-manager
description: Use when tasks require clinical trial systems snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Snapshot Manager

## Purpose
Design and execute clinical trial systems workflows using snapshot manager controls with validated outcomes.
