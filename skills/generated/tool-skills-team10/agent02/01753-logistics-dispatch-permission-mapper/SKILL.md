---
name: logistics-dispatch-permission-mapper
description: Use when tasks require logistics dispatch permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Permission Mapper

## Purpose
Design and execute logistics dispatch workflows using permission mapper controls with validated outcomes.
