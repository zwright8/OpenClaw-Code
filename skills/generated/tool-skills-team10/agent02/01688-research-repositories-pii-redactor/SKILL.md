---
name: research-repositories-pii-redactor
description: Use when tasks require research repositories pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories PII Redactor

## Purpose
Design and execute research repositories workflows using pii redactor controls with validated outcomes.
