---
name: environmental-sensors-operation-planner
description: Use when tasks require environmental sensors operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Operation Planner

## Purpose
Design and execute environmental sensors workflows using operation planner controls with validated outcomes.
