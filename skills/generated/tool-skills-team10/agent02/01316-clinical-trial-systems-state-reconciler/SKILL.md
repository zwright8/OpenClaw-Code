---
name: clinical-trial-systems-state-reconciler
description: Use when tasks require clinical trial systems state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems State Reconciler

## Purpose
Design and execute clinical trial systems workflows using state reconciler controls with validated outcomes.
