---
name: environmental-sensors-execution-runner
description: Use when tasks require environmental sensors execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Execution Runner

## Purpose
Design and execute environmental sensors workflows using execution runner controls with validated outcomes.
