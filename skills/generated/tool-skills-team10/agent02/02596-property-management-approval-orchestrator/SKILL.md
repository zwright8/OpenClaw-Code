---
name: property-management-approval-orchestrator
description: Use when tasks require property management approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Approval Orchestrator

## Purpose
Design and execute property management workflows using approval orchestrator controls with validated outcomes.
