---
name: research-repositories-retry-governor
description: Use when tasks require research repositories retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Retry Governor

## Purpose
Design and execute research repositories workflows using retry governor controls with validated outcomes.
