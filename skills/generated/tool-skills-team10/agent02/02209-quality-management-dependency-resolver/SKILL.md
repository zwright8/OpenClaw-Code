---
name: quality-management-dependency-resolver
description: Use when tasks require quality management dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Dependency Resolver

## Purpose
Design and execute quality management workflows using dependency resolver controls with validated outcomes.
