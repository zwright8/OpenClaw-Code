---
name: supply-chain-control-tower-capacity-planner
description: Use when tasks require supply chain control tower capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Capacity Planner

## Purpose
Design and execute supply chain control tower workflows using capacity planner controls with validated outcomes.

## Precision Profile
- Domain: Supply Chain Control Tower
- Capability: Capacity Planner
- Score: 68
- Rank: 5332
- Priority band: P3
...
4. Execute capacity planner actions with minimal blast radius.
...
- Capability: [Capacity Planner](../../resources/capabilities/capacity-planner.md)
