---
name: research-repositories-provenance-tracker
description: Use when tasks require research repositories provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Provenance Tracker

## Purpose
Design and execute research repositories workflows using provenance tracker controls with validated outcomes.
