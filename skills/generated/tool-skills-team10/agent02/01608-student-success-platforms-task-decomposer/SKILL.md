---
name: student-success-platforms-task-decomposer
description: Use when tasks require student success platforms task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Task Decomposer

## Purpose
Design and execute student success platforms workflows using task decomposer controls with validated outcomes.
