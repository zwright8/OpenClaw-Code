---
name: education-lms-access-auditor
description: Use when tasks require education lms access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Access Auditor

## Purpose
Design and execute education lms workflows using access auditor controls with validated outcomes.
