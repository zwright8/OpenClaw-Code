---
name: warehouse-robotics-evidence-collector
description: Use when tasks require warehouse robotics evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Evidence Collector

## Purpose
Design and execute warehouse robotics workflows using evidence collector controls with validated outcomes.
