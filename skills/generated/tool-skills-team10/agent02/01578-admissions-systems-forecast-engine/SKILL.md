---
name: admissions-systems-forecast-engine
description: Use when tasks require admissions systems forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Forecast Engine

## Purpose
Design and execute admissions systems workflows using forecast engine controls with validated outcomes.
