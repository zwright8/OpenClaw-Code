---
name: energy-grid-ops-snapshot-manager
description: Use when tasks require energy grid ops snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Snapshot Manager

## Purpose
Design and execute energy grid ops workflows using snapshot manager controls with validated outcomes.
