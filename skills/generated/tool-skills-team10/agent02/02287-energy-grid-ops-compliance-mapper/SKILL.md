---
name: energy-grid-ops-compliance-mapper
description: Use when tasks require energy grid ops compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Compliance Mapper

## Purpose
Design and execute energy grid ops workflows using compliance mapper controls with validated outcomes.
