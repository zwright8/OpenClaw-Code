---
name: digital-twins-artifact-publisher
description: Use when tasks require digital twins artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Digital Twins Artifact Publisher

## Purpose
Design and execute digital twins workflows using artifact publisher controls with validated outcomes.
