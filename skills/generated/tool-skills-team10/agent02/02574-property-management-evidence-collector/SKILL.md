---
name: property-management-evidence-collector
description: Use when tasks require property management evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Property Management Evidence Collector

## Purpose
Design and execute property management workflows using evidence collector controls with validated outcomes.
