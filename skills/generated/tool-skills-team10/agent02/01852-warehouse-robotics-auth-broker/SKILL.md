---
name: warehouse-robotics-auth-broker
description: Use when tasks require warehouse robotics auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Auth Broker

## Purpose
Design and execute warehouse robotics workflows using auth broker controls with validated outcomes.
