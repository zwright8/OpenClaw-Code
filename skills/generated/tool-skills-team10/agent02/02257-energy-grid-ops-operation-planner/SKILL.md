---
name: energy-grid-ops-operation-planner
description: Use when tasks require energy grid ops operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Operation Planner

## Purpose
Design and execute energy grid ops workflows using operation planner controls with validated outcomes.
