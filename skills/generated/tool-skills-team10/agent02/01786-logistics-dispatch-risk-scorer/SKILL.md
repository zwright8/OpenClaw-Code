---
name: logistics-dispatch-risk-scorer
description: Use when tasks require logistics dispatch risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Risk Scorer

## Purpose
Design and execute logistics dispatch workflows using risk scorer controls with validated outcomes.
