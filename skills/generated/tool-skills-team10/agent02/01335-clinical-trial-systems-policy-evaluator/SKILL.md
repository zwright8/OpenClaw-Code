---
name: clinical-trial-systems-policy-evaluator
description: Use when tasks require clinical trial systems policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Policy Evaluator

## Purpose
Design and execute clinical trial systems workflows using policy evaluator controls with validated outcomes.
