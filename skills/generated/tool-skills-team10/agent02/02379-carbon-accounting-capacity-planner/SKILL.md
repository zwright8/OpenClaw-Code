---
name: carbon-accounting-capacity-planner
description: Use when tasks require carbon accounting capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Capacity Planner

## Purpose
Design and execute carbon accounting workflows using capacity planner controls with validated outcomes.
