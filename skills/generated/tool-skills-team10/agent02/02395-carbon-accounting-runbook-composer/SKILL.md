---
name: carbon-accounting-runbook-composer
description: Use when tasks require carbon accounting runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Runbook Composer

## Purpose
Design and execute carbon accounting workflows using runbook composer controls with validated outcomes.
