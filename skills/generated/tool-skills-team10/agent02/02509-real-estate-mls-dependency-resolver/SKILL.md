---
name: real-estate-mls-dependency-resolver
description: Use when tasks require real estate mls dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Dependency Resolver

## Purpose
Design and execute real estate mls workflows using dependency resolver controls with validated outcomes.
