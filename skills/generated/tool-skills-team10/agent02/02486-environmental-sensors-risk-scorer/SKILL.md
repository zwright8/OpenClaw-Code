---
name: environmental-sensors-risk-scorer
description: Use when tasks require environmental sensors risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Risk Scorer

## Purpose
Design and execute environmental sensors workflows using risk scorer controls with validated outcomes.
