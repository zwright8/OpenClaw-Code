---
name: pharmacy-ops-human-handoff-router
description: Use when tasks require pharmacy ops human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Human Handoff Router

## Purpose
Design and execute pharmacy ops workflows using human handoff router controls with validated outcomes.
