---
name: manufacturing-mes-pii-redactor
description: Use when tasks require manufacturing mes pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES PII Redactor

## Purpose
Design and execute manufacturing mes workflows using pii redactor controls with validated outcomes.
