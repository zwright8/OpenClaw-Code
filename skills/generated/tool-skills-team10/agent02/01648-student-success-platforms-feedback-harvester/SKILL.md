---
name: student-success-platforms-feedback-harvester
description: Use when tasks require student success platforms feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Feedback Harvester

## Purpose
Design and execute student success platforms workflows using feedback harvester controls with validated outcomes.
