---
name: esg-reporting-anomaly-detector
description: Use when tasks require esg reporting anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Anomaly Detector

## Purpose
Design and execute esg reporting workflows using anomaly detector controls with validated outcomes.
