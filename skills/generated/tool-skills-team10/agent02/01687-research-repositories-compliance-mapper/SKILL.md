---
name: research-repositories-compliance-mapper
description: Use when tasks require research repositories compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Compliance Mapper

## Purpose
Design and execute research repositories workflows using compliance mapper controls with validated outcomes.
