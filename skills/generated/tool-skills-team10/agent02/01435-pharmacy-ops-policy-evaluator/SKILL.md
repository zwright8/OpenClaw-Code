---
name: pharmacy-ops-policy-evaluator
description: Use when tasks require pharmacy ops policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Policy Evaluator

## Purpose
Design and execute pharmacy ops workflows using policy evaluator controls with validated outcomes.
