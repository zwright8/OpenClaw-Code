---
name: energy-grid-ops-api-contract-validator
description: Use when tasks require energy grid ops api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops API Contract Validator

## Purpose
Design and execute energy grid ops workflows using api contract validator controls with validated outcomes.

## Precision Profile
- Domain: Energy Grid Ops
...
- Domain: [Energy Grid Ops](../../resources/domains/energy-grid-ops.md)
