---
name: energy-grid-ops-outcome-synthesizer
description: Use when tasks require energy grid ops outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Outcome Synthesizer

## Purpose
Design and execute energy grid ops workflows using outcome synthesizer controls with validated outcomes.
