---
name: freight-brokerage-provenance-tracker
description: Use when tasks require freight brokerage provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Provenance Tracker

## Purpose
Design and execute freight brokerage workflows using provenance tracker controls with validated outcomes.
