---
name: pharmacy-ops-permission-mapper
description: Use when tasks require pharmacy ops permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Permission Mapper

## Purpose
Design and execute pharmacy ops workflows using permission mapper controls with validated outcomes.
