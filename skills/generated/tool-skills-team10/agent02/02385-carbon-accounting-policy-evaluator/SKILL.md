---
name: carbon-accounting-policy-evaluator
description: Use when tasks require carbon accounting policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Policy Evaluator

## Purpose
Design and execute carbon accounting workflows using policy evaluator controls with validated outcomes.
