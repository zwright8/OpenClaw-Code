---
name: esg-reporting-provenance-tracker
description: Use when tasks require esg reporting provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Provenance Tracker

## Purpose
Design and execute esg reporting workflows using provenance tracker controls with validated outcomes.
