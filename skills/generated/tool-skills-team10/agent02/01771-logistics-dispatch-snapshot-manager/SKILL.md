---
name: logistics-dispatch-snapshot-manager
description: Use when tasks require logistics dispatch snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Snapshot Manager

## Purpose
Design and execute logistics dispatch workflows using snapshot manager controls with validated outcomes.
