---
name: pharmacy-ops-operation-planner
description: Use when tasks require pharmacy ops operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Operation Planner

## Purpose
Design and execute pharmacy ops workflows using operation planner controls with validated outcomes.
