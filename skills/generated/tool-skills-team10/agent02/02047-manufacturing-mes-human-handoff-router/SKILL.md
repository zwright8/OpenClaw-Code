---
name: manufacturing-mes-human-handoff-router
description: Use when tasks require manufacturing mes human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Human Handoff Router

## Purpose
Design and execute manufacturing mes workflows using human handoff router controls with validated outcomes.
