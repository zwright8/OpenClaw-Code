---
name: insurance-claims-auth-broker
description: Use when tasks require insurance claims auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Auth Broker

## Purpose
Design and execute insurance claims workflows using auth broker controls with validated outcomes.
