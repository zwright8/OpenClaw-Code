---
name: research-repositories-human-handoff-router
description: Use when tasks require research repositories human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Human Handoff Router

## Purpose
Design and execute research repositories workflows using human handoff router controls with validated outcomes.
