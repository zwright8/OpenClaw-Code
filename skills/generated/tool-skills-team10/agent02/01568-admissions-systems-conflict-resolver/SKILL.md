---
name: admissions-systems-conflict-resolver
description: Use when tasks require admissions systems conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Conflict Resolver

## Purpose
Design and execute admissions systems workflows using conflict resolver controls with validated outcomes.
