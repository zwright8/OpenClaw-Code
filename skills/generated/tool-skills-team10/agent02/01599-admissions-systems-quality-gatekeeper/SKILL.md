---
name: admissions-systems-quality-gatekeeper
description: Use when tasks require admissions systems quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Quality Gatekeeper

## Purpose
Design and execute admissions systems workflows using quality gatekeeper controls with validated outcomes.
