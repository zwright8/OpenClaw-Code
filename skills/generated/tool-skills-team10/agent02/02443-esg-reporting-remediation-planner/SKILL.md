---
name: esg-reporting-remediation-planner
description: Use when tasks require esg reporting remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Remediation Planner

## Purpose
Design and execute esg reporting workflows using remediation planner controls with validated outcomes.
