---
name: environmental-sensors-incident-triage
description: Use when tasks require environmental sensors incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Incident Triage

## Purpose
Design and execute environmental sensors workflows using incident triage controls with validated outcomes.
