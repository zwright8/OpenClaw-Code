---
name: carbon-accounting-incident-triage
description: Use when tasks require carbon accounting incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Incident Triage

## Purpose
Design and execute carbon accounting workflows using incident triage controls with validated outcomes.
