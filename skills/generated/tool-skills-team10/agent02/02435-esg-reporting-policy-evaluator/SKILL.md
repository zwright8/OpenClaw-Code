---
name: esg-reporting-policy-evaluator
description: Use when tasks require esg reporting policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Policy Evaluator

## Purpose
Design and execute esg reporting workflows using policy evaluator controls with validated outcomes.
