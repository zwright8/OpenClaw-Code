---
name: clinical-trial-systems-postmortem-drafting
description: Use when tasks require clinical trial systems postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Postmortem Drafting

## Purpose
Design and execute clinical trial systems workflows using postmortem drafting controls with validated outcomes.
