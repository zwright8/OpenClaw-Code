---
name: carbon-accounting-forecast-engine
description: Use when tasks require carbon accounting forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Forecast Engine

## Purpose
Design and execute carbon accounting workflows using forecast engine controls with validated outcomes.
