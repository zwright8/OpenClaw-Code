---
name: clinical-trial-systems-compliance-mapper
description: Use when tasks require clinical trial systems compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Compliance Mapper

## Purpose
Design and execute clinical trial systems workflows using compliance mapper controls with validated outcomes.
