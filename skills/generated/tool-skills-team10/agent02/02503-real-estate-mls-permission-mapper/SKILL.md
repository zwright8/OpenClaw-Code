---
name: real-estate-mls-permission-mapper
description: Use when tasks require real estate mls permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Permission Mapper

## Purpose
Design and execute real estate mls workflows using permission mapper controls with validated outcomes.
