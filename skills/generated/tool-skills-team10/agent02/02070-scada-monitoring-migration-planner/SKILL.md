---
name: scada-monitoring-migration-planner
description: Use when tasks require scada monitoring migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Migration Planner

## Purpose
Design and execute scada monitoring workflows using migration planner controls with validated outcomes.
