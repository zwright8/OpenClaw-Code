---
name: scada-monitoring-evidence-collector
description: Use when tasks require scada monitoring evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SCADA Monitoring Evidence Collector

## Purpose
Design and execute scada monitoring workflows using evidence collector controls with validated outcomes.
