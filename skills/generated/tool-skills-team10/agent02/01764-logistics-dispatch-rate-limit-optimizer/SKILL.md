---
name: logistics-dispatch-rate-limit-optimizer
description: Use when tasks require logistics dispatch rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Rate Limit Optimizer

## Purpose
Design and execute logistics dispatch workflows using rate limit optimizer controls with validated outcomes.
