---
name: energy-grid-ops-task-decomposer
description: Use when tasks require energy grid ops task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Task Decomposer

## Purpose
Design and execute energy grid ops workflows using task decomposer controls with validated outcomes.
