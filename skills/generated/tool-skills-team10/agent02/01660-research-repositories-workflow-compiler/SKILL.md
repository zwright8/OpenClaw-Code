---
name: research-repositories-workflow-compiler
description: Use when tasks require research repositories workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Workflow Compiler

## Purpose
Design and execute research repositories workflows using workflow compiler controls with validated outcomes.
