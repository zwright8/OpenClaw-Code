---
name: lab-information-systems-evidence-collector
description: Use when tasks require lab information systems evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Information Systems Evidence Collector

## Purpose
Design and execute lab information systems workflows using evidence collector controls with validated outcomes.
