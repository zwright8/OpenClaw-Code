---
name: freight-brokerage-anomaly-detector
description: Use when tasks require freight brokerage anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Anomaly Detector

## Purpose
Design and execute freight brokerage workflows using anomaly detector controls with validated outcomes.
