---
name: quality-management-provenance-tracker
description: Use when tasks require quality management provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Provenance Tracker

## Purpose
Design and execute quality management workflows using provenance tracker controls with validated outcomes.
