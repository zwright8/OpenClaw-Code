---
name: freight-brokerage-access-auditor
description: Use when tasks require freight brokerage access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Access Auditor

## Purpose
Design and execute freight brokerage workflows using access auditor controls with validated outcomes.
