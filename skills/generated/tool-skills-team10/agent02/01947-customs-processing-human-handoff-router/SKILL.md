---
name: customs-processing-human-handoff-router
description: Use when tasks require customs processing human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Human Handoff Router

## Purpose
Design and execute customs processing workflows using human handoff router controls with validated outcomes.
