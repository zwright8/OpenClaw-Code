---
name: logistics-dispatch-root-cause-miner
description: Use when tasks require logistics dispatch root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Root Cause Miner

## Purpose
Design and execute logistics dispatch workflows using root cause miner controls with validated outcomes.
