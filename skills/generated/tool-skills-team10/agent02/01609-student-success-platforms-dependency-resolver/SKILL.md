---
name: student-success-platforms-dependency-resolver
description: Use when tasks require student success platforms dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Dependency Resolver

## Purpose
Design and execute student success platforms workflows using dependency resolver controls with validated outcomes.
