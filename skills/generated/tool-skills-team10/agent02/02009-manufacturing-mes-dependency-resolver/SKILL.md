---
name: manufacturing-mes-dependency-resolver
description: Use when tasks require manufacturing mes dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Dependency Resolver

## Purpose
Design and execute manufacturing mes workflows using dependency resolver controls with validated outcomes.
