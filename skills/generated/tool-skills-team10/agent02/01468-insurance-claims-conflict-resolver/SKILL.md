---
name: insurance-claims-conflict-resolver
description: Use when tasks require insurance claims conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Conflict Resolver

## Purpose
Design and execute insurance claims workflows using conflict resolver controls with validated outcomes.
