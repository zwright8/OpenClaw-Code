---
name: freight-brokerage-capacity-planner
description: Use when tasks require freight brokerage capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Capacity Planner

## Purpose
Design and execute freight brokerage workflows using capacity planner controls with validated outcomes.
