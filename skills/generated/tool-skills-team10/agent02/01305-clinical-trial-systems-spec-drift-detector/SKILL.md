---
name: clinical-trial-systems-spec-drift-detector
description: Use when tasks require clinical trial systems spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Spec Drift Detector

## Purpose
Design and execute clinical trial systems workflows using spec drift detector controls with validated outcomes.
