---
name: logistics-dispatch-migration-planner
description: Use when tasks require logistics dispatch migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Migration Planner

## Purpose
Design and execute logistics dispatch workflows using migration planner controls with validated outcomes.
