---
name: pharmacy-ops-rate-limit-optimizer
description: Use when tasks require pharmacy ops rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Rate Limit Optimizer

## Purpose
Design and execute pharmacy ops workflows using rate limit optimizer controls with validated outcomes.
