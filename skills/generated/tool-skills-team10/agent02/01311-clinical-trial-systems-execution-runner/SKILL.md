---
name: clinical-trial-systems-execution-runner
description: Use when tasks require clinical trial systems execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Execution Runner

## Purpose
Design and execute clinical trial systems workflows using execution runner controls with validated outcomes.
