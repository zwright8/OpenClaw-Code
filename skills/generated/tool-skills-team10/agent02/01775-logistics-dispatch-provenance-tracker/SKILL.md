---
name: logistics-dispatch-provenance-tracker
description: Use when tasks require logistics dispatch provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Provenance Tracker

## Purpose
Design and execute logistics dispatch workflows using provenance tracker controls with validated outcomes.
