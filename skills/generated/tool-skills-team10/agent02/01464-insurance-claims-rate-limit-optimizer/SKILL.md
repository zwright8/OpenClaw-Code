---
name: insurance-claims-rate-limit-optimizer
description: Use when tasks require insurance claims rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Rate Limit Optimizer

## Purpose
Design and execute insurance claims workflows using rate limit optimizer controls with validated outcomes.
