---
name: clinical-trial-systems-workflow-compiler
description: Use when tasks require clinical trial systems workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Workflow Compiler

## Purpose
Design and execute clinical trial systems workflows using workflow compiler controls with validated outcomes.
