---
name: utility-billing-quality-gatekeeper
description: Use when tasks require utility billing quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Quality Gatekeeper

## Purpose
Design and execute utility billing workflows using quality gatekeeper controls with validated outcomes.
