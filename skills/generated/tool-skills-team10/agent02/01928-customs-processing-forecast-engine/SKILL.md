---
name: customs-processing-forecast-engine
description: Use when tasks require customs processing forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Forecast Engine

## Purpose
Design and execute customs processing workflows using forecast engine controls with validated outcomes.
