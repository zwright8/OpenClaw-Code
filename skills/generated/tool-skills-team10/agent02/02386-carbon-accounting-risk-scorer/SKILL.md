---
name: carbon-accounting-risk-scorer
description: Use when tasks require carbon accounting risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Risk Scorer

## Purpose
Design and execute carbon accounting workflows using risk scorer controls with validated outcomes.
