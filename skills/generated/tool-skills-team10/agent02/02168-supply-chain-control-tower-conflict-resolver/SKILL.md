---
name: supply-chain-control-tower-conflict-resolver
description: Use when tasks require supply chain control tower conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Supply Chain Control Tower Conflict Resolver

## Purpose
Design and execute supply chain control tower workflows using conflict resolver controls with validated outcomes.
