---
name: warehouse-robotics-policy-evaluator
description: Use when tasks require warehouse robotics policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Warehouse Robotics Policy Evaluator

## Purpose
Design and execute warehouse robotics workflows using policy evaluator controls with validated outcomes.
