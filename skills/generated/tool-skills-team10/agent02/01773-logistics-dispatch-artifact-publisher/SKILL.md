---
name: logistics-dispatch-artifact-publisher
description: Use when tasks require logistics dispatch artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Logistics Dispatch Artifact Publisher

## Purpose
Design and execute logistics dispatch workflows using artifact publisher controls with validated outcomes.
