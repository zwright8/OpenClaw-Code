---
name: carbon-accounting-latency-analyzer
description: Use when tasks require carbon accounting latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Latency Analyzer

## Purpose
Design and execute carbon accounting workflows using latency analyzer controls with validated outcomes.
