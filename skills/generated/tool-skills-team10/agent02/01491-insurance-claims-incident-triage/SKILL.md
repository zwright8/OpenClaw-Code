---
name: insurance-claims-incident-triage
description: Use when tasks require insurance claims incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Incident Triage

## Purpose
Design and execute insurance claims workflows using incident triage controls with validated outcomes.
