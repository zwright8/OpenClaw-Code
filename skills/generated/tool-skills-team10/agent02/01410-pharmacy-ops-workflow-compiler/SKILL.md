---
name: pharmacy-ops-workflow-compiler
description: Use when tasks require pharmacy ops workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Workflow Compiler

## Purpose
Design and execute pharmacy ops workflows using workflow compiler controls with validated outcomes.
