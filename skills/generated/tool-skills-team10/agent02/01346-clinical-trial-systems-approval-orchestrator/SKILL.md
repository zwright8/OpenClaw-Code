---
name: clinical-trial-systems-approval-orchestrator
description: Use when tasks require clinical trial systems approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Approval Orchestrator

## Purpose
Design and execute clinical trial systems workflows using approval orchestrator controls with validated outcomes.
