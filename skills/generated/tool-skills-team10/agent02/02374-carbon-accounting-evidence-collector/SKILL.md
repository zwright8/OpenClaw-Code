---
name: carbon-accounting-evidence-collector
description: Use when tasks require carbon accounting evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Evidence Collector

## Purpose
Design and execute carbon accounting workflows using evidence collector controls with validated outcomes.
