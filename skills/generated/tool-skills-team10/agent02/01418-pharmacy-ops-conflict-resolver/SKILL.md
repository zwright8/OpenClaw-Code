---
name: pharmacy-ops-conflict-resolver
description: Use when tasks require pharmacy ops conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Conflict Resolver

## Purpose
Design and execute pharmacy ops workflows using conflict resolver controls with validated outcomes.
