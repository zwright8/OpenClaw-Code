---
name: student-success-platforms-permission-mapper
description: Use when tasks require student success platforms permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Permission Mapper

## Purpose
Design and execute student success platforms workflows using permission mapper controls with validated outcomes.
