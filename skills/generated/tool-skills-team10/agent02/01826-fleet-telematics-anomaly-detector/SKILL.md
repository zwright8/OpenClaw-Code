---
name: fleet-telematics-anomaly-detector
description: Use when tasks require fleet telematics anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Anomaly Detector

## Purpose
Design and execute fleet telematics workflows using anomaly detector controls with validated outcomes.
