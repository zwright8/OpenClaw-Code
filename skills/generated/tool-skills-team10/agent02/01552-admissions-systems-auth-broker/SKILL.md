---
name: admissions-systems-auth-broker
description: Use when tasks require admissions systems auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Auth Broker

## Purpose
Design and execute admissions systems workflows using auth broker controls with validated outcomes.
