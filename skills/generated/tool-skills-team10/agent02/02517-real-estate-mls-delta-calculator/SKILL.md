---
name: real-estate-mls-delta-calculator
description: Use when tasks require real estate mls delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Real Estate MLS Delta Calculator

## Purpose
Design and execute real estate mls workflows using delta calculator controls with validated outcomes.
