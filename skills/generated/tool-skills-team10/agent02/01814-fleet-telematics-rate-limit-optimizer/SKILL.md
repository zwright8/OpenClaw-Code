---
name: fleet-telematics-rate-limit-optimizer
description: Use when tasks require fleet telematics rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Rate Limit Optimizer

## Purpose
Design and execute fleet telematics workflows using rate limit optimizer controls with validated outcomes.
