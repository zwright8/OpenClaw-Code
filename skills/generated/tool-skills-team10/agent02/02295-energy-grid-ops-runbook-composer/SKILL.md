---
name: energy-grid-ops-runbook-composer
description: Use when tasks require energy grid ops runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Energy Grid Ops Runbook Composer

## Purpose
Design and execute energy grid ops workflows using runbook composer controls with validated outcomes.
