---
name: student-success-platforms-anomaly-detector
description: Use when tasks require student success platforms anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Anomaly Detector

## Purpose
Design and execute student success platforms workflows using anomaly detector controls with validated outcomes.
