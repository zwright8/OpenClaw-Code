---
name: education-lms-permission-mapper
description: Use when tasks require education lms permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Education LMS Permission Mapper

## Purpose
Design and execute education lms workflows using permission mapper controls with validated outcomes.
