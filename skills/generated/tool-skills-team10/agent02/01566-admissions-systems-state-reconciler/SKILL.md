---
name: admissions-systems-state-reconciler
description: Use when tasks require admissions systems state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems State Reconciler

## Purpose
Design and execute admissions systems workflows using state reconciler controls with validated outcomes.
