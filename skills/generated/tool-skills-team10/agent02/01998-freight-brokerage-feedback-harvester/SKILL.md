---
name: freight-brokerage-feedback-harvester
description: Use when tasks require freight brokerage feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Feedback Harvester

## Purpose
Design and execute freight brokerage workflows using feedback harvester controls with validated outcomes.
