---
name: fleet-telematics-feedback-harvester
description: Use when tasks require fleet telematics feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fleet Telematics Feedback Harvester

## Purpose
Design and execute fleet telematics workflows using feedback harvester controls with validated outcomes.
