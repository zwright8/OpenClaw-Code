---
name: manufacturing-mes-state-reconciler
description: Use when tasks require manufacturing mes state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES State Reconciler

## Purpose
Design and execute manufacturing mes workflows using state reconciler controls with validated outcomes.
