---
name: environmental-sensors-forecast-engine
description: Use when tasks require environmental sensors forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Forecast Engine

## Purpose
Design and execute environmental sensors workflows using forecast engine controls with validated outcomes.
