---
name: research-repositories-conflict-resolver
description: Use when tasks require research repositories conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Research Repositories Conflict Resolver

## Purpose
Design and execute research repositories workflows using conflict resolver controls with validated outcomes.
