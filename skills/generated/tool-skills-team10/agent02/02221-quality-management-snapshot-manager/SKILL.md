---
name: quality-management-snapshot-manager
description: Use when tasks require quality management snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Snapshot Manager

## Purpose
Design and execute quality management workflows using snapshot manager controls with validated outcomes.
