---
name: admissions-systems-execution-runner
description: Use when tasks require admissions systems execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Admissions Systems Execution Runner

## Purpose
Design and execute admissions systems workflows using execution runner controls with validated outcomes.
