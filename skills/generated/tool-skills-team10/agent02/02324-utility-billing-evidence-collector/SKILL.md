---
name: utility-billing-evidence-collector
description: Use when tasks require utility billing evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Evidence Collector

## Purpose
Design and execute utility billing workflows using evidence collector controls with validated outcomes.
