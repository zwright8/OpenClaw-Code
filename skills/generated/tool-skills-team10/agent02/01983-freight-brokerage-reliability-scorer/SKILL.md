---
name: freight-brokerage-reliability-scorer
description: Use when tasks require freight brokerage reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Reliability Scorer

## Purpose
Design and execute freight brokerage workflows using reliability scorer controls with validated outcomes.
