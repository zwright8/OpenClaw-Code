---
name: student-success-platforms-spec-drift-detector
description: Use when tasks require student success platforms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Spec Drift Detector

## Purpose
Design and execute student success platforms workflows using spec drift detector controls with validated outcomes.
