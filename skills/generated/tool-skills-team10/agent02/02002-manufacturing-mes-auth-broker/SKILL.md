---
name: manufacturing-mes-auth-broker
description: Use when tasks require manufacturing mes auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Manufacturing MES Auth Broker

## Purpose
Design and execute manufacturing mes workflows using auth broker controls with validated outcomes.
