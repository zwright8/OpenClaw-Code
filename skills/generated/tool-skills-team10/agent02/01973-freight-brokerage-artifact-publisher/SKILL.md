---
name: freight-brokerage-artifact-publisher
description: Use when tasks require freight brokerage artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Artifact Publisher

## Purpose
Design and execute freight brokerage workflows using artifact publisher controls with validated outcomes.
