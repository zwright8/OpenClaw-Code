---
name: quality-management-incident-triage
description: Use when tasks require quality management incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Quality Management Incident Triage

## Purpose
Design and execute quality management workflows using incident triage controls with validated outcomes.
