---
name: customs-processing-postmortem-drafting
description: Use when tasks require customs processing postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customs Processing Postmortem Drafting

## Purpose
Design and execute customs processing workflows using postmortem drafting controls with validated outcomes.
