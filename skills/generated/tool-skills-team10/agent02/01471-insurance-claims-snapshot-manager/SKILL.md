---
name: insurance-claims-snapshot-manager
description: Use when tasks require insurance claims snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Insurance Claims Snapshot Manager

## Purpose
Design and execute insurance claims workflows using snapshot manager controls with validated outcomes.
