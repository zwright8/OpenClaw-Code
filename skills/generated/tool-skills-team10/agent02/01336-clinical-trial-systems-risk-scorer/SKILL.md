---
name: clinical-trial-systems-risk-scorer
description: Use when tasks require clinical trial systems risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Clinical Trial Systems Risk Scorer

## Purpose
Design and execute clinical trial systems workflows using risk scorer controls with validated outcomes.
