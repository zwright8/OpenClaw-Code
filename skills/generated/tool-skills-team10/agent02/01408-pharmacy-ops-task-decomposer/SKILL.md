---
name: pharmacy-ops-task-decomposer
description: Use when tasks require pharmacy ops task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Task Decomposer

## Purpose
Design and execute pharmacy ops workflows using task decomposer controls with validated outcomes.
