---
name: lab-information-systems-quality-gatekeeper
description: Use when tasks require lab information systems quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Information Systems Quality Gatekeeper

## Purpose
Design and execute lab information systems workflows using quality gatekeeper controls with validated outcomes.
