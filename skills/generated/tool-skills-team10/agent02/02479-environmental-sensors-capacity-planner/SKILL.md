---
name: environmental-sensors-capacity-planner
description: Use when tasks require environmental sensors capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Environmental Sensors Capacity Planner

## Purpose
Design and execute environmental sensors workflows using capacity planner controls with validated outcomes.
