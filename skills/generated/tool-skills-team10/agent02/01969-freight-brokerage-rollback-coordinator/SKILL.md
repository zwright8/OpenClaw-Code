---
name: freight-brokerage-rollback-coordinator
description: Use when tasks require freight brokerage rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Rollback Coordinator

## Purpose
Design and execute freight brokerage workflows using rollback coordinator controls with validated outcomes.
