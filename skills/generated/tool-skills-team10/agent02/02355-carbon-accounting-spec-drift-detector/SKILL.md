---
name: carbon-accounting-spec-drift-detector
description: Use when tasks require carbon accounting spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Carbon Accounting Spec Drift Detector

## Purpose
Design and execute carbon accounting workflows using spec drift detector controls with validated outcomes.
