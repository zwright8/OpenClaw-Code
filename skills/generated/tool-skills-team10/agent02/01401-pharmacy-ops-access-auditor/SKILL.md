---
name: pharmacy-ops-access-auditor
description: Use when tasks require pharmacy ops access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pharmacy Ops Access Auditor

## Purpose
Design and execute pharmacy ops workflows using access auditor controls with validated outcomes.
