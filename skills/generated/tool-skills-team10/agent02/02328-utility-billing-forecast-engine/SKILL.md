---
name: utility-billing-forecast-engine
description: Use when tasks require utility billing forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Forecast Engine

## Purpose
Design and execute utility billing workflows using forecast engine controls with validated outcomes.
