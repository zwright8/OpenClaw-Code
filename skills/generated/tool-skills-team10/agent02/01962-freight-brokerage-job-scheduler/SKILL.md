---
name: freight-brokerage-job-scheduler
description: Use when tasks require freight brokerage job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freight Brokerage Job Scheduler

## Purpose
Design and execute freight brokerage workflows using job scheduler controls with validated outcomes.
