---
name: digital-twins-access-auditor
description: Use when tasks require digital twins access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Digital Twins Access Auditor

## Purpose
Design and execute digital twins workflows using access auditor controls with validated outcomes.
