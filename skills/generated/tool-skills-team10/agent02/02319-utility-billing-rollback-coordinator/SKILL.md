---
name: utility-billing-rollback-coordinator
description: Use when tasks require utility billing rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Utility Billing Rollback Coordinator

## Purpose
Design and execute utility billing workflows using rollback coordinator controls with validated outcomes.
