---
name: esg-reporting-quality-gatekeeper
description: Use when tasks require esg reporting quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ESG Reporting Quality Gatekeeper

## Purpose
Design and execute esg reporting workflows using quality gatekeeper controls with validated outcomes.
