---
name: student-success-platforms-capacity-planner
description: Use when tasks require student success platforms capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Student Success Platforms Capacity Planner

## Purpose
Design and execute student success platforms workflows using capacity planner controls with validated outcomes.
