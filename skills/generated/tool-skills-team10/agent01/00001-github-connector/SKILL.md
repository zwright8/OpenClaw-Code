...
description: Use when tasks require github connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitHub Connector

## Purpose
Design and execute github workflows using connector controls with validated outcomes.
