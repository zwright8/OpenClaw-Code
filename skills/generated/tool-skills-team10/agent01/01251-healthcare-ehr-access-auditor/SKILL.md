---
name: healthcare-ehr-access-auditor
description: Use when tasks require healthcare ehr access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Access Auditor

## Purpose
Design and execute healthcare ehr workflows using access auditor controls with validated outcomes.
