---
name: government-records-workflow-compiler
description: Use when tasks require government records workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Workflow Compiler

## Purpose
Design and execute government records workflows using workflow compiler controls with validated outcomes.
