...
description: Use when tasks require databricks data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Databricks Data Importer

## Purpose
Design and execute databricks workflows using data importer controls with validated outcomes.
