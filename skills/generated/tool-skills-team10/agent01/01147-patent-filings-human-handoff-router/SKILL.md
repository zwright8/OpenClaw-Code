---
name: patent-filings-human-handoff-router
description: Use when tasks require patent filings human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Human Handoff Router

## Purpose
Design and execute patent filings workflows using human handoff router controls with validated outcomes.
