...
description: Use when tasks require intercom approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Intercom Approval Router

## Purpose
Design and execute intercom workflows using approval router controls with validated outcomes.
