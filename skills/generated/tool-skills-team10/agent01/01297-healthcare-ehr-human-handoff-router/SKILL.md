---
name: healthcare-ehr-human-handoff-router
description: Use when tasks require healthcare ehr human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Human Handoff Router

## Purpose
Design and execute healthcare ehr workflows using human handoff router controls with validated outcomes.
