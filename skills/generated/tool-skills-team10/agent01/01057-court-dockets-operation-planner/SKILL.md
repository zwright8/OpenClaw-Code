---
name: court-dockets-operation-planner
description: Use when tasks require court dockets operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Operation Planner

## Purpose
Design and execute court dockets workflows using operation planner controls with validated outcomes.
