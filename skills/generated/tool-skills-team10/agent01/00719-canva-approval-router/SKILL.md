...
description: Use when tasks require canva approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Canva Approval Router

## Purpose
Design and execute canva workflows using approval router controls with validated outcomes.
