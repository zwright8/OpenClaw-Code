---
name: compliance-registries-spec-drift-detector
description: Use when tasks require compliance registries spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Spec Drift Detector

## Purpose
Design and execute compliance registries workflows using spec drift detector controls with validated outcomes.
