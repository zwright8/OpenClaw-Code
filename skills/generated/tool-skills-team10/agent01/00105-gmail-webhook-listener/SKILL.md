...
description: Use when tasks require gmail webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Gmail Webhook Listener

## Purpose
Design and execute gmail workflows using webhook listener controls with validated outcomes.
