...
description: Use when tasks require postgres connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Postgres Connector

## Purpose
Design and execute postgres workflows using connector controls with validated outcomes.
