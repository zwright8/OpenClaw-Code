...
description: Use when tasks require prometheus approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prometheus Approval Router

## Purpose
Design and execute prometheus workflows using approval router controls with validated outcomes.
