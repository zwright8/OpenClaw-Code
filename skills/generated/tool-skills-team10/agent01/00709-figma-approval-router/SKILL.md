...
description: Use when tasks require figma approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Figma Approval Router

## Purpose
Design and execute figma workflows using approval router controls with validated outcomes.
