...
description: Use when tasks require sentry report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sentry Report Builder

## Purpose
Design and execute sentry workflows using report builder controls with validated outcomes.
