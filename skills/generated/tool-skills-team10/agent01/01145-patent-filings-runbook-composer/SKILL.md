---
name: patent-filings-runbook-composer
description: Use when tasks require patent filings runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Runbook Composer

## Purpose
Design and execute patent filings workflows using runbook composer controls with validated outcomes.
