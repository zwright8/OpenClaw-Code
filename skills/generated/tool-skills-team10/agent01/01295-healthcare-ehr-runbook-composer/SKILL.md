---
name: healthcare-ehr-runbook-composer
description: Use when tasks require healthcare ehr runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Runbook Composer

## Purpose
Design and execute healthcare ehr workflows using runbook composer controls with validated outcomes.
