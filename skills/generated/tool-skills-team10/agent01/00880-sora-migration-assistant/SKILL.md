...
description: Use when tasks require sora migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sora Migration Assistant

## Purpose
Design and execute sora workflows using migration assistant controls with validated outcomes.
...
- Domain: [Sora](../../resources/domains/sora.md)
