...
description: Use when tasks require mailchimp migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mailchimp Migration Assistant

## Purpose
Design and execute mailchimp workflows using migration assistant controls with validated outcomes.
...
- Domain: [Mailchimp](../../resources/domains/mailchimp.md)
