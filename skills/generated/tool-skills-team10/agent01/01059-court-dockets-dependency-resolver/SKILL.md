---
name: court-dockets-dependency-resolver
description: Use when tasks require court dockets dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Dependency Resolver

## Purpose
Design and execute court dockets workflows using dependency resolver controls with validated outcomes.
