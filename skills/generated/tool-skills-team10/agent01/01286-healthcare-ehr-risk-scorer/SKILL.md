---
name: healthcare-ehr-risk-scorer
description: Use when tasks require healthcare ehr risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Risk Scorer

## Purpose
Design and execute healthcare ehr workflows using risk scorer controls with validated outcomes.
