...
description: Use when tasks require whisper workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Whisper Workflow Automator

## Purpose
Design and execute whisper workflows using workflow automator controls with validated outcomes.
