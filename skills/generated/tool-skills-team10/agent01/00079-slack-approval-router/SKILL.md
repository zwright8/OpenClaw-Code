...
description: Use when tasks require slack approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Slack Approval Router

## Purpose
Design and execute slack workflows using approval router controls with validated outcomes.
