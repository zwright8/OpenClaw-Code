---
name: patent-filings-remediation-planner
description: Use when tasks require patent filings remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Remediation Planner

## Purpose
Design and execute patent filings workflows using remediation planner controls with validated outcomes.
