...
description: Use when tasks require databricks report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Databricks Report Builder

## Purpose
Design and execute databricks workflows using report builder controls with validated outcomes.
