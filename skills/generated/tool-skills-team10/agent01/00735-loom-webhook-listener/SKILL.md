...
description: Use when tasks require loom webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Loom Webhook Listener

## Purpose
Design and execute loom workflows using webhook listener controls with validated outcomes.
