...
description: Use when tasks require pdf report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# PDF Report Builder

## Purpose
Design and execute pdf workflows using report builder controls with validated outcomes.
