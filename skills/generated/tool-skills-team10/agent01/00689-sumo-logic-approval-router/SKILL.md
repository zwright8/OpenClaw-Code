...
description: Use when tasks require sumo logic approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sumo Logic Approval Router

## Purpose
Design and execute sumo logic workflows using approval router controls with validated outcomes.
