...
description: Use when tasks require gmail approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Gmail Approval Router

## Purpose
Design and execute gmail workflows using approval router controls with validated outcomes.
