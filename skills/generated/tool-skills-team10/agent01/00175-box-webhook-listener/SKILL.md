...
description: Use when tasks require box webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Box Webhook Listener

## Purpose
Design and execute box workflows using webhook listener controls with validated outcomes.
