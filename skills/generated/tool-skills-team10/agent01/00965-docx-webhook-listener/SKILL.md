...
description: Use when tasks require docx webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# DOCX Webhook Listener

## Purpose
Design and execute docx workflows using webhook listener controls with validated outcomes.
