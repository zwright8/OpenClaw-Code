---
name: patent-filings-artifact-publisher
description: Use when tasks require patent filings artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Artifact Publisher

## Purpose
Design and execute patent filings workflows using artifact publisher controls with validated outcomes.
