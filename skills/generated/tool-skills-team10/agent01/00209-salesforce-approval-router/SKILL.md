...
description: Use when tasks require salesforce approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Salesforce Approval Router

## Purpose
Design and execute salesforce workflows using approval router controls with validated outcomes.
