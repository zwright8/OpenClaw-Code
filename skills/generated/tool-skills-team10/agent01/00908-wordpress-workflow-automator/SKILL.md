...
description: Use when tasks require wordpress workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# WordPress Workflow Automator

## Purpose
Design and execute wordpress workflows using workflow automator controls with validated outcomes.
...
- Domain: [WordPress](../../resources/domains/wordpress.md)
