...
description: Use when tasks require woocommerce migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# WooCommerce Migration Assistant

## Purpose
Design and execute woocommerce workflows using migration assistant controls with validated outcomes.
...
- Domain: [WooCommerce](../../resources/domains/woocommerce.md)
