...
description: Use when tasks require substack report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Substack Report Builder

## Purpose
Design and execute substack workflows using report builder controls with validated outcomes.
