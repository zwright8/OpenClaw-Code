---
name: government-records-rollback-coordinator
description: Use when tasks require government records rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Rollback Coordinator

## Purpose
Design and execute government records workflows using rollback coordinator controls with validated outcomes.
