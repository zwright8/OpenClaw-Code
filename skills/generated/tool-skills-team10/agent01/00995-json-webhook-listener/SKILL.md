...
description: Use when tasks require json webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# JSON Webhook Listener

## Purpose
Design and execute json workflows using webhook listener controls with validated outcomes.
