---
name: patent-filings-anomaly-detector
description: Use when tasks require patent filings anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Anomaly Detector

## Purpose
Design and execute patent filings workflows using anomaly detector controls with validated outcomes.
