---
name: compliance-registries-rollback-coordinator
description: Use when tasks require compliance registries rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Rollback Coordinator

## Purpose
Design and execute compliance registries workflows using rollback coordinator controls with validated outcomes.
