---
name: healthcare-ehr-retry-governor
description: Use when tasks require healthcare ehr retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Retry Governor

## Purpose
Design and execute healthcare ehr workflows using retry governor controls with validated outcomes.
