---
name: patent-filings-delta-calculator
description: Use when tasks require patent filings delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Delta Calculator

## Purpose
Design and execute patent filings workflows using delta calculator controls with validated outcomes.
