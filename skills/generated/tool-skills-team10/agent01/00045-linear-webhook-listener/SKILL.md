...
description: Use when tasks require linear webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Linear Webhook Listener

## Purpose
Design and execute linear workflows using webhook listener controls with validated outcomes.
