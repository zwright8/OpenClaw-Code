...
description: Use when tasks require sumo logic report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sumo Logic Report Builder

## Purpose
Design and execute sumo logic workflows using report builder controls with validated outcomes.
