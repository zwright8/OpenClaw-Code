...
description: Use when tasks require klaviyo approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Klaviyo Approval Router

## Purpose
Design and execute klaviyo workflows using approval router controls with validated outcomes.
