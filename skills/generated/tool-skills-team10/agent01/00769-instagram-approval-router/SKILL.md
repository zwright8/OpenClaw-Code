...
description: Use when tasks require instagram approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Instagram Approval Router

## Purpose
Design and execute instagram workflows using approval router controls with validated outcomes.
