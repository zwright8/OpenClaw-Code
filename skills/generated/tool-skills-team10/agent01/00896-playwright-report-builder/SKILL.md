...
description: Use when tasks require playwright report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Playwright Report Builder

## Purpose
Design and execute playwright workflows using report builder controls with validated outcomes.
