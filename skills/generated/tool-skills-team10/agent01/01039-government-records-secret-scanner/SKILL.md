---
name: government-records-secret-scanner
description: Use when tasks require government records secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Secret Scanner

## Purpose
Design and execute government records workflows using secret scanner controls with validated outcomes.
