---
name: patent-filings-feedback-harvester
description: Use when tasks require patent filings feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Feedback Harvester

## Purpose
Design and execute patent filings workflows using feedback harvester controls with validated outcomes.
