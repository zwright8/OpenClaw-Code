...
description: Use when tasks require twilio connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Twilio Connector

## Purpose
Design and execute twilio workflows using connector controls with validated outcomes.
