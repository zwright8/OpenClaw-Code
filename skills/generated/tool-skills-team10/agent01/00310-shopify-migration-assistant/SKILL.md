...
description: Use when tasks require shopify migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Shopify Migration Assistant

## Purpose
Design and execute shopify workflows using migration assistant controls with validated outcomes.
