...
description: Use when tasks require postmark workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Postmark Workflow Automator

## Purpose
Design and execute postmark workflows using workflow automator controls with validated outcomes.
