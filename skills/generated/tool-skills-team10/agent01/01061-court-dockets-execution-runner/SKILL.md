---
name: court-dockets-execution-runner
description: Use when tasks require court dockets execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Execution Runner

## Purpose
Design and execute court dockets workflows using execution runner controls with validated outcomes.
