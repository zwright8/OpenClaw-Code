...
description: Use when tasks require linear migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Linear Migration Assistant

## Purpose
Design and execute linear workflows using migration assistant controls with validated outcomes.
...
- Domain: [Linear](../../resources/domains/linear.md)
