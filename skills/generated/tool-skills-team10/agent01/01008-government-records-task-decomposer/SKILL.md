---
name: government-records-task-decomposer
description: Use when tasks require government records task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Task Decomposer

## Purpose
Design and execute government records workflows using task decomposer controls with validated outcomes.
