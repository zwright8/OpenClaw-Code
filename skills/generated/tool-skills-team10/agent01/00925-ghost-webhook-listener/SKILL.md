...
description: Use when tasks require ghost webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ghost Webhook Listener

## Purpose
Design and execute ghost workflows using webhook listener controls with validated outcomes.
