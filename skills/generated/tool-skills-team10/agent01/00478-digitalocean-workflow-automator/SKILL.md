...
description: Use when tasks require digitalocean workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# DigitalOcean Workflow Automator

## Purpose
Design and execute digitalocean workflows using workflow automator controls with validated outcomes.
