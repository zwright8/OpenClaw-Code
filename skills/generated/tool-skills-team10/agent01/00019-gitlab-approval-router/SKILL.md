...
description: Use when tasks require gitlab approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitLab Approval Router

## Purpose
Design and execute gitlab workflows using approval router controls with validated outcomes.
