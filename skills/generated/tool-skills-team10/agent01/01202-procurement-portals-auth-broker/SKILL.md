---
name: procurement-portals-auth-broker
description: Use when tasks require procurement portals auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Auth Broker

## Purpose
Design and execute procurement portals workflows using auth broker controls with validated outcomes.
