---
name: healthcare-ehr-auth-broker
description: Use when tasks require healthcare ehr auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Auth Broker

## Purpose
Design and execute healthcare ehr workflows using auth broker controls with validated outcomes.
