---
name: government-records-capacity-planner
description: Use when tasks require government records capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Capacity Planner

## Purpose
Design and execute government records workflows using capacity planner controls with validated outcomes.
