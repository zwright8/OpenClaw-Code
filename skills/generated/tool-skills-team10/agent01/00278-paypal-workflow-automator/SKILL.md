...
description: Use when tasks require paypal workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# PayPal Workflow Automator

## Purpose
Design and execute paypal workflows using workflow automator controls with validated outcomes.
