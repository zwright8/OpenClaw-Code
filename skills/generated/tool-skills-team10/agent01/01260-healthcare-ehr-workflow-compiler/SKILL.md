---
name: healthcare-ehr-workflow-compiler
description: Use when tasks require healthcare ehr workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Workflow Compiler

## Purpose
Design and execute healthcare ehr workflows using workflow compiler controls with validated outcomes.
