...
description: Use when tasks require sendgrid report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SendGrid Report Builder

## Purpose
Design and execute sendgrid workflows using report builder controls with validated outcomes.
