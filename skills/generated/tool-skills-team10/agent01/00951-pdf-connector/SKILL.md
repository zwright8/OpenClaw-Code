---
name: pdf-connector
description: Use when tasks require pdf connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# PDF Connector

## Purpose
Design and execute pdf workflows using connector controls with validated outcomes.
