---
name: procurement-portals-anomaly-detector
description: Use when tasks require procurement portals anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Anomaly Detector

## Purpose
Design and execute procurement portals workflows using anomaly detector controls with validated outcomes.
