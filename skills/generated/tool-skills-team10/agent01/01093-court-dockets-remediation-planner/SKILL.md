---
name: court-dockets-remediation-planner
description: Use when tasks require court dockets remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Remediation Planner

## Purpose
Design and execute court dockets workflows using remediation planner controls with validated outcomes.
