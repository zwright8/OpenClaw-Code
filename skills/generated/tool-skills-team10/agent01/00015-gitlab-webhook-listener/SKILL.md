...
description: Use when tasks require gitlab webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitLab Webhook Listener

## Purpose
Design and execute gitlab workflows using webhook listener controls with validated outcomes.
