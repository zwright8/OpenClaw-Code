---
name: compliance-registries-permission-mapper
description: Use when tasks require compliance registries permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Permission Mapper

## Purpose
Design and execute compliance registries workflows using permission mapper controls with validated outcomes.
