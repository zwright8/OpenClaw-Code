---
name: patent-filings-task-decomposer
description: Use when tasks require patent filings task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Task Decomposer

## Purpose
Design and execute patent filings workflows using task decomposer controls with validated outcomes.
