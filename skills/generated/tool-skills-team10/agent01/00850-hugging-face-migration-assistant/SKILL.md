...
description: Use when tasks require hugging face migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hugging Face Migration Assistant

## Purpose
Design and execute hugging face workflows using migration assistant controls with validated outcomes.
...
- Domain: [Hugging Face](../../resources/domains/hugging-face.md)
