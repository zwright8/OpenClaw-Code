...
description: Use when tasks require outlook data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Outlook Data Importer

## Purpose
Design and execute outlook workflows using data importer controls with validated outcomes.
