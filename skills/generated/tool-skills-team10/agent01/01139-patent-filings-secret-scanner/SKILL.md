---
name: patent-filings-secret-scanner
description: Use when tasks require patent filings secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Secret Scanner

## Purpose
Design and execute patent filings workflows using secret scanner controls with validated outcomes.
