...
description: Use when tasks require json report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# JSON Report Builder

## Purpose
Design and execute json workflows using report builder controls with validated outcomes.
