...
description: Use when tasks require hubspot report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# HubSpot Report Builder

## Purpose
Design and execute hubspot workflows using report builder controls with validated outcomes.
