...
description: Use when tasks require confluence webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Confluence Webhook Listener

## Purpose
Design and execute confluence workflows using webhook listener controls with validated outcomes.
