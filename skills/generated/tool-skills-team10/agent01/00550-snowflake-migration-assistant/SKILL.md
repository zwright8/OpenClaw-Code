...
description: Use when tasks require snowflake migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Snowflake Migration Assistant

## Purpose
Design and execute snowflake workflows using migration assistant controls with validated outcomes.
