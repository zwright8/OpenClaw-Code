...
description: Use when tasks require new relic data exporter with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# New Relic Data Exporter

## Purpose
Design and execute new relic workflows using data exporter controls with validated outcomes.
