---
name: patent-filings-budget-guardrail
description: Use when tasks require patent filings budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Budget Guardrail

## Purpose
Design and execute patent filings workflows using budget guardrail controls with validated outcomes.
