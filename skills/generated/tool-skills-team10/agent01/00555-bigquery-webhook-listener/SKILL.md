...
description: Use when tasks require bigquery webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BigQuery Webhook Listener

## Purpose
Design and execute bigquery workflows using webhook listener controls with validated outcomes.
