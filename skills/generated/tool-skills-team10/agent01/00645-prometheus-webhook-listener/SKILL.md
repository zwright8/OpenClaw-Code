...
description: Use when tasks require prometheus webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prometheus Webhook Listener

## Purpose
Design and execute prometheus workflows using webhook listener controls with validated outcomes.
