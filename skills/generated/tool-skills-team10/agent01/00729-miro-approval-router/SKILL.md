...
description: Use when tasks require miro approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Miro Approval Router

## Purpose
Design and execute miro workflows using approval router controls with validated outcomes.
