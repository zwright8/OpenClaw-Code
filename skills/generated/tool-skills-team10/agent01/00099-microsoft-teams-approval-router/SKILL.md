...
description: Use when tasks require microsoft teams approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Microsoft Teams Approval Router

## Purpose
Design and execute microsoft teams workflows using approval router controls with validated outcomes.
