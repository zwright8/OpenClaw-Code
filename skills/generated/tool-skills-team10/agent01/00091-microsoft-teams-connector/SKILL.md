...
description: Use when tasks require microsoft teams connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Microsoft Teams Connector

## Purpose
Design and execute microsoft teams workflows using connector controls with validated outcomes.
