---
name: court-dockets-capacity-planner
description: Use when tasks require court dockets capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Capacity Planner

## Purpose
Design and execute court dockets workflows using capacity planner controls with validated outcomes.
