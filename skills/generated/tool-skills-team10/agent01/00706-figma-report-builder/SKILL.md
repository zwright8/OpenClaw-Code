...
description: Use when tasks require figma report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Figma Report Builder

## Purpose
Design and execute figma workflows using report builder controls with validated outcomes.
