...
description: Use when tasks require elevenlabs workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ElevenLabs Workflow Automator

## Purpose
Design and execute elevenlabs workflows using workflow automator controls with validated outcomes.
