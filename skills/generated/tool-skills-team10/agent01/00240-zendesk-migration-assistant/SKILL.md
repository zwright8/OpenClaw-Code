...
description: Use when tasks require zendesk migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Zendesk Migration Assistant

## Purpose
Design and execute zendesk workflows using migration assistant controls with validated outcomes.
...
- Domain: [Zendesk](../../resources/domains/zendesk.md)
