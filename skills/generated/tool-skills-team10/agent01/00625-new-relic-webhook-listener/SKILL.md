...
description: Use when tasks require new relic webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# New Relic Webhook Listener

## Purpose
Design and execute new relic workflows using webhook listener controls with validated outcomes.
