...
description: Use when tasks require paypal connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# PayPal Connector

## Purpose
Design and execute paypal workflows using connector controls with validated outcomes.
