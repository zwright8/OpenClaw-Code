...
description: Use when tasks require opensearch migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# OpenSearch Migration Assistant

## Purpose
Design and execute opensearch workflows using migration assistant controls with validated outcomes.
