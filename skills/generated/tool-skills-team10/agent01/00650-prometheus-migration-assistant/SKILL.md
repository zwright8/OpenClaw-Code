...
description: Use when tasks require prometheus migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prometheus Migration Assistant

## Purpose
Design and execute prometheus workflows using migration assistant controls with validated outcomes.
...
- Domain: [Prometheus](../../resources/domains/prometheus.md)
