...
description: Use when tasks require salesforce report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Salesforce Report Builder

## Purpose
Design and execute salesforce workflows using report builder controls with validated outcomes.
