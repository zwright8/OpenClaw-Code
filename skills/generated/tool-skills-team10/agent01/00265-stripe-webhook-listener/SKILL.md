...
description: Use when tasks require stripe webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Stripe Webhook Listener

## Purpose
Design and execute stripe workflows using webhook listener controls with validated outcomes.
