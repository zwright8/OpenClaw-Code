...
description: Use when tasks require csv workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CSV Workflow Automator

## Purpose
Design and execute csv workflows using workflow automator controls with validated outcomes.
