---
name: sora-connector
description: Use when tasks require sora connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sora Connector

## Purpose
Design and execute sora workflows using connector controls with validated outcomes.
