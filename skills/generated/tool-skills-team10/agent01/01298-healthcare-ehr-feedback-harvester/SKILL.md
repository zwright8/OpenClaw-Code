---
name: healthcare-ehr-feedback-harvester
description: Use when tasks require healthcare ehr feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Feedback Harvester

## Purpose
Design and execute healthcare ehr workflows using feedback harvester controls with validated outcomes.
