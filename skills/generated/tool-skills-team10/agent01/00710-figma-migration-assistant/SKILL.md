...
description: Use when tasks require figma migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Figma Migration Assistant

## Purpose
Design and execute figma workflows using migration assistant controls with validated outcomes.
...
- Domain: [Figma](../../resources/domains/figma.md)
