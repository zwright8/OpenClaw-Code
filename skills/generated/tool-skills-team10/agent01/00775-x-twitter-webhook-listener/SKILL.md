...
description: Use when tasks require x twitter webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# X Twitter Webhook Listener

## Purpose
Design and execute x twitter workflows using webhook listener controls with validated outcomes.
