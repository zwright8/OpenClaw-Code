...
description: Use when tasks require compliance registries anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Anomaly Detector

## Purpose
Design and execute compliance registries workflows using anomaly detector controls with validated outcomes.
