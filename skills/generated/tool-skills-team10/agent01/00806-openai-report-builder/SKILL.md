...
description: Use when tasks require openai report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# OpenAI Report Builder

## Purpose
Design and execute openai workflows using report builder controls with validated outcomes.
