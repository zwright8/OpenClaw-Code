...
description: Use when tasks require bitbucket approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bitbucket Approval Router

## Purpose
Design and execute bitbucket workflows using approval router controls with validated outcomes.
