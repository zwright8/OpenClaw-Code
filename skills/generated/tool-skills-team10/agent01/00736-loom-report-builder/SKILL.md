...
description: Use when tasks require loom report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Loom Report Builder

## Purpose
Design and execute loom workflows using report builder controls with validated outcomes.
