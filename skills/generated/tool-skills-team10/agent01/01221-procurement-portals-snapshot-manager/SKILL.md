---
name: procurement-portals-snapshot-manager
description: Use when tasks require procurement portals snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Snapshot Manager

## Purpose
Design and execute procurement portals workflows using snapshot manager controls with validated outcomes.
