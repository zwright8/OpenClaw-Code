...
description: Use when tasks require onedrive migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# OneDrive Migration Assistant

## Purpose
Design and execute onedrive workflows using migration assistant controls with validated outcomes.
...
- Domain: [OneDrive](../../resources/domains/onedrive.md)
