---
name: government-records-auth-broker
description: Use when tasks require government records auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Auth Broker

## Purpose
Design and execute government records workflows using auth broker controls with validated outcomes.
