...
description: Use when tasks require mysql approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# MySQL Approval Router

## Purpose
Design and execute mysql workflows using approval router controls with validated outcomes.
