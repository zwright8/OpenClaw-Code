---
name: healthcare-ehr-capacity-planner
description: Use when tasks require healthcare ehr capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Capacity Planner

## Purpose
Design and execute healthcare ehr workflows using capacity planner controls with validated outcomes.
