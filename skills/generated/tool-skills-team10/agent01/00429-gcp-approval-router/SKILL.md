...
description: Use when tasks require gcp approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GCP Approval Router

## Purpose
Design and execute gcp workflows using approval router controls with validated outcomes.
