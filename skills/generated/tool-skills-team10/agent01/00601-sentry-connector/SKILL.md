...
description: Use when tasks require sentry connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sentry Connector

## Purpose
Design and execute sentry workflows using connector controls with validated outcomes.
