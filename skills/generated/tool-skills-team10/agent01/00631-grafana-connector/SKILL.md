...
description: Use when tasks require grafana connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grafana Connector

## Purpose
Design and execute grafana workflows using connector controls with validated outcomes.
