...
description: Use when tasks require bitbucket workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bitbucket Workflow Automator

## Purpose
Design and execute bitbucket workflows using workflow automator controls with validated outcomes.
