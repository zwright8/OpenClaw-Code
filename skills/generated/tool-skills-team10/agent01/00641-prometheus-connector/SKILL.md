...
description: Use when tasks require prometheus connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prometheus Connector

## Purpose
Design and execute prometheus workflows using connector controls with validated outcomes.
