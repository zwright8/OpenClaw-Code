...
description: Use when tasks require intercom data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Intercom Data Importer

## Purpose
Design and execute intercom workflows using data importer controls with validated outcomes.
