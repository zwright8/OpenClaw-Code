...
description: Use when tasks require sendgrid migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SendGrid Migration Assistant

## Purpose
Design and execute sendgrid workflows using migration assistant controls with validated outcomes.
...
- Domain: [SendGrid](../../resources/domains/sendgrid.md)
