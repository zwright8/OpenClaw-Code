---
name: loom-connector
description: Use when tasks require loom connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Loom Connector

## Purpose
Design and execute loom workflows using connector controls with validated outcomes.
