---
name: procurement-portals-human-handoff-router
description: Use when tasks require procurement portals human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Human Handoff Router

## Purpose
Design and execute procurement portals workflows using human handoff router controls with validated outcomes.
