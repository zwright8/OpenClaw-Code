...
description: Use when tasks require ghost approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ghost Approval Router

## Purpose
Design and execute ghost workflows using approval router controls with validated outcomes.
