...
description: Use when tasks require gmail report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Gmail Report Builder

## Purpose
Design and execute gmail workflows using report builder controls with validated outcomes.
