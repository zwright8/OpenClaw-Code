...
description: Use when tasks require mailchimp report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mailchimp Report Builder

## Purpose
Design and execute mailchimp workflows using report builder controls with validated outcomes.
