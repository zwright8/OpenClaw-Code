...
description: Use when tasks require canva workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Canva Workflow Automator

## Purpose
Design and execute canva workflows using workflow automator controls with validated outcomes.
