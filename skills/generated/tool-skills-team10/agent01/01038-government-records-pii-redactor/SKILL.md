---
name: government-records-pii-redactor
description: Use when tasks require government records pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records PII Redactor

## Purpose
Design and execute government records workflows using pii redactor controls with validated outcomes.
