...
description: Use when tasks require xero approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Xero Approval Router

## Purpose
Design and execute xero workflows using approval router controls with validated outcomes.
