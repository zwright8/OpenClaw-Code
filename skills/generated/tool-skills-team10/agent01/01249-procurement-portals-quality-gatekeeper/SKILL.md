---
name: procurement-portals-quality-gatekeeper
description: Use when tasks require procurement portals quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Quality Gatekeeper

## Purpose
Design and execute procurement portals workflows using quality gatekeeper controls with validated outcomes.
