---
name: healthcare-ehr-secret-scanner
description: Use when tasks require healthcare ehr secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Secret Scanner

## Purpose
Design and execute healthcare ehr workflows using secret scanner controls with validated outcomes.
