...
description: Use when tasks require pagerduty workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# PagerDuty Workflow Automator

## Purpose
Design and execute pagerduty workflows using workflow automator controls with validated outcomes.
