...
description: Use when tasks require substack webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Substack Webhook Listener

## Purpose
Design and execute substack workflows using webhook listener controls with validated outcomes.
