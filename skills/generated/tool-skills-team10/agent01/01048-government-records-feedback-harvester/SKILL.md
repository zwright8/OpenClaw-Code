...
description: Use when tasks require government records feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Feedback Harvester

## Purpose
Design and execute government records workflows using feedback harvester controls with validated outcomes.
