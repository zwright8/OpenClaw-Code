...
description: Use when tasks require intercom migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Intercom Migration Assistant

## Purpose
Design and execute intercom workflows using migration assistant controls with validated outcomes.
...
- Domain: [Intercom](../../resources/domains/intercom.md)
