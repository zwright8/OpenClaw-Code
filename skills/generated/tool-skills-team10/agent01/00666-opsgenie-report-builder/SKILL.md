...
description: Use when tasks require opsgenie report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Opsgenie Report Builder

## Purpose
Design and execute opsgenie workflows using report builder controls with validated outcomes.
