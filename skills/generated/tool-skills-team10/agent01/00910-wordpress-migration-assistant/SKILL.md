...
description: Use when tasks require wordpress migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# WordPress Migration Assistant

## Purpose
Design and execute wordpress workflows using migration assistant controls with validated outcomes.
