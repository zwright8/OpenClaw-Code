---
name: patent-filings-postmortem-drafting
description: Use when tasks require patent filings postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Postmortem Drafting

## Purpose
Design and execute patent filings workflows using postmortem drafting controls with validated outcomes.
