---
name: patent-filings-conflict-resolver
description: Use when tasks require patent filings conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Conflict Resolver

## Purpose
Design and execute patent filings workflows using conflict resolver controls with validated outcomes.
