---
name: government-records-execution-runner
description: Use when tasks require government records execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Execution Runner

## Purpose
Design and execute government records workflows using execution runner controls with validated outcomes.
