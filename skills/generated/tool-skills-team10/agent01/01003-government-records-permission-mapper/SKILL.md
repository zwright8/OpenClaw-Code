---
name: government-records-permission-mapper
description: Use when tasks require government records permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Permission Mapper

## Purpose
Design and execute government records workflows using permission mapper controls with validated outcomes.
