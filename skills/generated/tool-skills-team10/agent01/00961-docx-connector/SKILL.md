---
name: docx-connector
description: Use when tasks require docx connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# DOCX Connector

## Purpose
Design and execute docx workflows using connector controls with validated outcomes.
