...
description: Use when tasks require ghost workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ghost Workflow Automator

## Purpose
Design and execute ghost workflows using workflow automator controls with validated outcomes.
