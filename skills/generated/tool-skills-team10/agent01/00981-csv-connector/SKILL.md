---
name: csv-connector
description: Use when tasks require csv connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CSV Connector

## Purpose
Design and execute csv workflows using connector controls with validated outcomes.
