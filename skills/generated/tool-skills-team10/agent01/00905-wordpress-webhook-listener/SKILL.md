...
description: Use when tasks require wordpress webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# WordPress Webhook Listener

## Purpose
Design and execute wordpress workflows using webhook listener controls with validated outcomes.
