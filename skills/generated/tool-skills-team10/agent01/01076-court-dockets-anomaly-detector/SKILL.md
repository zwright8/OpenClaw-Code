---
name: court-dockets-anomaly-detector
description: Use when tasks require court dockets anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Anomaly Detector

## Purpose
Design and execute court dockets workflows using anomaly detector controls with validated outcomes.
