---
name: compliance-registries-provenance-tracker
description: Use when tasks require compliance registries provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Provenance Tracker

## Purpose
Design and execute compliance registries workflows using provenance tracker controls with validated outcomes.
