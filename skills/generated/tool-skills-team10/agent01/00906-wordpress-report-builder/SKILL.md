...
description: Use when tasks require wordpress report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# WordPress Report Builder

## Purpose
Design and execute wordpress workflows using report builder controls with validated outcomes.
