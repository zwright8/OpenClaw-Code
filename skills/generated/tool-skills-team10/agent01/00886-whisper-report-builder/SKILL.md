...
description: Use when tasks require whisper report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Whisper Report Builder

## Purpose
Design and execute whisper workflows using report builder controls with validated outcomes.
