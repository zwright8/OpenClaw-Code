---
name: procurement-portals-root-cause-miner
description: Use when tasks require procurement portals root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Root Cause Miner

## Purpose
Design and execute procurement portals workflows using root cause miner controls with validated outcomes.
