...
description: Use when tasks require shopify report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Shopify Report Builder

## Purpose
Design and execute shopify workflows using report builder controls with validated outcomes.
