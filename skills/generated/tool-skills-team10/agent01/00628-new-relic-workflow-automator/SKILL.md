...
description: Use when tasks require new relic workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# New Relic Workflow Automator

## Purpose
Design and execute new relic workflows using workflow automator controls with validated outcomes.
...
- Domain: [New Relic](../../resources/domains/new-relic.md)
