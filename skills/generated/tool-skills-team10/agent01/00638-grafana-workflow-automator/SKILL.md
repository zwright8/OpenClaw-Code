...
description: Use when tasks require grafana workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grafana Workflow Automator

## Purpose
Design and execute grafana workflows using workflow automator controls with validated outcomes.
