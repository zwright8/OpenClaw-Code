...
description: Use when tasks require onedrive connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# OneDrive Connector

## Purpose
Design and execute onedrive workflows using connector controls with validated outcomes.
