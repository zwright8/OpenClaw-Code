...
description: Use when tasks require azure migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Azure Migration Assistant

## Purpose
Design and execute azure workflows using migration assistant controls with validated outcomes.
