...
description: Use when tasks require gmail connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Gmail Connector

## Purpose
Design and execute gmail workflows using connector controls with validated outcomes.
