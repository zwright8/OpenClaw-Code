---
name: court-dockets-auth-broker
description: Use when tasks require court dockets auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Auth Broker

## Purpose
Design and execute court dockets workflows using auth broker controls with validated outcomes.
