...
description: Use when tasks require linear approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Linear Approval Router

## Purpose
Design and execute linear workflows using approval router controls with validated outcomes.
