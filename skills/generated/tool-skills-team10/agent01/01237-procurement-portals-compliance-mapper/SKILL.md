---
name: procurement-portals-compliance-mapper
description: Use when tasks require procurement portals compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Compliance Mapper

## Purpose
Design and execute procurement portals workflows using compliance mapper controls with validated outcomes.
