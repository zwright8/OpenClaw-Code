---
name: court-dockets-postmortem-drafting
description: Use when tasks require court dockets postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Postmortem Drafting

## Purpose
Design and execute court dockets workflows using postmortem drafting controls with validated outcomes.
