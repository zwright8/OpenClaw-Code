---
name: patent-filings-root-cause-miner
description: Use when tasks require patent filings root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Root Cause Miner

## Purpose
Design and execute patent filings workflows using root cause miner controls with validated outcomes.
