...
description: Use when tasks require intercom workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Intercom Workflow Automator

## Purpose
Design and execute intercom workflows using workflow automator controls with validated outcomes.
