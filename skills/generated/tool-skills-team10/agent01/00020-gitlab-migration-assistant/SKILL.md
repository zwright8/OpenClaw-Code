...
description: Use when tasks require gitlab migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitLab Migration Assistant

## Purpose
Design and execute gitlab workflows using migration assistant controls with validated outcomes.
...
- Domain: [GitLab](../../resources/domains/gitlab.md)
