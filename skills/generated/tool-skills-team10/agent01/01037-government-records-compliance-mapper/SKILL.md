---
name: government-records-compliance-mapper
description: Use when tasks require government records compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Compliance Mapper

## Purpose
Design and execute government records workflows using compliance mapper controls with validated outcomes.
