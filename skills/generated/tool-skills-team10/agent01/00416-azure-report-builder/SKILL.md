...
description: Use when tasks require azure report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Azure Report Builder

## Purpose
Design and execute azure workflows using report builder controls with validated outcomes.
