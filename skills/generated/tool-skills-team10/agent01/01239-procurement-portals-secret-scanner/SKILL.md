---
name: procurement-portals-secret-scanner
description: Use when tasks require procurement portals secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Secret Scanner

## Purpose
Design and execute procurement portals workflows using secret scanner controls with validated outcomes.
