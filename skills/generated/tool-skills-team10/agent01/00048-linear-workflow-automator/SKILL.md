...
description: Use when tasks require linear workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Linear Workflow Automator

## Purpose
Design and execute linear workflows using workflow automator controls with validated outcomes.
