...
description: Use when tasks require json approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# JSON Approval Router

## Purpose
Design and execute json workflows using approval router controls with validated outcomes.
