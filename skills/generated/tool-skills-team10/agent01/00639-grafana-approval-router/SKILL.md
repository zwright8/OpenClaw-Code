...
description: Use when tasks require grafana approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grafana Approval Router

## Purpose
Design and execute grafana workflows using approval router controls with validated outcomes.
