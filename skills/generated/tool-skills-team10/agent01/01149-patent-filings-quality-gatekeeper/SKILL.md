---
name: patent-filings-quality-gatekeeper
description: Use when tasks require patent filings quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Quality Gatekeeper

## Purpose
Design and execute patent filings workflows using quality gatekeeper controls with validated outcomes.
