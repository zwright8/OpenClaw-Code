---
name: patent-filings-retry-governor
description: Use when tasks require patent filings retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Retry Governor

## Purpose
Design and execute patent filings workflows using retry governor controls with validated outcomes.
