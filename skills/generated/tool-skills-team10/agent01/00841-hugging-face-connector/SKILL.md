...
description: Use when tasks require hugging face connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hugging Face Connector

## Purpose
Design and execute hugging face workflows using connector controls with validated outcomes.
