...
description: Use when tasks require sora webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sora Webhook Listener

## Purpose
Design and execute sora workflows using webhook listener controls with validated outcomes.
