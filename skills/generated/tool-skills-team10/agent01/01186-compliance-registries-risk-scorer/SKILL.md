---
name: compliance-registries-risk-scorer
description: Use when tasks require compliance registries risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Risk Scorer

## Purpose
Design and execute compliance registries workflows using risk scorer controls with validated outcomes.
