...
description: Use when tasks require elevenlabs approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ElevenLabs Approval Router

## Purpose
Design and execute elevenlabs workflows using approval router controls with validated outcomes.
