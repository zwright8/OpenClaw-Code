...
description: Use when tasks require playwright data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Playwright Data Importer

## Purpose
Design and execute playwright workflows using data importer controls with validated outcomes.
