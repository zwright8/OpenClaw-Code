...
description: Use when tasks require slack migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Slack Migration Assistant

## Purpose
Design and execute slack workflows using migration assistant controls with validated outcomes.
...
- Domain: [Slack](../../resources/domains/slack.md)
