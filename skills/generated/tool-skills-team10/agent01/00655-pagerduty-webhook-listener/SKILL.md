...
description: Use when tasks require pagerduty webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# PagerDuty Webhook Listener

## Purpose
Design and execute pagerduty workflows using webhook listener controls with validated outcomes.
