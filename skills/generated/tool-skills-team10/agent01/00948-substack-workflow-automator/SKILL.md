...
description: Use when tasks require substack workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Substack Workflow Automator

## Purpose
Design and execute substack workflows using workflow automator controls with validated outcomes.
