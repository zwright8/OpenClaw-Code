---
name: court-dockets-task-decomposer
description: Use when tasks require court dockets task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Task Decomposer

## Purpose
Design and execute court dockets workflows using task decomposer controls with validated outcomes.
