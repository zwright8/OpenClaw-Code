---
name: healthcare-ehr-artifact-publisher
description: Use when tasks require healthcare ehr artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Artifact Publisher

## Purpose
Design and execute healthcare ehr workflows using artifact publisher controls with validated outcomes.
