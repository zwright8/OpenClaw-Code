---
name: court-dockets-spec-drift-detector
description: Use when tasks require court dockets spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Spec Drift Detector

## Purpose
Design and execute court dockets workflows using spec drift detector controls with validated outcomes.
