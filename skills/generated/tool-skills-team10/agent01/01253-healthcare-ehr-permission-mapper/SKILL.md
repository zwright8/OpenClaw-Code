---
name: healthcare-ehr-permission-mapper
description: Use when tasks require healthcare ehr permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Permission Mapper

## Purpose
Design and execute healthcare ehr workflows using permission mapper controls with validated outcomes.
