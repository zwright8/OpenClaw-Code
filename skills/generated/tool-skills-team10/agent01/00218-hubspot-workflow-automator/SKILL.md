...
description: Use when tasks require hubspot workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# HubSpot Workflow Automator

## Purpose
Design and execute hubspot workflows using workflow automator controls with validated outcomes.
