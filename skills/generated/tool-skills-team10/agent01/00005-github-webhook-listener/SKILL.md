...
description: Use when tasks require github webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitHub Webhook Listener

## Purpose
Design and execute github workflows using webhook listener controls with validated outcomes.
