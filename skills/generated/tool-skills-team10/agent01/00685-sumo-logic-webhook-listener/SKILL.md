...
description: Use when tasks require sumo logic webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sumo Logic Webhook Listener

## Purpose
Design and execute sumo logic workflows using webhook listener controls with validated outcomes.
