...
description: Use when tasks require freshdesk migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freshdesk Migration Assistant

## Purpose
Design and execute freshdesk workflows using migration assistant controls with validated outcomes.
...
- Domain: [Freshdesk](../../resources/domains/freshdesk.md)
