---
name: court-dockets-evidence-collector
description: Use when tasks require court dockets evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Evidence Collector

## Purpose
Design and execute court dockets workflows using evidence collector controls with validated outcomes.
