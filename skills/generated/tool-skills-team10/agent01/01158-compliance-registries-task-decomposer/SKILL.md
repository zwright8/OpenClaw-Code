---
name: compliance-registries-task-decomposer
description: Use when tasks require compliance registries task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Task Decomposer

## Purpose
Design and execute compliance registries workflows using task decomposer controls with validated outcomes.
