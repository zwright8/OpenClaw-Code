---
name: compliance-registries-migration-planner
description: Use when tasks require compliance registries migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Migration Planner

## Purpose
Design and execute compliance registries workflows using migration planner controls with validated outcomes.
