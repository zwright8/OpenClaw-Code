---
name: healthcare-ehr-policy-evaluator
description: Use when tasks require healthcare ehr policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Policy Evaluator

## Purpose
Design and execute healthcare ehr workflows using policy evaluator controls with validated outcomes.
