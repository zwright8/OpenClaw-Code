---
name: healthcare-ehr-quality-gatekeeper
description: Use when tasks require healthcare ehr quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Quality Gatekeeper

## Purpose
Design and execute healthcare ehr workflows using quality gatekeeper controls with validated outcomes.
