...
description: Use when tasks require bitbucket webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bitbucket Webhook Listener

## Purpose
Design and execute bitbucket workflows using webhook listener controls with validated outcomes.
