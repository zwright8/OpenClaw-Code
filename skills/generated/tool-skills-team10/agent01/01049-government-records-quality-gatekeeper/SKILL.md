---
name: government-records-quality-gatekeeper
description: Use when tasks require government records quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Quality Gatekeeper

## Purpose
Design and execute government records workflows using quality gatekeeper controls with validated outcomes.
