...
description: Use when tasks require opsgenie approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Opsgenie Approval Router

## Purpose
Design and execute opsgenie workflows using approval router controls with validated outcomes.
