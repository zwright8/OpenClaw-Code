...
description: Use when tasks require opsgenie webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Opsgenie Webhook Listener

## Purpose
Design and execute opsgenie workflows using webhook listener controls with validated outcomes.
