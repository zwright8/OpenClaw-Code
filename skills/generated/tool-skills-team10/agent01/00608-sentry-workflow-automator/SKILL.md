...
description: Use when tasks require sentry workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sentry Workflow Automator

## Purpose
Design and execute sentry workflows using workflow automator controls with validated outcomes.
