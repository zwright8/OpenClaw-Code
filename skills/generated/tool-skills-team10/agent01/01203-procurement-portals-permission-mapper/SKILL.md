---
name: procurement-portals-permission-mapper
description: Use when tasks require procurement portals permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Permission Mapper

## Purpose
Design and execute procurement portals workflows using permission mapper controls with validated outcomes.
