...
description: Use when tasks require github report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitHub Report Builder

## Purpose
Design and execute github workflows using report builder controls with validated outcomes.
