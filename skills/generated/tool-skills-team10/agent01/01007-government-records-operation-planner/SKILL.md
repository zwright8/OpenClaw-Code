---
name: government-records-operation-planner
description: Use when tasks require government records operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Operation Planner

## Purpose
Design and execute government records workflows using operation planner controls with validated outcomes.
