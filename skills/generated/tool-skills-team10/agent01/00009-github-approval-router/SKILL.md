...
description: Use when tasks require github approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitHub Approval Router

## Purpose
Design and execute github workflows using approval router controls with validated outcomes.
