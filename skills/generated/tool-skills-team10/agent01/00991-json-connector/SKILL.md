---
name: json-connector
description: Use when tasks require json connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# JSON Connector

## Purpose
Design and execute json workflows using connector controls with validated outcomes.
