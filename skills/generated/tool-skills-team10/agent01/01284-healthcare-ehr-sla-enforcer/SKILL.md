---
name: healthcare-ehr-sla-enforcer
description: Use when tasks require healthcare ehr sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR SLA Enforcer

## Purpose
Design and execute healthcare ehr workflows using sla enforcer controls with validated outcomes.
