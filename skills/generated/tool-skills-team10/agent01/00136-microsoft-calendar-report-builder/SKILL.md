...
description: Use when tasks require microsoft calendar report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Microsoft Calendar Report Builder

## Purpose
Design and execute microsoft calendar workflows using report builder controls with validated outcomes.
...
4. Execute report builder actions with minimal blast radius.
...
- Capability: [Report Builder](../../resources/capabilities/report-builder.md)
