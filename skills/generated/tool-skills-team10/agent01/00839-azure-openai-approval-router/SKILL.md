...
description: Use when tasks require azure openai approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Azure OpenAI Approval Router

## Purpose
Design and execute azure openai workflows using approval router controls with validated outcomes.
