...
description: Use when tasks require clickhouse report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ClickHouse Report Builder

## Purpose
Design and execute clickhouse workflows using report builder controls with validated outcomes.
