...
description: Use when tasks require figma webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Figma Webhook Listener

## Purpose
Design and execute figma workflows using webhook listener controls with validated outcomes.
