...
description: Use when tasks require sora alert monitor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sora Alert Monitor

## Purpose
Design and execute sora workflows using alert monitor controls with validated outcomes.
