---
name: patent-filings-access-auditor
description: Use when tasks require patent filings access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Access Auditor

## Purpose
Design and execute patent filings workflows using access auditor controls with validated outcomes.
