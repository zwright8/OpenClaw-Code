---
name: government-records-access-auditor
description: Use when tasks require government records access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Access Auditor

## Purpose
Design and execute government records workflows using access auditor controls with validated outcomes.
