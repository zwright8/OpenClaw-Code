...
description: Use when tasks require ghost connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ghost Connector

## Purpose
Design and execute ghost workflows using connector controls with validated outcomes.
