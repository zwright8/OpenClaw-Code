---
name: healthcare-ehr-rate-limit-optimizer
description: Use when tasks require healthcare ehr rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Rate Limit Optimizer

## Purpose
Design and execute healthcare ehr workflows using rate limit optimizer controls with validated outcomes.
