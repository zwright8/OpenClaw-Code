...
description: Use when tasks require ghost data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ghost Data Importer

## Purpose
Design and execute ghost workflows using data importer controls with validated outcomes.
