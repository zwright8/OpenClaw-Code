---
name: healthcare-ehr-snapshot-manager
description: Use when tasks require healthcare ehr snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Snapshot Manager

## Purpose
Design and execute healthcare ehr workflows using snapshot manager controls with validated outcomes.
