...
description: Use when tasks require onedrive webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# OneDrive Webhook Listener

## Purpose
Design and execute onedrive workflows using webhook listener controls with validated outcomes.
