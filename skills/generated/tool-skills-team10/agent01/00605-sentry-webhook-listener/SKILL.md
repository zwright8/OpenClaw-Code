...
description: Use when tasks require sentry webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sentry Webhook Listener

## Purpose
Design and execute sentry workflows using webhook listener controls with validated outcomes.
