...
description: Use when tasks require sora workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sora Workflow Automator

## Purpose
Design and execute sora workflows using workflow automator controls with validated outcomes.
