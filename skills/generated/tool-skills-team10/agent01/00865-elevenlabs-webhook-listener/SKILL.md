...
description: Use when tasks require elevenlabs webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ElevenLabs Webhook Listener

## Purpose
Design and execute elevenlabs workflows using webhook listener controls with validated outcomes.
