...
description: Use when tasks require figma data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Figma Data Importer

## Purpose
Design and execute figma workflows using data importer controls with validated outcomes.
