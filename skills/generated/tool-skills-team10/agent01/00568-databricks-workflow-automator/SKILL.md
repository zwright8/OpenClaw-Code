...
description: Use when tasks require databricks workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Databricks Workflow Automator

## Purpose
Design and execute databricks workflows using workflow automator controls with validated outcomes.
