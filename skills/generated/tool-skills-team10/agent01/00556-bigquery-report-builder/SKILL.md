...
description: Use when tasks require bigquery report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BigQuery Report Builder

## Purpose
Design and execute bigquery workflows using report builder controls with validated outcomes.
