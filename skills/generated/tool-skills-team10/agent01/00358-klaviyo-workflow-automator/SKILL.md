...
description: Use when tasks require klaviyo workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Klaviyo Workflow Automator

## Purpose
Design and execute klaviyo workflows using workflow automator controls with validated outcomes.
