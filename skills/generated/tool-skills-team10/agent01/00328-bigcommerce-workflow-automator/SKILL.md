...
description: Use when tasks require bigcommerce workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BigCommerce Workflow Automator

## Purpose
Design and execute bigcommerce workflows using workflow automator controls with validated outcomes.
