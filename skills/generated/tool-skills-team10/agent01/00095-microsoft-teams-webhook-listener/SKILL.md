...
description: Use when tasks require microsoft teams webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Microsoft Teams Webhook Listener

## Purpose
Design and execute microsoft teams workflows using webhook listener controls with validated outcomes.
