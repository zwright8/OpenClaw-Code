---
name: government-records-policy-evaluator
description: Use when tasks require government records policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Policy Evaluator

## Purpose
Design and execute government records workflows using policy evaluator controls with validated outcomes.
