...
description: Use when tasks require salesforce data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Salesforce Data Importer

## Purpose
Design and execute salesforce workflows using data importer controls with validated outcomes.
