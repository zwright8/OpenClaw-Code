...
description: Use when tasks require opensearch approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# OpenSearch Approval Router

## Purpose
Design and execute opensearch workflows using approval router controls with validated outcomes.
