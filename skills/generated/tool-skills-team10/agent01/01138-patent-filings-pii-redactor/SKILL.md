---
name: patent-filings-pii-redactor
description: Use when tasks require patent filings pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings PII Redactor

## Purpose
Design and execute patent filings workflows using pii redactor controls with validated outcomes.
