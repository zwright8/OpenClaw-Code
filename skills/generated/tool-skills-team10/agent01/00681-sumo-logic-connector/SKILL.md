...
description: Use when tasks require sumo logic connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sumo Logic Connector

## Purpose
Design and execute sumo logic workflows using connector controls with validated outcomes.
