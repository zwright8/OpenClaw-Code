---
name: compliance-registries-workflow-compiler
description: Use when tasks require compliance registries workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Workflow Compiler

## Purpose
Design and execute compliance registries workflows using workflow compiler controls with validated outcomes.
