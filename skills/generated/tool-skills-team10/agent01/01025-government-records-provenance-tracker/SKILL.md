---
name: government-records-provenance-tracker
description: Use when tasks require government records provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Provenance Tracker

## Purpose
Design and execute government records workflows using provenance tracker controls with validated outcomes.
