...
description: Use when tasks require substack connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Substack Connector

## Purpose
Design and execute substack workflows using connector controls with validated outcomes.
