...
description: Use when tasks require sendgrid webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SendGrid Webhook Listener

## Purpose
Design and execute sendgrid workflows using webhook listener controls with validated outcomes.
