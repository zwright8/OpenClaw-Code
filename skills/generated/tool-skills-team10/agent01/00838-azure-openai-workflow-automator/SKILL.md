...
description: Use when tasks require azure openai workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Azure OpenAI Workflow Automator

## Purpose
Design and execute azure openai workflows using workflow automator controls with validated outcomes.
