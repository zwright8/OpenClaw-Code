...
description: Use when tasks require elevenlabs report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ElevenLabs Report Builder

## Purpose
Design and execute elevenlabs workflows using report builder controls with validated outcomes.
