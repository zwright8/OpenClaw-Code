---
name: court-dockets-migration-planner
description: Use when tasks require court dockets migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Migration Planner

## Purpose
Design and execute court dockets workflows using migration planner controls with validated outcomes.
