...
description: Use when tasks require splunk migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Splunk Migration Assistant

## Purpose
Design and execute splunk workflows using migration assistant controls with validated outcomes.
...
- Domain: [Splunk](../../resources/domains/splunk.md)
