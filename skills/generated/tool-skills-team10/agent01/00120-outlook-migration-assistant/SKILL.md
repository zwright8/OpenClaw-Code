...
description: Use when tasks require outlook migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Outlook Migration Assistant

## Purpose
Design and execute outlook workflows using migration assistant controls with validated outcomes.
...
- Domain: [Outlook](../../resources/domains/outlook.md)
