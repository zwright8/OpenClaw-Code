---
name: patent-filings-evidence-collector
description: Use when tasks require patent filings evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Evidence Collector

## Purpose
Design and execute patent filings workflows using evidence collector controls with validated outcomes.
