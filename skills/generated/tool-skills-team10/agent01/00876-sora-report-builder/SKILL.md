...
description: Use when tasks require sora report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sora Report Builder

## Purpose
Design and execute sora workflows using report builder controls with validated outcomes.
