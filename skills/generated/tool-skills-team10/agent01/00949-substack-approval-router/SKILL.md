...
description: Use when tasks require substack approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Substack Approval Router

## Purpose
Design and execute substack workflows using approval router controls with validated outcomes.
