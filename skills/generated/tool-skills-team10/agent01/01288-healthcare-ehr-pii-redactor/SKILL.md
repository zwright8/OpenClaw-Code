---
name: healthcare-ehr-pii-redactor
description: Use when tasks require healthcare ehr pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR PII Redactor

## Purpose
Design and execute healthcare ehr workflows using pii redactor controls with validated outcomes.
