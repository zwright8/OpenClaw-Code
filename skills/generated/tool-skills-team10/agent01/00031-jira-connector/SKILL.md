---
name: jira-connector
description: Use when tasks require jira connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Jira Connector

## Purpose
Design and execute jira workflows using connector controls with validated outcomes.
