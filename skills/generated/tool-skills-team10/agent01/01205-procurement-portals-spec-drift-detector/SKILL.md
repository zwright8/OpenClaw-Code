---
name: procurement-portals-spec-drift-detector
description: Use when tasks require procurement portals spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Spec Drift Detector

## Purpose
Design and execute procurement portals workflows using spec drift detector controls with validated outcomes.
