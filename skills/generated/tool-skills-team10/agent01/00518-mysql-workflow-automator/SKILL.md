...
description: Use when tasks require mysql workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# MySQL Workflow Automator

## Purpose
Design and execute mysql workflows using workflow automator controls with validated outcomes.
