---
name: procurement-portals-execution-runner
description: Use when tasks require procurement portals execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Execution Runner

## Purpose
Design and execute procurement portals workflows using execution runner controls with validated outcomes.
