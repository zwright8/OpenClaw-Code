---
name: gcp-connector
description: Use when tasks require gcp connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GCP Connector

## Purpose
Design and execute gcp workflows using connector controls with validated outcomes.
