...
description: Use when tasks require jira workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Jira Workflow Automator

## Purpose
Design and execute jira workflows using workflow automator controls with validated outcomes.
