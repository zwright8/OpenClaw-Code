...
description: Use when tasks require salesforce sync orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Salesforce Sync Orchestrator

## Purpose
Design and execute salesforce workflows using sync orchestrator controls with validated outcomes.
