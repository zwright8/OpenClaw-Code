---
name: healthcare-ehr-dependency-resolver
description: Use when tasks require healthcare ehr dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Dependency Resolver

## Purpose
Design and execute healthcare ehr workflows using dependency resolver controls with validated outcomes.
