...
description: Use when tasks require miro migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Miro Migration Assistant

## Purpose
Design and execute miro workflows using migration assistant controls with validated outcomes.
...
- Domain: [Miro](../../resources/domains/miro.md)
