...
description: Use when tasks require microsoft teams workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Microsoft Teams Workflow Automator

## Purpose
Design and execute microsoft teams workflows using workflow automator controls with validated outcomes.
