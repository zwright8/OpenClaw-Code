---
name: patent-filings-capacity-planner
description: Use when tasks require patent filings capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Capacity Planner

## Purpose
Design and execute patent filings workflows using capacity planner controls with validated outcomes.
