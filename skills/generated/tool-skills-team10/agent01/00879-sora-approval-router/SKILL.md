...
description: Use when tasks require sora approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sora Approval Router

## Purpose
Design and execute sora workflows using approval router controls with validated outcomes.
