...
description: Use when tasks require postgres workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Postgres Workflow Automator

## Purpose
Design and execute postgres workflows using workflow automator controls with validated outcomes.
