...
description: Use when tasks require sendgrid sync orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SendGrid Sync Orchestrator

## Purpose
Design and execute sendgrid workflows using sync orchestrator controls with validated outcomes.
