...
description: Use when tasks require ghost report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ghost Report Builder

## Purpose
Design and execute ghost workflows using report builder controls with validated outcomes.
