...
description: Use when tasks require xero report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Xero Report Builder

## Purpose
Design and execute xero workflows using report builder controls with validated outcomes.
