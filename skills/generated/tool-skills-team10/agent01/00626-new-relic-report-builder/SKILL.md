...
description: Use when tasks require new relic report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# New Relic Report Builder

## Purpose
Design and execute new relic workflows using report builder controls with validated outcomes.
