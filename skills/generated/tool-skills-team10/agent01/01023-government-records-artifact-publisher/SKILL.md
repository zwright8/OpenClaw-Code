---
name: government-records-artifact-publisher
description: Use when tasks require government records artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Artifact Publisher

## Purpose
Design and execute government records workflows using artifact publisher controls with validated outcomes.
