---
name: healthcare-ehr-compliance-mapper
description: Use when tasks require healthcare ehr compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Compliance Mapper

## Purpose
Design and execute healthcare ehr workflows using compliance mapper controls with validated outcomes.
