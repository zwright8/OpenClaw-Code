...
description: Use when tasks require render report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Render Report Builder

## Purpose
Design and execute render workflows using report builder controls with validated outcomes.
