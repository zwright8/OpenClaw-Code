...
description: Use when tasks require prometheus workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prometheus Workflow Automator

## Purpose
Design and execute prometheus workflows using workflow automator controls with validated outcomes.
