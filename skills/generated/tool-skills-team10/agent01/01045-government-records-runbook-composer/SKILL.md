---
name: government-records-runbook-composer
description: Use when tasks require government records runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Runbook Composer

## Purpose
Design and execute government records workflows using runbook composer controls with validated outcomes.
