...
description: Use when tasks require paypal report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# PayPal Report Builder

## Purpose
Design and execute paypal workflows using report builder controls with validated outcomes.
