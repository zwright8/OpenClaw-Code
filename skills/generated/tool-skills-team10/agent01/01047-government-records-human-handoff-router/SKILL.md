---
name: government-records-human-handoff-router
description: Use when tasks require government records human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Human Handoff Router

## Purpose
Design and execute government records workflows using human handoff router controls with validated outcomes.
