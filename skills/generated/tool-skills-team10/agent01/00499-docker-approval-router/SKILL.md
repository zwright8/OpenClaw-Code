...
description: Use when tasks require docker approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Docker Approval Router

## Purpose
Design and execute docker workflows using approval router controls with validated outcomes.
