...
description: Use when tasks require zendesk workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Zendesk Workflow Automator

## Purpose
Design and execute zendesk workflows using workflow automator controls with validated outcomes.
