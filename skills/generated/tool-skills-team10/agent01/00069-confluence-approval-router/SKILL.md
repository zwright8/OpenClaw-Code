...
description: Use when tasks require confluence approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Confluence Approval Router

## Purpose
Design and execute confluence workflows using approval router controls with validated outcomes.
