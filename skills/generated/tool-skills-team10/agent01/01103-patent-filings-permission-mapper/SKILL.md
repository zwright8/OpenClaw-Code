---
name: patent-filings-permission-mapper
description: Use when tasks require patent filings permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Permission Mapper

## Purpose
Design and execute patent filings workflows using permission mapper controls with validated outcomes.
