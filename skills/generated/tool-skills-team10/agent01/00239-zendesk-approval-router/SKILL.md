...
description: Use when tasks require zendesk approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Zendesk Approval Router

## Purpose
Design and execute zendesk workflows using approval router controls with validated outcomes.
