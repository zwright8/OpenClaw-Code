...
description: Use when tasks require microsoft calendar webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Microsoft Calendar Webhook Listener

## Purpose
Design and execute microsoft calendar workflows using webhook listener controls with validated outcomes.

## Precision Profile
- Domain: Microsoft Calendar
- Capability: Webhook Listener
- Score: 54
- Rank: 12444
- Priority band: P3
...
4. Execute webhook listener actions with minimal blast radius.
...
- Capability: [Webhook Listener](../../resources/capabilities/webhook-listener.md)
