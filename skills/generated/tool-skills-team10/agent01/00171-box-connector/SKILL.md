---
name: box-connector
description: Use when tasks require box connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Box Connector

## Purpose
Design and execute box workflows using connector controls with validated outcomes.
