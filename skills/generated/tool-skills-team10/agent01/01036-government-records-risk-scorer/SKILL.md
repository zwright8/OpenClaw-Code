---
name: government-records-risk-scorer
description: Use when tasks require government records risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Risk Scorer

## Purpose
Design and execute government records workflows using risk scorer controls with validated outcomes.
