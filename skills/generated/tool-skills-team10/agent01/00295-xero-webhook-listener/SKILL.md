...
description: Use when tasks require xero webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Xero Webhook Listener

## Purpose
Design and execute xero workflows using webhook listener controls with validated outcomes.
