...
description: Use when tasks require zendesk data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Zendesk Data Importer

## Purpose
Design and execute zendesk workflows using data importer controls with validated outcomes.
