...
description: Use when tasks require salesforce workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Salesforce Workflow Automator

## Purpose
Design and execute salesforce workflows using workflow automator controls with validated outcomes.
...
- Domain: [Salesforce](../../resources/domains/salesforce.md)
