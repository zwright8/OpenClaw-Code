...
description: Use when tasks require elevenlabs connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ElevenLabs Connector

## Purpose
Design and execute elevenlabs workflows using connector controls with validated outcomes.
