---
name: patent-filings-execution-runner
description: Use when tasks require patent filings execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Execution Runner

## Purpose
Design and execute patent filings workflows using execution runner controls with validated outcomes.
