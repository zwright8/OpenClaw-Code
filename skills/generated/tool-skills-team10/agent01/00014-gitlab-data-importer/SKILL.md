...
description: Use when tasks require gitlab data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitLab Data Importer

## Purpose
Design and execute gitlab workflows using data importer controls with validated outcomes.
