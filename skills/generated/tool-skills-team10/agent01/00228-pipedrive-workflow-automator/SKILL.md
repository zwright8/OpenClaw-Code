...
description: Use when tasks require pipedrive workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pipedrive Workflow Automator

## Purpose
Design and execute pipedrive workflows using workflow automator controls with validated outcomes.
