---
name: government-records-root-cause-miner
description: Use when tasks require government records root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Root Cause Miner

## Purpose
Design and execute government records workflows using root cause miner controls with validated outcomes.
