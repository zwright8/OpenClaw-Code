---
name: healthcare-ehr-task-decomposer
description: Use when tasks require healthcare ehr task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Task Decomposer

## Purpose
Design and execute healthcare ehr workflows using task decomposer controls with validated outcomes.
