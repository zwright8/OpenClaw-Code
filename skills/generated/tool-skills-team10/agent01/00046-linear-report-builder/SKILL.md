...
description: Use when tasks require linear report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Linear Report Builder

## Purpose
Design and execute linear workflows using report builder controls with validated outcomes.
