---
name: procurement-portals-remediation-planner
description: Use when tasks require procurement portals remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Remediation Planner

## Purpose
Design and execute procurement portals workflows using remediation planner controls with validated outcomes.
