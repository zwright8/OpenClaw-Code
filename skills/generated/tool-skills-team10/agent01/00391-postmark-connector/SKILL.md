...
description: Use when tasks require postmark connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Postmark Connector

## Purpose
Design and execute postmark workflows using connector controls with validated outcomes.
