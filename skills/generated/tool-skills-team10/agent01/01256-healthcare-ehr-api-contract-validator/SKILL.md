---
name: healthcare-ehr-api-contract-validator
description: Use when tasks require healthcare ehr api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR API Contract Validator

## Purpose
Design and execute healthcare ehr workflows using api contract validator controls with validated outcomes.
...
- Domain: [Healthcare EHR](../../resources/domains/healthcare-ehr.md)
