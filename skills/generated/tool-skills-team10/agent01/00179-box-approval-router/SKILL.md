...
description: Use when tasks require box approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Box Approval Router

## Purpose
Design and execute box workflows using approval router controls with validated outcomes.
