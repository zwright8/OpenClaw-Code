...
description: Use when tasks require postgres webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Postgres Webhook Listener

## Purpose
Design and execute postgres workflows using webhook listener controls with validated outcomes.
