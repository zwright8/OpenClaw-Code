...
description: Use when tasks require discord approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discord Approval Router

## Purpose
Design and execute discord workflows using approval router controls with validated outcomes.
