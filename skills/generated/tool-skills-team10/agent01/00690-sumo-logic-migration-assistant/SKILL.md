...
description: Use when tasks require sumo logic migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sumo Logic Migration Assistant

## Purpose
Design and execute sumo logic workflows using migration assistant controls with validated outcomes.
...
- Domain: [Sumo Logic](../../resources/domains/sumo-logic.md)
