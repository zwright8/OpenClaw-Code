...
description: Use when tasks require paypal webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# PayPal Webhook Listener

## Purpose
Design and execute paypal workflows using webhook listener controls with validated outcomes.
