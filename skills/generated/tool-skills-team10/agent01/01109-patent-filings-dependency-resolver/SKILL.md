---
name: patent-filings-dependency-resolver
description: Use when tasks require patent filings dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Dependency Resolver

## Purpose
Design and execute patent filings workflows using dependency resolver controls with validated outcomes.
