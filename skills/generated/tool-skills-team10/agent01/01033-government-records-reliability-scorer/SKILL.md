---
name: government-records-reliability-scorer
description: Use when tasks require government records reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Reliability Scorer

## Purpose
Design and execute government records workflows using reliability scorer controls with validated outcomes.
