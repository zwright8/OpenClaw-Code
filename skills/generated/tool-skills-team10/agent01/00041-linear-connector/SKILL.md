...
description: Use when tasks require linear connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Linear Connector

## Purpose
Design and execute linear workflows using connector controls with validated outcomes.
