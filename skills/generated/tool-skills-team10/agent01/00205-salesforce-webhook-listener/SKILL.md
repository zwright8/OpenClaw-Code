...
description: Use when tasks require salesforce webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Salesforce Webhook Listener

## Purpose
Design and execute salesforce workflows using webhook listener controls with validated outcomes.
