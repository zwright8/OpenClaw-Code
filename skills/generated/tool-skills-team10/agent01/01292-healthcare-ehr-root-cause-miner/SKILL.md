---
name: healthcare-ehr-root-cause-miner
description: Use when tasks require healthcare ehr root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Root Cause Miner

## Purpose
Design and execute healthcare ehr workflows using root cause miner controls with validated outcomes.
