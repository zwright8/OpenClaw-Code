---
name: compliance-registries-retry-governor
description: Use when tasks require compliance registries retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Retry Governor

## Purpose
Design and execute compliance registries workflows using retry governor controls with validated outcomes.
