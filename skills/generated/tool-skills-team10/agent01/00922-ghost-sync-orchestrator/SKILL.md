...
description: Use when tasks require ghost sync orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ghost Sync Orchestrator

## Purpose
Design and execute ghost workflows using sync orchestrator controls with validated outcomes.
