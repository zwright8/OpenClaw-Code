...
description: Use when tasks require compliance registries compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Compliance Mapper

## Purpose
Design and execute compliance registries workflows using compliance mapper controls with validated outcomes.
