...
description: Use when tasks require splunk report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Splunk Report Builder

## Purpose
Design and execute splunk workflows using report builder controls with validated outcomes.
