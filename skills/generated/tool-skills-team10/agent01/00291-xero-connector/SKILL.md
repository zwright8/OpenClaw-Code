---
name: xero-connector
description: Use when tasks require xero connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Xero Connector

## Purpose
Design and execute xero workflows using connector controls with validated outcomes.
