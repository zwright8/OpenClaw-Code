---
name: patent-filings-rollback-coordinator
description: Use when tasks require patent filings rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Rollback Coordinator

## Purpose
Design and execute patent filings workflows using rollback coordinator controls with validated outcomes.
