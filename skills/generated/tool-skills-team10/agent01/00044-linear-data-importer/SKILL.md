...
description: Use when tasks require linear data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Linear Data Importer

## Purpose
Design and execute linear workflows using data importer controls with validated outcomes.
