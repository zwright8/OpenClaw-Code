...
description: Use when tasks require loom workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Loom Workflow Automator

## Purpose
Design and execute loom workflows using workflow automator controls with validated outcomes.
