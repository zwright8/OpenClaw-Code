...
description: Use when tasks require compliance registries evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Evidence Collector

## Purpose
Design and execute compliance registries workflows using evidence collector controls with validated outcomes.
