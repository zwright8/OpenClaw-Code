---
name: patent-filings-approval-orchestrator
description: Use when tasks require patent filings approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Approval Orchestrator

## Purpose
Design and execute patent filings workflows using approval orchestrator controls with validated outcomes.
