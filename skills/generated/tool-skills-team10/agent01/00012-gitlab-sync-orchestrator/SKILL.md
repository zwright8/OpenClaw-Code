...
description: Use when tasks require gitlab sync orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitLab Sync Orchestrator

## Purpose
Design and execute gitlab workflows using sync orchestrator controls with validated outcomes.
