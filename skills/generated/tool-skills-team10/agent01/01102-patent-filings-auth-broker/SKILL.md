---
name: patent-filings-auth-broker
description: Use when tasks require patent filings auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Auth Broker

## Purpose
Design and execute patent filings workflows using auth broker controls with validated outcomes.
