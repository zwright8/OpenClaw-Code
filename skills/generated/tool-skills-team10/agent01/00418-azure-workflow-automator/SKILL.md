...
description: Use when tasks require azure workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Azure Workflow Automator

## Purpose
Design and execute azure workflows using workflow automator controls with validated outcomes.
...
- Domain: [Azure](../../resources/domains/azure.md)
