...
description: Use when tasks require playwright migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Playwright Migration Assistant

## Purpose
Design and execute playwright workflows using migration assistant controls with validated outcomes.
...
- Domain: [Playwright](../../resources/domains/playwright.md)
