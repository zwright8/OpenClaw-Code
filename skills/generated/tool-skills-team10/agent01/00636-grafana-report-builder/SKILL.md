...
description: Use when tasks require grafana report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grafana Report Builder

## Purpose
Design and execute grafana workflows using report builder controls with validated outcomes.
