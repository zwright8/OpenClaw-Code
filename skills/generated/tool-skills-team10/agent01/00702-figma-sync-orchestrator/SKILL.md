...
description: Use when tasks require figma sync orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Figma Sync Orchestrator

## Purpose
Design and execute figma workflows using sync orchestrator controls with validated outcomes.
