...
description: Use when tasks require sentry migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sentry Migration Assistant

## Purpose
Design and execute sentry workflows using migration assistant controls with validated outcomes.
...
- Domain: [Sentry](../../resources/domains/sentry.md)
