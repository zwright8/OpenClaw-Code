...
description: Use when tasks require kubernetes approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Kubernetes Approval Router

## Purpose
Design and execute kubernetes workflows using approval router controls with validated outcomes.
