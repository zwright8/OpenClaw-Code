...
description: Use when tasks require whisper webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Whisper Webhook Listener

## Purpose
Design and execute whisper workflows using webhook listener controls with validated outcomes.
