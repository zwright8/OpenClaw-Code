---
name: court-dockets-snapshot-manager
description: Use when tasks require court dockets snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Snapshot Manager

## Purpose
Design and execute court dockets workflows using snapshot manager controls with validated outcomes.
