...
description: Use when tasks require figma connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Figma Connector

## Purpose
Design and execute figma workflows using connector controls with validated outcomes.
