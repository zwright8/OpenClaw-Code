...
description: Use when tasks require mailchimp approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mailchimp Approval Router

## Purpose
Design and execute mailchimp workflows using approval router controls with validated outcomes.
