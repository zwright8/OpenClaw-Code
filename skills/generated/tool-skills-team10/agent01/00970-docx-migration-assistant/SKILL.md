...
description: Use when tasks require docx migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# DOCX Migration Assistant

## Purpose
Design and execute docx workflows using migration assistant controls with validated outcomes.
...
- Domain: [DOCX](../../resources/domains/docx.md)
