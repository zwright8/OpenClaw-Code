...
description: Use when tasks require bigquery workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BigQuery Workflow Automator

## Purpose
Design and execute bigquery workflows using workflow automator controls with validated outcomes.
