...
description: Use when tasks require jira approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Jira Approval Router

## Purpose
Design and execute jira workflows using approval router controls with validated outcomes.
