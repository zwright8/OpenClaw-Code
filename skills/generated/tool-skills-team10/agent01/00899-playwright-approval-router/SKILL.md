...
description: Use when tasks require playwright approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Playwright Approval Router

## Purpose
Design and execute playwright workflows using approval router controls with validated outcomes.
