---
name: procurement-portals-capacity-planner
description: Use when tasks require procurement portals capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Capacity Planner

## Purpose
Design and execute procurement portals workflows using capacity planner controls with validated outcomes.
