---
name: miro-connector
description: Use when tasks require miro connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Miro Connector

## Purpose
Design and execute miro workflows using connector controls with validated outcomes.
