...
description: Use when tasks require databricks connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Databricks Connector

## Purpose
Design and execute databricks workflows using connector controls with validated outcomes.
