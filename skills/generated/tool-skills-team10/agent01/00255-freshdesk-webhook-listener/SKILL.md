...
description: Use when tasks require freshdesk webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Freshdesk Webhook Listener

## Purpose
Design and execute freshdesk workflows using webhook listener controls with validated outcomes.
