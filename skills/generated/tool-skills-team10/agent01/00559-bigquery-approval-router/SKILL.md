...
description: Use when tasks require bigquery approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BigQuery Approval Router

## Purpose
Design and execute bigquery workflows using approval router controls with validated outcomes.
