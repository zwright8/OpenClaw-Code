...
description: Use when tasks require hubspot connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# HubSpot Connector

## Purpose
Design and execute hubspot workflows using connector controls with validated outcomes.
