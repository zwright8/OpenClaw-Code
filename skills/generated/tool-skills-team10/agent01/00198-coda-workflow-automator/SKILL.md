...
description: Use when tasks require coda workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Coda Workflow Automator

## Purpose
Design and execute coda workflows using workflow automator controls with validated outcomes.
