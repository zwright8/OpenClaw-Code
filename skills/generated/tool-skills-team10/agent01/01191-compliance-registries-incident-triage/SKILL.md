---
name: compliance-registries-incident-triage
description: Use when tasks require compliance registries incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Incident Triage

## Purpose
Design and execute compliance registries workflows using incident triage controls with validated outcomes.
