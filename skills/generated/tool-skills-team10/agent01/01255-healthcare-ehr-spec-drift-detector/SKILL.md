---
name: healthcare-ehr-spec-drift-detector
description: Use when tasks require healthcare ehr spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Spec Drift Detector

## Purpose
Design and execute healthcare ehr workflows using spec drift detector controls with validated outcomes.
