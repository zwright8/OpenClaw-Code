---
name: patent-filings-spec-drift-detector
description: Use when tasks require patent filings spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Spec Drift Detector

## Purpose
Design and execute patent filings workflows using spec drift detector controls with validated outcomes.
