---
name: court-dockets-incident-triage
description: Use when tasks require court dockets incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Incident Triage

## Purpose
Design and execute court dockets workflows using incident triage controls with validated outcomes.
