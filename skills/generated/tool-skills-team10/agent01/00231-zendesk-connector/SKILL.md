...
description: Use when tasks require zendesk connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Zendesk Connector

## Purpose
Design and execute zendesk workflows using connector controls with validated outcomes.
