...
description: Use when tasks require playwright connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Playwright Connector

## Purpose
Design and execute playwright workflows using connector controls with validated outcomes.
