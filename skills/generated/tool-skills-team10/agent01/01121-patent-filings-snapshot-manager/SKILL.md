---
name: patent-filings-snapshot-manager
description: Use when tasks require patent filings snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Snapshot Manager

## Purpose
Design and execute patent filings workflows using snapshot manager controls with validated outcomes.
