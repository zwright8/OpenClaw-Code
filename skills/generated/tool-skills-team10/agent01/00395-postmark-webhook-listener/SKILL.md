...
description: Use when tasks require postmark webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Postmark Webhook Listener

## Purpose
Design and execute postmark workflows using webhook listener controls with validated outcomes.
