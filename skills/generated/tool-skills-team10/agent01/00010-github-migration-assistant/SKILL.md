...
description: Use when tasks require github migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitHub Migration Assistant

## Purpose
Design and execute github workflows using migration assistant controls with validated outcomes.
...
- Domain: [GitHub](../../resources/domains/github.md)
