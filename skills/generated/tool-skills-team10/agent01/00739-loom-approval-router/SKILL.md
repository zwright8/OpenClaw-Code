...
description: Use when tasks require loom approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Loom Approval Router

## Purpose
Design and execute loom workflows using approval router controls with validated outcomes.
