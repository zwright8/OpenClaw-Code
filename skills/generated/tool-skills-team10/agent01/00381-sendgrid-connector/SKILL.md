...
description: Use when tasks require sendgrid connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SendGrid Connector

## Purpose
Design and execute sendgrid workflows using connector controls with validated outcomes.
