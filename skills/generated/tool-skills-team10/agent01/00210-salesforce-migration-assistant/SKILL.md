...
description: Use when tasks require salesforce migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Salesforce Migration Assistant

## Purpose
Design and execute salesforce workflows using migration assistant controls with validated outcomes.
