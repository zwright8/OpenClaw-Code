...
description: Use when tasks require gitlab connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitLab Connector

## Purpose
Design and execute gitlab workflows using connector controls with validated outcomes.
