---
name: healthcare-ehr-incident-triage
description: Use when tasks require healthcare ehr incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Incident Triage

## Purpose
Design and execute healthcare ehr workflows using incident triage controls with validated outcomes.
