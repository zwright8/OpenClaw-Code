...
description: Use when tasks require json workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# JSON Workflow Automator

## Purpose
Design and execute json workflows using workflow automator controls with validated outcomes.
