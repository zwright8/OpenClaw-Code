...
description: Use when tasks require figma workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Figma Workflow Automator

## Purpose
Design and execute figma workflows using workflow automator controls with validated outcomes.
