...
description: Use when tasks require coda report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Coda Report Builder

## Purpose
Design and execute coda workflows using report builder controls with validated outcomes.
