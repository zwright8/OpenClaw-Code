---
name: court-dockets-human-handoff-router
description: Use when tasks require court dockets human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Human Handoff Router

## Purpose
Design and execute court dockets workflows using human handoff router controls with validated outcomes.
