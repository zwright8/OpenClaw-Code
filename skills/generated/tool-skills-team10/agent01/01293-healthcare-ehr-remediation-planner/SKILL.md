---
name: healthcare-ehr-remediation-planner
description: Use when tasks require healthcare ehr remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Remediation Planner

## Purpose
Design and execute healthcare ehr workflows using remediation planner controls with validated outcomes.
