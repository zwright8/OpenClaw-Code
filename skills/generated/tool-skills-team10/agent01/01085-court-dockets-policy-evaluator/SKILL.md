---
name: court-dockets-policy-evaluator
description: Use when tasks require court dockets policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Policy Evaluator

## Purpose
Design and execute court dockets workflows using policy evaluator controls with validated outcomes.
