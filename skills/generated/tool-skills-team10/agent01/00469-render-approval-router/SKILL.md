...
description: Use when tasks require render approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Render Approval Router

## Purpose
Design and execute render workflows using approval router controls with validated outcomes.
