...
description: Use when tasks require clickhouse webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ClickHouse Webhook Listener

## Purpose
Design and execute clickhouse workflows using webhook listener controls with validated outcomes.
