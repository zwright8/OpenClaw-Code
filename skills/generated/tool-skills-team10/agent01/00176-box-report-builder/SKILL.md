...
description: Use when tasks require box report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Box Report Builder

## Purpose
Design and execute box workflows using report builder controls with validated outcomes.
