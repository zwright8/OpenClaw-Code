---
name: patent-filings-forecast-engine
description: Use when tasks require patent filings forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Forecast Engine

## Purpose
Design and execute patent filings workflows using forecast engine controls with validated outcomes.
