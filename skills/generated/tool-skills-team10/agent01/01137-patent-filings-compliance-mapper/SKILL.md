---
name: patent-filings-compliance-mapper
description: Use when tasks require patent filings compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Compliance Mapper

## Purpose
Design and execute patent filings workflows using compliance mapper controls with validated outcomes.
