...
description: Use when tasks require whisper data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Whisper Data Importer

## Purpose
Design and execute whisper workflows using data importer controls with validated outcomes.
