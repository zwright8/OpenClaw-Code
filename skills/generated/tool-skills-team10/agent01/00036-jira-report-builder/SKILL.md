...
description: Use when tasks require jira report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Jira Report Builder

## Purpose
Design and execute jira workflows using report builder controls with validated outcomes.
