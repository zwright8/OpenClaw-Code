...
description: Use when tasks require ebay seller webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# eBay Seller Webhook Listener

## Purpose
Design and execute ebay seller workflows using webhook listener controls with validated outcomes.
