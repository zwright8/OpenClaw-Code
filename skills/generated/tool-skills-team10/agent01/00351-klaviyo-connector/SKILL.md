...
description: Use when tasks require klaviyo connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Klaviyo Connector

## Purpose
Design and execute klaviyo workflows using connector controls with validated outcomes.
