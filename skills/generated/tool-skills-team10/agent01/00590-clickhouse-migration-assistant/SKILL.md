...
description: Use when tasks require clickhouse migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ClickHouse Migration Assistant

## Purpose
Design and execute clickhouse workflows using migration assistant controls with validated outcomes.
...
- Domain: [ClickHouse](../../resources/domains/clickhouse.md)
