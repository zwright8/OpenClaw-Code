...
description: Use when tasks require box workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Box Workflow Automator

## Purpose
Design and execute box workflows using workflow automator controls with validated outcomes.
...
- Domain: [Box](../../resources/domains/box.md)
