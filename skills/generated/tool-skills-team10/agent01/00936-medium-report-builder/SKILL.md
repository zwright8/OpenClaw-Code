...
description: Use when tasks require medium report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Medium Report Builder

## Purpose
Design and execute medium workflows using report builder controls with validated outcomes.
