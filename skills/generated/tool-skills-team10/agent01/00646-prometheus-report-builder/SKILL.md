...
description: Use when tasks require prometheus report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prometheus Report Builder

## Purpose
Design and execute prometheus workflows using report builder controls with validated outcomes.
