...
description: Use when tasks require sora data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sora Data Importer

## Purpose
Design and execute sora workflows using data importer controls with validated outcomes.
