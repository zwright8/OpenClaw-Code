...
description: Use when tasks require postmark report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Postmark Report Builder

## Purpose
Design and execute postmark workflows using report builder controls with validated outcomes.
