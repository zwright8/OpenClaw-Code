---
name: government-records-forecast-engine
description: Use when tasks require government records forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Forecast Engine

## Purpose
Design and execute government records workflows using forecast engine controls with validated outcomes.
