---
name: patent-filings-reliability-scorer
description: Use when tasks require patent filings reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Reliability Scorer

## Purpose
Design and execute patent filings workflows using reliability scorer controls with validated outcomes.
