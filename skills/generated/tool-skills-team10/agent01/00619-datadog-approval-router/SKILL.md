...
description: Use when tasks require datadog approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Datadog Approval Router

## Purpose
Design and execute datadog workflows using approval router controls with validated outcomes.
