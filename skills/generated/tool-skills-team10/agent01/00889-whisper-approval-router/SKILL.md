...
description: Use when tasks require whisper approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Whisper Approval Router

## Purpose
Design and execute whisper workflows using approval router controls with validated outcomes.
