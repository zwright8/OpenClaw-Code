...
description: Use when tasks require xero workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Xero Workflow Automator

## Purpose
Design and execute xero workflows using workflow automator controls with validated outcomes.
