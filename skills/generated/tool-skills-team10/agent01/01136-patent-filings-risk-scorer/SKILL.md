---
name: patent-filings-risk-scorer
description: Use when tasks require patent filings risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Risk Scorer

## Purpose
Design and execute patent filings workflows using risk scorer controls with validated outcomes.
