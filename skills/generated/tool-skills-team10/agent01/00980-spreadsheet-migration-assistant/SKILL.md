...
description: Use when tasks require spreadsheet migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Spreadsheet Migration Assistant

## Purpose
Design and execute spreadsheet workflows using migration assistant controls with validated outcomes.
...
- Domain: [Spreadsheet](../../resources/domains/spreadsheet.md)
