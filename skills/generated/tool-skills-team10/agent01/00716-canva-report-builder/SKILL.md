...
description: Use when tasks require canva report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Canva Report Builder

## Purpose
Design and execute canva workflows using report builder controls with validated outcomes.
