...
description: Use when tasks require mailchimp webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mailchimp Webhook Listener

## Purpose
Design and execute mailchimp workflows using webhook listener controls with validated outcomes.
