...
description: Use when tasks require gitlab report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitLab Report Builder

## Purpose
Design and execute gitlab workflows using report builder controls with validated outcomes.
