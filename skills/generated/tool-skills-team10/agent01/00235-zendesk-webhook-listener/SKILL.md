...
description: Use when tasks require zendesk webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Zendesk Webhook Listener

## Purpose
Design and execute zendesk workflows using webhook listener controls with validated outcomes.
