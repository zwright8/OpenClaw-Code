...
description: Use when tasks require databricks webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Databricks Webhook Listener

## Purpose
Design and execute databricks workflows using webhook listener controls with validated outcomes.
