...
description: Use when tasks require elasticsearch migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Elasticsearch Migration Assistant

## Purpose
Design and execute elasticsearch workflows using migration assistant controls with validated outcomes.
...
- Domain: [Elasticsearch](../../resources/domains/elasticsearch.md)
