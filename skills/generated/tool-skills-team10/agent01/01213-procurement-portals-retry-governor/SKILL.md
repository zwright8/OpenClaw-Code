---
name: procurement-portals-retry-governor
description: Use when tasks require procurement portals retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Retry Governor

## Purpose
Design and execute procurement portals workflows using retry governor controls with validated outcomes.
