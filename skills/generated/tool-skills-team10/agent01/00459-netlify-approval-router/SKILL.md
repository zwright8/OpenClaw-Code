...
description: Use when tasks require netlify approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Netlify Approval Router

## Purpose
Design and execute netlify workflows using approval router controls with validated outcomes.
