---
name: healthcare-ehr-postmortem-drafting
description: Use when tasks require healthcare ehr postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Postmortem Drafting

## Purpose
Design and execute healthcare ehr workflows using postmortem drafting controls with validated outcomes.
