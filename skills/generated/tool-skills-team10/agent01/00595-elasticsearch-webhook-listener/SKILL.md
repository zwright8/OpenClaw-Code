...
description: Use when tasks require elasticsearch webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Elasticsearch Webhook Listener

## Purpose
Design and execute elasticsearch workflows using webhook listener controls with validated outcomes.
