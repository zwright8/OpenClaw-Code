...
description: Use when tasks require databricks migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Databricks Migration Assistant

## Purpose
Design and execute databricks workflows using migration assistant controls with validated outcomes.
...
- Domain: [Databricks](../../resources/domains/databricks.md)
