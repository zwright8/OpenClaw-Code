...
description: Use when tasks require google calendar connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Google Calendar Connector

## Purpose
Design and execute google calendar workflows using connector controls with validated outcomes.
