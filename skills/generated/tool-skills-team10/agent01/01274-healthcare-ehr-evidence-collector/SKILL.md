---
name: healthcare-ehr-evidence-collector
description: Use when tasks require healthcare ehr evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Evidence Collector

## Purpose
Design and execute healthcare ehr workflows using evidence collector controls with validated outcomes.
