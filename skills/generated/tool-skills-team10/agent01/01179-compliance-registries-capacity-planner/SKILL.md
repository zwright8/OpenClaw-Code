---
name: compliance-registries-capacity-planner
description: Use when tasks require compliance registries capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Capacity Planner

## Purpose
Design and execute compliance registries workflows using capacity planner controls with validated outcomes.
