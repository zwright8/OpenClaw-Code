...
description: Use when tasks require wordpress connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# WordPress Connector

## Purpose
Design and execute wordpress workflows using connector controls with validated outcomes.
