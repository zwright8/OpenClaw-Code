...
description: Use when tasks require bigquery migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BigQuery Migration Assistant

## Purpose
Design and execute bigquery workflows using migration assistant controls with validated outcomes.
