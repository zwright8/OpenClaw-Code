...
description: Use when tasks require whisper migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Whisper Migration Assistant

## Purpose
Design and execute whisper workflows using migration assistant controls with validated outcomes.
...
- Domain: [Whisper](../../resources/domains/whisper.md)
