...
description: Use when tasks require court dockets risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Risk Scorer

## Purpose
Design and execute court dockets workflows using risk scorer controls with validated outcomes.
