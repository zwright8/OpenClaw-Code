...
description: Use when tasks require playwright workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Playwright Workflow Automator

## Purpose
Design and execute playwright workflows using workflow automator controls with validated outcomes.
