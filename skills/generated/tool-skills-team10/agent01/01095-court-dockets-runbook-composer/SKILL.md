---
name: court-dockets-runbook-composer
description: Use when tasks require court dockets runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Runbook Composer

## Purpose
Design and execute court dockets workflows using runbook composer controls with validated outcomes.
