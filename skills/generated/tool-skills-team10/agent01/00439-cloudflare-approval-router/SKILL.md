...
description: Use when tasks require cloudflare approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Cloudflare Approval Router

## Purpose
Design and execute cloudflare workflows using approval router controls with validated outcomes.
