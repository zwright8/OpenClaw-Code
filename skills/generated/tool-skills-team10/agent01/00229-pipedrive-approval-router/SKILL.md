...
description: Use when tasks require pipedrive approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pipedrive Approval Router

## Purpose
Design and execute pipedrive workflows using approval router controls with validated outcomes.
