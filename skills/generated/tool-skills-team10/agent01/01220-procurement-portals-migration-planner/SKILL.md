---
name: procurement-portals-migration-planner
description: Use when tasks require procurement portals migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Migration Planner

## Purpose
Design and execute procurement portals workflows using migration planner controls with validated outcomes.
