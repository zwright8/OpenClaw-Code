---
name: court-dockets-provenance-tracker
description: Use when tasks require court dockets provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Provenance Tracker

## Purpose
Design and execute court dockets workflows using provenance tracker controls with validated outcomes.
