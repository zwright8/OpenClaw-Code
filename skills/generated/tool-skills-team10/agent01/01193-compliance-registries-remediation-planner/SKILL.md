---
name: compliance-registries-remediation-planner
description: Use when tasks require compliance registries remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Remediation Planner

## Purpose
Design and execute compliance registries workflows using remediation planner controls with validated outcomes.
