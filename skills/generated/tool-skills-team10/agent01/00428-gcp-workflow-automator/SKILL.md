...
description: Use when tasks require gcp workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GCP Workflow Automator

## Purpose
Design and execute gcp workflows using workflow automator controls with validated outcomes.
