---
name: healthcare-ehr-provenance-tracker
description: Use when tasks require healthcare ehr provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Provenance Tracker

## Purpose
Design and execute healthcare ehr workflows using provenance tracker controls with validated outcomes.
