...
description: Use when tasks require canva data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Canva Data Importer

## Purpose
Design and execute canva workflows using data importer controls with validated outcomes.
