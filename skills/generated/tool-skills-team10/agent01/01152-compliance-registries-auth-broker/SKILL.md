---
name: compliance-registries-auth-broker
description: Use when tasks require compliance registries auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Auth Broker

## Purpose
Design and execute compliance registries workflows using auth broker controls with validated outcomes.
