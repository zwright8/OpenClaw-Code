...
description: Use when tasks require intercom report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Intercom Report Builder

## Purpose
Design and execute intercom workflows using report builder controls with validated outcomes.
