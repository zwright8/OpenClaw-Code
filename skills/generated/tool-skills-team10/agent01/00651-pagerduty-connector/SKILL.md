...
description: Use when tasks require pagerduty connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# PagerDuty Connector

## Purpose
Design and execute pagerduty workflows using connector controls with validated outcomes.
