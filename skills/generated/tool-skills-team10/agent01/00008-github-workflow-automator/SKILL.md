...
description: Use when tasks require github workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitHub Workflow Automator

## Purpose
Design and execute github workflows using workflow automator controls with validated outcomes.
