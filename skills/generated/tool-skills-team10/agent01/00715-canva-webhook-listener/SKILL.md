...
description: Use when tasks require canva webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Canva Webhook Listener

## Purpose
Design and execute canva workflows using webhook listener controls with validated outcomes.
