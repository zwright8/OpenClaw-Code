---
name: healthcare-ehr-execution-runner
description: Use when tasks require healthcare ehr execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Execution Runner

## Purpose
Design and execute healthcare ehr workflows using execution runner controls with validated outcomes.
