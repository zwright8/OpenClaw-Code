---
name: court-dockets-quality-gatekeeper
description: Use when tasks require court dockets quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Quality Gatekeeper

## Purpose
Design and execute court dockets workflows using quality gatekeeper controls with validated outcomes.
