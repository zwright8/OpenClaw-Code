...
description: Use when tasks require openai workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# OpenAI Workflow Automator

## Purpose
Design and execute openai workflows using workflow automator controls with validated outcomes.
