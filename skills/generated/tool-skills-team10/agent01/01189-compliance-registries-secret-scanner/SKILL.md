---
name: compliance-registries-secret-scanner
description: Use when tasks require compliance registries secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Secret Scanner

## Purpose
Design and execute compliance registries workflows using secret scanner controls with validated outcomes.
