...
description: Use when tasks require stripe workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Stripe Workflow Automator

## Purpose
Design and execute stripe workflows using workflow automator controls with validated outcomes.
