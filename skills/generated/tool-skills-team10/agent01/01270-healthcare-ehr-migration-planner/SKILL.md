---
name: healthcare-ehr-migration-planner
description: Use when tasks require healthcare ehr migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Migration Planner

## Purpose
Design and execute healthcare ehr workflows using migration planner controls with validated outcomes.
