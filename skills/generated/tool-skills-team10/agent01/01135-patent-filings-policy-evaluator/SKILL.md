---
name: patent-filings-policy-evaluator
description: Use when tasks require patent filings policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Policy Evaluator

## Purpose
Design and execute patent filings workflows using policy evaluator controls with validated outcomes.
