---
name: healthcare-ehr-state-reconciler
description: Use when tasks require healthcare ehr state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR State Reconciler

## Purpose
Design and execute healthcare ehr workflows using state reconciler controls with validated outcomes.
