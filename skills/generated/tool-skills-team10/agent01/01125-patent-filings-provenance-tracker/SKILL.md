---
name: patent-filings-provenance-tracker
description: Use when tasks require patent filings provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Provenance Tracker

## Purpose
Design and execute patent filings workflows using provenance tracker controls with validated outcomes.
