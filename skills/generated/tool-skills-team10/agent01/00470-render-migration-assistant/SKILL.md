...
description: Use when tasks require render migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Render Migration Assistant

## Purpose
Design and execute render workflows using migration assistant controls with validated outcomes.
...
- Domain: [Render](../../resources/domains/render.md)
