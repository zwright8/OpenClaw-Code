...
description: Use when tasks require klaviyo report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Klaviyo Report Builder

## Purpose
Design and execute klaviyo workflows using report builder controls with validated outcomes.
