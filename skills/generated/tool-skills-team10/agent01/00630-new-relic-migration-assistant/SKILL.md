...
description: Use when tasks require new relic migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# New Relic Migration Assistant

## Purpose
Design and execute new relic workflows using migration assistant controls with validated outcomes.
