...
description: Use when tasks require onedrive report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# OneDrive Report Builder

## Purpose
Design and execute onedrive workflows using report builder controls with validated outcomes.
