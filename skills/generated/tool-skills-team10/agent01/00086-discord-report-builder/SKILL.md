...
description: Use when tasks require discord report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discord Report Builder

## Purpose
Design and execute discord workflows using report builder controls with validated outcomes.
