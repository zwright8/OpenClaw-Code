---
name: government-records-spec-drift-detector
description: Use when tasks require government records spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Spec Drift Detector

## Purpose
Design and execute government records workflows using spec drift detector controls with validated outcomes.
