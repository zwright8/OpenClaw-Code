...
description: Use when tasks require medium approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Medium Approval Router

## Purpose
Design and execute medium workflows using approval router controls with validated outcomes.
