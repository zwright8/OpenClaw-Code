---
name: procurement-portals-task-decomposer
description: Use when tasks require procurement portals task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Task Decomposer

## Purpose
Design and execute procurement portals workflows using task decomposer controls with validated outcomes.
