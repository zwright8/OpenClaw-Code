...
description: Use when tasks require azure approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Azure Approval Router

## Purpose
Design and execute azure workflows using approval router controls with validated outcomes.
