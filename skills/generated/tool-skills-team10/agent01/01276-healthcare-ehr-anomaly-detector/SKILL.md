---
name: healthcare-ehr-anomaly-detector
description: Use when tasks require healthcare ehr anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Anomaly Detector

## Purpose
Design and execute healthcare ehr workflows using anomaly detector controls with validated outcomes.
