---
name: healthcare-ehr-reliability-scorer
description: Use when tasks require healthcare ehr reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Reliability Scorer

## Purpose
Design and execute healthcare ehr workflows using reliability scorer controls with validated outcomes.
