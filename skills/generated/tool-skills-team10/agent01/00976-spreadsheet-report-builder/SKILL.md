...
description: Use when tasks require spreadsheet report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Spreadsheet Report Builder

## Purpose
Design and execute spreadsheet workflows using report builder controls with validated outcomes.
