...
description: Use when tasks require postgres approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Postgres Approval Router

## Purpose
Design and execute postgres workflows using approval router controls with validated outcomes.
