---
name: compliance-registries-runbook-composer
description: Use when tasks require compliance registries runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Runbook Composer

## Purpose
Design and execute compliance registries workflows using runbook composer controls with validated outcomes.
