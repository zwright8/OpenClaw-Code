...
description: Use when tasks require clickhouse data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ClickHouse Data Importer

## Purpose
Design and execute clickhouse workflows using data importer controls with validated outcomes.
