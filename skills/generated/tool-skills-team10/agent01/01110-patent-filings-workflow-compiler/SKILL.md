---
name: patent-filings-workflow-compiler
description: Use when tasks require patent filings workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Workflow Compiler

## Purpose
Design and execute patent filings workflows using workflow compiler controls with validated outcomes.
