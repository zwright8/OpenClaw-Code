...
description: Use when tasks require salesforce connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Salesforce Connector

## Purpose
Design and execute salesforce workflows using connector controls with validated outcomes.
