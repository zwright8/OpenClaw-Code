...
description: Use when tasks require microsoft calendar connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Microsoft Calendar Connector

## Purpose
Design and execute microsoft calendar workflows using connector controls with validated outcomes.
...
4. Execute connector actions with minimal blast radius.
...
- Capability: [Connector](../../resources/capabilities/connector.md)
