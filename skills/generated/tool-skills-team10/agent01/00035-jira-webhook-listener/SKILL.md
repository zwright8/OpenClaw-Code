...
description: Use when tasks require jira webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Jira Webhook Listener

## Purpose
Design and execute jira workflows using webhook listener controls with validated outcomes.
