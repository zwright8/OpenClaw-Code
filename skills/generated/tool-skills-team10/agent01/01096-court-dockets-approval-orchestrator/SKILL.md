---
name: court-dockets-approval-orchestrator
description: Use when tasks require court dockets approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Approval Orchestrator

## Purpose
Design and execute court dockets workflows using approval orchestrator controls with validated outcomes.
