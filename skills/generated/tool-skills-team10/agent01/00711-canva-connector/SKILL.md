...
description: Use when tasks require canva connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Canva Connector

## Purpose
Design and execute canva workflows using connector controls with validated outcomes.
