...
description: Use when tasks require klaviyo webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Klaviyo Webhook Listener

## Purpose
Design and execute klaviyo workflows using webhook listener controls with validated outcomes.
