...
description: Use when tasks require box migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Box Migration Assistant

## Purpose
Design and execute box workflows using migration assistant controls with validated outcomes.
