...
description: Use when tasks require opensearch report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# OpenSearch Report Builder

## Purpose
Design and execute opensearch workflows using report builder controls with validated outcomes.
