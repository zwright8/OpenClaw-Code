---
name: court-dockets-forecast-engine
description: Use when tasks require court dockets forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Forecast Engine

## Purpose
Design and execute court dockets workflows using forecast engine controls with validated outcomes.
