...
description: Use when tasks require clickhouse workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ClickHouse Workflow Automator

## Purpose
Design and execute clickhouse workflows using workflow automator controls with validated outcomes.
