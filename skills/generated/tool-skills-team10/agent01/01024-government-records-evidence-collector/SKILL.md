...
description: Use when tasks require government records evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Evidence Collector

## Purpose
Design and execute government records workflows using evidence collector controls with validated outcomes.
