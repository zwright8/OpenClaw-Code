...
description: Use when tasks require anthropic workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Anthropic Workflow Automator

## Purpose
Design and execute anthropic workflows using workflow automator controls with validated outcomes.
