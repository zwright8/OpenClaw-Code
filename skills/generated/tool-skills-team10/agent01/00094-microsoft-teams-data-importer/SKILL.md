...
description: Use when tasks require microsoft teams data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Microsoft Teams Data Importer

## Purpose
Design and execute microsoft teams workflows using data importer controls with validated outcomes.
