...
description: Use when tasks require playwright webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Playwright Webhook Listener

## Purpose
Design and execute playwright workflows using webhook listener controls with validated outcomes.
