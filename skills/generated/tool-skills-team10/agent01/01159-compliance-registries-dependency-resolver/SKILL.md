...
description: Use when tasks require compliance registries dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Dependency Resolver

## Purpose
Design and execute compliance registries workflows using dependency resolver controls with validated outcomes.
