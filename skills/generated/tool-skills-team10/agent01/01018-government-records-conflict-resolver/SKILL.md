---
name: government-records-conflict-resolver
description: Use when tasks require government records conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Conflict Resolver

## Purpose
Design and execute government records workflows using conflict resolver controls with validated outcomes.
