...
description: Use when tasks require wordpress approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# WordPress Approval Router

## Purpose
Design and execute wordpress workflows using approval router controls with validated outcomes.
