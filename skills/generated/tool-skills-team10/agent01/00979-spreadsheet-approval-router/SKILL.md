...
description: Use when tasks require spreadsheet approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Spreadsheet Approval Router

## Purpose
Design and execute spreadsheet workflows using approval router controls with validated outcomes.
