---
name: court-dockets-secret-scanner
description: Use when tasks require court dockets secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Secret Scanner

## Purpose
Design and execute court dockets workflows using secret scanner controls with validated outcomes.
