...
description: Use when tasks require sumo logic data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sumo Logic Data Importer

## Purpose
Design and execute sumo logic workflows using data importer controls with validated outcomes.
