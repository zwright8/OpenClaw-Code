...
description: Use when tasks require json migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# JSON Migration Assistant

## Purpose
Design and execute json workflows using migration assistant controls with validated outcomes.
...
- Domain: [JSON](../../resources/domains/json.md)
