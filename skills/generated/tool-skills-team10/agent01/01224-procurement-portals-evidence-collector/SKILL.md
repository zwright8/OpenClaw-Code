---
name: procurement-portals-evidence-collector
description: Use when tasks require procurement portals evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Evidence Collector

## Purpose
Design and execute procurement portals workflows using evidence collector controls with validated outcomes.
