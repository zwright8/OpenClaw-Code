---
name: government-records-state-reconciler
description: Use when tasks require government records state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records State Reconciler

## Purpose
Design and execute government records workflows using state reconciler controls with validated outcomes.
