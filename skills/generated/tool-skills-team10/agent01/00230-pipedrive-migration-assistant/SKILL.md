...
description: Use when tasks require pipedrive migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Pipedrive Migration Assistant

## Purpose
Design and execute pipedrive workflows using migration assistant controls with validated outcomes.
...
- Domain: [Pipedrive](../../resources/domains/pipedrive.md)
