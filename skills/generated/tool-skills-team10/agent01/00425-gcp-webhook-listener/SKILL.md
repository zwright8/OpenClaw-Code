...
description: Use when tasks require gcp webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GCP Webhook Listener

## Purpose
Design and execute gcp workflows using webhook listener controls with validated outcomes.
