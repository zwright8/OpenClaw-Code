...
description: Use when tasks require ghost migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ghost Migration Assistant

## Purpose
Design and execute ghost workflows using migration assistant controls with validated outcomes.
...
- Domain: [Ghost](../../resources/domains/ghost.md)
