...
description: Use when tasks require sentry approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sentry Approval Router

## Purpose
Design and execute sentry workflows using approval router controls with validated outcomes.
