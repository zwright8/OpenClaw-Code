---
name: procurement-portals-risk-scorer
description: Use when tasks require procurement portals risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procurement Portals Risk Scorer

## Purpose
Design and execute procurement portals workflows using risk scorer controls with validated outcomes.
