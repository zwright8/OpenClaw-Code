...
description: Use when tasks require outlook report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Outlook Report Builder

## Purpose
Design and execute outlook workflows using report builder controls with validated outcomes.
