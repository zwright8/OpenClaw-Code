...
description: Use when tasks require hugging face workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hugging Face Workflow Automator

## Purpose
Design and execute hugging face workflows using workflow automator controls with validated outcomes.
