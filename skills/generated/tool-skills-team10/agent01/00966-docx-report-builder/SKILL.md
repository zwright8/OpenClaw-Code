...
description: Use when tasks require docx report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# DOCX Report Builder

## Purpose
Design and execute docx workflows using report builder controls with validated outcomes.
