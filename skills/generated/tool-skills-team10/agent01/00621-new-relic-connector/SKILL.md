...
description: Use when tasks require new relic connector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# New Relic Connector

## Purpose
Design and execute new relic workflows using connector controls with validated outcomes.
