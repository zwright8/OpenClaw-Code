...
description: Use when tasks require docker migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Docker Migration Assistant

## Purpose
Design and execute docker workflows using migration assistant controls with validated outcomes.
...
- Domain: [Docker](../../resources/domains/docker.md)
