...
description: Use when tasks require google calendar webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Google Calendar Webhook Listener

## Purpose
Design and execute google calendar workflows using webhook listener controls with validated outcomes.
