...
description: Use when tasks require gitlab workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# GitLab Workflow Automator

## Purpose
Design and execute gitlab workflows using workflow automator controls with validated outcomes.
