---
name: government-records-anomaly-detector
description: Use when tasks require government records anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Anomaly Detector

## Purpose
Design and execute government records workflows using anomaly detector controls with validated outcomes.
