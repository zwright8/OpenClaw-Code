---
name: patent-filings-operation-planner
description: Use when tasks require patent filings operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patent Filings Operation Planner

## Purpose
Design and execute patent filings workflows using operation planner controls with validated outcomes.
