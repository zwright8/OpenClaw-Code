...
description: Use when tasks require intercom webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Intercom Webhook Listener

## Purpose
Design and execute intercom workflows using webhook listener controls with validated outcomes.
