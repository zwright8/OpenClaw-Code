---
name: government-records-snapshot-manager
description: Use when tasks require government records snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Government Records Snapshot Manager

## Purpose
Design and execute government records workflows using snapshot manager controls with validated outcomes.
