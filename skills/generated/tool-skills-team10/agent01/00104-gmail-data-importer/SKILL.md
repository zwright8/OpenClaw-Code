...
description: Use when tasks require gmail data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Gmail Data Importer

## Purpose
Design and execute gmail workflows using data importer controls with validated outcomes.
