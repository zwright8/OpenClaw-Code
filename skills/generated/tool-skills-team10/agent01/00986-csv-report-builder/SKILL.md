...
description: Use when tasks require csv report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CSV Report Builder

## Purpose
Design and execute csv workflows using report builder controls with validated outcomes.
