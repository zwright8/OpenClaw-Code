...
description: Use when tasks require elasticsearch report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Elasticsearch Report Builder

## Purpose
Design and execute elasticsearch workflows using report builder controls with validated outcomes.
