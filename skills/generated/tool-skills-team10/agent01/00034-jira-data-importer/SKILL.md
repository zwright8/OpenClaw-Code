...
description: Use when tasks require jira data importer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Jira Data Importer

## Purpose
Design and execute jira workflows using data importer controls with validated outcomes.
