...
description: Use when tasks require sumo logic workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sumo Logic Workflow Automator

## Purpose
Design and execute sumo logic workflows using workflow automator controls with validated outcomes.
