---
name: court-dockets-feedback-harvester
description: Use when tasks require court dockets feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Feedback Harvester

## Purpose
Design and execute court dockets workflows using feedback harvester controls with validated outcomes.
