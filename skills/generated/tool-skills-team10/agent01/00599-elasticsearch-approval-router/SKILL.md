...
description: Use when tasks require elasticsearch approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Elasticsearch Approval Router

## Purpose
Design and execute elasticsearch workflows using approval router controls with validated outcomes.
