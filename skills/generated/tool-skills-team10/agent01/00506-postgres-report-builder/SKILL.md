...
description: Use when tasks require postgres report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Postgres Report Builder

## Purpose
Design and execute postgres workflows using report builder controls with validated outcomes.
