---
name: court-dockets-root-cause-miner
description: Use when tasks require court dockets root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Court Dockets Root Cause Miner

## Purpose
Design and execute court dockets workflows using root cause miner controls with validated outcomes.
