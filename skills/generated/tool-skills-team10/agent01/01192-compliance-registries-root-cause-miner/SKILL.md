---
name: compliance-registries-root-cause-miner
description: Use when tasks require compliance registries root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Compliance Registries Root Cause Miner

## Purpose
Design and execute compliance registries workflows using root cause miner controls with validated outcomes.
