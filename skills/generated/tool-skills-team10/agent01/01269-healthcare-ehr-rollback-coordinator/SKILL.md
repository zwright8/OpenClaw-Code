---
name: healthcare-ehr-rollback-coordinator
description: Use when tasks require healthcare ehr rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Healthcare EHR Rollback Coordinator

## Purpose
Design and execute healthcare ehr workflows using rollback coordinator controls with validated outcomes.
