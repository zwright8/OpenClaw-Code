...
description: Use when tasks require zendesk report builder with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Zendesk Report Builder

## Purpose
Design and execute zendesk workflows using report builder controls with validated outcomes.
