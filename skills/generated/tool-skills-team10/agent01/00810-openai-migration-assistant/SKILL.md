...
description: Use when tasks require openai migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# OpenAI Migration Assistant

## Purpose
Design and execute openai workflows using migration assistant controls with validated outcomes.
...
- Domain: [OpenAI](../../resources/domains/openai.md)
