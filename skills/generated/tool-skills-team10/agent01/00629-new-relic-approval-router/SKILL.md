...
description: Use when tasks require new relic approval router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# New Relic Approval Router

## Purpose
Design and execute new relic workflows using approval router controls with validated outcomes.
