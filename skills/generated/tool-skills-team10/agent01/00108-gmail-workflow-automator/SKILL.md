...
description: Use when tasks require gmail workflow automator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Gmail Workflow Automator

## Purpose
Design and execute gmail workflows using workflow automator controls with validated outcomes.
