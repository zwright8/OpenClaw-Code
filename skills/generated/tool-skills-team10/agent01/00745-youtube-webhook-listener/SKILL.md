...
description: Use when tasks require youtube webhook listener with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# YouTube Webhook Listener

## Purpose
Design and execute youtube workflows using webhook listener controls with validated outcomes.
