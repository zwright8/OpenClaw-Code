...
description: Use when tasks require postgres migration assistant with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Postgres Migration Assistant

## Purpose
Design and execute postgres workflows using migration assistant controls with validated outcomes.
...
- Domain: [Postgres](../../resources/domains/postgres.md)
