...
description: Use when tasks require billing recovery feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Feedback Harvester

## Purpose
Design and execute billing recovery workflows using feedback harvester controls with validated outcomes.
