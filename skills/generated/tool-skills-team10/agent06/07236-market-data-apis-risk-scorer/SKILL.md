---
name: market-data-apis-risk-scorer
description: Use when tasks require market data apis risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Risk Scorer

## Purpose
Design and execute market data apis workflows using risk scorer controls with validated outcomes.
