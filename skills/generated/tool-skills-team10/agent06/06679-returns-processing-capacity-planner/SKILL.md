---
name: returns-processing-capacity-planner
description: Use when tasks require returns processing capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Capacity Planner

## Purpose
Design and execute returns processing workflows using capacity planner controls with validated outcomes.
