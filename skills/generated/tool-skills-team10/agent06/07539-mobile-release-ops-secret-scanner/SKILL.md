---
name: mobile-release-ops-secret-scanner
description: Use when tasks require mobile release ops secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobile Release Ops Secret Scanner

## Purpose
Design and execute mobile release ops workflows using secret scanner controls with validated outcomes.
