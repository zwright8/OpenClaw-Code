---
name: regulatory-feeds-operation-planner
description: Use when tasks require regulatory feeds operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Operation Planner

## Purpose
Design and execute regulatory feeds workflows using operation planner controls with validated outcomes.
