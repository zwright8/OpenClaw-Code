---
name: device-labs-version-tracker
description: Use when tasks require device labs version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Version Tracker

## Purpose
Design and execute device labs workflows using version tracker controls with validated outcomes.
