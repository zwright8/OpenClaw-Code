---
name: returns-processing-evidence-collector
description: Use when tasks require returns processing evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Evidence Collector

## Purpose
Design and execute returns processing workflows using evidence collector controls with validated outcomes.
