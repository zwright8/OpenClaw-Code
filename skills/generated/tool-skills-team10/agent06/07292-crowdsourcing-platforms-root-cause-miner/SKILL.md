---
name: crowdsourcing-platforms-root-cause-miner
description: Use when tasks require crowdsourcing platforms root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Crowdsourcing Platforms Root Cause Miner

## Purpose
Design and execute crowdsourcing platforms workflows using root cause miner controls with validated outcomes.
