---
name: mobile-release-ops-auth-broker
description: Use when tasks require mobile release ops auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobile Release Ops Auth Broker

## Purpose
Design and execute mobile release ops workflows using auth broker controls with validated outcomes.
