---
name: open-source-intelligence-outcome-synthesizer
description: Use when tasks require open source intelligence outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Outcome Synthesizer

## Purpose
Design and execute open source intelligence workflows using outcome synthesizer controls with validated outcomes.
