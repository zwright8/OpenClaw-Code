---
name: a-b-testing-secret-scanner
description: Use when tasks require a/b testing secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Secret Scanner

## Purpose
Design and execute a/b testing workflows using secret scanner controls with validated outcomes.
