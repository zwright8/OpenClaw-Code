---
name: a-b-testing-task-decomposer
description: Use when tasks require a/b testing task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Task Decomposer

## Purpose
Design and execute a/b testing workflows using task decomposer controls with validated outcomes.
