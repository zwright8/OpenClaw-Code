---
name: news-monitoring-postmortem-drafting
description: Use when tasks require news monitoring postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Postmortem Drafting

## Purpose
Design and execute news monitoring workflows using postmortem drafting controls with validated outcomes.
