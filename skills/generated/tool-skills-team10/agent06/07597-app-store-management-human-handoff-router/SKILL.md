---
name: app-store-management-human-handoff-router
description: Use when tasks require app store management human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Human Handoff Router

## Purpose
Design and execute app store management workflows using human handoff router controls with validated outcomes.
