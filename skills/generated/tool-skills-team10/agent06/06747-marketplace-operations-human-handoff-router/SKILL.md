---
name: marketplace-operations-human-handoff-router
description: Use when tasks require marketplace operations human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Human Handoff Router

## Purpose
Design and execute marketplace operations workflows using human handoff router controls with validated outcomes.
