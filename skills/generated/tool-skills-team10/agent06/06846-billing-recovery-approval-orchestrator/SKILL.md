---
name: billing-recovery-approval-orchestrator
description: Use when tasks require billing recovery approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Approval Orchestrator

## Purpose
Design and execute billing recovery workflows using approval orchestrator controls with validated outcomes.
