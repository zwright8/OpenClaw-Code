---
name: in-app-messaging-root-cause-miner
description: Use when tasks require in-app messaging root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Root Cause Miner

## Purpose
Design and execute in-app messaging workflows using root cause miner controls with validated outcomes.
