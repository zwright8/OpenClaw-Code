---
name: mobile-release-ops-capacity-planner
description: Use when tasks require mobile release ops capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobile Release Ops Capacity Planner

## Purpose
Design and execute mobile release ops workflows using capacity planner controls with validated outcomes.
