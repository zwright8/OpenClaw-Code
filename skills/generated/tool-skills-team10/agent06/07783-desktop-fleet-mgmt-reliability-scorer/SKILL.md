---
name: desktop-fleet-mgmt-reliability-scorer
description: Use when tasks require desktop fleet mgmt reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Reliability Scorer

## Purpose
Design and execute desktop fleet mgmt workflows using reliability scorer controls with validated outcomes.
