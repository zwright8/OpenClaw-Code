---
name: news-monitoring-operation-planner
description: Use when tasks require news monitoring operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Operation Planner

## Purpose
Design and execute news monitoring workflows using operation planner controls with validated outcomes.
