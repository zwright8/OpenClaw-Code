---
name: behavior-analytics-secret-scanner
description: Use when tasks require behavior analytics secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Secret Scanner

## Purpose
Design and execute behavior analytics workflows using secret scanner controls with validated outcomes.
