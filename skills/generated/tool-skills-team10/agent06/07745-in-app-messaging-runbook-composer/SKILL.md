---
name: in-app-messaging-runbook-composer
description: Use when tasks require in-app messaging runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Runbook Composer

## Purpose
Design and execute in-app messaging workflows using runbook composer controls with validated outcomes.
