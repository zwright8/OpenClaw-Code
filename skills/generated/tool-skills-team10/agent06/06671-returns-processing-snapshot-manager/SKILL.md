---
name: returns-processing-snapshot-manager
description: Use when tasks require returns processing snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Snapshot Manager

## Purpose
Design and execute returns processing workflows using snapshot manager controls with validated outcomes.
