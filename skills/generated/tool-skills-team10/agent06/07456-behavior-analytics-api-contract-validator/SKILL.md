---
name: behavior-analytics-api-contract-validator
description: Use when tasks require behavior analytics api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics API Contract Validator

## Purpose
Design and execute behavior analytics workflows using api contract validator controls with validated outcomes.
