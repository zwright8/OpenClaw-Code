---
name: regulatory-feeds-secret-scanner
description: Use when tasks require regulatory feeds secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Secret Scanner

## Purpose
Design and execute regulatory feeds workflows using secret scanner controls with validated outcomes.
