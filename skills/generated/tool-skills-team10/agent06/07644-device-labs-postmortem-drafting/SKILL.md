---
name: device-labs-postmortem-drafting
description: Use when tasks require device labs postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Postmortem Drafting

## Purpose
Design and execute device labs workflows using postmortem drafting controls with validated outcomes.
