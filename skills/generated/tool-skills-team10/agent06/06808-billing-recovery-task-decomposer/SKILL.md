---
name: billing-recovery-task-decomposer
description: Use when tasks require billing recovery task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Task Decomposer

## Purpose
Design and execute billing recovery workflows using task decomposer controls with validated outcomes.
