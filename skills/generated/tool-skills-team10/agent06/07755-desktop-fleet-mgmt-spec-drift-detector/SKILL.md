---
name: desktop-fleet-mgmt-spec-drift-detector
description: Use when tasks require desktop fleet mgmt spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Spec Drift Detector

## Purpose
Design and execute desktop fleet mgmt workflows using spec drift detector controls with validated outcomes.
