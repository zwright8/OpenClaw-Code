---
name: forecasting-models-incident-triage
description: Use when tasks require forecasting models incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Incident Triage

## Purpose
Design and execute forecasting models workflows using incident triage controls with validated outcomes.
