---
name: news-monitoring-rate-limit-optimizer
description: Use when tasks require news monitoring rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Rate Limit Optimizer

## Purpose
Design and execute news monitoring workflows using rate limit optimizer controls with validated outcomes.
