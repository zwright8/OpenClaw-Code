---
name: billing-recovery-runbook-composer
description: Use when tasks require billing recovery runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Runbook Composer

## Purpose
Design and execute billing recovery workflows using runbook composer controls with validated outcomes.
