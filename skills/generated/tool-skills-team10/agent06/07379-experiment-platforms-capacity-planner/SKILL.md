---
name: experiment-platforms-capacity-planner
description: Use when tasks require experiment platforms capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Experiment Platforms Capacity Planner

## Purpose
Design and execute experiment platforms workflows using capacity planner controls with validated outcomes.
