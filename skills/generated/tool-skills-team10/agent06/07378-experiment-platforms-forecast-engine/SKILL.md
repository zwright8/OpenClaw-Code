---
name: experiment-platforms-forecast-engine
description: Use when tasks require experiment platforms forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Experiment Platforms Forecast Engine

## Purpose
Design and execute experiment platforms workflows using forecast engine controls with validated outcomes.
