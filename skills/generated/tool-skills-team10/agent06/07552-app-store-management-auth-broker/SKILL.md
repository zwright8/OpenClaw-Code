---
name: app-store-management-auth-broker
description: Use when tasks require app store management auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Auth Broker

## Purpose
Design and execute app store management workflows using auth broker controls with validated outcomes.
