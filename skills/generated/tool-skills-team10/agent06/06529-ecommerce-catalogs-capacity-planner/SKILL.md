---
name: ecommerce-catalogs-capacity-planner
description: Use when tasks require ecommerce catalogs capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Capacity Planner

## Purpose
Design and execute ecommerce catalogs workflows using capacity planner controls with validated outcomes.
