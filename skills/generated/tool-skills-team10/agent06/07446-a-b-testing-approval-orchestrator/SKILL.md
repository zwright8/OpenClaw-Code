---
name: a-b-testing-approval-orchestrator
description: Use when tasks require a/b testing approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Approval Orchestrator

## Purpose
Design and execute a/b testing workflows using approval orchestrator controls with validated outcomes.
