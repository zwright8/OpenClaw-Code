---
name: regulatory-feeds-feedback-harvester
description: Use when tasks require regulatory feeds feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Feedback Harvester

## Purpose
Design and execute regulatory feeds workflows using feedback harvester controls with validated outcomes.
