---
name: regulatory-feeds-rollback-coordinator
description: Use when tasks require regulatory feeds rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Rollback Coordinator

## Purpose
Design and execute regulatory feeds workflows using rollback coordinator controls with validated outcomes.
