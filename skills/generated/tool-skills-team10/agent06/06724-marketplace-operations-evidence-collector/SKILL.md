---
name: marketplace-operations-evidence-collector
description: Use when tasks require marketplace operations evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Evidence Collector

## Purpose
Design and execute marketplace operations workflows using evidence collector controls with validated outcomes.
