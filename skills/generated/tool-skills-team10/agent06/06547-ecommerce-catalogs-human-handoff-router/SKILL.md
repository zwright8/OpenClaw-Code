---
name: ecommerce-catalogs-human-handoff-router
description: Use when tasks require ecommerce catalogs human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Human Handoff Router

## Purpose
Design and execute ecommerce catalogs workflows using human handoff router controls with validated outcomes.
