---
name: revenue-recognition-quality-gatekeeper
description: Use when tasks require revenue recognition quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Quality Gatekeeper

## Purpose
Design and execute revenue recognition workflows using quality gatekeeper controls with validated outcomes.
