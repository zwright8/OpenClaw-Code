---
name: market-data-apis-evidence-collector
description: Use when tasks require market data apis evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Evidence Collector

## Purpose
Design and execute market data apis workflows using evidence collector controls with validated outcomes.
