---
name: competitive-intelligence-spec-drift-detector
description: Use when tasks require competitive intelligence spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Spec Drift Detector

## Purpose
Design and execute competitive intelligence workflows using spec drift detector controls with validated outcomes.
