---
name: news-monitoring-risk-scorer
description: Use when tasks require news monitoring risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Risk Scorer

## Purpose
Design and execute news monitoring workflows using risk scorer controls with validated outcomes.
