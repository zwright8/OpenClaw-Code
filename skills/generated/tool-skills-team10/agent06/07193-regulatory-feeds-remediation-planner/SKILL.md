---
name: regulatory-feeds-remediation-planner
description: Use when tasks require regulatory feeds remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Remediation Planner

## Purpose
Design and execute regulatory feeds workflows using remediation planner controls with validated outcomes.
