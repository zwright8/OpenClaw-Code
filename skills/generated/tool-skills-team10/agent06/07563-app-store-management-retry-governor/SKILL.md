---
name: app-store-management-retry-governor
description: Use when tasks require app store management retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Retry Governor

## Purpose
Design and execute app store management workflows using retry governor controls with validated outcomes.
