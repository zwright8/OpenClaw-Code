---
name: a-b-testing-evidence-collector
description: Use when tasks require a/b testing evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Evidence Collector

## Purpose
Design and execute a/b testing workflows using evidence collector controls with validated outcomes.
