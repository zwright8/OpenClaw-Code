---
name: marketplace-operations-artifact-publisher
description: Use when tasks require marketplace operations artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Artifact Publisher

## Purpose
Design and execute marketplace operations workflows using artifact publisher controls with validated outcomes.
