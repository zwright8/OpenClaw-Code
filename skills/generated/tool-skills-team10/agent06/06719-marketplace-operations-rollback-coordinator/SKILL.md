---
name: marketplace-operations-rollback-coordinator
description: Use when tasks require marketplace operations rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Rollback Coordinator

## Purpose
Design and execute marketplace operations workflows using rollback coordinator controls with validated outcomes.
