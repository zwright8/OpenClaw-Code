---
name: order-management-execution-runner
description: Use when tasks require order management execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Execution Runner

## Purpose
Design and execute order management workflows using execution runner controls with validated outcomes.
