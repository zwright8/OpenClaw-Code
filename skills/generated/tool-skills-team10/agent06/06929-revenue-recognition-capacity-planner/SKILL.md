---
name: revenue-recognition-capacity-planner
description: Use when tasks require revenue recognition capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Capacity Planner

## Purpose
Design and execute revenue recognition workflows using capacity planner controls with validated outcomes.
