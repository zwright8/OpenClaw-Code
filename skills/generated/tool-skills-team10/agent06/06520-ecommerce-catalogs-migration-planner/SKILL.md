---
name: ecommerce-catalogs-migration-planner
description: Use when tasks require ecommerce catalogs migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Migration Planner

## Purpose
Design and execute ecommerce catalogs workflows using migration planner controls with validated outcomes.
