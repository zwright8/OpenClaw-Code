---
name: forecasting-models-rate-limit-optimizer
description: Use when tasks require forecasting models rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Rate Limit Optimizer

## Purpose
Design and execute forecasting models workflows using rate limit optimizer controls with validated outcomes.
