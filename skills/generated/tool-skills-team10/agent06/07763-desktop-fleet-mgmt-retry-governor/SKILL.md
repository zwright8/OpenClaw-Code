---
name: desktop-fleet-mgmt-retry-governor
description: Use when tasks require desktop fleet mgmt retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Retry Governor

## Purpose
Design and execute desktop fleet mgmt workflows using retry governor controls with validated outcomes.
