---
name: competitive-intelligence-schema-introspector
description: Use when tasks require competitive intelligence schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Schema Introspector

## Purpose
Design and execute competitive intelligence workflows using schema introspector controls with validated outcomes.
