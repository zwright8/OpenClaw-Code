---
name: desktop-fleet-mgmt-capacity-planner
description: Use when tasks require desktop fleet mgmt capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Capacity Planner

## Purpose
Design and execute desktop fleet mgmt workflows using capacity planner controls with validated outcomes.
