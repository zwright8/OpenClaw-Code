---
name: returns-processing-task-decomposer
description: Use when tasks require returns processing task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Task Decomposer

## Purpose
Design and execute returns processing workflows using task decomposer controls with validated outcomes.
