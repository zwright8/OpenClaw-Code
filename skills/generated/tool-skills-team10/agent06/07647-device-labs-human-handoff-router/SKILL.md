---
name: device-labs-human-handoff-router
description: Use when tasks require device labs human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Human Handoff Router

## Purpose
Design and execute device labs workflows using human handoff router controls with validated outcomes.
