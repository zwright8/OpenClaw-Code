---
name: news-monitoring-retry-governor
description: Use when tasks require news monitoring retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Retry Governor

## Purpose
Design and execute news monitoring workflows using retry governor controls with validated outcomes.
