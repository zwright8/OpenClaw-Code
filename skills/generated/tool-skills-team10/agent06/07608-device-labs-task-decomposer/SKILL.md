---
name: device-labs-task-decomposer
description: Use when tasks require device labs task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Task Decomposer

## Purpose
Design and execute device labs workflows using task decomposer controls with validated outcomes.
