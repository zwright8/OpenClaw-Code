---
name: competitive-intelligence-permission-mapper
description: Use when tasks require competitive intelligence permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Permission Mapper

## Purpose
Design and execute competitive intelligence workflows using permission mapper controls with validated outcomes.
