---
name: a-b-testing-access-auditor
description: Use when tasks require a/b testing access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Access Auditor

## Purpose
Design and execute a/b testing workflows using access auditor controls with validated outcomes.
