---
name: in-app-messaging-compliance-mapper
description: Use when tasks require in-app messaging compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Compliance Mapper

## Purpose
Design and execute in-app messaging workflows using compliance mapper controls with validated outcomes.
