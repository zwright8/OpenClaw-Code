---
name: device-labs-forecast-engine
description: Use when tasks require device labs forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Forecast Engine

## Purpose
Design and execute device labs workflows using forecast engine controls with validated outcomes.
