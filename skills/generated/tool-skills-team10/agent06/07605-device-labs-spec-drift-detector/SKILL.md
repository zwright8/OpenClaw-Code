---
name: device-labs-spec-drift-detector
description: Use when tasks require device labs spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Spec Drift Detector

## Purpose
Design and execute device labs workflows using spec drift detector controls with validated outcomes.
