---
name: a-b-testing-human-handoff-router
description: Use when tasks require a/b testing human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Human Handoff Router

## Purpose
Design and execute a/b testing workflows using human handoff router controls with validated outcomes.
