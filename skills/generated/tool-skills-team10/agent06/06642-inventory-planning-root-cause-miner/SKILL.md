---
name: inventory-planning-root-cause-miner
description: Use when tasks require inventory planning root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Root Cause Miner

## Purpose
Design and execute inventory planning workflows using root cause miner controls with validated outcomes.
