---
name: subscription-platforms-root-cause-miner
description: Use when tasks require subscription platforms root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Subscription Platforms Root Cause Miner

## Purpose
Design and execute subscription platforms workflows using root cause miner controls with validated outcomes.
