---
name: revenue-recognition-evidence-collector
description: Use when tasks require revenue recognition evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Evidence Collector

## Purpose
Design and execute revenue recognition workflows using evidence collector controls with validated outcomes.
