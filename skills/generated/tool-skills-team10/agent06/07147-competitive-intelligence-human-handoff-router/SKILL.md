---
name: competitive-intelligence-human-handoff-router
description: Use when tasks require competitive intelligence human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Human Handoff Router

## Purpose
Design and execute competitive intelligence workflows using human handoff router controls with validated outcomes.
