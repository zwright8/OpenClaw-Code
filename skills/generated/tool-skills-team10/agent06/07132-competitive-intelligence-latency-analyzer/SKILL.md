---
name: competitive-intelligence-latency-analyzer
description: Use when tasks require competitive intelligence latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Latency Analyzer

## Purpose
Design and execute competitive intelligence workflows using latency analyzer controls with validated outcomes.
