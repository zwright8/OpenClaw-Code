---
name: marketplace-operations-forecast-engine
description: Use when tasks require marketplace operations forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Forecast Engine

## Purpose
Design and execute marketplace operations workflows using forecast engine controls with validated outcomes.
