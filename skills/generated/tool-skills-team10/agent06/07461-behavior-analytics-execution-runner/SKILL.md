---
name: behavior-analytics-execution-runner
description: Use when tasks require behavior analytics execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Execution Runner

## Purpose
Design and execute behavior analytics workflows using execution runner controls with validated outcomes.
