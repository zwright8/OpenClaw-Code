---
name: competitive-intelligence-runbook-composer
description: Use when tasks require competitive intelligence runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Runbook Composer

## Purpose
Design and execute competitive intelligence workflows using runbook composer controls with validated outcomes.
