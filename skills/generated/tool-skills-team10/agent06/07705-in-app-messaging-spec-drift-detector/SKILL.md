---
name: in-app-messaging-spec-drift-detector
description: Use when tasks require in-app messaging spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Spec Drift Detector

## Purpose
Design and execute in-app messaging workflows using spec drift detector controls with validated outcomes.
