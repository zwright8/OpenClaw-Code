---
name: returns-processing-approval-orchestrator
description: Use when tasks require returns processing approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Approval Orchestrator

## Purpose
Design and execute returns processing workflows using approval orchestrator controls with validated outcomes.
