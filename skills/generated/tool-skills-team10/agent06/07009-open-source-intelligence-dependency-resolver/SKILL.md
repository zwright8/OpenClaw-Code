---
name: open-source-intelligence-dependency-resolver
description: Use when tasks require open source intelligence dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Dependency Resolver

## Purpose
Design and execute open source intelligence workflows using dependency resolver controls with validated outcomes.
