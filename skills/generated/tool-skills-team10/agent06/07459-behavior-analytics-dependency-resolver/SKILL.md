...
description: Use when tasks require behavior analytics dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Dependency Resolver

## Purpose
Design and execute behavior analytics workflows using dependency resolver controls with validated outcomes.
