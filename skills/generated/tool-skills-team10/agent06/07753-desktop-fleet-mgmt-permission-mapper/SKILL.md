---
name: desktop-fleet-mgmt-permission-mapper
description: Use when tasks require desktop fleet mgmt permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Permission Mapper

## Purpose
Design and execute desktop fleet mgmt workflows using permission mapper controls with validated outcomes.
