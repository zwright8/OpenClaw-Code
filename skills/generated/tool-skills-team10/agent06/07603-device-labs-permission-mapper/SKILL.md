---
name: device-labs-permission-mapper
description: Use when tasks require device labs permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Permission Mapper

## Purpose
Design and execute device labs workflows using permission mapper controls with validated outcomes.
