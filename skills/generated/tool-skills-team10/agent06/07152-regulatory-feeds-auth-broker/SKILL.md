---
name: regulatory-feeds-auth-broker
description: Use when tasks require regulatory feeds auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Auth Broker

## Purpose
Design and execute regulatory feeds workflows using auth broker controls with validated outcomes.
