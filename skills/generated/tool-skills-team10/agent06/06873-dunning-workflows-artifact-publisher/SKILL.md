---
name: dunning-workflows-artifact-publisher
description: Use when tasks require dunning workflows artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Dunning Workflows Artifact Publisher

## Purpose
Design and execute dunning workflows workflows using artifact publisher controls with validated outcomes.
