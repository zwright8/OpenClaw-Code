---
name: competitive-intelligence-migration-planner
description: Use when tasks require competitive intelligence migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Migration Planner

## Purpose
Design and execute competitive intelligence workflows using migration planner controls with validated outcomes.
