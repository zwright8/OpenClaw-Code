---
name: order-management-artifact-publisher
description: Use when tasks require order management artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Artifact Publisher

## Purpose
Design and execute order management workflows using artifact publisher controls with validated outcomes.
