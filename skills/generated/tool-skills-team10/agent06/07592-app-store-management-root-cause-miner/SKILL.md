---
name: app-store-management-root-cause-miner
description: Use when tasks require app store management root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Root Cause Miner

## Purpose
Design and execute app store management workflows using root cause miner controls with validated outcomes.
