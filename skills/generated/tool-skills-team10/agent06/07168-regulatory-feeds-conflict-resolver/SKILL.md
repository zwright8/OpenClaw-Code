---
name: regulatory-feeds-conflict-resolver
description: Use when tasks require regulatory feeds conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Conflict Resolver

## Purpose
Design and execute regulatory feeds workflows using conflict resolver controls with validated outcomes.
