---
name: behavior-analytics-policy-evaluator
description: Use when tasks require behavior analytics policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Policy Evaluator

## Purpose
Design and execute behavior analytics workflows using policy evaluator controls with validated outcomes.
