---
name: device-labs-workflow-compiler
description: Use when tasks require device labs workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Workflow Compiler

## Purpose
Design and execute device labs workflows using workflow compiler controls with validated outcomes.
