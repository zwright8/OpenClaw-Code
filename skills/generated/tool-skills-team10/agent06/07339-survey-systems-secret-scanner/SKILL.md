---
name: survey-systems-secret-scanner
description: Use when tasks require survey systems secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Secret Scanner

## Purpose
Design and execute survey systems workflows using secret scanner controls with validated outcomes.
