---
name: billing-recovery-conflict-resolver
description: Use when tasks require billing recovery conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Conflict Resolver

## Purpose
Design and execute billing recovery workflows using conflict resolver controls with validated outcomes.
