---
name: returns-processing-execution-runner
description: Use when tasks require returns processing execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Execution Runner

## Purpose
Design and execute returns processing workflows using execution runner controls with validated outcomes.
