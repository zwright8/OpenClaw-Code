---
name: in-app-messaging-workflow-compiler
description: Use when tasks require in-app messaging workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Workflow Compiler

## Purpose
Design and execute in-app messaging workflows using workflow compiler controls with validated outcomes.
