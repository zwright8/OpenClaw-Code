---
name: forecasting-models-job-scheduler
description: Use when tasks require forecasting models job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Job Scheduler

## Purpose
Design and execute forecasting models workflows using job scheduler controls with validated outcomes.
