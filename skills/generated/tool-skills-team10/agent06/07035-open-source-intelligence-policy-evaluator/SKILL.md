---
name: open-source-intelligence-policy-evaluator
description: Use when tasks require open source intelligence policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Policy Evaluator

## Purpose
Design and execute open source intelligence workflows using policy evaluator controls with validated outcomes.
