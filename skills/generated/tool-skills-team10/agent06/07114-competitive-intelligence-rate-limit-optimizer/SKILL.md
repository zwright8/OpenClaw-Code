---
name: competitive-intelligence-rate-limit-optimizer
description: Use when tasks require competitive intelligence rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Rate Limit Optimizer

## Purpose
Design and execute competitive intelligence workflows using rate limit optimizer controls with validated outcomes.
