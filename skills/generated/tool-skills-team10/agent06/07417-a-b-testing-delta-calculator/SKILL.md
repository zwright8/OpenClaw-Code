---
name: a-b-testing-delta-calculator
description: Use when tasks require a/b testing delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Delta Calculator

## Purpose
Design and execute a/b testing workflows using delta calculator controls with validated outcomes.
