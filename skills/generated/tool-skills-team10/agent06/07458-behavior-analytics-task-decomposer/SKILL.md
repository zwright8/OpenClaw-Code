---
name: behavior-analytics-task-decomposer
description: Use when tasks require behavior analytics task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Task Decomposer

## Purpose
Design and execute behavior analytics workflows using task decomposer controls with validated outcomes.
