---
name: returns-processing-permission-mapper
description: Use when tasks require returns processing permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Permission Mapper

## Purpose
Design and execute returns processing workflows using permission mapper controls with validated outcomes.
