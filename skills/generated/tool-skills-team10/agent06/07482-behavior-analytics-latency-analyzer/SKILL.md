---
name: behavior-analytics-latency-analyzer
description: Use when tasks require behavior analytics latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Latency Analyzer

## Purpose
Design and execute behavior analytics workflows using latency analyzer controls with validated outcomes.
