---
name: returns-processing-runbook-composer
description: Use when tasks require returns processing runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Runbook Composer

## Purpose
Design and execute returns processing workflows using runbook composer controls with validated outcomes.
