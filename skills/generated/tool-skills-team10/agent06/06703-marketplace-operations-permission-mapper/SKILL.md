---
name: marketplace-operations-permission-mapper
description: Use when tasks require marketplace operations permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Permission Mapper

## Purpose
Design and execute marketplace operations workflows using permission mapper controls with validated outcomes.
