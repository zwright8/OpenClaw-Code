---
name: forecasting-models-forecast-engine
description: Use when tasks require forecasting models forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Forecast Engine

## Purpose
Design and execute forecasting models workflows using forecast engine controls with validated outcomes.
