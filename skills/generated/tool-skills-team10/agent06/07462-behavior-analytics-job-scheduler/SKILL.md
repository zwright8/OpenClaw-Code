---
name: behavior-analytics-job-scheduler
description: Use when tasks require behavior analytics job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Job Scheduler

## Purpose
Design and execute behavior analytics workflows using job scheduler controls with validated outcomes.
