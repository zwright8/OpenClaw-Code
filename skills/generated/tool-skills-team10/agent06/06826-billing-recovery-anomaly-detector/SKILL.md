---
name: billing-recovery-anomaly-detector
description: Use when tasks require billing recovery anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Anomaly Detector

## Purpose
Design and execute billing recovery workflows using anomaly detector controls with validated outcomes.
