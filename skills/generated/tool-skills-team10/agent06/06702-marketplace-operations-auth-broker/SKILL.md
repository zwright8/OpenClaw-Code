---
name: marketplace-operations-auth-broker
description: Use when tasks require marketplace operations auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Auth Broker

## Purpose
Design and execute marketplace operations workflows using auth broker controls with validated outcomes.
