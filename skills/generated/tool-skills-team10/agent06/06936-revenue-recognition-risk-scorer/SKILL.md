---
name: revenue-recognition-risk-scorer
description: Use when tasks require revenue recognition risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Risk Scorer

## Purpose
Design and execute revenue recognition workflows using risk scorer controls with validated outcomes.
