---
name: billing-recovery-auth-broker
description: Use when tasks require billing recovery auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Auth Broker

## Purpose
Design and execute billing recovery workflows using auth broker controls with validated outcomes.
