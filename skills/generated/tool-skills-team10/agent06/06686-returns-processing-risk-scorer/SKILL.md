---
name: returns-processing-risk-scorer
description: Use when tasks require returns processing risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Risk Scorer

## Purpose
Design and execute returns processing workflows using risk scorer controls with validated outcomes.
