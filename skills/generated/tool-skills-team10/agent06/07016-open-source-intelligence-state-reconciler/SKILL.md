---
name: open-source-intelligence-state-reconciler
description: Use when tasks require open source intelligence state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence State Reconciler

## Purpose
Design and execute open source intelligence workflows using state reconciler controls with validated outcomes.
