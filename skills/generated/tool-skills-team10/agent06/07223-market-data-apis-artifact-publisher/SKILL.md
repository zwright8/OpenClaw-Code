---
name: market-data-apis-artifact-publisher
description: Use when tasks require market data apis artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Artifact Publisher

## Purpose
Design and execute market data apis workflows using artifact publisher controls with validated outcomes.
