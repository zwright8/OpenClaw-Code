---
name: a-b-testing-artifact-publisher
description: Use when tasks require a/b testing artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Artifact Publisher

## Purpose
Design and execute a/b testing workflows using artifact publisher controls with validated outcomes.
