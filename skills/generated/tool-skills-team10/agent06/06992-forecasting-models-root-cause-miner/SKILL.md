---
name: forecasting-models-root-cause-miner
description: Use when tasks require forecasting models root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Root Cause Miner

## Purpose
Design and execute forecasting models workflows using root cause miner controls with validated outcomes.
