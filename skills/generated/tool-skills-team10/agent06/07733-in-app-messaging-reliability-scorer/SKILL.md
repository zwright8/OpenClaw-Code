---
name: in-app-messaging-reliability-scorer
description: Use when tasks require in-app messaging reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Reliability Scorer

## Purpose
Design and execute in-app messaging workflows using reliability scorer controls with validated outcomes.
