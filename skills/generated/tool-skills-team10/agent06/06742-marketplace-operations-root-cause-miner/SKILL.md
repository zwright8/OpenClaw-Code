---
name: marketplace-operations-root-cause-miner
description: Use when tasks require marketplace operations root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Root Cause Miner

## Purpose
Design and execute marketplace operations workflows using root cause miner controls with validated outcomes.
