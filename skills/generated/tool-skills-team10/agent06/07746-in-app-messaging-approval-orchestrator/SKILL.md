---
name: in-app-messaging-approval-orchestrator
description: Use when tasks require in-app messaging approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Approval Orchestrator

## Purpose
Design and execute in-app messaging workflows using approval orchestrator controls with validated outcomes.
