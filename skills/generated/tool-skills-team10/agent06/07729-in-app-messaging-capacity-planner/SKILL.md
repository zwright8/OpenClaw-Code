---
name: in-app-messaging-capacity-planner
description: Use when tasks require in-app messaging capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Capacity Planner

## Purpose
Design and execute in-app messaging workflows using capacity planner controls with validated outcomes.
