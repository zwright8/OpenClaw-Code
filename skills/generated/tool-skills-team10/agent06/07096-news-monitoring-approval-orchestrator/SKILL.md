---
name: news-monitoring-approval-orchestrator
description: Use when tasks require news monitoring approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Approval Orchestrator

## Purpose
Design and execute news monitoring workflows using approval orchestrator controls with validated outcomes.
