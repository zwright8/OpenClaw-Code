---
name: open-source-intelligence-migration-planner
description: Use when tasks require open source intelligence migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Migration Planner

## Purpose
Design and execute open source intelligence workflows using migration planner controls with validated outcomes.
