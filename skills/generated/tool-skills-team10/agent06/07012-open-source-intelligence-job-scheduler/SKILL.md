---
name: open-source-intelligence-job-scheduler
description: Use when tasks require open source intelligence job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Job Scheduler

## Purpose
Design and execute open source intelligence workflows using job scheduler controls with validated outcomes.
