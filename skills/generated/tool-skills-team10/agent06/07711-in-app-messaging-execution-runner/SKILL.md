---
name: in-app-messaging-execution-runner
description: Use when tasks require in-app messaging execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Execution Runner

## Purpose
Design and execute in-app messaging workflows using execution runner controls with validated outcomes.
