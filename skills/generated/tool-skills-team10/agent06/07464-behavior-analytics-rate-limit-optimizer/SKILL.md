---
name: behavior-analytics-rate-limit-optimizer
description: Use when tasks require behavior analytics rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Rate Limit Optimizer

## Purpose
Design and execute behavior analytics workflows using rate limit optimizer controls with validated outcomes.
