---
name: forecasting-models-workflow-compiler
description: Use when tasks require forecasting models workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Workflow Compiler

## Purpose
Design and execute forecasting models workflows using workflow compiler controls with validated outcomes.
