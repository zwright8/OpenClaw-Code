---
name: billing-recovery-delta-calculator
description: Use when tasks require billing recovery delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Delta Calculator

## Purpose
Design and execute billing recovery workflows using delta calculator controls with validated outcomes.
