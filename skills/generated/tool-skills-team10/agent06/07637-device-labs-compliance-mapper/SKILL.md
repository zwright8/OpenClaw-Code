---
name: device-labs-compliance-mapper
description: Use when tasks require device labs compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Compliance Mapper

## Purpose
Design and execute device labs workflows using compliance mapper controls with validated outcomes.
