---
name: returns-processing-secret-scanner
description: Use when tasks require returns processing secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Secret Scanner

## Purpose
Design and execute returns processing workflows using secret scanner controls with validated outcomes.
