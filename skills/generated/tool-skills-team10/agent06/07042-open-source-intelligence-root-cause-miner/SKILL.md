---
name: open-source-intelligence-root-cause-miner
description: Use when tasks require open source intelligence root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Root Cause Miner

## Purpose
Design and execute open source intelligence workflows using root cause miner controls with validated outcomes.
