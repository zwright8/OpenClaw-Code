---
name: regulatory-feeds-human-handoff-router
description: Use when tasks require regulatory feeds human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Human Handoff Router

## Purpose
Design and execute regulatory feeds workflows using human handoff router controls with validated outcomes.
