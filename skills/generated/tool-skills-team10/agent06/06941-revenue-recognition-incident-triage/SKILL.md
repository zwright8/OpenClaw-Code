---
name: revenue-recognition-incident-triage
description: Use when tasks require revenue recognition incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Incident Triage

## Purpose
Design and execute revenue recognition workflows using incident triage controls with validated outcomes.
