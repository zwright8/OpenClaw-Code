---
name: desktop-fleet-mgmt-conflict-resolver
description: Use when tasks require desktop fleet mgmt conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Conflict Resolver

## Purpose
Design and execute desktop fleet mgmt workflows using conflict resolver controls with validated outcomes.
