---
name: behavior-analytics-rollback-coordinator
description: Use when tasks require behavior analytics rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Rollback Coordinator

## Purpose
Design and execute behavior analytics workflows using rollback coordinator controls with validated outcomes.
