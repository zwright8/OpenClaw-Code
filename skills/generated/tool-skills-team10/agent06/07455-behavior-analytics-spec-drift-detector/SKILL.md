---
name: behavior-analytics-spec-drift-detector
description: Use when tasks require behavior analytics spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Spec Drift Detector

## Purpose
Design and execute behavior analytics workflows using spec drift detector controls with validated outcomes.
