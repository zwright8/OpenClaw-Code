---
name: open-source-intelligence-workflow-compiler
description: Use when tasks require open source intelligence workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Workflow Compiler

## Purpose
Design and execute open source intelligence workflows using workflow compiler controls with validated outcomes.
