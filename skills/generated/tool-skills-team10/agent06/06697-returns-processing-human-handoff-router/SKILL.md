---
name: returns-processing-human-handoff-router
description: Use when tasks require returns processing human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Human Handoff Router

## Purpose
Design and execute returns processing workflows using human handoff router controls with validated outcomes.
