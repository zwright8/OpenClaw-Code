---
name: app-store-management-operation-planner
description: Use when tasks require app store management operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Operation Planner

## Purpose
Design and execute app store management workflows using operation planner controls with validated outcomes.
