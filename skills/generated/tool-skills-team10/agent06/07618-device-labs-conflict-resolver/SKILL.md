---
name: device-labs-conflict-resolver
description: Use when tasks require device labs conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Conflict Resolver

## Purpose
Design and execute device labs workflows using conflict resolver controls with validated outcomes.
