---
name: a-b-testing-operation-planner
description: Use when tasks require a/b testing operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Operation Planner

## Purpose
Design and execute a/b testing workflows using operation planner controls with validated outcomes.
