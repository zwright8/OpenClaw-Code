---
name: experiment-platforms-evidence-collector
description: Use when tasks require experiment platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Experiment Platforms Evidence Collector

## Purpose
Design and execute experiment platforms workflows using evidence collector controls with validated outcomes.
