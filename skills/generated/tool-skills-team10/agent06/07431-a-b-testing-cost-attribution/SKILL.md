---
name: a-b-testing-cost-attribution
description: Use when tasks require a/b testing cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Cost Attribution

## Purpose
Design and execute a/b testing workflows using cost attribution controls with validated outcomes.
