---
name: marketplace-operations-anomaly-detector
description: Use when tasks require marketplace operations anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Anomaly Detector

## Purpose
Design and execute marketplace operations workflows using anomaly detector controls with validated outcomes.
