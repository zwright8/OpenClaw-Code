---
name: returns-processing-delta-calculator
description: Use when tasks require returns processing delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Delta Calculator

## Purpose
Design and execute returns processing workflows using delta calculator controls with validated outcomes.
