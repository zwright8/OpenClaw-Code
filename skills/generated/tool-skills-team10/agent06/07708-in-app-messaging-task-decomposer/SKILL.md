---
name: in-app-messaging-task-decomposer
description: Use when tasks require in-app messaging task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Task Decomposer

## Purpose
Design and execute in-app messaging workflows using task decomposer controls with validated outcomes.
