---
name: behavior-analytics-snapshot-manager
description: Use when tasks require behavior analytics snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Snapshot Manager

## Purpose
Design and execute behavior analytics workflows using snapshot manager controls with validated outcomes.
