---
name: in-app-messaging-artifact-publisher
description: Use when tasks require in-app messaging artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Artifact Publisher

## Purpose
Design and execute in-app messaging workflows using artifact publisher controls with validated outcomes.
