---
name: market-data-apis-feedback-harvester
description: Use when tasks require market data apis feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Feedback Harvester

## Purpose
Design and execute market data apis workflows using feedback harvester controls with validated outcomes.
