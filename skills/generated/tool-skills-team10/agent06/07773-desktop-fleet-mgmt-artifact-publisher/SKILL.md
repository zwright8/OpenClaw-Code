---
name: desktop-fleet-mgmt-artifact-publisher
description: Use when tasks require desktop fleet mgmt artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Artifact Publisher

## Purpose
Design and execute desktop fleet mgmt workflows using artifact publisher controls with validated outcomes.
