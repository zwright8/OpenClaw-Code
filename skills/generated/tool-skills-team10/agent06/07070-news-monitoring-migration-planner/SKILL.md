---
name: news-monitoring-migration-planner
description: Use when tasks require news monitoring migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Migration Planner

## Purpose
Design and execute news monitoring workflows using migration planner controls with validated outcomes.
