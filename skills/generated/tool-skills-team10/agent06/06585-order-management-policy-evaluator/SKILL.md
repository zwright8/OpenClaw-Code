---
name: order-management-policy-evaluator
description: Use when tasks require order management policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Policy Evaluator

## Purpose
Design and execute order management workflows using policy evaluator controls with validated outcomes.
