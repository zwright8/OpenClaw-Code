---
name: news-monitoring-rollback-coordinator
description: Use when tasks require news monitoring rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Rollback Coordinator

## Purpose
Design and execute news monitoring workflows using rollback coordinator controls with validated outcomes.
