---
name: in-app-messaging-queue-balancer
description: Use when tasks require in-app messaging queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Queue Balancer

## Purpose
Design and execute in-app messaging workflows using queue balancer controls with validated outcomes.
