---
name: subscription-platforms-risk-scorer
description: Use when tasks require subscription platforms risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Subscription Platforms Risk Scorer

## Purpose
Design and execute subscription platforms workflows using risk scorer controls with validated outcomes.
