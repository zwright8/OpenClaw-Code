---
name: marketplace-operations-reliability-scorer
description: Use when tasks require marketplace operations reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Reliability Scorer

## Purpose
Design and execute marketplace operations workflows using reliability scorer controls with validated outcomes.
