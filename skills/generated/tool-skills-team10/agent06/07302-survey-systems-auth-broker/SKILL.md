---
name: survey-systems-auth-broker
description: Use when tasks require survey systems auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Auth Broker

## Purpose
Design and execute survey systems workflows using auth broker controls with validated outcomes.
