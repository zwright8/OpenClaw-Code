---
name: in-app-messaging-schema-introspector
description: Use when tasks require in-app messaging schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Schema Introspector

## Purpose
Design and execute in-app messaging workflows using schema introspector controls with validated outcomes.
