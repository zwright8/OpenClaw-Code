---
name: market-data-apis-execution-runner
description: Use when tasks require market data apis execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Execution Runner

## Purpose
Design and execute market data apis workflows using execution runner controls with validated outcomes.
