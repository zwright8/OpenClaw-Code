---
name: open-source-intelligence-secret-scanner
description: Use when tasks require open source intelligence secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Secret Scanner

## Purpose
Design and execute open source intelligence workflows using secret scanner controls with validated outcomes.
