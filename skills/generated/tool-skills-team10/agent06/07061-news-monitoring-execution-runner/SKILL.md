---
name: news-monitoring-execution-runner
description: Use when tasks require news monitoring execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Execution Runner

## Purpose
Design and execute news monitoring workflows using execution runner controls with validated outcomes.
