---
name: regulatory-feeds-outcome-synthesizer
description: Use when tasks require regulatory feeds outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Outcome Synthesizer

## Purpose
Design and execute regulatory feeds workflows using outcome synthesizer controls with validated outcomes.
