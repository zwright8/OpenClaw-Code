---
name: order-management-dependency-resolver
description: Use when tasks require order management dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Dependency Resolver

## Purpose
Design and execute order management workflows using dependency resolver controls with validated outcomes.
