---
name: revenue-recognition-anomaly-detector
description: Use when tasks require revenue recognition anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Anomaly Detector

## Purpose
Design and execute revenue recognition workflows using anomaly detector controls with validated outcomes.
