---
name: news-monitoring-human-handoff-router
description: Use when tasks require news monitoring human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Human Handoff Router

## Purpose
Design and execute news monitoring workflows using human handoff router controls with validated outcomes.
