---
name: ecommerce-catalogs-policy-evaluator
description: Use when tasks require ecommerce catalogs policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Policy Evaluator

## Purpose
Design and execute ecommerce catalogs workflows using policy evaluator controls with validated outcomes.
