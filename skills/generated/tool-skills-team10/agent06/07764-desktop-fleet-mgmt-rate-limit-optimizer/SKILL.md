---
name: desktop-fleet-mgmt-rate-limit-optimizer
description: Use when tasks require desktop fleet mgmt rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Rate Limit Optimizer

## Purpose
Design and execute desktop fleet mgmt workflows using rate limit optimizer controls with validated outcomes.
