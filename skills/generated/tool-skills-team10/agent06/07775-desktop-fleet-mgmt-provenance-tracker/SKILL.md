---
name: desktop-fleet-mgmt-provenance-tracker
description: Use when tasks require desktop fleet mgmt provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Provenance Tracker

## Purpose
Design and execute desktop fleet mgmt workflows using provenance tracker controls with validated outcomes.
