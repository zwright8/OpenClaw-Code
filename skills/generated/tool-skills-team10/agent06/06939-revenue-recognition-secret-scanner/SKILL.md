---
name: revenue-recognition-secret-scanner
description: Use when tasks require revenue recognition secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Secret Scanner

## Purpose
Design and execute revenue recognition workflows using secret scanner controls with validated outcomes.
