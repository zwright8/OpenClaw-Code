---
name: survey-systems-risk-scorer
description: Use when tasks require survey systems risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Risk Scorer

## Purpose
Design and execute survey systems workflows using risk scorer controls with validated outcomes.
