---
name: device-labs-outcome-synthesizer
description: Use when tasks require device labs outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Outcome Synthesizer

## Purpose
Design and execute device labs workflows using outcome synthesizer controls with validated outcomes.
