---
name: news-monitoring-remediation-planner
description: Use when tasks require news monitoring remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Remediation Planner

## Purpose
Design and execute news monitoring workflows using remediation planner controls with validated outcomes.
