---
name: forecasting-models-quality-gatekeeper
description: Use when tasks require forecasting models quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Quality Gatekeeper

## Purpose
Design and execute forecasting models workflows using quality gatekeeper controls with validated outcomes.
