---
name: competitive-intelligence-conflict-resolver
description: Use when tasks require competitive intelligence conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Conflict Resolver

## Purpose
Design and execute competitive intelligence workflows using conflict resolver controls with validated outcomes.
