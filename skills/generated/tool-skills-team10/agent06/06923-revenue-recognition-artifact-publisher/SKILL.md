---
name: revenue-recognition-artifact-publisher
description: Use when tasks require revenue recognition artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Artifact Publisher

## Purpose
Design and execute revenue recognition workflows using artifact publisher controls with validated outcomes.
