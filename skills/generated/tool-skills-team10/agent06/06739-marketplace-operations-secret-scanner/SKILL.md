---
name: marketplace-operations-secret-scanner
description: Use when tasks require marketplace operations secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Secret Scanner

## Purpose
Design and execute marketplace operations workflows using secret scanner controls with validated outcomes.
