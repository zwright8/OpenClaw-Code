---
name: in-app-messaging-secret-scanner
description: Use when tasks require in-app messaging secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Secret Scanner

## Purpose
Design and execute in-app messaging workflows using secret scanner controls with validated outcomes.
