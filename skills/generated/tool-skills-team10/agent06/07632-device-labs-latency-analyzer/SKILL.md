---
name: device-labs-latency-analyzer
description: Use when tasks require device labs latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Latency Analyzer

## Purpose
Design and execute device labs workflows using latency analyzer controls with validated outcomes.
