---
name: open-source-intelligence-human-handoff-router
description: Use when tasks require open source intelligence human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Human Handoff Router

## Purpose
Design and execute open source intelligence workflows using human handoff router controls with validated outcomes.
