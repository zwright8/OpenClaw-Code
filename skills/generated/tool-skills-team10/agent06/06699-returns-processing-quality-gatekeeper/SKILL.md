---
name: returns-processing-quality-gatekeeper
description: Use when tasks require returns processing quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Quality Gatekeeper

## Purpose
Design and execute returns processing workflows using quality gatekeeper controls with validated outcomes.
