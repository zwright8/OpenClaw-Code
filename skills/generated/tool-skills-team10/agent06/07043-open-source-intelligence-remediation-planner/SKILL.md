---
name: open-source-intelligence-remediation-planner
description: Use when tasks require open source intelligence remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Remediation Planner

## Purpose
Design and execute open source intelligence workflows using remediation planner controls with validated outcomes.
