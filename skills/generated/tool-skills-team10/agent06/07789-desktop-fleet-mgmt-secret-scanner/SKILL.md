---
name: desktop-fleet-mgmt-secret-scanner
description: Use when tasks require desktop fleet mgmt secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Secret Scanner

## Purpose
Design and execute desktop fleet mgmt workflows using secret scanner controls with validated outcomes.
