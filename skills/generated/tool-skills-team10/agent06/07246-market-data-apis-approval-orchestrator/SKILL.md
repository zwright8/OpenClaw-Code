---
name: market-data-apis-approval-orchestrator
description: Use when tasks require market data apis approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Approval Orchestrator

## Purpose
Design and execute market data apis workflows using approval orchestrator controls with validated outcomes.
