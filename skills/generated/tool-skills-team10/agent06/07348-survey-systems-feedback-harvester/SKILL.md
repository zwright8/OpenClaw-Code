---
name: survey-systems-feedback-harvester
description: Use when tasks require survey systems feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Feedback Harvester

## Purpose
Design and execute survey systems workflows using feedback harvester controls with validated outcomes.
