---
name: open-source-intelligence-delta-calculator
description: Use when tasks require open source intelligence delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Delta Calculator

## Purpose
Design and execute open source intelligence workflows using delta calculator controls with validated outcomes.
