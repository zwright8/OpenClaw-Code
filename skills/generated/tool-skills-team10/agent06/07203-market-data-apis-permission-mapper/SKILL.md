---
name: market-data-apis-permission-mapper
description: Use when tasks require market data apis permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Permission Mapper

## Purpose
Design and execute market data apis workflows using permission mapper controls with validated outcomes.
