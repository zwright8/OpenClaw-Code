---
name: revenue-recognition-migration-planner
description: Use when tasks require revenue recognition migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Migration Planner

## Purpose
Design and execute revenue recognition workflows using migration planner controls with validated outcomes.
