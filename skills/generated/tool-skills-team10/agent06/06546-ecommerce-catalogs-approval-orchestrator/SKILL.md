---
name: ecommerce-catalogs-approval-orchestrator
description: Use when tasks require ecommerce catalogs approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Approval Orchestrator

## Purpose
Design and execute ecommerce catalogs workflows using approval orchestrator controls with validated outcomes.
