---
name: device-labs-operation-planner
description: Use when tasks require device labs operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Operation Planner

## Purpose
Design and execute device labs workflows using operation planner controls with validated outcomes.
