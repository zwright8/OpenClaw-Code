---
name: order-management-capacity-planner
description: Use when tasks require order management capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Capacity Planner

## Purpose
Design and execute order management workflows using capacity planner controls with validated outcomes.
