---
name: forecasting-models-capacity-planner
description: Use when tasks require forecasting models capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Capacity Planner

## Purpose
Design and execute forecasting models workflows using capacity planner controls with validated outcomes.
