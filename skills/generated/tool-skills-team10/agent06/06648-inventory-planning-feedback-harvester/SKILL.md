---
name: inventory-planning-feedback-harvester
description: Use when tasks require inventory planning feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Feedback Harvester

## Purpose
Design and execute inventory planning workflows using feedback harvester controls with validated outcomes.
