---
name: ecommerce-catalogs-anomaly-detector
description: Use when tasks require ecommerce catalogs anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Anomaly Detector

## Purpose
Design and execute ecommerce catalogs workflows using anomaly detector controls with validated outcomes.
