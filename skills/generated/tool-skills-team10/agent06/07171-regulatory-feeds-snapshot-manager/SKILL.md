---
name: regulatory-feeds-snapshot-manager
description: Use when tasks require regulatory feeds snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Snapshot Manager

## Purpose
Design and execute regulatory feeds workflows using snapshot manager controls with validated outcomes.
