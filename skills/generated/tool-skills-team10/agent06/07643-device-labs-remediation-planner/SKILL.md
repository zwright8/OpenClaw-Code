---
name: device-labs-remediation-planner
description: Use when tasks require device labs remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Remediation Planner

## Purpose
Design and execute device labs workflows using remediation planner controls with validated outcomes.
