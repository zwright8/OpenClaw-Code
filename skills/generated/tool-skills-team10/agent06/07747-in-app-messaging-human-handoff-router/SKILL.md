---
name: in-app-messaging-human-handoff-router
description: Use when tasks require in-app messaging human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Human Handoff Router

## Purpose
Design and execute in-app messaging workflows using human handoff router controls with validated outcomes.
