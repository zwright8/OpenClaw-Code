---
name: a-b-testing-policy-evaluator
description: Use when tasks require a/b testing policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Policy Evaluator

## Purpose
Design and execute a/b testing workflows using policy evaluator controls with validated outcomes.
