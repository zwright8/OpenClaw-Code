---
name: competitive-intelligence-anomaly-detector
description: Use when tasks require competitive intelligence anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Anomaly Detector

## Purpose
Design and execute competitive intelligence workflows using anomaly detector controls with validated outcomes.
