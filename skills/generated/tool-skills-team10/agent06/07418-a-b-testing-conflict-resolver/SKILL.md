---
name: a-b-testing-conflict-resolver
description: Use when tasks require a/b testing conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Conflict Resolver

## Purpose
Design and execute a/b testing workflows using conflict resolver controls with validated outcomes.
