---
name: experiment-platforms-feedback-harvester
description: Use when tasks require experiment platforms feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Experiment Platforms Feedback Harvester

## Purpose
Design and execute experiment platforms workflows using feedback harvester controls with validated outcomes.
