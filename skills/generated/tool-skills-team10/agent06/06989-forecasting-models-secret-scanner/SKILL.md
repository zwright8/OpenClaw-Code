---
name: forecasting-models-secret-scanner
description: Use when tasks require forecasting models secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Secret Scanner

## Purpose
Design and execute forecasting models workflows using secret scanner controls with validated outcomes.
