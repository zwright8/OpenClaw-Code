---
name: survey-systems-task-decomposer
description: Use when tasks require survey systems task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Task Decomposer

## Purpose
Design and execute survey systems workflows using task decomposer controls with validated outcomes.
