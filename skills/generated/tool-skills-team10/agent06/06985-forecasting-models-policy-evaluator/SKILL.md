---
name: forecasting-models-policy-evaluator
description: Use when tasks require forecasting models policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Policy Evaluator

## Purpose
Design and execute forecasting models workflows using policy evaluator controls with validated outcomes.
