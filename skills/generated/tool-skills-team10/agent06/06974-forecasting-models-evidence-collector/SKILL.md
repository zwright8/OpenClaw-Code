---
name: forecasting-models-evidence-collector
description: Use when tasks require forecasting models evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Evidence Collector

## Purpose
Design and execute forecasting models workflows using evidence collector controls with validated outcomes.
