---
name: regulatory-feeds-retry-governor
description: Use when tasks require regulatory feeds retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Retry Governor

## Purpose
Design and execute regulatory feeds workflows using retry governor controls with validated outcomes.
