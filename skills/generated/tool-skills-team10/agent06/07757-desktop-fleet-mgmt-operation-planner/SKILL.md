---
name: desktop-fleet-mgmt-operation-planner
description: Use when tasks require desktop fleet mgmt operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Operation Planner

## Purpose
Design and execute desktop fleet mgmt workflows using operation planner controls with validated outcomes.
