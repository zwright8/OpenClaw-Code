---
name: regulatory-feeds-budget-guardrail
description: Use when tasks require regulatory feeds budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Budget Guardrail

## Purpose
Design and execute regulatory feeds workflows using budget guardrail controls with validated outcomes.
