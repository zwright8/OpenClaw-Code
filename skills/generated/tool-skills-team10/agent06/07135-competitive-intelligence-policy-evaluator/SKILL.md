---
name: competitive-intelligence-policy-evaluator
description: Use when tasks require competitive intelligence policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Policy Evaluator

## Purpose
Design and execute competitive intelligence workflows using policy evaluator controls with validated outcomes.
