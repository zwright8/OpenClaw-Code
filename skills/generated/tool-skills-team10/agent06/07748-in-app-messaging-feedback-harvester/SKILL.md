---
name: in-app-messaging-feedback-harvester
description: Use when tasks require in-app messaging feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Feedback Harvester

## Purpose
Design and execute in-app messaging workflows using feedback harvester controls with validated outcomes.
