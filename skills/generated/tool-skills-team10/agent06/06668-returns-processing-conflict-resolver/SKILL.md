---
name: returns-processing-conflict-resolver
description: Use when tasks require returns processing conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Conflict Resolver

## Purpose
Design and execute returns processing workflows using conflict resolver controls with validated outcomes.
