---
name: a-b-testing-runbook-composer
description: Use when tasks require a/b testing runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Runbook Composer

## Purpose
Design and execute a/b testing workflows using runbook composer controls with validated outcomes.
