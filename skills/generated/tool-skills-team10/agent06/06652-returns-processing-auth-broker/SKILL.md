---
name: returns-processing-auth-broker
description: Use when tasks require returns processing auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Auth Broker

## Purpose
Design and execute returns processing workflows using auth broker controls with validated outcomes.
