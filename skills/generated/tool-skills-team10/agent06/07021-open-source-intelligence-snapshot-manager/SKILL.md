---
name: open-source-intelligence-snapshot-manager
description: Use when tasks require open source intelligence snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Snapshot Manager

## Purpose
Design and execute open source intelligence workflows using snapshot manager controls with validated outcomes.
