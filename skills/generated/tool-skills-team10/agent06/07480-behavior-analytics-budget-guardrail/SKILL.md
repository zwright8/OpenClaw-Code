---
name: behavior-analytics-budget-guardrail
description: Use when tasks require behavior analytics budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Budget Guardrail

## Purpose
Design and execute behavior analytics workflows using budget guardrail controls with validated outcomes.
