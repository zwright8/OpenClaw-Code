---
name: open-source-intelligence-spec-drift-detector
description: Use when tasks require open source intelligence spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Spec Drift Detector

## Purpose
Design and execute open source intelligence workflows using spec drift detector controls with validated outcomes.
