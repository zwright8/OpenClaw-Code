---
name: competitive-intelligence-snapshot-manager
description: Use when tasks require competitive intelligence snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Snapshot Manager

## Purpose
Design and execute competitive intelligence workflows using snapshot manager controls with validated outcomes.
