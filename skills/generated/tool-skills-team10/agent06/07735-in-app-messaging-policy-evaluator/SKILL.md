---
name: in-app-messaging-policy-evaluator
description: Use when tasks require in-app messaging policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Policy Evaluator

## Purpose
Design and execute in-app messaging workflows using policy evaluator controls with validated outcomes.
