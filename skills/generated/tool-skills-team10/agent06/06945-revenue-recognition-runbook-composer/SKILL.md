---
name: revenue-recognition-runbook-composer
description: Use when tasks require revenue recognition runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Runbook Composer

## Purpose
Design and execute revenue recognition workflows using runbook composer controls with validated outcomes.
