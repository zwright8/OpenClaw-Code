---
name: open-source-intelligence-risk-scorer
description: Use when tasks require open source intelligence risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Risk Scorer

## Purpose
Design and execute open source intelligence workflows using risk scorer controls with validated outcomes.
