---
name: regulatory-feeds-api-contract-validator
description: Use when tasks require regulatory feeds api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds API Contract Validator

## Purpose
Design and execute regulatory feeds workflows using api contract validator controls with validated outcomes.

## Precision Profile
- Domain: Regulatory Feeds
...
- Domain: [Regulatory Feeds](../../resources/domains/regulatory-feeds.md)
