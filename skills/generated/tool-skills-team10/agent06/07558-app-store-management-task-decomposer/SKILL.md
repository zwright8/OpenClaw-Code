---
name: app-store-management-task-decomposer
description: Use when tasks require app store management task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Task Decomposer

## Purpose
Design and execute app store management workflows using task decomposer controls with validated outcomes.
