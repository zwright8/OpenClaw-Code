---
name: forecasting-models-spec-drift-detector
description: Use when tasks require forecasting models spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Spec Drift Detector

## Purpose
Design and execute forecasting models workflows using spec drift detector controls with validated outcomes.
