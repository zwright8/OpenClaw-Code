---
name: survey-systems-provenance-tracker
description: Use when tasks require survey systems provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Provenance Tracker

## Purpose
Design and execute survey systems workflows using provenance tracker controls with validated outcomes.
