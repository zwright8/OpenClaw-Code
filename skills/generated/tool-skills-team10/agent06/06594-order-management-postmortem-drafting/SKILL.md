---
name: order-management-postmortem-drafting
description: Use when tasks require order management postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Postmortem Drafting

## Purpose
Design and execute order management workflows using postmortem drafting controls with validated outcomes.
