---
name: in-app-messaging-provenance-tracker
description: Use when tasks require in-app messaging provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Provenance Tracker

## Purpose
Design and execute in-app messaging workflows using provenance tracker controls with validated outcomes.
