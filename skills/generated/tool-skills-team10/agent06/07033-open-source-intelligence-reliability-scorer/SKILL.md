---
name: open-source-intelligence-reliability-scorer
description: Use when tasks require open source intelligence reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Reliability Scorer

## Purpose
Design and execute open source intelligence workflows using reliability scorer controls with validated outcomes.
