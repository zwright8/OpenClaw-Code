---
name: returns-processing-forecast-engine
description: Use when tasks require returns processing forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Forecast Engine

## Purpose
Design and execute returns processing workflows using forecast engine controls with validated outcomes.
