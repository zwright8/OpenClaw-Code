---
name: marketplace-operations-dependency-resolver
description: Use when tasks require marketplace operations dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Dependency Resolver

## Purpose
Design and execute marketplace operations workflows using dependency resolver controls with validated outcomes.
