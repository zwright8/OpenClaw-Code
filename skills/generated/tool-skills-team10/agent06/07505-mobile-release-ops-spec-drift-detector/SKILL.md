---
name: mobile-release-ops-spec-drift-detector
description: Use when tasks require mobile release ops spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobile Release Ops Spec Drift Detector

## Purpose
Design and execute mobile release ops workflows using spec drift detector controls with validated outcomes.
