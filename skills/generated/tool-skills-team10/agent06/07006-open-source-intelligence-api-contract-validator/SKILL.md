---
name: open-source-intelligence-api-contract-validator
description: Use when tasks require open source intelligence api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence API Contract Validator

## Purpose
Design and execute open source intelligence workflows using api contract validator controls with validated outcomes.
...
- Domain: [Open Source Intelligence](../../resources/domains/open-source-intelligence.md)
