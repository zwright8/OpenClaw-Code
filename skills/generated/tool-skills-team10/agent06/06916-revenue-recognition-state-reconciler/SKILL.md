---
name: revenue-recognition-state-reconciler
description: Use when tasks require revenue recognition state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition State Reconciler

## Purpose
Design and execute revenue recognition workflows using state reconciler controls with validated outcomes.
