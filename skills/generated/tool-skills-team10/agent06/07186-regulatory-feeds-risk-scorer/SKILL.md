---
name: regulatory-feeds-risk-scorer
description: Use when tasks require regulatory feeds risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Risk Scorer

## Purpose
Design and execute regulatory feeds workflows using risk scorer controls with validated outcomes.
