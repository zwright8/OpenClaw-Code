---
name: survey-systems-conflict-resolver
description: Use when tasks require survey systems conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Conflict Resolver

## Purpose
Design and execute survey systems workflows using conflict resolver controls with validated outcomes.
