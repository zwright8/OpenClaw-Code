---
name: order-management-human-handoff-router
description: Use when tasks require order management human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Human Handoff Router

## Purpose
Design and execute order management workflows using human handoff router controls with validated outcomes.
