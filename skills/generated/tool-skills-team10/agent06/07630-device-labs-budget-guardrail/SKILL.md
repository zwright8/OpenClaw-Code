---
name: device-labs-budget-guardrail
description: Use when tasks require device labs budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Budget Guardrail

## Purpose
Design and execute device labs workflows using budget guardrail controls with validated outcomes.
