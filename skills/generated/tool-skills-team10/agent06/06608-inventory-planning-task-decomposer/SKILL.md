---
name: inventory-planning-task-decomposer
description: Use when tasks require inventory planning task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Task Decomposer

## Purpose
Design and execute inventory planning workflows using task decomposer controls with validated outcomes.
