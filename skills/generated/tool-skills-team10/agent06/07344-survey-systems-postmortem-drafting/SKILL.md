---
name: survey-systems-postmortem-drafting
description: Use when tasks require survey systems postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Postmortem Drafting

## Purpose
Design and execute survey systems workflows using postmortem drafting controls with validated outcomes.
