---
name: billing-recovery-rollback-coordinator
description: Use when tasks require billing recovery rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Rollback Coordinator

## Purpose
Design and execute billing recovery workflows using rollback coordinator controls with validated outcomes.
