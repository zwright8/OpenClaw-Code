---
name: behavior-analytics-feedback-harvester
description: Use when tasks require behavior analytics feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Feedback Harvester

## Purpose
Design and execute behavior analytics workflows using feedback harvester controls with validated outcomes.
