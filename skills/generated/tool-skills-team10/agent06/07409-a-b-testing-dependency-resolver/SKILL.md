---
name: a-b-testing-dependency-resolver
description: Use when tasks require a/b testing dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Dependency Resolver

## Purpose
Design and execute a/b testing workflows using dependency resolver controls with validated outcomes.
