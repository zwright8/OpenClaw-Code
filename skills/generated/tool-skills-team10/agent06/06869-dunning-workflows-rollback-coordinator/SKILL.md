---
name: dunning-workflows-rollback-coordinator
description: Use when tasks require dunning workflows rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Dunning Workflows Rollback Coordinator

## Purpose
Design and execute dunning workflows workflows using rollback coordinator controls with validated outcomes.
