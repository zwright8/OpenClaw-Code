---
name: inventory-planning-secret-scanner
description: Use when tasks require inventory planning secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Secret Scanner

## Purpose
Design and execute inventory planning workflows using secret scanner controls with validated outcomes.
