---
name: in-app-messaging-risk-scorer
description: Use when tasks require in-app messaging risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Risk Scorer

## Purpose
Design and execute in-app messaging workflows using risk scorer controls with validated outcomes.
