---
name: open-source-intelligence-version-tracker
description: Use when tasks require open source intelligence version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Version Tracker

## Purpose
Design and execute open source intelligence workflows using version tracker controls with validated outcomes.
