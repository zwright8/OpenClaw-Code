---
name: in-app-messaging-remediation-planner
description: Use when tasks require in-app messaging remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Remediation Planner

## Purpose
Design and execute in-app messaging workflows using remediation planner controls with validated outcomes.
