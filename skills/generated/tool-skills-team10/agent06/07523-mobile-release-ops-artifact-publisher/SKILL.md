---
name: mobile-release-ops-artifact-publisher
description: Use when tasks require mobile release ops artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobile Release Ops Artifact Publisher

## Purpose
Design and execute mobile release ops workflows using artifact publisher controls with validated outcomes.
