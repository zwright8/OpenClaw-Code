---
name: returns-processing-anomaly-detector
description: Use when tasks require returns processing anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Anomaly Detector

## Purpose
Design and execute returns processing workflows using anomaly detector controls with validated outcomes.
