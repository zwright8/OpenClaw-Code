---
name: dunning-workflows-anomaly-detector
description: Use when tasks require dunning workflows anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Dunning Workflows Anomaly Detector

## Purpose
Design and execute dunning workflows workflows using anomaly detector controls with validated outcomes.
