---
name: in-app-messaging-incident-triage
description: Use when tasks require in-app messaging incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Incident Triage

## Purpose
Design and execute in-app messaging workflows using incident triage controls with validated outcomes.
