---
name: regulatory-feeds-delta-calculator
description: Use when tasks require regulatory feeds delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Delta Calculator

## Purpose
Design and execute regulatory feeds workflows using delta calculator controls with validated outcomes.
