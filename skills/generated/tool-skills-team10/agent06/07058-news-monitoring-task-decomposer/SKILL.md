---
name: news-monitoring-task-decomposer
description: Use when tasks require news monitoring task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Task Decomposer

## Purpose
Design and execute news monitoring workflows using task decomposer controls with validated outcomes.
