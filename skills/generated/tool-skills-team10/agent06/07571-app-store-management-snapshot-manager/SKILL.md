---
name: app-store-management-snapshot-manager
description: Use when tasks require app store management snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Snapshot Manager

## Purpose
Design and execute app store management workflows using snapshot manager controls with validated outcomes.
