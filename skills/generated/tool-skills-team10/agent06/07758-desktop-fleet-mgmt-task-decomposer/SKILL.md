---
name: desktop-fleet-mgmt-task-decomposer
description: Use when tasks require desktop fleet mgmt task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Task Decomposer

## Purpose
Design and execute desktop fleet mgmt workflows using task decomposer controls with validated outcomes.
