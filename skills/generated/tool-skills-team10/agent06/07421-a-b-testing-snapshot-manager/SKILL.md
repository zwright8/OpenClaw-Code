---
name: a-b-testing-snapshot-manager
description: Use when tasks require a/b testing snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Snapshot Manager

## Purpose
Design and execute a/b testing workflows using snapshot manager controls with validated outcomes.
