---
name: billing-recovery-permission-mapper
description: Use when tasks require billing recovery permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Permission Mapper

## Purpose
Design and execute billing recovery workflows using permission mapper controls with validated outcomes.
