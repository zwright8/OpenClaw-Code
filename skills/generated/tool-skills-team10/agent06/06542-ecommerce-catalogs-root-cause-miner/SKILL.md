---
name: ecommerce-catalogs-root-cause-miner
description: Use when tasks require ecommerce catalogs root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Root Cause Miner

## Purpose
Design and execute ecommerce catalogs workflows using root cause miner controls with validated outcomes.
