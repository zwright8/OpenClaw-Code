---
name: desktop-fleet-mgmt-access-auditor
description: Use when tasks require desktop fleet mgmt access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Access Auditor

## Purpose
Design and execute desktop fleet mgmt workflows using access auditor controls with validated outcomes.
