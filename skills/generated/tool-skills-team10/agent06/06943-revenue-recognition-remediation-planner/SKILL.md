---
name: revenue-recognition-remediation-planner
description: Use when tasks require revenue recognition remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Remediation Planner

## Purpose
Design and execute revenue recognition workflows using remediation planner controls with validated outcomes.
