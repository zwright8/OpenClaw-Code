---
name: subscription-platforms-compliance-mapper
description: Use when tasks require subscription platforms compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Subscription Platforms Compliance Mapper

## Purpose
Design and execute subscription platforms workflows using compliance mapper controls with validated outcomes.
