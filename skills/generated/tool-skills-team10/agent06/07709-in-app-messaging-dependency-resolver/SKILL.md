---
name: in-app-messaging-dependency-resolver
description: Use when tasks require in-app messaging dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Dependency Resolver

## Purpose
Design and execute in-app messaging workflows using dependency resolver controls with validated outcomes.
