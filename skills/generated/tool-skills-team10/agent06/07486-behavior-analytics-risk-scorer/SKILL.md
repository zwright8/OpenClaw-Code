---
name: behavior-analytics-risk-scorer
description: Use when tasks require behavior analytics risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Risk Scorer

## Purpose
Design and execute behavior analytics workflows using risk scorer controls with validated outcomes.
