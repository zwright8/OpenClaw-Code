---
name: forecasting-models-postmortem-drafting
description: Use when tasks require forecasting models postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Postmortem Drafting

## Purpose
Design and execute forecasting models workflows using postmortem drafting controls with validated outcomes.
