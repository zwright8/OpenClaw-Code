---
name: device-labs-provenance-tracker
description: Use when tasks require device labs provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Provenance Tracker

## Purpose
Design and execute device labs workflows using provenance tracker controls with validated outcomes.
