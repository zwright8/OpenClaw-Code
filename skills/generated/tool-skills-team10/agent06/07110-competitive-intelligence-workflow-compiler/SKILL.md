---
name: competitive-intelligence-workflow-compiler
description: Use when tasks require competitive intelligence workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Workflow Compiler

## Purpose
Design and execute competitive intelligence workflows using workflow compiler controls with validated outcomes.
