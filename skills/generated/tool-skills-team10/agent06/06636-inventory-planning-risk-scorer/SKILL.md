---
name: inventory-planning-risk-scorer
description: Use when tasks require inventory planning risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Risk Scorer

## Purpose
Design and execute inventory planning workflows using risk scorer controls with validated outcomes.
