---
name: device-labs-anomaly-detector
description: Use when tasks require device labs anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Anomaly Detector

## Purpose
Design and execute device labs workflows using anomaly detector controls with validated outcomes.
