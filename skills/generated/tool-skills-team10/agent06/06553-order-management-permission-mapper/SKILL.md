---
name: order-management-permission-mapper
description: Use when tasks require order management permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Permission Mapper

## Purpose
Design and execute order management workflows using permission mapper controls with validated outcomes.
