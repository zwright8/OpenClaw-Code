---
name: dunning-workflows-snapshot-manager
description: Use when tasks require dunning workflows snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Dunning Workflows Snapshot Manager

## Purpose
Design and execute dunning workflows workflows using snapshot manager controls with validated outcomes.
