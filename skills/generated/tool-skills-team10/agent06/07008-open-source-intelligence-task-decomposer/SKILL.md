---
name: open-source-intelligence-task-decomposer
description: Use when tasks require open source intelligence task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Task Decomposer

## Purpose
Design and execute open source intelligence workflows using task decomposer controls with validated outcomes.
