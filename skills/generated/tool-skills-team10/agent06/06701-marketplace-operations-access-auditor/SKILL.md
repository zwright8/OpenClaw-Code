---
name: marketplace-operations-access-auditor
description: Use when tasks require marketplace operations access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Access Auditor

## Purpose
Design and execute marketplace operations workflows using access auditor controls with validated outcomes.
