---
name: news-monitoring-threshold-alerting
description: Use when tasks require news monitoring threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Threshold Alerting

## Purpose
Design and execute news monitoring workflows using threshold alerting controls with validated outcomes.
