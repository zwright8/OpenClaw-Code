---
name: ecommerce-catalogs-feedback-harvester
description: Use when tasks require ecommerce catalogs feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Feedback Harvester

## Purpose
Design and execute ecommerce catalogs workflows using feedback harvester controls with validated outcomes.
