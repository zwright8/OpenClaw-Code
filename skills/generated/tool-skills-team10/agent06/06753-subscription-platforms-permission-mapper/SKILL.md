---
name: subscription-platforms-permission-mapper
description: Use when tasks require subscription platforms permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Subscription Platforms Permission Mapper

## Purpose
Design and execute subscription platforms workflows using permission mapper controls with validated outcomes.
