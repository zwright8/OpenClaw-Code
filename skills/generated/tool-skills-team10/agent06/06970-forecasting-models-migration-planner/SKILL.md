---
name: forecasting-models-migration-planner
description: Use when tasks require forecasting models migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Migration Planner

## Purpose
Design and execute forecasting models workflows using migration planner controls with validated outcomes.
