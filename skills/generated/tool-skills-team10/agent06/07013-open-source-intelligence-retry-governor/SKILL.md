---
name: open-source-intelligence-retry-governor
description: Use when tasks require open source intelligence retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Retry Governor

## Purpose
Design and execute open source intelligence workflows using retry governor controls with validated outcomes.
