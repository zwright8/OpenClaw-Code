---
name: open-source-intelligence-artifact-publisher
description: Use when tasks require open source intelligence artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Artifact Publisher

## Purpose
Design and execute open source intelligence workflows using artifact publisher controls with validated outcomes.
