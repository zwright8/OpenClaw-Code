---
name: news-monitoring-budget-guardrail
description: Use when tasks require news monitoring budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Budget Guardrail

## Purpose
Design and execute news monitoring workflows using budget guardrail controls with validated outcomes.
