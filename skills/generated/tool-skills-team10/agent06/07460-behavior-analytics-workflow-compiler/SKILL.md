---
name: behavior-analytics-workflow-compiler
description: Use when tasks require behavior analytics workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Workflow Compiler

## Purpose
Design and execute behavior analytics workflows using workflow compiler controls with validated outcomes.
