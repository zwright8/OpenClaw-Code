---
name: forecasting-models-approval-orchestrator
description: Use when tasks require forecasting models approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Approval Orchestrator

## Purpose
Design and execute forecasting models workflows using approval orchestrator controls with validated outcomes.
