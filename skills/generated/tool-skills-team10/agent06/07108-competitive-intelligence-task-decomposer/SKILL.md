---
name: competitive-intelligence-task-decomposer
description: Use when tasks require competitive intelligence task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Task Decomposer

## Purpose
Design and execute competitive intelligence workflows using task decomposer controls with validated outcomes.
