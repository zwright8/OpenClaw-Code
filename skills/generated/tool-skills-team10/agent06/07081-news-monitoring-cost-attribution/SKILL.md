---
name: news-monitoring-cost-attribution
description: Use when tasks require news monitoring cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Cost Attribution

## Purpose
Design and execute news monitoring workflows using cost attribution controls with validated outcomes.
