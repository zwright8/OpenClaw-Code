---
name: in-app-messaging-delta-calculator
description: Use when tasks require in-app messaging delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Delta Calculator

## Purpose
Design and execute in-app messaging workflows using delta calculator controls with validated outcomes.
