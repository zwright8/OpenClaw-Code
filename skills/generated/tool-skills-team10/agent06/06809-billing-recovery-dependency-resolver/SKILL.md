---
name: billing-recovery-dependency-resolver
description: Use when tasks require billing recovery dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Dependency Resolver

## Purpose
Design and execute billing recovery workflows using dependency resolver controls with validated outcomes.
