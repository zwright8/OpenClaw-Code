---
name: order-management-secret-scanner
description: Use when tasks require order management secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Secret Scanner

## Purpose
Design and execute order management workflows using secret scanner controls with validated outcomes.
