---
name: market-data-apis-policy-evaluator
description: Use when tasks require market data apis policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Policy Evaluator

## Purpose
Design and execute market data apis workflows using policy evaluator controls with validated outcomes.
