---
name: billing-recovery-forecast-engine
description: Use when tasks require billing recovery forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Forecast Engine

## Purpose
Design and execute billing recovery workflows using forecast engine controls with validated outcomes.
