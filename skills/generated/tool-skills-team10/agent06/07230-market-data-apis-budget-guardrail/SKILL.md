---
name: market-data-apis-budget-guardrail
description: Use when tasks require market data apis budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Budget Guardrail

## Purpose
Design and execute market data apis workflows using budget guardrail controls with validated outcomes.
