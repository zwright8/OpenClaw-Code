---
name: in-app-messaging-migration-planner
description: Use when tasks require in-app messaging migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Migration Planner

## Purpose
Design and execute in-app messaging workflows using migration planner controls with validated outcomes.
