---
name: in-app-messaging-postmortem-drafting
description: Use when tasks require in-app messaging postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Postmortem Drafting

## Purpose
Design and execute in-app messaging workflows using postmortem drafting controls with validated outcomes.
