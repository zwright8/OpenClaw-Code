...
description: Use when tasks require market data apis state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs State Reconciler

## Purpose
Design and execute market data apis workflows using state reconciler controls with validated outcomes.
