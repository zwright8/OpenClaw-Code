---
name: device-labs-migration-planner
description: Use when tasks require device labs migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Migration Planner

## Purpose
Design and execute device labs workflows using migration planner controls with validated outcomes.
