---
name: inventory-planning-anomaly-detector
description: Use when tasks require inventory planning anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Anomaly Detector

## Purpose
Design and execute inventory planning workflows using anomaly detector controls with validated outcomes.
