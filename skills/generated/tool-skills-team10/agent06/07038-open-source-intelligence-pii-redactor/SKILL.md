---
name: open-source-intelligence-pii-redactor
description: Use when tasks require open source intelligence pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence PII Redactor

## Purpose
Design and execute open source intelligence workflows using pii redactor controls with validated outcomes.
