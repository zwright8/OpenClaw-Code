---
name: a-b-testing-feedback-harvester
description: Use when tasks require a/b testing feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Feedback Harvester

## Purpose
Design and execute a/b testing workflows using feedback harvester controls with validated outcomes.
