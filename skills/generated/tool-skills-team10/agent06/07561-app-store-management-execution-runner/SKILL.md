---
name: app-store-management-execution-runner
description: Use when tasks require app store management execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Execution Runner

## Purpose
Design and execute app store management workflows using execution runner controls with validated outcomes.
