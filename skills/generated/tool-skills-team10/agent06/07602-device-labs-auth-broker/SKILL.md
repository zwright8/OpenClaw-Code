---
name: device-labs-auth-broker
description: Use when tasks require device labs auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Auth Broker

## Purpose
Design and execute device labs workflows using auth broker controls with validated outcomes.
