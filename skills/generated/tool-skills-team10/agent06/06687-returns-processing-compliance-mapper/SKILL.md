---
name: returns-processing-compliance-mapper
description: Use when tasks require returns processing compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Compliance Mapper

## Purpose
Design and execute returns processing workflows using compliance mapper controls with validated outcomes.
