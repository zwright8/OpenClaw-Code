---
name: ecommerce-catalogs-retry-governor
description: Use when tasks require ecommerce catalogs retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Retry Governor

## Purpose
Design and execute ecommerce catalogs workflows using retry governor controls with validated outcomes.
