---
name: ecommerce-catalogs-secret-scanner
description: Use when tasks require ecommerce catalogs secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Secret Scanner

## Purpose
Design and execute ecommerce catalogs workflows using secret scanner controls with validated outcomes.
