---
name: competitive-intelligence-api-contract-validator
description: Use when tasks require competitive intelligence api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence API Contract Validator

## Purpose
Design and execute competitive intelligence workflows using api contract validator controls with validated outcomes.
...
- Domain: [Competitive Intelligence](../../resources/domains/competitive-intelligence.md)
