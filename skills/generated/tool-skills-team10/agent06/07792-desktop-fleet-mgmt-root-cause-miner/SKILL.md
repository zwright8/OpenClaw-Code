---
name: desktop-fleet-mgmt-root-cause-miner
description: Use when tasks require desktop fleet mgmt root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Root Cause Miner

## Purpose
Design and execute desktop fleet mgmt workflows using root cause miner controls with validated outcomes.
