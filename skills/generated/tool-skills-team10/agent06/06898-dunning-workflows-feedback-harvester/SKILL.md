---
name: dunning-workflows-feedback-harvester
description: Use when tasks require dunning workflows feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Dunning Workflows Feedback Harvester

## Purpose
Design and execute dunning workflows workflows using feedback harvester controls with validated outcomes.
