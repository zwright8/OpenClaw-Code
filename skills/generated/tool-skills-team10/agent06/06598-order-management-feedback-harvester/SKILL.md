---
name: order-management-feedback-harvester
description: Use when tasks require order management feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Feedback Harvester

## Purpose
Design and execute order management workflows using feedback harvester controls with validated outcomes.
