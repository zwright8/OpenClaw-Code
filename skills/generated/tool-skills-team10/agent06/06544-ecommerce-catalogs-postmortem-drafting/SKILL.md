---
name: ecommerce-catalogs-postmortem-drafting
description: Use when tasks require ecommerce catalogs postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Postmortem Drafting

## Purpose
Design and execute ecommerce catalogs workflows using postmortem drafting controls with validated outcomes.
