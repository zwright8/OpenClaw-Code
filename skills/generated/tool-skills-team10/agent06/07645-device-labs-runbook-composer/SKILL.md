---
name: device-labs-runbook-composer
description: Use when tasks require device labs runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Runbook Composer

## Purpose
Design and execute device labs workflows using runbook composer controls with validated outcomes.
