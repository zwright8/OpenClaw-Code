---
name: mobile-release-ops-snapshot-manager
description: Use when tasks require mobile release ops snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobile Release Ops Snapshot Manager

## Purpose
Design and execute mobile release ops workflows using snapshot manager controls with validated outcomes.
