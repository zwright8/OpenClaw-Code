---
name: dunning-workflows-forecast-engine
description: Use when tasks require dunning workflows forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Dunning Workflows Forecast Engine

## Purpose
Design and execute dunning workflows workflows using forecast engine controls with validated outcomes.
