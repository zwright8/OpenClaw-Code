---
name: forecasting-models-risk-scorer
description: Use when tasks require forecasting models risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Risk Scorer

## Purpose
Design and execute forecasting models workflows using risk scorer controls with validated outcomes.
