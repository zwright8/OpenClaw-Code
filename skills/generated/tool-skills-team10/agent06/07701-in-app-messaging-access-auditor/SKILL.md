---
name: in-app-messaging-access-auditor
description: Use when tasks require in-app messaging access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Access Auditor

## Purpose
Design and execute in-app messaging workflows using access auditor controls with validated outcomes.
