---
name: news-monitoring-provenance-tracker
description: Use when tasks require news monitoring provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Provenance Tracker

## Purpose
Design and execute news monitoring workflows using provenance tracker controls with validated outcomes.
