---
name: marketplace-operations-compliance-mapper
description: Use when tasks require marketplace operations compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Compliance Mapper

## Purpose
Design and execute marketplace operations workflows using compliance mapper controls with validated outcomes.
