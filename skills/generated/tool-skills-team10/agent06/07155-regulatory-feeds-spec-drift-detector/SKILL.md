---
name: regulatory-feeds-spec-drift-detector
description: Use when tasks require regulatory feeds spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Spec Drift Detector

## Purpose
Design and execute regulatory feeds workflows using spec drift detector controls with validated outcomes.
