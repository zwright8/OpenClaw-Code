---
name: regulatory-feeds-quality-gatekeeper
description: Use when tasks require regulatory feeds quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Quality Gatekeeper

## Purpose
Design and execute regulatory feeds workflows using quality gatekeeper controls with validated outcomes.
