---
name: survey-systems-root-cause-miner
description: Use when tasks require survey systems root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Root Cause Miner

## Purpose
Design and execute survey systems workflows using root cause miner controls with validated outcomes.
