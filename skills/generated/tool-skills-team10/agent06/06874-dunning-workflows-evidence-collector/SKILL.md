---
name: dunning-workflows-evidence-collector
description: Use when tasks require dunning workflows evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Dunning Workflows Evidence Collector

## Purpose
Design and execute dunning workflows workflows using evidence collector controls with validated outcomes.
