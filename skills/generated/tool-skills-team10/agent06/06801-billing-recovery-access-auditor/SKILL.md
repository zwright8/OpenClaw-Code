---
name: billing-recovery-access-auditor
description: Use when tasks require billing recovery access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Access Auditor

## Purpose
Design and execute billing recovery workflows using access auditor controls with validated outcomes.
