---
name: device-labs-approval-orchestrator
description: Use when tasks require device labs approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Approval Orchestrator

## Purpose
Design and execute device labs workflows using approval orchestrator controls with validated outcomes.
