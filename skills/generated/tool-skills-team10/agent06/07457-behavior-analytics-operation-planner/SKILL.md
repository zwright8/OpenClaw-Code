---
name: behavior-analytics-operation-planner
description: Use when tasks require behavior analytics operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Operation Planner

## Purpose
Design and execute behavior analytics workflows using operation planner controls with validated outcomes.
