---
name: marketplace-operations-spec-drift-detector
description: Use when tasks require marketplace operations spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Spec Drift Detector

## Purpose
Design and execute marketplace operations workflows using spec drift detector controls with validated outcomes.
