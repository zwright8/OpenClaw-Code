---
name: regulatory-feeds-provenance-tracker
description: Use when tasks require regulatory feeds provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Provenance Tracker

## Purpose
Design and execute regulatory feeds workflows using provenance tracker controls with validated outcomes.
