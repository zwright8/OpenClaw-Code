---
name: app-store-management-secret-scanner
description: Use when tasks require app store management secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Secret Scanner

## Purpose
Design and execute app store management workflows using secret scanner controls with validated outcomes.
