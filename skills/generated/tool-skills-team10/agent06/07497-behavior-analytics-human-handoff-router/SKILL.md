---
name: behavior-analytics-human-handoff-router
description: Use when tasks require behavior analytics human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Human Handoff Router

## Purpose
Design and execute behavior analytics workflows using human handoff router controls with validated outcomes.
