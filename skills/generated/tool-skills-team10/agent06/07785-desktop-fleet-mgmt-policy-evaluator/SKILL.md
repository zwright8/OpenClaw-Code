---
name: desktop-fleet-mgmt-policy-evaluator
description: Use when tasks require desktop fleet mgmt policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Policy Evaluator

## Purpose
Design and execute desktop fleet mgmt workflows using policy evaluator controls with validated outcomes.
