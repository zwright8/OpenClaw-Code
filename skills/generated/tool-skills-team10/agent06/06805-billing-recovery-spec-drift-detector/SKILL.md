---
name: billing-recovery-spec-drift-detector
description: Use when tasks require billing recovery spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Spec Drift Detector

## Purpose
Design and execute billing recovery workflows using spec drift detector controls with validated outcomes.
