---
name: desktop-fleet-mgmt-risk-scorer
description: Use when tasks require desktop fleet mgmt risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Risk Scorer

## Purpose
Design and execute desktop fleet mgmt workflows using risk scorer controls with validated outcomes.
