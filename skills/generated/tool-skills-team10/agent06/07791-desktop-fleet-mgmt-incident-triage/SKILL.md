---
name: desktop-fleet-mgmt-incident-triage
description: Use when tasks require desktop fleet mgmt incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Incident Triage

## Purpose
Design and execute desktop fleet mgmt workflows using incident triage controls with validated outcomes.
