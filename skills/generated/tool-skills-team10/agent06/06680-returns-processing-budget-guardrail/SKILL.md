---
name: returns-processing-budget-guardrail
description: Use when tasks require returns processing budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Budget Guardrail

## Purpose
Design and execute returns processing workflows using budget guardrail controls with validated outcomes.
