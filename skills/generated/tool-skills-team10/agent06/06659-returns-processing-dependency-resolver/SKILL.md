---
name: returns-processing-dependency-resolver
description: Use when tasks require returns processing dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Dependency Resolver

## Purpose
Design and execute returns processing workflows using dependency resolver controls with validated outcomes.
