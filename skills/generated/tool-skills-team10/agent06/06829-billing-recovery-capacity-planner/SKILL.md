---
name: billing-recovery-capacity-planner
description: Use when tasks require billing recovery capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Capacity Planner

## Purpose
Design and execute billing recovery workflows using capacity planner controls with validated outcomes.
