---
name: order-management-risk-scorer
description: Use when tasks require order management risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Risk Scorer

## Purpose
Design and execute order management workflows using risk scorer controls with validated outcomes.
