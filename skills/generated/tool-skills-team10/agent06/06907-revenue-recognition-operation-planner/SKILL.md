---
name: revenue-recognition-operation-planner
description: Use when tasks require revenue recognition operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Operation Planner

## Purpose
Design and execute revenue recognition workflows using operation planner controls with validated outcomes.
