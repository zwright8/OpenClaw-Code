---
name: ecommerce-catalogs-access-auditor
description: Use when tasks require ecommerce catalogs access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Access Auditor

## Purpose
Design and execute ecommerce catalogs workflows using access auditor controls with validated outcomes.
