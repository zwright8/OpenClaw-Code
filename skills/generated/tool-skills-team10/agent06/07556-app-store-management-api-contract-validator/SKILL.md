---
name: app-store-management-api-contract-validator
description: Use when tasks require app store management api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management API Contract Validator

## Purpose
Design and execute app store management workflows using api contract validator controls with validated outcomes.
