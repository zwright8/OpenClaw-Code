---
name: open-source-intelligence-budget-guardrail
description: Use when tasks require open source intelligence budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Budget Guardrail

## Purpose
Design and execute open source intelligence workflows using budget guardrail controls with validated outcomes.
