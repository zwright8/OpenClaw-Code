---
name: marketplace-operations-conflict-resolver
description: Use when tasks require marketplace operations conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Conflict Resolver

## Purpose
Design and execute marketplace operations workflows using conflict resolver controls with validated outcomes.
