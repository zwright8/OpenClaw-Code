---
name: dunning-workflows-conflict-resolver
description: Use when tasks require dunning workflows conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Dunning Workflows Conflict Resolver

## Purpose
Design and execute dunning workflows workflows using conflict resolver controls with validated outcomes.
