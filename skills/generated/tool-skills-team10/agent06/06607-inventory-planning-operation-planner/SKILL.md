---
name: inventory-planning-operation-planner
description: Use when tasks require inventory planning operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Operation Planner

## Purpose
Design and execute inventory planning workflows using operation planner controls with validated outcomes.
