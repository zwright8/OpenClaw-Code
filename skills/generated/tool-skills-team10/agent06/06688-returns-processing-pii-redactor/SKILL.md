---
name: returns-processing-pii-redactor
description: Use when tasks require returns processing pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing PII Redactor

## Purpose
Design and execute returns processing workflows using pii redactor controls with validated outcomes.
