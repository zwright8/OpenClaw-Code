---
name: ecommerce-catalogs-remediation-planner
description: Use when tasks require ecommerce catalogs remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Remediation Planner

## Purpose
Design and execute ecommerce catalogs workflows using remediation planner controls with validated outcomes.
