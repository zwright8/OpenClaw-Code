---
name: ecommerce-catalogs-risk-scorer
description: Use when tasks require ecommerce catalogs risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Risk Scorer

## Purpose
Design and execute ecommerce catalogs workflows using risk scorer controls with validated outcomes.
