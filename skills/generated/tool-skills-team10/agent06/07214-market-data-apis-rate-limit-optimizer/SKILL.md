---
name: market-data-apis-rate-limit-optimizer
description: Use when tasks require market data apis rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Rate Limit Optimizer

## Purpose
Design and execute market data apis workflows using rate limit optimizer controls with validated outcomes.
