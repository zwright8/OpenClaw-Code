---
name: mobile-release-ops-dependency-resolver
description: Use when tasks require mobile release ops dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobile Release Ops Dependency Resolver

## Purpose
Design and execute mobile release ops workflows using dependency resolver controls with validated outcomes.
