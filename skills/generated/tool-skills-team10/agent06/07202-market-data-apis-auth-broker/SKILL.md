---
name: market-data-apis-auth-broker
description: Use when tasks require market data apis auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Auth Broker

## Purpose
Design and execute market data apis workflows using auth broker controls with validated outcomes.
