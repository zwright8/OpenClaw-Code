---
name: dunning-workflows-task-decomposer
description: Use when tasks require dunning workflows task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Dunning Workflows Task Decomposer

## Purpose
Design and execute dunning workflows workflows using task decomposer controls with validated outcomes.
