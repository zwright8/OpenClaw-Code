---
name: app-store-management-spec-drift-detector
description: Use when tasks require app store management spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Spec Drift Detector

## Purpose
Design and execute app store management workflows using spec drift detector controls with validated outcomes.
