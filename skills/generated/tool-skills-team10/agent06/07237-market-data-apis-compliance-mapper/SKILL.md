---
name: market-data-apis-compliance-mapper
description: Use when tasks require market data apis compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Compliance Mapper

## Purpose
Design and execute market data apis workflows using compliance mapper controls with validated outcomes.
