---
name: news-monitoring-dependency-resolver
description: Use when tasks require news monitoring dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Dependency Resolver

## Purpose
Design and execute news monitoring workflows using dependency resolver controls with validated outcomes.
