---
name: survey-systems-approval-orchestrator
description: Use when tasks require survey systems approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Approval Orchestrator

## Purpose
Design and execute survey systems workflows using approval orchestrator controls with validated outcomes.
