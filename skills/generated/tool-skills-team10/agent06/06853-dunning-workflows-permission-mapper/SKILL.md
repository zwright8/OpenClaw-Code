---
name: dunning-workflows-permission-mapper
description: Use when tasks require dunning workflows permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Dunning Workflows Permission Mapper

## Purpose
Design and execute dunning workflows workflows using permission mapper controls with validated outcomes.
