---
name: regulatory-feeds-access-auditor
description: Use when tasks require regulatory feeds access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Access Auditor

## Purpose
Design and execute regulatory feeds workflows using access auditor controls with validated outcomes.
