---
name: device-labs-access-auditor
description: Use when tasks require device labs access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Access Auditor

## Purpose
Design and execute device labs workflows using access auditor controls with validated outcomes.
