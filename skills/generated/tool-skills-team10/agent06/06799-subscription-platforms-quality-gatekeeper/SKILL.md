---
name: subscription-platforms-quality-gatekeeper
description: Use when tasks require subscription platforms quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Subscription Platforms Quality Gatekeeper

## Purpose
Design and execute subscription platforms workflows using quality gatekeeper controls with validated outcomes.
