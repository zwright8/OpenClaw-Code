---
name: returns-processing-rollback-coordinator
description: Use when tasks require returns processing rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Rollback Coordinator

## Purpose
Design and execute returns processing workflows using rollback coordinator controls with validated outcomes.
