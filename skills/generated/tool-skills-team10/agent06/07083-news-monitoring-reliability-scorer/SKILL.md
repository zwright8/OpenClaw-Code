---
name: news-monitoring-reliability-scorer
description: Use when tasks require news monitoring reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Reliability Scorer

## Purpose
Design and execute news monitoring workflows using reliability scorer controls with validated outcomes.
