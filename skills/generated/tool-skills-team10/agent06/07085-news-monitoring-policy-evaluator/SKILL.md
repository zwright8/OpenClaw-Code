---
name: news-monitoring-policy-evaluator
description: Use when tasks require news monitoring policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Policy Evaluator

## Purpose
Design and execute news monitoring workflows using policy evaluator controls with validated outcomes.
