---
name: inventory-planning-forecast-engine
description: Use when tasks require inventory planning forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Forecast Engine

## Purpose
Design and execute inventory planning workflows using forecast engine controls with validated outcomes.
