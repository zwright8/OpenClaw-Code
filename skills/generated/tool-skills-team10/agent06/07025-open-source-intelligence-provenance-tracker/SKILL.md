---
name: open-source-intelligence-provenance-tracker
description: Use when tasks require open source intelligence provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Provenance Tracker

## Purpose
Design and execute open source intelligence workflows using provenance tracker controls with validated outcomes.
