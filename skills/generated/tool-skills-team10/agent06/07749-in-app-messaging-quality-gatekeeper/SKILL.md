---
name: in-app-messaging-quality-gatekeeper
description: Use when tasks require in-app messaging quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Quality Gatekeeper

## Purpose
Design and execute in-app messaging workflows using quality gatekeeper controls with validated outcomes.
