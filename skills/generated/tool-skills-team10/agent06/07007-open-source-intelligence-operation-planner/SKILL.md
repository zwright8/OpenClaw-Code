---
name: open-source-intelligence-operation-planner
description: Use when tasks require open source intelligence operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Operation Planner

## Purpose
Design and execute open source intelligence workflows using operation planner controls with validated outcomes.
