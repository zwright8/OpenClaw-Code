---
name: desktop-fleet-mgmt-snapshot-manager
description: Use when tasks require desktop fleet mgmt snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Snapshot Manager

## Purpose
Design and execute desktop fleet mgmt workflows using snapshot manager controls with validated outcomes.
