---
name: market-data-apis-task-decomposer
description: Use when tasks require market data apis task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Task Decomposer

## Purpose
Design and execute market data apis workflows using task decomposer controls with validated outcomes.
