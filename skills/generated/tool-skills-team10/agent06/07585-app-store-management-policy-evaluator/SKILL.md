---
name: app-store-management-policy-evaluator
description: Use when tasks require app store management policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Policy Evaluator

## Purpose
Design and execute app store management workflows using policy evaluator controls with validated outcomes.
