---
name: device-labs-incident-triage
description: Use when tasks require device labs incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Incident Triage

## Purpose
Design and execute device labs workflows using incident triage controls with validated outcomes.
