---
name: desktop-fleet-mgmt-state-reconciler
description: Use when tasks require desktop fleet mgmt state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt State Reconciler

## Purpose
Design and execute desktop fleet mgmt workflows using state reconciler controls with validated outcomes.
