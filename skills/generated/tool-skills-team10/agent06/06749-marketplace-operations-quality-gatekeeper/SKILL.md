---
name: marketplace-operations-quality-gatekeeper
description: Use when tasks require marketplace operations quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Quality Gatekeeper

## Purpose
Design and execute marketplace operations workflows using quality gatekeeper controls with validated outcomes.
