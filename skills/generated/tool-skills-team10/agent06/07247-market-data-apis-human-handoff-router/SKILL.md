---
name: market-data-apis-human-handoff-router
description: Use when tasks require market data apis human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Human Handoff Router

## Purpose
Design and execute market data apis workflows using human handoff router controls with validated outcomes.
