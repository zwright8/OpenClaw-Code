---
name: desktop-fleet-mgmt-remediation-planner
description: Use when tasks require desktop fleet mgmt remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Remediation Planner

## Purpose
Design and execute desktop fleet mgmt workflows using remediation planner controls with validated outcomes.
