...
description: Use when tasks require app store management evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Evidence Collector

## Purpose
Design and execute app store management workflows using evidence collector controls with validated outcomes.
