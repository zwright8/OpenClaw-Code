---
name: behavior-analytics-runbook-composer
description: Use when tasks require behavior analytics runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Runbook Composer

## Purpose
Design and execute behavior analytics workflows using runbook composer controls with validated outcomes.
