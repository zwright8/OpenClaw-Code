---
name: behavior-analytics-threshold-alerting
description: Use when tasks require behavior analytics threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Threshold Alerting

## Purpose
Design and execute behavior analytics workflows using threshold alerting controls with validated outcomes.
