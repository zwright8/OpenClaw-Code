---
name: order-management-quality-gatekeeper
description: Use when tasks require order management quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Quality Gatekeeper

## Purpose
Design and execute order management workflows using quality gatekeeper controls with validated outcomes.
