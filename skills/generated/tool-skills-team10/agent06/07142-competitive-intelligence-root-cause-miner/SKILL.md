---
name: competitive-intelligence-root-cause-miner
description: Use when tasks require competitive intelligence root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Root Cause Miner

## Purpose
Design and execute competitive intelligence workflows using root cause miner controls with validated outcomes.
