---
name: mobile-release-ops-feedback-harvester
description: Use when tasks require mobile release ops feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobile Release Ops Feedback Harvester

## Purpose
Design and execute mobile release ops workflows using feedback harvester controls with validated outcomes.
