---
name: open-source-intelligence-approval-orchestrator
description: Use when tasks require open source intelligence approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Approval Orchestrator

## Purpose
Design and execute open source intelligence workflows using approval orchestrator controls with validated outcomes.
