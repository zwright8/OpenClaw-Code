---
name: market-data-apis-runbook-composer
description: Use when tasks require market data apis runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Runbook Composer

## Purpose
Design and execute market data apis workflows using runbook composer controls with validated outcomes.
