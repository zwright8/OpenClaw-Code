---
name: desktop-fleet-mgmt-cost-attribution
description: Use when tasks require desktop fleet mgmt cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Cost Attribution

## Purpose
Design and execute desktop fleet mgmt workflows using cost attribution controls with validated outcomes.
