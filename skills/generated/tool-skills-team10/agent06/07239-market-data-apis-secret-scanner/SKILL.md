---
name: market-data-apis-secret-scanner
description: Use when tasks require market data apis secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Secret Scanner

## Purpose
Design and execute market data apis workflows using secret scanner controls with validated outcomes.
