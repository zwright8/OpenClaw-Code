---
name: forecasting-models-artifact-publisher
description: Use when tasks require forecasting models artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Artifact Publisher

## Purpose
Design and execute forecasting models workflows using artifact publisher controls with validated outcomes.
