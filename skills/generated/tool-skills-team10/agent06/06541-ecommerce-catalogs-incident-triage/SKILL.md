...
description: Use when tasks require ecommerce catalogs incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Incident Triage

## Purpose
Design and execute ecommerce catalogs workflows using incident triage controls with validated outcomes.
