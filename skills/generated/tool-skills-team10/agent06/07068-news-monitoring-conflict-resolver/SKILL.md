---
name: news-monitoring-conflict-resolver
description: Use when tasks require news monitoring conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Conflict Resolver

## Purpose
Design and execute news monitoring workflows using conflict resolver controls with validated outcomes.
