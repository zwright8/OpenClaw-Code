---
name: forecasting-models-dependency-resolver
description: Use when tasks require forecasting models dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Dependency Resolver

## Purpose
Design and execute forecasting models workflows using dependency resolver controls with validated outcomes.
