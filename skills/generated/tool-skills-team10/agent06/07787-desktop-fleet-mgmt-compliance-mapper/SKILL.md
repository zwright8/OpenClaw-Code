---
name: desktop-fleet-mgmt-compliance-mapper
description: Use when tasks require desktop fleet mgmt compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Compliance Mapper

## Purpose
Design and execute desktop fleet mgmt workflows using compliance mapper controls with validated outcomes.
