---
name: competitive-intelligence-evidence-collector
description: Use when tasks require competitive intelligence evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Evidence Collector

## Purpose
Design and execute competitive intelligence workflows using evidence collector controls with validated outcomes.
