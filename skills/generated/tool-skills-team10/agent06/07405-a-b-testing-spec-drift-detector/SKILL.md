---
name: a-b-testing-spec-drift-detector
description: Use when tasks require a/b testing spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Spec Drift Detector

## Purpose
Design and execute a/b testing workflows using spec drift detector controls with validated outcomes.
