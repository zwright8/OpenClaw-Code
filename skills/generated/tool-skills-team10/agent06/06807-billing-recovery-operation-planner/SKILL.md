---
name: billing-recovery-operation-planner
description: Use when tasks require billing recovery operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Operation Planner

## Purpose
Design and execute billing recovery workflows using operation planner controls with validated outcomes.
