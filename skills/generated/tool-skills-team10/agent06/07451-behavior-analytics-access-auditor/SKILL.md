---
name: behavior-analytics-access-auditor
description: Use when tasks require behavior analytics access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Access Auditor

## Purpose
Design and execute behavior analytics workflows using access auditor controls with validated outcomes.
