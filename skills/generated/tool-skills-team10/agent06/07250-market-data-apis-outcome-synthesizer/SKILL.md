---
name: market-data-apis-outcome-synthesizer
description: Use when tasks require market data apis outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Outcome Synthesizer

## Purpose
Design and execute market data apis workflows using outcome synthesizer controls with validated outcomes.
