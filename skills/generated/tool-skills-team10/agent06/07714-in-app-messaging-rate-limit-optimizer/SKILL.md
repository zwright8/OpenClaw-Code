---
name: in-app-messaging-rate-limit-optimizer
description: Use when tasks require in-app messaging rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Rate Limit Optimizer

## Purpose
Design and execute in-app messaging workflows using rate limit optimizer controls with validated outcomes.
