---
name: behavior-analytics-root-cause-miner
description: Use when tasks require behavior analytics root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Root Cause Miner

## Purpose
Design and execute behavior analytics workflows using root cause miner controls with validated outcomes.
