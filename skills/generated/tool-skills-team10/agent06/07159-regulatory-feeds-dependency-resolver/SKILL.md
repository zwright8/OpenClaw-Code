---
name: regulatory-feeds-dependency-resolver
description: Use when tasks require regulatory feeds dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Dependency Resolver

## Purpose
Design and execute regulatory feeds workflows using dependency resolver controls with validated outcomes.
