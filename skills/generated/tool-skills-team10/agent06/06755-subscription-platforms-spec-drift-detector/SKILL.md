---
name: subscription-platforms-spec-drift-detector
description: Use when tasks require subscription platforms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Subscription Platforms Spec Drift Detector

## Purpose
Design and execute subscription platforms workflows using spec drift detector controls with validated outcomes.
