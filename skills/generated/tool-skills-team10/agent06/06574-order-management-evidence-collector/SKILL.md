---
name: order-management-evidence-collector
description: Use when tasks require order management evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Evidence Collector

## Purpose
Design and execute order management workflows using evidence collector controls with validated outcomes.
