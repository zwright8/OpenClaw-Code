...
description: Use when tasks require behavior analytics evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Evidence Collector

## Purpose
Design and execute behavior analytics workflows using evidence collector controls with validated outcomes.
