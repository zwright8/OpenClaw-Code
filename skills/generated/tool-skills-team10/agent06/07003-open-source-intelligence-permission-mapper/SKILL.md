---
name: open-source-intelligence-permission-mapper
description: Use when tasks require open source intelligence permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Permission Mapper

## Purpose
Design and execute open source intelligence workflows using permission mapper controls with validated outcomes.
