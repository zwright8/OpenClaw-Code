---
name: behavior-analytics-postmortem-drafting
description: Use when tasks require behavior analytics postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Postmortem Drafting

## Purpose
Design and execute behavior analytics workflows using postmortem drafting controls with validated outcomes.
