---
name: order-management-root-cause-miner
description: Use when tasks require order management root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Root Cause Miner

## Purpose
Design and execute order management workflows using root cause miner controls with validated outcomes.
