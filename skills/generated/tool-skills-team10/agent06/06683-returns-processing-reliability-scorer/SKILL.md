---
name: returns-processing-reliability-scorer
description: Use when tasks require returns processing reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Reliability Scorer

## Purpose
Design and execute returns processing workflows using reliability scorer controls with validated outcomes.
