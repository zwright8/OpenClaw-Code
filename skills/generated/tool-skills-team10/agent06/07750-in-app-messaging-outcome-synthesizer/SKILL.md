---
name: in-app-messaging-outcome-synthesizer
description: Use when tasks require in-app messaging outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Outcome Synthesizer

## Purpose
Design and execute in-app messaging workflows using outcome synthesizer controls with validated outcomes.
