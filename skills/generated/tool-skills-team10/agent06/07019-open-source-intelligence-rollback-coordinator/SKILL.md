---
name: open-source-intelligence-rollback-coordinator
description: Use when tasks require open source intelligence rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Rollback Coordinator

## Purpose
Design and execute open source intelligence workflows using rollback coordinator controls with validated outcomes.
