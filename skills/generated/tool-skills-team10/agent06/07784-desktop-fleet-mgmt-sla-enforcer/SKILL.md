---
name: desktop-fleet-mgmt-sla-enforcer
description: Use when tasks require desktop fleet mgmt sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt SLA Enforcer

## Purpose
Design and execute desktop fleet mgmt workflows using sla enforcer controls with validated outcomes.
