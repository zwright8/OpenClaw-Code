---
name: regulatory-feeds-root-cause-miner
description: Use when tasks require regulatory feeds root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Root Cause Miner

## Purpose
Design and execute regulatory feeds workflows using root cause miner controls with validated outcomes.
