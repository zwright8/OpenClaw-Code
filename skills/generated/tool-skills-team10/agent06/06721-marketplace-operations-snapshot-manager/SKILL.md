---
name: marketplace-operations-snapshot-manager
description: Use when tasks require marketplace operations snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Snapshot Manager

## Purpose
Design and execute marketplace operations workflows using snapshot manager controls with validated outcomes.
