---
name: mobile-release-ops-permission-mapper
description: Use when tasks require mobile release ops permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobile Release Ops Permission Mapper

## Purpose
Design and execute mobile release ops workflows using permission mapper controls with validated outcomes.
