---
name: in-app-messaging-latency-analyzer
description: Use when tasks require in-app messaging latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Latency Analyzer

## Purpose
Design and execute in-app messaging workflows using latency analyzer controls with validated outcomes.
