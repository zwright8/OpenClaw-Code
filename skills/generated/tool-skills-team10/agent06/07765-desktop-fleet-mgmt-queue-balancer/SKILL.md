---
name: desktop-fleet-mgmt-queue-balancer
description: Use when tasks require desktop fleet mgmt queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Queue Balancer

## Purpose
Design and execute desktop fleet mgmt workflows using queue balancer controls with validated outcomes.
