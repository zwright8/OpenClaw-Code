---
name: forecasting-models-anomaly-detector
description: Use when tasks require forecasting models anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Anomaly Detector

## Purpose
Design and execute forecasting models workflows using anomaly detector controls with validated outcomes.
