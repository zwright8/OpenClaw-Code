---
name: mobile-release-ops-risk-scorer
description: Use when tasks require mobile release ops risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobile Release Ops Risk Scorer

## Purpose
Design and execute mobile release ops workflows using risk scorer controls with validated outcomes.
