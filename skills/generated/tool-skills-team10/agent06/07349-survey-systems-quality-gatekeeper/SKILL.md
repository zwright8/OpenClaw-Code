---
name: survey-systems-quality-gatekeeper
description: Use when tasks require survey systems quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Quality Gatekeeper

## Purpose
Design and execute survey systems workflows using quality gatekeeper controls with validated outcomes.
