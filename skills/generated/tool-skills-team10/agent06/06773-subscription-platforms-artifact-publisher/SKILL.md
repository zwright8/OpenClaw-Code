---
name: subscription-platforms-artifact-publisher
description: Use when tasks require subscription platforms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Subscription Platforms Artifact Publisher

## Purpose
Design and execute subscription platforms workflows using artifact publisher controls with validated outcomes.
