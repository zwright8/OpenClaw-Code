---
name: behavior-analytics-queue-balancer
description: Use when tasks require behavior analytics queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Queue Balancer

## Purpose
Design and execute behavior analytics workflows using queue balancer controls with validated outcomes.
