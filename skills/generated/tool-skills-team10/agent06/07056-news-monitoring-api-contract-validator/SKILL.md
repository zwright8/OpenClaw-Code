---
name: news-monitoring-api-contract-validator
description: Use when tasks require news monitoring api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring API Contract Validator

## Purpose
Design and execute news monitoring workflows using api contract validator controls with validated outcomes.

## Precision Profile
- Domain: News Monitoring
...
- Domain: [News Monitoring](../../resources/domains/news-monitoring.md)
