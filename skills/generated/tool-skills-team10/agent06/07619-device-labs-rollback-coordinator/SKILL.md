---
name: device-labs-rollback-coordinator
description: Use when tasks require device labs rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Rollback Coordinator

## Purpose
Design and execute device labs workflows using rollback coordinator controls with validated outcomes.
