---
name: in-app-messaging-rollback-coordinator
description: Use when tasks require in-app messaging rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Rollback Coordinator

## Purpose
Design and execute in-app messaging workflows using rollback coordinator controls with validated outcomes.
