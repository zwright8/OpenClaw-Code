---
name: market-data-apis-postmortem-drafting
description: Use when tasks require market data apis postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Postmortem Drafting

## Purpose
Design and execute market data apis workflows using postmortem drafting controls with validated outcomes.
