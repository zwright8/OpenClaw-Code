---
name: news-monitoring-root-cause-miner
description: Use when tasks require news monitoring root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Root Cause Miner

## Purpose
Design and execute news monitoring workflows using root cause miner controls with validated outcomes.
