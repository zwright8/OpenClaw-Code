---
name: returns-processing-policy-evaluator
description: Use when tasks require returns processing policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Policy Evaluator

## Purpose
Design and execute returns processing workflows using policy evaluator controls with validated outcomes.
