---
name: ecommerce-catalogs-compliance-mapper
description: Use when tasks require ecommerce catalogs compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Compliance Mapper

## Purpose
Design and execute ecommerce catalogs workflows using compliance mapper controls with validated outcomes.
