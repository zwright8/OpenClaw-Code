---
name: ecommerce-catalogs-auth-broker
description: Use when tasks require ecommerce catalogs auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Auth Broker

## Purpose
Design and execute ecommerce catalogs workflows using auth broker controls with validated outcomes.
