---
name: billing-recovery-artifact-publisher
description: Use when tasks require billing recovery artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Artifact Publisher

## Purpose
Design and execute billing recovery workflows using artifact publisher controls with validated outcomes.
