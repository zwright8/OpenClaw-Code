---
name: forecasting-models-auth-broker
description: Use when tasks require forecasting models auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Auth Broker

## Purpose
Design and execute forecasting models workflows using auth broker controls with validated outcomes.
