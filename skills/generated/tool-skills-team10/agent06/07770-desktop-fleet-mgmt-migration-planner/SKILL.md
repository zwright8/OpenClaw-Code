---
name: desktop-fleet-mgmt-migration-planner
description: Use when tasks require desktop fleet mgmt migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Migration Planner

## Purpose
Design and execute desktop fleet mgmt workflows using migration planner controls with validated outcomes.
