---
name: device-labs-policy-evaluator
description: Use when tasks require device labs policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Policy Evaluator

## Purpose
Design and execute device labs workflows using policy evaluator controls with validated outcomes.
