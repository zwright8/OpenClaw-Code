---
name: regulatory-feeds-anomaly-detector
description: Use when tasks require regulatory feeds anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Anomaly Detector

## Purpose
Design and execute regulatory feeds workflows using anomaly detector controls with validated outcomes.
