---
name: behavior-analytics-auth-broker
description: Use when tasks require behavior analytics auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Auth Broker

## Purpose
Design and execute behavior analytics workflows using auth broker controls with validated outcomes.
