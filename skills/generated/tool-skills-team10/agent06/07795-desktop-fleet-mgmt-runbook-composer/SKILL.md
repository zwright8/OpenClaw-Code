---
name: desktop-fleet-mgmt-runbook-composer
description: Use when tasks require desktop fleet mgmt runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Runbook Composer

## Purpose
Design and execute desktop fleet mgmt workflows using runbook composer controls with validated outcomes.
