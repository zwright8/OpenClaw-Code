---
name: news-monitoring-schema-introspector
description: Use when tasks require news monitoring schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Schema Introspector

## Purpose
Design and execute news monitoring workflows using schema introspector controls with validated outcomes.
