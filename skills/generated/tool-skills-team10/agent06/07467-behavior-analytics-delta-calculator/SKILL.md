---
name: behavior-analytics-delta-calculator
description: Use when tasks require behavior analytics delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Delta Calculator

## Purpose
Design and execute behavior analytics workflows using delta calculator controls with validated outcomes.
