---
name: regulatory-feeds-workflow-compiler
description: Use when tasks require regulatory feeds workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Workflow Compiler

## Purpose
Design and execute regulatory feeds workflows using workflow compiler controls with validated outcomes.
