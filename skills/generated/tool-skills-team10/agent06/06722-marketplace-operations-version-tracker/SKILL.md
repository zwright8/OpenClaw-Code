---
name: marketplace-operations-version-tracker
description: Use when tasks require marketplace operations version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Version Tracker

## Purpose
Design and execute marketplace operations workflows using version tracker controls with validated outcomes.
