---
name: returns-processing-spec-drift-detector
description: Use when tasks require returns processing spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Spec Drift Detector

## Purpose
Design and execute returns processing workflows using spec drift detector controls with validated outcomes.
