---
name: desktop-fleet-mgmt-human-handoff-router
description: Use when tasks require desktop fleet mgmt human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Human Handoff Router

## Purpose
Design and execute desktop fleet mgmt workflows using human handoff router controls with validated outcomes.
