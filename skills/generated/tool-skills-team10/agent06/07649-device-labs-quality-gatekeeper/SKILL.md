---
name: device-labs-quality-gatekeeper
description: Use when tasks require device labs quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Quality Gatekeeper

## Purpose
Design and execute device labs workflows using quality gatekeeper controls with validated outcomes.
