---
name: mobile-release-ops-forecast-engine
description: Use when tasks require mobile release ops forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobile Release Ops Forecast Engine

## Purpose
Design and execute mobile release ops workflows using forecast engine controls with validated outcomes.
