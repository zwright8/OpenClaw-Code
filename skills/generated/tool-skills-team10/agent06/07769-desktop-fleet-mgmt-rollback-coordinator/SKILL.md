---
name: desktop-fleet-mgmt-rollback-coordinator
description: Use when tasks require desktop fleet mgmt rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Rollback Coordinator

## Purpose
Design and execute desktop fleet mgmt workflows using rollback coordinator controls with validated outcomes.
