---
name: market-data-apis-snapshot-manager
description: Use when tasks require market data apis snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Snapshot Manager

## Purpose
Design and execute market data apis workflows using snapshot manager controls with validated outcomes.
