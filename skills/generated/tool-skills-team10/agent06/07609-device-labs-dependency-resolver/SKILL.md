---
name: device-labs-dependency-resolver
description: Use when tasks require device labs dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Dependency Resolver

## Purpose
Design and execute device labs workflows using dependency resolver controls with validated outcomes.
