---
name: behavior-analytics-cost-attribution
description: Use when tasks require behavior analytics cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Cost Attribution

## Purpose
Design and execute behavior analytics workflows using cost attribution controls with validated outcomes.
