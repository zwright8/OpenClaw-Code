---
name: market-data-apis-capacity-planner
description: Use when tasks require market data apis capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Capacity Planner

## Purpose
Design and execute market data apis workflows using capacity planner controls with validated outcomes.
