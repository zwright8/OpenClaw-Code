---
name: returns-processing-remediation-planner
description: Use when tasks require returns processing remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Remediation Planner

## Purpose
Design and execute returns processing workflows using remediation planner controls with validated outcomes.
