---
name: forecasting-models-operation-planner
description: Use when tasks require forecasting models operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Operation Planner

## Purpose
Design and execute forecasting models workflows using operation planner controls with validated outcomes.
