---
name: market-data-apis-spec-drift-detector
description: Use when tasks require market data apis spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Spec Drift Detector

## Purpose
Design and execute market data apis workflows using spec drift detector controls with validated outcomes.
