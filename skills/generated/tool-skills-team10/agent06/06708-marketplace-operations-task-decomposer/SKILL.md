---
name: marketplace-operations-task-decomposer
description: Use when tasks require marketplace operations task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Task Decomposer

## Purpose
Design and execute marketplace operations workflows using task decomposer controls with validated outcomes.
