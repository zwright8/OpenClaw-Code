---
name: revenue-recognition-auth-broker
description: Use when tasks require revenue recognition auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Auth Broker

## Purpose
Design and execute revenue recognition workflows using auth broker controls with validated outcomes.
