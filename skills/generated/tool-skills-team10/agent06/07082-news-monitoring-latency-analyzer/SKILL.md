---
name: news-monitoring-latency-analyzer
description: Use when tasks require news monitoring latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Latency Analyzer

## Purpose
Design and execute news monitoring workflows using latency analyzer controls with validated outcomes.
