---
name: behavior-analytics-forecast-engine
description: Use when tasks require behavior analytics forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Forecast Engine

## Purpose
Design and execute behavior analytics workflows using forecast engine controls with validated outcomes.
