---
name: news-monitoring-access-auditor
description: Use when tasks require news monitoring access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Access Auditor

## Purpose
Design and execute news monitoring workflows using access auditor controls with validated outcomes.
