---
name: in-app-messaging-cost-attribution
description: Use when tasks require in-app messaging cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Cost Attribution

## Purpose
Design and execute in-app messaging workflows using cost attribution controls with validated outcomes.
