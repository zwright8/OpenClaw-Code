---
name: order-management-task-decomposer
description: Use when tasks require order management task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Task Decomposer

## Purpose
Design and execute order management workflows using task decomposer controls with validated outcomes.
