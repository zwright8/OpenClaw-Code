---
name: desktop-fleet-mgmt-quality-gatekeeper
description: Use when tasks require desktop fleet mgmt quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Quality Gatekeeper

## Purpose
Design and execute desktop fleet mgmt workflows using quality gatekeeper controls with validated outcomes.
