---
name: survey-systems-runbook-composer
description: Use when tasks require survey systems runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Runbook Composer

## Purpose
Design and execute survey systems workflows using runbook composer controls with validated outcomes.
