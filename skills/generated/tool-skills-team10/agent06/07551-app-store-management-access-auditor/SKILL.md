---
name: app-store-management-access-auditor
description: Use when tasks require app store management access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Access Auditor

## Purpose
Design and execute app store management workflows using access auditor controls with validated outcomes.
