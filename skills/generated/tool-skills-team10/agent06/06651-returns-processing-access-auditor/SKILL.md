---
name: returns-processing-access-auditor
description: Use when tasks require returns processing access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Access Auditor

## Purpose
Design and execute returns processing workflows using access auditor controls with validated outcomes.
