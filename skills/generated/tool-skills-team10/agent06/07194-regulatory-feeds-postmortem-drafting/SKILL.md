---
name: regulatory-feeds-postmortem-drafting
description: Use when tasks require regulatory feeds postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Postmortem Drafting

## Purpose
Design and execute regulatory feeds workflows using postmortem drafting controls with validated outcomes.
