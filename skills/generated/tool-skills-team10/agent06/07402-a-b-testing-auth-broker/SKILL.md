---
name: a-b-testing-auth-broker
description: Use when tasks require a/b testing auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Auth Broker

## Purpose
Design and execute a/b testing workflows using auth broker controls with validated outcomes.
