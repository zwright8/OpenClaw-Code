---
name: news-monitoring-auth-broker
description: Use when tasks require news monitoring auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Auth Broker

## Purpose
Design and execute news monitoring workflows using auth broker controls with validated outcomes.
