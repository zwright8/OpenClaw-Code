---
name: survey-systems-access-auditor
description: Use when tasks require survey systems access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Access Auditor

## Purpose
Design and execute survey systems workflows using access auditor controls with validated outcomes.
