---
name: marketplace-operations-policy-evaluator
description: Use when tasks require marketplace operations policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Policy Evaluator

## Purpose
Design and execute marketplace operations workflows using policy evaluator controls with validated outcomes.
