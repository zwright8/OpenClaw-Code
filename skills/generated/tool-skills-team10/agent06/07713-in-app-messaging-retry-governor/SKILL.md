---
name: in-app-messaging-retry-governor
description: Use when tasks require in-app messaging retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Retry Governor

## Purpose
Design and execute in-app messaging workflows using retry governor controls with validated outcomes.
