---
name: order-management-auth-broker
description: Use when tasks require order management auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Auth Broker

## Purpose
Design and execute order management workflows using auth broker controls with validated outcomes.
