---
name: open-source-intelligence-evidence-collector
description: Use when tasks require open source intelligence evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Evidence Collector

## Purpose
Design and execute open source intelligence workflows using evidence collector controls with validated outcomes.
