---
name: open-source-intelligence-schema-introspector
description: Use when tasks require open source intelligence schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Schema Introspector

## Purpose
Design and execute open source intelligence workflows using schema introspector controls with validated outcomes.
