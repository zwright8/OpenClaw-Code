---
name: mobile-release-ops-evidence-collector
description: Use when tasks require mobile release ops evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobile Release Ops Evidence Collector

## Purpose
Design and execute mobile release ops workflows using evidence collector controls with validated outcomes.
