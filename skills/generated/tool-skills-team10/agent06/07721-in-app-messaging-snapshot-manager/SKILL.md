---
name: in-app-messaging-snapshot-manager
description: Use when tasks require in-app messaging snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Snapshot Manager

## Purpose
Design and execute in-app messaging workflows using snapshot manager controls with validated outcomes.
