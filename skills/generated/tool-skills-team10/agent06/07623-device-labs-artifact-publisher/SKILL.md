---
name: device-labs-artifact-publisher
description: Use when tasks require device labs artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Artifact Publisher

## Purpose
Design and execute device labs workflows using artifact publisher controls with validated outcomes.
