---
name: news-monitoring-delta-calculator
description: Use when tasks require news monitoring delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Delta Calculator

## Purpose
Design and execute news monitoring workflows using delta calculator controls with validated outcomes.
