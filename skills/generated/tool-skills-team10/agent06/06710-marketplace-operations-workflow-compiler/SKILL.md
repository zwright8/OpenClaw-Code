---
name: marketplace-operations-workflow-compiler
description: Use when tasks require marketplace operations workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Workflow Compiler

## Purpose
Design and execute marketplace operations workflows using workflow compiler controls with validated outcomes.
