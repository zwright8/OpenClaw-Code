---
name: competitive-intelligence-state-reconciler
description: Use when tasks require competitive intelligence state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence State Reconciler

## Purpose
Design and execute competitive intelligence workflows using state reconciler controls with validated outcomes.
