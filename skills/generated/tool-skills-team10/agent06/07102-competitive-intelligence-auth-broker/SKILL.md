---
name: competitive-intelligence-auth-broker
description: Use when tasks require competitive intelligence auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Auth Broker

## Purpose
Design and execute competitive intelligence workflows using auth broker controls with validated outcomes.
