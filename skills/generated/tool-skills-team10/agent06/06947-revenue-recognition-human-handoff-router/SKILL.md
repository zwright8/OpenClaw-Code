---
name: revenue-recognition-human-handoff-router
description: Use when tasks require revenue recognition human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Human Handoff Router

## Purpose
Design and execute revenue recognition workflows using human handoff router controls with validated outcomes.
