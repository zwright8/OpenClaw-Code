---
name: news-monitoring-job-scheduler
description: Use when tasks require news monitoring job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Job Scheduler

## Purpose
Design and execute news monitoring workflows using job scheduler controls with validated outcomes.
