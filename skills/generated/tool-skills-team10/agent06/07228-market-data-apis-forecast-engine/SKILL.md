---
name: market-data-apis-forecast-engine
description: Use when tasks require market data apis forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Forecast Engine

## Purpose
Design and execute market data apis workflows using forecast engine controls with validated outcomes.
