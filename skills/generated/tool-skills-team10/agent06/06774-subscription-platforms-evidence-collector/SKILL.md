---
name: subscription-platforms-evidence-collector
description: Use when tasks require subscription platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Subscription Platforms Evidence Collector

## Purpose
Design and execute subscription platforms workflows using evidence collector controls with validated outcomes.
