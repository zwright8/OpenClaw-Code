---
name: market-data-apis-rollback-coordinator
description: Use when tasks require market data apis rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Rollback Coordinator

## Purpose
Design and execute market data apis workflows using rollback coordinator controls with validated outcomes.
