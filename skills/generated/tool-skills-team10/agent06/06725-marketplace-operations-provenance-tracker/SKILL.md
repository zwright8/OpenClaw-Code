---
name: marketplace-operations-provenance-tracker
description: Use when tasks require marketplace operations provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Provenance Tracker

## Purpose
Design and execute marketplace operations workflows using provenance tracker controls with validated outcomes.
