---
name: regulatory-feeds-rate-limit-optimizer
description: Use when tasks require regulatory feeds rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Rate Limit Optimizer

## Purpose
Design and execute regulatory feeds workflows using rate limit optimizer controls with validated outcomes.
