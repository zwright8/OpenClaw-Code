---
name: order-management-approval-orchestrator
description: Use when tasks require order management approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Approval Orchestrator

## Purpose
Design and execute order management workflows using approval orchestrator controls with validated outcomes.
