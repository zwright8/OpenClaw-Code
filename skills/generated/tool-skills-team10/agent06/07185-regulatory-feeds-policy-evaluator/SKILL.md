---
name: regulatory-feeds-policy-evaluator
description: Use when tasks require regulatory feeds policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Policy Evaluator

## Purpose
Design and execute regulatory feeds workflows using policy evaluator controls with validated outcomes.
