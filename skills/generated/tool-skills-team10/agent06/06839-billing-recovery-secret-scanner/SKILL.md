---
name: billing-recovery-secret-scanner
description: Use when tasks require billing recovery secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Secret Scanner

## Purpose
Design and execute billing recovery workflows using secret scanner controls with validated outcomes.
