---
name: a-b-testing-capacity-planner
description: Use when tasks require a/b testing capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Capacity Planner

## Purpose
Design and execute a/b testing workflows using capacity planner controls with validated outcomes.
