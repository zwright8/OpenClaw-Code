---
name: open-source-intelligence-quality-gatekeeper
description: Use when tasks require open source intelligence quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Quality Gatekeeper

## Purpose
Design and execute open source intelligence workflows using quality gatekeeper controls with validated outcomes.
