---
name: news-monitoring-spec-drift-detector
description: Use when tasks require news monitoring spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Spec Drift Detector

## Purpose
Design and execute news monitoring workflows using spec drift detector controls with validated outcomes.
