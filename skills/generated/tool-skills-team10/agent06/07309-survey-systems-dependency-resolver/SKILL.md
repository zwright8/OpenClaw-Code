---
name: survey-systems-dependency-resolver
description: Use when tasks require survey systems dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Dependency Resolver

## Purpose
Design and execute survey systems workflows using dependency resolver controls with validated outcomes.
