---
name: news-monitoring-forecast-engine
description: Use when tasks require news monitoring forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Forecast Engine

## Purpose
Design and execute news monitoring workflows using forecast engine controls with validated outcomes.
