---
name: a-b-testing-outcome-synthesizer
description: Use when tasks require a/b testing outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Outcome Synthesizer

## Purpose
Design and execute a/b testing workflows using outcome synthesizer controls with validated outcomes.
