---
name: crowdsourcing-platforms-secret-scanner
description: Use when tasks require crowdsourcing platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Crowdsourcing Platforms Secret Scanner

## Purpose
Design and execute crowdsourcing platforms workflows using secret scanner controls with validated outcomes.
