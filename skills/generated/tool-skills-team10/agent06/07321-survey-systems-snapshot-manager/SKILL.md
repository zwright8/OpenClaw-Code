---
name: survey-systems-snapshot-manager
description: Use when tasks require survey systems snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Snapshot Manager

## Purpose
Design and execute survey systems workflows using snapshot manager controls with validated outcomes.
