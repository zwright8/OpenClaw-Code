---
name: inventory-planning-capacity-planner
description: Use when tasks require inventory planning capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Capacity Planner

## Purpose
Design and execute inventory planning workflows using capacity planner controls with validated outcomes.
