---
name: in-app-messaging-forecast-engine
description: Use when tasks require in-app messaging forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Forecast Engine

## Purpose
Design and execute in-app messaging workflows using forecast engine controls with validated outcomes.
