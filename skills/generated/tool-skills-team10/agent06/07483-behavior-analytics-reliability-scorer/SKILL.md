---
name: behavior-analytics-reliability-scorer
description: Use when tasks require behavior analytics reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Reliability Scorer

## Purpose
Design and execute behavior analytics workflows using reliability scorer controls with validated outcomes.
