---
name: revenue-recognition-provenance-tracker
description: Use when tasks require revenue recognition provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Provenance Tracker

## Purpose
Design and execute revenue recognition workflows using provenance tracker controls with validated outcomes.
