---
name: device-labs-feedback-harvester
description: Use when tasks require device labs feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Feedback Harvester

## Purpose
Design and execute device labs workflows using feedback harvester controls with validated outcomes.
