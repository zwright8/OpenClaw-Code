---
name: regulatory-feeds-execution-runner
description: Use when tasks require regulatory feeds execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Execution Runner

## Purpose
Design and execute regulatory feeds workflows using execution runner controls with validated outcomes.
