---
name: order-management-anomaly-detector
description: Use when tasks require order management anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Anomaly Detector

## Purpose
Design and execute order management workflows using anomaly detector controls with validated outcomes.
