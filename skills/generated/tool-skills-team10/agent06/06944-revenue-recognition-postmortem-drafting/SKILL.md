---
name: revenue-recognition-postmortem-drafting
description: Use when tasks require revenue recognition postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Postmortem Drafting

## Purpose
Design and execute revenue recognition workflows using postmortem drafting controls with validated outcomes.
