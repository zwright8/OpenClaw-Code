---
name: in-app-messaging-evidence-collector
description: Use when tasks require in-app messaging evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Evidence Collector

## Purpose
Design and execute in-app messaging workflows using evidence collector controls with validated outcomes.
