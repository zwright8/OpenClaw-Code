---
name: subscription-platforms-capacity-planner
description: Use when tasks require subscription platforms capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Subscription Platforms Capacity Planner

## Purpose
Design and execute subscription platforms workflows using capacity planner controls with validated outcomes.
