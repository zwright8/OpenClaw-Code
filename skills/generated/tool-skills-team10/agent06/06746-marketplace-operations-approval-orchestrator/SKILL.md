---
name: marketplace-operations-approval-orchestrator
description: Use when tasks require marketplace operations approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Approval Orchestrator

## Purpose
Design and execute marketplace operations workflows using approval orchestrator controls with validated outcomes.
