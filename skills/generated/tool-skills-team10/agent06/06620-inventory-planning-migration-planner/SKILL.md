---
name: inventory-planning-migration-planner
description: Use when tasks require inventory planning migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Migration Planner

## Purpose
Design and execute inventory planning workflows using migration planner controls with validated outcomes.
