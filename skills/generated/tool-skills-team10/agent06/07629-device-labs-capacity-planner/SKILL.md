---
name: device-labs-capacity-planner
description: Use when tasks require device labs capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Capacity Planner

## Purpose
Design and execute device labs workflows using capacity planner controls with validated outcomes.
