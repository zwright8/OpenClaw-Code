---
name: in-app-messaging-operation-planner
description: Use when tasks require in-app messaging operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Operation Planner

## Purpose
Design and execute in-app messaging workflows using operation planner controls with validated outcomes.
