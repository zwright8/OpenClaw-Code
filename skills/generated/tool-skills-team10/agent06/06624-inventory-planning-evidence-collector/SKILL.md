---
name: inventory-planning-evidence-collector
description: Use when tasks require inventory planning evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Evidence Collector

## Purpose
Design and execute inventory planning workflows using evidence collector controls with validated outcomes.
