---
name: news-monitoring-runbook-composer
description: Use when tasks require news monitoring runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Runbook Composer

## Purpose
Design and execute news monitoring workflows using runbook composer controls with validated outcomes.
