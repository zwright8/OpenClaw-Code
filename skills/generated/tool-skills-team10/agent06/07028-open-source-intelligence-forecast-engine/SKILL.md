---
name: open-source-intelligence-forecast-engine
description: Use when tasks require open source intelligence forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Forecast Engine

## Purpose
Design and execute open source intelligence workflows using forecast engine controls with validated outcomes.
