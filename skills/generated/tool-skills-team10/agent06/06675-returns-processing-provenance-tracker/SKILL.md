---
name: returns-processing-provenance-tracker
description: Use when tasks require returns processing provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Provenance Tracker

## Purpose
Design and execute returns processing workflows using provenance tracker controls with validated outcomes.
