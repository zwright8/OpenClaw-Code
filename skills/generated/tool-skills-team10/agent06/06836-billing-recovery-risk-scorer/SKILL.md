---
name: billing-recovery-risk-scorer
description: Use when tasks require billing recovery risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Risk Scorer

## Purpose
Design and execute billing recovery workflows using risk scorer controls with validated outcomes.
