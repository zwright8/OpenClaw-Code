---
name: regulatory-feeds-reliability-scorer
description: Use when tasks require regulatory feeds reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Reliability Scorer

## Purpose
Design and execute regulatory feeds workflows using reliability scorer controls with validated outcomes.
