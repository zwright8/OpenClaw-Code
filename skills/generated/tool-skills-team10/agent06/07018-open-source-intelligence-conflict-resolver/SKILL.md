---
name: open-source-intelligence-conflict-resolver
description: Use when tasks require open source intelligence conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Conflict Resolver

## Purpose
Design and execute open source intelligence workflows using conflict resolver controls with validated outcomes.
