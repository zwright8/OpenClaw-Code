---
name: experiment-platforms-spec-drift-detector
description: Use when tasks require experiment platforms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Experiment Platforms Spec Drift Detector

## Purpose
Design and execute experiment platforms workflows using spec drift detector controls with validated outcomes.
