---
name: billing-recovery-quality-gatekeeper
description: Use when tasks require billing recovery quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Quality Gatekeeper

## Purpose
Design and execute billing recovery workflows using quality gatekeeper controls with validated outcomes.
