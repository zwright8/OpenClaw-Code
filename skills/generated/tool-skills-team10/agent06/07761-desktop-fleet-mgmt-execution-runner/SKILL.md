---
name: desktop-fleet-mgmt-execution-runner
description: Use when tasks require desktop fleet mgmt execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Execution Runner

## Purpose
Design and execute desktop fleet mgmt workflows using execution runner controls with validated outcomes.
