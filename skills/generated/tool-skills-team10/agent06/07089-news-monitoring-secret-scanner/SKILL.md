---
name: news-monitoring-secret-scanner
description: Use when tasks require news monitoring secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Secret Scanner

## Purpose
Design and execute news monitoring workflows using secret scanner controls with validated outcomes.
