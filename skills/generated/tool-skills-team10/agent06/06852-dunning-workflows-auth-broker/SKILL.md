---
name: dunning-workflows-auth-broker
description: Use when tasks require dunning workflows auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Dunning Workflows Auth Broker

## Purpose
Design and execute dunning workflows workflows using auth broker controls with validated outcomes.
