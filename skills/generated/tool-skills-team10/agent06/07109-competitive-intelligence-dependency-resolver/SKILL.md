---
name: competitive-intelligence-dependency-resolver
description: Use when tasks require competitive intelligence dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Dependency Resolver

## Purpose
Design and execute competitive intelligence workflows using dependency resolver controls with validated outcomes.
