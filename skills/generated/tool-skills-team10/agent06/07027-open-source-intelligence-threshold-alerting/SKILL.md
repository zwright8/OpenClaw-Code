---
name: open-source-intelligence-threshold-alerting
description: Use when tasks require open source intelligence threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Threshold Alerting

## Purpose
Design and execute open source intelligence workflows using threshold alerting controls with validated outcomes.
