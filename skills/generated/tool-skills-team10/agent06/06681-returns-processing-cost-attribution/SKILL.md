---
name: returns-processing-cost-attribution
description: Use when tasks require returns processing cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Cost Attribution

## Purpose
Design and execute returns processing workflows using cost attribution controls with validated outcomes.
