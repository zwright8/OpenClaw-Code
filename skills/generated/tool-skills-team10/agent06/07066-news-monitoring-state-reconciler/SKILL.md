---
name: news-monitoring-state-reconciler
description: Use when tasks require news monitoring state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring State Reconciler

## Purpose
Design and execute news monitoring workflows using state reconciler controls with validated outcomes.
