---
name: open-source-intelligence-compliance-mapper
description: Use when tasks require open source intelligence compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Compliance Mapper

## Purpose
Design and execute open source intelligence workflows using compliance mapper controls with validated outcomes.
