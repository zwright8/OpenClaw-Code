---
name: revenue-recognition-dependency-resolver
description: Use when tasks require revenue recognition dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Dependency Resolver

## Purpose
Design and execute revenue recognition workflows using dependency resolver controls with validated outcomes.
