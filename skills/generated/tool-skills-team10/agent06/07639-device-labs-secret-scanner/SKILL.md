---
name: device-labs-secret-scanner
description: Use when tasks require device labs secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Secret Scanner

## Purpose
Design and execute device labs workflows using secret scanner controls with validated outcomes.
