---
name: in-app-messaging-budget-guardrail
description: Use when tasks require in-app messaging budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Budget Guardrail

## Purpose
Design and execute in-app messaging workflows using budget guardrail controls with validated outcomes.
