---
name: market-data-apis-conflict-resolver
description: Use when tasks require market data apis conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Conflict Resolver

## Purpose
Design and execute market data apis workflows using conflict resolver controls with validated outcomes.
