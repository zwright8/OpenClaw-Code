---
name: billing-recovery-provenance-tracker
description: Use when tasks require billing recovery provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Provenance Tracker

## Purpose
Design and execute billing recovery workflows using provenance tracker controls with validated outcomes.
