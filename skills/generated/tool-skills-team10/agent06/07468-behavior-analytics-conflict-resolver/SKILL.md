---
name: behavior-analytics-conflict-resolver
description: Use when tasks require behavior analytics conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Conflict Resolver

## Purpose
Design and execute behavior analytics workflows using conflict resolver controls with validated outcomes.
