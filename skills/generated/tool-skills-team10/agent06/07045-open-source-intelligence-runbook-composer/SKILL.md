---
name: open-source-intelligence-runbook-composer
description: Use when tasks require open source intelligence runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Runbook Composer

## Purpose
Design and execute open source intelligence workflows using runbook composer controls with validated outcomes.
