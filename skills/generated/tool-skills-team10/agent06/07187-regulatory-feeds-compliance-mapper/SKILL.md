---
name: regulatory-feeds-compliance-mapper
description: Use when tasks require regulatory feeds compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Compliance Mapper

## Purpose
Design and execute regulatory feeds workflows using compliance mapper controls with validated outcomes.
