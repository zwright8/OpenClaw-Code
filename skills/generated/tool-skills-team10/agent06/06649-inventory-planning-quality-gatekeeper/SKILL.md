---
name: inventory-planning-quality-gatekeeper
description: Use when tasks require inventory planning quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Quality Gatekeeper

## Purpose
Design and execute inventory planning workflows using quality gatekeeper controls with validated outcomes.
