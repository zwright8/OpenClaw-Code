---
name: ecommerce-catalogs-execution-runner
description: Use when tasks require ecommerce catalogs execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Execution Runner

## Purpose
Design and execute ecommerce catalogs workflows using execution runner controls with validated outcomes.
