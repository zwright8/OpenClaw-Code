---
name: crowdsourcing-platforms-state-reconciler
description: Use when tasks require crowdsourcing platforms state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Crowdsourcing Platforms State Reconciler

## Purpose
Design and execute crowdsourcing platforms workflows using state reconciler controls with validated outcomes.
