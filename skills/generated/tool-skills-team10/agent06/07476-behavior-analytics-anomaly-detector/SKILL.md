---
name: behavior-analytics-anomaly-detector
description: Use when tasks require behavior analytics anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Anomaly Detector

## Purpose
Design and execute behavior analytics workflows using anomaly detector controls with validated outcomes.
