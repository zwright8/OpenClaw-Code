---
name: regulatory-feeds-latency-analyzer
description: Use when tasks require regulatory feeds latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Latency Analyzer

## Purpose
Design and execute regulatory feeds workflows using latency analyzer controls with validated outcomes.
