---
name: regulatory-feeds-state-reconciler
description: Use when tasks require regulatory feeds state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds State Reconciler

## Purpose
Design and execute regulatory feeds workflows using state reconciler controls with validated outcomes.
