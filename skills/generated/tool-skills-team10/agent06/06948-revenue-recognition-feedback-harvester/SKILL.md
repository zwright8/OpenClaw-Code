---
name: revenue-recognition-feedback-harvester
description: Use when tasks require revenue recognition feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Feedback Harvester

## Purpose
Design and execute revenue recognition workflows using feedback harvester controls with validated outcomes.
