---
name: survey-systems-anomaly-detector
description: Use when tasks require survey systems anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Anomaly Detector

## Purpose
Design and execute survey systems workflows using anomaly detector controls with validated outcomes.
