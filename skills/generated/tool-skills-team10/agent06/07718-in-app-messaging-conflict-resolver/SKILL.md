---
name: in-app-messaging-conflict-resolver
description: Use when tasks require in-app messaging conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Conflict Resolver

## Purpose
Design and execute in-app messaging workflows using conflict resolver controls with validated outcomes.
