---
name: in-app-messaging-auth-broker
description: Use when tasks require in-app messaging auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Auth Broker

## Purpose
Design and execute in-app messaging workflows using auth broker controls with validated outcomes.
