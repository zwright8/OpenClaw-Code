---
name: survey-systems-artifact-publisher
description: Use when tasks require survey systems artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Artifact Publisher

## Purpose
Design and execute survey systems workflows using artifact publisher controls with validated outcomes.
