---
name: ecommerce-catalogs-spec-drift-detector
description: Use when tasks require ecommerce catalogs spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Spec Drift Detector

## Purpose
Design and execute ecommerce catalogs workflows using spec drift detector controls with validated outcomes.
