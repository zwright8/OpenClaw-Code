...
description: Use when tasks require behavior analytics artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Artifact Publisher

## Purpose
Design and execute behavior analytics workflows using artifact publisher controls with validated outcomes.
