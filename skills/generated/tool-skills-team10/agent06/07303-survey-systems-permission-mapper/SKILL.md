---
name: survey-systems-permission-mapper
description: Use when tasks require survey systems permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Permission Mapper

## Purpose
Design and execute survey systems workflows using permission mapper controls with validated outcomes.
