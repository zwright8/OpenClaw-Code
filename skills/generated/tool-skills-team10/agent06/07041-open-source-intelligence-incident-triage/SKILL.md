---
name: open-source-intelligence-incident-triage
description: Use when tasks require open source intelligence incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Incident Triage

## Purpose
Design and execute open source intelligence workflows using incident triage controls with validated outcomes.
