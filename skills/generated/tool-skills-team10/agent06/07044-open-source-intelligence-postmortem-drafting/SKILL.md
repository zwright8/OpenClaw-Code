---
name: open-source-intelligence-postmortem-drafting
description: Use when tasks require open source intelligence postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Postmortem Drafting

## Purpose
Design and execute open source intelligence workflows using postmortem drafting controls with validated outcomes.
