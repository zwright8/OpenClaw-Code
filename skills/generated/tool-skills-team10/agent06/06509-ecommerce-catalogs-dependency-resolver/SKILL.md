---
name: ecommerce-catalogs-dependency-resolver
description: Use when tasks require ecommerce catalogs dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Dependency Resolver

## Purpose
Design and execute ecommerce catalogs workflows using dependency resolver controls with validated outcomes.
