---
name: regulatory-feeds-permission-mapper
description: Use when tasks require regulatory feeds permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Permission Mapper

## Purpose
Design and execute regulatory feeds workflows using permission mapper controls with validated outcomes.
