---
name: news-monitoring-quality-gatekeeper
description: Use when tasks require news monitoring quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Quality Gatekeeper

## Purpose
Design and execute news monitoring workflows using quality gatekeeper controls with validated outcomes.
