...
description: Use when tasks require desktop fleet mgmt feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Feedback Harvester

## Purpose
Design and execute desktop fleet mgmt workflows using feedback harvester controls with validated outcomes.
