---
name: desktop-fleet-mgmt-postmortem-drafting
description: Use when tasks require desktop fleet mgmt postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Postmortem Drafting

## Purpose
Design and execute desktop fleet mgmt workflows using postmortem drafting controls with validated outcomes.
