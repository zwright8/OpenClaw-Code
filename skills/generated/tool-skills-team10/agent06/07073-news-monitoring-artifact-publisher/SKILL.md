---
name: news-monitoring-artifact-publisher
description: Use when tasks require news monitoring artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Artifact Publisher

## Purpose
Design and execute news monitoring workflows using artifact publisher controls with validated outcomes.
