---
name: inventory-planning-incident-triage
description: Use when tasks require inventory planning incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Incident Triage

## Purpose
Design and execute inventory planning workflows using incident triage controls with validated outcomes.
