---
name: behavior-analytics-incident-triage
description: Use when tasks require behavior analytics incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Incident Triage

## Purpose
Design and execute behavior analytics workflows using incident triage controls with validated outcomes.
