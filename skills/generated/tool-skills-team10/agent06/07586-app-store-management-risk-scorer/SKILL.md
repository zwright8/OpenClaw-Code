---
name: app-store-management-risk-scorer
description: Use when tasks require app store management risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Risk Scorer

## Purpose
Design and execute app store management workflows using risk scorer controls with validated outcomes.
