---
name: a-b-testing-anomaly-detector
description: Use when tasks require a/b testing anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Anomaly Detector

## Purpose
Design and execute a/b testing workflows using anomaly detector controls with validated outcomes.
