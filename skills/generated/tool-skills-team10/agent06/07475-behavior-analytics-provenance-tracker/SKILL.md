---
name: behavior-analytics-provenance-tracker
description: Use when tasks require behavior analytics provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Provenance Tracker

## Purpose
Design and execute behavior analytics workflows using provenance tracker controls with validated outcomes.
