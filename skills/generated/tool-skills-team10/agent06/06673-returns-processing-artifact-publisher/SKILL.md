---
name: returns-processing-artifact-publisher
description: Use when tasks require returns processing artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Artifact Publisher

## Purpose
Design and execute returns processing workflows using artifact publisher controls with validated outcomes.
