---
name: desktop-fleet-mgmt-api-contract-validator
description: Use when tasks require desktop fleet mgmt api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt API Contract Validator

## Purpose
Design and execute desktop fleet mgmt workflows using api contract validator controls with validated outcomes.
