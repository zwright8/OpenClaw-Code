---
name: a-b-testing-forecast-engine
description: Use when tasks require a/b testing forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Forecast Engine

## Purpose
Design and execute a/b testing workflows using forecast engine controls with validated outcomes.
