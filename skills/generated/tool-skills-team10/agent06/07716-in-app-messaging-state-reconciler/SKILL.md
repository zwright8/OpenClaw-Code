---
name: in-app-messaging-state-reconciler
description: Use when tasks require in-app messaging state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging State Reconciler

## Purpose
Design and execute in-app messaging workflows using state reconciler controls with validated outcomes.
