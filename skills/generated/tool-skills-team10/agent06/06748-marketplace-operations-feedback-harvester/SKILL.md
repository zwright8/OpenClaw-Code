---
name: marketplace-operations-feedback-harvester
description: Use when tasks require marketplace operations feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Feedback Harvester

## Purpose
Design and execute marketplace operations workflows using feedback harvester controls with validated outcomes.
