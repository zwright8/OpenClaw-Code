---
name: desktop-fleet-mgmt-auth-broker
description: Use when tasks require desktop fleet mgmt auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Auth Broker

## Purpose
Design and execute desktop fleet mgmt workflows using auth broker controls with validated outcomes.
