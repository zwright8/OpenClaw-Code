---
name: regulatory-feeds-task-decomposer
description: Use when tasks require regulatory feeds task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Task Decomposer

## Purpose
Design and execute regulatory feeds workflows using task decomposer controls with validated outcomes.
