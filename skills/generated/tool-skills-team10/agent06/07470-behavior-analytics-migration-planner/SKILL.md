---
name: behavior-analytics-migration-planner
description: Use when tasks require behavior analytics migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Migration Planner

## Purpose
Design and execute behavior analytics workflows using migration planner controls with validated outcomes.
