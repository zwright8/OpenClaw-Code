---
name: returns-processing-root-cause-miner
description: Use when tasks require returns processing root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Root Cause Miner

## Purpose
Design and execute returns processing workflows using root cause miner controls with validated outcomes.
