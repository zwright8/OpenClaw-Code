---
name: open-source-intelligence-capacity-planner
description: Use when tasks require open source intelligence capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Capacity Planner

## Purpose
Design and execute open source intelligence workflows using capacity planner controls with validated outcomes.
