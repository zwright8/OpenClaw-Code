---
name: in-app-messaging-anomaly-detector
description: Use when tasks require in-app messaging anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Anomaly Detector

## Purpose
Design and execute in-app messaging workflows using anomaly detector controls with validated outcomes.
