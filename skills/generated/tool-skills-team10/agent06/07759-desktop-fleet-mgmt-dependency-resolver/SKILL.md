...
description: Use when tasks require desktop fleet mgmt dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Dependency Resolver

## Purpose
Design and execute desktop fleet mgmt workflows using dependency resolver controls with validated outcomes.
