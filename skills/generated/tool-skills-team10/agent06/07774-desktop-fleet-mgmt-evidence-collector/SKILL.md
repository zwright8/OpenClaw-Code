---
name: desktop-fleet-mgmt-evidence-collector
description: Use when tasks require desktop fleet mgmt evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Desktop Fleet Mgmt Evidence Collector

## Purpose
Design and execute desktop fleet mgmt workflows using evidence collector controls with validated outcomes.
