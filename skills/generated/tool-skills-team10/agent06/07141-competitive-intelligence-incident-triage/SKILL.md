---
name: competitive-intelligence-incident-triage
description: Use when tasks require competitive intelligence incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Incident Triage

## Purpose
Design and execute competitive intelligence workflows using incident triage controls with validated outcomes.
