---
name: dunning-workflows-approval-orchestrator
description: Use when tasks require dunning workflows approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Dunning Workflows Approval Orchestrator

## Purpose
Design and execute dunning workflows workflows using approval orchestrator controls with validated outcomes.
