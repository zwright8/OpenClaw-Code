---
name: subscription-platforms-secret-scanner
description: Use when tasks require subscription platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Subscription Platforms Secret Scanner

## Purpose
Design and execute subscription platforms workflows using secret scanner controls with validated outcomes.
