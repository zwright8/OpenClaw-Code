---
name: survey-systems-evidence-collector
description: Use when tasks require survey systems evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Evidence Collector

## Purpose
Design and execute survey systems workflows using evidence collector controls with validated outcomes.
