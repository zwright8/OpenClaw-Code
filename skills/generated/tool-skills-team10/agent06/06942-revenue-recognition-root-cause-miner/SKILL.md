---
name: revenue-recognition-root-cause-miner
description: Use when tasks require revenue recognition root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Root Cause Miner

## Purpose
Design and execute revenue recognition workflows using root cause miner controls with validated outcomes.
