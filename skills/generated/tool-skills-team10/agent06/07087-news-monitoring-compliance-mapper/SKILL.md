---
name: news-monitoring-compliance-mapper
description: Use when tasks require news monitoring compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Compliance Mapper

## Purpose
Design and execute news monitoring workflows using compliance mapper controls with validated outcomes.
