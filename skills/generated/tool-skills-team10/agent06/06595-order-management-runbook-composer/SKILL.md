---
name: order-management-runbook-composer
description: Use when tasks require order management runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Runbook Composer

## Purpose
Design and execute order management workflows using runbook composer controls with validated outcomes.
