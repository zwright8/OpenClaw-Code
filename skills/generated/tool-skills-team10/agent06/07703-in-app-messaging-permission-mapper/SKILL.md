---
name: in-app-messaging-permission-mapper
description: Use when tasks require in-app messaging permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Permission Mapper

## Purpose
Design and execute in-app messaging workflows using permission mapper controls with validated outcomes.
