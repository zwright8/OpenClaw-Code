---
name: open-source-intelligence-queue-balancer
description: Use when tasks require open source intelligence queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Queue Balancer

## Purpose
Design and execute open source intelligence workflows using queue balancer controls with validated outcomes.
