---
name: regulatory-feeds-migration-planner
description: Use when tasks require regulatory feeds migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Migration Planner

## Purpose
Design and execute regulatory feeds workflows using migration planner controls with validated outcomes.
