---
name: competitive-intelligence-retry-governor
description: Use when tasks require competitive intelligence retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Retry Governor

## Purpose
Design and execute competitive intelligence workflows using retry governor controls with validated outcomes.
