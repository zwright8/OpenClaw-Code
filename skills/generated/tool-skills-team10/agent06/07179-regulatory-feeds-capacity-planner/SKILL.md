---
name: regulatory-feeds-capacity-planner
description: Use when tasks require regulatory feeds capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Capacity Planner

## Purpose
Design and execute regulatory feeds workflows using capacity planner controls with validated outcomes.
