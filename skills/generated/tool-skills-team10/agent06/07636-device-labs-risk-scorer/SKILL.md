---
name: device-labs-risk-scorer
description: Use when tasks require device labs risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Risk Scorer

## Purpose
Design and execute device labs workflows using risk scorer controls with validated outcomes.
