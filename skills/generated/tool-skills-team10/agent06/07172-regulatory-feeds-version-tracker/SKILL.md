---
name: regulatory-feeds-version-tracker
description: Use when tasks require regulatory feeds version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Version Tracker

## Purpose
Design and execute regulatory feeds workflows using version tracker controls with validated outcomes.
