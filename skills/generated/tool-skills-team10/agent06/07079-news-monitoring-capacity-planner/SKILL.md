---
name: news-monitoring-capacity-planner
description: Use when tasks require news monitoring capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Capacity Planner

## Purpose
Design and execute news monitoring workflows using capacity planner controls with validated outcomes.
