---
name: crowdsourcing-platforms-evidence-collector
description: Use when tasks require crowdsourcing platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Crowdsourcing Platforms Evidence Collector

## Purpose
Design and execute crowdsourcing platforms workflows using evidence collector controls with validated outcomes.
