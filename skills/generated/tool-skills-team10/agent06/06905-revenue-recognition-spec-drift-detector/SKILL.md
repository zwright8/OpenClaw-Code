---
name: revenue-recognition-spec-drift-detector
description: Use when tasks require revenue recognition spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Spec Drift Detector

## Purpose
Design and execute revenue recognition workflows using spec drift detector controls with validated outcomes.
