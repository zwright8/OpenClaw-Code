---
name: device-labs-evidence-collector
description: Use when tasks require device labs evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Evidence Collector

## Purpose
Design and execute device labs workflows using evidence collector controls with validated outcomes.
