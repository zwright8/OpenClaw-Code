---
name: marketplace-operations-capacity-planner
description: Use when tasks require marketplace operations capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Capacity Planner

## Purpose
Design and execute marketplace operations workflows using capacity planner controls with validated outcomes.
