...
description: Use when tasks require market data apis dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Dependency Resolver

## Purpose
Design and execute market data apis workflows using dependency resolver controls with validated outcomes.
