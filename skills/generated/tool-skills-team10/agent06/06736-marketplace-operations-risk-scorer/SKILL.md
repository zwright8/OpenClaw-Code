---
name: marketplace-operations-risk-scorer
description: Use when tasks require marketplace operations risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Risk Scorer

## Purpose
Design and execute marketplace operations workflows using risk scorer controls with validated outcomes.
