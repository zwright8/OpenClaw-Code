---
name: survey-systems-execution-runner
description: Use when tasks require survey systems execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Execution Runner

## Purpose
Design and execute survey systems workflows using execution runner controls with validated outcomes.
