---
name: marketplace-operations-execution-runner
description: Use when tasks require marketplace operations execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Execution Runner

## Purpose
Design and execute marketplace operations workflows using execution runner controls with validated outcomes.
