---
name: open-source-intelligence-execution-runner
description: Use when tasks require open source intelligence execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Execution Runner

## Purpose
Design and execute open source intelligence workflows using execution runner controls with validated outcomes.
