---
name: ecommerce-catalogs-task-decomposer
description: Use when tasks require ecommerce catalogs task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Task Decomposer

## Purpose
Design and execute ecommerce catalogs workflows using task decomposer controls with validated outcomes.
