---
name: behavior-analytics-permission-mapper
description: Use when tasks require behavior analytics permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Permission Mapper

## Purpose
Design and execute behavior analytics workflows using permission mapper controls with validated outcomes.
