---
name: competitive-intelligence-job-scheduler
description: Use when tasks require competitive intelligence job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Competitive Intelligence Job Scheduler

## Purpose
Design and execute competitive intelligence workflows using job scheduler controls with validated outcomes.
