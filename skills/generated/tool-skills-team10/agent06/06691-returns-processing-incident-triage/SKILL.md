---
name: returns-processing-incident-triage
description: Use when tasks require returns processing incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Incident Triage

## Purpose
Design and execute returns processing workflows using incident triage controls with validated outcomes.
