---
name: open-source-intelligence-auth-broker
description: Use when tasks require open source intelligence auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Auth Broker

## Purpose
Design and execute open source intelligence workflows using auth broker controls with validated outcomes.
