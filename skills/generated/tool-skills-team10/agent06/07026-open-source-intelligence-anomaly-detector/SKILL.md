---
name: open-source-intelligence-anomaly-detector
description: Use when tasks require open source intelligence anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Anomaly Detector

## Purpose
Design and execute open source intelligence workflows using anomaly detector controls with validated outcomes.
