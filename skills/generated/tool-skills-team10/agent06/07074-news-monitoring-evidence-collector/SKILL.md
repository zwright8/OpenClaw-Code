---
name: news-monitoring-evidence-collector
description: Use when tasks require news monitoring evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Evidence Collector

## Purpose
Design and execute news monitoring workflows using evidence collector controls with validated outcomes.
