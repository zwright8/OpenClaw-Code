---
name: open-source-intelligence-access-auditor
description: Use when tasks require open source intelligence access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Access Auditor

## Purpose
Design and execute open source intelligence workflows using access auditor controls with validated outcomes.
