---
name: returns-processing-postmortem-drafting
description: Use when tasks require returns processing postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Postmortem Drafting

## Purpose
Design and execute returns processing workflows using postmortem drafting controls with validated outcomes.
