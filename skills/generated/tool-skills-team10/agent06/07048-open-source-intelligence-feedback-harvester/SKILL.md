---
name: open-source-intelligence-feedback-harvester
description: Use when tasks require open source intelligence feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Feedback Harvester

## Purpose
Design and execute open source intelligence workflows using feedback harvester controls with validated outcomes.
