---
name: in-app-messaging-threshold-alerting
description: Use when tasks require in-app messaging threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Threshold Alerting

## Purpose
Design and execute in-app messaging workflows using threshold alerting controls with validated outcomes.
