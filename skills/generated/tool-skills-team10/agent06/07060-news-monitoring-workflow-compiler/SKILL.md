---
name: news-monitoring-workflow-compiler
description: Use when tasks require news monitoring workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Workflow Compiler

## Purpose
Design and execute news monitoring workflows using workflow compiler controls with validated outcomes.
