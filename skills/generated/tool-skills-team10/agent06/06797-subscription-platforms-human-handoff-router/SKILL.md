---
name: subscription-platforms-human-handoff-router
description: Use when tasks require subscription platforms human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Subscription Platforms Human Handoff Router

## Purpose
Design and execute subscription platforms workflows using human handoff router controls with validated outcomes.
