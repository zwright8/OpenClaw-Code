---
name: experiment-platforms-secret-scanner
description: Use when tasks require experiment platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Experiment Platforms Secret Scanner

## Purpose
Design and execute experiment platforms workflows using secret scanner controls with validated outcomes.
