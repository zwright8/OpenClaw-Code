---
name: app-store-management-rollback-coordinator
description: Use when tasks require app store management rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Rollback Coordinator

## Purpose
Design and execute app store management workflows using rollback coordinator controls with validated outcomes.
