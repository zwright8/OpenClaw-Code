---
name: regulatory-feeds-evidence-collector
description: Use when tasks require regulatory feeds evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Evidence Collector

## Purpose
Design and execute regulatory feeds workflows using evidence collector controls with validated outcomes.
