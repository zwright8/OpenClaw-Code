---
name: regulatory-feeds-approval-orchestrator
description: Use when tasks require regulatory feeds approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Approval Orchestrator

## Purpose
Design and execute regulatory feeds workflows using approval orchestrator controls with validated outcomes.
