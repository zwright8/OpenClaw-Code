---
name: order-management-spec-drift-detector
description: Use when tasks require order management spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Order Management Spec Drift Detector

## Purpose
Design and execute order management workflows using spec drift detector controls with validated outcomes.
