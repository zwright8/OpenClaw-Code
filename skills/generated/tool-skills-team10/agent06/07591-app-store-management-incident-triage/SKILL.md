---
name: app-store-management-incident-triage
description: Use when tasks require app store management incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Incident Triage

## Purpose
Design and execute app store management workflows using incident triage controls with validated outcomes.
