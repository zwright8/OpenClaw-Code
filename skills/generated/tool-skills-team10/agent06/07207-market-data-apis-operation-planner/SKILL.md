---
name: market-data-apis-operation-planner
description: Use when tasks require market data apis operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Operation Planner

## Purpose
Design and execute market data apis workflows using operation planner controls with validated outcomes.
