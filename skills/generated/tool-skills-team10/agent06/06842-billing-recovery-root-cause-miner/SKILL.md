---
name: billing-recovery-root-cause-miner
description: Use when tasks require billing recovery root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Root Cause Miner

## Purpose
Design and execute billing recovery workflows using root cause miner controls with validated outcomes.
