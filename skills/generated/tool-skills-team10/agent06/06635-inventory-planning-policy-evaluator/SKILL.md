---
name: inventory-planning-policy-evaluator
description: Use when tasks require inventory planning policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inventory Planning Policy Evaluator

## Purpose
Design and execute inventory planning workflows using policy evaluator controls with validated outcomes.
