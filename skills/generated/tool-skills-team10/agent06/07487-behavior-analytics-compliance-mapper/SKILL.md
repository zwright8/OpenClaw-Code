---
name: behavior-analytics-compliance-mapper
description: Use when tasks require behavior analytics compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Compliance Mapper

## Purpose
Design and execute behavior analytics workflows using compliance mapper controls with validated outcomes.
