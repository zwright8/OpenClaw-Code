---
name: news-monitoring-pii-redactor
description: Use when tasks require news monitoring pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring PII Redactor

## Purpose
Design and execute news monitoring workflows using pii redactor controls with validated outcomes.
