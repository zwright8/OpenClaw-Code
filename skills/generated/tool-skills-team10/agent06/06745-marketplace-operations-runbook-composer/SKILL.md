---
name: marketplace-operations-runbook-composer
description: Use when tasks require marketplace operations runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketplace Operations Runbook Composer

## Purpose
Design and execute marketplace operations workflows using runbook composer controls with validated outcomes.
