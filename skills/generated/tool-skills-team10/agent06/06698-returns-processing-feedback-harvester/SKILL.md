---
name: returns-processing-feedback-harvester
description: Use when tasks require returns processing feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Feedback Harvester

## Purpose
Design and execute returns processing workflows using feedback harvester controls with validated outcomes.
