---
name: open-source-intelligence-cost-attribution
description: Use when tasks require open source intelligence cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Open Source Intelligence Cost Attribution

## Purpose
Design and execute open source intelligence workflows using cost attribution controls with validated outcomes.
