---
name: app-store-management-postmortem-drafting
description: Use when tasks require app store management postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# App Store Management Postmortem Drafting

## Purpose
Design and execute app store management workflows using postmortem drafting controls with validated outcomes.
