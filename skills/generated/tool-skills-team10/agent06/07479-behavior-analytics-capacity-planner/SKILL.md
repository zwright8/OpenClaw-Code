---
name: behavior-analytics-capacity-planner
description: Use when tasks require behavior analytics capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Capacity Planner

## Purpose
Design and execute behavior analytics workflows using capacity planner controls with validated outcomes.
