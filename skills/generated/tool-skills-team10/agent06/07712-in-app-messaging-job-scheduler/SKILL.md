---
name: in-app-messaging-job-scheduler
description: Use when tasks require in-app messaging job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging Job Scheduler

## Purpose
Design and execute in-app messaging workflows using job scheduler controls with validated outcomes.
