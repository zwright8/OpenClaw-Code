---
name: news-monitoring-snapshot-manager
description: Use when tasks require news monitoring snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Snapshot Manager

## Purpose
Design and execute news monitoring workflows using snapshot manager controls with validated outcomes.
