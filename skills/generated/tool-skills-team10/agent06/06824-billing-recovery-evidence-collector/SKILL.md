---
name: billing-recovery-evidence-collector
description: Use when tasks require billing recovery evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Evidence Collector

## Purpose
Design and execute billing recovery workflows using evidence collector controls with validated outcomes.
