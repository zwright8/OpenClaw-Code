---
name: behavior-analytics-remediation-planner
description: Use when tasks require behavior analytics remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Behavior Analytics Remediation Planner

## Purpose
Design and execute behavior analytics workflows using remediation planner controls with validated outcomes.
