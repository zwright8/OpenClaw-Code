---
name: ecommerce-catalogs-evidence-collector
description: Use when tasks require ecommerce catalogs evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ecommerce Catalogs Evidence Collector

## Purpose
Design and execute ecommerce catalogs workflows using evidence collector controls with validated outcomes.
