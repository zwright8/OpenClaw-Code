---
name: returns-processing-operation-planner
description: Use when tasks require returns processing operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Operation Planner

## Purpose
Design and execute returns processing workflows using operation planner controls with validated outcomes.
