---
name: revenue-recognition-forecast-engine
description: Use when tasks require revenue recognition forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Revenue Recognition Forecast Engine

## Purpose
Design and execute revenue recognition workflows using forecast engine controls with validated outcomes.
