---
name: returns-processing-job-scheduler
description: Use when tasks require returns processing job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Returns Processing Job Scheduler

## Purpose
Design and execute returns processing workflows using job scheduler controls with validated outcomes.
