---
name: device-labs-snapshot-manager
description: Use when tasks require device labs snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Device Labs Snapshot Manager

## Purpose
Design and execute device labs workflows using snapshot manager controls with validated outcomes.
