---
name: regulatory-feeds-runbook-composer
description: Use when tasks require regulatory feeds runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Runbook Composer

## Purpose
Design and execute regulatory feeds workflows using runbook composer controls with validated outcomes.
