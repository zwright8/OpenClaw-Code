---
name: billing-recovery-snapshot-manager
description: Use when tasks require billing recovery snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Billing Recovery Snapshot Manager

## Purpose
Design and execute billing recovery workflows using snapshot manager controls with validated outcomes.
