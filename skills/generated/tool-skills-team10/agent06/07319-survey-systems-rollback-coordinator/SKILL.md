---
name: survey-systems-rollback-coordinator
description: Use when tasks require survey systems rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Rollback Coordinator

## Purpose
Design and execute survey systems workflows using rollback coordinator controls with validated outcomes.
