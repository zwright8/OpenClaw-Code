---
name: survey-systems-operation-planner
description: Use when tasks require survey systems operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Operation Planner

## Purpose
Design and execute survey systems workflows using operation planner controls with validated outcomes.
