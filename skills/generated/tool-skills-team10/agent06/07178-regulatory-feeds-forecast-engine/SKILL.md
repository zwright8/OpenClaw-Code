---
name: regulatory-feeds-forecast-engine
description: Use when tasks require regulatory feeds forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Regulatory Feeds Forecast Engine

## Purpose
Design and execute regulatory feeds workflows using forecast engine controls with validated outcomes.
