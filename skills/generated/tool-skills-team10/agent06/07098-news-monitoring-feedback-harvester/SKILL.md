---
name: news-monitoring-feedback-harvester
description: Use when tasks require news monitoring feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Feedback Harvester

## Purpose
Design and execute news monitoring workflows using feedback harvester controls with validated outcomes.
