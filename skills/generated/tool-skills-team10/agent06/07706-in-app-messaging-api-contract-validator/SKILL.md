---
name: in-app-messaging-api-contract-validator
description: Use when tasks require in-app messaging api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# In-App Messaging API Contract Validator

## Purpose
Design and execute in-app messaging workflows using api contract validator controls with validated outcomes.

## Precision Profile
- Domain: In-App Messaging
...
- Domain: [In-App Messaging](../../resources/domains/in-app-messaging.md)
