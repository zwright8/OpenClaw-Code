---
name: market-data-apis-anomaly-detector
description: Use when tasks require market data apis anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Market Data APIs Anomaly Detector

## Purpose
Design and execute market data apis workflows using anomaly detector controls with validated outcomes.
