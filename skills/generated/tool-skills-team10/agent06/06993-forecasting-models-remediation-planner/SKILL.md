---
name: forecasting-models-remediation-planner
description: Use when tasks require forecasting models remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Forecasting Models Remediation Planner

## Purpose
Design and execute forecasting models workflows using remediation planner controls with validated outcomes.
