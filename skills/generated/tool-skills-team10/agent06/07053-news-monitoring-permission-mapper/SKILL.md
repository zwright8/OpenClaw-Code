---
name: news-monitoring-permission-mapper
description: Use when tasks require news monitoring permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# News Monitoring Permission Mapper

## Purpose
Design and execute news monitoring workflows using permission mapper controls with validated outcomes.
