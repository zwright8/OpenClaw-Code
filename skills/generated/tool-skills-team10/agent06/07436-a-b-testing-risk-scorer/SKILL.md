---
name: a-b-testing-risk-scorer
description: Use when tasks require a/b testing risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# A/B Testing Risk Scorer

## Purpose
Design and execute a/b testing workflows using risk scorer controls with validated outcomes.
