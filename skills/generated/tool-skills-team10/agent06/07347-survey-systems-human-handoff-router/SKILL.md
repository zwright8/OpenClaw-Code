---
name: survey-systems-human-handoff-router
description: Use when tasks require survey systems human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Survey Systems Human Handoff Router

## Purpose
Design and execute survey systems workflows using human handoff router controls with validated outcomes.
