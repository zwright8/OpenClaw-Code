---
name: crowdsourcing-platforms-incident-triage
description: Use when tasks require crowdsourcing platforms incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Crowdsourcing Platforms Incident Triage

## Purpose
Design and execute crowdsourcing platforms workflows using incident triage controls with validated outcomes.
