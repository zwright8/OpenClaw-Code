---
name: evaluation-harnesses-remediation-planner
description: Use when tasks require evaluation harnesses remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Remediation Planner

## Purpose
Design and execute evaluation harnesses workflows using remediation planner controls with validated outcomes.
