---
name: scheduling-dispatch-auth-broker
description: Use when tasks require scheduling dispatch auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Auth Broker

## Purpose
Design and execute scheduling dispatch workflows using auth broker controls with validated outcomes.
