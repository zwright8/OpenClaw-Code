---
name: ontology-management-capacity-planner
description: Use when tasks require ontology management capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Capacity Planner

## Purpose
Design and execute ontology management workflows using capacity planner controls with validated outcomes.
