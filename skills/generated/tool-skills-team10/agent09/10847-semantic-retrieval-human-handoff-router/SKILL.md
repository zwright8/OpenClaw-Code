---
name: semantic-retrieval-human-handoff-router
description: Use when tasks require semantic retrieval human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Human Handoff Router

## Purpose
Design and execute semantic retrieval workflows using human handoff router controls with validated outcomes.
