---
name: field-service-ops-artifact-publisher
description: Use when tasks require field service ops artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Artifact Publisher

## Purpose
Design and execute field service ops workflows using artifact publisher controls with validated outcomes.
