---
name: inference-caches-evidence-collector
description: Use when tasks require inference caches evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inference Caches Evidence Collector

## Purpose
Design and execute inference caches workflows using evidence collector controls with validated outcomes.
