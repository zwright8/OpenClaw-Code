---
name: churn-prevention-schema-introspector
description: Use when tasks require churn prevention schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Schema Introspector

## Purpose
Design and execute churn prevention workflows using schema introspector controls with validated outcomes.
