---
name: partner-integrations-task-decomposer
description: Use when tasks require partner integrations task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Task Decomposer

## Purpose
Design and execute partner integrations workflows using task decomposer controls with validated outcomes.
