---
name: knowledge-graphs-remediation-planner
description: Use when tasks require knowledge graphs remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Remediation Planner

## Purpose
Design and execute knowledge graphs workflows using remediation planner controls with validated outcomes.
