---
name: evaluation-harnesses-execution-runner
description: Use when tasks require evaluation harnesses execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Execution Runner

## Purpose
Design and execute evaluation harnesses workflows using execution runner controls with validated outcomes.
