---
name: edi-pipelines-root-cause-miner
description: Use when tasks require edi pipelines root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Root Cause Miner

## Purpose
Design and execute edi pipelines workflows using root cause miner controls with validated outcomes.
