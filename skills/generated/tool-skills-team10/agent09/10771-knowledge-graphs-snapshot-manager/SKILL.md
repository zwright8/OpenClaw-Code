---
name: knowledge-graphs-snapshot-manager
description: Use when tasks require knowledge graphs snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Snapshot Manager

## Purpose
Design and execute knowledge graphs workflows using snapshot manager controls with validated outcomes.
