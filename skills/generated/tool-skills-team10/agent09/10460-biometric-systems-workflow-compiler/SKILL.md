---
name: biometric-systems-workflow-compiler
description: Use when tasks require biometric systems workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Workflow Compiler

## Purpose
Design and execute biometric systems workflows using workflow compiler controls with validated outcomes.
