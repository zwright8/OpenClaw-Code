---
name: customer-success-plans-artifact-publisher
description: Use when tasks require customer success plans artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Artifact Publisher

## Purpose
Design and execute customer success plans workflows using artifact publisher controls with validated outcomes.
