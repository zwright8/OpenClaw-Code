---
name: knowledge-graphs-rate-limit-optimizer
description: Use when tasks require knowledge graphs rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Rate Limit Optimizer

## Purpose
Design and execute knowledge graphs workflows using rate limit optimizer controls with validated outcomes.
