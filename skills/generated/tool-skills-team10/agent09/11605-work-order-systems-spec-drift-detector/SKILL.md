---
name: work-order-systems-spec-drift-detector
description: Use when tasks require work order systems spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Spec Drift Detector

## Purpose
Design and execute work order systems workflows using spec drift detector controls with validated outcomes.
