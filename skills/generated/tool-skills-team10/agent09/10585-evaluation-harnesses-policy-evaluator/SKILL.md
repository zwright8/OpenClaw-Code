---
name: evaluation-harnesses-policy-evaluator
description: Use when tasks require evaluation harnesses policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Policy Evaluator

## Purpose
Design and execute evaluation harnesses workflows using policy evaluator controls with validated outcomes.
