---
name: biometric-systems-snapshot-manager
description: Use when tasks require biometric systems snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Snapshot Manager

## Purpose
Design and execute biometric systems workflows using snapshot manager controls with validated outcomes.
