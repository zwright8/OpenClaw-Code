---
name: edi-pipelines-risk-scorer
description: Use when tasks require edi pipelines risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Risk Scorer

## Purpose
Design and execute edi pipelines workflows using risk scorer controls with validated outcomes.
