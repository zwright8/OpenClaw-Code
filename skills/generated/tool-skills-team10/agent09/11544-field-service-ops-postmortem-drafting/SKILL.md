---
name: field-service-ops-postmortem-drafting
description: Use when tasks require field service ops postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Postmortem Drafting

## Purpose
Design and execute field service ops workflows using postmortem drafting controls with validated outcomes.
