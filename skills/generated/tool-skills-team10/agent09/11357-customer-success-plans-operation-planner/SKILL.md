---
name: customer-success-plans-operation-planner
description: Use when tasks require customer success plans operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Operation Planner

## Purpose
Design and execute customer success plans workflows using operation planner controls with validated outcomes.
