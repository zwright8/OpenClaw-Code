---
name: qbr-automation-reliability-scorer
description: Use when tasks require qbr automation reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Reliability Scorer

## Purpose
Design and execute qbr automation workflows using reliability scorer controls with validated outcomes.
