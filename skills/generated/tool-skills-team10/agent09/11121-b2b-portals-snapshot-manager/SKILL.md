---
name: b2b-portals-snapshot-manager
description: Use when tasks require b2b portals snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Snapshot Manager

## Purpose
Design and execute b2b portals workflows using snapshot manager controls with validated outcomes.
