---
name: document-verification-risk-scorer
description: Use when tasks require document verification risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Risk Scorer

## Purpose
Design and execute document verification workflows using risk scorer controls with validated outcomes.
