---
name: customer-success-plans-secret-scanner
description: Use when tasks require customer success plans secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Secret Scanner

## Purpose
Design and execute customer success plans workflows using secret scanner controls with validated outcomes.
