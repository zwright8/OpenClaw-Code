---
name: qbr-automation-approval-orchestrator
description: Use when tasks require qbr automation approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Approval Orchestrator

## Purpose
Design and execute qbr automation workflows using approval orchestrator controls with validated outcomes.
