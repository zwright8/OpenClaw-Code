---
name: knowledge-graphs-permission-mapper
description: Use when tasks require knowledge graphs permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Permission Mapper

## Purpose
Design and execute knowledge graphs workflows using permission mapper controls with validated outcomes.
