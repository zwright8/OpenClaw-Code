---
name: catalog-syndication-spec-drift-detector
description: Use when tasks require catalog syndication spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Spec Drift Detector

## Purpose
Design and execute catalog syndication workflows using spec drift detector controls with validated outcomes.
