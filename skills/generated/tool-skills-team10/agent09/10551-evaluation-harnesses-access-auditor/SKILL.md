---
name: evaluation-harnesses-access-auditor
description: Use when tasks require evaluation harnesses access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Access Auditor

## Purpose
Design and execute evaluation harnesses workflows using access auditor controls with validated outcomes.
