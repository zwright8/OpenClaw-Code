---
name: knowledge-graphs-feedback-harvester
description: Use when tasks require knowledge graphs feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Feedback Harvester

## Purpose
Design and execute knowledge graphs workflows using feedback harvester controls with validated outcomes.
