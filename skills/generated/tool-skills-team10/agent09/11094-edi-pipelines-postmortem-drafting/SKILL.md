---
name: edi-pipelines-postmortem-drafting
description: Use when tasks require edi pipelines postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Postmortem Drafting

## Purpose
Design and execute edi pipelines workflows using postmortem drafting controls with validated outcomes.
