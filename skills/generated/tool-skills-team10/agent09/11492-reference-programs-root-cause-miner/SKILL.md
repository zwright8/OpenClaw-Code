---
name: reference-programs-root-cause-miner
description: Use when tasks require reference programs root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Root Cause Miner

## Purpose
Design and execute reference programs workflows using root cause miner controls with validated outcomes.
