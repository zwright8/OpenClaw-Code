---
name: semantic-retrieval-forecast-engine
description: Use when tasks require semantic retrieval forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Forecast Engine

## Purpose
Design and execute semantic retrieval workflows using forecast engine controls with validated outcomes.
