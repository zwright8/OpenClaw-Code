---
name: semantic-retrieval-migration-planner
description: Use when tasks require semantic retrieval migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Migration Planner

## Purpose
Design and execute semantic retrieval workflows using migration planner controls with validated outcomes.
