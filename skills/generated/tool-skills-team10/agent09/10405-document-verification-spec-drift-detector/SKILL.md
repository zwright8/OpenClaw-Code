---
name: document-verification-spec-drift-detector
description: Use when tasks require document verification spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Spec Drift Detector

## Purpose
Design and execute document verification workflows using spec drift detector controls with validated outcomes.
