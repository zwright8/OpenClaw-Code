---
name: reference-programs-threshold-alerting
description: Use when tasks require reference programs threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Threshold Alerting

## Purpose
Design and execute reference programs workflows using threshold alerting controls with validated outcomes.
