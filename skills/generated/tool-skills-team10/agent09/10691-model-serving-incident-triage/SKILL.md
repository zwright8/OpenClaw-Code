---
name: model-serving-incident-triage
description: Use when tasks require model serving incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Incident Triage

## Purpose
Design and execute model serving workflows using incident triage controls with validated outcomes.
