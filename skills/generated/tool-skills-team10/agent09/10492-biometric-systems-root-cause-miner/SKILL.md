---
name: biometric-systems-root-cause-miner
description: Use when tasks require biometric systems root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Root Cause Miner

## Purpose
Design and execute biometric systems workflows using root cause miner controls with validated outcomes.
