---
name: taxonomy-services-workflow-compiler
description: Use when tasks require taxonomy services workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Workflow Compiler

## Purpose
Design and execute taxonomy services workflows using workflow compiler controls with validated outcomes.
