---
name: semantic-retrieval-operation-planner
description: Use when tasks require semantic retrieval operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Operation Planner

## Purpose
Design and execute semantic retrieval workflows using operation planner controls with validated outcomes.
