---
name: taxonomy-services-risk-scorer
description: Use when tasks require taxonomy services risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Risk Scorer

## Purpose
Design and execute taxonomy services workflows using risk scorer controls with validated outcomes.
