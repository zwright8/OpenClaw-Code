---
name: catalog-syndication-remediation-planner
description: Use when tasks require catalog syndication remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Remediation Planner

## Purpose
Design and execute catalog syndication workflows using remediation planner controls with validated outcomes.
