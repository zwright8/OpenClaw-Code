---
name: knowledge-graphs-provenance-tracker
description: Use when tasks require knowledge graphs provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Provenance Tracker

## Purpose
Design and execute knowledge graphs workflows using provenance tracker controls with validated outcomes.
