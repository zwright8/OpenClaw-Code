---
name: work-order-systems-human-handoff-router
description: Use when tasks require work order systems human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Human Handoff Router

## Purpose
Design and execute work order systems workflows using human handoff router controls with validated outcomes.
