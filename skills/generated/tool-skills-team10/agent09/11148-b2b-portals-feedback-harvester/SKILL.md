---
name: b2b-portals-feedback-harvester
description: Use when tasks require b2b portals feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Feedback Harvester

## Purpose
Design and execute b2b portals workflows using feedback harvester controls with validated outcomes.
