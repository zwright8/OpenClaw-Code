---
name: b2b-portals-postmortem-drafting
description: Use when tasks require b2b portals postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Postmortem Drafting

## Purpose
Design and execute b2b portals workflows using postmortem drafting controls with validated outcomes.
