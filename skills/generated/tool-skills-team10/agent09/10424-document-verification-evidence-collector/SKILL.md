---
name: document-verification-evidence-collector
description: Use when tasks require document verification evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Evidence Collector

## Purpose
Design and execute document verification workflows using evidence collector controls with validated outcomes.
