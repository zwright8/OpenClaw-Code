---
name: evaluation-harnesses-queue-balancer
description: Use when tasks require evaluation harnesses queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Queue Balancer

## Purpose
Design and execute evaluation harnesses workflows using queue balancer controls with validated outcomes.
