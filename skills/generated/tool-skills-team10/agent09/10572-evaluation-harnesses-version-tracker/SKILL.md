---
name: evaluation-harnesses-version-tracker
description: Use when tasks require evaluation harnesses version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Version Tracker

## Purpose
Design and execute evaluation harnesses workflows using version tracker controls with validated outcomes.
