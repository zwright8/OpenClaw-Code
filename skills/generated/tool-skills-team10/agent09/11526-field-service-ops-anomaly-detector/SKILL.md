---
name: field-service-ops-anomaly-detector
description: Use when tasks require field service ops anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Anomaly Detector

## Purpose
Design and execute field service ops workflows using anomaly detector controls with validated outcomes.
