---
name: safety-guardrails-feedback-harvester
description: Use when tasks require safety guardrails feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Feedback Harvester

## Purpose
Design and execute safety guardrails workflows using feedback harvester controls with validated outcomes.
