---
name: qbr-automation-access-auditor
description: Use when tasks require qbr automation access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Access Auditor

## Purpose
Design and execute qbr automation workflows using access auditor controls with validated outcomes.
