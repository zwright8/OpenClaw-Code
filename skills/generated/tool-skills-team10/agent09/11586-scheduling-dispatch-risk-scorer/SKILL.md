---
name: scheduling-dispatch-risk-scorer
description: Use when tasks require scheduling dispatch risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Risk Scorer

## Purpose
Design and execute scheduling dispatch workflows using risk scorer controls with validated outcomes.
