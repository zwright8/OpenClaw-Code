---
name: reference-programs-artifact-publisher
description: Use when tasks require reference programs artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Artifact Publisher

## Purpose
Design and execute reference programs workflows using artifact publisher controls with validated outcomes.
