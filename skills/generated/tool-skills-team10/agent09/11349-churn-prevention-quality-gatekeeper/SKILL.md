---
name: churn-prevention-quality-gatekeeper
description: Use when tasks require churn prevention quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Quality Gatekeeper

## Purpose
Design and execute churn prevention workflows using quality gatekeeper controls with validated outcomes.
