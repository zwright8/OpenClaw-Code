---
name: customer-success-plans-task-decomposer
description: Use when tasks require customer success plans task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Task Decomposer

## Purpose
Design and execute customer success plans workflows using task decomposer controls with validated outcomes.
