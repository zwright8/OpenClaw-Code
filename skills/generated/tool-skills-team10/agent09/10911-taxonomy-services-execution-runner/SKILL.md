---
name: taxonomy-services-execution-runner
description: Use when tasks require taxonomy services execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Execution Runner

## Purpose
Design and execute taxonomy services workflows using execution runner controls with validated outcomes.
