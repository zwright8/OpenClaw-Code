---
name: catalog-syndication-root-cause-miner
description: Use when tasks require catalog syndication root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Root Cause Miner

## Purpose
Design and execute catalog syndication workflows using root cause miner controls with validated outcomes.
