---
name: biometric-systems-retry-governor
description: Use when tasks require biometric systems retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Retry Governor

## Purpose
Design and execute biometric systems workflows using retry governor controls with validated outcomes.
