---
name: evaluation-harnesses-secret-scanner
description: Use when tasks require evaluation harnesses secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Secret Scanner

## Purpose
Design and execute evaluation harnesses workflows using secret scanner controls with validated outcomes.
