---
name: field-service-ops-spec-drift-detector
description: Use when tasks require field service ops spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Spec Drift Detector

## Purpose
Design and execute field service ops workflows using spec drift detector controls with validated outcomes.
