---
name: spare-parts-planning-secret-scanner
description: Use when tasks require spare parts planning secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Spare Parts Planning Secret Scanner

## Purpose
Design and execute spare parts planning workflows using secret scanner controls with validated outcomes.
