---
name: scheduling-dispatch-execution-runner
description: Use when tasks require scheduling dispatch execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Execution Runner

## Purpose
Design and execute scheduling dispatch workflows using execution runner controls with validated outcomes.
