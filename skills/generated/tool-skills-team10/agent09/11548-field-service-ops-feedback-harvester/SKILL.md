---
name: field-service-ops-feedback-harvester
description: Use when tasks require field service ops feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Feedback Harvester

## Purpose
Design and execute field service ops workflows using feedback harvester controls with validated outcomes.
