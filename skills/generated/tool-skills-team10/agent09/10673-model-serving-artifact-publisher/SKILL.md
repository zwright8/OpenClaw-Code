---
name: model-serving-artifact-publisher
description: Use when tasks require model serving artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Artifact Publisher

## Purpose
Design and execute model serving workflows using artifact publisher controls with validated outcomes.
