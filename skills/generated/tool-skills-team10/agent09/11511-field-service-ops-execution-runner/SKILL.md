---
name: field-service-ops-execution-runner
description: Use when tasks require field service ops execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Execution Runner

## Purpose
Design and execute field service ops workflows using execution runner controls with validated outcomes.
