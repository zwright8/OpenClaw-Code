---
name: reference-programs-spec-drift-detector
description: Use when tasks require reference programs spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Spec Drift Detector

## Purpose
Design and execute reference programs workflows using spec drift detector controls with validated outcomes.
