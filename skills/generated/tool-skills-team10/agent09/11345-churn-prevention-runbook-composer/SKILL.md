---
name: churn-prevention-runbook-composer
description: Use when tasks require churn prevention runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Runbook Composer

## Purpose
Design and execute churn prevention workflows using runbook composer controls with validated outcomes.
