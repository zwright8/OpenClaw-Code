---
name: semantic-retrieval-task-decomposer
description: Use when tasks require semantic retrieval task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Task Decomposer

## Purpose
Design and execute semantic retrieval workflows using task decomposer controls with validated outcomes.
