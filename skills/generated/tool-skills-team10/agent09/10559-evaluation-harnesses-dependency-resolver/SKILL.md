---
name: evaluation-harnesses-dependency-resolver
description: Use when tasks require evaluation harnesses dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Dependency Resolver

## Purpose
Design and execute evaluation harnesses workflows using dependency resolver controls with validated outcomes.
