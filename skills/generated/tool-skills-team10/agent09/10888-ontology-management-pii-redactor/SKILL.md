---
name: ontology-management-pii-redactor
description: Use when tasks require ontology management pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management PII Redactor

## Purpose
Design and execute ontology management workflows using pii redactor controls with validated outcomes.
