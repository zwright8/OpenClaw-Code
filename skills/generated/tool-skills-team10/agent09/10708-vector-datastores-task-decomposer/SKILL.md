---
name: vector-datastores-task-decomposer
description: Use when tasks require vector datastores task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Task Decomposer

## Purpose
Design and execute vector datastores workflows using task decomposer controls with validated outcomes.
