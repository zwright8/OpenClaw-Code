---
name: biometric-systems-rollback-coordinator
description: Use when tasks require biometric systems rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Rollback Coordinator

## Purpose
Design and execute biometric systems workflows using rollback coordinator controls with validated outcomes.
