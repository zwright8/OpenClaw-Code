---
name: taxonomy-services-feedback-harvester
description: Use when tasks require taxonomy services feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Feedback Harvester

## Purpose
Design and execute taxonomy services workflows using feedback harvester controls with validated outcomes.
