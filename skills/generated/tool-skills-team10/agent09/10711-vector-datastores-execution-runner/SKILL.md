---
name: vector-datastores-execution-runner
description: Use when tasks require vector datastores execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Execution Runner

## Purpose
Design and execute vector datastores workflows using execution runner controls with validated outcomes.
