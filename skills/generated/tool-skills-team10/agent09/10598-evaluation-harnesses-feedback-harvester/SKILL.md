---
name: evaluation-harnesses-feedback-harvester
description: Use when tasks require evaluation harnesses feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Feedback Harvester

## Purpose
Design and execute evaluation harnesses workflows using feedback harvester controls with validated outcomes.
