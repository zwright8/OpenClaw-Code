---
name: reference-programs-schema-introspector
description: Use when tasks require reference programs schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Schema Introspector

## Purpose
Design and execute reference programs workflows using schema introspector controls with validated outcomes.
