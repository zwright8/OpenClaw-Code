---
name: catalog-syndication-incident-triage
description: Use when tasks require catalog syndication incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Incident Triage

## Purpose
Design and execute catalog syndication workflows using incident triage controls with validated outcomes.
