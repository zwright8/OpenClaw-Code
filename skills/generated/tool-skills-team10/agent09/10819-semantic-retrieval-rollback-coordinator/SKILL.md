---
name: semantic-retrieval-rollback-coordinator
description: Use when tasks require semantic retrieval rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Rollback Coordinator

## Purpose
Design and execute semantic retrieval workflows using rollback coordinator controls with validated outcomes.
