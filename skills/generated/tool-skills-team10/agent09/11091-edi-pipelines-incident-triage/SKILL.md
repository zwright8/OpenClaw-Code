---
name: edi-pipelines-incident-triage
description: Use when tasks require edi pipelines incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Incident Triage

## Purpose
Design and execute edi pipelines workflows using incident triage controls with validated outcomes.
