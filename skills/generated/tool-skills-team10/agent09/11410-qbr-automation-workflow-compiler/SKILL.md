---
name: qbr-automation-workflow-compiler
description: Use when tasks require qbr automation workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Workflow Compiler

## Purpose
Design and execute qbr automation workflows using workflow compiler controls with validated outcomes.
