---
name: scheduling-dispatch-runbook-composer
description: Use when tasks require scheduling dispatch runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Runbook Composer

## Purpose
Design and execute scheduling dispatch workflows using runbook composer controls with validated outcomes.
