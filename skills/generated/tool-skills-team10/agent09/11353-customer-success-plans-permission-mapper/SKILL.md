---
name: customer-success-plans-permission-mapper
description: Use when tasks require customer success plans permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Permission Mapper

## Purpose
Design and execute customer success plans workflows using permission mapper controls with validated outcomes.
