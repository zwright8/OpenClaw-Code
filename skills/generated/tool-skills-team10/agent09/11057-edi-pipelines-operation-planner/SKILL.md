---
name: edi-pipelines-operation-planner
description: Use when tasks require edi pipelines operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Operation Planner

## Purpose
Design and execute edi pipelines workflows using operation planner controls with validated outcomes.
