---
name: mlops-pipelines-approval-orchestrator
description: Use when tasks require mlops pipelines approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# MLOps Pipelines Approval Orchestrator

## Purpose
Design and execute mlops pipelines workflows using approval orchestrator controls with validated outcomes.
