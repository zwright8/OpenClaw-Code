---
name: channel-operations-forecast-engine
description: Use when tasks require channel operations forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Forecast Engine

## Purpose
Design and execute channel operations workflows using forecast engine controls with validated outcomes.
