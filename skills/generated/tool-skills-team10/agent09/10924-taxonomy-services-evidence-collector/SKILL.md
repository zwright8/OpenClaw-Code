---
name: taxonomy-services-evidence-collector
description: Use when tasks require taxonomy services evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Evidence Collector

## Purpose
Design and execute taxonomy services workflows using evidence collector controls with validated outcomes.
