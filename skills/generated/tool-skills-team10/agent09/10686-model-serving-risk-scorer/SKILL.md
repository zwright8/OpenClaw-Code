---
name: model-serving-risk-scorer
description: Use when tasks require model serving risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Risk Scorer

## Purpose
Design and execute model serving workflows using risk scorer controls with validated outcomes.
