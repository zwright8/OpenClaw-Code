---
name: knowledge-graphs-capacity-planner
description: Use when tasks require knowledge graphs capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Capacity Planner

## Purpose
Design and execute knowledge graphs workflows using capacity planner controls with validated outcomes.
