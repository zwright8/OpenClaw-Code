---
name: customer-success-plans-feedback-harvester
description: Use when tasks require customer success plans feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Feedback Harvester

## Purpose
Design and execute customer success plans workflows using feedback harvester controls with validated outcomes.
