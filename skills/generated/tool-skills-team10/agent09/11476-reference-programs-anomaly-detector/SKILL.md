---
name: reference-programs-anomaly-detector
description: Use when tasks require reference programs anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Anomaly Detector

## Purpose
Design and execute reference programs workflows using anomaly detector controls with validated outcomes.
