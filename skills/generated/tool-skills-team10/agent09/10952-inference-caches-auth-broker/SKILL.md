---
name: inference-caches-auth-broker
description: Use when tasks require inference caches auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inference Caches Auth Broker

## Purpose
Design and execute inference caches workflows using auth broker controls with validated outcomes.
