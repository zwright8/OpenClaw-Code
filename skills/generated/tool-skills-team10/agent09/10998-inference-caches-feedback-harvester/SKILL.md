---
name: inference-caches-feedback-harvester
description: Use when tasks require inference caches feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inference Caches Feedback Harvester

## Purpose
Design and execute inference caches workflows using feedback harvester controls with validated outcomes.
