---
name: qbr-automation-provenance-tracker
description: Use when tasks require qbr automation provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Provenance Tracker

## Purpose
Design and execute qbr automation workflows using provenance tracker controls with validated outcomes.
