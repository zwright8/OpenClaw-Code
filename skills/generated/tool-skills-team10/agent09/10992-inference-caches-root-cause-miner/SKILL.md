---
name: inference-caches-root-cause-miner
description: Use when tasks require inference caches root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inference Caches Root Cause Miner

## Purpose
Design and execute inference caches workflows using root cause miner controls with validated outcomes.
