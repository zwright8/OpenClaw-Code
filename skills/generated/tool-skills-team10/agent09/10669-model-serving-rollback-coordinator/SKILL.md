---
name: model-serving-rollback-coordinator
description: Use when tasks require model serving rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Rollback Coordinator

## Purpose
Design and execute model serving workflows using rollback coordinator controls with validated outcomes.
