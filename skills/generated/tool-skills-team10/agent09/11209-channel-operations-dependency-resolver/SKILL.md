---
name: channel-operations-dependency-resolver
description: Use when tasks require channel operations dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Dependency Resolver

## Purpose
Design and execute channel operations workflows using dependency resolver controls with validated outcomes.
