---
name: reference-programs-budget-guardrail
description: Use when tasks require reference programs budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Budget Guardrail

## Purpose
Design and execute reference programs workflows using budget guardrail controls with validated outcomes.
