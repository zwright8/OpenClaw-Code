---
name: reference-programs-auth-broker
description: Use when tasks require reference programs auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Auth Broker

## Purpose
Design and execute reference programs workflows using auth broker controls with validated outcomes.
