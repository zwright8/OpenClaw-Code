---
name: churn-prevention-evidence-collector
description: Use when tasks require churn prevention evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Evidence Collector

## Purpose
Design and execute churn prevention workflows using evidence collector controls with validated outcomes.
