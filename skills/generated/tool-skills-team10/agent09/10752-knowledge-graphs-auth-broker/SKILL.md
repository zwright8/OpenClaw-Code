---
name: knowledge-graphs-auth-broker
description: Use when tasks require knowledge graphs auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Auth Broker

## Purpose
Design and execute knowledge graphs workflows using auth broker controls with validated outcomes.
