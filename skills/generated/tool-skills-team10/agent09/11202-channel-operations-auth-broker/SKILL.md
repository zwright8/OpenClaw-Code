---
name: channel-operations-auth-broker
description: Use when tasks require channel operations auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Auth Broker

## Purpose
Design and execute channel operations workflows using auth broker controls with validated outcomes.
