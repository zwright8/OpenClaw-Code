---
name: safety-guardrails-rollback-coordinator
description: Use when tasks require safety guardrails rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Rollback Coordinator

## Purpose
Design and execute safety guardrails workflows using rollback coordinator controls with validated outcomes.
