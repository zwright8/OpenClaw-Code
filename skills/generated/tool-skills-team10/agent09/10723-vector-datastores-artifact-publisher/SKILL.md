---
name: vector-datastores-artifact-publisher
description: Use when tasks require vector datastores artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Artifact Publisher

## Purpose
Design and execute vector datastores workflows using artifact publisher controls with validated outcomes.
