---
name: work-order-systems-quality-gatekeeper
description: Use when tasks require work order systems quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Quality Gatekeeper

## Purpose
Design and execute work order systems workflows using quality gatekeeper controls with validated outcomes.
