---
name: qbr-automation-policy-evaluator
description: Use when tasks require qbr automation policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Policy Evaluator

## Purpose
Design and execute qbr automation workflows using policy evaluator controls with validated outcomes.
