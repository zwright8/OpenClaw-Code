---
name: safety-guardrails-evidence-collector
description: Use when tasks require safety guardrails evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Evidence Collector

## Purpose
Design and execute safety guardrails workflows using evidence collector controls with validated outcomes.
