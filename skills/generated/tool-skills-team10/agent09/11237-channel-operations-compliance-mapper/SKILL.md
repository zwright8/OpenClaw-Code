---
name: channel-operations-compliance-mapper
description: Use when tasks require channel operations compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Compliance Mapper

## Purpose
Design and execute channel operations workflows using compliance mapper controls with validated outcomes.
