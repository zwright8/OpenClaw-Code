---
name: work-order-systems-root-cause-miner
description: Use when tasks require work order systems root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Root Cause Miner

## Purpose
Design and execute work order systems workflows using root cause miner controls with validated outcomes.
