---
name: partner-integrations-compliance-mapper
description: Use when tasks require partner integrations compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Compliance Mapper

## Purpose
Design and execute partner integrations workflows using compliance mapper controls with validated outcomes.
