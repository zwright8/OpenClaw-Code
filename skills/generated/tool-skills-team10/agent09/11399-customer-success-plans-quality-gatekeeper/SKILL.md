---
name: customer-success-plans-quality-gatekeeper
description: Use when tasks require customer success plans quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Quality Gatekeeper

## Purpose
Design and execute customer success plans workflows using quality gatekeeper controls with validated outcomes.
