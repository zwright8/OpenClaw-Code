---
name: safety-guardrails-risk-scorer
description: Use when tasks require safety guardrails risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Risk Scorer

## Purpose
Design and execute safety guardrails workflows using risk scorer controls with validated outcomes.
