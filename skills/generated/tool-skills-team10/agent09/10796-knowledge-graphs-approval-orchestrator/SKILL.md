---
name: knowledge-graphs-approval-orchestrator
description: Use when tasks require knowledge graphs approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Approval Orchestrator

## Purpose
Design and execute knowledge graphs workflows using approval orchestrator controls with validated outcomes.
