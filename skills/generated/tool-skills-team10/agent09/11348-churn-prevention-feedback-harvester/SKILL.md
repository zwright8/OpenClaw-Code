---
name: churn-prevention-feedback-harvester
description: Use when tasks require churn prevention feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Feedback Harvester

## Purpose
Design and execute churn prevention workflows using feedback harvester controls with validated outcomes.
