---
name: qbr-automation-migration-planner
description: Use when tasks require qbr automation migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Migration Planner

## Purpose
Design and execute qbr automation workflows using migration planner controls with validated outcomes.
