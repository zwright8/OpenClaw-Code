---
name: vector-datastores-risk-scorer
description: Use when tasks require vector datastores risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Risk Scorer

## Purpose
Design and execute vector datastores workflows using risk scorer controls with validated outcomes.
