---
name: evaluation-harnesses-conflict-resolver
description: Use when tasks require evaluation harnesses conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Conflict Resolver

## Purpose
Design and execute evaluation harnesses workflows using conflict resolver controls with validated outcomes.
