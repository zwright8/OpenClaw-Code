---
name: field-service-ops-dependency-resolver
description: Use when tasks require field service ops dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Dependency Resolver

## Purpose
Design and execute field service ops workflows using dependency resolver controls with validated outcomes.
