---
name: qbr-automation-queue-balancer
description: Use when tasks require qbr automation queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Queue Balancer

## Purpose
Design and execute qbr automation workflows using queue balancer controls with validated outcomes.
