---
name: churn-prevention-compliance-mapper
description: Use when tasks require churn prevention compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Compliance Mapper

## Purpose
Design and execute churn prevention workflows using compliance mapper controls with validated outcomes.
