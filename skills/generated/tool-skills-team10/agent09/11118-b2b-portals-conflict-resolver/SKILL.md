---
name: b2b-portals-conflict-resolver
description: Use when tasks require b2b portals conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Conflict Resolver

## Purpose
Design and execute b2b portals workflows using conflict resolver controls with validated outcomes.
