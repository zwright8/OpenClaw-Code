---
name: vector-datastores-spec-drift-detector
description: Use when tasks require vector datastores spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Spec Drift Detector

## Purpose
Design and execute vector datastores workflows using spec drift detector controls with validated outcomes.
