---
name: scheduling-dispatch-retry-governor
description: Use when tasks require scheduling dispatch retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Retry Governor

## Purpose
Design and execute scheduling dispatch workflows using retry governor controls with validated outcomes.
