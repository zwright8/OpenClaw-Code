---
name: partner-integrations-risk-scorer
description: Use when tasks require partner integrations risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Risk Scorer

## Purpose
Design and execute partner integrations workflows using risk scorer controls with validated outcomes.
