---
name: qbr-automation-task-decomposer
description: Use when tasks require qbr automation task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Task Decomposer

## Purpose
Design and execute qbr automation workflows using task decomposer controls with validated outcomes.
