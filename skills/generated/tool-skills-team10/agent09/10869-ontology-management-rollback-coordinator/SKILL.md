---
name: ontology-management-rollback-coordinator
description: Use when tasks require ontology management rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Rollback Coordinator

## Purpose
Design and execute ontology management workflows using rollback coordinator controls with validated outcomes.
