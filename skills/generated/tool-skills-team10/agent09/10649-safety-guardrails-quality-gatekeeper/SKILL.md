---
name: safety-guardrails-quality-gatekeeper
description: Use when tasks require safety guardrails quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Quality Gatekeeper

## Purpose
Design and execute safety guardrails workflows using quality gatekeeper controls with validated outcomes.
