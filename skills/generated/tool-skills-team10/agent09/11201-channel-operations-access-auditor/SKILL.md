---
name: channel-operations-access-auditor
description: Use when tasks require channel operations access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Access Auditor

## Purpose
Design and execute channel operations workflows using access auditor controls with validated outcomes.
