---
name: vector-datastores-rollback-coordinator
description: Use when tasks require vector datastores rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Rollback Coordinator

## Purpose
Design and execute vector datastores workflows using rollback coordinator controls with validated outcomes.
