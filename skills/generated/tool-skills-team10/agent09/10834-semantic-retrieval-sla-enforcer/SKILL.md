---
name: semantic-retrieval-sla-enforcer
description: Use when tasks require semantic retrieval sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval SLA Enforcer

## Purpose
Design and execute semantic retrieval workflows using sla enforcer controls with validated outcomes.
