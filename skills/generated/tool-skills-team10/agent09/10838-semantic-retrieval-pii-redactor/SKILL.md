---
name: semantic-retrieval-pii-redactor
description: Use when tasks require semantic retrieval pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval PII Redactor

## Purpose
Design and execute semantic retrieval workflows using pii redactor controls with validated outcomes.
