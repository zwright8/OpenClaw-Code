---
name: channel-operations-risk-scorer
description: Use when tasks require channel operations risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Risk Scorer

## Purpose
Design and execute channel operations workflows using risk scorer controls with validated outcomes.
