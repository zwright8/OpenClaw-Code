---
name: semantic-retrieval-retry-governor
description: Use when tasks require semantic retrieval retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Retry Governor

## Purpose
Design and execute semantic retrieval workflows using retry governor controls with validated outcomes.
