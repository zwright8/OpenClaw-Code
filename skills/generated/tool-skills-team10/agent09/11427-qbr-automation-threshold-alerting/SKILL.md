---
name: qbr-automation-threshold-alerting
description: Use when tasks require qbr automation threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Threshold Alerting

## Purpose
Design and execute qbr automation workflows using threshold alerting controls with validated outcomes.
