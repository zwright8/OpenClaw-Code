---
name: safety-guardrails-artifact-publisher
description: Use when tasks require safety guardrails artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Artifact Publisher

## Purpose
Design and execute safety guardrails workflows using artifact publisher controls with validated outcomes.
