---
name: catalog-syndication-dependency-resolver
description: Use when tasks require catalog syndication dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Dependency Resolver

## Purpose
Design and execute catalog syndication workflows using dependency resolver controls with validated outcomes.
