---
name: taxonomy-services-root-cause-miner
description: Use when tasks require taxonomy services root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Root Cause Miner

## Purpose
Design and execute taxonomy services workflows using root cause miner controls with validated outcomes.
