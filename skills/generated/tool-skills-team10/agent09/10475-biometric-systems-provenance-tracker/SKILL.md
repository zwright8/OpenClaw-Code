---
name: biometric-systems-provenance-tracker
description: Use when tasks require biometric systems provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Provenance Tracker

## Purpose
Design and execute biometric systems workflows using provenance tracker controls with validated outcomes.
