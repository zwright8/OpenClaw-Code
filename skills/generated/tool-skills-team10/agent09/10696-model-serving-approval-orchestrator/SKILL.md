---
name: model-serving-approval-orchestrator
description: Use when tasks require model serving approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Approval Orchestrator

## Purpose
Design and execute model serving workflows using approval orchestrator controls with validated outcomes.
