---
name: edi-pipelines-state-reconciler
description: Use when tasks require edi pipelines state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines State Reconciler

## Purpose
Design and execute edi pipelines workflows using state reconciler controls with validated outcomes.
