---
name: taxonomy-services-auth-broker
description: Use when tasks require taxonomy services auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Auth Broker

## Purpose
Design and execute taxonomy services workflows using auth broker controls with validated outcomes.
