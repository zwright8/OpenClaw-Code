---
name: customer-success-plans-auth-broker
description: Use when tasks require customer success plans auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Auth Broker

## Purpose
Design and execute customer success plans workflows using auth broker controls with validated outcomes.
