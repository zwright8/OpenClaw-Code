---
name: churn-prevention-artifact-publisher
description: Use when tasks require churn prevention artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Artifact Publisher

## Purpose
Design and execute churn prevention workflows using artifact publisher controls with validated outcomes.
