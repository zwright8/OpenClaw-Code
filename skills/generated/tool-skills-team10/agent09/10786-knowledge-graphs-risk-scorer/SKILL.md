---
name: knowledge-graphs-risk-scorer
description: Use when tasks require knowledge graphs risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Risk Scorer

## Purpose
Design and execute knowledge graphs workflows using risk scorer controls with validated outcomes.
