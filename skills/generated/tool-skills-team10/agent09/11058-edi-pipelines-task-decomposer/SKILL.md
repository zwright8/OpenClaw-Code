---
name: edi-pipelines-task-decomposer
description: Use when tasks require edi pipelines task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Task Decomposer

## Purpose
Design and execute edi pipelines workflows using task decomposer controls with validated outcomes.
