---
name: renewal-management-anomaly-detector
description: Use when tasks require renewal management anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Renewal Management Anomaly Detector

## Purpose
Design and execute renewal management workflows using anomaly detector controls with validated outcomes.
