---
name: channel-operations-quality-gatekeeper
description: Use when tasks require channel operations quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Quality Gatekeeper

## Purpose
Design and execute channel operations workflows using quality gatekeeper controls with validated outcomes.
