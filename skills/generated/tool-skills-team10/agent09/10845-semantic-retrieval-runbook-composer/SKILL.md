---
name: semantic-retrieval-runbook-composer
description: Use when tasks require semantic retrieval runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Runbook Composer

## Purpose
Design and execute semantic retrieval workflows using runbook composer controls with validated outcomes.
