---
name: reference-programs-delta-calculator
description: Use when tasks require reference programs delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Delta Calculator

## Purpose
Design and execute reference programs workflows using delta calculator controls with validated outcomes.
