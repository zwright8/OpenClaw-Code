---
name: qbr-automation-state-reconciler
description: Use when tasks require qbr automation state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation State Reconciler

## Purpose
Design and execute qbr automation workflows using state reconciler controls with validated outcomes.
