---
name: safety-guardrails-conflict-resolver
description: Use when tasks require safety guardrails conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Conflict Resolver

## Purpose
Design and execute safety guardrails workflows using conflict resolver controls with validated outcomes.
