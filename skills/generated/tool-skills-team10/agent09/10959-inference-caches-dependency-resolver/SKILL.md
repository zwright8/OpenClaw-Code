---
name: inference-caches-dependency-resolver
description: Use when tasks require inference caches dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inference Caches Dependency Resolver

## Purpose
Design and execute inference caches workflows using dependency resolver controls with validated outcomes.
