---
name: scheduling-dispatch-evidence-collector
description: Use when tasks require scheduling dispatch evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Evidence Collector

## Purpose
Design and execute scheduling dispatch workflows using evidence collector controls with validated outcomes.
