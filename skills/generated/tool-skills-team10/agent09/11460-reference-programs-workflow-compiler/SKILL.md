---
name: reference-programs-workflow-compiler
description: Use when tasks require reference programs workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Workflow Compiler

## Purpose
Design and execute reference programs workflows using workflow compiler controls with validated outcomes.
