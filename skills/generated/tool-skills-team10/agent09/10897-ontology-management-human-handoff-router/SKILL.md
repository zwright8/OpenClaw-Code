---
name: ontology-management-human-handoff-router
description: Use when tasks require ontology management human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Human Handoff Router

## Purpose
Design and execute ontology management workflows using human handoff router controls with validated outcomes.
