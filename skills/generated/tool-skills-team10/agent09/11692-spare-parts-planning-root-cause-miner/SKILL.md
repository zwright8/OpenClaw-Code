---
name: spare-parts-planning-root-cause-miner
description: Use when tasks require spare parts planning root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Spare Parts Planning Root Cause Miner

## Purpose
Design and execute spare parts planning workflows using root cause miner controls with validated outcomes.
