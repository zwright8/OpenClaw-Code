---
name: edi-pipelines-policy-evaluator
description: Use when tasks require edi pipelines policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Policy Evaluator

## Purpose
Design and execute edi pipelines workflows using policy evaluator controls with validated outcomes.
