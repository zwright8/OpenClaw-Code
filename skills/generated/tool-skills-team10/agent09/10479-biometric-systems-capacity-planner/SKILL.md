---
name: biometric-systems-capacity-planner
description: Use when tasks require biometric systems capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Capacity Planner

## Purpose
Design and execute biometric systems workflows using capacity planner controls with validated outcomes.
