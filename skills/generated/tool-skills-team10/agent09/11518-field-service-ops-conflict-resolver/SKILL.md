---
name: field-service-ops-conflict-resolver
description: Use when tasks require field service ops conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Conflict Resolver

## Purpose
Design and execute field service ops workflows using conflict resolver controls with validated outcomes.
