---
name: evaluation-harnesses-workflow-compiler
description: Use when tasks require evaluation harnesses workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Workflow Compiler

## Purpose
Design and execute evaluation harnesses workflows using workflow compiler controls with validated outcomes.
