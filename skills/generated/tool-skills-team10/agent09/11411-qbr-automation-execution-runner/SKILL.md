---
name: qbr-automation-execution-runner
description: Use when tasks require qbr automation execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Execution Runner

## Purpose
Design and execute qbr automation workflows using execution runner controls with validated outcomes.
