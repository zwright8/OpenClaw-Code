---
name: qbr-automation-operation-planner
description: Use when tasks require qbr automation operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Operation Planner

## Purpose
Design and execute qbr automation workflows using operation planner controls with validated outcomes.
