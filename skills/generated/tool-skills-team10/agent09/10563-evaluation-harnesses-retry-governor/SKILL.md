---
name: evaluation-harnesses-retry-governor
description: Use when tasks require evaluation harnesses retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Retry Governor

## Purpose
Design and execute evaluation harnesses workflows using retry governor controls with validated outcomes.
