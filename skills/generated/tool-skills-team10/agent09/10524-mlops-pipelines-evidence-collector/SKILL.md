---
name: mlops-pipelines-evidence-collector
description: Use when tasks require mlops pipelines evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# MLOps Pipelines Evidence Collector

## Purpose
Design and execute mlops pipelines workflows using evidence collector controls with validated outcomes.
