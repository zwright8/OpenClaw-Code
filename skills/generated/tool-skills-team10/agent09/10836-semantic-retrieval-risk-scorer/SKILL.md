---
name: semantic-retrieval-risk-scorer
description: Use when tasks require semantic retrieval risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Risk Scorer

## Purpose
Design and execute semantic retrieval workflows using risk scorer controls with validated outcomes.
