---
name: taxonomy-services-provenance-tracker
description: Use when tasks require taxonomy services provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Provenance Tracker

## Purpose
Design and execute taxonomy services workflows using provenance tracker controls with validated outcomes.
