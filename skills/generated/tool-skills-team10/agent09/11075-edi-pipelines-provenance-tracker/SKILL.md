---
name: edi-pipelines-provenance-tracker
description: Use when tasks require edi pipelines provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Provenance Tracker

## Purpose
Design and execute edi pipelines workflows using provenance tracker controls with validated outcomes.
