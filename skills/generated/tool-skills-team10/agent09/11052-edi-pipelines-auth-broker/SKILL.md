---
name: edi-pipelines-auth-broker
description: Use when tasks require edi pipelines auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Auth Broker

## Purpose
Design and execute edi pipelines workflows using auth broker controls with validated outcomes.
