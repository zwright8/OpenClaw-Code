---
name: b2b-portals-operation-planner
description: Use when tasks require b2b portals operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Operation Planner

## Purpose
Design and execute b2b portals workflows using operation planner controls with validated outcomes.
