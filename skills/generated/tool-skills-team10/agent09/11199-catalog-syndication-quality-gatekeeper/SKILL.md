---
name: catalog-syndication-quality-gatekeeper
description: Use when tasks require catalog syndication quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Quality Gatekeeper

## Purpose
Design and execute catalog syndication workflows using quality gatekeeper controls with validated outcomes.
