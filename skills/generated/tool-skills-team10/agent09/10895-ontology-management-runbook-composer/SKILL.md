---
name: ontology-management-runbook-composer
description: Use when tasks require ontology management runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Runbook Composer

## Purpose
Design and execute ontology management workflows using runbook composer controls with validated outcomes.
