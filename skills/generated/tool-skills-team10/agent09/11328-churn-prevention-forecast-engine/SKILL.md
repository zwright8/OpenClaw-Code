---
name: churn-prevention-forecast-engine
description: Use when tasks require churn prevention forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Forecast Engine

## Purpose
Design and execute churn prevention workflows using forecast engine controls with validated outcomes.
