---
name: vector-datastores-forecast-engine
description: Use when tasks require vector datastores forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Forecast Engine

## Purpose
Design and execute vector datastores workflows using forecast engine controls with validated outcomes.
