---
name: partner-integrations-permission-mapper
description: Use when tasks require partner integrations permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Permission Mapper

## Purpose
Design and execute partner integrations workflows using permission mapper controls with validated outcomes.
