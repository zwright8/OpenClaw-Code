---
name: taxonomy-services-anomaly-detector
description: Use when tasks require taxonomy services anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Anomaly Detector

## Purpose
Design and execute taxonomy services workflows using anomaly detector controls with validated outcomes.
