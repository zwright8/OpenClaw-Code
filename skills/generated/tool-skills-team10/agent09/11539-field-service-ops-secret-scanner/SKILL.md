---
name: field-service-ops-secret-scanner
description: Use when tasks require field service ops secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Secret Scanner

## Purpose
Design and execute field service ops workflows using secret scanner controls with validated outcomes.
