---
name: qbr-automation-artifact-publisher
description: Use when tasks require qbr automation artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Artifact Publisher

## Purpose
Design and execute qbr automation workflows using artifact publisher controls with validated outcomes.
