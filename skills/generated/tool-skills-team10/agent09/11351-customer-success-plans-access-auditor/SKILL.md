---
name: customer-success-plans-access-auditor
description: Use when tasks require customer success plans access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Access Auditor

## Purpose
Design and execute customer success plans workflows using access auditor controls with validated outcomes.
