---
name: vector-datastores-quality-gatekeeper
description: Use when tasks require vector datastores quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Quality Gatekeeper

## Purpose
Design and execute vector datastores workflows using quality gatekeeper controls with validated outcomes.
