---
name: biometric-systems-execution-runner
description: Use when tasks require biometric systems execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Execution Runner

## Purpose
Design and execute biometric systems workflows using execution runner controls with validated outcomes.
