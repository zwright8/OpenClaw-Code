---
name: knowledge-graphs-retry-governor
description: Use when tasks require knowledge graphs retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Retry Governor

## Purpose
Design and execute knowledge graphs workflows using retry governor controls with validated outcomes.
