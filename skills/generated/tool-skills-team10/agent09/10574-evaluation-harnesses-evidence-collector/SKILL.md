---
name: evaluation-harnesses-evidence-collector
description: Use when tasks require evaluation harnesses evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Evidence Collector

## Purpose
Design and execute evaluation harnesses workflows using evidence collector controls with validated outcomes.
