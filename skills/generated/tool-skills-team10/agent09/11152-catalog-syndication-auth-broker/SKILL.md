---
name: catalog-syndication-auth-broker
description: Use when tasks require catalog syndication auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Auth Broker

## Purpose
Design and execute catalog syndication workflows using auth broker controls with validated outcomes.
