---
name: channel-operations-snapshot-manager
description: Use when tasks require channel operations snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Snapshot Manager

## Purpose
Design and execute channel operations workflows using snapshot manager controls with validated outcomes.
