---
name: churn-prevention-postmortem-drafting
description: Use when tasks require churn prevention postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Postmortem Drafting

## Purpose
Design and execute churn prevention workflows using postmortem drafting controls with validated outcomes.
