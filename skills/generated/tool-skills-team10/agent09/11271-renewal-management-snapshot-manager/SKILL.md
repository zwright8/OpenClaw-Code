---
name: renewal-management-snapshot-manager
description: Use when tasks require renewal management snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Renewal Management Snapshot Manager

## Purpose
Design and execute renewal management workflows using snapshot manager controls with validated outcomes.
