---
name: ontology-management-migration-planner
description: Use when tasks require ontology management migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Migration Planner

## Purpose
Design and execute ontology management workflows using migration planner controls with validated outcomes.
