---
name: safety-guardrails-operation-planner
description: Use when tasks require safety guardrails operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Operation Planner

## Purpose
Design and execute safety guardrails workflows using operation planner controls with validated outcomes.
