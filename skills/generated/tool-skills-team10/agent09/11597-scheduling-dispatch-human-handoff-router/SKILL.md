---
name: scheduling-dispatch-human-handoff-router
description: Use when tasks require scheduling dispatch human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Human Handoff Router

## Purpose
Design and execute scheduling dispatch workflows using human handoff router controls with validated outcomes.
