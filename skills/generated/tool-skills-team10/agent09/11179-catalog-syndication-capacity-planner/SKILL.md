---
name: catalog-syndication-capacity-planner
description: Use when tasks require catalog syndication capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Capacity Planner

## Purpose
Design and execute catalog syndication workflows using capacity planner controls with validated outcomes.
