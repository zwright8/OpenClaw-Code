---
name: b2b-portals-capacity-planner
description: Use when tasks require b2b portals capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Capacity Planner

## Purpose
Design and execute b2b portals workflows using capacity planner controls with validated outcomes.
