---
name: work-order-systems-risk-scorer
description: Use when tasks require work order systems risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Risk Scorer

## Purpose
Design and execute work order systems workflows using risk scorer controls with validated outcomes.
