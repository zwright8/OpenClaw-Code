---
name: safety-guardrails-runbook-composer
description: Use when tasks require safety guardrails runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Runbook Composer

## Purpose
Design and execute safety guardrails workflows using runbook composer controls with validated outcomes.
