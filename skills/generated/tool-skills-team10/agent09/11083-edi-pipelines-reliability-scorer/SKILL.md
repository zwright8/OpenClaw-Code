---
name: edi-pipelines-reliability-scorer
description: Use when tasks require edi pipelines reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Reliability Scorer

## Purpose
Design and execute edi pipelines workflows using reliability scorer controls with validated outcomes.
