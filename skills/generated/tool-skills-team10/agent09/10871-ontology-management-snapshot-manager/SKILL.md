---
name: ontology-management-snapshot-manager
description: Use when tasks require ontology management snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Snapshot Manager

## Purpose
Design and execute ontology management workflows using snapshot manager controls with validated outcomes.
