---
name: semantic-retrieval-remediation-planner
description: Use when tasks require semantic retrieval remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Remediation Planner

## Purpose
Design and execute semantic retrieval workflows using remediation planner controls with validated outcomes.
