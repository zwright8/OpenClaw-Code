---
name: channel-operations-execution-runner
description: Use when tasks require channel operations execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Execution Runner

## Purpose
Design and execute channel operations workflows using execution runner controls with validated outcomes.
