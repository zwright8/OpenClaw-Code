---
name: evaluation-harnesses-migration-planner
description: Use when tasks require evaluation harnesses migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Migration Planner

## Purpose
Design and execute evaluation harnesses workflows using migration planner controls with validated outcomes.
