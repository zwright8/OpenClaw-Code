---
name: semantic-retrieval-workflow-compiler
description: Use when tasks require semantic retrieval workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Workflow Compiler

## Purpose
Design and execute semantic retrieval workflows using workflow compiler controls with validated outcomes.
