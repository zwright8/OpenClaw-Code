---
name: biometric-systems-spec-drift-detector
description: Use when tasks require biometric systems spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Spec Drift Detector

## Purpose
Design and execute biometric systems workflows using spec drift detector controls with validated outcomes.
