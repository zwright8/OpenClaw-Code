---
name: partner-integrations-spec-drift-detector
description: Use when tasks require partner integrations spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Spec Drift Detector

## Purpose
Design and execute partner integrations workflows using spec drift detector controls with validated outcomes.
