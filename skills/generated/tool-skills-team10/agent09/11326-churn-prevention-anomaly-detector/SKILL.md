---
name: churn-prevention-anomaly-detector
description: Use when tasks require churn prevention anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Anomaly Detector

## Purpose
Design and execute churn prevention workflows using anomaly detector controls with validated outcomes.
