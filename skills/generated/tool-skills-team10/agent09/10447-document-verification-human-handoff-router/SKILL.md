---
name: document-verification-human-handoff-router
description: Use when tasks require document verification human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Human Handoff Router

## Purpose
Design and execute document verification workflows using human handoff router controls with validated outcomes.
