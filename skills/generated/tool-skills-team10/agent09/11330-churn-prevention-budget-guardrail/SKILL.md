---
name: churn-prevention-budget-guardrail
description: Use when tasks require churn prevention budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Budget Guardrail

## Purpose
Design and execute churn prevention workflows using budget guardrail controls with validated outcomes.
