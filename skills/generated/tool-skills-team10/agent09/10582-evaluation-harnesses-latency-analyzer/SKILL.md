---
name: evaluation-harnesses-latency-analyzer
description: Use when tasks require evaluation harnesses latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Latency Analyzer

## Purpose
Design and execute evaluation harnesses workflows using latency analyzer controls with validated outcomes.
