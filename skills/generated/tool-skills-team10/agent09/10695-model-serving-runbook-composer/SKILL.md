---
name: model-serving-runbook-composer
description: Use when tasks require model serving runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Runbook Composer

## Purpose
Design and execute model serving workflows using runbook composer controls with validated outcomes.
