...
description: Use when tasks require edi pipelines runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Runbook Composer

## Purpose
Design and execute edi pipelines workflows using runbook composer controls with validated outcomes.
