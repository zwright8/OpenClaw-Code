---
name: edi-pipelines-dependency-resolver
description: Use when tasks require edi pipelines dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Dependency Resolver

## Purpose
Design and execute edi pipelines workflows using dependency resolver controls with validated outcomes.
