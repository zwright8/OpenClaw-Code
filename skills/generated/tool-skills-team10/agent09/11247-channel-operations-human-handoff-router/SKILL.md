---
name: channel-operations-human-handoff-router
description: Use when tasks require channel operations human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Human Handoff Router

## Purpose
Design and execute channel operations workflows using human handoff router controls with validated outcomes.
