---
name: b2b-portals-compliance-mapper
description: Use when tasks require b2b portals compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Compliance Mapper

## Purpose
Design and execute b2b portals workflows using compliance mapper controls with validated outcomes.
