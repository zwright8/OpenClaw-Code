---
name: field-service-ops-rollback-coordinator
description: Use when tasks require field service ops rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Rollback Coordinator

## Purpose
Design and execute field service ops workflows using rollback coordinator controls with validated outcomes.
