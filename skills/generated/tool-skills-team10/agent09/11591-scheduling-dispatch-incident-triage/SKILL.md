---
name: scheduling-dispatch-incident-triage
description: Use when tasks require scheduling dispatch incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Incident Triage

## Purpose
Design and execute scheduling dispatch workflows using incident triage controls with validated outcomes.
