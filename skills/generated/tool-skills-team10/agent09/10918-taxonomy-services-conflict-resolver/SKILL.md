---
name: taxonomy-services-conflict-resolver
description: Use when tasks require taxonomy services conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Conflict Resolver

## Purpose
Design and execute taxonomy services workflows using conflict resolver controls with validated outcomes.
