---
name: customer-success-plans-anomaly-detector
description: Use when tasks require customer success plans anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Anomaly Detector

## Purpose
Design and execute customer success plans workflows using anomaly detector controls with validated outcomes.
