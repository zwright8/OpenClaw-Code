---
name: b2b-portals-workflow-compiler
description: Use when tasks require b2b portals workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Workflow Compiler

## Purpose
Design and execute b2b portals workflows using workflow compiler controls with validated outcomes.
