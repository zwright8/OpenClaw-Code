---
name: vector-datastores-postmortem-drafting
description: Use when tasks require vector datastores postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Postmortem Drafting

## Purpose
Design and execute vector datastores workflows using postmortem drafting controls with validated outcomes.
