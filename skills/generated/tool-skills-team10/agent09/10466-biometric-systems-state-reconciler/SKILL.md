---
name: biometric-systems-state-reconciler
description: Use when tasks require biometric systems state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems State Reconciler

## Purpose
Design and execute biometric systems workflows using state reconciler controls with validated outcomes.
