---
name: ontology-management-retry-governor
description: Use when tasks require ontology management retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Retry Governor

## Purpose
Design and execute ontology management workflows using retry governor controls with validated outcomes.
