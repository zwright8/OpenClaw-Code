---
name: mlops-pipelines-feedback-harvester
description: Use when tasks require mlops pipelines feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# MLOps Pipelines Feedback Harvester

## Purpose
Design and execute mlops pipelines workflows using feedback harvester controls with validated outcomes.
