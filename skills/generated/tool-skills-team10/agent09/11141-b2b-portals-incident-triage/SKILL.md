---
name: b2b-portals-incident-triage
description: Use when tasks require b2b portals incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Incident Triage

## Purpose
Design and execute b2b portals workflows using incident triage controls with validated outcomes.
