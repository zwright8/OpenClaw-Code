---
name: knowledge-graphs-evidence-collector
description: Use when tasks require knowledge graphs evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Evidence Collector

## Purpose
Design and execute knowledge graphs workflows using evidence collector controls with validated outcomes.
