---
name: field-service-ops-migration-planner
description: Use when tasks require field service ops migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Migration Planner

## Purpose
Design and execute field service ops workflows using migration planner controls with validated outcomes.
