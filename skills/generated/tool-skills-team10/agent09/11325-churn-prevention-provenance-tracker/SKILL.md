---
name: churn-prevention-provenance-tracker
description: Use when tasks require churn prevention provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Provenance Tracker

## Purpose
Design and execute churn prevention workflows using provenance tracker controls with validated outcomes.
