---
name: b2b-portals-rollback-coordinator
description: Use when tasks require b2b portals rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Rollback Coordinator

## Purpose
Design and execute b2b portals workflows using rollback coordinator controls with validated outcomes.
