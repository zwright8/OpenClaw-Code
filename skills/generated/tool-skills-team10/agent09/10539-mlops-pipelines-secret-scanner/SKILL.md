---
name: mlops-pipelines-secret-scanner
description: Use when tasks require mlops pipelines secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# MLOps Pipelines Secret Scanner

## Purpose
Design and execute mlops pipelines workflows using secret scanner controls with validated outcomes.
