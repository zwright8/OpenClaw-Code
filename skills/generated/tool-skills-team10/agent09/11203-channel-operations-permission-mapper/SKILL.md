---
name: channel-operations-permission-mapper
description: Use when tasks require channel operations permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Permission Mapper

## Purpose
Design and execute channel operations workflows using permission mapper controls with validated outcomes.
