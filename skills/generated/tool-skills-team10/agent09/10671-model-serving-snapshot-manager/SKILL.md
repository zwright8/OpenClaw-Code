---
name: model-serving-snapshot-manager
description: Use when tasks require model serving snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Snapshot Manager

## Purpose
Design and execute model serving workflows using snapshot manager controls with validated outcomes.
