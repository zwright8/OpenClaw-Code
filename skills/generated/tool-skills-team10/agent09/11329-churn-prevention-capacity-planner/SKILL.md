---
name: churn-prevention-capacity-planner
description: Use when tasks require churn prevention capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Capacity Planner

## Purpose
Design and execute churn prevention workflows using capacity planner controls with validated outcomes.
