---
name: catalog-syndication-evidence-collector
description: Use when tasks require catalog syndication evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Evidence Collector

## Purpose
Design and execute catalog syndication workflows using evidence collector controls with validated outcomes.
