---
name: biometric-systems-conflict-resolver
description: Use when tasks require biometric systems conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Conflict Resolver

## Purpose
Design and execute biometric systems workflows using conflict resolver controls with validated outcomes.
