---
name: scheduling-dispatch-artifact-publisher
description: Use when tasks require scheduling dispatch artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Artifact Publisher

## Purpose
Design and execute scheduling dispatch workflows using artifact publisher controls with validated outcomes.
