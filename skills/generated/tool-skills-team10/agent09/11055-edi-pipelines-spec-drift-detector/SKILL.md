---
name: edi-pipelines-spec-drift-detector
description: Use when tasks require edi pipelines spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Spec Drift Detector

## Purpose
Design and execute edi pipelines workflows using spec drift detector controls with validated outcomes.
