---
name: reference-programs-rollback-coordinator
description: Use when tasks require reference programs rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Rollback Coordinator

## Purpose
Design and execute reference programs workflows using rollback coordinator controls with validated outcomes.
