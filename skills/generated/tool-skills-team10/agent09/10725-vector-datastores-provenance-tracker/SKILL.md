---
name: vector-datastores-provenance-tracker
description: Use when tasks require vector datastores provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Provenance Tracker

## Purpose
Design and execute vector datastores workflows using provenance tracker controls with validated outcomes.
