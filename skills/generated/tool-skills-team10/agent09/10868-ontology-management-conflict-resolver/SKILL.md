---
name: ontology-management-conflict-resolver
description: Use when tasks require ontology management conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Conflict Resolver

## Purpose
Design and execute ontology management workflows using conflict resolver controls with validated outcomes.
