---
name: semantic-retrieval-dependency-resolver
description: Use when tasks require semantic retrieval dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Dependency Resolver

## Purpose
Design and execute semantic retrieval workflows using dependency resolver controls with validated outcomes.
