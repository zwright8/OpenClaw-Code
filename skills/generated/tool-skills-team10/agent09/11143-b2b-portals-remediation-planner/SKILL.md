---
name: b2b-portals-remediation-planner
description: Use when tasks require b2b portals remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Remediation Planner

## Purpose
Design and execute b2b portals workflows using remediation planner controls with validated outcomes.
