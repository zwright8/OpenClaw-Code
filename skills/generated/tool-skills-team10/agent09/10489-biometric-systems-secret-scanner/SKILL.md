---
name: biometric-systems-secret-scanner
description: Use when tasks require biometric systems secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Secret Scanner

## Purpose
Design and execute biometric systems workflows using secret scanner controls with validated outcomes.
