---
name: b2b-portals-evidence-collector
description: Use when tasks require b2b portals evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Evidence Collector

## Purpose
Design and execute b2b portals workflows using evidence collector controls with validated outcomes.
