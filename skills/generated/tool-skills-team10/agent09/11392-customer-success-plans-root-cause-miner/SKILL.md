---
name: customer-success-plans-root-cause-miner
description: Use when tasks require customer success plans root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Root Cause Miner

## Purpose
Design and execute customer success plans workflows using root cause miner controls with validated outcomes.
