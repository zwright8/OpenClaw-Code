---
name: vector-datastores-dependency-resolver
description: Use when tasks require vector datastores dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Dependency Resolver

## Purpose
Design and execute vector datastores workflows using dependency resolver controls with validated outcomes.
