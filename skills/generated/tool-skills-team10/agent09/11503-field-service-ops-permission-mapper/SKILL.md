---
name: field-service-ops-permission-mapper
description: Use when tasks require field service ops permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Permission Mapper

## Purpose
Design and execute field service ops workflows using permission mapper controls with validated outcomes.
