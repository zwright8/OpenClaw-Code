---
name: mlops-pipelines-runbook-composer
description: Use when tasks require mlops pipelines runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# MLOps Pipelines Runbook Composer

## Purpose
Design and execute mlops pipelines workflows using runbook composer controls with validated outcomes.
