---
name: work-order-systems-feedback-harvester
description: Use when tasks require work order systems feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Feedback Harvester

## Purpose
Design and execute work order systems workflows using feedback harvester controls with validated outcomes.
