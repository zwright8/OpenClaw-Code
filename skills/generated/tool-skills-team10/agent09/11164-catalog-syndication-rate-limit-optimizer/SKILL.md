---
name: catalog-syndication-rate-limit-optimizer
description: Use when tasks require catalog syndication rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Rate Limit Optimizer

## Purpose
Design and execute catalog syndication workflows using rate limit optimizer controls with validated outcomes.
