---
name: model-serving-remediation-planner
description: Use when tasks require model serving remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Remediation Planner

## Purpose
Design and execute model serving workflows using remediation planner controls with validated outcomes.
