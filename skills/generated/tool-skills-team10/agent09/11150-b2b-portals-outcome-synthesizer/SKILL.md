---
name: b2b-portals-outcome-synthesizer
description: Use when tasks require b2b portals outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Outcome Synthesizer

## Purpose
Design and execute b2b portals workflows using outcome synthesizer controls with validated outcomes.
