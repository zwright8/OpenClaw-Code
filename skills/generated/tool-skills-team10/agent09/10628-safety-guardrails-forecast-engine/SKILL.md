---
name: safety-guardrails-forecast-engine
description: Use when tasks require safety guardrails forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Forecast Engine

## Purpose
Design and execute safety guardrails workflows using forecast engine controls with validated outcomes.
