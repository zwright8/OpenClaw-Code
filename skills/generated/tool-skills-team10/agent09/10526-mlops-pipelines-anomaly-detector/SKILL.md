---
name: mlops-pipelines-anomaly-detector
description: Use when tasks require mlops pipelines anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# MLOps Pipelines Anomaly Detector

## Purpose
Design and execute mlops pipelines workflows using anomaly detector controls with validated outcomes.
