---
name: safety-guardrails-capacity-planner
description: Use when tasks require safety guardrails capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Capacity Planner

## Purpose
Design and execute safety guardrails workflows using capacity planner controls with validated outcomes.
