---
name: safety-guardrails-workflow-compiler
description: Use when tasks require safety guardrails workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Workflow Compiler

## Purpose
Design and execute safety guardrails workflows using workflow compiler controls with validated outcomes.
