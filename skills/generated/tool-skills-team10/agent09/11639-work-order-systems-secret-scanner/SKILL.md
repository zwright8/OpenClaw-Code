---
name: work-order-systems-secret-scanner
description: Use when tasks require work order systems secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Secret Scanner

## Purpose
Design and execute work order systems workflows using secret scanner controls with validated outcomes.
