---
name: semantic-retrieval-secret-scanner
description: Use when tasks require semantic retrieval secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Secret Scanner

## Purpose
Design and execute semantic retrieval workflows using secret scanner controls with validated outcomes.
