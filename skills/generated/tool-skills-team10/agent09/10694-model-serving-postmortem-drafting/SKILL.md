---
name: model-serving-postmortem-drafting
description: Use when tasks require model serving postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Postmortem Drafting

## Purpose
Design and execute model serving workflows using postmortem drafting controls with validated outcomes.
