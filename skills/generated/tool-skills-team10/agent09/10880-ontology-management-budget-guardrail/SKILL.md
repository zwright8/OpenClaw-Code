---
name: ontology-management-budget-guardrail
description: Use when tasks require ontology management budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Budget Guardrail

## Purpose
Design and execute ontology management workflows using budget guardrail controls with validated outcomes.
