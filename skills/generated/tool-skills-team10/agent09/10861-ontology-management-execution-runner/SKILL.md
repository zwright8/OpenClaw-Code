---
name: ontology-management-execution-runner
description: Use when tasks require ontology management execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Execution Runner

## Purpose
Design and execute ontology management workflows using execution runner controls with validated outcomes.
