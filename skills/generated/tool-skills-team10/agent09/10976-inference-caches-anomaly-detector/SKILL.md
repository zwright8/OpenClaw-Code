---
name: inference-caches-anomaly-detector
description: Use when tasks require inference caches anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inference Caches Anomaly Detector

## Purpose
Design and execute inference caches workflows using anomaly detector controls with validated outcomes.
