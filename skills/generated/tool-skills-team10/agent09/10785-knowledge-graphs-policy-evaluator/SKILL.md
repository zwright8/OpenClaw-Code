...
description: Use when tasks require knowledge graphs policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Policy Evaluator

## Purpose
Design and execute knowledge graphs workflows using policy evaluator controls with validated outcomes.
