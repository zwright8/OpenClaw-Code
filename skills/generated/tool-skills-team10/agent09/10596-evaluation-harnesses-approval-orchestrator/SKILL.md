---
name: evaluation-harnesses-approval-orchestrator
description: Use when tasks require evaluation harnesses approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Approval Orchestrator

## Purpose
Design and execute evaluation harnesses workflows using approval orchestrator controls with validated outcomes.
