---
name: knowledge-graphs-dependency-resolver
description: Use when tasks require knowledge graphs dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Dependency Resolver

## Purpose
Design and execute knowledge graphs workflows using dependency resolver controls with validated outcomes.
