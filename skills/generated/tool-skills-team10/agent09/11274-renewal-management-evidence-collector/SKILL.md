---
name: renewal-management-evidence-collector
description: Use when tasks require renewal management evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Renewal Management Evidence Collector

## Purpose
Design and execute renewal management workflows using evidence collector controls with validated outcomes.
