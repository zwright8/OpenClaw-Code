---
name: channel-operations-runbook-composer
description: Use when tasks require channel operations runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Runbook Composer

## Purpose
Design and execute channel operations workflows using runbook composer controls with validated outcomes.
