---
name: knowledge-graphs-task-decomposer
description: Use when tasks require knowledge graphs task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Task Decomposer

## Purpose
Design and execute knowledge graphs workflows using task decomposer controls with validated outcomes.
