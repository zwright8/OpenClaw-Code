---
name: b2b-portals-artifact-publisher
description: Use when tasks require b2b portals artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Artifact Publisher

## Purpose
Design and execute b2b portals workflows using artifact publisher controls with validated outcomes.
