---
name: churn-prevention-access-auditor
description: Use when tasks require churn prevention access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Access Auditor

## Purpose
Design and execute churn prevention workflows using access auditor controls with validated outcomes.
