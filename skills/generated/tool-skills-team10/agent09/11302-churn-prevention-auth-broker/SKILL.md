---
name: churn-prevention-auth-broker
description: Use when tasks require churn prevention auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Auth Broker

## Purpose
Design and execute churn prevention workflows using auth broker controls with validated outcomes.
