---
name: qbr-automation-spec-drift-detector
description: Use when tasks require qbr automation spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Spec Drift Detector

## Purpose
Design and execute qbr automation workflows using spec drift detector controls with validated outcomes.
