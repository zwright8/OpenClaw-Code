---
name: document-verification-provenance-tracker
description: Use when tasks require document verification provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Provenance Tracker

## Purpose
Design and execute document verification workflows using provenance tracker controls with validated outcomes.
