---
name: reference-programs-execution-runner
description: Use when tasks require reference programs execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Execution Runner

## Purpose
Design and execute reference programs workflows using execution runner controls with validated outcomes.
