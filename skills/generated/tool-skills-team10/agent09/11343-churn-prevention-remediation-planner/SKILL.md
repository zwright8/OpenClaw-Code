---
name: churn-prevention-remediation-planner
description: Use when tasks require churn prevention remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Remediation Planner

## Purpose
Design and execute churn prevention workflows using remediation planner controls with validated outcomes.
