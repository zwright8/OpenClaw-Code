---
name: safety-guardrails-rate-limit-optimizer
description: Use when tasks require safety guardrails rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Rate Limit Optimizer

## Purpose
Design and execute safety guardrails workflows using rate limit optimizer controls with validated outcomes.
