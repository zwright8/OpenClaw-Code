---
name: channel-operations-feedback-harvester
description: Use when tasks require channel operations feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Feedback Harvester

## Purpose
Design and execute channel operations workflows using feedback harvester controls with validated outcomes.
