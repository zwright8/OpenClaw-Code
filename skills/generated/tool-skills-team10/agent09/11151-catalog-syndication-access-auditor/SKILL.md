---
name: catalog-syndication-access-auditor
description: Use when tasks require catalog syndication access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Access Auditor

## Purpose
Design and execute catalog syndication workflows using access auditor controls with validated outcomes.
