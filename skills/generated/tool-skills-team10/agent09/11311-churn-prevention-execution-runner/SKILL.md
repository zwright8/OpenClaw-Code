---
name: churn-prevention-execution-runner
description: Use when tasks require churn prevention execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Execution Runner

## Purpose
Design and execute churn prevention workflows using execution runner controls with validated outcomes.
