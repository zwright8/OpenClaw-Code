---
name: qbr-automation-root-cause-miner
description: Use when tasks require qbr automation root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Root Cause Miner

## Purpose
Design and execute qbr automation workflows using root cause miner controls with validated outcomes.
