---
name: channel-operations-state-reconciler
description: Use when tasks require channel operations state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations State Reconciler

## Purpose
Design and execute channel operations workflows using state reconciler controls with validated outcomes.
