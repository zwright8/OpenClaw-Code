---
name: edi-pipelines-rollback-coordinator
description: Use when tasks require edi pipelines rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Rollback Coordinator

## Purpose
Design and execute edi pipelines workflows using rollback coordinator controls with validated outcomes.
