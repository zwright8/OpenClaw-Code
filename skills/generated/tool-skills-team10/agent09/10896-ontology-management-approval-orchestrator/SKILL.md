---
name: ontology-management-approval-orchestrator
description: Use when tasks require ontology management approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Approval Orchestrator

## Purpose
Design and execute ontology management workflows using approval orchestrator controls with validated outcomes.
