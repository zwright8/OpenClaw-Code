---
name: edi-pipelines-secret-scanner
description: Use when tasks require edi pipelines secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Secret Scanner

## Purpose
Design and execute edi pipelines workflows using secret scanner controls with validated outcomes.
