---
name: partner-integrations-snapshot-manager
description: Use when tasks require partner integrations snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Snapshot Manager

## Purpose
Design and execute partner integrations workflows using snapshot manager controls with validated outcomes.
