---
name: vector-datastores-capacity-planner
description: Use when tasks require vector datastores capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Capacity Planner

## Purpose
Design and execute vector datastores workflows using capacity planner controls with validated outcomes.
