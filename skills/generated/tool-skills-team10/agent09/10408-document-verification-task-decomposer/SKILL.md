---
name: document-verification-task-decomposer
description: Use when tasks require document verification task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Task Decomposer

## Purpose
Design and execute document verification workflows using task decomposer controls with validated outcomes.
