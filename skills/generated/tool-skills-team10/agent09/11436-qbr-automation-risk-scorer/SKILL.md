---
name: qbr-automation-risk-scorer
description: Use when tasks require qbr automation risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Risk Scorer

## Purpose
Design and execute qbr automation workflows using risk scorer controls with validated outcomes.
