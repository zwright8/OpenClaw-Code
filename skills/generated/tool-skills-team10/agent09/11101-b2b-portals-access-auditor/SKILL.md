---
name: b2b-portals-access-auditor
description: Use when tasks require b2b portals access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Access Auditor

## Purpose
Design and execute b2b portals workflows using access auditor controls with validated outcomes.
