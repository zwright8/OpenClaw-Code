---
name: ontology-management-remediation-planner
description: Use when tasks require ontology management remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Remediation Planner

## Purpose
Design and execute ontology management workflows using remediation planner controls with validated outcomes.
