---
name: evaluation-harnesses-forecast-engine
description: Use when tasks require evaluation harnesses forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Forecast Engine

## Purpose
Design and execute evaluation harnesses workflows using forecast engine controls with validated outcomes.
