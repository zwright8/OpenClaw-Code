---
name: field-service-ops-capacity-planner
description: Use when tasks require field service ops capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Capacity Planner

## Purpose
Design and execute field service ops workflows using capacity planner controls with validated outcomes.
