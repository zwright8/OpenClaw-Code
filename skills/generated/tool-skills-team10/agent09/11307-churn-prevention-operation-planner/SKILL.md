---
name: churn-prevention-operation-planner
description: Use when tasks require churn prevention operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Operation Planner

## Purpose
Design and execute churn prevention workflows using operation planner controls with validated outcomes.
