---
name: scheduling-dispatch-approval-orchestrator
description: Use when tasks require scheduling dispatch approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Approval Orchestrator

## Purpose
Design and execute scheduling dispatch workflows using approval orchestrator controls with validated outcomes.
