---
name: renewal-management-feedback-harvester
description: Use when tasks require renewal management feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Renewal Management Feedback Harvester

## Purpose
Design and execute renewal management workflows using feedback harvester controls with validated outcomes.
