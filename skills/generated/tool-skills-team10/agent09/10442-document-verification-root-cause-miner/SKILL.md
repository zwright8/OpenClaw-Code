---
name: document-verification-root-cause-miner
description: Use when tasks require document verification root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Root Cause Miner

## Purpose
Design and execute document verification workflows using root cause miner controls with validated outcomes.
