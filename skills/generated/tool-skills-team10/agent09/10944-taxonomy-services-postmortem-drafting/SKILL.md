---
name: taxonomy-services-postmortem-drafting
description: Use when tasks require taxonomy services postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Postmortem Drafting

## Purpose
Design and execute taxonomy services workflows using postmortem drafting controls with validated outcomes.
