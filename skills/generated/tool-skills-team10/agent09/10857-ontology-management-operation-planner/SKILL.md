---
name: ontology-management-operation-planner
description: Use when tasks require ontology management operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Operation Planner

## Purpose
Design and execute ontology management workflows using operation planner controls with validated outcomes.
