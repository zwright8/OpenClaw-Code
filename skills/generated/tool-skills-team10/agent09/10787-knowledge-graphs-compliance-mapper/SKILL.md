---
name: knowledge-graphs-compliance-mapper
description: Use when tasks require knowledge graphs compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Compliance Mapper

## Purpose
Design and execute knowledge graphs workflows using compliance mapper controls with validated outcomes.
