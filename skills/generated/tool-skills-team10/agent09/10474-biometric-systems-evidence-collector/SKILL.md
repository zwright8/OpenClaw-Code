---
name: biometric-systems-evidence-collector
description: Use when tasks require biometric systems evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Evidence Collector

## Purpose
Design and execute biometric systems workflows using evidence collector controls with validated outcomes.
