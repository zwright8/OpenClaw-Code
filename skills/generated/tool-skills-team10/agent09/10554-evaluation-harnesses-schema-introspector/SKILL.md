---
name: evaluation-harnesses-schema-introspector
description: Use when tasks require evaluation harnesses schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Schema Introspector

## Purpose
Design and execute evaluation harnesses workflows using schema introspector controls with validated outcomes.
