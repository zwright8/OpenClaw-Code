---
name: channel-operations-secret-scanner
description: Use when tasks require channel operations secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Secret Scanner

## Purpose
Design and execute channel operations workflows using secret scanner controls with validated outcomes.
