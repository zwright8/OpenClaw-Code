---
name: evaluation-harnesses-reliability-scorer
description: Use when tasks require evaluation harnesses reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Reliability Scorer

## Purpose
Design and execute evaluation harnesses workflows using reliability scorer controls with validated outcomes.
