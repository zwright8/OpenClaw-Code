---
name: knowledge-graphs-spec-drift-detector
description: Use when tasks require knowledge graphs spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Spec Drift Detector

## Purpose
Design and execute knowledge graphs workflows using spec drift detector controls with validated outcomes.
