---
name: renewal-management-permission-mapper
description: Use when tasks require renewal management permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Renewal Management Permission Mapper

## Purpose
Design and execute renewal management workflows using permission mapper controls with validated outcomes.
