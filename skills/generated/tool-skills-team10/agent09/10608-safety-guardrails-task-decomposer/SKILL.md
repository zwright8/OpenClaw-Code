---
name: safety-guardrails-task-decomposer
description: Use when tasks require safety guardrails task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Task Decomposer

## Purpose
Design and execute safety guardrails workflows using task decomposer controls with validated outcomes.
