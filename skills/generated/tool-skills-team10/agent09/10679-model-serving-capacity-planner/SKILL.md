---
name: model-serving-capacity-planner
description: Use when tasks require model serving capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Capacity Planner

## Purpose
Design and execute model serving workflows using capacity planner controls with validated outcomes.
