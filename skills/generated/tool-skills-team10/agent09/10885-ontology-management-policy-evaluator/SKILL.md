---
name: ontology-management-policy-evaluator
description: Use when tasks require ontology management policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Policy Evaluator

## Purpose
Design and execute ontology management workflows using policy evaluator controls with validated outcomes.
