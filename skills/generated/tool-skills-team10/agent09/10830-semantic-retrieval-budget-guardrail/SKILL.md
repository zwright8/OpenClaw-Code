---
name: semantic-retrieval-budget-guardrail
description: Use when tasks require semantic retrieval budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Budget Guardrail

## Purpose
Design and execute semantic retrieval workflows using budget guardrail controls with validated outcomes.
