---
name: customer-success-plans-remediation-planner
description: Use when tasks require customer success plans remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Remediation Planner

## Purpose
Design and execute customer success plans workflows using remediation planner controls with validated outcomes.
