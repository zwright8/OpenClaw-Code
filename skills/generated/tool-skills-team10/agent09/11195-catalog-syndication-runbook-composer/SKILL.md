---
name: catalog-syndication-runbook-composer
description: Use when tasks require catalog syndication runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Runbook Composer

## Purpose
Design and execute catalog syndication workflows using runbook composer controls with validated outcomes.
