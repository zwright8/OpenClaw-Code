---
name: biometric-systems-compliance-mapper
description: Use when tasks require biometric systems compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Compliance Mapper

## Purpose
Design and execute biometric systems workflows using compliance mapper controls with validated outcomes.
