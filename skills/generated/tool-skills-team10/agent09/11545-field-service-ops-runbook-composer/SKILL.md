---
name: field-service-ops-runbook-composer
description: Use when tasks require field service ops runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Runbook Composer

## Purpose
Design and execute field service ops workflows using runbook composer controls with validated outcomes.
