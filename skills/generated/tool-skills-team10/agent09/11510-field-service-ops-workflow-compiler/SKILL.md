---
name: field-service-ops-workflow-compiler
description: Use when tasks require field service ops workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Workflow Compiler

## Purpose
Design and execute field service ops workflows using workflow compiler controls with validated outcomes.
