---
name: b2b-portals-forecast-engine
description: Use when tasks require b2b portals forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Forecast Engine

## Purpose
Design and execute b2b portals workflows using forecast engine controls with validated outcomes.
