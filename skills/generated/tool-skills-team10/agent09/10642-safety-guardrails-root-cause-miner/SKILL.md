---
name: safety-guardrails-root-cause-miner
description: Use when tasks require safety guardrails root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Root Cause Miner

## Purpose
Design and execute safety guardrails workflows using root cause miner controls with validated outcomes.
