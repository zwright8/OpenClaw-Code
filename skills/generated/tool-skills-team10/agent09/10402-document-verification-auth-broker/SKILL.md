---
name: document-verification-auth-broker
description: Use when tasks require document verification auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Auth Broker

## Purpose
Design and execute document verification workflows using auth broker controls with validated outcomes.
