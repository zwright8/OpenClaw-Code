---
name: partner-integrations-auth-broker
description: Use when tasks require partner integrations auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Auth Broker

## Purpose
Design and execute partner integrations workflows using auth broker controls with validated outcomes.
