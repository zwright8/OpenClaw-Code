---
name: vector-datastores-auth-broker
description: Use when tasks require vector datastores auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Auth Broker

## Purpose
Design and execute vector datastores workflows using auth broker controls with validated outcomes.
