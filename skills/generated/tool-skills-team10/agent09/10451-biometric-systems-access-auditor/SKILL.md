---
name: biometric-systems-access-auditor
description: Use when tasks require biometric systems access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Access Auditor

## Purpose
Design and execute biometric systems workflows using access auditor controls with validated outcomes.
