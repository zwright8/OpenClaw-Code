---
name: edi-pipelines-rate-limit-optimizer
description: Use when tasks require edi pipelines rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Rate Limit Optimizer

## Purpose
Design and execute edi pipelines workflows using rate limit optimizer controls with validated outcomes.
