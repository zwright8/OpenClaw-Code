---
name: edi-pipelines-artifact-publisher
description: Use when tasks require edi pipelines artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Artifact Publisher

## Purpose
Design and execute edi pipelines workflows using artifact publisher controls with validated outcomes.
