---
name: mlops-pipelines-artifact-publisher
description: Use when tasks require mlops pipelines artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# MLOps Pipelines Artifact Publisher

## Purpose
Design and execute mlops pipelines workflows using artifact publisher controls with validated outcomes.
