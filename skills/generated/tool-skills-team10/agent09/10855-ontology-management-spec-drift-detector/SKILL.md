---
name: ontology-management-spec-drift-detector
description: Use when tasks require ontology management spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Spec Drift Detector

## Purpose
Design and execute ontology management workflows using spec drift detector controls with validated outcomes.
