...
description: Use when tasks require taxonomy services approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Approval Orchestrator

## Purpose
Design and execute taxonomy services workflows using approval orchestrator controls with validated outcomes.
