---
name: edi-pipelines-forecast-engine
description: Use when tasks require edi pipelines forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Forecast Engine

## Purpose
Design and execute edi pipelines workflows using forecast engine controls with validated outcomes.
