---
name: churn-prevention-migration-planner
description: Use when tasks require churn prevention migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Migration Planner

## Purpose
Design and execute churn prevention workflows using migration planner controls with validated outcomes.
