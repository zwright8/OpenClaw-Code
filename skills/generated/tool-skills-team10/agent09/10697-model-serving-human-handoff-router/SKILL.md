---
name: model-serving-human-handoff-router
description: Use when tasks require model serving human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Human Handoff Router

## Purpose
Design and execute model serving workflows using human handoff router controls with validated outcomes.
