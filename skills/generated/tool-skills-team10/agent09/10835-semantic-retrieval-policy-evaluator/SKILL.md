---
name: semantic-retrieval-policy-evaluator
description: Use when tasks require semantic retrieval policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Policy Evaluator

## Purpose
Design and execute semantic retrieval workflows using policy evaluator controls with validated outcomes.
