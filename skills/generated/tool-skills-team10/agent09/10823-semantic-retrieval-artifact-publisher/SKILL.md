---
name: semantic-retrieval-artifact-publisher
description: Use when tasks require semantic retrieval artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Artifact Publisher

## Purpose
Design and execute semantic retrieval workflows using artifact publisher controls with validated outcomes.
