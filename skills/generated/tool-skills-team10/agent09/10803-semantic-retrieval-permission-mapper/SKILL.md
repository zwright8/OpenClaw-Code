---
name: semantic-retrieval-permission-mapper
description: Use when tasks require semantic retrieval permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Permission Mapper

## Purpose
Design and execute semantic retrieval workflows using permission mapper controls with validated outcomes.
