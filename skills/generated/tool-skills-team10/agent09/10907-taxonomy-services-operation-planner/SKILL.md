---
name: taxonomy-services-operation-planner
description: Use when tasks require taxonomy services operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Operation Planner

## Purpose
Design and execute taxonomy services workflows using operation planner controls with validated outcomes.
