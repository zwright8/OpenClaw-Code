---
name: evaluation-harnesses-risk-scorer
description: Use when tasks require evaluation harnesses risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Risk Scorer

## Purpose
Design and execute evaluation harnesses workflows using risk scorer controls with validated outcomes.
