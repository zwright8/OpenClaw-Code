---
name: edi-pipelines-anomaly-detector
description: Use when tasks require edi pipelines anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Anomaly Detector

## Purpose
Design and execute edi pipelines workflows using anomaly detector controls with validated outcomes.
