---
name: churn-prevention-conflict-resolver
description: Use when tasks require churn prevention conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Conflict Resolver

## Purpose
Design and execute churn prevention workflows using conflict resolver controls with validated outcomes.
