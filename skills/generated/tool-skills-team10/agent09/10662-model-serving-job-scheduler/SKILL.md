---
name: model-serving-job-scheduler
description: Use when tasks require model serving job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Job Scheduler

## Purpose
Design and execute model serving workflows using job scheduler controls with validated outcomes.
