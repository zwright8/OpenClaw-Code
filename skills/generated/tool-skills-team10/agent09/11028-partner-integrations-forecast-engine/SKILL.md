---
name: partner-integrations-forecast-engine
description: Use when tasks require partner integrations forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Forecast Engine

## Purpose
Design and execute partner integrations workflows using forecast engine controls with validated outcomes.
