...
description: Use when tasks require churn prevention approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Approval Orchestrator

## Purpose
Design and execute churn prevention workflows using approval orchestrator controls with validated outcomes.
