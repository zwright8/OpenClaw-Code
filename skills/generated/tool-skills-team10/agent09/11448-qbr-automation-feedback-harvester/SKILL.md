---
name: qbr-automation-feedback-harvester
description: Use when tasks require qbr automation feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Feedback Harvester

## Purpose
Design and execute qbr automation workflows using feedback harvester controls with validated outcomes.
