---
name: qbr-automation-secret-scanner
description: Use when tasks require qbr automation secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Secret Scanner

## Purpose
Design and execute qbr automation workflows using secret scanner controls with validated outcomes.
