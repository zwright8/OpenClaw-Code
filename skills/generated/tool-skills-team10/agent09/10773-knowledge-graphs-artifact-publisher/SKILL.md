---
name: knowledge-graphs-artifact-publisher
description: Use when tasks require knowledge graphs artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Artifact Publisher

## Purpose
Design and execute knowledge graphs workflows using artifact publisher controls with validated outcomes.
