---
name: catalog-syndication-postmortem-drafting
description: Use when tasks require catalog syndication postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Postmortem Drafting

## Purpose
Design and execute catalog syndication workflows using postmortem drafting controls with validated outcomes.
