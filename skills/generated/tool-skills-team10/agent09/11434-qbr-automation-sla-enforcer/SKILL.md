---
name: qbr-automation-sla-enforcer
description: Use when tasks require qbr automation sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation SLA Enforcer

## Purpose
Design and execute qbr automation workflows using sla enforcer controls with validated outcomes.
