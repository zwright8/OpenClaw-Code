---
name: churn-prevention-task-decomposer
description: Use when tasks require churn prevention task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Task Decomposer

## Purpose
Design and execute churn prevention workflows using task decomposer controls with validated outcomes.
