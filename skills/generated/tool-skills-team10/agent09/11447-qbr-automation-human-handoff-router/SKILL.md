---
name: qbr-automation-human-handoff-router
description: Use when tasks require qbr automation human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Human Handoff Router

## Purpose
Design and execute qbr automation workflows using human handoff router controls with validated outcomes.
