---
name: partner-integrations-workflow-compiler
description: Use when tasks require partner integrations workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Workflow Compiler

## Purpose
Design and execute partner integrations workflows using workflow compiler controls with validated outcomes.
