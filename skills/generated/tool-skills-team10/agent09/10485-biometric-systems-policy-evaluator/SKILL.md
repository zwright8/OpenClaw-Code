---
name: biometric-systems-policy-evaluator
description: Use when tasks require biometric systems policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Policy Evaluator

## Purpose
Design and execute biometric systems workflows using policy evaluator controls with validated outcomes.
