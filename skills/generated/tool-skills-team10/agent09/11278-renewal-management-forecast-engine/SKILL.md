---
name: renewal-management-forecast-engine
description: Use when tasks require renewal management forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Renewal Management Forecast Engine

## Purpose
Design and execute renewal management workflows using forecast engine controls with validated outcomes.
