---
name: knowledge-graphs-execution-runner
description: Use when tasks require knowledge graphs execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Execution Runner

## Purpose
Design and execute knowledge graphs workflows using execution runner controls with validated outcomes.
