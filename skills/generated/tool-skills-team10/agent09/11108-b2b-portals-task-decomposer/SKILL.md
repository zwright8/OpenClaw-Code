---
name: b2b-portals-task-decomposer
description: Use when tasks require b2b portals task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Task Decomposer

## Purpose
Design and execute b2b portals workflows using task decomposer controls with validated outcomes.
