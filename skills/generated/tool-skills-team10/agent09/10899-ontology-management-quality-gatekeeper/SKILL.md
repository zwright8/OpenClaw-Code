---
name: ontology-management-quality-gatekeeper
description: Use when tasks require ontology management quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Quality Gatekeeper

## Purpose
Design and execute ontology management workflows using quality gatekeeper controls with validated outcomes.
