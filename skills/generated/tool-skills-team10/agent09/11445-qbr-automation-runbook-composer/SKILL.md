---
name: qbr-automation-runbook-composer
description: Use when tasks require qbr automation runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Runbook Composer

## Purpose
Design and execute qbr automation workflows using runbook composer controls with validated outcomes.
