---
name: ontology-management-artifact-publisher
description: Use when tasks require ontology management artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Artifact Publisher

## Purpose
Design and execute ontology management workflows using artifact publisher controls with validated outcomes.
