---
name: field-service-ops-schema-introspector
description: Use when tasks require field service ops schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Schema Introspector

## Purpose
Design and execute field service ops workflows using schema introspector controls with validated outcomes.
