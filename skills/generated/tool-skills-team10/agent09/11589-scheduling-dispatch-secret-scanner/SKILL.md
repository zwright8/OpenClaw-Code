---
name: scheduling-dispatch-secret-scanner
description: Use when tasks require scheduling dispatch secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Secret Scanner

## Purpose
Design and execute scheduling dispatch workflows using secret scanner controls with validated outcomes.
