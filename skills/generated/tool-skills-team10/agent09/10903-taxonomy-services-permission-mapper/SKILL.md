---
name: taxonomy-services-permission-mapper
description: Use when tasks require taxonomy services permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Permission Mapper

## Purpose
Design and execute taxonomy services workflows using permission mapper controls with validated outcomes.
