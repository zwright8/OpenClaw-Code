---
name: document-verification-anomaly-detector
description: Use when tasks require document verification anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Anomaly Detector

## Purpose
Design and execute document verification workflows using anomaly detector controls with validated outcomes.
