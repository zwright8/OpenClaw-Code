---
name: churn-prevention-policy-evaluator
description: Use when tasks require churn prevention policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Policy Evaluator

## Purpose
Design and execute churn prevention workflows using policy evaluator controls with validated outcomes.
