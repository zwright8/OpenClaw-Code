---
name: scheduling-dispatch-operation-planner
description: Use when tasks require scheduling dispatch operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Operation Planner

## Purpose
Design and execute scheduling dispatch workflows using operation planner controls with validated outcomes.
