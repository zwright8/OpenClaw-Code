---
name: field-service-ops-evidence-collector
description: Use when tasks require field service ops evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Evidence Collector

## Purpose
Design and execute field service ops workflows using evidence collector controls with validated outcomes.
