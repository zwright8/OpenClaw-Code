---
name: knowledge-graphs-workflow-compiler
description: Use when tasks require knowledge graphs workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Workflow Compiler

## Purpose
Design and execute knowledge graphs workflows using workflow compiler controls with validated outcomes.
