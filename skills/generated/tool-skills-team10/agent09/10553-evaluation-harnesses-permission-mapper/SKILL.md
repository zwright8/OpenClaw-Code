---
name: evaluation-harnesses-permission-mapper
description: Use when tasks require evaluation harnesses permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Permission Mapper

## Purpose
Design and execute evaluation harnesses workflows using permission mapper controls with validated outcomes.
