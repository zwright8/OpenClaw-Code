---
name: vector-datastores-rate-limit-optimizer
description: Use when tasks require vector datastores rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Rate Limit Optimizer

## Purpose
Design and execute vector datastores workflows using rate limit optimizer controls with validated outcomes.
