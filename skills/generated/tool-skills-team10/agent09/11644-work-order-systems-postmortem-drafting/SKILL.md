---
name: work-order-systems-postmortem-drafting
description: Use when tasks require work order systems postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Postmortem Drafting

## Purpose
Design and execute work order systems workflows using postmortem drafting controls with validated outcomes.
