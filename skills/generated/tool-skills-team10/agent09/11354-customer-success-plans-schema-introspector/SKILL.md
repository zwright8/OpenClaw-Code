---
name: customer-success-plans-schema-introspector
description: Use when tasks require customer success plans schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Schema Introspector

## Purpose
Design and execute customer success plans workflows using schema introspector controls with validated outcomes.
