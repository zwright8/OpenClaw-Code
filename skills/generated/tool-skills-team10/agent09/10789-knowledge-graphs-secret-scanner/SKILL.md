---
name: knowledge-graphs-secret-scanner
description: Use when tasks require knowledge graphs secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Secret Scanner

## Purpose
Design and execute knowledge graphs workflows using secret scanner controls with validated outcomes.
