---
name: channel-operations-anomaly-detector
description: Use when tasks require channel operations anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Anomaly Detector

## Purpose
Design and execute channel operations workflows using anomaly detector controls with validated outcomes.
