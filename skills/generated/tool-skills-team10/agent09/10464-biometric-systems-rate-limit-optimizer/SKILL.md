---
name: biometric-systems-rate-limit-optimizer
description: Use when tasks require biometric systems rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Rate Limit Optimizer

## Purpose
Design and execute biometric systems workflows using rate limit optimizer controls with validated outcomes.
