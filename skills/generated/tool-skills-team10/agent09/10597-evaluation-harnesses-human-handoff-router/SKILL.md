---
name: evaluation-harnesses-human-handoff-router
description: Use when tasks require evaluation harnesses human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Human Handoff Router

## Purpose
Design and execute evaluation harnesses workflows using human handoff router controls with validated outcomes.
