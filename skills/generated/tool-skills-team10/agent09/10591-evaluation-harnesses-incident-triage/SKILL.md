---
name: evaluation-harnesses-incident-triage
description: Use when tasks require evaluation harnesses incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Incident Triage

## Purpose
Design and execute evaluation harnesses workflows using incident triage controls with validated outcomes.
