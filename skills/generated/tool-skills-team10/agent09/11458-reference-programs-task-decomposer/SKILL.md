---
name: reference-programs-task-decomposer
description: Use when tasks require reference programs task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Task Decomposer

## Purpose
Design and execute reference programs workflows using task decomposer controls with validated outcomes.
