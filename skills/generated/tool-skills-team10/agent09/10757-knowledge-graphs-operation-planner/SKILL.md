---
name: knowledge-graphs-operation-planner
description: Use when tasks require knowledge graphs operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Operation Planner

## Purpose
Design and execute knowledge graphs workflows using operation planner controls with validated outcomes.
