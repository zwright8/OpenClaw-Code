---
name: semantic-retrieval-capacity-planner
description: Use when tasks require semantic retrieval capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Capacity Planner

## Purpose
Design and execute semantic retrieval workflows using capacity planner controls with validated outcomes.
