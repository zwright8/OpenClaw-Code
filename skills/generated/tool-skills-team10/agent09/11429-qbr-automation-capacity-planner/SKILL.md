---
name: qbr-automation-capacity-planner
description: Use when tasks require qbr automation capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Capacity Planner

## Purpose
Design and execute qbr automation workflows using capacity planner controls with validated outcomes.
