---
name: catalog-syndication-permission-mapper
description: Use when tasks require catalog syndication permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Permission Mapper

## Purpose
Design and execute catalog syndication workflows using permission mapper controls with validated outcomes.
