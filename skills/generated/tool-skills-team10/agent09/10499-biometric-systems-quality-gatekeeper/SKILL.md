---
name: biometric-systems-quality-gatekeeper
description: Use when tasks require biometric systems quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Quality Gatekeeper

## Purpose
Design and execute biometric systems workflows using quality gatekeeper controls with validated outcomes.
