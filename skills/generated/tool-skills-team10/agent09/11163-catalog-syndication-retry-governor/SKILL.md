---
name: catalog-syndication-retry-governor
description: Use when tasks require catalog syndication retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Retry Governor

## Purpose
Design and execute catalog syndication workflows using retry governor controls with validated outcomes.
