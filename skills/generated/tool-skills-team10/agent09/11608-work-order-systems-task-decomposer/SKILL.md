---
name: work-order-systems-task-decomposer
description: Use when tasks require work order systems task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Task Decomposer

## Purpose
Design and execute work order systems workflows using task decomposer controls with validated outcomes.
