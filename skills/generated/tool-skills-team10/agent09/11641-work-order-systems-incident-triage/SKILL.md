---
name: work-order-systems-incident-triage
description: Use when tasks require work order systems incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Incident Triage

## Purpose
Design and execute work order systems workflows using incident triage controls with validated outcomes.
