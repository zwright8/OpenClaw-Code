---
name: inference-caches-secret-scanner
description: Use when tasks require inference caches secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inference Caches Secret Scanner

## Purpose
Design and execute inference caches workflows using secret scanner controls with validated outcomes.
