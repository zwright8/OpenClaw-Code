---
name: mlops-pipelines-auth-broker
description: Use when tasks require mlops pipelines auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# MLOps Pipelines Auth Broker

## Purpose
Design and execute mlops pipelines workflows using auth broker controls with validated outcomes.
