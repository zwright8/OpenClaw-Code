---
name: safety-guardrails-snapshot-manager
description: Use when tasks require safety guardrails snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Snapshot Manager

## Purpose
Design and execute safety guardrails workflows using snapshot manager controls with validated outcomes.
