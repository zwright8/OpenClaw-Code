---
name: evaluation-harnesses-runbook-composer
description: Use when tasks require evaluation harnesses runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Runbook Composer

## Purpose
Design and execute evaluation harnesses workflows using runbook composer controls with validated outcomes.
