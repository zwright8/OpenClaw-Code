---
name: semantic-retrieval-execution-runner
description: Use when tasks require semantic retrieval execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Execution Runner

## Purpose
Design and execute semantic retrieval workflows using execution runner controls with validated outcomes.
