---
name: channel-operations-root-cause-miner
description: Use when tasks require channel operations root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Root Cause Miner

## Purpose
Design and execute channel operations workflows using root cause miner controls with validated outcomes.
