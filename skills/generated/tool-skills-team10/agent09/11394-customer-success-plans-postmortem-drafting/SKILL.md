---
name: customer-success-plans-postmortem-drafting
description: Use when tasks require customer success plans postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Postmortem Drafting

## Purpose
Design and execute customer success plans workflows using postmortem drafting controls with validated outcomes.
