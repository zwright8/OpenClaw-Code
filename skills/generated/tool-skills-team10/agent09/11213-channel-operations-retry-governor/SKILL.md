---
name: channel-operations-retry-governor
description: Use when tasks require channel operations retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Retry Governor

## Purpose
Design and execute channel operations workflows using retry governor controls with validated outcomes.
