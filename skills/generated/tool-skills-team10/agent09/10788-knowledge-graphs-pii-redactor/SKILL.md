---
name: knowledge-graphs-pii-redactor
description: Use when tasks require knowledge graphs pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs PII Redactor

## Purpose
Design and execute knowledge graphs workflows using pii redactor controls with validated outcomes.
