---
name: model-serving-evidence-collector
description: Use when tasks require model serving evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Evidence Collector

## Purpose
Design and execute model serving workflows using evidence collector controls with validated outcomes.
