---
name: semantic-retrieval-spec-drift-detector
description: Use when tasks require semantic retrieval spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Spec Drift Detector

## Purpose
Design and execute semantic retrieval workflows using spec drift detector controls with validated outcomes.
