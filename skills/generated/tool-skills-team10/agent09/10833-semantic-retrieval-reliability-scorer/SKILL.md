---
name: semantic-retrieval-reliability-scorer
description: Use when tasks require semantic retrieval reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Reliability Scorer

## Purpose
Design and execute semantic retrieval workflows using reliability scorer controls with validated outcomes.
