---
name: customer-success-plans-snapshot-manager
description: Use when tasks require customer success plans snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Snapshot Manager

## Purpose
Design and execute customer success plans workflows using snapshot manager controls with validated outcomes.
