---
name: taxonomy-services-human-handoff-router
description: Use when tasks require taxonomy services human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Human Handoff Router

## Purpose
Design and execute taxonomy services workflows using human handoff router controls with validated outcomes.
