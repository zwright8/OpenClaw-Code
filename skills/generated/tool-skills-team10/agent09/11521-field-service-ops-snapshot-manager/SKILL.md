---
name: field-service-ops-snapshot-manager
description: Use when tasks require field service ops snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Snapshot Manager

## Purpose
Design and execute field service ops workflows using snapshot manager controls with validated outcomes.
