---
name: reference-programs-postmortem-drafting
description: Use when tasks require reference programs postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Postmortem Drafting

## Purpose
Design and execute reference programs workflows using postmortem drafting controls with validated outcomes.
