---
name: customer-success-plans-evidence-collector
description: Use when tasks require customer success plans evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Evidence Collector

## Purpose
Design and execute customer success plans workflows using evidence collector controls with validated outcomes.
