---
name: safety-guardrails-human-handoff-router
description: Use when tasks require safety guardrails human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Human Handoff Router

## Purpose
Design and execute safety guardrails workflows using human handoff router controls with validated outcomes.
