---
name: document-verification-secret-scanner
description: Use when tasks require document verification secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Secret Scanner

## Purpose
Design and execute document verification workflows using secret scanner controls with validated outcomes.
