---
name: churn-prevention-risk-scorer
description: Use when tasks require churn prevention risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Risk Scorer

## Purpose
Design and execute churn prevention workflows using risk scorer controls with validated outcomes.
