---
name: partner-integrations-capacity-planner
description: Use when tasks require partner integrations capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Capacity Planner

## Purpose
Design and execute partner integrations workflows using capacity planner controls with validated outcomes.
