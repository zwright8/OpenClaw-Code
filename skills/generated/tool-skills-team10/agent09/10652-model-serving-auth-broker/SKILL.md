---
name: model-serving-auth-broker
description: Use when tasks require model serving auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Auth Broker

## Purpose
Design and execute model serving workflows using auth broker controls with validated outcomes.
