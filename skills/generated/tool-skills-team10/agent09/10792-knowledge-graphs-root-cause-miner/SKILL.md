---
name: knowledge-graphs-root-cause-miner
description: Use when tasks require knowledge graphs root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Root Cause Miner

## Purpose
Design and execute knowledge graphs workflows using root cause miner controls with validated outcomes.
