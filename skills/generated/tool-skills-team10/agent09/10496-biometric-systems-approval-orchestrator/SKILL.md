---
name: biometric-systems-approval-orchestrator
description: Use when tasks require biometric systems approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Approval Orchestrator

## Purpose
Design and execute biometric systems workflows using approval orchestrator controls with validated outcomes.
