---
name: field-service-ops-forecast-engine
description: Use when tasks require field service ops forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Forecast Engine

## Purpose
Design and execute field service ops workflows using forecast engine controls with validated outcomes.
