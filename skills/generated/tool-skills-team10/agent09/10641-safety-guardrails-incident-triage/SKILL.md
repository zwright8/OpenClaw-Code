---
name: safety-guardrails-incident-triage
description: Use when tasks require safety guardrails incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Incident Triage

## Purpose
Design and execute safety guardrails workflows using incident triage controls with validated outcomes.
