---
name: ontology-management-dependency-resolver
description: Use when tasks require ontology management dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Dependency Resolver

## Purpose
Design and execute ontology management workflows using dependency resolver controls with validated outcomes.
