---
name: semantic-retrieval-compliance-mapper
description: Use when tasks require semantic retrieval compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Compliance Mapper

## Purpose
Design and execute semantic retrieval workflows using compliance mapper controls with validated outcomes.
