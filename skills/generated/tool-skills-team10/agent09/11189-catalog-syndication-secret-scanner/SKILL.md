---
name: catalog-syndication-secret-scanner
description: Use when tasks require catalog syndication secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Secret Scanner

## Purpose
Design and execute catalog syndication workflows using secret scanner controls with validated outcomes.
