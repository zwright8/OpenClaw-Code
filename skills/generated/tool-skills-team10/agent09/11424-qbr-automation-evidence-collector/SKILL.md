---
name: qbr-automation-evidence-collector
description: Use when tasks require qbr automation evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Evidence Collector

## Purpose
Design and execute qbr automation workflows using evidence collector controls with validated outcomes.
