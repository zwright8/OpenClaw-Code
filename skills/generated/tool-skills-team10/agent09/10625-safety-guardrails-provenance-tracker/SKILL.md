---
name: safety-guardrails-provenance-tracker
description: Use when tasks require safety guardrails provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Provenance Tracker

## Purpose
Design and execute safety guardrails workflows using provenance tracker controls with validated outcomes.
