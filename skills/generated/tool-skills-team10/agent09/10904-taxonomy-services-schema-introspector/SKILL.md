---
name: taxonomy-services-schema-introspector
description: Use when tasks require taxonomy services schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Schema Introspector

## Purpose
Design and execute taxonomy services workflows using schema introspector controls with validated outcomes.
