---
name: taxonomy-services-pii-redactor
description: Use when tasks require taxonomy services pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services PII Redactor

## Purpose
Design and execute taxonomy services workflows using pii redactor controls with validated outcomes.
