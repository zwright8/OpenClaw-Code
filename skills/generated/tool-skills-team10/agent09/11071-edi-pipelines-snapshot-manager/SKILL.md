---
name: edi-pipelines-snapshot-manager
description: Use when tasks require edi pipelines snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Snapshot Manager

## Purpose
Design and execute edi pipelines workflows using snapshot manager controls with validated outcomes.
