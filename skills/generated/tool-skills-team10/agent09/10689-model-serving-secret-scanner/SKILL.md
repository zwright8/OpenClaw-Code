---
name: model-serving-secret-scanner
description: Use when tasks require model serving secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Secret Scanner

## Purpose
Design and execute model serving workflows using secret scanner controls with validated outcomes.
