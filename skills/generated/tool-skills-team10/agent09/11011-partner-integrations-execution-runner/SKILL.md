---
name: partner-integrations-execution-runner
description: Use when tasks require partner integrations execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Execution Runner

## Purpose
Design and execute partner integrations workflows using execution runner controls with validated outcomes.
