---
name: taxonomy-services-runbook-composer
description: Use when tasks require taxonomy services runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Runbook Composer

## Purpose
Design and execute taxonomy services workflows using runbook composer controls with validated outcomes.
