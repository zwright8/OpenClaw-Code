---
name: field-service-ops-auth-broker
description: Use when tasks require field service ops auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Auth Broker

## Purpose
Design and execute field service ops workflows using auth broker controls with validated outcomes.
