---
name: scheduling-dispatch-quality-gatekeeper
description: Use when tasks require scheduling dispatch quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Quality Gatekeeper

## Purpose
Design and execute scheduling dispatch workflows using quality gatekeeper controls with validated outcomes.
