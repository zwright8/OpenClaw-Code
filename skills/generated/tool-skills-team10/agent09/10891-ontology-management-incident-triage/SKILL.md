---
name: ontology-management-incident-triage
description: Use when tasks require ontology management incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Incident Triage

## Purpose
Design and execute ontology management workflows using incident triage controls with validated outcomes.
