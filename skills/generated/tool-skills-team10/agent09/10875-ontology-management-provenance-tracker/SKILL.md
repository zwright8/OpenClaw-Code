---
name: ontology-management-provenance-tracker
description: Use when tasks require ontology management provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Provenance Tracker

## Purpose
Design and execute ontology management workflows using provenance tracker controls with validated outcomes.
