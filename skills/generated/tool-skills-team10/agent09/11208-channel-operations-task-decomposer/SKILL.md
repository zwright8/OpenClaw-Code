---
name: channel-operations-task-decomposer
description: Use when tasks require channel operations task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Task Decomposer

## Purpose
Design and execute channel operations workflows using task decomposer controls with validated outcomes.
