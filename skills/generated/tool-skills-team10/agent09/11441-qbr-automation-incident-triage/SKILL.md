---
name: qbr-automation-incident-triage
description: Use when tasks require qbr automation incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Incident Triage

## Purpose
Design and execute qbr automation workflows using incident triage controls with validated outcomes.
