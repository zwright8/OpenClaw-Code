---
name: b2b-portals-secret-scanner
description: Use when tasks require b2b portals secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Secret Scanner

## Purpose
Design and execute b2b portals workflows using secret scanner controls with validated outcomes.
