---
name: catalog-syndication-workflow-compiler
description: Use when tasks require catalog syndication workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Workflow Compiler

## Purpose
Design and execute catalog syndication workflows using workflow compiler controls with validated outcomes.
