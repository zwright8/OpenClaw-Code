---
name: vector-datastores-schema-introspector
description: Use when tasks require vector datastores schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Schema Introspector

## Purpose
Design and execute vector datastores workflows using schema introspector controls with validated outcomes.
