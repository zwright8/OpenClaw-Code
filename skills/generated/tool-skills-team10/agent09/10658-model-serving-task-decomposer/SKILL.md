---
name: model-serving-task-decomposer
description: Use when tasks require model serving task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Task Decomposer

## Purpose
Design and execute model serving workflows using task decomposer controls with validated outcomes.
