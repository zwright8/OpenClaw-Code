---
name: biometric-systems-dependency-resolver
description: Use when tasks require biometric systems dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Dependency Resolver

## Purpose
Design and execute biometric systems workflows using dependency resolver controls with validated outcomes.
