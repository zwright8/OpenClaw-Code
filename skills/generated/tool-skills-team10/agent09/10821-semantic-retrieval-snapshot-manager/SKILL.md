---
name: semantic-retrieval-snapshot-manager
description: Use when tasks require semantic retrieval snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Snapshot Manager

## Purpose
Design and execute semantic retrieval workflows using snapshot manager controls with validated outcomes.
