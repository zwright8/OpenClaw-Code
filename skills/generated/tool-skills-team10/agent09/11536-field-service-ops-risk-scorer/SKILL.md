---
name: field-service-ops-risk-scorer
description: Use when tasks require field service ops risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Risk Scorer

## Purpose
Design and execute field service ops workflows using risk scorer controls with validated outcomes.
