---
name: churn-prevention-cost-attribution
description: Use when tasks require churn prevention cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Cost Attribution

## Purpose
Design and execute churn prevention workflows using cost attribution controls with validated outcomes.
