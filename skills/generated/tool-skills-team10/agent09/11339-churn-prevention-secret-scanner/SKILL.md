---
name: churn-prevention-secret-scanner
description: Use when tasks require churn prevention secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Secret Scanner

## Purpose
Design and execute churn prevention workflows using secret scanner controls with validated outcomes.
