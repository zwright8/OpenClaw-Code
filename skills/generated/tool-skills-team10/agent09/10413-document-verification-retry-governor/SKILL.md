---
name: document-verification-retry-governor
description: Use when tasks require document verification retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Retry Governor

## Purpose
Design and execute document verification workflows using retry governor controls with validated outcomes.
