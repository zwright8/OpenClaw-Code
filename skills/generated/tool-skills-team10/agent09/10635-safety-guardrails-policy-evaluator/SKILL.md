---
name: safety-guardrails-policy-evaluator
description: Use when tasks require safety guardrails policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Policy Evaluator

## Purpose
Design and execute safety guardrails workflows using policy evaluator controls with validated outcomes.
