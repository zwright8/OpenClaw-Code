---
name: evaluation-harnesses-job-scheduler
description: Use when tasks require evaluation harnesses job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Job Scheduler

## Purpose
Design and execute evaluation harnesses workflows using job scheduler controls with validated outcomes.
