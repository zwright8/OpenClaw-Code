---
name: inference-caches-migration-planner
description: Use when tasks require inference caches migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inference Caches Migration Planner

## Purpose
Design and execute inference caches workflows using migration planner controls with validated outcomes.
