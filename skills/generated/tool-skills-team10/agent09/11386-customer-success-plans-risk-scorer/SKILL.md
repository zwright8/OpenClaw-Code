---
name: customer-success-plans-risk-scorer
description: Use when tasks require customer success plans risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Risk Scorer

## Purpose
Design and execute customer success plans workflows using risk scorer controls with validated outcomes.
