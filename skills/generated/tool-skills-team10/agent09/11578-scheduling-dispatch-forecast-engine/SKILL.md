---
name: scheduling-dispatch-forecast-engine
description: Use when tasks require scheduling dispatch forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Forecast Engine

## Purpose
Design and execute scheduling dispatch workflows using forecast engine controls with validated outcomes.
