---
name: channel-operations-approval-orchestrator
description: Use when tasks require channel operations approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Approval Orchestrator

## Purpose
Design and execute channel operations workflows using approval orchestrator controls with validated outcomes.
