---
name: evaluation-harnesses-capacity-planner
description: Use when tasks require evaluation harnesses capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Capacity Planner

## Purpose
Design and execute evaluation harnesses workflows using capacity planner controls with validated outcomes.
