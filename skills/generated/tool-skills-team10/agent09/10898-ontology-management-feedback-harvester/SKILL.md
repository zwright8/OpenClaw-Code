---
name: ontology-management-feedback-harvester
description: Use when tasks require ontology management feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Feedback Harvester

## Purpose
Design and execute ontology management workflows using feedback harvester controls with validated outcomes.
