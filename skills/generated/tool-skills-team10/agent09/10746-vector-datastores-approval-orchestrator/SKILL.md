---
name: vector-datastores-approval-orchestrator
description: Use when tasks require vector datastores approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Approval Orchestrator

## Purpose
Design and execute vector datastores workflows using approval orchestrator controls with validated outcomes.
