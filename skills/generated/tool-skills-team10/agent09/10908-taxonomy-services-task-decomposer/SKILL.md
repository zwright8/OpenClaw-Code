---
name: taxonomy-services-task-decomposer
description: Use when tasks require taxonomy services task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Task Decomposer

## Purpose
Design and execute taxonomy services workflows using task decomposer controls with validated outcomes.
