---
name: model-serving-dependency-resolver
description: Use when tasks require model serving dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Dependency Resolver

## Purpose
Design and execute model serving workflows using dependency resolver controls with validated outcomes.
