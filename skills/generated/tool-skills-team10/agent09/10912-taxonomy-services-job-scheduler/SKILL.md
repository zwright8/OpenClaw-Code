---
name: taxonomy-services-job-scheduler
description: Use when tasks require taxonomy services job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Job Scheduler

## Purpose
Design and execute taxonomy services workflows using job scheduler controls with validated outcomes.
