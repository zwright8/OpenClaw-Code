---
name: reference-programs-latency-analyzer
description: Use when tasks require reference programs latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Latency Analyzer

## Purpose
Design and execute reference programs workflows using latency analyzer controls with validated outcomes.
