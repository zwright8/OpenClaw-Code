---
name: semantic-retrieval-incident-triage
description: Use when tasks require semantic retrieval incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Incident Triage

## Purpose
Design and execute semantic retrieval workflows using incident triage controls with validated outcomes.
