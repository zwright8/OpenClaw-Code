---
name: qbr-automation-auth-broker
description: Use when tasks require qbr automation auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Auth Broker

## Purpose
Design and execute qbr automation workflows using auth broker controls with validated outcomes.
