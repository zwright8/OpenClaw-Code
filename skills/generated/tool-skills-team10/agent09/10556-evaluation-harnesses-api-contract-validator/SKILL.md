---
name: evaluation-harnesses-api-contract-validator
description: Use when tasks require evaluation harnesses api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses API Contract Validator

## Purpose
Design and execute evaluation harnesses workflows using api contract validator controls with validated outcomes.
...
- Domain: [Evaluation Harnesses](../../resources/domains/evaluation-harnesses.md)
