---
name: partner-integrations-runbook-composer
description: Use when tasks require partner integrations runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Runbook Composer

## Purpose
Design and execute partner integrations workflows using runbook composer controls with validated outcomes.
