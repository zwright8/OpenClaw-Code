---
name: safety-guardrails-execution-runner
description: Use when tasks require safety guardrails execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Execution Runner

## Purpose
Design and execute safety guardrails workflows using execution runner controls with validated outcomes.
