---
name: reference-programs-approval-orchestrator
description: Use when tasks require reference programs approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Approval Orchestrator

## Purpose
Design and execute reference programs workflows using approval orchestrator controls with validated outcomes.
