---
name: churn-prevention-permission-mapper
description: Use when tasks require churn prevention permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Permission Mapper

## Purpose
Design and execute churn prevention workflows using permission mapper controls with validated outcomes.
