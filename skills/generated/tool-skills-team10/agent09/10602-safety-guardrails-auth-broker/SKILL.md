---
name: safety-guardrails-auth-broker
description: Use when tasks require safety guardrails auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Auth Broker

## Purpose
Design and execute safety guardrails workflows using auth broker controls with validated outcomes.
