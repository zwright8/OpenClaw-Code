---
name: model-serving-feedback-harvester
description: Use when tasks require model serving feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Feedback Harvester

## Purpose
Design and execute model serving workflows using feedback harvester controls with validated outcomes.
