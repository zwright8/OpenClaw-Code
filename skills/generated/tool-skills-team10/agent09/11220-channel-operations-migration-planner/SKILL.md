---
name: channel-operations-migration-planner
description: Use when tasks require channel operations migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Migration Planner

## Purpose
Design and execute channel operations workflows using migration planner controls with validated outcomes.
