---
name: knowledge-graphs-postmortem-drafting
description: Use when tasks require knowledge graphs postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Postmortem Drafting

## Purpose
Design and execute knowledge graphs workflows using postmortem drafting controls with validated outcomes.
