---
name: churn-prevention-spec-drift-detector
description: Use when tasks require churn prevention spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Spec Drift Detector

## Purpose
Design and execute churn prevention workflows using spec drift detector controls with validated outcomes.
