---
name: channel-operations-postmortem-drafting
description: Use when tasks require channel operations postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Postmortem Drafting

## Purpose
Design and execute channel operations workflows using postmortem drafting controls with validated outcomes.
