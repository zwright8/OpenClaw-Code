---
name: reference-programs-human-handoff-router
description: Use when tasks require reference programs human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Human Handoff Router

## Purpose
Design and execute reference programs workflows using human handoff router controls with validated outcomes.
