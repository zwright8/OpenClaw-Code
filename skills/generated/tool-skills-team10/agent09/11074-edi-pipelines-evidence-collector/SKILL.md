---
name: edi-pipelines-evidence-collector
description: Use when tasks require edi pipelines evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Evidence Collector

## Purpose
Design and execute edi pipelines workflows using evidence collector controls with validated outcomes.
