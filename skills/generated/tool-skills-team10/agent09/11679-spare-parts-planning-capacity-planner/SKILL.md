---
name: spare-parts-planning-capacity-planner
description: Use when tasks require spare parts planning capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Spare Parts Planning Capacity Planner

## Purpose
Design and execute spare parts planning workflows using capacity planner controls with validated outcomes.
