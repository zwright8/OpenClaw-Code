---
name: ontology-management-task-decomposer
description: Use when tasks require ontology management task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Task Decomposer

## Purpose
Design and execute ontology management workflows using task decomposer controls with validated outcomes.
