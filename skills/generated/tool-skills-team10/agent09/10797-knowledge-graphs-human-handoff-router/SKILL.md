---
name: knowledge-graphs-human-handoff-router
description: Use when tasks require knowledge graphs human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Human Handoff Router

## Purpose
Design and execute knowledge graphs workflows using human handoff router controls with validated outcomes.
