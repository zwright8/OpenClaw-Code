---
name: biometric-systems-remediation-planner
description: Use when tasks require biometric systems remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Remediation Planner

## Purpose
Design and execute biometric systems workflows using remediation planner controls with validated outcomes.
