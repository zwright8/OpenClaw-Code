---
name: evaluation-harnesses-provenance-tracker
description: Use when tasks require evaluation harnesses provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Provenance Tracker

## Purpose
Design and execute evaluation harnesses workflows using provenance tracker controls with validated outcomes.
