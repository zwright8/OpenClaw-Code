---
name: edi-pipelines-approval-orchestrator
description: Use when tasks require edi pipelines approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Approval Orchestrator

## Purpose
Design and execute edi pipelines workflows using approval orchestrator controls with validated outcomes.
