---
name: channel-operations-capacity-planner
description: Use when tasks require channel operations capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Capacity Planner

## Purpose
Design and execute channel operations workflows using capacity planner controls with validated outcomes.
