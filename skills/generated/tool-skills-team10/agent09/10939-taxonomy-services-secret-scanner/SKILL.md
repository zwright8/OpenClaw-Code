---
name: taxonomy-services-secret-scanner
description: Use when tasks require taxonomy services secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Secret Scanner

## Purpose
Design and execute taxonomy services workflows using secret scanner controls with validated outcomes.
