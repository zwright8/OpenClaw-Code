---
name: customer-success-plans-execution-runner
description: Use when tasks require customer success plans execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Execution Runner

## Purpose
Design and execute customer success plans workflows using execution runner controls with validated outcomes.
