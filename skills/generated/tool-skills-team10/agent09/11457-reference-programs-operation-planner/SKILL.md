---
name: reference-programs-operation-planner
description: Use when tasks require reference programs operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Operation Planner

## Purpose
Design and execute reference programs workflows using operation planner controls with validated outcomes.
