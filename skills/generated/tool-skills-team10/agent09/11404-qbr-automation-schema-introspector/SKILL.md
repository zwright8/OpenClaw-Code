---
name: qbr-automation-schema-introspector
description: Use when tasks require qbr automation schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Schema Introspector

## Purpose
Design and execute qbr automation workflows using schema introspector controls with validated outcomes.
