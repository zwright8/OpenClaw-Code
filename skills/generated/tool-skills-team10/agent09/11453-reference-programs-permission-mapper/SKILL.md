---
name: reference-programs-permission-mapper
description: Use when tasks require reference programs permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Permission Mapper

## Purpose
Design and execute reference programs workflows using permission mapper controls with validated outcomes.
