---
name: safety-guardrails-secret-scanner
description: Use when tasks require safety guardrails secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Secret Scanner

## Purpose
Design and execute safety guardrails workflows using secret scanner controls with validated outcomes.
