---
name: reference-programs-conflict-resolver
description: Use when tasks require reference programs conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Conflict Resolver

## Purpose
Design and execute reference programs workflows using conflict resolver controls with validated outcomes.
