...
description: Use when tasks require scheduling dispatch postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Postmortem Drafting

## Purpose
Design and execute scheduling dispatch workflows using postmortem drafting controls with validated outcomes.
