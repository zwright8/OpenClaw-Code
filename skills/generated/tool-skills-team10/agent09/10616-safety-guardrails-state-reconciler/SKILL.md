---
name: safety-guardrails-state-reconciler
description: Use when tasks require safety guardrails state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails State Reconciler

## Purpose
Design and execute safety guardrails workflows using state reconciler controls with validated outcomes.
