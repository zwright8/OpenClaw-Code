---
name: reference-programs-capacity-planner
description: Use when tasks require reference programs capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Capacity Planner

## Purpose
Design and execute reference programs workflows using capacity planner controls with validated outcomes.
