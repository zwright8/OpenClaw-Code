---
name: vector-datastores-evidence-collector
description: Use when tasks require vector datastores evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Evidence Collector

## Purpose
Design and execute vector datastores workflows using evidence collector controls with validated outcomes.
