---
name: field-service-ops-human-handoff-router
description: Use when tasks require field service ops human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Human Handoff Router

## Purpose
Design and execute field service ops workflows using human handoff router controls with validated outcomes.
