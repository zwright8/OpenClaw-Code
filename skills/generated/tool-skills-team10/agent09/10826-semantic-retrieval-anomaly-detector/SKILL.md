---
name: semantic-retrieval-anomaly-detector
description: Use when tasks require semantic retrieval anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Anomaly Detector

## Purpose
Design and execute semantic retrieval workflows using anomaly detector controls with validated outcomes.
