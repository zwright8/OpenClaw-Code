---
name: channel-operations-spec-drift-detector
description: Use when tasks require channel operations spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Spec Drift Detector

## Purpose
Design and execute channel operations workflows using spec drift detector controls with validated outcomes.
