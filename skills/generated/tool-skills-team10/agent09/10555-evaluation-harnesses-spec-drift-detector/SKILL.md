---
name: evaluation-harnesses-spec-drift-detector
description: Use when tasks require evaluation harnesses spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Spec Drift Detector

## Purpose
Design and execute evaluation harnesses workflows using spec drift detector controls with validated outcomes.
