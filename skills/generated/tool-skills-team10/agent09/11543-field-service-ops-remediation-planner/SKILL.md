---
name: field-service-ops-remediation-planner
description: Use when tasks require field service ops remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Remediation Planner

## Purpose
Design and execute field service ops workflows using remediation planner controls with validated outcomes.
