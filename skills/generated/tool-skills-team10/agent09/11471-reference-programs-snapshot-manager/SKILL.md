---
name: reference-programs-snapshot-manager
description: Use when tasks require reference programs snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Snapshot Manager

## Purpose
Design and execute reference programs workflows using snapshot manager controls with validated outcomes.
