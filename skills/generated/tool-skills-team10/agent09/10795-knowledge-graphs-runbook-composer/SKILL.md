---
name: knowledge-graphs-runbook-composer
description: Use when tasks require knowledge graphs runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Runbook Composer

## Purpose
Design and execute knowledge graphs workflows using runbook composer controls with validated outcomes.
