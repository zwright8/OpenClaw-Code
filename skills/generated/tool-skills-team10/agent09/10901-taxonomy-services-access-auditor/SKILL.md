---
name: taxonomy-services-access-auditor
description: Use when tasks require taxonomy services access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Access Auditor

## Purpose
Design and execute taxonomy services workflows using access auditor controls with validated outcomes.
