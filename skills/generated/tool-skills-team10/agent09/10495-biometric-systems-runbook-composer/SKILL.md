---
name: biometric-systems-runbook-composer
description: Use when tasks require biometric systems runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Runbook Composer

## Purpose
Design and execute biometric systems workflows using runbook composer controls with validated outcomes.
