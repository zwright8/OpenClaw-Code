---
name: vector-datastores-workflow-compiler
description: Use when tasks require vector datastores workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Workflow Compiler

## Purpose
Design and execute vector datastores workflows using workflow compiler controls with validated outcomes.
