---
name: safety-guardrails-permission-mapper
description: Use when tasks require safety guardrails permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Permission Mapper

## Purpose
Design and execute safety guardrails workflows using permission mapper controls with validated outcomes.
