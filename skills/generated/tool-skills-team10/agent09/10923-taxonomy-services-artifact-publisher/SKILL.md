---
name: taxonomy-services-artifact-publisher
description: Use when tasks require taxonomy services artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Artifact Publisher

## Purpose
Design and execute taxonomy services workflows using artifact publisher controls with validated outcomes.
