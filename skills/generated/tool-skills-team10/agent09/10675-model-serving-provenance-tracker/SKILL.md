---
name: model-serving-provenance-tracker
description: Use when tasks require model serving provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Provenance Tracker

## Purpose
Design and execute model serving workflows using provenance tracker controls with validated outcomes.
