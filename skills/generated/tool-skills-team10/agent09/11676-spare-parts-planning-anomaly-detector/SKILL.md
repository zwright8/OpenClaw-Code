---
name: spare-parts-planning-anomaly-detector
description: Use when tasks require spare parts planning anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Spare Parts Planning Anomaly Detector

## Purpose
Design and execute spare parts planning workflows using anomaly detector controls with validated outcomes.
