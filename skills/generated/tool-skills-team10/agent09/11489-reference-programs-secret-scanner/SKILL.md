---
name: reference-programs-secret-scanner
description: Use when tasks require reference programs secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Secret Scanner

## Purpose
Design and execute reference programs workflows using secret scanner controls with validated outcomes.
