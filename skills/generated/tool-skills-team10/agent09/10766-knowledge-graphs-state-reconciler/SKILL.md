---
name: knowledge-graphs-state-reconciler
description: Use when tasks require knowledge graphs state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs State Reconciler

## Purpose
Design and execute knowledge graphs workflows using state reconciler controls with validated outcomes.
