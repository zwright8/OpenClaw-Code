---
name: evaluation-harnesses-snapshot-manager
description: Use when tasks require evaluation harnesses snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Snapshot Manager

## Purpose
Design and execute evaluation harnesses workflows using snapshot manager controls with validated outcomes.
