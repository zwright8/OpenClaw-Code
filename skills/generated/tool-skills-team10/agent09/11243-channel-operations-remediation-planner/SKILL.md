---
name: channel-operations-remediation-planner
description: Use when tasks require channel operations remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Remediation Planner

## Purpose
Design and execute channel operations workflows using remediation planner controls with validated outcomes.
