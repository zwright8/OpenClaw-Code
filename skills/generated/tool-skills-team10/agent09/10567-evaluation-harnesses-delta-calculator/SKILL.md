---
name: evaluation-harnesses-delta-calculator
description: Use when tasks require evaluation harnesses delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Delta Calculator

## Purpose
Design and execute evaluation harnesses workflows using delta calculator controls with validated outcomes.
