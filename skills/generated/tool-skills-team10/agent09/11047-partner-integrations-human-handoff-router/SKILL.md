---
name: partner-integrations-human-handoff-router
description: Use when tasks require partner integrations human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Human Handoff Router

## Purpose
Design and execute partner integrations workflows using human handoff router controls with validated outcomes.
