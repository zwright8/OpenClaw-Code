---
name: qbr-automation-retry-governor
description: Use when tasks require qbr automation retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Retry Governor

## Purpose
Design and execute qbr automation workflows using retry governor controls with validated outcomes.
