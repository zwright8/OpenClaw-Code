---
name: customer-success-plans-spec-drift-detector
description: Use when tasks require customer success plans spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Spec Drift Detector

## Purpose
Design and execute customer success plans workflows using spec drift detector controls with validated outcomes.
