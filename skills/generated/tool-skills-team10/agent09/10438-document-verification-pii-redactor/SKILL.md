---
name: document-verification-pii-redactor
description: Use when tasks require document verification pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification PII Redactor

## Purpose
Design and execute document verification workflows using pii redactor controls with validated outcomes.
