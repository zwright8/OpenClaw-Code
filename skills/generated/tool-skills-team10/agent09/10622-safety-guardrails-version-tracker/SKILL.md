---
name: safety-guardrails-version-tracker
description: Use when tasks require safety guardrails version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Version Tracker

## Purpose
Design and execute safety guardrails workflows using version tracker controls with validated outcomes.
