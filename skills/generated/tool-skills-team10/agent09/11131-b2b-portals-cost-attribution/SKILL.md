---
name: b2b-portals-cost-attribution
description: Use when tasks require b2b portals cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Cost Attribution

## Purpose
Design and execute b2b portals workflows using cost attribution controls with validated outcomes.
