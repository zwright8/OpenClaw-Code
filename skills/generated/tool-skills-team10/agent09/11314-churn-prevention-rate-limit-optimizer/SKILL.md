---
name: churn-prevention-rate-limit-optimizer
description: Use when tasks require churn prevention rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Rate Limit Optimizer

## Purpose
Design and execute churn prevention workflows using rate limit optimizer controls with validated outcomes.
