---
name: biometric-systems-human-handoff-router
description: Use when tasks require biometric systems human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Human Handoff Router

## Purpose
Design and execute biometric systems workflows using human handoff router controls with validated outcomes.
