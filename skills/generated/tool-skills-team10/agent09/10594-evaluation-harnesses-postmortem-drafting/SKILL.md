---
name: evaluation-harnesses-postmortem-drafting
description: Use when tasks require evaluation harnesses postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Postmortem Drafting

## Purpose
Design and execute evaluation harnesses workflows using postmortem drafting controls with validated outcomes.
