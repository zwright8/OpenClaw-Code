---
name: catalog-syndication-state-reconciler
description: Use when tasks require catalog syndication state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication State Reconciler

## Purpose
Design and execute catalog syndication workflows using state reconciler controls with validated outcomes.
