---
name: qbr-automation-compliance-mapper
description: Use when tasks require qbr automation compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Compliance Mapper

## Purpose
Design and execute qbr automation workflows using compliance mapper controls with validated outcomes.
