---
name: document-verification-approval-orchestrator
description: Use when tasks require document verification approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Approval Orchestrator

## Purpose
Design and execute document verification workflows using approval orchestrator controls with validated outcomes.
