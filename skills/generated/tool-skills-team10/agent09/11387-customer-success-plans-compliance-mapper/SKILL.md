---
name: customer-success-plans-compliance-mapper
description: Use when tasks require customer success plans compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Compliance Mapper

## Purpose
Design and execute customer success plans workflows using compliance mapper controls with validated outcomes.
