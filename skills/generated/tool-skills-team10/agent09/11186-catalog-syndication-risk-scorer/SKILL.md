---
name: catalog-syndication-risk-scorer
description: Use when tasks require catalog syndication risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Risk Scorer

## Purpose
Design and execute catalog syndication workflows using risk scorer controls with validated outcomes.
