---
name: b2b-portals-runbook-composer
description: Use when tasks require b2b portals runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Runbook Composer

## Purpose
Design and execute b2b portals workflows using runbook composer controls with validated outcomes.
