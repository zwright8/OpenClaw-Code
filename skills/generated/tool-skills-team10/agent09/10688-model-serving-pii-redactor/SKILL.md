---
name: model-serving-pii-redactor
description: Use when tasks require model serving pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving PII Redactor

## Purpose
Design and execute model serving workflows using pii redactor controls with validated outcomes.
