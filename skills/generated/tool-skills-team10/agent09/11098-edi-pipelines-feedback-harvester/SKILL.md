---
name: edi-pipelines-feedback-harvester
description: Use when tasks require edi pipelines feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Feedback Harvester

## Purpose
Design and execute edi pipelines workflows using feedback harvester controls with validated outcomes.
