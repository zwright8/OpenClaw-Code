---
name: scheduling-dispatch-capacity-planner
description: Use when tasks require scheduling dispatch capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Capacity Planner

## Purpose
Design and execute scheduling dispatch workflows using capacity planner controls with validated outcomes.
