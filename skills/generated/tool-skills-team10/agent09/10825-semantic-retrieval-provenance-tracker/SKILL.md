---
name: semantic-retrieval-provenance-tracker
description: Use when tasks require semantic retrieval provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Provenance Tracker

## Purpose
Design and execute semantic retrieval workflows using provenance tracker controls with validated outcomes.
