---
name: field-service-ops-quality-gatekeeper
description: Use when tasks require field service ops quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Quality Gatekeeper

## Purpose
Design and execute field service ops workflows using quality gatekeeper controls with validated outcomes.
