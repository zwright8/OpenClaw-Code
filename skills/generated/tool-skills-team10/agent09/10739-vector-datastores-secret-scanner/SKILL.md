---
name: vector-datastores-secret-scanner
description: Use when tasks require vector datastores secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Secret Scanner

## Purpose
Design and execute vector datastores workflows using secret scanner controls with validated outcomes.
