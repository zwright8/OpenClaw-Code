---
name: evaluation-harnesses-auth-broker
description: Use when tasks require evaluation harnesses auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Auth Broker

## Purpose
Design and execute evaluation harnesses workflows using auth broker controls with validated outcomes.
