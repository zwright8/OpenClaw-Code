---
name: qbr-automation-remediation-planner
description: Use when tasks require qbr automation remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Remediation Planner

## Purpose
Design and execute qbr automation workflows using remediation planner controls with validated outcomes.
