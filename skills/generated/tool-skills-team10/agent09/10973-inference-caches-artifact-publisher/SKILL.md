---
name: inference-caches-artifact-publisher
description: Use when tasks require inference caches artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Inference Caches Artifact Publisher

## Purpose
Design and execute inference caches workflows using artifact publisher controls with validated outcomes.
