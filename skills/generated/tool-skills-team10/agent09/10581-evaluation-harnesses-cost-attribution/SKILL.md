---
name: evaluation-harnesses-cost-attribution
description: Use when tasks require evaluation harnesses cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Cost Attribution

## Purpose
Design and execute evaluation harnesses workflows using cost attribution controls with validated outcomes.
