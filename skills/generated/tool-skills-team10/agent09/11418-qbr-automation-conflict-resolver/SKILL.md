---
name: qbr-automation-conflict-resolver
description: Use when tasks require qbr automation conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Conflict Resolver

## Purpose
Design and execute qbr automation workflows using conflict resolver controls with validated outcomes.
