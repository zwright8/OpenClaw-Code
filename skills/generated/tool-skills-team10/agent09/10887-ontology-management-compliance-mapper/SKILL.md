---
name: ontology-management-compliance-mapper
description: Use when tasks require ontology management compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Compliance Mapper

## Purpose
Design and execute ontology management workflows using compliance mapper controls with validated outcomes.
