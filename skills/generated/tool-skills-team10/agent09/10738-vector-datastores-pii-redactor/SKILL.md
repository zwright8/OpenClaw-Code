---
name: vector-datastores-pii-redactor
description: Use when tasks require vector datastores pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores PII Redactor

## Purpose
Design and execute vector datastores workflows using pii redactor controls with validated outcomes.
