---
name: reference-programs-evidence-collector
description: Use when tasks require reference programs evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Evidence Collector

## Purpose
Design and execute reference programs workflows using evidence collector controls with validated outcomes.
