---
name: b2b-portals-anomaly-detector
description: Use when tasks require b2b portals anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Anomaly Detector

## Purpose
Design and execute b2b portals workflows using anomaly detector controls with validated outcomes.
