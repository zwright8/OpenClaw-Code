---
name: vector-datastores-feedback-harvester
description: Use when tasks require vector datastores feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Feedback Harvester

## Purpose
Design and execute vector datastores workflows using feedback harvester controls with validated outcomes.
