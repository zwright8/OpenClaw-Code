---
name: field-service-ops-task-decomposer
description: Use when tasks require field service ops task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Task Decomposer

## Purpose
Design and execute field service ops workflows using task decomposer controls with validated outcomes.
