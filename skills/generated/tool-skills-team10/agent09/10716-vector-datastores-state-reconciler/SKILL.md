---
name: vector-datastores-state-reconciler
description: Use when tasks require vector datastores state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores State Reconciler

## Purpose
Design and execute vector datastores workflows using state reconciler controls with validated outcomes.
