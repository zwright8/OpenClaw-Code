---
name: qbr-automation-permission-mapper
description: Use when tasks require qbr automation permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Permission Mapper

## Purpose
Design and execute qbr automation workflows using permission mapper controls with validated outcomes.
