---
name: biometric-systems-pii-redactor
description: Use when tasks require biometric systems pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems PII Redactor

## Purpose
Design and execute biometric systems workflows using pii redactor controls with validated outcomes.
