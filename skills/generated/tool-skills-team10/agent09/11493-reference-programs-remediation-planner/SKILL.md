---
name: reference-programs-remediation-planner
description: Use when tasks require reference programs remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Remediation Planner

## Purpose
Design and execute reference programs workflows using remediation planner controls with validated outcomes.
