---
name: qbr-automation-rate-limit-optimizer
description: Use when tasks require qbr automation rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Rate Limit Optimizer

## Purpose
Design and execute qbr automation workflows using rate limit optimizer controls with validated outcomes.
