---
name: qbr-automation-postmortem-drafting
description: Use when tasks require qbr automation postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Postmortem Drafting

## Purpose
Design and execute qbr automation workflows using postmortem drafting controls with validated outcomes.
