---
name: scheduling-dispatch-policy-evaluator
description: Use when tasks require scheduling dispatch policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Policy Evaluator

## Purpose
Design and execute scheduling dispatch workflows using policy evaluator controls with validated outcomes.
