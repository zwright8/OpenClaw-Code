---
name: biometric-systems-auth-broker
description: Use when tasks require biometric systems auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Auth Broker

## Purpose
Design and execute biometric systems workflows using auth broker controls with validated outcomes.
