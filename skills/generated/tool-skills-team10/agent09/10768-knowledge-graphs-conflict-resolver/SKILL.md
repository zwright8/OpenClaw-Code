---
name: knowledge-graphs-conflict-resolver
description: Use when tasks require knowledge graphs conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Conflict Resolver

## Purpose
Design and execute knowledge graphs workflows using conflict resolver controls with validated outcomes.
