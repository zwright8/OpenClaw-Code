---
name: safety-guardrails-spec-drift-detector
description: Use when tasks require safety guardrails spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Spec Drift Detector

## Purpose
Design and execute safety guardrails workflows using spec drift detector controls with validated outcomes.
