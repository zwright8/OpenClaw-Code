---
name: reference-programs-risk-scorer
description: Use when tasks require reference programs risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Risk Scorer

## Purpose
Design and execute reference programs workflows using risk scorer controls with validated outcomes.
