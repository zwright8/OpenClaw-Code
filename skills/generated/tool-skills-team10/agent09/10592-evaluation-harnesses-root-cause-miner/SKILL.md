---
name: evaluation-harnesses-root-cause-miner
description: Use when tasks require evaluation harnesses root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Root Cause Miner

## Purpose
Design and execute evaluation harnesses workflows using root cause miner controls with validated outcomes.
