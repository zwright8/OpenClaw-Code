---
name: taxonomy-services-forecast-engine
description: Use when tasks require taxonomy services forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Forecast Engine

## Purpose
Design and execute taxonomy services workflows using forecast engine controls with validated outcomes.
