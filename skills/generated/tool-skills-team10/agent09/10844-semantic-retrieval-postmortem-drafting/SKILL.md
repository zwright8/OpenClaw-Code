---
name: semantic-retrieval-postmortem-drafting
description: Use when tasks require semantic retrieval postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Postmortem Drafting

## Purpose
Design and execute semantic retrieval workflows using postmortem drafting controls with validated outcomes.
