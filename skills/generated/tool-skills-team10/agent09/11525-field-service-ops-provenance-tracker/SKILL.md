---
name: field-service-ops-provenance-tracker
description: Use when tasks require field service ops provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Provenance Tracker

## Purpose
Design and execute field service ops workflows using provenance tracker controls with validated outcomes.
