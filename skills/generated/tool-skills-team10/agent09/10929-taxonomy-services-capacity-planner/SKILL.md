---
name: taxonomy-services-capacity-planner
description: Use when tasks require taxonomy services capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Capacity Planner

## Purpose
Design and execute taxonomy services workflows using capacity planner controls with validated outcomes.
