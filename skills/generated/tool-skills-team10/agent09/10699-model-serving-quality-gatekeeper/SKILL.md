---
name: model-serving-quality-gatekeeper
description: Use when tasks require model serving quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Quality Gatekeeper

## Purpose
Design and execute model serving workflows using quality gatekeeper controls with validated outcomes.
