---
name: evaluation-harnesses-task-decomposer
description: Use when tasks require evaluation harnesses task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Task Decomposer

## Purpose
Design and execute evaluation harnesses workflows using task decomposer controls with validated outcomes.
