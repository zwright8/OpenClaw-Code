---
name: spare-parts-planning-spec-drift-detector
description: Use when tasks require spare parts planning spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Spare Parts Planning Spec Drift Detector

## Purpose
Design and execute spare parts planning workflows using spec drift detector controls with validated outcomes.
