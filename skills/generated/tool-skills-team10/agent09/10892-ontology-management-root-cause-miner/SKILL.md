---
name: ontology-management-root-cause-miner
description: Use when tasks require ontology management root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Root Cause Miner

## Purpose
Design and execute ontology management workflows using root cause miner controls with validated outcomes.
