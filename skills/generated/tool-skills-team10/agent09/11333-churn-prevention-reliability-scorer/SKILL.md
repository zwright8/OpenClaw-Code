---
name: churn-prevention-reliability-scorer
description: Use when tasks require churn prevention reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Reliability Scorer

## Purpose
Design and execute churn prevention workflows using reliability scorer controls with validated outcomes.
