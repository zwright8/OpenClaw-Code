---
name: ontology-management-risk-scorer
description: Use when tasks require ontology management risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Risk Scorer

## Purpose
Design and execute ontology management workflows using risk scorer controls with validated outcomes.
