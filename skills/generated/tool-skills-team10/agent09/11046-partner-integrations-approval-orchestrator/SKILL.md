---
name: partner-integrations-approval-orchestrator
description: Use when tasks require partner integrations approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Approval Orchestrator

## Purpose
Design and execute partner integrations workflows using approval orchestrator controls with validated outcomes.
