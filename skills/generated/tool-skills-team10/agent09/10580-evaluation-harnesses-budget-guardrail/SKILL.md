---
name: evaluation-harnesses-budget-guardrail
description: Use when tasks require evaluation harnesses budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Budget Guardrail

## Purpose
Design and execute evaluation harnesses workflows using budget guardrail controls with validated outcomes.
