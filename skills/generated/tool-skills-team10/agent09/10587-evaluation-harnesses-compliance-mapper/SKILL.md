---
name: evaluation-harnesses-compliance-mapper
description: Use when tasks require evaluation harnesses compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Compliance Mapper

## Purpose
Design and execute evaluation harnesses workflows using compliance mapper controls with validated outcomes.
