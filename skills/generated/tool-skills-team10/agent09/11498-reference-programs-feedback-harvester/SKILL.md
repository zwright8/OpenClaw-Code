---
name: reference-programs-feedback-harvester
description: Use when tasks require reference programs feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Feedback Harvester

## Purpose
Design and execute reference programs workflows using feedback harvester controls with validated outcomes.
