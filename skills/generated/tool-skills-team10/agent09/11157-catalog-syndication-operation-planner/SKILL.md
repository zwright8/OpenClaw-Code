---
name: catalog-syndication-operation-planner
description: Use when tasks require catalog syndication operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Operation Planner

## Purpose
Design and execute catalog syndication workflows using operation planner controls with validated outcomes.
