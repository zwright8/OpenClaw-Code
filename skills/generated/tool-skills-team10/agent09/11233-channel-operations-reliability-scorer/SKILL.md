---
name: channel-operations-reliability-scorer
description: Use when tasks require channel operations reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Reliability Scorer

## Purpose
Design and execute channel operations workflows using reliability scorer controls with validated outcomes.
