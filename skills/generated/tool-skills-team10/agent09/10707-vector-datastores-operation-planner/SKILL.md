---
name: vector-datastores-operation-planner
description: Use when tasks require vector datastores operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Operation Planner

## Purpose
Design and execute vector datastores workflows using operation planner controls with validated outcomes.
