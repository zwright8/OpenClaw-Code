---
name: qbr-automation-dependency-resolver
description: Use when tasks require qbr automation dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Dependency Resolver

## Purpose
Design and execute qbr automation workflows using dependency resolver controls with validated outcomes.
