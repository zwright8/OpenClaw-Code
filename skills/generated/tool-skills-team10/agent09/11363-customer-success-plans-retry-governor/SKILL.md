---
name: customer-success-plans-retry-governor
description: Use when tasks require customer success plans retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Retry Governor

## Purpose
Design and execute customer success plans workflows using retry governor controls with validated outcomes.
