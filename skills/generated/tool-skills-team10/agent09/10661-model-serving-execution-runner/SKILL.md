---
name: model-serving-execution-runner
description: Use when tasks require model serving execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Execution Runner

## Purpose
Design and execute model serving workflows using execution runner controls with validated outcomes.
