---
name: biometric-systems-permission-mapper
description: Use when tasks require biometric systems permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Permission Mapper

## Purpose
Design and execute biometric systems workflows using permission mapper controls with validated outcomes.
