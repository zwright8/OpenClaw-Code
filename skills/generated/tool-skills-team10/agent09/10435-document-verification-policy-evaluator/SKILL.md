---
name: document-verification-policy-evaluator
description: Use when tasks require document verification policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Policy Evaluator

## Purpose
Design and execute document verification workflows using policy evaluator controls with validated outcomes.
