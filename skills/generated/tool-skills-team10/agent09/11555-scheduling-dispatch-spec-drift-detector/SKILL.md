---
name: scheduling-dispatch-spec-drift-detector
description: Use when tasks require scheduling dispatch spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Spec Drift Detector

## Purpose
Design and execute scheduling dispatch workflows using spec drift detector controls with validated outcomes.
