---
name: safety-guardrails-compliance-mapper
description: Use when tasks require safety guardrails compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Compliance Mapper

## Purpose
Design and execute safety guardrails workflows using compliance mapper controls with validated outcomes.
