---
name: channel-operations-evidence-collector
description: Use when tasks require channel operations evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Evidence Collector

## Purpose
Design and execute channel operations workflows using evidence collector controls with validated outcomes.
