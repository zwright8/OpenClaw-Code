---
name: vector-datastores-runbook-composer
description: Use when tasks require vector datastores runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Runbook Composer

## Purpose
Design and execute vector datastores workflows using runbook composer controls with validated outcomes.
