---
name: evaluation-harnesses-anomaly-detector
description: Use when tasks require evaluation harnesses anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Anomaly Detector

## Purpose
Design and execute evaluation harnesses workflows using anomaly detector controls with validated outcomes.
