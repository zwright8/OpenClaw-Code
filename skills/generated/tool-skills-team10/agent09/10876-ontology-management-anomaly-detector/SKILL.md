---
name: ontology-management-anomaly-detector
description: Use when tasks require ontology management anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Anomaly Detector

## Purpose
Design and execute ontology management workflows using anomaly detector controls with validated outcomes.
