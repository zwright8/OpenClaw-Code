---
name: work-order-systems-evidence-collector
description: Use when tasks require work order systems evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Evidence Collector

## Purpose
Design and execute work order systems workflows using evidence collector controls with validated outcomes.
