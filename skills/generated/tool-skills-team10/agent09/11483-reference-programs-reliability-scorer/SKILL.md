---
name: reference-programs-reliability-scorer
description: Use when tasks require reference programs reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Reliability Scorer

## Purpose
Design and execute reference programs workflows using reliability scorer controls with validated outcomes.
