---
name: channel-operations-artifact-publisher
description: Use when tasks require channel operations artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Artifact Publisher

## Purpose
Design and execute channel operations workflows using artifact publisher controls with validated outcomes.
