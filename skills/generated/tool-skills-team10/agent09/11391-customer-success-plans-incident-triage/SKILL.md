---
name: customer-success-plans-incident-triage
description: Use when tasks require customer success plans incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Incident Triage

## Purpose
Design and execute customer success plans workflows using incident triage controls with validated outcomes.
