---
name: vector-datastores-snapshot-manager
description: Use when tasks require vector datastores snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Snapshot Manager

## Purpose
Design and execute vector datastores workflows using snapshot manager controls with validated outcomes.
