---
name: knowledge-graphs-anomaly-detector
description: Use when tasks require knowledge graphs anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Graphs Anomaly Detector

## Purpose
Design and execute knowledge graphs workflows using anomaly detector controls with validated outcomes.
