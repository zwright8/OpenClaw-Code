---
name: b2b-portals-execution-runner
description: Use when tasks require b2b portals execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Execution Runner

## Purpose
Design and execute b2b portals workflows using execution runner controls with validated outcomes.
