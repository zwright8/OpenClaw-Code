---
name: churn-prevention-workflow-compiler
description: Use when tasks require churn prevention workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Workflow Compiler

## Purpose
Design and execute churn prevention workflows using workflow compiler controls with validated outcomes.
