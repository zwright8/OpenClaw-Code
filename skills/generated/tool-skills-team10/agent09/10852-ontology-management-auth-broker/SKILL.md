---
name: ontology-management-auth-broker
description: Use when tasks require ontology management auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Auth Broker

## Purpose
Design and execute ontology management workflows using auth broker controls with validated outcomes.
