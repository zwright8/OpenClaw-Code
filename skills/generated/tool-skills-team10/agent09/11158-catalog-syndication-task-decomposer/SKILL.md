---
name: catalog-syndication-task-decomposer
description: Use when tasks require catalog syndication task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Task Decomposer

## Purpose
Design and execute catalog syndication workflows using task decomposer controls with validated outcomes.
