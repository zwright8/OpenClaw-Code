---
name: field-service-ops-reliability-scorer
description: Use when tasks require field service ops reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Reliability Scorer

## Purpose
Design and execute field service ops workflows using reliability scorer controls with validated outcomes.
