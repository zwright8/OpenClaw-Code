---
name: document-verification-quality-gatekeeper
description: Use when tasks require document verification quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Quality Gatekeeper

## Purpose
Design and execute document verification workflows using quality gatekeeper controls with validated outcomes.
