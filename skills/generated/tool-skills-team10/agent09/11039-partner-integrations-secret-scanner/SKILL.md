---
name: partner-integrations-secret-scanner
description: Use when tasks require partner integrations secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Secret Scanner

## Purpose
Design and execute partner integrations workflows using secret scanner controls with validated outcomes.
