---
name: vector-datastores-anomaly-detector
description: Use when tasks require vector datastores anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Anomaly Detector

## Purpose
Design and execute vector datastores workflows using anomaly detector controls with validated outcomes.
