---
name: b2b-portals-auth-broker
description: Use when tasks require b2b portals auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Auth Broker

## Purpose
Design and execute b2b portals workflows using auth broker controls with validated outcomes.
