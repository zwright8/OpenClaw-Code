---
name: vector-datastores-permission-mapper
description: Use when tasks require vector datastores permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Permission Mapper

## Purpose
Design and execute vector datastores workflows using permission mapper controls with validated outcomes.
