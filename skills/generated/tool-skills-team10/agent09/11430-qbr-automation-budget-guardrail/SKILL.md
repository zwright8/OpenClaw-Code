---
name: qbr-automation-budget-guardrail
description: Use when tasks require qbr automation budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Budget Guardrail

## Purpose
Design and execute qbr automation workflows using budget guardrail controls with validated outcomes.
