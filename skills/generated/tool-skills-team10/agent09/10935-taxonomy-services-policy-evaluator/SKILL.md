---
name: taxonomy-services-policy-evaluator
description: Use when tasks require taxonomy services policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Policy Evaluator

## Purpose
Design and execute taxonomy services workflows using policy evaluator controls with validated outcomes.
