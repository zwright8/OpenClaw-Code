---
name: evaluation-harnesses-quality-gatekeeper
description: Use when tasks require evaluation harnesses quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Quality Gatekeeper

## Purpose
Design and execute evaluation harnesses workflows using quality gatekeeper controls with validated outcomes.
