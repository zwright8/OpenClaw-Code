---
name: edi-pipelines-quality-gatekeeper
description: Use when tasks require edi pipelines quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Quality Gatekeeper

## Purpose
Design and execute edi pipelines workflows using quality gatekeeper controls with validated outcomes.
