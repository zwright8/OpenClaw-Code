---
name: catalog-syndication-compliance-mapper
description: Use when tasks require catalog syndication compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Compliance Mapper

## Purpose
Design and execute catalog syndication workflows using compliance mapper controls with validated outcomes.
