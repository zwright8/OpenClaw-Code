---
name: scheduling-dispatch-feedback-harvester
description: Use when tasks require scheduling dispatch feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Feedback Harvester

## Purpose
Design and execute scheduling dispatch workflows using feedback harvester controls with validated outcomes.
