---
name: b2b-portals-human-handoff-router
description: Use when tasks require b2b portals human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Human Handoff Router

## Purpose
Design and execute b2b portals workflows using human handoff router controls with validated outcomes.
