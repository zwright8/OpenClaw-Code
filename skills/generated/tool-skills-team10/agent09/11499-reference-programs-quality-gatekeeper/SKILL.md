---
name: reference-programs-quality-gatekeeper
description: Use when tasks require reference programs quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Quality Gatekeeper

## Purpose
Design and execute reference programs workflows using quality gatekeeper controls with validated outcomes.
