---
name: evaluation-harnesses-pii-redactor
description: Use when tasks require evaluation harnesses pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses PII Redactor

## Purpose
Design and execute evaluation harnesses workflows using pii redactor controls with validated outcomes.
