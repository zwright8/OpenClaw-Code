---
name: evaluation-harnesses-outcome-synthesizer
description: Use when tasks require evaluation harnesses outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Outcome Synthesizer

## Purpose
Design and execute evaluation harnesses workflows using outcome synthesizer controls with validated outcomes.
