---
name: ontology-management-secret-scanner
description: Use when tasks require ontology management secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Secret Scanner

## Purpose
Design and execute ontology management workflows using secret scanner controls with validated outcomes.
