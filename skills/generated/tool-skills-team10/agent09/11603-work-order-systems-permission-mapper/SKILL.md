---
name: work-order-systems-permission-mapper
description: Use when tasks require work order systems permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Permission Mapper

## Purpose
Design and execute work order systems workflows using permission mapper controls with validated outcomes.
