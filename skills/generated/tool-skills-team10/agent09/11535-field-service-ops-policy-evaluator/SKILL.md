---
name: field-service-ops-policy-evaluator
description: Use when tasks require field service ops policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Policy Evaluator

## Purpose
Design and execute field service ops workflows using policy evaluator controls with validated outcomes.
