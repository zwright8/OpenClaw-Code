---
name: document-verification-feedback-harvester
description: Use when tasks require document verification feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document Verification Feedback Harvester

## Purpose
Design and execute document verification workflows using feedback harvester controls with validated outcomes.
