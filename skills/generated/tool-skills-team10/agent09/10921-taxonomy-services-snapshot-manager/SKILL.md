---
name: taxonomy-services-snapshot-manager
description: Use when tasks require taxonomy services snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Snapshot Manager

## Purpose
Design and execute taxonomy services workflows using snapshot manager controls with validated outcomes.
