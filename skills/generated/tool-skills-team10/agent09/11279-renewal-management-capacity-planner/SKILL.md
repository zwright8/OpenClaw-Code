---
name: renewal-management-capacity-planner
description: Use when tasks require renewal management capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Renewal Management Capacity Planner

## Purpose
Design and execute renewal management workflows using capacity planner controls with validated outcomes.
