---
name: model-serving-anomaly-detector
description: Use when tasks require model serving anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Anomaly Detector

## Purpose
Design and execute model serving workflows using anomaly detector controls with validated outcomes.
