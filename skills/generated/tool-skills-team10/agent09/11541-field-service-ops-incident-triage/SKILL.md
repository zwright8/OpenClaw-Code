---
name: field-service-ops-incident-triage
description: Use when tasks require field service ops incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Incident Triage

## Purpose
Design and execute field service ops workflows using incident triage controls with validated outcomes.
