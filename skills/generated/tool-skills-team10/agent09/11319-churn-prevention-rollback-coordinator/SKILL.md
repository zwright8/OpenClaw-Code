---
name: churn-prevention-rollback-coordinator
description: Use when tasks require churn prevention rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Rollback Coordinator

## Purpose
Design and execute churn prevention workflows using rollback coordinator controls with validated outcomes.
