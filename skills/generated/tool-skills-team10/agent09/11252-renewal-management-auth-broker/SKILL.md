---
name: renewal-management-auth-broker
description: Use when tasks require renewal management auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Renewal Management Auth Broker

## Purpose
Design and execute renewal management workflows using auth broker controls with validated outcomes.
