---
name: edi-pipelines-permission-mapper
description: Use when tasks require edi pipelines permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Permission Mapper

## Purpose
Design and execute edi pipelines workflows using permission mapper controls with validated outcomes.
