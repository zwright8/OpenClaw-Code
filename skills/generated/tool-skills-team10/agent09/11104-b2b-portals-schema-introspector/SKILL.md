---
name: b2b-portals-schema-introspector
description: Use when tasks require b2b portals schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Schema Introspector

## Purpose
Design and execute b2b portals workflows using schema introspector controls with validated outcomes.
