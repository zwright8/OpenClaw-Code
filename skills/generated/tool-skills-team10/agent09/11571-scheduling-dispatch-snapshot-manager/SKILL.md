---
name: scheduling-dispatch-snapshot-manager
description: Use when tasks require scheduling dispatch snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Snapshot Manager

## Purpose
Design and execute scheduling dispatch workflows using snapshot manager controls with validated outcomes.
