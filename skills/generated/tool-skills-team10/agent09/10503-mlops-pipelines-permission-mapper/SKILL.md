---
name: mlops-pipelines-permission-mapper
description: Use when tasks require mlops pipelines permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# MLOps Pipelines Permission Mapper

## Purpose
Design and execute mlops pipelines workflows using permission mapper controls with validated outcomes.
