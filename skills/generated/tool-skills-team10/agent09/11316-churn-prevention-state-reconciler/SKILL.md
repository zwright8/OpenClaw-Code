---
name: churn-prevention-state-reconciler
description: Use when tasks require churn prevention state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention State Reconciler

## Purpose
Design and execute churn prevention workflows using state reconciler controls with validated outcomes.
