---
name: customer-success-plans-forecast-engine
description: Use when tasks require customer success plans forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Forecast Engine

## Purpose
Design and execute customer success plans workflows using forecast engine controls with validated outcomes.
