---
name: model-serving-root-cause-miner
description: Use when tasks require model serving root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Root Cause Miner

## Purpose
Design and execute model serving workflows using root cause miner controls with validated outcomes.
