---
name: evaluation-harnesses-threshold-alerting
description: Use when tasks require evaluation harnesses threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Threshold Alerting

## Purpose
Design and execute evaluation harnesses workflows using threshold alerting controls with validated outcomes.
