---
name: b2b-portals-risk-scorer
description: Use when tasks require b2b portals risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Risk Scorer

## Purpose
Design and execute b2b portals workflows using risk scorer controls with validated outcomes.
