---
name: ontology-management-evidence-collector
description: Use when tasks require ontology management evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ontology Management Evidence Collector

## Purpose
Design and execute ontology management workflows using evidence collector controls with validated outcomes.
