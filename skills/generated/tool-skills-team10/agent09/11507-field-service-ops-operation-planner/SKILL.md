---
name: field-service-ops-operation-planner
description: Use when tasks require field service ops operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Operation Planner

## Purpose
Design and execute field service ops workflows using operation planner controls with validated outcomes.
