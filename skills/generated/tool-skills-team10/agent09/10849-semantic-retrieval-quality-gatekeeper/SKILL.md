---
name: semantic-retrieval-quality-gatekeeper
description: Use when tasks require semantic retrieval quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Quality Gatekeeper

## Purpose
Design and execute semantic retrieval workflows using quality gatekeeper controls with validated outcomes.
