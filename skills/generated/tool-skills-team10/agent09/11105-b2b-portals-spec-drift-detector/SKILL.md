---
name: b2b-portals-spec-drift-detector
description: Use when tasks require b2b portals spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Spec Drift Detector

## Purpose
Design and execute b2b portals workflows using spec drift detector controls with validated outcomes.
