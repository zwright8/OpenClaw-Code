---
name: scheduling-dispatch-anomaly-detector
description: Use when tasks require scheduling dispatch anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Anomaly Detector

## Purpose
Design and execute scheduling dispatch workflows using anomaly detector controls with validated outcomes.
