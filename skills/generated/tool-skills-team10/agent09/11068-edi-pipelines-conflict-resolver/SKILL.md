---
name: edi-pipelines-conflict-resolver
description: Use when tasks require edi pipelines conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Conflict Resolver

## Purpose
Design and execute edi pipelines workflows using conflict resolver controls with validated outcomes.
