---
name: safety-guardrails-pii-redactor
description: Use when tasks require safety guardrails pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails PII Redactor

## Purpose
Design and execute safety guardrails workflows using pii redactor controls with validated outcomes.
