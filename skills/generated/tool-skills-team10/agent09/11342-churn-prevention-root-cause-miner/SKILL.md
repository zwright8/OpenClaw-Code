---
name: churn-prevention-root-cause-miner
description: Use when tasks require churn prevention root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Root Cause Miner

## Purpose
Design and execute churn prevention workflows using root cause miner controls with validated outcomes.
