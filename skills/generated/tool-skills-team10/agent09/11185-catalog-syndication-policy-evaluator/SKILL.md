---
name: catalog-syndication-policy-evaluator
description: Use when tasks require catalog syndication policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Policy Evaluator

## Purpose
Design and execute catalog syndication workflows using policy evaluator controls with validated outcomes.
