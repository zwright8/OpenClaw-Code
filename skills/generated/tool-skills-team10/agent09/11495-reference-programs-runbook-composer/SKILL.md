---
name: reference-programs-runbook-composer
description: Use when tasks require reference programs runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Runbook Composer

## Purpose
Design and execute reference programs workflows using runbook composer controls with validated outcomes.
