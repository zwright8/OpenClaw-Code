---
name: semantic-retrieval-feedback-harvester
description: Use when tasks require semantic retrieval feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Feedback Harvester

## Purpose
Design and execute semantic retrieval workflows using feedback harvester controls with validated outcomes.
