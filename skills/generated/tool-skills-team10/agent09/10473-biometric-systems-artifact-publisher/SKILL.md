---
name: biometric-systems-artifact-publisher
description: Use when tasks require biometric systems artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Artifact Publisher

## Purpose
Design and execute biometric systems workflows using artifact publisher controls with validated outcomes.
