---
name: catalog-syndication-approval-orchestrator
description: Use when tasks require catalog syndication approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Catalog Syndication Approval Orchestrator

## Purpose
Design and execute catalog syndication workflows using approval orchestrator controls with validated outcomes.
