---
name: customer-success-plans-conflict-resolver
description: Use when tasks require customer success plans conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Conflict Resolver

## Purpose
Design and execute customer success plans workflows using conflict resolver controls with validated outcomes.
