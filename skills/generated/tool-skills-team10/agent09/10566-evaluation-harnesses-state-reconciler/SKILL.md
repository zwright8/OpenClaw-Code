---
name: evaluation-harnesses-state-reconciler
description: Use when tasks require evaluation harnesses state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses State Reconciler

## Purpose
Design and execute evaluation harnesses workflows using state reconciler controls with validated outcomes.
