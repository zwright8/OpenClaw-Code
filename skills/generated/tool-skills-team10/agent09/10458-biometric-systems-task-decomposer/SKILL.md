---
name: biometric-systems-task-decomposer
description: Use when tasks require biometric systems task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Task Decomposer

## Purpose
Design and execute biometric systems workflows using task decomposer controls with validated outcomes.
