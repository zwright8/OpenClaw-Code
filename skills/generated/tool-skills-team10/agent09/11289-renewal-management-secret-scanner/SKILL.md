---
name: renewal-management-secret-scanner
description: Use when tasks require renewal management secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Renewal Management Secret Scanner

## Purpose
Design and execute renewal management workflows using secret scanner controls with validated outcomes.
