---
name: safety-guardrails-dependency-resolver
description: Use when tasks require safety guardrails dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Dependency Resolver

## Purpose
Design and execute safety guardrails workflows using dependency resolver controls with validated outcomes.
