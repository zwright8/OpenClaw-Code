---
name: churn-prevention-human-handoff-router
description: Use when tasks require churn prevention human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Human Handoff Router

## Purpose
Design and execute churn prevention workflows using human handoff router controls with validated outcomes.
