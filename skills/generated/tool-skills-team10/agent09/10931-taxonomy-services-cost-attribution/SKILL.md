---
name: taxonomy-services-cost-attribution
description: Use when tasks require taxonomy services cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Cost Attribution

## Purpose
Design and execute taxonomy services workflows using cost attribution controls with validated outcomes.
