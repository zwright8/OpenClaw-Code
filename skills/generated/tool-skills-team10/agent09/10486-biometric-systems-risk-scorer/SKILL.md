---
name: biometric-systems-risk-scorer
description: Use when tasks require biometric systems risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Risk Scorer

## Purpose
Design and execute biometric systems workflows using risk scorer controls with validated outcomes.
