---
name: spare-parts-planning-evidence-collector
description: Use when tasks require spare parts planning evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Spare Parts Planning Evidence Collector

## Purpose
Design and execute spare parts planning workflows using evidence collector controls with validated outcomes.
