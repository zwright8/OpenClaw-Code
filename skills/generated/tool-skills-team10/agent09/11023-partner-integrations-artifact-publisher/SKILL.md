---
name: partner-integrations-artifact-publisher
description: Use when tasks require partner integrations artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Artifact Publisher

## Purpose
Design and execute partner integrations workflows using artifact publisher controls with validated outcomes.
