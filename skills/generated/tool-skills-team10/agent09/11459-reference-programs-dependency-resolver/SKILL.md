---
name: reference-programs-dependency-resolver
description: Use when tasks require reference programs dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Dependency Resolver

## Purpose
Design and execute reference programs workflows using dependency resolver controls with validated outcomes.
