---
name: qbr-automation-anomaly-detector
description: Use when tasks require qbr automation anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Anomaly Detector

## Purpose
Design and execute qbr automation workflows using anomaly detector controls with validated outcomes.
