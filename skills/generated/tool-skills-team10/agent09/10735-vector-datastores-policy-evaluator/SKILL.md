---
name: vector-datastores-policy-evaluator
description: Use when tasks require vector datastores policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Policy Evaluator

## Purpose
Design and execute vector datastores workflows using policy evaluator controls with validated outcomes.
