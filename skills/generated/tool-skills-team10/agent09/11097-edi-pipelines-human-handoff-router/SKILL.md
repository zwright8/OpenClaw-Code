---
name: edi-pipelines-human-handoff-router
description: Use when tasks require edi pipelines human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Human Handoff Router

## Purpose
Design and execute edi pipelines workflows using human handoff router controls with validated outcomes.
