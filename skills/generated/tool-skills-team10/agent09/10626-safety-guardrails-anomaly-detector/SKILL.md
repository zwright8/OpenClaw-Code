---
name: safety-guardrails-anomaly-detector
description: Use when tasks require safety guardrails anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Anomaly Detector

## Purpose
Design and execute safety guardrails workflows using anomaly detector controls with validated outcomes.
