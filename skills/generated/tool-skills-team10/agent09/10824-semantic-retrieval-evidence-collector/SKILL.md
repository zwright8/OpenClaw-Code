---
name: semantic-retrieval-evidence-collector
description: Use when tasks require semantic retrieval evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Evidence Collector

## Purpose
Design and execute semantic retrieval workflows using evidence collector controls with validated outcomes.
