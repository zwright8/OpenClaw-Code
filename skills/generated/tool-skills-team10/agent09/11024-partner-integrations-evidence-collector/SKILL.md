---
name: partner-integrations-evidence-collector
description: Use when tasks require partner integrations evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Evidence Collector

## Purpose
Design and execute partner integrations workflows using evidence collector controls with validated outcomes.
