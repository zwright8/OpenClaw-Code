---
name: qbr-automation-quality-gatekeeper
description: Use when tasks require qbr automation quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Quality Gatekeeper

## Purpose
Design and execute qbr automation workflows using quality gatekeeper controls with validated outcomes.
