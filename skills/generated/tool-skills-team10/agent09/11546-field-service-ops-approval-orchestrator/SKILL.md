---
name: field-service-ops-approval-orchestrator
description: Use when tasks require field service ops approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Approval Orchestrator

## Purpose
Design and execute field service ops workflows using approval orchestrator controls with validated outcomes.
