---
name: customer-success-plans-human-handoff-router
description: Use when tasks require customer success plans human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Human Handoff Router

## Purpose
Design and execute customer success plans workflows using human handoff router controls with validated outcomes.
