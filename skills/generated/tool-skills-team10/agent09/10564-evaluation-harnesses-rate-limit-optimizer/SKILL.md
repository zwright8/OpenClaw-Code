---
name: evaluation-harnesses-rate-limit-optimizer
description: Use when tasks require evaluation harnesses rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Rate Limit Optimizer

## Purpose
Design and execute evaluation harnesses workflows using rate limit optimizer controls with validated outcomes.
