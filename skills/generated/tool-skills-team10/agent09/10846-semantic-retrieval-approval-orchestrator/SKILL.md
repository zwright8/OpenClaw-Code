---
name: semantic-retrieval-approval-orchestrator
description: Use when tasks require semantic retrieval approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Approval Orchestrator

## Purpose
Design and execute semantic retrieval workflows using approval orchestrator controls with validated outcomes.
