---
name: semantic-retrieval-root-cause-miner
description: Use when tasks require semantic retrieval root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Root Cause Miner

## Purpose
Design and execute semantic retrieval workflows using root cause miner controls with validated outcomes.
