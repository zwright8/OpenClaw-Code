---
name: taxonomy-services-rate-limit-optimizer
description: Use when tasks require taxonomy services rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Rate Limit Optimizer

## Purpose
Design and execute taxonomy services workflows using rate limit optimizer controls with validated outcomes.
