---
name: semantic-retrieval-rate-limit-optimizer
description: Use when tasks require semantic retrieval rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval Rate Limit Optimizer

## Purpose
Design and execute semantic retrieval workflows using rate limit optimizer controls with validated outcomes.
