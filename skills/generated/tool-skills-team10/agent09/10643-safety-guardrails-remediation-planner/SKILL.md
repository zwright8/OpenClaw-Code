---
name: safety-guardrails-remediation-planner
description: Use when tasks require safety guardrails remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Safety Guardrails Remediation Planner

## Purpose
Design and execute safety guardrails workflows using remediation planner controls with validated outcomes.
