---
name: evaluation-harnesses-operation-planner
description: Use when tasks require evaluation harnesses operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Operation Planner

## Purpose
Design and execute evaluation harnesses workflows using operation planner controls with validated outcomes.
