---
name: reference-programs-access-auditor
description: Use when tasks require reference programs access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Reference Programs Access Auditor

## Purpose
Design and execute reference programs workflows using access auditor controls with validated outcomes.
