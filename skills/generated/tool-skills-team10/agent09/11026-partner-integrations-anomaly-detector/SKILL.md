---
name: partner-integrations-anomaly-detector
description: Use when tasks require partner integrations anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Integrations Anomaly Detector

## Purpose
Design and execute partner integrations workflows using anomaly detector controls with validated outcomes.
