---
name: qbr-automation-forecast-engine
description: Use when tasks require qbr automation forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Forecast Engine

## Purpose
Design and execute qbr automation workflows using forecast engine controls with validated outcomes.
