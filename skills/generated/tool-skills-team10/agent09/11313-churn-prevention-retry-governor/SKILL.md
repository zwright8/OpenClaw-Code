---
name: churn-prevention-retry-governor
description: Use when tasks require churn prevention retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Retry Governor

## Purpose
Design and execute churn prevention workflows using retry governor controls with validated outcomes.
