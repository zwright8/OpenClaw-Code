---
name: semantic-retrieval-api-contract-validator
description: Use when tasks require semantic retrieval api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Semantic Retrieval API Contract Validator

## Purpose
Design and execute semantic retrieval workflows using api contract validator controls with validated outcomes.
...
- Domain: [Semantic Retrieval](../../resources/domains/semantic-retrieval.md)
