---
name: vector-datastores-root-cause-miner
description: Use when tasks require vector datastores root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Vector Datastores Root Cause Miner

## Purpose
Design and execute vector datastores workflows using root cause miner controls with validated outcomes.
