---
name: biometric-systems-incident-triage
description: Use when tasks require biometric systems incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Biometric Systems Incident Triage

## Purpose
Design and execute biometric systems workflows using incident triage controls with validated outcomes.
