---
name: evaluation-harnesses-rollback-coordinator
description: Use when tasks require evaluation harnesses rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Rollback Coordinator

## Purpose
Design and execute evaluation harnesses workflows using rollback coordinator controls with validated outcomes.
