---
name: scheduling-dispatch-migration-planner
description: Use when tasks require scheduling dispatch migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scheduling Dispatch Migration Planner

## Purpose
Design and execute scheduling dispatch workflows using migration planner controls with validated outcomes.
