---
name: model-serving-rate-limit-optimizer
description: Use when tasks require model serving rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Rate Limit Optimizer

## Purpose
Design and execute model serving workflows using rate limit optimizer controls with validated outcomes.
