---
name: b2b-portals-permission-mapper
description: Use when tasks require b2b portals permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals Permission Mapper

## Purpose
Design and execute b2b portals workflows using permission mapper controls with validated outcomes.
