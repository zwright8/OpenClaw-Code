---
name: edi-pipelines-capacity-planner
description: Use when tasks require edi pipelines capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Capacity Planner

## Purpose
Design and execute edi pipelines workflows using capacity planner controls with validated outcomes.
