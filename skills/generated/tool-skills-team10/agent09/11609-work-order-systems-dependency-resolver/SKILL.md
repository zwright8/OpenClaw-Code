---
name: work-order-systems-dependency-resolver
description: Use when tasks require work order systems dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Dependency Resolver

## Purpose
Design and execute work order systems workflows using dependency resolver controls with validated outcomes.
