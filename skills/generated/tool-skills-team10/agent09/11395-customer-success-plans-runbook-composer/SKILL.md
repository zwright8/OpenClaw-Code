---
name: customer-success-plans-runbook-composer
description: Use when tasks require customer success plans runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Success Plans Runbook Composer

## Purpose
Design and execute customer success plans workflows using runbook composer controls with validated outcomes.
