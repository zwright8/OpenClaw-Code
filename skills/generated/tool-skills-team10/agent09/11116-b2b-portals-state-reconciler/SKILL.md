---
name: b2b-portals-state-reconciler
description: Use when tasks require b2b portals state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# B2B Portals State Reconciler

## Purpose
Design and execute b2b portals workflows using state reconciler controls with validated outcomes.
