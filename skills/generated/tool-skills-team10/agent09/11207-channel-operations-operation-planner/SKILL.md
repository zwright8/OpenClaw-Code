---
name: channel-operations-operation-planner
description: Use when tasks require channel operations operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Operation Planner

## Purpose
Design and execute channel operations workflows using operation planner controls with validated outcomes.
