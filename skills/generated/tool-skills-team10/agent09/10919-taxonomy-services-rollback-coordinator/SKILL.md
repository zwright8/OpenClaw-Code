---
name: taxonomy-services-rollback-coordinator
description: Use when tasks require taxonomy services rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Taxonomy Services Rollback Coordinator

## Purpose
Design and execute taxonomy services workflows using rollback coordinator controls with validated outcomes.
