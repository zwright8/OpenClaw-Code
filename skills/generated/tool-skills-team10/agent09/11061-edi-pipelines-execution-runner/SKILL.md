---
name: edi-pipelines-execution-runner
description: Use when tasks require edi pipelines execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Execution Runner

## Purpose
Design and execute edi pipelines workflows using execution runner controls with validated outcomes.
