---
name: churn-prevention-incident-triage
description: Use when tasks require churn prevention incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Incident Triage

## Purpose
Design and execute churn prevention workflows using incident triage controls with validated outcomes.
