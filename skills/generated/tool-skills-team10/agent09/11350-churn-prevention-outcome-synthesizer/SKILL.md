---
name: churn-prevention-outcome-synthesizer
description: Use when tasks require churn prevention outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Churn Prevention Outcome Synthesizer

## Purpose
Design and execute churn prevention workflows using outcome synthesizer controls with validated outcomes.
