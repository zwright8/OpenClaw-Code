---
name: edi-pipelines-workflow-compiler
description: Use when tasks require edi pipelines workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# EDI Pipelines Workflow Compiler

## Purpose
Design and execute edi pipelines workflows using workflow compiler controls with validated outcomes.
