---
name: field-service-ops-root-cause-miner
description: Use when tasks require field service ops root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Field Service Ops Root Cause Miner

## Purpose
Design and execute field service ops workflows using root cause miner controls with validated outcomes.
