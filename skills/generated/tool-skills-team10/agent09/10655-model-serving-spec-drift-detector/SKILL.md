---
name: model-serving-spec-drift-detector
description: Use when tasks require model serving spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Serving Spec Drift Detector

## Purpose
Design and execute model serving workflows using spec drift detector controls with validated outcomes.
