---
name: evaluation-harnesses-artifact-publisher
description: Use when tasks require evaluation harnesses artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Evaluation Harnesses Artifact Publisher

## Purpose
Design and execute evaluation harnesses workflows using artifact publisher controls with validated outcomes.
