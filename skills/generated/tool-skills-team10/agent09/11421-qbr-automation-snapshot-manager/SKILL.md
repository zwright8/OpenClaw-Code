---
name: qbr-automation-snapshot-manager
description: Use when tasks require qbr automation snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Snapshot Manager

## Purpose
Design and execute qbr automation workflows using snapshot manager controls with validated outcomes.
