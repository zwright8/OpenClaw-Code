---
name: qbr-automation-rollback-coordinator
description: Use when tasks require qbr automation rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# QBR Automation Rollback Coordinator

## Purpose
Design and execute qbr automation workflows using rollback coordinator controls with validated outcomes.
