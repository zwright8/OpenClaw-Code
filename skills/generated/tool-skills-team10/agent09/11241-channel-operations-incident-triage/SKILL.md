---
name: channel-operations-incident-triage
description: Use when tasks require channel operations incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Channel Operations Incident Triage

## Purpose
Design and execute channel operations workflows using incident triage controls with validated outcomes.
