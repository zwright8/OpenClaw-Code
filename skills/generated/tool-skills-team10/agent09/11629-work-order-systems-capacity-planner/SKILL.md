---
name: work-order-systems-capacity-planner
description: Use when tasks require work order systems capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Work Order Systems Capacity Planner

## Purpose
Design and execute work order systems workflows using capacity planner controls with validated outcomes.
