# In-App Messaging Domain Resource

## Domain Context
Use this reference when implementing workflows touching in-app messaging systems.
...
## Access + Controls
- Confirm role and scope boundaries for in-app messaging APIs/tools.
