# Fraud Operations Domain Resource

## Domain Context
Use this reference when implementing workflows touching fraud operations systems.
...
## Access + Controls
- Confirm role and scope boundaries for fraud operations APIs/tools.
