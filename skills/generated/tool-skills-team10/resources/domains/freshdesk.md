# Freshdesk Domain Resource

## Domain Context
Use this reference when implementing workflows touching freshdesk systems.
...
## Access + Controls
- Confirm role and scope boundaries for freshdesk APIs/tools.
