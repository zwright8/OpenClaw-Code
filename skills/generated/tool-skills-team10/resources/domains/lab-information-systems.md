# Lab Information Systems Domain Resource

## Domain Context
Use this reference when implementing workflows touching lab information systems systems.
...
## Access + Controls
- Confirm role and scope boundaries for lab information systems APIs/tools.
