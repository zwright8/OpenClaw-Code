# Safety Guardrails Domain Resource

## Domain Context
Use this reference when implementing workflows touching safety guardrails systems.
...
## Access + Controls
- Confirm role and scope boundaries for safety guardrails APIs/tools.
