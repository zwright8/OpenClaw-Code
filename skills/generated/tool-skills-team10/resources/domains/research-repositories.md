# Research Repositories Domain Resource

## Domain Context
Use this reference when implementing workflows touching research repositories systems.
...
## Access + Controls
- Confirm role and scope boundaries for research repositories APIs/tools.
