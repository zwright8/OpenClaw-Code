# Marketplace Operations Domain Resource

## Domain Context
Use this reference when implementing workflows touching marketplace operations systems.
...
## Access + Controls
- Confirm role and scope boundaries for marketplace operations APIs/tools.
