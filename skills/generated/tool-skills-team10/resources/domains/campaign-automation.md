# Campaign Automation Domain Resource

## Domain Context
Use this reference when implementing workflows touching campaign automation systems.
...
## Access + Controls
- Confirm role and scope boundaries for campaign automation APIs/tools.
