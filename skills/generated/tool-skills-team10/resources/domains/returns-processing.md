# Returns Processing Domain Resource

## Domain Context
Use this reference when implementing workflows touching returns processing systems.
...
## Access + Controls
- Confirm role and scope boundaries for returns processing APIs/tools.
