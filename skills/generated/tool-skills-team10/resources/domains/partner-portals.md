# Partner Portals Domain Resource

## Domain Context
Use this reference when implementing workflows touching partner portals systems.
...
## Access + Controls
- Confirm role and scope boundaries for partner portals APIs/tools.
