# Order Management Domain Resource

## Domain Context
Use this reference when implementing workflows touching order management systems.
...
## Access + Controls
- Confirm role and scope boundaries for order management APIs/tools.
