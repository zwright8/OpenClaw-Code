# Metadata Stores Domain Resource

## Domain Context
Use this reference when implementing workflows touching metadata stores systems.
...
## Access + Controls
- Confirm role and scope boundaries for metadata stores APIs/tools.
