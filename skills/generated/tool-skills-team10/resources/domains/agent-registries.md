# Agent Registries Domain Resource

## Domain Context
Use this reference when implementing workflows touching agent registries systems.
...
## Access + Controls
- Confirm role and scope boundaries for agent registries APIs/tools.
