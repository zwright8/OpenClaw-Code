# Volunteer Coordination Domain Resource

## Domain Context
Use this reference when implementing workflows touching volunteer coordination systems.
...
## Access + Controls
- Confirm role and scope boundaries for volunteer coordination APIs/tools.
