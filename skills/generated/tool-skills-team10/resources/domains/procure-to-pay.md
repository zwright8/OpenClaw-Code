# Procure to Pay Domain Resource

## Domain Context
Use this reference when implementing workflows touching procure to pay systems.
...
## Access + Controls
- Confirm role and scope boundaries for procure to pay APIs/tools.
