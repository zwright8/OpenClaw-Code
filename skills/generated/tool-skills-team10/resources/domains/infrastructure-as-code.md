# Infrastructure as Code Domain Resource

## Domain Context
Use this reference when implementing workflows touching infrastructure as code systems.
...
## Access + Controls
- Confirm role and scope boundaries for infrastructure as code APIs/tools.
