# POS Systems Domain Resource

## Domain Context
Use this reference when implementing workflows touching pos systems systems.
...
## Access + Controls
- Confirm role and scope boundaries for pos systems APIs/tools.
