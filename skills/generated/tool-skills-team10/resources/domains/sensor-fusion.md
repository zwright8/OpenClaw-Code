# Sensor Fusion Domain Resource

## Domain Context
Use this reference when implementing workflows touching sensor fusion systems.
...
## Access + Controls
- Confirm role and scope boundaries for sensor fusion APIs/tools.
