# Whisper Domain Resource

## Domain Context
Use this reference when implementing workflows touching whisper systems.
...
## Access + Controls
- Confirm role and scope boundaries for whisper APIs/tools.
