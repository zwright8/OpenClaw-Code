# Task Queues Domain Resource

## Domain Context
Use this reference when implementing workflows touching task queues systems.
...
## Access + Controls
- Confirm role and scope boundaries for task queues APIs/tools.
