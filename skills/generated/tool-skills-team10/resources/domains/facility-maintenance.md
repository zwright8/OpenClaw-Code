# Facility Maintenance Domain Resource

## Domain Context
Use this reference when implementing workflows touching facility maintenance systems.
...
## Access + Controls
- Confirm role and scope boundaries for facility maintenance APIs/tools.
