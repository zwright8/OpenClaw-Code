# API Gateways Domain Resource

## Domain Context
Use this reference when implementing workflows touching api gateways systems.
...
## Access + Controls
- Confirm role and scope boundaries for api gateways APIs/tools.
