# Ontology Management Domain Resource

## Domain Context
Use this reference when implementing workflows touching ontology management systems.
...
## Access + Controls
- Confirm role and scope boundaries for ontology management APIs/tools.
