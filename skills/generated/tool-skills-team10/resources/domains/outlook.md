# Outlook Domain Resource

## Domain Context
Use this reference when implementing workflows touching outlook systems.
...
## Access + Controls
- Confirm role and scope boundaries for outlook APIs/tools.
