# Government Records Domain Resource

## Domain Context
Use this reference when implementing workflows touching government records systems.
...
## Access + Controls
- Confirm role and scope boundaries for government records APIs/tools.
