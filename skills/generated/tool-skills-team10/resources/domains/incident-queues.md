# Incident Queues Domain Resource

## Domain Context
Use this reference when implementing workflows touching incident queues systems.
...
## Access + Controls
- Confirm role and scope boundaries for incident queues APIs/tools.
