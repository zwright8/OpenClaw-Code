# Discord Domain Resource

## Domain Context
Use this reference when implementing workflows touching discord systems.
...
## Access + Controls
- Confirm role and scope boundaries for discord APIs/tools.
