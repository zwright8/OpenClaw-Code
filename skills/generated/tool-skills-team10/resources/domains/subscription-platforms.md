# Subscription Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching subscription platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for subscription platforms APIs/tools.
