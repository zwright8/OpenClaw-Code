# Knowledge Bases Domain Resource

## Domain Context
Use this reference when implementing workflows touching knowledge bases systems.
...
## Access + Controls
- Confirm role and scope boundaries for knowledge bases APIs/tools.
