# Zendesk Domain Resource

## Domain Context
Use this reference when implementing workflows touching zendesk systems.
...
## Access + Controls
- Confirm role and scope boundaries for zendesk APIs/tools.
