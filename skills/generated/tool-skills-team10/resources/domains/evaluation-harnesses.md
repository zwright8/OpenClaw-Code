# Evaluation Harnesses Domain Resource

## Domain Context
Use this reference when implementing workflows touching evaluation harnesses systems.
...
## Access + Controls
- Confirm role and scope boundaries for evaluation harnesses APIs/tools.
