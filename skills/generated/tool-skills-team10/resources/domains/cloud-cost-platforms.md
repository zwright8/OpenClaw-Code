# Cloud Cost Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching cloud cost platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for cloud cost platforms APIs/tools.
