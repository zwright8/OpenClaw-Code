# Customer QA Domain Resource

## Domain Context
Use this reference when implementing workflows touching customer qa systems.
...
## Access + Controls
- Confirm role and scope boundaries for customer qa APIs/tools.
