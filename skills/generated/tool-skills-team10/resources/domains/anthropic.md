# Anthropic Domain Resource

## Domain Context
Use this reference when implementing workflows touching anthropic systems.
...
## Access + Controls
- Confirm role and scope boundaries for anthropic APIs/tools.
