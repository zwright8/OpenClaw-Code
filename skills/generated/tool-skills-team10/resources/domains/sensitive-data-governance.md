# Sensitive Data Governance Domain Resource

## Domain Context
Use this reference when implementing workflows touching sensitive data governance systems.
...
## Access + Controls
- Confirm role and scope boundaries for sensitive data governance APIs/tools.
