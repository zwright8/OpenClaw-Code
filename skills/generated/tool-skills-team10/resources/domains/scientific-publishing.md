# Scientific Publishing Domain Resource

## Domain Context
Use this reference when implementing workflows touching scientific publishing systems.
...
## Access + Controls
- Confirm role and scope boundaries for scientific publishing APIs/tools.
