# Feature Stores Domain Resource

## Domain Context
Use this reference when implementing workflows touching feature stores systems.
...
## Access + Controls
- Confirm role and scope boundaries for feature stores APIs/tools.
