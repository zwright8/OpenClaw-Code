# Audit Trails Domain Resource

## Domain Context
Use this reference when implementing workflows touching audit trails systems.
...
## Access + Controls
- Confirm role and scope boundaries for audit trails APIs/tools.
