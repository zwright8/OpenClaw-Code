# Chargeback Ops Domain Resource

## Domain Context
Use this reference when implementing workflows touching chargeback ops systems.
...
## Access + Controls
- Confirm role and scope boundaries for chargeback ops APIs/tools.
