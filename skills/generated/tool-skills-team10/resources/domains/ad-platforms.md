# Ad Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching ad platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for ad platforms APIs/tools.
