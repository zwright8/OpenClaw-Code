# Discovery Pipelines Domain Resource

## Domain Context
Use this reference when implementing workflows touching discovery pipelines systems.
...
## Access + Controls
- Confirm role and scope boundaries for discovery pipelines APIs/tools.
