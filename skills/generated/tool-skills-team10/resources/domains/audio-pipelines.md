# Audio Pipelines Domain Resource

## Domain Context
Use this reference when implementing workflows touching audio pipelines systems.
...
## Access + Controls
- Confirm role and scope boundaries for audio pipelines APIs/tools.
