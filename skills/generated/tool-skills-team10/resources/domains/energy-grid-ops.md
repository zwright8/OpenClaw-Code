# Energy Grid Ops Domain Resource

## Domain Context
Use this reference when implementing workflows touching energy grid ops systems.
...
## Access + Controls
- Confirm role and scope boundaries for energy grid ops APIs/tools.
