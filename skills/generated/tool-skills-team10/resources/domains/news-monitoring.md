# News Monitoring Domain Resource

## Domain Context
Use this reference when implementing workflows touching news monitoring systems.
...
## Access + Controls
- Confirm role and scope boundaries for news monitoring APIs/tools.
