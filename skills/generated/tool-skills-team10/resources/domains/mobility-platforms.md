# Mobility Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching mobility platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for mobility platforms APIs/tools.
