# Salesforce Domain Resource

## Domain Context
Use this reference when implementing workflows touching salesforce systems.
...
## Access + Controls
- Confirm role and scope boundaries for salesforce APIs/tools.
