# Identity Verification Domain Resource

## Domain Context
Use this reference when implementing workflows touching identity verification systems.
...
## Access + Controls
- Confirm role and scope boundaries for identity verification APIs/tools.
