# Data Provenance Domain Resource

## Domain Context
Use this reference when implementing workflows touching data provenance systems.
...
## Access + Controls
- Confirm role and scope boundaries for data provenance APIs/tools.
