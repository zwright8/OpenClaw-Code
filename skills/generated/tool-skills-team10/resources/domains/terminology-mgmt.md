# Terminology Mgmt Domain Resource

## Domain Context
Use this reference when implementing workflows touching terminology mgmt systems.
...
## Access + Controls
- Confirm role and scope boundaries for terminology mgmt APIs/tools.
