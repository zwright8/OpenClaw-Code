# Utility Billing Domain Resource

## Domain Context
Use this reference when implementing workflows touching utility billing systems.
...
## Access + Controls
- Confirm role and scope boundaries for utility billing APIs/tools.
