# Error Tracking Domain Resource

## Domain Context
Use this reference when implementing workflows touching error tracking systems.
...
## Access + Controls
- Confirm role and scope boundaries for error tracking APIs/tools.
