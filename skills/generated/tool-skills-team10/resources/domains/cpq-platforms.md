# CPQ Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching cpq platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for cpq platforms APIs/tools.
