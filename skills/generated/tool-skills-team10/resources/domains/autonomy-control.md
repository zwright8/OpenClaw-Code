# Autonomy Control Domain Resource

## Domain Context
Use this reference when implementing workflows touching autonomy control systems.
...
## Access + Controls
- Confirm role and scope boundaries for autonomy control APIs/tools.
