# Freight Brokerage Domain Resource

## Domain Context
Use this reference when implementing workflows touching freight brokerage systems.
...
## Access + Controls
- Confirm role and scope boundaries for freight brokerage APIs/tools.
