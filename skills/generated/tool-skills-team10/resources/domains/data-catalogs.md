# Data Catalogs Domain Resource

## Domain Context
Use this reference when implementing workflows touching data catalogs systems.
...
## Access + Controls
- Confirm role and scope boundaries for data catalogs APIs/tools.
