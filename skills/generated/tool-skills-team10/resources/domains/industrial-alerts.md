# Industrial Alerts Domain Resource

## Domain Context
Use this reference when implementing workflows touching industrial alerts systems.
...
## Access + Controls
- Confirm role and scope boundaries for industrial alerts APIs/tools.
