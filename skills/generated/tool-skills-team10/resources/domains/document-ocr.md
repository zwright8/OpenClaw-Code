# Document OCR Domain Resource

## Domain Context
Use this reference when implementing workflows touching document ocr systems.
...
## Access + Controls
- Confirm role and scope boundaries for document ocr APIs/tools.
