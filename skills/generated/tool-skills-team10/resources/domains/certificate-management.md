# Certificate Management Domain Resource

## Domain Context
Use this reference when implementing workflows touching certificate management systems.
...
## Access + Controls
- Confirm role and scope boundaries for certificate management APIs/tools.
