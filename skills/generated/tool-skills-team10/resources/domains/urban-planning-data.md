# Urban Planning Data Domain Resource

## Domain Context
Use this reference when implementing workflows touching urban planning data systems.
...
## Access + Controls
- Confirm role and scope boundaries for urban planning data APIs/tools.
