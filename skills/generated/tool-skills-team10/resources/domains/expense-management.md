# Expense Management Domain Resource

## Domain Context
Use this reference when implementing workflows touching expense management systems.
...
## Access + Controls
- Confirm role and scope boundaries for expense management APIs/tools.
