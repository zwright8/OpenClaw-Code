# Customer Success Plans Domain Resource

## Domain Context
Use this reference when implementing workflows touching customer success plans systems.
...
## Access + Controls
- Confirm role and scope boundaries for customer success plans APIs/tools.
