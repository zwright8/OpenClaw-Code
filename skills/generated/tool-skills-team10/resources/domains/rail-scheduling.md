# Rail Scheduling Domain Resource

## Domain Context
Use this reference when implementing workflows touching rail scheduling systems.
...
## Access + Controls
- Confirm role and scope boundaries for rail scheduling APIs/tools.
