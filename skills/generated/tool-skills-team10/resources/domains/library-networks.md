# Library Networks Domain Resource

## Domain Context
Use this reference when implementing workflows touching library networks systems.
...
## Access + Controls
- Confirm role and scope boundaries for library networks APIs/tools.
