# Workflow Engines Domain Resource

## Domain Context
Use this reference when implementing workflows touching workflow engines systems.
...
## Access + Controls
- Confirm role and scope boundaries for workflow engines APIs/tools.
