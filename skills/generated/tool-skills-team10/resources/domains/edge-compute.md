# Edge Compute Domain Resource

## Domain Context
Use this reference when implementing workflows touching edge compute systems.
...
## Access + Controls
- Confirm role and scope boundaries for edge compute APIs/tools.
