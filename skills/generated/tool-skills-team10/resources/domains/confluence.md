# Confluence Domain Resource

## Domain Context
Use this reference when implementing workflows touching confluence systems.
...
## Access + Controls
- Confirm role and scope boundaries for confluence APIs/tools.
