# Identity Providers Domain Resource

## Domain Context
Use this reference when implementing workflows touching identity providers systems.
...
## Access + Controls
- Confirm role and scope boundaries for identity providers APIs/tools.
