# SendGrid Domain Resource

## Domain Context
Use this reference when implementing workflows touching sendgrid systems.
...
## Access + Controls
- Confirm role and scope boundaries for sendgrid APIs/tools.
