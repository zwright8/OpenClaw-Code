# WordPress Domain Resource

## Domain Context
Use this reference when implementing workflows touching wordpress systems.
...
## Access + Controls
- Confirm role and scope boundaries for wordpress APIs/tools.
