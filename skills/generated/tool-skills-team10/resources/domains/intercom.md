# Intercom Domain Resource

## Domain Context
Use this reference when implementing workflows touching intercom systems.
...
## Access + Controls
- Confirm role and scope boundaries for intercom APIs/tools.
