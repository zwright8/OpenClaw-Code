# Trading Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching trading platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for trading platforms APIs/tools.
