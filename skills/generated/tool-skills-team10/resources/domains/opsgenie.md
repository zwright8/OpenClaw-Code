# Opsgenie Domain Resource

## Domain Context
Use this reference when implementing workflows touching opsgenie systems.
...
## Access + Controls
- Confirm role and scope boundaries for opsgenie APIs/tools.
