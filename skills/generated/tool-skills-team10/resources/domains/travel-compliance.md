# Travel Compliance Domain Resource

## Domain Context
Use this reference when implementing workflows touching travel compliance systems.
...
## Access + Controls
- Confirm role and scope boundaries for travel compliance APIs/tools.
