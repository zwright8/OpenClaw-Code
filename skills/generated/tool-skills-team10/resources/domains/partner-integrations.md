# Partner Integrations Domain Resource

## Domain Context
Use this reference when implementing workflows touching partner integrations systems.
...
## Access + Controls
- Confirm role and scope boundaries for partner integrations APIs/tools.
