# Inference Caches Domain Resource

## Domain Context
Use this reference when implementing workflows touching inference caches systems.
...
## Access + Controls
- Confirm role and scope boundaries for inference caches APIs/tools.
