# Image Annotation Domain Resource

## Domain Context
Use this reference when implementing workflows touching image annotation systems.
...
## Access + Controls
- Confirm role and scope boundaries for image annotation APIs/tools.
