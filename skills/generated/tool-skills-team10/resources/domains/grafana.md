# Grafana Domain Resource

## Domain Context
Use this reference when implementing workflows touching grafana systems.
...
## Access + Controls
- Confirm role and scope boundaries for grafana APIs/tools.
