# eBay Seller Domain Resource

## Domain Context
Use this reference when implementing workflows touching ebay seller systems.
...
## Access + Controls
- Confirm role and scope boundaries for ebay seller APIs/tools.
