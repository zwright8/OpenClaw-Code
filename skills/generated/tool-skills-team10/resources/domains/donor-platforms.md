# Donor Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching donor platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for donor platforms APIs/tools.
