# Experiment Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching experiment platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for experiment platforms APIs/tools.
