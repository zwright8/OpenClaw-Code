# Asset Discovery Domain Resource

## Domain Context
Use this reference when implementing workflows touching asset discovery systems.
...
## Access + Controls
- Confirm role and scope boundaries for asset discovery APIs/tools.
