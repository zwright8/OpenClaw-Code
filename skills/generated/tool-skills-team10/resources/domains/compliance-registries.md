# Compliance Registries Domain Resource

## Domain Context
Use this reference when implementing workflows touching compliance registries systems.
...
## Access + Controls
- Confirm role and scope boundaries for compliance registries APIs/tools.
