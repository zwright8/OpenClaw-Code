# Education LMS Domain Resource

## Domain Context
Use this reference when implementing workflows touching education lms systems.
...
## Access + Controls
- Confirm role and scope boundaries for education lms APIs/tools.
