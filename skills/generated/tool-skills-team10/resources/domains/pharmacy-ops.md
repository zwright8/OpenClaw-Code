# Pharmacy Ops Domain Resource

## Domain Context
Use this reference when implementing workflows touching pharmacy ops systems.
...
## Access + Controls
- Confirm role and scope boundaries for pharmacy ops APIs/tools.
