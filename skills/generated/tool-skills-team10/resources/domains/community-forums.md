# Community Forums Domain Resource

## Domain Context
Use this reference when implementing workflows touching community forums systems.
...
## Access + Controls
- Confirm role and scope boundaries for community forums APIs/tools.
