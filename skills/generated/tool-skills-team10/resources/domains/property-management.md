# Property Management Domain Resource

## Domain Context
Use this reference when implementing workflows touching property management systems.
...
## Access + Controls
- Confirm role and scope boundaries for property management APIs/tools.
