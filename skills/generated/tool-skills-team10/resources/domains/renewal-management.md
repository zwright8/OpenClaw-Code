# Renewal Management Domain Resource

## Domain Context
Use this reference when implementing workflows touching renewal management systems.
...
## Access + Controls
- Confirm role and scope boundaries for renewal management APIs/tools.
