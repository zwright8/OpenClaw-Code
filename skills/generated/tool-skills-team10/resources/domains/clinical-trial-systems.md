# Clinical Trial Systems Domain Resource

## Domain Context
Use this reference when implementing workflows touching clinical trial systems systems.
...
## Access + Controls
- Confirm role and scope boundaries for clinical trial systems APIs/tools.
