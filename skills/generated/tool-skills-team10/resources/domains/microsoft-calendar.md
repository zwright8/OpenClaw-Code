# Microsoft Calendar Domain Resource

## Domain Context
Use this reference when implementing workflows touching microsoft calendar systems.
...
## Access + Controls
- Confirm role and scope boundaries for microsoft calendar APIs/tools.
