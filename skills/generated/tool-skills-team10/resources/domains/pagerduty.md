# PagerDuty Domain Resource

## Domain Context
Use this reference when implementing workflows touching pagerduty systems.
...
## Access + Controls
- Confirm role and scope boundaries for pagerduty APIs/tools.
