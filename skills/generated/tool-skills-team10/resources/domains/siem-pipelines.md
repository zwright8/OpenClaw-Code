# SIEM Pipelines Domain Resource

## Domain Context
Use this reference when implementing workflows touching siem pipelines systems.
...
## Access + Controls
- Confirm role and scope boundaries for siem pipelines APIs/tools.
