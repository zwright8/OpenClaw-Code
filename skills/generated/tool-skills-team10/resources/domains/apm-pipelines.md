# APM Pipelines Domain Resource

## Domain Context
Use this reference when implementing workflows touching apm pipelines systems.
...
## Access + Controls
- Confirm role and scope boundaries for apm pipelines APIs/tools.
