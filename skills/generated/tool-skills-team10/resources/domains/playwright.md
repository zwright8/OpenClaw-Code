# Playwright Domain Resource

## Domain Context
Use this reference when implementing workflows touching playwright systems.
...
## Access + Controls
- Confirm role and scope boundaries for playwright APIs/tools.
