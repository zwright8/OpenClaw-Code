# Secrets Vaults Domain Resource

## Domain Context
Use this reference when implementing workflows touching secrets vaults systems.
...
## Access + Controls
- Confirm role and scope boundaries for secrets vaults APIs/tools.
