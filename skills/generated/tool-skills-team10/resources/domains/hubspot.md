# HubSpot Domain Resource

## Domain Context
Use this reference when implementing workflows touching hubspot systems.
...
## Access + Controls
- Confirm role and scope boundaries for hubspot APIs/tools.
