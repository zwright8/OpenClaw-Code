# Service Mesh Domain Resource

## Domain Context
Use this reference when implementing workflows touching service mesh systems.
...
## Access + Controls
- Confirm role and scope boundaries for service mesh APIs/tools.
