# Open Source Intelligence Domain Resource

## Domain Context
Use this reference when implementing workflows touching open source intelligence systems.
...
## Access + Controls
- Confirm role and scope boundaries for open source intelligence APIs/tools.
