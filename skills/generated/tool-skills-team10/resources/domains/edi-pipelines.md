# EDI Pipelines Domain Resource

## Domain Context
Use this reference when implementing workflows touching edi pipelines systems.
...
## Access + Controls
- Confirm role and scope boundaries for edi pipelines APIs/tools.
