# Environmental Sensors Domain Resource

## Domain Context
Use this reference when implementing workflows touching environmental sensors systems.
...
## Access + Controls
- Confirm role and scope boundaries for environmental sensors APIs/tools.
