# KYC Pipelines Domain Resource

## Domain Context
Use this reference when implementing workflows touching kyc pipelines systems.
...
## Access + Controls
- Confirm role and scope boundaries for kyc pipelines APIs/tools.
