# RPA Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching rpa platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for rpa platforms APIs/tools.
