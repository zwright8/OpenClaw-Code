# Microsoft Teams Domain Resource

## Domain Context
Use this reference when implementing workflows touching microsoft teams systems.
...
## Access + Controls
- Confirm role and scope boundaries for microsoft teams APIs/tools.
