# Lab Notebook Systems Domain Resource

## Domain Context
Use this reference when implementing workflows touching lab notebook systems systems.
...
## Access + Controls
- Confirm role and scope boundaries for lab notebook systems APIs/tools.
