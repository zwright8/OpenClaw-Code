# Remote Access Domain Resource

## Domain Context
Use this reference when implementing workflows touching remote access systems.
...
## Access + Controls
- Confirm role and scope boundaries for remote access APIs/tools.
