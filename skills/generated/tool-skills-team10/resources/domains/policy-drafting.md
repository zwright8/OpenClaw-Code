# Policy Drafting Domain Resource

## Domain Context
Use this reference when implementing workflows touching policy drafting systems.
...
## Access + Controls
- Confirm role and scope boundaries for policy drafting APIs/tools.
