# AML Monitoring Domain Resource

## Domain Context
Use this reference when implementing workflows touching aml monitoring systems.
...
## Access + Controls
- Confirm role and scope boundaries for aml monitoring APIs/tools.
