# DigitalOcean Domain Resource

## Domain Context
Use this reference when implementing workflows touching digitalocean systems.
...
## Access + Controls
- Confirm role and scope boundaries for digitalocean APIs/tools.
