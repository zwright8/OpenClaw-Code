# BigQuery Domain Resource

## Domain Context
Use this reference when implementing workflows touching bigquery systems.
...
## Access + Controls
- Confirm role and scope boundaries for bigquery APIs/tools.
