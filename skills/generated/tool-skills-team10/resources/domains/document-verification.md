# Document Verification Domain Resource

## Domain Context
Use this reference when implementing workflows touching document verification systems.
...
## Access + Controls
- Confirm role and scope boundaries for document verification APIs/tools.
