# Biometric Systems Domain Resource

## Domain Context
Use this reference when implementing workflows touching biometric systems systems.
...
## Access + Controls
- Confirm role and scope boundaries for biometric systems APIs/tools.
