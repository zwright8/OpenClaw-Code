# ElevenLabs Domain Resource

## Domain Context
Use this reference when implementing workflows touching elevenlabs systems.
...
## Access + Controls
- Confirm role and scope boundaries for elevenlabs APIs/tools.
