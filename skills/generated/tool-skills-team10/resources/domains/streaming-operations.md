# Streaming Operations Domain Resource

## Domain Context
Use this reference when implementing workflows touching streaming operations systems.
...
## Access + Controls
- Confirm role and scope boundaries for streaming operations APIs/tools.
