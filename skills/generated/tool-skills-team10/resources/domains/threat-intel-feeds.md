# Threat Intel Feeds Domain Resource

## Domain Context
Use this reference when implementing workflows touching threat intel feeds systems.
...
## Access + Controls
- Confirm role and scope boundaries for threat intel feeds APIs/tools.
