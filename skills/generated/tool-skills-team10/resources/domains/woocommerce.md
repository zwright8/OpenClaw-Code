# WooCommerce Domain Resource

## Domain Context
Use this reference when implementing workflows touching woocommerce systems.
...
## Access + Controls
- Confirm role and scope boundaries for woocommerce APIs/tools.
