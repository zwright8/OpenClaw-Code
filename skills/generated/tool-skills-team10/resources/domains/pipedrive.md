# Pipedrive Domain Resource

## Domain Context
Use this reference when implementing workflows touching pipedrive systems.
...
## Access + Controls
- Confirm role and scope boundaries for pipedrive APIs/tools.
