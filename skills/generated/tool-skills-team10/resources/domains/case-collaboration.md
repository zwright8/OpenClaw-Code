# Case Collaboration Domain Resource

## Domain Context
Use this reference when implementing workflows touching case collaboration systems.
...
## Access + Controls
- Confirm role and scope boundaries for case collaboration APIs/tools.
