# Knowledge Graphs Domain Resource

## Domain Context
Use this reference when implementing workflows touching knowledge graphs systems.
...
## Access + Controls
- Confirm role and scope boundaries for knowledge graphs APIs/tools.
