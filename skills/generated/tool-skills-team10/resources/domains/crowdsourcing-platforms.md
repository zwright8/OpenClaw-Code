# Crowdsourcing Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching crowdsourcing platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for crowdsourcing platforms APIs/tools.
