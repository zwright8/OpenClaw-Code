# Ethics Review Boards Domain Resource

## Domain Context
Use this reference when implementing workflows touching ethics review boards systems.
...
## Access + Controls
- Confirm role and scope boundaries for ethics review boards APIs/tools.
