# Patch Orchestration Domain Resource

## Domain Context
Use this reference when implementing workflows touching patch orchestration systems.
...
## Access + Controls
- Confirm role and scope boundaries for patch orchestration APIs/tools.
