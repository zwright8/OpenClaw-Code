# Payroll Systems Domain Resource

## Domain Context
Use this reference when implementing workflows touching payroll systems systems.
...
## Access + Controls
- Confirm role and scope boundaries for payroll systems APIs/tools.
