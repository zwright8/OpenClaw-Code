# Synthetic Testing Domain Resource

## Domain Context
Use this reference when implementing workflows touching synthetic testing systems.
...
## Access + Controls
- Confirm role and scope boundaries for synthetic testing APIs/tools.
