# Construction PM Domain Resource

## Domain Context
Use this reference when implementing workflows touching construction pm systems.
...
## Access + Controls
- Confirm role and scope boundaries for construction pm APIs/tools.
