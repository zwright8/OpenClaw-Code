# Carbon Accounting Domain Resource

## Domain Context
Use this reference when implementing workflows touching carbon accounting systems.
...
## Access + Controls
- Confirm role and scope boundaries for carbon accounting APIs/tools.
