# Public Health Dashboards Domain Resource

## Domain Context
Use this reference when implementing workflows touching public health dashboards systems.
...
## Access + Controls
- Confirm role and scope boundaries for public health dashboards APIs/tools.
