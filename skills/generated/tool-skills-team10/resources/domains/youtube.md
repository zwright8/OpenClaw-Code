# YouTube Domain Resource

## Domain Context
Use this reference when implementing workflows touching youtube systems.
...
## Access + Controls
- Confirm role and scope boundaries for youtube APIs/tools.
