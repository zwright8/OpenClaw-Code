# Amazon Seller Domain Resource

## Domain Context
Use this reference when implementing workflows touching amazon seller systems.
...
## Access + Controls
- Confirm role and scope boundaries for amazon seller APIs/tools.
