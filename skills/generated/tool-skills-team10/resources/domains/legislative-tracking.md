# Legislative Tracking Domain Resource

## Domain Context
Use this reference when implementing workflows touching legislative tracking systems.
...
## Access + Controls
- Confirm role and scope boundaries for legislative tracking APIs/tools.
