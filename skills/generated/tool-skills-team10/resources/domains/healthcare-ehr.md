# Healthcare EHR Domain Resource

## Domain Context
Use this reference when implementing workflows touching healthcare ehr systems.
...
## Access + Controls
- Confirm role and scope boundaries for healthcare ehr APIs/tools.
