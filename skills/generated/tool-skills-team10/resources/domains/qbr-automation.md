# QBR Automation Domain Resource

## Domain Context
Use this reference when implementing workflows touching qbr automation systems.
...
## Access + Controls
- Confirm role and scope boundaries for qbr automation APIs/tools.
