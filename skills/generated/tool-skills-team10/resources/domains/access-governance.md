# Access Governance Domain Resource

## Domain Context
Use this reference when implementing workflows touching access governance systems.
...
## Access + Controls
- Confirm role and scope boundaries for access governance APIs/tools.
