# Civic Engagement Domain Resource

## Domain Context
Use this reference when implementing workflows touching civic engagement systems.
...
## Access + Controls
- Confirm role and scope boundaries for civic engagement APIs/tools.
