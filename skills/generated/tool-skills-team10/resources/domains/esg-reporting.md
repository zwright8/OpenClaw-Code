# ESG Reporting Domain Resource

## Domain Context
Use this reference when implementing workflows touching esg reporting systems.
...
## Access + Controls
- Confirm role and scope boundaries for esg reporting APIs/tools.
