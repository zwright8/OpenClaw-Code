# New Relic Domain Resource

## Domain Context
Use this reference when implementing workflows touching new relic systems.
...
## Access + Controls
- Confirm role and scope boundaries for new relic APIs/tools.
