# Nonprofit Program Ops Domain Resource

## Domain Context
Use this reference when implementing workflows touching nonprofit program ops systems.
...
## Access + Controls
- Confirm role and scope boundaries for nonprofit program ops APIs/tools.
