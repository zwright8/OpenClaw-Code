# Court Dockets Domain Resource

## Domain Context
Use this reference when implementing workflows touching court dockets systems.
...
## Access + Controls
- Confirm role and scope boundaries for court dockets APIs/tools.
