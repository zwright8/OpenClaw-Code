# Airline Operations Domain Resource

## Domain Context
Use this reference when implementing workflows touching airline operations systems.
...
## Access + Controls
- Confirm role and scope boundaries for airline operations APIs/tools.
