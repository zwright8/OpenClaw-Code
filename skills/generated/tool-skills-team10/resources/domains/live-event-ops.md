# Live Event Ops Domain Resource

## Domain Context
Use this reference when implementing workflows touching live event ops systems.
...
## Access + Controls
- Confirm role and scope boundaries for live event ops APIs/tools.
