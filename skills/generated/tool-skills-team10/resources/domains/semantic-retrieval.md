# Semantic Retrieval Domain Resource

## Domain Context
Use this reference when implementing workflows touching semantic retrieval systems.
...
## Access + Controls
- Confirm role and scope boundaries for semantic retrieval APIs/tools.
