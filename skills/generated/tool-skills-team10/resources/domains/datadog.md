# Datadog Domain Resource

## Domain Context
Use this reference when implementing workflows touching datadog systems.
...
## Access + Controls
- Confirm role and scope boundaries for datadog APIs/tools.
