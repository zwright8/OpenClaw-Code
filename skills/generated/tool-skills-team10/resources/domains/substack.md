# Substack Domain Resource

## Domain Context
Use this reference when implementing workflows touching substack systems.
...
## Access + Controls
- Confirm role and scope boundaries for substack APIs/tools.
