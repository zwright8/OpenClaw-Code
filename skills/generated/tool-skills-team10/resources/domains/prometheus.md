# Prometheus Domain Resource

## Domain Context
Use this reference when implementing workflows touching prometheus systems.
...
## Access + Controls
- Confirm role and scope boundaries for prometheus APIs/tools.
