# Taxonomy Services Domain Resource

## Domain Context
Use this reference when implementing workflows touching taxonomy services systems.
...
## Access + Controls
- Confirm role and scope boundaries for taxonomy services APIs/tools.
