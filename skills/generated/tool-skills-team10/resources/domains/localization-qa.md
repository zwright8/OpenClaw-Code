# Localization QA Domain Resource

## Domain Context
Use this reference when implementing workflows touching localization qa systems.
...
## Access + Controls
- Confirm role and scope boundaries for localization qa APIs/tools.
