# Accessibility Auditing Domain Resource

## Domain Context
Use this reference when implementing workflows touching accessibility auditing systems.
...
## Access + Controls
- Confirm role and scope boundaries for accessibility auditing APIs/tools.
