# Impact Measurement Domain Resource

## Domain Context
Use this reference when implementing workflows touching impact measurement systems.
...
## Access + Controls
- Confirm role and scope boundaries for impact measurement APIs/tools.
