# App Store Management Domain Resource

## Domain Context
Use this reference when implementing workflows touching app store management systems.
...
## Access + Controls
- Confirm role and scope boundaries for app store management APIs/tools.
