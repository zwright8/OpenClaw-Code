# Catalog Syndication Domain Resource

## Domain Context
Use this reference when implementing workflows touching catalog syndication systems.
...
## Access + Controls
- Confirm role and scope boundaries for catalog syndication APIs/tools.
