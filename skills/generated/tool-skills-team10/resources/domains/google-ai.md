# Google AI Domain Resource

## Domain Context
Use this reference when implementing workflows touching google ai systems.
...
## Access + Controls
- Confirm role and scope boundaries for google ai APIs/tools.
