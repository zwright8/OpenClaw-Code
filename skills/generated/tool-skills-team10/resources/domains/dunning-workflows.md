# Dunning Workflows Domain Resource

## Domain Context
Use this reference when implementing workflows touching dunning workflows systems.
...
## Access + Controls
- Confirm role and scope boundaries for dunning workflows APIs/tools.
