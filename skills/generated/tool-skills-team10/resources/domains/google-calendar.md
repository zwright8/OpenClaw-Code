# Google Calendar Domain Resource

## Domain Context
Use this reference when implementing workflows touching google calendar systems.
...
## Access + Controls
- Confirm role and scope boundaries for google calendar APIs/tools.
