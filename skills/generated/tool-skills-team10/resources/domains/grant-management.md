# Grant Management Domain Resource

## Domain Context
Use this reference when implementing workflows touching grant management systems.
...
## Access + Controls
- Confirm role and scope boundaries for grant management APIs/tools.
