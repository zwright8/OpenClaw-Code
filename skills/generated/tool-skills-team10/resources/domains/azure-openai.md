# Azure OpenAI Domain Resource

## Domain Context
Use this reference when implementing workflows touching azure openai systems.
...
## Access + Controls
- Confirm role and scope boundaries for azure openai APIs/tools.
