# MongoDB Domain Resource

## Domain Context
Use this reference when implementing workflows touching mongodb systems.
...
## Access + Controls
- Confirm role and scope boundaries for mongodb APIs/tools.
