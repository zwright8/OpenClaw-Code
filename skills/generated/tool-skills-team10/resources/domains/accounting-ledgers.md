# Accounting Ledgers Domain Resource

## Domain Context
Use this reference when implementing workflows touching accounting ledgers systems.
...
## Access + Controls
- Confirm role and scope boundaries for accounting ledgers APIs/tools.
