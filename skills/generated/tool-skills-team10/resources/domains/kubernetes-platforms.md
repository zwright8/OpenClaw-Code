# Kubernetes Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching kubernetes platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for kubernetes platforms APIs/tools.
