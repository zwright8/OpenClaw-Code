# Revenue Recognition Domain Resource

## Domain Context
Use this reference when implementing workflows touching revenue recognition systems.
...
## Access + Controls
- Confirm role and scope boundaries for revenue recognition APIs/tools.
