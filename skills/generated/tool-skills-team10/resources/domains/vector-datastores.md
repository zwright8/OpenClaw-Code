# Vector Datastores Domain Resource

## Domain Context
Use this reference when implementing workflows touching vector datastores systems.
...
## Access + Controls
- Confirm role and scope boundaries for vector datastores APIs/tools.
