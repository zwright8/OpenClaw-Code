# Portfolio Analytics Domain Resource

## Domain Context
Use this reference when implementing workflows touching portfolio analytics systems.
...
## Access + Controls
- Confirm role and scope boundaries for portfolio analytics APIs/tools.
