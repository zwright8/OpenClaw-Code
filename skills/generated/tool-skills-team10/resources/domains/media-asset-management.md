# Media Asset Management Domain Resource

## Domain Context
Use this reference when implementing workflows touching media asset management systems.
...
## Access + Controls
- Confirm role and scope boundaries for media asset management APIs/tools.
