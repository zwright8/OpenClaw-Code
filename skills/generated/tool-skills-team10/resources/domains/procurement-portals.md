# Procurement Portals Domain Resource

## Domain Context
Use this reference when implementing workflows touching procurement portals systems.
...
## Access + Controls
- Confirm role and scope boundaries for procurement portals APIs/tools.
