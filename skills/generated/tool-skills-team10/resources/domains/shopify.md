# Shopify Domain Resource

## Domain Context
Use this reference when implementing workflows touching shopify systems.
...
## Access + Controls
- Confirm role and scope boundaries for shopify APIs/tools.
