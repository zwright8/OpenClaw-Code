# Onboarding Journeys Domain Resource

## Domain Context
Use this reference when implementing workflows touching onboarding journeys systems.
...
## Access + Controls
- Confirm role and scope boundaries for onboarding journeys APIs/tools.
