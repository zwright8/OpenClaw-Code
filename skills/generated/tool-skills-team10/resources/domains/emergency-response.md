# Emergency Response Domain Resource

## Domain Context
Use this reference when implementing workflows touching emergency response systems.
...
## Access + Controls
- Confirm role and scope boundaries for emergency response APIs/tools.
