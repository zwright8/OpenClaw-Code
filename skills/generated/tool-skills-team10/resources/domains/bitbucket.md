# Bitbucket Domain Resource

## Domain Context
Use this reference when implementing workflows touching bitbucket systems.
...
## Access + Controls
- Confirm role and scope boundaries for bitbucket APIs/tools.
