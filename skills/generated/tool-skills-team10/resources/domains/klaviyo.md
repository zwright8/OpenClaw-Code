# Klaviyo Domain Resource

## Domain Context
Use this reference when implementing workflows touching klaviyo systems.
...
## Access + Controls
- Confirm role and scope boundaries for klaviyo APIs/tools.
