# Survey Systems Domain Resource

## Domain Context
Use this reference when implementing workflows touching survey systems systems.
...
## Access + Controls
- Confirm role and scope boundaries for survey systems APIs/tools.
