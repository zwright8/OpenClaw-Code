# Execution Monitoring Domain Resource

## Domain Context
Use this reference when implementing workflows touching execution monitoring systems.
...
## Access + Controls
- Confirm role and scope boundaries for execution monitoring APIs/tools.
