# Endpoint Security Domain Resource

## Domain Context
Use this reference when implementing workflows touching endpoint security systems.
...
## Access + Controls
- Confirm role and scope boundaries for endpoint security APIs/tools.
