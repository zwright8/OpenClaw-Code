# Hospitality PMS Domain Resource

## Domain Context
Use this reference when implementing workflows touching hospitality pms systems.
...
## Access + Controls
- Confirm role and scope boundaries for hospitality pms APIs/tools.
