# Billing Recovery Domain Resource

## Domain Context
Use this reference when implementing workflows touching billing recovery systems.
...
## Access + Controls
- Confirm role and scope boundaries for billing recovery APIs/tools.
