# Content Governance Domain Resource

## Domain Context
Use this reference when implementing workflows touching content governance systems.
...
## Access + Controls
- Confirm role and scope boundaries for content governance APIs/tools.
