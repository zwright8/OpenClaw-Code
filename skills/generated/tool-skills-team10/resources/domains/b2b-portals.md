# B2B Portals Domain Resource

## Domain Context
Use this reference when implementing workflows touching b2b portals systems.
...
## Access + Controls
- Confirm role and scope boundaries for b2b portals APIs/tools.
