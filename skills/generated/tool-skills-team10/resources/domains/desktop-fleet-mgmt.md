# Desktop Fleet Mgmt Domain Resource

## Domain Context
Use this reference when implementing workflows touching desktop fleet mgmt systems.
...
## Access + Controls
- Confirm role and scope boundaries for desktop fleet mgmt APIs/tools.
