# Admissions Systems Domain Resource

## Domain Context
Use this reference when implementing workflows touching admissions systems systems.
...
## Access + Controls
- Confirm role and scope boundaries for admissions systems APIs/tools.
