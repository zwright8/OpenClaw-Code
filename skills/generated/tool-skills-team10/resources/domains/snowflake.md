# Snowflake Domain Resource

## Domain Context
Use this reference when implementing workflows touching snowflake systems.
...
## Access + Controls
- Confirm role and scope boundaries for snowflake APIs/tools.
