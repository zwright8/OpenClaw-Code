# Work Order Systems Domain Resource

## Domain Context
Use this reference when implementing workflows touching work order systems systems.
...
## Access + Controls
- Confirm role and scope boundaries for work order systems APIs/tools.
