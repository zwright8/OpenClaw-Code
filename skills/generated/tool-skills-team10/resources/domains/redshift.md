# Redshift Domain Resource

## Domain Context
Use this reference when implementing workflows touching redshift systems.
...
## Access + Controls
- Confirm role and scope boundaries for redshift APIs/tools.
