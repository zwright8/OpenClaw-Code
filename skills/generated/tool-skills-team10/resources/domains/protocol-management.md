# Protocol Management Domain Resource

## Domain Context
Use this reference when implementing workflows touching protocol management systems.
...
## Access + Controls
- Confirm role and scope boundaries for protocol management APIs/tools.
