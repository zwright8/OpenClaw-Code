# Call Center Ops Domain Resource

## Domain Context
Use this reference when implementing workflows touching call center ops systems.
...
## Access + Controls
- Confirm role and scope boundaries for call center ops APIs/tools.
