# Customer Data Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching customer data platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for customer data platforms APIs/tools.
