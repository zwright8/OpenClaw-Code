# SCADA Monitoring Domain Resource

## Domain Context
Use this reference when implementing workflows touching scada monitoring systems.
...
## Access + Controls
- Confirm role and scope boundaries for scada monitoring APIs/tools.
