# SOAR Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching soar platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for soar platforms APIs/tools.
