# Records Retention Domain Resource

## Domain Context
Use this reference when implementing workflows touching records retention systems.
...
## Access + Controls
- Confirm role and scope boundaries for records retention APIs/tools.
