# Postmark Domain Resource

## Domain Context
Use this reference when implementing workflows touching postmark systems.
...
## Access + Controls
- Confirm role and scope boundaries for postmark APIs/tools.
