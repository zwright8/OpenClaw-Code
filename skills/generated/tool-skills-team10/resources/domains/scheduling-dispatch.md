# Scheduling Dispatch Domain Resource

## Domain Context
Use this reference when implementing workflows touching scheduling dispatch systems.
...
## Access + Controls
- Confirm role and scope boundaries for scheduling dispatch APIs/tools.
