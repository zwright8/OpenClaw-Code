# Patent Filings Domain Resource

## Domain Context
Use this reference when implementing workflows touching patent filings systems.
...
## Access + Controls
- Confirm role and scope boundaries for patent filings APIs/tools.
