# Churn Prevention Domain Resource

## Domain Context
Use this reference when implementing workflows touching churn prevention systems.
...
## Access + Controls
- Confirm role and scope boundaries for churn prevention APIs/tools.
