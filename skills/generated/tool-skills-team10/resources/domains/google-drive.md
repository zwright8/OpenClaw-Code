# Google Drive Domain Resource

## Domain Context
Use this reference when implementing workflows touching google drive systems.
...
## Access + Controls
- Confirm role and scope boundaries for google drive APIs/tools.
