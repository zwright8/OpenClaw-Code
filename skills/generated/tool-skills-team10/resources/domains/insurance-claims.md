# Insurance Claims Domain Resource

## Domain Context
Use this reference when implementing workflows touching insurance claims systems.
...
## Access + Controls
- Confirm role and scope boundaries for insurance claims APIs/tools.
