# Manufacturing MES Domain Resource

## Domain Context
Use this reference when implementing workflows touching manufacturing mes systems.
...
## Access + Controls
- Confirm role and scope boundaries for manufacturing mes APIs/tools.
