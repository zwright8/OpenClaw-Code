# Customs Processing Domain Resource

## Domain Context
Use this reference when implementing workflows touching customs processing systems.
...
## Access + Controls
- Confirm role and scope boundaries for customs processing APIs/tools.
