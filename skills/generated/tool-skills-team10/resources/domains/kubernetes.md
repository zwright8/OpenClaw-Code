# Kubernetes Domain Resource

## Domain Context
Use this reference when implementing workflows touching kubernetes systems.
...
## Access + Controls
- Confirm role and scope boundaries for kubernetes APIs/tools.
