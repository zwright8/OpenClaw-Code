# OneDrive Domain Resource

## Domain Context
Use this reference when implementing workflows touching onedrive systems.
...
## Access + Controls
- Confirm role and scope boundaries for onedrive APIs/tools.
