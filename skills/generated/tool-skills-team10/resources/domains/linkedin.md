# LinkedIn Domain Resource

## Domain Context
Use this reference when implementing workflows touching linkedin systems.
...
## Access + Controls
- Confirm role and scope boundaries for linkedin APIs/tools.
