# A/B Testing Domain Resource

## Domain Context
Use this reference when implementing workflows touching a/b testing systems.
...
## Access + Controls
- Confirm role and scope boundaries for a/b testing APIs/tools.
