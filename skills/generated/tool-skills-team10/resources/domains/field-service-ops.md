# Field Service Ops Domain Resource

## Domain Context
Use this reference when implementing workflows touching field service ops systems.
...
## Access + Controls
- Confirm role and scope boundaries for field service ops APIs/tools.
