# Dropbox Domain Resource

## Domain Context
Use this reference when implementing workflows touching dropbox systems.
...
## Access + Controls
- Confirm role and scope boundaries for dropbox APIs/tools.
