# Netlify Domain Resource

## Domain Context
Use this reference when implementing workflows touching netlify systems.
...
## Access + Controls
- Confirm role and scope boundaries for netlify APIs/tools.
