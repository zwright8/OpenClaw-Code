# Synthetic Data Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching synthetic data platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for synthetic data platforms APIs/tools.
