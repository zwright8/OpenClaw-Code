# VDI Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching vdi platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for vdi platforms APIs/tools.
