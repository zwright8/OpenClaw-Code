# Model Registries Domain Resource

## Domain Context
Use this reference when implementing workflows touching model registries systems.
...
## Access + Controls
- Confirm role and scope boundaries for model registries APIs/tools.
