# Maritime Routing Domain Resource

## Domain Context
Use this reference when implementing workflows touching maritime routing systems.
...
## Access + Controls
- Confirm role and scope boundaries for maritime routing APIs/tools.
