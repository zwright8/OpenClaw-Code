# Mailchimp Domain Resource

## Domain Context
Use this reference when implementing workflows touching mailchimp systems.
...
## Access + Controls
- Confirm role and scope boundaries for mailchimp APIs/tools.
