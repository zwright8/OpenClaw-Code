# 3D Asset Pipelines Domain Resource

## Domain Context
Use this reference when implementing workflows touching 3d asset pipelines systems.
...
## Access + Controls
- Confirm role and scope boundaries for 3d asset pipelines APIs/tools.
