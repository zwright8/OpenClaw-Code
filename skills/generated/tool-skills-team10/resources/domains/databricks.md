# Databricks Domain Resource

## Domain Context
Use this reference when implementing workflows touching databricks systems.
...
## Access + Controls
- Confirm role and scope boundaries for databricks APIs/tools.
