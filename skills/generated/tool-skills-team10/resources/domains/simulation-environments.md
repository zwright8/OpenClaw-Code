# Simulation Environments Domain Resource

## Domain Context
Use this reference when implementing workflows touching simulation environments systems.
...
## Access + Controls
- Confirm role and scope boundaries for simulation environments APIs/tools.
