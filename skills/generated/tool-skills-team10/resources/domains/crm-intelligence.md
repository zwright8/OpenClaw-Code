# CRM Intelligence Domain Resource

## Domain Context
Use this reference when implementing workflows touching crm intelligence systems.
...
## Access + Controls
- Confirm role and scope boundaries for crm intelligence APIs/tools.
