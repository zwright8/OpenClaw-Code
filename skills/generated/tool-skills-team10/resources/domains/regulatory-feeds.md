# Regulatory Feeds Domain Resource

## Domain Context
Use this reference when implementing workflows touching regulatory feeds systems.
...
## Access + Controls
- Confirm role and scope boundaries for regulatory feeds APIs/tools.
