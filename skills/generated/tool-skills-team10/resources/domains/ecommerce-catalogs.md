# Ecommerce Catalogs Domain Resource

## Domain Context
Use this reference when implementing workflows touching ecommerce catalogs systems.
...
## Access + Controls
- Confirm role and scope boundaries for ecommerce catalogs APIs/tools.
