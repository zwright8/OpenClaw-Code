# Sumo Logic Domain Resource

## Domain Context
Use this reference when implementing workflows touching sumo logic systems.
...
## Access + Controls
- Confirm role and scope boundaries for sumo logic APIs/tools.
