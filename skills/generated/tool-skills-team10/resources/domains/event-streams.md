# Event Streams Domain Resource

## Domain Context
Use this reference when implementing workflows touching event streams systems.
...
## Access + Controls
- Confirm role and scope boundaries for event streams APIs/tools.
