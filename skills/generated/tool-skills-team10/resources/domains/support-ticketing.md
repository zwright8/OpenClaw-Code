# Support Ticketing Domain Resource

## Domain Context
Use this reference when implementing workflows touching support ticketing systems.
...
## Access + Controls
- Confirm role and scope boundaries for support ticketing APIs/tools.
