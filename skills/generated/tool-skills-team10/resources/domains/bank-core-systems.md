# Bank Core Systems Domain Resource

## Domain Context
Use this reference when implementing workflows touching bank core systems systems.
...
## Access + Controls
- Confirm role and scope boundaries for bank core systems APIs/tools.
