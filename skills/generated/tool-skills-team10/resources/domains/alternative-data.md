# Alternative Data Domain Resource

## Domain Context
Use this reference when implementing workflows touching alternative data systems.
...
## Access + Controls
- Confirm role and scope boundaries for alternative data APIs/tools.
