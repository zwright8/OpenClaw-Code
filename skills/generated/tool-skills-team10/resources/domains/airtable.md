# Airtable Domain Resource

## Domain Context
Use this reference when implementing workflows touching airtable systems.
...
## Access + Controls
- Confirm role and scope boundaries for airtable APIs/tools.
