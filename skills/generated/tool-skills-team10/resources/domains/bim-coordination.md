# BIM Coordination Domain Resource

## Domain Context
Use this reference when implementing workflows touching bim coordination systems.
...
## Access + Controls
- Confirm role and scope boundaries for bim coordination APIs/tools.
