# SEO Tooling Domain Resource

## Domain Context
Use this reference when implementing workflows touching seo tooling systems.
...
## Access + Controls
- Confirm role and scope boundaries for seo tooling APIs/tools.
