# Device Labs Domain Resource

## Domain Context
Use this reference when implementing workflows touching device labs systems.
...
## Access + Controls
- Confirm role and scope boundaries for device labs APIs/tools.
