# BigCommerce Domain Resource

## Domain Context
Use this reference when implementing workflows touching bigcommerce systems.
...
## Access + Controls
- Confirm role and scope boundaries for bigcommerce APIs/tools.
