# Logistics Dispatch Domain Resource

## Domain Context
Use this reference when implementing workflows touching logistics dispatch systems.
...
## Access + Controls
- Confirm role and scope boundaries for logistics dispatch APIs/tools.
