# Behavior Analytics Domain Resource

## Domain Context
Use this reference when implementing workflows touching behavior analytics systems.
...
## Access + Controls
- Confirm role and scope boundaries for behavior analytics APIs/tools.
