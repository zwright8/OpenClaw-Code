# Lab Robotics Domain Resource

## Domain Context
Use this reference when implementing workflows touching lab robotics systems.
...
## Access + Controls
- Confirm role and scope boundaries for lab robotics APIs/tools.
