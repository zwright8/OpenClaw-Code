# Creator Platforms Domain Resource

## Domain Context
Use this reference when implementing workflows touching creator platforms systems.
...
## Access + Controls
- Confirm role and scope boundaries for creator platforms APIs/tools.
