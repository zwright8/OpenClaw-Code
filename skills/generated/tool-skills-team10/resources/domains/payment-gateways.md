# Payment Gateways Domain Resource

## Domain Context
Use this reference when implementing workflows touching payment gateways systems.
...
## Access + Controls
- Confirm role and scope boundaries for payment gateways APIs/tools.
