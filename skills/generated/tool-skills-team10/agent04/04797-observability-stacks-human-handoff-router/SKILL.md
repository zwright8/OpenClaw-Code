---
name: observability-stacks-human-handoff-router
description: Use when tasks require observability stacks human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Human Handoff Router

## Purpose
Design and execute observability stacks workflows using human handoff router controls with validated outcomes.
