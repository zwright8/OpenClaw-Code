---
name: soar-platforms-compliance-mapper
description: Use when tasks require soar platforms compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Compliance Mapper

## Purpose
Design and execute soar platforms workflows using compliance mapper controls with validated outcomes.
