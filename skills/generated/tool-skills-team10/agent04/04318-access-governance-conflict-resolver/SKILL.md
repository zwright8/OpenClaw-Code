---
name: access-governance-conflict-resolver
description: Use when tasks require access governance conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Conflict Resolver

## Purpose
Design and execute access governance workflows using conflict resolver controls with validated outcomes.
