---
name: endpoint-security-artifact-publisher
description: Use when tasks require endpoint security artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Artifact Publisher

## Purpose
Design and execute endpoint security workflows using artifact publisher controls with validated outcomes.
