---
name: incident-queues-dependency-resolver
description: Use when tasks require incident queues dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Dependency Resolver

## Purpose
Design and execute incident queues workflows using dependency resolver controls with validated outcomes.
