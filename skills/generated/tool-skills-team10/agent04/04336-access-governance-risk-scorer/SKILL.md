---
name: access-governance-risk-scorer
description: Use when tasks require access governance risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Risk Scorer

## Purpose
Design and execute access governance workflows using risk scorer controls with validated outcomes.
