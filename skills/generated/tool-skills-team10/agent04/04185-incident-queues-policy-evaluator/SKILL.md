---
name: incident-queues-policy-evaluator
description: Use when tasks require incident queues policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Policy Evaluator

## Purpose
Design and execute incident queues workflows using policy evaluator controls with validated outcomes.
