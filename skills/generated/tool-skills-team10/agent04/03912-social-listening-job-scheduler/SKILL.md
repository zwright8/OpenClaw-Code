---
name: social-listening-job-scheduler
description: Use when tasks require social listening job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Job Scheduler

## Purpose
Design and execute social listening workflows using job scheduler controls with validated outcomes.
