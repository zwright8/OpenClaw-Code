---
name: knowledge-bases-retry-governor
description: Use when tasks require knowledge bases retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Retry Governor

## Purpose
Design and execute knowledge bases workflows using retry governor controls with validated outcomes.
