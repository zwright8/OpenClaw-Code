---
name: support-ticketing-secret-scanner
description: Use when tasks require support ticketing secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Secret Scanner

## Purpose
Design and execute support ticketing workflows using secret scanner controls with validated outcomes.
