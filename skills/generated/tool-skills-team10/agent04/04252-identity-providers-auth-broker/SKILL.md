---
name: identity-providers-auth-broker
description: Use when tasks require identity providers auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Auth Broker

## Purpose
Design and execute identity providers workflows using auth broker controls with validated outcomes.
