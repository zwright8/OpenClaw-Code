---
name: error-tracking-auth-broker
description: Use when tasks require error tracking auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Auth Broker

## Purpose
Design and execute error tracking workflows using auth broker controls with validated outcomes.
