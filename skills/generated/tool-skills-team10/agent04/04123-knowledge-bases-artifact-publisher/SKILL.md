---
name: knowledge-bases-artifact-publisher
description: Use when tasks require knowledge bases artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Artifact Publisher

## Purpose
Design and execute knowledge bases workflows using artifact publisher controls with validated outcomes.
