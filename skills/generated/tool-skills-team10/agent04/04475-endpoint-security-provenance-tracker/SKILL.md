---
name: endpoint-security-provenance-tracker
description: Use when tasks require endpoint security provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Provenance Tracker

## Purpose
Design and execute endpoint security workflows using provenance tracker controls with validated outcomes.
