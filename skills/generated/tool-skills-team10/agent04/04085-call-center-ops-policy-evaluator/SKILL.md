---
name: call-center-ops-policy-evaluator
description: Use when tasks require call center ops policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Policy Evaluator

## Purpose
Design and execute call center ops workflows using policy evaluator controls with validated outcomes.
