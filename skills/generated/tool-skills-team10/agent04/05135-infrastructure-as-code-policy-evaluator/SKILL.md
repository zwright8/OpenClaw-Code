---
name: infrastructure-as-code-policy-evaluator
description: Use when tasks require infrastructure as code policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Policy Evaluator

## Purpose
Design and execute infrastructure as code workflows using policy evaluator controls with validated outcomes.
