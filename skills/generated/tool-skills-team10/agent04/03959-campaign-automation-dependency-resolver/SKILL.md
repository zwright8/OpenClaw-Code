---
name: campaign-automation-dependency-resolver
description: Use when tasks require campaign automation dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Dependency Resolver

## Purpose
Design and execute campaign automation workflows using dependency resolver controls with validated outcomes.
