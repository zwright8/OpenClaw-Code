---
name: secrets-vaults-auth-broker
description: Use when tasks require secrets vaults auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Auth Broker

## Purpose
Design and execute secrets vaults workflows using auth broker controls with validated outcomes.
