---
name: secrets-vaults-dependency-resolver
description: Use when tasks require secrets vaults dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Dependency Resolver

## Purpose
Design and execute secrets vaults workflows using dependency resolver controls with validated outcomes.
