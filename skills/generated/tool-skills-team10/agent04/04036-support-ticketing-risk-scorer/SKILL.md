---
name: support-ticketing-risk-scorer
description: Use when tasks require support ticketing risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Risk Scorer

## Purpose
Design and execute support ticketing workflows using risk scorer controls with validated outcomes.
