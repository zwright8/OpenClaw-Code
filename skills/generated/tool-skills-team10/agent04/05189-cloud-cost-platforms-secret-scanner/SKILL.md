---
name: cloud-cost-platforms-secret-scanner
description: Use when tasks require cloud cost platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Cloud Cost Platforms Secret Scanner

## Purpose
Design and execute cloud cost platforms workflows using secret scanner controls with validated outcomes.
