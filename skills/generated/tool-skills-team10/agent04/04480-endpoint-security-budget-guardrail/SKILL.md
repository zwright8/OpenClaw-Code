---
name: endpoint-security-budget-guardrail
description: Use when tasks require endpoint security budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Budget Guardrail

## Purpose
Design and execute endpoint security workflows using budget guardrail controls with validated outcomes.
