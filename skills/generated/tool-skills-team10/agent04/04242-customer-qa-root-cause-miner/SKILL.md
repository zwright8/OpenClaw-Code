---
name: customer-qa-root-cause-miner
description: Use when tasks require customer qa root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Root Cause Miner

## Purpose
Design and execute customer qa workflows using root cause miner controls with validated outcomes.
