---
name: secrets-vaults-spec-drift-detector
description: Use when tasks require secrets vaults spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Spec Drift Detector

## Purpose
Design and execute secrets vaults workflows using spec drift detector controls with validated outcomes.
