---
name: customer-qa-snapshot-manager
description: Use when tasks require customer qa snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Snapshot Manager

## Purpose
Design and execute customer qa workflows using snapshot manager controls with validated outcomes.
