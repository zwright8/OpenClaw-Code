---
name: social-listening-spec-drift-detector
description: Use when tasks require social listening spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Spec Drift Detector

## Purpose
Design and execute social listening workflows using spec drift detector controls with validated outcomes.
