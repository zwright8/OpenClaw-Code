---
name: serverless-runtimes-human-handoff-router
description: Use when tasks require serverless runtimes human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Serverless Runtimes Human Handoff Router

## Purpose
Design and execute serverless runtimes workflows using human handoff router controls with validated outcomes.
