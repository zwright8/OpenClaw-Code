---
name: identity-providers-execution-runner
description: Use when tasks require identity providers execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Execution Runner

## Purpose
Design and execute identity providers workflows using execution runner controls with validated outcomes.
