---
name: threat-intel-feeds-task-decomposer
description: Use when tasks require threat intel feeds task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Task Decomposer

## Purpose
Design and execute threat intel feeds workflows using task decomposer controls with validated outcomes.
