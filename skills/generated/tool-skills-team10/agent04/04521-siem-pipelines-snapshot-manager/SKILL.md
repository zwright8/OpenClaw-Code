---
name: siem-pipelines-snapshot-manager
description: Use when tasks require siem pipelines snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Snapshot Manager

## Purpose
Design and execute siem pipelines workflows using snapshot manager controls with validated outcomes.
