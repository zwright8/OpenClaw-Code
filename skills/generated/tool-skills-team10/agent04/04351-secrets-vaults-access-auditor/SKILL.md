---
name: secrets-vaults-access-auditor
description: Use when tasks require secrets vaults access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Access Auditor

## Purpose
Design and execute secrets vaults workflows using access auditor controls with validated outcomes.
