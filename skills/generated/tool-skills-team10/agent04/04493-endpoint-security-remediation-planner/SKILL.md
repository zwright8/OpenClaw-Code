---
name: endpoint-security-remediation-planner
description: Use when tasks require endpoint security remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Remediation Planner

## Purpose
Design and execute endpoint security workflows using remediation planner controls with validated outcomes.
