---
name: apm-pipelines-workflow-compiler
description: Use when tasks require apm pipelines workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Workflow Compiler

## Purpose
Design and execute apm pipelines workflows using workflow compiler controls with validated outcomes.
