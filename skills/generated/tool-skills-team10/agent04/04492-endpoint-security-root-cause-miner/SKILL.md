---
name: endpoint-security-root-cause-miner
description: Use when tasks require endpoint security root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Root Cause Miner

## Purpose
Design and execute endpoint security workflows using root cause miner controls with validated outcomes.
