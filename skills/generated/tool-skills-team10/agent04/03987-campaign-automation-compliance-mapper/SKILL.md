---
name: campaign-automation-compliance-mapper
description: Use when tasks require campaign automation compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Compliance Mapper

## Purpose
Design and execute campaign automation workflows using compliance mapper controls with validated outcomes.
