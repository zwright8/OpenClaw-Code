---
name: apm-pipelines-quality-gatekeeper
description: Use when tasks require apm pipelines quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Quality Gatekeeper

## Purpose
Design and execute apm pipelines workflows using quality gatekeeper controls with validated outcomes.
