---
name: siem-pipelines-human-handoff-router
description: Use when tasks require siem pipelines human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Human Handoff Router

## Purpose
Design and execute siem pipelines workflows using human handoff router controls with validated outcomes.
