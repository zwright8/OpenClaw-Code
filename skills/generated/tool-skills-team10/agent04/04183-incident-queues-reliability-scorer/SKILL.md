---
name: incident-queues-reliability-scorer
description: Use when tasks require incident queues reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Reliability Scorer

## Purpose
Design and execute incident queues workflows using reliability scorer controls with validated outcomes.
