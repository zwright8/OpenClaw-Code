---
name: access-governance-task-decomposer
description: Use when tasks require access governance task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Task Decomposer

## Purpose
Design and execute access governance workflows using task decomposer controls with validated outcomes.
