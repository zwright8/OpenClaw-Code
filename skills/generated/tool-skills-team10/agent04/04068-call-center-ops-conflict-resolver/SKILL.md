---
name: call-center-ops-conflict-resolver
description: Use when tasks require call center ops conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Conflict Resolver

## Purpose
Design and execute call center ops workflows using conflict resolver controls with validated outcomes.
