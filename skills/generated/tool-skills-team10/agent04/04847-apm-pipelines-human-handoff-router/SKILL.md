---
name: apm-pipelines-human-handoff-router
description: Use when tasks require apm pipelines human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Human Handoff Router

## Purpose
Design and execute apm pipelines workflows using human handoff router controls with validated outcomes.
