---
name: endpoint-security-rate-limit-optimizer
description: Use when tasks require endpoint security rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Rate Limit Optimizer

## Purpose
Design and execute endpoint security workflows using rate limit optimizer controls with validated outcomes.
