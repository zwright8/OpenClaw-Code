---
name: knowledge-bases-risk-scorer
description: Use when tasks require knowledge bases risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Risk Scorer

## Purpose
Design and execute knowledge bases workflows using risk scorer controls with validated outcomes.
