---
name: knowledge-bases-runbook-composer
description: Use when tasks require knowledge bases runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Runbook Composer

## Purpose
Design and execute knowledge bases workflows using runbook composer controls with validated outcomes.
