---
name: social-listening-incident-triage
description: Use when tasks require social listening incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Incident Triage

## Purpose
Design and execute social listening workflows using incident triage controls with validated outcomes.
