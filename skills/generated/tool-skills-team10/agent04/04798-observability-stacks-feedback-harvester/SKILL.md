---
name: observability-stacks-feedback-harvester
description: Use when tasks require observability stacks feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Feedback Harvester

## Purpose
Design and execute observability stacks workflows using feedback harvester controls with validated outcomes.
