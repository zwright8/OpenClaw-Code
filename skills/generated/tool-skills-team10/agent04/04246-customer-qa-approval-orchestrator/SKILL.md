---
name: customer-qa-approval-orchestrator
description: Use when tasks require customer qa approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Approval Orchestrator

## Purpose
Design and execute customer qa workflows using approval orchestrator controls with validated outcomes.
