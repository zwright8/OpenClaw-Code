---
name: siem-pipelines-rate-limit-optimizer
description: Use when tasks require siem pipelines rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Rate Limit Optimizer

## Purpose
Design and execute siem pipelines workflows using rate limit optimizer controls with validated outcomes.
