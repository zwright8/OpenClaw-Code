---
name: apm-pipelines-version-tracker
description: Use when tasks require apm pipelines version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Version Tracker

## Purpose
Design and execute apm pipelines workflows using version tracker controls with validated outcomes.
