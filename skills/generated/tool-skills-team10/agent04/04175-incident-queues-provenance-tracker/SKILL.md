---
name: incident-queues-provenance-tracker
description: Use when tasks require incident queues provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Provenance Tracker

## Purpose
Design and execute incident queues workflows using provenance tracker controls with validated outcomes.
