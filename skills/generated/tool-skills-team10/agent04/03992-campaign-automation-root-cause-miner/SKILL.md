---
name: campaign-automation-root-cause-miner
description: Use when tasks require campaign automation root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Root Cause Miner

## Purpose
Design and execute campaign automation workflows using root cause miner controls with validated outcomes.
