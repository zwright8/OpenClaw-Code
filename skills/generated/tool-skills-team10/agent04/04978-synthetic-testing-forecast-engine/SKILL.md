---
name: synthetic-testing-forecast-engine
description: Use when tasks require synthetic testing forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Forecast Engine

## Purpose
Design and execute synthetic testing workflows using forecast engine controls with validated outcomes.
