---
name: campaign-automation-reliability-scorer
description: Use when tasks require campaign automation reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Reliability Scorer

## Purpose
Design and execute campaign automation workflows using reliability scorer controls with validated outcomes.
