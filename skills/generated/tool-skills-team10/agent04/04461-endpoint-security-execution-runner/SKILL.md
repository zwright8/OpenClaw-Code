---
name: endpoint-security-execution-runner
description: Use when tasks require endpoint security execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Execution Runner

## Purpose
Design and execute endpoint security workflows using execution runner controls with validated outcomes.
