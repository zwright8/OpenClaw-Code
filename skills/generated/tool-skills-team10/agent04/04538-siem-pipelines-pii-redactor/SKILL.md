---
name: siem-pipelines-pii-redactor
description: Use when tasks require siem pipelines pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines PII Redactor

## Purpose
Design and execute siem pipelines workflows using pii redactor controls with validated outcomes.
