---
name: call-center-ops-pii-redactor
description: Use when tasks require call center ops pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops PII Redactor

## Purpose
Design and execute call center ops workflows using pii redactor controls with validated outcomes.
