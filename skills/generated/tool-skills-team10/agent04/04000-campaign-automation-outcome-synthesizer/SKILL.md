---
name: campaign-automation-outcome-synthesizer
description: Use when tasks require campaign automation outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Outcome Synthesizer

## Purpose
Design and execute campaign automation workflows using outcome synthesizer controls with validated outcomes.
