---
name: apm-pipelines-auth-broker
description: Use when tasks require apm pipelines auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Auth Broker

## Purpose
Design and execute apm pipelines workflows using auth broker controls with validated outcomes.
