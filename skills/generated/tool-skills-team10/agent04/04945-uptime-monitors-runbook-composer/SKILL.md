---
name: uptime-monitors-runbook-composer
description: Use when tasks require uptime monitors runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Runbook Composer

## Purpose
Design and execute uptime monitors workflows using runbook composer controls with validated outcomes.
