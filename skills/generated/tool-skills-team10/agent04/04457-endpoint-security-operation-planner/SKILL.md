---
name: endpoint-security-operation-planner
description: Use when tasks require endpoint security operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Operation Planner

## Purpose
Design and execute endpoint security workflows using operation planner controls with validated outcomes.
