---
name: observability-stacks-remediation-planner
description: Use when tasks require observability stacks remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Remediation Planner

## Purpose
Design and execute observability stacks workflows using remediation planner controls with validated outcomes.
