---
name: observability-stacks-compliance-mapper
description: Use when tasks require observability stacks compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Compliance Mapper

## Purpose
Design and execute observability stacks workflows using compliance mapper controls with validated outcomes.
