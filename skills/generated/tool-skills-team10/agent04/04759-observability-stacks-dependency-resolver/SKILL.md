---
name: observability-stacks-dependency-resolver
description: Use when tasks require observability stacks dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Dependency Resolver

## Purpose
Design and execute observability stacks workflows using dependency resolver controls with validated outcomes.
