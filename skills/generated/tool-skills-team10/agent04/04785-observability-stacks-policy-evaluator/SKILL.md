---
name: observability-stacks-policy-evaluator
description: Use when tasks require observability stacks policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Policy Evaluator

## Purpose
Design and execute observability stacks workflows using policy evaluator controls with validated outcomes.
