---
name: secrets-vaults-policy-evaluator
description: Use when tasks require secrets vaults policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Policy Evaluator

## Purpose
Design and execute secrets vaults workflows using policy evaluator controls with validated outcomes.
