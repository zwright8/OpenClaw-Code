---
name: call-center-ops-feedback-harvester
description: Use when tasks require call center ops feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Feedback Harvester

## Purpose
Design and execute call center ops workflows using feedback harvester controls with validated outcomes.
