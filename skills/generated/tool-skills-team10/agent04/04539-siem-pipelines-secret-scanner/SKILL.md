---
name: siem-pipelines-secret-scanner
description: Use when tasks require siem pipelines secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Secret Scanner

## Purpose
Design and execute siem pipelines workflows using secret scanner controls with validated outcomes.
