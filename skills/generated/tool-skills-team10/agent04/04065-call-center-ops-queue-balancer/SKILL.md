---
name: call-center-ops-queue-balancer
description: Use when tasks require call center ops queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Queue Balancer

## Purpose
Design and execute call center ops workflows using queue balancer controls with validated outcomes.
