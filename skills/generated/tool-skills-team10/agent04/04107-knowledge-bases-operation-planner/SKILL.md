---
name: knowledge-bases-operation-planner
description: Use when tasks require knowledge bases operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Operation Planner

## Purpose
Design and execute knowledge bases workflows using operation planner controls with validated outcomes.
