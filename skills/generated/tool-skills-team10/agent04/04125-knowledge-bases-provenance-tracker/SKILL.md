---
name: knowledge-bases-provenance-tracker
description: Use when tasks require knowledge bases provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Provenance Tracker

## Purpose
Design and execute knowledge bases workflows using provenance tracker controls with validated outcomes.
