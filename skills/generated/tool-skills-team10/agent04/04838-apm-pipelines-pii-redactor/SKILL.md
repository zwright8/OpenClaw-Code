---
name: apm-pipelines-pii-redactor
description: Use when tasks require apm pipelines pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines PII Redactor

## Purpose
Design and execute apm pipelines workflows using pii redactor controls with validated outcomes.
