---
name: infrastructure-as-code-secret-scanner
description: Use when tasks require infrastructure as code secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Secret Scanner

## Purpose
Design and execute infrastructure as code workflows using secret scanner controls with validated outcomes.
