---
name: error-tracking-rate-limit-optimizer
description: Use when tasks require error tracking rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Rate Limit Optimizer

## Purpose
Design and execute error tracking workflows using rate limit optimizer controls with validated outcomes.
