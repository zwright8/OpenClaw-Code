---
name: threat-intel-feeds-access-auditor
description: Use when tasks require threat intel feeds access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Access Auditor

## Purpose
Design and execute threat intel feeds workflows using access auditor controls with validated outcomes.
