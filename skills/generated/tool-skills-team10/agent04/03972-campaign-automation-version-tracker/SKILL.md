---
name: campaign-automation-version-tracker
description: Use when tasks require campaign automation version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Version Tracker

## Purpose
Design and execute campaign automation workflows using version tracker controls with validated outcomes.
