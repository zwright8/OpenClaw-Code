---
name: apm-pipelines-task-decomposer
description: Use when tasks require apm pipelines task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Task Decomposer

## Purpose
Design and execute apm pipelines workflows using task decomposer controls with validated outcomes.
