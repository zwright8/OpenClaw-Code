---
name: soar-platforms-risk-scorer
description: Use when tasks require soar platforms risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Risk Scorer

## Purpose
Design and execute soar platforms workflows using risk scorer controls with validated outcomes.
