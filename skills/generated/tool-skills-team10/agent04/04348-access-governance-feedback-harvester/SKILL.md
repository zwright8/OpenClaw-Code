---
name: access-governance-feedback-harvester
description: Use when tasks require access governance feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Feedback Harvester

## Purpose
Design and execute access governance workflows using feedback harvester controls with validated outcomes.
