---
name: identity-providers-artifact-publisher
description: Use when tasks require identity providers artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Artifact Publisher

## Purpose
Design and execute identity providers workflows using artifact publisher controls with validated outcomes.
