---
name: incident-queues-root-cause-miner
description: Use when tasks require incident queues root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Root Cause Miner

## Purpose
Design and execute incident queues workflows using root cause miner controls with validated outcomes.
