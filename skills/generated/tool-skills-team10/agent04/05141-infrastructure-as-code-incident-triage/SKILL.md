...
description: Use when tasks require infrastructure as code incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Incident Triage

## Purpose
Design and execute infrastructure as code workflows using incident triage controls with validated outcomes.
