---
name: endpoint-security-dependency-resolver
description: Use when tasks require endpoint security dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Dependency Resolver

## Purpose
Design and execute endpoint security workflows using dependency resolver controls with validated outcomes.
