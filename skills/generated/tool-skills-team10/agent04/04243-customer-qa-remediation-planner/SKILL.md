---
name: customer-qa-remediation-planner
description: Use when tasks require customer qa remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Remediation Planner

## Purpose
Design and execute customer qa workflows using remediation planner controls with validated outcomes.
