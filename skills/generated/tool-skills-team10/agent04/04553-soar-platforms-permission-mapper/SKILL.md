---
name: soar-platforms-permission-mapper
description: Use when tasks require soar platforms permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Permission Mapper

## Purpose
Design and execute soar platforms workflows using permission mapper controls with validated outcomes.
