---
name: threat-intel-feeds-outcome-synthesizer
description: Use when tasks require threat intel feeds outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Outcome Synthesizer

## Purpose
Design and execute threat intel feeds workflows using outcome synthesizer controls with validated outcomes.
