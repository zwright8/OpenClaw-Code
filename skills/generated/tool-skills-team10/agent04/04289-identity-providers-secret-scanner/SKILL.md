---
name: identity-providers-secret-scanner
description: Use when tasks require identity providers secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Secret Scanner

## Purpose
Design and execute identity providers workflows using secret scanner controls with validated outcomes.
