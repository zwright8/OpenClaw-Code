---
name: endpoint-security-approval-orchestrator
description: Use when tasks require endpoint security approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Approval Orchestrator

## Purpose
Design and execute endpoint security workflows using approval orchestrator controls with validated outcomes.
