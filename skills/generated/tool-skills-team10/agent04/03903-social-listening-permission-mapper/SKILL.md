---
name: social-listening-permission-mapper
description: Use when tasks require social listening permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Permission Mapper

## Purpose
Design and execute social listening workflows using permission mapper controls with validated outcomes.
