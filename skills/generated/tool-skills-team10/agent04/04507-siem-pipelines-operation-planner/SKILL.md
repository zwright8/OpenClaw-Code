---
name: siem-pipelines-operation-planner
description: Use when tasks require siem pipelines operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Operation Planner

## Purpose
Design and execute siem pipelines workflows using operation planner controls with validated outcomes.
