---
name: kubernetes-platforms-evidence-collector
description: Use when tasks require kubernetes platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Kubernetes Platforms Evidence Collector

## Purpose
Design and execute kubernetes platforms workflows using evidence collector controls with validated outcomes.
