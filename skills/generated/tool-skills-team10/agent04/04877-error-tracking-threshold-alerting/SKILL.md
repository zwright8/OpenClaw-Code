---
name: error-tracking-threshold-alerting
description: Use when tasks require error tracking threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Threshold Alerting

## Purpose
Design and execute error tracking workflows using threshold alerting controls with validated outcomes.
