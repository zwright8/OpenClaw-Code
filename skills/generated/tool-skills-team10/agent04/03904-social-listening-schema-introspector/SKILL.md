---
name: social-listening-schema-introspector
description: Use when tasks require social listening schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Schema Introspector

## Purpose
Design and execute social listening workflows using schema introspector controls with validated outcomes.
