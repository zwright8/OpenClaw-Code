---
name: policy-engines-auth-broker
description: Use when tasks require policy engines auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Engines Auth Broker

## Purpose
Design and execute policy engines workflows using auth broker controls with validated outcomes.
