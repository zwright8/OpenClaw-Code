---
name: incident-queues-compliance-mapper
description: Use when tasks require incident queues compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Compliance Mapper

## Purpose
Design and execute incident queues workflows using compliance mapper controls with validated outcomes.
