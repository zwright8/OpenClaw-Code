---
name: incident-queues-permission-mapper
description: Use when tasks require incident queues permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Permission Mapper

## Purpose
Design and execute incident queues workflows using permission mapper controls with validated outcomes.
