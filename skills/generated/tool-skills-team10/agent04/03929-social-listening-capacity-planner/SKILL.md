---
name: social-listening-capacity-planner
description: Use when tasks require social listening capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Capacity Planner

## Purpose
Design and execute social listening workflows using capacity planner controls with validated outcomes.
