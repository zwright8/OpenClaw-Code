---
name: incident-queues-rollback-coordinator
description: Use when tasks require incident queues rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Rollback Coordinator

## Purpose
Design and execute incident queues workflows using rollback coordinator controls with validated outcomes.
