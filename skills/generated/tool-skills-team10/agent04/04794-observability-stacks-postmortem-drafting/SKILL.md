---
name: observability-stacks-postmortem-drafting
description: Use when tasks require observability stacks postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Postmortem Drafting

## Purpose
Design and execute observability stacks workflows using postmortem drafting controls with validated outcomes.
