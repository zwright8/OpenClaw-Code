---
name: knowledge-bases-human-handoff-router
description: Use when tasks require knowledge bases human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Human Handoff Router

## Purpose
Design and execute knowledge bases workflows using human handoff router controls with validated outcomes.
