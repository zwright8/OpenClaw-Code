---
name: apm-pipelines-budget-guardrail
description: Use when tasks require apm pipelines budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Budget Guardrail

## Purpose
Design and execute apm pipelines workflows using budget guardrail controls with validated outcomes.
