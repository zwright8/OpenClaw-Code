---
name: call-center-ops-spec-drift-detector
description: Use when tasks require call center ops spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Spec Drift Detector

## Purpose
Design and execute call center ops workflows using spec drift detector controls with validated outcomes.
