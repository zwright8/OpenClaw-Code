---
name: synthetic-testing-approval-orchestrator
description: Use when tasks require synthetic testing approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Approval Orchestrator

## Purpose
Design and execute synthetic testing workflows using approval orchestrator controls with validated outcomes.
