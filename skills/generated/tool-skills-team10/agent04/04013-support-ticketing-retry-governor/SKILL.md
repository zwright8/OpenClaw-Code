---
name: support-ticketing-retry-governor
description: Use when tasks require support ticketing retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Retry Governor

## Purpose
Design and execute support ticketing workflows using retry governor controls with validated outcomes.
