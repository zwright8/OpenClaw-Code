---
name: apm-pipelines-api-contract-validator
description: Use when tasks require apm pipelines api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines API Contract Validator

## Purpose
Design and execute apm pipelines workflows using api contract validator controls with validated outcomes.
