---
name: support-ticketing-postmortem-drafting
description: Use when tasks require support ticketing postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Postmortem Drafting

## Purpose
Design and execute support ticketing workflows using postmortem drafting controls with validated outcomes.
