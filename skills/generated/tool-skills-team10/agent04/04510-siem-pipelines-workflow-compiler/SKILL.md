---
name: siem-pipelines-workflow-compiler
description: Use when tasks require siem pipelines workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Workflow Compiler

## Purpose
Design and execute siem pipelines workflows using workflow compiler controls with validated outcomes.
