---
name: uptime-monitors-root-cause-miner
description: Use when tasks require uptime monitors root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Root Cause Miner

## Purpose
Design and execute uptime monitors workflows using root cause miner controls with validated outcomes.
