---
name: apm-pipelines-rate-limit-optimizer
description: Use when tasks require apm pipelines rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Rate Limit Optimizer

## Purpose
Design and execute apm pipelines workflows using rate limit optimizer controls with validated outcomes.
