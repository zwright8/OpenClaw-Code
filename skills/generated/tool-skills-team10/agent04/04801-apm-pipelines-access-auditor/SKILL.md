---
name: apm-pipelines-access-auditor
description: Use when tasks require apm pipelines access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Access Auditor

## Purpose
Design and execute apm pipelines workflows using access auditor controls with validated outcomes.
