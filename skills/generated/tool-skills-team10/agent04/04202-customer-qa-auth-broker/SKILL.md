---
name: customer-qa-auth-broker
description: Use when tasks require customer qa auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Auth Broker

## Purpose
Design and execute customer qa workflows using auth broker controls with validated outcomes.
