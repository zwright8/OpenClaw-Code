---
name: observability-stacks-cost-attribution
description: Use when tasks require observability stacks cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Cost Attribution

## Purpose
Design and execute observability stacks workflows using cost attribution controls with validated outcomes.
