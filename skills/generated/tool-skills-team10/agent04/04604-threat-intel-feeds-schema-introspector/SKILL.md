---
name: threat-intel-feeds-schema-introspector
description: Use when tasks require threat intel feeds schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Schema Introspector

## Purpose
Design and execute threat intel feeds workflows using schema introspector controls with validated outcomes.
