---
name: call-center-ops-risk-scorer
description: Use when tasks require call center ops risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Risk Scorer

## Purpose
Design and execute call center ops workflows using risk scorer controls with validated outcomes.
