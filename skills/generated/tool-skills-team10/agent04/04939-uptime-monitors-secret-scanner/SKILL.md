---
name: uptime-monitors-secret-scanner
description: Use when tasks require uptime monitors secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Secret Scanner

## Purpose
Design and execute uptime monitors workflows using secret scanner controls with validated outcomes.
