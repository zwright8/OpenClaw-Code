---
name: certificate-management-approval-orchestrator
description: Use when tasks require certificate management approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Certificate Management Approval Orchestrator

## Purpose
Design and execute certificate management workflows using approval orchestrator controls with validated outcomes.
