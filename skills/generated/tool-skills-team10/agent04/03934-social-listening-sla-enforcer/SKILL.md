---
name: social-listening-sla-enforcer
description: Use when tasks require social listening sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening SLA Enforcer

## Purpose
Design and execute social listening workflows using sla enforcer controls with validated outcomes.
