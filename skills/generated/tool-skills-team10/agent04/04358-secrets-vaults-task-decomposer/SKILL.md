---
name: secrets-vaults-task-decomposer
description: Use when tasks require secrets vaults task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Task Decomposer

## Purpose
Design and execute secrets vaults workflows using task decomposer controls with validated outcomes.
