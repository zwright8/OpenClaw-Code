---
name: social-listening-api-contract-validator
description: Use when tasks require social listening api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening API Contract Validator

## Purpose
Design and execute social listening workflows using api contract validator controls with validated outcomes.
...
- Domain: [Social Listening](../../resources/domains/social-listening.md)
