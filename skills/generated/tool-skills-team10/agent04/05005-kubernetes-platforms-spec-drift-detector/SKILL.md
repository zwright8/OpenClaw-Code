---
name: kubernetes-platforms-spec-drift-detector
description: Use when tasks require kubernetes platforms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Kubernetes Platforms Spec Drift Detector

## Purpose
Design and execute kubernetes platforms workflows using spec drift detector controls with validated outcomes.
