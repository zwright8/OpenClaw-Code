---
name: siem-pipelines-conflict-resolver
description: Use when tasks require siem pipelines conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Conflict Resolver

## Purpose
Design and execute siem pipelines workflows using conflict resolver controls with validated outcomes.
