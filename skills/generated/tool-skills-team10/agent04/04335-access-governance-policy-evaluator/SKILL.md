---
name: access-governance-policy-evaluator
description: Use when tasks require access governance policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Policy Evaluator

## Purpose
Design and execute access governance workflows using policy evaluator controls with validated outcomes.
