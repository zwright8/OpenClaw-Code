---
name: endpoint-security-postmortem-drafting
description: Use when tasks require endpoint security postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Postmortem Drafting

## Purpose
Design and execute endpoint security workflows using postmortem drafting controls with validated outcomes.
