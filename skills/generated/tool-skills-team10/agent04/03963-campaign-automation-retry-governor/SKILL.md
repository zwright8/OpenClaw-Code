---
name: campaign-automation-retry-governor
description: Use when tasks require campaign automation retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Retry Governor

## Purpose
Design and execute campaign automation workflows using retry governor controls with validated outcomes.
