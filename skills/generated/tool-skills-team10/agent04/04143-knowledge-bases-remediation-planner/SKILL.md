---
name: knowledge-bases-remediation-planner
description: Use when tasks require knowledge bases remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Remediation Planner

## Purpose
Design and execute knowledge bases workflows using remediation planner controls with validated outcomes.
