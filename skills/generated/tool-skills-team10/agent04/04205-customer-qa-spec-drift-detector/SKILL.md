---
name: customer-qa-spec-drift-detector
description: Use when tasks require customer qa spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Spec Drift Detector

## Purpose
Design and execute customer qa workflows using spec drift detector controls with validated outcomes.
