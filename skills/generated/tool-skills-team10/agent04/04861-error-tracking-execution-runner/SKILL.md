---
name: error-tracking-execution-runner
description: Use when tasks require error tracking execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Execution Runner

## Purpose
Design and execute error tracking workflows using execution runner controls with validated outcomes.
