---
name: secrets-vaults-remediation-planner
description: Use when tasks require secrets vaults remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Remediation Planner

## Purpose
Design and execute secrets vaults workflows using remediation planner controls with validated outcomes.
