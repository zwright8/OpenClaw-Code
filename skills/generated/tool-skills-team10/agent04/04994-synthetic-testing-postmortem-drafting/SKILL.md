---
name: synthetic-testing-postmortem-drafting
description: Use when tasks require synthetic testing postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Postmortem Drafting

## Purpose
Design and execute synthetic testing workflows using postmortem drafting controls with validated outcomes.
