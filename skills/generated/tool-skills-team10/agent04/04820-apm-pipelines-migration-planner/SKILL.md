---
name: apm-pipelines-migration-planner
description: Use when tasks require apm pipelines migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Migration Planner

## Purpose
Design and execute apm pipelines workflows using migration planner controls with validated outcomes.
