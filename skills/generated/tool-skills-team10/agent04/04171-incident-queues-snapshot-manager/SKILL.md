---
name: incident-queues-snapshot-manager
description: Use when tasks require incident queues snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Snapshot Manager

## Purpose
Design and execute incident queues workflows using snapshot manager controls with validated outcomes.
