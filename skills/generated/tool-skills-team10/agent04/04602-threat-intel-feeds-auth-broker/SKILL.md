---
name: threat-intel-feeds-auth-broker
description: Use when tasks require threat intel feeds auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Auth Broker

## Purpose
Design and execute threat intel feeds workflows using auth broker controls with validated outcomes.
