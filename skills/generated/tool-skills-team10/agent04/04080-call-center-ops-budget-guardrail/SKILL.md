---
name: call-center-ops-budget-guardrail
description: Use when tasks require call center ops budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Budget Guardrail

## Purpose
Design and execute call center ops workflows using budget guardrail controls with validated outcomes.
