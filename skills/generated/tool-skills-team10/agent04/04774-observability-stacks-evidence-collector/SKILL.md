---
name: observability-stacks-evidence-collector
description: Use when tasks require observability stacks evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Evidence Collector

## Purpose
Design and execute observability stacks workflows using evidence collector controls with validated outcomes.
