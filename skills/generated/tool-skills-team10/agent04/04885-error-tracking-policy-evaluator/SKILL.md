---
name: error-tracking-policy-evaluator
description: Use when tasks require error tracking policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Policy Evaluator

## Purpose
Design and execute error tracking workflows using policy evaluator controls with validated outcomes.
