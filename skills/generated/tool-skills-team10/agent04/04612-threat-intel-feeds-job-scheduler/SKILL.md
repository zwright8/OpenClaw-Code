---
name: threat-intel-feeds-job-scheduler
description: Use when tasks require threat intel feeds job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Job Scheduler

## Purpose
Design and execute threat intel feeds workflows using job scheduler controls with validated outcomes.
