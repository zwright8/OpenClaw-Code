---
name: incident-queues-spec-drift-detector
description: Use when tasks require incident queues spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Spec Drift Detector

## Purpose
Design and execute incident queues workflows using spec drift detector controls with validated outcomes.
