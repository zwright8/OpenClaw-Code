---
name: access-governance-secret-scanner
description: Use when tasks require access governance secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Secret Scanner

## Purpose
Design and execute access governance workflows using secret scanner controls with validated outcomes.
