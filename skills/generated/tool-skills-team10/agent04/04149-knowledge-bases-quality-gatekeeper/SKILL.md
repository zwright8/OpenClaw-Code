---
name: knowledge-bases-quality-gatekeeper
description: Use when tasks require knowledge bases quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Quality Gatekeeper

## Purpose
Design and execute knowledge bases workflows using quality gatekeeper controls with validated outcomes.
