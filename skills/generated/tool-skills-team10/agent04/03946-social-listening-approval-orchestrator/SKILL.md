---
name: social-listening-approval-orchestrator
description: Use when tasks require social listening approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Approval Orchestrator

## Purpose
Design and execute social listening workflows using approval orchestrator controls with validated outcomes.
