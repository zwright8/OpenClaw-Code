---
name: threat-intel-feeds-compliance-mapper
description: Use when tasks require threat intel feeds compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Compliance Mapper

## Purpose
Design and execute threat intel feeds workflows using compliance mapper controls with validated outcomes.
