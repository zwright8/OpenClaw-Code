---
name: access-governance-quality-gatekeeper
description: Use when tasks require access governance quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Quality Gatekeeper

## Purpose
Design and execute access governance workflows using quality gatekeeper controls with validated outcomes.
