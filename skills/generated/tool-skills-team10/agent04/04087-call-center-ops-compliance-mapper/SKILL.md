---
name: call-center-ops-compliance-mapper
description: Use when tasks require call center ops compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Compliance Mapper

## Purpose
Design and execute call center ops workflows using compliance mapper controls with validated outcomes.
