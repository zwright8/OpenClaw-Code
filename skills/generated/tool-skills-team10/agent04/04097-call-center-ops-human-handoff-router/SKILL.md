---
name: call-center-ops-human-handoff-router
description: Use when tasks require call center ops human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Human Handoff Router

## Purpose
Design and execute call center ops workflows using human handoff router controls with validated outcomes.
