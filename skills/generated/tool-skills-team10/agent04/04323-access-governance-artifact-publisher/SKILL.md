---
name: access-governance-artifact-publisher
description: Use when tasks require access governance artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Artifact Publisher

## Purpose
Design and execute access governance workflows using artifact publisher controls with validated outcomes.
