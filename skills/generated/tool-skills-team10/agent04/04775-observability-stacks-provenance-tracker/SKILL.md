---
name: observability-stacks-provenance-tracker
description: Use when tasks require observability stacks provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Provenance Tracker

## Purpose
Design and execute observability stacks workflows using provenance tracker controls with validated outcomes.
