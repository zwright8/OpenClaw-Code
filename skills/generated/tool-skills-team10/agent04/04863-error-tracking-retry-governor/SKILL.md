---
name: error-tracking-retry-governor
description: Use when tasks require error tracking retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Retry Governor

## Purpose
Design and execute error tracking workflows using retry governor controls with validated outcomes.
