---
name: support-ticketing-incident-triage
description: Use when tasks require support ticketing incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Incident Triage

## Purpose
Design and execute support ticketing workflows using incident triage controls with validated outcomes.
