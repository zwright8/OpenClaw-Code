---
name: apm-pipelines-execution-runner
description: Use when tasks require apm pipelines execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Execution Runner

## Purpose
Design and execute apm pipelines workflows using execution runner controls with validated outcomes.
