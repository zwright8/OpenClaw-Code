---
name: error-tracking-capacity-planner
description: Use when tasks require error tracking capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Capacity Planner

## Purpose
Design and execute error tracking workflows using capacity planner controls with validated outcomes.
