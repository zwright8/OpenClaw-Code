---
name: threat-intel-feeds-incident-triage
description: Use when tasks require threat intel feeds incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Incident Triage

## Purpose
Design and execute threat intel feeds workflows using incident triage controls with validated outcomes.
