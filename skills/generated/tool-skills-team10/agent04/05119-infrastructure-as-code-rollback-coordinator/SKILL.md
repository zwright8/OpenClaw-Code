---
name: infrastructure-as-code-rollback-coordinator
description: Use when tasks require infrastructure as code rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Rollback Coordinator

## Purpose
Design and execute infrastructure as code workflows using rollback coordinator controls with validated outcomes.
