---
name: soar-platforms-spec-drift-detector
description: Use when tasks require soar platforms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Spec Drift Detector

## Purpose
Design and execute soar platforms workflows using spec drift detector controls with validated outcomes.
