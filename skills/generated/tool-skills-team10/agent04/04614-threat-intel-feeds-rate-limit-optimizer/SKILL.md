---
name: threat-intel-feeds-rate-limit-optimizer
description: Use when tasks require threat intel feeds rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Rate Limit Optimizer

## Purpose
Design and execute threat intel feeds workflows using rate limit optimizer controls with validated outcomes.
