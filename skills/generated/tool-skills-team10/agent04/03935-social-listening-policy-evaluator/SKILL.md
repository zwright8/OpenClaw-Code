---
name: social-listening-policy-evaluator
description: Use when tasks require social listening policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Policy Evaluator

## Purpose
Design and execute social listening workflows using policy evaluator controls with validated outcomes.
