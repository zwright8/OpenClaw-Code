---
name: support-ticketing-reliability-scorer
description: Use when tasks require support ticketing reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Reliability Scorer

## Purpose
Design and execute support ticketing workflows using reliability scorer controls with validated outcomes.
