---
name: serverless-runtimes-task-decomposer
description: Use when tasks require serverless runtimes task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Serverless Runtimes Task Decomposer

## Purpose
Design and execute serverless runtimes workflows using task decomposer controls with validated outcomes.
