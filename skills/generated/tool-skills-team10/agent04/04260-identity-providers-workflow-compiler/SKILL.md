---
name: identity-providers-workflow-compiler
description: Use when tasks require identity providers workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Workflow Compiler

## Purpose
Design and execute identity providers workflows using workflow compiler controls with validated outcomes.
