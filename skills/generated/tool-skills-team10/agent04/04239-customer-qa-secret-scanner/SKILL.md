---
name: customer-qa-secret-scanner
description: Use when tasks require customer qa secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Secret Scanner

## Purpose
Design and execute customer qa workflows using secret scanner controls with validated outcomes.
