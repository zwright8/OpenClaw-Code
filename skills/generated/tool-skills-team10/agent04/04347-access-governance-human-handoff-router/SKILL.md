---
name: access-governance-human-handoff-router
description: Use when tasks require access governance human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Human Handoff Router

## Purpose
Design and execute access governance workflows using human handoff router controls with validated outcomes.
