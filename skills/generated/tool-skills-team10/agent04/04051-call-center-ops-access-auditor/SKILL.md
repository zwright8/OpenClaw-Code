---
name: call-center-ops-access-auditor
description: Use when tasks require call center ops access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Access Auditor

## Purpose
Design and execute call center ops workflows using access auditor controls with validated outcomes.
