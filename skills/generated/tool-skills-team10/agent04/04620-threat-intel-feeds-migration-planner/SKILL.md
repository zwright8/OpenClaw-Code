---
name: threat-intel-feeds-migration-planner
description: Use when tasks require threat intel feeds migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Migration Planner

## Purpose
Design and execute threat intel feeds workflows using migration planner controls with validated outcomes.
