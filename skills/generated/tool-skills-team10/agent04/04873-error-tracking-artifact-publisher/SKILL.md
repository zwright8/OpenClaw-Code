---
name: error-tracking-artifact-publisher
description: Use when tasks require error tracking artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Artifact Publisher

## Purpose
Design and execute error tracking workflows using artifact publisher controls with validated outcomes.
