---
name: synthetic-testing-capacity-planner
description: Use when tasks require synthetic testing capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Capacity Planner

## Purpose
Design and execute synthetic testing workflows using capacity planner controls with validated outcomes.
