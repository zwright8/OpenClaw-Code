---
name: access-governance-auth-broker
description: Use when tasks require access governance auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Auth Broker

## Purpose
Design and execute access governance workflows using auth broker controls with validated outcomes.
