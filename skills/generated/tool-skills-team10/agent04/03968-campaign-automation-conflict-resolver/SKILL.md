---
name: campaign-automation-conflict-resolver
description: Use when tasks require campaign automation conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Conflict Resolver

## Purpose
Design and execute campaign automation workflows using conflict resolver controls with validated outcomes.
