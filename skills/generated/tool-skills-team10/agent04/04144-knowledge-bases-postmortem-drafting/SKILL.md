---
name: knowledge-bases-postmortem-drafting
description: Use when tasks require knowledge bases postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Postmortem Drafting

## Purpose
Design and execute knowledge bases workflows using postmortem drafting controls with validated outcomes.
