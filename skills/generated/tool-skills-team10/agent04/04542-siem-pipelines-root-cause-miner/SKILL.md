---
name: siem-pipelines-root-cause-miner
description: Use when tasks require siem pipelines root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Root Cause Miner

## Purpose
Design and execute siem pipelines workflows using root cause miner controls with validated outcomes.
