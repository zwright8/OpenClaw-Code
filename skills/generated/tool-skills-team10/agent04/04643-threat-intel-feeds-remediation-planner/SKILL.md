---
name: threat-intel-feeds-remediation-planner
description: Use when tasks require threat intel feeds remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Remediation Planner

## Purpose
Design and execute threat intel feeds workflows using remediation planner controls with validated outcomes.
