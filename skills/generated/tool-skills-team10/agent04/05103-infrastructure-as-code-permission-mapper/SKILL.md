---
name: infrastructure-as-code-permission-mapper
description: Use when tasks require infrastructure as code permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Permission Mapper

## Purpose
Design and execute infrastructure as code workflows using permission mapper controls with validated outcomes.
