---
name: observability-stacks-spec-drift-detector
description: Use when tasks require observability stacks spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Spec Drift Detector

## Purpose
Design and execute observability stacks workflows using spec drift detector controls with validated outcomes.
