---
name: identity-providers-reliability-scorer
description: Use when tasks require identity providers reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Reliability Scorer

## Purpose
Design and execute identity providers workflows using reliability scorer controls with validated outcomes.
