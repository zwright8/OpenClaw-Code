---
name: soar-platforms-runbook-composer
description: Use when tasks require soar platforms runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Runbook Composer

## Purpose
Design and execute soar platforms workflows using runbook composer controls with validated outcomes.
