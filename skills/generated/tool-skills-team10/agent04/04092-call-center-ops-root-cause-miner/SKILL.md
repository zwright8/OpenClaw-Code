---
name: call-center-ops-root-cause-miner
description: Use when tasks require call center ops root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Root Cause Miner

## Purpose
Design and execute call center ops workflows using root cause miner controls with validated outcomes.
