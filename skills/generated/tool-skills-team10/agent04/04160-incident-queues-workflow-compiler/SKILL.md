---
name: incident-queues-workflow-compiler
description: Use when tasks require incident queues workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Workflow Compiler

## Purpose
Design and execute incident queues workflows using workflow compiler controls with validated outcomes.
