---
name: customer-qa-outcome-synthesizer
description: Use when tasks require customer qa outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Outcome Synthesizer

## Purpose
Design and execute customer qa workflows using outcome synthesizer controls with validated outcomes.
