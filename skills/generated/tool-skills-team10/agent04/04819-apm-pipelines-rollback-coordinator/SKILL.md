---
name: apm-pipelines-rollback-coordinator
description: Use when tasks require apm pipelines rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Rollback Coordinator

## Purpose
Design and execute apm pipelines workflows using rollback coordinator controls with validated outcomes.
