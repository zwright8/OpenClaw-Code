---
name: threat-intel-feeds-dependency-resolver
description: Use when tasks require threat intel feeds dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Dependency Resolver

## Purpose
Design and execute threat intel feeds workflows using dependency resolver controls with validated outcomes.
