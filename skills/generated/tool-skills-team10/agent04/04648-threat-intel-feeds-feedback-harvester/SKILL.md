---
name: threat-intel-feeds-feedback-harvester
description: Use when tasks require threat intel feeds feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Feedback Harvester

## Purpose
Design and execute threat intel feeds workflows using feedback harvester controls with validated outcomes.
