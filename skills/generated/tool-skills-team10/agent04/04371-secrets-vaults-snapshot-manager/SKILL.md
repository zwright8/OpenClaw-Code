---
name: secrets-vaults-snapshot-manager
description: Use when tasks require secrets vaults snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Snapshot Manager

## Purpose
Design and execute secrets vaults workflows using snapshot manager controls with validated outcomes.
