---
name: secrets-vaults-artifact-publisher
description: Use when tasks require secrets vaults artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Artifact Publisher

## Purpose
Design and execute secrets vaults workflows using artifact publisher controls with validated outcomes.
