---
name: identity-providers-conflict-resolver
description: Use when tasks require identity providers conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Conflict Resolver

## Purpose
Design and execute identity providers workflows using conflict resolver controls with validated outcomes.
