---
name: siem-pipelines-execution-runner
description: Use when tasks require siem pipelines execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Execution Runner

## Purpose
Design and execute siem pipelines workflows using execution runner controls with validated outcomes.
