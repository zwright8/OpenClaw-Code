...
description: Use when tasks require infrastructure as code approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Approval Orchestrator

## Purpose
Design and execute infrastructure as code workflows using approval orchestrator controls with validated outcomes.
