---
name: support-ticketing-anomaly-detector
description: Use when tasks require support ticketing anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Anomaly Detector

## Purpose
Design and execute support ticketing workflows using anomaly detector controls with validated outcomes.
