---
name: uptime-monitors-artifact-publisher
description: Use when tasks require uptime monitors artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Artifact Publisher

## Purpose
Design and execute uptime monitors workflows using artifact publisher controls with validated outcomes.
