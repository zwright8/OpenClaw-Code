---
name: campaign-automation-delta-calculator
description: Use when tasks require campaign automation delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Delta Calculator

## Purpose
Design and execute campaign automation workflows using delta calculator controls with validated outcomes.
