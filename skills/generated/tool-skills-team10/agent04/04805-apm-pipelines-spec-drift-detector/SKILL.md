---
name: apm-pipelines-spec-drift-detector
description: Use when tasks require apm pipelines spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Spec Drift Detector

## Purpose
Design and execute apm pipelines workflows using spec drift detector controls with validated outcomes.
