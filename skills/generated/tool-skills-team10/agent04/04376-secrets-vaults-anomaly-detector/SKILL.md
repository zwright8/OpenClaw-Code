---
name: secrets-vaults-anomaly-detector
description: Use when tasks require secrets vaults anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Anomaly Detector

## Purpose
Design and execute secrets vaults workflows using anomaly detector controls with validated outcomes.
