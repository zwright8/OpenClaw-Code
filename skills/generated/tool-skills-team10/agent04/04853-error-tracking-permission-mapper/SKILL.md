---
name: error-tracking-permission-mapper
description: Use when tasks require error tracking permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Permission Mapper

## Purpose
Design and execute error tracking workflows using permission mapper controls with validated outcomes.
