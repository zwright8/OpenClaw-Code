---
name: siem-pipelines-task-decomposer
description: Use when tasks require siem pipelines task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Task Decomposer

## Purpose
Design and execute siem pipelines workflows using task decomposer controls with validated outcomes.
