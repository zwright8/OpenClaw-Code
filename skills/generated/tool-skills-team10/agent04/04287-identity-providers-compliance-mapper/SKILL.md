---
name: identity-providers-compliance-mapper
description: Use when tasks require identity providers compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Compliance Mapper

## Purpose
Design and execute identity providers workflows using compliance mapper controls with validated outcomes.
