---
name: customer-qa-dependency-resolver
description: Use when tasks require customer qa dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Dependency Resolver

## Purpose
Design and execute customer qa workflows using dependency resolver controls with validated outcomes.
