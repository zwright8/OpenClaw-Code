---
name: secrets-vaults-state-reconciler
description: Use when tasks require secrets vaults state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults State Reconciler

## Purpose
Design and execute secrets vaults workflows using state reconciler controls with validated outcomes.
