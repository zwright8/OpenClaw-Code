---
name: soar-platforms-evidence-collector
description: Use when tasks require soar platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Evidence Collector

## Purpose
Design and execute soar platforms workflows using evidence collector controls with validated outcomes.
