---
name: error-tracking-secret-scanner
description: Use when tasks require error tracking secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Secret Scanner

## Purpose
Design and execute error tracking workflows using secret scanner controls with validated outcomes.
