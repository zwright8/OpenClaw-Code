---
name: access-governance-remediation-planner
description: Use when tasks require access governance remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Remediation Planner

## Purpose
Design and execute access governance workflows using remediation planner controls with validated outcomes.
