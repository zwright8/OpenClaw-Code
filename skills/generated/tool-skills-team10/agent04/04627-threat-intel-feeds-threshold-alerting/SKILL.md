---
name: threat-intel-feeds-threshold-alerting
description: Use when tasks require threat intel feeds threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Threshold Alerting

## Purpose
Design and execute threat intel feeds workflows using threshold alerting controls with validated outcomes.
