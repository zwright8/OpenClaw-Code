---
name: knowledge-bases-execution-runner
description: Use when tasks require knowledge bases execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Execution Runner

## Purpose
Design and execute knowledge bases workflows using execution runner controls with validated outcomes.
