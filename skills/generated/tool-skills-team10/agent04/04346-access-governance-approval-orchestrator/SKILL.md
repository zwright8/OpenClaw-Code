---
name: access-governance-approval-orchestrator
description: Use when tasks require access governance approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Approval Orchestrator

## Purpose
Design and execute access governance workflows using approval orchestrator controls with validated outcomes.
