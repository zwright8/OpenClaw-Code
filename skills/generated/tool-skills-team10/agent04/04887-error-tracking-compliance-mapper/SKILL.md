---
name: error-tracking-compliance-mapper
description: Use when tasks require error tracking compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Compliance Mapper

## Purpose
Design and execute error tracking workflows using compliance mapper controls with validated outcomes.
