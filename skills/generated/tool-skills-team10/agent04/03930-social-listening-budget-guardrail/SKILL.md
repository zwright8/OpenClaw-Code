---
name: social-listening-budget-guardrail
description: Use when tasks require social listening budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Budget Guardrail

## Purpose
Design and execute social listening workflows using budget guardrail controls with validated outcomes.
