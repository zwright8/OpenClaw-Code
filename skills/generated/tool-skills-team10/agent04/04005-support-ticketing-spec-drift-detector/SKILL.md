---
name: support-ticketing-spec-drift-detector
description: Use when tasks require support ticketing spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Spec Drift Detector

## Purpose
Design and execute support ticketing workflows using spec drift detector controls with validated outcomes.
