---
name: identity-providers-migration-planner
description: Use when tasks require identity providers migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Migration Planner

## Purpose
Design and execute identity providers workflows using migration planner controls with validated outcomes.
