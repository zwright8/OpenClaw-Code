---
name: siem-pipelines-risk-scorer
description: Use when tasks require siem pipelines risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Risk Scorer

## Purpose
Design and execute siem pipelines workflows using risk scorer controls with validated outcomes.
