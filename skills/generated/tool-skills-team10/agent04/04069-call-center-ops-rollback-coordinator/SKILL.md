---
name: call-center-ops-rollback-coordinator
description: Use when tasks require call center ops rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Rollback Coordinator

## Purpose
Design and execute call center ops workflows using rollback coordinator controls with validated outcomes.
