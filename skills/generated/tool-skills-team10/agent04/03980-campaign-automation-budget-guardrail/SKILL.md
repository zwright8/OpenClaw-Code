---
name: campaign-automation-budget-guardrail
description: Use when tasks require campaign automation budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Budget Guardrail

## Purpose
Design and execute campaign automation workflows using budget guardrail controls with validated outcomes.
