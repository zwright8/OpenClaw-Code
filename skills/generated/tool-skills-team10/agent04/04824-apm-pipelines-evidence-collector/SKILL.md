---
name: apm-pipelines-evidence-collector
description: Use when tasks require apm pipelines evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Evidence Collector

## Purpose
Design and execute apm pipelines workflows using evidence collector controls with validated outcomes.
