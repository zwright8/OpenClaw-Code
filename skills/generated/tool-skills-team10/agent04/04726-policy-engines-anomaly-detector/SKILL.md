---
name: policy-engines-anomaly-detector
description: Use when tasks require policy engines anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Engines Anomaly Detector

## Purpose
Design and execute policy engines workflows using anomaly detector controls with validated outcomes.
