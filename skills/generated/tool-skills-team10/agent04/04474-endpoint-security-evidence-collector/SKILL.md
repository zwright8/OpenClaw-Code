---
name: endpoint-security-evidence-collector
description: Use when tasks require endpoint security evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Evidence Collector

## Purpose
Design and execute endpoint security workflows using evidence collector controls with validated outcomes.
