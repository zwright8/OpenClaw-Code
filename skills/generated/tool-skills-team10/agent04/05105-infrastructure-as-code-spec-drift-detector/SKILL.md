---
name: infrastructure-as-code-spec-drift-detector
description: Use when tasks require infrastructure as code spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Spec Drift Detector

## Purpose
Design and execute infrastructure as code workflows using spec drift detector controls with validated outcomes.
