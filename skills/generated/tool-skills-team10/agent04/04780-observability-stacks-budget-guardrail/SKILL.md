---
name: observability-stacks-budget-guardrail
description: Use when tasks require observability stacks budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Budget Guardrail

## Purpose
Design and execute observability stacks workflows using budget guardrail controls with validated outcomes.
