---
name: call-center-ops-incident-triage
description: Use when tasks require call center ops incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Incident Triage

## Purpose
Design and execute call center ops workflows using incident triage controls with validated outcomes.
