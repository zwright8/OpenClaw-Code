---
name: customer-qa-access-auditor
description: Use when tasks require customer qa access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Access Auditor

## Purpose
Design and execute customer qa workflows using access auditor controls with validated outcomes.
