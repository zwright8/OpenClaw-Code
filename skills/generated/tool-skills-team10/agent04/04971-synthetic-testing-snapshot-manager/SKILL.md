---
name: synthetic-testing-snapshot-manager
description: Use when tasks require synthetic testing snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Snapshot Manager

## Purpose
Design and execute synthetic testing workflows using snapshot manager controls with validated outcomes.
