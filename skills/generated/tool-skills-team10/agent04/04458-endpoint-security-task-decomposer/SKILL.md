---
name: endpoint-security-task-decomposer
description: Use when tasks require endpoint security task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Task Decomposer

## Purpose
Design and execute endpoint security workflows using task decomposer controls with validated outcomes.
