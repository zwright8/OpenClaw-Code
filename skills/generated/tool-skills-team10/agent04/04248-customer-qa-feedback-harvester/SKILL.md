---
name: customer-qa-feedback-harvester
description: Use when tasks require customer qa feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Feedback Harvester

## Purpose
Design and execute customer qa workflows using feedback harvester controls with validated outcomes.
