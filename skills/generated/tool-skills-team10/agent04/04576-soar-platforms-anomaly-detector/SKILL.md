---
name: soar-platforms-anomaly-detector
description: Use when tasks require soar platforms anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Anomaly Detector

## Purpose
Design and execute soar platforms workflows using anomaly detector controls with validated outcomes.
