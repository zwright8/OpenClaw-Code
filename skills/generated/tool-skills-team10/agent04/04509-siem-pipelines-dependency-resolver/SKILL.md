---
name: siem-pipelines-dependency-resolver
description: Use when tasks require siem pipelines dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Dependency Resolver

## Purpose
Design and execute siem pipelines workflows using dependency resolver controls with validated outcomes.
