---
name: knowledge-bases-state-reconciler
description: Use when tasks require knowledge bases state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases State Reconciler

## Purpose
Design and execute knowledge bases workflows using state reconciler controls with validated outcomes.
