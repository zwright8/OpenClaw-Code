---
name: campaign-automation-human-handoff-router
description: Use when tasks require campaign automation human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Human Handoff Router

## Purpose
Design and execute campaign automation workflows using human handoff router controls with validated outcomes.
