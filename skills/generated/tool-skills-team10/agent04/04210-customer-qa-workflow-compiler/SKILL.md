---
name: customer-qa-workflow-compiler
description: Use when tasks require customer qa workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Workflow Compiler

## Purpose
Design and execute customer qa workflows using workflow compiler controls with validated outcomes.
