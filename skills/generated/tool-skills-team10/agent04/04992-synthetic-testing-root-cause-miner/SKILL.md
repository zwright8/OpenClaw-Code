---
name: synthetic-testing-root-cause-miner
description: Use when tasks require synthetic testing root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Root Cause Miner

## Purpose
Design and execute synthetic testing workflows using root cause miner controls with validated outcomes.
