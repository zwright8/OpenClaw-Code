---
name: identity-providers-anomaly-detector
description: Use when tasks require identity providers anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Anomaly Detector

## Purpose
Design and execute identity providers workflows using anomaly detector controls with validated outcomes.
