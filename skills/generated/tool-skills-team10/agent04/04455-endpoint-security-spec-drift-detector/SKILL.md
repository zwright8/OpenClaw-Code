---
name: endpoint-security-spec-drift-detector
description: Use when tasks require endpoint security spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Spec Drift Detector

## Purpose
Design and execute endpoint security workflows using spec drift detector controls with validated outcomes.
