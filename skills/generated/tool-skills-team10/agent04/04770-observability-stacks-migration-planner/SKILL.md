---
name: observability-stacks-migration-planner
description: Use when tasks require observability stacks migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Migration Planner

## Purpose
Design and execute observability stacks workflows using migration planner controls with validated outcomes.
