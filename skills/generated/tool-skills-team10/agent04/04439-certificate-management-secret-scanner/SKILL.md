---
name: certificate-management-secret-scanner
description: Use when tasks require certificate management secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Certificate Management Secret Scanner

## Purpose
Design and execute certificate management workflows using secret scanner controls with validated outcomes.
