---
name: campaign-automation-cost-attribution
description: Use when tasks require campaign automation cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Cost Attribution

## Purpose
Design and execute campaign automation workflows using cost attribution controls with validated outcomes.
