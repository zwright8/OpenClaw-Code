---
name: call-center-ops-anomaly-detector
description: Use when tasks require call center ops anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Anomaly Detector

## Purpose
Design and execute call center ops workflows using anomaly detector controls with validated outcomes.
