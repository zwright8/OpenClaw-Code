---
name: campaign-automation-permission-mapper
description: Use when tasks require campaign automation permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Permission Mapper

## Purpose
Design and execute campaign automation workflows using permission mapper controls with validated outcomes.
