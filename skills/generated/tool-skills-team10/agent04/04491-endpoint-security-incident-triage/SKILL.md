---
name: endpoint-security-incident-triage
description: Use when tasks require endpoint security incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Incident Triage

## Purpose
Design and execute endpoint security workflows using incident triage controls with validated outcomes.
