---
name: apm-pipelines-artifact-publisher
description: Use when tasks require apm pipelines artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Artifact Publisher

## Purpose
Design and execute apm pipelines workflows using artifact publisher controls with validated outcomes.
