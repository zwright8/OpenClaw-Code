---
name: identity-providers-provenance-tracker
description: Use when tasks require identity providers provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Provenance Tracker

## Purpose
Design and execute identity providers workflows using provenance tracker controls with validated outcomes.
