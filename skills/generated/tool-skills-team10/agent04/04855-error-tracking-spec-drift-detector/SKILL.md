---
name: error-tracking-spec-drift-detector
description: Use when tasks require error tracking spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Spec Drift Detector

## Purpose
Design and execute error tracking workflows using spec drift detector controls with validated outcomes.
