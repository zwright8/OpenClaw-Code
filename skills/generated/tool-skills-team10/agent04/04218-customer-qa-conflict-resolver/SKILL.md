---
name: customer-qa-conflict-resolver
description: Use when tasks require customer qa conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Conflict Resolver

## Purpose
Design and execute customer qa workflows using conflict resolver controls with validated outcomes.
