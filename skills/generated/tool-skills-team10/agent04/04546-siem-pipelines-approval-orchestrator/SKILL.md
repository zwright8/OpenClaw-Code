---
name: siem-pipelines-approval-orchestrator
description: Use when tasks require siem pipelines approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Approval Orchestrator

## Purpose
Design and execute siem pipelines workflows using approval orchestrator controls with validated outcomes.
