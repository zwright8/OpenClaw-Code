---
name: access-governance-postmortem-drafting
description: Use when tasks require access governance postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Postmortem Drafting

## Purpose
Design and execute access governance workflows using postmortem drafting controls with validated outcomes.
