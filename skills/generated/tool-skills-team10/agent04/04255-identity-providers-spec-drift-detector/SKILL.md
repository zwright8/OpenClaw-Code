---
name: identity-providers-spec-drift-detector
description: Use when tasks require identity providers spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Spec Drift Detector

## Purpose
Design and execute identity providers workflows using spec drift detector controls with validated outcomes.
