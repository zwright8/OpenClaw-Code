---
name: campaign-automation-sla-enforcer
description: Use when tasks require campaign automation sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation SLA Enforcer

## Purpose
Design and execute campaign automation workflows using sla enforcer controls with validated outcomes.
