---
name: certificate-management-auth-broker
description: Use when tasks require certificate management auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Certificate Management Auth Broker

## Purpose
Design and execute certificate management workflows using auth broker controls with validated outcomes.
