---
name: threat-intel-feeds-quality-gatekeeper
description: Use when tasks require threat intel feeds quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Quality Gatekeeper

## Purpose
Design and execute threat intel feeds workflows using quality gatekeeper controls with validated outcomes.
