---
name: endpoint-security-migration-planner
description: Use when tasks require endpoint security migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Migration Planner

## Purpose
Design and execute endpoint security workflows using migration planner controls with validated outcomes.
