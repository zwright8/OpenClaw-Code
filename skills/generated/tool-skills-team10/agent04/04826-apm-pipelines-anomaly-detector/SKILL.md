---
name: apm-pipelines-anomaly-detector
description: Use when tasks require apm pipelines anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Anomaly Detector

## Purpose
Design and execute apm pipelines workflows using anomaly detector controls with validated outcomes.
