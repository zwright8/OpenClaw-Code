---
name: incident-queues-conflict-resolver
description: Use when tasks require incident queues conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Conflict Resolver

## Purpose
Design and execute incident queues workflows using conflict resolver controls with validated outcomes.
