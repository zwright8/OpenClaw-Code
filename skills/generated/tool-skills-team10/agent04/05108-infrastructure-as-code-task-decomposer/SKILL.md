---
name: infrastructure-as-code-task-decomposer
description: Use when tasks require infrastructure as code task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Task Decomposer

## Purpose
Design and execute infrastructure as code workflows using task decomposer controls with validated outcomes.
