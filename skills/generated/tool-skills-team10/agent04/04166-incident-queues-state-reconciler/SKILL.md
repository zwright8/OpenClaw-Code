---
name: incident-queues-state-reconciler
description: Use when tasks require incident queues state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues State Reconciler

## Purpose
Design and execute incident queues workflows using state reconciler controls with validated outcomes.
