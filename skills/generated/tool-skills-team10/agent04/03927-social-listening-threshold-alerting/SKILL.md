---
name: social-listening-threshold-alerting
description: Use when tasks require social listening threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Threshold Alerting

## Purpose
Design and execute social listening workflows using threshold alerting controls with validated outcomes.
