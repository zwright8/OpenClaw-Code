---
name: apm-pipelines-approval-orchestrator
description: Use when tasks require apm pipelines approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Approval Orchestrator

## Purpose
Design and execute apm pipelines workflows using approval orchestrator controls with validated outcomes.
