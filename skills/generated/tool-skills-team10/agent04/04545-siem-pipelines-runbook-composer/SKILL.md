---
name: siem-pipelines-runbook-composer
description: Use when tasks require siem pipelines runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Runbook Composer

## Purpose
Design and execute siem pipelines workflows using runbook composer controls with validated outcomes.
