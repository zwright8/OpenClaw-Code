---
name: threat-intel-feeds-version-tracker
description: Use when tasks require threat intel feeds version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Version Tracker

## Purpose
Design and execute threat intel feeds workflows using version tracker controls with validated outcomes.
