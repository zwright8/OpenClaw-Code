---
name: soar-platforms-human-handoff-router
description: Use when tasks require soar platforms human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Human Handoff Router

## Purpose
Design and execute soar platforms workflows using human handoff router controls with validated outcomes.
