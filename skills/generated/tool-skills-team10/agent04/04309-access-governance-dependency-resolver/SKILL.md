---
name: access-governance-dependency-resolver
description: Use when tasks require access governance dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Dependency Resolver

## Purpose
Design and execute access governance workflows using dependency resolver controls with validated outcomes.
