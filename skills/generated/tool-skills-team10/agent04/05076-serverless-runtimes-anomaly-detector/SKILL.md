---
name: serverless-runtimes-anomaly-detector
description: Use when tasks require serverless runtimes anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Serverless Runtimes Anomaly Detector

## Purpose
Design and execute serverless runtimes workflows using anomaly detector controls with validated outcomes.
