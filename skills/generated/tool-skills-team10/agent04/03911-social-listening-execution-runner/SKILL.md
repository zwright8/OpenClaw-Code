---
name: social-listening-execution-runner
description: Use when tasks require social listening execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Execution Runner

## Purpose
Design and execute social listening workflows using execution runner controls with validated outcomes.
