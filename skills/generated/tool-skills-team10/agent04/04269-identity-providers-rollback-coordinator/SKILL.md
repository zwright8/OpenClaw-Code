---
name: identity-providers-rollback-coordinator
description: Use when tasks require identity providers rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Rollback Coordinator

## Purpose
Design and execute identity providers workflows using rollback coordinator controls with validated outcomes.
