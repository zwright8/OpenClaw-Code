---
name: campaign-automation-provenance-tracker
description: Use when tasks require campaign automation provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Provenance Tracker

## Purpose
Design and execute campaign automation workflows using provenance tracker controls with validated outcomes.
