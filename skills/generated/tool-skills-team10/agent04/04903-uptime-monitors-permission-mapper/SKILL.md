---
name: uptime-monitors-permission-mapper
description: Use when tasks require uptime monitors permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Permission Mapper

## Purpose
Design and execute uptime monitors workflows using permission mapper controls with validated outcomes.
