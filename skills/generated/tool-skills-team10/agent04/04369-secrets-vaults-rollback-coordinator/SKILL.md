---
name: secrets-vaults-rollback-coordinator
description: Use when tasks require secrets vaults rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Rollback Coordinator

## Purpose
Design and execute secrets vaults workflows using rollback coordinator controls with validated outcomes.
