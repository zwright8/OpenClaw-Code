---
name: error-tracking-forecast-engine
description: Use when tasks require error tracking forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Forecast Engine

## Purpose
Design and execute error tracking workflows using forecast engine controls with validated outcomes.
