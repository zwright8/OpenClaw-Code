---
name: observability-stacks-risk-scorer
description: Use when tasks require observability stacks risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Risk Scorer

## Purpose
Design and execute observability stacks workflows using risk scorer controls with validated outcomes.
