---
name: knowledge-bases-workflow-compiler
description: Use when tasks require knowledge bases workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Workflow Compiler

## Purpose
Design and execute knowledge bases workflows using workflow compiler controls with validated outcomes.
