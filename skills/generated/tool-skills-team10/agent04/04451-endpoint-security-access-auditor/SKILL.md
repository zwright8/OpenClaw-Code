---
name: endpoint-security-access-auditor
description: Use when tasks require endpoint security access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Access Auditor

## Purpose
Design and execute endpoint security workflows using access auditor controls with validated outcomes.
