---
name: incident-queues-access-auditor
description: Use when tasks require incident queues access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Access Auditor

## Purpose
Design and execute incident queues workflows using access auditor controls with validated outcomes.
