---
name: soar-platforms-feedback-harvester
description: Use when tasks require soar platforms feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Feedback Harvester

## Purpose
Design and execute soar platforms workflows using feedback harvester controls with validated outcomes.
