---
name: uptime-monitors-risk-scorer
description: Use when tasks require uptime monitors risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Risk Scorer

## Purpose
Design and execute uptime monitors workflows using risk scorer controls with validated outcomes.
