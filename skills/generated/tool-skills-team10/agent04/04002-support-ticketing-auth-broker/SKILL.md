---
name: support-ticketing-auth-broker
description: Use when tasks require support ticketing auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Auth Broker

## Purpose
Design and execute support ticketing workflows using auth broker controls with validated outcomes.
