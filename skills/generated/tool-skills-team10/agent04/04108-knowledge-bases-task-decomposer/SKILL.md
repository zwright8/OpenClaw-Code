---
name: knowledge-bases-task-decomposer
description: Use when tasks require knowledge bases task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Task Decomposer

## Purpose
Design and execute knowledge bases workflows using task decomposer controls with validated outcomes.
