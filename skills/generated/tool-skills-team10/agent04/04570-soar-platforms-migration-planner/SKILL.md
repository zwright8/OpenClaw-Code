---
name: soar-platforms-migration-planner
description: Use when tasks require soar platforms migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Migration Planner

## Purpose
Design and execute soar platforms workflows using migration planner controls with validated outcomes.
