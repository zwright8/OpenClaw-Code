---
name: social-listening-rollback-coordinator
description: Use when tasks require social listening rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Rollback Coordinator

## Purpose
Design and execute social listening workflows using rollback coordinator controls with validated outcomes.
