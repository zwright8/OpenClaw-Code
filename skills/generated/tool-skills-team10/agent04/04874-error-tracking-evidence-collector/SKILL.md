---
name: error-tracking-evidence-collector
description: Use when tasks require error tracking evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Evidence Collector

## Purpose
Design and execute error tracking workflows using evidence collector controls with validated outcomes.
