---
name: endpoint-security-snapshot-manager
description: Use when tasks require endpoint security snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Snapshot Manager

## Purpose
Design and execute endpoint security workflows using snapshot manager controls with validated outcomes.
