---
name: social-listening-outcome-synthesizer
description: Use when tasks require social listening outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Outcome Synthesizer

## Purpose
Design and execute social listening workflows using outcome synthesizer controls with validated outcomes.
