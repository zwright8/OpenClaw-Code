---
name: infrastructure-as-code-budget-guardrail
description: Use when tasks require infrastructure as code budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Budget Guardrail

## Purpose
Design and execute infrastructure as code workflows using budget guardrail controls with validated outcomes.
