---
name: apm-pipelines-snapshot-manager
description: Use when tasks require apm pipelines snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Snapshot Manager

## Purpose
Design and execute apm pipelines workflows using snapshot manager controls with validated outcomes.
