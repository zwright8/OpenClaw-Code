---
name: threat-intel-feeds-risk-scorer
description: Use when tasks require threat intel feeds risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Risk Scorer

## Purpose
Design and execute threat intel feeds workflows using risk scorer controls with validated outcomes.
