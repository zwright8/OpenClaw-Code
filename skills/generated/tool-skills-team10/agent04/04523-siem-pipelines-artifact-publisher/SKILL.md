---
name: siem-pipelines-artifact-publisher
description: Use when tasks require siem pipelines artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Artifact Publisher

## Purpose
Design and execute siem pipelines workflows using artifact publisher controls with validated outcomes.
