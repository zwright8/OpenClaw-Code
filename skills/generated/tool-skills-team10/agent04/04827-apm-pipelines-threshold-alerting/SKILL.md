---
name: apm-pipelines-threshold-alerting
description: Use when tasks require apm pipelines threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Threshold Alerting

## Purpose
Design and execute apm pipelines workflows using threshold alerting controls with validated outcomes.
