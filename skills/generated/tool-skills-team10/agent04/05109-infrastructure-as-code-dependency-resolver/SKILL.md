...
description: Use when tasks require infrastructure as code dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Dependency Resolver

## Purpose
Design and execute infrastructure as code workflows using dependency resolver controls with validated outcomes.
