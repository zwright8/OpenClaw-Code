---
name: error-tracking-provenance-tracker
description: Use when tasks require error tracking provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Provenance Tracker

## Purpose
Design and execute error tracking workflows using provenance tracker controls with validated outcomes.
