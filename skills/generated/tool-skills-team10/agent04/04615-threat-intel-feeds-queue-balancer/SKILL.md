---
name: threat-intel-feeds-queue-balancer
description: Use when tasks require threat intel feeds queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Queue Balancer

## Purpose
Design and execute threat intel feeds workflows using queue balancer controls with validated outcomes.
