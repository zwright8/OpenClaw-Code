---
name: call-center-ops-remediation-planner
description: Use when tasks require call center ops remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Remediation Planner

## Purpose
Design and execute call center ops workflows using remediation planner controls with validated outcomes.
