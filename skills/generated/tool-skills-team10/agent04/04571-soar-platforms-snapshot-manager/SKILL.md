---
name: soar-platforms-snapshot-manager
description: Use when tasks require soar platforms snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Snapshot Manager

## Purpose
Design and execute soar platforms workflows using snapshot manager controls with validated outcomes.
