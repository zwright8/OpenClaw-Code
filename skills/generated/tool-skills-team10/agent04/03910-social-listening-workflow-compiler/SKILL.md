---
name: social-listening-workflow-compiler
description: Use when tasks require social listening workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Workflow Compiler

## Purpose
Design and execute social listening workflows using workflow compiler controls with validated outcomes.
