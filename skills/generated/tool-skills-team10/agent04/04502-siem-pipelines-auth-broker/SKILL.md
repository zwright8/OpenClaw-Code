---
name: siem-pipelines-auth-broker
description: Use when tasks require siem pipelines auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Auth Broker

## Purpose
Design and execute siem pipelines workflows using auth broker controls with validated outcomes.
