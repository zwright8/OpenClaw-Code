---
name: identity-providers-root-cause-miner
description: Use when tasks require identity providers root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Root Cause Miner

## Purpose
Design and execute identity providers workflows using root cause miner controls with validated outcomes.
