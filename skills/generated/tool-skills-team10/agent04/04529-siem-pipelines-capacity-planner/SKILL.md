---
name: siem-pipelines-capacity-planner
description: Use when tasks require siem pipelines capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Capacity Planner

## Purpose
Design and execute siem pipelines workflows using capacity planner controls with validated outcomes.
