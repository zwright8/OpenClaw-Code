---
name: kubernetes-platforms-artifact-publisher
description: Use when tasks require kubernetes platforms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Kubernetes Platforms Artifact Publisher

## Purpose
Design and execute kubernetes platforms workflows using artifact publisher controls with validated outcomes.
