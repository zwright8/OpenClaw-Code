---
name: campaign-automation-schema-introspector
description: Use when tasks require campaign automation schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Schema Introspector

## Purpose
Design and execute campaign automation workflows using schema introspector controls with validated outcomes.
