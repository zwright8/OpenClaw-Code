---
name: error-tracking-runbook-composer
description: Use when tasks require error tracking runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Runbook Composer

## Purpose
Design and execute error tracking workflows using runbook composer controls with validated outcomes.
