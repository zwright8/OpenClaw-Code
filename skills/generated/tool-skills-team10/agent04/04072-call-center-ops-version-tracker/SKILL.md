---
name: call-center-ops-version-tracker
description: Use when tasks require call center ops version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Version Tracker

## Purpose
Design and execute call center ops workflows using version tracker controls with validated outcomes.
