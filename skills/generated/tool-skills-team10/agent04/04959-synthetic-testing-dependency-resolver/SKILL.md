---
name: synthetic-testing-dependency-resolver
description: Use when tasks require synthetic testing dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Dependency Resolver

## Purpose
Design and execute synthetic testing workflows using dependency resolver controls with validated outcomes.
