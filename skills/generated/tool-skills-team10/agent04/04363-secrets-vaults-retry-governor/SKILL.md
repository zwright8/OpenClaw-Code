---
name: secrets-vaults-retry-governor
description: Use when tasks require secrets vaults retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Retry Governor

## Purpose
Design and execute secrets vaults workflows using retry governor controls with validated outcomes.
