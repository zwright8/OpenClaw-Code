---
name: knowledge-bases-anomaly-detector
description: Use when tasks require knowledge bases anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Anomaly Detector

## Purpose
Design and execute knowledge bases workflows using anomaly detector controls with validated outcomes.
