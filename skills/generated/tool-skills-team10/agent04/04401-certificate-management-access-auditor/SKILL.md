---
name: certificate-management-access-auditor
description: Use when tasks require certificate management access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Certificate Management Access Auditor

## Purpose
Design and execute certificate management workflows using access auditor controls with validated outcomes.
