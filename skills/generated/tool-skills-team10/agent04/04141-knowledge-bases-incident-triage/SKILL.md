---
name: knowledge-bases-incident-triage
description: Use when tasks require knowledge bases incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Incident Triage

## Purpose
Design and execute knowledge bases workflows using incident triage controls with validated outcomes.
