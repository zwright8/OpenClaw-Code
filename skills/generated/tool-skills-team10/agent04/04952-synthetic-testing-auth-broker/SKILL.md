---
name: synthetic-testing-auth-broker
description: Use when tasks require synthetic testing auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Auth Broker

## Purpose
Design and execute synthetic testing workflows using auth broker controls with validated outcomes.
