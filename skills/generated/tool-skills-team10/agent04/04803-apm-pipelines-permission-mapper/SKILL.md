---
name: apm-pipelines-permission-mapper
description: Use when tasks require apm pipelines permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Permission Mapper

## Purpose
Design and execute apm pipelines workflows using permission mapper controls with validated outcomes.
