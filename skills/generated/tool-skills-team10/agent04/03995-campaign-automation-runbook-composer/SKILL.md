---
name: campaign-automation-runbook-composer
description: Use when tasks require campaign automation runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Runbook Composer

## Purpose
Design and execute campaign automation workflows using runbook composer controls with validated outcomes.
