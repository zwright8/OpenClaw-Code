---
name: uptime-monitors-auth-broker
description: Use when tasks require uptime monitors auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Auth Broker

## Purpose
Design and execute uptime monitors workflows using auth broker controls with validated outcomes.
