---
name: access-governance-root-cause-miner
description: Use when tasks require access governance root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Root Cause Miner

## Purpose
Design and execute access governance workflows using root cause miner controls with validated outcomes.
