---
name: infrastructure-as-code-provenance-tracker
description: Use when tasks require infrastructure as code provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Provenance Tracker

## Purpose
Design and execute infrastructure as code workflows using provenance tracker controls with validated outcomes.
