---
name: social-listening-remediation-planner
description: Use when tasks require social listening remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Remediation Planner

## Purpose
Design and execute social listening workflows using remediation planner controls with validated outcomes.
