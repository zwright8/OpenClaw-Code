---
name: infrastructure-as-code-root-cause-miner
description: Use when tasks require infrastructure as code root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Root Cause Miner

## Purpose
Design and execute infrastructure as code workflows using root cause miner controls with validated outcomes.
