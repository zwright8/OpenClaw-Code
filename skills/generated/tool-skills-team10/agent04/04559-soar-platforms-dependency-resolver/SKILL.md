---
name: soar-platforms-dependency-resolver
description: Use when tasks require soar platforms dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Dependency Resolver

## Purpose
Design and execute soar platforms workflows using dependency resolver controls with validated outcomes.
