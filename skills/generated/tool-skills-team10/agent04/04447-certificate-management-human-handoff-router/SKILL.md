---
name: certificate-management-human-handoff-router
description: Use when tasks require certificate management human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Certificate Management Human Handoff Router

## Purpose
Design and execute certificate management workflows using human handoff router controls with validated outcomes.
