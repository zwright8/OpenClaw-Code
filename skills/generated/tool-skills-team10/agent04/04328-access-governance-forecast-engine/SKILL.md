---
name: access-governance-forecast-engine
description: Use when tasks require access governance forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Forecast Engine

## Purpose
Design and execute access governance workflows using forecast engine controls with validated outcomes.
