---
name: secrets-vaults-execution-runner
description: Use when tasks require secrets vaults execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Execution Runner

## Purpose
Design and execute secrets vaults workflows using execution runner controls with validated outcomes.
