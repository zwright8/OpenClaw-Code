---
name: policy-engines-evidence-collector
description: Use when tasks require policy engines evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Engines Evidence Collector

## Purpose
Design and execute policy engines workflows using evidence collector controls with validated outcomes.
