---
name: apm-pipelines-secret-scanner
description: Use when tasks require apm pipelines secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Secret Scanner

## Purpose
Design and execute apm pipelines workflows using secret scanner controls with validated outcomes.
