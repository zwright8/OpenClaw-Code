---
name: apm-pipelines-job-scheduler
description: Use when tasks require apm pipelines job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Job Scheduler

## Purpose
Design and execute apm pipelines workflows using job scheduler controls with validated outcomes.
