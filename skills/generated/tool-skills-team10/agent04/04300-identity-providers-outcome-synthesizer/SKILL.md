---
name: identity-providers-outcome-synthesizer
description: Use when tasks require identity providers outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Outcome Synthesizer

## Purpose
Design and execute identity providers workflows using outcome synthesizer controls with validated outcomes.
