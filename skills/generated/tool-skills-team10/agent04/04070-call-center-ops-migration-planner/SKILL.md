---
name: call-center-ops-migration-planner
description: Use when tasks require call center ops migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Migration Planner

## Purpose
Design and execute call center ops workflows using migration planner controls with validated outcomes.
