---
name: synthetic-testing-evidence-collector
description: Use when tasks require synthetic testing evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Evidence Collector

## Purpose
Design and execute synthetic testing workflows using evidence collector controls with validated outcomes.
