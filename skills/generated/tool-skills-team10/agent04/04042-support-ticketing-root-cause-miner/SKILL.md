---
name: support-ticketing-root-cause-miner
description: Use when tasks require support ticketing root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Root Cause Miner

## Purpose
Design and execute support ticketing workflows using root cause miner controls with validated outcomes.
