---
name: threat-intel-feeds-policy-evaluator
description: Use when tasks require threat intel feeds policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Policy Evaluator

## Purpose
Design and execute threat intel feeds workflows using policy evaluator controls with validated outcomes.
