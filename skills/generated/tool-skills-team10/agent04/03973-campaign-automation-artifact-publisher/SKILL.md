---
name: campaign-automation-artifact-publisher
description: Use when tasks require campaign automation artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Artifact Publisher

## Purpose
Design and execute campaign automation workflows using artifact publisher controls with validated outcomes.
