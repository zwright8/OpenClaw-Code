---
name: apm-pipelines-reliability-scorer
description: Use when tasks require apm pipelines reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Reliability Scorer

## Purpose
Design and execute apm pipelines workflows using reliability scorer controls with validated outcomes.
