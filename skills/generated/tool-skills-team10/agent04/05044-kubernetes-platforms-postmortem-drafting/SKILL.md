---
name: kubernetes-platforms-postmortem-drafting
description: Use when tasks require kubernetes platforms postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Kubernetes Platforms Postmortem Drafting

## Purpose
Design and execute kubernetes platforms workflows using postmortem drafting controls with validated outcomes.
