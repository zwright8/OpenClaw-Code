---
name: threat-intel-feeds-permission-mapper
description: Use when tasks require threat intel feeds permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Permission Mapper

## Purpose
Design and execute threat intel feeds workflows using permission mapper controls with validated outcomes.
