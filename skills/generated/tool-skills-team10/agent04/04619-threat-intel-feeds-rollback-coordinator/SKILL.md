---
name: threat-intel-feeds-rollback-coordinator
description: Use when tasks require threat intel feeds rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Rollback Coordinator

## Purpose
Design and execute threat intel feeds workflows using rollback coordinator controls with validated outcomes.
