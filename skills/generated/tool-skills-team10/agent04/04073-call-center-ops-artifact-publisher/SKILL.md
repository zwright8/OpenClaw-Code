---
name: call-center-ops-artifact-publisher
description: Use when tasks require call center ops artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Artifact Publisher

## Purpose
Design and execute call center ops workflows using artifact publisher controls with validated outcomes.
