---
name: social-listening-operation-planner
description: Use when tasks require social listening operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Operation Planner

## Purpose
Design and execute social listening workflows using operation planner controls with validated outcomes.
