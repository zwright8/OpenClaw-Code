---
name: social-listening-state-reconciler
description: Use when tasks require social listening state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening State Reconciler

## Purpose
Design and execute social listening workflows using state reconciler controls with validated outcomes.
