---
name: social-listening-version-tracker
description: Use when tasks require social listening version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Version Tracker

## Purpose
Design and execute social listening workflows using version tracker controls with validated outcomes.
