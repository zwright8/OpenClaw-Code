---
name: social-listening-migration-planner
description: Use when tasks require social listening migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Migration Planner

## Purpose
Design and execute social listening workflows using migration planner controls with validated outcomes.
