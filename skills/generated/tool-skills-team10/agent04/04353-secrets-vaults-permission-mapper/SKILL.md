---
name: secrets-vaults-permission-mapper
description: Use when tasks require secrets vaults permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Permission Mapper

## Purpose
Design and execute secrets vaults workflows using permission mapper controls with validated outcomes.
