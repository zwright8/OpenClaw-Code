---
name: observability-stacks-root-cause-miner
description: Use when tasks require observability stacks root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Root Cause Miner

## Purpose
Design and execute observability stacks workflows using root cause miner controls with validated outcomes.
