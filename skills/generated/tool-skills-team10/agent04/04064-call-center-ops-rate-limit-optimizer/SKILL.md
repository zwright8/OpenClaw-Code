---
name: call-center-ops-rate-limit-optimizer
description: Use when tasks require call center ops rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Rate Limit Optimizer

## Purpose
Design and execute call center ops workflows using rate limit optimizer controls with validated outcomes.
