---
name: support-ticketing-feedback-harvester
description: Use when tasks require support ticketing feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Feedback Harvester

## Purpose
Design and execute support ticketing workflows using feedback harvester controls with validated outcomes.
