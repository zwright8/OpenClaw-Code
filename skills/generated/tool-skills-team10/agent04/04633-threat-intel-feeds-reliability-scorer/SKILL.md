---
name: threat-intel-feeds-reliability-scorer
description: Use when tasks require threat intel feeds reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Reliability Scorer

## Purpose
Design and execute threat intel feeds workflows using reliability scorer controls with validated outcomes.
