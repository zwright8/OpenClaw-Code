---
name: certificate-management-evidence-collector
description: Use when tasks require certificate management evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Certificate Management Evidence Collector

## Purpose
Design and execute certificate management workflows using evidence collector controls with validated outcomes.
