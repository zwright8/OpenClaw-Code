---
name: error-tracking-conflict-resolver
description: Use when tasks require error tracking conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Conflict Resolver

## Purpose
Design and execute error tracking workflows using conflict resolver controls with validated outcomes.
