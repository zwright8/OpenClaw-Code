---
name: call-center-ops-schema-introspector
description: Use when tasks require call center ops schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Schema Introspector

## Purpose
Design and execute call center ops workflows using schema introspector controls with validated outcomes.
