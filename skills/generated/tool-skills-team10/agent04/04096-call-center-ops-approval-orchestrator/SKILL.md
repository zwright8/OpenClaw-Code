---
name: call-center-ops-approval-orchestrator
description: Use when tasks require call center ops approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Approval Orchestrator

## Purpose
Design and execute call center ops workflows using approval orchestrator controls with validated outcomes.
