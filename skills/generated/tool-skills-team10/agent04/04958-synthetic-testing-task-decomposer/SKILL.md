---
name: synthetic-testing-task-decomposer
description: Use when tasks require synthetic testing task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Task Decomposer

## Purpose
Design and execute synthetic testing workflows using task decomposer controls with validated outcomes.
