---
name: endpoint-security-feedback-harvester
description: Use when tasks require endpoint security feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Feedback Harvester

## Purpose
Design and execute endpoint security workflows using feedback harvester controls with validated outcomes.
