---
name: threat-intel-feeds-evidence-collector
description: Use when tasks require threat intel feeds evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Evidence Collector

## Purpose
Design and execute threat intel feeds workflows using evidence collector controls with validated outcomes.
