---
name: observability-stacks-anomaly-detector
description: Use when tasks require observability stacks anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Anomaly Detector

## Purpose
Design and execute observability stacks workflows using anomaly detector controls with validated outcomes.
