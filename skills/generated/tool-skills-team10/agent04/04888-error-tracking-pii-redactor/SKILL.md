---
name: error-tracking-pii-redactor
description: Use when tasks require error tracking pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking PII Redactor

## Purpose
Design and execute error tracking workflows using pii redactor controls with validated outcomes.
