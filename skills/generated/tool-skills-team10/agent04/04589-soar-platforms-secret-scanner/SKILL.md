---
name: soar-platforms-secret-scanner
description: Use when tasks require soar platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Secret Scanner

## Purpose
Design and execute soar platforms workflows using secret scanner controls with validated outcomes.
