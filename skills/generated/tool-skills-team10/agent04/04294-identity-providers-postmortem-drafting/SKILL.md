---
name: identity-providers-postmortem-drafting
description: Use when tasks require identity providers postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Postmortem Drafting

## Purpose
Design and execute identity providers workflows using postmortem drafting controls with validated outcomes.
