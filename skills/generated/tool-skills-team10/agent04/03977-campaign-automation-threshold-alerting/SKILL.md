---
name: campaign-automation-threshold-alerting
description: Use when tasks require campaign automation threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Threshold Alerting

## Purpose
Design and execute campaign automation workflows using threshold alerting controls with validated outcomes.
