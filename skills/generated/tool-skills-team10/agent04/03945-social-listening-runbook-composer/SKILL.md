---
name: social-listening-runbook-composer
description: Use when tasks require social listening runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Runbook Composer

## Purpose
Design and execute social listening workflows using runbook composer controls with validated outcomes.
