---
name: threat-intel-feeds-postmortem-drafting
description: Use when tasks require threat intel feeds postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Postmortem Drafting

## Purpose
Design and execute threat intel feeds workflows using postmortem drafting controls with validated outcomes.
