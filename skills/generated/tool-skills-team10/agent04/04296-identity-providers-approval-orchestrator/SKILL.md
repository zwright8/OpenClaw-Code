---
name: identity-providers-approval-orchestrator
description: Use when tasks require identity providers approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Approval Orchestrator

## Purpose
Design and execute identity providers workflows using approval orchestrator controls with validated outcomes.
