---
name: access-governance-snapshot-manager
description: Use when tasks require access governance snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Snapshot Manager

## Purpose
Design and execute access governance workflows using snapshot manager controls with validated outcomes.
