---
name: knowledge-bases-secret-scanner
description: Use when tasks require knowledge bases secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Secret Scanner

## Purpose
Design and execute knowledge bases workflows using secret scanner controls with validated outcomes.
