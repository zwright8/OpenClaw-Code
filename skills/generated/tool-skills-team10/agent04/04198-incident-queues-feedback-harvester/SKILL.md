---
name: incident-queues-feedback-harvester
description: Use when tasks require incident queues feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Feedback Harvester

## Purpose
Design and execute incident queues workflows using feedback harvester controls with validated outcomes.
