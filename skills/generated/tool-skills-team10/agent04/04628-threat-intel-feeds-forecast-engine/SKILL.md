---
name: threat-intel-feeds-forecast-engine
description: Use when tasks require threat intel feeds forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Forecast Engine

## Purpose
Design and execute threat intel feeds workflows using forecast engine controls with validated outcomes.
