---
name: serverless-runtimes-access-auditor
description: Use when tasks require serverless runtimes access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Serverless Runtimes Access Auditor

## Purpose
Design and execute serverless runtimes workflows using access auditor controls with validated outcomes.
