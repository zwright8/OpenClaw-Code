---
name: call-center-ops-api-contract-validator
description: Use when tasks require call center ops api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops API Contract Validator

## Purpose
Design and execute call center ops workflows using api contract validator controls with validated outcomes.

## Precision Profile
- Domain: Call Center Ops
...
- Domain: [Call Center Ops](../../resources/domains/call-center-ops.md)
