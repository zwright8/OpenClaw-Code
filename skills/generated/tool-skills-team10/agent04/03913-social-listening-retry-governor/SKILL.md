---
name: social-listening-retry-governor
description: Use when tasks require social listening retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Retry Governor

## Purpose
Design and execute social listening workflows using retry governor controls with validated outcomes.
