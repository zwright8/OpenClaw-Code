---
name: customer-qa-execution-runner
description: Use when tasks require customer qa execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Execution Runner

## Purpose
Design and execute customer qa workflows using execution runner controls with validated outcomes.
