---
name: campaign-automation-quality-gatekeeper
description: Use when tasks require campaign automation quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Quality Gatekeeper

## Purpose
Design and execute campaign automation workflows using quality gatekeeper controls with validated outcomes.
