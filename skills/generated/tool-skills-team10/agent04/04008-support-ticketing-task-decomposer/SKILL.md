---
name: support-ticketing-task-decomposer
description: Use when tasks require support ticketing task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Task Decomposer

## Purpose
Design and execute support ticketing workflows using task decomposer controls with validated outcomes.
