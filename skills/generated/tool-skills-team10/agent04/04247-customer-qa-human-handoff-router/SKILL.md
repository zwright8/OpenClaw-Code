---
name: customer-qa-human-handoff-router
description: Use when tasks require customer qa human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Human Handoff Router

## Purpose
Design and execute customer qa workflows using human handoff router controls with validated outcomes.
