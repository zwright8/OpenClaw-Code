---
name: secrets-vaults-risk-scorer
description: Use when tasks require secrets vaults risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Risk Scorer

## Purpose
Design and execute secrets vaults workflows using risk scorer controls with validated outcomes.
