---
name: observability-stacks-capacity-planner
description: Use when tasks require observability stacks capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Capacity Planner

## Purpose
Design and execute observability stacks workflows using capacity planner controls with validated outcomes.
