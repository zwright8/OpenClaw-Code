---
name: secrets-vaults-runbook-composer
description: Use when tasks require secrets vaults runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Runbook Composer

## Purpose
Design and execute secrets vaults workflows using runbook composer controls with validated outcomes.
