---
name: endpoint-security-cost-attribution
description: Use when tasks require endpoint security cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Cost Attribution

## Purpose
Design and execute endpoint security workflows using cost attribution controls with validated outcomes.
