---
name: knowledge-bases-permission-mapper
description: Use when tasks require knowledge bases permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Permission Mapper

## Purpose
Design and execute knowledge bases workflows using permission mapper controls with validated outcomes.
