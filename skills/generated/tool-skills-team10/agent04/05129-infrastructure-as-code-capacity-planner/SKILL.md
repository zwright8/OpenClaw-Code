---
name: infrastructure-as-code-capacity-planner
description: Use when tasks require infrastructure as code capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Capacity Planner

## Purpose
Design and execute infrastructure as code workflows using capacity planner controls with validated outcomes.
