---
name: incident-queues-migration-planner
description: Use when tasks require incident queues migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Migration Planner

## Purpose
Design and execute incident queues workflows using migration planner controls with validated outcomes.
