---
name: call-center-ops-retry-governor
description: Use when tasks require call center ops retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Retry Governor

## Purpose
Design and execute call center ops workflows using retry governor controls with validated outcomes.
