---
name: observability-stacks-task-decomposer
description: Use when tasks require observability stacks task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Task Decomposer

## Purpose
Design and execute observability stacks workflows using task decomposer controls with validated outcomes.
