---
name: siem-pipelines-migration-planner
description: Use when tasks require siem pipelines migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Migration Planner

## Purpose
Design and execute siem pipelines workflows using migration planner controls with validated outcomes.
