---
name: synthetic-testing-conflict-resolver
description: Use when tasks require synthetic testing conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Conflict Resolver

## Purpose
Design and execute synthetic testing workflows using conflict resolver controls with validated outcomes.
