---
name: social-listening-human-handoff-router
description: Use when tasks require social listening human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Human Handoff Router

## Purpose
Design and execute social listening workflows using human handoff router controls with validated outcomes.
