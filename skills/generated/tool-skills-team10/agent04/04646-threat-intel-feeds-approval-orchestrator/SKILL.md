---
name: threat-intel-feeds-approval-orchestrator
description: Use when tasks require threat intel feeds approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Approval Orchestrator

## Purpose
Design and execute threat intel feeds workflows using approval orchestrator controls with validated outcomes.
