...
description: Use when tasks require infrastructure as code evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Evidence Collector

## Purpose
Design and execute infrastructure as code workflows using evidence collector controls with validated outcomes.
