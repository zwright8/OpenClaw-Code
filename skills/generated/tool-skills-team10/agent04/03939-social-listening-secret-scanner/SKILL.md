---
name: social-listening-secret-scanner
description: Use when tasks require social listening secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Secret Scanner

## Purpose
Design and execute social listening workflows using secret scanner controls with validated outcomes.
