---
name: secrets-vaults-human-handoff-router
description: Use when tasks require secrets vaults human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Human Handoff Router

## Purpose
Design and execute secrets vaults workflows using human handoff router controls with validated outcomes.
