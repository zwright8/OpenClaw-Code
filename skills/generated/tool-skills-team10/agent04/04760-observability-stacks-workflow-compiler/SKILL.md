---
name: observability-stacks-workflow-compiler
description: Use when tasks require observability stacks workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Workflow Compiler

## Purpose
Design and execute observability stacks workflows using workflow compiler controls with validated outcomes.
