---
name: synthetic-testing-runbook-composer
description: Use when tasks require synthetic testing runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Runbook Composer

## Purpose
Design and execute synthetic testing workflows using runbook composer controls with validated outcomes.
