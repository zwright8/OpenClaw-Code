---
name: serverless-runtimes-evidence-collector
description: Use when tasks require serverless runtimes evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Serverless Runtimes Evidence Collector

## Purpose
Design and execute serverless runtimes workflows using evidence collector controls with validated outcomes.
