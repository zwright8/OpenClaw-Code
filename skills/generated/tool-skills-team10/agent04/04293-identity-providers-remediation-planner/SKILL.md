---
name: identity-providers-remediation-planner
description: Use when tasks require identity providers remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Remediation Planner

## Purpose
Design and execute identity providers workflows using remediation planner controls with validated outcomes.
