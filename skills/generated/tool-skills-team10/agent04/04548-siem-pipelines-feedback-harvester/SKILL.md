---
name: siem-pipelines-feedback-harvester
description: Use when tasks require siem pipelines feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Feedback Harvester

## Purpose
Design and execute siem pipelines workflows using feedback harvester controls with validated outcomes.
