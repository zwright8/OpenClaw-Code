---
name: observability-stacks-rate-limit-optimizer
description: Use when tasks require observability stacks rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Rate Limit Optimizer

## Purpose
Design and execute observability stacks workflows using rate limit optimizer controls with validated outcomes.
