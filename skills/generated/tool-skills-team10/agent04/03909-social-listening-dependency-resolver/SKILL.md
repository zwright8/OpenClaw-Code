---
name: social-listening-dependency-resolver
description: Use when tasks require social listening dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Dependency Resolver

## Purpose
Design and execute social listening workflows using dependency resolver controls with validated outcomes.
