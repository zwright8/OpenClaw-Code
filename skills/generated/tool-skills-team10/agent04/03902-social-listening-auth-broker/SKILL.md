---
name: social-listening-auth-broker
description: Use when tasks require social listening auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Auth Broker

## Purpose
Design and execute social listening workflows using auth broker controls with validated outcomes.
