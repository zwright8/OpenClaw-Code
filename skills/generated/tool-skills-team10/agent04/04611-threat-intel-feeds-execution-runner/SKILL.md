---
name: threat-intel-feeds-execution-runner
description: Use when tasks require threat intel feeds execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Execution Runner

## Purpose
Design and execute threat intel feeds workflows using execution runner controls with validated outcomes.
