---
name: infrastructure-as-code-workflow-compiler
description: Use when tasks require infrastructure as code workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Workflow Compiler

## Purpose
Design and execute infrastructure as code workflows using workflow compiler controls with validated outcomes.
