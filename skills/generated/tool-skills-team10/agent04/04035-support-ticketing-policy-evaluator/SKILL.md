---
name: support-ticketing-policy-evaluator
description: Use when tasks require support ticketing policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Policy Evaluator

## Purpose
Design and execute support ticketing workflows using policy evaluator controls with validated outcomes.
