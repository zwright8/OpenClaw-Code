---
name: soar-platforms-state-reconciler
description: Use when tasks require soar platforms state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms State Reconciler

## Purpose
Design and execute soar platforms workflows using state reconciler controls with validated outcomes.
