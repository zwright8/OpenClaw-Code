---
name: campaign-automation-approval-orchestrator
description: Use when tasks require campaign automation approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Approval Orchestrator

## Purpose
Design and execute campaign automation workflows using approval orchestrator controls with validated outcomes.
