---
name: infrastructure-as-code-pii-redactor
description: Use when tasks require infrastructure as code pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code PII Redactor

## Purpose
Design and execute infrastructure as code workflows using pii redactor controls with validated outcomes.
