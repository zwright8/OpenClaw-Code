---
name: apm-pipelines-postmortem-drafting
description: Use when tasks require apm pipelines postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Postmortem Drafting

## Purpose
Design and execute apm pipelines workflows using postmortem drafting controls with validated outcomes.
