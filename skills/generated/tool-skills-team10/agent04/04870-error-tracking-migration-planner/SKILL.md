---
name: error-tracking-migration-planner
description: Use when tasks require error tracking migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Migration Planner

## Purpose
Design and execute error tracking workflows using migration planner controls with validated outcomes.
