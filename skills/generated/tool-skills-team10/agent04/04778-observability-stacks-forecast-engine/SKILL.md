---
name: observability-stacks-forecast-engine
description: Use when tasks require observability stacks forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Forecast Engine

## Purpose
Design and execute observability stacks workflows using forecast engine controls with validated outcomes.
