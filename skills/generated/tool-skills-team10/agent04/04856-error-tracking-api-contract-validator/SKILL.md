---
name: error-tracking-api-contract-validator
description: Use when tasks require error tracking api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking API Contract Validator

## Purpose
Design and execute error tracking workflows using api contract validator controls with validated outcomes.
...
- Domain: [Error Tracking](../../resources/domains/error-tracking.md)
