---
name: threat-intel-feeds-anomaly-detector
description: Use when tasks require threat intel feeds anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Anomaly Detector

## Purpose
Design and execute threat intel feeds workflows using anomaly detector controls with validated outcomes.
