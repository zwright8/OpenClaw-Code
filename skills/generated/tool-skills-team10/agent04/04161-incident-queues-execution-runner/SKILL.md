---
name: incident-queues-execution-runner
description: Use when tasks require incident queues execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Execution Runner

## Purpose
Design and execute incident queues workflows using execution runner controls with validated outcomes.
