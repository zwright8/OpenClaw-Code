---
name: synthetic-testing-secret-scanner
description: Use when tasks require synthetic testing secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Secret Scanner

## Purpose
Design and execute synthetic testing workflows using secret scanner controls with validated outcomes.
