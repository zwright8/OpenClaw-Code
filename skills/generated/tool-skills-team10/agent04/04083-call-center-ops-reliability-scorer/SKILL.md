---
name: call-center-ops-reliability-scorer
description: Use when tasks require call center ops reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Reliability Scorer

## Purpose
Design and execute call center ops workflows using reliability scorer controls with validated outcomes.
