---
name: identity-providers-policy-evaluator
description: Use when tasks require identity providers policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Policy Evaluator

## Purpose
Design and execute identity providers workflows using policy evaluator controls with validated outcomes.
