---
name: customer-qa-anomaly-detector
description: Use when tasks require customer qa anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Anomaly Detector

## Purpose
Design and execute customer qa workflows using anomaly detector controls with validated outcomes.
