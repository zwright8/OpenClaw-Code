---
name: endpoint-security-policy-evaluator
description: Use when tasks require endpoint security policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Policy Evaluator

## Purpose
Design and execute endpoint security workflows using policy evaluator controls with validated outcomes.
