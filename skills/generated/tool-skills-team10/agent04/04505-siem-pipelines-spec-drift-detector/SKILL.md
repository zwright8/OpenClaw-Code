---
name: siem-pipelines-spec-drift-detector
description: Use when tasks require siem pipelines spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Spec Drift Detector

## Purpose
Design and execute siem pipelines workflows using spec drift detector controls with validated outcomes.
