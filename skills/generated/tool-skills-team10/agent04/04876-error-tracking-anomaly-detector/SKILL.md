---
name: error-tracking-anomaly-detector
description: Use when tasks require error tracking anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Anomaly Detector

## Purpose
Design and execute error tracking workflows using anomaly detector controls with validated outcomes.
