---
name: secrets-vaults-rate-limit-optimizer
description: Use when tasks require secrets vaults rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Rate Limit Optimizer

## Purpose
Design and execute secrets vaults workflows using rate limit optimizer controls with validated outcomes.
