---
name: soar-platforms-rollback-coordinator
description: Use when tasks require soar platforms rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Rollback Coordinator

## Purpose
Design and execute soar platforms workflows using rollback coordinator controls with validated outcomes.
