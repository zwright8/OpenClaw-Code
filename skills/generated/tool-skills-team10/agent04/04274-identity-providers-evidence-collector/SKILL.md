---
name: identity-providers-evidence-collector
description: Use when tasks require identity providers evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Evidence Collector

## Purpose
Design and execute identity providers workflows using evidence collector controls with validated outcomes.
