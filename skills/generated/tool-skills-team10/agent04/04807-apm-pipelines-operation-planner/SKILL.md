---
name: apm-pipelines-operation-planner
description: Use when tasks require apm pipelines operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Operation Planner

## Purpose
Design and execute apm pipelines workflows using operation planner controls with validated outcomes.
