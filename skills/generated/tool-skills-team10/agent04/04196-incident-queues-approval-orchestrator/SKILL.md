---
name: incident-queues-approval-orchestrator
description: Use when tasks require incident queues approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Approval Orchestrator

## Purpose
Design and execute incident queues workflows using approval orchestrator controls with validated outcomes.
