---
name: apm-pipelines-forecast-engine
description: Use when tasks require apm pipelines forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Forecast Engine

## Purpose
Design and execute apm pipelines workflows using forecast engine controls with validated outcomes.
