---
name: secrets-vaults-workflow-compiler
description: Use when tasks require secrets vaults workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Workflow Compiler

## Purpose
Design and execute secrets vaults workflows using workflow compiler controls with validated outcomes.
