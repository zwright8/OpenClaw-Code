---
name: incident-queues-quality-gatekeeper
description: Use when tasks require incident queues quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Quality Gatekeeper

## Purpose
Design and execute incident queues workflows using quality gatekeeper controls with validated outcomes.
