---
name: synthetic-testing-anomaly-detector
description: Use when tasks require synthetic testing anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Anomaly Detector

## Purpose
Design and execute synthetic testing workflows using anomaly detector controls with validated outcomes.
