---
name: soar-platforms-auth-broker
description: Use when tasks require soar platforms auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Auth Broker

## Purpose
Design and execute soar platforms workflows using auth broker controls with validated outcomes.
