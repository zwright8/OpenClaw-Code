---
name: soar-platforms-capacity-planner
description: Use when tasks require soar platforms capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Capacity Planner

## Purpose
Design and execute soar platforms workflows using capacity planner controls with validated outcomes.
