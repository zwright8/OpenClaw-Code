---
name: kubernetes-platforms-secret-scanner
description: Use when tasks require kubernetes platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Kubernetes Platforms Secret Scanner

## Purpose
Design and execute kubernetes platforms workflows using secret scanner controls with validated outcomes.
