---
name: uptime-monitors-dependency-resolver
description: Use when tasks require uptime monitors dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Dependency Resolver

## Purpose
Design and execute uptime monitors workflows using dependency resolver controls with validated outcomes.
