---
name: apm-pipelines-remediation-planner
description: Use when tasks require apm pipelines remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Remediation Planner

## Purpose
Design and execute apm pipelines workflows using remediation planner controls with validated outcomes.
