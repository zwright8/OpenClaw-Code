---
name: observability-stacks-approval-orchestrator
description: Use when tasks require observability stacks approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Approval Orchestrator

## Purpose
Design and execute observability stacks workflows using approval orchestrator controls with validated outcomes.
