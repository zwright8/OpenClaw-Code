---
name: apm-pipelines-capacity-planner
description: Use when tasks require apm pipelines capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Capacity Planner

## Purpose
Design and execute apm pipelines workflows using capacity planner controls with validated outcomes.
