---
name: campaign-automation-risk-scorer
description: Use when tasks require campaign automation risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Risk Scorer

## Purpose
Design and execute campaign automation workflows using risk scorer controls with validated outcomes.
