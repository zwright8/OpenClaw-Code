---
name: identity-providers-forecast-engine
description: Use when tasks require identity providers forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Forecast Engine

## Purpose
Design and execute identity providers workflows using forecast engine controls with validated outcomes.
