---
name: apm-pipelines-schema-introspector
description: Use when tasks require apm pipelines schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Schema Introspector

## Purpose
Design and execute apm pipelines workflows using schema introspector controls with validated outcomes.
