---
name: identity-providers-rate-limit-optimizer
description: Use when tasks require identity providers rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Rate Limit Optimizer

## Purpose
Design and execute identity providers workflows using rate limit optimizer controls with validated outcomes.
