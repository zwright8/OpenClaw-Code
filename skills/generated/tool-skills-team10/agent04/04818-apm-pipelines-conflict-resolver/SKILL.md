---
name: apm-pipelines-conflict-resolver
description: Use when tasks require apm pipelines conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Conflict Resolver

## Purpose
Design and execute apm pipelines workflows using conflict resolver controls with validated outcomes.
