---
name: social-listening-delta-calculator
description: Use when tasks require social listening delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Delta Calculator

## Purpose
Design and execute social listening workflows using delta calculator controls with validated outcomes.
