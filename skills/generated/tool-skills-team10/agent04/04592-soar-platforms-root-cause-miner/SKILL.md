---
name: soar-platforms-root-cause-miner
description: Use when tasks require soar platforms root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Root Cause Miner

## Purpose
Design and execute soar platforms workflows using root cause miner controls with validated outcomes.
