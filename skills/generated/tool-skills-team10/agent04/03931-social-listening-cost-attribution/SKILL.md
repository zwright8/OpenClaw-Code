---
name: social-listening-cost-attribution
description: Use when tasks require social listening cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Cost Attribution

## Purpose
Design and execute social listening workflows using cost attribution controls with validated outcomes.
