---
name: campaign-automation-snapshot-manager
description: Use when tasks require campaign automation snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Snapshot Manager

## Purpose
Design and execute campaign automation workflows using snapshot manager controls with validated outcomes.
