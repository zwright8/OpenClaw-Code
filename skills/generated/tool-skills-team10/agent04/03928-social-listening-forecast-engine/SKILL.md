---
name: social-listening-forecast-engine
description: Use when tasks require social listening forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Forecast Engine

## Purpose
Design and execute social listening workflows using forecast engine controls with validated outcomes.
