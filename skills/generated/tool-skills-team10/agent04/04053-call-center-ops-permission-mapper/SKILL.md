---
name: call-center-ops-permission-mapper
description: Use when tasks require call center ops permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Permission Mapper

## Purpose
Design and execute call center ops workflows using permission mapper controls with validated outcomes.
