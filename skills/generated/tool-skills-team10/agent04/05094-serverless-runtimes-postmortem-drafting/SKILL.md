---
name: serverless-runtimes-postmortem-drafting
description: Use when tasks require serverless runtimes postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Serverless Runtimes Postmortem Drafting

## Purpose
Design and execute serverless runtimes workflows using postmortem drafting controls with validated outcomes.
