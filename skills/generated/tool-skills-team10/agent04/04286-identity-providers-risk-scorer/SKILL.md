---
name: identity-providers-risk-scorer
description: Use when tasks require identity providers risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Risk Scorer

## Purpose
Design and execute identity providers workflows using risk scorer controls with validated outcomes.
