---
name: uptime-monitors-quality-gatekeeper
description: Use when tasks require uptime monitors quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Quality Gatekeeper

## Purpose
Design and execute uptime monitors workflows using quality gatekeeper controls with validated outcomes.
