---
name: identity-providers-access-auditor
description: Use when tasks require identity providers access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Access Auditor

## Purpose
Design and execute identity providers workflows using access auditor controls with validated outcomes.
