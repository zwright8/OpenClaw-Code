---
name: call-center-ops-workflow-compiler
description: Use when tasks require call center ops workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Workflow Compiler

## Purpose
Design and execute call center ops workflows using workflow compiler controls with validated outcomes.
