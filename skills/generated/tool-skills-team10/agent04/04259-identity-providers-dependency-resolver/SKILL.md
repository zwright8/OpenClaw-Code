---
name: identity-providers-dependency-resolver
description: Use when tasks require identity providers dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Dependency Resolver

## Purpose
Design and execute identity providers workflows using dependency resolver controls with validated outcomes.
