---
name: serverless-runtimes-snapshot-manager
description: Use when tasks require serverless runtimes snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Serverless Runtimes Snapshot Manager

## Purpose
Design and execute serverless runtimes workflows using snapshot manager controls with validated outcomes.
