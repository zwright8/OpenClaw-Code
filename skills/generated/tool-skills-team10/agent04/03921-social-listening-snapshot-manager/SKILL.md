---
name: social-listening-snapshot-manager
description: Use when tasks require social listening snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Snapshot Manager

## Purpose
Design and execute social listening workflows using snapshot manager controls with validated outcomes.
