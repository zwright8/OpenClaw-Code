---
name: incident-queues-task-decomposer
description: Use when tasks require incident queues task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Task Decomposer

## Purpose
Design and execute incident queues workflows using task decomposer controls with validated outcomes.
