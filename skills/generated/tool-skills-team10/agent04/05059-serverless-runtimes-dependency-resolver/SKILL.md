---
name: serverless-runtimes-dependency-resolver
description: Use when tasks require serverless runtimes dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Serverless Runtimes Dependency Resolver

## Purpose
Design and execute serverless runtimes workflows using dependency resolver controls with validated outcomes.
