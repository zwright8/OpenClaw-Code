---
name: apm-pipelines-runbook-composer
description: Use when tasks require apm pipelines runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Runbook Composer

## Purpose
Design and execute apm pipelines workflows using runbook composer controls with validated outcomes.
