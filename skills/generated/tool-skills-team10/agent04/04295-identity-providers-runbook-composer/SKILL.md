---
name: identity-providers-runbook-composer
description: Use when tasks require identity providers runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Runbook Composer

## Purpose
Design and execute identity providers workflows using runbook composer controls with validated outcomes.
