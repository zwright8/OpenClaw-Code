---
name: error-tracking-postmortem-drafting
description: Use when tasks require error tracking postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Postmortem Drafting

## Purpose
Design and execute error tracking workflows using postmortem drafting controls with validated outcomes.
