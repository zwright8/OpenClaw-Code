---
name: synthetic-testing-remediation-planner
description: Use when tasks require synthetic testing remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Remediation Planner

## Purpose
Design and execute synthetic testing workflows using remediation planner controls with validated outcomes.
