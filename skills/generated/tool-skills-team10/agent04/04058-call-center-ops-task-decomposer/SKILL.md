---
name: call-center-ops-task-decomposer
description: Use when tasks require call center ops task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Task Decomposer

## Purpose
Design and execute call center ops workflows using task decomposer controls with validated outcomes.
