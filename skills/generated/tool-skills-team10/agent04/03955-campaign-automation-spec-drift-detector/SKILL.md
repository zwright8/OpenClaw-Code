---
name: campaign-automation-spec-drift-detector
description: Use when tasks require campaign automation spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Spec Drift Detector

## Purpose
Design and execute campaign automation workflows using spec drift detector controls with validated outcomes.
