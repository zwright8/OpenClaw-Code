---
name: knowledge-bases-snapshot-manager
description: Use when tasks require knowledge bases snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Snapshot Manager

## Purpose
Design and execute knowledge bases workflows using snapshot manager controls with validated outcomes.
