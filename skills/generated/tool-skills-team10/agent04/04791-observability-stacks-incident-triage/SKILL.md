---
name: observability-stacks-incident-triage
description: Use when tasks require observability stacks incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Incident Triage

## Purpose
Design and execute observability stacks workflows using incident triage controls with validated outcomes.
