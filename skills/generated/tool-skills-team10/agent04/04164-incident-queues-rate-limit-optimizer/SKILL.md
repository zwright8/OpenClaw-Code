---
name: incident-queues-rate-limit-optimizer
description: Use when tasks require incident queues rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Rate Limit Optimizer

## Purpose
Design and execute incident queues workflows using rate limit optimizer controls with validated outcomes.
