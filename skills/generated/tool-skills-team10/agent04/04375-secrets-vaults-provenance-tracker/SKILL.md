---
name: secrets-vaults-provenance-tracker
description: Use when tasks require secrets vaults provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Provenance Tracker

## Purpose
Design and execute secrets vaults workflows using provenance tracker controls with validated outcomes.
