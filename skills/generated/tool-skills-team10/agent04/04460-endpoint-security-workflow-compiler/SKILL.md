---
name: endpoint-security-workflow-compiler
description: Use when tasks require endpoint security workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Workflow Compiler

## Purpose
Design and execute endpoint security workflows using workflow compiler controls with validated outcomes.
