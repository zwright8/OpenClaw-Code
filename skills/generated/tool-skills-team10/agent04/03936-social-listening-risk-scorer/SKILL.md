---
name: social-listening-risk-scorer
description: Use when tasks require social listening risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Risk Scorer

## Purpose
Design and execute social listening workflows using risk scorer controls with validated outcomes.
