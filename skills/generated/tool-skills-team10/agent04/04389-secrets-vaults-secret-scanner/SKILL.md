---
name: secrets-vaults-secret-scanner
description: Use when tasks require secrets vaults secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Secret Scanner

## Purpose
Design and execute secrets vaults workflows using secret scanner controls with validated outcomes.
