---
name: secrets-vaults-root-cause-miner
description: Use when tasks require secrets vaults root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Root Cause Miner

## Purpose
Design and execute secrets vaults workflows using root cause miner controls with validated outcomes.
