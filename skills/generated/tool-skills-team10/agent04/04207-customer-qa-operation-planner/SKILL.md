---
name: customer-qa-operation-planner
description: Use when tasks require customer qa operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Operation Planner

## Purpose
Design and execute customer qa workflows using operation planner controls with validated outcomes.
