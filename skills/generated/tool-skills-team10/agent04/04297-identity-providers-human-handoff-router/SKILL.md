---
name: identity-providers-human-handoff-router
description: Use when tasks require identity providers human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Human Handoff Router

## Purpose
Design and execute identity providers workflows using human handoff router controls with validated outcomes.
