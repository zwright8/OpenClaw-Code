---
name: threat-intel-feeds-human-handoff-router
description: Use when tasks require threat intel feeds human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Human Handoff Router

## Purpose
Design and execute threat intel feeds workflows using human handoff router controls with validated outcomes.
