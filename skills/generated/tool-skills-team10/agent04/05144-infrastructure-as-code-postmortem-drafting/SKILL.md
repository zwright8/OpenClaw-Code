---
name: infrastructure-as-code-postmortem-drafting
description: Use when tasks require infrastructure as code postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Postmortem Drafting

## Purpose
Design and execute infrastructure as code workflows using postmortem drafting controls with validated outcomes.
