---
name: social-listening-anomaly-detector
description: Use when tasks require social listening anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Anomaly Detector

## Purpose
Design and execute social listening workflows using anomaly detector controls with validated outcomes.
