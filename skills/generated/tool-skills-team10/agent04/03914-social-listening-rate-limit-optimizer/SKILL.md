---
name: social-listening-rate-limit-optimizer
description: Use when tasks require social listening rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Rate Limit Optimizer

## Purpose
Design and execute social listening workflows using rate limit optimizer controls with validated outcomes.
