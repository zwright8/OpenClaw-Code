---
name: access-governance-permission-mapper
description: Use when tasks require access governance permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Permission Mapper

## Purpose
Design and execute access governance workflows using permission mapper controls with validated outcomes.
