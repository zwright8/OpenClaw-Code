---
name: infrastructure-as-code-remediation-planner
description: Use when tasks require infrastructure as code remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Remediation Planner

## Purpose
Design and execute infrastructure as code workflows using remediation planner controls with validated outcomes.
