---
name: uptime-monitors-evidence-collector
description: Use when tasks require uptime monitors evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Evidence Collector

## Purpose
Design and execute uptime monitors workflows using evidence collector controls with validated outcomes.
