---
name: customer-qa-runbook-composer
description: Use when tasks require customer qa runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Runbook Composer

## Purpose
Design and execute customer qa workflows using runbook composer controls with validated outcomes.
