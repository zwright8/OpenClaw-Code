---
name: campaign-automation-forecast-engine
description: Use when tasks require campaign automation forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Forecast Engine

## Purpose
Design and execute campaign automation workflows using forecast engine controls with validated outcomes.
