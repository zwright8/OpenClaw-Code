---
name: soar-platforms-approval-orchestrator
description: Use when tasks require soar platforms approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Approval Orchestrator

## Purpose
Design and execute soar platforms workflows using approval orchestrator controls with validated outcomes.
