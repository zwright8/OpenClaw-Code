---
name: apm-pipelines-outcome-synthesizer
description: Use when tasks require apm pipelines outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Outcome Synthesizer

## Purpose
Design and execute apm pipelines workflows using outcome synthesizer controls with validated outcomes.
