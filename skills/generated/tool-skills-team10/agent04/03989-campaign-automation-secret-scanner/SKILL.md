---
name: campaign-automation-secret-scanner
description: Use when tasks require campaign automation secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Secret Scanner

## Purpose
Design and execute campaign automation workflows using secret scanner controls with validated outcomes.
