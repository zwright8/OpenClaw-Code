---
name: certificate-management-rollback-coordinator
description: Use when tasks require certificate management rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Certificate Management Rollback Coordinator

## Purpose
Design and execute certificate management workflows using rollback coordinator controls with validated outcomes.
