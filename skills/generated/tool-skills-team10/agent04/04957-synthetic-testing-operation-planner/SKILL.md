---
name: synthetic-testing-operation-planner
description: Use when tasks require synthetic testing operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Operation Planner

## Purpose
Design and execute synthetic testing workflows using operation planner controls with validated outcomes.
