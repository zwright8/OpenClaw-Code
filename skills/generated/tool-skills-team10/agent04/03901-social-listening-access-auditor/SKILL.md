---
name: social-listening-access-auditor
description: Use when tasks require social listening access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Access Auditor

## Purpose
Design and execute social listening workflows using access auditor controls with validated outcomes.
