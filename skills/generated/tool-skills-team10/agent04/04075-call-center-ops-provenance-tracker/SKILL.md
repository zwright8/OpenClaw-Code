---
name: call-center-ops-provenance-tracker
description: Use when tasks require call center ops provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Provenance Tracker

## Purpose
Design and execute call center ops workflows using provenance tracker controls with validated outcomes.
