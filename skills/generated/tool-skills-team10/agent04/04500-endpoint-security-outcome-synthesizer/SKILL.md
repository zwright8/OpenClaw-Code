---
name: endpoint-security-outcome-synthesizer
description: Use when tasks require endpoint security outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Outcome Synthesizer

## Purpose
Design and execute endpoint security workflows using outcome synthesizer controls with validated outcomes.
