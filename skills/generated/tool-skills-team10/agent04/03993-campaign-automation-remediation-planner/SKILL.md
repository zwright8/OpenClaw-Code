---
name: campaign-automation-remediation-planner
description: Use when tasks require campaign automation remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Remediation Planner

## Purpose
Design and execute campaign automation workflows using remediation planner controls with validated outcomes.
