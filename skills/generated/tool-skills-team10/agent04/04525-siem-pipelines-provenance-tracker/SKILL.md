---
name: siem-pipelines-provenance-tracker
description: Use when tasks require siem pipelines provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Provenance Tracker

## Purpose
Design and execute siem pipelines workflows using provenance tracker controls with validated outcomes.
