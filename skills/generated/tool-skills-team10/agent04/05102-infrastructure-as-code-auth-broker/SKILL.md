...
description: Use when tasks require infrastructure as code auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Auth Broker

## Purpose
Design and execute infrastructure as code workflows using auth broker controls with validated outcomes.
