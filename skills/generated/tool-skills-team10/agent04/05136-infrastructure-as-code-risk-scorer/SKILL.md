---
name: infrastructure-as-code-risk-scorer
description: Use when tasks require infrastructure as code risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Risk Scorer

## Purpose
Design and execute infrastructure as code workflows using risk scorer controls with validated outcomes.
