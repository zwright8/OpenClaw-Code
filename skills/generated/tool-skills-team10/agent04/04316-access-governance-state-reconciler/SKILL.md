---
name: access-governance-state-reconciler
description: Use when tasks require access governance state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance State Reconciler

## Purpose
Design and execute access governance workflows using state reconciler controls with validated outcomes.
