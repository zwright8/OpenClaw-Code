---
name: apm-pipelines-root-cause-miner
description: Use when tasks require apm pipelines root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Root Cause Miner

## Purpose
Design and execute apm pipelines workflows using root cause miner controls with validated outcomes.
