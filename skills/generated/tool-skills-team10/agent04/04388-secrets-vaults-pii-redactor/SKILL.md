---
name: secrets-vaults-pii-redactor
description: Use when tasks require secrets vaults pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults PII Redactor

## Purpose
Design and execute secrets vaults workflows using pii redactor controls with validated outcomes.
