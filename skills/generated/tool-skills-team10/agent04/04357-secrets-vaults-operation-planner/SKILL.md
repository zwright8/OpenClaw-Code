---
name: secrets-vaults-operation-planner
description: Use when tasks require secrets vaults operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Operation Planner

## Purpose
Design and execute secrets vaults workflows using operation planner controls with validated outcomes.
