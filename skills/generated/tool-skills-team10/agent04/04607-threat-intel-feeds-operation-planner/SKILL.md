---
name: threat-intel-feeds-operation-planner
description: Use when tasks require threat intel feeds operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Operation Planner

## Purpose
Design and execute threat intel feeds workflows using operation planner controls with validated outcomes.
