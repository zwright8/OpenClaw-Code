---
name: social-listening-compliance-mapper
description: Use when tasks require social listening compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Compliance Mapper

## Purpose
Design and execute social listening workflows using compliance mapper controls with validated outcomes.
