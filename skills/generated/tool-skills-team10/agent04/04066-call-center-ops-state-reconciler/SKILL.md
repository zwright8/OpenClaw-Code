---
name: call-center-ops-state-reconciler
description: Use when tasks require call center ops state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops State Reconciler

## Purpose
Design and execute call center ops workflows using state reconciler controls with validated outcomes.
