---
name: uptime-monitors-capacity-planner
description: Use when tasks require uptime monitors capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Capacity Planner

## Purpose
Design and execute uptime monitors workflows using capacity planner controls with validated outcomes.
