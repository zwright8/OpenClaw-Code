---
name: serverless-runtimes-permission-mapper
description: Use when tasks require serverless runtimes permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Serverless Runtimes Permission Mapper

## Purpose
Design and execute serverless runtimes workflows using permission mapper controls with validated outcomes.
