---
name: threat-intel-feeds-api-contract-validator
description: Use when tasks require threat intel feeds api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds API Contract Validator

## Purpose
Design and execute threat intel feeds workflows using api contract validator controls with validated outcomes.
...
- Domain: [Threat Intel Feeds](../../resources/domains/threat-intel-feeds.md)
