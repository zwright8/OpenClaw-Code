---
name: endpoint-security-compliance-mapper
description: Use when tasks require endpoint security compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Compliance Mapper

## Purpose
Design and execute endpoint security workflows using compliance mapper controls with validated outcomes.
