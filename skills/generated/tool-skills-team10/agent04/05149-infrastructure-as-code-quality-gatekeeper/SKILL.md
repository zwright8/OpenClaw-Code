...
description: Use when tasks require infrastructure as code quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Quality Gatekeeper

## Purpose
Design and execute infrastructure as code workflows using quality gatekeeper controls with validated outcomes.
