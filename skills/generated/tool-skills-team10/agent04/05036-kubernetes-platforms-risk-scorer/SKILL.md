---
name: kubernetes-platforms-risk-scorer
description: Use when tasks require kubernetes platforms risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Kubernetes Platforms Risk Scorer

## Purpose
Design and execute kubernetes platforms workflows using risk scorer controls with validated outcomes.
