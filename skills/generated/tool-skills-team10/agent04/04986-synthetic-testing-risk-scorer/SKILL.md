---
name: synthetic-testing-risk-scorer
description: Use when tasks require synthetic testing risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Risk Scorer

## Purpose
Design and execute synthetic testing workflows using risk scorer controls with validated outcomes.
