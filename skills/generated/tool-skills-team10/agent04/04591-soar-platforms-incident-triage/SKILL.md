---
name: soar-platforms-incident-triage
description: Use when tasks require soar platforms incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Incident Triage

## Purpose
Design and execute soar platforms workflows using incident triage controls with validated outcomes.
