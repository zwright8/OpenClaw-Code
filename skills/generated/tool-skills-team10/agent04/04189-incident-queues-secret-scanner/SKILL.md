---
name: incident-queues-secret-scanner
description: Use when tasks require incident queues secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Secret Scanner

## Purpose
Design and execute incident queues workflows using secret scanner controls with validated outcomes.
