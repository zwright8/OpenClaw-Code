---
name: knowledge-bases-policy-evaluator
description: Use when tasks require knowledge bases policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Policy Evaluator

## Purpose
Design and execute knowledge bases workflows using policy evaluator controls with validated outcomes.
