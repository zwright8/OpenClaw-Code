---
name: social-listening-provenance-tracker
description: Use when tasks require social listening provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Provenance Tracker

## Purpose
Design and execute social listening workflows using provenance tracker controls with validated outcomes.
