---
name: apm-pipelines-dependency-resolver
description: Use when tasks require apm pipelines dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Dependency Resolver

## Purpose
Design and execute apm pipelines workflows using dependency resolver controls with validated outcomes.
