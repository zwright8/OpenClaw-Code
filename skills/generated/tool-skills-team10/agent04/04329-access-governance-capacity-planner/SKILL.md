---
name: access-governance-capacity-planner
description: Use when tasks require access governance capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Capacity Planner

## Purpose
Design and execute access governance workflows using capacity planner controls with validated outcomes.
