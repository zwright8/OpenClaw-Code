---
name: siem-pipelines-reliability-scorer
description: Use when tasks require siem pipelines reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Reliability Scorer

## Purpose
Design and execute siem pipelines workflows using reliability scorer controls with validated outcomes.
