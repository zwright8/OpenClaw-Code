---
name: apm-pipelines-feedback-harvester
description: Use when tasks require apm pipelines feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Feedback Harvester

## Purpose
Design and execute apm pipelines workflows using feedback harvester controls with validated outcomes.
