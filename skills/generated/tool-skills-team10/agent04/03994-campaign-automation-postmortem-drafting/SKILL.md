---
name: campaign-automation-postmortem-drafting
description: Use when tasks require campaign automation postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Postmortem Drafting

## Purpose
Design and execute campaign automation workflows using postmortem drafting controls with validated outcomes.
