---
name: social-listening-task-decomposer
description: Use when tasks require social listening task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Task Decomposer

## Purpose
Design and execute social listening workflows using task decomposer controls with validated outcomes.
