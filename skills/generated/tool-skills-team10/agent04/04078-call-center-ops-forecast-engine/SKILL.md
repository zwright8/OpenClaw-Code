---
name: call-center-ops-forecast-engine
description: Use when tasks require call center ops forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Forecast Engine

## Purpose
Design and execute call center ops workflows using forecast engine controls with validated outcomes.
