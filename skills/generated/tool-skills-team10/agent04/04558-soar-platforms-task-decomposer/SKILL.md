...
description: Use when tasks require soar platforms task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Task Decomposer

## Purpose
Design and execute soar platforms workflows using task decomposer controls with validated outcomes.
