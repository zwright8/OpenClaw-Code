---
name: call-center-ops-cost-attribution
description: Use when tasks require call center ops cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Cost Attribution

## Purpose
Design and execute call center ops workflows using cost attribution controls with validated outcomes.
