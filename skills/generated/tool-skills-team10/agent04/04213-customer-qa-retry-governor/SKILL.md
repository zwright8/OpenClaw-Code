---
name: customer-qa-retry-governor
description: Use when tasks require customer qa retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Retry Governor

## Purpose
Design and execute customer qa workflows using retry governor controls with validated outcomes.
