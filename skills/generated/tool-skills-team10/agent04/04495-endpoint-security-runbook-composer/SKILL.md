---
name: endpoint-security-runbook-composer
description: Use when tasks require endpoint security runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Runbook Composer

## Purpose
Design and execute endpoint security workflows using runbook composer controls with validated outcomes.
