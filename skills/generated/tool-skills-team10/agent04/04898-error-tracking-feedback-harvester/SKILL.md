---
name: error-tracking-feedback-harvester
description: Use when tasks require error tracking feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Feedback Harvester

## Purpose
Design and execute error tracking workflows using feedback harvester controls with validated outcomes.
