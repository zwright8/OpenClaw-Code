---
name: soar-platforms-remediation-planner
description: Use when tasks require soar platforms remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Remediation Planner

## Purpose
Design and execute soar platforms workflows using remediation planner controls with validated outcomes.
