---
name: campaign-automation-migration-planner
description: Use when tasks require campaign automation migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Migration Planner

## Purpose
Design and execute campaign automation workflows using migration planner controls with validated outcomes.
