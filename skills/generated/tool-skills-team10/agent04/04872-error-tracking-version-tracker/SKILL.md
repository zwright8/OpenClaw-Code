---
name: error-tracking-version-tracker
description: Use when tasks require error tracking version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Version Tracker

## Purpose
Design and execute error tracking workflows using version tracker controls with validated outcomes.
