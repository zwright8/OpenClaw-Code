---
name: campaign-automation-job-scheduler
description: Use when tasks require campaign automation job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Job Scheduler

## Purpose
Design and execute campaign automation workflows using job scheduler controls with validated outcomes.
