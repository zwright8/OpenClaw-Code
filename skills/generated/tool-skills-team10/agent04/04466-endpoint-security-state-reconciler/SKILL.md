---
name: endpoint-security-state-reconciler
description: Use when tasks require endpoint security state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security State Reconciler

## Purpose
Design and execute endpoint security workflows using state reconciler controls with validated outcomes.
