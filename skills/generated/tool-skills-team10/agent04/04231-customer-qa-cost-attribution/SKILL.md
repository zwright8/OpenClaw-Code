---
name: customer-qa-cost-attribution
description: Use when tasks require customer qa cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Cost Attribution

## Purpose
Design and execute customer qa workflows using cost attribution controls with validated outcomes.
