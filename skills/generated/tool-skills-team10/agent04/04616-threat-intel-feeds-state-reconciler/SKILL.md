---
name: threat-intel-feeds-state-reconciler
description: Use when tasks require threat intel feeds state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds State Reconciler

## Purpose
Design and execute threat intel feeds workflows using state reconciler controls with validated outcomes.
