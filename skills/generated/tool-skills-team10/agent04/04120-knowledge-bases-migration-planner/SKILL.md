---
name: knowledge-bases-migration-planner
description: Use when tasks require knowledge bases migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Migration Planner

## Purpose
Design and execute knowledge bases workflows using migration planner controls with validated outcomes.
