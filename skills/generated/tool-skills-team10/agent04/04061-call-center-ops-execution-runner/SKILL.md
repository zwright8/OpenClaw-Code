---
name: call-center-ops-execution-runner
description: Use when tasks require call center ops execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Execution Runner

## Purpose
Design and execute call center ops workflows using execution runner controls with validated outcomes.
