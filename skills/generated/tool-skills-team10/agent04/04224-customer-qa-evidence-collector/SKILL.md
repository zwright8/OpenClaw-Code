---
name: customer-qa-evidence-collector
description: Use when tasks require customer qa evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Evidence Collector

## Purpose
Design and execute customer qa workflows using evidence collector controls with validated outcomes.
