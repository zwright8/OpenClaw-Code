---
name: identity-providers-operation-planner
description: Use when tasks require identity providers operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Operation Planner

## Purpose
Design and execute identity providers workflows using operation planner controls with validated outcomes.
