---
name: call-center-ops-quality-gatekeeper
description: Use when tasks require call center ops quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Quality Gatekeeper

## Purpose
Design and execute call center ops workflows using quality gatekeeper controls with validated outcomes.
