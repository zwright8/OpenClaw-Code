---
name: support-ticketing-rate-limit-optimizer
description: Use when tasks require support ticketing rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Rate Limit Optimizer

## Purpose
Design and execute support ticketing workflows using rate limit optimizer controls with validated outcomes.
