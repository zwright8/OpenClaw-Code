---
name: error-tracking-state-reconciler
description: Use when tasks require error tracking state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking State Reconciler

## Purpose
Design and execute error tracking workflows using state reconciler controls with validated outcomes.
