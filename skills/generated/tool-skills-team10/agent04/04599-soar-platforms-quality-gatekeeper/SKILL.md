---
name: soar-platforms-quality-gatekeeper
description: Use when tasks require soar platforms quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Quality Gatekeeper

## Purpose
Design and execute soar platforms workflows using quality gatekeeper controls with validated outcomes.
