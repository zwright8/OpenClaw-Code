---
name: siem-pipelines-state-reconciler
description: Use when tasks require siem pipelines state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines State Reconciler

## Purpose
Design and execute siem pipelines workflows using state reconciler controls with validated outcomes.
