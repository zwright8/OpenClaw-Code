---
name: knowledge-bases-feedback-harvester
description: Use when tasks require knowledge bases feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Feedback Harvester

## Purpose
Design and execute knowledge bases workflows using feedback harvester controls with validated outcomes.
