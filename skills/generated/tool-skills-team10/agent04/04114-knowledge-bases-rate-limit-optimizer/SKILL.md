---
name: knowledge-bases-rate-limit-optimizer
description: Use when tasks require knowledge bases rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Rate Limit Optimizer

## Purpose
Design and execute knowledge bases workflows using rate limit optimizer controls with validated outcomes.
