---
name: campaign-automation-pii-redactor
description: Use when tasks require campaign automation pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation PII Redactor

## Purpose
Design and execute campaign automation workflows using pii redactor controls with validated outcomes.
