---
name: threat-intel-feeds-workflow-compiler
description: Use when tasks require threat intel feeds workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Workflow Compiler

## Purpose
Design and execute threat intel feeds workflows using workflow compiler controls with validated outcomes.
