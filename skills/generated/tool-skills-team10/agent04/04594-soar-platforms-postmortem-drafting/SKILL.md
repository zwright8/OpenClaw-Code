---
name: soar-platforms-postmortem-drafting
description: Use when tasks require soar platforms postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Postmortem Drafting

## Purpose
Design and execute soar platforms workflows using postmortem drafting controls with validated outcomes.
