---
name: customer-qa-rollback-coordinator
description: Use when tasks require customer qa rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Rollback Coordinator

## Purpose
Design and execute customer qa workflows using rollback coordinator controls with validated outcomes.
