---
name: observability-stacks-permission-mapper
description: Use when tasks require observability stacks permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Permission Mapper

## Purpose
Design and execute observability stacks workflows using permission mapper controls with validated outcomes.
