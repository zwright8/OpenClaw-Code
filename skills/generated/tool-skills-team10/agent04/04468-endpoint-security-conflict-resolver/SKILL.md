---
name: endpoint-security-conflict-resolver
description: Use when tasks require endpoint security conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Conflict Resolver

## Purpose
Design and execute endpoint security workflows using conflict resolver controls with validated outcomes.
