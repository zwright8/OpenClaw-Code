---
name: uptime-monitors-rate-limit-optimizer
description: Use when tasks require uptime monitors rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Rate Limit Optimizer

## Purpose
Design and execute uptime monitors workflows using rate limit optimizer controls with validated outcomes.
