---
name: campaign-automation-state-reconciler
description: Use when tasks require campaign automation state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation State Reconciler

## Purpose
Design and execute campaign automation workflows using state reconciler controls with validated outcomes.
