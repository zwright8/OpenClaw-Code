---
name: access-governance-anomaly-detector
description: Use when tasks require access governance anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Anomaly Detector

## Purpose
Design and execute access governance workflows using anomaly detector controls with validated outcomes.
