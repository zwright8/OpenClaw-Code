---
name: soar-platforms-conflict-resolver
description: Use when tasks require soar platforms conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Conflict Resolver

## Purpose
Design and execute soar platforms workflows using conflict resolver controls with validated outcomes.
