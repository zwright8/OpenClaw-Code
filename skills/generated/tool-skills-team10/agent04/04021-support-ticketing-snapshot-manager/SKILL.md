---
name: support-ticketing-snapshot-manager
description: Use when tasks require support ticketing snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Snapshot Manager

## Purpose
Design and execute support ticketing workflows using snapshot manager controls with validated outcomes.
