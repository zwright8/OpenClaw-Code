---
name: endpoint-security-permission-mapper
description: Use when tasks require endpoint security permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Permission Mapper

## Purpose
Design and execute endpoint security workflows using permission mapper controls with validated outcomes.
