---
name: access-governance-workflow-compiler
description: Use when tasks require access governance workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Workflow Compiler

## Purpose
Design and execute access governance workflows using workflow compiler controls with validated outcomes.
