---
name: siem-pipelines-compliance-mapper
description: Use when tasks require siem pipelines compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Compliance Mapper

## Purpose
Design and execute siem pipelines workflows using compliance mapper controls with validated outcomes.
