---
name: campaign-automation-evidence-collector
description: Use when tasks require campaign automation evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Evidence Collector

## Purpose
Design and execute campaign automation workflows using evidence collector controls with validated outcomes.
