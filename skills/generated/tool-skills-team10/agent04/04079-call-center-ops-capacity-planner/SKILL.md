---
name: call-center-ops-capacity-planner
description: Use when tasks require call center ops capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Capacity Planner

## Purpose
Design and execute call center ops workflows using capacity planner controls with validated outcomes.
