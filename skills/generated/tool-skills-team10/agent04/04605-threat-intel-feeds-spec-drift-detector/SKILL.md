---
name: threat-intel-feeds-spec-drift-detector
description: Use when tasks require threat intel feeds spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Spec Drift Detector

## Purpose
Design and execute threat intel feeds workflows using spec drift detector controls with validated outcomes.
