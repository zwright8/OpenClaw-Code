---
name: threat-intel-feeds-artifact-publisher
description: Use when tasks require threat intel feeds artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Artifact Publisher

## Purpose
Design and execute threat intel feeds workflows using artifact publisher controls with validated outcomes.
