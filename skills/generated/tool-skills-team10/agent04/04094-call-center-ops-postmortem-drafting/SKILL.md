---
name: call-center-ops-postmortem-drafting
description: Use when tasks require call center ops postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Postmortem Drafting

## Purpose
Design and execute call center ops workflows using postmortem drafting controls with validated outcomes.
