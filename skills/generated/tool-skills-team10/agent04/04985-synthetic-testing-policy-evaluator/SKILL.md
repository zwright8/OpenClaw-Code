---
name: synthetic-testing-policy-evaluator
description: Use when tasks require synthetic testing policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Policy Evaluator

## Purpose
Design and execute synthetic testing workflows using policy evaluator controls with validated outcomes.
