---
name: observability-stacks-artifact-publisher
description: Use when tasks require observability stacks artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Artifact Publisher

## Purpose
Design and execute observability stacks workflows using artifact publisher controls with validated outcomes.
