---
name: uptime-monitors-operation-planner
description: Use when tasks require uptime monitors operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Operation Planner

## Purpose
Design and execute uptime monitors workflows using operation planner controls with validated outcomes.
