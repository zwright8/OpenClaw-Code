---
name: error-tracking-rollback-coordinator
description: Use when tasks require error tracking rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Rollback Coordinator

## Purpose
Design and execute error tracking workflows using rollback coordinator controls with validated outcomes.
