---
name: customer-qa-risk-scorer
description: Use when tasks require customer qa risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Risk Scorer

## Purpose
Design and execute customer qa workflows using risk scorer controls with validated outcomes.
