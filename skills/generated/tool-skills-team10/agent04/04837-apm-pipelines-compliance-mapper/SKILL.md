---
name: apm-pipelines-compliance-mapper
description: Use when tasks require apm pipelines compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Compliance Mapper

## Purpose
Design and execute apm pipelines workflows using compliance mapper controls with validated outcomes.
