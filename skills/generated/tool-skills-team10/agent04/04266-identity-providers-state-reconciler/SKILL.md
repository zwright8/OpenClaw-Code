---
name: identity-providers-state-reconciler
description: Use when tasks require identity providers state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers State Reconciler

## Purpose
Design and execute identity providers workflows using state reconciler controls with validated outcomes.
