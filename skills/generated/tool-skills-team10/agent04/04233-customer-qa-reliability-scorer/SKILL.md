---
name: customer-qa-reliability-scorer
description: Use when tasks require customer qa reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Reliability Scorer

## Purpose
Design and execute customer qa workflows using reliability scorer controls with validated outcomes.
