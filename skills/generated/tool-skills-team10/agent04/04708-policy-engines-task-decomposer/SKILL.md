---
name: policy-engines-task-decomposer
description: Use when tasks require policy engines task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Engines Task Decomposer

## Purpose
Design and execute policy engines workflows using task decomposer controls with validated outcomes.
