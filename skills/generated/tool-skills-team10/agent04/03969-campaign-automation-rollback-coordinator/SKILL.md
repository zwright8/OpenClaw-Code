---
name: campaign-automation-rollback-coordinator
description: Use when tasks require campaign automation rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Rollback Coordinator

## Purpose
Design and execute campaign automation workflows using rollback coordinator controls with validated outcomes.
