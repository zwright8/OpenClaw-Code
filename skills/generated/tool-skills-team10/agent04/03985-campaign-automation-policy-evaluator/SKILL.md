---
name: campaign-automation-policy-evaluator
description: Use when tasks require campaign automation policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Policy Evaluator

## Purpose
Design and execute campaign automation workflows using policy evaluator controls with validated outcomes.
