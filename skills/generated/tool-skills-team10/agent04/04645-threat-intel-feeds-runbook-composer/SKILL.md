---
name: threat-intel-feeds-runbook-composer
description: Use when tasks require threat intel feeds runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Runbook Composer

## Purpose
Design and execute threat intel feeds workflows using runbook composer controls with validated outcomes.
