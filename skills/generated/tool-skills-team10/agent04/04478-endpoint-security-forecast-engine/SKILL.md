---
name: endpoint-security-forecast-engine
description: Use when tasks require endpoint security forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Forecast Engine

## Purpose
Design and execute endpoint security workflows using forecast engine controls with validated outcomes.
