---
name: synthetic-testing-workflow-compiler
description: Use when tasks require synthetic testing workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Workflow Compiler

## Purpose
Design and execute synthetic testing workflows using workflow compiler controls with validated outcomes.
