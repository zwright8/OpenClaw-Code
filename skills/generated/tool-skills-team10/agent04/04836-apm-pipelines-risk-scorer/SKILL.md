---
name: apm-pipelines-risk-scorer
description: Use when tasks require apm pipelines risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Risk Scorer

## Purpose
Design and execute apm pipelines workflows using risk scorer controls with validated outcomes.
