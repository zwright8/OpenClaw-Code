---
name: synthetic-testing-human-handoff-router
description: Use when tasks require synthetic testing human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Human Handoff Router

## Purpose
Design and execute synthetic testing workflows using human handoff router controls with validated outcomes.
