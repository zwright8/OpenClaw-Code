---
name: serverless-runtimes-risk-scorer
description: Use when tasks require serverless runtimes risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Serverless Runtimes Risk Scorer

## Purpose
Design and execute serverless runtimes workflows using risk scorer controls with validated outcomes.
