---
name: apm-pipelines-policy-evaluator
description: Use when tasks require apm pipelines policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Policy Evaluator

## Purpose
Design and execute apm pipelines workflows using policy evaluator controls with validated outcomes.
