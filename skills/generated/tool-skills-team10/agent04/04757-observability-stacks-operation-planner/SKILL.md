---
name: observability-stacks-operation-planner
description: Use when tasks require observability stacks operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Operation Planner

## Purpose
Design and execute observability stacks workflows using operation planner controls with validated outcomes.
