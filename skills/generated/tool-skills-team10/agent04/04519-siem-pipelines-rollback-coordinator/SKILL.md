---
name: siem-pipelines-rollback-coordinator
description: Use when tasks require siem pipelines rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Rollback Coordinator

## Purpose
Design and execute siem pipelines workflows using rollback coordinator controls with validated outcomes.
