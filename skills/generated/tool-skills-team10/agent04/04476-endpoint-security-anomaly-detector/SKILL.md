---
name: endpoint-security-anomaly-detector
description: Use when tasks require endpoint security anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Anomaly Detector

## Purpose
Design and execute endpoint security workflows using anomaly detector controls with validated outcomes.
