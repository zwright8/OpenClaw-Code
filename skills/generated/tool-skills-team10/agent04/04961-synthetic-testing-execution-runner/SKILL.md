---
name: synthetic-testing-execution-runner
description: Use when tasks require synthetic testing execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Execution Runner

## Purpose
Design and execute synthetic testing workflows using execution runner controls with validated outcomes.
