---
name: knowledge-bases-root-cause-miner
description: Use when tasks require knowledge bases root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Root Cause Miner

## Purpose
Design and execute knowledge bases workflows using root cause miner controls with validated outcomes.
