---
name: identity-providers-pii-redactor
description: Use when tasks require identity providers pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers PII Redactor

## Purpose
Design and execute identity providers workflows using pii redactor controls with validated outcomes.
