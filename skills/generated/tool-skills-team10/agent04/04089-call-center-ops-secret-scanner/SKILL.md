---
name: call-center-ops-secret-scanner
description: Use when tasks require call center ops secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Secret Scanner

## Purpose
Design and execute call center ops workflows using secret scanner controls with validated outcomes.
