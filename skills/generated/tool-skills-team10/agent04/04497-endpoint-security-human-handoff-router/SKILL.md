---
name: endpoint-security-human-handoff-router
description: Use when tasks require endpoint security human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Human Handoff Router

## Purpose
Design and execute endpoint security workflows using human handoff router controls with validated outcomes.
