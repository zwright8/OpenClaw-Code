---
name: knowledge-bases-capacity-planner
description: Use when tasks require knowledge bases capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Capacity Planner

## Purpose
Design and execute knowledge bases workflows using capacity planner controls with validated outcomes.
