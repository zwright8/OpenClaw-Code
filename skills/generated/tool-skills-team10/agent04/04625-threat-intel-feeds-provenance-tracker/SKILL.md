---
name: threat-intel-feeds-provenance-tracker
description: Use when tasks require threat intel feeds provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Provenance Tracker

## Purpose
Design and execute threat intel feeds workflows using provenance tracker controls with validated outcomes.
