---
name: incident-queues-auth-broker
description: Use when tasks require incident queues auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Auth Broker

## Purpose
Design and execute incident queues workflows using auth broker controls with validated outcomes.
