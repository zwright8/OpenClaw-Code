---
name: identity-providers-incident-triage
description: Use when tasks require identity providers incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Incident Triage

## Purpose
Design and execute identity providers workflows using incident triage controls with validated outcomes.
