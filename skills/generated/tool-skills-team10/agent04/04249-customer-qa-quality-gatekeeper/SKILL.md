---
name: customer-qa-quality-gatekeeper
description: Use when tasks require customer qa quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Quality Gatekeeper

## Purpose
Design and execute customer qa workflows using quality gatekeeper controls with validated outcomes.
