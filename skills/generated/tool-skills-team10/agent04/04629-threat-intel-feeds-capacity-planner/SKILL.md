---
name: threat-intel-feeds-capacity-planner
description: Use when tasks require threat intel feeds capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Capacity Planner

## Purpose
Design and execute threat intel feeds workflows using capacity planner controls with validated outcomes.
