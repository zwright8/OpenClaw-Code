---
name: call-center-ops-auth-broker
description: Use when tasks require call center ops auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Auth Broker

## Purpose
Design and execute call center ops workflows using auth broker controls with validated outcomes.
