---
name: synthetic-testing-artifact-publisher
description: Use when tasks require synthetic testing artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Artifact Publisher

## Purpose
Design and execute synthetic testing workflows using artifact publisher controls with validated outcomes.
