---
name: call-center-ops-evidence-collector
description: Use when tasks require call center ops evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Evidence Collector

## Purpose
Design and execute call center ops workflows using evidence collector controls with validated outcomes.
