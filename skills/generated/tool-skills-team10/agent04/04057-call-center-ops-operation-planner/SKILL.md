---
name: call-center-ops-operation-planner
description: Use when tasks require call center ops operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Operation Planner

## Purpose
Design and execute call center ops workflows using operation planner controls with validated outcomes.
