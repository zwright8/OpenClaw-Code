---
name: incident-queues-human-handoff-router
description: Use when tasks require incident queues human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Human Handoff Router

## Purpose
Design and execute incident queues workflows using human handoff router controls with validated outcomes.
