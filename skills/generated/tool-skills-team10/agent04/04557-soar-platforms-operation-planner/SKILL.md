---
name: soar-platforms-operation-planner
description: Use when tasks require soar platforms operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Operation Planner

## Purpose
Design and execute soar platforms workflows using operation planner controls with validated outcomes.
