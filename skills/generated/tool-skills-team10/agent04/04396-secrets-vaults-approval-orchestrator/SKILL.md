---
name: secrets-vaults-approval-orchestrator
description: Use when tasks require secrets vaults approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Approval Orchestrator

## Purpose
Design and execute secrets vaults workflows using approval orchestrator controls with validated outcomes.
