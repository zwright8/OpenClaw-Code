---
name: secrets-vaults-incident-triage
description: Use when tasks require secrets vaults incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Incident Triage

## Purpose
Design and execute secrets vaults workflows using incident triage controls with validated outcomes.
