---
name: campaign-automation-incident-triage
description: Use when tasks require campaign automation incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Incident Triage

## Purpose
Design and execute campaign automation workflows using incident triage controls with validated outcomes.
