---
name: infrastructure-as-code-operation-planner
description: Use when tasks require infrastructure as code operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Operation Planner

## Purpose
Design and execute infrastructure as code workflows using operation planner controls with validated outcomes.
