---
name: endpoint-security-rollback-coordinator
description: Use when tasks require endpoint security rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Rollback Coordinator

## Purpose
Design and execute endpoint security workflows using rollback coordinator controls with validated outcomes.
