---
name: threat-intel-feeds-conflict-resolver
description: Use when tasks require threat intel feeds conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Conflict Resolver

## Purpose
Design and execute threat intel feeds workflows using conflict resolver controls with validated outcomes.
