---
name: infrastructure-as-code-snapshot-manager
description: Use when tasks require infrastructure as code snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Snapshot Manager

## Purpose
Design and execute infrastructure as code workflows using snapshot manager controls with validated outcomes.
