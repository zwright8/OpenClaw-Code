---
name: serverless-runtimes-secret-scanner
description: Use when tasks require serverless runtimes secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Serverless Runtimes Secret Scanner

## Purpose
Design and execute serverless runtimes workflows using secret scanner controls with validated outcomes.
