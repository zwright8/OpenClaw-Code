---
name: synthetic-testing-spec-drift-detector
description: Use when tasks require synthetic testing spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Spec Drift Detector

## Purpose
Design and execute synthetic testing workflows using spec drift detector controls with validated outcomes.
