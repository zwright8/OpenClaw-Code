---
name: campaign-automation-access-auditor
description: Use when tasks require campaign automation access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Access Auditor

## Purpose
Design and execute campaign automation workflows using access auditor controls with validated outcomes.
