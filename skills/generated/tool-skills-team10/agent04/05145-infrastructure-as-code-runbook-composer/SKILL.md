---
name: infrastructure-as-code-runbook-composer
description: Use when tasks require infrastructure as code runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Runbook Composer

## Purpose
Design and execute infrastructure as code workflows using runbook composer controls with validated outcomes.
