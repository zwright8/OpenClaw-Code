---
name: siem-pipelines-quality-gatekeeper
description: Use when tasks require siem pipelines quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Quality Gatekeeper

## Purpose
Design and execute siem pipelines workflows using quality gatekeeper controls with validated outcomes.
