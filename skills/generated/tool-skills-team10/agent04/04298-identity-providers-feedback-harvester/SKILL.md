---
name: identity-providers-feedback-harvester
description: Use when tasks require identity providers feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Feedback Harvester

## Purpose
Design and execute identity providers workflows using feedback harvester controls with validated outcomes.
