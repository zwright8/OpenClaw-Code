---
name: endpoint-security-quality-gatekeeper
description: Use when tasks require endpoint security quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Quality Gatekeeper

## Purpose
Design and execute endpoint security workflows using quality gatekeeper controls with validated outcomes.
