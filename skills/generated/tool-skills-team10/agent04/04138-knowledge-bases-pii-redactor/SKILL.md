---
name: knowledge-bases-pii-redactor
description: Use when tasks require knowledge bases pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases PII Redactor

## Purpose
Design and execute knowledge bases workflows using pii redactor controls with validated outcomes.
