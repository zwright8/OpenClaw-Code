---
name: soar-platforms-artifact-publisher
description: Use when tasks require soar platforms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Artifact Publisher

## Purpose
Design and execute soar platforms workflows using artifact publisher controls with validated outcomes.
