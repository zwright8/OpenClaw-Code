---
name: support-ticketing-quality-gatekeeper
description: Use when tasks require support ticketing quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Quality Gatekeeper

## Purpose
Design and execute support ticketing workflows using quality gatekeeper controls with validated outcomes.
