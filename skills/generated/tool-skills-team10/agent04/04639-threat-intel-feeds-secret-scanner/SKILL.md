---
name: threat-intel-feeds-secret-scanner
description: Use when tasks require threat intel feeds secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Secret Scanner

## Purpose
Design and execute threat intel feeds workflows using secret scanner controls with validated outcomes.
