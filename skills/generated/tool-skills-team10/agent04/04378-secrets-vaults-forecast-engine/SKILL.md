---
name: secrets-vaults-forecast-engine
description: Use when tasks require secrets vaults forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Forecast Engine

## Purpose
Design and execute secrets vaults workflows using forecast engine controls with validated outcomes.
