---
name: social-listening-evidence-collector
description: Use when tasks require social listening evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Evidence Collector

## Purpose
Design and execute social listening workflows using evidence collector controls with validated outcomes.
