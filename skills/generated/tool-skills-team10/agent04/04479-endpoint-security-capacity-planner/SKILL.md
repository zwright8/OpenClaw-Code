---
name: endpoint-security-capacity-planner
description: Use when tasks require endpoint security capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Capacity Planner

## Purpose
Design and execute endpoint security workflows using capacity planner controls with validated outcomes.
