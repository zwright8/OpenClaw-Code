---
name: call-center-ops-snapshot-manager
description: Use when tasks require call center ops snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Snapshot Manager

## Purpose
Design and execute call center ops workflows using snapshot manager controls with validated outcomes.
