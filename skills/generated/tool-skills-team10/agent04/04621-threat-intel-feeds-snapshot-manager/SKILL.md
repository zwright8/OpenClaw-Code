---
name: threat-intel-feeds-snapshot-manager
description: Use when tasks require threat intel feeds snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Snapshot Manager

## Purpose
Design and execute threat intel feeds workflows using snapshot manager controls with validated outcomes.
