---
name: secrets-vaults-feedback-harvester
description: Use when tasks require secrets vaults feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Feedback Harvester

## Purpose
Design and execute secrets vaults workflows using feedback harvester controls with validated outcomes.
