---
name: synthetic-testing-feedback-harvester
description: Use when tasks require synthetic testing feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Feedback Harvester

## Purpose
Design and execute synthetic testing workflows using feedback harvester controls with validated outcomes.
