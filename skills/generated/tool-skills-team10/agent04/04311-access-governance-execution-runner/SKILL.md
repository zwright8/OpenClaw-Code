---
name: access-governance-execution-runner
description: Use when tasks require access governance execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Execution Runner

## Purpose
Design and execute access governance workflows using execution runner controls with validated outcomes.
