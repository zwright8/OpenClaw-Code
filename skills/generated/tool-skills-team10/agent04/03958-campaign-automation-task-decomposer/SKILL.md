---
name: campaign-automation-task-decomposer
description: Use when tasks require campaign automation task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Task Decomposer

## Purpose
Design and execute campaign automation workflows using task decomposer controls with validated outcomes.
