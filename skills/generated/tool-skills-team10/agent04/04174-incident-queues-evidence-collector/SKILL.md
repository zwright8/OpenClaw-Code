---
name: incident-queues-evidence-collector
description: Use when tasks require incident queues evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Evidence Collector

## Purpose
Design and execute incident queues workflows using evidence collector controls with validated outcomes.
