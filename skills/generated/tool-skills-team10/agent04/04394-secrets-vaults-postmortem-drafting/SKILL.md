---
name: secrets-vaults-postmortem-drafting
description: Use when tasks require secrets vaults postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Postmortem Drafting

## Purpose
Design and execute secrets vaults workflows using postmortem drafting controls with validated outcomes.
