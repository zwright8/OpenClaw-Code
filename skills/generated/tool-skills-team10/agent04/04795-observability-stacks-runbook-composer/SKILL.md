---
name: observability-stacks-runbook-composer
description: Use when tasks require observability stacks runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Runbook Composer

## Purpose
Design and execute observability stacks workflows using runbook composer controls with validated outcomes.
