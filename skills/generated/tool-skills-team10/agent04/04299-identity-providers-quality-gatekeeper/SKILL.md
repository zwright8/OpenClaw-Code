---
name: identity-providers-quality-gatekeeper
description: Use when tasks require identity providers quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Quality Gatekeeper

## Purpose
Design and execute identity providers workflows using quality gatekeeper controls with validated outcomes.
