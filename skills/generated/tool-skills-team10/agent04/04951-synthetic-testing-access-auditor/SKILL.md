---
name: synthetic-testing-access-auditor
description: Use when tasks require synthetic testing access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Access Auditor

## Purpose
Design and execute synthetic testing workflows using access auditor controls with validated outcomes.
