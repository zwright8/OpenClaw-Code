---
name: error-tracking-approval-orchestrator
description: Use when tasks require error tracking approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Approval Orchestrator

## Purpose
Design and execute error tracking workflows using approval orchestrator controls with validated outcomes.
