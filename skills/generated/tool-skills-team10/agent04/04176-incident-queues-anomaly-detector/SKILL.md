---
name: incident-queues-anomaly-detector
description: Use when tasks require incident queues anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Anomaly Detector

## Purpose
Design and execute incident queues workflows using anomaly detector controls with validated outcomes.
