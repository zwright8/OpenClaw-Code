---
name: campaign-automation-capacity-planner
description: Use when tasks require campaign automation capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Capacity Planner

## Purpose
Design and execute campaign automation workflows using capacity planner controls with validated outcomes.
