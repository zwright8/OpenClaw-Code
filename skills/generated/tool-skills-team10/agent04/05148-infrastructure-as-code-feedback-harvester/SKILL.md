...
description: Use when tasks require infrastructure as code feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Feedback Harvester

## Purpose
Design and execute infrastructure as code workflows using feedback harvester controls with validated outcomes.
