...
description: Use when tasks require infrastructure as code artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Artifact Publisher

## Purpose
Design and execute infrastructure as code workflows using artifact publisher controls with validated outcomes.
