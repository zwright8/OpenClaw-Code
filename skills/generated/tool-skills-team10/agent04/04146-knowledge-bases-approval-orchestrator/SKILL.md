---
name: knowledge-bases-approval-orchestrator
description: Use when tasks require knowledge bases approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Approval Orchestrator

## Purpose
Design and execute knowledge bases workflows using approval orchestrator controls with validated outcomes.
