---
name: error-tracking-quality-gatekeeper
description: Use when tasks require error tracking quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Quality Gatekeeper

## Purpose
Design and execute error tracking workflows using quality gatekeeper controls with validated outcomes.
