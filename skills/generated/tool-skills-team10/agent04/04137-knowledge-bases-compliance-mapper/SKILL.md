---
name: knowledge-bases-compliance-mapper
description: Use when tasks require knowledge bases compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Compliance Mapper

## Purpose
Design and execute knowledge bases workflows using compliance mapper controls with validated outcomes.
