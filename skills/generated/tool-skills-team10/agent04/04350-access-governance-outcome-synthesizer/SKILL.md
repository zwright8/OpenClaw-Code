---
name: access-governance-outcome-synthesizer
description: Use when tasks require access governance outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Outcome Synthesizer

## Purpose
Design and execute access governance workflows using outcome synthesizer controls with validated outcomes.
