---
name: siem-pipelines-policy-evaluator
description: Use when tasks require siem pipelines policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Policy Evaluator

## Purpose
Design and execute siem pipelines workflows using policy evaluator controls with validated outcomes.
