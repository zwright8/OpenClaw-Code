---
name: error-tracking-dependency-resolver
description: Use when tasks require error tracking dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Dependency Resolver

## Purpose
Design and execute error tracking workflows using dependency resolver controls with validated outcomes.
