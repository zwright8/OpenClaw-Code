---
name: synthetic-testing-permission-mapper
description: Use when tasks require synthetic testing permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Permission Mapper

## Purpose
Design and execute synthetic testing workflows using permission mapper controls with validated outcomes.
