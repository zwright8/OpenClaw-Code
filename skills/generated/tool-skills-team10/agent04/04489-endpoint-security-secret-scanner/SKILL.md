---
name: endpoint-security-secret-scanner
description: Use when tasks require endpoint security secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Secret Scanner

## Purpose
Design and execute endpoint security workflows using secret scanner controls with validated outcomes.
