---
name: threat-intel-feeds-cost-attribution
description: Use when tasks require threat intel feeds cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Cost Attribution

## Purpose
Design and execute threat intel feeds workflows using cost attribution controls with validated outcomes.
