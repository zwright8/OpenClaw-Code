---
name: customer-qa-permission-mapper
description: Use when tasks require customer qa permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Permission Mapper

## Purpose
Design and execute customer qa workflows using permission mapper controls with validated outcomes.
