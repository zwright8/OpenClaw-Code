---
name: soar-platforms-job-scheduler
description: Use when tasks require soar platforms job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Job Scheduler

## Purpose
Design and execute soar platforms workflows using job scheduler controls with validated outcomes.
