---
name: call-center-ops-latency-analyzer
description: Use when tasks require call center ops latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Latency Analyzer

## Purpose
Design and execute call center ops workflows using latency analyzer controls with validated outcomes.
