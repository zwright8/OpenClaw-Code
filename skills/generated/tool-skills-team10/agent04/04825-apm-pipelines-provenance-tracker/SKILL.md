---
name: apm-pipelines-provenance-tracker
description: Use when tasks require apm pipelines provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Provenance Tracker

## Purpose
Design and execute apm pipelines workflows using provenance tracker controls with validated outcomes.
