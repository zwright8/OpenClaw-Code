---
name: synthetic-testing-latency-analyzer
description: Use when tasks require synthetic testing latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Latency Analyzer

## Purpose
Design and execute synthetic testing workflows using latency analyzer controls with validated outcomes.
