---
name: incident-queues-budget-guardrail
description: Use when tasks require incident queues budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Budget Guardrail

## Purpose
Design and execute incident queues workflows using budget guardrail controls with validated outcomes.
