---
name: identity-providers-permission-mapper
description: Use when tasks require identity providers permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Permission Mapper

## Purpose
Design and execute identity providers workflows using permission mapper controls with validated outcomes.
