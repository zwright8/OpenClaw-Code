---
name: uptime-monitors-anomaly-detector
description: Use when tasks require uptime monitors anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Anomaly Detector

## Purpose
Design and execute uptime monitors workflows using anomaly detector controls with validated outcomes.
