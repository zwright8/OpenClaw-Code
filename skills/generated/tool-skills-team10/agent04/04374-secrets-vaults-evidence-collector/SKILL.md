---
name: secrets-vaults-evidence-collector
description: Use when tasks require secrets vaults evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Evidence Collector

## Purpose
Design and execute secrets vaults workflows using evidence collector controls with validated outcomes.
