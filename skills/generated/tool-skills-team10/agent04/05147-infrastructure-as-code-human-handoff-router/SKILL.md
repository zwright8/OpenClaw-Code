---
name: infrastructure-as-code-human-handoff-router
description: Use when tasks require infrastructure as code human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Human Handoff Router

## Purpose
Design and execute infrastructure as code workflows using human handoff router controls with validated outcomes.
