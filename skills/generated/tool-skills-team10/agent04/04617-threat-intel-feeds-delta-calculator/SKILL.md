---
name: threat-intel-feeds-delta-calculator
description: Use when tasks require threat intel feeds delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Threat Intel Feeds Delta Calculator

## Purpose
Design and execute threat intel feeds workflows using delta calculator controls with validated outcomes.
