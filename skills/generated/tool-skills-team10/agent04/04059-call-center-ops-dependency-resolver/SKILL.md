---
name: call-center-ops-dependency-resolver
description: Use when tasks require call center ops dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Dependency Resolver

## Purpose
Design and execute call center ops workflows using dependency resolver controls with validated outcomes.
