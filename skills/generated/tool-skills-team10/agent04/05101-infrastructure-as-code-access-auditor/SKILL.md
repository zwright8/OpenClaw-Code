---
name: infrastructure-as-code-access-auditor
description: Use when tasks require infrastructure as code access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Infrastructure as Code Access Auditor

## Purpose
Design and execute infrastructure as code workflows using access auditor controls with validated outcomes.
