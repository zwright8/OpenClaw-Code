---
name: error-tracking-workflow-compiler
description: Use when tasks require error tracking workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Workflow Compiler

## Purpose
Design and execute error tracking workflows using workflow compiler controls with validated outcomes.
