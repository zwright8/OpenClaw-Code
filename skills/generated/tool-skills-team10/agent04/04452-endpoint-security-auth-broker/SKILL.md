...
description: Use when tasks require endpoint security auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security Auth Broker

## Purpose
Design and execute endpoint security workflows using auth broker controls with validated outcomes.
