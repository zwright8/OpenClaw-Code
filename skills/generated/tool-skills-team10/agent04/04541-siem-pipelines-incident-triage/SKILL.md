---
name: siem-pipelines-incident-triage
description: Use when tasks require siem pipelines incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Incident Triage

## Purpose
Design and execute siem pipelines workflows using incident triage controls with validated outcomes.
