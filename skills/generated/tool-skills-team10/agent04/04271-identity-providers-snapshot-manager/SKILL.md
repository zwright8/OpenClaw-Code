---
name: identity-providers-snapshot-manager
description: Use when tasks require identity providers snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Snapshot Manager

## Purpose
Design and execute identity providers workflows using snapshot manager controls with validated outcomes.
