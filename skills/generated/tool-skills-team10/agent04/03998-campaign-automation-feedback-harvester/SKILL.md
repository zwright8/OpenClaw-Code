---
name: campaign-automation-feedback-harvester
description: Use when tasks require campaign automation feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Feedback Harvester

## Purpose
Design and execute campaign automation workflows using feedback harvester controls with validated outcomes.
