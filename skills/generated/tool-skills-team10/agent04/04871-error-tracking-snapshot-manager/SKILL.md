---
name: error-tracking-snapshot-manager
description: Use when tasks require error tracking snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Snapshot Manager

## Purpose
Design and execute error tracking workflows using snapshot manager controls with validated outcomes.
