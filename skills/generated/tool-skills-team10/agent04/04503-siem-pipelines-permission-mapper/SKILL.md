---
name: siem-pipelines-permission-mapper
description: Use when tasks require siem pipelines permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Permission Mapper

## Purpose
Design and execute siem pipelines workflows using permission mapper controls with validated outcomes.
