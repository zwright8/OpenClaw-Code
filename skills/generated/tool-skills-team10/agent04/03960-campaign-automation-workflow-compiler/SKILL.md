---
name: campaign-automation-workflow-compiler
description: Use when tasks require campaign automation workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Workflow Compiler

## Purpose
Design and execute campaign automation workflows using workflow compiler controls with validated outcomes.
