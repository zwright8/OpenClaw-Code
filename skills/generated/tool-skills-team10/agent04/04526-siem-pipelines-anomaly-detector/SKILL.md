---
name: siem-pipelines-anomaly-detector
description: Use when tasks require siem pipelines anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Anomaly Detector

## Purpose
Design and execute siem pipelines workflows using anomaly detector controls with validated outcomes.
