---
name: campaign-automation-anomaly-detector
description: Use when tasks require campaign automation anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Anomaly Detector

## Purpose
Design and execute campaign automation workflows using anomaly detector controls with validated outcomes.
