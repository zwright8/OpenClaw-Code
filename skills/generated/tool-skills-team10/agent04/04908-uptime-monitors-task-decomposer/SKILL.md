---
name: uptime-monitors-task-decomposer
description: Use when tasks require uptime monitors task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Uptime Monitors Task Decomposer

## Purpose
Design and execute uptime monitors workflows using task decomposer controls with validated outcomes.
