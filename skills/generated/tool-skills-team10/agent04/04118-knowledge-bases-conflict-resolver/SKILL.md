---
name: knowledge-bases-conflict-resolver
description: Use when tasks require knowledge bases conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Conflict Resolver

## Purpose
Design and execute knowledge bases workflows using conflict resolver controls with validated outcomes.
