---
name: customer-qa-task-decomposer
description: Use when tasks require customer qa task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Task Decomposer

## Purpose
Design and execute customer qa workflows using task decomposer controls with validated outcomes.
