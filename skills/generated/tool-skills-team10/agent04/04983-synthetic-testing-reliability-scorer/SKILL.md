---
name: synthetic-testing-reliability-scorer
description: Use when tasks require synthetic testing reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Testing Reliability Scorer

## Purpose
Design and execute synthetic testing workflows using reliability scorer controls with validated outcomes.
