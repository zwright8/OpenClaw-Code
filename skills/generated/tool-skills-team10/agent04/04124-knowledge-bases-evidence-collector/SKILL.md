---
name: knowledge-bases-evidence-collector
description: Use when tasks require knowledge bases evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Evidence Collector

## Purpose
Design and execute knowledge bases workflows using evidence collector controls with validated outcomes.
