---
name: access-governance-operation-planner
description: Use when tasks require access governance operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Operation Planner

## Purpose
Design and execute access governance workflows using operation planner controls with validated outcomes.
