---
name: siem-pipelines-budget-guardrail
description: Use when tasks require siem pipelines budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Budget Guardrail

## Purpose
Design and execute siem pipelines workflows using budget guardrail controls with validated outcomes.
