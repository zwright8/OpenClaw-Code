---
name: social-listening-root-cause-miner
description: Use when tasks require social listening root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Root Cause Miner

## Purpose
Design and execute social listening workflows using root cause miner controls with validated outcomes.
