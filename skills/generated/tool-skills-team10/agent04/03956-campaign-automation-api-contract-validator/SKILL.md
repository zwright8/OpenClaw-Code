---
name: campaign-automation-api-contract-validator
description: Use when tasks require campaign automation api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation API Contract Validator

## Purpose
Design and execute campaign automation workflows using api contract validator controls with validated outcomes.

## Precision Profile
- Domain: Campaign Automation
...
- Domain: [Campaign Automation](../../resources/domains/campaign-automation.md)
