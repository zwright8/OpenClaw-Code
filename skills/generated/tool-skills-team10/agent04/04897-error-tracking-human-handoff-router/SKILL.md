---
name: error-tracking-human-handoff-router
description: Use when tasks require error tracking human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Human Handoff Router

## Purpose
Design and execute error tracking workflows using human handoff router controls with validated outcomes.
