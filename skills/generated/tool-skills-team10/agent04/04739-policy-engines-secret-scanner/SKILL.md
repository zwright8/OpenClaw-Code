---
name: policy-engines-secret-scanner
description: Use when tasks require policy engines secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Engines Secret Scanner

## Purpose
Design and execute policy engines workflows using secret scanner controls with validated outcomes.
