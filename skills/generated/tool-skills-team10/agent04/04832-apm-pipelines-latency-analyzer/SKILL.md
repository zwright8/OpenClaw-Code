---
name: apm-pipelines-latency-analyzer
description: Use when tasks require apm pipelines latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Latency Analyzer

## Purpose
Design and execute apm pipelines workflows using latency analyzer controls with validated outcomes.
