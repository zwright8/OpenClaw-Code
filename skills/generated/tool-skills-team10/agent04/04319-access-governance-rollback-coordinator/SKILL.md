---
name: access-governance-rollback-coordinator
description: Use when tasks require access governance rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Rollback Coordinator

## Purpose
Design and execute access governance workflows using rollback coordinator controls with validated outcomes.
