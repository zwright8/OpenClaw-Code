---
name: customer-qa-artifact-publisher
description: Use when tasks require customer qa artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Artifact Publisher

## Purpose
Design and execute customer qa workflows using artifact publisher controls with validated outcomes.
