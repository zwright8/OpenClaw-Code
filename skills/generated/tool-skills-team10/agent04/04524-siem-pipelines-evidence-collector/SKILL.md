---
name: siem-pipelines-evidence-collector
description: Use when tasks require siem pipelines evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Evidence Collector

## Purpose
Design and execute siem pipelines workflows using evidence collector controls with validated outcomes.
