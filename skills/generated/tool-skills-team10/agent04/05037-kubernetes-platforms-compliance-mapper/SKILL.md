---
name: kubernetes-platforms-compliance-mapper
description: Use when tasks require kubernetes platforms compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Kubernetes Platforms Compliance Mapper

## Purpose
Design and execute kubernetes platforms workflows using compliance mapper controls with validated outcomes.
