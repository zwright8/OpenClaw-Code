---
name: observability-stacks-secret-scanner
description: Use when tasks require observability stacks secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Observability Stacks Secret Scanner

## Purpose
Design and execute observability stacks workflows using secret scanner controls with validated outcomes.
