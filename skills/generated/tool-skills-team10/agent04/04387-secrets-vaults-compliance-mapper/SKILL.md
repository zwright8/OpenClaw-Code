---
name: secrets-vaults-compliance-mapper
description: Use when tasks require secrets vaults compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Compliance Mapper

## Purpose
Design and execute secrets vaults workflows using compliance mapper controls with validated outcomes.
