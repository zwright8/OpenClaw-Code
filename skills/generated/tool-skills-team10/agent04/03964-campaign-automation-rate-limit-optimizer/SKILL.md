---
name: campaign-automation-rate-limit-optimizer
description: Use when tasks require campaign automation rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Rate Limit Optimizer

## Purpose
Design and execute campaign automation workflows using rate limit optimizer controls with validated outcomes.
