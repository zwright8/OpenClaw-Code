---
name: apm-pipelines-queue-balancer
description: Use when tasks require apm pipelines queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Queue Balancer

## Purpose
Design and execute apm pipelines workflows using queue balancer controls with validated outcomes.
