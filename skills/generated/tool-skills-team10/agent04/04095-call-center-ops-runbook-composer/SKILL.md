---
name: call-center-ops-runbook-composer
description: Use when tasks require call center ops runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Call Center Ops Runbook Composer

## Purpose
Design and execute call center ops workflows using runbook composer controls with validated outcomes.
