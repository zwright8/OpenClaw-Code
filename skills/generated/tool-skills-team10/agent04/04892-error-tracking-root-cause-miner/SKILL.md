---
name: error-tracking-root-cause-miner
description: Use when tasks require error tracking root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Root Cause Miner

## Purpose
Design and execute error tracking workflows using root cause miner controls with validated outcomes.
