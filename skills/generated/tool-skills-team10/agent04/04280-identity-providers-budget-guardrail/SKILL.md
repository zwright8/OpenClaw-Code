---
name: identity-providers-budget-guardrail
description: Use when tasks require identity providers budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers Budget Guardrail

## Purpose
Design and execute identity providers workflows using budget guardrail controls with validated outcomes.
