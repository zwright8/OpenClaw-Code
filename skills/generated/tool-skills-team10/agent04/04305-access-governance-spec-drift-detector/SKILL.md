---
name: access-governance-spec-drift-detector
description: Use when tasks require access governance spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Spec Drift Detector

## Purpose
Design and execute access governance workflows using spec drift detector controls with validated outcomes.
