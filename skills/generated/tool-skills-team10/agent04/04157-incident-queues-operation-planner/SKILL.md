---
name: incident-queues-operation-planner
description: Use when tasks require incident queues operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Operation Planner

## Purpose
Design and execute incident queues workflows using operation planner controls with validated outcomes.
