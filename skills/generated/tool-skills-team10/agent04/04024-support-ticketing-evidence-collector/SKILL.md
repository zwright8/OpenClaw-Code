---
name: support-ticketing-evidence-collector
description: Use when tasks require support ticketing evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Support Ticketing Evidence Collector

## Purpose
Design and execute support ticketing workflows using evidence collector controls with validated outcomes.
