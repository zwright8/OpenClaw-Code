---
name: siem-pipelines-postmortem-drafting
description: Use when tasks require siem pipelines postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SIEM Pipelines Postmortem Drafting

## Purpose
Design and execute siem pipelines workflows using postmortem drafting controls with validated outcomes.
