---
name: identity-providers-api-contract-validator
description: Use when tasks require identity providers api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Providers API Contract Validator

## Purpose
Design and execute identity providers workflows using api contract validator controls with validated outcomes.
...
- Domain: [Identity Providers](../../resources/domains/identity-providers.md)
