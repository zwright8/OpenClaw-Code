---
name: access-governance-evidence-collector
description: Use when tasks require access governance evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Evidence Collector

## Purpose
Design and execute access governance workflows using evidence collector controls with validated outcomes.
