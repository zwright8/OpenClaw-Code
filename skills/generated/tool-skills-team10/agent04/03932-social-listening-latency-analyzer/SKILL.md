---
name: social-listening-latency-analyzer
description: Use when tasks require social listening latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Latency Analyzer

## Purpose
Design and execute social listening workflows using latency analyzer controls with validated outcomes.
