---
name: customer-qa-postmortem-drafting
description: Use when tasks require customer qa postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer QA Postmortem Drafting

## Purpose
Design and execute customer qa workflows using postmortem drafting controls with validated outcomes.
