---
name: social-listening-conflict-resolver
description: Use when tasks require social listening conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Social Listening Conflict Resolver

## Purpose
Design and execute social listening workflows using conflict resolver controls with validated outcomes.
