---
name: access-governance-access-auditor
description: Use when tasks require access governance access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Access Auditor

## Purpose
Design and execute access governance workflows using access auditor controls with validated outcomes.
