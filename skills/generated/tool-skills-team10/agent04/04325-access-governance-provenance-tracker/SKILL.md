---
name: access-governance-provenance-tracker
description: Use when tasks require access governance provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Provenance Tracker

## Purpose
Design and execute access governance workflows using provenance tracker controls with validated outcomes.
