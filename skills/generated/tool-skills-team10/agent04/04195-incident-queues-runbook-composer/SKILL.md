---
name: incident-queues-runbook-composer
description: Use when tasks require incident queues runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Incident Queues Runbook Composer

## Purpose
Design and execute incident queues workflows using runbook composer controls with validated outcomes.
