---
name: error-tracking-operation-planner
description: Use when tasks require error tracking operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Operation Planner

## Purpose
Design and execute error tracking workflows using operation planner controls with validated outcomes.
