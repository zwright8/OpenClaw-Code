---
name: access-governance-runbook-composer
description: Use when tasks require access governance runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Access Governance Runbook Composer

## Purpose
Design and execute access governance workflows using runbook composer controls with validated outcomes.
