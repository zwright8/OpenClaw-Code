---
name: knowledge-bases-dependency-resolver
description: Use when tasks require knowledge bases dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Dependency Resolver

## Purpose
Design and execute knowledge bases workflows using dependency resolver controls with validated outcomes.
