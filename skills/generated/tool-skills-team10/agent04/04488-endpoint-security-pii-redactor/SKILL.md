---
name: endpoint-security-pii-redactor
description: Use when tasks require endpoint security pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Endpoint Security PII Redactor

## Purpose
Design and execute endpoint security workflows using pii redactor controls with validated outcomes.
