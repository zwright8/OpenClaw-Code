---
name: secrets-vaults-migration-planner
description: Use when tasks require secrets vaults migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Secrets Vaults Migration Planner

## Purpose
Design and execute secrets vaults workflows using migration planner controls with validated outcomes.
