---
name: campaign-automation-execution-runner
description: Use when tasks require campaign automation execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Execution Runner

## Purpose
Design and execute campaign automation workflows using execution runner controls with validated outcomes.
