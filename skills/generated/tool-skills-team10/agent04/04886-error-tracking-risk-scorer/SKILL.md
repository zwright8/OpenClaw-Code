---
name: error-tracking-risk-scorer
description: Use when tasks require error tracking risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Error Tracking Risk Scorer

## Purpose
Design and execute error tracking workflows using risk scorer controls with validated outcomes.
