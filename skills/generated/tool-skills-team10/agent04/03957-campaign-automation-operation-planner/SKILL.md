---
name: campaign-automation-operation-planner
description: Use when tasks require campaign automation operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Campaign Automation Operation Planner

## Purpose
Design and execute campaign automation workflows using operation planner controls with validated outcomes.
