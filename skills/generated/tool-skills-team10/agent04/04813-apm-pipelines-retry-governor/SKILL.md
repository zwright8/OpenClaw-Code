---
name: apm-pipelines-retry-governor
description: Use when tasks require apm pipelines retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# APM Pipelines Retry Governor

## Purpose
Design and execute apm pipelines workflows using retry governor controls with validated outcomes.
