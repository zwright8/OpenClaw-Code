---
name: soar-platforms-execution-runner
description: Use when tasks require soar platforms execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SOAR Platforms Execution Runner

## Purpose
Design and execute soar platforms workflows using execution runner controls with validated outcomes.
