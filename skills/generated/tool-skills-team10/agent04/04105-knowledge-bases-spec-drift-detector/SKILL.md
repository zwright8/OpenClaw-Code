---
name: knowledge-bases-spec-drift-detector
description: Use when tasks require knowledge bases spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Knowledge Bases Spec Drift Detector

## Purpose
Design and execute knowledge bases workflows using spec drift detector controls with validated outcomes.
