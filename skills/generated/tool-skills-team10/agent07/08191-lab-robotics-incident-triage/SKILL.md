---
name: lab-robotics-incident-triage
description: Use when tasks require lab robotics incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Incident Triage

## Purpose
Design and execute lab robotics workflows using incident triage controls with validated outcomes.
