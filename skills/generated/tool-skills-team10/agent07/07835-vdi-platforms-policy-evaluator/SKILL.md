---
name: vdi-platforms-policy-evaluator
description: Use when tasks require vdi platforms policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Policy Evaluator

## Purpose
Design and execute vdi platforms workflows using policy evaluator controls with validated outcomes.
