---
name: legislative-tracking-execution-runner
description: Use when tasks require legislative tracking execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Execution Runner

## Purpose
Design and execute legislative tracking workflows using execution runner controls with validated outcomes.
