---
name: lab-robotics-evidence-collector
description: Use when tasks require lab robotics evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Evidence Collector

## Purpose
Design and execute lab robotics workflows using evidence collector controls with validated outcomes.
