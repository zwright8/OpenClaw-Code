---
name: policy-drafting-capacity-planner
description: Use when tasks require policy drafting capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Capacity Planner

## Purpose
Design and execute policy drafting workflows using capacity planner controls with validated outcomes.
