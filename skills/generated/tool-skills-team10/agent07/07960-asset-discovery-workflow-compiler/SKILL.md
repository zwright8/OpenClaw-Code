---
name: asset-discovery-workflow-compiler
description: Use when tasks require asset discovery workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Workflow Compiler

## Purpose
Design and execute asset discovery workflows using workflow compiler controls with validated outcomes.
