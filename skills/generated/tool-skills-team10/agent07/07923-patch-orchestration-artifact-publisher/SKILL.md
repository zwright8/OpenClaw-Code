---
name: patch-orchestration-artifact-publisher
description: Use when tasks require patch orchestration artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Artifact Publisher

## Purpose
Design and execute patch orchestration workflows using artifact publisher controls with validated outcomes.
