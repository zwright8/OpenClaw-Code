---
name: civic-engagement-permission-mapper
description: Use when tasks require civic engagement permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Permission Mapper

## Purpose
Design and execute civic engagement workflows using permission mapper controls with validated outcomes.
