---
name: chemical-informatics-evidence-collector
description: Use when tasks require chemical informatics evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chemical Informatics Evidence Collector

## Purpose
Design and execute chemical informatics workflows using evidence collector controls with validated outcomes.
