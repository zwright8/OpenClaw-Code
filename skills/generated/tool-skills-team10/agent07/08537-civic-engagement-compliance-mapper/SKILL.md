---
name: civic-engagement-compliance-mapper
description: Use when tasks require civic engagement compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Compliance Mapper

## Purpose
Design and execute civic engagement workflows using compliance mapper controls with validated outcomes.
