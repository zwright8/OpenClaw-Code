---
name: emergency-response-snapshot-manager
description: Use when tasks require emergency response snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Snapshot Manager

## Purpose
Design and execute emergency response workflows using snapshot manager controls with validated outcomes.
