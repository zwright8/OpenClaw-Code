---
name: asset-discovery-budget-guardrail
description: Use when tasks require asset discovery budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Budget Guardrail

## Purpose
Design and execute asset discovery workflows using budget guardrail controls with validated outcomes.
