---
name: nonprofit-program-ops-spec-drift-detector
description: Use when tasks require nonprofit program ops spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Spec Drift Detector

## Purpose
Design and execute nonprofit program ops workflows using spec drift detector controls with validated outcomes.
