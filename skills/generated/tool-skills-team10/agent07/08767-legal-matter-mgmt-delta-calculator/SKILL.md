---
name: legal-matter-mgmt-delta-calculator
description: Use when tasks require legal matter mgmt delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Delta Calculator

## Purpose
Design and execute legal matter mgmt workflows using delta calculator controls with validated outcomes.
