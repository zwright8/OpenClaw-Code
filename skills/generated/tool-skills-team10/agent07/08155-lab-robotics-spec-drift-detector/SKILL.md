---
name: lab-robotics-spec-drift-detector
description: Use when tasks require lab robotics spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Spec Drift Detector

## Purpose
Design and execute lab robotics workflows using spec drift detector controls with validated outcomes.
