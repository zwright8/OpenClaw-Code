---
name: nonprofit-program-ops-root-cause-miner
description: Use when tasks require nonprofit program ops root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Root Cause Miner

## Purpose
Design and execute nonprofit program ops workflows using root cause miner controls with validated outcomes.
