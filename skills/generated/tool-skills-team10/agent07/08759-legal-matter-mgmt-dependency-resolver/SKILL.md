---
name: legal-matter-mgmt-dependency-resolver
description: Use when tasks require legal matter mgmt dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Dependency Resolver

## Purpose
Design and execute legal matter mgmt workflows using dependency resolver controls with validated outcomes.
