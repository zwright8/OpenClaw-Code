---
name: scientific-publishing-remediation-planner
description: Use when tasks require scientific publishing remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Remediation Planner

## Purpose
Design and execute scientific publishing workflows using remediation planner controls with validated outcomes.
