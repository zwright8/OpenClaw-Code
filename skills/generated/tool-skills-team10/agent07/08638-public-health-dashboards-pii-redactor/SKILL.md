---
name: public-health-dashboards-pii-redactor
description: Use when tasks require public health dashboards pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards PII Redactor

## Purpose
Design and execute public health dashboards workflows using pii redactor controls with validated outcomes.
