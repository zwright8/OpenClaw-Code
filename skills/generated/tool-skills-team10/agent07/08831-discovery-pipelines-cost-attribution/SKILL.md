---
name: discovery-pipelines-cost-attribution
description: Use when tasks require discovery pipelines cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Cost Attribution

## Purpose
Design and execute discovery pipelines workflows using cost attribution controls with validated outcomes.
