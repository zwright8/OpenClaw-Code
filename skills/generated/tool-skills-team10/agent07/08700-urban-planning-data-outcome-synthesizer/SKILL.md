---
name: urban-planning-data-outcome-synthesizer
description: Use when tasks require urban planning data outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Outcome Synthesizer

## Purpose
Design and execute urban planning data workflows using outcome synthesizer controls with validated outcomes.
