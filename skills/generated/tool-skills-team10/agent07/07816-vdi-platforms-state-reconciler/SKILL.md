---
name: vdi-platforms-state-reconciler
description: Use when tasks require vdi platforms state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms State Reconciler

## Purpose
Design and execute vdi platforms workflows using state reconciler controls with validated outcomes.
