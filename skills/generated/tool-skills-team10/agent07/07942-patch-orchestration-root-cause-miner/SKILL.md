---
name: patch-orchestration-root-cause-miner
description: Use when tasks require patch orchestration root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Root Cause Miner

## Purpose
Design and execute patch orchestration workflows using root cause miner controls with validated outcomes.
