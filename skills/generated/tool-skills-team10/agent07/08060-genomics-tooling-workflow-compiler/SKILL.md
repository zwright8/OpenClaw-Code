---
name: genomics-tooling-workflow-compiler
description: Use when tasks require genomics tooling workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Workflow Compiler

## Purpose
Design and execute genomics tooling workflows using workflow compiler controls with validated outcomes.
