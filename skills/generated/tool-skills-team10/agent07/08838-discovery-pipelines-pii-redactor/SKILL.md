---
name: discovery-pipelines-pii-redactor
description: Use when tasks require discovery pipelines pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines PII Redactor

## Purpose
Design and execute discovery pipelines workflows using pii redactor controls with validated outcomes.
