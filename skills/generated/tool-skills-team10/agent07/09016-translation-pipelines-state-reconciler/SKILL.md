---
name: translation-pipelines-state-reconciler
description: Use when tasks require translation pipelines state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Translation Pipelines State Reconciler

## Purpose
Design and execute translation pipelines workflows using state reconciler controls with validated outcomes.
