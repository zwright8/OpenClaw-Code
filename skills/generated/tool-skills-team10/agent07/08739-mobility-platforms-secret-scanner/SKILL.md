---
name: mobility-platforms-secret-scanner
description: Use when tasks require mobility platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobility Platforms Secret Scanner

## Purpose
Design and execute mobility platforms workflows using secret scanner controls with validated outcomes.
