---
name: legal-matter-mgmt-rollback-coordinator
description: Use when tasks require legal matter mgmt rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Rollback Coordinator

## Purpose
Design and execute legal matter mgmt workflows using rollback coordinator controls with validated outcomes.
