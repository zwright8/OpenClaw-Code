---
name: asset-discovery-rollback-coordinator
description: Use when tasks require asset discovery rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Rollback Coordinator

## Purpose
Design and execute asset discovery workflows using rollback coordinator controls with validated outcomes.
