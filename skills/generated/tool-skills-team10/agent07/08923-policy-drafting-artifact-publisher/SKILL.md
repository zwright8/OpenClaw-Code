---
name: policy-drafting-artifact-publisher
description: Use when tasks require policy drafting artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Artifact Publisher

## Purpose
Design and execute policy drafting workflows using artifact publisher controls with validated outcomes.
