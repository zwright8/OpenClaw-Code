---
name: civic-engagement-reliability-scorer
description: Use when tasks require civic engagement reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Reliability Scorer

## Purpose
Design and execute civic engagement workflows using reliability scorer controls with validated outcomes.
