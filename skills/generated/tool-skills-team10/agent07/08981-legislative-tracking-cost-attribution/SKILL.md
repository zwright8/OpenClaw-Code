---
name: legislative-tracking-cost-attribution
description: Use when tasks require legislative tracking cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Cost Attribution

## Purpose
Design and execute legislative tracking workflows using cost attribution controls with validated outcomes.
