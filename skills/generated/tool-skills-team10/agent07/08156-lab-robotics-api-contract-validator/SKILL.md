---
name: lab-robotics-api-contract-validator
description: Use when tasks require lab robotics api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics API Contract Validator

## Purpose
Design and execute lab robotics workflows using api contract validator controls with validated outcomes.
...
- Domain: [Lab Robotics](../../resources/domains/lab-robotics.md)
