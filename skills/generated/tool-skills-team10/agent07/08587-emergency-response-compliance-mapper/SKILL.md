---
name: emergency-response-compliance-mapper
description: Use when tasks require emergency response compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Compliance Mapper

## Purpose
Design and execute emergency response workflows using compliance mapper controls with validated outcomes.
