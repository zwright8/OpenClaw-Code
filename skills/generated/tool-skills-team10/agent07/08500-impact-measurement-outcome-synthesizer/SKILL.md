---
name: impact-measurement-outcome-synthesizer
description: Use when tasks require impact measurement outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Outcome Synthesizer

## Purpose
Design and execute impact measurement workflows using outcome synthesizer controls with validated outcomes.
