---
name: nonprofit-program-ops-state-reconciler
description: Use when tasks require nonprofit program ops state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops State Reconciler

## Purpose
Design and execute nonprofit program ops workflows using state reconciler controls with validated outcomes.
