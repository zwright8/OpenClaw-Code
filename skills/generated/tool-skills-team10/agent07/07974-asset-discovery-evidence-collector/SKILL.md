---
name: asset-discovery-evidence-collector
description: Use when tasks require asset discovery evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Evidence Collector

## Purpose
Design and execute asset discovery workflows using evidence collector controls with validated outcomes.
