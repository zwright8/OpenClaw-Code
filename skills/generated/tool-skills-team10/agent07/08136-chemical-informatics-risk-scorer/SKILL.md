---
name: chemical-informatics-risk-scorer
description: Use when tasks require chemical informatics risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chemical Informatics Risk Scorer

## Purpose
Design and execute chemical informatics workflows using risk scorer controls with validated outcomes.
