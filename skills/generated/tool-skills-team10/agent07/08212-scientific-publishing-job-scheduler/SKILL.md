---
name: scientific-publishing-job-scheduler
description: Use when tasks require scientific publishing job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Job Scheduler

## Purpose
Design and execute scientific publishing workflows using job scheduler controls with validated outcomes.
