---
name: nonprofit-program-ops-anomaly-detector
description: Use when tasks require nonprofit program ops anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Anomaly Detector

## Purpose
Design and execute nonprofit program ops workflows using anomaly detector controls with validated outcomes.
