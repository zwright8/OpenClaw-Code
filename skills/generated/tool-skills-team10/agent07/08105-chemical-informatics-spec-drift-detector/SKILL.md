---
name: chemical-informatics-spec-drift-detector
description: Use when tasks require chemical informatics spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chemical Informatics Spec Drift Detector

## Purpose
Design and execute chemical informatics workflows using spec drift detector controls with validated outcomes.
