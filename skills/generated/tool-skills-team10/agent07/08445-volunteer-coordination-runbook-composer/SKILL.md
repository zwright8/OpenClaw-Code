---
name: volunteer-coordination-runbook-composer
description: Use when tasks require volunteer coordination runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Runbook Composer

## Purpose
Design and execute volunteer coordination workflows using runbook composer controls with validated outcomes.
