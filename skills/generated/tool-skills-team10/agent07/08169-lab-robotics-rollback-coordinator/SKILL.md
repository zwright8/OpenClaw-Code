---
name: lab-robotics-rollback-coordinator
description: Use when tasks require lab robotics rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Rollback Coordinator

## Purpose
Design and execute lab robotics workflows using rollback coordinator controls with validated outcomes.
