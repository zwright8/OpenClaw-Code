---
name: nonprofit-program-ops-evidence-collector
description: Use when tasks require nonprofit program ops evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Evidence Collector

## Purpose
Design and execute nonprofit program ops workflows using evidence collector controls with validated outcomes.
