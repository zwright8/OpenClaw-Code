---
name: genomics-tooling-dependency-resolver
description: Use when tasks require genomics tooling dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Dependency Resolver

## Purpose
Design and execute genomics tooling workflows using dependency resolver controls with validated outcomes.
