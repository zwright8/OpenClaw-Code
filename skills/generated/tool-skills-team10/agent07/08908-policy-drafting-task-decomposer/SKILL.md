---
name: policy-drafting-task-decomposer
description: Use when tasks require policy drafting task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Task Decomposer

## Purpose
Design and execute policy drafting workflows using task decomposer controls with validated outcomes.
