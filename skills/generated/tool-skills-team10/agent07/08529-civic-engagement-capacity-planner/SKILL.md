---
name: civic-engagement-capacity-planner
description: Use when tasks require civic engagement capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Capacity Planner

## Purpose
Design and execute civic engagement workflows using capacity planner controls with validated outcomes.
