---
name: scientific-publishing-task-decomposer
description: Use when tasks require scientific publishing task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Task Decomposer

## Purpose
Design and execute scientific publishing workflows using task decomposer controls with validated outcomes.
