---
name: public-health-dashboards-rollback-coordinator
description: Use when tasks require public health dashboards rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Rollback Coordinator

## Purpose
Design and execute public health dashboards workflows using rollback coordinator controls with validated outcomes.
