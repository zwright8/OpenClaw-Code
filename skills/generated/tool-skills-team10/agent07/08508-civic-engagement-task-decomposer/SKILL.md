---
name: civic-engagement-task-decomposer
description: Use when tasks require civic engagement task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Task Decomposer

## Purpose
Design and execute civic engagement workflows using task decomposer controls with validated outcomes.
