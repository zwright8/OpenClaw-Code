---
name: bioinformatics-pipelines-remediation-planner
description: Use when tasks require bioinformatics pipelines remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Remediation Planner

## Purpose
Design and execute bioinformatics pipelines workflows using remediation planner controls with validated outcomes.
