---
name: civic-engagement-threshold-alerting
description: Use when tasks require civic engagement threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Threshold Alerting

## Purpose
Design and execute civic engagement workflows using threshold alerting controls with validated outcomes.
