---
name: patch-orchestration-state-reconciler
description: Use when tasks require patch orchestration state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration State Reconciler

## Purpose
Design and execute patch orchestration workflows using state reconciler controls with validated outcomes.
