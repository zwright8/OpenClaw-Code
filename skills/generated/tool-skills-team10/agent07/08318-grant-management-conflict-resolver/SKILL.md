---
name: grant-management-conflict-resolver
description: Use when tasks require grant management conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Conflict Resolver

## Purpose
Design and execute grant management workflows using conflict resolver controls with validated outcomes.
