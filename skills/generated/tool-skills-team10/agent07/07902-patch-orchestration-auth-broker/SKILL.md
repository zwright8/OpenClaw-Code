---
name: patch-orchestration-auth-broker
description: Use when tasks require patch orchestration auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Auth Broker

## Purpose
Design and execute patch orchestration workflows using auth broker controls with validated outcomes.
