---
name: vdi-platforms-human-handoff-router
description: Use when tasks require vdi platforms human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Human Handoff Router

## Purpose
Design and execute vdi platforms workflows using human handoff router controls with validated outcomes.
