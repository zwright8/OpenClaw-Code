---
name: public-health-dashboards-root-cause-miner
description: Use when tasks require public health dashboards root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Root Cause Miner

## Purpose
Design and execute public health dashboards workflows using root cause miner controls with validated outcomes.
