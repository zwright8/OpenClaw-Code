---
name: remote-access-quality-gatekeeper
description: Use when tasks require remote access quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Remote Access Quality Gatekeeper

## Purpose
Design and execute remote access workflows using quality gatekeeper controls with validated outcomes.
