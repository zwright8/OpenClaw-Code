---
name: legislative-tracking-snapshot-manager
description: Use when tasks require legislative tracking snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Snapshot Manager

## Purpose
Design and execute legislative tracking workflows using snapshot manager controls with validated outcomes.
