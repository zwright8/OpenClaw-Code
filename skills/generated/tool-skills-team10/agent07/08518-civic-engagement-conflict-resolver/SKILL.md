---
name: civic-engagement-conflict-resolver
description: Use when tasks require civic engagement conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Conflict Resolver

## Purpose
Design and execute civic engagement workflows using conflict resolver controls with validated outcomes.
