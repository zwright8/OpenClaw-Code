---
name: case-collaboration-runbook-composer
description: Use when tasks require case collaboration runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Runbook Composer

## Purpose
Design and execute case collaboration workflows using runbook composer controls with validated outcomes.
