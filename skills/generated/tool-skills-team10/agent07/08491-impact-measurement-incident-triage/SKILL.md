---
name: impact-measurement-incident-triage
description: Use when tasks require impact measurement incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Incident Triage

## Purpose
Design and execute impact measurement workflows using incident triage controls with validated outcomes.
