---
name: remote-access-incident-triage
description: Use when tasks require remote access incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Remote Access Incident Triage

## Purpose
Design and execute remote access workflows using incident triage controls with validated outcomes.
