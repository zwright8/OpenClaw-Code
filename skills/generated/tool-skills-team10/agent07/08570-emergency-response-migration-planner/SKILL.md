---
name: emergency-response-migration-planner
description: Use when tasks require emergency response migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Migration Planner

## Purpose
Design and execute emergency response workflows using migration planner controls with validated outcomes.
