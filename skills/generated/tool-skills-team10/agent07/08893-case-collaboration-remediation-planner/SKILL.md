---
name: case-collaboration-remediation-planner
description: Use when tasks require case collaboration remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Remediation Planner

## Purpose
Design and execute case collaboration workflows using remediation planner controls with validated outcomes.
