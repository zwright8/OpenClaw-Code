---
name: emergency-response-postmortem-drafting
description: Use when tasks require emergency response postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Postmortem Drafting

## Purpose
Design and execute emergency response workflows using postmortem drafting controls with validated outcomes.
