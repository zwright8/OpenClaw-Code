---
name: lab-robotics-state-reconciler
description: Use when tasks require lab robotics state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics State Reconciler

## Purpose
Design and execute lab robotics workflows using state reconciler controls with validated outcomes.
