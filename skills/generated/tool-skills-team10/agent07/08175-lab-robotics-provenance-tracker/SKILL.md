---
name: lab-robotics-provenance-tracker
description: Use when tasks require lab robotics provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Provenance Tracker

## Purpose
Design and execute lab robotics workflows using provenance tracker controls with validated outcomes.
