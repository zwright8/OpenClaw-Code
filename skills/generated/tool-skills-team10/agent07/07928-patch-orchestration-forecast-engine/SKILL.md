---
name: patch-orchestration-forecast-engine
description: Use when tasks require patch orchestration forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Forecast Engine

## Purpose
Design and execute patch orchestration workflows using forecast engine controls with validated outcomes.
