---
name: emergency-response-permission-mapper
description: Use when tasks require emergency response permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Permission Mapper

## Purpose
Design and execute emergency response workflows using permission mapper controls with validated outcomes.
