---
name: legislative-tracking-forecast-engine
description: Use when tasks require legislative tracking forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Forecast Engine

## Purpose
Design and execute legislative tracking workflows using forecast engine controls with validated outcomes.
