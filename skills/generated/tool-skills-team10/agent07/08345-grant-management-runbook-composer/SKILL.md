---
name: grant-management-runbook-composer
description: Use when tasks require grant management runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Runbook Composer

## Purpose
Design and execute grant management workflows using runbook composer controls with validated outcomes.
