---
name: donor-platforms-feedback-harvester
description: Use when tasks require donor platforms feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Feedback Harvester

## Purpose
Design and execute donor platforms workflows using feedback harvester controls with validated outcomes.
