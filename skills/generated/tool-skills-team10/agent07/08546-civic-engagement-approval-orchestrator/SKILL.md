---
name: civic-engagement-approval-orchestrator
description: Use when tasks require civic engagement approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Approval Orchestrator

## Purpose
Design and execute civic engagement workflows using approval orchestrator controls with validated outcomes.
