---
name: case-collaboration-reliability-scorer
description: Use when tasks require case collaboration reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Reliability Scorer

## Purpose
Design and execute case collaboration workflows using reliability scorer controls with validated outcomes.
