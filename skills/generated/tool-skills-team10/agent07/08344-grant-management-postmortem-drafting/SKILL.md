---
name: grant-management-postmortem-drafting
description: Use when tasks require grant management postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Postmortem Drafting

## Purpose
Design and execute grant management workflows using postmortem drafting controls with validated outcomes.
