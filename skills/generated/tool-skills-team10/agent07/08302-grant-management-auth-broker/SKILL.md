---
name: grant-management-auth-broker
description: Use when tasks require grant management auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Auth Broker

## Purpose
Design and execute grant management workflows using auth broker controls with validated outcomes.
