---
name: donor-platforms-artifact-publisher
description: Use when tasks require donor platforms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Artifact Publisher

## Purpose
Design and execute donor platforms workflows using artifact publisher controls with validated outcomes.
