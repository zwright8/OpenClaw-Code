---
name: chemical-informatics-secret-scanner
description: Use when tasks require chemical informatics secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chemical Informatics Secret Scanner

## Purpose
Design and execute chemical informatics workflows using secret scanner controls with validated outcomes.
