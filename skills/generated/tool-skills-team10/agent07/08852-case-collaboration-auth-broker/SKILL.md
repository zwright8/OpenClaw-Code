---
name: case-collaboration-auth-broker
description: Use when tasks require case collaboration auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Auth Broker

## Purpose
Design and execute case collaboration workflows using auth broker controls with validated outcomes.
