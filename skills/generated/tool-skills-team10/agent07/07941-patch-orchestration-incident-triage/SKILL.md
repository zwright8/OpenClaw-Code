---
name: patch-orchestration-incident-triage
description: Use when tasks require patch orchestration incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Incident Triage

## Purpose
Design and execute patch orchestration workflows using incident triage controls with validated outcomes.
