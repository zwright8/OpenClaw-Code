---
name: case-collaboration-spec-drift-detector
description: Use when tasks require case collaboration spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Spec Drift Detector

## Purpose
Design and execute case collaboration workflows using spec drift detector controls with validated outcomes.
