---
name: emergency-response-remediation-planner
description: Use when tasks require emergency response remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Remediation Planner

## Purpose
Design and execute emergency response workflows using remediation planner controls with validated outcomes.
