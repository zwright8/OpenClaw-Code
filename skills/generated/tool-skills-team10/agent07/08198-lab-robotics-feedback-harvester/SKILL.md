---
name: lab-robotics-feedback-harvester
description: Use when tasks require lab robotics feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Feedback Harvester

## Purpose
Design and execute lab robotics workflows using feedback harvester controls with validated outcomes.
