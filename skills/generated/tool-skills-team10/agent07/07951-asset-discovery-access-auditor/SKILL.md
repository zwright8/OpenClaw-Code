---
name: asset-discovery-access-auditor
description: Use when tasks require asset discovery access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Access Auditor

## Purpose
Design and execute asset discovery workflows using access auditor controls with validated outcomes.
