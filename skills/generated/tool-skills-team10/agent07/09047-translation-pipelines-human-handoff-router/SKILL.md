---
name: translation-pipelines-human-handoff-router
description: Use when tasks require translation pipelines human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Translation Pipelines Human Handoff Router

## Purpose
Design and execute translation pipelines workflows using human handoff router controls with validated outcomes.
