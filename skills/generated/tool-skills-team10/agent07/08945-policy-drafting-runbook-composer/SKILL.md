---
name: policy-drafting-runbook-composer
description: Use when tasks require policy drafting runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Runbook Composer

## Purpose
Design and execute policy drafting workflows using runbook composer controls with validated outcomes.
