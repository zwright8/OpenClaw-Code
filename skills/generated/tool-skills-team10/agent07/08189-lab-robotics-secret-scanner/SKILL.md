---
name: lab-robotics-secret-scanner
description: Use when tasks require lab robotics secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Secret Scanner

## Purpose
Design and execute lab robotics workflows using secret scanner controls with validated outcomes.
