---
name: donor-platforms-evidence-collector
description: Use when tasks require donor platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Evidence Collector

## Purpose
Design and execute donor platforms workflows using evidence collector controls with validated outcomes.
