---
name: legislative-tracking-spec-drift-detector
description: Use when tasks require legislative tracking spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Spec Drift Detector

## Purpose
Design and execute legislative tracking workflows using spec drift detector controls with validated outcomes.
