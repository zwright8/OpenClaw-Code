---
name: asset-discovery-pii-redactor
description: Use when tasks require asset discovery pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery PII Redactor

## Purpose
Design and execute asset discovery workflows using pii redactor controls with validated outcomes.
