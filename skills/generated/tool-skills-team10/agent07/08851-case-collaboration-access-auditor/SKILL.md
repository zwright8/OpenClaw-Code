---
name: case-collaboration-access-auditor
description: Use when tasks require case collaboration access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Access Auditor

## Purpose
Design and execute case collaboration workflows using access auditor controls with validated outcomes.
