---
name: policy-drafting-human-handoff-router
description: Use when tasks require policy drafting human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Human Handoff Router

## Purpose
Design and execute policy drafting workflows using human handoff router controls with validated outcomes.
