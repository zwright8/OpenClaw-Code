---
name: grant-management-human-handoff-router
description: Use when tasks require grant management human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Human Handoff Router

## Purpose
Design and execute grant management workflows using human handoff router controls with validated outcomes.
