---
name: discovery-pipelines-operation-planner
description: Use when tasks require discovery pipelines operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Operation Planner

## Purpose
Design and execute discovery pipelines workflows using operation planner controls with validated outcomes.
