---
name: policy-drafting-risk-scorer
description: Use when tasks require policy drafting risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Risk Scorer

## Purpose
Design and execute policy drafting workflows using risk scorer controls with validated outcomes.
