---
name: policy-drafting-evidence-collector
description: Use when tasks require policy drafting evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Evidence Collector

## Purpose
Design and execute policy drafting workflows using evidence collector controls with validated outcomes.
