---
name: lab-robotics-reliability-scorer
description: Use when tasks require lab robotics reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Reliability Scorer

## Purpose
Design and execute lab robotics workflows using reliability scorer controls with validated outcomes.
