---
name: asset-discovery-state-reconciler
description: Use when tasks require asset discovery state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery State Reconciler

## Purpose
Design and execute asset discovery workflows using state reconciler controls with validated outcomes.
