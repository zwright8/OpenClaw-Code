---
name: discovery-pipelines-compliance-mapper
description: Use when tasks require discovery pipelines compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Compliance Mapper

## Purpose
Design and execute discovery pipelines workflows using compliance mapper controls with validated outcomes.
