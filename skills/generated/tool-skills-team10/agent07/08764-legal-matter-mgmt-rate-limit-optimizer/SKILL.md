---
name: legal-matter-mgmt-rate-limit-optimizer
description: Use when tasks require legal matter mgmt rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Rate Limit Optimizer

## Purpose
Design and execute legal matter mgmt workflows using rate limit optimizer controls with validated outcomes.
