---
name: legislative-tracking-access-auditor
description: Use when tasks require legislative tracking access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Access Auditor

## Purpose
Design and execute legislative tracking workflows using access auditor controls with validated outcomes.
