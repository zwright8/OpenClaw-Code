---
name: nonprofit-program-ops-provenance-tracker
description: Use when tasks require nonprofit program ops provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Provenance Tracker

## Purpose
Design and execute nonprofit program ops workflows using provenance tracker controls with validated outcomes.
