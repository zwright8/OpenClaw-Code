---
name: lab-robotics-capacity-planner
description: Use when tasks require lab robotics capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Capacity Planner

## Purpose
Design and execute lab robotics workflows using capacity planner controls with validated outcomes.
