---
name: patch-orchestration-rollback-coordinator
description: Use when tasks require patch orchestration rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Rollback Coordinator

## Purpose
Design and execute patch orchestration workflows using rollback coordinator controls with validated outcomes.
