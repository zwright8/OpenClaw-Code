---
name: patch-orchestration-human-handoff-router
description: Use when tasks require patch orchestration human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Human Handoff Router

## Purpose
Design and execute patch orchestration workflows using human handoff router controls with validated outcomes.
