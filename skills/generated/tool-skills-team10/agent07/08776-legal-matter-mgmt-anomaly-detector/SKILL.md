---
name: legal-matter-mgmt-anomaly-detector
description: Use when tasks require legal matter mgmt anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Anomaly Detector

## Purpose
Design and execute legal matter mgmt workflows using anomaly detector controls with validated outcomes.
