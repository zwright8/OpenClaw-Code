---
name: patch-orchestration-quality-gatekeeper
description: Use when tasks require patch orchestration quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Quality Gatekeeper

## Purpose
Design and execute patch orchestration workflows using quality gatekeeper controls with validated outcomes.
