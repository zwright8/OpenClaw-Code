---
name: lab-robotics-operation-planner
description: Use when tasks require lab robotics operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Operation Planner

## Purpose
Design and execute lab robotics workflows using operation planner controls with validated outcomes.
