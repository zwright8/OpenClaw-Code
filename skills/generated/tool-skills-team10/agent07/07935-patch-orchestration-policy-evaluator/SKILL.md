---
name: patch-orchestration-policy-evaluator
description: Use when tasks require patch orchestration policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Policy Evaluator

## Purpose
Design and execute patch orchestration workflows using policy evaluator controls with validated outcomes.
