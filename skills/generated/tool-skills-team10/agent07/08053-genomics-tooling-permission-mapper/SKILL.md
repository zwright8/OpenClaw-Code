---
name: genomics-tooling-permission-mapper
description: Use when tasks require genomics tooling permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Permission Mapper

## Purpose
Design and execute genomics tooling workflows using permission mapper controls with validated outcomes.
