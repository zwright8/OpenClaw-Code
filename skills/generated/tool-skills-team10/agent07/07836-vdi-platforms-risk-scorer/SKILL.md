---
name: vdi-platforms-risk-scorer
description: Use when tasks require vdi platforms risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Risk Scorer

## Purpose
Design and execute vdi platforms workflows using risk scorer controls with validated outcomes.
