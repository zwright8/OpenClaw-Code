---
name: legal-matter-mgmt-permission-mapper
description: Use when tasks require legal matter mgmt permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Permission Mapper

## Purpose
Design and execute legal matter mgmt workflows using permission mapper controls with validated outcomes.
