---
name: grant-management-risk-scorer
description: Use when tasks require grant management risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Risk Scorer

## Purpose
Design and execute grant management workflows using risk scorer controls with validated outcomes.
