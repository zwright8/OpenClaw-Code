---
name: donor-platforms-dependency-resolver
description: Use when tasks require donor platforms dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Dependency Resolver

## Purpose
Design and execute donor platforms workflows using dependency resolver controls with validated outcomes.
