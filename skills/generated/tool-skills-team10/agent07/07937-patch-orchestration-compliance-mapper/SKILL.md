---
name: patch-orchestration-compliance-mapper
description: Use when tasks require patch orchestration compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Compliance Mapper

## Purpose
Design and execute patch orchestration workflows using compliance mapper controls with validated outcomes.
