---
name: case-collaboration-permission-mapper
description: Use when tasks require case collaboration permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Permission Mapper

## Purpose
Design and execute case collaboration workflows using permission mapper controls with validated outcomes.
