---
name: scientific-publishing-operation-planner
description: Use when tasks require scientific publishing operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Operation Planner

## Purpose
Design and execute scientific publishing workflows using operation planner controls with validated outcomes.
