---
name: lab-robotics-rate-limit-optimizer
description: Use when tasks require lab robotics rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Rate Limit Optimizer

## Purpose
Design and execute lab robotics workflows using rate limit optimizer controls with validated outcomes.
