---
name: grant-management-incident-triage
description: Use when tasks require grant management incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Incident Triage

## Purpose
Design and execute grant management workflows using incident triage controls with validated outcomes.
