---
name: case-collaboration-secret-scanner
description: Use when tasks require case collaboration secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Secret Scanner

## Purpose
Design and execute case collaboration workflows using secret scanner controls with validated outcomes.
