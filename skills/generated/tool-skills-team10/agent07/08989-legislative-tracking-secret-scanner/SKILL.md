---
name: legislative-tracking-secret-scanner
description: Use when tasks require legislative tracking secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Secret Scanner

## Purpose
Design and execute legislative tracking workflows using secret scanner controls with validated outcomes.
