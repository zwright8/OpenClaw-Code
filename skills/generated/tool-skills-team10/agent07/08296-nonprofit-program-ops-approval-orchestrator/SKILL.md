---
name: nonprofit-program-ops-approval-orchestrator
description: Use when tasks require nonprofit program ops approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Approval Orchestrator

## Purpose
Design and execute nonprofit program ops workflows using approval orchestrator controls with validated outcomes.
