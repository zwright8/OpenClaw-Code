---
name: public-health-dashboards-rate-limit-optimizer
description: Use when tasks require public health dashboards rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Rate Limit Optimizer

## Purpose
Design and execute public health dashboards workflows using rate limit optimizer controls with validated outcomes.
