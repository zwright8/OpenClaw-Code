---
name: legal-matter-mgmt-capacity-planner
description: Use when tasks require legal matter mgmt capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Capacity Planner

## Purpose
Design and execute legal matter mgmt workflows using capacity planner controls with validated outcomes.
