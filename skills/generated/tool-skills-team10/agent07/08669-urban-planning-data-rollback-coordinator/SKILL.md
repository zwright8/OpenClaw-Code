---
name: urban-planning-data-rollback-coordinator
description: Use when tasks require urban planning data rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Rollback Coordinator

## Purpose
Design and execute urban planning data workflows using rollback coordinator controls with validated outcomes.
