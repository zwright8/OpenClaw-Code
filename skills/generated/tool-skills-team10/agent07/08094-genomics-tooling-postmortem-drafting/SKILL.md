---
name: genomics-tooling-postmortem-drafting
description: Use when tasks require genomics tooling postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Postmortem Drafting

## Purpose
Design and execute genomics tooling workflows using postmortem drafting controls with validated outcomes.
