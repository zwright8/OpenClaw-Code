---
name: discovery-pipelines-permission-mapper
description: Use when tasks require discovery pipelines permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Permission Mapper

## Purpose
Design and execute discovery pipelines workflows using permission mapper controls with validated outcomes.
