---
name: civic-engagement-provenance-tracker
description: Use when tasks require civic engagement provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Provenance Tracker

## Purpose
Design and execute civic engagement workflows using provenance tracker controls with validated outcomes.
