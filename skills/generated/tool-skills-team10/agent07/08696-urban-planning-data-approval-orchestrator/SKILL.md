---
name: urban-planning-data-approval-orchestrator
description: Use when tasks require urban planning data approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Approval Orchestrator

## Purpose
Design and execute urban planning data workflows using approval orchestrator controls with validated outcomes.
