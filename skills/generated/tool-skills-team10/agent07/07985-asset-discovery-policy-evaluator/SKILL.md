---
name: asset-discovery-policy-evaluator
description: Use when tasks require asset discovery policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Policy Evaluator

## Purpose
Design and execute asset discovery workflows using policy evaluator controls with validated outcomes.
