---
name: nonprofit-program-ops-quality-gatekeeper
description: Use when tasks require nonprofit program ops quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Quality Gatekeeper

## Purpose
Design and execute nonprofit program ops workflows using quality gatekeeper controls with validated outcomes.
