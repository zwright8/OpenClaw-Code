---
name: impact-measurement-workflow-compiler
description: Use when tasks require impact measurement workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Workflow Compiler

## Purpose
Design and execute impact measurement workflows using workflow compiler controls with validated outcomes.
