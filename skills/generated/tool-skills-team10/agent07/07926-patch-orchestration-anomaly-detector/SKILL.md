---
name: patch-orchestration-anomaly-detector
description: Use when tasks require patch orchestration anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Anomaly Detector

## Purpose
Design and execute patch orchestration workflows using anomaly detector controls with validated outcomes.
