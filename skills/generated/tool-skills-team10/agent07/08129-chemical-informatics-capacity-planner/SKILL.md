---
name: chemical-informatics-capacity-planner
description: Use when tasks require chemical informatics capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chemical Informatics Capacity Planner

## Purpose
Design and execute chemical informatics workflows using capacity planner controls with validated outcomes.
