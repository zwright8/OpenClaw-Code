---
name: legal-matter-mgmt-cost-attribution
description: Use when tasks require legal matter mgmt cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Cost Attribution

## Purpose
Design and execute legal matter mgmt workflows using cost attribution controls with validated outcomes.
