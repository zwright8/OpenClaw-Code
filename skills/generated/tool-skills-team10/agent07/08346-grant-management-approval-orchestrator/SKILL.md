---
name: grant-management-approval-orchestrator
description: Use when tasks require grant management approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Approval Orchestrator

## Purpose
Design and execute grant management workflows using approval orchestrator controls with validated outcomes.
