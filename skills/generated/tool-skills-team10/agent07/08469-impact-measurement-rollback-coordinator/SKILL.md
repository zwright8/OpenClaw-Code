---
name: impact-measurement-rollback-coordinator
description: Use when tasks require impact measurement rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Rollback Coordinator

## Purpose
Design and execute impact measurement workflows using rollback coordinator controls with validated outcomes.
