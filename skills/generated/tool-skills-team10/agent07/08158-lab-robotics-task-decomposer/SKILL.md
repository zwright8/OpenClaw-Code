---
name: lab-robotics-task-decomposer
description: Use when tasks require lab robotics task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Task Decomposer

## Purpose
Design and execute lab robotics workflows using task decomposer controls with validated outcomes.
