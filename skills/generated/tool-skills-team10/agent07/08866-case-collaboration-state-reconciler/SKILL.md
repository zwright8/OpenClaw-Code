---
name: case-collaboration-state-reconciler
description: Use when tasks require case collaboration state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration State Reconciler

## Purpose
Design and execute case collaboration workflows using state reconciler controls with validated outcomes.
