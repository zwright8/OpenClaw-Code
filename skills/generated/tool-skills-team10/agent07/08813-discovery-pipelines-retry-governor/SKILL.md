---
name: discovery-pipelines-retry-governor
description: Use when tasks require discovery pipelines retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Retry Governor

## Purpose
Design and execute discovery pipelines workflows using retry governor controls with validated outcomes.
