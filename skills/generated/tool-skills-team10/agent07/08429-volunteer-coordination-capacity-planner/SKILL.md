---
name: volunteer-coordination-capacity-planner
description: Use when tasks require volunteer coordination capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Capacity Planner

## Purpose
Design and execute volunteer coordination workflows using capacity planner controls with validated outcomes.
