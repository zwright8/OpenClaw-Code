---
name: volunteer-coordination-spec-drift-detector
description: Use when tasks require volunteer coordination spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Spec Drift Detector

## Purpose
Design and execute volunteer coordination workflows using spec drift detector controls with validated outcomes.
