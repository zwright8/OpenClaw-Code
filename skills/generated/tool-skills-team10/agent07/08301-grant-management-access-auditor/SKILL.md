---
name: grant-management-access-auditor
description: Use when tasks require grant management access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Access Auditor

## Purpose
Design and execute grant management workflows using access auditor controls with validated outcomes.
