---
name: legal-matter-mgmt-secret-scanner
description: Use when tasks require legal matter mgmt secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Secret Scanner

## Purpose
Design and execute legal matter mgmt workflows using secret scanner controls with validated outcomes.
