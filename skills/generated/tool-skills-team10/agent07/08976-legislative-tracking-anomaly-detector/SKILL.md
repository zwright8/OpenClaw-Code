---
name: legislative-tracking-anomaly-detector
description: Use when tasks require legislative tracking anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Anomaly Detector

## Purpose
Design and execute legislative tracking workflows using anomaly detector controls with validated outcomes.
