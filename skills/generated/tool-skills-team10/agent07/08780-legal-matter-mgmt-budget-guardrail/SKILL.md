---
name: legal-matter-mgmt-budget-guardrail
description: Use when tasks require legal matter mgmt budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Budget Guardrail

## Purpose
Design and execute legal matter mgmt workflows using budget guardrail controls with validated outcomes.
