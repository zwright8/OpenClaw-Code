---
name: impact-measurement-cost-attribution
description: Use when tasks require impact measurement cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Cost Attribution

## Purpose
Design and execute impact measurement workflows using cost attribution controls with validated outcomes.
