---
name: legislative-tracking-policy-evaluator
description: Use when tasks require legislative tracking policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Policy Evaluator

## Purpose
Design and execute legislative tracking workflows using policy evaluator controls with validated outcomes.
