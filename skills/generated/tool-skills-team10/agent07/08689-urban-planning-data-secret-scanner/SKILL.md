---
name: urban-planning-data-secret-scanner
description: Use when tasks require urban planning data secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Secret Scanner

## Purpose
Design and execute urban planning data workflows using secret scanner controls with validated outcomes.
