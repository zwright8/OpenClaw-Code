---
name: impact-measurement-retry-governor
description: Use when tasks require impact measurement retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Retry Governor

## Purpose
Design and execute impact measurement workflows using retry governor controls with validated outcomes.
