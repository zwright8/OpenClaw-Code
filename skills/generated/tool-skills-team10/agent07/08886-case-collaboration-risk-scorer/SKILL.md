---
name: case-collaboration-risk-scorer
description: Use when tasks require case collaboration risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Risk Scorer

## Purpose
Design and execute case collaboration workflows using risk scorer controls with validated outcomes.
