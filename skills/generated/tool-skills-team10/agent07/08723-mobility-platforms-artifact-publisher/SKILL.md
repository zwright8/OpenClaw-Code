---
name: mobility-platforms-artifact-publisher
description: Use when tasks require mobility platforms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobility Platforms Artifact Publisher

## Purpose
Design and execute mobility platforms workflows using artifact publisher controls with validated outcomes.
