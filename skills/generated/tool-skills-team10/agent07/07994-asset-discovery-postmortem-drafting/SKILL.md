---
name: asset-discovery-postmortem-drafting
description: Use when tasks require asset discovery postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Postmortem Drafting

## Purpose
Design and execute asset discovery workflows using postmortem drafting controls with validated outcomes.
