---
name: vdi-platforms-access-auditor
description: Use when tasks require vdi platforms access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Access Auditor

## Purpose
Design and execute vdi platforms workflows using access auditor controls with validated outcomes.
