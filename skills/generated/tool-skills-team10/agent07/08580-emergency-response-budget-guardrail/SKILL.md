---
name: emergency-response-budget-guardrail
description: Use when tasks require emergency response budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Budget Guardrail

## Purpose
Design and execute emergency response workflows using budget guardrail controls with validated outcomes.
