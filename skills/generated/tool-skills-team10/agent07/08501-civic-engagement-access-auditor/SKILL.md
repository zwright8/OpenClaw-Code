---
name: civic-engagement-access-auditor
description: Use when tasks require civic engagement access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Access Auditor

## Purpose
Design and execute civic engagement workflows using access auditor controls with validated outcomes.
