---
name: translation-pipelines-evidence-collector
description: Use when tasks require translation pipelines evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Translation Pipelines Evidence Collector

## Purpose
Design and execute translation pipelines workflows using evidence collector controls with validated outcomes.
