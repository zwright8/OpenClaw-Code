---
name: emergency-response-workflow-compiler
description: Use when tasks require emergency response workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Workflow Compiler

## Purpose
Design and execute emergency response workflows using workflow compiler controls with validated outcomes.
