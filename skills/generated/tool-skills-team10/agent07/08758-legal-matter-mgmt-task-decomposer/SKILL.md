---
name: legal-matter-mgmt-task-decomposer
description: Use when tasks require legal matter mgmt task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Task Decomposer

## Purpose
Design and execute legal matter mgmt workflows using task decomposer controls with validated outcomes.
