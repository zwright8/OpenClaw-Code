---
name: public-health-dashboards-migration-planner
description: Use when tasks require public health dashboards migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Migration Planner

## Purpose
Design and execute public health dashboards workflows using migration planner controls with validated outcomes.
