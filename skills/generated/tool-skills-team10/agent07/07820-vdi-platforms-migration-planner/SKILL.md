---
name: vdi-platforms-migration-planner
description: Use when tasks require vdi platforms migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Migration Planner

## Purpose
Design and execute vdi platforms workflows using migration planner controls with validated outcomes.
