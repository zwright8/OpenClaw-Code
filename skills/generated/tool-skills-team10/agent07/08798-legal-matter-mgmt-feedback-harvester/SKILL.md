---
name: legal-matter-mgmt-feedback-harvester
description: Use when tasks require legal matter mgmt feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Feedback Harvester

## Purpose
Design and execute legal matter mgmt workflows using feedback harvester controls with validated outcomes.
