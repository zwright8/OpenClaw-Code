---
name: patch-orchestration-spec-drift-detector
description: Use when tasks require patch orchestration spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Spec Drift Detector

## Purpose
Design and execute patch orchestration workflows using spec drift detector controls with validated outcomes.
