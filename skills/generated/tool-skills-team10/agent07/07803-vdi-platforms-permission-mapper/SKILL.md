---
name: vdi-platforms-permission-mapper
description: Use when tasks require vdi platforms permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Permission Mapper

## Purpose
Design and execute vdi platforms workflows using permission mapper controls with validated outcomes.
