---
name: nonprofit-program-ops-human-handoff-router
description: Use when tasks require nonprofit program ops human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Human Handoff Router

## Purpose
Design and execute nonprofit program ops workflows using human handoff router controls with validated outcomes.
