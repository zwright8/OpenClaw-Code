---
name: vdi-platforms-schema-introspector
description: Use when tasks require vdi platforms schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Schema Introspector

## Purpose
Design and execute vdi platforms workflows using schema introspector controls with validated outcomes.
