---
name: civic-engagement-secret-scanner
description: Use when tasks require civic engagement secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Secret Scanner

## Purpose
Design and execute civic engagement workflows using secret scanner controls with validated outcomes.
