---
name: legislative-tracking-remediation-planner
description: Use when tasks require legislative tracking remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Remediation Planner

## Purpose
Design and execute legislative tracking workflows using remediation planner controls with validated outcomes.
