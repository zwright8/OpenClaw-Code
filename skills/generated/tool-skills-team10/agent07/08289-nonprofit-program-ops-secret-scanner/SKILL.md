---
name: nonprofit-program-ops-secret-scanner
description: Use when tasks require nonprofit program ops secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Secret Scanner

## Purpose
Design and execute nonprofit program ops workflows using secret scanner controls with validated outcomes.
