---
name: donor-platforms-anomaly-detector
description: Use when tasks require donor platforms anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Anomaly Detector

## Purpose
Design and execute donor platforms workflows using anomaly detector controls with validated outcomes.
