---
name: grant-management-artifact-publisher
description: Use when tasks require grant management artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Artifact Publisher

## Purpose
Design and execute grant management workflows using artifact publisher controls with validated outcomes.
