---
name: chemical-informatics-incident-triage
description: Use when tasks require chemical informatics incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chemical Informatics Incident Triage

## Purpose
Design and execute chemical informatics workflows using incident triage controls with validated outcomes.
