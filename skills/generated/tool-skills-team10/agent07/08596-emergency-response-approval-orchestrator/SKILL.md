---
name: emergency-response-approval-orchestrator
description: Use when tasks require emergency response approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Approval Orchestrator

## Purpose
Design and execute emergency response workflows using approval orchestrator controls with validated outcomes.
