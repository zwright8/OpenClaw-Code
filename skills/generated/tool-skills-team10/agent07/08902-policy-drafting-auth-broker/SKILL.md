---
name: policy-drafting-auth-broker
description: Use when tasks require policy drafting auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Auth Broker

## Purpose
Design and execute policy drafting workflows using auth broker controls with validated outcomes.
