---
name: chemical-informatics-task-decomposer
description: Use when tasks require chemical informatics task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chemical Informatics Task Decomposer

## Purpose
Design and execute chemical informatics workflows using task decomposer controls with validated outcomes.
