---
name: discovery-pipelines-task-decomposer
description: Use when tasks require discovery pipelines task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Task Decomposer

## Purpose
Design and execute discovery pipelines workflows using task decomposer controls with validated outcomes.
