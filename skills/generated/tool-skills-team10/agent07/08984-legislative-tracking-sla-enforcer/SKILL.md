---
name: legislative-tracking-sla-enforcer
description: Use when tasks require legislative tracking sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking SLA Enforcer

## Purpose
Design and execute legislative tracking workflows using sla enforcer controls with validated outcomes.
