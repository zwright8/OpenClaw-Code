---
name: civic-engagement-artifact-publisher
description: Use when tasks require civic engagement artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Artifact Publisher

## Purpose
Design and execute civic engagement workflows using artifact publisher controls with validated outcomes.
