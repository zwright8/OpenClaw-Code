---
name: urban-planning-data-conflict-resolver
description: Use when tasks require urban planning data conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Conflict Resolver

## Purpose
Design and execute urban planning data workflows using conflict resolver controls with validated outcomes.
