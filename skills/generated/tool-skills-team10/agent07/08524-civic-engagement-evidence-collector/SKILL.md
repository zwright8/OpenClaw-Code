---
name: civic-engagement-evidence-collector
description: Use when tasks require civic engagement evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Evidence Collector

## Purpose
Design and execute civic engagement workflows using evidence collector controls with validated outcomes.
