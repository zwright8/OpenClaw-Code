---
name: grant-management-remediation-planner
description: Use when tasks require grant management remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Remediation Planner

## Purpose
Design and execute grant management workflows using remediation planner controls with validated outcomes.
