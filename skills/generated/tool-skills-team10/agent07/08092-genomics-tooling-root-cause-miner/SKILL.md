---
name: genomics-tooling-root-cause-miner
description: Use when tasks require genomics tooling root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Root Cause Miner

## Purpose
Design and execute genomics tooling workflows using root cause miner controls with validated outcomes.
