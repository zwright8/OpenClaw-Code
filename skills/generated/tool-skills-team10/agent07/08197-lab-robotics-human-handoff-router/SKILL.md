---
name: lab-robotics-human-handoff-router
description: Use when tasks require lab robotics human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Human Handoff Router

## Purpose
Design and execute lab robotics workflows using human handoff router controls with validated outcomes.
