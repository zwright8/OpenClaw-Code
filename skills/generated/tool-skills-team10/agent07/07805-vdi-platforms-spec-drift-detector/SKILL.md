---
name: vdi-platforms-spec-drift-detector
description: Use when tasks require vdi platforms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Spec Drift Detector

## Purpose
Design and execute vdi platforms workflows using spec drift detector controls with validated outcomes.
