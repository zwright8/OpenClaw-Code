---
name: public-health-dashboards-compliance-mapper
description: Use when tasks require public health dashboards compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Compliance Mapper

## Purpose
Design and execute public health dashboards workflows using compliance mapper controls with validated outcomes.
