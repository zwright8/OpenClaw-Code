---
name: emergency-response-secret-scanner
description: Use when tasks require emergency response secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Secret Scanner

## Purpose
Design and execute emergency response workflows using secret scanner controls with validated outcomes.
