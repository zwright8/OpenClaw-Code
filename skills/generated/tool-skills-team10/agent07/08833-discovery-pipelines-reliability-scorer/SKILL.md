---
name: discovery-pipelines-reliability-scorer
description: Use when tasks require discovery pipelines reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Reliability Scorer

## Purpose
Design and execute discovery pipelines workflows using reliability scorer controls with validated outcomes.
