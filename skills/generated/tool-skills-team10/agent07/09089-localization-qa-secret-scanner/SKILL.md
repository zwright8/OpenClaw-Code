---
name: localization-qa-secret-scanner
description: Use when tasks require localization qa secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Secret Scanner

## Purpose
Design and execute localization qa workflows using secret scanner controls with validated outcomes.
