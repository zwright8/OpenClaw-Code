---
name: emergency-response-retry-governor
description: Use when tasks require emergency response retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Retry Governor

## Purpose
Design and execute emergency response workflows using retry governor controls with validated outcomes.
