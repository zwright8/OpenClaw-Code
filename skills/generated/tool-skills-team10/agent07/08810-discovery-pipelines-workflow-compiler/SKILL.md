---
name: discovery-pipelines-workflow-compiler
description: Use when tasks require discovery pipelines workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Workflow Compiler

## Purpose
Design and execute discovery pipelines workflows using workflow compiler controls with validated outcomes.
