---
name: lab-robotics-execution-runner
description: Use when tasks require lab robotics execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Execution Runner

## Purpose
Design and execute lab robotics workflows using execution runner controls with validated outcomes.
