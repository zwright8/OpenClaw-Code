---
name: legislative-tracking-migration-planner
description: Use when tasks require legislative tracking migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Migration Planner

## Purpose
Design and execute legislative tracking workflows using migration planner controls with validated outcomes.
