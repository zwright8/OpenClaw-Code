---
name: patch-orchestration-capacity-planner
description: Use when tasks require patch orchestration capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Capacity Planner

## Purpose
Design and execute patch orchestration workflows using capacity planner controls with validated outcomes.
