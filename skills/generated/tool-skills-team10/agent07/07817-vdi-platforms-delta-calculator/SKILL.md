---
name: vdi-platforms-delta-calculator
description: Use when tasks require vdi platforms delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Delta Calculator

## Purpose
Design and execute vdi platforms workflows using delta calculator controls with validated outcomes.
