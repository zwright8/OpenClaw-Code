---
name: legislative-tracking-feedback-harvester
description: Use when tasks require legislative tracking feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Feedback Harvester

## Purpose
Design and execute legislative tracking workflows using feedback harvester controls with validated outcomes.
