---
name: translation-pipelines-dependency-resolver
description: Use when tasks require translation pipelines dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Translation Pipelines Dependency Resolver

## Purpose
Design and execute translation pipelines workflows using dependency resolver controls with validated outcomes.
