---
name: civic-engagement-risk-scorer
description: Use when tasks require civic engagement risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Risk Scorer

## Purpose
Design and execute civic engagement workflows using risk scorer controls with validated outcomes.
