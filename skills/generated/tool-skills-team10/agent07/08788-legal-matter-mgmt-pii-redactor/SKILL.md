---
name: legal-matter-mgmt-pii-redactor
description: Use when tasks require legal matter mgmt pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt PII Redactor

## Purpose
Design and execute legal matter mgmt workflows using pii redactor controls with validated outcomes.
