---
name: asset-discovery-rate-limit-optimizer
description: Use when tasks require asset discovery rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Rate Limit Optimizer

## Purpose
Design and execute asset discovery workflows using rate limit optimizer controls with validated outcomes.
