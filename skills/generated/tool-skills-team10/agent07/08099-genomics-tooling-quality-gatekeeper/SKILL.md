---
name: genomics-tooling-quality-gatekeeper
description: Use when tasks require genomics tooling quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Quality Gatekeeper

## Purpose
Design and execute genomics tooling workflows using quality gatekeeper controls with validated outcomes.
