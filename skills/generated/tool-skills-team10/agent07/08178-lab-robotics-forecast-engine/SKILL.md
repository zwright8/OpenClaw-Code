---
name: lab-robotics-forecast-engine
description: Use when tasks require lab robotics forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Forecast Engine

## Purpose
Design and execute lab robotics workflows using forecast engine controls with validated outcomes.
