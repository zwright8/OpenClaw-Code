---
name: legislative-tracking-runbook-composer
description: Use when tasks require legislative tracking runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Runbook Composer

## Purpose
Design and execute legislative tracking workflows using runbook composer controls with validated outcomes.
