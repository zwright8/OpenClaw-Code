---
name: scientific-publishing-state-reconciler
description: Use when tasks require scientific publishing state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing State Reconciler

## Purpose
Design and execute scientific publishing workflows using state reconciler controls with validated outcomes.
