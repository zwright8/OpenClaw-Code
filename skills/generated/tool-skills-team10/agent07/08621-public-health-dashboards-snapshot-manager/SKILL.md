---
name: public-health-dashboards-snapshot-manager
description: Use when tasks require public health dashboards snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Snapshot Manager

## Purpose
Design and execute public health dashboards workflows using snapshot manager controls with validated outcomes.
