---
name: remote-access-auth-broker
description: Use when tasks require remote access auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Remote Access Auth Broker

## Purpose
Design and execute remote access workflows using auth broker controls with validated outcomes.
