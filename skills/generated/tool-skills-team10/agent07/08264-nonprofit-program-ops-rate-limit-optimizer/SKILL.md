---
name: nonprofit-program-ops-rate-limit-optimizer
description: Use when tasks require nonprofit program ops rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Rate Limit Optimizer

## Purpose
Design and execute nonprofit program ops workflows using rate limit optimizer controls with validated outcomes.
