---
name: donor-platforms-policy-evaluator
description: Use when tasks require donor platforms policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Policy Evaluator

## Purpose
Design and execute donor platforms workflows using policy evaluator controls with validated outcomes.
