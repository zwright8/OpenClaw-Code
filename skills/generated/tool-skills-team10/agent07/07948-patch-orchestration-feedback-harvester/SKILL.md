---
name: patch-orchestration-feedback-harvester
description: Use when tasks require patch orchestration feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Feedback Harvester

## Purpose
Design and execute patch orchestration workflows using feedback harvester controls with validated outcomes.
