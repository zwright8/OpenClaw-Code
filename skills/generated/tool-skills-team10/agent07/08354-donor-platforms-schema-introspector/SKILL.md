---
name: donor-platforms-schema-introspector
description: Use when tasks require donor platforms schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Schema Introspector

## Purpose
Design and execute donor platforms workflows using schema introspector controls with validated outcomes.
