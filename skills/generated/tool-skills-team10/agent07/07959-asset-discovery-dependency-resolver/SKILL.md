---
name: asset-discovery-dependency-resolver
description: Use when tasks require asset discovery dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Dependency Resolver

## Purpose
Design and execute asset discovery workflows using dependency resolver controls with validated outcomes.
