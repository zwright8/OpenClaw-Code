---
name: legislative-tracking-capacity-planner
description: Use when tasks require legislative tracking capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Capacity Planner

## Purpose
Design and execute legislative tracking workflows using capacity planner controls with validated outcomes.
