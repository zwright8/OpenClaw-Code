---
name: discovery-pipelines-snapshot-manager
description: Use when tasks require discovery pipelines snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Snapshot Manager

## Purpose
Design and execute discovery pipelines workflows using snapshot manager controls with validated outcomes.
