---
name: public-health-dashboards-runbook-composer
description: Use when tasks require public health dashboards runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Runbook Composer

## Purpose
Design and execute public health dashboards workflows using runbook composer controls with validated outcomes.
