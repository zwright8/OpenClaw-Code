---
name: legislative-tracking-auth-broker
description: Use when tasks require legislative tracking auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Auth Broker

## Purpose
Design and execute legislative tracking workflows using auth broker controls with validated outcomes.
