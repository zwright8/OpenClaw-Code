---
name: impact-measurement-remediation-planner
description: Use when tasks require impact measurement remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Remediation Planner

## Purpose
Design and execute impact measurement workflows using remediation planner controls with validated outcomes.
