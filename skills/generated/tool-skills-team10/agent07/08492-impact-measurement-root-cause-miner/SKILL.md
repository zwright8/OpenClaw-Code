---
name: impact-measurement-root-cause-miner
description: Use when tasks require impact measurement root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Root Cause Miner

## Purpose
Design and execute impact measurement workflows using root cause miner controls with validated outcomes.
