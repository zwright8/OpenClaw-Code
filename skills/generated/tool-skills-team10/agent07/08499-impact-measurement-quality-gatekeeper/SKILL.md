---
name: impact-measurement-quality-gatekeeper
description: Use when tasks require impact measurement quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Quality Gatekeeper

## Purpose
Design and execute impact measurement workflows using quality gatekeeper controls with validated outcomes.
