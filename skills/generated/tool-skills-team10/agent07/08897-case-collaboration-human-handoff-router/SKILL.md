---
name: case-collaboration-human-handoff-router
description: Use when tasks require case collaboration human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Human Handoff Router

## Purpose
Design and execute case collaboration workflows using human handoff router controls with validated outcomes.
