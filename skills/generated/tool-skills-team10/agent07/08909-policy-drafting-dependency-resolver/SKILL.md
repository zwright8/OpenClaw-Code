---
name: policy-drafting-dependency-resolver
description: Use when tasks require policy drafting dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Dependency Resolver

## Purpose
Design and execute policy drafting workflows using dependency resolver controls with validated outcomes.
