---
name: vdi-platforms-capacity-planner
description: Use when tasks require vdi platforms capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Capacity Planner

## Purpose
Design and execute vdi platforms workflows using capacity planner controls with validated outcomes.
