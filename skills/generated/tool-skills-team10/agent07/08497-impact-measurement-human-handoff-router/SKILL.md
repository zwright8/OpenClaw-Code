---
name: impact-measurement-human-handoff-router
description: Use when tasks require impact measurement human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Human Handoff Router

## Purpose
Design and execute impact measurement workflows using human handoff router controls with validated outcomes.
