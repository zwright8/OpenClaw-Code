---
name: donor-platforms-permission-mapper
description: Use when tasks require donor platforms permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Permission Mapper

## Purpose
Design and execute donor platforms workflows using permission mapper controls with validated outcomes.
