---
name: public-health-dashboards-permission-mapper
description: Use when tasks require public health dashboards permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Permission Mapper

## Purpose
Design and execute public health dashboards workflows using permission mapper controls with validated outcomes.
