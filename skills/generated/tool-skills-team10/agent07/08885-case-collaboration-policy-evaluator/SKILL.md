---
name: case-collaboration-policy-evaluator
description: Use when tasks require case collaboration policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Policy Evaluator

## Purpose
Design and execute case collaboration workflows using policy evaluator controls with validated outcomes.
