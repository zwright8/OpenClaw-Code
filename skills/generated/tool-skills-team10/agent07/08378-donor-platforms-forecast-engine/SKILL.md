---
name: donor-platforms-forecast-engine
description: Use when tasks require donor platforms forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Forecast Engine

## Purpose
Design and execute donor platforms workflows using forecast engine controls with validated outcomes.
