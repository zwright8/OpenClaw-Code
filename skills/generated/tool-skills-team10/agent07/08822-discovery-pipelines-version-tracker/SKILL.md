---
name: discovery-pipelines-version-tracker
description: Use when tasks require discovery pipelines version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Version Tracker

## Purpose
Design and execute discovery pipelines workflows using version tracker controls with validated outcomes.
