---
name: urban-planning-data-snapshot-manager
description: Use when tasks require urban planning data snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Snapshot Manager

## Purpose
Design and execute urban planning data workflows using snapshot manager controls with validated outcomes.
