---
name: genomics-tooling-anomaly-detector
description: Use when tasks require genomics tooling anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Anomaly Detector

## Purpose
Design and execute genomics tooling workflows using anomaly detector controls with validated outcomes.
