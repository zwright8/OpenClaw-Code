---
name: legal-matter-mgmt-retry-governor
description: Use when tasks require legal matter mgmt retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Retry Governor

## Purpose
Design and execute legal matter mgmt workflows using retry governor controls with validated outcomes.
