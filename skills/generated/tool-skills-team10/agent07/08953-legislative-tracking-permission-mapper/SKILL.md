---
name: legislative-tracking-permission-mapper
description: Use when tasks require legislative tracking permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Permission Mapper

## Purpose
Design and execute legislative tracking workflows using permission mapper controls with validated outcomes.
