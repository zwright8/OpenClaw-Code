---
name: legislative-tracking-reliability-scorer
description: Use when tasks require legislative tracking reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Reliability Scorer

## Purpose
Design and execute legislative tracking workflows using reliability scorer controls with validated outcomes.
