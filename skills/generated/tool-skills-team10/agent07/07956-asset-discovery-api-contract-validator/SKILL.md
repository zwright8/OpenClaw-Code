---
name: asset-discovery-api-contract-validator
description: Use when tasks require asset discovery api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery API Contract Validator

## Purpose
Design and execute asset discovery workflows using api contract validator controls with validated outcomes.
...
- Domain: [Asset Discovery](../../resources/domains/asset-discovery.md)
