---
name: vdi-platforms-dependency-resolver
description: Use when tasks require vdi platforms dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Dependency Resolver

## Purpose
Design and execute vdi platforms workflows using dependency resolver controls with validated outcomes.
