...
description: Use when tasks require discovery pipelines artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Artifact Publisher

## Purpose
Design and execute discovery pipelines workflows using artifact publisher controls with validated outcomes.
