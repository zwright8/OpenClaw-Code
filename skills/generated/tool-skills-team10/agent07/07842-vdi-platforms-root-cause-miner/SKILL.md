---
name: vdi-platforms-root-cause-miner
description: Use when tasks require vdi platforms root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Root Cause Miner

## Purpose
Design and execute vdi platforms workflows using root cause miner controls with validated outcomes.
