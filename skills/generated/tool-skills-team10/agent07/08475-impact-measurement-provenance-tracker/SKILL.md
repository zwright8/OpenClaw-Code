---
name: impact-measurement-provenance-tracker
description: Use when tasks require impact measurement provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Provenance Tracker

## Purpose
Design and execute impact measurement workflows using provenance tracker controls with validated outcomes.
