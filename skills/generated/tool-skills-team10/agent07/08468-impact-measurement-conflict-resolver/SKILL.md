---
name: impact-measurement-conflict-resolver
description: Use when tasks require impact measurement conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Conflict Resolver

## Purpose
Design and execute impact measurement workflows using conflict resolver controls with validated outcomes.
