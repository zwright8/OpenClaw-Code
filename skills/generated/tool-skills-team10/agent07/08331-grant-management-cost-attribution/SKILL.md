---
name: grant-management-cost-attribution
description: Use when tasks require grant management cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Cost Attribution

## Purpose
Design and execute grant management workflows using cost attribution controls with validated outcomes.
