---
name: public-health-dashboards-job-scheduler
description: Use when tasks require public health dashboards job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Job Scheduler

## Purpose
Design and execute public health dashboards workflows using job scheduler controls with validated outcomes.
