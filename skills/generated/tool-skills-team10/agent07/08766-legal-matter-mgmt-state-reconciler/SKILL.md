---
name: legal-matter-mgmt-state-reconciler
description: Use when tasks require legal matter mgmt state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt State Reconciler

## Purpose
Design and execute legal matter mgmt workflows using state reconciler controls with validated outcomes.
