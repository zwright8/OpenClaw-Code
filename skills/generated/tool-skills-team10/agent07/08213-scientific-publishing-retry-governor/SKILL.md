---
name: scientific-publishing-retry-governor
description: Use when tasks require scientific publishing retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Retry Governor

## Purpose
Design and execute scientific publishing workflows using retry governor controls with validated outcomes.
