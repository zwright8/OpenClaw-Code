---
name: impact-measurement-auth-broker
description: Use when tasks require impact measurement auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Auth Broker

## Purpose
Design and execute impact measurement workflows using auth broker controls with validated outcomes.
