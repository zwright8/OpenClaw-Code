---
name: vdi-platforms-secret-scanner
description: Use when tasks require vdi platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Secret Scanner

## Purpose
Design and execute vdi platforms workflows using secret scanner controls with validated outcomes.
