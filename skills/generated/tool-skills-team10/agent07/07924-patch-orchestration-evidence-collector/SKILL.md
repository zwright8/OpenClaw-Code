---
name: patch-orchestration-evidence-collector
description: Use when tasks require patch orchestration evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Evidence Collector

## Purpose
Design and execute patch orchestration workflows using evidence collector controls with validated outcomes.
