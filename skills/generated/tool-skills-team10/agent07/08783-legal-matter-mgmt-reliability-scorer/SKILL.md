---
name: legal-matter-mgmt-reliability-scorer
description: Use when tasks require legal matter mgmt reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Reliability Scorer

## Purpose
Design and execute legal matter mgmt workflows using reliability scorer controls with validated outcomes.
