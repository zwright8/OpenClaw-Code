---
name: localization-qa-conflict-resolver
description: Use when tasks require localization qa conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Conflict Resolver

## Purpose
Design and execute localization qa workflows using conflict resolver controls with validated outcomes.
