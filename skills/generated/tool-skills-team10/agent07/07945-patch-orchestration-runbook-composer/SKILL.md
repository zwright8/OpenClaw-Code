---
name: patch-orchestration-runbook-composer
description: Use when tasks require patch orchestration runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Runbook Composer

## Purpose
Design and execute patch orchestration workflows using runbook composer controls with validated outcomes.
