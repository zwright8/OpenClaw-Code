---
name: urban-planning-data-risk-scorer
description: Use when tasks require urban planning data risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Risk Scorer

## Purpose
Design and execute urban planning data workflows using risk scorer controls with validated outcomes.
