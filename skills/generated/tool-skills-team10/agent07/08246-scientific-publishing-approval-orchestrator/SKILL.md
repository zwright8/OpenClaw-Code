---
name: scientific-publishing-approval-orchestrator
description: Use when tasks require scientific publishing approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Approval Orchestrator

## Purpose
Design and execute scientific publishing workflows using approval orchestrator controls with validated outcomes.
