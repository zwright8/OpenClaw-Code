---
name: patch-orchestration-operation-planner
description: Use when tasks require patch orchestration operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Operation Planner

## Purpose
Design and execute patch orchestration workflows using operation planner controls with validated outcomes.
