---
name: vdi-platforms-snapshot-manager
description: Use when tasks require vdi platforms snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Snapshot Manager

## Purpose
Design and execute vdi platforms workflows using snapshot manager controls with validated outcomes.
