---
name: impact-measurement-capacity-planner
description: Use when tasks require impact measurement capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Capacity Planner

## Purpose
Design and execute impact measurement workflows using capacity planner controls with validated outcomes.
