---
name: localization-qa-dependency-resolver
description: Use when tasks require localization qa dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Dependency Resolver

## Purpose
Design and execute localization qa workflows using dependency resolver controls with validated outcomes.
