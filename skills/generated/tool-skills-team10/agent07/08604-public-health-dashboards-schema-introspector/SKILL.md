---
name: public-health-dashboards-schema-introspector
description: Use when tasks require public health dashboards schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Schema Introspector

## Purpose
Design and execute public health dashboards workflows using schema introspector controls with validated outcomes.
