---
name: scientific-publishing-spec-drift-detector
description: Use when tasks require scientific publishing spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Spec Drift Detector

## Purpose
Design and execute scientific publishing workflows using spec drift detector controls with validated outcomes.
