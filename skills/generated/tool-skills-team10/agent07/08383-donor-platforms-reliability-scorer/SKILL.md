---
name: donor-platforms-reliability-scorer
description: Use when tasks require donor platforms reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Reliability Scorer

## Purpose
Design and execute donor platforms workflows using reliability scorer controls with validated outcomes.
