---
name: impact-measurement-rate-limit-optimizer
description: Use when tasks require impact measurement rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Rate Limit Optimizer

## Purpose
Design and execute impact measurement workflows using rate limit optimizer controls with validated outcomes.
