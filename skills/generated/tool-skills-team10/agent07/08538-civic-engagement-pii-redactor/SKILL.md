---
name: civic-engagement-pii-redactor
description: Use when tasks require civic engagement pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement PII Redactor

## Purpose
Design and execute civic engagement workflows using pii redactor controls with validated outcomes.
