---
name: donor-platforms-execution-runner
description: Use when tasks require donor platforms execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Execution Runner

## Purpose
Design and execute donor platforms workflows using execution runner controls with validated outcomes.
