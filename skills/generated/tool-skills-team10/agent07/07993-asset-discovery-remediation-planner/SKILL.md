---
name: asset-discovery-remediation-planner
description: Use when tasks require asset discovery remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Remediation Planner

## Purpose
Design and execute asset discovery workflows using remediation planner controls with validated outcomes.
