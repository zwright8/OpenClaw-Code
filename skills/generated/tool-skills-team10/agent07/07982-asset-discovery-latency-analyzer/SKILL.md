---
name: asset-discovery-latency-analyzer
description: Use when tasks require asset discovery latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Latency Analyzer

## Purpose
Design and execute asset discovery workflows using latency analyzer controls with validated outcomes.
