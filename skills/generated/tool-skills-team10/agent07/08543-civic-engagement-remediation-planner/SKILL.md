---
name: civic-engagement-remediation-planner
description: Use when tasks require civic engagement remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Remediation Planner

## Purpose
Design and execute civic engagement workflows using remediation planner controls with validated outcomes.
