---
name: grant-management-execution-runner
description: Use when tasks require grant management execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Execution Runner

## Purpose
Design and execute grant management workflows using execution runner controls with validated outcomes.
