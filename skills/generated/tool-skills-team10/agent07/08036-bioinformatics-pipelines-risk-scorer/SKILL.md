---
name: bioinformatics-pipelines-risk-scorer
description: Use when tasks require bioinformatics pipelines risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Risk Scorer

## Purpose
Design and execute bioinformatics pipelines workflows using risk scorer controls with validated outcomes.
