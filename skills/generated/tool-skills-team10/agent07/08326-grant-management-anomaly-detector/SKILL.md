---
name: grant-management-anomaly-detector
description: Use when tasks require grant management anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Anomaly Detector

## Purpose
Design and execute grant management workflows using anomaly detector controls with validated outcomes.
