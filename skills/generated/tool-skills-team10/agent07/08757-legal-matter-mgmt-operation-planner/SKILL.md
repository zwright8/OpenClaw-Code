---
name: legal-matter-mgmt-operation-planner
description: Use when tasks require legal matter mgmt operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Operation Planner

## Purpose
Design and execute legal matter mgmt workflows using operation planner controls with validated outcomes.
