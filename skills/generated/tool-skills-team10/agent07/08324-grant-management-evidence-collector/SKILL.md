---
name: grant-management-evidence-collector
description: Use when tasks require grant management evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Evidence Collector

## Purpose
Design and execute grant management workflows using evidence collector controls with validated outcomes.
