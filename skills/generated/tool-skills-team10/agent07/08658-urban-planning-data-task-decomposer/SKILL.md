---
name: urban-planning-data-task-decomposer
description: Use when tasks require urban planning data task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Task Decomposer

## Purpose
Design and execute urban planning data workflows using task decomposer controls with validated outcomes.
