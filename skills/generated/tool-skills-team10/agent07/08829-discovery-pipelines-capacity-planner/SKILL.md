---
name: discovery-pipelines-capacity-planner
description: Use when tasks require discovery pipelines capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Capacity Planner

## Purpose
Design and execute discovery pipelines workflows using capacity planner controls with validated outcomes.
