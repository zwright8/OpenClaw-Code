---
name: lab-robotics-snapshot-manager
description: Use when tasks require lab robotics snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Snapshot Manager

## Purpose
Design and execute lab robotics workflows using snapshot manager controls with validated outcomes.
