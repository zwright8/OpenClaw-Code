---
name: genomics-tooling-human-handoff-router
description: Use when tasks require genomics tooling human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Human Handoff Router

## Purpose
Design and execute genomics tooling workflows using human handoff router controls with validated outcomes.
