---
name: nonprofit-program-ops-risk-scorer
description: Use when tasks require nonprofit program ops risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Risk Scorer

## Purpose
Design and execute nonprofit program ops workflows using risk scorer controls with validated outcomes.
