---
name: case-collaboration-migration-planner
description: Use when tasks require case collaboration migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Migration Planner

## Purpose
Design and execute case collaboration workflows using migration planner controls with validated outcomes.
