---
name: discovery-pipelines-access-auditor
description: Use when tasks require discovery pipelines access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Access Auditor

## Purpose
Design and execute discovery pipelines workflows using access auditor controls with validated outcomes.
