---
name: chemical-informatics-root-cause-miner
description: Use when tasks require chemical informatics root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chemical Informatics Root Cause Miner

## Purpose
Design and execute chemical informatics workflows using root cause miner controls with validated outcomes.
