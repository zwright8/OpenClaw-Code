---
name: remote-access-root-cause-miner
description: Use when tasks require remote access root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Remote Access Root Cause Miner

## Purpose
Design and execute remote access workflows using root cause miner controls with validated outcomes.
