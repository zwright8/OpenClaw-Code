---
name: public-health-dashboards-capacity-planner
description: Use when tasks require public health dashboards capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Capacity Planner

## Purpose
Design and execute public health dashboards workflows using capacity planner controls with validated outcomes.
