---
name: asset-discovery-root-cause-miner
description: Use when tasks require asset discovery root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Root Cause Miner

## Purpose
Design and execute asset discovery workflows using root cause miner controls with validated outcomes.
