---
name: emergency-response-policy-evaluator
description: Use when tasks require emergency response policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Policy Evaluator

## Purpose
Design and execute emergency response workflows using policy evaluator controls with validated outcomes.
