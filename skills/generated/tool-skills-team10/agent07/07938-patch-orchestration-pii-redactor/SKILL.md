---
name: patch-orchestration-pii-redactor
description: Use when tasks require patch orchestration pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration PII Redactor

## Purpose
Design and execute patch orchestration workflows using pii redactor controls with validated outcomes.
