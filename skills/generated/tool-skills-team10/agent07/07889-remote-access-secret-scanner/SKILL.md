---
name: remote-access-secret-scanner
description: Use when tasks require remote access secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Remote Access Secret Scanner

## Purpose
Design and execute remote access workflows using secret scanner controls with validated outcomes.
