...
description: Use when tasks require discovery pipelines conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Conflict Resolver

## Purpose
Design and execute discovery pipelines workflows using conflict resolver controls with validated outcomes.
