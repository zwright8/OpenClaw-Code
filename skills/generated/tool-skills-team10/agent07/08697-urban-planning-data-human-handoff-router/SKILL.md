---
name: urban-planning-data-human-handoff-router
description: Use when tasks require urban planning data human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Human Handoff Router

## Purpose
Design and execute urban planning data workflows using human handoff router controls with validated outcomes.
