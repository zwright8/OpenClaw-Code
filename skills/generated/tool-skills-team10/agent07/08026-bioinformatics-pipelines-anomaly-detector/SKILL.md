---
name: bioinformatics-pipelines-anomaly-detector
description: Use when tasks require bioinformatics pipelines anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Anomaly Detector

## Purpose
Design and execute bioinformatics pipelines workflows using anomaly detector controls with validated outcomes.
