---
name: legal-matter-mgmt-workflow-compiler
description: Use when tasks require legal matter mgmt workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Workflow Compiler

## Purpose
Design and execute legal matter mgmt workflows using workflow compiler controls with validated outcomes.
