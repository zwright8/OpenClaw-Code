---
name: scientific-publishing-budget-guardrail
description: Use when tasks require scientific publishing budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Budget Guardrail

## Purpose
Design and execute scientific publishing workflows using budget guardrail controls with validated outcomes.
