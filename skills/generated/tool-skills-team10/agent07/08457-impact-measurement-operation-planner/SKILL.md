---
name: impact-measurement-operation-planner
description: Use when tasks require impact measurement operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Operation Planner

## Purpose
Design and execute impact measurement workflows using operation planner controls with validated outcomes.
