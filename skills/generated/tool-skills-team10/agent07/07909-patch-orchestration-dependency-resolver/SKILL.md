---
name: patch-orchestration-dependency-resolver
description: Use when tasks require patch orchestration dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Dependency Resolver

## Purpose
Design and execute patch orchestration workflows using dependency resolver controls with validated outcomes.
