---
name: civic-engagement-operation-planner
description: Use when tasks require civic engagement operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Operation Planner

## Purpose
Design and execute civic engagement workflows using operation planner controls with validated outcomes.
