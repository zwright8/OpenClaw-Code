---
name: asset-discovery-human-handoff-router
description: Use when tasks require asset discovery human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Human Handoff Router

## Purpose
Design and execute asset discovery workflows using human handoff router controls with validated outcomes.
