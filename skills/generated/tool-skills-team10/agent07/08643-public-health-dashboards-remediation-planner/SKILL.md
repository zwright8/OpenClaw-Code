---
name: public-health-dashboards-remediation-planner
description: Use when tasks require public health dashboards remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Remediation Planner

## Purpose
Design and execute public health dashboards workflows using remediation planner controls with validated outcomes.
