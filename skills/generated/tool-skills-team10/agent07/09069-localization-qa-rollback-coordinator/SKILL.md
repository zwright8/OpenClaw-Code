---
name: localization-qa-rollback-coordinator
description: Use when tasks require localization qa rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Rollback Coordinator

## Purpose
Design and execute localization qa workflows using rollback coordinator controls with validated outcomes.
