---
name: vdi-platforms-feedback-harvester
description: Use when tasks require vdi platforms feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Feedback Harvester

## Purpose
Design and execute vdi platforms workflows using feedback harvester controls with validated outcomes.
