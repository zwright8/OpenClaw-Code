---
name: bioinformatics-pipelines-quality-gatekeeper
description: Use when tasks require bioinformatics pipelines quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Quality Gatekeeper

## Purpose
Design and execute bioinformatics pipelines workflows using quality gatekeeper controls with validated outcomes.
