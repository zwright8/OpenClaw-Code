---
name: grant-management-capacity-planner
description: Use when tasks require grant management capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Capacity Planner

## Purpose
Design and execute grant management workflows using capacity planner controls with validated outcomes.
