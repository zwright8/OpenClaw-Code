---
name: nonprofit-program-ops-operation-planner
description: Use when tasks require nonprofit program ops operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Operation Planner

## Purpose
Design and execute nonprofit program ops workflows using operation planner controls with validated outcomes.
