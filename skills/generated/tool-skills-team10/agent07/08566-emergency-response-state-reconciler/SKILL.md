---
name: emergency-response-state-reconciler
description: Use when tasks require emergency response state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response State Reconciler

## Purpose
Design and execute emergency response workflows using state reconciler controls with validated outcomes.
