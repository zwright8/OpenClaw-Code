---
name: grant-management-reliability-scorer
description: Use when tasks require grant management reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Reliability Scorer

## Purpose
Design and execute grant management workflows using reliability scorer controls with validated outcomes.
