---
name: civic-engagement-forecast-engine
description: Use when tasks require civic engagement forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Forecast Engine

## Purpose
Design and execute civic engagement workflows using forecast engine controls with validated outcomes.
