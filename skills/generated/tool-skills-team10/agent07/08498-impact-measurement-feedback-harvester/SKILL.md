---
name: impact-measurement-feedback-harvester
description: Use when tasks require impact measurement feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Feedback Harvester

## Purpose
Design and execute impact measurement workflows using feedback harvester controls with validated outcomes.
