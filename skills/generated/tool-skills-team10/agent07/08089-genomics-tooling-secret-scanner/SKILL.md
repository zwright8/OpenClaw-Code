---
name: genomics-tooling-secret-scanner
description: Use when tasks require genomics tooling secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Secret Scanner

## Purpose
Design and execute genomics tooling workflows using secret scanner controls with validated outcomes.
