---
name: grant-management-dependency-resolver
description: Use when tasks require grant management dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Dependency Resolver

## Purpose
Design and execute grant management workflows using dependency resolver controls with validated outcomes.
