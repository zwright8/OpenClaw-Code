---
name: nonprofit-program-ops-permission-mapper
description: Use when tasks require nonprofit program ops permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Permission Mapper

## Purpose
Design and execute nonprofit program ops workflows using permission mapper controls with validated outcomes.
