---
name: genomics-tooling-rollback-coordinator
description: Use when tasks require genomics tooling rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Rollback Coordinator

## Purpose
Design and execute genomics tooling workflows using rollback coordinator controls with validated outcomes.
