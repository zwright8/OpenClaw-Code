---
name: mobility-platforms-auth-broker
description: Use when tasks require mobility platforms auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobility Platforms Auth Broker

## Purpose
Design and execute mobility platforms workflows using auth broker controls with validated outcomes.
