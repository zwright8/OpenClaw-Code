---
name: emergency-response-conflict-resolver
description: Use when tasks require emergency response conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Conflict Resolver

## Purpose
Design and execute emergency response workflows using conflict resolver controls with validated outcomes.
