...
description: Use when tasks require discovery pipelines quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Quality Gatekeeper

## Purpose
Design and execute discovery pipelines workflows using quality gatekeeper controls with validated outcomes.
