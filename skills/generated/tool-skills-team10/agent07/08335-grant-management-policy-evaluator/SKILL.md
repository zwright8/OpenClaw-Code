---
name: grant-management-policy-evaluator
description: Use when tasks require grant management policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Policy Evaluator

## Purpose
Design and execute grant management workflows using policy evaluator controls with validated outcomes.
