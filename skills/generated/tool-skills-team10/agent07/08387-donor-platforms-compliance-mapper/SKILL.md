---
name: donor-platforms-compliance-mapper
description: Use when tasks require donor platforms compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Compliance Mapper

## Purpose
Design and execute donor platforms workflows using compliance mapper controls with validated outcomes.
