---
name: remote-access-evidence-collector
description: Use when tasks require remote access evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Remote Access Evidence Collector

## Purpose
Design and execute remote access workflows using evidence collector controls with validated outcomes.
