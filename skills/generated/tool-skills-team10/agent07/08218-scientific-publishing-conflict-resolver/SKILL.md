---
name: scientific-publishing-conflict-resolver
description: Use when tasks require scientific publishing conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Conflict Resolver

## Purpose
Design and execute scientific publishing workflows using conflict resolver controls with validated outcomes.
