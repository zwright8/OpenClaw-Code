---
name: nonprofit-program-ops-retry-governor
description: Use when tasks require nonprofit program ops retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Retry Governor

## Purpose
Design and execute nonprofit program ops workflows using retry governor controls with validated outcomes.
