---
name: genomics-tooling-access-auditor
description: Use when tasks require genomics tooling access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Access Auditor

## Purpose
Design and execute genomics tooling workflows using access auditor controls with validated outcomes.
