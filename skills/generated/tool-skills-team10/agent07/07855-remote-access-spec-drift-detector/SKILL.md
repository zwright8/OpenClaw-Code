---
name: remote-access-spec-drift-detector
description: Use when tasks require remote access spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Remote Access Spec Drift Detector

## Purpose
Design and execute remote access workflows using spec drift detector controls with validated outcomes.
