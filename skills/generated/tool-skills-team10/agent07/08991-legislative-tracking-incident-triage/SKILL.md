---
name: legislative-tracking-incident-triage
description: Use when tasks require legislative tracking incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Incident Triage

## Purpose
Design and execute legislative tracking workflows using incident triage controls with validated outcomes.
