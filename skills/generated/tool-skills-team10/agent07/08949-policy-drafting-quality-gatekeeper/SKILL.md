---
name: policy-drafting-quality-gatekeeper
description: Use when tasks require policy drafting quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Quality Gatekeeper

## Purpose
Design and execute policy drafting workflows using quality gatekeeper controls with validated outcomes.
