---
name: donor-platforms-rollback-coordinator
description: Use when tasks require donor platforms rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Rollback Coordinator

## Purpose
Design and execute donor platforms workflows using rollback coordinator controls with validated outcomes.
