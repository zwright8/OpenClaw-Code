---
name: localization-qa-risk-scorer
description: Use when tasks require localization qa risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Risk Scorer

## Purpose
Design and execute localization qa workflows using risk scorer controls with validated outcomes.
