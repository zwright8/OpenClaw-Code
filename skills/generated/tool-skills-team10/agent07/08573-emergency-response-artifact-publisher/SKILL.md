---
name: emergency-response-artifact-publisher
description: Use when tasks require emergency response artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Artifact Publisher

## Purpose
Design and execute emergency response workflows using artifact publisher controls with validated outcomes.
