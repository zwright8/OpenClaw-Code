---
name: legal-matter-mgmt-provenance-tracker
description: Use when tasks require legal matter mgmt provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Provenance Tracker

## Purpose
Design and execute legal matter mgmt workflows using provenance tracker controls with validated outcomes.
