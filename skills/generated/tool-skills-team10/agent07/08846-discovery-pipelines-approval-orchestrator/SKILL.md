...
description: Use when tasks require discovery pipelines approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Approval Orchestrator

## Purpose
Design and execute discovery pipelines workflows using approval orchestrator controls with validated outcomes.
