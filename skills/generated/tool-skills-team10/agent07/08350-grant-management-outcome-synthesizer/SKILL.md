---
name: grant-management-outcome-synthesizer
description: Use when tasks require grant management outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Outcome Synthesizer

## Purpose
Design and execute grant management workflows using outcome synthesizer controls with validated outcomes.
