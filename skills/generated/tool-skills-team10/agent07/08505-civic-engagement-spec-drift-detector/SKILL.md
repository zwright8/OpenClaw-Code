---
name: civic-engagement-spec-drift-detector
description: Use when tasks require civic engagement spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Spec Drift Detector

## Purpose
Design and execute civic engagement workflows using spec drift detector controls with validated outcomes.
