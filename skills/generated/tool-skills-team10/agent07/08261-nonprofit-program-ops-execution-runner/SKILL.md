---
name: nonprofit-program-ops-execution-runner
description: Use when tasks require nonprofit program ops execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Execution Runner

## Purpose
Design and execute nonprofit program ops workflows using execution runner controls with validated outcomes.
