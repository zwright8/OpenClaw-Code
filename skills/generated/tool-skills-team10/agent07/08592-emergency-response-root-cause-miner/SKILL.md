---
name: emergency-response-root-cause-miner
description: Use when tasks require emergency response root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Root Cause Miner

## Purpose
Design and execute emergency response workflows using root cause miner controls with validated outcomes.
