---
name: patch-orchestration-retry-governor
description: Use when tasks require patch orchestration retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Retry Governor

## Purpose
Design and execute patch orchestration workflows using retry governor controls with validated outcomes.
