---
name: discovery-pipelines-budget-guardrail
description: Use when tasks require discovery pipelines budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Budget Guardrail

## Purpose
Design and execute discovery pipelines workflows using budget guardrail controls with validated outcomes.
