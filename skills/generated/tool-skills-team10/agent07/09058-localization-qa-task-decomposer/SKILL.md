---
name: localization-qa-task-decomposer
description: Use when tasks require localization qa task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Task Decomposer

## Purpose
Design and execute localization qa workflows using task decomposer controls with validated outcomes.
