---
name: grant-management-compliance-mapper
description: Use when tasks require grant management compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Compliance Mapper

## Purpose
Design and execute grant management workflows using compliance mapper controls with validated outcomes.
