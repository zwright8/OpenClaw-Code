---
name: lab-robotics-policy-evaluator
description: Use when tasks require lab robotics policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Policy Evaluator

## Purpose
Design and execute lab robotics workflows using policy evaluator controls with validated outcomes.
