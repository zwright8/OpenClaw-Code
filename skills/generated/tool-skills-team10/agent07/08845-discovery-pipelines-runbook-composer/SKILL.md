---
name: discovery-pipelines-runbook-composer
description: Use when tasks require discovery pipelines runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Runbook Composer

## Purpose
Design and execute discovery pipelines workflows using runbook composer controls with validated outcomes.
