---
name: grant-management-workflow-compiler
description: Use when tasks require grant management workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Workflow Compiler

## Purpose
Design and execute grant management workflows using workflow compiler controls with validated outcomes.
