---
name: legislative-tracking-budget-guardrail
description: Use when tasks require legislative tracking budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Budget Guardrail

## Purpose
Design and execute legislative tracking workflows using budget guardrail controls with validated outcomes.
