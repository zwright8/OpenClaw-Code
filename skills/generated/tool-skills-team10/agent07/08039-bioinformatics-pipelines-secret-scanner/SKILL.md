---
name: bioinformatics-pipelines-secret-scanner
description: Use when tasks require bioinformatics pipelines secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Secret Scanner

## Purpose
Design and execute bioinformatics pipelines workflows using secret scanner controls with validated outcomes.
