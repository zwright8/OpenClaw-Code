---
name: case-collaboration-compliance-mapper
description: Use when tasks require case collaboration compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Compliance Mapper

## Purpose
Design and execute case collaboration workflows using compliance mapper controls with validated outcomes.
