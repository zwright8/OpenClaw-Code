---
name: public-health-dashboards-spec-drift-detector
description: Use when tasks require public health dashboards spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Spec Drift Detector

## Purpose
Design and execute public health dashboards workflows using spec drift detector controls with validated outcomes.
