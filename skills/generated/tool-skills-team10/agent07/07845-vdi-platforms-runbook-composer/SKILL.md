...
description: Use when tasks require vdi platforms runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Runbook Composer

## Purpose
Design and execute vdi platforms workflows using runbook composer controls with validated outcomes.
