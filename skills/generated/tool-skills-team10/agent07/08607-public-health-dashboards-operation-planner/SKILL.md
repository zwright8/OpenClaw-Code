---
name: public-health-dashboards-operation-planner
description: Use when tasks require public health dashboards operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Operation Planner

## Purpose
Design and execute public health dashboards workflows using operation planner controls with validated outcomes.
