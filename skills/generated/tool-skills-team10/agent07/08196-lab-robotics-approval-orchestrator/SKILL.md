---
name: lab-robotics-approval-orchestrator
description: Use when tasks require lab robotics approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Approval Orchestrator

## Purpose
Design and execute lab robotics workflows using approval orchestrator controls with validated outcomes.
