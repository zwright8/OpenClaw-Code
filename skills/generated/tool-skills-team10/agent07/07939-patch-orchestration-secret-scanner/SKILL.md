---
name: patch-orchestration-secret-scanner
description: Use when tasks require patch orchestration secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Secret Scanner

## Purpose
Design and execute patch orchestration workflows using secret scanner controls with validated outcomes.
