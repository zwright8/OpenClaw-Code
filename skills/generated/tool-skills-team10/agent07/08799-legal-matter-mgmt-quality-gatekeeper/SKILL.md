---
name: legal-matter-mgmt-quality-gatekeeper
description: Use when tasks require legal matter mgmt quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Quality Gatekeeper

## Purpose
Design and execute legal matter mgmt workflows using quality gatekeeper controls with validated outcomes.
