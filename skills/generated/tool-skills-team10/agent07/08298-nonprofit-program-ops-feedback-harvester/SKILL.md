---
name: nonprofit-program-ops-feedback-harvester
description: Use when tasks require nonprofit program ops feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Feedback Harvester

## Purpose
Design and execute nonprofit program ops workflows using feedback harvester controls with validated outcomes.
