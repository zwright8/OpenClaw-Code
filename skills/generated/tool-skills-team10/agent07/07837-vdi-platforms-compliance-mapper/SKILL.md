---
name: vdi-platforms-compliance-mapper
description: Use when tasks require vdi platforms compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Compliance Mapper

## Purpose
Design and execute vdi platforms workflows using compliance mapper controls with validated outcomes.
