---
name: donor-platforms-approval-orchestrator
description: Use when tasks require donor platforms approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Approval Orchestrator

## Purpose
Design and execute donor platforms workflows using approval orchestrator controls with validated outcomes.
