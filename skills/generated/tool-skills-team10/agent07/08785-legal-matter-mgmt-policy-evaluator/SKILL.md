---
name: legal-matter-mgmt-policy-evaluator
description: Use when tasks require legal matter mgmt policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Policy Evaluator

## Purpose
Design and execute legal matter mgmt workflows using policy evaluator controls with validated outcomes.
