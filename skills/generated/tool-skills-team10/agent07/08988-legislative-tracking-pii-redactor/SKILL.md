---
name: legislative-tracking-pii-redactor
description: Use when tasks require legislative tracking pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking PII Redactor

## Purpose
Design and execute legislative tracking workflows using pii redactor controls with validated outcomes.
