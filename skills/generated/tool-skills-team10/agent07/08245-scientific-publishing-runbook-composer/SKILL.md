---
name: scientific-publishing-runbook-composer
description: Use when tasks require scientific publishing runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Runbook Composer

## Purpose
Design and execute scientific publishing workflows using runbook composer controls with validated outcomes.
