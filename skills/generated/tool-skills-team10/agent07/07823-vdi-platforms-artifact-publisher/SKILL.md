---
name: vdi-platforms-artifact-publisher
description: Use when tasks require vdi platforms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Artifact Publisher

## Purpose
Design and execute vdi platforms workflows using artifact publisher controls with validated outcomes.
