---
name: donor-platforms-migration-planner
description: Use when tasks require donor platforms migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Migration Planner

## Purpose
Design and execute donor platforms workflows using migration planner controls with validated outcomes.
