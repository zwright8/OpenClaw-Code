---
name: nonprofit-program-ops-reliability-scorer
description: Use when tasks require nonprofit program ops reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Reliability Scorer

## Purpose
Design and execute nonprofit program ops workflows using reliability scorer controls with validated outcomes.
