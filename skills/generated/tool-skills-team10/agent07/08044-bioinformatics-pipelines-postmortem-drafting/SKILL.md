---
name: bioinformatics-pipelines-postmortem-drafting
description: Use when tasks require bioinformatics pipelines postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Postmortem Drafting

## Purpose
Design and execute bioinformatics pipelines workflows using postmortem drafting controls with validated outcomes.
