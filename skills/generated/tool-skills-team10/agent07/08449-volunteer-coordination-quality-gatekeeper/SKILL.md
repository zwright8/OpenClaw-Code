---
name: volunteer-coordination-quality-gatekeeper
description: Use when tasks require volunteer coordination quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Quality Gatekeeper

## Purpose
Design and execute volunteer coordination workflows using quality gatekeeper controls with validated outcomes.
