---
name: legislative-tracking-rate-limit-optimizer
description: Use when tasks require legislative tracking rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Rate Limit Optimizer

## Purpose
Design and execute legislative tracking workflows using rate limit optimizer controls with validated outcomes.
