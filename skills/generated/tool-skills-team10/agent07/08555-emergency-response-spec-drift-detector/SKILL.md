---
name: emergency-response-spec-drift-detector
description: Use when tasks require emergency response spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Spec Drift Detector

## Purpose
Design and execute emergency response workflows using spec drift detector controls with validated outcomes.
