---
name: volunteer-coordination-access-auditor
description: Use when tasks require volunteer coordination access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Access Auditor

## Purpose
Design and execute volunteer coordination workflows using access auditor controls with validated outcomes.
