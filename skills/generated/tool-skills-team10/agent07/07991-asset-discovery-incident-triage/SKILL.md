---
name: asset-discovery-incident-triage
description: Use when tasks require asset discovery incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Incident Triage

## Purpose
Design and execute asset discovery workflows using incident triage controls with validated outcomes.
