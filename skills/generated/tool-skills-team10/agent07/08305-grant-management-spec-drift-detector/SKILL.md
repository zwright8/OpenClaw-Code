---
name: grant-management-spec-drift-detector
description: Use when tasks require grant management spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Spec Drift Detector

## Purpose
Design and execute grant management workflows using spec drift detector controls with validated outcomes.
