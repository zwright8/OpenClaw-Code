---
name: public-health-dashboards-forecast-engine
description: Use when tasks require public health dashboards forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Forecast Engine

## Purpose
Design and execute public health dashboards workflows using forecast engine controls with validated outcomes.
