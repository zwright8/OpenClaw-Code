---
name: impact-measurement-anomaly-detector
description: Use when tasks require impact measurement anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Anomaly Detector

## Purpose
Design and execute impact measurement workflows using anomaly detector controls with validated outcomes.
