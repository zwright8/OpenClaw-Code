---
name: asset-discovery-artifact-publisher
description: Use when tasks require asset discovery artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Artifact Publisher

## Purpose
Design and execute asset discovery workflows using artifact publisher controls with validated outcomes.
