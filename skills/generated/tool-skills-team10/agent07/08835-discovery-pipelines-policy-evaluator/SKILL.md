---
name: discovery-pipelines-policy-evaluator
description: Use when tasks require discovery pipelines policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Policy Evaluator

## Purpose
Design and execute discovery pipelines workflows using policy evaluator controls with validated outcomes.
