---
name: emergency-response-operation-planner
description: Use when tasks require emergency response operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Operation Planner

## Purpose
Design and execute emergency response workflows using operation planner controls with validated outcomes.
