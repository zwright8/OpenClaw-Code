---
name: donor-platforms-auth-broker
description: Use when tasks require donor platforms auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Auth Broker

## Purpose
Design and execute donor platforms workflows using auth broker controls with validated outcomes.
