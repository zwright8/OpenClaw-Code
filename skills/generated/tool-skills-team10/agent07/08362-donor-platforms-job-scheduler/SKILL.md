---
name: donor-platforms-job-scheduler
description: Use when tasks require donor platforms job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Job Scheduler

## Purpose
Design and execute donor platforms workflows using job scheduler controls with validated outcomes.
