---
name: nonprofit-program-ops-forecast-engine
description: Use when tasks require nonprofit program ops forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Forecast Engine

## Purpose
Design and execute nonprofit program ops workflows using forecast engine controls with validated outcomes.
