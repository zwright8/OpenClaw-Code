---
name: vdi-platforms-provenance-tracker
description: Use when tasks require vdi platforms provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Provenance Tracker

## Purpose
Design and execute vdi platforms workflows using provenance tracker controls with validated outcomes.
