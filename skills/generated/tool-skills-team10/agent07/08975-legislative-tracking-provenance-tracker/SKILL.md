---
name: legislative-tracking-provenance-tracker
description: Use when tasks require legislative tracking provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Provenance Tracker

## Purpose
Design and execute legislative tracking workflows using provenance tracker controls with validated outcomes.
