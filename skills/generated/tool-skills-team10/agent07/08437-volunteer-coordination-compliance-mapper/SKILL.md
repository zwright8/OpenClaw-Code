---
name: volunteer-coordination-compliance-mapper
description: Use when tasks require volunteer coordination compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Compliance Mapper

## Purpose
Design and execute volunteer coordination workflows using compliance mapper controls with validated outcomes.
