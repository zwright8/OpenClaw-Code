---
name: scientific-publishing-migration-planner
description: Use when tasks require scientific publishing migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Migration Planner

## Purpose
Design and execute scientific publishing workflows using migration planner controls with validated outcomes.
