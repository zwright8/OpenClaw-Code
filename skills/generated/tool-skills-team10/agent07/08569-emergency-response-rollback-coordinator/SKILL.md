---
name: emergency-response-rollback-coordinator
description: Use when tasks require emergency response rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Rollback Coordinator

## Purpose
Design and execute emergency response workflows using rollback coordinator controls with validated outcomes.
