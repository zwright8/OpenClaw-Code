---
name: chemical-informatics-auth-broker
description: Use when tasks require chemical informatics auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chemical Informatics Auth Broker

## Purpose
Design and execute chemical informatics workflows using auth broker controls with validated outcomes.
