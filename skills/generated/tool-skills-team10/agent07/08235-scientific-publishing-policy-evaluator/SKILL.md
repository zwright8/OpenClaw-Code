---
name: scientific-publishing-policy-evaluator
description: Use when tasks require scientific publishing policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Policy Evaluator

## Purpose
Design and execute scientific publishing workflows using policy evaluator controls with validated outcomes.
