---
name: emergency-response-execution-runner
description: Use when tasks require emergency response execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Execution Runner

## Purpose
Design and execute emergency response workflows using execution runner controls with validated outcomes.
