---
name: scientific-publishing-quality-gatekeeper
description: Use when tasks require scientific publishing quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Quality Gatekeeper

## Purpose
Design and execute scientific publishing workflows using quality gatekeeper controls with validated outcomes.
