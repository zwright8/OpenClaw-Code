---
name: urban-planning-data-quality-gatekeeper
description: Use when tasks require urban planning data quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Quality Gatekeeper

## Purpose
Design and execute urban planning data workflows using quality gatekeeper controls with validated outcomes.
