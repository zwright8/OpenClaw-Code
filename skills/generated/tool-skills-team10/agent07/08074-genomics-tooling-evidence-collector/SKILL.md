---
name: genomics-tooling-evidence-collector
description: Use when tasks require genomics tooling evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Evidence Collector

## Purpose
Design and execute genomics tooling workflows using evidence collector controls with validated outcomes.
