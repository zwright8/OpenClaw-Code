---
name: public-health-dashboards-provenance-tracker
description: Use when tasks require public health dashboards provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Provenance Tracker

## Purpose
Design and execute public health dashboards workflows using provenance tracker controls with validated outcomes.
