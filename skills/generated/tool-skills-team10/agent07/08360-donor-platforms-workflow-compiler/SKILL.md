---
name: donor-platforms-workflow-compiler
description: Use when tasks require donor platforms workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Workflow Compiler

## Purpose
Design and execute donor platforms workflows using workflow compiler controls with validated outcomes.
