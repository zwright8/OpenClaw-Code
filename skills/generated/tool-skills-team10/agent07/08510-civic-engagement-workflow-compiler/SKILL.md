---
name: civic-engagement-workflow-compiler
description: Use when tasks require civic engagement workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Workflow Compiler

## Purpose
Design and execute civic engagement workflows using workflow compiler controls with validated outcomes.
