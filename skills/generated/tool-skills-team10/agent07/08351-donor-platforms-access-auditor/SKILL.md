---
name: donor-platforms-access-auditor
description: Use when tasks require donor platforms access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Access Auditor

## Purpose
Design and execute donor platforms workflows using access auditor controls with validated outcomes.
