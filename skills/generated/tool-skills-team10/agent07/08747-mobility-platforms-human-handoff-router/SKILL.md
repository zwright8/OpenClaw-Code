---
name: mobility-platforms-human-handoff-router
description: Use when tasks require mobility platforms human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobility Platforms Human Handoff Router

## Purpose
Design and execute mobility platforms workflows using human handoff router controls with validated outcomes.
