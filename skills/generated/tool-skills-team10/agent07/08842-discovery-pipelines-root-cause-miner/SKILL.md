---
name: discovery-pipelines-root-cause-miner
description: Use when tasks require discovery pipelines root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Root Cause Miner

## Purpose
Design and execute discovery pipelines workflows using root cause miner controls with validated outcomes.
