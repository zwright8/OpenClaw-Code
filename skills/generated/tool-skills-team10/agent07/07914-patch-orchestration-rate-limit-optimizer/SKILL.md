---
name: patch-orchestration-rate-limit-optimizer
description: Use when tasks require patch orchestration rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Rate Limit Optimizer

## Purpose
Design and execute patch orchestration workflows using rate limit optimizer controls with validated outcomes.
