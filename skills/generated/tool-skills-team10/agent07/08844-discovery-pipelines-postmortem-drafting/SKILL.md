---
name: discovery-pipelines-postmortem-drafting
description: Use when tasks require discovery pipelines postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Postmortem Drafting

## Purpose
Design and execute discovery pipelines workflows using postmortem drafting controls with validated outcomes.
