---
name: translation-pipelines-migration-planner
description: Use when tasks require translation pipelines migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Translation Pipelines Migration Planner

## Purpose
Design and execute translation pipelines workflows using migration planner controls with validated outcomes.
