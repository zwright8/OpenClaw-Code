---
name: localization-qa-remediation-planner
description: Use when tasks require localization qa remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Remediation Planner

## Purpose
Design and execute localization qa workflows using remediation planner controls with validated outcomes.
