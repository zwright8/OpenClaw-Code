---
name: civic-engagement-rollback-coordinator
description: Use when tasks require civic engagement rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Rollback Coordinator

## Purpose
Design and execute civic engagement workflows using rollback coordinator controls with validated outcomes.
