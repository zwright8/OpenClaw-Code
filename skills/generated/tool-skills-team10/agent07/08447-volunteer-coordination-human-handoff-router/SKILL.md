---
name: volunteer-coordination-human-handoff-router
description: Use when tasks require volunteer coordination human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Human Handoff Router

## Purpose
Design and execute volunteer coordination workflows using human handoff router controls with validated outcomes.
