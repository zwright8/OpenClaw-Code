---
name: scientific-publishing-postmortem-drafting
description: Use when tasks require scientific publishing postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Postmortem Drafting

## Purpose
Design and execute scientific publishing workflows using postmortem drafting controls with validated outcomes.
