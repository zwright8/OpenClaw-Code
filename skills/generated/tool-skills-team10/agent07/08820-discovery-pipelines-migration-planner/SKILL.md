---
name: discovery-pipelines-migration-planner
description: Use when tasks require discovery pipelines migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Migration Planner

## Purpose
Design and execute discovery pipelines workflows using migration planner controls with validated outcomes.
