---
name: patch-orchestration-migration-planner
description: Use when tasks require patch orchestration migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Migration Planner

## Purpose
Design and execute patch orchestration workflows using migration planner controls with validated outcomes.
