---
name: legal-matter-mgmt-remediation-planner
description: Use when tasks require legal matter mgmt remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Remediation Planner

## Purpose
Design and execute legal matter mgmt workflows using remediation planner controls with validated outcomes.
