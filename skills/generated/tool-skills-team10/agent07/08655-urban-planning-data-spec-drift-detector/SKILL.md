---
name: urban-planning-data-spec-drift-detector
description: Use when tasks require urban planning data spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Spec Drift Detector

## Purpose
Design and execute urban planning data workflows using spec drift detector controls with validated outcomes.
