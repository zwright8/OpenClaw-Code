---
name: volunteer-coordination-auth-broker
description: Use when tasks require volunteer coordination auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Auth Broker

## Purpose
Design and execute volunteer coordination workflows using auth broker controls with validated outcomes.
