---
name: case-collaboration-evidence-collector
description: Use when tasks require case collaboration evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Evidence Collector

## Purpose
Design and execute case collaboration workflows using evidence collector controls with validated outcomes.
