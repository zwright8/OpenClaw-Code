---
name: donor-platforms-quality-gatekeeper
description: Use when tasks require donor platforms quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Quality Gatekeeper

## Purpose
Design and execute donor platforms workflows using quality gatekeeper controls with validated outcomes.
