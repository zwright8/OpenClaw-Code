---
name: grant-management-secret-scanner
description: Use when tasks require grant management secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Secret Scanner

## Purpose
Design and execute grant management workflows using secret scanner controls with validated outcomes.
