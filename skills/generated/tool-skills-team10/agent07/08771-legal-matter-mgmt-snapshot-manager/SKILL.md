---
name: legal-matter-mgmt-snapshot-manager
description: Use when tasks require legal matter mgmt snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Snapshot Manager

## Purpose
Design and execute legal matter mgmt workflows using snapshot manager controls with validated outcomes.
