---
name: legislative-tracking-dependency-resolver
description: Use when tasks require legislative tracking dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Dependency Resolver

## Purpose
Design and execute legislative tracking workflows using dependency resolver controls with validated outcomes.
