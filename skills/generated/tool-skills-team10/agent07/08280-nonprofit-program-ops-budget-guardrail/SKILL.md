---
name: nonprofit-program-ops-budget-guardrail
description: Use when tasks require nonprofit program ops budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Budget Guardrail

## Purpose
Design and execute nonprofit program ops workflows using budget guardrail controls with validated outcomes.
