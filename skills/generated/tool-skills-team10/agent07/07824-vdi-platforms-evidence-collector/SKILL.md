---
name: vdi-platforms-evidence-collector
description: Use when tasks require vdi platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Evidence Collector

## Purpose
Design and execute vdi platforms workflows using evidence collector controls with validated outcomes.
