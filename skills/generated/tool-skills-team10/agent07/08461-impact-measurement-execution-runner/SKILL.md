---
name: impact-measurement-execution-runner
description: Use when tasks require impact measurement execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Execution Runner

## Purpose
Design and execute impact measurement workflows using execution runner controls with validated outcomes.
