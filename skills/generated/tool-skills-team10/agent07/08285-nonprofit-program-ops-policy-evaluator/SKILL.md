---
name: nonprofit-program-ops-policy-evaluator
description: Use when tasks require nonprofit program ops policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Policy Evaluator

## Purpose
Design and execute nonprofit program ops workflows using policy evaluator controls with validated outcomes.
