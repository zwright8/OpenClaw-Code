---
name: case-collaboration-cost-attribution
description: Use when tasks require case collaboration cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Cost Attribution

## Purpose
Design and execute case collaboration workflows using cost attribution controls with validated outcomes.
