---
name: nonprofit-program-ops-runbook-composer
description: Use when tasks require nonprofit program ops runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Runbook Composer

## Purpose
Design and execute nonprofit program ops workflows using runbook composer controls with validated outcomes.
