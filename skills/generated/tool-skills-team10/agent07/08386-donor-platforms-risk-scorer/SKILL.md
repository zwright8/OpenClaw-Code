---
name: donor-platforms-risk-scorer
description: Use when tasks require donor platforms risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Risk Scorer

## Purpose
Design and execute donor platforms workflows using risk scorer controls with validated outcomes.
