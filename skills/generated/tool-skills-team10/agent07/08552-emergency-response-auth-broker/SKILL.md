---
name: emergency-response-auth-broker
description: Use when tasks require emergency response auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Auth Broker

## Purpose
Design and execute emergency response workflows using auth broker controls with validated outcomes.
