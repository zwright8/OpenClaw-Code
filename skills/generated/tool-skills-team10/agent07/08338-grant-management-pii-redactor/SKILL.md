---
name: grant-management-pii-redactor
description: Use when tasks require grant management pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management PII Redactor

## Purpose
Design and execute grant management workflows using pii redactor controls with validated outcomes.
