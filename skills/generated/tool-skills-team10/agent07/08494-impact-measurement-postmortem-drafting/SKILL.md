---
name: impact-measurement-postmortem-drafting
description: Use when tasks require impact measurement postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Postmortem Drafting

## Purpose
Design and execute impact measurement workflows using postmortem drafting controls with validated outcomes.
