---
name: impact-measurement-runbook-composer
description: Use when tasks require impact measurement runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Runbook Composer

## Purpose
Design and execute impact measurement workflows using runbook composer controls with validated outcomes.
