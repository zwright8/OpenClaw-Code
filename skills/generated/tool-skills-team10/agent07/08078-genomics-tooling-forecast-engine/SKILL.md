---
name: genomics-tooling-forecast-engine
description: Use when tasks require genomics tooling forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Forecast Engine

## Purpose
Design and execute genomics tooling workflows using forecast engine controls with validated outcomes.
