---
name: patch-orchestration-outcome-synthesizer
description: Use when tasks require patch orchestration outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Outcome Synthesizer

## Purpose
Design and execute patch orchestration workflows using outcome synthesizer controls with validated outcomes.
