---
name: impact-measurement-policy-evaluator
description: Use when tasks require impact measurement policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Policy Evaluator

## Purpose
Design and execute impact measurement workflows using policy evaluator controls with validated outcomes.
