---
name: grant-management-sla-enforcer
description: Use when tasks require grant management sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management SLA Enforcer

## Purpose
Design and execute grant management workflows using sla enforcer controls with validated outcomes.
