---
name: legislative-tracking-task-decomposer
description: Use when tasks require legislative tracking task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Task Decomposer

## Purpose
Design and execute legislative tracking workflows using task decomposer controls with validated outcomes.
