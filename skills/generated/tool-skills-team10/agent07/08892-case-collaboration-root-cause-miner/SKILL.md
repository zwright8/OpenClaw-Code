---
name: case-collaboration-root-cause-miner
description: Use when tasks require case collaboration root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Root Cause Miner

## Purpose
Design and execute case collaboration workflows using root cause miner controls with validated outcomes.
