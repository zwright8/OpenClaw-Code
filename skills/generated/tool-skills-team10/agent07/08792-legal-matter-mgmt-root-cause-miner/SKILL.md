---
name: legal-matter-mgmt-root-cause-miner
description: Use when tasks require legal matter mgmt root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Root Cause Miner

## Purpose
Design and execute legal matter mgmt workflows using root cause miner controls with validated outcomes.
