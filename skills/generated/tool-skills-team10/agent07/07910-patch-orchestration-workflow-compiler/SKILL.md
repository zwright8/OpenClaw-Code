---
name: patch-orchestration-workflow-compiler
description: Use when tasks require patch orchestration workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Workflow Compiler

## Purpose
Design and execute patch orchestration workflows using workflow compiler controls with validated outcomes.
