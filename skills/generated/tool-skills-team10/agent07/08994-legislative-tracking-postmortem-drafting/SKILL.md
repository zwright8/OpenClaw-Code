---
name: legislative-tracking-postmortem-drafting
description: Use when tasks require legislative tracking postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Postmortem Drafting

## Purpose
Design and execute legislative tracking workflows using postmortem drafting controls with validated outcomes.
