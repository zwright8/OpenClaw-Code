---
name: bioinformatics-pipelines-capacity-planner
description: Use when tasks require bioinformatics pipelines capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Capacity Planner

## Purpose
Design and execute bioinformatics pipelines workflows using capacity planner controls with validated outcomes.
