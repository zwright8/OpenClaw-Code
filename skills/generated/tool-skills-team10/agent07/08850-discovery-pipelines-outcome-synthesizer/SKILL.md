...
description: Use when tasks require discovery pipelines outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Outcome Synthesizer

## Purpose
Design and execute discovery pipelines workflows using outcome synthesizer controls with validated outcomes.
