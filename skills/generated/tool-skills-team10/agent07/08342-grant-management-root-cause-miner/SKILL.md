---
name: grant-management-root-cause-miner
description: Use when tasks require grant management root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Root Cause Miner

## Purpose
Design and execute grant management workflows using root cause miner controls with validated outcomes.
