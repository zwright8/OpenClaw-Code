---
name: nonprofit-program-ops-outcome-synthesizer
description: Use when tasks require nonprofit program ops outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Outcome Synthesizer

## Purpose
Design and execute nonprofit program ops workflows using outcome synthesizer controls with validated outcomes.
