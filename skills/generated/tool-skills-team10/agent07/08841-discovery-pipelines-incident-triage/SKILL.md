---
name: discovery-pipelines-incident-triage
description: Use when tasks require discovery pipelines incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Incident Triage

## Purpose
Design and execute discovery pipelines workflows using incident triage controls with validated outcomes.
