---
name: lab-robotics-risk-scorer
description: Use when tasks require lab robotics risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Risk Scorer

## Purpose
Design and execute lab robotics workflows using risk scorer controls with validated outcomes.
