---
name: mobility-platforms-task-decomposer
description: Use when tasks require mobility platforms task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobility Platforms Task Decomposer

## Purpose
Design and execute mobility platforms workflows using task decomposer controls with validated outcomes.
