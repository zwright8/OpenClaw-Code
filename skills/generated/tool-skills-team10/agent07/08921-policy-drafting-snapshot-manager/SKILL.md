---
name: policy-drafting-snapshot-manager
description: Use when tasks require policy drafting snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Snapshot Manager

## Purpose
Design and execute policy drafting workflows using snapshot manager controls with validated outcomes.
