---
name: case-collaboration-anomaly-detector
description: Use when tasks require case collaboration anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Anomaly Detector

## Purpose
Design and execute case collaboration workflows using anomaly detector controls with validated outcomes.
