---
name: impact-measurement-latency-analyzer
description: Use when tasks require impact measurement latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Latency Analyzer

## Purpose
Design and execute impact measurement workflows using latency analyzer controls with validated outcomes.
