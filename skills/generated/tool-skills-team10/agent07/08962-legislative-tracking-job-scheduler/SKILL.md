---
name: legislative-tracking-job-scheduler
description: Use when tasks require legislative tracking job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Job Scheduler

## Purpose
Design and execute legislative tracking workflows using job scheduler controls with validated outcomes.
