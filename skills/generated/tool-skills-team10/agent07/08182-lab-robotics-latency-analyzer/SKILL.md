---
name: lab-robotics-latency-analyzer
description: Use when tasks require lab robotics latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Latency Analyzer

## Purpose
Design and execute lab robotics workflows using latency analyzer controls with validated outcomes.
