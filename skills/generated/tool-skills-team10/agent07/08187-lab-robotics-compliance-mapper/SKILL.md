---
name: lab-robotics-compliance-mapper
description: Use when tasks require lab robotics compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Compliance Mapper

## Purpose
Design and execute lab robotics workflows using compliance mapper controls with validated outcomes.
