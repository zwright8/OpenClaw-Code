---
name: vdi-platforms-reliability-scorer
description: Use when tasks require vdi platforms reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Reliability Scorer

## Purpose
Design and execute vdi platforms workflows using reliability scorer controls with validated outcomes.
