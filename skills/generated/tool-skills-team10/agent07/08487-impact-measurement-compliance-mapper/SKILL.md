---
name: impact-measurement-compliance-mapper
description: Use when tasks require impact measurement compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Compliance Mapper

## Purpose
Design and execute impact measurement workflows using compliance mapper controls with validated outcomes.
