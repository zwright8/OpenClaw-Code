---
name: asset-discovery-cost-attribution
description: Use when tasks require asset discovery cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Cost Attribution

## Purpose
Design and execute asset discovery workflows using cost attribution controls with validated outcomes.
