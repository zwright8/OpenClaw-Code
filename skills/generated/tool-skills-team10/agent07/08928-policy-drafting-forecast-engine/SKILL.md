---
name: policy-drafting-forecast-engine
description: Use when tasks require policy drafting forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Forecast Engine

## Purpose
Design and execute policy drafting workflows using forecast engine controls with validated outcomes.
