---
name: public-health-dashboards-anomaly-detector
description: Use when tasks require public health dashboards anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Anomaly Detector

## Purpose
Design and execute public health dashboards workflows using anomaly detector controls with validated outcomes.
