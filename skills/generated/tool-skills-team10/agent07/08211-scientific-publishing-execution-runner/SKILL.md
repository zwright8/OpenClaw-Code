---
name: scientific-publishing-execution-runner
description: Use when tasks require scientific publishing execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Execution Runner

## Purpose
Design and execute scientific publishing workflows using execution runner controls with validated outcomes.
