---
name: scientific-publishing-risk-scorer
description: Use when tasks require scientific publishing risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Risk Scorer

## Purpose
Design and execute scientific publishing workflows using risk scorer controls with validated outcomes.
