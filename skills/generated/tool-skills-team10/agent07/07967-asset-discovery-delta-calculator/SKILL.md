---
name: asset-discovery-delta-calculator
description: Use when tasks require asset discovery delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Delta Calculator

## Purpose
Design and execute asset discovery workflows using delta calculator controls with validated outcomes.
