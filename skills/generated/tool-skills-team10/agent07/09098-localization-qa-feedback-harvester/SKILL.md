---
name: localization-qa-feedback-harvester
description: Use when tasks require localization qa feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Feedback Harvester

## Purpose
Design and execute localization qa workflows using feedback harvester controls with validated outcomes.
