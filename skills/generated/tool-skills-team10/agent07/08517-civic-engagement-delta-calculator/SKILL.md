---
name: civic-engagement-delta-calculator
description: Use when tasks require civic engagement delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Delta Calculator

## Purpose
Design and execute civic engagement workflows using delta calculator controls with validated outcomes.
