---
name: asset-discovery-capacity-planner
description: Use when tasks require asset discovery capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Capacity Planner

## Purpose
Design and execute asset discovery workflows using capacity planner controls with validated outcomes.
