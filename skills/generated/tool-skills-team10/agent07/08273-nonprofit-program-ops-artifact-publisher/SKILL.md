---
name: nonprofit-program-ops-artifact-publisher
description: Use when tasks require nonprofit program ops artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Artifact Publisher

## Purpose
Design and execute nonprofit program ops workflows using artifact publisher controls with validated outcomes.
