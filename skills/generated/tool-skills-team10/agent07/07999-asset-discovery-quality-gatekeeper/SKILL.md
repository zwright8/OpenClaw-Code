---
name: asset-discovery-quality-gatekeeper
description: Use when tasks require asset discovery quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Quality Gatekeeper

## Purpose
Design and execute asset discovery workflows using quality gatekeeper controls with validated outcomes.
