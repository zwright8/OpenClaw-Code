---
name: vdi-platforms-quality-gatekeeper
description: Use when tasks require vdi platforms quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Quality Gatekeeper

## Purpose
Design and execute vdi platforms workflows using quality gatekeeper controls with validated outcomes.
