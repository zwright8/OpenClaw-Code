---
name: urban-planning-data-permission-mapper
description: Use when tasks require urban planning data permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Permission Mapper

## Purpose
Design and execute urban planning data workflows using permission mapper controls with validated outcomes.
