---
name: asset-discovery-feedback-harvester
description: Use when tasks require asset discovery feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Feedback Harvester

## Purpose
Design and execute asset discovery workflows using feedback harvester controls with validated outcomes.
