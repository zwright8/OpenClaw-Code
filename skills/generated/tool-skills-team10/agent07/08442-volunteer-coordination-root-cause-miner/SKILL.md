---
name: volunteer-coordination-root-cause-miner
description: Use when tasks require volunteer coordination root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Root Cause Miner

## Purpose
Design and execute volunteer coordination workflows using root cause miner controls with validated outcomes.
