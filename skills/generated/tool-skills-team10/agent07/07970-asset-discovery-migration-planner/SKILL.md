---
name: asset-discovery-migration-planner
description: Use when tasks require asset discovery migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Migration Planner

## Purpose
Design and execute asset discovery workflows using migration planner controls with validated outcomes.
