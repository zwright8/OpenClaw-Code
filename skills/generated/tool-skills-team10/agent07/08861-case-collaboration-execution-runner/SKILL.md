---
name: case-collaboration-execution-runner
description: Use when tasks require case collaboration execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Execution Runner

## Purpose
Design and execute case collaboration workflows using execution runner controls with validated outcomes.
