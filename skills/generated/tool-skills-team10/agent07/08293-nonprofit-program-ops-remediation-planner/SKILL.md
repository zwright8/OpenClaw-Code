---
name: nonprofit-program-ops-remediation-planner
description: Use when tasks require nonprofit program ops remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Remediation Planner

## Purpose
Design and execute nonprofit program ops workflows using remediation planner controls with validated outcomes.
