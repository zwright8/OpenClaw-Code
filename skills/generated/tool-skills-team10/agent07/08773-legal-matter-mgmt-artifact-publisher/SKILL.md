---
name: legal-matter-mgmt-artifact-publisher
description: Use when tasks require legal matter mgmt artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Artifact Publisher

## Purpose
Design and execute legal matter mgmt workflows using artifact publisher controls with validated outcomes.
