---
name: case-collaboration-artifact-publisher
description: Use when tasks require case collaboration artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Artifact Publisher

## Purpose
Design and execute case collaboration workflows using artifact publisher controls with validated outcomes.
