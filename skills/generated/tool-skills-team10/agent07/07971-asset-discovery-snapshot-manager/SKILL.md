---
name: asset-discovery-snapshot-manager
description: Use when tasks require asset discovery snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Snapshot Manager

## Purpose
Design and execute asset discovery workflows using snapshot manager controls with validated outcomes.
