...
description: Use when tasks require discovery pipelines evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Evidence Collector

## Purpose
Design and execute discovery pipelines workflows using evidence collector controls with validated outcomes.
