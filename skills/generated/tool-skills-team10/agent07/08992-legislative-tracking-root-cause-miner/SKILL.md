---
name: legislative-tracking-root-cause-miner
description: Use when tasks require legislative tracking root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Root Cause Miner

## Purpose
Design and execute legislative tracking workflows using root cause miner controls with validated outcomes.
