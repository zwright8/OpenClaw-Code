---
name: donor-platforms-state-reconciler
description: Use when tasks require donor platforms state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms State Reconciler

## Purpose
Design and execute donor platforms workflows using state reconciler controls with validated outcomes.
