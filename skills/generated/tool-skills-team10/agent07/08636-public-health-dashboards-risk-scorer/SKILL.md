---
name: public-health-dashboards-risk-scorer
description: Use when tasks require public health dashboards risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Risk Scorer

## Purpose
Design and execute public health dashboards workflows using risk scorer controls with validated outcomes.
