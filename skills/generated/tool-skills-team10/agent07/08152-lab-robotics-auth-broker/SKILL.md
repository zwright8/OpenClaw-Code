---
name: lab-robotics-auth-broker
description: Use when tasks require lab robotics auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Auth Broker

## Purpose
Design and execute lab robotics workflows using auth broker controls with validated outcomes.
