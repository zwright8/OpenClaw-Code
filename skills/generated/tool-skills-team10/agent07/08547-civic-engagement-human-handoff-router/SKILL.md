---
name: civic-engagement-human-handoff-router
description: Use when tasks require civic engagement human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Human Handoff Router

## Purpose
Design and execute civic engagement workflows using human handoff router controls with validated outcomes.
