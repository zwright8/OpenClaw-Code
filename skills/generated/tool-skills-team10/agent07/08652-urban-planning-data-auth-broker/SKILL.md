---
name: urban-planning-data-auth-broker
description: Use when tasks require urban planning data auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Auth Broker

## Purpose
Design and execute urban planning data workflows using auth broker controls with validated outcomes.
