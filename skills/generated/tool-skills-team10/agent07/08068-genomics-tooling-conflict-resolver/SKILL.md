---
name: genomics-tooling-conflict-resolver
description: Use when tasks require genomics tooling conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Conflict Resolver

## Purpose
Design and execute genomics tooling workflows using conflict resolver controls with validated outcomes.
