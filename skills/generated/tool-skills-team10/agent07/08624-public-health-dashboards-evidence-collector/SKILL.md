---
name: public-health-dashboards-evidence-collector
description: Use when tasks require public health dashboards evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Evidence Collector

## Purpose
Design and execute public health dashboards workflows using evidence collector controls with validated outcomes.
