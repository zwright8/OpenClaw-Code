---
name: legislative-tracking-conflict-resolver
description: Use when tasks require legislative tracking conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Conflict Resolver

## Purpose
Design and execute legislative tracking workflows using conflict resolver controls with validated outcomes.
