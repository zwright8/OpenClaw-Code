---
name: bioinformatics-pipelines-root-cause-miner
description: Use when tasks require bioinformatics pipelines root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Root Cause Miner

## Purpose
Design and execute bioinformatics pipelines workflows using root cause miner controls with validated outcomes.
