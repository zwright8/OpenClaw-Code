---
name: chemical-informatics-runbook-composer
description: Use when tasks require chemical informatics runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chemical Informatics Runbook Composer

## Purpose
Design and execute chemical informatics workflows using runbook composer controls with validated outcomes.
