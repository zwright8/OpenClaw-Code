---
name: civic-engagement-incident-triage
description: Use when tasks require civic engagement incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Incident Triage

## Purpose
Design and execute civic engagement workflows using incident triage controls with validated outcomes.
