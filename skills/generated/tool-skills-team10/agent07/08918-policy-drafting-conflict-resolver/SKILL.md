---
name: policy-drafting-conflict-resolver
description: Use when tasks require policy drafting conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Conflict Resolver

## Purpose
Design and execute policy drafting workflows using conflict resolver controls with validated outcomes.
