---
name: public-health-dashboards-incident-triage
description: Use when tasks require public health dashboards incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Incident Triage

## Purpose
Design and execute public health dashboards workflows using incident triage controls with validated outcomes.
