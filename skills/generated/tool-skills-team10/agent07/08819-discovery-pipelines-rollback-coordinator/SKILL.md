---
name: discovery-pipelines-rollback-coordinator
description: Use when tasks require discovery pipelines rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Rollback Coordinator

## Purpose
Design and execute discovery pipelines workflows using rollback coordinator controls with validated outcomes.
