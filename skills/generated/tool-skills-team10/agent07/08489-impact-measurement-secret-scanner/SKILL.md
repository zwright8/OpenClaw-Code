---
name: impact-measurement-secret-scanner
description: Use when tasks require impact measurement secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Secret Scanner

## Purpose
Design and execute impact measurement workflows using secret scanner controls with validated outcomes.
