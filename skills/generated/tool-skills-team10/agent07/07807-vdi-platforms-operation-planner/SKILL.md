---
name: vdi-platforms-operation-planner
description: Use when tasks require vdi platforms operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Operation Planner

## Purpose
Design and execute vdi platforms workflows using operation planner controls with validated outcomes.
