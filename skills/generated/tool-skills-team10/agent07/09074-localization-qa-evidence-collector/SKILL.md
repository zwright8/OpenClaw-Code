---
name: localization-qa-evidence-collector
description: Use when tasks require localization qa evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Evidence Collector

## Purpose
Design and execute localization qa workflows using evidence collector controls with validated outcomes.
