---
name: asset-discovery-retry-governor
description: Use when tasks require asset discovery retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Retry Governor

## Purpose
Design and execute asset discovery workflows using retry governor controls with validated outcomes.
