---
name: discovery-pipelines-remediation-planner
description: Use when tasks require discovery pipelines remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Remediation Planner

## Purpose
Design and execute discovery pipelines workflows using remediation planner controls with validated outcomes.
