---
name: discovery-pipelines-forecast-engine
description: Use when tasks require discovery pipelines forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Forecast Engine

## Purpose
Design and execute discovery pipelines workflows using forecast engine controls with validated outcomes.
