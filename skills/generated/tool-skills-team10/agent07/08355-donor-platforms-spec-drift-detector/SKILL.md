---
name: donor-platforms-spec-drift-detector
description: Use when tasks require donor platforms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Spec Drift Detector

## Purpose
Design and execute donor platforms workflows using spec drift detector controls with validated outcomes.
