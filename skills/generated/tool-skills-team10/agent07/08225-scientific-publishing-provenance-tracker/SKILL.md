---
name: scientific-publishing-provenance-tracker
description: Use when tasks require scientific publishing provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Provenance Tracker

## Purpose
Design and execute scientific publishing workflows using provenance tracker controls with validated outcomes.
