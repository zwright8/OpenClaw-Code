---
name: impact-measurement-spec-drift-detector
description: Use when tasks require impact measurement spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Spec Drift Detector

## Purpose
Design and execute impact measurement workflows using spec drift detector controls with validated outcomes.
