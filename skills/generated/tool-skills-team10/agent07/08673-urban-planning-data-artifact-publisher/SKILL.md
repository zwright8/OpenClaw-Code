---
name: urban-planning-data-artifact-publisher
description: Use when tasks require urban planning data artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Artifact Publisher

## Purpose
Design and execute urban planning data workflows using artifact publisher controls with validated outcomes.
