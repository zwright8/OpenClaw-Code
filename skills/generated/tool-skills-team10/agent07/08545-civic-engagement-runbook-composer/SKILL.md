---
name: civic-engagement-runbook-composer
description: Use when tasks require civic engagement runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Runbook Composer

## Purpose
Design and execute civic engagement workflows using runbook composer controls with validated outcomes.
