---
name: vdi-platforms-rollback-coordinator
description: Use when tasks require vdi platforms rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Rollback Coordinator

## Purpose
Design and execute vdi platforms workflows using rollback coordinator controls with validated outcomes.
