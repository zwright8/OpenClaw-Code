...
description: Use when tasks require discovery pipelines feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Feedback Harvester

## Purpose
Design and execute discovery pipelines workflows using feedback harvester controls with validated outcomes.
