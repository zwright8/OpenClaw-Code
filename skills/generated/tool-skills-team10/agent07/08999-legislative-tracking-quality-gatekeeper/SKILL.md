---
name: legislative-tracking-quality-gatekeeper
description: Use when tasks require legislative tracking quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Quality Gatekeeper

## Purpose
Design and execute legislative tracking workflows using quality gatekeeper controls with validated outcomes.
