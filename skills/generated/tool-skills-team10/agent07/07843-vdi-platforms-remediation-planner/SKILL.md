---
name: vdi-platforms-remediation-planner
description: Use when tasks require vdi platforms remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Remediation Planner

## Purpose
Design and execute vdi platforms workflows using remediation planner controls with validated outcomes.
