---
name: policy-drafting-root-cause-miner
description: Use when tasks require policy drafting root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Root Cause Miner

## Purpose
Design and execute policy drafting workflows using root cause miner controls with validated outcomes.
