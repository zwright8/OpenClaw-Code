---
name: patch-orchestration-approval-orchestrator
description: Use when tasks require patch orchestration approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Approval Orchestrator

## Purpose
Design and execute patch orchestration workflows using approval orchestrator controls with validated outcomes.
