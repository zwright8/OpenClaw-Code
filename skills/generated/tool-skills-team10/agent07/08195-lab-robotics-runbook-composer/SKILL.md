---
name: lab-robotics-runbook-composer
description: Use when tasks require lab robotics runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Runbook Composer

## Purpose
Design and execute lab robotics workflows using runbook composer controls with validated outcomes.
