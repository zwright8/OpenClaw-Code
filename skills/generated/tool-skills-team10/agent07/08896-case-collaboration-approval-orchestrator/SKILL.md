---
name: case-collaboration-approval-orchestrator
description: Use when tasks require case collaboration approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Approval Orchestrator

## Purpose
Design and execute case collaboration workflows using approval orchestrator controls with validated outcomes.
