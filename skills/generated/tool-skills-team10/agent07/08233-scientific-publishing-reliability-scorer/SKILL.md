---
name: scientific-publishing-reliability-scorer
description: Use when tasks require scientific publishing reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Reliability Scorer

## Purpose
Design and execute scientific publishing workflows using reliability scorer controls with validated outcomes.
