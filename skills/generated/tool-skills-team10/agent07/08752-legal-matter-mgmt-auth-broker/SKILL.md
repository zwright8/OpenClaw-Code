---
name: legal-matter-mgmt-auth-broker
description: Use when tasks require legal matter mgmt auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Auth Broker

## Purpose
Design and execute legal matter mgmt workflows using auth broker controls with validated outcomes.
