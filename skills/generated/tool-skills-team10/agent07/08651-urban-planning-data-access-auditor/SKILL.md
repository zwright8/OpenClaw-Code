---
name: urban-planning-data-access-auditor
description: Use when tasks require urban planning data access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Access Auditor

## Purpose
Design and execute urban planning data workflows using access auditor controls with validated outcomes.
