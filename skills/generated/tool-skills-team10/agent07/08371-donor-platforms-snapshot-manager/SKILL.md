---
name: donor-platforms-snapshot-manager
description: Use when tasks require donor platforms snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Snapshot Manager

## Purpose
Design and execute donor platforms workflows using snapshot manager controls with validated outcomes.
