---
name: asset-discovery-approval-orchestrator
description: Use when tasks require asset discovery approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Approval Orchestrator

## Purpose
Design and execute asset discovery workflows using approval orchestrator controls with validated outcomes.
