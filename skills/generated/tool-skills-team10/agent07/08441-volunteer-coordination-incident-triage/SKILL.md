---
name: volunteer-coordination-incident-triage
description: Use when tasks require volunteer coordination incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Incident Triage

## Purpose
Design and execute volunteer coordination workflows using incident triage controls with validated outcomes.
