---
name: asset-discovery-secret-scanner
description: Use when tasks require asset discovery secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Secret Scanner

## Purpose
Design and execute asset discovery workflows using secret scanner controls with validated outcomes.
