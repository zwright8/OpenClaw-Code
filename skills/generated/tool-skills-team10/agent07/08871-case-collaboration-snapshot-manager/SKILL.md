---
name: case-collaboration-snapshot-manager
description: Use when tasks require case collaboration snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Snapshot Manager

## Purpose
Design and execute case collaboration workflows using snapshot manager controls with validated outcomes.
