---
name: vdi-platforms-execution-runner
description: Use when tasks require vdi platforms execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Execution Runner

## Purpose
Design and execute vdi platforms workflows using execution runner controls with validated outcomes.
