---
name: bioinformatics-pipelines-approval-orchestrator
description: Use when tasks require bioinformatics pipelines approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Approval Orchestrator

## Purpose
Design and execute bioinformatics pipelines workflows using approval orchestrator controls with validated outcomes.
