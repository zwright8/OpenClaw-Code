---
name: emergency-response-anomaly-detector
description: Use when tasks require emergency response anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Anomaly Detector

## Purpose
Design and execute emergency response workflows using anomaly detector controls with validated outcomes.
