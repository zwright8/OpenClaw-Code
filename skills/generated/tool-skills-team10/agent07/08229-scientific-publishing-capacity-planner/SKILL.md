---
name: scientific-publishing-capacity-planner
description: Use when tasks require scientific publishing capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Capacity Planner

## Purpose
Design and execute scientific publishing workflows using capacity planner controls with validated outcomes.
