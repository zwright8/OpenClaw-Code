---
name: legislative-tracking-artifact-publisher
description: Use when tasks require legislative tracking artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Artifact Publisher

## Purpose
Design and execute legislative tracking workflows using artifact publisher controls with validated outcomes.
