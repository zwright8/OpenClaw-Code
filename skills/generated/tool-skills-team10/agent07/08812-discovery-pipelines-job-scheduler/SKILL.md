---
name: discovery-pipelines-job-scheduler
description: Use when tasks require discovery pipelines job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Job Scheduler

## Purpose
Design and execute discovery pipelines workflows using job scheduler controls with validated outcomes.
