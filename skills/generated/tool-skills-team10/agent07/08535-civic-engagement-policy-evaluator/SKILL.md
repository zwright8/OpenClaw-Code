---
name: civic-engagement-policy-evaluator
description: Use when tasks require civic engagement policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Policy Evaluator

## Purpose
Design and execute civic engagement workflows using policy evaluator controls with validated outcomes.
