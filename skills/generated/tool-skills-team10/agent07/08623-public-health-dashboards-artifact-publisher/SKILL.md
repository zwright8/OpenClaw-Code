---
name: public-health-dashboards-artifact-publisher
description: Use when tasks require public health dashboards artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Artifact Publisher

## Purpose
Design and execute public health dashboards workflows using artifact publisher controls with validated outcomes.
