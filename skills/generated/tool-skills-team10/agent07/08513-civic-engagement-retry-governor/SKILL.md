---
name: civic-engagement-retry-governor
description: Use when tasks require civic engagement retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Retry Governor

## Purpose
Design and execute civic engagement workflows using retry governor controls with validated outcomes.
