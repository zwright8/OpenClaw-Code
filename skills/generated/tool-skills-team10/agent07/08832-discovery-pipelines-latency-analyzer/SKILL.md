---
name: discovery-pipelines-latency-analyzer
description: Use when tasks require discovery pipelines latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Latency Analyzer

## Purpose
Design and execute discovery pipelines workflows using latency analyzer controls with validated outcomes.
