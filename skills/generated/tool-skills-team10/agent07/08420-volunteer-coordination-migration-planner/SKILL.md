---
name: volunteer-coordination-migration-planner
description: Use when tasks require volunteer coordination migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Migration Planner

## Purpose
Design and execute volunteer coordination workflows using migration planner controls with validated outcomes.
