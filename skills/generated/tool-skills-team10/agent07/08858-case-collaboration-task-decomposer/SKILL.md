---
name: case-collaboration-task-decomposer
description: Use when tasks require case collaboration task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Task Decomposer

## Purpose
Design and execute case collaboration workflows using task decomposer controls with validated outcomes.
