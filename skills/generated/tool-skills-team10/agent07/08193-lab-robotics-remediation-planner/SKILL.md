---
name: lab-robotics-remediation-planner
description: Use when tasks require lab robotics remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Remediation Planner

## Purpose
Design and execute lab robotics workflows using remediation planner controls with validated outcomes.
