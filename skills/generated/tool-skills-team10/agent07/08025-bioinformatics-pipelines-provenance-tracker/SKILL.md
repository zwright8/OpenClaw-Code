---
name: bioinformatics-pipelines-provenance-tracker
description: Use when tasks require bioinformatics pipelines provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Provenance Tracker

## Purpose
Design and execute bioinformatics pipelines workflows using provenance tracker controls with validated outcomes.
