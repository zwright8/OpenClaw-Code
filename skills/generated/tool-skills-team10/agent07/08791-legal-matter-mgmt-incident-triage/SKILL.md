---
name: legal-matter-mgmt-incident-triage
description: Use when tasks require legal matter mgmt incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Incident Triage

## Purpose
Design and execute legal matter mgmt workflows using incident triage controls with validated outcomes.
