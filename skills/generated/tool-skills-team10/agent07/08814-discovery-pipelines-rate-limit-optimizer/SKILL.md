---
name: discovery-pipelines-rate-limit-optimizer
description: Use when tasks require discovery pipelines rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Rate Limit Optimizer

## Purpose
Design and execute discovery pipelines workflows using rate limit optimizer controls with validated outcomes.
