---
name: case-collaboration-incident-triage
description: Use when tasks require case collaboration incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Incident Triage

## Purpose
Design and execute case collaboration workflows using incident triage controls with validated outcomes.
