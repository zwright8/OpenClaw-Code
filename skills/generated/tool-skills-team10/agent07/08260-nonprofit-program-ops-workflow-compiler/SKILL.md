---
name: nonprofit-program-ops-workflow-compiler
description: Use when tasks require nonprofit program ops workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Workflow Compiler

## Purpose
Design and execute nonprofit program ops workflows using workflow compiler controls with validated outcomes.
