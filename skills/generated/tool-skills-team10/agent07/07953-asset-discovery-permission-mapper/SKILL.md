---
name: asset-discovery-permission-mapper
description: Use when tasks require asset discovery permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Permission Mapper

## Purpose
Design and execute asset discovery workflows using permission mapper controls with validated outcomes.
