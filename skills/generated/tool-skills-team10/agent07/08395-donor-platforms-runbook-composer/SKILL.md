---
name: donor-platforms-runbook-composer
description: Use when tasks require donor platforms runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Runbook Composer

## Purpose
Design and execute donor platforms workflows using runbook composer controls with validated outcomes.
