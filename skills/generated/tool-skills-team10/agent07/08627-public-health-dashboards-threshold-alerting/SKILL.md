---
name: public-health-dashboards-threshold-alerting
description: Use when tasks require public health dashboards threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Threshold Alerting

## Purpose
Design and execute public health dashboards workflows using threshold alerting controls with validated outcomes.
