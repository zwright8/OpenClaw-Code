---
name: donor-platforms-root-cause-miner
description: Use when tasks require donor platforms root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Root Cause Miner

## Purpose
Design and execute donor platforms workflows using root cause miner controls with validated outcomes.
