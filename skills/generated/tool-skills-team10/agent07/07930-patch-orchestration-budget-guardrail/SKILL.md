---
name: patch-orchestration-budget-guardrail
description: Use when tasks require patch orchestration budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Budget Guardrail

## Purpose
Design and execute patch orchestration workflows using budget guardrail controls with validated outcomes.
