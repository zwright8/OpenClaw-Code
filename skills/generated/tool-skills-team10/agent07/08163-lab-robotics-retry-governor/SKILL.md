---
name: lab-robotics-retry-governor
description: Use when tasks require lab robotics retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Retry Governor

## Purpose
Design and execute lab robotics workflows using retry governor controls with validated outcomes.
