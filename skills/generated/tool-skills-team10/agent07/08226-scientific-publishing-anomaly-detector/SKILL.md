---
name: scientific-publishing-anomaly-detector
description: Use when tasks require scientific publishing anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Anomaly Detector

## Purpose
Design and execute scientific publishing workflows using anomaly detector controls with validated outcomes.
