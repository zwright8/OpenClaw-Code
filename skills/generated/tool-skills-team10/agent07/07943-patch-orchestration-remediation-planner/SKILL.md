---
name: patch-orchestration-remediation-planner
description: Use when tasks require patch orchestration remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Remediation Planner

## Purpose
Design and execute patch orchestration workflows using remediation planner controls with validated outcomes.
