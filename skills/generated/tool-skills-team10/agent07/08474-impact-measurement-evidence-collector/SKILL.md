---
name: impact-measurement-evidence-collector
description: Use when tasks require impact measurement evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Evidence Collector

## Purpose
Design and execute impact measurement workflows using evidence collector controls with validated outcomes.
