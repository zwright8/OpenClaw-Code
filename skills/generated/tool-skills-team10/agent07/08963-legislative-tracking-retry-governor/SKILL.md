---
name: legislative-tracking-retry-governor
description: Use when tasks require legislative tracking retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Retry Governor

## Purpose
Design and execute legislative tracking workflows using retry governor controls with validated outcomes.
