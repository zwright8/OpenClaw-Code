---
name: volunteer-coordination-risk-scorer
description: Use when tasks require volunteer coordination risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Risk Scorer

## Purpose
Design and execute volunteer coordination workflows using risk scorer controls with validated outcomes.
