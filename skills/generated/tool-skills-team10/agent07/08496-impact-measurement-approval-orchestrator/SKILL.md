---
name: impact-measurement-approval-orchestrator
description: Use when tasks require impact measurement approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Approval Orchestrator

## Purpose
Design and execute impact measurement workflows using approval orchestrator controls with validated outcomes.
