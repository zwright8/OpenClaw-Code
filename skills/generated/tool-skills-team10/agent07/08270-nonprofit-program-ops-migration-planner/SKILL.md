---
name: nonprofit-program-ops-migration-planner
description: Use when tasks require nonprofit program ops migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Migration Planner

## Purpose
Design and execute nonprofit program ops workflows using migration planner controls with validated outcomes.
