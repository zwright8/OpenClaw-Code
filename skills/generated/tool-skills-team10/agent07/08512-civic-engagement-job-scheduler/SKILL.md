---
name: civic-engagement-job-scheduler
description: Use when tasks require civic engagement job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Job Scheduler

## Purpose
Design and execute civic engagement workflows using job scheduler controls with validated outcomes.
