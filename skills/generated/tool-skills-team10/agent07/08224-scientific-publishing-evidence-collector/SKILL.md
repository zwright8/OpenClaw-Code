---
name: scientific-publishing-evidence-collector
description: Use when tasks require scientific publishing evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Evidence Collector

## Purpose
Design and execute scientific publishing workflows using evidence collector controls with validated outcomes.
