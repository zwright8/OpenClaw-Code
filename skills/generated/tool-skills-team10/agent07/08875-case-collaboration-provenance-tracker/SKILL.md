---
name: case-collaboration-provenance-tracker
description: Use when tasks require case collaboration provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Provenance Tracker

## Purpose
Design and execute case collaboration workflows using provenance tracker controls with validated outcomes.
