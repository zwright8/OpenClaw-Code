---
name: lab-robotics-migration-planner
description: Use when tasks require lab robotics migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Migration Planner

## Purpose
Design and execute lab robotics workflows using migration planner controls with validated outcomes.
