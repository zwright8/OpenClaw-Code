---
name: impact-measurement-pii-redactor
description: Use when tasks require impact measurement pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement PII Redactor

## Purpose
Design and execute impact measurement workflows using pii redactor controls with validated outcomes.
