---
name: asset-discovery-spec-drift-detector
description: Use when tasks require asset discovery spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Spec Drift Detector

## Purpose
Design and execute asset discovery workflows using spec drift detector controls with validated outcomes.
