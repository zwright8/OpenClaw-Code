---
name: policy-drafting-approval-orchestrator
description: Use when tasks require policy drafting approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Approval Orchestrator

## Purpose
Design and execute policy drafting workflows using approval orchestrator controls with validated outcomes.
