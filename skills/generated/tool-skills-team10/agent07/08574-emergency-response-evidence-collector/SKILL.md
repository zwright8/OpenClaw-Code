---
name: emergency-response-evidence-collector
description: Use when tasks require emergency response evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Evidence Collector

## Purpose
Design and execute emergency response workflows using evidence collector controls with validated outcomes.
