---
name: case-collaboration-forecast-engine
description: Use when tasks require case collaboration forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Forecast Engine

## Purpose
Design and execute case collaboration workflows using forecast engine controls with validated outcomes.
