---
name: public-health-dashboards-feedback-harvester
description: Use when tasks require public health dashboards feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Feedback Harvester

## Purpose
Design and execute public health dashboards workflows using feedback harvester controls with validated outcomes.
