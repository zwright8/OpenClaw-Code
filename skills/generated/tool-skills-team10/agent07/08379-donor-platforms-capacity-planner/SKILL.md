---
name: donor-platforms-capacity-planner
description: Use when tasks require donor platforms capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Capacity Planner

## Purpose
Design and execute donor platforms workflows using capacity planner controls with validated outcomes.
