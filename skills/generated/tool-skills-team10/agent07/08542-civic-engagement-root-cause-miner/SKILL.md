---
name: civic-engagement-root-cause-miner
description: Use when tasks require civic engagement root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Root Cause Miner

## Purpose
Design and execute civic engagement workflows using root cause miner controls with validated outcomes.
