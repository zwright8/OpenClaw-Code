---
name: remote-access-risk-scorer
description: Use when tasks require remote access risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Remote Access Risk Scorer

## Purpose
Design and execute remote access workflows using risk scorer controls with validated outcomes.
