---
name: bioinformatics-pipelines-runbook-composer
description: Use when tasks require bioinformatics pipelines runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Runbook Composer

## Purpose
Design and execute bioinformatics pipelines workflows using runbook composer controls with validated outcomes.
