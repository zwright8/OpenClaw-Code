---
name: asset-discovery-compliance-mapper
description: Use when tasks require asset discovery compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Compliance Mapper

## Purpose
Design and execute asset discovery workflows using compliance mapper controls with validated outcomes.
