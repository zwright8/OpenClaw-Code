---
name: asset-discovery-queue-balancer
description: Use when tasks require asset discovery queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Queue Balancer

## Purpose
Design and execute asset discovery workflows using queue balancer controls with validated outcomes.
