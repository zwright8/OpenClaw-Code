---
name: nonprofit-program-ops-auth-broker
description: Use when tasks require nonprofit program ops auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Auth Broker

## Purpose
Design and execute nonprofit program ops workflows using auth broker controls with validated outcomes.
