---
name: legislative-tracking-state-reconciler
description: Use when tasks require legislative tracking state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking State Reconciler

## Purpose
Design and execute legislative tracking workflows using state reconciler controls with validated outcomes.
