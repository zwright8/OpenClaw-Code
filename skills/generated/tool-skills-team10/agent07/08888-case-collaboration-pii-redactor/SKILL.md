---
name: case-collaboration-pii-redactor
description: Use when tasks require case collaboration pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration PII Redactor

## Purpose
Design and execute case collaboration workflows using pii redactor controls with validated outcomes.
