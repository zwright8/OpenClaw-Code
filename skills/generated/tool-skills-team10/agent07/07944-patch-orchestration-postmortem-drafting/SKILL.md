---
name: patch-orchestration-postmortem-drafting
description: Use when tasks require patch orchestration postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Postmortem Drafting

## Purpose
Design and execute patch orchestration workflows using postmortem drafting controls with validated outcomes.
