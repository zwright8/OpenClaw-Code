---
name: asset-discovery-auth-broker
description: Use when tasks require asset discovery auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Auth Broker

## Purpose
Design and execute asset discovery workflows using auth broker controls with validated outcomes.
