---
name: case-collaboration-feedback-harvester
description: Use when tasks require case collaboration feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Feedback Harvester

## Purpose
Design and execute case collaboration workflows using feedback harvester controls with validated outcomes.
