---
name: localization-qa-approval-orchestrator
description: Use when tasks require localization qa approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Approval Orchestrator

## Purpose
Design and execute localization qa workflows using approval orchestrator controls with validated outcomes.
