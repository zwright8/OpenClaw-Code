---
name: civic-engagement-state-reconciler
description: Use when tasks require civic engagement state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement State Reconciler

## Purpose
Design and execute civic engagement workflows using state reconciler controls with validated outcomes.
