---
name: vdi-platforms-job-scheduler
description: Use when tasks require vdi platforms job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Job Scheduler

## Purpose
Design and execute vdi platforms workflows using job scheduler controls with validated outcomes.
