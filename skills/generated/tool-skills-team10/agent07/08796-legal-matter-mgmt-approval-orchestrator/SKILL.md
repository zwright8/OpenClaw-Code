---
name: legal-matter-mgmt-approval-orchestrator
description: Use when tasks require legal matter mgmt approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Approval Orchestrator

## Purpose
Design and execute legal matter mgmt workflows using approval orchestrator controls with validated outcomes.
