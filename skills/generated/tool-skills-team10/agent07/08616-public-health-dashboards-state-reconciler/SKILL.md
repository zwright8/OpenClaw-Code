---
name: public-health-dashboards-state-reconciler
description: Use when tasks require public health dashboards state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards State Reconciler

## Purpose
Design and execute public health dashboards workflows using state reconciler controls with validated outcomes.
