---
name: patch-orchestration-conflict-resolver
description: Use when tasks require patch orchestration conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Conflict Resolver

## Purpose
Design and execute patch orchestration workflows using conflict resolver controls with validated outcomes.
