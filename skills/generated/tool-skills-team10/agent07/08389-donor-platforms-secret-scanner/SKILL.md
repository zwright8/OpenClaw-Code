---
name: donor-platforms-secret-scanner
description: Use when tasks require donor platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Secret Scanner

## Purpose
Design and execute donor platforms workflows using secret scanner controls with validated outcomes.
