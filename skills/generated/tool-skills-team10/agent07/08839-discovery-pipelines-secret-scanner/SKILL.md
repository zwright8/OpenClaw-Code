---
name: discovery-pipelines-secret-scanner
description: Use when tasks require discovery pipelines secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Secret Scanner

## Purpose
Design and execute discovery pipelines workflows using secret scanner controls with validated outcomes.
