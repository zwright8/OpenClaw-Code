---
name: case-collaboration-quality-gatekeeper
description: Use when tasks require case collaboration quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Quality Gatekeeper

## Purpose
Design and execute case collaboration workflows using quality gatekeeper controls with validated outcomes.
