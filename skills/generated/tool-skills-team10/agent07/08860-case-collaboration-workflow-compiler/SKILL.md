---
name: case-collaboration-workflow-compiler
description: Use when tasks require case collaboration workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Workflow Compiler

## Purpose
Design and execute case collaboration workflows using workflow compiler controls with validated outcomes.
