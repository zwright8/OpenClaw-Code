---
name: urban-planning-data-root-cause-miner
description: Use when tasks require urban planning data root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Root Cause Miner

## Purpose
Design and execute urban planning data workflows using root cause miner controls with validated outcomes.
