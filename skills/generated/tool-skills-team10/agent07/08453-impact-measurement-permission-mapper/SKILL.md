---
name: impact-measurement-permission-mapper
description: Use when tasks require impact measurement permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Permission Mapper

## Purpose
Design and execute impact measurement workflows using permission mapper controls with validated outcomes.
