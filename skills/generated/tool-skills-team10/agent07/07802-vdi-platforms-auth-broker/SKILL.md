---
name: vdi-platforms-auth-broker
description: Use when tasks require vdi platforms auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Auth Broker

## Purpose
Design and execute vdi platforms workflows using auth broker controls with validated outcomes.
