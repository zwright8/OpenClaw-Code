---
name: legal-matter-mgmt-access-auditor
description: Use when tasks require legal matter mgmt access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Access Auditor

## Purpose
Design and execute legal matter mgmt workflows using access auditor controls with validated outcomes.
