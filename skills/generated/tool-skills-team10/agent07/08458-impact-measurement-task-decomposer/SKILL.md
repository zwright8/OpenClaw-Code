---
name: impact-measurement-task-decomposer
description: Use when tasks require impact measurement task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Task Decomposer

## Purpose
Design and execute impact measurement workflows using task decomposer controls with validated outcomes.
