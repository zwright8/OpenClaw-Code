---
name: scientific-publishing-pii-redactor
description: Use when tasks require scientific publishing pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing PII Redactor

## Purpose
Design and execute scientific publishing workflows using pii redactor controls with validated outcomes.
