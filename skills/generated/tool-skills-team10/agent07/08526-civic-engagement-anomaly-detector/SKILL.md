---
name: civic-engagement-anomaly-detector
description: Use when tasks require civic engagement anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Anomaly Detector

## Purpose
Design and execute civic engagement workflows using anomaly detector controls with validated outcomes.
