---
name: case-collaboration-capacity-planner
description: Use when tasks require case collaboration capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Capacity Planner

## Purpose
Design and execute case collaboration workflows using capacity planner controls with validated outcomes.
