---
name: scientific-publishing-secret-scanner
description: Use when tasks require scientific publishing secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Secret Scanner

## Purpose
Design and execute scientific publishing workflows using secret scanner controls with validated outcomes.
