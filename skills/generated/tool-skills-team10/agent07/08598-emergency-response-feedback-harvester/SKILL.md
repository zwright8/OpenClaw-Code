---
name: emergency-response-feedback-harvester
description: Use when tasks require emergency response feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Feedback Harvester

## Purpose
Design and execute emergency response workflows using feedback harvester controls with validated outcomes.
