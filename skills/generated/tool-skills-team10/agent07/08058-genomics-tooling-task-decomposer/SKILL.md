---
name: genomics-tooling-task-decomposer
description: Use when tasks require genomics tooling task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Task Decomposer

## Purpose
Design and execute genomics tooling workflows using task decomposer controls with validated outcomes.
