---
name: vdi-platforms-incident-triage
description: Use when tasks require vdi platforms incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Incident Triage

## Purpose
Design and execute vdi platforms workflows using incident triage controls with validated outcomes.
