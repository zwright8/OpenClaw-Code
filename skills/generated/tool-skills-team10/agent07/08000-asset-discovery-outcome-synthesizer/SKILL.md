---
name: asset-discovery-outcome-synthesizer
description: Use when tasks require asset discovery outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Outcome Synthesizer

## Purpose
Design and execute asset discovery workflows using outcome synthesizer controls with validated outcomes.
