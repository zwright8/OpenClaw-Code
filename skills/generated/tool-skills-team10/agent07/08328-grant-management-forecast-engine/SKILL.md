---
name: grant-management-forecast-engine
description: Use when tasks require grant management forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Forecast Engine

## Purpose
Design and execute grant management workflows using forecast engine controls with validated outcomes.
