---
name: scientific-publishing-feedback-harvester
description: Use when tasks require scientific publishing feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Feedback Harvester

## Purpose
Design and execute scientific publishing workflows using feedback harvester controls with validated outcomes.
