---
name: grant-management-snapshot-manager
description: Use when tasks require grant management snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Snapshot Manager

## Purpose
Design and execute grant management workflows using snapshot manager controls with validated outcomes.
