---
name: civic-engagement-budget-guardrail
description: Use when tasks require civic engagement budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Budget Guardrail

## Purpose
Design and execute civic engagement workflows using budget guardrail controls with validated outcomes.
