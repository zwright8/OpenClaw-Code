---
name: legal-matter-mgmt-migration-planner
description: Use when tasks require legal matter mgmt migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Migration Planner

## Purpose
Design and execute legal matter mgmt workflows using migration planner controls with validated outcomes.
