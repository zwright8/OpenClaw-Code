---
name: lab-robotics-pii-redactor
description: Use when tasks require lab robotics pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics PII Redactor

## Purpose
Design and execute lab robotics workflows using pii redactor controls with validated outcomes.
