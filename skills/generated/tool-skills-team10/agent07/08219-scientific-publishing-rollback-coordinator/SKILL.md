---
name: scientific-publishing-rollback-coordinator
description: Use when tasks require scientific publishing rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Rollback Coordinator

## Purpose
Design and execute scientific publishing workflows using rollback coordinator controls with validated outcomes.
