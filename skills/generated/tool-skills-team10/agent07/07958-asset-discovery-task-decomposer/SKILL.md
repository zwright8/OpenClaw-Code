---
name: asset-discovery-task-decomposer
description: Use when tasks require asset discovery task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Task Decomposer

## Purpose
Design and execute asset discovery workflows using task decomposer controls with validated outcomes.
