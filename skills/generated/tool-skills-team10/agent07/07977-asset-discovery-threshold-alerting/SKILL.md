---
name: asset-discovery-threshold-alerting
description: Use when tasks require asset discovery threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Threshold Alerting

## Purpose
Design and execute asset discovery workflows using threshold alerting controls with validated outcomes.
