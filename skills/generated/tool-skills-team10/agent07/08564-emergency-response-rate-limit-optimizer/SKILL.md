---
name: emergency-response-rate-limit-optimizer
description: Use when tasks require emergency response rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Rate Limit Optimizer

## Purpose
Design and execute emergency response workflows using rate limit optimizer controls with validated outcomes.
