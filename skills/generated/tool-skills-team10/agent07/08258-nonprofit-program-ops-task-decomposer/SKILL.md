---
name: nonprofit-program-ops-task-decomposer
description: Use when tasks require nonprofit program ops task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Task Decomposer

## Purpose
Design and execute nonprofit program ops workflows using task decomposer controls with validated outcomes.
