---
name: asset-discovery-schema-introspector
description: Use when tasks require asset discovery schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Schema Introspector

## Purpose
Design and execute asset discovery workflows using schema introspector controls with validated outcomes.
