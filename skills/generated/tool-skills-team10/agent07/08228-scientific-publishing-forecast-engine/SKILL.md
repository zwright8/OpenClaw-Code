---
name: scientific-publishing-forecast-engine
description: Use when tasks require scientific publishing forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Forecast Engine

## Purpose
Design and execute scientific publishing workflows using forecast engine controls with validated outcomes.
