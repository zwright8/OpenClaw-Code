---
name: public-health-dashboards-execution-runner
description: Use when tasks require public health dashboards execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Execution Runner

## Purpose
Design and execute public health dashboards workflows using execution runner controls with validated outcomes.
