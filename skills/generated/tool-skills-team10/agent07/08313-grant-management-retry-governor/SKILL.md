---
name: grant-management-retry-governor
description: Use when tasks require grant management retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Retry Governor

## Purpose
Design and execute grant management workflows using retry governor controls with validated outcomes.
