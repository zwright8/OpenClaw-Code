---
name: scientific-publishing-workflow-compiler
description: Use when tasks require scientific publishing workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Workflow Compiler

## Purpose
Design and execute scientific publishing workflows using workflow compiler controls with validated outcomes.
