---
name: legislative-tracking-compliance-mapper
description: Use when tasks require legislative tracking compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Compliance Mapper

## Purpose
Design and execute legislative tracking workflows using compliance mapper controls with validated outcomes.
