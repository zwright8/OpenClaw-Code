---
name: bioinformatics-pipelines-evidence-collector
description: Use when tasks require bioinformatics pipelines evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Evidence Collector

## Purpose
Design and execute bioinformatics pipelines workflows using evidence collector controls with validated outcomes.
