---
name: impact-measurement-schema-introspector
description: Use when tasks require impact measurement schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Schema Introspector

## Purpose
Design and execute impact measurement workflows using schema introspector controls with validated outcomes.
