---
name: volunteer-coordination-evidence-collector
description: Use when tasks require volunteer coordination evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Evidence Collector

## Purpose
Design and execute volunteer coordination workflows using evidence collector controls with validated outcomes.
