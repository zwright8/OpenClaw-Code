---
name: nonprofit-program-ops-access-auditor
description: Use when tasks require nonprofit program ops access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Access Auditor

## Purpose
Design and execute nonprofit program ops workflows using access auditor controls with validated outcomes.
