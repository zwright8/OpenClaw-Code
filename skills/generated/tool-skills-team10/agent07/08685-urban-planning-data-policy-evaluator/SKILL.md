---
name: urban-planning-data-policy-evaluator
description: Use when tasks require urban planning data policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Policy Evaluator

## Purpose
Design and execute urban planning data workflows using policy evaluator controls with validated outcomes.
