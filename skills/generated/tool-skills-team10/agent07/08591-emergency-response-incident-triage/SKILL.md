---
name: emergency-response-incident-triage
description: Use when tasks require emergency response incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Incident Triage

## Purpose
Design and execute emergency response workflows using incident triage controls with validated outcomes.
