---
name: public-health-dashboards-policy-evaluator
description: Use when tasks require public health dashboards policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Policy Evaluator

## Purpose
Design and execute public health dashboards workflows using policy evaluator controls with validated outcomes.
