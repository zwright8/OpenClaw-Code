---
name: impact-measurement-state-reconciler
description: Use when tasks require impact measurement state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement State Reconciler

## Purpose
Design and execute impact measurement workflows using state reconciler controls with validated outcomes.
