---
name: impact-measurement-api-contract-validator
description: Use when tasks require impact measurement api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement API Contract Validator

## Purpose
Design and execute impact measurement workflows using api contract validator controls with validated outcomes.
...
- Domain: [Impact Measurement](../../resources/domains/impact-measurement.md)
