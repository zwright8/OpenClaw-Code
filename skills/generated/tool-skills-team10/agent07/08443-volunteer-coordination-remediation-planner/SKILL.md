---
name: volunteer-coordination-remediation-planner
description: Use when tasks require volunteer coordination remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Remediation Planner

## Purpose
Design and execute volunteer coordination workflows using remediation planner controls with validated outcomes.
