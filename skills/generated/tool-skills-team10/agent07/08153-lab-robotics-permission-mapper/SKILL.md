---
name: lab-robotics-permission-mapper
description: Use when tasks require lab robotics permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Permission Mapper

## Purpose
Design and execute lab robotics workflows using permission mapper controls with validated outcomes.
