---
name: civic-engagement-migration-planner
description: Use when tasks require civic engagement migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Migration Planner

## Purpose
Design and execute civic engagement workflows using migration planner controls with validated outcomes.
