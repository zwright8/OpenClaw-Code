---
name: impact-measurement-migration-planner
description: Use when tasks require impact measurement migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Migration Planner

## Purpose
Design and execute impact measurement workflows using migration planner controls with validated outcomes.
