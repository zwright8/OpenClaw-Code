---
name: scientific-publishing-incident-triage
description: Use when tasks require scientific publishing incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Incident Triage

## Purpose
Design and execute scientific publishing workflows using incident triage controls with validated outcomes.
