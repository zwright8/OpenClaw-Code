---
name: patch-orchestration-permission-mapper
description: Use when tasks require patch orchestration permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Permission Mapper

## Purpose
Design and execute patch orchestration workflows using permission mapper controls with validated outcomes.
