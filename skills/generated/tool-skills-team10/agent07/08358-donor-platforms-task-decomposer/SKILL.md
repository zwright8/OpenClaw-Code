---
name: donor-platforms-task-decomposer
description: Use when tasks require donor platforms task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Task Decomposer

## Purpose
Design and execute donor platforms workflows using task decomposer controls with validated outcomes.
