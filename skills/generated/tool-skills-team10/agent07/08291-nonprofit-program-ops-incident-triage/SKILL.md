---
name: nonprofit-program-ops-incident-triage
description: Use when tasks require nonprofit program ops incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Incident Triage

## Purpose
Design and execute nonprofit program ops workflows using incident triage controls with validated outcomes.
