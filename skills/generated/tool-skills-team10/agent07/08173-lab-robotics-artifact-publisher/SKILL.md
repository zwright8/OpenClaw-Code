---
name: lab-robotics-artifact-publisher
description: Use when tasks require lab robotics artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Artifact Publisher

## Purpose
Design and execute lab robotics workflows using artifact publisher controls with validated outcomes.
