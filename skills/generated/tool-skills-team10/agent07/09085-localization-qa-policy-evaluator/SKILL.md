---
name: localization-qa-policy-evaluator
description: Use when tasks require localization qa policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Policy Evaluator

## Purpose
Design and execute localization qa workflows using policy evaluator controls with validated outcomes.
