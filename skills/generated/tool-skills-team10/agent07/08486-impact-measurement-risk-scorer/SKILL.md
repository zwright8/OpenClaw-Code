---
name: impact-measurement-risk-scorer
description: Use when tasks require impact measurement risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Risk Scorer

## Purpose
Design and execute impact measurement workflows using risk scorer controls with validated outcomes.
