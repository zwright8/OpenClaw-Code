---
name: chemical-informatics-remediation-planner
description: Use when tasks require chemical informatics remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chemical Informatics Remediation Planner

## Purpose
Design and execute chemical informatics workflows using remediation planner controls with validated outcomes.
