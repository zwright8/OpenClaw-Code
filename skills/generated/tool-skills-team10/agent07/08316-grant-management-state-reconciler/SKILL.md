---
name: grant-management-state-reconciler
description: Use when tasks require grant management state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management State Reconciler

## Purpose
Design and execute grant management workflows using state reconciler controls with validated outcomes.
