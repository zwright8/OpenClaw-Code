---
name: volunteer-coordination-artifact-publisher
description: Use when tasks require volunteer coordination artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Artifact Publisher

## Purpose
Design and execute volunteer coordination workflows using artifact publisher controls with validated outcomes.
