---
name: translation-pipelines-spec-drift-detector
description: Use when tasks require translation pipelines spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Translation Pipelines Spec Drift Detector

## Purpose
Design and execute translation pipelines workflows using spec drift detector controls with validated outcomes.
