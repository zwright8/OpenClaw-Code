---
name: nonprofit-program-ops-capacity-planner
description: Use when tasks require nonprofit program ops capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Capacity Planner

## Purpose
Design and execute nonprofit program ops workflows using capacity planner controls with validated outcomes.
