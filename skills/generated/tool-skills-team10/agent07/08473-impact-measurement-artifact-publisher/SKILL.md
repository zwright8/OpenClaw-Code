---
name: impact-measurement-artifact-publisher
description: Use when tasks require impact measurement artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Artifact Publisher

## Purpose
Design and execute impact measurement workflows using artifact publisher controls with validated outcomes.
