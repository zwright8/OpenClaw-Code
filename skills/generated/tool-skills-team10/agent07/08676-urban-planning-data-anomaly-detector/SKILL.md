---
name: urban-planning-data-anomaly-detector
description: Use when tasks require urban planning data anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Anomaly Detector

## Purpose
Design and execute urban planning data workflows using anomaly detector controls with validated outcomes.
