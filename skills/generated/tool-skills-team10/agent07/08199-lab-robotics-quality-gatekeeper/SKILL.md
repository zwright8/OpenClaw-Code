---
name: lab-robotics-quality-gatekeeper
description: Use when tasks require lab robotics quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Quality Gatekeeper

## Purpose
Design and execute lab robotics workflows using quality gatekeeper controls with validated outcomes.
