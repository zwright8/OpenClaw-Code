---
name: asset-discovery-version-tracker
description: Use when tasks require asset discovery version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Version Tracker

## Purpose
Design and execute asset discovery workflows using version tracker controls with validated outcomes.
