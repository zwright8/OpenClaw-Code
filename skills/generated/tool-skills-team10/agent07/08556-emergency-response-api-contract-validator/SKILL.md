---
name: emergency-response-api-contract-validator
description: Use when tasks require emergency response api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response API Contract Validator

## Purpose
Design and execute emergency response workflows using api contract validator controls with validated outcomes.
...
- Domain: [Emergency Response](../../resources/domains/emergency-response.md)
