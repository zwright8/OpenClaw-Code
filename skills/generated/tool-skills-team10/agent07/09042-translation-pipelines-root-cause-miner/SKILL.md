---
name: translation-pipelines-root-cause-miner
description: Use when tasks require translation pipelines root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Translation Pipelines Root Cause Miner

## Purpose
Design and execute translation pipelines workflows using root cause miner controls with validated outcomes.
