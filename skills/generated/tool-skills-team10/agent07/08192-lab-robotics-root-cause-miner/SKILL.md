---
name: lab-robotics-root-cause-miner
description: Use when tasks require lab robotics root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Root Cause Miner

## Purpose
Design and execute lab robotics workflows using root cause miner controls with validated outcomes.
