---
name: discovery-pipelines-anomaly-detector
description: Use when tasks require discovery pipelines anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Anomaly Detector

## Purpose
Design and execute discovery pipelines workflows using anomaly detector controls with validated outcomes.
