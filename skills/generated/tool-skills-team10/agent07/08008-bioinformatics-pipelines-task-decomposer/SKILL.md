---
name: bioinformatics-pipelines-task-decomposer
description: Use when tasks require bioinformatics pipelines task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Task Decomposer

## Purpose
Design and execute bioinformatics pipelines workflows using task decomposer controls with validated outcomes.
