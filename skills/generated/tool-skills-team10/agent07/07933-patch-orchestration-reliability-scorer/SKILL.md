---
name: patch-orchestration-reliability-scorer
description: Use when tasks require patch orchestration reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Reliability Scorer

## Purpose
Design and execute patch orchestration workflows using reliability scorer controls with validated outcomes.
