---
name: public-health-dashboards-retry-governor
description: Use when tasks require public health dashboards retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Retry Governor

## Purpose
Design and execute public health dashboards workflows using retry governor controls with validated outcomes.
