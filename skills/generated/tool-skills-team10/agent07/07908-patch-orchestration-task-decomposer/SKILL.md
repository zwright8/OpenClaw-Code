---
name: patch-orchestration-task-decomposer
description: Use when tasks require patch orchestration task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Task Decomposer

## Purpose
Design and execute patch orchestration workflows using task decomposer controls with validated outcomes.
