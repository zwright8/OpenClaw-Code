---
name: emergency-response-task-decomposer
description: Use when tasks require emergency response task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Task Decomposer

## Purpose
Design and execute emergency response workflows using task decomposer controls with validated outcomes.
