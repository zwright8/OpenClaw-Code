---
name: impact-measurement-snapshot-manager
description: Use when tasks require impact measurement snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Snapshot Manager

## Purpose
Design and execute impact measurement workflows using snapshot manager controls with validated outcomes.
