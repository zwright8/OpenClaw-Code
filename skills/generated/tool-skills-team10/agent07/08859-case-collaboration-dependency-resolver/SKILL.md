---
name: case-collaboration-dependency-resolver
description: Use when tasks require case collaboration dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Dependency Resolver

## Purpose
Design and execute case collaboration workflows using dependency resolver controls with validated outcomes.
