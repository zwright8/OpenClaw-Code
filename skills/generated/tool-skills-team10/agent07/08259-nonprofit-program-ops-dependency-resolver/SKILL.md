...
description: Use when tasks require nonprofit program ops dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Dependency Resolver

## Purpose
Design and execute nonprofit program ops workflows using dependency resolver controls with validated outcomes.
