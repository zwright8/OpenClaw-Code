---
name: grant-management-provenance-tracker
description: Use when tasks require grant management provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Provenance Tracker

## Purpose
Design and execute grant management workflows using provenance tracker controls with validated outcomes.
