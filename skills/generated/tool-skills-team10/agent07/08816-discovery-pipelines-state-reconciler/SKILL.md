---
name: discovery-pipelines-state-reconciler
description: Use when tasks require discovery pipelines state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines State Reconciler

## Purpose
Design and execute discovery pipelines workflows using state reconciler controls with validated outcomes.
