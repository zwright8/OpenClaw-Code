---
name: donor-platforms-postmortem-drafting
description: Use when tasks require donor platforms postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Postmortem Drafting

## Purpose
Design and execute donor platforms workflows using postmortem drafting controls with validated outcomes.
