---
name: localization-qa-permission-mapper
description: Use when tasks require localization qa permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Permission Mapper

## Purpose
Design and execute localization qa workflows using permission mapper controls with validated outcomes.
