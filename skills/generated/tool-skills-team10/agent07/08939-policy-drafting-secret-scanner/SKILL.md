---
name: policy-drafting-secret-scanner
description: Use when tasks require policy drafting secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Secret Scanner

## Purpose
Design and execute policy drafting workflows using secret scanner controls with validated outcomes.
