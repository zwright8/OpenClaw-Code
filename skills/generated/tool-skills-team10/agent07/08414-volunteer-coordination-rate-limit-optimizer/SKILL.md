---
name: volunteer-coordination-rate-limit-optimizer
description: Use when tasks require volunteer coordination rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Rate Limit Optimizer

## Purpose
Design and execute volunteer coordination workflows using rate limit optimizer controls with validated outcomes.
