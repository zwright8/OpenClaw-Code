---
name: impact-measurement-forecast-engine
description: Use when tasks require impact measurement forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Forecast Engine

## Purpose
Design and execute impact measurement workflows using forecast engine controls with validated outcomes.
