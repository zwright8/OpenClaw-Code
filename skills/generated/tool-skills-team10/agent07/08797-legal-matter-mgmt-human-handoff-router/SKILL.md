---
name: legal-matter-mgmt-human-handoff-router
description: Use when tasks require legal matter mgmt human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Human Handoff Router

## Purpose
Design and execute legal matter mgmt workflows using human handoff router controls with validated outcomes.
