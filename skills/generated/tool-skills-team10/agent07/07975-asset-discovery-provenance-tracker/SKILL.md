---
name: asset-discovery-provenance-tracker
description: Use when tasks require asset discovery provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Provenance Tracker

## Purpose
Design and execute asset discovery workflows using provenance tracker controls with validated outcomes.
