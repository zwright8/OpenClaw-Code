---
name: donor-platforms-provenance-tracker
description: Use when tasks require donor platforms provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Provenance Tracker

## Purpose
Design and execute donor platforms workflows using provenance tracker controls with validated outcomes.
