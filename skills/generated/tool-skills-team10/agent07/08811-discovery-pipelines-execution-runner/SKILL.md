---
name: discovery-pipelines-execution-runner
description: Use when tasks require discovery pipelines execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Execution Runner

## Purpose
Design and execute discovery pipelines workflows using execution runner controls with validated outcomes.
