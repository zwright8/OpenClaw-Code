---
name: discovery-pipelines-provenance-tracker
description: Use when tasks require discovery pipelines provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Provenance Tracker

## Purpose
Design and execute discovery pipelines workflows using provenance tracker controls with validated outcomes.
