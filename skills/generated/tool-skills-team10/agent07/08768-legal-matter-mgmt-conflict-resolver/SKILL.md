---
name: legal-matter-mgmt-conflict-resolver
description: Use when tasks require legal matter mgmt conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Conflict Resolver

## Purpose
Design and execute legal matter mgmt workflows using conflict resolver controls with validated outcomes.
