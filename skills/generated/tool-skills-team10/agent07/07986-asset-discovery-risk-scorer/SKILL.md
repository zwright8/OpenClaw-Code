---
name: asset-discovery-risk-scorer
description: Use when tasks require asset discovery risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Risk Scorer

## Purpose
Design and execute asset discovery workflows using risk scorer controls with validated outcomes.
