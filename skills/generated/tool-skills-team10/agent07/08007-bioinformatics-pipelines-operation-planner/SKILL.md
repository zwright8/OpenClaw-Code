---
name: bioinformatics-pipelines-operation-planner
description: Use when tasks require bioinformatics pipelines operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Operation Planner

## Purpose
Design and execute bioinformatics pipelines workflows using operation planner controls with validated outcomes.
