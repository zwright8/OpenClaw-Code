---
name: impact-measurement-budget-guardrail
description: Use when tasks require impact measurement budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Budget Guardrail

## Purpose
Design and execute impact measurement workflows using budget guardrail controls with validated outcomes.
