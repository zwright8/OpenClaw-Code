---
name: localization-qa-anomaly-detector
description: Use when tasks require localization qa anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Anomaly Detector

## Purpose
Design and execute localization qa workflows using anomaly detector controls with validated outcomes.
