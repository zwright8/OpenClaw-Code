---
name: lab-robotics-anomaly-detector
description: Use when tasks require lab robotics anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Anomaly Detector

## Purpose
Design and execute lab robotics workflows using anomaly detector controls with validated outcomes.
