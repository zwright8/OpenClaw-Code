---
name: civic-engagement-auth-broker
description: Use when tasks require civic engagement auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Auth Broker

## Purpose
Design and execute civic engagement workflows using auth broker controls with validated outcomes.
