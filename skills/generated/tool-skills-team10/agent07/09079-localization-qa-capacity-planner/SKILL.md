---
name: localization-qa-capacity-planner
description: Use when tasks require localization qa capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Capacity Planner

## Purpose
Design and execute localization qa workflows using capacity planner controls with validated outcomes.
