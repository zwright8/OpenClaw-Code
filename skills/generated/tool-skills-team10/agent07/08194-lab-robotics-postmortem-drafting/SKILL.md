---
name: lab-robotics-postmortem-drafting
description: Use when tasks require lab robotics postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Postmortem Drafting

## Purpose
Design and execute lab robotics workflows using postmortem drafting controls with validated outcomes.
