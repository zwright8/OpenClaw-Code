---
name: impact-measurement-reliability-scorer
description: Use when tasks require impact measurement reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Reliability Scorer

## Purpose
Design and execute impact measurement workflows using reliability scorer controls with validated outcomes.
