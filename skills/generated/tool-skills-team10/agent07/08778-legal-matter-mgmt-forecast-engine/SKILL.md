---
name: legal-matter-mgmt-forecast-engine
description: Use when tasks require legal matter mgmt forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Forecast Engine

## Purpose
Design and execute legal matter mgmt workflows using forecast engine controls with validated outcomes.
