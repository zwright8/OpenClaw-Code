---
name: asset-discovery-operation-planner
description: Use when tasks require asset discovery operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Operation Planner

## Purpose
Design and execute asset discovery workflows using operation planner controls with validated outcomes.
