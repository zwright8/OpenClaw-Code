---
name: emergency-response-forecast-engine
description: Use when tasks require emergency response forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Forecast Engine

## Purpose
Design and execute emergency response workflows using forecast engine controls with validated outcomes.
