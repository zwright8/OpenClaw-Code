---
name: public-health-dashboards-secret-scanner
description: Use when tasks require public health dashboards secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Secret Scanner

## Purpose
Design and execute public health dashboards workflows using secret scanner controls with validated outcomes.
