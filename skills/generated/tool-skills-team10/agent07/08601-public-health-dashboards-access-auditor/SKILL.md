---
name: public-health-dashboards-access-auditor
description: Use when tasks require public health dashboards access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Access Auditor

## Purpose
Design and execute public health dashboards workflows using access auditor controls with validated outcomes.
