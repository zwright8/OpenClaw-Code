---
name: scientific-publishing-snapshot-manager
description: Use when tasks require scientific publishing snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Snapshot Manager

## Purpose
Design and execute scientific publishing workflows using snapshot manager controls with validated outcomes.
