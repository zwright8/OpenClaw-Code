---
name: donor-platforms-human-handoff-router
description: Use when tasks require donor platforms human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Human Handoff Router

## Purpose
Design and execute donor platforms workflows using human handoff router controls with validated outcomes.
