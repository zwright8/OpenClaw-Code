---
name: legal-matter-mgmt-execution-runner
description: Use when tasks require legal matter mgmt execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Execution Runner

## Purpose
Design and execute legal matter mgmt workflows using execution runner controls with validated outcomes.
