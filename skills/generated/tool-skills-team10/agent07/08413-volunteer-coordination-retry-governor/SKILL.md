---
name: volunteer-coordination-retry-governor
description: Use when tasks require volunteer coordination retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Retry Governor

## Purpose
Design and execute volunteer coordination workflows using retry governor controls with validated outcomes.
