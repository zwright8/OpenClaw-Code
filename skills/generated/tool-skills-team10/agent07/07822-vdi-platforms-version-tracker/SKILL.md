---
name: vdi-platforms-version-tracker
description: Use when tasks require vdi platforms version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Version Tracker

## Purpose
Design and execute vdi platforms workflows using version tracker controls with validated outcomes.
