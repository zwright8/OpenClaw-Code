---
name: emergency-response-provenance-tracker
description: Use when tasks require emergency response provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Provenance Tracker

## Purpose
Design and execute emergency response workflows using provenance tracker controls with validated outcomes.
