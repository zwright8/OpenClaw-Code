---
name: policy-drafting-rollback-coordinator
description: Use when tasks require policy drafting rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Rollback Coordinator

## Purpose
Design and execute policy drafting workflows using rollback coordinator controls with validated outcomes.
