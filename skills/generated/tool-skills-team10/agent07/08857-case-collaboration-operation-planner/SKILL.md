---
name: case-collaboration-operation-planner
description: Use when tasks require case collaboration operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Operation Planner

## Purpose
Design and execute case collaboration workflows using operation planner controls with validated outcomes.
