---
name: grant-management-quality-gatekeeper
description: Use when tasks require grant management quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Quality Gatekeeper

## Purpose
Design and execute grant management workflows using quality gatekeeper controls with validated outcomes.
