---
name: vdi-platforms-forecast-engine
description: Use when tasks require vdi platforms forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Forecast Engine

## Purpose
Design and execute vdi platforms workflows using forecast engine controls with validated outcomes.
