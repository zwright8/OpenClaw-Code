---
name: scientific-publishing-api-contract-validator
description: Use when tasks require scientific publishing api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing API Contract Validator

## Purpose
Design and execute scientific publishing workflows using api contract validator controls with validated outcomes.
...
- Domain: [Scientific Publishing](../../resources/domains/scientific-publishing.md)
