---
name: grant-management-task-decomposer
description: Use when tasks require grant management task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Task Decomposer

## Purpose
Design and execute grant management workflows using task decomposer controls with validated outcomes.
