---
name: emergency-response-human-handoff-router
description: Use when tasks require emergency response human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Human Handoff Router

## Purpose
Design and execute emergency response workflows using human handoff router controls with validated outcomes.
