---
name: lab-robotics-conflict-resolver
description: Use when tasks require lab robotics conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Conflict Resolver

## Purpose
Design and execute lab robotics workflows using conflict resolver controls with validated outcomes.
