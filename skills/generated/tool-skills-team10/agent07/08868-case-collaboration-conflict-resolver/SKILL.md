---
name: case-collaboration-conflict-resolver
description: Use when tasks require case collaboration conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Conflict Resolver

## Purpose
Design and execute case collaboration workflows using conflict resolver controls with validated outcomes.
