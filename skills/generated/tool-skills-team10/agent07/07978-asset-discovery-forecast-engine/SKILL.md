---
name: asset-discovery-forecast-engine
description: Use when tasks require asset discovery forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Forecast Engine

## Purpose
Design and execute asset discovery workflows using forecast engine controls with validated outcomes.
