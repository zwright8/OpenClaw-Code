---
name: asset-discovery-conflict-resolver
description: Use when tasks require asset discovery conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Conflict Resolver

## Purpose
Design and execute asset discovery workflows using conflict resolver controls with validated outcomes.
