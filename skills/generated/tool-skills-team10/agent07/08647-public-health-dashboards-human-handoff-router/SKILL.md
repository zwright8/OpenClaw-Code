---
name: public-health-dashboards-human-handoff-router
description: Use when tasks require public health dashboards human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Human Handoff Router

## Purpose
Design and execute public health dashboards workflows using human handoff router controls with validated outcomes.
