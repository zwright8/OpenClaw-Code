---
name: scientific-publishing-rate-limit-optimizer
description: Use when tasks require scientific publishing rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Rate Limit Optimizer

## Purpose
Design and execute scientific publishing workflows using rate limit optimizer controls with validated outcomes.
