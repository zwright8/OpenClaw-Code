---
name: discovery-pipelines-human-handoff-router
description: Use when tasks require discovery pipelines human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Human Handoff Router

## Purpose
Design and execute discovery pipelines workflows using human handoff router controls with validated outcomes.
