---
name: vdi-platforms-anomaly-detector
description: Use when tasks require vdi platforms anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Anomaly Detector

## Purpose
Design and execute vdi platforms workflows using anomaly detector controls with validated outcomes.
