---
name: discovery-pipelines-spec-drift-detector
description: Use when tasks require discovery pipelines spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Spec Drift Detector

## Purpose
Design and execute discovery pipelines workflows using spec drift detector controls with validated outcomes.
