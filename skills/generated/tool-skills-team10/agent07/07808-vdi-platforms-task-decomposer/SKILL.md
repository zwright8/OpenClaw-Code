---
name: vdi-platforms-task-decomposer
description: Use when tasks require vdi platforms task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Task Decomposer

## Purpose
Design and execute vdi platforms workflows using task decomposer controls with validated outcomes.
