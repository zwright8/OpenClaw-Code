---
name: impact-measurement-dependency-resolver
description: Use when tasks require impact measurement dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Dependency Resolver

## Purpose
Design and execute impact measurement workflows using dependency resolver controls with validated outcomes.
