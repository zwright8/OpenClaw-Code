---
name: volunteer-coordination-secret-scanner
description: Use when tasks require volunteer coordination secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Secret Scanner

## Purpose
Design and execute volunteer coordination workflows using secret scanner controls with validated outcomes.
