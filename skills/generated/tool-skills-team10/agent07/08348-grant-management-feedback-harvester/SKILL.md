---
name: grant-management-feedback-harvester
description: Use when tasks require grant management feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Feedback Harvester

## Purpose
Design and execute grant management workflows using feedback harvester controls with validated outcomes.
