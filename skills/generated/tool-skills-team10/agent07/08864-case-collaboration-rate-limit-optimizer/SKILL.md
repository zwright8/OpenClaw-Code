---
name: case-collaboration-rate-limit-optimizer
description: Use when tasks require case collaboration rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Rate Limit Optimizer

## Purpose
Design and execute case collaboration workflows using rate limit optimizer controls with validated outcomes.
