---
name: emergency-response-quality-gatekeeper
description: Use when tasks require emergency response quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Quality Gatekeeper

## Purpose
Design and execute emergency response workflows using quality gatekeeper controls with validated outcomes.
