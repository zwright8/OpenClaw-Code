---
name: legal-matter-mgmt-sla-enforcer
description: Use when tasks require legal matter mgmt sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt SLA Enforcer

## Purpose
Design and execute legal matter mgmt workflows using sla enforcer controls with validated outcomes.
