---
name: lab-robotics-workflow-compiler
description: Use when tasks require lab robotics workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Workflow Compiler

## Purpose
Design and execute lab robotics workflows using workflow compiler controls with validated outcomes.
