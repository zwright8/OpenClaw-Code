---
name: legal-matter-mgmt-risk-scorer
description: Use when tasks require legal matter mgmt risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Risk Scorer

## Purpose
Design and execute legal matter mgmt workflows using risk scorer controls with validated outcomes.
