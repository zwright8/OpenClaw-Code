---
name: asset-discovery-runbook-composer
description: Use when tasks require asset discovery runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Runbook Composer

## Purpose
Design and execute asset discovery workflows using runbook composer controls with validated outcomes.
