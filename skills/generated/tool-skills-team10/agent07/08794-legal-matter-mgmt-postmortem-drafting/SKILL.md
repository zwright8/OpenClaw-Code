---
name: legal-matter-mgmt-postmortem-drafting
description: Use when tasks require legal matter mgmt postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Postmortem Drafting

## Purpose
Design and execute legal matter mgmt workflows using postmortem drafting controls with validated outcomes.
