---
name: asset-discovery-job-scheduler
description: Use when tasks require asset discovery job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Job Scheduler

## Purpose
Design and execute asset discovery workflows using job scheduler controls with validated outcomes.
