---
name: public-health-dashboards-workflow-compiler
description: Use when tasks require public health dashboards workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Workflow Compiler

## Purpose
Design and execute public health dashboards workflows using workflow compiler controls with validated outcomes.
