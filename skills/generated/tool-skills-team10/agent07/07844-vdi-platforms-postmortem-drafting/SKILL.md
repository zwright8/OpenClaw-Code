---
name: vdi-platforms-postmortem-drafting
description: Use when tasks require vdi platforms postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Postmortem Drafting

## Purpose
Design and execute vdi platforms workflows using postmortem drafting controls with validated outcomes.
