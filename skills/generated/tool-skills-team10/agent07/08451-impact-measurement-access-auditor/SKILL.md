---
name: impact-measurement-access-auditor
description: Use when tasks require impact measurement access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Impact Measurement Access Auditor

## Purpose
Design and execute impact measurement workflows using access auditor controls with validated outcomes.
