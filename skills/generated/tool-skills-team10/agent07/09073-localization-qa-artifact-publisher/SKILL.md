---
name: localization-qa-artifact-publisher
description: Use when tasks require localization qa artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Localization QA Artifact Publisher

## Purpose
Design and execute localization qa workflows using artifact publisher controls with validated outcomes.
