---
name: asset-discovery-execution-runner
description: Use when tasks require asset discovery execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Execution Runner

## Purpose
Design and execute asset discovery workflows using execution runner controls with validated outcomes.
