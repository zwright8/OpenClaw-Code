---
name: legislative-tracking-evidence-collector
description: Use when tasks require legislative tracking evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Evidence Collector

## Purpose
Design and execute legislative tracking workflows using evidence collector controls with validated outcomes.
