---
name: discovery-pipelines-sla-enforcer
description: Use when tasks require discovery pipelines sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines SLA Enforcer

## Purpose
Design and execute discovery pipelines workflows using sla enforcer controls with validated outcomes.
