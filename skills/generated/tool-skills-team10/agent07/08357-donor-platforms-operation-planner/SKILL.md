---
name: donor-platforms-operation-planner
description: Use when tasks require donor platforms operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Operation Planner

## Purpose
Design and execute donor platforms workflows using operation planner controls with validated outcomes.
