...
description: Use when tasks require discovery pipelines schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Schema Introspector

## Purpose
Design and execute discovery pipelines workflows using schema introspector controls with validated outcomes.
