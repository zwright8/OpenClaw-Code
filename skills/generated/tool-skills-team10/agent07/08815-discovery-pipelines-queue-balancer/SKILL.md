---
name: discovery-pipelines-queue-balancer
description: Use when tasks require discovery pipelines queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Queue Balancer

## Purpose
Design and execute discovery pipelines workflows using queue balancer controls with validated outcomes.
