---
name: vdi-platforms-workflow-compiler
description: Use when tasks require vdi platforms workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Workflow Compiler

## Purpose
Design and execute vdi platforms workflows using workflow compiler controls with validated outcomes.
