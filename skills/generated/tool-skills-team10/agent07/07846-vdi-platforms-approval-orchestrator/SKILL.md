---
name: vdi-platforms-approval-orchestrator
description: Use when tasks require vdi platforms approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Approval Orchestrator

## Purpose
Design and execute vdi platforms workflows using approval orchestrator controls with validated outcomes.
