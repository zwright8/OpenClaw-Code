---
name: policy-drafting-feedback-harvester
description: Use when tasks require policy drafting feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Feedback Harvester

## Purpose
Design and execute policy drafting workflows using feedback harvester controls with validated outcomes.
