---
name: grant-management-rollback-coordinator
description: Use when tasks require grant management rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Rollback Coordinator

## Purpose
Design and execute grant management workflows using rollback coordinator controls with validated outcomes.
