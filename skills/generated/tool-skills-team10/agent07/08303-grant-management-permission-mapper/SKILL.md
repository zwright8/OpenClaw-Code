---
name: grant-management-permission-mapper
description: Use when tasks require grant management permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Grant Management Permission Mapper

## Purpose
Design and execute grant management workflows using permission mapper controls with validated outcomes.
