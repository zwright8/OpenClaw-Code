---
name: bioinformatics-pipelines-spec-drift-detector
description: Use when tasks require bioinformatics pipelines spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Spec Drift Detector

## Purpose
Design and execute bioinformatics pipelines workflows using spec drift detector controls with validated outcomes.
