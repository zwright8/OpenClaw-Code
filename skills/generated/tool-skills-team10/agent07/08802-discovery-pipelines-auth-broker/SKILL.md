---
name: discovery-pipelines-auth-broker
description: Use when tasks require discovery pipelines auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Auth Broker

## Purpose
Design and execute discovery pipelines workflows using auth broker controls with validated outcomes.
