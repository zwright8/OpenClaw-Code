---
name: asset-discovery-anomaly-detector
description: Use when tasks require asset discovery anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Anomaly Detector

## Purpose
Design and execute asset discovery workflows using anomaly detector controls with validated outcomes.
