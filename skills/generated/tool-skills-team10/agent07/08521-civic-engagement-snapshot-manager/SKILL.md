---
name: civic-engagement-snapshot-manager
description: Use when tasks require civic engagement snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Snapshot Manager

## Purpose
Design and execute civic engagement workflows using snapshot manager controls with validated outcomes.
