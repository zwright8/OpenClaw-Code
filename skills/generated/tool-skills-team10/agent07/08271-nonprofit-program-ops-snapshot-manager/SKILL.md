---
name: nonprofit-program-ops-snapshot-manager
description: Use when tasks require nonprofit program ops snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Snapshot Manager

## Purpose
Design and execute nonprofit program ops workflows using snapshot manager controls with validated outcomes.
