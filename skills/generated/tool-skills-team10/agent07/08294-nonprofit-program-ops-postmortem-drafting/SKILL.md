---
name: nonprofit-program-ops-postmortem-drafting
description: Use when tasks require nonprofit program ops postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Postmortem Drafting

## Purpose
Design and execute nonprofit program ops workflows using postmortem drafting controls with validated outcomes.
