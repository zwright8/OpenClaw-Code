---
name: discovery-pipelines-threshold-alerting
description: Use when tasks require discovery pipelines threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Threshold Alerting

## Purpose
Design and execute discovery pipelines workflows using threshold alerting controls with validated outcomes.
