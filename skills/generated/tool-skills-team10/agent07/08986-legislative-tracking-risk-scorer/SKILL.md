---
name: legislative-tracking-risk-scorer
description: Use when tasks require legislative tracking risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Risk Scorer

## Purpose
Design and execute legislative tracking workflows using risk scorer controls with validated outcomes.
