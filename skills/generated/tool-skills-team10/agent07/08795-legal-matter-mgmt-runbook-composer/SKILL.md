---
name: legal-matter-mgmt-runbook-composer
description: Use when tasks require legal matter mgmt runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Runbook Composer

## Purpose
Design and execute legal matter mgmt workflows using runbook composer controls with validated outcomes.
