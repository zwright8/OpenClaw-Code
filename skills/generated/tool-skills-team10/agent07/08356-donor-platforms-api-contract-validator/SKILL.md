---
name: donor-platforms-api-contract-validator
description: Use when tasks require donor platforms api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms API Contract Validator

## Purpose
Design and execute donor platforms workflows using api contract validator controls with validated outcomes.

## Precision Profile
- Domain: Donor Platforms
...
- Domain: [Donor Platforms](../../resources/domains/donor-platforms.md)
