---
name: legislative-tracking-workflow-compiler
description: Use when tasks require legislative tracking workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Workflow Compiler

## Purpose
Design and execute legislative tracking workflows using workflow compiler controls with validated outcomes.
