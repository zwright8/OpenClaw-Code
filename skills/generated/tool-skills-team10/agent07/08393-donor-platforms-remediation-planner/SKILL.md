---
name: donor-platforms-remediation-planner
description: Use when tasks require donor platforms remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Remediation Planner

## Purpose
Design and execute donor platforms workflows using remediation planner controls with validated outcomes.
