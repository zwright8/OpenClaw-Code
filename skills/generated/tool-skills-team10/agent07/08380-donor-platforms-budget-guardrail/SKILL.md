---
name: donor-platforms-budget-guardrail
description: Use when tasks require donor platforms budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Donor Platforms Budget Guardrail

## Purpose
Design and execute donor platforms workflows using budget guardrail controls with validated outcomes.
