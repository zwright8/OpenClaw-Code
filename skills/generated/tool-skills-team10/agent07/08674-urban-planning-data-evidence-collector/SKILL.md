---
name: urban-planning-data-evidence-collector
description: Use when tasks require urban planning data evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Evidence Collector

## Purpose
Design and execute urban planning data workflows using evidence collector controls with validated outcomes.
