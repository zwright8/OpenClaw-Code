---
name: nonprofit-program-ops-compliance-mapper
description: Use when tasks require nonprofit program ops compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Nonprofit Program Ops Compliance Mapper

## Purpose
Design and execute nonprofit program ops workflows using compliance mapper controls with validated outcomes.
