---
name: bioinformatics-pipelines-migration-planner
description: Use when tasks require bioinformatics pipelines migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bioinformatics Pipelines Migration Planner

## Purpose
Design and execute bioinformatics pipelines workflows using migration planner controls with validated outcomes.
