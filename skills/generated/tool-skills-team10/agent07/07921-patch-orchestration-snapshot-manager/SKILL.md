---
name: patch-orchestration-snapshot-manager
description: Use when tasks require patch orchestration snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Snapshot Manager

## Purpose
Design and execute patch orchestration workflows using snapshot manager controls with validated outcomes.
