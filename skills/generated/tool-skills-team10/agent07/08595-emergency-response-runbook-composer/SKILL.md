---
name: emergency-response-runbook-composer
description: Use when tasks require emergency response runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Runbook Composer

## Purpose
Design and execute emergency response workflows using runbook composer controls with validated outcomes.
