---
name: emergency-response-capacity-planner
description: Use when tasks require emergency response capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Capacity Planner

## Purpose
Design and execute emergency response workflows using capacity planner controls with validated outcomes.
