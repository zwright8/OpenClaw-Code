---
name: asset-discovery-reliability-scorer
description: Use when tasks require asset discovery reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Asset Discovery Reliability Scorer

## Purpose
Design and execute asset discovery workflows using reliability scorer controls with validated outcomes.
