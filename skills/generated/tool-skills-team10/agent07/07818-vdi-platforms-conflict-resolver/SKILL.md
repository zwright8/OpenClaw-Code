---
name: vdi-platforms-conflict-resolver
description: Use when tasks require vdi platforms conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# VDI Platforms Conflict Resolver

## Purpose
Design and execute vdi platforms workflows using conflict resolver controls with validated outcomes.
