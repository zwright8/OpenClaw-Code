---
name: chemical-informatics-quality-gatekeeper
description: Use when tasks require chemical informatics quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chemical Informatics Quality Gatekeeper

## Purpose
Design and execute chemical informatics workflows using quality gatekeeper controls with validated outcomes.
