---
name: genomics-tooling-capacity-planner
description: Use when tasks require genomics tooling capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Genomics Tooling Capacity Planner

## Purpose
Design and execute genomics tooling workflows using capacity planner controls with validated outcomes.
