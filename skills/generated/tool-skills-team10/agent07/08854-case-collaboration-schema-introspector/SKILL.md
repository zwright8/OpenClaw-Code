---
name: case-collaboration-schema-introspector
description: Use when tasks require case collaboration schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Case Collaboration Schema Introspector

## Purpose
Design and execute case collaboration workflows using schema introspector controls with validated outcomes.
