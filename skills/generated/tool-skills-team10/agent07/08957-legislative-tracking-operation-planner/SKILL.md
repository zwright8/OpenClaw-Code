---
name: legislative-tracking-operation-planner
description: Use when tasks require legislative tracking operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Operation Planner

## Purpose
Design and execute legislative tracking workflows using operation planner controls with validated outcomes.
