---
name: emergency-response-dependency-resolver
description: Use when tasks require emergency response dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Dependency Resolver

## Purpose
Design and execute emergency response workflows using dependency resolver controls with validated outcomes.
