---
name: volunteer-coordination-operation-planner
description: Use when tasks require volunteer coordination operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Operation Planner

## Purpose
Design and execute volunteer coordination workflows using operation planner controls with validated outcomes.
