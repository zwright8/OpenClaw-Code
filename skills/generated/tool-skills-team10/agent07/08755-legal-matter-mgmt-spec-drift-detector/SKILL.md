---
name: legal-matter-mgmt-spec-drift-detector
description: Use when tasks require legal matter mgmt spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Spec Drift Detector

## Purpose
Design and execute legal matter mgmt workflows using spec drift detector controls with validated outcomes.
