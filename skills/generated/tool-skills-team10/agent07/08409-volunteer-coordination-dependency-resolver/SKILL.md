---
name: volunteer-coordination-dependency-resolver
description: Use when tasks require volunteer coordination dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Volunteer Coordination Dependency Resolver

## Purpose
Design and execute volunteer coordination workflows using dependency resolver controls with validated outcomes.
