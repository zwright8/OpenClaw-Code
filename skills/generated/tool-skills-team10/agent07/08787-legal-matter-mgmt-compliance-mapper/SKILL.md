---
name: legal-matter-mgmt-compliance-mapper
description: Use when tasks require legal matter mgmt compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Compliance Mapper

## Purpose
Design and execute legal matter mgmt workflows using compliance mapper controls with validated outcomes.
