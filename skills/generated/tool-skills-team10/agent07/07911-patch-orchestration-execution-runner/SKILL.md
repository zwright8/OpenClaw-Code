---
name: patch-orchestration-execution-runner
description: Use when tasks require patch orchestration execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Execution Runner

## Purpose
Design and execute patch orchestration workflows using execution runner controls with validated outcomes.
