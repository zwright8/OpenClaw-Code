---
name: patch-orchestration-access-auditor
description: Use when tasks require patch orchestration access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Access Auditor

## Purpose
Design and execute patch orchestration workflows using access auditor controls with validated outcomes.
