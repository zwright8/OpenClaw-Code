---
name: scientific-publishing-human-handoff-router
description: Use when tasks require scientific publishing human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Human Handoff Router

## Purpose
Design and execute scientific publishing workflows using human handoff router controls with validated outcomes.
