---
name: legal-matter-mgmt-evidence-collector
description: Use when tasks require legal matter mgmt evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legal Matter Mgmt Evidence Collector

## Purpose
Design and execute legal matter mgmt workflows using evidence collector controls with validated outcomes.
