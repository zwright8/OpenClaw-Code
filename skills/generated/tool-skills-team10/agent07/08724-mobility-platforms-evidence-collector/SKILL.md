---
name: mobility-platforms-evidence-collector
description: Use when tasks require mobility platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Mobility Platforms Evidence Collector

## Purpose
Design and execute mobility platforms workflows using evidence collector controls with validated outcomes.
