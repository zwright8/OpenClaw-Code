---
name: emergency-response-risk-scorer
description: Use when tasks require emergency response risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Emergency Response Risk Scorer

## Purpose
Design and execute emergency response workflows using risk scorer controls with validated outcomes.
