...
description: Use when tasks require discovery pipelines dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines Dependency Resolver

## Purpose
Design and execute discovery pipelines workflows using dependency resolver controls with validated outcomes.
