---
name: discovery-pipelines-api-contract-validator
description: Use when tasks require discovery pipelines api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Discovery Pipelines API Contract Validator

## Purpose
Design and execute discovery pipelines workflows using api contract validator controls with validated outcomes.
