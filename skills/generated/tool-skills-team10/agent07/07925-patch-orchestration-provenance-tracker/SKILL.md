---
name: patch-orchestration-provenance-tracker
description: Use when tasks require patch orchestration provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Patch Orchestration Provenance Tracker

## Purpose
Design and execute patch orchestration workflows using provenance tracker controls with validated outcomes.
