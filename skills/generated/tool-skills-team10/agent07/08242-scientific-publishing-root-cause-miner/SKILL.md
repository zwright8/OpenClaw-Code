---
name: scientific-publishing-root-cause-miner
description: Use when tasks require scientific publishing root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Root Cause Miner

## Purpose
Design and execute scientific publishing workflows using root cause miner controls with validated outcomes.
