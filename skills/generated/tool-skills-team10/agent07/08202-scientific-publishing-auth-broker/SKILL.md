---
name: scientific-publishing-auth-broker
description: Use when tasks require scientific publishing auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Auth Broker

## Purpose
Design and execute scientific publishing workflows using auth broker controls with validated outcomes.
