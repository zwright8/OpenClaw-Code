---
name: policy-drafting-anomaly-detector
description: Use when tasks require policy drafting anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Drafting Anomaly Detector

## Purpose
Design and execute policy drafting workflows using anomaly detector controls with validated outcomes.
