---
name: public-health-dashboards-dependency-resolver
description: Use when tasks require public health dashboards dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Dependency Resolver

## Purpose
Design and execute public health dashboards workflows using dependency resolver controls with validated outcomes.
