---
name: urban-planning-data-dependency-resolver
description: Use when tasks require urban planning data dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Urban Planning Data Dependency Resolver

## Purpose
Design and execute urban planning data workflows using dependency resolver controls with validated outcomes.
