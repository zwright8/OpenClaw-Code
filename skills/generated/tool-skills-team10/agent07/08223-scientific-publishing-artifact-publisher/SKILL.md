---
name: scientific-publishing-artifact-publisher
description: Use when tasks require scientific publishing artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Scientific Publishing Artifact Publisher

## Purpose
Design and execute scientific publishing workflows using artifact publisher controls with validated outcomes.
