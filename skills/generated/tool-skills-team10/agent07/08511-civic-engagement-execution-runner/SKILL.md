---
name: civic-engagement-execution-runner
description: Use when tasks require civic engagement execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Civic Engagement Execution Runner

## Purpose
Design and execute civic engagement workflows using execution runner controls with validated outcomes.
