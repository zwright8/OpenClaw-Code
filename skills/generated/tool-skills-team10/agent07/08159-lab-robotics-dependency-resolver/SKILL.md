---
name: lab-robotics-dependency-resolver
description: Use when tasks require lab robotics dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Robotics Dependency Resolver

## Purpose
Design and execute lab robotics workflows using dependency resolver controls with validated outcomes.
