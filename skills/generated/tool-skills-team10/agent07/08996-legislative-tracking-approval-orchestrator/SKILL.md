---
name: legislative-tracking-approval-orchestrator
description: Use when tasks require legislative tracking approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Approval Orchestrator

## Purpose
Design and execute legislative tracking workflows using approval orchestrator controls with validated outcomes.
