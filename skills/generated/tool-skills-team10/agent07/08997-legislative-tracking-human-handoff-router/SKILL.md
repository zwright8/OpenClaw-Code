---
name: legislative-tracking-human-handoff-router
description: Use when tasks require legislative tracking human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Legislative Tracking Human Handoff Router

## Purpose
Design and execute legislative tracking workflows using human handoff router controls with validated outcomes.
