---
name: public-health-dashboards-auth-broker
description: Use when tasks require public health dashboards auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Public Health Dashboards Auth Broker

## Purpose
Design and execute public health dashboards workflows using auth broker controls with validated outcomes.
