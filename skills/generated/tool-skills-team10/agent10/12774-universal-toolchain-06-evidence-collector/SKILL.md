...
description: Use when tasks require universal toolchain 06 evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Evidence Collector

## Purpose
Design and execute universal toolchain 06 workflows using evidence collector controls with validated outcomes.
