---
name: consent-management-incident-triage
description: Use when tasks require consent management incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Incident Triage

## Purpose
Design and execute consent management workflows using incident triage controls with validated outcomes.
