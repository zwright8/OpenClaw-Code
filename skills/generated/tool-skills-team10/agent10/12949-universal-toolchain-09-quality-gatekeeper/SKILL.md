---
name: universal-toolchain-09-quality-gatekeeper
description: Use when tasks require universal toolchain 09 quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 09 Quality Gatekeeper

## Purpose
Design and execute universal toolchain 09 workflows using quality gatekeeper controls with validated outcomes.
