---
name: ai-evaluation-markets-task-decomposer
description: Use when tasks require ai evaluation markets task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Task Decomposer

## Purpose
Design and execute ai evaluation markets workflows using task decomposer controls with validated outcomes.
