---
name: simulation-environments-evidence-collector
description: Use when tasks require simulation environments evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Simulation Environments Evidence Collector

## Purpose
Design and execute simulation environments workflows using evidence collector controls with validated outcomes.
