---
name: sensitive-data-governance-execution-runner
description: Use when tasks require sensitive data governance execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Execution Runner

## Purpose
Design and execute sensitive data governance workflows using execution runner controls with validated outcomes.
