---
name: consent-management-risk-scorer
description: Use when tasks require consent management risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Risk Scorer

## Purpose
Design and execute consent management workflows using risk scorer controls with validated outcomes.
