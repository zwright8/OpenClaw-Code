---
name: universal-toolchain-09-auth-broker
description: Use when tasks require universal toolchain 09 auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 09 Auth Broker

## Purpose
Design and execute universal toolchain 09 workflows using auth broker controls with validated outcomes.
