---
name: service-quality-secret-scanner
description: Use when tasks require service quality secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Secret Scanner

## Purpose
Design and execute service quality workflows using secret scanner controls with validated outcomes.
