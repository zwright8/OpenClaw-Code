---
name: audit-trails-provenance-tracker
description: Use when tasks require audit trails provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Provenance Tracker

## Purpose
Design and execute audit trails workflows using provenance tracker controls with validated outcomes.
