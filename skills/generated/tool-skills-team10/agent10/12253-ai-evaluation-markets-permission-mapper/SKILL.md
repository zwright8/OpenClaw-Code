---
name: ai-evaluation-markets-permission-mapper
description: Use when tasks require ai evaluation markets permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Permission Mapper

## Purpose
Design and execute ai evaluation markets workflows using permission mapper controls with validated outcomes.
