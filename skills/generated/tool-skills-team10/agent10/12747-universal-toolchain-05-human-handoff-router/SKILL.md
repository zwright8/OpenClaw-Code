---
name: universal-toolchain-05-human-handoff-router
description: Use when tasks require universal toolchain 05 human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Human Handoff Router

## Purpose
Design and execute universal toolchain 05 workflows using human handoff router controls with validated outcomes.
