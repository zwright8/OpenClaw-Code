---
name: consent-management-feedback-harvester
description: Use when tasks require consent management feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Feedback Harvester

## Purpose
Design and execute consent management workflows using feedback harvester controls with validated outcomes.
