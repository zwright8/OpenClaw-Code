---
name: universal-toolchain-09-risk-scorer
description: Use when tasks require universal toolchain 09 risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 09 Risk Scorer

## Purpose
Design and execute universal toolchain 09 workflows using risk scorer controls with validated outcomes.
