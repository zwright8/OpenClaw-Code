---
name: policy-compliance-snapshot-manager
description: Use when tasks require policy compliance snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Compliance Snapshot Manager

## Purpose
Design and execute policy compliance workflows using snapshot manager controls with validated outcomes.
