---
name: peer-review-ops-feedback-harvester
description: Use when tasks require peer review ops feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Feedback Harvester

## Purpose
Design and execute peer review ops workflows using feedback harvester controls with validated outcomes.
