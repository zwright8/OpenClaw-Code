---
name: benchmark-repositories-feedback-harvester
description: Use when tasks require benchmark repositories feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Feedback Harvester

## Purpose
Design and execute benchmark repositories workflows using feedback harvester controls with validated outcomes.
