---
name: benchmark-repositories-anomaly-detector
description: Use when tasks require benchmark repositories anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Anomaly Detector

## Purpose
Design and execute benchmark repositories workflows using anomaly detector controls with validated outcomes.
