...
description: Use when tasks require ethics review boards artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Artifact Publisher

## Purpose
Design and execute ethics review boards workflows using artifact publisher controls with validated outcomes.
