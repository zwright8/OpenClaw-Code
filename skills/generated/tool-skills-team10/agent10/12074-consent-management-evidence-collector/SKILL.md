---
name: consent-management-evidence-collector
description: Use when tasks require consent management evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Evidence Collector

## Purpose
Design and execute consent management workflows using evidence collector controls with validated outcomes.
