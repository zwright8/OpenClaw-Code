---
name: audit-trails-evidence-collector
description: Use when tasks require audit trails evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Evidence Collector

## Purpose
Design and execute audit trails workflows using evidence collector controls with validated outcomes.
