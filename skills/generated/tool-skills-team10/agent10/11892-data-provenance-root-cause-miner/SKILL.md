---
name: data-provenance-root-cause-miner
description: Use when tasks require data provenance root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Root Cause Miner

## Purpose
Design and execute data provenance workflows using root cause miner controls with validated outcomes.
