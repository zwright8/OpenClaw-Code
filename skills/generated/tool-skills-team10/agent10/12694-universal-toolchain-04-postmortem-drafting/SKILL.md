---
name: universal-toolchain-04-postmortem-drafting
description: Use when tasks require universal toolchain 04 postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Postmortem Drafting

## Purpose
Design and execute universal toolchain 04 workflows using postmortem drafting controls with validated outcomes.
