---
name: autonomy-control-provenance-tracker
description: Use when tasks require autonomy control provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Provenance Tracker

## Purpose
Design and execute autonomy control workflows using provenance tracker controls with validated outcomes.
