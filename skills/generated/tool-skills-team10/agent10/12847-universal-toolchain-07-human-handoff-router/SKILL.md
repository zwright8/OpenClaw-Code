---
name: universal-toolchain-07-human-handoff-router
description: Use when tasks require universal toolchain 07 human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 07 Human Handoff Router

## Purpose
Design and execute universal toolchain 07 workflows using human handoff router controls with validated outcomes.
