---
name: universal-toolchain-10-evidence-collector
description: Use when tasks require universal toolchain 10 evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 10 Evidence Collector

## Purpose
Design and execute universal toolchain 10 workflows using evidence collector controls with validated outcomes.
