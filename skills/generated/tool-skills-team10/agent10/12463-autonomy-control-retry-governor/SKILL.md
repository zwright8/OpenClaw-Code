---
name: autonomy-control-retry-governor
description: Use when tasks require autonomy control retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Retry Governor

## Purpose
Design and execute autonomy control workflows using retry governor controls with validated outcomes.
