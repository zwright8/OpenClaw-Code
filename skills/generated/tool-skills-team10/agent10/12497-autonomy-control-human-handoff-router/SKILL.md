---
name: autonomy-control-human-handoff-router
description: Use when tasks require autonomy control human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Human Handoff Router

## Purpose
Design and execute autonomy control workflows using human handoff router controls with validated outcomes.
