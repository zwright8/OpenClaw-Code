---
name: peer-review-ops-rollback-coordinator
description: Use when tasks require peer review ops rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Rollback Coordinator

## Purpose
Design and execute peer review ops workflows using rollback coordinator controls with validated outcomes.
