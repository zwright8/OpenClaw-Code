---
name: benchmark-repositories-evidence-collector
description: Use when tasks require benchmark repositories evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Evidence Collector

## Purpose
Design and execute benchmark repositories workflows using evidence collector controls with validated outcomes.
