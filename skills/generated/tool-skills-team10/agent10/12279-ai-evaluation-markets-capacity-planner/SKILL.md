---
name: ai-evaluation-markets-capacity-planner
description: Use when tasks require ai evaluation markets capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Capacity Planner

## Purpose
Design and execute ai evaluation markets workflows using capacity planner controls with validated outcomes.
