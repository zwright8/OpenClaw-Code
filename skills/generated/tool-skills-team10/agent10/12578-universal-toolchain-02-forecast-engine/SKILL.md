---
name: universal-toolchain-02-forecast-engine
description: Use when tasks require universal toolchain 02 forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Forecast Engine

## Purpose
Design and execute universal toolchain 02 workflows using forecast engine controls with validated outcomes.
