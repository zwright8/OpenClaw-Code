---
name: universal-toolchain-08-permission-mapper
description: Use when tasks require universal toolchain 08 permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Permission Mapper

## Purpose
Design and execute universal toolchain 08 workflows using permission mapper controls with validated outcomes.
