---
name: protocol-management-artifact-publisher
description: Use when tasks require protocol management artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Artifact Publisher

## Purpose
Design and execute protocol management workflows using artifact publisher controls with validated outcomes.
