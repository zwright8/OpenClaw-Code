---
name: consent-management-task-decomposer
description: Use when tasks require consent management task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Task Decomposer

## Purpose
Design and execute consent management workflows using task decomposer controls with validated outcomes.
