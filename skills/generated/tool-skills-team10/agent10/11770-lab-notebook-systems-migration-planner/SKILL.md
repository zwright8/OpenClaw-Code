---
name: lab-notebook-systems-migration-planner
description: Use when tasks require lab notebook systems migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Notebook Systems Migration Planner

## Purpose
Design and execute lab notebook systems workflows using migration planner controls with validated outcomes.
