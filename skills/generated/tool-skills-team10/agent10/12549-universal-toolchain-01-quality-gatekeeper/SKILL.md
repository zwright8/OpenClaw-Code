---
name: universal-toolchain-01-quality-gatekeeper
description: Use when tasks require universal toolchain 01 quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 01 Quality Gatekeeper

## Purpose
Design and execute universal toolchain 01 workflows using quality gatekeeper controls with validated outcomes.
