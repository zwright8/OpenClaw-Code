...
description: Use when tasks require universal toolchain 05 feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Feedback Harvester

## Purpose
Design and execute universal toolchain 05 workflows using feedback harvester controls with validated outcomes.
