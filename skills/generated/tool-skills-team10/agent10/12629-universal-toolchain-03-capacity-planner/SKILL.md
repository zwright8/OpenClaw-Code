---
name: universal-toolchain-03-capacity-planner
description: Use when tasks require universal toolchain 03 capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Capacity Planner

## Purpose
Design and execute universal toolchain 03 workflows using capacity planner controls with validated outcomes.
