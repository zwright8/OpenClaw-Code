---
name: universal-toolchain-10-task-decomposer
description: Use when tasks require universal toolchain 10 task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 10 Task Decomposer

## Purpose
Design and execute universal toolchain 10 workflows using task decomposer controls with validated outcomes.
