---
name: sensitive-data-governance-remediation-planner
description: Use when tasks require sensitive data governance remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Remediation Planner

## Purpose
Design and execute sensitive data governance workflows using remediation planner controls with validated outcomes.
