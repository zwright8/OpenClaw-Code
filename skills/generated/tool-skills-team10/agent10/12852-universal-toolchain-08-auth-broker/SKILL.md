---
name: universal-toolchain-08-auth-broker
description: Use when tasks require universal toolchain 08 auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Auth Broker

## Purpose
Design and execute universal toolchain 08 workflows using auth broker controls with validated outcomes.
