---
name: benchmark-repositories-compliance-mapper
description: Use when tasks require benchmark repositories compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Compliance Mapper

## Purpose
Design and execute benchmark repositories workflows using compliance mapper controls with validated outcomes.
