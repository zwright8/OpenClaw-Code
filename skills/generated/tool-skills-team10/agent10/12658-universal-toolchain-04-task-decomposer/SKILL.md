---
name: universal-toolchain-04-task-decomposer
description: Use when tasks require universal toolchain 04 task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Task Decomposer

## Purpose
Design and execute universal toolchain 04 workflows using task decomposer controls with validated outcomes.
