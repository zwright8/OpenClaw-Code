---
name: service-quality-dependency-resolver
description: Use when tasks require service quality dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Dependency Resolver

## Purpose
Design and execute service quality workflows using dependency resolver controls with validated outcomes.
