---
name: sensitive-data-governance-incident-triage
description: Use when tasks require sensitive data governance incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Incident Triage

## Purpose
Design and execute sensitive data governance workflows using incident triage controls with validated outcomes.
