---
name: universal-toolchain-06-risk-scorer
description: Use when tasks require universal toolchain 06 risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Risk Scorer

## Purpose
Design and execute universal toolchain 06 workflows using risk scorer controls with validated outcomes.
