---
name: universal-toolchain-06-rollback-coordinator
description: Use when tasks require universal toolchain 06 rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Rollback Coordinator

## Purpose
Design and execute universal toolchain 06 workflows using rollback coordinator controls with validated outcomes.
