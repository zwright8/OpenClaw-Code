---
name: universal-toolchain-05-rate-limit-optimizer
description: Use when tasks require universal toolchain 05 rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Rate Limit Optimizer

## Purpose
Design and execute universal toolchain 05 workflows using rate limit optimizer controls with validated outcomes.
