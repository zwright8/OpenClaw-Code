---
name: universal-toolchain-02-root-cause-miner
description: Use when tasks require universal toolchain 02 root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Root Cause Miner

## Purpose
Design and execute universal toolchain 02 workflows using root cause miner controls with validated outcomes.
