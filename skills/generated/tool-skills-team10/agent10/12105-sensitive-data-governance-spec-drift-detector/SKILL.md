---
name: sensitive-data-governance-spec-drift-detector
description: Use when tasks require sensitive data governance spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Spec Drift Detector

## Purpose
Design and execute sensitive data governance workflows using spec drift detector controls with validated outcomes.
