...
description: Use when tasks require universal toolchain 05 anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Anomaly Detector

## Purpose
Design and execute universal toolchain 05 workflows using anomaly detector controls with validated outcomes.
