---
name: consent-management-policy-evaluator
description: Use when tasks require consent management policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Policy Evaluator

## Purpose
Design and execute consent management workflows using policy evaluator controls with validated outcomes.
