---
name: universal-toolchain-08-rollback-coordinator
description: Use when tasks require universal toolchain 08 rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Rollback Coordinator

## Purpose
Design and execute universal toolchain 08 workflows using rollback coordinator controls with validated outcomes.
