---
name: peer-review-ops-spec-drift-detector
description: Use when tasks require peer review ops spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Spec Drift Detector

## Purpose
Design and execute peer review ops workflows using spec drift detector controls with validated outcomes.
