---
name: peer-review-ops-evidence-collector
description: Use when tasks require peer review ops evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Evidence Collector

## Purpose
Design and execute peer review ops workflows using evidence collector controls with validated outcomes.
