---
name: universal-toolchain-02-snapshot-manager
description: Use when tasks require universal toolchain 02 snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Snapshot Manager

## Purpose
Design and execute universal toolchain 02 workflows using snapshot manager controls with validated outcomes.
