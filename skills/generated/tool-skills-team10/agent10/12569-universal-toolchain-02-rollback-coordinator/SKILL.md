---
name: universal-toolchain-02-rollback-coordinator
description: Use when tasks require universal toolchain 02 rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Rollback Coordinator

## Purpose
Design and execute universal toolchain 02 workflows using rollback coordinator controls with validated outcomes.
