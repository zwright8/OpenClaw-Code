---
name: universal-toolchain-08-feedback-harvester
description: Use when tasks require universal toolchain 08 feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Feedback Harvester

## Purpose
Design and execute universal toolchain 08 workflows using feedback harvester controls with validated outcomes.
