---
name: ethics-review-boards-threshold-alerting
description: Use when tasks require ethics review boards threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Threshold Alerting

## Purpose
Design and execute ethics review boards workflows using threshold alerting controls with validated outcomes.
