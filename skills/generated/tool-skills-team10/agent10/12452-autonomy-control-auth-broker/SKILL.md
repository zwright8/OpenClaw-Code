---
name: autonomy-control-auth-broker
description: Use when tasks require autonomy control auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Auth Broker

## Purpose
Design and execute autonomy control workflows using auth broker controls with validated outcomes.
