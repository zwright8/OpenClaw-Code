---
name: protocol-management-approval-orchestrator
description: Use when tasks require protocol management approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Approval Orchestrator

## Purpose
Design and execute protocol management workflows using approval orchestrator controls with validated outcomes.
