---
name: universal-toolchain-05-budget-guardrail
description: Use when tasks require universal toolchain 05 budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Budget Guardrail

## Purpose
Design and execute universal toolchain 05 workflows using budget guardrail controls with validated outcomes.
