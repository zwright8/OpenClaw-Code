---
name: peer-review-ops-compliance-mapper
description: Use when tasks require peer review ops compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Compliance Mapper

## Purpose
Design and execute peer review ops workflows using compliance mapper controls with validated outcomes.
