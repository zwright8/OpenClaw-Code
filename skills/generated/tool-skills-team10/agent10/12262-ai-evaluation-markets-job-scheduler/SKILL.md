---
name: ai-evaluation-markets-job-scheduler
description: Use when tasks require ai evaluation markets job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Job Scheduler

## Purpose
Design and execute ai evaluation markets workflows using job scheduler controls with validated outcomes.
