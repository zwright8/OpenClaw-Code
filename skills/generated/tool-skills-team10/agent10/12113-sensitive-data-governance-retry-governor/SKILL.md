---
name: sensitive-data-governance-retry-governor
description: Use when tasks require sensitive data governance retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Retry Governor

## Purpose
Design and execute sensitive data governance workflows using retry governor controls with validated outcomes.
