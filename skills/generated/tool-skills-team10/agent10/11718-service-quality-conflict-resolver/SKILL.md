---
name: service-quality-conflict-resolver
description: Use when tasks require service quality conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Conflict Resolver

## Purpose
Design and execute service quality workflows using conflict resolver controls with validated outcomes.
