...
description: Use when tasks require ethics review boards approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Approval Orchestrator

## Purpose
Design and execute ethics review boards workflows using approval orchestrator controls with validated outcomes.
