---
name: universal-toolchain-09-postmortem-drafting
description: Use when tasks require universal toolchain 09 postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 09 Postmortem Drafting

## Purpose
Design and execute universal toolchain 09 workflows using postmortem drafting controls with validated outcomes.
