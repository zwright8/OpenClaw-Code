---
name: simulation-environments-anomaly-detector
description: Use when tasks require simulation environments anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Simulation Environments Anomaly Detector

## Purpose
Design and execute simulation environments workflows using anomaly detector controls with validated outcomes.
