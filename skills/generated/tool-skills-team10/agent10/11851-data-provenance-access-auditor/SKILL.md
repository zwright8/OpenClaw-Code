---
name: data-provenance-access-auditor
description: Use when tasks require data provenance access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Access Auditor

## Purpose
Design and execute data provenance workflows using access auditor controls with validated outcomes.
