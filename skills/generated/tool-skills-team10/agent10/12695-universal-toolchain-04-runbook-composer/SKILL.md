---
name: universal-toolchain-04-runbook-composer
description: Use when tasks require universal toolchain 04 runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Runbook Composer

## Purpose
Design and execute universal toolchain 04 workflows using runbook composer controls with validated outcomes.
