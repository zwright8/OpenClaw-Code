---
name: ethics-review-boards-migration-planner
description: Use when tasks require ethics review boards migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Migration Planner

## Purpose
Design and execute ethics review boards workflows using migration planner controls with validated outcomes.
