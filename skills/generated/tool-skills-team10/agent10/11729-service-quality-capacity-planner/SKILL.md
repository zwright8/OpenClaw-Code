---
name: service-quality-capacity-planner
description: Use when tasks require service quality capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Capacity Planner

## Purpose
Design and execute service quality workflows using capacity planner controls with validated outcomes.
