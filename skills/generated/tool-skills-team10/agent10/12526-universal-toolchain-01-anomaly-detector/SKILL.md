---
name: universal-toolchain-01-anomaly-detector
description: Use when tasks require universal toolchain 01 anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 01 Anomaly Detector

## Purpose
Design and execute universal toolchain 01 workflows using anomaly detector controls with validated outcomes.
