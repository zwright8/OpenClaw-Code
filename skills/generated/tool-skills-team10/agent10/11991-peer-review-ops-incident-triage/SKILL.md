---
name: peer-review-ops-incident-triage
description: Use when tasks require peer review ops incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Incident Triage

## Purpose
Design and execute peer review ops workflows using incident triage controls with validated outcomes.
