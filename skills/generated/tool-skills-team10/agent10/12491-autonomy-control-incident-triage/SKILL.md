---
name: autonomy-control-incident-triage
description: Use when tasks require autonomy control incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Incident Triage

## Purpose
Design and execute autonomy control workflows using incident triage controls with validated outcomes.
