---
name: consent-management-runbook-composer
description: Use when tasks require consent management runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Runbook Composer

## Purpose
Design and execute consent management workflows using runbook composer controls with validated outcomes.
