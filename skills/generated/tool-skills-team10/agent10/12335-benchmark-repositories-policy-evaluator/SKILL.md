---
name: benchmark-repositories-policy-evaluator
description: Use when tasks require benchmark repositories policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Policy Evaluator

## Purpose
Design and execute benchmark repositories workflows using policy evaluator controls with validated outcomes.
