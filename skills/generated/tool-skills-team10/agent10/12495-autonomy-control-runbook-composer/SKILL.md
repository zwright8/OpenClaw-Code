---
name: autonomy-control-runbook-composer
description: Use when tasks require autonomy control runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Runbook Composer

## Purpose
Design and execute autonomy control workflows using runbook composer controls with validated outcomes.
