---
name: ai-evaluation-markets-budget-guardrail
description: Use when tasks require ai evaluation markets budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Budget Guardrail

## Purpose
Design and execute ai evaluation markets workflows using budget guardrail controls with validated outcomes.
