---
name: universal-toolchain-03-dependency-resolver
description: Use when tasks require universal toolchain 03 dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Dependency Resolver

## Purpose
Design and execute universal toolchain 03 workflows using dependency resolver controls with validated outcomes.
