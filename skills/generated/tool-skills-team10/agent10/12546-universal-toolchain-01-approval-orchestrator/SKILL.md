---
name: universal-toolchain-01-approval-orchestrator
description: Use when tasks require universal toolchain 01 approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 01 Approval Orchestrator

## Purpose
Design and execute universal toolchain 01 workflows using approval orchestrator controls with validated outcomes.
