---
name: universal-toolchain-04-compliance-mapper
description: Use when tasks require universal toolchain 04 compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Compliance Mapper

## Purpose
Design and execute universal toolchain 04 workflows using compliance mapper controls with validated outcomes.
