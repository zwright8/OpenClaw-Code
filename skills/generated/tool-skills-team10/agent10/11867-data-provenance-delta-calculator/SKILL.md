---
name: data-provenance-delta-calculator
description: Use when tasks require data provenance delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Delta Calculator

## Purpose
Design and execute data provenance workflows using delta calculator controls with validated outcomes.
