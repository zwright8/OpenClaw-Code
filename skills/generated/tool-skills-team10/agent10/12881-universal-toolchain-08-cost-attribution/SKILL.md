---
name: universal-toolchain-08-cost-attribution
description: Use when tasks require universal toolchain 08 cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Cost Attribution

## Purpose
Design and execute universal toolchain 08 workflows using cost attribution controls with validated outcomes.
