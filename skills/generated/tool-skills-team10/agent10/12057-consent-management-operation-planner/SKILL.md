---
name: consent-management-operation-planner
description: Use when tasks require consent management operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Operation Planner

## Purpose
Design and execute consent management workflows using operation planner controls with validated outcomes.
