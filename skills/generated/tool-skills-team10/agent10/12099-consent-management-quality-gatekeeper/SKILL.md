---
name: consent-management-quality-gatekeeper
description: Use when tasks require consent management quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Quality Gatekeeper

## Purpose
Design and execute consent management workflows using quality gatekeeper controls with validated outcomes.
