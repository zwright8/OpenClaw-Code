---
name: audit-trails-human-handoff-router
description: Use when tasks require audit trails human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Human Handoff Router

## Purpose
Design and execute audit trails workflows using human handoff router controls with validated outcomes.
