---
name: ai-evaluation-markets-secret-scanner
description: Use when tasks require ai evaluation markets secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Secret Scanner

## Purpose
Design and execute ai evaluation markets workflows using secret scanner controls with validated outcomes.
