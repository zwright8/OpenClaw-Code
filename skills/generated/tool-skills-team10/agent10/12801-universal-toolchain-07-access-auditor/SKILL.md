---
name: universal-toolchain-07-access-auditor
description: Use when tasks require universal toolchain 07 access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 07 Access Auditor

## Purpose
Design and execute universal toolchain 07 workflows using access auditor controls with validated outcomes.
