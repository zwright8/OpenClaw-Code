---
name: universal-toolchain-08-operation-planner
description: Use when tasks require universal toolchain 08 operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Operation Planner

## Purpose
Design and execute universal toolchain 08 workflows using operation planner controls with validated outcomes.
