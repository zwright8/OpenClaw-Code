---
name: sensitive-data-governance-feedback-harvester
description: Use when tasks require sensitive data governance feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Feedback Harvester

## Purpose
Design and execute sensitive data governance workflows using feedback harvester controls with validated outcomes.
