---
name: sensitive-data-governance-dependency-resolver
description: Use when tasks require sensitive data governance dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Dependency Resolver

## Purpose
Design and execute sensitive data governance workflows using dependency resolver controls with validated outcomes.
