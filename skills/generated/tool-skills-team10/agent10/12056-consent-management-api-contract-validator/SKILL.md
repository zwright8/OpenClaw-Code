---
name: consent-management-api-contract-validator
description: Use when tasks require consent management api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management API Contract Validator

## Purpose
Design and execute consent management workflows using api contract validator controls with validated outcomes.
...
- Domain: [Consent Management](../../resources/domains/consent-management.md)
