---
name: protocol-management-spec-drift-detector
description: Use when tasks require protocol management spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Spec Drift Detector

## Purpose
Design and execute protocol management workflows using spec drift detector controls with validated outcomes.
