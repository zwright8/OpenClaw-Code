---
name: ai-evaluation-markets-execution-runner
description: Use when tasks require ai evaluation markets execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Execution Runner

## Purpose
Design and execute ai evaluation markets workflows using execution runner controls with validated outcomes.
