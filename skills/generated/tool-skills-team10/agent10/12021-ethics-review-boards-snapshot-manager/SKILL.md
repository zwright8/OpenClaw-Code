---
name: ethics-review-boards-snapshot-manager
description: Use when tasks require ethics review boards snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Snapshot Manager

## Purpose
Design and execute ethics review boards workflows using snapshot manager controls with validated outcomes.
