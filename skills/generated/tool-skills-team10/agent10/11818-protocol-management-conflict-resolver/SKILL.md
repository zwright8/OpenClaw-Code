---
name: protocol-management-conflict-resolver
description: Use when tasks require protocol management conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Conflict Resolver

## Purpose
Design and execute protocol management workflows using conflict resolver controls with validated outcomes.
