---
name: data-provenance-anomaly-detector
description: Use when tasks require data provenance anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Anomaly Detector

## Purpose
Design and execute data provenance workflows using anomaly detector controls with validated outcomes.
