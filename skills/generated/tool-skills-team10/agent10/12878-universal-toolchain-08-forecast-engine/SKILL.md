---
name: universal-toolchain-08-forecast-engine
description: Use when tasks require universal toolchain 08 forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Forecast Engine

## Purpose
Design and execute universal toolchain 08 workflows using forecast engine controls with validated outcomes.
