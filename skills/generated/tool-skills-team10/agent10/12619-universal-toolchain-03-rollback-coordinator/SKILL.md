---
name: universal-toolchain-03-rollback-coordinator
description: Use when tasks require universal toolchain 03 rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Rollback Coordinator

## Purpose
Design and execute universal toolchain 03 workflows using rollback coordinator controls with validated outcomes.
