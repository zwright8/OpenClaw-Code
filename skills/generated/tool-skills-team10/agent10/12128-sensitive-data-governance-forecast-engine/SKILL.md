---
name: sensitive-data-governance-forecast-engine
description: Use when tasks require sensitive data governance forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Forecast Engine

## Purpose
Design and execute sensitive data governance workflows using forecast engine controls with validated outcomes.
