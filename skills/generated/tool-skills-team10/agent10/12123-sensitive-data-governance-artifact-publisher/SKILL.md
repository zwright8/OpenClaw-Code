---
name: sensitive-data-governance-artifact-publisher
description: Use when tasks require sensitive data governance artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Artifact Publisher

## Purpose
Design and execute sensitive data governance workflows using artifact publisher controls with validated outcomes.
