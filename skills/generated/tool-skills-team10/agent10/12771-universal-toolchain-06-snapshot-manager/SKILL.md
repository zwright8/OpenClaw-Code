---
name: universal-toolchain-06-snapshot-manager
description: Use when tasks require universal toolchain 06 snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Snapshot Manager

## Purpose
Design and execute universal toolchain 06 workflows using snapshot manager controls with validated outcomes.
