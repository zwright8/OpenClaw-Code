---
name: ethics-review-boards-forecast-engine
description: Use when tasks require ethics review boards forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Forecast Engine

## Purpose
Design and execute ethics review boards workflows using forecast engine controls with validated outcomes.
