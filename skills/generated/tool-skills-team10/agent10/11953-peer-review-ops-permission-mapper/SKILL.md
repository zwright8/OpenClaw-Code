---
name: peer-review-ops-permission-mapper
description: Use when tasks require peer review ops permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Permission Mapper

## Purpose
Design and execute peer review ops workflows using permission mapper controls with validated outcomes.
