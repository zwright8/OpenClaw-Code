...
description: Use when tasks require universal toolchain 06 quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Quality Gatekeeper

## Purpose
Design and execute universal toolchain 06 workflows using quality gatekeeper controls with validated outcomes.
