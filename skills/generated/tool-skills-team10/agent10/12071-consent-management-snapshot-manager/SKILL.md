---
name: consent-management-snapshot-manager
description: Use when tasks require consent management snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Snapshot Manager

## Purpose
Design and execute consent management workflows using snapshot manager controls with validated outcomes.
