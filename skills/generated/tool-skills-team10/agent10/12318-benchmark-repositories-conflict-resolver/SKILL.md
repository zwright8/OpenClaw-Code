---
name: benchmark-repositories-conflict-resolver
description: Use when tasks require benchmark repositories conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Conflict Resolver

## Purpose
Design and execute benchmark repositories workflows using conflict resolver controls with validated outcomes.
