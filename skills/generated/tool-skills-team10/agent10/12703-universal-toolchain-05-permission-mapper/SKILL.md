---
name: universal-toolchain-05-permission-mapper
description: Use when tasks require universal toolchain 05 permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Permission Mapper

## Purpose
Design and execute universal toolchain 05 workflows using permission mapper controls with validated outcomes.
