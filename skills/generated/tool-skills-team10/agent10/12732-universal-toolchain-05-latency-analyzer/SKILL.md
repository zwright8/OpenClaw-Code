---
name: universal-toolchain-05-latency-analyzer
description: Use when tasks require universal toolchain 05 latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Latency Analyzer

## Purpose
Design and execute universal toolchain 05 workflows using latency analyzer controls with validated outcomes.
