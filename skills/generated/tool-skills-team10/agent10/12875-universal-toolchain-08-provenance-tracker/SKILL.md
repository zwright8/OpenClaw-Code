---
name: universal-toolchain-08-provenance-tracker
description: Use when tasks require universal toolchain 08 provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Provenance Tracker

## Purpose
Design and execute universal toolchain 08 workflows using provenance tracker controls with validated outcomes.
