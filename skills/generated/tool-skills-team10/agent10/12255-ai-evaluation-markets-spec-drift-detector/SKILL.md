---
name: ai-evaluation-markets-spec-drift-detector
description: Use when tasks require ai evaluation markets spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Spec Drift Detector

## Purpose
Design and execute ai evaluation markets workflows using spec drift detector controls with validated outcomes.
