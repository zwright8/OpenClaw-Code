...
description: Use when tasks require ethics review boards feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Feedback Harvester

## Purpose
Design and execute ethics review boards workflows using feedback harvester controls with validated outcomes.
