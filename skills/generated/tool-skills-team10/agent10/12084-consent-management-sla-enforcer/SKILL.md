---
name: consent-management-sla-enforcer
description: Use when tasks require consent management sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management SLA Enforcer

## Purpose
Design and execute consent management workflows using sla enforcer controls with validated outcomes.
