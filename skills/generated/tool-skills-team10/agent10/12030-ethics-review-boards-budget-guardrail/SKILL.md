---
name: ethics-review-boards-budget-guardrail
description: Use when tasks require ethics review boards budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Budget Guardrail

## Purpose
Design and execute ethics review boards workflows using budget guardrail controls with validated outcomes.
