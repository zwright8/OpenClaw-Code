---
name: universal-toolchain-01-rollback-coordinator
description: Use when tasks require universal toolchain 01 rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 01 Rollback Coordinator

## Purpose
Design and execute universal toolchain 01 workflows using rollback coordinator controls with validated outcomes.
