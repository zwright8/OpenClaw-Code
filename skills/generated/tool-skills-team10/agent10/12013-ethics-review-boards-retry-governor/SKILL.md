---
name: ethics-review-boards-retry-governor
description: Use when tasks require ethics review boards retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Retry Governor

## Purpose
Design and execute ethics review boards workflows using retry governor controls with validated outcomes.
