---
name: benchmark-repositories-runbook-composer
description: Use when tasks require benchmark repositories runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Runbook Composer

## Purpose
Design and execute benchmark repositories workflows using runbook composer controls with validated outcomes.
