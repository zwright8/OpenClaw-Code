---
name: data-provenance-task-decomposer
description: Use when tasks require data provenance task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Task Decomposer

## Purpose
Design and execute data provenance workflows using task decomposer controls with validated outcomes.
