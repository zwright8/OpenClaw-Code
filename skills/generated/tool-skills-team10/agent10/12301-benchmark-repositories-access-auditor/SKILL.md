---
name: benchmark-repositories-access-auditor
description: Use when tasks require benchmark repositories access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Access Auditor

## Purpose
Design and execute benchmark repositories workflows using access auditor controls with validated outcomes.
