---
name: consent-management-provenance-tracker
description: Use when tasks require consent management provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Provenance Tracker

## Purpose
Design and execute consent management workflows using provenance tracker controls with validated outcomes.
