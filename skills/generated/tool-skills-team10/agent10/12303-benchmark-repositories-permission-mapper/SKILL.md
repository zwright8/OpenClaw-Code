---
name: benchmark-repositories-permission-mapper
description: Use when tasks require benchmark repositories permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Permission Mapper

## Purpose
Design and execute benchmark repositories workflows using permission mapper controls with validated outcomes.
