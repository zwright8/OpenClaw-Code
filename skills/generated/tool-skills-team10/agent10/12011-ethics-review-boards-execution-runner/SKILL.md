...
description: Use when tasks require ethics review boards execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Execution Runner

## Purpose
Design and execute ethics review boards workflows using execution runner controls with validated outcomes.
