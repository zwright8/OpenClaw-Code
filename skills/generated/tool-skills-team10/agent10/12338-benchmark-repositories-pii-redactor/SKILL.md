---
name: benchmark-repositories-pii-redactor
description: Use when tasks require benchmark repositories pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories PII Redactor

## Purpose
Design and execute benchmark repositories workflows using pii redactor controls with validated outcomes.
