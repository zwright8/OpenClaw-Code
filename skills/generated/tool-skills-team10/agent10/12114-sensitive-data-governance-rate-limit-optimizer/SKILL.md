---
name: sensitive-data-governance-rate-limit-optimizer
description: Use when tasks require sensitive data governance rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Rate Limit Optimizer

## Purpose
Design and execute sensitive data governance workflows using rate limit optimizer controls with validated outcomes.
