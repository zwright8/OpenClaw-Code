---
name: service-quality-execution-runner
description: Use when tasks require service quality execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Execution Runner

## Purpose
Design and execute service quality workflows using execution runner controls with validated outcomes.
