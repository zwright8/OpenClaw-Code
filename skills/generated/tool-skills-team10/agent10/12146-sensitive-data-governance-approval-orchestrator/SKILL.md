---
name: sensitive-data-governance-approval-orchestrator
description: Use when tasks require sensitive data governance approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Approval Orchestrator

## Purpose
Design and execute sensitive data governance workflows using approval orchestrator controls with validated outcomes.
