---
name: audit-trails-operation-planner
description: Use when tasks require audit trails operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Operation Planner

## Purpose
Design and execute audit trails workflows using operation planner controls with validated outcomes.
