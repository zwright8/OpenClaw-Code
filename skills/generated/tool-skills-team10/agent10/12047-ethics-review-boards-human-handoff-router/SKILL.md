---
name: ethics-review-boards-human-handoff-router
description: Use when tasks require ethics review boards human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Human Handoff Router

## Purpose
Design and execute ethics review boards workflows using human handoff router controls with validated outcomes.
