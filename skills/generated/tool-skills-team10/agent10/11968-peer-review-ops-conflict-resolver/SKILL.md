---
name: peer-review-ops-conflict-resolver
description: Use when tasks require peer review ops conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Conflict Resolver

## Purpose
Design and execute peer review ops workflows using conflict resolver controls with validated outcomes.
