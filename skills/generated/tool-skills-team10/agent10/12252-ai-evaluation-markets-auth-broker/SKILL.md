---
name: ai-evaluation-markets-auth-broker
description: Use when tasks require ai evaluation markets auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Auth Broker

## Purpose
Design and execute ai evaluation markets workflows using auth broker controls with validated outcomes.
