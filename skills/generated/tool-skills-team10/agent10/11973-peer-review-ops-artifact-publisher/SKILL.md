---
name: peer-review-ops-artifact-publisher
description: Use when tasks require peer review ops artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Artifact Publisher

## Purpose
Design and execute peer review ops workflows using artifact publisher controls with validated outcomes.
