---
name: sensitive-data-governance-quality-gatekeeper
description: Use when tasks require sensitive data governance quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Quality Gatekeeper

## Purpose
Design and execute sensitive data governance workflows using quality gatekeeper controls with validated outcomes.
