---
name: benchmark-repositories-auth-broker
description: Use when tasks require benchmark repositories auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Auth Broker

## Purpose
Design and execute benchmark repositories workflows using auth broker controls with validated outcomes.
