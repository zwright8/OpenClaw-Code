---
name: universal-toolchain-08-risk-scorer
description: Use when tasks require universal toolchain 08 risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Risk Scorer

## Purpose
Design and execute universal toolchain 08 workflows using risk scorer controls with validated outcomes.
