---
name: data-provenance-schema-introspector
description: Use when tasks require data provenance schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Schema Introspector

## Purpose
Design and execute data provenance workflows using schema introspector controls with validated outcomes.
