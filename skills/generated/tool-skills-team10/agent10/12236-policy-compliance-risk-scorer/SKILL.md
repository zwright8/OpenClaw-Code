---
name: policy-compliance-risk-scorer
description: Use when tasks require policy compliance risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Compliance Risk Scorer

## Purpose
Design and execute policy compliance workflows using risk scorer controls with validated outcomes.
