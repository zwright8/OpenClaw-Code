---
name: ethics-review-boards-permission-mapper
description: Use when tasks require ethics review boards permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Permission Mapper

## Purpose
Design and execute ethics review boards workflows using permission mapper controls with validated outcomes.
