---
name: peer-review-ops-execution-runner
description: Use when tasks require peer review ops execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Execution Runner

## Purpose
Design and execute peer review ops workflows using execution runner controls with validated outcomes.
