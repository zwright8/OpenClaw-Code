---
name: audit-trails-task-decomposer
description: Use when tasks require audit trails task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Task Decomposer

## Purpose
Design and execute audit trails workflows using task decomposer controls with validated outcomes.
