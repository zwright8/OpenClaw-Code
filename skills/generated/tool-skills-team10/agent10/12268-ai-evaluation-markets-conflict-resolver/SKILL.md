---
name: ai-evaluation-markets-conflict-resolver
description: Use when tasks require ai evaluation markets conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Conflict Resolver

## Purpose
Design and execute ai evaluation markets workflows using conflict resolver controls with validated outcomes.
