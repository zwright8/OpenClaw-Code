---
name: peer-review-ops-snapshot-manager
description: Use when tasks require peer review ops snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Snapshot Manager

## Purpose
Design and execute peer review ops workflows using snapshot manager controls with validated outcomes.
