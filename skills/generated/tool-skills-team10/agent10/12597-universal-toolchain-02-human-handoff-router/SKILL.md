---
name: universal-toolchain-02-human-handoff-router
description: Use when tasks require universal toolchain 02 human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Human Handoff Router

## Purpose
Design and execute universal toolchain 02 workflows using human handoff router controls with validated outcomes.
