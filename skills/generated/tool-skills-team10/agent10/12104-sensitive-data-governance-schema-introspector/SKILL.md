---
name: sensitive-data-governance-schema-introspector
description: Use when tasks require sensitive data governance schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Schema Introspector

## Purpose
Design and execute sensitive data governance workflows using schema introspector controls with validated outcomes.
