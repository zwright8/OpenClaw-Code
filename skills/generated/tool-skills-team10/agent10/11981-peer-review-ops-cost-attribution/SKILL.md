---
name: peer-review-ops-cost-attribution
description: Use when tasks require peer review ops cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Cost Attribution

## Purpose
Design and execute peer review ops workflows using cost attribution controls with validated outcomes.
