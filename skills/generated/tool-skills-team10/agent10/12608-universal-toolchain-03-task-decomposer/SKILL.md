---
name: universal-toolchain-03-task-decomposer
description: Use when tasks require universal toolchain 03 task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Task Decomposer

## Purpose
Design and execute universal toolchain 03 workflows using task decomposer controls with validated outcomes.
