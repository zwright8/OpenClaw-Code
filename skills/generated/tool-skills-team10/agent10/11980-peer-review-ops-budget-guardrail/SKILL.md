---
name: peer-review-ops-budget-guardrail
description: Use when tasks require peer review ops budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Budget Guardrail

## Purpose
Design and execute peer review ops workflows using budget guardrail controls with validated outcomes.
