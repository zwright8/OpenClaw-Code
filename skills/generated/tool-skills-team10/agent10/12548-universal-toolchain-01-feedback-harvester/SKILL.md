---
name: universal-toolchain-01-feedback-harvester
description: Use when tasks require universal toolchain 01 feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 01 Feedback Harvester

## Purpose
Design and execute universal toolchain 01 workflows using feedback harvester controls with validated outcomes.
