---
name: benchmark-repositories-risk-scorer
description: Use when tasks require benchmark repositories risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Risk Scorer

## Purpose
Design and execute benchmark repositories workflows using risk scorer controls with validated outcomes.
