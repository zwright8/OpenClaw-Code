---
name: consent-management-retry-governor
description: Use when tasks require consent management retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Retry Governor

## Purpose
Design and execute consent management workflows using retry governor controls with validated outcomes.
