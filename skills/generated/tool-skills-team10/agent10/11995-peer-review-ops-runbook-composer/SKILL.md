---
name: peer-review-ops-runbook-composer
description: Use when tasks require peer review ops runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Runbook Composer

## Purpose
Design and execute peer review ops workflows using runbook composer controls with validated outcomes.
