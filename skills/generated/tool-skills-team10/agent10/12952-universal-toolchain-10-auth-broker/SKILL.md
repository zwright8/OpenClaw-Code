---
name: universal-toolchain-10-auth-broker
description: Use when tasks require universal toolchain 10 auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 10 Auth Broker

## Purpose
Design and execute universal toolchain 10 workflows using auth broker controls with validated outcomes.
