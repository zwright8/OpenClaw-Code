---
name: protocol-management-feedback-harvester
description: Use when tasks require protocol management feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Feedback Harvester

## Purpose
Design and execute protocol management workflows using feedback harvester controls with validated outcomes.
