---
name: autonomy-control-remediation-planner
description: Use when tasks require autonomy control remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Remediation Planner

## Purpose
Design and execute autonomy control workflows using remediation planner controls with validated outcomes.
