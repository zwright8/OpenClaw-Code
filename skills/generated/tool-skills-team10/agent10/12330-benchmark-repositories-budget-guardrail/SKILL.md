---
name: benchmark-repositories-budget-guardrail
description: Use when tasks require benchmark repositories budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Budget Guardrail

## Purpose
Design and execute benchmark repositories workflows using budget guardrail controls with validated outcomes.
