---
name: ethics-review-boards-rollback-coordinator
description: Use when tasks require ethics review boards rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Rollback Coordinator

## Purpose
Design and execute ethics review boards workflows using rollback coordinator controls with validated outcomes.
