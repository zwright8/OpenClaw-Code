---
name: audit-trails-approval-orchestrator
description: Use when tasks require audit trails approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Approval Orchestrator

## Purpose
Design and execute audit trails workflows using approval orchestrator controls with validated outcomes.
