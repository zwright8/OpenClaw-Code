---
name: autonomy-control-task-decomposer
description: Use when tasks require autonomy control task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Task Decomposer

## Purpose
Design and execute autonomy control workflows using task decomposer controls with validated outcomes.
