---
name: audit-trails-workflow-compiler
description: Use when tasks require audit trails workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Workflow Compiler

## Purpose
Design and execute audit trails workflows using workflow compiler controls with validated outcomes.
