---
name: audit-trails-secret-scanner
description: Use when tasks require audit trails secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Secret Scanner

## Purpose
Design and execute audit trails workflows using secret scanner controls with validated outcomes.
