---
name: universal-toolchain-06-task-decomposer
description: Use when tasks require universal toolchain 06 task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Task Decomposer

## Purpose
Design and execute universal toolchain 06 workflows using task decomposer controls with validated outcomes.
