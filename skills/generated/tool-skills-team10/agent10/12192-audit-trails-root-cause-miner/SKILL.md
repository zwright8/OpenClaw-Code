---
name: audit-trails-root-cause-miner
description: Use when tasks require audit trails root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Root Cause Miner

## Purpose
Design and execute audit trails workflows using root cause miner controls with validated outcomes.
