---
name: audit-trails-rate-limit-optimizer
description: Use when tasks require audit trails rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Rate Limit Optimizer

## Purpose
Design and execute audit trails workflows using rate limit optimizer controls with validated outcomes.
