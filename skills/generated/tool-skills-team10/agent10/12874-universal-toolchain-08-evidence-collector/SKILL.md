---
name: universal-toolchain-08-evidence-collector
description: Use when tasks require universal toolchain 08 evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Evidence Collector

## Purpose
Design and execute universal toolchain 08 workflows using evidence collector controls with validated outcomes.
