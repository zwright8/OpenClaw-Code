---
name: ai-evaluation-markets-migration-planner
description: Use when tasks require ai evaluation markets migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Migration Planner

## Purpose
Design and execute ai evaluation markets workflows using migration planner controls with validated outcomes.
