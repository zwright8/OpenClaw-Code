---
name: benchmark-repositories-postmortem-drafting
description: Use when tasks require benchmark repositories postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Postmortem Drafting

## Purpose
Design and execute benchmark repositories workflows using postmortem drafting controls with validated outcomes.
