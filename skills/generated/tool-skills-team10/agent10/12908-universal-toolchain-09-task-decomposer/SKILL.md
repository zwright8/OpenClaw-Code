---
name: universal-toolchain-09-task-decomposer
description: Use when tasks require universal toolchain 09 task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 09 Task Decomposer

## Purpose
Design and execute universal toolchain 09 workflows using task decomposer controls with validated outcomes.
