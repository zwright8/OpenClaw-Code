---
name: universal-toolchain-08-task-decomposer
description: Use when tasks require universal toolchain 08 task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Task Decomposer

## Purpose
Design and execute universal toolchain 08 workflows using task decomposer controls with validated outcomes.
