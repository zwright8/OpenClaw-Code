---
name: universal-toolchain-06-auth-broker
description: Use when tasks require universal toolchain 06 auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Auth Broker

## Purpose
Design and execute universal toolchain 06 workflows using auth broker controls with validated outcomes.
