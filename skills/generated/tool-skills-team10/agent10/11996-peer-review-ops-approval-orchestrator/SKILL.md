---
name: peer-review-ops-approval-orchestrator
description: Use when tasks require peer review ops approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Approval Orchestrator

## Purpose
Design and execute peer review ops workflows using approval orchestrator controls with validated outcomes.
