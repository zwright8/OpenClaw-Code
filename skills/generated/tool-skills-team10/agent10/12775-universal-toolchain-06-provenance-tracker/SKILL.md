---
name: universal-toolchain-06-provenance-tracker
description: Use when tasks require universal toolchain 06 provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Provenance Tracker

## Purpose
Design and execute universal toolchain 06 workflows using provenance tracker controls with validated outcomes.
