---
name: audit-trails-execution-runner
description: Use when tasks require audit trails execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Execution Runner

## Purpose
Design and execute audit trails workflows using execution runner controls with validated outcomes.
