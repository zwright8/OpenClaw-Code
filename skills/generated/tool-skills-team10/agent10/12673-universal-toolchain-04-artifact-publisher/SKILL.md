---
name: universal-toolchain-04-artifact-publisher
description: Use when tasks require universal toolchain 04 artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Artifact Publisher

## Purpose
Design and execute universal toolchain 04 workflows using artifact publisher controls with validated outcomes.
