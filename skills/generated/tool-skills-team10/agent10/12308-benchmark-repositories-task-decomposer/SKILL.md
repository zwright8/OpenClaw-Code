---
name: benchmark-repositories-task-decomposer
description: Use when tasks require benchmark repositories task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Task Decomposer

## Purpose
Design and execute benchmark repositories workflows using task decomposer controls with validated outcomes.
