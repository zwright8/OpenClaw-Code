---
name: autonomy-control-root-cause-miner
description: Use when tasks require autonomy control root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Root Cause Miner

## Purpose
Design and execute autonomy control workflows using root cause miner controls with validated outcomes.
