---
name: audit-trails-spec-drift-detector
description: Use when tasks require audit trails spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Spec Drift Detector

## Purpose
Design and execute audit trails workflows using spec drift detector controls with validated outcomes.
