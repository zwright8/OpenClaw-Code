---
name: lab-notebook-systems-secret-scanner
description: Use when tasks require lab notebook systems secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Notebook Systems Secret Scanner

## Purpose
Design and execute lab notebook systems workflows using secret scanner controls with validated outcomes.
