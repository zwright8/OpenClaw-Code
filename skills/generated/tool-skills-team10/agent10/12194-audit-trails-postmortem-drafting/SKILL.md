---
name: audit-trails-postmortem-drafting
description: Use when tasks require audit trails postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Postmortem Drafting

## Purpose
Design and execute audit trails workflows using postmortem drafting controls with validated outcomes.
