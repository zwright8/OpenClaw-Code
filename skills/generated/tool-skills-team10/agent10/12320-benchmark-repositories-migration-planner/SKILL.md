---
name: benchmark-repositories-migration-planner
description: Use when tasks require benchmark repositories migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Migration Planner

## Purpose
Design and execute benchmark repositories workflows using migration planner controls with validated outcomes.
