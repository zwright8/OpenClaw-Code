---
name: consent-management-pii-redactor
description: Use when tasks require consent management pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management PII Redactor

## Purpose
Design and execute consent management workflows using pii redactor controls with validated outcomes.
