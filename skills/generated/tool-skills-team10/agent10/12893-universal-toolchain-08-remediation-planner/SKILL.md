---
name: universal-toolchain-08-remediation-planner
description: Use when tasks require universal toolchain 08 remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Remediation Planner

## Purpose
Design and execute universal toolchain 08 workflows using remediation planner controls with validated outcomes.
