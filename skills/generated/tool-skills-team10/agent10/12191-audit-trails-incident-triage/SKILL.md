---
name: audit-trails-incident-triage
description: Use when tasks require audit trails incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Incident Triage

## Purpose
Design and execute audit trails workflows using incident triage controls with validated outcomes.
