---
name: ethics-review-boards-incident-triage
description: Use when tasks require ethics review boards incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Incident Triage

## Purpose
Design and execute ethics review boards workflows using incident triage controls with validated outcomes.
