...
description: Use when tasks require universal toolchain 05 remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Remediation Planner

## Purpose
Design and execute universal toolchain 05 workflows using remediation planner controls with validated outcomes.
