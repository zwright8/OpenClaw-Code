---
name: universal-toolchain-03-approval-orchestrator
description: Use when tasks require universal toolchain 03 approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Approval Orchestrator

## Purpose
Design and execute universal toolchain 03 workflows using approval orchestrator controls with validated outcomes.
