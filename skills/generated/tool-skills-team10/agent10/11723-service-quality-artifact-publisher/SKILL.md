---
name: service-quality-artifact-publisher
description: Use when tasks require service quality artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Artifact Publisher

## Purpose
Design and execute service quality workflows using artifact publisher controls with validated outcomes.
