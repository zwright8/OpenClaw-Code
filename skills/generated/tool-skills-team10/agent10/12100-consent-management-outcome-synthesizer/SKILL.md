---
name: consent-management-outcome-synthesizer
description: Use when tasks require consent management outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Outcome Synthesizer

## Purpose
Design and execute consent management workflows using outcome synthesizer controls with validated outcomes.
