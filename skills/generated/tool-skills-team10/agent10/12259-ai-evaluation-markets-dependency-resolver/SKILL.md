---
name: ai-evaluation-markets-dependency-resolver
description: Use when tasks require ai evaluation markets dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Dependency Resolver

## Purpose
Design and execute ai evaluation markets workflows using dependency resolver controls with validated outcomes.
