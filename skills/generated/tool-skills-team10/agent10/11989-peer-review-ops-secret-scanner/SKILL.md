---
name: peer-review-ops-secret-scanner
description: Use when tasks require peer review ops secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Secret Scanner

## Purpose
Design and execute peer review ops workflows using secret scanner controls with validated outcomes.
