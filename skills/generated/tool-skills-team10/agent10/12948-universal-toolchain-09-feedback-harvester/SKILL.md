---
name: universal-toolchain-09-feedback-harvester
description: Use when tasks require universal toolchain 09 feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 09 Feedback Harvester

## Purpose
Design and execute universal toolchain 09 workflows using feedback harvester controls with validated outcomes.
