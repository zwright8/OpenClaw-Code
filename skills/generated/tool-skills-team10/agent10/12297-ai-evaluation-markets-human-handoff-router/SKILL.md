---
name: ai-evaluation-markets-human-handoff-router
description: Use when tasks require ai evaluation markets human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Human Handoff Router

## Purpose
Design and execute ai evaluation markets workflows using human handoff router controls with validated outcomes.
