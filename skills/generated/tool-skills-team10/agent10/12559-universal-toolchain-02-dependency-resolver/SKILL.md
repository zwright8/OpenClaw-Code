---
name: universal-toolchain-02-dependency-resolver
description: Use when tasks require universal toolchain 02 dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Dependency Resolver

## Purpose
Design and execute universal toolchain 02 workflows using dependency resolver controls with validated outcomes.
