---
name: sensitive-data-governance-auth-broker
description: Use when tasks require sensitive data governance auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Auth Broker

## Purpose
Design and execute sensitive data governance workflows using auth broker controls with validated outcomes.
