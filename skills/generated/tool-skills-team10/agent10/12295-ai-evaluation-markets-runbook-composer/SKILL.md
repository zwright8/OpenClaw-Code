---
name: ai-evaluation-markets-runbook-composer
description: Use when tasks require ai evaluation markets runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Runbook Composer

## Purpose
Design and execute ai evaluation markets workflows using runbook composer controls with validated outcomes.
