---
name: universal-toolchain-02-artifact-publisher
description: Use when tasks require universal toolchain 02 artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Artifact Publisher

## Purpose
Design and execute universal toolchain 02 workflows using artifact publisher controls with validated outcomes.
