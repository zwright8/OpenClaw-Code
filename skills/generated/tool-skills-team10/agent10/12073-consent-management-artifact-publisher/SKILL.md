---
name: consent-management-artifact-publisher
description: Use when tasks require consent management artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Artifact Publisher

## Purpose
Design and execute consent management workflows using artifact publisher controls with validated outcomes.
