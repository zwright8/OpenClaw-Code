---
name: ethics-review-boards-auth-broker
description: Use when tasks require ethics review boards auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Auth Broker

## Purpose
Design and execute ethics review boards workflows using auth broker controls with validated outcomes.
