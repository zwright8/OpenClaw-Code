---
name: consent-management-remediation-planner
description: Use when tasks require consent management remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Remediation Planner

## Purpose
Design and execute consent management workflows using remediation planner controls with validated outcomes.
