---
name: simulation-environments-dependency-resolver
description: Use when tasks require simulation environments dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Simulation Environments Dependency Resolver

## Purpose
Design and execute simulation environments workflows using dependency resolver controls with validated outcomes.
