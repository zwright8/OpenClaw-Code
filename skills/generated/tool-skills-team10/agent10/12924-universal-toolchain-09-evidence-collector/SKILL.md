---
name: universal-toolchain-09-evidence-collector
description: Use when tasks require universal toolchain 09 evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 09 Evidence Collector

## Purpose
Design and execute universal toolchain 09 workflows using evidence collector controls with validated outcomes.
