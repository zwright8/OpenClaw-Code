---
name: benchmark-repositories-operation-planner
description: Use when tasks require benchmark repositories operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Operation Planner

## Purpose
Design and execute benchmark repositories workflows using operation planner controls with validated outcomes.
