---
name: universal-toolchain-04-budget-guardrail
description: Use when tasks require universal toolchain 04 budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Budget Guardrail

## Purpose
Design and execute universal toolchain 04 workflows using budget guardrail controls with validated outcomes.
