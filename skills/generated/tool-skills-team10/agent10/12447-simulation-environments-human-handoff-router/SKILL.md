---
name: simulation-environments-human-handoff-router
description: Use when tasks require simulation environments human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Simulation Environments Human Handoff Router

## Purpose
Design and execute simulation environments workflows using human handoff router controls with validated outcomes.
