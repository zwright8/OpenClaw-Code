---
name: universal-toolchain-02-postmortem-drafting
description: Use when tasks require universal toolchain 02 postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Postmortem Drafting

## Purpose
Design and execute universal toolchain 02 workflows using postmortem drafting controls with validated outcomes.
