---
name: audit-trails-auth-broker
description: Use when tasks require audit trails auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Auth Broker

## Purpose
Design and execute audit trails workflows using auth broker controls with validated outcomes.
