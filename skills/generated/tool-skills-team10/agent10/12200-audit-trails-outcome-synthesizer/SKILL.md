---
name: audit-trails-outcome-synthesizer
description: Use when tasks require audit trails outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Outcome Synthesizer

## Purpose
Design and execute audit trails workflows using outcome synthesizer controls with validated outcomes.
