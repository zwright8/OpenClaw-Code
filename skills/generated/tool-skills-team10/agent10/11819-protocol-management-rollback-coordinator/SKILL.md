---
name: protocol-management-rollback-coordinator
description: Use when tasks require protocol management rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Rollback Coordinator

## Purpose
Design and execute protocol management workflows using rollback coordinator controls with validated outcomes.
