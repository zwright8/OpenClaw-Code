---
name: peer-review-ops-anomaly-detector
description: Use when tasks require peer review ops anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Anomaly Detector

## Purpose
Design and execute peer review ops workflows using anomaly detector controls with validated outcomes.
