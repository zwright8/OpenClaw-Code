---
name: universal-toolchain-10-secret-scanner
description: Use when tasks require universal toolchain 10 secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 10 Secret Scanner

## Purpose
Design and execute universal toolchain 10 workflows using secret scanner controls with validated outcomes.
