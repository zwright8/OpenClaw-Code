---
name: universal-toolchain-07-rollback-coordinator
description: Use when tasks require universal toolchain 07 rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 07 Rollback Coordinator

## Purpose
Design and execute universal toolchain 07 workflows using rollback coordinator controls with validated outcomes.
