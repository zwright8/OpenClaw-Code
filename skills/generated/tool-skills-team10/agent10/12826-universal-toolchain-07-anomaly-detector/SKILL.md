...
description: Use when tasks require universal toolchain 07 anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 07 Anomaly Detector

## Purpose
Design and execute universal toolchain 07 workflows using anomaly detector controls with validated outcomes.
