---
name: ai-evaluation-markets-provenance-tracker
description: Use when tasks require ai evaluation markets provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Provenance Tracker

## Purpose
Design and execute ai evaluation markets workflows using provenance tracker controls with validated outcomes.
