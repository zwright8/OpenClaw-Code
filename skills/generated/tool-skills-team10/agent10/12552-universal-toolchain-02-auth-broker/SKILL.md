---
name: universal-toolchain-02-auth-broker
description: Use when tasks require universal toolchain 02 auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Auth Broker

## Purpose
Design and execute universal toolchain 02 workflows using auth broker controls with validated outcomes.
