---
name: ethics-review-boards-api-contract-validator
description: Use when tasks require ethics review boards api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards API Contract Validator

## Purpose
Design and execute ethics review boards workflows using api contract validator controls with validated outcomes.
