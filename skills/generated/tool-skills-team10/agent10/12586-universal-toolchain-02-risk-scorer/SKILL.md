---
name: universal-toolchain-02-risk-scorer
description: Use when tasks require universal toolchain 02 risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Risk Scorer

## Purpose
Design and execute universal toolchain 02 workflows using risk scorer controls with validated outcomes.
