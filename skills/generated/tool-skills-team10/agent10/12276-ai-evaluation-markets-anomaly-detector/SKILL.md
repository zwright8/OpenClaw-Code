---
name: ai-evaluation-markets-anomaly-detector
description: Use when tasks require ai evaluation markets anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Anomaly Detector

## Purpose
Design and execute ai evaluation markets workflows using anomaly detector controls with validated outcomes.
