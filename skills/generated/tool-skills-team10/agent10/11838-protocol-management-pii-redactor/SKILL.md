---
name: protocol-management-pii-redactor
description: Use when tasks require protocol management pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management PII Redactor

## Purpose
Design and execute protocol management workflows using pii redactor controls with validated outcomes.
