---
name: sensitive-data-governance-human-handoff-router
description: Use when tasks require sensitive data governance human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Human Handoff Router

## Purpose
Design and execute sensitive data governance workflows using human handoff router controls with validated outcomes.
