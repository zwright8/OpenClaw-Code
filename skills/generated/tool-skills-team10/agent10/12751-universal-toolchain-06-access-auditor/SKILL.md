---
name: universal-toolchain-06-access-auditor
description: Use when tasks require universal toolchain 06 access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Access Auditor

## Purpose
Design and execute universal toolchain 06 workflows using access auditor controls with validated outcomes.
