---
name: ethics-review-boards-reliability-scorer
description: Use when tasks require ethics review boards reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Reliability Scorer

## Purpose
Design and execute ethics review boards workflows using reliability scorer controls with validated outcomes.
