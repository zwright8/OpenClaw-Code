---
name: universal-toolchain-04-snapshot-manager
description: Use when tasks require universal toolchain 04 snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Snapshot Manager

## Purpose
Design and execute universal toolchain 04 workflows using snapshot manager controls with validated outcomes.
