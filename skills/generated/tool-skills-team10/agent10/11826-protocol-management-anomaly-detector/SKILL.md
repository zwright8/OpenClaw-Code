---
name: protocol-management-anomaly-detector
description: Use when tasks require protocol management anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Anomaly Detector

## Purpose
Design and execute protocol management workflows using anomaly detector controls with validated outcomes.
