---
name: autonomy-control-risk-scorer
description: Use when tasks require autonomy control risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Risk Scorer

## Purpose
Design and execute autonomy control workflows using risk scorer controls with validated outcomes.
