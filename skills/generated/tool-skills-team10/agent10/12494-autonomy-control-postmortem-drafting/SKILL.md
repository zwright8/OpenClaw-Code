---
name: autonomy-control-postmortem-drafting
description: Use when tasks require autonomy control postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Postmortem Drafting

## Purpose
Design and execute autonomy control workflows using postmortem drafting controls with validated outcomes.
