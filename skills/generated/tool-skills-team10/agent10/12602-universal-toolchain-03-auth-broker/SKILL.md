---
name: universal-toolchain-03-auth-broker
description: Use when tasks require universal toolchain 03 auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Auth Broker

## Purpose
Design and execute universal toolchain 03 workflows using auth broker controls with validated outcomes.
