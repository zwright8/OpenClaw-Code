---
name: autonomy-control-state-reconciler
description: Use when tasks require autonomy control state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control State Reconciler

## Purpose
Design and execute autonomy control workflows using state reconciler controls with validated outcomes.
