---
name: sensitive-data-governance-root-cause-miner
description: Use when tasks require sensitive data governance root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Root Cause Miner

## Purpose
Design and execute sensitive data governance workflows using root cause miner controls with validated outcomes.
