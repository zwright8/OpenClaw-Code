---
name: sensitive-data-governance-capacity-planner
description: Use when tasks require sensitive data governance capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Capacity Planner

## Purpose
Design and execute sensitive data governance workflows using capacity planner controls with validated outcomes.
