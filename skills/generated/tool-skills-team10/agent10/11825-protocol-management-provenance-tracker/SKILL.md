---
name: protocol-management-provenance-tracker
description: Use when tasks require protocol management provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Provenance Tracker

## Purpose
Design and execute protocol management workflows using provenance tracker controls with validated outcomes.
