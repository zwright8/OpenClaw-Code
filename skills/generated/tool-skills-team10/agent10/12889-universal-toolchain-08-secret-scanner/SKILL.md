---
name: universal-toolchain-08-secret-scanner
description: Use when tasks require universal toolchain 08 secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Secret Scanner

## Purpose
Design and execute universal toolchain 08 workflows using secret scanner controls with validated outcomes.
