---
name: autonomy-control-policy-evaluator
description: Use when tasks require autonomy control policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Policy Evaluator

## Purpose
Design and execute autonomy control workflows using policy evaluator controls with validated outcomes.
