---
name: synthetic-data-platforms-secret-scanner
description: Use when tasks require synthetic data platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Synthetic Data Platforms Secret Scanner

## Purpose
Design and execute synthetic data platforms workflows using secret scanner controls with validated outcomes.
