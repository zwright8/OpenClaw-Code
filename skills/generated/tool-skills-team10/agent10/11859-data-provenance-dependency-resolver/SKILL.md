---
name: data-provenance-dependency-resolver
description: Use when tasks require data provenance dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Dependency Resolver

## Purpose
Design and execute data provenance workflows using dependency resolver controls with validated outcomes.
