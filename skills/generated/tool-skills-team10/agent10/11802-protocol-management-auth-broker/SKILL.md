---
name: protocol-management-auth-broker
description: Use when tasks require protocol management auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Auth Broker

## Purpose
Design and execute protocol management workflows using auth broker controls with validated outcomes.
