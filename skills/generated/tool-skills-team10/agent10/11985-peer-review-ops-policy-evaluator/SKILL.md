---
name: peer-review-ops-policy-evaluator
description: Use when tasks require peer review ops policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Policy Evaluator

## Purpose
Design and execute peer review ops workflows using policy evaluator controls with validated outcomes.
