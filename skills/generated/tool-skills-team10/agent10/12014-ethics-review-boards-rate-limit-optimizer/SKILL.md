---
name: ethics-review-boards-rate-limit-optimizer
description: Use when tasks require ethics review boards rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Rate Limit Optimizer

## Purpose
Design and execute ethics review boards workflows using rate limit optimizer controls with validated outcomes.
