---
name: service-quality-permission-mapper
description: Use when tasks require service quality permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Permission Mapper

## Purpose
Design and execute service quality workflows using permission mapper controls with validated outcomes.
