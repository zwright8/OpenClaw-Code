---
name: consent-management-root-cause-miner
description: Use when tasks require consent management root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Root Cause Miner

## Purpose
Design and execute consent management workflows using root cause miner controls with validated outcomes.
