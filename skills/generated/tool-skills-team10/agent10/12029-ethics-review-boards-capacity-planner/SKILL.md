---
name: ethics-review-boards-capacity-planner
description: Use when tasks require ethics review boards capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Capacity Planner

## Purpose
Design and execute ethics review boards workflows using capacity planner controls with validated outcomes.
