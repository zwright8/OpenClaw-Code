---
name: universal-toolchain-08-postmortem-drafting
description: Use when tasks require universal toolchain 08 postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Postmortem Drafting

## Purpose
Design and execute universal toolchain 08 workflows using postmortem drafting controls with validated outcomes.
