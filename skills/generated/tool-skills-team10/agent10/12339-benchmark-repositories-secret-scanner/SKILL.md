---
name: benchmark-repositories-secret-scanner
description: Use when tasks require benchmark repositories secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Secret Scanner

## Purpose
Design and execute benchmark repositories workflows using secret scanner controls with validated outcomes.
