---
name: universal-toolchain-07-snapshot-manager
description: Use when tasks require universal toolchain 07 snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 07 Snapshot Manager

## Purpose
Design and execute universal toolchain 07 workflows using snapshot manager controls with validated outcomes.
