---
name: ai-evaluation-markets-policy-evaluator
description: Use when tasks require ai evaluation markets policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Policy Evaluator

## Purpose
Design and execute ai evaluation markets workflows using policy evaluator controls with validated outcomes.
