---
name: universal-toolchain-02-feedback-harvester
description: Use when tasks require universal toolchain 02 feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Feedback Harvester

## Purpose
Design and execute universal toolchain 02 workflows using feedback harvester controls with validated outcomes.
