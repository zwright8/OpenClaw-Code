---
name: universal-toolchain-05-operation-planner
description: Use when tasks require universal toolchain 05 operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Operation Planner

## Purpose
Design and execute universal toolchain 05 workflows using operation planner controls with validated outcomes.
