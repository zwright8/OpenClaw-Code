---
name: audit-trails-risk-scorer
description: Use when tasks require audit trails risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Risk Scorer

## Purpose
Design and execute audit trails workflows using risk scorer controls with validated outcomes.
