---
name: data-provenance-risk-scorer
description: Use when tasks require data provenance risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Risk Scorer

## Purpose
Design and execute data provenance workflows using risk scorer controls with validated outcomes.
