---
name: protocol-management-execution-runner
description: Use when tasks require protocol management execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Execution Runner

## Purpose
Design and execute protocol management workflows using execution runner controls with validated outcomes.
