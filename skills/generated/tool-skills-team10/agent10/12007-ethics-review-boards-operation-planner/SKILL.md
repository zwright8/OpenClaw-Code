---
name: ethics-review-boards-operation-planner
description: Use when tasks require ethics review boards operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Operation Planner

## Purpose
Design and execute ethics review boards workflows using operation planner controls with validated outcomes.
