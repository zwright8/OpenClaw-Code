---
name: universal-toolchain-06-secret-scanner
description: Use when tasks require universal toolchain 06 secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Secret Scanner

## Purpose
Design and execute universal toolchain 06 workflows using secret scanner controls with validated outcomes.
