---
name: universal-toolchain-04-pii-redactor
description: Use when tasks require universal toolchain 04 pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 PII Redactor

## Purpose
Design and execute universal toolchain 04 workflows using pii redactor controls with validated outcomes.
