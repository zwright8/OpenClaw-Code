---
name: universal-toolchain-04-remediation-planner
description: Use when tasks require universal toolchain 04 remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Remediation Planner

## Purpose
Design and execute universal toolchain 04 workflows using remediation planner controls with validated outcomes.
