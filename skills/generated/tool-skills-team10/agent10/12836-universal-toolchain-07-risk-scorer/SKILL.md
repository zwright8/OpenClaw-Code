---
name: universal-toolchain-07-risk-scorer
description: Use when tasks require universal toolchain 07 risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 07 Risk Scorer

## Purpose
Design and execute universal toolchain 07 workflows using risk scorer controls with validated outcomes.
