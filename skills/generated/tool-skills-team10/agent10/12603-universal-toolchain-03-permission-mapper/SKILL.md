---
name: universal-toolchain-03-permission-mapper
description: Use when tasks require universal toolchain 03 permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Permission Mapper

## Purpose
Design and execute universal toolchain 03 workflows using permission mapper controls with validated outcomes.
