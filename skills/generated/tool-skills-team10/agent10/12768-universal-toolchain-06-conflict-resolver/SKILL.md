...
description: Use when tasks require universal toolchain 06 conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Conflict Resolver

## Purpose
Design and execute universal toolchain 06 workflows using conflict resolver controls with validated outcomes.
