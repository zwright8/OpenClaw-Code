---
name: policy-compliance-anomaly-detector
description: Use when tasks require policy compliance anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Compliance Anomaly Detector

## Purpose
Design and execute policy compliance workflows using anomaly detector controls with validated outcomes.
