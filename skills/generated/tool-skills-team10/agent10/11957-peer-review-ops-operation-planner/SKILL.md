---
name: peer-review-ops-operation-planner
description: Use when tasks require peer review ops operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Operation Planner

## Purpose
Design and execute peer review ops workflows using operation planner controls with validated outcomes.
