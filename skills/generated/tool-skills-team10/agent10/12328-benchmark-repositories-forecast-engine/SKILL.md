---
name: benchmark-repositories-forecast-engine
description: Use when tasks require benchmark repositories forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Forecast Engine

## Purpose
Design and execute benchmark repositories workflows using forecast engine controls with validated outcomes.
