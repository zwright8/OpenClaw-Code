...
description: Use when tasks require ethics review boards conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Conflict Resolver

## Purpose
Design and execute ethics review boards workflows using conflict resolver controls with validated outcomes.
