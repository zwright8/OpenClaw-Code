---
name: data-provenance-postmortem-drafting
description: Use when tasks require data provenance postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Postmortem Drafting

## Purpose
Design and execute data provenance workflows using postmortem drafting controls with validated outcomes.
