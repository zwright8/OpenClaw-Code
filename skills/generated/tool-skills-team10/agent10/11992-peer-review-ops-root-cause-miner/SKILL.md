---
name: peer-review-ops-root-cause-miner
description: Use when tasks require peer review ops root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Root Cause Miner

## Purpose
Design and execute peer review ops workflows using root cause miner controls with validated outcomes.
