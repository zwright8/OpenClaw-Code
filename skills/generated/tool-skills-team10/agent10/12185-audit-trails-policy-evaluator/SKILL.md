---
name: audit-trails-policy-evaluator
description: Use when tasks require audit trails policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Policy Evaluator

## Purpose
Design and execute audit trails workflows using policy evaluator controls with validated outcomes.
