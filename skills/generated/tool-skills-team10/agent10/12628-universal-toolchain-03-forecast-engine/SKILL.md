---
name: universal-toolchain-03-forecast-engine
description: Use when tasks require universal toolchain 03 forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Forecast Engine

## Purpose
Design and execute universal toolchain 03 workflows using forecast engine controls with validated outcomes.
