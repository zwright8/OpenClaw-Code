---
name: universal-toolchain-06-permission-mapper
description: Use when tasks require universal toolchain 06 permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Permission Mapper

## Purpose
Design and execute universal toolchain 06 workflows using permission mapper controls with validated outcomes.
