---
name: universal-toolchain-08-dependency-resolver
description: Use when tasks require universal toolchain 08 dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Dependency Resolver

## Purpose
Design and execute universal toolchain 08 workflows using dependency resolver controls with validated outcomes.
