---
name: simulation-environments-task-decomposer
description: Use when tasks require simulation environments task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Simulation Environments Task Decomposer

## Purpose
Design and execute simulation environments workflows using task decomposer controls with validated outcomes.
