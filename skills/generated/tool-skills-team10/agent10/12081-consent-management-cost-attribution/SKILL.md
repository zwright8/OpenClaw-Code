---
name: consent-management-cost-attribution
description: Use when tasks require consent management cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Cost Attribution

## Purpose
Design and execute consent management workflows using cost attribution controls with validated outcomes.
