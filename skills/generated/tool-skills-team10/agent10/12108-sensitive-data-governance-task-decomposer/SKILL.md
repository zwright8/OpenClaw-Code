---
name: sensitive-data-governance-task-decomposer
description: Use when tasks require sensitive data governance task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Task Decomposer

## Purpose
Design and execute sensitive data governance workflows using task decomposer controls with validated outcomes.
