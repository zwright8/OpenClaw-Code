---
name: ethics-review-boards-access-auditor
description: Use when tasks require ethics review boards access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Access Auditor

## Purpose
Design and execute ethics review boards workflows using access auditor controls with validated outcomes.
