---
name: ethics-review-boards-sla-enforcer
description: Use when tasks require ethics review boards sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards SLA Enforcer

## Purpose
Design and execute ethics review boards workflows using sla enforcer controls with validated outcomes.
