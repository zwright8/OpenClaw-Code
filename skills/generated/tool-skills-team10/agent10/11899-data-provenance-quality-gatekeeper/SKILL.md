---
name: data-provenance-quality-gatekeeper
description: Use when tasks require data provenance quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Quality Gatekeeper

## Purpose
Design and execute data provenance workflows using quality gatekeeper controls with validated outcomes.
