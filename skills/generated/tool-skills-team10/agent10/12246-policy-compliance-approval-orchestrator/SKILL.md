---
name: policy-compliance-approval-orchestrator
description: Use when tasks require policy compliance approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Compliance Approval Orchestrator

## Purpose
Design and execute policy compliance workflows using approval orchestrator controls with validated outcomes.
