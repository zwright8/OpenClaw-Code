---
name: ai-evaluation-markets-evidence-collector
description: Use when tasks require ai evaluation markets evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Evidence Collector

## Purpose
Design and execute ai evaluation markets workflows using evidence collector controls with validated outcomes.
