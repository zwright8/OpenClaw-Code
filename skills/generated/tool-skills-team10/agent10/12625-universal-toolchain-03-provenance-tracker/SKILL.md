---
name: universal-toolchain-03-provenance-tracker
description: Use when tasks require universal toolchain 03 provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Provenance Tracker

## Purpose
Design and execute universal toolchain 03 workflows using provenance tracker controls with validated outcomes.
