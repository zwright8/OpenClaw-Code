---
name: service-quality-auth-broker
description: Use when tasks require service quality auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Auth Broker

## Purpose
Design and execute service quality workflows using auth broker controls with validated outcomes.
