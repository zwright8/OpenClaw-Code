---
name: peer-review-ops-capacity-planner
description: Use when tasks require peer review ops capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Capacity Planner

## Purpose
Design and execute peer review ops workflows using capacity planner controls with validated outcomes.
