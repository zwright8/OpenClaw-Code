---
name: protocol-management-remediation-planner
description: Use when tasks require protocol management remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Remediation Planner

## Purpose
Design and execute protocol management workflows using remediation planner controls with validated outcomes.
