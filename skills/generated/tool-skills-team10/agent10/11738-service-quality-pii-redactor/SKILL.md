---
name: service-quality-pii-redactor
description: Use when tasks require service quality pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality PII Redactor

## Purpose
Design and execute service quality workflows using pii redactor controls with validated outcomes.
