...
description: Use when tasks require universal toolchain 07 feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 07 Feedback Harvester

## Purpose
Design and execute universal toolchain 07 workflows using feedback harvester controls with validated outcomes.
