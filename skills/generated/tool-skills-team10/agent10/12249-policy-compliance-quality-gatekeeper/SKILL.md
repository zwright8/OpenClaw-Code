---
name: policy-compliance-quality-gatekeeper
description: Use when tasks require policy compliance quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Compliance Quality Gatekeeper

## Purpose
Design and execute policy compliance workflows using quality gatekeeper controls with validated outcomes.
