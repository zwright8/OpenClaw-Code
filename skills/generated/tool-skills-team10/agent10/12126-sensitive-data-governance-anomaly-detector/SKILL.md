---
name: sensitive-data-governance-anomaly-detector
description: Use when tasks require sensitive data governance anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Anomaly Detector

## Purpose
Design and execute sensitive data governance workflows using anomaly detector controls with validated outcomes.
