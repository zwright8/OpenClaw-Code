---
name: service-quality-human-handoff-router
description: Use when tasks require service quality human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Human Handoff Router

## Purpose
Design and execute service quality workflows using human handoff router controls with validated outcomes.
