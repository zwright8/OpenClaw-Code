---
name: benchmark-repositories-rollback-coordinator
description: Use when tasks require benchmark repositories rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Rollback Coordinator

## Purpose
Design and execute benchmark repositories workflows using rollback coordinator controls with validated outcomes.
