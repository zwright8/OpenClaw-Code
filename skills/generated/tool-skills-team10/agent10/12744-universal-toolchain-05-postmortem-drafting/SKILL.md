---
name: universal-toolchain-05-postmortem-drafting
description: Use when tasks require universal toolchain 05 postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Postmortem Drafting

## Purpose
Design and execute universal toolchain 05 workflows using postmortem drafting controls with validated outcomes.
