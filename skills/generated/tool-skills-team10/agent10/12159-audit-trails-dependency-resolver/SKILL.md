---
name: audit-trails-dependency-resolver
description: Use when tasks require audit trails dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Dependency Resolver

## Purpose
Design and execute audit trails workflows using dependency resolver controls with validated outcomes.
