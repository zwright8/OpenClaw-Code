---
name: consent-management-anomaly-detector
description: Use when tasks require consent management anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Anomaly Detector

## Purpose
Design and execute consent management workflows using anomaly detector controls with validated outcomes.
