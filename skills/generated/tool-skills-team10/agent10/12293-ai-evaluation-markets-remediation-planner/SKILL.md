---
name: ai-evaluation-markets-remediation-planner
description: Use when tasks require ai evaluation markets remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Remediation Planner

## Purpose
Design and execute ai evaluation markets workflows using remediation planner controls with validated outcomes.
