---
name: universal-toolchain-04-quality-gatekeeper
description: Use when tasks require universal toolchain 04 quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Quality Gatekeeper

## Purpose
Design and execute universal toolchain 04 workflows using quality gatekeeper controls with validated outcomes.
