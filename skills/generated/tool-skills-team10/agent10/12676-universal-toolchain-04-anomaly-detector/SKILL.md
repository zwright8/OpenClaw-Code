---
name: universal-toolchain-04-anomaly-detector
description: Use when tasks require universal toolchain 04 anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Anomaly Detector

## Purpose
Design and execute universal toolchain 04 workflows using anomaly detector controls with validated outcomes.
