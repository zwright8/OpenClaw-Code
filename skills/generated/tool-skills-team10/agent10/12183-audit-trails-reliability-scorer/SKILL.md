---
name: audit-trails-reliability-scorer
description: Use when tasks require audit trails reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Reliability Scorer

## Purpose
Design and execute audit trails workflows using reliability scorer controls with validated outcomes.
