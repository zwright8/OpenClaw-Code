---
name: universal-toolchain-03-risk-scorer
description: Use when tasks require universal toolchain 03 risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Risk Scorer

## Purpose
Design and execute universal toolchain 03 workflows using risk scorer controls with validated outcomes.
