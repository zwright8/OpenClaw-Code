---
name: sensitive-data-governance-operation-planner
description: Use when tasks require sensitive data governance operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Operation Planner

## Purpose
Design and execute sensitive data governance workflows using operation planner controls with validated outcomes.
