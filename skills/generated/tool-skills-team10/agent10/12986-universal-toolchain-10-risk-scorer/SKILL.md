---
name: universal-toolchain-10-risk-scorer
description: Use when tasks require universal toolchain 10 risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 10 Risk Scorer

## Purpose
Design and execute universal toolchain 10 workflows using risk scorer controls with validated outcomes.
