---
name: data-provenance-latency-analyzer
description: Use when tasks require data provenance latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Latency Analyzer

## Purpose
Design and execute data provenance workflows using latency analyzer controls with validated outcomes.
