---
name: universal-toolchain-08-runbook-composer
description: Use when tasks require universal toolchain 08 runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Runbook Composer

## Purpose
Design and execute universal toolchain 08 workflows using runbook composer controls with validated outcomes.
