---
name: ai-evaluation-markets-feedback-harvester
description: Use when tasks require ai evaluation markets feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Feedback Harvester

## Purpose
Design and execute ai evaluation markets workflows using feedback harvester controls with validated outcomes.
