---
name: ai-evaluation-markets-operation-planner
description: Use when tasks require ai evaluation markets operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Operation Planner

## Purpose
Design and execute ai evaluation markets workflows using operation planner controls with validated outcomes.
