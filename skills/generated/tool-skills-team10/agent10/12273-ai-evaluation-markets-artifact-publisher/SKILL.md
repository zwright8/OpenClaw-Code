---
name: ai-evaluation-markets-artifact-publisher
description: Use when tasks require ai evaluation markets artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Artifact Publisher

## Purpose
Design and execute ai evaluation markets workflows using artifact publisher controls with validated outcomes.
