---
name: peer-review-ops-auth-broker
description: Use when tasks require peer review ops auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Auth Broker

## Purpose
Design and execute peer review ops workflows using auth broker controls with validated outcomes.
