---
name: universal-toolchain-04-incident-triage
description: Use when tasks require universal toolchain 04 incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Incident Triage

## Purpose
Design and execute universal toolchain 04 workflows using incident triage controls with validated outcomes.
