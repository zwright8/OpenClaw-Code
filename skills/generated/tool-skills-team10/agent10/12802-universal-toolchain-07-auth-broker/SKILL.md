---
name: universal-toolchain-07-auth-broker
description: Use when tasks require universal toolchain 07 auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 07 Auth Broker

## Purpose
Design and execute universal toolchain 07 workflows using auth broker controls with validated outcomes.
