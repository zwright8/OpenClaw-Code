---
name: ai-evaluation-markets-quality-gatekeeper
description: Use when tasks require ai evaluation markets quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Quality Gatekeeper

## Purpose
Design and execute ai evaluation markets workflows using quality gatekeeper controls with validated outcomes.
