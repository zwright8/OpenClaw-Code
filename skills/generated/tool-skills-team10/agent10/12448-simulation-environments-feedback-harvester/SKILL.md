---
name: simulation-environments-feedback-harvester
description: Use when tasks require simulation environments feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Simulation Environments Feedback Harvester

## Purpose
Design and execute simulation environments workflows using feedback harvester controls with validated outcomes.
