---
name: universal-toolchain-06-spec-drift-detector
description: Use when tasks require universal toolchain 06 spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Spec Drift Detector

## Purpose
Design and execute universal toolchain 06 workflows using spec drift detector controls with validated outcomes.
