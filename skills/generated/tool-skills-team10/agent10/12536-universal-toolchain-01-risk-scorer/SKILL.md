---
name: universal-toolchain-01-risk-scorer
description: Use when tasks require universal toolchain 01 risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 01 Risk Scorer

## Purpose
Design and execute universal toolchain 01 workflows using risk scorer controls with validated outcomes.
