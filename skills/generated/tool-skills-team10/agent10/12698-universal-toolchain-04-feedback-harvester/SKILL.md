---
name: universal-toolchain-04-feedback-harvester
description: Use when tasks require universal toolchain 04 feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Feedback Harvester

## Purpose
Design and execute universal toolchain 04 workflows using feedback harvester controls with validated outcomes.
