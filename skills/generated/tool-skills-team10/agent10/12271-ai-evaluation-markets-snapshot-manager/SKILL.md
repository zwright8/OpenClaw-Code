---
name: ai-evaluation-markets-snapshot-manager
description: Use when tasks require ai evaluation markets snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Snapshot Manager

## Purpose
Design and execute ai evaluation markets workflows using snapshot manager controls with validated outcomes.
