---
name: universal-toolchain-03-cost-attribution
description: Use when tasks require universal toolchain 03 cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Cost Attribution

## Purpose
Design and execute universal toolchain 03 workflows using cost attribution controls with validated outcomes.
