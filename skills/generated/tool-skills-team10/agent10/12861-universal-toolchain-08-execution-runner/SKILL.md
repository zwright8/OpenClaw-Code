---
name: universal-toolchain-08-execution-runner
description: Use when tasks require universal toolchain 08 execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Execution Runner

## Purpose
Design and execute universal toolchain 08 workflows using execution runner controls with validated outcomes.
