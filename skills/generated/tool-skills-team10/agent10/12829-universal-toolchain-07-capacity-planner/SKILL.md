---
name: universal-toolchain-07-capacity-planner
description: Use when tasks require universal toolchain 07 capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 07 Capacity Planner

## Purpose
Design and execute universal toolchain 07 workflows using capacity planner controls with validated outcomes.
