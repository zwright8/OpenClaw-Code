---
name: policy-compliance-artifact-publisher
description: Use when tasks require policy compliance artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Compliance Artifact Publisher

## Purpose
Design and execute policy compliance workflows using artifact publisher controls with validated outcomes.
