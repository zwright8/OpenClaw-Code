---
name: ethics-review-boards-root-cause-miner
description: Use when tasks require ethics review boards root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Root Cause Miner

## Purpose
Design and execute ethics review boards workflows using root cause miner controls with validated outcomes.
