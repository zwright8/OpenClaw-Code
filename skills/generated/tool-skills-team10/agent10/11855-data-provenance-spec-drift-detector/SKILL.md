---
name: data-provenance-spec-drift-detector
description: Use when tasks require data provenance spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Spec Drift Detector

## Purpose
Design and execute data provenance workflows using spec drift detector controls with validated outcomes.
