...
description: Use when tasks require ethics review boards evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Evidence Collector

## Purpose
Design and execute ethics review boards workflows using evidence collector controls with validated outcomes.
