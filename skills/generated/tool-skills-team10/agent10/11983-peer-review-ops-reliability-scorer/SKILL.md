---
name: peer-review-ops-reliability-scorer
description: Use when tasks require peer review ops reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Reliability Scorer

## Purpose
Design and execute peer review ops workflows using reliability scorer controls with validated outcomes.
