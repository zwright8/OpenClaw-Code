---
name: universal-toolchain-04-operation-planner
description: Use when tasks require universal toolchain 04 operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Operation Planner

## Purpose
Design and execute universal toolchain 04 workflows using operation planner controls with validated outcomes.
