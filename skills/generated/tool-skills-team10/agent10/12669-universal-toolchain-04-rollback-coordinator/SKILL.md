---
name: universal-toolchain-04-rollback-coordinator
description: Use when tasks require universal toolchain 04 rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Rollback Coordinator

## Purpose
Design and execute universal toolchain 04 workflows using rollback coordinator controls with validated outcomes.
