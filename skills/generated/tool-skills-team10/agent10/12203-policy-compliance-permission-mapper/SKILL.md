---
name: policy-compliance-permission-mapper
description: Use when tasks require policy compliance permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Compliance Permission Mapper

## Purpose
Design and execute policy compliance workflows using permission mapper controls with validated outcomes.
