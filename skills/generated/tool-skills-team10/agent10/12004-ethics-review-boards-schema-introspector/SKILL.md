...
description: Use when tasks require ethics review boards schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Schema Introspector

## Purpose
Design and execute ethics review boards workflows using schema introspector controls with validated outcomes.
