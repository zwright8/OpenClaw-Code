---
name: benchmark-repositories-rate-limit-optimizer
description: Use when tasks require benchmark repositories rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Rate Limit Optimizer

## Purpose
Design and execute benchmark repositories workflows using rate limit optimizer controls with validated outcomes.
