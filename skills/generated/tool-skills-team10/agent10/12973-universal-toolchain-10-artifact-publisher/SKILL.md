---
name: universal-toolchain-10-artifact-publisher
description: Use when tasks require universal toolchain 10 artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 10 Artifact Publisher

## Purpose
Design and execute universal toolchain 10 workflows using artifact publisher controls with validated outcomes.
