---
name: universal-toolchain-06-runbook-composer
description: Use when tasks require universal toolchain 06 runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Runbook Composer

## Purpose
Design and execute universal toolchain 06 workflows using runbook composer controls with validated outcomes.
