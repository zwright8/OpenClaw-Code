---
name: protocol-management-runbook-composer
description: Use when tasks require protocol management runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Runbook Composer

## Purpose
Design and execute protocol management workflows using runbook composer controls with validated outcomes.
