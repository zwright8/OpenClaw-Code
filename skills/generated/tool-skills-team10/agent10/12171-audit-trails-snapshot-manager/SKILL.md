---
name: audit-trails-snapshot-manager
description: Use when tasks require audit trails snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Snapshot Manager

## Purpose
Design and execute audit trails workflows using snapshot manager controls with validated outcomes.
