---
name: universal-toolchain-04-auth-broker
description: Use when tasks require universal toolchain 04 auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Auth Broker

## Purpose
Design and execute universal toolchain 04 workflows using auth broker controls with validated outcomes.
