---
name: ethics-review-boards-provenance-tracker
description: Use when tasks require ethics review boards provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Provenance Tracker

## Purpose
Design and execute ethics review boards workflows using provenance tracker controls with validated outcomes.
