---
name: protocol-management-operation-planner
description: Use when tasks require protocol management operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Operation Planner

## Purpose
Design and execute protocol management workflows using operation planner controls with validated outcomes.
