---
name: lab-notebook-systems-root-cause-miner
description: Use when tasks require lab notebook systems root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Notebook Systems Root Cause Miner

## Purpose
Design and execute lab notebook systems workflows using root cause miner controls with validated outcomes.
