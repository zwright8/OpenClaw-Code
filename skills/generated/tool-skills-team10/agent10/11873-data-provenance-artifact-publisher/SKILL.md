---
name: data-provenance-artifact-publisher
description: Use when tasks require data provenance artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Artifact Publisher

## Purpose
Design and execute data provenance workflows using artifact publisher controls with validated outcomes.
