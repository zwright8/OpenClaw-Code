---
name: data-provenance-rollback-coordinator
description: Use when tasks require data provenance rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Rollback Coordinator

## Purpose
Design and execute data provenance workflows using rollback coordinator controls with validated outcomes.
