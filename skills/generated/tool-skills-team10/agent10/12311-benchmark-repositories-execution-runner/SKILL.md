---
name: benchmark-repositories-execution-runner
description: Use when tasks require benchmark repositories execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Execution Runner

## Purpose
Design and execute benchmark repositories workflows using execution runner controls with validated outcomes.
