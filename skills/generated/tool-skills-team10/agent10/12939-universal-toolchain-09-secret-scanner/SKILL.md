---
name: universal-toolchain-09-secret-scanner
description: Use when tasks require universal toolchain 09 secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 09 Secret Scanner

## Purpose
Design and execute universal toolchain 09 workflows using secret scanner controls with validated outcomes.
