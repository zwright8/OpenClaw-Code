---
name: benchmark-repositories-retry-governor
description: Use when tasks require benchmark repositories retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Retry Governor

## Purpose
Design and execute benchmark repositories workflows using retry governor controls with validated outcomes.
