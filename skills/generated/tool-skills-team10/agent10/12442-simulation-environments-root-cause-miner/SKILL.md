---
name: simulation-environments-root-cause-miner
description: Use when tasks require simulation environments root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Simulation Environments Root Cause Miner

## Purpose
Design and execute simulation environments workflows using root cause miner controls with validated outcomes.
