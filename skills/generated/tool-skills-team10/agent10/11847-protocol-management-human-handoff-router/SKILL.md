---
name: protocol-management-human-handoff-router
description: Use when tasks require protocol management human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Human Handoff Router

## Purpose
Design and execute protocol management workflows using human handoff router controls with validated outcomes.
