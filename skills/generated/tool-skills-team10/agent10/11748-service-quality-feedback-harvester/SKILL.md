---
name: service-quality-feedback-harvester
description: Use when tasks require service quality feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Feedback Harvester

## Purpose
Design and execute service quality workflows using feedback harvester controls with validated outcomes.
