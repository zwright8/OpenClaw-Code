---
name: universal-toolchain-05-auth-broker
description: Use when tasks require universal toolchain 05 auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Auth Broker

## Purpose
Design and execute universal toolchain 05 workflows using auth broker controls with validated outcomes.
