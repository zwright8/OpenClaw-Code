---
name: sensitive-data-governance-cost-attribution
description: Use when tasks require sensitive data governance cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Cost Attribution

## Purpose
Design and execute sensitive data governance workflows using cost attribution controls with validated outcomes.
