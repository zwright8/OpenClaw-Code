---
name: protocol-management-postmortem-drafting
description: Use when tasks require protocol management postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Postmortem Drafting

## Purpose
Design and execute protocol management workflows using postmortem drafting controls with validated outcomes.
