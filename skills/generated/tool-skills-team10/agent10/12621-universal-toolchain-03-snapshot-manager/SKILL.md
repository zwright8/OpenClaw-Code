---
name: universal-toolchain-03-snapshot-manager
description: Use when tasks require universal toolchain 03 snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Snapshot Manager

## Purpose
Design and execute universal toolchain 03 workflows using snapshot manager controls with validated outcomes.
