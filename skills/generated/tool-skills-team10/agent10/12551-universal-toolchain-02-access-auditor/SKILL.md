---
name: universal-toolchain-02-access-auditor
description: Use when tasks require universal toolchain 02 access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Access Auditor

## Purpose
Design and execute universal toolchain 02 workflows using access auditor controls with validated outcomes.
