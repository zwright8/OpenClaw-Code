---
name: universal-toolchain-05-workflow-compiler
description: Use when tasks require universal toolchain 05 workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Workflow Compiler

## Purpose
Design and execute universal toolchain 05 workflows using workflow compiler controls with validated outcomes.
