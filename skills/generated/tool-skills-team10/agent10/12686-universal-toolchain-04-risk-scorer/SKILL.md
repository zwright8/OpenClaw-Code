---
name: universal-toolchain-04-risk-scorer
description: Use when tasks require universal toolchain 04 risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Risk Scorer

## Purpose
Design and execute universal toolchain 04 workflows using risk scorer controls with validated outcomes.
