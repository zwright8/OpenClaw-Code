---
name: protocol-management-secret-scanner
description: Use when tasks require protocol management secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Secret Scanner

## Purpose
Design and execute protocol management workflows using secret scanner controls with validated outcomes.
