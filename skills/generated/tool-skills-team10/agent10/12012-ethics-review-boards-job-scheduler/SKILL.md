---
name: ethics-review-boards-job-scheduler
description: Use when tasks require ethics review boards job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Job Scheduler

## Purpose
Design and execute ethics review boards workflows using job scheduler controls with validated outcomes.
