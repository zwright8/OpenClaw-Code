---
name: consent-management-human-handoff-router
description: Use when tasks require consent management human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Human Handoff Router

## Purpose
Design and execute consent management workflows using human handoff router controls with validated outcomes.
