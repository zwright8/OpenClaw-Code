---
name: peer-review-ops-task-decomposer
description: Use when tasks require peer review ops task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Task Decomposer

## Purpose
Design and execute peer review ops workflows using task decomposer controls with validated outcomes.
