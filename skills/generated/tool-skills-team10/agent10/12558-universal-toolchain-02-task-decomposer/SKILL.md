---
name: universal-toolchain-02-task-decomposer
description: Use when tasks require universal toolchain 02 task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Task Decomposer

## Purpose
Design and execute universal toolchain 02 workflows using task decomposer controls with validated outcomes.
