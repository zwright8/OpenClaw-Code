---
name: universal-toolchain-05-capacity-planner
description: Use when tasks require universal toolchain 05 capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Capacity Planner

## Purpose
Design and execute universal toolchain 05 workflows using capacity planner controls with validated outcomes.
