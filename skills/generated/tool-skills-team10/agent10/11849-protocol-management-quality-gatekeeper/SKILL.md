---
name: protocol-management-quality-gatekeeper
description: Use when tasks require protocol management quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Quality Gatekeeper

## Purpose
Design and execute protocol management workflows using quality gatekeeper controls with validated outcomes.
