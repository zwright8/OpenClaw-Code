---
name: ai-evaluation-markets-access-auditor
description: Use when tasks require ai evaluation markets access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Access Auditor

## Purpose
Design and execute ai evaluation markets workflows using access auditor controls with validated outcomes.
