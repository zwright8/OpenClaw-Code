---
name: ai-evaluation-markets-forecast-engine
description: Use when tasks require ai evaluation markets forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Forecast Engine

## Purpose
Design and execute ai evaluation markets workflows using forecast engine controls with validated outcomes.
