---
name: universal-toolchain-08-quality-gatekeeper
description: Use when tasks require universal toolchain 08 quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Quality Gatekeeper

## Purpose
Design and execute universal toolchain 08 workflows using quality gatekeeper controls with validated outcomes.
