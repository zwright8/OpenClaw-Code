---
name: autonomy-control-evidence-collector
description: Use when tasks require autonomy control evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Evidence Collector

## Purpose
Design and execute autonomy control workflows using evidence collector controls with validated outcomes.
