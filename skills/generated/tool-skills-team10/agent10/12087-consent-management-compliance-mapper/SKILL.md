---
name: consent-management-compliance-mapper
description: Use when tasks require consent management compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Compliance Mapper

## Purpose
Design and execute consent management workflows using compliance mapper controls with validated outcomes.
