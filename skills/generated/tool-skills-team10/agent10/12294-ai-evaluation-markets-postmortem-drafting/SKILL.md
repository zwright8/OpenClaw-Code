---
name: ai-evaluation-markets-postmortem-drafting
description: Use when tasks require ai evaluation markets postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Postmortem Drafting

## Purpose
Design and execute ai evaluation markets workflows using postmortem drafting controls with validated outcomes.
