---
name: audit-trails-conflict-resolver
description: Use when tasks require audit trails conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Conflict Resolver

## Purpose
Design and execute audit trails workflows using conflict resolver controls with validated outcomes.
