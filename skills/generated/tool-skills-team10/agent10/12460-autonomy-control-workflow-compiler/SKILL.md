---
name: autonomy-control-workflow-compiler
description: Use when tasks require autonomy control workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Workflow Compiler

## Purpose
Design and execute autonomy control workflows using workflow compiler controls with validated outcomes.
