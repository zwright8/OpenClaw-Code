---
name: peer-review-ops-quality-gatekeeper
description: Use when tasks require peer review ops quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Quality Gatekeeper

## Purpose
Design and execute peer review ops workflows using quality gatekeeper controls with validated outcomes.
