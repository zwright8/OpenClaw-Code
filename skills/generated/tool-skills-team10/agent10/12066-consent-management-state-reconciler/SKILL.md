---
name: consent-management-state-reconciler
description: Use when tasks require consent management state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management State Reconciler

## Purpose
Design and execute consent management workflows using state reconciler controls with validated outcomes.
