---
name: universal-toolchain-09-artifact-publisher
description: Use when tasks require universal toolchain 09 artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 09 Artifact Publisher

## Purpose
Design and execute universal toolchain 09 workflows using artifact publisher controls with validated outcomes.
