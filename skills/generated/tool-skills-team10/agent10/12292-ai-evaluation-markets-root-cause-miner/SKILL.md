---
name: ai-evaluation-markets-root-cause-miner
description: Use when tasks require ai evaluation markets root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Root Cause Miner

## Purpose
Design and execute ai evaluation markets workflows using root cause miner controls with validated outcomes.
