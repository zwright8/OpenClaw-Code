---
name: universal-toolchain-02-provenance-tracker
description: Use when tasks require universal toolchain 02 provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Provenance Tracker

## Purpose
Design and execute universal toolchain 02 workflows using provenance tracker controls with validated outcomes.
