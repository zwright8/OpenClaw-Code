---
name: sensitive-data-governance-outcome-synthesizer
description: Use when tasks require sensitive data governance outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Outcome Synthesizer

## Purpose
Design and execute sensitive data governance workflows using outcome synthesizer controls with validated outcomes.
