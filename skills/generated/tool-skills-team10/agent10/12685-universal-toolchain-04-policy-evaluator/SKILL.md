---
name: universal-toolchain-04-policy-evaluator
description: Use when tasks require universal toolchain 04 policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Policy Evaluator

## Purpose
Design and execute universal toolchain 04 workflows using policy evaluator controls with validated outcomes.
