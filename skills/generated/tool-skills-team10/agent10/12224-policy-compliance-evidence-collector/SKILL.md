---
name: policy-compliance-evidence-collector
description: Use when tasks require policy compliance evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Compliance Evidence Collector

## Purpose
Design and execute policy compliance workflows using evidence collector controls with validated outcomes.
