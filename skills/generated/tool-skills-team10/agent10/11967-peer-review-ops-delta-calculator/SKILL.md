---
name: peer-review-ops-delta-calculator
description: Use when tasks require peer review ops delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Delta Calculator

## Purpose
Design and execute peer review ops workflows using delta calculator controls with validated outcomes.
