---
name: ai-evaluation-markets-rollback-coordinator
description: Use when tasks require ai evaluation markets rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Rollback Coordinator

## Purpose
Design and execute ai evaluation markets workflows using rollback coordinator controls with validated outcomes.
