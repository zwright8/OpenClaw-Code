---
name: universal-toolchain-04-cost-attribution
description: Use when tasks require universal toolchain 04 cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Cost Attribution

## Purpose
Design and execute universal toolchain 04 workflows using cost attribution controls with validated outcomes.
