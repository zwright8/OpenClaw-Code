---
name: data-provenance-evidence-collector
description: Use when tasks require data provenance evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Evidence Collector

## Purpose
Design and execute data provenance workflows using evidence collector controls with validated outcomes.
