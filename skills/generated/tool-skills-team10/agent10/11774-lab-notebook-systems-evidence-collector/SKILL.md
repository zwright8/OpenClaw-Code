---
name: lab-notebook-systems-evidence-collector
description: Use when tasks require lab notebook systems evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Lab Notebook Systems Evidence Collector

## Purpose
Design and execute lab notebook systems workflows using evidence collector controls with validated outcomes.
