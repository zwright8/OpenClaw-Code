---
name: universal-toolchain-08-capacity-planner
description: Use when tasks require universal toolchain 08 capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Capacity Planner

## Purpose
Design and execute universal toolchain 08 workflows using capacity planner controls with validated outcomes.
