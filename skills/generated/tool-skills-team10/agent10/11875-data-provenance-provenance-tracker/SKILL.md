---
name: data-provenance-provenance-tracker
description: Use when tasks require data provenance provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Provenance Tracker

## Purpose
Design and execute data provenance workflows using provenance tracker controls with validated outcomes.
