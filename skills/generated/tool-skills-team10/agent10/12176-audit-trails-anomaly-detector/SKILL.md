---
name: audit-trails-anomaly-detector
description: Use when tasks require audit trails anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Anomaly Detector

## Purpose
Design and execute audit trails workflows using anomaly detector controls with validated outcomes.
