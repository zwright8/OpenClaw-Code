---
name: ethics-review-boards-task-decomposer
description: Use when tasks require ethics review boards task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Task Decomposer

## Purpose
Design and execute ethics review boards workflows using task decomposer controls with validated outcomes.
