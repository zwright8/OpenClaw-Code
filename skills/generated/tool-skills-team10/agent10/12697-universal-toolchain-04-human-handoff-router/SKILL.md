---
name: universal-toolchain-04-human-handoff-router
description: Use when tasks require universal toolchain 04 human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Human Handoff Router

## Purpose
Design and execute universal toolchain 04 workflows using human handoff router controls with validated outcomes.
