---
name: protocol-management-evidence-collector
description: Use when tasks require protocol management evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Evidence Collector

## Purpose
Design and execute protocol management workflows using evidence collector controls with validated outcomes.
