---
name: universal-toolchain-02-secret-scanner
description: Use when tasks require universal toolchain 02 secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Secret Scanner

## Purpose
Design and execute universal toolchain 02 workflows using secret scanner controls with validated outcomes.
