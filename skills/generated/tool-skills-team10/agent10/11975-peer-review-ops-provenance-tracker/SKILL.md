---
name: peer-review-ops-provenance-tracker
description: Use when tasks require peer review ops provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Provenance Tracker

## Purpose
Design and execute peer review ops workflows using provenance tracker controls with validated outcomes.
