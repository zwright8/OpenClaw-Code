---
name: benchmark-repositories-spec-drift-detector
description: Use when tasks require benchmark repositories spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Spec Drift Detector

## Purpose
Design and execute benchmark repositories workflows using spec drift detector controls with validated outcomes.
