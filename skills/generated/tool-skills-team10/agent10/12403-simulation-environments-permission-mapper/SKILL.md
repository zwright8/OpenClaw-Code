---
name: simulation-environments-permission-mapper
description: Use when tasks require simulation environments permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Simulation Environments Permission Mapper

## Purpose
Design and execute simulation environments workflows using permission mapper controls with validated outcomes.
