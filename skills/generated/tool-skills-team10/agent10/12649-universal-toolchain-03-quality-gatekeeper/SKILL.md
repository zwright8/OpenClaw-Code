---
name: universal-toolchain-03-quality-gatekeeper
description: Use when tasks require universal toolchain 03 quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Quality Gatekeeper

## Purpose
Design and execute universal toolchain 03 workflows using quality gatekeeper controls with validated outcomes.
