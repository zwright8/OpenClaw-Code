---
name: sensitive-data-governance-budget-guardrail
description: Use when tasks require sensitive data governance budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Budget Guardrail

## Purpose
Design and execute sensitive data governance workflows using budget guardrail controls with validated outcomes.
