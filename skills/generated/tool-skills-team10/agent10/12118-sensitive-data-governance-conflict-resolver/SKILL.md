---
name: sensitive-data-governance-conflict-resolver
description: Use when tasks require sensitive data governance conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Conflict Resolver

## Purpose
Design and execute sensitive data governance workflows using conflict resolver controls with validated outcomes.
