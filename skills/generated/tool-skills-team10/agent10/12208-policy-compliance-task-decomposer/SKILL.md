---
name: policy-compliance-task-decomposer
description: Use when tasks require policy compliance task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Compliance Task Decomposer

## Purpose
Design and execute policy compliance workflows using task decomposer controls with validated outcomes.
