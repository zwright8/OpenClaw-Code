---
name: consent-management-rate-limit-optimizer
description: Use when tasks require consent management rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Rate Limit Optimizer

## Purpose
Design and execute consent management workflows using rate limit optimizer controls with validated outcomes.
