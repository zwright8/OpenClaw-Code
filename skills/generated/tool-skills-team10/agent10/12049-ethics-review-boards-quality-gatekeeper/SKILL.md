...
description: Use when tasks require ethics review boards quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Quality Gatekeeper

## Purpose
Design and execute ethics review boards workflows using quality gatekeeper controls with validated outcomes.
