---
name: universal-toolchain-02-permission-mapper
description: Use when tasks require universal toolchain 02 permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Permission Mapper

## Purpose
Design and execute universal toolchain 02 workflows using permission mapper controls with validated outcomes.
