---
name: ethics-review-boards-workflow-compiler
description: Use when tasks require ethics review boards workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Workflow Compiler

## Purpose
Design and execute ethics review boards workflows using workflow compiler controls with validated outcomes.
