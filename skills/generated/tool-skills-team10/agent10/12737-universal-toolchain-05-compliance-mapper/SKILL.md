...
description: Use when tasks require universal toolchain 05 compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Compliance Mapper

## Purpose
Design and execute universal toolchain 05 workflows using compliance mapper controls with validated outcomes.
