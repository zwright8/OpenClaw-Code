---
name: universal-toolchain-04-evidence-collector
description: Use when tasks require universal toolchain 04 evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Evidence Collector

## Purpose
Design and execute universal toolchain 04 workflows using evidence collector controls with validated outcomes.
