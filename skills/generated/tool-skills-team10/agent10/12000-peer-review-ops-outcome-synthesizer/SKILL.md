---
name: peer-review-ops-outcome-synthesizer
description: Use when tasks require peer review ops outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Outcome Synthesizer

## Purpose
Design and execute peer review ops workflows using outcome synthesizer controls with validated outcomes.
