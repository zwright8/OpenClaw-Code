---
name: autonomy-control-snapshot-manager
description: Use when tasks require autonomy control snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Snapshot Manager

## Purpose
Design and execute autonomy control workflows using snapshot manager controls with validated outcomes.
