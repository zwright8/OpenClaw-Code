---
name: consent-management-execution-runner
description: Use when tasks require consent management execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Execution Runner

## Purpose
Design and execute consent management workflows using execution runner controls with validated outcomes.
