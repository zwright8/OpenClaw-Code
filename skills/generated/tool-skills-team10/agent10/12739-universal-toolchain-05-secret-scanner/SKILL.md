---
name: universal-toolchain-05-secret-scanner
description: Use when tasks require universal toolchain 05 secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Secret Scanner

## Purpose
Design and execute universal toolchain 05 workflows using secret scanner controls with validated outcomes.
