---
name: universal-toolchain-10-postmortem-drafting
description: Use when tasks require universal toolchain 10 postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 10 Postmortem Drafting

## Purpose
Design and execute universal toolchain 10 workflows using postmortem drafting controls with validated outcomes.
