---
name: universal-toolchain-06-postmortem-drafting
description: Use when tasks require universal toolchain 06 postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Postmortem Drafting

## Purpose
Design and execute universal toolchain 06 workflows using postmortem drafting controls with validated outcomes.
