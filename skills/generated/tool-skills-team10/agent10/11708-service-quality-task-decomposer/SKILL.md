---
name: service-quality-task-decomposer
description: Use when tasks require service quality task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Task Decomposer

## Purpose
Design and execute service quality workflows using task decomposer controls with validated outcomes.
