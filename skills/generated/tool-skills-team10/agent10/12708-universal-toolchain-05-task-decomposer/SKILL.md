---
name: universal-toolchain-05-task-decomposer
description: Use when tasks require universal toolchain 05 task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Task Decomposer

## Purpose
Design and execute universal toolchain 05 workflows using task decomposer controls with validated outcomes.
