---
name: autonomy-control-operation-planner
description: Use when tasks require autonomy control operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Operation Planner

## Purpose
Design and execute autonomy control workflows using operation planner controls with validated outcomes.
