---
name: benchmark-repositories-approval-orchestrator
description: Use when tasks require benchmark repositories approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Approval Orchestrator

## Purpose
Design and execute benchmark repositories workflows using approval orchestrator controls with validated outcomes.
