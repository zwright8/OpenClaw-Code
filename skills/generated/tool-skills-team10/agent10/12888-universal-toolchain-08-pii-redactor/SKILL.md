---
name: universal-toolchain-08-pii-redactor
description: Use when tasks require universal toolchain 08 pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 PII Redactor

## Purpose
Design and execute universal toolchain 08 workflows using pii redactor controls with validated outcomes.
