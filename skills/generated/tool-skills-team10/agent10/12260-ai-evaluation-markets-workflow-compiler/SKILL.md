---
name: ai-evaluation-markets-workflow-compiler
description: Use when tasks require ai evaluation markets workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Workflow Compiler

## Purpose
Design and execute ai evaluation markets workflows using workflow compiler controls with validated outcomes.
