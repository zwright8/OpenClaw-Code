...
description: Use when tasks require universal toolchain 05 incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Incident Triage

## Purpose
Design and execute universal toolchain 05 workflows using incident triage controls with validated outcomes.
