---
name: universal-toolchain-08-access-auditor
description: Use when tasks require universal toolchain 08 access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Access Auditor

## Purpose
Design and execute universal toolchain 08 workflows using access auditor controls with validated outcomes.
