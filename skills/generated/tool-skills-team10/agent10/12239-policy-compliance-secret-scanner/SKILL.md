---
name: policy-compliance-secret-scanner
description: Use when tasks require policy compliance secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Compliance Secret Scanner

## Purpose
Design and execute policy compliance workflows using secret scanner controls with validated outcomes.
