---
name: protocol-management-compliance-mapper
description: Use when tasks require protocol management compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Compliance Mapper

## Purpose
Design and execute protocol management workflows using compliance mapper controls with validated outcomes.
