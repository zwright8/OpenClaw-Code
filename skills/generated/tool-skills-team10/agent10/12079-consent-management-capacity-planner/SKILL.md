---
name: consent-management-capacity-planner
description: Use when tasks require consent management capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Capacity Planner

## Purpose
Design and execute consent management workflows using capacity planner controls with validated outcomes.
