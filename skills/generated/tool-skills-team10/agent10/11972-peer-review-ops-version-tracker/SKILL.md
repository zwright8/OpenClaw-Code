---
name: peer-review-ops-version-tracker
description: Use when tasks require peer review ops version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Version Tracker

## Purpose
Design and execute peer review ops workflows using version tracker controls with validated outcomes.
