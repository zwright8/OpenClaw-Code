...
description: Use when tasks require universal toolchain 05 quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Quality Gatekeeper

## Purpose
Design and execute universal toolchain 05 workflows using quality gatekeeper controls with validated outcomes.
