---
name: simulation-environments-capacity-planner
description: Use when tasks require simulation environments capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Simulation Environments Capacity Planner

## Purpose
Design and execute simulation environments workflows using capacity planner controls with validated outcomes.
