---
name: universal-toolchain-03-artifact-publisher
description: Use when tasks require universal toolchain 03 artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Artifact Publisher

## Purpose
Design and execute universal toolchain 03 workflows using artifact publisher controls with validated outcomes.
