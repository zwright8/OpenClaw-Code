---
name: audit-trails-pii-redactor
description: Use when tasks require audit trails pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails PII Redactor

## Purpose
Design and execute audit trails workflows using pii redactor controls with validated outcomes.
