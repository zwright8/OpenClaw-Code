---
name: service-quality-forecast-engine
description: Use when tasks require service quality forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Forecast Engine

## Purpose
Design and execute service quality workflows using forecast engine controls with validated outcomes.
