---
name: consent-management-forecast-engine
description: Use when tasks require consent management forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Forecast Engine

## Purpose
Design and execute consent management workflows using forecast engine controls with validated outcomes.
