---
name: autonomy-control-compliance-mapper
description: Use when tasks require autonomy control compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Compliance Mapper

## Purpose
Design and execute autonomy control workflows using compliance mapper controls with validated outcomes.
