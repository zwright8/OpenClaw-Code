---
name: policy-compliance-dependency-resolver
description: Use when tasks require policy compliance dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Policy Compliance Dependency Resolver

## Purpose
Design and execute policy compliance workflows using dependency resolver controls with validated outcomes.
