---
name: service-quality-approval-orchestrator
description: Use when tasks require service quality approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Approval Orchestrator

## Purpose
Design and execute service quality workflows using approval orchestrator controls with validated outcomes.
