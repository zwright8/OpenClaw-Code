---
name: consent-management-approval-orchestrator
description: Use when tasks require consent management approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Approval Orchestrator

## Purpose
Design and execute consent management workflows using approval orchestrator controls with validated outcomes.
