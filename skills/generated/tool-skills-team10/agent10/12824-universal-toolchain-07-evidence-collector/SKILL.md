...
description: Use when tasks require universal toolchain 07 evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 07 Evidence Collector

## Purpose
Design and execute universal toolchain 07 workflows using evidence collector controls with validated outcomes.
