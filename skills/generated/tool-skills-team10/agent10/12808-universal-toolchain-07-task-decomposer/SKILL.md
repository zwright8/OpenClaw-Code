---
name: universal-toolchain-07-task-decomposer
description: Use when tasks require universal toolchain 07 task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 07 Task Decomposer

## Purpose
Design and execute universal toolchain 07 workflows using task decomposer controls with validated outcomes.
