---
name: universal-toolchain-08-conflict-resolver
description: Use when tasks require universal toolchain 08 conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Conflict Resolver

## Purpose
Design and execute universal toolchain 08 workflows using conflict resolver controls with validated outcomes.
