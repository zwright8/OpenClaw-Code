---
name: service-quality-risk-scorer
description: Use when tasks require service quality risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Risk Scorer

## Purpose
Design and execute service quality workflows using risk scorer controls with validated outcomes.
