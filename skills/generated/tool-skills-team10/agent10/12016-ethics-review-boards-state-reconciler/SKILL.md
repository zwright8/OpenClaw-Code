---
name: ethics-review-boards-state-reconciler
description: Use when tasks require ethics review boards state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards State Reconciler

## Purpose
Design and execute ethics review boards workflows using state reconciler controls with validated outcomes.
