---
name: autonomy-control-forecast-engine
description: Use when tasks require autonomy control forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Forecast Engine

## Purpose
Design and execute autonomy control workflows using forecast engine controls with validated outcomes.
