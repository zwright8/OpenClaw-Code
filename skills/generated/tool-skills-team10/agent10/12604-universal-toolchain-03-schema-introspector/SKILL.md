---
name: universal-toolchain-03-schema-introspector
description: Use when tasks require universal toolchain 03 schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Schema Introspector

## Purpose
Design and execute universal toolchain 03 workflows using schema introspector controls with validated outcomes.
