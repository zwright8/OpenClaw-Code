---
name: ai-evaluation-markets-compliance-mapper
description: Use when tasks require ai evaluation markets compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Compliance Mapper

## Purpose
Design and execute ai evaluation markets workflows using compliance mapper controls with validated outcomes.
