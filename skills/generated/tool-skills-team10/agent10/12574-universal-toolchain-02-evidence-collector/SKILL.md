---
name: universal-toolchain-02-evidence-collector
description: Use when tasks require universal toolchain 02 evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Evidence Collector

## Purpose
Design and execute universal toolchain 02 workflows using evidence collector controls with validated outcomes.
