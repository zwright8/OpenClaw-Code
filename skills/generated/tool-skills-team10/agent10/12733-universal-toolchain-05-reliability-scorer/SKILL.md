---
name: universal-toolchain-05-reliability-scorer
description: Use when tasks require universal toolchain 05 reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Reliability Scorer

## Purpose
Design and execute universal toolchain 05 workflows using reliability scorer controls with validated outcomes.
