---
name: benchmark-repositories-dependency-resolver
description: Use when tasks require benchmark repositories dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Dependency Resolver

## Purpose
Design and execute benchmark repositories workflows using dependency resolver controls with validated outcomes.
