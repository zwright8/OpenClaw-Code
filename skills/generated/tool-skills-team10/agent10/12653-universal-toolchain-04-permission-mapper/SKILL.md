---
name: universal-toolchain-04-permission-mapper
description: Use when tasks require universal toolchain 04 permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Permission Mapper

## Purpose
Design and execute universal toolchain 04 workflows using permission mapper controls with validated outcomes.
