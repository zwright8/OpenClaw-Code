---
name: sensitive-data-governance-permission-mapper
description: Use when tasks require sensitive data governance permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Permission Mapper

## Purpose
Design and execute sensitive data governance workflows using permission mapper controls with validated outcomes.
