---
name: sensitive-data-governance-secret-scanner
description: Use when tasks require sensitive data governance secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Secret Scanner

## Purpose
Design and execute sensitive data governance workflows using secret scanner controls with validated outcomes.
