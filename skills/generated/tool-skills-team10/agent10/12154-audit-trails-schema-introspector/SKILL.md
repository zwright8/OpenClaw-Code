---
name: audit-trails-schema-introspector
description: Use when tasks require audit trails schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Schema Introspector

## Purpose
Design and execute audit trails workflows using schema introspector controls with validated outcomes.
