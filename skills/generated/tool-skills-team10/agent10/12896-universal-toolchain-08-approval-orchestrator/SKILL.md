---
name: universal-toolchain-08-approval-orchestrator
description: Use when tasks require universal toolchain 08 approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Approval Orchestrator

## Purpose
Design and execute universal toolchain 08 workflows using approval orchestrator controls with validated outcomes.
