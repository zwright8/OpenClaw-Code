---
name: universal-toolchain-07-postmortem-drafting
description: Use when tasks require universal toolchain 07 postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 07 Postmortem Drafting

## Purpose
Design and execute universal toolchain 07 workflows using postmortem drafting controls with validated outcomes.
