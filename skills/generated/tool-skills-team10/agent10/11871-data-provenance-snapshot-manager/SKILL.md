---
name: data-provenance-snapshot-manager
description: Use when tasks require data provenance snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Snapshot Manager

## Purpose
Design and execute data provenance workflows using snapshot manager controls with validated outcomes.
