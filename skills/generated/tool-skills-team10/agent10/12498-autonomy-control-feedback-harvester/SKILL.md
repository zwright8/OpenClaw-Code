---
name: autonomy-control-feedback-harvester
description: Use when tasks require autonomy control feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Feedback Harvester

## Purpose
Design and execute autonomy control workflows using feedback harvester controls with validated outcomes.
