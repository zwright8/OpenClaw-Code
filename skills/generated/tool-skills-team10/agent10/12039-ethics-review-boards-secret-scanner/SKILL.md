---
name: ethics-review-boards-secret-scanner
description: Use when tasks require ethics review boards secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Secret Scanner

## Purpose
Design and execute ethics review boards workflows using secret scanner controls with validated outcomes.
