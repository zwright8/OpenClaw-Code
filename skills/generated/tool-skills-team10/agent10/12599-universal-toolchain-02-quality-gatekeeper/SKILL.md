---
name: universal-toolchain-02-quality-gatekeeper
description: Use when tasks require universal toolchain 02 quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Quality Gatekeeper

## Purpose
Design and execute universal toolchain 02 workflows using quality gatekeeper controls with validated outcomes.
