...
description: Use when tasks require universal toolchain 06 approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Approval Orchestrator

## Purpose
Design and execute universal toolchain 06 workflows using approval orchestrator controls with validated outcomes.
