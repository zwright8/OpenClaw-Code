---
name: consent-management-access-auditor
description: Use when tasks require consent management access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Access Auditor

## Purpose
Design and execute consent management workflows using access auditor controls with validated outcomes.
