---
name: sensitive-data-governance-provenance-tracker
description: Use when tasks require sensitive data governance provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Provenance Tracker

## Purpose
Design and execute sensitive data governance workflows using provenance tracker controls with validated outcomes.
