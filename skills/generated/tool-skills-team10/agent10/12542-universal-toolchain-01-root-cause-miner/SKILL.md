---
name: universal-toolchain-01-root-cause-miner
description: Use when tasks require universal toolchain 01 root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 01 Root Cause Miner

## Purpose
Design and execute universal toolchain 01 workflows using root cause miner controls with validated outcomes.
