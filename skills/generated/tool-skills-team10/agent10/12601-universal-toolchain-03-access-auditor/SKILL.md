---
name: universal-toolchain-03-access-auditor
description: Use when tasks require universal toolchain 03 access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Access Auditor

## Purpose
Design and execute universal toolchain 03 workflows using access auditor controls with validated outcomes.
