---
name: ai-evaluation-markets-approval-orchestrator
description: Use when tasks require ai evaluation markets approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Approval Orchestrator

## Purpose
Design and execute ai evaluation markets workflows using approval orchestrator controls with validated outcomes.
