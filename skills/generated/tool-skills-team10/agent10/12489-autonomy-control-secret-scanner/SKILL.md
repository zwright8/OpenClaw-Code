---
name: autonomy-control-secret-scanner
description: Use when tasks require autonomy control secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Secret Scanner

## Purpose
Design and execute autonomy control workflows using secret scanner controls with validated outcomes.
