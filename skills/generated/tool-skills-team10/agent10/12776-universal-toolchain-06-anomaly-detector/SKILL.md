...
description: Use when tasks require universal toolchain 06 anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 06 Anomaly Detector

## Purpose
Design and execute universal toolchain 06 workflows using anomaly detector controls with validated outcomes.
