---
name: autonomy-control-conflict-resolver
description: Use when tasks require autonomy control conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Conflict Resolver

## Purpose
Design and execute autonomy control workflows using conflict resolver controls with validated outcomes.
