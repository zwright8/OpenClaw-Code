---
name: universal-toolchain-05-access-auditor
description: Use when tasks require universal toolchain 05 access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Access Auditor

## Purpose
Design and execute universal toolchain 05 workflows using access auditor controls with validated outcomes.
