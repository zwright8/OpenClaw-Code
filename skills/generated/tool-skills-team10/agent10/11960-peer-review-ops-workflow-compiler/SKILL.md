---
name: peer-review-ops-workflow-compiler
description: Use when tasks require peer review ops workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Workflow Compiler

## Purpose
Design and execute peer review ops workflows using workflow compiler controls with validated outcomes.
