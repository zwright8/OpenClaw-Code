---
name: audit-trails-runbook-composer
description: Use when tasks require audit trails runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Runbook Composer

## Purpose
Design and execute audit trails workflows using runbook composer controls with validated outcomes.
