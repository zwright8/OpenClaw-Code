---
name: universal-toolchain-02-schema-introspector
description: Use when tasks require universal toolchain 02 schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Schema Introspector

## Purpose
Design and execute universal toolchain 02 workflows using schema introspector controls with validated outcomes.
