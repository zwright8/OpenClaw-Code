---
name: universal-toolchain-01-evidence-collector
description: Use when tasks require universal toolchain 01 evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 01 Evidence Collector

## Purpose
Design and execute universal toolchain 01 workflows using evidence collector controls with validated outcomes.
