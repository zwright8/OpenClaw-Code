---
name: audit-trails-compliance-mapper
description: Use when tasks require audit trails compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Compliance Mapper

## Purpose
Design and execute audit trails workflows using compliance mapper controls with validated outcomes.
