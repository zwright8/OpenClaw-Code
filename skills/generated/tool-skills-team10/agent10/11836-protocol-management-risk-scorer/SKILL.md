---
name: protocol-management-risk-scorer
description: Use when tasks require protocol management risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Risk Scorer

## Purpose
Design and execute protocol management workflows using risk scorer controls with validated outcomes.
