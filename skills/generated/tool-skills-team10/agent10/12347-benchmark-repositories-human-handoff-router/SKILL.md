---
name: benchmark-repositories-human-handoff-router
description: Use when tasks require benchmark repositories human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Human Handoff Router

## Purpose
Design and execute benchmark repositories workflows using human handoff router controls with validated outcomes.
