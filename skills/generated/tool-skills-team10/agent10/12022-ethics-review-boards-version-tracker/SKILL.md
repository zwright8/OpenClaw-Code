---
name: ethics-review-boards-version-tracker
description: Use when tasks require ethics review boards version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Version Tracker

## Purpose
Design and execute ethics review boards workflows using version tracker controls with validated outcomes.
