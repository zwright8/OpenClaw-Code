---
name: autonomy-control-dependency-resolver
description: Use when tasks require autonomy control dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Dependency Resolver

## Purpose
Design and execute autonomy control workflows using dependency resolver controls with validated outcomes.
