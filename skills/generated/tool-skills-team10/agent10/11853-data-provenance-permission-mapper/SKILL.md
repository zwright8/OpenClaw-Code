---
name: data-provenance-permission-mapper
description: Use when tasks require data provenance permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Permission Mapper

## Purpose
Design and execute data provenance workflows using permission mapper controls with validated outcomes.
