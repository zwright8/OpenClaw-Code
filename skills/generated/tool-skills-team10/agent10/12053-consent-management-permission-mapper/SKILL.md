---
name: consent-management-permission-mapper
description: Use when tasks require consent management permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Permission Mapper

## Purpose
Design and execute consent management workflows using permission mapper controls with validated outcomes.
