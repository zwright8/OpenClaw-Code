---
name: universal-toolchain-01-secret-scanner
description: Use when tasks require universal toolchain 01 secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 01 Secret Scanner

## Purpose
Design and execute universal toolchain 01 workflows using secret scanner controls with validated outcomes.
