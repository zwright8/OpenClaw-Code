---
name: ethics-review-boards-postmortem-drafting
description: Use when tasks require ethics review boards postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Postmortem Drafting

## Purpose
Design and execute ethics review boards workflows using postmortem drafting controls with validated outcomes.
