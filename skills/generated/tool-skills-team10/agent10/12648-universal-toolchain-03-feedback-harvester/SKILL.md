---
name: universal-toolchain-03-feedback-harvester
description: Use when tasks require universal toolchain 03 feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Feedback Harvester

## Purpose
Design and execute universal toolchain 03 workflows using feedback harvester controls with validated outcomes.
