---
name: simulation-environments-secret-scanner
description: Use when tasks require simulation environments secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Simulation Environments Secret Scanner

## Purpose
Design and execute simulation environments workflows using secret scanner controls with validated outcomes.
