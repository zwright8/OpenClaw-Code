---
name: service-quality-evidence-collector
description: Use when tasks require service quality evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Evidence Collector

## Purpose
Design and execute service quality workflows using evidence collector controls with validated outcomes.
