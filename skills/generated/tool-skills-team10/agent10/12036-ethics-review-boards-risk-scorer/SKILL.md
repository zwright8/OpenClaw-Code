---
name: ethics-review-boards-risk-scorer
description: Use when tasks require ethics review boards risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Risk Scorer

## Purpose
Design and execute ethics review boards workflows using risk scorer controls with validated outcomes.
