---
name: audit-trails-rollback-coordinator
description: Use when tasks require audit trails rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Rollback Coordinator

## Purpose
Design and execute audit trails workflows using rollback coordinator controls with validated outcomes.
