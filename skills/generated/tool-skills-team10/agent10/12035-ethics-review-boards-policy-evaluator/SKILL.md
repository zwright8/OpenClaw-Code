---
name: ethics-review-boards-policy-evaluator
description: Use when tasks require ethics review boards policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Policy Evaluator

## Purpose
Design and execute ethics review boards workflows using policy evaluator controls with validated outcomes.
