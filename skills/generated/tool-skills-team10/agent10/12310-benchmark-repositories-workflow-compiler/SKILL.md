---
name: benchmark-repositories-workflow-compiler
description: Use when tasks require benchmark repositories workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Workflow Compiler

## Purpose
Design and execute benchmark repositories workflows using workflow compiler controls with validated outcomes.
