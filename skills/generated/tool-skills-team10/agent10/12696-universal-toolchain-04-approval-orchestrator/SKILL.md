---
name: universal-toolchain-04-approval-orchestrator
description: Use when tasks require universal toolchain 04 approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Approval Orchestrator

## Purpose
Design and execute universal toolchain 04 workflows using approval orchestrator controls with validated outcomes.
