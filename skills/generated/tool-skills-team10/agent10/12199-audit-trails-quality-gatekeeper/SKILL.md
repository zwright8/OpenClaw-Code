---
name: audit-trails-quality-gatekeeper
description: Use when tasks require audit trails quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Quality Gatekeeper

## Purpose
Design and execute audit trails workflows using quality gatekeeper controls with validated outcomes.
