...
description: Use when tasks require universal toolchain 05 evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Evidence Collector

## Purpose
Design and execute universal toolchain 05 workflows using evidence collector controls with validated outcomes.
