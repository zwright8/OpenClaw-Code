---
name: data-provenance-feedback-harvester
description: Use when tasks require data provenance feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Feedback Harvester

## Purpose
Design and execute data provenance workflows using feedback harvester controls with validated outcomes.
