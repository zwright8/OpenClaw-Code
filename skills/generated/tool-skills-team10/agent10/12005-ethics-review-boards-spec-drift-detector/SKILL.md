---
name: ethics-review-boards-spec-drift-detector
description: Use when tasks require ethics review boards spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Spec Drift Detector

## Purpose
Design and execute ethics review boards workflows using spec drift detector controls with validated outcomes.
