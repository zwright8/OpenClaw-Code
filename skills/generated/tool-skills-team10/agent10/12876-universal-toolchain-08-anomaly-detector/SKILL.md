---
name: universal-toolchain-08-anomaly-detector
description: Use when tasks require universal toolchain 08 anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Anomaly Detector

## Purpose
Design and execute universal toolchain 08 workflows using anomaly detector controls with validated outcomes.
