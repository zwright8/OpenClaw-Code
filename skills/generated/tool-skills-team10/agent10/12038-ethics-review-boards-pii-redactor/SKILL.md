---
name: ethics-review-boards-pii-redactor
description: Use when tasks require ethics review boards pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards PII Redactor

## Purpose
Design and execute ethics review boards workflows using pii redactor controls with validated outcomes.
