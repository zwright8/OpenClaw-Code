---
name: universal-toolchain-03-anomaly-detector
description: Use when tasks require universal toolchain 03 anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Anomaly Detector

## Purpose
Design and execute universal toolchain 03 workflows using anomaly detector controls with validated outcomes.
