---
name: peer-review-ops-human-handoff-router
description: Use when tasks require peer review ops human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Human Handoff Router

## Purpose
Design and execute peer review ops workflows using human handoff router controls with validated outcomes.
