---
name: autonomy-control-execution-runner
description: Use when tasks require autonomy control execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Execution Runner

## Purpose
Design and execute autonomy control workflows using execution runner controls with validated outcomes.
