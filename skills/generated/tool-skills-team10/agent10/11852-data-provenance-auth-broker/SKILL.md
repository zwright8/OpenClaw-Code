---
name: data-provenance-auth-broker
description: Use when tasks require data provenance auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Auth Broker

## Purpose
Design and execute data provenance workflows using auth broker controls with validated outcomes.
