---
name: universal-toolchain-02-approval-orchestrator
description: Use when tasks require universal toolchain 02 approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Approval Orchestrator

## Purpose
Design and execute universal toolchain 02 workflows using approval orchestrator controls with validated outcomes.
