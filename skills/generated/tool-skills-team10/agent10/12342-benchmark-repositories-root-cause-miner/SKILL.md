---
name: benchmark-repositories-root-cause-miner
description: Use when tasks require benchmark repositories root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Root Cause Miner

## Purpose
Design and execute benchmark repositories workflows using root cause miner controls with validated outcomes.
