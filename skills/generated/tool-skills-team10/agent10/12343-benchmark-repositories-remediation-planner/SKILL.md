---
name: benchmark-repositories-remediation-planner
description: Use when tasks require benchmark repositories remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Remediation Planner

## Purpose
Design and execute benchmark repositories workflows using remediation planner controls with validated outcomes.
