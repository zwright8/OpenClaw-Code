---
name: audit-trails-artifact-publisher
description: Use when tasks require audit trails artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Artifact Publisher

## Purpose
Design and execute audit trails workflows using artifact publisher controls with validated outcomes.
