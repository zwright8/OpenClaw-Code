---
name: universal-toolchain-01-artifact-publisher
description: Use when tasks require universal toolchain 01 artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 01 Artifact Publisher

## Purpose
Design and execute universal toolchain 01 workflows using artifact publisher controls with validated outcomes.
