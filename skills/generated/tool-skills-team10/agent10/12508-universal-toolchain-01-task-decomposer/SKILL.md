---
name: universal-toolchain-01-task-decomposer
description: Use when tasks require universal toolchain 01 task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 01 Task Decomposer

## Purpose
Design and execute universal toolchain 01 workflows using task decomposer controls with validated outcomes.
