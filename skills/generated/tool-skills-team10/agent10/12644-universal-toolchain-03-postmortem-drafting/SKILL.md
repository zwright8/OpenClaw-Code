---
name: universal-toolchain-03-postmortem-drafting
description: Use when tasks require universal toolchain 03 postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Postmortem Drafting

## Purpose
Design and execute universal toolchain 03 workflows using postmortem drafting controls with validated outcomes.
