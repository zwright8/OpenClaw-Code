---
name: sensitive-data-governance-rollback-coordinator
description: Use when tasks require sensitive data governance rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Rollback Coordinator

## Purpose
Design and execute sensitive data governance workflows using rollback coordinator controls with validated outcomes.
