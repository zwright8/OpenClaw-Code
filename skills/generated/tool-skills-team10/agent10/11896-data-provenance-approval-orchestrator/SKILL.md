---
name: data-provenance-approval-orchestrator
description: Use when tasks require data provenance approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Approval Orchestrator

## Purpose
Design and execute data provenance workflows using approval orchestrator controls with validated outcomes.
