---
name: sensitive-data-governance-access-auditor
description: Use when tasks require sensitive data governance access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Access Auditor

## Purpose
Design and execute sensitive data governance workflows using access auditor controls with validated outcomes.
