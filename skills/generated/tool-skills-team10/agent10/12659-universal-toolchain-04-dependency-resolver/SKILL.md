---
name: universal-toolchain-04-dependency-resolver
description: Use when tasks require universal toolchain 04 dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Dependency Resolver

## Purpose
Design and execute universal toolchain 04 workflows using dependency resolver controls with validated outcomes.
