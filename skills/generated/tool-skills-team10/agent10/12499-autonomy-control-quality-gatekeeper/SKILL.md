---
name: autonomy-control-quality-gatekeeper
description: Use when tasks require autonomy control quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Quality Gatekeeper

## Purpose
Design and execute autonomy control workflows using quality gatekeeper controls with validated outcomes.
