---
name: universal-toolchain-02-conflict-resolver
description: Use when tasks require universal toolchain 02 conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Conflict Resolver

## Purpose
Design and execute universal toolchain 02 workflows using conflict resolver controls with validated outcomes.
