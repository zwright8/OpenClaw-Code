---
name: universal-toolchain-05-pii-redactor
description: Use when tasks require universal toolchain 05 pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 PII Redactor

## Purpose
Design and execute universal toolchain 05 workflows using pii redactor controls with validated outcomes.
