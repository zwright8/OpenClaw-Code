---
name: benchmark-repositories-quality-gatekeeper
description: Use when tasks require benchmark repositories quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Quality Gatekeeper

## Purpose
Design and execute benchmark repositories workflows using quality gatekeeper controls with validated outcomes.
