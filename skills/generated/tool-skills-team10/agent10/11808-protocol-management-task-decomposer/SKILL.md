---
name: protocol-management-task-decomposer
description: Use when tasks require protocol management task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Task Decomposer

## Purpose
Design and execute protocol management workflows using task decomposer controls with validated outcomes.
