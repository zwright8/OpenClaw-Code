---
name: sensitive-data-governance-evidence-collector
description: Use when tasks require sensitive data governance evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Evidence Collector

## Purpose
Design and execute sensitive data governance workflows using evidence collector controls with validated outcomes.
