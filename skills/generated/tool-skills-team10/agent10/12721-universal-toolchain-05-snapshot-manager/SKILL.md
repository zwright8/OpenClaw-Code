---
name: universal-toolchain-05-snapshot-manager
description: Use when tasks require universal toolchain 05 snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Snapshot Manager

## Purpose
Design and execute universal toolchain 05 workflows using snapshot manager controls with validated outcomes.
