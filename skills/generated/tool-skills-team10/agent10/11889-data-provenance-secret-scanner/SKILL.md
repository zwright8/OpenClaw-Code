---
name: data-provenance-secret-scanner
description: Use when tasks require data provenance secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Secret Scanner

## Purpose
Design and execute data provenance workflows using secret scanner controls with validated outcomes.
