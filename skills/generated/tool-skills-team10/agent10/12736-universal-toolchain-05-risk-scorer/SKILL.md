---
name: universal-toolchain-05-risk-scorer
description: Use when tasks require universal toolchain 05 risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Risk Scorer

## Purpose
Design and execute universal toolchain 05 workflows using risk scorer controls with validated outcomes.
