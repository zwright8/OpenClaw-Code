---
name: ethics-review-boards-delta-calculator
description: Use when tasks require ethics review boards delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Delta Calculator

## Purpose
Design and execute ethics review boards workflows using delta calculator controls with validated outcomes.
