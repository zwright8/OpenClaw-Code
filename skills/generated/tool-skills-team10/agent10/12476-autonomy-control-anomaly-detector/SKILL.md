---
name: autonomy-control-anomaly-detector
description: Use when tasks require autonomy control anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Anomaly Detector

## Purpose
Design and execute autonomy control workflows using anomaly detector controls with validated outcomes.
