---
name: peer-review-ops-risk-scorer
description: Use when tasks require peer review ops risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Risk Scorer

## Purpose
Design and execute peer review ops workflows using risk scorer controls with validated outcomes.
