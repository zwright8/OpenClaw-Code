---
name: consent-management-spec-drift-detector
description: Use when tasks require consent management spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Spec Drift Detector

## Purpose
Design and execute consent management workflows using spec drift detector controls with validated outcomes.
