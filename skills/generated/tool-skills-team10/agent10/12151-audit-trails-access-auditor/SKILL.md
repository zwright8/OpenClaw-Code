---
name: audit-trails-access-auditor
description: Use when tasks require audit trails access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audit Trails Access Auditor

## Purpose
Design and execute audit trails workflows using access auditor controls with validated outcomes.
