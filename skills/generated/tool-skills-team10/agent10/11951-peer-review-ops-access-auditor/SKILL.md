---
name: peer-review-ops-access-auditor
description: Use when tasks require peer review ops access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Access Auditor

## Purpose
Design and execute peer review ops workflows using access auditor controls with validated outcomes.
