---
name: service-quality-rollback-coordinator
description: Use when tasks require service quality rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Rollback Coordinator

## Purpose
Design and execute service quality workflows using rollback coordinator controls with validated outcomes.
