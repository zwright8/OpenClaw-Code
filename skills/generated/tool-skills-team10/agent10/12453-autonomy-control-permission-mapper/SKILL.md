---
name: autonomy-control-permission-mapper
description: Use when tasks require autonomy control permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Permission Mapper

## Purpose
Design and execute autonomy control workflows using permission mapper controls with validated outcomes.
