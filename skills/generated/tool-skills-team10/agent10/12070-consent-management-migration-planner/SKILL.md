---
name: consent-management-migration-planner
description: Use when tasks require consent management migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Migration Planner

## Purpose
Design and execute consent management workflows using migration planner controls with validated outcomes.
