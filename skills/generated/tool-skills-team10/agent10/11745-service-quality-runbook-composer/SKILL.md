---
name: service-quality-runbook-composer
description: Use when tasks require service quality runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Runbook Composer

## Purpose
Design and execute service quality workflows using runbook composer controls with validated outcomes.
