---
name: sensitive-data-governance-runbook-composer
description: Use when tasks require sensitive data governance runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Runbook Composer

## Purpose
Design and execute sensitive data governance workflows using runbook composer controls with validated outcomes.
