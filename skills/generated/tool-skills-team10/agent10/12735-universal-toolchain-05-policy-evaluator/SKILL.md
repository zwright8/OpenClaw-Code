---
name: universal-toolchain-05-policy-evaluator
description: Use when tasks require universal toolchain 05 policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Policy Evaluator

## Purpose
Design and execute universal toolchain 05 workflows using policy evaluator controls with validated outcomes.
