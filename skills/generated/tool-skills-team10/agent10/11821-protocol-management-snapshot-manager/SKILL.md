---
name: protocol-management-snapshot-manager
description: Use when tasks require protocol management snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Snapshot Manager

## Purpose
Design and execute protocol management workflows using snapshot manager controls with validated outcomes.
