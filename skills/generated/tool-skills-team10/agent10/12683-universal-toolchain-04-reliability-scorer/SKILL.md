---
name: universal-toolchain-04-reliability-scorer
description: Use when tasks require universal toolchain 04 reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Reliability Scorer

## Purpose
Design and execute universal toolchain 04 workflows using reliability scorer controls with validated outcomes.
