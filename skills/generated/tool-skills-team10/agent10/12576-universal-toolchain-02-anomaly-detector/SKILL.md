---
name: universal-toolchain-02-anomaly-detector
description: Use when tasks require universal toolchain 02 anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 02 Anomaly Detector

## Purpose
Design and execute universal toolchain 02 workflows using anomaly detector controls with validated outcomes.
