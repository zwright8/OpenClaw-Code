---
name: consent-management-secret-scanner
description: Use when tasks require consent management secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Secret Scanner

## Purpose
Design and execute consent management workflows using secret scanner controls with validated outcomes.
