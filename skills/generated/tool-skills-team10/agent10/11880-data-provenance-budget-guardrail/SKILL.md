---
name: data-provenance-budget-guardrail
description: Use when tasks require data provenance budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Budget Guardrail

## Purpose
Design and execute data provenance workflows using budget guardrail controls with validated outcomes.
