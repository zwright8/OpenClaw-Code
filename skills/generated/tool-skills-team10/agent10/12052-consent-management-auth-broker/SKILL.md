---
name: consent-management-auth-broker
description: Use when tasks require consent management auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Consent Management Auth Broker

## Purpose
Design and execute consent management workflows using auth broker controls with validated outcomes.
