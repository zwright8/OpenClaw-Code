---
name: universal-toolchain-08-artifact-publisher
description: Use when tasks require universal toolchain 08 artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 08 Artifact Publisher

## Purpose
Design and execute universal toolchain 08 workflows using artifact publisher controls with validated outcomes.
