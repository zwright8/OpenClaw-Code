...
description: Use when tasks require universal toolchain 05 artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Artifact Publisher

## Purpose
Design and execute universal toolchain 05 workflows using artifact publisher controls with validated outcomes.
