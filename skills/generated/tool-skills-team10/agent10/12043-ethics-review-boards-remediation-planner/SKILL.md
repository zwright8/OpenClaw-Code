---
name: ethics-review-boards-remediation-planner
description: Use when tasks require ethics review boards remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Remediation Planner

## Purpose
Design and execute ethics review boards workflows using remediation planner controls with validated outcomes.
