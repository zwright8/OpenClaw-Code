---
name: protocol-management-migration-planner
description: Use when tasks require protocol management migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Migration Planner

## Purpose
Design and execute protocol management workflows using migration planner controls with validated outcomes.
