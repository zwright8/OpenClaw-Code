---
name: autonomy-control-spec-drift-detector
description: Use when tasks require autonomy control spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Spec Drift Detector

## Purpose
Design and execute autonomy control workflows using spec drift detector controls with validated outcomes.
