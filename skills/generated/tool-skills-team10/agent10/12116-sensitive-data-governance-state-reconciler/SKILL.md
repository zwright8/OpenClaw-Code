---
name: sensitive-data-governance-state-reconciler
description: Use when tasks require sensitive data governance state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance State Reconciler

## Purpose
Design and execute sensitive data governance workflows using state reconciler controls with validated outcomes.
