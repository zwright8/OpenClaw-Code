---
name: sensitive-data-governance-snapshot-manager
description: Use when tasks require sensitive data governance snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Snapshot Manager

## Purpose
Design and execute sensitive data governance workflows using snapshot manager controls with validated outcomes.
