---
name: benchmark-repositories-artifact-publisher
description: Use when tasks require benchmark repositories artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories Artifact Publisher

## Purpose
Design and execute benchmark repositories workflows using artifact publisher controls with validated outcomes.
