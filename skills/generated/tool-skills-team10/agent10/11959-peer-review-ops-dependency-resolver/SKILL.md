---
name: peer-review-ops-dependency-resolver
description: Use when tasks require peer review ops dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Dependency Resolver

## Purpose
Design and execute peer review ops workflows using dependency resolver controls with validated outcomes.
