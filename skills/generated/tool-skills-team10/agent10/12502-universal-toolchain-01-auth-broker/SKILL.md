---
name: universal-toolchain-01-auth-broker
description: Use when tasks require universal toolchain 01 auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 01 Auth Broker

## Purpose
Design and execute universal toolchain 01 workflows using auth broker controls with validated outcomes.
