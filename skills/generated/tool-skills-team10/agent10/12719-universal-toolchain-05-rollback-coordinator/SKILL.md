---
name: universal-toolchain-05-rollback-coordinator
description: Use when tasks require universal toolchain 05 rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Rollback Coordinator

## Purpose
Design and execute universal toolchain 05 workflows using rollback coordinator controls with validated outcomes.
