---
name: autonomy-control-capacity-planner
description: Use when tasks require autonomy control capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Capacity Planner

## Purpose
Design and execute autonomy control workflows using capacity planner controls with validated outcomes.
