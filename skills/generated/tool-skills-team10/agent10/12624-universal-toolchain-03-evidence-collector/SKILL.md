---
name: universal-toolchain-03-evidence-collector
description: Use when tasks require universal toolchain 03 evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Evidence Collector

## Purpose
Design and execute universal toolchain 03 workflows using evidence collector controls with validated outcomes.
