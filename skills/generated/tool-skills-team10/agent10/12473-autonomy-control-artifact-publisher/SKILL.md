---
name: autonomy-control-artifact-publisher
description: Use when tasks require autonomy control artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Artifact Publisher

## Purpose
Design and execute autonomy control workflows using artifact publisher controls with validated outcomes.
