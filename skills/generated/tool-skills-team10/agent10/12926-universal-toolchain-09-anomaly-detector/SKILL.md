---
name: universal-toolchain-09-anomaly-detector
description: Use when tasks require universal toolchain 09 anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 09 Anomaly Detector

## Purpose
Design and execute universal toolchain 09 workflows using anomaly detector controls with validated outcomes.
