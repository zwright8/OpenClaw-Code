---
name: universal-toolchain-05-runbook-composer
description: Use when tasks require universal toolchain 05 runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 05 Runbook Composer

## Purpose
Design and execute universal toolchain 05 workflows using runbook composer controls with validated outcomes.
