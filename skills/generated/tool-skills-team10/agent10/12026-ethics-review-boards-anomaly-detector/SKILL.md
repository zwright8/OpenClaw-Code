...
description: Use when tasks require ethics review boards anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Anomaly Detector

## Purpose
Design and execute ethics review boards workflows using anomaly detector controls with validated outcomes.
