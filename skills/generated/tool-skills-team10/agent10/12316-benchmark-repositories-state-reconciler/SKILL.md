---
name: benchmark-repositories-state-reconciler
description: Use when tasks require benchmark repositories state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Benchmark Repositories State Reconciler

## Purpose
Design and execute benchmark repositories workflows using state reconciler controls with validated outcomes.
