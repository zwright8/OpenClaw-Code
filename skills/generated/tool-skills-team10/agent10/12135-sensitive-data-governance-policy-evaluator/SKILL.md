---
name: sensitive-data-governance-policy-evaluator
description: Use when tasks require sensitive data governance policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Policy Evaluator

## Purpose
Design and execute sensitive data governance workflows using policy evaluator controls with validated outcomes.
