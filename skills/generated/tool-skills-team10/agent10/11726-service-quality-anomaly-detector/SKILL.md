---
name: service-quality-anomaly-detector
description: Use when tasks require service quality anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Anomaly Detector

## Purpose
Design and execute service quality workflows using anomaly detector controls with validated outcomes.
