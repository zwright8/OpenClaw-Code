---
name: peer-review-ops-forecast-engine
description: Use when tasks require peer review ops forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Peer Review Ops Forecast Engine

## Purpose
Design and execute peer review ops workflows using forecast engine controls with validated outcomes.
