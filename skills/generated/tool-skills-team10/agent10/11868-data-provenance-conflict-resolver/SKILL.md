---
name: data-provenance-conflict-resolver
description: Use when tasks require data provenance conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Conflict Resolver

## Purpose
Design and execute data provenance workflows using conflict resolver controls with validated outcomes.
