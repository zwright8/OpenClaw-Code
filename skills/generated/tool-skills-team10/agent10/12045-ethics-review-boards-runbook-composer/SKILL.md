...
description: Use when tasks require ethics review boards runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ethics Review Boards Runbook Composer

## Purpose
Design and execute ethics review boards workflows using runbook composer controls with validated outcomes.
