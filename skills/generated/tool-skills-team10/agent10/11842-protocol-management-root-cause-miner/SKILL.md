---
name: protocol-management-root-cause-miner
description: Use when tasks require protocol management root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Protocol Management Root Cause Miner

## Purpose
Design and execute protocol management workflows using root cause miner controls with validated outcomes.
