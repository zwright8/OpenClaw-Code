---
name: simulation-environments-auth-broker
description: Use when tasks require simulation environments auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Simulation Environments Auth Broker

## Purpose
Design and execute simulation environments workflows using auth broker controls with validated outcomes.
