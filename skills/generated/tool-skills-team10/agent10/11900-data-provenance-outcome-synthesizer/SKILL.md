---
name: data-provenance-outcome-synthesizer
description: Use when tasks require data provenance outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Provenance Outcome Synthesizer

## Purpose
Design and execute data provenance workflows using outcome synthesizer controls with validated outcomes.
