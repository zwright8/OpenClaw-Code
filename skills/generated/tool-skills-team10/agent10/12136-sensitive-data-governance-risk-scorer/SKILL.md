---
name: sensitive-data-governance-risk-scorer
description: Use when tasks require sensitive data governance risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensitive Data Governance Risk Scorer

## Purpose
Design and execute sensitive data governance workflows using risk scorer controls with validated outcomes.
