---
name: service-quality-root-cause-miner
description: Use when tasks require service quality root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Quality Root Cause Miner

## Purpose
Design and execute service quality workflows using root cause miner controls with validated outcomes.
