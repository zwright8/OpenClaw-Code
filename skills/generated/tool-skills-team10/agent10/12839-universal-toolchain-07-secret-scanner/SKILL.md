---
name: universal-toolchain-07-secret-scanner
description: Use when tasks require universal toolchain 07 secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 07 Secret Scanner

## Purpose
Design and execute universal toolchain 07 workflows using secret scanner controls with validated outcomes.
