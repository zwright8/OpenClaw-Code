---
name: universal-toolchain-04-secret-scanner
description: Use when tasks require universal toolchain 04 secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 04 Secret Scanner

## Purpose
Design and execute universal toolchain 04 workflows using secret scanner controls with validated outcomes.
