---
name: autonomy-control-rate-limit-optimizer
description: Use when tasks require autonomy control rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Autonomy Control Rate Limit Optimizer

## Purpose
Design and execute autonomy control workflows using rate limit optimizer controls with validated outcomes.
