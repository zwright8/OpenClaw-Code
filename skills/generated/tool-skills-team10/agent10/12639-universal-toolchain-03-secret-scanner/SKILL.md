---
name: universal-toolchain-03-secret-scanner
description: Use when tasks require universal toolchain 03 secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Universal Toolchain 03 Secret Scanner

## Purpose
Design and execute universal toolchain 03 workflows using secret scanner controls with validated outcomes.
