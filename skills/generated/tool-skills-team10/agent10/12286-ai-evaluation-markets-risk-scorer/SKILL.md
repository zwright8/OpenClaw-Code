---
name: ai-evaluation-markets-risk-scorer
description: Use when tasks require ai evaluation markets risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AI Evaluation Markets Risk Scorer

## Purpose
Design and execute ai evaluation markets workflows using risk scorer controls with validated outcomes.
