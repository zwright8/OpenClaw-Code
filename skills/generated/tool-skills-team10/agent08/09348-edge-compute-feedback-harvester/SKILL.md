---
name: edge-compute-feedback-harvester
description: Use when tasks require edge compute feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Feedback Harvester

## Purpose
Design and execute edge compute workflows using feedback harvester controls with validated outcomes.
