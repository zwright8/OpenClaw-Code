---
name: accessibility-auditing-evidence-collector
description: Use when tasks require accessibility auditing evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Evidence Collector

## Purpose
Design and execute accessibility auditing workflows using evidence collector controls with validated outcomes.
