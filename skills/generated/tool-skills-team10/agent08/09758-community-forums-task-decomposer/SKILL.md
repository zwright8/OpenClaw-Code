---
name: community-forums-task-decomposer
description: Use when tasks require community forums task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Task Decomposer

## Purpose
Design and execute community forums workflows using task decomposer controls with validated outcomes.
