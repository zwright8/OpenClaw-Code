---
name: live-event-ops-spec-drift-detector
description: Use when tasks require live event ops spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Spec Drift Detector

## Purpose
Design and execute live event ops workflows using spec drift detector controls with validated outcomes.
