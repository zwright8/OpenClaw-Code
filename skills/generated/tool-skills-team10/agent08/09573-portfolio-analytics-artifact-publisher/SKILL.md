---
name: portfolio-analytics-artifact-publisher
description: Use when tasks require portfolio analytics artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Artifact Publisher

## Purpose
Design and execute portfolio analytics workflows using artifact publisher controls with validated outcomes.
