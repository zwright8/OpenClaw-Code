---
name: onboarding-journeys-pii-redactor
description: Use when tasks require onboarding journeys pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys PII Redactor

## Purpose
Design and execute onboarding journeys workflows using pii redactor controls with validated outcomes.
