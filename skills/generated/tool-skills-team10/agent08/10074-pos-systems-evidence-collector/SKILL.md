---
name: pos-systems-evidence-collector
description: Use when tasks require pos systems evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Evidence Collector

## Purpose
Design and execute pos systems workflows using evidence collector controls with validated outcomes.
