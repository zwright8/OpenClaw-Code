---
name: streaming-operations-workflow-compiler
description: Use when tasks require streaming operations workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Workflow Compiler

## Purpose
Design and execute streaming operations workflows using workflow compiler controls with validated outcomes.
