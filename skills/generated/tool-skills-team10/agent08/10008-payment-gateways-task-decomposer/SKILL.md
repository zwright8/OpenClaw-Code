---
name: payment-gateways-task-decomposer
description: Use when tasks require payment gateways task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Task Decomposer

## Purpose
Design and execute payment gateways workflows using task decomposer controls with validated outcomes.
