---
name: merchant-risk-workflow-compiler
description: Use when tasks require merchant risk workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Workflow Compiler

## Purpose
Design and execute merchant risk workflows using workflow compiler controls with validated outcomes.
