---
name: identity-verification-runbook-composer
description: Use when tasks require identity verification runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Runbook Composer

## Purpose
Design and execute identity verification workflows using runbook composer controls with validated outcomes.
