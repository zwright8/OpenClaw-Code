---
name: streaming-operations-runbook-composer
description: Use when tasks require streaming operations runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Runbook Composer

## Purpose
Design and execute streaming operations workflows using runbook composer controls with validated outcomes.
