---
name: merchant-risk-operation-planner
description: Use when tasks require merchant risk operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Operation Planner

## Purpose
Design and execute merchant risk workflows using operation planner controls with validated outcomes.
