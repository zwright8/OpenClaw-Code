---
name: terminology-mgmt-capacity-planner
description: Use when tasks require terminology mgmt capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Capacity Planner

## Purpose
Design and execute terminology mgmt workflows using capacity planner controls with validated outcomes.
