---
name: community-forums-artifact-publisher
description: Use when tasks require community forums artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Artifact Publisher

## Purpose
Design and execute community forums workflows using artifact publisher controls with validated outcomes.
