---
name: merchant-risk-provenance-tracker
description: Use when tasks require merchant risk provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Provenance Tracker

## Purpose
Design and execute merchant risk workflows using provenance tracker controls with validated outcomes.
