---
name: kyc-pipelines-permission-mapper
description: Use when tasks require kyc pipelines permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Permission Mapper

## Purpose
Design and execute kyc pipelines workflows using permission mapper controls with validated outcomes.
