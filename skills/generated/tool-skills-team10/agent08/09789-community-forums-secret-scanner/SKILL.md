---
name: community-forums-secret-scanner
description: Use when tasks require community forums secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Secret Scanner

## Purpose
Design and execute community forums workflows using secret scanner controls with validated outcomes.
