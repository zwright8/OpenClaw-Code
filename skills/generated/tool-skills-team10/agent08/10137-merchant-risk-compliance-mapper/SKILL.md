---
name: merchant-risk-compliance-mapper
description: Use when tasks require merchant risk compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Compliance Mapper

## Purpose
Design and execute merchant risk workflows using compliance mapper controls with validated outcomes.
