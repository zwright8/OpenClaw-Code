---
name: sensor-fusion-postmortem-drafting
description: Use when tasks require sensor fusion postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Postmortem Drafting

## Purpose
Design and execute sensor fusion workflows using postmortem drafting controls with validated outcomes.
