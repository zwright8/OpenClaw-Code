---
name: kyc-pipelines-capacity-planner
description: Use when tasks require kyc pipelines capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Capacity Planner

## Purpose
Design and execute kyc pipelines workflows using capacity planner controls with validated outcomes.
