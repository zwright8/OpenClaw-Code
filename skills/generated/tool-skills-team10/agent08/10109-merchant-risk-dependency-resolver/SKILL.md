---
name: merchant-risk-dependency-resolver
description: Use when tasks require merchant risk dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Dependency Resolver

## Purpose
Design and execute merchant risk workflows using dependency resolver controls with validated outcomes.
