---
name: settlement-reconciliation-human-handoff-router
description: Use when tasks require settlement reconciliation human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Settlement Reconciliation Human Handoff Router

## Purpose
Design and execute settlement reconciliation workflows using human handoff router controls with validated outcomes.
