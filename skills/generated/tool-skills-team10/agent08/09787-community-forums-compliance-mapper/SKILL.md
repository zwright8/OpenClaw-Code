---
name: community-forums-compliance-mapper
description: Use when tasks require community forums compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Compliance Mapper

## Purpose
Design and execute community forums workflows using compliance mapper controls with validated outcomes.
