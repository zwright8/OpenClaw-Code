---
name: accessibility-auditing-incident-triage
description: Use when tasks require accessibility auditing incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Incident Triage

## Purpose
Design and execute accessibility auditing workflows using incident triage controls with validated outcomes.
