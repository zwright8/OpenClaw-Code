---
name: sensor-fusion-policy-evaluator
description: Use when tasks require sensor fusion policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Policy Evaluator

## Purpose
Design and execute sensor fusion workflows using policy evaluator controls with validated outcomes.
