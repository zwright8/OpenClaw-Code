---
name: edge-compute-policy-evaluator
description: Use when tasks require edge compute policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Policy Evaluator

## Purpose
Design and execute edge compute workflows using policy evaluator controls with validated outcomes.
