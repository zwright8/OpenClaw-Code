---
name: content-governance-access-auditor
description: Use when tasks require content governance access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Access Auditor

## Purpose
Design and execute content governance workflows using access auditor controls with validated outcomes.
