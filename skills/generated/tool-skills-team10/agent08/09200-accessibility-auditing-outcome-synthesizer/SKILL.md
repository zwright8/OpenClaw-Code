---
name: accessibility-auditing-outcome-synthesizer
description: Use when tasks require accessibility auditing outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Outcome Synthesizer

## Purpose
Design and execute accessibility auditing workflows using outcome synthesizer controls with validated outcomes.
