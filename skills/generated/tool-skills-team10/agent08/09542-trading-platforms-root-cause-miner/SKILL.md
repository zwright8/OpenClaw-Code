---
name: trading-platforms-root-cause-miner
description: Use when tasks require trading platforms root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Root Cause Miner

## Purpose
Design and execute trading platforms workflows using root cause miner controls with validated outcomes.
