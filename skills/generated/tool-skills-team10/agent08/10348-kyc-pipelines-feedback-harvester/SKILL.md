---
name: kyc-pipelines-feedback-harvester
description: Use when tasks require kyc pipelines feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Feedback Harvester

## Purpose
Design and execute kyc pipelines workflows using feedback harvester controls with validated outcomes.
