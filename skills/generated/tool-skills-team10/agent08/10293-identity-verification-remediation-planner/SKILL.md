---
name: identity-verification-remediation-planner
description: Use when tasks require identity verification remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Remediation Planner

## Purpose
Design and execute identity verification workflows using remediation planner controls with validated outcomes.
