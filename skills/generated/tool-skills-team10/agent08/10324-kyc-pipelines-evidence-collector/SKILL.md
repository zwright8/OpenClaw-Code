---
name: kyc-pipelines-evidence-collector
description: Use when tasks require kyc pipelines evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Evidence Collector

## Purpose
Design and execute kyc pipelines workflows using evidence collector controls with validated outcomes.
