---
name: onboarding-journeys-root-cause-miner
description: Use when tasks require onboarding journeys root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Root Cause Miner

## Purpose
Design and execute onboarding journeys workflows using root cause miner controls with validated outcomes.
