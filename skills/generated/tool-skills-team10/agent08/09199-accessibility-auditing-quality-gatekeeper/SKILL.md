---
name: accessibility-auditing-quality-gatekeeper
description: Use when tasks require accessibility auditing quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Quality Gatekeeper

## Purpose
Design and execute accessibility auditing workflows using quality gatekeeper controls with validated outcomes.
