---
name: sensor-fusion-runbook-composer
description: Use when tasks require sensor fusion runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Runbook Composer

## Purpose
Design and execute sensor fusion workflows using runbook composer controls with validated outcomes.
