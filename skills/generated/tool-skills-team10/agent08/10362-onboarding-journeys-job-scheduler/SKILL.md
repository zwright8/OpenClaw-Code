---
name: onboarding-journeys-job-scheduler
description: Use when tasks require onboarding journeys job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Job Scheduler

## Purpose
Design and execute onboarding journeys workflows using job scheduler controls with validated outcomes.
