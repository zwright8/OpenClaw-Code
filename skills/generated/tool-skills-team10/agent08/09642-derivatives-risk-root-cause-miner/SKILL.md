---
name: derivatives-risk-root-cause-miner
description: Use when tasks require derivatives risk root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Root Cause Miner

## Purpose
Design and execute derivatives risk workflows using root cause miner controls with validated outcomes.
