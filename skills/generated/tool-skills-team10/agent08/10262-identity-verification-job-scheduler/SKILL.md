---
name: identity-verification-job-scheduler
description: Use when tasks require identity verification job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Job Scheduler

## Purpose
Design and execute identity verification workflows using job scheduler controls with validated outcomes.
