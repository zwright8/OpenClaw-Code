---
name: edge-compute-permission-mapper
description: Use when tasks require edge compute permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Permission Mapper

## Purpose
Design and execute edge compute workflows using permission mapper controls with validated outcomes.
