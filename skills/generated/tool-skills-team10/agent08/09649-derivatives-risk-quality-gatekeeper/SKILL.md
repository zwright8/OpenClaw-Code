---
name: derivatives-risk-quality-gatekeeper
description: Use when tasks require derivatives risk quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Quality Gatekeeper

## Purpose
Design and execute derivatives risk workflows using quality gatekeeper controls with validated outcomes.
