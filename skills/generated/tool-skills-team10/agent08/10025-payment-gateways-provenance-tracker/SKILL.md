---
name: payment-gateways-provenance-tracker
description: Use when tasks require payment gateways provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Provenance Tracker

## Purpose
Design and execute payment gateways workflows using provenance tracker controls with validated outcomes.
