---
name: edge-compute-runbook-composer
description: Use when tasks require edge compute runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Runbook Composer

## Purpose
Design and execute edge compute workflows using runbook composer controls with validated outcomes.
