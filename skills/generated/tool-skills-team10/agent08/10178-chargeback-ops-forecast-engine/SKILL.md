---
name: chargeback-ops-forecast-engine
description: Use when tasks require chargeback ops forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Forecast Engine

## Purpose
Design and execute chargeback ops workflows using forecast engine controls with validated outcomes.
