---
name: community-forums-capacity-planner
description: Use when tasks require community forums capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Capacity Planner

## Purpose
Design and execute community forums workflows using capacity planner controls with validated outcomes.
