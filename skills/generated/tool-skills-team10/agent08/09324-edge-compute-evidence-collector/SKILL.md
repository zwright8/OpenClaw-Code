---
name: edge-compute-evidence-collector
description: Use when tasks require edge compute evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Evidence Collector

## Purpose
Design and execute edge compute workflows using evidence collector controls with validated outcomes.
