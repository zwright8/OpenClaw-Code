---
name: identity-verification-rollback-coordinator
description: Use when tasks require identity verification rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Rollback Coordinator

## Purpose
Design and execute identity verification workflows using rollback coordinator controls with validated outcomes.
