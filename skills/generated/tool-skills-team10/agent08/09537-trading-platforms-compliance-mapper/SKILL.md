---
name: trading-platforms-compliance-mapper
description: Use when tasks require trading platforms compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Compliance Mapper

## Purpose
Design and execute trading platforms workflows using compliance mapper controls with validated outcomes.
