---
name: merchant-risk-pii-redactor
description: Use when tasks require merchant risk pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk PII Redactor

## Purpose
Design and execute merchant risk workflows using pii redactor controls with validated outcomes.
