---
name: terminology-mgmt-evidence-collector
description: Use when tasks require terminology mgmt evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Evidence Collector

## Purpose
Design and execute terminology mgmt workflows using evidence collector controls with validated outcomes.
