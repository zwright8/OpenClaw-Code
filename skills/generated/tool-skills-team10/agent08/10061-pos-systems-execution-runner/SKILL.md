---
name: pos-systems-execution-runner
description: Use when tasks require pos systems execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Execution Runner

## Purpose
Design and execute pos systems workflows using execution runner controls with validated outcomes.
