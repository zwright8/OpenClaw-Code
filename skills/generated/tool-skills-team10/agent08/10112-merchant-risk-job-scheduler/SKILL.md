---
name: merchant-risk-job-scheduler
description: Use when tasks require merchant risk job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Job Scheduler

## Purpose
Design and execute merchant risk workflows using job scheduler controls with validated outcomes.
