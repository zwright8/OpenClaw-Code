---
name: kyc-pipelines-access-auditor
description: Use when tasks require kyc pipelines access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Access Auditor

## Purpose
Design and execute kyc pipelines workflows using access auditor controls with validated outcomes.
