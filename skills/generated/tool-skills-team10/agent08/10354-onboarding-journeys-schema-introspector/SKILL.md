---
name: onboarding-journeys-schema-introspector
description: Use when tasks require onboarding journeys schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Schema Introspector

## Purpose
Design and execute onboarding journeys workflows using schema introspector controls with validated outcomes.
