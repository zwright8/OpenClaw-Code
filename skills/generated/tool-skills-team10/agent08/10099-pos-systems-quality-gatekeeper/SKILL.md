---
name: pos-systems-quality-gatekeeper
description: Use when tasks require pos systems quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Quality Gatekeeper

## Purpose
Design and execute pos systems workflows using quality gatekeeper controls with validated outcomes.
