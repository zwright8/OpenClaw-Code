---
name: alternative-data-task-decomposer
description: Use when tasks require alternative data task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Task Decomposer

## Purpose
Design and execute alternative data workflows using task decomposer controls with validated outcomes.
