---
name: trading-platforms-conflict-resolver
description: Use when tasks require trading platforms conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Conflict Resolver

## Purpose
Design and execute trading platforms workflows using conflict resolver controls with validated outcomes.
