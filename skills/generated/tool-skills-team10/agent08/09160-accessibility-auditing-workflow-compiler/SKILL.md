---
name: accessibility-auditing-workflow-compiler
description: Use when tasks require accessibility auditing workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Workflow Compiler

## Purpose
Design and execute accessibility auditing workflows using workflow compiler controls with validated outcomes.
