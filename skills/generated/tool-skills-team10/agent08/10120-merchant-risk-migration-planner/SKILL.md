---
name: merchant-risk-migration-planner
description: Use when tasks require merchant risk migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Migration Planner

## Purpose
Design and execute merchant risk workflows using migration planner controls with validated outcomes.
