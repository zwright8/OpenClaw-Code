---
name: live-event-ops-snapshot-manager
description: Use when tasks require live event ops snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Snapshot Manager

## Purpose
Design and execute live event ops workflows using snapshot manager controls with validated outcomes.
