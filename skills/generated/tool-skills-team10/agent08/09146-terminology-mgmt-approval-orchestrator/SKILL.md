---
name: terminology-mgmt-approval-orchestrator
description: Use when tasks require terminology mgmt approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Approval Orchestrator

## Purpose
Design and execute terminology mgmt workflows using approval orchestrator controls with validated outcomes.
