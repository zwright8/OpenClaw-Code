---
name: accessibility-auditing-reliability-scorer
description: Use when tasks require accessibility auditing reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Reliability Scorer

## Purpose
Design and execute accessibility auditing workflows using reliability scorer controls with validated outcomes.
