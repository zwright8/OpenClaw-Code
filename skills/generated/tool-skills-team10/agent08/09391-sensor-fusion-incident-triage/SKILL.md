---
name: sensor-fusion-incident-triage
description: Use when tasks require sensor fusion incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Incident Triage

## Purpose
Design and execute sensor fusion workflows using incident triage controls with validated outcomes.
