---
name: content-governance-forecast-engine
description: Use when tasks require content governance forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Forecast Engine

## Purpose
Design and execute content governance workflows using forecast engine controls with validated outcomes.
