---
name: sensor-fusion-snapshot-manager
description: Use when tasks require sensor fusion snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Snapshot Manager

## Purpose
Design and execute sensor fusion workflows using snapshot manager controls with validated outcomes.
