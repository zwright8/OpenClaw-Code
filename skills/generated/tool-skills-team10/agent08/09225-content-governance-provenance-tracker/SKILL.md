---
name: content-governance-provenance-tracker
description: Use when tasks require content governance provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Provenance Tracker

## Purpose
Design and execute content governance workflows using provenance tracker controls with validated outcomes.
