---
name: alternative-data-forecast-engine
description: Use when tasks require alternative data forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Forecast Engine

## Purpose
Design and execute alternative data workflows using forecast engine controls with validated outcomes.
