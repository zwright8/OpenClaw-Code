---
name: portfolio-analytics-conflict-resolver
description: Use when tasks require portfolio analytics conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Conflict Resolver

## Purpose
Design and execute portfolio analytics workflows using conflict resolver controls with validated outcomes.
