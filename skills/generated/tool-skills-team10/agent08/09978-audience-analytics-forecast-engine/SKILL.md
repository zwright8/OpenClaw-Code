---
name: audience-analytics-forecast-engine
description: Use when tasks require audience analytics forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Forecast Engine

## Purpose
Design and execute audience analytics workflows using forecast engine controls with validated outcomes.
