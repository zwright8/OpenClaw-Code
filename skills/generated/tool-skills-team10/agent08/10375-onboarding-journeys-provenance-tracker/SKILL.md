---
name: onboarding-journeys-provenance-tracker
description: Use when tasks require onboarding journeys provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Provenance Tracker

## Purpose
Design and execute onboarding journeys workflows using provenance tracker controls with validated outcomes.
