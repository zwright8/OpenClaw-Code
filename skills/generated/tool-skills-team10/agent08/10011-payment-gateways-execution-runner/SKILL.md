---
name: payment-gateways-execution-runner
description: Use when tasks require payment gateways execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Execution Runner

## Purpose
Design and execute payment gateways workflows using execution runner controls with validated outcomes.
