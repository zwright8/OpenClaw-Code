---
name: merchant-risk-state-reconciler
description: Use when tasks require merchant risk state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk State Reconciler

## Purpose
Design and execute merchant risk workflows using state reconciler controls with validated outcomes.
