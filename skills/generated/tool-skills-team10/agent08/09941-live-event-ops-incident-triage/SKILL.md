---
name: live-event-ops-incident-triage
description: Use when tasks require live event ops incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Incident Triage

## Purpose
Design and execute live event ops workflows using incident triage controls with validated outcomes.
