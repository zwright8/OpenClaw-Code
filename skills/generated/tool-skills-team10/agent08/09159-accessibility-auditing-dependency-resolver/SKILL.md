---
name: accessibility-auditing-dependency-resolver
description: Use when tasks require accessibility auditing dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Dependency Resolver

## Purpose
Design and execute accessibility auditing workflows using dependency resolver controls with validated outcomes.
