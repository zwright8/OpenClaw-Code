---
name: merchant-risk-evidence-collector
description: Use when tasks require merchant risk evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Evidence Collector

## Purpose
Design and execute merchant risk workflows using evidence collector controls with validated outcomes.
