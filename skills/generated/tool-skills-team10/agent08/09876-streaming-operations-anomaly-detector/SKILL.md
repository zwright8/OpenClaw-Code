---
name: streaming-operations-anomaly-detector
description: Use when tasks require streaming operations anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Anomaly Detector

## Purpose
Design and execute streaming operations workflows using anomaly detector controls with validated outcomes.
