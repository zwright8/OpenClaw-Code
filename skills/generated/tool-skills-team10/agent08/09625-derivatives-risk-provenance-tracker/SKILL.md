---
name: derivatives-risk-provenance-tracker
description: Use when tasks require derivatives risk provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Provenance Tracker

## Purpose
Design and execute derivatives risk workflows using provenance tracker controls with validated outcomes.
