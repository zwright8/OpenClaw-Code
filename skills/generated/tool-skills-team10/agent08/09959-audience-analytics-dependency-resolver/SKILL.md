---
name: audience-analytics-dependency-resolver
description: Use when tasks require audience analytics dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Dependency Resolver

## Purpose
Design and execute audience analytics workflows using dependency resolver controls with validated outcomes.
