---
name: content-governance-outcome-synthesizer
description: Use when tasks require content governance outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Outcome Synthesizer

## Purpose
Design and execute content governance workflows using outcome synthesizer controls with validated outcomes.
