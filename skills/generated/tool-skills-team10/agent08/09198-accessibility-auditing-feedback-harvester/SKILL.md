---
name: accessibility-auditing-feedback-harvester
description: Use when tasks require accessibility auditing feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Feedback Harvester

## Purpose
Design and execute accessibility auditing workflows using feedback harvester controls with validated outcomes.
