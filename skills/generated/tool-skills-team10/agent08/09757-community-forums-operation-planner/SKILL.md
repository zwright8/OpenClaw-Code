---
name: community-forums-operation-planner
description: Use when tasks require community forums operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Operation Planner

## Purpose
Design and execute community forums workflows using operation planner controls with validated outcomes.
