---
name: payment-gateways-quality-gatekeeper
description: Use when tasks require payment gateways quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Quality Gatekeeper

## Purpose
Design and execute payment gateways workflows using quality gatekeeper controls with validated outcomes.
