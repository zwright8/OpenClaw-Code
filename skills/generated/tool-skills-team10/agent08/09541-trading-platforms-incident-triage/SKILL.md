---
name: trading-platforms-incident-triage
description: Use when tasks require trading platforms incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Incident Triage

## Purpose
Design and execute trading platforms workflows using incident triage controls with validated outcomes.
