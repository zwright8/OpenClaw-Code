---
name: terminology-mgmt-remediation-planner
description: Use when tasks require terminology mgmt remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Remediation Planner

## Purpose
Design and execute terminology mgmt workflows using remediation planner controls with validated outcomes.
