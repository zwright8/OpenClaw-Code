---
name: portfolio-analytics-schema-introspector
description: Use when tasks require portfolio analytics schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Schema Introspector

## Purpose
Design and execute portfolio analytics workflows using schema introspector controls with validated outcomes.
