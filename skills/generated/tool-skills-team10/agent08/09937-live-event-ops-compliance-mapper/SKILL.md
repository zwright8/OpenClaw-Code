---
name: live-event-ops-compliance-mapper
description: Use when tasks require live event ops compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Compliance Mapper

## Purpose
Design and execute live event ops workflows using compliance mapper controls with validated outcomes.
