---
name: onboarding-journeys-snapshot-manager
description: Use when tasks require onboarding journeys snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Snapshot Manager

## Purpose
Design and execute onboarding journeys workflows using snapshot manager controls with validated outcomes.
