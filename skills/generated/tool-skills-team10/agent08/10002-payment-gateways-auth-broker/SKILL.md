---
name: payment-gateways-auth-broker
description: Use when tasks require payment gateways auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Auth Broker

## Purpose
Design and execute payment gateways workflows using auth broker controls with validated outcomes.
