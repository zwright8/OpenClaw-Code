---
name: predictive-maintenance-migration-planner
description: Use when tasks require predictive maintenance migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Predictive Maintenance Migration Planner

## Purpose
Design and execute predictive maintenance workflows using migration planner controls with validated outcomes.
