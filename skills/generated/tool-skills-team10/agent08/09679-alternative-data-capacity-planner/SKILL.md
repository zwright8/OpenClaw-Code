---
name: alternative-data-capacity-planner
description: Use when tasks require alternative data capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Capacity Planner

## Purpose
Design and execute alternative data workflows using capacity planner controls with validated outcomes.
