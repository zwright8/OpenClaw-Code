---
name: settlement-reconciliation-conflict-resolver
description: Use when tasks require settlement reconciliation conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Settlement Reconciliation Conflict Resolver

## Purpose
Design and execute settlement reconciliation workflows using conflict resolver controls with validated outcomes.
