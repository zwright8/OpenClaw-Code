---
name: sensor-fusion-dependency-resolver
description: Use when tasks require sensor fusion dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Dependency Resolver

## Purpose
Design and execute sensor fusion workflows using dependency resolver controls with validated outcomes.
