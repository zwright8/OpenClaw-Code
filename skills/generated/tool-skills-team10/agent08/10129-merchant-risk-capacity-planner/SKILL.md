---
name: merchant-risk-capacity-planner
description: Use when tasks require merchant risk capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Capacity Planner

## Purpose
Design and execute merchant risk workflows using capacity planner controls with validated outcomes.
