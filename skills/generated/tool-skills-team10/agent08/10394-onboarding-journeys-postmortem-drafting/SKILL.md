---
name: onboarding-journeys-postmortem-drafting
description: Use when tasks require onboarding journeys postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Postmortem Drafting

## Purpose
Design and execute onboarding journeys workflows using postmortem drafting controls with validated outcomes.
