---
name: identity-verification-approval-orchestrator
description: Use when tasks require identity verification approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Approval Orchestrator

## Purpose
Design and execute identity verification workflows using approval orchestrator controls with validated outcomes.
