---
name: audience-analytics-cost-attribution
description: Use when tasks require audience analytics cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Cost Attribution

## Purpose
Design and execute audience analytics workflows using cost attribution controls with validated outcomes.
