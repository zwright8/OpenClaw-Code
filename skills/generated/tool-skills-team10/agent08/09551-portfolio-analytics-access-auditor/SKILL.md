---
name: portfolio-analytics-access-auditor
description: Use when tasks require portfolio analytics access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Access Auditor

## Purpose
Design and execute portfolio analytics workflows using access auditor controls with validated outcomes.
