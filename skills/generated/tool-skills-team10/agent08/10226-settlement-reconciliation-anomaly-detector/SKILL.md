---
name: settlement-reconciliation-anomaly-detector
description: Use when tasks require settlement reconciliation anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Settlement Reconciliation Anomaly Detector

## Purpose
Design and execute settlement reconciliation workflows using anomaly detector controls with validated outcomes.
