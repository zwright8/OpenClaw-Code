---
name: edge-compute-approval-orchestrator
description: Use when tasks require edge compute approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Approval Orchestrator

## Purpose
Design and execute edge compute workflows using approval orchestrator controls with validated outcomes.
