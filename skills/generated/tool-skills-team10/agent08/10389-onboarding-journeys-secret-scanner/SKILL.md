---
name: onboarding-journeys-secret-scanner
description: Use when tasks require onboarding journeys secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Secret Scanner

## Purpose
Design and execute onboarding journeys workflows using secret scanner controls with validated outcomes.
