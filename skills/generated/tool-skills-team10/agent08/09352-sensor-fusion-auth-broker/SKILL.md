---
name: sensor-fusion-auth-broker
description: Use when tasks require sensor fusion auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Auth Broker

## Purpose
Design and execute sensor fusion workflows using auth broker controls with validated outcomes.
