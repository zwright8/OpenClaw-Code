---
name: pos-systems-conflict-resolver
description: Use when tasks require pos systems conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Conflict Resolver

## Purpose
Design and execute pos systems workflows using conflict resolver controls with validated outcomes.
