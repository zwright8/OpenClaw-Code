---
name: chargeback-ops-anomaly-detector
description: Use when tasks require chargeback ops anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Anomaly Detector

## Purpose
Design and execute chargeback ops workflows using anomaly detector controls with validated outcomes.
