---
name: merchant-risk-delta-calculator
description: Use when tasks require merchant risk delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Delta Calculator

## Purpose
Design and execute merchant risk workflows using delta calculator controls with validated outcomes.
