---
name: accessibility-auditing-capacity-planner
description: Use when tasks require accessibility auditing capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Capacity Planner

## Purpose
Design and execute accessibility auditing workflows using capacity planner controls with validated outcomes.
