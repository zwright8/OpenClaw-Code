---
name: kyc-pipelines-compliance-mapper
description: Use when tasks require kyc pipelines compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Compliance Mapper

## Purpose
Design and execute kyc pipelines workflows using compliance mapper controls with validated outcomes.
