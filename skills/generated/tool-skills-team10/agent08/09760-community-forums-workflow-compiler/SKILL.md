---
name: community-forums-workflow-compiler
description: Use when tasks require community forums workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Workflow Compiler

## Purpose
Design and execute community forums workflows using workflow compiler controls with validated outcomes.
