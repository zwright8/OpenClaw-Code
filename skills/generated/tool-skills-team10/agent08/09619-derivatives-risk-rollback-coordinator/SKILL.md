---
name: derivatives-risk-rollback-coordinator
description: Use when tasks require derivatives risk rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Rollback Coordinator

## Purpose
Design and execute derivatives risk workflows using rollback coordinator controls with validated outcomes.
