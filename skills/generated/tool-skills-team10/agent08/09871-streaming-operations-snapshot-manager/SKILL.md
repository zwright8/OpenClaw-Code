---
name: streaming-operations-snapshot-manager
description: Use when tasks require streaming operations snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Snapshot Manager

## Purpose
Design and execute streaming operations workflows using snapshot manager controls with validated outcomes.
