---
name: chargeback-ops-snapshot-manager
description: Use when tasks require chargeback ops snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Snapshot Manager

## Purpose
Design and execute chargeback ops workflows using snapshot manager controls with validated outcomes.
