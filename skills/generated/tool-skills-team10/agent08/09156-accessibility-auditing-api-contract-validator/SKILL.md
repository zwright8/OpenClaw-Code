---
name: accessibility-auditing-api-contract-validator
description: Use when tasks require accessibility auditing api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing API Contract Validator

## Purpose
Design and execute accessibility auditing workflows using api contract validator controls with validated outcomes.

## Precision Profile
- Domain: Accessibility Auditing
...
- Domain: [Accessibility Auditing](../../resources/domains/accessibility-auditing.md)
