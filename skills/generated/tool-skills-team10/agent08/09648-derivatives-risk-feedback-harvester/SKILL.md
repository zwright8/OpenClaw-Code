---
name: derivatives-risk-feedback-harvester
description: Use when tasks require derivatives risk feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Feedback Harvester

## Purpose
Design and execute derivatives risk workflows using feedback harvester controls with validated outcomes.
