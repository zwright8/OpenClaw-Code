---
name: portfolio-analytics-capacity-planner
description: Use when tasks require portfolio analytics capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Capacity Planner

## Purpose
Design and execute portfolio analytics workflows using capacity planner controls with validated outcomes.
