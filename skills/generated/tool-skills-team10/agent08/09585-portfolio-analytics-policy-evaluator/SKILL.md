---
name: portfolio-analytics-policy-evaluator
description: Use when tasks require portfolio analytics policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Policy Evaluator

## Purpose
Design and execute portfolio analytics workflows using policy evaluator controls with validated outcomes.
