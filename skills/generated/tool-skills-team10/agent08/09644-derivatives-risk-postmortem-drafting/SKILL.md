---
name: derivatives-risk-postmortem-drafting
description: Use when tasks require derivatives risk postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Postmortem Drafting

## Purpose
Design and execute derivatives risk workflows using postmortem drafting controls with validated outcomes.
