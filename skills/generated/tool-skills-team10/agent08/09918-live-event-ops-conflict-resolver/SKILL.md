---
name: live-event-ops-conflict-resolver
description: Use when tasks require live event ops conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Conflict Resolver

## Purpose
Design and execute live event ops workflows using conflict resolver controls with validated outcomes.
