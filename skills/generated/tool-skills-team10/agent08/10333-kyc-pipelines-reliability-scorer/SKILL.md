---
name: kyc-pipelines-reliability-scorer
description: Use when tasks require kyc pipelines reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Reliability Scorer

## Purpose
Design and execute kyc pipelines workflows using reliability scorer controls with validated outcomes.
