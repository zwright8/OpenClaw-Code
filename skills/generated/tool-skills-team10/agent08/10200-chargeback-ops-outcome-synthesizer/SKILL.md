---
name: chargeback-ops-outcome-synthesizer
description: Use when tasks require chargeback ops outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Outcome Synthesizer

## Purpose
Design and execute chargeback ops workflows using outcome synthesizer controls with validated outcomes.
