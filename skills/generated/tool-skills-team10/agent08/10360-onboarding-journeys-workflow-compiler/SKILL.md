---
name: onboarding-journeys-workflow-compiler
description: Use when tasks require onboarding journeys workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Workflow Compiler

## Purpose
Design and execute onboarding journeys workflows using workflow compiler controls with validated outcomes.
