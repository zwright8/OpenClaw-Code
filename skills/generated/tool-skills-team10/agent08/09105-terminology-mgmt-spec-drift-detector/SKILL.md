---
name: terminology-mgmt-spec-drift-detector
description: Use when tasks require terminology mgmt spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Spec Drift Detector

## Purpose
Design and execute terminology mgmt workflows using spec drift detector controls with validated outcomes.
