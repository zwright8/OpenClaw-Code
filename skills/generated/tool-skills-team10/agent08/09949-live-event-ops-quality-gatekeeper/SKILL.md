---
name: live-event-ops-quality-gatekeeper
description: Use when tasks require live event ops quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Quality Gatekeeper

## Purpose
Design and execute live event ops workflows using quality gatekeeper controls with validated outcomes.
