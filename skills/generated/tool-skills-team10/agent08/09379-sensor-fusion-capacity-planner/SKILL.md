---
name: sensor-fusion-capacity-planner
description: Use when tasks require sensor fusion capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Capacity Planner

## Purpose
Design and execute sensor fusion workflows using capacity planner controls with validated outcomes.
