---
name: accessibility-auditing-latency-analyzer
description: Use when tasks require accessibility auditing latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Latency Analyzer

## Purpose
Design and execute accessibility auditing workflows using latency analyzer controls with validated outcomes.
