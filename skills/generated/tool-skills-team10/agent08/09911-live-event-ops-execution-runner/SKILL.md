---
name: live-event-ops-execution-runner
description: Use when tasks require live event ops execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Execution Runner

## Purpose
Design and execute live event ops workflows using execution runner controls with validated outcomes.
