---
name: alternative-data-feedback-harvester
description: Use when tasks require alternative data feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Feedback Harvester

## Purpose
Design and execute alternative data workflows using feedback harvester controls with validated outcomes.
