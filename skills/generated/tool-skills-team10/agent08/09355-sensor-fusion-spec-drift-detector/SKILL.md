---
name: sensor-fusion-spec-drift-detector
description: Use when tasks require sensor fusion spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Spec Drift Detector

## Purpose
Design and execute sensor fusion workflows using spec drift detector controls with validated outcomes.
