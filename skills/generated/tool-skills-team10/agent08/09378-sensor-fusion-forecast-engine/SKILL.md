---
name: sensor-fusion-forecast-engine
description: Use when tasks require sensor fusion forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Forecast Engine

## Purpose
Design and execute sensor fusion workflows using forecast engine controls with validated outcomes.
