---
name: identity-verification-postmortem-drafting
description: Use when tasks require identity verification postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Postmortem Drafting

## Purpose
Design and execute identity verification workflows using postmortem drafting controls with validated outcomes.
