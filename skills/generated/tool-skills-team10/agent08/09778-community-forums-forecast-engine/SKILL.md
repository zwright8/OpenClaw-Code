---
name: community-forums-forecast-engine
description: Use when tasks require community forums forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Forecast Engine

## Purpose
Design and execute community forums workflows using forecast engine controls with validated outcomes.
