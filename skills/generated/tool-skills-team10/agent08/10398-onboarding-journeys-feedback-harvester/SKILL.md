---
name: onboarding-journeys-feedback-harvester
description: Use when tasks require onboarding journeys feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Feedback Harvester

## Purpose
Design and execute onboarding journeys workflows using feedback harvester controls with validated outcomes.
