---
name: chargeback-ops-access-auditor
description: Use when tasks require chargeback ops access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Access Auditor

## Purpose
Design and execute chargeback ops workflows using access auditor controls with validated outcomes.
