---
name: audience-analytics-artifact-publisher
description: Use when tasks require audience analytics artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Artifact Publisher

## Purpose
Design and execute audience analytics workflows using artifact publisher controls with validated outcomes.
