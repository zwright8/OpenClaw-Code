---
name: onboarding-journeys-capacity-planner
description: Use when tasks require onboarding journeys capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Capacity Planner

## Purpose
Design and execute onboarding journeys workflows using capacity planner controls with validated outcomes.
