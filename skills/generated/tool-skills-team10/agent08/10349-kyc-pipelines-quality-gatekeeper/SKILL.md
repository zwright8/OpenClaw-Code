---
name: kyc-pipelines-quality-gatekeeper
description: Use when tasks require kyc pipelines quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Quality Gatekeeper

## Purpose
Design and execute kyc pipelines workflows using quality gatekeeper controls with validated outcomes.
