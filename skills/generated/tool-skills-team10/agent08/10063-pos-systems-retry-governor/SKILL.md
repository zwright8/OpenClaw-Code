---
name: pos-systems-retry-governor
description: Use when tasks require pos systems retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Retry Governor

## Purpose
Design and execute pos systems workflows using retry governor controls with validated outcomes.
