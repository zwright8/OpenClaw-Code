---
name: live-event-ops-capacity-planner
description: Use when tasks require live event ops capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Capacity Planner

## Purpose
Design and execute live event ops workflows using capacity planner controls with validated outcomes.
