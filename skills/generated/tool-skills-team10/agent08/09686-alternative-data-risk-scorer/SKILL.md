---
name: alternative-data-risk-scorer
description: Use when tasks require alternative data risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Risk Scorer

## Purpose
Design and execute alternative data workflows using risk scorer controls with validated outcomes.
