---
name: sensor-fusion-human-handoff-router
description: Use when tasks require sensor fusion human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Human Handoff Router

## Purpose
Design and execute sensor fusion workflows using human handoff router controls with validated outcomes.
