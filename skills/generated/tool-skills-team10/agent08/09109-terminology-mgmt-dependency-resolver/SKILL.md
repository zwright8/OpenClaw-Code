---
name: terminology-mgmt-dependency-resolver
description: Use when tasks require terminology mgmt dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Dependency Resolver

## Purpose
Design and execute terminology mgmt workflows using dependency resolver controls with validated outcomes.
