---
name: onboarding-journeys-permission-mapper
description: Use when tasks require onboarding journeys permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Permission Mapper

## Purpose
Design and execute onboarding journeys workflows using permission mapper controls with validated outcomes.
