---
name: trading-platforms-migration-planner
description: Use when tasks require trading platforms migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Migration Planner

## Purpose
Design and execute trading platforms workflows using migration planner controls with validated outcomes.
