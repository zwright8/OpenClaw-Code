---
name: content-governance-task-decomposer
description: Use when tasks require content governance task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Task Decomposer

## Purpose
Design and execute content governance workflows using task decomposer controls with validated outcomes.
