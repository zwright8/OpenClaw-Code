---
name: edge-compute-human-handoff-router
description: Use when tasks require edge compute human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Human Handoff Router

## Purpose
Design and execute edge compute workflows using human handoff router controls with validated outcomes.
