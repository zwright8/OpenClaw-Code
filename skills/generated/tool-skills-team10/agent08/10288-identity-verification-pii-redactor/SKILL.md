---
name: identity-verification-pii-redactor
description: Use when tasks require identity verification pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification PII Redactor

## Purpose
Design and execute identity verification workflows using pii redactor controls with validated outcomes.
