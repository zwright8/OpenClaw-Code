---
name: trading-platforms-policy-evaluator
description: Use when tasks require trading platforms policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Policy Evaluator

## Purpose
Design and execute trading platforms workflows using policy evaluator controls with validated outcomes.
