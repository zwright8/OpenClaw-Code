---
name: payment-gateways-outcome-synthesizer
description: Use when tasks require payment gateways outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Outcome Synthesizer

## Purpose
Design and execute payment gateways workflows using outcome synthesizer controls with validated outcomes.
