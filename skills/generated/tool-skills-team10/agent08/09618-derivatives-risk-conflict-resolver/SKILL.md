---
name: derivatives-risk-conflict-resolver
description: Use when tasks require derivatives risk conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Conflict Resolver

## Purpose
Design and execute derivatives risk workflows using conflict resolver controls with validated outcomes.
