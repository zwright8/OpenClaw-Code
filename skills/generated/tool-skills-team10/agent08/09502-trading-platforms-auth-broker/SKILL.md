---
name: trading-platforms-auth-broker
description: Use when tasks require trading platforms auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Auth Broker

## Purpose
Design and execute trading platforms workflows using auth broker controls with validated outcomes.
