---
name: identity-verification-provenance-tracker
description: Use when tasks require identity verification provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Provenance Tracker

## Purpose
Design and execute identity verification workflows using provenance tracker controls with validated outcomes.
