---
name: identity-verification-threshold-alerting
description: Use when tasks require identity verification threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Threshold Alerting

## Purpose
Design and execute identity verification workflows using threshold alerting controls with validated outcomes.
