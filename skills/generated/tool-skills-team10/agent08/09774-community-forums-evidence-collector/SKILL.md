---
name: community-forums-evidence-collector
description: Use when tasks require community forums evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Evidence Collector

## Purpose
Design and execute community forums workflows using evidence collector controls with validated outcomes.
