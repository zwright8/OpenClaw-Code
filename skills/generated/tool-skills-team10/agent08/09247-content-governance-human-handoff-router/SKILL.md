---
name: content-governance-human-handoff-router
description: Use when tasks require content governance human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Human Handoff Router

## Purpose
Design and execute content governance workflows using human handoff router controls with validated outcomes.
