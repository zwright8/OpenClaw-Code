---
name: onboarding-journeys-budget-guardrail
description: Use when tasks require onboarding journeys budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Budget Guardrail

## Purpose
Design and execute onboarding journeys workflows using budget guardrail controls with validated outcomes.
