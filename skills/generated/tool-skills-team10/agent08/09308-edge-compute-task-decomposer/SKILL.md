---
name: edge-compute-task-decomposer
description: Use when tasks require edge compute task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Task Decomposer

## Purpose
Design and execute edge compute workflows using task decomposer controls with validated outcomes.
