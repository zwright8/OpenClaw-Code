---
name: identity-verification-retry-governor
description: Use when tasks require identity verification retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Retry Governor

## Purpose
Design and execute identity verification workflows using retry governor controls with validated outcomes.
