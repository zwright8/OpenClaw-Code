---
name: live-event-ops-schema-introspector
description: Use when tasks require live event ops schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Schema Introspector

## Purpose
Design and execute live event ops workflows using schema introspector controls with validated outcomes.
