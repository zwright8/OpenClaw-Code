---
name: identity-verification-schema-introspector
description: Use when tasks require identity verification schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Schema Introspector

## Purpose
Design and execute identity verification workflows using schema introspector controls with validated outcomes.
