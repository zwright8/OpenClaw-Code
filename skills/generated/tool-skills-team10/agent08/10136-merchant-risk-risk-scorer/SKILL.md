---
name: merchant-risk-risk-scorer
description: Use when tasks require merchant risk risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Risk Scorer

## Purpose
Design and execute merchant risk workflows using risk scorer controls with validated outcomes.
