---
name: chargeback-ops-secret-scanner
description: Use when tasks require chargeback ops secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Secret Scanner

## Purpose
Design and execute chargeback ops workflows using secret scanner controls with validated outcomes.
