---
name: portfolio-analytics-secret-scanner
description: Use when tasks require portfolio analytics secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Secret Scanner

## Purpose
Design and execute portfolio analytics workflows using secret scanner controls with validated outcomes.
