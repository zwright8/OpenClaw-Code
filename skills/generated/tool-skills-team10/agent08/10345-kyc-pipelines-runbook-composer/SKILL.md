---
name: kyc-pipelines-runbook-composer
description: Use when tasks require kyc pipelines runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Runbook Composer

## Purpose
Design and execute kyc pipelines workflows using runbook composer controls with validated outcomes.
