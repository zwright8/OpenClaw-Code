---
name: sensor-fusion-execution-runner
description: Use when tasks require sensor fusion execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Execution Runner

## Purpose
Design and execute sensor fusion workflows using execution runner controls with validated outcomes.
