---
name: derivatives-risk-human-handoff-router
description: Use when tasks require derivatives risk human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Human Handoff Router

## Purpose
Design and execute derivatives risk workflows using human handoff router controls with validated outcomes.
