---
name: identity-verification-auth-broker
description: Use when tasks require identity verification auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Auth Broker

## Purpose
Design and execute identity verification workflows using auth broker controls with validated outcomes.
