---
name: community-forums-risk-scorer
description: Use when tasks require community forums risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Risk Scorer

## Purpose
Design and execute community forums workflows using risk scorer controls with validated outcomes.
