---
name: live-event-ops-auth-broker
description: Use when tasks require live event ops auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Auth Broker

## Purpose
Design and execute live event ops workflows using auth broker controls with validated outcomes.
