---
name: settlement-reconciliation-rollback-coordinator
description: Use when tasks require settlement reconciliation rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Settlement Reconciliation Rollback Coordinator

## Purpose
Design and execute settlement reconciliation workflows using rollback coordinator controls with validated outcomes.
