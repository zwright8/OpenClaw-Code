---
name: kyc-pipelines-execution-runner
description: Use when tasks require kyc pipelines execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Execution Runner

## Purpose
Design and execute kyc pipelines workflows using execution runner controls with validated outcomes.
