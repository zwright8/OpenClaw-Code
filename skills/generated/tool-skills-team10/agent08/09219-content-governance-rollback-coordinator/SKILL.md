---
name: content-governance-rollback-coordinator
description: Use when tasks require content governance rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Rollback Coordinator

## Purpose
Design and execute content governance workflows using rollback coordinator controls with validated outcomes.
