---
name: merchant-risk-permission-mapper
description: Use when tasks require merchant risk permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Permission Mapper

## Purpose
Design and execute merchant risk workflows using permission mapper controls with validated outcomes.
