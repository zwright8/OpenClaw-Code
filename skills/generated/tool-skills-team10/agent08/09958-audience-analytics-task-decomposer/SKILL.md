---
name: audience-analytics-task-decomposer
description: Use when tasks require audience analytics task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Task Decomposer

## Purpose
Design and execute audience analytics workflows using task decomposer controls with validated outcomes.
