---
name: onboarding-journeys-incident-triage
description: Use when tasks require onboarding journeys incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Incident Triage

## Purpose
Design and execute onboarding journeys workflows using incident triage controls with validated outcomes.
