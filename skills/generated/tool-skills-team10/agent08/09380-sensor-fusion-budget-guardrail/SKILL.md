---
name: sensor-fusion-budget-guardrail
description: Use when tasks require sensor fusion budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Budget Guardrail

## Purpose
Design and execute sensor fusion workflows using budget guardrail controls with validated outcomes.
