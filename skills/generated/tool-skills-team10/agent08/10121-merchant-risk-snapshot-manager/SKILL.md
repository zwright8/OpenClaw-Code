---
name: merchant-risk-snapshot-manager
description: Use when tasks require merchant risk snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Snapshot Manager

## Purpose
Design and execute merchant risk workflows using snapshot manager controls with validated outcomes.
