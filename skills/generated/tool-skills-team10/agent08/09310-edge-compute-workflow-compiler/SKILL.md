---
name: edge-compute-workflow-compiler
description: Use when tasks require edge compute workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Workflow Compiler

## Purpose
Design and execute edge compute workflows using workflow compiler controls with validated outcomes.
