---
name: live-event-ops-migration-planner
description: Use when tasks require live event ops migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Migration Planner

## Purpose
Design and execute live event ops workflows using migration planner controls with validated outcomes.
