---
name: trading-platforms-provenance-tracker
description: Use when tasks require trading platforms provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Provenance Tracker

## Purpose
Design and execute trading platforms workflows using provenance tracker controls with validated outcomes.
