---
name: merchant-risk-outcome-synthesizer
description: Use when tasks require merchant risk outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Outcome Synthesizer

## Purpose
Design and execute merchant risk workflows using outcome synthesizer controls with validated outcomes.
