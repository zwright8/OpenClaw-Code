---
name: payment-gateways-spec-drift-detector
description: Use when tasks require payment gateways spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Spec Drift Detector

## Purpose
Design and execute payment gateways workflows using spec drift detector controls with validated outcomes.
