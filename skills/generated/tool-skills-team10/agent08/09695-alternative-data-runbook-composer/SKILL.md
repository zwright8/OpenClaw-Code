---
name: alternative-data-runbook-composer
description: Use when tasks require alternative data runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Runbook Composer

## Purpose
Design and execute alternative data workflows using runbook composer controls with validated outcomes.
