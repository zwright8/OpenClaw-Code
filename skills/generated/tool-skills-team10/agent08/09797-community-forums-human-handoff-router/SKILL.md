---
name: community-forums-human-handoff-router
description: Use when tasks require community forums human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Human Handoff Router

## Purpose
Design and execute community forums workflows using human handoff router controls with validated outcomes.
