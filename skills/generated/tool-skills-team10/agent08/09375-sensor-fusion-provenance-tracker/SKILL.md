---
name: sensor-fusion-provenance-tracker
description: Use when tasks require sensor fusion provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Provenance Tracker

## Purpose
Design and execute sensor fusion workflows using provenance tracker controls with validated outcomes.
