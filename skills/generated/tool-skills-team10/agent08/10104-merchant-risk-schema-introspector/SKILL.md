---
name: merchant-risk-schema-introspector
description: Use when tasks require merchant risk schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Schema Introspector

## Purpose
Design and execute merchant risk workflows using schema introspector controls with validated outcomes.
