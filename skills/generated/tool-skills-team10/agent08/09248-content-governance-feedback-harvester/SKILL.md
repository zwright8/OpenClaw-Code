---
name: content-governance-feedback-harvester
description: Use when tasks require content governance feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Feedback Harvester

## Purpose
Design and execute content governance workflows using feedback harvester controls with validated outcomes.
