---
name: audience-analytics-runbook-composer
description: Use when tasks require audience analytics runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Runbook Composer

## Purpose
Design and execute audience analytics workflows using runbook composer controls with validated outcomes.
