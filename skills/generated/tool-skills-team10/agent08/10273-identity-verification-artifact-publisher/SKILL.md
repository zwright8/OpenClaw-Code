---
name: identity-verification-artifact-publisher
description: Use when tasks require identity verification artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Artifact Publisher

## Purpose
Design and execute identity verification workflows using artifact publisher controls with validated outcomes.
