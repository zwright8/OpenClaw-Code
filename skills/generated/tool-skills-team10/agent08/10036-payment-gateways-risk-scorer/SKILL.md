---
name: payment-gateways-risk-scorer
description: Use when tasks require payment gateways risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Risk Scorer

## Purpose
Design and execute payment gateways workflows using risk scorer controls with validated outcomes.
