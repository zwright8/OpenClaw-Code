---
name: portfolio-analytics-human-handoff-router
description: Use when tasks require portfolio analytics human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Human Handoff Router

## Purpose
Design and execute portfolio analytics workflows using human handoff router controls with validated outcomes.
