---
name: kyc-pipelines-pii-redactor
description: Use when tasks require kyc pipelines pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines PII Redactor

## Purpose
Design and execute kyc pipelines workflows using pii redactor controls with validated outcomes.
