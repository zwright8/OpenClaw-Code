---
name: pos-systems-spec-drift-detector
description: Use when tasks require pos systems spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Spec Drift Detector

## Purpose
Design and execute pos systems workflows using spec drift detector controls with validated outcomes.
