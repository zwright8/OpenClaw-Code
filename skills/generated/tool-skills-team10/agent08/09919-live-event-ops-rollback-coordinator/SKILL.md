---
name: live-event-ops-rollback-coordinator
description: Use when tasks require live event ops rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Rollback Coordinator

## Purpose
Design and execute live event ops workflows using rollback coordinator controls with validated outcomes.
