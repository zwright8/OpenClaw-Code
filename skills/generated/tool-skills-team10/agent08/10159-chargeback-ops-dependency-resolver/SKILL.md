---
name: chargeback-ops-dependency-resolver
description: Use when tasks require chargeback ops dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Dependency Resolver

## Purpose
Design and execute chargeback ops workflows using dependency resolver controls with validated outcomes.
