---
name: live-event-ops-retry-governor
description: Use when tasks require live event ops retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Retry Governor

## Purpose
Design and execute live event ops workflows using retry governor controls with validated outcomes.
