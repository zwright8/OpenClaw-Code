---
name: chargeback-ops-risk-scorer
description: Use when tasks require chargeback ops risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Risk Scorer

## Purpose
Design and execute chargeback ops workflows using risk scorer controls with validated outcomes.
