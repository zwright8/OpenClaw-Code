---
name: merchant-risk-quality-gatekeeper
description: Use when tasks require merchant risk quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Quality Gatekeeper

## Purpose
Design and execute merchant risk workflows using quality gatekeeper controls with validated outcomes.
