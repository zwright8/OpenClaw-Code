---
name: predictive-maintenance-anomaly-detector
description: Use when tasks require predictive maintenance anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Predictive Maintenance Anomaly Detector

## Purpose
Design and execute predictive maintenance workflows using anomaly detector controls with validated outcomes.
