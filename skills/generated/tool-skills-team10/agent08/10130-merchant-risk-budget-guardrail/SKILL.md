---
name: merchant-risk-budget-guardrail
description: Use when tasks require merchant risk budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Budget Guardrail

## Purpose
Design and execute merchant risk workflows using budget guardrail controls with validated outcomes.
