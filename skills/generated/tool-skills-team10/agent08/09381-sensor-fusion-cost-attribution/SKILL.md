---
name: sensor-fusion-cost-attribution
description: Use when tasks require sensor fusion cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Cost Attribution

## Purpose
Design and execute sensor fusion workflows using cost attribution controls with validated outcomes.
