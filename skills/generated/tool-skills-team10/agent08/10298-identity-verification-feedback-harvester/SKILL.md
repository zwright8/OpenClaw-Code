---
name: identity-verification-feedback-harvester
description: Use when tasks require identity verification feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Feedback Harvester

## Purpose
Design and execute identity verification workflows using feedback harvester controls with validated outcomes.
