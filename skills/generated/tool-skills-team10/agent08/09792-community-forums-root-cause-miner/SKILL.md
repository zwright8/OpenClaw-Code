---
name: community-forums-root-cause-miner
description: Use when tasks require community forums root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Root Cause Miner

## Purpose
Design and execute community forums workflows using root cause miner controls with validated outcomes.
