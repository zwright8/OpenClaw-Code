---
name: live-event-ops-approval-orchestrator
description: Use when tasks require live event ops approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Approval Orchestrator

## Purpose
Design and execute live event ops workflows using approval orchestrator controls with validated outcomes.
