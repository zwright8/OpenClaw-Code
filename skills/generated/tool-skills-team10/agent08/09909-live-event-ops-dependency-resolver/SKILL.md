---
name: live-event-ops-dependency-resolver
description: Use when tasks require live event ops dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Dependency Resolver

## Purpose
Design and execute live event ops workflows using dependency resolver controls with validated outcomes.
