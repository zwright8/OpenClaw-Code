---
name: payment-gateways-state-reconciler
description: Use when tasks require payment gateways state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways State Reconciler

## Purpose
Design and execute payment gateways workflows using state reconciler controls with validated outcomes.
