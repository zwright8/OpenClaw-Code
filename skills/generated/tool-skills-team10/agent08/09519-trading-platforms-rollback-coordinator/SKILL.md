---
name: trading-platforms-rollback-coordinator
description: Use when tasks require trading platforms rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Rollback Coordinator

## Purpose
Design and execute trading platforms workflows using rollback coordinator controls with validated outcomes.
