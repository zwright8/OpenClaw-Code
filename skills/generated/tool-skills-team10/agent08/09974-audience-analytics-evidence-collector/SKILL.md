---
name: audience-analytics-evidence-collector
description: Use when tasks require audience analytics evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Evidence Collector

## Purpose
Design and execute audience analytics workflows using evidence collector controls with validated outcomes.
