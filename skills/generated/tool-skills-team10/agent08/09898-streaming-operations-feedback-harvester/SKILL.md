---
name: streaming-operations-feedback-harvester
description: Use when tasks require streaming operations feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Feedback Harvester

## Purpose
Design and execute streaming operations workflows using feedback harvester controls with validated outcomes.
