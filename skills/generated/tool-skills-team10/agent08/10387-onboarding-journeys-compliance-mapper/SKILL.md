---
name: onboarding-journeys-compliance-mapper
description: Use when tasks require onboarding journeys compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Compliance Mapper

## Purpose
Design and execute onboarding journeys workflows using compliance mapper controls with validated outcomes.
