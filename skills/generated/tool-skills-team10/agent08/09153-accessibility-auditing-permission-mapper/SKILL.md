---
name: accessibility-auditing-permission-mapper
description: Use when tasks require accessibility auditing permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Permission Mapper

## Purpose
Design and execute accessibility auditing workflows using permission mapper controls with validated outcomes.
