---
name: payment-gateways-snapshot-manager
description: Use when tasks require payment gateways snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Snapshot Manager

## Purpose
Design and execute payment gateways workflows using snapshot manager controls with validated outcomes.
