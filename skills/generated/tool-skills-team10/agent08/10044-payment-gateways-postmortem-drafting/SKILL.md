---
name: payment-gateways-postmortem-drafting
description: Use when tasks require payment gateways postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Postmortem Drafting

## Purpose
Design and execute payment gateways workflows using postmortem drafting controls with validated outcomes.
