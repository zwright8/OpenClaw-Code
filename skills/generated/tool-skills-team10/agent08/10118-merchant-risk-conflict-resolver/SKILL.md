---
name: merchant-risk-conflict-resolver
description: Use when tasks require merchant risk conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Conflict Resolver

## Purpose
Design and execute merchant risk workflows using conflict resolver controls with validated outcomes.
