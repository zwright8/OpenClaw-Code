---
name: merchant-risk-version-tracker
description: Use when tasks require merchant risk version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Version Tracker

## Purpose
Design and execute merchant risk workflows using version tracker controls with validated outcomes.
