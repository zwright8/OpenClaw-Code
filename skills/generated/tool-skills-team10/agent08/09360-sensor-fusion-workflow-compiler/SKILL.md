---
name: sensor-fusion-workflow-compiler
description: Use when tasks require sensor fusion workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Workflow Compiler

## Purpose
Design and execute sensor fusion workflows using workflow compiler controls with validated outcomes.
