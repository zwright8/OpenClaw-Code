---
name: alternative-data-compliance-mapper
description: Use when tasks require alternative data compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Compliance Mapper

## Purpose
Design and execute alternative data workflows using compliance mapper controls with validated outcomes.
