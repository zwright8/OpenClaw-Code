---
name: trading-platforms-access-auditor
description: Use when tasks require trading platforms access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Access Auditor

## Purpose
Design and execute trading platforms workflows using access auditor controls with validated outcomes.
