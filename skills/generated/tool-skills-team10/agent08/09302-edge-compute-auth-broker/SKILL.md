---
name: edge-compute-auth-broker
description: Use when tasks require edge compute auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Auth Broker

## Purpose
Design and execute edge compute workflows using auth broker controls with validated outcomes.
