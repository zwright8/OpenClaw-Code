---
name: sensor-fusion-conflict-resolver
description: Use when tasks require sensor fusion conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Conflict Resolver

## Purpose
Design and execute sensor fusion workflows using conflict resolver controls with validated outcomes.
