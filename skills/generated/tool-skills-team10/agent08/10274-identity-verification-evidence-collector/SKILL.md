---
name: identity-verification-evidence-collector
description: Use when tasks require identity verification evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Evidence Collector

## Purpose
Design and execute identity verification workflows using evidence collector controls with validated outcomes.
