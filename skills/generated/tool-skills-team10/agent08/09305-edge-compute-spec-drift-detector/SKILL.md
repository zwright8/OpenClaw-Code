---
name: edge-compute-spec-drift-detector
description: Use when tasks require edge compute spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Spec Drift Detector

## Purpose
Design and execute edge compute workflows using spec drift detector controls with validated outcomes.
