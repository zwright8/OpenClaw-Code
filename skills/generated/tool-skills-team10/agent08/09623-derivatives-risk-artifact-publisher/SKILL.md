---
name: derivatives-risk-artifact-publisher
description: Use when tasks require derivatives risk artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Artifact Publisher

## Purpose
Design and execute derivatives risk workflows using artifact publisher controls with validated outcomes.
