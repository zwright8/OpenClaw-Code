---
name: chargeback-ops-remediation-planner
description: Use when tasks require chargeback ops remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Remediation Planner

## Purpose
Design and execute chargeback ops workflows using remediation planner controls with validated outcomes.
