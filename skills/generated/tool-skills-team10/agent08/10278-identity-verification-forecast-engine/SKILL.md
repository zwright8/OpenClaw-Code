---
name: identity-verification-forecast-engine
description: Use when tasks require identity verification forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Forecast Engine

## Purpose
Design and execute identity verification workflows using forecast engine controls with validated outcomes.
