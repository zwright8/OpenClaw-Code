---
name: onboarding-journeys-execution-runner
description: Use when tasks require onboarding journeys execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Execution Runner

## Purpose
Design and execute onboarding journeys workflows using execution runner controls with validated outcomes.
