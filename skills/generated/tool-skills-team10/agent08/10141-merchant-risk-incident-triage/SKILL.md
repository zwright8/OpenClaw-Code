---
name: merchant-risk-incident-triage
description: Use when tasks require merchant risk incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Incident Triage

## Purpose
Design and execute merchant risk workflows using incident triage controls with validated outcomes.
