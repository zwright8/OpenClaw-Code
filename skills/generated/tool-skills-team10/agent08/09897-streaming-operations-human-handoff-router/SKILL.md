---
name: streaming-operations-human-handoff-router
description: Use when tasks require streaming operations human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Human Handoff Router

## Purpose
Design and execute streaming operations workflows using human handoff router controls with validated outcomes.
