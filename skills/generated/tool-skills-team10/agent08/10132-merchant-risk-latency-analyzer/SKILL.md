---
name: merchant-risk-latency-analyzer
description: Use when tasks require merchant risk latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Latency Analyzer

## Purpose
Design and execute merchant risk workflows using latency analyzer controls with validated outcomes.
