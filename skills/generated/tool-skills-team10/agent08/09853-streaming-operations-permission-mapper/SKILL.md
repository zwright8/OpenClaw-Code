---
name: streaming-operations-permission-mapper
description: Use when tasks require streaming operations permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Permission Mapper

## Purpose
Design and execute streaming operations workflows using permission mapper controls with validated outcomes.
