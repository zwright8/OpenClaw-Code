---
name: accessibility-auditing-state-reconciler
description: Use when tasks require accessibility auditing state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing State Reconciler

## Purpose
Design and execute accessibility auditing workflows using state reconciler controls with validated outcomes.
