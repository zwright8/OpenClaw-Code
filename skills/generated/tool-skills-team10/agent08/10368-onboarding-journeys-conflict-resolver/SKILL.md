---
name: onboarding-journeys-conflict-resolver
description: Use when tasks require onboarding journeys conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Conflict Resolver

## Purpose
Design and execute onboarding journeys workflows using conflict resolver controls with validated outcomes.
