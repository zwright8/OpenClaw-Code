---
name: identity-verification-quality-gatekeeper
description: Use when tasks require identity verification quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Quality Gatekeeper

## Purpose
Design and execute identity verification workflows using quality gatekeeper controls with validated outcomes.
