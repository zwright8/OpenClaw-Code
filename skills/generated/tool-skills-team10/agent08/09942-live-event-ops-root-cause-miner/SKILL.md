---
name: live-event-ops-root-cause-miner
description: Use when tasks require live event ops root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Root Cause Miner

## Purpose
Design and execute live event ops workflows using root cause miner controls with validated outcomes.
