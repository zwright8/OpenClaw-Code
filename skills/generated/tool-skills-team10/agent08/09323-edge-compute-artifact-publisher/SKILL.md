---
name: edge-compute-artifact-publisher
description: Use when tasks require edge compute artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Artifact Publisher

## Purpose
Design and execute edge compute workflows using artifact publisher controls with validated outcomes.
