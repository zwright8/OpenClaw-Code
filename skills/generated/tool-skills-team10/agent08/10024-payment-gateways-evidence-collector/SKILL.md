---
name: payment-gateways-evidence-collector
description: Use when tasks require payment gateways evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Evidence Collector

## Purpose
Design and execute payment gateways workflows using evidence collector controls with validated outcomes.
