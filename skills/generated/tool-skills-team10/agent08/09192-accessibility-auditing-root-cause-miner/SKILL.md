---
name: accessibility-auditing-root-cause-miner
description: Use when tasks require accessibility auditing root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Root Cause Miner

## Purpose
Design and execute accessibility auditing workflows using root cause miner controls with validated outcomes.
