---
name: payment-gateways-incident-triage
description: Use when tasks require payment gateways incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Incident Triage

## Purpose
Design and execute payment gateways workflows using incident triage controls with validated outcomes.
