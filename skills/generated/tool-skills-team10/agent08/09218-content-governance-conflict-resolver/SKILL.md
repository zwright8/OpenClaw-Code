---
name: content-governance-conflict-resolver
description: Use when tasks require content governance conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Conflict Resolver

## Purpose
Design and execute content governance workflows using conflict resolver controls with validated outcomes.
