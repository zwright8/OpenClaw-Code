---
name: onboarding-journeys-outcome-synthesizer
description: Use when tasks require onboarding journeys outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Outcome Synthesizer

## Purpose
Design and execute onboarding journeys workflows using outcome synthesizer controls with validated outcomes.
