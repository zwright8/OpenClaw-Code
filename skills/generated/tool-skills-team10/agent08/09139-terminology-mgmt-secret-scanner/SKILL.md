---
name: terminology-mgmt-secret-scanner
description: Use when tasks require terminology mgmt secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Secret Scanner

## Purpose
Design and execute terminology mgmt workflows using secret scanner controls with validated outcomes.
