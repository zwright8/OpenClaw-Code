---
name: community-forums-runbook-composer
description: Use when tasks require community forums runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Runbook Composer

## Purpose
Design and execute community forums workflows using runbook composer controls with validated outcomes.
