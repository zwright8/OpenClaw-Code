---
name: onboarding-journeys-evidence-collector
description: Use when tasks require onboarding journeys evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Evidence Collector

## Purpose
Design and execute onboarding journeys workflows using evidence collector controls with validated outcomes.
