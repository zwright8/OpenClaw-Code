---
name: live-event-ops-task-decomposer
description: Use when tasks require live event ops task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Task Decomposer

## Purpose
Design and execute live event ops workflows using task decomposer controls with validated outcomes.
