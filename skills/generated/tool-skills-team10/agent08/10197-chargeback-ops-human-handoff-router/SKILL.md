---
name: chargeback-ops-human-handoff-router
description: Use when tasks require chargeback ops human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Human Handoff Router

## Purpose
Design and execute chargeback ops workflows using human handoff router controls with validated outcomes.
