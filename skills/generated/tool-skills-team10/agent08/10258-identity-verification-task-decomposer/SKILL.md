---
name: identity-verification-task-decomposer
description: Use when tasks require identity verification task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Task Decomposer

## Purpose
Design and execute identity verification workflows using task decomposer controls with validated outcomes.
