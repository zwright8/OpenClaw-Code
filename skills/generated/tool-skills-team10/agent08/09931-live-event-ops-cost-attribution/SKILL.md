---
name: live-event-ops-cost-attribution
description: Use when tasks require live event ops cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Cost Attribution

## Purpose
Design and execute live event ops workflows using cost attribution controls with validated outcomes.
