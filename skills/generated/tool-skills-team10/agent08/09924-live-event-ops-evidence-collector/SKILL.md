---
name: live-event-ops-evidence-collector
description: Use when tasks require live event ops evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Evidence Collector

## Purpose
Design and execute live event ops workflows using evidence collector controls with validated outcomes.
