---
name: pos-systems-human-handoff-router
description: Use when tasks require pos systems human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Human Handoff Router

## Purpose
Design and execute pos systems workflows using human handoff router controls with validated outcomes.
