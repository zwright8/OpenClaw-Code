---
name: sensor-fusion-evidence-collector
description: Use when tasks require sensor fusion evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Evidence Collector

## Purpose
Design and execute sensor fusion workflows using evidence collector controls with validated outcomes.
