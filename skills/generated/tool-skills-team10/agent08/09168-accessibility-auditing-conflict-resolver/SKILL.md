---
name: accessibility-auditing-conflict-resolver
description: Use when tasks require accessibility auditing conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Conflict Resolver

## Purpose
Design and execute accessibility auditing workflows using conflict resolver controls with validated outcomes.
