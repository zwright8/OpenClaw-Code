---
name: identity-verification-reliability-scorer
description: Use when tasks require identity verification reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Reliability Scorer

## Purpose
Design and execute identity verification workflows using reliability scorer controls with validated outcomes.
