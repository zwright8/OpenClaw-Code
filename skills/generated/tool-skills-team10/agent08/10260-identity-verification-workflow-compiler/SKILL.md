---
name: identity-verification-workflow-compiler
description: Use when tasks require identity verification workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Workflow Compiler

## Purpose
Design and execute identity verification workflows using workflow compiler controls with validated outcomes.
