---
name: accessibility-auditing-anomaly-detector
description: Use when tasks require accessibility auditing anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Anomaly Detector

## Purpose
Design and execute accessibility auditing workflows using anomaly detector controls with validated outcomes.
