---
name: accessibility-auditing-access-auditor
description: Use when tasks require accessibility auditing access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Access Auditor

## Purpose
Design and execute accessibility auditing workflows using access auditor controls with validated outcomes.
