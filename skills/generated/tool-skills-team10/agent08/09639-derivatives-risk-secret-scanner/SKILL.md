---
name: derivatives-risk-secret-scanner
description: Use when tasks require derivatives risk secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Secret Scanner

## Purpose
Design and execute derivatives risk workflows using secret scanner controls with validated outcomes.
