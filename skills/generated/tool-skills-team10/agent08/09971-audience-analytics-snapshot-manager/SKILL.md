---
name: audience-analytics-snapshot-manager
description: Use when tasks require audience analytics snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Snapshot Manager

## Purpose
Design and execute audience analytics workflows using snapshot manager controls with validated outcomes.
