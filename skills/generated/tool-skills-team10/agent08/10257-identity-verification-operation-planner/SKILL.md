---
name: identity-verification-operation-planner
description: Use when tasks require identity verification operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Operation Planner

## Purpose
Design and execute identity verification workflows using operation planner controls with validated outcomes.
