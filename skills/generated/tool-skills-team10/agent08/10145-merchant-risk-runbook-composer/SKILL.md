---
name: merchant-risk-runbook-composer
description: Use when tasks require merchant risk runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Runbook Composer

## Purpose
Design and execute merchant risk workflows using runbook composer controls with validated outcomes.
