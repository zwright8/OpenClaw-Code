---
name: onboarding-journeys-reliability-scorer
description: Use when tasks require onboarding journeys reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Reliability Scorer

## Purpose
Design and execute onboarding journeys workflows using reliability scorer controls with validated outcomes.
