---
name: trading-platforms-api-contract-validator
description: Use when tasks require trading platforms api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms API Contract Validator

## Purpose
Design and execute trading platforms workflows using api contract validator controls with validated outcomes.
...
- Domain: [Trading Platforms](../../resources/domains/trading-platforms.md)
