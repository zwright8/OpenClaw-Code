---
name: onboarding-journeys-risk-scorer
description: Use when tasks require onboarding journeys risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Risk Scorer

## Purpose
Design and execute onboarding journeys workflows using risk scorer controls with validated outcomes.
