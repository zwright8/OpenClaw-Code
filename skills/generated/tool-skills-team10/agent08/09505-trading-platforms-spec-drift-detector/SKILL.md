---
name: trading-platforms-spec-drift-detector
description: Use when tasks require trading platforms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Spec Drift Detector

## Purpose
Design and execute trading platforms workflows using spec drift detector controls with validated outcomes.
