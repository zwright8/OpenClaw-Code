---
name: edge-compute-snapshot-manager
description: Use when tasks require edge compute snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Snapshot Manager

## Purpose
Design and execute edge compute workflows using snapshot manager controls with validated outcomes.
