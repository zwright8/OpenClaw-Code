---
name: audience-analytics-delta-calculator
description: Use when tasks require audience analytics delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Delta Calculator

## Purpose
Design and execute audience analytics workflows using delta calculator controls with validated outcomes.
