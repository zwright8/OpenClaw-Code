---
name: audience-analytics-anomaly-detector
description: Use when tasks require audience analytics anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Anomaly Detector

## Purpose
Design and execute audience analytics workflows using anomaly detector controls with validated outcomes.
