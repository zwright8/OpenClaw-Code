---
name: merchant-risk-spec-drift-detector
description: Use when tasks require merchant risk spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Spec Drift Detector

## Purpose
Design and execute merchant risk workflows using spec drift detector controls with validated outcomes.
