---
name: pos-systems-postmortem-drafting
description: Use when tasks require pos systems postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Postmortem Drafting

## Purpose
Design and execute pos systems workflows using postmortem drafting controls with validated outcomes.
