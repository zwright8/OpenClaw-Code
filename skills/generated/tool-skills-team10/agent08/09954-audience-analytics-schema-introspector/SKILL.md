---
name: audience-analytics-schema-introspector
description: Use when tasks require audience analytics schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Schema Introspector

## Purpose
Design and execute audience analytics workflows using schema introspector controls with validated outcomes.
