---
name: onboarding-journeys-quality-gatekeeper
description: Use when tasks require onboarding journeys quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Quality Gatekeeper

## Purpose
Design and execute onboarding journeys workflows using quality gatekeeper controls with validated outcomes.
