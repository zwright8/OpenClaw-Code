---
name: onboarding-journeys-operation-planner
description: Use when tasks require onboarding journeys operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Operation Planner

## Purpose
Design and execute onboarding journeys workflows using operation planner controls with validated outcomes.
