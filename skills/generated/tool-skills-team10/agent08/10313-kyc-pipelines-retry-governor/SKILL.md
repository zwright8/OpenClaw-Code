---
name: kyc-pipelines-retry-governor
description: Use when tasks require kyc pipelines retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Retry Governor

## Purpose
Design and execute kyc pipelines workflows using retry governor controls with validated outcomes.
