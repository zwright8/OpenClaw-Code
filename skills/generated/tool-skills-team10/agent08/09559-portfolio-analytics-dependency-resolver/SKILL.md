---
name: portfolio-analytics-dependency-resolver
description: Use when tasks require portfolio analytics dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Dependency Resolver

## Purpose
Design and execute portfolio analytics workflows using dependency resolver controls with validated outcomes.
