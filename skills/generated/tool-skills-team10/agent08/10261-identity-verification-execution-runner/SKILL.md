---
name: identity-verification-execution-runner
description: Use when tasks require identity verification execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Execution Runner

## Purpose
Design and execute identity verification workflows using execution runner controls with validated outcomes.
