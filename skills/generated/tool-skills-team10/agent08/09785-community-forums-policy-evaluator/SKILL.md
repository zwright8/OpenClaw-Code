---
name: community-forums-policy-evaluator
description: Use when tasks require community forums policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Policy Evaluator

## Purpose
Design and execute community forums workflows using policy evaluator controls with validated outcomes.
