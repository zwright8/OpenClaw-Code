---
name: audience-analytics-feedback-harvester
description: Use when tasks require audience analytics feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Feedback Harvester

## Purpose
Design and execute audience analytics workflows using feedback harvester controls with validated outcomes.
