---
name: identity-verification-compliance-mapper
description: Use when tasks require identity verification compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Compliance Mapper

## Purpose
Design and execute identity verification workflows using compliance mapper controls with validated outcomes.
