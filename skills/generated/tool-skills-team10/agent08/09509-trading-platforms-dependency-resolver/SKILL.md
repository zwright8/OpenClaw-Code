---
name: trading-platforms-dependency-resolver
description: Use when tasks require trading platforms dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Dependency Resolver

## Purpose
Design and execute trading platforms workflows using dependency resolver controls with validated outcomes.
