---
name: iot-device-clouds-evidence-collector
description: Use when tasks require iot device clouds evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# IoT Device Clouds Evidence Collector

## Purpose
Design and execute iot device clouds workflows using evidence collector controls with validated outcomes.
