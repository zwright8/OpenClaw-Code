---
name: streaming-operations-postmortem-drafting
description: Use when tasks require streaming operations postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Postmortem Drafting

## Purpose
Design and execute streaming operations workflows using postmortem drafting controls with validated outcomes.
