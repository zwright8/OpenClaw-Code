---
name: community-forums-migration-planner
description: Use when tasks require community forums migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Migration Planner

## Purpose
Design and execute community forums workflows using migration planner controls with validated outcomes.
