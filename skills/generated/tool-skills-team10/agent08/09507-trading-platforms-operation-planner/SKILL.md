---
name: trading-platforms-operation-planner
description: Use when tasks require trading platforms operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Operation Planner

## Purpose
Design and execute trading platforms workflows using operation planner controls with validated outcomes.
