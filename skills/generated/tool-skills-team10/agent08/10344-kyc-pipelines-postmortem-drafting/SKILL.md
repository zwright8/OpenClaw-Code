---
name: kyc-pipelines-postmortem-drafting
description: Use when tasks require kyc pipelines postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Postmortem Drafting

## Purpose
Design and execute kyc pipelines workflows using postmortem drafting controls with validated outcomes.
