---
name: content-governance-artifact-publisher
description: Use when tasks require content governance artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Artifact Publisher

## Purpose
Design and execute content governance workflows using artifact publisher controls with validated outcomes.
