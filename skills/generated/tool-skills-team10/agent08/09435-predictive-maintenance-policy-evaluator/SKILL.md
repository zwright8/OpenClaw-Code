---
name: predictive-maintenance-policy-evaluator
description: Use when tasks require predictive maintenance policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Predictive Maintenance Policy Evaluator

## Purpose
Design and execute predictive maintenance workflows using policy evaluator controls with validated outcomes.
