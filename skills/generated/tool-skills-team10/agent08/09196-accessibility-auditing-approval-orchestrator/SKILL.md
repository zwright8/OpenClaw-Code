---
name: accessibility-auditing-approval-orchestrator
description: Use when tasks require accessibility auditing approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Approval Orchestrator

## Purpose
Design and execute accessibility auditing workflows using approval orchestrator controls with validated outcomes.
