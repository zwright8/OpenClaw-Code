---
name: derivatives-risk-capacity-planner
description: Use when tasks require derivatives risk capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Capacity Planner

## Purpose
Design and execute derivatives risk workflows using capacity planner controls with validated outcomes.
