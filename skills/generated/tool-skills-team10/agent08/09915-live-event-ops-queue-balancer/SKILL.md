---
name: live-event-ops-queue-balancer
description: Use when tasks require live event ops queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Queue Balancer

## Purpose
Design and execute live event ops workflows using queue balancer controls with validated outcomes.
