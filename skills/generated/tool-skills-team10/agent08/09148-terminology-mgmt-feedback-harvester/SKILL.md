---
name: terminology-mgmt-feedback-harvester
description: Use when tasks require terminology mgmt feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Feedback Harvester

## Purpose
Design and execute terminology mgmt workflows using feedback harvester controls with validated outcomes.
