---
name: execution-monitoring-secret-scanner
description: Use when tasks require execution monitoring secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Execution Monitoring Secret Scanner

## Purpose
Design and execute execution monitoring workflows using secret scanner controls with validated outcomes.
