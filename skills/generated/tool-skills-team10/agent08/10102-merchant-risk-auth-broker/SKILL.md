---
name: merchant-risk-auth-broker
description: Use when tasks require merchant risk auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Auth Broker

## Purpose
Design and execute merchant risk workflows using auth broker controls with validated outcomes.
