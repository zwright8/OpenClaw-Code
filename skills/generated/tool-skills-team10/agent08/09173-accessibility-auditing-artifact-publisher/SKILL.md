...
description: Use when tasks require accessibility auditing artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Artifact Publisher

## Purpose
Design and execute accessibility auditing workflows using artifact publisher controls with validated outcomes.
