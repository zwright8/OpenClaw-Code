---
name: identity-verification-spec-drift-detector
description: Use when tasks require identity verification spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Spec Drift Detector

## Purpose
Design and execute identity verification workflows using spec drift detector controls with validated outcomes.
