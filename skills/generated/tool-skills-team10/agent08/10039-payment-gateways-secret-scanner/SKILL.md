---
name: payment-gateways-secret-scanner
description: Use when tasks require payment gateways secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Secret Scanner

## Purpose
Design and execute payment gateways workflows using secret scanner controls with validated outcomes.
