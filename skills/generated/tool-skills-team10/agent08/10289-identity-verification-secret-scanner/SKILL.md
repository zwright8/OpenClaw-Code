...
description: Use when tasks require identity verification secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Secret Scanner

## Purpose
Design and execute identity verification workflows using secret scanner controls with validated outcomes.
