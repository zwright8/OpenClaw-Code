---
name: onboarding-journeys-migration-planner
description: Use when tasks require onboarding journeys migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Migration Planner

## Purpose
Design and execute onboarding journeys workflows using migration planner controls with validated outcomes.
