---
name: trading-platforms-state-reconciler
description: Use when tasks require trading platforms state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms State Reconciler

## Purpose
Design and execute trading platforms workflows using state reconciler controls with validated outcomes.
