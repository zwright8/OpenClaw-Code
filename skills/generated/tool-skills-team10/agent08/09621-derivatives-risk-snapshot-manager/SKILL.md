---
name: derivatives-risk-snapshot-manager
description: Use when tasks require derivatives risk snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Snapshot Manager

## Purpose
Design and execute derivatives risk workflows using snapshot manager controls with validated outcomes.
