---
name: alternative-data-root-cause-miner
description: Use when tasks require alternative data root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Root Cause Miner

## Purpose
Design and execute alternative data workflows using root cause miner controls with validated outcomes.
