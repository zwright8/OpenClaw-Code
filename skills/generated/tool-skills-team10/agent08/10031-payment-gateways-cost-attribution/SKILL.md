---
name: payment-gateways-cost-attribution
description: Use when tasks require payment gateways cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Cost Attribution

## Purpose
Design and execute payment gateways workflows using cost attribution controls with validated outcomes.
