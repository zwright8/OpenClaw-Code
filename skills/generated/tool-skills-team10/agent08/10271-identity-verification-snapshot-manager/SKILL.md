...
description: Use when tasks require identity verification snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Snapshot Manager

## Purpose
Design and execute identity verification workflows using snapshot manager controls with validated outcomes.
