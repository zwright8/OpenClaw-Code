---
name: trading-platforms-anomaly-detector
description: Use when tasks require trading platforms anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Anomaly Detector

## Purpose
Design and execute trading platforms workflows using anomaly detector controls with validated outcomes.
