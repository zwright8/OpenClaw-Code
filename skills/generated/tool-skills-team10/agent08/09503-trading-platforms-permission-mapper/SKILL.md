---
name: trading-platforms-permission-mapper
description: Use when tasks require trading platforms permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Permission Mapper

## Purpose
Design and execute trading platforms workflows using permission mapper controls with validated outcomes.
