...
description: Use when tasks require accessibility auditing execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Execution Runner

## Purpose
Design and execute accessibility auditing workflows using execution runner controls with validated outcomes.
