---
name: audience-analytics-operation-planner
description: Use when tasks require audience analytics operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Operation Planner

## Purpose
Design and execute audience analytics workflows using operation planner controls with validated outcomes.
