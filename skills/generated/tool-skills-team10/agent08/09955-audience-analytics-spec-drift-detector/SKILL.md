---
name: audience-analytics-spec-drift-detector
description: Use when tasks require audience analytics spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Spec Drift Detector

## Purpose
Design and execute audience analytics workflows using spec drift detector controls with validated outcomes.
