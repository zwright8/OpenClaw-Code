---
name: onboarding-journeys-auth-broker
description: Use when tasks require onboarding journeys auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Auth Broker

## Purpose
Design and execute onboarding journeys workflows using auth broker controls with validated outcomes.
