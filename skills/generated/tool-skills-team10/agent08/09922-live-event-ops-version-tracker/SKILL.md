---
name: live-event-ops-version-tracker
description: Use when tasks require live event ops version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Version Tracker

## Purpose
Design and execute live event ops workflows using version tracker controls with validated outcomes.
