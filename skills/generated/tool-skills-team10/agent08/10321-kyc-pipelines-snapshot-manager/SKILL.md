---
name: kyc-pipelines-snapshot-manager
description: Use when tasks require kyc pipelines snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Snapshot Manager

## Purpose
Design and execute kyc pipelines workflows using snapshot manager controls with validated outcomes.
