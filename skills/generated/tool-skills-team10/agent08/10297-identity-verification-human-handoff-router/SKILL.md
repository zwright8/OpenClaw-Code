---
name: identity-verification-human-handoff-router
description: Use when tasks require identity verification human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Human Handoff Router

## Purpose
Design and execute identity verification workflows using human handoff router controls with validated outcomes.
