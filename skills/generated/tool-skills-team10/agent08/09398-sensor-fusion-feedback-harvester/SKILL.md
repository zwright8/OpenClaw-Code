---
name: sensor-fusion-feedback-harvester
description: Use when tasks require sensor fusion feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Feedback Harvester

## Purpose
Design and execute sensor fusion workflows using feedback harvester controls with validated outcomes.
