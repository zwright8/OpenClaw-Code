---
name: sensor-fusion-approval-orchestrator
description: Use when tasks require sensor fusion approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Approval Orchestrator

## Purpose
Design and execute sensor fusion workflows using approval orchestrator controls with validated outcomes.
