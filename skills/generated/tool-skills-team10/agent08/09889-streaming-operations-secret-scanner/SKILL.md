---
name: streaming-operations-secret-scanner
description: Use when tasks require streaming operations secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Secret Scanner

## Purpose
Design and execute streaming operations workflows using secret scanner controls with validated outcomes.
