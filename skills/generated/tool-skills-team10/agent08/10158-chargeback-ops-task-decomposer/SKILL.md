---
name: chargeback-ops-task-decomposer
description: Use when tasks require chargeback ops task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Task Decomposer

## Purpose
Design and execute chargeback ops workflows using task decomposer controls with validated outcomes.
