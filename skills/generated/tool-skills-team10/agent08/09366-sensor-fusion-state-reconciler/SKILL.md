---
name: sensor-fusion-state-reconciler
description: Use when tasks require sensor fusion state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion State Reconciler

## Purpose
Design and execute sensor fusion workflows using state reconciler controls with validated outcomes.
