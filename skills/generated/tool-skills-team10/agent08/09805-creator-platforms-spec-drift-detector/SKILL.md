---
name: creator-platforms-spec-drift-detector
description: Use when tasks require creator platforms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Creator Platforms Spec Drift Detector

## Purpose
Design and execute creator platforms workflows using spec drift detector controls with validated outcomes.
