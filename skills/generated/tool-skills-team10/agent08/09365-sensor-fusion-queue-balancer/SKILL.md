---
name: sensor-fusion-queue-balancer
description: Use when tasks require sensor fusion queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Queue Balancer

## Purpose
Design and execute sensor fusion workflows using queue balancer controls with validated outcomes.
