---
name: live-event-ops-runbook-composer
description: Use when tasks require live event ops runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Runbook Composer

## Purpose
Design and execute live event ops workflows using runbook composer controls with validated outcomes.
