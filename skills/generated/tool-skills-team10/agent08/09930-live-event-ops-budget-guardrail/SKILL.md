---
name: live-event-ops-budget-guardrail
description: Use when tasks require live event ops budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Budget Guardrail

## Purpose
Design and execute live event ops workflows using budget guardrail controls with validated outcomes.
