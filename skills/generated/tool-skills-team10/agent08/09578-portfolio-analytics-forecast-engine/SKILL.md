---
name: portfolio-analytics-forecast-engine
description: Use when tasks require portfolio analytics forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Forecast Engine

## Purpose
Design and execute portfolio analytics workflows using forecast engine controls with validated outcomes.
