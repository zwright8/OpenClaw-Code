---
name: onboarding-journeys-anomaly-detector
description: Use when tasks require onboarding journeys anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Anomaly Detector

## Purpose
Design and execute onboarding journeys workflows using anomaly detector controls with validated outcomes.
