---
name: derivatives-risk-evidence-collector
description: Use when tasks require derivatives risk evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Evidence Collector

## Purpose
Design and execute derivatives risk workflows using evidence collector controls with validated outcomes.
