---
name: streaming-operations-auth-broker
description: Use when tasks require streaming operations auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Auth Broker

## Purpose
Design and execute streaming operations workflows using auth broker controls with validated outcomes.
