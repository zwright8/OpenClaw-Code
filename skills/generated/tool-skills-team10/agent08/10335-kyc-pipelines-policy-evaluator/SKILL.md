---
name: kyc-pipelines-policy-evaluator
description: Use when tasks require kyc pipelines policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Policy Evaluator

## Purpose
Design and execute kyc pipelines workflows using policy evaluator controls with validated outcomes.
