---
name: community-forums-execution-runner
description: Use when tasks require community forums execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Execution Runner

## Purpose
Design and execute community forums workflows using execution runner controls with validated outcomes.
