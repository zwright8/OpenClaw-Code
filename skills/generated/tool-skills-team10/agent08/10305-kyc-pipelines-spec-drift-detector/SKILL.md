---
name: kyc-pipelines-spec-drift-detector
description: Use when tasks require kyc pipelines spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Spec Drift Detector

## Purpose
Design and execute kyc pipelines workflows using spec drift detector controls with validated outcomes.
