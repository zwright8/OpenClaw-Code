---
name: merchant-risk-feedback-harvester
description: Use when tasks require merchant risk feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Feedback Harvester

## Purpose
Design and execute merchant risk workflows using feedback harvester controls with validated outcomes.
