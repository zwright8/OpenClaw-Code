---
name: identity-verification-api-contract-validator
description: Use when tasks require identity verification api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification API Contract Validator

## Purpose
Design and execute identity verification workflows using api contract validator controls with validated outcomes.
...
- Domain: [Identity Verification](../../resources/domains/identity-verification.md)
