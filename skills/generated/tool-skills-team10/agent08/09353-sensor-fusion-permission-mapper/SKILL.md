---
name: sensor-fusion-permission-mapper
description: Use when tasks require sensor fusion permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Permission Mapper

## Purpose
Design and execute sensor fusion workflows using permission mapper controls with validated outcomes.
