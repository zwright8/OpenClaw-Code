---
name: derivatives-risk-dependency-resolver
description: Use when tasks require derivatives risk dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Dependency Resolver

## Purpose
Design and execute derivatives risk workflows using dependency resolver controls with validated outcomes.
