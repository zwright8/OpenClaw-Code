---
name: edge-compute-provenance-tracker
description: Use when tasks require edge compute provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Provenance Tracker

## Purpose
Design and execute edge compute workflows using provenance tracker controls with validated outcomes.
