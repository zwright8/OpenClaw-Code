---
name: audience-analytics-human-handoff-router
description: Use when tasks require audience analytics human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Human Handoff Router

## Purpose
Design and execute audience analytics workflows using human handoff router controls with validated outcomes.
