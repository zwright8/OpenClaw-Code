---
name: sensor-fusion-secret-scanner
description: Use when tasks require sensor fusion secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Secret Scanner

## Purpose
Design and execute sensor fusion workflows using secret scanner controls with validated outcomes.
