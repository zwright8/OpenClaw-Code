---
name: alternative-data-anomaly-detector
description: Use when tasks require alternative data anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Anomaly Detector

## Purpose
Design and execute alternative data workflows using anomaly detector controls with validated outcomes.
