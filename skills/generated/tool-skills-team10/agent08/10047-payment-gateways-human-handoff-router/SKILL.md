---
name: payment-gateways-human-handoff-router
description: Use when tasks require payment gateways human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Human Handoff Router

## Purpose
Design and execute payment gateways workflows using human handoff router controls with validated outcomes.
