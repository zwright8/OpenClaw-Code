---
name: edge-compute-operation-planner
description: Use when tasks require edge compute operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Operation Planner

## Purpose
Design and execute edge compute workflows using operation planner controls with validated outcomes.
