---
name: pos-systems-artifact-publisher
description: Use when tasks require pos systems artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Artifact Publisher

## Purpose
Design and execute pos systems workflows using artifact publisher controls with validated outcomes.
