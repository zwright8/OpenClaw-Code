---
name: onboarding-journeys-version-tracker
description: Use when tasks require onboarding journeys version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Version Tracker

## Purpose
Design and execute onboarding journeys workflows using version tracker controls with validated outcomes.
