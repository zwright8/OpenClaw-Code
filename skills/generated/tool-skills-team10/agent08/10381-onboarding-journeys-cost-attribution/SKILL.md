---
name: onboarding-journeys-cost-attribution
description: Use when tasks require onboarding journeys cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Cost Attribution

## Purpose
Design and execute onboarding journeys workflows using cost attribution controls with validated outcomes.
