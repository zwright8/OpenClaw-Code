---
name: predictive-maintenance-postmortem-drafting
description: Use when tasks require predictive maintenance postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Predictive Maintenance Postmortem Drafting

## Purpose
Design and execute predictive maintenance workflows using postmortem drafting controls with validated outcomes.
