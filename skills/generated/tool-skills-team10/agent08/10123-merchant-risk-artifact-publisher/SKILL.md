---
name: merchant-risk-artifact-publisher
description: Use when tasks require merchant risk artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Artifact Publisher

## Purpose
Design and execute merchant risk workflows using artifact publisher controls with validated outcomes.
