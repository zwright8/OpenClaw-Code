---
name: kyc-pipelines-artifact-publisher
description: Use when tasks require kyc pipelines artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Artifact Publisher

## Purpose
Design and execute kyc pipelines workflows using artifact publisher controls with validated outcomes.
