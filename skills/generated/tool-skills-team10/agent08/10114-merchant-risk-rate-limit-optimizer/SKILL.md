---
name: merchant-risk-rate-limit-optimizer
description: Use when tasks require merchant risk rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Rate Limit Optimizer

## Purpose
Design and execute merchant risk workflows using rate limit optimizer controls with validated outcomes.
