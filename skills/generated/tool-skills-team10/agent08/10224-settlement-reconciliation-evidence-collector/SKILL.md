---
name: settlement-reconciliation-evidence-collector
description: Use when tasks require settlement reconciliation evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Settlement Reconciliation Evidence Collector

## Purpose
Design and execute settlement reconciliation workflows using evidence collector controls with validated outcomes.
