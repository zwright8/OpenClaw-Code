---
name: identity-verification-state-reconciler
description: Use when tasks require identity verification state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification State Reconciler

## Purpose
Design and execute identity verification workflows using state reconciler controls with validated outcomes.
