---
name: sensor-fusion-quality-gatekeeper
description: Use when tasks require sensor fusion quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Quality Gatekeeper

## Purpose
Design and execute sensor fusion workflows using quality gatekeeper controls with validated outcomes.
