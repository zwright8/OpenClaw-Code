---
name: trading-platforms-artifact-publisher
description: Use when tasks require trading platforms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Artifact Publisher

## Purpose
Design and execute trading platforms workflows using artifact publisher controls with validated outcomes.
