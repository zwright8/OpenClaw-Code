---
name: sensor-fusion-migration-planner
description: Use when tasks require sensor fusion migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Migration Planner

## Purpose
Design and execute sensor fusion workflows using migration planner controls with validated outcomes.
