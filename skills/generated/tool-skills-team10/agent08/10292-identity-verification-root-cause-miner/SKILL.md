---
name: identity-verification-root-cause-miner
description: Use when tasks require identity verification root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Root Cause Miner

## Purpose
Design and execute identity verification workflows using root cause miner controls with validated outcomes.
