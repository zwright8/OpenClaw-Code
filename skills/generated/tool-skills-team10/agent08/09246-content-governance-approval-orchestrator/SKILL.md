---
name: content-governance-approval-orchestrator
description: Use when tasks require content governance approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Approval Orchestrator

## Purpose
Design and execute content governance workflows using approval orchestrator controls with validated outcomes.
