---
name: accessibility-auditing-operation-planner
description: Use when tasks require accessibility auditing operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Operation Planner

## Purpose
Design and execute accessibility auditing workflows using operation planner controls with validated outcomes.
