---
name: portfolio-analytics-evidence-collector
description: Use when tasks require portfolio analytics evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Evidence Collector

## Purpose
Design and execute portfolio analytics workflows using evidence collector controls with validated outcomes.
