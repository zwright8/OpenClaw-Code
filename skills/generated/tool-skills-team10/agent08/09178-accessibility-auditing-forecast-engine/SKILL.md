---
name: accessibility-auditing-forecast-engine
description: Use when tasks require accessibility auditing forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Forecast Engine

## Purpose
Design and execute accessibility auditing workflows using forecast engine controls with validated outcomes.
