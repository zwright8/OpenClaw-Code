---
name: content-governance-root-cause-miner
description: Use when tasks require content governance root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Root Cause Miner

## Purpose
Design and execute content governance workflows using root cause miner controls with validated outcomes.
