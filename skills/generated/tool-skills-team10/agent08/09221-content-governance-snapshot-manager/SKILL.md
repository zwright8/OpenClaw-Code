---
name: content-governance-snapshot-manager
description: Use when tasks require content governance snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Snapshot Manager

## Purpose
Design and execute content governance workflows using snapshot manager controls with validated outcomes.
