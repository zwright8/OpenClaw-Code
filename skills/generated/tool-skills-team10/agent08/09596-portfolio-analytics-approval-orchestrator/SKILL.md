---
name: portfolio-analytics-approval-orchestrator
description: Use when tasks require portfolio analytics approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Approval Orchestrator

## Purpose
Design and execute portfolio analytics workflows using approval orchestrator controls with validated outcomes.
