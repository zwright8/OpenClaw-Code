---
name: live-event-ops-access-auditor
description: Use when tasks require live event ops access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Access Auditor

## Purpose
Design and execute live event ops workflows using access auditor controls with validated outcomes.
