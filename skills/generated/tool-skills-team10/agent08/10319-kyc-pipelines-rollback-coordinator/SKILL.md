---
name: kyc-pipelines-rollback-coordinator
description: Use when tasks require kyc pipelines rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Rollback Coordinator

## Purpose
Design and execute kyc pipelines workflows using rollback coordinator controls with validated outcomes.
