---
name: creator-platforms-evidence-collector
description: Use when tasks require creator platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Creator Platforms Evidence Collector

## Purpose
Design and execute creator platforms workflows using evidence collector controls with validated outcomes.
