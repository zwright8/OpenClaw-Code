---
name: payment-gateways-anomaly-detector
description: Use when tasks require payment gateways anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Anomaly Detector

## Purpose
Design and execute payment gateways workflows using anomaly detector controls with validated outcomes.
