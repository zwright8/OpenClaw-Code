---
name: live-event-ops-state-reconciler
description: Use when tasks require live event ops state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops State Reconciler

## Purpose
Design and execute live event ops workflows using state reconciler controls with validated outcomes.
