---
name: merchant-risk-retry-governor
description: Use when tasks require merchant risk retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Retry Governor

## Purpose
Design and execute merchant risk workflows using retry governor controls with validated outcomes.
