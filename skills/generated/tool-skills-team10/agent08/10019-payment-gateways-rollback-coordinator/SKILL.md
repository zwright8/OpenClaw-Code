---
name: payment-gateways-rollback-coordinator
description: Use when tasks require payment gateways rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Rollback Coordinator

## Purpose
Design and execute payment gateways workflows using rollback coordinator controls with validated outcomes.
