---
name: live-event-ops-risk-scorer
description: Use when tasks require live event ops risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Risk Scorer

## Purpose
Design and execute live event ops workflows using risk scorer controls with validated outcomes.
