---
name: live-event-ops-provenance-tracker
description: Use when tasks require live event ops provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Provenance Tracker

## Purpose
Design and execute live event ops workflows using provenance tracker controls with validated outcomes.
