---
name: portfolio-analytics-workflow-compiler
description: Use when tasks require portfolio analytics workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Workflow Compiler

## Purpose
Design and execute portfolio analytics workflows using workflow compiler controls with validated outcomes.
