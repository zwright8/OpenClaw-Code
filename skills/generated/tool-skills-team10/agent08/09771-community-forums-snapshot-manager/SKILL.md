---
name: community-forums-snapshot-manager
description: Use when tasks require community forums snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Snapshot Manager

## Purpose
Design and execute community forums workflows using snapshot manager controls with validated outcomes.
