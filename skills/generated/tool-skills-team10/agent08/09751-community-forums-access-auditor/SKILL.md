---
name: community-forums-access-auditor
description: Use when tasks require community forums access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Access Auditor

## Purpose
Design and execute community forums workflows using access auditor controls with validated outcomes.
