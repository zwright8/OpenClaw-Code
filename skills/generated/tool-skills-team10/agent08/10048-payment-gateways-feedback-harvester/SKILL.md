---
name: payment-gateways-feedback-harvester
description: Use when tasks require payment gateways feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Feedback Harvester

## Purpose
Design and execute payment gateways workflows using feedback harvester controls with validated outcomes.
