---
name: portfolio-analytics-rollback-coordinator
description: Use when tasks require portfolio analytics rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Rollback Coordinator

## Purpose
Design and execute portfolio analytics workflows using rollback coordinator controls with validated outcomes.
