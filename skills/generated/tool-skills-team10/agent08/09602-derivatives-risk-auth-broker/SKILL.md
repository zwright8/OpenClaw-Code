---
name: derivatives-risk-auth-broker
description: Use when tasks require derivatives risk auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Auth Broker

## Purpose
Design and execute derivatives risk workflows using auth broker controls with validated outcomes.
