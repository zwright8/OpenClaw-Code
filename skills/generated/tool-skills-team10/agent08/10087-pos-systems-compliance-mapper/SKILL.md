---
name: pos-systems-compliance-mapper
description: Use when tasks require pos systems compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Compliance Mapper

## Purpose
Design and execute pos systems workflows using compliance mapper controls with validated outcomes.
