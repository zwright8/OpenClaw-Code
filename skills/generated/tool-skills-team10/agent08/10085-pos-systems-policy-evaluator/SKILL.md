---
name: pos-systems-policy-evaluator
description: Use when tasks require pos systems policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Policy Evaluator

## Purpose
Design and execute pos systems workflows using policy evaluator controls with validated outcomes.
