---
name: accessibility-auditing-task-decomposer
description: Use when tasks require accessibility auditing task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Task Decomposer

## Purpose
Design and execute accessibility auditing workflows using task decomposer controls with validated outcomes.
