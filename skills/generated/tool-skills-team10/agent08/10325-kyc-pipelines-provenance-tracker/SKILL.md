---
name: kyc-pipelines-provenance-tracker
description: Use when tasks require kyc pipelines provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Provenance Tracker

## Purpose
Design and execute kyc pipelines workflows using provenance tracker controls with validated outcomes.
