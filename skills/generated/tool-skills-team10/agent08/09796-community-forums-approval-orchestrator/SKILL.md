---
name: community-forums-approval-orchestrator
description: Use when tasks require community forums approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Approval Orchestrator

## Purpose
Design and execute community forums workflows using approval orchestrator controls with validated outcomes.
