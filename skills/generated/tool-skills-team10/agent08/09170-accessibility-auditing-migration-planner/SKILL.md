---
name: accessibility-auditing-migration-planner
description: Use when tasks require accessibility auditing migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Migration Planner

## Purpose
Design and execute accessibility auditing workflows using migration planner controls with validated outcomes.
