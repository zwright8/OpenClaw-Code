---
name: audience-analytics-execution-runner
description: Use when tasks require audience analytics execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Execution Runner

## Purpose
Design and execute audience analytics workflows using execution runner controls with validated outcomes.
