---
name: kyc-pipelines-dependency-resolver
description: Use when tasks require kyc pipelines dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Dependency Resolver

## Purpose
Design and execute kyc pipelines workflows using dependency resolver controls with validated outcomes.
