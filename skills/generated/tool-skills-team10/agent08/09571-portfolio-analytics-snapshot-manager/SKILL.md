---
name: portfolio-analytics-snapshot-manager
description: Use when tasks require portfolio analytics snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Snapshot Manager

## Purpose
Design and execute portfolio analytics workflows using snapshot manager controls with validated outcomes.
