---
name: terminology-mgmt-retry-governor
description: Use when tasks require terminology mgmt retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Retry Governor

## Purpose
Design and execute terminology mgmt workflows using retry governor controls with validated outcomes.
