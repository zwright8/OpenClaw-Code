---
name: live-event-ops-reliability-scorer
description: Use when tasks require live event ops reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Reliability Scorer

## Purpose
Design and execute live event ops workflows using reliability scorer controls with validated outcomes.
