---
name: community-forums-permission-mapper
description: Use when tasks require community forums permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Permission Mapper

## Purpose
Design and execute community forums workflows using permission mapper controls with validated outcomes.
