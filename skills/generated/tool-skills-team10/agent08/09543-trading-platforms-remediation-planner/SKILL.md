---
name: trading-platforms-remediation-planner
description: Use when tasks require trading platforms remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Remediation Planner

## Purpose
Design and execute trading platforms workflows using remediation planner controls with validated outcomes.
