---
name: kyc-pipelines-risk-scorer
description: Use when tasks require kyc pipelines risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Risk Scorer

## Purpose
Design and execute kyc pipelines workflows using risk scorer controls with validated outcomes.
