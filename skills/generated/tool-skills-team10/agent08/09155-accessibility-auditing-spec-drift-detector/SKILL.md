---
name: accessibility-auditing-spec-drift-detector
description: Use when tasks require accessibility auditing spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Spec Drift Detector

## Purpose
Design and execute accessibility auditing workflows using spec drift detector controls with validated outcomes.
