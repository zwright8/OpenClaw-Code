---
name: derivatives-risk-task-decomposer
description: Use when tasks require derivatives risk task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Task Decomposer

## Purpose
Design and execute derivatives risk workflows using task decomposer controls with validated outcomes.
