---
name: streaming-operations-spec-drift-detector
description: Use when tasks require streaming operations spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Spec Drift Detector

## Purpose
Design and execute streaming operations workflows using spec drift detector controls with validated outcomes.
