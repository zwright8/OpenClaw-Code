---
name: portfolio-analytics-anomaly-detector
description: Use when tasks require portfolio analytics anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Anomaly Detector

## Purpose
Design and execute portfolio analytics workflows using anomaly detector controls with validated outcomes.
