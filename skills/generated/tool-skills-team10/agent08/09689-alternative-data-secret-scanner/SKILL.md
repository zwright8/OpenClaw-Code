---
name: alternative-data-secret-scanner
description: Use when tasks require alternative data secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Secret Scanner

## Purpose
Design and execute alternative data workflows using secret scanner controls with validated outcomes.
