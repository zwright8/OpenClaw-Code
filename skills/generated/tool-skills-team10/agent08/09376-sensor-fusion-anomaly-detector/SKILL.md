...
description: Use when tasks require sensor fusion anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Anomaly Detector

## Purpose
Design and execute sensor fusion workflows using anomaly detector controls with validated outcomes.
