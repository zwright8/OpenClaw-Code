---
name: live-event-ops-forecast-engine
description: Use when tasks require live event ops forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Forecast Engine

## Purpose
Design and execute live event ops workflows using forecast engine controls with validated outcomes.
