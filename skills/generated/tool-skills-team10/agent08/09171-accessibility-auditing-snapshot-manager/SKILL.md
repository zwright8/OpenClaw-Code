---
name: accessibility-auditing-snapshot-manager
description: Use when tasks require accessibility auditing snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Snapshot Manager

## Purpose
Design and execute accessibility auditing workflows using snapshot manager controls with validated outcomes.
