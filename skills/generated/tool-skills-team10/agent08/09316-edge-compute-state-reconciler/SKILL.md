---
name: edge-compute-state-reconciler
description: Use when tasks require edge compute state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute State Reconciler

## Purpose
Design and execute edge compute workflows using state reconciler controls with validated outcomes.
