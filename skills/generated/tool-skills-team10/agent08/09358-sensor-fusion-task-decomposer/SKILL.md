---
name: sensor-fusion-task-decomposer
description: Use when tasks require sensor fusion task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Task Decomposer

## Purpose
Design and execute sensor fusion workflows using task decomposer controls with validated outcomes.
