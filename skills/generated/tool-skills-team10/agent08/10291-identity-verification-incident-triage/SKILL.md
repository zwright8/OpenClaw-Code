---
name: identity-verification-incident-triage
description: Use when tasks require identity verification incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Incident Triage

## Purpose
Design and execute identity verification workflows using incident triage controls with validated outcomes.
