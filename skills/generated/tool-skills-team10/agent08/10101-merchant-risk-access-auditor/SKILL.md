---
name: merchant-risk-access-auditor
description: Use when tasks require merchant risk access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Access Auditor

## Purpose
Design and execute merchant risk workflows using access auditor controls with validated outcomes.
