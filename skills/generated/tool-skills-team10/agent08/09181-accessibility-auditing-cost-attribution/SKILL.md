---
name: accessibility-auditing-cost-attribution
description: Use when tasks require accessibility auditing cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Cost Attribution

## Purpose
Design and execute accessibility auditing workflows using cost attribution controls with validated outcomes.
