---
name: kyc-pipelines-auth-broker
description: Use when tasks require kyc pipelines auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Auth Broker

## Purpose
Design and execute kyc pipelines workflows using auth broker controls with validated outcomes.
