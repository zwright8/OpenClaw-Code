---
name: payment-gateways-schema-introspector
description: Use when tasks require payment gateways schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Schema Introspector

## Purpose
Design and execute payment gateways workflows using schema introspector controls with validated outcomes.
