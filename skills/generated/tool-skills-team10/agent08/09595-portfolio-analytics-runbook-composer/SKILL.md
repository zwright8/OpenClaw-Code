---
name: portfolio-analytics-runbook-composer
description: Use when tasks require portfolio analytics runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Runbook Composer

## Purpose
Design and execute portfolio analytics workflows using runbook composer controls with validated outcomes.
