---
name: alternative-data-evidence-collector
description: Use when tasks require alternative data evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Evidence Collector

## Purpose
Design and execute alternative data workflows using evidence collector controls with validated outcomes.
