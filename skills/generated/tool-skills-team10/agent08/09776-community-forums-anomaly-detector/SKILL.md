---
name: community-forums-anomaly-detector
description: Use when tasks require community forums anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Anomaly Detector

## Purpose
Design and execute community forums workflows using anomaly detector controls with validated outcomes.
