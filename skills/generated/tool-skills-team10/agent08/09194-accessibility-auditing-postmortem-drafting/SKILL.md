---
name: accessibility-auditing-postmortem-drafting
description: Use when tasks require accessibility auditing postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Postmortem Drafting

## Purpose
Design and execute accessibility auditing workflows using postmortem drafting controls with validated outcomes.
