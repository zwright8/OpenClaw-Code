---
name: identity-verification-migration-planner
description: Use when tasks require identity verification migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Migration Planner

## Purpose
Design and execute identity verification workflows using migration planner controls with validated outcomes.
