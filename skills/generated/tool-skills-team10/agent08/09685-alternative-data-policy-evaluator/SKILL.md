---
name: alternative-data-policy-evaluator
description: Use when tasks require alternative data policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Policy Evaluator

## Purpose
Design and execute alternative data workflows using policy evaluator controls with validated outcomes.
