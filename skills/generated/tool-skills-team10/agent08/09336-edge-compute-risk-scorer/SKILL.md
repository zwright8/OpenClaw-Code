---
name: edge-compute-risk-scorer
description: Use when tasks require edge compute risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Risk Scorer

## Purpose
Design and execute edge compute workflows using risk scorer controls with validated outcomes.
