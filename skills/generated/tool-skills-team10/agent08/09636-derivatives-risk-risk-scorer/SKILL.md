---
name: derivatives-risk-risk-scorer
description: Use when tasks require derivatives risk risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Risk Scorer

## Purpose
Design and execute derivatives risk workflows using risk scorer controls with validated outcomes.
