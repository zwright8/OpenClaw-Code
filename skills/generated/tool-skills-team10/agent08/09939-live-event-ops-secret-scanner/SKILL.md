---
name: live-event-ops-secret-scanner
description: Use when tasks require live event ops secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Secret Scanner

## Purpose
Design and execute live event ops workflows using secret scanner controls with validated outcomes.
