---
name: portfolio-analytics-execution-runner
description: Use when tasks require portfolio analytics execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Execution Runner

## Purpose
Design and execute portfolio analytics workflows using execution runner controls with validated outcomes.
