---
name: onboarding-journeys-approval-orchestrator
description: Use when tasks require onboarding journeys approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Approval Orchestrator

## Purpose
Design and execute onboarding journeys workflows using approval orchestrator controls with validated outcomes.
