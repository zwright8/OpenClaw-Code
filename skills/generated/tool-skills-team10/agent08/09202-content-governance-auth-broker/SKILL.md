---
name: content-governance-auth-broker
description: Use when tasks require content governance auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Auth Broker

## Purpose
Design and execute content governance workflows using auth broker controls with validated outcomes.
