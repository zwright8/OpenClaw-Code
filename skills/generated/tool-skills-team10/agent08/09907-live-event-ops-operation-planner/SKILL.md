---
name: live-event-ops-operation-planner
description: Use when tasks require live event ops operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Operation Planner

## Purpose
Design and execute live event ops workflows using operation planner controls with validated outcomes.
