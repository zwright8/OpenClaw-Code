---
name: content-governance-secret-scanner
description: Use when tasks require content governance secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Secret Scanner

## Purpose
Design and execute content governance workflows using secret scanner controls with validated outcomes.
