---
name: pos-systems-migration-planner
description: Use when tasks require pos systems migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Migration Planner

## Purpose
Design and execute pos systems workflows using migration planner controls with validated outcomes.
