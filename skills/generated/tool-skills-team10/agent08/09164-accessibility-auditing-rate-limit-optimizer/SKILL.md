---
name: accessibility-auditing-rate-limit-optimizer
description: Use when tasks require accessibility auditing rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Rate Limit Optimizer

## Purpose
Design and execute accessibility auditing workflows using rate limit optimizer controls with validated outcomes.
