---
name: settlement-reconciliation-access-auditor
description: Use when tasks require settlement reconciliation access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Settlement Reconciliation Access Auditor

## Purpose
Design and execute settlement reconciliation workflows using access auditor controls with validated outcomes.
