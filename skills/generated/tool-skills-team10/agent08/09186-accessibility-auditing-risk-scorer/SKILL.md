---
name: accessibility-auditing-risk-scorer
description: Use when tasks require accessibility auditing risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Risk Scorer

## Purpose
Design and execute accessibility auditing workflows using risk scorer controls with validated outcomes.
