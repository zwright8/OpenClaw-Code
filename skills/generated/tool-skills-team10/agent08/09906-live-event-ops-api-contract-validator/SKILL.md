---
name: live-event-ops-api-contract-validator
description: Use when tasks require live event ops api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops API Contract Validator

## Purpose
Design and execute live event ops workflows using api contract validator controls with validated outcomes.

## Precision Profile
- Domain: Live Event Ops
...
- Domain: [Live Event Ops](../../resources/domains/live-event-ops.md)
