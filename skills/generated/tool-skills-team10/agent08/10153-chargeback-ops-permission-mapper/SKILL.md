---
name: chargeback-ops-permission-mapper
description: Use when tasks require chargeback ops permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Permission Mapper

## Purpose
Design and execute chargeback ops workflows using permission mapper controls with validated outcomes.
