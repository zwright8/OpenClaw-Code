---
name: onboarding-journeys-retry-governor
description: Use when tasks require onboarding journeys retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Retry Governor

## Purpose
Design and execute onboarding journeys workflows using retry governor controls with validated outcomes.
