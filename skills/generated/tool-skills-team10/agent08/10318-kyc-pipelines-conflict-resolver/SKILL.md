---
name: kyc-pipelines-conflict-resolver
description: Use when tasks require kyc pipelines conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Conflict Resolver

## Purpose
Design and execute kyc pipelines workflows using conflict resolver controls with validated outcomes.
