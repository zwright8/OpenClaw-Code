---
name: onboarding-journeys-spec-drift-detector
description: Use when tasks require onboarding journeys spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Spec Drift Detector

## Purpose
Design and execute onboarding journeys workflows using spec drift detector controls with validated outcomes.
