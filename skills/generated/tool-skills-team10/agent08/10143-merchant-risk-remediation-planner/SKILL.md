---
name: merchant-risk-remediation-planner
description: Use when tasks require merchant risk remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Remediation Planner

## Purpose
Design and execute merchant risk workflows using remediation planner controls with validated outcomes.
