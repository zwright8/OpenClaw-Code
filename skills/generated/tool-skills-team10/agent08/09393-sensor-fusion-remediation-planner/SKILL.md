---
name: sensor-fusion-remediation-planner
description: Use when tasks require sensor fusion remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Remediation Planner

## Purpose
Design and execute sensor fusion workflows using remediation planner controls with validated outcomes.
