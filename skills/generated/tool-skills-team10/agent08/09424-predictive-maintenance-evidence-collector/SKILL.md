---
name: predictive-maintenance-evidence-collector
description: Use when tasks require predictive maintenance evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Predictive Maintenance Evidence Collector

## Purpose
Design and execute predictive maintenance workflows using evidence collector controls with validated outcomes.
