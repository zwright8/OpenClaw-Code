---
name: accessibility-auditing-compliance-mapper
description: Use when tasks require accessibility auditing compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Compliance Mapper

## Purpose
Design and execute accessibility auditing workflows using compliance mapper controls with validated outcomes.
