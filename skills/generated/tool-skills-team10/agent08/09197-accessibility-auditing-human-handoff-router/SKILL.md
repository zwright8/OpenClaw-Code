---
name: accessibility-auditing-human-handoff-router
description: Use when tasks require accessibility auditing human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Human Handoff Router

## Purpose
Design and execute accessibility auditing workflows using human handoff router controls with validated outcomes.
