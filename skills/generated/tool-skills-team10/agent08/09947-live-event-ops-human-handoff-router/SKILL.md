...
description: Use when tasks require live event ops human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Human Handoff Router

## Purpose
Design and execute live event ops workflows using human handoff router controls with validated outcomes.
