---
name: merchant-risk-queue-balancer
description: Use when tasks require merchant risk queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Queue Balancer

## Purpose
Design and execute merchant risk workflows using queue balancer controls with validated outcomes.
