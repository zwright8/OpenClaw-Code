---
name: accessibility-auditing-retry-governor
description: Use when tasks require accessibility auditing retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Retry Governor

## Purpose
Design and execute accessibility auditing workflows using retry governor controls with validated outcomes.
