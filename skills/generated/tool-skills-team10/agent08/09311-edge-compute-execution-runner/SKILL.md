---
name: edge-compute-execution-runner
description: Use when tasks require edge compute execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Execution Runner

## Purpose
Design and execute edge compute workflows using execution runner controls with validated outcomes.
