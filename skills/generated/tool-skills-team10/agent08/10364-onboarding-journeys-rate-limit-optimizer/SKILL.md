...
description: Use when tasks require onboarding journeys rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Rate Limit Optimizer

## Purpose
Design and execute onboarding journeys workflows using rate limit optimizer controls with validated outcomes.
