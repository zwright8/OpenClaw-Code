---
name: accessibility-auditing-secret-scanner
description: Use when tasks require accessibility auditing secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Secret Scanner

## Purpose
Design and execute accessibility auditing workflows using secret scanner controls with validated outcomes.
