---
name: portfolio-analytics-delta-calculator
description: Use when tasks require portfolio analytics delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Delta Calculator

## Purpose
Design and execute portfolio analytics workflows using delta calculator controls with validated outcomes.
