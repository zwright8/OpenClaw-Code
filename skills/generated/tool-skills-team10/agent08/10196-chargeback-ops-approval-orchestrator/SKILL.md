---
name: chargeback-ops-approval-orchestrator
description: Use when tasks require chargeback ops approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Approval Orchestrator

## Purpose
Design and execute chargeback ops workflows using approval orchestrator controls with validated outcomes.
