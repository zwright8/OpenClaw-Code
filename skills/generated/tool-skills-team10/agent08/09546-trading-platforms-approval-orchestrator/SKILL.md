---
name: trading-platforms-approval-orchestrator
description: Use when tasks require trading platforms approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Approval Orchestrator

## Purpose
Design and execute trading platforms workflows using approval orchestrator controls with validated outcomes.
