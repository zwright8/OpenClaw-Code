---
name: streaming-operations-compliance-mapper
description: Use when tasks require streaming operations compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Compliance Mapper

## Purpose
Design and execute streaming operations workflows using compliance mapper controls with validated outcomes.
