---
name: predictive-maintenance-root-cause-miner
description: Use when tasks require predictive maintenance root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Predictive Maintenance Root Cause Miner

## Purpose
Design and execute predictive maintenance workflows using root cause miner controls with validated outcomes.
