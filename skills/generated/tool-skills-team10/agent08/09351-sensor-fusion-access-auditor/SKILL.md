---
name: sensor-fusion-access-auditor
description: Use when tasks require sensor fusion access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Access Auditor

## Purpose
Design and execute sensor fusion workflows using access auditor controls with validated outcomes.
