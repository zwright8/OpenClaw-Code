---
name: content-governance-dependency-resolver
description: Use when tasks require content governance dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Dependency Resolver

## Purpose
Design and execute content governance workflows using dependency resolver controls with validated outcomes.
