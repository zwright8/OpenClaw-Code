---
name: streaming-operations-execution-runner
description: Use when tasks require streaming operations execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Execution Runner

## Purpose
Design and execute streaming operations workflows using execution runner controls with validated outcomes.
