---
name: merchant-risk-cost-attribution
description: Use when tasks require merchant risk cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Cost Attribution

## Purpose
Design and execute merchant risk workflows using cost attribution controls with validated outcomes.
