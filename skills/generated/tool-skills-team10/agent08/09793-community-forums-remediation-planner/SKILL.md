---
name: community-forums-remediation-planner
description: Use when tasks require community forums remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Remediation Planner

## Purpose
Design and execute community forums workflows using remediation planner controls with validated outcomes.
