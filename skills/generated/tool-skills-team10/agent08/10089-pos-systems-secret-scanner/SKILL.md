---
name: pos-systems-secret-scanner
description: Use when tasks require pos systems secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Secret Scanner

## Purpose
Design and execute pos systems workflows using secret scanner controls with validated outcomes.
