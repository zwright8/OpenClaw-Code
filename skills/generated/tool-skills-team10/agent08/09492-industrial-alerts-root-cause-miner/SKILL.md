---
name: industrial-alerts-root-cause-miner
description: Use when tasks require industrial alerts root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Industrial Alerts Root Cause Miner

## Purpose
Design and execute industrial alerts workflows using root cause miner controls with validated outcomes.
