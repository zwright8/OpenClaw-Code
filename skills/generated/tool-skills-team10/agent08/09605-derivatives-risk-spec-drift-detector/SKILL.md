---
name: derivatives-risk-spec-drift-detector
description: Use when tasks require derivatives risk spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Spec Drift Detector

## Purpose
Design and execute derivatives risk workflows using spec drift detector controls with validated outcomes.
