---
name: merchant-risk-secret-scanner
description: Use when tasks require merchant risk secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Secret Scanner

## Purpose
Design and execute merchant risk workflows using secret scanner controls with validated outcomes.
