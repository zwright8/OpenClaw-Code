---
name: onboarding-journeys-access-auditor
description: Use when tasks require onboarding journeys access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Access Auditor

## Purpose
Design and execute onboarding journeys workflows using access auditor controls with validated outcomes.
