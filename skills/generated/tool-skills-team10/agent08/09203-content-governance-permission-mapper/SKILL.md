---
name: content-governance-permission-mapper
description: Use when tasks require content governance permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Permission Mapper

## Purpose
Design and execute content governance workflows using permission mapper controls with validated outcomes.
