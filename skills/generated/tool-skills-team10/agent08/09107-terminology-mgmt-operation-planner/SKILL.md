---
name: terminology-mgmt-operation-planner
description: Use when tasks require terminology mgmt operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Operation Planner

## Purpose
Design and execute terminology mgmt workflows using operation planner controls with validated outcomes.
