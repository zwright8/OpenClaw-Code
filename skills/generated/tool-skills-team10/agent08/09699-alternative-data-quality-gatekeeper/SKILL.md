---
name: alternative-data-quality-gatekeeper
description: Use when tasks require alternative data quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Quality Gatekeeper

## Purpose
Design and execute alternative data workflows using quality gatekeeper controls with validated outcomes.
