---
name: chargeback-ops-artifact-publisher
description: Use when tasks require chargeback ops artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Artifact Publisher

## Purpose
Design and execute chargeback ops workflows using artifact publisher controls with validated outcomes.
