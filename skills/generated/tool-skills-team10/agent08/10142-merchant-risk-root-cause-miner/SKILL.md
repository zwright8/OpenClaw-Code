---
name: merchant-risk-root-cause-miner
description: Use when tasks require merchant risk root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Root Cause Miner

## Purpose
Design and execute merchant risk workflows using root cause miner controls with validated outcomes.
