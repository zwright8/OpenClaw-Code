---
name: creator-platforms-secret-scanner
description: Use when tasks require creator platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Creator Platforms Secret Scanner

## Purpose
Design and execute creator platforms workflows using secret scanner controls with validated outcomes.
