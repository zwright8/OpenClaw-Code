---
name: kyc-pipelines-secret-scanner
description: Use when tasks require kyc pipelines secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Secret Scanner

## Purpose
Design and execute kyc pipelines workflows using secret scanner controls with validated outcomes.
