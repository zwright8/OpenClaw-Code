---
name: industrial-alerts-incident-triage
description: Use when tasks require industrial alerts incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Industrial Alerts Incident Triage

## Purpose
Design and execute industrial alerts workflows using incident triage controls with validated outcomes.
