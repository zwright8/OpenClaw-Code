---
name: live-event-ops-permission-mapper
description: Use when tasks require live event ops permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Permission Mapper

## Purpose
Design and execute live event ops workflows using permission mapper controls with validated outcomes.
