---
name: derivatives-risk-outcome-synthesizer
description: Use when tasks require derivatives risk outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Outcome Synthesizer

## Purpose
Design and execute derivatives risk workflows using outcome synthesizer controls with validated outcomes.
