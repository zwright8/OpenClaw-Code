---
name: portfolio-analytics-operation-planner
description: Use when tasks require portfolio analytics operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Operation Planner

## Purpose
Design and execute portfolio analytics workflows using operation planner controls with validated outcomes.
