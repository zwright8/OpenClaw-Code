---
name: terminology-mgmt-anomaly-detector
description: Use when tasks require terminology mgmt anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Anomaly Detector

## Purpose
Design and execute terminology mgmt workflows using anomaly detector controls with validated outcomes.
