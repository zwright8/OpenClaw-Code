---
name: merchant-risk-policy-evaluator
description: Use when tasks require merchant risk policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Policy Evaluator

## Purpose
Design and execute merchant risk workflows using policy evaluator controls with validated outcomes.
