---
name: payment-gateways-access-auditor
description: Use when tasks require payment gateways access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Access Auditor

## Purpose
Design and execute payment gateways workflows using access auditor controls with validated outcomes.
