---
name: portfolio-analytics-feedback-harvester
description: Use when tasks require portfolio analytics feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Feedback Harvester

## Purpose
Design and execute portfolio analytics workflows using feedback harvester controls with validated outcomes.
