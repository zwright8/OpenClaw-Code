---
name: audience-analytics-auth-broker
description: Use when tasks require audience analytics auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Auth Broker

## Purpose
Design and execute audience analytics workflows using auth broker controls with validated outcomes.
