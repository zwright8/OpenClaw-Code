---
name: onboarding-journeys-dependency-resolver
description: Use when tasks require onboarding journeys dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Dependency Resolver

## Purpose
Design and execute onboarding journeys workflows using dependency resolver controls with validated outcomes.
