...
description: Use when tasks require payment gateways approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Approval Orchestrator

## Purpose
Design and execute payment gateways workflows using approval orchestrator controls with validated outcomes.
