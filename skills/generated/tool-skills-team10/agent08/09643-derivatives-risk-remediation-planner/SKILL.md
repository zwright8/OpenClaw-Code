...
description: Use when tasks require derivatives risk remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Remediation Planner

## Purpose
Design and execute derivatives risk workflows using remediation planner controls with validated outcomes.
