---
name: streaming-operations-artifact-publisher
description: Use when tasks require streaming operations artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Artifact Publisher

## Purpose
Design and execute streaming operations workflows using artifact publisher controls with validated outcomes.
