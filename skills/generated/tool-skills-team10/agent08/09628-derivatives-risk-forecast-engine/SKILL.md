---
name: derivatives-risk-forecast-engine
description: Use when tasks require derivatives risk forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Forecast Engine

## Purpose
Design and execute derivatives risk workflows using forecast engine controls with validated outcomes.
