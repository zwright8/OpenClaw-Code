---
name: edge-compute-anomaly-detector
description: Use when tasks require edge compute anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Anomaly Detector

## Purpose
Design and execute edge compute workflows using anomaly detector controls with validated outcomes.
