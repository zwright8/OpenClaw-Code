---
name: content-governance-anomaly-detector
description: Use when tasks require content governance anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Anomaly Detector

## Purpose
Design and execute content governance workflows using anomaly detector controls with validated outcomes.
