---
name: accessibility-auditing-remediation-planner
description: Use when tasks require accessibility auditing remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Remediation Planner

## Purpose
Design and execute accessibility auditing workflows using remediation planner controls with validated outcomes.
