---
name: audience-analytics-postmortem-drafting
description: Use when tasks require audience analytics postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Postmortem Drafting

## Purpose
Design and execute audience analytics workflows using postmortem drafting controls with validated outcomes.
