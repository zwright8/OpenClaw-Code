---
name: audience-analytics-capacity-planner
description: Use when tasks require audience analytics capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Capacity Planner

## Purpose
Design and execute audience analytics workflows using capacity planner controls with validated outcomes.
