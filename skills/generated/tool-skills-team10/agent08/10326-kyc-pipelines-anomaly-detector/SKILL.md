---
name: kyc-pipelines-anomaly-detector
description: Use when tasks require kyc pipelines anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Anomaly Detector

## Purpose
Design and execute kyc pipelines workflows using anomaly detector controls with validated outcomes.
