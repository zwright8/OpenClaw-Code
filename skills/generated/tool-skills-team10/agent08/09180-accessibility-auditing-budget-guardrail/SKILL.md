---
name: accessibility-auditing-budget-guardrail
description: Use when tasks require accessibility auditing budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Budget Guardrail

## Purpose
Design and execute accessibility auditing workflows using budget guardrail controls with validated outcomes.
