---
name: payment-gateways-permission-mapper
description: Use when tasks require payment gateways permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Permission Mapper

## Purpose
Design and execute payment gateways workflows using permission mapper controls with validated outcomes.
