---
name: identity-verification-dependency-resolver
description: Use when tasks require identity verification dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Dependency Resolver

## Purpose
Design and execute identity verification workflows using dependency resolver controls with validated outcomes.
