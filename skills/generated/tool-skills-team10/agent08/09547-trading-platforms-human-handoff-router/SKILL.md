---
name: trading-platforms-human-handoff-router
description: Use when tasks require trading platforms human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Human Handoff Router

## Purpose
Design and execute trading platforms workflows using human handoff router controls with validated outcomes.
