---
name: payment-gateways-forecast-engine
description: Use when tasks require payment gateways forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Forecast Engine

## Purpose
Design and execute payment gateways workflows using forecast engine controls with validated outcomes.
