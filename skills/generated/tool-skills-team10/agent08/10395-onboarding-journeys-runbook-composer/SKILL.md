---
name: onboarding-journeys-runbook-composer
description: Use when tasks require onboarding journeys runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Runbook Composer

## Purpose
Design and execute onboarding journeys workflows using runbook composer controls with validated outcomes.
