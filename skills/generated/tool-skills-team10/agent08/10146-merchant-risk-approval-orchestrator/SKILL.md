---
name: merchant-risk-approval-orchestrator
description: Use when tasks require merchant risk approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Approval Orchestrator

## Purpose
Design and execute merchant risk workflows using approval orchestrator controls with validated outcomes.
