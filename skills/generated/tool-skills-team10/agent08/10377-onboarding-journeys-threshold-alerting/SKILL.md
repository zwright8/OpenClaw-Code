---
name: onboarding-journeys-threshold-alerting
description: Use when tasks require onboarding journeys threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Threshold Alerting

## Purpose
Design and execute onboarding journeys workflows using threshold alerting controls with validated outcomes.
