---
name: sensor-fusion-artifact-publisher
description: Use when tasks require sensor fusion artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Artifact Publisher

## Purpose
Design and execute sensor fusion workflows using artifact publisher controls with validated outcomes.
