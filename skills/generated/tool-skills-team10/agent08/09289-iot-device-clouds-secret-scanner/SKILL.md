---
name: iot-device-clouds-secret-scanner
description: Use when tasks require iot device clouds secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# IoT Device Clouds Secret Scanner

## Purpose
Design and execute iot device clouds workflows using secret scanner controls with validated outcomes.
