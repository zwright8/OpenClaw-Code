---
name: community-forums-auth-broker
description: Use when tasks require community forums auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Auth Broker

## Purpose
Design and execute community forums workflows using auth broker controls with validated outcomes.
