---
name: pos-systems-dependency-resolver
description: Use when tasks require pos systems dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Dependency Resolver

## Purpose
Design and execute pos systems workflows using dependency resolver controls with validated outcomes.
