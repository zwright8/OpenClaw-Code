---
name: pos-systems-auth-broker
description: Use when tasks require pos systems auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Auth Broker

## Purpose
Design and execute pos systems workflows using auth broker controls with validated outcomes.
