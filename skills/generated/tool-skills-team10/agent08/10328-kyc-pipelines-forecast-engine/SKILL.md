---
name: kyc-pipelines-forecast-engine
description: Use when tasks require kyc pipelines forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Forecast Engine

## Purpose
Design and execute kyc pipelines workflows using forecast engine controls with validated outcomes.
