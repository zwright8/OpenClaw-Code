---
name: chargeback-ops-api-contract-validator
description: Use when tasks require chargeback ops api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops API Contract Validator

## Purpose
Design and execute chargeback ops workflows using api contract validator controls with validated outcomes.

## Precision Profile
- Domain: Chargeback Ops
...
- Domain: [Chargeback Ops](../../resources/domains/chargeback-ops.md)
