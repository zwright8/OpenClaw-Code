---
name: identity-verification-capacity-planner
description: Use when tasks require identity verification capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Capacity Planner

## Purpose
Design and execute identity verification workflows using capacity planner controls with validated outcomes.
