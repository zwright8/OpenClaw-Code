---
name: trading-platforms-runbook-composer
description: Use when tasks require trading platforms runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Runbook Composer

## Purpose
Design and execute trading platforms workflows using runbook composer controls with validated outcomes.
