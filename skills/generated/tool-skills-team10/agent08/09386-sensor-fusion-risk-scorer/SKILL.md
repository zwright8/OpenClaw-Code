---
name: sensor-fusion-risk-scorer
description: Use when tasks require sensor fusion risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Risk Scorer

## Purpose
Design and execute sensor fusion workflows using risk scorer controls with validated outcomes.
