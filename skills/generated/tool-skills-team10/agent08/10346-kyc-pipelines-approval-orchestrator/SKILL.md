---
name: kyc-pipelines-approval-orchestrator
description: Use when tasks require kyc pipelines approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Approval Orchestrator

## Purpose
Design and execute kyc pipelines workflows using approval orchestrator controls with validated outcomes.
