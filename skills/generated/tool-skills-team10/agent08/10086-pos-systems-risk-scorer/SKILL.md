---
name: pos-systems-risk-scorer
description: Use when tasks require pos systems risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Risk Scorer

## Purpose
Design and execute pos systems workflows using risk scorer controls with validated outcomes.
