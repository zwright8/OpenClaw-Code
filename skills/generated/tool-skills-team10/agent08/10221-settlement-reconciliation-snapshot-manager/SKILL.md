---
name: settlement-reconciliation-snapshot-manager
description: Use when tasks require settlement reconciliation snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Settlement Reconciliation Snapshot Manager

## Purpose
Design and execute settlement reconciliation workflows using snapshot manager controls with validated outcomes.
