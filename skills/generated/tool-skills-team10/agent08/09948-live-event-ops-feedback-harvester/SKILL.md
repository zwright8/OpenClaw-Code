---
name: live-event-ops-feedback-harvester
description: Use when tasks require live event ops feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Feedback Harvester

## Purpose
Design and execute live event ops workflows using feedback harvester controls with validated outcomes.
