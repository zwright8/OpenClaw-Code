---
name: trading-platforms-risk-scorer
description: Use when tasks require trading platforms risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Risk Scorer

## Purpose
Design and execute trading platforms workflows using risk scorer controls with validated outcomes.
