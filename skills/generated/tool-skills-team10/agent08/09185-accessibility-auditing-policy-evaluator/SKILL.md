---
name: accessibility-auditing-policy-evaluator
description: Use when tasks require accessibility auditing policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Policy Evaluator

## Purpose
Design and execute accessibility auditing workflows using policy evaluator controls with validated outcomes.
