---
name: onboarding-journeys-artifact-publisher
description: Use when tasks require onboarding journeys artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Artifact Publisher

## Purpose
Design and execute onboarding journeys workflows using artifact publisher controls with validated outcomes.
