---
name: pos-systems-root-cause-miner
description: Use when tasks require pos systems root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Root Cause Miner

## Purpose
Design and execute pos systems workflows using root cause miner controls with validated outcomes.
