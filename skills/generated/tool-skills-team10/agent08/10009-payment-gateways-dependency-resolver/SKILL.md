---
name: payment-gateways-dependency-resolver
description: Use when tasks require payment gateways dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Dependency Resolver

## Purpose
Design and execute payment gateways workflows using dependency resolver controls with validated outcomes.
