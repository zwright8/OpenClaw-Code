---
name: derivatives-risk-operation-planner
description: Use when tasks require derivatives risk operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Operation Planner

## Purpose
Design and execute derivatives risk workflows using operation planner controls with validated outcomes.
