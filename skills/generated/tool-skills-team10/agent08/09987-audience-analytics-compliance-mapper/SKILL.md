---
name: audience-analytics-compliance-mapper
description: Use when tasks require audience analytics compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Compliance Mapper

## Purpose
Design and execute audience analytics workflows using compliance mapper controls with validated outcomes.
