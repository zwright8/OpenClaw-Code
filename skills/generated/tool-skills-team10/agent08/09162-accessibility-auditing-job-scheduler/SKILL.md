---
name: accessibility-auditing-job-scheduler
description: Use when tasks require accessibility auditing job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Job Scheduler

## Purpose
Design and execute accessibility auditing workflows using job scheduler controls with validated outcomes.
