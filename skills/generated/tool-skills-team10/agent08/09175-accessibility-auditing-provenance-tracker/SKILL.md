---
name: accessibility-auditing-provenance-tracker
description: Use when tasks require accessibility auditing provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Provenance Tracker

## Purpose
Design and execute accessibility auditing workflows using provenance tracker controls with validated outcomes.
