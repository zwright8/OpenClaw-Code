---
name: accessibility-auditing-auth-broker
description: Use when tasks require accessibility auditing auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Auth Broker

## Purpose
Design and execute accessibility auditing workflows using auth broker controls with validated outcomes.
