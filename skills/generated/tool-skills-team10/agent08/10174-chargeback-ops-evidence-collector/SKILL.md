---
name: chargeback-ops-evidence-collector
description: Use when tasks require chargeback ops evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Evidence Collector

## Purpose
Design and execute chargeback ops workflows using evidence collector controls with validated outcomes.
