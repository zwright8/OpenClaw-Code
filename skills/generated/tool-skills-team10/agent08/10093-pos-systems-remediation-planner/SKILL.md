---
name: pos-systems-remediation-planner
description: Use when tasks require pos systems remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Remediation Planner

## Purpose
Design and execute pos systems workflows using remediation planner controls with validated outcomes.
