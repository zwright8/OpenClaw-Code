---
name: edge-compute-dependency-resolver
description: Use when tasks require edge compute dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Dependency Resolver

## Purpose
Design and execute edge compute workflows using dependency resolver controls with validated outcomes.
