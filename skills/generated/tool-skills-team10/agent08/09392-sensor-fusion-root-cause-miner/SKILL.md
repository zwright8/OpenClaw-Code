---
name: sensor-fusion-root-cause-miner
description: Use when tasks require sensor fusion root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Root Cause Miner

## Purpose
Design and execute sensor fusion workflows using root cause miner controls with validated outcomes.
