---
name: community-forums-rollback-coordinator
description: Use when tasks require community forums rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Rollback Coordinator

## Purpose
Design and execute community forums workflows using rollback coordinator controls with validated outcomes.
