---
name: audience-analytics-risk-scorer
description: Use when tasks require audience analytics risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Risk Scorer

## Purpose
Design and execute audience analytics workflows using risk scorer controls with validated outcomes.
