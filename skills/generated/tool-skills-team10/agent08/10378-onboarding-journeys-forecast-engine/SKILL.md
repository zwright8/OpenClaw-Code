---
name: onboarding-journeys-forecast-engine
description: Use when tasks require onboarding journeys forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Forecast Engine

## Purpose
Design and execute onboarding journeys workflows using forecast engine controls with validated outcomes.
