...
description: Use when tasks require derivatives risk incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Incident Triage

## Purpose
Design and execute derivatives risk workflows using incident triage controls with validated outcomes.
