---
name: derivatives-risk-permission-mapper
description: Use when tasks require derivatives risk permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Permission Mapper

## Purpose
Design and execute derivatives risk workflows using permission mapper controls with validated outcomes.
