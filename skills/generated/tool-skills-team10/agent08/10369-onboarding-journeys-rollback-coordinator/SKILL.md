---
name: onboarding-journeys-rollback-coordinator
description: Use when tasks require onboarding journeys rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Rollback Coordinator

## Purpose
Design and execute onboarding journeys workflows using rollback coordinator controls with validated outcomes.
