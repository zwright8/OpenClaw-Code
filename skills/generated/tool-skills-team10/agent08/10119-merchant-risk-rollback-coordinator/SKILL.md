---
name: merchant-risk-rollback-coordinator
description: Use when tasks require merchant risk rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Rollback Coordinator

## Purpose
Design and execute merchant risk workflows using rollback coordinator controls with validated outcomes.
