---
name: live-event-ops-postmortem-drafting
description: Use when tasks require live event ops postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Postmortem Drafting

## Purpose
Design and execute live event ops workflows using postmortem drafting controls with validated outcomes.
