---
name: onboarding-journeys-queue-balancer
description: Use when tasks require onboarding journeys queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Queue Balancer

## Purpose
Design and execute onboarding journeys workflows using queue balancer controls with validated outcomes.
