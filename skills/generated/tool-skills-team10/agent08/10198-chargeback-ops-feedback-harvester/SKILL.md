---
name: chargeback-ops-feedback-harvester
description: Use when tasks require chargeback ops feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Feedback Harvester

## Purpose
Design and execute chargeback ops workflows using feedback harvester controls with validated outcomes.
