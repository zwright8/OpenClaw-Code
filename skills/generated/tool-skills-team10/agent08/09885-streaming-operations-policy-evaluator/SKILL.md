---
name: streaming-operations-policy-evaluator
description: Use when tasks require streaming operations policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Policy Evaluator

## Purpose
Design and execute streaming operations workflows using policy evaluator controls with validated outcomes.
