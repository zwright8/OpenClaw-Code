---
name: audience-analytics-workflow-compiler
description: Use when tasks require audience analytics workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Workflow Compiler

## Purpose
Design and execute audience analytics workflows using workflow compiler controls with validated outcomes.
