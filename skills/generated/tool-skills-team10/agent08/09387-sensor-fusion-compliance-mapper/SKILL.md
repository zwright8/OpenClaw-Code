---
name: sensor-fusion-compliance-mapper
description: Use when tasks require sensor fusion compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Compliance Mapper

## Purpose
Design and execute sensor fusion workflows using compliance mapper controls with validated outcomes.
