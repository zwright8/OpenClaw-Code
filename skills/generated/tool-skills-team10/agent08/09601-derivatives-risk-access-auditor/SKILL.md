---
name: derivatives-risk-access-auditor
description: Use when tasks require derivatives risk access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Access Auditor

## Purpose
Design and execute derivatives risk workflows using access auditor controls with validated outcomes.
