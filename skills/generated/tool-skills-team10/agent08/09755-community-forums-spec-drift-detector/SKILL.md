---
name: community-forums-spec-drift-detector
description: Use when tasks require community forums spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Community Forums Spec Drift Detector

## Purpose
Design and execute community forums workflows using spec drift detector controls with validated outcomes.
