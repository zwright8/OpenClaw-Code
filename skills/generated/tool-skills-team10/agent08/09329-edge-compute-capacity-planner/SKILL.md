---
name: edge-compute-capacity-planner
description: Use when tasks require edge compute capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Capacity Planner

## Purpose
Design and execute edge compute workflows using capacity planner controls with validated outcomes.
