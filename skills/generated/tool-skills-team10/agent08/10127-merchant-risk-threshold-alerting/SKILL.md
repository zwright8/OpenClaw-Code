---
name: merchant-risk-threshold-alerting
description: Use when tasks require merchant risk threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Threshold Alerting

## Purpose
Design and execute merchant risk workflows using threshold alerting controls with validated outcomes.
