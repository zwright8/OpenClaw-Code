---
name: identity-verification-budget-guardrail
description: Use when tasks require identity verification budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Budget Guardrail

## Purpose
Design and execute identity verification workflows using budget guardrail controls with validated outcomes.
