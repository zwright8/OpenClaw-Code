---
name: live-event-ops-policy-evaluator
description: Use when tasks require live event ops policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Policy Evaluator

## Purpose
Design and execute live event ops workflows using policy evaluator controls with validated outcomes.
