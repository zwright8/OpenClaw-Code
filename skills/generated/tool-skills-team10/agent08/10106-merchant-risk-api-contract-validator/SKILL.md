---
name: merchant-risk-api-contract-validator
description: Use when tasks require merchant risk api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk API Contract Validator

## Purpose
Design and execute merchant risk workflows using api contract validator controls with validated outcomes.
...
- Domain: [Merchant Risk](../../resources/domains/merchant-risk.md)
