---
name: portfolio-analytics-permission-mapper
description: Use when tasks require portfolio analytics permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Permission Mapper

## Purpose
Design and execute portfolio analytics workflows using permission mapper controls with validated outcomes.
