---
name: derivatives-risk-approval-orchestrator
description: Use when tasks require derivatives risk approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Approval Orchestrator

## Purpose
Design and execute derivatives risk workflows using approval orchestrator controls with validated outcomes.
