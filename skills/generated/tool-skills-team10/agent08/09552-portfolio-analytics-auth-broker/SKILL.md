---
name: portfolio-analytics-auth-broker
description: Use when tasks require portfolio analytics auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Auth Broker

## Purpose
Design and execute portfolio analytics workflows using auth broker controls with validated outcomes.
