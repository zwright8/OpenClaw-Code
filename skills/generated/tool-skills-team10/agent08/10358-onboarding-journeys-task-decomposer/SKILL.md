---
name: onboarding-journeys-task-decomposer
description: Use when tasks require onboarding journeys task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Task Decomposer

## Purpose
Design and execute onboarding journeys workflows using task decomposer controls with validated outcomes.
