---
name: audience-analytics-provenance-tracker
description: Use when tasks require audience analytics provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Provenance Tracker

## Purpose
Design and execute audience analytics workflows using provenance tracker controls with validated outcomes.
