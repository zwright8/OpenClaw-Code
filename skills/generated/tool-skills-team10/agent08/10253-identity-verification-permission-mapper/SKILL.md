---
name: identity-verification-permission-mapper
description: Use when tasks require identity verification permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Permission Mapper

## Purpose
Design and execute identity verification workflows using permission mapper controls with validated outcomes.
