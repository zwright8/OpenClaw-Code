---
name: onboarding-journeys-human-handoff-router
description: Use when tasks require onboarding journeys human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Human Handoff Router

## Purpose
Design and execute onboarding journeys workflows using human handoff router controls with validated outcomes.
