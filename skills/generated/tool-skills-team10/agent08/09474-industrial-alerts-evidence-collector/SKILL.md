---
name: industrial-alerts-evidence-collector
description: Use when tasks require industrial alerts evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Industrial Alerts Evidence Collector

## Purpose
Design and execute industrial alerts workflows using evidence collector controls with validated outcomes.
