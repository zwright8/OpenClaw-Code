---
name: streaming-operations-evidence-collector
description: Use when tasks require streaming operations evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Evidence Collector

## Purpose
Design and execute streaming operations workflows using evidence collector controls with validated outcomes.
