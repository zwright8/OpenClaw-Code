---
name: execution-monitoring-root-cause-miner
description: Use when tasks require execution monitoring root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Execution Monitoring Root Cause Miner

## Purpose
Design and execute execution monitoring workflows using root cause miner controls with validated outcomes.
