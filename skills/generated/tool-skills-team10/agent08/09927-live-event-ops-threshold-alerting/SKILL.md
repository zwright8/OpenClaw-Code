---
name: live-event-ops-threshold-alerting
description: Use when tasks require live event ops threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Threshold Alerting

## Purpose
Design and execute live event ops workflows using threshold alerting controls with validated outcomes.
