---
name: identity-verification-cost-attribution
description: Use when tasks require identity verification cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Cost Attribution

## Purpose
Design and execute identity verification workflows using cost attribution controls with validated outcomes.
