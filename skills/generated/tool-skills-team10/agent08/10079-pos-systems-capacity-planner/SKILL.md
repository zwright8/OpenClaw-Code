---
name: pos-systems-capacity-planner
description: Use when tasks require pos systems capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Capacity Planner

## Purpose
Design and execute pos systems workflows using capacity planner controls with validated outcomes.
