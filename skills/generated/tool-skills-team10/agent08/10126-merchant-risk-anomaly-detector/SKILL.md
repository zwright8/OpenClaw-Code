---
name: merchant-risk-anomaly-detector
description: Use when tasks require merchant risk anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Anomaly Detector

## Purpose
Design and execute merchant risk workflows using anomaly detector controls with validated outcomes.
