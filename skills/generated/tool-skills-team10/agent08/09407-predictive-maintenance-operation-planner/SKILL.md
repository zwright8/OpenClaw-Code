---
name: predictive-maintenance-operation-planner
description: Use when tasks require predictive maintenance operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Predictive Maintenance Operation Planner

## Purpose
Design and execute predictive maintenance workflows using operation planner controls with validated outcomes.
