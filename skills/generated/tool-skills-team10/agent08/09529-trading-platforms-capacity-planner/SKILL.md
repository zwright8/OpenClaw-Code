---
name: trading-platforms-capacity-planner
description: Use when tasks require trading platforms capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Capacity Planner

## Purpose
Design and execute trading platforms workflows using capacity planner controls with validated outcomes.
