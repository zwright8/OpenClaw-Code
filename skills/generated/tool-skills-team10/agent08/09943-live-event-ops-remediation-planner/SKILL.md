---
name: live-event-ops-remediation-planner
description: Use when tasks require live event ops remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Remediation Planner

## Purpose
Design and execute live event ops workflows using remediation planner controls with validated outcomes.
