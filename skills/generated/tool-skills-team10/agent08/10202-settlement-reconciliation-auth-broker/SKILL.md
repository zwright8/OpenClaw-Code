---
name: settlement-reconciliation-auth-broker
description: Use when tasks require settlement reconciliation auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Settlement Reconciliation Auth Broker

## Purpose
Design and execute settlement reconciliation workflows using auth broker controls with validated outcomes.
