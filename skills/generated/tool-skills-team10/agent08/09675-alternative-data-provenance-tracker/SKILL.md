---
name: alternative-data-provenance-tracker
description: Use when tasks require alternative data provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Alternative Data Provenance Tracker

## Purpose
Design and execute alternative data workflows using provenance tracker controls with validated outcomes.
