---
name: trading-platforms-secret-scanner
description: Use when tasks require trading platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Secret Scanner

## Purpose
Design and execute trading platforms workflows using secret scanner controls with validated outcomes.
