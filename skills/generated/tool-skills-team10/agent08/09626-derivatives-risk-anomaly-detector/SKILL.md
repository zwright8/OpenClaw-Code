---
name: derivatives-risk-anomaly-detector
description: Use when tasks require derivatives risk anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Anomaly Detector

## Purpose
Design and execute derivatives risk workflows using anomaly detector controls with validated outcomes.
