---
name: identity-verification-version-tracker
description: Use when tasks require identity verification version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Version Tracker

## Purpose
Design and execute identity verification workflows using version tracker controls with validated outcomes.
