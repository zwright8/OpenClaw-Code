---
name: derivatives-risk-runbook-composer
description: Use when tasks require derivatives risk runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Runbook Composer

## Purpose
Design and execute derivatives risk workflows using runbook composer controls with validated outcomes.
