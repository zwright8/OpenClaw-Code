---
name: derivatives-risk-compliance-mapper
description: Use when tasks require derivatives risk compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Compliance Mapper

## Purpose
Design and execute derivatives risk workflows using compliance mapper controls with validated outcomes.
