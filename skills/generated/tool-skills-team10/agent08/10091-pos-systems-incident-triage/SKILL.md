---
name: pos-systems-incident-triage
description: Use when tasks require pos systems incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Incident Triage

## Purpose
Design and execute pos systems workflows using incident triage controls with validated outcomes.
