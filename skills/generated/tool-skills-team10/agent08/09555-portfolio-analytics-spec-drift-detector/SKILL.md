---
name: portfolio-analytics-spec-drift-detector
description: Use when tasks require portfolio analytics spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Spec Drift Detector

## Purpose
Design and execute portfolio analytics workflows using spec drift detector controls with validated outcomes.
