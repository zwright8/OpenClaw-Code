---
name: edge-compute-budget-guardrail
description: Use when tasks require edge compute budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Budget Guardrail

## Purpose
Design and execute edge compute workflows using budget guardrail controls with validated outcomes.
