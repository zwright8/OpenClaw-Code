---
name: settlement-reconciliation-feedback-harvester
description: Use when tasks require settlement reconciliation feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Settlement Reconciliation Feedback Harvester

## Purpose
Design and execute settlement reconciliation workflows using feedback harvester controls with validated outcomes.
