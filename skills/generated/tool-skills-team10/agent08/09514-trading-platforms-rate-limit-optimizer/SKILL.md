---
name: trading-platforms-rate-limit-optimizer
description: Use when tasks require trading platforms rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Rate Limit Optimizer

## Purpose
Design and execute trading platforms workflows using rate limit optimizer controls with validated outcomes.
