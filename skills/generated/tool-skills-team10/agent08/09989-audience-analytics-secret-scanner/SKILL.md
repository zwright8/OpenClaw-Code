---
name: audience-analytics-secret-scanner
description: Use when tasks require audience analytics secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Secret Scanner

## Purpose
Design and execute audience analytics workflows using secret scanner controls with validated outcomes.
