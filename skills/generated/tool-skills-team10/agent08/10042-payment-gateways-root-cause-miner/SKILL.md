---
name: payment-gateways-root-cause-miner
description: Use when tasks require payment gateways root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Root Cause Miner

## Purpose
Design and execute payment gateways workflows using root cause miner controls with validated outcomes.
