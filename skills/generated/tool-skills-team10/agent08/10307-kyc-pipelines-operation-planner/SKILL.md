---
name: kyc-pipelines-operation-planner
description: Use when tasks require kyc pipelines operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Operation Planner

## Purpose
Design and execute kyc pipelines workflows using operation planner controls with validated outcomes.
