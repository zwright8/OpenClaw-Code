---
name: terminology-mgmt-risk-scorer
description: Use when tasks require terminology mgmt risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Risk Scorer

## Purpose
Design and execute terminology mgmt workflows using risk scorer controls with validated outcomes.
