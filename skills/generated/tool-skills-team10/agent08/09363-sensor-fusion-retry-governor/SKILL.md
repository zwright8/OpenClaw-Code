---
name: sensor-fusion-retry-governor
description: Use when tasks require sensor fusion retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Retry Governor

## Purpose
Design and execute sensor fusion workflows using retry governor controls with validated outcomes.
