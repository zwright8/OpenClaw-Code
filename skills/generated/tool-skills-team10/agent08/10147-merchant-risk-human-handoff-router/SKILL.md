---
name: merchant-risk-human-handoff-router
description: Use when tasks require merchant risk human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Human Handoff Router

## Purpose
Design and execute merchant risk workflows using human handoff router controls with validated outcomes.
