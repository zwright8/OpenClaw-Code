---
name: kyc-pipelines-schema-introspector
description: Use when tasks require kyc pipelines schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Schema Introspector

## Purpose
Design and execute kyc pipelines workflows using schema introspector controls with validated outcomes.
