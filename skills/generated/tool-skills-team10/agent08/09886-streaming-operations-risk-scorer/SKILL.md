---
name: streaming-operations-risk-scorer
description: Use when tasks require streaming operations risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Streaming Operations Risk Scorer

## Purpose
Design and execute streaming operations workflows using risk scorer controls with validated outcomes.
