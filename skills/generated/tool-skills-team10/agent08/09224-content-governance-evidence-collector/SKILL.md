---
name: content-governance-evidence-collector
description: Use when tasks require content governance evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Evidence Collector

## Purpose
Design and execute content governance workflows using evidence collector controls with validated outcomes.
