---
name: derivatives-risk-pii-redactor
description: Use when tasks require derivatives risk pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk PII Redactor

## Purpose
Design and execute derivatives risk workflows using pii redactor controls with validated outcomes.
