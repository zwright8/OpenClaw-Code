---
name: onboarding-journeys-remediation-planner
description: Use when tasks require onboarding journeys remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Remediation Planner

## Purpose
Design and execute onboarding journeys workflows using remediation planner controls with validated outcomes.
