---
name: chargeback-ops-auth-broker
description: Use when tasks require chargeback ops auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Auth Broker

## Purpose
Design and execute chargeback ops workflows using auth broker controls with validated outcomes.
