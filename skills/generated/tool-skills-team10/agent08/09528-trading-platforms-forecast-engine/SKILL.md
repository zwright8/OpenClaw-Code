---
name: trading-platforms-forecast-engine
description: Use when tasks require trading platforms forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Forecast Engine

## Purpose
Design and execute trading platforms workflows using forecast engine controls with validated outcomes.
