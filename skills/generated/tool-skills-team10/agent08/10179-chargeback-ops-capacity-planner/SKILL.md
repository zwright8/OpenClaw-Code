---
name: chargeback-ops-capacity-planner
description: Use when tasks require chargeback ops capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Capacity Planner

## Purpose
Design and execute chargeback ops workflows using capacity planner controls with validated outcomes.
