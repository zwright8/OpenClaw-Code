---
name: kyc-pipelines-remediation-planner
description: Use when tasks require kyc pipelines remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Remediation Planner

## Purpose
Design and execute kyc pipelines workflows using remediation planner controls with validated outcomes.
