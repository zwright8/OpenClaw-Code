---
name: chargeback-ops-rollback-coordinator
description: Use when tasks require chargeback ops rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Rollback Coordinator

## Purpose
Design and execute chargeback ops workflows using rollback coordinator controls with validated outcomes.
