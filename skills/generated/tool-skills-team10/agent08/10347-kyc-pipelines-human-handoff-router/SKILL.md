---
name: kyc-pipelines-human-handoff-router
description: Use when tasks require kyc pipelines human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Human Handoff Router

## Purpose
Design and execute kyc pipelines workflows using human handoff router controls with validated outcomes.
