---
name: chargeback-ops-conflict-resolver
description: Use when tasks require chargeback ops conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Conflict Resolver

## Purpose
Design and execute chargeback ops workflows using conflict resolver controls with validated outcomes.
