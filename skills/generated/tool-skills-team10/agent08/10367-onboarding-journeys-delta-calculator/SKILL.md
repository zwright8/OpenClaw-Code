---
name: onboarding-journeys-delta-calculator
description: Use when tasks require onboarding journeys delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Delta Calculator

## Purpose
Design and execute onboarding journeys workflows using delta calculator controls with validated outcomes.
