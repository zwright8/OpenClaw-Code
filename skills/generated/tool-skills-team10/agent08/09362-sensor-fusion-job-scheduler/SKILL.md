---
name: sensor-fusion-job-scheduler
description: Use when tasks require sensor fusion job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Job Scheduler

## Purpose
Design and execute sensor fusion workflows using job scheduler controls with validated outcomes.
