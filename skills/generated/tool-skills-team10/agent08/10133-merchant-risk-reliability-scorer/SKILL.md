---
name: merchant-risk-reliability-scorer
description: Use when tasks require merchant risk reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Reliability Scorer

## Purpose
Design and execute merchant risk workflows using reliability scorer controls with validated outcomes.
