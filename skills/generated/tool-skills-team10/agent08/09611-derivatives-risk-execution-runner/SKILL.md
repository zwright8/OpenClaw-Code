---
name: derivatives-risk-execution-runner
description: Use when tasks require derivatives risk execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Execution Runner

## Purpose
Design and execute derivatives risk workflows using execution runner controls with validated outcomes.
