---
name: terminology-mgmt-root-cause-miner
description: Use when tasks require terminology mgmt root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Root Cause Miner

## Purpose
Design and execute terminology mgmt workflows using root cause miner controls with validated outcomes.
