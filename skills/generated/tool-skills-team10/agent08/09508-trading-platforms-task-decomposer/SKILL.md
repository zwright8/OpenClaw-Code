---
name: trading-platforms-task-decomposer
description: Use when tasks require trading platforms task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Task Decomposer

## Purpose
Design and execute trading platforms workflows using task decomposer controls with validated outcomes.
