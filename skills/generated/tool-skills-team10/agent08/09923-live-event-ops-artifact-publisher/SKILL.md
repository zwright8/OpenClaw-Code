---
name: live-event-ops-artifact-publisher
description: Use when tasks require live event ops artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Artifact Publisher

## Purpose
Design and execute live event ops workflows using artifact publisher controls with validated outcomes.
