---
name: identity-verification-conflict-resolver
description: Use when tasks require identity verification conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Conflict Resolver

## Purpose
Design and execute identity verification workflows using conflict resolver controls with validated outcomes.
