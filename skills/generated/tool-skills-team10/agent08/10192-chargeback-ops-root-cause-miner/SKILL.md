---
name: chargeback-ops-root-cause-miner
description: Use when tasks require chargeback ops root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Root Cause Miner

## Purpose
Design and execute chargeback ops workflows using root cause miner controls with validated outcomes.
