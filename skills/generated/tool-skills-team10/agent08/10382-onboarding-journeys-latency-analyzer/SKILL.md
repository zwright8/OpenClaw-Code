---
name: onboarding-journeys-latency-analyzer
description: Use when tasks require onboarding journeys latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Onboarding Journeys Latency Analyzer

## Purpose
Design and execute onboarding journeys workflows using latency analyzer controls with validated outcomes.
