---
name: kyc-pipelines-task-decomposer
description: Use when tasks require kyc pipelines task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Task Decomposer

## Purpose
Design and execute kyc pipelines workflows using task decomposer controls with validated outcomes.
