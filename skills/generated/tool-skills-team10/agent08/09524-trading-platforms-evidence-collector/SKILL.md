---
name: trading-platforms-evidence-collector
description: Use when tasks require trading platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Evidence Collector

## Purpose
Design and execute trading platforms workflows using evidence collector controls with validated outcomes.
