---
name: accessibility-auditing-runbook-composer
description: Use when tasks require accessibility auditing runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accessibility Auditing Runbook Composer

## Purpose
Design and execute accessibility auditing workflows using runbook composer controls with validated outcomes.
