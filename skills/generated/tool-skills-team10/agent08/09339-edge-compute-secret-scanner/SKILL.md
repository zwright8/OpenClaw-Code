---
name: edge-compute-secret-scanner
description: Use when tasks require edge compute secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Edge Compute Secret Scanner

## Purpose
Design and execute edge compute workflows using secret scanner controls with validated outcomes.
