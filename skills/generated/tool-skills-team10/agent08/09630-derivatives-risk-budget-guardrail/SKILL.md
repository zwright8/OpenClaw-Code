---
name: derivatives-risk-budget-guardrail
description: Use when tasks require derivatives risk budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Budget Guardrail

## Purpose
Design and execute derivatives risk workflows using budget guardrail controls with validated outcomes.
