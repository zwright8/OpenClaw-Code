---
name: sensor-fusion-rate-limit-optimizer
description: Use when tasks require sensor fusion rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Rate Limit Optimizer

## Purpose
Design and execute sensor fusion workflows using rate limit optimizer controls with validated outcomes.
