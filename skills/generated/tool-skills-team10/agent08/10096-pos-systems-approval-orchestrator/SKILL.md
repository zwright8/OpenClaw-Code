---
name: pos-systems-approval-orchestrator
description: Use when tasks require pos systems approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# POS Systems Approval Orchestrator

## Purpose
Design and execute pos systems workflows using approval orchestrator controls with validated outcomes.
