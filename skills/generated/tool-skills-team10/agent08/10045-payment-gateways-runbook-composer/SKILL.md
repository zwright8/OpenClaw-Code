---
name: payment-gateways-runbook-composer
description: Use when tasks require payment gateways runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payment Gateways Runbook Composer

## Purpose
Design and execute payment gateways workflows using runbook composer controls with validated outcomes.
