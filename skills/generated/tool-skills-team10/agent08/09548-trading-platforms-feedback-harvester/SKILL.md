---
name: trading-platforms-feedback-harvester
description: Use when tasks require trading platforms feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Feedback Harvester

## Purpose
Design and execute trading platforms workflows using feedback harvester controls with validated outcomes.
