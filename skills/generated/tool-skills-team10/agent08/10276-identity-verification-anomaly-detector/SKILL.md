---
name: identity-verification-anomaly-detector
description: Use when tasks require identity verification anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Anomaly Detector

## Purpose
Design and execute identity verification workflows using anomaly detector controls with validated outcomes.
