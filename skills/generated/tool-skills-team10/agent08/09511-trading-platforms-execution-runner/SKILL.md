---
name: trading-platforms-execution-runner
description: Use when tasks require trading platforms execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Trading Platforms Execution Runner

## Purpose
Design and execute trading platforms workflows using execution runner controls with validated outcomes.
