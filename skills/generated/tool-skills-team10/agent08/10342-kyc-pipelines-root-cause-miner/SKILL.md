---
name: kyc-pipelines-root-cause-miner
description: Use when tasks require kyc pipelines root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# KYC Pipelines Root Cause Miner

## Purpose
Design and execute kyc pipelines workflows using root cause miner controls with validated outcomes.
