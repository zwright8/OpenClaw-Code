---
name: sensor-fusion-operation-planner
description: Use when tasks require sensor fusion operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Sensor Fusion Operation Planner

## Purpose
Design and execute sensor fusion workflows using operation planner controls with validated outcomes.
