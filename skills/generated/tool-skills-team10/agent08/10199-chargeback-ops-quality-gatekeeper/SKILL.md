---
name: chargeback-ops-quality-gatekeeper
description: Use when tasks require chargeback ops quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Chargeback Ops Quality Gatekeeper

## Purpose
Design and execute chargeback ops workflows using quality gatekeeper controls with validated outcomes.
