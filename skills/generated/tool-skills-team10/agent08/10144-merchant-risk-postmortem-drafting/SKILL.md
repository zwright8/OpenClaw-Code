---
name: merchant-risk-postmortem-drafting
description: Use when tasks require merchant risk postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Postmortem Drafting

## Purpose
Design and execute merchant risk workflows using postmortem drafting controls with validated outcomes.
