---
name: portfolio-analytics-task-decomposer
description: Use when tasks require portfolio analytics task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Portfolio Analytics Task Decomposer

## Purpose
Design and execute portfolio analytics workflows using task decomposer controls with validated outcomes.
