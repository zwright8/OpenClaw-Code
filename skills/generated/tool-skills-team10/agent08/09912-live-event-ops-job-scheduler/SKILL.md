---
name: live-event-ops-job-scheduler
description: Use when tasks require live event ops job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Job Scheduler

## Purpose
Design and execute live event ops workflows using job scheduler controls with validated outcomes.
