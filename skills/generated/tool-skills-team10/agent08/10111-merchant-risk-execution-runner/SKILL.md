---
name: merchant-risk-execution-runner
description: Use when tasks require merchant risk execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Execution Runner

## Purpose
Design and execute merchant risk workflows using execution runner controls with validated outcomes.
