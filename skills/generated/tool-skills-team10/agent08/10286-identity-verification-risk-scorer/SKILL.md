---
name: identity-verification-risk-scorer
description: Use when tasks require identity verification risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Risk Scorer

## Purpose
Design and execute identity verification workflows using risk scorer controls with validated outcomes.
