---
name: merchant-risk-task-decomposer
description: Use when tasks require merchant risk task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Task Decomposer

## Purpose
Design and execute merchant risk workflows using task decomposer controls with validated outcomes.
