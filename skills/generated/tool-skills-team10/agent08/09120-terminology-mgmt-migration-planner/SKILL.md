---
name: terminology-mgmt-migration-planner
description: Use when tasks require terminology mgmt migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Terminology Mgmt Migration Planner

## Purpose
Design and execute terminology mgmt workflows using migration planner controls with validated outcomes.
