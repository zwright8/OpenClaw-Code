---
name: live-event-ops-workflow-compiler
description: Use when tasks require live event ops workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Live Event Ops Workflow Compiler

## Purpose
Design and execute live event ops workflows using workflow compiler controls with validated outcomes.
