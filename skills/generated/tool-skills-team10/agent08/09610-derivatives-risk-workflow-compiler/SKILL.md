---
name: derivatives-risk-workflow-compiler
description: Use when tasks require derivatives risk workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Derivatives Risk Workflow Compiler

## Purpose
Design and execute derivatives risk workflows using workflow compiler controls with validated outcomes.
