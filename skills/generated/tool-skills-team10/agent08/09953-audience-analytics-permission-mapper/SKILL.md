---
name: audience-analytics-permission-mapper
description: Use when tasks require audience analytics permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audience Analytics Permission Mapper

## Purpose
Design and execute audience analytics workflows using permission mapper controls with validated outcomes.
