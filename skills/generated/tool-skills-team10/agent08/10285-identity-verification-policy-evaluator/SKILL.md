---
name: identity-verification-policy-evaluator
description: Use when tasks require identity verification policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Policy Evaluator

## Purpose
Design and execute identity verification workflows using policy evaluator controls with validated outcomes.
