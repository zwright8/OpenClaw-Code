---
name: predictive-maintenance-incident-triage
description: Use when tasks require predictive maintenance incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Predictive Maintenance Incident Triage

## Purpose
Design and execute predictive maintenance workflows using incident triage controls with validated outcomes.
