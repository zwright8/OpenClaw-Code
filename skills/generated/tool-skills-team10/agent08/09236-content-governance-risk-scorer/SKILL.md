---
name: content-governance-risk-scorer
description: Use when tasks require content governance risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Content Governance Risk Scorer

## Purpose
Design and execute content governance workflows using risk scorer controls with validated outcomes.
