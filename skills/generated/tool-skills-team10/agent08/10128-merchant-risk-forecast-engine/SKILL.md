---
name: merchant-risk-forecast-engine
description: Use when tasks require merchant risk forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Merchant Risk Forecast Engine

## Purpose
Design and execute merchant risk workflows using forecast engine controls with validated outcomes.
