---
name: identity-verification-access-auditor
description: Use when tasks require identity verification access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Identity Verification Access Auditor

## Purpose
Design and execute identity verification workflows using access auditor controls with validated outcomes.
