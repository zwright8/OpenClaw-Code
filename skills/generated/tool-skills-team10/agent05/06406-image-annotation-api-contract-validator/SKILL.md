---
name: image-annotation-api-contract-validator
description: Use when tasks require image annotation api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation API Contract Validator

## Purpose
Design and execute image annotation workflows using api contract validator controls with validated outcomes.
...
- Domain: [Image Annotation](../../resources/domains/image-annotation.md)
