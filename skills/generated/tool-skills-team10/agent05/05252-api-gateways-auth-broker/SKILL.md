---
name: api-gateways-auth-broker
description: Use when tasks require api gateways auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Auth Broker

## Purpose
Design and execute api gateways workflows using auth broker controls with validated outcomes.
