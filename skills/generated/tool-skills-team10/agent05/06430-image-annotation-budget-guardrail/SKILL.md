---
name: image-annotation-budget-guardrail
description: Use when tasks require image annotation budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Budget Guardrail

## Purpose
Design and execute image annotation workflows using budget guardrail controls with validated outcomes.
