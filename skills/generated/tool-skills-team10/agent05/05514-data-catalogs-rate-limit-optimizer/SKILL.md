---
name: data-catalogs-rate-limit-optimizer
description: Use when tasks require data catalogs rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Rate Limit Optimizer

## Purpose
Design and execute data catalogs workflows using rate limit optimizer controls with validated outcomes.
