---
name: data-catalogs-dependency-resolver
description: Use when tasks require data catalogs dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Dependency Resolver

## Purpose
Design and execute data catalogs workflows using dependency resolver controls with validated outcomes.
