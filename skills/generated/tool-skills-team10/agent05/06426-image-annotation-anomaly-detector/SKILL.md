---
name: image-annotation-anomaly-detector
description: Use when tasks require image annotation anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Anomaly Detector

## Purpose
Design and execute image annotation workflows using anomaly detector controls with validated outcomes.
