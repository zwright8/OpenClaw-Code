---
name: media-asset-management-evidence-collector
description: Use when tasks require media asset management evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Evidence Collector

## Purpose
Design and execute media asset management workflows using evidence collector controls with validated outcomes.
