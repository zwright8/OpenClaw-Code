---
name: release-orchestration-execution-runner
description: Use when tasks require release orchestration execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Execution Runner

## Purpose
Design and execute release orchestration workflows using execution runner controls with validated outcomes.
