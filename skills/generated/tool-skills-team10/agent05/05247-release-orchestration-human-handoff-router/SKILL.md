---
name: release-orchestration-human-handoff-router
description: Use when tasks require release orchestration human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Human Handoff Router

## Purpose
Design and execute release orchestration workflows using human handoff router controls with validated outcomes.
