---
name: records-retention-state-reconciler
description: Use when tasks require records retention state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention State Reconciler

## Purpose
Design and execute records retention workflows using state reconciler controls with validated outcomes.
