---
name: document-ocr-spec-drift-detector
description: Use when tasks require document ocr spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Spec Drift Detector

## Purpose
Design and execute document ocr workflows using spec drift detector controls with validated outcomes.
