---
name: audio-pipelines-migration-planner
description: Use when tasks require audio pipelines migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audio Pipelines Migration Planner

## Purpose
Design and execute audio pipelines workflows using migration planner controls with validated outcomes.
