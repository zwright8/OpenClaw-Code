---
name: etl-orchestrators-root-cause-miner
description: Use when tasks require etl orchestrators root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ETL Orchestrators Root Cause Miner

## Purpose
Design and execute etl orchestrators workflows using root cause miner controls with validated outcomes.
