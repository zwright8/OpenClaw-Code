---
name: agent-registries-artifact-publisher
description: Use when tasks require agent registries artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Artifact Publisher

## Purpose
Design and execute agent registries workflows using artifact publisher controls with validated outcomes.
