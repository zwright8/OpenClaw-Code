---
name: video-processing-pii-redactor
description: Use when tasks require video processing pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing PII Redactor

## Purpose
Design and execute video processing workflows using pii redactor controls with validated outcomes.
