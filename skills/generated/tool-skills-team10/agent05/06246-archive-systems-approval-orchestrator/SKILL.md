---
name: archive-systems-approval-orchestrator
description: Use when tasks require archive systems approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Archive Systems Approval Orchestrator

## Purpose
Design and execute archive systems workflows using approval orchestrator controls with validated outcomes.
