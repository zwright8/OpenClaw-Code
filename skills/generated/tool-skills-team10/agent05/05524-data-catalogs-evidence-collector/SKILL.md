---
name: data-catalogs-evidence-collector
description: Use when tasks require data catalogs evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Evidence Collector

## Purpose
Design and execute data catalogs workflows using evidence collector controls with validated outcomes.
