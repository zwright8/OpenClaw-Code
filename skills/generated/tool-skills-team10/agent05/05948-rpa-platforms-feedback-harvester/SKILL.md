---
name: rpa-platforms-feedback-harvester
description: Use when tasks require rpa platforms feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Feedback Harvester

## Purpose
Design and execute rpa platforms workflows using feedback harvester controls with validated outcomes.
