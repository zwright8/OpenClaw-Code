---
name: release-orchestration-dependency-resolver
description: Use when tasks require release orchestration dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Dependency Resolver

## Purpose
Design and execute release orchestration workflows using dependency resolver controls with validated outcomes.
