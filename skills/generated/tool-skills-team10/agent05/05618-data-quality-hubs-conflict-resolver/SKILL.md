---
name: data-quality-hubs-conflict-resolver
description: Use when tasks require data quality hubs conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Quality Hubs Conflict Resolver

## Purpose
Design and execute data quality hubs workflows using conflict resolver controls with validated outcomes.
