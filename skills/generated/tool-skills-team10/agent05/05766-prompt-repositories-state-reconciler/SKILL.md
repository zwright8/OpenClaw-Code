---
name: prompt-repositories-state-reconciler
description: Use when tasks require prompt repositories state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories State Reconciler

## Purpose
Design and execute prompt repositories workflows using state reconciler controls with validated outcomes.
