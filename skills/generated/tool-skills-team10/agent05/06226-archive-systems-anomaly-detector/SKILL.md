---
name: archive-systems-anomaly-detector
description: Use when tasks require archive systems anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Archive Systems Anomaly Detector

## Purpose
Design and execute archive systems workflows using anomaly detector controls with validated outcomes.
