---
name: image-annotation-feedback-harvester
description: Use when tasks require image annotation feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Feedback Harvester

## Purpose
Design and execute image annotation workflows using feedback harvester controls with validated outcomes.
