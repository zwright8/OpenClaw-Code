---
name: message-brokers-artifact-publisher
description: Use when tasks require message brokers artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Artifact Publisher

## Purpose
Design and execute message brokers workflows using artifact publisher controls with validated outcomes.
