---
name: prompt-repositories-dependency-resolver
description: Use when tasks require prompt repositories dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Dependency Resolver

## Purpose
Design and execute prompt repositories workflows using dependency resolver controls with validated outcomes.
