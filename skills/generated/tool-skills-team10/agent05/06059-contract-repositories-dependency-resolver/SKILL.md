---
name: contract-repositories-dependency-resolver
description: Use when tasks require contract repositories dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Dependency Resolver

## Purpose
Design and execute contract repositories workflows using dependency resolver controls with validated outcomes.
