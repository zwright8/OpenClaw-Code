---
name: document-ocr-compliance-mapper
description: Use when tasks require document ocr compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Compliance Mapper

## Purpose
Design and execute document ocr workflows using compliance mapper controls with validated outcomes.
