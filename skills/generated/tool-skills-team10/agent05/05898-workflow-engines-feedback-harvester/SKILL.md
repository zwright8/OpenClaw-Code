---
name: workflow-engines-feedback-harvester
description: Use when tasks require workflow engines feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Feedback Harvester

## Purpose
Design and execute workflow engines workflows using feedback harvester controls with validated outcomes.
