---
name: workflow-engines-artifact-publisher
description: Use when tasks require workflow engines artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Artifact Publisher

## Purpose
Design and execute workflow engines workflows using artifact publisher controls with validated outcomes.
