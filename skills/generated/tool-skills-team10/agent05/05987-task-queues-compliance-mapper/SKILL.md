---
name: task-queues-compliance-mapper
description: Use when tasks require task queues compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Compliance Mapper

## Purpose
Design and execute task queues workflows using compliance mapper controls with validated outcomes.
