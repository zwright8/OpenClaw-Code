---
name: image-annotation-cost-attribution
description: Use when tasks require image annotation cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Cost Attribution

## Purpose
Design and execute image annotation workflows using cost attribution controls with validated outcomes.
