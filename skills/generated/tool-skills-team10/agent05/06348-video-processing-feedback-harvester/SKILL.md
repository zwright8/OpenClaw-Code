---
name: video-processing-feedback-harvester
description: Use when tasks require video processing feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Feedback Harvester

## Purpose
Design and execute video processing workflows using feedback harvester controls with validated outcomes.
