---
name: records-retention-permission-mapper
description: Use when tasks require records retention permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Permission Mapper

## Purpose
Design and execute records retention workflows using permission mapper controls with validated outcomes.
