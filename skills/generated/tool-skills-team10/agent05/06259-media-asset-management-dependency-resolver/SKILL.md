---
name: media-asset-management-dependency-resolver
description: Use when tasks require media asset management dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Dependency Resolver

## Purpose
Design and execute media asset management workflows using dependency resolver controls with validated outcomes.
