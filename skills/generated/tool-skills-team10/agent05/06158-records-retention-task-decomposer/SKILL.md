---
name: records-retention-task-decomposer
description: Use when tasks require records retention task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Task Decomposer

## Purpose
Design and execute records retention workflows using task decomposer controls with validated outcomes.
