---
name: media-asset-management-runbook-composer
description: Use when tasks require media asset management runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Runbook Composer

## Purpose
Design and execute media asset management workflows using runbook composer controls with validated outcomes.
