---
name: records-retention-secret-scanner
description: Use when tasks require records retention secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Secret Scanner

## Purpose
Design and execute records retention workflows using secret scanner controls with validated outcomes.
