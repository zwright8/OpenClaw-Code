---
name: image-annotation-job-scheduler
description: Use when tasks require image annotation job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Job Scheduler

## Purpose
Design and execute image annotation workflows using job scheduler controls with validated outcomes.
