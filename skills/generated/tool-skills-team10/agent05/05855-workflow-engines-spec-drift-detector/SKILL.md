---
name: workflow-engines-spec-drift-detector
description: Use when tasks require workflow engines spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Spec Drift Detector

## Purpose
Design and execute workflow engines workflows using spec drift detector controls with validated outcomes.
