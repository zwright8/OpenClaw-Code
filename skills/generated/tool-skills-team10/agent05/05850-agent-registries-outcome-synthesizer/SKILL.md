---
name: agent-registries-outcome-synthesizer
description: Use when tasks require agent registries outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Outcome Synthesizer

## Purpose
Design and execute agent registries workflows using outcome synthesizer controls with validated outcomes.
