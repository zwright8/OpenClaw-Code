---
name: metadata-stores-permission-mapper
description: Use when tasks require metadata stores permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Permission Mapper

## Purpose
Design and execute metadata stores workflows using permission mapper controls with validated outcomes.
