---
name: archive-systems-permission-mapper
description: Use when tasks require archive systems permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Archive Systems Permission Mapper

## Purpose
Design and execute archive systems workflows using permission mapper controls with validated outcomes.
