---
name: prompt-repositories-anomaly-detector
description: Use when tasks require prompt repositories anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Anomaly Detector

## Purpose
Design and execute prompt repositories workflows using anomaly detector controls with validated outcomes.
