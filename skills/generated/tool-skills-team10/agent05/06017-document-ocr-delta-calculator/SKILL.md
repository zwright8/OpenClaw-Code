---
name: document-ocr-delta-calculator
description: Use when tasks require document ocr delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Delta Calculator

## Purpose
Design and execute document ocr workflows using delta calculator controls with validated outcomes.
