---
name: contract-repositories-workflow-compiler
description: Use when tasks require contract repositories workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Workflow Compiler

## Purpose
Design and execute contract repositories workflows using workflow compiler controls with validated outcomes.
