---
name: 3d-asset-pipelines-pii-redactor
description: Use when tasks require 3d asset pipelines pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines PII Redactor

## Purpose
Design and execute 3d asset pipelines workflows using pii redactor controls with validated outcomes.
