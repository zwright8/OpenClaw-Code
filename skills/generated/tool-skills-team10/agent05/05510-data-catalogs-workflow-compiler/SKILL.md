---
name: data-catalogs-workflow-compiler
description: Use when tasks require data catalogs workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Workflow Compiler

## Purpose
Design and execute data catalogs workflows using workflow compiler controls with validated outcomes.
