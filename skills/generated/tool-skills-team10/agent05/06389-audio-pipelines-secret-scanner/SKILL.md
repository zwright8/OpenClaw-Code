---
name: audio-pipelines-secret-scanner
description: Use when tasks require audio pipelines secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audio Pipelines Secret Scanner

## Purpose
Design and execute audio pipelines workflows using secret scanner controls with validated outcomes.
