---
name: event-streams-policy-evaluator
description: Use when tasks require event streams policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Policy Evaluator

## Purpose
Design and execute event streams workflows using policy evaluator controls with validated outcomes.
