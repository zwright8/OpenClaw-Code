---
name: document-ocr-operation-planner
description: Use when tasks require document ocr operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Operation Planner

## Purpose
Design and execute document ocr workflows using operation planner controls with validated outcomes.
