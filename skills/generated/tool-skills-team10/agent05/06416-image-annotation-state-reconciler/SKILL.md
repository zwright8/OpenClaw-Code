---
name: image-annotation-state-reconciler
description: Use when tasks require image annotation state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation State Reconciler

## Purpose
Design and execute image annotation workflows using state reconciler controls with validated outcomes.
