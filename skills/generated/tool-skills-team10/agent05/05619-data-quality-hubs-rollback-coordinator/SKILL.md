---
name: data-quality-hubs-rollback-coordinator
description: Use when tasks require data quality hubs rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Quality Hubs Rollback Coordinator

## Purpose
Design and execute data quality hubs workflows using rollback coordinator controls with validated outcomes.
