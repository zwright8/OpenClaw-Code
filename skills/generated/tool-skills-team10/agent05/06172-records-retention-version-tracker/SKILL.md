---
name: records-retention-version-tracker
description: Use when tasks require records retention version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Version Tracker

## Purpose
Design and execute records retention workflows using version tracker controls with validated outcomes.
