---
name: records-retention-postmortem-drafting
description: Use when tasks require records retention postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Postmortem Drafting

## Purpose
Design and execute records retention workflows using postmortem drafting controls with validated outcomes.
