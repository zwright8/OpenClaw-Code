---
name: records-retention-budget-guardrail
description: Use when tasks require records retention budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Budget Guardrail

## Purpose
Design and execute records retention workflows using budget guardrail controls with validated outcomes.
