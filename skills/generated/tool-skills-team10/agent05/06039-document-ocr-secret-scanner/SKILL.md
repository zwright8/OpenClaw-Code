---
name: document-ocr-secret-scanner
description: Use when tasks require document ocr secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Secret Scanner

## Purpose
Design and execute document ocr workflows using secret scanner controls with validated outcomes.
