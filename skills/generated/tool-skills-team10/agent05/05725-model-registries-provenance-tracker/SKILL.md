---
name: model-registries-provenance-tracker
description: Use when tasks require model registries provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Provenance Tracker

## Purpose
Design and execute model registries workflows using provenance tracker controls with validated outcomes.
