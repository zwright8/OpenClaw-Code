---
name: event-streams-quality-gatekeeper
description: Use when tasks require event streams quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Quality Gatekeeper

## Purpose
Design and execute event streams workflows using quality gatekeeper controls with validated outcomes.
