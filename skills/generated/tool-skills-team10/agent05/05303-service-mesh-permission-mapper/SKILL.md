---
name: service-mesh-permission-mapper
description: Use when tasks require service mesh permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Permission Mapper

## Purpose
Design and execute service mesh workflows using permission mapper controls with validated outcomes.
