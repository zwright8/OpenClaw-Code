---
name: agent-registries-conflict-resolver
description: Use when tasks require agent registries conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Conflict Resolver

## Purpose
Design and execute agent registries workflows using conflict resolver controls with validated outcomes.
