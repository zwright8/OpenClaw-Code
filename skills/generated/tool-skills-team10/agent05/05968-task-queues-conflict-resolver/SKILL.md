---
name: task-queues-conflict-resolver
description: Use when tasks require task queues conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Conflict Resolver

## Purpose
Design and execute task queues workflows using conflict resolver controls with validated outcomes.
