---
name: model-registries-pii-redactor
description: Use when tasks require model registries pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries PII Redactor

## Purpose
Design and execute model registries workflows using pii redactor controls with validated outcomes.
