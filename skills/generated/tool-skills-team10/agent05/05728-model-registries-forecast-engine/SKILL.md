---
name: model-registries-forecast-engine
description: Use when tasks require model registries forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Forecast Engine

## Purpose
Design and execute model registries workflows using forecast engine controls with validated outcomes.
