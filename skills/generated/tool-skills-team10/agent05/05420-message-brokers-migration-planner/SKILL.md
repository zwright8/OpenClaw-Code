---
name: message-brokers-migration-planner
description: Use when tasks require message brokers migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Migration Planner

## Purpose
Design and execute message brokers workflows using migration planner controls with validated outcomes.
