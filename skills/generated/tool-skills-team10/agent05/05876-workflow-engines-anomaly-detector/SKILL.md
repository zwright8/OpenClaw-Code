---
name: workflow-engines-anomaly-detector
description: Use when tasks require workflow engines anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Anomaly Detector

## Purpose
Design and execute workflow engines workflows using anomaly detector controls with validated outcomes.
