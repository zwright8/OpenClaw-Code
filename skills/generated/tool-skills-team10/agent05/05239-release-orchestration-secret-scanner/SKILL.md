---
name: release-orchestration-secret-scanner
description: Use when tasks require release orchestration secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Secret Scanner

## Purpose
Design and execute release orchestration workflows using secret scanner controls with validated outcomes.
