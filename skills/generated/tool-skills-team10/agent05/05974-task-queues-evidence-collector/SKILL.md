---
name: task-queues-evidence-collector
description: Use when tasks require task queues evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Evidence Collector

## Purpose
Design and execute task queues workflows using evidence collector controls with validated outcomes.
