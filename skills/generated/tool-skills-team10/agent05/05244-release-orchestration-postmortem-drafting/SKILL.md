---
name: release-orchestration-postmortem-drafting
description: Use when tasks require release orchestration postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Postmortem Drafting

## Purpose
Design and execute release orchestration workflows using postmortem drafting controls with validated outcomes.
