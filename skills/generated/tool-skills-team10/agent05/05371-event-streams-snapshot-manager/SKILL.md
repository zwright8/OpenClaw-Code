---
name: event-streams-snapshot-manager
description: Use when tasks require event streams snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Snapshot Manager

## Purpose
Design and execute event streams workflows using snapshot manager controls with validated outcomes.
