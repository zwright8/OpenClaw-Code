---
name: video-processing-root-cause-miner
description: Use when tasks require video processing root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Root Cause Miner

## Purpose
Design and execute video processing workflows using root cause miner controls with validated outcomes.
