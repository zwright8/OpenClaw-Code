---
name: video-processing-migration-planner
description: Use when tasks require video processing migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Migration Planner

## Purpose
Design and execute video processing workflows using migration planner controls with validated outcomes.
