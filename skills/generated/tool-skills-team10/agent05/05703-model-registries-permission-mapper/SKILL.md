---
name: model-registries-permission-mapper
description: Use when tasks require model registries permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Permission Mapper

## Purpose
Design and execute model registries workflows using permission mapper controls with validated outcomes.
