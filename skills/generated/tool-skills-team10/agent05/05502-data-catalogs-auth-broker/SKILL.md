---
name: data-catalogs-auth-broker
description: Use when tasks require data catalogs auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Auth Broker

## Purpose
Design and execute data catalogs workflows using auth broker controls with validated outcomes.
