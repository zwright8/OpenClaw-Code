---
name: message-brokers-runbook-composer
description: Use when tasks require message brokers runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Runbook Composer

## Purpose
Design and execute message brokers workflows using runbook composer controls with validated outcomes.
