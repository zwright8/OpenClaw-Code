---
name: audio-pipelines-spec-drift-detector
description: Use when tasks require audio pipelines spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audio Pipelines Spec Drift Detector

## Purpose
Design and execute audio pipelines workflows using spec drift detector controls with validated outcomes.
