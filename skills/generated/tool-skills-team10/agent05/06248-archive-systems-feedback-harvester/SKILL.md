---
name: archive-systems-feedback-harvester
description: Use when tasks require archive systems feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Archive Systems Feedback Harvester

## Purpose
Design and execute archive systems workflows using feedback harvester controls with validated outcomes.
