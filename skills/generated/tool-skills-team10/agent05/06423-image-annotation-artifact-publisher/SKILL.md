---
name: image-annotation-artifact-publisher
description: Use when tasks require image annotation artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Artifact Publisher

## Purpose
Design and execute image annotation workflows using artifact publisher controls with validated outcomes.
