---
name: video-processing-incident-triage
description: Use when tasks require video processing incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Incident Triage

## Purpose
Design and execute video processing workflows using incident triage controls with validated outcomes.
