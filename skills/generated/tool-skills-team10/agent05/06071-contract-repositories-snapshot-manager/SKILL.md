---
name: contract-repositories-snapshot-manager
description: Use when tasks require contract repositories snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Snapshot Manager

## Purpose
Design and execute contract repositories workflows using snapshot manager controls with validated outcomes.
