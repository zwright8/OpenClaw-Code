---
name: 3d-asset-pipelines-evidence-collector
description: Use when tasks require 3d asset pipelines evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Evidence Collector

## Purpose
Design and execute 3d asset pipelines workflows using evidence collector controls with validated outcomes.
