---
name: model-registries-evidence-collector
description: Use when tasks require model registries evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Evidence Collector

## Purpose
Design and execute model registries workflows using evidence collector controls with validated outcomes.
