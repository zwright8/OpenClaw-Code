---
name: prompt-repositories-reliability-scorer
description: Use when tasks require prompt repositories reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Reliability Scorer

## Purpose
Design and execute prompt repositories workflows using reliability scorer controls with validated outcomes.
