---
name: model-registries-quality-gatekeeper
description: Use when tasks require model registries quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Quality Gatekeeper

## Purpose
Design and execute model registries workflows using quality gatekeeper controls with validated outcomes.
