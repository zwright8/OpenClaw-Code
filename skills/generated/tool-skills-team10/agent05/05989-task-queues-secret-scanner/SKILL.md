---
name: task-queues-secret-scanner
description: Use when tasks require task queues secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Secret Scanner

## Purpose
Design and execute task queues workflows using secret scanner controls with validated outcomes.
