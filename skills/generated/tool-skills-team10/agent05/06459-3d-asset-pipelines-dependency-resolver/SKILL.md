---
name: 3d-asset-pipelines-dependency-resolver
description: Use when tasks require 3d asset pipelines dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Dependency Resolver

## Purpose
Design and execute 3d asset pipelines workflows using dependency resolver controls with validated outcomes.
