---
name: 3d-asset-pipelines-auth-broker
description: Use when tasks require 3d asset pipelines auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Auth Broker

## Purpose
Design and execute 3d asset pipelines workflows using auth broker controls with validated outcomes.
