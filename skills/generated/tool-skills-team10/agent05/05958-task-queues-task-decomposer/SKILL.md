---
name: task-queues-task-decomposer
description: Use when tasks require task queues task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Task Decomposer

## Purpose
Design and execute task queues workflows using task decomposer controls with validated outcomes.
