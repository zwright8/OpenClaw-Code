---
name: api-gateways-postmortem-drafting
description: Use when tasks require api gateways postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Postmortem Drafting

## Purpose
Design and execute api gateways workflows using postmortem drafting controls with validated outcomes.
