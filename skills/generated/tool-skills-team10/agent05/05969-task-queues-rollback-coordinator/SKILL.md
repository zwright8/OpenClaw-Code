---
name: task-queues-rollback-coordinator
description: Use when tasks require task queues rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Rollback Coordinator

## Purpose
Design and execute task queues workflows using rollback coordinator controls with validated outcomes.
