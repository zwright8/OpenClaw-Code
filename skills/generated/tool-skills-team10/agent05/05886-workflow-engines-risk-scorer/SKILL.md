---
name: workflow-engines-risk-scorer
description: Use when tasks require workflow engines risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Risk Scorer

## Purpose
Design and execute workflow engines workflows using risk scorer controls with validated outcomes.
