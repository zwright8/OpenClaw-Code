---
name: esignature-systems-root-cause-miner
description: Use when tasks require esignature systems root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# eSignature Systems Root Cause Miner

## Purpose
Design and execute esignature systems workflows using root cause miner controls with validated outcomes.
