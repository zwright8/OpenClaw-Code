---
name: document-ocr-feedback-harvester
description: Use when tasks require document ocr feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Feedback Harvester

## Purpose
Design and execute document ocr workflows using feedback harvester controls with validated outcomes.
