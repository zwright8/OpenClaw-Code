---
name: event-streams-reliability-scorer
description: Use when tasks require event streams reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Reliability Scorer

## Purpose
Design and execute event streams workflows using reliability scorer controls with validated outcomes.
