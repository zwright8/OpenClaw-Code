---
name: event-streams-dependency-resolver
description: Use when tasks require event streams dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Dependency Resolver

## Purpose
Design and execute event streams workflows using dependency resolver controls with validated outcomes.
