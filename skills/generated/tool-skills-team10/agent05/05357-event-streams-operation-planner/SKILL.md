---
name: event-streams-operation-planner
description: Use when tasks require event streams operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Operation Planner

## Purpose
Design and execute event streams workflows using operation planner controls with validated outcomes.
