---
name: document-ocr-api-contract-validator
description: Use when tasks require document ocr api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR API Contract Validator

## Purpose
Design and execute document ocr workflows using api contract validator controls with validated outcomes.
...
- Domain: [Document OCR](../../resources/domains/document-ocr.md)
