---
name: prompt-repositories-feedback-harvester
description: Use when tasks require prompt repositories feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Feedback Harvester

## Purpose
Design and execute prompt repositories workflows using feedback harvester controls with validated outcomes.
