---
name: prompt-repositories-operation-planner
description: Use when tasks require prompt repositories operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Operation Planner

## Purpose
Design and execute prompt repositories workflows using operation planner controls with validated outcomes.
