---
name: agent-registries-human-handoff-router
description: Use when tasks require agent registries human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Human Handoff Router

## Purpose
Design and execute agent registries workflows using human handoff router controls with validated outcomes.
