---
name: event-streams-approval-orchestrator
description: Use when tasks require event streams approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Approval Orchestrator

## Purpose
Design and execute event streams workflows using approval orchestrator controls with validated outcomes.
