---
name: metadata-stores-artifact-publisher
description: Use when tasks require metadata stores artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Artifact Publisher

## Purpose
Design and execute metadata stores workflows using artifact publisher controls with validated outcomes.
