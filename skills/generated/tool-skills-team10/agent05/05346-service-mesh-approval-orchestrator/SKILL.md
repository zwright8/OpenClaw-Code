---
name: service-mesh-approval-orchestrator
description: Use when tasks require service mesh approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Approval Orchestrator

## Purpose
Design and execute service mesh workflows using approval orchestrator controls with validated outcomes.
