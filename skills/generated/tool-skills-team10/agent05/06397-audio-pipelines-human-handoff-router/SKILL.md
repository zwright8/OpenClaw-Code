---
name: audio-pipelines-human-handoff-router
description: Use when tasks require audio pipelines human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audio Pipelines Human Handoff Router

## Purpose
Design and execute audio pipelines workflows using human handoff router controls with validated outcomes.
