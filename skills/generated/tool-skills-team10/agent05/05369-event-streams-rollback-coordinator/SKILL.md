---
name: event-streams-rollback-coordinator
description: Use when tasks require event streams rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Rollback Coordinator

## Purpose
Design and execute event streams workflows using rollback coordinator controls with validated outcomes.
