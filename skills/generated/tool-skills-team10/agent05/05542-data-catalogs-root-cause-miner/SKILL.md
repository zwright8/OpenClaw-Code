---
name: data-catalogs-root-cause-miner
description: Use when tasks require data catalogs root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Root Cause Miner

## Purpose
Design and execute data catalogs workflows using root cause miner controls with validated outcomes.
