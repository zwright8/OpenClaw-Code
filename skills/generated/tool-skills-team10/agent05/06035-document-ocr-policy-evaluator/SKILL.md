---
name: document-ocr-policy-evaluator
description: Use when tasks require document ocr policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Policy Evaluator

## Purpose
Design and execute document ocr workflows using policy evaluator controls with validated outcomes.
