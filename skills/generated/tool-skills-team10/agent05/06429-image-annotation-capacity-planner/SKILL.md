---
name: image-annotation-capacity-planner
description: Use when tasks require image annotation capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Capacity Planner

## Purpose
Design and execute image annotation workflows using capacity planner controls with validated outcomes.
