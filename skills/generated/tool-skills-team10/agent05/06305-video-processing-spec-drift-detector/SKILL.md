---
name: video-processing-spec-drift-detector
description: Use when tasks require video processing spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Spec Drift Detector

## Purpose
Design and execute video processing workflows using spec drift detector controls with validated outcomes.
