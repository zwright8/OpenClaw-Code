---
name: release-orchestration-feedback-harvester
description: Use when tasks require release orchestration feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Feedback Harvester

## Purpose
Design and execute release orchestration workflows using feedback harvester controls with validated outcomes.
