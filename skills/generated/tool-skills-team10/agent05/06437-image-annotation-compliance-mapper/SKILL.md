---
name: image-annotation-compliance-mapper
description: Use when tasks require image annotation compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Compliance Mapper

## Purpose
Design and execute image annotation workflows using compliance mapper controls with validated outcomes.
