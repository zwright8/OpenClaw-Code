---
name: prompt-repositories-migration-planner
description: Use when tasks require prompt repositories migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Migration Planner

## Purpose
Design and execute prompt repositories workflows using migration planner controls with validated outcomes.
