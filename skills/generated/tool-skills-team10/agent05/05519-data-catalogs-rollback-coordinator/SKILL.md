...
description: Use when tasks require data catalogs rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Rollback Coordinator

## Purpose
Design and execute data catalogs workflows using rollback coordinator controls with validated outcomes.
