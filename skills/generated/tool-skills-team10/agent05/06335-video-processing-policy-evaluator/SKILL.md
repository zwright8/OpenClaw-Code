---
name: video-processing-policy-evaluator
description: Use when tasks require video processing policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Policy Evaluator

## Purpose
Design and execute video processing workflows using policy evaluator controls with validated outcomes.
