---
name: records-retention-rollback-coordinator
description: Use when tasks require records retention rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Rollback Coordinator

## Purpose
Design and execute records retention workflows using rollback coordinator controls with validated outcomes.
