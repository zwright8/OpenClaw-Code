---
name: image-annotation-root-cause-miner
description: Use when tasks require image annotation root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Root Cause Miner

## Purpose
Design and execute image annotation workflows using root cause miner controls with validated outcomes.
