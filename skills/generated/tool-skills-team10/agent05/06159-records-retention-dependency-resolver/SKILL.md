---
name: records-retention-dependency-resolver
description: Use when tasks require records retention dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Dependency Resolver

## Purpose
Design and execute records retention workflows using dependency resolver controls with validated outcomes.
