---
name: agent-registries-approval-orchestrator
description: Use when tasks require agent registries approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Approval Orchestrator

## Purpose
Design and execute agent registries workflows using approval orchestrator controls with validated outcomes.
