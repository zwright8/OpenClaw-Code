---
name: records-retention-human-handoff-router
description: Use when tasks require records retention human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Human Handoff Router

## Purpose
Design and execute records retention workflows using human handoff router controls with validated outcomes.
