---
name: agent-registries-evidence-collector
description: Use when tasks require agent registries evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Evidence Collector

## Purpose
Design and execute agent registries workflows using evidence collector controls with validated outcomes.
