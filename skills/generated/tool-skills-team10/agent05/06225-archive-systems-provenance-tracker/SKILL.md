---
name: archive-systems-provenance-tracker
description: Use when tasks require archive systems provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Archive Systems Provenance Tracker

## Purpose
Design and execute archive systems workflows using provenance tracker controls with validated outcomes.
