...
description: Use when tasks require metadata stores provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Provenance Tracker

## Purpose
Design and execute metadata stores workflows using provenance tracker controls with validated outcomes.
