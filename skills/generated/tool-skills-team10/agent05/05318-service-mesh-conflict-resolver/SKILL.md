---
name: service-mesh-conflict-resolver
description: Use when tasks require service mesh conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Conflict Resolver

## Purpose
Design and execute service mesh workflows using conflict resolver controls with validated outcomes.
