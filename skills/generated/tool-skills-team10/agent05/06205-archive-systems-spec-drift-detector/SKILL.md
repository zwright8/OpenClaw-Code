---
name: archive-systems-spec-drift-detector
description: Use when tasks require archive systems spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Archive Systems Spec Drift Detector

## Purpose
Design and execute archive systems workflows using spec drift detector controls with validated outcomes.
