---
name: prompt-repositories-schema-introspector
description: Use when tasks require prompt repositories schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Schema Introspector

## Purpose
Design and execute prompt repositories workflows using schema introspector controls with validated outcomes.
