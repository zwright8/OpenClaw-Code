---
name: agent-registries-secret-scanner
description: Use when tasks require agent registries secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Secret Scanner

## Purpose
Design and execute agent registries workflows using secret scanner controls with validated outcomes.
