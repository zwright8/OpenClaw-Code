---
name: service-mesh-feedback-harvester
description: Use when tasks require service mesh feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Feedback Harvester

## Purpose
Design and execute service mesh workflows using feedback harvester controls with validated outcomes.
