---
name: model-registries-capacity-planner
description: Use when tasks require model registries capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Capacity Planner

## Purpose
Design and execute model registries workflows using capacity planner controls with validated outcomes.
