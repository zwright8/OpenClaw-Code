---
name: model-registries-compliance-mapper
description: Use when tasks require model registries compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Compliance Mapper

## Purpose
Design and execute model registries workflows using compliance mapper controls with validated outcomes.
