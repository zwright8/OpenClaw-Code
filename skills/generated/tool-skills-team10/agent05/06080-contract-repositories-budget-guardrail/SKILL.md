---
name: contract-repositories-budget-guardrail
description: Use when tasks require contract repositories budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Budget Guardrail

## Purpose
Design and execute contract repositories workflows using budget guardrail controls with validated outcomes.
