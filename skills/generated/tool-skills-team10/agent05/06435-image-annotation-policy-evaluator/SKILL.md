---
name: image-annotation-policy-evaluator
description: Use when tasks require image annotation policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Policy Evaluator

## Purpose
Design and execute image annotation workflows using policy evaluator controls with validated outcomes.
