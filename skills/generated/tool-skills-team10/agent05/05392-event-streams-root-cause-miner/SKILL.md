---
name: event-streams-root-cause-miner
description: Use when tasks require event streams root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Root Cause Miner

## Purpose
Design and execute event streams workflows using root cause miner controls with validated outcomes.
