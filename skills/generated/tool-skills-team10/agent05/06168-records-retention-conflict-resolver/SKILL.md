---
name: records-retention-conflict-resolver
description: Use when tasks require records retention conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Conflict Resolver

## Purpose
Design and execute records retention workflows using conflict resolver controls with validated outcomes.
