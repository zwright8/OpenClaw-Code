---
name: event-streams-state-reconciler
description: Use when tasks require event streams state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams State Reconciler

## Purpose
Design and execute event streams workflows using state reconciler controls with validated outcomes.
