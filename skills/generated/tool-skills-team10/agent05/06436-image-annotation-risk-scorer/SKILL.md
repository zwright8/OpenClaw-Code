---
name: image-annotation-risk-scorer
description: Use when tasks require image annotation risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Risk Scorer

## Purpose
Design and execute image annotation workflows using risk scorer controls with validated outcomes.
