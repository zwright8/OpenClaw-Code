---
name: event-streams-incident-triage
description: Use when tasks require event streams incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Incident Triage

## Purpose
Design and execute event streams workflows using incident triage controls with validated outcomes.
