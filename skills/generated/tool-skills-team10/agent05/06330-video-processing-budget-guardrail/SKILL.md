---
name: video-processing-budget-guardrail
description: Use when tasks require video processing budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Budget Guardrail

## Purpose
Design and execute video processing workflows using budget guardrail controls with validated outcomes.
