---
name: agent-registries-compliance-mapper
description: Use when tasks require agent registries compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Compliance Mapper

## Purpose
Design and execute agent registries workflows using compliance mapper controls with validated outcomes.
