---
name: media-asset-management-compliance-mapper
description: Use when tasks require media asset management compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Compliance Mapper

## Purpose
Design and execute media asset management workflows using compliance mapper controls with validated outcomes.
