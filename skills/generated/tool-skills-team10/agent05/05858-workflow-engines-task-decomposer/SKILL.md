---
name: workflow-engines-task-decomposer
description: Use when tasks require workflow engines task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Task Decomposer

## Purpose
Design and execute workflow engines workflows using task decomposer controls with validated outcomes.
