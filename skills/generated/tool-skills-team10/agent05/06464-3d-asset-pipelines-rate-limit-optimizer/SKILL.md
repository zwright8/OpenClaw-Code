---
name: 3d-asset-pipelines-rate-limit-optimizer
description: Use when tasks require 3d asset pipelines rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Rate Limit Optimizer

## Purpose
Design and execute 3d asset pipelines workflows using rate limit optimizer controls with validated outcomes.
