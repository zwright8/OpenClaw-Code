---
name: contract-repositories-operation-planner
description: Use when tasks require contract repositories operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Operation Planner

## Purpose
Design and execute contract repositories workflows using operation planner controls with validated outcomes.
