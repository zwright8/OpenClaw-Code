---
name: video-processing-risk-scorer
description: Use when tasks require video processing risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Risk Scorer

## Purpose
Design and execute video processing workflows using risk scorer controls with validated outcomes.
