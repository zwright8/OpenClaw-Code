---
name: prompt-repositories-workflow-compiler
description: Use when tasks require prompt repositories workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Workflow Compiler

## Purpose
Design and execute prompt repositories workflows using workflow compiler controls with validated outcomes.
