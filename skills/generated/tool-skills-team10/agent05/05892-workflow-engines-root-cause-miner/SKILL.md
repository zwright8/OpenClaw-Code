---
name: workflow-engines-root-cause-miner
description: Use when tasks require workflow engines root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Root Cause Miner

## Purpose
Design and execute workflow engines workflows using root cause miner controls with validated outcomes.
