---
name: feature-stores-operation-planner
description: Use when tasks require feature stores operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Operation Planner

## Purpose
Design and execute feature stores workflows using operation planner controls with validated outcomes.
