---
name: data-catalogs-approval-orchestrator
description: Use when tasks require data catalogs approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Approval Orchestrator

## Purpose
Design and execute data catalogs workflows using approval orchestrator controls with validated outcomes.
