---
name: service-mesh-incident-triage
description: Use when tasks require service mesh incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Incident Triage

## Purpose
Design and execute service mesh workflows using incident triage controls with validated outcomes.
