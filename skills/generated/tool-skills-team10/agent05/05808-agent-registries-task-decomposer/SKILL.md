---
name: agent-registries-task-decomposer
description: Use when tasks require agent registries task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Task Decomposer

## Purpose
Design and execute agent registries workflows using task decomposer controls with validated outcomes.
