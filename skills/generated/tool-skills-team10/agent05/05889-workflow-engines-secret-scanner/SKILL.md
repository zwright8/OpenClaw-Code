---
name: workflow-engines-secret-scanner
description: Use when tasks require workflow engines secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Secret Scanner

## Purpose
Design and execute workflow engines workflows using secret scanner controls with validated outcomes.
