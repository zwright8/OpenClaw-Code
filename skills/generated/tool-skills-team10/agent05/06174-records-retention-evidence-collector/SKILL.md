---
name: records-retention-evidence-collector
description: Use when tasks require records retention evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Evidence Collector

## Purpose
Design and execute records retention workflows using evidence collector controls with validated outcomes.
