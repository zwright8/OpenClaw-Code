---
name: records-retention-schema-introspector
description: Use when tasks require records retention schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Schema Introspector

## Purpose
Design and execute records retention workflows using schema introspector controls with validated outcomes.
