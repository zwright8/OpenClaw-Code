---
name: contract-repositories-task-decomposer
description: Use when tasks require contract repositories task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Task Decomposer

## Purpose
Design and execute contract repositories workflows using task decomposer controls with validated outcomes.
