---
name: video-processing-auth-broker
description: Use when tasks require video processing auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Auth Broker

## Purpose
Design and execute video processing workflows using auth broker controls with validated outcomes.
