---
name: model-registries-spec-drift-detector
description: Use when tasks require model registries spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Spec Drift Detector

## Purpose
Design and execute model registries workflows using spec drift detector controls with validated outcomes.
