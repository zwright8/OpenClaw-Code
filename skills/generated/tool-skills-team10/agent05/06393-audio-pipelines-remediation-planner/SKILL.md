---
name: audio-pipelines-remediation-planner
description: Use when tasks require audio pipelines remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audio Pipelines Remediation Planner

## Purpose
Design and execute audio pipelines workflows using remediation planner controls with validated outcomes.
