---
name: image-annotation-migration-planner
description: Use when tasks require image annotation migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Migration Planner

## Purpose
Design and execute image annotation workflows using migration planner controls with validated outcomes.
