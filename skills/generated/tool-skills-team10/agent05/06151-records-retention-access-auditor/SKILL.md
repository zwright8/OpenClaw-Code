---
name: records-retention-access-auditor
description: Use when tasks require records retention access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Access Auditor

## Purpose
Design and execute records retention workflows using access auditor controls with validated outcomes.
