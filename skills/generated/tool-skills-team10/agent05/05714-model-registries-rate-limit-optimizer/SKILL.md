---
name: model-registries-rate-limit-optimizer
description: Use when tasks require model registries rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Rate Limit Optimizer

## Purpose
Design and execute model registries workflows using rate limit optimizer controls with validated outcomes.
