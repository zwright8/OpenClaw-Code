---
name: model-registries-policy-evaluator
description: Use when tasks require model registries policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Policy Evaluator

## Purpose
Design and execute model registries workflows using policy evaluator controls with validated outcomes.
