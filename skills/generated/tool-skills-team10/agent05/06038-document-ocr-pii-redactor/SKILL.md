---
name: document-ocr-pii-redactor
description: Use when tasks require document ocr pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR PII Redactor

## Purpose
Design and execute document ocr workflows using pii redactor controls with validated outcomes.
