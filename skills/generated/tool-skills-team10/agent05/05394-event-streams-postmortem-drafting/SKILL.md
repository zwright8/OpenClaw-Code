---
name: event-streams-postmortem-drafting
description: Use when tasks require event streams postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Postmortem Drafting

## Purpose
Design and execute event streams workflows using postmortem drafting controls with validated outcomes.
