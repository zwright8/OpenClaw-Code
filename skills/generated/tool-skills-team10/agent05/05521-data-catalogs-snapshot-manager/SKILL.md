---
name: data-catalogs-snapshot-manager
description: Use when tasks require data catalogs snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Snapshot Manager

## Purpose
Design and execute data catalogs workflows using snapshot manager controls with validated outcomes.
