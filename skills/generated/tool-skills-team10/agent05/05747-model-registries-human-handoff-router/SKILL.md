---
name: model-registries-human-handoff-router
description: Use when tasks require model registries human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Human Handoff Router

## Purpose
Design and execute model registries workflows using human handoff router controls with validated outcomes.
