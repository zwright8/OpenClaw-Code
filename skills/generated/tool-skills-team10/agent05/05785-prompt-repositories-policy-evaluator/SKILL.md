---
name: prompt-repositories-policy-evaluator
description: Use when tasks require prompt repositories policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Policy Evaluator

## Purpose
Design and execute prompt repositories workflows using policy evaluator controls with validated outcomes.
