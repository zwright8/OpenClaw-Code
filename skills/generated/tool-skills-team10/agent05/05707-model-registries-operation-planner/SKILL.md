---
name: model-registries-operation-planner
description: Use when tasks require model registries operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Operation Planner

## Purpose
Design and execute model registries workflows using operation planner controls with validated outcomes.
