---
name: image-annotation-access-auditor
description: Use when tasks require image annotation access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Access Auditor

## Purpose
Design and execute image annotation workflows using access auditor controls with validated outcomes.
