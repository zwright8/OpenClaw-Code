---
name: metadata-stores-runbook-composer
description: Use when tasks require metadata stores runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Runbook Composer

## Purpose
Design and execute metadata stores workflows using runbook composer controls with validated outcomes.
