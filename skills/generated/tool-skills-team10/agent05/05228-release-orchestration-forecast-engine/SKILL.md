---
name: release-orchestration-forecast-engine
description: Use when tasks require release orchestration forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Forecast Engine

## Purpose
Design and execute release orchestration workflows using forecast engine controls with validated outcomes.
