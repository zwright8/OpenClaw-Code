---
name: contract-repositories-risk-scorer
description: Use when tasks require contract repositories risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Risk Scorer

## Purpose
Design and execute contract repositories workflows using risk scorer controls with validated outcomes.
