---
name: image-annotation-retry-governor
description: Use when tasks require image annotation retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Retry Governor

## Purpose
Design and execute image annotation workflows using retry governor controls with validated outcomes.
