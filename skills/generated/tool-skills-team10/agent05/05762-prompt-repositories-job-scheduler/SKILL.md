---
name: prompt-repositories-job-scheduler
description: Use when tasks require prompt repositories job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Job Scheduler

## Purpose
Design and execute prompt repositories workflows using job scheduler controls with validated outcomes.
