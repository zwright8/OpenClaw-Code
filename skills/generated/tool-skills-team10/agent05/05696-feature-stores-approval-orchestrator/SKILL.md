---
name: feature-stores-approval-orchestrator
description: Use when tasks require feature stores approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Approval Orchestrator

## Purpose
Design and execute feature stores workflows using approval orchestrator controls with validated outcomes.
