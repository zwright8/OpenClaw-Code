---
name: event-streams-access-auditor
description: Use when tasks require event streams access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Access Auditor

## Purpose
Design and execute event streams workflows using access auditor controls with validated outcomes.
