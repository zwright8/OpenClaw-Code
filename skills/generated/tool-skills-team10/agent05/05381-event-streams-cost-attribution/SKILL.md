---
name: event-streams-cost-attribution
description: Use when tasks require event streams cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Cost Attribution

## Purpose
Design and execute event streams workflows using cost attribution controls with validated outcomes.
