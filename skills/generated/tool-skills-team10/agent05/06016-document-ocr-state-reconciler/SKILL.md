---
name: document-ocr-state-reconciler
description: Use when tasks require document ocr state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR State Reconciler

## Purpose
Design and execute document ocr workflows using state reconciler controls with validated outcomes.
