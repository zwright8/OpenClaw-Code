---
name: task-queues-policy-evaluator
description: Use when tasks require task queues policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Policy Evaluator

## Purpose
Design and execute task queues workflows using policy evaluator controls with validated outcomes.
