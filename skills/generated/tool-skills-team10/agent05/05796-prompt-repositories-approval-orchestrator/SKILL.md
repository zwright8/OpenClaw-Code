---
name: prompt-repositories-approval-orchestrator
description: Use when tasks require prompt repositories approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Approval Orchestrator

## Purpose
Design and execute prompt repositories workflows using approval orchestrator controls with validated outcomes.
