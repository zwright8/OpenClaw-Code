---
name: image-annotation-pii-redactor
description: Use when tasks require image annotation pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation PII Redactor

## Purpose
Design and execute image annotation workflows using pii redactor controls with validated outcomes.
