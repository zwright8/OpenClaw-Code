---
name: feature-stores-permission-mapper
description: Use when tasks require feature stores permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Permission Mapper

## Purpose
Design and execute feature stores workflows using permission mapper controls with validated outcomes.
