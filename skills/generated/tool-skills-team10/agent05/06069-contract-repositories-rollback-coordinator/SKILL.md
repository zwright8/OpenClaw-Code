---
name: contract-repositories-rollback-coordinator
description: Use when tasks require contract repositories rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Rollback Coordinator

## Purpose
Design and execute contract repositories workflows using rollback coordinator controls with validated outcomes.
