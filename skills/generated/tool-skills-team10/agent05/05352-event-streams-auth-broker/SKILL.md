---
name: event-streams-auth-broker
description: Use when tasks require event streams auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Auth Broker

## Purpose
Design and execute event streams workflows using auth broker controls with validated outcomes.
