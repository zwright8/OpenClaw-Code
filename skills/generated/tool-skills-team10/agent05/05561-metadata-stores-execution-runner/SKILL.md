---
name: metadata-stores-execution-runner
description: Use when tasks require metadata stores execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Execution Runner

## Purpose
Design and execute metadata stores workflows using execution runner controls with validated outcomes.
