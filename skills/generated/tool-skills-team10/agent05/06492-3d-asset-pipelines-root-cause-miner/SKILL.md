---
name: 3d-asset-pipelines-root-cause-miner
description: Use when tasks require 3d asset pipelines root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Root Cause Miner

## Purpose
Design and execute 3d asset pipelines workflows using root cause miner controls with validated outcomes.
