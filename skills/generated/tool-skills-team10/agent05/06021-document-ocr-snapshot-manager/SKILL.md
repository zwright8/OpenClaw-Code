---
name: document-ocr-snapshot-manager
description: Use when tasks require document ocr snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Snapshot Manager

## Purpose
Design and execute document ocr workflows using snapshot manager controls with validated outcomes.
