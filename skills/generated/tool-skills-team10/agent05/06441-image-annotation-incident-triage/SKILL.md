---
name: image-annotation-incident-triage
description: Use when tasks require image annotation incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Incident Triage

## Purpose
Design and execute image annotation workflows using incident triage controls with validated outcomes.
