---
name: data-quality-hubs-task-decomposer
description: Use when tasks require data quality hubs task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Quality Hubs Task Decomposer

## Purpose
Design and execute data quality hubs workflows using task decomposer controls with validated outcomes.
