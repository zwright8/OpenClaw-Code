---
name: video-processing-approval-orchestrator
description: Use when tasks require video processing approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Approval Orchestrator

## Purpose
Design and execute video processing workflows using approval orchestrator controls with validated outcomes.
