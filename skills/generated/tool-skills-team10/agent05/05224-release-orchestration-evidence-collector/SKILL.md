---
name: release-orchestration-evidence-collector
description: Use when tasks require release orchestration evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Evidence Collector

## Purpose
Design and execute release orchestration workflows using evidence collector controls with validated outcomes.
