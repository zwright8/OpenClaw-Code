---
name: metadata-stores-feedback-harvester
description: Use when tasks require metadata stores feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Feedback Harvester

## Purpose
Design and execute metadata stores workflows using feedback harvester controls with validated outcomes.
