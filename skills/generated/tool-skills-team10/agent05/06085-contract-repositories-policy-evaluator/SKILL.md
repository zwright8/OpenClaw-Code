---
name: contract-repositories-policy-evaluator
description: Use when tasks require contract repositories policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Policy Evaluator

## Purpose
Design and execute contract repositories workflows using policy evaluator controls with validated outcomes.
