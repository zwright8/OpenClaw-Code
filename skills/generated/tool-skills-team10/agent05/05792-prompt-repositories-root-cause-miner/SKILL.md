---
name: prompt-repositories-root-cause-miner
description: Use when tasks require prompt repositories root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Root Cause Miner

## Purpose
Design and execute prompt repositories workflows using root cause miner controls with validated outcomes.
