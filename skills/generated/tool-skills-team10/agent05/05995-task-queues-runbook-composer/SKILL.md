---
name: task-queues-runbook-composer
description: Use when tasks require task queues runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Runbook Composer

## Purpose
Design and execute task queues workflows using runbook composer controls with validated outcomes.
