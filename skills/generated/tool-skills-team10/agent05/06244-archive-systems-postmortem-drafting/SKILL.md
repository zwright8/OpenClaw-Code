---
name: archive-systems-postmortem-drafting
description: Use when tasks require archive systems postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Archive Systems Postmortem Drafting

## Purpose
Design and execute archive systems workflows using postmortem drafting controls with validated outcomes.
