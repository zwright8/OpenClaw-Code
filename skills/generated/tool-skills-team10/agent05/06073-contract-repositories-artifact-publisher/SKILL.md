---
name: contract-repositories-artifact-publisher
description: Use when tasks require contract repositories artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Artifact Publisher

## Purpose
Design and execute contract repositories workflows using artifact publisher controls with validated outcomes.
