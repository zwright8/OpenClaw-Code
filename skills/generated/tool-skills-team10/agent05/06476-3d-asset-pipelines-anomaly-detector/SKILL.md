---
name: 3d-asset-pipelines-anomaly-detector
description: Use when tasks require 3d asset pipelines anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Anomaly Detector

## Purpose
Design and execute 3d asset pipelines workflows using anomaly detector controls with validated outcomes.
