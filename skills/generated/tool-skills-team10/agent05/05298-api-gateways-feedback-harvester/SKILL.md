---
name: api-gateways-feedback-harvester
description: Use when tasks require api gateways feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Feedback Harvester

## Purpose
Design and execute api gateways workflows using feedback harvester controls with validated outcomes.
