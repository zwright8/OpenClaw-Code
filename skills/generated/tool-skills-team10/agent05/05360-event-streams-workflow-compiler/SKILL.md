---
name: event-streams-workflow-compiler
description: Use when tasks require event streams workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Workflow Compiler

## Purpose
Design and execute event streams workflows using workflow compiler controls with validated outcomes.
