---
name: event-streams-evidence-collector
description: Use when tasks require event streams evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Evidence Collector

## Purpose
Design and execute event streams workflows using evidence collector controls with validated outcomes.
