---
name: agent-registries-retry-governor
description: Use when tasks require agent registries retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Retry Governor

## Purpose
Design and execute agent registries workflows using retry governor controls with validated outcomes.
