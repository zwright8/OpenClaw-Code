---
name: service-mesh-workflow-compiler
description: Use when tasks require service mesh workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Workflow Compiler

## Purpose
Design and execute service mesh workflows using workflow compiler controls with validated outcomes.
