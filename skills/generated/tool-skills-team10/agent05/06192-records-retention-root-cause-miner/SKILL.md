---
name: records-retention-root-cause-miner
description: Use when tasks require records retention root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Root Cause Miner

## Purpose
Design and execute records retention workflows using root cause miner controls with validated outcomes.
