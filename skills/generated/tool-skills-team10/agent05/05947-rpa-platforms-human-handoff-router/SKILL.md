---
name: rpa-platforms-human-handoff-router
description: Use when tasks require rpa platforms human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Human Handoff Router

## Purpose
Design and execute rpa platforms workflows using human handoff router controls with validated outcomes.
