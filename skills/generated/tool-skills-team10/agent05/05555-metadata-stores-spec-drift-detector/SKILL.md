---
name: metadata-stores-spec-drift-detector
description: Use when tasks require metadata stores spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Spec Drift Detector

## Purpose
Design and execute metadata stores workflows using spec drift detector controls with validated outcomes.
