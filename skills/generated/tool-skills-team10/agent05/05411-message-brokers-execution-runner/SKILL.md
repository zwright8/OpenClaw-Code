---
name: message-brokers-execution-runner
description: Use when tasks require message brokers execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Execution Runner

## Purpose
Design and execute message brokers workflows using execution runner controls with validated outcomes.
