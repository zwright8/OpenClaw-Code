---
name: video-processing-rate-limit-optimizer
description: Use when tasks require video processing rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Rate Limit Optimizer

## Purpose
Design and execute video processing workflows using rate limit optimizer controls with validated outcomes.
