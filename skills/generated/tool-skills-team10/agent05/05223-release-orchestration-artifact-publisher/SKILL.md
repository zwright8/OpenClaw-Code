---
name: release-orchestration-artifact-publisher
description: Use when tasks require release orchestration artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Artifact Publisher

## Purpose
Design and execute release orchestration workflows using artifact publisher controls with validated outcomes.
