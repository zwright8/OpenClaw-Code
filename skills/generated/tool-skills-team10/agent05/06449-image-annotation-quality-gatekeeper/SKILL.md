---
name: image-annotation-quality-gatekeeper
description: Use when tasks require image annotation quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Quality Gatekeeper

## Purpose
Design and execute image annotation workflows using quality gatekeeper controls with validated outcomes.
