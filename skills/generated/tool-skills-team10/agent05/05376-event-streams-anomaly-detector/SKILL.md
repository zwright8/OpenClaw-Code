---
name: event-streams-anomaly-detector
description: Use when tasks require event streams anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Anomaly Detector

## Purpose
Design and execute event streams workflows using anomaly detector controls with validated outcomes.
