---
name: message-brokers-task-decomposer
description: Use when tasks require message brokers task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Task Decomposer

## Purpose
Design and execute message brokers workflows using task decomposer controls with validated outcomes.
