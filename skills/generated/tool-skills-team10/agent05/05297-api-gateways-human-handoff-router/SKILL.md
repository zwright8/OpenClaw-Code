---
name: api-gateways-human-handoff-router
description: Use when tasks require api gateways human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Human Handoff Router

## Purpose
Design and execute api gateways workflows using human handoff router controls with validated outcomes.
