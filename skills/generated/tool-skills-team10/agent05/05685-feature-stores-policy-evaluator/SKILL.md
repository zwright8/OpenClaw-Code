---
name: feature-stores-policy-evaluator
description: Use when tasks require feature stores policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Policy Evaluator

## Purpose
Design and execute feature stores workflows using policy evaluator controls with validated outcomes.
