---
name: 3d-asset-pipelines-feedback-harvester
description: Use when tasks require 3d asset pipelines feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Feedback Harvester

## Purpose
Design and execute 3d asset pipelines workflows using feedback harvester controls with validated outcomes.
