---
name: records-retention-delta-calculator
description: Use when tasks require records retention delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Delta Calculator

## Purpose
Design and execute records retention workflows using delta calculator controls with validated outcomes.
