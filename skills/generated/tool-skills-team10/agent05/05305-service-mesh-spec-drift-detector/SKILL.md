---
name: service-mesh-spec-drift-detector
description: Use when tasks require service mesh spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Spec Drift Detector

## Purpose
Design and execute service mesh workflows using spec drift detector controls with validated outcomes.
