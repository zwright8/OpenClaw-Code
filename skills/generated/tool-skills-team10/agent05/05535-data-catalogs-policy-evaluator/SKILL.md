---
name: data-catalogs-policy-evaluator
description: Use when tasks require data catalogs policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Policy Evaluator

## Purpose
Design and execute data catalogs workflows using policy evaluator controls with validated outcomes.
