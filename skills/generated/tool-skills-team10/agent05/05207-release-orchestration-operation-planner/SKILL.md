---
name: release-orchestration-operation-planner
description: Use when tasks require release orchestration operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Operation Planner

## Purpose
Design and execute release orchestration workflows using operation planner controls with validated outcomes.
