---
name: event-streams-job-scheduler
description: Use when tasks require event streams job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Job Scheduler

## Purpose
Design and execute event streams workflows using job scheduler controls with validated outcomes.
