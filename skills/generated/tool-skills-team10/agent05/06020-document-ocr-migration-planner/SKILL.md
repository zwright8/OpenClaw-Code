---
name: document-ocr-migration-planner
description: Use when tasks require document ocr migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Migration Planner

## Purpose
Design and execute document ocr workflows using migration planner controls with validated outcomes.
