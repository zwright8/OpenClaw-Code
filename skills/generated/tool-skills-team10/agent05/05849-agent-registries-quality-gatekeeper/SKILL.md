---
name: agent-registries-quality-gatekeeper
description: Use when tasks require agent registries quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Quality Gatekeeper

## Purpose
Design and execute agent registries workflows using quality gatekeeper controls with validated outcomes.
