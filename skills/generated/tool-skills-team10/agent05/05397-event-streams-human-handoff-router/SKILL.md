---
name: event-streams-human-handoff-router
description: Use when tasks require event streams human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Human Handoff Router

## Purpose
Design and execute event streams workflows using human handoff router controls with validated outcomes.
