---
name: event-streams-conflict-resolver
description: Use when tasks require event streams conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Conflict Resolver

## Purpose
Design and execute event streams workflows using conflict resolver controls with validated outcomes.
