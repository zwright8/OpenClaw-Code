---
name: agent-registries-risk-scorer
description: Use when tasks require agent registries risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Risk Scorer

## Purpose
Design and execute agent registries workflows using risk scorer controls with validated outcomes.
