---
name: records-retention-risk-scorer
description: Use when tasks require records retention risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Risk Scorer

## Purpose
Design and execute records retention workflows using risk scorer controls with validated outcomes.
