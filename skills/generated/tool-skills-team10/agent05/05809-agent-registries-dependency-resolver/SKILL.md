---
name: agent-registries-dependency-resolver
description: Use when tasks require agent registries dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Dependency Resolver

## Purpose
Design and execute agent registries workflows using dependency resolver controls with validated outcomes.
