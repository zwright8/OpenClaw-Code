---
name: document-ocr-forecast-engine
description: Use when tasks require document ocr forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Forecast Engine

## Purpose
Design and execute document ocr workflows using forecast engine controls with validated outcomes.
