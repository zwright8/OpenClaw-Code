---
name: image-annotation-human-handoff-router
description: Use when tasks require image annotation human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Human Handoff Router

## Purpose
Design and execute image annotation workflows using human handoff router controls with validated outcomes.
