---
name: service-mesh-provenance-tracker
description: Use when tasks require service mesh provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Provenance Tracker

## Purpose
Design and execute service mesh workflows using provenance tracker controls with validated outcomes.
