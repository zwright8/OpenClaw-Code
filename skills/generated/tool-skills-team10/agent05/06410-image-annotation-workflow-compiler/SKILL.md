---
name: image-annotation-workflow-compiler
description: Use when tasks require image annotation workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Workflow Compiler

## Purpose
Design and execute image annotation workflows using workflow compiler controls with validated outcomes.
