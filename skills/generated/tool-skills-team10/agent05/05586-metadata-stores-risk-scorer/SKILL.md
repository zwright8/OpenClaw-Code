---
name: metadata-stores-risk-scorer
description: Use when tasks require metadata stores risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Risk Scorer

## Purpose
Design and execute metadata stores workflows using risk scorer controls with validated outcomes.
