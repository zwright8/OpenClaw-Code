---
name: message-brokers-rate-limit-optimizer
description: Use when tasks require message brokers rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Rate Limit Optimizer

## Purpose
Design and execute message brokers workflows using rate limit optimizer controls with validated outcomes.
