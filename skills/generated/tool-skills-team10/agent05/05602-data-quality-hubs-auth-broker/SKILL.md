---
name: data-quality-hubs-auth-broker
description: Use when tasks require data quality hubs auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Quality Hubs Auth Broker

## Purpose
Design and execute data quality hubs workflows using auth broker controls with validated outcomes.
