---
name: document-ocr-workflow-compiler
description: Use when tasks require document ocr workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Workflow Compiler

## Purpose
Design and execute document ocr workflows using workflow compiler controls with validated outcomes.
