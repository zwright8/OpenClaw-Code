---
name: release-orchestration-risk-scorer
description: Use when tasks require release orchestration risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Risk Scorer

## Purpose
Design and execute release orchestration workflows using risk scorer controls with validated outcomes.
