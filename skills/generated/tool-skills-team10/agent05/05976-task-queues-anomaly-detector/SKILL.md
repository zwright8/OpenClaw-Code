---
name: task-queues-anomaly-detector
description: Use when tasks require task queues anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Anomaly Detector

## Purpose
Design and execute task queues workflows using anomaly detector controls with validated outcomes.
