---
name: contract-repositories-runbook-composer
description: Use when tasks require contract repositories runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Runbook Composer

## Purpose
Design and execute contract repositories workflows using runbook composer controls with validated outcomes.
