---
name: data-catalogs-conflict-resolver
description: Use when tasks require data catalogs conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Conflict Resolver

## Purpose
Design and execute data catalogs workflows using conflict resolver controls with validated outcomes.
