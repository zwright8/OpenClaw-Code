---
name: api-gateways-task-decomposer
description: Use when tasks require api gateways task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Task Decomposer

## Purpose
Design and execute api gateways workflows using task decomposer controls with validated outcomes.
