---
name: 3d-asset-pipelines-permission-mapper
description: Use when tasks require 3d asset pipelines permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Permission Mapper

## Purpose
Design and execute 3d asset pipelines workflows using permission mapper controls with validated outcomes.
