---
name: workflow-engines-runbook-composer
description: Use when tasks require workflow engines runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Runbook Composer

## Purpose
Design and execute workflow engines workflows using runbook composer controls with validated outcomes.
