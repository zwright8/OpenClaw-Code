---
name: model-registries-budget-guardrail
description: Use when tasks require model registries budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Budget Guardrail

## Purpose
Design and execute model registries workflows using budget guardrail controls with validated outcomes.
