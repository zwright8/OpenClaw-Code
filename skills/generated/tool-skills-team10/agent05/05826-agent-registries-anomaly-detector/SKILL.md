---
name: agent-registries-anomaly-detector
description: Use when tasks require agent registries anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Anomaly Detector

## Purpose
Design and execute agent registries workflows using anomaly detector controls with validated outcomes.
