---
name: prompt-repositories-rate-limit-optimizer
description: Use when tasks require prompt repositories rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Rate Limit Optimizer

## Purpose
Design and execute prompt repositories workflows using rate limit optimizer controls with validated outcomes.
