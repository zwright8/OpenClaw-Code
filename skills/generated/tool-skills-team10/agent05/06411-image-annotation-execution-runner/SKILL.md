---
name: image-annotation-execution-runner
description: Use when tasks require image annotation execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Execution Runner

## Purpose
Design and execute image annotation workflows using execution runner controls with validated outcomes.
