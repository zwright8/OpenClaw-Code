---
name: metadata-stores-remediation-planner
description: Use when tasks require metadata stores remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Remediation Planner

## Purpose
Design and execute metadata stores workflows using remediation planner controls with validated outcomes.
