---
name: feature-stores-anomaly-detector
description: Use when tasks require feature stores anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Anomaly Detector

## Purpose
Design and execute feature stores workflows using anomaly detector controls with validated outcomes.
