---
name: contract-repositories-access-auditor
description: Use when tasks require contract repositories access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Access Auditor

## Purpose
Design and execute contract repositories workflows using access auditor controls with validated outcomes.
