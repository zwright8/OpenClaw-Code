---
name: message-brokers-dependency-resolver
description: Use when tasks require message brokers dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Dependency Resolver

## Purpose
Design and execute message brokers workflows using dependency resolver controls with validated outcomes.
