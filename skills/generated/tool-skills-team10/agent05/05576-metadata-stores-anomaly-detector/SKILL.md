---
name: metadata-stores-anomaly-detector
description: Use when tasks require metadata stores anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Anomaly Detector

## Purpose
Design and execute metadata stores workflows using anomaly detector controls with validated outcomes.
