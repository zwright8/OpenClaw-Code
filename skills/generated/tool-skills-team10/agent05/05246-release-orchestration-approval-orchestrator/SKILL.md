---
name: release-orchestration-approval-orchestrator
description: Use when tasks require release orchestration approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Approval Orchestrator

## Purpose
Design and execute release orchestration workflows using approval orchestrator controls with validated outcomes.
