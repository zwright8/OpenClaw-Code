---
name: contract-repositories-root-cause-miner
description: Use when tasks require contract repositories root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Root Cause Miner

## Purpose
Design and execute contract repositories workflows using root cause miner controls with validated outcomes.
