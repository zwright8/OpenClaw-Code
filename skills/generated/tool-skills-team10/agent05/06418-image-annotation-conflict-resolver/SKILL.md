---
name: image-annotation-conflict-resolver
description: Use when tasks require image annotation conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Conflict Resolver

## Purpose
Design and execute image annotation workflows using conflict resolver controls with validated outcomes.
