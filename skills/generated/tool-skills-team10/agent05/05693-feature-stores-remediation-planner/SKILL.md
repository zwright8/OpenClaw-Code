---
name: feature-stores-remediation-planner
description: Use when tasks require feature stores remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Remediation Planner

## Purpose
Design and execute feature stores workflows using remediation planner controls with validated outcomes.
