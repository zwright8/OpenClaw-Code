---
name: records-retention-quality-gatekeeper
description: Use when tasks require records retention quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Quality Gatekeeper

## Purpose
Design and execute records retention workflows using quality gatekeeper controls with validated outcomes.
