---
name: video-processing-permission-mapper
description: Use when tasks require video processing permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Permission Mapper

## Purpose
Design and execute video processing workflows using permission mapper controls with validated outcomes.
