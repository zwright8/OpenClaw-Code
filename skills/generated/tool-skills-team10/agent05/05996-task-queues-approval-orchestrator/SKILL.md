---
name: task-queues-approval-orchestrator
description: Use when tasks require task queues approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Approval Orchestrator

## Purpose
Design and execute task queues workflows using approval orchestrator controls with validated outcomes.
