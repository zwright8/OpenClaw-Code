---
name: agent-registries-snapshot-manager
description: Use when tasks require agent registries snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Snapshot Manager

## Purpose
Design and execute agent registries workflows using snapshot manager controls with validated outcomes.
