---
name: feature-stores-artifact-publisher
description: Use when tasks require feature stores artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Artifact Publisher

## Purpose
Design and execute feature stores workflows using artifact publisher controls with validated outcomes.
