---
name: document-ocr-cost-attribution
description: Use when tasks require document ocr cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Cost Attribution

## Purpose
Design and execute document ocr workflows using cost attribution controls with validated outcomes.
