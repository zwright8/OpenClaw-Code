---
name: task-queues-rate-limit-optimizer
description: Use when tasks require task queues rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Rate Limit Optimizer

## Purpose
Design and execute task queues workflows using rate limit optimizer controls with validated outcomes.
