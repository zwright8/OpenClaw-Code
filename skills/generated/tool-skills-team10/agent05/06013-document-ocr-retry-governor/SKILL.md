---
name: document-ocr-retry-governor
description: Use when tasks require document ocr retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Retry Governor

## Purpose
Design and execute document ocr workflows using retry governor controls with validated outcomes.
