---
name: image-annotation-reliability-scorer
description: Use when tasks require image annotation reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Reliability Scorer

## Purpose
Design and execute image annotation workflows using reliability scorer controls with validated outcomes.
