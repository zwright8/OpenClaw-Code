---
name: model-registries-risk-scorer
description: Use when tasks require model registries risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Risk Scorer

## Purpose
Design and execute model registries workflows using risk scorer controls with validated outcomes.
