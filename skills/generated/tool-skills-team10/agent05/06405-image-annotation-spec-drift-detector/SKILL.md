---
name: image-annotation-spec-drift-detector
description: Use when tasks require image annotation spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Spec Drift Detector

## Purpose
Design and execute image annotation workflows using spec drift detector controls with validated outcomes.
