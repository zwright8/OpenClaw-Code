---
name: document-ocr-outcome-synthesizer
description: Use when tasks require document ocr outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Outcome Synthesizer

## Purpose
Design and execute document ocr workflows using outcome synthesizer controls with validated outcomes.
