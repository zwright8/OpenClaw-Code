---
name: document-ocr-conflict-resolver
description: Use when tasks require document ocr conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Conflict Resolver

## Purpose
Design and execute document ocr workflows using conflict resolver controls with validated outcomes.
