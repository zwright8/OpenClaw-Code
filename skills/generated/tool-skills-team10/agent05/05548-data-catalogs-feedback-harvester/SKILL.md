---
name: data-catalogs-feedback-harvester
description: Use when tasks require data catalogs feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Feedback Harvester

## Purpose
Design and execute data catalogs workflows using feedback harvester controls with validated outcomes.
