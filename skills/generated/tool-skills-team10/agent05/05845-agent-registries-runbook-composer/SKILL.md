---
name: agent-registries-runbook-composer
description: Use when tasks require agent registries runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Runbook Composer

## Purpose
Design and execute agent registries workflows using runbook composer controls with validated outcomes.
