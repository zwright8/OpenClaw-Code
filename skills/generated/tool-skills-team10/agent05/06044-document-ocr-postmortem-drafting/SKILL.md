---
name: document-ocr-postmortem-drafting
description: Use when tasks require document ocr postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Postmortem Drafting

## Purpose
Design and execute document ocr workflows using postmortem drafting controls with validated outcomes.
