---
name: contract-repositories-permission-mapper
description: Use when tasks require contract repositories permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Permission Mapper

## Purpose
Design and execute contract repositories workflows using permission mapper controls with validated outcomes.
