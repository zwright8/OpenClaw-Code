---
name: workflow-engines-conflict-resolver
description: Use when tasks require workflow engines conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Conflict Resolver

## Purpose
Design and execute workflow engines workflows using conflict resolver controls with validated outcomes.
