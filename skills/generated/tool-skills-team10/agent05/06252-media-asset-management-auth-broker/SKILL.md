---
name: media-asset-management-auth-broker
description: Use when tasks require media asset management auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Auth Broker

## Purpose
Design and execute media asset management workflows using auth broker controls with validated outcomes.
