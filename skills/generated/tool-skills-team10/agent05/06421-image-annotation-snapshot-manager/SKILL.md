---
name: image-annotation-snapshot-manager
description: Use when tasks require image annotation snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Snapshot Manager

## Purpose
Design and execute image annotation workflows using snapshot manager controls with validated outcomes.
