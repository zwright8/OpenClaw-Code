---
name: release-orchestration-anomaly-detector
description: Use when tasks require release orchestration anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Anomaly Detector

## Purpose
Design and execute release orchestration workflows using anomaly detector controls with validated outcomes.
