---
name: api-gateways-snapshot-manager
description: Use when tasks require api gateways snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Snapshot Manager

## Purpose
Design and execute api gateways workflows using snapshot manager controls with validated outcomes.
