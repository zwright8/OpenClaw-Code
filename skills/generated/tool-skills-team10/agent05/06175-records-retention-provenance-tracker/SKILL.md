---
name: records-retention-provenance-tracker
description: Use when tasks require records retention provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Provenance Tracker

## Purpose
Design and execute records retention workflows using provenance tracker controls with validated outcomes.
