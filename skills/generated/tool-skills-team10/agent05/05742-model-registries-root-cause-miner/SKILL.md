---
name: model-registries-root-cause-miner
description: Use when tasks require model registries root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Root Cause Miner

## Purpose
Design and execute model registries workflows using root cause miner controls with validated outcomes.
