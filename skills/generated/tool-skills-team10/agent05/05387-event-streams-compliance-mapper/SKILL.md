---
name: event-streams-compliance-mapper
description: Use when tasks require event streams compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Compliance Mapper

## Purpose
Design and execute event streams workflows using compliance mapper controls with validated outcomes.
