---
name: prompt-repositories-version-tracker
description: Use when tasks require prompt repositories version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Version Tracker

## Purpose
Design and execute prompt repositories workflows using version tracker controls with validated outcomes.
