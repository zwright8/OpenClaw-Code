---
name: 3d-asset-pipelines-provenance-tracker
description: Use when tasks require 3d asset pipelines provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Provenance Tracker

## Purpose
Design and execute 3d asset pipelines workflows using provenance tracker controls with validated outcomes.
