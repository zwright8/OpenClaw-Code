---
name: prompt-repositories-retry-governor
description: Use when tasks require prompt repositories retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Retry Governor

## Purpose
Design and execute prompt repositories workflows using retry governor controls with validated outcomes.
