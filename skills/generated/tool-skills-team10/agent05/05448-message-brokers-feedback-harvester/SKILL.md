---
name: message-brokers-feedback-harvester
description: Use when tasks require message brokers feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Feedback Harvester

## Purpose
Design and execute message brokers workflows using feedback harvester controls with validated outcomes.
