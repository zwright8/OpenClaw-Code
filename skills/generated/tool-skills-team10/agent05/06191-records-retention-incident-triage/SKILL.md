---
name: records-retention-incident-triage
description: Use when tasks require records retention incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Incident Triage

## Purpose
Design and execute records retention workflows using incident triage controls with validated outcomes.
