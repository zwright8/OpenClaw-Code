---
name: prompt-repositories-pii-redactor
description: Use when tasks require prompt repositories pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories PII Redactor

## Purpose
Design and execute prompt repositories workflows using pii redactor controls with validated outcomes.
