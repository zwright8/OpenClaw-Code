---
name: 3d-asset-pipelines-risk-scorer
description: Use when tasks require 3d asset pipelines risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Risk Scorer

## Purpose
Design and execute 3d asset pipelines workflows using risk scorer controls with validated outcomes.
