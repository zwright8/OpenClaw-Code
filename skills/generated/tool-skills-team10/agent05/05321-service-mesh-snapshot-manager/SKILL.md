---
name: service-mesh-snapshot-manager
description: Use when tasks require service mesh snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Snapshot Manager

## Purpose
Design and execute service mesh workflows using snapshot manager controls with validated outcomes.
