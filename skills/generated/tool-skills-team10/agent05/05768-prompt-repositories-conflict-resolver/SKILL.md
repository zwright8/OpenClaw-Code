---
name: prompt-repositories-conflict-resolver
description: Use when tasks require prompt repositories conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Conflict Resolver

## Purpose
Design and execute prompt repositories workflows using conflict resolver controls with validated outcomes.
