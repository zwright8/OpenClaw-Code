---
name: feature-stores-postmortem-drafting
description: Use when tasks require feature stores postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Postmortem Drafting

## Purpose
Design and execute feature stores workflows using postmortem drafting controls with validated outcomes.
