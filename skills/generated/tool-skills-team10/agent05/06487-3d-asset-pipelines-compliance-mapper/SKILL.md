---
name: 3d-asset-pipelines-compliance-mapper
description: Use when tasks require 3d asset pipelines compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Compliance Mapper

## Purpose
Design and execute 3d asset pipelines workflows using compliance mapper controls with validated outcomes.
