---
name: release-orchestration-capacity-planner
description: Use when tasks require release orchestration capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Capacity Planner

## Purpose
Design and execute release orchestration workflows using capacity planner controls with validated outcomes.
