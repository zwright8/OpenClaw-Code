---
name: image-annotation-sla-enforcer
description: Use when tasks require image annotation sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation SLA Enforcer

## Purpose
Design and execute image annotation workflows using sla enforcer controls with validated outcomes.
