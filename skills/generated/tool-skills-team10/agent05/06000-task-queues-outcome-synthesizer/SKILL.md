---
name: task-queues-outcome-synthesizer
description: Use when tasks require task queues outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Outcome Synthesizer

## Purpose
Design and execute task queues workflows using outcome synthesizer controls with validated outcomes.
