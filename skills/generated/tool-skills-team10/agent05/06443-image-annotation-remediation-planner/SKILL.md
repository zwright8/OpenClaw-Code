---
name: image-annotation-remediation-planner
description: Use when tasks require image annotation remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Remediation Planner

## Purpose
Design and execute image annotation workflows using remediation planner controls with validated outcomes.
