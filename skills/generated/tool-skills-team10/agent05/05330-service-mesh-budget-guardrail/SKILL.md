---
name: service-mesh-budget-guardrail
description: Use when tasks require service mesh budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Budget Guardrail

## Purpose
Design and execute service mesh workflows using budget guardrail controls with validated outcomes.
