---
name: metadata-stores-migration-planner
description: Use when tasks require metadata stores migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Migration Planner

## Purpose
Design and execute metadata stores workflows using migration planner controls with validated outcomes.
