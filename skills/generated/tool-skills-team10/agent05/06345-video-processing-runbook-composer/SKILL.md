---
name: video-processing-runbook-composer
description: Use when tasks require video processing runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Runbook Composer

## Purpose
Design and execute video processing workflows using runbook composer controls with validated outcomes.
