---
name: task-queues-risk-scorer
description: Use when tasks require task queues risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Risk Scorer

## Purpose
Design and execute task queues workflows using risk scorer controls with validated outcomes.
