---
name: agent-registries-feedback-harvester
description: Use when tasks require agent registries feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Feedback Harvester

## Purpose
Design and execute agent registries workflows using feedback harvester controls with validated outcomes.
