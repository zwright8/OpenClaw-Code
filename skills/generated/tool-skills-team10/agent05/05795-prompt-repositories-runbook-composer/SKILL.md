---
name: prompt-repositories-runbook-composer
description: Use when tasks require prompt repositories runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Runbook Composer

## Purpose
Design and execute prompt repositories workflows using runbook composer controls with validated outcomes.
