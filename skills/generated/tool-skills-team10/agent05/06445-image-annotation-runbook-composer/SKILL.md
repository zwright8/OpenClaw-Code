---
name: image-annotation-runbook-composer
description: Use when tasks require image annotation runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Runbook Composer

## Purpose
Design and execute image annotation workflows using runbook composer controls with validated outcomes.
