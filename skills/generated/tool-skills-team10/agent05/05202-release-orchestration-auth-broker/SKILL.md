---
name: release-orchestration-auth-broker
description: Use when tasks require release orchestration auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Auth Broker

## Purpose
Design and execute release orchestration workflows using auth broker controls with validated outcomes.
