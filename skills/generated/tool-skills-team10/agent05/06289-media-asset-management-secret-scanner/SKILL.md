---
name: media-asset-management-secret-scanner
description: Use when tasks require media asset management secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Secret Scanner

## Purpose
Design and execute media asset management workflows using secret scanner controls with validated outcomes.
