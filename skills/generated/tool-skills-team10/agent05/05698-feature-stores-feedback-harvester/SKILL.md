---
name: feature-stores-feedback-harvester
description: Use when tasks require feature stores feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Feedback Harvester

## Purpose
Design and execute feature stores workflows using feedback harvester controls with validated outcomes.
