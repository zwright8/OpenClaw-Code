---
name: model-registries-feedback-harvester
description: Use when tasks require model registries feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Feedback Harvester

## Purpose
Design and execute model registries workflows using feedback harvester controls with validated outcomes.
