---
name: document-ocr-runbook-composer
description: Use when tasks require document ocr runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Runbook Composer

## Purpose
Design and execute document ocr workflows using runbook composer controls with validated outcomes.
