---
name: model-registries-remediation-planner
description: Use when tasks require model registries remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Remediation Planner

## Purpose
Design and execute model registries workflows using remediation planner controls with validated outcomes.
