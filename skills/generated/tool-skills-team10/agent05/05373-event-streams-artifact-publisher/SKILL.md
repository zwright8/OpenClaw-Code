---
name: event-streams-artifact-publisher
description: Use when tasks require event streams artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Artifact Publisher

## Purpose
Design and execute event streams workflows using artifact publisher controls with validated outcomes.
