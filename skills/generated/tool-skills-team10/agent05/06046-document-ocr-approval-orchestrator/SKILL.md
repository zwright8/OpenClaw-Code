---
name: document-ocr-approval-orchestrator
description: Use when tasks require document ocr approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Approval Orchestrator

## Purpose
Design and execute document ocr workflows using approval orchestrator controls with validated outcomes.
