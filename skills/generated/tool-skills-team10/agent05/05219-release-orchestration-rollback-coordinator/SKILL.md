---
name: release-orchestration-rollback-coordinator
description: Use when tasks require release orchestration rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Rollback Coordinator

## Purpose
Design and execute release orchestration workflows using rollback coordinator controls with validated outcomes.
