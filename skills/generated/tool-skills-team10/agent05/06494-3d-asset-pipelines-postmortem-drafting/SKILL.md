---
name: 3d-asset-pipelines-postmortem-drafting
description: Use when tasks require 3d asset pipelines postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Postmortem Drafting

## Purpose
Design and execute 3d asset pipelines workflows using postmortem drafting controls with validated outcomes.
