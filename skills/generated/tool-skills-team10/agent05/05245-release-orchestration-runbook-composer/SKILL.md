---
name: release-orchestration-runbook-composer
description: Use when tasks require release orchestration runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Runbook Composer

## Purpose
Design and execute release orchestration workflows using runbook composer controls with validated outcomes.
