---
name: release-orchestration-snapshot-manager
description: Use when tasks require release orchestration snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Snapshot Manager

## Purpose
Design and execute release orchestration workflows using snapshot manager controls with validated outcomes.
