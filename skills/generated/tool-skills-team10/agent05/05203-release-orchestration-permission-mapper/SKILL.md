---
name: release-orchestration-permission-mapper
description: Use when tasks require release orchestration permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Permission Mapper

## Purpose
Design and execute release orchestration workflows using permission mapper controls with validated outcomes.
