---
name: task-queues-quality-gatekeeper
description: Use when tasks require task queues quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Quality Gatekeeper

## Purpose
Design and execute task queues workflows using quality gatekeeper controls with validated outcomes.
