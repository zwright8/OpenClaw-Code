---
name: metadata-stores-operation-planner
description: Use when tasks require metadata stores operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Operation Planner

## Purpose
Design and execute metadata stores workflows using operation planner controls with validated outcomes.
