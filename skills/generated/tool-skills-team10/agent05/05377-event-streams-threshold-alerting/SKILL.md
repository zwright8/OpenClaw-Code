---
name: event-streams-threshold-alerting
description: Use when tasks require event streams threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Threshold Alerting

## Purpose
Design and execute event streams workflows using threshold alerting controls with validated outcomes.
