---
name: model-registries-migration-planner
description: Use when tasks require model registries migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Migration Planner

## Purpose
Design and execute model registries workflows using migration planner controls with validated outcomes.
