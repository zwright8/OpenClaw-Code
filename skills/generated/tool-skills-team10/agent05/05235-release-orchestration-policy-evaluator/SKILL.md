---
name: release-orchestration-policy-evaluator
description: Use when tasks require release orchestration policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Policy Evaluator

## Purpose
Design and execute release orchestration workflows using policy evaluator controls with validated outcomes.
