---
name: model-registries-anomaly-detector
description: Use when tasks require model registries anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Anomaly Detector

## Purpose
Design and execute model registries workflows using anomaly detector controls with validated outcomes.
