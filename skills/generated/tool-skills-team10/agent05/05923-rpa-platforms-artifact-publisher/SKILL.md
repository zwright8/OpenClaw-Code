---
name: rpa-platforms-artifact-publisher
description: Use when tasks require rpa platforms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Artifact Publisher

## Purpose
Design and execute rpa platforms workflows using artifact publisher controls with validated outcomes.
