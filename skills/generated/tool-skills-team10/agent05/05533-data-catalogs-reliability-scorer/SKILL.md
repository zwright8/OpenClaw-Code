---
name: data-catalogs-reliability-scorer
description: Use when tasks require data catalogs reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Reliability Scorer

## Purpose
Design and execute data catalogs workflows using reliability scorer controls with validated outcomes.
