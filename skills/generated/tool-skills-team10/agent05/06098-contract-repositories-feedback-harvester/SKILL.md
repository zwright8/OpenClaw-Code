---
name: contract-repositories-feedback-harvester
description: Use when tasks require contract repositories feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Feedback Harvester

## Purpose
Design and execute contract repositories workflows using feedback harvester controls with validated outcomes.
