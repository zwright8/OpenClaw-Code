---
name: agent-registries-provenance-tracker
description: Use when tasks require agent registries provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Provenance Tracker

## Purpose
Design and execute agent registries workflows using provenance tracker controls with validated outcomes.
