---
name: rpa-platforms-dependency-resolver
description: Use when tasks require rpa platforms dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Dependency Resolver

## Purpose
Design and execute rpa platforms workflows using dependency resolver controls with validated outcomes.
