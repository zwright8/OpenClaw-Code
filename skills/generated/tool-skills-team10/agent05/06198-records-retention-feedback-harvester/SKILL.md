---
name: records-retention-feedback-harvester
description: Use when tasks require records retention feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Feedback Harvester

## Purpose
Design and execute records retention workflows using feedback harvester controls with validated outcomes.
