---
name: message-brokers-human-handoff-router
description: Use when tasks require message brokers human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Human Handoff Router

## Purpose
Design and execute message brokers workflows using human handoff router controls with validated outcomes.
