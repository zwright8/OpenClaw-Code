---
name: workflow-engines-quality-gatekeeper
description: Use when tasks require workflow engines quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Quality Gatekeeper

## Purpose
Design and execute workflow engines workflows using quality gatekeeper controls with validated outcomes.
