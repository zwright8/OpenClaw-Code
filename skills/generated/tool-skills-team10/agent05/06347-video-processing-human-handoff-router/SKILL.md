---
name: video-processing-human-handoff-router
description: Use when tasks require video processing human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Human Handoff Router

## Purpose
Design and execute video processing workflows using human handoff router controls with validated outcomes.
