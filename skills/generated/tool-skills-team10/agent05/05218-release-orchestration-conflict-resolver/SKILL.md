---
name: release-orchestration-conflict-resolver
description: Use when tasks require release orchestration conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Conflict Resolver

## Purpose
Design and execute release orchestration workflows using conflict resolver controls with validated outcomes.
