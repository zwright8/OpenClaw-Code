---
name: archive-systems-secret-scanner
description: Use when tasks require archive systems secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Archive Systems Secret Scanner

## Purpose
Design and execute archive systems workflows using secret scanner controls with validated outcomes.
