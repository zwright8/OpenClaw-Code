---
name: event-streams-provenance-tracker
description: Use when tasks require event streams provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Provenance Tracker

## Purpose
Design and execute event streams workflows using provenance tracker controls with validated outcomes.
