---
name: document-ocr-dependency-resolver
description: Use when tasks require document ocr dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Dependency Resolver

## Purpose
Design and execute document ocr workflows using dependency resolver controls with validated outcomes.
