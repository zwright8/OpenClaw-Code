---
name: service-mesh-root-cause-miner
description: Use when tasks require service mesh root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Root Cause Miner

## Purpose
Design and execute service mesh workflows using root cause miner controls with validated outcomes.
