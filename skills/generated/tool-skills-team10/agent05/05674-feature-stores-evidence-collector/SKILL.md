---
name: feature-stores-evidence-collector
description: Use when tasks require feature stores evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Evidence Collector

## Purpose
Design and execute feature stores workflows using evidence collector controls with validated outcomes.
