---
name: message-brokers-policy-evaluator
description: Use when tasks require message brokers policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Policy Evaluator

## Purpose
Design and execute message brokers workflows using policy evaluator controls with validated outcomes.
