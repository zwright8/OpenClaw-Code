---
name: service-mesh-secret-scanner
description: Use when tasks require service mesh secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Secret Scanner

## Purpose
Design and execute service mesh workflows using secret scanner controls with validated outcomes.
