---
name: rpa-platforms-risk-scorer
description: Use when tasks require rpa platforms risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Risk Scorer

## Purpose
Design and execute rpa platforms workflows using risk scorer controls with validated outcomes.
