---
name: document-ocr-quality-gatekeeper
description: Use when tasks require document ocr quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Quality Gatekeeper

## Purpose
Design and execute document ocr workflows using quality gatekeeper controls with validated outcomes.
