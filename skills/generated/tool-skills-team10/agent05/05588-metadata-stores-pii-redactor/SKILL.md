---
name: metadata-stores-pii-redactor
description: Use when tasks require metadata stores pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores PII Redactor

## Purpose
Design and execute metadata stores workflows using pii redactor controls with validated outcomes.
