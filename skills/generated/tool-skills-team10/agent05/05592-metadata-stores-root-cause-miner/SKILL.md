---
name: metadata-stores-root-cause-miner
description: Use when tasks require metadata stores root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Root Cause Miner

## Purpose
Design and execute metadata stores workflows using root cause miner controls with validated outcomes.
