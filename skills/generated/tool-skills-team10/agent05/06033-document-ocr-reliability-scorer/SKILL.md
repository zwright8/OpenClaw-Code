---
name: document-ocr-reliability-scorer
description: Use when tasks require document ocr reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Reliability Scorer

## Purpose
Design and execute document ocr workflows using reliability scorer controls with validated outcomes.
