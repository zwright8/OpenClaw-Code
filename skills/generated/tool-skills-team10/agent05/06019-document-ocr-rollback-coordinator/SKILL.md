---
name: document-ocr-rollback-coordinator
description: Use when tasks require document ocr rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Rollback Coordinator

## Purpose
Design and execute document ocr workflows using rollback coordinator controls with validated outcomes.
