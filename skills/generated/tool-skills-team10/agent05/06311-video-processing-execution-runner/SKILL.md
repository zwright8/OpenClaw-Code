---
name: video-processing-execution-runner
description: Use when tasks require video processing execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Execution Runner

## Purpose
Design and execute video processing workflows using execution runner controls with validated outcomes.
