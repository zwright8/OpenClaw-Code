---
name: metadata-stores-secret-scanner
description: Use when tasks require metadata stores secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Secret Scanner

## Purpose
Design and execute metadata stores workflows using secret scanner controls with validated outcomes.
