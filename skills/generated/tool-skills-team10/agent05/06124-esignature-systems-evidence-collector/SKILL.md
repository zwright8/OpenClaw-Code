---
name: esignature-systems-evidence-collector
description: Use when tasks require esignature systems evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# eSignature Systems Evidence Collector

## Purpose
Design and execute esignature systems workflows using evidence collector controls with validated outcomes.
