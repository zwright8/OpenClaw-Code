---
name: prompt-repositories-human-handoff-router
description: Use when tasks require prompt repositories human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Human Handoff Router

## Purpose
Design and execute prompt repositories workflows using human handoff router controls with validated outcomes.
