---
name: image-annotation-task-decomposer
description: Use when tasks require image annotation task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Task Decomposer

## Purpose
Design and execute image annotation workflows using task decomposer controls with validated outcomes.
