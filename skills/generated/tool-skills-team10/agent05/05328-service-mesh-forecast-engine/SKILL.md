---
name: service-mesh-forecast-engine
description: Use when tasks require service mesh forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Forecast Engine

## Purpose
Design and execute service mesh workflows using forecast engine controls with validated outcomes.
