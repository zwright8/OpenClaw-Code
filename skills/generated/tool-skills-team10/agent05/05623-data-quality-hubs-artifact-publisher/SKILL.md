---
name: data-quality-hubs-artifact-publisher
description: Use when tasks require data quality hubs artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Quality Hubs Artifact Publisher

## Purpose
Design and execute data quality hubs workflows using artifact publisher controls with validated outcomes.
