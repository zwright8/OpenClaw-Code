...
description: Use when tasks require metadata stores approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Approval Orchestrator

## Purpose
Design and execute metadata stores workflows using approval orchestrator controls with validated outcomes.
