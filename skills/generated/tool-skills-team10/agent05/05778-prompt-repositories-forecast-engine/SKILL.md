---
name: prompt-repositories-forecast-engine
description: Use when tasks require prompt repositories forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Forecast Engine

## Purpose
Design and execute prompt repositories workflows using forecast engine controls with validated outcomes.
