---
name: archive-systems-artifact-publisher
description: Use when tasks require archive systems artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Archive Systems Artifact Publisher

## Purpose
Design and execute archive systems workflows using artifact publisher controls with validated outcomes.
