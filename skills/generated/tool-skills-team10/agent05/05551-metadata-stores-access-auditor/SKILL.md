---
name: metadata-stores-access-auditor
description: Use when tasks require metadata stores access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Access Auditor

## Purpose
Design and execute metadata stores workflows using access auditor controls with validated outcomes.
