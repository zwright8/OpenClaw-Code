---
name: archive-systems-dependency-resolver
description: Use when tasks require archive systems dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Archive Systems Dependency Resolver

## Purpose
Design and execute archive systems workflows using dependency resolver controls with validated outcomes.
