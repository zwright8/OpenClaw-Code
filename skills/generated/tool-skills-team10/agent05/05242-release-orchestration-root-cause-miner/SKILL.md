---
name: release-orchestration-root-cause-miner
description: Use when tasks require release orchestration root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Root Cause Miner

## Purpose
Design and execute release orchestration workflows using root cause miner controls with validated outcomes.
