---
name: contract-repositories-spec-drift-detector
description: Use when tasks require contract repositories spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Spec Drift Detector

## Purpose
Design and execute contract repositories workflows using spec drift detector controls with validated outcomes.
