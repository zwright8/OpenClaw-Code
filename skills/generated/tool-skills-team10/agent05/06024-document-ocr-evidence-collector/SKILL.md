---
name: document-ocr-evidence-collector
description: Use when tasks require document ocr evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Evidence Collector

## Purpose
Design and execute document ocr workflows using evidence collector controls with validated outcomes.
