---
name: message-brokers-evidence-collector
description: Use when tasks require message brokers evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Evidence Collector

## Purpose
Design and execute message brokers workflows using evidence collector controls with validated outcomes.
