---
name: video-processing-forecast-engine
description: Use when tasks require video processing forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Forecast Engine

## Purpose
Design and execute video processing workflows using forecast engine controls with validated outcomes.
