---
name: document-ocr-root-cause-miner
description: Use when tasks require document ocr root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Root Cause Miner

## Purpose
Design and execute document ocr workflows using root cause miner controls with validated outcomes.
