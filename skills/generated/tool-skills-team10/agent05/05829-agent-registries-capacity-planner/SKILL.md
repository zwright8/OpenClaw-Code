---
name: agent-registries-capacity-planner
description: Use when tasks require agent registries capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Capacity Planner

## Purpose
Design and execute agent registries workflows using capacity planner controls with validated outcomes.
