---
name: release-orchestration-reliability-scorer
description: Use when tasks require release orchestration reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Reliability Scorer

## Purpose
Design and execute release orchestration workflows using reliability scorer controls with validated outcomes.
