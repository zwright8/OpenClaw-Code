---
name: feature-stores-snapshot-manager
description: Use when tasks require feature stores snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Snapshot Manager

## Purpose
Design and execute feature stores workflows using snapshot manager controls with validated outcomes.
