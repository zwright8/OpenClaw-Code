---
name: metadata-stores-dependency-resolver
description: Use when tasks require metadata stores dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Dependency Resolver

## Purpose
Design and execute metadata stores workflows using dependency resolver controls with validated outcomes.
