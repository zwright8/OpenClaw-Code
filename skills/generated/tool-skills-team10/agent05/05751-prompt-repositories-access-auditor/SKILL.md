---
name: prompt-repositories-access-auditor
description: Use when tasks require prompt repositories access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Access Auditor

## Purpose
Design and execute prompt repositories workflows using access auditor controls with validated outcomes.
