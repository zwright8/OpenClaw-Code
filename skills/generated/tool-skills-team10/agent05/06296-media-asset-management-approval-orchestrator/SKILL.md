---
name: media-asset-management-approval-orchestrator
description: Use when tasks require media asset management approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Approval Orchestrator

## Purpose
Design and execute media asset management workflows using approval orchestrator controls with validated outcomes.
