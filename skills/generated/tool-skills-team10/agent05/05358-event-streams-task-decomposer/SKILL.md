---
name: event-streams-task-decomposer
description: Use when tasks require event streams task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Task Decomposer

## Purpose
Design and execute event streams workflows using task decomposer controls with validated outcomes.
