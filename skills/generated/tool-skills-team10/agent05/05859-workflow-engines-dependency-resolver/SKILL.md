---
name: workflow-engines-dependency-resolver
description: Use when tasks require workflow engines dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Dependency Resolver

## Purpose
Design and execute workflow engines workflows using dependency resolver controls with validated outcomes.
