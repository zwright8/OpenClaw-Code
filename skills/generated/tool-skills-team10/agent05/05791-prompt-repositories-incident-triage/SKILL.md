---
name: prompt-repositories-incident-triage
description: Use when tasks require prompt repositories incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Incident Triage

## Purpose
Design and execute prompt repositories workflows using incident triage controls with validated outcomes.
