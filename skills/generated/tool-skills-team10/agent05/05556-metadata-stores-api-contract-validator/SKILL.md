---
name: metadata-stores-api-contract-validator
description: Use when tasks require metadata stores api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores API Contract Validator

## Purpose
Design and execute metadata stores workflows using api contract validator controls with validated outcomes.
