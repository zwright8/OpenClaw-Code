---
name: 3d-asset-pipelines-quality-gatekeeper
description: Use when tasks require 3d asset pipelines quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Quality Gatekeeper

## Purpose
Design and execute 3d asset pipelines workflows using quality gatekeeper controls with validated outcomes.
