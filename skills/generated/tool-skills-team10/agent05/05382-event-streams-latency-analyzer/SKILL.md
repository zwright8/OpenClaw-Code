---
name: event-streams-latency-analyzer
description: Use when tasks require event streams latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Latency Analyzer

## Purpose
Design and execute event streams workflows using latency analyzer controls with validated outcomes.
