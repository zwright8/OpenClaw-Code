---
name: records-retention-cost-attribution
description: Use when tasks require records retention cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Cost Attribution

## Purpose
Design and execute records retention workflows using cost attribution controls with validated outcomes.
