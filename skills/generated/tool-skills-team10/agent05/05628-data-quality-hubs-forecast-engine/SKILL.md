---
name: data-quality-hubs-forecast-engine
description: Use when tasks require data quality hubs forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Quality Hubs Forecast Engine

## Purpose
Design and execute data quality hubs workflows using forecast engine controls with validated outcomes.
