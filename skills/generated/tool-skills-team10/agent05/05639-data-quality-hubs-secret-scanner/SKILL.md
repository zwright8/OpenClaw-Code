---
name: data-quality-hubs-secret-scanner
description: Use when tasks require data quality hubs secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Quality Hubs Secret Scanner

## Purpose
Design and execute data quality hubs workflows using secret scanner controls with validated outcomes.
