---
name: metadata-stores-policy-evaluator
description: Use when tasks require metadata stores policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Policy Evaluator

## Purpose
Design and execute metadata stores workflows using policy evaluator controls with validated outcomes.
