---
name: rpa-platforms-permission-mapper
description: Use when tasks require rpa platforms permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Permission Mapper

## Purpose
Design and execute rpa platforms workflows using permission mapper controls with validated outcomes.
