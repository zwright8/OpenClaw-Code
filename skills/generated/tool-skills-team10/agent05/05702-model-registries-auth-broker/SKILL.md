---
name: model-registries-auth-broker
description: Use when tasks require model registries auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Auth Broker

## Purpose
Design and execute model registries workflows using auth broker controls with validated outcomes.
