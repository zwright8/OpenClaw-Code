---
name: media-asset-management-root-cause-miner
description: Use when tasks require media asset management root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Root Cause Miner

## Purpose
Design and execute media asset management workflows using root cause miner controls with validated outcomes.
