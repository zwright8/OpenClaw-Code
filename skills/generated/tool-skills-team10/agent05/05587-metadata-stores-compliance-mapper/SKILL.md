---
name: metadata-stores-compliance-mapper
description: Use when tasks require metadata stores compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Compliance Mapper

## Purpose
Design and execute metadata stores workflows using compliance mapper controls with validated outcomes.
