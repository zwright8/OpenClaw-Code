---
name: records-retention-spec-drift-detector
description: Use when tasks require records retention spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Spec Drift Detector

## Purpose
Design and execute records retention workflows using spec drift detector controls with validated outcomes.
