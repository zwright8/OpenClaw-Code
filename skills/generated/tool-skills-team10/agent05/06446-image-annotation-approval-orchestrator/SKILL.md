---
name: image-annotation-approval-orchestrator
description: Use when tasks require image annotation approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Approval Orchestrator

## Purpose
Design and execute image annotation workflows using approval orchestrator controls with validated outcomes.
