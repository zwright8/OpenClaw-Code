---
name: prompt-repositories-budget-guardrail
description: Use when tasks require prompt repositories budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Budget Guardrail

## Purpose
Design and execute prompt repositories workflows using budget guardrail controls with validated outcomes.
