---
name: prompt-repositories-quality-gatekeeper
description: Use when tasks require prompt repositories quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Quality Gatekeeper

## Purpose
Design and execute prompt repositories workflows using quality gatekeeper controls with validated outcomes.
