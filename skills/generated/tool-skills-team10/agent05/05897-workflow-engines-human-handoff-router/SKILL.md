---
name: workflow-engines-human-handoff-router
description: Use when tasks require workflow engines human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Human Handoff Router

## Purpose
Design and execute workflow engines workflows using human handoff router controls with validated outcomes.
