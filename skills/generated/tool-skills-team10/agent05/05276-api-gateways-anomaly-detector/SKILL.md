---
name: api-gateways-anomaly-detector
description: Use when tasks require api gateways anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Anomaly Detector

## Purpose
Design and execute api gateways workflows using anomaly detector controls with validated outcomes.
