---
name: prompt-repositories-execution-runner
description: Use when tasks require prompt repositories execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Execution Runner

## Purpose
Design and execute prompt repositories workflows using execution runner controls with validated outcomes.
