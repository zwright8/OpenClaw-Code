---
name: task-queues-capacity-planner
description: Use when tasks require task queues capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Capacity Planner

## Purpose
Design and execute task queues workflows using capacity planner controls with validated outcomes.
