---
name: data-catalogs-risk-scorer
description: Use when tasks require data catalogs risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Risk Scorer

## Purpose
Design and execute data catalogs workflows using risk scorer controls with validated outcomes.
