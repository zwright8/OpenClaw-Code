---
name: agent-registries-workflow-compiler
description: Use when tasks require agent registries workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Workflow Compiler

## Purpose
Design and execute agent registries workflows using workflow compiler controls with validated outcomes.
