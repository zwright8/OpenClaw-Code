---
name: agent-registries-root-cause-miner
description: Use when tasks require agent registries root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Root Cause Miner

## Purpose
Design and execute agent registries workflows using root cause miner controls with validated outcomes.
