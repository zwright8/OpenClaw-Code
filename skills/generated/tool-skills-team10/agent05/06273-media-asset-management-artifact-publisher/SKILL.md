---
name: media-asset-management-artifact-publisher
description: Use when tasks require media asset management artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Artifact Publisher

## Purpose
Design and execute media asset management workflows using artifact publisher controls with validated outcomes.
