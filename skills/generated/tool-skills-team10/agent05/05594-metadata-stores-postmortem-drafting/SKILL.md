---
name: metadata-stores-postmortem-drafting
description: Use when tasks require metadata stores postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Postmortem Drafting

## Purpose
Design and execute metadata stores workflows using postmortem drafting controls with validated outcomes.
