---
name: api-gateways-access-auditor
description: Use when tasks require api gateways access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Access Auditor

## Purpose
Design and execute api gateways workflows using access auditor controls with validated outcomes.
