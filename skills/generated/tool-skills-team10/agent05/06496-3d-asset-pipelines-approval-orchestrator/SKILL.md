---
name: 3d-asset-pipelines-approval-orchestrator
description: Use when tasks require 3d asset pipelines approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Approval Orchestrator

## Purpose
Design and execute 3d asset pipelines workflows using approval orchestrator controls with validated outcomes.
