---
name: image-annotation-operation-planner
description: Use when tasks require image annotation operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Operation Planner

## Purpose
Design and execute image annotation workflows using operation planner controls with validated outcomes.
