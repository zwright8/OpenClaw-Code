---
name: image-annotation-rollback-coordinator
description: Use when tasks require image annotation rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Rollback Coordinator

## Purpose
Design and execute image annotation workflows using rollback coordinator controls with validated outcomes.
