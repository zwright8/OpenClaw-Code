---
name: feature-stores-spec-drift-detector
description: Use when tasks require feature stores spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Spec Drift Detector

## Purpose
Design and execute feature stores workflows using spec drift detector controls with validated outcomes.
