---
name: prompt-repositories-api-contract-validator
description: Use when tasks require prompt repositories api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories API Contract Validator

## Purpose
Design and execute prompt repositories workflows using api contract validator controls with validated outcomes.

## Precision Profile
- Domain: Prompt Repositories
...
- Domain: [Prompt Repositories](../../resources/domains/prompt-repositories.md)
