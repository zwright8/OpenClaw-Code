---
name: records-retention-runbook-composer
description: Use when tasks require records retention runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Runbook Composer

## Purpose
Design and execute records retention workflows using runbook composer controls with validated outcomes.
