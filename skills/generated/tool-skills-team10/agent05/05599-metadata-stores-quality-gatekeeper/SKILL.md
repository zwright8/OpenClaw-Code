---
name: metadata-stores-quality-gatekeeper
description: Use when tasks require metadata stores quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Quality Gatekeeper

## Purpose
Design and execute metadata stores workflows using quality gatekeeper controls with validated outcomes.
