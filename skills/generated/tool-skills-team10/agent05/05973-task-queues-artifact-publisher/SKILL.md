---
name: task-queues-artifact-publisher
description: Use when tasks require task queues artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Artifact Publisher

## Purpose
Design and execute task queues workflows using artifact publisher controls with validated outcomes.
