---
name: image-annotation-rate-limit-optimizer
description: Use when tasks require image annotation rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Rate Limit Optimizer

## Purpose
Design and execute image annotation workflows using rate limit optimizer controls with validated outcomes.
