---
name: event-streams-migration-planner
description: Use when tasks require event streams migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Migration Planner

## Purpose
Design and execute event streams workflows using migration planner controls with validated outcomes.
