---
name: audio-pipelines-retry-governor
description: Use when tasks require audio pipelines retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audio Pipelines Retry Governor

## Purpose
Design and execute audio pipelines workflows using retry governor controls with validated outcomes.
