---
name: agent-registries-auth-broker
description: Use when tasks require agent registries auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Auth Broker

## Purpose
Design and execute agent registries workflows using auth broker controls with validated outcomes.
