---
name: service-mesh-dependency-resolver
description: Use when tasks require service mesh dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Dependency Resolver

## Purpose
Design and execute service mesh workflows using dependency resolver controls with validated outcomes.
