---
name: records-retention-capacity-planner
description: Use when tasks require records retention capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Capacity Planner

## Purpose
Design and execute records retention workflows using capacity planner controls with validated outcomes.
