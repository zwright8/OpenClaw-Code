---
name: etl-orchestrators-secret-scanner
description: Use when tasks require etl orchestrators secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# ETL Orchestrators Secret Scanner

## Purpose
Design and execute etl orchestrators workflows using secret scanner controls with validated outcomes.
