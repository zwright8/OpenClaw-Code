---
name: service-mesh-artifact-publisher
description: Use when tasks require service mesh artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Artifact Publisher

## Purpose
Design and execute service mesh workflows using artifact publisher controls with validated outcomes.
