---
name: image-annotation-forecast-engine
description: Use when tasks require image annotation forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Forecast Engine

## Purpose
Design and execute image annotation workflows using forecast engine controls with validated outcomes.
