---
name: media-asset-management-risk-scorer
description: Use when tasks require media asset management risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Risk Scorer

## Purpose
Design and execute media asset management workflows using risk scorer controls with validated outcomes.
