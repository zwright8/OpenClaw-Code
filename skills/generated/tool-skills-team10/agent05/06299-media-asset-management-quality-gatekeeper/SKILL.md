---
name: media-asset-management-quality-gatekeeper
description: Use when tasks require media asset management quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Quality Gatekeeper

## Purpose
Design and execute media asset management workflows using quality gatekeeper controls with validated outcomes.
