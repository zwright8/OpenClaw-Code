---
name: document-ocr-auth-broker
description: Use when tasks require document ocr auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Auth Broker

## Purpose
Design and execute document ocr workflows using auth broker controls with validated outcomes.
