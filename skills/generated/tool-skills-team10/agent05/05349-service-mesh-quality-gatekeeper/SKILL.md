---
name: service-mesh-quality-gatekeeper
description: Use when tasks require service mesh quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Quality Gatekeeper

## Purpose
Design and execute service mesh workflows using quality gatekeeper controls with validated outcomes.
