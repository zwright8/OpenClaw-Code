---
name: feature-stores-execution-runner
description: Use when tasks require feature stores execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Execution Runner

## Purpose
Design and execute feature stores workflows using execution runner controls with validated outcomes.
