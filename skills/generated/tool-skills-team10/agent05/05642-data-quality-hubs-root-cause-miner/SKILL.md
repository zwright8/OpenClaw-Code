---
name: data-quality-hubs-root-cause-miner
description: Use when tasks require data quality hubs root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Quality Hubs Root Cause Miner

## Purpose
Design and execute data quality hubs workflows using root cause miner controls with validated outcomes.
