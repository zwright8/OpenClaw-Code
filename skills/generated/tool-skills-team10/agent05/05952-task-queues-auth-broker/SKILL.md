---
name: task-queues-auth-broker
description: Use when tasks require task queues auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Auth Broker

## Purpose
Design and execute task queues workflows using auth broker controls with validated outcomes.
