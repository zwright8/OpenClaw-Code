---
name: prompt-repositories-postmortem-drafting
description: Use when tasks require prompt repositories postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Postmortem Drafting

## Purpose
Design and execute prompt repositories workflows using postmortem drafting controls with validated outcomes.
