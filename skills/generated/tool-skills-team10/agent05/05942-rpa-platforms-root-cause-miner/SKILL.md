---
name: rpa-platforms-root-cause-miner
description: Use when tasks require rpa platforms root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Root Cause Miner

## Purpose
Design and execute rpa platforms workflows using root cause miner controls with validated outcomes.
