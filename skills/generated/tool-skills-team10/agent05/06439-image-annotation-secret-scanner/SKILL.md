---
name: image-annotation-secret-scanner
description: Use when tasks require image annotation secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Secret Scanner

## Purpose
Design and execute image annotation workflows using secret scanner controls with validated outcomes.
