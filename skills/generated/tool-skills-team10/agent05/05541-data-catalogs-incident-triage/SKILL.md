---
name: data-catalogs-incident-triage
description: Use when tasks require data catalogs incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Incident Triage

## Purpose
Design and execute data catalogs workflows using incident triage controls with validated outcomes.
