---
name: feature-stores-secret-scanner
description: Use when tasks require feature stores secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Secret Scanner

## Purpose
Design and execute feature stores workflows using secret scanner controls with validated outcomes.
