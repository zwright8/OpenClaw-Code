---
name: contract-repositories-human-handoff-router
description: Use when tasks require contract repositories human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Human Handoff Router

## Purpose
Design and execute contract repositories workflows using human handoff router controls with validated outcomes.
