---
name: document-ocr-execution-runner
description: Use when tasks require document ocr execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Execution Runner

## Purpose
Design and execute document ocr workflows using execution runner controls with validated outcomes.
