---
name: release-orchestration-delta-calculator
description: Use when tasks require release orchestration delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Delta Calculator

## Purpose
Design and execute release orchestration workflows using delta calculator controls with validated outcomes.
