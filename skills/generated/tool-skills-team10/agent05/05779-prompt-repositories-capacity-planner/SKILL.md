---
name: prompt-repositories-capacity-planner
description: Use when tasks require prompt repositories capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Capacity Planner

## Purpose
Design and execute prompt repositories workflows using capacity planner controls with validated outcomes.
