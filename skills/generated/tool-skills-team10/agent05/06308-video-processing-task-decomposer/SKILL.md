---
name: video-processing-task-decomposer
description: Use when tasks require video processing task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Task Decomposer

## Purpose
Design and execute video processing workflows using task decomposer controls with validated outcomes.
