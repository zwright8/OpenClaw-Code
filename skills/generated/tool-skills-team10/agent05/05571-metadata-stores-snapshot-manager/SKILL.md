---
name: metadata-stores-snapshot-manager
description: Use when tasks require metadata stores snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Snapshot Manager

## Purpose
Design and execute metadata stores workflows using snapshot manager controls with validated outcomes.
