---
name: service-mesh-auth-broker
description: Use when tasks require service mesh auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Auth Broker

## Purpose
Design and execute service mesh workflows using auth broker controls with validated outcomes.
