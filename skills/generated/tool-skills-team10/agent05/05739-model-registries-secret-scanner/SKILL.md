---
name: model-registries-secret-scanner
description: Use when tasks require model registries secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Secret Scanner

## Purpose
Design and execute model registries workflows using secret scanner controls with validated outcomes.
