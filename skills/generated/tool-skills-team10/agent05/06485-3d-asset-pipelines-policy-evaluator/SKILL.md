---
name: 3d-asset-pipelines-policy-evaluator
description: Use when tasks require 3d asset pipelines policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Policy Evaluator

## Purpose
Design and execute 3d asset pipelines workflows using policy evaluator controls with validated outcomes.
