---
name: document-ocr-incident-triage
description: Use when tasks require document ocr incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Incident Triage

## Purpose
Design and execute document ocr workflows using incident triage controls with validated outcomes.
