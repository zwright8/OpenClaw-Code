---
name: service-mesh-execution-runner
description: Use when tasks require service mesh execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Execution Runner

## Purpose
Design and execute service mesh workflows using execution runner controls with validated outcomes.
