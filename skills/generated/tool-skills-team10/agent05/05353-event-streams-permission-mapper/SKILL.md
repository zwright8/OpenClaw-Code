---
name: event-streams-permission-mapper
description: Use when tasks require event streams permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Permission Mapper

## Purpose
Design and execute event streams workflows using permission mapper controls with validated outcomes.
