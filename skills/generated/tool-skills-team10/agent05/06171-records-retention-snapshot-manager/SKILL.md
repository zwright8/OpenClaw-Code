---
name: records-retention-snapshot-manager
description: Use when tasks require records retention snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Snapshot Manager

## Purpose
Design and execute records retention workflows using snapshot manager controls with validated outcomes.
