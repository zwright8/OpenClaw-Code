---
name: rpa-platforms-auth-broker
description: Use when tasks require rpa platforms auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Auth Broker

## Purpose
Design and execute rpa platforms workflows using auth broker controls with validated outcomes.
