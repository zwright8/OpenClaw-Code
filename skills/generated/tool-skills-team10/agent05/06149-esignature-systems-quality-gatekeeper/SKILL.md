---
name: esignature-systems-quality-gatekeeper
description: Use when tasks require esignature systems quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# eSignature Systems Quality Gatekeeper

## Purpose
Design and execute esignature systems workflows using quality gatekeeper controls with validated outcomes.
