---
name: document-ocr-risk-scorer
description: Use when tasks require document ocr risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Risk Scorer

## Purpose
Design and execute document ocr workflows using risk scorer controls with validated outcomes.
