---
name: model-registries-rollback-coordinator
description: Use when tasks require model registries rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Rollback Coordinator

## Purpose
Design and execute model registries workflows using rollback coordinator controls with validated outcomes.
