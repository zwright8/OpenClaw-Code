---
name: task-queues-snapshot-manager
description: Use when tasks require task queues snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Snapshot Manager

## Purpose
Design and execute task queues workflows using snapshot manager controls with validated outcomes.
