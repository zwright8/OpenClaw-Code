---
name: media-asset-management-spec-drift-detector
description: Use when tasks require media asset management spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Spec Drift Detector

## Purpose
Design and execute media asset management workflows using spec drift detector controls with validated outcomes.
