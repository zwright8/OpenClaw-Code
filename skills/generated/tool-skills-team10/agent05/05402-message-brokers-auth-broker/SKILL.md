---
name: message-brokers-auth-broker
description: Use when tasks require message brokers auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Auth Broker

## Purpose
Design and execute message brokers workflows using auth broker controls with validated outcomes.
