---
name: data-catalogs-postmortem-drafting
description: Use when tasks require data catalogs postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Postmortem Drafting

## Purpose
Design and execute data catalogs workflows using postmortem drafting controls with validated outcomes.
