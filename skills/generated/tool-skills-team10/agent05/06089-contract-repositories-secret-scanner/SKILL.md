---
name: contract-repositories-secret-scanner
description: Use when tasks require contract repositories secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Secret Scanner

## Purpose
Design and execute contract repositories workflows using secret scanner controls with validated outcomes.
