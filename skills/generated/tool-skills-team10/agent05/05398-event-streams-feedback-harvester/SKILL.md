---
name: event-streams-feedback-harvester
description: Use when tasks require event streams feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Feedback Harvester

## Purpose
Design and execute event streams workflows using feedback harvester controls with validated outcomes.
