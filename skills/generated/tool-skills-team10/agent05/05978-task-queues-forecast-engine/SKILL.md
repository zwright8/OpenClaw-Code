---
name: task-queues-forecast-engine
description: Use when tasks require task queues forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Forecast Engine

## Purpose
Design and execute task queues workflows using forecast engine controls with validated outcomes.
