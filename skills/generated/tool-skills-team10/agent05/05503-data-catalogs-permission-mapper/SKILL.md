---
name: data-catalogs-permission-mapper
description: Use when tasks require data catalogs permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Permission Mapper

## Purpose
Design and execute data catalogs workflows using permission mapper controls with validated outcomes.
