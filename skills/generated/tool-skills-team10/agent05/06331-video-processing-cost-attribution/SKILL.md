---
name: video-processing-cost-attribution
description: Use when tasks require video processing cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Cost Attribution

## Purpose
Design and execute video processing workflows using cost attribution controls with validated outcomes.
