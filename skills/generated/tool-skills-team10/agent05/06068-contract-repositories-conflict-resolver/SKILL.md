---
name: contract-repositories-conflict-resolver
description: Use when tasks require contract repositories conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Conflict Resolver

## Purpose
Design and execute contract repositories workflows using conflict resolver controls with validated outcomes.
