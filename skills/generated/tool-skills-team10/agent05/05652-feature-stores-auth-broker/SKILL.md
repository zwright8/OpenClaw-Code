---
name: feature-stores-auth-broker
description: Use when tasks require feature stores auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Auth Broker

## Purpose
Design and execute feature stores workflows using auth broker controls with validated outcomes.
