---
name: prompt-repositories-compliance-mapper
description: Use when tasks require prompt repositories compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Compliance Mapper

## Purpose
Design and execute prompt repositories workflows using compliance mapper controls with validated outcomes.
