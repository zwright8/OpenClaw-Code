---
name: message-brokers-budget-guardrail
description: Use when tasks require message brokers budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Budget Guardrail

## Purpose
Design and execute message brokers workflows using budget guardrail controls with validated outcomes.
