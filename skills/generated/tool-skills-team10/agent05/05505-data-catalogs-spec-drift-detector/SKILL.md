---
name: data-catalogs-spec-drift-detector
description: Use when tasks require data catalogs spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Spec Drift Detector

## Purpose
Design and execute data catalogs workflows using spec drift detector controls with validated outcomes.
