---
name: metadata-stores-evidence-collector
description: Use when tasks require metadata stores evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Evidence Collector

## Purpose
Design and execute metadata stores workflows using evidence collector controls with validated outcomes.
