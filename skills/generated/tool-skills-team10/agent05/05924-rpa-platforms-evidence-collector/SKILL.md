---
name: rpa-platforms-evidence-collector
description: Use when tasks require rpa platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Evidence Collector

## Purpose
Design and execute rpa platforms workflows using evidence collector controls with validated outcomes.
