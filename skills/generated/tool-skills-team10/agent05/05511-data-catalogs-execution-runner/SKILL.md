---
name: data-catalogs-execution-runner
description: Use when tasks require data catalogs execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Execution Runner

## Purpose
Design and execute data catalogs workflows using execution runner controls with validated outcomes.
