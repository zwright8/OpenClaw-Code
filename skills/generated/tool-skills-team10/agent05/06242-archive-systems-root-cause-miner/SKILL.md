---
name: archive-systems-root-cause-miner
description: Use when tasks require archive systems root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Archive Systems Root Cause Miner

## Purpose
Design and execute archive systems workflows using root cause miner controls with validated outcomes.
