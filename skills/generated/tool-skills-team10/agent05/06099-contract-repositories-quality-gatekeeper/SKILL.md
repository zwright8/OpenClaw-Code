---
name: contract-repositories-quality-gatekeeper
description: Use when tasks require contract repositories quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Quality Gatekeeper

## Purpose
Design and execute contract repositories workflows using quality gatekeeper controls with validated outcomes.
