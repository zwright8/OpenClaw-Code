---
name: agent-registries-rate-limit-optimizer
description: Use when tasks require agent registries rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Rate Limit Optimizer

## Purpose
Design and execute agent registries workflows using rate limit optimizer controls with validated outcomes.
