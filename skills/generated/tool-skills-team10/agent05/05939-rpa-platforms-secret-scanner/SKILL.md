---
name: rpa-platforms-secret-scanner
description: Use when tasks require rpa platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Secret Scanner

## Purpose
Design and execute rpa platforms workflows using secret scanner controls with validated outcomes.
