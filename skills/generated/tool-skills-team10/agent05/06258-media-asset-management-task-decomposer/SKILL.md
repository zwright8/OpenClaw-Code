---
name: media-asset-management-task-decomposer
description: Use when tasks require media asset management task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Task Decomposer

## Purpose
Design and execute media asset management workflows using task decomposer controls with validated outcomes.
