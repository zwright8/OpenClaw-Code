---
name: message-brokers-spec-drift-detector
description: Use when tasks require message brokers spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Spec Drift Detector

## Purpose
Design and execute message brokers workflows using spec drift detector controls with validated outcomes.
