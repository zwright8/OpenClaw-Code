---
name: records-retention-forecast-engine
description: Use when tasks require records retention forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Forecast Engine

## Purpose
Design and execute records retention workflows using forecast engine controls with validated outcomes.
