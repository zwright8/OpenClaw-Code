---
name: service-mesh-access-auditor
description: Use when tasks require service mesh access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Access Auditor

## Purpose
Design and execute service mesh workflows using access auditor controls with validated outcomes.
