---
name: event-streams-runbook-composer
description: Use when tasks require event streams runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Runbook Composer

## Purpose
Design and execute event streams workflows using runbook composer controls with validated outcomes.
