---
name: media-asset-management-pii-redactor
description: Use when tasks require media asset management pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management PII Redactor

## Purpose
Design and execute media asset management workflows using pii redactor controls with validated outcomes.
