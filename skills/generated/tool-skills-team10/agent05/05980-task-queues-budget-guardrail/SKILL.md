---
name: task-queues-budget-guardrail
description: Use when tasks require task queues budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Budget Guardrail

## Purpose
Design and execute task queues workflows using budget guardrail controls with validated outcomes.
