---
name: image-annotation-dependency-resolver
description: Use when tasks require image annotation dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Dependency Resolver

## Purpose
Design and execute image annotation workflows using dependency resolver controls with validated outcomes.
