---
name: video-processing-secret-scanner
description: Use when tasks require video processing secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Secret Scanner

## Purpose
Design and execute video processing workflows using secret scanner controls with validated outcomes.
