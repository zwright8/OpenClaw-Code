---
name: api-gateways-outcome-synthesizer
description: Use when tasks require api gateways outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Outcome Synthesizer

## Purpose
Design and execute api gateways workflows using outcome synthesizer controls with validated outcomes.
