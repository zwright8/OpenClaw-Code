---
name: service-mesh-postmortem-drafting
description: Use when tasks require service mesh postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Postmortem Drafting

## Purpose
Design and execute service mesh workflows using postmortem drafting controls with validated outcomes.
