---
name: image-annotation-provenance-tracker
description: Use when tasks require image annotation provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Provenance Tracker

## Purpose
Design and execute image annotation workflows using provenance tracker controls with validated outcomes.
