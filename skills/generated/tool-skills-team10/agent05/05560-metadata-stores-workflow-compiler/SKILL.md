---
name: metadata-stores-workflow-compiler
description: Use when tasks require metadata stores workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Workflow Compiler

## Purpose
Design and execute metadata stores workflows using workflow compiler controls with validated outcomes.
