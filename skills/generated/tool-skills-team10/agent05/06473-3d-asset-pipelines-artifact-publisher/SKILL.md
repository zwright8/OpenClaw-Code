---
name: 3d-asset-pipelines-artifact-publisher
description: Use when tasks require 3d asset pipelines artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Artifact Publisher

## Purpose
Design and execute 3d asset pipelines workflows using artifact publisher controls with validated outcomes.
