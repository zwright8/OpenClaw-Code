---
name: records-retention-workflow-compiler
description: Use when tasks require records retention workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Workflow Compiler

## Purpose
Design and execute records retention workflows using workflow compiler controls with validated outcomes.
