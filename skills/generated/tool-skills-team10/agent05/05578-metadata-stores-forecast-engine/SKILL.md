---
name: metadata-stores-forecast-engine
description: Use when tasks require metadata stores forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Forecast Engine

## Purpose
Design and execute metadata stores workflows using forecast engine controls with validated outcomes.
