---
name: model-registries-access-auditor
description: Use when tasks require model registries access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Access Auditor

## Purpose
Design and execute model registries workflows using access auditor controls with validated outcomes.
