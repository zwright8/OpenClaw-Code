---
name: prompt-repositories-artifact-publisher
description: Use when tasks require prompt repositories artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Artifact Publisher

## Purpose
Design and execute prompt repositories workflows using artifact publisher controls with validated outcomes.
