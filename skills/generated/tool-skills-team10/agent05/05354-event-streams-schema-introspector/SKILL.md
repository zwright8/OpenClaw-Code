---
name: event-streams-schema-introspector
description: Use when tasks require event streams schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Schema Introspector

## Purpose
Design and execute event streams workflows using schema introspector controls with validated outcomes.
