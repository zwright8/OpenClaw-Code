---
name: rpa-platforms-snapshot-manager
description: Use when tasks require rpa platforms snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Snapshot Manager

## Purpose
Design and execute rpa platforms workflows using snapshot manager controls with validated outcomes.
