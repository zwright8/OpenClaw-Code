---
name: prompt-repositories-auth-broker
description: Use when tasks require prompt repositories auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Auth Broker

## Purpose
Design and execute prompt repositories workflows using auth broker controls with validated outcomes.
