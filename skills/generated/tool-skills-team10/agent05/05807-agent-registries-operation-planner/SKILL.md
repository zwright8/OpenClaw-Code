---
name: agent-registries-operation-planner
description: Use when tasks require agent registries operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Operation Planner

## Purpose
Design and execute agent registries workflows using operation planner controls with validated outcomes.
