---
name: archive-systems-evidence-collector
description: Use when tasks require archive systems evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Archive Systems Evidence Collector

## Purpose
Design and execute archive systems workflows using evidence collector controls with validated outcomes.
