---
name: service-mesh-pii-redactor
description: Use when tasks require service mesh pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh PII Redactor

## Purpose
Design and execute service mesh workflows using pii redactor controls with validated outcomes.
