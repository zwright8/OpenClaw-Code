---
name: api-gateways-evidence-collector
description: Use when tasks require api gateways evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Evidence Collector

## Purpose
Design and execute api gateways workflows using evidence collector controls with validated outcomes.
