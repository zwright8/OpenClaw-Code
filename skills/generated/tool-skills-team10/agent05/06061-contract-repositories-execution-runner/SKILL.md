---
name: contract-repositories-execution-runner
description: Use when tasks require contract repositories execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Execution Runner

## Purpose
Design and execute contract repositories workflows using execution runner controls with validated outcomes.
