---
name: document-ocr-budget-guardrail
description: Use when tasks require document ocr budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Budget Guardrail

## Purpose
Design and execute document ocr workflows using budget guardrail controls with validated outcomes.
