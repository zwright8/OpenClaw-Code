---
name: data-catalogs-pii-redactor
description: Use when tasks require data catalogs pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs PII Redactor

## Purpose
Design and execute data catalogs workflows using pii redactor controls with validated outcomes.
