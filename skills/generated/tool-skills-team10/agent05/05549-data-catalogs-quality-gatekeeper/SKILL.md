---
name: data-catalogs-quality-gatekeeper
description: Use when tasks require data catalogs quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Quality Gatekeeper

## Purpose
Design and execute data catalogs workflows using quality gatekeeper controls with validated outcomes.
