---
name: message-brokers-secret-scanner
description: Use when tasks require message brokers secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Secret Scanner

## Purpose
Design and execute message brokers workflows using secret scanner controls with validated outcomes.
