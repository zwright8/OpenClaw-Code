---
name: api-gateways-forecast-engine
description: Use when tasks require api gateways forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Forecast Engine

## Purpose
Design and execute api gateways workflows using forecast engine controls with validated outcomes.
