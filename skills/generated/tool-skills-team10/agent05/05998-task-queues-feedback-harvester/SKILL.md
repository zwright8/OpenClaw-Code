---
name: task-queues-feedback-harvester
description: Use when tasks require task queues feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Feedback Harvester

## Purpose
Design and execute task queues workflows using feedback harvester controls with validated outcomes.
