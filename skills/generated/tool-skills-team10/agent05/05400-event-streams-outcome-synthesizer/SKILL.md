---
name: event-streams-outcome-synthesizer
description: Use when tasks require event streams outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Outcome Synthesizer

## Purpose
Design and execute event streams workflows using outcome synthesizer controls with validated outcomes.
