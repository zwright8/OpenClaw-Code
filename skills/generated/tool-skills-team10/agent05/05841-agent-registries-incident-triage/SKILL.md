---
name: agent-registries-incident-triage
description: Use when tasks require agent registries incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Incident Triage

## Purpose
Design and execute agent registries workflows using incident triage controls with validated outcomes.
