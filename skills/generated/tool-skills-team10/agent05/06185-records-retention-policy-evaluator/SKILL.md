---
name: records-retention-policy-evaluator
description: Use when tasks require records retention policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Policy Evaluator

## Purpose
Design and execute records retention workflows using policy evaluator controls with validated outcomes.
