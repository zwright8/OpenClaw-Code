---
name: video-processing-artifact-publisher
description: Use when tasks require video processing artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Artifact Publisher

## Purpose
Design and execute video processing workflows using artifact publisher controls with validated outcomes.
