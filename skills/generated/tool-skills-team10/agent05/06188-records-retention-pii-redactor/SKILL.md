---
name: records-retention-pii-redactor
description: Use when tasks require records retention pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention PII Redactor

## Purpose
Design and execute records retention workflows using pii redactor controls with validated outcomes.
