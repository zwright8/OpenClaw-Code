---
name: metadata-stores-rate-limit-optimizer
description: Use when tasks require metadata stores rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Rate Limit Optimizer

## Purpose
Design and execute metadata stores workflows using rate limit optimizer controls with validated outcomes.
