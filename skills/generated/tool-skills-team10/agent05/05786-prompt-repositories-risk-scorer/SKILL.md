---
name: prompt-repositories-risk-scorer
description: Use when tasks require prompt repositories risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Risk Scorer

## Purpose
Design and execute prompt repositories workflows using risk scorer controls with validated outcomes.
