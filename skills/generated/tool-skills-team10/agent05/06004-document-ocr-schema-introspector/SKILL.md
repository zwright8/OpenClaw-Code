---
name: document-ocr-schema-introspector
description: Use when tasks require document ocr schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Schema Introspector

## Purpose
Design and execute document ocr workflows using schema introspector controls with validated outcomes.
