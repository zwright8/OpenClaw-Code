---
name: video-processing-evidence-collector
description: Use when tasks require video processing evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Evidence Collector

## Purpose
Design and execute video processing workflows using evidence collector controls with validated outcomes.
