---
name: document-ocr-sla-enforcer
description: Use when tasks require document ocr sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR SLA Enforcer

## Purpose
Design and execute document ocr workflows using sla enforcer controls with validated outcomes.
