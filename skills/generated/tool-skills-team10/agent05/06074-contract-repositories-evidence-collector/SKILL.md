---
name: contract-repositories-evidence-collector
description: Use when tasks require contract repositories evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Evidence Collector

## Purpose
Design and execute contract repositories workflows using evidence collector controls with validated outcomes.
