---
name: contract-repositories-auth-broker
description: Use when tasks require contract repositories auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Auth Broker

## Purpose
Design and execute contract repositories workflows using auth broker controls with validated outcomes.
