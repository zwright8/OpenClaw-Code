---
name: metadata-stores-state-reconciler
description: Use when tasks require metadata stores state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores State Reconciler

## Purpose
Design and execute metadata stores workflows using state reconciler controls with validated outcomes.
