---
name: data-catalogs-anomaly-detector
description: Use when tasks require data catalogs anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Anomaly Detector

## Purpose
Design and execute data catalogs workflows using anomaly detector controls with validated outcomes.
