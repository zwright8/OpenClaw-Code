---
name: workflow-engines-approval-orchestrator
description: Use when tasks require workflow engines approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Approval Orchestrator

## Purpose
Design and execute workflow engines workflows using approval orchestrator controls with validated outcomes.
