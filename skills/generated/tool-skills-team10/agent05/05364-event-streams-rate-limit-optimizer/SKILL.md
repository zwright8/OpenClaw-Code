---
name: event-streams-rate-limit-optimizer
description: Use when tasks require event streams rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Rate Limit Optimizer

## Purpose
Design and execute event streams workflows using rate limit optimizer controls with validated outcomes.
