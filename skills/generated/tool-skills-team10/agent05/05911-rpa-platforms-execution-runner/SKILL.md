---
name: rpa-platforms-execution-runner
description: Use when tasks require rpa platforms execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Execution Runner

## Purpose
Design and execute rpa platforms workflows using execution runner controls with validated outcomes.
