---
name: esignature-systems-secret-scanner
description: Use when tasks require esignature systems secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# eSignature Systems Secret Scanner

## Purpose
Design and execute esignature systems workflows using secret scanner controls with validated outcomes.
