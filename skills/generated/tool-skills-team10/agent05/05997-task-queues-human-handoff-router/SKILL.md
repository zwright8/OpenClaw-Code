---
name: task-queues-human-handoff-router
description: Use when tasks require task queues human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Human Handoff Router

## Purpose
Design and execute task queues workflows using human handoff router controls with validated outcomes.
