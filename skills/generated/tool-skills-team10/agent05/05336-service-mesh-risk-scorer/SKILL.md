---
name: service-mesh-risk-scorer
description: Use when tasks require service mesh risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Risk Scorer

## Purpose
Design and execute service mesh workflows using risk scorer controls with validated outcomes.
