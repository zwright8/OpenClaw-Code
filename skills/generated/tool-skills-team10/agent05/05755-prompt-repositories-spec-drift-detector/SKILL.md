---
name: prompt-repositories-spec-drift-detector
description: Use when tasks require prompt repositories spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Spec Drift Detector

## Purpose
Design and execute prompt repositories workflows using spec drift detector controls with validated outcomes.
