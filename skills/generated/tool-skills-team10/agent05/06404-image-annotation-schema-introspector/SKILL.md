---
name: image-annotation-schema-introspector
description: Use when tasks require image annotation schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Schema Introspector

## Purpose
Design and execute image annotation workflows using schema introspector controls with validated outcomes.
