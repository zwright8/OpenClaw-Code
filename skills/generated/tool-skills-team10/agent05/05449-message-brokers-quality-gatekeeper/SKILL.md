---
name: message-brokers-quality-gatekeeper
description: Use when tasks require message brokers quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Quality Gatekeeper

## Purpose
Design and execute message brokers workflows using quality gatekeeper controls with validated outcomes.
