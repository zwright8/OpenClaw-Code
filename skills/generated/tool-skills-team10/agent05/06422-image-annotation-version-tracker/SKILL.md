---
name: image-annotation-version-tracker
description: Use when tasks require image annotation version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Version Tracker

## Purpose
Design and execute image annotation workflows using version tracker controls with validated outcomes.
