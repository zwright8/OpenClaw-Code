---
name: agent-registries-budget-guardrail
description: Use when tasks require agent registries budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Budget Guardrail

## Purpose
Design and execute agent registries workflows using budget guardrail controls with validated outcomes.
