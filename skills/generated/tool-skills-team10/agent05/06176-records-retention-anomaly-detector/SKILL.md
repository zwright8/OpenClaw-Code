---
name: records-retention-anomaly-detector
description: Use when tasks require records retention anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Anomaly Detector

## Purpose
Design and execute records retention workflows using anomaly detector controls with validated outcomes.
