---
name: api-gateways-artifact-publisher
description: Use when tasks require api gateways artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Artifact Publisher

## Purpose
Design and execute api gateways workflows using artifact publisher controls with validated outcomes.
