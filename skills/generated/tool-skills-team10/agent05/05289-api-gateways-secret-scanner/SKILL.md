---
name: api-gateways-secret-scanner
description: Use when tasks require api gateways secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Secret Scanner

## Purpose
Design and execute api gateways workflows using secret scanner controls with validated outcomes.
