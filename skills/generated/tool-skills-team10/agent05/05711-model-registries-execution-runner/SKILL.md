---
name: model-registries-execution-runner
description: Use when tasks require model registries execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Execution Runner

## Purpose
Design and execute model registries workflows using execution runner controls with validated outcomes.
