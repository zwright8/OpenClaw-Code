---
name: video-processing-postmortem-drafting
description: Use when tasks require video processing postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Postmortem Drafting

## Purpose
Design and execute video processing workflows using postmortem drafting controls with validated outcomes.
