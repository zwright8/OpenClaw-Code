---
name: document-ocr-rate-limit-optimizer
description: Use when tasks require document ocr rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Rate Limit Optimizer

## Purpose
Design and execute document ocr workflows using rate limit optimizer controls with validated outcomes.
