---
name: event-streams-secret-scanner
description: Use when tasks require event streams secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Secret Scanner

## Purpose
Design and execute event streams workflows using secret scanner controls with validated outcomes.
