---
name: document-ocr-permission-mapper
description: Use when tasks require document ocr permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Permission Mapper

## Purpose
Design and execute document ocr workflows using permission mapper controls with validated outcomes.
