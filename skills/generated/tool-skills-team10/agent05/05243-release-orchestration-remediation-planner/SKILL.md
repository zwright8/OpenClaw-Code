---
name: release-orchestration-remediation-planner
description: Use when tasks require release orchestration remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Remediation Planner

## Purpose
Design and execute release orchestration workflows using remediation planner controls with validated outcomes.
