---
name: metadata-stores-rollback-coordinator
description: Use when tasks require metadata stores rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Rollback Coordinator

## Purpose
Design and execute metadata stores workflows using rollback coordinator controls with validated outcomes.
