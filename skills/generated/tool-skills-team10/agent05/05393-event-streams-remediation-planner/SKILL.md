---
name: event-streams-remediation-planner
description: Use when tasks require event streams remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Remediation Planner

## Purpose
Design and execute event streams workflows using remediation planner controls with validated outcomes.
