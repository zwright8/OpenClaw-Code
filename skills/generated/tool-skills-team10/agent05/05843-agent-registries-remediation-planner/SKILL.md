---
name: agent-registries-remediation-planner
description: Use when tasks require agent registries remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Remediation Planner

## Purpose
Design and execute agent registries workflows using remediation planner controls with validated outcomes.
