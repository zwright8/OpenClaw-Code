---
name: agent-registries-execution-runner
description: Use when tasks require agent registries execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Execution Runner

## Purpose
Design and execute agent registries workflows using execution runner controls with validated outcomes.
