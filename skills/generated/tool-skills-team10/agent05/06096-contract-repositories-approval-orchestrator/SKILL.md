---
name: contract-repositories-approval-orchestrator
description: Use when tasks require contract repositories approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Approval Orchestrator

## Purpose
Design and execute contract repositories workflows using approval orchestrator controls with validated outcomes.
