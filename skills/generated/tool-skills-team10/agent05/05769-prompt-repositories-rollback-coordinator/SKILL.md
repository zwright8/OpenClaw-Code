---
name: prompt-repositories-rollback-coordinator
description: Use when tasks require prompt repositories rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Rollback Coordinator

## Purpose
Design and execute prompt repositories workflows using rollback coordinator controls with validated outcomes.
