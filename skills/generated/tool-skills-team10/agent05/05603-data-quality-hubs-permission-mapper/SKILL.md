---
name: data-quality-hubs-permission-mapper
description: Use when tasks require data quality hubs permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Quality Hubs Permission Mapper

## Purpose
Design and execute data quality hubs workflows using permission mapper controls with validated outcomes.
