---
name: image-annotation-auth-broker
description: Use when tasks require image annotation auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Auth Broker

## Purpose
Design and execute image annotation workflows using auth broker controls with validated outcomes.
