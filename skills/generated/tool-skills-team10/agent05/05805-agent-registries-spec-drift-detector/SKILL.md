---
name: agent-registries-spec-drift-detector
description: Use when tasks require agent registries spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Spec Drift Detector

## Purpose
Design and execute agent registries workflows using spec drift detector controls with validated outcomes.
