---
name: workflow-engines-incident-triage
description: Use when tasks require workflow engines incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Incident Triage

## Purpose
Design and execute workflow engines workflows using incident triage controls with validated outcomes.
