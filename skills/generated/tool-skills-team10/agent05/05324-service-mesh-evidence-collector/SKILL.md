---
name: service-mesh-evidence-collector
description: Use when tasks require service mesh evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Evidence Collector

## Purpose
Design and execute service mesh workflows using evidence collector controls with validated outcomes.
