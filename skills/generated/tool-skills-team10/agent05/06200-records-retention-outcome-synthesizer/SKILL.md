---
name: records-retention-outcome-synthesizer
description: Use when tasks require records retention outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Outcome Synthesizer

## Purpose
Design and execute records retention workflows using outcome synthesizer controls with validated outcomes.
