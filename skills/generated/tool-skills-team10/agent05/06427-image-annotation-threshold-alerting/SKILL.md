---
name: image-annotation-threshold-alerting
description: Use when tasks require image annotation threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Threshold Alerting

## Purpose
Design and execute image annotation workflows using threshold alerting controls with validated outcomes.
