---
name: contract-repositories-capacity-planner
description: Use when tasks require contract repositories capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Capacity Planner

## Purpose
Design and execute contract repositories workflows using capacity planner controls with validated outcomes.
