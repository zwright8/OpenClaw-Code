---
name: agent-registries-rollback-coordinator
description: Use when tasks require agent registries rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Rollback Coordinator

## Purpose
Design and execute agent registries workflows using rollback coordinator controls with validated outcomes.
