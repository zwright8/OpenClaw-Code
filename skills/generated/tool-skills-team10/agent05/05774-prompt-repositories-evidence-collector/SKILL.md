---
name: prompt-repositories-evidence-collector
description: Use when tasks require prompt repositories evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Evidence Collector

## Purpose
Design and execute prompt repositories workflows using evidence collector controls with validated outcomes.
