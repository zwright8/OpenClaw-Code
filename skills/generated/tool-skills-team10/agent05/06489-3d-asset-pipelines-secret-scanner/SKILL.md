---
name: 3d-asset-pipelines-secret-scanner
description: Use when tasks require 3d asset pipelines secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Secret Scanner

## Purpose
Design and execute 3d asset pipelines workflows using secret scanner controls with validated outcomes.
