---
name: release-orchestration-compliance-mapper
description: Use when tasks require release orchestration compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Compliance Mapper

## Purpose
Design and execute release orchestration workflows using compliance mapper controls with validated outcomes.
