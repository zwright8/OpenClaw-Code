---
name: service-mesh-runbook-composer
description: Use when tasks require service mesh runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Runbook Composer

## Purpose
Design and execute service mesh workflows using runbook composer controls with validated outcomes.
