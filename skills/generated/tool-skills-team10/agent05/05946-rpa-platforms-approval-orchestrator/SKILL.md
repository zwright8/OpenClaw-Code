---
name: rpa-platforms-approval-orchestrator
description: Use when tasks require rpa platforms approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Approval Orchestrator

## Purpose
Design and execute rpa platforms workflows using approval orchestrator controls with validated outcomes.
