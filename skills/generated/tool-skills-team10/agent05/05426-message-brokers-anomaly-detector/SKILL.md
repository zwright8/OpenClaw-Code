---
name: message-brokers-anomaly-detector
description: Use when tasks require message brokers anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Anomaly Detector

## Purpose
Design and execute message brokers workflows using anomaly detector controls with validated outcomes.
