---
name: event-streams-risk-scorer
description: Use when tasks require event streams risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Risk Scorer

## Purpose
Design and execute event streams workflows using risk scorer controls with validated outcomes.
