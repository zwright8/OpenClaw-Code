---
name: release-orchestration-budget-guardrail
description: Use when tasks require release orchestration budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Budget Guardrail

## Purpose
Design and execute release orchestration workflows using budget guardrail controls with validated outcomes.
