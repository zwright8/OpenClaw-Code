---
name: media-asset-management-provenance-tracker
description: Use when tasks require media asset management provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Provenance Tracker

## Purpose
Design and execute media asset management workflows using provenance tracker controls with validated outcomes.
