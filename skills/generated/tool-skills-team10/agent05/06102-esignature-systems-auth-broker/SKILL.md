---
name: esignature-systems-auth-broker
description: Use when tasks require esignature systems auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# eSignature Systems Auth Broker

## Purpose
Design and execute esignature systems workflows using auth broker controls with validated outcomes.
