---
name: rpa-platforms-task-decomposer
description: Use when tasks require rpa platforms task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Task Decomposer

## Purpose
Design and execute rpa platforms workflows using task decomposer controls with validated outcomes.
