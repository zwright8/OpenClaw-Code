---
name: records-retention-artifact-publisher
description: Use when tasks require records retention artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Artifact Publisher

## Purpose
Design and execute records retention workflows using artifact publisher controls with validated outcomes.
