---
name: model-registries-task-decomposer
description: Use when tasks require model registries task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Task Decomposer

## Purpose
Design and execute model registries workflows using task decomposer controls with validated outcomes.
