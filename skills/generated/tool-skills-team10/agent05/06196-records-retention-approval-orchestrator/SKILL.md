---
name: records-retention-approval-orchestrator
description: Use when tasks require records retention approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Approval Orchestrator

## Purpose
Design and execute records retention workflows using approval orchestrator controls with validated outcomes.
