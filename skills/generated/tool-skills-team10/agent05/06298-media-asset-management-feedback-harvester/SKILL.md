---
name: media-asset-management-feedback-harvester
description: Use when tasks require media asset management feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Feedback Harvester

## Purpose
Design and execute media asset management workflows using feedback harvester controls with validated outcomes.
