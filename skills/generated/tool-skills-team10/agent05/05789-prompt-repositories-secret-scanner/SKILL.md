---
name: prompt-repositories-secret-scanner
description: Use when tasks require prompt repositories secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Secret Scanner

## Purpose
Design and execute prompt repositories workflows using secret scanner controls with validated outcomes.
