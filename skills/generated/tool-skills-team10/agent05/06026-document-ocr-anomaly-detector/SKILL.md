---
name: document-ocr-anomaly-detector
description: Use when tasks require document ocr anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Anomaly Detector

## Purpose
Design and execute document ocr workflows using anomaly detector controls with validated outcomes.
