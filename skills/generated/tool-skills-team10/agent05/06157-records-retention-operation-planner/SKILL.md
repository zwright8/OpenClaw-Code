---
name: records-retention-operation-planner
description: Use when tasks require records retention operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Operation Planner

## Purpose
Design and execute records retention workflows using operation planner controls with validated outcomes.
