---
name: video-processing-anomaly-detector
description: Use when tasks require video processing anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Anomaly Detector

## Purpose
Design and execute video processing workflows using anomaly detector controls with validated outcomes.
