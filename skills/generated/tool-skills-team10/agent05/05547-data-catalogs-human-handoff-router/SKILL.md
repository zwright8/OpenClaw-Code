---
name: data-catalogs-human-handoff-router
description: Use when tasks require data catalogs human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Human Handoff Router

## Purpose
Design and execute data catalogs workflows using human handoff router controls with validated outcomes.
