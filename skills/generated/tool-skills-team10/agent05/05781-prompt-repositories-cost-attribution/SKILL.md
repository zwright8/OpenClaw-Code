---
name: prompt-repositories-cost-attribution
description: Use when tasks require prompt repositories cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Cost Attribution

## Purpose
Design and execute prompt repositories workflows using cost attribution controls with validated outcomes.
