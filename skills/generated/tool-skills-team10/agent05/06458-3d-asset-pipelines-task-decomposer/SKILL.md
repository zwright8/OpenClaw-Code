---
name: 3d-asset-pipelines-task-decomposer
description: Use when tasks require 3d asset pipelines task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Task Decomposer

## Purpose
Design and execute 3d asset pipelines workflows using task decomposer controls with validated outcomes.
