---
name: event-streams-pii-redactor
description: Use when tasks require event streams pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams PII Redactor

## Purpose
Design and execute event streams workflows using pii redactor controls with validated outcomes.
