---
name: agent-registries-permission-mapper
description: Use when tasks require agent registries permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Permission Mapper

## Purpose
Design and execute agent registries workflows using permission mapper controls with validated outcomes.
