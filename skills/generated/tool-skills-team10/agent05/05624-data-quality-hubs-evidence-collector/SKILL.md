---
name: data-quality-hubs-evidence-collector
description: Use when tasks require data quality hubs evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Quality Hubs Evidence Collector

## Purpose
Design and execute data quality hubs workflows using evidence collector controls with validated outcomes.
