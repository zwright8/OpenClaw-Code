---
name: records-retention-auth-broker
description: Use when tasks require records retention auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Auth Broker

## Purpose
Design and execute records retention workflows using auth broker controls with validated outcomes.
