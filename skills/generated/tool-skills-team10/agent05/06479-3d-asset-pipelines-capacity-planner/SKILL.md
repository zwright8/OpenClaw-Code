---
name: 3d-asset-pipelines-capacity-planner
description: Use when tasks require 3d asset pipelines capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Capacity Planner

## Purpose
Design and execute 3d asset pipelines workflows using capacity planner controls with validated outcomes.
