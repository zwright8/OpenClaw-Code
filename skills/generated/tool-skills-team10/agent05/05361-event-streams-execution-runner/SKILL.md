---
name: event-streams-execution-runner
description: Use when tasks require event streams execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Execution Runner

## Purpose
Design and execute event streams workflows using execution runner controls with validated outcomes.
