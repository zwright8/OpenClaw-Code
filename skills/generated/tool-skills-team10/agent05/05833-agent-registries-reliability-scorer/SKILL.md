---
name: agent-registries-reliability-scorer
description: Use when tasks require agent registries reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Reliability Scorer

## Purpose
Design and execute agent registries workflows using reliability scorer controls with validated outcomes.
