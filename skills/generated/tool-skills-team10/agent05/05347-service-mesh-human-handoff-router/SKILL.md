---
name: service-mesh-human-handoff-router
description: Use when tasks require service mesh human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Human Handoff Router

## Purpose
Design and execute service mesh workflows using human handoff router controls with validated outcomes.
