---
name: prompt-repositories-permission-mapper
description: Use when tasks require prompt repositories permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Permission Mapper

## Purpose
Design and execute prompt repositories workflows using permission mapper controls with validated outcomes.
