---
name: agent-registries-cost-attribution
description: Use when tasks require agent registries cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Cost Attribution

## Purpose
Design and execute agent registries workflows using cost attribution controls with validated outcomes.
