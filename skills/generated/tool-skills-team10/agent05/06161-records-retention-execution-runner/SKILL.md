---
name: records-retention-execution-runner
description: Use when tasks require records retention execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Execution Runner

## Purpose
Design and execute records retention workflows using execution runner controls with validated outcomes.
