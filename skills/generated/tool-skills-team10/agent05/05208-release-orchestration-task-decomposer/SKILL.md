---
name: release-orchestration-task-decomposer
description: Use when tasks require release orchestration task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Task Decomposer

## Purpose
Design and execute release orchestration workflows using task decomposer controls with validated outcomes.
