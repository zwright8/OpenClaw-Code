---
name: contract-repositories-compliance-mapper
description: Use when tasks require contract repositories compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Compliance Mapper

## Purpose
Design and execute contract repositories workflows using compliance mapper controls with validated outcomes.
