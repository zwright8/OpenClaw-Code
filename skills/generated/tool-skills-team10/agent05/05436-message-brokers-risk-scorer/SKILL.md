---
name: message-brokers-risk-scorer
description: Use when tasks require message brokers risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Risk Scorer

## Purpose
Design and execute message brokers workflows using risk scorer controls with validated outcomes.
