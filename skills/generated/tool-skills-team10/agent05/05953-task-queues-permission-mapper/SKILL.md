---
name: task-queues-permission-mapper
description: Use when tasks require task queues permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Permission Mapper

## Purpose
Design and execute task queues workflows using permission mapper controls with validated outcomes.
