---
name: service-mesh-remediation-planner
description: Use when tasks require service mesh remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Remediation Planner

## Purpose
Design and execute service mesh workflows using remediation planner controls with validated outcomes.
