---
name: release-orchestration-quality-gatekeeper
description: Use when tasks require release orchestration quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Quality Gatekeeper

## Purpose
Design and execute release orchestration workflows using quality gatekeeper controls with validated outcomes.
