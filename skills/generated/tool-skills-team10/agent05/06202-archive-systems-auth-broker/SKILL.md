---
name: archive-systems-auth-broker
description: Use when tasks require archive systems auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Archive Systems Auth Broker

## Purpose
Design and execute archive systems workflows using auth broker controls with validated outcomes.
