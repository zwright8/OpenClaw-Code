---
name: workflow-engines-auth-broker
description: Use when tasks require workflow engines auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Auth Broker

## Purpose
Design and execute workflow engines workflows using auth broker controls with validated outcomes.
