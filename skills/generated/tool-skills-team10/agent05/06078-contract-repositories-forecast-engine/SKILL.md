---
name: contract-repositories-forecast-engine
description: Use when tasks require contract repositories forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Forecast Engine

## Purpose
Design and execute contract repositories workflows using forecast engine controls with validated outcomes.
