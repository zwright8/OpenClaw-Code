---
name: prompt-repositories-remediation-planner
description: Use when tasks require prompt repositories remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Remediation Planner

## Purpose
Design and execute prompt repositories workflows using remediation planner controls with validated outcomes.
