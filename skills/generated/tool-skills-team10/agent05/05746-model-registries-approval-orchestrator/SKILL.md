---
name: model-registries-approval-orchestrator
description: Use when tasks require model registries approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Approval Orchestrator

## Purpose
Design and execute model registries workflows using approval orchestrator controls with validated outcomes.
