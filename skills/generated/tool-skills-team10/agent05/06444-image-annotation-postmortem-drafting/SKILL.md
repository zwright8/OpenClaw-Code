---
name: image-annotation-postmortem-drafting
description: Use when tasks require image annotation postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Postmortem Drafting

## Purpose
Design and execute image annotation workflows using postmortem drafting controls with validated outcomes.
