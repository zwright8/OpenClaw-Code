---
name: feature-stores-risk-scorer
description: Use when tasks require feature stores risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Risk Scorer

## Purpose
Design and execute feature stores workflows using risk scorer controls with validated outcomes.
