---
name: service-mesh-policy-evaluator
description: Use when tasks require service mesh policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Policy Evaluator

## Purpose
Design and execute service mesh workflows using policy evaluator controls with validated outcomes.
