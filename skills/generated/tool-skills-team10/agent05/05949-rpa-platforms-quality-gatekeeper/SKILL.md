---
name: rpa-platforms-quality-gatekeeper
description: Use when tasks require rpa platforms quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Quality Gatekeeper

## Purpose
Design and execute rpa platforms workflows using quality gatekeeper controls with validated outcomes.
