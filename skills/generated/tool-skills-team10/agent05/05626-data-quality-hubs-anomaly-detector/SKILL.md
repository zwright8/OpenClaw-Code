---
name: data-quality-hubs-anomaly-detector
description: Use when tasks require data quality hubs anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Quality Hubs Anomaly Detector

## Purpose
Design and execute data quality hubs workflows using anomaly detector controls with validated outcomes.
