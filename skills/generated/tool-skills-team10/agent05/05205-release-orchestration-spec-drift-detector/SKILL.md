---
name: release-orchestration-spec-drift-detector
description: Use when tasks require release orchestration spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Spec Drift Detector

## Purpose
Design and execute release orchestration workflows using spec drift detector controls with validated outcomes.
