---
name: prompt-repositories-snapshot-manager
description: Use when tasks require prompt repositories snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Snapshot Manager

## Purpose
Design and execute prompt repositories workflows using snapshot manager controls with validated outcomes.
