---
name: agent-registries-migration-planner
description: Use when tasks require agent registries migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Migration Planner

## Purpose
Design and execute agent registries workflows using migration planner controls with validated outcomes.
