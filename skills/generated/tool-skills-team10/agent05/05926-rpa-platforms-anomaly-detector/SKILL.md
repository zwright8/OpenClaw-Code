---
name: rpa-platforms-anomaly-detector
description: Use when tasks require rpa platforms anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Anomaly Detector

## Purpose
Design and execute rpa platforms workflows using anomaly detector controls with validated outcomes.
