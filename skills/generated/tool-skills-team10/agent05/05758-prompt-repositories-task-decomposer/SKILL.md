---
name: prompt-repositories-task-decomposer
description: Use when tasks require prompt repositories task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Task Decomposer

## Purpose
Design and execute prompt repositories workflows using task decomposer controls with validated outcomes.
