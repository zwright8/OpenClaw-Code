---
name: video-processing-operation-planner
description: Use when tasks require video processing operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Video Processing Operation Planner

## Purpose
Design and execute video processing workflows using operation planner controls with validated outcomes.
