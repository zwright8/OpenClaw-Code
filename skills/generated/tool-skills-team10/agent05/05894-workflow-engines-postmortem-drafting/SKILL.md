---
name: workflow-engines-postmortem-drafting
description: Use when tasks require workflow engines postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Postmortem Drafting

## Purpose
Design and execute workflow engines workflows using postmortem drafting controls with validated outcomes.
