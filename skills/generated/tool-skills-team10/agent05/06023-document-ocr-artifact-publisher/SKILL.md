---
name: document-ocr-artifact-publisher
description: Use when tasks require document ocr artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Artifact Publisher

## Purpose
Design and execute document ocr workflows using artifact publisher controls with validated outcomes.
