---
name: data-catalogs-secret-scanner
description: Use when tasks require data catalogs secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Secret Scanner

## Purpose
Design and execute data catalogs workflows using secret scanner controls with validated outcomes.
