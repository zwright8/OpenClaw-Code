---
name: document-ocr-provenance-tracker
description: Use when tasks require document ocr provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Provenance Tracker

## Purpose
Design and execute document ocr workflows using provenance tracker controls with validated outcomes.
