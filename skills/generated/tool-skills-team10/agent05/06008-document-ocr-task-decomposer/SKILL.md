---
name: document-ocr-task-decomposer
description: Use when tasks require document ocr task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Document OCR Task Decomposer

## Purpose
Design and execute document ocr workflows using task decomposer controls with validated outcomes.
