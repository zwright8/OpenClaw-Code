---
name: api-gateways-permission-mapper
description: Use when tasks require api gateways permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# API Gateways Permission Mapper

## Purpose
Design and execute api gateways workflows using permission mapper controls with validated outcomes.
