---
name: prompt-repositories-provenance-tracker
description: Use when tasks require prompt repositories provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Prompt Repositories Provenance Tracker

## Purpose
Design and execute prompt repositories workflows using provenance tracker controls with validated outcomes.
