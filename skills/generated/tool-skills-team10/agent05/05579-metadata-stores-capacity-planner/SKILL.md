---
name: metadata-stores-capacity-planner
description: Use when tasks require metadata stores capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Capacity Planner

## Purpose
Design and execute metadata stores workflows using capacity planner controls with validated outcomes.
