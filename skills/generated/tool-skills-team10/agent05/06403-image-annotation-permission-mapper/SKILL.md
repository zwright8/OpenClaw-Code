---
name: image-annotation-permission-mapper
description: Use when tasks require image annotation permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Permission Mapper

## Purpose
Design and execute image annotation workflows using permission mapper controls with validated outcomes.
