---
name: task-queues-execution-runner
description: Use when tasks require task queues execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Execution Runner

## Purpose
Design and execute task queues workflows using execution runner controls with validated outcomes.
