---
name: audio-pipelines-evidence-collector
description: Use when tasks require audio pipelines evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audio Pipelines Evidence Collector

## Purpose
Design and execute audio pipelines workflows using evidence collector controls with validated outcomes.
