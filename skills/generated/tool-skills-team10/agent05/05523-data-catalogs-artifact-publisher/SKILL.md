---
name: data-catalogs-artifact-publisher
description: Use when tasks require data catalogs artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Artifact Publisher

## Purpose
Design and execute data catalogs workflows using artifact publisher controls with validated outcomes.
