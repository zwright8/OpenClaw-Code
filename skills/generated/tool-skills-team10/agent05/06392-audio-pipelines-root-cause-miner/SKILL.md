---
name: audio-pipelines-root-cause-miner
description: Use when tasks require audio pipelines root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Audio Pipelines Root Cause Miner

## Purpose
Design and execute audio pipelines workflows using root cause miner controls with validated outcomes.
