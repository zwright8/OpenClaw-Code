---
name: service-mesh-outcome-synthesizer
description: Use when tasks require service mesh outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Outcome Synthesizer

## Purpose
Design and execute service mesh workflows using outcome synthesizer controls with validated outcomes.
