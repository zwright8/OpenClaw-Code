---
name: service-mesh-rollback-coordinator
description: Use when tasks require service mesh rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Rollback Coordinator

## Purpose
Design and execute service mesh workflows using rollback coordinator controls with validated outcomes.
