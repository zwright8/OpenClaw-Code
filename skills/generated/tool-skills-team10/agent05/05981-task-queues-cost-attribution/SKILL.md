---
name: task-queues-cost-attribution
description: Use when tasks require task queues cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Cost Attribution

## Purpose
Design and execute task queues workflows using cost attribution controls with validated outcomes.
