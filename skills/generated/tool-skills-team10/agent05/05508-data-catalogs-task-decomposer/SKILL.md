---
name: data-catalogs-task-decomposer
description: Use when tasks require data catalogs task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Task Decomposer

## Purpose
Design and execute data catalogs workflows using task decomposer controls with validated outcomes.
