---
name: media-asset-management-human-handoff-router
description: Use when tasks require media asset management human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Human Handoff Router

## Purpose
Design and execute media asset management workflows using human handoff router controls with validated outcomes.
