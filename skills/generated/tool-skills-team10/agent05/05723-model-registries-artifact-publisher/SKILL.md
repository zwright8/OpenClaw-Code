---
name: model-registries-artifact-publisher
description: Use when tasks require model registries artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Model Registries Artifact Publisher

## Purpose
Design and execute model registries workflows using artifact publisher controls with validated outcomes.
