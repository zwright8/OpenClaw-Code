---
name: feature-stores-root-cause-miner
description: Use when tasks require feature stores root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Root Cause Miner

## Purpose
Design and execute feature stores workflows using root cause miner controls with validated outcomes.
