---
name: records-retention-reliability-scorer
description: Use when tasks require records retention reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Records Retention Reliability Scorer

## Purpose
Design and execute records retention workflows using reliability scorer controls with validated outcomes.
