---
name: agent-registries-postmortem-drafting
description: Use when tasks require agent registries postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Agent Registries Postmortem Drafting

## Purpose
Design and execute agent registries workflows using postmortem drafting controls with validated outcomes.
