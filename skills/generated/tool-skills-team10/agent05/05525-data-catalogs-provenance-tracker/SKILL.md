---
name: data-catalogs-provenance-tracker
description: Use when tasks require data catalogs provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Data Catalogs Provenance Tracker

## Purpose
Design and execute data catalogs workflows using provenance tracker controls with validated outcomes.
