---
name: workflow-engines-evidence-collector
description: Use when tasks require workflow engines evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Workflow Engines Evidence Collector

## Purpose
Design and execute workflow engines workflows using evidence collector controls with validated outcomes.
