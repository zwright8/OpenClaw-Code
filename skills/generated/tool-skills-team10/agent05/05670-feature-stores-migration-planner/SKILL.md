---
name: feature-stores-migration-planner
description: Use when tasks require feature stores migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Feature Stores Migration Planner

## Purpose
Design and execute feature stores workflows using migration planner controls with validated outcomes.
