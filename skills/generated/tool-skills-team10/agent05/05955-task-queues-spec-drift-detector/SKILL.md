---
name: task-queues-spec-drift-detector
description: Use when tasks require task queues spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Task Queues Spec Drift Detector

## Purpose
Design and execute task queues workflows using spec drift detector controls with validated outcomes.
