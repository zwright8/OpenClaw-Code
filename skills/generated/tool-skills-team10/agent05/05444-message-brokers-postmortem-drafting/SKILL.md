---
name: message-brokers-postmortem-drafting
description: Use when tasks require message brokers postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Postmortem Drafting

## Purpose
Design and execute message brokers workflows using postmortem drafting controls with validated outcomes.
