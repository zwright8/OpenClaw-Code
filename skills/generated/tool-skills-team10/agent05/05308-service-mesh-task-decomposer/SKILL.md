---
name: service-mesh-task-decomposer
description: Use when tasks require service mesh task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Service Mesh Task Decomposer

## Purpose
Design and execute service mesh workflows using task decomposer controls with validated outcomes.
