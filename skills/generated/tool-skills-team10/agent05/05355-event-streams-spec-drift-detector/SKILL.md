---
name: event-streams-spec-drift-detector
description: Use when tasks require event streams spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Event Streams Spec Drift Detector

## Purpose
Design and execute event streams workflows using spec drift detector controls with validated outcomes.
