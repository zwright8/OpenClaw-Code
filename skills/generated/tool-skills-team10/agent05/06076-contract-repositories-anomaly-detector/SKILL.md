---
name: contract-repositories-anomaly-detector
description: Use when tasks require contract repositories anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Anomaly Detector

## Purpose
Design and execute contract repositories workflows using anomaly detector controls with validated outcomes.
