---
name: media-asset-management-postmortem-drafting
description: Use when tasks require media asset management postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Media Asset Management Postmortem Drafting

## Purpose
Design and execute media asset management workflows using postmortem drafting controls with validated outcomes.
