---
name: rpa-platforms-compliance-mapper
description: Use when tasks require rpa platforms compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RPA Platforms Compliance Mapper

## Purpose
Design and execute rpa platforms workflows using compliance mapper controls with validated outcomes.
