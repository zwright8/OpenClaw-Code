---
name: image-annotation-queue-balancer
description: Use when tasks require image annotation queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Queue Balancer

## Purpose
Design and execute image annotation workflows using queue balancer controls with validated outcomes.
