---
name: metadata-stores-task-decomposer
description: Use when tasks require metadata stores task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Task Decomposer

## Purpose
Design and execute metadata stores workflows using task decomposer controls with validated outcomes.
