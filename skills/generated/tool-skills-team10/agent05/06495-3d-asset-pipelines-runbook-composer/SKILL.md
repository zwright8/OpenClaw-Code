---
name: 3d-asset-pipelines-runbook-composer
description: Use when tasks require 3d asset pipelines runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# 3D Asset Pipelines Runbook Composer

## Purpose
Design and execute 3d asset pipelines workflows using runbook composer controls with validated outcomes.
