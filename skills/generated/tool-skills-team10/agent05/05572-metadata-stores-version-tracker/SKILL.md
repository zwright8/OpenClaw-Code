---
name: metadata-stores-version-tracker
description: Use when tasks require metadata stores version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Metadata Stores Version Tracker

## Purpose
Design and execute metadata stores workflows using version tracker controls with validated outcomes.
