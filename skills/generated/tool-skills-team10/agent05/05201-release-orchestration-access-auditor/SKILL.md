---
name: release-orchestration-access-auditor
description: Use when tasks require release orchestration access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Release Orchestration Access Auditor

## Purpose
Design and execute release orchestration workflows using access auditor controls with validated outcomes.
