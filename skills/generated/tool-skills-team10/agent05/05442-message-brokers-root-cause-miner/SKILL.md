---
name: message-brokers-root-cause-miner
description: Use when tasks require message brokers root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Message Brokers Root Cause Miner

## Purpose
Design and execute message brokers workflows using root cause miner controls with validated outcomes.
