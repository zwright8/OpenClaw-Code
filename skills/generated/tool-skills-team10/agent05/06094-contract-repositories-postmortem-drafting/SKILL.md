---
name: contract-repositories-postmortem-drafting
description: Use when tasks require contract repositories postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Contract Repositories Postmortem Drafting

## Purpose
Design and execute contract repositories workflows using postmortem drafting controls with validated outcomes.
