---
name: image-annotation-evidence-collector
description: Use when tasks require image annotation evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Image Annotation Evidence Collector

## Purpose
Design and execute image annotation workflows using evidence collector controls with validated outcomes.
