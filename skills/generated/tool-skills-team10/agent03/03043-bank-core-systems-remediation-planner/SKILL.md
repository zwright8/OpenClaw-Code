---
name: bank-core-systems-remediation-planner
description: Use when tasks require bank core systems remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Remediation Planner

## Purpose
Design and execute bank core systems workflows using remediation planner controls with validated outcomes.
