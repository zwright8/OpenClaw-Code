---
name: rail-scheduling-spec-drift-detector
description: Use when tasks require rail scheduling spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Spec Drift Detector

## Purpose
Design and execute rail scheduling workflows using spec drift detector controls with validated outcomes.
