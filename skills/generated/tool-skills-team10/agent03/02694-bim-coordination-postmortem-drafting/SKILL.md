---
name: bim-coordination-postmortem-drafting
description: Use when tasks require bim coordination postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Postmortem Drafting

## Purpose
Design and execute bim coordination workflows using postmortem drafting controls with validated outcomes.
