---
name: bim-coordination-rollback-coordinator
description: Use when tasks require bim coordination rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Rollback Coordinator

## Purpose
Design and execute bim coordination workflows using rollback coordinator controls with validated outcomes.
