---
name: maritime-routing-auth-broker
description: Use when tasks require maritime routing auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Auth Broker

## Purpose
Design and execute maritime routing workflows using auth broker controls with validated outcomes.
