---
name: procure-to-pay-dependency-resolver
description: Use when tasks require procure to pay dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Dependency Resolver

## Purpose
Design and execute procure to pay workflows using dependency resolver controls with validated outcomes.
