---
name: cpq-platforms-provenance-tracker
description: Use when tasks require cpq platforms provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Provenance Tracker

## Purpose
Design and execute cpq platforms workflows using provenance tracker controls with validated outcomes.
