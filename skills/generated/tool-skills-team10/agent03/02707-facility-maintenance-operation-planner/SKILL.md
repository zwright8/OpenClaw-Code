---
name: facility-maintenance-operation-planner
description: Use when tasks require facility maintenance operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Operation Planner

## Purpose
Design and execute facility maintenance workflows using operation planner controls with validated outcomes.
