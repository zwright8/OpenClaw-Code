---
name: cpq-platforms-spec-drift-detector
description: Use when tasks require cpq platforms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Spec Drift Detector

## Purpose
Design and execute cpq platforms workflows using spec drift detector controls with validated outcomes.
