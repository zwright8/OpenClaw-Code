---
name: construction-pm-root-cause-miner
description: Use when tasks require construction pm root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Root Cause Miner

## Purpose
Design and execute construction pm workflows using root cause miner controls with validated outcomes.
