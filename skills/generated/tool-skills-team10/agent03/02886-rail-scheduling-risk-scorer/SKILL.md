---
name: rail-scheduling-risk-scorer
description: Use when tasks require rail scheduling risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Risk Scorer

## Purpose
Design and execute rail scheduling workflows using risk scorer controls with validated outcomes.
