---
name: ad-platforms-auth-broker
description: Use when tasks require ad platforms auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Auth Broker

## Purpose
Design and execute ad platforms workflows using auth broker controls with validated outcomes.
