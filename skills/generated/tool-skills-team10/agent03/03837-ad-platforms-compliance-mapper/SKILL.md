---
name: ad-platforms-compliance-mapper
description: Use when tasks require ad platforms compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Compliance Mapper

## Purpose
Design and execute ad platforms workflows using compliance mapper controls with validated outcomes.
