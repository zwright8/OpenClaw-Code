---
name: bim-coordination-permission-mapper
description: Use when tasks require bim coordination permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Permission Mapper

## Purpose
Design and execute bim coordination workflows using permission mapper controls with validated outcomes.
