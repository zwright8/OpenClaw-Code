---
name: partner-portals-forecast-engine
description: Use when tasks require partner portals forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Forecast Engine

## Purpose
Design and execute partner portals workflows using forecast engine controls with validated outcomes.
