---
name: maritime-routing-policy-evaluator
description: Use when tasks require maritime routing policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Policy Evaluator

## Purpose
Design and execute maritime routing workflows using policy evaluator controls with validated outcomes.
