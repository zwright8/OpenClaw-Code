---
name: bim-coordination-schema-introspector
description: Use when tasks require bim coordination schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Schema Introspector

## Purpose
Design and execute bim coordination workflows using schema introspector controls with validated outcomes.
