---
name: hospitality-pms-risk-scorer
description: Use when tasks require hospitality pms risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Risk Scorer

## Purpose
Design and execute hospitality pms workflows using risk scorer controls with validated outcomes.
