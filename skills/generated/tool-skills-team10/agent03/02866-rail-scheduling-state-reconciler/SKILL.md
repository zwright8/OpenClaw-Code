---
name: rail-scheduling-state-reconciler
description: Use when tasks require rail scheduling state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling State Reconciler

## Purpose
Design and execute rail scheduling workflows using state reconciler controls with validated outcomes.
