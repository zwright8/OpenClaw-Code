---
name: cpq-platforms-risk-scorer
description: Use when tasks require cpq platforms risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Risk Scorer

## Purpose
Design and execute cpq platforms workflows using risk scorer controls with validated outcomes.
