---
name: aml-monitoring-anomaly-detector
description: Use when tasks require aml monitoring anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Anomaly Detector

## Purpose
Design and execute aml monitoring workflows using anomaly detector controls with validated outcomes.
