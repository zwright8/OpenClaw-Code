---
name: bim-coordination-sla-enforcer
description: Use when tasks require bim coordination sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination SLA Enforcer

## Purpose
Design and execute bim coordination workflows using sla enforcer controls with validated outcomes.
