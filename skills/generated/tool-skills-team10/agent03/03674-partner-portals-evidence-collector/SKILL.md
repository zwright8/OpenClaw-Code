---
name: partner-portals-evidence-collector
description: Use when tasks require partner portals evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Evidence Collector

## Purpose
Design and execute partner portals workflows using evidence collector controls with validated outcomes.
