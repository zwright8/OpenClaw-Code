---
name: ad-platforms-spec-drift-detector
description: Use when tasks require ad platforms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Spec Drift Detector

## Purpose
Design and execute ad platforms workflows using spec drift detector controls with validated outcomes.
