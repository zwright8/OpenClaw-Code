---
name: payroll-systems-policy-evaluator
description: Use when tasks require payroll systems policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Policy Evaluator

## Purpose
Design and execute payroll systems workflows using policy evaluator controls with validated outcomes.
