---
name: payroll-systems-spec-drift-detector
description: Use when tasks require payroll systems spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Spec Drift Detector

## Purpose
Design and execute payroll systems workflows using spec drift detector controls with validated outcomes.
