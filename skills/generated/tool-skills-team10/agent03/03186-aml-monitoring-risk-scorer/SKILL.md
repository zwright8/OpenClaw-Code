---
name: aml-monitoring-risk-scorer
description: Use when tasks require aml monitoring risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Risk Scorer

## Purpose
Design and execute aml monitoring workflows using risk scorer controls with validated outcomes.
