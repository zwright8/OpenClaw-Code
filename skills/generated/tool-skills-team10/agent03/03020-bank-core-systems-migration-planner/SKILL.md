---
name: bank-core-systems-migration-planner
description: Use when tasks require bank core systems migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Migration Planner

## Purpose
Design and execute bank core systems workflows using migration planner controls with validated outcomes.
