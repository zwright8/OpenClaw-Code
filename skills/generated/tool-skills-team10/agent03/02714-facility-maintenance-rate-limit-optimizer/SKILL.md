---
name: facility-maintenance-rate-limit-optimizer
description: Use when tasks require facility maintenance rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Rate Limit Optimizer

## Purpose
Design and execute facility maintenance workflows using rate limit optimizer controls with validated outcomes.
