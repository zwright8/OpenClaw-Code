---
name: facility-maintenance-conflict-resolver
description: Use when tasks require facility maintenance conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Conflict Resolver

## Purpose
Design and execute facility maintenance workflows using conflict resolver controls with validated outcomes.
