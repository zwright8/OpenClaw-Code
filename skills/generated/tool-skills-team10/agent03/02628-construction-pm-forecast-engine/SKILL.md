---
name: construction-pm-forecast-engine
description: Use when tasks require construction pm forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Forecast Engine

## Purpose
Design and execute construction pm workflows using forecast engine controls with validated outcomes.
