---
name: revops-systems-evidence-collector
description: Use when tasks require revops systems evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RevOps Systems Evidence Collector

## Purpose
Design and execute revops systems workflows using evidence collector controls with validated outcomes.
