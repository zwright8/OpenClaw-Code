---
name: travel-compliance-task-decomposer
description: Use when tasks require travel compliance task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Travel Compliance Task Decomposer

## Purpose
Design and execute travel compliance workflows using task decomposer controls with validated outcomes.
