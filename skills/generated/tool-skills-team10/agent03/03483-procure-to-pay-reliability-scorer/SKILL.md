---
name: procure-to-pay-reliability-scorer
description: Use when tasks require procure to pay reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Reliability Scorer

## Purpose
Design and execute procure to pay workflows using reliability scorer controls with validated outcomes.
