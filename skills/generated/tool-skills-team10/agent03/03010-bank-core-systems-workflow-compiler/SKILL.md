---
name: bank-core-systems-workflow-compiler
description: Use when tasks require bank core systems workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Workflow Compiler

## Purpose
Design and execute bank core systems workflows using workflow compiler controls with validated outcomes.
