---
name: customer-data-platforms-task-decomposer
description: Use when tasks require customer data platforms task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Task Decomposer

## Purpose
Design and execute customer data platforms workflows using task decomposer controls with validated outcomes.
