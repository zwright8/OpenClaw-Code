---
name: expense-management-secret-scanner
description: Use when tasks require expense management secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Expense Management Secret Scanner

## Purpose
Design and execute expense management workflows using secret scanner controls with validated outcomes.
