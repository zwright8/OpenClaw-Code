---
name: marketing-attribution-remediation-planner
description: Use when tasks require marketing attribution remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Remediation Planner

## Purpose
Design and execute marketing attribution workflows using remediation planner controls with validated outcomes.
