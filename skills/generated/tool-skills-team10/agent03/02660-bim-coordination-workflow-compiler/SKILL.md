---
name: bim-coordination-workflow-compiler
description: Use when tasks require bim coordination workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Workflow Compiler

## Purpose
Design and execute bim coordination workflows using workflow compiler controls with validated outcomes.
