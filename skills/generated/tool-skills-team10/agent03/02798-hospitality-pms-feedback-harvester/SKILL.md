---
name: hospitality-pms-feedback-harvester
description: Use when tasks require hospitality pms feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Feedback Harvester

## Purpose
Design and execute hospitality pms workflows using feedback harvester controls with validated outcomes.
