---
name: hospitality-pms-secret-scanner
description: Use when tasks require hospitality pms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Secret Scanner

## Purpose
Design and execute hospitality pms workflows using secret scanner controls with validated outcomes.
