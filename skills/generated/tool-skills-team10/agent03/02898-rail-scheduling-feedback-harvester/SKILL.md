---
name: rail-scheduling-feedback-harvester
description: Use when tasks require rail scheduling feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Feedback Harvester

## Purpose
Design and execute rail scheduling workflows using feedback harvester controls with validated outcomes.
