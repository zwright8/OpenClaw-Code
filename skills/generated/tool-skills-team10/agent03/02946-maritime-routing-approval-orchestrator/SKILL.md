---
name: maritime-routing-approval-orchestrator
description: Use when tasks require maritime routing approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Approval Orchestrator

## Purpose
Design and execute maritime routing workflows using approval orchestrator controls with validated outcomes.
