---
name: procure-to-pay-postmortem-drafting
description: Use when tasks require procure to pay postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Postmortem Drafting

## Purpose
Design and execute procure to pay workflows using postmortem drafting controls with validated outcomes.
