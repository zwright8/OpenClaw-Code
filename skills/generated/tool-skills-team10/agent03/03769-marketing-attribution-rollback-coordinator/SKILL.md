---
name: marketing-attribution-rollback-coordinator
description: Use when tasks require marketing attribution rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Rollback Coordinator

## Purpose
Design and execute marketing attribution workflows using rollback coordinator controls with validated outcomes.
