---
name: payroll-systems-quality-gatekeeper
description: Use when tasks require payroll systems quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Quality Gatekeeper

## Purpose
Design and execute payroll systems workflows using quality gatekeeper controls with validated outcomes.
