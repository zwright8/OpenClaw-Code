---
name: payroll-systems-capacity-planner
description: Use when tasks require payroll systems capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Capacity Planner

## Purpose
Design and execute payroll systems workflows using capacity planner controls with validated outcomes.
