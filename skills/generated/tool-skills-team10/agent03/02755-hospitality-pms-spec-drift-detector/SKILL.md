---
name: hospitality-pms-spec-drift-detector
description: Use when tasks require hospitality pms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Spec Drift Detector

## Purpose
Design and execute hospitality pms workflows using spec drift detector controls with validated outcomes.
