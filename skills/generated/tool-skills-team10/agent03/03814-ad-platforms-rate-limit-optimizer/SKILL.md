---
name: ad-platforms-rate-limit-optimizer
description: Use when tasks require ad platforms rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Rate Limit Optimizer

## Purpose
Design and execute ad platforms workflows using rate limit optimizer controls with validated outcomes.
