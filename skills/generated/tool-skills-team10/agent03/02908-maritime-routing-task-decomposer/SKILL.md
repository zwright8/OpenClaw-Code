---
name: maritime-routing-task-decomposer
description: Use when tasks require maritime routing task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Task Decomposer

## Purpose
Design and execute maritime routing workflows using task decomposer controls with validated outcomes.
