---
name: cpq-platforms-remediation-planner
description: Use when tasks require cpq platforms remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Remediation Planner

## Purpose
Design and execute cpq platforms workflows using remediation planner controls with validated outcomes.
