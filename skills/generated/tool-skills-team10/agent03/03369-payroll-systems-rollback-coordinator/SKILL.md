---
name: payroll-systems-rollback-coordinator
description: Use when tasks require payroll systems rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Rollback Coordinator

## Purpose
Design and execute payroll systems workflows using rollback coordinator controls with validated outcomes.
