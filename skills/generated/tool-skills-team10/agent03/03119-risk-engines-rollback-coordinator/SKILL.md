---
name: risk-engines-rollback-coordinator
description: Use when tasks require risk engines rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Rollback Coordinator

## Purpose
Design and execute risk engines workflows using rollback coordinator controls with validated outcomes.
