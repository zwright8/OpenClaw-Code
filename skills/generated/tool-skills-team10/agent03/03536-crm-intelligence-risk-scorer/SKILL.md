---
name: crm-intelligence-risk-scorer
description: Use when tasks require crm intelligence risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Risk Scorer

## Purpose
Design and execute crm intelligence workflows using risk scorer controls with validated outcomes.
