---
name: treasury-management-spec-drift-detector
description: Use when tasks require treasury management spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Spec Drift Detector

## Purpose
Design and execute treasury management workflows using spec drift detector controls with validated outcomes.
