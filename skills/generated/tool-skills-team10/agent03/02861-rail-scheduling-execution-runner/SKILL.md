---
name: rail-scheduling-execution-runner
description: Use when tasks require rail scheduling execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Execution Runner

## Purpose
Design and execute rail scheduling workflows using execution runner controls with validated outcomes.
