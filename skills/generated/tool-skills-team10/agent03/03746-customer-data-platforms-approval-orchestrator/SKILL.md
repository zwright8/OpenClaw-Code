---
name: customer-data-platforms-approval-orchestrator
description: Use when tasks require customer data platforms approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Approval Orchestrator

## Purpose
Design and execute customer data platforms workflows using approval orchestrator controls with validated outcomes.
