---
name: bim-coordination-delta-calculator
description: Use when tasks require bim coordination delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Delta Calculator

## Purpose
Design and execute bim coordination workflows using delta calculator controls with validated outcomes.
