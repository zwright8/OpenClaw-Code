---
name: rail-scheduling-snapshot-manager
description: Use when tasks require rail scheduling snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Snapshot Manager

## Purpose
Design and execute rail scheduling workflows using snapshot manager controls with validated outcomes.
