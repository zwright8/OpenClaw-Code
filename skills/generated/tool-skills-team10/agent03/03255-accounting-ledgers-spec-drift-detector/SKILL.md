---
name: accounting-ledgers-spec-drift-detector
description: Use when tasks require accounting ledgers spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accounting Ledgers Spec Drift Detector

## Purpose
Design and execute accounting ledgers workflows using spec drift detector controls with validated outcomes.
