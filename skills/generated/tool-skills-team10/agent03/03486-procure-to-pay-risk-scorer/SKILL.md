---
name: procure-to-pay-risk-scorer
description: Use when tasks require procure to pay risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Risk Scorer

## Purpose
Design and execute procure to pay workflows using risk scorer controls with validated outcomes.
