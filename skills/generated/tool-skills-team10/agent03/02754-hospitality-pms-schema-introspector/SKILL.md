---
name: hospitality-pms-schema-introspector
description: Use when tasks require hospitality pms schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Schema Introspector

## Purpose
Design and execute hospitality pms workflows using schema introspector controls with validated outcomes.
