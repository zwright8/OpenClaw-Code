---
name: hospitality-pms-access-auditor
description: Use when tasks require hospitality pms access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Access Auditor

## Purpose
Design and execute hospitality pms workflows using access auditor controls with validated outcomes.
