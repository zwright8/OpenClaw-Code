---
name: marketing-attribution-artifact-publisher
description: Use when tasks require marketing attribution artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Artifact Publisher

## Purpose
Design and execute marketing attribution workflows using artifact publisher controls with validated outcomes.
