---
name: payroll-systems-access-auditor
description: Use when tasks require payroll systems access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Access Auditor

## Purpose
Design and execute payroll systems workflows using access auditor controls with validated outcomes.
