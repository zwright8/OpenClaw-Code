---
name: facility-maintenance-migration-planner
description: Use when tasks require facility maintenance migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Migration Planner

## Purpose
Design and execute facility maintenance workflows using migration planner controls with validated outcomes.
