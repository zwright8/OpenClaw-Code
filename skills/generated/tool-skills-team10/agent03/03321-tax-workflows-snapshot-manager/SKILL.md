---
name: tax-workflows-snapshot-manager
description: Use when tasks require tax workflows snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Tax Workflows Snapshot Manager

## Purpose
Design and execute tax workflows workflows using snapshot manager controls with validated outcomes.
