---
name: facility-maintenance-api-contract-validator
description: Use when tasks require facility maintenance api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance API Contract Validator

## Purpose
Design and execute facility maintenance workflows using api contract validator controls with validated outcomes.
...
- Domain: [Facility Maintenance](../../resources/domains/facility-maintenance.md)
