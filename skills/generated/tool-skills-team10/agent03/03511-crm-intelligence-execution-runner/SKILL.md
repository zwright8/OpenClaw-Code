---
name: crm-intelligence-execution-runner
description: Use when tasks require crm intelligence execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Execution Runner

## Purpose
Design and execute crm intelligence workflows using execution runner controls with validated outcomes.
