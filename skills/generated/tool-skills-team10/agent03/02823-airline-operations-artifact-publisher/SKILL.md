---
name: airline-operations-artifact-publisher
description: Use when tasks require airline operations artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Artifact Publisher

## Purpose
Design and execute airline operations workflows using artifact publisher controls with validated outcomes.
