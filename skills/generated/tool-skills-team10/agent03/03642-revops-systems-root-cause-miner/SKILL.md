---
name: revops-systems-root-cause-miner
description: Use when tasks require revops systems root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RevOps Systems Root Cause Miner

## Purpose
Design and execute revops systems workflows using root cause miner controls with validated outcomes.
