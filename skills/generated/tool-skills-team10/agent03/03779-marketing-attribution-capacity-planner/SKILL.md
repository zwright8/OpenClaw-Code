---
name: marketing-attribution-capacity-planner
description: Use when tasks require marketing attribution capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Capacity Planner

## Purpose
Design and execute marketing attribution workflows using capacity planner controls with validated outcomes.
