---
name: construction-pm-delta-calculator
description: Use when tasks require construction pm delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Delta Calculator

## Purpose
Design and execute construction pm workflows using delta calculator controls with validated outcomes.
