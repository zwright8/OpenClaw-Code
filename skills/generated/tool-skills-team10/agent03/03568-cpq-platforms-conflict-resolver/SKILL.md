---
name: cpq-platforms-conflict-resolver
description: Use when tasks require cpq platforms conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Conflict Resolver

## Purpose
Design and execute cpq platforms workflows using conflict resolver controls with validated outcomes.
