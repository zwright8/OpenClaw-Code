---
name: aml-monitoring-pii-redactor
description: Use when tasks require aml monitoring pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring PII Redactor

## Purpose
Design and execute aml monitoring workflows using pii redactor controls with validated outcomes.
