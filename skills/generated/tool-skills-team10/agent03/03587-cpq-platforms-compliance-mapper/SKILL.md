---
name: cpq-platforms-compliance-mapper
description: Use when tasks require cpq platforms compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Compliance Mapper

## Purpose
Design and execute cpq platforms workflows using compliance mapper controls with validated outcomes.
