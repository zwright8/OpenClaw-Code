---
name: crm-intelligence-forecast-engine
description: Use when tasks require crm intelligence forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Forecast Engine

## Purpose
Design and execute crm intelligence workflows using forecast engine controls with validated outcomes.
