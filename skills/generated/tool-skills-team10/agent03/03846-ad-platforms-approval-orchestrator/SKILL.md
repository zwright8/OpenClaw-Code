---
name: ad-platforms-approval-orchestrator
description: Use when tasks require ad platforms approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Approval Orchestrator

## Purpose
Design and execute ad platforms workflows using approval orchestrator controls with validated outcomes.
