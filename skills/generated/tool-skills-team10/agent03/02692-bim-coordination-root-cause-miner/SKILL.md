---
name: bim-coordination-root-cause-miner
description: Use when tasks require bim coordination root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Root Cause Miner

## Purpose
Design and execute bim coordination workflows using root cause miner controls with validated outcomes.
