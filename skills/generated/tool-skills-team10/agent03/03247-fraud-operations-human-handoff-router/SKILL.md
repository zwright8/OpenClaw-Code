---
name: fraud-operations-human-handoff-router
description: Use when tasks require fraud operations human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Human Handoff Router

## Purpose
Design and execute fraud operations workflows using human handoff router controls with validated outcomes.
