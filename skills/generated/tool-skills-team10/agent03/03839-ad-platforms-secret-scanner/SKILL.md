---
name: ad-platforms-secret-scanner
description: Use when tasks require ad platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Secret Scanner

## Purpose
Design and execute ad platforms workflows using secret scanner controls with validated outcomes.
