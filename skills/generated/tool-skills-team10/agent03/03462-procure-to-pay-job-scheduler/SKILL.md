---
name: procure-to-pay-job-scheduler
description: Use when tasks require procure to pay job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Job Scheduler

## Purpose
Design and execute procure to pay workflows using job scheduler controls with validated outcomes.
