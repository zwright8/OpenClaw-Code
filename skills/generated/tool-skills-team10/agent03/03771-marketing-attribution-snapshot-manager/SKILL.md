---
name: marketing-attribution-snapshot-manager
description: Use when tasks require marketing attribution snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Snapshot Manager

## Purpose
Design and execute marketing attribution workflows using snapshot manager controls with validated outcomes.
