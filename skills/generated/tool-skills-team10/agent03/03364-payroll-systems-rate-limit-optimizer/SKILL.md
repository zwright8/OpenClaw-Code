---
name: payroll-systems-rate-limit-optimizer
description: Use when tasks require payroll systems rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Rate Limit Optimizer

## Purpose
Design and execute payroll systems workflows using rate limit optimizer controls with validated outcomes.
