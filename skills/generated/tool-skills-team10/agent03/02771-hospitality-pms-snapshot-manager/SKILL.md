---
name: hospitality-pms-snapshot-manager
description: Use when tasks require hospitality pms snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Snapshot Manager

## Purpose
Design and execute hospitality pms workflows using snapshot manager controls with validated outcomes.
