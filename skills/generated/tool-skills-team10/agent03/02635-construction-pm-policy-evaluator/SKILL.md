---
name: construction-pm-policy-evaluator
description: Use when tasks require construction pm policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Policy Evaluator

## Purpose
Design and execute construction pm workflows using policy evaluator controls with validated outcomes.
