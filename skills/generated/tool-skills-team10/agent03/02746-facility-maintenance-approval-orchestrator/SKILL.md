---
name: facility-maintenance-approval-orchestrator
description: Use when tasks require facility maintenance approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Approval Orchestrator

## Purpose
Design and execute facility maintenance workflows using approval orchestrator controls with validated outcomes.
