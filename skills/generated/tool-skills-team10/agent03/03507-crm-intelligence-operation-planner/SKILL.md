---
name: crm-intelligence-operation-planner
description: Use when tasks require crm intelligence operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Operation Planner

## Purpose
Design and execute crm intelligence workflows using operation planner controls with validated outcomes.
