---
name: rail-scheduling-migration-planner
description: Use when tasks require rail scheduling migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Migration Planner

## Purpose
Design and execute rail scheduling workflows using migration planner controls with validated outcomes.
