---
name: facility-maintenance-anomaly-detector
description: Use when tasks require facility maintenance anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Anomaly Detector

## Purpose
Design and execute facility maintenance workflows using anomaly detector controls with validated outcomes.
