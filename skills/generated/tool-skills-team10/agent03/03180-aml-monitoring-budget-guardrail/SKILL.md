---
name: aml-monitoring-budget-guardrail
description: Use when tasks require aml monitoring budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Budget Guardrail

## Purpose
Design and execute aml monitoring workflows using budget guardrail controls with validated outcomes.
