---
name: partner-portals-delta-calculator
description: Use when tasks require partner portals delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Delta Calculator

## Purpose
Design and execute partner portals workflows using delta calculator controls with validated outcomes.
