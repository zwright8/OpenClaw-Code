---
name: crm-intelligence-compliance-mapper
description: Use when tasks require crm intelligence compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Compliance Mapper

## Purpose
Design and execute crm intelligence workflows using compliance mapper controls with validated outcomes.
