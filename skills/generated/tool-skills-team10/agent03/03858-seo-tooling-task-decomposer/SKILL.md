---
name: seo-tooling-task-decomposer
description: Use when tasks require seo tooling task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SEO Tooling Task Decomposer

## Purpose
Design and execute seo tooling workflows using task decomposer controls with validated outcomes.
