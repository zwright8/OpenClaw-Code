---
name: hospitality-pms-reliability-scorer
description: Use when tasks require hospitality pms reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Reliability Scorer

## Purpose
Design and execute hospitality pms workflows using reliability scorer controls with validated outcomes.
