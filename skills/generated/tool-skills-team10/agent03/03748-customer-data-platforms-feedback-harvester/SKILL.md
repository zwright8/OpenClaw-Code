---
name: customer-data-platforms-feedback-harvester
description: Use when tasks require customer data platforms feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Feedback Harvester

## Purpose
Design and execute customer data platforms workflows using feedback harvester controls with validated outcomes.
