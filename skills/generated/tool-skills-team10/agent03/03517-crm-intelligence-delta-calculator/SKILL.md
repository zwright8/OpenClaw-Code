---
name: crm-intelligence-delta-calculator
description: Use when tasks require crm intelligence delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Delta Calculator

## Purpose
Design and execute crm intelligence workflows using delta calculator controls with validated outcomes.
