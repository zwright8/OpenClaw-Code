---
name: construction-pm-cost-attribution
description: Use when tasks require construction pm cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Cost Attribution

## Purpose
Design and execute construction pm workflows using cost attribution controls with validated outcomes.
