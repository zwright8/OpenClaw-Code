---
name: maritime-routing-human-handoff-router
description: Use when tasks require maritime routing human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Human Handoff Router

## Purpose
Design and execute maritime routing workflows using human handoff router controls with validated outcomes.
