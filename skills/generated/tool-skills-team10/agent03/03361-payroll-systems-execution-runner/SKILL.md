---
name: payroll-systems-execution-runner
description: Use when tasks require payroll systems execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Execution Runner

## Purpose
Design and execute payroll systems workflows using execution runner controls with validated outcomes.
