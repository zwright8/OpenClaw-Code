---
name: maritime-routing-rate-limit-optimizer
description: Use when tasks require maritime routing rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Rate Limit Optimizer

## Purpose
Design and execute maritime routing workflows using rate limit optimizer controls with validated outcomes.
