---
name: fraud-operations-compliance-mapper
description: Use when tasks require fraud operations compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Compliance Mapper

## Purpose
Design and execute fraud operations workflows using compliance mapper controls with validated outcomes.
