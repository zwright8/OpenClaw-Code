---
name: customer-data-platforms-workflow-compiler
description: Use when tasks require customer data platforms workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Workflow Compiler

## Purpose
Design and execute customer data platforms workflows using workflow compiler controls with validated outcomes.
