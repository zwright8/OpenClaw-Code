---
name: facility-maintenance-quality-gatekeeper
description: Use when tasks require facility maintenance quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Quality Gatekeeper

## Purpose
Design and execute facility maintenance workflows using quality gatekeeper controls with validated outcomes.
