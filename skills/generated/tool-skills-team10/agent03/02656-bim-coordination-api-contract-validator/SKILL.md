---
name: bim-coordination-api-contract-validator
description: Use when tasks require bim coordination api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination API Contract Validator

## Purpose
Design and execute bim coordination workflows using api contract validator controls with validated outcomes.
...
- Domain: [BIM Coordination](../../resources/domains/bim-coordination.md)
