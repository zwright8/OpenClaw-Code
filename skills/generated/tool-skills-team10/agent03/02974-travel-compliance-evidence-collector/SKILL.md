---
name: travel-compliance-evidence-collector
description: Use when tasks require travel compliance evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Travel Compliance Evidence Collector

## Purpose
Design and execute travel compliance workflows using evidence collector controls with validated outcomes.
