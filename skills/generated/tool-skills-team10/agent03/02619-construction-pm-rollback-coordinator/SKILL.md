---
name: construction-pm-rollback-coordinator
description: Use when tasks require construction pm rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Rollback Coordinator

## Purpose
Design and execute construction pm workflows using rollback coordinator controls with validated outcomes.
