---
name: fraud-operations-evidence-collector
description: Use when tasks require fraud operations evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Evidence Collector

## Purpose
Design and execute fraud operations workflows using evidence collector controls with validated outcomes.
