---
name: bim-coordination-approval-orchestrator
description: Use when tasks require bim coordination approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Approval Orchestrator

## Purpose
Design and execute bim coordination workflows using approval orchestrator controls with validated outcomes.
