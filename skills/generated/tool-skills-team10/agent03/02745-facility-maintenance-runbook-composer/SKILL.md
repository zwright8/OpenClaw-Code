---
name: facility-maintenance-runbook-composer
description: Use when tasks require facility maintenance runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Runbook Composer

## Purpose
Design and execute facility maintenance workflows using runbook composer controls with validated outcomes.
