---
name: bank-core-systems-retry-governor
description: Use when tasks require bank core systems retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Retry Governor

## Purpose
Design and execute bank core systems workflows using retry governor controls with validated outcomes.
