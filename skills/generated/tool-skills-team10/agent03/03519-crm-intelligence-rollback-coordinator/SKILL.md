---
name: crm-intelligence-rollback-coordinator
description: Use when tasks require crm intelligence rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Rollback Coordinator

## Purpose
Design and execute crm intelligence workflows using rollback coordinator controls with validated outcomes.
