---
name: hospitality-pms-job-scheduler
description: Use when tasks require hospitality pms job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Job Scheduler

## Purpose
Design and execute hospitality pms workflows using job scheduler controls with validated outcomes.
