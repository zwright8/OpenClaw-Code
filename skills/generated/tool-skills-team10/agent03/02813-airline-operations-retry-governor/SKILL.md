---
name: airline-operations-retry-governor
description: Use when tasks require airline operations retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Retry Governor

## Purpose
Design and execute airline operations workflows using retry governor controls with validated outcomes.
