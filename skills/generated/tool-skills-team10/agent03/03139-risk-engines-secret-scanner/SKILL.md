---
name: risk-engines-secret-scanner
description: Use when tasks require risk engines secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Secret Scanner

## Purpose
Design and execute risk engines workflows using secret scanner controls with validated outcomes.
