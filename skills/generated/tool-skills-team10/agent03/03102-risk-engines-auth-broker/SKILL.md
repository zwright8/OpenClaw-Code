---
name: risk-engines-auth-broker
description: Use when tasks require risk engines auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Auth Broker

## Purpose
Design and execute risk engines workflows using auth broker controls with validated outcomes.
