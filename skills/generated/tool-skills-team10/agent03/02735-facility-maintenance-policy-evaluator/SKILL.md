---
name: facility-maintenance-policy-evaluator
description: Use when tasks require facility maintenance policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Policy Evaluator

## Purpose
Design and execute facility maintenance workflows using policy evaluator controls with validated outcomes.
