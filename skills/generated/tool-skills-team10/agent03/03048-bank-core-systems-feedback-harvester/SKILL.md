---
name: bank-core-systems-feedback-harvester
description: Use when tasks require bank core systems feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Feedback Harvester

## Purpose
Design and execute bank core systems workflows using feedback harvester controls with validated outcomes.
