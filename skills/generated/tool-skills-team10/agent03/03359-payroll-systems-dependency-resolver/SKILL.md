---
name: payroll-systems-dependency-resolver
description: Use when tasks require payroll systems dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Dependency Resolver

## Purpose
Design and execute payroll systems workflows using dependency resolver controls with validated outcomes.
