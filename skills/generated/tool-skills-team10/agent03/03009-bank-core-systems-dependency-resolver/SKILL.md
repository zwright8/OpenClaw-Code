---
name: bank-core-systems-dependency-resolver
description: Use when tasks require bank core systems dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Dependency Resolver

## Purpose
Design and execute bank core systems workflows using dependency resolver controls with validated outcomes.
