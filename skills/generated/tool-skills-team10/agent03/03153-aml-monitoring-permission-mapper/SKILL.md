---
name: aml-monitoring-permission-mapper
description: Use when tasks require aml monitoring permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Permission Mapper

## Purpose
Design and execute aml monitoring workflows using permission mapper controls with validated outcomes.
