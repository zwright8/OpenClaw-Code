---
name: maritime-routing-capacity-planner
description: Use when tasks require maritime routing capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Capacity Planner

## Purpose
Design and execute maritime routing workflows using capacity planner controls with validated outcomes.
