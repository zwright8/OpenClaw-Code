---
name: airline-operations-anomaly-detector
description: Use when tasks require airline operations anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Anomaly Detector

## Purpose
Design and execute airline operations workflows using anomaly detector controls with validated outcomes.
