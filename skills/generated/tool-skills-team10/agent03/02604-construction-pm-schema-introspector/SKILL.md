---
name: construction-pm-schema-introspector
description: Use when tasks require construction pm schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Schema Introspector

## Purpose
Design and execute construction pm workflows using schema introspector controls with validated outcomes.
