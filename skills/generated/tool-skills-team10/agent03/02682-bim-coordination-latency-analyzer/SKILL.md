---
name: bim-coordination-latency-analyzer
description: Use when tasks require bim coordination latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Latency Analyzer

## Purpose
Design and execute bim coordination workflows using latency analyzer controls with validated outcomes.
