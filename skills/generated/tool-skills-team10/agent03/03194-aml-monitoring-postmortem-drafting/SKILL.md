---
name: aml-monitoring-postmortem-drafting
description: Use when tasks require aml monitoring postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Postmortem Drafting

## Purpose
Design and execute aml monitoring workflows using postmortem drafting controls with validated outcomes.
