---
name: hospitality-pms-remediation-planner
description: Use when tasks require hospitality pms remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Remediation Planner

## Purpose
Design and execute hospitality pms workflows using remediation planner controls with validated outcomes.
