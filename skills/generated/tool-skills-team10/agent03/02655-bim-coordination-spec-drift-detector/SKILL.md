---
name: bim-coordination-spec-drift-detector
description: Use when tasks require bim coordination spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Spec Drift Detector

## Purpose
Design and execute bim coordination workflows using spec drift detector controls with validated outcomes.
