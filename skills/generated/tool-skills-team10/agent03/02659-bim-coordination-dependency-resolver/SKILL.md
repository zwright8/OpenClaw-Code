---
name: bim-coordination-dependency-resolver
description: Use when tasks require bim coordination dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Dependency Resolver

## Purpose
Design and execute bim coordination workflows using dependency resolver controls with validated outcomes.
