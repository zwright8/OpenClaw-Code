---
name: procure-to-pay-workflow-compiler
description: Use when tasks require procure to pay workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Workflow Compiler

## Purpose
Design and execute procure to pay workflows using workflow compiler controls with validated outcomes.
