---
name: customer-data-platforms-incident-triage
description: Use when tasks require customer data platforms incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Incident Triage

## Purpose
Design and execute customer data platforms workflows using incident triage controls with validated outcomes.
