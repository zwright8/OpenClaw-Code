---
name: accounting-ledgers-root-cause-miner
description: Use when tasks require accounting ledgers root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accounting Ledgers Root Cause Miner

## Purpose
Design and execute accounting ledgers workflows using root cause miner controls with validated outcomes.
