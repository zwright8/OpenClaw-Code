...
description: Use when tasks require procure to pay human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Human Handoff Router

## Purpose
Design and execute procure to pay workflows using human handoff router controls with validated outcomes.
