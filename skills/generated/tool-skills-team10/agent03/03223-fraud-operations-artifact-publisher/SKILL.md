---
name: fraud-operations-artifact-publisher
description: Use when tasks require fraud operations artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Artifact Publisher

## Purpose
Design and execute fraud operations workflows using artifact publisher controls with validated outcomes.
