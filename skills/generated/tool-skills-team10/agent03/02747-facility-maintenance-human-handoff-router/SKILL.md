---
name: facility-maintenance-human-handoff-router
description: Use when tasks require facility maintenance human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Human Handoff Router

## Purpose
Design and execute facility maintenance workflows using human handoff router controls with validated outcomes.
