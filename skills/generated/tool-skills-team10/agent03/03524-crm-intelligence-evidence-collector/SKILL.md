---
name: crm-intelligence-evidence-collector
description: Use when tasks require crm intelligence evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Evidence Collector

## Purpose
Design and execute crm intelligence workflows using evidence collector controls with validated outcomes.
