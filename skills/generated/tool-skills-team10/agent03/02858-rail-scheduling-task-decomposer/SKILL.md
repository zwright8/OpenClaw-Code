---
name: rail-scheduling-task-decomposer
description: Use when tasks require rail scheduling task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Task Decomposer

## Purpose
Design and execute rail scheduling workflows using task decomposer controls with validated outcomes.
