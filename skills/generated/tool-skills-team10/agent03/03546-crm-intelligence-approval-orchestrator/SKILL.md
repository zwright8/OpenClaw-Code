---
name: crm-intelligence-approval-orchestrator
description: Use when tasks require crm intelligence approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Approval Orchestrator

## Purpose
Design and execute crm intelligence workflows using approval orchestrator controls with validated outcomes.
