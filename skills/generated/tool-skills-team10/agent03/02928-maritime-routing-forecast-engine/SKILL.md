---
name: maritime-routing-forecast-engine
description: Use when tasks require maritime routing forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Forecast Engine

## Purpose
Design and execute maritime routing workflows using forecast engine controls with validated outcomes.
