---
name: rail-scheduling-root-cause-miner
description: Use when tasks require rail scheduling root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Root Cause Miner

## Purpose
Design and execute rail scheduling workflows using root cause miner controls with validated outcomes.
