---
name: crm-intelligence-remediation-planner
description: Use when tasks require crm intelligence remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Remediation Planner

## Purpose
Design and execute crm intelligence workflows using remediation planner controls with validated outcomes.
