---
name: bank-core-systems-state-reconciler
description: Use when tasks require bank core systems state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems State Reconciler

## Purpose
Design and execute bank core systems workflows using state reconciler controls with validated outcomes.
