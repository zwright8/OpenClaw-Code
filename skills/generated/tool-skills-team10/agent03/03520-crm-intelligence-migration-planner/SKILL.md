---
name: crm-intelligence-migration-planner
description: Use when tasks require crm intelligence migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Migration Planner

## Purpose
Design and execute crm intelligence workflows using migration planner controls with validated outcomes.
