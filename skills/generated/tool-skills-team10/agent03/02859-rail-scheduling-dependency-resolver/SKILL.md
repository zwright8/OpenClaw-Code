---
name: rail-scheduling-dependency-resolver
description: Use when tasks require rail scheduling dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Dependency Resolver

## Purpose
Design and execute rail scheduling workflows using dependency resolver controls with validated outcomes.
