---
name: procure-to-pay-rollback-coordinator
description: Use when tasks require procure to pay rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Rollback Coordinator

## Purpose
Design and execute procure to pay workflows using rollback coordinator controls with validated outcomes.
