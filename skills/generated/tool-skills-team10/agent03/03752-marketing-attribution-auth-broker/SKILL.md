---
name: marketing-attribution-auth-broker
description: Use when tasks require marketing attribution auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Auth Broker

## Purpose
Design and execute marketing attribution workflows using auth broker controls with validated outcomes.
