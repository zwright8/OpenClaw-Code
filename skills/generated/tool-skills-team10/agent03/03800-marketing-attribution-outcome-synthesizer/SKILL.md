---
name: marketing-attribution-outcome-synthesizer
description: Use when tasks require marketing attribution outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Outcome Synthesizer

## Purpose
Design and execute marketing attribution workflows using outcome synthesizer controls with validated outcomes.
