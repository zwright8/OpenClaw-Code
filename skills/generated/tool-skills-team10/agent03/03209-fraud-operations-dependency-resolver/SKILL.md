---
name: fraud-operations-dependency-resolver
description: Use when tasks require fraud operations dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Dependency Resolver

## Purpose
Design and execute fraud operations workflows using dependency resolver controls with validated outcomes.
