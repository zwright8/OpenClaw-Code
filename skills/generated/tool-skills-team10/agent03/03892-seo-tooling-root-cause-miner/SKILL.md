---
name: seo-tooling-root-cause-miner
description: Use when tasks require seo tooling root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SEO Tooling Root Cause Miner

## Purpose
Design and execute seo tooling workflows using root cause miner controls with validated outcomes.
