---
name: facility-maintenance-reliability-scorer
description: Use when tasks require facility maintenance reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Reliability Scorer

## Purpose
Design and execute facility maintenance workflows using reliability scorer controls with validated outcomes.
