---
name: bank-core-systems-spec-drift-detector
description: Use when tasks require bank core systems spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Spec Drift Detector

## Purpose
Design and execute bank core systems workflows using spec drift detector controls with validated outcomes.
