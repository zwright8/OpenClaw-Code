---
name: bim-coordination-risk-scorer
description: Use when tasks require bim coordination risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Risk Scorer

## Purpose
Design and execute bim coordination workflows using risk scorer controls with validated outcomes.
