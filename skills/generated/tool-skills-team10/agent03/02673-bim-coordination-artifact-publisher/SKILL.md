---
name: bim-coordination-artifact-publisher
description: Use when tasks require bim coordination artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Artifact Publisher

## Purpose
Design and execute bim coordination workflows using artifact publisher controls with validated outcomes.
