---
name: airline-operations-dependency-resolver
description: Use when tasks require airline operations dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Dependency Resolver

## Purpose
Design and execute airline operations workflows using dependency resolver controls with validated outcomes.
