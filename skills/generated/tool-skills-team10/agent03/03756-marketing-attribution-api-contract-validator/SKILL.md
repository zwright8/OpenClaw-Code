---
name: marketing-attribution-api-contract-validator
description: Use when tasks require marketing attribution api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution API Contract Validator

## Purpose
Design and execute marketing attribution workflows using api contract validator controls with validated outcomes.
...
- Domain: [Marketing Attribution](../../resources/domains/marketing-attribution.md)
