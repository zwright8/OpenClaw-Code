---
name: bim-coordination-state-reconciler
description: Use when tasks require bim coordination state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination State Reconciler

## Purpose
Design and execute bim coordination workflows using state reconciler controls with validated outcomes.
