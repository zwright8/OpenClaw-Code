---
name: fraud-operations-retry-governor
description: Use when tasks require fraud operations retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Retry Governor

## Purpose
Design and execute fraud operations workflows using retry governor controls with validated outcomes.
