---
name: aml-monitoring-artifact-publisher
description: Use when tasks require aml monitoring artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Artifact Publisher

## Purpose
Design and execute aml monitoring workflows using artifact publisher controls with validated outcomes.
