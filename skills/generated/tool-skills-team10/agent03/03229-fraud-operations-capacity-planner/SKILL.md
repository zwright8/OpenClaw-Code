---
name: fraud-operations-capacity-planner
description: Use when tasks require fraud operations capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Capacity Planner

## Purpose
Design and execute fraud operations workflows using capacity planner controls with validated outcomes.
