---
name: marketing-attribution-access-auditor
description: Use when tasks require marketing attribution access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Access Auditor

## Purpose
Design and execute marketing attribution workflows using access auditor controls with validated outcomes.
