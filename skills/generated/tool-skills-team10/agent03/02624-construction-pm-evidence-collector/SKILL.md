---
name: construction-pm-evidence-collector
description: Use when tasks require construction pm evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Evidence Collector

## Purpose
Design and execute construction pm workflows using evidence collector controls with validated outcomes.
