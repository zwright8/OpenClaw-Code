---
name: procure-to-pay-conflict-resolver
description: Use when tasks require procure to pay conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Conflict Resolver

## Purpose
Design and execute procure to pay workflows using conflict resolver controls with validated outcomes.
