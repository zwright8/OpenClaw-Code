---
name: tax-workflows-postmortem-drafting
description: Use when tasks require tax workflows postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Tax Workflows Postmortem Drafting

## Purpose
Design and execute tax workflows workflows using postmortem drafting controls with validated outcomes.
