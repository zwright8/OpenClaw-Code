---
name: cpq-platforms-schema-introspector
description: Use when tasks require cpq platforms schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Schema Introspector

## Purpose
Design and execute cpq platforms workflows using schema introspector controls with validated outcomes.
