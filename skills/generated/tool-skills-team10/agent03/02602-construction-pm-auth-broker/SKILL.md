---
name: construction-pm-auth-broker
description: Use when tasks require construction pm auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Auth Broker

## Purpose
Design and execute construction pm workflows using auth broker controls with validated outcomes.
