---
name: cpq-platforms-approval-orchestrator
description: Use when tasks require cpq platforms approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Approval Orchestrator

## Purpose
Design and execute cpq platforms workflows using approval orchestrator controls with validated outcomes.
