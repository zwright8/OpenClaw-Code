---
name: maritime-routing-operation-planner
description: Use when tasks require maritime routing operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Operation Planner

## Purpose
Design and execute maritime routing workflows using operation planner controls with validated outcomes.
