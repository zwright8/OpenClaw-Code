---
name: customer-data-platforms-migration-planner
description: Use when tasks require customer data platforms migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Migration Planner

## Purpose
Design and execute customer data platforms workflows using migration planner controls with validated outcomes.
