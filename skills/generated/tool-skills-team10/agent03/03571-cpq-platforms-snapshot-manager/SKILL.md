---
name: cpq-platforms-snapshot-manager
description: Use when tasks require cpq platforms snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Snapshot Manager

## Purpose
Design and execute cpq platforms workflows using snapshot manager controls with validated outcomes.
