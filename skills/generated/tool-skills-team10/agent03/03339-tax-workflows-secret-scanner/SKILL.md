---
name: tax-workflows-secret-scanner
description: Use when tasks require tax workflows secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Tax Workflows Secret Scanner

## Purpose
Design and execute tax workflows workflows using secret scanner controls with validated outcomes.
