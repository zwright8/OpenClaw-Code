---
name: airline-operations-budget-guardrail
description: Use when tasks require airline operations budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Budget Guardrail

## Purpose
Design and execute airline operations workflows using budget guardrail controls with validated outcomes.
