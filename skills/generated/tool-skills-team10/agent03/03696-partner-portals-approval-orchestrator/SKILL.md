---
name: partner-portals-approval-orchestrator
description: Use when tasks require partner portals approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Approval Orchestrator

## Purpose
Design and execute partner portals workflows using approval orchestrator controls with validated outcomes.
