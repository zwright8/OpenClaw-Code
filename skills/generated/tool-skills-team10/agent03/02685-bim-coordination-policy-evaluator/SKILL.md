---
name: bim-coordination-policy-evaluator
description: Use when tasks require bim coordination policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Policy Evaluator

## Purpose
Design and execute bim coordination workflows using policy evaluator controls with validated outcomes.
