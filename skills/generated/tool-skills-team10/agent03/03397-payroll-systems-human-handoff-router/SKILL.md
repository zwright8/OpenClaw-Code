---
name: payroll-systems-human-handoff-router
description: Use when tasks require payroll systems human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Human Handoff Router

## Purpose
Design and execute payroll systems workflows using human handoff router controls with validated outcomes.
