---
name: fraud-operations-feedback-harvester
description: Use when tasks require fraud operations feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Feedback Harvester

## Purpose
Design and execute fraud operations workflows using feedback harvester controls with validated outcomes.
