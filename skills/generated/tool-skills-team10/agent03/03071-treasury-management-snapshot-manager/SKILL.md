---
name: treasury-management-snapshot-manager
description: Use when tasks require treasury management snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Snapshot Manager

## Purpose
Design and execute treasury management workflows using snapshot manager controls with validated outcomes.
