---
name: cpq-platforms-rollback-coordinator
description: Use when tasks require cpq platforms rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Rollback Coordinator

## Purpose
Design and execute cpq platforms workflows using rollback coordinator controls with validated outcomes.
