---
name: procure-to-pay-operation-planner
description: Use when tasks require procure to pay operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Operation Planner

## Purpose
Design and execute procure to pay workflows using operation planner controls with validated outcomes.
