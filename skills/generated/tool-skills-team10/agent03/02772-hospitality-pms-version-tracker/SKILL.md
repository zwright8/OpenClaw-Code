---
name: hospitality-pms-version-tracker
description: Use when tasks require hospitality pms version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Version Tracker

## Purpose
Design and execute hospitality pms workflows using version tracker controls with validated outcomes.
