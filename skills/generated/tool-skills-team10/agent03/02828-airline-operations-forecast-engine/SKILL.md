---
name: airline-operations-forecast-engine
description: Use when tasks require airline operations forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Forecast Engine

## Purpose
Design and execute airline operations workflows using forecast engine controls with validated outcomes.
