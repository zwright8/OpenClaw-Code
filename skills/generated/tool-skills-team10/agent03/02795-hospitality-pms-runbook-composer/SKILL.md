---
name: hospitality-pms-runbook-composer
description: Use when tasks require hospitality pms runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Runbook Composer

## Purpose
Design and execute hospitality pms workflows using runbook composer controls with validated outcomes.
