---
name: construction-pm-task-decomposer
description: Use when tasks require construction pm task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Task Decomposer

## Purpose
Design and execute construction pm workflows using task decomposer controls with validated outcomes.
