---
name: bank-core-systems-forecast-engine
description: Use when tasks require bank core systems forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Forecast Engine

## Purpose
Design and execute bank core systems workflows using forecast engine controls with validated outcomes.
