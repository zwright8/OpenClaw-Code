---
name: crm-intelligence-anomaly-detector
description: Use when tasks require crm intelligence anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Anomaly Detector

## Purpose
Design and execute crm intelligence workflows using anomaly detector controls with validated outcomes.
