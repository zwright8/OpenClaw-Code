---
name: airline-operations-reliability-scorer
description: Use when tasks require airline operations reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Reliability Scorer

## Purpose
Design and execute airline operations workflows using reliability scorer controls with validated outcomes.
