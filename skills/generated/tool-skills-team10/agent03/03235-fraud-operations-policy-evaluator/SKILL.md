---
name: fraud-operations-policy-evaluator
description: Use when tasks require fraud operations policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Policy Evaluator

## Purpose
Design and execute fraud operations workflows using policy evaluator controls with validated outcomes.
