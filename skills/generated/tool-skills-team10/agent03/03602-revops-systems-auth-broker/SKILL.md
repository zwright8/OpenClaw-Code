---
name: revops-systems-auth-broker
description: Use when tasks require revops systems auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RevOps Systems Auth Broker

## Purpose
Design and execute revops systems workflows using auth broker controls with validated outcomes.
