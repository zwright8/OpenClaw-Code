---
name: bank-core-systems-incident-triage
description: Use when tasks require bank core systems incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Incident Triage

## Purpose
Design and execute bank core systems workflows using incident triage controls with validated outcomes.
