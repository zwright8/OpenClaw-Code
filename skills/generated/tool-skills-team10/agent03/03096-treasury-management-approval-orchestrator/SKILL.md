---
name: treasury-management-approval-orchestrator
description: Use when tasks require treasury management approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Approval Orchestrator

## Purpose
Design and execute treasury management workflows using approval orchestrator controls with validated outcomes.
