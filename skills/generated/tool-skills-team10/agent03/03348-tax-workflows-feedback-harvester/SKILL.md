---
name: tax-workflows-feedback-harvester
description: Use when tasks require tax workflows feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Tax Workflows Feedback Harvester

## Purpose
Design and execute tax workflows workflows using feedback harvester controls with validated outcomes.
