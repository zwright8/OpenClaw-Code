---
name: facility-maintenance-risk-scorer
description: Use when tasks require facility maintenance risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Risk Scorer

## Purpose
Design and execute facility maintenance workflows using risk scorer controls with validated outcomes.
