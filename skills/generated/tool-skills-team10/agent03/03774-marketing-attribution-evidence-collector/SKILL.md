---
name: marketing-attribution-evidence-collector
description: Use when tasks require marketing attribution evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Evidence Collector

## Purpose
Design and execute marketing attribution workflows using evidence collector controls with validated outcomes.
