---
name: aml-monitoring-compliance-mapper
description: Use when tasks require aml monitoring compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Compliance Mapper

## Purpose
Design and execute aml monitoring workflows using compliance mapper controls with validated outcomes.
