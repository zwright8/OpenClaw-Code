---
name: cpq-platforms-capacity-planner
description: Use when tasks require cpq platforms capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Capacity Planner

## Purpose
Design and execute cpq platforms workflows using capacity planner controls with validated outcomes.
