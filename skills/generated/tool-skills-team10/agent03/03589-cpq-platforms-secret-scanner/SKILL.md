---
name: cpq-platforms-secret-scanner
description: Use when tasks require cpq platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Secret Scanner

## Purpose
Design and execute cpq platforms workflows using secret scanner controls with validated outcomes.
