---
name: fraud-operations-root-cause-miner
description: Use when tasks require fraud operations root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Root Cause Miner

## Purpose
Design and execute fraud operations workflows using root cause miner controls with validated outcomes.
