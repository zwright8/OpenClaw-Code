---
name: customer-data-platforms-artifact-publisher
description: Use when tasks require customer data platforms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Artifact Publisher

## Purpose
Design and execute customer data platforms workflows using artifact publisher controls with validated outcomes.
