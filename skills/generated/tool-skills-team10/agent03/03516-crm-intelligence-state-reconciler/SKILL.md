---
name: crm-intelligence-state-reconciler
description: Use when tasks require crm intelligence state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence State Reconciler

## Purpose
Design and execute crm intelligence workflows using state reconciler controls with validated outcomes.
