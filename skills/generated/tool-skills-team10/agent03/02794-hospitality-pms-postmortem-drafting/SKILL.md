---
name: hospitality-pms-postmortem-drafting
description: Use when tasks require hospitality pms postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Postmortem Drafting

## Purpose
Design and execute hospitality pms workflows using postmortem drafting controls with validated outcomes.
