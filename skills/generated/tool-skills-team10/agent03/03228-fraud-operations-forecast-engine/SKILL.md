---
name: fraud-operations-forecast-engine
description: Use when tasks require fraud operations forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Forecast Engine

## Purpose
Design and execute fraud operations workflows using forecast engine controls with validated outcomes.
