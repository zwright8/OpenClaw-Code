---
name: marketing-attribution-dependency-resolver
description: Use when tasks require marketing attribution dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Dependency Resolver

## Purpose
Design and execute marketing attribution workflows using dependency resolver controls with validated outcomes.
