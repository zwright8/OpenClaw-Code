---
name: revops-systems-risk-scorer
description: Use when tasks require revops systems risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RevOps Systems Risk Scorer

## Purpose
Design and execute revops systems workflows using risk scorer controls with validated outcomes.
