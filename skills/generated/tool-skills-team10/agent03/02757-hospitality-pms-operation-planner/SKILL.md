---
name: hospitality-pms-operation-planner
description: Use when tasks require hospitality pms operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Operation Planner

## Purpose
Design and execute hospitality pms workflows using operation planner controls with validated outcomes.
