---
name: customer-data-platforms-anomaly-detector
description: Use when tasks require customer data platforms anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Anomaly Detector

## Purpose
Design and execute customer data platforms workflows using anomaly detector controls with validated outcomes.
