---
name: treasury-management-artifact-publisher
description: Use when tasks require treasury management artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Artifact Publisher

## Purpose
Design and execute treasury management workflows using artifact publisher controls with validated outcomes.
