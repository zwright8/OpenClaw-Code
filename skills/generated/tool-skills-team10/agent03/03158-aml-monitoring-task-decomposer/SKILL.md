---
name: aml-monitoring-task-decomposer
description: Use when tasks require aml monitoring task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Task Decomposer

## Purpose
Design and execute aml monitoring workflows using task decomposer controls with validated outcomes.
