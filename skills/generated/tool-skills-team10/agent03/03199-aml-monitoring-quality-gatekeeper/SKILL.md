---
name: aml-monitoring-quality-gatekeeper
description: Use when tasks require aml monitoring quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Quality Gatekeeper

## Purpose
Design and execute aml monitoring workflows using quality gatekeeper controls with validated outcomes.
