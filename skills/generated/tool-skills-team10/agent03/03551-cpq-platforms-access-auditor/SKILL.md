---
name: cpq-platforms-access-auditor
description: Use when tasks require cpq platforms access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Access Auditor

## Purpose
Design and execute cpq platforms workflows using access auditor controls with validated outcomes.
