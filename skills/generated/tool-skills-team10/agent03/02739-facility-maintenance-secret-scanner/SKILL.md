---
name: facility-maintenance-secret-scanner
description: Use when tasks require facility maintenance secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Secret Scanner

## Purpose
Design and execute facility maintenance workflows using secret scanner controls with validated outcomes.
