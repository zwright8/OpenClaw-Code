---
name: procure-to-pay-snapshot-manager
description: Use when tasks require procure to pay snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Snapshot Manager

## Purpose
Design and execute procure to pay workflows using snapshot manager controls with validated outcomes.
