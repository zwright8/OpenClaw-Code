---
name: cpq-platforms-pii-redactor
description: Use when tasks require cpq platforms pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms PII Redactor

## Purpose
Design and execute cpq platforms workflows using pii redactor controls with validated outcomes.
