---
name: crm-intelligence-latency-analyzer
description: Use when tasks require crm intelligence latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Latency Analyzer

## Purpose
Design and execute crm intelligence workflows using latency analyzer controls with validated outcomes.
