---
name: payroll-systems-permission-mapper
description: Use when tasks require payroll systems permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Permission Mapper

## Purpose
Design and execute payroll systems workflows using permission mapper controls with validated outcomes.
