---
name: airline-operations-spec-drift-detector
description: Use when tasks require airline operations spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Spec Drift Detector

## Purpose
Design and execute airline operations workflows using spec drift detector controls with validated outcomes.
