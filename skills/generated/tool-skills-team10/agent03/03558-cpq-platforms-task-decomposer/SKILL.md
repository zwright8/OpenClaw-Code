---
name: cpq-platforms-task-decomposer
description: Use when tasks require cpq platforms task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Task Decomposer

## Purpose
Design and execute cpq platforms workflows using task decomposer controls with validated outcomes.
