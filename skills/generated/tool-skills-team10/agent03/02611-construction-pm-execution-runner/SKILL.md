---
name: construction-pm-execution-runner
description: Use when tasks require construction pm execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Execution Runner

## Purpose
Design and execute construction pm workflows using execution runner controls with validated outcomes.
