---
name: marketing-attribution-workflow-compiler
description: Use when tasks require marketing attribution workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Workflow Compiler

## Purpose
Design and execute marketing attribution workflows using workflow compiler controls with validated outcomes.
