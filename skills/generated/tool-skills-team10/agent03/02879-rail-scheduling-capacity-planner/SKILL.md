---
name: rail-scheduling-capacity-planner
description: Use when tasks require rail scheduling capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Capacity Planner

## Purpose
Design and execute rail scheduling workflows using capacity planner controls with validated outcomes.
