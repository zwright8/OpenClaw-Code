---
name: risk-engines-outcome-synthesizer
description: Use when tasks require risk engines outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Outcome Synthesizer

## Purpose
Design and execute risk engines workflows using outcome synthesizer controls with validated outcomes.
