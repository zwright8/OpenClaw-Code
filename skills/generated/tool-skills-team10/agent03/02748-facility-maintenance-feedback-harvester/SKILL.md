---
name: facility-maintenance-feedback-harvester
description: Use when tasks require facility maintenance feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Feedback Harvester

## Purpose
Design and execute facility maintenance workflows using feedback harvester controls with validated outcomes.
