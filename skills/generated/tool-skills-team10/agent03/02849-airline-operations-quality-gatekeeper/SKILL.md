---
name: airline-operations-quality-gatekeeper
description: Use when tasks require airline operations quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Quality Gatekeeper

## Purpose
Design and execute airline operations workflows using quality gatekeeper controls with validated outcomes.
