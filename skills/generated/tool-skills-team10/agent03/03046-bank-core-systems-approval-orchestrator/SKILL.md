...
description: Use when tasks require bank core systems approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Approval Orchestrator

## Purpose
Design and execute bank core systems workflows using approval orchestrator controls with validated outcomes.
