---
name: construction-pm-reliability-scorer
description: Use when tasks require construction pm reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Reliability Scorer

## Purpose
Design and execute construction pm workflows using reliability scorer controls with validated outcomes.
