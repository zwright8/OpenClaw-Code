---
name: rail-scheduling-runbook-composer
description: Use when tasks require rail scheduling runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Runbook Composer

## Purpose
Design and execute rail scheduling workflows using runbook composer controls with validated outcomes.
