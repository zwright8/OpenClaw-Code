---
name: fraud-operations-execution-runner
description: Use when tasks require fraud operations execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Execution Runner

## Purpose
Design and execute fraud operations workflows using execution runner controls with validated outcomes.
