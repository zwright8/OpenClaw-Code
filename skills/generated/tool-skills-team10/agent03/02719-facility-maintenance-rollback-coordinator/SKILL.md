---
name: facility-maintenance-rollback-coordinator
description: Use when tasks require facility maintenance rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Rollback Coordinator

## Purpose
Design and execute facility maintenance workflows using rollback coordinator controls with validated outcomes.
