---
name: customer-data-platforms-secret-scanner
description: Use when tasks require customer data platforms secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Secret Scanner

## Purpose
Design and execute customer data platforms workflows using secret scanner controls with validated outcomes.
