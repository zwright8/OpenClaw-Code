---
name: hospitality-pms-permission-mapper
description: Use when tasks require hospitality pms permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Permission Mapper

## Purpose
Design and execute hospitality pms workflows using permission mapper controls with validated outcomes.
