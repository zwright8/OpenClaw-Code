---
name: marketing-attribution-version-tracker
description: Use when tasks require marketing attribution version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Version Tracker

## Purpose
Design and execute marketing attribution workflows using version tracker controls with validated outcomes.
