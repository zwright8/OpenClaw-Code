---
name: travel-compliance-capacity-planner
description: Use when tasks require travel compliance capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Travel Compliance Capacity Planner

## Purpose
Design and execute travel compliance workflows using capacity planner controls with validated outcomes.
