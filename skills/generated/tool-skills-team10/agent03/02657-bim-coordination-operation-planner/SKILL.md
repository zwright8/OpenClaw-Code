---
name: bim-coordination-operation-planner
description: Use when tasks require bim coordination operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Operation Planner

## Purpose
Design and execute bim coordination workflows using operation planner controls with validated outcomes.
