---
name: marketing-attribution-secret-scanner
description: Use when tasks require marketing attribution secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Secret Scanner

## Purpose
Design and execute marketing attribution workflows using secret scanner controls with validated outcomes.
