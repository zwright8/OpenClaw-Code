---
name: fraud-operations-postmortem-drafting
description: Use when tasks require fraud operations postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Postmortem Drafting

## Purpose
Design and execute fraud operations workflows using postmortem drafting controls with validated outcomes.
