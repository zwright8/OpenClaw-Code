---
name: rail-scheduling-auth-broker
description: Use when tasks require rail scheduling auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Auth Broker

## Purpose
Design and execute rail scheduling workflows using auth broker controls with validated outcomes.
