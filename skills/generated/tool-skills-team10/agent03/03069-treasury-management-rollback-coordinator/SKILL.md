---
name: treasury-management-rollback-coordinator
description: Use when tasks require treasury management rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Rollback Coordinator

## Purpose
Design and execute treasury management workflows using rollback coordinator controls with validated outcomes.
