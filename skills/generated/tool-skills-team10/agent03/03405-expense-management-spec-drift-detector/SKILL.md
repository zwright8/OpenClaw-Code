---
name: expense-management-spec-drift-detector
description: Use when tasks require expense management spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Expense Management Spec Drift Detector

## Purpose
Design and execute expense management workflows using spec drift detector controls with validated outcomes.
