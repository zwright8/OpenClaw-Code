---
name: cpq-platforms-state-reconciler
description: Use when tasks require cpq platforms state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms State Reconciler

## Purpose
Design and execute cpq platforms workflows using state reconciler controls with validated outcomes.
