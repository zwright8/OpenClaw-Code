---
name: maritime-routing-access-auditor
description: Use when tasks require maritime routing access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Access Auditor

## Purpose
Design and execute maritime routing workflows using access auditor controls with validated outcomes.
