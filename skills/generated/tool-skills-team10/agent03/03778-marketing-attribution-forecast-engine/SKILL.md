---
name: marketing-attribution-forecast-engine
description: Use when tasks require marketing attribution forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Forecast Engine

## Purpose
Design and execute marketing attribution workflows using forecast engine controls with validated outcomes.
