---
name: payroll-systems-risk-scorer
description: Use when tasks require payroll systems risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Risk Scorer

## Purpose
Design and execute payroll systems workflows using risk scorer controls with validated outcomes.
