---
name: construction-pm-outcome-synthesizer
description: Use when tasks require construction pm outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Outcome Synthesizer

## Purpose
Design and execute construction pm workflows using outcome synthesizer controls with validated outcomes.
