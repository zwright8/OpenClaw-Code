---
name: payroll-systems-state-reconciler
description: Use when tasks require payroll systems state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems State Reconciler

## Purpose
Design and execute payroll systems workflows using state reconciler controls with validated outcomes.
