---
name: cpq-platforms-queue-balancer
description: Use when tasks require cpq platforms queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Queue Balancer

## Purpose
Design and execute cpq platforms workflows using queue balancer controls with validated outcomes.
