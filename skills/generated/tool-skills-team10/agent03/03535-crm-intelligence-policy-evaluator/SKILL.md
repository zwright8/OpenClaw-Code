---
name: crm-intelligence-policy-evaluator
description: Use when tasks require crm intelligence policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Policy Evaluator

## Purpose
Design and execute crm intelligence workflows using policy evaluator controls with validated outcomes.
