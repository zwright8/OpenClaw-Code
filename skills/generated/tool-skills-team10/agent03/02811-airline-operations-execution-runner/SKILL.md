---
name: airline-operations-execution-runner
description: Use when tasks require airline operations execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Execution Runner

## Purpose
Design and execute airline operations workflows using execution runner controls with validated outcomes.
