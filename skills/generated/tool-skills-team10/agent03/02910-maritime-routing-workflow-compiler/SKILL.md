---
name: maritime-routing-workflow-compiler
description: Use when tasks require maritime routing workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Workflow Compiler

## Purpose
Design and execute maritime routing workflows using workflow compiler controls with validated outcomes.
