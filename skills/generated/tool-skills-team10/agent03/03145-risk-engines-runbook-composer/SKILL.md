---
name: risk-engines-runbook-composer
description: Use when tasks require risk engines runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Runbook Composer

## Purpose
Design and execute risk engines workflows using runbook composer controls with validated outcomes.
