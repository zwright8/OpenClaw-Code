---
name: crm-intelligence-budget-guardrail
description: Use when tasks require crm intelligence budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Budget Guardrail

## Purpose
Design and execute crm intelligence workflows using budget guardrail controls with validated outcomes.
