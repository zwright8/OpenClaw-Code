---
name: rail-scheduling-provenance-tracker
description: Use when tasks require rail scheduling provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Provenance Tracker

## Purpose
Design and execute rail scheduling workflows using provenance tracker controls with validated outcomes.
