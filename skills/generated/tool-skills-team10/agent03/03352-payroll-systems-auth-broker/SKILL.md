---
name: payroll-systems-auth-broker
description: Use when tasks require payroll systems auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Auth Broker

## Purpose
Design and execute payroll systems workflows using auth broker controls with validated outcomes.
