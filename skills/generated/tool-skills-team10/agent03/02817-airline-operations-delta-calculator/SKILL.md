---
name: airline-operations-delta-calculator
description: Use when tasks require airline operations delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Delta Calculator

## Purpose
Design and execute airline operations workflows using delta calculator controls with validated outcomes.
