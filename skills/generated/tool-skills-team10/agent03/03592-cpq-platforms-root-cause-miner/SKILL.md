---
name: cpq-platforms-root-cause-miner
description: Use when tasks require cpq platforms root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Root Cause Miner

## Purpose
Design and execute cpq platforms workflows using root cause miner controls with validated outcomes.
