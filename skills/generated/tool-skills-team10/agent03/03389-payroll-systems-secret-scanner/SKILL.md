---
name: payroll-systems-secret-scanner
description: Use when tasks require payroll systems secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Secret Scanner

## Purpose
Design and execute payroll systems workflows using secret scanner controls with validated outcomes.
