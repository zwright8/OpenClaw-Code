---
name: hospitality-pms-auth-broker
description: Use when tasks require hospitality pms auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Auth Broker

## Purpose
Design and execute hospitality pms workflows using auth broker controls with validated outcomes.
