---
name: maritime-routing-delta-calculator
description: Use when tasks require maritime routing delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Delta Calculator

## Purpose
Design and execute maritime routing workflows using delta calculator controls with validated outcomes.
