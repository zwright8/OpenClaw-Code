---
name: maritime-routing-pii-redactor
description: Use when tasks require maritime routing pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing PII Redactor

## Purpose
Design and execute maritime routing workflows using pii redactor controls with validated outcomes.
