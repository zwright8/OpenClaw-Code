---
name: risk-engines-evidence-collector
description: Use when tasks require risk engines evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Evidence Collector

## Purpose
Design and execute risk engines workflows using evidence collector controls with validated outcomes.
