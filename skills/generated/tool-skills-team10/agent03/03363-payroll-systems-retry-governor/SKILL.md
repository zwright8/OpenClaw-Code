---
name: payroll-systems-retry-governor
description: Use when tasks require payroll systems retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Retry Governor

## Purpose
Design and execute payroll systems workflows using retry governor controls with validated outcomes.
