---
name: aml-monitoring-cost-attribution
description: Use when tasks require aml monitoring cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Cost Attribution

## Purpose
Design and execute aml monitoring workflows using cost attribution controls with validated outcomes.
