---
name: customer-data-platforms-postmortem-drafting
description: Use when tasks require customer data platforms postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Postmortem Drafting

## Purpose
Design and execute customer data platforms workflows using postmortem drafting controls with validated outcomes.
