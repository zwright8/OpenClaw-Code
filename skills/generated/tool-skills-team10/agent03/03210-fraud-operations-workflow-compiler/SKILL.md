---
name: fraud-operations-workflow-compiler
description: Use when tasks require fraud operations workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Workflow Compiler

## Purpose
Design and execute fraud operations workflows using workflow compiler controls with validated outcomes.
