---
name: risk-engines-snapshot-manager
description: Use when tasks require risk engines snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Snapshot Manager

## Purpose
Design and execute risk engines workflows using snapshot manager controls with validated outcomes.
