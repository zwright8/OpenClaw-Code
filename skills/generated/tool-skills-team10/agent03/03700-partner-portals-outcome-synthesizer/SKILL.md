---
name: partner-portals-outcome-synthesizer
description: Use when tasks require partner portals outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Outcome Synthesizer

## Purpose
Design and execute partner portals workflows using outcome synthesizer controls with validated outcomes.
