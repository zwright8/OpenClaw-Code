---
name: bank-core-systems-evidence-collector
description: Use when tasks require bank core systems evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Evidence Collector

## Purpose
Design and execute bank core systems workflows using evidence collector controls with validated outcomes.
