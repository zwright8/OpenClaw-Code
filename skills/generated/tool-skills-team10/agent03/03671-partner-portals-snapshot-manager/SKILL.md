---
name: partner-portals-snapshot-manager
description: Use when tasks require partner portals snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Snapshot Manager

## Purpose
Design and execute partner portals workflows using snapshot manager controls with validated outcomes.
