---
name: treasury-management-policy-evaluator
description: Use when tasks require treasury management policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Policy Evaluator

## Purpose
Design and execute treasury management workflows using policy evaluator controls with validated outcomes.
