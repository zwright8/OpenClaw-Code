---
name: fraud-operations-migration-planner
description: Use when tasks require fraud operations migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Migration Planner

## Purpose
Design and execute fraud operations workflows using migration planner controls with validated outcomes.
