---
name: marketing-attribution-migration-planner
description: Use when tasks require marketing attribution migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Migration Planner

## Purpose
Design and execute marketing attribution workflows using migration planner controls with validated outcomes.
