---
name: construction-pm-permission-mapper
description: Use when tasks require construction pm permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Permission Mapper

## Purpose
Design and execute construction pm workflows using permission mapper controls with validated outcomes.
