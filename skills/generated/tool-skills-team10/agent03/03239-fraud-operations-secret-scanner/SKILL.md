---
name: fraud-operations-secret-scanner
description: Use when tasks require fraud operations secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Secret Scanner

## Purpose
Design and execute fraud operations workflows using secret scanner controls with validated outcomes.
