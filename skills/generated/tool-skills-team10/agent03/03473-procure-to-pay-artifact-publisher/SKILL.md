---
name: procure-to-pay-artifact-publisher
description: Use when tasks require procure to pay artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Artifact Publisher

## Purpose
Design and execute procure to pay workflows using artifact publisher controls with validated outcomes.
