---
name: construction-pm-spec-drift-detector
description: Use when tasks require construction pm spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Spec Drift Detector

## Purpose
Design and execute construction pm workflows using spec drift detector controls with validated outcomes.
