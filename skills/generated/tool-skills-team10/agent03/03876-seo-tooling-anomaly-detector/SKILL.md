---
name: seo-tooling-anomaly-detector
description: Use when tasks require seo tooling anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SEO Tooling Anomaly Detector

## Purpose
Design and execute seo tooling workflows using anomaly detector controls with validated outcomes.
