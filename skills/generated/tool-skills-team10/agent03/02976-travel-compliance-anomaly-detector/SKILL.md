---
name: travel-compliance-anomaly-detector
description: Use when tasks require travel compliance anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Travel Compliance Anomaly Detector

## Purpose
Design and execute travel compliance workflows using anomaly detector controls with validated outcomes.
