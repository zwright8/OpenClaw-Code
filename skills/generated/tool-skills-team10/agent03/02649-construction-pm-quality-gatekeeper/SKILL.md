---
name: construction-pm-quality-gatekeeper
description: Use when tasks require construction pm quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Quality Gatekeeper

## Purpose
Design and execute construction pm workflows using quality gatekeeper controls with validated outcomes.
