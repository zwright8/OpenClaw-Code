---
name: procure-to-pay-anomaly-detector
description: Use when tasks require procure to pay anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Anomaly Detector

## Purpose
Design and execute procure to pay workflows using anomaly detector controls with validated outcomes.
