---
name: procure-to-pay-outcome-synthesizer
description: Use when tasks require procure to pay outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Outcome Synthesizer

## Purpose
Design and execute procure to pay workflows using outcome synthesizer controls with validated outcomes.
