---
name: cpq-platforms-anomaly-detector
description: Use when tasks require cpq platforms anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Anomaly Detector

## Purpose
Design and execute cpq platforms workflows using anomaly detector controls with validated outcomes.
