---
name: ad-platforms-dependency-resolver
description: Use when tasks require ad platforms dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Dependency Resolver

## Purpose
Design and execute ad platforms workflows using dependency resolver controls with validated outcomes.
