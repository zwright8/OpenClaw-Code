---
name: cpq-platforms-auth-broker
description: Use when tasks require cpq platforms auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Auth Broker

## Purpose
Design and execute cpq platforms workflows using auth broker controls with validated outcomes.
