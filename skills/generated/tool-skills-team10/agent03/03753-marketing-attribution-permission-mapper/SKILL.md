---
name: marketing-attribution-permission-mapper
description: Use when tasks require marketing attribution permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Permission Mapper

## Purpose
Design and execute marketing attribution workflows using permission mapper controls with validated outcomes.
