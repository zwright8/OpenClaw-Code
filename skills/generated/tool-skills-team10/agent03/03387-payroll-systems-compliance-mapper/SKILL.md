---
name: payroll-systems-compliance-mapper
description: Use when tasks require payroll systems compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Compliance Mapper

## Purpose
Design and execute payroll systems workflows using compliance mapper controls with validated outcomes.
