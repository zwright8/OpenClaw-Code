---
name: crm-intelligence-conflict-resolver
description: Use when tasks require crm intelligence conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Conflict Resolver

## Purpose
Design and execute crm intelligence workflows using conflict resolver controls with validated outcomes.
