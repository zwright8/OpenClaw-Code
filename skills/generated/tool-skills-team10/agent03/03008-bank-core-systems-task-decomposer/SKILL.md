---
name: bank-core-systems-task-decomposer
description: Use when tasks require bank core systems task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Task Decomposer

## Purpose
Design and execute bank core systems workflows using task decomposer controls with validated outcomes.
