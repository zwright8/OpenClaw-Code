---
name: seo-tooling-secret-scanner
description: Use when tasks require seo tooling secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SEO Tooling Secret Scanner

## Purpose
Design and execute seo tooling workflows using secret scanner controls with validated outcomes.
