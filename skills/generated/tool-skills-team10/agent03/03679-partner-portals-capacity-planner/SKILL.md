---
name: partner-portals-capacity-planner
description: Use when tasks require partner portals capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Capacity Planner

## Purpose
Design and execute partner portals workflows using capacity planner controls with validated outcomes.
