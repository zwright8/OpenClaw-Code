---
name: marketing-attribution-conflict-resolver
description: Use when tasks require marketing attribution conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Conflict Resolver

## Purpose
Design and execute marketing attribution workflows using conflict resolver controls with validated outcomes.
