---
name: accounting-ledgers-secret-scanner
description: Use when tasks require accounting ledgers secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accounting Ledgers Secret Scanner

## Purpose
Design and execute accounting ledgers workflows using secret scanner controls with validated outcomes.
