---
name: aml-monitoring-approval-orchestrator
description: Use when tasks require aml monitoring approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Approval Orchestrator

## Purpose
Design and execute aml monitoring workflows using approval orchestrator controls with validated outcomes.
