---
name: customer-data-platforms-root-cause-miner
description: Use when tasks require customer data platforms root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Root Cause Miner

## Purpose
Design and execute customer data platforms workflows using root cause miner controls with validated outcomes.
