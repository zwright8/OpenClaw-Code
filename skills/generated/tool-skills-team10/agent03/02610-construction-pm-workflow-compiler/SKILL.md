---
name: construction-pm-workflow-compiler
description: Use when tasks require construction pm workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Workflow Compiler

## Purpose
Design and execute construction pm workflows using workflow compiler controls with validated outcomes.
