---
name: payroll-systems-snapshot-manager
description: Use when tasks require payroll systems snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Snapshot Manager

## Purpose
Design and execute payroll systems workflows using snapshot manager controls with validated outcomes.
