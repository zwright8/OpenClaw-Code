---
name: hospitality-pms-capacity-planner
description: Use when tasks require hospitality pms capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Capacity Planner

## Purpose
Design and execute hospitality pms workflows using capacity planner controls with validated outcomes.
