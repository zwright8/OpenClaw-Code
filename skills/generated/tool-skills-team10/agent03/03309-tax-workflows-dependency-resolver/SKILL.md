---
name: tax-workflows-dependency-resolver
description: Use when tasks require tax workflows dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Tax Workflows Dependency Resolver

## Purpose
Design and execute tax workflows workflows using dependency resolver controls with validated outcomes.
