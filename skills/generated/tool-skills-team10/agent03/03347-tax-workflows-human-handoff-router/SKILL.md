---
name: tax-workflows-human-handoff-router
description: Use when tasks require tax workflows human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Tax Workflows Human Handoff Router

## Purpose
Design and execute tax workflows workflows using human handoff router controls with validated outcomes.
