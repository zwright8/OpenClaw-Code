---
name: bim-coordination-outcome-synthesizer
description: Use when tasks require bim coordination outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Outcome Synthesizer

## Purpose
Design and execute bim coordination workflows using outcome synthesizer controls with validated outcomes.
