---
name: maritime-routing-secret-scanner
description: Use when tasks require maritime routing secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Secret Scanner

## Purpose
Design and execute maritime routing workflows using secret scanner controls with validated outcomes.
