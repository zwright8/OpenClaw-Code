---
name: procure-to-pay-execution-runner
description: Use when tasks require procure to pay execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Execution Runner

## Purpose
Design and execute procure to pay workflows using execution runner controls with validated outcomes.
