---
name: construction-pm-feedback-harvester
description: Use when tasks require construction pm feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Feedback Harvester

## Purpose
Design and execute construction pm workflows using feedback harvester controls with validated outcomes.
