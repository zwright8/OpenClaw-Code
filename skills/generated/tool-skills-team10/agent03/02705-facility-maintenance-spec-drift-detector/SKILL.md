---
name: facility-maintenance-spec-drift-detector
description: Use when tasks require facility maintenance spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Spec Drift Detector

## Purpose
Design and execute facility maintenance workflows using spec drift detector controls with validated outcomes.
