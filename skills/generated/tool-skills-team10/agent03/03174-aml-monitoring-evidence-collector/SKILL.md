---
name: aml-monitoring-evidence-collector
description: Use when tasks require aml monitoring evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Evidence Collector

## Purpose
Design and execute aml monitoring workflows using evidence collector controls with validated outcomes.
