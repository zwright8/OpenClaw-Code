---
name: bank-core-systems-api-contract-validator
description: Use when tasks require bank core systems api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems API Contract Validator

## Purpose
Design and execute bank core systems workflows using api contract validator controls with validated outcomes.
