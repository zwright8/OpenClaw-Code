---
name: procure-to-pay-budget-guardrail
description: Use when tasks require procure to pay budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Budget Guardrail

## Purpose
Design and execute procure to pay workflows using budget guardrail controls with validated outcomes.
