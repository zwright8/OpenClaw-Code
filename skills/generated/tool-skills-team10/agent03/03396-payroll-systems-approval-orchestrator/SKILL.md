---
name: payroll-systems-approval-orchestrator
description: Use when tasks require payroll systems approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Approval Orchestrator

## Purpose
Design and execute payroll systems workflows using approval orchestrator controls with validated outcomes.
