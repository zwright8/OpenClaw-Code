---
name: customer-data-platforms-capacity-planner
description: Use when tasks require customer data platforms capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Capacity Planner

## Purpose
Design and execute customer data platforms workflows using capacity planner controls with validated outcomes.
