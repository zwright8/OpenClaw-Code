---
name: bim-coordination-queue-balancer
description: Use when tasks require bim coordination queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Queue Balancer

## Purpose
Design and execute bim coordination workflows using queue balancer controls with validated outcomes.
