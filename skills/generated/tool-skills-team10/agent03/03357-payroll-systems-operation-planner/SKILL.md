---
name: payroll-systems-operation-planner
description: Use when tasks require payroll systems operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Operation Planner

## Purpose
Design and execute payroll systems workflows using operation planner controls with validated outcomes.
