---
name: rail-scheduling-quality-gatekeeper
description: Use when tasks require rail scheduling quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Quality Gatekeeper

## Purpose
Design and execute rail scheduling workflows using quality gatekeeper controls with validated outcomes.
