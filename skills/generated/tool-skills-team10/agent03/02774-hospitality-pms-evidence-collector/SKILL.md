---
name: hospitality-pms-evidence-collector
description: Use when tasks require hospitality pms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Evidence Collector

## Purpose
Design and execute hospitality pms workflows using evidence collector controls with validated outcomes.
