---
name: cpq-platforms-outcome-synthesizer
description: Use when tasks require cpq platforms outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Outcome Synthesizer

## Purpose
Design and execute cpq platforms workflows using outcome synthesizer controls with validated outcomes.
