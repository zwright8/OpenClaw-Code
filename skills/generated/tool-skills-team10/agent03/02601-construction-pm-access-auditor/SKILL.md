---
name: construction-pm-access-auditor
description: Use when tasks require construction pm access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Access Auditor

## Purpose
Design and execute construction pm workflows using access auditor controls with validated outcomes.
