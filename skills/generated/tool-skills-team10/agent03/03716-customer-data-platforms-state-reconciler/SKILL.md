---
name: customer-data-platforms-state-reconciler
description: Use when tasks require customer data platforms state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms State Reconciler

## Purpose
Design and execute customer data platforms workflows using state reconciler controls with validated outcomes.
