---
name: partner-portals-access-auditor
description: Use when tasks require partner portals access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Access Auditor

## Purpose
Design and execute partner portals workflows using access auditor controls with validated outcomes.
