---
name: cpq-platforms-forecast-engine
description: Use when tasks require cpq platforms forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Forecast Engine

## Purpose
Design and execute cpq platforms workflows using forecast engine controls with validated outcomes.
