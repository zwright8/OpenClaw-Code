---
name: bank-core-systems-policy-evaluator
description: Use when tasks require bank core systems policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Policy Evaluator

## Purpose
Design and execute bank core systems workflows using policy evaluator controls with validated outcomes.
