---
name: hospitality-pms-cost-attribution
description: Use when tasks require hospitality pms cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Cost Attribution

## Purpose
Design and execute hospitality pms workflows using cost attribution controls with validated outcomes.
