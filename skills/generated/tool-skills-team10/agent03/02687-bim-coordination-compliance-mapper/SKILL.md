---
name: bim-coordination-compliance-mapper
description: Use when tasks require bim coordination compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Compliance Mapper

## Purpose
Design and execute bim coordination workflows using compliance mapper controls with validated outcomes.
