---
name: construction-pm-snapshot-manager
description: Use when tasks require construction pm snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Snapshot Manager

## Purpose
Design and execute construction pm workflows using snapshot manager controls with validated outcomes.
