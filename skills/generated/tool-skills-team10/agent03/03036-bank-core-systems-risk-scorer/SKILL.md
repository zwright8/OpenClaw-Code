---
name: bank-core-systems-risk-scorer
description: Use when tasks require bank core systems risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Risk Scorer

## Purpose
Design and execute bank core systems workflows using risk scorer controls with validated outcomes.
