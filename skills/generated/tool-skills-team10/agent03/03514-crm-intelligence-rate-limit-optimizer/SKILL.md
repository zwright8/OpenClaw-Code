---
name: crm-intelligence-rate-limit-optimizer
description: Use when tasks require crm intelligence rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Rate Limit Optimizer

## Purpose
Design and execute crm intelligence workflows using rate limit optimizer controls with validated outcomes.
