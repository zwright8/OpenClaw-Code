---
name: seo-tooling-access-auditor
description: Use when tasks require seo tooling access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SEO Tooling Access Auditor

## Purpose
Design and execute seo tooling workflows using access auditor controls with validated outcomes.
