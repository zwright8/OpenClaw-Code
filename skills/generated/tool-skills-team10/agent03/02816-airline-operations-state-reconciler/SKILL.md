---
name: airline-operations-state-reconciler
description: Use when tasks require airline operations state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations State Reconciler

## Purpose
Design and execute airline operations workflows using state reconciler controls with validated outcomes.
