---
name: bim-coordination-task-decomposer
description: Use when tasks require bim coordination task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Task Decomposer

## Purpose
Design and execute bim coordination workflows using task decomposer controls with validated outcomes.
