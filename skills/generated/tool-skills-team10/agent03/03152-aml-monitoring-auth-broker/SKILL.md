---
name: aml-monitoring-auth-broker
description: Use when tasks require aml monitoring auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Auth Broker

## Purpose
Design and execute aml monitoring workflows using auth broker controls with validated outcomes.
