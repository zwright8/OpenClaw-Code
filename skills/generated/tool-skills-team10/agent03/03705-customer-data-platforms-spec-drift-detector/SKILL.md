---
name: customer-data-platforms-spec-drift-detector
description: Use when tasks require customer data platforms spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Spec Drift Detector

## Purpose
Design and execute customer data platforms workflows using spec drift detector controls with validated outcomes.
