---
name: ad-platforms-incident-triage
description: Use when tasks require ad platforms incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Incident Triage

## Purpose
Design and execute ad platforms workflows using incident triage controls with validated outcomes.
