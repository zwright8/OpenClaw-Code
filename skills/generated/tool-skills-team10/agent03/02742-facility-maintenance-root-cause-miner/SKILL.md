---
name: facility-maintenance-root-cause-miner
description: Use when tasks require facility maintenance root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Root Cause Miner

## Purpose
Design and execute facility maintenance workflows using root cause miner controls with validated outcomes.
