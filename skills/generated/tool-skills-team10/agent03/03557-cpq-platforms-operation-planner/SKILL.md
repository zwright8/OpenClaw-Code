---
name: cpq-platforms-operation-planner
description: Use when tasks require cpq platforms operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Operation Planner

## Purpose
Design and execute cpq platforms workflows using operation planner controls with validated outcomes.
