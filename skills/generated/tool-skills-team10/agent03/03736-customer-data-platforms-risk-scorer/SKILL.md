---
name: customer-data-platforms-risk-scorer
description: Use when tasks require customer data platforms risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Risk Scorer

## Purpose
Design and execute customer data platforms workflows using risk scorer controls with validated outcomes.
