---
name: partner-portals-task-decomposer
description: Use when tasks require partner portals task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Task Decomposer

## Purpose
Design and execute partner portals workflows using task decomposer controls with validated outcomes.
