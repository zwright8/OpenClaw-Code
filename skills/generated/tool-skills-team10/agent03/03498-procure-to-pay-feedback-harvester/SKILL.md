---
name: procure-to-pay-feedback-harvester
description: Use when tasks require procure to pay feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Feedback Harvester

## Purpose
Design and execute procure to pay workflows using feedback harvester controls with validated outcomes.
