---
name: procure-to-pay-remediation-planner
description: Use when tasks require procure to pay remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Remediation Planner

## Purpose
Design and execute procure to pay workflows using remediation planner controls with validated outcomes.
