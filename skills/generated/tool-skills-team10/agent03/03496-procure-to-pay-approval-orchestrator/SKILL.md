---
name: procure-to-pay-approval-orchestrator
description: Use when tasks require procure to pay approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Approval Orchestrator

## Purpose
Design and execute procure to pay workflows using approval orchestrator controls with validated outcomes.
