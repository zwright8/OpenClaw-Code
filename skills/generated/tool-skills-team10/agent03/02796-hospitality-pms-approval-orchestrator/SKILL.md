---
name: hospitality-pms-approval-orchestrator
description: Use when tasks require hospitality pms approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Approval Orchestrator

## Purpose
Design and execute hospitality pms workflows using approval orchestrator controls with validated outcomes.
