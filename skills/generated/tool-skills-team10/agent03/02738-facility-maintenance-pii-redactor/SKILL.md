---
name: facility-maintenance-pii-redactor
description: Use when tasks require facility maintenance pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance PII Redactor

## Purpose
Design and execute facility maintenance workflows using pii redactor controls with validated outcomes.
