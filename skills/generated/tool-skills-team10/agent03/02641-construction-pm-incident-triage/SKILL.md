---
name: construction-pm-incident-triage
description: Use when tasks require construction pm incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Incident Triage

## Purpose
Design and execute construction pm workflows using incident triage controls with validated outcomes.
