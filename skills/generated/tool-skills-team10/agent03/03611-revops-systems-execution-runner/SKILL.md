---
name: revops-systems-execution-runner
description: Use when tasks require revops systems execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RevOps Systems Execution Runner

## Purpose
Design and execute revops systems workflows using execution runner controls with validated outcomes.
