---
name: facility-maintenance-snapshot-manager
description: Use when tasks require facility maintenance snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Snapshot Manager

## Purpose
Design and execute facility maintenance workflows using snapshot manager controls with validated outcomes.
