---
name: airline-operations-human-handoff-router
description: Use when tasks require airline operations human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Human Handoff Router

## Purpose
Design and execute airline operations workflows using human handoff router controls with validated outcomes.
