---
name: hospitality-pms-execution-runner
description: Use when tasks require hospitality pms execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Execution Runner

## Purpose
Design and execute hospitality pms workflows using execution runner controls with validated outcomes.
