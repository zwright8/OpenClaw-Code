---
name: procure-to-pay-compliance-mapper
description: Use when tasks require procure to pay compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Compliance Mapper

## Purpose
Design and execute procure to pay workflows using compliance mapper controls with validated outcomes.
