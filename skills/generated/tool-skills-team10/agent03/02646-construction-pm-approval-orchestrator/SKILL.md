---
name: construction-pm-approval-orchestrator
description: Use when tasks require construction pm approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Approval Orchestrator

## Purpose
Design and execute construction pm workflows using approval orchestrator controls with validated outcomes.
