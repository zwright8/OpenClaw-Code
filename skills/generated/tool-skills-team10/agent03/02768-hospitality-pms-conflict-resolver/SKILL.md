---
name: hospitality-pms-conflict-resolver
description: Use when tasks require hospitality pms conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Conflict Resolver

## Purpose
Design and execute hospitality pms workflows using conflict resolver controls with validated outcomes.
