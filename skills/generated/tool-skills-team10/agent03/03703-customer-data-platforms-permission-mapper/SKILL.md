---
name: customer-data-platforms-permission-mapper
description: Use when tasks require customer data platforms permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Permission Mapper

## Purpose
Design and execute customer data platforms workflows using permission mapper controls with validated outcomes.
