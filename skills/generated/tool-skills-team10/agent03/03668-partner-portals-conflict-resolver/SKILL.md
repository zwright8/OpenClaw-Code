---
name: partner-portals-conflict-resolver
description: Use when tasks require partner portals conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Conflict Resolver

## Purpose
Design and execute partner portals workflows using conflict resolver controls with validated outcomes.
