---
name: cpq-platforms-workflow-compiler
description: Use when tasks require cpq platforms workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Workflow Compiler

## Purpose
Design and execute cpq platforms workflows using workflow compiler controls with validated outcomes.
