---
name: bank-core-systems-execution-runner
description: Use when tasks require bank core systems execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Execution Runner

## Purpose
Design and execute bank core systems workflows using execution runner controls with validated outcomes.
