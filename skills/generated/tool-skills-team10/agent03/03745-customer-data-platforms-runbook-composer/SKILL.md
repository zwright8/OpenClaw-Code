---
name: customer-data-platforms-runbook-composer
description: Use when tasks require customer data platforms runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Runbook Composer

## Purpose
Design and execute customer data platforms workflows using runbook composer controls with validated outcomes.
