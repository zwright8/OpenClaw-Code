---
name: airline-operations-snapshot-manager
description: Use when tasks require airline operations snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Snapshot Manager

## Purpose
Design and execute airline operations workflows using snapshot manager controls with validated outcomes.
