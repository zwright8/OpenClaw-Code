---
name: construction-pm-provenance-tracker
description: Use when tasks require construction pm provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Provenance Tracker

## Purpose
Design and execute construction pm workflows using provenance tracker controls with validated outcomes.
