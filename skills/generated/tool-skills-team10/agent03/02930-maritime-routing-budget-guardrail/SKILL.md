---
name: maritime-routing-budget-guardrail
description: Use when tasks require maritime routing budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Budget Guardrail

## Purpose
Design and execute maritime routing workflows using budget guardrail controls with validated outcomes.
