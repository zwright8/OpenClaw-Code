---
name: construction-pm-remediation-planner
description: Use when tasks require construction pm remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Remediation Planner

## Purpose
Design and execute construction pm workflows using remediation planner controls with validated outcomes.
