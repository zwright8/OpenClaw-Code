---
name: seo-tooling-forecast-engine
description: Use when tasks require seo tooling forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SEO Tooling Forecast Engine

## Purpose
Design and execute seo tooling workflows using forecast engine controls with validated outcomes.
