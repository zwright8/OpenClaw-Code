---
name: partner-portals-permission-mapper
description: Use when tasks require partner portals permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Permission Mapper

## Purpose
Design and execute partner portals workflows using permission mapper controls with validated outcomes.
