---
name: marketing-attribution-provenance-tracker
description: Use when tasks require marketing attribution provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Provenance Tracker

## Purpose
Design and execute marketing attribution workflows using provenance tracker controls with validated outcomes.
