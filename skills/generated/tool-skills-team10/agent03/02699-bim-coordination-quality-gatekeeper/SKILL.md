---
name: bim-coordination-quality-gatekeeper
description: Use when tasks require bim coordination quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Quality Gatekeeper

## Purpose
Design and execute bim coordination workflows using quality gatekeeper controls with validated outcomes.
