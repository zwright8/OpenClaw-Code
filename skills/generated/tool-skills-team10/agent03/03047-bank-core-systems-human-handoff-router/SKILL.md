---
name: bank-core-systems-human-handoff-router
description: Use when tasks require bank core systems human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Human Handoff Router

## Purpose
Design and execute bank core systems workflows using human handoff router controls with validated outcomes.
