---
name: airline-operations-auth-broker
description: Use when tasks require airline operations auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Auth Broker

## Purpose
Design and execute airline operations workflows using auth broker controls with validated outcomes.
