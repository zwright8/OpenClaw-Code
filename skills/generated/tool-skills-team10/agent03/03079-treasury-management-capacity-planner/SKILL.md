---
name: treasury-management-capacity-planner
description: Use when tasks require treasury management capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Capacity Planner

## Purpose
Design and execute treasury management workflows using capacity planner controls with validated outcomes.
