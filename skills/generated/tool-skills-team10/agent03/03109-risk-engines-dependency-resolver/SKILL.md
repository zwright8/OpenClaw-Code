---
name: risk-engines-dependency-resolver
description: Use when tasks require risk engines dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Dependency Resolver

## Purpose
Design and execute risk engines workflows using dependency resolver controls with validated outcomes.
