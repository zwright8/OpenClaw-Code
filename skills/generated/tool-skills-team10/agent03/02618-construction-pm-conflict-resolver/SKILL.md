---
name: construction-pm-conflict-resolver
description: Use when tasks require construction pm conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Conflict Resolver

## Purpose
Design and execute construction pm workflows using conflict resolver controls with validated outcomes.
