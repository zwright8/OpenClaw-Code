---
name: customer-data-platforms-dependency-resolver
description: Use when tasks require customer data platforms dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Dependency Resolver

## Purpose
Design and execute customer data platforms workflows using dependency resolver controls with validated outcomes.
