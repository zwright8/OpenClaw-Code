---
name: bank-core-systems-provenance-tracker
description: Use when tasks require bank core systems provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Provenance Tracker

## Purpose
Design and execute bank core systems workflows using provenance tracker controls with validated outcomes.
