---
name: hospitality-pms-rate-limit-optimizer
description: Use when tasks require hospitality pms rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Rate Limit Optimizer

## Purpose
Design and execute hospitality pms workflows using rate limit optimizer controls with validated outcomes.
