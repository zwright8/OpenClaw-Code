---
name: construction-pm-secret-scanner
description: Use when tasks require construction pm secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Secret Scanner

## Purpose
Design and execute construction pm workflows using secret scanner controls with validated outcomes.
