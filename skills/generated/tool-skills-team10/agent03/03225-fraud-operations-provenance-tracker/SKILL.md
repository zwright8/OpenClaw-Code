---
name: fraud-operations-provenance-tracker
description: Use when tasks require fraud operations provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Provenance Tracker

## Purpose
Design and execute fraud operations workflows using provenance tracker controls with validated outcomes.
