---
name: aml-monitoring-runbook-composer
description: Use when tasks require aml monitoring runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Runbook Composer

## Purpose
Design and execute aml monitoring workflows using runbook composer controls with validated outcomes.
