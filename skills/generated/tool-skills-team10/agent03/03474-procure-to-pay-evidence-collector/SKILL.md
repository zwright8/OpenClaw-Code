---
name: procure-to-pay-evidence-collector
description: Use when tasks require procure to pay evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Evidence Collector

## Purpose
Design and execute procure to pay workflows using evidence collector controls with validated outcomes.
