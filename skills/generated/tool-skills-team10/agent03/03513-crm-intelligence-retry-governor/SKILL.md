---
name: crm-intelligence-retry-governor
description: Use when tasks require crm intelligence retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Retry Governor

## Purpose
Design and execute crm intelligence workflows using retry governor controls with validated outcomes.
