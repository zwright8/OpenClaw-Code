---
name: procure-to-pay-root-cause-miner
description: Use when tasks require procure to pay root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Root Cause Miner

## Purpose
Design and execute procure to pay workflows using root cause miner controls with validated outcomes.
