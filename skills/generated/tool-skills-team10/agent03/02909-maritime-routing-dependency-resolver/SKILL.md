---
name: maritime-routing-dependency-resolver
description: Use when tasks require maritime routing dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Dependency Resolver

## Purpose
Design and execute maritime routing workflows using dependency resolver controls with validated outcomes.
