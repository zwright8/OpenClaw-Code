---
name: construction-pm-dependency-resolver
description: Use when tasks require construction pm dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Dependency Resolver

## Purpose
Design and execute construction pm workflows using dependency resolver controls with validated outcomes.
