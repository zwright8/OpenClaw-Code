---
name: airline-operations-capacity-planner
description: Use when tasks require airline operations capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Capacity Planner

## Purpose
Design and execute airline operations workflows using capacity planner controls with validated outcomes.
