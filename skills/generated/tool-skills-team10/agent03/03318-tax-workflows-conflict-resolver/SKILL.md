---
name: tax-workflows-conflict-resolver
description: Use when tasks require tax workflows conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Tax Workflows Conflict Resolver

## Purpose
Design and execute tax workflows workflows using conflict resolver controls with validated outcomes.
