---
name: marketing-attribution-operation-planner
description: Use when tasks require marketing attribution operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Operation Planner

## Purpose
Design and execute marketing attribution workflows using operation planner controls with validated outcomes.
