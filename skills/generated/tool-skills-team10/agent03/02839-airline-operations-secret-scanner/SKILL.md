---
name: airline-operations-secret-scanner
description: Use when tasks require airline operations secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Secret Scanner

## Purpose
Design and execute airline operations workflows using secret scanner controls with validated outcomes.
