---
name: revops-systems-feedback-harvester
description: Use when tasks require revops systems feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RevOps Systems Feedback Harvester

## Purpose
Design and execute revops systems workflows using feedback harvester controls with validated outcomes.
