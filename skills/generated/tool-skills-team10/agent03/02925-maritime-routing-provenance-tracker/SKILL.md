---
name: maritime-routing-provenance-tracker
description: Use when tasks require maritime routing provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Provenance Tracker

## Purpose
Design and execute maritime routing workflows using provenance tracker controls with validated outcomes.
