---
name: customer-data-platforms-snapshot-manager
description: Use when tasks require customer data platforms snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Snapshot Manager

## Purpose
Design and execute customer data platforms workflows using snapshot manager controls with validated outcomes.
