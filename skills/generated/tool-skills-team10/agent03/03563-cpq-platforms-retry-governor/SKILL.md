---
name: cpq-platforms-retry-governor
description: Use when tasks require cpq platforms retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Retry Governor

## Purpose
Design and execute cpq platforms workflows using retry governor controls with validated outcomes.
