---
name: crm-intelligence-queue-balancer
description: Use when tasks require crm intelligence queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Queue Balancer

## Purpose
Design and execute crm intelligence workflows using queue balancer controls with validated outcomes.
