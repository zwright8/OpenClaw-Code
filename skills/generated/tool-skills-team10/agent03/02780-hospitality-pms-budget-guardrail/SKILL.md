---
name: hospitality-pms-budget-guardrail
description: Use when tasks require hospitality pms budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Budget Guardrail

## Purpose
Design and execute hospitality pms workflows using budget guardrail controls with validated outcomes.
