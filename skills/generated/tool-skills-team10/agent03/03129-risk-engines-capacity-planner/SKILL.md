---
name: risk-engines-capacity-planner
description: Use when tasks require risk engines capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Capacity Planner

## Purpose
Design and execute risk engines workflows using capacity planner controls with validated outcomes.
