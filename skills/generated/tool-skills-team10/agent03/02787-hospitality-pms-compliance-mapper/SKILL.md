---
name: hospitality-pms-compliance-mapper
description: Use when tasks require hospitality pms compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Compliance Mapper

## Purpose
Design and execute hospitality pms workflows using compliance mapper controls with validated outcomes.
