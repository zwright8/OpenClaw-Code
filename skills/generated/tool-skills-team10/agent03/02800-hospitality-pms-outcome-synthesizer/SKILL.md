---
name: hospitality-pms-outcome-synthesizer
description: Use when tasks require hospitality pms outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Outcome Synthesizer

## Purpose
Design and execute hospitality pms workflows using outcome synthesizer controls with validated outcomes.
