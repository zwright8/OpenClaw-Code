---
name: hospitality-pms-provenance-tracker
description: Use when tasks require hospitality pms provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Provenance Tracker

## Purpose
Design and execute hospitality pms workflows using provenance tracker controls with validated outcomes.
