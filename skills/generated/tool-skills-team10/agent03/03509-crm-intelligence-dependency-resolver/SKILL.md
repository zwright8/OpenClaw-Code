---
name: crm-intelligence-dependency-resolver
description: Use when tasks require crm intelligence dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Dependency Resolver

## Purpose
Design and execute crm intelligence workflows using dependency resolver controls with validated outcomes.
