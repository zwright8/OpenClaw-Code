---
name: fraud-operations-reliability-scorer
description: Use when tasks require fraud operations reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Reliability Scorer

## Purpose
Design and execute fraud operations workflows using reliability scorer controls with validated outcomes.
