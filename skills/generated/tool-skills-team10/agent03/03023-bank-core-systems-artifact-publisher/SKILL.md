---
name: bank-core-systems-artifact-publisher
description: Use when tasks require bank core systems artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Artifact Publisher

## Purpose
Design and execute bank core systems workflows using artifact publisher controls with validated outcomes.
