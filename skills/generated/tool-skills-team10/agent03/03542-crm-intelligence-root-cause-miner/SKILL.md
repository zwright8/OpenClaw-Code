---
name: crm-intelligence-root-cause-miner
description: Use when tasks require crm intelligence root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Root Cause Miner

## Purpose
Design and execute crm intelligence workflows using root cause miner controls with validated outcomes.
