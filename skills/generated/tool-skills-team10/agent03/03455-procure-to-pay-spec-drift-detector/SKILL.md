---
name: procure-to-pay-spec-drift-detector
description: Use when tasks require procure to pay spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Spec Drift Detector

## Purpose
Design and execute procure to pay workflows using spec drift detector controls with validated outcomes.
