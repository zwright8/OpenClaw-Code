---
name: partner-portals-spec-drift-detector
description: Use when tasks require partner portals spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Spec Drift Detector

## Purpose
Design and execute partner portals workflows using spec drift detector controls with validated outcomes.
