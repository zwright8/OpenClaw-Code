---
name: hospitality-pms-api-contract-validator
description: Use when tasks require hospitality pms api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS API Contract Validator

## Purpose
Design and execute hospitality pms workflows using api contract validator controls with validated outcomes.

## Precision Profile
- Domain: Hospitality PMS
...
- Domain: [Hospitality PMS](../../resources/domains/hospitality-pms.md)
