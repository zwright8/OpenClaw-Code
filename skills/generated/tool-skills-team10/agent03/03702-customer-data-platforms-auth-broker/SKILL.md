---
name: customer-data-platforms-auth-broker
description: Use when tasks require customer data platforms auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Auth Broker

## Purpose
Design and execute customer data platforms workflows using auth broker controls with validated outcomes.
