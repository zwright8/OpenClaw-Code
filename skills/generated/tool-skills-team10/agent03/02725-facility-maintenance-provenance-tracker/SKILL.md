---
name: facility-maintenance-provenance-tracker
description: Use when tasks require facility maintenance provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Provenance Tracker

## Purpose
Design and execute facility maintenance workflows using provenance tracker controls with validated outcomes.
