---
name: construction-pm-risk-scorer
description: Use when tasks require construction pm risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Risk Scorer

## Purpose
Design and execute construction pm workflows using risk scorer controls with validated outcomes.
