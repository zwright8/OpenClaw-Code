---
name: bim-coordination-budget-guardrail
description: Use when tasks require bim coordination budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Budget Guardrail

## Purpose
Design and execute bim coordination workflows using budget guardrail controls with validated outcomes.
