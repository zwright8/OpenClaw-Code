---
name: ad-platforms-permission-mapper
description: Use when tasks require ad platforms permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Permission Mapper

## Purpose
Design and execute ad platforms workflows using permission mapper controls with validated outcomes.
