---
name: hospitality-pms-pii-redactor
description: Use when tasks require hospitality pms pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS PII Redactor

## Purpose
Design and execute hospitality pms workflows using pii redactor controls with validated outcomes.
