---
name: maritime-routing-quality-gatekeeper
description: Use when tasks require maritime routing quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Quality Gatekeeper

## Purpose
Design and execute maritime routing workflows using quality gatekeeper controls with validated outcomes.
