---
name: facility-maintenance-postmortem-drafting
description: Use when tasks require facility maintenance postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Postmortem Drafting

## Purpose
Design and execute facility maintenance workflows using postmortem drafting controls with validated outcomes.
