---
name: ad-platforms-evidence-collector
description: Use when tasks require ad platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Evidence Collector

## Purpose
Design and execute ad platforms workflows using evidence collector controls with validated outcomes.
