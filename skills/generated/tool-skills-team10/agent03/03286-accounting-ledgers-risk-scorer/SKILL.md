---
name: accounting-ledgers-risk-scorer
description: Use when tasks require accounting ledgers risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accounting Ledgers Risk Scorer

## Purpose
Design and execute accounting ledgers workflows using risk scorer controls with validated outcomes.
