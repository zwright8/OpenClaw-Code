---
name: marketing-attribution-runbook-composer
description: Use when tasks require marketing attribution runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Runbook Composer

## Purpose
Design and execute marketing attribution workflows using runbook composer controls with validated outcomes.
