---
name: bank-core-systems-operation-planner
description: Use when tasks require bank core systems operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Operation Planner

## Purpose
Design and execute bank core systems workflows using operation planner controls with validated outcomes.
