---
name: facility-maintenance-access-auditor
description: Use when tasks require facility maintenance access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Access Auditor

## Purpose
Design and execute facility maintenance workflows using access auditor controls with validated outcomes.
