---
name: airline-operations-provenance-tracker
description: Use when tasks require airline operations provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Provenance Tracker

## Purpose
Design and execute airline operations workflows using provenance tracker controls with validated outcomes.
