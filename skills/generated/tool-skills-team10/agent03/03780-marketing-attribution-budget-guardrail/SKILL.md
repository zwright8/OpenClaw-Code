---
name: marketing-attribution-budget-guardrail
description: Use when tasks require marketing attribution budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Budget Guardrail

## Purpose
Design and execute marketing attribution workflows using budget guardrail controls with validated outcomes.
