---
name: facility-maintenance-forecast-engine
description: Use when tasks require facility maintenance forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Forecast Engine

## Purpose
Design and execute facility maintenance workflows using forecast engine controls with validated outcomes.
