---
name: construction-pm-operation-planner
description: Use when tasks require construction pm operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Operation Planner

## Purpose
Design and execute construction pm workflows using operation planner controls with validated outcomes.
