---
name: customer-data-platforms-evidence-collector
description: Use when tasks require customer data platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Evidence Collector

## Purpose
Design and execute customer data platforms workflows using evidence collector controls with validated outcomes.
