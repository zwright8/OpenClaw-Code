---
name: airline-operations-evidence-collector
description: Use when tasks require airline operations evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Evidence Collector

## Purpose
Design and execute airline operations workflows using evidence collector controls with validated outcomes.
