---
name: crm-intelligence-secret-scanner
description: Use when tasks require crm intelligence secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Secret Scanner

## Purpose
Design and execute crm intelligence workflows using secret scanner controls with validated outcomes.
