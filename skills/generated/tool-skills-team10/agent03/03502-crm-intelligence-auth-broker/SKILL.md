---
name: crm-intelligence-auth-broker
description: Use when tasks require crm intelligence auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Auth Broker

## Purpose
Design and execute crm intelligence workflows using auth broker controls with validated outcomes.
