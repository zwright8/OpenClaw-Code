---
name: expense-management-root-cause-miner
description: Use when tasks require expense management root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Expense Management Root Cause Miner

## Purpose
Design and execute expense management workflows using root cause miner controls with validated outcomes.
