---
name: crm-intelligence-artifact-publisher
description: Use when tasks require crm intelligence artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Artifact Publisher

## Purpose
Design and execute crm intelligence workflows using artifact publisher controls with validated outcomes.
