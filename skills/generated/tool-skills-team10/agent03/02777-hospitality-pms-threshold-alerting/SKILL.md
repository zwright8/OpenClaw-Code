---
name: hospitality-pms-threshold-alerting
description: Use when tasks require hospitality pms threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Threshold Alerting

## Purpose
Design and execute hospitality pms workflows using threshold alerting controls with validated outcomes.
