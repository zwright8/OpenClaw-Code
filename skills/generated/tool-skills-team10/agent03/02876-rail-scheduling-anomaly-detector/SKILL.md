---
name: rail-scheduling-anomaly-detector
description: Use when tasks require rail scheduling anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Anomaly Detector

## Purpose
Design and execute rail scheduling workflows using anomaly detector controls with validated outcomes.
