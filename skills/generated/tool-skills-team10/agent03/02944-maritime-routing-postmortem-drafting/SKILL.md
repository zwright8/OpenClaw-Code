---
name: maritime-routing-postmortem-drafting
description: Use when tasks require maritime routing postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Postmortem Drafting

## Purpose
Design and execute maritime routing workflows using postmortem drafting controls with validated outcomes.
