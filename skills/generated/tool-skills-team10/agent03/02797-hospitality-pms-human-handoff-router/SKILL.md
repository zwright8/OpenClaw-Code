---
name: hospitality-pms-human-handoff-router
description: Use when tasks require hospitality pms human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Human Handoff Router

## Purpose
Design and execute hospitality pms workflows using human handoff router controls with validated outcomes.
