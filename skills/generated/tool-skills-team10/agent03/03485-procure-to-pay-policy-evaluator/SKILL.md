---
name: procure-to-pay-policy-evaluator
description: Use when tasks require procure to pay policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Policy Evaluator

## Purpose
Design and execute procure to pay workflows using policy evaluator controls with validated outcomes.
