---
name: fraud-operations-incident-triage
description: Use when tasks require fraud operations incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Incident Triage

## Purpose
Design and execute fraud operations workflows using incident triage controls with validated outcomes.
