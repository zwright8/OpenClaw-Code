...
description: Use when tasks require bank core systems compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Compliance Mapper

## Purpose
Design and execute bank core systems workflows using compliance mapper controls with validated outcomes.
