---
name: partner-portals-secret-scanner
description: Use when tasks require partner portals secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Secret Scanner

## Purpose
Design and execute partner portals workflows using secret scanner controls with validated outcomes.
