---
name: cpq-platforms-incident-triage
description: Use when tasks require cpq platforms incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Incident Triage

## Purpose
Design and execute cpq platforms workflows using incident triage controls with validated outcomes.
