---
name: rail-scheduling-incident-triage
description: Use when tasks require rail scheduling incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Incident Triage

## Purpose
Design and execute rail scheduling workflows using incident triage controls with validated outcomes.
