---
name: fraud-operations-rate-limit-optimizer
description: Use when tasks require fraud operations rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Rate Limit Optimizer

## Purpose
Design and execute fraud operations workflows using rate limit optimizer controls with validated outcomes.
