---
name: hospitality-pms-dependency-resolver
description: Use when tasks require hospitality pms dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Dependency Resolver

## Purpose
Design and execute hospitality pms workflows using dependency resolver controls with validated outcomes.
