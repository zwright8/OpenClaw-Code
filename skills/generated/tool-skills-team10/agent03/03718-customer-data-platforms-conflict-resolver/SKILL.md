---
name: customer-data-platforms-conflict-resolver
description: Use when tasks require customer data platforms conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Conflict Resolver

## Purpose
Design and execute customer data platforms workflows using conflict resolver controls with validated outcomes.
