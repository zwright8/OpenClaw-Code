---
name: seo-tooling-permission-mapper
description: Use when tasks require seo tooling permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SEO Tooling Permission Mapper

## Purpose
Design and execute seo tooling workflows using permission mapper controls with validated outcomes.
