---
name: customer-data-platforms-remediation-planner
description: Use when tasks require customer data platforms remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Remediation Planner

## Purpose
Design and execute customer data platforms workflows using remediation planner controls with validated outcomes.
