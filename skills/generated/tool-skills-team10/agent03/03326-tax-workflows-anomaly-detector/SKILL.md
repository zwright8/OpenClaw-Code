---
name: tax-workflows-anomaly-detector
description: Use when tasks require tax workflows anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Tax Workflows Anomaly Detector

## Purpose
Design and execute tax workflows workflows using anomaly detector controls with validated outcomes.
