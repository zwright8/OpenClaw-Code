---
name: construction-pm-retry-governor
description: Use when tasks require construction pm retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Retry Governor

## Purpose
Design and execute construction pm workflows using retry governor controls with validated outcomes.
