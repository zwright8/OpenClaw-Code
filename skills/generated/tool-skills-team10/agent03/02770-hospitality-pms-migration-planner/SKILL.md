---
name: hospitality-pms-migration-planner
description: Use when tasks require hospitality pms migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Migration Planner

## Purpose
Design and execute hospitality pms workflows using migration planner controls with validated outcomes.
