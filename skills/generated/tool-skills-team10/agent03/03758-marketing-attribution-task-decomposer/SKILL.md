---
name: marketing-attribution-task-decomposer
description: Use when tasks require marketing attribution task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Task Decomposer

## Purpose
Design and execute marketing attribution workflows using task decomposer controls with validated outcomes.
