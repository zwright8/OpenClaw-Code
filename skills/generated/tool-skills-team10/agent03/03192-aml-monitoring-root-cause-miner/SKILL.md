---
name: aml-monitoring-root-cause-miner
description: Use when tasks require aml monitoring root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Root Cause Miner

## Purpose
Design and execute aml monitoring workflows using root cause miner controls with validated outcomes.
