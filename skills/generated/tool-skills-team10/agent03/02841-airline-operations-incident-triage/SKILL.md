---
name: airline-operations-incident-triage
description: Use when tasks require airline operations incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Incident Triage

## Purpose
Design and execute airline operations workflows using incident triage controls with validated outcomes.
