---
name: airline-operations-policy-evaluator
description: Use when tasks require airline operations policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Policy Evaluator

## Purpose
Design and execute airline operations workflows using policy evaluator controls with validated outcomes.
