---
name: risk-engines-conflict-resolver
description: Use when tasks require risk engines conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Conflict Resolver

## Purpose
Design and execute risk engines workflows using conflict resolver controls with validated outcomes.
