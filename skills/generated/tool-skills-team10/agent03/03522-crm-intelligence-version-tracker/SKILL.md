---
name: crm-intelligence-version-tracker
description: Use when tasks require crm intelligence version tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Version Tracker

## Purpose
Design and execute crm intelligence workflows using version tracker controls with validated outcomes.
