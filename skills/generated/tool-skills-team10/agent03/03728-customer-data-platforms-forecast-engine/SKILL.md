---
name: customer-data-platforms-forecast-engine
description: Use when tasks require customer data platforms forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Forecast Engine

## Purpose
Design and execute customer data platforms workflows using forecast engine controls with validated outcomes.
