---
name: bank-core-systems-runbook-composer
description: Use when tasks require bank core systems runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Runbook Composer

## Purpose
Design and execute bank core systems workflows using runbook composer controls with validated outcomes.
