---
name: bim-coordination-conflict-resolver
description: Use when tasks require bim coordination conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Conflict Resolver

## Purpose
Design and execute bim coordination workflows using conflict resolver controls with validated outcomes.
