---
name: maritime-routing-permission-mapper
description: Use when tasks require maritime routing permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Permission Mapper

## Purpose
Design and execute maritime routing workflows using permission mapper controls with validated outcomes.
