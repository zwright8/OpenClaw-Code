---
name: airline-operations-risk-scorer
description: Use when tasks require airline operations risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Risk Scorer

## Purpose
Design and execute airline operations workflows using risk scorer controls with validated outcomes.
