---
name: cpq-platforms-postmortem-drafting
description: Use when tasks require cpq platforms postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Postmortem Drafting

## Purpose
Design and execute cpq platforms workflows using postmortem drafting controls with validated outcomes.
