---
name: bim-coordination-secret-scanner
description: Use when tasks require bim coordination secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Secret Scanner

## Purpose
Design and execute bim coordination workflows using secret scanner controls with validated outcomes.
