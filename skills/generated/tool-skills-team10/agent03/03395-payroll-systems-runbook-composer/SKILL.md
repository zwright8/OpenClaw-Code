---
name: payroll-systems-runbook-composer
description: Use when tasks require payroll systems runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Runbook Composer

## Purpose
Design and execute payroll systems workflows using runbook composer controls with validated outcomes.
