---
name: procure-to-pay-permission-mapper
description: Use when tasks require procure to pay permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Permission Mapper

## Purpose
Design and execute procure to pay workflows using permission mapper controls with validated outcomes.
