---
name: bim-coordination-execution-runner
description: Use when tasks require bim coordination execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Execution Runner

## Purpose
Design and execute bim coordination workflows using execution runner controls with validated outcomes.
