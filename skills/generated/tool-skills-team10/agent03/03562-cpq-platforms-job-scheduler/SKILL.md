---
name: cpq-platforms-job-scheduler
description: Use when tasks require cpq platforms job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Job Scheduler

## Purpose
Design and execute cpq platforms workflows using job scheduler controls with validated outcomes.
