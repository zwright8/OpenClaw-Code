---
name: payroll-systems-root-cause-miner
description: Use when tasks require payroll systems root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Root Cause Miner

## Purpose
Design and execute payroll systems workflows using root cause miner controls with validated outcomes.
