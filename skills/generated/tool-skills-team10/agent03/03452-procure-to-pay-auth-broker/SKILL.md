---
name: procure-to-pay-auth-broker
description: Use when tasks require procure to pay auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Auth Broker

## Purpose
Design and execute procure to pay workflows using auth broker controls with validated outcomes.
