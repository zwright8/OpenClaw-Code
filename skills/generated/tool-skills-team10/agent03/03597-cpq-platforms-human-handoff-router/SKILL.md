---
name: cpq-platforms-human-handoff-router
description: Use when tasks require cpq platforms human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Human Handoff Router

## Purpose
Design and execute cpq platforms workflows using human handoff router controls with validated outcomes.
