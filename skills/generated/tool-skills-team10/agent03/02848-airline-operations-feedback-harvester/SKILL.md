---
name: airline-operations-feedback-harvester
description: Use when tasks require airline operations feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Feedback Harvester

## Purpose
Design and execute airline operations workflows using feedback harvester controls with validated outcomes.
