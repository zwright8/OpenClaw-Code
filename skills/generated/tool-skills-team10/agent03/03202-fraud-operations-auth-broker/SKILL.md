---
name: fraud-operations-auth-broker
description: Use when tasks require fraud operations auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Auth Broker

## Purpose
Design and execute fraud operations workflows using auth broker controls with validated outcomes.
