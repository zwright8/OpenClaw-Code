---
name: facility-maintenance-evidence-collector
description: Use when tasks require facility maintenance evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Evidence Collector

## Purpose
Design and execute facility maintenance workflows using evidence collector controls with validated outcomes.
