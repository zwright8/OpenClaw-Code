---
name: treasury-management-secret-scanner
description: Use when tasks require treasury management secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Secret Scanner

## Purpose
Design and execute treasury management workflows using secret scanner controls with validated outcomes.
