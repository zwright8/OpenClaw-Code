---
name: construction-pm-latency-analyzer
description: Use when tasks require construction pm latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Latency Analyzer

## Purpose
Design and execute construction pm workflows using latency analyzer controls with validated outcomes.
