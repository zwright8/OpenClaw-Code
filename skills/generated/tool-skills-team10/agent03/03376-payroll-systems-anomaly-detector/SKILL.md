---
name: payroll-systems-anomaly-detector
description: Use when tasks require payroll systems anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Anomaly Detector

## Purpose
Design and execute payroll systems workflows using anomaly detector controls with validated outcomes.
