---
name: payroll-systems-feedback-harvester
description: Use when tasks require payroll systems feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Feedback Harvester

## Purpose
Design and execute payroll systems workflows using feedback harvester controls with validated outcomes.
