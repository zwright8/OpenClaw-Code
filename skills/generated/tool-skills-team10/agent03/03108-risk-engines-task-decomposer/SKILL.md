---
name: risk-engines-task-decomposer
description: Use when tasks require risk engines task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Task Decomposer

## Purpose
Design and execute risk engines workflows using task decomposer controls with validated outcomes.
