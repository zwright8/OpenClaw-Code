---
name: procure-to-pay-capacity-planner
description: Use when tasks require procure to pay capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Capacity Planner

## Purpose
Design and execute procure to pay workflows using capacity planner controls with validated outcomes.
