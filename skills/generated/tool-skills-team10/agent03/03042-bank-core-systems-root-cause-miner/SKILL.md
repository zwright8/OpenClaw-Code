---
name: bank-core-systems-root-cause-miner
description: Use when tasks require bank core systems root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Root Cause Miner

## Purpose
Design and execute bank core systems workflows using root cause miner controls with validated outcomes.
