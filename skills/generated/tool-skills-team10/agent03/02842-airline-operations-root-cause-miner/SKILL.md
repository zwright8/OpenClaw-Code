---
name: airline-operations-root-cause-miner
description: Use when tasks require airline operations root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Root Cause Miner

## Purpose
Design and execute airline operations workflows using root cause miner controls with validated outcomes.
