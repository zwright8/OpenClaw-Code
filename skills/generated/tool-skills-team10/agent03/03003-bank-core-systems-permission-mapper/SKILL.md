---
name: bank-core-systems-permission-mapper
description: Use when tasks require bank core systems permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Permission Mapper

## Purpose
Design and execute bank core systems workflows using permission mapper controls with validated outcomes.
