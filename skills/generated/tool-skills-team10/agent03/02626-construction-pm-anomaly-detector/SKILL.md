---
name: construction-pm-anomaly-detector
description: Use when tasks require construction pm anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Anomaly Detector

## Purpose
Design and execute construction pm workflows using anomaly detector controls with validated outcomes.
