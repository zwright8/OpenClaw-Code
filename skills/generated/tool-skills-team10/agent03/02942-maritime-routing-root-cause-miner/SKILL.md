---
name: maritime-routing-root-cause-miner
description: Use when tasks require maritime routing root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Root Cause Miner

## Purpose
Design and execute maritime routing workflows using root cause miner controls with validated outcomes.
