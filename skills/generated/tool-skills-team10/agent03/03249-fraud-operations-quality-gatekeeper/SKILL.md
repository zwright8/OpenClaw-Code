---
name: fraud-operations-quality-gatekeeper
description: Use when tasks require fraud operations quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Quality Gatekeeper

## Purpose
Design and execute fraud operations workflows using quality gatekeeper controls with validated outcomes.
