---
name: risk-engines-approval-orchestrator
description: Use when tasks require risk engines approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Approval Orchestrator

## Purpose
Design and execute risk engines workflows using approval orchestrator controls with validated outcomes.
