---
name: treasury-management-anomaly-detector
description: Use when tasks require treasury management anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Anomaly Detector

## Purpose
Design and execute treasury management workflows using anomaly detector controls with validated outcomes.
