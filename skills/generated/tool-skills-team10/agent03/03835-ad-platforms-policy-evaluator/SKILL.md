---
name: ad-platforms-policy-evaluator
description: Use when tasks require ad platforms policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Policy Evaluator

## Purpose
Design and execute ad platforms workflows using policy evaluator controls with validated outcomes.
