---
name: maritime-routing-reliability-scorer
description: Use when tasks require maritime routing reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Reliability Scorer

## Purpose
Design and execute maritime routing workflows using reliability scorer controls with validated outcomes.
