...
description: Use when tasks require bim coordination provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Provenance Tracker

## Purpose
Design and execute bim coordination workflows using provenance tracker controls with validated outcomes.
