---
name: partner-portals-artifact-publisher
description: Use when tasks require partner portals artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Artifact Publisher

## Purpose
Design and execute partner portals workflows using artifact publisher controls with validated outcomes.
