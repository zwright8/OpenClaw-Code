---
name: payroll-systems-task-decomposer
description: Use when tasks require payroll systems task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Task Decomposer

## Purpose
Design and execute payroll systems workflows using task decomposer controls with validated outcomes.
