---
name: cpq-platforms-migration-planner
description: Use when tasks require cpq platforms migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Migration Planner

## Purpose
Design and execute cpq platforms workflows using migration planner controls with validated outcomes.
