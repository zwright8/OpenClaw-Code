---
name: bank-core-systems-access-auditor
description: Use when tasks require bank core systems access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Access Auditor

## Purpose
Design and execute bank core systems workflows using access auditor controls with validated outcomes.
