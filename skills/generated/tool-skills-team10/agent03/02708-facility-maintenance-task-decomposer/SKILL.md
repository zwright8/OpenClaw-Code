---
name: facility-maintenance-task-decomposer
description: Use when tasks require facility maintenance task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Task Decomposer

## Purpose
Design and execute facility maintenance workflows using task decomposer controls with validated outcomes.
