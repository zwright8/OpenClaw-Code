---
name: treasury-management-human-handoff-router
description: Use when tasks require treasury management human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Human Handoff Router

## Purpose
Design and execute treasury management workflows using human handoff router controls with validated outcomes.
