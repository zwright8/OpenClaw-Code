---
name: travel-compliance-secret-scanner
description: Use when tasks require travel compliance secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Travel Compliance Secret Scanner

## Purpose
Design and execute travel compliance workflows using secret scanner controls with validated outcomes.
