---
name: crm-intelligence-human-handoff-router
description: Use when tasks require crm intelligence human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Human Handoff Router

## Purpose
Design and execute crm intelligence workflows using human handoff router controls with validated outcomes.
