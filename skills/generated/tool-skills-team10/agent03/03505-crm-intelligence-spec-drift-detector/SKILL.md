---
name: crm-intelligence-spec-drift-detector
description: Use when tasks require crm intelligence spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Spec Drift Detector

## Purpose
Design and execute crm intelligence workflows using spec drift detector controls with validated outcomes.
