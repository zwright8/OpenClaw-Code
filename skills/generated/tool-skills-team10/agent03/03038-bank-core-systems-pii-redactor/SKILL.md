---
name: bank-core-systems-pii-redactor
description: Use when tasks require bank core systems pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems PII Redactor

## Purpose
Design and execute bank core systems workflows using pii redactor controls with validated outcomes.
