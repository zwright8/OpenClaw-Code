---
name: bank-core-systems-quality-gatekeeper
description: Use when tasks require bank core systems quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Quality Gatekeeper

## Purpose
Design and execute bank core systems workflows using quality gatekeeper controls with validated outcomes.
