---
name: cpq-platforms-artifact-publisher
description: Use when tasks require cpq platforms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Artifact Publisher

## Purpose
Design and execute cpq platforms workflows using artifact publisher controls with validated outcomes.
