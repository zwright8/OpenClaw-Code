---
name: hospitality-pms-queue-balancer
description: Use when tasks require hospitality pms queue balancer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Queue Balancer

## Purpose
Design and execute hospitality pms workflows using queue balancer controls with validated outcomes.
