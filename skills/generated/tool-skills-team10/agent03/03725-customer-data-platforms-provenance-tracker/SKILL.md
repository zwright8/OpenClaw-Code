---
name: customer-data-platforms-provenance-tracker
description: Use when tasks require customer data platforms provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Provenance Tracker

## Purpose
Design and execute customer data platforms workflows using provenance tracker controls with validated outcomes.
