---
name: hospitality-pms-retry-governor
description: Use when tasks require hospitality pms retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Retry Governor

## Purpose
Design and execute hospitality pms workflows using retry governor controls with validated outcomes.
