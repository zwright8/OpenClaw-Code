---
name: treasury-management-root-cause-miner
description: Use when tasks require treasury management root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Root Cause Miner

## Purpose
Design and execute treasury management workflows using root cause miner controls with validated outcomes.
