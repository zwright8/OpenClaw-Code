---
name: customer-data-platforms-api-contract-validator
description: Use when tasks require customer data platforms api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms API Contract Validator

## Purpose
Design and execute customer data platforms workflows using api contract validator controls with validated outcomes.
...
- Domain: [Customer Data Platforms](../../resources/domains/customer-data-platforms.md)
