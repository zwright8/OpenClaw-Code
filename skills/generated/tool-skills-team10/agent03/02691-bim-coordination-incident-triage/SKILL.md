---
name: bim-coordination-incident-triage
description: Use when tasks require bim coordination incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Incident Triage

## Purpose
Design and execute bim coordination workflows using incident triage controls with validated outcomes.
