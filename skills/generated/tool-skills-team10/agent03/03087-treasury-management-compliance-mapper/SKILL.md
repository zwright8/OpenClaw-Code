---
name: treasury-management-compliance-mapper
description: Use when tasks require treasury management compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Compliance Mapper

## Purpose
Design and execute treasury management workflows using compliance mapper controls with validated outcomes.
