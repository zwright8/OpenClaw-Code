---
name: marketing-attribution-policy-evaluator
description: Use when tasks require marketing attribution policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Policy Evaluator

## Purpose
Design and execute marketing attribution workflows using policy evaluator controls with validated outcomes.
