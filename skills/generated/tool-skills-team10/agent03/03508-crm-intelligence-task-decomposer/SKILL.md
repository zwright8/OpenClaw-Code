---
name: crm-intelligence-task-decomposer
description: Use when tasks require crm intelligence task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Task Decomposer

## Purpose
Design and execute crm intelligence workflows using task decomposer controls with validated outcomes.
