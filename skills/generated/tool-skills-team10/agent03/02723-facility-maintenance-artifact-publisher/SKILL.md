---
name: facility-maintenance-artifact-publisher
description: Use when tasks require facility maintenance artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Artifact Publisher

## Purpose
Design and execute facility maintenance workflows using artifact publisher controls with validated outcomes.
