---
name: treasury-management-permission-mapper
description: Use when tasks require treasury management permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Permission Mapper

## Purpose
Design and execute treasury management workflows using permission mapper controls with validated outcomes.
