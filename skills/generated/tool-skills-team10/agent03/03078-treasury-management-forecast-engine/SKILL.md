---
name: treasury-management-forecast-engine
description: Use when tasks require treasury management forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Forecast Engine

## Purpose
Design and execute treasury management workflows using forecast engine controls with validated outcomes.
