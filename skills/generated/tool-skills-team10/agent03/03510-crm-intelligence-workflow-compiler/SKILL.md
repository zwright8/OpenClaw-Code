---
name: crm-intelligence-workflow-compiler
description: Use when tasks require crm intelligence workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Workflow Compiler

## Purpose
Design and execute crm intelligence workflows using workflow compiler controls with validated outcomes.
