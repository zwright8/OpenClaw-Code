---
name: partner-portals-feedback-harvester
description: Use when tasks require partner portals feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Feedback Harvester

## Purpose
Design and execute partner portals workflows using feedback harvester controls with validated outcomes.
