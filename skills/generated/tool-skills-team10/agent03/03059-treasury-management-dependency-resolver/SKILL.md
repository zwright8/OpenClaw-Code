---
name: treasury-management-dependency-resolver
description: Use when tasks require treasury management dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Dependency Resolver

## Purpose
Design and execute treasury management workflows using dependency resolver controls with validated outcomes.
