---
name: marketing-attribution-job-scheduler
description: Use when tasks require marketing attribution job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Job Scheduler

## Purpose
Design and execute marketing attribution workflows using job scheduler controls with validated outcomes.
