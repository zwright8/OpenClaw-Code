---
name: airline-operations-runbook-composer
description: Use when tasks require airline operations runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Runbook Composer

## Purpose
Design and execute airline operations workflows using runbook composer controls with validated outcomes.
