---
name: airline-operations-remediation-planner
description: Use when tasks require airline operations remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Remediation Planner

## Purpose
Design and execute airline operations workflows using remediation planner controls with validated outcomes.
