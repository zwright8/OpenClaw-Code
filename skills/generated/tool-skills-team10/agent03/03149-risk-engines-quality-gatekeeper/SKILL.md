---
name: risk-engines-quality-gatekeeper
description: Use when tasks require risk engines quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Quality Gatekeeper

## Purpose
Design and execute risk engines workflows using quality gatekeeper controls with validated outcomes.
