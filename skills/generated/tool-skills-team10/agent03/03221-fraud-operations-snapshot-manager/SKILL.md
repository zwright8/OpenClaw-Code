---
name: fraud-operations-snapshot-manager
description: Use when tasks require fraud operations snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Snapshot Manager

## Purpose
Design and execute fraud operations workflows using snapshot manager controls with validated outcomes.
