---
name: marketing-attribution-quality-gatekeeper
description: Use when tasks require marketing attribution quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Quality Gatekeeper

## Purpose
Design and execute marketing attribution workflows using quality gatekeeper controls with validated outcomes.
