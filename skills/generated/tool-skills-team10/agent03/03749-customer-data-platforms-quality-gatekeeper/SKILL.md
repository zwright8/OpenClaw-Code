---
name: customer-data-platforms-quality-gatekeeper
description: Use when tasks require customer data platforms quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Quality Gatekeeper

## Purpose
Design and execute customer data platforms workflows using quality gatekeeper controls with validated outcomes.
