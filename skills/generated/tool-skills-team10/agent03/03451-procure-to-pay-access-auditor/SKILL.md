---
name: procure-to-pay-access-auditor
description: Use when tasks require procure to pay access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Access Auditor

## Purpose
Design and execute procure to pay workflows using access auditor controls with validated outcomes.
