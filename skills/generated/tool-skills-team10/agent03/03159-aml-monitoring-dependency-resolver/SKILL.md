---
name: aml-monitoring-dependency-resolver
description: Use when tasks require aml monitoring dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Dependency Resolver

## Purpose
Design and execute aml monitoring workflows using dependency resolver controls with validated outcomes.
