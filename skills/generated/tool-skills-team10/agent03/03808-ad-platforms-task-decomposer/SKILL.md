---
name: ad-platforms-task-decomposer
description: Use when tasks require ad platforms task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Task Decomposer

## Purpose
Design and execute ad platforms workflows using task decomposer controls with validated outcomes.
