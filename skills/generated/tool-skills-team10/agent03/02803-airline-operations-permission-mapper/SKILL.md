---
name: airline-operations-permission-mapper
description: Use when tasks require airline operations permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Permission Mapper

## Purpose
Design and execute airline operations workflows using permission mapper controls with validated outcomes.
