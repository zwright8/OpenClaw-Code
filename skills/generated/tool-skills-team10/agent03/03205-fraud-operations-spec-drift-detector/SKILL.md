---
name: fraud-operations-spec-drift-detector
description: Use when tasks require fraud operations spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Spec Drift Detector

## Purpose
Design and execute fraud operations workflows using spec drift detector controls with validated outcomes.
