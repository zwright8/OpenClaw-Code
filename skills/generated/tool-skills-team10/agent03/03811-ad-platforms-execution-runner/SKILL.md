---
name: ad-platforms-execution-runner
description: Use when tasks require ad platforms execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Execution Runner

## Purpose
Design and execute ad platforms workflows using execution runner controls with validated outcomes.
