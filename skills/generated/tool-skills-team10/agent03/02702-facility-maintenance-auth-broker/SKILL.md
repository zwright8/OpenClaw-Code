---
name: facility-maintenance-auth-broker
description: Use when tasks require facility maintenance auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Auth Broker

## Purpose
Design and execute facility maintenance workflows using auth broker controls with validated outcomes.
