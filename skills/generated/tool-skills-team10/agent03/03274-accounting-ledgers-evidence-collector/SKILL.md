---
name: accounting-ledgers-evidence-collector
description: Use when tasks require accounting ledgers evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accounting Ledgers Evidence Collector

## Purpose
Design and execute accounting ledgers workflows using evidence collector controls with validated outcomes.
