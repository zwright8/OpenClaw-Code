---
name: payroll-systems-artifact-publisher
description: Use when tasks require payroll systems artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Artifact Publisher

## Purpose
Design and execute payroll systems workflows using artifact publisher controls with validated outcomes.
