---
name: payroll-systems-migration-planner
description: Use when tasks require payroll systems migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Migration Planner

## Purpose
Design and execute payroll systems workflows using migration planner controls with validated outcomes.
