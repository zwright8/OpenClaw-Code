---
name: ad-platforms-snapshot-manager
description: Use when tasks require ad platforms snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Snapshot Manager

## Purpose
Design and execute ad platforms workflows using snapshot manager controls with validated outcomes.
