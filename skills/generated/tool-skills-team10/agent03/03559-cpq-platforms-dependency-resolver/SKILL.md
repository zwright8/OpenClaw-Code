---
name: cpq-platforms-dependency-resolver
description: Use when tasks require cpq platforms dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Dependency Resolver

## Purpose
Design and execute cpq platforms workflows using dependency resolver controls with validated outcomes.
