---
name: customer-data-platforms-access-auditor
description: Use when tasks require customer data platforms access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Access Auditor

## Purpose
Design and execute customer data platforms workflows using access auditor controls with validated outcomes.
