---
name: bank-core-systems-rate-limit-optimizer
description: Use when tasks require bank core systems rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Rate Limit Optimizer

## Purpose
Design and execute bank core systems workflows using rate limit optimizer controls with validated outcomes.
