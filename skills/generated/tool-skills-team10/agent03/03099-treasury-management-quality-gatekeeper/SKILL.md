---
name: treasury-management-quality-gatekeeper
description: Use when tasks require treasury management quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Quality Gatekeeper

## Purpose
Design and execute treasury management workflows using quality gatekeeper controls with validated outcomes.
