---
name: crm-intelligence-access-auditor
description: Use when tasks require crm intelligence access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Access Auditor

## Purpose
Design and execute crm intelligence workflows using access auditor controls with validated outcomes.
