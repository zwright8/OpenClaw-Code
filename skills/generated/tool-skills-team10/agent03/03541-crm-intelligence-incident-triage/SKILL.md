---
name: crm-intelligence-incident-triage
description: Use when tasks require crm intelligence incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Incident Triage

## Purpose
Design and execute crm intelligence workflows using incident triage controls with validated outcomes.
