---
name: airline-operations-workflow-compiler
description: Use when tasks require airline operations workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Workflow Compiler

## Purpose
Design and execute airline operations workflows using workflow compiler controls with validated outcomes.
