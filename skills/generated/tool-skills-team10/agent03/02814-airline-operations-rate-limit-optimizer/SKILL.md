---
name: airline-operations-rate-limit-optimizer
description: Use when tasks require airline operations rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Rate Limit Optimizer

## Purpose
Design and execute airline operations workflows using rate limit optimizer controls with validated outcomes.
