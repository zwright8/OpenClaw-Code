---
name: travel-compliance-snapshot-manager
description: Use when tasks require travel compliance snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Travel Compliance Snapshot Manager

## Purpose
Design and execute travel compliance workflows using snapshot manager controls with validated outcomes.
