---
name: marketing-attribution-approval-orchestrator
description: Use when tasks require marketing attribution approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Approval Orchestrator

## Purpose
Design and execute marketing attribution workflows using approval orchestrator controls with validated outcomes.
