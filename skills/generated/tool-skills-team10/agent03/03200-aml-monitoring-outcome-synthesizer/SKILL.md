---
name: aml-monitoring-outcome-synthesizer
description: Use when tasks require aml monitoring outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Outcome Synthesizer

## Purpose
Design and execute aml monitoring workflows using outcome synthesizer controls with validated outcomes.
