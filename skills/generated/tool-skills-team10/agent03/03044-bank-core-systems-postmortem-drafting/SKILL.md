---
name: bank-core-systems-postmortem-drafting
description: Use when tasks require bank core systems postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Postmortem Drafting

## Purpose
Design and execute bank core systems workflows using postmortem drafting controls with validated outcomes.
