---
name: customer-data-platforms-policy-evaluator
description: Use when tasks require customer data platforms policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Policy Evaluator

## Purpose
Design and execute customer data platforms workflows using policy evaluator controls with validated outcomes.
