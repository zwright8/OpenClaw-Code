---
name: marketing-attribution-spec-drift-detector
description: Use when tasks require marketing attribution spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Spec Drift Detector

## Purpose
Design and execute marketing attribution workflows using spec drift detector controls with validated outcomes.
