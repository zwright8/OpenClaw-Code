---
name: risk-engines-spec-drift-detector
description: Use when tasks require risk engines spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Spec Drift Detector

## Purpose
Design and execute risk engines workflows using spec drift detector controls with validated outcomes.
