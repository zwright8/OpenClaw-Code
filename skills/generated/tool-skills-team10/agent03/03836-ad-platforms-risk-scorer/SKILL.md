---
name: ad-platforms-risk-scorer
description: Use when tasks require ad platforms risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Risk Scorer

## Purpose
Design and execute ad platforms workflows using risk scorer controls with validated outcomes.
