---
name: cpq-platforms-evidence-collector
description: Use when tasks require cpq platforms evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Evidence Collector

## Purpose
Design and execute cpq platforms workflows using evidence collector controls with validated outcomes.
