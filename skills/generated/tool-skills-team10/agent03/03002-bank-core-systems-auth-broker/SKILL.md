---
name: bank-core-systems-auth-broker
description: Use when tasks require bank core systems auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Auth Broker

## Purpose
Design and execute bank core systems workflows using auth broker controls with validated outcomes.
