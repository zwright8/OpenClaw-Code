---
name: marketing-attribution-human-handoff-router
description: Use when tasks require marketing attribution human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Human Handoff Router

## Purpose
Design and execute marketing attribution workflows using human handoff router controls with validated outcomes.
