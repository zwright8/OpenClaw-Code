---
name: bim-coordination-pii-redactor
description: Use when tasks require bim coordination pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination PII Redactor

## Purpose
Design and execute bim coordination workflows using pii redactor controls with validated outcomes.
