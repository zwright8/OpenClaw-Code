---
name: bim-coordination-threshold-alerting
description: Use when tasks require bim coordination threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Threshold Alerting

## Purpose
Design and execute bim coordination workflows using threshold alerting controls with validated outcomes.
