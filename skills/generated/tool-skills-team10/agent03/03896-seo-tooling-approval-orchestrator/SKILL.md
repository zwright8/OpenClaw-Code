---
name: seo-tooling-approval-orchestrator
description: Use when tasks require seo tooling approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SEO Tooling Approval Orchestrator

## Purpose
Design and execute seo tooling workflows using approval orchestrator controls with validated outcomes.
