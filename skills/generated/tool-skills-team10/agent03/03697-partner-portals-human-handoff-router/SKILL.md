---
name: partner-portals-human-handoff-router
description: Use when tasks require partner portals human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Partner Portals Human Handoff Router

## Purpose
Design and execute partner portals workflows using human handoff router controls with validated outcomes.
