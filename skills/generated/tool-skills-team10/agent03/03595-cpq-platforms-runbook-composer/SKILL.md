---
name: cpq-platforms-runbook-composer
description: Use when tasks require cpq platforms runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Runbook Composer

## Purpose
Design and execute cpq platforms workflows using runbook composer controls with validated outcomes.
