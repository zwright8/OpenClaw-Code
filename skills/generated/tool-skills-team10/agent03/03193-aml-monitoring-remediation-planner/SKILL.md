---
name: aml-monitoring-remediation-planner
description: Use when tasks require aml monitoring remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Remediation Planner

## Purpose
Design and execute aml monitoring workflows using remediation planner controls with validated outcomes.
