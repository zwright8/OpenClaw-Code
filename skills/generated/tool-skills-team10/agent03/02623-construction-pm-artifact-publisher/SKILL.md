---
name: construction-pm-artifact-publisher
description: Use when tasks require construction pm artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Artifact Publisher

## Purpose
Design and execute construction pm workflows using artifact publisher controls with validated outcomes.
