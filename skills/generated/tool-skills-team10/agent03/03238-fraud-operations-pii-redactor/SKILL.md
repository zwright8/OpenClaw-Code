---
name: fraud-operations-pii-redactor
description: Use when tasks require fraud operations pii redactor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations PII Redactor

## Purpose
Design and execute fraud operations workflows using pii redactor controls with validated outcomes.
