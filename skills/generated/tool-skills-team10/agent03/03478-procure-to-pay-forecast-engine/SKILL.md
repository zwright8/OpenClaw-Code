---
name: procure-to-pay-forecast-engine
description: Use when tasks require procure to pay forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Forecast Engine

## Purpose
Design and execute procure to pay workflows using forecast engine controls with validated outcomes.
