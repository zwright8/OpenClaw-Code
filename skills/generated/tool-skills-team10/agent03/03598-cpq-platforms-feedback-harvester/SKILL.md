---
name: cpq-platforms-feedback-harvester
description: Use when tasks require cpq platforms feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Feedback Harvester

## Purpose
Design and execute cpq platforms workflows using feedback harvester controls with validated outcomes.
