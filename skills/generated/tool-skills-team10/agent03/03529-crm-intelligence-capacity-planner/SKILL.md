---
name: crm-intelligence-capacity-planner
description: Use when tasks require crm intelligence capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Capacity Planner

## Purpose
Design and execute crm intelligence workflows using capacity planner controls with validated outcomes.
