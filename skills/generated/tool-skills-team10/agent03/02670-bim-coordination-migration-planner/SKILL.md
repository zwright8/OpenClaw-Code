---
name: bim-coordination-migration-planner
description: Use when tasks require bim coordination migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Migration Planner

## Purpose
Design and execute bim coordination workflows using migration planner controls with validated outcomes.
