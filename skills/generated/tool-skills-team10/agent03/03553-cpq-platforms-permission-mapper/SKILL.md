---
name: cpq-platforms-permission-mapper
description: Use when tasks require cpq platforms permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Permission Mapper

## Purpose
Design and execute cpq platforms workflows using permission mapper controls with validated outcomes.
