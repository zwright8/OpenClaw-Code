---
name: cpq-platforms-quality-gatekeeper
description: Use when tasks require cpq platforms quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Quality Gatekeeper

## Purpose
Design and execute cpq platforms workflows using quality gatekeeper controls with validated outcomes.
