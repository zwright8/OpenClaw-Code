---
name: aml-monitoring-snapshot-manager
description: Use when tasks require aml monitoring snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Snapshot Manager

## Purpose
Design and execute aml monitoring workflows using snapshot manager controls with validated outcomes.
