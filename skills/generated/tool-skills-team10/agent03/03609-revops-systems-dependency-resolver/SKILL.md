---
name: revops-systems-dependency-resolver
description: Use when tasks require revops systems dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RevOps Systems Dependency Resolver

## Purpose
Design and execute revops systems workflows using dependency resolver controls with validated outcomes.
