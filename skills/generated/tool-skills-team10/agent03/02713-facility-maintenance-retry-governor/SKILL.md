---
name: facility-maintenance-retry-governor
description: Use when tasks require facility maintenance retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Retry Governor

## Purpose
Design and execute facility maintenance workflows using retry governor controls with validated outcomes.
