---
name: risk-engines-anomaly-detector
description: Use when tasks require risk engines anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Anomaly Detector

## Purpose
Design and execute risk engines workflows using anomaly detector controls with validated outcomes.
