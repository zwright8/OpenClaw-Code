---
name: airline-operations-approval-orchestrator
description: Use when tasks require airline operations approval orchestrator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Approval Orchestrator

## Purpose
Design and execute airline operations workflows using approval orchestrator controls with validated outcomes.
