---
name: bank-core-systems-anomaly-detector
description: Use when tasks require bank core systems anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Anomaly Detector

## Purpose
Design and execute bank core systems workflows using anomaly detector controls with validated outcomes.
