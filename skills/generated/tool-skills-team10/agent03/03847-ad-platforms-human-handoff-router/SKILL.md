---
name: ad-platforms-human-handoff-router
description: Use when tasks require ad platforms human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Human Handoff Router

## Purpose
Design and execute ad platforms workflows using human handoff router controls with validated outcomes.
