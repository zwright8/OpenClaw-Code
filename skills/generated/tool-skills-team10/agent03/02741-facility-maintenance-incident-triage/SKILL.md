---
name: facility-maintenance-incident-triage
description: Use when tasks require facility maintenance incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Incident Triage

## Purpose
Design and execute facility maintenance workflows using incident triage controls with validated outcomes.
