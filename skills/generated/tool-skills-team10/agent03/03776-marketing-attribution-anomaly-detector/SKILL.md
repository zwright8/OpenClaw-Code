---
name: marketing-attribution-anomaly-detector
description: Use when tasks require marketing attribution anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Anomaly Detector

## Purpose
Design and execute marketing attribution workflows using anomaly detector controls with validated outcomes.
