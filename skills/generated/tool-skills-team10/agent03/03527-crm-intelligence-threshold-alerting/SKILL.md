---
name: crm-intelligence-threshold-alerting
description: Use when tasks require crm intelligence threshold alerting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Threshold Alerting

## Purpose
Design and execute crm intelligence workflows using threshold alerting controls with validated outcomes.
