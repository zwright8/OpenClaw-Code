---
name: treasury-management-access-auditor
description: Use when tasks require treasury management access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Access Auditor

## Purpose
Design and execute treasury management workflows using access auditor controls with validated outcomes.
