---
name: ad-platforms-artifact-publisher
description: Use when tasks require ad platforms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Artifact Publisher

## Purpose
Design and execute ad platforms workflows using artifact publisher controls with validated outcomes.
