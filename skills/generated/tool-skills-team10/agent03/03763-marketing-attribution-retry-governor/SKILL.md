---
name: marketing-attribution-retry-governor
description: Use when tasks require marketing attribution retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Retry Governor

## Purpose
Design and execute marketing attribution workflows using retry governor controls with validated outcomes.
