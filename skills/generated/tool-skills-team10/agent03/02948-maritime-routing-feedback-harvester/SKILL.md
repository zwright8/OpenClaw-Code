---
name: maritime-routing-feedback-harvester
description: Use when tasks require maritime routing feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Feedback Harvester

## Purpose
Design and execute maritime routing workflows using feedback harvester controls with validated outcomes.
