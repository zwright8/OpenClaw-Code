---
name: crm-intelligence-runbook-composer
description: Use when tasks require crm intelligence runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Runbook Composer

## Purpose
Design and execute crm intelligence workflows using runbook composer controls with validated outcomes.
