---
name: seo-tooling-evidence-collector
description: Use when tasks require seo tooling evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SEO Tooling Evidence Collector

## Purpose
Design and execute seo tooling workflows using evidence collector controls with validated outcomes.
