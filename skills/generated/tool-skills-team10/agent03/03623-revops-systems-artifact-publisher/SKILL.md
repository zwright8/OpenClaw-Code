---
name: revops-systems-artifact-publisher
description: Use when tasks require revops systems artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RevOps Systems Artifact Publisher

## Purpose
Design and execute revops systems workflows using artifact publisher controls with validated outcomes.
