---
name: payroll-systems-evidence-collector
description: Use when tasks require payroll systems evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Evidence Collector

## Purpose
Design and execute payroll systems workflows using evidence collector controls with validated outcomes.
