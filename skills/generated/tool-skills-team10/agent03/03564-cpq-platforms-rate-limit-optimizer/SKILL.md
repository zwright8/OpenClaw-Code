---
name: cpq-platforms-rate-limit-optimizer
description: Use when tasks require cpq platforms rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Rate Limit Optimizer

## Purpose
Design and execute cpq platforms workflows using rate limit optimizer controls with validated outcomes.
