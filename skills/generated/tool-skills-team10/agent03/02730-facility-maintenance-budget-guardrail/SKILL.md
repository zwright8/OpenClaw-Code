---
name: facility-maintenance-budget-guardrail
description: Use when tasks require facility maintenance budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Budget Guardrail

## Purpose
Design and execute facility maintenance workflows using budget guardrail controls with validated outcomes.
