---
name: bim-coordination-human-handoff-router
description: Use when tasks require bim coordination human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Human Handoff Router

## Purpose
Design and execute bim coordination workflows using human handoff router controls with validated outcomes.
