---
name: marketing-attribution-incident-triage
description: Use when tasks require marketing attribution incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Incident Triage

## Purpose
Design and execute marketing attribution workflows using incident triage controls with validated outcomes.
