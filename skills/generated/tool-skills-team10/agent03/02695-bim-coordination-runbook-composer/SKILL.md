---
name: bim-coordination-runbook-composer
description: Use when tasks require bim coordination runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Runbook Composer

## Purpose
Design and execute bim coordination workflows using runbook composer controls with validated outcomes.
