---
name: crm-intelligence-snapshot-manager
description: Use when tasks require crm intelligence snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Snapshot Manager

## Purpose
Design and execute crm intelligence workflows using snapshot manager controls with validated outcomes.
