---
name: bim-coordination-auth-broker
description: Use when tasks require bim coordination auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Auth Broker

## Purpose
Design and execute bim coordination workflows using auth broker controls with validated outcomes.
