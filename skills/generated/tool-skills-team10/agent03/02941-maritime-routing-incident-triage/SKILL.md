---
name: maritime-routing-incident-triage
description: Use when tasks require maritime routing incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Incident Triage

## Purpose
Design and execute maritime routing workflows using incident triage controls with validated outcomes.
