---
name: crm-intelligence-permission-mapper
description: Use when tasks require crm intelligence permission mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Permission Mapper

## Purpose
Design and execute crm intelligence workflows using permission mapper controls with validated outcomes.
