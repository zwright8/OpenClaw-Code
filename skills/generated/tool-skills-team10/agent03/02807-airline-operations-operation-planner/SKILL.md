---
name: airline-operations-operation-planner
description: Use when tasks require airline operations operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Operation Planner

## Purpose
Design and execute airline operations workflows using operation planner controls with validated outcomes.
