---
name: crm-intelligence-schema-introspector
description: Use when tasks require crm intelligence schema introspector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Schema Introspector

## Purpose
Design and execute crm intelligence workflows using schema introspector controls with validated outcomes.
