---
name: cpq-platforms-policy-evaluator
description: Use when tasks require cpq platforms policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Policy Evaluator

## Purpose
Design and execute cpq platforms workflows using policy evaluator controls with validated outcomes.
