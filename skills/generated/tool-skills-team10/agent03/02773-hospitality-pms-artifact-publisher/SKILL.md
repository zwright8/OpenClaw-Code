---
name: hospitality-pms-artifact-publisher
description: Use when tasks require hospitality pms artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Artifact Publisher

## Purpose
Design and execute hospitality pms workflows using artifact publisher controls with validated outcomes.
