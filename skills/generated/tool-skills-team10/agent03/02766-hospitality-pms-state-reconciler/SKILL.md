---
name: hospitality-pms-state-reconciler
description: Use when tasks require hospitality pms state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS State Reconciler

## Purpose
Design and execute hospitality pms workflows using state reconciler controls with validated outcomes.
