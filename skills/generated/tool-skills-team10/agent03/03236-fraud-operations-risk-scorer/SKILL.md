---
name: fraud-operations-risk-scorer
description: Use when tasks require fraud operations risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Risk Scorer

## Purpose
Design and execute fraud operations workflows using risk scorer controls with validated outcomes.
