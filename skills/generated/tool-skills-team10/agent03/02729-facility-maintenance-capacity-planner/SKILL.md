---
name: facility-maintenance-capacity-planner
description: Use when tasks require facility maintenance capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Capacity Planner

## Purpose
Design and execute facility maintenance workflows using capacity planner controls with validated outcomes.
