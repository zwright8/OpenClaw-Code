---
name: customer-data-platforms-human-handoff-router
description: Use when tasks require customer data platforms human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Human Handoff Router

## Purpose
Design and execute customer data platforms workflows using human handoff router controls with validated outcomes.
