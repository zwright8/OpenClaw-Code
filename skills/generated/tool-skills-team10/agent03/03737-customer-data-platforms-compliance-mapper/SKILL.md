---
name: customer-data-platforms-compliance-mapper
description: Use when tasks require customer data platforms compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Compliance Mapper

## Purpose
Design and execute customer data platforms workflows using compliance mapper controls with validated outcomes.
