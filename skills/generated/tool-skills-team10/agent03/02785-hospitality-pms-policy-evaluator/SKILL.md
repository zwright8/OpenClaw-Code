---
name: hospitality-pms-policy-evaluator
description: Use when tasks require hospitality pms policy evaluator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Policy Evaluator

## Purpose
Design and execute hospitality pms workflows using policy evaluator controls with validated outcomes.
