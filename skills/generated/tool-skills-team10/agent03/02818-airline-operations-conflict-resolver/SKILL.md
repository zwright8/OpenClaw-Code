---
name: airline-operations-conflict-resolver
description: Use when tasks require airline operations conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Conflict Resolver

## Purpose
Design and execute airline operations workflows using conflict resolver controls with validated outcomes.
