---
name: facility-maintenance-state-reconciler
description: Use when tasks require facility maintenance state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance State Reconciler

## Purpose
Design and execute facility maintenance workflows using state reconciler controls with validated outcomes.
