---
name: bim-coordination-snapshot-manager
description: Use when tasks require bim coordination snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Snapshot Manager

## Purpose
Design and execute bim coordination workflows using snapshot manager controls with validated outcomes.
