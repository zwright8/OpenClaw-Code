---
name: aml-monitoring-feedback-harvester
description: Use when tasks require aml monitoring feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Feedback Harvester

## Purpose
Design and execute aml monitoring workflows using feedback harvester controls with validated outcomes.
