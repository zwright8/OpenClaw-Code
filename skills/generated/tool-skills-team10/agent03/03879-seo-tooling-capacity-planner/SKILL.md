---
name: seo-tooling-capacity-planner
description: Use when tasks require seo tooling capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SEO Tooling Capacity Planner

## Purpose
Design and execute seo tooling workflows using capacity planner controls with validated outcomes.
