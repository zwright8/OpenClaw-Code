---
name: ad-platforms-root-cause-miner
description: Use when tasks require ad platforms root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Root Cause Miner

## Purpose
Design and execute ad platforms workflows using root cause miner controls with validated outcomes.
