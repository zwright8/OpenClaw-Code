---
name: fraud-operations-conflict-resolver
description: Use when tasks require fraud operations conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Conflict Resolver

## Purpose
Design and execute fraud operations workflows using conflict resolver controls with validated outcomes.
