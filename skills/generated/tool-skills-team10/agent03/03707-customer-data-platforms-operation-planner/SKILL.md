---
name: customer-data-platforms-operation-planner
description: Use when tasks require customer data platforms operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Operation Planner

## Purpose
Design and execute customer data platforms workflows using operation planner controls with validated outcomes.
