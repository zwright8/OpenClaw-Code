---
name: cpq-platforms-sla-enforcer
description: Use when tasks require cpq platforms sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms SLA Enforcer

## Purpose
Design and execute cpq platforms workflows using sla enforcer controls with validated outcomes.
