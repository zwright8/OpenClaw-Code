---
name: marketing-attribution-risk-scorer
description: Use when tasks require marketing attribution risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Risk Scorer

## Purpose
Design and execute marketing attribution workflows using risk scorer controls with validated outcomes.
