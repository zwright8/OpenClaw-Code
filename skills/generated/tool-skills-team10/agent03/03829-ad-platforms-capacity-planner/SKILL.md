---
name: ad-platforms-capacity-planner
description: Use when tasks require ad platforms capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Capacity Planner

## Purpose
Design and execute ad platforms workflows using capacity planner controls with validated outcomes.
