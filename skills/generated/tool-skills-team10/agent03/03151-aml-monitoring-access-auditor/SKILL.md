---
name: aml-monitoring-access-auditor
description: Use when tasks require aml monitoring access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Access Auditor

## Purpose
Design and execute aml monitoring workflows using access auditor controls with validated outcomes.
