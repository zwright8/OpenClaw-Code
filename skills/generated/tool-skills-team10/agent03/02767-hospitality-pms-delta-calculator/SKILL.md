---
name: hospitality-pms-delta-calculator
description: Use when tasks require hospitality pms delta calculator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Delta Calculator

## Purpose
Design and execute hospitality pms workflows using delta calculator controls with validated outcomes.
