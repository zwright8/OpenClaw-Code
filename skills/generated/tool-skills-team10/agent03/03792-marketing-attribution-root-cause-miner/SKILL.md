---
name: marketing-attribution-root-cause-miner
description: Use when tasks require marketing attribution root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Root Cause Miner

## Purpose
Design and execute marketing attribution workflows using root cause miner controls with validated outcomes.
