---
name: bim-coordination-anomaly-detector
description: Use when tasks require bim coordination anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Anomaly Detector

## Purpose
Design and execute bim coordination workflows using anomaly detector controls with validated outcomes.
