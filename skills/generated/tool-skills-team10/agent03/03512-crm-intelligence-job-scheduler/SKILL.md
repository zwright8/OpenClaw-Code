---
name: crm-intelligence-job-scheduler
description: Use when tasks require crm intelligence job scheduler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Job Scheduler

## Purpose
Design and execute crm intelligence workflows using job scheduler controls with validated outcomes.
