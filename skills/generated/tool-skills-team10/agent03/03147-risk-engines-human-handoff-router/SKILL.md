---
name: risk-engines-human-handoff-router
description: Use when tasks require risk engines human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Human Handoff Router

## Purpose
Design and execute risk engines workflows using human handoff router controls with validated outcomes.
