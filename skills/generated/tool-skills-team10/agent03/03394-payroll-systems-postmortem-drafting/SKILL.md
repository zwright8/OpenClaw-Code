---
name: payroll-systems-postmortem-drafting
description: Use when tasks require payroll systems postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Postmortem Drafting

## Purpose
Design and execute payroll systems workflows using postmortem drafting controls with validated outcomes.
