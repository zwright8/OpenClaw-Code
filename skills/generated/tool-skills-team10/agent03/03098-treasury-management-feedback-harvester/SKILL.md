---
name: treasury-management-feedback-harvester
description: Use when tasks require treasury management feedback harvester with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Feedback Harvester

## Purpose
Design and execute treasury management workflows using feedback harvester controls with validated outcomes.
