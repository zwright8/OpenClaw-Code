---
name: bim-coordination-capacity-planner
description: Use when tasks require bim coordination capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Capacity Planner

## Purpose
Design and execute bim coordination workflows using capacity planner controls with validated outcomes.
