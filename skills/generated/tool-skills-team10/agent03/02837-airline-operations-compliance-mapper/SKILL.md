---
name: airline-operations-compliance-mapper
description: Use when tasks require airline operations compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Compliance Mapper

## Purpose
Design and execute airline operations workflows using compliance mapper controls with validated outcomes.
