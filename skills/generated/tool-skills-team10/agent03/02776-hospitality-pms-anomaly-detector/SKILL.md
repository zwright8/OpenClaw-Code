---
name: hospitality-pms-anomaly-detector
description: Use when tasks require hospitality pms anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Anomaly Detector

## Purpose
Design and execute hospitality pms workflows using anomaly detector controls with validated outcomes.
