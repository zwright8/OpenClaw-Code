---
name: ad-platforms-anomaly-detector
description: Use when tasks require ad platforms anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Anomaly Detector

## Purpose
Design and execute ad platforms workflows using anomaly detector controls with validated outcomes.
