---
name: accounting-ledgers-incident-triage
description: Use when tasks require accounting ledgers incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accounting Ledgers Incident Triage

## Purpose
Design and execute accounting ledgers workflows using incident triage controls with validated outcomes.
