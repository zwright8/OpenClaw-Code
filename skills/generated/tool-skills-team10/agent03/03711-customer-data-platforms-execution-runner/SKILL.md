---
name: customer-data-platforms-execution-runner
description: Use when tasks require customer data platforms execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Customer Data Platforms Execution Runner

## Purpose
Design and execute customer data platforms workflows using execution runner controls with validated outcomes.
