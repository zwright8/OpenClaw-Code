---
name: treasury-management-evidence-collector
description: Use when tasks require treasury management evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Evidence Collector

## Purpose
Design and execute treasury management workflows using evidence collector controls with validated outcomes.
