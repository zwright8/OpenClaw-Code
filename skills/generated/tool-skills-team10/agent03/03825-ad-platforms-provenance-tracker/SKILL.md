---
name: ad-platforms-provenance-tracker
description: Use when tasks require ad platforms provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Provenance Tracker

## Purpose
Design and execute ad platforms workflows using provenance tracker controls with validated outcomes.
