---
name: construction-pm-capacity-planner
description: Use when tasks require construction pm capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Capacity Planner

## Purpose
Design and execute construction pm workflows using capacity planner controls with validated outcomes.
