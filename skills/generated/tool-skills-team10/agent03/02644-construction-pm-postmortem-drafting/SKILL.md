---
name: construction-pm-postmortem-drafting
description: Use when tasks require construction pm postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Postmortem Drafting

## Purpose
Design and execute construction pm workflows using postmortem drafting controls with validated outcomes.
