---
name: maritime-routing-risk-scorer
description: Use when tasks require maritime routing risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Risk Scorer

## Purpose
Design and execute maritime routing workflows using risk scorer controls with validated outcomes.
