---
name: fraud-operations-runbook-composer
description: Use when tasks require fraud operations runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Runbook Composer

## Purpose
Design and execute fraud operations workflows using runbook composer controls with validated outcomes.
