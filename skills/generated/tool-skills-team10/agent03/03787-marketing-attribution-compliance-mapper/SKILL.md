---
name: marketing-attribution-compliance-mapper
description: Use when tasks require marketing attribution compliance mapper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Compliance Mapper

## Purpose
Design and execute marketing attribution workflows using compliance mapper controls with validated outcomes.
