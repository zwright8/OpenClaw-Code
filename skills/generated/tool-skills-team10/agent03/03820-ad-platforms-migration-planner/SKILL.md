---
name: ad-platforms-migration-planner
description: Use when tasks require ad platforms migration planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Migration Planner

## Purpose
Design and execute ad platforms workflows using migration planner controls with validated outcomes.
