---
name: facility-maintenance-execution-runner
description: Use when tasks require facility maintenance execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Execution Runner

## Purpose
Design and execute facility maintenance workflows using execution runner controls with validated outcomes.
