---
name: facility-maintenance-dependency-resolver
description: Use when tasks require facility maintenance dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Dependency Resolver

## Purpose
Design and execute facility maintenance workflows using dependency resolver controls with validated outcomes.
