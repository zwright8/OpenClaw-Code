---
name: crm-intelligence-cost-attribution
description: Use when tasks require crm intelligence cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Cost Attribution

## Purpose
Design and execute crm intelligence workflows using cost attribution controls with validated outcomes.
