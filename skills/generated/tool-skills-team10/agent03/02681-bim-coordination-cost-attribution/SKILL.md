---
name: bim-coordination-cost-attribution
description: Use when tasks require bim coordination cost attribution with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Cost Attribution

## Purpose
Design and execute bim coordination workflows using cost attribution controls with validated outcomes.
