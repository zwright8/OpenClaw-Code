---
name: aml-monitoring-secret-scanner
description: Use when tasks require aml monitoring secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Secret Scanner

## Purpose
Design and execute aml monitoring workflows using secret scanner controls with validated outcomes.
