---
name: travel-compliance-human-handoff-router
description: Use when tasks require travel compliance human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Travel Compliance Human Handoff Router

## Purpose
Design and execute travel compliance workflows using human handoff router controls with validated outcomes.
