---
name: aml-monitoring-operation-planner
description: Use when tasks require aml monitoring operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Operation Planner

## Purpose
Design and execute aml monitoring workflows using operation planner controls with validated outcomes.
