---
name: marketing-attribution-rate-limit-optimizer
description: Use when tasks require marketing attribution rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Rate Limit Optimizer

## Purpose
Design and execute marketing attribution workflows using rate limit optimizer controls with validated outcomes.
