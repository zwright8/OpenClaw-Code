---
name: hospitality-pms-sla-enforcer
description: Use when tasks require hospitality pms sla enforcer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS SLA Enforcer

## Purpose
Design and execute hospitality pms workflows using sla enforcer controls with validated outcomes.
