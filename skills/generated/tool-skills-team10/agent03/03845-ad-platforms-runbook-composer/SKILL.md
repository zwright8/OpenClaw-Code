---
name: ad-platforms-runbook-composer
description: Use when tasks require ad platforms runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Runbook Composer

## Purpose
Design and execute ad platforms workflows using runbook composer controls with validated outcomes.
