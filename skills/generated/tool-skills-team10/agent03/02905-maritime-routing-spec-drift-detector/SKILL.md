---
name: maritime-routing-spec-drift-detector
description: Use when tasks require maritime routing spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Spec Drift Detector

## Purpose
Design and execute maritime routing workflows using spec drift detector controls with validated outcomes.
