---
name: seo-tooling-auth-broker
description: Use when tasks require seo tooling auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SEO Tooling Auth Broker

## Purpose
Design and execute seo tooling workflows using auth broker controls with validated outcomes.
