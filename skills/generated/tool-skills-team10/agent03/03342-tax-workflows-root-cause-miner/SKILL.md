---
name: tax-workflows-root-cause-miner
description: Use when tasks require tax workflows root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Tax Workflows Root Cause Miner

## Purpose
Design and execute tax workflows workflows using root cause miner controls with validated outcomes.
