---
name: risk-engines-risk-scorer
description: Use when tasks require risk engines risk scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Risk Engines Risk Scorer

## Purpose
Design and execute risk engines workflows using risk scorer controls with validated outcomes.
