---
name: maritime-routing-conflict-resolver
description: Use when tasks require maritime routing conflict resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Conflict Resolver

## Purpose
Design and execute maritime routing workflows using conflict resolver controls with validated outcomes.
