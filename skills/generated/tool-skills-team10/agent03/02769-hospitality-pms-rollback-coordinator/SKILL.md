---
name: hospitality-pms-rollback-coordinator
description: Use when tasks require hospitality pms rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Rollback Coordinator

## Purpose
Design and execute hospitality pms workflows using rollback coordinator controls with validated outcomes.
