---
name: rail-scheduling-operation-planner
description: Use when tasks require rail scheduling operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Operation Planner

## Purpose
Design and execute rail scheduling workflows using operation planner controls with validated outcomes.
