---
name: hospitality-pms-latency-analyzer
description: Use when tasks require hospitality pms latency analyzer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Latency Analyzer

## Purpose
Design and execute hospitality pms workflows using latency analyzer controls with validated outcomes.
