---
name: hospitality-pms-incident-triage
description: Use when tasks require hospitality pms incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Incident Triage

## Purpose
Design and execute hospitality pms workflows using incident triage controls with validated outcomes.
