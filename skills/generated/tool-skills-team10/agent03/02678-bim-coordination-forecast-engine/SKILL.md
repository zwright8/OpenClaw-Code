---
name: bim-coordination-forecast-engine
description: Use when tasks require bim coordination forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Forecast Engine

## Purpose
Design and execute bim coordination workflows using forecast engine controls with validated outcomes.
