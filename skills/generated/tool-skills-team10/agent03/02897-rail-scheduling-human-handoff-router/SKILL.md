---
name: rail-scheduling-human-handoff-router
description: Use when tasks require rail scheduling human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Human Handoff Router

## Purpose
Design and execute rail scheduling workflows using human handoff router controls with validated outcomes.
