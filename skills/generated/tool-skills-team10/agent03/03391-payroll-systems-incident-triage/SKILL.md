---
name: payroll-systems-incident-triage
description: Use when tasks require payroll systems incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Incident Triage

## Purpose
Design and execute payroll systems workflows using incident triage controls with validated outcomes.
