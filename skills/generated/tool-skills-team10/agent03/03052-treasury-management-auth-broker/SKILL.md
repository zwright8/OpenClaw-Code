---
name: treasury-management-auth-broker
description: Use when tasks require treasury management auth broker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Auth Broker

## Purpose
Design and execute treasury management workflows using auth broker controls with validated outcomes.
