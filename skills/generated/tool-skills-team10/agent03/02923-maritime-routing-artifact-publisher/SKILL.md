---
name: maritime-routing-artifact-publisher
description: Use when tasks require maritime routing artifact publisher with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Artifact Publisher

## Purpose
Design and execute maritime routing workflows using artifact publisher controls with validated outcomes.
