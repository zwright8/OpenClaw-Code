---
name: procure-to-pay-quality-gatekeeper
description: Use when tasks require procure to pay quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Quality Gatekeeper

## Purpose
Design and execute procure to pay workflows using quality gatekeeper controls with validated outcomes.
