---
name: fraud-operations-remediation-planner
description: Use when tasks require fraud operations remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Remediation Planner

## Purpose
Design and execute fraud operations workflows using remediation planner controls with validated outcomes.
