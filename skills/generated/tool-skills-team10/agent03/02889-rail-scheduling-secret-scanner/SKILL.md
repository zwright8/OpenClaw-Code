---
name: rail-scheduling-secret-scanner
description: Use when tasks require rail scheduling secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Secret Scanner

## Purpose
Design and execute rail scheduling workflows using secret scanner controls with validated outcomes.
