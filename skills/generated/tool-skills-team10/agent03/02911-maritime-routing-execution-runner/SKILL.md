---
name: maritime-routing-execution-runner
description: Use when tasks require maritime routing execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Execution Runner

## Purpose
Design and execute maritime routing workflows using execution runner controls with validated outcomes.
