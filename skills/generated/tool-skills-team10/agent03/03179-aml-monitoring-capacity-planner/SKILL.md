---
name: aml-monitoring-capacity-planner
description: Use when tasks require aml monitoring capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Capacity Planner

## Purpose
Design and execute aml monitoring workflows using capacity planner controls with validated outcomes.
