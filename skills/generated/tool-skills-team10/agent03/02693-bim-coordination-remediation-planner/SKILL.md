---
name: bim-coordination-remediation-planner
description: Use when tasks require bim coordination remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Remediation Planner

## Purpose
Design and execute bim coordination workflows using remediation planner controls with validated outcomes.
