---
name: accounting-ledgers-dependency-resolver
description: Use when tasks require accounting ledgers dependency resolver with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accounting Ledgers Dependency Resolver

## Purpose
Design and execute accounting ledgers workflows using dependency resolver controls with validated outcomes.
