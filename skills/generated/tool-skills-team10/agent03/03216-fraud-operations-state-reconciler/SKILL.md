---
name: fraud-operations-state-reconciler
description: Use when tasks require fraud operations state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations State Reconciler

## Purpose
Design and execute fraud operations workflows using state reconciler controls with validated outcomes.
