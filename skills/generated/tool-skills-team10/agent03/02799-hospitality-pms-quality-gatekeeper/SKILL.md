---
name: hospitality-pms-quality-gatekeeper
description: Use when tasks require hospitality pms quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Quality Gatekeeper

## Purpose
Design and execute hospitality pms workflows using quality gatekeeper controls with validated outcomes.
