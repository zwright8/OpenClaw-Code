---
name: revops-systems-human-handoff-router
description: Use when tasks require revops systems human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RevOps Systems Human Handoff Router

## Purpose
Design and execute revops systems workflows using human handoff router controls with validated outcomes.
