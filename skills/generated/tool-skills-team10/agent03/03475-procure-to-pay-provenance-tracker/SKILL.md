---
name: procure-to-pay-provenance-tracker
description: Use when tasks require procure to pay provenance tracker with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Provenance Tracker

## Purpose
Design and execute procure to pay workflows using provenance tracker controls with validated outcomes.
