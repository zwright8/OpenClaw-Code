---
name: hospitality-pms-task-decomposer
description: Use when tasks require hospitality pms task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Task Decomposer

## Purpose
Design and execute hospitality pms workflows using task decomposer controls with validated outcomes.
