---
name: bank-core-systems-snapshot-manager
description: Use when tasks require bank core systems snapshot manager with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Snapshot Manager

## Purpose
Design and execute bank core systems workflows using snapshot manager controls with validated outcomes.
