---
name: facility-maintenance-workflow-compiler
description: Use when tasks require facility maintenance workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Workflow Compiler

## Purpose
Design and execute facility maintenance workflows using workflow compiler controls with validated outcomes.
