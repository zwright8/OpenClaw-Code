---
name: revops-systems-quality-gatekeeper
description: Use when tasks require revops systems quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RevOps Systems Quality Gatekeeper

## Purpose
Design and execute revops systems workflows using quality gatekeeper controls with validated outcomes.
