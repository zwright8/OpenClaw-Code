---
name: airline-operations-rollback-coordinator
description: Use when tasks require airline operations rollback coordinator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Rollback Coordinator

## Purpose
Design and execute airline operations workflows using rollback coordinator controls with validated outcomes.
