---
name: bim-coordination-retry-governor
description: Use when tasks require bim coordination retry governor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Retry Governor

## Purpose
Design and execute bim coordination workflows using retry governor controls with validated outcomes.
