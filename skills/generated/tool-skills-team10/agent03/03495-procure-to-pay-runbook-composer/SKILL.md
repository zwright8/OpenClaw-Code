---
name: procure-to-pay-runbook-composer
description: Use when tasks require procure to pay runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Runbook Composer

## Purpose
Design and execute procure to pay workflows using runbook composer controls with validated outcomes.
