---
name: ad-platforms-access-auditor
description: Use when tasks require ad platforms access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Access Auditor

## Purpose
Design and execute ad platforms workflows using access auditor controls with validated outcomes.
