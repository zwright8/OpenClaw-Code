---
name: facility-maintenance-remediation-planner
description: Use when tasks require facility maintenance remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Facility Maintenance Remediation Planner

## Purpose
Design and execute facility maintenance workflows using remediation planner controls with validated outcomes.
