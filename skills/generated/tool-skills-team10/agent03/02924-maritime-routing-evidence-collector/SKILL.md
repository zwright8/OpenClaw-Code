---
name: maritime-routing-evidence-collector
description: Use when tasks require maritime routing evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Evidence Collector

## Purpose
Design and execute maritime routing workflows using evidence collector controls with validated outcomes.
