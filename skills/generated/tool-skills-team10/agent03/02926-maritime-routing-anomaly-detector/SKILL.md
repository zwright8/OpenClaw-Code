---
name: maritime-routing-anomaly-detector
description: Use when tasks require maritime routing anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Anomaly Detector

## Purpose
Design and execute maritime routing workflows using anomaly detector controls with validated outcomes.
