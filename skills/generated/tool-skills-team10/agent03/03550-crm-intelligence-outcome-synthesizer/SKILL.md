---
name: crm-intelligence-outcome-synthesizer
description: Use when tasks require crm intelligence outcome synthesizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence Outcome Synthesizer

## Purpose
Design and execute crm intelligence workflows using outcome synthesizer controls with validated outcomes.
