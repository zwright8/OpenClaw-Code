---
name: bank-core-systems-capacity-planner
description: Use when tasks require bank core systems capacity planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Bank Core Systems Capacity Planner

## Purpose
Design and execute bank core systems workflows using capacity planner controls with validated outcomes.
