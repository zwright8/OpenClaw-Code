---
name: procure-to-pay-incident-triage
description: Use when tasks require procure to pay incident triage with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Incident Triage

## Purpose
Design and execute procure to pay workflows using incident triage controls with validated outcomes.
