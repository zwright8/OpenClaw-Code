---
name: bim-coordination-rate-limit-optimizer
description: Use when tasks require bim coordination rate limit optimizer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Rate Limit Optimizer

## Purpose
Design and execute bim coordination workflows using rate limit optimizer controls with validated outcomes.
