---
name: procure-to-pay-task-decomposer
description: Use when tasks require procure to pay task decomposer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Task Decomposer

## Purpose
Design and execute procure to pay workflows using task decomposer controls with validated outcomes.
