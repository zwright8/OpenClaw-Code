---
name: ad-platforms-operation-planner
description: Use when tasks require ad platforms operation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Ad Platforms Operation Planner

## Purpose
Design and execute ad platforms workflows using operation planner controls with validated outcomes.
