---
name: bim-coordination-evidence-collector
description: Use when tasks require bim coordination evidence collector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Evidence Collector

## Purpose
Design and execute bim coordination workflows using evidence collector controls with validated outcomes.
