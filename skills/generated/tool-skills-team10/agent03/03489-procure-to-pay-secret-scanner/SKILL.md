---
name: procure-to-pay-secret-scanner
description: Use when tasks require procure to pay secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Procure to Pay Secret Scanner

## Purpose
Design and execute procure to pay workflows using secret scanner controls with validated outcomes.
