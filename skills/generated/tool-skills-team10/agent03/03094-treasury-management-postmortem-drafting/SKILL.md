---
name: treasury-management-postmortem-drafting
description: Use when tasks require treasury management postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Postmortem Drafting

## Purpose
Design and execute treasury management workflows using postmortem drafting controls with validated outcomes.
