---
name: marketing-attribution-execution-runner
description: Use when tasks require marketing attribution execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution Execution Runner

## Purpose
Design and execute marketing attribution workflows using execution runner controls with validated outcomes.
