---
name: treasury-management-runbook-composer
description: Use when tasks require treasury management runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Treasury Management Runbook Composer

## Purpose
Design and execute treasury management workflows using runbook composer controls with validated outcomes.
