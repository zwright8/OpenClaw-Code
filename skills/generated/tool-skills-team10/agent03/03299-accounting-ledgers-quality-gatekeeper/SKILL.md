---
name: accounting-ledgers-quality-gatekeeper
description: Use when tasks require accounting ledgers quality gatekeeper with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Accounting Ledgers Quality Gatekeeper

## Purpose
Design and execute accounting ledgers workflows using quality gatekeeper controls with validated outcomes.
