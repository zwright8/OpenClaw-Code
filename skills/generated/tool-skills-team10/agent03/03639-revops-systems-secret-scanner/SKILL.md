---
name: revops-systems-secret-scanner
description: Use when tasks require revops systems secret scanner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# RevOps Systems Secret Scanner

## Purpose
Design and execute revops systems workflows using secret scanner controls with validated outcomes.
