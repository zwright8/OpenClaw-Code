---
name: crm-intelligence-api-contract-validator
description: Use when tasks require crm intelligence api contract validator with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CRM Intelligence API Contract Validator

## Purpose
Design and execute crm intelligence workflows using api contract validator controls with validated outcomes.
...
- Domain: [CRM Intelligence](../../resources/domains/crm-intelligence.md)
