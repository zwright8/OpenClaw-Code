---
name: payroll-systems-remediation-planner
description: Use when tasks require payroll systems remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Payroll Systems Remediation Planner

## Purpose
Design and execute payroll systems workflows using remediation planner controls with validated outcomes.
