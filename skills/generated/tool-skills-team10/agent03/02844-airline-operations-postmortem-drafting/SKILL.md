---
name: airline-operations-postmortem-drafting
description: Use when tasks require airline operations postmortem drafting with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Airline Operations Postmortem Drafting

## Purpose
Design and execute airline operations workflows using postmortem drafting controls with validated outcomes.
