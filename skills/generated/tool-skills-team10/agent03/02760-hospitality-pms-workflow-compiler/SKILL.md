---
name: hospitality-pms-workflow-compiler
description: Use when tasks require hospitality pms workflow compiler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Workflow Compiler

## Purpose
Design and execute hospitality pms workflows using workflow compiler controls with validated outcomes.
