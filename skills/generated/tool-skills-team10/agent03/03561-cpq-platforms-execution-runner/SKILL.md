---
name: cpq-platforms-execution-runner
description: Use when tasks require cpq platforms execution runner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# CPQ Platforms Execution Runner

## Purpose
Design and execute cpq platforms workflows using execution runner controls with validated outcomes.
