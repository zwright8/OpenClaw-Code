---
name: hospitality-pms-root-cause-miner
description: Use when tasks require hospitality pms root cause miner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Root Cause Miner

## Purpose
Design and execute hospitality pms workflows using root cause miner controls with validated outcomes.
