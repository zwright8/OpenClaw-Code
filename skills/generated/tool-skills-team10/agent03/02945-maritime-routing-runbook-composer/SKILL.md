---
name: maritime-routing-runbook-composer
description: Use when tasks require maritime routing runbook composer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Maritime Routing Runbook Composer

## Purpose
Design and execute maritime routing workflows using runbook composer controls with validated outcomes.
