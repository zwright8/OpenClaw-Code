---
name: hospitality-pms-forecast-engine
description: Use when tasks require hospitality pms forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Hospitality PMS Forecast Engine

## Purpose
Design and execute hospitality pms workflows using forecast engine controls with validated outcomes.
