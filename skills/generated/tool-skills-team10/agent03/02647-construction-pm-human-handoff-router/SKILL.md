---
name: construction-pm-human-handoff-router
description: Use when tasks require construction pm human handoff router with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Human Handoff Router

## Purpose
Design and execute construction pm workflows using human handoff router controls with validated outcomes.
