---
name: construction-pm-budget-guardrail
description: Use when tasks require construction pm budget guardrail with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Construction PM Budget Guardrail

## Purpose
Design and execute construction pm workflows using budget guardrail controls with validated outcomes.
