---
name: marketing-attribution-state-reconciler
description: Use when tasks require marketing attribution state reconciler with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Marketing Attribution State Reconciler

## Purpose
Design and execute marketing attribution workflows using state reconciler controls with validated outcomes.
