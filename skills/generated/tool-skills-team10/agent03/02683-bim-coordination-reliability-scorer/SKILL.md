---
name: bim-coordination-reliability-scorer
description: Use when tasks require bim coordination reliability scorer with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Reliability Scorer

## Purpose
Design and execute bim coordination workflows using reliability scorer controls with validated outcomes.
