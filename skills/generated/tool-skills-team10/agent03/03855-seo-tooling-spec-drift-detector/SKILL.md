---
name: seo-tooling-spec-drift-detector
description: Use when tasks require seo tooling spec drift detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# SEO Tooling Spec Drift Detector

## Purpose
Design and execute seo tooling workflows using spec drift detector controls with validated outcomes.
