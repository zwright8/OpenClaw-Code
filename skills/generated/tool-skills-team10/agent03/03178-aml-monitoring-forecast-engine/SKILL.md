---
name: aml-monitoring-forecast-engine
description: Use when tasks require aml monitoring forecast engine with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# AML Monitoring Forecast Engine

## Purpose
Design and execute aml monitoring workflows using forecast engine controls with validated outcomes.
