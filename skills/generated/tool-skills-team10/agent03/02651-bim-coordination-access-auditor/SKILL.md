---
name: bim-coordination-access-auditor
description: Use when tasks require bim coordination access auditor with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# BIM Coordination Access Auditor

## Purpose
Design and execute bim coordination workflows using access auditor controls with validated outcomes.
