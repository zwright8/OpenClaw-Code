---
name: rail-scheduling-remediation-planner
description: Use when tasks require rail scheduling remediation planner with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Rail Scheduling Remediation Planner

## Purpose
Design and execute rail scheduling workflows using remediation planner controls with validated outcomes.
