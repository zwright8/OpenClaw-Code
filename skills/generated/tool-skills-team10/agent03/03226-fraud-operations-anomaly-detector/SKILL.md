---
name: fraud-operations-anomaly-detector
description: Use when tasks require fraud operations anomaly detector with production-grade validation, rollback safety, and OpenClaw extension controls.
---

# Fraud Operations Anomaly Detector

## Purpose
Design and execute fraud operations workflows using anomaly detector controls with validated outcomes.
