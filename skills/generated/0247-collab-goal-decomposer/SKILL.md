...
description: Build and operate the "Collab Goal Decomposer" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Goal Decomposer" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Goal Decomposer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0247_collab-goal-decomposer, approval gates, and rollback owner before autonomous use.
