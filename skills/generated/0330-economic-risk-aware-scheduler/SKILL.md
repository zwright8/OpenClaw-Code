...
description: Build and operate the "Economic Risk-Aware Scheduler" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Risk-Aware Scheduler" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Risk-Aware Scheduler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0330_economic-risk-aware-scheduler, approval gates, and rollback owner before autonomous use.
