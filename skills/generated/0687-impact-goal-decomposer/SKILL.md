...
description: Build and operate the "Impact Goal Decomposer" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Goal Decomposer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0687_impact-goal-decomposer, approval gates, and rollback owner before autonomous use.
