...
description: Build and operate the "Evolution Memory Consolidation Pipeline" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Evolution Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0978_evolution-memory-consolidation-p, approval gates, and rollback owner before autonomous use.
