...
description: Build and operate the "Governance Compliance Evidence Mapper" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Compliance Evidence Mapper" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Compliance Evidence Mapper request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0192_governance-compliance-evidence-m, approval gates, and rollback owner before autonomous use.
