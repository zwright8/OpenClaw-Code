...
## Operational Runbook
### Preflight
- Confirm the Crisis Multi-Agent Negotiation Mediator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0662_crisis-multi-agent-negotiation-m, approval gates, and rollback owner before autonomous use.
