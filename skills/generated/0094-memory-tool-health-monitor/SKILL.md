...
description: Build and operate the "Memory Tool Health Monitor" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Tool Health Monitor" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0094_memory-tool-health-monitor, approval gates, and rollback owner before autonomous use.
