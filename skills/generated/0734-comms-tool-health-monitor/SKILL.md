...
description: Build and operate the "Comms Tool Health Monitor" capability for Communication and Explainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Comms Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0734_comms-tool-health-monitor, approval gates, and rollback owner before autonomous use.
