...
description: Build and operate the "Impact Conflict Resolution Coach" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Impact Conflict Resolution Coach" outcomes in the Social Impact Measurement domain.
...
- Orchestration integration: social-impact-measurement:collaboration-mediator routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Impact Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0703_impact-conflict-resolution-coach, approval gates, and rollback owner before autonomous use.
