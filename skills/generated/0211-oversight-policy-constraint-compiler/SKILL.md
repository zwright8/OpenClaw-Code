...
- Orchestration integration: human-oversight-and-operator-ux:contract-compiler routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Oversight Policy Constraint Compiler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0211_oversight-policy-constraint-comp, approval gates, and rollback owner before autonomous use.
