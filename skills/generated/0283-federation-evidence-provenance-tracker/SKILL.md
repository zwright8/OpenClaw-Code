...
description: Build and operate the "Federation Evidence Provenance Tracker" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Evidence Provenance Tracker" outcomes in the Federation and Interoperability domain.
...
- Orchestration integration: federation-and-interoperability:provenance-tracker routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Federation Evidence Provenance Tracker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0283_federation-evidence-provenance-t, approval gates, and rollback owner before autonomous use.
