...
description: Build and operate the "Governance Policy Constraint Compiler" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Policy Constraint Compiler" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Policy Constraint Compiler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0171_governance-policy-constraint-com, approval gates, and rollback owner before autonomous use.
