...
description: Build and operate the "Governance A/B Rollout Governor" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance A/B Rollout Governor" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance A/B Rollout Governor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0187_governance-a-b-rollout-governor, approval gates, and rollback owner before autonomous use.
