...
description: Build and operate the "Evolution Resource Budget Allocator" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Evolution Resource Budget Allocator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0969_evolution-resource-budget-alloca, approval gates, and rollback owner before autonomous use.
