...
description: Build and operate the "Observability Human Approval Router" capability for Data Quality and Observability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Observability Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0572_observability-human-approval-rou, approval gates, and rollback owner before autonomous use.
