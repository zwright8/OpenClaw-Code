...
description: Build and operate the "Tooling Memory Consolidation Pipeline" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Memory Consolidation Pipeline" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0138_tooling-memory-consolidation-pip, approval gates, and rollback owner before autonomous use.
