...
description: Build and operate the "Governance Disaster Recovery Orchestrator" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Disaster Recovery Orchestrator" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0189_governance-disaster-recovery-orc, approval gates, and rollback owner before autonomous use.
