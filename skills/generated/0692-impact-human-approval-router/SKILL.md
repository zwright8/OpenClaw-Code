...
description: Build and operate the "Impact Human Approval Router" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0692_impact-human-approval-router, approval gates, and rollback owner before autonomous use.
