...
description: Build and operate the "Inclusion Explainability Narrative Builder" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Explainability Narrative Builder request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0824_inclusion-explainability-narrati, approval gates, and rollback owner before autonomous use.
