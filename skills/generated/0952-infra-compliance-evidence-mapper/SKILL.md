...
description: Build and operate the "Infra Compliance Evidence Mapper" capability for Infrastructure and Sustainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Infra Compliance Evidence Mapper request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0952_infra-compliance-evidence-mapper, approval gates, and rollback owner before autonomous use.
