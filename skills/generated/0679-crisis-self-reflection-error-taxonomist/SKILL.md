...
description: Build and operate the "Crisis Self-Reflection Error Taxonomist" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Crisis Self-Reflection Error Taxonomist request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0679_crisis-self-reflection-error-tax, approval gates, and rollback owner before autonomous use.
