...
description: Build and operate the "Economic Disaster Recovery Orchestrator" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Disaster Recovery Orchestrator" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0349_economic-disaster-recovery-orche, approval gates, and rollback owner before autonomous use.
