...
description: Build and operate the "Oversight Confidence Calibration Engine" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Confidence Calibration Engine" outcomes in the Human Oversight and Operator UX domain.
...
- Orchestration integration: human-oversight-and-operator-ux:optimization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Oversight Confidence Calibration Engine request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0205_oversight-confidence-calibration, approval gates, and rollback owner before autonomous use.
