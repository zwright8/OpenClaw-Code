...
description: Build and operate the "Epistemic Knowledge Graph Linker" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Knowledge Graph Linker" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0019_epistemic-knowledge-graph-linker, approval gates, and rollback owner before autonomous use.
