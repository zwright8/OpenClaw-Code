...
description: Build and operate the "Memory Evidence Provenance Tracker" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Evidence Provenance Tracker" outcomes in the Memory and Knowledge Operations domain.
...
- Orchestration integration: memory-and-knowledge-operations:provenance-tracker routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Memory Evidence Provenance Tracker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0083_memory-evidence-provenance-track, approval gates, and rollback owner before autonomous use.
