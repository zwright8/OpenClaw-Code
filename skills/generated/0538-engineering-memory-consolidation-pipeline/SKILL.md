...
description: Build and operate the "Engineering Memory Consolidation Pipeline" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Engineering Memory Consolidation Pipeline" outcomes in the Software Engineering Automation domain.
...
## Operational Runbook
### Preflight
- Confirm the Engineering Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0538_engineering-memory-consolidation, approval gates, and rollback owner before autonomous use.
