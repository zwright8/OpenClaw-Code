...
description: Build and operate the "Epistemic Human Approval Router" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Human Approval Router" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0012_epistemic-human-approval-router, approval gates, and rollback owner before autonomous use.
