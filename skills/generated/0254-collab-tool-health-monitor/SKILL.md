...
description: Build and operate the "Collab Tool Health Monitor" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Tool Health Monitor" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0254_collab-tool-health-monitor, approval gates, and rollback owner before autonomous use.
