...
description: Build and operate the "Tooling Failure Root-Cause Miner" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Failure Root-Cause Miner" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0136_tooling-failure-root-cause-miner, approval gates, and rollback owner before autonomous use.
