...
description: Build and operate the "Crisis Goal Decomposer" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Crisis Goal Decomposer" outcomes in the Crisis and Incident Response domain.
...
## Operational Runbook
### Preflight
- Confirm the Crisis Goal Decomposer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0647_crisis-goal-decomposer, approval gates, and rollback owner before autonomous use.
