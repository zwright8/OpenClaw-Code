...
description: Build and operate the "Epistemic Resource Budget Allocator" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Resource Budget Allocator" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Resource Budget Allocator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0009_epistemic-resource-budget-alloca, approval gates, and rollback owner before autonomous use.
