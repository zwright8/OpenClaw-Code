...
description: Build and operate the "Planning Security Threat Modeler" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Security Threat Modeler" outcomes in the Strategic Planning and Decomposition domain.
...
## Operational Runbook
### Preflight
- Confirm the Planning Security Threat Modeler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0071_planning-security-threat-modeler, approval gates, and rollback owner before autonomous use.
