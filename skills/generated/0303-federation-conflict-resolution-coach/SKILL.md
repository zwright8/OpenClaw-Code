...
description: Build and operate the "Federation Conflict Resolution Coach" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Conflict Resolution Coach" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0303_federation-conflict-resolution-c, approval gates, and rollback owner before autonomous use.
