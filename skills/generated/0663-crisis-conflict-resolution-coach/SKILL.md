...
description: Build and operate the "Crisis Conflict Resolution Coach" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Crisis Conflict Resolution Coach" outcomes in the Crisis and Incident Response domain.
...
- Orchestration integration: crisis-and-incident-response:collaboration-mediator routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Crisis Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0663_crisis-conflict-resolution-coach, approval gates, and rollback owner before autonomous use.
