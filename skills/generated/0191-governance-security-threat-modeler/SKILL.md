...
## Operational Runbook
### Preflight
- Confirm the Governance Security Threat Modeler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0191_governance-security-threat-model, approval gates, and rollback owner before autonomous use.
