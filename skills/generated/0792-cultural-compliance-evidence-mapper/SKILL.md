...
description: Build and operate the "Cultural Compliance Evidence Mapper" capability for Multilingual and Cultural Adaptation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Cultural Compliance Evidence Mapper" outcomes in the Multilingual and Cultural Adaptation domain.
...
## Operational Runbook
### Preflight
- Confirm the Cultural Compliance Evidence Mapper request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0792_cultural-compliance-evidence-map, approval gates, and rollback owner before autonomous use.
