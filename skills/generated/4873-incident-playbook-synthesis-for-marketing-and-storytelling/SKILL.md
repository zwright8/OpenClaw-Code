...
## When To Use
Use this skill when the request explicitly needs "Incident Playbook Synthesis for marketing and storytelling" outcomes in the marketing and storytelling domain.
...
- Runtime profile: incident-response-engine using incident playbook synthesis to produce incident-playbook-synthesis-artifact-marketing-and-storytelling.
- Orchestration integration: marketing-and-storytelling:incident-response-engine routing, approval gates, retries, and rollback controls.
