...
description: Build and operate the "Oversight Contradiction Detector" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Contradiction Detector" outcomes in the Human Oversight and Operator UX domain.
...
## Operational Runbook
### Preflight
- Confirm the Oversight Contradiction Detector request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0204_oversight-contradiction-detector, approval gates, and rollback owner before autonomous use.
