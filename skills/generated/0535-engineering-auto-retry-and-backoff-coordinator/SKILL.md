...
## Operational Runbook
### Preflight
- Confirm the Engineering Auto-Retry and Backoff Coordinator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0535_engineering-auto-retry-and-backo, approval gates, and rollback owner before autonomous use.
