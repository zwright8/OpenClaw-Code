...
## When To Use
Use this skill when the request explicitly needs "Experiment Design for fitness and recovery training" outcomes in the fitness and recovery training domain.
...
- Runtime profile: experimentation-engine using experiment design to produce experiment-design-artifact-fitness-and-recovery-training.
- Orchestration integration: fitness-and-recovery-training:experimentation-engine routing, approval gates, retries, and rollback controls.
