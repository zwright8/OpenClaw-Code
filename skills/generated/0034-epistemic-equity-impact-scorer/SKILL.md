...
description: Build and operate the "Epistemic Equity Impact Scorer" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Equity Impact Scorer" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Equity Impact Scorer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0034_epistemic-equity-impact-scorer, approval gates, and rollback owner before autonomous use.
