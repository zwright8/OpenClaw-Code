...
description: Build and operate the "Rights Continuous Improvement Planner" capability for Legal, Rights, and Compliance. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Rights Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0920_rights-continuous-improvement-pl, approval gates, and rollback owner before autonomous use.
