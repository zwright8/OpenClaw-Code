...
## Operational Runbook
### Preflight
- Confirm the Comms KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0756_comms-kpi-dashboard-publisher, approval gates, and rollback owner before autonomous use.
