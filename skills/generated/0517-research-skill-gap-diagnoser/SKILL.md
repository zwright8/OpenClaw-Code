...
description: Build and operate the "Research Skill Gap Diagnoser" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Research Skill Gap Diagnoser" outcomes in the Scientific Research Systems domain.
...
## Operational Runbook
### Preflight
- Confirm the Research Skill Gap Diagnoser request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0517_research-skill-gap-diagnoser, approval gates, and rollback owner before autonomous use.
