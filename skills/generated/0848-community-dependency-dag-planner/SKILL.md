...
description: Build and operate the "Community Dependency DAG Planner" capability for Community Engagement and Feedback. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Community Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0848_community-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
