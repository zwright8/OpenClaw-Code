...
description: Build and operate the "Impact Semantic Retrieval Ranker" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0700_impact-semantic-retrieval-ranker, approval gates, and rollback owner before autonomous use.
