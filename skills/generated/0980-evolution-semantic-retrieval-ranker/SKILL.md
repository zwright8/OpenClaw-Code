...
description: Build and operate the "Evolution Semantic Retrieval Ranker" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Evolution Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0980_evolution-semantic-retrieval-ran, approval gates, and rollback owner before autonomous use.
