...
description: Build and operate the "Planning Policy Constraint Compiler" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Policy Constraint Compiler" outcomes in the Strategic Planning and Decomposition domain.
...
- Orchestration integration: strategic-planning-and-decomposition:contract-compiler routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Planning Policy Constraint Compiler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0051_planning-policy-constraint-compi, approval gates, and rollback owner before autonomous use.
