...
description: Build and operate the "Engineering Evidence Provenance Tracker" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
- Orchestration integration: software-engineering-automation:provenance-tracker routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Engineering Evidence Provenance Tracker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0523_engineering-evidence-provenance-, approval gates, and rollback owner before autonomous use.
