...
description: Build and operate the "Economic Signal Ingestion Normalizer" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Signal Ingestion Normalizer" outcomes in the Economic Optimization domain.
...
- Orchestration integration: economic-optimization:normalization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Economic Signal Ingestion Normalizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0321_economic-signal-ingestion-normal, approval gates, and rollback owner before autonomous use.
