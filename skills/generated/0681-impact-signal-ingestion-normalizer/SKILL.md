...
description: Build and operate the "Impact Signal Ingestion Normalizer" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
- Orchestration integration: social-impact-measurement:normalization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Impact Signal Ingestion Normalizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0681_impact-signal-ingestion-normaliz, approval gates, and rollback owner before autonomous use.
