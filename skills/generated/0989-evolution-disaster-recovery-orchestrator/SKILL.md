...
description: Build and operate the "Evolution Disaster Recovery Orchestrator" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Evolution Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0989_evolution-disaster-recovery-orch, approval gates, and rollback owner before autonomous use.
