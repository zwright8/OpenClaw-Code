...
description: Build and operate the "Inclusion Incident Playbook Synthesizer" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Incident Playbook Synthesizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0828_inclusion-incident-playbook-synt, approval gates, and rollback owner before autonomous use.
