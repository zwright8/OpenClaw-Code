...
description: Build and operate the "Tooling Contradiction Detector" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling Contradiction Detector" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling Contradiction Detector request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0124_tooling-contradiction-detector, approval gates, and rollback owner before autonomous use.
