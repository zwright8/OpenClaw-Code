...
description: Build and operate the "Governance Human Approval Router" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Human Approval Router" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0172_governance-human-approval-router, approval gates, and rollback owner before autonomous use.
