...
description: Build and operate the "Collab Counterfactual Simulator" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Counterfactual Simulator" outcomes in the Collaboration and Negotiation domain.
...
- Orchestration integration: collaboration-and-negotiation:simulation-lab routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Collab Counterfactual Simulator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0246_collab-counterfactual-simulator, approval gates, and rollback owner before autonomous use.
