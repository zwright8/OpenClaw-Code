...
description: Build and operate the "Inclusion Disaster Recovery Orchestrator" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0829_inclusion-disaster-recovery-orch, approval gates, and rollback owner before autonomous use.
