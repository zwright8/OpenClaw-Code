...
description: Build and operate the "Planning A/B Rollout Governor" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning A/B Rollout Governor" outcomes in the Strategic Planning and Decomposition domain.
...
## Operational Runbook
### Preflight
- Confirm the Planning A/B Rollout Governor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0067_planning-a-b-rollout-governor, approval gates, and rollback owner before autonomous use.
