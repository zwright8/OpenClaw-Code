...
description: Build and operate the "Inclusion Cost-Benefit Forecaster" capability for Accessibility and Inclusion. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Inclusion Cost-Benefit Forecaster request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0833_inclusion-cost-benefit-forecaste, approval gates, and rollback owner before autonomous use.
