...
description: Build and operate the "Epistemic Self-Reflection Error Taxonomist" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Self-Reflection Error Taxonomist" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Self-Reflection Error Taxonomist request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0039_epistemic-self-reflection-error-, approval gates, and rollback owner before autonomous use.
