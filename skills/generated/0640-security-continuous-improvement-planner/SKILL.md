...
description: Build and operate the "Security Continuous Improvement Planner" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0640_security-continuous-improvement-, approval gates, and rollback owner before autonomous use.
