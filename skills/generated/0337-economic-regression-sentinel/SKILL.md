...
description: Build and operate the "Economic Regression Sentinel" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Regression Sentinel" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0337_economic-regression-sentinel, approval gates, and rollback owner before autonomous use.
