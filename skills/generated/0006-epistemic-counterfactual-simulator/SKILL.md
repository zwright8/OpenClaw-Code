...
description: Build and operate the "Epistemic Counterfactual Simulator" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Counterfactual Simulator" outcomes in the Truth-Seeking and Epistemics domain.
...
- Orchestration integration: truth-seeking-and-epistemics:simulation-lab routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Epistemic Counterfactual Simulator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0006_epistemic-counterfactual-simulat, approval gates, and rollback owner before autonomous use.
