...
description: Build and operate the "Governance Tool Health Monitor" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Tool Health Monitor" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0174_governance-tool-health-monitor, approval gates, and rollback owner before autonomous use.
