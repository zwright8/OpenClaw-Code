...
description: Build and operate the "Memory Memory Consolidation Pipeline" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Memory Consolidation Pipeline" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0098_memory-memory-consolidation-pipe, approval gates, and rollback owner before autonomous use.
