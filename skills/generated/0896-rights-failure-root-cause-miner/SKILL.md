...
## Operational Runbook
### Preflight
- Confirm the Rights Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0896_rights-failure-root-cause-miner, approval gates, and rollback owner before autonomous use.
