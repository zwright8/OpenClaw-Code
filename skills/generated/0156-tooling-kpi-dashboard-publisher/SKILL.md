...
description: Build and operate the "Tooling KPI Dashboard Publisher" capability for Tool Reliability and Execution Quality. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Tooling KPI Dashboard Publisher" outcomes in the Tool Reliability and Execution Quality domain.
...
## Operational Runbook
### Preflight
- Confirm the Tooling KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0156_tooling-kpi-dashboard-publisher, approval gates, and rollback owner before autonomous use.
