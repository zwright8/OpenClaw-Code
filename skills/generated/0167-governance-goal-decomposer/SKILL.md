...
description: Build and operate the "Governance Goal Decomposer" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Goal Decomposer" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Goal Decomposer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0167_governance-goal-decomposer, approval gates, and rollback owner before autonomous use.
