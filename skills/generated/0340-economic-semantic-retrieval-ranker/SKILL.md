...
## Operational Runbook
### Preflight
- Confirm the Economic Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0340_economic-semantic-retrieval-rank, approval gates, and rollback owner before autonomous use.
