...
description: Build and operate the "Collab Task Handoff Contractor" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Task Handoff Contractor" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Task Handoff Contractor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0253_collab-task-handoff-contractor, approval gates, and rollback owner before autonomous use.
