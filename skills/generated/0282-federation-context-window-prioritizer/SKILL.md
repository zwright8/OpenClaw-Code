...
description: Build and operate the "Federation Context Window Prioritizer" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Context Window Prioritizer" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation Context Window Prioritizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0282_federation-context-window-priori, approval gates, and rollback owner before autonomous use.
