...
description: Build and operate the "Economic A/B Rollout Governor" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic A/B Rollout Governor" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic A/B Rollout Governor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0347_economic-a-b-rollout-governor, approval gates, and rollback owner before autonomous use.
