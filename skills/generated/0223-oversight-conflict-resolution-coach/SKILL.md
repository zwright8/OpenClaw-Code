...
description: Build and operate the "Oversight Conflict Resolution Coach" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Conflict Resolution Coach" outcomes in the Human Oversight and Operator UX domain.
...
## Operational Runbook
### Preflight
- Confirm the Oversight Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0223_oversight-conflict-resolution-co, approval gates, and rollback owner before autonomous use.
