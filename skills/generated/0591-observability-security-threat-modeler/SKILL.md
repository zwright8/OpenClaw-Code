...
## Operational Runbook
### Preflight
- Confirm the Observability Security Threat Modeler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0591_observability-security-threat-mo, approval gates, and rollback owner before autonomous use.
