...
## Operational Runbook
### Preflight
- Confirm the Inclusion KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0836_inclusion-kpi-dashboard-publishe, approval gates, and rollback owner before autonomous use.
