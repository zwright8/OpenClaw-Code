...
description: Build and operate the "Memory Community Feedback Harvester" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Community Feedback Harvester" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Community Feedback Harvester request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0115_memory-community-feedback-harves, approval gates, and rollback owner before autonomous use.
