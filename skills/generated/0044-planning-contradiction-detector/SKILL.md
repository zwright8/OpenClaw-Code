...
description: Build and operate the "Planning Contradiction Detector" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Contradiction Detector" outcomes in the Strategic Planning and Decomposition domain.
...
- Orchestration integration: strategic-planning-and-decomposition:detection-guard routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Planning Contradiction Detector request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0044_planning-contradiction-detector, approval gates, and rollback owner before autonomous use.
