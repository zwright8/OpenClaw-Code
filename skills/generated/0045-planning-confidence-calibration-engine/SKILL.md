...
description: Build and operate the "Planning Confidence Calibration Engine" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Confidence Calibration Engine" outcomes in the Strategic Planning and Decomposition domain.
...
- Orchestration integration: strategic-planning-and-decomposition:optimization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Planning Confidence Calibration Engine request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0045_planning-confidence-calibration-, approval gates, and rollback owner before autonomous use.
