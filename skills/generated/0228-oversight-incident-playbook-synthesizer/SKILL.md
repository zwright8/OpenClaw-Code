...
description: Build and operate the "Oversight Incident Playbook Synthesizer" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Incident Playbook Synthesizer" outcomes in the Human Oversight and Operator UX domain.
...
## Operational Runbook
### Preflight
- Confirm the Oversight Incident Playbook Synthesizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0228_oversight-incident-playbook-synt, approval gates, and rollback owner before autonomous use.
