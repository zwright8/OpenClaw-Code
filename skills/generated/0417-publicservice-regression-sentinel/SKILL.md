...
## Operational Runbook
### Preflight
- Confirm the PublicService Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0417_publicservice-regression-sentine, approval gates, and rollback owner before autonomous use.
