...
description: Build and operate the "Impact Experiment Design Generator" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Experiment Design Generator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0706_impact-experiment-design-generat, approval gates, and rollback owner before autonomous use.
