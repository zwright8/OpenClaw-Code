...
description: Build and operate the "Impact Multi-Agent Negotiation Mediator" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Multi-Agent Negotiation Mediator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0702_impact-multi-agent-negotiation-m, approval gates, and rollback owner before autonomous use.
