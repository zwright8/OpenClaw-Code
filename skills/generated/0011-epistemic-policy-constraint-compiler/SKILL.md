...
## Operational Runbook
### Preflight
- Confirm the Epistemic Policy Constraint Compiler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0011_epistemic-policy-constraint-comp, approval gates, and rollback owner before autonomous use.
