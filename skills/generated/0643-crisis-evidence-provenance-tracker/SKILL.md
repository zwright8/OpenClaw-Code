...
- Orchestration integration: crisis-and-incident-response:provenance-tracker routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Crisis Evidence Provenance Tracker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0643_crisis-evidence-provenance-track, approval gates, and rollback owner before autonomous use.
