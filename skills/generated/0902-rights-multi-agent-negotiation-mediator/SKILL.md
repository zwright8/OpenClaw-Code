...
## Operational Runbook
### Preflight
- Confirm the Rights Multi-Agent Negotiation Mediator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0902_rights-multi-agent-negotiation-m, approval gates, and rollback owner before autonomous use.
