...
description: Build and operate the "Engineering Equity Impact Scorer" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Engineering Equity Impact Scorer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0554_engineering-equity-impact-scorer, approval gates, and rollback owner before autonomous use.
