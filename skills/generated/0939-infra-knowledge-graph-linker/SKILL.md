...
description: Build and operate the "Infra Knowledge Graph Linker" capability for Infrastructure and Sustainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Infra Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0939_infra-knowledge-graph-linker, approval gates, and rollback owner before autonomous use.
