...
description: Build and operate the "Security Self-Reflection Error Taxonomist" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security Self-Reflection Error Taxonomist request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0639_security-self-reflection-error-t, approval gates, and rollback owner before autonomous use.
