...
## Operational Runbook
### Preflight
- Confirm the Logistics KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0396_logistics-kpi-dashboard-publishe, approval gates, and rollback owner before autonomous use.
