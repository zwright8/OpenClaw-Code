...
description: Build and operate the "Infra Disaster Recovery Orchestrator" capability for Infrastructure and Sustainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Infra Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0949_infra-disaster-recovery-orchestr, approval gates, and rollback owner before autonomous use.
