...
## When To Use
Use this skill when the request explicitly needs "Engineering Failure Root-Cause Miner" outcomes in the Software Engineering Automation domain.
...
## Operational Runbook
### Preflight
- Confirm the Engineering Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0536_engineering-failure-root-cause-m, approval gates, and rollback owner before autonomous use.
