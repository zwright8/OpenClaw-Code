...
description: Build and operate the "Oversight Security Threat Modeler" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Security Threat Modeler" outcomes in the Human Oversight and Operator UX domain.
...
## Operational Runbook
### Preflight
- Confirm the Oversight Security Threat Modeler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0231_oversight-security-threat-modele, approval gates, and rollback owner before autonomous use.
