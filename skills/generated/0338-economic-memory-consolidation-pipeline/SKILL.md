...
description: Build and operate the "Economic Memory Consolidation Pipeline" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Memory Consolidation Pipeline" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0338_economic-memory-consolidation-pi, approval gates, and rollback owner before autonomous use.
