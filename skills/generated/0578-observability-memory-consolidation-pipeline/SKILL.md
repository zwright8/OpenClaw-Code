...
description: Build and operate the "Observability Memory Consolidation Pipeline" capability for Data Quality and Observability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Observability Memory Consolidation Pipeline request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0578_observability-memory-consolidati, approval gates, and rollback owner before autonomous use.
