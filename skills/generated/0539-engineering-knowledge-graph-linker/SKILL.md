...
description: Build and operate the "Engineering Knowledge Graph Linker" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Engineering Knowledge Graph Linker" outcomes in the Software Engineering Automation domain.
...
## Operational Runbook
### Preflight
- Confirm the Engineering Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0539_engineering-knowledge-graph-link, approval gates, and rollback owner before autonomous use.
