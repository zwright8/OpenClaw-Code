...
description: Build and operate the "Memory Dependency DAG Planner" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Dependency DAG Planner" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0088_memory-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
