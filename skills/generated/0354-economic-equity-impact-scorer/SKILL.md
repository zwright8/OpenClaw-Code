...
description: Build and operate the "Economic Equity Impact Scorer" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Equity Impact Scorer" outcomes in the Economic Optimization domain.
...
## Handoff Contract
- Produces: Economic Equity Impact Scorer normalized artifacts; execution scorecard; risk posture
- Consumes: budgets; costs; benefits; opportunity values; claims; evidence; confidence traces
- Downstream routing hint: Route next to economic-optimization:general-capability consumers with approval-gate context
