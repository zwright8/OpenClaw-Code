...
description: Build and operate the "Governance Explainability Narrative Builder" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Explainability Narrative Builder" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Explainability Narrative Builder request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0184_governance-explainability-narrat, approval gates, and rollback owner before autonomous use.
