...
description: Build and operate the "Governance Conflict Resolution Coach" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Conflict Resolution Coach" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0183_governance-conflict-resolution-c, approval gates, and rollback owner before autonomous use.
