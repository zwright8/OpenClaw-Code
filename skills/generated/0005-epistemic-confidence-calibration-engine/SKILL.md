...
description: Build and operate the "Epistemic Confidence Calibration Engine" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Confidence Calibration Engine" outcomes in the Truth-Seeking and Epistemics domain.
...
- Orchestration integration: truth-seeking-and-epistemics:optimization-engine routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Epistemic Confidence Calibration Engine request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0005_epistemic-confidence-calibration, approval gates, and rollback owner before autonomous use.
