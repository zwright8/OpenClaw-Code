...
description: Build and operate the "Rights KPI Dashboard Publisher" capability for Legal, Rights, and Compliance. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Rights KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0916_rights-kpi-dashboard-publisher, approval gates, and rollback owner before autonomous use.
