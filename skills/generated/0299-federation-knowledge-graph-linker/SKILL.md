...
description: Build and operate the "Federation Knowledge Graph Linker" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Knowledge Graph Linker" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0299_federation-knowledge-graph-linke, approval gates, and rollback owner before autonomous use.
