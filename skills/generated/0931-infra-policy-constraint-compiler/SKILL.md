...
- Orchestration integration: infrastructure-and-sustainability:contract-compiler routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Infra Policy Constraint Compiler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0931_infra-policy-constraint-compiler, approval gates, and rollback owner before autonomous use.
