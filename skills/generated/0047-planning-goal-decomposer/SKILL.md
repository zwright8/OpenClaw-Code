...
description: Build and operate the "Planning Goal Decomposer" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Goal Decomposer" outcomes in the Strategic Planning and Decomposition domain.
...
## Operational Runbook
### Preflight
- Confirm the Planning Goal Decomposer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0047_planning-goal-decomposer, approval gates, and rollback owner before autonomous use.
