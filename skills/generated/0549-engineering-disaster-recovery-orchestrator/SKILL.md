...
## When To Use
Use this skill when the request explicitly needs "Engineering Disaster Recovery Orchestrator" outcomes in the Software Engineering Automation domain.
...
## Operational Runbook
### Preflight
- Confirm the Engineering Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0549_engineering-disaster-recovery-or, approval gates, and rollback owner before autonomous use.
