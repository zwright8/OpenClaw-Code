...
description: Build and operate the "Collab A/B Rollout Governor" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab A/B Rollout Governor" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab A/B Rollout Governor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0267_collab-a-b-rollout-governor, approval gates, and rollback owner before autonomous use.
