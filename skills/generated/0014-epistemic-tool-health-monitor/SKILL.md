...
description: Build and operate the "Epistemic Tool Health Monitor" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Tool Health Monitor" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0014_epistemic-tool-health-monitor, approval gates, and rollback owner before autonomous use.
