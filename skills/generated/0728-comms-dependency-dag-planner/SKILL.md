...
description: Build and operate the "Comms Dependency DAG Planner" capability for Communication and Explainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Comms Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0728_comms-dependency-dag-planner, approval gates, and rollback owner before autonomous use.
