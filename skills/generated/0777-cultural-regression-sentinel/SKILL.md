...
description: Build and operate the "Cultural Regression Sentinel" capability for Multilingual and Cultural Adaptation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Cultural Regression Sentinel" outcomes in the Multilingual and Cultural Adaptation domain.
...
- Orchestration integration: multilingual-and-cultural-adaptation:detection-guard routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Cultural Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0777_cultural-regression-sentinel, approval gates, and rollback owner before autonomous use.
