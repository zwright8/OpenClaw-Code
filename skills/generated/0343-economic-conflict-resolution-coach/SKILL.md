...
description: Build and operate the "Economic Conflict Resolution Coach" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Conflict Resolution Coach" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0343_economic-conflict-resolution-coa, approval gates, and rollback owner before autonomous use.
