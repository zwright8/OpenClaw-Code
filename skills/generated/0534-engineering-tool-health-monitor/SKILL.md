...
description: Build and operate the "Engineering Tool Health Monitor" capability for Software Engineering Automation. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Engineering Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0534_engineering-tool-health-monitor, approval gates, and rollback owner before autonomous use.
