...
description: Build and operate the "Governance Community Feedback Harvester" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Community Feedback Harvester" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Community Feedback Harvester request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0195_governance-community-feedback-ha, approval gates, and rollback owner before autonomous use.
