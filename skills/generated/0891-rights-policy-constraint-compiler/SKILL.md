...
## Operational Runbook
### Preflight
- Confirm the Rights Policy Constraint Compiler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0891_rights-policy-constraint-compile, approval gates, and rollback owner before autonomous use.
