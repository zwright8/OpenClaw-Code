...
description: Build and operate the "Research Training Curriculum Composer" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Research Training Curriculum Composer" outcomes in the Scientific Research Systems domain.
...
## Operational Runbook
### Preflight
- Confirm the Research Training Curriculum Composer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0518_research-training-curriculum-com, approval gates, and rollback owner before autonomous use.
