...
## When To Use
Use this skill when the request explicitly needs "Incident Playbook Synthesis for family caregiving systems" outcomes in the family caregiving systems domain.
...
- Runtime profile: incident-response-engine using incident playbook synthesis to produce incident-playbook-synthesis-artifact-family-caregiving-systems.
- Orchestration integration: family-caregiving-systems:incident-response-engine routing, approval gates, retries, and rollback controls.
