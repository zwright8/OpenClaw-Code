...
description: Build and operate the "Collab Contradiction Detector" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Contradiction Detector" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Contradiction Detector request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0244_collab-contradiction-detector, approval gates, and rollback owner before autonomous use.
