...
description: Build and operate the "Impact Knowledge Graph Linker" capability for Social Impact Measurement. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Impact Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0699_impact-knowledge-graph-linker, approval gates, and rollback owner before autonomous use.
