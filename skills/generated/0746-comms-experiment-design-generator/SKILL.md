...
description: Build and operate the "Comms Experiment Design Generator" capability for Communication and Explainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Comms Experiment Design Generator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0746_comms-experiment-design-generato, approval gates, and rollback owner before autonomous use.
