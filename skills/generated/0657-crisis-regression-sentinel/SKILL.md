...
description: Build and operate the "Crisis Regression Sentinel" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Crisis Regression Sentinel request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0657_crisis-regression-sentinel, approval gates, and rollback owner before autonomous use.
