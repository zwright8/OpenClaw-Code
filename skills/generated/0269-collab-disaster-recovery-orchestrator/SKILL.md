...
description: Build and operate the "Collab Disaster Recovery Orchestrator" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Disaster Recovery Orchestrator" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab Disaster Recovery Orchestrator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0269_collab-disaster-recovery-orchest, approval gates, and rollback owner before autonomous use.
