...
- Orchestration integration: education-and-upskilling:contract-compiler routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Education Task Handoff Contractor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0453_education-task-handoff-contracto, approval gates, and rollback owner before autonomous use.
