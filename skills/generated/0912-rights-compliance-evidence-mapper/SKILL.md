...
## Operational Runbook
### Preflight
- Confirm the Rights Compliance Evidence Mapper request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0912_rights-compliance-evidence-mappe, approval gates, and rollback owner before autonomous use.
