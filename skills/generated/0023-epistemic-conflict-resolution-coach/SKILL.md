...
description: Build and operate the "Epistemic Conflict Resolution Coach" capability for Truth-Seeking and Epistemics. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Epistemic Conflict Resolution Coach" outcomes in the Truth-Seeking and Epistemics domain.
...
## Operational Runbook
### Preflight
- Confirm the Epistemic Conflict Resolution Coach request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0023_epistemic-conflict-resolution-co, approval gates, and rollback owner before autonomous use.
