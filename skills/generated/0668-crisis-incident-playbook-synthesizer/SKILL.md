...
description: Build and operate the "Crisis Incident Playbook Synthesizer" capability for Crisis and Incident Response. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Crisis Incident Playbook Synthesizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0668_crisis-incident-playbook-synthes, approval gates, and rollback owner before autonomous use.
