...
description: Build and operate the "Rights Security Threat Modeler" capability for Legal, Rights, and Compliance. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Rights Security Threat Modeler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0911_rights-security-threat-modeler, approval gates, and rollback owner before autonomous use.
