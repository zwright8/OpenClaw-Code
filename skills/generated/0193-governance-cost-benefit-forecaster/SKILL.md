...
description: Build and operate the "Governance Cost-Benefit Forecaster" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Cost-Benefit Forecaster" outcomes in the Safety and Governance domain.
...
- Orchestration integration: safety-and-governance:simulation-lab routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Governance Cost-Benefit Forecaster request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0193_governance-cost-benefit-forecast, approval gates, and rollback owner before autonomous use.
