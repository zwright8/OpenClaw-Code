...
## Operational Runbook
### Preflight
- Confirm the Education Human Approval Router request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0452_education-human-approval-router, approval gates, and rollback owner before autonomous use.
