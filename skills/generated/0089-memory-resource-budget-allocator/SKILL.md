...
description: Build and operate the "Memory Resource Budget Allocator" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Resource Budget Allocator" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Resource Budget Allocator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0089_memory-resource-budget-allocator, approval gates, and rollback owner before autonomous use.
