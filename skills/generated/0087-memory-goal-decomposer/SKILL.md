...
description: Build and operate the "Memory Goal Decomposer" capability for Memory and Knowledge Operations. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Memory Goal Decomposer" outcomes in the Memory and Knowledge Operations domain.
...
## Operational Runbook
### Preflight
- Confirm the Memory Goal Decomposer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0087_memory-goal-decomposer, approval gates, and rollback owner before autonomous use.
