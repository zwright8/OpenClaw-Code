...
## Operational Runbook
### Preflight
- Confirm the Impact Resource Budget Allocator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0689_impact-resource-budget-allocator, approval gates, and rollback owner before autonomous use.
