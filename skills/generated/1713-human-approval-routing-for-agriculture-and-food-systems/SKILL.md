...
## When To Use
Use this skill when the request explicitly needs "Human Approval Routing for agriculture and food systems" outcomes in the agriculture and food systems domain.
...
- Runtime profile: generalist-engine using human approval routing to produce human-approval-routing-artifact-agriculture-and-food-systems.
