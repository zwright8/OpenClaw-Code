...
description: Build and operate the "Collab Equity Impact Scorer" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab Equity Impact Scorer" outcomes in the Collaboration and Negotiation domain.
...
## Handoff Contract
- Produces: Collab Equity Impact Scorer normalized artifacts; execution scorecard; risk posture
