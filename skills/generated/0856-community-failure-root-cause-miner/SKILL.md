...
## Operational Runbook
### Preflight
- Confirm the Community Failure Root-Cause Miner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0856_community-failure-root-cause-min, approval gates, and rollback owner before autonomous use.
