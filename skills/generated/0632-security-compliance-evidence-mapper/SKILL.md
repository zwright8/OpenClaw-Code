...
description: Build and operate the "Security Compliance Evidence Mapper" capability for Security and Privacy. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Security Compliance Evidence Mapper request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0632_security-compliance-evidence-map, approval gates, and rollback owner before autonomous use.
