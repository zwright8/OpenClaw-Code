...
## Operational Runbook
### Preflight
- Confirm the Tooling Security Threat Modeler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0151_tooling-security-threat-modeler, approval gates, and rollback owner before autonomous use.
