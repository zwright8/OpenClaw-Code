...
description: Build and operate the "Research A/B Rollout Governor" capability for Scientific Research Systems. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Research A/B Rollout Governor" outcomes in the Scientific Research Systems domain.
...
## Operational Runbook
### Preflight
- Confirm the Research A/B Rollout Governor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0507_research-a-b-rollout-governor, approval gates, and rollback owner before autonomous use.
