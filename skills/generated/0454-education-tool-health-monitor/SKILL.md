...
## Operational Runbook
### Preflight
- Confirm the Education Tool Health Monitor request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0454_education-tool-health-monitor, approval gates, and rollback owner before autonomous use.
