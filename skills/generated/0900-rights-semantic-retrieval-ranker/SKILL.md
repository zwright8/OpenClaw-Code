...
description: Build and operate the "Rights Semantic Retrieval Ranker" capability for Legal, Rights, and Compliance. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Rights Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0900_rights-semantic-retrieval-ranker, approval gates, and rollback owner before autonomous use.
