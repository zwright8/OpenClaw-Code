...
description: Build and operate the "Evolution KPI Dashboard Publisher" capability for Autonomous Learning and Evolution. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Evolution KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0996_evolution-kpi-dashboard-publishe, approval gates, and rollback owner before autonomous use.
