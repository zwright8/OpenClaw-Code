...
description: Build and operate the "Governance Semantic Retrieval Ranker" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Semantic Retrieval Ranker" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Semantic Retrieval Ranker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0180_governance-semantic-retrieval-ra, approval gates, and rollback owner before autonomous use.
