...
description: Build and operate the "Infra Security Threat Modeler" capability for Infrastructure and Sustainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Infra Security Threat Modeler request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0951_infra-security-threat-modeler, approval gates, and rollback owner before autonomous use.
