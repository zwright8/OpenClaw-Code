...
## Operational Runbook
### Preflight
- Confirm the PublicService Explainability Narrative Builder request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0424_publicservice-explainability-nar, approval gates, and rollback owner before autonomous use.
