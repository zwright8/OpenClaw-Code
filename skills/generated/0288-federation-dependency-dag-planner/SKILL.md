...
description: Build and operate the "Federation Dependency DAG Planner" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Dependency DAG Planner" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation Dependency DAG Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0288_federation-dependency-dag-planne, approval gates, and rollback owner before autonomous use.
