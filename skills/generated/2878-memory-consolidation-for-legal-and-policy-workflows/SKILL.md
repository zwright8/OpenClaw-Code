...
## When To Use
Use this skill when the request explicitly needs "Memory Consolidation for legal and policy workflows" outcomes in the legal and policy workflows domain.
...
- Runtime profile: generalist-engine using memory consolidation to produce memory-consolidation-artifact-legal-and-policy-workflows.
