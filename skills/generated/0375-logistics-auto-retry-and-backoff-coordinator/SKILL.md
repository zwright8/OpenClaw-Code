...
## Operational Runbook
### Preflight
- Confirm the Logistics Auto-Retry and Backoff Coordinator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0375_logistics-auto-retry-and-backoff, approval gates, and rollback owner before autonomous use.
