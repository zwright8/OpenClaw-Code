...
description: Build and operate the "Economic Compliance Evidence Mapper" capability for Economic Optimization. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Economic Compliance Evidence Mapper" outcomes in the Economic Optimization domain.
...
## Operational Runbook
### Preflight
- Confirm the Economic Compliance Evidence Mapper request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0352_economic-compliance-evidence-map, approval gates, and rollback owner before autonomous use.
