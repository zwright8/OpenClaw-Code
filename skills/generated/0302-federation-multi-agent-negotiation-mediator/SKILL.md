...
description: Build and operate the "Federation Multi-Agent Negotiation Mediator" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Multi-Agent Negotiation Mediator" outcomes in the Federation and Interoperability domain.
...
- Orchestration integration: federation-and-interoperability:collaboration-mediator routing, approval gates, retries, and rollback controls.
- Validation evidence: unit, integration, simulation, regression-baseline suites and rollout telemetry.

## Operational Runbook
### Preflight
- Confirm the Federation Multi-Agent Negotiation Mediator request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0302_federation-multi-agent-negotiati, approval gates, and rollback owner before autonomous use.
