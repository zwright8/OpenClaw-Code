...
description: Build and operate the "Oversight Context Window Prioritizer" capability for Human Oversight and Operator UX. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Oversight Context Window Prioritizer" outcomes in the Human Oversight and Operator UX domain.
...
## Operational Runbook
### Preflight
- Confirm the Oversight Context Window Prioritizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0202_oversight-context-window-priorit, approval gates, and rollback owner before autonomous use.
