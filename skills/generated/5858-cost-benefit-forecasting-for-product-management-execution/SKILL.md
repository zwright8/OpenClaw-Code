...
## When To Use
Use this skill when the request explicitly needs "Cost-Benefit Forecasting for product management execution" outcomes in the product management execution domain.
...
- Runtime profile: forecasting-engine using cost-benefit forecasting to produce cost-benefit-forecasting-artifact-product-management-execution.
- Orchestration integration: product-management-execution:forecasting-engine routing, approval gates, retries, and rollback controls.
