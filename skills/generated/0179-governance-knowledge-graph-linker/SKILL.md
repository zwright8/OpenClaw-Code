...
description: Build and operate the "Governance Knowledge Graph Linker" capability for Safety and Governance. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Governance Knowledge Graph Linker" outcomes in the Safety and Governance domain.
...
## Operational Runbook
### Preflight
- Confirm the Governance Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0179_governance-knowledge-graph-linke, approval gates, and rollback owner before autonomous use.
