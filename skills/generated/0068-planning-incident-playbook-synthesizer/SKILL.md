...
description: Build and operate the "Planning Incident Playbook Synthesizer" capability for Strategic Planning and Decomposition. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Planning Incident Playbook Synthesizer" outcomes in the Strategic Planning and Decomposition domain.
...
## Operational Runbook
### Preflight
- Confirm the Planning Incident Playbook Synthesizer request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0068_planning-incident-playbook-synth, approval gates, and rollback owner before autonomous use.
