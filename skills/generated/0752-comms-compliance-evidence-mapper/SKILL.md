...
description: Build and operate the "Comms Compliance Evidence Mapper" capability for Communication and Explainability. Trigger when this exact capability is needed in mission execution.
---
...
## Operational Runbook
### Preflight
- Confirm the Comms Compliance Evidence Mapper request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0752_comms-compliance-evidence-mapper, approval gates, and rollback owner before autonomous use.
