...
## When To Use
Use this skill when the request explicitly needs "Human Approval Routing for marketing and storytelling" outcomes in the marketing and storytelling domain.
...
- Runtime profile: generalist-engine using human approval routing to produce human-approval-routing-artifact-marketing-and-storytelling.
