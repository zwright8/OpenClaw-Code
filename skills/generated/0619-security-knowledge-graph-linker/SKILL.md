...
## Operational Runbook
### Preflight
- Confirm the Security Knowledge Graph Linker request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0619_security-knowledge-graph-linker, approval gates, and rollback owner before autonomous use.
