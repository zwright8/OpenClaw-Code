...
description: Build and operate the "Collab KPI Dashboard Publisher" capability for Collaboration and Negotiation. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Collab KPI Dashboard Publisher" outcomes in the Collaboration and Negotiation domain.
...
## Operational Runbook
### Preflight
- Confirm the Collab KPI Dashboard Publisher request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0276_collab-kpi-dashboard-publisher, approval gates, and rollback owner before autonomous use.
