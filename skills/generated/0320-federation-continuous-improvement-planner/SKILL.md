...
description: Build and operate the "Federation Continuous Improvement Planner" capability for Federation and Interoperability. Trigger when this exact capability is needed in mission execution.
---
...
## When To Use
Use this skill when the request explicitly needs "Federation Continuous Improvement Planner" outcomes in the Federation and Interoperability domain.
...
## Operational Runbook
### Preflight
- Confirm the Federation Continuous Improvement Planner request scope, source evidence, and measurable success criteria before execution.
- Verify feature flag skill_0320_federation-continuous-improvemen, approval gates, and rollback owner before autonomous use.
