...
## When To Use
Use this skill when the request explicitly needs "Risk-Aware Scheduling for family caregiving systems" outcomes in the family caregiving systems domain.
...
- Runtime profile: generalist-engine using risk-aware scheduling to produce risk-aware-scheduling-artifact-family-caregiving-systems.
