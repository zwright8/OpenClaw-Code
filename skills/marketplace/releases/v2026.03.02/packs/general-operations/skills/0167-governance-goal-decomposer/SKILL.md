---
name: openclaw-0167-hierarchical-decomposition
description: Governance Goal Decomposer. Use when work requires hierarchical decomposition for Safety and Governance with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires hierarchical decomposition in Safety and Governance.
...
- Return artifact target: `atomic task trees`.
