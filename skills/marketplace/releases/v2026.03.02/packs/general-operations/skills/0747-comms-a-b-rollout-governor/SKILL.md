---
name: openclaw-0747-staged-rollout-policies
description: Comms A/B Rollout Governor. Use when work requires staged rollout policies for Communication and Explainability with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires staged rollout policies in Communication and Explainability.
