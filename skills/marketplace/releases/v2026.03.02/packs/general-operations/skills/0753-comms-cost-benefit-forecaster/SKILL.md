---
name: openclaw-0753-cost-impact-simulation
description: Comms Cost-Benefit Forecaster. Use when work requires cost-impact simulation for Communication and Explainability with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires cost-impact simulation in Communication and Explainability.
...
- Return artifact target: `forecasted ROI scenarios`.
