---
name: openclaw-0377-baseline-delta-detection
description: Logistics Regression Sentinel. Use when work requires baseline-delta detection for Resource Allocation and Logistics with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires baseline-delta detection in Resource Allocation and Logistics.
