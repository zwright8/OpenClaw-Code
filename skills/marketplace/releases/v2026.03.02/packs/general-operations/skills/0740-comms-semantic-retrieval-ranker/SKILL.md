---
name: openclaw-0740-semantic-relevance-scoring
description: Comms Semantic Retrieval Ranker. Use when work requires semantic relevance scoring for Communication and Explainability with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires semantic relevance scoring in Communication and Explainability.
