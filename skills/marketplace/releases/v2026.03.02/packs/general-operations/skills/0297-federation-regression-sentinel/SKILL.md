---
name: openclaw-0297-baseline-delta-detection
description: Federation Regression Sentinel. Use when work requires baseline-delta detection for Federation and Interoperability with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires baseline-delta detection in Federation and Interoperability.
