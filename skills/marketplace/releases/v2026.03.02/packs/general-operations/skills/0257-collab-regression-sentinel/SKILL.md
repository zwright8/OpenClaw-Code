---
name: openclaw-0257-baseline-delta-detection
description: Collab Regression Sentinel. Use when work requires baseline-delta detection for Collaboration and Negotiation with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires baseline-delta detection in Collaboration and Negotiation.
