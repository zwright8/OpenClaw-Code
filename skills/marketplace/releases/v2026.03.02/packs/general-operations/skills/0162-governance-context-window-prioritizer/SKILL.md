---
name: openclaw-0162-importance-scoring
description: Governance Context Window Prioritizer. Use when work requires importance scoring for Safety and Governance with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires importance scoring in Safety and Governance.
...
- Return artifact target: `ranked context bundles`.
