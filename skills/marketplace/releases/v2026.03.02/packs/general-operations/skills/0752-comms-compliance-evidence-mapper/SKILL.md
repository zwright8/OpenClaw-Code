---
name: openclaw-0752-requirement-to-evidence-mapping
description: Comms Compliance Evidence Mapper. Use when work requires requirement-to-evidence mapping for Communication and Explainability with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires requirement-to-evidence mapping in Communication and Explainability.
...
- Return artifact target: `compliance evidence matrices`.
