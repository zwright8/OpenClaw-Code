---
name: openclaw-0733-contracted-payload-schemas
description: Comms Task Handoff Contractor. Use when work requires contracted payload schemas for Communication and Explainability with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires contracted payload schemas in Communication and Explainability.
