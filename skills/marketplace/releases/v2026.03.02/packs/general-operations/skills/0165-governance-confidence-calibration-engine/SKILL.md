---
name: openclaw-0165-calibration-curves-and-error-bins
description: Governance Confidence Calibration Engine. Use when work requires calibration curves and error bins for Safety and Governance with guardrails, traceable execution, and measurable outcomes.
---
