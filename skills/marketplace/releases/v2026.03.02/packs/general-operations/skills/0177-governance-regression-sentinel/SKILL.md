---
name: openclaw-0177-baseline-delta-detection
description: Governance Regression Sentinel. Use when work requires baseline-delta detection for Safety and Governance with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires baseline-delta detection in Safety and Governance.
