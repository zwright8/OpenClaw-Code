---
name: openclaw-1476-constraint-compilation
description: Constraint Compilation for legal and policy workflows. Use when work requires constraint compilation for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires constraint compilation in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Constraint Compilation for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `constraint-compilation-artifact-legal-and-policy-workflows`.
