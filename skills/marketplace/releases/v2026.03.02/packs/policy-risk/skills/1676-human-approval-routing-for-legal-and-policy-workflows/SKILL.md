---
name: openclaw-1676-human-approval-routing
description: Human Approval Routing for legal and policy workflows. Use when work requires human approval routing for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires human approval routing in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Human Approval Routing for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `human-approval-routing-artifact-legal-and-policy-workflows`.
