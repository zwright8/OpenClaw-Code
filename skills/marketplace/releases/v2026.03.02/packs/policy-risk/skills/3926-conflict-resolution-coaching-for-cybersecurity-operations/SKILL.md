---
name: openclaw-3926-conflict-resolution-coaching
description: Conflict Resolution Coaching for cybersecurity operations. Use when work requires conflict resolution coaching for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires conflict resolution coaching in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Conflict Resolution Coaching for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `conflict-resolution-coaching-artifact-cybersecurity-operations`.
