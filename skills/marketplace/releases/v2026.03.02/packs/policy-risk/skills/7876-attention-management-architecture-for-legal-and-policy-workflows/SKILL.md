---
name: openclaw-7876-attention-management-architecture
description: Attention Management Architecture for legal and policy workflows. Use when work requires attention management architecture for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires attention management architecture in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Attention Management Architecture for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `attention-management-architecture-artifact-legal-and-policy-work`.
