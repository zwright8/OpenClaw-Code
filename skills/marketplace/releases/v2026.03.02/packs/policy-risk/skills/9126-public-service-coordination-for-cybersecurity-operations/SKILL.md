---
name: openclaw-9126-public-service-coordination
description: Public Service Coordination for cybersecurity operations. Use when work requires public service coordination for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires public service coordination in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Public Service Coordination for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `public-service-coordination-artifact-cybersecurity-operations`.
