---
name: openclaw-8526-curiosity-agenda-generation
description: Curiosity Agenda Generation for cybersecurity operations. Use when work requires curiosity agenda generation for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires curiosity agenda generation in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Curiosity Agenda Generation for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `curiosity-agenda-generation-artifact-cybersecurity-operations`.
