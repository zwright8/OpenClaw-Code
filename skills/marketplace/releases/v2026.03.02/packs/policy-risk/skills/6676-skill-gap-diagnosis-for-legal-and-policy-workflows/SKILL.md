---
name: openclaw-6676-skill-gap-diagnosis
description: Skill Gap Diagnosis for legal and policy workflows. Use when work requires skill gap diagnosis for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires skill gap diagnosis in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Skill Gap Diagnosis for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `skill-gap-diagnosis-artifact-legal-and-policy-workflows`.
