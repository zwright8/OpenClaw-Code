---
name: openclaw-3726-multi-agent-negotiation
description: Multi-Agent Negotiation for cybersecurity operations. Use when work requires multi-agent negotiation for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires multi-agent negotiation in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Multi-Agent Negotiation for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `multi-agent-negotiation-artifact-cybersecurity-operations`.
