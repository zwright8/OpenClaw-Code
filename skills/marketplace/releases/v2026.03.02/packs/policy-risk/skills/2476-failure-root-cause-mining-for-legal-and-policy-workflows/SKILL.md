---
name: openclaw-2476-failure-root-cause-mining
description: Failure Root Cause Mining for legal and policy workflows. Use when work requires failure root cause mining for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires failure root cause mining in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Failure Root Cause Mining for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `failure-root-cause-mining-artifact-legal-and-policy-workflows`.
