---
name: openclaw-9326-mentoring-and-coaching-design
description: Mentoring And Coaching Design for cybersecurity operations. Use when work requires mentoring and coaching design for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires mentoring and coaching design in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Mentoring And Coaching Design for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `mentoring-and-coaching-design-artifact-cybersecurity-operations`.
