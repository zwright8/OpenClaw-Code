---
name: openclaw-5476-security-threat-modeling
description: Security Threat Modeling for legal and policy workflows. Use when work requires security threat modeling for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires security threat modeling in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Security Threat Modeling for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `security-threat-modeling-artifact-legal-and-policy-workflows`.
