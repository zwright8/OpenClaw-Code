---
name: openclaw-5876-cost-benefit-forecasting
description: Cost-Benefit Forecasting for legal and policy workflows. Use when work requires cost-benefit forecasting for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires cost-benefit forecasting in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Cost-Benefit Forecasting for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `cost-benefit-forecasting-artifact-legal-and-policy-workflows`.
