---
name: openclaw-9526-negotiation-strategy-crafting
description: Negotiation Strategy Crafting for cybersecurity operations. Use when work requires negotiation strategy crafting for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires negotiation strategy crafting in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Negotiation Strategy Crafting for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `negotiation-strategy-crafting-artifact-cybersecurity-operations`.
