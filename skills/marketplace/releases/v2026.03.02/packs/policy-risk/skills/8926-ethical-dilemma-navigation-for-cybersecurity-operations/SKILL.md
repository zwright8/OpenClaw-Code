---
name: openclaw-8926-ethical-dilemma-navigation
description: Ethical Dilemma Navigation for cybersecurity operations. Use when work requires ethical dilemma navigation for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires ethical dilemma navigation in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Ethical Dilemma Navigation for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `ethical-dilemma-navigation-artifact-cybersecurity-operations`.
