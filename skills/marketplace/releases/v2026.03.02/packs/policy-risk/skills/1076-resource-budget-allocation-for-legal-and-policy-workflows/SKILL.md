---
name: openclaw-1076-resource-budget-allocation
description: Resource Budget Allocation for legal and policy workflows. Use when work requires resource budget allocation for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires resource budget allocation in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Resource Budget Allocation for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `resource-budget-allocation-artifact-legal-and-policy-workflows`.
