---
name: openclaw-2676-regression-sentinel-design
description: Regression Sentinel Design for legal and policy workflows. Use when work requires regression sentinel design for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires regression sentinel design in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Regression Sentinel Design for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `regression-sentinel-design-artifact-legal-and-policy-workflows`.
