---
name: openclaw-1876-handoff-contracting
description: Handoff Contracting for legal and policy workflows. Use when work requires handoff contracting for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires handoff contracting in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Handoff Contracting for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `handoff-contracting-artifact-legal-and-policy-workflows`.
