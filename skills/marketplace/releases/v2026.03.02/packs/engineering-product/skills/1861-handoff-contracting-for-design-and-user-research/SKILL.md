---
name: openclaw-1861-handoff-contracting
description: Handoff Contracting for design and user research. Use when work requires handoff contracting for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires handoff contracting in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Handoff Contracting for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `handoff-contracting-artifact-design-and-user-research`.
