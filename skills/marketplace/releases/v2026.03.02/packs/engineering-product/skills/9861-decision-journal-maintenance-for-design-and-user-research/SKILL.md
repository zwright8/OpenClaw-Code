---
name: openclaw-9861-decision-journal-maintenance
description: Decision Journal Maintenance for design and user research. Use when work requires decision journal maintenance for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires decision journal maintenance in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Decision Journal Maintenance for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `decision-journal-maintenance-artifact-design-and-user-research`.
