---
name: openclaw-7861-attention-management-architecture
description: Attention Management Architecture for design and user research. Use when work requires attention management architecture for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires attention management architecture in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Attention Management Architecture for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `attention-management-architecture-artifact-design-and-user-resea`.
