---
name: openclaw-7461-autonomous-workflow-authoring
description: Autonomous Workflow Authoring for design and user research. Use when work requires autonomous workflow authoring for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires autonomous workflow authoring in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Autonomous Workflow Authoring for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `autonomous-workflow-authoring-artifact-design-and-user-research`.
