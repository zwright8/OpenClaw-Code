---
name: openclaw-2461-failure-root-cause-mining
description: Failure Root Cause Mining for design and user research. Use when work requires failure root cause mining for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires failure root cause mining in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Failure Root Cause Mining for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `failure-root-cause-mining-artifact-design-and-user-research`.
