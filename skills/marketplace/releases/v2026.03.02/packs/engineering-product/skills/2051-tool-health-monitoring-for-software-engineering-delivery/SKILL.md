---
name: openclaw-2051-tool-health-monitoring
description: Tool Health Monitoring for software engineering delivery. Use when work requires tool health monitoring for software engineering delivery with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires tool health monitoring in software engineering delivery.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Tool Health Monitoring for software engineering delivery. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `tool-health-monitoring-artifact-software-engineering-delivery`.
