---
name: openclaw-5856-cost-benefit-forecasting
description: Cost-Benefit Forecasting for product management execution. Use when work requires cost-benefit forecasting for product management execution with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires cost-benefit forecasting in product management execution.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Cost-Benefit Forecasting for product management execution. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `cost-benefit-forecasting-artifact-product-management-execution`.
