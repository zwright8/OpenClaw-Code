---
name: openclaw-4661-a-b-rollout-governance
description: A/B Rollout Governance for design and user research. Use when work requires a/b rollout governance for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires a/b rollout governance in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting A/B Rollout Governance for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `a-b-rollout-governance-artifact-design-and-user-research`.
