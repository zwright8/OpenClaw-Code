---
name: openclaw-1661-human-approval-routing
description: Human Approval Routing for design and user research. Use when work requires human approval routing for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires human approval routing in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Human Approval Routing for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `human-approval-routing-artifact-design-and-user-research`.
