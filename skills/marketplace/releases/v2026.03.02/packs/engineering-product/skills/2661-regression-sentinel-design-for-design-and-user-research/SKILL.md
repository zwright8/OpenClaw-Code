---
name: openclaw-2661-regression-sentinel-design
description: Regression Sentinel Design for design and user research. Use when work requires regression sentinel design for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires regression sentinel design in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Regression Sentinel Design for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `regression-sentinel-design-artifact-design-and-user-research`.
