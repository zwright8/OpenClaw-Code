---
name: openclaw-1461-constraint-compilation
description: Constraint Compilation for design and user research. Use when work requires constraint compilation for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires constraint compilation in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Constraint Compilation for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `constraint-compilation-artifact-design-and-user-research`.
