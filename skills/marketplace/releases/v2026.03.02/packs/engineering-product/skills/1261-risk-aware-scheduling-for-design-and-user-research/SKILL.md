---
name: openclaw-1261-risk-aware-scheduling
description: Risk-Aware Scheduling for design and user research. Use when work requires risk-aware scheduling for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires risk-aware scheduling in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Risk-Aware Scheduling for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `risk-aware-scheduling-artifact-design-and-user-research`.
