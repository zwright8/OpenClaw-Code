---
name: openclaw-1666-human-approval-routing
description: Human Approval Routing for sales and client success. Use when work requires human approval routing for sales and client success with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires human approval routing in sales and client success.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Human Approval Routing for sales and client success. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `human-approval-routing-artifact-sales-and-client-success`.
