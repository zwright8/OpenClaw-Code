---
name: openclaw-3066-knowledge-graph-linking
description: Knowledge Graph Linking for sales and client success. Use when work requires knowledge graph linking for sales and client success with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires knowledge graph linking in sales and client success.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Knowledge Graph Linking for sales and client success. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `knowledge-graph-linking-artifact-sales-and-client-success`.
