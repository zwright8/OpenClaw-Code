---
name: openclaw-1871-handoff-contracting
description: Handoff Contracting for marketing and storytelling. Use when work requires handoff contracting for marketing and storytelling with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires handoff contracting in marketing and storytelling.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Handoff Contracting for marketing and storytelling. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `handoff-contracting-artifact-marketing-and-storytelling`.
