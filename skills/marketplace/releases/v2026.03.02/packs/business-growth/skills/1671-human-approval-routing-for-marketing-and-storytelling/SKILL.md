---
name: openclaw-1671-human-approval-routing
description: Human Approval Routing for marketing and storytelling. Use when work requires human approval routing for marketing and storytelling with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires human approval routing in marketing and storytelling.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Human Approval Routing for marketing and storytelling. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `human-approval-routing-artifact-marketing-and-storytelling`.
