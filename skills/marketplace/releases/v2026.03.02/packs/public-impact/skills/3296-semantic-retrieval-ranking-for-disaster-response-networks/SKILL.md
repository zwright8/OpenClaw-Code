---
name: openclaw-3296-semantic-retrieval-ranking
description: Semantic Retrieval Ranking for disaster response networks. Use when work requires semantic retrieval ranking for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires semantic retrieval ranking in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Semantic Retrieval Ranking for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `semantic-retrieval-ranking-artifact-disaster-response-networks`.
