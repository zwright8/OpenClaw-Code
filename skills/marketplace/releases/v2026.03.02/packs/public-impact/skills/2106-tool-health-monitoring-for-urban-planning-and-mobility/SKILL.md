---
name: openclaw-2106-tool-health-monitoring
description: Tool Health Monitoring for urban planning and mobility. Use when work requires tool health monitoring for urban planning and mobility with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires tool health monitoring in urban planning and mobility.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Tool Health Monitoring for urban planning and mobility. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `tool-health-monitoring-artifact-urban-planning-and-mobility`.
