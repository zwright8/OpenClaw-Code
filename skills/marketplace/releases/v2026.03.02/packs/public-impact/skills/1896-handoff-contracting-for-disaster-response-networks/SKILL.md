---
name: openclaw-1896-handoff-contracting
description: Handoff Contracting for disaster response networks. Use when work requires handoff contracting for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires handoff contracting in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Handoff Contracting for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `handoff-contracting-artifact-disaster-response-networks`.
