---
name: openclaw-5496-security-threat-modeling
description: Security Threat Modeling for disaster response networks. Use when work requires security threat modeling for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires security threat modeling in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Security Threat Modeling for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `security-threat-modeling-artifact-disaster-response-networks`.
