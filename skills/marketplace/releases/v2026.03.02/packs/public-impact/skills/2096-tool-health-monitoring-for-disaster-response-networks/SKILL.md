---
name: openclaw-2096-tool-health-monitoring
description: Tool Health Monitoring for disaster response networks. Use when work requires tool health monitoring for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires tool health monitoring in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Tool Health Monitoring for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `tool-health-monitoring-artifact-disaster-response-networks`.
