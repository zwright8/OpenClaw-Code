---
name: openclaw-1096-resource-budget-allocation
description: Resource Budget Allocation for disaster response networks. Use when work requires resource budget allocation for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires resource budget allocation in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Resource Budget Allocation for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `resource-budget-allocation-artifact-disaster-response-networks`.
