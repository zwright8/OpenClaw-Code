---
name: openclaw-3096-knowledge-graph-linking
description: Knowledge Graph Linking for disaster response networks. Use when work requires knowledge graph linking for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires knowledge graph linking in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Knowledge Graph Linking for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `knowledge-graph-linking-artifact-disaster-response-networks`.
