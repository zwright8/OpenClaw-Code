---
name: openclaw-9896-decision-journal-maintenance
description: Decision Journal Maintenance for disaster response networks. Use when work requires decision journal maintenance for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires decision journal maintenance in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Decision Journal Maintenance for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `decision-journal-maintenance-artifact-disaster-response-networks`.
