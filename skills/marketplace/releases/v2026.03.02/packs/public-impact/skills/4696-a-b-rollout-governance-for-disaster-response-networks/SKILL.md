---
name: openclaw-4696-a-b-rollout-governance
description: A/B Rollout Governance for disaster response networks. Use when work requires a/b rollout governance for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires a/b rollout governance in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting A/B Rollout Governance for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `a-b-rollout-governance-artifact-disaster-response-networks`.
