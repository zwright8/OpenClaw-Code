---
name: openclaw-1296-risk-aware-scheduling
description: Risk-Aware Scheduling for disaster response networks. Use when work requires risk-aware scheduling for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires risk-aware scheduling in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Risk-Aware Scheduling for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `risk-aware-scheduling-artifact-disaster-response-networks`.
