---
name: openclaw-7281-continuous-improvement-planning
description: Continuous Improvement Planning for healthcare operations. Use when work requires continuous improvement planning for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires continuous improvement planning in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Continuous Improvement Planning for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `continuous-improvement-planning-artifact-healthcare-operations`.
