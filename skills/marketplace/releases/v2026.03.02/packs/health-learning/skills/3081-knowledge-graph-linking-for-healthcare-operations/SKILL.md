---
name: openclaw-3081-knowledge-graph-linking
description: Knowledge Graph Linking for healthcare operations. Use when work requires knowledge graph linking for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires knowledge graph linking in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Knowledge Graph Linking for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `knowledge-graph-linking-artifact-healthcare-operations`.
