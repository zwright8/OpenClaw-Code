---
name: openclaw-2681-regression-sentinel-design
description: Regression Sentinel Design for healthcare operations. Use when work requires regression sentinel design for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires regression sentinel design in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Regression Sentinel Design for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `regression-sentinel-design-artifact-healthcare-operations`.
