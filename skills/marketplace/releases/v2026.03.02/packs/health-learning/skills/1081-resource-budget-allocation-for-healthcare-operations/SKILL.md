---
name: openclaw-1081-resource-budget-allocation
description: Resource Budget Allocation for healthcare operations. Use when work requires resource budget allocation for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires resource budget allocation in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Resource Budget Allocation for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `resource-budget-allocation-artifact-healthcare-operations`.
