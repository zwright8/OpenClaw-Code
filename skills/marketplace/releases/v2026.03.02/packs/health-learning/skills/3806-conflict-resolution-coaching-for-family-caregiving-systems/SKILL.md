---
name: openclaw-3806-conflict-resolution-coaching
description: Conflict Resolution Coaching for family caregiving systems. Use when work requires conflict resolution coaching for family caregiving systems with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires conflict resolution coaching in family caregiving systems.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Conflict Resolution Coaching for family caregiving systems. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `conflict-resolution-coaching-artifact-family-caregiving-systems`.
