---
name: openclaw-1686-human-approval-routing
description: Human Approval Routing for education support services. Use when work requires human approval routing for education support services with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires human approval routing in education support services.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Human Approval Routing for education support services. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `human-approval-routing-artifact-education-support-services`.
