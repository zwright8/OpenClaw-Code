---
name: openclaw-9881-decision-journal-maintenance
description: Decision Journal Maintenance for healthcare operations. Use when work requires decision journal maintenance for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires decision journal maintenance in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Decision Journal Maintenance for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `decision-journal-maintenance-artifact-healthcare-operations`.
