---
name: openclaw-1881-handoff-contracting
description: Handoff Contracting for healthcare operations. Use when work requires handoff contracting for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires handoff contracting in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Handoff Contracting for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `handoff-contracting-artifact-healthcare-operations`.
