---
name: openclaw-2281-retry-and-backoff-orchestration
description: Retry And Backoff Orchestration for healthcare operations. Use when work requires retry and backoff orchestration for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires retry and backoff orchestration in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Retry And Backoff Orchestration for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `retry-and-backoff-orchestration-artifact-healthcare-operations`.
