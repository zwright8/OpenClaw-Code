---
name: openclaw-5481-security-threat-modeling
description: Security Threat Modeling for healthcare operations. Use when work requires security threat modeling for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires security threat modeling in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Security Threat Modeling for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `security-threat-modeling-artifact-healthcare-operations`.
