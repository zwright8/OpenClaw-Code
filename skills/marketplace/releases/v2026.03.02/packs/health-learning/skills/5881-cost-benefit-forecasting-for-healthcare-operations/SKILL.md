---
name: openclaw-5881-cost-benefit-forecasting
description: Cost-Benefit Forecasting for healthcare operations. Use when work requires cost-benefit forecasting for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires cost-benefit forecasting in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Cost-Benefit Forecasting for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `cost-benefit-forecasting-artifact-healthcare-operations`.
