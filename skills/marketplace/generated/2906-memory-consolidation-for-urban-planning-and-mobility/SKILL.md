---
name: openclaw-2906-memory-consolidation
description: Memory Consolidation for urban planning and mobility. Use when work requires memory consolidation for urban planning and mobility with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires memory consolidation in urban planning and mobility.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Memory Consolidation for urban planning and mobility. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `memory-consolidation-artifact-urban-planning-and-mobility`.
