---
name: openclaw-3266-semantic-retrieval-ranking
description: Semantic Retrieval Ranking for sales and client success. Use when work requires semantic retrieval ranking for sales and client success with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires semantic retrieval ranking in sales and client success.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Semantic Retrieval Ranking for sales and client success. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `semantic-retrieval-ranking-artifact-sales-and-client-success`.
