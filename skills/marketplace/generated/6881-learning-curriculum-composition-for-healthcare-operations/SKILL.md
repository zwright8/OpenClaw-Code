---
name: openclaw-6881-learning-curriculum-composition
description: Learning Curriculum Composition for healthcare operations. Use when work requires learning curriculum composition for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires learning curriculum composition in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Learning Curriculum Composition for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `learning-curriculum-composition-artifact-healthcare-operations`.
