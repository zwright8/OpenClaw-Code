---
name: openclaw-2926-memory-consolidation
description: Memory Consolidation for cybersecurity operations. Use when work requires memory consolidation for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires memory consolidation in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Memory Consolidation for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `memory-consolidation-artifact-cybersecurity-operations`.
