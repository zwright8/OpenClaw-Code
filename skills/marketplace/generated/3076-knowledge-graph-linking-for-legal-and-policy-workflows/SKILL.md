---
name: openclaw-3076-knowledge-graph-linking
description: Knowledge Graph Linking for legal and policy workflows. Use when work requires knowledge graph linking for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires knowledge graph linking in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Knowledge Graph Linking for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `knowledge-graph-linking-artifact-legal-and-policy-workflows`.
