---
name: openclaw-6696-skill-gap-diagnosis
description: Skill Gap Diagnosis for disaster response networks. Use when work requires skill gap diagnosis for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires skill gap diagnosis in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Skill Gap Diagnosis for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `skill-gap-diagnosis-artifact-disaster-response-networks`.
