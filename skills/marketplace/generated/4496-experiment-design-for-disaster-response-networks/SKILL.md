---
name: openclaw-4496-experiment-design
description: Experiment Design for disaster response networks. Use when work requires experiment design for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires experiment design in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Experiment Design for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `experiment-design-artifact-disaster-response-networks`.
