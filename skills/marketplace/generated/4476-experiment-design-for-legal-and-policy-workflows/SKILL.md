---
name: openclaw-4476-experiment-design
description: Experiment Design for legal and policy workflows. Use when work requires experiment design for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires experiment design in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Experiment Design for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `experiment-design-artifact-legal-and-policy-workflows`.
