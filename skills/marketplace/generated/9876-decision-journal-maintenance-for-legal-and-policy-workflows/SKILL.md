---
name: openclaw-9876-decision-journal-maintenance
description: Decision Journal Maintenance for legal and policy workflows. Use when work requires decision journal maintenance for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires decision journal maintenance in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Decision Journal Maintenance for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `decision-journal-maintenance-artifact-legal-and-policy-workflows`.
