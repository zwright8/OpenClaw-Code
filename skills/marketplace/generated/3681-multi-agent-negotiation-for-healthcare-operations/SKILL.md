---
name: openclaw-3681-multi-agent-negotiation
description: Multi-Agent Negotiation for healthcare operations. Use when work requires multi-agent negotiation for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires multi-agent negotiation in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Multi-Agent Negotiation for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `multi-agent-negotiation-artifact-healthcare-operations`.
