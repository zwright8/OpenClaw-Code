---
name: openclaw-7881-attention-management-architecture
description: Attention Management Architecture for healthcare operations. Use when work requires attention management architecture for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires attention management architecture in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Attention Management Architecture for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `attention-management-architecture-artifact-healthcare-operations`.
