---
name: openclaw-0893-contracted-payload-schemas
description: Rights Task Handoff Contractor. Use when work requires contracted payload schemas for Legal, Rights, and Compliance with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires contracted payload schemas in Legal, Rights, and Compliance.
...
- Return artifact target: `typed handoff artifacts`.
