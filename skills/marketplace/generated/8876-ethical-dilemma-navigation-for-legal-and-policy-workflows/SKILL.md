---
name: openclaw-8876-ethical-dilemma-navigation
description: Ethical Dilemma Navigation for legal and policy workflows. Use when work requires ethical dilemma navigation for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires ethical dilemma navigation in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Ethical Dilemma Navigation for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `ethical-dilemma-navigation-artifact-legal-and-policy-workflows`.
