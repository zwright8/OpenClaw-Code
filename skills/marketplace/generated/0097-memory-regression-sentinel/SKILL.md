---
name: openclaw-0097-baseline-delta-detection
description: Memory Regression Sentinel. Use when work requires baseline-delta detection for Memory and Knowledge Operations with guardrails, traceable execution, and measurable outcomes.
---
