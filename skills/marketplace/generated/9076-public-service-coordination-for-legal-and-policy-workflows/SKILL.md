---
name: openclaw-9076-public-service-coordination
description: Public Service Coordination for legal and policy workflows. Use when work requires public service coordination for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires public service coordination in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Public Service Coordination for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `public-service-coordination-artifact-legal-and-policy-workflows`.
