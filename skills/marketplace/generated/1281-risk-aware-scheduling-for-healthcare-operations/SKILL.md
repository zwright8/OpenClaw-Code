---
name: openclaw-1281-risk-aware-scheduling
description: Risk-Aware Scheduling for healthcare operations. Use when work requires risk-aware scheduling for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires risk-aware scheduling in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Risk-Aware Scheduling for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `risk-aware-scheduling-artifact-healthcare-operations`.
