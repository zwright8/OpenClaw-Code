---
name: openclaw-0161-schema-mapping-and-validation
description: Governance Signal Ingestion Normalizer. Use when work requires schema mapping and validation for Safety and Governance with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires schema mapping and validation in Safety and Governance.
...
- Return artifact target: `normalized signal feeds`.
