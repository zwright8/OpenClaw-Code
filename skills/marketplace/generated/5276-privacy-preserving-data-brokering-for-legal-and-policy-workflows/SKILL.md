---
name: openclaw-5276-privacy-preserving-data-brokering
description: Privacy-Preserving Data Brokering for legal and policy workflows. Use when work requires privacy-preserving data brokering for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires privacy-preserving data brokering in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Privacy-Preserving Data Brokering for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `privacy-preserving-data-brokering-artifact-legal-and-policy-work`.
