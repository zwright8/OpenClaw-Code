---
name: openclaw-1481-constraint-compilation
description: Constraint Compilation for healthcare operations. Use when work requires constraint compilation for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires constraint compilation in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Constraint Compilation for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `constraint-compilation-artifact-healthcare-operations`.
