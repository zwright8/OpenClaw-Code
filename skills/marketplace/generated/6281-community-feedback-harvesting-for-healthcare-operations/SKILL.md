---
name: openclaw-6281-community-feedback-harvesting
description: Community Feedback Harvesting for healthcare operations. Use when work requires community feedback harvesting for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires community feedback harvesting in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Community Feedback Harvesting for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `community-feedback-harvesting-artifact-healthcare-operations`.
