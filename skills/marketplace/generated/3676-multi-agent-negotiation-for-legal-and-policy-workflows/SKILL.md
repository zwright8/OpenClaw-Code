---
name: openclaw-3676-multi-agent-negotiation
description: Multi-Agent Negotiation for legal and policy workflows. Use when work requires multi-agent negotiation for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires multi-agent negotiation in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Multi-Agent Negotiation for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `multi-agent-negotiation-artifact-legal-and-policy-workflows`.
