---
name: openclaw-4871-incident-playbook-synthesis
description: Incident Playbook Synthesis for marketing and storytelling. Use when work requires incident playbook synthesis for marketing and storytelling with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires incident playbook synthesis in marketing and storytelling.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Incident Playbook Synthesis for marketing and storytelling. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `incident-playbook-synthesis-artifact-marketing-and-storytelling`.
