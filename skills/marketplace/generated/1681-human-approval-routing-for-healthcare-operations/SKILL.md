---
name: openclaw-1681-human-approval-routing
description: Human Approval Routing for healthcare operations. Use when work requires human approval routing for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires human approval routing in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Human Approval Routing for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `human-approval-routing-artifact-healthcare-operations`.
