---
name: openclaw-4861-incident-playbook-synthesis
description: Incident Playbook Synthesis for design and user research. Use when work requires incident playbook synthesis for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires incident playbook synthesis in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Incident Playbook Synthesis for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `incident-playbook-synthesis-artifact-design-and-user-research`.
