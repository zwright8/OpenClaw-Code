---
name: openclaw-4481-experiment-design
description: Experiment Design for healthcare operations. Use when work requires experiment design for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires experiment design in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Experiment Design for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `experiment-design-artifact-healthcare-operations`.
