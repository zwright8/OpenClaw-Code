---
name: openclaw-5861-cost-benefit-forecasting
description: Cost-Benefit Forecasting for design and user research. Use when work requires cost-benefit forecasting for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires cost-benefit forecasting in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Cost-Benefit Forecasting for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `cost-benefit-forecasting-artifact-design-and-user-research`.
