---
name: openclaw-3061-knowledge-graph-linking
description: Knowledge Graph Linking for design and user research. Use when work requires knowledge graph linking for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires knowledge graph linking in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Knowledge Graph Linking for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `knowledge-graph-linking-artifact-design-and-user-research`.
