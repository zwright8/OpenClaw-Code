---
name: openclaw-3526-plan-quality-evaluation
description: Plan Quality Evaluation for cybersecurity operations. Use when work requires plan quality evaluation for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires plan quality evaluation in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Plan Quality Evaluation for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `plan-quality-evaluation-artifact-cybersecurity-operations`.
