---
name: openclaw-4676-a-b-rollout-governance
description: A/B Rollout Governance for legal and policy workflows. Use when work requires a/b rollout governance for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires a/b rollout governance in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting A/B Rollout Governance for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `a-b-rollout-governance-artifact-legal-and-policy-workflows`.
