---
name: openclaw-7481-autonomous-workflow-authoring
description: Autonomous Workflow Authoring for healthcare operations. Use when work requires autonomous workflow authoring for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires autonomous workflow authoring in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Autonomous Workflow Authoring for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `autonomous-workflow-authoring-artifact-healthcare-operations`.
