---
name: openclaw-3481-plan-quality-evaluation
description: Plan Quality Evaluation for healthcare operations. Use when work requires plan quality evaluation for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires plan quality evaluation in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Plan Quality Evaluation for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `plan-quality-evaluation-artifact-healthcare-operations`.
