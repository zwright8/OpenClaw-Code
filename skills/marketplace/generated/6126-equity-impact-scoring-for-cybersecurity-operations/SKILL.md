---
name: openclaw-6126-equity-impact-scoring
description: Equity Impact Scoring for cybersecurity operations. Use when work requires equity impact scoring for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires equity impact scoring in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Equity Impact Scoring for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `equity-impact-scoring-artifact-cybersecurity-operations`.
