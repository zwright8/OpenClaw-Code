---
name: openclaw-2876-memory-consolidation
description: Memory Consolidation for legal and policy workflows. Use when work requires memory consolidation for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires memory consolidation in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Memory Consolidation for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `memory-consolidation-artifact-legal-and-policy-workflows`.
