---
name: openclaw-1276-risk-aware-scheduling
description: Risk-Aware Scheduling for legal and policy workflows. Use when work requires risk-aware scheduling for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires risk-aware scheduling in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Risk-Aware Scheduling for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `risk-aware-scheduling-artifact-legal-and-policy-workflows`.
