---
name: openclaw-6926-learning-curriculum-composition
description: Learning Curriculum Composition for cybersecurity operations. Use when work requires learning curriculum composition for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires learning curriculum composition in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Learning Curriculum Composition for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `learning-curriculum-composition-artifact-cybersecurity-operation`.
