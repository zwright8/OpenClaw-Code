---
name: openclaw-7081-self-reflection-taxonomy
description: Self-Reflection Taxonomy for healthcare operations. Use when work requires self-reflection taxonomy for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires self-reflection taxonomy in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Self-Reflection Taxonomy for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `self-reflection-taxonomy-artifact-healthcare-operations`.
