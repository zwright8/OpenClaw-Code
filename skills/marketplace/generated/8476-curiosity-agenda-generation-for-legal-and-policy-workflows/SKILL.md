---
name: openclaw-8476-curiosity-agenda-generation
description: Curiosity Agenda Generation for legal and policy workflows. Use when work requires curiosity agenda generation for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires curiosity agenda generation in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Curiosity Agenda Generation for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `curiosity-agenda-generation-artifact-legal-and-policy-workflows`.
