---
name: openclaw-8481-curiosity-agenda-generation
description: Curiosity Agenda Generation for healthcare operations. Use when work requires curiosity agenda generation for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires curiosity agenda generation in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Curiosity Agenda Generation for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `curiosity-agenda-generation-artifact-healthcare-operations`.
