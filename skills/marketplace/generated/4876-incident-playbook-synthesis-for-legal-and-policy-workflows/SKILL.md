---
name: openclaw-4876-incident-playbook-synthesis
description: Incident Playbook Synthesis for legal and policy workflows. Use when work requires incident playbook synthesis for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires incident playbook synthesis in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Incident Playbook Synthesis for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `incident-playbook-synthesis-artifact-legal-and-policy-workflows`.
