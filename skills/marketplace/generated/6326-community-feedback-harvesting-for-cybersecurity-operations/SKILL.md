---
name: openclaw-6326-community-feedback-harvesting
description: Community Feedback Harvesting for cybersecurity operations. Use when work requires community feedback harvesting for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires community feedback harvesting in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Community Feedback Harvesting for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `community-feedback-harvesting-artifact-cybersecurity-operations`.
