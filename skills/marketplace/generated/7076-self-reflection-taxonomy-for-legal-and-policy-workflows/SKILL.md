---
name: openclaw-7076-self-reflection-taxonomy
description: Self-Reflection Taxonomy for legal and policy workflows. Use when work requires self-reflection taxonomy for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires self-reflection taxonomy in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Self-Reflection Taxonomy for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `self-reflection-taxonomy-artifact-legal-and-policy-workflows`.
