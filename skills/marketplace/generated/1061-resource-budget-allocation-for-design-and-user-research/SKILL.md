---
name: openclaw-1061-resource-budget-allocation
description: Resource Budget Allocation for design and user research. Use when work requires resource budget allocation for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires resource budget allocation in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Resource Budget Allocation for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `resource-budget-allocation-artifact-design-and-user-research`.
