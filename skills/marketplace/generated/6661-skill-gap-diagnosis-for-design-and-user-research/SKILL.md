---
name: openclaw-6661-skill-gap-diagnosis
description: Skill Gap Diagnosis for design and user research. Use when work requires skill gap diagnosis for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires skill gap diagnosis in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Skill Gap Diagnosis for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `skill-gap-diagnosis-artifact-design-and-user-research`.
