---
name: openclaw-1526-constraint-compilation
description: Constraint Compilation for cybersecurity operations. Use when work requires constraint compilation for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires constraint compilation in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Constraint Compilation for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `constraint-compilation-artifact-cybersecurity-operations`.
