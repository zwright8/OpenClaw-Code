---
name: openclaw-6106-equity-impact-scoring
description: Equity Impact Scoring for urban planning and mobility. Use when work requires equity impact scoring for urban planning and mobility with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires equity impact scoring in urban planning and mobility.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Equity Impact Scoring for urban planning and mobility. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `equity-impact-scoring-artifact-urban-planning-and-mobility`.
