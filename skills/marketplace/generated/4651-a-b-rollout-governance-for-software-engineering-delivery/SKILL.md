---
name: openclaw-4651-a-b-rollout-governance
description: A/B Rollout Governance for software engineering delivery. Use when work requires a/b rollout governance for software engineering delivery with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires a/b rollout governance in software engineering delivery.
...
## Guardrails
- [quality] Require unit and integration validations before promoting A/B Rollout Governance for software engineering delivery. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `a-b-rollout-governance-artifact-software-engineering-delivery`.
