---
name: openclaw-3476-plan-quality-evaluation
description: Plan Quality Evaluation for legal and policy workflows. Use when work requires plan quality evaluation for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires plan quality evaluation in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Plan Quality Evaluation for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `plan-quality-evaluation-artifact-legal-and-policy-workflows`.
