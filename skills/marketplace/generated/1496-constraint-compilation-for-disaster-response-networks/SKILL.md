---
name: openclaw-1496-constraint-compilation
description: Constraint Compilation for disaster response networks. Use when work requires constraint compilation for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires constraint compilation in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Constraint Compilation for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `constraint-compilation-artifact-disaster-response-networks`.
