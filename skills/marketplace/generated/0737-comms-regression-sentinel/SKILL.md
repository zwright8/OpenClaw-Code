---
name: openclaw-0737-baseline-delta-detection
description: Comms Regression Sentinel. Use when work requires baseline-delta detection for Communication and Explainability with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires baseline-delta detection in Communication and Explainability.
