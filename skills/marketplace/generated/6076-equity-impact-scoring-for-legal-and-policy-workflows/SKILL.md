---
name: openclaw-6076-equity-impact-scoring
description: Equity Impact Scoring for legal and policy workflows. Use when work requires equity impact scoring for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires equity impact scoring in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Equity Impact Scoring for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `equity-impact-scoring-artifact-legal-and-policy-workflows`.
