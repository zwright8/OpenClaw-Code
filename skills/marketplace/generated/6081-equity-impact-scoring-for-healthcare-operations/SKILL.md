---
name: openclaw-6081-equity-impact-scoring
description: Equity Impact Scoring for healthcare operations. Use when work requires equity impact scoring for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires equity impact scoring in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Equity Impact Scoring for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `equity-impact-scoring-artifact-healthcare-operations`.
