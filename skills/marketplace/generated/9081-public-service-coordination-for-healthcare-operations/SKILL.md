---
name: openclaw-9081-public-service-coordination
description: Public Service Coordination for healthcare operations. Use when work requires public service coordination for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires public service coordination in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Public Service Coordination for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `public-service-coordination-artifact-healthcare-operations`.
