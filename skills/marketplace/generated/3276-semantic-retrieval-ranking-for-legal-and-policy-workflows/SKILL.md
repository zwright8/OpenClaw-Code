---
name: openclaw-3276-semantic-retrieval-ranking
description: Semantic Retrieval Ranking for legal and policy workflows. Use when work requires semantic retrieval ranking for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires semantic retrieval ranking in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Semantic Retrieval Ranking for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `semantic-retrieval-ranking-artifact-legal-and-policy-workflows`.
