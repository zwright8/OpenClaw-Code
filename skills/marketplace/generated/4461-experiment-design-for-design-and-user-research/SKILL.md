---
name: openclaw-4461-experiment-design
description: Experiment Design for design and user research. Use when work requires experiment design for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires experiment design in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Experiment Design for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `experiment-design-artifact-design-and-user-research`.
