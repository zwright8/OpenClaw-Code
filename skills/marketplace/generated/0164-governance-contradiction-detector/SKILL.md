---
name: openclaw-0164-cross-claim-consistency-checks
description: Governance Contradiction Detector. Use when work requires cross-claim consistency checks for Safety and Governance with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires cross-claim consistency checks in Safety and Governance.
...
- Return artifact target: `contradiction alerts`.
