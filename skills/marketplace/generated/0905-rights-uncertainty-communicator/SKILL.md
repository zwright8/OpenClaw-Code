---
name: openclaw-0905-confidence-bound-communication-templates
description: Rights Uncertainty Communicator. Use when work requires confidence-bound communication templates for Legal, Rights, and Compliance with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires confidence-bound communication templates in Legal, Rights, and Compliance.
...
- Return artifact target: `uncertainty briefs`.
