---
name: openclaw-8881-ethical-dilemma-navigation
description: Ethical Dilemma Navigation for healthcare operations. Use when work requires ethical dilemma navigation for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires ethical dilemma navigation in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Ethical Dilemma Navigation for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `ethical-dilemma-navigation-artifact-healthcare-operations`.
