---
name: openclaw-8276-beauty-pattern-detection
description: Beauty Pattern Detection for legal and policy workflows. Use when work requires beauty pattern detection for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires beauty pattern detection in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Beauty Pattern Detection for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `beauty-pattern-detection-artifact-legal-and-policy-workflows`.
