---
name: openclaw-2061-tool-health-monitoring
description: Tool Health Monitoring for design and user research. Use when work requires tool health monitoring for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires tool health monitoring in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Tool Health Monitoring for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `tool-health-monitoring-artifact-design-and-user-research`.
