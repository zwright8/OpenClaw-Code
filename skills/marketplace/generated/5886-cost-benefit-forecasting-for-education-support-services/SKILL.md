---
name: openclaw-5886-cost-benefit-forecasting
description: Cost-Benefit Forecasting for education support services. Use when work requires cost-benefit forecasting for education support services with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires cost-benefit forecasting in education support services.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Cost-Benefit Forecasting for education support services. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `cost-benefit-forecasting-artifact-education-support-services`.
