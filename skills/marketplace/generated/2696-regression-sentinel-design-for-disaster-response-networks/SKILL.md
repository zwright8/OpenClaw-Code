---
name: openclaw-2696-regression-sentinel-design
description: Regression Sentinel Design for disaster response networks. Use when work requires regression sentinel design for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires regression sentinel design in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Regression Sentinel Design for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `regression-sentinel-design-artifact-disaster-response-networks`.
