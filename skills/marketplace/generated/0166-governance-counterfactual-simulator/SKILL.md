---
name: openclaw-0166-counterfactual-replay
description: Governance Counterfactual Simulator. Use when work requires counterfactual replay for Safety and Governance with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires counterfactual replay in Safety and Governance.
...
- Return artifact target: `scenario comparison reports`.
