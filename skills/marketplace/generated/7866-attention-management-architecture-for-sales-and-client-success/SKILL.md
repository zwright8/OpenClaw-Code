---
name: openclaw-7866-attention-management-architecture
description: Attention Management Architecture for sales and client success. Use when work requires attention management architecture for sales and client success with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires attention management architecture in sales and client success.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Attention Management Architecture for sales and client success. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `attention-management-architecture-artifact-sales-and-client-succ`.
