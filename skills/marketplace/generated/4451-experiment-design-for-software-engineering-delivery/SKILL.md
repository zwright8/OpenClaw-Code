---
name: openclaw-4451-experiment-design
description: Experiment Design for software engineering delivery. Use when work requires experiment design for software engineering delivery with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires experiment design in software engineering delivery.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Experiment Design for software engineering delivery. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `experiment-design-artifact-software-engineering-delivery`.
