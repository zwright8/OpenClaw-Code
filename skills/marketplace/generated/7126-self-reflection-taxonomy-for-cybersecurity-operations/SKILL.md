---
name: openclaw-7126-self-reflection-taxonomy
description: Self-Reflection Taxonomy for cybersecurity operations. Use when work requires self-reflection taxonomy for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires self-reflection taxonomy in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Self-Reflection Taxonomy for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `self-reflection-taxonomy-artifact-cybersecurity-operations`.
