---
name: openclaw-7906-attention-management-architecture
description: Attention Management Architecture for urban planning and mobility. Use when work requires attention management architecture for urban planning and mobility with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires attention management architecture in urban planning and mobility.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Attention Management Architecture for urban planning and mobility. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `attention-management-architecture-artifact-urban-planning-and-mo`.
