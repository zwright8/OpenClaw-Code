---
name: openclaw-2481-failure-root-cause-mining
description: Failure Root Cause Mining for healthcare operations. Use when work requires failure root cause mining for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires failure root cause mining in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Failure Root Cause Mining for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `failure-root-cause-mining-artifact-healthcare-operations`.
