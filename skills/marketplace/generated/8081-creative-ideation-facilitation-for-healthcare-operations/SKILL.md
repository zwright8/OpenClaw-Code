---
name: openclaw-8081-creative-ideation-facilitation
description: Creative Ideation Facilitation for healthcare operations. Use when work requires creative ideation facilitation for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires creative ideation facilitation in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Creative Ideation Facilitation for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `creative-ideation-facilitation-artifact-healthcare-operations`.
