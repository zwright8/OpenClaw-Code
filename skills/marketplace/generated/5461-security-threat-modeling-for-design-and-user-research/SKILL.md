---
name: openclaw-5461-security-threat-modeling
description: Security Threat Modeling for design and user research. Use when work requires security threat modeling for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires security threat modeling in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Security Threat Modeling for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `security-threat-modeling-artifact-design-and-user-research`.
