---
name: openclaw-8281-beauty-pattern-detection
description: Beauty Pattern Detection for healthcare operations. Use when work requires beauty pattern detection for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires beauty pattern detection in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Beauty Pattern Detection for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `beauty-pattern-detection-artifact-healthcare-operations`.
