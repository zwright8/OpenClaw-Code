---
name: openclaw-2881-memory-consolidation
description: Memory Consolidation for healthcare operations. Use when work requires memory consolidation for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires memory consolidation in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Memory Consolidation for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `memory-consolidation-artifact-healthcare-operations`.
