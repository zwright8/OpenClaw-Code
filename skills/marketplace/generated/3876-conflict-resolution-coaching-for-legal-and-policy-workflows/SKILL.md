---
name: openclaw-3876-conflict-resolution-coaching
description: Conflict Resolution Coaching for legal and policy workflows. Use when work requires conflict resolution coaching for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires conflict resolution coaching in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Conflict Resolution Coaching for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `conflict-resolution-coaching-artifact-legal-and-policy-workflows`.
