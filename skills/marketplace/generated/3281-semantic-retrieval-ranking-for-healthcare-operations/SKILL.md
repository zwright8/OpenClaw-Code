---
name: openclaw-3281-semantic-retrieval-ranking
description: Semantic Retrieval Ranking for healthcare operations. Use when work requires semantic retrieval ranking for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires semantic retrieval ranking in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Semantic Retrieval Ranking for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `semantic-retrieval-ranking-artifact-healthcare-operations`.
