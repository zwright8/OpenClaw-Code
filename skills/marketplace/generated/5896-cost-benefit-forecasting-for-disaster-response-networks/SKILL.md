---
name: openclaw-5896-cost-benefit-forecasting
description: Cost-Benefit Forecasting for disaster response networks. Use when work requires cost-benefit forecasting for disaster response networks with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires cost-benefit forecasting in disaster response networks.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Cost-Benefit Forecasting for disaster response networks. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `cost-benefit-forecasting-artifact-disaster-response-networks`.
