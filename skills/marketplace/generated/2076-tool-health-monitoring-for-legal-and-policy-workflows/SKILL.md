---
name: openclaw-2076-tool-health-monitoring
description: Tool Health Monitoring for legal and policy workflows. Use when work requires tool health monitoring for legal and policy workflows with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires tool health monitoring in legal and policy workflows.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Tool Health Monitoring for legal and policy workflows. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `tool-health-monitoring-artifact-legal-and-policy-workflows`.
