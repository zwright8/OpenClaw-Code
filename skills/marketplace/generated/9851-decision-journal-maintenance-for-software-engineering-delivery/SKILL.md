---
name: openclaw-9851-decision-journal-maintenance
description: Decision Journal Maintenance for software engineering delivery. Use when work requires decision journal maintenance for software engineering delivery with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires decision journal maintenance in software engineering delivery.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Decision Journal Maintenance for software engineering delivery. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `decision-journal-maintenance-artifact-software-engineering-deliv`.
