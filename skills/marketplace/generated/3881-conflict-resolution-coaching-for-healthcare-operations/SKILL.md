---
name: openclaw-3881-conflict-resolution-coaching
description: Conflict Resolution Coaching for healthcare operations. Use when work requires conflict resolution coaching for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires conflict resolution coaching in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Conflict Resolution Coaching for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `conflict-resolution-coaching-artifact-healthcare-operations`.
