---
name: openclaw-7451-autonomous-workflow-authoring
description: Autonomous Workflow Authoring for software engineering delivery. Use when work requires autonomous workflow authoring for software engineering delivery with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires autonomous workflow authoring in software engineering delivery.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Autonomous Workflow Authoring for software engineering delivery. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `autonomous-workflow-authoring-artifact-software-engineering-deli`.
