---
name: openclaw-1126-resource-budget-allocation
description: Resource Budget Allocation for cybersecurity operations. Use when work requires resource budget allocation for cybersecurity operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires resource budget allocation in cybersecurity operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Resource Budget Allocation for cybersecurity operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `resource-budget-allocation-artifact-cybersecurity-operations`.
