---
name: openclaw-3261-semantic-retrieval-ranking
description: Semantic Retrieval Ranking for design and user research. Use when work requires semantic retrieval ranking for design and user research with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires semantic retrieval ranking in design and user research.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Semantic Retrieval Ranking for design and user research. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `semantic-retrieval-ranking-artifact-design-and-user-research`.
