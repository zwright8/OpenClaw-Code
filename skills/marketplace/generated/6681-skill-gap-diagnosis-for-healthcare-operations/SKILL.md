---
name: openclaw-6681-skill-gap-diagnosis
description: Skill Gap Diagnosis for healthcare operations. Use when work requires skill gap diagnosis for healthcare operations with guardrails, traceable execution, and measurable outcomes.
---
...
## Activation Cues
- Task requires skill gap diagnosis in healthcare operations.
...
## Guardrails
- [quality] Require unit and integration validations before promoting Skill Gap Diagnosis for healthcare operations. Automation: `run-validation:unit+integration+simulation+regression-baseline`
...
- Return artifact target: `skill-gap-diagnosis-artifact-healthcare-operations`.
