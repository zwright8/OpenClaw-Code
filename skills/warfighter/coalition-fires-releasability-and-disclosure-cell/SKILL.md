---
name: coalition-fires-releasability-and-disclosure-cell
description: Assess and package fires data for coalition release while preserving operational security and legal compliance. Use when multinational fires coordination requires releasability adjudication.
---
...
1. Frame the mission problem using these core inputs: classification caveats, coalition disclosure rules, target/airspace data pedigree, legal review status.
...
Primary products for this skill: coalition releasability matrix, redacted fires package, release approval tracker.
...
- Prioritize these tools or tool families for this domain: cross-domain guards, coalition COP tools, disclosure governance systems, legal policy repositories.
- Specify outbound exchange format for recommendations and tasking: NATO APP-11/ADatP-3, USMTF, OGC, API/JSON.
