---
name: joint-arctic-prepositioned-stock-attrition-and-reconstitution-cell
description: Plan attrition tracking and reconstitution of prepositioned stocks in Arctic and extreme-weather theaters. Use when commanders need to preserve arctic sustainment posture under infrastructure and climate stress.
---
...
Primary products for this skill: arctic stock attrition ledger, reconstitution branch matrix, prepositioned-equipment readiness forecast.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-logistics-distribution-v1` with `protocol_stack_id=ps-contested-logistics-sustainment-stack-v1`.
- Alternate: `tool_suite_id=ts-polar-routing-v1` with `protocol_stack_id=ps-arctic-mobility-stack-v1`.
