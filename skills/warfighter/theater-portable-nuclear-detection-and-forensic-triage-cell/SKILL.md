---
name: theater-portable-nuclear-detection-and-forensic-triage-cell
description: Support expeditionary portable nuclear and radiological detection triage with evidentiary-grade forensic coordination. Use when commanders must rapidly classify, isolate, and route suspect nuclear signatures.
---
...
Primary products for this skill: portable detection triage matrix, forensic sample custody plan, isolation-and-transfer branch card.
...
- Add `tool_suite_id=ts-portable-nuclear-detection-forensic-triage-v1` + `protocol_stack_id=ps-portable-nuclear-detection-forensic-triage-stack-v1` when producing critical recommendations for this mission domain.
