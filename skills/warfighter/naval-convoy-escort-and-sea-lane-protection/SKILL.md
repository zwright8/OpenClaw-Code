---
name: naval-convoy-escort-and-sea-lane-protection
description: Plan convoy escort and sea lane protection missions for contested maritime routes. Use when balancing escort force packages, routing risk, and response posture.
---
...
1. Frame the mission problem using these core inputs: convoy composition, threat intelligence, escort availability, route weather.
...
Primary products for this skill: convoy protection plan, escort assignment matrix, response playbook.
...
- Prioritize these tools or protocol families for this domain: maritime C2 systems, AIS/NMEA, Link 16 J-series.
