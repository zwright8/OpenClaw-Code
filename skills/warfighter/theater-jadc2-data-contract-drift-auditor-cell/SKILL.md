---
name: theater-jadc2-data-contract-drift-auditor-cell
description: Audit and correct JADC2 mission data contract drift across joint and coalition systems. Use when U.S. commanders need trusted machine-to-machine decision support despite schema mismatch, stale transforms, or releasability drift.
---
...
Primary products for this skill: JADC2 schema drift scorecard, contract remediation plan, releasability and translation exception board.

## Domain Tool Stack

Use these tool categories as the baseline stack: data contract registries, schema validation services, mission data brokers, cross-domain guard telemetry.

## Protocol Profile

Preferred protocol families for this skill: JC3IEDM, USMTF, VMF, Link 16 J-series, protobuf/JSON schema governance.
