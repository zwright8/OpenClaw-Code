---
name: joint-undersea-glider-barrier-and-chokepoint-surveillance-cell
description: Coordinate joint deployment and sustainment of undersea glider surveillance barriers across chokepoints in contested maritime environments.
---
...
Primary products for this skill: undersea barrier placement plan, glider sortie and recharge schedule, chokepoint alert escalation card.
...
- For this domain, prioritize `ts-undersea-glider-barrier-v1` with `ps-undersea-glider-barrier-stack-v1` and `DPL-UNDERSEA-GLIDER-BARRIER-001`.
