---
name: coalition-expeditionary-morgue-overflow-management-cell
description: Support coalition military planning for temporary morgue overflow management and dignified remains handling during mass-casualty surges. Use when mortuary capacity, chain-of-custody, and repatriation timelines are stressed.
---
...
Primary products for this skill: overflow remains disposition matrix, temporary capacity expansion plan, chain-of-custody assurance tracker.

## U.S. Warfighter Employment Notes

- Prioritize dignified handling, legal compliance, and family-notification synchronization while preserving operational tempo under casualty surges.
...
- For this domain, prioritize `ts-expeditionary-morgue-overflow-v1` with `ps-expeditionary-morgue-overflow-stack-v1` and `DPL-EXPEDITIONARY-MORGUE-OVERFLOW-001`.
