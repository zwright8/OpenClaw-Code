---
name: joint-cognitive-electronic-attack-counter-influence-cell
description: Support U.S. warfighter planning and decision support for Joint Cognitive Electronic Attack Counter Influence Cell. Use when missions require cognitive-electronic influence detection, adversary narrative disruption, and cross-domain response synchronization, integrated options, and protocol-aware staff outputs.
---

# Joint Cognitive Electronic Attack Counter Influence Cell
...
Primary products for this skill: influence-threat ladder, counter-influence branch plan, information-electromagnetic effects ledger.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: OSINT aggregation suites, EW event timelines, social graph analytics, cyber threat intelligence brokers.

## Protocol Profile

Preferred protocol families for this skill: STIX/TAXII, CoT, API/JSON.
...
- Start with tool_suite_id=ts-cognitive-electromagnetic-influence-defense-v1 and protocol_stack_id=ps-cognitive-electromagnetic-influence-defense-stack-v1, then branch only when mission constraints require it.
