---
name: expeditionary-hypersonic-threat-shelter-reposition-cell
description: Coordinate expeditionary force sheltering and rapid reposition options under hypersonic threat warning windows. Use when warfighters must compress warning-to-action timelines for survivability.
---

# Expeditionary Hypersonic Threat Alert and Shelter Reposition Cell
...
Primary products for this skill: hypersonic warning action matrix, shelter reposition sequence board, survivability branch trigger card.
...
- Add `tool_suite_id=ts-expeditionary-hypersonic-threat-shelter-reposition-v1` + `protocol_stack_id=ps-expeditionary-hypersonic-threat-shelter-reposition-stack-v1` when producing critical recommendations for this mission domain.
