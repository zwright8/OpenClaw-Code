---
name: expeditionary-civil-engineering-prime-power-cell
description: Coordinate expeditionary utility restoration and prime-power generation for austere bases and critical host-nation infrastructure. Use when synchronizing generators, grid tie-ins, and infrastructure repair priorities.
---
...
1. Frame the mission problem using these core inputs: damage assessment, power demand by mission node, generation assets and fuel status, engineer availability.
...
Primary products for this skill: critical-load restoration sequence, prime-power allocation matrix, repair timeline with branch points.
