---
name: coalition-jadc2-schema-translation-and-validation-cell
description: Support coalition JADC2 schema translation and validation for multi-domain command data exchange. Use when allied systems need lossless translation, releasability controls, and machine-readable validation gates.
---
...
Primary products for this skill: schema translation matrix, data-loss risk ledger, coalition validation release packet.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-jadc2-schema-assurance-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Preferred protocol families: API/JSON, USMTF, NATO APP-11/ADatP-3.
...
- Default packet IDs: DPL-JADC2-SCHEMA-001, DPL-COAL-FIRES-001.
