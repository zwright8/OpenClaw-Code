---
name: joint-autonomous-firebreak-and-wildland-base-defense-cell
description: Coordinate autonomous and human teams for wildfire containment around military bases and ranges. Use when climate-driven fires threaten mission continuity.
---

# Joint Autonomous Firebreak and Wildland Base Defense Cell
...
1. Frame the mission problem using these core inputs: fire spread projections, base critical asset map, autonomous platform availability, evacuation thresholds.
...
Primary products for this skill: firebreak defense plan, base-continuity risk branches, civil-military coordination packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: wildfire incident command systems, autonomous suppression coordination tools, base resilience dashboards.

## Protocol Profile

Preferred protocol families for this skill: NIMS/ICS, OGC, USMTF, API/JSON.
