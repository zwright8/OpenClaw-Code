---
name: acquisition-and-contracting-support
description: Support urgent acquisition and contracting for operations. Use when translating capability gaps into executable requirements, market research tasks, and contract-ready statements.
---
...
1. Frame the mission problem using these core inputs: capability gap statement, required timeline, funding constraints, supportability needs.
...
Primary products for this skill: acquisition action plan, requirement package outline, contracting risk notes.
