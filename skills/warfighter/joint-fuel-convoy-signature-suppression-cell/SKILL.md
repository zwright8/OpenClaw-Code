---
name: joint-fuel-convoy-signature-suppression-cell
description: Support U.S. warfighter planning and operational decision support for Joint Fuel Convoy Signature Suppression Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
Primary products for this skill: infrastructure survivability plan, sustainment service continuity matrix, degraded utility operations branch package.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: utility telemetry systems, sustainment C2 tools, engineering ops dashboards, logistics monitoring tools.
...
- Prefer these protocol families for this skill: API/JSON, OGC, USMTF.
