---
name: homeland-defense-rail-fuel-water-node-cascading-failure-cell
description: Anticipate and mitigate cascading failures across rail, fuel, and water nodes supporting homeland defense mobilization. Use when infrastructure interdependencies create compound mission risk.
---
...
Primary products for this skill: cascading-failure dependency map, critical-node stabilization order, mobilization continuity branch plan.
...
- Default to `tool_suite_id=ts-rail-fuel-water-cascading-failure-v1` and `protocol_stack_id=ps-rail-fuel-water-cascading-failure-stack-v1` for mission-critical recommendations in this domain.
