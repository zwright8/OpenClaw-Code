---
name: coalition-human-machine-teaming-roe-assurance-cell
description: Support coalition rules-of-engagement and legal compliance assurance for human-machine teaming operations. Use when autonomous and human-in-the-loop actions require auditable ROE traceability.
---
...
Primary products for this skill: ROE traceability matrix, coalition approval escalation map, autonomous action audit packet

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-coalition-human-machine-roe-assurance-v1 and protocol_stack_id=ps-coalition-human-machine-roe-assurance-stack-v1.
- Primary tools for this domain: ROE policy engines, coalition approval workflow systems, autonomy decision audit ledgers
