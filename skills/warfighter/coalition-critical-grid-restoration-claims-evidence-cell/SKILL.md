---
name: coalition-critical-grid-restoration-claims-evidence-cell
description: Assemble auditable operational evidence for coalition grid restoration decisions, cost-share claims, and legal accountability.
---
...
- Use packet template `DPL-COALITION-GRID-CLAIMS-EVIDENCE-001` from `../_shared/references/domain-tool-packet-library.md`.
- Bind tool and protocol choices to `ts-coalition-grid-claims-evidence-v1` and `ps-coalition-grid-claims-evidence-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Align execution profile with `coalition-grid-claims-evidence-v1` from `../_shared/references/joint-operations-external-toolchain-profiles.md`.
...
- Primary: `tool_suite_id=ts-coalition-grid-claims-evidence-v1` with `protocol_stack_id=ps-coalition-grid-claims-evidence-stack-v1`.
...
- Default packet ID: `DPL-COALITION-GRID-CLAIMS-EVIDENCE-001`.
