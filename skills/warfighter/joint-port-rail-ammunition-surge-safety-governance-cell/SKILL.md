---
name: joint-port-rail-ammunition-surge-safety-governance-cell
description: Govern explosive safety and custody controls during high-tempo port-rail ammunition surge operations.
---
...
- Primary: `tool_suite_id=ts-port-rail-ammunition-surge-safety-v1` with `protocol_stack_id=ps-port-rail-ammunition-surge-safety-stack-v1`.
...
- Default packet IDs: `DPL-PORT-RAIL-AMMUNITION-SURGE-SAFETY-001`.
