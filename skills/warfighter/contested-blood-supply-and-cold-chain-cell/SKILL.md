---
name: contested-blood-supply-and-cold-chain-cell
description: Optimize blood product routing, storage integrity, and transfusion readiness in disrupted theaters.
---

# Contested Blood Supply and Cold Chain Cell
...
Primary products for this skill: blood availability dashboard, cold-chain breach response plan, transfusion readiness forecast.
...
- Suggested tools: blood bank LIS, medevac manifests, IoT temperature sensors, airlift schedules, trauma registry feeds.
- Protocol/message standards: HL7 v2, FHIR, GS1 EPCIS, USMTF.
