---
name: underwater-uncrewed-systems-mission-control
description: Plan and coordinate uncrewed underwater vehicle missions for ISR, mine countermeasures, and infrastructure inspection. Use when assigning UUV sorties and recovery plans.
---
...
1. Frame the mission problem using these core inputs: mission objectives, UUV endurance, seabed hazards, comms constraints.
...
Primary products for this skill: UUV sortie plan, recovery and handoff matrix, sensor collection schedule.
...
- Prioritize these tools or protocol families for this domain: UUV control systems, API/JSON, AIS/NMEA.
