---
name: homeland-rail-grid-cyber-physical-evacuation-priority-cell
description: Synchronize rail and power-grid restoration priorities to protect evacuation corridors during homeland crisis response.
---
...
Primary products: evacuation priority ladder, rail-grid restoration queue, civil-military branch packet.
...
- Primary: `tool_suite_id=ts-homeland-rail-grid-cyber-physical-evacuation-priority-v1` with `protocol_stack_id=ps-homeland-rail-grid-cyber-physical-evacuation-priority-stack-v1`.
...
- Default packet IDs: `DPL-HOMELAND-RAIL-GRID-CYBER-PHYSICAL-EVACUATION-PRIORITY-001`.
