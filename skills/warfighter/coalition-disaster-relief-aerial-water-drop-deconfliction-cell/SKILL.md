---
name: coalition-disaster-relief-aerial-water-drop-deconfliction-cell
description: Deconflict coalition aerial water-drop operations with military air tasking during wildfire and disaster-response contingencies.
---
...
- Primary: `tool_suite_id=ts-coalition-aerial-water-drop-deconfliction-v1` with `protocol_stack_id=ps-coalition-aerial-water-drop-deconfliction-stack-v1`.
...
- Default packet IDs: `DPL-COALITION-AERIAL-WATER-DROP-DECONFLICTION-001`.
