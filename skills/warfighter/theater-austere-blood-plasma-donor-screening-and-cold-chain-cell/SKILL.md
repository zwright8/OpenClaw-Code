...
description: Support U.S. warfighter planning and decision support for austere blood/plasma donor screening, contamination risk control, and cold-chain continuity in contested theaters. Use when missions require integrated options, tool-protocol bindings, and authority-gated staff outputs.
---
...
Primary products for this skill: donor-screening confidence ladder, plasma cold-chain survivability matrix, casualty-support packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: donor screening decision engines, plasma cold-chain telemetry fusion boards, medical distribution surge planners.
...
- Prefer these protocol families for this skill: HL7/FHIR, USMTF, NIEM, API/JSON.
...
- Alternate: tool_suite_id=ts-expeditionary-rare-blood-plasma-assurance-v1 with protocol_stack_id=ps-expeditionary-rare-blood-plasma-assurance-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-AUSTERE-BLOOD-PLASMA-SCREENING-001, DPL-AUSTERE-BLOOD-PLASMA-SCREENING-002.
