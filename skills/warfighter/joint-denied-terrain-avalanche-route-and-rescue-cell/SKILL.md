---
name: joint-denied-terrain-avalanche-route-and-rescue-cell
description: Manage avalanche-threatened mobility corridors and rescue operations in denied mountain terrain. Use when convoy, patrol, or medevac routes face dynamic avalanche risk and degraded communications.
---
...
Primary products for this skill: avalanche mobility corridor risk board, route closure and reroute matrix, denied-terrain rescue synchronization plan.
...
- Prioritize tool_suite_id=ts-denied-terrain-avalanche-route-rescue-v1 + protocol_stack_id=ps-denied-terrain-avalanche-route-rescue-stack-v1 when mountain operations require synchronized route assurance and rapid rescue under weather and communication denial.
- Add packet_id=DPL-DENIED-TERRAIN-AVALANCHE-ROUTE-RESCUE-001 for recommendation branches that alter convoy timing, helicopter lift windows, or rescue force composition.
