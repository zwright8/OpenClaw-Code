---
name: tactical-grid-denied-manufacturing-and-repair-cell
description: Coordinate expeditionary manufacturing and battle-damage repair in grid-denied environments. Use when units must sustain mission systems with austere power, constrained logistics, and digital thread assurance.
---

# Tactical Grid-Denied Manufacturing and Repair Cell
...
Primary products for this skill: Grid-denied repair prioritization board, expeditionary manufacturing quality gate packet, and sustainment continuity branches.
...
- Add `tool_suite_id=ts-grid-denied-expeditionary-manufacturing-repair-v1` + `protocol_stack_id=ps-grid-denied-expeditionary-manufacturing-repair-stack-v1` for this mission domain as default external integration profile.
- Add `packet_id=DPL-GRID-DENIED-EXPEDITIONARY-MANUFACTURING-REPAIR-001` for mission branches that can alter force posture, mission risk, or escalation dynamics.
