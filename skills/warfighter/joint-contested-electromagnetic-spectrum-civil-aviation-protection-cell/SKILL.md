---
name: joint-contested-electromagnetic-spectrum-civil-aviation-protection-cell
description: Protect civil aviation and military flight safety in contested electromagnetic environments. Use when EW interference, spoofing, or civilian air corridor risks require rapid joint deconfliction.
---
...
1. Frame the mission problem using these core inputs: spectrum interference map, civil and military flight routes, EW threat emitters, GNSS integrity status, airspace restrictions.
...
Primary products for this skill: civil-aviation protection plan, spectrum deconfliction execution order, flight-safety risk trigger matrix.
...
- Add `tool_suite_id=ts-contested-spectrum-civil-aviation-protection-v1` + `protocol_stack_id=ps-contested-spectrum-civil-aviation-protection-stack-v1` when this domain is mission-critical in current planning.
- Add `packet_id=DPL-CONTESTED-SPECTRUM-CIVIL-AVIATION-001` for branches that can materially alter mission posture or civil-protection outcomes.
