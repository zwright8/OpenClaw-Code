---
name: joint-portable-nuclear-detector-network-resilience-cell
description: Maintain distributed portable nuclear detector coverage, trust, and rapid reconstitution under contested conditions.
---
...
Primary products for this skill: detector coverage resilience map, anomaly triage board, rapid reconstitution task matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-portable-nuclear-detector-resilience-v1` with `protocol_stack_id=ps-portable-nuclear-detector-resilience-stack-v1`.
- Alternate: `tool_suite_id=ts-cbrn-consequence-v1` with `protocol_stack_id=ps-cbrn-consequence-stack-v1`.
...
- Default packet IDs: DPL-PORTABLE-NUCLEAR-DETECTOR-RESILIENCE-001.
