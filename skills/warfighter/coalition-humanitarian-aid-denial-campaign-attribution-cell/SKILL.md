---
name: coalition-humanitarian-aid-denial-campaign-attribution-cell
description: Attribute coordinated campaigns denying humanitarian aid access and propose protected aid-corridor restoration options.
---
...
Primary products for this skill: attribution confidence brief, aid-corridor risk map, restoration trigger matrix.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: OSINT influence analytics, convoy incident ledgers, humanitarian corridor coordination tools.
- Preferred protocol profiles for coordination and machine exchange: NIMS/ICS, API/JSON, USMTF.
