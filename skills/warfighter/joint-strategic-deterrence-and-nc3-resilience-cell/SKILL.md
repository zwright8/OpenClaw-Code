---
name: joint-strategic-deterrence-and-nc3-resilience-cell
description: Support U.S. warfighter planning and decision support for strategic deterrence and NC3 resilience. Use when missions require escalation control, strategic messaging integrity, resilient command pathways, and continuity under strategic attack conditions.
---
...
Primary products for this skill: deterrence signaling option set, NC3 continuity branch matrix, strategic escalation containment decision packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: NC3 path-monitoring systems, strategic warning fusion tools, cryptographic key custody systems, assured messaging channels.
...
- Prefer these protocol families for this skill: USMTF, ACP-127, Link 16 J-series, STIX/TAXII.
...
- Primary: tool_suite_id=ts-strategic-deterrence-nc3-resilience-v1 with protocol_stack_id=ps-strategic-deterrence-nc3-resilience-stack-v1.
- Alternate: tool_suite_id=ts-strategic-hardened-fiber-nc3-failover-assurance-v1 with protocol_stack_id=ps-strategic-hardened-fiber-nc3-failover-assurance-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-DETERR-NC3-001, DPL-DETERR-ESCALATION-CONTROL-001.
