---
name: joint-mission-assurance-digital-twin-red-cell
description: Support U.S. warfighter planning and decision support for Joint Mission Assurance Digital Twin Red Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: digital twin adversarial test report, mission-thread integrity risk matrix, commander assurance decision packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: mission digital twin simulators, red-team model attack harnesses, readiness evidence and trust scoring systems.
