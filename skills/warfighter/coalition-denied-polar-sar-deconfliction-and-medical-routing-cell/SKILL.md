---
name: coalition-denied-polar-sar-deconfliction-and-medical-routing-cell
description: Coordinate denied-environment polar search-and-rescue with medical routing and coalition deconfliction across sparse communications. Use when warfighters and partners must recover personnel in Arctic/Antarctic conditions under contested access.
---
...
Primary products: polar SAR deconfliction board, casualty route confidence ladder, multinational recovery packet.
...
- Primary: `tool_suite_id=ts-polar-sar-medical-routing-v1 with protocol_stack_id=ps-polar-sar-medical-routing-stack-v1`.
- Alternate: `tool_suite_id=ts-medical-force-health-v1 with protocol_stack_id=ps-medical-evac-regulation-stack-v1`.
...
- Default packet IDs: DPL-MED-TRIAGE-001, DPL-MARITIME-SUBSEA-001, DPL-COALITION-TRAINREADY-001.
