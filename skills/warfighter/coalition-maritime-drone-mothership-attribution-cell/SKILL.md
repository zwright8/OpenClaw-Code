---
name: coalition-maritime-drone-mothership-attribution-cell
description: Support coalition attribution of maritime drone mothership networks that enable proxy attacks and deniable harassment campaigns.
---

# Coalition Maritime Drone Mothership Attribution Cell
...
- Primary: `tool_suite_id=ts-maritime-drone-mothership-attribution-v1` with `protocol_stack_id=ps-maritime-drone-mothership-attribution-stack-v1`.
- Alternate: `tool_suite_id=ts-maritime-interdiction-v1` with `protocol_stack_id=ps-maritime-chokepoint-contraband-interdiction-stack-v1`.
...
- Default packet IDs: DPL-MARITIME-DRONE-MOTHERSHIP-ATTRIBUTION-001, DPL-MARITIME-CHOKEPOINT-CONTRABAND-INTERDICTION-001.
