---
name: contested-electromagnetic-fratricide-prevention-cell
description: Prevent friendly electromagnetic fratricide across jamming, sensing, and communication operations in dense spectrum battlespaces.
---
...
Primary products for this skill: fratricide risk matrix, emissions deconfliction order, EMCON decision triggers.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: spectrum assignment tools, EW planners, emitter identity services, blue-force comms monitors.
- Preferred protocol profiles for coordination and machine exchange: Link 16 J-series, VMF, USMTF, API/JSON.
