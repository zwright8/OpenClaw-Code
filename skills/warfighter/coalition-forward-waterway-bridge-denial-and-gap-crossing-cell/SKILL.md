---
name: coalition-forward-waterway-bridge-denial-and-gap-crossing-cell
description: Plan coalition waterway bridge denial and friendly gap crossing synchronization under fire. Use when maneuver tempo relies on crossing-site survivability and deception timing.
---

# Coalition Forward Waterway Bridge Denial And Gap Crossing Cell
...
- Use packet template DPL-GAP-CROSSING-DENIAL-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-waterway-bridge-denial-gap-crossing-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-waterway-bridge-denial-gap-crossing-v1 with protocol_stack_id=ps-waterway-gap-crossing-stack-v1.
...
- Default packet ID: DPL-GAP-CROSSING-DENIAL-001.
