---
name: theater-rapid-airbase-decoy-and-deception-layout-cell
description: Support U.S. warfighter planning for rapid airbase decoy layout and deception pattern management. Use when adversary ISR threatens sortie generation and base survivability.
---
...
Primary products for this skill: airbase decoy disposition plan, adversary ISR misdirection matrix, deception effectiveness tracker.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-airfield-recovery-v1` with `protocol_stack_id=ps-air-tasking-deconfliction-stack-v1`.
...
- Preferred tools: airfield status dashboards, decoy/signature simulation tools, ISR change-detection services, force-protection overlays.
- Preferred protocol families: AIXM/FIXM, Link 16 J-series, USMTF.
...
- Default packet IDs: DPL-EMSIG-LIFECYCLE-001, DPL-KILLWEB-MAP-001.
