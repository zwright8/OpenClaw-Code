---
name: joint-ocean-forecast-anti-submarine-acoustic-advantage-cell
description: Fuse oceanographic forecasting with ASW planning to maximize acoustic advantage and sensor effectiveness. Use when thermal layers, salinity shifts, and seabed effects materially change ASW prosecution outcomes.
---
...
1. Frame the mission problem using these core inputs: oceanographic model outputs, sonar performance predictions, adversary submarine activity, sensor deployment posture, and weather impacts.
...
Primary products for this skill: acoustic advantage forecast brief, ASW sensor placement recommendation, prosecution timing window matrix.
...
- Primary: `tool_suite_id=ts-ocean-acoustic-asw-v1` with `protocol_stack_id=ps-geo-maritime-stack-v1`.
