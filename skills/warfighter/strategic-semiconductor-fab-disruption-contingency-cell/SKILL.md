---
name: strategic-semiconductor-fab-disruption-contingency-cell
description: Plan defense-priority semiconductor continuity under sabotage, sanctions, or natural disruption affecting mission systems.
---
...
Primary products for this skill: fab disruption impact map, defense-priority allocation board, alternate sourcing decision tree.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-semiconductor-fab-contingency-v1` with `protocol_stack_id=ps-semiconductor-fab-contingency-stack-v1`.
- Alternate: `tool_suite_id=ts-strategic-supply-shock-v1` with `protocol_stack_id=ps-counterfeit-parts-assurance-stack-v1`.
...
- Default packet IDs: DPL-SEMICONDUCTOR-FAB-CONTINGENCY-001.
