---
name: joint-high-altitude-electromagnetic-pulse-consequence-cell
description: Assess high-altitude EMP effects and coordinate mission continuity, infrastructure hardening, and phased restoration actions across theater systems. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: emp consequence dependency map, phased restoration action matrix, mission continuity priority list.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: infrastructure dependency graph tools, grid and telecom status dashboards, mission system readiness monitors, restoration planning systems.
- Prioritize these protocol families for this domain: USMTF, API/JSON, STIX/TAXII, NIMS/ICS.
