---
name: homeland-precision-agriculture-food-security-mobilization-cell
description: Support homeland food-security mobilization through precision agriculture telemetry, logistics allocation, and sabotage resilience.
---

# Homeland Precision Agriculture Food Security Mobilization Cell
...
- Primary: `tool_suite_id=ts-homeland-precision-ag-food-mobilization-v1` with `protocol_stack_id=ps-homeland-precision-ag-food-mobilization-stack-v1`.
- Alternate: `tool_suite_id=ts-strategic-supply-shock-v1` with `protocol_stack_id=ps-strategic-food-water-stability-stack-v1`.
...
- Default packet IDs: DPL-HOMELAND-PRECISION-AG-FOOD-MOBILIZATION-001, DPL-CEMA-BDA-001.
