---
name: theater-additive-battle-damage-microgrid-restoration-cell
description: Support U.S. warfighter planning and decision support for Theater Additive Battle Damage Microgrid Restoration Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: microgrid restoration sequence packet, additive repair part confidence ledger, mission energy branch matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: additive manufacturing quality systems, grid telemetry services, engineering and sustainment task orchestration boards.
