---
name: homeland-defense-critical-ports-rail-fuel-synchronization-cell
description: Synchronize ports, rail, and bulk fuel movement for homeland defense surge deployment under disruption. Use when force-flow continuity depends on cross-network sustainment coordination.
---
...
Primary products for this skill: port-rail-fuel synchronization matrix, force-flow bottleneck forecast, restoration branch trigger board

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-homeland-port-rail-fuel-sync-v1 and protocol_stack_id=ps-homeland-port-rail-fuel-sync-stack-v1.
- Primary tools for this domain: port throughput control systems, rail movement planners, fuel depot telemetry and convoy schedulers
- Required exchange protocols/formats for this domain: NIMS/ICS, USMTF, AIS/NMEA, API/JSON
