---
name: joint-battlefield-power-generation-signature-management-cell
description: Support U.S. warfighter battlefield power-generation posture and signature management. Use when energy resilience, thermal/acoustic signature, and sustainment exposure must be balanced.
---
...
Primary products for this skill: power-node signature map, generator dispatch and concealment matrix, sustainment exposure report.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-power-signature-management-v1` with `protocol_stack_id=ps-power-signature-management-stack-v1`.
- Alternate: `tool_suite_id=ts-gridload-blackstart-fuel-v1` with `protocol_stack_id=ps-gridload-blackstart-fuel-stack-v1`.
...
- Default packet IDs: DPL-POWER-SIG-MGMT-001, DPL-GRID-BLACKSTART-001.
