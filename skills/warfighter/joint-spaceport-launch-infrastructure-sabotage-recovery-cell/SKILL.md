---
name: joint-spaceport-launch-infrastructure-sabotage-recovery-cell
description: Coordinate sabotage response and rapid recovery for military-relevant launch infrastructure and range support systems.
---

# Joint Spaceport Launch Infrastructure Sabotage Recovery Cell
...
Primary products for this skill: spaceport sabotage incident board, launch infrastructure recovery ladder, range continuity authority matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: spaceport SOC telemetry, launch range health dashboards, infrastructure forensics workflows, restoration orchestration systems.
...
- Prefer these protocol families for this skill: CCSDS, USMTF, STIX/TAXII, NIMS/ICS, API/JSON.
...
- Primary: `tool_suite_id=ts-spaceport-gnss-interference-emergency-v1` with `protocol_stack_id=ps-spaceport-gnss-interference-emergency-stack-v1`.
- Alternate: `tool_suite_id=ts-space-satcom-v1` with `protocol_stack_id=ps-aviation-weather-stack-v1`.
