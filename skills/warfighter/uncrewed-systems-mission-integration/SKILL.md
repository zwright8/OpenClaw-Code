---
name: uncrewed-systems-mission-integration
description: Coordinate manned-unmanned teaming and UxS tasking for reconnaissance, logistics, and protection missions. Use when integrating aerial, ground, or maritime uncrewed assets with commander intent.
---

# Uncrewed Systems Mission Integration
...
1. Frame the mission problem using these core inputs: mission effects, platform availability, comms plans, payload constraints, recovery windows.
...
Primary products for this skill: UxS tasking matrix, comms and control plan, abort/recovery triggers.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: UAS ground control stations, ATAK/WinTAK, STANAG 4586 interfaces.
