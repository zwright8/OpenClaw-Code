---
name: homeland-dam-and-levee-defense-support-priority-cell
description: Support U.S. warfighter and DSCA planning for dam and levee defense-support prioritization under flood, sabotage, and cascading infrastructure risk.
---
...
Primary products for this skill: priority-of-life flood defense matrix, engineer deployment sequence, civil-support continuity branch plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: hydrology risk dashboard, critical-infrastructure dependency graph, engineer-force allocation planner, evacuation throughput monitor.
...
- Prefer these protocol families for this skill: NIMS/ICS, CAP/EDXL, API/JSON, USMTF.
