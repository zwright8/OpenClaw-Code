---
name: coalition-strategic-mobilization-rail-port-energy-coupling-cell
description: Integrate rail throughput, port throughput, and energy constraints into coalition strategic mobilization decisions.
---
...
Primary products: mobilization coupling dashboard, chokepoint energy-risk matrix, coalition throughput reallocation plan, and branch trigger map.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-mobilization-rail-port-energy-coupling-v1` with `protocol_stack_id=ps-mobilization-rail-port-energy-coupling-stack-v1`.
...
- Default packet IDs: DPL-MOBILIZATION-COUPLING-001, DPL-PORT-RAIL-ENERGY-BRANCH-001.
