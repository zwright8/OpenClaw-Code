---
name: joint-additive-explosive-traceability-and-counter-diversion-cell
description: Support U.S. warfighter planning and decision support for Joint Additive Explosive Traceability And Counter Diversion Cell. Use when missions require additive explosive chain-of-custody enforcement, lot traceability, and counter-diversion response planning, integrated options, and protocol-aware staff outputs.
---

# Joint Additive Explosive Traceability And Counter Diversion Cell
...
Primary products for this skill: explosive lot provenance ledger, counter-diversion alert board, additive manufacturing compliance packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: munitions inventory systems, additive manufacturing execution systems, forensic trace databases, EOD task trackers.

## Protocol Profile

Preferred protocol families for this skill: USMTF, API/JSON, STANAG 4427 references.
...
- Start with tool_suite_id=ts-additive-explosive-traceability-v1 and protocol_stack_id=ps-additive-explosive-traceability-stack-v1, then branch only when mission constraints require it.
