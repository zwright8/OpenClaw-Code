---
name: expeditionary-rare-fuel-substitution-and-engine-compatibility-cell
description: Support U.S. warfighter planning and operational decision support for Expeditionary Rare Fuel Substitution And Engine Compatibility Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---

# Expeditionary Rare Fuel Substitution And Engine Compatibility Cell
...
Primary products for this skill: fuel substitution decision matrix, engine compatibility register, mission endurance impact board.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: fuel quality labs, engine maintenance systems, readiness analytics tools, logistics control towers.
...
- Prefer these protocol families for this skill: API/JSON, USMTF, NATO APP-11/ADatP-3.
