---
name: joint-solar-storm-radiation-force-posture-cell
description: Synchronize force-protection posture and mission timing under severe solar storm radiation and space-weather disruption conditions.
---
...
Primary products for this skill: solar storm force-posture board, radiation exposure risk matrix, mission timing deferral branch triggers.
...
- Add `tool_suite_id=ts-solar-storm-radiation-force-posture-v1` + `protocol_stack_id=ps-solar-storm-radiation-force-posture-stack-v1` when producing critical recommendations for this mission domain.
