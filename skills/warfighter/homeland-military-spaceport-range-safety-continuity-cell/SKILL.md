---
name: homeland-military-spaceport-range-safety-continuity-cell
description: Preserve homeland military spaceport range safety and launch continuity during cyber, weather, and sabotage stress.
---

# Homeland Military Spaceport Range Safety Continuity Cell
...
1. Frame the mission problem using these core inputs: range safety telemetry, launch countdown events, weather holds, and critical infrastructure status.
...
Primary products for this skill: range safety continuity matrix, launch hold/release decision packet, recovery and reconstitution sequence.
...
## Domain Toolchain Override (2026-03-09, Homeland Spaceport Range Safety Continuity)

- Prioritize `tool_suite_id=ts-homeland-spaceport-range-safety-continuity-v1` with `protocol_stack_id=ps-homeland-spaceport-range-safety-continuity-stack-v1` for this mission set when indicators exceed baseline risk thresholds.
- Use packet `DPL-HOMELAND-SPACEPORT-RANGE-SAFETY-CONTINUITY-001` to bind machine-ingestible tasking fields, commander decision prompts, and degraded-mode controls.
