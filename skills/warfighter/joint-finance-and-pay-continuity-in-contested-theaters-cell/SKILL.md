---
name: joint-finance-and-pay-continuity-in-contested-theaters-cell
description: Sustain military finance and pay continuity for deployed forces operating with degraded connectivity and disrupted payment rails. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: pay continuity branch plan, disbursement risk map, reconciliation task board.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: pay and entitlements systems, disconnected payment reconciliation services, treasury disbursement trackers, fraud-monitoring analytics.
- Prioritize these protocol families for this domain: API/JSON, USMTF, STIX/TAXII.
