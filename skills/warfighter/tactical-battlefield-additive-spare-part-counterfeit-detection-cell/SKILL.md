---
name: tactical-battlefield-additive-spare-part-counterfeit-detection-cell
description: Detect counterfeit additive spares and protect tactical maintenance release decisions in austere environments.
---
...
- Primary: `tool_suite_id=ts-additive-spare-counterfeit-detection-v1` with `protocol_stack_id=ps-additive-spare-counterfeit-detection-stack-v1`.
...
- Default packet IDs: `DPL-ADDITIVE-SPARE-COUNTERFEIT-DETECTION-001`.
