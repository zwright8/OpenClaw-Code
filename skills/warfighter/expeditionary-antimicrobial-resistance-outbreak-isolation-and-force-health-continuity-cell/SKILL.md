---
name: expeditionary-antimicrobial-resistance-outbreak-isolation-and-force-health-continuity-cell
description: Support U.S. warfighter planning for Expeditionary Antimicrobial Resistance Outbreak Isolation and Force Health Continuity Cell.
---
...
Use these tool categories by default: field microbiology surveillance boards, isolation corridor planners, and force-health continuity allocators.

## Protocol Profile

Preferred protocol families for this skill: HL7/FHIR, USMTF, NIMS/ICS, NIEM, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-EXPEDITIONARY-ANTIMICROBIAL-RESISTANCE-OUTBREAK-ISOLATION-FORCE-HEALTH-CONTINUITY-001 for critical recommendations.
