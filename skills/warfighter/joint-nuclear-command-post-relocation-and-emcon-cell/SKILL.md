---
name: joint-nuclear-command-post-relocation-and-emcon-cell
description: Plan NC3-adjacent command post relocation and electromagnetic-control posture under strategic warning and contested sensing pressure.
---
...
Primary products for this skill: relocation decision matrix, EMCON posture ladder, continuity handoff timeline.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: NC3 status monitors, RF emission-control analyzers, relocation movement command boards.
