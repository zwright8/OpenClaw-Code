---
name: tactical-vertical-lift-landing-zone-obstacle-clearance-cell
description: Support rapid helicopter and tiltrotor landing zone obstacle detection and clearance planning in contested terrain. Use when forces must open, verify, and sustain LZs under time pressure.
---
...
Primary products for this skill: LZ obstacle threat board, clearance sequence matrix, alternate LZ branch packet

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-vertical-lift-lz-obstacle-clearance-v1 and protocol_stack_id=ps-vertical-lift-lz-obstacle-clearance-stack-v1.
- Primary tools for this domain: UAS LZ reconnaissance feeds, terrain obstacle extraction services, assault aviation mission boards
- Required exchange protocols/formats for this domain: USMTF, VMF, CoT, OGC WMS/WFS/WMTS, API/JSON
