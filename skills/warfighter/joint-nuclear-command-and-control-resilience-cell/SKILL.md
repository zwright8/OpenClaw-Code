---
name: joint-nuclear-command-and-control-resilience-cell
description: Protect strategic command and control continuity under cyber, kinetic, and electromagnetic disruption. Use when validating NC3 fallback paths, execution assurance, and decision latency controls.
---

# Joint Nuclear Command And Control Resilience Cell
...
1. Frame the mission problem using these core inputs: nc3 topology, execution authority pathways, timing posture, and communications survivability.
...
Primary products for this skill: nc3 resilience posture brief, continuity branch matrix, decision latency risk register.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: nc3 path integrity monitors, EMP and cyber disruption simulators, authenticated order-chain verification boards.

## Protocol Profile

Preferred protocol families for this skill: USMTF, API/JSON, Link 16 J-series, hardened voice and data failover profiles.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-nc3-resilience-and-order-integrity-v1` with `protocol_stack_id=ps-nc3-resilience-and-order-integrity-stack-v1`.
- Alternate:   `tool_suite_id=ts-denied-pnt-timing-holdover-v1` with `protocol_stack_id=ps-denied-pnt-timing-holdover-stack-v1`.
...
- Default packet IDs: DPL-NC3-RESILIENCE-ORDER-INTEGRITY-001, DPL-DENIED-PNT-TIMING-HOLDOVER-001.
