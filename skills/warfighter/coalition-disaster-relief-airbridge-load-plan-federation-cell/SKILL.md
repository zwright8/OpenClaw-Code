---
name: coalition-disaster-relief-airbridge-load-plan-federation-cell
description: Support U.S. warfighter planning and decision support for coalition disaster relief airbridge load plans, airport throughput, and humanitarian prioritization.
---
...
Primary products for this skill: airbridge load federation matrix, sortie and cargo priority ladder, host-nation coordination packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: air mobility planners, humanitarian demand mapping tools, airfield throughput dashboards, coalition logistics reconciliation boards.
...
- Prefer these protocol families for this skill: NATO APP-11/ADatP-3, USMTF, API/JSON.
