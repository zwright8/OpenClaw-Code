---
name: joint-counter-wmd-site-neutralization-cell
description: Plan integrated operations to isolate, neutralize, and exploit WMD-related sites while controlling escalation, contamination, and evidence integrity. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: wmd site neutralization concept of support, contamination and exploitation control matrix, escalation and legal review decision log.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: wmd intelligence fusion platforms, CBRN hazard modeling tools, sensitive site exploitation tracking systems, legal-policy workflow dashboards.
- Prioritize these protocol families for this domain: USMTF, EDXL-DE/CAP, STIX/TAXII, NATO APP-11/ADatP-3 aligned.
