---
name: joint-pow-mia-and-missing-persons-fusion-cell
description: Fuse reporting and recovery planning for POW/MIA and missing personnel in joint and coalition operations. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: missing persons fusion brief, recovery prioritization board, case confidence ledger.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: personnel accountability systems, forensic and recovery case tools, geospatial clue fusion platforms, diplomatic coordination trackers.
