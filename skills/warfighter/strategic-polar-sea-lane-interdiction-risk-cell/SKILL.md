---
name: strategic-polar-sea-lane-interdiction-risk-cell
description: Support U.S. warfighter planning and operational decision support for Strategic Polar Sea Lane Interdiction Risk Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: sea-lane traffic data, adversary posture, weather and ice conditions, strategic sustainment priorities.
...
Primary products for this skill: polar lane threat forecast, convoy risk index, strategic reroute recommendation pack.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: maritime COP tools, AIS analytics, ISR correlation tools, weather and ice forecast systems.
...
- Prefer these protocol families for this skill: AIS/NMEA, Link 16 J-series, USMTF.
