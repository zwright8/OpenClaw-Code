---
name: quantum-resistant-tactical-network-transition-cell
description: Plan transition of tactical and operational network paths toward quantum-resistant cryptographic posture. Use when mission networks need phased crypto agility and interoperability under contested conditions.
---
...
1. Frame the mission problem using these core inputs: current cryptographic inventory, platform crypto constraints, coalition interoperability requirements, and mission comms criticality.
...
Primary products for this skill: crypto migration readiness board, phased transition timeline, interoperability risk register.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: key management systems, network management telemetry, coalition interoperability validation tools.
...
- Prefer these protocol families for this skill: USMTF, API/JSON, STIX/TAXII, NATO APP-11/ADatP-3.
