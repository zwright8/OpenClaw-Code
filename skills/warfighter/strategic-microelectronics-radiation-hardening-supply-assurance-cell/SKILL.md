---
name: strategic-microelectronics-radiation-hardening-supply-assurance-cell
description: Support strategic warfighter assurance for radiation-hardened microelectronics supply continuity. Use when mission-critical space, missile, and C2 systems face component shortages or tampering risk.
---
...
Primary products for this skill: rad-hard component risk board, substitute-part approval matrix, mission-impact restoration sequence.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-radhard-microelectronics-assurance-v1` with `protocol_stack_id=ps-radhard-microelectronics-assurance-stack-v1`.
- Alternate: `tool_suite_id=ts-additive-feedstock-authenticity-v1` with `protocol_stack_id=ps-munitions-quality-escape-stack-v1`.
...
- Default packet IDs: DPL-RADHARD-SUPPLY-001, DPL-MUNI-QESC-001.
