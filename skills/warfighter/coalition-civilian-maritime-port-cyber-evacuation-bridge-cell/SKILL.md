---
name: coalition-civilian-maritime-port-cyber-evacuation-bridge-cell
description: Bridge civilian maritime evacuation operations through cyber-disrupted port infrastructure. Use when port systems are degraded and evacuation throughput must be sustained with coalition coordination.
---
...
Primary products for this skill: port cyber evacuation bridge plan, throughput continuity board, civilian embarkation risk timeline.
...
- Default to `tool_suite_id=ts-maritime-port-cyber-evacuation-bridge-v1` and `protocol_stack_id=ps-maritime-port-cyber-evacuation-bridge-stack-v1` for mission-critical recommendations in this domain.
