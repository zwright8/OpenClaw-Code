---
name: expeditionary-small-modular-reactor-siting-and-force-protection-cell
description: Support expeditionary SMR siting, protection, and emergency consequence planning for deployed forces. Use when U.S. commands evaluate nuclear microreactor basing, logistics, and layered defense in contested theaters.
---
...
Primary products for this skill: SMR siting risk matrix, force protection ring plan, emergency shutdown and consequence playbook.

## Domain Tool Stack

Use these tool categories as the baseline stack: infrastructure geospatial models, force protection COP tools, radiological monitoring dashboards, logistics sustainment planners.

## Protocol Profile

Preferred protocol families for this skill: USMTF, CBRN warning formats, ICS/NIMS interfaces, STANAG 2103, secure SCADA telemetry.
