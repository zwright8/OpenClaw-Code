---
name: weather-driven-mission-risk-nowcasting-cell
description: Generate near-real-time weather and environmental mission-risk updates for dynamic execution decisions. Use when rapidly changing conditions can invalidate current plans.
---
...
1. Frame the mission problem using these core inputs: nowcast weather feeds, terrain mobility impact data, sensor performance impacts, sortie/route windows.
...
Primary products for this skill: nowcast mission risk board, weather-triggered branch criteria, task reprioritization schedule.
...
- Prioritize these tools or tool families for this domain: weather prediction systems, terrain analytics tools, air/maritime planning systems, COP tools.
- Specify outbound exchange format for recommendations and tasking: USMTF, OGC WMS/WFS/WMTS, API/JSON.
