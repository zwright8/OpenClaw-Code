---
name: theater-rapid-camouflage-decoy-inflatable-emplacement-cell
description: Plan rapid emplacement of camouflage and inflatable decoys to dilute adversary ISR and targeting effectiveness.
---
...
Primary products for this skill: decoy emplacement scheme, ISR deception timing plan, adversary targeting dilution estimate.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: deception planning tools, terrain/imagery overlays, logistics staging trackers, ISR pattern analyzers.
- Preferred protocol profiles for coordination and machine exchange: USMTF, OGC, API/JSON, CoT.
