---
name: joint-cyber-physical-dam-spillway-sabotage-and-downstream-evacuation-sync-cell
description: Support U.S. warfighter planning for cyber-physical dam spillway sabotage response and downstream evacuation synchronization.
---
...
Use these tool categories by default: dam telemetry integrity boards, spillway release consequence modelers, and evacuation synchronization workflows.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-JOINT-CYBER-PHYSICAL-DAM-SPILLWAY-SABOTAGE-DOWNSTREAM-EVACUATION-SYNC-001 for critical recommendations.
