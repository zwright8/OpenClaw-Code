---
name: theater-airfield-damage-assessment-and-rapid-repair-cell
description: Assess runway and airfield damage and prioritize rapid repair sequencing to restore sortie generation. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: runway recovery plan, repair prioritization board, sortie regeneration forecast.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: airfield inspection imagery pipelines, repair resource schedulers, runway friction/surface status tools, engineering COP dashboards.
