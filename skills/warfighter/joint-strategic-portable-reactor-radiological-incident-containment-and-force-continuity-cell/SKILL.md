---
name: joint-strategic-portable-reactor-radiological-incident-containment-and-force-continuity-cell
description: Support U.S. warfighter planning for portable-reactor radiological incident containment and force continuity under contested conditions.
---
...
Use these tool categories by default: portable-reactor telemetry fusion boards, radiological plume consequence modelers, and force-continuity decision ladders.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-JOINT-STRATEGIC-PORTABLE-REACTOR-RADIOLOGICAL-CONTAINMENT-FORCE-CONTINUITY-001 for critical recommendations.
