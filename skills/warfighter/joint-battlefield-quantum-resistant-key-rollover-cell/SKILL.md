---
name: joint-battlefield-quantum-resistant-key-rollover-cell
description: Coordinate battlefield cryptographic rollover to quantum-resistant keying without losing mission tempo or coalition interoperability. Use when warfighters must execute urgent key transitions across joint and coalition networks.
---
...
Primary products: crypto rollover branch map, key-compromise exposure log, cross-domain key transition packet.
...
- Primary: `tool_suite_id=ts-quantum-resistant-key-transition-v1 with protocol_stack_id=ps-quantum-resistant-key-transition-stack-v1`.
- Alternate: `tool_suite_id=ts-nc3-resilience-v1 with protocol_stack_id=ps-cross-domain-key-material-continuity-stack-v1`.
...
- Default packet IDs: DPL-CYBER-ICAM-001, DPL-NC3-CONTINUITY-001, DPL-COALITION-CUSTODY-001.
