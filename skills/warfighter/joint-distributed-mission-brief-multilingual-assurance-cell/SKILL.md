...
description: Assure mission-brief translation fidelity and intent preservation across distributed multilingual teams. Use when degraded communications and coalition diversity increase command misunderstanding risk.
---
...
Primary products for this skill: multilingual mission-brief fidelity scorecard, intent drift register, and dissemination branch plan.
...
- Bind recommendations to tool_suite_id=ts-joint-distributed-mission-brief-multilingual-assurance-cell-v1 and protocol_stack_id=ps-joint-distributed-mission-brief-multilingual-assurance-cell-stack-v1.
- Use packet templates in ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-MISSION-BRIEF-MULTI-001 for critical recommendations.
- Prioritize these protocol families for this domain: USMTF, NIEM, APP-11/ADatP-3 aligned, API/JSON.
