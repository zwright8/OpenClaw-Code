---
name: strategic-hyperspectral-decoy-detection-and-camouflage-assurance-cell
description: Detect decoy campaigns and camouflage drift using hyperspectral analytics to protect strike confidence and deception resilience.
---
...
Primary products for this skill: hyperspectral anomaly map, decoy confidence ledger, camouflage control order.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-hyperspectral-decoy-detection-v1` with `protocol_stack_id=ps-hyperspectral-decoy-detection-stack-v1`.
- Alternate: `tool_suite_id=ts-intel-fusion-v1` with `protocol_stack_id=ps-imagery-denial-fallback-stack-v1`.
...
- Default packet IDs: DPL-HYPERSPECTRAL-DECOY-DETECTION-001.
