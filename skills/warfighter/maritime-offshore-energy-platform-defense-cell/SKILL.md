---
name: maritime-offshore-energy-platform-defense-cell
description: Support U.S. warfighter planning and operational decision support for Maritime Offshore Energy Platform Defense Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: platform status, maritime traffic patterns, threat indicators, response timelines.
...
Primary products for this skill: platform defense posture board, sabotage risk matrix, quick-reaction force synchronization brief.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: maritime security systems, infrastructure telemetry, undersea sensor feeds, response force tasking tools.
...
- Prefer these protocol families for this skill: AIS/NMEA, API/JSON, USMTF.
