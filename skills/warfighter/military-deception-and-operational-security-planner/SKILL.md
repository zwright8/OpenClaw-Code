---
name: military-deception-and-operational-security-planner
description: Develop deception and OPSEC support plans to protect friendly intent and induce adversary misallocation. Use when planning narrative, signature, and force-posture deception actions.
---
...
1. Frame the mission problem using these core inputs: commander objectives, adversary collection focus, friendly signatures, disclosure risks.
...
Primary products for this skill: deception support plan, OPSEC critical information list, assessment framework.
...
- Prioritize these tools or protocol families for this domain: planning tools with MISO analytics, USMTF, API/JSON.
