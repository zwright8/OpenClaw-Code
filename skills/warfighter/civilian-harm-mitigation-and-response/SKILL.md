---
name: civilian-harm-mitigation-and-response
description: Assess and mitigate civilian harm risk in operational planning and post-strike review. Use when commanders need alternatives, precautions, and documented proportionality/risk tradeoffs.
---
...
1. Frame the mission problem using these core inputs: target context, civilian pattern-of-life, timing windows, collateral constraints, legal policy guidance.
...
Primary products for this skill: civilian harm risk estimate, mitigation options, post-action incident review template.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: ISR analytics tools, legal workflow systems, GCCS-J/COP layers.
