---
name: air-defense-artillery-fire-control-cell
description: Coordinate short-to-high altitude air defense engagements and sensor-shooter pairing. Use when planning ADA coverage, engagement authority sequencing, and protected asset defense timelines.
---
...
1. Frame the mission problem using these core inputs: threat tracks, defended asset list, weapon readiness, engagement authorities.
...
Primary products for this skill: engagement matrix, defended asset priority board, weapon control status plan.
...
- Prioritize these tools or protocol families for this domain: IBCS/FAAD C2, Link 16 J-series, USMTF.
