---
name: contested-electronic-warfare-order-of-battle-refresh-cell
description: Support U.S. warfighter planning for rapid electronic-order-of-battle refresh under contested sensing. Use when emitter identity drift, adversary adaptation, and EW targeting confidence require rapid recalibration.
---
...
Primary products for this skill: emitter confidence ladder, EW order-of-battle refresh queue, retasking trigger matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-ew-order-of-battle-refresh-v1` with `protocol_stack_id=ps-ew-emitter-identity-stack-v1`.
- Alternate: `tool_suite_id=ts-spectrum-governance-v1` with `protocol_stack_id=ps-electromagnetic-management-stack-v1`.
...
- Default packet IDs: DPL-EW-EOB-REFRESH-001, DPL-EW-WAVE-001.
