---
name: coalition-disinformation-enabled-bank-run-stability-support-cell
description: Support coalition mission continuity against disinformation-driven bank-run dynamics affecting liquidity, procurement, and pay operations.
---
...
Primary products: disinformation-financial incident confidence map, liquidity continuity plan, and stability support decision matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-disinformation-bank-run-stability-support-v1` with `protocol_stack_id=ps-disinformation-bank-run-stability-support-stack-v1`.
...
- Default packet IDs: `DPL-DISINFORMATION-BANK-RUN-STABILITY-001`, `DPL-COALITION-LIQUIDITY-CONTINUITY-001`.
