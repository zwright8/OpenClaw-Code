---
name: tactical-maritime-unmanned-logistics-corridor-cell
description: Orchestrate unmanned maritime logistics corridor operations in contested littorals. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: unmanned vessel availability, littoral threat map, resupply priorities, weather/sea state.
...
Primary products for this skill: maritime logistics corridor plan, risk-based routing, resupply synchronization order.
