---
name: joint-orbital-debris-reentry-population-risk-mitigation-cell
description: Support U.S. and coalition planning for orbital debris reentry population-risk mitigation and force protection. Use when reentry uncertainty, warning timelines, and civil-military coordination must be synchronized.
---
...
Primary products for this skill: reentry risk corridor map, warning and shelter trigger ladder, force-posture mitigation branch plan.

## U.S. Warfighter Employment Notes

- Prioritize transparent warning windows and protective posture adjustments when uncertain debris reentry paths threaten U.S. or partner populations.
...
- For this domain, prioritize `ts-orbital-reentry-population-risk-v1` with `ps-orbital-reentry-population-risk-stack-v1` and `DPL-ORBITAL-REENTRY-POPULATION-RISK-001`.
