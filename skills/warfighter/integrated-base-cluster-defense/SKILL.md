---
name: integrated-base-cluster-defense
description: Develop integrated defense plans for clusters of bases and support nodes. Use when synchronizing surveillance, quick reaction forces, and passive protection measures.
---

# Integrated Base Cluster Defense
...
1. Frame the mission problem using these core inputs: base layout, threat assessments, response forces, protective infrastructure.
...
Primary products for this skill: base cluster defense plan, QRF trigger matrix, vulnerability reduction list.
