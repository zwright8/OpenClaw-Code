...
description: Support U.S. warfighter planning and decision support for undersea cable sabotage attribution, forensic custody, and prioritized restoration sequencing.
---
...
Primary products for this skill: cable-sabotage forensic ladder, restoration sequencing matrix, cross-domain continuity authority packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: undersea telemetry fusion boards, maritime anomaly forensics engines, restoration-priority schedulers.
...
- Prefer protocol families: AIS/NMEA, USMTF, STIX/TAXII, NIEM, API/JSON.
...
- Alternate: tool_suite_id=ts-theater-underwater-datacenter-cooling-grid-defense-v1 with protocol_stack_id=ps-theater-underwater-datacenter-cooling-grid-defense-stack-v1.
- Degraded: authenticated voice/readback plus UTC acknowledgment ledger and manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-UNDERSEA-CABLE-SABOTAGE-FORENSICS-001, DPL-UNDERSEA-CABLE-SABOTAGE-FORENSICS-002.
