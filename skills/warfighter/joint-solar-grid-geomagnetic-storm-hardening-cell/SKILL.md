---
name: joint-solar-grid-geomagnetic-storm-hardening-cell
description: Prepare and execute geomagnetic storm protective actions for military installations and critical mission grids. Use when solar activity threatens power continuity and mission systems.
---
...
1. Frame the mission problem using these core inputs: solar weather warning lead times, grid transformer vulnerability map, backup power posture, mission critical load list.
...
Primary products for this skill: geomagnetic storm hardening plan, critical load preservation matrix, grid restoration branch timeline.
...
- Primary: `tool_suite_id=ts-geomagnetic-grid-hardening-v1` with `protocol_stack_id=ps-space-weather-grid-protection-stack-v1`.
- Alternate: `tool_suite_id=ts-energy-physical-cyber-convergence-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
