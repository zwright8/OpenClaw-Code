---
name: expeditionary-camouflage-multispectral-effectiveness-cell
description: Evaluate and optimize multispectral camouflage effectiveness against modern ISR and targeting chains.
---
...
Primary products for this skill: multispectral camouflage assessment, signature reduction options, survivability validation board.
...
- `tool_suite_id`: `ts-multispectral-camouflage-assurance-v1`
- `protocol_stack_id`: `ps-multispectral-camouflage-assurance-stack-v1`
