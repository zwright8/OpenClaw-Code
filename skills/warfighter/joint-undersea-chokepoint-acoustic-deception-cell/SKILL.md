---
name: joint-undersea-chokepoint-acoustic-deception-cell
description: Design acoustic deception postures for undersea chokepoints to protect joint force maneuver and sea-lane access.
---
...
Primary products for this skill: acoustic deception lane plan, adversary cueing disruption matrix, chokepoint risk ladder.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-undersea-acoustic-deception-v1` with `protocol_stack_id=ps-undersea-acoustic-deception-stack-v1`.
...
- Default packet IDs: DPL-UNDERSEA-ACOUSTIC-DECEPTION-001.
