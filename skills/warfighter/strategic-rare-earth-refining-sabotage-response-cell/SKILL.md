---
name: strategic-rare-earth-refining-sabotage-response-cell
description: Assess and coordinate responses to sabotage impacting rare-earth refining essential to defense production.
---
...
Primary products for this skill: refining sabotage impact brief, restoration priority board, strategic material continuity plan.
...
- `tool_suite_id`: `ts-rare-earth-refining-protection-v1`
- `protocol_stack_id`: `ps-rare-earth-refining-response-stack-v1`
