---
name: humanitarian-assistance-disaster-relief-cell
description: Plan humanitarian assistance and disaster relief support operations in austere environments. Use when prioritizing lifesaving support, access routes, and interagency coordination.
---

# Humanitarian Assistance and Disaster Relief Cell
...
1. Frame the mission problem using these core inputs: impact assessment, affected population, access corridors, aid partner capacity.
...
Primary products for this skill: HADR support concept, relief distribution priorities, interagency synchronization board.
