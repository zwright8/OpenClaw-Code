---
name: homeland-wildfire-smoke-military-flight-continuity-cell
description: Preserve military flight operations and mission support during wildfire smoke events by integrating air quality, visibility, and sortie risk controls.
---
...
Primary products for this skill: smoke flight-continuity posture board, sortie viability decision ladder, airfield smoke mitigation branch plan.
...
- Add `tool_suite_id=ts-wildfire-smoke-military-flight-continuity-v1` + `protocol_stack_id=ps-wildfire-smoke-military-flight-continuity-stack-v1` when producing critical recommendations for this mission domain.
