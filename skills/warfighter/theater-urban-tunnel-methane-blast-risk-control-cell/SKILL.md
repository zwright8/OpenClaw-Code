---
name: theater-urban-tunnel-methane-blast-risk-control-cell
description: Reduce casualty and mission risk for urban tunnel operations by integrating methane blast indicators, utility mapping, and route control decisions.
---

# Theater Urban Tunnel Methane Blast Risk Control Cell
...
Primary products for this skill: subsurface methane risk heatmap, tunnel route control board, blast mitigation branch matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: subsurface geospatial mapping tools, utility gas telemetry systems, structural integrity assessment boards, maneuver route risk planners.
...
- Prefer these protocol families for this skill: OGC WMS/WFS/WMTS, VMF, CoT, USMTF, API/JSON.
...
- Primary: `tool_suite_id=ts-urban-subsurface-raid-safety-v1` with `protocol_stack_id=ps-urban-subsurface-raid-safety-stack-v1`.
