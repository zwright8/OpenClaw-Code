...
description: Support U.S. warfighter planning and decision support for expeditionary hydrogen microgrid safety, leak containment, and emissions-signature-aware power continuity. Use when missions require integrated options, tool-protocol bindings, and authority-gated staff outputs.
---
...
Primary products for this skill: hydrogen microgrid safety matrix, leak-response branch ladder, emissions-control continuity packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: fuel-cell telemetry fusion tools, leak plume modeling boards, expeditionary microgrid dispatch planners.
...
- Prefer these protocol families for this skill: USMTF, OGC, NIMS/ICS, API/JSON.
...
- Alternate: tool_suite_id=ts-microgrid-ammonia-blackstart-v1 with protocol_stack_id=ps-microgrid-ammonia-blackstart-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-HYDROGEN-MICROGRID-SAFETY-001, DPL-HYDROGEN-MICROGRID-SAFETY-002.
