---
name: joint-stratospheric-balloon-isr-reconstitution-cell
description: Coordinate stratospheric ISR balloon network reconstitution and retasking under contested conditions. Use when restoring surveillance persistence after losses, weather drift, or adversary attack.
---
...
Primary products for this skill: stratospheric ISR reconstitution plan, payload retasking order, comms relay continuity matrix.
...
- Prioritize tool_suite_id=ts-stratospheric-balloon-isr-reconstitution-v1 + protocol_stack_id=ps-stratospheric-balloon-isr-reconstitution-stack-v1 when layered ISR persistence depends on rapid balloon relay regeneration under contested weather and EW pressure.
- Add packet_id=DPL-STRATOSPHERIC-BALLOON-ISR-RECONSTITUTION-001 for recommendation branches that alter ISR coverage rings, SATCOM relay dependencies, or recovery sortie tasking.
