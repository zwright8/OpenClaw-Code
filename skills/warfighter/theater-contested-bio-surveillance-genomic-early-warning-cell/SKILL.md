---
name: theater-contested-bio-surveillance-genomic-early-warning-cell
description: Coordinate contested-theater biosurveillance and genomic early warning for force-health and operational continuity. Use when pathogen drift, lab integrity, and distributed sampling must be fused quickly.
---

# Theater Contested Bio Surveillance Genomic Early Warning Cell
...
- Use packet template DPL-GENOMIC-EARLY-WARNING-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-biosurveillance-genomic-warning-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-biosurveillance-genomic-warning-v1 with protocol_stack_id=ps-biosurveillance-genomic-stack-v1.
...
- Default packet ID: DPL-GENOMIC-EARLY-WARNING-001.
