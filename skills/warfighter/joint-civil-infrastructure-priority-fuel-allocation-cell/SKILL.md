---
name: joint-civil-infrastructure-priority-fuel-allocation-cell
description: Support U.S. warfighter planning and decision support for Joint Civil Infrastructure Priority Fuel Allocation Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: priority fuel allocation matrix, critical-service sustainment branches, civil-military adjudication packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: fuel distribution command tools, critical infrastructure dependency maps, civil emergency operations dashboards.

## Protocol Profile

Preferred protocol families for this skill: USMTF, NIMS/ICS, API/JSON.
