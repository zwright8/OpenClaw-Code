---
name: strategic-energetics-precursor-counterfeit-intelligence-cell
description: Track and assess counterfeit energetics precursors threatening munitions reliability and safety. Use when industrial and theater inputs suggest adulterated chemical supply exposure.
---
...
Primary products for this skill: precursor counterfeit risk ledger, lot quarantine recommendation board, source disruption options.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-energetics-precursor-counterfeit-v1` with `protocol_stack_id=ps-energetics-precursor-counterfeit-stack-v1`.
...
- Default packet IDs: DPL-ENERGETICS-COUNTERFEIT-001.
