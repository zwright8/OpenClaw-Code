---
name: contested-electromagnetic-signature-management-cell
description: Plan electromagnetic signature reduction and deception for survivability in contested sensing environments. Use when operations require emission-control discipline and dynamic signature management.
---
...
1. Frame the mission problem using these core inputs: platform emission plans, adversary sensing coverage, mission timing windows, and comms priorities.
...
Primary products for this skill: signature management posture card, emission-control branch plan, deception trigger matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: EW planning tools, spectrum monitoring systems, platform emission-control status feeds.
