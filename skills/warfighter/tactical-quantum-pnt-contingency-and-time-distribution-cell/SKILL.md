---
name: tactical-quantum-pnt-contingency-and-time-distribution-cell
description: Support U.S. warfighter mission continuity by planning resilient tactical timing and navigation distribution during degraded or denied GNSS conditions.
---
...
Primary products for this skill: timing holdover posture, PNT confidence ladder, mission timeline compensation matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: inertial and terrain-relative fusion services, resilient time-distribution controllers, timing anomaly adjudication dashboards, maneuver synchronization planners.
...
- Prefer these protocol families for this skill: Link 16 J-series, VMF, API/JSON, OGC.
