---
name: joint-long-range-fires-ammunition-lot-reliability-cell
description: Assess ammunition lot reliability for long-range fires and prioritize safe, mission-capable expenditure plans.
---
...
Primary products for this skill: ammo reliability assessment, lot hold/release matrix, risk-informed expenditure plan.
...
- `tool_suite_id`: `ts-ammo-lot-reliability-v1`
- `protocol_stack_id`: `ps-ammunition-reliability-governance-stack-v1`
