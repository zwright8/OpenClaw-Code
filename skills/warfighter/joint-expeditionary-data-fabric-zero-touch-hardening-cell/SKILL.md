---
name: joint-expeditionary-data-fabric-zero-touch-hardening-cell
description: Harden expeditionary mission data fabrics with zero-touch controls, trust telemetry, and degraded synchronization plans.
---
...
Primary products for this skill: data-fabric hardening priority queue, trust posture dashboard, degraded sync branch matrix.
...
- Alternate: `tool_suite_id=ts-cyber-defense-v1` with `protocol_stack_id=ps-cyber-defense-stack-v1`.
...
- Default packet IDs: DPL-EXPEDITIONARY-DATA-FABRIC-ZERO-TOUCH-HARDENING-001.
