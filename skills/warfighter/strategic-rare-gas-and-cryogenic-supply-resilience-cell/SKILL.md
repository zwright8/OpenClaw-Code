---
name: strategic-rare-gas-and-cryogenic-supply-resilience-cell
description: Protect and reconstitute strategic rare-gas and cryogenic supply chains that underpin defense manufacturing and sensing capabilities. Use when disruptions threaten mission-critical industrial readiness.
---
...
1. Frame the mission problem using these core inputs: industrial production telemetry, inventory posture, transport integrity alerts, demand signals from defense programs.
...
Primary products for this skill: supply resilience options, prioritized allocation plan, industrial recovery timeline.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools or tool families for this domain: industrial operations dashboards, strategic inventory systems, transport monitoring telemetry, sustainment planning tools.
