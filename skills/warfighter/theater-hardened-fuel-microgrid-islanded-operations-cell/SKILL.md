---
name: theater-hardened-fuel-microgrid-islanded-operations-cell
description: Synchronize hardened fuel and microgrid islanded operations for force continuity under infrastructure attack. Use when grid fragmentation and fuel point risk threaten operational tempo.
---
...
Primary products for this skill: fuel and microgrid islanding plan, critical-load continuity matrix, restoration branch trigger timeline.
...
- Default to `tool_suite_id=ts-fuel-microgrid-islanded-ops-v1` and `protocol_stack_id=ps-fuel-microgrid-islanded-ops-stack-v1` for mission-critical recommendations in this domain.
