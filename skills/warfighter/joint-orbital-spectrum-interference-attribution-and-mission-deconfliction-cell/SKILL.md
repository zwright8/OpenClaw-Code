---
name: joint-orbital-spectrum-interference-attribution-and-mission-deconfliction-cell
description: Support U.S. warfighter planning for orbital-spectrum interference attribution and multi-mission deconfliction.
---
...
Use these tool categories by default: orbital RF interference boards, mission-priority deconfliction engines, and space-ground service continuity planners.

## Protocol Profile

Preferred protocol families for this skill: CCSDS, USMTF, STIX/TAXII, NIEM, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-JOINT-ORBITAL-SPECTRUM-INTERFERENCE-ATTRIBUTION-MISSION-DECONFLICTION-001 for critical recommendations.
