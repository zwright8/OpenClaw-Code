---
name: theater-digital-twin-contested-wargame-branch-generator-cell
description: Support U.S. warfighter planning with theater digital twins for contested branch-and-sequel generation. Use when staffs need simulation-backed decision options under fast-changing threat and sustainment conditions.
---
...
Primary products for this skill: digital-twin branch tree, COA stress-test report, commander decision trigger pack.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: theater digital twin environments, simulation orchestrators, campaign assessment dashboards.
- Preferred protocol profile for machine and staff exchange: USMTF + API/JSON + OGC.
- Default tool suite binding: `tool_suite_id=ts-theater-digital-twin-wargame-v1`.
- Default protocol stack binding: `protocol_stack_id=ps-digital-twin-branching-stack-v1`.
- Default packet binding: `packet_id=DPL-DIGITAL-TWIN-001`.
