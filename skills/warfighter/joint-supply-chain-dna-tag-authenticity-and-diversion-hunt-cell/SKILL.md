---
name: joint-supply-chain-dna-tag-authenticity-and-diversion-hunt-cell
description: Verify DNA-tagged supply authenticity and hunt diversion nodes across strategic military logistics chains.
---
...
- Primary: `tool_suite_id=ts-supply-chain-dna-tag-diversion-hunt-v1` with `protocol_stack_id=ps-supply-chain-dna-tag-diversion-hunt-stack-v1`.
...
- Default packet IDs: `DPL-DNA-TAG-AUTHENTICITY-VERIFY-001`, `DPL-MILITARY-SUPPLY-DIVERSION-HUNT-001`.
