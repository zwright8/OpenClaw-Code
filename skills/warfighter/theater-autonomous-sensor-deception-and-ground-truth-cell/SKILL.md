---
name: theater-autonomous-sensor-deception-and-ground-truth-cell
description: Detect adversary multi-sensor deception and re-anchor mission decisions to verified ground truth under contested conditions.
---

# Theater Autonomous Sensor Deception And Ground Truth Cell
...
Primary products for this skill: sensor deception confidence ladder, ground-truth adjudication packet, retask trigger matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: multi-INT fusion boards, sensor calibration telemetry, autonomous confidence anomaly detectors.

## Protocol Profile

Preferred protocol families for this skill: USMTF, STIX/TAXII, CoT.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-autonomous-sensor-groundtruth-v1`.
- Alternate: `tool_suite_id=ts-intel-fusion-v1`.
...
- Prefer `tool_suite_id=ts-autonomous-sensor-groundtruth-v1` for primary decision support and bind to mission packet `DPL-SENSOR-GROUNDTRUTH-001`.
- Use `tool_suite_id=ts-intel-fusion-v1` as required cross-check for divergence or trust-score decay.
- Include `packet_id=DPL-SENSOR-GROUNDTRUTH-001`, `protocol_profile`, `ack_chain_status`, and `trust_score` in all commander-facing outputs.
