...
- Add `toolchain_id=TC-MYPAY-366`, `tool_suite_id=ts-joint-mypay-les-allotment-payroll-access-continuity-v1`, and `protocol_stack_id=ps-joint-mypay-les-allotment-payroll-access-continuity-stack-v1` when activation timing or backfill confidence depends on restoring MyPay access, LES correctness, or allotment continuity for affected personnel.
- Add `toolchain_id=TC-REENLIST-367`, `tool_suite_id=ts-joint-reenlistment-selective-retention-bonus-career-field-reclassification-continuity-v1`, and `protocol_stack_id=ps-joint-reenlistment-selective-retention-bonus-career-field-reclassification-continuity-stack-v1` when mobilization viability depends on reenlistment timing, SRB legitimacy, or reclassification path continuity for key billets.
- Add `toolchain_id=TC-BARRDORM-368`, `tool_suite_id=ts-joint-barracks-dorm-work-order-bah-exception-emergency-relocation-continuity-v1`, and `protocol_stack_id=ps-joint-barracks-dorm-work-order-bah-exception-emergency-relocation-continuity-stack-v1` when unsafe barracks or dorms, delayed repairs, or BAH-exception routing change whether members can report or remain mobilized.
- Add `toolchain_id=TC-KITISS-369`, `tool_suite_id=ts-joint-initial-issue-cif-ocie-clothing-record-mobilization-kitting-continuity-v1`, and `protocol_stack_id=ps-joint-initial-issue-cif-ocie-clothing-record-mobilization-kitting-continuity-stack-v1` when mobilization timing depends on clothing-record legitimacy, missing issue, or substitute-kit approval.
- Add `toolchain_id=TC-LEAVE-370`, `tool_suite_id=ts-joint-leave-carryover-special-leave-accrual-sell-back-continuity-v1`, and `protocol_stack_id=ps-joint-leave-carryover-special-leave-accrual-sell-back-continuity-stack-v1` when activation confidence depends on correct leave balances, SLA posture, or sell-back exposure during mobilization or demobilization.
- Add `toolchain_id=TC-PROFILE-371`, `tool_suite_id=ts-joint-duty-limiting-profile-accommodation-nondeployable-code-continuity-v1`, and `protocol_stack_id=ps-joint-duty-limiting-profile-accommodation-nondeployable-code-continuity-stack-v1` when mobilization timing or lawful force flow depends on reconciled duty-limiting profiles, accommodations, or nondeployable-code evidence.
- Add `packet_id=DPL-MYPAY-LES-ALLOTMENT-001`, `packet_id=DPL-REENLISTMENT-SRB-RECLASS-001`, `packet_id=DPL-BARRACKS-DORM-BAH-RELOCATE-001`, `packet_id=DPL-INITIAL-ISSUE-KITTING-001`, `packet_id=DPL-LEAVE-SLA-SELLBACK-001`, and `packet_id=DPL-PROFILE-NONDEPLOY-CODE-001` for branches that materially alter activation timing, lawful force flow, or commander confidence in Reserve or Guard availability.

## Domain Toolchain Override (2026-04-11, Expansion Wave XCI Addendum)

- Add `toolchain_id=TC-IDTRST-374`, `tool_suite_id=ts-reserve-component-idt-rst-at-good-year-continuity-v1`, and `protocol_stack_id=ps-reserve-component-idt-rst-at-good-year-continuity-stack-v1` when mobilization timing or lawful force flow depends on preserved IDT evidence, RST approvals, AT orders, or good-year legitimacy for key personnel.
- Add `toolchain_id=TC-UNIFORM-377`, `tool_suite_id=ts-joint-uniform-replacement-clothing-allowance-serviceability-bridge-v1`, and `protocol_stack_id=ps-joint-uniform-replacement-clothing-allowance-serviceability-bridge-stack-v1` when activation confidence depends on serviceable uniforms, clothing-allowance legitimacy, or rapid replacement of missing duty gear.
- Add `packet_id=DPL-RESERVE-IDT-RST-AT-GOODYEAR-001` and `packet_id=DPL-UNIFORM-REPLACEMENT-ALLOWANCE-SERVICEABILITY-001` for branches that materially alter activation timing, lawful force flow, or commander confidence in Reserve or Guard availability.

## Domain Toolchain Override (2026-04-11, Expansion Wave XCII Addendum)

- Add `toolchain_id=TC-AVPAY-378`, `tool_suite_id=ts-joint-aviation-incentive-pay-aeronautical-order-gate-month-continuity-v1`, and `protocol_stack_id=ps-joint-aviation-incentive-pay-aeronautical-order-gate-month-continuity-stack-v1` when activation timing or mobilization-safe force flow depends on current aeronautical orders, gate-month evidence, or flight-pay legitimacy for Reserve aircrew.
- Add `toolchain_id=TC-HAZPAY-379`, `tool_suite_id=ts-joint-hazardous-duty-jump-dive-special-duty-pay-certification-continuity-v1`, and `protocol_stack_id=ps-joint-hazardous-duty-jump-dive-special-duty-pay-certification-continuity-stack-v1` when mobilization viability depends on jump or dive currency, hazardous-duty certification, or special-duty pay legitimacy for key personnel.
- Add `toolchain_id=TC-PME-380`, `tool_suite_id=ts-joint-professional-military-education-school-seat-waiver-promotion-prerequisite-continuity-v1`, and `protocol_stack_id=ps-joint-professional-military-education-school-seat-waiver-promotion-prerequisite-continuity-stack-v1` when activation, backfill, or command assumption depends on preserved PME prerequisites, seat status, or waiver approval.
- Add `toolchain_id=TC-POLY-381`, `tool_suite_id=ts-joint-security-clearance-polygraph-continuous-vetting-readiness-v1`, and `protocol_stack_id=ps-joint-security-clearance-polygraph-continuous-vetting-readiness-stack-v1` when mobilization timing or mission-access viability depends on resolved polygraph requirements, vetting alerts, or adjudicative backlog.
- Add `toolchain_id=TC-LANG-382`, `tool_suite_id=ts-joint-foreign-language-proficiency-bonus-dlpt-linguist-readiness-continuity-v1`, and `protocol_stack_id=ps-joint-foreign-language-proficiency-bonus-dlpt-linguist-readiness-continuity-stack-v1` when mission-language coverage, DLPT currency, or FLPB legitimacy changes whether a Reserve or Guard linguist can mobilize into the required billet.
- Add `packet_id=DPL-AVIATION-PAY-AERO-ORDER-001`, `packet_id=DPL-HAZDUTY-JUMP-DIVE-CERT-001`, `packet_id=DPL-PME-SCHOOL-SEAT-PREREQ-001`, `packet_id=DPL-POLYGRAPH-CONTINUOUS-VETTING-001`, and `packet_id=DPL-FLPB-DLPT-LINGUIST-001` for branches that materially alter activation timing, lawful force flow, or commander confidence in Reserve or Guard availability.
