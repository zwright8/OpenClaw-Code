---
name: tactical-cbrn-hotzone-robotic-recon-and-marking-cell
description: Coordinate robotic CBRN reconnaissance, contamination boundary marking, and entry-control recommendations in hazardous zones.
---
...
Primary products for this skill: hazard boundary overlay, robotic recon tasking matrix, decon corridor plan.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: CBRN sensor fusion tools, robotic mission controllers, plume/fallout models, hazard sampling ledgers.
- Preferred protocol profiles for coordination and machine exchange: USMTF, OGC, API/JSON, NIMS/ICS.
