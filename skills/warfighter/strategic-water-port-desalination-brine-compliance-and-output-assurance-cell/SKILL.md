---
name: strategic-water-port-desalination-brine-compliance-and-output-assurance-cell
description: Support strategic sustainment planning for military port desalination systems where output reliability and brine-discharge compliance both affect base and coalition endurance.
---
...
Primary products for this skill: desalination output assurance dashboard, brine compliance risk board, emergency water continuity branch matrix.

## U.S. Warfighter Employment Notes

- Prioritize assured potable and process-water output for U.S. and coalition forces without violating host-nation maritime environmental constraints.
...
- For this domain, prioritize `ts-port-desalination-brine-output-assurance-v1` with `ps-port-desalination-brine-output-assurance-stack-v1` and `DPL-PORT-DESALINATION-BRINE-OUTPUT-ASSURANCE-001`.
