---
name: tactical-ship-to-shore-energy-cable-emplacement-protection-cell
description: Plan and protect ship-to-shore expeditionary energy cable emplacement under maritime and littoral threat.
---
...
Primary products for this skill: cable emplacement sequence plan, protection posture matrix, restoration fallback card.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: undersea route survey tools, cable-lay control systems, littoral security COP and patrol planners.
- Preferred protocol profiles for coordination and machine exchange: AIS/NMEA, USMTF, API/JSON.
