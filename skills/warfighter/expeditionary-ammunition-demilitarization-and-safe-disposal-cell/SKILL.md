---
name: expeditionary-ammunition-demilitarization-and-safe-disposal-cell
description: Plan safe demilitarization and disposal of unstable or captured munitions in expeditionary environments. Use when explosive degradation, stockage overflow, or retrograde constraints create urgent disposal requirements.
---
...
1. Frame the mission problem using these core inputs: munition condition codes, disposal site constraints, EOD capacity, environmental restrictions, and host-nation legal limits.
...
Primary products for this skill: demilitarization sequencing order, explosive safety perimeter plan, disposal compliance evidence packet.
...
- Primary: `tool_suite_id=ts-explosive-demil-safety-v1` with `protocol_stack_id=ps-demil-safety-stack-v1`.
