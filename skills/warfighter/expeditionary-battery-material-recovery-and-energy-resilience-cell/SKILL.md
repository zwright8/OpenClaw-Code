---
name: expeditionary-battery-material-recovery-and-energy-resilience-cell
description: Sustain expeditionary operations by recovering battery materials, triaging storage assets, and maintaining microgrid resilience.
---

# Expeditionary Battery Material Recovery And Energy Resilience Cell
...
Primary products for this skill: battery health and recovery board, microgrid continuity branch chart, hazardous-handling compliance packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: battery telemetry systems, expeditionary microgrid controllers, hazardous materials tracking services.

## Protocol Profile

Preferred protocol families for this skill: USMTF, API/JSON, IEEE 2030.5 profiles.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-expeditionary-energy-recovery-v1`.
- Alternate: `tool_suite_id=ts-civil-support-v1`.
...
- Prefer `tool_suite_id=ts-expeditionary-energy-recovery-v1` for primary decision support and bind to mission packet `DPL-EXPEDITIONARY-ENERGY-RECOVERY-001`.
- Use `tool_suite_id=ts-civil-support-v1` as required cross-check for divergence or trust-score decay.
- Include `packet_id=DPL-EXPEDITIONARY-ENERGY-RECOVERY-001`, `protocol_profile`, `ack_chain_status`, and `trust_score` in all commander-facing outputs.
