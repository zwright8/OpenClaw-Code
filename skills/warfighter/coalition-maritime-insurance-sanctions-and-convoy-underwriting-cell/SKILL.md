...
description: Support U.S. warfighter planning and decision support for coalition maritime insurance risk under sanctions pressure, convoy underwriting, and legal-compliant shipping continuity. Use when missions require integrated options, tool-protocol bindings, and authority-gated staff outputs.
---
...
Primary products for this skill: underwriting risk matrix, sanctions-compliance decision ladder, convoy assurance packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: maritime insurance risk engines, sanctions-evasion detection boards, coalition convoy liability planners.
...
- Prefer these protocol families for this skill: NATO APP-11/ADatP-3 aligned, AIS/NMEA, STIX/TAXII, API/JSON.
...
- Alternate: tool_suite_id=ts-coalition-cyber-sanctions-evasion-shipping-interdiction-cell-v1 with protocol_stack_id=ps-coalition-cyber-sanctions-evasion-shipping-interdiction-cell-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-MARITIME-INSURANCE-UNDERWRITE-001, DPL-MARITIME-INSURANCE-UNDERWRITE-002.
