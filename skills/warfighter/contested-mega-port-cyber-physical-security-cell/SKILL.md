---
name: contested-mega-port-cyber-physical-security-cell
description: Integrate cyber and physical defense plans for contested mega-port operations supporting strategic throughput.
---
...
1. Frame the mission problem using these core inputs: port OT/IT alerts, physical security posture, cargo flow priorities, partner agency dependencies.
...
Primary products for this skill: cyber-physical defense synchronization matrix, critical-node defense plan, throughput-risk forecast.
