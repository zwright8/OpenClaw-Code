---
name: counterintelligence-and-insider-threat-cell
description: Support U.S. warfighter planning and decision support for Counterintelligence And Insider Threat Cell. Use when missions require counterintelligence, insider threat detection, and force protection decision support, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: threat network map, insider risk indicator matrix, CI collection synchronization plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: personnel vetting systems, CI case management platforms, intelligence fusion workspaces, insider activity telemetry feeds.
...
- Prefer these protocol families for this skill: STIX/TAXII, USMTF, OGC.
