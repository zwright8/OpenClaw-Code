---
name: contested-joint-force-jadc2-gateway-survivability-cell
description: Plan resilient joint all-domain command-and-control gateway operations under cyber, kinetic, and electromagnetic disruption. Use when mission command depends on degraded or denied network pathways.
---
...
Primary products for this skill: JADC2 pathway survivability matrix, gateway failover execution plan, command continuity risk ladder.
...
- Prioritize these tool/protocol families for this domain: JADC2 gateway orchestration, mission network failover tooling, cryptographic key continuity services.
