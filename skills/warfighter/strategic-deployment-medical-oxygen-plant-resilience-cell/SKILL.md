---
name: strategic-deployment-medical-oxygen-plant-resilience-cell
description: Protect and reconstitute oxygen generation and distribution for deployed hospitals during kinetic and cyber disruption.
---
...
Primary products for this skill: oxygen generation resilience plan, cylinder redistribution matrix, medical demand trigger ladder.

## Tool Suite and Protocol Binding

- Bind tool selection to `ts-medical-oxygen-plant-resilience-v1` and `ps-medical-oxygen-plant-resilience-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Recommended external tools for this domain: oxygen plant telemetry, biomedical maintenance systems, hospital demand dashboards, and logistics routing engines.
- Required protocol families for implementation: HL7 FHIR, DICOM, MQTT over TLS, and NIEM.
