---
name: joint-urban-mass-casualty-drone-resupply-cell
description: Route medical drone resupply in urban mass-casualty operations while balancing airspace safety and treatment priorities.
---
...
Primary products for this skill: urban medical drone corridor plan, casualty resupply prioritization matrix, contested airspace deconfliction board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-urban-mascas-drone-resupply-v1` with `protocol_stack_id=ps-urban-mascas-drone-resupply-stack-v1`.
...
- Default packet IDs: DPL-URBAN-MASCAS-DRONE-RESUPPLY-001.
