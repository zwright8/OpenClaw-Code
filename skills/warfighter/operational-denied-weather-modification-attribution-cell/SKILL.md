---
name: operational-denied-weather-modification-attribution-cell
description: Assess and attribute adversary weather-modification effects that distort flight, ISR, and fires planning.
---

# Operational Denied Weather Modification Attribution Cell
...
1. Frame the mission problem using these core inputs: weather sensor divergence, atmospheric anomaly tracks, mission abort trends, and adversary capability indicators.
...
Primary products for this skill: weather-attribution confidence brief, mission-impact deltas, mitigation and sensor-tasking branches.
...
## Domain Toolchain Override (2026-03-09, Denied Weather Modification Attribution)

- Prioritize `tool_suite_id=ts-denied-weather-modification-attribution-v1` with `protocol_stack_id=ps-denied-weather-modification-attribution-stack-v1` for this mission set when indicators exceed baseline risk thresholds.
- Use packet `DPL-DENIED-WEATHER-MODIFICATION-ATTRIBUTION-001` to bind machine-ingestible tasking fields, commander decision prompts, and degraded-mode controls.
