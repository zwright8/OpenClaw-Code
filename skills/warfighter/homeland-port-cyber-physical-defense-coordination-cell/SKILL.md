---
name: homeland-port-cyber-physical-defense-coordination-cell
description: Coordinate homeland port cyber-physical defense, cargo continuity, and emergency authority escalation in hybrid attack scenarios.
---
...
- Use packet template DPL-HOMELAND-PORT-CYBER-PHYSICAL-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-homeland-port-cyber-physical-defense-coordination-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-homeland-port-cyber-physical-defense-coordination-v1 with protocol_stack_id=ps-homeland-port-cyber-physical-defense-coordination-stack-v1.
...
- Default packet ID: DPL-HOMELAND-PORT-CYBER-PHYSICAL-001.
