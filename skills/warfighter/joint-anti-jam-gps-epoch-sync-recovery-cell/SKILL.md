---
name: joint-anti-jam-gps-epoch-sync-recovery-cell
description: Recover denied PNT timing coherence for joint operations under anti-jam and spoofing pressure.
---
...
Primary products for this skill: epoch recovery matrix, alternate timing source ladder, PNT confidence branch table.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-anti-jam-gps-epoch-recovery-v1` with `protocol_stack_id=ps-anti-jam-gps-epoch-stack-v1`.
- Alternate: `tool_suite_id=ts-vertical-datum-reconciliation-v1` with `protocol_stack_id=ps-vertical-datum-reconciliation-stack-v1`.
...
- Default packet IDs: DPL-ANTI-JAM-GPS-EPOCH-001.
