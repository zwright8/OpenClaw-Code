---
name: strategic-quantum-resistant-key-rollover-fielding-cell
description: Plan phased deployment of quantum-resistant cryptographic keys and certificates across mission networks. Use when U.S. forces need crypto-agility, backward-compatible interoperability, and controlled cutover sequencing for operational continuity.
---
...
Primary products for this skill: crypto rollover phasing plan, mission-system interoperability exception list, key-custody and revocation timeline.

## Domain Tool Stack

Use these tool categories as the baseline stack: PKI management systems, KMI/key escrow services, certificate telemetry monitors, mission enclave configuration managers.

## Protocol Profile

Preferred protocol families for this skill: X.509 PKI, CNSA 2.0 migration profiles, IPsec/IKEv2, TLS 1.3, ACME/SCEP.
