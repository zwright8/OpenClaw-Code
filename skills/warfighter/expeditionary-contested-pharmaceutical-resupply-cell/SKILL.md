---
name: expeditionary-contested-pharmaceutical-resupply-cell
description: Support U.S. warfighter planning and operational decision support for Expeditionary Contested Pharmaceutical Resupply Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: medical demand signal, transport capacity, cold-chain status, threat and route constraints.
...
Primary products for this skill: critical drug resupply plan, cold-chain survivability matrix, casualty risk mitigation board.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: medical logistics systems, cold-chain telemetry tools, movement control platforms, demand forecasting dashboards.
...
- Prefer these protocol families for this skill: USMTF, API/JSON, HL7/FHIR.
