---
name: coalition-hospital-ship-cyber-physical-triage-cell
description: Synchronize cyber-physical resilience and casualty triage continuity aboard coalition hospital ships.
---

# Coalition Hospital Ship Cyber Physical Triage Cell
...
1. Frame the mission problem using these core inputs: clinical network health, device telemetry alerts, casualty inflow, and maritime mobility constraints.
...
Primary products for this skill: hospital-ship triage continuity matrix, cyber-physical incident branch plan, coalition care-capacity timeline.
...
## Domain Toolchain Override (2026-03-09, Hospital Ship Cyber-Physical Care Continuity)

- Prioritize `tool_suite_id=ts-hospital-ship-cyber-physical-triage-v1` with `protocol_stack_id=ps-hospital-ship-cyber-physical-triage-stack-v1` for this mission set when indicators exceed baseline risk thresholds.
- Use packet `DPL-HOSPITAL-SHIP-CYBER-PHYSICAL-TRIAGE-001` to bind machine-ingestible tasking fields, commander decision prompts, and degraded-mode controls.
