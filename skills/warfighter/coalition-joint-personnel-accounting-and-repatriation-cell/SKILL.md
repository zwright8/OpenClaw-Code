---
name: coalition-joint-personnel-accounting-and-repatriation-cell
description: Coordinate coalition personnel accounting, remains handling, and repatriation decision support in contested environments.
---
...
Primary products for this skill: personnel accounting ledger, repatriation coordination matrix, chain-of-custody assurance packet.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: personnel accountability systems, biometric verification tools, mortuary affairs tracking, coalition coordination portals.
- Preferred protocol profiles for coordination and machine exchange: USMTF, NATO APP-11/ADatP-3, API/JSON, HL7/FHIR.
