---
name: joint-adversarial-ai-sensor-spoofing-forensics-cell
description: Detect and adjudicate adversarial AI-enabled sensor spoofing across joint ISR and fires kill chains in contested theaters.
---
...
- Primary: `tool_suite_id=ts-ai-sensor-spoofing-forensics-v1` with `protocol_stack_id=ps-ai-sensor-spoofing-forensics-stack-v1`.
...
- Default packet IDs: `DPL-AI-SENSOR-SPOOF-001`, `DPL-GHOST-TRACK-ADJUDICATION-001`.
