---
name: tactical-battery-repair-and-recertification-cell
description: Plan and govern field-level battery repair, recertification, and safe redistribution for tactical systems. Use when units need to recover energy-storage readiness during prolonged operations.
---
...
1. Frame the mission problem using these core inputs: battery health telemetry, maintenance logs, safety incidents, demand forecast by unit.
...
Primary products for this skill: battery recovery priority list, recertification schedule, risk-controlled redistribution plan.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools or tool families for this domain: battery management systems, maintenance quality platforms, hazardous material trackers, sustainment dashboards.
