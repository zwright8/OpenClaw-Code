---
name: autonomous-multi-domain-decoy-synchronization-cell
description: Synchronize autonomous decoy employment across air, maritime, land, and electromagnetic domains to shape adversary targeting and decision cycles. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: decoy synchronization employment matrix, adversary response observation plan, branch and sequel deception triggers.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: decoy mission planning software, EMS simulation tools, sensor telemetry fusion dashboards, battle rhythm synchronization boards.
