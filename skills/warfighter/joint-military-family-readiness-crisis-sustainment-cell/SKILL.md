...
- Add `toolchain_id=TC-DLATLE-396`, `tool_suite_id=ts-joint-dislocation-allowance-temporary-lodging-expense-temporary-lodging-allowance-continuity-v1`, and `protocol_stack_id=ps-joint-dislocation-allowance-temporary-lodging-expense-temporary-lodging-allowance-continuity-stack-v1` when family-readiness posture depends on temporary lodging solvency, PCS hold time, or safehaven reimbursement trust.
- Add `toolchain_id=TC-BASMESS-399`, `tool_suite_id=ts-joint-basic-allowance-for-subsistence-meal-card-messing-debt-continuity-v1`, and `protocol_stack_id=ps-joint-basic-allowance-for-subsistence-meal-card-messing-debt-continuity-stack-v1` when household resilience depends on stable food access, BAS legitimacy, or debt-free meal support.
- Add `toolchain_id=TC-SPACEA-400`, `tool_suite_id=ts-joint-space-available-travel-emergency-leave-nonmedical-attendant-priority-continuity-v1`, and `protocol_stack_id=ps-joint-space-available-travel-emergency-leave-nonmedical-attendant-priority-continuity-stack-v1` when crisis support depends on compassionate travel speed, Space-A priority, or bedside movement viability.
- Add `toolchain_id=TC-GEOBACH-401`, `tool_suite_id=ts-joint-geographic-bachelor-housing-exception-separate-rations-continuity-v1`, and `protocol_stack_id=ps-joint-geographic-bachelor-housing-exception-separate-rations-continuity-stack-v1` when split-household strain, separate-rations drift, or housing-exception delay degrades family stability and retention confidence.
- Add `packet_id=DPL-DLA-TLE-TLA-001`, `packet_id=DPL-BAS-MEALCARD-MESS-001`, `packet_id=DPL-SPACEA-EMERGENCY-ATTENDANT-001`, and `packet_id=DPL-GEOBACH-SEPRATS-001` for branches that materially alter family-support posture, household resilience, or commander confidence in household continuity.
...
- Add `toolchain_id=TC-DUALMIL-390`, `tool_suite_id=ts-joint-dual-military-colocation-career-field-alignment-dependent-care-continuity-v1`, and `protocol_stack_id=ps-joint-dual-military-colocation-career-field-alignment-dependent-care-continuity-stack-v1` when family-readiness posture depends on keeping a dual-military household co-located, aligned to compatible assignments, and protected from dependent-care collapse.
- Add `toolchain_id=TC-SOFA-391`, `tool_suite_id=ts-joint-overseas-spouse-work-authorization-host-nation-banking-driver-license-continuity-v1`, and `protocol_stack_id=ps-joint-overseas-spouse-work-authorization-host-nation-banking-driver-license-continuity-stack-v1` when overseas household stability depends on whether a spouse can lawfully work, bank, and drive after movement.
- Add `toolchain_id=TC-TELEHEALTH-392`, `tool_suite_id=ts-joint-cross-state-telehealth-licensure-compact-specialty-access-continuity-v1`, and `protocol_stack_id=ps-joint-cross-state-telehealth-licensure-compact-specialty-access-continuity-stack-v1` when household stability depends on remote specialty-care access rather than local-network recovery.
- Add `packet_id=DPL-DUAL-MIL-COLOCATION-001`, `packet_id=DPL-SPOUSE-WORKAUTH-BANK-DRIVER-001`, and `packet_id=DPL-TELEHEALTH-LICENSURE-SPECIALTY-001` for branches that materially alter family-support posture, household resilience, or retention confidence.
