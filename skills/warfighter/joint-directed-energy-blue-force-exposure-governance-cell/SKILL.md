---
name: joint-directed-energy-blue-force-exposure-governance-cell
description: Govern directed-energy employment risk to friendly forces and critical sensors. Use when DE operations require strict fratricide, safety, and legal checks.
---

# Joint Directed Energy Blue-Force Exposure Governance Cell
...
1. Frame the mission problem using these core inputs: DE system status, blue-force positions, atmospheric propagation, no-strike/protected zones.
...
Primary products for this skill: blue-force exposure ladder, DE safety release matrix, engagement-governance packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: directed-energy mission-control boards, fratricide-risk estimators, sensor protection overlays.
