---
name: joint-rapid-runway-camouflage-and-decoy-emplacement-cell
description: Support U.S. warfighter planning and decision support for runway survivability via rapid camouflage, decoy employment, and reconstitution deception planning.
---
...
Primary products for this skill: runway deception layout plan, decoy emplacement timeline, sortie regeneration survivability estimate.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: airfield damage-assessment systems, decoy effects simulators, ISR signature comparison tools, engineering recovery planners.
...
- Prefer these protocol families for this skill: USMTF, Link 16 J-series, OGC.
