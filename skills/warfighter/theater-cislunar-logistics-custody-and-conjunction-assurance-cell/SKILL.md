---
name: theater-cislunar-logistics-custody-and-conjunction-assurance-cell
description: Coordinate cislunar logistics custody, conjunction-risk screening, and maneuver assurance for U.S. and allied mission continuity under contested space conditions.
---

# Theater Cislunar Logistics Custody and Conjunction Assurance Cell
...
Primary products for this skill: cislunar custody confidence ledger, conjunction-risk branch board, maneuver authority release matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: space-domain awareness services, cislunar ephemeris and conjunction analytics, launch/re-entry schedule boards, mission custody ledgers.
...
- Prefer these protocol families for this skill: CCSDS, USMTF, API/JSON, NIEM.
...
- Primary: `tool_suite_id=ts-joint-cislunar-logistics-interdiction-reconstitution-v1` with `protocol_stack_id=ps-joint-cislunar-logistics-interdiction-reconstitution-stack-v1`.
