---
name: joint-space-launch-debris-reentry-civil-warning-cell
description: Coordinate warning and risk communication for launch debris and reentry hazards across military and civil authorities. Use when launch anomalies or controlled reentries threaten populated corridors or critical infrastructure.
---
...
1. Frame the mission problem using these core inputs: launch/reentry trajectories, debris dispersion models, civil population exposure maps, warning authority posture, and timeline to impact.
...
Primary products for this skill: reentry hazard warning package, civil-military notification timeline, protective action recommendation matrix.
...
- Primary: `tool_suite_id=ts-space-reentry-warning-v1` with `protocol_stack_id=ps-space-reentry-warning-stack-v1`.
- Alternate: `tool_suite_id=ts-space-satcom-v1` with `protocol_stack_id=ps-civil-emergency-stack-v1`.
