---
name: coalition-rapid-ceasefire-violation-evidence-synchronization-cell
description: Support U.S. and coalition warfighter planning for rapid ceasefire-violation evidence synchronization, observer corroboration, and legal release assurance.
---
...
Primary products for this skill: ceasefire incident evidence packet, corroboration confidence matrix, legal release timeline.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: incident geospatial event board, observer report reconciler, chain-of-custody ledger, legal release gate monitor.
...
- Prefer these protocol families for this skill: NIEM, STIX/TAXII, API/JSON, signed evidence manifests.
