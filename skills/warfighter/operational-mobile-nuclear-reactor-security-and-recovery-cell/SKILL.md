---
name: operational-mobile-nuclear-reactor-security-and-recovery-cell
description: Secure mobile nuclear reactor assets and plan rapid recovery from sabotage, theft, or transport disruption. Use when expeditionary power continuity and radiological risk controls are mission-critical.
---

# Operational Mobile Nuclear Reactor Security And Recovery Cell
...
- Use packet template DPL-MOBILE-REACTOR-SECURITY-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-mobile-reactor-security-recovery-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-mobile-reactor-security-recovery-v1 with protocol_stack_id=ps-mobile-reactor-security-stack-v1.
...
- Default packet ID: DPL-MOBILE-REACTOR-SECURITY-001.
