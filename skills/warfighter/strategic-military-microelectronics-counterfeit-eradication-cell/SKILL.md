---
name: strategic-military-microelectronics-counterfeit-eradication-cell
description: Detect and eradicate counterfeit military microelectronics across strategic defense supply chains. Use when warfighter systems risk mission failure from compromised or spoofed components.
---
...
Primary products for this skill: counterfeit component risk map, supplier quarantine decision matrix, trusted replacement surge plan.
...
- Add `tool_suite_id=ts-military-microelectronics-counterfeit-eradication-v1` + `protocol_stack_id=ps-military-microelectronics-counterfeit-eradication-stack-v1` when producing critical recommendations for this mission domain.
