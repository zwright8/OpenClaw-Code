...
description: Govern tactical data schemas and interoperability contracts across edge nodes and mission apps. Use when cross-platform integration errors threaten decision timelines.
---
...
1. Frame the mission problem using these core inputs: message schemas, interface control docs, data quality metrics, producer-consumer dependency map.
...
Primary products for this skill: schema compliance report, interface change board packet, rollback/cutover plan.
...
- Prioritize these tools or tool families for this domain: data fabric registries, API gateways, schema validation services, event bus observability tools.
- Specify outbound exchange format for recommendations and tasking: API/JSON, STIX/TAXII, OGC, USMTF.
