---
name: tactical-data-fabric-schema-governance-cell
description: Govern tactical data fabric schemas and cross-domain mappings for mission systems interoperability. Use when operational data products require stable schema contracts and low-latency federation across enclaves.
---
...
1. Frame the mission problem using these core inputs: current schema versions, producer-consumer dependencies, coalition translation rules, and latency constraints.
...
Primary products for this skill: schema compatibility risk board, migration rollout matrix, cross-domain mapping decision packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: mission data fabrics, schema registries, cross-domain gateways and validation services.
...
- Prefer these protocol families for this skill: API/JSON, OGC, USMTF, NATO APP-11/ADatP-3.
