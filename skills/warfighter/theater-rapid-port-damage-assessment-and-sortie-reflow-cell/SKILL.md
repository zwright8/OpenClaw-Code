---
name: theater-rapid-port-damage-assessment-and-sortie-reflow-cell
description: Support rapid theater port damage assessment and sortie reflow planning. Use when strikes or sabotage disrupt port throughput and commanders need synchronized repair, ship scheduling, and sustainment reflow options.
---
...
Primary products for this skill: port damage severity matrix, throughput reflow plan, repair-and-sortie synchronization board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-port-damage-sortie-reflow-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Preferred protocol families: AIS/NMEA, USMTF, NIMS/ICS.
...
- Default packet IDs: DPL-PORT-REPAIR-001, DPL-PORT-CYPHY-SURGE-001.
