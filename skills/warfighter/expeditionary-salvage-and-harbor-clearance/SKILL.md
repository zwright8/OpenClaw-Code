---
name: expeditionary-salvage-and-harbor-clearance
description: Plan salvage and harbor clearance operations to reopen maritime access. Use when sequencing obstruction removal, dive operations, and port reopening milestones.
---
...
1. Frame the mission problem using these core inputs: port damage assessments, hydrographic survey data, salvage assets, access priorities.
...
Primary products for this skill: harbor clearance sequence, salvage task board, reopening decision timeline.
...
- Prioritize these tools or protocol families for this domain: maritime C2 plus port survey tools, AIS/NMEA, OGC WMS/WFS.
