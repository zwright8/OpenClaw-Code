---
name: joint-theater-battlefield-electromagnetic-pulse-hardening-cell
description: Support U.S. warfighter force protection and mission assurance by prioritizing EMP hardening and rapid restoration across theater systems.
---
...
Primary products for this skill: EMP hardening priority matrix, mission dependency survivability plan, restoration branch packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: E3 vulnerability databases, mission dependency graphs, infrastructure telemetry, restoration orchestration tools.

## Protocol Profile

Preferred protocol families for this skill: USMTF, API/JSON, NIMS/ICS.

## Domain Toolchain Defaults

- Primary: \ with \.\n- Alternate: \ with \.\n- Degraded: mission-essential service hardening checklist with command-approved outage prioritization.
...
- Prefer these protocol families for this skill: USMTF, API/JSON, NIMS/ICS.
