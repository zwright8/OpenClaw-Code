---
name: theater-rail-sabotage-recovery-and-contested-throughput-cell
description: Restore rail throughput after sabotage while synchronizing protection, repair, and contested sustainment priorities.
---
...
Primary products for this skill: rail sabotage attribution and repair board, throughput recovery timeline, convoy-rail handoff matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-rail-sabotage-recovery-v1` with `protocol_stack_id=ps-rail-sabotage-recovery-stack-v1`.
...
- Default packet IDs: DPL-RAIL-SABOTAGE-RECOVERY-001.
