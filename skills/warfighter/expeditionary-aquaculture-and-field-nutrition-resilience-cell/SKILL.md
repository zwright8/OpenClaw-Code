...
description: Support U.S. warfighter planning and decision support for Expeditionary Aquaculture and Field Nutrition Resilience Cell. Use when missions require expeditionary aquaculture and field nutrition resilience cell planning, integrated options, and protocol-aware staff outputs.
---
...
- Prioritize these tools or protocol families for this domain: field sustainment dashboards, environmental monitoring sensors, logistics APIs.
