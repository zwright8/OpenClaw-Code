---
name: expeditionary-aquaculture-and-field-nutrition-resilience-cell
description: Coordinate field feeding, hydration, ration quality, and expeditionary aquaculture fallback options for U.S. warfighters when contested sustainment threatens nutrition resilience and force health.
---
...
- Confirm echelon, operating environment, ration or water constraints, local food-production options, force-health risks, and decision deadlines before recommending action.
- Keep outputs unclassified by default unless explicit handling guidance is provided.

## Workflow

1. Frame the mission problem using ration inventories, caloric demand, hydration status, water quality, local protein-production options, and resupply reliability.
2. Identify assumptions, decision thresholds, and what reporting or indicators would invalidate the current plan.
3. Build primary and alternate options with explicit tradeoffs in nutritional adequacy, food safety, sustainment burden, and operational endurance.
4. Integrate dependencies across joint functions, especially sustainment, preventive medicine, water production, and civil-support coordination.
...
Primary products for this skill: field nutrition resilience scorecard, aquaculture output forecast, sustainment health risk matrix.
...
- Alternate: select a mission-adjacent logistics, force-health, or water-production suite or stack from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md` and explain tradeoffs.
- Degraded: manual ration board with daily hydration checks, hand-logged cold-chain verification, and commander-approved substitution rules.

## Domain Packet Defaults

- Default packet ID: `DPL-FIELD-NUTRITION-001`.
...
- Prioritize these tools or protocol families for this domain: ration quality ledger, hydration and biomonitoring dashboard, aquaculture yield tracker, and water-quality telemetry board.
- State the protocol or message format for outbound coordination (for example `HL7/FHIR`, `OPC UA`, signed sustainment manifests, `API/JSON`, or `USMTF`).
...
- Identify food-safety, cold-chain, water-quality, legal, policy, and coalition interoperability constraints early.
