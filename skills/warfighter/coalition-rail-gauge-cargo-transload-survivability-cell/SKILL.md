---
name: coalition-rail-gauge-cargo-transload-survivability-cell
description: Optimize coalition transload operations across rail gauge breaks under threat. Use when logistics throughput requires survivable handoff sequencing and sabotage-aware routing.
---
...
Primary products for this skill: rail transload survivability matrix, throughput restoration ladder, and coalition cargo-priority packet.
...
- Bind recommendations to tool_suite_id=ts-coalition-rail-gauge-cargo-transload-survivability-cell-v1 and protocol_stack_id=ps-coalition-rail-gauge-cargo-transload-survivability-cell-stack-v1.
- Use packet templates in ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-RAIL-GAUGE-TRANSLOAD-SURVIVE-001 for critical recommendations.
- Prioritize these protocol families for this domain: NATO APP-11/ADatP-3 aligned, USMTF, API/JSON, OGC.
