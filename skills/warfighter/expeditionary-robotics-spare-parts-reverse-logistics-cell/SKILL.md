---
name: expeditionary-robotics-spare-parts-reverse-logistics-cell
description: Support U.S. warfighter maintenance planning for robotics spare-parts reverse logistics and battlefield refurbishment. Use when autonomous systems readiness depends on fast component recovery and recertification.
---
...
Primary products for this skill: robotics cannibalization matrix, reverse-logistics priority queue, readiness recertification packet.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: robotics health telemetry services, maintenance logistics systems, additive-part qualification trackers.
- Preferred protocol profile for machine and staff exchange: USMTF + API/JSON + STANAG.
- Default tool suite binding: `tool_suite_id=ts-robotics-reverse-logistics-v1`.
- Default protocol stack binding: `protocol_stack_id=ps-robotics-maintenance-stack-v1`.
- Default packet binding: `packet_id=DPL-ROBOTICS-RL-001`.
