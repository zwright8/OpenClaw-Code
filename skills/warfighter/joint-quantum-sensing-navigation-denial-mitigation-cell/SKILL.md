---
name: joint-quantum-sensing-navigation-denial-mitigation-cell
description: Support warfighter planning for quantum-sensing-aided navigation and timing resilience when GNSS is denied or spoofed.
---

# Joint Quantum Sensing Navigation Denial Mitigation Cell
...
- Primary: `tool_suite_id=ts-quantum-pnt-denial-mitigation-v1` with `protocol_stack_id=ps-quantum-pnt-denial-mitigation-stack-v1`.
- Alternate: `tool_suite_id=ts-denied-pnt-artillery-survey-alignment-v1` with `protocol_stack_id=ps-denied-pnt-artillery-survey-alignment-stack-v1`.
...
- Default packet IDs: DPL-QUANTUM-PNT-DENIAL-MITIGATION-001, DPL-CEMA-BDA-001.
