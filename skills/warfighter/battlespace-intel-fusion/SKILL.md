---
name: battlespace-intel-fusion
description: Fuse multi-source reporting into actionable intelligence assessments. Use when preparing IPB updates, threat estimates, named area indicators, or collection priorities for operations.
---

# Battlespace Intel Fusion
...
1. Frame the mission problem using these core inputs: SIGINT/HUMINT/OSINT summaries, terrain/weather, enemy doctrine, recent incidents.
...
Primary products for this skill: threat estimate, indicator dashboard, PIR collection plan.
