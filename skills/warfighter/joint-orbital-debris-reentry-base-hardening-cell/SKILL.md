---
name: joint-orbital-debris-reentry-base-hardening-cell
description: Assess orbital-debris reentry threats to bases and prioritize force-protection hardening actions. Use when reentry windows can disrupt installation survivability or mission continuity.
---
...
Primary products for this skill: reentry hazard hardening matrix, critical asset protection timeline, continuity branch recommendations.

## Domain Tool Stack

Use these tool categories as the baseline stack: orbital track fusion services, base vulnerability mappers, shelter readiness and hardening planners.

## Protocol Profile

Preferred protocol families for this skill: CCSDS/TLE, USMTF, signed command manifests.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-orbital-debris-reentry-base-hardening-v1` with `protocol_stack_id=ps-orbital-debris-reentry-base-hardening-stack-v1`.
...
- Default packet IDs: DPL-ORBITAL-DEBRIS-REENTRY-BASE-HARDENING-001, DPL-MULTI-DOMAIN-BATTLE-RHYTHM-FRAGMENT-RECOVERY-001.
