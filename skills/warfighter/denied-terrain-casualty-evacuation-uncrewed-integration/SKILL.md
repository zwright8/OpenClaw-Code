---
name: denied-terrain-casualty-evacuation-uncrewed-integration
description: Integrate uncrewed systems into CASEVAC and medical resupply in denied terrain. Use when evacuation routes are threatened and remote triage must be synchronized.
---
...
Primary products for this skill: Denied-terrain CASEVAC routing board, uncrewed med-resupply queue, triage escalation matrix.
