---
name: joint-military-police-detainee-and-site-security-cell
description: Support U.S. warfighter planning and decision support for military police detainee operations and site security. Use when missions require custody integrity, evidence preservation, transfer governance, and secure detention-site posture decisions.
---
...
Primary products for this skill: detainee custody integrity matrix, detention-site security posture board, evidence and transfer governance packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: biometric enrollment systems, custody-evidence ledgers, site security incident trackers, legal workflow systems.
...
- Prefer these protocol families for this skill: NIEM, CJIS exchange profiles, USMTF, STIX/TAXII.
...
- Primary: tool_suite_id=ts-mp-detainee-site-security-v1 with protocol_stack_id=ps-mp-detainee-site-security-stack-v1.
- Alternate: tool_suite_id=ts-custody-handshake-ledger-v1 with protocol_stack_id=ps-custody-handshake-ledger-stack-v1.
