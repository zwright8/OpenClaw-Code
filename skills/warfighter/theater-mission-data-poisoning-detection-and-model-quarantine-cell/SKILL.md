---
name: theater-mission-data-poisoning-detection-and-model-quarantine-cell
description: Detect mission-data poisoning and quarantine compromised AI models before they corrupt operational decisions. Use when AI-enabled mission systems show suspicious drift or adversarial behavior.
---
...
Primary products for this skill: model trust posture board, poisoned-data containment packet, quarantine and rollback decision matrix

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-mission-data-poisoning-quarantine-v1 and protocol_stack_id=ps-mission-data-poisoning-quarantine-stack-v1.
- Primary tools for this domain: feature-store integrity monitors, model drift detectors, mission AI release governance tools
- Required exchange protocols/formats for this domain: STIX/TAXII, USMTF, API/JSON, signed model-manifest exchange
