---
name: tactical-disconnected-biometric-rules-of-engagement-audit-cell
description: Audit tactical biometric watchlist and ROE alignment in disconnected operations to reduce misidentification and fratricide risk. Use when edge units must make identity-critical decisions with partial synchronization.
---
...
Primary products: edge biometric confidence ladder, ROE alignment exception log, commander identity-risk brief.
...
- Primary: `tool_suite_id=ts-tactical-disconnected-biometric-roe-audit-v1` with `protocol_stack_id=ps-tactical-disconnected-biometric-roe-audit-stack-v1`.
- Alternate: `tool_suite_id=ts-tactical-disconnected-biometric-roe-audit-v1` with `protocol_stack_id=ps-tactical-disconnected-biometric-roe-audit-stack-v1`.
...
- Default packet IDs: DPL-TACTICAL-DISCONNECTED-BIOMETRIC-ROE-AUDIT-001, DPL-TACTICAL-DISCONNECTED-BIOMETRIC-ROE-AUDIT-001.
