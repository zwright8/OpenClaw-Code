---
name: tactical-urban-substation-microgrid-hostage-continuity-cell
description: Support U.S. warfighter planning for urban substation attacks where microgrid continuity and hostage-safety decisions are coupled.
---
...
Use these tool categories by default: urban power topology boards, microgrid islanding controllers, and hostage-safe corridor planners.

## Protocol Profile

Preferred protocol families for this skill: NIMS/ICS, USMTF, CoT, NIEM, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-TACTICAL-URBAN-SUBSTATION-MICROGRID-HOSTAGE-CONTINUITY-001 for critical recommendations.
