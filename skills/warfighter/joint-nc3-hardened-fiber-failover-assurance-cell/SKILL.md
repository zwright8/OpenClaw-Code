---
name: joint-nc3-hardened-fiber-failover-assurance-cell
description: Support joint NC3 continuity via hardened terrestrial fiber failover planning and acknowledgment integrity controls. Use when commanders need resilient NC3 transport branches.
---
...
Primary products for this skill: NC3 fiber failover plan, acknowledgment integrity ledger, continuity decision trigger matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: hardened transport path mapping, timing assurance services, message acknowledgment-chain monitors, failover governance boards.
