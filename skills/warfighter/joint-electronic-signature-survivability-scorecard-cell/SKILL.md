---
name: joint-electronic-signature-survivability-scorecard-cell
description: Score and reduce force-wide electronic signature exposure across domains to preserve survivability and mission tempo.
---
...
Primary products for this skill: electronic signature survivability scorecard, emission discipline branch plan, decoy and EMCON priority matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-electronic-signature-survivability-v1` with `protocol_stack_id=ps-electronic-signature-survivability-stack-v1`.
- Alternate: `tool_suite_id=ts-spectrum-governance-v1` with `protocol_stack_id=ps-ew-fratricide-mitigation-stack-v1`.
...
- Default packet IDs: DPL-ELECTRONIC-SIGNATURE-SURVIVABILITY-001.
