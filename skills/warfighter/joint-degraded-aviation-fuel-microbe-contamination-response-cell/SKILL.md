---
name: joint-degraded-aviation-fuel-microbe-contamination-response-cell
description: Detect and contain microbial contamination in degraded aviation fuel networks while preserving sortie generation safety.
---
...
- Primary: `tool_suite_id=ts-aviation-fuel-microbe-contamination-response-v1` with `protocol_stack_id=ps-aviation-fuel-microbe-contamination-response-stack-v1`.
...
- Default packet IDs: `DPL-AVIATION-FUEL-MICROBE-CONTAMINATION-RESPONSE-001`.
