---
name: electromagnetic-spectrum-operations
description: Coordinate EMS maneuver and spectrum management in contested environments. Use when allocating frequencies, planning EW support, and reducing fratricide risk across units.
---
...
1. Frame the mission problem using these core inputs: spectrum allocations, EW assets, comms plan, interference reports.
...
Primary products for this skill: EMS allocation plan, EW support matrix, interference mitigation steps.
...
- Add `tool_suite_id=ts-theater-spectrum-license-host-nation-regulatory-emissions-continuity-v1` + `protocol_stack_id=ps-theater-spectrum-license-host-nation-regulatory-emissions-continuity-stack-v1` when spectrum maneuver depends on host-nation waivers, regulator acknowledgment, or legal continuity of emergency emissions.
- Add `packet_id=DPL-SPECTRUM-LICENSE-REGULATORY-001` for branches that materially alter emissions release, coalition interoperability, or commander confidence in lawful EMSO posture.
