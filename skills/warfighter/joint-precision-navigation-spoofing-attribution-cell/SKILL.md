---
name: joint-precision-navigation-spoofing-attribution-cell
description: Support U.S. warfighter spoofing attribution and navigation trust decisions. Use when precision-navigation degradation may come from hostile spoofing, interference, or system faults.
---
...
Primary products for this skill: spoofing confidence matrix, navigation trust ladder, mitigation and retask branch plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-nav-spoofing-attribution-v1` with `protocol_stack_id=ps-nav-spoofing-attribution-stack-v1`.
- Alternate: `tool_suite_id=ts-disconnected-time-pnt-holdover-v1` with `protocol_stack_id=ps-polar-orbit-handover-stack-v1`.
...
- Default packet IDs: DPL-NAV-SPOOF-ATTRIB-001, DPL-POLAR-HANDOVER-001.
