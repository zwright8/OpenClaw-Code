---
name: coalition-cross-domain-data-diode-operations-cell
description: Plan and govern coalition information exchange using one-way data diode and cross-domain guard architectures. Use when releasability and assurance requirements demand controlled cross-domain transfer.
---
...
1. Frame the mission problem using these core inputs: classification/releasability profiles, mission data exchange needs, data diode throughput limits, partner caveats, audit requirements.
...
Primary products for this skill: cross-domain exchange control plan, releasability-compliant transfer matrix, assurance and audit evidence packet.
