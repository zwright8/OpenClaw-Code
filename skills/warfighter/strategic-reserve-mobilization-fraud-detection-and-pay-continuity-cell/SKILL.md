---
name: strategic-reserve-mobilization-fraud-detection-and-pay-continuity-cell
description: Preserve reserve-component pay continuity during mobilization surges while identifying fraud and adjudicating entitlement conflicts.
---
...
Primary products: pay continuity order, fraud triage dashboard, and entitlement dispute closure tracker.

## Domain Toolchain Defaults

- Primary: tool_suite_id=ts-reserve-mobilization-pay-anti-fraud-v1 with protocol_stack_id=ps-reserve-mobilization-pay-anti-fraud-stack-v1.
...
- Default packet IDs: DPL-RESERVE-MOBILIZATION-PAY-ANTIFRAUD-001.
