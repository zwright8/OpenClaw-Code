---
name: theater-multi-domain-decoy-inventory-allocator-cell
description: Allocate decoy inventory across air, land, maritime, and cyber domains to maximize adversary misallocation.
---
...
Primary products for this skill: decoy allocation matrix, domain effectiveness scorecard, depletion and replenishment branch table.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-multi-domain-decoy-inventory-v1` with `protocol_stack_id=ps-multi-domain-decoy-inventory-stack-v1`.
- Alternate: `tool_suite_id=ts-ai-camouflage-discipline-audit-v1` with `protocol_stack_id=ps-ai-camouflage-discipline-stack-v1`.
...
- Default packet IDs: DPL-MULTI-DOMAIN-DECOY-INV-001.
