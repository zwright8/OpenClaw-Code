---
name: multi-domain-fog-forecast-and-sensor-confidence-cell
description: Provide U.S. warfighter decision support for Multi Domain Fog Forecast And Sensor Confidence Cell missions, including joint planning outputs, external tool usage, and protocol-aware fallback actions.
---
