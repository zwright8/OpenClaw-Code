---
name: coalition-custody-handshake-ledger-and-detainee-transfer-cell
description: Synchronize coalition detainee transfer custody handshakes with evidence integrity and legal notification timelines.
---
...
Primary products for this skill: custody handshake ledger, transfer readiness and legal hold board, evidence continuity packet.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-custody-handshake-ledger-v1` with `protocol_stack_id=ps-custody-handshake-ledger-stack-v1`.
...
- Default packet IDs: DPL-CUSTODY-HANDSHAKE-LEDGER-001.
