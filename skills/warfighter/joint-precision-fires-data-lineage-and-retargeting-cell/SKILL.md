...
description: Support precision-fires data lineage assurance and retargeting decisions. Use when target data provenance, timing drift, and sensor disagreement affect strike authorization and re-attack decisions.
---
...
Primary products for this skill: fires data lineage graph, retarget decision matrix, re-attack confidence brief.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-fires-data-lineage-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Preferred protocol families: VMF, Link 16 J-series, USMTF.
...
- Default packet IDs: DPL-FIRES-LINEAGE-001, DPL-CEMA-BDA-001.
