---
name: coalition-humanitarian-access-negotiation-and-deconfliction-cell
description: Synchronize coalition military actions with humanitarian corridor negotiation, convoy deconfliction, and protected site assurance.
---

# Coalition Humanitarian Access Negotiation And Deconfliction Cell
...
Primary products for this skill: humanitarian access negotiation board, convoy deconfliction matrix, protected site assurance ledger.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: humanitarian coordination portals, convoy tracking platforms, protected-site geospatial overlays.

## Protocol Profile

Preferred protocol families for this skill: USMTF, OCHA-style HXL mappings, CoT, NATO APP-11/ADatP-3.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-humanitarian-access-deconfliction-v1`.
...
- Prefer `tool_suite_id=ts-humanitarian-access-deconfliction-v1` for primary decision support and bind to mission packet `DPL-HUMANITARIAN-ACCESS-001`.
- Use `tool_suite_id=ts-civil-support-v1` as required cross-check for divergence or trust-score decay.
- Include `packet_id=DPL-HUMANITARIAN-ACCESS-001`, `protocol_profile`, `ack_chain_status`, and `trust_score` in all commander-facing outputs.
