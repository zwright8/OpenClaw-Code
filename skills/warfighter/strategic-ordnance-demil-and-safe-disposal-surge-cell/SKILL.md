---
name: strategic-ordnance-demil-and-safe-disposal-surge-cell
description: Plan surge demilitarization and safe disposal of unstable ordnance lots without collapsing operational ammunition availability.
---
...
Primary products for this skill: demil surge schedule, disposal risk ledger, munitions availability branch matrix.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: ordnance safety incident systems, demil throughput planners, stockpile readiness dashboards.
...
- Default packet binding for this domain: DPL-ORDNANCE-DEMIL-SURGE-001.
