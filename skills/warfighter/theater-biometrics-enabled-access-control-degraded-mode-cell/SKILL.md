---
name: theater-biometrics-enabled-access-control-degraded-mode-cell
description: Maintain access control integrity when biometric systems degrade, are spoofed, or partially fail in theater operations.
---
...
Primary products for this skill: access-control degraded-mode SOP, identity assurance ladder, insider-risk escalation matrix.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: biometric identity systems, watchlist services, badge/access-control logs, insider threat analytics.
- Preferred protocol profiles for coordination and machine exchange: STIX/TAXII, CoT, USMTF, API/JSON.
