---
name: homeland-satcom-ground-station-blackout-restoration-cell
description: Support homeland defense planning for rapid restoration of SATCOM ground station operations during blackouts, sabotage, or grid instability.
---
...
Primary products for this skill: ground-station blackout recovery matrix, continuity-of-control branch ladder, restoration authority checklist.
...
- For this domain, prioritize `ts-satcom-ground-blackout-restoration-v1` with `ps-satcom-ground-blackout-restoration-stack-v1` and `DPL-SATCOM-GROUND-BLACKOUT-RESTORATION-001`.
