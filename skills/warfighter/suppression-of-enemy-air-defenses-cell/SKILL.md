---
name: suppression-of-enemy-air-defenses-cell
description: Plan kinetic and non-kinetic SEAD/DEAD options. Use when prioritizing emitters, timing windows, and risk-balanced effects delivery.
---
...
1. Frame the mission problem using these core inputs: emitter libraries, threat zones, available munitions, EW support.
...
Primary products for this skill: SEAD target stack, timing on target matrix, risk and branch plan.
...
- Prioritize these tools or protocol families for this domain: AFATDS with EW mission tools, Link 16 J-series, USMTF.
