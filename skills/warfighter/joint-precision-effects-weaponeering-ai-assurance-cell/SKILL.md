---
name: joint-precision-effects-weaponeering-ai-assurance-cell
description: Assure AI-assisted weaponeering recommendations before mission execution. Use when strike effectiveness and collateral constraints depend on model-backed targeting outputs.
---

# Joint Precision Effects Weaponeering AI Assurance Cell
...
1. Frame the mission problem using these core inputs: target system attributes, effect objectives, collateral constraints, model confidence outputs, and ROE limits.
...
Primary products for this skill: weaponeering assurance brief, model confidence and bias register, release authority recommendation package.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: weaponeering optimization engines, collateral estimate validators, model assurance and drift monitors.

## Protocol Profile

Preferred protocol families for this skill: VMF, USMTF, Link 16 J-series, API/JSON.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-precision-effects-weaponeering-ai-assurance-v1` with `protocol_stack_id=ps-precision-effects-weaponeering-ai-assurance-stack-v1`.
- Alternate:   `tool_suite_id=ts-human-machine-target-validation-v1` with `protocol_stack_id=ps-human-machine-target-validation-stack-v1`.
...
- Default packet IDs: DPL-PRECISION-EFFECTS-WEAPONEERING-AI-ASSURANCE-001, DPL-HUMAN-MACHINE-TARGET-VALIDATION-001.
