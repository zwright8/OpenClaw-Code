---
name: coalition-aviation-language-phraseology-assurance-cell
description: Reduce coalition aviation miscommunication risk by standardizing phraseology, call signs, and critical message confirmation loops. Use during mixed-language high-tempo air operations.
---
...
1. Frame the mission problem using these core inputs: coalition language proficiency profiles, phraseology deviations and incidents, mission communication criticality, airspace complexity.
...
Primary products for this skill: coalition phraseology control plan, comms misunderstanding risk matrix, mandatory readback checklist.
...
- Primary: `tool_suite_id=ts-coalition-aviation-phraseology-v1` with `protocol_stack_id=ps-coalition-aviation-phraseology-stack-v1`.
- Alternate: `tool_suite_id=ts-nato-coalition-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
