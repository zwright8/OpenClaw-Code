---
name: strategic-microelectronics-trusted-packaging-chain-of-custody-cell
description: Assure trusted microelectronics packaging and chain-of-custody integrity for mission-critical defense systems.
---
...
Primary products for this skill: trusted packaging provenance ledger, release/hold decision board, counterfeit risk escalation packet.

## Domain Tool Stack

Use these tool categories as the baseline stack: foundry and OSAT quality feeds, tamper-evidence attestation services, supply-chain provenance ledger, mission-impact dependency map.

## Protocol Profile

Preferred protocol families for this skill: STIX/TAXII, EDI X12, USMTF logistics annexes, API/JSON.
...
- Prioritize `tool_suite_id=ts-strategic-microelectronics-trusted-packaging-chain-of-custody-cell-v1` + `protocol_stack_id=ps-strategic-microelectronics-trusted-packaging-chain-of-custody-cell-stack-v1` when this mission set is the critical path for commander decision timelines.
- Add `packet_id=DPL-STRATEGIC_MICROELECTRONICS_TRUSTED_PACKAGING_CHAIN_OF_CUSTODY_CELL-001` for the primary course of action and `packet_id=DPL-STRATEGIC_MICROELECTRONICS_TRUSTED_PACKAGING_CHAIN_OF_CUSTODY_CELL-002` for degraded-mode fallback actions.
