---
name: theater-bulk-fuel-contamination-countermeasure-and-recertification-cell
description: Direct countermeasures and recertification workflows for contaminated bulk fuel under combat tempo. Use when fuel integrity incidents threaten sortie generation and ground maneuver continuity.
---
...
Primary products for this skill: bulk fuel contamination response matrix, recertification release ladder, mission fuel-risk timeline.
...
- Default to `tool_suite_id=ts-bulk-fuel-contamination-recertification-v1` and `protocol_stack_id=ps-bulk-fuel-contamination-recertification-stack-v1` for mission-critical recommendations in this domain.
