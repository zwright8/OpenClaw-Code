---
name: theater-directed-energy-air-defense-power-management-cell
description: Optimize power allocation, thermal windows, and duty cycles for directed-energy air defense nodes in sustained raids.
---
...
Primary products for this skill: directed-energy shot budget matrix, generator rotation timeline, thermal exceedance branch card.

## Tool Suite and Protocol Binding

- Bind tool selection to `ts-directed-energy-power-management-v1` and `ps-directed-energy-power-management-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Recommended external tools for this domain: directed-energy fire control logs, microgrid SCADA, battery management telemetry, and raid timeline COP.
- Required protocol families for implementation: Link 16 J-series, DDS, STANAG 4586, and MQTT over TLS.
