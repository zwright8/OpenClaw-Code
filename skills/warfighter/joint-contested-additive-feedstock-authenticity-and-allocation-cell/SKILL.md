---
name: joint-contested-additive-feedstock-authenticity-and-allocation-cell
description: Support U.S. warfighter planning and decision support for Joint Contested Additive Feedstock Authenticity and Allocation Cell. Use when missions require joint additive manufacturing feedstock authenticity checks, counterfeit interdiction, and mission-priority allocation decisions, integrated options, and protocol-aware staff outputs.
---

# Joint Contested Additive Feedstock Authenticity and Allocation Cell
...
Primary products for this skill: feedstock authenticity board, counterfeit interdiction ladder, additive allocation branch matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: material provenance ledgers, spectrochemical verification tools, additive production priority planners.
...
- Prefer these protocol families for this skill: USMTF, STIX/TAXII, EDI X12, API/JSON.
...
- Primary: tool_suite_id=ts-joint-contested-additive-feedstock-authenticity-and-allocation-cell-v1 with protocol_stack_id=ps-joint-contested-additive-feedstock-authenticity-and-allocation-cell-stack-v1.
- Alternate: tool_suite_id=ts-disconnected-additive-feedstock-provenance-v1 with protocol_stack_id=ps-disconnected-additive-feedstock-provenance-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-ADDITIVE-FEEDSTOCK-AUTH-001, DPL-ADDITIVE-FEEDSTOCK-AUTH-002.
