---
name: theater-prepositioned-medical-supply-cold-chain-continuity-cell
description: Support U.S. warfighter planning and decision support for prepositioned medical cold-chain readiness and degradation response in contested theaters.
---
...
Primary products for this skill: cold-chain risk posture, preposition stock relocation sequence, casualty-impact mitigation plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: medical logistics systems, cold-chain telemetry, transport condition monitors, contingency storage dashboards.
...
- Primary: \ with \.\n- Alternate: \ with \.\n- Degraded: manual temperature accountability log with 2-hour command updates.
...
- Prefer these protocol families for this skill: HL7/FHIR, USMTF, API/JSON.
