---
name: homeland-energy-market-cyber-disruption-and-defense-industrial-load-priority-cell
description: Support U.S. warfighter planning for homeland energy-market cyber disruption and defense-industrial load-priority continuity.
---
...
Use these tool categories by default: energy-market anomaly boards, defense-industrial load-priority arbiters, and cross-sector restoration schedulers.

## Protocol Profile

Preferred protocol families for this skill: NIMS/ICS, EDXL-DE/CAP, STIX/TAXII, NIEM, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-HOMELAND-ENERGY-MARKET-CYBER-DISRUPTION-DEFENSE-INDUSTRIAL-LOAD-PRIORITY-001 for critical recommendations.
