---
name: tactical-digital-twin-combined-arms-rehearsal-cell
description: Build and stress-test digital-twin rehearsals for combined arms operations before execution. Use when staffs need branch testing with machine-ingestible tool packets and explicit confidence controls.
---
...
Primary products for this skill: rehearsal branch scorecard, dependency failure map, commander decision rehearsal brief.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-combined-arms-digital-twin-v1` with `protocol_stack_id=ps-simulation-rehearsal-stack-v1`.
- Alternate: `tool_suite_id=ts-joint-c2-fusion-v1` with `protocol_stack_id=ps-simulation-rehearsal-stack-v1`.
- Degraded: authenticated voice/readback + UTC acknowledgment ledger + commander decision log.

## Domain Packet Defaults

- Default packet ID: `DPL-COMBINED-ARMS-DIGITAL-TWIN-001`.
...
- Default `toolchain_id`: `TC-MISSION-C2-001`.
