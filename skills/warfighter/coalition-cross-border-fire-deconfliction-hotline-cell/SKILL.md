---
name: coalition-cross-border-fire-deconfliction-hotline-cell
description: Run cross-border fire deconfliction hotlines with coalition/partner forces to prevent escalation and blue-on-blue risk.
---
...
Primary products for this skill: hotline operating matrix, fire deconfliction window board, escalation trigger map.
...
- `tool_suite_id`: `ts-cross-border-fire-hotline-v1`
- `protocol_stack_id`: `ps-cross-border-fire-deconfliction-stack-v1`
