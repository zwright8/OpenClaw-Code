---
name: theater-contested-additive-propellant-quality-assurance-cell
description: Support U.S. warfighter sustainment planning for additive propellant quality assurance, contamination detection, and mission-safe release under contested logistics.
---
...
Primary products: propellant quality confidence ledger, release-governance matrix, contamination remediation branch map.
...
- Prioritize these tool families for this domain: energetics QA analytics, additive manufacturing telemetry, contamination forensics, munitions release governance.
...
- Bind recommendations to `tool_suite_id=ts-theater-contested-additive-propellant-quality-assurance-cell-v1` and `protocol_stack_id=ps-theater-contested-additive-propellant-quality-assurance-cell-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Bind machine-ingestible execution packets to `packet_id=DPL-ADDITIVE-PROPELLANT-QA-001` from `../_shared/references/domain-tool-packet-library.md`.
