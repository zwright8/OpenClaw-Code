---
name: strategic-sealift-contested-port-repair-and-cargo-prioritization-cell
description: Coordinate contested port repair and strategic sealift cargo prioritization under strike damage and throughput constraints. Use for deployment and distribution continuity.
---
...
Primary products for this skill: port repair and cargo priority ladder, sealift throughput recovery timeline, mission-load adjudication matrix.
...
- Prioritize these tool/protocol families for this domain: port engineering assessment systems, sealift scheduling platforms, cargo criticality analytics.
