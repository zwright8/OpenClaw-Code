---
name: joint-biometrics-identity-contested-detainee-transfer-cell
description: Validate detainee identity and custody integrity across contested transfers and coalition handoffs. Use when adversaries may exploit identity ambiguity or custody-chain gaps.
---
...
Primary products for this skill: detainee identity confidence brief, custody transfer assurance matrix, contested handoff risk register.

## Domain Tool Stack

Use these tool categories as the baseline stack: biometric matching systems, custody ledgers, transfer adjudication boards, evidence provenance services.

## Protocol Profile

Preferred protocol families for this skill: EBTS, NIEM, API/JSON, STIX/TAXII, secure custody ledger profiles.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-biometrics-contested-detainee-transfer-v1` with `protocol_stack_id=ps-biometrics-contested-detainee-transfer-stack-v1`.
- Alternate: `tool_suite_id=ts-detainee-accountability-v1` with `protocol_stack_id=ps-detainee-accountability-stack-v1`.
...
- Default packet IDs: DPL-BIOMETRICS-CONTESTED-DETAINEE-TRANSFER-001, DPL-DETAINEE-ACCOUNTABILITY-001.
