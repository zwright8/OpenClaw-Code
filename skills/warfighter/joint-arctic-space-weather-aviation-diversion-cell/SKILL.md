---
name: joint-arctic-space-weather-aviation-diversion-cell
description: Coordinate arctic aviation diversions under space-weather and comm/navigation degradation. Use when solar events, GNSS disruption, and austere weather combine to threaten sortie continuity and safety.
---
...
1. Frame the mission problem using these core inputs: space-weather alerts, arctic route weather, nav/comm degradation indicators, runway viability, tanker/support posture.
...
Primary products for this skill: arctic diversion decision matrix, assured-route continuity plan, sortie-risk watchboard.
...
- Add `tool_suite_id=ts-arctic-space-weather-aviation-diversion-v1` + `protocol_stack_id=ps-arctic-space-weather-aviation-diversion-stack-v1` when this domain is mission-critical in current planning.
- Add `packet_id=DPL-ARCTIC-SPACE-WEATHER-AVIATION-001` for branches that can materially alter mission posture or civil-protection outcomes.
