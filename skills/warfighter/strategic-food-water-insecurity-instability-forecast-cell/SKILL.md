---
name: strategic-food-water-insecurity-instability-forecast-cell
description: Forecast instability risks caused by food and water shocks that could trigger conflict, migration, or operational disruption in priority theaters. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: instability risk forecast heatmap, food-water shock trigger ledger, theater contingency recommendation brief.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: agricultural yield intelligence platforms, hydrology monitoring dashboards, migration pattern analytics, market disruption trackers.
- Prioritize these protocol families for this domain: OGC WMS/WFS/WMTS, API/JSON, USMTF, STIX/TAXII.
