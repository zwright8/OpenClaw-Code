---
name: electromagnetic-battle-management-cell
description: Coordinate electromagnetic maneuver and battle management across spectrum-dependent forces. Use when allocating spectrum access, protection priorities, and attack windows.
---
...
1. Frame the mission problem using these core inputs: spectrum allocations, emitter priorities, interference reports, mission timelines.
...
Primary products for this skill: EM battle management plan, allocation matrix, interference response playbook.
...
- Prioritize these tools or protocol families for this domain: EW management tools, Link 16 J-series, API/JSON.
