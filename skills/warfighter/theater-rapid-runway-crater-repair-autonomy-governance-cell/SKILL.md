---
name: theater-rapid-runway-crater-repair-autonomy-governance-cell
description: Coordinate autonomous and crewed runway crater repair sequencing with sortie-regeneration priorities. Use when airfields require high-tempo reconstitution under threat.
---
...
Primary products for this skill: runway repair governance matrix, autonomy release checklist, and sortie recovery timeline.
...
- Bind recommendations to tool_suite_id=ts-theater-rapid-runway-crater-repair-autonomy-governance-cell-v1 and protocol_stack_id=ps-theater-rapid-runway-crater-repair-autonomy-governance-cell-stack-v1.
- Use packet templates in ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-RUNWAY-CRATER-AUTONOMY-001 for critical recommendations.
- Prioritize these protocol families for this domain: USMTF, AIXM/FIXM, VMF, API/JSON.
