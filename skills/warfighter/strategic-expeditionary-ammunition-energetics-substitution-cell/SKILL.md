---
name: strategic-expeditionary-ammunition-energetics-substitution-cell
description: Support warfighter planning for energetics substitution, certification, and allocation when strategic ammunition precursor supply is denied.
---
...
- Primary: `tool_suite_id=ts-ammo-energetics-substitution-v1` with `protocol_stack_id=ps-ammo-energetics-substitution-stack-v1`.
- Alternate: `tool_suite_id=ts-munitions-port-safety-v1` with `protocol_stack_id=ps-munitions-port-safety-stack-v1`.
...
- Default packet IDs: DPL-AMMO-ENERGETICS-SUB-001, DPL-MUNITIONS-PORT-SAFETY-001.
