---
name: theater-civil-alert-authenticity-broadcast-assurance-cell
description: Protect civil warning broadcasts against spoofing and misinformation while preserving trusted public alert continuity.
---
...
Primary products for this skill: alert authenticity confidence board, broadcast continuity fallback plan, misinformation escalation matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-civil-alert-authenticity-v1` with `protocol_stack_id=ps-civil-alert-authenticity-stack-v1`.
...
- Default packet IDs: DPL-CIVIL-ALERT-AUTHENTICITY-001.
