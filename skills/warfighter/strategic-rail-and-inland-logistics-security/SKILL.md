---
name: strategic-rail-and-inland-logistics-security
description: Secure strategic rail corridors and inland logistics nodes against disruption in large-scale sustainment operations. Use when protecting key terrain, schedules, and critical cargo flow.
---
...
1. Frame the mission problem using these core inputs: rail network status, cargo priority lists, threat activity reports, and movement schedules.
...
Primary products for this skill: critical node risk map, rail security synchronization matrix, cargo flow protection plan.
