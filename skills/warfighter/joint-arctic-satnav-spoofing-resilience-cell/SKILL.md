---
name: joint-arctic-satnav-spoofing-resilience-cell
description: Harden Arctic navigation and timing against satnav spoofing, meaconing, and geometry-induced confidence collapse. Use when polar force movement and fires timing depend on trustworthy PNT.
---

# Joint Arctic Satnav Spoofing Resilience Cell
...
- Use packet template DPL-ARCTIC-SATNAV-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-arctic-satnav-resilience-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-arctic-satnav-resilience-v1 with protocol_stack_id=ps-arctic-satnav-stack-v1.
...
- Default packet ID: DPL-ARCTIC-SATNAV-001.
