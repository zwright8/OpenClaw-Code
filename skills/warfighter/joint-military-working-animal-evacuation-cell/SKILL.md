---
name: joint-military-working-animal-evacuation-cell
description: Support U.S. warfighter planning and decision support for Joint Military Working Animal Evacuation Cell. Use when missions require Joint Military Working Animal Evacuation Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: animal evacuation priority roster, treatment and transport timeline, zoonotic containment tracker.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: veterinary records systems, medevac scheduling tools, biosecurity risk monitors.
