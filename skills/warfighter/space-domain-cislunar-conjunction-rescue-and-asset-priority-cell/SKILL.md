---
name: space-domain-cislunar-conjunction-rescue-and-asset-priority-cell
description: Prioritize cislunar conjunction rescue and asset protection decisions during contested space operations.
---
...
Primary products: cislunar conjunction rescue queue, maneuver custody matrix, strategic orbit continuity packet.
...
- Primary: `tool_suite_id=ts-space-domain-cislunar-conjunction-rescue-asset-priority-v1` with `protocol_stack_id=ps-space-domain-cislunar-conjunction-rescue-asset-priority-stack-v1`.
...
- Default packet IDs: `DPL-SPACE-CISLUNAR-CONJUNCTION-RESCUE-ASSET-PRIORITY-001`.
