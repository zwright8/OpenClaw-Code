---
name: joint-denied-pnt-celestial-tercom-requalification-cell
description: Support denied-PNT requalification using celestial, TERCOM, and inertial fallback profiles for joint maneuver and strike operations.
---

# Joint Denied PNT Celestial TERCOM Requalification Cell
...
- Primary: `tool_suite_id=ts-denied-pnt-celestial-tercom-requalification-v1` with `protocol_stack_id=ps-denied-pnt-celestial-tercom-requalification-stack-v1`.
- Alternate: `tool_suite_id=ts-precision-navigation-spoofing-adjudication-v1` with `protocol_stack_id=ps-precision-navigation-spoofing-adjudication-stack-v1`.
...
- Default packet IDs: DPL-DENIED-PNT-CELESTIAL-TERCOM-REQUALIFICATION-001, DPL-PRECISION-NAVIGATION-SPOOFING-ADJUDICATION-001.
