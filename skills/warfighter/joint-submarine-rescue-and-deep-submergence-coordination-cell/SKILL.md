---
name: joint-submarine-rescue-and-deep-submergence-coordination-cell
description: Coordinate submarine rescue operations and deep-submergence contingency planning under contested maritime conditions. Use when distressed submarine timelines, pressure-depth limits, and multinational rescue assets must be synchronized.
---
...
1. Frame the mission problem using these core inputs: distressed submarine last-known position, depth/pressure constraints, submarine life-support timeline, rescue asset availability, and sea-state constraints.
...
Primary products for this skill: submarine rescue synchronization matrix, pressure-depth rescue feasibility brief, multinational rescue timeline.
...
- Primary: `tool_suite_id=ts-submarine-rescue-v1` with `protocol_stack_id=ps-undersea-rescue-stack-v1`.
