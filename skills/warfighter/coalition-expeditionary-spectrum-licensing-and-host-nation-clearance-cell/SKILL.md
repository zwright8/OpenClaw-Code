---
name: coalition-expeditionary-spectrum-licensing-and-host-nation-clearance-cell
description: Manage coalition expeditionary spectrum licensing and host-nation clearance workflows. Use when rapid deployment requires legal frequency access, deconfliction, and partner approvals.
---
...
Primary products for this skill: spectrum licensing status board, host-nation clearance tracker, coalition frequency conflict resolution matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-spectrum-licensing-clearance-v1` with `protocol_stack_id=ps-spectrum-licensing-clearance-stack-v1`.
...
- Default packet IDs: DPL-SPECTRUM-LICENSE-001.
