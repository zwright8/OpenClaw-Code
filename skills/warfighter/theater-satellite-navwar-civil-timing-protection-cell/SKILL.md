---
name: theater-satellite-navwar-civil-timing-protection-cell
description: Protect military and civil timing dependencies during satellite navigation warfare. Use when PNT disruption threatens command timing, financial systems, transportation control, or critical infrastructure synchronization.
---
...
1. Frame the mission problem using these core inputs: PNT degradation indicators, timing-dependent mission systems, civil infrastructure timing dependencies, holdover clock status, and threat assessments.
...
Primary products for this skill: timing dependency risk map, holdover synchronization plan, navwar mitigation decision matrix.
...
- Primary: `tool_suite_id=ts-pnt-timing-protection-v1` with `protocol_stack_id=ps-pnt-timing-resilience-stack-v1`.
