---
name: homeland-electromagnetic-grid-geomagnetic-disturbance-recovery-cell
description: Coordinate homeland grid resilience and geomagnetic disturbance recovery to preserve military C2 and critical civil services.
---
...
- Primary: `tool_suite_id=ts-homeland-grid-geomagnetic-recovery-v1` with `protocol_stack_id=ps-homeland-grid-geomagnetic-recovery-stack-v1`.
...
- Default packet IDs: `DPL-GEOMAGNETIC-GRID-DISTURBANCE-001`, `DPL-GRID-EMERGENCY-BLACKSTART-PRIORITY-001`.
