---
name: joint-space-ground-laser-dazzle-attribution-and-recovery-cell
description: Fuse space and terrestrial sensing to attribute laser dazzle incidents and orchestrate payload recovery posture.
---
...
Primary products for this skill: dazzle attribution confidence pack, payload recovery playbook, recurrence-risk timeline.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: SDA event analytics, optical sensor telemetry fusion, payload health management boards.
- Preferred protocol profiles for coordination and machine exchange: CCSDS, USMTF, API/JSON.
