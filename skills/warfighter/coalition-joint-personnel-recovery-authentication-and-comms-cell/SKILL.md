---
name: coalition-joint-personnel-recovery-authentication-and-comms-cell
description: Support U.S. and coalition personnel recovery planning with identity authentication, secure signaling, and multi-partner comms deconfliction.
---
...
Primary products for this skill: authenticated recovery signal matrix, coalition comms deconfliction plan, isolated personnel decision support brief.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: personnel recovery systems, identity verification services, coalition comms gateways, ISR cueing dashboards.

## Protocol Profile

Preferred protocol families for this skill: USMTF, VMF, NATO APP-11/ADatP-3 aligned.

## Domain Toolchain Defaults

- Primary: \ with \.\n- Alternate: \ with \.\n- Degraded: authenticated voice challenge-response and delayed digital reconciliation.
...
- Prefer these protocol families for this skill: USMTF, VMF, NATO APP-11/ADatP-3 aligned.
