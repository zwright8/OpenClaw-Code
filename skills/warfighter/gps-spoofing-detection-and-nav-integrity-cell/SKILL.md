---
name: gps-spoofing-detection-and-nav-integrity-cell
description: Detect and manage navigation integrity degradation from spoofing or interference across joint formations. Use when mission timing, route safety, or weapons-safe geofencing depends on trusted PNT.
---

# GPS Spoofing Detection and Navigation Integrity Cell
...
1. Frame the mission problem using these core inputs: position anomalies, timing deviation alerts, platform inertial references, and mission phase criticality.
...
Primary products for this skill: PNT integrity dashboard, spoofing incident triage packet, navigation fallback execution card.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: PNT monitoring tools, EW detection stacks, platform nav telemetry and inertial cross-check systems.
...
- Prefer these protocol families for this skill: USMTF, Link 16 J-series, API/JSON, CoT.
