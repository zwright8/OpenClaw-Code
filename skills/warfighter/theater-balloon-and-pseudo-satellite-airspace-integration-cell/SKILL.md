---
name: theater-balloon-and-pseudo-satellite-airspace-integration-cell
description: Support U.S. warfighter planning and decision support for Theater Balloon and Pseudo-Satellite Airspace Integration Cell. Use when missions require deconflicting stratospheric balloon and pseudo-satellite operations with ISR, air defense, and civil air corridors, integrated options, and protocol-aware staff outputs.
---

# Theater Balloon and Pseudo-Satellite Airspace Integration Cell
...
Primary products for this skill: high-altitude corridor deconfliction board, pseudo-satellite priority matrix, engagement safeguard packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: high-altitude track managers, airspace deconfliction planners, sensor handover arbitration tools.
...
- Prefer these protocol families for this skill: AIXM/FIXM, Link 16 J-series, USMTF, API/JSON.
...
- Primary: tool_suite_id=ts-theater-balloon-and-pseudo-satellite-airspace-integration-cell-v1 with protocol_stack_id=ps-theater-balloon-and-pseudo-satellite-airspace-integration-cell-stack-v1.
- Alternate: tool_suite_id=ts-joint-hypersonic-strike-warning-fusion-and-response-cell-v1 with protocol_stack_id=ps-joint-hypersonic-strike-warning-fusion-and-response-cell-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-BALLOON-PSEUDOSAT-AIRSPACE-001, DPL-BALLOON-PSEUDOSAT-AIRSPACE-002.
