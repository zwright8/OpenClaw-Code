---
name: autonomous-cbrn-sensor-fusion-and-decon-corridor-cell
description: Fuse autonomous and human CBRN sensing to establish decontamination corridors and restoration branches. Use when forces require rapid hazard characterization, zone control, and decon routing under contested conditions.
---

# Autonomous CBRN Sensor Fusion and Decon Corridor Cell
...
Primary products for this skill: CBRN hazard confidence ladder, decon corridor control order, and protected mobility routing packet.
...
- Add `tool_suite_id=ts-autonomous-cbrn-sensor-fusion-decon-corridor-v1` + `protocol_stack_id=ps-autonomous-cbrn-sensor-fusion-decon-corridor-stack-v1` for this mission domain as default external integration profile.
- Add `packet_id=DPL-AUTONOMOUS-CBRN-SENSOR-FUSION-DECON-CORRIDOR-001` for mission branches that can alter force posture, mission risk, or escalation dynamics.
