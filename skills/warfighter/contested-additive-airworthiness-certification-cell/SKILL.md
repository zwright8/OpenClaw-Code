---
name: contested-additive-airworthiness-certification-cell
description: Certify additive-manufactured aviation repairs in contested environments. Use when commanders need rapid part substitution with airworthiness, traceability, and risk acceptance controls.
---
...
Primary products for this skill: additive part certification packet, airworthiness release matrix, risk acceptance decision log.
...
- Prioritize `tool_suite_id=ts-additive-airworthiness-certification-v1` + `protocol_stack_id=ps-additive-airworthiness-certification-stack-v1` for this mission set.
- Include `packet_id=DPL-ADDITIVE-AIRWORTHINESS-CERTIFICATION-001` for high-consequence recommendations and branch decisions.
- Bind recommendations to `toolchain_profile_id=additive-airworthiness-certification-v1` in joint operations profile selection.
