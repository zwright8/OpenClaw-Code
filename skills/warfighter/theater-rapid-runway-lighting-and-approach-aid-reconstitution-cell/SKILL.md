...
description: Support U.S. warfighter planning and decision support for rapid runway lighting and approach-aid restoration under attack and degraded navigation conditions. Use when missions require integrated options, tool-protocol bindings, and authority-gated staff outputs.
---
...
Primary products for this skill: runway aid restoration matrix, sortie-safe sequencing ladder, airfield recertification packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: airfield lighting fault isolation tools, approach-aid integrity monitors, expeditionary sortie regeneration planners.
...
- Prefer these protocol families for this skill: AIXM/FIXM, USMTF, VMF, API/JSON.
...
- Alternate: tool_suite_id=ts-expeditionary-runway-rapid-certification-v1 with protocol_stack_id=ps-expeditionary-runway-rapid-certification-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-RUNWAY-LIGHTING-APPROACH-AID-001, DPL-RUNWAY-LIGHTING-APPROACH-AID-002.
