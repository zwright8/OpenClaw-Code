---
name: theater-electronic-warfare-civil-gps-fallback-and-precision-fire-safeguard-cell
description: Support U.S. warfighter planning for electronic-warfare pressure on civil GPS services and precision-fire safeguard branches.
---
...
Use these tool categories by default: EW effects boards, civil-GPS fallback route planners, and precision-fire safety interlock controls.

## Protocol Profile

Preferred protocol families for this skill: Link 16 J-series, VMF, CoT, AIXM/FIXM, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-THEATER-ELECTRONIC-WARFARE-CIVIL-GPS-FALLBACK-PRECISION-FIRE-SAFEGUARD-001 for critical recommendations.
