---
name: joint-hypersonic-debris-forecast-and-civil-warning-integration-cell
description: Fuse hypersonic engagement debris forecasts into military-civil warning timelines to protect forces and population centers.
---
...
Primary products for this skill: debris impact forecast board, warning timeline matrix, protected-route adjustment order set.

## Domain Tool Stack

Use these tool categories as the baseline stack: hypersonic trajectory fusion, geospatial blast/debris modeling, civil warning dissemination systems, mission route replanning board.

## Protocol Profile

Preferred protocol families for this skill: USMTF, EDXL-DE/CAP, OGC WMS/WFS/WMTS, API/JSON.
...
- Prioritize `tool_suite_id=ts-joint-hypersonic-debris-forecast-and-civil-warning-integration-cell-v1` + `protocol_stack_id=ps-joint-hypersonic-debris-forecast-and-civil-warning-integration-cell-stack-v1` when this mission set is the critical path for commander decision timelines.
- Add `packet_id=DPL-JOINT_HYPERSONIC_DEBRIS_FORECAST_AND_CIVIL_WARNING_INTEGRATION_CELL-001` for the primary course of action and `packet_id=DPL-JOINT_HYPERSONIC_DEBRIS_FORECAST_AND_CIVIL_WARNING_INTEGRATION_CELL-002` for degraded-mode fallback actions.
