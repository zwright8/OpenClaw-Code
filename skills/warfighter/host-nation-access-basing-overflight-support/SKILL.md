---
name: host-nation-access-basing-overflight-support
description: Plan host-nation access, basing, and overflight dependencies for campaign options. Use when diplomatic constraints shape force posture, transit, and sustainment viability.
---

# Host Nation Access Basing Overflight Support
...
1. Frame the mission problem using these core inputs: country permissions, treaty constraints, force package movement needs, time-phased deployment data.
...
Primary products for this skill: access dependency map, basing option comparison, overflight risk register.
