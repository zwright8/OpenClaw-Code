---
name: coalition-disconnected-fires-clearance-ledger-cell
description: Support U.S. warfighter planning and decision support for Coalition Disconnected Fires Clearance Ledger Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: disconnected fires clearance ledger, coalition authority reconciliation board, release/hold decision timeline.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: fires C2 systems, legal approval routing tools, disconnected synchronization and acknowledgment ledgers.

## Protocol Profile

Preferred protocol families for this skill: VMF, USMTF, NATO APP-11/ADatP-3 aligned, API/JSON.
