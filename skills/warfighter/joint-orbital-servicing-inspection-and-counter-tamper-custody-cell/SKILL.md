---
name: joint-orbital-servicing-inspection-and-counter-tamper-custody-cell
description: Coordinate orbital servicing and inspection operations with counter-tamper custody evidence and cross-domain mission assurance. Use when space operators require recommendations that connect on-orbit maintenance, security posture, and chain-of-custody accountability.
---
...
Primary products for this skill: orbital servicing sequence plan, tamper-custody evidence ledger, anomaly adjudication branch matrix.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools for this domain: space object telemetry brokers, orbital inspection planning tools, tamper-forensics services, custody/audit-chain ledgers.
- Prioritize these protocol families for this domain: CCSDS, USMTF, STIX/TAXII, API/JSON.
...
- Include tool_suite_id=ts-joint-orbital-servicing-inspection-and-counter-tamper-custody-cell-v1, protocol_stack_id=ps-joint-orbital-servicing-inspection-and-counter-tamper-custody-cell-stack-v1, and packet_id=DPL-ORBITAL-SERVICING-TAMPER-CUSTODY-001 for each critical recommendation.
