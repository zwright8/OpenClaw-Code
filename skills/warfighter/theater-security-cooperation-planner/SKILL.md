---
name: theater-security-cooperation-planner
description: Plan theater security cooperation activities with allies and partners. Use when aligning exercises, capacity building, and strategic objectives across time.
---

# Theater Security Cooperation Planner
...
1. Frame the mission problem using these core inputs: campaign objectives, partner priorities, exercise calendar, available resources.
...
Primary products for this skill: security cooperation activity plan, partner capability map, assessment framework.
