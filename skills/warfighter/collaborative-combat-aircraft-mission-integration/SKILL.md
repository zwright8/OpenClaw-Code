---
name: collaborative-combat-aircraft-mission-integration
description: Coordinate planning support for crewed-uncrewed collaborative combat aircraft mission integration. Use when commanders need task allocation, comms-resilience, and mission assurance options for collaborative air packages.
---
...
1. Frame the mission problem using these core inputs: manned and autonomous package composition, data link quality, rules and authorities, and sortie priorities.
...
Primary products for this skill: crewed-uncrewed task allocation matrix, comms degradation branch plan, sortie risk board.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: air C2 systems, mission data-link managers, autonomy mission management consoles.
...
- Prefer these protocol families for this skill: Link 16 J-series, VMF, USMTF, API/JSON.
