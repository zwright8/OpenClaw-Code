---
name: strategic-target-development-and-no-strike-governance-cell
description: Support strategic target system analysis while maintaining strict no-strike and restricted-target governance. Use when integrating legal, intelligence, and effects assessments.
---
...
1. Frame the mission problem using these core inputs: target system intelligence, no-strike list updates, collateral risk estimates, command authorities.
...
Primary products for this skill: target nomination governance board, no-strike compliance audit, strategic effects risk comparison.
