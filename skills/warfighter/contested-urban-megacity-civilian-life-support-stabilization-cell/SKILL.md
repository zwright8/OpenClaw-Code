---
name: contested-urban-megacity-civilian-life-support-stabilization-cell
description: Plan military support options to stabilize civilian life-support systems in contested megacities while preserving force protection and mission objectives. Use for urban crisis operations.
---
...
Primary products for this skill: megacity life-support stabilization order, priority-of-life restoration matrix, civil-military risk synchronization board.
...
- Prioritize these tool/protocol families for this domain: utility and infrastructure telemetry platforms, urban mobility analytics, civil support incident management systems.
