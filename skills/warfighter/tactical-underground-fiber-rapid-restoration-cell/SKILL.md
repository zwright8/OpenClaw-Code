---
name: tactical-underground-fiber-rapid-restoration-cell
description: Restore underground tactical fiber links under contested conditions with route risk controls and mission-priority bandwidth allocation.
---
...
Primary products for this skill: fiber restoration sequence, mission bandwidth priority table, reroute fallback card.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: fiber fault localization services, civil works dispatch boards, mission network SLA monitors.
- Preferred protocol profiles for coordination and machine exchange: USMTF, API/JSON, XML.
...
- Default packet binding for this domain: DPL-UNDERGROUND-FIBER-RESTORE-001.
