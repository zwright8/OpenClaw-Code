---
name: joint-deception-operations-red-indicator-fusion-cell
description: Fuse red-indicator evidence for deception operations detection, confidence adjudication, and commander warning decisions.
---
...
- Use packet template DPL-DECEPTION-RED-INDICATOR-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-joint-deception-red-indicator-fusion-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-joint-deception-red-indicator-fusion-v1 with protocol_stack_id=ps-joint-deception-red-indicator-fusion-stack-v1.
...
- Default packet ID: DPL-DECEPTION-RED-INDICATOR-001.
