---
name: joint-contested-casualty-evacuation-c2-fallback-cell
description: Maintain casualty evacuation command-and-control continuity when primary medical C2 links are degraded or denied.
---
...
Primary products for this skill: medevac C2 failover plan, triage transport branch board, medical handoff confidence matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-contested-cas-evac-c2-fallback-v1` with `protocol_stack_id=ps-contested-cas-evac-c2-stack-v1`.
- Alternate: `tool_suite_id=ts-denied-casualty-data-sync-v1` with `protocol_stack_id=ps-denied-casualty-data-sync-stack-v1`.
...
- Default packet IDs: DPL-CONTESTED-CASEVAC-C2-001.
