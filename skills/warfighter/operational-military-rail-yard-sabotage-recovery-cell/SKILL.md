---
name: operational-military-rail-yard-sabotage-recovery-cell
description: Recover military rail-yard throughput after sabotage while preserving munition safety and movement priorities. Use when rail nodes are damaged or infiltrated during large-scale deployment.
---

# Operational Military Rail Yard Sabotage Recovery Cell
...
1. Frame the mission problem using these core inputs: yard damage assessment, switch and signal status, hazardous cargo positions, and theater movement priorities.
...
Primary products for this skill: rail yard recovery timeline, safe re-marshaling sequence, movement-priority throughput ladder.
...
## Domain Toolchain Override (2026-03-09, Rail Yard Sabotage Throughput Recovery)

- Prioritize tool_suite_id=ts-military-rail-yard-sabotage-recovery-v1 with protocol_stack_id=ps-military-rail-yard-sabotage-recovery-stack-v1 when sabotage impairs military rail throughput.
- Use packet DPL-MILITARY-RAIL-YARD-SABOTAGE-RECOVERY-001 to synchronize hazard isolation, switch restoration, and movement-control reflow decisions.
- If rail safety certification or custody evidence is incomplete, issue constrained-tempo recommendations and require commander plus rail-safety authority approval.
