---
name: expeditionary-robotic-casualty-collection-route-assurance-cell
description: Assure safe robotic casualty collection routes in contested zones with dynamic threat and mobility constraints. Use when autonomous or semi-autonomous CASEVAC platforms are employed.
---
...
Primary products for this skill: robotic casualty route assurance board, threat-adaptive dispatch matrix, casualty transfer continuity packet

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-robotic-casualty-route-assurance-v1 and protocol_stack_id=ps-robotic-casualty-route-assurance-stack-v1.
- Primary tools for this domain: autonomous route planners, casualty telemetry trackers, medevac dispatch and handoff systems
- Required exchange protocols/formats for this domain: USMTF, VMF, CoT, HL7/FHIR, API/JSON
