---
name: coalition-rapid-runway-ice-fod-clearance-cell
description: Coordinate coalition rapid runway ice and foreign-object debris clearance to preserve sortie generation in severe weather.
---
...
Primary products for this skill: runway clearance priority board, sortie interruption forecast, coalition equipment tasking queue.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-runway-ice-fod-clearance-v1` with `protocol_stack_id=ps-runway-ice-fod-clearance-stack-v1`.
- Alternate: `tool_suite_id=ts-weather-diversion-recovery-v1` with `protocol_stack_id=ps-cloudburst-flood-route-stack-v1`.
...
- Default packet IDs: DPL-RUNWAY-ICE-FOD-001.
