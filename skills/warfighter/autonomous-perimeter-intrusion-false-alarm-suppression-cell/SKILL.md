---
name: autonomous-perimeter-intrusion-false-alarm-suppression-cell
description: Tune and govern autonomous perimeter sensing to suppress false alarms without missing genuine intrusions. Use when base defense sensors are overloaded or spoofed.
---
...
1. Frame the mission problem using these core inputs: perimeter sensor alert history, false-positive pattern clusters, adversary spoofing indicators, guard-force response capacity.
...
Primary products for this skill: intrusion alert tuning order, false-alarm suppression matrix, response readiness confidence ledger.
...
- Primary: `tool_suite_id=ts-autonomous-perimeter-alert-governance-v1` with `protocol_stack_id=ps-base-defense-sensor-assurance-stack-v1`.
