---
name: joint-personnel-recovery-isochrones-and-corridor-safety-cell
description: Support personnel recovery mission timing windows, safe-corridor analysis, and recovery support deconfliction.
---

# Joint Personnel Recovery Isochrones and Corridor Safety Cell
...
Primary products for this skill: recovery timing/isochrone map, corridor risk matrix, support force synchronization card.
...
- Suggested tools: SAR mission systems, weather/radar feeds, terrain and threat overlays, CSAR communications logs.
- Protocol/message standards: USMTF PR formats, CoT, Link 16 J-series, OGC GeoJSON.
