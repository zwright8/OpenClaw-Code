---
name: joint-forward-rare-blood-typing-and-donor-matching-cell
description: Support forward rare-blood typing and donor matching across distributed casualty networks. Use when transfusion compatibility constraints threaten survival in austere theaters.
---
...
Primary products for this skill: rare-blood availability map, donor matching confidence matrix, urgent transfer prioritization board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-forward-rare-blood-matching-v1` with `protocol_stack_id=ps-forward-rare-blood-stack-v1`.
...
- Default packet IDs: DPL-RARE-BLOOD-MATCH-001.
