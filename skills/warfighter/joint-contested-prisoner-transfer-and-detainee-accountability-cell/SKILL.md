---
name: joint-contested-prisoner-transfer-and-detainee-accountability-cell
description: Coordinate contested prisoner transfer and detainee accountability with verifiable identity, legal compliance, and handoff integrity.
---
...
Primary products: transfer corridor governance board, detainee identity confidence ledger, legal compliance exception packet.
...
- Primary: `tool_suite_id=ts-joint-contested-prisoner-transfer-detainee-accountability-v1` with `protocol_stack_id=ps-joint-contested-prisoner-transfer-detainee-accountability-stack-v1`.
- Alternate: `tool_suite_id=ts-truce-monitoring-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Default packet IDs: `DPL-JOINT-CONTESTED-PRISONER-TRANSFER-001`, `DPL-JOINT-CONTESTED-PRISONER-TRANSFER-002`.
