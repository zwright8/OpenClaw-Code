---
name: coalition-undersea-cable-repair-diplomacy-and-clearance-cell
description: Synchronize multinational legal clearances, vessel routing, and repair sequencing for damaged undersea communication cable systems. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: undersea cable repair clearance matrix, coalition diplomatic action tracker, repair vessel deconfliction timeline.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: undersea cable telemetry platforms, maritime routing and clearance systems, legal workflow trackers, diplomatic coordination portals.
- Prioritize these protocol families for this domain: AIS/NMEA, OGC WMS/WFS/WMTS, USMTF, NATO APP-11/ADatP-3 aligned.
