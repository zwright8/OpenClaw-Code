---
name: joint-lunar-communications-relay-contingency-cell
description: Support U.S. warfighter planning for lunar relay communications continuity across cislunar and terrestrial operations. Use when mission traffic depends on lunar relay paths, deep-space timing, or contested space-ground links.
---
...
Primary products for this skill: lunar relay continuity matrix, cislunar message-priority ladder, comms-loss branch plan.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-space-satcom-v1` with `protocol_stack_id=ps-space-satcom-sync-stack-v1`.
- Alternate:   `tool_suite_id=ts-nc3-resilience-v1` with `protocol_stack_id=ps-strategic-message-assurance-stack-v1`.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## External Tool Stack and Protocols

- Preferred tools: SDA catalog services, SATCOM planners, optical crosslink schedulers, timing-integrity monitors.
- Preferred protocol families: API/JSON, USMTF, Link 16 J-series.
