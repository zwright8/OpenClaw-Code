---
name: strategic-additive-energetics-supply-denial-countermeasure-cell
description: Counter adversary disruptions to additive energetics precursor supply and preserve munitions production tempo. Use when energetic binder, oxidizer, and feedstock pipelines are under attack.
---

# Strategic Additive Energetics Supply Denial Countermeasure Cell
...
- Use packet template DPL-ENERGETICS-SUPPLY-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-energetics-supply-denial-countermeasure-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-energetics-supply-denial-countermeasure-v1 with protocol_stack_id=ps-energetics-supply-stack-v1.
...
- Default packet ID: DPL-ENERGETICS-SUPPLY-001.
