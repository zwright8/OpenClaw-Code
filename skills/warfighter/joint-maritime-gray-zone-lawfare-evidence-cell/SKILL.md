---
name: joint-maritime-gray-zone-lawfare-evidence-cell
description: Support U.S. warfighter planning for maritime gray-zone legal evidence generation and attribution. Use when coercive maritime actions require admissible evidence packets for allied and interagency response.
---
...
Primary products for this skill: gray-zone incident evidence chain, legal-attribution confidence board, response option brief.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-maritime-interdiction-v1` with `protocol_stack_id=ps-maritime-interdiction-stack-v1`.
- Alternate:   `tool_suite_id=ts-truce-monitoring-v1` with `protocol_stack_id=ps-nato-coalition-stack-v1`.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## External Tool Stack and Protocols

- Preferred tools: maritime COP, vessel identity analytics, evidence custody ledger services, legal decision workflow trackers.
- Preferred protocol families: AIS/NMEA, NATO APP-11/ADatP-3 aligned, USMTF.
...
- Default packet IDs: DPL-UNDERSEA-BARRIER-001, DPL-HUM-COR-001.
