---
name: joint-denied-gps-precision-approach-and-airdrop-certification-cell
description: Support U.S. warfighter planning for denied-GPS precision approach and airdrop certification under contested PNT and degraded weather/terrain conditions.
---
...
Primary products for this skill: precision approach fallback matrix, airdrop certification checklist, denied-PNT risk and timing ladder.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: terrain-relative nav confidence engine, approach corridor deconfliction board, airdrop drift predictor, sortie safety adjudication tracker.
...
- Prefer these protocol families for this skill: AIXM/FIXM, VMF, Link 16 J-series, API/JSON.
