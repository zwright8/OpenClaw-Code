---
name: expeditionary-additive-manufacturing-quality-assurance
description: Validate and govern expeditionary additive manufacturing outputs for mission-critical parts in austere environments. Use when field-printed components affect safety, readiness, or airworthiness.
---
...
1. Frame the mission problem using these core inputs: part technical data, printer telemetry, material batch data, inspection/test results.
...
Primary products for this skill: field manufacturing quality log, release/reject decision brief, replacement-part risk matrix.
...
- Prioritize these tools or tool families for this domain: maintenance management systems, additive manufacturing queues, digital twin repositories, QA tracking systems.
- Specify outbound exchange format for recommendations and tasking: API/JSON, USMTF, XML/JSON.
