---
name: joint-hardened-rail-bridge-drone-swarm-defense-and-repair-cell
description: Defend and rapidly reconstitute military-critical rail bridges under drone swarm attack to preserve strategic force flow. Use when rail chokepoints are contested by UAS and precision strike threat.
---
...
Primary products: bridge defense posture matrix, swarm-threat repair queue, force-flow continuity branch brief.
...
- Primary: `tool_suite_id=ts-joint-rail-bridge-drone-swarm-defense-repair-v1` with `protocol_stack_id=ps-joint-rail-bridge-drone-swarm-defense-repair-stack-v1`.
- Alternate: `tool_suite_id=ts-joint-rail-bridge-drone-swarm-defense-repair-v1` with `protocol_stack_id=ps-joint-rail-bridge-drone-swarm-defense-repair-stack-v1`.
...
- Default packet IDs: DPL-JOINT-RAIL-BRIDGE-DRONE-SWARM-DEFENSE-REPAIR-001, DPL-JOINT-RAIL-BRIDGE-DRONE-SWARM-DEFENSE-REPAIR-001.
