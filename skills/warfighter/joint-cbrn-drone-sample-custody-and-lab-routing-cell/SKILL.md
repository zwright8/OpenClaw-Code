---
name: joint-cbrn-drone-sample-custody-and-lab-routing-cell
description: Coordinate contested-environment CBRN sample collection by uncrewed systems with chain-of-custody and lab-routing assurance.
---
...
Primary products: sample custody timeline, lab routing priority matrix, contamination confidence ladder, and commander release packet.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-cbrn-drone-sample-custody-v1` with `protocol_stack_id=ps-cbrn-drone-sample-custody-stack-v1`.
...
- Default packet IDs: DPL-CBRN-DRONE-CUSTODY-001, DPL-CBRN-LAB-ROUTING-001.
