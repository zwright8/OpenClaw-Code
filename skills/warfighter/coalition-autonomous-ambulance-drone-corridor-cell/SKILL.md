---
name: coalition-autonomous-ambulance-drone-corridor-cell
description: Establish coalition autonomous ambulance drone corridors for contested casualty movement. Use when ground evacuation is delayed and aerial casualty throughput must be governed safely.
---
...
Primary products for this skill: ambulance drone corridor order, casualty flow prioritization board, medevac deconfliction branch matrix.

## Domain Tool Stack

Use these tool categories as the baseline stack: autonomous medevac dispatch services, UAS corridor control tools, patient regulation systems, coalition legal clearance trackers.

## Protocol Profile

Preferred protocol families for this skill: STANAG 4586, CoT, HL7/FHIR, UTM API/JSON.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-coalition-autonomous-ambulance-drone-corridor-v1` with `protocol_stack_id=ps-coalition-autonomous-ambulance-drone-corridor-stack-v1`.
- Alternate: `tool_suite_id=ts-medical-force-health-v1` with `protocol_stack_id=ps-forward-rare-blood-stack-v1`.
...
- Default packet IDs: DPL-COALITION-AUTONOMOUS-AMBULANCE-DRONE-CORRIDOR-001, DPL-MEDICAL-FORCE-HEALTH-001.
