---
name: joint-autonomous-cargo-airdrop-drift-denial-cell
description: Plan autonomous cargo airdrop operations that remain accurate under contested weather, GNSS degradation, and electromagnetic attack. Use when warfighters need assured resupply without exposing crewed aircraft to high risk.
---
...
Primary products: airdrop drift risk matrix, release-go/no-go worksheet, recovery corridor packet.
...
- Primary: `tool_suite_id=ts-autonomous-airdrop-drift-control-v1 with protocol_stack_id=ps-autonomous-airdrop-drift-control-stack-v1`.
...
- Default packet IDs: DPL-AIRSPACE-FIRES-001, DPL-LOGISTICS-AIRDROP-001, DPL-C2-DISP-002.
