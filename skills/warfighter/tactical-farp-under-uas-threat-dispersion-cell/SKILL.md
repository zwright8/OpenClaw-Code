---
name: tactical-farp-under-uas-threat-dispersion-cell
description: Disperse and reconfigure forward arming and refueling points under persistent UAS surveillance and strike threat. Use when FARP survivability and sortie support must be balanced in real time.
---
...
1. Frame the mission problem using these core inputs: UAS threat tracks and intent, FARP site options and signatures, fuel and ammo throughput demand, air tasking priorities.
...
Primary products for this skill: FARP dispersion and relocation plan, survivability-throughput tradeoff matrix, rapid rearm and refuel timeline.
...
- Primary: `tool_suite_id=ts-farp-dispersion-under-uas-v1` with `protocol_stack_id=ps-farp-survivability-stack-v1`.
- Alternate: `tool_suite_id=ts-fires-airspace-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
