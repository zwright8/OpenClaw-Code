---
name: expeditionary-aircraft-battle-damage-forensic-triage-cell
description: Prioritize aircraft battle-damage forensics, repairability decisions, and sortie return sequencing under expeditionary constraints. Use when aviation platforms take kinetic or directed-energy damage.
---
...
1. Frame the mission problem using these core inputs: damage signatures by subsystem, maintenance skill mix, spare part availability, sortie generation demand.
...
Primary products for this skill: aircraft forensic triage board, repair-versus-cannibalization matrix, sortie return timeline.
...
- Primary: `tool_suite_id=ts-aircraft-battle-damage-triage-v1` with `protocol_stack_id=ps-aviation-maintenance-forensics-stack-v1`.
