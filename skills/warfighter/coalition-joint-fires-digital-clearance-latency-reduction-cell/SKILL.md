---
name: coalition-joint-fires-digital-clearance-latency-reduction-cell
description: Reduce coalition fires clearance latency by identifying approval bottlenecks, pre-delegation windows, and digital evidence gaps.
---
...
Primary products for this skill: clearance latency dashboard, ROE bottleneck heatmap, pre-delegation candidate list.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-coalition-fires-latency-reduction-v1` with `protocol_stack_id=ps-coalition-fires-latency-stack-v1`.
- Alternate: `tool_suite_id=ts-fires-airspace-v1` with `protocol_stack_id=ps-nato-coalition-stack-v1`.
...
- Default packet IDs: DPL-COALITION-FIRES-LATENCY-001.
