---
name: joint-deployment-and-distribution-ops-center-optimizer
description: Support U.S. warfighter planning and decision support for Joint Deployment And Distribution Ops Center Optimizer. Use when missions require deployment and distribution operations center optimization for theater lift, staging, and throughput control, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: DDOC optimization board package, throughput constraint analysis, lift allocation decision matrix.
...
- Prioritize these tools or protocol families for this domain: movement control planners, strategic mobility systems, port/airfield ops trackers.
- State the protocol or message format for outbound coordination (for example USMTF, XML/JSON, API/JSON).
