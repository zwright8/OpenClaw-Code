---
name: theater-rapid-cyber-physical-hospital-evacuation-cell
description: Coordinate cyber-physical hospital evacuation and continuity of care during attacks on medical infrastructure. Use when hospital systems, power, water, or network integrity degrade during active operations.
---

# Theater Rapid Cyber Physical Hospital Evacuation Cell
...
- Use packet template DPL-HOSPITAL-CP-EVAC-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-hospital-cyber-physical-evac-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-hospital-cyber-physical-evac-v1 with protocol_stack_id=ps-hospital-cyber-physical-evac-stack-v1.
...
- Default packet ID: DPL-HOSPITAL-CP-EVAC-001.
