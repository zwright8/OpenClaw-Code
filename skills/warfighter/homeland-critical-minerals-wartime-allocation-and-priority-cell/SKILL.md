---
name: homeland-critical-minerals-wartime-allocation-and-priority-cell
description: Prioritize and deconflict wartime critical-mineral allocation to sustain U.S. defense production, maintenance, and energy systems under disruption.
---

# Homeland Critical Minerals Wartime Allocation and Priority Cell
...
Primary products for this skill: critical-mineral allocation board, industrial sustainment risk map, priority contract adjudication matrix.

## External Tools and Protocol Integration

- Suggested tools: DLA logistics systems, DOE grid stress dashboards, USGS mineral flow data, ERP inventory feeds.
- Protocol/message standards: NIEM, OASIS EDXL, ANSI X12, JSON/REST.
