---
name: autonomous-attritable-swarm-operations-cell
description: Support planning and control assurance for autonomous attritable swarms in joint operations. Use when commanders need synchronized mission packages with robust command fallback and risk containment.
---
...
1. Frame the mission problem using these core inputs: swarm mission objectives, comms and control constraints, operating area restrictions, and collateral risk controls.
...
Primary products for this skill: swarm tasking package, command-fallback decision tree, attrition-risk branch matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: uncrewed mission control systems, tactical COP tools, autonomy health telemetry dashboards.
...
- Prefer these protocol families for this skill: CoT, VMF, Link 16 J-series, API/JSON.
