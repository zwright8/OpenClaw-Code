---
name: theater-battle-network-time-synchronization-assurance-cell
description: Support U.S. warfighter planning and decision support for battle-network time synchronization integrity, holdover continuity, and cross-domain command timing assurance.
---
...
Primary products for this skill: time-sync integrity dashboard brief, holdover failover sequence, cross-domain timing risk decision packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: time-distribution monitors, network timing integrity analyzers, GNSS/PNT fallback orchestration tools, mission command systems.
...
- Prefer these protocol families for this skill: PTP/NTP, USMTF, API/JSON.
