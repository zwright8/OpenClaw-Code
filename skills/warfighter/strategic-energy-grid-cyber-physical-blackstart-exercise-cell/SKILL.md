---
name: strategic-energy-grid-cyber-physical-blackstart-exercise-cell
description: Support U.S. warfighter planning and decision support for cyber-physical grid blackstart exercises, military support to restoration, and continuity risk governance.
---
...
Primary products for this skill: blackstart exercise scenario board, restoration priority matrix, mission energy continuity risk packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: grid telemetry and SCADA mirrors, cyber incident command dashboards, restoration orchestration planners, mission dependency graph tools.
...
- Prefer these protocol families for this skill: NIMS/ICS, STIX/TAXII, API/JSON.
