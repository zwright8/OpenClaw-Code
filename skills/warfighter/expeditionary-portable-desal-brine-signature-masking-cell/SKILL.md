---
name: expeditionary-portable-desal-brine-signature-masking-cell
description: Plan portable desalination operations that reduce detectable brine signatures while preserving potable output. Use when water sustainment must avoid adversary cueing and compliance failures.
---
...
Primary products for this skill: signature-masked discharge plan, potable continuity dashboard, environmental risk branch set.

## Domain Tool Stack

Use these tool categories as the baseline stack: desal telemetry services, discharge signature modelers, contamination and compliance analytics.

## Protocol Profile

Preferred protocol families for this skill: EPA telemetry profiles, OGC, signed manifests.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-desal-brine-signature-masking-v1` with `protocol_stack_id=ps-desal-brine-signature-masking-stack-v1`.
...
- Default packet IDs: DPL-DESAL-BRINE-SIGNATURE-MASKING-001, DPL-MULTI-DOMAIN-BATTLE-RHYTHM-FRAGMENT-RECOVERY-001.
