---
name: joint-hypersonic-threat-raid-break-and-dispersal-cell
description: Plan raid-break timing, defended-asset reprioritization, and force dispersal under hypersonic attack pressure. Use when commanders need compressed warning-to-decision cycles and resilient mission continuation branches.
---

# Joint Hypersonic Threat Raid-Break and Dispersal Cell
...
Primary products for this skill: Hypersonic raid-break decision ladder, defended-asset dispersal matrix, and continuity branch packet.
...
- Add `tool_suite_id=ts-joint-hypersonic-raid-break-and-force-dispersal-v1` + `protocol_stack_id=ps-joint-hypersonic-raid-break-and-force-dispersal-stack-v1` for this mission domain as default external integration profile.
- Add `packet_id=DPL-JOINT-HYPERSONIC-RAID-BREAK-AND-FORCE-DISPERSAL-001` for mission branches that can alter force posture, mission risk, or escalation dynamics.
