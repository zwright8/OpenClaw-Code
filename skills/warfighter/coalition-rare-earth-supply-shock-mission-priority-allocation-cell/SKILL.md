---
name: coalition-rare-earth-supply-shock-mission-priority-allocation-cell
description: Allocate mission-critical components during coalition rare-earth supply shocks. Use when contested supply chains threaten readiness of precision systems, radars, batteries, and aerospace assets.
---

# Coalition Rare-Earth Supply Shock Mission Priority Allocation Cell
...
Primary products for this skill: critical component allocation board, coalition industrial-priority matrix, readiness impact branch ladder.
...
- Prioritize these tool families for this domain: industrial base ERP/MRP systems, allied customs and sanctions analytics, readiness reporting systems, strategic mobility tools.
- Prioritize these protocol families for this domain: NATO logistics message standards, STIX/TAXII, USMTF.
