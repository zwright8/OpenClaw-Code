---
name: strategic-space-launch-fuel-oxidizer-contested-allocation-cell
description: Prioritize strategic launch fuel and oxidizer allocation under contested supply conditions. Use when launch campaign timelines, deterrence posture, and logistics shortfalls intersect.
---
...
Primary products for this skill: propellant allocation priority board, launch slip-risk matrix, substitute sourcing branch timeline.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-space-launch-propellant-allocation-v1` with `protocol_stack_id=ps-space-launch-propellant-stack-v1`.
...
- Default packet IDs: DPL-SPACE-PROPELLANT-ALLOC-001.
