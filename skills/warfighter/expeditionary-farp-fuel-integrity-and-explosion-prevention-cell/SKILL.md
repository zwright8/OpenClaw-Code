---
name: expeditionary-farp-fuel-integrity-and-explosion-prevention-cell
description: Plan fuel quality assurance, contamination response, and blast-risk controls for forward arming and refueling points in contested theaters.
---

# Expeditionary FARP Fuel Integrity and Explosion Prevention Cell
...
Primary products for this skill: fuel integrity audit, contamination isolation plan, FARP blast standoff matrix.

## External Tools and Protocol Integration

- Suggested tools: fuel assay sensors, POL logistics systems, weather/lightning feeds, EOD incident logs.
- Protocol/message standards: USMTF, OGC SensorThings API, STANAG 7149, JSON/REST.
