---
name: tactical-forward-surgical-oxygen-and-power-coupling-cell
description: Coordinate coupled oxygen and power resilience for forward surgical teams in contested environments. Use when surgical throughput depends on synchronized life-support utilities and rapid failover.
---
...
Primary products for this skill: forward surgical utility resilience matrix, oxygen and power coupling status board, casualty throughput branch triggers.
...
- Default to `tool_suite_id=ts-forward-surgical-oxygen-power-coupling-v1` and `protocol_stack_id=ps-forward-surgical-oxygen-power-coupling-stack-v1` for mission-critical recommendations in this domain.
