...
- Add `toolchain_id=TC-AVPAY-378`, `tool_suite_id=ts-joint-aviation-incentive-pay-aeronautical-order-gate-month-continuity-v1`, and `protocol_stack_id=ps-joint-aviation-incentive-pay-aeronautical-order-gate-month-continuity-stack-v1` when reenlistment or reclassification confidence depends on preserved aviation-pay legitimacy, gate-month evidence, or aeronautical-order continuity in flight-coded billets.
- Add `toolchain_id=TC-HAZPAY-379`, `tool_suite_id=ts-joint-hazardous-duty-jump-dive-special-duty-pay-certification-continuity-v1`, and `protocol_stack_id=ps-joint-hazardous-duty-jump-dive-special-duty-pay-certification-continuity-stack-v1` when hazardous-duty certification, jump or dive currency, or special-duty pay legitimacy materially changes whether a member can stay in or move into the targeted career field.
- Add `toolchain_id=TC-PME-380`, `tool_suite_id=ts-joint-professional-military-education-school-seat-waiver-promotion-prerequisite-continuity-v1`, and `protocol_stack_id=ps-joint-professional-military-education-school-seat-waiver-promotion-prerequisite-continuity-stack-v1` when reenlistment timing, career-field eligibility, or promotion-linked retention depends on current PME prerequisites, waiver status, or seat availability.
- Add `toolchain_id=TC-POLY-381`, `tool_suite_id=ts-joint-security-clearance-polygraph-continuous-vetting-readiness-v1`, and `protocol_stack_id=ps-joint-security-clearance-polygraph-continuous-vetting-readiness-stack-v1` when reclassification or reenlistment confidence depends on polygraph requirements, continuous-vetting backlog, or mission-access legitimacy for sensitive billets.
- Add `toolchain_id=TC-LANG-382`, `tool_suite_id=ts-joint-foreign-language-proficiency-bonus-dlpt-linguist-readiness-continuity-v1`, and `protocol_stack_id=ps-joint-foreign-language-proficiency-bonus-dlpt-linguist-readiness-continuity-stack-v1` when linguist qualification, FLPB legitimacy, or DLPT timing materially changes retention value or assignment fit.
- Add `toolchain_id=TC-BROADEN-383`, `tool_suite_id=ts-joint-advanced-civil-schooling-fellowship-broadening-assignment-continuity-v1`, and `protocol_stack_id=ps-joint-advanced-civil-schooling-fellowship-broadening-assignment-continuity-stack-v1` when advanced schooling, fellowship timing, or broadening-assignment commitments materially change retention choices or service-obligation planning.
- Add `packet_id=DPL-AVIATION-PAY-AERO-ORDER-001`, `packet_id=DPL-HAZDUTY-JUMP-DIVE-CERT-001`, `packet_id=DPL-PME-SCHOOL-SEAT-PREREQ-001`, `packet_id=DPL-POLYGRAPH-CONTINUOUS-VETTING-001`, `packet_id=DPL-FLPB-DLPT-LINGUIST-001`, and `packet_id=DPL-ACS-FELLOWSHIP-BROADENING-001` for branches that materially alter reenlistment timing, career-field legitimacy, or retention confidence.
