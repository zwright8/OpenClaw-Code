---
name: strategic-reserve-component-medical-readiness-surge-cell
description: Coordinate Reserve and National Guard medical readiness surge to backfill active component demand. Use when theater casualty load exceeds forward care capacity.
---
...
1. Frame the mission problem with: readiness rosters, clinical credential status, mobility windows, demand forecasts.
...
Primary products for this skill: surge sourcing roster, credential exception ladder, deployment phasing timeline.

## U.S. Warfighter Employment Notes

- Use reserve surge as a time-phased capacity bridge while preserving homeland response obligations.
...
- For this domain, prioritize ts-reserve-medical-surge-v1 with ps-reserve-medical-surge-stack-v1.
