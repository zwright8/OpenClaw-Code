---
name: legal-roe-compliance-checker
description: Check operational concepts for legal and ROE alignment. Use when reviewing targeting, detention, collection, and escalation actions before execution.
---

# Legal ROE Compliance Checker
...
1. Frame the mission problem using these core inputs: proposed actions, authorities, ROE extracts, LOAC considerations.
...
Primary products for this skill: legal risk findings, ROE compliance checklist, required approvals list.
