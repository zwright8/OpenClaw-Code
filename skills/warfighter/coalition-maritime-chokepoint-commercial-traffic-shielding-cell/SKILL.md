---
name: coalition-maritime-chokepoint-commercial-traffic-shielding-cell
description: Coordinate coalition protection of commercial maritime traffic through contested chokepoints while preserving military maneuver options. Use when warfighters must deconflict force operations with civilian shipping continuity.
---
...
Primary products for this skill: commercial traffic shielding matrix, chokepoint risk branch map, convoy deconfliction order.
...
- Add `tool_suite_id=ts-maritime-chokepoint-commercial-traffic-shielding-v1` + `protocol_stack_id=ps-maritime-chokepoint-commercial-traffic-shielding-stack-v1` when producing critical recommendations for this mission domain.
