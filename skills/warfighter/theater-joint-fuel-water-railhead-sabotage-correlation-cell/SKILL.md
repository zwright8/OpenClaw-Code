---
name: theater-joint-fuel-water-railhead-sabotage-correlation-cell
description: Correlate sabotage indicators across railheads, fuel farms, and water nodes to protect sustainment continuity under hybrid attack.
---
...
Primary products: sabotage correlation heatmap, sustainment branch ladder, railhead continuity board, and authority escalation ledger.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-fuel-water-railhead-sabotage-correlation-v1` with `protocol_stack_id=ps-fuel-water-railhead-sabotage-correlation-stack-v1`.
...
- Default packet IDs: DPL-FUEL-WATER-RAILHEAD-SABOTAGE-001, DPL-SUSTAINMENT-CORRELATION-BRANCH-001.
