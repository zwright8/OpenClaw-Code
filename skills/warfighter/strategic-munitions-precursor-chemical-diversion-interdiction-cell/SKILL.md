---
name: strategic-munitions-precursor-chemical-diversion-interdiction-cell
description: Detect and interdict diversion of precursor chemicals critical to munitions production. Use when strategic production continuity is at risk from theft, fraud, or sanctions evasion.
---
...
Primary products for this skill: precursor diversion risk ledger, interdiction options matrix, and production continuity mitigation packet.
...
- Bind recommendations to tool_suite_id=ts-strategic-munitions-precursor-chemical-diversion-interdiction-cell-v1 and protocol_stack_id=ps-strategic-munitions-precursor-chemical-diversion-interdiction-cell-stack-v1.
- Use packet templates in ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-MUNITION-PRECURSOR-DIVERSION-001 for critical recommendations.
- Prioritize these protocol families for this domain: EDI X12, STIX/TAXII, USMTF, API/JSON.
