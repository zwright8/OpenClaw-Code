---
name: joint-riverine-drone-smuggling-interdiction-cell
description: Coordinate joint riverine interdiction against drone-enabled smuggling corridors while balancing civilian traffic and legal evidence capture.
---
...
Primary products for this skill: riverine drone-smuggling interdiction matrix, interdiction timing window board, evidence custody handoff packet.
...
- Add `tool_suite_id=ts-riverine-drone-smuggling-interdiction-v1` + `protocol_stack_id=ps-riverine-drone-smuggling-interdiction-stack-v1` when producing critical recommendations for this mission domain.
