---
name: coalition-sanctions-maritime-insurance-evasion-disruption-cell
description: Disrupt maritime sanctions evasion by fusing vessel identity, insurance fraud, and ownership-obfuscation indicators with coalition legal controls.
---

# Coalition Sanctions Maritime Insurance Evasion Disruption Cell
...
Primary products for this skill: maritime sanctions evasion network map, interdiction legal confidence ladder, coalition disruption sequencing board.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: maritime COP and AIS analytics, cargo and ownership anomaly graphing tools, sanctions enforcement ledgers, legal evidence custody trackers.
...
- Prefer these protocol families for this skill: AIS/NMEA, STIX/TAXII, NATO APP-11/ADatP-3 aligned, USMTF, API/JSON.
...
- Primary: `tool_suite_id=ts-sanctions-evasion-maritime-disruption-v1` with `protocol_stack_id=ps-sanctions-evasion-maritime-disruption-stack-v1`.
- Alternate: `tool_suite_id=ts-maritime-interdiction-v1` with `protocol_stack_id=ps-joint-tactical-link-stack-v1`.
