---
name: strategic-defense-industrial-sabotage-insider-risk-fusion-cell
description: Fuse cyber, physical security, and workforce anomaly indicators to detect and contain defense-industrial sabotage threats.
---

# Strategic Defense Industrial Sabotage Insider Risk Fusion Cell
...
Primary products for this skill: insider-risk confidence board, sabotage kill-chain interruption plan, industrial continuity decision packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: industrial SOC/SIEM, physical access control analytics, supply chain integrity registries.
...
- Primary: `tool_suite_id=ts-industrial-sabotage-fusion-v1`.
...
- Prefer `tool_suite_id=ts-industrial-sabotage-fusion-v1` for primary decision support and bind to mission packet `DPL-INDUSTRIAL-SABOTAGE-001`.
- Use `tool_suite_id=ts-cyber-defense-v1` as required cross-check for divergence or trust-score decay.
- Include `packet_id=DPL-INDUSTRIAL-SABOTAGE-001`, `protocol_profile`, `ack_chain_status`, and `trust_score` in all commander-facing outputs.
