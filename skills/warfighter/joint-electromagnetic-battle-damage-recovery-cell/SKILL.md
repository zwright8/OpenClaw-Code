---
name: joint-electromagnetic-battle-damage-recovery-cell
description: Assess and recover from electromagnetic battle damage affecting C2, sensing, and communications systems. Use when EMS effects degrade mission networks and platform readiness.
---
...
1. Frame the mission problem using these core inputs: post-strike EMS anomaly reports, comms outages, platform diagnostics, operational impact reports.
...
Primary products for this skill: electromagnetic recovery sequence, mission-priority restoration plan, residual risk statement.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools or tool families for this domain: EW diagnostics systems, network monitoring tools, mission assurance dashboards, platform readiness systems.
