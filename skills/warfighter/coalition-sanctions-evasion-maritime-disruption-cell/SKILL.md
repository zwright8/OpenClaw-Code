---
name: coalition-sanctions-evasion-maritime-disruption-cell
description: Disrupt maritime sanctions evasion networks with coalition legal and evidence continuity. Use when joint or allied forces need compliant interdiction options, attribution confidence, and escalation controls.
---
...
Primary products for this skill: sanctions evasion network disruption plan, coalition interdiction evidence packet, legal escalation matrix.
...
- Prioritize `tool_suite_id=ts-sanctions-evasion-maritime-network-disruption-v1` + `protocol_stack_id=ps-sanctions-evasion-maritime-network-disruption-stack-v1` for this mission set.
- Include `packet_id=DPL-SANCTIONS-EVASION-MARITIME-DISRUPTION-001` for high-consequence recommendations and branch decisions.
- Bind recommendations to `toolchain_profile_id=sanctions-evasion-maritime-disruption-v1` in joint operations profile selection.
