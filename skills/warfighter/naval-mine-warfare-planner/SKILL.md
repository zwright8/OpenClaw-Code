---
name: naval-mine-warfare-planner
description: Plan mine warfare support including mining, mine countermeasures, and maritime route risk reduction. Use when assessing sea lane access and protection options.
---

# Naval Mine Warfare Planner
...
1. Frame the mission problem using these core inputs: sea lane priorities, mine threat assessments, MCM assets, operational timelines.
...
Primary products for this skill: mine warfare support estimate, route risk matrix, MCM tasking board.
