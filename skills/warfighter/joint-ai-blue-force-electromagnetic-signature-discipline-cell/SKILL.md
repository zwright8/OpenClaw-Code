---
name: joint-ai-blue-force-electromagnetic-signature-discipline-cell
description: Reduce blue-force detectability by governing emissions discipline with AI-assisted signature-risk scoring. Use when maneuver survivability depends on electromagnetic signature control.
---
...
Primary products for this skill: EM signature risk heatmap, emission-control branch plan, fratricide-safe emissions matrix.

## Domain Tool Stack

Use these tool categories as the baseline stack: EMS COP tools, emitter inventory services, RF anomaly analytics, AI signature policy scorers.

## Protocol Profile

Preferred protocol families for this skill: VMF, Link 16 J-series, STANAG 4607, MIL-STD-188-220.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-blue-force-em-signature-discipline-v1` with `protocol_stack_id=ps-blue-force-em-signature-discipline-stack-v1`.
- Alternate: `tool_suite_id=ts-spectrum-governance-v1` with `protocol_stack_id=ps-spectrum-governance-stack-v1`.
...
- Default packet IDs: DPL-BLUEFOR-EM-SIGNATURE-DISCIPLINE-001, DPL-SPECTRUM-GOVERNANCE-001.
