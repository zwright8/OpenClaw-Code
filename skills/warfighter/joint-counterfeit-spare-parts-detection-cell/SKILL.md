---
name: joint-counterfeit-spare-parts-detection-cell
description: Support U.S. warfighter planning and decision support for Joint Counterfeit Spare Parts Detection Cell. Use when missions require Joint Counterfeit Spare Parts Detection Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: counterfeit part risk watchlist, inspection and quarantine workflow, mission-system release/hold board.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: supply provenance ledgers, parts forensics tools, maintenance release systems.
- Prioritize these protocol families for this domain: STIX/TAXII, USMTF, API/JSON.
