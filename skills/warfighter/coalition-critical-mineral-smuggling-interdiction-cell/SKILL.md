---
name: coalition-critical-mineral-smuggling-interdiction-cell
description: Detect and disrupt illicit flows of critical minerals that sustain adversary military production or sanctions evasion. Use for maritime, land, and financial interdiction synchronization.
---
...
1. Frame the mission problem using these core inputs: shipment manifests and anomalies, smuggling network indicators, coalition legal authorities, interdiction asset posture.
...
Primary products for this skill: critical mineral interdiction plan, suspect network priority board, legal-action synchronization matrix.
...
- Primary: `tool_suite_id=ts-critical-mineral-interdiction-v1` with `protocol_stack_id=ps-coalition-interdiction-ledger-stack-v1`.
