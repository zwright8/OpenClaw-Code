...
description: Assess adversary kill-web vulnerabilities and branch options that disrupt targeting chains without creating uncontrolled escalation. Use when commanders need decision-ready kill-web disruption analysis with protocol-bound outputs.
---
...
Primary products for this skill: kill-web disruption branch matrix, dependency fracture map, and escalation-safe disruption options board.
...
- Bind recommendations to tool_suite_id=ts-joint-adversary-kill-web-disruption-assessment-cell-v1 and protocol_stack_id=ps-joint-adversary-kill-web-disruption-assessment-cell-stack-v1.
- Use packet templates in ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-KILLWEB-DISRUPT-002 for critical recommendations.
- Prioritize these protocol families for this domain: USMTF, STIX/TAXII, Link 16 J-series, API/JSON.
