---
name: urban-subsurface-raid-safety-and-utility-protection-cell
description: Support raid planning in dense urban subsurface environments while protecting critical utilities. Use when operations require tunnel/subsurface maneuver, civilian-harm mitigation, and utility survivability constraints.
---
...
Primary products for this skill: subsurface raid safety packet, utility protection overlay, no-strike and hazard decision board.
...
- Prioritize `tool_suite_id=ts-urban-subsurface-raid-safety-v1` + `protocol_stack_id=ps-urban-subsurface-raid-safety-stack-v1` for this mission set.
- Include `packet_id=DPL-URBAN-SUBSURFACE-RAID-SAFETY-001` for high-consequence recommendations and branch decisions.
- Bind recommendations to `toolchain_profile_id=urban-subsurface-raid-safety-v1` in joint operations profile selection.
