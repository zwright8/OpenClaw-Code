...
description: Support U.S. warfighter planning and decision support for Coalition Fires Clearance and Digital ROE Cell. Use when missions require coalition-fires-clearance-and-digital-roe-cell planning, integrated options, and protocol-aware staff outputs.
---
...
- Prioritize these tools or protocol families for this domain: joint fires coordination systems, ROE decision support tools, coalition clearance trackers.
- State the protocol or message format for outbound coordination (for example VMF, Link 16 J-series, NATO APP-11/ADatP-3).
