---
name: theater-undersea-fiber-tap-attribution-and-isolation-cell
description: Support warfighter planning to detect, attribute, and isolate hostile undersea fiber tapping in contested maritime theaters.
---
...
- Primary: `tool_suite_id=ts-undersea-fiber-tap-attribution-v1` with `protocol_stack_id=ps-undersea-fiber-tap-attribution-stack-v1`.
- Alternate: `tool_suite_id=ts-subsea-cable-segment-isolation-v1` with `protocol_stack_id=ps-subsea-cable-segment-isolation-stack-v1`.
...
- Default packet IDs: DPL-UNDERSEA-FIBER-TAP-ATTRIBUTION-001, DPL-SUBSEA-CABLE-SEGMENT-ISOLATION-001.
