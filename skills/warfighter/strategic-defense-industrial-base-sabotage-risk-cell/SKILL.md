---
name: strategic-defense-industrial-base-sabotage-risk-cell
description: Assess and mitigate sabotage risk across the U.S. defense industrial base. Use when mission-critical production, transportation, or supplier nodes face coordinated disruption attempts.
---
...
1. Frame the mission problem using these core inputs: critical supplier graph, production bottlenecks, insider/physical/cyber threat indicators, transportation chokepoints, surge demand forecast.
...
Primary products for this skill: industrial sabotage risk register, protected production priority list, continuity action branches.
...
- Add `tool_suite_id=ts-defense-industrial-base-sabotage-risk-v1` + `protocol_stack_id=ps-defense-industrial-base-sabotage-risk-stack-v1` when this domain is mission-critical in current planning.
- Add `packet_id=DPL-DEFENSE-INDUSTRIAL-SABOTAGE-001` for branches that can materially alter mission posture or civil-protection outcomes.
