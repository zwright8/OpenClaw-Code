---
name: coalition-disaster-relief-airdrop-corridor-assurance-cell
description: Assure safe, deconflicted coalition airdrop corridors for humanitarian relief in contested or disaster-struck regions. Use when airspace congestion, weather, and security risks threaten relief flow.
---

# Coalition Disaster Relief Airdrop Corridor Assurance Cell
...
1. Frame the mission problem using these core inputs: air corridor demand, weather and hazard overlays, drop-zone validation status, and coalition airspace rules.
...
Primary products for this skill: airdrop corridor deconfliction matrix, drop-zone assurance board, relief throughput risk timeline.
...
## Domain Toolchain Override (2026-03-09, Coalition Relief Airdrop Corridor Governance)

- Prioritize tool_suite_id=ts-disaster-relief-airdrop-corridor-assurance-v1 with protocol_stack_id=ps-disaster-relief-airdrop-corridor-assurance-stack-v1 for high-tempo coalition relief flights in constrained airspace.
- Use packet DPL-DISASTER-RELIEF-AIRDROP-CORRIDOR-ASSURANCE-001 to bind corridor priorities, drop-zone confidence, and humanitarian deconfliction actions.
- If corridor deconfliction or partner acknowledgment integrity degrades, publish constrained-drop recommendations and require air component commander approval.
