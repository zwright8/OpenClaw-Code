---
name: strategic-domestic-industrial-cyber-sabotage-containment-cell
description: Support U.S. warfighter strategic planning for domestic defense-industrial cyber sabotage containment. Use when manufacturing disruption, OT compromise, and surge production restoration must be coordinated.
---
...
Primary products for this skill: industrial sabotage containment matrix, production restoration ladder, OT isolation decision board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-industrial-cyber-sabotage-containment-v1` with `protocol_stack_id=ps-cyber-incident-response-stack-v1`.
- Alternate: `tool_suite_id=ts-cyber-defense-v1` with `protocol_stack_id=ps-cyber-threat-intel-stack-v1`.
...
- Default packet IDs: DPL-IND-CYBER-SABOTAGE-001, DPL-MUNI-QA-001.
