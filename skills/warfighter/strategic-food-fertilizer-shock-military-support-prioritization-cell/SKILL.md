---
name: strategic-food-fertilizer-shock-military-support-prioritization-cell
description: Prioritize military support options under food and fertilizer supply shocks that threaten stability and force sustainment.
---
...
Primary products for this skill: food/fertilizer shock risk board, military support prioritization matrix, stability trigger escalation packet.

## Domain Tool Stack

Use these tool categories as the baseline stack: commodity flow analytics, agricultural yield intelligence, strategic mobility planning tools, civil support operations dashboard.

## Protocol Profile

Preferred protocol families for this skill: NIMS/ICS, USMTF, EDI X12, API/JSON.
...
- Prioritize `tool_suite_id=ts-strategic-food-fertilizer-shock-military-support-prioritization-cell-v1` + `protocol_stack_id=ps-strategic-food-fertilizer-shock-military-support-prioritization-cell-stack-v1` when this mission set is the critical path for commander decision timelines.
- Add `packet_id=DPL-STRATEGIC_FOOD_FERTILIZER_SHOCK_MILITARY_SUPPORT_PRIORITIZATION_CELL-001` for the primary course of action and `packet_id=DPL-STRATEGIC_FOOD_FERTILIZER_SHOCK_MILITARY_SUPPORT_PRIORITIZATION_CELL-002` for degraded-mode fallback actions.
