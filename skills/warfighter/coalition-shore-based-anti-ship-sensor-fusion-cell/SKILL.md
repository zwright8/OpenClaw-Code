---
name: coalition-shore-based-anti-ship-sensor-fusion-cell
description: Support coalition littoral defense by fusing shore-based anti-ship sensor data for cueing, deconfliction, and survivable targeting support.
---
...
Primary products for this skill: sensor fusion confidence board, maritime cueing priority matrix, coalition deconfliction packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: maritime COP, coastal radar and EO/IR feeds, AIS analytics, coalition data-sharing services.

## Protocol Profile

Preferred protocol families for this skill: AIS/NMEA, Link 16 J-series, NATO APP-11/ADatP-3 aligned.

## Domain Toolchain Defaults

- Primary: \ with \.\n- Alternate: \ with \.\n- Degraded: sectorized manual coastal watch with periodic commander synchronization.
...
- Prefer these protocol families for this skill: AIS/NMEA, Link 16 J-series, NATO APP-11/ADatP-3 aligned.
