---
name: homeland-critical-satcom-ground-station-hardening-cell
description: Support hardening and continuity planning for critical homeland SATCOM ground stations facing cyber-physical and EW threats. Use for resilient strategic communications posture management.
---
...
Primary products for this skill: ground-station hardening sequence, SATCOM continuity fallback matrix, strategic comms risk posture brief.
...
- Prioritize these tool/protocol families for this domain: SATCOM network health monitors, infrastructure hardening planners, cyber-physical incident response boards.
