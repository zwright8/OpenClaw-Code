---
name: expeditionary-food-supply-safety-and-contamination-cell
description: Prevent and contain food-borne hazards in deployed operations while preserving ration throughput and force health. Use when contamination, spoilage, or tampering indicators emerge.
---
...
1. Frame the mission problem using these core inputs: food source chain data, temperature and cold-chain status, contamination indicators, force consumption forecast.
...
Primary products for this skill: food safety containment order, contaminated-lot disposition matrix, ration continuity plan.
