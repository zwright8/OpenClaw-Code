---
name: casualty-evac-and-medical-regulation
description: Structure casualty evacuation and medical regulation workflows. Use when planning CASEVAC/MEDEVAC routing, treatment capacity balancing, and medical command-and-control updates.
---

# Casualty Evac And Medical Regulation
...
1. Frame the mission problem using these core inputs: casualty estimates, medical facility capacity, transport options, threat to routes.
...
Primary products for this skill: evacuation routing plan, treatment load-balancing table, medical C2 dashboard.
