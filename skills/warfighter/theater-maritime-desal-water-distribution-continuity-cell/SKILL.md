---
name: theater-maritime-desal-water-distribution-continuity-cell
description: Maintain maritime desalination and water distribution continuity under disruption and contamination pressure. Use when expeditionary forces depend on afloat and shore-linked water production chains.
---

# Theater Maritime Desalination And Water Distribution Continuity Cell
...
Primary products for this skill: desal throughput continuity map, water quality risk board, distribution branch timeline.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-maritime-desal-water-continuity-v1` with `protocol_stack_id=ps-maritime-desal-water-stack-v1`.
...
- Default packet IDs: DPL-MARITIME-DESAL-001.
