---
name: coalition-cross-border-undersea-power-cable-sabotage-response-cell
description: Support coalition response to cross-border undersea power-cable sabotage with legal authority synchronization and grid continuity.
---
...
Use these tool categories by default: cable telemetry fusion boards, cross-border legal authority ledgers, and grid restoration dependency engines.

## Protocol Profile

Preferred protocol families for this skill: AIS/NMEA, NIMS/ICS, USMTF, NATO APP-11/ADatP-3 aligned, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-COALITION-CROSS-BORDER-UNDERSEA-POWER-CABLE-SABOTAGE-RESPONSE-001 for critical recommendations.
