---
name: combat-engineering-urban-breach-synchronizer
description: Synchronize urban breaching operations across maneuver, fires, EOD, and protection elements. Use when dense urban obstacles require timed multi-domain breach execution.
---
...
1. Frame the mission problem using these core inputs: obstacle intelligence, engineer asset readiness, collateral-risk constraints, route survivability data.
...
Primary products for this skill: urban breach synchronization matrix, lane proofing plan, breach branch triggers.
...
- Prioritize these tools or tool families for this domain: engineer planning tools, route clearance systems, C2 COP platforms, ISR geospatial tools.
- Specify outbound exchange format for recommendations and tasking: VMF, CoT, USMTF, OGC WMS/WFS/WMTS.
