---
name: joint-subsea-telecom-repeater-tamper-hunt-and-restoration-cell
description: Coordinate detection, attribution, and restoration for tampered subsea telecom repeaters supporting joint military command pathways. Use when undersea communications degradation threatens operational command continuity or ISR dissemination.
---

# Joint Subsea Telecom Repeater Tamper Hunt And Restoration Cell
...
1. Frame the mission problem using these core inputs: undersea cable repeater telemetry, optical power anomalies, repair vessel availability, and mission network priority routes.
...
Primary products for this skill: tamper attribution matrix, repeater restoration sequencing board, mission-network reroute decision ladder.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: subsea telemetry analytics, cable landing station dashboards, maritime repair orchestration systems.
...
## Domain Toolchain Override (2026-03-09, Subsea Repeater Tamper Branch)

- Prioritize tool_suite_id=ts-subsea-repeater-tamper-restoration-v1 with protocol_stack_id=ps-subsea-repeater-tamper-restoration-stack-v1 when command-critical undersea circuits show coordinated power or latency anomalies.
- Use packet DPL-SUBSEA-REPEATER-TAMPER-RESTORATION-001 to bind tamper confidence, reroute branch triggers, and repair convoy synchronization steps.
- If telemetry confidence or acknowledgment integrity degrades, publish advisory-only reroute guidance and require explicit commander approval before network posture changes.
