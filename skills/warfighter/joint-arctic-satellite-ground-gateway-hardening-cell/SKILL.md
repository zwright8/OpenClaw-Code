---
name: joint-arctic-satellite-ground-gateway-hardening-cell
description: Support U.S. warfighter planning and operational decision support for Joint Arctic Satellite Ground Gateway Hardening Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: commander intent, gateway topology, threat reports, weather and space-weather constraints.
...
Primary products for this skill: gateway hardening plan, arctic satcom redundancy matrix, adversary interference response playbook.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: satcom planning tools, SDA catalogs, cyber defense telemetry, infrastructure assurance dashboards.
...
- Prefer these protocol families for this skill: USMTF, API/JSON, STIX/TAXII.
