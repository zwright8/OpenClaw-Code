---
name: expeditionary-water-purification-membrane-contamination-recovery-cell
description: Support U.S. warfighter planning for contaminated expeditionary water-purification systems with medical risk controls and sustainment continuity.
---
...
Use these tool categories by default: field-water telemetry boards, contamination adjudication engines, and purification mission-recovery schedulers.

## Protocol Profile

Preferred protocol families for this skill: USMTF, NIMS/ICS, HL7/FHIR, OGC WMS/WFS/WMTS, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-EXPEDITIONARY-WATER-PURIFICATION-MEMBRANE-CONTAMINATION-RECOVERY-001 for critical recommendations.
