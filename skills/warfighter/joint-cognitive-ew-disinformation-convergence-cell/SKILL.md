---
name: joint-cognitive-ew-disinformation-convergence-cell
description: Support U.S. warfighter planning for converged cognitive, EW, and disinformation threat response. Use when adversaries blend influence operations with electromagnetic attack and deception.
---
...
Primary products for this skill: converged threat timeline, narrative-EW linkage graph, counter-action release plan.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: OSINT narrative analytics, EW telemetry fusion boards, influence attribution platforms.
- Preferred protocol profile for machine and staff exchange: STIX/TAXII + CoT + USMTF.
- Default tool suite binding: `tool_suite_id=ts-cognitive-ew-disinformation-v1`.
- Default protocol stack binding: `protocol_stack_id=ps-cognitive-ew-convergence-stack-v1`.
- Default packet binding: `packet_id=DPL-COGNITIVE-EW-001`.
