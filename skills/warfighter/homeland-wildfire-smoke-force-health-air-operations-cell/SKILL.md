---
name: homeland-wildfire-smoke-force-health-air-operations-cell
description: Support homeland defense force-health and sortie planning under large-scale wildfire smoke and visibility degradation.
---

# Homeland Wildfire Smoke Force Health Air Operations Cell
...
- Primary: `tool_suite_id=ts-homeland-wildfire-smoke-air-operations-v1` with `protocol_stack_id=ps-homeland-wildfire-smoke-air-operations-stack-v1`.
- Alternate: `tool_suite_id=ts-medical-force-health-v1` with `protocol_stack_id=ps-medical-evacuation-coordination-stack-v1`.
...
- Default packet IDs: DPL-HOMELAND-WILDFIRE-SMOKE-AIR-OPS-001, DPL-CEMA-BDA-001.
