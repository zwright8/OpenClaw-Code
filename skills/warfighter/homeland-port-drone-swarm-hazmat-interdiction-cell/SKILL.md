---
name: homeland-port-drone-swarm-hazmat-interdiction-cell
description: Coordinate homeland port defense against drone-swarm-enabled hazardous material interdiction scenarios. Use when military and civil agencies must synchronize counter-UAS, HAZMAT response, and maritime continuity.
---
...
Primary products for this skill: drone swarm interdiction matrix, HAZMAT maritime isolation sequence, port continuity decision packet.

## Domain Tool Stack

Use these tool categories as the baseline stack: counter-UAS command systems, port surveillance fusion tools, HAZMAT plume modeling platforms, Coast Guard incident coordination systems.

## Protocol Profile

Preferred protocol families for this skill: NIMS/ICS message profiles, AIS, USMTF, CBRN hazard reporting formats, STANAG 4607.
