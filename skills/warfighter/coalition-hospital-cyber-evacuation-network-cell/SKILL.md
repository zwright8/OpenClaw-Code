---
name: coalition-hospital-cyber-evacuation-network-cell
description: Coordinate coalition medical evacuation and bed network continuity when hospital IT systems are degraded by cyber or ransomware conditions.
---
...
Primary products for this skill: coalition medevac reroute matrix, hospital network degradation tracker, cyber-safe patient movement plan.
...
- For this domain, prioritize `ts-coalition-hospital-cyber-evac-v1` with `ps-coalition-hospital-cyber-evac-stack-v1` and `DPL-COALITION-HOSPITAL-CYBER-EVAC-001`.
