---
name: theater-electronic-order-of-life-pattern-shift-cell
description: Support U.S. warfighter planning and decision support for Theater Electronic Order of Life Pattern Shift Cell. Use when missions require Theater Electronic Order of Life Pattern Shift Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: electronic baseline-of-life model, anomaly escalation matrix, deception indicator report.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: EW telemetry stores, pattern analytics pipelines, adversary signature libraries.
- Prioritize these protocol families for this domain: STIX/TAXII, MISP, USMTF, API/JSON.
