---
name: tactical-counter-precision-fires-thermal-signature-management-cell
description: Control thermal signatures and displacement timing to reduce precision-fire vulnerability of tactical units and support nodes.
---
...
Primary products for this skill: thermal signature suppression plan, sensor exposure timeline, displacement trigger matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-counter-precision-fires-thermal-signature-v1` with `protocol_stack_id=ps-counter-precision-thermal-signature-stack-v1`.
- Alternate: `tool_suite_id=ts-joint-c2-fusion-v1` with `protocol_stack_id=ps-farp-survivability-stack-v1`.
...
- Default packet IDs: DPL-COUNTER-PRECISION-THERMAL-SIGNATURE-001.
