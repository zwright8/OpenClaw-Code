---
name: coalition-contested-spectrum-fratricide-prevention-cell
description: Support coalition spectrum fratricide prevention under contested electromagnetic conditions. Use when allied emitters, jammers, and datalinks require synchronized controls to avoid blue-on-blue interference.
---
...
Primary products for this skill: coalition emitter conflict board, fratricide risk ladder, spectrum deconfliction order.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-spectrum-fratricide-prevention-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Preferred protocol families: Link 16 J-series, VMF, USMTF.
...
- Default packet IDs: DPL-SPECTRUM-FRAT-001, DPL-EW-LEASE-001.
