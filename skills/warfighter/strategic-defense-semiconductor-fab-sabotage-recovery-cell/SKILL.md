---
name: strategic-defense-semiconductor-fab-sabotage-recovery-cell
description: Restore defense semiconductor production after sabotage while preserving trusted-chip integrity and mission-priority allocation.
---
...
- Primary: `tool_suite_id=ts-defense-semiconductor-fab-sabotage-recovery-v1` with `protocol_stack_id=ps-defense-semiconductor-fab-sabotage-recovery-stack-v1`.
...
- Default packet IDs: `DPL-DEFENSE-SEMICONDUCTOR-FAB-RECOVERY-001`, `DPL-TRUSTED-CHIP-SUPPLY-ALLOCATION-001`.
