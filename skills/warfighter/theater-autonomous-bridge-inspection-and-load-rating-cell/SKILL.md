---
name: theater-autonomous-bridge-inspection-and-load-rating-cell
description: Employ autonomous sensing to inspect damaged bridges, estimate military load classes, and sequence crossing operations. Use when mobility corridors depend on rapid structural confidence under threat.
---

# Theater Autonomous Bridge Inspection and Load Rating Cell
...
1. Frame the mission problem using these core inputs: bridge imagery and lidar capture, structural sensor telemetry, unit crossing demand, and engineer availability.
...
Primary products for this skill: bridge load-rating confidence map, crossing sequence matrix, repair or bypass decision packet.
...
## Domain Toolchain Override (2026-03-09, Autonomous Bridge Load-Rating Assurance)

- Prioritize tool_suite_id=ts-autonomous-bridge-load-rating-v1 with protocol_stack_id=ps-autonomous-bridge-load-rating-stack-v1 when maneuver timelines require rapid crossing decisions with incomplete structural certainty.
- Use packet DPL-AUTONOMOUS-BRIDGE-LOAD-RATING-001 to link sensor confidence, crossing order, and heavy-load authorization gates.
- If structural confidence drops below threshold, issue constrained movement recommendations and require commander plus chief engineer concurrence.
