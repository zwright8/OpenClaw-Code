---
name: battlefield-neuromorphic-sensor-anomaly-triage-cell
description: Triage neuromorphic and edge-AI sensor anomalies on the battlefield. Use when novel sensor classes generate uncertain detections that can affect fires, maneuver, or force protection decisions.
---

# Battlefield Neuromorphic Sensor Anomaly Triage Cell
...
Primary products for this skill: sensor anomaly triage board, confidence-tiered cueing plan, false-positive suppression workflow.
...
- Prioritize these tool families for this domain: edge sensor management platforms, MLOps drift monitors, ISR fusion systems, EW spectrum monitors.
- Prioritize these protocol families for this domain: CoT, OGC WMS/WFS, STIX/TAXII.
