---
name: coalition-arctic-fiber-microwave-troposcatter-failover-cell
description: Support U.S. warfighter planning and decision support for Coalition Arctic Fiber Microwave Troposcatter Failover Cell. Use when missions require arctic coalition transport failover across fiber, microwave, and troposcatter paths under weather and threat pressure, integrated options, and protocol-aware staff outputs.
---

# Coalition Arctic Fiber Microwave Troposcatter Failover Cell
...
Primary products for this skill: arctic transport failover matrix, coalition priority-service routing ladder, weather-threat branch packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: transport path assurance dashboards, arctic weather risk forecasters, coalition service-priority orchestrators.
...
- Prefer these protocol families for this skill: NATO APP-11/ADatP-3 aligned, USMTF, STIX/TAXII, API/JSON.
...
- Primary: tool_suite_id=ts-coalition-arctic-fiber-microwave-troposcatter-failover-cell-v1 with protocol_stack_id=ps-coalition-arctic-fiber-microwave-troposcatter-failover-cell-stack-v1.
- Alternate: tool_suite_id=ts-coalition-host-nation-fiber-cut-and-backhaul-restoration-cell-v1 with protocol_stack_id=ps-coalition-host-nation-fiber-cut-and-backhaul-restoration-cell-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-ARCTIC-TRANSPORT-FAILOVER-001, DPL-ARCTIC-TRANSPORT-FAILOVER-002.
