---
name: coalition-civil-maritime-autonomy-jamming-response-cell
description: Protect coalition civil and military autonomous maritime corridors during GPS and command-link jamming campaigns.
---
...
Primary products: autonomy corridor survivability brief, jamming response decision tree, convoy reroute matrix, and coalition acknowledgment packet.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-civil-maritime-autonomy-jamming-response-v1` with `protocol_stack_id=ps-civil-maritime-autonomy-jamming-response-stack-v1`.
...
- Default packet IDs: DPL-MARITIME-AUTONOMY-JAMMING-001, DPL-COALITION-CORRIDOR-REROUTE-001.
