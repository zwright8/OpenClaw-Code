---
name: theater-civil-power-grid-load-shedding-coordination-cell
description: Support U.S. warfighter planning and decision support for Theater Civil Power Grid Load Shedding Coordination Cell. Use when missions require Theater Civil Power Grid Load Shedding Coordination Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: load shedding mission-priority map, restoration sequencing board, civilian critical-service protection matrix.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: grid telemetry platforms, utility dispatch systems, emergency operations dashboards.
- Prioritize these protocol families for this domain: NIMS/ICS, USMTF, API/JSON.
