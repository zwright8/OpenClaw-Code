---
name: theater-forward-microreactor-fuel-security-and-blackstart-cell
description: Coordinate theater microreactor fuel security, sabotage response, and blackstart-driven mission-energy restoration.
---
...
Primary products: microreactor fuel-risk matrix, blackstart release ladder, mission-energy assurance packet.
...
- Primary: `tool_suite_id=ts-theater-forward-microreactor-fuel-security-blackstart-v1` with `protocol_stack_id=ps-theater-forward-microreactor-fuel-security-blackstart-stack-v1`.
...
- Default packet IDs: `DPL-THEATER-FORWARD-MICROREACTOR-FUEL-SECURITY-BLACKSTART-001`.
