---
name: joint-aviation-fuel-quality-and-contamination-forensics-cell
description: Detect, triage, and investigate aviation fuel contamination threats to protect sortie generation and flight safety. Use when fuel supply integrity is uncertain across expeditionary or coalition fuel points.
---
...
1. Frame the mission problem using these core inputs: fuel sample telemetry, sortie demand profile, distribution chain custody, contamination indicators, and maintenance incident reports.
...
Primary products for this skill: fuel contamination incident brief, sortie fuel risk posture update, remediation and recertification plan.
...
- Primary: `tool_suite_id=ts-aviation-fuel-integrity-v1` with `protocol_stack_id=ps-fuel-quality-forensics-stack-v1`.
- Alternate: `tool_suite_id=ts-airfield-recovery-v1` with `protocol_stack_id=ps-aviation-weather-stack-v1`.
