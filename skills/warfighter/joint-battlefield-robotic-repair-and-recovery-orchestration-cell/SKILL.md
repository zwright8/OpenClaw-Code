---
name: joint-battlefield-robotic-repair-and-recovery-orchestration-cell
description: Support U.S. warfighter planning for autonomous and crewed robotic battlefield recovery, repair queue prioritization, and contested sustainment continuity.
---
...
Primary products for this skill: robotic recovery queue, repair confidence ladder, mobility-restoration command packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: autonomous recovery fleet managers, battlefield damage triage engines, repair-parts routing boards.
...
- Prefer protocol families: USMTF, VMF, CoT, NIEM, API/JSON.
...
- Primary: tool_suite_id=ts-joint-battlefield-robotic-repair-recovery-orchestration-v1 with protocol_stack_id=ps-joint-battlefield-robotic-repair-recovery-orchestration-stack-v1.
...
- Default packet IDs: DPL-BATTLEFIELD-ROBOTIC-REPAIR-RECOVERY-001, DPL-BATTLEFIELD-ROBOTIC-REPAIR-RECOVERY-002.
