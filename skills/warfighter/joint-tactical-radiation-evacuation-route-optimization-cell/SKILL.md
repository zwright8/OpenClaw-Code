---
name: joint-tactical-radiation-evacuation-route-optimization-cell
description: Optimize tactical evacuation routing around radiation hazard dynamics while preserving force protection and treatment timelines.
---
...
Primary products for this skill: radiation-safe evacuation route matrix, route invalidation trigger chart, casualty flow optimization board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-tactical-radiation-evac-routing-v1` with `protocol_stack_id=ps-tactical-radiation-evac-routing-stack-v1`.
...
- Default packet IDs: DPL-TACTICAL-RADIATION-EVAC-ROUTING-001.
