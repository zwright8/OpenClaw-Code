---
name: strategic-nc3-courier-eam-bridge-assurance-cell
description: Assure strategic NC3 continuity by bridging emergency action messages across digital and physical courier paths under network disruption.
---
...
Primary products for this skill: EAM digital-physical bridge matrix, courier acknowledgment integrity ledger, NC3 continuity decision card.
...
- Add `tool_suite_id=ts-nc3-courier-eam-bridge-assurance-v1` + `protocol_stack_id=ps-nc3-courier-eam-bridge-assurance-stack-v1` when producing critical recommendations for this mission domain.
