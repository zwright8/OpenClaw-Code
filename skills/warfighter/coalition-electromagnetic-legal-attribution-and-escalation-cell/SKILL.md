---
name: coalition-electromagnetic-legal-attribution-and-escalation-cell
description: Build coalition-grade legal attribution for electromagnetic incidents and prepare calibrated escalation response options.
---
...
Primary products for this skill: electromagnetic attribution evidence packet, coalition legal-advisory escalation matrix, response option decision ladder.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-spectrum-legal-attribution-v1` with `protocol_stack_id=ps-spectrum-legal-attribution-stack-v1`.
...
- Default packet IDs: DPL-SPECTRUM-LEGAL-ATTRIBUTION-001.
