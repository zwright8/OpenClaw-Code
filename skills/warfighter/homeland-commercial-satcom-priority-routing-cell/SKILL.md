---
name: homeland-commercial-satcom-priority-routing-cell
description: Support U.S. warfighter planning and decision support for Homeland Commercial Satcom Rapid Requisition And Priority Routing Cell. Use when missions require commercial SATCOM emergency requisition, priority routing arbitration, and mission continuity assurance, integrated options, and protocol-aware staff outputs.
---

# Homeland Commercial Satcom Rapid Requisition And Priority Routing Cell
...
Primary products for this skill: satcom requisition packet, priority routing matrix, mission continuity comms branch plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: SATCOM network management systems, commercial lease orchestration portals, mission network failover planners, link quality monitors.

## Protocol Profile

Preferred protocol families for this skill: USMTF, API/JSON, CCSDS.
...
- Start with tool_suite_id=ts-commercial-satcom-requisition-routing-v1 and protocol_stack_id=ps-commercial-satcom-requisition-routing-stack-v1, then branch only when mission constraints require it.
