---
name: joint-rail-sabotage-detection-and-continuity-cell
description: Detect, confirm, and mitigate sabotage against military rail corridors to preserve deployment and sustainment throughput. Use for high-tempo strategic movement resilience.
---
...
1. Frame the mission problem using these core inputs: rail sensor anomaly feed, route critical segments, repair crew availability, movement demand timeline.
...
Primary products for this skill: rail sabotage response plan, reroute or repair decision matrix, throughput continuity timeline.
...
- Primary: `tool_suite_id=ts-rail-sabotage-continuity-v1` with `protocol_stack_id=ps-rail-continuity-command-stack-v1`.
- Alternate: `tool_suite_id=ts-rail-bridge-recovery-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
