---
name: theater-fiber-backbone-restoration-and-reroute-cell
description: Restore and reroute theater fiber backbones after disruption while preserving mission network priorities.
---
...
Primary products for this skill: fiber restoration plan, reroute priority matrix, communications resilience timeline.
...
- Prioritize these domain tools: telecom fault localization systems, route engineering planners, mission traffic prioritizers, cyber incident response boards.
...
- `tool_suite_id`: `ts-fiber-backbone-restoration-v1`
- `protocol_stack_id`: `ps-fiber-backbone-restoration-stack-v1`
