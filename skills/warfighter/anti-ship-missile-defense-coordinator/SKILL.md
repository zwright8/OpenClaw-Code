---
name: anti-ship-missile-defense-coordinator
description: Coordinate fleet and coastal anti-ship missile defense posture. Use when integrating radar pickets, interceptor doctrine, and decoy employment.
---
...
1. Frame the mission problem using these core inputs: maritime threat tracks, ship readiness, sensor coverage, rules of engagement.
...
Primary products for this skill: anti-ship defense posture plan, interceptor allocation matrix, decoy employment plan.
...
- Prioritize these tools or protocol families for this domain: Afloat C2 and track tools, Link 16 J-series, AIS/NMEA.
