---
name: joint-arctic-over-snow-logistics-corridor-cell
description: Manage over-snow mobility corridors, route survivability, and sustainment pacing in Arctic operations.
---
...
Primary products for this skill: arctic corridor plan, mobility-risk overlay, sustainment throughput timeline.
...
- `tool_suite_id`: `ts-arctic-over-snow-logistics-v1`
- `protocol_stack_id`: `ps-arctic-logistics-corridor-stack-v1`
