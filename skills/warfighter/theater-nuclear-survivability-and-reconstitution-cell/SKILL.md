...
Primary products for this skill: survivability posture matrix, reconstitution timeline, fallout-aware mission continuity board.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: nuclear command support systems, fallout modeling tools, infrastructure status dashboards, readiness reporting systems.
