---
name: operational-rapid-runway-magnetic-anomaly-clearance-cell
description: Detect and clear magnetic or UXO-like anomalies on runways to restore safe sortie operations. Use when rapid runway turnover is threatened by sensor-detected subsurface hazards.
---

# Operational Rapid Runway Magnetic Anomaly Clearance Cell
...
- Use packet template DPL-RUNWAY-MAG-ANOMALY-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-runway-magnetic-anomaly-clearance-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-runway-magnetic-anomaly-clearance-v1 with protocol_stack_id=ps-runway-magnetic-anomaly-stack-v1.
...
- Default packet ID: DPL-RUNWAY-MAG-ANOMALY-001.
