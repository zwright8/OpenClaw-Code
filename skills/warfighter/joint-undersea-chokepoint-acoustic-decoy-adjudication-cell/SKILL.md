---
name: joint-undersea-chokepoint-acoustic-decoy-adjudication-cell
description: Discriminate real undersea threats from acoustic decoys to protect chokepoint operations and mission cue trust.
---
...
Primary products: acoustic decoy adjudication board, cue-confidence ladder, undersea release packet.
...
- Primary: `tool_suite_id=ts-joint-undersea-chokepoint-acoustic-decoy-adjudication-v1` with `protocol_stack_id=ps-joint-undersea-chokepoint-acoustic-decoy-adjudication-stack-v1`.
...
- Default packet IDs: `DPL-JOINT-UNDERSEA-CHOKEPOINT-ACOUSTIC-DECOY-ADJUDICATION-001`.
