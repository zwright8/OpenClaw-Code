---
name: operational-disinformation-rapid-attribution-and-response-cell
description: Rapidly triage operational disinformation incidents, assess attribution confidence, and prepare commander-approved response options.
---

# Operational Disinformation Rapid Attribution and Response Cell
...
Primary products for this skill: incident triage board, attribution confidence matrix, response option and legal constraints packet.

## External Tools and Protocol Integration

- Suggested tools: media monitoring platforms, cyber threat intel feeds, public affairs workflows, legal advisory trackers.
- Protocol/message standards: STIX 2.1, TAXII 2.1, USMTF, RFC 3339 timestamped JSON.
