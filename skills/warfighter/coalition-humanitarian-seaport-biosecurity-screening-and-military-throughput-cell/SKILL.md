---
name: coalition-humanitarian-seaport-biosecurity-screening-and-military-throughput-cell
description: Support U.S. warfighter planning for coalition seaport biosecurity screening while preserving military throughput under surge demand.
---
...
Use these tool categories by default: seaport biosecurity screening boards, coalition cargo-priority arbiters, and berth throughput schedulers.

## Protocol Profile

Preferred protocol families for this skill: NIMS/ICS, HL7/FHIR, USMTF, NATO APP-11/ADatP-3 aligned, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-COALITION-HUMANITARIAN-SEAPORT-BIOSECURITY-SCREENING-MILITARY-THROUGHPUT-001 for critical recommendations.
