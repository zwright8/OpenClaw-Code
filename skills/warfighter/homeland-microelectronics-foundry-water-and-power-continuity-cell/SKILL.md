---
name: homeland-microelectronics-foundry-water-and-power-continuity-cell
description: Maintain strategic foundry water and power continuity for homeland microelectronics production under grid and infrastructure disruption. Use when defense-critical chip output is at risk from utility instability.
---

# Homeland Microelectronics Foundry Water and Power Continuity Cell
...
1. Frame the mission problem using these core inputs: foundry utility telemetry, ultrapure water production status, grid interruption forecasts, and production priority queue.
...
Primary products for this skill: foundry utility continuity matrix, priority load and water allocation plan, production risk ladder.
...
## Domain Toolchain Override (2026-03-09, Foundry Utility Continuity Under Grid Stress)

- Prioritize tool_suite_id=ts-foundry-water-power-continuity-v1 with protocol_stack_id=ps-foundry-water-power-continuity-stack-v1 when utility volatility threatens defense microelectronics throughput.
- Use packet DPL-FOUNDRY-WATER-POWER-CONTINUITY-001 to connect utility restoration choices, production-priority sequencing, and strategic release decisions.
- If utility telemetry trust or alternate-supply readiness is incomplete, issue advisory-only production recommendations and escalate to strategic industrial authority.
