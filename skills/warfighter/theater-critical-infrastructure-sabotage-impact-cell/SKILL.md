---
name: theater-critical-infrastructure-sabotage-impact-cell
description: Assess sabotage impact on critical theater infrastructure and mission continuity. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: incident reports, infrastructure dependencies, restoration timelines, operational priorities.
...
Primary products for this skill: sabotage impact assessment, mission continuity options, restoration prioritization board.
