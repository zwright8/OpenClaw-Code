---
name: joint-leo-mesh-satcom-denial-recovery-cell
description: Support warfighter communications continuity when LEO satcom mesh links are degraded, jammed, or denied. Use when staffs must rapidly reconstitute beyond-line-of-sight command links.
---
...
Primary products for this skill: satcom outage impact board, mesh-link reconstitution sequence, mission-priority comms restoration plan

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-leo-mesh-satcom-denial-recovery-v1 and protocol_stack_id=ps-leo-mesh-satcom-denial-recovery-stack-v1.
- Primary tools for this domain: satcom network operations dashboards, anti-jam profile orchestrators, mission-priority link allocators
- Required exchange protocols/formats for this domain: USMTF, Link 16 J-series, API/JSON, STIX/TAXII
