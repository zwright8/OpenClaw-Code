---
name: homeland-base-islanded-grid-blackstart-synchronization-cell
description: Synchronize military base islanded-grid blackstart operations with civil utility restoration during cyber-physical outages.
---

# Homeland Base Islanded Grid Blackstart Synchronization Cell
...
Primary products for this skill: blackstart sequencing matrix, mission-load restoration ladder, utility synchronization decision board.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: grid telemetry and SCADA mirrors, base microgrid control systems, utility restoration coordination tools, mission-load prioritization boards.
...
- Prefer these protocol families for this skill: USMTF, NIMS/ICS, NIEM, STIX/TAXII, API/JSON.
...
- Primary: `tool_suite_id=ts-critical-infrastructure-grid-blackstart-v1` with `protocol_stack_id=ps-critical-infrastructure-grid-blackstart-stack-v1`.
- Alternate: `tool_suite_id=ts-civil-support-v1` with `protocol_stack_id=ps-civil-emergency-stack-v1`.
