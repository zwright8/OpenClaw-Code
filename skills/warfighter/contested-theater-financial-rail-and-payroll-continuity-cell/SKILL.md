---
name: contested-theater-financial-rail-and-payroll-continuity-cell
description: Preserve payroll and disbursement continuity for deployed forces when theater financial rails are contested. Use when payment disruption threatens morale, retention, or partner-force reliability.
---
...
Primary products for this skill: theater disbursement continuity board, payroll disruption impact matrix, alternate payment rail decision log.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-financial-rail-payroll-v1` with `protocol_stack_id=ps-financial-rail-payroll-stack-v1`.
...
- Default packet IDs: DPL-FINRAIL-PAYROLL-001.
