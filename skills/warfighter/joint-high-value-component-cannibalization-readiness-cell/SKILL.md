---
name: joint-high-value-component-cannibalization-readiness-cell
description: Support warfighter planning for high-value component cannibalization decisions that preserve mission readiness under supply denial.
---
...
- Primary: `tool_suite_id=ts-component-cannibalization-readiness-v1` with `protocol_stack_id=ps-component-cannibalization-readiness-stack-v1`.
- Alternate: `tool_suite_id=ts-cross-platform-part-substitution-risk-v1` with `protocol_stack_id=ps-cross-platform-part-substitution-risk-stack-v1`.
...
- Default packet IDs: DPL-COMPONENT-CANNIBALIZATION-READINESS-001, DPL-CROSS-PLATFORM-PART-SUBSTITUTION-RISK-001.
