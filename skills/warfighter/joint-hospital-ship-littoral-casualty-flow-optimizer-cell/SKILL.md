---
name: joint-hospital-ship-littoral-casualty-flow-optimizer-cell
description: Optimize afloat and littoral casualty movement under degraded evacuation capacity and contested access.
---
...
- Primary: `tool_suite_id=ts-hospital-ship-littoral-casualty-flow-v1` with `protocol_stack_id=ps-hospital-ship-littoral-casualty-flow-stack-v1`.
...
- Default packet IDs: `DPL-HOSPITAL-SHIP-LITTORAL-CASUALTY-FLOW-001`.
