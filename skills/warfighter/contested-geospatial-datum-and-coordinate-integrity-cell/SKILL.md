---
name: contested-geospatial-datum-and-coordinate-integrity-cell
description: Protect mission planning and fires accuracy from geospatial datum drift, coordinate transformation errors, and map manipulation attacks. Use when coordinate trust affects lethal or safety-critical actions.
---
...
1. Frame the mission problem using these core inputs: source geospatial datum pedigree, targeting coordinate transformations, map service integrity alerts, mission timing windows.
...
Primary products for this skill: datum integrity risk matrix, coordinate correction order, precision confidence ledger.
...
- Primary: `tool_suite_id=ts-geospatial-datum-integrity-v1` with `protocol_stack_id=ps-geodesy-coordinate-assurance-stack-v1`.
