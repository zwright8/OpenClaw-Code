...
description: Support U.S. warfighter planning and decision support for gray-zone commercial fleet shadowing attribution, escalation control, and maritime legal observability. Use when missions require integrated options, tool-protocol bindings, and authority-gated staff outputs.
---
...
Primary products for this skill: fleet-shadowing attribution board, escalation guardrail matrix, legal-observability packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: commercial vessel behavior anomaly engines, attribution evidence fusion boards, gray-zone escalation branch planners.
...
- Prefer these protocol families for this skill: AIS/NMEA, USMTF, STIX/TAXII, API/JSON.
...
- Alternate: tool_suite_id=ts-coalition-gray-zone-maritime-militia-attribution-v1 with protocol_stack_id=ps-coalition-gray-zone-maritime-militia-attribution-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-GRAYZONE-FLEET-SHADOWING-001, DPL-GRAYZONE-FLEET-SHADOWING-002.
