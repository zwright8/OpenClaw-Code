---
name: coalition-disaster-relief-airfield-digital-twin-recovery-cell
description: Use digital twins to restore coalition airfield operations during disaster relief and contested conditions. Use when runway/airfield recovery sequencing affects humanitarian and military throughput.
---

# Coalition Disaster Relief Airfield Digital Twin Recovery Cell
...
1. Frame the mission problem using these core inputs: runway damage telemetry, repair resources, flight demand priorities, host-nation authority constraints.
...
Primary products for this skill: airfield recovery digital twin plan, throughput restoration matrix, coalition tasking packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: airfield digital twin platforms, runway repair planners, humanitarian air-tasking dashboards.

## Protocol Profile

Preferred protocol families for this skill: AIXM/FIXM, NIMS/ICS, NATO APP-11/ADatP-3 aligned, API/JSON.
...
- Provide decision-support framing only; do not provide tactical execution directives.
- Require explicit human command approval (`requires_human_approval: true`) before recommendations that could change engagement posture or escalation risk.
