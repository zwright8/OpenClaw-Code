---
name: ai-enabled-red-teaming-cell
description: Support adversary-emulation and red-team analysis to stress-test plans and assumptions. Use when evaluating vulnerabilities, deception opportunities, and branch outcomes.
---
...
1. Frame the mission problem using these core inputs: friendly plan, threat doctrine assumptions, key dependencies, decision points.
...
Primary products for this skill: red-team findings brief, vulnerability register, branch recommendation set.
