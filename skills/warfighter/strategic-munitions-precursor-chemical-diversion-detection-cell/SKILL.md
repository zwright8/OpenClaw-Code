---
name: strategic-munitions-precursor-chemical-diversion-detection-cell
description: Support strategic detection and response planning for diversion, sabotage, or contamination of munitions precursor chemical supply chains.
---
...
Primary products for this skill: precursor diversion risk board, contamination and hold-point matrix, replacement sourcing branch plan.
...
- For this domain, prioritize `ts-munitions-precursor-diversion-v1` with `ps-munitions-precursor-diversion-stack-v1` and `DPL-MUNITIONS-PRECURSOR-DIVERSION-001`.
