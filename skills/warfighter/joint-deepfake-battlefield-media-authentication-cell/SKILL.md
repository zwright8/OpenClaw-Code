---
name: joint-deepfake-battlefield-media-authentication-cell
description: Support U.S. warfighter planning and decision support for Joint Deepfake Battlefield Media Authentication Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: media authenticity confidence matrix, influence risk branch map, commander communications release packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: multimodal forensics engines, provenance watermark verifiers, open-source narrative telemetry dashboards.
