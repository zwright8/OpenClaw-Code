---
name: coalition-autonomous-convoy-ethical-governance-cell
description: Support U.S. and coalition warfighter planning for ethical and legal governance of autonomous convoy behaviors. Use when autonomous logistics must align with coalition ROE, host-nation law, and civilian risk constraints.
---
...
Primary products for this skill: autonomy policy matrix, convoy authority-state ladder, coalition caveat exception board.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-logistics-distribution-v1` with `protocol_stack_id=ps-coalition-logistics-stack-v1`.
...
- Preferred tools: autonomy mission managers, convoy route-risk engines, coalition legal/caveat trackers, incident adjudication boards.
- Preferred protocol families: NATO APP-11/ADatP-3 aligned, API/JSON, USMTF.
...
- Default packet IDs: DPL-AUTON-WING-001, DPL-HUM-COR-001.
