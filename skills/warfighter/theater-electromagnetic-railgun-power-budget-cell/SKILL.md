---
name: theater-electromagnetic-railgun-power-budget-cell
description: Support theater planning for electromagnetic launch-system power budgeting, charging cycles, and mission-safe allocation under contested energy supply.
---
...
Primary products for this skill: railgun power allocation matrix, charging cycle and shot window ladder, energy resilience branch plan.
...
- For this domain, prioritize `ts-railgun-power-budget-v1` with `ps-railgun-power-budget-stack-v1` and `DPL-RAILGUN-POWER-BUDGET-001`.
