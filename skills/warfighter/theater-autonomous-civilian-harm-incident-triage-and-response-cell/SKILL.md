---
name: theater-autonomous-civilian-harm-incident-triage-and-response-cell
description: Support rapid triage and response for civilian-harm incidents involving autonomous or AI-assisted military systems. Use when commanders need transparent incident handling and mitigation options.
---
...
Primary products for this skill: incident triage queue, mitigation-and-notification timeline, confidence-ranked accountability packet

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-autonomous-civilian-harm-triage-v1 and protocol_stack_id=ps-autonomous-civilian-harm-triage-stack-v1.
- Primary tools for this domain: targeting/event log correlators, ISR replay services, civilian-harm assessment workflows
- Required exchange protocols/formats for this domain: USMTF, STIX/TAXII, NIEM, API/JSON
