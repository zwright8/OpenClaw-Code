...
description: Arbitrate military-civil autonomous evacuation convoy priorities with life-safety, legal, and logistics constraints. Use when DSCA operations require high-tempo route decisions under uncertainty.
---
...
Primary products for this skill: evacuation convoy priority matrix, route arbitration log, and life-safety risk ladder.
...
- Bind recommendations to tool_suite_id=ts-homeland-military-civil-autonomous-evacuation-convoy-arbitration-cell-v1 and protocol_stack_id=ps-homeland-military-civil-autonomous-evacuation-convoy-arbitration-cell-stack-v1.
- Use packet templates in ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-AUTO-EVAC-ARBITRATION-001 for critical recommendations.
