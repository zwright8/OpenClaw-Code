---
name: strategic-rare-gas-and-energetic-precursor-allocation-cell
description: Optimize strategic allocation of rare gases and energetic precursors across defense-industrial and operational demand under disruption.
---
...
Primary products for this skill: strategic precursor allocation ladder, industrial-to-operational transfer matrix, surge sustainment authority packet.

## Domain Tool Stack

Use these tool categories as the baseline stack: industrial bottleneck predictors, energetic precursor custody ledgers, strategic demand arbitration engines.
...
- Prioritize `tool_suite_id=ts-strategic-rare-gas-energetic-precursor-allocation-v1` + `protocol_stack_id=ps-strategic-rare-gas-energetic-precursor-allocation-stack-v1` when this mission set is the critical path for commander decision timelines.
- Add `packet_id=DPL-STRATEGIC-RAREGAS-ENERGETICS-001` for the primary course of action and `packet_id=DPL-STRATEGIC-RAREGAS-ENERGETICS-002` for degraded-mode fallback actions.
