---
name: theater-quantum-navigation-test-and-transition-cell
description: Support U.S. warfighter planning and decision support for Theater Quantum Navigation Test and Transition Cell. Use when missions require Theater Quantum Navigation Test and Transition Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: quantum navigation pilot plan, PNT degradation transition matrix, assurance test report.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: PNT integrity monitors, inertial-quantum fusion testbeds, mission timing validation tools.
- Prioritize these protocol families for this domain: USMTF, AIXM/FIXM/IWXXM, API/JSON.
