---
name: theater-quantum-key-rollover-disconnected-trust-cell
description: Coordinate theater-level quantum-resistant key rollover and disconnected trust continuity for mission systems. Use when contested networks force cryptographic transition and offline credential survivability.
---

# Theater Quantum-Resistant Key Rollover and Disconnected Trust Cell
...
Primary products for this skill: post-quantum rollover timeline, disconnected trust continuity matrix, cryptographic risk acceptance board.
...
- Add `tool_suite_id=ts-quantum-resistant-key-rollover-disconnected-trust-v1` + `protocol_stack_id=ps-quantum-resistant-key-rollover-disconnected-trust-stack-v1` when producing critical recommendations for this mission domain.
