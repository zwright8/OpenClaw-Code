---
name: coalition-disaster-relief-dual-use-airport-control-cell
description: Coordinate military and humanitarian operations at dual-use airports during disaster response with contested security conditions.
---
...
Primary products for this skill: airport flow control plan, military-humanitarian slot matrix, protection and recovery branch chart.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: airfield operations dashboards, humanitarian demand systems, customs/clearance trackers, force protection COP.
- Preferred protocol profiles for coordination and machine exchange: AIXM/FIXM, USMTF, NIMS/ICS, NATO APP-11/ADatP-3.
