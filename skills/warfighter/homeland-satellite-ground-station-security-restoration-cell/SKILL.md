---
name: homeland-satellite-ground-station-security-restoration-cell
description: Coordinate security hardening and restoration sequencing for homeland satellite ground stations under physical and cyber attack.
---
...
- Primary: `tool_suite_id=ts-ground-station-security-restoration-v1` with `protocol_stack_id=ps-ground-station-security-restoration-stack-v1`.
...
- Default packet IDs: `DPL-GROUND-STATION-RESTORATION-001`, `DPL-SATCOM-HOMELAND-DEFENSE-001`.
