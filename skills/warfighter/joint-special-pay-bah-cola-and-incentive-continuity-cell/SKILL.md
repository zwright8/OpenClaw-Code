...
- Add `toolchain_id=TC-OHA-397`, `tool_suite_id=ts-joint-overseas-housing-allowance-utility-reconciliation-lease-continuity-v1`, and `protocol_stack_id=ps-joint-overseas-housing-allowance-utility-reconciliation-lease-continuity-stack-v1` when overseas housing-allowance trust depends on valid lease posture, utility evidence, or move-in cost reconciliation instead of generic BAH or COLA logic.
- Add `toolchain_id=TC-OCOLA-398`, `tool_suite_id=ts-joint-overseas-cola-post-allowance-currency-shock-continuity-v1`, and `protocol_stack_id=ps-joint-overseas-cola-post-allowance-currency-shock-continuity-stack-v1` when overseas COLA, post-allowance, or exchange-rate shock materially changes compensation legitimacy for moved households.
- Add `toolchain_id=TC-BASMESS-399`, `tool_suite_id=ts-joint-basic-allowance-for-subsistence-meal-card-messing-debt-continuity-v1`, and `protocol_stack_id=ps-joint-basic-allowance-for-subsistence-meal-card-messing-debt-continuity-stack-v1` when subsistence coding, meal-card status, or messing-debt posture materially changes pay accuracy or household food security.
- Add `toolchain_id=TC-GEOBACH-401`, `tool_suite_id=ts-joint-geographic-bachelor-housing-exception-separate-rations-continuity-v1`, and `protocol_stack_id=ps-joint-geographic-bachelor-housing-exception-separate-rations-continuity-stack-v1` when separate-rations legitimacy, split-household support, or housing-exception posture materially changes compensation confidence.
- Add `packet_id=DPL-OHA-LEASE-UTILITY-001`, `packet_id=DPL-OCOLA-POST-CURRENCY-001`, `packet_id=DPL-BAS-MEALCARD-MESS-001`, and `packet_id=DPL-GEOBACH-SEPRATS-001` for branches that materially alter special-pay, allowance, or subsistence legitimacy across moved and split households.
