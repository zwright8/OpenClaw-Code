---
name: coalition-precision-fires-battle-damage-legal-assurance-cell
description: Support U.S. warfighter planning and decision support for coalition precision fires battle-damage assessment with legal traceability and ROE assurance.
---
...
Primary products for this skill: battle damage legal assurance packet, coalition evidence chain summary, restrike decision matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: fires coordination systems, ISR exploitation workflows, legal advisory decision logs, coalition releasability trackers.
...
- Prefer these protocol families for this skill: VMF, Link 16 J-series, NATO APP-11/ADatP-3.
