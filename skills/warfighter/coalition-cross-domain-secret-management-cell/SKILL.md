---
name: coalition-cross-domain-secret-management-cell
description: Coordinate coalition cross-domain secret handling and releasability governance. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: classification guidance, coalition caveats, data-sharing requests, cross-domain guard status.
...
Primary products for this skill: releasability decision matrix, release workflow, cross-domain exception log.
