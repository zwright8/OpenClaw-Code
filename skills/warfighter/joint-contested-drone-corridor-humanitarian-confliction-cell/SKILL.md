---
name: joint-contested-drone-corridor-humanitarian-confliction-cell
description: Manage contested drone corridors while preserving humanitarian access and deconfliction timing. Use when military and relief flights compete for constrained airspace and sensor confidence is degraded.
---
...
Primary products for this skill: contested drone corridor deconfliction matrix, humanitarian access timing board, emergency reroute trigger ledger.
...
- Default to `tool_suite_id=ts-contested-drone-humanitarian-corridor-v1` and `protocol_stack_id=ps-contested-drone-humanitarian-corridor-stack-v1` for mission-critical recommendations in this domain.
