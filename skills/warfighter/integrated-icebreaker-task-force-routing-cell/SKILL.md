---
name: integrated-icebreaker-task-force-routing-cell
description: Optimize icebreaker task force routing, escort assignments, and risk-informed timing for polar mission assurance and logistics access. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: polar route risk overlay, icebreaker escort allocation matrix, Arctic timing and branch trigger brief.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: ice condition intelligence services, polar route optimization platforms, maritime traffic analytics, logistics synchronization boards.
- Prioritize these protocol families for this domain: AIS/NMEA, OGC WMS/WFS/WMTS, USMTF, API/JSON.
