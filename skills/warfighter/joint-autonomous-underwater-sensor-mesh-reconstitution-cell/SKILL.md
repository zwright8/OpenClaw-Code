---
name: joint-autonomous-underwater-sensor-mesh-reconstitution-cell
description: Support U.S. warfighter planning and decision support for Joint Autonomous Underwater Sensor Mesh Reconstitution Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: undersea mesh reconstitution sequence, sensor custody readiness board, contact confidence restoration packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: undersea autonomy mission managers, acoustic propagation planners, subsea telemetry health monitors.

## Protocol Profile

Preferred protocol families for this skill: AIS/NMEA, API/JSON, USMTF.
