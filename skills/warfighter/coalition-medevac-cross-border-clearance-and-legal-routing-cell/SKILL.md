---
name: coalition-medevac-cross-border-clearance-and-legal-routing-cell
description: Coordinate coalition medevac movement across borders with legal clearances, diplomatic constraints, and medical urgency tradeoffs. Use when warfighters must route casualties through multinational approval pathways.
---
...
Primary products for this skill: cross-border medevac clearance matrix, coalition legal-routing decision log, casualty transfer handoff packet.
...
- Add `tool_suite_id=ts-coalition-medevac-cross-border-clearance-routing-v1` + `protocol_stack_id=ps-coalition-medevac-cross-border-clearance-routing-stack-v1` when producing critical recommendations for this mission domain.
