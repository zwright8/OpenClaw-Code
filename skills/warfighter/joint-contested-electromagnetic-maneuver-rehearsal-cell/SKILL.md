---
name: joint-contested-electromagnetic-maneuver-rehearsal-cell
description: Design and rehearse electromagnetic maneuver plans that preserve friendly sensing and communications under jamming and deception pressure. Use when operations require time-phased spectrum maneuvers across multiple components.
---
...
1. Frame the mission problem using these core inputs: friendly emissions plan, threat jammer laydown, maneuver timeline, mission data loads, authority constraints.
...
Primary products for this skill: electromagnetic maneuver rehearsal script, emissions control branch matrix, contested-spectrum decision support brief.
