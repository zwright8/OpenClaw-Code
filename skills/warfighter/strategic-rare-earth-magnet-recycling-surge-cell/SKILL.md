---
name: strategic-rare-earth-magnet-recycling-surge-cell
description: Orchestrate defense-critical rare-earth magnet recycling surge to stabilize weapons and sensor production continuity.
---
...
Primary products for this skill: recycling surge allocation plan, feedstock confidence ladder, industrial restoration decision matrix.

## Tool Suite and Protocol Binding

- Bind tool selection to `ts-rare-earth-magnet-recycling-surge-v1` and `ps-rare-earth-magnet-recycling-surge-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Recommended external tools for this domain: industrial base telemetry, scrap feedstock assay reports, logistics rail and truck status boards, and supplier risk monitors.
- Required protocol families for implementation: EDIFACT, REST JSON over mTLS, STIX/TAXII, and NIEM.
