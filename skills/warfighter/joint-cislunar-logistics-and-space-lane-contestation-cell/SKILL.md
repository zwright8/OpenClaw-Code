---
name: joint-cislunar-logistics-and-space-lane-contestation-cell
description: Support U.S. warfighter planning and decision support for cislunar logistics protection, contested space-lane routing, and mission-priority orbital sustainment. Use when missions require integrated options, tool-protocol bindings, and authority-gated staff outputs.
---

# Joint Cislunar Logistics and Space-Lane Contestation Cell
...
Primary products for this skill: cislunar lane-risk board, logistics convoy branch matrix, mission-priority orbital sustainment packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: cislunar trajectory conflict analyzers, orbital logistics custody ledgers, launch-resupply arbitration boards.
...
- Prefer these protocol families for this skill: CCSDS, USMTF, STIX/TAXII, API/JSON.
...
- Primary: tool_suite_id=ts-joint-cislunar-logistics-and-space-lane-contestation-cell-v1 with protocol_stack_id=ps-joint-cislunar-logistics-and-space-lane-contestation-cell-stack-v1.
- Alternate: tool_suite_id=ts-contested-space-launch-reconstitution-v1 with protocol_stack_id=ps-contested-space-launch-reconstitution-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-CISLUNAR-LOGISTICS-CONTEST-001, DPL-CISLUNAR-LOGISTICS-CONTEST-002.
