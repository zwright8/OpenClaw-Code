---
name: coalition-battlefield-additive-ceramic-armor-surge-cell
description: Manage coalition surge production, quality assurance, and field allocation for additively manufactured ceramic armor kits. Use when battle damage rates exceed baseline replacement capacity.
---

# Coalition Battlefield Additive Ceramic Armor Surge Cell
...
1. Frame the mission problem using these core inputs: armor loss rates, additive line throughput, ceramic feedstock status, and coalition vehicle protection priorities.
...
Primary products for this skill: armor surge allocation matrix, quality hold-and-release board, coalition reconstitution timeline.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: additive manufacturing MES tools, ballistic test data platforms, coalition sustainment planning systems.
...
## Domain Toolchain Override (2026-03-09, Ceramic Armor Surge Control)

- Prioritize tool_suite_id=ts-additive-ceramic-armor-surge-v1 with protocol_stack_id=ps-additive-ceramic-armor-surge-stack-v1 when coalition armor replacement demand exceeds validated production yield.
- Use packet DPL-ADDITIVE-CERAMIC-ARMOR-SURGE-001 to bind lot certification, allocation priorities, and release-authority checkpoints.
- If ballistic validation evidence or supplier trust posture drops below threshold, downgrade to advisory-only distribution recommendations and require commander approval before releasing lots.
