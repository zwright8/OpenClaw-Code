---
name: joint-cyber-kinetic-infrastructure-cascade-containment-cell
description: Contain and stabilize cascading effects across cyber and physical infrastructure after blended attacks impacting joint force operations. Use when warfighters must sequence containment, restoration, and mission reprioritization decisions rapidly.
---
...
Primary products for this skill: cyber-kinetic cascade containment board, critical-node restoration sequence matrix, mission reprioritization trigger packet.
...
- Add `tool_suite_id=ts-joint-cyber-kinetic-infrastructure-cascade-containment-v1` + `protocol_stack_id=ps-joint-cyber-kinetic-infrastructure-cascade-containment-stack-v1` when producing critical recommendations for this mission domain.
