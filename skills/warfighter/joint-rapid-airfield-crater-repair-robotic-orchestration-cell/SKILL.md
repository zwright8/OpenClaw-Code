---
name: joint-rapid-airfield-crater-repair-robotic-orchestration-cell
description: Synchronize robotic and human teams for rapid crater repair and runway re-opening during sustained strike campaigns. Use when sortie generation depends on high-tempo damage-repair cycles.
---

# Joint Rapid Airfield Crater Repair Robotic Orchestration Cell
...
- Use packet template DPL-AIRFIELD-ROBOT-REPAIR-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-robotic-airfield-repair-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-robotic-airfield-repair-v1 with protocol_stack_id=ps-joint-tactical-link-stack-v1.
...
- Default packet ID: DPL-AIRFIELD-ROBOT-REPAIR-001.
