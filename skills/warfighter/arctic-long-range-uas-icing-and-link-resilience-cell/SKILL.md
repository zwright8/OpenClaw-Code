---
name: arctic-long-range-uas-icing-and-link-resilience-cell
description: Protect Arctic long-range UAS operations from icing and comm-link degradation. Use when polar operations require persistent ISR or relay under severe weather and intermittent satcom.
---

# Arctic Long-Range UAS Icing and Link Resilience Cell
...
Primary products for this skill: UAS icing risk operations card, link-resilience branch plan, Arctic ISR persistence matrix.
...
- Prioritize these tool families for this domain: polar weather nowcast systems, UAS fleet health telemetry, SATCOM/HF link managers, Arctic airspace coordination tools.
- Prioritize these protocol families for this domain: METAR/TAF exchanges, Link 16 J-series, HF data link standards.
