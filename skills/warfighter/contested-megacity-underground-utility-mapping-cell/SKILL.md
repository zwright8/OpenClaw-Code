---
name: contested-megacity-underground-utility-mapping-cell
description: Fuse multi-source mapping of underground utilities to reduce strike, maneuver, and restoration risk in megacities.
---
...
Primary products for this skill: underground utility risk map, no-strike utility register, restoration sequencing options.
...
- `tool_suite_id`: `ts-megacity-underground-infrastructure-v1`
- `protocol_stack_id`: `ps-underground-utility-mapping-stack-v1`
