---
name: tactical-human-machine-teaming-robotics-cell
description: Integrate robotic and autonomous teammates with manned formations for reconnaissance, breaching, and protection tasks. Use when assigning autonomy roles, supervision logic, and fail-safe triggers.
---
...
Primary products for this skill: Human-machine task allocation board, autonomy supervision matrix, robot fallback trigger card.
