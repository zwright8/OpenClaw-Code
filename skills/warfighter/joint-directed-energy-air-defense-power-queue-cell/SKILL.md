---
name: joint-directed-energy-air-defense-power-queue-cell
description: Coordinate power-constrained directed-energy air defense engagement queues and generator/load balancing in contested operations. Use when warfighters must prioritize high-value aerial threats under constrained energy availability.
---
...
Primary products for this skill: directed-energy engagement priority board, power-queue survivability matrix, generator reallocation branch card.
...
- Add `tool_suite_id=ts-directed-energy-air-defense-power-queue-v1` + `protocol_stack_id=ps-directed-energy-air-defense-power-queue-stack-v1` when producing critical recommendations for this mission domain.
