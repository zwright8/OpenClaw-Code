---
name: joint-high-altitude-balloon-mesh-comms-restoration-cell
description: Restore denied-terrain command connectivity through resilient high-altitude balloon mesh communications.
---
...
- Primary: `tool_suite_id=ts-high-altitude-balloon-mesh-restoration-v1` with `protocol_stack_id=ps-high-altitude-balloon-mesh-restoration-stack-v1`.
...
- Default packet IDs: `DPL-HIGH-ALTITUDE-BALLOON-MESH-RESTORATION-001`.
