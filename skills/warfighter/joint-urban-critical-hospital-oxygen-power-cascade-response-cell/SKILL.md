---
name: joint-urban-critical-hospital-oxygen-power-cascade-response-cell
description: Support U.S. warfighter planning for Joint Urban Critical Hospital Oxygen Power Cascade Response Cell.
---
...
Use these tool categories by default: hospital oxygen telemetry fusion boards, urban power-failure cascade models, and emergency care load balancing planners.

## Protocol Profile

Preferred protocol families for this skill: HL7/FHIR, NIMS/ICS, EDXL-DE/CAP, NIEM, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-JOINT-URBAN-CRITICAL-HOSPITAL-OXYGEN-POWER-CASCADE-RESPONSE-001 for critical recommendations.
