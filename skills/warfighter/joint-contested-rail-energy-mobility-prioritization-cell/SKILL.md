---
name: joint-contested-rail-energy-mobility-prioritization-cell
description: Fuse rail throughput and energy restoration priorities to sustain joint mobility in contested conditions. Use when deployment timelines are constrained by simultaneous transport and power disruption.
---
...
Primary products for this skill: rail-energy fused priority matrix, restoration sequence board, mobility risk profile.

## Domain Tool Stack

Use these tool categories as the baseline stack: rail movement optimizers, grid load-priority planners, deployment timeline analyzers.

## Protocol Profile

Preferred protocol families for this skill: rail API/JSON, IEC 61850, USMTF.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-rail-energy-mobility-priority-fusion-v1` with `protocol_stack_id=ps-rail-energy-mobility-priority-fusion-stack-v1`.
...
- Default packet IDs: DPL-RAIL-ENERGY-MOBILITY-PRIORITY-FUSION-001, DPL-MULTI-DOMAIN-BATTLE-RHYTHM-FRAGMENT-RECOVERY-001.
