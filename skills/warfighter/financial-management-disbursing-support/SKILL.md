---
name: financial-management-disbursing-support
description: Support operational finance and disbursing planning for deployed formations. Use when managing cash requirements, fiscal controls, and funding execution timelines.
---

# Financial Management and Disbursing Support
...
1. Frame the mission problem using these core inputs: funding authorities, spending plan, disbursing capabilities, audit controls.
...
Primary products for this skill: operational finance plan, disbursing support matrix, fiscal risk controls checklist.
