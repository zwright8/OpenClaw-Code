---
name: high-threat-vip-movement-protection-planner
description: Design secure movement plans for high-threat VIP and command visits in contested environments. Use when route, timing, and protection posture require dynamic adjustment.
---
...
1. Frame the mission problem using these core inputs: threat intelligence, route surveillance status, escort availability, air/ground medevac contingencies.
...
Primary products for this skill: VIP movement protection plan, route/decoy options matrix, emergency action triggers.
...
- Prioritize these tools or tool families for this domain: protective intelligence systems, route planning/COP tools, counter-surveillance feeds, medevac coordination systems.
- Specify outbound exchange format for recommendations and tasking: USMTF, CoT, VMF, API/JSON.
