---
name: joint-expeditionary-mortuary-affairs-surge-cell
description: Coordinate mass-fatality accountability, respectful recovery, identification workflows, and family-notification synchronization during major combat or disaster operations. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: mortuary affairs surge capacity plan, remains identification workflow tracker, family notification synchronization board.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: personnel accountability systems, forensic lab workflow tools, mortuary logistics dashboards, case status management platforms.
- Prioritize these protocol families for this domain: USMTF, HL7/FHIR, API/JSON, NATO APP-11/ADatP-3 aligned.
