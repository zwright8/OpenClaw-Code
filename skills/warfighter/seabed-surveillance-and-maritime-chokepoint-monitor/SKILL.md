---
name: seabed-surveillance-and-maritime-chokepoint-monitor
description: Monitor seabed and chokepoint activity to detect threats to maritime infrastructure and sea lines of communication. Use when integrating subsea sensing and maritime traffic analysis.
---
...
1. Frame the mission problem using these core inputs: subsea sensor detections, maritime traffic patterns, chokepoint threat reporting, and protection priorities.
...
Primary products for this skill: seabed threat correlation product, chokepoint control recommendation set, maritime infrastructure protection board.
