---
name: human-performance-and-combat-stress-risk-cell
description: Support U.S. warfighter planning and decision support for Human Performance And Combat Stress Risk Cell. Use when missions require human performance and combat stress risk assessment to preserve mission effectiveness and unit resilience, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: unit stress-risk heatmap, performance preservation plan, command intervention decision points.
...
- Prioritize these tools or protocol families for this domain: force health monitoring tools, personnel readiness dashboards, medical reporting systems.
- State the protocol or message format for outbound coordination (for example API/JSON, HL7/FHIR, USMTF).
