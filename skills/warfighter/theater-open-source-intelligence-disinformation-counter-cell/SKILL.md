---
name: theater-open-source-intelligence-disinformation-counter-cell
description: Fuse open-source reporting, social media signals, and influence indicators to detect and counter adversary disinformation targeting U.S. and partner forces. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: disinformation threat map, narrative counter-message plan, source credibility confidence ledger.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: OSINT aggregation platforms, social network analysis dashboards, media forensics toolchains, narrative monitoring services.
- Prioritize these protocol families for this domain: STIX/TAXII, API/JSON, CoT, OGC.
