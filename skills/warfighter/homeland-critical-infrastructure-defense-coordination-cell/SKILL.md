---
name: homeland-critical-infrastructure-defense-coordination-cell
description: Coordinate military support to defend and restore critical U.S. infrastructure under cyber-physical or hybrid threat. Use when prioritizing restoration, protection, and mission continuity across power, water, telecom, and transport systems.
---
...
1. Frame the mission problem using these core inputs: critical infrastructure status boards, utility telemetry, incident reports, state/federal coordination requests.
...
Primary products for this skill: critical-node defense prioritization matrix, restoration sequencing plan, mission continuity branch plan.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools or tool families for this domain: ICS/EOC dashboards, utility telemetry systems, cyber defense watchfloors, transportation operations boards.
