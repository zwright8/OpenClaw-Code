---
name: strategic-bioindustrial-supply-assurance-and-counter-sabotage-cell
description: Protect and restore strategic bioindustrial production and supply continuity under sabotage risk. Use when planners need policy-aware mitigation options with explicit protocol and authority bindings.
---
...
Primary products for this skill: bioindustrial critical-node map, sabotage impact branch plan, supply restoration priority board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-bioindustrial-assurance-v1` with `protocol_stack_id=ps-bioindustrial-assurance-stack-v1`.
...
- Default packet ID: `DPL-BIOINDUSTRIAL-ASSURANCE-001`.
...
- Default `toolchain_id`: `TC-IND-STRAT-010`.
