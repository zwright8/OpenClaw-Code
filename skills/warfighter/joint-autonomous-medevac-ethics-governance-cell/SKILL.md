---
name: joint-autonomous-medevac-ethics-governance-cell
description: Support governance for autonomous casualty evacuation in contested operations. Use when autonomous medevac recommendations require authority boundaries, ethics checks, and medical-risk escalation controls.
---
...
Primary products for this skill: autonomous medevac authority matrix, ethics exception ledger, medical-risk escalation package.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-autonomous-medevac-governance-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
- Alternate: `tool_suite_id=ts-medical-force-health-v1` with `protocol_stack_id=ps-joint-tactical-link-stack-v1`.
...
- Default packet IDs: DPL-AUTOMEDEVAC-GOV-001, DPL-CASEVAC-AUTO-001.
