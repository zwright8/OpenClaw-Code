---
name: theater-denied-space-weather-pnt-recovery-cell
description: Recover theater PNT assurance during severe space-weather and denial conditions through multi-source timing and navigation reconstitution.
---
...
- Primary: `tool_suite_id=ts-denied-space-weather-pnt-recovery-v1` with `protocol_stack_id=ps-denied-space-weather-pnt-recovery-stack-v1`.
...
- Default packet IDs: `DPL-DENIED-SPACE-WEATHER-PNT-RECOVERY-001`, `DPL-PNT-CONFIDENCE-RECONSTITUTION-001`.
