---
name: theater-uas-launch-site-pattern-disruption-cell
description: Identify and disrupt adversary UAS launch-site patterns across the theater. Use when commanders need persistent anti-UAS campaign shaping beyond point defense.
---
...
Primary products for this skill: launch-site pattern atlas, disruption branch map, reattack prioritization matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-air-defense-ammo-economy-v1` with `protocol_stack_id=ps-counter-uas-killchain-stack-v1`.
- Alternate: `tool_suite_id=ts-intel-fusion-v1` with `protocol_stack_id=ps-osint-info-ops-stack-v1`.
