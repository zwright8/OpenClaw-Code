---
name: medical-c4i-and-patient-movement-fusion-cell
description: Support U.S. warfighter planning and decision support for Medical C4I And Patient Movement Fusion Cell. Use when missions require medical C4I synchronization and theater patient movement prioritization under contested conditions, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: patient movement prioritization board, medevac routing matrix, care-capacity forecast.
...
- Prioritize these tools or protocol families for this domain: patient regulation systems, med logistics inventories, evacuation coordinators.
- State the protocol or message format for outbound coordination (for example USMTF, HL7/FHIR, API/JSON).
