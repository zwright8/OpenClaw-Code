---
name: contested-theater-weather-routing-and-force-protection-cell
description: Adapt routing and force protection posture to contested weather conditions. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: theater weather hazards, route options, protection assets, mission timing demands.
...
Primary products for this skill: weather-adaptive routing plan, force protection posture recommendations, branch triggers.
