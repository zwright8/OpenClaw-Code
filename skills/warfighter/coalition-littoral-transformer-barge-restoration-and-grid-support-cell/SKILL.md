---
name: coalition-littoral-transformer-barge-restoration-and-grid-support-cell
description: Coordinate transformer-barge delivery and littoral grid restoration support for coalition and host-nation mission power continuity.
---
...
Primary products for this skill: transformer-barge escort and emplacement plan, littoral grid support priority matrix, coalition restoration synchronization board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-littoral-transformer-barge-restoration-v1` with `protocol_stack_id=ps-littoral-transformer-barge-restoration-stack-v1`.
- Alternate: `tool_suite_id=ts-grid-transformer-escort-install-v1` with `protocol_stack_id=ps-grid-transformer-escort-install-stack-v1`.
...
- Default packet IDs: DPL-LITTORAL-TRANSFORMER-BARGE-RESTORATION-001.
