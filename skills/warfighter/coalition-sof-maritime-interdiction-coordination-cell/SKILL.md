---
name: coalition-sof-maritime-interdiction-coordination-cell
description: Coordinate coalition SOF-enabled maritime interdiction missions across legal regimes, intelligence feeds, and tactical control measures.
---
...
1. Frame the mission problem using these core inputs: target vessel pattern analysis, partner force availability, legal authorities, sea state and routing.
...
Primary products for this skill: interdiction mission synchronization board, authorities and handoff matrix, post-action evidence package.
