---
name: theater-contested-undersea-fiber-repeater-reconstitution-cell
description: Coordinate contested undersea fiber repeater restoration and traffic rerouting for theater command continuity. Use when U.S. operations require rapid subsea communications recovery under sabotage, natural hazard, or kinetic disruption.
---
...
Primary products for this skill: undersea repeater restoration sequence, theater traffic reroute plan, cable landing station continuity board.

## Domain Tool Stack

Use these tool categories as the baseline stack: undersea cable telemetry, maritime infrastructure monitoring, network orchestration control planes, repair vessel mission planners.

## Protocol Profile

Preferred protocol families for this skill: NIPR/SIPR transport profiles, DISN routing policies, STANAG 5066, IPsec/TACLANE overlays.
