---
name: joint-undersea-sensor-spoofing-confidence-adjudication-cell
description: Adjudicate undersea sensor spoofing indicators and preserve confidence in submarine and seabed warning networks.
---
...
- Primary: `tool_suite_id=ts-undersea-sensor-spoofing-confidence-adjudication-v1` with `protocol_stack_id=ps-undersea-sensor-spoofing-confidence-adjudication-stack-v1`.
...
- Default packet IDs: `DPL-UNDERSEA-SENSOR-SPOOFING-CONFIDENCE-ADJUDICATION-001`.
