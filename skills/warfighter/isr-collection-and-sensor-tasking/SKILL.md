...
description: Design ISR collection strategies and sensor tasking plans for contested environments. Use when balancing collection requirements, platform risk, and reporting timelines.
---
...
1. Frame the mission problem using these core inputs: priority intelligence requirements, sensor inventory, weather windows, denial threats.
...
Primary products for this skill: ISR collection plan, sensor allocation matrix, reporting battle rhythm.
