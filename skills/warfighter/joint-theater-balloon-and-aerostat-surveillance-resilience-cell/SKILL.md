---
name: joint-theater-balloon-and-aerostat-surveillance-resilience-cell
description: Plan resilient theater balloon and aerostat ISR operations under EW attack, weather disruption, and kinetic attrition.
---
...
Primary products for this skill: aerostat recovery matrix, ISR persistence ladder, weather/EW branch card.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: aerostat fleet health monitors, weather nowcast fusion, EW interference analytics.
...
- Default packet binding for this domain: DPL-AEROSTAT-RESILIENCE-001.
