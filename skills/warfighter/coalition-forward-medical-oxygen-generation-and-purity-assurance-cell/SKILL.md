---
name: coalition-forward-medical-oxygen-generation-and-purity-assurance-cell
description: Assure forward medical oxygen generation, purity verification, and distribution resilience across coalition casualty-care networks.
---

# Coalition Forward Medical Oxygen Generation And Purity Assurance Cell
...
- Use packet template DPL-FWD-MEDICAL-OXYGEN-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-forward-medical-oxygen-assurance-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-forward-medical-oxygen-assurance-v1 with protocol_stack_id=ps-forward-medical-oxygen-assurance-stack-v1.
...
- Default packet ID: DPL-FWD-MEDICAL-OXYGEN-001.
