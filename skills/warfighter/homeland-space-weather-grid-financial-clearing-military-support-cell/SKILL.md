---
name: homeland-space-weather-grid-financial-clearing-military-support-cell
description: Support U.S. warfighter planning for Homeland Space-Weather Grid Financial Clearing Military Support Cell.
---
...
Use these tool categories by default: geomagnetic storm impact boards, grid-restoration synchronizers, and financial-clearing continuity monitors.

## Protocol Profile

Preferred protocol families for this skill: NIMS/ICS, EDXL-DE/CAP, NIEM, USMTF, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-HOMELAND-SPACE-WEATHER-GRID-FINANCIAL-CLEARING-MILITARY-SUPPORT-001 for critical recommendations.
