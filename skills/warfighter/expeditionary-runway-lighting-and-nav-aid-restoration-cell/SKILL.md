---
name: expeditionary-runway-lighting-and-nav-aid-restoration-cell
description: Support U.S. warfighter planning and operational decision support for Expeditionary Runway Lighting And Nav Aid Restoration Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
Primary products for this skill: airfield recovery priority plan, navigation service restoration matrix, sortie-tempo risk branch package.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: airfield operations systems, TAIS-style airspace planners, engineering status boards, weather support feeds.
...
- Prefer these protocol families for this skill: AIXM/FIXM, USMTF, VMF.
