---
name: joint-space-weather-solar-storm-mission-assurance-cell
description: Support warfighter planning for contested space-weather disruption across SATCOM, timing, and power dependencies. Use when solar storm risk can degrade mission assurance.
---

# Joint Space Weather Solar Storm Mission Assurance Cell
...
- Primary: `tool_suite_id=ts-space-weather-solar-storm-mission-assurance-v1` with `protocol_stack_id=ps-space-weather-solar-storm-mission-assurance-stack-v1`.
- Alternate: `tool_suite_id=ts-geomagnetic-storm-grid-satcom-posture-v1` with `protocol_stack_id=ps-geomagnetic-storm-grid-satcom-posture-stack-v1`.
...
- Default packet IDs: DPL-SPACE-WEATHER-SOLAR-STORM-MISSION-ASSURANCE-001, DPL-GEOMAGNETIC-STORM-GRID-SATCOM-POSTURE-001.
