---
name: information-integrity-and-deepfake-incident-response-cell
description: Detect and triage synthetic media incidents that threaten force protection, command trust, or civil stability.
---

# Information Integrity and Deepfake Incident Response Cell
...
Primary products for this skill: synthetic-media incident brief, attribution confidence ladder, response communication matrix.
...
- Suggested tools: media forensics platforms, social listening APIs, platform trust/safety portals, SIEM, public affairs approval workflow.
- Protocol/message standards: STIX/TAXII, C2PA manifests, JSON Web Signature (JWS), MISP.
