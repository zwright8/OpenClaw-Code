---
name: joint-microgrid-blackstart-fuel-cell-ammonia-conversion-cell
description: Support joint planning for microgrid blackstart options using fuel-cell and ammonia conversion pathways at expeditionary installations. Use when conventional fuel reliability is degraded and resilient restart options are required.
---
...
Primary products for this skill: blackstart option matrix, fuel-cell and ammonia conversion sequence card, mission-power restoration timeline.

## U.S. Warfighter Employment Notes

- Prioritize resilient blackstart pathways that reduce logistics signature and sustain mission-essential loads during prolonged grid loss.
...
- For this domain, prioritize `ts-microgrid-ammonia-blackstart-v1` with `ps-microgrid-ammonia-blackstart-stack-v1` and `DPL-MICROGRID-AMMONIA-BLACKSTART-001`.
