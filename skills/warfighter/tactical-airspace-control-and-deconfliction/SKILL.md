---
name: tactical-airspace-control-and-deconfliction
description: Support U.S. warfighter planning and decision support for Tactical Airspace Control And Deconfliction. Use when missions require airspace control measures and cross-domain deconfliction for dynamic operations, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: airspace control order synchronization board, airspace conflict matrix, restricted operating zone execution plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: TBMCS, TAIS, AFATDS, tactical track management systems.
...
- Prefer these protocol families for this skill: USMTF, Link 16 J-series, VMF.
...
- Default packet IDs: `DPL-AIRLIFT-LZ-001`, `DPL-FIRES-LINEAGE-001`.
