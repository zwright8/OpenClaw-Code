---
name: joint-spectrum-governance-and-emissions-control-cell
description: Govern spectrum allocation and emissions control decisions across joint force elements in congested and contested theaters. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: spectrum governance order, emissions control matrix, conflict resolution log.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: spectrum assignment tools, emitter management systems, EMS common operating picture dashboards, interference adjudication boards.
