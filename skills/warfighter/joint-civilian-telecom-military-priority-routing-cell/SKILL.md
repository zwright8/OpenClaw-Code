---
name: joint-civilian-telecom-military-priority-routing-cell
description: Support military-priority telecommunications routing through contested civilian infrastructure. Use when civil carriers, military comms demands, and emergency authorities must be synchronized for mission continuity.
---
...
Primary products for this skill: telecom priority routing matrix, carrier outage mitigation branch table, comms authority escalation log.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-telecom-priority-routing-v1` with `protocol_stack_id=ps-telecom-priority-routing-stack-v1`.
...
- Default packet IDs: DPL-TELECOM-PRIORITY-001.
