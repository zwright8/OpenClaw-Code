---
name: land-maneuver-course-of-action
description: Develop and compare land maneuver COAs for brigade-to-platoon operations. Use when selecting axes of advance, phasing movement, and integrating fires and sustainment in ground combat.
---

# Land Maneuver Course Of Action
...
1. Frame the mission problem using these core inputs: friendly/enemy disposition, terrain avenues, mobility constraints, fires availability.
...
Primary products for this skill: COA comparison matrix, maneuver overlay narrative, decisive-point plan.
