---
name: expeditionary-runway-rapid-repair-orchestrator
description: Orchestrate rapid runway damage assessment and repair sequencing for expeditionary air operations. Use when restoring sortie generation after attack or severe degradation.
---
...
1. Frame the mission problem using these core inputs: runway damage surveys, repair kit availability, engineering teams, and sortie demand requirements.
...
Primary products for this skill: runway repair phasing matrix, sortie restoration timeline, engineering resource allocation board.
