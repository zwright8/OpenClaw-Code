---
name: tactical-urban-substation-hardening-and-islanding-cell
description: Support warfighter planning for urban power-substation hardening, islanding, and restoration to preserve mission-essential services.
---
...
- Primary: `tool_suite_id=ts-urban-substation-islanding-v1` with `protocol_stack_id=ps-urban-substation-islanding-stack-v1`.
...
- Default packet IDs: DPL-URBAN-SUBSTATION-ISLANDING-001, DPL-GRID-FEEDER-PRIORITY-SHED-001.
