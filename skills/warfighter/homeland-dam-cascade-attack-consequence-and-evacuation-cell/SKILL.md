---
name: homeland-dam-cascade-attack-consequence-and-evacuation-cell
description: Support U.S. warfighter and DSCA planning for hostile dam-cascade consequences, downstream evacuation, and critical infrastructure defense. Use when missions require forecasting flood-wave impacts, synchronizing civil-military evacuation routes, and prioritizing life-safety restoration.
---

# Homeland Dam Cascade Attack Consequence and Evacuation Cell
...
Primary products: dam-cascade consequence model, evacuation and force-protection sequencing board, critical-node restoration packet

## External Tool and Protocol Requirements

- Prioritize tool families: hydrologic consequence modeling tools, emergency operations and evacuation routing systems, infrastructure telemetry and incident coordination boards
- Prioritize protocol/message bindings: NIMS/ICS, EDXL-DE/CAP, USMTF
...
- tool_suite_id: ts-dam-cascade-attack-response-v1
- toolchain_profile_id: dam-cascade-attack-response-v1
