---
name: joint-electronic-warfare-fratricide-risk-mitigation-cell
description: Reduce fratricide risk from electronic attack and protection activities across joint formations.
---
...
Primary products for this skill: EW fratricide risk matrix, protected emitter list, effects deconfliction timeline.
...
- `tool_suite_id`: `ts-ew-fratricide-mitigation-v1`
- `protocol_stack_id`: `ps-ew-fratricide-mitigation-stack-v1`
