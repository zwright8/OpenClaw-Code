---
name: coalition-host-nation-grid-protection-and-blackstart-cell
description: Support U.S. warfighter coalition planning for host-nation grid protection and blackstart sequencing. Use when military and civil power restoration must be synchronized under cyber-physical threat.
---
...
Primary products for this skill: grid blackstart branch matrix, critical-load priority board, coalition restoration coordination timeline.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-coalition-grid-blackstart-v1` with `protocol_stack_id=ps-civil-grid-restoration-stack-v1`.
- Alternate: `tool_suite_id=ts-civil-support-v1` with `protocol_stack_id=ps-ics-civil-support-stack-v1`.
...
- Default packet IDs: DPL-GRID-BLACKSTART-001, DPL-MEGACITY-STAB-001.
