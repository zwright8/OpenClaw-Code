---
name: advisor-mission-force-assistance
description: Support advisor mission planning for security force assistance operations. Use when shaping partner force development, advisor risk, and sustainment paths.
---

# Advisor Mission and Force Assistance
...
1. Frame the mission problem using these core inputs: partner unit assessments, advisor team capacity, mission milestones, risk factors.
...
Primary products for this skill: advisor mission support plan, partner development roadmap, milestone tracking board.
