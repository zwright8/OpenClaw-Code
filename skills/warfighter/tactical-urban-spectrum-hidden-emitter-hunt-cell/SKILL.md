---
name: tactical-urban-spectrum-hidden-emitter-hunt-cell
description: Support tactical hidden-emitter hunt operations in dense urban terrain. Use when low-power or mobile emitters threaten force protection and C2.
---

# Tactical Urban Spectrum Hidden Emitter Hunt Cell
...
- Primary: `tool_suite_id=ts-urban-spectrum-hidden-emitter-hunt-v1` with `protocol_stack_id=ps-urban-spectrum-hidden-emitter-hunt-stack-v1`.
...
- Default packet IDs: DPL-URBAN-SPECTRUM-HIDDEN-EMITTER-HUNT-001, DPL-EW-WAVE-001.
