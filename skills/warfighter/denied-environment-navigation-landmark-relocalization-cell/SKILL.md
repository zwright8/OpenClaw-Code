---
name: denied-environment-navigation-landmark-relocalization-cell
description: Support U.S. warfighter planning for navigation relocalization in GNSS-denied environments using terrain/landmark fusion. Use when maneuver units require robust position/time confidence under spoofing and jamming.
---
...
Primary products for this skill: relocalization confidence map, navigation fallback sequence, position-integrity risk report.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: terrain matching engines, visual landmark fusion tools, inertial timing monitors.
- Preferred protocol profile for machine and staff exchange: USMTF + Link 16 J-series + API/JSON.
- Default tool suite binding: `tool_suite_id=ts-denied-nav-relocalization-v1`.
- Default protocol stack binding: `protocol_stack_id=ps-denied-nav-relocalization-stack-v1`.
- Default packet binding: `packet_id=DPL-DENIED-NAV-001`.
