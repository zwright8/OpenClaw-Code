---
name: coalition-contested-undersea-cable-repair-rights-and-security-cell
description: Coordinate coalition legal authorities, repair sequencing, and force protection for contested undersea cable restoration.
---

# Coalition Contested Undersea Cable Repair Rights And Security Cell
...
Primary products for this skill: repair rights matrix, cable restoration priority board, coalition legal exception log.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: undersea cable telemetry dashboards, maritime COP, coalition legal casework trackers.

## Protocol Profile

Preferred protocol families for this skill: USMTF, AIS/NMEA, NATO APP-11/ADatP-3.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-undersea-cable-rights-security-v1`.
- Alternate: `tool_suite_id=ts-maritime-undersea-v1`.
...
- Prefer `tool_suite_id=ts-undersea-cable-rights-security-v1` for primary decision support and bind to mission packet `DPL-UNDERSEA-CABLE-RIGHTS-001`.
- Use `tool_suite_id=ts-maritime-undersea-v1` as required cross-check for divergence or trust-score decay.
- Include `packet_id=DPL-UNDERSEA-CABLE-RIGHTS-001`, `protocol_profile`, `ack_chain_status`, and `trust_score` in all commander-facing outputs.
