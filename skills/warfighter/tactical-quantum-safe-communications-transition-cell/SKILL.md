---
name: tactical-quantum-safe-communications-transition-cell
description: Plan phased migration of tactical communications to quantum-resistant cryptographic profiles without mission disruption. Use when sequencing key rollover, interoperability tests, and fallback paths.
---
...
1. Frame the mission problem using these core inputs: current crypto inventory, interoperability constraints, rekey windows, mission-critical links.
...
Primary products for this skill: crypto transition timeline, interoperability risk register, degraded fallback communications matrix.
