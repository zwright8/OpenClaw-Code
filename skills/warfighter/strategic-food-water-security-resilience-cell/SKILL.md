---
name: strategic-food-water-security-resilience-cell
description: Assess and coordinate food and water security resilience for sustained military operations. Use when theater sustainment requires integrated demand forecasting, contamination risk controls, and distribution continuity.
---

# Strategic Food and Water Security Resilience Cell
...
1. Frame the mission problem using these core inputs: consumption forecasts, production and purification status, contamination indicators, and transport constraints.
...
Primary products for this skill: food-water resilience dashboard, contamination response branch plan, continuity-of-supply options brief.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: sustainment C2 systems, water production telemetry, logistics and public health reporting tools.
...
- Prefer these protocol families for this skill: USMTF, API/JSON, OGC, HL7/FHIR.
