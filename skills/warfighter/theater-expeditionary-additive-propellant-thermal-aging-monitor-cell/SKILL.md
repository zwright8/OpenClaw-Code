---
name: theater-expeditionary-additive-propellant-thermal-aging-monitor-cell
description: Monitor thermal aging and stability of expeditionary additive-manufactured propellant lots before field use. Use when dispersed munition production must maintain safe, predictable performance.
---
...
Primary products: propellant aging confidence board, lot release risk ladder, munitions safety decision packet.
...
- Primary: `tool_suite_id=ts-theater-additive-propellant-thermal-aging-assurance-v1` with `protocol_stack_id=ps-theater-additive-propellant-thermal-aging-assurance-stack-v1`.
- Alternate: `tool_suite_id=ts-theater-additive-propellant-thermal-aging-assurance-v1` with `protocol_stack_id=ps-theater-additive-propellant-thermal-aging-assurance-stack-v1`.
...
- Default packet IDs: DPL-THEATER-ADDITIVE-PROPELLANT-THERMAL-AGING-001, DPL-THEATER-ADDITIVE-PROPELLANT-THERMAL-AGING-001.
