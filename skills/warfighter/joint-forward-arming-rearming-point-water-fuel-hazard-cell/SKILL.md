---
name: joint-forward-arming-rearming-point-water-fuel-hazard-cell
description: Assess and mitigate water and fuel contamination, fire risk, and environmental hazards at forward arming and rearming points.
---
...
Primary products for this skill: FARP hazard posture card, contamination response branch table, sortie fueling go/no-go matrix.

## Tool Suite and Protocol Binding

- Bind tool selection to `ts-farp-water-fuel-hazard-v1` and `ps-farp-water-fuel-hazard-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Recommended external tools for this domain: fuel quality analyzers, water treatment telemetry, FARP ops trackers, and CBRN field sensor feeds.
- Required protocol families for implementation: STANAG 3756, USMTF, CoT, and HL7 FHIR.
