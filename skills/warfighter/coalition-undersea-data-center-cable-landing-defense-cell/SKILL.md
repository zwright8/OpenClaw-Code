---
name: coalition-undersea-data-center-cable-landing-defense-cell
description: Support U.S. warfighter planning and decision support for Coalition Undersea Data Center Cable Landing Defense Cell. Use when missions require coalition protection of seabed data center cable landings, rapid fault isolation, and continuity reroute governance, integrated options, and protocol-aware staff outputs.
---

# Coalition Undersea Data Center Cable Landing Defense Cell
...
Primary products for this skill: cable-landing defense matrix, fault-isolation timeline, coalition reroute authority packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: undersea cable topology analyzers, coalition releasability gateways, maritime anomaly correlation systems.
...
- Prefer these protocol families for this skill: NATO APP-11/ADatP-3 aligned, OGC, STIX/TAXII, API/JSON.
...
- Primary: tool_suite_id=ts-coalition-undersea-data-center-cable-landing-defense-cell-v1 with protocol_stack_id=ps-coalition-undersea-data-center-cable-landing-defense-cell-stack-v1.
- Alternate: tool_suite_id=ts-undersea-cable-restoration-traffic-priority-v1 with protocol_stack_id=ps-undersea-cable-restoration-traffic-priority-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-COALITION-CABLE-LANDING-DEFENSE-001, DPL-COALITION-CABLE-LANDING-DEFENSE-002.
