---
name: contested-geothermal-power-node-security-cell
description: Protect and restore contested geothermal power nodes supporting military and dual-use infrastructure. Use when energy resilience depends on geothermal wellfield security, control-system integrity, and phased power restoration.
---
...
Primary products for this skill: geothermal node defense and recovery sequence, ICS anomaly triage board, mission-load restoration ladder.
...
- Prioritize tool_suite_id=ts-geothermal-power-node-security-v1 + protocol_stack_id=ps-geothermal-power-node-security-stack-v1 when forward or homeland power continuity depends on geothermal production integrity under cyber and kinetic threat.
- Add packet_id=DPL-GEOTHERMAL-POWER-NODE-SECURITY-001 for recommendation branches that alter generation dispatch, protective patrol posture, or restoration priorities.
