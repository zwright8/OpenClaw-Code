---
name: joint-additive-prosthetics-rehabilitation-surge-cell
description: Support joint prosthetics fabrication and rehabilitation surge planning in contested theaters with constrained med-log throughput.
---

# Joint Additive Prosthetics Rehabilitation Surge Cell
...
- Primary: `tool_suite_id=ts-joint-additive-prosthetics-rehab-surge-v1` with `protocol_stack_id=ps-joint-additive-prosthetics-rehab-surge-stack-v1`.
- Alternate: `tool_suite_id=ts-medical-force-health-v1` with `protocol_stack_id=ps-contested-medical-regulation-stack-v1`.
...
- Default packet IDs: DPL-JOINT-ADDITIVE-PROSTHETICS-REHAB-SURGE-001, DPL-CEMA-BDA-001.
