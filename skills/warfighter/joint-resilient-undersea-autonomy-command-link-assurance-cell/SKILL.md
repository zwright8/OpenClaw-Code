---
name: joint-resilient-undersea-autonomy-command-link-assurance-cell
description: Assure command-and-control links for undersea autonomous systems with resilient routing, trust checks, and safe-mode governance.
---
...
Primary products for this skill: autonomy link assurance matrix, latency and burst-loss risk ladder, safe-mode trigger board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-undersea-autonomy-command-link-assurance-v1` with `protocol_stack_id=ps-undersea-autonomy-command-link-stack-v1`.
...
- Default packet IDs: DPL-UNDERSEA-AUTONOMY-C2-LINK-001.
