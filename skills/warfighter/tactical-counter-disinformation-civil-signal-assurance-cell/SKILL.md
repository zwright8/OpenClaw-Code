---
name: tactical-counter-disinformation-civil-signal-assurance-cell
description: Counter adversary disinformation at tactical and civil interfaces while protecting mission legitimacy and local trust indicators. Use when units need rapid options for rumor suppression, verified messaging, and cross-channel integrity assurance.
---
...
Primary products for this skill: disinformation threat map, trusted-message release plan, civil-signal confidence scorecard.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools for this domain: social signal monitoring platforms, message-authenticity verifiers, civil-affairs outreach trackers, multilingual narrative analysis tools.
- Prioritize these protocol families for this domain: STIX/TAXII, NIEM, USMTF, API/JSON.
...
- Include tool_suite_id=ts-tactical-counter-disinformation-civil-signal-assurance-cell-v1, protocol_stack_id=ps-tactical-counter-disinformation-civil-signal-assurance-cell-stack-v1, and packet_id=DPL-TACTICAL-COUNTER-DISINFORMATION-SIGNAL-001 for each critical recommendation.
