---
name: resilient-munition-production-and-quality-surveillance-cell
description: Support U.S. warfighter planning and decision support for Resilient Munition Production and Quality Surveillance Cell. Use when missions require resilient-munition-production-and-quality-surveillance-cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: mission decision brief, protocol-validated tool packet set, branch-sequel trigger matrix.
...
- Prioritize these tools or protocol families for this domain: industrial MES/SCADA, quality surveillance databases, lot traceability registries.
- State the protocol or message format for outbound coordination (for example API/JSON, USMTF, XML).
