---
name: theater-electromagnetic-decoy-corridor-and-civil-aviation-protection-cell
description: Support U.S. warfighter planning for electromagnetic decoy corridors while preserving civil aviation safety and deconfliction.
---
...
Use these tool categories by default: spectrum corridor planners, decoy-emission governance engines, and civil-airspace deconfliction boards.

## Protocol Profile

Preferred protocol families for this skill: Link 16 J-series, AIXM/FIXM, USMTF, STIX/TAXII, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-THEATER-ELECTROMAGNETIC-DECOY-CORRIDOR-CIVIL-AVIATION-PROTECTION-001 for critical recommendations.
