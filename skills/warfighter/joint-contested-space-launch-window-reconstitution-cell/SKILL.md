---
name: joint-contested-space-launch-window-reconstitution-cell
description: Support joint planning to reconstitute military launch windows after kinetic, cyber, or debris disruptions degrade assured access to orbit.
---
...
Primary products for this skill: launch window recovery matrix, payload reprioritization board, range and telemetry resilience timeline.

## U.S. Warfighter Employment Notes

- Prioritize military mission assurance and strategic warning continuity when launch windows collapse under contested conditions.
...
- For this domain, prioritize `ts-contested-space-launch-reconstitution-v1` with `ps-contested-space-launch-reconstitution-stack-v1` and `DPL-CONTESTED-SPACE-LAUNCH-RECONSTITUTION-001`.
