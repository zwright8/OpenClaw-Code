---
name: homeland-defense-industrial-control-system-ransomware-rapid-recovery-cell
description: Enable rapid recovery of defense-critical industrial control environments under ransomware attack while preserving safety and mission output. Use when national production nodes are disrupted by ICS-targeted malware.
---

# Homeland Defense Industrial Control System Ransomware Rapid Recovery Cell
...
1. Frame the mission problem using these core inputs: OT incident telemetry, safety interlock status, production mission priorities, and legal reporting obligations.
...
Primary products for this skill: ICS containment and restoration sequence, mission-output continuity matrix, cyber-physical safety exception log.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: OT SIEM/SOAR tools, safety PLC integrity monitors, industrial incident command boards.
...
## Domain Toolchain Override (2026-03-09, ICS Ransomware Recovery Branch)

- Prioritize tool_suite_id=ts-ics-ransomware-rapid-recovery-v1 with protocol_stack_id=ps-ics-ransomware-rapid-recovery-stack-v1 when ransomware impacts defense-industrial OT systems tied to mission-essential output.
- Use packet DPL-ICS-RANSOMWARE-RAPID-RECOVERY-001 to bind containment actions, safe restart gates, and production-priority restoration sequencing.
- If safety interlock trust or forensic evidence integrity degrades, downgrade to advisory-only restart recommendations and require commander or safety authority approval before re-energizing lines.
