---
name: denied-environment-humint-biometric-crosscue-cell
description: Support denied-environment targeting and force protection with HUMINT-biometric cross-cue confidence checks and source-risk-aware decision support.
---

# Denied Environment HUMINT Biometric Crosscue Cell
...
Use these tool categories by default: HUMINT confidence ledgers, biometric edge-watchlist services, source-compromise risk adjudication boards.

## Protocol Profile

Preferred protocol families for this skill: USMTF, STIX/TAXII, NIEM, CoT, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-HUMINT-BIOMETRIC-CROSSCUE-001 for critical recommendations.
