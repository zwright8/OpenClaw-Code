---
name: expeditionary-cold-chain-biologics-denied-corridor-cell
description: Plan expeditionary biologics and blood-product cold-chain continuity through denied logistics corridors. Use when medical sustainment requires mission-speed routing decisions with viability assurance and protocol-bound evidence trails.
---
...
Primary products for this skill: cold-chain survivability matrix, biologics diversion plan, denied-corridor medical sustainment packet.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools for this domain: cold-chain telemetry platforms, med-log routing optimizers, biologics viability analyzers, clinical demand forecasting boards.
- Prioritize these protocol families for this domain: HL7/FHIR, USMTF, API/JSON, NIEM.
...
- Include tool_suite_id=ts-expeditionary-cold-chain-biologics-denied-corridor-cell-v1, protocol_stack_id=ps-expeditionary-cold-chain-biologics-denied-corridor-cell-stack-v1, and packet_id=DPL-COLD-CHAIN-BIOLOGICS-DENIED-CORRIDOR-001 for each critical recommendation.
