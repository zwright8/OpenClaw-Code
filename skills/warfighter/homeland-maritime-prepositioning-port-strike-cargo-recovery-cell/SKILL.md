---
name: homeland-maritime-prepositioning-port-strike-cargo-recovery-cell
description: Orchestrate cargo recovery and mission-priority offload after kinetic or cyber-physical strikes on maritime prepositioning ports.
---
...
- Primary: `tool_suite_id=ts-maritime-prepositioning-port-strike-cargo-recovery-v1` with `protocol_stack_id=ps-maritime-prepositioning-port-strike-cargo-recovery-stack-v1`.
...
- Default packet IDs: `DPL-MARITIME-PREPOSITIONING-PORT-STRIKE-CARGO-RECOVERY-001`.
