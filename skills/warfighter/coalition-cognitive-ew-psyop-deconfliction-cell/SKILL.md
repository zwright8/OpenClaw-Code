---
name: coalition-cognitive-ew-psyop-deconfliction-cell
description: Support coalition deconfliction of electromagnetic and information influence effects to avoid fratricidal narrative outcomes.
---

# Coalition Cognitive Ew Psyop Deconfliction Cell
...
- Primary: `tool_suite_id=ts-coalition-cognitive-ew-psyop-deconfliction-v1` with `protocol_stack_id=ps-coalition-cognitive-ew-psyop-deconfliction-stack-v1`.
- Alternate: `tool_suite_id=ts-disinformation-counter-v1` with `protocol_stack_id=ps-disinformation-response-stack-v1`.
...
- Default packet IDs: DPL-COALITION-COGNITIVE-EW-PSYOP-DECONFLICTION-001, DPL-CEMA-BDA-001.
