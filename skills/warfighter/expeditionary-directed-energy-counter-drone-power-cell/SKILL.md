---
name: expeditionary-directed-energy-counter-drone-power-cell
description: Support U.S. warfighter planning for power-constrained directed-energy counter-UAS operations. Use when DE systems must balance engagement tempo, thermal limits, and base survivability.
---
...
Primary products for this skill: directed-energy firing budget, recharge cycle prioritization board, engagement constraint matrix.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-fires-airspace-v1` with `protocol_stack_id=ps-joint-tactical-link-stack-v1`.
...
- Preferred tools: counter-UAS C2 systems, directed-energy power/thermal telemetry, base energy microgrid controllers, sensor track fusion tools.
- Preferred protocol families: Link 16 J-series, VMF, API/JSON.
...
- Default packet IDs: DPL-CUAS-URBAN-001, DPL-EMSIG-LIFECYCLE-001.
