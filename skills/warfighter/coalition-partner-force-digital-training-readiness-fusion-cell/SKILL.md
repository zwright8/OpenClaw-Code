---
name: coalition-partner-force-digital-training-readiness-fusion-cell
description: Support coalition warfighter partner-force digital training readiness fusion. Use when multinational units require synchronized readiness evidence, training gaps, and interoperability remediation plans.
---
...
Primary products for this skill: partner readiness fusion board, interoperability gap closure queue, certification confidence summary.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-coalition-training-readiness-fusion-v1` with `protocol_stack_id=ps-coalition-training-readiness-fusion-stack-v1`.
- Alternate: `tool_suite_id=ts-reservist-mobilization-readiness-v1` with `protocol_stack_id=ps-reservist-mobilization-readiness-stack-v1`.
...
- Default packet IDs: DPL-COALITION-TRAINREADY-001, DPL-RESERVE-MOB-001.
