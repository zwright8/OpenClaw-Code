---
name: integrated-harbor-mine-countermeasures-and-clearance-cell
description: Coordinate harbor mine countermeasures, channel clearance, and reopening sequencing for military and relief traffic. Use when balancing clearance speed with port force protection.
---
...
1. Frame the mission problem using these core inputs: mine threat reports, hydrographic survey updates, MCM asset readiness, port traffic priorities.
...
Primary products for this skill: clearance tasking board, harbor reopening sequence, residual-risk acceptance package.
