---
name: coalition-border-biometrics-watchlist-latency-governance-cell
description: Control biometrics/watchlist synchronization latency across coalition border operations. Use when denied links and delayed updates increase false-match or miss risk.
---
...
Primary products for this skill: latency governance scorecard, identity confidence queue, sync recovery branch plan.

## Domain Tool Stack

Use these tool categories as the baseline stack: biometric sync brokers, watchlist latency telemetry, identity confidence adjudication services.

## Protocol Profile

Preferred protocol families for this skill: EBTS, NIEM watchlist exchange, signed latency manifests.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-border-biometrics-watchlist-latency-governance-v1` with `protocol_stack_id=ps-border-biometrics-watchlist-latency-governance-stack-v1`.
...
- Default packet IDs: DPL-BORDER-BIOMETRICS-WATCHLIST-LATENCY-GOVERNANCE-001, DPL-MULTI-DOMAIN-BATTLE-RHYTHM-FRAGMENT-RECOVERY-001.
