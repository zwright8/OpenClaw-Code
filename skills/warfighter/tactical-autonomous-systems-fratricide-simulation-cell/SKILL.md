---
name: tactical-autonomous-systems-fratricide-simulation-cell
description: Model and stress-test autonomous and semi-autonomous battlefield behaviors for fratricide risk, escalation hazards, and command override timing.
---
...
Primary products for this skill: autonomy fratricide risk simulation pack, override timing ladder, safety-governance release recommendations.
...
- Prioritize these domain tools: digital twin simulation environments, kill-web behavior analyzers, blue-force position feeds, mission replay services.
- Prioritize these protocol families: VMF, Link 16 J-series, USMTF, API/JSON.
...
- `tool_suite_id`: `ts-autonomy-fratricide-simulation-v1`
- `protocol_stack_id`: `ps-autonomy-fratricide-simulation-stack-v1`
