---
name: dynamic-civil-evacuation-route-protection-cell
description: Plan and adapt protected evacuation corridors for civilian movement during conflict or disaster response. Use when evacuation routes face evolving kinetic, criminal, or infrastructure threats.
---
...
1. Frame the mission problem using these core inputs: population movement feeds, route threat incidents, bridge/road status, host-nation coordination inputs.
...
Primary products for this skill: evacuation corridor protection plan, checkpoint posture matrix, reroute trigger table.
...
- Prioritize these tools or tool families for this domain: civil defense coordination tools, geospatial routing systems, law-enforcement liaison feeds, COP platforms.
