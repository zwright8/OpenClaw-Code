---
name: geospatial-intelligence-support-cell
description: Build GEOINT-informed products for mission planning and targeting support. Use when terrain, line-of-sight, mobility corridors, and population overlays drive mission success.
---

# Geospatial Intelligence Support Cell
...
1. Frame the mission problem using these core inputs: AOI boundaries, terrain/weather layers, ISR imagery, mobility constraints, named areas of interest.
...
Primary products for this skill: GEOINT packet, mobility and observation overlays, geospatial risk brief.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: DCGS GEOINT tools, ArcGIS/QGIS, OGC map services.
