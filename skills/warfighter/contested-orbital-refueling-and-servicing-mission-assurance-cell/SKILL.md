---
name: contested-orbital-refueling-and-servicing-mission-assurance-cell
description: Support U.S. warfighter planning and decision support for Contested Orbital Refueling and Servicing Mission Assurance Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: orbital servicing risk ledger, refueling window synchronization plan, mission assurance decision packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: orbital servicing mission planners, rendezvous safety monitors, propulsion and fuel state estimators.

## Protocol Profile

Preferred protocol families for this skill: CCSDS, API/JSON, USMTF.
