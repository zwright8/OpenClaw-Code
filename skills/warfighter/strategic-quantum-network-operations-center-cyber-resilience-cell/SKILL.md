---
name: strategic-quantum-network-operations-center-cyber-resilience-cell
description: Support U.S. warfighter planning for strategic quantum-network operations during cyber compromise and key-custody disruption.
---
...
Use these tool categories by default: quantum key-custody ledgers, network anomaly correlation boards, and strategic cyber-recovery orchestrators.

## Protocol Profile

Preferred protocol families for this skill: USMTF, STIX/TAXII, NIEM, API/JSON, signed key-status exports.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-STRATEGIC-QUANTUM-NETWORK-OPERATIONS-CYBER-RESILIENCE-001 for critical recommendations.
