---
name: theater-contested-airlift-landing-zone-viability-cell
description: Support U.S. warfighter contested-airlift landing-zone viability decisions. Use when changing weather, threat systems, or infrastructure damage alters landing-zone suitability and sortie recovery timelines.
---
...
Primary products for this skill: landing-zone viability scorecard, sortie risk timeline, reroute and divert trigger matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-airlift-lz-viability-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Preferred protocol families: USMTF, VMF, OGC.
...
- Default packet IDs: DPL-AIRLIFT-LZ-001, DPL-MED-COLDCHAIN-001.
