---
name: joint-electronic-signature-camouflage-compliance-cell
description: Support U.S. warfighter planning for electronic signature camouflage and deception discipline compliance. Use when missions require emissions hygiene, decoy timing, and survivability under persistent sensing.
---
...
Primary products for this skill: signature discipline scorecard, decoy timing matrix, detectability risk map.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: EW planning suites, signature library tools, threat-sensor analytics consoles.
- Preferred protocol profile for machine and staff exchange: Link 16 J-series + USMTF + API/JSON.
- Default tool suite binding: `tool_suite_id=ts-signature-camouflage-discipline-v1`.
- Default protocol stack binding: `protocol_stack_id=ps-signature-camouflage-stack-v1`.
- Default packet binding: `packet_id=DPL-EMSIG-CAMO-001`.
