---
name: homeland-pharma-raw-material-war-reserve-synchronization-cell
description: Support warfighter planning for pharmaceutical raw-material reserve posture, surge conversion, and protected military-civil allocation.
---

# Homeland Pharma Raw Material War Reserve Synchronization Cell
...
Primary products for this skill: raw-material reserve posture brief, pharma surge conversion matrix, and allocation branch plan with medical-force continuity triggers.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-pharma-raw-material-war-reserve-sync-v1` with `protocol_stack_id=ps-pharma-raw-material-war-reserve-sync-stack-v1`.
- Alternate: `tool_suite_id=ts-additive-pharma-authenticity-v1` with `protocol_stack_id=ps-additive-pharma-authenticity-stack-v1`.
...
- Default packet IDs: DPL-PHARMA-RAW-MATERIAL-RESERVE-001, DPL-PHARMA-SURGE-ALLOCATION-001
