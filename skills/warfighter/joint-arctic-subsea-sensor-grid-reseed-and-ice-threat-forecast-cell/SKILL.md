---
name: joint-arctic-subsea-sensor-grid-reseed-and-ice-threat-forecast-cell
description: Support U.S. warfighter planning for Joint Arctic Subsea Sensor Grid Reseed and Ice Threat Forecast Cell.
---
...
Use these tool categories by default: arctic subsea telemetry fusion boards, ice-keel threat predictors, and undersea reseed mission planners.

## Protocol Profile

Preferred protocol families for this skill: AIS/NMEA, USMTF, OGC WMS/WFS/WMTS, NATO APP-11/ADatP-3 aligned, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-JOINT-ARCTIC-SUBSEA-SENSOR-GRID-RESEED-ICE-THREAT-FORECAST-001 for critical recommendations.
