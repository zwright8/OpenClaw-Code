---
name: theater-denied-electronic-warfare-mission-data-reprogramming-cell
description: Reprogram EW mission data in denied conditions while preserving safety, fratricide control, and release authority.
---
...
Primary products for this skill: EW mission-data delta packet, release authority gate log, spectrum fratricide risk matrix.

## Domain Tool Stack

Use these tool categories as the baseline stack: EW library management, emitter intelligence fusion, disconnected software signing pipeline, mission-data distribution cell.

## Protocol Profile

Preferred protocol families for this skill: Link 16 J-series, VMF, USMTF, STIX/TAXII.
...
- Prioritize `tool_suite_id=ts-theater-denied-electronic-warfare-mission-data-reprogramming-cell-v1` + `protocol_stack_id=ps-theater-denied-electronic-warfare-mission-data-reprogramming-cell-stack-v1` when this mission set is the critical path for commander decision timelines.
- Add `packet_id=DPL-THEATER_DENIED_ELECTRONIC_WARFARE_MISSION_DATA_REPROGRAMMING_CELL-001` for the primary course of action and `packet_id=DPL-THEATER_DENIED_ELECTRONIC_WARFARE_MISSION_DATA_REPROGRAMMING_CELL-002` for degraded-mode fallback actions.
