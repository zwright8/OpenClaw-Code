---
name: strategic-seabed-critical-mineral-supply-denial-mitigation-cell
description: Coordinate strategic responses to seabed critical-mineral supply denial with industrial and operational continuity controls.
---
...
Primary products: seabed supply denial matrix, strategic allocation ladder, mineral-continuity packet.
...
- Primary: `tool_suite_id=ts-strategic-seabed-critical-mineral-supply-denial-mitigation-v1` with `protocol_stack_id=ps-strategic-seabed-critical-mineral-supply-denial-mitigation-stack-v1`.
...
- Default packet IDs: `DPL-STRATEGIC-SEABED-CRITICAL-MINERAL-SUPPLY-DENIAL-MITIGATION-001`.
