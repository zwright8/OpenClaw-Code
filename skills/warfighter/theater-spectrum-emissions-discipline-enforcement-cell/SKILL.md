---
name: theater-spectrum-emissions-discipline-enforcement-cell
description: Enforce emissions-control discipline to reduce detectability and fratricide in contested electromagnetic battlespaces. Use when warfighters must synchronize mission tempo with strict spectrum posture controls.
---

# Theater Battlefield Spectrum Emissions Discipline Enforcement Cell
...
Primary products for this skill: spectrum emissions compliance board, detectability risk heatmap, EMCON enforcement trigger matrix.
...
- Add `tool_suite_id=ts-theater-spectrum-emissions-discipline-enforcement-v1` + `protocol_stack_id=ps-theater-spectrum-emissions-discipline-enforcement-stack-v1` when producing critical recommendations for this mission domain.
