---
name: joint-rapid-ice-runway-construction-and-fracture-monitoring-cell
description: Support rapid construction and fracture monitoring of ice runways for joint polar air operations. Use when sortie generation depends on temporary ice runway integrity under changing climate and threat conditions.
---
...
Primary products for this skill: ice runway construction sequence, fracture risk monitoring board, sortie viability confidence chart.
...
- Add `tool_suite_id=ts-joint-ice-runway-fracture-monitoring-v1` + `protocol_stack_id=ps-joint-ice-runway-fracture-monitoring-stack-v1` when producing critical recommendations for this mission domain.
