---
name: joint-theater-waterway-chokepoint-obstruction-clearance-cell
description: Support U.S. warfighter planning and operational decision support for Joint Theater Waterway Chokepoint Obstruction Clearance Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---

# Joint Theater Waterway Chokepoint Obstruction Clearance Cell
...
Primary products for this skill: obstruction assessment map, clearance sequencing matrix, throughput recovery forecast.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: maritime C2 systems, hydrographic survey tools, salvage tasking platforms, port throughput dashboards.
...
- Prefer these protocol families for this skill: AIS/NMEA, OGC, USMTF.
