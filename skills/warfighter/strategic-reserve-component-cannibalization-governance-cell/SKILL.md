---
name: strategic-reserve-component-cannibalization-governance-cell
description: Support U.S. warfighter planning for reserve-component cannibalization governance balancing readiness recovery, maintenance debt, and legal sustainment controls.
---
...
Primary products for this skill: cannibalization decision ledger, readiness debt projection, controlled restoration sequencing packet.

## Domain Tool Stack

Use these tool categories by default: maintenance readiness systems, supply ledger analytics, fleet availability forecasting services.

## Protocol Profile

Preferred protocol families for this skill: USMTF, NIEM, API/JSON.

## Domain Toolchain Defaults

- Primary: tool_suite_id=ts-reserve-cannibalization-governance-v1 with protocol_stack_id=ps-reserve-cannibalization-governance-stack-v1.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-RESERVE-CANNIBALIZATION-GOVERNANCE-001 for critical recommendations.
