---
name: contested-personnel-recovery-planner
description: Plan personnel recovery support in contested environments with joint and coalition assets. Use when coordinating location, authentication, recovery forces, and reintegration steps.
---
...
1. Frame the mission problem using these core inputs: isolated personnel data, threat disposition, recovery asset status, authentication procedures.
...
Primary products for this skill: personnel recovery support plan, recovery decision matrix, reintegration checklist.
