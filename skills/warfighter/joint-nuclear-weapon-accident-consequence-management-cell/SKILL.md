---
name: joint-nuclear-weapon-accident-consequence-management-cell
description: Coordinate consequence management for a nuclear weapon accident with contamination control, public safety alignment, and force continuity.
---
...
Primary products for this skill: nuclear accident consequence packet, contamination control matrix, phased restoration timeline.
...
- Prioritize these domain tools: radiation sensor fusion platforms, hazard plume modeling tools, emergency command dashboards, restoration orchestration systems.
- Prioritize these protocol families: EDXL-DE/CAP, NIMS/ICS, USMTF, API/JSON.
...
- `tool_suite_id`: `ts-nuclear-accident-consequence-v1`
- `protocol_stack_id`: `ps-nuclear-accident-consequence-stack-v1`
