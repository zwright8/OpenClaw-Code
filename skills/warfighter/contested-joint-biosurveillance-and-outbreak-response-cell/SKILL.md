---
name: contested-joint-biosurveillance-and-outbreak-response-cell
description: Support biosurveillance and outbreak containment planning in contested theaters. Use when integrating syndromic signals, laboratory reporting, and movement controls for force health protection.
---
...
1. Frame the mission problem using these core inputs: syndromic surveillance, lab confirmation status, troop movement patterns, medical isolation capacity.
...
Primary products for this skill: outbreak early-warning dashboard, containment COA comparison, medical movement restriction order set.
