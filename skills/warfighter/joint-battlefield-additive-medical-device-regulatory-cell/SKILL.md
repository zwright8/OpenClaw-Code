---
name: joint-battlefield-additive-medical-device-regulatory-cell
description: Govern additive manufacturing of battlefield medical devices with quality, safety, legal, and interoperability controls across coalition treatment networks.
---
...
Primary products for this skill: additive medical device release board, quality and traceability packet, field-use regulatory exception matrix.
...
- Prioritize these domain tools: medical additive manufacturing QA systems, med-log part traceability ledgers, biomedical validation services, clinical governance tools.
- Prioritize these protocol families: HL7/FHIR, USMTF, API/JSON.
...
- `tool_suite_id`: `ts-additive-medical-device-regulatory-v1`
- `protocol_stack_id`: `ps-additive-medical-device-regulatory-stack-v1`
