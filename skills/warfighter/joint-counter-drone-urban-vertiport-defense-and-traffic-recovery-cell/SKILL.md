---
name: joint-counter-drone-urban-vertiport-defense-and-traffic-recovery-cell
description: Defend urban vertiports from drone threats while restoring protected military and emergency mobility traffic.
---
...
Primary products: vertiport defense posture brief, mobility recovery launch matrix, and airspace deconfliction packet.

## Domain Toolchain Defaults

- Primary: tool_suite_id=ts-urban-vertiport-defense-recovery-v1 with protocol_stack_id=ps-urban-vertiport-defense-recovery-stack-v1.
...
- Default packet IDs: DPL-URBAN-VERTIPORT-DEFENSE-RECOVERY-001.
