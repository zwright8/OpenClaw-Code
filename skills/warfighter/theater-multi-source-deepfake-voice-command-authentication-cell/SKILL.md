---
name: theater-multi-source-deepfake-voice-command-authentication-cell
description: Authenticate and triage suspected deepfake voice command injections across theater command networks. Use when adversaries may spoof leaders or operators through synthetic audio.
---
...
Primary products for this skill: voice-command authenticity triage log, command trust restoration workflow, synthetic-audio threat packet.
...
- Add `tool_suite_id=ts-theater-deepfake-voice-command-authentication-v1` + `protocol_stack_id=ps-theater-deepfake-voice-command-authentication-stack-v1` when producing critical recommendations for this mission domain.
