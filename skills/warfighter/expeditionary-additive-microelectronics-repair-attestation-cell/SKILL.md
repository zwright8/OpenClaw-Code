---
name: expeditionary-additive-microelectronics-repair-attestation-cell
description: Manage expeditionary additive microelectronics repair and attestation for mission-critical systems under denied supply conditions.
---
...
- Confirm command echelon, authority constraints, coalition caveats, and decision deadlines before recommending action.
...
4. Bind critical recommendations to concrete external tools, protocol stacks, and packet templates.
...
Primary products: repair attestation packet, component trust scorecard, and mission release recommendation board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-expeditionary-additive-microelectronics-attestation-v1` with `protocol_stack_id=ps-expeditionary-additive-microelectronics-attestation-stack-v1`.
...
- Default packet IDs: `DPL-EXPEDITIONARY-ADDITIVE-MICROELECTRONICS-REPAIR-001`, `DPL-MICROELECTRONICS-ATTESTATION-MISSION-RELEASE-001`.
