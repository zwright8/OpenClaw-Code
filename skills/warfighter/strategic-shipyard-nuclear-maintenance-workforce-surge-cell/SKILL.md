---
name: strategic-shipyard-nuclear-maintenance-workforce-surge-cell
description: Support strategic shipyard nuclear-maintenance workforce surge planning under combat readiness pressure. Use when certification bottlenecks and industrial workforce constraints threaten fleet availability.
---
...
Primary products for this skill: nuclear maintenance workforce surge matrix, certification throughput forecast, critical-skill gap closure queue.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-shipyard-nuclear-workforce-v1` with `protocol_stack_id=ps-shipyard-nuclear-workforce-stack-v1`.
...
- Default packet IDs: DPL-SHIPYARD-NUKE-WF-001.
