---
name: strategic-orbital-nuclear-debris-collision-avoidance-cell
description: Support warfighter planning for orbital nuclear-effects debris monitoring and collision-avoidance governance for strategic assets.
---

# Strategic Orbital Nuclear Debris Collision Avoidance Cell
...
Primary products for this skill: orbital debris collision risk brief, strategic asset protection matrix, and maneuver authority branch plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-orbital-nuclear-debris-collision-avoidance-v1` with `protocol_stack_id=ps-orbital-nuclear-debris-collision-avoidance-stack-v1`.
- Alternate: `tool_suite_id=ts-space-satcom-v1` with `protocol_stack_id=ps-space-rpo-denial-awareness-stack-v1`.
...
- Default packet IDs: DPL-ORBITAL-NUCLEAR-DEBRIS-COLLISION-001, DPL-STRATEGIC-ORBITAL-MANEUVER-AUTH-001
