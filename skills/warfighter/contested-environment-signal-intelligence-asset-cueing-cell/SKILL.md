---
name: contested-environment-signal-intelligence-asset-cueing-cell
description: Cue SIGINT assets for contested environments using multi-source trigger fusion.
---
...
Primary products for this skill: sigint cueing priority matrix, emitter watchlist update plan, contested collection synchronization board.
