---
name: arctic-and-extreme-environment-ops
description: Develop plans for operations in arctic and extreme environments with severe weather and sustainment stressors. Use when tailoring force posture, mobility, and survivability to climate risks.
---
...
1. Frame the mission problem using these core inputs: temperature and weather projections, mobility limits, sustainment constraints, personnel readiness.
...
Primary products for this skill: extreme environment operations plan, climate risk controls, sustainment contingency matrix.
