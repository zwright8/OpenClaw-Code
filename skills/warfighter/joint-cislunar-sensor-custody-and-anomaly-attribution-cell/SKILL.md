---
name: joint-cislunar-sensor-custody-and-anomaly-attribution-cell
description: Support U.S. warfighter planning for cislunar sensor custody assurance, anomaly attribution, and joint warning continuity across space-ground networks.
---
...
Primary products for this skill: sensor custody confidence ledger, anomaly attribution packet, warning continuity branch ladder.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: space domain awareness fusion board, sensor custody ledger, anomaly classifier, warning dissemination control board.
...
- Prefer these protocol families for this skill: CCSDS telemetry, API/JSON, USMTF, signed custody manifests.
