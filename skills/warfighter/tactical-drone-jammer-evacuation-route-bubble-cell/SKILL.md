---
name: tactical-drone-jammer-evacuation-route-bubble-cell
description: Support tactical planning to establish protected evacuation movement bubbles with drone-jammer coverage in urban and peri-urban conflict zones.
---
...
Primary products for this skill: jammer bubble geometry card, evac route viability matrix, contested movement trigger board.
...
- For this domain, prioritize `ts-drone-jammer-evac-route-bubble-v1` with `ps-drone-jammer-evac-route-bubble-stack-v1` and `DPL-DRONE-JAMMER-EVAC-ROUTE-BUBBLE-001`.
