---
name: pnt-navwar-resilience-planner
description: Develop positioning, navigation, and timing resilience plans for navigation warfare conditions. Use when GPS denial or spoofing risks mission execution.
---

# PNT and NAVWAR Resilience Planner
...
1. Frame the mission problem using these core inputs: mission navigation dependencies, PNT alternatives, threat EW profiles, timing requirements.
...
Primary products for this skill: PNT resilience concept, NAVWAR mitigation matrix, decision thresholds card.
