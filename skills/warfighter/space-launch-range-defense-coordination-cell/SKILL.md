---
name: space-launch-range-defense-coordination-cell
description: Coordinate defense of launch ranges, spaceports, and critical support nodes against kinetic and cyber threats. Use when synchronizing warning, security posture, and recovery actions.
---
...
Primary products for this skill: Range defense readiness board, launch support node risk matrix, recovery priority sequence.
