---
name: joint-additive-electronics-repair-and-assurance-cell
description: Support U.S. warfighter planning for field-expedient additive electronics repair, validation, and release authority. Use when critical boards, RF modules, or compute components fail in denied logistics environments.
---
...
Primary products for this skill: repair eligibility triage list, additive electronics QA release packet, mission-impact restoration timeline.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-logistics-distribution-v1` with `protocol_stack_id=ps-logistics-ledger-stack-v1`.
...
- Preferred tools: maintenance readiness systems, additive fabrication queues, electronics test/validation benches, SBOM verification tools.
- Preferred protocol families: API/JSON, USMTF, XML.
...
- Default packet IDs: DPL-MUNI-QA-001, DPL-RAILPORT-001.
