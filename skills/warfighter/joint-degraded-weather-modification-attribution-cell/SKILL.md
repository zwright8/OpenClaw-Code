---
name: joint-degraded-weather-modification-attribution-cell
description: Support attribution and mission-adjustment planning when weather anomalies may be adversary-influenced or sensor-manipulated.
---

# Joint Degraded Weather Modification Attribution Cell
...
- Primary: `tool_suite_id=ts-joint-weather-modification-attribution-v1` with `protocol_stack_id=ps-joint-weather-modification-attribution-stack-v1`.
- Alternate: `tool_suite_id=ts-climate-digital-twin-v1` with `protocol_stack_id=ps-climate-digital-twin-resilience-stack-v1`.
...
- Default packet IDs: DPL-JOINT-WEATHER-MODIFICATION-ATTRIBUTION-001, DPL-CEMA-BDA-001.
