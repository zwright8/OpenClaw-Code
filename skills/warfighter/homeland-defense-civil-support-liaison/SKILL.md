---
name: homeland-defense-civil-support-liaison
description: Support defense support of civil authorities and homeland defense mission coordination. Use when integrating military capabilities with federal, state, and local response structures.
---

# Homeland Defense and Civil Support Liaison
...
1. Frame the mission problem using these core inputs: incident scope, civil authority requests, force availability, legal constraints.
...
Primary products for this skill: civil support coordination brief, capability allocation plan, authority-compliance checklist.
