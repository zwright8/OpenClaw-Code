---
name: multi-domain-targeting-ethics-and-authority-check-cell
description: Plan and coordinate Multi Domain Targeting Ethics And Authority Check Cell operations for U.S. warfighters. Use when staff needs mission-ready recommendations, tool/protocol-integrated workflows, and escalation triggers in this domain.
---
