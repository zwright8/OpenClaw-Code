---
name: theater-solar-microgrid-signature-control-and-expeditionary-power-cell
description: Manage expeditionary solar-microgrid resilience while minimizing electromagnetic and thermal signature exposure.
---
...
Primary products for this skill: microgrid signature-control plan, expeditionary power continuity board, load-priority reconfiguration matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-solar-microgrid-signature-control-v1` with `protocol_stack_id=ps-solar-microgrid-signature-control-stack-v1`.
- Alternate: `tool_suite_id=ts-grid-feeder-priority-shed-v1` with `protocol_stack_id=ps-grid-feeder-priority-shed-stack-v1`.
...
- Default packet IDs: DPL-SOLAR-MICROGRID-SIGNATURE-CONTROL-001.
