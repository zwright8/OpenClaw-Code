---
name: joint-deep-strike-target-system-analysis-cell
description: Develop target-system analysis and sequencing options for long-range joint strike campaigns. Use when commanders need effects-focused target development beyond single-target prosecution.
---
...
1. Frame the mission problem using these core inputs: target system model, ISR confidence, weaponeering constraints, campaign objectives.
...
Primary products for this skill: target-system dependency map, phased deep-strike options, operational assessment criteria.
...
- Prioritize these tools or tool families for this domain: DCGS variants, targeting tools, weaponeering applications, campaign planning boards.
- Specify outbound exchange format for recommendations and tasking: USMTF, VMF, OGC WMS/WFS/WMTS.
