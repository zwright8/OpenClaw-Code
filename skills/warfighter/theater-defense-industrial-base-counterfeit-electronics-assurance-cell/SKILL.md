---
name: theater-defense-industrial-base-counterfeit-electronics-assurance-cell
description: Detect and contain counterfeit, tampered, or unreliable electronics entering theater supply chains before they degrade mission assurance.
---

# Theater Defense Industrial Base Counterfeit Electronics Assurance Cell
...
Primary products for this skill: counterfeit part risk map, quarantine and replacement order set, supplier trust and remediation board.

## Domain Tool Stack

Use these tool categories as the baseline stack: DIB supplier intelligence fusion, serial provenance ledger, failure-analysis lab exchange, sustainment ERP quality feeds.

## Protocol Profile

Preferred protocol families for this skill: JC3IEDM, USMTF logistics annexes, STIX/TAXII, EDI X12.
...
- Prioritize `tool_suite_id=ts-theater-defense-industrial-base-counterfeit-electronics-assurance-cell-v1` + `protocol_stack_id=ps-theater-defense-industrial-base-counterfeit-electronics-assurance-cell-stack-v1` when this mission set is the critical path for commander decision timelines.
- Add `packet_id=DPL-THEATER_DEFENSE_INDUSTRIAL_BASE_COUNTERFEIT_ELECTRONICS_ASSURANCE_CELL-001` for the primary course of action and `packet_id=DPL-THEATER_DEFENSE_INDUSTRIAL_BASE_COUNTERFEIT_ELECTRONICS_ASSURANCE_CELL-002` for degraded-mode fallback actions.
