---
name: strategic-waterway-lock-and-dam-cyber-physical-resilience-cell
description: Support U.S. warfighter planning and decision support for Strategic Waterway Lock And Dam Cyber Physical Resilience Cell. Use when missions require lock-and-dam cyber-physical defense, inland waterway throughput resilience, and restoration branch orchestration, integrated options, and protocol-aware staff outputs.
---

# Strategic Waterway Lock And Dam Cyber Physical Resilience Cell
...
Primary products for this skill: waterway critical node risk board, lock-and-dam incident response matrix, throughput restoration branch package.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: industrial control telemetry platforms, inland maritime movement systems, cyber incident response boards, infrastructure digital twins.

## Protocol Profile

Preferred protocol families for this skill: IEC 62443 profiles, STIX/TAXII, API/JSON.
...
- Start with tool_suite_id=ts-waterway-lock-dam-cyber-physical-resilience-v1 and protocol_stack_id=ps-waterway-lock-dam-cyber-physical-stack-v1, then branch only when mission constraints require it.
