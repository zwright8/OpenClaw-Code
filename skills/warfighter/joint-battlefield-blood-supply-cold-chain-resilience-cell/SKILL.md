---
name: joint-battlefield-blood-supply-cold-chain-resilience-cell
description: Coordinate joint battlefield blood supply and cold-chain resilience in contested logistics environments. Use when warfighters need casualty survival support despite transport disruption and power instability.
---
...
Primary products for this skill: battlefield blood distribution board, cold-chain failure branch plan, casualty-priority allocation matrix.
...
- Add `tool_suite_id=ts-battlefield-blood-cold-chain-resilience-v1` + `protocol_stack_id=ps-battlefield-blood-cold-chain-resilience-stack-v1` when producing critical recommendations for this mission domain.
