---
name: joint-dynamic-no-strike-list-assurance-cell
description: Support U.S. warfighter planning and operational decision support for Joint Dynamic No-Strike List Assurance Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: restricted target lists, legal constraints, coalition caveats, sensor confirmation inputs.
...
Primary products for this skill: no-strike assurance brief, data-conflict adjudication board, fires release control matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: targeting systems, legal review workflows, geospatial validation tools, coalition releasability dashboards.
...
- Prefer these protocol families for this skill: USMTF, VMF, OGC.
