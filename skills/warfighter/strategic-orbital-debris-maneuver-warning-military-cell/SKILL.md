---
name: strategic-orbital-debris-maneuver-warning-military-cell
description: Coordinate strategic warning and maneuver decisions for military constellations exposed to orbital debris and adversary-created fragmentation events. Use when warfighters need timely maneuver sequencing and mission-priority tradeoffs in space.
---

# Strategic Orbital Debris Maneuver Warning for Military Constellations Cell
...
Primary products for this skill: orbital debris maneuver warning board, constellation priority maneuver queue, mission-loss risk matrix.
...
- Add `tool_suite_id=ts-orbital-debris-maneuver-warning-military-constellations-v1` + `protocol_stack_id=ps-orbital-debris-maneuver-warning-military-constellations-stack-v1` when producing critical recommendations for this mission domain.
