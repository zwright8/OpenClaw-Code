---
name: theater-civil-maritime-evacuation-sea-bridge-cell
description: Plan and synchronize civilian maritime evacuation corridors with military sea control and port throughput constraints. Use when noncombatant evacuation requires high-confidence maritime routing and staging.
---
...
1. Frame the mission problem using these core inputs: evacuation demand by port, vessel readiness, maritime threat posture, embarkation processing rates, host-nation restrictions.
...
Primary products for this skill: civil maritime evacuation schedule, protected sea bridge corridor plan, embarkation-debarkation throughput matrix.
