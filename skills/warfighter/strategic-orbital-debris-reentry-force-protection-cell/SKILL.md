---
name: strategic-orbital-debris-reentry-force-protection-cell
description: Assess and mitigate force and infrastructure risk from adversary-linked orbital debris and uncontrolled reentry events.
---
...
Primary products: reentry threat picture, force-protection branch matrix, infrastructure risk heatmap, and warning dissemination order.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-orbital-debris-reentry-force-protection-v1` with `protocol_stack_id=ps-orbital-debris-reentry-force-protection-stack-v1`.
...
- Default packet IDs: DPL-ORBITAL-DEBRIS-REENTRY-PROTECTION-001, DPL-REENTRY-WARNING-DISSEMINATION-001.
