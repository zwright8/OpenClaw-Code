---
name: theater-fuel-pipeline-sabotage-repair-prioritization-cell
description: Prioritize fuel pipeline sabotage response and theater fuel continuity. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: damage reports, pump station status, storage levels, fuel demand by operation.
...
Primary products for this skill: repair priority board, fuel continuity plan, risk-to-mission forecast.
