---
name: theater-denied-terrain-autonomy-map-poisoning-detection-cell
description: Detect autonomy map poisoning in denied terrain and protect mission navigation trust. Use when adversaries manipulate mapping data or terrain models used by autonomous systems.
---
...
Primary products for this skill: map trust anomaly board, autonomy route confidence ladder, map-source quarantine and remediation plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-autonomy-map-poisoning-detect-v1` with `protocol_stack_id=ps-autonomy-map-poisoning-stack-v1`.
...
- Default packet IDs: DPL-AUTON-MAP-POISON-001.
