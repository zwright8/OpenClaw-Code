---
name: theater-denied-pnt-artillery-timing-assurance-cell
description: Support U.S. warfighter planning for artillery timing assurance in denied-PNT environments with synchronized fires and reduced fratricide risk.
---
...
Primary products for this skill: timing integrity confidence board, fires synchronization drift matrix, alternate timing branch packet.

## Domain Tool Stack

Use these tool categories by default: time-transfer integrity monitors, fire-control synchronization tools, PNT fallback planning boards.

## Protocol Profile

Preferred protocol families for this skill: Link 16 J-series, USMTF, STANAG, API/JSON.

## Domain Toolchain Defaults

- Primary: tool_suite_id=ts-denied-pnt-artillery-timing-assurance-v1 with protocol_stack_id=ps-denied-pnt-artillery-timing-assurance-stack-v1.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-DENIED-PNT-ARTILLERY-TIMING-001 for critical recommendations.
