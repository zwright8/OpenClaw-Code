---
name: strategic-rare-isotope-supply-chain-denial-and-medical-deterrence-continuity-cell
description: Support U.S. warfighter planning for strategic rare-isotope supply denial mitigation and medical-deterrence continuity.
---
...
Use these tool categories by default: rare-isotope inventory confidence boards, strategic allocation adjudicators, and mission-medical continuity planners.

## Protocol Profile

Preferred protocol families for this skill: USMTF, NIEM, STIX/TAXII, signed custody exports, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-STRATEGIC-RARE-ISOTOPE-SUPPLY-DENIAL-MEDICAL-DETERRENCE-CONTINUITY-001 for critical recommendations.
