---
name: coalition-host-nation-transportation-network-assurance-cell
description: Plan coalition and host-nation transportation resilience under disruption. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: host-nation route network status, throughput constraints, security incidents, coalition movement priorities.
...
Primary products for this skill: transport assurance plan, reroute matrix, coalition movement advisory.
