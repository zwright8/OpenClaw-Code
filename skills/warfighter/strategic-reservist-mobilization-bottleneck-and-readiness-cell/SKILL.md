---
name: strategic-reservist-mobilization-bottleneck-and-readiness-cell
description: Support U.S. warfighter force-generation decisions by identifying reserve mobilization bottlenecks, readiness risks, and mitigation branches.
---
...
Primary products for this skill: mobilization bottleneck map, readiness recovery sequence, force-flow decision brief.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: personnel readiness systems, training certification ledgers, transport and staging dashboards, dependency analytics.
...
- Primary: \ with \.\n- Alternate: \ with \.\n- Degraded: phased mobilization board with 12-hour readiness refresh cadence.
...
- Prefer these protocol families for this skill: USMTF, API/JSON, NATO APP-11/ADatP-3 aligned.
