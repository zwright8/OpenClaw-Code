---
name: coalition-cyber-electromagnetic-order-of-battle-fusion-cell
description: Fuse coalition cyber and electromagnetic order-of-battle signals to improve joint sensing, attribution confidence, and defensive campaign coordination.
---
...
Primary products for this skill: coalition cyber-EM OOB confidence map, attribution and response option matrix, synchronized defensive campaign trigger table.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: cyber threat intelligence fusion boards, spectrum occupancy analyzers, coalition releasability and legal gates, cross-domain warning dashboards.
...
- Prefer these protocol families for this skill: STIX/TAXII, Link 16 J-series, VMF, NATO APP-11/ADatP-3.
