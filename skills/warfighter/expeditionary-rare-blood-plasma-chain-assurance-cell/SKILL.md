---
name: expeditionary-rare-blood-plasma-chain-assurance-cell
description: Support U.S. warfighter planning for rare blood and plasma chain assurance in expeditionary operations with contested cold-chain and evacuation constraints.
---

# Expeditionary Rare Blood and Plasma Chain Assurance Cell
...
Primary products for this skill: rare-blood availability forecast, plasma chain assurance plan, casualty-priority allocation matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: medical cold-chain telemetry board, blood registry reconciler, casualty movement prioritizer, spoilage risk monitor.
...
- Prefer these protocol families for this skill: HL7/FHIR, API/JSON, USMTF, EDXL.
