---
name: theater-denied-fuel-bladder-integrity-monitor-cell
description: Detect and manage fuel bladder leaks, sabotage indicators, and contamination risks in denied forward sustainment areas.
---
...
Primary products for this skill: fuel bladder integrity monitor, contamination branch matrix, resupply protection task board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-denied-fuel-bladder-integrity-v1` with `protocol_stack_id=ps-denied-fuel-bladder-integrity-stack-v1`.
- Alternate: `tool_suite_id=ts-convoy-fuel-fraud-detection-v1` with `protocol_stack_id=ps-convoy-fuel-fraud-stack-v1`.
...
- Default packet IDs: DPL-DENIED-FUEL-BLADDER-001.
