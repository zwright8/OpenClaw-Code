---
name: littoral-anti-ship-missile-defense-coordination-cell
description: Integrate sensors, shooters, and decoys to defend littoral formations and ports from anti-ship missile threats. Use when setting defense sectors, engagement priorities, and decoy employment.
---
...
1. Frame the mission problem using these core inputs: missile threat laydown, defended assets list, interceptor magazine status, EW/decoy availability.
...
Primary products for this skill: littoral defense sector plan, engagement authority matrix, interceptor/decoy expenditure forecast.
