---
name: religious-support-operations-coordinator
description: Coordinate religious support planning for deployed forces and mission environments. Use when balancing unit ministry support, advisement, and operational constraints.
---

# Religious Support Operations Coordinator
...
1. Frame the mission problem using these core inputs: force composition, religious support assets, location constraints, operational tempo.
...
Primary products for this skill: religious support plan, coverage schedule, advisement issue tracker.
