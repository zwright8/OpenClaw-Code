---
name: coalition-information-operations-civil-trust-stabilization-cell
description: Stabilize civil trust against adversary influence operations in coalition campaigns. Use when disinformation, deepfake narratives, or rumor cascades threaten mission legitimacy and public safety.
---
...
1. Frame the mission problem using these core inputs: narrative threat telemetry, audience sentiment shifts, coalition messaging authorities, incident timeline, civil-risk hotspots.
...
Primary products for this skill: civil-trust stabilization campaign plan, influence-threat confidence ladder, coalition release and rebuttal matrix.
...
- Add `tool_suite_id=ts-coalition-information-ops-civil-trust-stabilization-v1` + `protocol_stack_id=ps-coalition-information-ops-civil-trust-stabilization-stack-v1` when this domain is mission-critical in current planning.
- Add `packet_id=DPL-COALITION-CIVIL-TRUST-STABILIZATION-001` for branches that can materially alter mission posture or civil-protection outcomes.
