---
name: theater-dam-and-lock-critical-waterway-defense-cell
description: Defend and restore critical dams and lock-controlled waterways that shape maneuver and sustainment.
---
...
- Use packet template `DPL-DAM-LOCK-001` from `../_shared/references/domain-tool-packet-library.md`.
- Bind tool and protocol choices to `ts-dam-lock-defense-v1` and `ps-dam-lock-defense-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
...
- Primary: `tool_suite_id=ts-dam-lock-defense-v1` with `protocol_stack_id=ps-dam-lock-defense-stack-v1`.
...
- Default packet ID: `DPL-DAM-LOCK-001`.
