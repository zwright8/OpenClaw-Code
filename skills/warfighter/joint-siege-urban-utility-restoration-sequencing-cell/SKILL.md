---
name: joint-siege-urban-utility-restoration-sequencing-cell
description: Sequence restoration of power, water, sanitation, and communications during urban siege or prolonged disruption. Use when utility restoration must balance civilian protection, force requirements, and contested security conditions.
---
...
1. Frame the mission problem using these core inputs: urban utility damage assessments, population service demand, repair crew availability, security threat map, and critical-service priorities.
...
Primary products for this skill: urban utility restoration sequencing matrix, security-constrained repair plan, civilian-impact risk brief.
...
- Primary: `tool_suite_id=ts-urban-utility-restoration-v1` with `protocol_stack_id=ps-critical-infrastructure-triage-stack-v1`.
