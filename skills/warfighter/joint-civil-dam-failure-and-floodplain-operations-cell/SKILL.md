---
name: joint-civil-dam-failure-and-floodplain-operations-cell
description: Support military-civil operations for dam failure risk, floodplain evacuation, and downstream infrastructure protection. Use for pre-failure warning and post-failure response.
---
...
1. Frame the mission problem using these core inputs: dam structural health indicators, downstream population and infrastructure exposure, evacuation route status, response force availability.
...
Primary products for this skill: dam-failure contingency operations order, floodplain protection priority board, evacuation and rescue timeline.
...
- Primary: `tool_suite_id=ts-dam-failure-flood-ops-v1` with `protocol_stack_id=ps-civil-flood-response-stack-v1`.
