---
name: tactical-portable-nuclear-detection-and-attribution-cell
description: Support tactical employment of portable nuclear and radiological detection packages for rapid attribution and force protection decisions. Use when suspected radiological signatures appear in contested terrain.
---

# Tactical Portable Nuclear Detection And Attribution Cell
...
1. Frame the mission problem using these core inputs: detector hit telemetry, geospatial plume assumptions, ISR cueing status, and EOD or CBRN team availability.
...
Primary products for this skill: radiological confidence ladder, tactical cordon and maneuver guidance, attribution and escalation report.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: radiation sensor fusion suites, isotope analysis tools, tactical geospatial overlays.
...
## Domain Toolchain Override (2026-03-09, Portable Nuclear Detection Escalation)

- Prioritize tool_suite_id=ts-portable-nuclear-detection-attribution-v1 with protocol_stack_id=ps-portable-nuclear-detection-attribution-stack-v1 when detector hits indicate potential special nuclear material signatures.
- Use packet DPL-PORTABLE-NUCLEAR-DETECTION-ATTRIBUTION-001 to bind sampling custody, attribution confidence, and force-protection decision gates.
- If sample-chain integrity or isotope confidence falls below threshold, downgrade to advisory-only maneuver constraints and require explicit command approval before attribution release.
