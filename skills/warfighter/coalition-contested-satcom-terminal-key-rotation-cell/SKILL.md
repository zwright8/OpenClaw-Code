---
name: coalition-contested-satcom-terminal-key-rotation-cell
description: Support coalition warfighter SATCOM terminal key-rotation and continuity planning in contested EM and cyber conditions. Use when key compromise risk threatens mission traffic assurance.
---
...
Primary products for this skill: key-rotation priority ledger, terminal continuity branch matrix, coalition releasability gate report.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-satcom-terminal-key-rotation-v1` with `protocol_stack_id=ps-satcom-terminal-key-rotation-stack-v1`.
- Alternate: `tool_suite_id=ts-orbital-spectrum-continuity-v1` with `protocol_stack_id=ps-space-ground-failover-stack-v1`.
...
- Default packet IDs: DPL-SATCOM-KEYROT-001, DPL-GS-FAILOVER-001.
