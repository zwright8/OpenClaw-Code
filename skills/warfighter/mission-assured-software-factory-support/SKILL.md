---
name: mission-assured-software-factory-support
description: Support U.S. warfighter planning and decision support for Mission Assured Software Factory Support. Use when missions require mission software release assurance, security, and rollback readiness, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: release readiness board, accreditation gap register, rollback/failover execution plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: CI/CD pipelines, SBOM generators, artifact repositories, automated test and scan systems.
...
- Prefer these protocol families for this skill: SPDX/CycloneDX, REST APIs, signed artifact metadata.
