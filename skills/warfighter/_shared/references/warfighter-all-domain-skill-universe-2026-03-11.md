...
- Added a 12-skill expansion wave focused on tactical legal-attribution synthesis, coalition depot sabotage wargaming, mission-AI confidence early warning, sovereign cloud-to-edge compute migration governance, launch microcontroller counterfeit interdiction, maritime minefield humanitarian corridor integrity, homeland dam/levee engineer surge prioritization, command-voice spoof defense, dynamic no-strike geofence integrity, austere pediatric casualty surge balancing, satellite ephemeris spoofing/timing confidence, and strategic economic-coercion logistics early warning.
...
- Planned Wave XLII improvement targets for core warfighter skills include mission-risk, coalition interoperability, contested logistics, Role 3 medical movement, theater mission network failover, joint targeting/CDE governance, strategic mobility, and contested space assurance.
