---
name: contested-pow-camp-outbreak-riot-containment-cell
description: Coordinate outbreak control and riot containment in detainee facilities while preserving custody, legal, and force-protection requirements.
---
...
Primary products for this skill: detainee outbreak containment board, riot-response branch matrix, custody integrity and notification tracker.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-pow-camp-outbreak-riot-containment-v1` with `protocol_stack_id=ps-pow-camp-outbreak-riot-containment-stack-v1`.
...
- Default packet IDs: DPL-POW-CAMP-OUTBREAK-RIOT-CONTAINMENT-001.
