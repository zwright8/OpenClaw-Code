---
name: coalition-contested-civil-rail-evacuation-and-military-priority-merge-cell
description: Merge coalition civil rail evacuation and military movement priorities under contested throughput, sabotage, and life-safety constraints.
---
...
Primary products: rail priority merge schedule, station conflict resolution log, and movement continuity branch.

## Domain Toolchain Defaults

- Primary: tool_suite_id=ts-civil-rail-evac-priority-merge-v1 with protocol_stack_id=ps-civil-rail-evac-priority-merge-stack-v1.
...
- Default packet IDs: DPL-CIVIL-RAIL-EVAC-PRIORITY-MERGE-001.
