---
name: homeland-defense-satellite-ground-cloud-cutover-cell
description: Synchronize SATCOM ground-segment and cloud cutovers to preserve command continuity under disruption. Use when cyber, kinetic, or infrastructure failures threaten mission service availability.
---
...
Primary products for this skill: cutover continuity order, degraded-service matrix, reconstitution timeline.

## Domain Tool Stack

Use these tool categories as the baseline stack: SATCOM ground monitors, cloud failover orchestrators, service dependency mappers.

## Protocol Profile

Preferred protocol families for this skill: USMTF, API/JSON failover events, signed continuity manifests.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-sat-ground-cloud-cutover-defense-v1` with `protocol_stack_id=ps-sat-ground-cloud-cutover-defense-stack-v1`.
...
- Default packet IDs: DPL-SAT-GROUND-CLOUD-CUTOVER-DEFENSE-001, DPL-MULTI-DOMAIN-BATTLE-RHYTHM-FRAGMENT-RECOVERY-001.
