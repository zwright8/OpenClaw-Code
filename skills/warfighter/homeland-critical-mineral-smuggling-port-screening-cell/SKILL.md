---
name: homeland-critical-mineral-smuggling-port-screening-cell
description: Coordinate homeland interdiction of critical mineral smuggling with port screening and legal handoff controls. Use when contested supply pressure drives strategic mineral diversion risk.
---

# Homeland Critical Mineral Smuggling Interdiction and Port Screening Cell
...
Primary products for this skill: smuggling interdiction matrix, port screening prioritization board, legal handoff evidence packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: maritime cargo anomaly detection, customs screening orchestration, sanctions-risk linkage analytics, evidence-chain governance tools.
...
- Add `tool_suite_id=ts-critical-mineral-smuggling-port-screening-v1` + `protocol_stack_id=ps-critical-mineral-smuggling-port-screening-stack-v1` when producing critical recommendations for this mission domain.
