---
name: homeland-continuity-of-government-support-cell
description: Support continuity-of-government mission planning under national disruption. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: COG directives, mission-essential functions, infrastructure status, succession/relocation constraints.
...
Primary products for this skill: continuity support plan, mission-essential function prioritization, relocation decision triggers.
