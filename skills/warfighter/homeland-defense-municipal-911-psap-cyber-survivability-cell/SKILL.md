---
name: homeland-defense-municipal-911-psap-cyber-survivability-cell
description: Support U.S. warfighter planning and decision support for municipal 911/PSAP cyber survivability, call-routing integrity, and military-civil emergency continuity. Use when missions require integrated options, tool-protocol bindings, and authority-gated staff outputs.
---

# Homeland Defense Municipal 911 PSAP Cyber Survivability Cell
...
Primary products for this skill: PSAP survivability map, call-routing integrity ladder, emergency continuity coordination packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: PSAP queue integrity monitors, emergency call-routing failover planners, municipal cyber incident fusion boards.
...
- Prefer these protocol families for this skill: NIMS/ICS, NIEM, USMTF, API/JSON.
...
- Primary: tool_suite_id=ts-homeland-defense-municipal-911-psap-cyber-survivability-cell-v1 with protocol_stack_id=ps-homeland-defense-municipal-911-psap-cyber-survivability-cell-stack-v1.
- Alternate: tool_suite_id=ts-homeland-defense-telecom-911-priority-restoration-cell-v1 with protocol_stack_id=ps-homeland-defense-telecom-911-priority-restoration-cell-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-MUNICIPAL-911-PSAP-CYBER-001, DPL-MUNICIPAL-911-PSAP-CYBER-002.
