---
name: contested-austere-water-production-distribution-assurance-cell
description: Plan austere water production, quality assurance, and contested distribution to maneuver forces. Use when water infrastructure is degraded or adversary actions threaten sustainment.
---
...
Primary products for this skill: water production continuity plan, quality-assurance exception board, distribution priority matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-water-infrastructure-protection-v1` with `protocol_stack_id=ps-water-infrastructure-protection-stack-v1`.
- Alternate: `tool_suite_id=ts-logistics-distribution-v1` with `protocol_stack_id=ps-contested-logistics-sustainment-stack-v1`.
