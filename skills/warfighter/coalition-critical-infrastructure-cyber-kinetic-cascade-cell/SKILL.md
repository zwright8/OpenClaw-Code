...
Use these tool categories by default: coalition ICS telemetry fusion, cyber-physical cascade predictors, restoration-priority synchronization boards.

## Protocol Profile

Preferred protocol families for this skill: NIMS/ICS, USMTF, STIX/TAXII, NIEM, OGC, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-COALITION-CYBER-KINETIC-CASCADE-001 for critical recommendations.
