---
name: strategic-allied-supply-reallocation-negotiation-cell
description: Support strategic allied supply reallocation negotiations under scarcity. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: allied stock levels, demand signals, treaty constraints, transport feasibility.
...
Primary products for this skill: reallocation options brief, negotiation support matrix, alliance risk assessment.
