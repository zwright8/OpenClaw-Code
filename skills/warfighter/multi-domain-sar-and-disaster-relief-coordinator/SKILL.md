---
name: multi-domain-sar-and-disaster-relief-coordinator
description: Coordinate search-and-rescue and disaster relief operations across military, civil, and partner responders. Use when large-scale emergencies require synchronized cross-domain rescue and sustainment actions.
---
...
1. Frame the mission problem using these core inputs: incident reports, survivor location cues, air/ground/maritime asset status, medical surge capacity.
...
Primary products for this skill: SAR tasking board, disaster relief prioritization matrix, interagency synchronization timeline.
...
- Prioritize these tools or tool families for this domain: SAR coordination platforms, geospatial incident systems, medical regulation tools, mobility planning systems.
- Specify outbound exchange format for recommendations and tasking: USMTF, CoT, OGC WMS/WFS/WMTS, API/JSON.
