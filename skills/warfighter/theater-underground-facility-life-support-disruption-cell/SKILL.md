...
1. Frame the mission problem using these core inputs: facility intelligence, mission objectives, legal constraints, effects assessment inputs.
...
Primary products for this skill: life-support node dependency map, disruption effects matrix, escalation risk brief.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: ISR fusion tools, infrastructure dependency analyzers, effects planning systems, legal review workflows.
...
- Prefer these protocol families for this skill: USMTF, API/JSON, OGC.
