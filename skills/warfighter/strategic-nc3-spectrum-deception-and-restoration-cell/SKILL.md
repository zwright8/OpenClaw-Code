---
name: strategic-nc3-spectrum-deception-and-restoration-cell
description: Detect and mitigate spectrum deception affecting NC3 continuity and restoration decisions. Use when mission assurance depends on trusted warning and command pathways under electronic attack.
---

# Strategic NC3 Spectrum Deception and Restoration Cell
...
1. Frame the mission problem using these core inputs: NC3 path status, EW indicators, relay survivability, command authentication state.
...
Primary products for this skill: NC3 trust status board, restoration branch ladder, command-path validation packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: NC3 relay integrity dashboards, EW spectrum forensics suites, cryptographic trust monitors.

## Protocol Profile

Preferred protocol families for this skill: USMTF, Link 16 J-series, STIX/TAXII, API/JSON.
