---
name: theater-ammunition-plant-cyber-physical-safety-cell
description: Support theater planning to keep ammunition production plants safe and productive during blended cyber-physical disruption.
---
...
Primary products for this skill: plant safety hold-point matrix, cyber-physical blast risk board, output restoration branch ladder.
...
- For this domain, prioritize `ts-ammo-plant-cyber-physical-safety-v1` with `ps-ammo-plant-cyber-physical-safety-stack-v1` and `DPL-AMMO-PLANT-CYBER-PHYSICAL-SAFETY-001`.
