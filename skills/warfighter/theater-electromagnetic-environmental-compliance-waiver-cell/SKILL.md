---
name: theater-electromagnetic-environmental-compliance-waiver-cell
description: Coordinate rapid environmental and spectrum compliance waivers for mission-critical emitters, radars, and directed-energy systems.
---

# Theater Electromagnetic Environmental Compliance Waiver Cell
...
Primary products for this skill: compliance waiver decision packet, mitigation controls matrix, post-mission remediation ledger.

## Domain Tool Stack

Use these tool categories as the baseline stack: spectrum management tools, environmental impact models, legal waiver workflow systems, base operations logs.

## Protocol Profile

Preferred protocol families for this skill: USMTF, NTIA spectrum formats, OGC standards, PKI-signed XML.
...
- Prioritize `tool_suite_id=ts-theater-electromagnetic-environmental-compliance-waiver-cell-v1` + `protocol_stack_id=ps-theater-electromagnetic-environmental-compliance-waiver-cell-stack-v1` when this mission set is the critical path for commander decision timelines.
- Add `packet_id=DPL-THEATER_ELECTROMAGNETIC_ENVIRONMENTAL_COMPLIANCE_WAIVER_CELL-001` for the primary course of action and `packet_id=DPL-THEATER_ELECTROMAGNETIC_ENVIRONMENTAL_COMPLIANCE_WAIVER_CELL-002` for degraded-mode fallback actions.
