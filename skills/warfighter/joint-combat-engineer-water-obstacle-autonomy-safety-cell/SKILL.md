---
name: joint-combat-engineer-water-obstacle-autonomy-safety-cell
description: Coordinate autonomous and crewed combat-engineer water obstacle breaching with safety, fratricide, and tempo controls.
---
...
Primary products: water-obstacle breach safety matrix, autonomy authority-state ledger, crossing tempo decision board, and risk branch packet.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-water-obstacle-autonomy-safety-v1` with `protocol_stack_id=ps-water-obstacle-autonomy-safety-stack-v1`.
...
- Default packet IDs: DPL-WATER-OBSTACLE-AUTONOMY-SAFETY-001, DPL-CROSSING-TEMPO-RISK-001.
