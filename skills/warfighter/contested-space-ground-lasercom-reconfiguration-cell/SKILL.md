---
name: contested-space-ground-lasercom-reconfiguration-cell
description: Reconfigure optical space-ground links under jamming, weather, and orbital conflict pressure. Use when SATCOM resilience depends on dynamic laser communications routing.
---
...
Primary products for this skill: lasercom re-route decision matrix, weather-jam risk timeline, orbital handover branch plan.

## Domain Tool Stack

Use these tool categories as the baseline stack: space link planners, atmospheric attenuation models, orbital conjunction monitors, optical ground terminal status boards.

## Protocol Profile

Preferred protocol families for this skill: CCSDS, API/JSON, OGC, Link 16 J-series gateway profiles.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-space-ground-lasercom-reconfiguration-v1` with `protocol_stack_id=ps-space-ground-lasercom-reconfiguration-stack-v1`.
- Alternate: `tool_suite_id=ts-space-satcom-v1` with `protocol_stack_id=ps-space-ground-failover-stack-v1`.
...
- Default packet IDs: DPL-SPACE-GROUND-LASERCOM-RECONFIG-001, DPL-SPACE-SATCOM-FAILOVER-001.
