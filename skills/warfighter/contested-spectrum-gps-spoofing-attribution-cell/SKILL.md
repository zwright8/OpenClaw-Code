---
name: contested-spectrum-gps-spoofing-attribution-cell
description: Fuse navigation anomalies and RF indicators to attribute GPS spoofing/jamming and recommend mitigation actions. Use when operations face PNT degradation or suspected spoofing.
---
...
1. Frame the mission problem using these core inputs: PNT error reports, RF direction-finding hits, platform logs, space weather and interference data.
...
Primary products for this skill: spoofing attribution assessment, mitigation tasking matrix, navigation confidence map.
