---
name: joint-contested-cislunar-space-domain-awareness-cell
description: Maintain contested cislunar awareness and relay continuity with maneuver-risk assessment and escalation-aware warning products.
---
...
Primary products for this skill: cislunar contact risk board, relay survivability branch chart, maneuver intent confidence table.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-cislunar-domain-awareness-v1` with `protocol_stack_id=ps-cislunar-domain-awareness-stack-v1`.
- Alternate: `tool_suite_id=ts-space-satcom-v1` with `protocol_stack_id=ps-space-intent-warning-stack-v1`.
...
- Default packet IDs: DPL-CISLUNAR-SDA-CONTESTED-001.
