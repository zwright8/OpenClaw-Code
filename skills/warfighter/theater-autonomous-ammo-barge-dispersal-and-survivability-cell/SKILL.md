---
name: theater-autonomous-ammo-barge-dispersal-and-survivability-cell
description: Support U.S. warfighter planning and decision support for Theater Autonomous Ammo Barge Dispersal and Survivability Cell. Use when missions require autonomous ammunition barge dispersal, survivability under strike risk, and dynamic resupply synchronization, integrated options, and protocol-aware staff outputs.
---

# Theater Autonomous Ammo Barge Dispersal and Survivability Cell
...
Primary products for this skill: ammo barge dispersal matrix, survivability branch ladder, resupply synchronization packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: autonomous littoral routing controllers, munitions custody and blast-risk estimators, maritime resupply orchestration boards.
...
- Prefer these protocol families for this skill: USMTF, AIS/NMEA, STIX/TAXII, API/JSON.
...
- Primary: tool_suite_id=ts-theater-autonomous-ammo-barge-dispersal-and-survivability-cell-v1 with protocol_stack_id=ps-theater-autonomous-ammo-barge-dispersal-and-survivability-cell-stack-v1.
- Alternate: tool_suite_id=ts-theater-offshore-prepositioning-ship-survivability-and-reload-cell-v1 with protocol_stack_id=ps-theater-offshore-prepositioning-ship-survivability-and-reload-cell-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-AMMO-BARGE-DISPERSAL-001, DPL-AMMO-BARGE-DISPERSAL-002.
