---
name: strategic-deepfake-diplomatic-hotline-authentication-cell
description: Support U.S. warfighter planning and decision support for Strategic Deepfake Diplomatic Hotline Authentication Cell. Use when missions require strategic hotline voice/message authentication, escalation prevention, and cross-government confirmation governance, integrated options, and protocol-aware staff outputs.
---

# Strategic Deepfake Diplomatic Hotline Authentication Cell
...
Primary products for this skill: hotline authenticity confidence board, escalation prevention branch map, diplomatic confirmation packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: synthetic voice spoof detectors, secure hotline attestation ledgers, cross-channel confirmation orchestrators.
...
- Prefer these protocol families for this skill: USMTF, STIX/TAXII, NIEM, API/JSON.
...
- Primary: tool_suite_id=ts-strategic-deepfake-diplomatic-hotline-authentication-cell-v1 with protocol_stack_id=ps-strategic-deepfake-diplomatic-hotline-authentication-cell-stack-v1.
- Alternate: tool_suite_id=ts-deepfake-orders-auth-countersign-v1 with protocol_stack_id=ps-deepfake-orders-auth-countersign-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-DEEPFAKE-HOTLINE-AUTH-001, DPL-DEEPFAKE-HOTLINE-AUTH-002.
