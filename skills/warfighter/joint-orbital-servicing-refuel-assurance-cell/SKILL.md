---
name: joint-orbital-servicing-refuel-assurance-cell
description: Support warfighter planning for contested on-orbit servicing and refuel assurance across cislunar and GEO operations.
---

# Joint Orbital Servicing Refuel Assurance Cell
...
Primary products for this skill: orbital servicing assurance brief, refuel timeline conflict matrix, and custody-verified servicing branch plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-orbital-servicing-refuel-assurance-v1` with `protocol_stack_id=ps-orbital-servicing-refuel-assurance-stack-v1`.
- Alternate: `tool_suite_id=ts-space-satcom-v1` with `protocol_stack_id=ps-space-weather-solar-storm-mission-assurance-stack-v1`.
...
- Default packet IDs: DPL-ORBITAL-SERVICING-REFUEL-001, DPL-ORBITAL-LOGISTICS-CONFLICT-001
