---
name: joint-balloon-and-high-altitude-object-response-cell
description: Support U.S. warfighter planning and decision support for Joint Balloon and High-Altitude Object Response Cell. Use when missions require Joint Balloon and High-Altitude Object Response Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: high-altitude object track triage board, engagement-decision support matrix, debris recovery and attribution packet.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: air surveillance COP, NORAD warning feeds, debris pattern modeling tools.
- Prioritize these protocol families for this domain: Link 16 J-series, USMTF, API/JSON.
