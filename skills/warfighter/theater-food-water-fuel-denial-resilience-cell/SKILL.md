---
name: theater-food-water-fuel-denial-resilience-cell
description: Plan sustainment resilience when adversaries target food, water, and fuel chains. Use when theater-level sustainment continuity must be preserved under interdiction, contamination, or infrastructure disruption.
---
...
Primary products for this skill: denial resilience sustainment plan, critical-node triage matrix, sustainment branch trigger board.
...
- Prioritize `tool_suite_id=ts-theater-food-water-fuel-denial-v1` + `protocol_stack_id=ps-theater-food-water-fuel-denial-stack-v1` for this mission set.
- Include `packet_id=DPL-THEATER-FOOD-WATER-FUEL-DENIAL-001` for high-consequence recommendations and branch decisions.
- Bind recommendations to `toolchain_profile_id=theater-food-water-fuel-denial-v1` in joint operations profile selection.
