---
name: joint-civilian-port-labor-disruption-contingency-cell
description: Develop contingency plans for military throughput when civilian port labor availability degrades. Use when strikes, coercion, or safety incidents threaten deployment and sustainment timelines.
---
...
1. Frame the mission problem with: port throughput data, labor status, cargo priority, alternate terminal availability.
...
Primary products for this skill: labor disruption contingency plan, cargo reprioritization matrix, diversion timeline.

## U.S. Warfighter Employment Notes

- Minimize strategic deployment delay by pre-coordinating legal authorities and alternate handling capacity.
...
- For this domain, prioritize ts-port-labor-disruption-contingency-v1 with ps-port-labor-disruption-contingency-stack-v1.
