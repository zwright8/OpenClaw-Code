---
name: joint-spaceport-propellant-sabotage-and-toxic-release-response-cell
description: Coordinate response to spaceport propellant sabotage and toxic release events while sustaining launch-critical mission assurance and force protection.
---
...
- Primary: `tool_suite_id=ts-joint-spaceport-propellant-toxic-response-v1` with `protocol_stack_id=ps-joint-spaceport-propellant-toxic-response-stack-v1`.
...
- Default packet IDs: `DPL-SPACEPORT-PROPELLANT-SABOTAGE-001`, `DPL-SPACEPORT-TOXIC-PLUME-RESPONSE-001`.
