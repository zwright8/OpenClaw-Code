---
name: joint-electronic-warfare-order-of-battle-drift-cell
description: Detect and respond to adversary EW order-of-battle drift that invalidates mission data and spectrum plans. Use when emitter behavior changes faster than update cycles.
---

# Joint Electronic Warfare Order Of Battle Drift Cell
...
- Use packet template DPL-EW-OB-DRIFT-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-ew-order-of-battle-drift-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-ew-order-of-battle-drift-v1 with protocol_stack_id=ps-ew-ob-drift-stack-v1.
...
- Default packet ID: DPL-EW-OB-DRIFT-001.
