---
name: coalition-host-nation-fiber-cut-and-backhaul-restoration-cell
description: Synchronize coalition-host-nation backhaul restoration after fiber cuts or sabotage. Use when C2 continuity depends on telecom corridor repair and releasability-safe routing.
---
...
Primary products for this skill: fiber restoration branch map, coalition backhaul priority board, and releasability-safe transport plan.
...
- Bind recommendations to tool_suite_id=ts-coalition-host-nation-fiber-cut-and-backhaul-restoration-cell-v1 and protocol_stack_id=ps-coalition-host-nation-fiber-cut-and-backhaul-restoration-cell-stack-v1.
- Use packet templates in ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-COALITION-FIBER-BACKHAUL-RESTORE-001 for critical recommendations.
