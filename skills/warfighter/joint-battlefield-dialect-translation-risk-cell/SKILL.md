---
name: joint-battlefield-dialect-translation-risk-cell
description: Support joint planning for language and dialect ambiguity risk management in partnered operations and civilian-protection missions.
---
...
Primary products for this skill: dialect confidence heatmap, interpreter task-priority board, mistranslation risk mitigation ladder.
...
- For this domain, prioritize `ts-battlefield-dialect-translation-risk-v1` with `ps-battlefield-dialect-translation-risk-stack-v1` and `DPL-BATTLEFIELD-DIALECT-TRANSLATION-RISK-001`.
