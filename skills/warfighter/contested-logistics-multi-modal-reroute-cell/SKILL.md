---
name: contested-logistics-multi-modal-reroute-cell
description: Plan resilient convoy, airlift, rail, and sealift rerouting under disruption, cyber outage, and infrastructure damage.
---

# Contested Logistics Multi-Modal Reroute Cell
...
Primary products for this skill: reroute COA matrix, lift allocation board, logistics risk heatmap.
...
- Suggested tools: USTRANSCOM planning feeds, GCCS-J logistics COP, AIS/ADS-B, NOAA weather, host-nation route status APIs.
- Protocol/message standards: USMTF, OGC API Features, STANAG APP-11, NTCIP.
