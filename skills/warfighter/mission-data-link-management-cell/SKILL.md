---
name: mission-data-link-management-cell
description: Coordinate tactical data link planning and network management for joint operations. Use when ensuring interoperable data exchange across platforms and echelons.
---

# Mission Data Link Management Cell
...
1. Frame the mission problem using these core inputs: link architecture, platform participation, crypto windows, bandwidth constraints.
...
Primary products for this skill: data link execution plan, network load management matrix, interoperability issue log.
