---
name: joint-undersea-cable-landing-station-island-power-defense-cell
description: Defend cable landing stations and associated islanded power systems against cyber-physical disruption. Use when undersea communications continuity depends on resilient shore infrastructure.
---
...
Primary products for this skill: landing-station hardening board, island-power continuity plan, tamper-response decision ladder

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-cable-landing-island-power-defense-v1 and protocol_stack_id=ps-cable-landing-island-power-defense-stack-v1.
- Primary tools for this domain: subsea cable telemetry monitors, microgrid control boards, OT/ICS anomaly detection systems
- Required exchange protocols/formats for this domain: USMTF, NIMS/ICS, OGC WMS/WFS/WMTS, API/JSON
