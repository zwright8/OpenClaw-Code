---
name: counter-space-electronic-attack-response-cell
description: Coordinate response actions to counter-space electronic attack against SATCOM and space-enabled services. Use when triaging interference, restoring services, and synchronizing protection measures.
---
...
Primary products for this skill: Counter-space EA incident board, SATCOM restoration priority matrix, service continuity branch plan.
