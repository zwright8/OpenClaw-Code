---
name: coalition-contested-port-cyber-customs-fraud-fusion-cell
description: Coordinate coalition port defense by fusing cyber incidents, customs-fraud signals, and throughput impacts during contested operations. Use when warfighters need port continuity decisions under simultaneous cyber and commercial manipulation threats.
---
...
Primary products: port continuity triage board, fraud-attribution brief, customs risk control matrix.
...
- Primary: `tool_suite_id=ts-contested-port-cyber-fraud-fusion-v1 with protocol_stack_id=ps-contested-port-cyber-fraud-fusion-stack-v1`.
- Alternate: `tool_suite_id=ts-cyber-defense-v1 with protocol_stack_id=ps-homeland-port-cyber-physical-defense-coordination-stack-v1`.
...
- Default packet IDs: DPL-PORT-SAFETY-001, DPL-CYBER-ICAM-001, DPL-COALITION-CUSTODY-001.
