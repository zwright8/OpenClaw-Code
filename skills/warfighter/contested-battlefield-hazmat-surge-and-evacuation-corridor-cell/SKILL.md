---
name: contested-battlefield-hazmat-surge-and-evacuation-corridor-cell
description: Contain hazardous-material surges after strike damage and keep evacuation corridors viable for military and civilian movement.
---
...
Primary products for this skill: hazmat surge containment matrix, evacuation corridor viability board, decontamination and reroute timeline.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-battlefield-hazmat-control-v1` with `protocol_stack_id=ps-battlefield-hazmat-control-stack-v1`.
...
- Default packet IDs: DPL-BATTLEFIELD-HAZMAT-CONTROL-001.
