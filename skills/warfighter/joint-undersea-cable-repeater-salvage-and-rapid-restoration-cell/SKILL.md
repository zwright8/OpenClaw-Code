---
name: joint-undersea-cable-repeater-salvage-and-rapid-restoration-cell
description: Coordinate undersea cable repeater salvage and rapid restoration under contested maritime conditions while protecting command-network continuity.
---
...
Primary products: repeater salvage priority ledger, repair-window risk map, command continuity restoration packet.
...
- Primary: `tool_suite_id=ts-joint-undersea-cable-repeater-salvage-rapid-restoration-v1` with `protocol_stack_id=ps-joint-undersea-cable-repeater-salvage-rapid-restoration-stack-v1`.
...
- Default packet IDs: `DPL-JOINT-UNDERSEA-CABLE-REPEATER-SALVAGE-RESTORATION-001`.
