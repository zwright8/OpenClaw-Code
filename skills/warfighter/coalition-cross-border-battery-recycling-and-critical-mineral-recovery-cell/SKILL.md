...
description: Support U.S. warfighter planning and decision support for coalition battery recycling, critical mineral recovery, and defense-industrial sustainment under contested logistics. Use when missions require integrated options, tool-protocol bindings, and authority-gated staff outputs.
---
...
Primary products for this skill: battery recovery throughput matrix, mineral yield branch ladder, coalition sustainment packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: battery lifecycle forensics tools, critical-mineral recovery optimizers, coalition recycling throughput boards.
...
- Prefer these protocol families for this skill: NATO APP-11/ADatP-3 aligned, USMTF, OGC, API/JSON.
...
- Alternate: tool_suite_id=ts-critical-mineral-refinery-defense-restart-v1 with protocol_stack_id=ps-critical-mineral-refinery-defense-restart-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-BATTERY-RECYCLING-MINERAL-RECOVERY-001, DPL-BATTERY-RECYCLING-MINERAL-RECOVERY-002.
