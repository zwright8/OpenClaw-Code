---
name: theater-orbital-debris-reentry-base-hardening-cell
description: Plan force-protection hardening and mission continuity actions for orbital debris reentry hazard windows.
---
...
Primary products for this skill: reentry hazard hardening timeline, shelter and sortie protection matrix, base continuity branch chart.
...
- Alternate: `tool_suite_id=ts-space-satcom-v1` with `protocol_stack_id=ps-space-satcom-stack-v1`.
...
- Default packet IDs: DPL-ORBITAL-DEBRIS-REENTRY-BASE-HARDENING-001.
