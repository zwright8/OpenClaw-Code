---
name: expeditionary-ai-enabled-prisoner-processing-and-evidence-integrity-cell
description: Support lawful prisoner processing with AI-assisted evidence integrity controls in expeditionary settings. Use when detention operations require chain-of-custody assurance under disruption.
---

# Expeditionary AI-Enabled Prisoner Processing and Evidence Integrity Cell
...
1. Frame the mission problem using these core inputs: detainee intake records, biometric confidence, evidence custody state, legal/releasability constraints.
...
Primary products for this skill: intake compliance matrix, evidence integrity ledger, legal-risk branch packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: custody workflow systems, biometric adjudication tools, legal observability ledgers.

## Protocol Profile

Preferred protocol families for this skill: NIEM, USMTF, HL7/FHIR, API/JSON.
