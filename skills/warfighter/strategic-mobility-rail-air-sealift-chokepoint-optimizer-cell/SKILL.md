---
name: strategic-mobility-rail-air-sealift-chokepoint-optimizer-cell
description: Support strategic mobility staff with multimodal rail-air-sealift flow optimization, chokepoint risk mitigation, and contested reroute planning.
---

# Strategic Mobility Rail Air Sealift Chokepoint Optimizer Cell
...
Use these tool categories by default: mobility flow optimizers, chokepoint disruption predictors, multimodal route deconfliction planners.

## Protocol Profile

Preferred protocol families for this skill: USMTF, NATO APP-11/ADatP-3 aligned, AIS/NMEA, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-STRAT-MOBILITY-CHOKEPOINT-001 for critical recommendations.
