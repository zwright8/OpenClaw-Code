---
name: strategic-defense-industrial-additive-feedstock-counterfeit-eradication-cell
description: Support U.S. warfighter planning for Strategic Defense-Industrial Additive Feedstock Counterfeit Eradication Cell.
---
...
Use these tool categories by default: additive feedstock provenance ledgers, counterfeit anomaly scanners, and industrial release assurance workflows.

## Protocol Profile

Preferred protocol families for this skill: USMTF, STIX/TAXII, NIEM, signed custody exports, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-STRATEGIC-DEFENSE-INDUSTRIAL-ADDITIVE-FEEDSTOCK-COUNTERFEIT-ERADICATION-001 for critical recommendations.
