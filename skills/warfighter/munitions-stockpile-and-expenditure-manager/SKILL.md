---
name: munitions-stockpile-and-expenditure-manager
description: Support U.S. warfighter planning and decision support for Munitions Stockpile And Expenditure Manager. Use when missions require munitions forecasting, allocation, and risk-based redistribution, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: munitions expenditure forecast, critical shortfall watchlist, theater redistribution plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: enterprise logistics systems, ammunition depot inventory tools, transportation management systems, maintenance readiness feeds.
...
- Prefer these protocol families for this skill: USMTF, XML/JSON schema exchange, API gateways.
