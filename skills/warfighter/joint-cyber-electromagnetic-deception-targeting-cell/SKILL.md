---
name: joint-cyber-electromagnetic-deception-targeting-cell
description: Coordinate cyber and electromagnetic deception actions that shape adversary sensing and targeting loops.
---
...
Primary products for this skill: deception effects sequence, adversary-sensor miscue matrix, cross-domain timing order.

## Tool Suite and Protocol Binding

- Bind tool selection to `ts-cyber-em-deception-targeting-v1` and `ps-cyber-em-deception-targeting-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Recommended external tools for this domain: EW planning suites, cyber mission planning tools, SIGINT trend feeds, and fires deconfliction boards.
- Required protocol families for implementation: STIX/TAXII, VMF, Link 16 J-series, and MISP API.
