---
name: joint-denied-navigation-inland-waterway-pilotage-cell
description: Support U.S. warfighter planning and decision support for denied-navigation inland waterway pilotage, convoy movement safety, and alternate PNT governance.
---
...
Primary products for this skill: inland pilotage route book, denied-PNT transit risk matrix, convoy timing and control order.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: riverine navigation planners, bathymetric map services, alternate timing-reference tools, convoy movement control systems.
