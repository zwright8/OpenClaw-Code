---
name: theater-ar-vr-mission-rehearsal-fidelity-assurance-cell
description: Assure AR/VR rehearsal systems accurately mirror operational terrain, threat behavior, and command timelines before execution.
---

# Theater AR/VR Mission Rehearsal Fidelity Assurance Cell
...
Primary products for this skill: rehearsal fidelity scorecard, scenario drift correction plan, commander rehearsal certification packet.

## Domain Tool Stack

Use these tool categories as the baseline stack: synthetic training systems, terrain data services, after-action telemetry collectors, simulation orchestration platforms.

## Protocol Profile

Preferred protocol families for this skill: DIS/HLA, OGC 3D tiles, Protobuf, USMTF rehearsal extracts.
...
- Prioritize `tool_suite_id=ts-theater-ar-vr-mission-rehearsal-fidelity-assurance-cell-v1` + `protocol_stack_id=ps-theater-ar-vr-mission-rehearsal-fidelity-assurance-cell-stack-v1` when this mission set is the critical path for commander decision timelines.
- Add `packet_id=DPL-THEATER_AR_VR_MISSION_REHEARSAL_FIDELITY_ASSURANCE_CELL-001` for the primary course of action and `packet_id=DPL-THEATER_AR_VR_MISSION_REHEARSAL_FIDELITY_ASSURANCE_CELL-002` for degraded-mode fallback actions.
