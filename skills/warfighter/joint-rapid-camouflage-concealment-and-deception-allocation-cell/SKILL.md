---
name: joint-rapid-camouflage-concealment-and-deception-allocation-cell
description: Allocate deception, decoy, and concealment assets rapidly to preserve survivability of high-value formations and enablers.
---
...
Primary products: CCD allocation board, decoy effectiveness confidence map, survivability branch options.
...
- Primary: `tool_suite_id=ts-joint-rapid-camouflage-concealment-deception-allocation-v1` with `protocol_stack_id=ps-joint-rapid-camouflage-concealment-deception-allocation-stack-v1`.
- Alternate: `tool_suite_id=ts-disinformation-counter-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Default packet IDs: `DPL-JOINT-RAPID-CCD-ALLOCATION-001`, `DPL-JOINT-RAPID-CCD-ALLOCATION-002`.
