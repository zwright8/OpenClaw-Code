---
name: coalition-autonomous-maritime-traffic-separation-and-liability-cell
description: Coordinate autonomous maritime traffic separation and legal liability controls in coalition chokepoints. Use when crewed and uncrewed vessels must be deconflicted while preserving legal defensibility after incidents.
---
...
Primary products for this skill: autonomous traffic separation plan, collision and liability evidence packet, coalition maritime rules-of-road adjudication matrix.
...
- Prioritize tool_suite_id=ts-autonomous-maritime-traffic-liability-v1 + protocol_stack_id=ps-autonomous-maritime-traffic-liability-stack-v1 when coalition maritime lanes include mixed autonomous and crewed traffic under contested conditions.
- Add packet_id=DPL-AUTONOMOUS-MARITIME-TRAFFIC-LIABILITY-001 for recommendation branches that alter lane assignments, autonomy constraints, or legal notification timelines.
