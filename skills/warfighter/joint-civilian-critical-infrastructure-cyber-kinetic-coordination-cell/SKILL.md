---
name: joint-civilian-critical-infrastructure-cyber-kinetic-coordination-cell
description: Coordinate military and civilian cyber-kinetic actions that protect power, water, telecom, and transportation critical infrastructure during conflict. Use when commanders need synchronized restoration and defense options that minimize civilian harm and mission disruption.
---
...
1. Frame the mission problem using these core inputs: critical node status, cyber incident telemetry, kinetic threat posture, restoration resource availability, civil authority constraints.
...
Primary products for this skill: critical infrastructure defense-restoration synchronization board, cyber-kinetic dependency matrix, priority-of-life restoration decision package.
