---
name: coalition-contested-polar-medical-evac-staging-cell
description: Plan coalition casualty staging and evacuation in contested polar conditions with severe weather and access limits. Use when medical evacuation windows are narrow and high-risk.
---
...
Primary products for this skill: polar medevac staging plan, weather-window triage board, coalition casualty transfer matrix

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-contested-polar-medevac-staging-v1 and protocol_stack_id=ps-contested-polar-medevac-staging-stack-v1.
- Primary tools for this domain: polar weather route planners, patient regulation brokers, coalition air/sea lift scheduling tools
- Required exchange protocols/formats for this domain: USMTF, HL7/FHIR, VMF, OGC WMS/WFS/WMTS, API/JSON
