---
name: theater-grid-feeder-priority-shedding-and-mission-load-restoration-cell
description: Synchronize feeder shedding and rapid mission-load restoration for military and dual-use infrastructure under grid stress.
---
...
Primary products for this skill: mission-load feeder priority matrix, controlled shedding schedule, restoration trigger and branch plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-grid-feeder-priority-shed-v1` with `protocol_stack_id=ps-grid-feeder-priority-shed-stack-v1`.
...
- Default packet IDs: DPL-GRID-FEEDER-PRIORITY-SHED-001.
