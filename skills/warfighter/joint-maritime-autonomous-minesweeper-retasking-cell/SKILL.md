---
name: joint-maritime-autonomous-minesweeper-retasking-cell
description: Support warfighter planning for autonomous maritime mine-countermeasure retasking under contested ISR and comms disruption.
---
...
- Primary: `tool_suite_id=ts-autonomous-minesweeper-retask-v1` with `protocol_stack_id=ps-autonomous-minesweeper-retask-stack-v1`.
- Alternate: `tool_suite_id=ts-littoral-mcm-priority-lane-v1` with `protocol_stack_id=ps-littoral-mcm-priority-lane-stack-v1`.
...
- Default packet IDs: DPL-AUTONOMOUS-MINESWEEPER-RETASK-001, DPL-LITTORAL-MCM-PRIORITY-LANE-001.
