---
name: joint-energy-infrastructure-physical-cyber-convergence-cell
description: Synchronize defense of energy infrastructure against blended physical and cyber attacks across military and civil grids. Use when adversaries target generation, substations, fuel storage, and control networks together.
---
...
1. Frame the mission problem using these core inputs: grid telemetry, OT cybersecurity alerts, physical security incident logs, fuel stock status, and priority load requirements.
...
Primary products for this skill: blended attack impact assessment, physical-cyber defense synchronization order, restoration branch matrix.
...
- Primary: `tool_suite_id=ts-energy-physical-cyber-convergence-v1` with `protocol_stack_id=ps-critical-infrastructure-triage-stack-v1`.
