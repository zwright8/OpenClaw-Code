---
name: theater-adversarial-ai-model-poisoning-detection-cell
description: Detect and contain adversarial data/model poisoning against mission AI services. Use when mission planning, targeting support, or logistics optimizers show anomalous AI behavior.
---
...
Primary products for this skill: AI poisoning threat estimate, model trust recovery plan, mission-AI containment decision matrix.

## Domain Tool Stack

Use these tool categories as the baseline stack: model lineage trackers, feature-drift analytics, dataset provenance ledgers, security orchestration services.

## Protocol Profile

Preferred protocol families for this skill: ML metadata schemas, STIX/TAXII, API/JSON, signed model artifact profiles.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-adversarial-ai-model-poisoning-detection-v1` with `protocol_stack_id=ps-adversarial-ai-model-poisoning-detection-stack-v1`.
- Alternate: `tool_suite_id=ts-contested-ai-model-governance-and-mission-assurance-v1` with `protocol_stack_id=ps-contested-ai-model-governance-and-mission-assurance-stack-v1`.
...
- Default packet IDs: DPL-ADVERSARIAL-AI-MODEL-POISONING-DETECTION-001, DPL-CONTESTED-AI-MODEL-GOVERNANCE-001.
