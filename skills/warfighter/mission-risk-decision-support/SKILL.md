...
- Add `toolchain_id=TC-FAMCARE-301`, `tool_suite_id=ts-joint-family-care-guardianship-dependent-support-v1`, and `protocol_stack_id=ps-joint-family-care-guardianship-dependent-support-stack-v1` when commander risk posture depends on family-care-plan integrity, guardian viability, or dependent-support confirmation before deployment, mobilization, or extended response.
- Add `toolchain_id=TC-SPOUSELIC-302`, `tool_suite_id=ts-joint-military-spouse-license-portability-employment-continuity-v1`, and `protocol_stack_id=ps-joint-military-spouse-license-portability-employment-continuity-stack-v1` when retention or readiness risk depends on spouse license portability, employer continuity, or household income stability.
- Add `toolchain_id=TC-SCRA-303`, `tool_suite_id=ts-joint-servicemember-civil-relief-estate-poa-v1`, and `protocol_stack_id=ps-joint-servicemember-civil-relief-estate-poa-stack-v1` when risk framing depends on civil-relief timing, estate-document validity, or emergency POA continuity.
- Add `toolchain_id=TC-HHGKIT-304`, `tool_suite_id=ts-joint-household-goods-loss-claims-essential-kit-v1`, and `protocol_stack_id=ps-joint-household-goods-loss-claims-essential-kit-stack-v1` when household-goods disruption, essential-item shortages, or claims delays materially affect reporting confidence, recovery tempo, or retention.
- Add `packet_id=DPL-FAMILY-CARE-GUARDIANSHIP-001`, `packet_id=DPL-SPOUSE-LICENSE-EMPLOYMENT-001`, `packet_id=DPL-SCRA-ESTATE-POA-001`, and `packet_id=DPL-HOUSEHOLD-GOODS-ESSENTIAL-KIT-001` for branches that materially alter commander GO, NO-GO, or GO-WITH-CONSTRAINTS posture across household-stability and legal-readiness decisions.
