...
- Add `toolchain_id=TC-LEGALRELIEF-266`, `tool_suite_id=ts-joint-servicemember-civil-relief-estate-poa-v1`, and `protocol_stack_id=ps-joint-servicemember-civil-relief-estate-poa-stack-v1` when commander risk posture depends on protecting deployed servicemembers from legal default, expired powers of attorney, or unresolved estate fragility.
- Add `toolchain_id=TC-SANITATION-267`, `tool_suite_id=ts-joint-field-sanitation-latrine-vector-discipline-v1`, and `protocol_stack_id=ps-joint-field-sanitation-latrine-vector-discipline-stack-v1` when force-readiness confidence depends on sanitation discipline, vector pressure, or illness-prevention compliance at dense expeditionary sites.
- Add `toolchain_id=TC-NONLETHAL-268`, `tool_suite_id=ts-joint-nonlethal-crowd-control-evidence-v1`, and `protocol_stack_id=ps-joint-nonlethal-crowd-control-evidence-stack-v1` when risk acceptance depends on controlled escalation, evidence sufficiency, or public-legitimacy exposure during disturbances.
- Add `toolchain_id=TC-RECORDS-269`, `tool_suite_id=ts-joint-personnel-records-dd214-benefits-continuity-v1`, and `protocol_stack_id=ps-joint-personnel-records-dd214-benefits-continuity-stack-v1` when commander confidence depends on personnel-record integrity, discharge timing, or benefits continuity during mobilization or casualty surges.
- Add `toolchain_id=TC-FAMILYCARE-273`, `tool_suite_id=ts-joint-family-care-guardianship-dependent-support-v1`, and `protocol_stack_id=ps-joint-family-care-guardianship-dependent-support-stack-v1` when readiness assumptions depend on guardian viability, dependent care continuity, or family-plan execution.
- Add `packet_id=DPL-SCRA-ESTATE-POA-001`, `packet_id=DPL-FIELD-SANITATION-LATRINE-001`, `packet_id=DPL-NONLETHAL-CROWD-EOF-001`, `packet_id=DPL-PERSONNEL-RECORDS-DD214-001`, and `packet_id=DPL-FAMILY-CARE-GUARDIANSHIP-001` for branches that materially alter commander GO, NO-GO, or GO-WITH-CONSTRAINTS posture.

## Domain Toolchain Override (2026-04-06, Expansion Wave LXXIII Addendum)

- Add `toolchain_id=TC-SPOUSELIC-282`, `tool_suite_id=ts-joint-military-spouse-license-portability-employment-continuity-v1`, and `protocol_stack_id=ps-joint-military-spouse-license-portability-employment-continuity-stack-v1` when readiness risk depends on spouse-income collapse, license portability delay, or retention-sensitive household instability.
- Add `toolchain_id=TC-REENTRY-285`, `tool_suite_id=ts-joint-installation-access-badge-curfew-reentry-v1`, and `protocol_stack_id=ps-joint-installation-access-badge-curfew-reentry-stack-v1` when commander risk posture depends on safe family reentry, access-control restoration, or curfew legitimacy after installation disruption.
- Add `toolchain_id=TC-BPHARM-286`, `tool_suite_id=ts-joint-base-pharmacy-refill-tricare-coldchain-v1`, and `protocol_stack_id=ps-joint-base-pharmacy-refill-tricare-coldchain-stack-v1` when risk acceptance depends on medication continuity, refill override confidence, or cold-chain integrity for warfighter families and recovering casualties.
- Add `toolchain_id=TC-HOMEMOD-289`, `tool_suite_id=ts-joint-wounded-warrior-home-modification-caregiver-ramp-v1`, and `protocol_stack_id=ps-joint-wounded-warrior-home-modification-caregiver-ramp-stack-v1` when recovery timelines, caregiver capacity, or discharge-to-home readiness materially alter commander GO or NO-GO posture.
- Add `packet_id=DPL-SPOUSE-LICENSE-EMPLOYMENT-001`, `packet_id=DPL-ACCESS-BADGE-CURFEW-REENTRY-001`, `packet_id=DPL-BASE-PHARMACY-TRICARE-COLDCHAIN-001`, and `packet_id=DPL-WOUNDED-WARRIOR-HOME-CAREGIVER-001` for branches that materially change commander GO, NO-GO, or GO-WITH-CONSTRAINTS decisions.
