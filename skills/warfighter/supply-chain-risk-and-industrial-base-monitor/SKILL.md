---
name: supply-chain-risk-and-industrial-base-monitor
description: Assess supply chain and defense industrial base risks that affect operational readiness. Use when tracking bottlenecks, vendor fragility, and component shortfalls.
---

# Supply Chain Risk and Industrial Base Monitor
...
1. Frame the mission problem using these core inputs: critical components list, supplier status, lead times, demand forecasts.
...
Primary products for this skill: industrial base risk dashboard, critical shortage forecast, mitigation action plan.
