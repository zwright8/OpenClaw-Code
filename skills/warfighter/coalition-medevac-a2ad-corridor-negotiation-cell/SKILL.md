---
name: coalition-medevac-a2ad-corridor-negotiation-cell
description: Coordinate coalition casualty evacuation corridor negotiation and medical movement deconfliction in anti-access and area-denial environments.
---
...
Primary products for this skill: corridor access decision log, medevac route deconfliction matrix, casualty movement authority and legal-observability tracker.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: air corridor risk analyzers, coalition medevac regulator tools, legal and ROE observability boards, casualty load balancing planners.
...
- Prefer these protocol families for this skill: AIXM/FIXM, USMTF, HL7/FHIR, NATO APP-11/ADatP-3.
