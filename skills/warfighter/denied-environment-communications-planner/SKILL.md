---
name: denied-environment-communications-planner
description: Plan resilient communications architectures for degraded and denied environments. Use when balancing low probability of intercept communications, redundancy, and mission command needs.
---

# Denied Environment Communications Planner
...
1. Frame the mission problem using these core inputs: network topology, jamming threat, waveform options, command relationships.
...
Primary products for this skill: PACE communications plan, comms degradation playbook, network resilience checklist.
