---
name: joint-maritime-chokepoint-closure-and-reopening-cell
description: Support U.S. warfighter maritime chokepoint closure/reopening planning under contested conditions. Use when commanders must balance denial effects, coalition shipping, and restoration timelines.
---
...
Primary products for this skill: closure trigger ladder, reopening branch matrix, coalition shipping risk board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-maritime-chokepoint-closure-v1` with `protocol_stack_id=ps-maritime-chokepoint-closure-stack-v1`.
- Alternate: `tool_suite_id=ts-port-damage-sortie-reflow-v1` with `protocol_stack_id=ps-port-damage-reflow-stack-v1`.
...
- Default packet IDs: DPL-MARITIME-CHOKE-001, DPL-PORT-REPAIR-001.
...
- Enforce `ack_chain_status=verified` for all mission-critical tool exchanges before recommending closure or reopening posture changes.
