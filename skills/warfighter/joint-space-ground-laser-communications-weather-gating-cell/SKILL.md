---
name: joint-space-ground-laser-communications-weather-gating-cell
description: Plan optical comms windows and fallback paths across weather, obscurants, and orbital geometry constraints.
---
...
Primary products for this skill: laser-comm availability board, weather-gated comms branch plan, fallback transport trigger table.

## Tool Suite and Protocol Binding

- Bind tool selection to `ts-laser-comms-weather-gating-v1` and `ps-laser-comms-weather-gating-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Recommended external tools for this domain: space link planners, cloud and visibility model feeds, SATCOM link-health monitors, and terrestrial gateway telemetry.
- Required protocol families for implementation: CCSDS, SNMPv3, OGC API Coverages, and MIL-STD-188.
