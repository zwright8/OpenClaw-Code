---
name: tactical-ew-mission-data-rapid-reprogramming-cell
description: Support rapid EW mission-data reprogramming in response to new emitter behaviors and waveform threats.
---
...
Primary products for this skill: mission-data reprogram package, emitter-change impact assessment, fielding priority queue.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: EW mission data tools, threat emitter libraries, software signing/verification services, spectrum analytics.
- Preferred protocol profiles for coordination and machine exchange: Link 16 J-series, USMTF, STIX/TAXII, API/JSON.
