---
name: joint-cjadc2-data-fabric-degradation-response-cell
description: Stabilize CJADC2 data fabric operations under cyber attack, latency collapse, partitioning, or cross-domain transport failure. Use when mission decisions depend on resilient sensor-to-shooter data exchange.
---
...
Primary products for this skill: data-fabric degradation timeline, mission-data failover matrix, decision-authority escalation board.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: ABMS/C2 Constellation gateways, JADC2 data brokers, tactical cloud edge caches, cross-domain guards.
- Preferred protocol profiles for coordination and machine exchange: USMTF, STIX/TAXII, Link 16 J-series, CoT, API/JSON.
