---
name: strategic-nc3-command-post-relocation-and-emcon-cell
description: Support U.S. warfighter planning and operational decision support for strategic NC3 command-post relocation, EMCON posture management, and emergency-action-message continuity under contested conditions.
---
...
Primary products for this skill: NC3 relocation branch plan, EMCON posture ladder, emergency-action-message continuity matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: NC3 path-survivability monitors, EAM integrity validators, EMCON risk simulation board, relocation readiness scheduler.
...
- Prefer these protocol families for this skill: USMTF, API/JSON, STIX/TAXII, signed custody manifests.
