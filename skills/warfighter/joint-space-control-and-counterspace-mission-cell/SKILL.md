---
name: joint-space-control-and-counterspace-mission-cell
description: Support U.S. warfighter planning and decision support for space control and counterspace missions. Use when missions require satellite defense, orbital threat response, launch/reconstitution integration, and escalation-aware space operations.
---
...
Primary products for this skill: space posture recommendation matrix, protected SATCOM continuity branch plan, counterspace escalation risk ledger.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: space-domain awareness systems, telemetry and ephemeris tools, space C2 mission planners, missile warning cross-cue systems.
...
- Prefer these protocol families for this skill: CCSDS, OMM/OEM, USMTF, STIX/TAXII.
...
- Primary: tool_suite_id=ts-space-control-counterspace-escalation-v1 with protocol_stack_id=ps-space-control-counterspace-escalation-stack-v1.
