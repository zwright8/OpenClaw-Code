---
name: coalition-maritime-insurance-risk-and-reconstitution-cell
description: Analyze coalition maritime insurance risk and reconstitution options to sustain military sealift and protected shipping. Use when insurance market shocks disrupt strategic sealift capacity.
---
...
Primary products for this skill: maritime insurance exposure matrix, reconstitution finance options board, sealift continuity risk ladder.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-maritime-insurance-reconstitution-v1` with `protocol_stack_id=ps-maritime-insurance-reconstitution-stack-v1`.
...
- Default packet IDs: DPL-MARITIME-INSURE-001.
