---
name: tactical-directed-energy-optics-degradation-recovery-cell
description: Assess and recover from optics/sensor degradation caused by directed-energy exposure during tactical operations.
---
...
- Primary: `tool_suite_id=ts-directed-energy-optics-recovery-v1` with `protocol_stack_id=ps-directed-energy-optics-recovery-stack-v1`.
...
- Default packet IDs: `DPL-DE-OPTICS-RECOVERY-001`, `DPL-SENSOR-DEGRADATION-RECOVERY-001`.
