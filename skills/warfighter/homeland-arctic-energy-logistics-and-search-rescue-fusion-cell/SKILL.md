---
name: homeland-arctic-energy-logistics-and-search-rescue-fusion-cell
description: Fuse Arctic energy logistics, mobility constraints, and SAR priorities to sustain homeland defense operations in extreme environments. Use when warfighters need synchronized fuel-power-SAR decisions in austere Arctic theaters.
---
...
Primary products for this skill: arctic fuel-power sustainment map, SAR prioritization ladder, weather-risk logistics branch matrix.
...
- Add `tool_suite_id=ts-homeland-arctic-energy-logistics-sar-fusion-v1` + `protocol_stack_id=ps-homeland-arctic-energy-logistics-sar-fusion-stack-v1` when producing critical recommendations for this mission domain.
