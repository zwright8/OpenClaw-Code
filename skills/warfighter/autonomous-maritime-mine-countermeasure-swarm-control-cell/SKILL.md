---
name: autonomous-maritime-mine-countermeasure-swarm-control-cell
description: Support U.S. warfighter planning for autonomous maritime mine countermeasure swarms. Use when commanders need MCM swarm tasking, lane-clearance confidence, and autonomous safety governance.
---
...
Primary products for this skill: mine-lane clearance confidence board, autonomous swarm control plan, MCM branch timeline.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: uncrewed maritime control systems, mine-detection analytics, maritime COP tools.
- Preferred protocol profile for machine and staff exchange: AIS/NMEA + Link 16 J-series + API/JSON.
- Default tool suite binding: `tool_suite_id=ts-autonomous-mcm-swarm-v1`.
- Default protocol stack binding: `protocol_stack_id=ps-maritime-mcm-autonomy-stack-v1`.
- Default packet binding: `packet_id=DPL-MCM-SWARM-001`.
