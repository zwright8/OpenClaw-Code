---
name: contested-theater-multi-cloud-mission-data-integrity-cell
description: Preserve mission data integrity across contested multi-cloud environments with cryptographic attestation and failover governance.
---
...
Primary products for this skill: integrity attestation board, cross-cloud divergence tracker, failover data trust plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-multi-cloud-mission-data-integrity-v1` with `protocol_stack_id=ps-multi-cloud-mission-data-integrity-stack-v1`.
...
- Default packet IDs: DPL-MULTI-CLOUD-MISSION-DATA-INTEGRITY-001.
