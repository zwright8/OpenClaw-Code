---
name: theater-ai-enabled-sensor-ghost-track-adjudication-cell
description: Adjudicate AI-amplified ghost tracks and false positives across theater sensor networks to prevent fratricide and wasted fires.
---
...
- Primary: `tool_suite_id=ts-sensor-ghost-track-adjudication-v1` with `protocol_stack_id=ps-sensor-ghost-track-adjudication-stack-v1`.
...
- Default packet IDs: `DPL-GHOST-TRACK-ADJUDICATION-001`, `DPL-FRATRICIDE-TRACK-INTERLOCK-001`.
