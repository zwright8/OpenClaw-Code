---
name: strategic-nuclear-triad-readiness-support
description: Provide readiness decision support for strategic deterrence force posture. Use when tracking readiness indicators, survivability concerns, and signaling implications.
---
...
1. Frame the mission problem using these core inputs: readiness indicators, maintenance windows, command directives, threat assessments.
...
Primary products for this skill: triad readiness posture brief, risk and mitigation matrix, signaling options.
...
- Prioritize these tools or protocol families for this domain: strategic C2 systems, USMTF, secure reporting formats.
