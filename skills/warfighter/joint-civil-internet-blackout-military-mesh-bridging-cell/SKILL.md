---
name: joint-civil-internet-blackout-military-mesh-bridging-cell
description: Bridge military and civil command networks during widespread internet blackout while preserving command authority integrity.
---
...
Primary products: internet blackout impact board, military mesh bridge activation matrix, commander continuity branch packet.
...
- Primary: `tool_suite_id=ts-joint-civil-internet-blackout-military-mesh-bridging-v1` with `protocol_stack_id=ps-joint-civil-internet-blackout-military-mesh-bridging-stack-v1`.
...
- Default packet IDs: `DPL-JOINT-CIVIL-INTERNET-BLACKOUT-MESH-BRIDGING-001`.
