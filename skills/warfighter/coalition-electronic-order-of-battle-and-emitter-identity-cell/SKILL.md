---
name: coalition-electronic-order-of-battle-and-emitter-identity-cell
description: Support U.S. warfighter planning and decision support for Coalition Electronic Order of Battle and Emitter Identity Cell. Use when missions require coalition emitter identity fusion, adversary EOB curation, and protocol-aware staff outputs.
---
...
Primary products for this skill: coalition emitter identity ledger, EOB confidence map, collection retask matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: all-source fusion boards, RF signature libraries, coalition data-sharing gateways.

## Protocol Profile

Preferred protocol families for this skill: Link 16 J-series, NATO APP-11/ADatP-3, STIX/TAXII.
