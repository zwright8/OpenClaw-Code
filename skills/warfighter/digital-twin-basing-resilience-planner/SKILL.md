---
name: digital-twin-basing-resilience-planner
description: Use digital twin models to evaluate base resilience, infrastructure vulnerabilities, and restoration priorities. Use when comparing hardening and recovery options for critical military installations.
---
...
1. Frame the mission problem using these core inputs: infrastructure model data, threat scenarios, utility dependencies, and mission-critical functions.
...
Primary products for this skill: base resilience stress-test report, infrastructure hardening priority list, restoration sequencing plan.
