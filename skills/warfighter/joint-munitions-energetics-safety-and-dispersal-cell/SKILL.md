---
name: joint-munitions-energetics-safety-and-dispersal-cell
description: Support munitions survivability with energetics safety controls, depot dispersal options, and explosive-compatibility-informed throughput decisions.
---

# Joint Munitions Energetics Safety and Dispersal Cell
...
Use these tool categories by default: munitions compatibility and blast-radius planners, energetics aging/risk monitors, depot dispersal and throughput schedulers.

## Protocol Profile

Preferred protocol families for this skill: USMTF, NIEM, OGC, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-MUNITIONS-ENERGETICS-DISPERSAL-001 for critical recommendations.
