---
name: tactical-urban-vertical-lift-landing-zone-authentication-cell
description: Authenticate dynamic urban landing zones for vertical lift under spoofing, decoys, and civilian congestion.
---
...
- Use packet template `DPL-VTOL-LZ-001` from `../_shared/references/domain-tool-packet-library.md`.
- Bind tool and protocol choices to `ts-urban-vtol-lz-auth-v1` and `ps-urban-vtol-lz-auth-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Align execution profile with `fires-airspace-deconfliction-v1` from `../_shared/references/joint-operations-external-toolchain-profiles.md`.
...
- Primary: `tool_suite_id=ts-urban-vtol-lz-auth-v1` with `protocol_stack_id=ps-urban-vtol-lz-auth-stack-v1`.
...
- Default packet ID: `DPL-VTOL-LZ-001`.
