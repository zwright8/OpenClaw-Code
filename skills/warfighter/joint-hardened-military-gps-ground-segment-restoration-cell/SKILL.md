---
name: joint-hardened-military-gps-ground-segment-restoration-cell
description: Support warfighter planning for hardened military GPS ground-segment restoration after kinetic, cyber, or electromagnetic disruption.
---
...
- Primary: `tool_suite_id=ts-gps-ground-segment-restoration-v1` with `protocol_stack_id=ps-gps-ground-segment-restoration-stack-v1`.
- Alternate: `tool_suite_id=ts-pnt-time-transfer-assurance-v1` with `protocol_stack_id=ps-pnt-time-transfer-assurance-stack-v1`.
...
- Default packet IDs: DPL-GPS-GROUND-RESTORE-001, DPL-PNT-TIME-TRANSFER-001.
