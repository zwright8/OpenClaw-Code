---
name: theater-denied-pharmaceutical-counterfeit-detection-cell
description: Detect counterfeit or degraded pharmaceuticals in denied theaters and guide quarantine, substitution, and treatment continuity decisions.
---
...
Primary products for this skill: drug lot risk board, quarantine and substitution decision tree, treatment continuity tracker.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: pharma lot traceability services, field assay telemetry, medical logistics planning boards.
- Preferred protocol profiles for coordination and machine exchange: HL7/FHIR, API/JSON, USMTF.
...
- Default packet binding for this domain: DPL-DENIED-PHARMA-COUNTERFEIT-001.
