---
name: denied-pnt-swarm-rendezvous-and-recovery-cell
description: Provide U.S. warfighter decision support for Denied Pnt Swarm Rendezvous And Recovery Cell missions, including joint planning outputs, external tool usage, and protocol-aware fallback actions.
---
