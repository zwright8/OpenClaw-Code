---
name: joint-cross-border-river-flood-bridging-and-evacuation-cell
description: Synchronize military bridging, evacuation, and logistics continuity during cross-border flood crises in contested theaters.
---
...
Primary products: flood bridging mission matrix, evacuation corridor priority map, engineer sustainment timeline, and civil-military decision packet.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-cross-border-river-flood-bridging-evac-v1` with `protocol_stack_id=ps-cross-border-river-flood-bridging-evac-stack-v1`.
...
- Default packet IDs: DPL-RIVER-FLOOD-BRIDGING-EVAC-001, DPL-CROSS-BORDER-FLOOD-CIVMIL-001.
