---
name: austere-arctic-ground-lines-of-communication-resilience-cell
description: Plan arctic sustainment corridor resilience across ice roads, railheads, and fuel nodes under weather and adversary disruption. Use for Arctic and sub-Arctic military mobility planning.
---
...
Primary products for this skill: Arctic GLOC resilience map, sustainment corridor branch plan, mobility choke-point restoration matrix.
...
- Prioritize these tool/protocol families for this domain: polar route analytics, convoy and rail movement control, weather/ice hazard intelligence.
