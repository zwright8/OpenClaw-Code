---
name: coalition-joint-fire-mission-data-translation-cell
description: Translate, validate, and reconcile coalition fires mission data formats to preserve timing and no-strike compliance.
---
...
- Primary: `tool_suite_id=ts-coalition-fire-data-translation-v1` with `protocol_stack_id=ps-coalition-fire-data-translation-stack-v1`.
...
- Default packet IDs: `DPL-FIRE-DATA-TRANSLATION-001`, `DPL-NO-STRIKE-TRANSLATION-ASSURANCE-001`.
