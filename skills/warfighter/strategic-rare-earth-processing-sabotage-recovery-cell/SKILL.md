---
name: strategic-rare-earth-processing-sabotage-recovery-cell
description: Restore defense-critical rare-earth processing throughput after sabotage or cyber-physical disruption. Use when precision weapons and electronic systems supply continuity is at risk.
---
...
Primary products for this skill: rare-earth recovery prioritization board, industrial restoration timeline, strategic supply assurance branch map.

## Domain Tool Stack

Use these tool categories as the baseline stack: industrial telemetry monitors, supply-chain provenance ledgers, OT incident response systems, strategic stockpile dashboards.

## Protocol Profile

Preferred protocol families for this skill: STIX/TAXII, ISA/IEC 62443, API/JSON, EPCIS provenance profiles.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-rare-earth-processing-sabotage-recovery-v1` with `protocol_stack_id=ps-rare-earth-processing-sabotage-recovery-stack-v1`.
- Alternate: `tool_suite_id=ts-strategic-supply-shock-v1` with `protocol_stack_id=ps-strategic-supply-shock-stack-v1`.
...
- Default packet IDs: DPL-RARE-EARTH-SABOTAGE-RECOVERY-001, DPL-STRATEGIC-SUPPLY-SHOCK-001.
