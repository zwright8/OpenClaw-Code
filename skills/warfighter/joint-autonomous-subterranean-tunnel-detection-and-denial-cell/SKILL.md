---
name: joint-autonomous-subterranean-tunnel-detection-and-denial-cell
description: Coordinate joint autonomous subterranean tunnel detection, mapping, and denial planning in contested terrain. Use when warfighters need rapid underground threat localization and breach/containment options.
---
...
Primary products for this skill: subterranean threat localization board, tunnel denial branch plan, underground ISR confidence ledger.
...
- Add `tool_suite_id=ts-autonomous-subterranean-tunnel-detection-denial-v1` + `protocol_stack_id=ps-autonomous-subterranean-tunnel-detection-denial-stack-v1` when producing critical recommendations for this mission domain.
