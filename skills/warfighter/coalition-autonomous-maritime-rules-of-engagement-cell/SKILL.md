---
name: coalition-autonomous-maritime-rules-of-engagement-cell
description: Support U.S. warfighter planning and decision support for Coalition Autonomous Maritime Rules of Engagement Cell. Use when missions require Coalition Autonomous Maritime Rules of Engagement Cell planning, integrated options, and protocol-aware staff outputs.
---
...
2. Identify assumptions, decision thresholds, and indicators that would invalidate the current plan.
...
Primary products for this skill: autonomous vessel ROE decision tree, coalition legal interoperability packet, incident escalation flow.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: maritime autonomy control boards, coalition legal policy trackers, vessel behavior analytics.
- Prioritize these protocol families for this domain: NATO APP-11/ADatP-3 aligned, AIS/NMEA, USMTF, API/JSON.
