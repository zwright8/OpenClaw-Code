---
name: joint-long-range-fires-ammo-lot-reliability-cell
description: Assess long-range fires ammunition lot reliability, defect risk, and employment constraints under high operational tempo.
---
...
Primary products for this skill: ammo lot reliability heatmap, defect quarantine matrix, fires employment constraint table.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-long-range-fires-lot-reliability-v1` with `protocol_stack_id=ps-long-range-fires-lot-reliability-stack-v1`.
- Alternate: `tool_suite_id=ts-additive-propellant-safety-v1` with `protocol_stack_id=ps-additive-propellant-safety-stack-v1`.
...
- Default packet IDs: DPL-LONG-RANGE-FIRES-LOT-001.
