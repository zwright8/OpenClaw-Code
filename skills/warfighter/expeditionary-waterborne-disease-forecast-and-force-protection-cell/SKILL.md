---
name: expeditionary-waterborne-disease-forecast-and-force-protection-cell
description: Forecast and mitigate waterborne disease risks that degrade force readiness in austere theaters. Use when operations depend on contested water sources, disrupted sanitation, or rapid population movement.
---
...
1. Frame the mission problem using these core inputs: water source quality telemetry, outbreak indicators, field sanitation posture, medical treatment capacity, mission tempo.
...
Primary products for this skill: waterborne outbreak risk forecast, force-health protection action matrix, water treatment prioritization package.
