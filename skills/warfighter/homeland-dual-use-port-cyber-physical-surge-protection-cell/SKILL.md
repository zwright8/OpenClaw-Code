---
name: homeland-dual-use-port-cyber-physical-surge-protection-cell
description: Coordinate cyber-physical surge protection for homeland dual-use ports during military and civilian throughput surges. Use when port operations face concurrent cyber, safety, and force-flow pressures.
---
...
Primary products for this skill: port surge protection posture board, cyber-physical hazard escalation ladder, throughput continuity branch packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: port OT security telemetry, cargo throughput digital twins, berth allocation orchestration, incident response command dashboards.
...
- Add `tool_suite_id=ts-dual-use-port-cyber-physical-surge-protection-v1` + `protocol_stack_id=ps-dual-use-port-cyber-physical-surge-protection-stack-v1` when producing critical recommendations for this mission domain.
