---
name: joint-operational-energy-demand-signature-reduction-cell
description: Reduce energy demand and detectable sustainment signatures while preserving combat effectiveness. Use when fuel resupply risk, thermal/electromagnetic exposure, or logistics vulnerability threatens mission continuity.
---
...
1. Frame the mission problem using these core inputs: mission energy demand profile, resupply route risk, thermal/electromagnetic signature data, generator/storage status, force posture.
...
Primary products for this skill: energy-signature tradeoff model, fuel demand reduction branch plan, signature-aware sustainment decision matrix.
