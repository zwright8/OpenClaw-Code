---
name: joint-civilian-airlift-requisition-and-priority-cell
description: Coordinate civilian airlift requisition and prioritization for military surge, evacuation, and humanitarian throughput.
---
...
Primary products for this skill: civil airlift requisition packet, aircraft allocation matrix, priority movement timeline.
...
- `tool_suite_id`: `ts-civil-airlift-requisition-v1`
- `protocol_stack_id`: `ps-civil-airlift-requisition-stack-v1`
