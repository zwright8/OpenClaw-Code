---
name: coalition-contested-orbit-rescue-and-deorbit-governance-cell
description: Support U.S. warfighter planning and decision support for coalition satellite rescue, collision avoidance, and controlled deorbit governance in contested space.
---
...
Primary products for this skill: satellite rescue decision matrix, deorbit safety corridor package, coalition authority and release ledger.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: space domain awareness catalogs, conjunction analysis services, satellite operations planners, coalition releasability governance boards.
...
- Prefer these protocol families for this skill: CCSDS, API/JSON, USMTF.
