---
name: joint-autonomous-undersea-data-mule-and-exfiltration-denial-cell
description: Detect and deny autonomous undersea data-mule exfiltration routes while protecting friendly subsea operations.
---
...
- Primary: `tool_suite_id=ts-autonomous-undersea-data-mule-denial-v1` with `protocol_stack_id=ps-autonomous-undersea-data-mule-denial-stack-v1`.
...
- Default packet IDs: `DPL-UNDERSEA-DATA-MULE-DETECTION-001`, `DPL-UNDERSEA-EXFILTRATION-DENIAL-001`.
