---
name: theater-strategic-tanker-airbridge-contested-replan-cell
description: Replan strategic tanker and airbridge tasking under missile, EW, and airfield disruption to preserve sortie generation and mobility.
---
...
Primary products for this skill: airbridge reroute matrix, tanker allocation ladder, sortie sustainment risk timeline.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: air mobility planning systems, tanker mission schedulers, airfield threat and status dashboards.
- Preferred protocol profiles for coordination and machine exchange: AIXM/FIXM, USMTF, Link 16 J-series.
