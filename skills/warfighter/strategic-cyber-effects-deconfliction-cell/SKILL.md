---
name: strategic-cyber-effects-deconfliction-cell
description: Deconflict strategic cyber effects with kinetic, EW, and information operations to avoid mission interference and escalation surprises. Use when coordinating cross-domain effects campaigns.
---
...
1. Frame the mission problem using these core inputs: planned cyber effects windows, kinetic/EW timelines, target dependencies, and escalation constraints.
...
Primary products for this skill: strategic effects deconfliction matrix, timing conflict resolution board, escalation-aware branch plan.
