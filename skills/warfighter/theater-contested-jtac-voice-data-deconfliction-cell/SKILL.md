---
name: theater-contested-jtac-voice-data-deconfliction-cell
description: Synchronize JTAC voice and digital fires control under jamming, latency, and relay degradation. Use when warfighters need safe close-air-support deconfliction in denied communications conditions.
---
...
Primary products for this skill: JTAC voice-data deconfliction ledger, CAS clearance confidence matrix, denied-link escalation decision card.
...
- Add `tool_suite_id=ts-contested-jtac-voice-data-deconfliction-v1` + `protocol_stack_id=ps-contested-jtac-voice-data-deconfliction-stack-v1` when producing critical recommendations for this mission domain.
