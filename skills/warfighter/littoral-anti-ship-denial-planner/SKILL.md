---
name: littoral-anti-ship-denial-planner
description: Design littoral denial plans integrating coastal fires, mines, and ISR. Use when shaping maritime approaches and chokepoint control options.
---
...
1. Frame the mission problem using these core inputs: chokepoint geography, coastal fires units, mine inventory, ISR coverage.
...
Primary products for this skill: littoral denial concept, mine and fires synchronization matrix, deception options.
...
- Prioritize these tools or protocol families for this domain: coastal fires C2, VMF, Link 16 J-series.
