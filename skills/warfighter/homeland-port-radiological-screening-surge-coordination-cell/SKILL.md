---
name: homeland-port-radiological-screening-surge-coordination-cell
description: Coordinate radiological screening surge operations at U.S. ports. Use when elevated threat conditions require synchronized military-civil inspection, quarantine, and throughput continuity decisions.
---

# Homeland Port Radiological Screening Surge Coordination Cell
...
Primary products for this skill: port screening surge battle rhythm, suspicious cargo escalation matrix, continuity-of-commerce reroute plan.
...
- Prioritize these tool families for this domain: port customs screening systems, radiation sensor fusion platforms, Coast Guard command tools, FEMA/EOC systems.
- Prioritize these protocol families for this domain: NIMS/ICS, EDXL-DE/CAP, AIS/NMEA.
