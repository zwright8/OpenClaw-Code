---
name: theater-portable-microreactor-power-employment-cell
description: Plan and govern portable microreactor emplacement, load-priority allocation, and safety boundaries in contested theaters.
---
...
Primary products for this skill: microreactor placement board, critical load priority matrix, radiological safety branch triggers.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-portable-microreactor-employment-v1` with `protocol_stack_id=ps-portable-microreactor-employment-stack-v1`.
- Alternate: `tool_suite_id=ts-operational-energy-microgrid-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Default packet IDs: DPL-MICROREACTOR-EMPLOY-001.
