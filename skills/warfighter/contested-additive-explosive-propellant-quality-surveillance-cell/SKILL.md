---
name: contested-additive-explosive-propellant-quality-surveillance-cell
description: Monitor quality drift and safety risks in expeditionary additive explosive and propellant production lines.
---
...
Primary products for this skill: propellant quality risk register, stop-production trigger matrix, lot release exception board.

## Tool Suite and Protocol Binding

- Bind tool selection to `ts-additive-propellant-quality-surveillance-v1` and `ps-additive-propellant-quality-surveillance-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Recommended external tools for this domain: manufacturing execution systems, explosive safety instrumentation, spectroscopy test logs, and ammo lot traceability ledgers.
- Required protocol families for implementation: ISA-95 B2MML, OPC UA, MQTT over TLS, and NIEM.
