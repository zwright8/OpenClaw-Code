---
name: tactical-cloud-sovereign-model-governance-cell
description: Support U.S. warfighter planning and operational decision support for Tactical Cloud Sovereign Model Governance Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---

# Tactical Cloud Sovereign Model Governance Cell
...
Primary products for this skill: model governance status board, sovereign-control compliance matrix, rollback decision triggers.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: model registries, cloud policy engines, software supply-chain scanners, mission data fabric control planes.
