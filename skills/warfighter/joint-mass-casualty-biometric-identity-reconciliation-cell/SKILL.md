---
name: joint-mass-casualty-biometric-identity-reconciliation-cell
description: Fuse biometric, forensic, and personnel data for rapid casualty identity reconciliation and family notification integrity.
---
...
Primary products for this skill: identity reconciliation confidence board, casualty notification queue, forensic gap closure plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-mass-casualty-biometric-reconciliation-v1` with `protocol_stack_id=ps-mass-casualty-biometric-reconciliation-stack-v1`.
...
- Default packet IDs: DPL-MASS-CASUALTY-BIOMETRIC-RECONCILIATION-001.
