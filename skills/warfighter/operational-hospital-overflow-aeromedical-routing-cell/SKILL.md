---
name: operational-hospital-overflow-aeromedical-routing-cell
description: Route casualties across overflowing hospital networks using aeromedical corridors and priority regulation. Use when mass-casualty surges exceed local care capacity and transfer speed is mission-critical.
---
...
Primary products for this skill: overflow routing order, casualty transfer timeline, care-gap mitigation plan.

## Domain Tool Stack

Use these tool categories as the baseline stack: hospital stress dashboards, aeromedical route optimizers, casualty-priority regulators.

## Protocol Profile

Preferred protocol families for this skill: HL7/FHIR, STANAG 3204, signed patient-priority manifests.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-hospital-overflow-aeromedical-routing-v1` with `protocol_stack_id=ps-hospital-overflow-aeromedical-routing-stack-v1`.
...
- Default packet IDs: DPL-HOSPITAL-OVERFLOW-AEROMEDICAL-ROUTING-001, DPL-MULTI-DOMAIN-BATTLE-RHYTHM-FRAGMENT-RECOVERY-001.
