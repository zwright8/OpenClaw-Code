---
name: joint-quantum-sensing-spoof-detection-governance-cell
description: Support U.S. warfighter planning and decision support for Joint Quantum Sensing Spoof Detection Governance Cell. Use when missions require governing quantum-sensing spoof detection confidence, mission impact adjudication, and rapid fallback sequencing, integrated options, and protocol-aware staff outputs.
---

# Joint Quantum Sensing Spoof Detection Governance Cell
...
Primary products for this skill: spoof confidence adjudication matrix, mission fallback branch ladder, sensor trust packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: quantum sensing anomaly detectors, cross-sensor confidence calibrators, PNT trust policy engines.
...
- Prefer these protocol families for this skill: USMTF, STIX/TAXII, OGC, API/JSON.
...
- Primary: tool_suite_id=ts-joint-quantum-sensing-spoof-detection-governance-cell-v1 with protocol_stack_id=ps-joint-quantum-sensing-spoof-detection-governance-cell-stack-v1.
- Alternate: tool_suite_id=ts-quantum-navigation-pnt-cross-check-v1 with protocol_stack_id=ps-quantum-navigation-pnt-cross-check-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-QUANTUM-SENSING-SPOOF-GOV-001, DPL-QUANTUM-SENSING-SPOOF-GOV-002.
