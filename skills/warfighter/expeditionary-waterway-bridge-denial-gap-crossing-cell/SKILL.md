---
name: expeditionary-waterway-bridge-denial-gap-crossing-cell
description: Support expeditionary bridge denial, breach, and gap-crossing sequencing across contested waterways. Use when maneuver forces require synchronized crossing and denial branches.
---

# Expeditionary Forward Waterway Bridge Denial and Gap Crossing Cell
...
Primary products for this skill: waterway crossing decision board, denial-and-breach branch matrix, engineer support tasking packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: hydrology route analytics, bridge load-class services, engineer maneuver planners, crossing risk adjudication tools.
...
- Add `tool_suite_id=ts-forward-waterway-gap-crossing-assurance-v1` + `protocol_stack_id=ps-forward-waterway-gap-crossing-assurance-stack-v1` when producing critical recommendations for this mission domain.
