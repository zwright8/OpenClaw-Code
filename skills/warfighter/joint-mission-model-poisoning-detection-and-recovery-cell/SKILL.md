---
name: joint-mission-model-poisoning-detection-and-recovery-cell
description: Detect model poisoning and data integrity attacks in mission AI pipelines and drive rapid trusted rollback.
---
...
Primary products for this skill: model integrity alert board, rollback decision tree, retraining provenance packet.

## Tool Suite and Protocol Binding

- Bind tool selection to `ts-mission-model-poisoning-recovery-v1` and `ps-mission-model-poisoning-recovery-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Recommended external tools for this domain: MLOps lineage systems, model registry attestations, SIEM and SOAR telemetry, and validation benchmark harness.
- Required protocol families for implementation: in-toto attestations, Sigstore, STIX/TAXII, and REST JSON over mTLS.
