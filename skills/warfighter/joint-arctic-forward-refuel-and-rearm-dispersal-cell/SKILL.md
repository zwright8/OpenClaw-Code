---
name: joint-arctic-forward-refuel-and-rearm-dispersal-cell
description: Support U.S. warfighter planning for Arctic forward refuel-and-rearm dispersal under weather and threat stress. Use when expeditionary nodes must remain survivable while sustaining sortie tempo.
---
...
Primary products for this skill: Arctic FARP dispersal matrix, weather-threat risk ladder, fuel and ordnance continuity timeline.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-arctic-farp-dispersal-v1` with `protocol_stack_id=ps-arctic-air-maritime-stack-v1`.
...
- Default packet IDs: DPL-ARCTIC-FARP-001, DPL-ICELOG-001.
