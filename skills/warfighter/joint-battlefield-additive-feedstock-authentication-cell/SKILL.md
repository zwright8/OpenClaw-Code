---
name: joint-battlefield-additive-feedstock-authentication-cell
description: Authenticate additive manufacturing feedstock and block counterfeit material from entering battlefield repair and production workflows.
---
...
Primary products for this skill: feedstock authenticity ledger, counterfeit indicator heatmap, production hold and release board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-additive-feedstock-authentication-v1` with `protocol_stack_id=ps-additive-feedstock-authentication-stack-v1`.
- Alternate: `tool_suite_id=ts-logistics-distribution-v1` with `protocol_stack_id=ps-additive-compliance-stack-v1`.
...
- Default packet IDs: DPL-ADDITIVE-FEEDSTOCK-AUTH-001.
