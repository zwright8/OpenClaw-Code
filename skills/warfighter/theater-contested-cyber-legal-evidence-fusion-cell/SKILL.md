---
name: theater-contested-cyber-legal-evidence-fusion-cell
description: Fuse contested-theater cyber evidence into legally actionable attribution packets. Use when command decisions require chain-of-custody, coalition legal interoperability, and rapid escalation options.
---
...
1. Frame the mission problem using these core inputs: incident telemetry, malware/forensic artifacts, custody ledger status, coalition legal constraints, escalation decision windows.
...
Primary products for this skill: cyber attribution evidence packet, legal admissibility risk matrix, response-option authority ladder.
...
- Add `tool_suite_id=ts-contested-cyber-legal-evidence-fusion-v1` + `protocol_stack_id=ps-contested-cyber-legal-evidence-fusion-stack-v1` when this domain is mission-critical in current planning.
- Add `packet_id=DPL-CONTESTED-CYBER-LEGAL-EVIDENCE-001` for branches that can materially alter mission posture or civil-protection outcomes.
