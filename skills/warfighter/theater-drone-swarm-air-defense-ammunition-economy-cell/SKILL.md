---
name: theater-drone-swarm-air-defense-ammunition-economy-cell
description: Support U.S. warfighter planning and decision support for Theater Drone Swarm Air Defense Ammunition Economy Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: air-defense ammunition economy board, swarm engagement conservation plan, rearm and resupply trigger packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: counter-UAS battle managers, interceptor inventory analytics, engagement simulation tools.

## Protocol Profile

Preferred protocol families for this skill: Link 16 J-series, VMF, USMTF.
