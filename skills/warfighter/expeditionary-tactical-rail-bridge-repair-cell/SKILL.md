---
name: expeditionary-tactical-rail-bridge-repair-cell
description: Prioritize and coordinate rapid repair of rail bridges and associated corridors to restore military throughput under contested conditions. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: rail bridge damage triage board, repair sequence and resource matrix, throughput restoration decision brief.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: engineering damage assessment tools, rail movement control systems, geospatial route analytics, logistics command dashboards.
- Prioritize these protocol families for this domain: USMTF, OGC WMS/WFS/WMTS, API/JSON, NATO APP-11/ADatP-3 aligned.
