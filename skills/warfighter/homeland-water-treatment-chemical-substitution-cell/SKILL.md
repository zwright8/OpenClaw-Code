---
name: homeland-water-treatment-chemical-substitution-cell
description: Support military-civil water treatment continuity when purification chemical supply is disrupted. Use when planners must rapidly substitute treatment processes while protecting force health.
---
...
Primary products for this skill: water treatment substitution decision matrix, force health risk timeline, restoration-and-resupply branch plan

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-homeland-water-treatment-chemical-substitution-v1 and protocol_stack_id=ps-homeland-water-treatment-chemical-substitution-stack-v1.
- Primary tools for this domain: water quality telemetry dashboards, treatment chemistry substitution models, public-health coordination boards
- Required exchange protocols/formats for this domain: NIMS/ICS, USMTF, NIEM, API/JSON
