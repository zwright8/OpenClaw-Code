---
name: joint-civil-air-gps-spoofing-deconfliction-cell
description: Support joint planning for civil-military deconfliction when GPS spoofing disrupts civilian and military air operations in contested theaters.
---
...
Primary products for this skill: civil-military spoofing impact matrix, alternate nav deconfliction ladder, emergency corridor activation board.
...
- For this domain, prioritize `ts-civil-air-gps-spoof-deconfliction-v1` with `ps-civil-air-gps-spoof-deconfliction-stack-v1` and `DPL-CIVIL-AIR-GPS-SPOOF-DECONFLICTION-001`.
