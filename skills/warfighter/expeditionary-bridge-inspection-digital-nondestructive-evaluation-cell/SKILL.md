---
name: expeditionary-bridge-inspection-digital-nondestructive-evaluation-cell
description: Direct rapid bridge integrity inspection using digital and non-destructive evaluation methods under expeditionary timelines. Use when mobility corridors depend on fast structural confidence assessments.
---
...
1. Frame the mission problem using these core inputs: bridge structural telemetry, NDE sensor outputs, engineer route priorities, traffic load forecasts, and repair asset status.
...
Primary products for this skill: bridge structural confidence report, mobility route release matrix, repair vs bypass recommendation.
...
- Primary: `tool_suite_id=ts-bridge-nde-recovery-v1` with `protocol_stack_id=ps-engineer-nde-stack-v1`.
