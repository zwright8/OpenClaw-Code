---
name: tactical-language-enabled-civil-engagement-cell
description: Support tactical civil engagement with language-enabled products, interpreter workflows, and risk-aware messaging.
---
...
Primary products for this skill: civil engagement packet, interpreter tasking plan, message risk mitigation matrix.
...
- `tool_suite_id`: `ts-civil-engagement-language-support-v1`
- `protocol_stack_id`: `ps-civil-engagement-language-stack-v1`
