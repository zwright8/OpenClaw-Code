---
name: contested-expeditionary-fiber-line-build-and-cutover-cell
description: Support U.S. warfighter planning for rapid build, protection, and cutover of expeditionary fiber in contested environments.
---
...
Primary products for this skill: fiber build and cutover sequence, comms survivability risk table, degraded transport fallback plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: network build management tools, route survey geospatial services, optical telemetry monitors, cyber assurance dashboards.

## Protocol Profile

Preferred protocol families for this skill: OGC, API/JSON, USMTF.

## Domain Toolchain Defaults

- Primary: \ with \.\n- Alternate: \ with \.\n- Degraded: line-of-sight and SATCOM fallback with fixed synchronization windows.
...
- Prefer these protocol families for this skill: OGC, API/JSON, USMTF.
