---
name: coalition-integrated-airbase-missile-shelter-hardening-cell
description: Prioritize coalition airbase shelter hardening and aircraft survivability under missile and drone attack. Use when rapid survivability upgrades must be sequenced across multiple bases.
---
...
Primary products for this skill: hardening priority board, shelter engineering package, sortie survivability estimate.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: airbase engineering task board, runway/shelter imagery exploitation, threat missile library, logistics readiness board.
- Preferred protocol profiles for coordination and machine exchange: USMTF, OGC, NATO APP-11/ADatP-3, API/JSON.
