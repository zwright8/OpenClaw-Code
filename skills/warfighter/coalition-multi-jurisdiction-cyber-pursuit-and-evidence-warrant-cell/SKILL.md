---
name: coalition-multi-jurisdiction-cyber-pursuit-and-evidence-warrant-cell
description: Synchronize coalition cyber pursuit with evidence and warrant workflows across multiple legal jurisdictions.
---
...
Primary products for this skill: cross-border cyber pursuit timeline, warrant dependency matrix, evidence admissibility tracker.

## Domain Tool Stack

Use these tool categories as the baseline stack: SOAR incident timeline, legal process orchestration tools, digital evidence chain services, coalition liaison portal.

## Protocol Profile

Preferred protocol families for this skill: STIX/TAXII, NATO APP-11/ADatP-3 aligned, USMTF, API/JSON.
...
- Prioritize `tool_suite_id=ts-coalition-multi-jurisdiction-cyber-pursuit-and-evidence-warrant-cell-v1` + `protocol_stack_id=ps-coalition-multi-jurisdiction-cyber-pursuit-and-evidence-warrant-cell-stack-v1` when this mission set is the critical path for commander decision timelines.
- Add `packet_id=DPL-COALITION_MULTI_JURISDICTION_CYBER_PURSUIT_AND_EVIDENCE_WARRANT_CELL-001` for the primary course of action and `packet_id=DPL-COALITION_MULTI_JURISDICTION_CYBER_PURSUIT_AND_EVIDENCE_WARRANT_CELL-002` for degraded-mode fallback actions.
