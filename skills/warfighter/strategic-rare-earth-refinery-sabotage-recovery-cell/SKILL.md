---
name: strategic-rare-earth-refinery-sabotage-recovery-cell
description: Coordinate sabotage attribution, rapid recovery, and force-priority allocation for rare-earth refining infrastructure.
---
...
- Primary: `tool_suite_id=ts-rare-earth-refinery-recovery-v1` with `protocol_stack_id=ps-rare-earth-refinery-recovery-stack-v1`.
...
- Default packet IDs: `DPL-RARE-EARTH-REFINERY-RECOVERY-001`, `DPL-CRITICAL-MINERAL-FORCE-ALLOCATION-001`.
