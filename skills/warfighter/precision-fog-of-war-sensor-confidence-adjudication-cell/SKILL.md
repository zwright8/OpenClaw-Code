---
name: precision-fog-of-war-sensor-confidence-adjudication-cell
description: Adjudicate conflicting sensor inputs to preserve decision quality under fog-of-war conditions. Use when commanders need confidence-ranked alternatives despite contested or deceptive data.
---
...
Primary products for this skill: sensor confidence adjudication board, cross-source conflict resolution packet, decision-confidence trigger timeline.
...
- Prioritize these tool/protocol families for this domain: multi-INT fusion tools, anomaly and deception detection analytics, confidence scoring and provenance services.
