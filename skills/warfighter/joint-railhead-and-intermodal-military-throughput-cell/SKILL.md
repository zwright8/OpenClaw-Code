---
name: joint-railhead-and-intermodal-military-throughput-cell
description: Optimize railhead and intermodal node throughput for force flow, munitions movement, and sustainment timing. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: railhead throughput plan, intermodal conflict matrix, delay recovery branch.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: rail network control systems, intermodal terminal schedulers, cargo visibility platforms, infrastructure status dashboards.
