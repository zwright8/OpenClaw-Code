---
name: strategic-energetics-precursor-supply-diversion-counter-cell
description: Counter diversion of energetics precursor supplies needed for U.S. defense munitions and propulsion production. Use when strategic precursor flows face theft, sanctions evasion, or sabotage pressure.
---
...
Primary products for this skill: precursor diversion risk board, interdiction and substitution plan, strategic energetics continuity timeline.
...
- Add `tool_suite_id=ts-strategic-energetics-precursor-diversion-counter-v1` + `protocol_stack_id=ps-strategic-energetics-precursor-diversion-counter-stack-v1` when producing critical recommendations for this mission domain.
