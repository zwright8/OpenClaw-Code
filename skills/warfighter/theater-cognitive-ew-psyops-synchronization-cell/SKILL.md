---
name: theater-cognitive-ew-psyops-synchronization-cell
description: Synchronize cognitive effects, electromagnetic operations, and PSYOPS release timing to maximize effect while avoiding fratricide.
---
...
- Primary: `tool_suite_id=ts-cognitive-ew-psyops-sync-v1` with `protocol_stack_id=ps-cognitive-ew-psyops-sync-stack-v1`.
...
- Default packet IDs: `DPL-COGNITIVE-EW-PSYOPS-SYNC-001`, `DPL-INFLUENCE-EFFECT-DECONFLICTION-001`.
