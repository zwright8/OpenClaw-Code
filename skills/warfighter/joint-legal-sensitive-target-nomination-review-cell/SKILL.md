---
name: joint-legal-sensitive-target-nomination-review-cell
description: Provide rapid legal-policy review support for sensitive target nominations with documented assumptions, authorities, and collateral risk posture. Use when high-consequence targets demand accelerated but auditable review.
---
...
1. Frame the mission problem using these core inputs: target dossier fidelity, legal authority baseline, collateral estimation confidence, approval suspense.
...
Primary products for this skill: sensitive target legal review packet, approval risk matrix, decision audit trail.
...
- Primary: `tool_suite_id=ts-sensitive-target-legal-review-v1` with `protocol_stack_id=ps-legal-targeting-assurance-stack-v1`.
