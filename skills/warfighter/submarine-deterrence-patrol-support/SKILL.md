---
name: submarine-deterrence-patrol-support
description: Support deterrent patrol planning and risk management for strategic undersea operations. Use when evaluating patrol area constraints, comms windows, and force protection posture.
---
...
1. Frame the mission problem using these core inputs: patrol constraints, oceanographic factors, adversary ASW activity, comms plans.
...
Primary products for this skill: deterrent patrol support matrix, risk register, branch response triggers.
...
- Prioritize these tools or protocol families for this domain: undersea planning systems, secure message traffic, USMTF.
