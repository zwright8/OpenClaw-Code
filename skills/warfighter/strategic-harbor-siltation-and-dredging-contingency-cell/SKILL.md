---
name: strategic-harbor-siltation-and-dredging-contingency-cell
description: Assess and manage harbor siltation risks that threaten military sealift throughput, amphibious operations, or logistics staging. Use when channel depth and dredging capacity become mission-critical.
---
...
1. Frame the mission problem using these core inputs: harbor depth survey changes, dredging asset readiness, vessel draft demand, weather and sediment drivers.
...
Primary products for this skill: harbor dredging contingency plan, sealift throughput risk matrix, dredge-priority schedule.
...
- Primary: `tool_suite_id=ts-harbor-siltation-dredging-v1` with `protocol_stack_id=ps-maritime-harbor-restoration-stack-v1`.
