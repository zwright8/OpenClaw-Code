---
name: multi-domain-degraded-weather-and-fires-recalibration-cell
description: Support dynamic recalibration of sensor-to-shooter chains when degraded weather undermines targeting confidence. Use when fires, ISR, and airspace decisions require rapid meteorological adaptation.
---
...
Primary products for this skill: weather-degraded targeting confidence map, fires recalibration recommendation set, branch-and-sequel weather trigger card

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-multi-domain-degraded-weather-fires-recalibration-v1 and protocol_stack_id=ps-multi-domain-degraded-weather-fires-recalibration-stack-v1.
- Primary tools for this domain: battlefield weather fusion systems, fires solution recalculation services, ISR sensor quality estimators
- Required exchange protocols/formats for this domain: USMTF, OGC WMS/WFS/WMTS, VMF, API/JSON
