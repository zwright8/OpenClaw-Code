---
name: expeditionary-seabasing-and-offshore-staging-coordinator
description: Support planning for expeditionary seabasing and offshore staging nodes in contested theaters. Use when operations require afloat staging, distributed sustainment, and sea-based command options.
---
...
1. Frame the mission problem using these core inputs: sea-state and weather constraints, afloat capacity, sustainment demand, and threat envelope changes.
...
Primary products for this skill: offshore staging posture map, afloat sustainment branch plan, sea-base risk decision matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: maritime C2 systems, afloat logistics dashboards, weather and sea-state forecasting feeds.
...
- Prefer these protocol families for this skill: AIS/NMEA, USMTF, OGC, Link 16 J-series.
