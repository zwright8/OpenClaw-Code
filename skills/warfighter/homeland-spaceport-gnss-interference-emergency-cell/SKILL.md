---
name: homeland-spaceport-gnss-interference-emergency-cell
description: Coordinate launch safety and range continuity during GNSS jamming, spoofing, and timing instability events.
---
...
- Use packet template `DPL-SPACEPORT-GNSS-001` from `../_shared/references/domain-tool-packet-library.md`.
- Bind tool and protocol choices to `ts-spaceport-gnss-emergency-v1` and `ps-spaceport-gnss-emergency-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Align execution profile with `space-satcom-resilience-v1` from `../_shared/references/joint-operations-external-toolchain-profiles.md`.
...
- Primary: `tool_suite_id=ts-spaceport-gnss-emergency-v1` with `protocol_stack_id=ps-spaceport-gnss-emergency-stack-v1`.
...
- Default packet ID: `DPL-SPACEPORT-GNSS-001`.
