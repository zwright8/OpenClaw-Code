---
name: joint-civil-cyber-infrastructure-continuity-cell
description: Synchronize military support to civil cyber infrastructure continuity during major attacks or outages. Use when mission operations depend on restoration of power, telecom, transport, or emergency services.
---
...
1. Frame the mission problem using these core inputs: critical infrastructure outage reports, cyber incident telemetry, civil authority requests, mission dependency mapping.
...
Primary products for this skill: infrastructure continuity support plan, restoration priority stack, civil-military coordination matrix.
...
- Prioritize these tools or tool families for this domain: critical infrastructure monitoring platforms, SIEM/SOAR tools, emergency management systems, liaison data fabrics.
- Specify outbound exchange format for recommendations and tasking: STIX/TAXII, API/JSON, USMTF, OGC.
