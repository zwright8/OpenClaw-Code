---
name: contested-space-weather-gnss-outage-fusion-cell
description: Support U.S. warfighter planning and decision support for Contested Space Weather GNSS Outage Fusion Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: space-weather outage forecast board, GNSS degradation impact matrix, navigation fallback decision packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: space weather monitors, GNSS integrity analyzers, alternate navigation confidence services.
