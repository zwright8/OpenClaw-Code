---
name: contested-civil-spectrum-priority-restoration-cell
description: Restore critical civil spectrum services under contested conditions. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: service outage map, interference signatures, civil priority services list, spectrum allocation authorities.
...
Primary products for this skill: spectrum restoration order, priority-service continuity plan, interference mitigation actions.
