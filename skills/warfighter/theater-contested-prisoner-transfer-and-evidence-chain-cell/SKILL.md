---
name: theater-contested-prisoner-transfer-and-evidence-chain-cell
description: Support warfighter planning for lawful prisoner transfer continuity and evidence-chain integrity across contested theaters.
---
...
- Primary: `tool_suite_id=ts-prisoner-transfer-evidence-chain-v1` with `protocol_stack_id=ps-prisoner-transfer-evidence-chain-stack-v1`.
...
- Default packet IDs: DPL-PRISONER-TRANSFER-EVIDENCE-CHAIN-001, DPL-CUSTODY-HANDSHAKE-LEDGER-001.
