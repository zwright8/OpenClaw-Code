---
name: strategic-rare-earth-alloy-and-magnet-industrial-assurance-cell
description: Assess and stabilize strategic rare earth alloy and permanent magnet production pathways for defense readiness. Use when supply disruptions threaten weapon system sustainment, industrial surge, or allied production timelines.
---
...
1. Frame the mission problem using these core inputs: ore-to-magnet production flow, refinery status, alloy plant throughput, component demand forecasts, strategic reserve policy constraints.
...
Primary products for this skill: industrial choke-point risk board, magnet-alloy surge allocation matrix, defense program impact forecast.
