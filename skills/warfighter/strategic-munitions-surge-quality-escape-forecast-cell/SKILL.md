---
name: strategic-munitions-surge-quality-escape-forecast-cell
description: Support strategic munitions surge planning with quality-escape forecasting. Use when production tempo increases and commanders must balance throughput against lot safety, defect escape, and release risk.
---
...
Primary products for this skill: quality-escape forecast, lot release risk board, surge throughput mitigation plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-munitions-quality-escape-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
- Alternate: `tool_suite_id=ts-munitions-fragmentation-safety-v1` with `protocol_stack_id=ps-joint-tactical-link-stack-v1`.
...
- Preferred protocol families: API/JSON, XML, USMTF.
...
- Default packet IDs: DPL-MUNI-QESC-001, DPL-MUNI-QA-001.
