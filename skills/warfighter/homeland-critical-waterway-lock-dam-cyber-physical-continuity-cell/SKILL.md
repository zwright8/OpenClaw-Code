---
name: homeland-critical-waterway-lock-dam-cyber-physical-continuity-cell
description: Plan military support for lock-and-dam cyber-physical disruption while preserving inland waterway throughput, life safety, and infrastructure recovery order. Use when domestic contingency operations require rapid continuity recommendations and authority-gated tasking.
---
...
Primary products for this skill: waterway continuity ladder, lock/dam restoration priority board, DSCA support tasking packet.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools for this domain: industrial control incident dashboards, inland waterway traffic systems, hydraulic safety monitors, interagency restoration planners.
...
- Include tool_suite_id=ts-homeland-critical-waterway-lock-dam-cyber-physical-continuity-cell-v1, protocol_stack_id=ps-homeland-critical-waterway-lock-dam-cyber-physical-continuity-cell-stack-v1, and packet_id=DPL-LOCK-DAM-CYBER-PHYSICAL-CONTINUITY-001 for each critical recommendation.
