---
name: coalition-contested-private-5g-mission-priority-failover-cell
description: Coordinate coalition private-5G mission-priority failover under contested spectrum and infrastructure disruption. Use when mission services must be re-prioritized across degraded coalition enclaves.
---
...
Primary products for this skill: private-5G mission-priority matrix, coalition failover branch chart, service-restoration decision log.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: private-5G policy controllers, coalition QoS arbitration services, RF contention monitors, cross-domain failover governance tools.
