---
name: fires-and-effects-synchronizer
description: Synchronize lethal and nonlethal effects across domains. Use when aligning fires, information effects, and maneuver windows to achieve commander intent.
---

# Fires And Effects Synchronizer
...
1. Frame the mission problem using these core inputs: target lists, ROE constraints, platform availability, battle rhythm windows.
...
Primary products for this skill: effects synchronization matrix, target engagement priorities, no-strike/conflict checks.
