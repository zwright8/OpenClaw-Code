---
name: battlefield-drone-forensics-and-attribution-cell
description: Exploit recovered or downed drones for attribution, supply-chain signatures, and rapid countermeasure updates. Use when drone incidents require evidence-grade technical exploitation.
---
...
1. Frame the mission problem using these core inputs: recovered drone hardware and software artifacts, RF and flight telemetry, known adversary signatures, custody chain status.
...
Primary products for this skill: drone attribution packet, exploit-to-countermeasure update board, evidence provenance ledger.
...
- Primary: `tool_suite_id=ts-drone-forensics-attribution-v1` with `protocol_stack_id=ps-drone-exploitation-evidence-stack-v1`.
