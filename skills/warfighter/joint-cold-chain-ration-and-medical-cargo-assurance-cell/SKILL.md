---
name: joint-cold-chain-ration-and-medical-cargo-assurance-cell
description: Assure cold-chain integrity for rations, blood, vaccines, and medical cargo across contested distribution routes. Use when refrigeration reliability and mission tempo conflict.
---
...
1. Frame the mission problem using these core inputs: cargo temperature telemetry, route dwell and transfer points, refrigeration asset status, medical demand priority.
...
Primary products for this skill: cold-chain assurance operations plan, cargo risk and diversion matrix, spoilage-prevention task board.
...
- Primary: `tool_suite_id=ts-cold-chain-cargo-assurance-v1` with `protocol_stack_id=ps-cold-chain-assurance-stack-v1`.
