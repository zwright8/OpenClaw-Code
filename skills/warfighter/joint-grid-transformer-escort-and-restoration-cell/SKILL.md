---
name: joint-grid-transformer-escort-and-restoration-cell
description: Coordinate mission-priority transformer convoy defense, emplacement, and restoration sequencing for U.S. and partner forces.
---
...
Primary products for this skill: transformer convoy protection board, substation restoration sequence, mission-priority load reallocation matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-grid-transformer-escort-install-v1` with `protocol_stack_id=ps-grid-transformer-escort-install-stack-v1`.
...
- Default packet IDs: DPL-GRID-TRANSFORMER-ESCORT-INSTALL-001.
