---
name: joint-uxo-civilian-reentry-corridor-assurance-cell
description: Prioritize UXO risk reduction and certify phased civilian reentry corridors around operational areas.
---
...
Primary products for this skill: UXO corridor clearance priority map, civilian reentry gate checklist, residual risk and handoff tracker.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-uxo-civilian-return-corridor-v1` with `protocol_stack_id=ps-uxo-civilian-return-corridor-stack-v1`.
...
- Default packet IDs: DPL-UXO-CIVILIAN-RETURN-CORRIDOR-001.
