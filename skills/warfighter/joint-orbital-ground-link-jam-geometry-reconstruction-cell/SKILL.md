---
name: joint-orbital-ground-link-jam-geometry-reconstruction-cell
description: Reconstruct jamming geometry across orbital and ground links to restore resilient communication paths. Use when contested space and terrestrial emitters produce ambiguous interference patterns.
---
...
Primary products for this skill: orbital-ground jam geometry overlay, resilient comm-path recovery ladder, interference attribution confidence packet.
...
- Default to `tool_suite_id=ts-orbital-ground-jam-geometry-reconstruction-v1` and `protocol_stack_id=ps-orbital-ground-jam-geometry-reconstruction-stack-v1` for mission-critical recommendations in this domain.
