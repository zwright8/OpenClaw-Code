---
name: joint-maritime-autonomous-salvage-rights-and-evidence-cell
description: Support U.S. warfighter planning and decision support for autonomous maritime salvage, evidence integrity, and legal-rights adjudication. Use when missions require uncrewed salvage sequencing, custody assurance, and coalition legal interoperability outputs.
---

# Joint Maritime Autonomous Salvage Rights and Evidence Cell
...
1. Frame the mission with these core inputs: salvage target manifests, uncrewed vessel telemetry, evidence custody requirements, coalition legal caveats.
...
Primary products: autonomous salvage sequence board, legal-rights decision matrix, evidence custody and tribunal handoff packet.

## External Tool and Protocol Requirements

- Prioritize tool families: maritime COP and salvage planning systems, autonomous surface vessel control services, digital evidence chain managers.
- Prioritize protocol/message bindings: AIS/NMEA, OGC, NATO APP-11/ADatP-3.
