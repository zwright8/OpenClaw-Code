---
name: expeditionary-radiological-smuggling-interdiction-cell
description: Support expeditionary interdiction of radiological and nuclear smuggling threats. Use when teams need rapid screening, attribution support, and containment coordination.
---
...
Primary products for this skill: radiological screening lane plan, interdiction risk priority board, containment and evidence handoff packet

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-expeditionary-radiological-smuggling-interdiction-v1 and protocol_stack_id=ps-expeditionary-radiological-smuggling-interdiction-stack-v1.
- Primary tools for this domain: portal monitor telemetry fusion, isotope signature analyzers, customs/intel watchlist correlation tools
- Required exchange protocols/formats for this domain: USMTF, NIEM, STIX/TAXII, API/JSON
