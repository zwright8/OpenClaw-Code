---
name: coalition-disaster-relief-air-bridge-integrity-cell
description: Protect coalition humanitarian air bridge integrity, slot discipline, and aid delivery assurance under disruption.
---
...
Primary products for this skill: air bridge integrity dashboard, humanitarian slot deconfliction board, aid leakage risk matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-disaster-relief-airbridge-integrity-v1` with `protocol_stack_id=ps-disaster-relief-airbridge-stack-v1`.
- Alternate: `tool_suite_id=ts-port-repair-sortie-reflow-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Default packet IDs: DPL-DISASTER-AIRBRIDGE-001.
