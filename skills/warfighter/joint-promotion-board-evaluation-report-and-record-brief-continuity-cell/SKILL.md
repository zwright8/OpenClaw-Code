...
- Add `toolchain_id=TC-PME-380`, `tool_suite_id=ts-joint-professional-military-education-school-seat-waiver-promotion-prerequisite-continuity-v1`, and `protocol_stack_id=ps-joint-professional-military-education-school-seat-waiver-promotion-prerequisite-continuity-stack-v1` when board-file trust, promotion eligibility, or command-screen timing depends on preserved PME prerequisites, waiver approval, or school-seat evidence.
- Add `toolchain_id=TC-POLY-381`, `tool_suite_id=ts-joint-security-clearance-polygraph-continuous-vetting-readiness-v1`, and `protocol_stack_id=ps-joint-security-clearance-polygraph-continuous-vetting-readiness-stack-v1` when board competitiveness or billet trust depends on current mission-access legitimacy, polygraph posture, or continuous-vetting resolution.
- Add `toolchain_id=TC-LANG-382`, `tool_suite_id=ts-joint-foreign-language-proficiency-bonus-dlpt-linguist-readiness-continuity-v1`, and `protocol_stack_id=ps-joint-foreign-language-proficiency-bonus-dlpt-linguist-readiness-continuity-stack-v1` when promotion-board confidence or assignment matching depends on current DLPT evidence, FLPB legitimacy, or linguist-readiness status.
- Add `toolchain_id=TC-BROADEN-383`, `tool_suite_id=ts-joint-advanced-civil-schooling-fellowship-broadening-assignment-continuity-v1`, and `protocol_stack_id=ps-joint-advanced-civil-schooling-fellowship-broadening-assignment-continuity-stack-v1` when broadening-assignment timing, fellowship selection, or advanced-schooling status materially changes career-timing assumptions in board or command-screen decisions.
- Add `packet_id=DPL-PME-SCHOOL-SEAT-PREREQ-001`, `packet_id=DPL-POLYGRAPH-CONTINUOUS-VETTING-001`, `packet_id=DPL-FLPB-DLPT-LINGUIST-001`, and `packet_id=DPL-ACS-FELLOWSHIP-BROADENING-001` for branches that materially alter promotion-board integrity, assignment trust, or career-timing legitimacy.
