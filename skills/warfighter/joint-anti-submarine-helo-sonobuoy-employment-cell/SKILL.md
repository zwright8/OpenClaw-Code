---
name: joint-anti-submarine-helo-sonobuoy-employment-cell
description: Plan and retask maritime patrol helicopter sonobuoy patterns for contested ASW prosecution. Use when acoustic conditions and adversary submarine behavior are changing rapidly.
---
...
Primary products for this skill: sonobuoy pattern package, acoustic confidence ladder, prosecution branch plan.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: ASW mission planner, ocean acoustic forecast models, sonobuoy inventory trackers, maritime COP.
- Preferred protocol profiles for coordination and machine exchange: AIS/NMEA, Link 16 J-series, USMTF, API/JSON.
