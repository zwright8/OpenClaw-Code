---
name: strategic-defense-fuel-refinery-cyber-physical-restart-cell
description: Support safe restart of defense-critical refineries after cyber-physical disruption. Use when fuel production continuity and industrial control integrity are both at risk.
---
...
1. Frame the mission problem with: refinery process telemetry, ICS incident status, fuel demand, safety constraints.
...
Primary products for this skill: restart decision packet, fuel continuity risk register, phased restart timeline.

## U.S. Warfighter Employment Notes

- Sequence restart actions to avoid unsafe process states while preserving operational fuel availability.
...
- For this domain, prioritize ts-refinery-cyber-physical-restart-v1 with ps-refinery-cyber-physical-restart-stack-v1.
