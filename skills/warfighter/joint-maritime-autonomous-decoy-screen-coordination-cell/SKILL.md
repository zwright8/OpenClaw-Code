---
name: joint-maritime-autonomous-decoy-screen-coordination-cell
description: Coordinate autonomous maritime decoy screens to protect high-value naval assets and convoy lanes. Use when adversary targeting pressure requires synchronized deception and threat-adaptive maneuver.
---
...
Primary products for this skill: autonomous decoy screen plan, threat-adaptive maritime deception matrix, convoy protection trigger map.
...
- Default to `tool_suite_id=ts-maritime-autonomous-decoy-screen-v1` and `protocol_stack_id=ps-maritime-autonomous-decoy-screen-stack-v1` for mission-critical recommendations in this domain.
