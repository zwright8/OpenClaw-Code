---
name: joint-space-weather-cyber-cascade-mission-risk-cell
description: Assess and contain mission risk when space-weather effects trigger cyber, timing, and network cascades across joint operations. Use when geomagnetic or solar events degrade both infrastructure and mission systems.
---
...
Primary products: space-weather cyber cascade ladder, mission-service risk matrix, commander continuity decision brief.
...
- Primary: `tool_suite_id=ts-joint-space-weather-cyber-cascade-risk-v1` with `protocol_stack_id=ps-joint-space-weather-cyber-cascade-risk-stack-v1`.
- Alternate: `tool_suite_id=ts-joint-space-weather-cyber-cascade-risk-v1` with `protocol_stack_id=ps-joint-space-weather-cyber-cascade-risk-stack-v1`.
...
- Default packet IDs: DPL-JOINT-SPACE-WEATHER-CYBER-CASCADE-RISK-001, DPL-JOINT-SPACE-WEATHER-CYBER-CASCADE-RISK-001.
