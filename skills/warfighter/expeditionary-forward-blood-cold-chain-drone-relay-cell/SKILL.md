---
name: expeditionary-forward-blood-cold-chain-drone-relay-cell
description: Sustain forward blood cold-chain integrity using autonomous drone relay under contested logistics constraints.
---
...
Primary products: blood relay viability board, cold-chain risk ladder, medical continuity packet.
...
- Primary: `tool_suite_id=ts-expeditionary-forward-blood-cold-chain-drone-relay-v1` with `protocol_stack_id=ps-expeditionary-forward-blood-cold-chain-drone-relay-stack-v1`.
...
- Default packet IDs: `DPL-EXPEDITIONARY-FORWARD-BLOOD-COLD-CHAIN-DRONE-RELAY-001`.
