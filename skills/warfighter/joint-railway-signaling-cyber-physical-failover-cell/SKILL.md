---
name: joint-railway-signaling-cyber-physical-failover-cell
description: Coordinate cyber-physical failover for military-relevant railway signaling networks. Use when signaling disruption threatens force flow and rail-dependent sustainment timing.
---
...
Primary products for this skill: rail signaling failover board, cyber-physical incident sequence log, throughput continuity forecast.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-rail-signaling-cyber-failover-v1` with `protocol_stack_id=ps-rail-signaling-cyber-failover-stack-v1`.
- Alternate: `tool_suite_id=ts-rail-bridge-recovery-v1` with `protocol_stack_id=ps-intermodal-rail-airfield-stack-v1`.
...
- Default packet IDs: DPL-RAIL-SIGNAL-FAILOVER-001.
