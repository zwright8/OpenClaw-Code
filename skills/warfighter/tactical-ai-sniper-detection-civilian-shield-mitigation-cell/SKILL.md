---
name: tactical-ai-sniper-detection-civilian-shield-mitigation-cell
description: Integrate sensor fusion and civilian-presence safeguards for sniper detection and response in complex terrain. Use when warfighters need rapid threat adjudication while minimizing civilian harm.
---

# Tactical AI-Enabled Sniper Detection and Civilian Shield Mitigation Cell
...
Primary products for this skill: sniper cue-confidence board, civilian-shield mitigation decision ladder, tactical response constraint card.
...
- Add `tool_suite_id=ts-tactical-ai-sniper-detection-civilian-shield-mitigation-v1` + `protocol_stack_id=ps-tactical-ai-sniper-detection-civilian-shield-mitigation-stack-v1` when producing critical recommendations for this mission domain.
