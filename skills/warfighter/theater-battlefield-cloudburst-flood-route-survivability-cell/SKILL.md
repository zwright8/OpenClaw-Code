---
name: theater-battlefield-cloudburst-flood-route-survivability-cell
description: Assess route survivability during battlefield cloudburst and flash-flood events. Use when mobility corridors, sustainment routes, and evacuation plans are threatened by extreme rainfall.
---
...
Primary products for this skill: flood route survivability map, movement branch trigger chart, sustainment reroute matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-cloudburst-flood-route-survivability-v1` with `protocol_stack_id=ps-cloudburst-flood-route-stack-v1`.
...
- Default packet IDs: DPL-CLOUDBURST-ROUTE-001.
