---
name: theater-joint-personnel-recovery-beacon-deception-counter-cell
description: Support joint personnel recovery when adversaries spoof, replay, or jam survivor beacons. Use when authentication uncertainty can misroute recovery forces.
---

# Theater Joint Personnel Recovery Beacon Deception Counter Cell
...
- Primary: `tool_suite_id=ts-personnel-recovery-beacon-deception-counter-v1` with `protocol_stack_id=ps-personnel-recovery-beacon-deception-counter-stack-v1`.
- Alternate: `tool_suite_id=ts-pow-mia-fusion-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Default packet IDs: DPL-PERSONNEL-RECOVERY-BEACON-DECEPTION-COUNTER-001, DPL-HR-ISR-001.
