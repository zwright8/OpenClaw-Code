---
name: joint-contested-additive-feedstock-authenticity-cell
description: Assure additive manufacturing feedstock authenticity and release authority for mission-critical parts in contested supply environments.
---

# Joint Contested Additive Feedstock Authenticity Cell
...
Primary products for this skill: feedstock authenticity confidence ledger, additive part release board, counterfeit risk escalation matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: additive quality pipelines, material spectroscopy and assay systems, provenance ledger services, maintenance release workflow tools.
...
- Prefer these protocol families for this skill: USMTF, NIEM, API/JSON, STIX/TAXII.
...
- Primary: `tool_suite_id=ts-additive-airworthiness-certification-v1` with `protocol_stack_id=ps-additive-airworthiness-certification-stack-v1`.
- Alternate: `tool_suite_id=ts-logistics-distribution-v1` with `protocol_stack_id=ps-courier-assurance-stack-v1`.
