---
name: strategic-sealift-and-prepositioning-coordinator
description: Synchronize sealift, afloat prepositioning, and port throughput for theater sustainment. Use when heavy force flow and sustainment depend on maritime lift and staging nodes.
---

# Strategic Sealift And Prepositioning Coordinator
...
1. Frame the mission problem using these core inputs: force flow requirements, vessel schedules, port capacities, cargo priority rules.
...
Primary products for this skill: sealift movement plan, prepositioning drawdown timeline, chokepoint risk list.
...
- Prioritize these tools or tool families for this domain: USTRANSCOM planning systems, port operations tools, logistics COP.
