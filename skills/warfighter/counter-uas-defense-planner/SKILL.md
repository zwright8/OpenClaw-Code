---
name: counter-uas-defense-planner
description: Plan layered defense against unmanned aerial system threats across fixed and mobile formations. Use when integrating detection, tracking, and defeat options under legal constraints.
---

# Counter-UAS Defense Planner
...
1. Frame the mission problem using these core inputs: UAS threat profile, sensor coverage, available defeat systems, ROE limits.
...
Primary products for this skill: counter-UAS defense scheme, sensor-to-shooter matrix, engagement authority card.
