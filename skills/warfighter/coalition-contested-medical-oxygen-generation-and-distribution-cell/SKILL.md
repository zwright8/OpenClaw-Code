---
name: coalition-contested-medical-oxygen-generation-and-distribution-cell
description: Plan contested production, purification, and distribution of medical oxygen across coalition care networks. Use when U.S. and partner forces require resilient oxygen supply under disruption, evacuation surge, or infrastructure loss.
---
...
Primary products for this skill: oxygen generation continuity plan, theater oxygen distribution priorities, coalition med-log oxygen risk ledger.

## Domain Tool Stack

Use these tool categories as the baseline stack: medical logistics systems, oxygen plant telemetry, evacuation coordination boards, hospital bed-status networks.

## Protocol Profile

Preferred protocol families for this skill: HL7/FHIR interoperability, USMTF medical messaging, STANAG 2132, coalition medevac coordination formats.
