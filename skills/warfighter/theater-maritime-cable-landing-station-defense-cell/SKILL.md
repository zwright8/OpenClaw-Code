---
name: theater-maritime-cable-landing-station-defense-cell
description: Protect cable landing stations that support theater battle networks and logistics coordination. Use when maritime sabotage risk threatens joint command continuity.
---
...
Primary products for this skill: landing-station defense posture brief, sabotage response matrix, comms continuity branch package.

## Domain Tool Stack

Use these tool categories as the baseline stack: undersea cable telemetry monitors, port OT security dashboards, maritime COP, incident command ledgers.

## Protocol Profile

Preferred protocol families for this skill: AIS, OGC, STIX/TAXII, IEC 62443 telemetry profiles, API/JSON.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-maritime-cable-landing-defense-v1` with `protocol_stack_id=ps-maritime-cable-landing-defense-stack-v1`.
- Alternate: `tool_suite_id=ts-undersea-battle-network-self-healing-v1` with `protocol_stack_id=ps-undersea-battle-network-self-healing-stack-v1`.
...
- Default packet IDs: DPL-MARITIME-CABLE-LANDING-DEFENSE-001, DPL-UNDERSEA-BATTLE-NETWORK-SELF-HEALING-001.
