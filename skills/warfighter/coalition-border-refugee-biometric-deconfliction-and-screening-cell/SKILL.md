---
name: coalition-border-refugee-biometric-deconfliction-and-screening-cell
description: Coordinate coalition border screening for refugee surges while preserving humanitarian law compliance, biometric deconfliction quality, and mission security. Use when commands need options that balance throughput, protection, and legal constraints with protocol-aware outputs.
---
...
Primary products for this skill: biometric deconfliction matrix, screening throughput plan, legal-compliance evidence packet.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools for this domain: biometric identity services, border intake workflow systems, watchlist adjudication queues, humanitarian case-tracking boards.
- Prioritize these protocol families for this domain: NIEM, NATO APP-11/ADatP-3 aligned, USMTF, API/JSON.
...
- Include tool_suite_id=ts-coalition-border-refugee-biometric-deconfliction-and-screening-cell-v1, protocol_stack_id=ps-coalition-border-refugee-biometric-deconfliction-and-screening-cell-stack-v1, and packet_id=DPL-COALITION-REFUGEE-BIOMETRIC-SCREENING-001 for each critical recommendation.
