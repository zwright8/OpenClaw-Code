---
name: coalition-cable-landing-data-sovereignty-cell
description: Support warfighter planning for coalition cable-landing security and sovereign data continuity under gray-zone pressure.
---

# Coalition Cable Landing Data Sovereignty Cell
...
Primary products for this skill: cable landing sovereignty brief, coalition routing releasability matrix, and sovereignty-safe continuity branch plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-coalition-cable-landing-data-sovereignty-v1` with `protocol_stack_id=ps-coalition-cable-landing-data-sovereignty-stack-v1`.
- Alternate: `tool_suite_id=ts-undersea-data-fabric-reroute-v1` with `protocol_stack_id=ps-undersea-data-fabric-reroute-stack-v1`.
...
- Default packet IDs: DPL-COALITION-CABLE-LANDING-SOVEREIGNTY-001, DPL-COALITION-DATA-RELEASABILITY-001
