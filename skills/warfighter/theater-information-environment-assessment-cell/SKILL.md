---
name: theater-information-environment-assessment-cell
description: Assess theater information environment dynamics to support commander decisions on narratives, influence risk, and adversary messaging trends. Use when integrating IO, PA, and intelligence assessments.
---
...
1. Frame the mission problem using these core inputs: audience sentiment indicators, adversary narrative activity, friendly messaging effects, and campaign objectives.
...
Primary products for this skill: information environment baseline, adversary narrative risk board, commander information effects assessment.
