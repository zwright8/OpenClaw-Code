---
name: joint-uncrewed-swarm-logistics-defense-cell
description: Support U.S. warfighter planning and decision support for Joint Uncrewed Swarm Logistics Defense Cell. Use when missions require defending sustainment corridors from autonomous swarm threats and protocol-aware staff outputs.
---
...
Primary products for this skill: swarm threat route overlay, convoy defense posture matrix, logistics continuity branch plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: counter-UxS C2 suites, convoy telemetry systems, route defense analytics boards.

## Protocol Profile

Preferred protocol families for this skill: CoT, Link 16 J-series, USMTF.
