---
name: joint-battlefield-acoustic-deception-countertargeting-cell
description: Support U.S. warfighter planning for detection and countering of adversary acoustic deception targeting fires, ISR, and maneuver forces.
---
...
Primary products for this skill: acoustic deception detection ledger, countertargeting options matrix, sensor retask decision packet.

## Domain Tool Stack

Use these tool categories by default: acoustic signature analytics, fires targeting confidence services, EW/acoustic cross-cue dashboards.

## Protocol Profile

Preferred protocol families for this skill: USMTF, STIX/TAXII, OGC, API/JSON.

## Domain Toolchain Defaults

- Primary: tool_suite_id=ts-acoustic-deception-countertargeting-v1 with protocol_stack_id=ps-acoustic-deception-countertargeting-stack-v1.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-ACOUSTIC-DECEPTION-COUNTERTARGETING-001 for critical recommendations.
