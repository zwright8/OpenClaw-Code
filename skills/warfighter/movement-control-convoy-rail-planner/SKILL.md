---
name: movement-control-convoy-rail-planner
description: Develop multimodal movement control plans for convoy and rail operations. Use when coordinating routes, protection, and throughput under contested logistics conditions.
---

# Movement Control Convoy and Rail Planner
...
1. Frame the mission problem using these core inputs: movement requirements, route status, rail availability, threat updates.
...
Primary products for this skill: movement table, route security synchronization matrix, transport risk dashboard.
