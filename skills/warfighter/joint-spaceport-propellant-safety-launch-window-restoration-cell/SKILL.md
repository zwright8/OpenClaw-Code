---
name: joint-spaceport-propellant-safety-launch-window-restoration-cell
description: Restore launch windows while enforcing propellant safety and custody controls after spaceport incidents.
---
...
Primary products: launch recovery branch board, propellant safety custody ladder, strategic release packet.
...
- Primary: `tool_suite_id=ts-joint-spaceport-propellant-safety-launch-window-restoration-v1` with `protocol_stack_id=ps-joint-spaceport-propellant-safety-launch-window-restoration-stack-v1`.
...
- Default packet IDs: `DPL-JOINT-SPACEPORT-PROPELLANT-SAFETY-LAUNCH-WINDOW-RESTORATION-001`.
