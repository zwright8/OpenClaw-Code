---
name: joint-railhead-security-and-throughput-governance-cell
description: Synchronize railhead security with throughput goals for rapid sustainment. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: railhead threat reports, cargo priority queues, security force posture, loading constraints.
...
Primary products for this skill: railhead governance plan, throughput surge options, security control matrix.
