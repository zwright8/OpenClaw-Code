---
name: theater-undersea-cable-landing-station-blackstart-defense-cell
description: Coordinate defense and blackstart restoration for undersea cable landing stations under sabotage or kinetic disruption to preserve mission communications.
---
...
Primary products: landing-station defense plan, cable restoration sequencing board, and comms continuity branch package.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-undersea-cable-landing-blackstart-defense-v1` with `protocol_stack_id=ps-undersea-cable-landing-blackstart-defense-stack-v1`.
...
- Default packet IDs: `DPL-UNDERSEA-CABLE-LANDING-BLACKSTART-001`, `DPL-CABLE-LANDING-COMMS-CONTINUITY-001`.
