...
- Add `toolchain_id=TC-PME-380`, `tool_suite_id=ts-joint-professional-military-education-school-seat-waiver-promotion-prerequisite-continuity-v1`, and `protocol_stack_id=ps-joint-professional-military-education-school-seat-waiver-promotion-prerequisite-continuity-stack-v1` when retirement or continued-service counseling depends on remaining PME obligations, waived prerequisites, or school-seat timing for mid-career decision points.
- Add `toolchain_id=TC-BROADEN-383`, `tool_suite_id=ts-joint-advanced-civil-schooling-fellowship-broadening-assignment-continuity-v1`, and `protocol_stack_id=ps-joint-advanced-civil-schooling-fellowship-broadening-assignment-continuity-stack-v1` when advanced schooling, fellowship selection, or broadening-assignment timing materially changes deliberate-retention or retirement-transition counseling.
- Add `packet_id=DPL-PME-SCHOOL-SEAT-PREREQ-001` and `packet_id=DPL-ACS-FELLOWSHIP-BROADENING-001` for branches that materially alter retirement-legitimacy, continued-service counseling, or transition-confidence.
