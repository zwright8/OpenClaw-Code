---
name: theater-hypersonic-strike-battle-damage-corroboration-cell
description: Corroborate hypersonic strike battle damage under compressed timelines and disputed sensor narratives.
---

# Theater Hypersonic Strike Battle Damage Corroboration Cell
...
Primary products for this skill: battle damage corroboration confidence board, compressed retask timeline, escalation-safe assessment matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: multi-INT ISR fusion boards, strike timeline adjudicators, geospatial damage verification systems, legal/ROE confidence ledgers.
...
- Prefer these protocol families for this skill: USMTF, Link 16 J-series, CoT, OGC WMS/WFS/WMTS, API/JSON.
...
- Primary: `tool_suite_id=ts-joint-hypersonic-warning-fusion-and-response-v1` with `protocol_stack_id=ps-joint-hypersonic-warning-fusion-and-response-stack-v1`.
