---
name: theater-disinformation-civil-alert-authenticity-cell
description: Support theater operations that must authenticate civil warning messages and counter disinformation aimed at degrading public protective actions.
---
...
Primary products for this skill: civil alert authenticity dashboard, disinformation campaign risk ladder, corrective messaging branch plan.
...
- For this domain, prioritize `ts-civil-alert-authenticity-v1` with `ps-civil-alert-authenticity-stack-v1` and `DPL-CIVIL-ALERT-AUTHENTICITY-001`.
