---
name: orbital-maneuver-and-space-control-cell
description: Support orbital maneuver planning, conjunction risk prioritization, and space control coordination for military space operations. Use when balancing survivability, mission assurance, and SATCOM/PNT continuity.
---
...
1. Frame the mission problem using these core inputs: space object ephemerides, mission thread criticality, conjunction risk metrics, and maneuver windows.
...
Primary products for this skill: orbital maneuver decision matrix, conjunction mitigation plan, mission thread continuity package.
