---
name: joint-denied-environment-3d-terrain-model-refresh-cell
description: Support U.S. warfighter planning for rapid 3D terrain model refresh in denied or disconnected theaters. Use when stale terrain data increases maneuver, fires, or aviation risk.
---
...
Primary products for this skill: terrain freshness risk board, prioritized model-refresh queue, maneuver impact delta brief.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-intel-fusion-v1` with `protocol_stack_id=ps-geo-mission-sharing-stack-v1`.
...
- Preferred tools: GEOINT exploitation stacks, offline geospatial processing pipelines, terrain mesh validation services, mission map package distributors.
- Preferred protocol families: OGC, CoT, USMTF.
...
- Default packet IDs: DPL-RAILPORT-001, DPL-ARCTIC-PREPO-001.
