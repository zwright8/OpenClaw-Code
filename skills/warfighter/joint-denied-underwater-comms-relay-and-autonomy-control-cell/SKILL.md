---
name: joint-denied-underwater-comms-relay-and-autonomy-control-cell
description: Coordinate denied-environment underwater communications relay and autonomous control continuity for joint maritime operations. Use when subsea links are degraded and commanders need assured autonomy supervision and tasking updates.
---
...
Primary products for this skill: underwater comms continuity board, autonomy control fallback tree, subsea relay recovery sequence.
...
- Add `tool_suite_id=ts-denied-underwater-comms-autonomy-control-v1` + `protocol_stack_id=ps-denied-underwater-comms-autonomy-control-stack-v1` when producing critical recommendations for this mission domain.
