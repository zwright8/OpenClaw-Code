---
name: contested-theater-courier-network-and-physical-message-assurance-cell
description: Design resilient courier and physical-message assurance pathways when digital transport is denied or compromised. Use when command-critical message custody and timing must survive cyber/electromagnetic disruption.
---
...
1. Frame the mission problem using these core inputs: message priority tiers, denied-network conditions, courier route security, custody chain requirements, and acknowledgment timing.
...
Primary products for this skill: courier network route plan, physical message custody SOP, delayed-ack risk register.
...
- Primary: `tool_suite_id=ts-physical-message-assurance-v1` with `protocol_stack_id=ps-courier-assurance-stack-v1`.
