---
name: strategic-homeland-rail-port-mobilization-recovery-cell
description: Support U.S. warfighter planning and decision support for Strategic Homeland Rail Port Mobilization Recovery Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: rail-port mobilization recovery dashboard, throughput restoration decision matrix, strategic movement branch triggers.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: rail network status systems, port throughput orchestration tools, industrial restoration and convoy planners.

## Protocol Profile

Preferred protocol families for this skill: USMTF, NIMS/ICS, OGC WMS/WFS/WMTS, API/JSON.
