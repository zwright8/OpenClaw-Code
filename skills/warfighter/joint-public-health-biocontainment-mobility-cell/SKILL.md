---
name: joint-public-health-biocontainment-mobility-cell
description: Plan biocontainment transport and movement corridors for infectious cases without collapsing operational tempo. Use when synchronizing evacuation, isolation, and receiving-facility capacity.
---
...
1. Frame the mission problem using these core inputs: infectious case status, transport platform availability, isolation bed capacity, route and host-nation constraints.
...
Primary products for this skill: biocontainment evacuation flow plan, corridor deconfliction matrix, receiving-node load forecast.
