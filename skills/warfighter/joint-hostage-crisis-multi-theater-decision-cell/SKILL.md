---
name: joint-hostage-crisis-multi-theater-decision-cell
description: Support U.S. warfighter planning and decision support for Joint Hostage Crisis Multi Theater Decision Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: multi-theater hostage decision matrix, recovery branch synchronization board, policy-legal escalation packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: personnel recovery management systems, ISR fusion tasking boards, legal-policy adjudication workflows.

## Protocol Profile

Preferred protocol families for this skill: USMTF, VMF, STIX/TAXII.
