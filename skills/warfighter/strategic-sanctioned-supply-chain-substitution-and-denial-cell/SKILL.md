---
name: strategic-sanctioned-supply-chain-substitution-and-denial-cell
description: Design sanctioned-component substitution strategies while denying adversary access to dual-use military supply chains.
---
...
Primary products for this skill: sanctioned supply substitution roadmap, denial enforcement campaign matrix, strategic industrial risk dashboard.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-sanctioned-supply-substitution-denial-v1` with `protocol_stack_id=ps-sanctioned-supply-substitution-denial-stack-v1`.
- Alternate: `tool_suite_id=ts-joint-c2-fusion-v1` with `protocol_stack_id=ps-joint-c2-fusion-stack-v1`.
...
- Default packet IDs: DPL-SANCTIONED-SUPPLY-SUBSTITUTION-DENIAL-001.
