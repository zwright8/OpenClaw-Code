---
name: coalition-ai-targeting-policy-explainability-and-audit-cell
description: Audit coalition AI-assisted targeting recommendations for policy compliance, explainability, and accountable release decisions.
---
...
Primary products: targeting explainability report, policy exception queue, coalition release audit packet.
...
- Primary: `tool_suite_id=ts-coalition-ai-targeting-policy-explainability-audit-v1` with `protocol_stack_id=ps-coalition-ai-targeting-policy-explainability-audit-stack-v1`.
...
- Default packet IDs: `DPL-COALITION-AI-TARGETING-EXPLAINABILITY-AUDIT-001`.
