---
name: joint-ai-enabled-sar-satellite-imagery-deception-detection-cell
description: Detect synthetic or manipulated SAR satellite imagery and protect targeting and ISR decisions from deception-driven error.
---
...
Primary products: imagery deception confidence report, target trust and hold/release table, and retask prioritization queue.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-ai-sar-imagery-deception-detection-v1` with `protocol_stack_id=ps-ai-sar-imagery-deception-detection-stack-v1`.
...
- Default packet IDs: `DPL-AI-SAR-IMAGERY-DECEPTION-DETECTION-001`, `DPL-SAR-TARGET-TRUST-RETASK-001`.
