---
name: forward-deployed-blood-supply-cold-chain-optimizer
description: Support U.S. warfighter planning and operational decision support for Forward Deployed Blood Supply Cold Chain Optimizer scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---

# Forward Deployed Blood Supply Cold Chain Optimizer
...
Primary products for this skill: blood inventory risk board, cold chain continuity matrix, evacuation-linked resupply plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: medical logistics systems, cold-chain telemetry platforms, patient regulation systems, airbridge schedulers.
...
- Prefer these protocol families for this skill: HL7/FHIR, API/JSON, USMTF.
