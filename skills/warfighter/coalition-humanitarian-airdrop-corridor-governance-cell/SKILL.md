---
name: coalition-humanitarian-airdrop-corridor-governance-cell
description: Govern coalition humanitarian airdrop corridors balancing civilian safety, access equity, and military deconfliction. Use when air-delivered aid must be synchronized across contested or denied regions.
---
...
1. Frame the mission problem using these core inputs: humanitarian demand clusters, airspace deconfliction status, drop-zone integrity, coalition ROE/releasability rules, and threat indicators.
...
Primary products for this skill: airdrop corridor governance order, drop-zone risk prioritization matrix, coalition coordination timeline.
...
- Primary: `tool_suite_id=ts-humanitarian-airdrop-corridor-v1` with `protocol_stack_id=ps-humanitarian-airdrop-stack-v1`.
- Alternate: `tool_suite_id=ts-civil-support-v1` with `protocol_stack_id=ps-nato-coalition-stack-v1`.
