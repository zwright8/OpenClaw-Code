---
name: theater-civil-gridload-blackstart-fuel-priority-cell
description: Support U.S. warfighter theater-level civil gridload and blackstart fuel-priority planning. Use when mission and civil critical loads must be sequenced after major disruption.
---
...
Primary products for this skill: critical-load restoration map, fuel-priority matrix, blackstart branch timeline.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-gridload-blackstart-fuel-v1` with `protocol_stack_id=ps-gridload-blackstart-fuel-stack-v1`.
- Alternate: `tool_suite_id=ts-emp-cascade-consequence-v1` with `protocol_stack_id=ps-engineering-repair-prioritization-stack-v1`.
...
- Default packet IDs: DPL-GRID-BLACKSTART-001, DPL-ENG-REPAIR-001.
