---
name: multi-domain-kill-chain-clock-synchronization-cell
description: Maintain timing coherence across sensor, C2, and shooter systems to protect kill-chain effectiveness under PNT disruption.
---
...
Primary products for this skill: timing integrity status board, sync-recovery sequence, kill-chain latency risk report.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: timing assurance monitors, PNT integrity tools, data-link latency analytics, C2 event correlation boards.
- Preferred protocol profiles for coordination and machine exchange: USMTF, Link 16 J-series, PTP/NTP profiles, API/JSON.
