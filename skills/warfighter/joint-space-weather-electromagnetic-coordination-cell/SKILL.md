---
name: joint-space-weather-electromagnetic-coordination-cell
description: Coordinate joint planning for coupled space-weather and EMS impacts on mission systems. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: solar/geomagnetic forecast feeds, spectrum dependency map, mission timeline, platform vulnerability profiles.
...
Primary products for this skill: space-weather/EMS impact matrix, mitigation recommendations, timing windows.
