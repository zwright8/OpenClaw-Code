---
name: joint-electronic-warfare-spectrum-leasing-and-priority-cell
description: Support U.S. warfighter planning and decision support for Joint Electronic Warfare Spectrum Leasing and Priority Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: spectrum leasing adjudication board, mission-priority emission timeline, interference branch packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: spectrum assignment services, EW mission-data managers, RF conflict adjudication dashboards.
