---
name: theater-energy-microgrid-resilience-cell
description: Protect and restore base and civil-support microgrids with fuel, generation, and load-shedding decision support.
---

# Theater Energy Microgrid Resilience Cell
...
Primary products for this skill: microgrid continuity plan, blackstart sequence card, mission-load shedding matrix.
...
- Suggested tools: SCADA historians, PMU telemetry, fuel inventory systems, utility outage feeds, weather and wildfire models.
- Protocol/message standards: IEC 61850, DNP3, Modbus/TCP, CIM.
