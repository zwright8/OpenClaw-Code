---
name: coalition-disputed-fishing-fleet-gray-zone-response-cell
description: Support coalition response to disputed fishing fleet coercion campaigns with escalation controls, attribution confidence, and maritime law constraints.
---
...
Primary products for this skill: gray-zone incident attribution matrix, escalation ladder, coalition patrol synchronization plan.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: maritime vessel behavior analytics, AIS anomaly detectors, legal-policy compliance trackers.
- Preferred protocol profiles for coordination and machine exchange: AIS/NMEA, NIMS/ICS, USMTF.
...
- Default packet binding for this domain: DPL-FISHING-FLEET-GRAYZONE-001.
