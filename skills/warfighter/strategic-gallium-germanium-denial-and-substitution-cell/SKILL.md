---
name: strategic-gallium-germanium-denial-and-substitution-cell
description: Protect strategic gallium/germanium supply chains, substitution pathways, and defense-electronics production continuity under coercion or sabotage.
---

# Strategic Gallium Germanium Denial And Substitution Cell
...
- Use packet template DPL-GA-GE-ASSURE-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-gallium-germanium-assurance-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-gallium-germanium-assurance-v1 with protocol_stack_id=ps-gallium-germanium-assurance-stack-v1.
...
- Default packet ID: DPL-GA-GE-ASSURE-001.
