---
name: contested-medical-telemetry-and-remote-triage
description: Coordinate remote triage and medical telemetry in communications-degraded combat environments. Use when routing casualties and specialist support under contested conditions.
---
...
1. Frame the mission problem using these core inputs: casualty status feeds, available medevac routes, clinical specialty availability, and comms reliability.
...
Primary products for this skill: remote triage prioritization board, contested med-regulation flow, telemedicine fallback plan.
