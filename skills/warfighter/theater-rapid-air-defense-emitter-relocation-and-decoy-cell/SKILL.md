---
name: theater-rapid-air-defense-emitter-relocation-and-decoy-cell
description: Optimize rapid emitter relocation and decoy employment for air and missile defense survivability under adversary targeting pressure.
---

# Theater Rapid Air Defense Emitter Relocation And Decoy Cell
...
- Use packet template DPL-ADA-EMITTER-RELOCATION-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-air-defense-emitter-relocation-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-air-defense-emitter-relocation-v1 with protocol_stack_id=ps-air-defense-emitter-relocation-stack-v1.
...
- Default packet ID: DPL-ADA-EMITTER-RELOCATION-001.
