---
name: theater-denied-additive-feedstock-provenance-and-substitution-cell
description: Assure additive manufacturing feedstock integrity, provenance, and substitution policy in disconnected logistics environments.
---
...
Primary products for this skill: feedstock integrity risk ledger, substitution approval decision matrix, additive production continuity tracker.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-additive-feedstock-provenance-v1` with `protocol_stack_id=ps-additive-feedstock-provenance-stack-v1`.
...
- Default packet IDs: DPL-ADDITIVE-FEEDSTOCK-PROVENANCE-001.
