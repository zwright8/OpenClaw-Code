---
name: joint-climate-security-instability-operations-cell
description: Support U.S. warfighter planning and operational decision support for Joint Climate Security Instability Operations Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: climate forecasts, instability indicators, force posture data, campaign objectives.
...
Primary products for this skill: climate-instability operational impact brief, risk-trigger matrix, contingency action synchronization board.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: climate hazard analytics, civil instability indicators, logistics readiness systems, campaign planning tools.
