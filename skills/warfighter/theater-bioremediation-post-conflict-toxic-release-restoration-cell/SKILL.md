---
name: theater-bioremediation-post-conflict-toxic-release-restoration-cell
description: Support warfighter and civil restoration planning for post-conflict toxic release containment and bioremediation sequencing.
---

# Theater Bioremediation Post-Conflict Toxic Release Restoration Cell
...
- Primary: `tool_suite_id=ts-theater-bioremediation-toxic-release-restoration-v1` with `protocol_stack_id=ps-theater-bioremediation-toxic-release-restoration-stack-v1`.
- Alternate: `tool_suite_id=ts-cbrn-consequence-v1` with `protocol_stack_id=ps-cbrn-consequence-management-stack-v1`.
...
- Default packet IDs: DPL-THEATER-BIOREMEDIATION-TOXIC-RESTORATION-001, DPL-CEMA-BDA-001.
