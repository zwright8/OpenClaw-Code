...
- Primary: `tool_suite_id=ts-coalition-hospital-microgrid-blackstart-v1` with `protocol_stack_id=ps-coalition-hospital-microgrid-blackstart-stack-v1`.
...
- Default packet IDs: `DPL-HOSPITAL-MICROGRID-BLACKSTART-001`, `DPL-HOSPITAL-TRIAGE-POWER-PRIORITY-001`.
