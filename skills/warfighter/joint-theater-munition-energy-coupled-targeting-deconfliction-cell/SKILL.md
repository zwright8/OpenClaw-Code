---
name: joint-theater-munition-energy-coupled-targeting-deconfliction-cell
description: Synchronize munition and directed-energy allocation across joint theaters. Use when commanders must deconflict scarce kinetic and non-kinetic effects across simultaneous operations.
---

# Joint Theater Munition-Energy Coupled Targeting Deconfliction Cell
...
Primary products for this skill: cross-theater effects allocation matrix, munition-energy conflict ledger, authority-gated retask plan.
...
- Prioritize these tool families for this domain: JADOCS/TBMCS, AOC mission planning tools, directed-energy readiness telemetry, logistics ERP munitions visibility.
- Prioritize these protocol families for this domain: USMTF, Link 16 J-series, VMF.
