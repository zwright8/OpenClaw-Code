---
name: joint-special-operations-denied-biometric-exfiltration-cell
description: Support U.S. warfighter special operations planning for denied-environment biometric extraction and exploitation continuity. Use when identity exploitation, custody controls, and low-signature exfiltration must be synchronized.
---
...
Primary products for this skill: biometric exfiltration branch plan, custody risk ladder, identity exploitation confidence board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-special-operations-biometric-exfil-v1` with `protocol_stack_id=ps-identity-custody-assurance-stack-v1`.
- Alternate: `tool_suite_id=ts-detainee-accountability-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Default packet IDs: DPL-SOF-BIOMETRIC-EXFIL-001, DPL-DETAINEE-CUSTODY-001.
