---
name: joint-denied-weather-sensor-reseeding-and-forecast-assurance-cell
description: Reconstitute weather sensing in denied environments and restore forecast confidence for operations. Use when contested ISR or jamming degrades theater weather decision support.
---
...
Primary products for this skill: sensor reseed plan, forecast confidence ladder, and sortie-risk update packet.
...
- Bind recommendations to tool_suite_id=ts-joint-denied-weather-sensor-reseeding-and-forecast-assurance-cell-v1 and protocol_stack_id=ps-joint-denied-weather-sensor-reseeding-and-forecast-assurance-cell-stack-v1.
- Use packet templates in ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-DENIED-WEATHER-SENSOR-RESEED-001 for critical recommendations.
