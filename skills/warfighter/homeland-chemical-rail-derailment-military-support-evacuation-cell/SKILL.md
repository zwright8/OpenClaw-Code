---
name: homeland-chemical-rail-derailment-military-support-evacuation-cell
description: Coordinate military support to chemical rail derailment evacuation, decontamination, and mobility restoration operations.
---
...
Primary products: hazard and evacuation confidence board, military support task matrix, civil continuity restoration packet.
...
- Primary: `tool_suite_id=ts-homeland-chemical-rail-derailment-support-evacuation-v1` with `protocol_stack_id=ps-homeland-chemical-rail-derailment-support-evacuation-stack-v1`.
...
- Default packet IDs: `DPL-HOMELAND-CHEMICAL-RAIL-DERAILMENT-EVAC-001`.
