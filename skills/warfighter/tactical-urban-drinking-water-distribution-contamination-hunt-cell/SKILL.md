---
name: tactical-urban-drinking-water-distribution-contamination-hunt-cell
description: Detect, isolate, and mitigate deliberate contamination in urban water distribution networks that support military and civil populations.
---

# Tactical Urban Drinking Water Distribution Contamination Hunt Cell
...
- Use packet template DPL-URBAN-WATER-CONTAM-HUNT-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-urban-water-contamination-hunt-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-urban-water-contamination-hunt-v1 with protocol_stack_id=ps-urban-water-contamination-hunt-stack-v1.
...
- Default packet ID: DPL-URBAN-WATER-CONTAM-HUNT-001.
