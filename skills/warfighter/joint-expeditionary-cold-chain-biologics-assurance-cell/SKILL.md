---
name: joint-expeditionary-cold-chain-biologics-assurance-cell
description: Assure biologics, blood, and vaccine cold-chain integrity during contested expeditionary operations and re-supply.
---
...
Primary products: cold-chain risk map, biologics diversion and salvage matrix, mission-impact forecast, and restoration action ledger.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-expeditionary-biologics-cold-chain-assurance-v1` with `protocol_stack_id=ps-expeditionary-biologics-cold-chain-assurance-stack-v1`.
...
- Default packet IDs: DPL-BIOLOGICS-COLD-CHAIN-ASSURANCE-001, DPL-COLD-CHAIN-DIVERSION-001.
