---
name: strategic-space-weather-pnt-compensation-and-time-transfer-cell
description: Coordinate resilient PNT compensation and precision time transfer during severe space-weather disruption windows. Use when warfighters require assured timing and navigation continuity under solar disturbance.
---
...
Primary products for this skill: space-weather PNT compensation board, timing transfer assurance ledger, mission-time deferral branch chart.
...
- Add `tool_suite_id=ts-strategic-space-weather-pnt-time-transfer-v1` + `protocol_stack_id=ps-strategic-space-weather-pnt-time-transfer-stack-v1` when producing critical recommendations for this mission domain.
