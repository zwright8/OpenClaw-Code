---
name: coalition-military-rail-gauge-interoperability-cell
description: Support U.S. warfighter planning and decision support for Coalition Military Rail Gauge Interoperability Cell. Use when missions require Coalition Military Rail Gauge Interoperability Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: gauge-transition throughput plan, transload node prioritization board, coalition rail waiver packet.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: rail network planners, cargo transfer scheduling tools, coalition customs workflow systems.
- Prioritize these protocol families for this domain: NATO APP-11/ADatP-3 aligned, USMTF, API/JSON.
