---
name: air-defense-early-warning-battle-management
description: Coordinate early warning, track prioritization, and engagement sequencing for layered air defense operations. Use when fusing sensor reports, assigning interceptors, and deconflicting defensive fires.
---
...
1. Frame the mission problem using these core inputs: integrated sensor tracks, defended-asset list, interceptor availability, and engagement authorities.
...
Primary products for this skill: raid timeline and prioritization board, defended-asset engagement matrix, interceptor allocation branch plan.
