---
name: joint-coastal-tsunami-early-warning-and-force-protection-cell
description: Integrate tsunami warning intelligence with force-protection and base continuity actions for coastal and littoral forces. Use when seismic or undersea events threaten ports, airfields, and expeditionary nodes.
---
...
1. Frame the mission problem using these core inputs: seismic warning feeds, coastal base exposure maps, evacuation route status, mission-critical asset locations, and host-nation alert posture.
...
Primary products for this skill: coastal force-protection trigger matrix, phased relocation timeline, mission-continuity branch plan.
...
- Primary: `tool_suite_id=ts-coastal-hazard-protection-v1` with `protocol_stack_id=ps-hazard-warning-stack-v1`.
