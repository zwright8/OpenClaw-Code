---
name: joint-unmanned-ground-convoy-contested-bridge-negotiation-cell
description: Plan unmanned ground convoy routing, bridge crossing risk, and recovery branches across contested mobility corridors. Use when warfighters need high-confidence convoy mobility with limited manned exposure.
---
...
Primary products for this skill: unmanned convoy crossing decision board, contested bridge load-risk ledger, mobility recovery branch card.
...
- Add `tool_suite_id=ts-joint-unmanned-ground-convoy-bridge-negotiation-v1` + `protocol_stack_id=ps-joint-unmanned-ground-convoy-bridge-negotiation-stack-v1` when producing critical recommendations for this mission domain.
