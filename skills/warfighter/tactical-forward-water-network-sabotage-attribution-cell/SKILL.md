---
name: tactical-forward-water-network-sabotage-attribution-cell
description: Support warfighter planning for forward water network sabotage detection, attribution, and continuity of potable supply under attack.
---
...
- Alternate: `tool_suite_id=ts-port-desalination-brine-output-assurance-v1` with `protocol_stack_id=ps-port-desalination-brine-output-assurance-stack-v1`.
...
- Default packet IDs: DPL-FWD-WATER-SABOTAGE-001, DPL-WATER-OUTPUT-ASSURANCE-001.
