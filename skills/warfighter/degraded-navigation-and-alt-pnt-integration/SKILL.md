---
name: degraded-navigation-and-alt-pnt-integration
description: Integrate alternate PNT methods and degraded navigation procedures when GPS is denied or unreliable. Use when preserving maneuver, fires, and logistics precision under navwar conditions.
---
...
1. Frame the mission problem using these core inputs: PNT degradation indicators, alternate navigation assets, mission precision requirements, and platform constraints.
...
Primary products for this skill: alternate PNT architecture plan, navigation degradation decision tree, precision mission continuity matrix.
