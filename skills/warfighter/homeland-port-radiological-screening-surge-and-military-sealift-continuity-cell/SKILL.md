---
name: homeland-port-radiological-screening-surge-and-military-sealift-continuity-cell
description: Support U.S. warfighter planning for Homeland Port Radiological Screening Surge and Military Sealift Continuity Cell.
---
...
Use these tool categories by default: port radiological screening orchestrators, military sealift prioritization boards, and customs-security throughput synchronizers.

## Protocol Profile

Preferred protocol families for this skill: NIMS/ICS, USMTF, NIEM, AIS/NMEA, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-HOMELAND-PORT-RADIOLOGICAL-SCREENING-SURGE-MILITARY-SEALIFT-CONTINUITY-001 for critical recommendations.
