---
name: joint-battlefield-quantum-sensor-validation-cell
description: Support U.S. warfighter planning and operational decision support for Joint Battlefield Quantum Sensor Validation Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: sensor outputs, calibration records, threat emitter libraries, mission confidence thresholds.
...
Primary products for this skill: sensor reliability scoreboard, anomaly adjudication packet, deployment confidence brief.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: sensor fusion platforms, EW analytics tools, model assurance dashboards, mission data fabric monitors.
