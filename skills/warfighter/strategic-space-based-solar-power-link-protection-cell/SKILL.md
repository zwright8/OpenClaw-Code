---
name: strategic-space-based-solar-power-link-protection-cell
description: Assess and protect strategic space-based power transmission links that support expeditionary grids and mission systems. Use when orbital power relay degradation could cascade into joint operational energy failure.
---

# Strategic Space-Based Solar Power Link Protection Cell
...
- Use packet template DPL-SBSP-LINK-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-space-power-link-protection-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-space-power-link-protection-v1 with protocol_stack_id=ps-joint-tactical-link-stack-v1.
...
- Default packet ID: DPL-SBSP-LINK-001.
