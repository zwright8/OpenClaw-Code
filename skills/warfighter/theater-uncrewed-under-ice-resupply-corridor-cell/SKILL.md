---
name: theater-uncrewed-under-ice-resupply-corridor-cell
description: Plan and govern uncrewed under-ice logistics corridors for high-risk resupply when surface routes are denied.
---
...
Primary products for this skill: under-ice corridor viability assessment, uncrewed resupply risk matrix, contingency retrieval branch plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-under-ice-uncrewed-resupply-v1` with `protocol_stack_id=ps-under-ice-uncrewed-resupply-stack-v1`.
...
- Default packet IDs: DPL-UNDER-ICE-UNCREWED-RESUPPLY-001.
