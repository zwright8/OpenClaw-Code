---
name: coalition-legal-autonomous-weapons-incident-investigation-cell
description: Coordinate coalition legal investigation workflows for autonomous-weapon incidents with evidence-grade forensic integrity.
---
...
Primary products: incident legal triage matrix, forensic custody ladder, coalition investigation authority packet.
...
- Primary: `tool_suite_id=ts-coalition-legal-autonomous-weapons-incident-investigation-v1` with `protocol_stack_id=ps-coalition-legal-autonomous-weapons-incident-investigation-stack-v1`.
...
- Default packet IDs: `DPL-COALITION-LEGAL-AUTONOMOUS-WEAPONS-INCIDENT-INVESTIGATION-001`.
