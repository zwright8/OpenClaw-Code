...
description: Adjudicate coupled fuel-energy-water anomalies across coalition operations and civil-support dependencies. Use when cascading infrastructure shocks threaten mission continuity.
---
...
Primary products for this skill: nexus anomaly adjudication board, cascade-risk trigger ladder, and coalition mitigation task matrix.
...
- Bind recommendations to tool_suite_id=ts-coalition-fuel-energy-water-nexus-anomaly-adjudication-cell-v1 and protocol_stack_id=ps-coalition-fuel-energy-water-nexus-anomaly-adjudication-cell-stack-v1.
- Use packet templates in ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-FEW-NEXUS-ANOMALY-001 for critical recommendations.
