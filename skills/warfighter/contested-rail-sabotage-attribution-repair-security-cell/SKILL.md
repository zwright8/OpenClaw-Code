---
name: contested-rail-sabotage-attribution-repair-security-cell
description: Support U.S. warfighter planning for rail sabotage attribution, repair sequencing, and throughput security in contested theaters. Use when rail sustainment routes face repeated disruption.
---
...
Primary products for this skill: rail sabotage attribution board, repair-security sequence order, throughput recovery forecast.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: rail telemetry systems, infrastructure forensics tools, movement-control dashboards.
- Preferred protocol profile for machine and staff exchange: USMTF + API/JSON + OGC.
- Default tool suite binding: `tool_suite_id=ts-rail-sabotage-repair-security-v1`.
- Default protocol stack binding: `protocol_stack_id=ps-rail-repair-security-stack-v1`.
- Default packet binding: `packet_id=DPL-RAIL-SABOTAGE-001`.
