---
name: contested-pnt-assurance-and-time-transfer-cell
description: Preserve precision navigation and timing assurance with resilient time transfer under GNSS denial, spoofing, and jamming pressure.
---
...
- Use packet template DPL-PNT-TIME-TRANSFER-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-contested-pnt-time-transfer-assurance-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-contested-pnt-time-transfer-assurance-v1 with protocol_stack_id=ps-contested-pnt-time-transfer-stack-v1.
...
- Default packet ID: DPL-PNT-TIME-TRANSFER-001.
