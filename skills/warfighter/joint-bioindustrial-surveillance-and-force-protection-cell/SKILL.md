---
name: joint-bioindustrial-surveillance-and-force-protection-cell
description: Fuse bioindustrial and epidemiological signals into force-protection actions. Use when military formations face dual-use biotech, outbreak, or contamination risks.
---
...
Primary products for this skill: bioindustrial risk board, force-health protective posture matrix, outbreak trigger ladder.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-biosecurity-lab-incident-v1` with `protocol_stack_id=ps-biosecurity-response-stack-v1`.
- Alternate: `tool_suite_id=ts-medical-force-health-v1` with `protocol_stack_id=ps-medical-evacuation-stack-v1`.
