---
name: homeland-wildfire-smoke-airbase-sortie-continuity-cell
description: Support homeland defense and DSCA-aligned warfighter planning for sustaining sortie generation under wildfire smoke, infrastructure disruption, and civilian airspace contention.
---
...
Primary products for this skill: smoke-informed sortie continuity plan, runway and airspace risk matrix, civil-military air task deconfliction board.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: wildfire and smoke dispersion forecast tools, base infrastructure status trackers, sortie generation planners, civil aviation coordination dashboards.
...
- Prefer these protocol families for this skill: AIXM/FIXM, NIMS/ICS, USMTF, OGC.
