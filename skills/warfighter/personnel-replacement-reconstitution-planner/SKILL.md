---
name: personnel-replacement-reconstitution-planner
description: Plan personnel replacement and unit reconstitution actions after combat losses or prolonged operations. Use when restoring combat effectiveness under time and resource pressure.
---

# Personnel Replacement and Reconstitution Planner
...
1. Frame the mission problem using these core inputs: casualty rates, unit readiness status, replacement pipeline, training requirements.
...
Primary products for this skill: reconstitution decision support brief, personnel fill plan, readiness recovery timeline.
