---
name: coalition-border-refugee-biometric-deconfliction-and-insider-risk-screening-cell
description: Support U.S. warfighter planning for Coalition Border Refugee Biometric Deconfliction and Insider-Risk Screening Cell.
---
...
Use these tool categories by default: refugee identity reconciliation boards, coalition biometric trust scorers, and insider-risk triage workflows.

## Protocol Profile

Preferred protocol families for this skill: NIEM, USMTF, NATO APP-11/ADatP-3 aligned, EDXL-DE/CAP, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-COALITION-BORDER-REFUGEE-BIOMETRIC-DECONFLICTION-INSIDER-RISK-SCREENING-001 for critical recommendations.
