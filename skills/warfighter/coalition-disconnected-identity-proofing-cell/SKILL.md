---
name: coalition-disconnected-identity-proofing-cell
description: Support U.S. warfighter planning and operational decision support for Coalition Disconnected Identity Proofing Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: identity records, coalition trust policies, credential state, network availability.
...
Primary products for this skill: offline identity proofing SOP, coalition trust chain matrix, access restoration transition plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: identity governance platforms, PKI management systems, disconnected credential tools, audit log analyzers.
...
- Prefer these protocol families for this skill: API/JSON, NATO APP-11, USMTF.
