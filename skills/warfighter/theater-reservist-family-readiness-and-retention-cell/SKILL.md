---
name: theater-reservist-family-readiness-and-retention-cell
description: Support theater-level planning for reserve-component family readiness, stress risk mitigation, and retention stabilization during prolonged operations.
---
...
Primary products for this skill: family readiness stress board, retention risk ladder, support resource allocation matrix.
...
- For this domain, prioritize `ts-reservist-family-retention-readiness-v1` with `ps-reservist-family-retention-readiness-stack-v1` and `DPL-RESERVIST-FAMILY-RETENTION-READINESS-001`.
