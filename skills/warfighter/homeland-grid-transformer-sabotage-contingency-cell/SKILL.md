---
name: homeland-grid-transformer-sabotage-contingency-cell
description: Support homeland defense response to coordinated transformer sabotage affecting military installation power. Use when grid restoration and mission continuity need synchronized defense-civil action.
---

# Homeland Grid Transformer Sabotage Contingency Cell
...
- Use packet template DPL-GRID-TRANSFORMER-SABOTAGE-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-grid-transformer-sabotage-contingency-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-grid-transformer-sabotage-contingency-v1 with protocol_stack_id=ps-grid-transformer-sabotage-stack-v1.
...
- Default packet ID: DPL-GRID-TRANSFORMER-SABOTAGE-001.
