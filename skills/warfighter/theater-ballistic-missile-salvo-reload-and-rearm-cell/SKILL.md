---
name: theater-ballistic-missile-salvo-reload-and-rearm-cell
description: Optimize ballistic and cruise missile defense reload/rearm sequencing during sustained salvo campaigns. Use when interceptor inventories and launcher availability drive theater risk.
---
...
Primary products for this skill: interceptor expenditure forecast, reload/rearm priority matrix, defended-asset risk timeline.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: IAMD battle manager, launcher status telemetry, munitions readiness ledgers, convoy movement trackers.
- Preferred protocol profiles for coordination and machine exchange: USMTF, Link 16 J-series, VMF, API/JSON.
