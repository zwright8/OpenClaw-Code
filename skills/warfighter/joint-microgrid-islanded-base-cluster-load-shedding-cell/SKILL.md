---
name: joint-microgrid-islanded-base-cluster-load-shedding-cell
description: Optimize islanded military-base cluster power posture under contested generation, storage, and fuel constraints.
---
...
Primary products: critical load shedding matrix, islanded power synchronization board, base continuity release packet.
...
- Primary: `tool_suite_id=ts-joint-microgrid-islanded-base-load-shedding-v1` with `protocol_stack_id=ps-joint-microgrid-islanded-base-load-shedding-stack-v1`.
...
- Default packet IDs: `DPL-JOINT-MICROGRID-ISLANDED-LOAD-001`, `DPL-JOINT-MICROGRID-ISLANDED-LOAD-002`.
