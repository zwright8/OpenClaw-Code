---
name: theater-prison-facility-overrun-contingency-cell
description: Prepare theater responses for prison overrun scenarios with detainee accountability, force protection, and legal controls.
---
...
Primary products for this skill: prison overrun contingency plan, detainee accountability branch, rapid stabilization task board.
...
- `tool_suite_id`: `ts-prison-overrun-contingency-v1`
- `protocol_stack_id`: `ps-prison-overrun-contingency-stack-v1`
