---
name: strategic-food-cold-storage-grid-denial-continuity-cell
description: Support strategic continuity planning for military and dual-use food cold-storage networks during long-duration grid disruption or fuel denial.
---
...
Primary products for this skill: cold-storage continuity map, spoilage-risk priority ladder, sustainment reroute branch matrix.
...
- For this domain, prioritize `ts-food-cold-storage-grid-denial-v1` with `ps-food-cold-storage-grid-denial-stack-v1` and `DPL-FOOD-COLD-STORAGE-GRID-DENIAL-001`.
