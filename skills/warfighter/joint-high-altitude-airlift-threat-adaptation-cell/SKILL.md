---
name: joint-high-altitude-airlift-threat-adaptation-cell
description: Adapt high-altitude airlift routes and timings to evolving threats. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: airlift mission schedule, threat envelopes, airspace constraints, alternate basing options.
...
Primary products for this skill: airlift threat-adaptation plan, route/time deconfliction matrix, commander decision prompts.
