---
name: tactical-rapid-materiel-authentication-counterfeit-shield-cell
description: Detect counterfeit and tampered parts before tactical fielding. Use when mission systems rely on rapid verification of critical spares and electronics.
---

# Tactical Rapid Materiel Authentication Counterfeit Shield Cell
...
1. Frame the mission problem using these core inputs: incoming part pedigree data, lot and vendor records, mission-critical subsystem demand, and failure indicators.
...
Primary products for this skill: counterfeit risk triage board, release or quarantine recommendation set, trusted substitution routing plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: part provenance attestation services, lot anomaly analytics, field authentication inspection workflows.

## Protocol Profile

Preferred protocol families for this skill: API/JSON, signed supply manifests, USMTF sustainment messaging.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-rapid-materiel-authentication-counterfeit-shield-v1` with `protocol_stack_id=ps-rapid-materiel-authentication-counterfeit-shield-stack-v1`.
- Alternate:   `tool_suite_id=ts-homeland-microelectronics-counterfeit-quarantine-v1` with `protocol_stack_id=ps-homeland-microelectronics-counterfeit-quarantine-stack-v1`.
...
- Default packet IDs: DPL-RAPID-MATERIEL-AUTH-COUNTERFEIT-SHIELD-001, DPL-HOMELAND-MICROELECTRONICS-COUNTERFEIT-QUARANTINE-001.
