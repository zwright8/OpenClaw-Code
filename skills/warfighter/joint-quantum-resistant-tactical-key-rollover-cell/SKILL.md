---
name: joint-quantum-resistant-tactical-key-rollover-cell
description: Support U.S. and coalition tactical cryptographic transition planning under contested operations. Use when key rollover windows, mixed crypto fleets, and mission continuity must be synchronized.
---
...
1. Frame the mission problem with: crypto inventory, link topology, platform constraints, keying authorities.
...
Primary products for this skill: key rollover sequence card, crypto-risk ladder, mixed-fleet compatibility matrix.

## U.S. Warfighter Employment Notes

- Prioritize mission continuity during mixed post-quantum and legacy cryptographic operation windows.
...
- For this domain, prioritize ts-quantum-key-rollover-v1 with ps-quantum-key-rollover-stack-v1.
