---
name: joint-littoral-autonomous-ferry-resupply-under-fire-cell
description: Coordinate autonomous littoral ferry resupply under hostile fires while preserving sustainment throughput, deconfliction, and force protection continuity.
---
...
Primary products: ferry corridor defense matrix, sustainment demand allocation board, and under-fire resupply branch map.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-littoral-autonomous-ferry-resupply-defense-v1` with `protocol_stack_id=ps-littoral-autonomous-ferry-resupply-defense-stack-v1`.
...
- Default packet IDs: `DPL-LITTORAL-AUTONOMOUS-FERRY-RESUPPLY-001`, `DPL-LITTORAL-RESUPPLY-FIRE-DECONFLICTION-001`.
