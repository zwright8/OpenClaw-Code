---
name: theater-additive-munitions-microfactory-control-cell
description: Support U.S. warfighter planning and decision support for Theater Additive Munitions Microfactory Control Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: microfactory production priority board, lot-quality release matrix, munitions surge risk packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: additive MES controllers, non-destructive inspection analytics, lot genealogy and QA registries.

## Protocol Profile

Preferred protocol families for this skill: API/JSON, USMTF, XML.
