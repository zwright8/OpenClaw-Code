---
name: joint-high-value-asset-ground-convoy-fuel-fraud-detection-cell
description: Detect and disrupt convoy fuel fraud affecting high-value asset protection and mission endurance. Use when fuel loss anomalies suggest internal diversion, tampering, or hostile financial pressure.
---
...
Primary products for this skill: fuel anomaly confidence board, fraud investigation branch plan, convoy endurance risk matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-convoy-fuel-fraud-detection-v1` with `protocol_stack_id=ps-convoy-fuel-fraud-stack-v1`.
...
- Default packet IDs: DPL-CONVOY-FUEL-FRAUD-001.
