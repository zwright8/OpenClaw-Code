---
name: strategic-rare-gas-sensor-supply-resilience-cell
description: Support strategic resilience for rare-gas constrained sensor and semiconductor supply chains. Use when xenon/krypton disruptions threaten ISR and guidance production.
---

# Strategic Rare Gas Sensor Supply Resilience Cell
...
- Primary: `tool_suite_id=ts-strategic-rare-gas-sensor-supply-resilience-v1` with `protocol_stack_id=ps-strategic-rare-gas-sensor-supply-resilience-stack-v1`.
- Alternate: `tool_suite_id=ts-advanced-packaging-semiconductor-assurance-v1` with `protocol_stack_id=ps-advanced-packaging-semiconductor-assurance-stack-v1`.
...
- Default packet IDs: DPL-STRATEGIC-RARE-GAS-SENSOR-SUPPLY-RESILIENCE-001, DPL-ADVANCED-PACKAGING-SEMICONDUCTOR-ASSURANCE-001.
