---
name: joint-synthetic-media-watermark-evidence-assurance-cell
description: Validate synthetic-media watermark integrity and preserve evidentiary trust for influence, legal, and attribution missions.
---
...
Primary products for this skill: watermark verification confidence ledger, evidentiary integrity packet, release authority decision chart.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-synthetic-media-watermark-assurance-v1` with `protocol_stack_id=ps-synthetic-media-watermark-assurance-stack-v1`.
...
- Default packet IDs: DPL-SYNTHETIC-MEDIA-WATERMARK-ASSURANCE-001.
