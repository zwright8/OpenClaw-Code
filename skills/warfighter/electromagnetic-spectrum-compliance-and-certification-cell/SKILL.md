---
name: electromagnetic-spectrum-compliance-and-certification-cell
description: Validate mission plans for spectrum compliance and emissions certification before execution. Use when joint operations risk fratricide or mission failure from unmanaged spectrum conflicts.
---
...
1. Frame the mission problem using these core inputs: frequency assignments, platform emission profiles, EW plans, host-nation restrictions.
...
Primary products for this skill: spectrum compliance certification packet, conflict resolution plan, execution risk notice.
...
- Prioritize these tools or tool families for this domain: joint spectrum management tools, EW mission systems, regulatory databases, mission planning tools.
- Specify outbound exchange format for recommendations and tasking: USMTF, Link 16 J-series, API/JSON.
