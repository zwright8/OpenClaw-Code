---
name: joint-pow-camp-outbreak-and-riot-containment-cell
description: Support joint planning for outbreak containment and coordinated riot response in detainee and POW holding facilities.
---
...
Primary products for this skill: facility outbreak containment plan, riot escalation branch chart, custody continuity assurance board.
...
- For this domain, prioritize `ts-pow-camp-outbreak-riot-containment-v1` with `ps-pow-camp-outbreak-riot-containment-stack-v1` and `DPL-POW-CAMP-OUTBREAK-RIOT-CONTAINMENT-001`.
