---
name: theater-additive-energetics-quality-assurance-and-safety-cell
description: Assist joint sustainment and EOD teams with additive energetics quality control, storage safety, and release-governance planning under contested logistics.
---

# Theater Additive Energetics Quality Assurance and Safety Cell
...
Use these tool categories by default: energetics QC analytics, additive manufacturing lot-trace systems, and blast-safety compliance planners.

## Protocol Profile

Preferred protocol families for this skill: USMTF, NIEM, STANAG, OGC, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-ADDITIVE-ENERGETICS-QA-001 for critical recommendations.
