---
name: joint-hypersonic-strike-posture-deception-and-survivability-cell
description: Support U.S. warfighter planning and decision support for hypersonic strike posture survivability through deception, dispersion, and passive-defense integration.
---
...
Primary products for this skill: hypersonic survivability posture matrix, deception branch plan, passive defense trigger ladder.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: missile warning fusion systems, strategic posture dashboards, decoy planning engines, infrastructure survivability models.
...
- Prefer these protocol families for this skill: USMTF, Link 16 J-series, API/JSON.
