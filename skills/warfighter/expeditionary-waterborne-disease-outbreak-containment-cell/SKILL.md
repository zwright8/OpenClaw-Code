---
name: expeditionary-waterborne-disease-outbreak-containment-cell
description: Support U.S. warfighter planning and decision support for waterborne disease containment, force protection, and expeditionary water-system remediation.
---
...
Primary products for this skill: outbreak containment action plan, water-point risk map, force-health protection timeline.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: field epidemiology dashboards, water-quality telemetry systems, med-log coordination platforms, civil-military health liaison trackers.
...
- Prefer these protocol families for this skill: HL7/FHIR, NIMS/ICS, USMTF.
