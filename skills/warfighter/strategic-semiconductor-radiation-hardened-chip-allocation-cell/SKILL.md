---
name: strategic-semiconductor-radiation-hardened-chip-allocation-cell
description: Allocate radiation-hardened semiconductor supply across strategic missions during constrained production and contested logistics.
---
...
Primary products for this skill: chip allocation priority matrix, mission impact risk ledger, reconstitution branch plan.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: semiconductor inventory ledgers, mission dependency graphs, strategic logistics allocation boards.
- Preferred protocol profiles for coordination and machine exchange: API/JSON, USMTF, XML.
