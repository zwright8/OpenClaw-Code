---
name: defensive-space-control-counterspace-cell
description: Support defensive space control actions to protect friendly space capabilities from interference and attack. Use when integrating detection, attribution, and restoration options.
---
...
1. Frame the mission problem using these core inputs: space threat indications, satellite mission priorities, control network health, authority limits.
...
Primary products for this skill: defensive space control plan, restoration priority list, escalation options.
...
- Prioritize these tools or protocol families for this domain: space ops tools, API/JSON, USMTF.
