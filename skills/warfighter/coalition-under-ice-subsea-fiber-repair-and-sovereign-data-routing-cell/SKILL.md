---
name: coalition-under-ice-subsea-fiber-repair-and-sovereign-data-routing-cell
description: Support U.S. warfighter planning for coalition under-ice subsea fiber restoration with sovereign data-routing assurance.
---
...
Use these tool categories by default: under-ice cable telemetry fusion boards, sovereign data-routing policy engines, and coalition repair-rights adjudication workflows.

## Protocol Profile

Preferred protocol families for this skill: AIS/NMEA, USMTF, NIEM, NATO APP-11/ADatP-3 aligned, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-COALITION-UNDER-ICE-SUBSEA-FIBER-REPAIR-SOVEREIGN-DATA-ROUTING-001 for critical recommendations.
