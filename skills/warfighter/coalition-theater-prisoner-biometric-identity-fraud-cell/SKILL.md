---
name: coalition-theater-prisoner-biometric-identity-fraud-cell
description: Detect and disrupt biometric identity fraud across coalition prisoner and detainee workflows. Use when repeated identity manipulation risks custody integrity, legal proceedings, or force protection.
---

# Coalition Theater Prisoner Biometric Identity Fraud Cell
...
1. Frame the mission problem using these core inputs: biometric mismatch alerts, detainee transfer records, legal chain-of-custody status, and coalition caveats.
...
Primary products for this skill: identity fraud confidence matrix, custody correction action plan, tribunal-ready evidence packet.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: biometric adjudication systems, detainee management platforms, legal evidence provenance tools.
...
## Domain Toolchain Override (2026-03-09, Prisoner Identity Fraud Adjudication)

- Prioritize tool_suite_id=ts-prisoner-biometric-identity-fraud-v1 with protocol_stack_id=ps-prisoner-biometric-identity-fraud-stack-v1 when coalition prisoner workflows show recurrent biometric mismatch or spoofing indicators.
- Use packet DPL-PRISONER-BIOMETRIC-IDENTITY-FRAUD-001 to bind identity adjudication steps, custody update controls, and legal evidence handoff requirements.
- If biometric confidence thresholds or coalition releasability checks fail, downgrade to advisory-only custody recommendations and require commander or legal approval before identity status changes.
