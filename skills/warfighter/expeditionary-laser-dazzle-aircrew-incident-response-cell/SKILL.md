---
name: expeditionary-laser-dazzle-aircrew-incident-response-cell
description: Support U.S. warfighter planning and decision support for Expeditionary Laser Dazzle Aircrew Incident Response Cell. Use when missions require aircrew laser-dazzle incident triage, sortie-risk adjustment, and base defense evidence synchronization, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: aircrew incident triage board, sortie adaptation matrix, evidence handoff packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: aviation safety event correlators, electro-optical exposure risk estimators, legal evidence custody ledgers.
...
- Prefer these protocol families for this skill: AIXM/FIXM, USMTF, NIEM, API/JSON.
...
- Primary: tool_suite_id=ts-expeditionary-laser-dazzle-aircrew-incident-response-cell-v1 with protocol_stack_id=ps-expeditionary-laser-dazzle-aircrew-incident-response-cell-stack-v1.
- Alternate: tool_suite_id=ts-air-missile-defense-early-warning-network-resilience-cell-v1 with protocol_stack_id=ps-air-missile-defense-early-warning-network-resilience-cell-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-LASER-DAZZLE-AIRCREW-001, DPL-LASER-DAZZLE-AIRCREW-002.
