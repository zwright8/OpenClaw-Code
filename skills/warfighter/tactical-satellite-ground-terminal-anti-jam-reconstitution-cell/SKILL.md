---
name: tactical-satellite-ground-terminal-anti-jam-reconstitution-cell
description: Restore degraded tactical SATCOM terminals under jamming and maintain mission command connectivity.
---
...
Primary products for this skill: anti-jam reconstitution plan, terminal prioritization board, comms continuity branch.
...
- `tool_suite_id`: `ts-satcom-anti-jam-reconstitution-v1`
- `protocol_stack_id`: `ps-satcom-antijam-reconstitution-stack-v1`
