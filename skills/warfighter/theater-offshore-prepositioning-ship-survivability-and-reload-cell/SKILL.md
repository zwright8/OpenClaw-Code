---
name: theater-offshore-prepositioning-ship-survivability-and-reload-cell
description: Plan survivability and reload synchronization for offshore prepositioning ships in contested theaters. Use when sustainment persistence depends on afloat logistics under threat.
---

# Theater Offshore Prepositioning Ship Survivability and Reload Cell
...
1. Frame the mission problem using these core inputs: ship status and location, threat envelopes, reload node capacity, joint sustainment priorities.
...
Primary products for this skill: afloat survivability matrix, reload branch timeline, theater sustainment continuity packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: maritime COP tools, afloat logistics planners, threat-envelope decision dashboards.

## Protocol Profile

Preferred protocol families for this skill: USMTF, AIS/NMEA, Link 16 J-series, API/JSON.
