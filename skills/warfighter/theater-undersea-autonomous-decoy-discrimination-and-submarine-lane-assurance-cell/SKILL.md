---
name: theater-undersea-autonomous-decoy-discrimination-and-submarine-lane-assurance-cell
description: Support U.S. warfighter planning for Theater Undersea Autonomous Decoy Discrimination and Submarine Lane Assurance Cell.
---
...
Use these tool categories by default: undersea acoustic classification boards, autonomous decoy discrimination engines, and submarine lane assurance planners.

## Protocol Profile

Preferred protocol families for this skill: AIS/NMEA, USMTF, Link 16 J-series, STIX/TAXII, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-THEATER-UNDERSEA-AUTONOMOUS-DECOY-DISCRIMINATION-SUBMARINE-LANE-ASSURANCE-001 for critical recommendations.
