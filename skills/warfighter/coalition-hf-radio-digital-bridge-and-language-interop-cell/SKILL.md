---
name: coalition-hf-radio-digital-bridge-and-language-interop-cell
description: Bridge coalition HF voice/data networks with digital messaging and multilingual interoperability controls. Use when U.S. and partner forces must synchronize degraded comms with translation assurance and protocol-safe relay.
---
...
Primary products for this skill: coalition HF bridge architecture, multilingual comms risk register, degraded comms relay battle drill.

## Domain Tool Stack

Use these tool categories as the baseline stack: HF gateway controllers, digital message relay services, translation assurance boards, coalition communications control centers.

## Protocol Profile

Preferred protocol families for this skill: MIL-STD-188-141, ACP 125, ACP 131, USMTF, STANAG 6001 annotations.
