---
name: theater-disconnected-undersea-surveillance-data-fusion-cell
description: Fuse disconnected undersea surveillance streams into actionable theater decisions when links are degraded or denied. Use when warfighters need anti-submarine, mine, or undersea infrastructure decisions from intermittent or delayed data.
---
...
Primary products: undersea confidence ledger, delayed-fusion risk board, mission cueing packet.
...
- Primary: `tool_suite_id=ts-undersea-surveillance-fusion-v1 with protocol_stack_id=ps-undersea-disconnected-fusion-stack-v1`.
- Alternate: `tool_suite_id=ts-maritime-undersea-v1 with protocol_stack_id=ps-maritime-undersea-c2-stack-v1`.
...
- Default packet IDs: DPL-MARITIME-SUBSEA-001, DPL-INTEL-FUSION-001, DPL-TIME-INTEGRITY-001.
