---
name: theater-expeditionary-blood-cold-chain-denial-recovery-cell
description: Coordinate theater blood cold-chain recovery planning during sustained denial of power, transport, or refrigeration. Use when casualty survival depends on rapid cold-chain restoration branches.
---
...
Primary products for this skill: blood cold-chain recovery board, viability-risk escalation matrix, theater transfusion continuity packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: temperature telemetry systems, blood logistics synchronization boards, mobile refrigeration health monitors, casualty-priority allocation services.
...
- Add `tool_suite_id=ts-theater-blood-cold-chain-denial-recovery-v1` + `protocol_stack_id=ps-theater-blood-cold-chain-denial-recovery-stack-v1` when producing critical recommendations for this mission domain.
