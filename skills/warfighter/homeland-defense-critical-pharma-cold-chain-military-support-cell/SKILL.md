---
name: homeland-defense-critical-pharma-cold-chain-military-support-cell
description: Support military-civil planning for critical pharmaceutical cold-chain continuity under cyber-physical disruption and homeland emergency conditions.
---
...
Primary products: cold-chain continuity map, military support branch plan, life-safety prioritization board.
...
- Prioritize these tool families for this domain: cold-chain telemetry, logistics risk forecasting, DSCA coordination boards, public health dependency mapping.
...
- Bind recommendations to `tool_suite_id=ts-homeland-defense-critical-pharma-cold-chain-military-support-cell-v1` and `protocol_stack_id=ps-homeland-defense-critical-pharma-cold-chain-military-support-cell-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Bind machine-ingestible execution packets to `packet_id=DPL-HOMELAND-PHARMA-COLD-CHAIN-MILSUP-001` from `../_shared/references/domain-tool-packet-library.md`.
