---
name: tactical-denied-environment-additive-munitions-safety-cell
description: Govern safety controls for additive munitions production in denied environments with limited QA infrastructure. Use when forward units must produce energetics with strict risk controls.
---
...
Primary products for this skill: forward additive safety gate matrix, lot quarantine and release log, explosive risk branch plan

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-denied-additive-munitions-safety-v1 and protocol_stack_id=ps-denied-additive-munitions-safety-stack-v1.
- Primary tools for this domain: additive process monitors, energetics QA analyzers, explosive safety modeling tools
