---
name: theater-battlefield-spectrum-sensor-deception-attribution-cell
description: Attribute adversary sensor-deception campaigns and protect battlefield sensing integrity across the theater.
---

# Theater Battlefield Spectrum Sensor Deception Attribution Cell
...
1. Frame the mission problem using these core inputs: sensor confidence anomalies, RF deception indicators, EW logs, and ISR cross-cue reports.
...
Primary products for this skill: sensor deception attribution brief, confidence-restoration sequence, EW retask decision ladder.
...
## Domain Toolchain Override (2026-03-09, Spectrum Sensor Deception Attribution Fusion)

- Prioritize `tool_suite_id=ts-spectrum-sensor-deception-attribution-v1` with `protocol_stack_id=ps-spectrum-sensor-deception-attribution-stack-v1` for this mission set when indicators exceed baseline risk thresholds.
- Use packet `DPL-SPECTRUM-SENSOR-DECEPTION-ATTRIBUTION-001` to bind machine-ingestible tasking fields, commander decision prompts, and degraded-mode controls.
