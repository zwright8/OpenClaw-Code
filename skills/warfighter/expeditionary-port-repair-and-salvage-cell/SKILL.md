---
name: expeditionary-port-repair-and-salvage-cell
description: Plan rapid port restoration, salvage sequencing, and throughput recovery in contested or disaster-damaged maritime nodes. Use when reopening degraded ports for joint sustainment.
---
...
1. Frame the mission problem using these core inputs: port damage assessments, salvage asset status, berth/channel constraints, and throughput requirements.
...
Primary products for this skill: port restoration phasing plan, salvage task matrix, throughput recovery forecast.
