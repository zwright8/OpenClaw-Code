---
name: coalition-autonomous-maritime-mine-countermeasure-deconfliction-cell
description: Synchronize coalition autonomous mine-countermeasure operations while preventing fratricide and preserving chokepoint throughput.
---
...
Primary products: autonomous MCM sortie deconfliction board, mine-risk confidence ladder, coalition release authority packet.
...
- Primary: `tool_suite_id=ts-coalition-autonomous-maritime-mcm-deconfliction-v1` with `protocol_stack_id=ps-coalition-autonomous-maritime-mcm-deconfliction-stack-v1`.
...
- Default packet IDs: `DPL-COALITION-AUTONOMOUS-MCM-DECONFLICTION-001`, `DPL-COALITION-AUTONOMOUS-MCM-DECONFLICTION-002`.
