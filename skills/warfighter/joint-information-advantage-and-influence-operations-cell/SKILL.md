---
name: joint-information-advantage-and-influence-operations-cell
description: Support U.S. warfighter planning and decision support for information advantage and influence operations. Use when missions require narrative battlespace assessment, adversary influence disruption, and trusted public messaging synchronization.
---
...
Primary products for this skill: information effects campaign board, narrative risk and attribution map, trusted public messaging release packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: media monitoring platforms, social graph analytics, attribution/evidence tools, messaging release coordination systems.
...
- Prefer these protocol families for this skill: STIX/TAXII, CAP, USMTF, CoT.
...
- Primary: tool_suite_id=ts-information-advantage-influence-ops-v1 with protocol_stack_id=ps-information-advantage-influence-ops-stack-v1.
- Alternate: tool_suite_id=ts-tactical-counter-disinformation-civil-signal-assurance-v1 with protocol_stack_id=ps-tactical-counter-disinformation-civil-signal-assurance-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-INFO-ADV-INFLUENCE-001, DPL-TRUSTED-MESSAGING-001.
