---
name: homeland-grid-transformer-sabotage-military-support-restoration-cell
description: Plan military-support restoration of critical power dependencies after grid-transformer sabotage, including blackstart and mission-priority load governance.
---
...
Primary products: sabotage impact map, blackstart dependency sequence, and mission-priority load restoration matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-grid-transformer-sabotage-restoration-v1` with `protocol_stack_id=ps-grid-transformer-sabotage-restoration-stack-v1`.
...
- Default packet IDs: `DPL-GRID-TRANSFORMER-SABOTAGE-RESTORATION-001`, `DPL-MILITARY-PRIORITY-GRID-BLACKSTART-001`.
