---
name: joint-electronic-attack-deconfliction-effects-cell
description: Deconflict electronic attack actions and correlate effects across joint cyber-electromagnetic activities and fires. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---

# joint electronic attack deconfliction and effects correlation cell
...
Primary products for this skill: electronic attack synchronization matrix, effects correlation report, conflict mitigation branch plan.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: electronic warfare mission management tools, emitter effect analytics, jamming coordination boards, battle damage assessment services.
- Prioritize these protocol families for this domain: Link 16 J-series, VMF, API/JSON.
