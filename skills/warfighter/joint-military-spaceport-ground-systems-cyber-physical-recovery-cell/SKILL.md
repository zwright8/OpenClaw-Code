---
name: joint-military-spaceport-ground-systems-cyber-physical-recovery-cell
description: Coordinate cyber-physical recovery of military spaceport ground systems after attack or major failure. Use when launch operations and range support must be restored under pressure.
---
...
Primary products for this skill: ground-system recovery sequence, launch-readiness gating board, cyber-physical fault isolation packet

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-military-spaceport-ground-recovery-v1 and protocol_stack_id=ps-military-spaceport-ground-recovery-stack-v1.
- Primary tools for this domain: range telemetry dashboards, launch ground control incident boards, OT/IT cyber recovery planners
- Required exchange protocols/formats for this domain: USMTF, STIX/TAXII, OGC WMS/WFS/WMTS, API/JSON
