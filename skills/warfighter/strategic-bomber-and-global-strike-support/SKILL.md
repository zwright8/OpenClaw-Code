---
name: strategic-bomber-and-global-strike-support
description: Support long-range strike mission integration and retasking. Use when coordinating bomber timelines, tanker bridges, and cross-domain strike dependencies.
---
...
1. Frame the mission problem using these core inputs: global target priorities, bomber availability, tanker corridors, command authorities.
...
Primary products for this skill: global strike timeline, retask branch plan, support dependency matrix.
...
- Prioritize these tools or protocol families for this domain: AOC planning stack, USMTF, Link 16 J-series.
