---
name: strategic-missile-defense-sensor-fusion-cell
description: Fuse strategic warning and missile defense sensor data into decision-ready tracks and engagement support recommendations. Use when theater or homeland missile defense requires rapid multi-sensor correlation.
---
...
1. Frame the mission problem using these core inputs: early warning feeds, radar track quality, sensor latency, engagement authority constraints.
...
Primary products for this skill: sensor-fusion confidence board, engagement-support timeline, defended-asset prioritization table.
...
- Prioritize these tools or tool families for this domain: missile warning systems, IAMD command systems, radar C2 consoles, battle management dashboards.
- Specify outbound exchange format for recommendations and tasking: Link 16 J-series, USMTF, API/JSON.
