---
name: joint-shipyard-battle-damage-assessment-and-repair-cell
description: Prioritize shipyard battle-damage repair sequencing and industrial surge allocation for naval force regeneration.
---
...
Primary products for this skill: shipyard damage triage matrix, repair sequencing plan, fleet readiness regeneration forecast.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: shipyard maintenance systems, structural integrity analytics, supply-chain trackers, naval readiness dashboards.
- Preferred protocol profiles for coordination and machine exchange: USMTF, API/JSON, XML, NATO APP-11/ADatP-3.
