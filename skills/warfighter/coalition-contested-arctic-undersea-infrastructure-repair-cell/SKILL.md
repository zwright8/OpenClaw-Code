---
name: coalition-contested-arctic-undersea-infrastructure-repair-cell
description: Support warfighter planning for coalition undersea infrastructure damage localization, repair, and protection in contested Arctic waters.
---
...
- Primary: `tool_suite_id=ts-arctic-undersea-repair-v1` with `protocol_stack_id=ps-arctic-undersea-repair-stack-v1`.
- Alternate: `tool_suite_id=ts-undersea-geohazard-v1` with `protocol_stack_id=ps-undersea-geohazard-stack-v1`.
...
- Default packet IDs: DPL-ARCTIC-UNDERSEA-REPAIR-001, DPL-UNDERSEA-GEOHAZARD-001.
