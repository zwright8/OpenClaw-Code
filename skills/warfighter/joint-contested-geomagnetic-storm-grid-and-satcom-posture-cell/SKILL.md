---
name: joint-contested-geomagnetic-storm-grid-and-satcom-posture-cell
description: Synchronize mission posture for concurrent geomagnetic storm impacts on power grids and SATCOM dependencies. Use when space weather events create cascading mission assurance risk.
---

# Joint Contested Geomagnetic Storm Grid And SATCOM Posture Cell
...
1. Frame the mission problem using these core inputs: space weather alerts, grid disturbance telemetry, SATCOM link integrity, and mission dependency criticality.
...
Primary products for this skill: geomagnetic impact posture report, grid-and-SATCOM fallback sequence, commander risk decision prompts.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: space weather analytics feeds, grid resilience dashboards, SATCOM link health and failover orchestration tools.
...
## Domain Toolchain Override (2026-03-09, Geomagnetic Storm Joint Posture)

- Prioritize tool_suite_id=ts-geomagnetic-storm-grid-satcom-posture-v1 with protocol_stack_id=ps-geomagnetic-storm-grid-satcom-posture-stack-v1 when severe geomagnetic disturbance indicators threaten synchronized grid and SATCOM continuity.
- Use packet DPL-GEOMAGNETIC-STORM-GRID-SATCOM-POSTURE-001 to bind posture transitions, failover checkpoints, and escalation authority prompts.
- If space-weather confidence or cross-domain acknowledgment chains degrade, issue advisory-only mission posture updates and require explicit commander approval for force posture changes.
