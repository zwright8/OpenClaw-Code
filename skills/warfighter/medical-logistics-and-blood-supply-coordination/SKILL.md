---
name: medical-logistics-and-blood-supply-coordination
description: Coordinate blood products, medical materiel, and evacuation support to keep casualty care effective under contested logistics conditions. Use when treatment timelines depend on supply reliability.
---

# Medical Logistics And Blood Supply Coordination
...
1. Frame the mission problem using these core inputs: casualty estimates, blood demand forecasts, cold-chain status, medevac timelines.
...
Primary products for this skill: medical sustainment plan, blood chain risk matrix, priority resupply list.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: medical logistics systems, blood program trackers, patient movement tools.
...
- Use `joint-insulin-cold-chain-and-diabetic-readiness-cell` when medical sustainment recommendations depend on insulin refrigeration loss, diabetic duty restrictions, or prioritizing limited cold-chain capacity across affected personnel.
