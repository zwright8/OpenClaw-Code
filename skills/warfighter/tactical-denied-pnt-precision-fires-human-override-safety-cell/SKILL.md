---
name: tactical-denied-pnt-precision-fires-human-override-safety-cell
description: Support U.S. warfighter planning for Tactical Denied-PNT Precision Fires Human Override Safety Cell.
---
...
Use these tool categories by default: denied-PNT confidence engines, precision-fires safety interlocks, and human-override release controllers.

## Protocol Profile

Preferred protocol families for this skill: VMF, CoT, Link 16 J-series, USMTF, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-TACTICAL-DENIED-PNT-PRECISION-FIRES-HUMAN-OVERRIDE-SAFETY-001 for critical recommendations.
