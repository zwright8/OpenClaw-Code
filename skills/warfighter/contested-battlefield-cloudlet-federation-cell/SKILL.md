---
name: contested-battlefield-cloudlet-federation-cell
description: Support U.S. warfighter planning and operational decision support for Contested Battlefield Cloudlet Federation Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: mission applications, network topology, trust boundaries, latency and bandwidth constraints.
...
Primary products for this skill: edge cloud federation plan, disconnected data consistency board, mission-service failover package.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: tactical cloud orchestration platforms, identity federation tools, service mesh telemetry, cyber health monitors.
...
- Prefer these protocol families for this skill: API/JSON, STIX/TAXII, USMTF.
