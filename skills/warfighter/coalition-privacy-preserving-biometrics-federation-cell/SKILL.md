---
name: coalition-privacy-preserving-biometrics-federation-cell
description: Federate coalition biometrics matching with privacy safeguards, legal constraints, and degraded identity assurance branches.
---
...
Primary products for this skill: privacy-preserving match confidence board, releasability and legal caveat matrix, identity conflict adjudication packet.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-privacy-preserving-biometrics-federation-v1` with `protocol_stack_id=ps-privacy-preserving-biometrics-federation-stack-v1`.
...
- Default packet IDs: DPL-PRIVACY-PRESERVING-BIOMETRICS-FEDERATION-001.
