---
name: expeditionary-electromagnetic-camouflage-effectiveness-cell
description: Support electromagnetic camouflage assessment for expeditionary forces. Use when commanders need measurable reduction in RF detectability without breaking friendly interoperability and mission timing.
---

# Expeditionary Electromagnetic Camouflage Effectiveness Range Cell
...
Primary products for this skill: camouflage effectiveness heatmap, emission-control timeline, detection-risk branch options.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-em-signature-camouflage-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
- Alternate: `tool_suite_id=ts-spectrum-governance-v1` with `protocol_stack_id=ps-joint-tactical-link-stack-v1`.
...
- Preferred protocol families: Link 16 J-series, USMTF, API/JSON.
...
- Default packet IDs: DPL-EM-CAMO-001, DPL-EMSIG-LIFECYCLE-001.
