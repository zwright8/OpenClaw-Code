---
name: joint-mass-casualty-biosurveillance-isolation-evacuation-cell
description: Coordinate biosurveillance-driven isolation corridors and evacuation governance during mass-casualty biological incidents.
---
...
Primary products: biosurveillance isolation matrix, evacuation sequencing ladder, joint health-protection packet.
...
- Primary: `tool_suite_id=ts-joint-mass-casualty-biosurveillance-isolation-evacuation-v1` with `protocol_stack_id=ps-joint-mass-casualty-biosurveillance-isolation-evacuation-stack-v1`.
...
- Default packet IDs: `DPL-JOINT-MASS-CASUALTY-BIOSURVEILLANCE-ISOLATION-EVACUATION-001`.
