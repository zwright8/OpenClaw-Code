---
name: combat-engineering-obstacle-intelligence-cell
description: Fuse obstacle intelligence to support mobility and countermobility planning. Use when prioritizing breach locations, obstacle reduction assets, and survivability measures.
---
...
1. Frame the mission problem using these core inputs: obstacle reports, terrain analysis, engineer asset status, enemy fires.
...
Primary products for this skill: obstacle intelligence picture, breach priority matrix, reduction support timeline.
...
- Prioritize these tools or protocol families for this domain: engineer planning systems, CoT, VMF.
