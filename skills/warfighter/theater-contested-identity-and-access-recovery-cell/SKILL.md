---
name: theater-contested-identity-and-access-recovery-cell
description: Recover mission-critical identity and access posture during contested operations with revocation, re-issuance, and audit continuity. Use when force access trust is degraded and command needs bounded restoration options.
---
...
Primary products for this skill: identity recovery sequence board, privileged-access risk matrix, revocation/reissue audit packet.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-identity-access-recovery-v1` with `protocol_stack_id=ps-identity-access-recovery-stack-v1`.
...
- Default packet ID: `DPL-IDENTITY-ACCESS-RECOVERY-001`.
...
- Default `toolchain_id`: `TC-CYBER-EMSO-007`.
