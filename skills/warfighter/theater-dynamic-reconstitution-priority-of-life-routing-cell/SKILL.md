---
name: theater-dynamic-reconstitution-priority-of-life-routing-cell
description: Route restoration assets dynamically across contested theaters using priority-of-life sequencing and mission dependency scoring.
---
...
Primary products for this skill: priority-of-life route matrix, restoration sequencing board, civil-military conflict resolver.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-priority-of-life-routing-v1` with `protocol_stack_id=ps-priority-of-life-routing-stack-v1`.
...
- Default packet IDs: DPL-PRIORITY-OF-LIFE-ROUTING-001.
