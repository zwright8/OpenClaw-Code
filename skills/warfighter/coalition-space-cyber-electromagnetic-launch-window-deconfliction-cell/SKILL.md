---
name: coalition-space-cyber-electromagnetic-launch-window-deconfliction-cell
description: Coordinate coalition launch-window decisions across space, cyber, and electromagnetic constraints to prevent mission-fratricide and launch delays.
---
...
Primary products: launch deconfliction matrix, cyber-EM conflict ledger, and coalition release recommendation.

## Domain Toolchain Defaults

- Primary: tool_suite_id=ts-space-cyber-em-launch-deconfliction-v1 with protocol_stack_id=ps-space-cyber-em-launch-deconfliction-stack-v1.
...
- Default packet IDs: DPL-SPACE-CYBER-EM-LAUNCH-DECONF-001.
