---
name: expeditionary-cold-chain-biologics-integrity-cell
description: Preserve biologics and blood-product integrity across expeditionary cold chains under contested logistics conditions. Use when temperature excursions, route threats, or power loss put medical readiness at risk.
---

# Expeditionary Cold-Chain Biologics Integrity Cell
...
1. Frame the mission problem using these core inputs: cold-chain sensor telemetry, transport route status, storage power resilience, and treatment demand forecasts.
...
Primary products for this skill: cold-chain integrity status board, reroute and stabilization plan, treatment-priority sustainment matrix.
...
## Domain Toolchain Override (2026-03-09, Expeditionary Biologics Cold-Chain Assurance)

- Prioritize tool_suite_id=ts-expeditionary-cold-chain-biologics-integrity-v1 with protocol_stack_id=ps-expeditionary-cold-chain-biologics-integrity-stack-v1 when biologics sustainment is threatened by temperature or power instability.
- Use packet DPL-EXPEDITIONARY-COLD-CHAIN-BIOLOGICS-INTEGRITY-001 to bind excursion triage, reroute timing, and med authority release decisions.
- If chain-of-custody or temperature evidence is incomplete, downgrade to restricted-use recommendations and require senior medical approval before issue.
