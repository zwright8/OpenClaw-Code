---
name: coalition-contested-medical-oxygen-and-anesthetic-surge-cell
description: Coordinate coalition oxygen and anesthetic supply surges for Role 2/3 care under contested logistics and disrupted pharma chains. Use when casualty spikes threaten surgical throughput and ventilation capacity.
---
...
Primary products: coalition oxygen stress map, anesthetic allocation ladder, surgical throughput risk brief.
...
- Primary: `tool_suite_id=ts-coalition-medical-oxygen-anesthetic-surge-v1` with `protocol_stack_id=ps-coalition-medical-oxygen-anesthetic-surge-stack-v1`.
- Alternate: `tool_suite_id=ts-coalition-medical-oxygen-anesthetic-surge-v1` with `protocol_stack_id=ps-coalition-medical-oxygen-anesthetic-surge-stack-v1`.
...
- Default packet IDs: DPL-COALITION-MEDICAL-OXYGEN-ANESTHETIC-SURGE-001, DPL-COALITION-MEDICAL-OXYGEN-ANESTHETIC-SURGE-001.
