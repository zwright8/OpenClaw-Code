---
name: joint-civilian-maritime-traffic-military-deconfliction-cell
description: Support U.S. warfighter planning and decision support for Joint Civilian Maritime Traffic Military Deconfliction Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: maritime military-civil deconfliction matrix, contested corridor access decision packet, harbor risk branch timeline.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: maritime COP fusion, commercial shipping analytics, coalition legal and incident adjudication ledgers.

## Protocol Profile

Preferred protocol families for this skill: AIS/NMEA, USMTF, NATO APP-11/ADatP-3 aligned, API/JSON.
