---
name: coalition-deep-ocean-salvage-and-recompression-operations-cell
description: Plan coalition deep-ocean salvage, diver recompression, and pressure-hazard response under contested maritime conditions. Use when damaged assets or sensors must be recovered safely at depth.
---

# Coalition Deep Ocean Salvage And Recompression Operations Cell
...
- Use packet template DPL-DEEP-OCEAN-SALVAGE-RECOMP-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-deep-ocean-salvage-recompression-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-deep-ocean-salvage-recompression-v1 with protocol_stack_id=ps-deep-ocean-salvage-recompression-stack-v1.
...
- Default packet ID: DPL-DEEP-OCEAN-SALVAGE-RECOMP-001.
