---
name: strategic-energy-grid-cyber-physical-deterrence-cell
description: Support U.S. warfighter planning and decision support for Strategic Energy Grid Cyber-Physical Deterrence Cell. Use when missions require strategic energy grid cyber-physical deterrence modeling and protocol-aware staff outputs.
---
...
Primary products for this skill: critical grid deterrence map, mission dependency disruption table, restoration deterrence branch plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: grid telemetry security tools, ICS/OT cyber monitoring platforms, strategic infrastructure impact dashboards.

## Protocol Profile

Preferred protocol families for this skill: STIX/TAXII, API/JSON, NIMS/ICS.
