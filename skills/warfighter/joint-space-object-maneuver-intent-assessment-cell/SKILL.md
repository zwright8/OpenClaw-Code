---
name: joint-space-object-maneuver-intent-assessment-cell
description: Assess intent and risk from adversary or unknown space-object maneuvers and provide response options for U.S. and allied forces. Use when rapid maneuver attribution and escalation control are required.
---
...
1. Frame the mission problem using these core inputs: orbital maneuver telemetry, conjunction risk trajectory, actor baseline behavior, mission dependency exposure.
...
Primary products for this skill: maneuver intent assessment brief, escalation trigger matrix, space response options ledger.
...
- Primary: `tool_suite_id=ts-space-maneuver-intent-v1` with `protocol_stack_id=ps-space-intent-warning-stack-v1`.
