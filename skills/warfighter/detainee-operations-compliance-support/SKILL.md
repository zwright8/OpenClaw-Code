---
name: detainee-operations-compliance-support
description: Assist detainee operation planning with legal and policy compliance controls. Use when establishing handling, transfer, and documentation procedures in operational settings.
---

# Detainee Operations Compliance Support
...
1. Frame the mission problem using these core inputs: detainee categories, facility capacity, transfer authorities, reporting requirements.
...
Primary products for this skill: detainee operations framework, compliance checklist, transfer decision matrix.
