---
name: joint-under-ice-submarine-transit-risk-cell
description: Support U.S. warfighter planning and decision support for Joint Under-Ice Submarine Transit Risk Cell. Use when missions require Joint Under-Ice Submarine Transit Risk Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: under-ice route risk matrix, surfacing contingency ladder, comms-loss branch triggers.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: under-ice bathymetry services, submarine route simulators, ice-drift forecast tools.
