---
name: contested-battlefield-additive-propellant-safety-governance-cell
description: Govern additive-manufactured propellant safety under contested production timelines. Use when additive energetics outputs require rapid safety gates, lot controls, and employment recommendations.
---
...
Primary products for this skill: propellant lot safety board, hazard branch trigger table, release authority packet.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-additive-propellant-safety-v1` with `protocol_stack_id=ps-additive-propellant-safety-stack-v1`.
...
- Default packet IDs: DPL-ADD-PROPELLANT-SAFE-001.
