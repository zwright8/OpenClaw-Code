---
name: tactical-portable-desalination-brine-and-chemical-discharge-compliance-cell
description: Govern tactical portable desalination output, brine disposal, and chemical discharge compliance in littoral operations. Use when freshwater production must continue without mission-breaking environmental violations.
---

# Tactical Portable Desalination Brine And Chemical Discharge Compliance Cell
...
- Use packet template DPL-DESAL-BRINE-COMPLIANCE-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-portable-desalination-compliance-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-portable-desalination-compliance-v1 with protocol_stack_id=ps-desalination-compliance-stack-v1.
...
- Default packet ID: DPL-DESAL-BRINE-COMPLIANCE-001.
