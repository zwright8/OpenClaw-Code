---
name: urban-operations-civil-network-mapper
description: Map civil networks and urban system dependencies to support operations in dense population centers. Use when reducing collateral effects and maintaining critical services.
---

# Urban Operations Civil Network Mapper
...
1. Frame the mission problem using these core inputs: urban infrastructure map, population patterns, key civil actors, critical services status.
...
Primary products for this skill: urban civil network map, service protection priorities, operational constraints matrix.
