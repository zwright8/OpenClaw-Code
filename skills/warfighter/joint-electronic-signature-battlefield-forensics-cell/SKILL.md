---
name: joint-electronic-signature-battlefield-forensics-cell
description: Fuse battlefield electronic signatures for forensics and attribution support. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: emitter captures, signal metadata, timeline of incidents, coalition attribution thresholds.
...
Primary products for this skill: electronic forensics package, attribution confidence brief, evidentiary gap list.
