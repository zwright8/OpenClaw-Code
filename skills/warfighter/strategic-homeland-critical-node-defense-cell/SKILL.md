---
name: strategic-homeland-critical-node-defense-cell
description: Prioritize defense and resilience actions for homeland critical nodes supporting military power projection. Use when threats to ports, depots, energy, or transport hubs risk force deployment timelines.
---
...
1. Frame the mission problem using these core inputs: critical node risk scoring, threat intelligence, readiness impacts, interagency defense posture.
...
Primary products for this skill: critical node defense priorities, resilience investment ladder, rapid protection tasking board.
...
- Prioritize these tools or tool families for this domain: homeland security dashboards, force protection systems, logistics/readiness tools, infrastructure telemetry.
- Specify outbound exchange format for recommendations and tasking: USMTF, API/JSON, CoT, STIX/TAXII.
