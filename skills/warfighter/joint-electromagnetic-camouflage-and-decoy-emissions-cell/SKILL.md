---
name: joint-electromagnetic-camouflage-and-decoy-emissions-cell
description: Support warfighter planning for electromagnetic camouflage, decoy emissions employment, and fratricide-safe spectrum deception.
---

# Joint Electromagnetic Camouflage and Decoy Emissions Cell
...
Primary products for this skill: emission camouflage brief, decoy employment matrix, and fratricide-safe deception branch plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-electromagnetic-camouflage-decoy-emissions-v1` with `protocol_stack_id=ps-electromagnetic-camouflage-decoy-emissions-stack-v1`.
- Alternate: `tool_suite_id=ts-spectrum-deception-emitter-auth-v1` with `protocol_stack_id=ps-spectrum-deception-emitter-auth-stack-v1`.
...
- Default packet IDs: DPL-EM-CAMOUFLAGE-DECOY-001, DPL-EM-DECEPTION-SAFETY-001
