---
name: coalition-forward-airfield-counter-drone-rearming-and-sortie-resilience-cell
description: Support U.S. warfighter planning for Coalition Forward Airfield Counter-Drone Rearming and Sortie Resilience Cell.
---
...
Use these tool categories by default: airfield counter-UAS fusion cells, rearming throughput optimizers, and sortie resilience schedulers.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-COALITION-FORWARD-AIRFIELD-COUNTER-DRONE-REARMING-SORTIE-RESILIENCE-001 for critical recommendations.
