---
name: joint-ai-enabled-force-generation-readiness-forecast-cell
description: Forecast force generation and readiness using AI-supported indicators. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: training completion data, maintenance backlog, personnel readiness, equipment availability.
...
Primary products for this skill: readiness forecast model brief, risk drivers list, force generation options.
