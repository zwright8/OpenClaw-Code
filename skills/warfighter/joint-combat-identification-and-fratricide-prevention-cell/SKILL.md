---
name: joint-combat-identification-and-fratricide-prevention-cell
description: Reduce fratricide risk by integrating combat identification procedures, data links, and positive identification decision points. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: combat ID confidence matrix, fratricide risk triggers, engagement control matrix.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: combat ID correlation services, Blue Force Tracking, Link monitoring tools, rules-of-engagement decision aids.
- Prioritize these protocol families for this domain: Link 16 J-series, VMF, USMTF.
