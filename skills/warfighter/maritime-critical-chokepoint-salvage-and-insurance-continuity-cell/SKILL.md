---
name: maritime-critical-chokepoint-salvage-and-insurance-continuity-cell
description: Support U.S. warfighter planning for maritime chokepoint salvage sequencing and insurance continuity to preserve coalition sealift and operational throughput.
---
...
Primary products for this skill: chokepoint salvage sequence plan, insurance continuity risk matrix, convoy throughput branch triggers.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: maritime traffic COP, salvage asset scheduler, hull risk adjudication board, shipping insurance disruption tracker.
...
- Prefer these protocol families for this skill: AIS/NMEA, API/JSON, NIEM, USMTF.
