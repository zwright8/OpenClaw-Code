...
description: Support U.S. warfighter planning and decision support for additive-manufactured warhead liner quality assurance, lot traceability, and safety release governance. Use when missions require integrated options, tool-protocol bindings, and authority-gated staff outputs.
---
...
Primary products for this skill: liner quality confidence board, lot traceability branch matrix, release-authority packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: additive lot metrology analyzers, ballistic-liner defect classifiers, ordnance release governance boards.
...
- Alternate: tool_suite_id=ts-theater-defense-industrial-base-counterfeit-electronics-assurance-cell-v1 with protocol_stack_id=ps-theater-defense-industrial-base-counterfeit-electronics-assurance-cell-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-ADDITIVE-WARHEAD-LINER-QA-001, DPL-ADDITIVE-WARHEAD-LINER-QA-002.
