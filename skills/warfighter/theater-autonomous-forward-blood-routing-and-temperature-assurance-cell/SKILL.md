---
name: theater-autonomous-forward-blood-routing-and-temperature-assurance-cell
description: Support autonomous forward blood movement, cold-chain assurance, and casualty-priority routing under contested logistics conditions.
---
...
Primary products: blood-routing execution packet, temperature exception report, and casualty continuity branch.

## Domain Toolchain Defaults

- Primary: tool_suite_id=ts-forward-blood-autonomy-assurance-v1 with protocol_stack_id=ps-forward-blood-autonomy-assurance-stack-v1.
...
- Default packet IDs: DPL-FORWARD-BLOOD-AUTONOMY-ASSURANCE-001.
