---
name: joint-prisoner-transfer-and-status-accountability-cell
description: Coordinate lawful prisoner transfer, status accountability, and reporting across joint and coalition forces. Use when detainee movement or custody transitions require synchronized legal and operational controls.
---
...
1. Frame the mission problem using these core inputs: detainee status records, transfer requests, legal constraints, destination facility capacity.
...
Primary products for this skill: transfer compliance plan, custody accountability tracker, exception escalation list.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools or tool families for this domain: detainee tracking platforms, legal workflow engines, coalition caveat registries, transport coordination systems.
