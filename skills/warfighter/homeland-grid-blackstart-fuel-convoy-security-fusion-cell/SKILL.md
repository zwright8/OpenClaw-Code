---
name: homeland-grid-blackstart-fuel-convoy-security-fusion-cell
description: Support U.S. warfighter planning and decision support for homeland grid blackstart operations tied to protected fuel convoy synchronization. Use when missions require infrastructure restoration, convoy security fusion, and protocol-aware DSCA command products.
---

# Homeland Grid Blackstart Fuel Convoy Security Fusion Cell
...
1. Frame the mission with these core inputs: blackstart node priority lists, fuel convoy routes, threat incidents, restoration crew status.
...
Primary products: blackstart-convoy synchronization matrix, fuel security route branches, critical-load restoration decision packet.

## External Tool and Protocol Requirements

- Prioritize tool families: grid restoration orchestration tools, convoy tracking systems, infrastructure security incident boards.
- Prioritize protocol/message bindings: NIMS/ICS, USMTF, API/JSON.
