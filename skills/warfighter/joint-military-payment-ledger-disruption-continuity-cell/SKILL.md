---
name: joint-military-payment-ledger-disruption-continuity-cell
description: Support U.S. warfighter planning and decision support for Joint Military Payment Ledger Disruption Continuity Cell. Use when missions require joint pay and entitlement continuity under cyber disruption, identity dispute, and disconnected command environments, integrated options, and protocol-aware staff outputs.
---

# Joint Military Payment Ledger Disruption Continuity Cell
...
Primary products for this skill: pay continuity adjudication board, entitlement exception ladder, accountability reconciliation packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: personnel/pay ledger validators, biometric confidence matchers, financial rail integrity monitors.
...
- Primary: tool_suite_id=ts-joint-military-payment-ledger-disruption-continuity-cell-v1 with protocol_stack_id=ps-joint-military-payment-ledger-disruption-continuity-cell-stack-v1.
- Alternate: tool_suite_id=ts-joint-contested-biometric-pay-and-personnel-reconstitution-cell-v1 with protocol_stack_id=ps-joint-contested-biometric-pay-and-personnel-reconstitution-cell-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-MILPAY-LEDGER-CONTINUITY-001, DPL-MILPAY-LEDGER-CONTINUITY-002.
