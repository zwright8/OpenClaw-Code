---
name: contested-electronic-navigation-chart-denial-recovery-cell
description: Restore maritime and littoral navigation assurance when digital chart systems are denied, degraded, spoofed, or corrupted. Use when U.S. or coalition units must maintain safe maneuver under chart-data uncertainty.
---
...
1. Frame the mission problem using these core inputs: navigation chart source integrity, ship or boat route criticality, hydrographic update latency, spoofing indicators.
...
Primary products for this skill: chart integrity recovery plan, degraded navigation routing matrix, chart source trust ledger.
...
- Primary: `tool_suite_id=ts-nav-chart-denial-recovery-v1` with `protocol_stack_id=ps-maritime-navigation-integrity-stack-v1`.
