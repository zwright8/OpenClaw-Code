---
name: joint-space-based-ir-missile-warning-false-track-adjudication-cell
description: Adjudicate false-track risks in space-based IR missile warning to preserve strategic warning credibility and response discipline.
---
...
Primary products for this skill: false-track adjudication ledger, warning confidence brief, strategic escalation decision support packet.

## Domain Tool Stack

Use these tool categories as the baseline stack: space warning fusion services, IR track quality analytics, multi-sensor correlation engines, strategic warning dashboards.
...
- Prioritize `tool_suite_id=ts-joint-space-based-ir-missile-warning-false-track-adjudication-cell-v1` + `protocol_stack_id=ps-joint-space-based-ir-missile-warning-false-track-adjudication-cell-stack-v1` when this mission set is the critical path for commander decision timelines.
- Add `packet_id=DPL-JOINT_SPACE_BASED_IR_MISSILE_WARNING_FALSE_TRACK_ADJUDICATION_CELL-001` for the primary course of action and `packet_id=DPL-JOINT_SPACE_BASED_IR_MISSILE_WARNING_FALSE_TRACK_ADJUDICATION_CELL-002` for degraded-mode fallback actions.
