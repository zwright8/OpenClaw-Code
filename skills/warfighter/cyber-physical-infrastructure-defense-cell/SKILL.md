---
name: cyber-physical-infrastructure-defense-cell
description: Support U.S. warfighter planning and decision support for Cyber Physical Infrastructure Defense Cell. Use when missions require defense of operational cyber-physical infrastructure supporting bases, ports, and logistics hubs, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: critical infrastructure defense plan, cyber-physical risk register, incident branch plan.
...
- Prioritize these tools or protocol families for this domain: SIEM/SOAR platforms, ICS monitoring dashboards, infrastructure telemetry gateways.
- State the protocol or message format for outbound coordination (for example STIX/TAXII, API/JSON, USMTF).
