---
name: theater-electronic-warfare-battle-management-cell
description: Synchronize theater-wide EW support, deconfliction, and priority of effects across joint force components. Use when allocating jamming windows, protection actions, and emitter management.
---
...
1. Frame the mission problem using these core inputs: EW target/emitter picture, component requests for support, spectrum restrictions, mission timing.
...
Primary products for this skill: EW effects synchronization matrix, component support priority list, protected-emitter no-jam plan.
