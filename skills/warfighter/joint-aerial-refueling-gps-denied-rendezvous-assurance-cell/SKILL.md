---
name: joint-aerial-refueling-gps-denied-rendezvous-assurance-cell
description: Support U.S. warfighter planning for aerial refueling rendezvous assurance when GNSS is degraded or denied. Use when tanker-receiver timing, track geometry, and anti-spoofing checks must remain synchronized.
---
...
Primary products for this skill: GPS-denied rendezvous assurance board, tanker-receiver timing matrix, anti-spoofing branch plan.

## U.S. Warfighter Employment Notes

- Prioritize fuel continuity and aircraft survivability by synchronizing inertial, celestial, and alternative timing references before rendezvous commits.
...
- For this domain, prioritize `tool_suite_id=ts-aerial-refuel-gps-denied-v1` with `protocol_stack_id=ps-aerial-refuel-gps-denied-stack-v1` and `DPL-AERIAL-REFUEL-GPS-DENIED-001`.
