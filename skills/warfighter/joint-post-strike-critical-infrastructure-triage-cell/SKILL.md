---
name: joint-post-strike-critical-infrastructure-triage-cell
description: Triage damaged critical infrastructure after kinetic strikes and prioritize restoration actions that maximize force and civilian mission resilience. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: post-strike infrastructure triage board, restoration priority decision matrix, cascading failure risk brief.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: infrastructure telemetry platforms, battle damage assessment tools, utility operations dashboards, mission dependency analyzers.
- Prioritize these protocol families for this domain: USMTF, API/JSON, NIMS/ICS, OGC.
