---
name: tactical-loitering-munition-counter-swarm-attrition-cell
description: Plan layered detection, decoying, and attrition of hostile loitering munition swarms around maneuver and support nodes. Use when dynamic defense and ammunition conservation must be balanced under compressed timelines.
---

# Tactical Loitering Munition Counter-Swarm Attrition Cell
...
- Use packet template DPL-CLM-ATTRITION-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-counter-loitering-swarm-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-counter-loitering-swarm-v1 with protocol_stack_id=ps-joint-tactical-link-stack-v1.
...
- Default packet ID: DPL-CLM-ATTRITION-001.
