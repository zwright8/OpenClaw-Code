---
name: border-security-and-counter-transnational-threat-cell
description: Support border security operations against transnational threat networks. Use when integrating surveillance, interdiction, and partner-force coordination.
---
...
1. Frame the mission problem using these core inputs: route intelligence, surveillance feeds, partner capabilities, legal authorities.
...
Primary products for this skill: border threat network map, interdiction synchronization plan, partner tasking matrix.
...
- Prioritize these tools or protocol families for this domain: surveillance and COP tools, CoT, OGC services.
