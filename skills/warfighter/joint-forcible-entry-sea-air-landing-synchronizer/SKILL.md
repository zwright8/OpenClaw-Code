---
name: joint-forcible-entry-sea-air-landing-synchronizer
description: Synchronize joint sea-air landing operations for forcible entry mission support. Use when commanders need integrated timing, protection, and sustainment sequencing for initial lodgment.
---
...
1. Frame the mission problem using these core inputs: landing force phasing, naval and air lift availability, fires support timelines, and beach/landing-zone status.
...
Primary products for this skill: forcible-entry synchronization matrix, lodgment risk board, branch-sequel task tracker.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: joint C2 systems, amphibious and air movement planners, fires coordination tools.
...
- Prefer these protocol families for this skill: USMTF, VMF, Link 16 J-series, CoT.
