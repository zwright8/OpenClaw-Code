---
name: expeditionary-additive-spare-part-intellectual-property-compliance-cell
description: Manage additive manufacturing of spare parts with licensing, export-control, and quality-compliance safeguards in theater. Use when urgent fabrication demand collides with intellectual-property and legal constraints.
---
...
1. Frame the mission problem using these core inputs: spare part demand queue, digital part file provenance, licensing/export restrictions, quality certification requirements, and mission criticality.
...
Primary products for this skill: fabrication legal-compliance decision matrix, approved part-file release order, quality and traceability audit packet.
...
- Primary: `tool_suite_id=ts-additive-ip-compliance-v1` with `protocol_stack_id=ps-additive-compliance-stack-v1`.
