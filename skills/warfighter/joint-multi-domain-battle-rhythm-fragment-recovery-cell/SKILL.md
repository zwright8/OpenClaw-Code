---
name: joint-multi-domain-battle-rhythm-fragment-recovery-cell
description: Recover synchronized battle rhythm after comms fragmentation and delayed acknowledgments. Use when distributed forces lose shared operating tempo across domains.
---

# Joint Multi Domain Battle Rhythm Fragment Recovery Cell
...
1. Frame the mission problem using these core inputs: command timeline fragments, ack-chain integrity, cross-domain decision dependencies, and force readiness state.
...
Primary products for this skill: battle rhythm restoration sequence, decision dependency repair map, branch trigger realignment brief.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: battle rhythm synchronization engines, delayed-ack reconciliation queues, dependency graph recovery analytics.

## Protocol Profile

Preferred protocol families for this skill: USMTF, CoT, API/JSON, NATO APP-11/ADatP-3 aligned.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-multi-domain-battle-rhythm-fragment-recovery-v1` with `protocol_stack_id=ps-multi-domain-battle-rhythm-fragment-recovery-stack-v1`.
- Alternate:   `tool_suite_id=ts-disconnected-command-intent-reconciliation-v1` with `protocol_stack_id=ps-disconnected-command-intent-reconciliation-stack-v1`.
...
- Default packet IDs: DPL-MULTI-DOMAIN-BATTLE-RHYTHM-FRAGMENT-RECOVERY-001, DPL-DISCONNECTED-COMMAND-INTENT-RECON-001.
