---
name: joint-electronic-order-of-battle-drift-detection-cell
description: Detect adversary and friendly EOB drift that invalidates prior planning assumptions. Use when emitter behavior, identity, or geolocation changes can degrade targeting and protection decisions.
---
...
1. Frame the mission problem with: EOB baseline, emitter detections, geolocation confidence, mission effects timeline.
...
Primary products for this skill: EOB drift alert board, confidence-scored anomaly ledger, retask recommendation packet.

## U.S. Warfighter Employment Notes

- Prevent fratricide and mis-targeting by enforcing freshness and confidence gates on EOB updates.
...
- For this domain, prioritize ts-eob-drift-detection-v1 with ps-eob-drift-detection-stack-v1.
