---
name: joint-near-space-haps-mesh-resilience-cell
description: Synchronize resilient high-altitude pseudo-satellite and tactical mesh operations for U.S. warfighters under jamming, weather, and attrition pressure. Use when missions require assured C2 continuity between terrestrial and near-space nodes.
---
...
Primary products: HAPS continuity matrix, mesh failover trigger ledger, commander comms branch brief.
...
- Primary: `tool_suite_id=ts-near-space-haps-resilience-v1 with protocol_stack_id=ps-near-space-haps-resilience-stack-v1`.
...
- Default packet IDs: DPL-C2-DISP-002, DPL-SPECTRUM-REMEDIATION-002, DPL-SPACE-C2-LINK-001.
