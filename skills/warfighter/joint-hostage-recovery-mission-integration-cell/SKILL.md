---
name: joint-hostage-recovery-mission-integration-cell
description: Integrate hostage recovery options across intelligence, fires, legal, and diplomatic constraints. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: hostage recovery options matrix, rescue trigger chart, risk containment branch plan.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: hostage event management boards, ISR cueing planners, special mission coordination tools, legal-policy review workflows.
- Prioritize these protocol families for this domain: USMTF, NATO APP-11/ADatP-3 aligned, API/JSON.
