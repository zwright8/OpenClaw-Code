---
name: joint-battlefield-cloud-seeding-weather-governance-cell
description: Support U.S. warfighter planning and decision support for Joint Battlefield Cloud Seeding Weather Governance Cell. Use when missions require Joint Battlefield Cloud Seeding Weather Governance Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: weather modification governance memo, operational risk/benefit matrix, legal-escalation decision packet.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: weather modeling suites, atmospheric chemistry monitors, legal compliance boards.
- Prioritize these protocol families for this domain: AIXM/FIXM/IWXXM, USMTF, API/JSON.
