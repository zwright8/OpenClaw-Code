---
name: denied-logistics-aerial-resupply-optimizer
description: Optimize aerial resupply in denied or contested theaters with dynamic threat, weather, and runway constraints. Use when traditional ground logistics are disrupted and sortie efficiency is decisive.
---
...
1. Frame the mission problem using these core inputs: threat overlays, lift availability, weather windows, delivery priority codes.
...
Primary products for this skill: contested resupply sortie plan, dynamic reroute branches, cargo risk ledger.
...
- Prioritize these tools or tool families for this domain: airlift mission planning systems, logistics C2 dashboards, threat fusion tools, airspace control tools.
- Specify outbound exchange format for recommendations and tasking: USMTF, VMF, Link 16 J-series, API/JSON.
