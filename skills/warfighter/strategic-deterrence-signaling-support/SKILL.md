---
name: strategic-deterrence-signaling-support
description: Develop strategic signaling options that reinforce deterrence objectives and reduce escalation miscalculation. Use when crafting posture, messaging, and visible activity options.
---

# Strategic Deterrence Signaling Support
...
1. Frame the mission problem using these core inputs: deterrence objectives, adversary behavior indicators, force posture options, policy limits.
...
Primary products for this skill: deterrence signaling options brief, escalation risk matrix, decision trigger framework.
