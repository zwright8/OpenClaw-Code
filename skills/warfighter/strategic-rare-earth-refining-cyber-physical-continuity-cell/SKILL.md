---
name: strategic-rare-earth-refining-cyber-physical-continuity-cell
description: Plan resilient rare-earth refining continuity against combined cyber and physical disruption affecting defense industrial supply chains. Use when warfighters require strategic production assurance for critical materials.
---
...
Primary products for this skill: refining continuity decision board, cyber-physical disruption branch plan, critical-output restoration ladder.
...
- Add `tool_suite_id=ts-strategic-rare-earth-refining-cyber-physical-continuity-v1` + `protocol_stack_id=ps-strategic-rare-earth-refining-cyber-physical-continuity-stack-v1` when producing critical recommendations for this mission domain.
