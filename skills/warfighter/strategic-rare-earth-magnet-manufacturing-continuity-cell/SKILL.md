---
name: strategic-rare-earth-magnet-manufacturing-continuity-cell
description: Protect strategic rare-earth magnet production continuity for precision weapons, sensors, and propulsion systems.
---

# Strategic Rare Earth Magnet Manufacturing Continuity Cell
...
1. Frame the mission problem using these core inputs: feedstock availability, line throughput, defect rates, and mission-priority demand signals.
...
Primary products for this skill: manufacturing continuity forecast, substitution and surge matrix, production risk adjudication packet.
...
## Domain Toolchain Override (2026-03-09, Rare-Earth Magnet Industrial Continuity)

- Prioritize `tool_suite_id=ts-rare-earth-magnet-manufacturing-continuity-v1` with `protocol_stack_id=ps-rare-earth-magnet-manufacturing-continuity-stack-v1` for this mission set when indicators exceed baseline risk thresholds.
- Use packet `DPL-RARE-EARTH-MAGNET-CONTINUITY-001` to bind machine-ingestible tasking fields, commander decision prompts, and degraded-mode controls.
