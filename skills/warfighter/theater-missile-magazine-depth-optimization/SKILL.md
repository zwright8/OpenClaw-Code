---
name: theater-missile-magazine-depth-optimization
description: Optimize missile inventory posture and expenditure pacing for sustained theater campaigns. Use when balancing defensive and offensive missile allocations against anticipated demand.
---
...
1. Frame the mission problem using these core inputs: inventory by munition type, resupply cadence, defended asset priorities, and campaign demand projections.
...
Primary products for this skill: magazine depth optimization matrix, expenditure pacing plan, resupply risk mitigation package.
