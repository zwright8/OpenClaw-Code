---
name: joint-autonomous-bridge-inspection-and-load-rating-cell
description: Support U.S. warfighter planning and decision support for autonomous bridge inspection, load classification, and movement authorization under combat stress.
---
...
Primary products for this skill: bridge load classification board, route authorization packet, repair prioritization queue.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: autonomous inspection platforms, structural digital-twin analytics, mobility COP tools, engineer repair coordination systems.
...
- Prefer these protocol families for this skill: USMTF, OGC, API/JSON.
