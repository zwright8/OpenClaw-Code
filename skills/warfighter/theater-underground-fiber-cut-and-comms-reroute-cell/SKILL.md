---
name: theater-underground-fiber-cut-and-comms-reroute-cell
description: Preserve joint command continuity when buried fiber and terrestrial backhaul are disrupted by kinetic or cyber sabotage.
---
...
Primary products: fiber-cut attribution timeline, comms reroute execution ladder, command continuity risk brief.
...
- Primary: `tool_suite_id=ts-theater-underground-fiber-cut-comms-reroute-v1` with `protocol_stack_id=ps-theater-underground-fiber-cut-comms-reroute-stack-v1`.
- Alternate: `tool_suite_id=ts-cyber-defense-v1` with `protocol_stack_id=ps-joint-tactical-link-stack-v1`.
...
- Default packet IDs: `DPL-THEATER-UNDERGROUND-FIBER-REROUTE-001`, `DPL-THEATER-UNDERGROUND-FIBER-REROUTE-002`.
