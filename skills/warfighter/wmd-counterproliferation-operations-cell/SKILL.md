---
name: wmd-counterproliferation-operations-cell
description: Support U.S. warfighter planning and decision support for WMD Counterproliferation Operations Cell. Use when missions require counterproliferation planning for WMD threat networks, interdiction opportunities, and consequence risk control, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: counterproliferation action matrix, interdiction decision support package, WMD risk branch plan.
...
- Prioritize these tools or protocol families for this domain: all-source intelligence platforms, watchlist systems, interagency coordination dashboards.
- State the protocol or message format for outbound coordination (for example USMTF, STIX/TAXII, API/JSON).
