---
name: joint-digital-twin-urban-siege-civilian-lifeline-cell
description: Use urban infrastructure digital twins to preserve civilian lifelines and mission access during siege, encirclement, or prolonged urban conflict.
---

# Joint Digital Twin Urban Siege Civilian Lifeline Cell
...
Primary products for this skill: urban lifeline continuity matrix, infrastructure restoration priority tree, protected route schedule.

## External Tools and Protocol Integration

- Suggested tools: city digital twin platforms, utility SCADA read-only feeds, satellite imagery, humanitarian NGO reporting.
- Protocol/message standards: OGC API Features, NIEM, CAP, STANAG APP-11.
