---
name: nc3-emergency-action-message-integrity-assurance-cell
description: Validate integrity and continuity of emergency-action message pathways in NC3-relevant workflows. Use when command message assurance and acknowledgment integrity are critical.
---
...
1. Frame the mission problem using these core inputs: message path telemetry, acknowledgment chain records, comm-path health status, continuity policies.
...
Primary products for this skill: message integrity posture report, continuity fallback sequence, command decision prompts.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools or tool families for this domain: message integrity validators, NC3 continuity monitors, signed acknowledgment ledgers, comm-path orchestration tools.
