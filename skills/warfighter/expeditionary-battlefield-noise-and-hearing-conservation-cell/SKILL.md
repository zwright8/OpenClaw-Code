---
name: expeditionary-battlefield-noise-and-hearing-conservation-cell
description: Reduce preventable hearing injury while preserving combat effectiveness in high-noise operational environments. Use when sustained exposure threatens readiness.
---
...
1. Frame the mission problem using these core inputs: noise exposure patterns by unit and task, hearing protection availability, mission communication requirements, medical monitoring data.
...
Primary products for this skill: hearing risk mitigation plan, protective equipment allocation matrix, hearing readiness status report.
