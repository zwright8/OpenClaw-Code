---
name: coalition-seabed-critical-node-tamper-alert-and-repair-cell
description: Coordinate coalition tamper detection and repair prioritization for seabed critical nodes. Use when undersea sensors, cables, or energy nodes show signs of interference or sabotage.
---
...
Primary products for this skill: seabed tamper alert board, repair convoy priority timeline, evidence-preservation handoff log.

## U.S. Warfighter Employment Notes

- Prioritize fast isolation and coalition-safe repair routing while preserving forensic integrity for technical and legal attribution.
...
- For this domain, prioritize `tool_suite_id=ts-seabed-node-tamper-repair-v1` with `protocol_stack_id=ps-seabed-node-tamper-repair-stack-v1` and `DPL-SEABED-NODE-TAMPER-REPAIR-001`.
