---
name: theater-hostage-recovery-urban-sensor-fusion-cell
description: Coordinate theater hostage-recovery support through dense urban multi-sensor fusion and time-critical route/target confidence updates. Use when warfighters must reduce uncertainty before sensitive rescue decisions.
---
...
Primary products for this skill: hostage-recovery sensor fusion brief, urban route confidence matrix, mission-go/no-go escalation ladder.
...
- Add `tool_suite_id=ts-hostage-recovery-urban-sensor-fusion-v1` + `protocol_stack_id=ps-hostage-recovery-urban-sensor-fusion-stack-v1` when producing critical recommendations for this mission domain.
