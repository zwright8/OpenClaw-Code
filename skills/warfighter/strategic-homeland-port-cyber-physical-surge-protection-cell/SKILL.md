---
name: strategic-homeland-port-cyber-physical-surge-protection-cell
description: Support U.S. warfighter planning and decision support for Strategic Homeland Port Cyber Physical Surge Protection Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: port surge protection matrix, cyber-physical dependency restoration queue, strategic throughput risk packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: port ICS telemetry, maritime movement control dashboards, cyber incident orchestration boards.

## Protocol Profile

Preferred protocol families for this skill: NIMS/ICS, API/JSON, USMTF.
