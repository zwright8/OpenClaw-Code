---
name: joint-cislunar-supply-route-threat-adjudication-cell
description: Adjudicate threats to joint cislunar logistics and supply routes across military and allied space infrastructure. Use when orbital or cislunar sustainment lanes face disruption, interference, or collision risk.
---
...
Primary products for this skill: cislunar route threat ledger, sustainment lane reroute matrix, orbital risk adjudication packet.
...
- Add `tool_suite_id=ts-cislunar-supply-route-threat-adjudication-v1` + `protocol_stack_id=ps-cislunar-supply-route-threat-adjudication-stack-v1` when producing critical recommendations for this mission domain.
