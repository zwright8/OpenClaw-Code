---
name: coalition-military-spaceport-dual-use-safety-and-priority-cell
description: Support U.S. warfighter planning and decision support for Coalition Military Spaceport Dual-Use Safety and Priority Cell. Use when missions require coalition dual-use spaceport sortie/launch safety, payload-priority arbitration, and civilian corridor deconfliction, integrated options, and protocol-aware staff outputs.
---

# Coalition Military Spaceport Dual-Use Safety and Priority Cell
...
Primary products for this skill: dual-use launch safety board, payload priority ladder, civil-military deconfliction packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: spaceport range safety monitors, launch scheduling arbitration systems, coalition payload releasability gateways.
...
- Prefer these protocol families for this skill: CCSDS, AIXM/FIXM, NATO APP-11/ADatP-3 aligned, API/JSON.
...
- Primary: tool_suite_id=ts-coalition-military-spaceport-dual-use-safety-and-priority-cell-v1 with protocol_stack_id=ps-coalition-military-spaceport-dual-use-safety-and-priority-cell-stack-v1.
- Alternate: tool_suite_id=ts-joint-space-launch-window-conflict-deconfliction-cell-v1 with protocol_stack_id=ps-joint-space-launch-window-conflict-deconfliction-cell-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-SPACEPORT-DUAL-USE-SAFETY-001, DPL-SPACEPORT-DUAL-USE-SAFETY-002.
