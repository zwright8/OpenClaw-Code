---
name: theater-mission-ledger-zero-trust-disconnected-audit-cell
description: Maintain auditable mission-action ledgers and zero-trust controls during disconnected or partitioned operations.
---
...
Primary products for this skill: disconnected ledger reconciliation report, privilege drift audit, delayed-acknowledgment exception queue.

## Tool Suite and Protocol Binding

- Bind tool selection to `ts-mission-ledger-disconnected-audit-v1` and `ps-mission-ledger-disconnected-audit-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Recommended external tools for this domain: identity governance tools, signed mission ledgers, endpoint health telemetry, and gateway sync status.
- Required protocol families for implementation: OpenID Connect, SCIM, ACME mTLS, and CBOR/COSE.
