---
name: theater-autonomous-farp-fuel-bladder-leak-hunt-cell
description: Detect and contain FARP fuel leaks with autonomous sensing and sustainment safeguards. Use when sortie tempo depends on rapid fuel integrity assurance in contested environments.
---
...
Primary products for this skill: leak containment execution plan, sortie fuel confidence chart, hazard mitigation queue.

## Domain Tool Stack

Use these tool categories as the baseline stack: fuel telemetry anomaly detectors, leak localization planners, hazmat containment decision boards.

## Protocol Profile

Preferred protocol families for this skill: OGC SensorThings, NIMS/ICS, USMTF.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-autonomous-farp-fuel-leak-hunt-v1` with `protocol_stack_id=ps-autonomous-farp-fuel-leak-hunt-stack-v1`.
...
- Default packet IDs: DPL-AUTONOMOUS-FARP-FUEL-LEAK-HUNT-001, DPL-MULTI-DOMAIN-BATTLE-RHYTHM-FRAGMENT-RECOVERY-001.
