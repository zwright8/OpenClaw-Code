---
name: contested-joint-personnel-data-integrity-cell
description: Support U.S. warfighter planning and operational decision support for Contested Joint Personnel Data Integrity Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: personnel roster data, access logs, incident indicators, readiness reporting needs.
...
Primary products for this skill: personnel integrity assurance packet, identity conflict resolution board, force-accountability confidence brief.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: personnel systems, identity and access logs, audit analytics, mission readiness dashboards.
...
- Prefer these protocol families for this skill: API/JSON, USMTF, STIX/TAXII.
