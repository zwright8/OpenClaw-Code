---
name: dynamic-targeting-and-time-sensitive-strike-cell
description: Support dynamic targeting for fleeting targets with compressed decision cycles. Use when coordinating sensor-to-shooter timelines and delegated authorities.
---
...
1. Frame the mission problem using these core inputs: sensor cues, legal constraints, shooter status, collateral estimates.
...
Primary products for this skill: dynamic target prosecution board, delegated authority matrix, strike confirmation log.
...
- Prioritize these tools or protocol families for this domain: JADOCS/C2 systems, Link 16 J-series, VMF.
