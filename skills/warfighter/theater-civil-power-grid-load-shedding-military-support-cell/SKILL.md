---
name: theater-civil-power-grid-load-shedding-military-support-cell
description: Plan military support to civil grid load-shedding and blackstart stabilization in contested theaters. Use when force protection and critical services depend on coordinated power sequencing.
---
...
1. Frame the mission problem with: grid telemetry, critical-node dependencies, military load profile, blackstart assets.
...
Primary products for this skill: load-shed sequencing matrix, blackstart branch plan, critical-service restoration priority board.

## U.S. Warfighter Employment Notes

- Balance force sustainment with civilian priority-of-life services during prolonged outages.
...
- For this domain, prioritize ts-grid-loadshedding-military-support-v1 with ps-grid-loadshedding-military-support-stack-v1.
