---
name: joint-ai-red-cell-adversary-agent-harness
description: Support U.S. warfighter red-team planning for adversary AI-enabled operations and agentic kill-chain stress testing. Use when commands need adversary emulation, decision-path vulnerability discovery, and AI-enabled branch/sequel rehearsal.
---
...
Primary products for this skill: adversary-agent behavior pack, kill-chain weakness map, commander risk-injection options.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: adversary emulation platforms, campaign simulation engines, mission-event correlation dashboards.
- Preferred protocol profile for machine and staff exchange: USMTF + STIX/TAXII + API/JSON.
- Default tool suite binding: `tool_suite_id=ts-ai-red-team-agentics-v1`.
- Default protocol stack binding: `protocol_stack_id=ps-agentic-red-team-assurance-stack-v1`.
- Default packet binding: `packet_id=DPL-AI-RED-001`.
