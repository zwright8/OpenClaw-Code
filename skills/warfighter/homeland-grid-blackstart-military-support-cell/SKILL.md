---
name: homeland-grid-blackstart-military-support-cell
description: Support military planning for civil grid blackstart and restoration under domestic crisis response authorities. Use when DSCA missions require power restoration prioritization and force support coordination.
---
...
Primary products for this skill: Grid restoration support priorities, support force allocation matrix, civil-military sync timeline.
...
- For this domain, prioritize `tool_suite_id=ts-urban-substation-islanding-defense-v1` and `protocol_stack_id=ps-grid-loadshedding-military-support-stack-v1` when civil-military load restoration is a primary decision driver.
