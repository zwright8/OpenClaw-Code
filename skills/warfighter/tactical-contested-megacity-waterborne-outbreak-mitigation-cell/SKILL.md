---
name: tactical-contested-megacity-waterborne-outbreak-mitigation-cell
description: Coordinate waterborne disease outbreak mitigation in contested megacities while sustaining military tempo. Use when force health and civilian stability both depend on rapid sanitation and treatment branching.
---
...
Primary products for this skill: outbreak hotspot prioritization board, water safety mitigation ladder, force-health containment timeline.
...
- Add `tool_suite_id=ts-contested-megacity-waterborne-outbreak-mitigation-v1` + `protocol_stack_id=ps-contested-megacity-waterborne-outbreak-mitigation-stack-v1` when producing critical recommendations for this mission domain.
