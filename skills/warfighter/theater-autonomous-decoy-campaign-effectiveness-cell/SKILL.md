---
name: theater-autonomous-decoy-campaign-effectiveness-cell
description: Plan and measure autonomous decoy campaigns that force adversary resource misallocation. Use when deception operations require quantified effect tracking and fratricide safeguards.
---

# Theater Autonomous Decoy Campaign Effectiveness Cell
...
1. Frame the mission problem using these core inputs: decoy inventory and deployment windows, adversary sensing and fires patterns, blue-force signature posture, and campaign effects.
...
Primary products for this skill: decoy campaign effectiveness scorecard, adversary misallocation estimate, retask and replenishment branch plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: decoy orchestration controllers, signature emulation analytics, adversary response modeling services.

## Protocol Profile

Preferred protocol families for this skill: CoT, USMTF, API/JSON, Link 16 J-series.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-autonomous-decoy-campaign-effectiveness-v1` with `protocol_stack_id=ps-autonomous-decoy-campaign-effectiveness-stack-v1`.
- Alternate:   `tool_suite_id=ts-multi-domain-decoy-orchestration-v1` with `protocol_stack_id=ps-multi-domain-decoy-orchestration-stack-v1`.
...
- Default packet IDs: DPL-AUTONOMOUS-DECOY-CAMPAIGN-EFFECTIVENESS-001, DPL-MULTI-DOMAIN-DECOY-ORCHESTRATION-001.
