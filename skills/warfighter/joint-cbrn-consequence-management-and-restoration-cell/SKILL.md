---
name: joint-cbrn-consequence-management-and-restoration-cell
description: Plan and synchronize CBRN consequence management, hazard isolation, and restoration priorities for military and civil support missions. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: CBRN hazard control plan, restoration priority matrix, decontamination timeline.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: CBRN sensor fusion dashboards, plume/hazard modeling systems, emergency operations coordination tools, contamination mapping platforms.
- Prioritize these protocol families for this domain: EDXL-DE/CAP, USMTF, API/JSON.
