---
name: joint-precision-fires-c2-latency-compensation-cell
description: Support U.S. warfighter planning for precision-fires C2 latency compensation. Use when sensor-to-shooter delays, transport instability, or message queuing threatens timely effects.
---
...
Primary products for this skill: fires latency compensation table, timing exception log, target validity branch plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-precision-fires-latency-comp-v1` with `protocol_stack_id=ps-fires-digital-clearance-stack-v1`.
...
- Default packet IDs: DPL-FIRES-LATENCY-001, DPL-FIRES-LINEAGE-001.
