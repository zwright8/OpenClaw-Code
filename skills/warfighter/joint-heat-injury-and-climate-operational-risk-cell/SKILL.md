---
name: joint-heat-injury-and-climate-operational-risk-cell
description: Forecast heat injury and climate exposure risk for U.S. formations and align work/rest, water, and mission tempo controls.
---
...
Primary products for this skill: heat-risk phase card, work-rest-control matrix, casualty prevention branch triggers.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: WBGT telemetry, force health surveillance dashboards, operational tempo planners.
...
- Default packet binding for this domain: DPL-HEAT-CLIMATE-RISK-001.
