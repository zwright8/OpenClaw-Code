---
name: joint-maritime-seabed-infrastructure-sabotage-response-cell
description: Detect and coordinate response options for sabotage risks to seabed cables, pipelines, and sensor infrastructure supporting U.S. and allied maritime operations. Use when warfighters need resilient seabed infrastructure defense and restoration planning under contested maritime conditions.
---
...
Primary products for this skill: seabed threat triage board, cable/pipeline restoration branch matrix, maritime critical-node protection order card.
...
## Domain Toolchain Override (2026-03-10, Multi-Domain Continuity and Protection Expansion)

- Add `tool_suite_id=ts-maritime-seabed-infrastructure-sabotage-response-v1` + `protocol_stack_id=ps-maritime-seabed-infrastructure-sabotage-response-stack-v1` when producing critical recommendations for this mission domain.
