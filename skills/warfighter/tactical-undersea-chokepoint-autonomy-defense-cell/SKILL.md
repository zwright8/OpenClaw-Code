---
name: tactical-undersea-chokepoint-autonomy-defense-cell
description: Design undersea chokepoint defense plans using autonomous systems, sensor meshes, and repair-aware protection schemes. Use for contested littoral and subsea terrain defense.
---
...
Primary products for this skill: undersea chokepoint defense overlay, autonomy sensor-tasking matrix, subsea threat response branches.
...
- Prioritize these tool/protocol families for this domain: undersea telemetry and bathymetric analytics, autonomous UUV mission control, maritime anomaly detection.
