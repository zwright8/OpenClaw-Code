---
name: joint-civilian-harm-mitigation-and-incident-response-cell
description: Support civilian harm prevention, incident response, and transparent assessment workflows in joint operations.
---

# Joint Civilian Harm Mitigation and Incident Response Cell
...
Primary products for this skill: civilian harm risk register, incident response playbook, corrective action tracker.
...
- Suggested tools: CIVCAS incident systems, ISR annotations, NGO/UN situation feeds, geospatial basemaps, legal review queues.
- Protocol/message standards: MIP JC3IEDM, OGC WMS/WFS, STIX/TAXII, JSON-LD.
