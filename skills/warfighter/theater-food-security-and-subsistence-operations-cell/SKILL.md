---
name: theater-food-security-and-subsistence-operations-cell
description: Plan resilient food supply, ration distribution, and subsistence continuity for joint forces in contested theaters.
---
...
1. Frame the mission problem using these core inputs: ration stock levels, cold-chain status, transport risk, local procurement constraints.
...
Primary products for this skill: subsistence continuity plan, ration distribution prioritization matrix, spoilage/loss mitigation tracker.
