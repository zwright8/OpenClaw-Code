---
name: joint-ems-target-system-harmonization-cell
description: Support U.S. warfighter planning and decision support for Joint EMS Target System Harmonization Cell. Use when missions require electromagnetic target-system harmonization and dynamic EMS conflict resolution across components, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: EMS conflict-resolution board package, emitter-priority matrix, deconfliction orders.
...
- Prioritize these tools or protocol families for this domain: EW mission tools, spectrum interference resolvers, electronic order-of-battle systems.
- State the protocol or message format for outbound coordination (for example Link 16 J-series, USMTF, API/JSON).
