---
name: joint-rapid-adrift-mines-drift-forecast-and-warning-cell
description: Support U.S. warfighter planning and decision support for adrift mine drift forecasting, maritime warning dissemination, and route protection decisions.
---
...
Primary products for this skill: mine drift forecast overlay, navigation warning schedule, route closure and reopening matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: ocean current forecast models, mine detection reports, maritime COP platforms, warning dissemination tools.
