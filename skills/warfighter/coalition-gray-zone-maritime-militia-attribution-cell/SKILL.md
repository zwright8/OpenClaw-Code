---
name: coalition-gray-zone-maritime-militia-attribution-cell
description: Attribute gray-zone maritime militia actions and support calibrated coalition response options. Use when deniable actors, civilian vessel masking, and escalation control must be synchronized.
---

# Coalition Gray Zone Maritime Militia Attribution Cell
...
- Use packet template DPL-GRAYZONE-MARITIME-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-gray-zone-maritime-attribution-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-gray-zone-maritime-attribution-v1 with protocol_stack_id=ps-gray-zone-maritime-stack-v1.
...
- Default packet ID: DPL-GRAYZONE-MARITIME-001.
