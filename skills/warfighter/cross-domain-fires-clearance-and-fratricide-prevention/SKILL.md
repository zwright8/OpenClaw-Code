---
name: cross-domain-fires-clearance-and-fratricide-prevention
description: Synchronize fires clearance and fratricide prevention across land, air, maritime, cyber, and space effects. Use when integrating high-tempo joint fires under compressed decision timelines.
---
...
1. Frame the mission problem using these core inputs: friendly force disposition, no-fire/restricted fire areas, effects requests, and clearance authorities.
...
Primary products for this skill: cross-domain fires clearance board, fratricide risk heatmap, effects deconfliction execution plan.
