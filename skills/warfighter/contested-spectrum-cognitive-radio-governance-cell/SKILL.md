---
name: contested-spectrum-cognitive-radio-governance-cell
description: Support U.S. warfighter planning and decision support for Contested Spectrum Cognitive Radio Governance Cell. Use when missions require Contested Spectrum Cognitive Radio Governance Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: cognitive radio policy envelope, adaptive waveform conflict ledger, commander EM risk board.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: spectrum management services, cognitive radio policy engines, RF interference monitors.
