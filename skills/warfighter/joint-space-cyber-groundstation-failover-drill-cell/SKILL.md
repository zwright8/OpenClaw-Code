---
name: joint-space-cyber-groundstation-failover-drill-cell
description: Support joint space-cyber groundstation failover drills and mission assurance. Use when satellite ground segments face cyber disruption and operators need validated failover playbooks with acknowledgment integrity.
---
...
Primary products for this skill: failover drill plan, groundstation continuity matrix, acknowledgment integrity report.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-groundstation-failover-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
- Alternate: `tool_suite_id=ts-space-satcom-v1` with `protocol_stack_id=ps-joint-tactical-link-stack-v1`.
...
- Preferred protocol families: API/JSON, USMTF, CCSDS.
...
- Default packet IDs: DPL-GS-FAILOVER-001, DPL-SPACEWX-GNSS-001.
