---
name: joint-civil-authority-cyber-incident-unity-cell
description: Coordinate military support to civil authorities during major cyber incidents affecting mission-critical infrastructure. Use when aligning federal, state, and defense response actions.
---
...
1. Frame the mission problem using these core inputs: incident scope by infrastructure sector, agency roles, legal authorities, restoration dependencies.
...
Primary products for this skill: unity-of-effort action board, critical-service restoration priorities, cross-agency decision log.
