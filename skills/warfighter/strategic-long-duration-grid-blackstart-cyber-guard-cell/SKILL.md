---
name: strategic-long-duration-grid-blackstart-cyber-guard-cell
description: Coordinate cyber-guarded blackstart operations for long-duration regional outages affecting strategic force support.
---
...
- Primary: `tool_suite_id=ts-long-duration-grid-blackstart-cyber-guard-v1` with `protocol_stack_id=ps-long-duration-grid-blackstart-cyber-guard-stack-v1`.
...
- Default packet IDs: `DPL-LONG-DURATION-GRID-BLACKSTART-CYBER-GUARD-001`.
