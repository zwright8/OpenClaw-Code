---
name: theater-battlefield-waste-and-hazardous-material-control-cell
description: Plan hazardous battlefield waste handling, disposal routing, and environmental risk control during sustained operations.
---
...
Primary products for this skill: hazmat segregation plan, disposal route matrix, contamination risk brief.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: hazmat inventory trackers, contamination telemetry systems, disposal capacity schedulers.
- Preferred protocol profiles for coordination and machine exchange: USMTF, OGC, API/JSON.
...
- Default packet binding for this domain: DPL-BATTLEFIELD-HAZMAT-001.
