---
name: strategic-telemetry-supply-chain-anti-tamper-cell
description: Support strategic planning for anti-tamper assurance across telemetry hardware and firmware supply chains critical to U.S. mission systems.
---
...
Primary products for this skill: telemetry anti-tamper confidence ledger, firmware provenance exception board, trust restoration timeline.
...
- For this domain, prioritize `ts-telemetry-supply-chain-anti-tamper-v1` with `ps-telemetry-supply-chain-anti-tamper-stack-v1` and `DPL-TELEMETRY-SUPPLY-CHAIN-ANTI-TAMPER-001`.
