---
name: theater-unexploded-ordnance-civilian-return-corridor-cell
description: Support theater planning for unexploded ordnance risk reduction in civilian return corridors after combat operations. Use when clearance prioritization, route certification, and civilian protection decisions must be sequenced.
---
...
Primary products for this skill: UXO corridor certification board, clearance prioritization schedule, civilian return risk communication card.

## U.S. Warfighter Employment Notes

- Prioritize life-safety and credible clearance confidence before recommending reopening of civilian movement corridors.
...
- For this domain, prioritize `ts-uxo-civilian-return-corridor-v1` with `ps-uxo-civilian-return-corridor-stack-v1` and `DPL-UXO-CIVILIAN-RETURN-CORRIDOR-001`.
