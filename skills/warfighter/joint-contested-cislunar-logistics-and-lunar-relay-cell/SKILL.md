---
name: joint-contested-cislunar-logistics-and-lunar-relay-cell
description: Support U.S. warfighter planning for contested cislunar logistics and lunar relay continuity. Use when mission sustainment, relay architecture, and timing integrity must be preserved across terrestrial and cislunar nodes.
---
...
Primary products for this skill: cislunar relay continuity board, orbital sustainment branch matrix, timing integrity exception ledger.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-cislunar-logistics-relay-v1` with `protocol_stack_id=ps-space-c2-satcom-stack-v1`.
- Alternate: `tool_suite_id=ts-space-satcom-v1` with `protocol_stack_id=ps-satcom-resilience-stack-v1`.
...
- Default packet IDs: DPL-CISLUNAR-LOG-001, DPL-ORBIT-PNT-001.
