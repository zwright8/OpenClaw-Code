---
name: joint-shipyard-battle-damage-digital-twin-repair-cell
description: Sequence battle-damage repair with digital twin modeling across joint shipyard infrastructure. Use when fleet regeneration depends on constrained drydock capacity and contested timelines.
---
...
Primary products for this skill: repair orchestration timeline, drydock priority matrix, fleet availability forecast.

## Domain Tool Stack

Use these tool categories as the baseline stack: shipyard digital twins, repair dependency schedulers, dock optimization analytics.

## Protocol Profile

Preferred protocol families for this skill: OGC overlays, USMTF maintenance updates, signed repair manifests.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-shipyard-digital-twin-repair-orchestration-v1` with `protocol_stack_id=ps-shipyard-digital-twin-repair-orchestration-stack-v1`.
...
- Default packet IDs: DPL-SHIPYARD-DIGITAL-TWIN-REPAIR-ORCHESTRATION-001, DPL-MULTI-DOMAIN-BATTLE-RHYTHM-FRAGMENT-RECOVERY-001.
