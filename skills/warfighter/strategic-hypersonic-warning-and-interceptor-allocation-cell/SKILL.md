---
name: strategic-hypersonic-warning-and-interceptor-allocation-cell
description: Support strategic defense with hypersonic warning fusion, interceptor allocation governance, and defended-asset reprioritization under compressed timelines.
---

# Strategic Hypersonic Warning and Interceptor Allocation Cell
...
Use these tool categories by default: strategic warning fusion boards, hypersonic track-confidence analyzers, interceptor-allocation doctrine engines.

## Protocol Profile

Preferred protocol families for this skill: Link 16 J-series, USMTF, STIX/TAXII, NIEM, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-HYPERSONIC-WARN-ALLOC-001 for critical recommendations.
