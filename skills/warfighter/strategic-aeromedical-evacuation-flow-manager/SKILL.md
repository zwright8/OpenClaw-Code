---
name: strategic-aeromedical-evacuation-flow-manager
description: Manage strategic aeromedical evacuation flow, bed allocation, and movement synchronization across theaters. Use when balancing casualty priority, lift constraints, and receiving capacity.
---
...
Primary products for this skill: Strategic AE flow dashboard, bed-lift matching matrix, diversion branch plan.
