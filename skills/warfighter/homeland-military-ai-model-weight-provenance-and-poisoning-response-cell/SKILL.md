---
name: homeland-military-ai-model-weight-provenance-and-poisoning-response-cell
description: Protect homeland military AI operations by validating model-weight provenance, detecting poisoning, and coordinating rapid mission-safe rollback.
---
...
- Primary: `tool_suite_id=ts-homeland-model-weight-provenance-response-v1` with `protocol_stack_id=ps-homeland-model-weight-provenance-response-stack-v1`.
...
- Default packet IDs: `DPL-MODEL-WEIGHT-PROVENANCE-VERIFY-001`, `DPL-MODEL-POISONING-CONTAINMENT-001`.
