---
name: joint-radiological-dispersal-device-urban-response-cell
description: Coordinate joint response planning for urban radiological dispersal incidents affecting military operations.
---
...
1. Frame the mission problem using these core inputs: domain reports, force readiness data, operational constraints, and threat indicators.
...
Primary products for this skill: rdd response operations plan, contamination zone decision board, force protection mitigation matrix.
