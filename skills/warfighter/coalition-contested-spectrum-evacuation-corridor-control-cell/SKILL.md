---
name: coalition-contested-spectrum-evacuation-corridor-control-cell
description: Coordinate coalition evacuation corridors under jamming and degraded communications. Use when mass movement or NEO timelines are constrained by spectrum contestation.
---
...
Primary products for this skill: evacuation corridor control order, RF congestion branch map, coalition synchronization tracker.

## Domain Tool Stack

Use these tool categories as the baseline stack: corridor traffic management boards, EW congestion analytics, coalition interoperability monitors.

## Protocol Profile

Preferred protocol families for this skill: CoT, NATO APP-11/ADatP-3, signed corridor manifests.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-spectrum-evacuation-corridor-control-v1` with `protocol_stack_id=ps-spectrum-evacuation-corridor-control-stack-v1`.
...
- Default packet IDs: DPL-SPECTRUM-EVACUATION-CORRIDOR-CONTROL-001, DPL-MULTI-DOMAIN-BATTLE-RHYTHM-FRAGMENT-RECOVERY-001.
