---
name: operational-target-custody-and-reidentification-cell
description: Maintain target custody across sensors and re-identification events. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: target track history, sensor confidence, identity attributes, handoff latency.
...
Primary products for this skill: target custody ledger, re-identification protocol, confidence decay alerts.
