---
name: contested-maritime-logistics-protection-cell
description: Support U.S. warfighter planning and decision support for Contested Maritime Logistics Protection Cell. Use when missions require convoy protection and maritime sustainment risk management across contested sea lanes, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: maritime sustainment protection plan, convoy risk register, reroute decision matrix.
...
- Prioritize these tools or protocol families for this domain: afloat C2 systems, AIS feeds, logistics movement planners.
- State the protocol or message format for outbound coordination (for example AIS/NMEA, Link 16 J-series, USMTF).
