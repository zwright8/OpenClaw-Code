---
name: battlefield-spectrum-anomaly-triage-cell
description: Detect and triage battlefield spectrum anomalies to distinguish interference, deception, and system faults. Use when rapid spectrum diagnosis is needed to preserve mission command and fires.
---
...
1. Frame the mission problem using these core inputs: spectrum event logs, emitter baseline libraries, platform telemetry, and mission impact reports.
...
Primary products for this skill: spectrum anomaly triage board, emitter attribution assessment, EW incident response tasking.
