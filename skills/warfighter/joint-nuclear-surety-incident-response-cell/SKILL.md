---
name: joint-nuclear-surety-incident-response-cell
description: Coordinate nuclear surety incident triage, consequence control, and command decision support under compressed timelines.
---
...
- Use packet template DPL-NUCLEAR-SURETY-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-nuclear-surety-incident-response-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-nuclear-surety-incident-response-v1 with protocol_stack_id=ps-nuclear-surety-incident-response-stack-v1.
...
- Default packet ID: DPL-NUCLEAR-SURETY-001.
