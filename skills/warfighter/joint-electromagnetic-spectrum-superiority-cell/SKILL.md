---
name: joint-electromagnetic-spectrum-superiority-cell
description: Support U.S. warfighter planning and decision support for electromagnetic spectrum superiority. Use when missions require EMS sensing, jamming/deception planning, blue-force protection, and spectrum fratricide prevention.
---
...
Primary products for this skill: spectrum maneuver decision board, emitter-control synchronization plan, electromagnetic fratricide prevention matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: electronic support and EW planning tools, spectrum analyzers, emitter geolocation systems, tactical C2 data links.
...
- Prefer these protocol families for this skill: VMF, Link 16 J-series, CoT, STIX/TAXII.
...
- Primary: tool_suite_id=ts-electromagnetic-spectrum-superiority-v1 with protocol_stack_id=ps-electromagnetic-spectrum-superiority-stack-v1.
- Alternate: tool_suite_id=ts-theater-spectrum-emissions-discipline-enforcement-v1 with protocol_stack_id=ps-theater-spectrum-emissions-discipline-enforcement-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-EMSO-SUPERIORITY-001, DPL-EMSO-FRATRICIDE-SHIELD-001.
