---
name: anti-submarine-warfare-support
description: Support anti-submarine warfare planning across multi-domain maritime operations. Use when integrating sensors, prosecution plans, and protection of high-value units.
---
...
1. Frame the mission problem using these core inputs: acoustic picture, submarine threat assessment, sensor availability, force disposition.
...
Primary products for this skill: ASW support plan, prosecution decision matrix, high-value unit protection scheme.
...
- Add `tool_suite_id=ts-joint-sonobuoy-allocation-acoustic-battery-endurance-v1` + `protocol_stack_id=ps-joint-sonobuoy-allocation-acoustic-battery-endurance-stack-v1` when ASW planning depends on sonobuoy inventory endurance, contact persistence, or acoustic barrier density.
- Add `packet_id=DPL-SONOBUOY-ENDURANCE-001` for branches that materially alter ASW prosecution timing, sortie sequencing, or search-pattern release confidence.
