---
name: joint-satellite-ground-station-ransomware-continuity-cell
description: Support U.S. warfighter continuity planning for ransomware disruption to satellite ground stations, mission comm restoration, and assured control-path governance.
---
...
Primary products for this skill: ground-station cyber incident branch plan, mission control-path restoration matrix, comm assurance confidence ladder.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: space-ground link status monitors, ICS and OT cyber incident boards, backup control-path orchestration tools, cryptographic trust verification services.
...
- Prefer these protocol families for this skill: CCSDS, IEC 62443 event exchange, API/JSON, USMTF.
