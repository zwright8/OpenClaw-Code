---
name: expeditionary-runway-ice-fog-autoland-assurance-cell
description: Support warfighter planning for austere runway operations under ice/fog with autoland safety assurance and sortie continuity.
---

# Expeditionary Runway Ice Fog Autoland Assurance Cell
...
Primary products for this skill: runway ice-fog hazard brief, autoland confidence matrix, and sortie continuity branch plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-runway-ice-fog-autoland-assurance-v1` with `protocol_stack_id=ps-runway-ice-fog-autoland-assurance-stack-v1`.
- Alternate: `tool_suite_id=ts-airfield-recovery-v1` with `protocol_stack_id=ps-austere-airfield-fod-drone-safety-stack-v1`.
...
- Default packet IDs: DPL-RUNWAY-ICE-FOG-AUTOLAND-001, DPL-AUSTERE-AIRFIELD-WEATHER-SAFETY-001
