---
name: homeland-defense-grid-transformer-escort-and-install-cell
description: Support warfighter planning for convoy escort, emplacement, and security of strategic grid transformers during homeland defense contingencies.
---
...
- Alternate: `tool_suite_id=ts-grid-loadshedding-military-support-v1` with `protocol_stack_id=ps-grid-loadshedding-military-support-stack-v1`.
...
- Default packet IDs: DPL-GRID-TRANSFORMER-ESCORT-001, DPL-GRID-LOADSHED-SUPPORT-001.
