---
name: coalition-rotary-wing-dustoff-weather-contested-routing-cell
description: Optimize coalition rotary-wing casualty evacuation routing under severe weather, contested airspace, and denied comms. Use when medevac timelines and weather hazards are simultaneously driving mortality risk.
---
...
Primary products: dustoff weather-risk corridor map, contested-route release ladder, casualty timing confidence brief.
...
- Primary: `tool_suite_id=ts-coalition-rotary-wing-dustoff-contested-weather-routing-v1` with `protocol_stack_id=ps-coalition-rotary-wing-dustoff-contested-weather-routing-stack-v1`.
- Alternate: `tool_suite_id=ts-coalition-rotary-wing-dustoff-contested-weather-routing-v1` with `protocol_stack_id=ps-coalition-rotary-wing-dustoff-contested-weather-routing-stack-v1`.
...
- Default packet IDs: DPL-COALITION-ROTARY-WING-DUSTOFF-WEATHER-ROUTING-001, DPL-COALITION-ROTARY-WING-DUSTOFF-WEATHER-ROUTING-001.
