---
name: joint-maritime-salvage-diver-life-support-and-decompression-cell
description: Coordinate diver life-support, decompression safety, and salvage timelines for complex maritime recovery operations. Use when deep or repetitive dive operations are required under contested operational constraints.
---
...
1. Frame the mission problem using these core inputs: dive profile requirements, decompression chamber status, salvage task priorities, environmental hazards, and medical support readiness.
...
Primary products for this skill: diver life-support timeline, decompression risk control matrix, salvage mission sequencing order.
