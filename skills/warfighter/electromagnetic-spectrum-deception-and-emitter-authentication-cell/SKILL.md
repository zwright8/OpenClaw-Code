---
name: electromagnetic-spectrum-deception-and-emitter-authentication-cell
description: Support CEMA teams with emitter identity assurance, deception campaign governance, and fratricide-safe spectrum branch recommendations.
---

# Electromagnetic Spectrum Deception and Emitter Authentication Cell
...
Use these tool categories by default: electronic order-of-battle fusion, emitter fingerprint validators, decoy/deception campaign control boards.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-SPECTRUM-DECEPTION-EMITTER-AUTH-001 for critical recommendations.
