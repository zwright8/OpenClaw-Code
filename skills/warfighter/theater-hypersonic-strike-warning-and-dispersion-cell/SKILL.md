---
name: theater-hypersonic-strike-warning-and-dispersion-cell
description: Support U.S. warfighter planning and decision support for Theater Hypersonic Strike Warning And Dispersion Cell. Use when missions require hypersonic warning triage, force dispersion timing, and protected-mobility branch execution, integrated options, and protocol-aware staff outputs.
---

# Theater Hypersonic Strike Warning And Dispersion Cell
...
Primary products for this skill: hypersonic warning timeline, dispersion synchronization matrix, protected asset relocation order.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: missile warning fusion boards, trajectory prediction tools, theater movement control dashboards, hardened basing planners.

## Protocol Profile

Preferred protocol families for this skill: USMTF, Link 16 J-series, API/JSON.
...
- Start with tool_suite_id=ts-hypersonic-warning-dispersion-v1 and protocol_stack_id=ps-hypersonic-warning-dispersion-stack-v1, then branch only when mission constraints require it.
