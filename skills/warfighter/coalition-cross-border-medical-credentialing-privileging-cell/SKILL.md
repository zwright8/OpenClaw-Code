---
name: coalition-cross-border-medical-credentialing-privileging-cell
description: Synchronize cross-border coalition medical credentialing and privileging under surge casualty conditions. Use when partner clinicians need rapid legal, clinical, and authority validation.
---

# Coalition Cross Border Medical Credentialing And Privileging Cell
...
Primary products for this skill: credentialing status board, privileging exception queue, coalition treatment authority log.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-coalition-medical-credentialing-v1` with `protocol_stack_id=ps-coalition-medical-credentialing-stack-v1`.
...
- Default packet IDs: DPL-MED-CRED-PRIV-001.
