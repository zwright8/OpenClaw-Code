---
name: joint-infrastructure-resilience-priority-of-life-restoration-cell
description: Prioritize restoration of life-critical infrastructure services under contested conditions using mission and humanitarian tradeoff analysis. Use when commanders must sequence restoration of power, water, healthcare, and communications.
---
...
1. Frame the mission problem using these core inputs: life-critical service outage map, casualty and population risk indicators, repair force availability, mission dependency graph, civil authority priorities.
...
Primary products for this skill: priority-of-life restoration queue, mission-humanitarian tradeoff board, restoration branch-and-sequel package.
