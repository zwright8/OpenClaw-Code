---
name: expeditionary-human-machine-breaching-safety-assurance-cell
description: Support expeditionary combat engineer breaching missions by validating human-machine teaming safety, command authority controls, and route breach assurance.
---
...
Primary products for this skill: breach safety assurance brief, autonomous/human task partition matrix, authority-gated breach execution checklist.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: combat engineer route and obstacle analytics, autonomous breaching mission planners, safety telemetry monitors, command-approval audit boards.
...
- Prefer these protocol families for this skill: VMF, CoT, API/JSON, USMTF.
