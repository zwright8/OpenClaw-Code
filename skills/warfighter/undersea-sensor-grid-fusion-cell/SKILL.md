---
name: undersea-sensor-grid-fusion-cell
description: Fuse fixed and mobile undersea sensing for mission support and maritime denial awareness. Use when commanders require confidence-graded undersea track custody and choke-point threat warnings.
---
...
1. Frame the mission problem using these core inputs: acoustic detections, undersea sensor health, environmental models, and mission route priorities.
...
Primary products for this skill: undersea custody-confidence matrix, anomaly escalation board, chokepoint risk picture.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: undersea surveillance systems, maritime COP tools, oceanographic model services.
...
- Prefer these protocol families for this skill: AIS/NMEA, Link 16 J-series, USMTF, OGC.
