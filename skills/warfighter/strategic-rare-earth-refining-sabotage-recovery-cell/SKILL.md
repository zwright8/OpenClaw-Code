...
description: Support U.S. warfighter planning and decision support for rare-earth refining sabotage response, industrial recovery sequencing, and weapon-system supply continuity.
---
...
Primary products for this skill: refining recovery sequencing board, material shortfall risk register, defense production mitigation plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: industrial telemetry services, supply-chain risk analytics, production planning systems, strategic logistics command boards.
...
- Prefer these protocol families for this skill: API/JSON, USMTF, XML.
