---
name: strategic-rare-earth-refining-sabotage-recovery-cell
description: Coordinate military support to recover rare-earth refining capacity after sabotage, contamination, or cyber-physical disruption. Use when strategic weapons and electronics supply chains are threatened.
---
...
Primary products for this skill: refinery restart prioritization matrix, feedstock diversion risk board, industrial recovery protection plan

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-rare-earth-refining-sabotage-recovery-v1 and protocol_stack_id=ps-rare-earth-refining-sabotage-recovery-stack-v1.
- Primary tools for this domain: industrial control telemetry fusion, refinery process safety analyzers, strategic supply network monitors
- Required exchange protocols/formats for this domain: USMTF, NIMS/ICS, API/JSON, OGC WMS/WFS/WMTS
