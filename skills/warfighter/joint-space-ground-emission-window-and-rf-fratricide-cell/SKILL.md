---
name: joint-space-ground-emission-window-and-rf-fratricide-cell
description: Coordinate space-ground emissions windows to prevent RF fratricide while sustaining sensing, comms, and fires timing.
---
...
Primary products: emission window order, RF fratricide risk register, mission timing ladder, and commander decision gate card.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-space-ground-emission-fratricide-prevention-v1` with `protocol_stack_id=ps-space-ground-emission-fratricide-prevention-stack-v1`.
...
- Default packet IDs: DPL-SPACE-GROUND-EMISSION-FRATRICIDE-001, DPL-RF-WINDOW-TIMING-001.
