---
name: theater-additive-propellant-safety-and-traceability-cell
description: Support additive propellant production safety, lot traceability, and release decisions in theater. Use when contested manufacturing requires strict energetic risk controls.
---
...
Primary products for this skill: propellant lot risk ledger, safety gate release matrix, contamination rollback plan

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-theater-additive-propellant-safety-traceability-v1 and protocol_stack_id=ps-theater-additive-propellant-safety-traceability-stack-v1.
- Primary tools for this domain: additive process telemetry, propellant QA analytics, hazardous materials compliance boards
- Required exchange protocols/formats for this domain: USMTF, API/JSON, XML, NATO APP-11/ADatP-3 aligned
