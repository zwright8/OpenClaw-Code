---
name: coalition-civilian-harm-mitigation-battle-damage-cell
description: Support U.S. and coalition warfighter operations with civilian-harm mitigation integrated into battle-damage assessment. Use when commanders require protected-site risk controls, harm forecasting, and post-strike verification.
---
...
Primary products for this skill: civilian harm risk overlay, post-strike harm verification packet, mitigation branch matrix.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: collateral estimation tools, ISR damage assessment systems, civilian incident tracking platforms.
- Preferred protocol profile for machine and staff exchange: NATO APP-11/ADatP-3 + USMTF + API/JSON.
- Default tool suite binding: `tool_suite_id=ts-civilian-harm-mitigation-v1`.
- Default protocol stack binding: `protocol_stack_id=ps-civilian-harm-assurance-stack-v1`.
- Default packet binding: `packet_id=DPL-CHM-BDA-001`.
