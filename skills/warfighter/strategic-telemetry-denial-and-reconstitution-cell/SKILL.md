---
name: strategic-telemetry-denial-and-reconstitution-cell
description: Manage telemetry-denied conditions and reconstitution of strategic sensing. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: telemetry outage reports, alternate sensor feeds, mission critical dependencies, restoration options.
...
Primary products for this skill: telemetry reconstitution plan, alternate sensing package, strategic risk brief.
