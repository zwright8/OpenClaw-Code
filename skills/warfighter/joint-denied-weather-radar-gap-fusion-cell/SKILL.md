---
name: joint-denied-weather-radar-gap-fusion-cell
description: Support warfighter planning for denied weather-radar environments by fusing alternate sensors and forecast confidence controls.
---
...
- Primary: `tool_suite_id=ts-denied-weather-radar-gap-fusion-v1` with `protocol_stack_id=ps-denied-weather-radar-gap-fusion-stack-v1`.
- Alternate: `tool_suite_id=ts-multi-sensor-nowcast-fallback-v1` with `protocol_stack_id=ps-multi-sensor-nowcast-fallback-stack-v1`.
...
- Default packet IDs: DPL-DENIED-WEATHER-RADAR-GAP-FUSION-001, DPL-MULTI-SENSOR-NOWCAST-FALLBACK-001.
