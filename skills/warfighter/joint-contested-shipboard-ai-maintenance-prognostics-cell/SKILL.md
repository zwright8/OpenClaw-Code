---
name: joint-contested-shipboard-ai-maintenance-prognostics-cell
description: Synchronize contested shipboard AI prognostics with maintenance windows, spares posture, and sortie generation priorities. Use when naval platforms need predictive sustainment under cyber and EW pressure.
---

# Joint Contested Shipboard AI Maintenance Prognostics Cell
...
- Use packet template DPL-SHIPBOARD-AI-PROGNOSTICS-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-shipboard-ai-maintenance-prognostics-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-shipboard-ai-maintenance-prognostics-v1 with protocol_stack_id=ps-shipboard-ai-prognostics-stack-v1.
...
- Default packet ID: DPL-SHIPBOARD-AI-PROGNOSTICS-001.
