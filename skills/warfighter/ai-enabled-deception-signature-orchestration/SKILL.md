---
name: ai-enabled-deception-signature-orchestration
description: Design and evaluate multi-domain deception and signature-management campaigns with measurable indicators. Use when shaping adversary perception is required to protect friendly operations or create decision advantage.
---
...
1. Frame the mission problem using these core inputs: adversary collection model, friendly signature baseline, deception objectives, indicator/feedback signals.
...
Primary products for this skill: deception signature plan, indicator monitoring board, escalation control triggers.
...
- Prioritize these tools or tool families for this domain: information environment assessment tools, EW mission systems, cyber telemetry tools, influence analytics dashboards.
- Specify outbound exchange format for recommendations and tasking: USMTF, STIX/TAXII, API/JSON, CoT.
