---
name: coalition-cross-border-cyber-forensics-and-extradition-evidence-cell
description: Build coalition-grade cyber forensic evidence packets for cross-border legal handoff and extradition workflows.
---
...
- Primary: `tool_suite_id=ts-cross-border-cyber-forensics-extradition-v1` with `protocol_stack_id=ps-cross-border-cyber-forensics-extradition-stack-v1`.
...
- Default packet IDs: `DPL-CROSS-BORDER-CYBER-FORENSICS-EXTRADITION-001`.
