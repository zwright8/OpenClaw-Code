---
name: tactical-biometrics-privacy-preserving-watchlist-federation-cell
description: Support tactical planning for privacy-preserving watchlist federation when coalition operations require biometric deconfliction without overexposing sensitive identity data.
---
...
Primary products for this skill: watchlist federation policy matrix, biometric confidence and privacy risk ladder, identity deconfliction action board.

## U.S. Warfighter Employment Notes

- Prioritize mission security while enforcing U.S. legal-policy constraints and coalition data-minimization requirements in contested environments.
...
- For this domain, prioritize `ts-privacy-preserving-biometrics-federation-v1` with `ps-privacy-preserving-biometrics-federation-stack-v1` and `DPL-PRIVACY-PRESERVING-BIOMETRICS-FEDERATION-001`.
