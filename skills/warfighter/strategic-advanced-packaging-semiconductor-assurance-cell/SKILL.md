---
name: strategic-advanced-packaging-semiconductor-assurance-cell
description: Sustain defense microelectronics advanced-packaging capacity under sabotage, material shortage, and quality drift pressure. Use when chiplet packaging or secure assembly bottlenecks threaten force readiness.
---

# Strategic Advanced Packaging Semiconductor Assurance Cell
...
1. Frame the mission problem using these core inputs: line yield telemetry, substrate and chemical feedstock status, secure test outcomes, and mission demand priorities.
...
Primary products for this skill: packaging continuity forecast, secure assembly surge matrix, defect containment and rework plan.
...
## Domain Toolchain Override (2026-03-09, Semiconductor Packaging Continuity)

- Prioritize tool_suite_id=ts-advanced-packaging-semiconductor-assurance-v1 with protocol_stack_id=ps-advanced-packaging-semiconductor-assurance-stack-v1 when secure packaging lines show disruption risk.
- Use packet DPL-ADVANCED-PACKAGING-SEMICONDUCTOR-ASSURANCE-001 to bind feedstock allocation, yield-confidence gates, and mission-priority release decisions.
- If supplier attestation or QA confidence is insufficient, publish reduced-throughput recommendations and require strategic acquisition authority approval.
