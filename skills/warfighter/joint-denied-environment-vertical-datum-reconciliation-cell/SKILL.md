---
name: joint-denied-environment-vertical-datum-reconciliation-cell
description: Reconcile vertical datum mismatches in denied environments to prevent fires and mobility error. Use when multi-source terrain products disagree and precision effects depend on elevation trust.
---

# Joint Denied Environment Digital Map Vertical Datum Reconciliation Cell
...
Primary products for this skill: vertical datum discrepancy ledger, terrain correction priority queue, precision-risk advisory.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-vertical-datum-reconciliation-v1` with `protocol_stack_id=ps-vertical-datum-reconciliation-stack-v1`.
...
- Default packet IDs: DPL-VERTICAL-DATUM-RECON-001.
