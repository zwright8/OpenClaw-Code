---
name: space-weather-and-radiation-operational-impacts-cell
description: Assess mission impacts from solar storms, radiation events, and ionospheric disturbance across air, space, and comms operations.
---

# Space Weather and Radiation Operational Impacts Cell
...
Primary products for this skill: space-weather impact bulletin, mission risk window matrix, protection posture recommendations.
...
- Suggested tools: NOAA SWPC feeds, USSF space domain awareness outputs, GNSS integrity monitors, SATCOM health telemetry.
- Protocol/message standards: CCSDS, NMEA, OGC API, SNMP.
