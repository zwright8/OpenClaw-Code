---
name: joint-expeditionary-spectrum-cyber-weather-fusion-cell
description: Support U.S. warfighter planning and decision support for Joint Expeditionary Spectrum Cyber Weather Fusion Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: spectrum-cyber-weather synchronization brief, mission degradation trigger ledger, EW-cyber branch matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: spectrum COP services, cyber threat telemetry fusion, aviation and space weather forecasting systems.

## Protocol Profile

Preferred protocol families for this skill: Link 16 J-series, STIX/TAXII, AIXM/FIXM/IWXXM, API/JSON.
