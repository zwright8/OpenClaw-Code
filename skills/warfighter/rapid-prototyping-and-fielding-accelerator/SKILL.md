---
name: rapid-prototyping-and-fielding-accelerator
description: Support U.S. warfighter planning and decision support for Rapid Prototyping And Fielding Accelerator. Use when missions require urgent capability prototyping and fast fielding decisions, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: urgent sprint plan, experiment scorecard, fielding decision memo.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: digital engineering environments, test range instrumentation, user feedback capture platforms, acquisition trackers.
...
- Prefer these protocol families for this skill: API/JSON exchange, OGC/CoT for geospatial outputs, USMTF summary reporting.
