---
name: expeditionary-water-purification-and-distribution-assurance-cell
description: Plan potable water purification, contamination control, and distribution continuity for expeditionary forces and partnered populations.
---
...
Primary products for this skill: water production plan, contamination response branch, distribution risk scorecard.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: water quality telemetry, purification plant controllers, logistics distribution boards, preventive medicine dashboards.
- Preferred protocol profiles for coordination and machine exchange: USMTF, HL7/FHIR, API/JSON, NIMS/ICS.
