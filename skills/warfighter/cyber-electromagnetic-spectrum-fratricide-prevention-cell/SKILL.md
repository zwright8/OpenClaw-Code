---
name: cyber-electromagnetic-spectrum-fratricide-prevention-cell
description: Prevent blue-on-blue effects across cyber and electromagnetic operations through synchronized deconfliction and authority controls. Use when offensive and defensive cyber and EMS actions overlap.
---
...
Primary products for this skill: cyber-EM fratricide risk board, deconfliction authority matrix, synchronized effects release timeline.
...
- Prioritize these tool/protocol families for this domain: EMSO common operating tools, cyber mission coordination systems, spectrum conflict adjudication services.
