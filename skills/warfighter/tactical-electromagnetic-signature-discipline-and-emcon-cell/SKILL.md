---
name: tactical-electromagnetic-signature-discipline-and-emcon-cell
description: Control tactical electromagnetic emissions and EMCON transitions to reduce detection while preserving mission command.
---
...
Primary products: emission discipline timeline, EMCON transition matrix, detection-risk commander card.
...
- Primary: `tool_suite_id=ts-tactical-electromagnetic-signature-discipline-emcon-v1` with `protocol_stack_id=ps-tactical-electromagnetic-signature-discipline-emcon-stack-v1`.
...
- Default packet IDs: `DPL-TACTICAL-EM-SIGNATURE-EMCON-001`, `DPL-TACTICAL-EM-SIGNATURE-EMCON-002`.
