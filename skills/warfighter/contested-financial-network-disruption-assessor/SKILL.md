---
name: contested-financial-network-disruption-assessor
description: Assess operational impact of adversary or partner financial network disruptions on campaign sustainment and partner stability. Use when sanctions, cyber attacks, or banking outages alter mission support.
---
...
1. Frame the mission problem using these core inputs: payment network status, sanctions actions, fuel/contract payment dependencies, partner force pay status.
...
Primary products for this skill: financial disruption impact brief, sustainment risk branches, mitigation prioritization ledger.
...
- Prioritize these tools or tool families for this domain: treasury/sanctions intelligence feeds, enterprise resource planning systems, cyber threat dashboards, logistics finance trackers.
- Specify outbound exchange format for recommendations and tasking: API/JSON, USMTF, STIX/TAXII.
