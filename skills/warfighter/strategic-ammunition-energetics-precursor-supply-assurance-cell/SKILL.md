---
name: strategic-ammunition-energetics-precursor-supply-assurance-cell
description: Assess and protect strategic supply continuity for energetics precursors used in ammunition production. Use when disruptions, sanctions, sabotage, or quality failures threaten munitions production capacity.
---
...
Primary products for this skill: precursor vulnerability map, mitigation branch plan, strategic supply risk brief.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-strategic-supply-shock-v1` with `protocol_stack_id=ps-ammunition-reliability-governance-stack-v1`.
- Alternate: `tool_suite_id=ts-logistics-distribution-v1` with `protocol_stack_id=ps-harbor-safety-logistics-stack-v1`.
