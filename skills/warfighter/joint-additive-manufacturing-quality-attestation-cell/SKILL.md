---
name: joint-additive-manufacturing-quality-attestation-cell
description: Support U.S. warfighter planning and decision support for Joint Additive Manufacturing Quality Attestation Cell. Use when missions require deployed additive manufacturing quality assurance, traceability, and protocol-aware staff outputs.
---
...
Primary products for this skill: part quality attestation packet, lot traceability matrix, fielded part risk register.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: manufacturing execution systems, digital thread registries, nondestructive inspection workflows.

## Protocol Profile

Preferred protocol families for this skill: API/JSON, XML, USMTF.
