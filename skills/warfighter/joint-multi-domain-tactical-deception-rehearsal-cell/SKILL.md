---
name: joint-multi-domain-tactical-deception-rehearsal-cell
description: Support U.S. warfighter planning and decision support for Joint Multi-Domain Tactical Deception Rehearsal Cell. Use when missions require rehearsed deception options across land, maritime, air, cyber, and electromagnetic domains with protocol-aware staff outputs.
---
...
Primary products for this skill: deception rehearsal storyboard, adversary observation disruption plan, execution trigger ladder.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: red-cell simulation environments, signature management tools, all-source deception indicator trackers.

## Protocol Profile

Preferred protocol families for this skill: USMTF, CoT, STIX/TAXII.
