---
name: joint-uncrewed-ground-sensor-border-denial-cell
description: Support U.S. warfighter planning and decision support for Joint Uncrewed Ground Sensor Border Denial Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: uncrewed sensor denial posture map, border breach risk ledger, layered response sequencing packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: autonomous sensor mesh control, border pattern analytics, biometric and ISR fusion services.

## Protocol Profile

Preferred protocol families for this skill: CoT, USMTF, STIX/TAXII, API/JSON.
