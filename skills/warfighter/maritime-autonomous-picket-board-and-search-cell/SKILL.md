---
name: maritime-autonomous-picket-board-and-search-cell
description: Synchronize autonomous picket sensing with compliant board-and-search operations in contested sea lanes.
---
...
- Use packet template `DPL-MAR-PICKET-001` from `../_shared/references/domain-tool-packet-library.md`.
- Bind tool and protocol choices to `ts-autonomous-maritime-picket-v1` and `ps-autonomous-maritime-picket-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Align execution profile with `maritime-undersea-control-v1` from `../_shared/references/joint-operations-external-toolchain-profiles.md`.
...
- Primary: `tool_suite_id=ts-autonomous-maritime-picket-v1` with `protocol_stack_id=ps-autonomous-maritime-picket-stack-v1`.
...
- Default packet ID: `DPL-MAR-PICKET-001`.
