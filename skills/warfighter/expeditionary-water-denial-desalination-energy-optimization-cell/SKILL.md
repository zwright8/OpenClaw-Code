---
name: expeditionary-water-denial-desalination-energy-optimization-cell
description: Plan expeditionary water production and distribution under denial, contamination, and fuel constraints using desalination and purification mixes.
---

# Expeditionary Water Denial Desalination Energy Optimization Cell
...
Primary products for this skill: water production resilience board, desalination energy allocation matrix, contamination-to-distribution decision ladder.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: water quality surveillance tools, purification and desalination plant telemetry, expeditionary fuel and power dashboards, route distribution planners.
...
- Prefer these protocol families for this skill: USMTF, NIMS/ICS, HL7/FHIR, API/JSON.
...
- Primary: `tool_suite_id=ts-theater-food-water-fuel-denial-v1` with `protocol_stack_id=ps-food-water-fuel-denial-stack-v1`.
- Alternate: `tool_suite_id=ts-logistics-distribution-v1` with `protocol_stack_id=ps-civil-emergency-stack-v1`.
