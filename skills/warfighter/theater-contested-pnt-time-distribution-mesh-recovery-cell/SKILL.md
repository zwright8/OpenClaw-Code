---
name: theater-contested-pnt-time-distribution-mesh-recovery-cell
description: Support U.S. warfighter planning and decision support for GNSS-denied timing recovery, resilient time-distribution mesh operations, and precision-fire synchronization assurance.
---
...
Primary products for this skill: time-mesh restoration board, precision-timing confidence map, fires-synchronization risk packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: time-transfer integrity monitors, PNT fallback orchestration boards, mesh reroute analyzers.
...
- Prefer protocol families: USMTF, Link 16 J-series, VMF, CoT, API/JSON.
...
- Primary: tool_suite_id=ts-theater-contested-pnt-time-mesh-recovery-v1 with protocol_stack_id=ps-theater-contested-pnt-time-mesh-recovery-stack-v1.
- Alternate: tool_suite_id=ts-astroinertial-reversion-v1 with protocol_stack_id=ps-astroinertial-reversion-stack-v1.
- Degraded: authenticated voice/readback plus UTC acknowledgment ledger and manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-PNT-TIME-MESH-RECOVERY-001, DPL-PNT-TIME-MESH-RECOVERY-002.
