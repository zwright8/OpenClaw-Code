---
name: theater-ai-enabled-air-defense-identification-friend-foe-spoofing-recovery-cell
description: Support U.S. warfighter planning for AI-assisted air-defense IFF spoofing recovery and defended-asset release confidence.
---

# Theater AI-Enabled Air Defense Identification Friend-or-Foe Spoofing Recovery Cell
...
Use these tool categories by default: air-defense track-fusion boards, IFF confidence adjudicators, and defended-asset release planners.

## Protocol Profile

Preferred protocol families for this skill: Link 16 J-series, VMF, USMTF, STIX/TAXII, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-THEATER-AI-AIR-DEFENSE-IFF-SPOOFING-RECOVERY-001 for critical recommendations.
