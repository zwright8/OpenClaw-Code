---
name: tactical-disconnected-mission-data-replication-cell
description: Synchronize mission data and operational picture updates across intermittently connected tactical networks. Use when edge units must operate through disrupted or denied links without data divergence.
---
...
1. Frame the mission problem using these core inputs: current mission data versions, link availability windows, data priority tiers, integrity constraints, reconciliation checkpoints.
...
Primary products for this skill: disconnected replication schedule, priority data synchronization ledger, conflict-resolution and rollback plan.
