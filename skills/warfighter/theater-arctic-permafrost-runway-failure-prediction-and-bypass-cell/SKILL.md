---
name: theater-arctic-permafrost-runway-failure-prediction-and-bypass-cell
description: Support U.S. warfighter planning for arctic runway failure prediction linked to permafrost stress and sortie bypass routing. Use when missions require forecasting runway risk, sequencing alternate landing surfaces, and preserving air mobility in extreme cold environments.
---

# Theater Arctic Permafrost Runway Failure Prediction and Bypass Cell
...
Primary products: permafrost runway failure forecast, sortie bypass and diversion matrix, airfield resilience branch plan

## External Tool and Protocol Requirements

- Prioritize tool families: runway condition telemetry, geotechnical and permafrost monitoring analytics, air mobility route optimization tools
- Prioritize protocol/message bindings: AIXM/FIXM, USMTF, OGC
...
- tool_suite_id: ts-permafrost-runway-failure-bypass-v1
- toolchain_profile_id: arctic-permafrost-runway-bypass-v1
