---
name: coalition-sanctions-evasion-network-disruption-cell
description: Map and disrupt sanctions-evasion networks supporting adversary warfighting capacity. Use when operational planning requires tracing illicit finance, procurement, and logistics pathways.
---
...
1. Frame the mission problem using these core inputs: financial anomaly reports, shipping manifests, procurement traces, sanctions watchlists.
...
Primary products for this skill: network disruption options matrix, legal-risk screen, coalition coordination tasks.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools or tool families for this domain: financial intelligence platforms, sanctions list fusion tools, logistics trace analytics, legal coordination workflows.
