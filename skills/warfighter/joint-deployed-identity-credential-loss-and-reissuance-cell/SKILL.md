---
name: joint-deployed-identity-credential-loss-and-reissuance-cell
description: Support U.S. warfighter mission continuity when deployed digital credentials are lost, compromised, or revoked and must be reissued quickly.
---
...
Primary products for this skill: credential compromise triage board, reissuance priority list, mission-access continuity packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: identity lifecycle services, revocation status brokers, policy engines, access anomaly dashboards.
...
- Primary: \ with \.\n- Alternate: \ with \.\n- Degraded: mission-essential allowlist and dual-control manual credential issuance.
...
- Prefer these protocol families for this skill: X.509/PKI, API/JSON, USMTF.
