---
name: preventive-medicine-and-force-health-protection
description: Identify operational health threats and recommend prevention controls for deployed forces. Use when disease, environment, sanitation, or vector risk can degrade combat power.
---
...
1. Frame the mission problem using these core inputs: unit disposition, climate and sanitation conditions, medical surveillance trends, immunization status.
...
Primary products for this skill: force health risk brief, preventive control plan, surveillance watchlist.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: public health surveillance systems, environmental monitoring tools, medical readiness dashboards.
...
- Add `toolchain_id=TC-BURNPIT-338`, `tool_suite_id=ts-joint-airborne-hazard-burn-pit-pact-act-toxic-exposure-registry-continuity-v1`, and `protocol_stack_id=ps-joint-airborne-hazard-burn-pit-pact-act-toxic-exposure-registry-continuity-stack-v1` when force-health posture depends on preserving burn-pit, airborne-hazard, or toxic-exposure evidence long enough to drive registry enrollment, specialty follow-up, or lawful benefits documentation.
- Add `toolchain_id=TC-PDHAIMR-339`, `tool_suite_id=ts-joint-post-deployment-health-assessment-imr-duty-limitation-recovery-v1`, and `protocol_stack_id=ps-joint-post-deployment-health-assessment-imr-duty-limitation-recovery-stack-v1` when commander risk depends on closing PDHA or PDHRA gaps, correcting IMR drift, or recovering duty-limitation follow-through after redeployment.
- Add `packet_id=DPL-BURN-PIT-PACT-ACT-EXPOSURE-001` and `packet_id=DPL-POST-DEPLOYMENT-HEALTH-IMR-001` for branches that materially alter surveillance posture, deployability confidence, or protected-health follow-up timing.
