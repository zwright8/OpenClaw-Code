---
name: theater-autonomous-casevac-corridor-assurance-cell
description: Support U.S. warfighter planning and decision support for Theater Autonomous CASEVAC Corridor Assurance Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: autonomous CASEVAC corridor confidence board, casualty movement timing matrix, medevac risk branch packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: uncrewed route planners, medical regulation dashboards, contested mobility and air-ground deconfliction tools.

## Protocol Profile

Preferred protocol families for this skill: HL7/FHIR, USMTF, VMF, API/JSON.
