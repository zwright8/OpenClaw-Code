---
name: coalition-human-rights-detention-oversight-cell
description: Support U.S. warfighter planning and decision support for Coalition Human Rights Detention Oversight Cell. Use when missions require Coalition Human Rights Detention Oversight Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: detention oversight inspection tracker, abuse allegation triage flow, remediation suspense board.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: detainee accountability systems, oversight case trackers, coalition legal reporting portals.
