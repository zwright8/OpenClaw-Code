---
name: joint-mobile-satcom-emission-discipline-cell
description: Manage mobile SATCOM emission control, movement timing, and detection-risk suppression for expeditionary C2 nodes.
---
...
Primary products for this skill: SATCOM emission discipline board, movement and emit schedule matrix, detection risk reduction plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-mobile-satcom-emission-discipline-v1` with `protocol_stack_id=ps-mobile-satcom-emission-stack-v1`.
- Alternate: `tool_suite_id=ts-spectrum-licensing-clearance-v1` with `protocol_stack_id=ps-spectrum-licensing-clearance-stack-v1`.
...
- Default packet IDs: DPL-MOBILE-SATCOM-EMCON-001.
