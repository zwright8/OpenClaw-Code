---
name: coalition-denied-environment-identity-proofing-cell
description: Support U.S. warfighter planning and operational decision support for Coalition Denied Environment Identity Proofing Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---

# Coalition Denied Environment Identity Proofing Cell
...
Primary products for this skill: identity assurance matrix, credential resilience plan, coalition access risk register.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: identity federation services, biometric match systems, edge credential stores, coalition access brokers.
...
- Prefer these protocol families for this skill: API/JSON, STIX/TAXII, NATO APP-11/ADatP-3.
