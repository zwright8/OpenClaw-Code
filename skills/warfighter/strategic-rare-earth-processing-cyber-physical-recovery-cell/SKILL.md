---
name: strategic-rare-earth-processing-cyber-physical-recovery-cell
description: Support recovery of strategic rare-earth processing capacity after cyber-physical disruption affecting defense supply chains.
---
...
Primary products for this skill: rare-earth plant recovery sequence, strategic output restoration board, cyber-physical risk mitigation packet.

## Domain Tool Stack

Use these tool categories as the baseline stack: industrial control incident response tools, supply-chain risk analytics, process restoration simulators, strategic mobility planning.

## Protocol Profile

Preferred protocol families for this skill: STIX/TAXII, EDI X12, USMTF, API/JSON.
...
- Prioritize `tool_suite_id=ts-strategic-rare-earth-processing-cyber-physical-recovery-cell-v1` + `protocol_stack_id=ps-strategic-rare-earth-processing-cyber-physical-recovery-cell-stack-v1` when this mission set is the critical path for commander decision timelines.
- Add `packet_id=DPL-STRATEGIC_RARE_EARTH_PROCESSING_CYBER_PHYSICAL_RECOVERY_CELL-001` for the primary course of action and `packet_id=DPL-STRATEGIC_RARE_EARTH_PROCESSING_CYBER_PHYSICAL_RECOVERY_CELL-002` for degraded-mode fallback actions.
