---
name: port-opening-jrsoi-integrator
description: Support joint reception, staging, onward movement, and integration at ports of debarkation. Use when sequencing force flow and reducing bottlenecks into theater.
---

# Port Opening and JRSOI Integrator
...
1. Frame the mission problem using these core inputs: force flow data, port throughput, transportation assets, host nation constraints.
...
Primary products for this skill: JRSOI execution board, throughput bottleneck analysis, onward movement plan.
