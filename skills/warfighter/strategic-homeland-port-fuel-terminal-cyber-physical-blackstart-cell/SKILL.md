---
name: strategic-homeland-port-fuel-terminal-cyber-physical-blackstart-cell
description: Support U.S. warfighter planning and decision support for Strategic Homeland Port Fuel Terminal Cyber-Physical Blackstart Cell. Use when missions require strategic fuel terminal cyber-physical restoration, military priority fuel sequencing, and DSCA blackstart coordination, integrated options, and protocol-aware staff outputs.
---

# Strategic Homeland Port Fuel Terminal Cyber-Physical Blackstart Cell
...
Primary products for this skill: terminal restoration branch matrix, priority fuel release schedule, cyber-safe energization checklist.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: terminal SCADA resilience consoles, fuel quality telemetry fusion boards, DSCA logistics restoration planners.
...
- Prefer these protocol families for this skill: USMTF, NIMS/ICS, STIX/TAXII, API/JSON.
...
- Primary: tool_suite_id=ts-strategic-homeland-port-fuel-terminal-cyber-physical-blackstart-cell-v1 with protocol_stack_id=ps-strategic-homeland-port-fuel-terminal-cyber-physical-blackstart-cell-stack-v1.
- Alternate: tool_suite_id=ts-homeland-grid-blackstart-fuel-cyber-v1 with protocol_stack_id=ps-homeland-grid-blackstart-fuel-cyber-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-HOMELAND-PORT-FUEL-BLACKSTART-001, DPL-HOMELAND-PORT-FUEL-BLACKSTART-002.
