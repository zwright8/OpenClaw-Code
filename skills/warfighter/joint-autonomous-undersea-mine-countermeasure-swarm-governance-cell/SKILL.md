---
name: joint-autonomous-undersea-mine-countermeasure-swarm-governance-cell
description: Govern autonomous undersea mine-countermeasure swarms with strict safety, legal, and mission-assurance controls.
---
...
Primary products for this skill: MCM swarm governance matrix, autonomy release authority packet, safe-lane certification board.

## Domain Tool Stack

Use these tool categories as the baseline stack: undersea autonomy mission control, minefield mapping analytics, legal and ROE workflow board, safety override telemetry.

## Protocol Profile

Preferred protocol families for this skill: USMTF, OGC WMS/WFS/WMTS, NATO APP-11/ADatP-3 aligned, API/JSON.
...
- Prioritize `tool_suite_id=ts-joint-autonomous-undersea-mine-countermeasure-swarm-governance-cell-v1` + `protocol_stack_id=ps-joint-autonomous-undersea-mine-countermeasure-swarm-governance-cell-stack-v1` when this mission set is the critical path for commander decision timelines.
- Add `packet_id=DPL-JOINT_AUTONOMOUS_UNDERSEA_MINE_COUNTERMEASURE_SWARM_GOVERNANCE_CELL-001` for the primary course of action and `packet_id=DPL-JOINT_AUTONOMOUS_UNDERSEA_MINE_COUNTERMEASURE_SWARM_GOVERNANCE_CELL-002` for degraded-mode fallback actions.
