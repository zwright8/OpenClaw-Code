---
name: arms-control-treaty-compliance-monitor
description: Support U.S. warfighter planning and decision support for Arms Control Treaty Compliance Monitor. Use when missions require arms-control and treaty compliance monitoring with escalation support, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: treaty obligation tracker, inspection readiness checklist, anomaly escalation package.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: treaty data repositories, verification intelligence systems, legal policy trackers, inspection scheduling platforms.
...
- Prefer these protocol families for this skill: USMTF, NATO APP-11/ADatP-3, API/JSON.
