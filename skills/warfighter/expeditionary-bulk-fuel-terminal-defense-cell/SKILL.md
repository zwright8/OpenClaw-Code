---
name: expeditionary-bulk-fuel-terminal-defense-cell
description: Plan defense and continuity for expeditionary bulk fuel terminals under missile, sabotage, or cyber threat. Use when protecting storage, transfer nodes, and fuel distribution flow.
---
...
Primary products for this skill: Fuel terminal defense matrix, transfer-node continuity plan, fuel flow risk tracker.
