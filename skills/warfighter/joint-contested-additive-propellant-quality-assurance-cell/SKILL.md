---
name: joint-contested-additive-propellant-quality-assurance-cell
description: Support joint quality-assurance planning for additive-manufactured propellant components and related energetics under denied logistics.
---
...
Primary products for this skill: propellant QA release ladder, additive process control board, mission risk and hold-point matrix.
...
- For this domain, prioritize `ts-additive-propellant-qa-v1` with `ps-additive-propellant-qa-stack-v1` and `DPL-ADDITIVE-PROPELLANT-QA-001`.
