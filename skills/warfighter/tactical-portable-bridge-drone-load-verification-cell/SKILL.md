---
name: tactical-portable-bridge-drone-load-verification-cell
description: Support tactical route-opening planning with rapid drone-based assessment of portable bridge placement, span integrity, and load safety under fire.
---
...
Primary products for this skill: bridge placement and span-confidence board, load class recommendation ladder, crossing sequence timeline.
...
- For this domain, prioritize `ts-portable-bridge-drone-load-v1` with `ps-portable-bridge-drone-load-stack-v1` and `DPL-PORTABLE-BRIDGE-DRONE-LOAD-001`.
