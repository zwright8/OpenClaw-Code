---
name: joint-ai-enabled-collection-gaps-optimizer-cell
description: Prioritize ISR collection gap closure across joint sensors and partner reporting streams.
---
...
Primary products for this skill: collection gap closure plan, sensor retask recommendation set, confidence-weighted collection dashboard.
