---
name: expeditionary-biomass-to-fuel-conversion-cell
description: Plan biomass-to-fuel conversion options to extend expeditionary energy endurance under contested supply lines.
---
...
Primary products for this skill: fuel conversion feasibility brief, feedstock prioritization matrix, output quality risk ledger.
...
- `tool_suite_id`: `ts-biomass-fuel-expeditionary-v1`
- `protocol_stack_id`: `ps-expeditionary-energy-conversion-stack-v1`
