---
name: strategic-cognitive-warfare-attribution-and-response-cell
description: Support U.S. warfighter and strategic leadership planning for coordinated cognitive warfare attribution, campaign-impact assessment, and response-option governance.
---
...
Primary products for this skill: influence-attribution confidence ladder, response-option governance matrix, strategic messaging release packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: cross-platform narrative telemetry analyzers, attribution adjudication boards, policy-legal response workflow engines.
...
- Prefer protocol families: STIX/TAXII, NIEM, USMTF, NATO APP-11/ADatP-3 aligned, API/JSON.
...
- Primary: tool_suite_id=ts-strategic-cognitive-warfare-attribution-response-v1 with protocol_stack_id=ps-strategic-cognitive-warfare-attribution-response-stack-v1.
- Alternate: tool_suite_id=ts-disinformation-counter-v1 with protocol_stack_id=ps-disinformation-counter-stack-v1.
- Degraded: authenticated voice/readback plus UTC acknowledgment ledger and manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-STRATEGIC-COGNITIVE-WARFARE-001, DPL-STRATEGIC-COGNITIVE-WARFARE-002.
