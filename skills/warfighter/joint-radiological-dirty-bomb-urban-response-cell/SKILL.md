---
name: joint-radiological-dirty-bomb-urban-response-cell
description: Coordinate military support for radiological dispersal incidents in dense urban terrain with consequence management, hazard control, and civil authority integration. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: radiological hazard control overlay, decontamination prioritization matrix, urban restoration branch plan.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: radiation sensor fusion dashboards, plume and fallout modeling tools, urban infrastructure status boards, emergency coordination systems.
- Prioritize these protocol families for this domain: EDXL-DE/CAP, USMTF, API/JSON, NIMS/ICS.
