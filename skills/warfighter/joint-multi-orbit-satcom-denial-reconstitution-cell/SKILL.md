---
name: joint-multi-orbit-satcom-denial-reconstitution-cell
description: Coordinate resilient SATCOM restoration across LEO/MEO/GEO and alternative comm paths during adversary denial campaigns.
---
...
Primary products for this skill: multi-orbit SATCOM restoration matrix, mission path failover timeline, denied-communications reconstitution branch chart.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-multi-orbit-satcom-reconstitution-v1` with `protocol_stack_id=ps-multi-orbit-satcom-reconstitution-stack-v1`.
...
- Default packet IDs: DPL-MULTI-ORBIT-SATCOM-RECONSTITUTION-001.
