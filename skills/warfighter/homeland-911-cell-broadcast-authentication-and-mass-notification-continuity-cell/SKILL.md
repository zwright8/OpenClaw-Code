...
description: Support U.S. warfighter planning for emergency-warning authenticity, 911 continuity, and mass-notification trust under disruption.
---
...
Use these tool categories by default: emergency alert authenticity analyzers, PSAP continuity dashboards, and public-warning release governance boards.

## Protocol Profile

Preferred protocol families for this skill: EDXL-DE/CAP, NIMS/ICS, NIEM, USMTF, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-HOMELAND-911-CELL-BROADCAST-AUTHENTICATION-MASS-NOTIFICATION-CONTINUITY-001 for critical recommendations.
