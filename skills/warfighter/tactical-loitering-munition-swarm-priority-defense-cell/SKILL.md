---
name: tactical-loitering-munition-swarm-priority-defense-cell
description: Prioritize defended assets and interception timing against loitering-munition swarm attacks.
---
...
Primary products: swarm defense priority matrix, interceptor allocation ladder, tactical defense packet.
...
- Primary: `tool_suite_id=ts-tactical-loitering-munition-swarm-priority-defense-v1` with `protocol_stack_id=ps-tactical-loitering-munition-swarm-priority-defense-stack-v1`.
...
- Default packet IDs: `DPL-TACTICAL-LOITERING-MUNITION-SWARM-PRIORITY-DEFENSE-001`.
