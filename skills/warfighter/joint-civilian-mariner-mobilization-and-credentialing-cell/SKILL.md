---
name: joint-civilian-mariner-mobilization-and-credentialing-cell
description: Support surge mobilization of U.S. civilian mariners with credential verification, force-protection controls, and port assignment under crisis.
---
...
Primary products for this skill: mariner mobilization roster, credential exception ladder, sealift assignment timeline.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: mariner credential registry, sealift crew management, port readiness dashboards.
- Preferred protocol profiles for coordination and machine exchange: USMTF, XML, API/JSON.
...
- Default packet binding for this domain: DPL-MARINER-MOBILIZATION-001.
