---
name: coalition-denied-terrain-bridge-airdrop-synchronization-cell
description: Support U.S. warfighter planning and operational decision support for Coalition Denied Terrain Bridge Airdrop Synchronization Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: terrain constraints, airdrop windows, coalition authorities, mobility asset status.
...
Primary products for this skill: bridge-airdrop synchronization plan, terrain access risk board, coalition corridor timing matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: mobility engineering tools, airlift planning systems, coalition coordination portals, geospatial analytics stacks.
...
- Prefer these protocol families for this skill: VMF, USMTF, OGC.
