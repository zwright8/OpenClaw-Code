---
name: joint-electronic-protection-and-spectrum-maneuver-cell
description: Drive joint electronic protection and spectrum maneuver planning to preserve mission communications and emitter survivability.
---
...
- Use packet template DPL-ELECTRONIC-PROTECTION-MANEUVER-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-joint-electronic-protection-spectrum-maneuver-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-joint-electronic-protection-spectrum-maneuver-v1 with protocol_stack_id=ps-joint-electronic-protection-spectrum-maneuver-stack-v1.
...
- Default packet ID: DPL-ELECTRONIC-PROTECTION-MANEUVER-001.
