---
name: joint-urban-subterranean-life-support-and-denial-cell
description: Support U.S. warfighter planning and operational decision support for Joint Urban Subterranean Life Support And Denial Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---

# Joint Urban Subterranean Life Support And Denial Cell
...
Primary products for this skill: subterranean sustainment map, life-support vulnerability matrix, branch contingency board.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: underground mapping systems, environmental sensing stacks, engineer route planning tools, C2 mission boards.
...
- Prefer these protocol families for this skill: OGC, CoT, USMTF.
