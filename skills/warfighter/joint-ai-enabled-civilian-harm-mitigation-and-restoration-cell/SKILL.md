---
name: joint-ai-enabled-civilian-harm-mitigation-and-restoration-cell
description: Support commanders with pre-strike civilian harm mitigation options and post-strike restoration sequencing under joint and coalition constraints.
---

# Joint AI-Enabled Civilian Harm Mitigation And Restoration Cell
...
Primary products for this skill: civilian harm mitigation option matrix, protected-site confidence ledger, restoration sequencing packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: targeting collateral-estimation engines, humanitarian impact dashboards, infrastructure restoration planners.

## Protocol Profile

Preferred protocol families for this skill: USMTF, VMF, OGC, NATO APP-11/ADatP-3.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-civilian-harm-restoration-v1`.
...
- Prefer `tool_suite_id=ts-civilian-harm-restoration-v1` for primary decision support and bind to mission packet `DPL-CIVHARM-RESTORE-001`.
- Use `tool_suite_id=ts-civil-support-v1` as required cross-check for divergence or trust-score decay.
- Include `packet_id=DPL-CIVHARM-RESTORE-001`, `protocol_profile`, `ack_chain_status`, and `trust_score` in all commander-facing outputs.
