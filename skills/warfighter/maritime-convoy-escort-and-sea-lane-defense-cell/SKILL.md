---
name: maritime-convoy-escort-and-sea-lane-defense-cell
description: Coordinate convoy escort composition, route defense, and threat response for sea-lane protection. Use when balancing merchant throughput, submarine threat, and air cover constraints.
---
...
Primary products for this skill: Convoy escort assignment matrix, sea-lane threat response board, reroute trigger framework.
