---
name: contested-spaceport-rapid-launch-pad-decontamination-cell
description: Coordinate rapid launch-pad decontamination and safe relaunch gating after toxic propellant or sabotage incidents.
---
...
- Primary: `tool_suite_id=ts-spaceport-launch-pad-decontamination-v1` with `protocol_stack_id=ps-spaceport-launch-pad-decontamination-stack-v1`.
...
- Default packet IDs: `DPL-SPACEPORT-LAUNCH-PAD-DECONTAMINATION-001`.
