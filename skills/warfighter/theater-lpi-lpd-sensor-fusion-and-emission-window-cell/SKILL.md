---
name: theater-lpi-lpd-sensor-fusion-and-emission-window-cell
description: Support U.S. warfighter planning and decision support for Theater LPI LPD Sensor Fusion And Emission Window Cell. Use when missions require LPI/LPD emission-window governance, sensor fusion timing, and contested-signature mission execution, integrated options, and protocol-aware staff outputs.
---

# Theater LPI LPD Sensor Fusion And Emission Window Cell
...
Primary products for this skill: emission window battle rhythm, low-observable sensor plan, signature risk-control matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: electromagnetic spectrum COP, multi-sensor fusion services, waveform governance tools, mission thread synchronizers.

## Protocol Profile

Preferred protocol families for this skill: Link 16 J-series, VMF, API/JSON.
...
- Start with tool_suite_id=ts-lpi-lpd-emission-window-orchestration-v1 and protocol_stack_id=ps-lpi-lpd-emission-window-stack-v1, then branch only when mission constraints require it.
