---
name: coalition-autonomous-border-interdiction-liability-governance-cell
description: Support U.S. and coalition warfighter planning for autonomous border interdiction governance, liability partitioning, and escalation-safe adjudication workflows.
---
...
Primary products for this skill: autonomous interdiction governance packet, liability decision matrix, escalation and legal branch triggers.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: coalition border COP, autonomy-event audit ledger, legal adjudication board, identity verification cross-check service.
...
- Prefer these protocol families for this skill: NATO APP-11/ADatP-3, NIEM, API/JSON, signed legal manifests.
