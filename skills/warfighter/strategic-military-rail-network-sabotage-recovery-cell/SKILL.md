---
name: strategic-military-rail-network-sabotage-recovery-cell
description: Coordinate military rail throughput restoration after sabotage, precision strike, and cyber-physical disruption.
---
...
Primary products for this skill: rail chokepoint restoration sequence, throughput risk register, reroute authority tracker.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: rail network COP, bridge/tunnel integrity monitoring, strategic lift scheduler.
- Preferred protocol profiles for coordination and machine exchange: USMTF, NIMS/ICS, API/JSON.
...
- Default packet binding for this domain: DPL-RAIL-SABOTAGE-RECOVERY-001.
