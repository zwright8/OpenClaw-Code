---
name: coalition-contested-port-crane-cyber-physical-recovery-cell
description: Support coalition recovery of cyber-disrupted port crane operations with safety-gated throughput restoration and sabotage containment.
---
...
Primary products: crane cyber-physical isolation order, berth throughput reflow plan, and recovery risk register.

## Domain Toolchain Defaults

- Primary: tool_suite_id=ts-port-crane-cyber-physical-recovery-v1 with protocol_stack_id=ps-port-crane-cyber-physical-recovery-stack-v1.
...
- Default packet IDs: DPL-PORT-CRANE-CYBER-PHYSICAL-RECOVERY-001.
