---
name: joint-gray-zone-influence-campaign-detection-and-countermessaging-cell
description: Detect and counter coordinated gray-zone influence operations targeting U.S. and partner military objectives while preserving legal and policy constraints.
---

# Joint Gray-Zone Influence Campaign Detection and Countermessaging Cell
...
Primary products for this skill: influence threat heatmap, attribution confidence ladder, counter-message action board.

## External Tools and Protocol Integration

- Suggested tools: OSINT/social media trend analytics, GDELT event feeds, DISN public affairs channels, MISO planning tools.
- Protocol/message standards: STIX 2.1, TAXII 2.1, USMTF, OASIS CAP.
