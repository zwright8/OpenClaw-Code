---
name: joint-rail-node-sabotage-attribution-and-recovery-cell
description: Coordinate sabotage attribution and throughput recovery for critical military rail nodes. Use when rail disruption threatens strategic mobility and force flow.
---
...
Primary products for this skill: rail sabotage attribution confidence brief, repair-and-recovery sequencing matrix, throughput restoration timeline.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-rail-bridge-recovery-v1` with `protocol_stack_id=ps-rail-mobility-recovery-stack-v1`.
