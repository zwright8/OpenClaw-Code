---
name: targeting-cycle-manager
description: Manage joint targeting cycle support across deliberate and dynamic conditions. Use when prioritizing targets, validating effects, and aligning fires with command objectives.
---

# Targeting Cycle Manager
...
1. Frame the mission problem using these core inputs: commander objectives, target nominations, collateral constraints, battle damage indicators.
...
Primary products for this skill: joint integrated prioritized target list support brief, target synchronization matrix, assessment update.
