---
name: expeditionary-water-purification-membrane-integrity-cell
description: Assure potable water continuity by detecting membrane degradation, contamination, and maintenance risk in austere operations. Use when water production reliability drives force endurance.
---
...
Primary products for this skill: water membrane health report, contamination branch matrix, sustainment maintenance forecast.

## Domain Tool Stack

Use these tool categories as the baseline stack: water quality analyzers, purification telemetry systems, predictive maintenance boards, expeditionary lab verification tools.

## Protocol Profile

Preferred protocol families for this skill: EPA water telemetry profiles, API/JSON, OGC sensor feeds, CoT.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-expeditionary-water-membrane-integrity-v1` with `protocol_stack_id=ps-expeditionary-water-membrane-integrity-stack-v1`.
- Alternate: `tool_suite_id=ts-contested-austere-water-production-v1` with `protocol_stack_id=ps-contested-austere-water-production-stack-v1`.
...
- Default packet IDs: DPL-EXPEDITIONARY-WATER-MEMBRANE-INTEGRITY-001, DPL-CONTESTED-WATER-PRODUCTION-001.
