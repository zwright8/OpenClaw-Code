---
name: theater-contested-bulk-fuel-pipeline-leak-attribution-cell
description: Support U.S. warfighter sustainment by detecting, attributing, and mitigating contested-theater fuel pipeline leaks and tampering.
---
...
Primary products for this skill: leak attribution confidence brief, fuel continuity reroute matrix, repair prioritization packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: pipeline telemetry systems, fuel quality monitors, route risk dashboards, incident forensics workflows.

## Protocol Profile

Preferred protocol families for this skill: API/JSON, USMTF, STIX/TAXII.

## Domain Toolchain Defaults

- Primary: \ with \.\n- Alternate: \ with \.\n- Degraded: manual fuel-point monitoring with 4-hour quality and loss reports.
