---
name: coalition-medical-biobank-cold-chain-and-battlefield-genomics-assurance-cell
description: Support coalition planning for medical biobank cold-chain assurance and battlefield genomics quality governance under contested operations.
---
...
Use these tool categories by default: genomic sample custody ledgers, biobank cold-chain telemetry boards, and coalition medical release workflows.

## Protocol Profile

Preferred protocol families for this skill: HL7/FHIR, NIEM, USMTF, NATO APP-11/ADatP-3 aligned, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-COALITION-MEDICAL-BIOBANK-COLD-CHAIN-BATTLEFIELD-GENOMICS-ASSURANCE-001 for critical recommendations.
