---
name: public-affairs-operational-communications
description: Develop public affairs and command information plans aligned with operational objectives. Use when preparing messaging lines, media engagement, and communication risk mitigation.
---

# Public Affairs and Operational Communications
...
1. Frame the mission problem using these core inputs: commander themes, public affairs guidance, media environment, incident timeline.
...
Primary products for this skill: public affairs plan, key message matrix, media engagement decision guide.
...
- Add `toolchain_id=TC-FATALITY-278`, `tool_suite_id=ts-homeland-fatality-management-morgue-family-assistance-v1`, and `protocol_stack_id=ps-homeland-fatality-management-morgue-family-assistance-stack-v1` when operational communications depend on family-assistance-center status, dignified fatality messaging, or morgue-capacity-linked release timing.
...
- Add `toolchain_id=TC-WATERCOM-280`, `tool_suite_id=ts-homeland-boil-water-food-safety-commodities-distribution-v1`, and `protocol_stack_id=ps-homeland-boil-water-food-safety-commodities-distribution-stack-v1` when messaging depends on boil-water advisories, POD activation, or food-safety restrictions.
...
- Add `toolchain_id=TC-COMEX-284`, `tool_suite_id=ts-joint-commissary-exchange-subsistence-hygiene-restoration-v1`, and `protocol_stack_id=ps-joint-commissary-exchange-subsistence-hygiene-restoration-stack-v1` when public messaging depends on transparent rationing, essential-item access, or retail-restoration timelines for warfighter families.
- Add `toolchain_id=TC-REENTRY-285`, `tool_suite_id=ts-joint-installation-access-badge-curfew-reentry-v1`, and `protocol_stack_id=ps-joint-installation-access-badge-curfew-reentry-stack-v1` when operational communications depend on phased reentry windows, badge reissue timelines, or curfew exception legitimacy.
- Add `toolchain_id=TC-BPHARM-286`, `tool_suite_id=ts-joint-base-pharmacy-refill-tricare-coldchain-v1`, and `protocol_stack_id=ps-joint-base-pharmacy-refill-tricare-coldchain-stack-v1` when public information must address refill continuity, override routes, or medication-protection measures without creating privacy or panic risk.
- Add `toolchain_id=TC-ANIMAL-288`, `tool_suite_id=ts-joint-service-animal-family-pet-evacuation-shelter-v1`, and `protocol_stack_id=ps-joint-service-animal-family-pet-evacuation-shelter-stack-v1` when warning language depends on service-animal accommodation, pet-shelter rules, or refusal-to-evacuate risk.
- Add `packet_id=DPL-COMMISSARY-EXCHANGE-HYGIENE-001`, `packet_id=DPL-ACCESS-BADGE-CURFEW-REENTRY-001`, `packet_id=DPL-BASE-PHARMACY-TRICARE-COLDCHAIN-001`, and `packet_id=DPL-SERVICE-ANIMAL-PET-EVAC-001` for branches that materially alter public-release timing, warning content, or community-trust posture.
