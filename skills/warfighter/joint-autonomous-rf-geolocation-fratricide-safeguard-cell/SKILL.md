---
name: joint-autonomous-rf-geolocation-fratricide-safeguard-cell
description: Prevent fratricide from autonomous RF geolocation and emitter targeting recommendations. Use when U.S. forces need cross-domain emitter identity confidence, kill-chain safeguards, and protocol-verified mission authorization under contested spectrum conditions.
---
...
Primary products for this skill: RF geolocation confidence ledger, fratricide safeguard matrix, emitter-identity adjudication packet.

## Domain Tool Stack

Use these tool categories as the baseline stack: spectrum situational awareness systems, emitter identity repositories, kill-chain authorization boards, EW incident forensics tools.

## Protocol Profile

Preferred protocol families for this skill: Link 16 J-series, VMF, STANAG 5516/4586, JREAP-C.
