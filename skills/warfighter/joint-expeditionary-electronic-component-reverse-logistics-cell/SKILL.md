---
name: joint-expeditionary-electronic-component-reverse-logistics-cell
description: Plan reverse logistics for damaged electronic components to restore mission systems faster. Use when forward repair, secure return, and component attribution must be synchronized.
---
...
Primary products for this skill: component recovery priority queue, reverse-logistics route matrix, repair-versus-replace decision board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-electronics-reverse-logistics-v1` with `protocol_stack_id=ps-electronics-reverse-logistics-stack-v1`.
- Alternate: `tool_suite_id=ts-logistics-distribution-v1` with `protocol_stack_id=ps-intermodal-rail-airfield-stack-v1`.
...
- Default packet IDs: DPL-ELEC-REVERSE-LOG-001.
