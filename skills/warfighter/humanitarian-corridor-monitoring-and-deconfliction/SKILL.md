---
name: humanitarian-corridor-monitoring-and-deconfliction
description: Design and monitor humanitarian corridors with real-time deconfliction across military, host-nation, and aid actors. Use when enabling protected movement in unstable operational environments.
---
...
1. Frame the mission problem using these core inputs: corridor geometry, actor movement schedules, threat reporting, and humanitarian priority locations.
...
Primary products for this skill: humanitarian corridor control plan, movement deconfliction board, protected access risk assessment.
