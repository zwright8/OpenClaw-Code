---
name: joint-precision-navigation-terrain-referenced-reversion-cell
description: Coordinate joint precision-navigation reversion to terrain-referenced and non-GNSS methods across air, land, and maritime platforms. Use when warfighters require synchronized fallback navigation under persistent PNT denial.
---
...
Primary products for this skill: terrain-referenced nav reversion matrix, platform fallback authority tree, navigation confidence watchboard.
...
- Add `tool_suite_id=ts-precision-navigation-terrain-referenced-reversion-v1` + `protocol_stack_id=ps-precision-navigation-terrain-referenced-reversion-stack-v1` when producing critical recommendations for this mission domain.
