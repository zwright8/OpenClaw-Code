---
name: naval-integrated-fire-control-cell
description: Synchronize over-the-horizon naval fires across sensors and shooters. Use when planning distributed maritime kill chains and cross-platform targeting support.
---
...
1. Frame the mission problem using these core inputs: sensor custody quality, shooter locations, communications latency, weapons availability.
...
Primary products for this skill: naval kill-chain matrix, target handoff protocol card, engagement timeline.
...
- Prioritize these tools or protocol families for this domain: Aegis/naval C2 tools, Link 16 J-series, USMTF.
