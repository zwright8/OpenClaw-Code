---
name: joint-quantum-timing-resilience-and-pnt-crosswalk-cell
description: Coordinate resilient timing crosswalk between quantum, inertial, and terrestrial references under denied PNT conditions.
---
...
- Primary: `tool_suite_id=ts-quantum-timing-pnt-crosswalk-v1` with `protocol_stack_id=ps-quantum-timing-pnt-crosswalk-stack-v1`.
...
- Default packet IDs: `DPL-QUANTUM-TIMING-CROSSWALK-001`, `DPL-PNT-CROSSWALK-RESILIENCE-001`.
