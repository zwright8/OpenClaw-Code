---
name: cislunar-space-domain-awareness-support
description: Support cislunar and deep-space domain awareness decision support for U.S. warfighter space operations. Use when missions require anomaly triage and service assurance beyond geosynchronous regimes.
---
...
1. Frame the mission problem using these core inputs: orbital catalog updates, conjunction warnings, comms degradation indicators, and mission service dependencies.
...
Primary products for this skill: cislunar object-priority board, service-impact forecast, restoration decision matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: space domain awareness catalogs, SATCOM monitoring dashboards, mission service dependency maps.
...
- Prefer these protocol families for this skill: API/JSON, USMTF, STIX/TAXII, OGC.
