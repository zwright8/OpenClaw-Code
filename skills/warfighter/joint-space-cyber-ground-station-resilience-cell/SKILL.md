---
name: joint-space-cyber-ground-station-resilience-cell
description: Harden and recover satellite ground-station operations under cyber attack and electronic interference. Use when planning continuity of satellite command and data services.
---
...
1. Frame the mission problem using these core inputs: ground station topology, cyber alerts, EW interference reports, mission support priorities.
...
Primary products for this skill: ground-station resilience plan, continuity-of-operations trigger matrix, service restoration sequence.
