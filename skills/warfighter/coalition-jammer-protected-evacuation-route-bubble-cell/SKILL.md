---
name: coalition-jammer-protected-evacuation-route-bubble-cell
description: Coordinate jammer-protected evacuation route bubbles for coalition casualty and civilian movement under drone threat.
---
...
Primary products for this skill: evac route jammer bubble plan, protected movement timing board, interference and deconfliction matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-drone-jammer-evac-route-bubble-v1` with `protocol_stack_id=ps-drone-jammer-evac-route-bubble-stack-v1`.
...
- Default packet IDs: DPL-DRONE-JAMMER-EVAC-ROUTE-BUBBLE-001.
