---
name: theater-human-machine-battle-staff-cognitive-load-balancing-cell
description: Balance human-machine battle staff workload and decision velocity. Use when AI copilots, watchfloor alerts, and staff battle rhythm overload command teams in high-tempo operations.
---
...
1. Frame the mission problem using these core inputs: battle rhythm events, watchfloor alert volume, staffing availability, decision cycle deadlines, automation confidence scores.
...
Primary products for this skill: cognitive load heat map, staff-task reallocation plan, commander decision-velocity risk board.
...
- Add `tool_suite_id=ts-battle-staff-cognitive-load-balancing-v1` + `protocol_stack_id=ps-battle-staff-cognitive-load-balancing-stack-v1` when this domain is mission-critical in current planning.
- Add `packet_id=DPL-BATTLE-STAFF-COGNITIVE-LOAD-001` for branches that can materially alter mission posture or civil-protection outcomes.
