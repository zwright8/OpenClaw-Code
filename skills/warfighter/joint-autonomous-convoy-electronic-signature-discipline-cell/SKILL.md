---
name: joint-autonomous-convoy-electronic-signature-discipline-cell
description: Enforce electromagnetic signature discipline for autonomous logistics convoys under adversary sensing and targeting pressure.
---
...
Primary products for this skill: signature-control schedule, convoy emission risk ladder, deception/reconfiguration branch triggers.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: convoy telemetry COP, emission monitoring analytics, route threat prediction services.
- Preferred protocol profiles for coordination and machine exchange: CoT, USMTF, API/JSON.
...
- Default packet binding for this domain: DPL-AUTONOMOUS-CONVOY-SIGNATURE-001.
