---
name: special-operations-maritime-infiltration-tide-traffic-signature-cell
description: Support special operations maritime infiltration/exfiltration planning by fusing tide, traffic, and signature discipline constraints in contested littoral environments.
---
...
Primary products for this skill: infiltration timing and route branch plan, signature exposure risk matrix, maritime exfiltration fallback decision ladder.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: littoral tide and currents forecasters, maritime traffic pattern analyzers, ISR signature risk boards, SOF branch-and-sequel planners.
...
- Prefer these protocol families for this skill: AIS/NMEA, CoT, VMF, API/JSON.
