---
name: tactical-biometrics-spoof-detection-checkpoint-assurance-cell
description: Detect spoofed biometric identities at tactical checkpoints and coordinate lawful adjudication workflows for partner and U.S. forces.
---
...
Primary products for this skill: checkpoint identity spoof-confidence ledger, adjudication escalation matrix, false-acceptance reduction packet.
...
- Add `tool_suite_id=ts-biometrics-spoof-detection-checkpoint-assurance-v1` + `protocol_stack_id=ps-biometrics-spoof-detection-checkpoint-assurance-stack-v1` when producing critical recommendations for this mission domain.
