---
name: theater-electronic-signature-logistics-convoy-masking-cell
description: Mask and reshape convoy signatures to reduce adversary detection while maintaining theater sustainment throughput.
---
...
Primary products for this skill: convoy signature masking schedule, decoy route matrix, detection-risk versus throughput curve.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-logistics-signature-masking-v1` with `protocol_stack_id=ps-logistics-signature-masking-stack-v1`.
...
- Default packet IDs: DPL-LOGISTICS-SIGNATURE-MASKING-001.
