---
name: tactical-subterranean-robotic-recon-and-breach-cell
description: Coordinate subterranean robotic reconnaissance and breach planning in tunnels and dense underground infrastructure. Use when denied visibility, trapped hazards, and comms degradation shape assault decisions.
---

# Tactical Subterranean Robotic Recon And Breach Cell
...
- Use packet template DPL-SUBTERRANEAN-ROBOTICS-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-subterranean-robotic-recon-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-subterranean-robotic-recon-v1 with protocol_stack_id=ps-subterranean-robotic-stack-v1.
...
- Default packet ID: DPL-SUBTERRANEAN-ROBOTICS-001.
