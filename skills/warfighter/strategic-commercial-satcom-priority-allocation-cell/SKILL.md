---
name: strategic-commercial-satcom-priority-allocation-cell
description: Allocate commercial SATCOM capacity by mission priority during contested demand surges. Use when military and coalition users compete for constrained orbital bandwidth.
---
...
Primary products for this skill: priority allocation board, SATCOM preemption branch matrix, mission-impact comms risk brief.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-orbital-spectrum-continuity-v1` with `protocol_stack_id=ps-satcom-antijam-reconstitution-stack-v1`.
- Alternate: `tool_suite_id=ts-space-satcom-v1` with `protocol_stack_id=ps-space-weather-gnss-fusion-stack-v1`.
