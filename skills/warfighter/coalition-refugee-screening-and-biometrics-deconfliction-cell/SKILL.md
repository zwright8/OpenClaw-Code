---
name: coalition-refugee-screening-and-biometrics-deconfliction-cell
description: Coordinate refugee screening with biometric deconfliction, humanitarian access, and force protection safeguards. Use during mass displacement near operating areas.
---
...
1. Frame the mission problem using these core inputs: population movement flows, biometric enrollment quality, watchlist and derogatory hits, host-nation legal constraints.
...
Primary products for this skill: refugee screening operations plan, biometric deconfliction exception ledger, humanitarian-force-protection balance matrix.
...
- Primary: `tool_suite_id=ts-refugee-biometrics-deconfliction-v1` with `protocol_stack_id=ps-humanitarian-screening-biometrics-stack-v1`.
