---
name: contested-arctic-multi-domain-recovery-and-extraction-cell
description: Coordinate contested Arctic personnel and platform recovery in multi-domain operations. Use when planning extraction chains, weather-limited rescue windows, and authority-gated cross-domain recovery sequencing for U.S. warfighters and coalition partners.
---

# Contested Arctic Multi-Domain Recovery and Extraction Cell
...
Primary products for this skill: Arctic recovery branch matrix, extraction corridor synchronization packet, and recovery risk/authority ledger.
...
- Add `tool_suite_id=ts-contested-arctic-personnel-recovery-and-extraction-v1` + `protocol_stack_id=ps-contested-arctic-personnel-recovery-and-extraction-stack-v1` for this mission domain as default external integration profile.
- Add `packet_id=DPL-CONTESTED-ARCTIC-PERSONNEL-RECOVERY-AND-EXTRACTION-001` for mission branches that can alter force posture, mission risk, or escalation dynamics.
