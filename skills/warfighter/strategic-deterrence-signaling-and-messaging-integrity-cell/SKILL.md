---
name: strategic-deterrence-signaling-and-messaging-integrity-cell
description: Design strategic deterrence messaging options with integrity checks, escalation guardrails, and coalition synchronization. Use when commanders need high-consequence signaling recommendations with explicit external tool/protocol bindings and human authority gates.
---
...
Primary products for this skill: deterrence signaling matrix, narrative integrity risk board, escalation-safe release timeline.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools for this domain: strategic messaging workflow boards, narrative tamper-detection analytics, coalition release-adjudication trackers, public-attribution confidence monitors.
- Prioritize these protocol families for this domain: USMTF, STIX/TAXII, NIEM, API/JSON.
...
- Include tool_suite_id=ts-strategic-deterrence-signaling-and-messaging-integrity-cell-v1, protocol_stack_id=ps-strategic-deterrence-signaling-and-messaging-integrity-cell-stack-v1, and packet_id=DPL-DETERRENCE-MESSAGING-INTEGRITY-001 for each critical recommendation.
