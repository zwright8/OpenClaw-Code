---
name: joint-autonomous-convoy-legal-liability-governance-cell
description: Govern autonomous convoy operations with legal liability controls, safety evidence, and command authority routing.
---
...
Primary products for this skill: autonomous convoy governance packet, liability risk matrix, authority escalation chain.
...
- `tool_suite_id`: `ts-autonomous-convoy-liability-v1`
- `protocol_stack_id`: `ps-autonomous-convoy-liability-stack-v1`
