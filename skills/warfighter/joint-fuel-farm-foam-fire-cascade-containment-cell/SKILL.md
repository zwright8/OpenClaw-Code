---
name: joint-fuel-farm-foam-fire-cascade-containment-cell
description: Contain cascading fuel farm fires and foam-system failures while preserving operational fuel throughput.
---
...
Primary products: fuel fire cascade impact board, suppression branch schedule, fuel continuity authority packet.
...
- Primary: `tool_suite_id=ts-joint-fuel-farm-foam-fire-cascade-containment-v1` with `protocol_stack_id=ps-joint-fuel-farm-foam-fire-cascade-containment-stack-v1`.
...
- Default packet IDs: `DPL-JOINT-FUEL-FARM-FOAM-FIRE-CASCADE-001`.
