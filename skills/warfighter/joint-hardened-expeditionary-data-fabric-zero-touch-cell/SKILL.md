---
name: joint-hardened-expeditionary-data-fabric-zero-touch-cell
description: Stand up and sustain zero-touch expeditionary data fabrics with policy and security hardening. Use when distributed forces require resilient data exchange in denied and intermittent networks.
---

# Joint Hardened Expeditionary Data Fabric Zero Touch Cell
...
1. Frame the mission problem using these core inputs: data contract priorities, enclave boundaries, link constraints, policy enforcement requirements, and identity posture.
...
Primary products for this skill: zero-touch deployment blueprint, data-fabric trust scorecard, continuity and rollback playbook.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: data-fabric orchestration services, schema translation validators, zero-trust policy enforcement engines.

## Protocol Profile

Preferred protocol families for this skill: API/JSON, STIX/TAXII, USMTF, CoT.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-expeditionary-data-fabric-zero-touch-hardening-v1` with `protocol_stack_id=ps-expeditionary-data-fabric-zero-touch-hardening-stack-v1`.
- Alternate:   `tool_suite_id=ts-coalition-data-fabric-interoperability-v1` with `protocol_stack_id=ps-coalition-data-fabric-interoperability-stack-v1`.
...
- Default packet IDs: DPL-EXPEDITIONARY-DATA-FABRIC-ZERO-TOUCH-HARDENING-001, DPL-COALITION-DATA-FABRIC-INTEROP-001.
