---
name: coalition-port-cyber-physical-threat-fusion-cell
description: Provide U.S. warfighter decision support for Coalition Port Cyber Physical Threat Fusion Cell missions, including joint planning outputs, external tool usage, and protocol-aware fallback actions.
---
