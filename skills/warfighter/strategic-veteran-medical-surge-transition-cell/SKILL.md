---
name: strategic-veteran-medical-surge-transition-cell
description: Coordinate strategic transition of wounded service members into veteran care networks during surge conditions. Use when military-to-VA handoff capacity, specialty care matching, and continuity-of-care risk are mission-critical.
---
...
Primary products for this skill: military-to-VA transition queue, specialty-care bed brokerage plan, continuity-of-care risk and follow-up tracker.
...
- Prioritize tool_suite_id=ts-veteran-medical-surge-transition-v1 + protocol_stack_id=ps-veteran-medical-surge-transition-stack-v1 when sustained casualty flows require synchronized DoD-to-VA care transfer without continuity loss.
- Add packet_id=DPL-VETERAN-MEDICAL-SURGE-TRANSITION-001 for recommendation branches that alter transfer priorities, specialty matching, or family-notification and follow-up timelines.
