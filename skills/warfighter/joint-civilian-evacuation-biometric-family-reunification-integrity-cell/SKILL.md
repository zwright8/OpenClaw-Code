...
description: Support U.S. warfighter planning for biometric identity assurance and family-reunification integrity during large-scale civilian evacuations.
---
...
Use these tool categories by default: evacuation identity reconciliation boards, biometric confidence engines, and reunification workflow trackers.

## Protocol Profile

Preferred protocol families for this skill: NIMS/ICS, NIEM, USMTF, EDXL-DE/CAP, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-JOINT-CIVILIAN-EVACUATION-BIOMETRIC-FAMILY-REUNIFICATION-INTEGRITY-001 for critical recommendations.
