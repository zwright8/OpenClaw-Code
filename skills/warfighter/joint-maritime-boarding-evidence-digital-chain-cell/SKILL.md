---
name: joint-maritime-boarding-evidence-digital-chain-cell
description: Support U.S. warfighter and coalition maritime interdiction operations with auditable digital chain-of-evidence across boarding teams.
---
...
Primary products for this skill: boarding evidence chain packet, legal admissibility risk register, custody transfer timeline.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: maritime interdiction planning tools, digital evidence capture systems, biometric verification services, custody audit ledgers.

## Protocol Profile

Preferred protocol families for this skill: AIS/NMEA, USMTF, API/JSON.

## Domain Toolchain Defaults

- Primary: \ with \.\n- Alternate: \ with \.\n- Degraded: paper-backed custody chain with signed digital hash reconciliation.
...
- Prefer these protocol families for this skill: AIS/NMEA, USMTF, API/JSON.
