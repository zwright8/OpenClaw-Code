---
name: theater-disconnected-identity-wallet-and-credential-continuity-cell
description: Maintain identity assurance and credential continuity for coalition operators and critical civilians during prolonged disconnected operations.
---
...
Primary products for this skill: credential continuity branch plan, revocation-and-rekey matrix, offline trust recovery timeline.
...
- Prioritize these domain tools: identity federation controllers, offline credential wallet services, revocation ledgers, coalition access governance workflows.
- Prioritize these protocol families: USMTF, NATO APP-11/ADatP-3 aligned, API/JSON.
...
- `tool_suite_id`: `ts-disconnected-identity-continuity-v1`
- `protocol_stack_id`: `ps-disconnected-identity-continuity-stack-v1`
