---
name: expeditionary-airfield-operations
description: Coordinate setup and sustainment of expeditionary airfields for distributed operations. Use when assessing runway suitability, sortie generation, and base support limitations.
---
...
1. Frame the mission problem using these core inputs: runway status, engineer support, fuel stocks, aircraft mix.
...
Primary products for this skill: expeditionary airfield operations plan, sortie generation estimate, critical shortfall tracker.
