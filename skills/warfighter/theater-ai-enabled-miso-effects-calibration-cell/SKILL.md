---
name: theater-ai-enabled-miso-effects-calibration-cell
description: Calibrate AI-assisted MISO products against observed audience behaviors, adversary adaptation, and escalation risk in contested information environments.
---
...
Primary products for this skill: MISO effects calibration scorecard, audience response confidence ledger, release/hold branch triggers.
...
- Add `tool_suite_id=ts-ai-enabled-miso-effects-calibration-v1` + `protocol_stack_id=ps-ai-enabled-miso-effects-calibration-stack-v1` when producing critical recommendations for this mission domain.
