---
name: joint-allied-data-link-interoperability-cell
description: Support U.S. warfighter planning and decision support for Joint Allied Data Link Interoperability Cell. Use when missions require multinational data-link interoperability planning, gateway routing, and coalition message quality assurance, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: coalition link architecture plan, gateway routing matrix, interoperability fault log.
...
- Prioritize these tools or protocol families for this domain: mission data link managers, coalition C2 gateways, spectrum management tools.
- State the protocol or message format for outbound coordination (for example Link 16 J-series, NATO APP-11/ADatP-3, USMTF).
