---
name: contested-polar-satcom-restoration-cell
description: Plan and synchronize SATCOM restoration for Arctic and high-latitude operations under jamming, weather, and infrastructure disruption. Use when polar communications are degraded or denied and mission continuity depends on alternate paths.
---
...
1. Frame the mission problem using these core inputs: jamming/interference telemetry, high-latitude weather/ionospheric effects, SATCOM gateway status, mission criticality tiers.
...
Primary products for this skill: polar SATCOM restoration matrix, alternate bearer plan, service-priority cutover order.
...
- Prioritize these tools or tool families for this domain: SATCOM network management systems, SDA catalogs, spectrum analyzers, gateway monitoring dashboards.
- Specify outbound exchange format for recommendations and tasking: USMTF, API/JSON, STIX/TAXII, Link 16 J-series.
