---
name: arctic-multi-domain-sustainment-weather-routing-cell
description: Support U.S. warfighter planning and decision support for Arctic Multi-Domain Sustainment Weather Routing Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: arctic sustainment route survivability board, weather-driven branch trigger chart, convoy and airlift sequencing packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: polar weather and ice analytics, convoy mobility systems, arctic air and maritime routing tools.

## Protocol Profile

Preferred protocol families for this skill: AIXM/FIXM/IWXXM, USMTF, OGC WMS/WFS/WMTS, API/JSON.
