---
name: allied-industrial-surge-and-repair-network-cell
description: Coordinate allied industrial surge, depot repair throughput, and cross-national maintenance handoffs for prolonged operations.
---
...
1. Frame the mission problem using these core inputs: depot capacity, repair demand backlog, transportation constraints, partner release limitations.
...
Primary products for this skill: industrial surge allocation plan, cross-national repair queue, bottleneck remediation tracker.
