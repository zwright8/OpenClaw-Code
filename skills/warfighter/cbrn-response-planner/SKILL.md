---
name: cbrn-response-planner
description: Plan CBRN response and consequence management actions. Use when preparing detection response drills, contamination control plans, and force health protection updates.
---

# CBRN Response Planner
...
1. Frame the mission problem using these core inputs: agent indicators, sensor reports, wind/weather, protective equipment status.
...
Primary products for this skill: CBRN response timeline, contamination control measures, hazard communication brief.
