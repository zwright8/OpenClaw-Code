---
name: coalition-battlefield-evidence-translation-and-tribunal-handoff-cell
description: Prepare coalition battlefield evidence translation, legal metadata normalization, and tribunal handoff packets. Use when multilingual evidence must remain chain-of-custody sound across jurisdictions.
---

# Coalition Battlefield Evidence Translation And Tribunal Handoff Cell
...
- Use packet template DPL-EVIDENCE-TRIBUNAL-HANDOFF-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-evidence-translation-tribunal-handoff-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-evidence-translation-tribunal-handoff-v1 with protocol_stack_id=ps-evidence-tribunal-handoff-stack-v1.
...
- Default packet ID: DPL-EVIDENCE-TRIBUNAL-HANDOFF-001.
