---
name: strategic-competition-gray-zone-response-cell
description: Support U.S. warfighter planning and decision support for Strategic Competition Gray Zone Response Cell. Use when missions require competition below armed conflict and gray-zone response design, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: competitive pressure map, adversary indicator set, interagency response options matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: OSINT intelligence platforms, campaign assessment dashboards, sanctions and influence monitoring tools.
...
- Prefer these protocol families for this skill: STIX/TAXII, USMTF, NATO APP-11/ADatP-3.
