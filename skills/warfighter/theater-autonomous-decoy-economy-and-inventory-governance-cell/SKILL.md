...
description: Plan decoy allocation and replenishment governance for autonomous and crewed forces under contested sensing. Use when survivability depends on disciplined decoy economy decisions.
---
...
Primary products for this skill: decoy allocation ladder, replenishment governance timeline, and survivability risk board.
...
- Bind recommendations to tool_suite_id=ts-theater-autonomous-decoy-economy-and-inventory-governance-cell-v1 and protocol_stack_id=ps-theater-autonomous-decoy-economy-and-inventory-governance-cell-stack-v1.
- Use packet templates in ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-DECOY-ECON-001 for critical recommendations.
- Prioritize these protocol families for this domain: USMTF, VMF, CoT, API/JSON.
