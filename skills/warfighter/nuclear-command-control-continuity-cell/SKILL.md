---
name: nuclear-command-control-continuity-cell
description: Support resilient nuclear command, control, and communications continuity planning. Use when stress-testing NC3 support paths, degraded communications branches, and assured message integrity governance.
---
...
Primary products for this skill: NC3 continuity branch plan, communications degradation decision matrix, command acknowledgment integrity log
...
- Preferred toolchain profile: `nc3-continuity-resilience-v1`.
- Preferred protocol profile: `USMTF + strategic message buses + authenticated ACK chains`.
