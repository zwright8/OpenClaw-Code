---
name: tactical-smoke-obscurant-and-visibility-management-cell
description: Plan and govern smoke or obscurant employment to maximize survivability while controlling fratricide and sensor degradation risk. Use for maneuver masking and defensive deception.
---
...
1. Frame the mission problem using these core inputs: obscurant stock and delivery means, weather and terrain effects, friendly sensor dependencies, ROE and safety constraints.
...
Primary products for this skill: smoke employment synchronization matrix, visibility risk control board, branch trigger timeline.
...
- Primary: `tool_suite_id=ts-smoke-obscurant-effects-v1` with `protocol_stack_id=ps-fires-obscurant-control-stack-v1`.
