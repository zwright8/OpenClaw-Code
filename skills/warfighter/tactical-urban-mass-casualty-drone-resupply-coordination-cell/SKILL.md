---
name: tactical-urban-mass-casualty-drone-resupply-coordination-cell
description: Coordinate drone-based medical and sustainment resupply during urban mass-casualty events. Use when ground routes are denied and treatment nodes need time-critical replenishment.
---
...
1. Frame the mission problem with: casualty node demand, drone fleet status, urban airspace constraints, threat overlays.
...
Primary products for this skill: drone resupply wave plan, delivery priority matrix, risk-adjusted corridor schedule.

## U.S. Warfighter Employment Notes

- Preserve casualty survivability windows by prioritizing blood, airway, and hemorrhage-control payloads.
...
- For this domain, prioritize ts-urban-mascas-drone-resupply-v1 with ps-urban-mascas-drone-resupply-stack-v1.
