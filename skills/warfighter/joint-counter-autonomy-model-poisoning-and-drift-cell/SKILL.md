---
name: joint-counter-autonomy-model-poisoning-and-drift-cell
description: Detect and mitigate poisoning, drift, and adversarial manipulation in deployed autonomy models across domains. Use when autonomous systems must remain mission-safe under active model-space attack.
---

# Joint Counter-Autonomy Model Poisoning and Drift Cell
...
- Use packet template DPL-AUTON-MODEL-INTEGRITY-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-autonomy-model-integrity-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-autonomy-model-integrity-v1 with protocol_stack_id=ps-joint-tactical-link-stack-v1.
...
- Default packet ID: DPL-AUTON-MODEL-INTEGRITY-001.
