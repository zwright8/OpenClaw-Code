---
name: riverine-and-inland-waterways-operations
description: Plan operations in rivers, deltas, and inland waterways with integrated maneuver, sustainment, and force protection. Use when waterways shape access, tempo, and threat exposure.
---

# Riverine And Inland Waterways Operations
...
1. Frame the mission problem using these core inputs: hydrography, current/seasonal conditions, vessel mix, landing points, threat activity.
...
Primary products for this skill: riverine operations sketch, route and timing plan, interdiction and security matrix.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: riverine mission planning tools, hydrographic data services, maritime C2 systems.
...
- Add `tool_suite_id=ts-joint-small-craft-riverine-maintenance-spares-v1` + `protocol_stack_id=ps-joint-small-craft-riverine-maintenance-spares-stack-v1` when mission viability depends on recovering patrol craft readiness, allocating scarce spares, or pacing watercraft maintenance under threat.
- Add `packet_id=DPL-SMALL-CRAFT-RIVERINE-MAINT-SPARES-001` for branches that materially alter patrol coverage, convoy escort confidence, or inland-waterway sustainment reach.
