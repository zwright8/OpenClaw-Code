---
name: homeland-military-microelectronics-counterfeit-quarantine-cell
description: Support homeland quarantine and triage of counterfeit military microelectronics before they contaminate mission systems and sustainment flows.
---

# Homeland Military Microelectronics Counterfeit Quarantine Cell
...
- Primary: `tool_suite_id=ts-homeland-microelectronics-counterfeit-quarantine-v1` with `protocol_stack_id=ps-homeland-microelectronics-counterfeit-quarantine-stack-v1`.
- Alternate: `tool_suite_id=ts-foundry-water-power-continuity-v1` with `protocol_stack_id=ps-foundry-water-power-continuity-stack-v1`.
...
- Default packet IDs: DPL-HOMELAND-MICROELECTRONICS-COUNTERFEIT-QUARANTINE-001, DPL-FOUNDRY-WATER-POWER-CONTINUITY-001.
