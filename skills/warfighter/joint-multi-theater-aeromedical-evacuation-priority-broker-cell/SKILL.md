---
name: joint-multi-theater-aeromedical-evacuation-priority-broker-cell
description: Broker aeromedical evacuation priorities across theaters when lift, beds, and blood are simultaneously constrained.
---
...
- Use packet template `DPL-AEROMED-BROKER-001` from `../_shared/references/domain-tool-packet-library.md`.
- Bind tool and protocol choices to `ts-multitheater-aeromed-priority-v1` and `ps-multitheater-aeromed-priority-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Align execution profile with `medical-casualty-regulation-v1` from `../_shared/references/joint-operations-external-toolchain-profiles.md`.
...
- Primary: `tool_suite_id=ts-multitheater-aeromed-priority-v1` with `protocol_stack_id=ps-multitheater-aeromed-priority-stack-v1`.
...
- Default packet ID: `DPL-AEROMED-BROKER-001`.
