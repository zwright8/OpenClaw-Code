---
name: coalition-expeditionary-blood-cold-chain-denial-recovery-cell
description: Support coalition expeditionary blood and biologics cold-chain integrity under denial, disruption, and contested sustainment conditions.
---

# Coalition Expeditionary Blood Cold Chain Denial Recovery Cell
...
- Primary: `tool_suite_id=ts-expeditionary-blood-cold-chain-denial-recovery-v1` with `protocol_stack_id=ps-expeditionary-blood-cold-chain-denial-recovery-stack-v1`.
- Alternate: `tool_suite_id=ts-expeditionary-cold-chain-biologics-integrity-v1` with `protocol_stack_id=ps-expeditionary-cold-chain-biologics-integrity-stack-v1`.
...
- Default packet IDs: DPL-EXPEDITIONARY-BLOOD-COLD-CHAIN-DENIAL-RECOVERY-001, DPL-EXPEDITIONARY-COLD-CHAIN-BIOLOGICS-INTEGRITY-001.
