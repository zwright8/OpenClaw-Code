---
name: joint-arctic-gps-denied-heavy-airlift-dropzone-certification-cell
description: Certify GPS-denied heavy-airlift drop zones in Arctic conditions while preserving delivery timing and survivability.
---
...
Primary products: dropzone certification confidence board, heavy-airlift routing risk matrix, commander release packet.
...
- Primary: `tool_suite_id=ts-joint-arctic-gps-denied-heavy-airlift-dropzone-certification-v1` with `protocol_stack_id=ps-joint-arctic-gps-denied-heavy-airlift-dropzone-certification-stack-v1`.
...
- Default packet IDs: `DPL-JOINT-ARCTIC-GPS-DENIED-HEAVY-AIRLIFT-DROPZONE-CERTIFICATION-001`.
