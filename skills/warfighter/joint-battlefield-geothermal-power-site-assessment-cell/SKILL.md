---
name: joint-battlefield-geothermal-power-site-assessment-cell
description: Support U.S. warfighter planning and decision support for Joint Battlefield Geothermal Power Site Assessment Cell. Use when missions require Joint Battlefield Geothermal Power Site Assessment Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: geothermal site feasibility brief, force protection siting matrix, expeditionary power integration plan.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: geology hazard services, power demand models, engineering survey tools.
- Prioritize these protocol families for this domain: USMTF, OGC WMS/WFS/WMTS, API/JSON.
