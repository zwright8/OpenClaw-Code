---
name: strategic-quantum-key-distribution-denial-and-fallback-cell
description: Protect strategic communications when quantum key distribution paths are degraded, denied, or spoofed. Use when high-assurance crypto continuity is needed across contested strategic links.
---

# Strategic Quantum Key Distribution Denial and Fallback Cell
...
- Use packet template DPL-QKD-FALLBACK-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-quantum-key-fallback-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-quantum-key-fallback-v1 with protocol_stack_id=ps-joint-tactical-link-stack-v1.
...
- Default packet ID: DPL-QKD-FALLBACK-001.
