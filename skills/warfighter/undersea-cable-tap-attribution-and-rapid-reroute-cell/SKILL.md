---
name: undersea-cable-tap-attribution-and-rapid-reroute-cell
description: Attribute probable undersea cable tapping or manipulation and coordinate mission reroute. Use when subsea comms compromise could affect operational security or C2 continuity.
---

# Undersea Cable Tap Attribution and Rapid Reroute Cell
...
Primary products for this skill: subsea anomaly attribution board, reroute priority order, cable-security incident escalation packet.
...
- Prioritize these tool families for this domain: subsea cable telemetry systems, maritime domain awareness tools, SATCOM failover managers, cyber SIEM/SOAR.
- Prioritize these protocol families for this domain: AIS/NMEA, STIX/TAXII, CCSDS.
