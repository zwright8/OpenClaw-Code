---
name: theater-electromagnetic-battle-damage-repair-prioritization-cell
description: Support U.S. warfighter planning and decision support for restoring electromagnetic mission systems after battle damage while preserving theater C2 and fires timing integrity.
---
...
Primary products for this skill: EM system damage triage board, repair-priority sequence, C2 and fires continuity risk matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: EM damage telemetry fusion board, repair-workcell scheduler, spare-part allocation optimizer, spectrum survivability monitor.
...
- Prefer these protocol families for this skill: Link 16 J-series, VMF, API/JSON, USMTF.
