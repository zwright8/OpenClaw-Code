---
name: joint-battlefield-lidar-dust-obscurant-navigation-assurance-cell
description: Preserve navigation and targeting reliability when dust, smoke, and obscurants degrade lidar and electro-optical sensing on the battlefield.
---

# Joint Battlefield Lidar Dust Obscurant Navigation Assurance Cell
...
- Use packet template DPL-LIDAR-OBSCURANT-NAV-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-lidar-obscurant-navigation-assurance-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-lidar-obscurant-navigation-assurance-v1 with protocol_stack_id=ps-lidar-obscurant-navigation-assurance-stack-v1.
...
- Default packet ID: DPL-LIDAR-OBSCURANT-NAV-001.
