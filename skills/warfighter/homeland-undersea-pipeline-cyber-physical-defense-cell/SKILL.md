---
name: homeland-undersea-pipeline-cyber-physical-defense-cell
description: Protect homeland undersea energy pipelines against cyber-physical sabotage, sensor deception, and flow disruption. Use when infrastructure defense directly affects military mobilization and civil stability.
---

# Homeland Undersea Pipeline Cyber-Physical Defense Cell
...
- Use packet template DPL-UNDERSEA-PIPELINE-CP-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-undersea-pipeline-defense-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-undersea-pipeline-defense-v1 with protocol_stack_id=ps-joint-tactical-link-stack-v1.
...
- Default packet ID: DPL-UNDERSEA-PIPELINE-CP-001.
