---
name: joint-amphibious-humanitarian-shore-entry-control-cell
description: Control amphibious humanitarian shore entry, beach throughput, and aid handoff security in crises.
---
...
Primary products for this skill: shore entry control plan, beach throughput matrix, aid handoff governance packet.
...
- `tool_suite_id`: `ts-amphibious-shore-entry-control-v1`
- `protocol_stack_id`: `ps-amphibious-shore-entry-control-stack-v1`
