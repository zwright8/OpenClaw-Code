---
name: contested-orbital-ground-station-defense-cell
description: Defend and reconstitute ground stations supporting orbital operations in contested environments. Use when kinetic, cyber, or EW threats reduce space support to operations.
---
...
1. Frame the mission problem using these core inputs: ground station status telemetry, threat warnings, cyber alerts, mission support dependencies.
...
Primary products for this skill: ground station defense options, reconstitution sequence, mission-impact mitigation plan.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools or tool families for this domain: ground station telemetry systems, space operations dashboards, cyber defense tooling, facility security monitors.
