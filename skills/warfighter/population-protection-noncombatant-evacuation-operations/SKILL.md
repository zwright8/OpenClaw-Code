---
name: population-protection-noncombatant-evacuation-operations
description: Support U.S. warfighter planning and decision support for Population Protection Noncombatant Evacuation Operations. Use when missions require noncombatant evacuation operations and population protection planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: NEO trigger matrix, assembly-and-evacuation flow plan, embassy/host-nation coordination tracker.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: consular status systems, movement control planners, GCCS-J/COP tools, transportation scheduling platforms.
...
- Prefer these protocol families for this skill: USMTF, NATO APP-11/ADatP-3, OGC.
