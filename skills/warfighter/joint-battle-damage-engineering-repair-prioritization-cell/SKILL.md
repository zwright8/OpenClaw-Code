---
name: joint-battle-damage-engineering-repair-prioritization-cell
description: Support joint engineering repair prioritization after battle damage. Use when multiple damaged nodes compete for limited engineer capacity and commanders need mission-impact-optimized repair sequencing.
---
...
Primary products for this skill: engineering repair priority queue, mission impact restoration map, resource-constrained branch plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-engineering-repair-prioritization-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
- Alternate: `tool_suite_id=ts-rail-bridge-recovery-v1` with `protocol_stack_id=ps-joint-tactical-link-stack-v1`.
...
- Preferred protocol families: USMTF, OGC, API/JSON.
...
- Default packet IDs: DPL-ENG-REPAIR-001, DPL-RAILPORT-001.
