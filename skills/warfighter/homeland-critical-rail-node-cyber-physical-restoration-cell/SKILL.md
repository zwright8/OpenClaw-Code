---
name: homeland-critical-rail-node-cyber-physical-restoration-cell
description: Restore military-relevant rail chokepoints after cyber-physical attacks or cascading infrastructure failures. Use when force deployment timelines depend on rail node recovery.
---
...
Primary products for this skill: rail-node restoration decision brief, cyber-physical incident branch chart, throughput reconstitution timeline.

## Domain Tool Stack

Use these tool categories as the baseline stack: rail OT telemetry systems, dispatch and signaling dashboards, incident command boards, convoy/rail throughput analytics.

## Protocol Profile

Preferred protocol families for this skill: AAR railroad exchange profiles, API/JSON, STIX/TAXII, IEC 62443.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-critical-rail-node-cyber-physical-restoration-v1` with `protocol_stack_id=ps-critical-rail-node-cyber-physical-restoration-stack-v1`.
- Alternate: `tool_suite_id=ts-rail-bridge-recovery-v1` with `protocol_stack_id=ps-rail-bridge-recovery-stack-v1`.
...
- Default packet IDs: DPL-CRITICAL-RAIL-NODE-CYBER-PHYSICAL-RESTORE-001, DPL-RAIL-BRIDGE-RECOVERY-001.
