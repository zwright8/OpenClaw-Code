---
name: joint-cbrn-consequence-management-cell
description: Coordinate joint CBRN consequence management and force/civil protection response after contamination events. Use when integrating detection, hazard modeling, and recovery planning.
---
...
1. Frame the mission problem using these core inputs: contamination indicators, exposure reports, force disposition, and civil infrastructure status.
...
Primary products for this skill: CBRN consequence estimate, protective action matrix, contamination recovery branch plan.
