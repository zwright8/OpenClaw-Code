---
name: operational-lawfare-and-adversary-legal-exposure-cell
description: Assess adversary legal vulnerabilities and friendly legal risk in competition and conflict operations. Use when preparing legally defensible information and operational actions.
---
...
1. Frame the mission problem using these core inputs: adversary violations dossier, evidence confidence, friendly action proposals, treaty/policy constraints.
...
Primary products for this skill: lawfare opportunity matrix, evidentiary support package, legal risk heatmap.
