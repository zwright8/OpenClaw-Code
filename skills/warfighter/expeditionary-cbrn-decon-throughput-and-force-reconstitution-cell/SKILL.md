---
name: expeditionary-cbrn-decon-throughput-and-force-reconstitution-cell
description: Coordinate expeditionary CBRN decontamination throughput and force reconstitution sequencing after contamination events. Use when units must restore combat power while controlling residual hazard.
---
...
Primary products for this skill: decon throughput schedule, contamination-control and reconstitution priorities, exposure-risk decision board.
...
- Prioritize these tool/protocol families for this domain: CBRN sensor fusion, plume and contamination modeling, decon line throughput management.
