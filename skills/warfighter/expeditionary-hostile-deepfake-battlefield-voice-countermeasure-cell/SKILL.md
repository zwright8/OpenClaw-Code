---
name: expeditionary-hostile-deepfake-battlefield-voice-countermeasure-cell
description: Detect and mitigate hostile synthetic voice operations targeting tactical command and control, call-for-fire, and emergency authority chains.
---
...
Primary products for this skill: voice-authentication risk board, command-channel trust restoration plan, spoof incident attribution packet.
...
- Prioritize these domain tools: voice authenticity forensics pipelines, secure radio authentication services, command-net incident ledgers, influence operations monitors.
- Prioritize these protocol families: STIX/TAXII, VMF, USMTF, API/JSON.
...
- `tool_suite_id`: `ts-voice-deepfake-countermeasure-v1`
- `protocol_stack_id`: `ps-voice-deepfake-countermeasure-stack-v1`
