---
name: joint-quantum-navigation-contested-pnt-transition-cell
description: Plan transition to quantum and non-GNSS navigation methods in denied-PNT conditions. Use when operations require resilient timing and navigation under persistent jamming/spoofing.
---
...
Primary products for this skill: PNT transition phase plan, quantum-nav integration risk matrix, holdover assurance brief.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-disconnected-time-pnt-holdover-v1` with `protocol_stack_id=ps-time-sync-holdover-stack-v1`.
- Alternate: `tool_suite_id=ts-space-weather-gnss-fusion-v1` with `protocol_stack_id=ps-space-weather-gnss-fusion-stack-v1`.
