---
name: joint-denied-metadata-and-file-triage-cell
description: Support U.S. warfighter planning and decision support for secure metadata reconstruction, captured file triage, and mission-relevant digital evidence extraction in denied conditions.
---
...
Primary products for this skill: captured media triage queue, metadata confidence ledger, exploitation tasking packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: digital forensics suites, object-store evidence ledgers, malware detonation sandboxes, chain-of-custody trackers.
