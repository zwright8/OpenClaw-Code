---
name: joint-wearable-biosurveillance-force-health-anomaly-triage-cell
description: Fuse wearable biosurveillance anomalies with mission context to triage force-health risks before operational degradation.
---
...
Primary products: biosurveillance anomaly board, triage and intervention plan, mission-impact forecast, and force-health command brief.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-wearable-biosurveillance-anomaly-triage-v1` with `protocol_stack_id=ps-wearable-biosurveillance-anomaly-triage-stack-v1`.
...
- Default packet IDs: DPL-WEARABLE-BIOSURVEILLANCE-TRIAGE-001, DPL-FORCE-HEALTH-ANOMALY-INTERVENTION-001.
