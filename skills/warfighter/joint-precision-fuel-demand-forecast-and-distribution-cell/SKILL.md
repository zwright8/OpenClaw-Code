---
name: joint-precision-fuel-demand-forecast-and-distribution-cell
description: Plan and coordinate Joint Precision Fuel Demand Forecast And Distribution Cell operations for U.S. warfighters. Use when staff needs mission-ready recommendations, tool/protocol-integrated workflows, and escalation triggers in this domain.
---
