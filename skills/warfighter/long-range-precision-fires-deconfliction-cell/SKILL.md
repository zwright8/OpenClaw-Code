---
name: long-range-precision-fires-deconfliction-cell
description: Deconflict long-range precision fires across components and domains. Use when synchronizing targeting windows, airspace constraints, and cross-boundary fire support.
---
...
Primary products for this skill: Fires timing deconfliction board, cross-domain clearance matrix, no-strike boundary monitor.
