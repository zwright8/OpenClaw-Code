---
name: strategic-stratospheric-sensor-layer-reconstitution-cell
description: Support U.S. warfighter planning and decision support for Strategic Stratospheric Sensor Layer Reconstitution Cell. Use when missions require Strategic Stratospheric Sensor Layer Reconstitution Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: sensor layer reconstitution sequence, launch/recovery prioritization plan, gap-risk warning brief.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: stratospheric platform mission planners, sensor health monitors, ISR gap analytics.
- Prioritize these protocol families for this domain: USMTF, API/JSON, OGC WMS/WFS/WMTS.
