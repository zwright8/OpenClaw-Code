---
name: theater-civilian-cellular-priority-service-restoration-cell
description: Support theater military-civil planning for restoration of civilian cellular priority services that affect emergency response and military coordination. Use when outage recovery and priority access policy must be synchronized.
---
...
Primary products for this skill: priority service restoration sequence, outage impact board, emergency access governance checklist.

## U.S. Warfighter Employment Notes

- Prioritize rapid restoration of emergency and command-support communications without overloading degraded carrier infrastructure.
...
- For this domain, prioritize `ts-cellular-priority-service-restoration-v1` with `ps-cellular-priority-service-restoration-stack-v1` and `DPL-CELLULAR-PRIORITY-SERVICE-RESTORATION-001`.
