---
name: joint-forward-arming-and-refueling-under-drone-threat-cell
description: Optimize FARP setup, displacement, and protection under persistent drone ISR and strike threat.
---
...
Primary products for this skill: FARP protection scheme, displacement trigger matrix, sortie generation risk timeline.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: FARP logistics planners, counter-UAS C2, threat ISR trackers, fuel quality and throughput systems.
- Preferred protocol profiles for coordination and machine exchange: USMTF, VMF, CoT, Link 16 J-series.
