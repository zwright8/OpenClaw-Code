---
name: joint-battlefield-neuromorphic-sensor-fusion-cell
description: Support U.S. warfighter planning for neuromorphic sensor fusion in low-latency targeting and force-protection workflows. Use when high-volume edge sensing must be fused under bandwidth and power constraints.
---
...
Primary products for this skill: edge fusion confidence ladder, low-latency cueing matrix, false-positive suppression plan.

## Domain Toolchain Defaults

- Primary:   `tool_suite_id=ts-intel-fusion-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Preferred tools: edge ISR fusion stacks, event brokers, waveform health monitors, blue-force deconfliction services.
- Preferred protocol families: CoT, VMF, Link 16 J-series.
...
- Default packet IDs: DPL-CUAS-URBAN-001, DPL-CEMA-BDA-001.
