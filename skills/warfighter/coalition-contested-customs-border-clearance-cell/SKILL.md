---
name: coalition-contested-customs-border-clearance-cell
description: Coordinate coalition customs and border-clearance workflows that preserve military tempo while managing legal and security constraints. Use when contested transit requires synchronized inspections, waivers, and tracking.
---
...
1. Frame the mission problem using these core inputs: cross-border movement requests, customs/legal authorities, convoy or airlift manifests, inspection bottlenecks, and coalition caveats.
...
Primary products for this skill: coalition clearance synchronization board, waiver decision matrix, border transit risk timeline.
...
- Primary: `tool_suite_id=ts-coalition-border-clearance-v1` with `protocol_stack_id=ps-border-clearance-stack-v1`.
