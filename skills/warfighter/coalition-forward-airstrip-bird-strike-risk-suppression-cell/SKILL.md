---
name: coalition-forward-airstrip-bird-strike-risk-suppression-cell
description: Support coalition expeditionary aviation planning for bird-strike risk suppression at forward and austere airstrips. Use when sortie generation depends on runway wildlife hazard control under constrained resources.
---
...
Primary products for this skill: wildlife hazard heatmap, sortie window risk card, airstrip mitigation task board.

## U.S. Warfighter Employment Notes

- Prioritize sortie safety at austere coalition strips where runway inspections, waste control, and dispersal posture interact.
...
- For this domain, prioritize `ts-forward-airstrip-bird-strike-suppression-v1` with `ps-forward-airstrip-bird-strike-suppression-stack-v1` and `DPL-FORWARD-AIRSTRIP-BIRD-STRIKE-SUPPRESSION-001`.
