---
name: maritime-operations-planner
description: Plan maritime operations for sea control, power projection, and convoy protection. Use when sequencing naval tasks, chokepoint coverage, and maritime ISR in contested waters.
---
...
1. Frame the mission problem using these core inputs: maritime tasking, sea state/weather, adversary naval/air threat, logistics windows.
...
Primary products for this skill: maritime scheme of maneuver, patrol/escort schedule, risk-controlled task list.
