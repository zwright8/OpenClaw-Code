---
name: tactical-counter-uas-legal-evidence-packaging-cell
description: Coordinate tactical counter-UAS incident evidence packaging for lawful response, attribution, and prosecution support. Use when warfighters need rapid evidentiary workflows after drone incursions or attacks.
---
...
Primary products for this skill: counter-UAS evidence package, legal attribution timeline, incident escalation handoff card.
...
- Add `tool_suite_id=ts-counter-uas-legal-evidence-packaging-v1` + `protocol_stack_id=ps-counter-uas-legal-evidence-packaging-stack-v1` when producing critical recommendations for this mission domain.
