---
name: expeditionary-additive-spare-parts-airworthiness-cell
description: Coordinate expeditionary additive-manufactured spare part certification for aircraft and critical mission systems. Use when warfighters need rapid fielded part production with airworthiness and safety evidence.
---

# Expeditionary Additive Spare Parts Airworthiness Certification Cell
...
Primary products for this skill: expeditionary part certification packet, airworthiness evidence chain, additive defect escalation board.
...
- Add `tool_suite_id=ts-additive-spare-parts-airworthiness-certification-v1` + `protocol_stack_id=ps-additive-spare-parts-airworthiness-certification-stack-v1` when producing critical recommendations for this mission domain.
