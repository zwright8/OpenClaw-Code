---
name: joint-maritime-drone-carrier-air-defense-magazine-arbitration-cell
description: Support U.S. warfighter planning for maritime drone-carrier raids with air-defense magazine prioritization and defended-asset arbitration.
---
...
Use these tool categories by default: maritime track fusion boards, interceptor expenditure forecasters, and defended-asset arbitration engines.

## Protocol Profile

Preferred protocol families for this skill: AIS/NMEA, Link 16 J-series, USMTF, VMF, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-JOINT-MARITIME-DRONE-CARRIER-AIR-DEFENSE-MAGAZINE-ARBITRATION-001 for critical recommendations.
