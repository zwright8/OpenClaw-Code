---
name: military-police-area-security-operations
description: Support military police planning for area security, route regulation, and detainee support. Use when managing security zones, movement control, and law-and-order tasks in theater.
---

# Military Police Area Security Operations
...
1. Frame the mission problem using these core inputs: security incidents, movement demands, detention requirements, MP force availability.
...
Primary products for this skill: area security plan, route regulation matrix, MP task organization.
