---
name: tactical-forward-arctic-fiber-microwave-hybrid-backhaul-cell
description: Maintain Arctic forward C2 connectivity by orchestrating hybrid fiber-microwave backhaul with contested-weather failover.
---
...
- Primary: `tool_suite_id=ts-arctic-fiber-microwave-hybrid-backhaul-v1` with `protocol_stack_id=ps-arctic-fiber-microwave-hybrid-backhaul-stack-v1`.
...
- Default packet IDs: `DPL-ARCTIC-HYBRID-BACKHAUL-RESILIENCE-001`, `DPL-FORWARD-BACKHAUL-FAILOVER-001`.
