---
name: directed-energy-defense-integration-cell
description: Provide battle-management support for integrating directed-energy systems into layered defense. Use when missions require synchronization of sensor custody, power budgets, and kinetic/non-kinetic defensive options.
---
...
1. Frame the mission problem using these core inputs: threat raid profile, sensor track quality, power and thermal constraints, and defended asset priorities.
...
Primary products for this skill: directed-energy employment readiness board, layered defense synchronization matrix, power-priority decision card.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: air and missile defense C2, power management telemetry, fire-control status systems.
...
- Prefer these protocol families for this skill: Link 16 J-series, USMTF, API/JSON, CoT.
