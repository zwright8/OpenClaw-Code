---
name: theater-forward-watercraft-autonomy-collision-avoidance-cell
description: Support warfighter autonomous watercraft collision-avoidance and traffic deconfliction in forward theater waterways. Use when mixed manned/unmanned traffic raises mission and safety risk.
---
...
Primary products for this skill: autonomous transit conflict board, collision-risk trigger ladder, comms fallback routing plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-watercraft-autonomy-collision-avoidance-v1` with `protocol_stack_id=ps-watercraft-autonomy-collision-stack-v1`.
- Alternate: `tool_suite_id=ts-uncrewed-maritime-corridor-defense-v1` with `protocol_stack_id=ps-maritime-chokepoint-closure-stack-v1`.
...
- Default packet IDs: DPL-WATERCRAFT-AUTONOMY-001, DPL-MARITIME-CHOKE-001.
