---
name: route-clearance-and-counter-ied-fusion
description: Support U.S. warfighter planning and decision support for Route Clearance And Counter Ied Fusion. Use when missions require route threat reduction and counter-IED fusion for mobility corridors, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: route threat heatmap, clearance priority board, exploitation-to-targeting feedback loop.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: C-IED incident databases, ISR collections, route clearance trackers, geospatial analysis services.
...
- Prefer these protocol families for this skill: CoT, OGC WMS/WFS/WMTS, USMTF.
