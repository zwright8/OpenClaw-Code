---
name: survivability-camouflage-deception-planner
description: Design survivability, signature management, and deception actions to complicate enemy targeting. Use when reducing detectability and shaping adversary perceptions.
---

# Survivability Camouflage and Deception Planner
...
1. Frame the mission problem using these core inputs: threat ISR posture, unit signatures, deception objectives, terrain masking options.
...
Primary products for this skill: signature reduction plan, deception event matrix, survivability task list.
