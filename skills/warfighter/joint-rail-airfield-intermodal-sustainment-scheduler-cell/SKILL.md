---
name: joint-rail-airfield-intermodal-sustainment-scheduler-cell
description: Support U.S. warfighter intermodal rail-airfield sustainment scheduling under disruption and surge demand. Use when throughput decisions must synchronize rail, airlift, and ground distribution.
---
...
Primary products for this skill: intermodal throughput schedule, chokepoint reroute matrix, sustainment risk timeline.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-intermodal-rail-airfield-sustainment-v1` with `protocol_stack_id=ps-intermodal-rail-airfield-stack-v1`.
- Alternate: `tool_suite_id=ts-strategic-mobility-port-rail-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Default packet IDs: DPL-INTERMODAL-RAIL-AIR-001, DPL-PORT-REPAIR-001.
