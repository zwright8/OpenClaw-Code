---
name: coalition-military-police-detention-transfer-governance-cell
description: Coordinate coalition military police detention transfer governance. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: detainee transfer requests, legal authorities, receiving facility capacity, chain-of-custody records.
...
Primary products for this skill: detention transfer governance plan, compliance checklist, handoff audit packet.
