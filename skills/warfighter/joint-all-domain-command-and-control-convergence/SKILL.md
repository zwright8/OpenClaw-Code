---
name: joint-all-domain-command-and-control-convergence
description: Integrate joint and coalition command-and-control data into a coherent decision picture for JADC2-style operations. Use when synchronizing cross-domain effects, data flows, and battle rhythm decisions across components.
---

# Joint All Domain Command And Control Convergence
...
1. Frame the mission problem using these core inputs: component objectives, current COP deltas, decision authorities, latency limits, data-sharing constraints.
...
Primary products for this skill: cross-domain decision matrix, C2 convergence plan, battle-rhythm sync schedule.
...
- Prioritize these tools or tool families for this domain: GCCS-J, CPOF, JADOCS, ATAK/WinTAK.
