---
name: strategic-financial-rail-and-maritime-sanctions-leakage-disruption-cell
description: Detect and disrupt sanctions leakage across linked rail, maritime, and financial corridors supporting adversary warfighting capacity. Use when warfighters and interagency teams need actionable disruption options with legal/coalition constraints.
---
...
Primary products: sanctions leakage topology map, disruption option ladder, legal-risk and attribution packet.
...
- Primary: `tool_suite_id=ts-sanctions-leakage-disruption-v1 with protocol_stack_id=ps-sanctions-leakage-disruption-stack-v1`.
- Alternate: `tool_suite_id=ts-strategic-supply-shock-v1 with protocol_stack_id=ps-defense-industrial-base-sabotage-risk-stack-v1`.
...
- Default packet IDs: DPL-CYBER-LEGAL-EVIDENCE-001, DPL-STRATEGIC-SUPPLY-001, DPL-COALITION-CUSTODY-001.
