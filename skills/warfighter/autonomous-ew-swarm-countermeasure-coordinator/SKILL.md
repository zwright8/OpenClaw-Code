---
name: autonomous-ew-swarm-countermeasure-coordinator
description: Coordinate detection and neutralization of adversary autonomous EW swarms threatening C2 and navigation. Use when distributed unmanned EW effects are degrading friendly mission systems.
---
...
1. Frame the mission problem using these core inputs: EW emitter detections, drone swarm behavior telemetry, comms degradation metrics, friendly spectrum priorities.
...
Primary products for this skill: swarm threat triage board, EW countermeasure tasking plan, comms resilience fallback matrix.
...
- Prioritize these tools or tool families for this domain: EW mission systems, counter-UAS systems, SIEM/SOAR telemetry fusion, spectrum monitoring tools.
- Specify outbound exchange format for recommendations and tasking: STIX/TAXII, Link 16 J-series, USMTF, API/JSON.
