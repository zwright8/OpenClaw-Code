---
name: joint-theater-ai-enabled-camouflage-discipline-auditor-cell
description: Audit camouflage and signature-control discipline using AI-assisted sensing in contested theaters. Use when commanders need deception effectiveness checks and correction priorities under ISR pressure.
---
...
Primary products for this skill: camouflage drift audit, decoy discipline violation board, corrective action matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-ai-camouflage-discipline-audit-v1` with `protocol_stack_id=ps-ai-camouflage-discipline-stack-v1`.
- Alternate: `tool_suite_id=ts-decoy-heat-signature-v1` with `protocol_stack_id=ps-decoy-heat-signature-stack-v1`.
...
- Default packet IDs: DPL-AI-CAMO-AUDIT-001.
