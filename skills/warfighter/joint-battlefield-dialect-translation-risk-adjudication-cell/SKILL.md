---
name: joint-battlefield-dialect-translation-risk-adjudication-cell
description: Support battlefield dialect translation risk adjudication for multinational command and partner-force coordination. Use when language variance can cause command misunderstanding or escalation.
---
...
Primary products for this skill: translation risk confidence map, command-language adjudication ledger, partner-force communication mitigation plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: speech and text translation confidence engines, dialect ambiguity monitors, command phrasebook validation boards, human linguist escalation workflows.
...
- Add `tool_suite_id=ts-battlefield-dialect-translation-risk-adjudication-v1` + `protocol_stack_id=ps-battlefield-dialect-translation-risk-adjudication-stack-v1` when producing critical recommendations for this mission domain.
