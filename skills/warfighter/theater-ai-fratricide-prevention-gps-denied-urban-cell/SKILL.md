---
name: theater-ai-fratricide-prevention-gps-denied-urban-cell
description: Reduce fratricide risk in dense urban operations when positioning and identity confidence degrade due to GPS denial and multipath effects. Use when warfighters must reconcile sensor ambiguity before fires and maneuver decisions.
---

# Theater AI-Enabled Fratricide Prevention in GPS-Denied Urban Canyon Cell
...
Primary products for this skill: urban fratricide-risk confidence map, blue-force identity adjudication ledger, fires hold/release trigger card.
...
- Add `tool_suite_id=ts-ai-fratricide-prevention-gps-denied-urban-v1` + `protocol_stack_id=ps-ai-fratricide-prevention-gps-denied-urban-stack-v1` when producing critical recommendations for this mission domain.
