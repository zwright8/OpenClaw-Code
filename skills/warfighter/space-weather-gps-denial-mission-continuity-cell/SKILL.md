---
name: space-weather-gps-denial-mission-continuity-cell
description: Plan mission continuity under space weather and GPS-denial conditions across joint operations. Use when satellite degradation threatens PNT-dependent command, fires, logistics, or rescue timelines.
---

# Space Weather GPS-Denial Mission Continuity Cell
...
Primary products for this skill: PNT degradation impact ladder, mission continuity fallback matrix, and command acknowledgment packet.
...
- Add `tool_suite_id=ts-space-weather-gnss-denial-mission-continuity-v1` + `protocol_stack_id=ps-space-weather-gnss-denial-mission-continuity-stack-v1` for this mission domain as default external integration profile.
- Add `packet_id=DPL-SPACE-WEATHER-GNSS-DENIAL-MISSION-CONTINUITY-001` for mission branches that can alter force posture, mission risk, or escalation dynamics.
