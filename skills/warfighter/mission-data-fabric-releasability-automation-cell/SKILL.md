---
name: mission-data-fabric-releasability-automation-cell
description: Automate releasability checks and partner-routing decisions across mission data fabrics.
---
...
Primary products for this skill: releasability decision matrix, data release workflow board, compliance exception log.
