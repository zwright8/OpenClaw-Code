---
name: strategic-bioforensics-rapid-attribution-cell
description: Support warfighter planning for rapid bioforensics attribution during strategic biological incidents and contested influence operations.
---
...
- Primary: `tool_suite_id=ts-bioforensics-rapid-attribution-v1` with `protocol_stack_id=ps-bioforensics-rapid-attribution-stack-v1`.
- Alternate: `tool_suite_id=ts-lab-chain-custody-continuity-v1` with `protocol_stack_id=ps-lab-chain-custody-continuity-stack-v1`.
...
- Default packet IDs: DPL-BIOFORENSICS-RAPID-ATTRIBUTION-001, DPL-LAB-CHAIN-CUSTODY-CONTINUITY-001.
