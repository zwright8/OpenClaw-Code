---
name: expeditionary-runway-repair-and-airfield-recovery
description: Plan rapid runway damage repair and airfield recovery in contested environments. Use when prioritizing crater repair, MOS opening, and sortie restoration decisions.
---
...
1. Frame the mission problem using these core inputs: damage assessments, engineer assets, MOS criteria, sortie demand.
...
Primary products for this skill: airfield recovery plan, repair sequencing card, sortie regeneration estimate.
...
- Prioritize these tools or protocol families for this domain: airfield ops tools plus engineer planning, CoT, USMTF.
