---
name: space-support-effects-planner
description: Plan space-enabled support to joint operations. Use when mapping PNT, SATCOM, ISR, and missile warning dependencies to mission outcomes and contingencies.
---

# Space Support Effects Planner
...
1. Frame the mission problem using these core inputs: space-enabled dependencies, jamming/interference reports, timing windows, mission priorities.
...
Primary products for this skill: space effects support matrix, degradation contingency options, dependency map.
