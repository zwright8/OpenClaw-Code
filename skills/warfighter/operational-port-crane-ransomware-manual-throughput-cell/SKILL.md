---
name: operational-port-crane-ransomware-manual-throughput-cell
description: Support port-opening continuity when crane automation is degraded by ransomware or cyber compromise. Use when manual throughput fallback is required.
---

# Operational Port Crane Ransomware Manual Throughput Cell
...
- Primary: `tool_suite_id=ts-port-crane-ransomware-manual-throughput-v1` with `protocol_stack_id=ps-port-crane-ransomware-manual-throughput-stack-v1`.
- Alternate: `tool_suite_id=ts-ics-ransomware-rapid-recovery-v1` with `protocol_stack_id=ps-ics-ransomware-rapid-recovery-stack-v1`.
...
- Default packet IDs: DPL-PORT-CRANE-RANSOMWARE-MANUAL-THROUGHPUT-001, DPL-ICS-RANSOMWARE-RAPID-RECOVERY-001.
