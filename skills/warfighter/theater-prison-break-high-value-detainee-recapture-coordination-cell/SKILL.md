---
name: theater-prison-break-high-value-detainee-recapture-coordination-cell
description: Coordinate recapture operations after prison breaks involving high-value detainees under contested security conditions.
---
...
Primary products: recapture prioritization matrix, detainee movement risk board, command recapture authority packet.
...
- Primary: `tool_suite_id=ts-theater-prison-break-hvd-recapture-coordination-v1` with `protocol_stack_id=ps-theater-prison-break-hvd-recapture-coordination-stack-v1`.
...
- Default packet IDs: `DPL-THEATER-PRISON-BREAK-HVD-RECAPTURE-001`.
