---
name: theater-spectrum-to-targeting-latency-auditor
description: Audit and reduce end-to-end latency from electromagnetic detection to target engagement recommendations. Use when commanders need to tighten kill-chain timing under contested spectrum conditions.
---
...
1. Frame the mission problem using these core inputs: emitter detection timeline, sensor fusion latency, fires approval cycle, network delay profile, deconfliction gates.
...
Primary products for this skill: latency bottleneck map, timing remediation plan, kill-chain readiness scorecard.
