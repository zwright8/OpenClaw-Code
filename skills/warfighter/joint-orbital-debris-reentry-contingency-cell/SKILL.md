---
name: joint-orbital-debris-reentry-contingency-cell
description: Coordinate prediction, warning, and consequence management for hazardous orbital debris reentry over operational theaters and homeland assets. Use when reentry uncertainty threatens launch windows, force posture, or civil-military continuity.
---

# Joint Orbital Debris Reentry Contingency Cell
...
1. Frame the mission problem using these core inputs: orbital debris track set, reentry covariance, protected asset registry, and warning dissemination paths.
...
Primary products for this skill: orbital reentry risk timeline, protected-asset mitigation matrix, launch or shelter decision ladder.
...
## Domain Toolchain Override (2026-03-09, Orbital Reentry Consequence Sequencing)

- Prioritize tool_suite_id=ts-orbital-reentry-consequence-v1 with protocol_stack_id=ps-orbital-reentry-consequence-stack-v1 when uncertainty ellipses overlap defended installations or launch corridors.
- Use packet DPL-ORBITAL-REENTRY-CONSEQUENCE-001 to bind hazard windows, shelter/hold recommendations, and authority-gated warning release steps.
- If tracking confidence or acknowledgment integrity falls below threshold, downgrade to advisory-only and require explicit commander approval before posture changes.
