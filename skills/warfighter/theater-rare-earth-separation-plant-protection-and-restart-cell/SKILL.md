---
name: theater-rare-earth-separation-plant-protection-and-restart-cell
description: Support theater-level planning to protect and restart rare-earth separation plants critical to military sensor, guidance, and energy supply chains.
---
...
Primary products for this skill: plant defense and restart sequence, critical mineral output prioritization matrix, contamination and safety hold-point log.

## U.S. Warfighter Employment Notes

- Prioritize defense-industrial continuity for munitions, avionics, and precision systems under sabotage and cyber-physical disruption.
...
- For this domain, prioritize `ts-rare-earth-plant-protect-restart-v1` with `ps-rare-earth-plant-protect-restart-stack-v1` and `DPL-RARE-EARTH-PLANT-PROTECT-RESTART-001`.
