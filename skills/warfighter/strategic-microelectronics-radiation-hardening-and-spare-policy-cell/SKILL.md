---
name: strategic-microelectronics-radiation-hardening-and-spare-policy-cell
description: Set mission-driven sparing policy for rad-hard and radiation-tolerant microelectronics across strategic weapon and C2 systems.
---
...
Primary products for this skill: rad-hard component priority ledger, sparing policy decision memo, mission-impact substitution matrix.

## Tool Suite and Protocol Binding

- Bind tool selection to `ts-radhard-microelectronics-policy-v1` and `ps-radhard-microelectronics-policy-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Recommended external tools for this domain: microelectronics provenance systems, radiation test lab reports, depot readiness dashboards, and sustainment ERP records.
- Required protocol families for implementation: SBOM (CycloneDX), STIX/TAXII, REST JSON over mTLS, and NIEM.
