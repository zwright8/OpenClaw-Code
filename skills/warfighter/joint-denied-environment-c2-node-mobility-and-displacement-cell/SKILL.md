---
name: joint-denied-environment-c2-node-mobility-and-displacement-cell
description: Support U.S. warfighter command-node survivability and displacement planning in denied environments. Use when mobile C2 nodes must relocate while preserving command continuity and authority chains.
---
...
Primary products for this skill: displacement trigger ladder, command continuity branch matrix, comm-path survivability confidence report.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-c2-node-displacement-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
- Alternate: `tool_suite_id=ts-command-post-displacement-survivability-v1` with `protocol_stack_id=ps-joint-tactical-link-stack-v1`.
...
- Preferred protocol families: USMTF, CoT, Link 16 J-series.
...
- Default packet IDs: DPL-C2-DISP-002, DPL-MCP-DISP-001.
