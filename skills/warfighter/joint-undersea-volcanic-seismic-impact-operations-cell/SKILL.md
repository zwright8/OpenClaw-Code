---
name: joint-undersea-volcanic-seismic-impact-operations-cell
description: Assess operational impacts from undersea volcanic and seismic events on cables, ports, and maritime routes. Use when geologic disruptions threaten mission transport, communications, or undersea infrastructure.
---
...
1. Frame the mission problem using these core inputs: seismic and bathymetric feeds, undersea cable route maps, port status reports, shipping lane density, and mission dependency graph.
...
Primary products for this skill: undersea geohazard impact brief, cable/port restoration priority board, maritime reroute decision matrix.
...
- Primary: `tool_suite_id=ts-undersea-geohazard-v1` with `protocol_stack_id=ps-undersea-rescue-stack-v1`.
