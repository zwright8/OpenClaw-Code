---
name: homeland-defense-electromagnetic-pulse-grid-and-c2-recovery-cell
description: Coordinate homeland defense recovery of grid and command-and-control services after electromagnetic pulse effects. Use when warfighters must restore mission-critical infrastructure under degraded electronics conditions.
---
...
Primary products for this skill: EMP impact restoration map, protected C2 recovery sequence, grid-c2 branch trigger card.
...
- Add `tool_suite_id=ts-electromagnetic-pulse-grid-c2-recovery-v1` + `protocol_stack_id=ps-electromagnetic-pulse-grid-c2-recovery-stack-v1` when producing critical recommendations for this mission domain.
