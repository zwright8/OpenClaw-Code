---
name: strategic-autonomous-systems-component-security-cell
description: Secure autonomous system hardware/software component chains against counterfeit, compromise, and hidden dependency risk. Use when scaling unmanned systems in contested or coalition environments.
---
...
1. Frame the mission problem using these core inputs: component bill of materials, firmware/software provenance, supplier trust posture, mission criticality tiers, field failure telemetry.
...
Primary products for this skill: autonomy component trust ledger, counterfeit-compromise risk map, remediation and revalidation task board.
