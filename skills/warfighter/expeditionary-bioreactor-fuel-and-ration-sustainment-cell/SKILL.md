---
name: expeditionary-bioreactor-fuel-and-ration-sustainment-cell
description: Plan expeditionary sustainment using bioreactor-enabled fuel and ration production. Use when contested logistics require local generation of mission-critical energy and nutrition.
---

# Expeditionary Bioreactor Fuel and Ration Sustainment Cell
...
Primary products for this skill: bioreactor sustainment production plan, contamination-risk decision matrix, fuel-ration mission priority board.
...
- Prioritize these tool families for this domain: bioprocess control SCADA, expeditionary lab quality systems, logistics ERP, power and water telemetry tools.
- Prioritize these protocol families for this domain: NATO STANAG logistics exchanges, HL7/FHIR for medical nutrition risk, OGC telemetry feeds.
