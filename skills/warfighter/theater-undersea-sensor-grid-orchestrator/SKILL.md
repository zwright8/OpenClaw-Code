---
name: theater-undersea-sensor-grid-orchestrator
description: Orchestrate theater undersea sensor networks for detection, tracking, and infrastructure protection. Use when commanders need persistent underwater awareness and rapid anomaly triage.
---
...
1. Frame the mission problem using these core inputs: sensor health/status, acoustic detections, infrastructure geofences, maritime traffic patterns.
...
Primary products for this skill: undersea sensor tasking plan, anomaly triage queue, restoration and patrol integration matrix.
...
- Prioritize these tools or tool families for this domain: undersea surveillance systems, maritime COP tools, AIS fusion feeds, maintenance planning systems.
- Specify outbound exchange format for recommendations and tasking: AIS/NMEA, Link 16 J-series, USMTF, API/JSON.
