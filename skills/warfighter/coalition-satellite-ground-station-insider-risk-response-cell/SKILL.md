---
name: coalition-satellite-ground-station-insider-risk-response-cell
description: Support coalition insider-risk detection and continuity response for satellite ground station operations.
---

# Coalition Satellite Ground Station Insider Risk Response Cell
...
- Primary: `tool_suite_id=ts-coalition-sat-ground-insider-risk-response-v1` with `protocol_stack_id=ps-coalition-sat-ground-insider-risk-response-stack-v1`.
...
- Default packet IDs: DPL-COALITION-SAT-GROUND-INSIDER-RISK-RESPONSE-001, DPL-CEMA-BDA-001.
