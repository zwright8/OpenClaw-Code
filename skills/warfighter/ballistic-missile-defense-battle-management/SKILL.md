---
name: ballistic-missile-defense-battle-management
description: Plan regional ballistic missile defense sensor cueing and interceptor employment. Use when synchronizing BMD warning, battle management, and defended-area priorities.
---
...
1. Frame the mission problem using these core inputs: missile warning feeds, defended-area priorities, interceptor inventory, track quality.
...
Primary products for this skill: BMD engagement sequence, defended-area posture card, shot doctrine matrix.
...
- Prioritize these tools or protocol families for this domain: C2BMC or Aegis C2, Link 16 J-series, USMTF.
