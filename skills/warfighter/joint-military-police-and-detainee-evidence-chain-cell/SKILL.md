---
name: joint-military-police-and-detainee-evidence-chain-cell
description: Manage military police operations with detainee accountability, biometric confirmation, and defensible evidence chains. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: detainee transfer ledger, evidence provenance packet, facility risk status brief.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: detainee management systems, biometric verification tools, case/evidence management platforms, facility status dashboards.
- Prioritize these protocol families for this domain: USMTF, API/JSON, NATO APP-11/ADatP-3 aligned.
