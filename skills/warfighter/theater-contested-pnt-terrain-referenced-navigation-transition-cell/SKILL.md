---
name: theater-contested-pnt-terrain-referenced-navigation-transition-cell
description: Transition formations from GNSS-dependent navigation to terrain-referenced and inertial fallback under navwar attack.
---
...
Primary products for this skill: PNT transition execution card, route confidence ladder, navigation risk decision matrix.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: terrain-referenced navigation planners, inertial quality monitors, map and route assurance tools.
- Preferred protocol profiles for coordination and machine exchange: CoT, VMF, USMTF.
