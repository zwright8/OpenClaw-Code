---
name: coalition-harbor-chemical-release-decon-and-reopen-cell
description: Coordinate coalition response to harbor chemical release events and restore safe military throughput with decontamination controls.
---
...
- Use packet template `DPL-HARBOR-CHEM-DECON-REOPEN-001` from `../_shared/references/domain-tool-packet-library.md`.
- Bind tool and protocol choices to `ts-harbor-chemical-decon-reopen-v1` and `ps-harbor-chemical-decon-reopen-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Align execution profile with `harbor-chemical-decon-reopen-v1` from `../_shared/references/joint-operations-external-toolchain-profiles.md`.
...
- Primary: `tool_suite_id=ts-harbor-chemical-decon-reopen-v1` with `protocol_stack_id=ps-harbor-chemical-decon-reopen-stack-v1`.
...
- Default packet ID: `DPL-HARBOR-CHEM-DECON-REOPEN-001`.
