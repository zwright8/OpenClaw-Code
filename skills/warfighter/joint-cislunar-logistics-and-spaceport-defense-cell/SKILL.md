---
name: joint-cislunar-logistics-and-spaceport-defense-cell
description: Support warfighter planning for cislunar logistics continuity and spaceport defense under contested launch and orbital threat conditions.
---
...
- Primary: `tool_suite_id=ts-cislunar-logistics-spaceport-defense-v1` with `protocol_stack_id=ps-cislunar-logistics-spaceport-defense-stack-v1`.
- Alternate: `tool_suite_id=ts-space-launch-resilience-v1` with `protocol_stack_id=ps-space-launch-resilience-stack-v1`.
