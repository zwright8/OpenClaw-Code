---
name: expeditionary-robotic-combat-engineer-support-cell
description: Plan robotic combat engineer support in high-risk mobility corridors. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: obstacle intelligence, robotic platform status, route objectives, threat to engineer teams.
...
Primary products for this skill: robotic engineer task matrix, route breach options, risk-reduction controls.
