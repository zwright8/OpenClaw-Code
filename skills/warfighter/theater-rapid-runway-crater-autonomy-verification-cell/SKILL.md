---
name: theater-rapid-runway-crater-autonomy-verification-cell
description: Verify autonomy-assisted runway crater repair recommendations before sortie regeneration decisions. Use when runway recovery tempo is high and safety validation must remain auditable.
---
...
Primary products for this skill: runway crater repair verification board, autonomy confidence ladder, sortie regeneration safety gate tracker.
...
- Default to `tool_suite_id=ts-runway-crater-autonomy-verification-v1` and `protocol_stack_id=ps-runway-crater-autonomy-verification-stack-v1` for mission-critical recommendations in this domain.
