---
name: tactical-urban-utility-isolation-and-restoration-cell
description: Support U.S. warfighter planning and operational decision support for Tactical Urban Utility Isolation and Restoration Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: utility state data, civil impact estimates, protection constraints, mission priorities.
...
Primary products for this skill: urban utility isolation plan, restoration sequencing matrix, force protection utility board.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: utility telemetry systems, engineering ops dashboards, civil infrastructure maps, emergency coordination tools.
