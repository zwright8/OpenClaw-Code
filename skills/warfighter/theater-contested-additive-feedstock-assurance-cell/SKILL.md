---
name: theater-contested-additive-feedstock-assurance-cell
description: Coordinate theater-level additive feedstock quality assurance under contested sustainment conditions. Use when units must validate feedstock provenance before mission-critical production.
---

# Theater Contested Additive Manufacturing Feedstock Assurance Cell
...
Primary products for this skill: feedstock assurance ledger, additive production release matrix, contamination response branch plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: material assay telemetry, additive process control boards, supply provenance monitors, quality release governance tools.
...
- Add `tool_suite_id=ts-contested-additive-feedstock-assurance-v1` + `protocol_stack_id=ps-contested-additive-feedstock-assurance-stack-v1` when producing critical recommendations for this mission domain.
