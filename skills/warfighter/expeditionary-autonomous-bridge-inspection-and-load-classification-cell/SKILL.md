---
name: expeditionary-autonomous-bridge-inspection-and-load-classification-cell
description: Coordinate autonomous bridge inspection and military load classification for expeditionary maneuver under contested conditions. Use when mobility corridors depend on rapid confidence-scored structural assessment.
---
...
Primary products for this skill: bridge load classification board, autonomous inspection confidence report, heavy-route branch decision matrix.
...
- Add `tool_suite_id=ts-expeditionary-autonomous-bridge-load-classification-v1` + `protocol_stack_id=ps-expeditionary-autonomous-bridge-load-classification-stack-v1` when producing critical recommendations for this mission domain.
