---
name: coalition-civilian-evacuation-digital-twin-traffic-cell
description: Build coalition evacuation traffic digital twins to reduce civilian bottlenecks, exposure, and route collisions during large-scale movement operations.
---

# Coalition Civilian Evacuation Digital Twin Traffic Assurance Cell
...
Primary products for this skill: evacuation digital-twin throughput board, convoy release sequence plan, civilian congestion risk ladder.
...
- Add `tool_suite_id=ts-civilian-evacuation-digital-twin-traffic-assurance-v1` + `protocol_stack_id=ps-civilian-evacuation-digital-twin-traffic-assurance-stack-v1` when producing critical recommendations for this mission domain.
