---
name: joint-weapon-system-software-supply-chain-assurance-cell
description: Assure weapon-system software supply chains with provenance checks, vulnerability triage, and release-governance controls.
---
...
Primary products for this skill: software supply assurance report, release hold/release matrix, mission risk acceptance packet.
...
- `tool_suite_id`: `ts-weapons-software-supply-chain-v1`
- `protocol_stack_id`: `ps-weapons-software-supply-chain-stack-v1`
