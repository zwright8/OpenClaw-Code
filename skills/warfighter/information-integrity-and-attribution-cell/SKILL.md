---
name: information-integrity-and-attribution-cell
description: Support U.S. warfighter planning and decision support for Information Integrity And Attribution Cell. Use when missions require mis/disinformation attribution support and operational information integrity assessments for commanders, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: information integrity assessment, attribution confidence matrix, counter-narrative decision options.
...
- Prioritize these tools or protocol families for this domain: social/media analytics tools, deepfake detection stacks, public affairs workflows.
- State the protocol or message format for outbound coordination (for example API/JSON, STIX/TAXII, USMTF).
