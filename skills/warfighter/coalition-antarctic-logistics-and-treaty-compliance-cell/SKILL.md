---
name: coalition-antarctic-logistics-and-treaty-compliance-cell
description: Plan coalition Antarctic sustainment while preserving treaty compliance and mission assurance. Use when austere polar operations need legal-safe logistics, environmental controls, and medical continuity.
---
...
Primary products for this skill: polar sustainment synchronization board, treaty compliance risk log, antarctic medevac and weather-branch plan.
...
- Prioritize tool_suite_id=ts-antarctic-logistics-treaty-compliance-v1 + protocol_stack_id=ps-antarctic-logistics-treaty-compliance-stack-v1 when coalition sustainment actions must satisfy Antarctic Treaty constraints and severe-weather risk controls.
- Add packet_id=DPL-ANTARCTIC-LOGISTICS-TREATY-COMPLIANCE-001 for recommendation branches that alter fuel caches, protected area transit, or international notification timelines.
