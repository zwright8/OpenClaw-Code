---
name: joint-subsea-geothermal-sensor-power-denial-cell
description: Sustain subsea sensor networks using geothermal and alternate power plans under denial, sabotage, or cable cut conditions.
---
...
Primary products for this skill: subsea power continuity map, sensor duty-cycle branch table, repair-versus-reroute decision board.

## Tool Suite and Protocol Binding

- Bind tool selection to `ts-subsea-geothermal-power-denial-v1` and `ps-subsea-geothermal-power-denial-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Recommended external tools for this domain: subsea power management systems, cable integrity monitors, UUV inspection telemetry, and maritime energy models.
- Required protocol families for implementation: NMEA 2000, DDS, IEC 61850, and OGC SensorThings API.
