---
name: coalition-offshore-energy-platform-defense-integration-cell
description: Coordinate coalition defense of offshore energy platforms against drone, missile, and sabotage threats while preserving production continuity.
---
...
Primary products for this skill: platform defense posture map, patrol/deconfliction matrix, continuity branch plan.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: offshore platform telemetry, maritime patrol COP, coastal radar and UAS defense feeds.
- Preferred protocol profiles for coordination and machine exchange: AIS/NMEA, Link 16 J-series, USMTF.
...
- Default packet binding for this domain: DPL-OFFSHORE-PLATFORM-DEFENSE-001.
