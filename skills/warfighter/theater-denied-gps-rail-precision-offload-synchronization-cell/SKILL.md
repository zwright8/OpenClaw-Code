---
name: theater-denied-gps-rail-precision-offload-synchronization-cell
description: Synchronize rail offload and onward movement in denied GPS environments using resilient timing and cross-domain tracking.
---
...
- Primary: `tool_suite_id=ts-denied-gps-rail-precision-offload-sync-v1` with `protocol_stack_id=ps-denied-gps-rail-precision-offload-sync-stack-v1`.
...
- Default packet IDs: `DPL-DENIED-GPS-RAIL-PRECISION-OFFLOAD-SYNC-001`.
