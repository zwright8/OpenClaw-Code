---
name: strategic-semiconductor-packaging-defense-surge-cell
description: Support defense-priority semiconductor packaging and test surge planning during contested supply shocks. Use when military-critical electronics throughput is threatened.
---
...
Primary products for this skill: semiconductor packaging bottleneck brief, defense-priority wafer-to-package routing plan, surge readiness scorecard

## External Tools and Protocol Integration

- Use ../_shared/references/warfighter-external-tool-and-protocol-catalog.md and bind outputs to tool_suite_id=ts-strategic-semiconductor-packaging-defense-surge-v1 and protocol_stack_id=ps-strategic-semiconductor-packaging-defense-surge-stack-v1.
- Primary tools for this domain: industrial throughput dashboards, packaging/test capacity planners, defense-priority demand allocators
- Required exchange protocols/formats for this domain: NIMS/ICS, USMTF, API/JSON, OGC WMS/WFS/WMTS
