---
name: joint-cislunar-deep-space-crew-radiation-storm-response-cell
description: Coordinate warning, sheltering, mission timeline adaptation, and rescue fallback for cislunar and deep-space crewed operations under radiation storm conditions.
---

# Joint Cislunar Deep Space Crew Radiation Storm Response Cell
...
- Use packet template DPL-CISLUNAR-RAD-STORM-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-cislunar-radiation-storm-response-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-cislunar-radiation-storm-response-v1 with protocol_stack_id=ps-cislunar-radiation-storm-response-stack-v1.
...
- Default packet ID: DPL-CISLUNAR-RAD-STORM-001.
