---
name: tactical-civilian-hospital-overflow-integration-cell
description: Support U.S. warfighter planning and decision support for Tactical Civilian Hospital Overflow Integration Cell. Use when missions require Tactical Civilian Hospital Overflow Integration Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: civil-military bed integration board, casualty diversion plan, critical-care shortage trigger matrix.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: hospital bed status exchanges, casualty regulation systems, ambulance routing boards.
- Prioritize these protocol families for this domain: HL7/FHIR, NIMS/ICS, USMTF, API/JSON.
