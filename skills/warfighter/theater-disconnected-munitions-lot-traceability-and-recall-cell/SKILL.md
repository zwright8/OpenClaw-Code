---
name: theater-disconnected-munitions-lot-traceability-and-recall-cell
description: Support U.S. warfighter planning for disconnected munitions lot traceability, safety recall execution, and reallocation under denied logistics conditions.
---
...
Primary products for this skill: munitions lot risk register, recall execution sequence, safe reallocation matrix.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: munitions inventory ledger, lot genealogy analyzer, recall workflow orchestrator, depot-status cross-check mirror.
...
- Prefer these protocol families for this skill: USMTF, API/JSON, STIX/TAXII, signed release manifests.
