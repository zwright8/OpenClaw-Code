---
name: integrated-air-missile-defense-decoy-discrimination-cell
description: Discriminate adversary decoys from valid air and missile tracks for integrated defense. Use when saturation attacks stress sensor confidence and interceptor allocation.
---

# Integrated Air and Missile Defense Decoy Discrimination Cell
...
Primary products for this skill: decoy discrimination confidence map, interceptor allocation branch matrix, sensor-truth cross-check report.
...
- Prioritize these tool families for this domain: AMD battle management systems, multi-sensor fusion engines, EW emitter libraries, interceptor inventory tools.
- Prioritize these protocol families for this domain: Link 16 J-series, CEC tactical data exchanges, USMTF.
