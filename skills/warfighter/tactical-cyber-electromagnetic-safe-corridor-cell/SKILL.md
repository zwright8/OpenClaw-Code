---
name: tactical-cyber-electromagnetic-safe-corridor-cell
description: Support U.S. warfighter planning and operational decision support for Tactical Cyber Electromagnetic Safe Corridor Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: mission routes, EW threat posture, cyber indicators, command authorities.
...
Primary products for this skill: safe corridor control plan, cyber-EW deconfliction matrix, comms survivability branch plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: EW planning suites, cyber defense consoles, tactical network managers, mission routing dashboards.
...
- Prefer these protocol families for this skill: STIX/TAXII, VMF, USMTF.
