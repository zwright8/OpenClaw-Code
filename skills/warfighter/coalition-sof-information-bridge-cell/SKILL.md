---
name: coalition-sof-information-bridge-cell
description: Bridge releasable operational information between coalition SOF elements while preserving caveats and mission tempo. Use when SOF mission success depends on tightly governed coalition sharing.
---
...
1. Frame the mission problem using these core inputs: SOF mission timelines, caveat rules, data releasability tags, partner reporting latency.
...
Primary products for this skill: coalition sharing architecture, caveat-safe release packets, synchronization timeline.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools or tool families for this domain: coalition data-fabric services, identity federation systems, releasability guard workflows, secure collaboration boards.
