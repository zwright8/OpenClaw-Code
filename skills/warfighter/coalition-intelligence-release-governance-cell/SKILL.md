---
name: coalition-intelligence-release-governance-cell
description: Govern multinational intelligence release, sanitization, and caveat compliance for coalition operations. Use when producing releasable intelligence products across mixed classification environments.
---
...
1. Frame the mission problem using these core inputs: source classification caveats, partner releasability rules, mission timelines, and intelligence priorities.
...
Primary products for this skill: releasability decision log, sanitization workflow matrix, coalition intelligence release package.
