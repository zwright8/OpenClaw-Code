---
name: joint-arctic-multi-domain-sar-and-medical-authentication-cell
description: Support Arctic rescue and casualty recovery with survivor-authentication confidence, cross-domain SAR synchronization, and hypothermia-driven medical routing.
---

# Joint Arctic Multi Domain SAR and Medical Authentication Cell
...
Use these tool categories by default: polar SAR route planners, survivor-authentication and beacon-verification services, cold-weather casualty regulation boards.

## Protocol Profile

Preferred protocol families for this skill: USMTF, CoT, HL7/FHIR, AIS/NMEA, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-ARCTIC-SAR-MEDAUTH-001 for critical recommendations.
