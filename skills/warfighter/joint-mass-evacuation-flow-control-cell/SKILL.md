---
name: joint-mass-evacuation-flow-control-cell
description: Optimize military-supported mass evacuation under contested conditions, balancing throughput, security, and medical prioritization. Use when planning or adapting large-scale evacuation operations.
---
...
1. Frame the mission problem using these core inputs: evacuation demand estimates, route status, transport availability, shelter capacity and medical acuity.
...
Primary products for this skill: evacuation throughput control plan, route branch matrix, prioritized lift schedule.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools or tool families for this domain: movement control systems, ICS evacuation boards, patient regulation systems, geospatial routing tools.
