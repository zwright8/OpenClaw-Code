---
name: theater-biofabrication-blood-substitute-surge-cell
description: Coordinate emergency biofabrication and distribution of blood substitutes and critical biologics in prolonged casualty surge operations.
---

# Theater Biofabrication Blood Substitute Surge Cell
...
Primary products for this skill: biofabrication production plan, cold-chain release matrix, casualty-priority biologic allocation board.

## Domain Tool Stack

Use these tool categories as the baseline stack: medical manufacturing execution systems, blood-bank registries, temp-chain telemetry, evacuation regulation dashboards.

## Protocol Profile

Preferred protocol families for this skill: HL7 FHIR, USMTF medical messages, ASTM cold-chain telemetry, CoT.
...
- Prioritize `tool_suite_id=ts-theater-biofabrication-blood-substitute-surge-cell-v1` + `protocol_stack_id=ps-theater-biofabrication-blood-substitute-surge-cell-stack-v1` when this mission set is the critical path for commander decision timelines.
- Add `packet_id=DPL-THEATER_BIOFABRICATION_BLOOD_SUBSTITUTE_SURGE_CELL-001` for the primary course of action and `packet_id=DPL-THEATER_BIOFABRICATION_BLOOD_SUBSTITUTE_SURGE_CELL-002` for degraded-mode fallback actions.
