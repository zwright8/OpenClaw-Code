---
name: joint-counter-hypersonic-decoy-discrimination-cell
description: Discriminate hypersonic decoys from credible threats to improve warning confidence, defensive posture timing, and escalation control.
---
...
Primary products: decoy discrimination confidence ladder, warning posture trigger matrix, and high-risk branch decision packet.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-counter-hypersonic-decoy-discrimination-v1` with `protocol_stack_id=ps-counter-hypersonic-decoy-discrimination-stack-v1`.
...
- Default packet IDs: `DPL-COUNTER-HYPERSONIC-DECOY-DISCRIMINATION-001`, `DPL-HYPERSONIC-WARNING-POSTURE-TRIGGER-001`.
