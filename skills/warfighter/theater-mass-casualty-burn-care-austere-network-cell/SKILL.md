---
name: theater-mass-casualty-burn-care-austere-network-cell
description: Support U.S. warfighter planning for mass-casualty burn care across austere medical networks. Use when evacuation routing, burn-bed availability, and supply continuity are contested.
---
...
Primary products for this skill: burn-care triage network map, evacuation and transfer ladder, consumables depletion forecast.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-burn-care-austere-network-v1` with `protocol_stack_id=ps-medical-c4i-patient-movement-stack-v1`.
...
- Default packet IDs: DPL-BURN-MASCAL-001, DPL-CASEVAC-AUTO-001.
