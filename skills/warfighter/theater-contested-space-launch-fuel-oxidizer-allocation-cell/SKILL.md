---
name: theater-contested-space-launch-fuel-oxidizer-allocation-cell
description: Support contested theater allocation of launch fuel and oxidizer across military space reconstitution priorities. Use when launch cadence and survivability depend on constrained propellant distribution.
---
...
Primary products for this skill: launch fuel-oxidizer allocation board, reconstitution priority ladder, mission-delay decision trigger packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: spaceport fuel inventory telemetry, launch scheduling arbitration services, oxidizer safety compliance monitors, strategic reconstitution planning tools.
...
- Add `tool_suite_id=ts-space-launch-fuel-oxidizer-allocation-v1` + `protocol_stack_id=ps-space-launch-fuel-oxidizer-allocation-stack-v1` when producing critical recommendations for this mission domain.
