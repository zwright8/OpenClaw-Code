---
name: joint-rapid-harbor-mine-countermeasure-autonomy-cell
description: Synchronize autonomous and crewed mine-countermeasure operations to reopen harbors under threat. Use when commanders need risk-bounded opening timelines with concrete external tool and protocol contracts.
---
...
Primary products for this skill: harbor reopen timeline, autonomous sortie sync board, mine-risk clearance matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-harbor-mcm-autonomy-v1` with `protocol_stack_id=ps-harbor-mcm-autonomy-stack-v1`.
...
- Default packet ID: `DPL-HARBOR-MCM-AUTONOMY-001`.
...
- Default `toolchain_id`: `TC-MAR-SUB-004`.
