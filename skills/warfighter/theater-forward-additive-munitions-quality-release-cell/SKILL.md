---
name: theater-forward-additive-munitions-quality-release-cell
description: Govern forward additive munitions production quality and release decisions under contested sustainment pressure.
---
...
Primary products: additive lot confidence board, munitions release governance queue, theater sustainment quality packet.
...
- Primary: `tool_suite_id=ts-theater-forward-additive-munitions-quality-release-v1` with `protocol_stack_id=ps-theater-forward-additive-munitions-quality-release-stack-v1`.
...
- Default packet IDs: `DPL-THEATER-FORWARD-ADDITIVE-MUNITIONS-QUALITY-RELEASE-001`.
