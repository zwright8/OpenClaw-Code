---
name: contested-communications-electromagnetic-hardening
description: Harden mission communications against jamming, spoofing, and electromagnetic disruption. Use when designing resilient comms architectures and fallback pathways under contested spectrum conditions.
---
...
1. Frame the mission problem using these core inputs: network topology, spectrum usage profile, threat EW activity, and mission communication priorities.
...
Primary products for this skill: communications hardening plan, EW resilience profile, comms fallback execution matrix.
