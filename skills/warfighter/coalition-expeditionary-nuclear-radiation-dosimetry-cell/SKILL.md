---
name: coalition-expeditionary-nuclear-radiation-dosimetry-cell
description: Coordinate coalition portable dosimetry operations for expeditionary nuclear and radiological threats. Use when forces require exposure tracking, sheltering thresholds, and mission continuation decisions.
---

# Coalition Expeditionary Portable Nuclear Radiation Dosimetry Cell
...
Primary products for this skill: radiation exposure posture board, dosimeter distribution plan, mission continuation threshold log.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-expeditionary-radiation-dosimetry-v1` with `protocol_stack_id=ps-expeditionary-radiation-dosimetry-stack-v1`.
- Alternate: `tool_suite_id=ts-radiological-urban-response-v1` with `protocol_stack_id=ps-cbrn-urban-plume-evac-stack-v1`.
...
- Default packet IDs: DPL-RAD-DOSIMETRY-001.
