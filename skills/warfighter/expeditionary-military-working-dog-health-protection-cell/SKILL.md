---
name: expeditionary-military-working-dog-health-protection-cell
description: Support expeditionary military working dog readiness with veterinary triage, zoonotic risk tracking, and preventive care scheduling.
---
...
- Use packet template `DPL-MWD-HEALTH-PROTECTION-001` from `../_shared/references/domain-tool-packet-library.md`.
- Bind tool and protocol choices to `ts-mwd-health-protection-v1` and `ps-mwd-health-protection-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Align execution profile with `mwd-health-protection-v1` from `../_shared/references/joint-operations-external-toolchain-profiles.md`.
...
- Primary: `tool_suite_id=ts-mwd-health-protection-v1` with `protocol_stack_id=ps-mwd-health-protection-stack-v1`.
...
- Default packet ID: `DPL-MWD-HEALTH-PROTECTION-001`.
