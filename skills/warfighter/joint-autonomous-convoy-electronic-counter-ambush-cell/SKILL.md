---
name: joint-autonomous-convoy-electronic-counter-ambush-cell
description: Support U.S. warfighter planning and operational decision support for Joint Autonomous Convoy Electronic Counter-Ambush Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: route plans, convoy composition, EW threat profile, ISR cueing data.
...
Primary products for this skill: convoy counter-ambush operations matrix, EW protective routing plan, autonomous escort control package.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: autonomous convoy C2 tools, EW countermeasure systems, route-risk analytics, ISR cueing dashboards.
