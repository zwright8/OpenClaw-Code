---
name: expeditionary-water-infrastructure-sabotage-response-cell
description: Coordinate response to water infrastructure sabotage affecting expeditionary and civil-support operations. Use when detecting contamination, restoring potable flow, and managing force health and local stability impacts.
---

# Expeditionary Water Infrastructure Sabotage Response Cell
...
Primary products for this skill: Water sabotage attribution board, restoration sequencing packet, and force health risk branch matrix.
...
- Add `tool_suite_id=ts-expeditionary-water-infrastructure-sabotage-response-v1` + `protocol_stack_id=ps-expeditionary-water-infrastructure-sabotage-response-stack-v1` for this mission domain as default external integration profile.
- Add `packet_id=DPL-EXPEDITIONARY-WATER-INFRASTRUCTURE-SABOTAGE-RESPONSE-001` for mission branches that can alter force posture, mission risk, or escalation dynamics.
