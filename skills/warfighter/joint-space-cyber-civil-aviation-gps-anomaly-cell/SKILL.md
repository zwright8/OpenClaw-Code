---
name: joint-space-cyber-civil-aviation-gps-anomaly-cell
description: Adjudicate cross-domain GPS/PNT anomalies impacting military and civil aviation operations. Use when U.S. commands must separate spoofing, jamming, space weather, and cyber causes to protect flight safety and mission continuity.
---
...
Primary products for this skill: GPS anomaly attribution packet, aviation continuity branch matrix, cross-domain PNT mitigation order.

## Domain Tool Stack

Use these tool categories as the baseline stack: space weather monitoring, GNSS integrity services, civil aviation surveillance feeds, cyber threat telemetry and route safety tools.

## Protocol Profile

Preferred protocol families for this skill: NOTAM/ICAO exchange formats, ADS-B, Link 16 J-series, STANAG 4586, NMEA/RTCM integrity profiles.
