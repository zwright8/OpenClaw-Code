---
name: humanitarian-aid-supply-deconfliction-and-last-mile-delivery-cell
description: Coordinate military-supported humanitarian logistics with NGOs and civil authorities while reducing delivery conflict and duplication.
---

# Humanitarian Aid Supply Deconfliction and Last-Mile Delivery Cell
...
Primary products for this skill: aid deconfliction board, last-mile delivery routing plan, humanitarian access risk log.
...
- Suggested tools: WFP logistics feeds, UN OCHA updates, host-nation customs/port status, convoy tracking systems, satellite imagery.
- Protocol/message standards: HDX APIs, OGC WMS/WFS, CAP, EDXL.
