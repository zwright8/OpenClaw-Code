---
name: theater-adversary-drone-factory-disruption-prioritization-cell
description: Prioritize non-kinetic and kinetic disruption options against adversary drone manufacturing and assembly networks.
---
...
Primary products for this skill: factory disruption priority board, campaign options ladder, effects verification timeline.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: supply-chain network analytics, ISR factory-activity monitors, sanctions and interdiction workflow boards.
- Preferred protocol profiles for coordination and machine exchange: STIX/TAXII, USMTF, API/JSON.
