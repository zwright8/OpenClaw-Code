---
name: joint-expeditionary-waterborne-drone-port-security-cell
description: Support U.S. warfighter planning for expeditionary port security against waterborne drone swarms and mixed surface threats.
---
...
Primary products for this skill: port-waterline threat confidence map, pier defense branch matrix, convoy ingress protection packet.

## Domain Tool Stack

Use these tool categories by default: maritime sensor fusion services, C-UxS command tools, harbor defense kill-chain rehearsal boards.

## Protocol Profile

Preferred protocol families for this skill: AIS/NMEA, USMTF, VMF, API/JSON.

## Domain Toolchain Defaults

- Primary: tool_suite_id=ts-waterborne-drone-port-security-v1 with protocol_stack_id=ps-waterborne-drone-port-security-stack-v1.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-WATERBORNE-DRONE-PORT-SECURITY-001 for critical recommendations.
