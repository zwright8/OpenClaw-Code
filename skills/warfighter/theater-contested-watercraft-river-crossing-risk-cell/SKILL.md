---
name: theater-contested-watercraft-river-crossing-risk-cell
description: Support U.S. warfighter planning and decision support for Theater Contested Watercraft River Crossing Risk Cell. Use when missions require contested river crossing risk analysis and synchronized military watercraft employment with protocol-aware staff outputs.
---
...
Primary products for this skill: crossing feasibility matrix, crossing-window risk map, engineer and watercraft synchronization board.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: hydrographic feeds, combat engineer planning tools, inland watercraft movement control dashboards.

## Protocol Profile

Preferred protocol families for this skill: USMTF, VMF, OGC.
