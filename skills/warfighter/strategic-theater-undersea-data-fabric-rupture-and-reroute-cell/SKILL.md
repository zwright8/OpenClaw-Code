---
name: strategic-theater-undersea-data-fabric-rupture-and-reroute-cell
description: Support U.S. warfighter planning for strategic undersea data-fabric rupture detection, reroute sequencing, and mission-network continuity under maritime contestation.
---
...
Primary products for this skill: undersea data-fabric rupture triage board, reroute confidence matrix, mission continuity branch packet.

## Domain Tool Stack

Use these tool categories by default: subsea cable telemetry analytics, maritime anomaly correlation tools, mission-network path orchestration dashboards.

## Protocol Profile

Preferred protocol families for this skill: USMTF, CCSDS, STIX/TAXII, AIS/NMEA, API/JSON.

## Domain Toolchain Defaults

- Primary: tool_suite_id=ts-undersea-data-fabric-reroute-v1 with protocol_stack_id=ps-undersea-data-fabric-reroute-stack-v1.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-UNDERSEA-DATA-FABRIC-REROUTE-001 for critical recommendations.
