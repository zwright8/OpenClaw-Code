---
name: joint-civilian-maritime-evacuation-port-surge-arbitration-cell
description: Support warfighter planning for civilian maritime evacuation, port surge arbitration, and protected military throughput coexistence.
---

# Joint Civilian Maritime Evacuation Port Surge Arbitration Cell
...
Primary products for this skill: evacuation port surge brief, military-civil throughput arbitration matrix, and legal-authority branch plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-civilian-maritime-evac-port-surge-arbitration-v1` with `protocol_stack_id=ps-civilian-maritime-evac-port-surge-arbitration-stack-v1`.
- Alternate: `tool_suite_id=ts-maritime-undersea-v1` with `protocol_stack_id=ps-maritime-quarantine-stack-v1`.
...
- Default packet IDs: DPL-MARITIME-EVAC-PORT-SURGE-001, DPL-CIVIL-MIL-PORT-ARBITRATION-001
