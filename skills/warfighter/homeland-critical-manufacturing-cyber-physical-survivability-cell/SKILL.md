---
name: homeland-critical-manufacturing-cyber-physical-survivability-cell
description: Support U.S. warfighter and homeland defense planning for cyber-physical resilience of critical manufacturing nodes supporting force readiness.
---
...
Primary products for this skill: manufacturing survivability matrix, disruption containment branch board, strategic output continuity packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: industrial telemetry fusion boards, cyber-physical anomaly detectors, production-priority adjudicators.
...
- Prefer protocol families: USMTF, STIX/TAXII, NIEM, NIMS/ICS, API/JSON.
...
- Primary: tool_suite_id=ts-homeland-critical-manufacturing-cyber-physical-survivability-v1 with protocol_stack_id=ps-homeland-critical-manufacturing-cyber-physical-survivability-stack-v1.
- Alternate: tool_suite_id=ts-strategic-industrial-mobilization-readiness-v1 with protocol_stack_id=ps-strategic-industrial-mobilization-readiness-stack-v1.
- Degraded: authenticated voice/readback plus UTC acknowledgment ledger and manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-HOMELAND-MANUFACTURING-SURVIVABILITY-001, DPL-HOMELAND-MANUFACTURING-SURVIVABILITY-002.
