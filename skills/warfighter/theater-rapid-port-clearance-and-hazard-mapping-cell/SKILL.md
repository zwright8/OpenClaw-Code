...
1. Frame the mission problem using these core inputs: port status reports, hydrographic data, hazard sightings, throughput requirements.
...
Primary products for this skill: port clearance operations brief, hazard-priority map set, throughput restoration branch plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: maritime ops centers, hydrographic survey tools, explosive hazard mapping systems, logistics flow monitors.
