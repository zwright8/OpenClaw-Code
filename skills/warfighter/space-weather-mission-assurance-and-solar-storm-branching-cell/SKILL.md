---
name: space-weather-mission-assurance-and-solar-storm-branching-cell
description: Assess space weather impacts on communications, navigation, and ISR to branch mission plans safely. Use when solar activity can degrade multi-domain operations.
---

# Space Weather Mission Assurance and Solar Storm Branching Cell
...
1. Frame the mission problem using these core inputs: space weather forecasts, comms/nav system health, mission critical path dependencies, escalation thresholds.
...
Primary products for this skill: space-weather impact matrix, mission branch recommendations, assurance watchlist packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: space weather monitoring systems, SATCOM/PNT health dashboards, cross-domain dependency graphs.

## Protocol Profile

Preferred protocol families for this skill: CCSDS, USMTF, OGC, API/JSON.
