---
name: theater-denied-water-purification-membrane-failure-and-bypass-cell
description: Support denied-environment potable water continuity by diagnosing membrane failure, validating bypass treatment, and controlling contamination risk.
---
...
Primary products: bypass activation order, potable confidence scorecard, and distribution continuity branch.

## Domain Toolchain Defaults

- Primary: tool_suite_id=ts-water-membrane-bypass-assurance-v1 with protocol_stack_id=ps-water-membrane-bypass-assurance-stack-v1.
...
- Default packet IDs: DPL-WATER-MEMBRANE-BYPASS-ASSURANCE-001.
