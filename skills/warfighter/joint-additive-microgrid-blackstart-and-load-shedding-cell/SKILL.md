---
name: joint-additive-microgrid-blackstart-and-load-shedding-cell
description: Coordinate additive-enabled microgrid blackstart and tactical load shedding during sustained base disruption. Use when expeditionary power restoration must preserve C2 and life-support priorities.
---

# Joint Additive Microgrid Blackstart And Load Shedding Cell
...
- Use packet template DPL-ADDITIVE-MICROGRID-BLACKSTART-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-additive-microgrid-blackstart-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-additive-microgrid-blackstart-v1 with protocol_stack_id=ps-additive-microgrid-blackstart-stack-v1.
...
- Default packet ID: DPL-ADDITIVE-MICROGRID-BLACKSTART-001.
