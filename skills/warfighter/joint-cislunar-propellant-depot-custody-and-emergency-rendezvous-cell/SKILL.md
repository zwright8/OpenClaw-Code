---
name: joint-cislunar-propellant-depot-custody-and-emergency-rendezvous-cell
description: Support U.S. warfighter planning for Joint Cislunar Propellant Depot Custody and Emergency Rendezvous Cell.
---
...
Use these tool categories by default: cislunar depot telemetry boards, propellant custody ledgers, and emergency rendezvous deconfliction planners.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-JOINT-CISLUNAR-PROPELLANT-DEPOT-CUSTODY-EMERGENCY-RENDEZVOUS-001 for critical recommendations.
