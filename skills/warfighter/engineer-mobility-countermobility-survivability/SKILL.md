---
name: engineer-mobility-countermobility-survivability
description: Plan engineer mobility, countermobility, and survivability effects for maneuver forces. Use when integrating breaching, obstacle employment, and defensive works.
---

# Engineer MCS Planner
...
1. Frame the mission problem using these core inputs: terrain obstacles, breach assets, obstacle intent, force posture.
...
Primary products for this skill: MCS support matrix, obstacle effects overlay, survivability priorities list.
