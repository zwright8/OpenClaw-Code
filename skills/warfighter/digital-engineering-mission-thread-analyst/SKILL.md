---
name: digital-engineering-mission-thread-analyst
description: Map mission threads and digital dependencies to expose fragility in command-and-control systems. Use when evaluating architecture readiness and failure propagation risk.
---

# Digital Engineering Mission Thread Analyst
...
1. Frame the mission problem using these core inputs: system architecture, mission threads, integration dependencies, failure modes.
...
Primary products for this skill: mission thread analysis, digital dependency map, resilience investment priorities.
