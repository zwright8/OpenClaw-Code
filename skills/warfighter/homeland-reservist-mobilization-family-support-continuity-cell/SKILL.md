---
name: homeland-reservist-mobilization-family-support-continuity-cell
description: Synchronize reserve mobilization with family-support continuity to protect force readiness and civic stability.
---
...
- Primary: `tool_suite_id=ts-reservist-family-readiness-continuity-v1` with `protocol_stack_id=ps-reservist-family-readiness-continuity-stack-v1`.
...
- Default packet IDs: `DPL-RESERVIST-FAMILY-READINESS-CONTINUITY-001`.
