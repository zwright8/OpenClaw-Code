---
name: expeditionary-fuel-pipeline-and-bulk-water-terminal-support
description: Support theater fuel and water distribution through expeditionary pipeline and terminal operations. Use when planning throughput, protection, and contingency reroute actions.
---
...
1. Frame the mission problem using these core inputs: demand forecasts, node capacities, line status, threat posture.
...
Primary products for this skill: fuel and water flow plan, terminal operating schedule, contingency reroute matrix.
...
- Prioritize these tools or protocol families for this domain: logistics C2 systems, USMTF, API/JSON.
