---
name: strategic-battlefield-ai-model-weight-supply-chain-assurance-cell
description: Assure the integrity and provenance of battlefield AI model weights across distributed deployment channels. Use when adversarial tampering risk affects mission-critical model behavior.
---
...
Primary products for this skill: model weight provenance assurance packet, tamper-risk branch matrix, deployment trust gate ledger.
...
- Default to `tool_suite_id=ts-ai-model-weight-supply-chain-assurance-v1` and `protocol_stack_id=ps-ai-model-weight-supply-chain-assurance-stack-v1` for mission-critical recommendations in this domain.
