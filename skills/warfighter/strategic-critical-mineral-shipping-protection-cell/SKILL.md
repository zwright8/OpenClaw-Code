---
name: strategic-critical-mineral-shipping-protection-cell
description: Secure strategic critical-mineral shipping routes, port handling continuity, and interdiction response options.
---
...
Primary products for this skill: critical-mineral shipment risk map, convoy and port protection branch table, interdiction response matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-critical-mineral-shipping-protection-v1` with `protocol_stack_id=ps-critical-mineral-shipping-protection-stack-v1`.
- Alternate: `tool_suite_id=ts-maritime-insurance-reconstitution-v1` with `protocol_stack_id=ps-maritime-insurance-reconstitution-stack-v1`.
...
- Default packet IDs: DPL-CRITICAL-MINERAL-SHIPPING-001.
