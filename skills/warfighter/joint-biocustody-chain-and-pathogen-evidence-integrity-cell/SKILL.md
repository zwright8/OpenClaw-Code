---
name: joint-biocustody-chain-and-pathogen-evidence-integrity-cell
description: Coordinate joint biocustody chains and pathogen evidence integrity for high-consequence incidents, force protection, and legal attribution support.
---
...
- Primary: `tool_suite_id=ts-joint-biocustody-pathogen-integrity-v1` with `protocol_stack_id=ps-joint-biocustody-pathogen-integrity-stack-v1`.
...
- Default packet IDs: `DPL-BIOCUSTODY-PATHOGEN-CHAIN-001`, `DPL-PATHOGEN-EVIDENCE-ATTRIBUTION-001`.
