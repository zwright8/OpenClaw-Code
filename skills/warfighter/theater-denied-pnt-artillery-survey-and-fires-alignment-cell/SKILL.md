---
name: theater-denied-pnt-artillery-survey-and-fires-alignment-cell
description: Support denied-environment artillery survey alignment and fires geometry assurance when GNSS/PNT is degraded, spoofed, or denied.
---
...
Primary products: survey confidence map, fires alignment release packet, and denied-PNT geometry hold/release board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-denied-pnt-artillery-survey-alignment-v1` with `protocol_stack_id=ps-denied-pnt-artillery-survey-alignment-stack-v1`.
...
- Default packet IDs: `DPL-DENIED-PNT-ARTILLERY-SURVEY-001`, `DPL-FIRES-GEOMETRY-CONFIDENCE-DENIED-PNT-001`.
