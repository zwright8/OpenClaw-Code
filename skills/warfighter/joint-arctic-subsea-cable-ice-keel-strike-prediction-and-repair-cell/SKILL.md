---
name: joint-arctic-subsea-cable-ice-keel-strike-prediction-and-repair-cell
description: Predict and mitigate arctic undersea cable damage from ice-keel strikes while preserving U.S. and allied mission network continuity. Use when commanders need repair-window prioritization under contested maritime conditions.
---
...
Primary products: ice-keel risk forecast board, cable repair window ladder, mission-network continuity decision brief.
...
- Primary: `tool_suite_id=ts-arctic-subsea-cable-ice-keel-repair-v1` with `protocol_stack_id=ps-arctic-subsea-cable-ice-keel-repair-stack-v1`.
- Alternate: `tool_suite_id=ts-arctic-subsea-cable-ice-keel-repair-v1` with `protocol_stack_id=ps-arctic-subsea-cable-ice-keel-repair-stack-v1`.
...
- Default packet IDs: DPL-ARCTIC-SUBSEA-CABLE-ICE-KEEL-REPAIR-001, DPL-ARCTIC-SUBSEA-CABLE-ICE-KEEL-REPAIR-001.
