---
name: theater-undersea-chokepoint-autonomy-traffic-control-cell
description: Support U.S. warfighter planning and decision support for undersea chokepoint control using autonomous systems, convoy timing, and deconflicted maritime traffic governance.
---
...
Primary products for this skill: undersea traffic control order, autonomy patrol timing matrix, chokepoint risk and diversion plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: undersea sensor grid managers, maritime traffic analytics, autonomous mission controllers, ASW cueing tools.
