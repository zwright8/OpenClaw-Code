---
name: nuclear-command-authentication-and-incident-containment-cell
description: Support U.S. strategic command teams with authenticated order-path validation, nuclear incident containment, and continuity decision support under high-consequence conditions.
---

# Nuclear Command Authentication and Incident Containment Cell
...
Use these tool categories by default: order-authentication assurance services, strategic incident-containment planners, EMP and fallout impact simulators.

## Protocol Profile

Preferred protocol families for this skill: USMTF, NIEM, NIMS/ICS, STIX/TAXII, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-NUCLEAR-AUTH-CONTAINMENT-001 for critical recommendations.
