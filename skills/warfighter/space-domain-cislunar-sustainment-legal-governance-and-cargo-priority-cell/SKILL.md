---
name: space-domain-cislunar-sustainment-legal-governance-and-cargo-priority-cell
description: Coordinate cislunar sustainment legal governance, cargo-priority arbitration, and custody-safe maneuver sequencing.
---
...
Primary products: cislunar sustainment legal matrix, cargo-priority ladder, orbital custody continuity packet.
...
- Primary: `tool_suite_id=ts-space-domain-cislunar-sustainment-legal-governance-cargo-priority-v1` with `protocol_stack_id=ps-space-domain-cislunar-sustainment-legal-governance-cargo-priority-stack-v1`.
...
- Default packet IDs: `DPL-SPACE-DOMAIN-CISLUNAR-SUSTAINMENT-LEGAL-GOVERNANCE-CARGO-PRIORITY-001`.
