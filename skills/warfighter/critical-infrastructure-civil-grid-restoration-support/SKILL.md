---
name: critical-infrastructure-civil-grid-restoration-support
description: Support restoration of critical civil power and infrastructure to stabilize operations and populations. Use when synchronizing military support, utility priorities, and security conditions.
---
...
1. Frame the mission problem using these core inputs: commander intent, threat and environment updates, force and readiness status, and supporting authorities.
...
Primary products for this skill: Critical grid restoration priority board, utility support task matrix, security-restoration synchronization plan.
