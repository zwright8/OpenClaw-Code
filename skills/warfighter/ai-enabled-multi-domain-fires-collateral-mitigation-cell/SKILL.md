---
name: ai-enabled-multi-domain-fires-collateral-mitigation-cell
description: Support multi-domain fires planning with collateral risk mitigation, legal-compliance checks, and dynamic target confidence management. Use for high-tempo strike planning in contested environments.
---
...
Primary products for this skill: collateral-risk bounded fires option set, target confidence and legal release board, dynamic retarget trigger timeline.
...
- Prioritize these tool/protocol families for this domain: fires mission systems, collateral estimation tools, legal/ROE adjudication workflows.
