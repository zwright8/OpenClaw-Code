---
name: joint-counterspace-satellite-anomaly-attribution-cell
description: Support U.S. warfighter planning and decision support for Joint Counterspace Satellite Anomaly Attribution Cell. Use when missions require protocol-aware, authority-gated planning products in this domain.
---
...
Primary products for this skill: anomaly attribution confidence board, counterspace incident branch matrix, escalation recommendation packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: space domain awareness catalogs, telemetry integrity analytics, adversary TTP correlation graph.

## Protocol Profile

Preferred protocol families for this skill: USMTF, CCSDS, API/JSON.
