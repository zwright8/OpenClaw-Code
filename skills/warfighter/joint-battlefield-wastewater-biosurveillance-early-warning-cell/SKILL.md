---
name: joint-battlefield-wastewater-biosurveillance-early-warning-cell
description: Enable battlefield wastewater biosurveillance early warning for force health and operational continuity. Use when disease emergence risk and force protection posture must be synchronized.
---
...
Primary products for this skill: biosurveillance sentinel map, pathogen trend confidence ladder, force-health intervention trigger matrix.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-wastewater-biosurveillance-v1` with `protocol_stack_id=ps-wastewater-biosurveillance-stack-v1`.
...
- Default packet IDs: DPL-WASTEWATER-BIOSURV-001.
