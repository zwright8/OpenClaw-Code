---
name: theater-seabed-energy-pipeline-protection-and-repair-cell
description: Plan surveillance, damage isolation, and repair prioritization for undersea fuel and power pipeline networks in contested theaters.
---
...
Primary products for this skill: seabed pipeline threat map, repair-window prioritization matrix, energy continuity branch plan.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-seabed-energy-pipeline-defense-v1` with `protocol_stack_id=ps-seabed-energy-pipeline-defense-stack-v1`.
...
- Default packet IDs: DPL-SEABED-ENERGY-PIPELINE-PROTECTION-001.
