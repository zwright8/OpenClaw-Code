---
name: partner-force-vetting-and-trust-assurance
description: Support partner force vetting, trust scoring, and risk-managed integration in security cooperation operations. Use when deciding advisory access, equipment release, and combined planning roles.
---
...
1. Frame the mission problem using these core inputs: partner unit background data, behavior indicators, legal/policy constraints, and mission dependency levels.
...
Primary products for this skill: partner trust assurance matrix, vetting risk register, integration decision support package.
