---
name: strategic-sealift-convoy-protection-and-port-survivability-cell
description: Plan strategic sealift convoy protection and damaged-port throughput recovery for sustained multi-theater force projection.
---
...
- Use packet template DPL-SEALIFT-PORT-SURVIVABILITY-001 from ../_shared/references/domain-tool-packet-library.md.
- Bind tool and protocol choices to ts-strategic-sealift-port-survivability-v1 from ../_shared/references/warfighter-external-tool-and-protocol-catalog.md.
...
- Primary: tool_suite_id=ts-strategic-sealift-port-survivability-v1 with protocol_stack_id=ps-strategic-sealift-port-survivability-stack-v1.
...
- Default packet ID: DPL-SEALIFT-PORT-SURVIVABILITY-001.
