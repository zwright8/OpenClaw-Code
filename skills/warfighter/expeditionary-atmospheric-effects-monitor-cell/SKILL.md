---
name: expeditionary-atmospheric-effects-monitor-cell
description: Assess operational impacts of cloud seeding, aerosol operations, and deliberate atmospheric modification while protecting mission assurance and attribution integrity. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---

# Expeditionary Weather Modification and Atmospheric Effects Monitor Cell
...
Primary products for this skill: atmospheric effects impact brief, weather-modification attribution matrix, sortie and sensor risk window chart.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: weather intelligence platforms, atmospheric chemistry models, satellite weather analytics, mission weather decision dashboards.
- Prioritize these protocol families for this domain: AIXM/FIXM/IWXXM, API/JSON, USMTF, OGC.
