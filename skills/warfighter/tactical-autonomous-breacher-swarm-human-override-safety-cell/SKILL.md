---
name: tactical-autonomous-breacher-swarm-human-override-safety-cell
description: Support U.S. warfighter planning for tactical autonomous breacher-swarm employment with deterministic human-override safety controls.
---
...
Use these tool categories by default: autonomous breacher control boards, human-override timing governors, and urban assault safety monitors.

## Protocol Profile

Preferred protocol families for this skill: CoT, VMF, USMTF, STIX/TAXII, API/JSON.
...
- Use ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-TACTICAL-AUTONOMOUS-BREACHER-SWARM-HUMAN-OVERRIDE-SAFETY-001 for critical recommendations.
