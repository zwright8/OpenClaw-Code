---
name: joint-denied-comms-line-of-bearing-triangulation-cell
description: Generate emitter geolocation and command options when conventional comms are denied and only direction-finding reports are available.
---
...
Primary products for this skill: line-of-bearing fusion plot, emitter confidence map, action recommendation matrix.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: EW direction-finding systems, triangulation solver tools, SIGINT correlation boards, ATAK/WinTAK.
- Preferred protocol profiles for coordination and machine exchange: CoT, Link 16 J-series, USMTF, API/JSON.
