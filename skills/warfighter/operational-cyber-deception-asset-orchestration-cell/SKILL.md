---
name: operational-cyber-deception-asset-orchestration-cell
description: Plan operational cyber deception asset orchestration and control. Use when coordinating options, risks, and staff actions for this mission domain.
---
...
1. Frame the mission problem using these core inputs: deception objectives, adversary observables, asset inventory, legal/authority constraints.
...
Primary products for this skill: cyber deception orchestration plan, observable management matrix, risk controls.
