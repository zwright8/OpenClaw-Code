---
name: theater-fuel-adulteration-detection-and-vehicle-protection-cell
description: Detect fuel adulteration attacks and protect tactical fleets from cascading mobility failures. Use when fuel quality compromise, supply sabotage, or contamination-driven readiness degradation is suspected.
---
...
Primary products for this skill: fuel integrity threat picture, contaminated-lot quarantine and reroute plan, fleet protection and maintenance surge order.
...
- Prioritize tool_suite_id=ts-fuel-adulteration-vehicle-protection-v1 + protocol_stack_id=ps-fuel-adulteration-vehicle-protection-stack-v1 when contested sustainment corridors show abnormal engine failures or fuel quality indicators.
- Add packet_id=DPL-FUEL-ADULTERATION-VEHICLE-PROTECTION-001 for recommendation branches that alter bulk-fuel sourcing, convoy route selection, or platform operating limits.
