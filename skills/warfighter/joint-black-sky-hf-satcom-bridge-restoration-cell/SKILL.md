---
name: joint-black-sky-hf-satcom-bridge-restoration-cell
description: Maintain command-and-control continuity during black-sky events by synchronizing HF fallback, SATCOM recovery, and priority message routing.
---
...
- Use packet template `DPL-BLACK-SKY-C2-BRIDGE-001` from `../_shared/references/domain-tool-packet-library.md`.
- Bind tool and protocol choices to `ts-black-sky-c2-bridge-v1` and `ps-black-sky-c2-bridge-stack-v1` from `../_shared/references/warfighter-external-tool-and-protocol-catalog.md`.
- Align execution profile with `black-sky-c2-bridge-v1` from `../_shared/references/joint-operations-external-toolchain-profiles.md`.
...
- Primary: `tool_suite_id=ts-black-sky-c2-bridge-v1` with `protocol_stack_id=ps-black-sky-c2-bridge-stack-v1`.
...
- Default packet ID: `DPL-BLACK-SKY-C2-BRIDGE-001`.
