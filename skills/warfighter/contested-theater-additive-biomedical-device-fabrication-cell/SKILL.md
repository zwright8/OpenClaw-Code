---
name: contested-theater-additive-biomedical-device-fabrication-cell
description: Plan distributed additive manufacturing of urgent biomedical devices and replacement medical components under denied logistics conditions. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: biomedical fabrication mission queue, material and sterility assurance matrix, distributed delivery branch plan.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: additive manufacturing production planners, medical device QA tracking systems, supply chain inventory tools, med-log coordination platforms.
- Prioritize these protocol families for this domain: HL7/FHIR, API/JSON, USMTF, OGC.
