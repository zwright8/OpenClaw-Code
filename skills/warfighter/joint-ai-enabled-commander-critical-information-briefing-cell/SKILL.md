---
name: joint-ai-enabled-commander-critical-information-briefing-cell
description: Produce commander-ready CCIR/PIR updates by fusing high-velocity reporting into concise decision briefs. Use when staffs need prioritized, confidence-scored updates for time-sensitive command decisions.
---
...
1. Frame the mission problem using these core inputs: commander critical information requirements, incoming reports, sensor/collection confidence, decision timeline, authority thresholds.
...
Primary products for this skill: CCIR delta brief, confidence-weighted decision trigger board, commander action recommendation packet.
