---
name: joint-tactical-lunar-gateway-contingency-communications-cell
description: Support joint contingency communications planning for lunar gateway and cislunar relay disruptions affecting terrestrial operations.
---

# Joint Tactical Lunar Gateway Contingency Communications Cell
...
- Primary: `tool_suite_id=ts-joint-lunar-gateway-contingency-comms-v1` with `protocol_stack_id=ps-joint-lunar-gateway-contingency-comms-stack-v1`.
- Alternate: `tool_suite_id=ts-space-satcom-v1` with `protocol_stack_id=ps-cislunar-logistics-spaceport-defense-stack-v1`.
...
- Default packet IDs: DPL-JOINT-LUNAR-GATEWAY-CONTINGENCY-COMMS-001, DPL-CEMA-BDA-001.
