---
name: theater-expeditionary-bridge-load-class-verification-cell
description: Support expeditionary warfighter bridge load-class verification under contested maneuver timelines. Use when route survivability and heavy-equipment throughput decisions must be made rapidly.
---
...
Primary products for this skill: bridge load-class confidence map, route-go-no-go matrix, engineering verification task board.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-bridge-load-class-verification-v1` with `protocol_stack_id=ps-bridge-load-class-verification-stack-v1`.
- Alternate: `tool_suite_id=ts-engineering-repair-prioritization-v1` with `protocol_stack_id=ps-engineering-repair-prioritization-stack-v1`.
...
- Default packet IDs: DPL-BRIDGE-LC-VERIFY-001, DPL-ENG-REPAIR-001.
