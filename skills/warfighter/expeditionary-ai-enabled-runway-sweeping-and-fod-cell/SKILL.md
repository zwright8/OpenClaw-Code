---
name: expeditionary-ai-enabled-runway-sweeping-and-fod-cell
description: Support U.S. warfighter planning and operational decision support for Expeditionary AI-Enabled Runway Sweeping and FOD Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: sortie schedule, runway condition feeds, maintenance status, threat conditions.
...
Primary products for this skill: runway FOD mitigation campaign, sortie-impact forecast, autonomous sweep task board.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: airfield ops systems, computer-vision analytics, maintenance telemetry, safety incident trackers.
...
- Prefer these protocol families for this skill: API/JSON, CoT, USMTF.
