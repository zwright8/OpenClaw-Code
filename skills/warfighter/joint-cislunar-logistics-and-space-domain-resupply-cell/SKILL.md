---
name: joint-cislunar-logistics-and-space-domain-resupply-cell
description: Support U.S. warfighter planning and decision support for Joint Cislunar Logistics And Space Domain Resupply Cell. Use when missions require cislunar resupply synchronization, orbital logistics branch planning, and allied relay coordination, integrated options, and protocol-aware staff outputs.
---

# Joint Cislunar Logistics And Space Domain Resupply Cell
...
Primary products for this skill: cislunar resupply window board, relay asset allocation matrix, orbital sustainment risk ledger.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: space domain awareness catalogs, launch manifests, depot inventory synchronization services, allied payload routing planners.

## Protocol Profile

Preferred protocol families for this skill: USMTF, CCSDS telemetry formats, API/JSON.
...
- Start with tool_suite_id=ts-cislunar-resupply-node-protection-v1 and protocol_stack_id=ps-cislunar-resupply-assurance-stack-v1, then branch only when mission constraints require it.
