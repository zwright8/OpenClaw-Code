---
name: strategic-cognitive-electromagnetic-deception-exposure-cell
description: Expose adversary cognitive-electromagnetic deception campaigns that blend information operations with spectrum manipulation.
---

# Strategic Cognitive Electromagnetic Deception Exposure Cell
...
Primary products for this skill: cognitive-EM deception exposure matrix, attribution confidence ladder, strategic response options board.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: narrative telemetry fusion tools, RF spectrum anomaly analytics, source credibility ledgers, policy-governed response workflow engines.
...
- Prefer these protocol families for this skill: STIX/TAXII, NIEM, USMTF, NATO APP-11/ADatP-3 aligned, API/JSON.
