---
name: strategic-ai-enabled-adversary-mobilization-indications-cell
description: Support U.S. warfighter planning for strategic adversary mobilization indications and warning with AI-assisted confidence scoring and deception checks.
---
...
Primary products for this skill: mobilization indicators warning brief, deception-vs-signal confidence ladder, strategic branch trigger ledger.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: all-source fusion board, mobilization pattern detector, deception counter-analysis engine, strategic warning synchronization board.
...
- Prefer these protocol families for this skill: STIX/TAXII, API/JSON, OGC, USMTF.
