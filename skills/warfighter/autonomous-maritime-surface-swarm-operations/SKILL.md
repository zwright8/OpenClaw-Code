---
name: autonomous-maritime-surface-swarm-operations
description: Coordinate autonomous maritime surface swarm missions for ISR, screening, and maritime security. Use when tasking distributed uncrewed surface systems with human-on-the-loop controls.
---
...
1. Frame the mission problem using these core inputs: mission area boundaries, platform readiness, comms links, and rules of engagement.
...
Primary products for this skill: swarm task allocation matrix, control-link contingency plan, maritime screen effectiveness assessment.
