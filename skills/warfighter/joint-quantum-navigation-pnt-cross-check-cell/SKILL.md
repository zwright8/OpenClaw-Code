---
name: joint-quantum-navigation-pnt-cross-check-cell
description: Cross-check conventional PNT with quantum and inertial alternatives under spoofing and jamming. Use when precision timing and navigation integrity are mission-critical.
---
...
Primary products for this skill: PNT cross-check confidence brief, timing integrity branch plan, denied-navigation mitigation matrix.

## Domain Tool Stack

Use these tool categories as the baseline stack: quantum inertial sensor services, PNT anomaly monitors, timing distribution ledgers, navigation adjudication tools.

## Protocol Profile

Preferred protocol families for this skill: NMEA, IEEE 1588 PTP profiles, STANAG navigation messaging, API/JSON.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-quantum-navigation-pnt-cross-check-v1` with `protocol_stack_id=ps-quantum-navigation-pnt-cross-check-stack-v1`.
...
- Default packet IDs: DPL-QUANTUM-NAV-PNT-CROSS-CHECK-001, DPL-DENIED-PNT-TIMING-HOLDOVER-001.
