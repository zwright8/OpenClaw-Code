---
name: homeland-satellite-ground-station-defense-cell
description: Protect critical homeland satellite ground stations from cyber, physical, and information attacks. Use when SATCOM continuity depends on rapid hardening, layered defense, and prioritized restoration sequencing.
---
...
Primary products for this skill: ground-station defense posture plan, restoration priority matrix, continuity branch and failover board.
...
- Prioritize `tool_suite_id=ts-satellite-ground-station-defense-v1` + `protocol_stack_id=ps-satellite-ground-station-defense-stack-v1` for this mission set.
- Include `packet_id=DPL-SATELLITE-GROUND-STATION-DEFENSE-001` for high-consequence recommendations and branch decisions.
- Bind recommendations to `toolchain_profile_id=satellite-ground-station-defense-v1` in joint operations profile selection.
