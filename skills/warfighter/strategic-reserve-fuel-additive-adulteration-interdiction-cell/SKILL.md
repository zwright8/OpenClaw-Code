...
description: Support interdiction planning for strategic fuel additive adulteration threats across military and civil supply chains. Use when sustainment risk depends on fuel-quality trust and rapid containment.
---
...
Primary products for this skill: fuel adulteration interdiction map, additive integrity confidence board, and sustainment branch plan.
...
- Bind recommendations to tool_suite_id=ts-strategic-reserve-fuel-additive-adulteration-interdiction-cell-v1 and protocol_stack_id=ps-strategic-reserve-fuel-additive-adulteration-interdiction-cell-stack-v1.
- Use packet templates in ../_shared/references/domain-tool-packet-library.md and include packet_id=DPL-FUEL-ADDITIVE-INTERDICT-001 for critical recommendations.
- Prioritize these protocol families for this domain: USMTF, STIX/TAXII, EDI X12, API/JSON.
