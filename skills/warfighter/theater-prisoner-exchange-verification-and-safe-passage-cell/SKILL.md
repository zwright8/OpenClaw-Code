---
name: theater-prisoner-exchange-verification-and-safe-passage-cell
description: Coordinate prisoner exchange verification, identity assurance, and safe-passage timing while reducing deception and escalation risk.
---

# Theater Prisoner Exchange Verification and Safe Passage Cell
...
Primary products for this skill: exchange verification packet, safe-passage corridor control matrix, detainee identity confidence report.

## External Tools and Protocol Integration

- Suggested tools: biometric verification systems, detainee records, ISR corridor monitoring feeds, ICRC liaison reporting.
- Protocol/message standards: NIEM, STANAG 5500 series, USMTF, signed JSON.
