---
name: special-operations-support-cell
description: Support special operations mission planning and integration with conventional forces. Use when coordinating partner force activities, low-signature operations, and mission command relationships.
---

# Special Operations Support Cell
...
1. Frame the mission problem using these core inputs: mission objectives, partner force status, authorities, exfiltration constraints.
...
Primary products for this skill: SOF support estimate, integration matrix, branch-and-sequel decision table.
