---
name: space-enabled-maritime-target-correlation-cell
description: Support U.S. warfighter planning and operational decision support for Space-Enabled Maritime Target Correlation Cell scenarios across joint and coalition mission environments. Use when planning, synchronizing, or adapting operations that require cross-domain coordination under uncertainty.
---
...
1. Frame the mission problem using these core inputs: orbital sensor data, maritime tracks, target priorities, ROE constraints.
...
Primary products for this skill: space-maritime target correlation brief, confidence-ranked track ledger, fires cueing recommendation pack.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: SDA catalogs, maritime COP tools, sensor fusion engines, targeting support systems.
...
- Prefer these protocol families for this skill: Link 16 J-series, AIS/NMEA, USMTF.
