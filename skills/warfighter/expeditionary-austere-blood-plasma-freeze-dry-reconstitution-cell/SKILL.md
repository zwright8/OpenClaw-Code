---
name: expeditionary-austere-blood-plasma-freeze-dry-reconstitution-cell
description: Coordinate freeze-dried plasma handling, reconstitution quality, and forward casualty support in austere expeditionary settings. Use when cold-chain fragility or mass casualty tempo stresses conventional blood logistics.
---

# Expeditionary Austere Blood Plasma Freeze-Dry Reconstitution Cell
...
1. Frame the mission problem using these core inputs: plasma inventory status, reconstitution kit availability, casualty demand forecast, and medical quality controls.
...
Primary products for this skill: plasma reconstitution readiness board, casualty-priority allocation ladder, quality exception and recall log.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: medical logistics platforms, blood-product quality assurance systems, expeditionary treatment network tools.
...
## Domain Toolchain Override (2026-03-09, Freeze-Dry Plasma Reconstitution Continuity)

- Prioritize tool_suite_id=ts-austere-plasma-reconstitution-v1 with protocol_stack_id=ps-austere-plasma-reconstitution-stack-v1 when expeditionary casualty demand exceeds cold-chain supported blood component availability.
- Use packet DPL-AUSTERE-PLASMA-RECONSTITUTION-001 to bind reconstitution quality checks, issue prioritization, and medical authority release gates.
- If quality evidence completeness or custody integrity fails, downgrade to advisory-only issue recommendations and require senior medical authority approval before administration.
