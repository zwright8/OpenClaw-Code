---
name: coalition-littoral-fuel-bladder-security-and-distribution-cell
description: Support coalition planning for secure littoral fuel bladder placement, protection, and redistribution under strike and sabotage threat.
---
...
Primary products for this skill: fuel bladder posture map, sabotage-risk routing board, coalition redistribution timeline.
...
- For this domain, prioritize `ts-littoral-fuel-bladder-security-v1` with `ps-littoral-fuel-bladder-security-stack-v1` and `DPL-LITTORAL-FUEL-BLADDER-SECURITY-001`.
