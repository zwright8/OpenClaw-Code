---
name: coalition-littoral-desal-plant-cyber-physical-defense-cell
description: Protect coalition desalination plants supporting expeditionary operations from cyber-physical disruption, contamination, and throughput collapse. Use when water security and partner-force sustainment depend on littoral plant resilience.
---

# Coalition Littoral Desal Plant Cyber-Physical Defense Cell
...
1. Frame the mission problem using these core inputs: desal telemetry stream, plant control network posture, intake and brine channel status, and coalition demand forecasts.
...
Primary products for this skill: plant defense hardening plan, contamination isolation sequence, coalition water continuity board.
...
## Domain Toolchain Override (2026-03-09, Littoral Desal Cyber-Physical Continuity)

- Prioritize tool_suite_id=ts-littoral-desal-cyber-physical-defense-v1 with protocol_stack_id=ps-littoral-desal-cyber-physical-defense-stack-v1 when coalition water production nodes show coordinated cyber/OT anomalies.
- Use packet DPL-LITTORAL-DESAL-CYBER-PHYSICAL-DEFENSE-001 to synchronize contamination gates, throughput protection, and partner notification timelines.
- If OT command trust or sample-chain integrity is incomplete, publish constrained-output recommendations and require commander plus host-nation utility authority approval.
