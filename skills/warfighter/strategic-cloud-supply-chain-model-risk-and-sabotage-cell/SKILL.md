---
name: strategic-cloud-supply-chain-model-risk-and-sabotage-cell
description: Support U.S. warfighter planning and decision support for cloud-hosted mission data and model supply-chain sabotage risk. Use when missions require model provenance verification, dependency compromise triage, and protocol-aware strategic mitigation outputs.
---

# Strategic Cloud Supply Chain Model Risk and Sabotage Cell
...
1. Frame the mission with these core inputs: model artifact lineage, cloud workload dependency graphs, firmware and library attestation status, mission criticality tiers.
...
Primary products: cloud-model risk heatmap, sabotage containment branches, strategic dependency reconstitution packet.

## External Tool and Protocol Requirements

- Prioritize tool families: software bill-of-materials and attestation services, cloud security telemetry platforms, model registry governance systems.
- Prioritize protocol/message bindings: STIX/TAXII, API/JSON, USMTF.
