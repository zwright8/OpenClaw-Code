---
name: joint-arctic-over-ice-logistics-corridor-assurance-cell
description: Assure over-ice sustainment corridors for U.S. and allied forces under weather, ISR, and adversary disruption.
---
...
Primary products: over-ice sustainment corridor confidence board, convoy reroute matrix, commander branch trigger packet.
...
- Primary: `tool_suite_id=ts-joint-arctic-over-ice-logistics-corridor-assurance-v1` with `protocol_stack_id=ps-joint-arctic-over-ice-logistics-corridor-assurance-stack-v1`.
- Alternate: `tool_suite_id=ts-polar-routing-v1` with `protocol_stack_id=ps-cop-event-sharing-stack-v1`.
...
- Default packet IDs: `DPL-JOINT-ARCTIC-OVER-ICE-LOGISTICS-001`, `DPL-JOINT-ARCTIC-OVER-ICE-LOGISTICS-002`.
