---
name: theater-prisoner-of-war-and-detainee-transfer-coordination
description: Plan lawful, auditable transfer and custody workflows for prisoners of war and detainees across echelons and coalition interfaces. Use when coordinating transport, accountability, and legal oversight.
---
...
1. Frame the mission problem using these core inputs: captured-person accountability records, holding capacity, transfer route risk, legal review status.
...
Primary products for this skill: detainee transfer synchronization matrix, chain-of-custody audit trail, legal compliance exception tracker.
