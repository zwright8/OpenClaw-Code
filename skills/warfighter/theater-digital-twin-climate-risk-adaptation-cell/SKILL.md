---
name: theater-digital-twin-climate-risk-adaptation-cell
description: Use theater digital twins to model climate stressors and adapt force posture, basing, and sustainment plans for long-horizon mission resilience. Use when commanders or staffs need mission-ready options with explicit tool/protocol bindings, authority gates, and degraded-mode branches.
---
...
Primary products for this skill: climate stress mission-impact model, adaptation option scorecard, phased posture adjustment roadmap.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: digital twin simulation environments, climate hazard analytics, infrastructure resilience dashboards, force posture planning tools.
- Prioritize these protocol families for this domain: API/JSON, OGC WMS/WFS/WMTS, USMTF, STIX/TAXII.
