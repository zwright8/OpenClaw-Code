---
name: theater-inland-waterway-logistics-under-fire-cell
description: Synchronize riverine and inland waterway logistics movement under kinetic threat, bridge loss, and chokepoint disruption.
---
...
Primary products for this skill: waterway movement synchronization matrix, chokepoint branch plan, throughput restoration board.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: riverine traffic COP, bridge integrity monitors, convoy movement C2 tools, ISR threat overlays.
- Preferred protocol profiles for coordination and machine exchange: AIS/NMEA, USMTF, VMF, API/JSON.
