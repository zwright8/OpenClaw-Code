---
name: strategic-arctic-fuel-bladder-and-pipeline-risk-cell
description: Assess Arctic fuel storage and pipeline vulnerability risks and sequence mitigation for sustained joint operations.
---
...
Primary products for this skill: fuel infrastructure risk map, mitigation option matrix, sustainment continuity timeline.

## Domain Tooling and Protocol Baseline

- Preferred external toolsets for this domain: fuel telemetry systems, pipeline integrity monitors, Arctic weather/ice intelligence, logistics COP.
- Preferred protocol profiles for coordination and machine exchange: USMTF, OGC, AIS/NMEA, API/JSON.
