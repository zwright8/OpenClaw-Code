---
name: expeditionary-portable-nuclear-reactor-safety-cell
description: Support U.S. warfighter planning and decision support for Expeditionary Portable Nuclear Reactor Safety Cell. Use when missions require Expeditionary Portable Nuclear Reactor Safety Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: reactor deployment safety case, exclusion-zone and consequence map, continuity power branch plan.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: reactor health telemetry, radiation hazard models, microgrid stability planners.
- Prioritize these protocol families for this domain: EDXL-DE/CAP, NIMS/ICS, USMTF, API/JSON.
