---
name: joint-integrated-air-missile-defense-multi-node-radar-deception-recovery-cell
description: Recover integrated air and missile defense picture quality after multi-node radar deception or spoofing campaigns. Use when operators need rapid branch options to restore track trust, engagement discipline, and cross-domain warning confidence.
---
...
Primary products for this skill: radar deception recovery playbook, track-trust adjudication board, engagement-discipline decision packet.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools for this domain: IAMD fusion services, radar track integrity analytics, engagement simulation tools, warning confidence adjudicators.
...
- Include tool_suite_id=ts-joint-iamd-multi-node-radar-deception-recovery-cell-v1, protocol_stack_id=ps-joint-iamd-multi-node-radar-deception-recovery-cell-stack-v1, and packet_id=DPL-IAMD-RADAR-DECEPTION-RECOVERY-001 for each critical recommendation.
