---
name: homeland-base-water-treatment-chemical-attack-recovery-cell
description: Support U.S. warfighter planning and decision support for Homeland Base Water Treatment Chemical Attack Recovery Cell. Use when missions require rapid military installation water-treatment recovery after chemical attack, contamination spread control, and continuity planning, integrated options, and protocol-aware staff outputs.
---

# Homeland Base Water Treatment Chemical Attack Recovery Cell
...
Primary products for this skill: water contamination containment map, treatment restoration timeline, base continuity risk packet.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: water quality sensor fusion systems, contamination plume estimators, emergency treatment dispatch planners.
...
- Prefer these protocol families for this skill: NIMS/ICS, USMTF, OGC, API/JSON.
...
- Primary: tool_suite_id=ts-homeland-base-water-treatment-chemical-attack-recovery-cell-v1 with protocol_stack_id=ps-homeland-base-water-treatment-chemical-attack-recovery-cell-stack-v1.
- Alternate: tool_suite_id=ts-urban-underground-water-contamination-rapid-response-v1 with protocol_stack_id=ps-urban-underground-water-contamination-rapid-response-stack-v1.
- Degraded: use authenticated voice/readback + UTC acknowledgment ledger + manual fallback board.

## Domain Packet Defaults

- Default packet IDs: DPL-BASE-WATER-CHEM-ATTACK-001, DPL-BASE-WATER-CHEM-ATTACK-002.
