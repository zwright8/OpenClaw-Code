---
name: homeland-waterway-lock-dam-cyber-physical-defense-cell
description: Protect inland lock and dam systems from cyber-physical disruption that can impact military mobility and civil stability.
---
...
- Primary: `tool_suite_id=ts-lock-dam-cyber-physical-defense-v1` with `protocol_stack_id=ps-lock-dam-cyber-physical-defense-stack-v1`.
...
- Default packet IDs: `DPL-LOCK-DAM-DEFENSE-001`, `DPL-INLAND-WATERWAY-MOBILITY-001`.
