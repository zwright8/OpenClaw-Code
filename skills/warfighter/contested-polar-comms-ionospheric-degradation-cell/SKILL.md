---
name: contested-polar-comms-ionospheric-degradation-cell
description: Maintain communications continuity in polar theaters under ionospheric disturbance and adversary interference. Use when HF and SATCOM reliability shifts rapidly.
---
...
1. Frame the mission problem using these core inputs: ionospheric disturbance forecast, comm path health telemetry, polar mission task priorities, adversary jamming indicators.
...
Primary products for this skill: polar comms continuity plan, path switching decision matrix, degraded comms branch timeline.
...
- Primary: `tool_suite_id=ts-polar-ionospheric-comms-v1` with `protocol_stack_id=ps-polar-comms-resilience-stack-v1`.
