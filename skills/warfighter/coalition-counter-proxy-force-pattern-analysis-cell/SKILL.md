---
name: coalition-counter-proxy-force-pattern-analysis-cell
description: Analyze coalition-area proxy force patterns and support counter-network campaign decisions.
---
...
Primary products for this skill: proxy pattern assessment, interdiction recommendation matrix, partner synchronization board.
