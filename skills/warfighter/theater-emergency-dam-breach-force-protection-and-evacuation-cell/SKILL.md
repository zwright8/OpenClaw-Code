---
name: theater-emergency-dam-breach-force-protection-and-evacuation-cell
description: Plan force protection and population-support actions for emergent dam breach scenarios across theater installations and partner communities. Use when upstream structural failure indicators threaten mission nodes.
---

# Theater Emergency Dam Breach Force Protection And Evacuation Cell
...
1. Frame the mission problem using these core inputs: hydrology sensor alerts, downstream force posture, evacuation route capacity, and partner civil coordination status.
...
Primary products for this skill: dam breach hazard timeline, evacuation and shelter priority ladder, installation continuity branch plan.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Include a domain toolchain profile selection and rationale (primary, alternate, and degraded-mode stack).
- Prioritize these tools or tool families for this domain: hydrologic forecast services, emergency operations dashboards, route and shelter capacity models.
...
## Domain Toolchain Override (2026-03-09, Dam Breach Evacuation Branch)

- Prioritize tool_suite_id=ts-dam-breach-force-protection-evacuation-v1 with protocol_stack_id=ps-dam-breach-force-protection-evacuation-stack-v1 when breach probability or downstream inundation timelines cross force-protection thresholds.
- Use packet DPL-DAM-BREACH-FORCE-PROTECTION-EVACUATION-001 to bind warning dissemination, phased evacuation triggers, and mission-continuity fallback actions.
- If hydrology model divergence or partner acknowledgment integrity is incomplete, issue advisory-only recommendations and require commander approval before mandatory movement orders.
