---
name: strategic-deterrence-signaling-options-cell
description: Develop bounded deterrence signaling options with explicit escalation risk and legal-policy constraints. Use when leaders need calibrated response options under strategic pressure.
---
...
1. Frame the mission problem using these core inputs: strategic warning indicators, adversary behavior trends, policy constraints, alliance posture.
...
Primary products for this skill: deterrence signaling option set, escalation trigger map, risk-bounded recommendation.

## External Tools and Protocol Integration

- Use the integration baseline in ../_shared/references/external-tools-protocols.md.
- Prioritize these tools or tool families for this domain: strategic warning dashboards, policy/legal advisory workflows, campaign risk models, secure reporting systems.
