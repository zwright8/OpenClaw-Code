---
name: joint-rocket-artillery-munition-dud-risk-cell
description: Support U.S. warfighter planning and decision support for Joint Rocket Artillery Munition Dud Risk Cell. Use when missions require Joint Rocket Artillery Munition Dud Risk Cell planning, integrated options, and protocol-aware staff outputs.
---
...
Primary products for this skill: dud risk heatmap, post-strike UXO hazard advisory, fires adjustment decision matrix.

## External Tools and Protocol Integration

- Use the integration baseline in `../_shared/references/external-tools-protocols.md`.
- Prioritize these tools for this domain: munition reliability trackers, impact telemetry analyzers, EOD hazard planners.
- Prioritize these protocol families for this domain: VMF, USMTF, API/JSON.
