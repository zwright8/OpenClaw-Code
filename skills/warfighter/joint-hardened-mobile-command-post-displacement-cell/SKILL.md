---
name: joint-hardened-mobile-command-post-displacement-cell
description: Support U.S. warfighter command survivability planning for mobile command post displacement under precision strike and EW pressure.
---
...
Primary products for this skill: command post displacement decision matrix, survivability posture sequence, command continuity branch plan.

## Domain Tool Stack

Use these tool categories as the default stack for this skill: COP systems, mobility and route-risk planners, comms path assurance tools, counter-targeting telemetry.

## Protocol Profile

Preferred protocol families for this skill: USMTF, CoT, Link 16 J-series.

## Domain Toolchain Defaults

- Primary: \ with \.\n- Alternate: \ with \.\n- Degraded: preplanned displacement triggers with courier-backed command updates.
...
- Prefer these protocol families for this skill: USMTF, CoT, Link 16 J-series.
