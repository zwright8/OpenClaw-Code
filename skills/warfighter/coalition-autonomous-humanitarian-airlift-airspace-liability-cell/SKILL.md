---
name: coalition-autonomous-humanitarian-airlift-airspace-liability-cell
description: Coordinate coalition autonomous humanitarian airlift corridors with airspace liability controls and host-nation legal alignment.
---
...
Primary products: autonomous airlift corridor matrix, liability authority ladder, coalition relief airspace packet.
...
- Primary: `tool_suite_id=ts-coalition-autonomous-humanitarian-airlift-airspace-liability-v1` with `protocol_stack_id=ps-coalition-autonomous-humanitarian-airlift-airspace-liability-stack-v1`.
...
- Default packet IDs: `DPL-COALITION-AUTONOMOUS-HUMANITARIAN-AIRLIFT-AIRSPACE-LIABILITY-001`.
