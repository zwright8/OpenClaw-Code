---
name: theater-electromagnetic-decoy-fratricide-audit-cell
description: Audit electromagnetic decoy and deception plans for blue-force fratricide risk. Use when decoy campaigns and EMS operations intersect with friendly emitters in complex theaters.
---
...
Primary products for this skill: decoy-fratricide audit brief, emission conflict matrix, command release gate checklist.

## Domain Tool Stack

Use these tool categories as the baseline stack: decoy campaign managers, blue-emitter identity boards, fratricide risk simulators.

## Protocol Profile

Preferred protocol families for this skill: Link 16 J-series, VMF, signed safety manifests.

## Domain Toolchain Defaults

- Primary: `tool_suite_id=ts-electromagnetic-decoy-fratricide-audit-v1` with `protocol_stack_id=ps-electromagnetic-decoy-fratricide-audit-stack-v1`.
...
- Default packet IDs: DPL-ELECTROMAGNETIC-DECOY-FRATRICIDE-AUDIT-001, DPL-MULTI-DOMAIN-BATTLE-RHYTHM-FRAGMENT-RECOVERY-001.
