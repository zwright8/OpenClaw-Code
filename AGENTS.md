...
- `npm --prefix swarm-protocol run ops` - run swarm operator workflow CLI (see scoped subcommands below).
...
- Verified `1666d82e34..616b1dfdc7`: no root/`cognition-core`/`swarm-protocol` npm script deltas; added missing explicit `swarm-protocol` `ops` entrypoint documentation.
