...
- Verified `1d3941f8d9..cd48ddca1a`: no new README command-map additions were found (range improves reward-aware recency scoring + EXP3-IX recency metadata alignment); `package.json` script-map diff remains blocked in this checkout because root/`swarm-protocol` package manifests are absent.
