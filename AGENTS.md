...
- Verified `914e400a9d..efbf0419a2`: added README command-map workflow for anytime-MOSS autonomous run flags (`--selection-policy moss_anytime`, `--moss-alpha`); `package.json` script-map diff remains blocked in this checkout because root/`swarm-protocol` package manifests are absent.
