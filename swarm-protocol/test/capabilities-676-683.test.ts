...
const capabilities = [
    {
        ...
        evaluate: 'publishCrisisKpiDashboard',
        toTasks: 'crisisKpiDashboardPublisherToTasks',
        className: 'CrisisKpiDashboardPublisher',
    ...
    },
    {
        ...
        evaluate: 'diagnoseCrisisSkillGaps',
        toTasks: 'crisisSkillGapDiagnoserToTasks',
        className: 'CrisisSkillGapDiagnoser',
    ...
    },
    {
        ...
        evaluate: 'composeCrisisTrainingCurriculum',
        toTasks: 'crisisTrainingCurriculumComposerToTasks',
        className: 'CrisisTrainingCurriculumComposer',
    ...
    },
    {
        ...
        evaluate: 'taxonomyCrisisSelfReflectionErrors',
        toTasks: 'crisisSelfReflectionErrorTaxonomistToTasks',
        className: 'CrisisSelfReflectionErrorTaxonomist',
    ...
    },
    {
        ...
        evaluate: 'planCrisisContinuousImprovement',
        toTasks: 'crisisContinuousImprovementPlannerToTasks',
        className: 'CrisisContinuousImprovementPlanner',
    ...
    },
    {
        ...
        evaluate: 'normalizeImpactSignalIngestion',
        toTasks: 'impactSignalIngestionNormalizerToTasks',
        className: 'ImpactSignalIngestionNormalizer',
    ...
    },
    {
        ...
        evaluate: 'prioritizeImpactContextWindow',
        toTasks: 'impactContextWindowPrioritizerToTasks',
        className: 'ImpactContextWindowPrioritizer',
    ...
    },
    {
        ...
        evaluate: 'trackImpactEvidenceProvenance',
        toTasks: 'impactEvidenceProvenanceTrackerToTasks',
        className: 'ImpactEvidenceProvenanceTracker',
