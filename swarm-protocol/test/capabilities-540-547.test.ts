...
const capabilities = [
    {
        ...
        evaluate: 'rankEngineeringSemanticRetrieval',
        toTasks: 'engineeringSemanticRetrievalRankerToTasks',
        className: 'EngineeringSemanticRetrievalRanker',
    ...
    },
    {
        ...
        evaluate: 'evaluateEngineeringPlanQuality',
        toTasks: 'engineeringPlanQualityEvaluatorToTasks',
        className: 'EngineeringPlanQualityEvaluator',
    ...
    },
    {
        ...
        evaluate: 'mediateEngineeringMultiAgentNegotiation',
        toTasks: 'engineeringMultiAgentNegotiationMediatorToTasks',
        className: 'EngineeringMultiAgentNegotiationMediator',
    ...
    },
    {
        ...
        evaluate: 'coachEngineeringConflictResolution',
        toTasks: 'engineeringConflictResolutionCoachToTasks',
        className: 'EngineeringConflictResolutionCoach',
    ...
    },
    {
        ...
        evaluate: 'buildEngineeringExplainabilityNarratives',
        toTasks: 'engineeringExplainabilityNarrativeBuilderToTasks',
        className: 'EngineeringExplainabilityNarrativeBuilder',
    ...
    },
    {
        ...
        evaluate: 'communicateEngineeringUncertainty',
        toTasks: 'engineeringUncertaintyCommunicatorToTasks',
        className: 'EngineeringUncertaintyCommunicator',
    ...
    },
    {
        ...
        evaluate: 'generateEngineeringExperimentDesigns',
        toTasks: 'engineeringExperimentDesignGeneratorToTasks',
        className: 'EngineeringExperimentDesignGenerator',
    ...
    },
    {
        ...
        evaluate: 'governEngineeringAbRollouts',
        toTasks: 'engineeringAbRolloutGovernorToTasks',
        className: 'EngineeringAbRolloutGovernor',
