...
const capabilities = [
    {
        ...
        evaluate: 'rankEconomicSemanticRetrieval',
        toTasks: 'economicSemanticRetrievalRankerToTasks',
        className: 'EconomicSemanticRetrievalRanker',
    ...
    },
    {
        ...
        evaluate: 'evaluateEconomicPlanQuality',
        toTasks: 'economicPlanQualityEvaluatorToTasks',
        className: 'EconomicPlanQualityEvaluator',
    ...
    },
    {
        ...
        evaluate: 'mediateEconomicMultiAgentNegotiation',
        toTasks: 'economicMultiAgentNegotiationMediatorToTasks',
        className: 'EconomicMultiAgentNegotiationMediator',
    ...
    },
    {
        ...
        evaluate: 'coachEconomicConflictResolution',
        toTasks: 'economicConflictResolutionCoachToTasks',
        className: 'EconomicConflictResolutionCoach',
    ...
    },
    {
        ...
        evaluate: 'buildEconomicExplainabilityNarratives',
        toTasks: 'economicExplainabilityNarrativeBuilderToTasks',
        className: 'EconomicExplainabilityNarrativeBuilder',
    ...
    },
    {
        ...
        evaluate: 'communicateEconomicUncertainty',
        toTasks: 'economicUncertaintyCommunicatorToTasks',
        className: 'EconomicUncertaintyCommunicator',
    ...
    },
    {
        ...
        evaluate: 'generateEconomicExperimentDesigns',
        toTasks: 'economicExperimentDesignGeneratorToTasks',
        className: 'EconomicExperimentDesignGenerator',
    ...
    },
    {
        ...
        evaluate: 'governEconomicAbRollouts',
        toTasks: 'economicAbRolloutGovernorToTasks',
        className: 'EconomicAbRolloutGovernor',
