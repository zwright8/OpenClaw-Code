...
const capabilities = [
    {
        ...
        evaluate: 'synthesizeEconomicIncidentPlaybooks',
        toTasks: 'economicIncidentPlaybookSynthesizerToTasks',
        className: 'EconomicIncidentPlaybookSynthesizer',
    ...
    },
    {
        ...
        evaluate: 'orchestrateEconomicDisasterRecovery',
        toTasks: 'economicDisasterRecoveryOrchestratorToTasks',
        className: 'EconomicDisasterRecoveryOrchestrator',
    ...
    },
    {
        ...
        evaluate: 'brokerEconomicPrivacyData',
        toTasks: 'economicPrivacyPreservingDataBrokerToTasks',
        className: 'EconomicPrivacyPreservingDataBroker',
    ...
    },
    {
        ...
        evaluate: 'modelEconomicSecurityThreats',
        toTasks: 'economicSecurityThreatModelerToTasks',
        className: 'EconomicSecurityThreatModeler',
    ...
    },
    {
        ...
        evaluate: 'mapEconomicComplianceEvidence',
        toTasks: 'economicComplianceEvidenceMapperToTasks',
        className: 'EconomicComplianceEvidenceMapper',
    ...
    },
    {
        ...
        evaluate: 'forecastEconomicCostBenefit',
        toTasks: 'economicCostBenefitForecasterToTasks',
        className: 'EconomicCostBenefitForecaster',
    ...
    },
    {
        ...
        evaluate: 'scoreEconomicEquityImpact',
        toTasks: 'economicEquityImpactScorerToTasks',
        className: 'EconomicEquityImpactScorer',
    ...
    },
    {
        ...
        evaluate: 'harvestEconomicCommunityFeedback',
        toTasks: 'economicCommunityFeedbackHarvesterToTasks',
        className: 'EconomicCommunityFeedbackHarvester',
