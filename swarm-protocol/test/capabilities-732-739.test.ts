...
const capabilities = [
    {
        ...
        evaluate: 'routeCommsHumanApprovals',
        toTasks: 'commsHumanApprovalRouterToTasks',
        className: 'CommsHumanApprovalRouter',
    ...
    },
    {
        ...
        evaluate: 'contractCommsTaskHandoffs',
        toTasks: 'commsTaskHandoffContractorToTasks',
        className: 'CommsTaskHandoffContractor',
    ...
    },
    {
        ...
        evaluate: 'monitorCommsToolHealth',
        toTasks: 'commsToolHealthMonitorToTasks',
        className: 'CommsToolHealthMonitor',
    ...
    },
    {
        ...
        evaluate: 'coordinateCommsAutoRetryBackoff',
        toTasks: 'commsAutoRetryBackoffCoordinatorToTasks',
        className: 'CommsAutoRetryBackoffCoordinator',
    ...
    },
    {
        ...
        evaluate: 'mineCommsFailureRootCauses',
        toTasks: 'commsFailureRootCauseMinerToTasks',
        className: 'CommsFailureRootCauseMiner',
    ...
    },
    {
        ...
        evaluate: 'detectCommsRegressions',
        toTasks: 'commsRegressionSentinelToTasks',
        className: 'CommsRegressionSentinel',
    ...
    },
    {
        ...
        evaluate: 'consolidateCommsMemory',
        toTasks: 'commsMemoryConsolidationPipelineToTasks',
        className: 'CommsMemoryConsolidationPipeline',
    ...
    },
    {
        ...
        evaluate: 'linkCommsKnowledgeGraph',
        toTasks: 'commsKnowledgeGraphLinkerToTasks',
        className: 'CommsKnowledgeGraphLinker',
