...
const capabilities = [
    {
        ...
        evaluate: 'detectPublicServiceContradictions',
        toTasks: 'publicServiceContradictionDetectorToTasks',
        className: 'PublicServiceContradictionDetector',
    ...
    },
    {
        ...
        evaluate: 'calibratePublicServiceConfidence',
        toTasks: 'publicServiceConfidenceCalibrationEngineToTasks',
        className: 'PublicServiceConfidenceCalibrationEngine',
    ...
    },
    {
        ...
        evaluate: 'simulatePublicServiceCounterfactuals',
        toTasks: 'publicServiceCounterfactualSimulatorToTasks',
        className: 'PublicServiceCounterfactualSimulator',
    ...
    },
    {
        ...
        evaluate: 'decomposePublicServiceGoals',
        toTasks: 'publicServiceGoalDecomposerToTasks',
        className: 'PublicServiceGoalDecomposer',
    ...
    },
    {
        ...
        evaluate: 'planPublicServiceDependencyDag',
        toTasks: 'publicServiceDependencyDagPlannerToTasks',
        className: 'PublicServiceDependencyDagPlanner',
    ...
    },
    {
        ...
        evaluate: 'allocatePublicServiceResourceBudgets',
        toTasks: 'publicServiceResourceBudgetAllocatorToTasks',
        className: 'PublicServiceResourceBudgetAllocator',
    ...
    },
    {
        ...
        evaluate: 'schedulePublicServiceRiskAware',
        toTasks: 'publicServiceRiskAwareSchedulerToTasks',
        className: 'PublicServiceRiskAwareScheduler',
    ...
    },
    {
        ...
        evaluate: 'compilePublicServicePolicyConstraints',
        toTasks: 'publicServicePolicyConstraintCompilerToTasks',
        className: 'PublicServicePolicyConstraintCompiler',
