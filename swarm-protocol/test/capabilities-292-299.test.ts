...
const capabilities = [
    {
        ...
        evaluate: 'routeFederationHumanApprovals',
        toTasks: 'federationHumanApprovalRouterToTasks',
        className: 'FederationHumanApprovalRouter',
    ...
    },
    {
        ...
        evaluate: 'contractFederationTaskHandoffs',
        toTasks: 'federationTaskHandoffContractorToTasks',
        className: 'FederationTaskHandoffContractor',
    ...
    },
    {
        ...
        evaluate: 'monitorFederationToolHealth',
        toTasks: 'federationToolHealthMonitorToTasks',
        className: 'FederationToolHealthMonitor',
    ...
    },
    {
        ...
        evaluate: 'coordinateFederationAutoRetryBackoff',
        toTasks: 'federationAutoRetryBackoffCoordinatorToTasks',
        className: 'FederationAutoRetryBackoffCoordinator',
    ...
    },
    {
        ...
        evaluate: 'mineFederationFailureRootCauses',
        toTasks: 'federationFailureRootCauseMinerToTasks',
        className: 'FederationFailureRootCauseMiner',
    ...
    },
    {
        ...
        evaluate: 'detectFederationRegressions',
        toTasks: 'federationRegressionSentinelToTasks',
        className: 'FederationRegressionSentinel',
    ...
    },
    {
        ...
        evaluate: 'consolidateFederationMemory',
        toTasks: 'federationMemoryConsolidationPipelineToTasks',
        className: 'FederationMemoryConsolidationPipeline',
    ...
    },
    {
        ...
        evaluate: 'linkFederationKnowledgeGraph',
        toTasks: 'federationKnowledgeGraphLinkerToTasks',
        className: 'FederationKnowledgeGraphLinker',
