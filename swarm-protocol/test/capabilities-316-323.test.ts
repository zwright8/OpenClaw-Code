...
const capabilities = [
    {
        ...
        evaluate: 'publishFederationKpiDashboard',
        toTasks: 'federationKpiDashboardPublisherToTasks',
        className: 'FederationKpiDashboardPublisher',
    ...
    },
    {
        ...
        evaluate: 'diagnoseFederationSkillGaps',
        toTasks: 'federationSkillGapDiagnoserToTasks',
        className: 'FederationSkillGapDiagnoser',
    ...
    },
    {
        ...
        evaluate: 'composeFederationTrainingCurriculum',
        toTasks: 'federationTrainingCurriculumComposerToTasks',
        className: 'FederationTrainingCurriculumComposer',
    ...
    },
    {
        ...
        evaluate: 'taxonomyFederationSelfReflectionErrors',
        toTasks: 'federationSelfReflectionErrorTaxonomistToTasks',
        className: 'FederationSelfReflectionErrorTaxonomist',
    ...
    },
    {
        ...
        evaluate: 'planFederationContinuousImprovement',
        toTasks: 'federationContinuousImprovementPlannerToTasks',
        className: 'FederationContinuousImprovementPlanner',
    ...
    },
    {
        ...
        evaluate: 'normalizeEconomicSignalIngestion',
        toTasks: 'economicSignalIngestionNormalizerToTasks',
        className: 'EconomicSignalIngestionNormalizer',
    ...
    },
    {
        ...
        evaluate: 'prioritizeEconomicContextWindow',
        toTasks: 'economicContextWindowPrioritizerToTasks',
        className: 'EconomicContextWindowPrioritizer',
    ...
    },
    {
        ...
        evaluate: 'trackEconomicEvidenceProvenance',
        toTasks: 'economicEvidenceProvenanceTrackerToTasks',
        className: 'EconomicEvidenceProvenanceTracker',
