...
const capabilities = [
    {
        ...
        evaluate: 'synthesizePublicServiceIncidentPlaybooks',
        toTasks: 'publicServiceIncidentPlaybookSynthesizerToTasks',
        className: 'PublicServiceIncidentPlaybookSynthesizer',
    ...
    },
    {
        ...
        evaluate: 'orchestratePublicServiceDisasterRecovery',
        toTasks: 'publicServiceDisasterRecoveryOrchestratorToTasks',
        className: 'PublicServiceDisasterRecoveryOrchestrator',
    ...
    },
    {
        ...
        evaluate: 'brokerPublicServicePrivacyData',
        toTasks: 'publicServicePrivacyPreservingDataBrokerToTasks',
        className: 'PublicServicePrivacyPreservingDataBroker',
    ...
    },
    {
        ...
        evaluate: 'modelPublicServiceSecurityThreats',
        toTasks: 'publicServiceSecurityThreatModelerToTasks',
        className: 'PublicServiceSecurityThreatModeler',
    ...
    },
    {
        ...
        evaluate: 'mapPublicServiceComplianceEvidence',
        toTasks: 'publicServiceComplianceEvidenceMapperToTasks',
        className: 'PublicServiceComplianceEvidenceMapper',
    ...
    },
    {
        ...
        evaluate: 'forecastPublicServiceCostBenefit',
        toTasks: 'publicServiceCostBenefitForecasterToTasks',
        className: 'PublicServiceCostBenefitForecaster',
    ...
    },
    {
        ...
        evaluate: 'scorePublicServiceEquityImpact',
        toTasks: 'publicServiceEquityImpactScorerToTasks',
        className: 'PublicServiceEquityImpactScorer',
    ...
    },
    {
        ...
        evaluate: 'harvestPublicServiceCommunityFeedback',
        toTasks: 'publicServiceCommunityFeedbackHarvesterToTasks',
        className: 'PublicServiceCommunityFeedbackHarvester',
