...
const capabilities = [
    {
        ...
        evaluate: 'routeObservabilityHumanApprovals',
        toTasks: 'observabilityHumanApprovalRouterToTasks',
        className: 'ObservabilityHumanApprovalRouter',
    ...
    },
    {
        ...
        evaluate: 'contractObservabilityTaskHandoffs',
        toTasks: 'observabilityTaskHandoffContractorToTasks',
        className: 'ObservabilityTaskHandoffContractor',
    ...
    },
    {
        ...
        evaluate: 'monitorObservabilityToolHealth',
        toTasks: 'observabilityToolHealthMonitorToTasks',
        className: 'ObservabilityToolHealthMonitor',
    ...
    },
    {
        ...
        evaluate: 'coordinateObservabilityAutoRetryBackoff',
        toTasks: 'observabilityAutoRetryBackoffCoordinatorToTasks',
        className: 'ObservabilityAutoRetryBackoffCoordinator',
    ...
    },
    {
        ...
        evaluate: 'mineObservabilityFailureRootCauses',
        toTasks: 'observabilityFailureRootCauseMinerToTasks',
        className: 'ObservabilityFailureRootCauseMiner',
    ...
    },
    {
        ...
        evaluate: 'detectObservabilityRegressions',
        toTasks: 'observabilityRegressionSentinelToTasks',
        className: 'ObservabilityRegressionSentinel',
    ...
    },
    {
        ...
        evaluate: 'consolidateObservabilityMemory',
        toTasks: 'observabilityMemoryConsolidationPipelineToTasks',
        className: 'ObservabilityMemoryConsolidationPipeline',
    ...
    },
    {
        ...
        evaluate: 'linkObservabilityKnowledgeGraph',
        toTasks: 'observabilityKnowledgeGraphLinkerToTasks',
        className: 'ObservabilityKnowledgeGraphLinker',
