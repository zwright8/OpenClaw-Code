...
const capabilities = [
    {
        ...
        evaluate: 'routeEconomicHumanApprovals',
        toTasks: 'economicHumanApprovalRouterToTasks',
        className: 'EconomicHumanApprovalRouter',
    ...
    },
    {
        ...
        evaluate: 'contractEconomicTaskHandoffs',
        toTasks: 'economicTaskHandoffContractorToTasks',
        className: 'EconomicTaskHandoffContractor',
    ...
    },
    {
        ...
        evaluate: 'monitorEconomicToolHealth',
        toTasks: 'economicToolHealthMonitorToTasks',
        className: 'EconomicToolHealthMonitor',
    ...
    },
    {
        ...
        evaluate: 'coordinateEconomicAutoRetryBackoff',
        toTasks: 'economicAutoRetryBackoffCoordinatorToTasks',
        className: 'EconomicAutoRetryBackoffCoordinator',
    ...
    },
    {
        ...
        evaluate: 'mineEconomicFailureRootCauses',
        toTasks: 'economicFailureRootCauseMinerToTasks',
        className: 'EconomicFailureRootCauseMiner',
    ...
    },
    {
        ...
        evaluate: 'detectEconomicRegressions',
        toTasks: 'economicRegressionSentinelToTasks',
        className: 'EconomicRegressionSentinel',
    ...
    },
    {
        ...
        evaluate: 'consolidateEconomicMemory',
        toTasks: 'economicMemoryConsolidationPipelineToTasks',
        className: 'EconomicMemoryConsolidationPipeline',
    ...
    },
    {
        ...
        evaluate: 'linkEconomicKnowledgeGraph',
        toTasks: 'economicKnowledgeGraphLinkerToTasks',
        className: 'EconomicKnowledgeGraphLinker',
