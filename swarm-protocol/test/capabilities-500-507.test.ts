...
const capabilities = [
    {
        ...
        evaluate: 'rankResearchSemanticRetrieval',
        toTasks: 'researchSemanticRetrievalRankerToTasks',
        className: 'ResearchSemanticRetrievalRanker',
    ...
    },
    {
        ...
        evaluate: 'evaluateResearchPlanQuality',
        toTasks: 'researchPlanQualityEvaluatorToTasks',
        className: 'ResearchPlanQualityEvaluator',
    ...
    },
    {
        ...
        evaluate: 'mediateResearchMultiAgentNegotiation',
        toTasks: 'researchMultiAgentNegotiationMediatorToTasks',
        className: 'ResearchMultiAgentNegotiationMediator',
    ...
    },
    {
        ...
        evaluate: 'coachResearchConflictResolution',
        toTasks: 'researchConflictResolutionCoachToTasks',
        className: 'ResearchConflictResolutionCoach',
    ...
    },
    {
        ...
        evaluate: 'buildResearchExplainabilityNarratives',
        toTasks: 'researchExplainabilityNarrativeBuilderToTasks',
        className: 'ResearchExplainabilityNarrativeBuilder',
    ...
    },
    {
        ...
        evaluate: 'communicateResearchUncertainty',
        toTasks: 'researchUncertaintyCommunicatorToTasks',
        className: 'ResearchUncertaintyCommunicator',
    ...
    },
    {
        ...
        evaluate: 'generateResearchExperimentDesigns',
        toTasks: 'researchExperimentDesignGeneratorToTasks',
        className: 'ResearchExperimentDesignGenerator',
    ...
    },
    {
        ...
        evaluate: 'governResearchAbRollouts',
        toTasks: 'researchAbRolloutGovernorToTasks',
        className: 'ResearchAbRolloutGovernor',
