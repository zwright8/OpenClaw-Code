...
const capabilities = [
    {
        ...
        evaluate: 'synthesizeCommsIncidentPlaybooks',
        toTasks: 'commsIncidentPlaybookSynthesizerToTasks',
        className: 'CommsIncidentPlaybookSynthesizer',
    ...
    },
    {
        ...
        evaluate: 'orchestrateCommsDisasterRecovery',
        toTasks: 'commsDisasterRecoveryOrchestratorToTasks',
        className: 'CommsDisasterRecoveryOrchestrator',
    ...
    },
    {
        ...
        evaluate: 'brokerCommsPrivacyData',
        toTasks: 'commsPrivacyPreservingDataBrokerToTasks',
        className: 'CommsPrivacyPreservingDataBroker',
    ...
    },
    {
        ...
        evaluate: 'modelCommsSecurityThreats',
        toTasks: 'commsSecurityThreatModelerToTasks',
        className: 'CommsSecurityThreatModeler',
    ...
    },
    {
        ...
        evaluate: 'mapCommsComplianceEvidence',
        toTasks: 'commsComplianceEvidenceMapperToTasks',
        className: 'CommsComplianceEvidenceMapper',
    ...
    },
    {
        ...
        evaluate: 'forecastCommsCostBenefit',
        toTasks: 'commsCostBenefitForecasterToTasks',
        className: 'CommsCostBenefitForecaster',
    ...
    },
    {
        ...
        evaluate: 'scoreCommsEquityImpact',
        toTasks: 'commsEquityImpactScorerToTasks',
        className: 'CommsEquityImpactScorer',
    ...
    },
    {
        ...
        evaluate: 'harvestCommsCommunityFeedback',
        toTasks: 'commsCommunityFeedbackHarvesterToTasks',
        className: 'CommsCommunityFeedbackHarvester',
