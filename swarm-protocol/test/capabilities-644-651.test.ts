...
const capabilities = [
    {
        ...
        evaluate: 'detectCrisisContradictions',
        toTasks: 'crisisContradictionDetectorToTasks',
        className: 'CrisisContradictionDetector',
    ...
    },
    {
        ...
        evaluate: 'calibrateCrisisConfidence',
        toTasks: 'crisisConfidenceCalibrationEngineToTasks',
        className: 'CrisisConfidenceCalibrationEngine',
    ...
    },
    {
        ...
        evaluate: 'simulateCrisisCounterfactuals',
        toTasks: 'crisisCounterfactualSimulatorToTasks',
        className: 'CrisisCounterfactualSimulator',
    ...
    },
    {
        ...
        evaluate: 'decomposeCrisisGoals',
        toTasks: 'crisisGoalDecomposerToTasks',
        className: 'CrisisGoalDecomposer',
    ...
    },
    {
        ...
        evaluate: 'planCrisisDependencyDag',
        toTasks: 'crisisDependencyDagPlannerToTasks',
        className: 'CrisisDependencyDagPlanner',
    ...
    },
    {
        ...
        evaluate: 'allocateCrisisResourceBudgets',
        toTasks: 'crisisResourceBudgetAllocatorToTasks',
        className: 'CrisisResourceBudgetAllocator',
    ...
    },
    {
        ...
        evaluate: 'scheduleCrisisRiskAware',
        toTasks: 'crisisRiskAwareSchedulerToTasks',
        className: 'CrisisRiskAwareScheduler',
    ...
    },
    {
        ...
        evaluate: 'compileCrisisPolicyConstraints',
        toTasks: 'crisisPolicyConstraintCompilerToTasks',
        className: 'CrisisPolicyConstraintCompiler',
