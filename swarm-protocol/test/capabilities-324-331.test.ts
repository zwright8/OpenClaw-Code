...
const capabilities = [
    {
        ...
        evaluate: 'detectEconomicContradictions',
        toTasks: 'economicContradictionDetectorToTasks',
        className: 'EconomicContradictionDetector',
    ...
    },
    {
        ...
        evaluate: 'calibrateEconomicConfidence',
        toTasks: 'economicConfidenceCalibrationEngineToTasks',
        className: 'EconomicConfidenceCalibrationEngine',
    ...
    },
    {
        ...
        evaluate: 'simulateEconomicCounterfactuals',
        toTasks: 'economicCounterfactualSimulatorToTasks',
        className: 'EconomicCounterfactualSimulator',
    ...
    },
    {
        ...
        evaluate: 'decomposeEconomicGoals',
        toTasks: 'economicGoalDecomposerToTasks',
        className: 'EconomicGoalDecomposer',
    ...
    },
    {
        ...
        evaluate: 'planEconomicDependencyDag',
        toTasks: 'economicDependencyDagPlannerToTasks',
        className: 'EconomicDependencyDagPlanner',
    ...
    },
    {
        ...
        evaluate: 'allocateEconomicResourceBudgets',
        toTasks: 'economicResourceBudgetAllocatorToTasks',
        className: 'EconomicResourceBudgetAllocator',
    ...
    },
    {
        ...
        evaluate: 'scheduleEconomicRiskAware',
        toTasks: 'economicRiskAwareSchedulerToTasks',
        className: 'EconomicRiskAwareScheduler',
    ...
    },
    {
        ...
        evaluate: 'compileEconomicPolicyConstraints',
        toTasks: 'economicPolicyConstraintCompilerToTasks',
        className: 'EconomicPolicyConstraintCompiler',
