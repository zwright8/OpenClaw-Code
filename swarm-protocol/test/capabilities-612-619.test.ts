...
const capabilities = [
    {
        ...
        evaluate: 'routeSecurityHumanApprovals',
        toTasks: 'securityHumanApprovalRouterToTasks',
        className: 'SecurityHumanApprovalRouter',
    ...
    },
    {
        ...
        evaluate: 'contractSecurityTaskHandoffs',
        toTasks: 'securityTaskHandoffContractorToTasks',
        className: 'SecurityTaskHandoffContractor',
    ...
    },
    {
        ...
        evaluate: 'monitorSecurityToolHealth',
        toTasks: 'securityToolHealthMonitorToTasks',
        className: 'SecurityToolHealthMonitor',
    ...
    },
    {
        ...
        evaluate: 'coordinateSecurityAutoRetryBackoff',
        toTasks: 'securityAutoRetryBackoffCoordinatorToTasks',
        className: 'SecurityAutoRetryBackoffCoordinator',
    ...
    },
    {
        ...
        evaluate: 'mineSecurityFailureRootCauses',
        toTasks: 'securityFailureRootCauseMinerToTasks',
        className: 'SecurityFailureRootCauseMiner',
    ...
    },
    {
        ...
        evaluate: 'detectSecurityRegressions',
        toTasks: 'securityRegressionSentinelToTasks',
        className: 'SecurityRegressionSentinel',
    ...
    },
    {
        ...
        evaluate: 'consolidateSecurityMemory',
        toTasks: 'securityMemoryConsolidationPipelineToTasks',
        className: 'SecurityMemoryConsolidationPipeline',
    ...
    },
    {
        ...
        evaluate: 'linkSecurityKnowledgeGraph',
        toTasks: 'securityKnowledgeGraphLinkerToTasks',
        className: 'SecurityKnowledgeGraphLinker',
