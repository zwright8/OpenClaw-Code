...
const capabilities = [
    {
        ...
        evaluate: 'publishEducationKpiDashboard',
        toTasks: 'educationKpiDashboardPublisherToTasks',
        className: 'EducationKpiDashboardPublisher',
    ...
    },
    {
        ...
        evaluate: 'diagnoseEducationSkillGaps',
        toTasks: 'educationSkillGapDiagnoserToTasks',
        className: 'EducationSkillGapDiagnoser',
    ...
    },
    {
        ...
        evaluate: 'composeEducationTrainingCurriculum',
        toTasks: 'educationTrainingCurriculumComposerToTasks',
        className: 'EducationTrainingCurriculumComposer',
    ...
    },
    {
        ...
        evaluate: 'taxonomyEducationSelfReflectionErrors',
        toTasks: 'educationSelfReflectionErrorTaxonomistToTasks',
        className: 'EducationSelfReflectionErrorTaxonomist',
    ...
    },
    {
        ...
        evaluate: 'planEducationContinuousImprovement',
        toTasks: 'educationContinuousImprovementPlannerToTasks',
        className: 'EducationContinuousImprovementPlanner',
    ...
    },
    {
        ...
        evaluate: 'normalizeResearchSignalIngestion',
        toTasks: 'researchSignalIngestionNormalizerToTasks',
        className: 'ResearchSignalIngestionNormalizer',
    ...
    },
    {
        ...
        evaluate: 'prioritizeResearchContextWindow',
        toTasks: 'researchContextWindowPrioritizerToTasks',
        className: 'ResearchContextWindowPrioritizer',
    ...
    },
    {
        ...
        evaluate: 'trackResearchEvidenceProvenance',
        toTasks: 'researchEvidenceProvenanceTrackerToTasks',
        className: 'ResearchEvidenceProvenanceTracker',
