...
const capabilities = [
    {
        ...
        evaluate: 'publishEngineeringKpiDashboard',
        toTasks: 'engineeringKpiDashboardPublisherToTasks',
        className: 'EngineeringKpiDashboardPublisher',
    ...
    },
    {
        ...
        evaluate: 'diagnoseEngineeringSkillGaps',
        toTasks: 'engineeringSkillGapDiagnoserToTasks',
        className: 'EngineeringSkillGapDiagnoser',
    ...
    },
    {
        ...
        evaluate: 'composeEngineeringTrainingCurriculum',
        toTasks: 'engineeringTrainingCurriculumComposerToTasks',
        className: 'EngineeringTrainingCurriculumComposer',
    ...
    },
    {
        ...
        evaluate: 'taxonomyEngineeringSelfReflectionErrors',
        toTasks: 'engineeringSelfReflectionErrorTaxonomistToTasks',
        className: 'EngineeringSelfReflectionErrorTaxonomist',
    ...
    },
    {
        ...
        evaluate: 'planEngineeringContinuousImprovement',
        toTasks: 'engineeringContinuousImprovementPlannerToTasks',
        className: 'EngineeringContinuousImprovementPlanner',
    ...
    },
    {
        ...
        evaluate: 'normalizeLogisticsSignalIngestion',
        toTasks: 'logisticsSignalIngestionNormalizerToTasks',
        className: 'LogisticsSignalIngestionNormalizer',
    ...
    },
    {
        ...
        evaluate: 'prioritizeLogisticsContextWindow',
        toTasks: 'logisticsContextWindowPrioritizerToTasks',
        className: 'LogisticsContextWindowPrioritizer',
    ...
    },
    {
        ...
        evaluate: 'trackLogisticsEvidenceProvenance',
        toTasks: 'logisticsEvidenceProvenanceTrackerToTasks',
        className: 'LogisticsEvidenceProvenanceTracker',
