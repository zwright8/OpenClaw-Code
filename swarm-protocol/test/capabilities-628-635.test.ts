...
const capabilities = [
    {
        ...
        evaluate: 'synthesizeSecurityIncidentPlaybooks',
        toTasks: 'securityIncidentPlaybookSynthesizerToTasks',
        className: 'SecurityIncidentPlaybookSynthesizer',
    ...
    },
    {
        ...
        evaluate: 'orchestrateSecurityDisasterRecovery',
        toTasks: 'securityDisasterRecoveryOrchestratorToTasks',
        className: 'SecurityDisasterRecoveryOrchestrator',
    ...
    },
    {
        ...
        evaluate: 'brokerSecurityPrivacyData',
        toTasks: 'securityPrivacyPreservingDataBrokerToTasks',
        className: 'SecurityPrivacyPreservingDataBroker',
    ...
    },
    {
        ...
        evaluate: 'modelSecuritySecurityThreats',
        toTasks: 'securitySecurityThreatModelerToTasks',
        className: 'SecuritySecurityThreatModeler',
    ...
    },
    {
        ...
        evaluate: 'mapSecurityComplianceEvidence',
        toTasks: 'securityComplianceEvidenceMapperToTasks',
        className: 'SecurityComplianceEvidenceMapper',
    ...
    },
    {
        ...
        evaluate: 'forecastSecurityCostBenefit',
        toTasks: 'securityCostBenefitForecasterToTasks',
        className: 'SecurityCostBenefitForecaster',
    ...
    },
    {
        ...
        evaluate: 'scoreSecurityEquityImpact',
        toTasks: 'securityEquityImpactScorerToTasks',
        className: 'SecurityEquityImpactScorer',
    ...
    },
    {
        ...
        evaluate: 'harvestSecurityCommunityFeedback',
        toTasks: 'securityCommunityFeedbackHarvesterToTasks',
        className: 'SecurityCommunityFeedbackHarvester',
