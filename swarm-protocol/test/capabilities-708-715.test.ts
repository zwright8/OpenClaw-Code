...
const capabilities = [
    {
        ...
        evaluate: 'synthesizeImpactIncidentPlaybooks',
        toTasks: 'impactIncidentPlaybookSynthesizerToTasks',
        className: 'ImpactIncidentPlaybookSynthesizer',
    ...
    },
    {
        ...
        evaluate: 'orchestrateImpactDisasterRecovery',
        toTasks: 'impactDisasterRecoveryOrchestratorToTasks',
        className: 'ImpactDisasterRecoveryOrchestrator',
    ...
    },
    {
        ...
        evaluate: 'brokerImpactPrivacyData',
        toTasks: 'impactPrivacyPreservingDataBrokerToTasks',
        className: 'ImpactPrivacyPreservingDataBroker',
    ...
    },
    {
        ...
        evaluate: 'modelImpactSecurityThreats',
        toTasks: 'impactSecurityThreatModelerToTasks',
        className: 'ImpactSecurityThreatModeler',
    ...
    },
    {
        ...
        evaluate: 'mapImpactComplianceEvidence',
        toTasks: 'impactComplianceEvidenceMapperToTasks',
        className: 'ImpactComplianceEvidenceMapper',
    ...
    },
    {
        ...
        evaluate: 'forecastImpactCostBenefit',
        toTasks: 'impactCostBenefitForecasterToTasks',
        className: 'ImpactCostBenefitForecaster',
    ...
    },
    {
        ...
        evaluate: 'scoreImpactEquityImpact',
        toTasks: 'impactEquityImpactScorerToTasks',
        className: 'ImpactEquityImpactScorer',
    ...
    },
    {
        ...
        evaluate: 'harvestImpactCommunityFeedback',
        toTasks: 'impactCommunityFeedbackHarvesterToTasks',
        className: 'ImpactCommunityFeedbackHarvester',
