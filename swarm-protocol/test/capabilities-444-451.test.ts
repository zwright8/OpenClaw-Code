...
const capabilities = [
    {
        ...
        evaluate: 'detectEducationContradictions',
        toTasks: 'educationContradictionDetectorToTasks',
        className: 'EducationContradictionDetector',
    ...
    },
    {
        ...
        evaluate: 'calibrateEducationConfidence',
        toTasks: 'educationConfidenceCalibrationEngineToTasks',
        className: 'EducationConfidenceCalibrationEngine',
    ...
    },
    {
        ...
        evaluate: 'simulateEducationCounterfactuals',
        toTasks: 'educationCounterfactualSimulatorToTasks',
        className: 'EducationCounterfactualSimulator',
    ...
    },
    {
        ...
        evaluate: 'decomposeEducationGoals',
        toTasks: 'educationGoalDecomposerToTasks',
        className: 'EducationGoalDecomposer',
    ...
    },
    {
        ...
        evaluate: 'planEducationDependencyDag',
        toTasks: 'educationDependencyDagPlannerToTasks',
        className: 'EducationDependencyDagPlanner',
    ...
    },
    {
        ...
        evaluate: 'allocateEducationResourceBudgets',
        toTasks: 'educationResourceBudgetAllocatorToTasks',
        className: 'EducationResourceBudgetAllocator',
    ...
    },
    {
        ...
        evaluate: 'scheduleEducationRiskAware',
        toTasks: 'educationRiskAwareSchedulerToTasks',
        className: 'EducationRiskAwareScheduler',
    ...
    },
    {
        ...
        evaluate: 'compileEducationPolicyConstraints',
        toTasks: 'educationPolicyConstraintCompilerToTasks',
        className: 'EducationPolicyConstraintCompiler',
