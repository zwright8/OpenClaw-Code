...
const capabilities = [
    {
        ...
        evaluate: 'rankEducationSemanticRetrieval',
        toTasks: 'educationSemanticRetrievalRankerToTasks',
        className: 'EducationSemanticRetrievalRanker',
    ...
    },
    {
        ...
        evaluate: 'evaluateEducationPlanQuality',
        toTasks: 'educationPlanQualityEvaluatorToTasks',
        className: 'EducationPlanQualityEvaluator',
    ...
    },
    {
        ...
        evaluate: 'mediateEducationMultiAgentNegotiation',
        toTasks: 'educationMultiAgentNegotiationMediatorToTasks',
        className: 'EducationMultiAgentNegotiationMediator',
    ...
    },
    {
        ...
        evaluate: 'coachEducationConflictResolution',
        toTasks: 'educationConflictResolutionCoachToTasks',
        className: 'EducationConflictResolutionCoach',
    ...
    },
    {
        ...
        evaluate: 'buildEducationExplainabilityNarratives',
        toTasks: 'educationExplainabilityNarrativeBuilderToTasks',
        className: 'EducationExplainabilityNarrativeBuilder',
    ...
    },
    {
        ...
        evaluate: 'communicateEducationUncertainty',
        toTasks: 'educationUncertaintyCommunicatorToTasks',
        className: 'EducationUncertaintyCommunicator',
    ...
    },
    {
        ...
        evaluate: 'generateEducationExperimentDesigns',
        toTasks: 'educationExperimentDesignGeneratorToTasks',
        className: 'EducationExperimentDesignGenerator',
    ...
    },
    {
        ...
        evaluate: 'governEducationAbRollouts',
        toTasks: 'educationAbRolloutGovernorToTasks',
        className: 'EducationAbRolloutGovernor',
