...
const capabilities = [
    {
        ...
        evaluate: 'detectEngineeringContradictions',
        toTasks: 'engineeringContradictionDetectorToTasks',
        className: 'EngineeringContradictionDetector',
    ...
    },
    {
        ...
        evaluate: 'calibrateEngineeringConfidence',
        toTasks: 'engineeringConfidenceCalibrationEngineToTasks',
        className: 'EngineeringConfidenceCalibrationEngine',
    ...
    },
    {
        ...
        evaluate: 'simulateEngineeringCounterfactuals',
        toTasks: 'engineeringCounterfactualSimulatorToTasks',
        className: 'EngineeringCounterfactualSimulator',
    ...
    },
    {
        ...
        evaluate: 'decomposeEngineeringGoals',
        toTasks: 'engineeringGoalDecomposerToTasks',
        className: 'EngineeringGoalDecomposer',
    ...
    },
    {
        ...
        evaluate: 'planEngineeringDependencyDag',
        toTasks: 'engineeringDependencyDagPlannerToTasks',
        className: 'EngineeringDependencyDagPlanner',
    ...
    },
    {
        ...
        evaluate: 'allocateEngineeringResourceBudgets',
        toTasks: 'engineeringResourceBudgetAllocatorToTasks',
        className: 'EngineeringResourceBudgetAllocator',
    ...
    },
    {
        ...
        evaluate: 'scheduleEngineeringRiskAware',
        toTasks: 'engineeringRiskAwareSchedulerToTasks',
        className: 'EngineeringRiskAwareScheduler',
    ...
    },
    {
        ...
        evaluate: 'compileEngineeringPolicyConstraints',
        toTasks: 'engineeringPolicyConstraintCompilerToTasks',
        className: 'EngineeringPolicyConstraintCompiler',
