...
const capabilities = [
    {
        ...
        evaluate: 'synthesizeObservabilityIncidentPlaybooks',
        toTasks: 'observabilityIncidentPlaybookSynthesizerToTasks',
        className: 'ObservabilityIncidentPlaybookSynthesizer',
    ...
    },
    {
        ...
        evaluate: 'orchestrateObservabilityDisasterRecovery',
        toTasks: 'observabilityDisasterRecoveryOrchestratorToTasks',
        className: 'ObservabilityDisasterRecoveryOrchestrator',
    ...
    },
    {
        ...
        evaluate: 'brokerObservabilityPrivacyData',
        toTasks: 'observabilityPrivacyPreservingDataBrokerToTasks',
        className: 'ObservabilityPrivacyPreservingDataBroker',
    ...
    },
    {
        ...
        evaluate: 'modelObservabilitySecurityThreats',
        toTasks: 'observabilitySecurityThreatModelerToTasks',
        className: 'ObservabilitySecurityThreatModeler',
    ...
    },
    {
        ...
        evaluate: 'mapObservabilityComplianceEvidence',
        toTasks: 'observabilityComplianceEvidenceMapperToTasks',
        className: 'ObservabilityComplianceEvidenceMapper',
    ...
    },
    {
        ...
        evaluate: 'forecastObservabilityCostBenefit',
        toTasks: 'observabilityCostBenefitForecasterToTasks',
        className: 'ObservabilityCostBenefitForecaster',
    ...
    },
    {
        ...
        evaluate: 'scoreObservabilityEquityImpact',
        toTasks: 'observabilityEquityImpactScorerToTasks',
        className: 'ObservabilityEquityImpactScorer',
    ...
    },
    {
        ...
        evaluate: 'harvestObservabilityCommunityFeedback',
        toTasks: 'observabilityCommunityFeedbackHarvesterToTasks',
        className: 'ObservabilityCommunityFeedbackHarvester',
