...
const capabilities = [
    {
        ...
        evaluate: 'synthesizeEducationIncidentPlaybooks',
        toTasks: 'educationIncidentPlaybookSynthesizerToTasks',
        className: 'EducationIncidentPlaybookSynthesizer',
    ...
    },
    {
        ...
        evaluate: 'orchestrateEducationDisasterRecovery',
        toTasks: 'educationDisasterRecoveryOrchestratorToTasks',
        className: 'EducationDisasterRecoveryOrchestrator',
    ...
    },
    {
        ...
        evaluate: 'brokerEducationPrivacyData',
        toTasks: 'educationPrivacyPreservingDataBrokerToTasks',
        className: 'EducationPrivacyPreservingDataBroker',
    ...
    },
    {
        ...
        evaluate: 'modelEducationSecurityThreats',
        toTasks: 'educationSecurityThreatModelerToTasks',
        className: 'EducationSecurityThreatModeler',
    ...
    },
    {
        ...
        evaluate: 'mapEducationComplianceEvidence',
        toTasks: 'educationComplianceEvidenceMapperToTasks',
        className: 'EducationComplianceEvidenceMapper',
    ...
    },
    {
        ...
        evaluate: 'forecastEducationCostBenefit',
        toTasks: 'educationCostBenefitForecasterToTasks',
        className: 'EducationCostBenefitForecaster',
    ...
    },
    {
        ...
        evaluate: 'scoreEducationEquityImpact',
        toTasks: 'educationEquityImpactScorerToTasks',
        className: 'EducationEquityImpactScorer',
    ...
    },
    {
        ...
        evaluate: 'harvestEducationCommunityFeedback',
        toTasks: 'educationCommunityFeedbackHarvesterToTasks',
        className: 'EducationCommunityFeedbackHarvester',
