...
const capabilities = [
    {
        ...
        evaluate: 'routeEducationHumanApprovals',
        toTasks: 'educationHumanApprovalRouterToTasks',
        className: 'EducationHumanApprovalRouter',
    ...
    },
    {
        ...
        evaluate: 'contractEducationTaskHandoffs',
        toTasks: 'educationTaskHandoffContractorToTasks',
        className: 'EducationTaskHandoffContractor',
    ...
    },
    {
        ...
        evaluate: 'monitorEducationToolHealth',
        toTasks: 'educationToolHealthMonitorToTasks',
        className: 'EducationToolHealthMonitor',
    ...
    },
    {
        ...
        evaluate: 'coordinateEducationAutoRetryBackoff',
        toTasks: 'educationAutoRetryBackoffCoordinatorToTasks',
        className: 'EducationAutoRetryBackoffCoordinator',
    ...
    },
    {
        ...
        evaluate: 'mineEducationFailureRootCauses',
        toTasks: 'educationFailureRootCauseMinerToTasks',
        className: 'EducationFailureRootCauseMiner',
    ...
    },
    {
        ...
        evaluate: 'detectEducationRegressions',
        toTasks: 'educationRegressionSentinelToTasks',
        className: 'EducationRegressionSentinel',
    ...
    },
    {
        ...
        evaluate: 'consolidateEducationMemory',
        toTasks: 'educationMemoryConsolidationPipelineToTasks',
        className: 'EducationMemoryConsolidationPipeline',
    ...
    },
    {
        ...
        evaluate: 'linkEducationKnowledgeGraph',
        toTasks: 'educationKnowledgeGraphLinkerToTasks',
        className: 'EducationKnowledgeGraphLinker',
