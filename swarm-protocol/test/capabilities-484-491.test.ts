...
const capabilities = [
    {
        ...
        evaluate: 'detectResearchContradictions',
        toTasks: 'researchContradictionDetectorToTasks',
        className: 'ResearchContradictionDetector',
    ...
    },
    {
        ...
        evaluate: 'calibrateResearchConfidence',
        toTasks: 'researchConfidenceCalibrationEngineToTasks',
        className: 'ResearchConfidenceCalibrationEngine',
    ...
    },
    {
        ...
        evaluate: 'simulateResearchCounterfactuals',
        toTasks: 'researchCounterfactualSimulatorToTasks',
        className: 'ResearchCounterfactualSimulator',
    ...
    },
    {
        ...
        evaluate: 'decomposeResearchGoals',
        toTasks: 'researchGoalDecomposerToTasks',
        className: 'ResearchGoalDecomposer',
    ...
    },
    {
        ...
        evaluate: 'planResearchDependencyDag',
        toTasks: 'researchDependencyDagPlannerToTasks',
        className: 'ResearchDependencyDagPlanner',
    ...
    },
    {
        ...
        evaluate: 'allocateResearchResourceBudgets',
        toTasks: 'researchResourceBudgetAllocatorToTasks',
        className: 'ResearchResourceBudgetAllocator',
    ...
    },
    {
        ...
        evaluate: 'scheduleResearchRiskAware',
        toTasks: 'researchRiskAwareSchedulerToTasks',
        className: 'ResearchRiskAwareScheduler',
    ...
    },
    {
        ...
        evaluate: 'compileResearchPolicyConstraints',
        toTasks: 'researchPolicyConstraintCompilerToTasks',
        className: 'ResearchPolicyConstraintCompiler',
