...
const capabilities = [
    {
        ...
        evaluate: 'publishImpactKpiDashboard',
        toTasks: 'impactKpiDashboardPublisherToTasks',
        className: 'ImpactKpiDashboardPublisher',
    ...
    },
    {
        ...
        evaluate: 'diagnoseImpactSkillGaps',
        toTasks: 'impactSkillGapDiagnoserToTasks',
        className: 'ImpactSkillGapDiagnoser',
    ...
    },
    {
        ...
        evaluate: 'composeImpactTrainingCurriculum',
        toTasks: 'impactTrainingCurriculumComposerToTasks',
        className: 'ImpactTrainingCurriculumComposer',
    ...
    },
    {
        ...
        evaluate: 'taxonomyImpactSelfReflectionErrors',
        toTasks: 'impactSelfReflectionErrorTaxonomistToTasks',
        className: 'ImpactSelfReflectionErrorTaxonomist',
    ...
    },
    {
        ...
        evaluate: 'planImpactContinuousImprovement',
        toTasks: 'impactContinuousImprovementPlannerToTasks',
        className: 'ImpactContinuousImprovementPlanner',
    ...
    },
    {
        ...
        evaluate: 'normalizeCommsSignalIngestion',
        toTasks: 'commsSignalIngestionNormalizerToTasks',
        className: 'CommsSignalIngestionNormalizer',
    ...
    },
    {
        ...
        evaluate: 'prioritizeCommsContextWindow',
        toTasks: 'commsContextWindowPrioritizerToTasks',
        className: 'CommsContextWindowPrioritizer',
    ...
    },
    {
        ...
        evaluate: 'trackCommsEvidenceProvenance',
        toTasks: 'commsEvidenceProvenanceTrackerToTasks',
        className: 'CommsEvidenceProvenanceTracker',
