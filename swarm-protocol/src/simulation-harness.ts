...
const SimulationScenarioSchema = z.object({
    ...
    adaptiveTimeoutEnabled: z.boolean().default(true),
    adaptiveTimeoutMinMs: z.number().int().positive().default(100),
    adaptiveTimeoutMaxMs: z.number().int().positive().default(5_000),
    adaptiveTimeoutSafetyMarginMs: z.number().int().nonnegative().default(25),
    bulkheadMaxInFlightPerTarget: z.number().int().positive().default(8),
    bulkheadMaxInFlightGlobal: z.number().int().positive().optional(),
    bulkheadGlobalHighPriorityReserve: z.number().int().nonnegative().default(0),
    bulkheadRetryDelayMs: z.number().int().positive().default(50),
    maintenanceRetryBatchLimit: z.number().int().positive().optional(),
    maintenanceHighPriorityShare: z.number().int().positive().default(2),
    retryBudgetRatio: z.number().nonnegative().default(0.2),
    retryBudgetMinPerWindow: z.number().int().nonnegative().default(3),
    retryBudgetWindowMs: z.number().int().positive().default(10_000),
    maxRetryElapsedMs: z.number().int().nonnegative().optional(),
    hedgingEnabled: z.boolean().default(false),
    hedgingDelayRatio: z.number().positive().max(0.99).default(0.8),
    hedgingMinDelayMs: z.number().int().nonnegative().default(250),
    hedgingMaxDelayMs: z.number().int().positive().default(5_000),
    hedgingMaxDispatches: z.number().int().nonnegative().default(1),
    hedgingEligiblePriorities: z.array(TaskPriority).default(['high', 'critical']),
    adaptiveThrottleEnabled: z.boolean().default(false),
    adaptiveThrottleWindowMs: z.number().int().positive().default(30_000),
    adaptiveThrottleMinSamples: z.number().int().positive().default(10),
    adaptiveThrottleDropThreshold: z.number().min(0).max(0.99).default(0.5),
    adaptiveThrottleBypassPriorities: z.array(TaskPriority).default(['high', 'critical']),
    adaptiveConcurrencyEnabled: z.boolean().default(false),
    adaptiveConcurrencyInitialLimit: z.number().int().positive().default(8),
    adaptiveConcurrencyMinLimit: z.number().int().positive().default(1),
    adaptiveConcurrencyMaxLimit: z.number().int().positive().default(64),
    adaptiveConcurrencyQueueLowWater: z.number().nonnegative().default(2),
    adaptiveConcurrencyQueueHighWater: z.number().nonnegative().default(4),
...
export async function runSimulationScenario(scenarioPayload, options = {}) {
    ...
    const orchestrator = new TaskOrchestrator({
        ...
        adaptiveTimeoutEnabled: scenario.adaptiveTimeoutEnabled,
        adaptiveTimeoutMinMs: scenario.adaptiveTimeoutMinMs,
        adaptiveTimeoutMaxMs: scenario.adaptiveTimeoutMaxMs,
        adaptiveTimeoutSafetyMarginMs: scenario.adaptiveTimeoutSafetyMarginMs,
        bulkheadMaxInFlightPerTarget: scenario.bulkheadMaxInFlightPerTarget,
        bulkheadMaxInFlightGlobal: scenario.bulkheadMaxInFlightGlobal,
        bulkheadGlobalHighPriorityReserve: scenario.bulkheadGlobalHighPriorityReserve,
        bulkheadRetryDelayMs: scenario.bulkheadRetryDelayMs,
        maintenanceRetryBatchLimit: scenario.maintenanceRetryBatchLimit,
        maintenanceHighPriorityShare: scenario.maintenanceHighPriorityShare,
        retryBudgetRatio: scenario.retryBudgetRatio,
        retryBudgetMinPerWindow: scenario.retryBudgetMinPerWindow,
        retryBudgetWindowMs: scenario.retryBudgetWindowMs,
        maxRetryElapsedMs: scenario.maxRetryElapsedMs,
        hedgingEnabled: scenario.hedgingEnabled,
        hedgingDelayRatio: scenario.hedgingDelayRatio,
        hedgingMinDelayMs: scenario.hedgingMinDelayMs,
        hedgingMaxDelayMs: scenario.hedgingMaxDelayMs,
        hedgingMaxDispatches: scenario.hedgingMaxDispatches,
        hedgingEligiblePriorities: scenario.hedgingEligiblePriorities,
        adaptiveThrottleEnabled: scenario.adaptiveThrottleEnabled,
        adaptiveThrottleWindowMs: scenario.adaptiveThrottleWindowMs,
        adaptiveThrottleMinSamples: scenario.adaptiveThrottleMinSamples,
        adaptiveThrottleDropThreshold: scenario.adaptiveThrottleDropThreshold,
        adaptiveThrottleBypassPriorities: scenario.adaptiveThrottleBypassPriorities,
        adaptiveConcurrencyEnabled: scenario.adaptiveConcurrencyEnabled,
        adaptiveConcurrencyInitialLimit: scenario.adaptiveConcurrencyInitialLimit,
        adaptiveConcurrencyMinLimit: scenario.adaptiveConcurrencyMinLimit,
        adaptiveConcurrencyMaxLimit: scenario.adaptiveConcurrencyMaxLimit,
        adaptiveConcurrencyQueueLowWater: scenario.adaptiveConcurrencyQueueLowWater,
        adaptiveConcurrencyQueueHighWater: scenario.adaptiveConcurrencyQueueHighWater,
