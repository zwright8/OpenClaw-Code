...
Options:
  ...
  --cd-min-samples <n>         Min outcomes before change detection in cd_ucb/sw_cd_ucb (default: 8)
  --cd-threshold <n>           Drift threshold for cd_ucb/sw_cd_ucb Page-Hinkley detector (default: 1.5)
  --cd-delta <n>               Mean slack delta for cd_ucb/sw_cd_ucb detector (default: 0.02)
  --cusum-threshold <n>        Drift threshold for cusum_ucb/sw_cusum_ucb (default: 1.2)
  --cusum-baseline-weight <n>  EWMA baseline weight for cusum_ucb/sw_cusum_ucb (0-1, default: 0.15)
