...
export async function runAutonomousOpenClaw({
    ...
    for (let wave = 1; wave <= normalizedWaves; wave++) {
        ...
        const workerReport = await runBotWorkerLoop({
            ...
            botRetryBudgetRatio,
            botRetryBudgetMaxTokens,
            botHedgeBudgetRatio,
            botHedgeBudgetMaxTokens,
    ...
    return {
        ...
        config: {
            ...
            botHedgedDelayAutoWindowSize: parsePositiveInt(botHedgedDelayAutoWindowSize, 32),
            botHedgedDelayAutoBlend: clamp(parseNonNegativeNumber(botHedgedDelayAutoBlend, 0.5), 0, 1),
            ...
            botAttemptTimeoutAutoWindowSize: parsePositiveInt(botAttemptTimeoutAutoWindowSize, 32),
            botAttemptTimeoutAutoBlend: clamp(parseNonNegativeNumber(botAttemptTimeoutAutoBlend, 0.5), 0, 1),
            ...
            botRetryBudgetMaxTokens: parseNonNegativeInt(botRetryBudgetMaxTokens, 10),
            botHedgeBudgetRatio: clamp(parseNonNegativeNumber(botHedgeBudgetRatio, 0), 0, 1),
            botHedgeBudgetMaxTokens: parseNonNegativeInt(botHedgeBudgetMaxTokens, 10),
            ...
            botCircuitBreakerCooldownJitter: clamp(
                parseNonNegativeNumber(botCircuitBreakerCooldownJitter, 0),
                0,
                1
            ),
            ...
            botCircuitBreakerHalfOpenMaxWaitMs: parseNonNegativeInt(botCircuitBreakerHalfOpenMaxWaitMs, 0),
